...
import 'voice_consent_deleted_resource_object.dart';final class VoiceConsentDeletedResource {const VoiceConsentDeletedResource({required this.id, required this.object, required this.deleted, });
