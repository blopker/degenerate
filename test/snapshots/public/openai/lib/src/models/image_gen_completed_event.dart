...
import 'image_gen_completed_event_output_format.dart';
...
///
final class ImageGenCompletedEvent {
  ...
  factory ImageGenCompletedEvent.fromJson(Map<String, dynamic> json) {
    return ImageGenCompletedEvent(
      ...
      quality: ImageGenCompletedEventQuality.fromJson(
        json['quality'] as String,
      ),
      background: ImageGenCompletedEventBackground.fromJson(
        json['background'] as String,
      ),
      outputFormat: ImageGenCompletedEventOutputFormat.fromJson(
  ...
  ImageGenCompletedEvent copyWith({
    ...
    ImageGenCompletedEventOutputFormat? outputFormat,
    ImagesUsage? usage,
  }) {
    return ImageGenCompletedEvent(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'ImageGenCompletedEvent(type: $type, b64Json: $b64Json, createdAt: $createdAt, size: $size, quality: $quality, background: $background, outputFormat: $outputFormat, usage: $usage)';
  }
}
