...
final class TranscriptTextDeltaEvent {
  ...
  factory TranscriptTextDeltaEvent.fromJson(Map<String, dynamic> json) {
    return TranscriptTextDeltaEvent(
      ...
      logprobs: (json['logprobs'] as List<dynamic>?)
          ?.map(
            (e) => TranscriptTextDeltaEventLogprobs.fromJson(
  ...
  TranscriptTextDeltaEvent copyWith({
    ...
    String? delta,
    List<TranscriptTextDeltaEventLogprobs> Function()? logprobs,
  ...
  @override
  String toString() {
    return 'TranscriptTextDeltaEvent(type: $type, delta: $delta, logprobs: $logprobs, segmentId: $segmentId)';
  }
}
