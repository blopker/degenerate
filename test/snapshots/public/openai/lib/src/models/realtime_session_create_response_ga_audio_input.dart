...
final class RealtimeSessionCreateResponseGaAudioInput {
  ...
  factory RealtimeSessionCreateResponseGaAudioInput.fromJson(
    ...
    return RealtimeSessionCreateResponseGaAudioInput(
      ...
      noiseReduction: json['noise_reduction'] != null
          ? RealtimeSessionCreateResponseGaAudioInputNoiseReduction.fromJson(
  ...
  RealtimeSessionCreateResponseGaAudioInput copyWith({
    RealtimeAudioFormats Function()? format,
    AudioTranscription Function()? transcription,
    RealtimeSessionCreateResponseGaAudioInputNoiseReduction Function()?
    noiseReduction,
  ...
  @override
  String toString() {
    return 'RealtimeSessionCreateResponseGaAudioInput(format: $format, transcription: $transcription, noiseReduction: $noiseReduction, turnDetection: $turnDetection)';
  }
}
