...
import 'realtime_session_create_response_max_output_tokens.dart';
import 'realtime_session_create_response_tracing.dart';
import 'realtime_session_create_response_turn_detection.dart';

/// A Realtime session configuration object.
///
final class RealtimeSessionCreateResponse {
  ...
  factory RealtimeSessionCreateResponse.fromJson(Map<String, dynamic> json) {
    return RealtimeSessionCreateResponse(
      ...
      include: (json['include'] as List<dynamic>?)
          ?.map(
            (e) => RealtimeSessionCreateResponseInclude.fromJson(e as String),
          )
          .toList(),
      ...
      audio: json['audio'] != null
          ? RealtimeSessionCreateResponseAudio.fromJson(
      ...
      turnDetection: json['turn_detection'] != null
          ? RealtimeSessionCreateResponseTurnDetection.fromJson(
      ...
      maxOutputTokens: json['max_output_tokens'] != null
          ? RealtimeSessionCreateResponseMaxOutputTokens.fromJson(
  ...
  RealtimeSessionCreateResponse copyWith({
    ...
    List<RealtimeSessionCreateResponseInclude> Function()? include,
    String Function()? model,
    String Function()? outputModalities,
    String Function()? instructions,
    RealtimeSessionCreateResponseAudio Function()? audio,
    RealtimeSessionCreateResponseTracing Function()? tracing,
    RealtimeSessionCreateResponseTurnDetection Function()? turnDetection,
    List<RealtimeFunctionTool> Function()? tools,
    String Function()? toolChoice,
    RealtimeSessionCreateResponseMaxOutputTokens Function()? maxOutputTokens,
  }) {
    return RealtimeSessionCreateResponse(
  ...
  @override
  String toString() {
    return 'RealtimeSessionCreateResponse(id: $id, object: $object, expiresAt: $expiresAt, include: $include, model: $model, outputModalities: $outputModalities, instructions: $instructions, audio: $audio, tracing: $tracing, turnDetection: $turnDetection, tools: $tools, toolChoice: $toolChoice, maxOutputTokens: $maxOutputTokens)';
  }
}
