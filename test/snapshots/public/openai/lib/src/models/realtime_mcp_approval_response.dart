...
///
final class RealtimeMcpApprovalResponse {
  ...
  factory RealtimeMcpApprovalResponse.fromJson(Map<String, dynamic> json) {
  ...
  RealtimeMcpApprovalResponse copyWith({
  ...
  @override
  String toString() {
    return 'RealtimeMcpApprovalResponse(type: $type, id: $id, approvalRequestId: $approvalRequestId, approve: $approve, reason: $reason)';
  }
}
