...
final class TranscriptionSegment {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('avg_logprob') &&
        json['avg_logprob'] is num &&
        json.containsKey('compression_ratio') &&
        json['compression_ratio'] is num &&
        json.containsKey('no_speech_prob') &&
        json['no_speech_prob'] is num;
  }
  ...
  @override
  String toString() {
    return 'TranscriptionSegment(id: $id, seek: $seek, start: $start, end: $end, text: $text, tokens: $tokens, temperature: $temperature, avgLogprob: $avgLogprob, compressionRatio: $compressionRatio, noSpeechProb: $noSpeechProb)';
  }
}
