...
final class AssignedRoleDetails {
  ...
  factory AssignedRoleDetails.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['resource_type'] is String &&
        json.containsKey('predefined_role') &&
        json['predefined_role'] is bool &&
  ...
  AssignedRoleDetails copyWith({
    ...
    int? Function()? createdAt,
    int? Function()? updatedAt,
    String? Function()? createdBy,
    Map<String, String>? Function()? createdByUserObj,
    ...
    return AssignedRoleDetails(
      ...
      createdByUserObj: createdByUserObj != null
          ? createdByUserObj()
          : this.createdByUserObj,
  ...
  @override
  String toString() {
    return 'AssignedRoleDetails(id: $id, name: $name, permissions: $permissions, resourceType: $resourceType, predefinedRole: $predefinedRole, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, createdByUserObj: $createdByUserObj, metadata: $metadata)';
  }
}
