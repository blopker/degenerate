...
///
final class ResponseMcpCallCompletedEvent {
  ...
  @override
  String toString() {
    return 'ResponseMcpCallCompletedEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, sequenceNumber: $sequenceNumber)';
  }
}
