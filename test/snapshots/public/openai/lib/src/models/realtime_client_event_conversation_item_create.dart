...
final class RealtimeClientEventConversationItemCreate {
  ...
  factory RealtimeClientEventConversationItemCreate.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeClientEventConversationItemCreate(
      eventId: json['event_id'] as String?,
      type: RealtimeClientEventConversationItemCreateType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeClientEventConversationItemCreate copyWith({
  ...
  @override
  String toString() {
    return 'RealtimeClientEventConversationItemCreate(eventId: $eventId, type: $type, previousItemId: $previousItemId, item: $item)';
  }
}
