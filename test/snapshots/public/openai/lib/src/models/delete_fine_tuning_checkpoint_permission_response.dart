...
import 'delete_fine_tuning_checkpoint_permission_response_object.dart';final class DeleteFineTuningCheckpointPermissionResponse {const DeleteFineTuningCheckpointPermissionResponse({required this.id, required this.object, required this.deleted, });
