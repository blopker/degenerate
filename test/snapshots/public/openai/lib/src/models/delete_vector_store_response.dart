...
import 'delete_vector_store_response_object.dart';final class DeleteVectorStoreResponse {const DeleteVectorStoreResponse({required this.id, required this.deleted, required this.object, });
