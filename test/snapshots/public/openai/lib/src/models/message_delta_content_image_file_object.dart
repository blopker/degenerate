...
final class MessageDeltaContentImageFileObject {
  ...
  factory MessageDeltaContentImageFileObject.fromJson(
    ...
    return MessageDeltaContentImageFileObject(
      ...
      type: MessageDeltaContentImageFileObjectType.fromJson(
        json['type'] as String,
      ),
      imageFile: json['image_file'] != null
          ? MessageDeltaContentImageFileObjectImageFile.fromJson(
  ...
  MessageDeltaContentImageFileObject copyWith({
    int? index,
    MessageDeltaContentImageFileObjectType? type,
    MessageDeltaContentImageFileObjectImageFile Function()? imageFile,
  }) {
    return MessageDeltaContentImageFileObject(
  ...
  @override
  int get hashCode {
    return Object.hash(index, type, imageFile);
  }

  @override
  String toString() {
    return 'MessageDeltaContentImageFileObject(index: $index, type: $type, imageFile: $imageFile)';
  }
}
