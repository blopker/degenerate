...
import 'package:collection/collection.dart';import 'fine_tuning_checkpoint_permission.dart';import 'list_fine_tuning_checkpoint_permission_response_object.dart';final class ListFineTuningCheckpointPermissionResponse {const ListFineTuningCheckpointPermissionResponse({required this.data, required this.object, this.firstId, this.lastId, required this.hasMore, });
