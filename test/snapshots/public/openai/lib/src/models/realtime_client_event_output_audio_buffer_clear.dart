...
///
final class RealtimeClientEventOutputAudioBufferClear {
  const RealtimeClientEventOutputAudioBufferClear({
    this.eventId,
    required this.type,
  });

  factory RealtimeClientEventOutputAudioBufferClear.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeClientEventOutputAudioBufferClear(
      eventId: json['event_id'] as String?,
      type: RealtimeClientEventOutputAudioBufferClearType.fromJson(
        json['type'] as String,
      ),
    );
  }
  ...
  RealtimeClientEventOutputAudioBufferClear copyWith({
  ...
  @override
  String toString() {
    return 'RealtimeClientEventOutputAudioBufferClear(eventId: $eventId, type: $type)';
  }
}
