...
import 'file_input_detail.dart';

/// A file input to the model.
final class InputFileContent {
  ...
  InputFileContent copyWith({
    ...
    FileInputDetail Function()? detail,
  }) {
    return InputFileContent(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'InputFileContent(type: $type, fileId: $fileId, filename: $filename, fileData: $fileData, fileUrl: $fileUrl, detail: $detail)';
  }
}
