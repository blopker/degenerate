...
final class ListProjectGroupsOrder {
  const ListProjectGroupsOrder._(this.value);

  factory ListProjectGroupsOrder.fromJson(String json) {
    return switch (json) {
      'asc' => asc,
      'desc' => desc,
  ...
  @override
  String toString() {
    return 'ListProjectGroupsOrder($value)';
  }
}
