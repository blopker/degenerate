...
final class ResponseCodeInterpreterCallInProgressEvent {
  ...
  factory ResponseCodeInterpreterCallInProgressEvent.fromJson(
    ...
    return ResponseCodeInterpreterCallInProgressEvent(
      type: ResponseCodeInterpreterCallInProgressEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseCodeInterpreterCallInProgressEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
