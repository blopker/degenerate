...
///
final class RealtimeResponseUsage {
  ...
  factory RealtimeResponseUsage.fromJson(Map<String, dynamic> json) {
    return RealtimeResponseUsage(
      ...
      inputTokenDetails: json['input_token_details'] != null
          ? RealtimeResponseUsageInputTokenDetails.fromJson(
              json['input_token_details'] as Map<String, dynamic>,
            )
          : null,
      outputTokenDetails: json['output_token_details'] != null
          ? RealtimeResponseUsageOutputTokenDetails.fromJson(
  ...
  RealtimeResponseUsage copyWith({
    int Function()? totalTokens,
    int Function()? inputTokens,
    int Function()? outputTokens,
    RealtimeResponseUsageInputTokenDetails Function()? inputTokenDetails,
    RealtimeResponseUsageOutputTokenDetails Function()? outputTokenDetails,
  }) {
    return RealtimeResponseUsage(
  ...
  @override
  String toString() {
    return 'RealtimeResponseUsage(totalTokens: $totalTokens, inputTokens: $inputTokens, outputTokens: $outputTokens, inputTokenDetails: $inputTokenDetails, outputTokenDetails: $outputTokenDetails)';
  }
}
