...
factory RunGraderResponse.fromJson(Map<String, dynamic> json) { return RunGraderResponse(
  ...
  subRewards: (json['sub_rewards'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
  modelGraderTokenUsagePerModel: (json['model_grader_token_usage_per_model'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
); }
...
RunGraderResponse copyWith({double? reward, RunGraderResponseMetadata? metadata, Map<String,String>? subRewards, Map<String,String>? modelGraderTokenUsagePerModel, }) { return RunGraderResponse(
