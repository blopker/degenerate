...
import 'dart:convert';import 'dart:typed_data';import 'create_image_variation_request_model.dart';import 'create_image_variation_request_response_format.dart';import 'create_image_variation_request_size.dart';final class CreateImageVariationRequest {const CreateImageVariationRequest({required this.image, this.model, this.n = 1, this.responseFormat = CreateImageVariationRequestResponseFormat.url, this.size = CreateImageVariationRequestSize.$1024x1024, this.user, });
