...
///
final class ChatCompletionRequestMessageContentPartAudio {
  const ChatCompletionRequestMessageContentPartAudio({
    required this.type,
    required this.inputAudio,
  });

  factory ChatCompletionRequestMessageContentPartAudio.fromJson(
    Map<String, dynamic> json,
  ) {
    return ChatCompletionRequestMessageContentPartAudio(
      type: ChatCompletionRequestMessageContentPartAudioType.fromJson(
        json['type'] as String,
      ),
      inputAudio:
          ChatCompletionRequestMessageContentPartAudioInputAudio.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'input_audio': inputAudio.toJson()};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('input_audio');
  }

  ChatCompletionRequestMessageContentPartAudio copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, inputAudio);
  }

  @override
  String toString() {
    return 'ChatCompletionRequestMessageContentPartAudio(type: $type, inputAudio: $inputAudio)';
  }
}
