...
final class RunStepDeltaStepDetailsMessageCreationObject {
  ...
  factory RunStepDeltaStepDetailsMessageCreationObject.fromJson(
    ...
    return RunStepDeltaStepDetailsMessageCreationObject(
      type: RunStepDeltaStepDetailsMessageCreationObjectType.fromJson(
        json['type'] as String,
      ),
      messageCreation: json['message_creation'] != null
          ? RunStepDeltaStepDetailsMessageCreationObjectMessageCreation.fromJson(
  ...
  RunStepDeltaStepDetailsMessageCreationObject copyWith({
    RunStepDeltaStepDetailsMessageCreationObjectType? type,
    RunStepDeltaStepDetailsMessageCreationObjectMessageCreation Function()?
    messageCreation,
  }) {
    return RunStepDeltaStepDetailsMessageCreationObject(
      type: type ?? this.type,
      messageCreation: messageCreation != null
          ? messageCreation()
          : this.messageCreation,
    );
  }
  ...
  @override
  String toString() {
    return 'RunStepDeltaStepDetailsMessageCreationObject(type: $type, messageCreation: $messageCreation)';
  }
}
