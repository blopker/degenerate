...
import 'run_grader_request_grader.dart';final class RunGraderRequest {const RunGraderRequest({required this.grader, this.item, required this.modelSample, });
...
RunGraderRequest copyWith({RunGraderRequestGrader? grader, Map<String, String> Function()? item, String? modelSample, }) { return RunGraderRequest(
