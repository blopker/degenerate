...
final class ComputerScreenshotContent {
  const ComputerScreenshotContent({
    this.type = ComputerScreenshotContentType.computerScreenshot,
  ...
  ComputerScreenshotContent copyWith({
  ...
  @override
  String toString() {
    return 'ComputerScreenshotContent(type: $type, imageUrl: $imageUrl, fileId: $fileId, detail: $detail)';
  }
}
