...
import 'dart:convert';import 'dart:typed_data';import 'create_file_request_purpose.dart';import 'file_expiration_after.dart';final class CreateFileRequest {const CreateFileRequest({required this.file, required this.purpose, this.expiresAfter, });
