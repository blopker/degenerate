...
final class CodeInterpreterOutputImage {
  const CodeInterpreterOutputImage({
    this.type = CodeInterpreterOutputImageType.image,
    required this.url,
  });

  factory CodeInterpreterOutputImage.fromJson(Map<String, dynamic> json) {
  ...
  CodeInterpreterOutputImage copyWith({
    CodeInterpreterOutputImageType? type,
    String? url,
  }) {
    return CodeInterpreterOutputImage(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'CodeInterpreterOutputImage(type: $type, url: $url)';
  }
}
