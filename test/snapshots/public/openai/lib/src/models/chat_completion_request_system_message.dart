...
import 'chat_completion_request_system_message_content.dart';/// Developer-provided instructions that the model should follow, regardless of
...
factory ChatCompletionRequestSystemMessage.fromJson(Map<String, dynamic> json) { return ChatCompletionRequestSystemMessage(
  content: ChatCompletionRequestSystemMessageContent.fromJson(json['content']),
