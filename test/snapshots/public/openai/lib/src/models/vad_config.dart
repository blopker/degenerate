...
import 'vad_config_type.dart';final class VadConfig {const VadConfig({required this.type, this.prefixPaddingMs = 300, this.silenceDurationMs = 200, this.threshold = 0.5, });
