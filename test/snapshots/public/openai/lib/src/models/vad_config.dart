...
final class VadConfig {
  ...
  factory VadConfig.fromJson(Map<String, dynamic> json) {
    return VadConfig(
      ...
      prefixPaddingMs: json.containsKey('prefix_padding_ms')
          ? (json['prefix_padding_ms'] as num).toInt()
          : 300,
      silenceDurationMs: json.containsKey('silence_duration_ms')
  ...
  @override
  int get hashCode {
    return Object.hash(type, prefixPaddingMs, silenceDurationMs, threshold);
  }

  @override
  String toString() {
    return 'VadConfig(type: $type, prefixPaddingMs: $prefixPaddingMs, silenceDurationMs: $silenceDurationMs, threshold: $threshold)';
  }
}
