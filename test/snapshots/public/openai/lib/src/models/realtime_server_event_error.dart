...
///
final class RealtimeServerEventError {
  ...
  factory RealtimeServerEventError.fromJson(Map<String, dynamic> json) {
    return RealtimeServerEventError(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventErrorType.fromJson(json['type'] as String),
      error: RealtimeServerEventErrorError.fromJson(
  ...
  RealtimeServerEventError copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventError(eventId: $eventId, type: $type, error: $error)';
  }
}
