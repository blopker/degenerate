...
import 'package:collection/collection.dart';final class CreateCompletionResponseChoicesLogprobs {const CreateCompletionResponseChoicesLogprobs({this.textOffset, this.tokenLogprobs, this.tokens, this.topLogprobs, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CreateCompletionResponseChoicesLogprobs &&
          const ListEquality<dynamic>().equals(textOffset, other.textOffset) &&
          const ListEquality<dynamic>().equals(tokenLogprobs, other.tokenLogprobs) &&
