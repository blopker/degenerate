...
import 'fine_tuning_job_event_object.dart';
import 'fine_tuning_job_event_type.dart';

/// Fine-tuning job event object
final class FineTuningJobEvent {
  ...
  factory FineTuningJobEvent.fromJson(Map<String, dynamic> json) {
    return FineTuningJobEvent(
      ...
      type: json['type'] != null
          ? FineTuningJobEventType.fromJson(json['type'] as String)
          : null,
  ...
  FineTuningJobEvent copyWith({
    FineTuningJobEventObject? object,
    String? id,
    int? createdAt,
    FineTuningJobEventLevel? level,
    String? message,
    FineTuningJobEventType Function()? type,
  ...
  @override
  int get hashCode {
    return Object.hash(object, id, createdAt, level, message, type, data);
  }

  @override
  String toString() {
    return 'FineTuningJobEvent(object: $object, id: $id, createdAt: $createdAt, level: $level, message: $message, type: $type, data: $data)';
  }
}
