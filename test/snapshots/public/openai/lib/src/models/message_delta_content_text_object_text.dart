...
import 'package:collection/collection.dart';import 'message_delta_content_text_object_text_annotations.dart';final class MessageDeltaContentTextObjectText {const MessageDeltaContentTextObjectText({this.value, this.annotations, });

factory MessageDeltaContentTextObjectText.fromJson(Map<String, dynamic> json) { return MessageDeltaContentTextObjectText(
  value: json['value'] as String?,
  annotations: (json['annotations'] as List<dynamic>?)?.map((e) => MessageDeltaContentTextObjectTextAnnotations.fromJson(e)).toList(),
); }
