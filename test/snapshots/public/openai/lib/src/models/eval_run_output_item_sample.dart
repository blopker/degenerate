...
final class EvalRunOutputItemSample {
  ...
  factory EvalRunOutputItemSample.fromJson(Map<String, dynamic> json) {
    return EvalRunOutputItemSample(
      input: (json['input'] as List<dynamic>)
          .map(
            (e) => EvalRunOutputItemSampleInput.fromJson(
      ...
      output: (json['output'] as List<dynamic>)
          .map(
            (e) => EvalRunOutputItemSampleOutput.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      usage: EvalRunOutputItemSampleUsage.fromJson(
  ...
  EvalRunOutputItemSample copyWith({
  ...
  @override
  String toString() {
    return 'EvalRunOutputItemSample(input: $input, output: $output, finishReason: $finishReason, model: $model, usage: $usage, error: $error, temperature: $temperature, maxCompletionTokens: $maxCompletionTokens, topP: $topP, seed: $seed)';
  }
}
