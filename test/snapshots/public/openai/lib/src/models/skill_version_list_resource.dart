...
import 'package:collection/collection.dart';import 'skill_version_list_resource_object.dart';import 'skill_version_resource.dart';final class SkillVersionListResource {const SkillVersionListResource({this.object = SkillVersionListResourceObject.list, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
