...
import 'key3_object.dart';
import 'key3_owner.dart';
...
final class Key3 {
  ...
  factory Key3.fromJson(Map<String, dynamic> json) {
    return Key3(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('object') &&
        json.containsKey('redacted_value') &&
        json['redacted_value'] is String &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('created_at') &&
        json['created_at'] is num &&
        json.containsKey('last_used_at') &&
        json['last_used_at'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
  ...
  @override
  String toString() {
    return 'Key3(object: $object, redactedValue: $redactedValue, name: $name, createdAt: $createdAt, lastUsedAt: $lastUsedAt, id: $id, owner: $owner)';
  }
}
