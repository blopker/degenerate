...
final class CreateModerationResponseResults {
  ...
  factory CreateModerationResponseResults.fromJson(Map<String, dynamic> json) {
    return CreateModerationResponseResults(
      flagged: json['flagged'] as bool,
      categories: CreateModerationResponseResultsCategories.fromJson(
        json['categories'] as Map<String, dynamic>,
      ),
      categoryScores: CreateModerationResponseResultsCategoryScores.fromJson(
        json['category_scores'] as Map<String, dynamic>,
      ),
      categoryAppliedInputTypes:
          CreateModerationResponseResultsCategoryAppliedInputTypes.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('flagged') &&
        json['flagged'] is bool &&
        json.containsKey('categories') &&
        json.containsKey('category_scores') &&
        json.containsKey('category_applied_input_types');
  }

  CreateModerationResponseResults copyWith({
    bool? flagged,
    CreateModerationResponseResultsCategories? categories,
  ...
  @override
  String toString() {
    return 'CreateModerationResponseResults(flagged: $flagged, categories: $categories, categoryScores: $categoryScores, categoryAppliedInputTypes: $categoryAppliedInputTypes)';
  }
}
