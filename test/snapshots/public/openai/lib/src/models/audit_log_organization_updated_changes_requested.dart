...
final class AuditLogOrganizationUpdatedChangesRequested {
  ...
  factory AuditLogOrganizationUpdatedChangesRequested.fromJson(
  ...
  AuditLogOrganizationUpdatedChangesRequested copyWith({
    String Function()? title,
    String Function()? description,
    String Function()? name,
    String Function()? threadsUiVisibility,
    String Function()? usageDashboardVisibility,
    String Function()? apiCallLogging,
    String Function()? apiCallLoggingProjectIds,
  }) {
    return AuditLogOrganizationUpdatedChangesRequested(
      title: title != null ? title() : this.title,
      description: description != null ? description() : this.description,
      name: name != null ? name() : this.name,
      threadsUiVisibility: threadsUiVisibility != null
          ? threadsUiVisibility()
          : this.threadsUiVisibility,
      usageDashboardVisibility: usageDashboardVisibility != null
          ? usageDashboardVisibility()
          : this.usageDashboardVisibility,
      apiCallLogging: apiCallLogging != null
          ? apiCallLogging()
          : this.apiCallLogging,
      apiCallLoggingProjectIds: apiCallLoggingProjectIds != null
  ...
  @override
  String toString() {
    return 'AuditLogOrganizationUpdatedChangesRequested(title: $title, description: $description, name: $name, threadsUiVisibility: $threadsUiVisibility, usageDashboardVisibility: $usageDashboardVisibility, apiCallLogging: $apiCallLogging, apiCallLoggingProjectIds: $apiCallLoggingProjectIds)';
  }
}
