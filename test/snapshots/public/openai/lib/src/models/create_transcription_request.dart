...
import 'dart:convert';import 'dart:typed_data';import 'package:collection/collection.dart';import 'audio_response_format.dart';import 'create_transcription_request_chunking_strategy.dart';import 'create_transcription_request_model.dart';import 'create_transcription_request_timestamp_granularities.dart';import 'transcription_include.dart';final class CreateTranscriptionRequest {const CreateTranscriptionRequest({required this.file, required this.model, this.language, this.prompt, this.responseFormat, this.temperature = 0.0, this.include, this.timestampGranularities, this.stream, this.chunkingStrategy, this.knownSpeakerNames, this.knownSpeakerReferences, });
...
factory CreateTranscriptionRequest.fromJson(Map<String, dynamic> json) { return CreateTranscriptionRequest(
  ...
  model: CreateTranscriptionRequestModel.fromJson(json['model'] as Map<String, dynamic>),
