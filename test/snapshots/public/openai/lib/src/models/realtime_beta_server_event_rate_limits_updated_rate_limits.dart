...
import 'realtime_beta_server_event_rate_limits_updated_rate_limits_name.dart';final class RealtimeBetaServerEventRateLimitsUpdatedRateLimits {const RealtimeBetaServerEventRateLimitsUpdatedRateLimits({this.name, this.limit, this.remaining, this.resetSeconds, });
