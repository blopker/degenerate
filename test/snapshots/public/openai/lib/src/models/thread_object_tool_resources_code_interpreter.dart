...
import 'package:collection/collection.dart';final class ThreadObjectToolResourcesCodeInterpreter {const ThreadObjectToolResourcesCodeInterpreter({this.fileIds = const []});
