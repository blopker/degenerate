...
import 'realtime_server_event_conversation_item_input_audio_transcription_segment_type.dart';/// Returned when an input audio transcription segment is identified for an item.
