...
final class CreateChatSessionBody {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('workflow') &&
        json.containsKey('user') &&
        json['user'] is String;
  }

  CreateChatSessionBody copyWith({
    WorkflowParam? workflow,
    String? user,
    ExpiresAfterParam Function()? expiresAfter,
    RateLimitsParam Function()? rateLimits,
    ChatkitConfigurationParam Function()? chatkitConfiguration,
  }) {
    return CreateChatSessionBody(
  ...
  @override
  String toString() {
    return 'CreateChatSessionBody(workflow: $workflow, user: $user, expiresAfter: $expiresAfter, rateLimits: $rateLimits, chatkitConfiguration: $chatkitConfiguration)';
  }
}
