...
///
final class ModifyThreadRequestToolResources {
  const ModifyThreadRequestToolResources({
    this.codeInterpreter,
    this.fileSearch,
  });

  factory ModifyThreadRequestToolResources.fromJson(Map<String, dynamic> json) {
    return ModifyThreadRequestToolResources(
      codeInterpreter: json['code_interpreter'] != null
          ? ModifyThreadRequestToolResourcesCodeInterpreter.fromJson(
              json['code_interpreter'] as Map<String, dynamic>,
            )
          : null,
      fileSearch: json['file_search'] != null
          ? ModifyThreadRequestToolResourcesFileSearch.fromJson(
  ...
  ModifyThreadRequestToolResources copyWith({
    ModifyThreadRequestToolResourcesCodeInterpreter Function()? codeInterpreter,
    ModifyThreadRequestToolResourcesFileSearch Function()? fileSearch,
  }) {
    return ModifyThreadRequestToolResources(
  ...
  @override
  String toString() {
    return 'ModifyThreadRequestToolResources(codeInterpreter: $codeInterpreter, fileSearch: $fileSearch)';
  }
}
