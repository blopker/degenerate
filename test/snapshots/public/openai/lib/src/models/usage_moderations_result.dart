...
import 'usage_moderations_result_object.dart';

/// The aggregated moderations usage details of the specific time bucket.
final class UsageModerationsResult {
  ...
  factory UsageModerationsResult.fromJson(Map<String, dynamic> json) {
  ...
  UsageModerationsResult copyWith({
  ...
  @override
  String toString() {
    return 'UsageModerationsResult(object: $object, inputTokens: $inputTokens, numModelRequests: $numModelRequests, projectId: $projectId, userId: $userId, apiKeyId: $apiKeyId, model: $model)';
  }
}
