...
import 'user_delete_response_object.dart';final class UserDeleteResponse {const UserDeleteResponse({required this.object, required this.id, required this.deleted, });
