...
final class ResponseFunctionCallArgumentsDeltaEvent {
  ...
  factory ResponseFunctionCallArgumentsDeltaEvent.fromJson(
    ...
    return ResponseFunctionCallArgumentsDeltaEvent(
      type: ResponseFunctionCallArgumentsDeltaEventType.fromJson(
        json['type'] as String,
      ),
  ...
  ResponseFunctionCallArgumentsDeltaEvent copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, itemId, outputIndex, sequenceNumber, delta);
  }

  @override
  String toString() {
    return 'ResponseFunctionCallArgumentsDeltaEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, sequenceNumber: $sequenceNumber, delta: $delta)';
  }
}
