...
final class CreateVoiceRequest {
  const CreateVoiceRequest({
    required this.name,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        ...
        json.containsKey('consent') &&
        json['consent'] is String;
  }

  CreateVoiceRequest copyWith({
    String? name,
  ...
  @override
  int get hashCode {
    return Object.hash(name, audioSample, consent);
  }

  @override
  String toString() {
    return 'CreateVoiceRequest(name: $name, audioSample: $audioSample, consent: $consent)';
  }
}
