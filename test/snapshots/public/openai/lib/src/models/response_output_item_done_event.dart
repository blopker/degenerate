...
final class ResponseOutputItemDoneEvent {
  ...
  ResponseOutputItemDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseOutputItemDoneEvent(type: $type, outputIndex: $outputIndex, sequenceNumber: $sequenceNumber, item: $item)';
  }
}
