...
final class StaticChunkingStrategy {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('max_chunk_size_tokens') &&
        json['max_chunk_size_tokens'] is num &&
        json.containsKey('chunk_overlap_tokens') &&
        json['chunk_overlap_tokens'] is num;
  }

  StaticChunkingStrategy copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(maxChunkSizeTokens, chunkOverlapTokens);
  }
