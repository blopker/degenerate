...
final class ResponseCodeInterpreterCallCodeDoneEvent {
  ...
  factory ResponseCodeInterpreterCallCodeDoneEvent.fromJson(
    ...
    return ResponseCodeInterpreterCallCodeDoneEvent(
      type: ResponseCodeInterpreterCallCodeDoneEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  int get hashCode {
    return Object.hash(type, outputIndex, itemId, code, sequenceNumber);
  }

  @override
  String toString() {
    return 'ResponseCodeInterpreterCallCodeDoneEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, code: $code, sequenceNumber: $sequenceNumber)';
  }
}
