...
final class ImagesUsageInputTokensDetails {
  ...
  ImagesUsageInputTokensDetails copyWith({int? textTokens, int? imageTokens}) {
    return ImagesUsageInputTokensDetails(
  ...
  @override
  String toString() {
    return 'ImagesUsageInputTokensDetails(textTokens: $textTokens, imageTokens: $imageTokens)';
  }
}
