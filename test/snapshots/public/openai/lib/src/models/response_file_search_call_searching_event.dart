...
final class ResponseFileSearchCallSearchingEvent {
  ...
  factory ResponseFileSearchCallSearchingEvent.fromJson(
    ...
    return ResponseFileSearchCallSearchingEvent(
      type: ResponseFileSearchCallSearchingEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseFileSearchCallSearchingEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
