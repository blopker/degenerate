...
import 'invite_delete_response_object.dart';final class InviteDeleteResponse {const InviteDeleteResponse({required this.object, required this.id, required this.deleted, });
