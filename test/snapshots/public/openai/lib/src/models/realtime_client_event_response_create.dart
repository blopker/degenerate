...
final class RealtimeClientEventResponseCreate {
  ...
  factory RealtimeClientEventResponseCreate.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeClientEventResponseCreate(
      eventId: json['event_id'] as String?,
      type: RealtimeClientEventResponseCreateType.fromJson(
        json['type'] as String,
      ),
      response: json['response'] != null
          ? RealtimeResponseCreateParams.fromJson(
  ...
  RealtimeClientEventResponseCreate copyWith({
    String Function()? eventId,
    RealtimeClientEventResponseCreateType? type,
    RealtimeResponseCreateParams Function()? response,
  }) {
    return RealtimeClientEventResponseCreate(
  ...
  @override
  String toString() {
    return 'RealtimeClientEventResponseCreate(eventId: $eventId, type: $type, response: $response)';
  }
}
