...
import 'realtime_server_event_input_audio_buffer_timeout_triggered_type.dart';
...
///
final class RealtimeServerEventInputAudioBufferTimeoutTriggered {
  ...
  factory RealtimeServerEventInputAudioBufferTimeoutTriggered.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventInputAudioBufferTimeoutTriggered(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventInputAudioBufferTimeoutTriggeredType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventInputAudioBufferTimeoutTriggered copyWith({
    String? eventId,
    RealtimeServerEventInputAudioBufferTimeoutTriggeredType? type,
    int? audioStartMs,
    int? audioEndMs,
    String? itemId,
  }) {
  ...
  @override
  int get hashCode {
    return Object.hash(eventId, type, audioStartMs, audioEndMs, itemId);
  }

  @override
  String toString() {
    return 'RealtimeServerEventInputAudioBufferTimeoutTriggered(eventId: $eventId, type: $type, audioStartMs: $audioStartMs, audioEndMs: $audioEndMs, itemId: $itemId)';
  }
}
