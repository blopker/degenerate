...
import 'create_eval_custom_data_source_config_type.dart';/// A CustomDataSourceConfig object that defines the schema for the data source used for the evaluation runs.
...
factory CreateEvalCustomDataSourceConfig.fromJson(Map<String, dynamic> json) { return CreateEvalCustomDataSourceConfig(
  ...
  itemSchema: (json['item_schema'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
...
CreateEvalCustomDataSourceConfig copyWith({CreateEvalCustomDataSourceConfigType? type, Map<String,String>? itemSchema, bool Function()? includeSampleSchema, }) { return CreateEvalCustomDataSourceConfig(
  type: type ?? this.type,
