...
import 'project_group_list_resource_object.dart';

/// Paginated list of groups that have access to a project.
final class ProjectGroupListResource {
  ...
  factory ProjectGroupListResource.fromJson(Map<String, dynamic> json) {
  ...
  ProjectGroupListResource copyWith({
    ProjectGroupListResourceObject? object,
  ...
  @override
  String toString() {
    return 'ProjectGroupListResource(object: $object, data: $data, hasMore: $hasMore, next: $next)';
  }
}
