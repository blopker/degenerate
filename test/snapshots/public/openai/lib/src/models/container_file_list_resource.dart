...
import 'package:collection/collection.dart';import 'container_file_list_resource_object.dart';import 'container_file_resource.dart';final class ContainerFileListResource {const ContainerFileListResource({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
