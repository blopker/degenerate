...
import 'package:collection/collection.dart';import 'eval_data_source_config.dart';import 'eval_object.dart';import 'eval_testing_criteria.dart';/// An Eval object with a data source config and testing criteria.
...
factory Eval.fromJson(Map<String, dynamic> json) { return Eval(
  ...
  dataSourceConfig: EvalDataSourceConfig.fromJson(json['data_source_config']),
  testingCriteria: (json['testing_criteria'] as List<dynamic>).map((e) => EvalTestingCriteria.fromJson(e)).toList(),
