...
import 'fine_tune_dpo_hyperparameters.dart';

/// Configuration for the DPO fine-tuning method.
final class FineTuneDpoMethod {
  ...
  FineTuneDpoMethod copyWith({
    FineTuneDpoHyperparameters Function()? hyperparameters,
  }) {
    return FineTuneDpoMethod(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is FineTuneDpoMethod && hyperparameters == other.hyperparameters;
  }

  @override
  int get hashCode {
    return hyperparameters.hashCode;
  }
