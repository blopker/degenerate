...
final class FileSearchTool {
  ...
  @override
  String toString() {
    return 'FileSearchTool(type: $type, vectorStoreIds: $vectorStoreIds, maxNumResults: $maxNumResults, rankingOptions: $rankingOptions, filters: $filters)';
  }
}
