...
/// Always `list`.
final class UserListResourceObject {
  const UserListResourceObject._(this.value);

  factory UserListResourceObject.fromJson(String json) {
    return switch (json) {
      'list' => list,
  ...
  @override
  String toString() {
    return 'UserListResourceObject($value)';
  }
}
