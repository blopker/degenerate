...
final class UsageImagesGroupBy {
  const UsageImagesGroupBy._(this.value);

  factory UsageImagesGroupBy.fromJson(String json) {
    return switch (json) {
  ...
  static const UsageImagesGroupBy projectId = UsageImagesGroupBy._(
    'project_id',
  );
  ...
  static const List<UsageImagesGroupBy> values = [
    projectId,
    userId,
    apiKeyId,
    model,
  ...
  @override
  String toString() {
    return 'UsageImagesGroupBy($value)';
  }
}
