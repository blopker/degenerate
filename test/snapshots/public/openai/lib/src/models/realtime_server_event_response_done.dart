...
/// any audio content.
///
final class RealtimeServerEventResponseDone {
  ...
  factory RealtimeServerEventResponseDone.fromJson(Map<String, dynamic> json) {
    return RealtimeServerEventResponseDone(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventResponseDoneType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventResponseDone copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventResponseDone(eventId: $eventId, type: $type, response: $response)';
  }
}
