...
final class ChatSessionChatkitConfiguration {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('automatic_thread_titling') &&
        json.containsKey('file_upload') &&
        json.containsKey('history');
  }

  ChatSessionChatkitConfiguration copyWith({
    ...
    return ChatSessionChatkitConfiguration(
      automaticThreadTitling:
          automaticThreadTitling ?? this.automaticThreadTitling,
  ...
  @override
  String toString() {
    return 'ChatSessionChatkitConfiguration(automaticThreadTitling: $automaticThreadTitling, fileUpload: $fileUpload, history: $history)';
  }
}
