...
import 'open_ai_file_object.dart';
...
final class OpenAiFile {
  ...
  @override
  String toString() {
    return 'OpenAiFile(id: $id, bytes: $bytes, createdAt: $createdAt, expiresAt: $expiresAt, filename: $filename, object: $object, purpose: $purpose, status: $status, statusDetails: $statusDetails)';
  }
}
