...
final class RunStepDetailsToolCallsCodeObject {
  ...
  factory RunStepDetailsToolCallsCodeObject.fromJson(
    ...
    return RunStepDetailsToolCallsCodeObject(
      ...
      type: RunStepDetailsToolCallsCodeObjectType.fromJson(
        json['type'] as String,
      ),
      codeInterpreter:
  ...
  RunStepDetailsToolCallsCodeObject copyWith({
    String? id,
  ...
  @override
  int get hashCode {
    return Object.hash(id, type, codeInterpreter);
  }

  @override
  String toString() {
    return 'RunStepDetailsToolCallsCodeObject(id: $id, type: $type, codeInterpreter: $codeInterpreter)';
  }
}
