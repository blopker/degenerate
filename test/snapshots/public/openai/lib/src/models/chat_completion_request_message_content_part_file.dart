...
///
final class ChatCompletionRequestMessageContentPartFile {
  const ChatCompletionRequestMessageContentPartFile({
    required this.type,
    required this.file,
  });

  factory ChatCompletionRequestMessageContentPartFile.fromJson(
    Map<String, dynamic> json,
  ) {
    return ChatCompletionRequestMessageContentPartFile(
      type: ChatCompletionRequestMessageContentPartFileType.fromJson(
        json['type'] as String,
      ),
      file: ChatCompletionRequestMessageContentPartFileFile.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'file': file.toJson()};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('file');
  }

  ChatCompletionRequestMessageContentPartFile copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, file);
  }

  @override
  String toString() {
    return 'ChatCompletionRequestMessageContentPartFile(type: $type, file: $file)';
  }
}
