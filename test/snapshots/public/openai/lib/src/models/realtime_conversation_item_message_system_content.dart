...
import 'realtime_conversation_item_message_system_content_type.dart';final class RealtimeConversationItemMessageSystemContent {const RealtimeConversationItemMessageSystemContent({this.type, this.text, });
