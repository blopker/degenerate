...
final class AudioTranscription {
  ...
  factory AudioTranscription.fromJson(Map<String, dynamic> json) {
    return AudioTranscription(
      model: json['model'] != null
          ? AudioTranscriptionModel.fromJson(
  ...
  AudioTranscription copyWith({
    AudioTranscriptionModel Function()? model,
  ...
  @override
  int get hashCode {
    return Object.hash(model, language, prompt);
  }

  @override
  String toString() {
    return 'AudioTranscription(model: $model, language: $language, prompt: $prompt)';
  }
}
