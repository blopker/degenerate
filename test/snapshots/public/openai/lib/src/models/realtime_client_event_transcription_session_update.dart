...
///
final class RealtimeClientEventTranscriptionSessionUpdate {
  ...
  factory RealtimeClientEventTranscriptionSessionUpdate.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeClientEventTranscriptionSessionUpdate(
      eventId: json['event_id'] as String?,
      type: RealtimeClientEventTranscriptionSessionUpdateType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeClientEventTranscriptionSessionUpdate copyWith({
  ...
  @override
  String toString() {
    return 'RealtimeClientEventTranscriptionSessionUpdate(eventId: $eventId, type: $type, session: $session)';
  }
}
