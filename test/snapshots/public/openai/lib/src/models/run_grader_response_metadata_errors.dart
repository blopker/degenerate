...
final class RunGraderResponseMetadataErrors {
  ...
  factory RunGraderResponseMetadataErrors.fromJson(Map<String, dynamic> json) {
    return RunGraderResponseMetadataErrors(
      ...
      pythonGraderServerErrorType:
          json['python_grader_server_error_type'] as String,
      pythonGraderRuntimeError: json['python_grader_runtime_error'] as bool,
      pythonGraderRuntimeErrorDetails:
          json['python_grader_runtime_error_details'] as String,
      ...
      modelGraderServerErrorDetails:
          json['model_grader_server_error_details'] as String,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('formula_parse_error') &&
        json['formula_parse_error'] is bool &&
        json.containsKey('sample_parse_error') &&
        json['sample_parse_error'] is bool &&
        json.containsKey('truncated_observation_error') &&
        json['truncated_observation_error'] is bool &&
        json.containsKey('unresponsive_reward_error') &&
        json['unresponsive_reward_error'] is bool &&
        json.containsKey('invalid_variable_error') &&
        json['invalid_variable_error'] is bool &&
        json.containsKey('other_error') &&
        json['other_error'] is bool &&
        json.containsKey('python_grader_server_error') &&
        json['python_grader_server_error'] is bool &&
        json.containsKey('python_grader_server_error_type') &&
        json['python_grader_server_error_type'] is String &&
        json.containsKey('python_grader_runtime_error') &&
        json['python_grader_runtime_error'] is bool &&
        json.containsKey('python_grader_runtime_error_details') &&
        json['python_grader_runtime_error_details'] is String &&
        json.containsKey('model_grader_server_error') &&
        json['model_grader_server_error'] is bool &&
        json.containsKey('model_grader_refusal_error') &&
        json['model_grader_refusal_error'] is bool &&
        json.containsKey('model_grader_parse_error') &&
        json['model_grader_parse_error'] is bool &&
        json.containsKey('model_grader_server_error_details') &&
        json['model_grader_server_error_details'] is String;
  }

  RunGraderResponseMetadataErrors copyWith({
    ...
    String? Function()? pythonGraderServerErrorType,
    ...
    String? Function()? modelGraderServerErrorDetails,
  }) {
    return RunGraderResponseMetadataErrors(
      ...
      truncatedObservationError:
          truncatedObservationError ?? this.truncatedObservationError,
      unresponsiveRewardError:
          unresponsiveRewardError ?? this.unresponsiveRewardError,
      ...
      pythonGraderServerError:
          pythonGraderServerError ?? this.pythonGraderServerError,
      pythonGraderServerErrorType: pythonGraderServerErrorType != null
          ? pythonGraderServerErrorType()
          : this.pythonGraderServerErrorType,
      pythonGraderRuntimeError:
          pythonGraderRuntimeError ?? this.pythonGraderRuntimeError,
      pythonGraderRuntimeErrorDetails: pythonGraderRuntimeErrorDetails != null
          ? pythonGraderRuntimeErrorDetails()
          : this.pythonGraderRuntimeErrorDetails,
      modelGraderServerError:
          modelGraderServerError ?? this.modelGraderServerError,
      modelGraderRefusalError:
          modelGraderRefusalError ?? this.modelGraderRefusalError,
      modelGraderParseError:
          modelGraderParseError ?? this.modelGraderParseError,
      modelGraderServerErrorDetails: modelGraderServerErrorDetails != null
          ? modelGraderServerErrorDetails()
          : this.modelGraderServerErrorDetails,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RunGraderResponseMetadataErrors &&
            ...
            pythonGraderRuntimeErrorDetails ==
                other.pythonGraderRuntimeErrorDetails &&
            ...
            modelGraderServerErrorDetails ==
                other.modelGraderServerErrorDetails;
  }
