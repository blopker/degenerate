...
final class FileSearchRanker {
  const FileSearchRanker._(this.value);

  factory FileSearchRanker.fromJson(String json) {
    return switch (json) {
      'auto' => auto,
  ...
  static const FileSearchRanker default20240821 = FileSearchRanker._(
    'default_2024_08_21',
  );
