...
import 'response_output_text_annotation_added_event_type.dart';/// Emitted when an annotation is added to output text content.
/// 
...
factory ResponseOutputTextAnnotationAddedEvent.fromJson(Map<String, dynamic> json) { return ResponseOutputTextAnnotationAddedEvent(
  ...
  annotation: (json['annotation'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
); }
...
ResponseOutputTextAnnotationAddedEvent copyWith({ResponseOutputTextAnnotationAddedEventType? type, String? itemId, int? outputIndex, int? contentIndex, int? annotationIndex, int? sequenceNumber, Map<String,String>? annotation, }) { return ResponseOutputTextAnnotationAddedEvent(
  type: type ?? this.type,
