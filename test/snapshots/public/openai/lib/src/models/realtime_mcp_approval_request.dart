...
///
final class RealtimeMcpApprovalRequest {
  ...
  factory RealtimeMcpApprovalRequest.fromJson(Map<String, dynamic> json) {
  ...
  RealtimeMcpApprovalRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, id, serverLabel, name, arguments);
  }

  @override
  String toString() {
    return 'RealtimeMcpApprovalRequest(type: $type, id: $id, serverLabel: $serverLabel, name: $name, arguments: $arguments)';
  }
}
