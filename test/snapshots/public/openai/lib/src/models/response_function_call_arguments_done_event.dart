...
final class ResponseFunctionCallArgumentsDoneEvent {
  ...
  factory ResponseFunctionCallArgumentsDoneEvent.fromJson(
    ...
    return ResponseFunctionCallArgumentsDoneEvent(
      type: ResponseFunctionCallArgumentsDoneEventType.fromJson(
        json['type'] as String,
      ),
  ...
  ResponseFunctionCallArgumentsDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseFunctionCallArgumentsDoneEvent(type: $type, itemId: $itemId, name: $name, outputIndex: $outputIndex, sequenceNumber: $sequenceNumber, arguments: $arguments)';
  }
}
