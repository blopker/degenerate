...
import 'realtime_beta_client_event_conversation_item_retrieve_type.dart';/// Send this event when you want to retrieve the server's representation of a specific item in the conversation history. This is useful, for example, to inspect user audio after noise cancellation and VAD.
