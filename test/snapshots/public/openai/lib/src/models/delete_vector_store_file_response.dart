...
import 'delete_vector_store_file_response_object.dart';

final class DeleteVectorStoreFileResponse {
  ...
  factory DeleteVectorStoreFileResponse.fromJson(Map<String, dynamic> json) {
    return DeleteVectorStoreFileResponse(
      ...
      object: DeleteVectorStoreFileResponseObject.fromJson(
  ...
  DeleteVectorStoreFileResponse copyWith({
    String? id,
    bool? deleted,
