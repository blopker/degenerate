...
import 'delete_vector_store_file_response_object.dart';final class DeleteVectorStoreFileResponse {const DeleteVectorStoreFileResponse({required this.id, required this.deleted, required this.object, });
