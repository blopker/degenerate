...
final class RealtimeSessionCreateRequestGaAudioInput {
  ...
  factory RealtimeSessionCreateRequestGaAudioInput.fromJson(
    ...
    return RealtimeSessionCreateRequestGaAudioInput(
      ...
      noiseReduction: json['noise_reduction'] != null
          ? RealtimeSessionCreateRequestGaAudioInputNoiseReduction.fromJson(
  ...
  RealtimeSessionCreateRequestGaAudioInput copyWith({
    RealtimeAudioFormats Function()? format,
    AudioTranscription Function()? transcription,
    RealtimeSessionCreateRequestGaAudioInputNoiseReduction Function()?
    noiseReduction,
  ...
  @override
  String toString() {
    return 'RealtimeSessionCreateRequestGaAudioInput(format: $format, transcription: $transcription, noiseReduction: $noiseReduction, turnDetection: $turnDetection)';
  }
}
