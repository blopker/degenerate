...
final class RunObjectRequiredAction {
  const RunObjectRequiredAction({
    required this.type,
    required this.submitToolOutputs,
  });

  factory RunObjectRequiredAction.fromJson(Map<String, dynamic> json) {
    return RunObjectRequiredAction(
      type: RunObjectRequiredActionType.fromJson(json['type'] as String),
      submitToolOutputs: RunObjectRequiredActionSubmitToolOutputs.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('submit_tool_outputs');
  }

  RunObjectRequiredAction copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, submitToolOutputs);
  }

  @override
  String toString() {
    return 'RunObjectRequiredAction(type: $type, submitToolOutputs: $submitToolOutputs)';
  }
}
