...
final class ApplyPatchDeleteFileOperation {
  const ApplyPatchDeleteFileOperation({
    this.type = ApplyPatchDeleteFileOperationType.deleteFile,
    required this.path,
  });

  factory ApplyPatchDeleteFileOperation.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'path': path};
  }
  ...
  ApplyPatchDeleteFileOperation copyWith({
    ApplyPatchDeleteFileOperationType? type,
    String? path,
  }) {
    return ApplyPatchDeleteFileOperation(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'ApplyPatchDeleteFileOperation(type: $type, path: $path)';
  }
}
