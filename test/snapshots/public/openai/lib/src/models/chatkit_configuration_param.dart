...
final class ChatkitConfigurationParam {
  ...
  ChatkitConfigurationParam copyWith({
    AutomaticThreadTitlingParam Function()? automaticThreadTitling,
    FileUploadParam Function()? fileUpload,
    HistoryParam Function()? history,
  }) {
    return ChatkitConfigurationParam(
      automaticThreadTitling: automaticThreadTitling != null
  ...
  @override
  int get hashCode {
    return Object.hash(automaticThreadTitling, fileUpload, history);
  }

  @override
  String toString() {
    return 'ChatkitConfigurationParam(automaticThreadTitling: $automaticThreadTitling, fileUpload: $fileUpload, history: $history)';
  }
}
