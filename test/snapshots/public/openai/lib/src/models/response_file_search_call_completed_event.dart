...
final class ResponseFileSearchCallCompletedEvent {
  ...
  factory ResponseFileSearchCallCompletedEvent.fromJson(
    ...
    return ResponseFileSearchCallCompletedEvent(
      type: ResponseFileSearchCallCompletedEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseFileSearchCallCompletedEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
