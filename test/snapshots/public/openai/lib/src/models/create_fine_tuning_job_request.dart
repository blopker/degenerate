...
import 'create_fine_tuning_job_request_model.dart';
import 'fine_tune_method.dart';

final class CreateFineTuningJobRequest {
  ...
  factory CreateFineTuningJobRequest.fromJson(Map<String, dynamic> json) {
    return CreateFineTuningJobRequest(
      model: CreateFineTuningJobRequestModel.fromJson(
        json['model'] as Map<String, dynamic>,
      ),
      trainingFile: json['training_file'] as String,
      hyperparameters: json['hyperparameters'] != null
          ? CreateFineTuningJobRequestHyperparameters.fromJson(
      ...
      integrations: (json['integrations'] as List<dynamic>?)
          ?.map(
            (e) => CreateFineTuningJobRequestIntegrations.fromJson(
  ...
  CreateFineTuningJobRequest copyWith({
    CreateFineTuningJobRequestModel? model,
    String? trainingFile,
    CreateFineTuningJobRequestHyperparameters Function()? hyperparameters,
    String? Function()? suffix,
    String? Function()? validationFile,
    List<CreateFineTuningJobRequestIntegrations>? Function()? integrations,
    int? Function()? seed,
