...
/// - `nin`: not in
///
final class ComparisonFilterType {
  const ComparisonFilterType._(this.value);

  factory ComparisonFilterType.fromJson(String json) {
    return switch (json) {
      'eq' => eq,
      'ne' => ne,
      'gt' => gt,
  ...
  @override
  String toString() {
    return 'ComparisonFilterType($value)';
  }
}
