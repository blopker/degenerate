...
final class ResponseReasoningTextDoneEvent {
  ...
  factory ResponseReasoningTextDoneEvent.fromJson(Map<String, dynamic> json) {
  ...
  ResponseReasoningTextDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseReasoningTextDoneEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, text: $text, sequenceNumber: $sequenceNumber)';
  }
}
