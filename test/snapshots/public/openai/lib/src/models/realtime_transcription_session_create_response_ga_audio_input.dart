...
import 'audio_transcription.dart';import 'realtime_audio_formats.dart';import 'realtime_transcription_session_create_response_ga_audio_input_noise_reduction.dart';import 'realtime_transcription_session_create_response_ga_audio_input_turn_detection.dart';final class RealtimeTranscriptionSessionCreateResponseGaAudioInput {const RealtimeTranscriptionSessionCreateResponseGaAudioInput({this.format, this.transcription, this.noiseReduction, this.turnDetection, });
...
factory RealtimeTranscriptionSessionCreateResponseGaAudioInput.fromJson(Map<String, dynamic> json) { return RealtimeTranscriptionSessionCreateResponseGaAudioInput(
  ...
  noiseReduction: json['noise_reduction'] != null
        ? RealtimeTranscriptionSessionCreateResponseGaAudioInputNoiseReduction.fromJson(json['noise_reduction'] as Map<String, dynamic>)
        : null,
  turnDetection: json['turn_detection'] != null
        ? RealtimeTranscriptionSessionCreateResponseGaAudioInputTurnDetection.fromJson(json['turn_detection'] as Map<String, dynamic>)
        : null,
); }
