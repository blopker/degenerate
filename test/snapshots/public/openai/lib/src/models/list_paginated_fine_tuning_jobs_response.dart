...
import 'package:collection/collection.dart';import 'fine_tuning_job.dart';import 'list_paginated_fine_tuning_jobs_response_object.dart';final class ListPaginatedFineTuningJobsResponse {const ListPaginatedFineTuningJobsResponse({required this.data, required this.hasMore, required this.object, });
