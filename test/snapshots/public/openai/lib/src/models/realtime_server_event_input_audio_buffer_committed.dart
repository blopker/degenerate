...
///
final class RealtimeServerEventInputAudioBufferCommitted {
  ...
  factory RealtimeServerEventInputAudioBufferCommitted.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventInputAudioBufferCommitted(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventInputAudioBufferCommittedType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventInputAudioBufferCommitted copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventInputAudioBufferCommitted(eventId: $eventId, type: $type, previousItemId: $previousItemId, itemId: $itemId)';
  }
}
