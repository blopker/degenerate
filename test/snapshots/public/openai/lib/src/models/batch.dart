...
final class Batch {
  ...
  factory Batch.fromJson(Map<String, dynamic> json) {
    return Batch(
      ...
      inProgressAt: json['in_progress_at'] != null
          ? (json['in_progress_at'] as num).toInt()
          : null,
      expiresAt: json['expires_at'] != null
          ? (json['expires_at'] as num).toInt()
          : null,
      finalizingAt: json['finalizing_at'] != null
          ? (json['finalizing_at'] as num).toInt()
          : null,
      ...
      expiredAt: json['expired_at'] != null
          ? (json['expired_at'] as num).toInt()
          : null,
      cancellingAt: json['cancelling_at'] != null
          ? (json['cancelling_at'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('input_file_id') &&
        json['input_file_id'] is String &&
        json.containsKey('completion_window') &&
        json['completion_window'] is String &&
  ...
  Batch copyWith({
    ...
    BatchErrors Function()? errors,
    String? inputFileId,
    String? completionWindow,
    BatchStatus? status,
    String Function()? outputFileId,
    String Function()? errorFileId,
    int? createdAt,
    int Function()? inProgressAt,
    int Function()? expiresAt,
    int Function()? finalizingAt,
    int Function()? completedAt,
    int Function()? failedAt,
    int Function()? expiredAt,
    int Function()? cancellingAt,
    int Function()? cancelledAt,
    BatchRequestCounts Function()? requestCounts,
    BatchUsage Function()? usage,
