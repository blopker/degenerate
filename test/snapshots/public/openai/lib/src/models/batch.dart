...
import 'batch_errors.dart';import 'batch_object.dart';import 'batch_request_counts.dart';import 'batch_status.dart';import 'batch_usage.dart';final class Batch {const Batch({required this.id, required this.object, required this.endpoint, this.model, this.errors, required this.inputFileId, required this.completionWindow, required this.status, this.outputFileId, this.errorFileId, required this.createdAt, this.inProgressAt, this.expiresAt, this.finalizingAt, this.completedAt, this.failedAt, this.expiredAt, this.cancellingAt, this.cancelledAt, this.requestCounts, this.usage, this.metadata, });
