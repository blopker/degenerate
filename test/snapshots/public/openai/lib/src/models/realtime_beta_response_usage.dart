...
///
final class RealtimeBetaResponseUsage {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (outputTokenDetails != null)
        'output_token_details': outputTokenDetails?.toJson(),
    };
  }
  ...
  RealtimeBetaResponseUsage copyWith({
    int Function()? totalTokens,
    int Function()? inputTokens,
    int Function()? outputTokens,
    RealtimeBetaResponseUsageInputTokenDetails Function()? inputTokenDetails,
    RealtimeBetaResponseUsageOutputTokenDetails Function()? outputTokenDetails,
  }) {
    return RealtimeBetaResponseUsage(
  ...
  @override
  String toString() {
    return 'RealtimeBetaResponseUsage(totalTokens: $totalTokens, inputTokens: $inputTokens, outputTokens: $outputTokens, inputTokenDetails: $inputTokenDetails, outputTokenDetails: $outputTokenDetails)';
  }
}
