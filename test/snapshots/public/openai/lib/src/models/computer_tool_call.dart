...
///
final class ComputerToolCall {
  const ComputerToolCall({
    this.type = 'computer_call',
    required this.id,
  ...
  factory ComputerToolCall.fromJson(Map<String, dynamic> json) {
    return ComputerToolCall(
      ...
      actions: (json['actions'] as List<dynamic>?)
          ...
          .toList(),
      pendingSafetyChecks: (json['pending_safety_checks'] as List<dynamic>)
          .map(
  ...
  ComputerToolCall copyWith({
    String? type,
    String? id,
    String? callId,
    ComputerAction Function()? action,
    List<ComputerAction> Function()? actions,
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(pendingSafetyChecks),
      status,
    );
  }
  ...
  @override
  String toString() {
    return 'ComputerToolCall(type: $type, id: $id, callId: $callId, action: $action, actions: $actions, pendingSafetyChecks: $pendingSafetyChecks, status: $status)';
  }
}
