...
import 'package:collection/collection.dart';import 'compact_resource_object.dart';import 'item_field.dart';import 'response_usage.dart';final class CompactResource {const CompactResource({required this.id, this.object = CompactResourceObject.responseCompaction, required this.output, required this.createdAt, required this.usage, });
