...
final class SkillListResourceObject {
  const SkillListResourceObject._(this.value);

  factory SkillListResourceObject.fromJson(String json) {
    return switch (json) {
      'list' => list,
  ...
  @override
  String toString() {
    return 'SkillListResourceObject($value)';
  }
}
