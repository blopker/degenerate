...
import 'function_call_status.dart';import 'tool_search_execution_type.dart';final class ToolSearchCall {const ToolSearchCall({this.type = 'tool_search_call', required this.id, required this.callId, required this.execution, required this.arguments, required this.status, this.createdBy, });
