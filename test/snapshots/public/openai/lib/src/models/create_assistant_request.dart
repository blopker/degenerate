...
import 'create_assistant_request_model.dart';
import 'create_assistant_request_tool_resources.dart';
import 'create_assistant_request_tools.dart';
import 'reasoning_effort.dart';
import 'response_format_option.dart';

final class CreateAssistantRequest {
  ...
  factory CreateAssistantRequest.fromJson(Map<String, dynamic> json) {
    return CreateAssistantRequest(
      model: CreateAssistantRequestModel.fromJson(
      ...
      tools: json.containsKey('tools')
          ? (json['tools'] as List<dynamic>)
                .map((e) => CreateAssistantRequestTools.fromJson(e))
                .toList()
          : const [],
      toolResources: json['tool_resources'] != null
          ? CreateAssistantRequestToolResources.fromJson(
  ...
  CreateAssistantRequest copyWith({
    CreateAssistantRequestModel? model,
    String? Function()? name,
    String? Function()? description,
    String? Function()? instructions,
    ReasoningEffort? Function()? reasoningEffort,
    List<CreateAssistantRequestTools> Function()? tools,
    CreateAssistantRequestToolResources? Function()? toolResources,
  ...
  @override
  String toString() {
    return 'CreateAssistantRequest(model: $model, name: $name, description: $description, instructions: $instructions, reasoningEffort: $reasoningEffort, tools: $tools, toolResources: $toolResources, metadata: $metadata, temperature: $temperature, topP: $topP, responseFormat: $responseFormat)';
  }
}
