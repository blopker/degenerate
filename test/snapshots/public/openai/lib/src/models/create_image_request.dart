...
import 'create_image_request_model.dart';
import 'create_image_request_moderation.dart';
import 'create_image_request_output_format.dart';
import 'create_image_request_quality.dart';
import 'create_image_request_response_format.dart';
...
final class CreateImageRequest {
  const CreateImageRequest({
    ...
    this.responseFormat = CreateImageRequestResponseFormat.url,
  ...
  factory CreateImageRequest.fromJson(Map<String, dynamic> json) {
    return CreateImageRequest(
      ...
      model: json['model'] != null
          ? CreateImageRequestModel.fromJson(
              json['model'] as Map<String, dynamic>,
            )
          : null,
      n: json.containsKey('n') ? (json['n'] as num).toInt() : 1,
      quality: json.containsKey('quality')
          ? CreateImageRequestQuality.fromJson(json['quality'] as String)
          : CreateImageRequestQuality.auto,
      responseFormat: json.containsKey('response_format')
          ? CreateImageRequestResponseFormat.fromJson(
              json['response_format'] as String,
            )
          : CreateImageRequestResponseFormat.url,
      outputFormat: json.containsKey('output_format')
          ? CreateImageRequestOutputFormat.fromJson(
      ...
      size: json.containsKey('size')
          ? CreateImageRequestSize.fromJson(json['size'] as String)
          : CreateImageRequestSize.auto,
      moderation: json.containsKey('moderation')
          ? CreateImageRequestModeration.fromJson(json['moderation'] as String)
          : CreateImageRequestModeration.auto,
      background: json.containsKey('background')
          ? CreateImageRequestBackground.fromJson(json['background'] as String)
          : CreateImageRequestBackground.auto,
      style: json.containsKey('style')
          ? CreateImageRequestStyle.fromJson(json['style'] as String)
          : CreateImageRequestStyle.vivid,
  ...
  CreateImageRequest copyWith({
    String? prompt,
    CreateImageRequestModel? Function()? model,
    int? Function()? n,
    CreateImageRequestQuality? Function()? quality,
    CreateImageRequestResponseFormat? Function()? responseFormat,
    CreateImageRequestOutputFormat? Function()? outputFormat,
    int? Function()? outputCompression,
    bool? Function()? stream,
    int? Function()? partialImages,
    CreateImageRequestSize? Function()? size,
    CreateImageRequestModeration? Function()? moderation,
    CreateImageRequestBackground? Function()? background,
    CreateImageRequestStyle? Function()? style,
  ...
  @override
  String toString() {
    return 'CreateImageRequest(prompt: $prompt, model: $model, n: $n, quality: $quality, responseFormat: $responseFormat, outputFormat: $outputFormat, outputCompression: $outputCompression, stream: $stream, partialImages: $partialImages, size: $size, moderation: $moderation, background: $background, style: $style, user: $user)';
  }
}
