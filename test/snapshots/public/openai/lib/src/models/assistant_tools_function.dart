...
final class AssistantToolsFunction {
  const AssistantToolsFunction({required this.type, required this.function});
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'function': function.toJson()};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('function');
  }

  AssistantToolsFunction copyWith({
  ...
  @override
  String toString() {
    return 'AssistantToolsFunction(type: $type, function: $function)';
  }
}
