...
final class RunObject {
  ...
  factory RunObject.fromJson(Map<String, dynamic> json) {
    return RunObject(
      ...
      requiredAction: RunObjectRequiredAction.fromJson(
        json['required_action'] as Map<String, dynamic>,
      ),
      lastError: RunObjectLastError.fromJson(
      ...
      incompleteDetails: RunObjectIncompleteDetails.fromJson(
        json['incomplete_details'] as Map<String, dynamic>,
      ),
      model: json['model'] as String,
      instructions: json['instructions'] as String,
      tools: (json['tools'] as List<dynamic>)
          .map((e) => RunObjectTools.fromJson(e))
          .toList(),
      ...
      truncationStrategy: TruncationObject.fromJson(
        json['truncation_strategy'] as Map<String, dynamic>,
      ),
      toolChoice: ToolChoiceOption.fromJson(
        json['tool_choice'] as Map<String, dynamic>,
      ),
      parallelToolCalls: json['parallel_tool_calls'] as bool,
      responseFormat: ResponseFormatOption.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('assistant_id') &&
        json['assistant_id'] is String &&
        ...
        json['started_at'] is num &&
        json.containsKey('cancelled_at') &&
        json['cancelled_at'] is num &&
        json.containsKey('failed_at') &&
        json['failed_at'] is num &&
        json.containsKey('completed_at') &&
        json['completed_at'] is num &&
        ...
        json.containsKey('max_prompt_tokens') &&
        json['max_prompt_tokens'] is num &&
        json.containsKey('max_completion_tokens') &&
        json['max_completion_tokens'] is num &&
        json.containsKey('truncation_strategy') &&
        json.containsKey('tool_choice') &&
        json.containsKey('parallel_tool_calls') &&
        json['parallel_tool_calls'] is bool &&
  ...
  RunObject copyWith({
    ...
    RunObjectRequiredAction? Function()? requiredAction,
    RunObjectLastError? Function()? lastError,
    int? Function()? expiresAt,
    int? Function()? startedAt,
    int? Function()? cancelledAt,
    int? Function()? failedAt,
    int? Function()? completedAt,
    RunObjectIncompleteDetails? Function()? incompleteDetails,
    String? model,
    String? instructions,
    List<RunObjectTools>? tools,
