...
final class VectorStoreFileBatchObjectFileCounts {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('in_progress') &&
        ...
        json['cancelled'] is num &&
        json.containsKey('total') &&
        json['total'] is num;
  }

  VectorStoreFileBatchObjectFileCounts copyWith({
    int? inProgress,
    int? completed,
    int? failed,
    int? cancelled,
  ...
  @override
  int get hashCode {
    return Object.hash(inProgress, completed, failed, cancelled, total);
  }
