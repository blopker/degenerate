...
///
final class RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailed {
  ...
  factory RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailed.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailed(
      eventId: json['event_id'] as String,
      type:
          RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailedType.fromJson(
            json['type'] as String,
          ),
      itemId: json['item_id'] as String,
      contentIndex: (json['content_index'] as num).toInt(),
      error:
          RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailedError.fromJson(
  ...
  ///
  final RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailedType
  type;
  ...
  @override
  String toString() {
    return 'RealtimeBetaServerEventConversationItemInputAudioTranscriptionFailed(eventId: $eventId, type: $type, itemId: $itemId, contentIndex: $contentIndex, error: $error)';
  }
}
