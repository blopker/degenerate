...
///
final class ResponseMcpCallArgumentsDeltaEvent {
  ...
  factory ResponseMcpCallArgumentsDeltaEvent.fromJson(
    ...
    return ResponseMcpCallArgumentsDeltaEvent(
      type: ResponseMcpCallArgumentsDeltaEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseMcpCallArgumentsDeltaEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, delta: $delta, sequenceNumber: $sequenceNumber)';
  }
}
