...
final class ResponseContentPartAddedEvent {
  ...
  ResponseContentPartAddedEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseContentPartAddedEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, \$part: ${$part}, sequenceNumber: $sequenceNumber)';
  }
}
