...
import 'vector_store_search_request_filters.dart';import 'vector_store_search_request_query.dart';import 'vector_store_search_request_ranking_options.dart';final class VectorStoreSearchRequest {const VectorStoreSearchRequest({required this.query, this.rewriteQuery = false, this.maxNumResults = 10, this.filters, this.rankingOptions, });
