...
///
final class RealtimeServerEventRateLimitsUpdated {
  ...
  factory RealtimeServerEventRateLimitsUpdated.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventRateLimitsUpdated(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventRateLimitsUpdatedType.fromJson(
        json['type'] as String,
      ),
      rateLimits: (json['rate_limits'] as List<dynamic>)
          .map(
            (e) => RealtimeServerEventRateLimitsUpdatedRateLimits.fromJson(
  ...
  RealtimeServerEventRateLimitsUpdated copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventRateLimitsUpdated(eventId: $eventId, type: $type, rateLimits: $rateLimits)';
  }
}
