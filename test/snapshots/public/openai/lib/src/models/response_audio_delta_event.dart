...
final class ResponseAudioDeltaEvent {
  ...
  @override
  int get hashCode {
    return Object.hash(type, sequenceNumber, delta);
  }

  @override
  String toString() {
    return 'ResponseAudioDeltaEvent(type: $type, sequenceNumber: $sequenceNumber, delta: $delta)';
  }
}
