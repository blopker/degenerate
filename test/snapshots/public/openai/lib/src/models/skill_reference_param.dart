...
import 'skill_reference_param_type.dart';final class SkillReferenceParam {const SkillReferenceParam({this.type = SkillReferenceParamType.skillReference, required this.skillId, this.version, });
