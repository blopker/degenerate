...
import 'container_reference_param_type.dart';final class ContainerReferenceParam {const ContainerReferenceParam({this.type = ContainerReferenceParamType.containerReference, required this.containerId, });
