...
import 'delete_thread_response_object.dart';final class DeleteThreadResponse {const DeleteThreadResponse({required this.id, required this.deleted, required this.object, });
