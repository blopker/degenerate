...
final class ResponseCodeInterpreterCallCompletedEvent {
  ...
  factory ResponseCodeInterpreterCallCompletedEvent.fromJson(
    ...
    return ResponseCodeInterpreterCallCompletedEvent(
      type: ResponseCodeInterpreterCallCompletedEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseCodeInterpreterCallCompletedEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
