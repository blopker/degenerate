...
import 'create_completion_request_model.dart';
import 'create_completion_request_prompt.dart';
import 'stop_configuration.dart';

final class CreateCompletionRequest {
  ...
  factory CreateCompletionRequest.fromJson(Map<String, dynamic> json) {
    return CreateCompletionRequest(
      model: CreateCompletionRequestModel.fromJson(
        json['model'] as Map<String, dynamic>,
      ),
      prompt: CreateCompletionRequestPrompt.fromJson(json['prompt']),
      bestOf: json.containsKey('best_of')
          ? (json['best_of'] as num).toInt()
          : 1,
      echo: json.containsKey('echo') ? json['echo'] as bool : false,
      frequencyPenalty: json.containsKey('frequency_penalty')
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('model') && json.containsKey('prompt');
  }

  CreateCompletionRequest copyWith({
    CreateCompletionRequestModel? model,
    CreateCompletionRequestPrompt? Function()? prompt,
    int? Function()? bestOf,
    bool? Function()? echo,
    double? Function()? frequencyPenalty,
    Map<String, int>? Function()? logitBias,
    int? Function()? logprobs,
    int? Function()? maxTokens,
    int? Function()? n,
    double? Function()? presencePenalty,
    int? Function()? seed,
    StopConfiguration Function()? stop,
    bool? Function()? stream,
    ChatCompletionStreamOptions Function()? streamOptions,
