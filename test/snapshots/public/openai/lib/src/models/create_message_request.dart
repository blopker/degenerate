...
import 'create_message_request_attachments2.dart';
import 'create_message_request_content.dart';
...
final class CreateMessageRequest {
  ...
  factory CreateMessageRequest.fromJson(Map<String, dynamic> json) {
    return CreateMessageRequest(
      ...
      attachments: (json['attachments'] as List<dynamic>?)
          ?.map(
            (e) => CreateMessageRequestAttachments2.fromJson(
  ...
  CreateMessageRequest copyWith({
    ...
    List<CreateMessageRequestAttachments2>? Function()? attachments,
