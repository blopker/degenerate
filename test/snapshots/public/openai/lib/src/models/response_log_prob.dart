...
final class ResponseLogProb {
  ...
  factory ResponseLogProb.fromJson(Map<String, dynamic> json) {
    return ResponseLogProb(
      ...
      topLogprobs: (json['top_logprobs'] as List<dynamic>?)
          ?.map(
            (e) =>
                ResponseLogProbTopLogprobs.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
  ...
  ResponseLogProb copyWith({
    String? token,
    double? logprob,
    List<ResponseLogProbTopLogprobs> Function()? topLogprobs,
  }) {
    return ResponseLogProb(
  ...
  @override
  int get hashCode {
    return Object.hash(token, logprob, Object.hashAll(topLogprobs ?? const []));
  }

  @override
  String toString() {
    return 'ResponseLogProb(token: $token, logprob: $logprob, topLogprobs: $topLogprobs)';
  }
}
