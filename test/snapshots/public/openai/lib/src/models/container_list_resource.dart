...
import 'package:collection/collection.dart';import 'container_list_resource_object.dart';import 'container_resource.dart';final class ContainerListResource {const ContainerListResource({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
