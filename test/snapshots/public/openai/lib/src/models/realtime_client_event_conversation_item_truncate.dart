...
/// event.
///
final class RealtimeClientEventConversationItemTruncate {
  ...
  factory RealtimeClientEventConversationItemTruncate.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeClientEventConversationItemTruncate(
      eventId: json['event_id'] as String?,
      type: RealtimeClientEventConversationItemTruncateType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeClientEventConversationItemTruncate copyWith({
  ...
  @override
  String toString() {
    return 'RealtimeClientEventConversationItemTruncate(eventId: $eventId, type: $type, itemId: $itemId, contentIndex: $contentIndex, audioEndMs: $audioEndMs)';
  }
}
