...
///
final class ResponseMcpCallArgumentsDoneEvent {
  ...
  factory ResponseMcpCallArgumentsDoneEvent.fromJson(
    ...
    return ResponseMcpCallArgumentsDoneEvent(
      type: ResponseMcpCallArgumentsDoneEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  int get hashCode {
    return Object.hash(type, outputIndex, itemId, arguments, sequenceNumber);
  }

  @override
  String toString() {
    return 'ResponseMcpCallArgumentsDoneEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, arguments: $arguments, sequenceNumber: $sequenceNumber)';
  }
}
