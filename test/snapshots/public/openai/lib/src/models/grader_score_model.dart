...
final class GraderScoreModel {
  ...
  factory GraderScoreModel.fromJson(Map<String, dynamic> json) {
    return GraderScoreModel(
      ...
      samplingParams: json['sampling_params'] != null
          ? GraderScoreModelSamplingParams.fromJson(
              json['sampling_params'] as Map<String, dynamic>,
            )
          : null,
      input: (json['input'] as List<dynamic>)
          .map((e) => EvalItem.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  GraderScoreModel copyWith({
    GraderScoreModelType? type,
    String? name,
    String? model,
    GraderScoreModelSamplingParams Function()? samplingParams,
    List<EvalItem>? input,
    List<double> Function()? range,
  }) {
    return GraderScoreModel(
      type: type ?? this.type,
      name: name ?? this.name,
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(range ?? const []),
    );
  }

  @override
  String toString() {
    return 'GraderScoreModel(type: $type, name: $name, model: $model, samplingParams: $samplingParams, input: $input, range: $range)';
  }
}
