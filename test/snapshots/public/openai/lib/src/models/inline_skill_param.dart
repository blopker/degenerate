...
import 'inline_skill_param_type.dart';import 'inline_skill_source_param.dart';final class InlineSkillParam {const InlineSkillParam({this.type = InlineSkillParamType.inline, required this.name, required this.description, required this.source, });
