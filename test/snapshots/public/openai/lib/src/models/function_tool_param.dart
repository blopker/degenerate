...
import 'empty_model_param.dart';import 'function_tool_param_type.dart';final class FunctionToolParam {const FunctionToolParam({required this.name, this.description, this.parameters, this.strict, this.type = FunctionToolParamType.function, });
