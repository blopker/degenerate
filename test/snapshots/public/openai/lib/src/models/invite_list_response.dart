...
import 'package:collection/collection.dart';import 'invite.dart';import 'invite_list_response_object.dart';final class InviteListResponse {const InviteListResponse({required this.object, required this.data, this.firstId, this.lastId, this.hasMore, });
