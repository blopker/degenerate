...
import 'package:collection/collection.dart';import 'chat_completion_allowed_tools_mode.dart';/// Constrains the tools available to the model to a pre-defined set.
/// 
...
ChatCompletionAllowedTools copyWith({ChatCompletionAllowedToolsMode? mode, List<Map<String,String>>? tools, }) { return ChatCompletionAllowedTools(
  mode: mode ?? this.mode,
