...
final class RealtimeCallRejectRequest {
  ...
  RealtimeCallRejectRequest copyWith({int Function()? statusCode}) {
    return RealtimeCallRejectRequest(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RealtimeCallRejectRequest && statusCode == other.statusCode;
  }
  ...
  @override
  String toString() {
    return 'RealtimeCallRejectRequest(statusCode: $statusCode)';
  }
}
