...
import 'image_edit_partial_image_event_output_format.dart';
...
///
final class ImageEditPartialImageEvent {
  ...
  factory ImageEditPartialImageEvent.fromJson(Map<String, dynamic> json) {
    return ImageEditPartialImageEvent(
      ...
      quality: ImageEditPartialImageEventQuality.fromJson(
        json['quality'] as String,
      ),
      background: ImageEditPartialImageEventBackground.fromJson(
        json['background'] as String,
      ),
      outputFormat: ImageEditPartialImageEventOutputFormat.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        json.containsKey('b64_json') &&
        json['b64_json'] is String &&
        ...
        json.containsKey('partial_image_index') &&
        json['partial_image_index'] is num;
  }

  ImageEditPartialImageEvent copyWith({
    ...
    ImageEditPartialImageEventOutputFormat? outputFormat,
  ...
  @override
  String toString() {
    return 'ImageEditPartialImageEvent(type: $type, b64Json: $b64Json, createdAt: $createdAt, size: $size, quality: $quality, background: $background, outputFormat: $outputFormat, partialImageIndex: $partialImageIndex)';
  }
}
