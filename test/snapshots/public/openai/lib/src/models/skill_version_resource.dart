...
import 'skill_version_resource_object.dart';final class SkillVersionResource {const SkillVersionResource({this.object = SkillVersionResourceObject.skillVersion, required this.id, required this.skillId, required this.version, required this.createdAt, required this.name, required this.description, });
