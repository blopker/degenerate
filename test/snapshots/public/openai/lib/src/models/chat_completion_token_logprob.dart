...
final class ChatCompletionTokenLogprob {
  ...
  factory ChatCompletionTokenLogprob.fromJson(Map<String, dynamic> json) {
    return ChatCompletionTokenLogprob(
      ...
      topLogprobs: (json['top_logprobs'] as List<dynamic>)
          .map(
            (e) => ChatCompletionTokenLogprobTopLogprobs.fromJson(
  ...
  ChatCompletionTokenLogprob copyWith({
    String? token,
    double? logprob,
  ...
  int get hashCode {
    return Object.hash(
      token,
      logprob,
      Object.hashAll(bytes ?? const []),
      Object.hashAll(topLogprobs),
    );
  }
