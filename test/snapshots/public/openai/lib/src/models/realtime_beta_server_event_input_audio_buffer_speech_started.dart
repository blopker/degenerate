...
import 'realtime_beta_server_event_input_audio_buffer_speech_started_type.dart';/// Sent by the server when in `server_vad` mode to indicate that speech has been
