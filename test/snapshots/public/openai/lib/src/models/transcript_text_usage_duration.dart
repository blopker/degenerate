...
final class TranscriptTextUsageDuration {
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'seconds': seconds};
  }
  ...
  TranscriptTextUsageDuration copyWith({
    TranscriptTextUsageDurationType? type,
    double? seconds,
  }) {
    return TranscriptTextUsageDuration(
      type: type ?? this.type,
  ...
  @override
  int get hashCode {
    return Object.hash(type, seconds);
  }

  @override
  String toString() {
    return 'TranscriptTextUsageDuration(type: $type, seconds: $seconds)';
  }
}
