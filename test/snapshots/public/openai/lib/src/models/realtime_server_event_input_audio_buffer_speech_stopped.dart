...
///
final class RealtimeServerEventInputAudioBufferSpeechStopped {
  ...
  factory RealtimeServerEventInputAudioBufferSpeechStopped.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventInputAudioBufferSpeechStopped(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventInputAudioBufferSpeechStoppedType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventInputAudioBufferSpeechStopped copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventInputAudioBufferSpeechStopped(eventId: $eventId, type: $type, audioEndMs: $audioEndMs, itemId: $itemId)';
  }
}
