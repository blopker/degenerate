...
import 'package:collection/collection.dart';import 'run_step_details_tool_calls_code_object_code_interpreter_outputs.dart';/// The Code Interpreter tool call definition.
...
factory RunStepDetailsToolCallsCodeObjectCodeInterpreter.fromJson(Map<String, dynamic> json) { return RunStepDetailsToolCallsCodeObjectCodeInterpreter(
  ...
  outputs: (json['outputs'] as List<dynamic>).map((e) => RunStepDetailsToolCallsCodeObjectCodeInterpreterOutputs.fromJson(e)).toList(),
); }
