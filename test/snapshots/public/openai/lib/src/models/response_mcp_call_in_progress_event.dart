...
///
final class ResponseMcpCallInProgressEvent {
  ...
  @override
  int get hashCode {
    return Object.hash(type, sequenceNumber, outputIndex, itemId);
  }

  @override
  String toString() {
    return 'ResponseMcpCallInProgressEvent(type: $type, sequenceNumber: $sequenceNumber, outputIndex: $outputIndex, itemId: $itemId)';
  }
}
