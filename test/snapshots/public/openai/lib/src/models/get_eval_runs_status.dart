...
final class GetEvalRunsStatus {
  const GetEvalRunsStatus._(this.value);

  factory GetEvalRunsStatus.fromJson(String json) {
    return switch (json) {
      'queued' => queued,
  ...
  static const GetEvalRunsStatus inProgress = GetEvalRunsStatus._(
    'in_progress',
  );
  ...
  static const List<GetEvalRunsStatus> values = [
    queued,
    inProgress,
    completed,
    canceled,
  ...
  @override
  String toString() {
    return 'GetEvalRunsStatus($value)';
  }
}
