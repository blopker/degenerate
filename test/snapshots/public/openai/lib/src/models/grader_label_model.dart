...
final class GraderLabelModel {
  ...
  factory GraderLabelModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'GraderLabelModel(type: $type, name: $name, model: $model, input: $input, labels: $labels, passingLabels: $passingLabels)';
  }
}
