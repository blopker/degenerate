...
final class SpeechAudioDeltaEvent {
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'audio': audio};
  }
  ...
  SpeechAudioDeltaEvent copyWith({
    SpeechAudioDeltaEventType? type,
    String? audio,
  }) {
    return SpeechAudioDeltaEvent(
      type: type ?? this.type,
  ...
  @override
  int get hashCode {
    return Object.hash(type, audio);
  }

  @override
  String toString() {
    return 'SpeechAudioDeltaEvent(type: $type, audio: $audio)';
  }
}
