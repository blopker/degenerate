...
///
final class ChatCompletionRequestMessageContentPartText {
  ...
  ChatCompletionRequestMessageContentPartText copyWith({
    String? type,
    String? text,
  }) {
    return ChatCompletionRequestMessageContentPartText(
  ...
  @override
  String toString() {
    return 'ChatCompletionRequestMessageContentPartText(type: $type, text: $text)';
  }
}
