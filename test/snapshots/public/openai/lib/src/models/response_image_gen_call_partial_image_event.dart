...
///
final class ResponseImageGenCallPartialImageEvent {
  ...
  factory ResponseImageGenCallPartialImageEvent.fromJson(
    Map<String, dynamic> json,
  ) {
    return ResponseImageGenCallPartialImageEvent(
      type: ResponseImageGenCallPartialImageEventType.fromJson(
        json['type'] as String,
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        ...
        json.containsKey('partial_image_b64') &&
        json['partial_image_b64'] is String;
  }

  ResponseImageGenCallPartialImageEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseImageGenCallPartialImageEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber, partialImageIndex: $partialImageIndex, partialImageB64: $partialImageB64)';
  }
}
