...
final class MessageContentImageFileObject {
  ...
  factory MessageContentImageFileObject.fromJson(Map<String, dynamic> json) {
    return MessageContentImageFileObject(
      ...
      imageFile: MessageContentImageFileObjectImageFile.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'image_file': imageFile.toJson()};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('image_file');
  }

  MessageContentImageFileObject copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, imageFile);
  }

  @override
  String toString() {
    return 'MessageContentImageFileObject(type: $type, imageFile: $imageFile)';
  }
}
