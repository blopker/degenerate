...
import 'package:collection/collection.dart';import 'project_user.dart';final class ProjectUserListResponse {const ProjectUserListResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
