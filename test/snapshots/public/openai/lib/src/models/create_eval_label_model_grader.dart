...
import 'package:collection/collection.dart';import 'create_eval_item.dart';import 'create_eval_label_model_grader_type.dart';/// A LabelModelGrader object which uses a model to assign labels to each item
/// in the evaluation.
/// 
...
factory CreateEvalLabelModelGrader.fromJson(Map<String, dynamic> json) { return CreateEvalLabelModelGrader(
  ...
  input: (json['input'] as List<dynamic>).map((e) => CreateEvalItem.fromJson(e as Map<String, dynamic>)).toList(),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CreateEvalLabelModelGrader &&
          ...
          const ListEquality<dynamic>().equals(passingLabels, other.passingLabels); } 
