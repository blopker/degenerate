...
/// in the evaluation.
///
final class CreateEvalLabelModelGrader {
  ...
  factory CreateEvalLabelModelGrader.fromJson(Map<String, dynamic> json) {
    return CreateEvalLabelModelGrader(
      type: CreateEvalLabelModelGraderType.fromJson(json['type'] as String),
      name: json['name'] as String,
      model: json['model'] as String,
      input: (json['input'] as List<dynamic>)
          .map((e) => CreateEvalItem.fromJson(e as Map<String, dynamic>))
          .toList(),
      labels: (json['labels'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      passingLabels: (json['passing_labels'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
    );
  }
  ...
  CreateEvalLabelModelGrader copyWith({
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(passingLabels),
    );
  }

  @override
  String toString() {
    return 'CreateEvalLabelModelGrader(type: $type, name: $name, model: $model, input: $input, labels: $labels, passingLabels: $passingLabels)';
  }
}
