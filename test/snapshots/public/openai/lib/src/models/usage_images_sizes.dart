...
final class UsageImagesSizes {
  const UsageImagesSizes._(this.value);

  factory UsageImagesSizes.fromJson(String json) {
    return switch (json) {
      '256x256' => $256x256,
      '512x512' => $512x512,
      '1024x1024' => $1024x1024,
  ...
  static const List<UsageImagesSizes> values = [
    $256x256,
    $512x512,
    $1024x1024,
    $1792x1792,
