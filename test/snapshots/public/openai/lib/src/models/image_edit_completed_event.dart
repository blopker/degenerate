...
import 'image_edit_completed_event_output_format.dart';
...
///
final class ImageEditCompletedEvent {
  ...
  factory ImageEditCompletedEvent.fromJson(Map<String, dynamic> json) {
    return ImageEditCompletedEvent(
      ...
      quality: ImageEditCompletedEventQuality.fromJson(
        json['quality'] as String,
      ),
      background: ImageEditCompletedEventBackground.fromJson(
        json['background'] as String,
      ),
      outputFormat: ImageEditCompletedEventOutputFormat.fromJson(
  ...
  ImageEditCompletedEvent copyWith({
    ...
    ImageEditCompletedEventOutputFormat? outputFormat,
    ImagesUsage? usage,
  }) {
    return ImageEditCompletedEvent(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'ImageEditCompletedEvent(type: $type, b64Json: $b64Json, createdAt: $createdAt, size: $size, quality: $quality, background: $background, outputFormat: $outputFormat, usage: $usage)';
  }
}
