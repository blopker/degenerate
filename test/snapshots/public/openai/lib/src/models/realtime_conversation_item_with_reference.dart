...
import 'realtime_conversation_item_with_reference_object.dart';
...
final class RealtimeConversationItemWithReference {
  ...
  factory RealtimeConversationItemWithReference.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeConversationItemWithReference(
      id: json['id'] as String?,
      type: json['type'] != null
          ? RealtimeConversationItemWithReferenceType.fromJson(
              json['type'] as String,
            )
          : null,
      object: json['object'] != null
          ? RealtimeConversationItemWithReferenceObject.fromJson(
              json['object'] as String,
            )
          : null,
      status: json['status'] != null
          ? RealtimeConversationItemWithReferenceStatus.fromJson(
              json['status'] as String,
            )
          : null,
      role: json['role'] != null
          ? RealtimeConversationItemWithReferenceRole.fromJson(
              json['role'] as String,
            )
          : null,
      content: (json['content'] as List<dynamic>?)
          ?.map(
            (e) => RealtimeConversationItemWithReferenceContent.fromJson(
  ...
  RealtimeConversationItemWithReference copyWith({
    String Function()? id,
    RealtimeConversationItemWithReferenceType Function()? type,
    RealtimeConversationItemWithReferenceObject Function()? object,
    RealtimeConversationItemWithReferenceStatus Function()? status,
    RealtimeConversationItemWithReferenceRole Function()? role,
    List<RealtimeConversationItemWithReferenceContent> Function()? content,
  ...
  @override
  String toString() {
    return 'RealtimeConversationItemWithReference(id: $id, type: $type, object: $object, status: $status, role: $role, content: $content, callId: $callId, name: $name, arguments: $arguments, output: $output)';
  }
}
