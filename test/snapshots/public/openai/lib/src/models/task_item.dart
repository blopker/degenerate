...
final class TaskItem {
  const TaskItem({
    required this.id,
    this.object = TaskItemObject.chatkitThreadItem,
    required this.createdAt,
    required this.threadId,
    this.type = 'chatkit.task',
  ...
  @override
  String toString() {
    return 'TaskItem(id: $id, object: $object, createdAt: $createdAt, threadId: $threadId, type: $type, taskType: $taskType, heading: $heading, summary: $summary)';
  }
}
