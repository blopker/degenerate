...
import 'create_moderation_request_input.dart';
import 'create_moderation_request_model.dart';

final class CreateModerationRequest {
  ...
  factory CreateModerationRequest.fromJson(Map<String, dynamic> json) {
    return CreateModerationRequest(
      ...
      model: json['model'] != null
          ? CreateModerationRequestModel.fromJson(
  ...
  CreateModerationRequest copyWith({
    CreateModerationRequestInput? input,
    CreateModerationRequestModel Function()? model,
  }) {
    return CreateModerationRequest(
  ...
  @override
  int get hashCode {
    return Object.hash(input, model);
  }
