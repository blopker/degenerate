...
import 'package:collection/collection.dart';import 'transcript_text_done_event_logprobs.dart';import 'transcript_text_done_event_type.dart';import 'transcript_text_usage_tokens.dart';/// Emitted when the transcription is complete. Contains the complete transcription text. Only emitted when you [create a transcription](/docs/api-reference/audio/create-transcription) with the `Stream` parameter set to `true`.
