...
final class TranscriptTextDoneEvent {
  ...
  factory TranscriptTextDoneEvent.fromJson(Map<String, dynamic> json) {
    return TranscriptTextDoneEvent(
      ...
      logprobs: (json['logprobs'] as List<dynamic>?)
          ?.map(
            (e) => TranscriptTextDoneEventLogprobs.fromJson(
  ...
  TranscriptTextDoneEvent copyWith({
    ...
    String? text,
    List<TranscriptTextDoneEventLogprobs> Function()? logprobs,
    TranscriptTextUsageTokens Function()? usage,
  }) {
    return TranscriptTextDoneEvent(
      type: type ?? this.type,
      text: text ?? this.text,
  ...
  @override
  int get hashCode {
    return Object.hash(type, text, Object.hashAll(logprobs ?? const []), usage);
  }

  @override
  String toString() {
    return 'TranscriptTextDoneEvent(type: $type, text: $text, logprobs: $logprobs, usage: $usage)';
  }
}
