...
final class StaticChunkingStrategyRequestParam {
  ...
  Map<String, dynamic> toJson() {
    return {'type': type, 'static': $static.toJson()};
  }
  ...
  StaticChunkingStrategyRequestParam copyWith({
    String? type,
  ...
  @override
  String toString() {
    return 'StaticChunkingStrategyRequestParam(type: $type, \$static: ${$static})';
  }
}
