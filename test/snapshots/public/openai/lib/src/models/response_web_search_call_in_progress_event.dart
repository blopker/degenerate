...
final class ResponseWebSearchCallInProgressEvent {
  ...
  factory ResponseWebSearchCallInProgressEvent.fromJson(
    ...
    return ResponseWebSearchCallInProgressEvent(
      type: ResponseWebSearchCallInProgressEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseWebSearchCallInProgressEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
