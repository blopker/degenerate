...
final class ResponseWebSearchCallSearchingEvent {
  ...
  factory ResponseWebSearchCallSearchingEvent.fromJson(
    ...
    return ResponseWebSearchCallSearchingEvent(
      type: ResponseWebSearchCallSearchingEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseWebSearchCallSearchingEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
