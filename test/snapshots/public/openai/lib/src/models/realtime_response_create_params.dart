...
import 'realtime_response_create_params_conversation.dart';
import 'realtime_response_create_params_max_output_tokens.dart';
import 'realtime_response_create_params_output_modalities.dart';
import 'realtime_response_create_params_tool_choice.dart';
import 'realtime_response_create_params_tools.dart';

/// Create a new Realtime response with these parameters
final class RealtimeResponseCreateParams {
  ...
  factory RealtimeResponseCreateParams.fromJson(Map<String, dynamic> json) {
    return RealtimeResponseCreateParams(
      outputModalities: (json['output_modalities'] as List<dynamic>?)
          ?.map(
            (e) => RealtimeResponseCreateParamsOutputModalities.fromJson(
              e as String,
            ),
          )
          .toList(),
      ...
      audio: json['audio'] != null
          ? RealtimeResponseCreateParamsAudio.fromJson(
              json['audio'] as Map<String, dynamic>,
            )
          : null,
      tools: (json['tools'] as List<dynamic>?)
          ?.map((e) => RealtimeResponseCreateParamsTools.fromJson(e))
          .toList(),
      toolChoice: json['tool_choice'] != null
          ? RealtimeResponseCreateParamsToolChoice.fromJson(json['tool_choice'])
          : null,
      maxOutputTokens: json['max_output_tokens'] != null
          ? RealtimeResponseCreateParamsMaxOutputTokens.fromJson(
              json['max_output_tokens'],
            )
          : null,
      conversation: json['conversation'] != null
          ? RealtimeResponseCreateParamsConversation.fromJson(
              json['conversation'],
            )
          : null,
  ...
  RealtimeResponseCreateParams copyWith({
    List<RealtimeResponseCreateParamsOutputModalities> Function()?
    outputModalities,
    String Function()? instructions,
    RealtimeResponseCreateParamsAudio Function()? audio,
    List<RealtimeResponseCreateParamsTools> Function()? tools,
    RealtimeResponseCreateParamsToolChoice Function()? toolChoice,
    RealtimeResponseCreateParamsMaxOutputTokens Function()? maxOutputTokens,
    RealtimeResponseCreateParamsConversation Function()? conversation,
  ...
  @override
  String toString() {
    return 'RealtimeResponseCreateParams(outputModalities: $outputModalities, instructions: $instructions, audio: $audio, tools: $tools, toolChoice: $toolChoice, maxOutputTokens: $maxOutputTokens, conversation: $conversation, metadata: $metadata, prompt: $prompt, input: $input)';
  }
}
