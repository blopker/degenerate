...
final class ResponseContentPartDoneEvent {
  ...
  ResponseContentPartDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseContentPartDoneEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, sequenceNumber: $sequenceNumber, \$part: ${$part})';
  }
}
