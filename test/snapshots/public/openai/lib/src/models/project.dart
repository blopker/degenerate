...
final class Project {
  ...
  @override
  int get hashCode {
    return Object.hash(id, object, name, createdAt, archivedAt, status);
  }

  @override
  String toString() {
    return 'Project(id: $id, object: $object, name: $name, createdAt: $createdAt, archivedAt: $archivedAt, status: $status)';
  }
}
