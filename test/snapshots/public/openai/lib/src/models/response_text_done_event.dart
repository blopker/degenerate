...
final class ResponseTextDoneEvent {
  ...
  ResponseTextDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseTextDoneEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, text: $text, sequenceNumber: $sequenceNumber, logprobs: $logprobs)';
  }
}
