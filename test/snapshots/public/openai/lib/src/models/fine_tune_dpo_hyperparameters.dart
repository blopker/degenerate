...
import 'fine_tune_dpo_hyperparameters_batch_size.dart';
import 'fine_tune_dpo_hyperparameters_beta.dart';
import 'fine_tune_dpo_hyperparameters_learning_rate_multiplier.dart';
import 'fine_tune_dpo_hyperparameters_n_epochs.dart';

/// The hyperparameters used for the DPO fine-tuning job.
final class FineTuneDpoHyperparameters {
  ...
  factory FineTuneDpoHyperparameters.fromJson(Map<String, dynamic> json) {
    return FineTuneDpoHyperparameters(
      ...
      learningRateMultiplier: json['learning_rate_multiplier'] != null
          ? FineTuneDpoHyperparametersLearningRateMultiplier.fromJson(
  ...
  FineTuneDpoHyperparameters copyWith({
    FineTuneDpoHyperparametersBeta Function()? beta,
    FineTuneDpoHyperparametersBatchSize Function()? batchSize,
    FineTuneDpoHyperparametersLearningRateMultiplier Function()?
    learningRateMultiplier,
    FineTuneDpoHyperparametersNEpochs Function()? nEpochs,
  }) {
    return FineTuneDpoHyperparameters(
  ...
  @override
  int get hashCode {
    return Object.hash(beta, batchSize, learningRateMultiplier, nEpochs);
  }

  @override
  String toString() {
    return 'FineTuneDpoHyperparameters(beta: $beta, batchSize: $batchSize, learningRateMultiplier: $learningRateMultiplier, nEpochs: $nEpochs)';
  }
}
