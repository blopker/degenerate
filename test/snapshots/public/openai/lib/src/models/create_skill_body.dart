...
import 'create_skill_body_files.dart';/// Uploads a skill either as a directory (multipart `files[]`) or as a single zip file.
...
factory CreateSkillBody.fromJson(Map<String, dynamic> json) { return CreateSkillBody(
  files: CreateSkillBodyFiles.fromJson(json['files']),
); }
