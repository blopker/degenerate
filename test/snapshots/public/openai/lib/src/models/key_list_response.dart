...
import 'package:collection/collection.dart';import 'key3.dart';import 'key_list_response_object.dart';final class KeyListResponse {const KeyListResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
