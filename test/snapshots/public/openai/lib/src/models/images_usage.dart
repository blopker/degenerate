...
final class ImagesUsage {
  ...
  ImagesUsage copyWith({
    int? totalTokens,
    int? inputTokens,
    int? outputTokens,
    ImagesUsageInputTokensDetails? inputTokensDetails,
  }) {
    return ImagesUsage(
  ...
  @override
  String toString() {
    return 'ImagesUsage(totalTokens: $totalTokens, inputTokens: $inputTokens, outputTokens: $outputTokens, inputTokensDetails: $inputTokensDetails)';
  }
}
