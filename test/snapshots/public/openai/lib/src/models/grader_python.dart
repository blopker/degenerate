...
final class GraderPython {
  ...
  factory GraderPython.fromJson(Map<String, dynamic> json) {
    return GraderPython(
  ...
  GraderPython copyWith({
    GraderPythonType? type,
    String? name,
    String? source,
    String Function()? imageTag,
  }) {
    return GraderPython(
      type: type ?? this.type,
      name: name ?? this.name,
  ...
  @override
  int get hashCode {
    return Object.hash(type, name, source, imageTag);
  }

  @override
  String toString() {
    return 'GraderPython(type: $type, name: $name, source: $source, imageTag: $imageTag)';
  }
}
