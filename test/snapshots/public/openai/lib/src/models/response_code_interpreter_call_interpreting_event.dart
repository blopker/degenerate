...
final class ResponseCodeInterpreterCallInterpretingEvent {
  ...
  factory ResponseCodeInterpreterCallInterpretingEvent.fromJson(
    ...
    return ResponseCodeInterpreterCallInterpretingEvent(
      type: ResponseCodeInterpreterCallInterpretingEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  String toString() {
    return 'ResponseCodeInterpreterCallInterpretingEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, sequenceNumber: $sequenceNumber)';
  }
}
