...
final class MessageContentTextAnnotationsFileCitationObject {
  ...
  factory MessageContentTextAnnotationsFileCitationObject.fromJson(
    ...
    return MessageContentTextAnnotationsFileCitationObject(
      type: MessageContentTextAnnotationsFileCitationObjectType.fromJson(
        json['type'] as String,
      ),
      text: json['text'] as String,
      fileCitation:
          MessageContentTextAnnotationsFileCitationObjectFileCitation.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        ...
        json['start_index'] is num &&
        json.containsKey('end_index') &&
        json['end_index'] is num;
  }

  MessageContentTextAnnotationsFileCitationObject copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, text, fileCitation, startIndex, endIndex);
  }

  @override
  String toString() {
    return 'MessageContentTextAnnotationsFileCitationObject(type: $type, text: $text, fileCitation: $fileCitation, startIndex: $startIndex, endIndex: $endIndex)';
  }
}
