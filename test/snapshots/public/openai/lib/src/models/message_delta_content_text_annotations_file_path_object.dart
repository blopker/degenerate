...
final class MessageDeltaContentTextAnnotationsFilePathObject {
  ...
  factory MessageDeltaContentTextAnnotationsFilePathObject.fromJson(
    ...
    return MessageDeltaContentTextAnnotationsFilePathObject(
      ...
      type: MessageDeltaContentTextAnnotationsFilePathObjectType.fromJson(
        json['type'] as String,
      ),
  ...
  MessageDeltaContentTextAnnotationsFilePathObject copyWith({
    int? index,
    MessageDeltaContentTextAnnotationsFilePathObjectType? type,
    String Function()? text,
    MessageDeltaContentTextAnnotationsFilePathObjectFilePath Function()?
    filePath,
  ...
  @override
  int get hashCode {
    return Object.hash(index, type, text, filePath, startIndex, endIndex);
  }

  @override
  String toString() {
    return 'MessageDeltaContentTextAnnotationsFilePathObject(index: $index, type: $type, text: $text, filePath: $filePath, startIndex: $startIndex, endIndex: $endIndex)';
  }
}
