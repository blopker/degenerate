...
import 'list_fine_tuning_job_events_response_object.dart';

final class ListFineTuningJobEventsResponse {
  ...
  factory ListFineTuningJobEventsResponse.fromJson(Map<String, dynamic> json) {
    return ListFineTuningJobEventsResponse(
      data: (json['data'] as List<dynamic>)
          ...
          .toList(),
      object: ListFineTuningJobEventsResponseObject.fromJson(
  ...
  ListFineTuningJobEventsResponse copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(Object.hashAll(data), object, hasMore);
  }

  @override
  String toString() {
    return 'ListFineTuningJobEventsResponse(data: $data, object: $object, hasMore: $hasMore)';
  }
}
