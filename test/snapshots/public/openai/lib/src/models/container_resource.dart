...
import 'container_resource_memory_limit.dart';
import 'container_resource_network_policy.dart';
...
final class ContainerResource {
  ...
  factory ContainerResource.fromJson(Map<String, dynamic> json) {
  ...
  ContainerResource copyWith({
    ...
    ContainerResourceExpiresAfter Function()? expiresAfter,
    ContainerResourceMemoryLimit Function()? memoryLimit,
    ContainerResourceNetworkPolicy Function()? networkPolicy,
  }) {
    return ContainerResource(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'ContainerResource(id: $id, object: $object, name: $name, createdAt: $createdAt, status: $status, lastActiveAt: $lastActiveAt, expiresAfter: $expiresAfter, memoryLimit: $memoryLimit, networkPolicy: $networkPolicy)';
  }
}
