...
final class InputTextContentParam {
  const InputTextContentParam({
    this.type = InputTextContentParamType.inputText,
    required this.text,
  });

  factory InputTextContentParam.fromJson(Map<String, dynamic> json) {
  ...
  InputTextContentParam copyWith({
    InputTextContentParamType? type,
    String? text,
  }) {
    return InputTextContentParam(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'InputTextContentParam(type: $type, text: $text)';
  }
}
