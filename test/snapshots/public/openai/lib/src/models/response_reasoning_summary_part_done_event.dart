...
final class ResponseReasoningSummaryPartDoneEvent {
  ...
  factory ResponseReasoningSummaryPartDoneEvent.fromJson(
    Map<String, dynamic> json,
  ) {
    return ResponseReasoningSummaryPartDoneEvent(
      type: ResponseReasoningSummaryPartDoneEventType.fromJson(
        json['type'] as String,
      ),
  ...
  ResponseReasoningSummaryPartDoneEvent copyWith({
    ResponseReasoningSummaryPartDoneEventType? type,
    String? itemId,
    int? outputIndex,
    int? summaryIndex,
    int? sequenceNumber,
    ResponseReasoningSummaryPartDoneEventPart? $part,
  }) {
    return ResponseReasoningSummaryPartDoneEvent(
      type: type ?? this.type,
  ...
  @override
  String toString() {
    return 'ResponseReasoningSummaryPartDoneEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, summaryIndex: $summaryIndex, sequenceNumber: $sequenceNumber, \$part: ${$part})';
  }
}
