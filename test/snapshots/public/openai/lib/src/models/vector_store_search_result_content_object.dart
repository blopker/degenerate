...
import 'vector_store_search_result_content_object_type.dart';final class VectorStoreSearchResultContentObject {const VectorStoreSearchResultContentObject({required this.type, required this.text, });
