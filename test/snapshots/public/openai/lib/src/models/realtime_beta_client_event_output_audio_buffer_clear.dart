...
import 'realtime_beta_client_event_output_audio_buffer_clear_type.dart';/// **WebRTC/SIP Only:** Emit to cut off the current audio response. This will trigger the server to
