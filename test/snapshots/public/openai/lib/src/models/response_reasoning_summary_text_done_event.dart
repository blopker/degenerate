...
final class ResponseReasoningSummaryTextDoneEvent {
  ...
  factory ResponseReasoningSummaryTextDoneEvent.fromJson(
    Map<String, dynamic> json,
  ) {
    return ResponseReasoningSummaryTextDoneEvent(
      type: ResponseReasoningSummaryTextDoneEventType.fromJson(
        json['type'] as String,
      ),
  ...
  ResponseReasoningSummaryTextDoneEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseReasoningSummaryTextDoneEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, summaryIndex: $summaryIndex, text: $text, sequenceNumber: $sequenceNumber)';
  }
}
