...
final class ResponseCodeInterpreterCallCodeDeltaEvent {
  ...
  factory ResponseCodeInterpreterCallCodeDeltaEvent.fromJson(
    ...
    return ResponseCodeInterpreterCallCodeDeltaEvent(
      type: ResponseCodeInterpreterCallCodeDeltaEventType.fromJson(
        json['type'] as String,
      ),
  ...
  @override
  int get hashCode {
    return Object.hash(type, outputIndex, itemId, delta, sequenceNumber);
  }

  @override
  String toString() {
    return 'ResponseCodeInterpreterCallCodeDeltaEvent(type: $type, outputIndex: $outputIndex, itemId: $itemId, delta: $delta, sequenceNumber: $sequenceNumber)';
  }
}
