...
import 'run_step_object_object.dart';
import 'run_step_object_status.dart';
import 'run_step_object_step_details.dart';
import 'run_step_object_type.dart';

/// Represents a step in execution of a run.
///
final class RunStepObject {
  const RunStepObject({
    required this.id,
  ...
  factory RunStepObject.fromJson(Map<String, dynamic> json) {
    return RunStepObject(
      ...
      lastError: RunStepObjectLastError.fromJson(
      ...
      usage: RunStepCompletionUsage.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('expired_at') &&
        json['expired_at'] is num &&
  ...
  RunStepObject copyWith({
    ...
    RunStepObjectLastError? Function()? lastError,
    int? Function()? expiredAt,
