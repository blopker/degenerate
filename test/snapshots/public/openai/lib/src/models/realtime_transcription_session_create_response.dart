...
///
final class RealtimeTranscriptionSessionCreateResponse {
  ...
  factory RealtimeTranscriptionSessionCreateResponse.fromJson(
    ...
    return RealtimeTranscriptionSessionCreateResponse(
      clientSecret:
          RealtimeTranscriptionSessionCreateResponseClientSecret.fromJson(
      ...
      turnDetection: json['turn_detection'] != null
          ? RealtimeTranscriptionSessionCreateResponseTurnDetection.fromJson(
  ...
  RealtimeTranscriptionSessionCreateResponse copyWith({
    ...
    RealtimeTranscriptionSessionCreateResponseTurnDetection Function()?
    turnDetection,
  }) {
    return RealtimeTranscriptionSessionCreateResponse(
  ...
  @override
  String toString() {
    return 'RealtimeTranscriptionSessionCreateResponse(clientSecret: $clientSecret, modalities: $modalities, inputAudioFormat: $inputAudioFormat, inputAudioTranscription: $inputAudioTranscription, turnDetection: $turnDetection)';
  }
}
