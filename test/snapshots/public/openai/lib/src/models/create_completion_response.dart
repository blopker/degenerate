...
import 'create_completion_response_object.dart';

/// Represents a completion response from the API. Note: both the streamed and non-streamed response objects share the same shape (unlike the chat endpoint).
///
final class CreateCompletionResponse {
  ...
  factory CreateCompletionResponse.fromJson(Map<String, dynamic> json) {
    return CreateCompletionResponse(
      ...
      choices: (json['choices'] as List<dynamic>)
          .map(
            (e) => CreateCompletionResponseChoices.fromJson(
  ...
  CreateCompletionResponse copyWith({
    String? id,
