...
///
final class ResponseFormatJsonSchema {
  ...
  factory ResponseFormatJsonSchema.fromJson(Map<String, dynamic> json) {
    return ResponseFormatJsonSchema(
      ...
      jsonSchema: ResponseFormatJsonSchemaJsonSchema.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {'type': type.toJson(), 'json_schema': jsonSchema.toJson()};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') && json.containsKey('json_schema');
  }

  ResponseFormatJsonSchema copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, jsonSchema);
  }

  @override
  String toString() {
    return 'ResponseFormatJsonSchema(type: $type, jsonSchema: $jsonSchema)';
  }
}
