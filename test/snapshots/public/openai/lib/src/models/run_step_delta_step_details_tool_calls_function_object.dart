...
final class RunStepDeltaStepDetailsToolCallsFunctionObject {
  ...
  factory RunStepDeltaStepDetailsToolCallsFunctionObject.fromJson(
    ...
    return RunStepDeltaStepDetailsToolCallsFunctionObject(
      ...
      type: RunStepDeltaStepDetailsToolCallsFunctionObjectType.fromJson(
        json['type'] as String,
      ),
      function: json['function'] != null
          ? RunStepDeltaStepDetailsToolCallsFunctionObjectFunction.fromJson(
  ...
  RunStepDeltaStepDetailsToolCallsFunctionObject copyWith({
    int? index,
    String Function()? id,
    RunStepDeltaStepDetailsToolCallsFunctionObjectType? type,
    RunStepDeltaStepDetailsToolCallsFunctionObjectFunction Function()? function,
  }) {
    return RunStepDeltaStepDetailsToolCallsFunctionObject(
  ...
  @override
  String toString() {
    return 'RunStepDeltaStepDetailsToolCallsFunctionObject(index: $index, id: $id, type: $type, function: $function)';
  }
}
