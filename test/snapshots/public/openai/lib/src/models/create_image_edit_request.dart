...
import 'dart:convert';import 'dart:typed_data';import 'create_image_edit_request_background.dart';import 'create_image_edit_request_image.dart';import 'create_image_edit_request_model.dart';import 'create_image_edit_request_output_format.dart';import 'create_image_edit_request_quality.dart';import 'create_image_edit_request_response_format.dart';import 'create_image_edit_request_size.dart';import 'input_fidelity.dart';final class CreateImageEditRequest {const CreateImageEditRequest({required this.image, required this.prompt, this.mask, this.background = CreateImageEditRequestBackground.auto, this.model, this.n = 1, this.size = CreateImageEditRequestSize.$1024x1024, this.responseFormat, this.outputFormat = CreateImageEditRequestOutputFormat.png, this.outputCompression = 100, this.user, this.inputFidelity, this.stream = false, this.partialImages, this.quality = CreateImageEditRequestQuality.auto, });
...
CreateImageEditRequest copyWith({CreateImageEditRequestImage? image, String? prompt, Uint8List Function()? mask, CreateImageEditRequestBackground? Function()? background, CreateImageEditRequestModel? Function()? model, int? Function()? n, CreateImageEditRequestSize? Function()? size, CreateImageEditRequestResponseFormat? Function()? responseFormat, CreateImageEditRequestOutputFormat? Function()? outputFormat, int? Function()? outputCompression, String Function()? user, InputFidelity? Function()? inputFidelity, bool? Function()? stream, int? Function()? partialImages, CreateImageEditRequestQuality? Function()? quality, }) { return CreateImageEditRequest(
