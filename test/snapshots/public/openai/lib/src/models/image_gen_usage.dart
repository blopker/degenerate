...
import 'image_gen_output_tokens_details.dart';

/// For `gpt-image-1` only, the token usage information for the image generation.
final class ImageGenUsage {
  const ImageGenUsage({
  ...
  factory ImageGenUsage.fromJson(Map<String, dynamic> json) {
    return ImageGenUsage(
      ...
      outputTokensDetails: json['output_tokens_details'] != null
          ? ImageGenOutputTokensDetails.fromJson(
              json['output_tokens_details'] as Map<String, dynamic>,
            )
          : null,
      inputTokensDetails: ImageGenInputUsageDetails.fromJson(
  ...
  @override
  String toString() {
    return 'ImageGenUsage(inputTokens: $inputTokens, totalTokens: $totalTokens, outputTokens: $outputTokens, outputTokensDetails: $outputTokensDetails, inputTokensDetails: $inputTokensDetails)';
  }
}
