...
final class Upload {
  ...
  factory Upload.fromJson(Map<String, dynamic> json) {
    return Upload(
      ...
      object: json['object'] != null
          ? UploadObject.fromJson(json['object'] as String)
          : null,
      file: json['file'] != null
  ...
  @override
  String toString() {
    return 'Upload(id: $id, createdAt: $createdAt, filename: $filename, bytes: $bytes, purpose: $purpose, status: $status, expiresAt: $expiresAt, object: $object, file: $file)';
  }
}
