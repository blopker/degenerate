...
final class CreateConversationBody {
  ...
  CreateConversationBody copyWith({
    Map<String, String>? Function()? metadata,
    List<InputItem>? Function()? items,
  }) {
    return CreateConversationBody(
  ...
  @override
  int get hashCode {
    return Object.hash(metadata, Object.hashAll(items ?? const []));
  }

  @override
  String toString() {
    return 'CreateConversationBody(metadata: $metadata, items: $items)';
  }
}
