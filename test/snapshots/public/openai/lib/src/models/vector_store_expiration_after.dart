...
final class VectorStoreExpirationAfter {
  ...
  factory VectorStoreExpirationAfter.fromJson(Map<String, dynamic> json) {
    return VectorStoreExpirationAfter(
      anchor: VectorStoreExpirationAfterAnchor.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {'anchor': anchor.toJson(), 'days': days};
  }
  ...
  VectorStoreExpirationAfter copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(anchor, days);
  }
