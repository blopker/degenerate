...
final class CreateVoiceConsentRequest {
  const CreateVoiceConsentRequest({
    required this.name,
    required this.recording,
    required this.language,
  });

  factory CreateVoiceConsentRequest.fromJson(Map<String, dynamic> json) {
    return CreateVoiceConsentRequest(
  ...
  CreateVoiceConsentRequest copyWith({
    String? name,
    Uint8List? recording,
    String? language,
  }) {
  ...
  @override
  int get hashCode {
    return Object.hash(name, recording, language);
  }

  @override
  String toString() {
    return 'CreateVoiceConsentRequest(name: $name, recording: $recording, language: $language)';
  }
}
