...
final class InlineObject52 {
  const InlineObject52({this.always, this.never});
  ...
  InlineObject52 copyWith({
    McpToolFilter Function()? always,
    McpToolFilter Function()? never,
  }) {
    return InlineObject52(
  ...
  @override
  int get hashCode {
    return Object.hash(always, never);
  }

  @override
  String toString() {
    return 'InlineObject52(always: $always, never: $never)';
  }
}
