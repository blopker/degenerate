...
import 'chunking_strategy_request_param.dart';import 'inline_object110.dart';final class CreateVectorStoreFileRequest {const CreateVectorStoreFileRequest({required this.fileId, this.chunkingStrategy, this.attributes, });
...
CreateVectorStoreFileRequest copyWith({String? fileId, ChunkingStrategyRequestParam Function()? chunkingStrategy, Map<String, InlineObject110>? Function()? attributes, }) { return CreateVectorStoreFileRequest(
