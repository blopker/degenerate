...
final class CreateTranscriptionResponseVerboseJson {
  ...
  factory CreateTranscriptionResponseVerboseJson.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('language') &&
  ...
  CreateTranscriptionResponseVerboseJson copyWith({
    String? language,
    double? duration,
    String? text,
    List<TranscriptionWord> Function()? words,
    List<TranscriptionSegment> Function()? segments,
    TranscriptTextUsageDuration Function()? usage,
  }) {
    return CreateTranscriptionResponseVerboseJson(
  ...
  @override
  String toString() {
    return 'CreateTranscriptionResponseVerboseJson(language: $language, duration: $duration, text: $text, words: $words, segments: $segments, usage: $usage)';
  }
}
