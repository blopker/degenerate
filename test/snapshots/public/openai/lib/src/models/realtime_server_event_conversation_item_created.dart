...
///     to the Conversation.
///
final class RealtimeServerEventConversationItemCreated {
  ...
  factory RealtimeServerEventConversationItemCreated.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventConversationItemCreated(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventConversationItemCreatedType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventConversationItemCreated copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventConversationItemCreated(eventId: $eventId, type: $type, previousItemId: $previousItemId, item: $item)';
  }
}
