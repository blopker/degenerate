...
final class AssistantToolsFileSearch {
  const AssistantToolsFileSearch({required this.type, this.fileSearch});
  ...
  AssistantToolsFileSearch copyWith({
    AssistantToolsFileSearchType? type,
    AssistantToolsFileSearchFileSearch Function()? fileSearch,
  }) {
    return AssistantToolsFileSearch(
      type: type ?? this.type,
  ...
  @override
  int get hashCode {
    return Object.hash(type, fileSearch);
  }

  @override
  String toString() {
    return 'AssistantToolsFileSearch(type: $type, fileSearch: $fileSearch)';
  }
}
