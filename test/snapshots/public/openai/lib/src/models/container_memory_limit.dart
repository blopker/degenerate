...
final class ContainerMemoryLimit {
  const ContainerMemoryLimit._(this.value);

  factory ContainerMemoryLimit.fromJson(String json) {
    return switch (json) {
      '1g' => $1g,
      '4g' => $4g,
      '16g' => $16g,
  ...
  @override
  String toString() {
    return 'ContainerMemoryLimit($value)';
  }
}
