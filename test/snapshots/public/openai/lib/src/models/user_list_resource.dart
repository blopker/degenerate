...
import 'user.dart';
import 'user_list_resource_object.dart';
...
final class UserListResource {
  ...
  UserListResource copyWith({
    UserListResourceObject? object,
    List<User>? data,
    bool? hasMore,
  ...
  @override
  String toString() {
    return 'UserListResource(object: $object, data: $data, hasMore: $hasMore, next: $next)';
  }
}
