...
import 'create_completion_response_choices_finish_reason.dart';import 'create_completion_response_choices_logprobs.dart';final class CreateCompletionResponseChoices {const CreateCompletionResponseChoices({required this.finishReason, required this.index, required this.logprobs, required this.text, });
