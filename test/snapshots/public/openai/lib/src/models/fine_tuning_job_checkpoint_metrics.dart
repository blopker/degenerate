...
final class FineTuningJobCheckpointMetrics {
  ...
  factory FineTuningJobCheckpointMetrics.fromJson(Map<String, dynamic> json) {
    return FineTuningJobCheckpointMetrics(
      ...
      trainLoss: json['train_loss'] != null
          ? (json['train_loss'] as num).toDouble()
          : null,
      trainMeanTokenAccuracy: json['train_mean_token_accuracy'] != null
          ? (json['train_mean_token_accuracy'] as num).toDouble()
          : null,
      validLoss: json['valid_loss'] != null
          ? (json['valid_loss'] as num).toDouble()
          : null,
      validMeanTokenAccuracy: json['valid_mean_token_accuracy'] != null
          ? (json['valid_mean_token_accuracy'] as num).toDouble()
          : null,
      fullValidLoss: json['full_valid_loss'] != null
          ? (json['full_valid_loss'] as num).toDouble()
          : null,
      fullValidMeanTokenAccuracy: json['full_valid_mean_token_accuracy'] != null
  ...
  FineTuningJobCheckpointMetrics copyWith({
    double Function()? step,
    double Function()? trainLoss,
    double Function()? trainMeanTokenAccuracy,
    double Function()? validLoss,
    double Function()? validMeanTokenAccuracy,
    double Function()? fullValidLoss,
    double Function()? fullValidMeanTokenAccuracy,
  }) {
    return FineTuningJobCheckpointMetrics(
      step: step != null ? step() : this.step,
      trainLoss: trainLoss != null ? trainLoss() : this.trainLoss,
      trainMeanTokenAccuracy: trainMeanTokenAccuracy != null
          ? trainMeanTokenAccuracy()
          : this.trainMeanTokenAccuracy,
      validLoss: validLoss != null ? validLoss() : this.validLoss,
      validMeanTokenAccuracy: validMeanTokenAccuracy != null
          ? validMeanTokenAccuracy()
          : this.validMeanTokenAccuracy,
      fullValidLoss: fullValidLoss != null
          ? fullValidLoss()
          : this.fullValidLoss,
      fullValidMeanTokenAccuracy: fullValidMeanTokenAccuracy != null
