...
import 'create_chat_completion_response_object.dart';
import 'service_tier.dart';

/// Represents a chat completion response returned by model, based on the provided input.
final class CreateChatCompletionResponse {
  ...
  factory CreateChatCompletionResponse.fromJson(Map<String, dynamic> json) {
    return CreateChatCompletionResponse(
      ...
      choices: (json['choices'] as List<dynamic>)
          .map(
            (e) => CreateChatCompletionResponseChoices.fromJson(
      ...
      object: CreateChatCompletionResponseObject.fromJson(
  ...
  CreateChatCompletionResponse copyWith({
    String? id,
