...
import 'easy_input_message_content.dart';
import 'easy_input_message_role.dart';
import 'message_phase.dart';
...
final class EasyInputMessage {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('role') && json.containsKey('content');
  }

  EasyInputMessage copyWith({
    EasyInputMessageRole? role,
    EasyInputMessageContent? content,
    MessagePhase? Function()? phase,
  ...
  @override
  int get hashCode {
    return Object.hash(role, content, phase, type);
  }

  @override
  String toString() {
    return 'EasyInputMessage(role: $role, content: $content, phase: $phase, type: $type)';
  }
}
