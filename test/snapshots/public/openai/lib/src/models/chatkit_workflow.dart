...
final class ChatkitWorkflow {
  ...
  factory ChatkitWorkflow.fromJson(Map<String, dynamic> json) {
    return ChatkitWorkflow(
      ...
      stateVariables: (json['state_variables'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, InlineObject116.fromJson(v)),
      ),
      tracing: ChatkitWorkflowTracing.fromJson(
  ...
  ChatkitWorkflow copyWith({
    String? id,
    String? Function()? version,
    Map<String, InlineObject116>? Function()? stateVariables,
  ...
  @override
  String toString() {
    return 'ChatkitWorkflow(id: $id, version: $version, stateVariables: $stateVariables, tracing: $tracing)';
  }
}
