...
import 'fine_tuning_job_checkpoint_object.dart';

/// The `fine_tuning.job.checkpoint` object represents a model checkpoint for a fine-tuning job that is ready to use.
///
final class FineTuningJobCheckpoint {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('fine_tuned_model_checkpoint') &&
        json['fine_tuned_model_checkpoint'] is String &&
        json.containsKey('step_number') &&
        json['step_number'] is num &&
        json.containsKey('metrics') &&
        json.containsKey('fine_tuning_job_id') &&
        json['fine_tuning_job_id'] is String &&
        json.containsKey('object');
  }

  FineTuningJobCheckpoint copyWith({
    String? id,
    int? createdAt,
    ...
    return FineTuningJobCheckpoint(
      ...
      fineTunedModelCheckpoint:
          fineTunedModelCheckpoint ?? this.fineTunedModelCheckpoint,
