...
import 'vector_store_file_batch_object_object.dart';
import 'vector_store_file_batch_object_status.dart';

/// A batch of files attached to a vector store.
final class VectorStoreFileBatchObject {
  ...
  factory VectorStoreFileBatchObject.fromJson(Map<String, dynamic> json) {
    return VectorStoreFileBatchObject(
      ...
      object: VectorStoreFileBatchObjectObject.fromJson(
        json['object'] as String,
      ),
      createdAt: (json['created_at'] as num).toInt(),
      vectorStoreId: json['vector_store_id'] as String,
      status: VectorStoreFileBatchObjectStatus.fromJson(
  ...
  VectorStoreFileBatchObject copyWith({
    String? id,
