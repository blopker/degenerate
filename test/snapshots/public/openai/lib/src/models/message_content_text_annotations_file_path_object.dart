...
final class MessageContentTextAnnotationsFilePathObject {
  ...
  factory MessageContentTextAnnotationsFilePathObject.fromJson(
    ...
    return MessageContentTextAnnotationsFilePathObject(
      type: MessageContentTextAnnotationsFilePathObjectType.fromJson(
        json['type'] as String,
      ),
      text: json['text'] as String,
      filePath: MessageContentTextAnnotationsFilePathObjectFilePath.fromJson(
  ...
  MessageContentTextAnnotationsFilePathObject copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(type, text, filePath, startIndex, endIndex);
  }

  @override
  String toString() {
    return 'MessageContentTextAnnotationsFilePathObject(type: $type, text: $text, filePath: $filePath, startIndex: $startIndex, endIndex: $endIndex)';
  }
}
