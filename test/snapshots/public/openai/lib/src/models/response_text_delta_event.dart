...
final class ResponseTextDeltaEvent {
  ...
  factory ResponseTextDeltaEvent.fromJson(Map<String, dynamic> json) {
    return ResponseTextDeltaEvent(
      ...
      logprobs: (json['logprobs'] as List<dynamic>)
          .map((e) => ResponseLogProb.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  ResponseTextDeltaEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseTextDeltaEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, delta: $delta, sequenceNumber: $sequenceNumber, logprobs: $logprobs)';
  }
}
