...
import 'image_gen_partial_image_event_output_format.dart';
...
///
final class ImageGenPartialImageEvent {
  ...
  factory ImageGenPartialImageEvent.fromJson(Map<String, dynamic> json) {
    return ImageGenPartialImageEvent(
      ...
      quality: ImageGenPartialImageEventQuality.fromJson(
        json['quality'] as String,
      ),
      background: ImageGenPartialImageEventBackground.fromJson(
        json['background'] as String,
      ),
      outputFormat: ImageGenPartialImageEventOutputFormat.fromJson(
  ...
  ImageGenPartialImageEvent copyWith({
    ...
    ImageGenPartialImageEventOutputFormat? outputFormat,
  ...
  @override
  String toString() {
    return 'ImageGenPartialImageEvent(type: $type, b64Json: $b64Json, createdAt: $createdAt, size: $size, quality: $quality, background: $background, outputFormat: $outputFormat, partialImageIndex: $partialImageIndex)';
  }
}
