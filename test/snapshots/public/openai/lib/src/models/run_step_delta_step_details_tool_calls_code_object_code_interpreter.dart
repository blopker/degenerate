...
import 'package:collection/collection.dart';import 'run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs.dart';/// The Code Interpreter tool call definition.
...
factory RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.fromJson(Map<String, dynamic> json) { return RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter(
  ...
  outputs: (json['outputs'] as List<dynamic>?)?.map((e) => RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreterOutputs.fromJson(e)).toList(),
); }
