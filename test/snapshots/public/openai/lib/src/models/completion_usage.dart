...
final class CompletionUsage {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('completion_tokens') &&
  ...
  CompletionUsage copyWith({
    int? completionTokens,
    int? promptTokens,
    int? totalTokens,
    CompletionUsageCompletionTokensDetails Function()? completionTokensDetails,
    CompletionUsagePromptTokensDetails Function()? promptTokensDetails,
  }) {
    return CompletionUsage(
      completionTokens: completionTokens ?? this.completionTokens,
      promptTokens: promptTokens ?? this.promptTokens,
      totalTokens: totalTokens ?? this.totalTokens,
      completionTokensDetails: completionTokensDetails != null
