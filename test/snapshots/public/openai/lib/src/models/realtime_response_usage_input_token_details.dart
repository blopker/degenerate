...
final class RealtimeResponseUsageInputTokenDetails {
  ...
  factory RealtimeResponseUsageInputTokenDetails.fromJson(
    ...
    return RealtimeResponseUsageInputTokenDetails(
      ...
      cachedTokensDetails: json['cached_tokens_details'] != null
          ? RealtimeResponseUsageInputTokenDetailsCachedTokensDetails.fromJson(
  ...
  RealtimeResponseUsageInputTokenDetails copyWith({
    int Function()? cachedTokens,
    int Function()? textTokens,
    int Function()? imageTokens,
    int Function()? audioTokens,
    RealtimeResponseUsageInputTokenDetailsCachedTokensDetails Function()?
    cachedTokensDetails,
  }) {
    return RealtimeResponseUsageInputTokenDetails(
  ...
  @override
  String toString() {
    return 'RealtimeResponseUsageInputTokenDetails(cachedTokens: $cachedTokens, textTokens: $textTokens, imageTokens: $imageTokens, audioTokens: $audioTokens, cachedTokensDetails: $cachedTokensDetails)';
  }
}
