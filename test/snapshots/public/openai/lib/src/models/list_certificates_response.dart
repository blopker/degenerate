...
import 'package:collection/collection.dart';import 'certificate.dart';import 'list_certificates_response_object.dart';final class ListCertificatesResponse {const ListCertificatesResponse({required this.data, this.firstId, this.lastId, required this.hasMore, required this.object, });
