...
final class Role {
  ...
  @override
  String toString() {
    return 'Role(object: $object, id: $id, name: $name, description: $description, permissions: $permissions, resourceType: $resourceType, predefinedRole: $predefinedRole)';
  }
}
