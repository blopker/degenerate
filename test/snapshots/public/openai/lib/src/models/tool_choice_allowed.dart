...
final class ToolChoiceAllowed {
  ...
  factory ToolChoiceAllowed.fromJson(Map<String, dynamic> json) {
  ...
  @override
  int get hashCode {
    return Object.hash(type, mode, Object.hashAll(tools));
  }

  @override
  String toString() {
    return 'ToolChoiceAllowed(type: $type, mode: $mode, tools: $tools)';
  }
}
