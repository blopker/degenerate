...
import 'model_response_properties_prompt_cache_retention.dart';
import 'service_tier.dart';

final class ModelResponseProperties {
  ...
  factory ModelResponseProperties.fromJson(Map<String, dynamic> json) {
    return ModelResponseProperties(
      ...
      promptCacheRetention: json['prompt_cache_retention'] != null
          ? ModelResponsePropertiesPromptCacheRetention.fromJson(
  ...
  ModelResponseProperties copyWith({
    ...
    String Function()? safetyIdentifier,
    String Function()? promptCacheKey,
    ServiceTier? Function()? serviceTier,
    ModelResponsePropertiesPromptCacheRetention? Function()?
  ...
  @override
  String toString() {
    return 'ModelResponseProperties(metadata: $metadata, topLogprobs: $topLogprobs, temperature: $temperature, topP: $topP, user: $user, safetyIdentifier: $safetyIdentifier, promptCacheKey: $promptCacheKey, serviceTier: $serviceTier, promptCacheRetention: $promptCacheRetention)';
  }
}
