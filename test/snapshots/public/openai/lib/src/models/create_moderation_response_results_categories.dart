...
final class CreateModerationResponseResultsCategories {
  ...
  factory CreateModerationResponseResultsCategories.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('hate') &&
        ...
        json['hate/threatening'] is bool &&
        json.containsKey('harassment') &&
        json['harassment'] is bool &&
        json.containsKey('harassment/threatening') &&
        json['harassment/threatening'] is bool &&
        json.containsKey('illicit') &&
        json['illicit'] is bool &&
        json.containsKey('illicit/violent') &&
        json['illicit/violent'] is bool &&
        json.containsKey('self-harm') &&
        json['self-harm'] is bool &&
        json.containsKey('self-harm/intent') &&
        json['self-harm/intent'] is bool &&
        json.containsKey('self-harm/instructions') &&
        json['self-harm/instructions'] is bool &&
        json.containsKey('sexual') &&
        json['sexual'] is bool &&
        json.containsKey('sexual/minors') &&
        json['sexual/minors'] is bool &&
        json.containsKey('violence') &&
        json['violence'] is bool &&
        json.containsKey('violence/graphic') &&
        json['violence/graphic'] is bool;
  }

  CreateModerationResponseResultsCategories copyWith({
    bool? hate,
    bool? hateThreatening,
    bool? harassment,
    bool? harassmentThreatening,
    bool? Function()? illicit,
    bool? Function()? illicitViolent,
    bool? selfHarm,
    bool? selfHarmIntent,
    ...
    return CreateModerationResponseResultsCategories(
      ...
      illicitViolent: illicitViolent != null
          ? illicitViolent()
          : this.illicitViolent,
