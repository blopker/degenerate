...
factory RunGraderResponseMetadata.fromJson(Map<String, dynamic> json) { return RunGraderResponseMetadata(
  ...
  scores: (json['scores'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
...
RunGraderResponseMetadata copyWith({String? name, String? type, RunGraderResponseMetadataErrors? errors, double? executionTime, Map<String,String>? scores, int? Function()? tokenUsage, String? Function()? sampledModelName, }) { return RunGraderResponseMetadata(
  name: name ?? this.name,
  type: type ?? this.type,
