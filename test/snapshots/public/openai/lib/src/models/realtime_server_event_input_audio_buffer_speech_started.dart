...
///
final class RealtimeServerEventInputAudioBufferSpeechStarted {
  ...
  factory RealtimeServerEventInputAudioBufferSpeechStarted.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimeServerEventInputAudioBufferSpeechStarted(
      eventId: json['event_id'] as String,
      type: RealtimeServerEventInputAudioBufferSpeechStartedType.fromJson(
        json['type'] as String,
      ),
  ...
  RealtimeServerEventInputAudioBufferSpeechStarted copyWith({
    String? eventId,
  ...
  @override
  String toString() {
    return 'RealtimeServerEventInputAudioBufferSpeechStarted(eventId: $eventId, type: $type, audioStartMs: $audioStartMs, itemId: $itemId)';
  }
}
