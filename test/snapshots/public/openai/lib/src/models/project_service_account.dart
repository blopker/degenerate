...
import 'project_service_account_object.dart';
import 'project_service_account_role.dart';

/// Represents an individual service account in a project.
final class ProjectServiceAccount {
  ...
  factory ProjectServiceAccount.fromJson(Map<String, dynamic> json) {
  ...
  ProjectServiceAccount copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(object, id, name, role, createdAt);
  }

  @override
  String toString() {
    return 'ProjectServiceAccount(object: $object, id: $id, name: $name, role: $role, createdAt: $createdAt)';
  }
}
