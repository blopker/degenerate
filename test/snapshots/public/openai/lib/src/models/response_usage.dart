...
import 'response_usage_input_tokens_details.dart';
...
final class ResponseUsage {
  ...
  factory ResponseUsage.fromJson(Map<String, dynamic> json) {
    return ResponseUsage(
      ...
      inputTokensDetails: ResponseUsageInputTokensDetails.fromJson(
        json['input_tokens_details'] as Map<String, dynamic>,
      ),
      outputTokens: (json['output_tokens'] as num).toInt(),
      outputTokensDetails: ResponseUsageOutputTokensDetails.fromJson(
  ...
  @override
  String toString() {
    return 'ResponseUsage(inputTokens: $inputTokens, inputTokensDetails: $inputTokensDetails, outputTokens: $outputTokens, outputTokensDetails: $outputTokensDetails, totalTokens: $totalTokens)';
  }
}
