...
import 'package:collection/collection.dart';import 'fine_tuning_job_checkpoint.dart';import 'list_fine_tuning_job_checkpoints_response_object.dart';final class ListFineTuningJobCheckpointsResponse {const ListFineTuningJobCheckpointsResponse({required this.data, required this.object, this.firstId, this.lastId, required this.hasMore, });
