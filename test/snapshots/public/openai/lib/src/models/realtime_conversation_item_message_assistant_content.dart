...
import 'realtime_conversation_item_message_assistant_content_type.dart';final class RealtimeConversationItemMessageAssistantContent {const RealtimeConversationItemMessageAssistantContent({this.type, this.text, this.audio, this.transcript, });
