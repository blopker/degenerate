...
final class ResponseReasoningSummaryTextDeltaEvent {
  ...
  factory ResponseReasoningSummaryTextDeltaEvent.fromJson(
    Map<String, dynamic> json,
  ) {
    return ResponseReasoningSummaryTextDeltaEvent(
      type: ResponseReasoningSummaryTextDeltaEventType.fromJson(
        json['type'] as String,
      ),
  ...
  ResponseReasoningSummaryTextDeltaEvent copyWith({
  ...
  @override
  String toString() {
    return 'ResponseReasoningSummaryTextDeltaEvent(type: $type, itemId: $itemId, outputIndex: $outputIndex, summaryIndex: $summaryIndex, delta: $delta, sequenceNumber: $sequenceNumber)';
  }
}
