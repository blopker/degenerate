...
import '../models/realtime_call_create_request.dart';
...
/// RealtimeApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class RealtimeApi {
  const RealtimeApi(this._config);
  ...
  ///
  /// `POST /realtime/calls`
  Future<ApiResult<void>> createRealtimeCall({
    required RealtimeCallCreateRequest body,
  }) async {
  ...
  Future<ApiResult<void>> acceptRealtimeCall({
    required String callId,
    required RealtimeSessionCreateRequestGa body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> hangupRealtimeCall({required String callId}) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> referRealtimeCall({
    required String callId,
    required RealtimeCallReferRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> rejectRealtimeCall({
    required String callId,
    RealtimeCallRejectRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<RealtimeCreateClientSecretResponse>>
  createRealtimeClientSecret({
    required RealtimeCreateClientSecretRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return RealtimeCreateClientSecretResponse.fromJson(
  ...
  Future<ApiResult<RealtimeSessionCreateResponse>> createRealtimeSession({
    required RealtimeSessionCreateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<RealtimeTranscriptionSessionCreateResponse>>
  createRealtimeTranscriptionSession({
    required RealtimeTranscriptionSessionCreateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
