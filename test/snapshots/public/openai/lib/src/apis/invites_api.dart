...
/// InvitesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class InvitesApi {
  const InvitesApi(this._config);
  ...
  Future<ApiResult<InviteListResponse>> listInvites({
    int? limit,
    String? after,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return InviteListResponse.fromJson(
  ...
  Future<ApiResult<Invite>> inviteUser({required InviteRequest body}) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/organization/invites',
  ...
  Future<ApiResult<Invite>> retrieveInvite({required String inviteId}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<InviteDeleteResponse>> deleteInvite({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return InviteDeleteResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
