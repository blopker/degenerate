...
/// ModelsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ModelsApi {
  const ModelsApi(this._config);
  ...
  ///
  /// `GET /models`
  Future<ApiResult<ListModelsResponse>> listModels() async {
  ...
  ///
  /// `GET /models/{model}`
  Future<ApiResult<Model>> retrieveModel({required String model}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  ///
  /// `DELETE /models/{model}`
  Future<ApiResult<DeleteModelResponse>> deleteModel({
