...
/// ModerationsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ModerationsApi {
  const ModerationsApi(this._config);
  ...
  ///
  /// `POST /moderations`
  Future<ApiResult<CreateModerationResponse>> createModeration({
    required CreateModerationRequest body,
  }) async {
