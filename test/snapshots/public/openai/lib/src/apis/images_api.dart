...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/create_image_request.dart';import '../models/create_image_variation_request.dart';import '../models/edit_image_body_json_param.dart';import '../models/images_response.dart';/// ImagesApi operations.
///
...
///
/// `POST /images/edits`
Future<ApiResult<ImagesResponse>> createImageEdit({required EditImageBodyJsonParam body}) async  { final request = ApiRequest(
  method: 'POST',
  path: '/images/edits',
...
Future<ApiResult<ImagesResponse>> createImage({required CreateImageRequest body}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<ImagesResponse>> createImageVariation({required CreateImageVariationRequest body}) async  { final request = ApiRequest(
  method: 'POST',
