...
import '../models/edit_image_body_json_param.dart';
import '../models/images_response.dart';

/// ImagesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ImagesApi {
  const ImagesApi(this._config);
  ...
  ///
  /// `POST /images/edits`
  Future<ApiResult<ImagesResponse>> createImageEdit({
    required EditImageBodyJsonParam body,
  }) async {
  ...
  Future<ApiResult<ImagesResponse>> createImage({
  ...
  Future<ApiResult<ImagesResponse>> createImageVariation({
    required CreateImageVariationRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
