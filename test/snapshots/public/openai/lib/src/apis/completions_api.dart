...
/// CompletionsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CompletionsApi {
  const CompletionsApi(this._config);
  ...
  ///
  /// `POST /completions`
  Future<ApiResult<CreateCompletionResponse>> createCompletion({
    required CreateCompletionRequest body,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CreateCompletionResponse.fromJson(
