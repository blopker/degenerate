...
final class UsersApi {
  ...
  Future<ApiResult<UserListResponse>> listUsers({
    int? limit,
    String? after,
    List<String>? emails,
  }) async {
  ...
  Future<ApiResult<User>> retrieveUser({required String userId}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<User>> modifyUser({
    required String userId,
    required UserRoleUpdateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/organization/users/${Uri.encodeComponent(userId)}',
  ...
  Future<ApiResult<UserDeleteResponse>> deleteUser({
    required String userId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
