...
final class UploadsApi {
  ...
  ///
  /// `POST /uploads`
  Future<ApiResult<Upload>> createUpload({
    required CreateUploadRequest body,
  }) async {
  ...
  Future<ApiResult<Upload>> cancelUpload({required String uploadId}) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<Upload>> completeUpload({
    required String uploadId,
    required CompleteUploadRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<UploadPart>> addUploadPart({
    required String uploadId,
    required AddUploadPartRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
