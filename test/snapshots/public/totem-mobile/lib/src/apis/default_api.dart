...
final class DefaultApi {
  ...
  Future<ApiResult<FcmTokenResponseSchema>> totemApiMobileApiRegisterFcmToken({
  ...
  Future<ApiResult<void>> totemApiMobileApiUnregisterFcmToken({
  ...
  Future<ApiResult<OnboardSchema>> totemOnboardMobileApiOnboardGet() async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<OnboardSchema>> totemOnboardMobileApiOnboardPost({
  ...
  Future<ApiResult<MessageResponse>> totemApiAuthRequestPin({
  ...
  Future<ApiResult<TokenResponse>> totemApiAuthValidatePin({
  ...
  Future<ApiResult<TokenResponse>> totemApiAuthRefreshToken({
  ...
  Future<ApiResult<MessageResponse>> totemApiAuthLogout({
    required RefreshTokenSchema body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
