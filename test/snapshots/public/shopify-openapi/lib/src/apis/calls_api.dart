...
final class CallsApi {
  ...
  Future<ApiResult<void>> deprecated202101GetDeprecatedApiCalls() async {
  ...
  Future<ApiResult<void>> deprecatedUnstableGetDeprecatedApiCalls() async {
    final request = ApiRequest(
      method: 'GET',
