...
/// TendertransactionApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class TendertransactionApi {
  const TendertransactionApi(this._config);
  ...
  Future<ApiResult<void>> deprecated202001GetTenderTransactions({
    String? limit,
    String? sinceId,
  ...
  Future<ApiResult<void>> deprecated202004GetTenderTransactions({
    String? limit,
    String? sinceId,
    String? processedAtMin,
    String? processedAtMax,
  ...
  Future<ApiResult<void>> deprecated202007GetTenderTransactions({
    String? limit,
    String? sinceId,
    String? processedAtMin,
    String? processedAtMax,
  ...
  Future<ApiResult<void>> getTenderTransactions({
    String? limit,
    String? sinceId,
    String? processedAtMin,
    String? processedAtMax,
  ...
  Future<ApiResult<void>> deprecated202101GetTenderTransactions({
    String? limit,
    String? sinceId,
    String? processedAtMin,
    String? processedAtMax,
  ...
  Future<ApiResult<void>> deprecatedUnstableGetTenderTransactions({
    String? limit,
    String? sinceId,
    String? processedAtMin,
    String? processedAtMax,
