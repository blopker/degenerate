...
import 'package:collection/collection.dart';import 'post_radar_value_lists_request_item_type.dart';final class PostRadarValueListsRequest {const PostRadarValueListsRequest({required this.alias, this.expand, this.itemType, this.metadata, required this.name, });
