...
import 'payment_method_details_card_checks2.dart';
import 'payment_method_details_card_installments2.dart';
import 'payment_method_details_card_network_token2.dart';
import 'payment_method_details_card_regulated_status.dart';
import 'payment_method_details_card_three_d_secure.dart';
import 'payment_method_details_card_wallet2.dart';
import 'resource_enterprise_features_extended_authorization_extended_authorization.dart';
import 'resource_enterprise_features_incremental_authorization_incremental_authorization.dart';
import 'resource_enterprise_features_overcapture_overcapture.dart';
import 'resource_multicapture.dart';

///
final class PaymentMethodDetailsCard {
  ...
  factory PaymentMethodDetailsCard.fromJson(Map<String, dynamic> json) {
    return PaymentMethodDetailsCard(
      amountAuthorized: json['amount_authorized'] != null
          ? (json['amount_authorized'] as num).toInt()
          : null,
      ...
      checks: json['checks'] != null
          ? PaymentMethodDetailsCardChecks2.fromJson(
      ...
      extendedAuthorization: json['extended_authorization'] != null
          ? ResourceEnterpriseFeaturesExtendedAuthorizationExtendedAuthorization.fromJson(
      ...
      incrementalAuthorization: json['incremental_authorization'] != null
          ? ResourceEnterpriseFeaturesIncrementalAuthorizationIncrementalAuthorization.fromJson(
              json['incremental_authorization'] as Map<String, dynamic>,
            )
          : null,
      installments: json['installments'] != null
          ? PaymentMethodDetailsCardInstallments2.fromJson(
      ...
      overcapture: json['overcapture'] != null
          ? ResourceEnterpriseFeaturesOvercaptureOvercapture.fromJson(
              json['overcapture'] as Map<String, dynamic>,
            )
          : null,
      regulatedStatus: json['regulated_status'] != null
          ? PaymentMethodDetailsCardRegulatedStatus.fromJson(
              json['regulated_status'] as String,
            )
          : null,
      ...
      wallet: json['wallet'] != null
          ? PaymentMethodDetailsCardWallet2.fromJson(
  ...
  final ResourceEnterpriseFeaturesExtendedAuthorizationExtendedAuthorization?
  ...
  final ResourceEnterpriseFeaturesIncrementalAuthorizationIncrementalAuthorization?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (regulatedStatus != null)
        'regulated_status': regulatedStatus?.toJson(),
  ...
  PaymentMethodDetailsCard copyWith({
    int? Function()? amountAuthorized,
    String? Function()? authorizationCode,
    String? Function()? brand,
    int Function()? captureBefore,
    PaymentMethodDetailsCardChecks2? Function()? checks,
    String? Function()? country,
    int? expMonth,
    int? expYear,
    ResourceEnterpriseFeaturesExtendedAuthorizationExtendedAuthorization
    Function()?
    extendedAuthorization,
    String? Function()? fingerprint,
    String? Function()? funding,
    ResourceEnterpriseFeaturesIncrementalAuthorizationIncrementalAuthorization
    Function()?
    incrementalAuthorization,
    PaymentMethodDetailsCardInstallments2? Function()? installments,
    String? Function()? last4,
    String? Function()? mandate,
    ResourceMulticapture Function()? multicapture,
    String? Function()? network,
    PaymentMethodDetailsCardNetworkToken2? Function()? networkToken,
    String? Function()? networkTransactionId,
    ResourceEnterpriseFeaturesOvercaptureOvercapture Function()? overcapture,
    PaymentMethodDetailsCardRegulatedStatus? Function()? regulatedStatus,
    PaymentMethodDetailsCardThreeDSecure? Function()? threeDSecure,
    PaymentMethodDetailsCardWallet2? Function()? wallet,
  }) {
    return PaymentMethodDetailsCard(
      ...
      extendedAuthorization: extendedAuthorization != null
          ? extendedAuthorization()
          : this.extendedAuthorization,
      fingerprint: fingerprint != null ? fingerprint() : this.fingerprint,
      funding: funding != null ? funding() : this.funding,
      incrementalAuthorization: incrementalAuthorization != null
          ? incrementalAuthorization()
          : this.incrementalAuthorization,
      ...
      regulatedStatus: regulatedStatus != null
          ? regulatedStatus()
          : this.regulatedStatus,
