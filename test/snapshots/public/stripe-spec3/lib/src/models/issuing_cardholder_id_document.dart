...
///
final class IssuingCardholderIdDocument {
  const IssuingCardholderIdDocument({this.back, this.front});

  factory IssuingCardholderIdDocument.fromJson(Map<String, dynamic> json) {
    return IssuingCardholderIdDocument(
      back: json['back'] != null
          ? IssuingCardholderIdDocumentBack.fromJson(
              json['back'] as Map<String, dynamic>,
            )
          : null,
      front: json['front'] != null
          ? IssuingCardholderIdDocumentFront.fromJson(
  ...
  IssuingCardholderIdDocument copyWith({
    IssuingCardholderIdDocumentBack? Function()? back,
    IssuingCardholderIdDocumentFront? Function()? front,
  }) {
    return IssuingCardholderIdDocument(
  ...
  @override
  String toString() {
    return 'IssuingCardholderIdDocument(back: $back, front: $front)';
  }
}
