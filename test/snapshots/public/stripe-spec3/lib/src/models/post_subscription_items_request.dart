...
import 'post_subscription_items_request_billing_thresholds.dart';
import 'post_subscription_items_request_discounts.dart';
import 'post_subscription_items_request_payment_behavior.dart';
import 'post_subscription_items_request_price_data.dart';
import 'post_subscription_items_request_proration_behavior.dart';
import 'post_subscription_items_request_tax_rates.dart';

final class PostSubscriptionItemsRequest {
  const PostSubscriptionItemsRequest({
  ...
  factory PostSubscriptionItemsRequest.fromJson(Map<String, dynamic> json) {
    return PostSubscriptionItemsRequest(
      billingThresholds: json['billing_thresholds'] != null
          ? PostSubscriptionItemsRequestBillingThresholds.fromJson(
              json['billing_thresholds'] as Map<String, dynamic>,
            )
          : null,
      discounts: json['discounts'] != null
          ? PostSubscriptionItemsRequestDiscounts.fromJson(
      ...
      paymentBehavior: json['payment_behavior'] != null
          ? PostSubscriptionItemsRequestPaymentBehavior.fromJson(
              json['payment_behavior'] as String,
            )
          : null,
      price: json['price'] as String?,
      priceData: json['price_data'] != null
          ? PostSubscriptionItemsRequestPriceData.fromJson(
              json['price_data'] as Map<String, dynamic>,
            )
          : null,
      prorationBehavior: json['proration_behavior'] != null
          ? PostSubscriptionItemsRequestProrationBehavior.fromJson(
      ...
      taxRates: json['tax_rates'] != null
          ? PostSubscriptionItemsRequestTaxRates.fromJson(
  ...
  PostSubscriptionItemsRequest copyWith({
    PostSubscriptionItemsRequestBillingThresholds Function()? billingThresholds,
    PostSubscriptionItemsRequestDiscounts Function()? discounts,
    List<String> Function()? expand,
    Map<String, String> Function()? metadata,
    PostSubscriptionItemsRequestPaymentBehavior Function()? paymentBehavior,
    String Function()? price,
    PostSubscriptionItemsRequestPriceData Function()? priceData,
    PostSubscriptionItemsRequestProrationBehavior Function()? prorationBehavior,
    int Function()? prorationDate,
    int Function()? quantity,
    String? subscription,
    PostSubscriptionItemsRequestTaxRates Function()? taxRates,
  }) {
    return PostSubscriptionItemsRequest(
