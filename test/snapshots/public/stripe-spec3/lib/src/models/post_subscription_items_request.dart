...
import 'package:collection/collection.dart';import 'post_subscription_items_request_billing_thresholds.dart';import 'post_subscription_items_request_discounts.dart';import 'post_subscription_items_request_payment_behavior.dart';import 'post_subscription_items_request_price_data.dart';import 'post_subscription_items_request_proration_behavior.dart';import 'post_subscription_items_request_tax_rates.dart';final class PostSubscriptionItemsRequest {const PostSubscriptionItemsRequest({this.billingThresholds, this.discounts, this.expand, this.metadata, this.paymentBehavior, this.price, this.priceData, this.prorationBehavior, this.prorationDate, this.quantity, required this.subscription, this.taxRates, });
...
factory PostSubscriptionItemsRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionItemsRequest(
  billingThresholds: json['billing_thresholds'] != null
        ? PostSubscriptionItemsRequestBillingThresholds.fromJson(json['billing_thresholds'] as Map<String, dynamic>)
        : null,
  discounts: json['discounts'] != null
        ? PostSubscriptionItemsRequestDiscounts.fromJson(json['discounts'] as Map<String, dynamic>)
        : null,
  ...
  priceData: json['price_data'] != null
        ? PostSubscriptionItemsRequestPriceData.fromJson(json['price_data'] as Map<String, dynamic>)
        : null,
  ...
  taxRates: json['tax_rates'] != null
        ? PostSubscriptionItemsRequestTaxRates.fromJson(json['tax_rates'] as Map<String, dynamic>)
        : null,
); }
