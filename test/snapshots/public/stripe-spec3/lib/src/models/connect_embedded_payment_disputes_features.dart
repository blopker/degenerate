...
///
final class ConnectEmbeddedPaymentDisputesFeatures {
  const ConnectEmbeddedPaymentDisputesFeatures({
    required this.destinationOnBehalfOfChargeManagement,
    required this.disputeManagement,
    required this.refundManagement,
  });

  factory ConnectEmbeddedPaymentDisputesFeatures.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('destination_on_behalf_of_charge_management') &&
  ...
  ConnectEmbeddedPaymentDisputesFeatures copyWith({
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedPaymentDisputesFeatures(destinationOnBehalfOfChargeManagement: $destinationOnBehalfOfChargeManagement, disputeManagement: $disputeManagement, refundManagement: $refundManagement)';
  }
}
