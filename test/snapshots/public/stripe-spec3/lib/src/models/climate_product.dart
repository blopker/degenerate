...
import 'climate_product_object.dart';
import 'climate_removals_products_price.dart';
import 'climate_supplier.dart';

/// A Climate product represents a type of carbon removal unit available for reservation.
/// You can retrieve it to see the current price and availability.
final class ClimateProduct {
  ...
  factory ClimateProduct.fromJson(Map<String, dynamic> json) {
    return ClimateProduct(
      created: (json['created'] as num).toInt(),
      currentPricesPerMetricTon:
          (json['current_prices_per_metric_ton'] as Map<String, dynamic>).map(
            (k, v) => MapEntry(
              k,
              ClimateRemovalsProductsPrice.fromJson(v as Map<String, dynamic>),
            ),
          ),
      deliveryYear: json['delivery_year'] != null
          ? (json['delivery_year'] as num).toInt()
          : null,
      ...
      suppliers: (json['suppliers'] as List<dynamic>)
          .map((e) => ClimateSupplier.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      'created': created,
      'current_prices_per_metric_ton': currentPricesPerMetricTon.map(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created') &&
        ...
        json.containsKey('metric_tons_available') &&
        json['metric_tons_available'] is String &&
  ...
  ClimateProduct copyWith({
    int? created,
    Map<String, ClimateRemovalsProductsPrice>? currentPricesPerMetricTon,
    int? Function()? deliveryYear,
    String? id,
    bool? livemode,
    String? metricTonsAvailable,
    String? name,
    ClimateProductObject? object,
    List<ClimateSupplier>? suppliers,
  }) {
    return ClimateProduct(
      created: created ?? this.created,
      currentPricesPerMetricTon:
          currentPricesPerMetricTon ?? this.currentPricesPerMetricTon,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ClimateProduct &&
            ...
            name == other.name &&
            object == other.object &&
            const ListEquality<dynamic>().equals(suppliers, other.suppliers);
  }
  ...
  @override
  String toString() {
    return 'ClimateProduct(created: $created, currentPricesPerMetricTon: $currentPricesPerMetricTon, deliveryYear: $deliveryYear, id: $id, livemode: $livemode, metricTonsAvailable: $metricTonsAvailable, name: $name, object: $object, suppliers: $suppliers)';
  }
}
