...
import 'inline_object712_on_demand_purchase_interval.dart';final class InlineObject712OnDemand {const InlineObject712OnDemand({this.averageAmount, this.maximumAmount, this.minimumAmount, this.purchaseInterval, this.purchaseIntervalCount, });
