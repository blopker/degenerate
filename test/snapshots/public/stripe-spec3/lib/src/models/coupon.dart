...
import 'coupon_currency_option.dart';
...
final class Coupon {
  ...
  factory Coupon.fromJson(Map<String, dynamic> json) {
    return Coupon(
      ...
      currencyOptions: (json['currency_options'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(
          k,
          CouponCurrencyOption.fromJson(v as Map<String, dynamic>),
        ),
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created') &&
        ...
        json.containsKey('times_redeemed') &&
        json['times_redeemed'] is num &&
  ...
  Coupon copyWith({
    ...
    CouponAppliesTo Function()? appliesTo,
    int? created,
    String? Function()? currency,
    Map<String, CouponCurrencyOption> Function()? currencyOptions,
  ...
  @override
  String toString() {
    return 'Coupon(amountOff: $amountOff, appliesTo: $appliesTo, created: $created, currency: $currency, currencyOptions: $currencyOptions, duration: $duration, durationInMonths: $durationInMonths, id: $id, livemode: $livemode, maxRedemptions: $maxRedemptions, metadata: $metadata, name: $name, object: $object, percentOff: $percentOff, redeemBy: $redeemBy, timesRedeemed: $timesRedeemed, valid: $valid)';
  }
}
