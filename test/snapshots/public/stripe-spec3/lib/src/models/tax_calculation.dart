...
import 'tax_calculation_line_items.dart';
import 'tax_calculation_object.dart';
import 'tax_calculation_ship_from_details.dart';
import 'tax_calculation_shipping_cost.dart';
...
final class TaxCalculation {
  ...
  factory TaxCalculation.fromJson(Map<String, dynamic> json) {
    return TaxCalculation(
      ...
      lineItems: json['line_items'] != null
          ? TaxCalculationLineItems.fromJson(
      ...
      shipFromDetails: json['ship_from_details'] != null
          ? TaxCalculationShipFromDetails.fromJson(
      ...
      taxBreakdown: (json['tax_breakdown'] as List<dynamic>)
          .map(
            (e) => TaxProductResourceTaxBreakdown.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount_total') &&
        ...
        json.containsKey('tax_amount_exclusive') &&
        json['tax_amount_exclusive'] is num &&
        json.containsKey('tax_amount_inclusive') &&
        json['tax_amount_inclusive'] is num &&
  ...
  TaxCalculation copyWith({
    ...
    String? Function()? id,
    TaxCalculationLineItems? Function()? lineItems,
    bool? livemode,
    TaxCalculationObject? object,
    TaxCalculationShipFromDetails? Function()? shipFromDetails,
    TaxCalculationShippingCost? Function()? shippingCost,
