...
import 'post_climate_orders_request_beneficiary.dart';

final class PostClimateOrdersRequest {
  const PostClimateOrdersRequest({
    this.amount,
    this.beneficiary,
    this.currency,
    this.expand,
  ...
  factory PostClimateOrdersRequest.fromJson(Map<String, dynamic> json) {
    return PostClimateOrdersRequest(
      amount: json['amount'] != null ? (json['amount'] as num).toInt() : null,
      beneficiary: json['beneficiary'] != null
          ? PostClimateOrdersRequestBeneficiary.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('product') && json['product'] is String;
  }

  PostClimateOrdersRequest copyWith({
    int Function()? amount,
    PostClimateOrdersRequestBeneficiary Function()? beneficiary,
    String Function()? currency,
    List<String> Function()? expand,
    Map<String, String> Function()? metadata,
    String Function()? metricTons,
    String? product,
  }) {
    return PostClimateOrdersRequest(
  ...
  @override
  String toString() {
    return 'PostClimateOrdersRequest(amount: $amount, beneficiary: $beneficiary, currency: $currency, expand: $expand, metadata: $metadata, metricTons: $metricTons, product: $product)';
  }
}
