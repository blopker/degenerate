...
import 'package:collection/collection.dart';final class PostInvoicesInvoiceFinalizeRequest {const PostInvoicesInvoiceFinalizeRequest({this.autoAdvance, this.expand, });
