...
///
final class GelatoVerificationSessionOptions {
  const GelatoVerificationSessionOptions({
    this.document,
    this.email,
    this.idNumber,
    this.matching,
  ...
  factory GelatoVerificationSessionOptions.fromJson(Map<String, dynamic> json) {
    return GelatoVerificationSessionOptions(
      document: json['document'] != null
          ? GelatoSessionDocumentOptions.fromJson(
              json['document'] as Map<String, dynamic>,
            )
          : null,
      email: json['email'] != null
          ? GelatoSessionEmailOptions.fromJson(
              json['email'] as Map<String, dynamic>,
            )
          : null,
      idNumber: json['id_number'] != null
          ? GelatoSessionIdNumberOptions.fromJson(
              json['id_number'] as Map<String, dynamic>,
            )
          : null,
      matching: json['matching'] != null
          ? GelatoSessionMatchingOptions.fromJson(
              json['matching'] as Map<String, dynamic>,
            )
          : null,
      phone: json['phone'] != null
          ? GelatoSessionPhoneOptions.fromJson(
  ...
  GelatoVerificationSessionOptions copyWith({
    ...
    GelatoSessionEmailOptions Function()? email,
    GelatoSessionIdNumberOptions Function()? idNumber,
    GelatoSessionMatchingOptions Function()? matching,
    GelatoSessionPhoneOptions Function()? phone,
  }) {
    return GelatoVerificationSessionOptions(
  ...
  @override
  int get hashCode {
    return Object.hash(document, email, idNumber, matching, phone);
  }

  @override
  String toString() {
    return 'GelatoVerificationSessionOptions(document: $document, email: $email, idNumber: $idNumber, matching: $matching, phone: $phone)';
  }
}
