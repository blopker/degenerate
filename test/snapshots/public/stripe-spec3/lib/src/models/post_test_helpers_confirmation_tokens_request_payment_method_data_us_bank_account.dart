...
import 'post_test_helpers_confirmation_tokens_request_payment_method_data_us_bank_account_account_holder_type.dart';import 'post_test_helpers_confirmation_tokens_request_payment_method_data_us_bank_account_account_type.dart';final class PostTestHelpersConfirmationTokensRequestPaymentMethodDataUsBankAccount {const PostTestHelpersConfirmationTokensRequestPaymentMethodDataUsBankAccount({this.accountHolderType, this.accountNumber, this.accountType, this.financialConnectionsAccount, this.routingNumber, });
