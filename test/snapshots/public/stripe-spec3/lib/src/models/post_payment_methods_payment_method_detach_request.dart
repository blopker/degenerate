...
import 'package:collection/collection.dart';final class PostPaymentMethodsPaymentMethodDetachRequest {const PostPaymentMethodsPaymentMethodDetachRequest({this.expand});
