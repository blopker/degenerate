...
///
final class CheckoutSessionPaymentMethodOptions {
  ...
  factory CheckoutSessionPaymentMethodOptions.fromJson(
    ...
    return CheckoutSessionPaymentMethodOptions(
      ...
      bacsDebit: json['bacs_debit'] != null
          ? CheckoutBacsDebitPaymentMethodOptions.fromJson(
              json['bacs_debit'] as Map<String, dynamic>,
            )
          : null,
      bancontact: json['bancontact'] != null
          ? CheckoutBancontactPaymentMethodOptions.fromJson(
              json['bancontact'] as Map<String, dynamic>,
            )
          : null,
      billie: json['billie'] != null
          ? CheckoutBilliePaymentMethodOptions.fromJson(
      ...
      customerBalance: json['customer_balance'] != null
          ? CheckoutCustomerBalancePaymentMethodOptions.fromJson(
      ...
      eps: json['eps'] != null
          ...
          : null,
      fpx: json['fpx'] != null
          ? CheckoutFpxPaymentMethodOptions.fromJson(
      ...
      ideal: json['ideal'] != null
          ? CheckoutIdealPaymentMethodOptions.fromJson(
              json['ideal'] as Map<String, dynamic>,
            )
          : null,
      kakaoPay: json['kakao_pay'] != null
          ? CheckoutKakaoPayPaymentMethodOptions.fromJson(
      ...
      payco: json['payco'] != null
          ? CheckoutPaycoPaymentMethodOptions.fromJson(
              json['payco'] as Map<String, dynamic>,
            )
          : null,
      paynow: json['paynow'] != null
          ? CheckoutPaynowPaymentMethodOptions.fromJson(
      ...
      payto: json['payto'] != null
          ? CheckoutPaytoPaymentMethodOptions.fromJson(
  ...
  CheckoutSessionPaymentMethodOptions copyWith({
    CheckoutAcssDebitPaymentMethodOptions Function()? acssDebit,
    CheckoutAffirmPaymentMethodOptions Function()? affirm,
    CheckoutAfterpayClearpayPaymentMethodOptions Function()? afterpayClearpay,
    CheckoutAlipayPaymentMethodOptions Function()? alipay,
    CheckoutAlmaPaymentMethodOptions Function()? alma,
    CheckoutAmazonPayPaymentMethodOptions Function()? amazonPay,
    CheckoutAuBecsDebitPaymentMethodOptions Function()? auBecsDebit,
    CheckoutBacsDebitPaymentMethodOptions Function()? bacsDebit,
    CheckoutBancontactPaymentMethodOptions Function()? bancontact,
    CheckoutBilliePaymentMethodOptions Function()? billie,
    CheckoutBoletoPaymentMethodOptions Function()? boleto,
    CheckoutCardPaymentMethodOptions Function()? card,
    CheckoutCashappPaymentMethodOptions Function()? cashapp,
    CheckoutCustomerBalancePaymentMethodOptions Function()? customerBalance,
    CheckoutEpsPaymentMethodOptions Function()? eps,
    CheckoutFpxPaymentMethodOptions Function()? fpx,
    CheckoutGiropayPaymentMethodOptions Function()? giropay,
    CheckoutGrabPayPaymentMethodOptions Function()? grabpay,
    CheckoutIdealPaymentMethodOptions Function()? ideal,
    CheckoutKakaoPayPaymentMethodOptions Function()? kakaoPay,
    CheckoutKlarnaPaymentMethodOptions Function()? klarna,
    CheckoutKonbiniPaymentMethodOptions Function()? konbini,
    CheckoutKrCardPaymentMethodOptions Function()? krCard,
    CheckoutLinkPaymentMethodOptions Function()? link,
    CheckoutMobilepayPaymentMethodOptions Function()? mobilepay,
    CheckoutMultibancoPaymentMethodOptions Function()? multibanco,
    CheckoutNaverPayPaymentMethodOptions Function()? naverPay,
    CheckoutOxxoPaymentMethodOptions Function()? oxxo,
    CheckoutP24PaymentMethodOptions Function()? p24,
    CheckoutPaycoPaymentMethodOptions Function()? payco,
    CheckoutPaynowPaymentMethodOptions Function()? paynow,
    CheckoutPaypalPaymentMethodOptions Function()? paypal,
    CheckoutPaytoPaymentMethodOptions Function()? payto,
    CheckoutPixPaymentMethodOptions Function()? pix,
    CheckoutRevolutPayPaymentMethodOptions Function()? revolutPay,
    CheckoutSamsungPayPaymentMethodOptions Function()? samsungPay,
    CheckoutSatispayPaymentMethodOptions Function()? satispay,
    CheckoutSepaDebitPaymentMethodOptions Function()? sepaDebit,
    CheckoutSofortPaymentMethodOptions Function()? sofort,
    CheckoutSwishPaymentMethodOptions Function()? swish,
    CheckoutTwintPaymentMethodOptions Function()? twint,
    CheckoutUsBankAccountPaymentMethodOptions Function()? usBankAccount,
  }) {
    return CheckoutSessionPaymentMethodOptions(
