...
import 'post_checkout_sessions_request_custom_fields_label_type.dart';final class PostCheckoutSessionsRequestCustomFieldsLabel {const PostCheckoutSessionsRequestCustomFieldsLabel({required this.custom, required this.type, });
