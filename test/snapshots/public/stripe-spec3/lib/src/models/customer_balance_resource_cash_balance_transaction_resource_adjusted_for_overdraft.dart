...
///
final class CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft {
  const CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft({
    required this.balanceTransaction,
    required this.linkedTransaction,
  });

  factory CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft.fromJson(
    Map<String, dynamic> json,
  ) {
    return CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft(
      balanceTransaction:
          CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraftBalanceTransaction.fromJson(
            json['balance_transaction'] as Map<String, dynamic>,
          ),
      linkedTransaction:
          CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraftLinkedTransaction.fromJson(
            json['linked_transaction'] as Map<String, dynamic>,
          ),
    );
  }
  ...
  final CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraftBalanceTransaction
  balanceTransaction;
  ...
  final CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraftLinkedTransaction
  linkedTransaction;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('balance_transaction') &&
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft &&
  ...
  @override
  int get hashCode {
    return Object.hash(balanceTransaction, linkedTransaction);
  }

  @override
  String toString() {
    return 'CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft(balanceTransaction: $balanceTransaction, linkedTransaction: $linkedTransaction)';
  }
}
