...
import 'package:collection/collection.dart';import 'price.dart';import 'subscription_item_billing_thresholds2.dart';import 'subscription_item_discounts.dart';import 'subscription_item_object.dart';import 'tax_rate.dart';/// Subscription items allow you to create customer subscriptions with more than
...
factory SubscriptionItem.fromJson(Map<String, dynamic> json) { return SubscriptionItem(
  ...
  discounts: (json['discounts'] as List<dynamic>).map((e) => SubscriptionItemDiscounts.fromJson(e as Map<String, dynamic>)).toList(),
