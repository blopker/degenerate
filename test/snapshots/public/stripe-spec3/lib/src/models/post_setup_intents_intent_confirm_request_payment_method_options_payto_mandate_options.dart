...
import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_amount.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_amount_type.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_end_date.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_payment_schedule.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_payments_per_period.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_purpose.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_payto_mandate_options_start_date.dart';final class PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions {const PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions({this.amount, this.amountType, this.endDate, this.paymentSchedule, this.paymentsPerPeriod, this.purpose, this.startDate, });
...
factory PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions(
  amount: json['amount'] != null
        ? PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsAmount.fromJson(json['amount'] as Map<String, dynamic>)
        : null,
  ...
  endDate: json['end_date'] != null
        ? PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsEndDate.fromJson(json['end_date'] as Map<String, dynamic>)
        : null,
  ...
  paymentsPerPeriod: json['payments_per_period'] != null
        ? PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsPaymentsPerPeriod.fromJson(json['payments_per_period'] as Map<String, dynamic>)
        : null,
  ...
  startDate: json['start_date'] != null
        ? PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsStartDate.fromJson(json['start_date'] as Map<String, dynamic>)
        : null,
); }
