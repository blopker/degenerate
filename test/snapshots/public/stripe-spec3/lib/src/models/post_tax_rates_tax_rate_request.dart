...
import 'package:collection/collection.dart';import 'post_tax_rates_tax_rate_request_metadata.dart';import 'post_tax_rates_tax_rate_request_tax_type.dart';final class PostTaxRatesTaxRateRequest {const PostTaxRatesTaxRateRequest({this.active, this.country, this.description, this.displayName, this.expand, this.jurisdiction, this.metadata, this.state, this.taxType, });
