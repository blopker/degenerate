...
import 'package:collection/collection.dart';import 'post_customers_customer_funding_instructions_request_bank_transfer.dart';import 'post_customers_customer_funding_instructions_request_funding_type.dart';final class PostCustomersCustomerFundingInstructionsRequest {const PostCustomersCustomerFundingInstructionsRequest({required this.bankTransfer, required this.currency, this.expand, required this.fundingType, });
