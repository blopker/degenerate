...
import 'post_tax_registrations_request_country_options_cr_type.dart';final class PostTaxRegistrationsRequestCountryOptionsCr {const PostTaxRegistrationsRequestCountryOptionsCr({required this.type});
