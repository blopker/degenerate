...
final class CheckoutSessionLocale {
  const CheckoutSessionLocale._(this.value);

  factory CheckoutSessionLocale.fromJson(String json) {
    return switch (json) {
      'auto' => auto,
      'bg' => bg,
      'cs' => cs,
  ...
  static const List<CheckoutSessionLocale> values = [
    auto,
    bg,
    cs,
    da,
  ...
  @override
  String toString() {
    return 'CheckoutSessionLocale($value)';
  }
}
