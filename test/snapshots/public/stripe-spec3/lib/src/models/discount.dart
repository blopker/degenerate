...
final class Discount {
  ...
  factory Discount.fromJson(Map<String, dynamic> json) {
    return Discount(
      ...
      promotionCode: json['promotion_code'] != null
          ? DiscountPromotionCode.fromJson(
  ...
  Discount copyWith({
    ...
    DiscountCustomer? Function()? customer,
    ...
    DiscountPromotionCode? Function()? promotionCode,
  ...
  @override
  String toString() {
    return 'Discount(checkoutSession: $checkoutSession, customer: $customer, customerAccount: $customerAccount, end: $end, id: $id, invoice: $invoice, invoiceItem: $invoiceItem, object: $object, promotionCode: $promotionCode, source: $source, start: $start, subscription: $subscription, subscriptionItem: $subscriptionItem)';
  }
}
