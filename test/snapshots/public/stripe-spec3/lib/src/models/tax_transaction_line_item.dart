...
import 'tax_transaction_line_item_object.dart';
import 'tax_transaction_line_item_reversal.dart';
import 'tax_transaction_line_item_tax_behavior.dart';
import 'tax_transaction_line_item_type.dart';

///
final class TaxTransactionLineItem {
  const TaxTransactionLineItem({
  ...
  factory TaxTransactionLineItem.fromJson(Map<String, dynamic> json) {
    return TaxTransactionLineItem(
      ...
      reversal: json['reversal'] != null
          ? TaxTransactionLineItemReversal.fromJson(
              json['reversal'] as Map<String, dynamic>,
            )
          : null,
      taxBehavior: TaxTransactionLineItemTaxBehavior.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        ...
        json.containsKey('tax_code') &&
        json['tax_code'] is String &&
        json.containsKey('type');
  }

  TaxTransactionLineItem copyWith({
    int? amount,
    int? amountTax,
    String? id,
    bool? livemode,
    Map<String, String>? Function()? metadata,
    TaxTransactionLineItemObject? object,
    String? Function()? product,
    int? quantity,
    String? reference,
    TaxTransactionLineItemReversal? Function()? reversal,
    TaxTransactionLineItemTaxBehavior? taxBehavior,
    String? taxCode,
    TaxTransactionLineItemType? type,
  }) {
    return TaxTransactionLineItem(
  ...
  @override
  String toString() {
    return 'TaxTransactionLineItem(amount: $amount, amountTax: $amountTax, id: $id, livemode: $livemode, metadata: $metadata, object: $object, product: $product, quantity: $quantity, reference: $reference, reversal: $reversal, taxBehavior: $taxBehavior, taxCode: $taxCode, type: $type)';
  }
}
