...
///
final class CheckoutCustomerBalanceBankTransferPaymentMethodOptions {
  const CheckoutCustomerBalanceBankTransferPaymentMethodOptions({
    this.euBankTransfer,
  ...
  factory CheckoutCustomerBalanceBankTransferPaymentMethodOptions.fromJson(
    ...
    return CheckoutCustomerBalanceBankTransferPaymentMethodOptions(
      ...
      requestedAddressTypes: (json['requested_address_types'] as List<dynamic>?)
          ?.map(
            (e) =>
                CheckoutCustomerBalanceBankTransferPaymentMethodOptionsRequestedAddressTypes.fromJson(
                  e as String,
                ),
          )
          .toList(),
  ...
  CheckoutCustomerBalanceBankTransferPaymentMethodOptions copyWith({
    ...
    Function()?
    requestedAddressTypes,
    CheckoutCustomerBalanceBankTransferPaymentMethodOptionsType? Function()?
    type,
  }) {
    return CheckoutCustomerBalanceBankTransferPaymentMethodOptions(
  ...
  @override
  String toString() {
    return 'CheckoutCustomerBalanceBankTransferPaymentMethodOptions(euBankTransfer: $euBankTransfer, requestedAddressTypes: $requestedAddressTypes, type: $type)';
  }
}
