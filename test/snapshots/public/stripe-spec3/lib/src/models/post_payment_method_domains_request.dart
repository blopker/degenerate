...
import 'package:collection/collection.dart';final class PostPaymentMethodDomainsRequest {const PostPaymentMethodDomainsRequest({required this.domainName, this.enabled, this.expand, });
