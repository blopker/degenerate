...
final class SourceTypeSepaDebit {
  ...
  factory SourceTypeSepaDebit.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'SourceTypeSepaDebit(bankCode: $bankCode, branchCode: $branchCode, country: $country, fingerprint: $fingerprint, last4: $last4, mandateReference: $mandateReference, mandateUrl: $mandateUrl)';
  }
}
