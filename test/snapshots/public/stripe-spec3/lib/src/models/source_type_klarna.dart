...
final class SourceTypeKlarna {
  ...
  factory SourceTypeKlarna.fromJson(Map<String, dynamic> json) {
    return SourceTypeKlarna(
      ...
      payLaterAssetUrlsDescriptive:
          json['pay_later_asset_urls_descriptive'] as String?,
      payLaterAssetUrlsStandard:
          json['pay_later_asset_urls_standard'] as String?,
      ...
      payNowAssetUrlsDescriptive:
          json['pay_now_asset_urls_descriptive'] as String?,
      ...
      payOverTimeAssetUrlsDescriptive:
          json['pay_over_time_asset_urls_descriptive'] as String?,
      payOverTimeAssetUrlsStandard:
          json['pay_over_time_asset_urls_standard'] as String?,
      ...
      shippingDelay: json['shipping_delay'] != null
          ? (json['shipping_delay'] as num).toInt()
          : null,
  ...
  SourceTypeKlarna copyWith({
    String Function()? backgroundImageUrl,
    String? Function()? clientToken,
    String Function()? firstName,
    String Function()? lastName,
    String Function()? locale,
    String Function()? logoUrl,
    String Function()? pageTitle,
    String Function()? payLaterAssetUrlsDescriptive,
    String Function()? payLaterAssetUrlsStandard,
    String Function()? payLaterName,
    String Function()? payLaterRedirectUrl,
    String Function()? payNowAssetUrlsDescriptive,
    String Function()? payNowAssetUrlsStandard,
    String Function()? payNowName,
    String Function()? payNowRedirectUrl,
    String Function()? payOverTimeAssetUrlsDescriptive,
    String Function()? payOverTimeAssetUrlsStandard,
    String Function()? payOverTimeName,
    String Function()? payOverTimeRedirectUrl,
    String Function()? paymentMethodCategories,
    String Function()? purchaseCountry,
    String Function()? purchaseType,
    String Function()? redirectUrl,
    int Function()? shippingDelay,
    String Function()? shippingFirstName,
    String Function()? shippingLastName,
  }) {
    return SourceTypeKlarna(
      ...
      payLaterAssetUrlsDescriptive: payLaterAssetUrlsDescriptive != null
          ? payLaterAssetUrlsDescriptive()
          : this.payLaterAssetUrlsDescriptive,
      payLaterAssetUrlsStandard: payLaterAssetUrlsStandard != null
          ? payLaterAssetUrlsStandard()
          : this.payLaterAssetUrlsStandard,
      payLaterName: payLaterName != null ? payLaterName() : this.payLaterName,
      payLaterRedirectUrl: payLaterRedirectUrl != null
          ? payLaterRedirectUrl()
          : this.payLaterRedirectUrl,
      payNowAssetUrlsDescriptive: payNowAssetUrlsDescriptive != null
          ? payNowAssetUrlsDescriptive()
          : this.payNowAssetUrlsDescriptive,
      payNowAssetUrlsStandard: payNowAssetUrlsStandard != null
      ...
      payNowRedirectUrl: payNowRedirectUrl != null
          ? payNowRedirectUrl()
          : this.payNowRedirectUrl,
      payOverTimeAssetUrlsDescriptive: payOverTimeAssetUrlsDescriptive != null
          ? payOverTimeAssetUrlsDescriptive()
          : this.payOverTimeAssetUrlsDescriptive,
      payOverTimeAssetUrlsStandard: payOverTimeAssetUrlsStandard != null
          ? payOverTimeAssetUrlsStandard()
          : this.payOverTimeAssetUrlsStandard,
      payOverTimeName: payOverTimeName != null
          ? payOverTimeName()
          : this.payOverTimeName,
      payOverTimeRedirectUrl: payOverTimeRedirectUrl != null
          ? payOverTimeRedirectUrl()
          : this.payOverTimeRedirectUrl,
      paymentMethodCategories: paymentMethodCategories != null
          ? paymentMethodCategories()
          : this.paymentMethodCategories,
      purchaseCountry: purchaseCountry != null
          ? purchaseCountry()
          : this.purchaseCountry,
      purchaseType: purchaseType != null ? purchaseType() : this.purchaseType,
      redirectUrl: redirectUrl != null ? redirectUrl() : this.redirectUrl,
      shippingDelay: shippingDelay != null
          ? shippingDelay()
          : this.shippingDelay,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SourceTypeKlarna &&
            ...
            payOverTimeAssetUrlsDescriptive ==
                other.payOverTimeAssetUrlsDescriptive &&
            payOverTimeAssetUrlsStandard ==
                other.payOverTimeAssetUrlsStandard &&
