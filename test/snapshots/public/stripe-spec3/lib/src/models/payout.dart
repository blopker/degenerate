...
final class Payout {
  ...
  factory Payout.fromJson(Map<String, dynamic> json) {
    return Payout(
      ...
      balanceTransaction: json['balance_transaction'] != null
          ? PayoutBalanceTransaction.fromJson(
      ...
      failureBalanceTransaction: json['failure_balance_transaction'] != null
          ? PayoutFailureBalanceTransaction.fromJson(
      ...
      originalPayout: json['original_payout'] != null
          ? PayoutOriginalPayout.fromJson(
              json['original_payout'] as Map<String, dynamic>,
            )
          : null,
      payoutMethod: json['payout_method'] as String?,
      reconciliationStatus: PayoutReconciliationStatus.fromJson(
        json['reconciliation_status'] as String,
      ),
      reversedBy: json['reversed_by'] != null
          ? PayoutReversedBy.fromJson(
              json['reversed_by'] as Map<String, dynamic>,
            )
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        json['amount'] is num &&
        json.containsKey('arrival_date') &&
        json['arrival_date'] is num &&
        json.containsKey('automatic') &&
        json['automatic'] is bool &&
  ...
  Payout copyWith({
    int? amount,
    PayoutApplicationFee? Function()? applicationFee,
    int? Function()? applicationFeeAmount,
    int? arrivalDate,
    bool? automatic,
    PayoutBalanceTransaction? Function()? balanceTransaction,
    int? created,
    String? currency,
    String? Function()? description,
    PayoutDestination? Function()? destination,
    PayoutFailureBalanceTransaction? Function()? failureBalanceTransaction,
    ...
    String? method,
    PayoutObject? object,
    PayoutOriginalPayout? Function()? originalPayout,
    String? Function()? payoutMethod,
    PayoutReconciliationStatus? reconciliationStatus,
    PayoutReversedBy? Function()? reversedBy,
    String? sourceType,
    String? Function()? statementDescriptor,
    String? status,
    PayoutTraceId? Function()? traceId,
    PayoutType? type,
  }) {
    return Payout(
      ...
      originalPayout: originalPayout != null
          ? originalPayout()
          : this.originalPayout,
