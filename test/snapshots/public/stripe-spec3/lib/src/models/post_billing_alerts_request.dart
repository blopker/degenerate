...
import 'package:collection/collection.dart';import 'post_billing_alerts_request_alert_type.dart';import 'post_billing_alerts_request_usage_threshold.dart';final class PostBillingAlertsRequest {const PostBillingAlertsRequest({required this.alertType, this.expand, required this.title, this.usageThreshold, });
