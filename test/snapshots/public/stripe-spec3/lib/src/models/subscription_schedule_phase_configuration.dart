...
import 'stackable_discount_with_discount_settings_and_discount_end.dart';
...
import 'subscription_schedule_phase_configuration_billing_thresholds.dart';
...
import 'subscription_schedule_phase_configuration_invoice_settings.dart';
...
import 'subscription_schedule_phase_configuration_transfer_data.dart';
import 'tax_rate.dart';

/// A phase describes the plans, coupon, and trialing status of a subscription for a predefined time period.
final class SubscriptionSchedulePhaseConfiguration {
  ...
  factory SubscriptionSchedulePhaseConfiguration.fromJson(
    ...
    return SubscriptionSchedulePhaseConfiguration(
      ...
      automaticTax: json['automatic_tax'] != null
          ? SchedulesPhaseAutomaticTax.fromJson(
      ...
      billingThresholds: json['billing_thresholds'] != null
          ? SubscriptionSchedulePhaseConfigurationBillingThresholds.fromJson(
      ...
      defaultPaymentMethod: json['default_payment_method'] != null
          ? SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod.fromJson(
      ...
      discounts: (json['discounts'] as List<dynamic>)
          .map(
            (e) => StackableDiscountWithDiscountSettingsAndDiscountEnd.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      invoiceSettings: json['invoice_settings'] != null
          ? SubscriptionSchedulePhaseConfigurationInvoiceSettings.fromJson(
              json['invoice_settings'] as Map<String, dynamic>,
            )
          : null,
      items: (json['items'] as List<dynamic>)
          .map(
            (e) => SubscriptionScheduleConfigurationItem.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      onBehalfOf: json['on_behalf_of'] != null
          ? SubscriptionSchedulePhaseConfigurationOnBehalfOf.fromJson(
              json['on_behalf_of'] as Map<String, dynamic>,
            )
          : null,
      prorationBehavior:
          SubscriptionSchedulePhaseConfigurationProrationBehavior.fromJson(
            json['proration_behavior'] as String,
          ),
      startDate: (json['start_date'] as num).toInt(),
      transferData: json['transfer_data'] != null
          ? SubscriptionSchedulePhaseConfigurationTransferData.fromJson(
  ...
  final SubscriptionSchedulePhaseConfigurationBillingCycleAnchor?
  billingCycleAnchor;

  /// Define thresholds at which an invoice will be sent, and the subscription advanced to a new billing period
  final SubscriptionSchedulePhaseConfigurationBillingThresholds?
  billingThresholds;

  /// Either `charge_automatically`, or `send_invoice`. When charging automatically, Stripe will attempt to pay the underlying subscription at the end of each billing cycle using the default source attached to the customer. When sending an invoice, Stripe will email your customer an invoice with payment instructions and mark the subscription as `active`.
  final SubscriptionSchedulePhaseConfigurationCollectionMethod?
  collectionMethod;
  ...
  final SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod?
  ...
  final SubscriptionSchedulePhaseConfigurationProrationBehavior
  prorationBehavior;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('add_invoice_items') &&
        json.containsKey('currency') &&
        json['currency'] is String &&
        json.containsKey('discounts') &&
        json.containsKey('end_date') &&
        json['end_date'] is num &&
  ...
  SubscriptionSchedulePhaseConfiguration copyWith({
    List<SubscriptionScheduleAddInvoiceItem>? addInvoiceItems,
    double? Function()? applicationFeePercent,
    SchedulesPhaseAutomaticTax Function()? automaticTax,
    SubscriptionSchedulePhaseConfigurationBillingCycleAnchor? Function()?
    billingCycleAnchor,
    SubscriptionSchedulePhaseConfigurationBillingThresholds? Function()?
    billingThresholds,
    SubscriptionSchedulePhaseConfigurationCollectionMethod? Function()?
    collectionMethod,
    String? currency,
    SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod? Function()?
    defaultPaymentMethod,
    List<TaxRate>? Function()? defaultTaxRates,
    String? Function()? description,
    List<StackableDiscountWithDiscountSettingsAndDiscountEnd>? discounts,
    int? endDate,
    SubscriptionSchedulePhaseConfigurationInvoiceSettings? Function()?
    invoiceSettings,
    List<SubscriptionScheduleConfigurationItem>? items,
    Map<String, String>? Function()? metadata,
    SubscriptionSchedulePhaseConfigurationOnBehalfOf? Function()? onBehalfOf,
    SubscriptionSchedulePhaseConfigurationProrationBehavior? prorationBehavior,
    int? startDate,
    SubscriptionSchedulePhaseConfigurationTransferData? Function()?
    transferData,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(addInvoiceItems),
      applicationFeePercent,
      automaticTax,
      billingCycleAnchor,
      billingThresholds,
