...
import 'post_transfers_request_source_type.dart';

final class PostTransfersRequest {
  ...
  factory PostTransfersRequest.fromJson(Map<String, dynamic> json) {
    return PostTransfersRequest(
      ...
      sourceType: json['source_type'] != null
          ? PostTransfersRequestSourceType.fromJson(
  ...
  PostTransfersRequest copyWith({
    ...
    String Function()? sourceTransaction,
    PostTransfersRequestSourceType Function()? sourceType,
  ...
  @override
  String toString() {
    return 'PostTransfersRequest(amount: $amount, currency: $currency, description: $description, destination: $destination, expand: $expand, metadata: $metadata, sourceTransaction: $sourceTransaction, sourceType: $sourceType, transferGroup: $transferGroup)';
  }
}
