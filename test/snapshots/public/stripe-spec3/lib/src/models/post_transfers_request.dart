...
import 'package:collection/collection.dart';import 'post_transfers_request_source_type.dart';final class PostTransfersRequest {const PostTransfersRequest({this.amount, required this.currency, this.description, required this.destination, this.expand, this.metadata, this.sourceTransaction, this.sourceType, this.transferGroup, });
