...
///
final class DisputeEvidenceDetails {
  const DisputeEvidenceDetails({
    this.dueBy,
  ...
  factory DisputeEvidenceDetails.fromJson(Map<String, dynamic> json) {
    return DisputeEvidenceDetails(
      dueBy: json['due_by'] != null ? (json['due_by'] as num).toInt() : null,
      enhancedEligibility: DisputeEnhancedEligibility.fromJson(
        json['enhanced_eligibility'] as Map<String, dynamic>,
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('enhanced_eligibility') &&
        json.containsKey('has_evidence') &&
        json['has_evidence'] is bool &&
        json.containsKey('past_due') &&
        json['past_due'] is bool &&
        json.containsKey('submission_count') &&
        json['submission_count'] is num;
  }

  DisputeEvidenceDetails copyWith({
    int? Function()? dueBy,
  ...
  @override
  String toString() {
    return 'DisputeEvidenceDetails(dueBy: $dueBy, enhancedEligibility: $enhancedEligibility, hasEvidence: $hasEvidence, pastDue: $pastDue, submissionCount: $submissionCount)';
  }
}
