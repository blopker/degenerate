...
import 'customer_cash_balance.dart';
...
final class Customer {
  ...
  factory Customer.fromJson(Map<String, dynamic> json) {
    return Customer(
      ...
      defaultSource: json['default_source'] != null
          ? CustomerDefaultSource.fromJson(
      ...
      invoiceCreditBalance:
          (json['invoice_credit_balance'] as Map<String, dynamic>?)?.map(
      ...
      subscriptions: json['subscriptions'] != null
          ? CustomerSubscriptions.fromJson(
  ...
  Customer copyWith({
    CustomerAddress? Function()? address,
    int Function()? balance,
    String Function()? businessName,
    CustomerCashBalance? Function()? cashBalance,
    int? created,
    String? Function()? currency,
    String? Function()? customerAccount,
    CustomerDefaultSource? Function()? defaultSource,
    bool? Function()? delinquent,
    String? Function()? description,
    CustomerDiscount? Function()? discount,
    String? Function()? email,
    String? id,
    String Function()? individualName,
    Map<String, int> Function()? invoiceCreditBalance,
    String? Function()? invoicePrefix,
    InvoiceSettingCustomerSetting Function()? invoiceSettings,
    bool? livemode,
    ...
    CustomerShipping? Function()? shipping,
    CustomerSources Function()? sources,
    CustomerSubscriptions Function()? subscriptions,
    CustomerTax Function()? tax,
    CustomerTaxExempt? Function()? taxExempt,
    CustomerTaxIds Function()? taxIds,
    CustomerTestClock? Function()? testClock,
  }) {
    return Customer(
      ...
      individualName: individualName != null
          ? individualName()
          : this.individualName,
      invoiceCreditBalance: invoiceCreditBalance != null
          ? invoiceCreditBalance()
          : this.invoiceCreditBalance,
  ...
  @override
  String toString() {
    return 'Customer(address: $address, balance: $balance, businessName: $businessName, cashBalance: $cashBalance, created: $created, currency: $currency, customerAccount: $customerAccount, defaultSource: $defaultSource, delinquent: $delinquent, description: $description, discount: $discount, email: $email, id: $id, individualName: $individualName, invoiceCreditBalance: $invoiceCreditBalance, invoicePrefix: $invoicePrefix, invoiceSettings: $invoiceSettings, livemode: $livemode, metadata: $metadata, name: $name, nextInvoiceSequence: $nextInvoiceSequence, object: $object, phone: $phone, preferredLocales: $preferredLocales, shipping: $shipping, sources: $sources, subscriptions: $subscriptions, tax: $tax, taxExempt: $taxExempt, taxIds: $taxIds, testClock: $testClock)';
  }
}
