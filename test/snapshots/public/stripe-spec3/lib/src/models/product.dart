...
import 'product_package_dimensions.dart';
...
final class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    return Product(
      ...
      defaultPrice: json['default_price'] != null
          ? ProductDefaultPrice.fromJson(
              json['default_price'] as Map<String, dynamic>,
            )
          : null,
      ...
      marketingFeatures: (json['marketing_features'] as List<dynamic>)
          .map(
            (e) => ProductMarketingFeature.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      ...
      packageDimensions: json['package_dimensions'] != null
          ? ProductPackageDimensions.fromJson(
  ...
  Product copyWith({
    bool? active,
    int? created,
    ProductDefaultPrice? Function()? defaultPrice,
    ...
    ProductPackageDimensions? Function()? packageDimensions,
    bool? Function()? shippable,
    String? Function()? statementDescriptor,
    ProductTaxCode? Function()? taxCode,
  ...
  int get hashCode {
    return Object.hash(
      ...
      livemode,
      Object.hashAll(marketingFeatures),
      metadata,
      name,
      object,
      packageDimensions,
