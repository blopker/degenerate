...
final class EphemeralKey {
  ...
  @override
  int get hashCode {
    return Object.hash(created, expires, id, livemode, object, secret);
  }

  @override
  String toString() {
    return 'EphemeralKey(created: $created, expires: $expires, id: $id, livemode: $livemode, object: $object, secret: $secret)';
  }
}
