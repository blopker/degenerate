...
import 'treasury_debit_reversal_linked_flows.dart';
import 'treasury_debit_reversal_network.dart';
import 'treasury_debit_reversal_object.dart';
import 'treasury_debit_reversal_status.dart';
import 'treasury_debit_reversal_transaction.dart';
...
final class TreasuryDebitReversal {
  ...
  factory TreasuryDebitReversal.fromJson(Map<String, dynamic> json) {
    return TreasuryDebitReversal(
      ...
      linkedFlows: json['linked_flows'] != null
          ? TreasuryDebitReversalLinkedFlows.fromJson(
      ...
      statusTransitions:
          TreasuryReceivedDebitsResourceStatusTransitions.fromJson(
            json['status_transitions'] as Map<String, dynamic>,
          ),
      transaction: json['transaction'] != null
          ? TreasuryDebitReversalTransaction.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        ...
        json.containsKey('received_debit') &&
        json['received_debit'] is String &&
        json.containsKey('status') &&
        json.containsKey('status_transitions');
  }

  TreasuryDebitReversal copyWith({
    int? amount,
    int? created,
    String? currency,
    ...
    String? id,
    TreasuryDebitReversalLinkedFlows? Function()? linkedFlows,
    bool? livemode,
    Map<String, String>? metadata,
    TreasuryDebitReversalNetwork? network,
    TreasuryDebitReversalObject? object,
    String? receivedDebit,
    TreasuryDebitReversalStatus? status,
    TreasuryReceivedDebitsResourceStatusTransitions? statusTransitions,
    TreasuryDebitReversalTransaction? Function()? transaction,
  }) {
    return TreasuryDebitReversal(
