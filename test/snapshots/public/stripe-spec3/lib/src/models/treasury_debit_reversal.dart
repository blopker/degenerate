...
import 'treasury_debit_reversal_linked_flows.dart';import 'treasury_debit_reversal_network.dart';import 'treasury_debit_reversal_object.dart';import 'treasury_debit_reversal_status.dart';import 'treasury_debit_reversal_transaction.dart';import 'treasury_received_debits_resource_status_transitions.dart';/// You can reverse some [ReceivedDebits](https://api.stripe.com#received_debits) depending on their network and source flow. Reversing a ReceivedDebit leads to the creation of a new object known as a DebitReversal.
...
factory TreasuryDebitReversal.fromJson(Map<String, dynamic> json) { return TreasuryDebitReversal(
  ...
  linkedFlows: json['linked_flows'] != null
        ? TreasuryDebitReversalLinkedFlows.fromJson(json['linked_flows'] as Map<String, dynamic>)
        : null,
  ...
  transaction: json['transaction'] != null
        ? TreasuryDebitReversalTransaction.fromJson(json['transaction'] as Map<String, dynamic>)
        : null,
); }
