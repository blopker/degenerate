...
///
final class InboundTransfersPaymentMethodDetailsUsBankAccount {
  ...
  factory InboundTransfersPaymentMethodDetailsUsBankAccount.fromJson(
    Map<String, dynamic> json,
  ) {
    return InboundTransfersPaymentMethodDetailsUsBankAccount(
      accountHolderType: json['account_holder_type'] != null
          ? InboundTransfersPaymentMethodDetailsUsBankAccountAccountHolderType.fromJson(
              json['account_holder_type'] as String,
            )
          : null,
      accountType: json['account_type'] != null
          ? InboundTransfersPaymentMethodDetailsUsBankAccountAccountType.fromJson(
      ...
      mandate: json['mandate'] != null
          ? InboundTransfersPaymentMethodDetailsUsBankAccountMandate.fromJson(
              json['mandate'] as Map<String, dynamic>,
            )
          : null,
      network:
          InboundTransfersPaymentMethodDetailsUsBankAccountNetwork.fromJson(
  ...
  final InboundTransfersPaymentMethodDetailsUsBankAccountAccountHolderType?
  accountHolderType;

  /// Account type: checkings or savings. Defaults to checking if omitted.
  final InboundTransfersPaymentMethodDetailsUsBankAccountAccountType?
  accountType;
  ...
  InboundTransfersPaymentMethodDetailsUsBankAccount copyWith({
    InboundTransfersPaymentMethodDetailsUsBankAccountAccountHolderType?
    Function()?
    accountHolderType,
    InboundTransfersPaymentMethodDetailsUsBankAccountAccountType? Function()?
    accountType,
    String? Function()? bankName,
    String? Function()? fingerprint,
    String? Function()? last4,
    InboundTransfersPaymentMethodDetailsUsBankAccountMandate Function()?
    mandate,
  ...
  @override
  String toString() {
    return 'InboundTransfersPaymentMethodDetailsUsBankAccount(accountHolderType: $accountHolderType, accountType: $accountType, bankName: $bankName, fingerprint: $fingerprint, last4: $last4, mandate: $mandate, network: $network, routingNumber: $routingNumber)';
  }
}
