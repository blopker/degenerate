...
import 'package:collection/collection.dart';import 'post_checkout_sessions_request_adaptive_pricing.dart';import 'post_checkout_sessions_request_after_expiration.dart';import 'post_checkout_sessions_request_automatic_tax.dart';import 'post_checkout_sessions_request_billing_address_collection.dart';import 'post_checkout_sessions_request_branding_settings.dart';import 'post_checkout_sessions_request_consent_collection.dart';import 'post_checkout_sessions_request_custom_fields.dart';import 'post_checkout_sessions_request_custom_text.dart';import 'post_checkout_sessions_request_customer_creation.dart';import 'post_checkout_sessions_request_customer_update.dart';import 'post_checkout_sessions_request_discounts.dart';import 'post_checkout_sessions_request_excluded_payment_method_types.dart';import 'post_checkout_sessions_request_invoice_creation.dart';import 'post_checkout_sessions_request_line_items.dart';import 'post_checkout_sessions_request_locale.dart';import 'post_checkout_sessions_request_mode.dart';import 'post_checkout_sessions_request_name_collection.dart';import 'post_checkout_sessions_request_optional_items.dart';import 'post_checkout_sessions_request_origin_context.dart';import 'post_checkout_sessions_request_payment_intent_data.dart';import 'post_checkout_sessions_request_payment_method_collection.dart';import 'post_checkout_sessions_request_payment_method_data.dart';import 'post_checkout_sessions_request_payment_method_options.dart';import 'post_checkout_sessions_request_payment_method_types.dart';import 'post_checkout_sessions_request_permissions.dart';import 'post_checkout_sessions_request_phone_number_collection.dart';import 'post_checkout_sessions_request_redirect_on_completion.dart';import 'post_checkout_sessions_request_saved_payment_method_options.dart';import 'post_checkout_sessions_request_setup_intent_data.dart';import 'post_checkout_sessions_request_shipping_address_collection.dart';import 'post_checkout_sessions_request_shipping_options.dart';import 'post_checkout_sessions_request_submit_type.dart';import 'post_checkout_sessions_request_subscription_data.dart';import 'post_checkout_sessions_request_tax_id_collection.dart';import 'post_checkout_sessions_request_ui_mode.dart';import 'post_checkout_sessions_request_wallet_options.dart';final class PostCheckoutSessionsRequest {const PostCheckoutSessionsRequest({this.adaptivePricing, this.afterExpiration, this.allowPromotionCodes, this.automaticTax, this.billingAddressCollection, this.brandingSettings, this.cancelUrl, this.clientReferenceId, this.consentCollection, this.currency, this.customFields, this.customText, this.customer, this.customerAccount, this.customerCreation, this.customerEmail, this.customerUpdate, this.discounts, this.excludedPaymentMethodTypes, this.expand, this.expiresAt, this.invoiceCreation, this.lineItems, this.locale, this.metadata, this.mode, this.nameCollection, this.optionalItems, this.originContext, this.paymentIntentData, this.paymentMethodCollection, this.paymentMethodConfiguration, this.paymentMethodData, this.paymentMethodOptions, this.paymentMethodTypes, this.permissions, this.phoneNumberCollection, this.redirectOnCompletion, this.returnUrl, this.savedPaymentMethodOptions, this.setupIntentData, this.shippingAddressCollection, this.shippingOptions, this.submitType, this.subscriptionData, this.successUrl, this.taxIdCollection, this.uiMode, this.walletOptions, });
