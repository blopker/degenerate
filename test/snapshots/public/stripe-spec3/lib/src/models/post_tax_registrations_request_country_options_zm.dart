...
import 'post_tax_registrations_request_country_options_zm_type.dart';final class PostTaxRegistrationsRequestCountryOptionsZm {const PostTaxRegistrationsRequestCountryOptionsZm({required this.type});
