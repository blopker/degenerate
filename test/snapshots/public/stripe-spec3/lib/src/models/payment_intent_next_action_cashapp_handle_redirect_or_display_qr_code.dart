...
///
final class PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode {
  ...
  factory PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode.fromJson(
    ...
    return PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode(
      ...
      qrCode: PaymentIntentNextActionCashappQrCode.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('hosted_instructions_url') &&
        json['hosted_instructions_url'] is String &&
        json.containsKey('mobile_auth_url') &&
        json['mobile_auth_url'] is String &&
        json.containsKey('qr_code');
  }

  PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(hostedInstructionsUrl, mobileAuthUrl, qrCode);
  }

  @override
  String toString() {
    return 'PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode(hostedInstructionsUrl: $hostedInstructionsUrl, mobileAuthUrl: $mobileAuthUrl, qrCode: $qrCode)';
  }
}
