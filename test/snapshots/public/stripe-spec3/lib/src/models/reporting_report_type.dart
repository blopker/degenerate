...
import 'reporting_report_type_object.dart';
...
final class ReportingReportType {
  const ReportingReportType({
  ...
  factory ReportingReportType.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('data_available_end') &&
        json['data_available_end'] is num &&
        json.containsKey('data_available_start') &&
        json['data_available_start'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
  ...
  ReportingReportType copyWith({
    int? dataAvailableEnd,
    int? dataAvailableStart,
    List<String>? Function()? defaultColumns,
    String? id,
    bool? livemode,
    String? name,
    ReportingReportTypeObject? object,
    int? updated,
    int? version,
  }) {
    return ReportingReportType(
  ...
  int get hashCode {
    return Object.hash(
      dataAvailableEnd,
      dataAvailableStart,
      Object.hashAll(defaultColumns ?? const []),
      id,
      livemode,
      name,
      object,
  ...
  @override
  String toString() {
    return 'ReportingReportType(dataAvailableEnd: $dataAvailableEnd, dataAvailableStart: $dataAvailableStart, defaultColumns: $defaultColumns, id: $id, livemode: $livemode, name: $name, object: $object, updated: $updated, version: $version)';
  }
}
