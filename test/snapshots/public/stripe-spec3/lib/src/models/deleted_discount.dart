...
final class DeletedDiscount {
  ...
  factory DeletedDiscount.fromJson(Map<String, dynamic> json) {
    return DeletedDiscount(
      checkoutSession: json['checkout_session'] as String?,
      customer: json['customer'] != null
          ? DeletedDiscountCustomer.fromJson(
      ...
      promotionCode: json['promotion_code'] != null
          ? DeletedDiscountPromotionCode.fromJson(
  ...
  DeletedDiscount copyWith({
    String? Function()? checkoutSession,
    DeletedDiscountCustomer? Function()? customer,
    ...
    DeletedDiscountPromotionCode? Function()? promotionCode,
    DiscountSource? source,
    int? start,
    String? Function()? subscription,
    String? Function()? subscriptionItem,
  }) {
    return DeletedDiscount(
  ...
  @override
  String toString() {
    return 'DeletedDiscount(checkoutSession: $checkoutSession, customer: $customer, customerAccount: $customerAccount, deleted: $deleted, id: $id, invoice: $invoice, invoiceItem: $invoiceItem, object: $object, promotionCode: $promotionCode, source: $source, start: $start, subscription: $subscription, subscriptionItem: $subscriptionItem)';
  }
}
