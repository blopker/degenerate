...
import 'setup_attempt_setup_error.dart';
...
final class SetupAttempt {
  ...
  factory SetupAttempt.fromJson(Map<String, dynamic> json) {
    return SetupAttempt(
      application: json['application'] != null
          ? SetupAttemptApplication.fromJson(
      ...
      setupError: json['setup_error'] != null
          ? SetupAttemptSetupError.fromJson(
              json['setup_error'] as Map<String, dynamic>,
            )
          : null,
      setupIntent: SetupAttemptSetupIntent.fromJson(
  ...
  SetupAttempt copyWith({
    SetupAttemptApplication? Function()? application,
    bool Function()? attachToSelf,
    int? created,
    SetupAttemptCustomer? Function()? customer,
    String? Function()? customerAccount,
    List<SetupAttemptFlowDirections>? Function()? flowDirections,
    String? id,
    bool? livemode,
    SetupAttemptObject? object,
    SetupAttemptOnBehalfOf? Function()? onBehalfOf,
    SetupAttemptPaymentMethod? paymentMethod,
    SetupAttemptPaymentMethodDetails? paymentMethodDetails,
    SetupAttemptSetupError? Function()? setupError,
  ...
  @override
  String toString() {
    return 'SetupAttempt(application: $application, attachToSelf: $attachToSelf, created: $created, customer: $customer, customerAccount: $customerAccount, flowDirections: $flowDirections, id: $id, livemode: $livemode, object: $object, onBehalfOf: $onBehalfOf, paymentMethod: $paymentMethod, paymentMethodDetails: $paymentMethodDetails, setupError: $setupError, setupIntent: $setupIntent, status: $status, usage: $usage)';
  }
}
