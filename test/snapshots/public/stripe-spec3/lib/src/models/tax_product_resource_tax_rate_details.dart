...
final class TaxProductResourceTaxRateDetails {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('percentage_decimal') &&
        json['percentage_decimal'] is String;
  }

  TaxProductResourceTaxRateDetails copyWith({
    String? Function()? country,
    TaxProductResourceTaxRateDetailsFlatAmount? Function()? flatAmount,
    String? percentageDecimal,
    TaxProductResourceTaxRateDetailsRateType? Function()? rateType,
    String? Function()? state,
    TaxProductResourceTaxRateDetailsTaxType? Function()? taxType,
  }) {
    return TaxProductResourceTaxRateDetails(
  ...
  @override
  String toString() {
    return 'TaxProductResourceTaxRateDetails(country: $country, flatAmount: $flatAmount, percentageDecimal: $percentageDecimal, rateType: $rateType, state: $state, taxType: $taxType)';
  }
}
