...
///
final class PortalPaymentMethodUpdate {
  const PortalPaymentMethodUpdate({
    required this.enabled,
    this.paymentMethodConfiguration,
  });

  factory PortalPaymentMethodUpdate.fromJson(Map<String, dynamic> json) {
  ...
  PortalPaymentMethodUpdate copyWith({
    bool? enabled,
  ...
  @override
  String toString() {
    return 'PortalPaymentMethodUpdate(enabled: $enabled, paymentMethodConfiguration: $paymentMethodConfiguration)';
  }
}
