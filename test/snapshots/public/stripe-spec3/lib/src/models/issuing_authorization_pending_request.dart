...
///
final class IssuingAuthorizationPendingRequest {
  const IssuingAuthorizationPendingRequest({
  ...
  factory IssuingAuthorizationPendingRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return IssuingAuthorizationPendingRequest(
      amount: (json['amount'] as num).toInt(),
      amountDetails: json['amount_details'] != null
          ? IssuingAuthorizationPendingRequestAmountDetails.fromJson(
      ...
      networkRiskScore: json['network_risk_score'] != null
          ? (json['network_risk_score'] as num).toInt()
          : null,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        ...
        json.containsKey('is_amount_controllable') &&
        json['is_amount_controllable'] is bool &&
  ...
  IssuingAuthorizationPendingRequest copyWith({
    int? amount,
    IssuingAuthorizationPendingRequestAmountDetails? Function()? amountDetails,
    String? currency,
    bool? isAmountControllable,
    int? merchantAmount,
    String? merchantCurrency,
    int? Function()? networkRiskScore,
  }) {
    return IssuingAuthorizationPendingRequest(
      ...
      networkRiskScore: networkRiskScore != null
          ? networkRiskScore()
          : this.networkRiskScore,
    );
  }
  ...
  @override
  String toString() {
    return 'IssuingAuthorizationPendingRequest(amount: $amount, amountDetails: $amountDetails, currency: $currency, isAmountControllable: $isAmountControllable, merchantAmount: $merchantAmount, merchantCurrency: $merchantCurrency, networkRiskScore: $networkRiskScore)';
  }
}
