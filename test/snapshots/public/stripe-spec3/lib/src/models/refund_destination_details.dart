...
///
final class RefundDestinationDetails {
  ...
  factory RefundDestinationDetails.fromJson(Map<String, dynamic> json) {
    return RefundDestinationDetails(
      ...
      auBankTransfer: json['au_bank_transfer'] != null
          ? DestinationDetailsUnimplemented.fromJson(
              json['au_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      blik: json['blik'] != null
          ? RefundDestinationDetailsBlik.fromJson(
              json['blik'] as Map<String, dynamic>,
            )
          : null,
      brBankTransfer: json['br_bank_transfer'] != null
          ? RefundDestinationDetailsBrBankTransfer.fromJson(
              json['br_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      card: json['card'] != null
      ...
      crypto: json['crypto'] != null
          ? RefundDestinationDetailsCrypto.fromJson(
              json['crypto'] as Map<String, dynamic>,
            )
          : null,
      customerCashBalance: json['customer_cash_balance'] != null
          ? DestinationDetailsUnimplemented.fromJson(
              json['customer_cash_balance'] as Map<String, dynamic>,
            )
          : null,
      eps: json['eps'] != null
          ? DestinationDetailsUnimplemented.fromJson(
      ...
      euBankTransfer: json['eu_bank_transfer'] != null
          ? RefundDestinationDetailsEuBankTransfer.fromJson(
              json['eu_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      gbBankTransfer: json['gb_bank_transfer'] != null
          ? RefundDestinationDetailsGbBankTransfer.fromJson(
              json['gb_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      ...
      jpBankTransfer: json['jp_bank_transfer'] != null
          ? RefundDestinationDetailsJpBankTransfer.fromJson(
              json['jp_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      ...
      mbWay: json['mb_way'] != null
          ? RefundDestinationDetailsMbWay.fromJson(
              json['mb_way'] as Map<String, dynamic>,
            )
          : null,
      multibanco: json['multibanco'] != null
          ? RefundDestinationDetailsMultibanco.fromJson(
              json['multibanco'] as Map<String, dynamic>,
            )
          : null,
      mxBankTransfer: json['mx_bank_transfer'] != null
          ? RefundDestinationDetailsMxBankTransfer.fromJson(
              json['mx_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      nzBankTransfer: json['nz_bank_transfer'] != null
          ? DestinationDetailsUnimplemented.fromJson(
              json['nz_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      p24: json['p24'] != null
          ? RefundDestinationDetailsP24.fromJson(
      ...
      paypal: json['paypal'] != null
          ? RefundDestinationDetailsPaypal.fromJson(
      ...
      revolut: json['revolut'] != null
          ? DestinationDetailsUnimplemented.fromJson(
              json['revolut'] as Map<String, dynamic>,
            )
          : null,
      ...
      swish: json['swish'] != null
          ? RefundDestinationDetailsSwish.fromJson(
              json['swish'] as Map<String, dynamic>,
            )
          : null,
      thBankTransfer: json['th_bank_transfer'] != null
          ? RefundDestinationDetailsThBankTransfer.fromJson(
              json['th_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
      ...
      usBankTransfer: json['us_bank_transfer'] != null
          ? RefundDestinationDetailsUsBankTransfer.fromJson(
              json['us_bank_transfer'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (customerCashBalance != null)
        'customer_cash_balance': customerCashBalance?.toJson(),
  ...
  RefundDestinationDetails copyWith({
    DestinationDetailsUnimplemented Function()? affirm,
    DestinationDetailsUnimplemented Function()? afterpayClearpay,
    DestinationDetailsUnimplemented Function()? alipay,
    DestinationDetailsUnimplemented Function()? alma,
    DestinationDetailsUnimplemented Function()? amazonPay,
    DestinationDetailsUnimplemented Function()? auBankTransfer,
    RefundDestinationDetailsBlik Function()? blik,
    RefundDestinationDetailsBrBankTransfer Function()? brBankTransfer,
    RefundDestinationDetailsCard Function()? card,
    DestinationDetailsUnimplemented Function()? cashapp,
    RefundDestinationDetailsCrypto Function()? crypto,
    DestinationDetailsUnimplemented Function()? customerCashBalance,
    DestinationDetailsUnimplemented Function()? eps,
    RefundDestinationDetailsEuBankTransfer Function()? euBankTransfer,
    RefundDestinationDetailsGbBankTransfer Function()? gbBankTransfer,
    DestinationDetailsUnimplemented Function()? giropay,
    DestinationDetailsUnimplemented Function()? grabpay,
    RefundDestinationDetailsJpBankTransfer Function()? jpBankTransfer,
    DestinationDetailsUnimplemented Function()? klarna,
    RefundDestinationDetailsMbWay Function()? mbWay,
    RefundDestinationDetailsMultibanco Function()? multibanco,
    RefundDestinationDetailsMxBankTransfer Function()? mxBankTransfer,
    DestinationDetailsUnimplemented Function()? nzBankTransfer,
    RefundDestinationDetailsP24 Function()? p24,
    DestinationDetailsUnimplemented Function()? paynow,
    RefundDestinationDetailsPaypal Function()? paypal,
    DestinationDetailsUnimplemented Function()? pix,
    DestinationDetailsUnimplemented Function()? revolut,
    DestinationDetailsUnimplemented Function()? sofort,
    RefundDestinationDetailsSwish Function()? swish,
    RefundDestinationDetailsThBankTransfer Function()? thBankTransfer,
    DestinationDetailsUnimplemented Function()? twint,
    String? type,
    RefundDestinationDetailsUsBankTransfer Function()? usBankTransfer,
    DestinationDetailsUnimplemented Function()? wechatPay,
    DestinationDetailsUnimplemented Function()? zip,
  }) {
    return RefundDestinationDetails(
      ...
      auBankTransfer: auBankTransfer != null
          ? auBankTransfer()
          : this.auBankTransfer,
      blik: blik != null ? blik() : this.blik,
      brBankTransfer: brBankTransfer != null
          ? brBankTransfer()
          : this.brBankTransfer,
      ...
      mxBankTransfer: mxBankTransfer != null
          ? mxBankTransfer()
          : this.mxBankTransfer,
      nzBankTransfer: nzBankTransfer != null
          ? nzBankTransfer()
          : this.nzBankTransfer,
      ...
      thBankTransfer: thBankTransfer != null
          ? thBankTransfer()
          : this.thBankTransfer,
      twint: twint != null ? twint() : this.twint,
      type: type ?? this.type,
      usBankTransfer: usBankTransfer != null
          ? usBankTransfer()
          : this.usBankTransfer,
