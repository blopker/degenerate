...
import 'post_tax_transactions_create_reversal_request_line_items.dart';
import 'post_tax_transactions_create_reversal_request_mode.dart';
import 'post_tax_transactions_create_reversal_request_shipping_cost.dart';

final class PostTaxTransactionsCreateReversalRequest {
  const PostTaxTransactionsCreateReversalRequest({
    this.expand,
    this.flatAmount,
    this.lineItems,
    this.metadata,
  ...
  factory PostTaxTransactionsCreateReversalRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostTaxTransactionsCreateReversalRequest(
      ...
      lineItems: (json['line_items'] as List<dynamic>?)
          ?.map(
            (e) => PostTaxTransactionsCreateReversalRequestLineItems.fromJson(
      ...
      mode: PostTaxTransactionsCreateReversalRequestMode.fromJson(
        json['mode'] as String,
      ),
      originalTransaction: json['original_transaction'] as String,
      reference: json['reference'] as String,
      shippingCost: json['shipping_cost'] != null
          ? PostTaxTransactionsCreateReversalRequestShippingCost.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('mode') &&
        json.containsKey('original_transaction') &&
        json['original_transaction'] is String &&
        json.containsKey('reference') &&
        json['reference'] is String;
  }

  PostTaxTransactionsCreateReversalRequest copyWith({
    List<String> Function()? expand,
    int Function()? flatAmount,
    List<PostTaxTransactionsCreateReversalRequestLineItems> Function()?
    lineItems,
    Map<String, String> Function()? metadata,
    PostTaxTransactionsCreateReversalRequestMode? mode,
    String? originalTransaction,
    String? reference,
    PostTaxTransactionsCreateReversalRequestShippingCost Function()?
    shippingCost,
  }) {
    return PostTaxTransactionsCreateReversalRequest(
  ...
  @override
  String toString() {
    return 'PostTaxTransactionsCreateReversalRequest(expand: $expand, flatAmount: $flatAmount, lineItems: $lineItems, metadata: $metadata, mode: $mode, originalTransaction: $originalTransaction, reference: $reference, shippingCost: $shippingCost)';
  }
}
