...
///
final class PaymentMethodCustom {
  const PaymentMethodCustom({this.displayName, this.logo, required this.type});

  factory PaymentMethodCustom.fromJson(Map<String, dynamic> json) {
    return PaymentMethodCustom(
      displayName: json['display_name'] as String?,
      logo: json['logo'] != null
          ? PaymentMethodCustomLogo.fromJson(
  ...
  PaymentMethodCustom copyWith({
    ...
    PaymentMethodCustomLogo? Function()? logo,
    String? type,
  }) {
    return PaymentMethodCustom(
  ...
  @override
  int get hashCode {
    return Object.hash(displayName, logo, type);
  }

  @override
  String toString() {
    return 'PaymentMethodCustom(displayName: $displayName, logo: $logo, type: $type)';
  }
}
