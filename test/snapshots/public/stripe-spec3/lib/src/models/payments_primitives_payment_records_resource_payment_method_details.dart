...
import 'payment_method_details_payment_record_affirm.dart';
import 'payment_method_details_payment_record_afterpay_clearpay.dart';
import 'payment_method_details_payment_record_bancontact.dart';
import 'payment_method_details_payment_record_boleto.dart';
import 'payment_method_details_payment_record_cashapp.dart';
import 'payment_method_details_payment_record_giropay.dart';
import 'payment_method_details_payment_record_kakao_pay.dart';
import 'payment_method_details_payment_record_konbini.dart';
import 'payment_method_details_payment_record_mb_way.dart';
import 'payment_method_details_payment_record_multibanco.dart';
import 'payment_method_details_payment_record_naver_pay.dart';
import 'payment_method_details_payment_record_oxxo.dart';
import 'payment_method_details_payment_record_paynow.dart';
import 'payment_method_details_payment_record_promptpay.dart';
import 'payment_method_details_payment_record_us_bank_account.dart';
import 'payment_method_details_payment_record_wechat_pay.dart';
import 'payment_method_details_payment_record_zip.dart';
...
import 'payments_primitives_payment_records_resource_payment_method_card_details.dart';
import 'payments_primitives_payment_records_resource_payment_method_custom_details.dart';
import 'payments_primitives_payment_records_resource_payment_method_details_billing_details.dart';
...
final class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails {
  ...
  factory PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails.fromJson(
    ...
    return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
      achCreditTransfer: json['ach_credit_transfer'] != null
          ? PaymentMethodDetailsAchCreditTransfer.fromJson(
              json['ach_credit_transfer'] as Map<String, dynamic>,
            )
          : null,
      achDebit: json['ach_debit'] != null
          ? PaymentMethodDetailsAchDebit.fromJson(
              json['ach_debit'] as Map<String, dynamic>,
            )
          : null,
      ...
      affirm: json['affirm'] != null
          ? PaymentMethodDetailsPaymentRecordAffirm.fromJson(
              json['affirm'] as Map<String, dynamic>,
            )
          : null,
      afterpayClearpay: json['afterpay_clearpay'] != null
          ? PaymentMethodDetailsPaymentRecordAfterpayClearpay.fromJson(
      ...
      bancontact: json['bancontact'] != null
          ? PaymentMethodDetailsPaymentRecordBancontact.fromJson(
              json['bancontact'] as Map<String, dynamic>,
            )
          : null,
      billie: json['billie'] != null
          ? PaymentMethodDetailsBillie.fromJson(
              json['billie'] as Map<String, dynamic>,
            )
          : null,
      billingDetails: json['billing_details'] != null
          ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsBillingDetails.fromJson(
              json['billing_details'] as Map<String, dynamic>,
            )
          : null,
      blik: json['blik'] != null
          ? PaymentMethodDetailsBlik.fromJson(
              json['blik'] as Map<String, dynamic>,
            )
          : null,
      boleto: json['boleto'] != null
          ? PaymentMethodDetailsPaymentRecordBoleto.fromJson(
              json['boleto'] as Map<String, dynamic>,
            )
          : null,
      card: json['card'] != null
          ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails.fromJson(
              json['card'] as Map<String, dynamic>,
            )
          : null,
      cardPresent: json['card_present'] != null
          ? PaymentMethodDetailsCardPresent.fromJson(
              json['card_present'] as Map<String, dynamic>,
            )
          : null,
      cashapp: json['cashapp'] != null
          ? PaymentMethodDetailsPaymentRecordCashapp.fromJson(
              json['cashapp'] as Map<String, dynamic>,
            )
          : null,
      crypto: json['crypto'] != null
          ? PaymentMethodDetailsCrypto.fromJson(
              json['crypto'] as Map<String, dynamic>,
            )
          : null,
      custom: json['custom'] != null
          ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails.fromJson(
      ...
      customerBalance: json['customer_balance'] != null
          ...
          : null,
      eps: json['eps'] != null
          ? PaymentMethodDetailsEps.fromJson(
      ...
      giropay: json['giropay'] != null
          ? PaymentMethodDetailsPaymentRecordGiropay.fromJson(
              json['giropay'] as Map<String, dynamic>,
            )
          : null,
      grabpay: json['grabpay'] != null
          ? PaymentMethodDetailsGrabpay.fromJson(
              json['grabpay'] as Map<String, dynamic>,
            )
          : null,
      ideal: json['ideal'] != null
          ? PaymentMethodDetailsIdeal.fromJson(
      ...
      kakaoPay: json['kakao_pay'] != null
          ? PaymentMethodDetailsPaymentRecordKakaoPay.fromJson(
  ...
  final PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsBillingDetails?
  billingDetails;
  ...
  final PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails?
  custom;
  ...
  Map<String, dynamic> toJson() {
    return {
      if (achCreditTransfer != null)
        'ach_credit_transfer': achCreditTransfer?.toJson(),
  ...
  PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails copyWith({
    PaymentMethodDetailsAchCreditTransfer Function()? achCreditTransfer,
    PaymentMethodDetailsAchDebit Function()? achDebit,
    PaymentMethodDetailsAcssDebit Function()? acssDebit,
    PaymentMethodDetailsPaymentRecordAffirm Function()? affirm,
    PaymentMethodDetailsPaymentRecordAfterpayClearpay Function()?
    afterpayClearpay,
    PaymentFlowsPrivatePaymentMethodsAlipayDetails Function()? alipay,
    PaymentMethodDetailsAlma Function()? alma,
    PaymentMethodDetailsAmazonPay Function()? amazonPay,
    PaymentMethodDetailsAuBecsDebit Function()? auBecsDebit,
    PaymentMethodDetailsBacsDebit Function()? bacsDebit,
    PaymentMethodDetailsPaymentRecordBancontact Function()? bancontact,
    PaymentMethodDetailsBillie Function()? billie,
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsBillingDetails?
    Function()?
    billingDetails,
    PaymentMethodDetailsBlik Function()? blik,
    PaymentMethodDetailsPaymentRecordBoleto Function()? boleto,
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetails Function()?
    card,
    PaymentMethodDetailsCardPresent Function()? cardPresent,
    PaymentMethodDetailsPaymentRecordCashapp Function()? cashapp,
    PaymentMethodDetailsCrypto Function()? crypto,
    PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCustomDetails
    Function()?
    custom,
    PaymentMethodDetailsCustomerBalance Function()? customerBalance,
    PaymentMethodDetailsEps Function()? eps,
    PaymentMethodDetailsFpx Function()? fpx,
    PaymentMethodDetailsPaymentRecordGiropay Function()? giropay,
    PaymentMethodDetailsGrabpay Function()? grabpay,
    PaymentMethodDetailsIdeal Function()? ideal,
    PaymentMethodDetailsInteracPresent Function()? interacPresent,
    PaymentMethodDetailsPaymentRecordKakaoPay Function()? kakaoPay,
    PaymentMethodDetailsKlarna Function()? klarna,
    PaymentMethodDetailsPaymentRecordKonbini Function()? konbini,
    PaymentMethodDetailsKrCard Function()? krCard,
    PaymentMethodDetailsLink Function()? link,
    PaymentMethodDetailsPaymentRecordMbWay Function()? mbWay,
    PaymentMethodDetailsMobilepay Function()? mobilepay,
    PaymentMethodDetailsPaymentRecordMultibanco Function()? multibanco,
    PaymentMethodDetailsPaymentRecordNaverPay Function()? naverPay,
    PaymentMethodDetailsNzBankAccount Function()? nzBankAccount,
    PaymentMethodDetailsPaymentRecordOxxo Function()? oxxo,
    PaymentMethodDetailsP24 Function()? p24,
    PaymentMethodDetailsPayByBank Function()? payByBank,
    PaymentMethodDetailsPayco Function()? payco,
    String? Function()? paymentMethod,
    PaymentMethodDetailsPaymentRecordPaynow Function()? paynow,
    PaymentMethodDetailsPaypal Function()? paypal,
    PaymentMethodDetailsPayto Function()? payto,
    PaymentMethodDetailsPix Function()? pix,
    PaymentMethodDetailsPaymentRecordPromptpay Function()? promptpay,
    PaymentMethodDetailsRevolutPay Function()? revolutPay,
    PaymentMethodDetailsSamsungPay Function()? samsungPay,
    PaymentMethodDetailsSatispay Function()? satispay,
    PaymentMethodDetailsSepaDebit Function()? sepaDebit,
    PaymentMethodDetailsSofort Function()? sofort,
    PaymentMethodDetailsStripeAccount Function()? stripeAccount,
    PaymentMethodDetailsSwish Function()? swish,
    PaymentMethodDetailsTwint Function()? twint,
    String? type,
    PaymentMethodDetailsPaymentRecordUsBankAccount Function()? usBankAccount,
    PaymentMethodDetailsWechat Function()? wechat,
    PaymentMethodDetailsPaymentRecordWechatPay Function()? wechatPay,
    PaymentMethodDetailsPaymentRecordZip Function()? zip,
  }) {
    return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
      achCreditTransfer: achCreditTransfer != null
          ? achCreditTransfer()
          : this.achCreditTransfer,
