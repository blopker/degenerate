...
///
final class AccountFutureRequirements {
  const AccountFutureRequirements({
    this.alternatives,
  ...
  factory AccountFutureRequirements.fromJson(Map<String, dynamic> json) {
    return AccountFutureRequirements(
      alternatives: (json['alternatives'] as List<dynamic>?)
          ?.map(
            (e) => AccountRequirementsAlternative.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      currentDeadline: json['current_deadline'] != null
          ? (json['current_deadline'] as num).toInt()
          : null,
      currentlyDue: (json['currently_due'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      disabledReason: json['disabled_reason'] != null
          ? AccountFutureRequirementsDisabledReason.fromJson(
              json['disabled_reason'] as String,
            )
          : null,
      errors: (json['errors'] as List<dynamic>?)
          ?.map(
            (e) => AccountRequirementsError.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  AccountFutureRequirements copyWith({
    List<AccountRequirementsAlternative>? Function()? alternatives,
    int? Function()? currentDeadline,
    List<String>? Function()? currentlyDue,
    AccountFutureRequirementsDisabledReason? Function()? disabledReason,
    List<AccountRequirementsError>? Function()? errors,
    List<String>? Function()? eventuallyDue,
    List<String>? Function()? pastDue,
    List<String>? Function()? pendingVerification,
  }) {
    return AccountFutureRequirements(
      ...
      eventuallyDue: eventuallyDue != null
          ? eventuallyDue()
          : this.eventuallyDue,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(alternatives ?? const []),
      currentDeadline,
      Object.hashAll(currentlyDue ?? const []),
      disabledReason,
      Object.hashAll(errors ?? const []),
      Object.hashAll(eventuallyDue ?? const []),
      Object.hashAll(pastDue ?? const []),
      Object.hashAll(pendingVerification ?? const []),
    );
  }

  @override
  String toString() {
    return 'AccountFutureRequirements(alternatives: $alternatives, currentDeadline: $currentDeadline, currentlyDue: $currentlyDue, disabledReason: $disabledReason, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
