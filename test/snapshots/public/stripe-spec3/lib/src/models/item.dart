...
import 'item_adjustable_quantity.dart';
...
final class Item {
  ...
  factory Item.fromJson(Map<String, dynamic> json) {
    return Item(
      adjustableQuantity: json['adjustable_quantity'] != null
          ? ItemAdjustableQuantity.fromJson(
      ...
      discounts: (json['discounts'] as List<dynamic>?)
          ?.map(
            (e) => LineItemsDiscountAmount.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount_discount') &&
        json['amount_discount'] is num &&
  ...
  Item copyWith({
    ItemAdjustableQuantity? Function()? adjustableQuantity,
    int? amountDiscount,
    int? amountSubtotal,
    int? amountTax,
    int? amountTotal,
    ...
    List<LineItemsDiscountAmount> Function()? discounts,
    String? id,
  ...
  @override
  String toString() {
    return 'Item(adjustableQuantity: $adjustableQuantity, amountDiscount: $amountDiscount, amountSubtotal: $amountSubtotal, amountTax: $amountTax, amountTotal: $amountTotal, currency: $currency, description: $description, discounts: $discounts, id: $id, metadata: $metadata, object: $object, price: $price, quantity: $quantity, taxes: $taxes)';
  }
}
