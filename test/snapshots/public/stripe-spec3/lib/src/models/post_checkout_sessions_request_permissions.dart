...
import 'post_checkout_sessions_request_permissions_update_shipping_details.dart';/// This property is used to set up permissions for various actions (e.g., update) on the CheckoutSession object. Can only be set when creating `embedded` or `custom` sessions.
/// 
