...
import 'package:collection/collection.dart';import 'post_test_helpers_treasury_received_credits_request_initiating_payment_method_details.dart';import 'post_test_helpers_treasury_received_credits_request_network.dart';final class PostTestHelpersTreasuryReceivedCreditsRequest {const PostTestHelpersTreasuryReceivedCreditsRequest({required this.amount, required this.currency, this.description, this.expand, required this.financialAccount, this.initiatingPaymentMethodDetails, required this.network, });
