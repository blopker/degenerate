...
final class Refund {
  ...
  factory Refund.fromJson(Map<String, dynamic> json) {
    return Refund(
      ...
      balanceTransaction: json['balance_transaction'] != null
          ? RefundBalanceTransaction.fromJson(
      ...
      failureBalanceTransaction: json['failure_balance_transaction'] != null
          ? RefundFailureBalanceTransaction.fromJson(
      ...
      paymentIntent: json['payment_intent'] != null
          ? RefundPaymentIntent.fromJson(
              json['payment_intent'] as Map<String, dynamic>,
            )
          : null,
      pendingReason: json['pending_reason'] != null
          ? RefundPendingReason.fromJson(json['pending_reason'] as String)
          : null,
      ...
      reason: json['reason'] != null
          ? RefundReason.fromJson(json['reason'] as String)
          : null,
      receiptNumber: json['receipt_number'] as String?,
      sourceTransferReversal: json['source_transfer_reversal'] != null
          ? RefundSourceTransferReversal.fromJson(
              json['source_transfer_reversal'] as Map<String, dynamic>,
            )
          : null,
      status: json['status'] as String?,
      transferReversal: json['transfer_reversal'] != null
          ? RefundTransferReversal.fromJson(
              json['transfer_reversal'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (sourceTransferReversal != null)
        'source_transfer_reversal': sourceTransferReversal?.toJson(),
      'status': ?status,
      if (transferReversal != null)
        'transfer_reversal': transferReversal?.toJson(),
    };
  }
  ...
  Refund copyWith({
    int? amount,
    RefundBalanceTransaction? Function()? balanceTransaction,
    RefundCharge? Function()? charge,
    int? created,
    String? currency,
    String Function()? description,
    RefundDestinationDetails Function()? destinationDetails,
    RefundFailureBalanceTransaction Function()? failureBalanceTransaction,
    String Function()? failureReason,
    String? id,
    String Function()? instructionsEmail,
    Map<String, String>? Function()? metadata,
    RefundNextAction Function()? nextAction,
    RefundObject? object,
    RefundPaymentIntent? Function()? paymentIntent,
    RefundPendingReason Function()? pendingReason,
    PaymentFlowsPaymentIntentPresentmentDetails Function()? presentmentDetails,
    RefundReason? Function()? reason,
    String? Function()? receiptNumber,
    RefundSourceTransferReversal? Function()? sourceTransferReversal,
    String? Function()? status,
    RefundTransferReversal? Function()? transferReversal,
  }) {
    return Refund(
      ...
      failureReason: failureReason != null
          ...
          : this.failureReason,
      id: id ?? this.id,
      instructionsEmail: instructionsEmail != null
          ? instructionsEmail()
          : this.instructionsEmail,
      ...
      receiptNumber: receiptNumber != null
          ? receiptNumber()
          : this.receiptNumber,
      sourceTransferReversal: sourceTransferReversal != null
  ...
  @override
  String toString() {
    return 'Refund(amount: $amount, balanceTransaction: $balanceTransaction, charge: $charge, created: $created, currency: $currency, description: $description, destinationDetails: $destinationDetails, failureBalanceTransaction: $failureBalanceTransaction, failureReason: $failureReason, id: $id, instructionsEmail: $instructionsEmail, metadata: $metadata, nextAction: $nextAction, object: $object, paymentIntent: $paymentIntent, pendingReason: $pendingReason, presentmentDetails: $presentmentDetails, reason: $reason, receiptNumber: $receiptNumber, sourceTransferReversal: $sourceTransferReversal, status: $status, transferReversal: $transferReversal)';
  }
}
