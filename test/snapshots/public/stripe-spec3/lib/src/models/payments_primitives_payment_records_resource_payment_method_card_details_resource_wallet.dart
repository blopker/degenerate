...
///
final class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet {
  const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet({
    this.applePay,
    this.dynamicLast4,
    this.googlePay,
    required this.type,
  ...
  factory PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet(
      applePay: json['apple_pay'] != null
          ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletResourceApplePay.fromJson(
              json['apple_pay'] as Map<String, dynamic>,
            )
          : null,
      dynamicLast4: json['dynamic_last4'] as String?,
      googlePay: json['google_pay'] != null
          ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletResourceGooglePay.fromJson(
  ...
  final PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletResourceApplePay?
  applePay;

  /// (For tokenized numbers only.) The last four digits of the device account number.
  final String? dynamicLast4;

  final PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWalletResourceGooglePay?
  googlePay;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet &&
  ...
  @override
  int get hashCode {
    return Object.hash(applePay, dynamicLast4, googlePay, type);
  }

  @override
  String toString() {
    return 'PaymentsPrimitivesPaymentRecordsResourcePaymentMethodCardDetailsResourceWallet(applePay: $applePay, dynamicLast4: $dynamicLast4, googlePay: $googlePay, type: $type)';
  }
}
