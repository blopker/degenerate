...
///
final class AccountPaymentsSettings {
  const AccountPaymentsSettings({
    this.statementDescriptor,
    this.statementDescriptorKana,
    this.statementDescriptorKanji,
  });

  factory AccountPaymentsSettings.fromJson(Map<String, dynamic> json) {
  ...
  AccountPaymentsSettings copyWith({
  ...
  @override
  String toString() {
    return 'AccountPaymentsSettings(statementDescriptor: $statementDescriptor, statementDescriptorKana: $statementDescriptorKana, statementDescriptorKanji: $statementDescriptorKanji)';
  }
}
