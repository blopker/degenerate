...
final class PromotionCode {
  ...
  factory PromotionCode.fromJson(Map<String, dynamic> json) {
    return PromotionCode(
      ...
      customer: json['customer'] != null
          ? PromotionCodeCustomer.fromJson(
      ...
      promotion: PromotionCodesResourcePromotion.fromJson(
        json['promotion'] as Map<String, dynamic>,
      ),
      restrictions: PromotionCodesResourceRestrictions.fromJson(
  ...
  PromotionCode copyWith({
    ...
    String? code,
    int? created,
    PromotionCodeCustomer? Function()? customer,
  ...
  @override
  String toString() {
    return 'PromotionCode(active: $active, code: $code, created: $created, customer: $customer, customerAccount: $customerAccount, expiresAt: $expiresAt, id: $id, livemode: $livemode, maxRedemptions: $maxRedemptions, metadata: $metadata, object: $object, promotion: $promotion, restrictions: $restrictions, timesRedeemed: $timesRedeemed)';
  }
}
