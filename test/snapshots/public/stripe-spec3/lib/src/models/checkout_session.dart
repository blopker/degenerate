...
import 'checkout_session_adaptive_pricing.dart';
import 'checkout_session_after_expiration.dart';
import 'checkout_session_billing_address_collection.dart';
import 'checkout_session_collected_information.dart';
import 'checkout_session_consent.dart';
import 'checkout_session_consent_collection.dart';
import 'checkout_session_currency_conversion.dart';
import 'checkout_session_customer.dart';
import 'checkout_session_customer_creation.dart';
import 'checkout_session_customer_details.dart';
import 'checkout_session_invoice.dart';
import 'checkout_session_invoice_creation.dart';
import 'checkout_session_line_items.dart';
import 'checkout_session_locale.dart';
import 'checkout_session_mode.dart';
import 'checkout_session_object.dart';
import 'checkout_session_origin_context.dart';
import 'checkout_session_payment_intent.dart';
import 'checkout_session_payment_link.dart';
import 'checkout_session_payment_method_collection.dart';
import 'checkout_session_payment_method_configuration_details.dart';
import 'checkout_session_payment_method_options2.dart';
import 'checkout_session_payment_status.dart';
import 'checkout_session_permissions.dart';
import 'checkout_session_redirect_on_completion.dart';
import 'checkout_session_saved_payment_method_options.dart';
import 'checkout_session_setup_intent.dart';
import 'checkout_session_shipping_address_collection.dart';
import 'checkout_session_shipping_cost.dart';
import 'checkout_session_status.dart';
import 'checkout_session_submit_type.dart';
import 'checkout_session_subscription.dart';
import 'checkout_session_total_details.dart';
import 'checkout_session_ui_mode.dart';
import 'checkout_session_wallet_options2.dart';
...
final class CheckoutSession {
  ...
  factory CheckoutSession.fromJson(Map<String, dynamic> json) {
    return CheckoutSession(
      ...
      brandingSettings: json['branding_settings'] != null
          ? PaymentPagesCheckoutSessionBrandingSettings.fromJson(
      ...
      collectedInformation: json['collected_information'] != null
          ? CheckoutSessionCollectedInformation.fromJson(
      ...
      currencyConversion: json['currency_conversion'] != null
          ? CheckoutSessionCurrencyConversion.fromJson(
              json['currency_conversion'] as Map<String, dynamic>,
            )
          : null,
      customFields: (json['custom_fields'] as List<dynamic>)
          .map(
            (e) => PaymentPagesCheckoutSessionCustomFields.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      customText: PaymentPagesCheckoutSessionCustomText.fromJson(
        json['custom_text'] as Map<String, dynamic>,
      ),
      customer: json['customer'] != null
          ? CheckoutSessionCustomer.fromJson(
      ...
      discounts: (json['discounts'] as List<dynamic>?)
          ?.map(
            (e) => PaymentPagesCheckoutSessionDiscount.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      nameCollection: json['name_collection'] != null
          ? PaymentPagesCheckoutSessionNameCollection.fromJson(
      ...
      paymentMethodOptions: json['payment_method_options'] != null
          ? CheckoutSessionPaymentMethodOptions2.fromJson(
      ...
      paymentMethodTypes: (json['payment_method_types'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      paymentStatus: CheckoutSessionPaymentStatus.fromJson(
        json['payment_status'] as String,
      ),
      permissions: json['permissions'] != null
          ? CheckoutSessionPermissions.fromJson(
      ...
      presentmentDetails: json['presentment_details'] != null
          ? PaymentFlowsPaymentIntentPresentmentDetails.fromJson(
              json['presentment_details'] as Map<String, dynamic>,
            )
          : null,
      ...
      savedPaymentMethodOptions: json['saved_payment_method_options'] != null
          ? CheckoutSessionSavedPaymentMethodOptions.fromJson(
              json['saved_payment_method_options'] as Map<String, dynamic>,
            )
          : null,
      setupIntent: json['setup_intent'] != null
          ? CheckoutSessionSetupIntent.fromJson(
              json['setup_intent'] as Map<String, dynamic>,
            )
          : null,
      ...
      shippingOptions: (json['shipping_options'] as List<dynamic>)
          .map(
            (e) => PaymentPagesCheckoutSessionShippingOption.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      status: json['status'] != null
          ? CheckoutSessionStatus.fromJson(json['status'] as String)
          : null,
      submitType: json['submit_type'] != null
          ? CheckoutSessionSubmitType.fromJson(json['submit_type'] as String)
          : null,
      subscription: json['subscription'] != null
          ? CheckoutSessionSubscription.fromJson(
      ...
      totalDetails: json['total_details'] != null
          ? CheckoutSessionTotalDetails.fromJson(
              json['total_details'] as Map<String, dynamic>,
            )
          : null,
      uiMode: json['ui_mode'] != null
          ? CheckoutSessionUiMode.fromJson(json['ui_mode'] as String)
          : null,
      url: json['url'] as String?,
      walletOptions: json['wallet_options'] != null
          ? CheckoutSessionWalletOptions2.fromJson(
  ...
  final CheckoutSessionPaymentMethodConfigurationDetails?
  paymentMethodConfigurationDetails;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (currencyConversion != null)
        'currency_conversion': currencyConversion?.toJson(),
      ...
      if (presentmentDetails != null)
        'presentment_details': presentmentDetails?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('automatic_tax') &&
  ...
  CheckoutSession copyWith({
    CheckoutSessionAdaptivePricing? Function()? adaptivePricing,
    CheckoutSessionAfterExpiration? Function()? afterExpiration,
    bool? Function()? allowPromotionCodes,
    int? Function()? amountSubtotal,
    int? Function()? amountTotal,
    PaymentPagesCheckoutSessionAutomaticTax? automaticTax,
    CheckoutSessionBillingAddressCollection? Function()?
    billingAddressCollection,
    PaymentPagesCheckoutSessionBrandingSettings Function()? brandingSettings,
    String? Function()? cancelUrl,
    String? Function()? clientReferenceId,
    String? Function()? clientSecret,
    CheckoutSessionCollectedInformation? Function()? collectedInformation,
    CheckoutSessionConsent? Function()? consent,
    CheckoutSessionConsentCollection? Function()? consentCollection,
    int? created,
    String? Function()? currency,
    CheckoutSessionCurrencyConversion? Function()? currencyConversion,
    List<PaymentPagesCheckoutSessionCustomFields>? customFields,
    PaymentPagesCheckoutSessionCustomText? customText,
    CheckoutSessionCustomer? Function()? customer,
    String? Function()? customerAccount,
    CheckoutSessionCustomerCreation? Function()? customerCreation,
    CheckoutSessionCustomerDetails? Function()? customerDetails,
    String? Function()? customerEmail,
    List<PaymentPagesCheckoutSessionDiscount>? Function()? discounts,
    List<String> Function()? excludedPaymentMethodTypes,
    int? expiresAt,
    String? id,
    CheckoutSessionInvoice? Function()? invoice,
    CheckoutSessionInvoiceCreation? Function()? invoiceCreation,
    CheckoutSessionLineItems Function()? lineItems,
    bool? livemode,
    CheckoutSessionLocale? Function()? locale,
    Map<String, String>? Function()? metadata,
    CheckoutSessionMode? mode,
    PaymentPagesCheckoutSessionNameCollection Function()? nameCollection,
    CheckoutSessionObject? object,
    List<PaymentPagesCheckoutSessionOptionalItem>? Function()? optionalItems,
    CheckoutSessionOriginContext? Function()? originContext,
    CheckoutSessionPaymentIntent? Function()? paymentIntent,
    CheckoutSessionPaymentLink? Function()? paymentLink,
    CheckoutSessionPaymentMethodCollection? Function()? paymentMethodCollection,
    CheckoutSessionPaymentMethodConfigurationDetails? Function()?
    paymentMethodConfigurationDetails,
    CheckoutSessionPaymentMethodOptions2? Function()? paymentMethodOptions,
    List<String>? paymentMethodTypes,
    CheckoutSessionPaymentStatus? paymentStatus,
    CheckoutSessionPermissions? Function()? permissions,
    PaymentPagesCheckoutSessionPhoneNumberCollection Function()?
    phoneNumberCollection,
    PaymentFlowsPaymentIntentPresentmentDetails Function()? presentmentDetails,
    String? Function()? recoveredFrom,
    CheckoutSessionRedirectOnCompletion Function()? redirectOnCompletion,
    String Function()? returnUrl,
    CheckoutSessionSavedPaymentMethodOptions? Function()?
    savedPaymentMethodOptions,
    CheckoutSessionSetupIntent? Function()? setupIntent,
    CheckoutSessionShippingAddressCollection? Function()?
    shippingAddressCollection,
    CheckoutSessionShippingCost? Function()? shippingCost,
    List<PaymentPagesCheckoutSessionShippingOption>? shippingOptions,
    CheckoutSessionStatus? Function()? status,
    CheckoutSessionSubmitType? Function()? submitType,
    CheckoutSessionSubscription? Function()? subscription,
    String? Function()? successUrl,
    PaymentPagesCheckoutSessionTaxIdCollection Function()? taxIdCollection,
    CheckoutSessionTotalDetails? Function()? totalDetails,
    CheckoutSessionUiMode? Function()? uiMode,
    String? Function()? url,
    CheckoutSessionWalletOptions2? Function()? walletOptions,
  }) {
    return CheckoutSession(
      ...
      collectedInformation: collectedInformation != null
