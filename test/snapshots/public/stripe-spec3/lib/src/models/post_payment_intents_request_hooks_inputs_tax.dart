...
import 'post_payment_intents_request_hooks_inputs_tax_calculation.dart';final class PostPaymentIntentsRequestHooksInputsTax {const PostPaymentIntentsRequestHooksInputsTax({required this.calculation});
...
factory PostPaymentIntentsRequestHooksInputsTax.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsRequestHooksInputsTax(
  calculation: PostPaymentIntentsRequestHooksInputsTaxCalculation.fromJson(json['calculation'] as Map<String, dynamic>),
); }
