...
///
final class ConnectEmbeddedFinancialAccountFeatures {
  const ConnectEmbeddedFinancialAccountFeatures({
  ...
  factory ConnectEmbeddedFinancialAccountFeatures.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('disable_stripe_user_authentication') &&
        ...
        json.containsKey('send_money') &&
        json['send_money'] is bool &&
        json.containsKey('transfer_balance') &&
        json['transfer_balance'] is bool;
  }

  ConnectEmbeddedFinancialAccountFeatures copyWith({
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedFinancialAccountFeatures(disableStripeUserAuthentication: $disableStripeUserAuthentication, externalAccountCollection: $externalAccountCollection, sendMoney: $sendMoney, transferBalance: $transferBalance)';
  }
}
