...
import 'get_reviews_response_object.dart';
import 'review.dart';
...
final class GetReviewsResponse {
  ...
  GetReviewsResponse copyWith({
    List<Review>? data,
    bool? hasMore,
    GetReviewsResponseObject? object,
    String? url,
  }) {
    return GetReviewsResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetReviewsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
