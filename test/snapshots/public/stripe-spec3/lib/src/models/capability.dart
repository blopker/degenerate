...
final class Capability {
  ...
  factory Capability.fromJson(Map<String, dynamic> json) {
    return Capability(
      account: CapabilityAccount.fromJson(
      ...
      requirements: json['requirements'] != null
          ? AccountCapabilityRequirements.fromJson(
  ...
  Capability copyWith({
    ...
    AccountCapabilityFutureRequirements Function()? futureRequirements,
    String? id,
    CapabilityObject? object,
    bool? requested,
    int? Function()? requestedAt,
    AccountCapabilityRequirements Function()? requirements,
  ...
  @override
  String toString() {
    return 'Capability(account: $account, futureRequirements: $futureRequirements, id: $id, object: $object, requested: $requested, requestedAt: $requestedAt, requirements: $requirements, status: $status)';
  }
}
