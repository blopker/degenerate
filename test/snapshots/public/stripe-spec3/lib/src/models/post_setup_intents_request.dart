...
import 'post_setup_intents_request_automatic_payment_methods.dart';
import 'post_setup_intents_request_excluded_payment_method_types.dart';
import 'post_setup_intents_request_flow_directions.dart';
import 'post_setup_intents_request_mandate_data.dart';
import 'post_setup_intents_request_payment_method_data.dart';
import 'post_setup_intents_request_payment_method_options.dart';
import 'post_setup_intents_request_single_use.dart';
import 'post_setup_intents_request_usage.dart';

final class PostSetupIntentsRequest {
  const PostSetupIntentsRequest({
    this.attachToSelf,
  ...
  factory PostSetupIntentsRequest.fromJson(Map<String, dynamic> json) {
    return PostSetupIntentsRequest(
      attachToSelf: json['attach_to_self'] as bool?,
      automaticPaymentMethods: json['automatic_payment_methods'] != null
          ? PostSetupIntentsRequestAutomaticPaymentMethods.fromJson(
      ...
      excludedPaymentMethodTypes:
          (json['excluded_payment_method_types'] as List<dynamic>?)
              ?.map(
                (e) =>
                    PostSetupIntentsRequestExcludedPaymentMethodTypes.fromJson(
                      e as String,
                    ),
              )
              .toList(),
      ...
      flowDirections: (json['flow_directions'] as List<dynamic>?)
          ?.map(
            (e) => PostSetupIntentsRequestFlowDirections.fromJson(e as String),
          )
          .toList(),
      mandateData: json['mandate_data'] != null
          ? PostSetupIntentsRequestMandateData.fromJson(
      ...
      paymentMethodData: json['payment_method_data'] != null
          ? PostSetupIntentsRequestPaymentMethodData.fromJson(
              json['payment_method_data'] as Map<String, dynamic>,
            )
          : null,
      paymentMethodOptions: json['payment_method_options'] != null
          ? PostSetupIntentsRequestPaymentMethodOptions.fromJson(
      ...
      singleUse: json['single_use'] != null
          ? PostSetupIntentsRequestSingleUse.fromJson(
              json['single_use'] as Map<String, dynamic>,
            )
          : null,
      usage: json['usage'] != null
          ? PostSetupIntentsRequestUsage.fromJson(json['usage'] as String)
          : null,
  ...
  final List<PostSetupIntentsRequestExcludedPaymentMethodTypes>?
  excludedPaymentMethodTypes;
  ...
  PostSetupIntentsRequest copyWith({
    bool Function()? attachToSelf,
    PostSetupIntentsRequestAutomaticPaymentMethods Function()?
    ...
    List<PostSetupIntentsRequestExcludedPaymentMethodTypes> Function()?
    excludedPaymentMethodTypes,
    List<String> Function()? expand,
    List<PostSetupIntentsRequestFlowDirections> Function()? flowDirections,
    PostSetupIntentsRequestMandateData Function()? mandateData,
    ...
    PostSetupIntentsRequestPaymentMethodData Function()? paymentMethodData,
    PostSetupIntentsRequestPaymentMethodOptions Function()?
    paymentMethodOptions,
    List<String> Function()? paymentMethodTypes,
    String Function()? returnUrl,
    PostSetupIntentsRequestSingleUse Function()? singleUse,
    PostSetupIntentsRequestUsage Function()? usage,
