...
import 'apps_secret_object.dart';
...
final class AppsSecret {
  ...
  factory AppsSecret.fromJson(Map<String, dynamic> json) {
    return AppsSecret(
      ...
      scope: SecretServiceResourceScope.fromJson(
  ...
  @override
  String toString() {
    return 'AppsSecret(created: $created, deleted: $deleted, expiresAt: $expiresAt, id: $id, livemode: $livemode, name: $name, object: $object, payload: $payload, scope: $scope)';
  }
}
