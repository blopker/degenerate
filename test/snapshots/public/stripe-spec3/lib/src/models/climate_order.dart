...
import 'climate_order_cancellation_reason.dart';
import 'climate_order_object.dart';
import 'climate_order_product.dart';
import 'climate_order_status.dart';
import 'climate_removals_beneficiary.dart';
import 'climate_removals_order_deliveries.dart';

/// Orders represent your intent to purchase a particular Climate product. When you create an order, the
/// payment is deducted from your merchant balance.
final class ClimateOrder {
  const ClimateOrder({
  ...
  factory ClimateOrder.fromJson(Map<String, dynamic> json) {
    return ClimateOrder(
      ...
      beneficiary: json['beneficiary'] != null
          ? ClimateRemovalsBeneficiary.fromJson(
      ...
      confirmedAt: json['confirmed_at'] != null
          ? (json['confirmed_at'] as num).toInt()
          : null,
      created: (json['created'] as num).toInt(),
      currency: json['currency'] as String,
      delayedAt: json['delayed_at'] != null
          ? (json['delayed_at'] as num).toInt()
          : null,
      deliveredAt: json['delivered_at'] != null
          ? (json['delivered_at'] as num).toInt()
          : null,
      deliveryDetails: (json['delivery_details'] as List<dynamic>)
          .map(
            (e) => ClimateRemovalsOrderDeliveries.fromJson(
      ...
      product: ClimateOrderProduct.fromJson(
        json['product'] as Map<String, dynamic>,
      ),
      productSubstitutedAt: json['product_substituted_at'] != null
          ? (json['product_substituted_at'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount_fees') &&
        json['amount_fees'] is num &&
        json.containsKey('amount_subtotal') &&
        ...
        json.containsKey('expected_delivery_year') &&
        json['expected_delivery_year'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('livemode') &&
        json['livemode'] is bool &&
        json.containsKey('metadata') &&
        json.containsKey('metric_tons') &&
        json['metric_tons'] is String &&
        json.containsKey('object') &&
        json.containsKey('product') &&
        json.containsKey('status');
  }

  ClimateOrder copyWith({
    int? amountFees,
    int? amountSubtotal,
    int? amountTotal,
    ClimateRemovalsBeneficiary Function()? beneficiary,
    int? Function()? canceledAt,
    ClimateOrderCancellationReason? Function()? cancellationReason,
    String? Function()? certificate,
    int? Function()? confirmedAt,
    int? created,
    String? currency,
    int? Function()? delayedAt,
    int? Function()? deliveredAt,
    ...
    String? metricTons,
    ClimateOrderObject? object,
    ClimateOrderProduct? product,
    int? Function()? productSubstitutedAt,
    ClimateOrderStatus? status,
  }) {
    return ClimateOrder(
      ...
      productSubstitutedAt: productSubstitutedAt != null
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      delayedAt,
      deliveredAt,
      Object.hashAll(deliveryDetails),
