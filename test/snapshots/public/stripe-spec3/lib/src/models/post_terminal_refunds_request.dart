...
import 'post_terminal_refunds_request_reason.dart';

final class PostTerminalRefundsRequest {
  const PostTerminalRefundsRequest({
    this.amount,
    this.charge,
    this.expand,
    this.metadata,
  ...
  factory PostTerminalRefundsRequest.fromJson(Map<String, dynamic> json) {
    return PostTerminalRefundsRequest(
      ...
      reason: json['reason'] != null
          ? PostTerminalRefundsRequestReason.fromJson(json['reason'] as String)
          : null,
  ...
  @override
  String toString() {
    return 'PostTerminalRefundsRequest(amount: $amount, charge: $charge, expand: $expand, metadata: $metadata, paymentIntent: $paymentIntent, reason: $reason, refundApplicationFee: $refundApplicationFee, reverseTransfer: $reverseTransfer)';
  }
}
