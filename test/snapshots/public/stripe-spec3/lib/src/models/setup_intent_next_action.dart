...
///
final class SetupIntentNextAction {
  ...
  factory SetupIntentNextAction.fromJson(Map<String, dynamic> json) {
    return SetupIntentNextAction(
      ...
      redirectToUrl: json['redirect_to_url'] != null
          ? SetupIntentNextActionRedirectToUrl.fromJson(
  ...
  SetupIntentNextAction copyWith({
    PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode Function()?
    cashappHandleRedirectOrDisplayQrCode,
    SetupIntentNextActionRedirectToUrl Function()? redirectToUrl,
    String? type,
    Map<String, String> Function()? useStripeSdk,
    SetupIntentNextActionVerifyWithMicrodeposits Function()?
  ...
  @override
  String toString() {
    return 'SetupIntentNextAction(cashappHandleRedirectOrDisplayQrCode: $cashappHandleRedirectOrDisplayQrCode, redirectToUrl: $redirectToUrl, type: $type, useStripeSdk: $useStripeSdk, verifyWithMicrodeposits: $verifyWithMicrodeposits)';
  }
}
