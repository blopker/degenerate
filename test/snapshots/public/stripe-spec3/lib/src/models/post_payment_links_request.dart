...
import 'post_payment_links_request_after_completion.dart';
import 'post_payment_links_request_automatic_tax.dart';
import 'post_payment_links_request_billing_address_collection.dart';
import 'post_payment_links_request_consent_collection.dart';
import 'post_payment_links_request_custom_fields.dart';
import 'post_payment_links_request_custom_text.dart';
import 'post_payment_links_request_customer_creation.dart';
import 'post_payment_links_request_invoice_creation.dart';
import 'post_payment_links_request_line_items.dart';
import 'post_payment_links_request_name_collection.dart';
import 'post_payment_links_request_optional_items.dart';
import 'post_payment_links_request_payment_intent_data.dart';
import 'post_payment_links_request_payment_method_collection.dart';
import 'post_payment_links_request_payment_method_types.dart';
import 'post_payment_links_request_phone_number_collection.dart';
import 'post_payment_links_request_restrictions.dart';
import 'post_payment_links_request_shipping_address_collection.dart';
import 'post_payment_links_request_shipping_options.dart';
import 'post_payment_links_request_submit_type.dart';
import 'post_payment_links_request_subscription_data.dart';
import 'post_payment_links_request_tax_id_collection.dart';
import 'post_payment_links_request_transfer_data.dart';

final class PostPaymentLinksRequest {
  const PostPaymentLinksRequest({
  ...
  factory PostPaymentLinksRequest.fromJson(Map<String, dynamic> json) {
    return PostPaymentLinksRequest(
      afterCompletion: json['after_completion'] != null
          ? PostPaymentLinksRequestAfterCompletion.fromJson(
      ...
      customFields: (json['custom_fields'] as List<dynamic>?)
          ?.map(
            (e) => PostPaymentLinksRequestCustomFields.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      customText: json['custom_text'] != null
          ? PostPaymentLinksRequestCustomText.fromJson(
              json['custom_text'] as Map<String, dynamic>,
            )
          : null,
      customerCreation: json['customer_creation'] != null
          ? PostPaymentLinksRequestCustomerCreation.fromJson(
      ...
      invoiceCreation: json['invoice_creation'] != null
          ? PostPaymentLinksRequestInvoiceCreation.fromJson(
              json['invoice_creation'] as Map<String, dynamic>,
            )
          : null,
      lineItems: (json['line_items'] as List<dynamic>)
          .map(
            (e) => PostPaymentLinksRequestLineItems.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      nameCollection: json['name_collection'] != null
          ? PostPaymentLinksRequestNameCollection.fromJson(
  ...
  final PostPaymentLinksRequestBillingAddressCollection?
  ...
  final PostPaymentLinksRequestShippingAddressCollection?
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('line_items');
  }

  PostPaymentLinksRequest copyWith({
    PostPaymentLinksRequestAfterCompletion Function()? afterCompletion,
    bool Function()? allowPromotionCodes,
    int Function()? applicationFeeAmount,
    double Function()? applicationFeePercent,
    PostPaymentLinksRequestAutomaticTax Function()? automaticTax,
    PostPaymentLinksRequestBillingAddressCollection Function()?
    billingAddressCollection,
    PostPaymentLinksRequestConsentCollection Function()? consentCollection,
    String Function()? currency,
    List<PostPaymentLinksRequestCustomFields> Function()? customFields,
    PostPaymentLinksRequestCustomText Function()? customText,
    PostPaymentLinksRequestCustomerCreation Function()? customerCreation,
    List<String> Function()? expand,
    String Function()? inactiveMessage,
    PostPaymentLinksRequestInvoiceCreation Function()? invoiceCreation,
    List<PostPaymentLinksRequestLineItems>? lineItems,
    Map<String, String> Function()? metadata,
    PostPaymentLinksRequestNameCollection Function()? nameCollection,
    String Function()? onBehalfOf,
    List<PostPaymentLinksRequestOptionalItems> Function()? optionalItems,
    PostPaymentLinksRequestPaymentIntentData Function()? paymentIntentData,
    PostPaymentLinksRequestPaymentMethodCollection Function()?
    paymentMethodCollection,
    List<PostPaymentLinksRequestPaymentMethodTypes> Function()?
    paymentMethodTypes,
    PostPaymentLinksRequestPhoneNumberCollection Function()?
    phoneNumberCollection,
    PostPaymentLinksRequestRestrictions Function()? restrictions,
    PostPaymentLinksRequestShippingAddressCollection Function()?
    shippingAddressCollection,
    List<PostPaymentLinksRequestShippingOptions> Function()? shippingOptions,
    PostPaymentLinksRequestSubmitType Function()? submitType,
    PostPaymentLinksRequestSubscriptionData Function()? subscriptionData,
    PostPaymentLinksRequestTaxIdCollection Function()? taxIdCollection,
    PostPaymentLinksRequestTransferData Function()? transferData,
  }) {
    return PostPaymentLinksRequest(
      afterCompletion: afterCompletion != null
          ? afterCompletion()
          : this.afterCompletion,
