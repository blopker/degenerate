...
import 'package:collection/collection.dart';import 'post_customers_customer_sources_id_request_account_holder_type.dart';import 'post_customers_customer_sources_id_request_metadata.dart';import 'post_customers_customer_sources_id_request_owner.dart';final class PostCustomersCustomerSourcesIdRequest {const PostCustomersCustomerSourcesIdRequest({this.accountHolderName, this.accountHolderType, this.addressCity, this.addressCountry, this.addressLine1, this.addressLine2, this.addressState, this.addressZip, this.expMonth, this.expYear, this.expand, this.metadata, this.name, this.owner, });
