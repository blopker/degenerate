...
import 'payment_method_details_card_present_offline2.dart';
import 'payment_method_details_card_present_read_method.dart';
import 'payment_method_details_card_present_receipt2.dart';

///
final class PaymentMethodDetailsCardPresent {
  ...
  factory PaymentMethodDetailsCardPresent.fromJson(Map<String, dynamic> json) {
    return PaymentMethodDetailsCardPresent(
      ...
      incrementalAuthorizationSupported:
          json['incremental_authorization_supported'] as bool,
      ...
      offline: json['offline'] != null
          ? PaymentMethodDetailsCardPresentOffline2.fromJson(
      ...
      preferredLocales: (json['preferred_locales'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      readMethod: json['read_method'] != null
          ? PaymentMethodDetailsCardPresentReadMethod.fromJson(
              json['read_method'] as String,
            )
          : null,
      reader: json['reader'] as String?,
      receipt: json['receipt'] != null
          ? PaymentMethodDetailsCardPresentReceipt2.fromJson(
              json['receipt'] as Map<String, dynamic>,
            )
          : null,
      wallet: json['wallet'] != null
          ? PaymentFlowsPrivatePaymentMethodsCardPresentCommonWallet.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('exp_month') &&
        ...
        json.containsKey('incremental_authorization_supported') &&
        json['incremental_authorization_supported'] is bool &&
        json.containsKey('overcapture_supported') &&
        json['overcapture_supported'] is bool;
  }

  PaymentMethodDetailsCardPresent copyWith({
    int? Function()? amountAuthorized,
    String? Function()? brand,
    String? Function()? brandProduct,
    int Function()? captureBefore,
    String? Function()? cardholderName,
    String? Function()? country,
    String? Function()? description,
    String? Function()? emvAuthData,
    int? expMonth,
    int? expYear,
    String? Function()? fingerprint,
    String? Function()? funding,
    String? Function()? generatedCard,
    ...
    PaymentMethodDetailsCardPresentOffline2? Function()? offline,
    bool? overcaptureSupported,
    List<String>? Function()? preferredLocales,
    PaymentMethodDetailsCardPresentReadMethod? Function()? readMethod,
    String Function()? reader,
    PaymentMethodDetailsCardPresentReceipt2? Function()? receipt,
    PaymentFlowsPrivatePaymentMethodsCardPresentCommonWallet Function()? wallet,
  }) {
    return PaymentMethodDetailsCardPresent(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PaymentMethodDetailsCardPresent &&
            ...
            incrementalAuthorizationSupported ==
                other.incrementalAuthorizationSupported &&
            issuer == other.issuer &&
            last4 == other.last4 &&
