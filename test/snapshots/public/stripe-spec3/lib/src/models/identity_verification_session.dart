...
import 'identity_verification_session_last_error.dart';
import 'identity_verification_session_last_verification_report.dart';
import 'identity_verification_session_object.dart';
import 'identity_verification_session_options.dart';
import 'identity_verification_session_provided_details.dart';
import 'identity_verification_session_redaction.dart';
import 'identity_verification_session_status.dart';
import 'identity_verification_session_type.dart';
import 'identity_verification_session_verified_outputs.dart';
...
final class IdentityVerificationSession {
  ...
  factory IdentityVerificationSession.fromJson(Map<String, dynamic> json) {
    return IdentityVerificationSession(
      ...
      lastError: json['last_error'] != null
          ? IdentityVerificationSessionLastError.fromJson(
              json['last_error'] as Map<String, dynamic>,
            )
          : null,
      lastVerificationReport: json['last_verification_report'] != null
          ? IdentityVerificationSessionLastVerificationReport.fromJson(
              json['last_verification_report'] as Map<String, dynamic>,
            )
          : null,
      ...
      object: IdentityVerificationSessionObject.fromJson(
        json['object'] as String,
      ),
      options: json['options'] != null
          ? IdentityVerificationSessionOptions.fromJson(
              json['options'] as Map<String, dynamic>,
            )
          : null,
      providedDetails: json['provided_details'] != null
          ? IdentityVerificationSessionProvidedDetails.fromJson(
              json['provided_details'] as Map<String, dynamic>,
            )
          : null,
      ...
      relatedPerson: json['related_person'] != null
          ? GelatoRelatedPerson.fromJson(
              json['related_person'] as Map<String, dynamic>,
            )
          : null,
      status: IdentityVerificationSessionStatus.fromJson(
      ...
      verifiedOutputs: json['verified_outputs'] != null
          ? IdentityVerificationSessionVerifiedOutputs.fromJson(
              json['verified_outputs'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  final IdentityVerificationSessionLastVerificationReport?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (lastVerificationReport != null)
        'last_verification_report': lastVerificationReport?.toJson(),
      'livemode': livemode,
      'metadata': metadata,
      'object': object.toJson(),
      if (options != null) 'options': options?.toJson(),
      if (providedDetails != null)
        'provided_details': providedDetails?.toJson(),
      ...
      if (verifiedOutputs != null)
        'verified_outputs': verifiedOutputs?.toJson(),
    };
  }
  ...
  IdentityVerificationSession copyWith({
    ...
    int? created,
    String? id,
    IdentityVerificationSessionLastError? Function()? lastError,
    IdentityVerificationSessionLastVerificationReport? Function()?
    lastVerificationReport,
    bool? livemode,
    Map<String, String>? metadata,
    IdentityVerificationSessionObject? object,
    IdentityVerificationSessionOptions? Function()? options,
    IdentityVerificationSessionProvidedDetails? Function()? providedDetails,
    IdentityVerificationSessionRedaction? Function()? redaction,
    String? Function()? relatedCustomer,
    String? Function()? relatedCustomerAccount,
    GelatoRelatedPerson Function()? relatedPerson,
    IdentityVerificationSessionStatus? status,
    IdentityVerificationSessionType? type,
    String? Function()? url,
    String Function()? verificationFlow,
    IdentityVerificationSessionVerifiedOutputs? Function()? verifiedOutputs,
  }) {
    return IdentityVerificationSession(
      ...
      lastVerificationReport: lastVerificationReport != null
          ? lastVerificationReport()
          : this.lastVerificationReport,
      ...
      providedDetails: providedDetails != null
          ? providedDetails()
          : this.providedDetails,
      ...
      relatedCustomer: relatedCustomer != null
          ? relatedCustomer()
          : this.relatedCustomer,
      relatedCustomerAccount: relatedCustomerAccount != null
      ...
      verificationFlow: verificationFlow != null
          ? verificationFlow()
          : this.verificationFlow,
      verifiedOutputs: verifiedOutputs != null
          ? verifiedOutputs()
          : this.verifiedOutputs,
    );
  }
