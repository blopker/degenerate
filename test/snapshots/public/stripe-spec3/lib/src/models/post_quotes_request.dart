...
import 'post_quotes_request_application_fee_amount.dart';
import 'post_quotes_request_application_fee_percent.dart';
import 'post_quotes_request_automatic_tax.dart';
import 'post_quotes_request_collection_method.dart';
import 'post_quotes_request_default_tax_rates.dart';
import 'post_quotes_request_description.dart';
import 'post_quotes_request_discounts.dart';
import 'post_quotes_request_footer.dart';
import 'post_quotes_request_from_quote.dart';
import 'post_quotes_request_header.dart';
import 'post_quotes_request_invoice_settings.dart';
import 'post_quotes_request_line_items.dart';
import 'post_quotes_request_on_behalf_of.dart';
import 'post_quotes_request_subscription_data.dart';
import 'post_quotes_request_transfer_data.dart';
...
final class PostQuotesRequest {
  ...
  factory PostQuotesRequest.fromJson(Map<String, dynamic> json) {
    return PostQuotesRequest(
      ...
      defaultTaxRates: json['default_tax_rates'] != null
          ? PostQuotesRequestDefaultTaxRates.fromJson(
              json['default_tax_rates'] as Map<String, dynamic>,
            )
          : null,
      description: json['description'] != null
          ? PostQuotesRequestDescription.fromJson(
              json['description'] as Map<String, dynamic>,
            )
          : null,
      discounts: json['discounts'] != null
          ? PostQuotesRequestDiscounts.fromJson(
      ...
      footer: json['footer'] != null
          ? PostQuotesRequestFooter.fromJson(
              json['footer'] as Map<String, dynamic>,
            )
          : null,
      fromQuote: json['from_quote'] != null
          ? PostQuotesRequestFromQuote.fromJson(
              json['from_quote'] as Map<String, dynamic>,
            )
          : null,
      header: json['header'] != null
          ? PostQuotesRequestHeader.fromJson(
              json['header'] as Map<String, dynamic>,
            )
          : null,
      invoiceSettings: json['invoice_settings'] != null
          ? PostQuotesRequestInvoiceSettings.fromJson(
      ...
      lineItems: (json['line_items'] as List<dynamic>?)
          ?.map(
            (e) =>
                PostQuotesRequestLineItems.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  PostQuotesRequest copyWith({
    PostQuotesRequestApplicationFeeAmount Function()? applicationFeeAmount,
    PostQuotesRequestApplicationFeePercent Function()? applicationFeePercent,
    PostQuotesRequestAutomaticTax Function()? automaticTax,
    PostQuotesRequestCollectionMethod Function()? collectionMethod,
    String Function()? customer,
    String Function()? customerAccount,
    PostQuotesRequestDefaultTaxRates Function()? defaultTaxRates,
    PostQuotesRequestDescription Function()? description,
    PostQuotesRequestDiscounts Function()? discounts,
    List<String> Function()? expand,
    int Function()? expiresAt,
    PostQuotesRequestFooter Function()? footer,
    PostQuotesRequestFromQuote Function()? fromQuote,
    PostQuotesRequestHeader Function()? header,
    PostQuotesRequestInvoiceSettings Function()? invoiceSettings,
    List<PostQuotesRequestLineItems> Function()? lineItems,
    Map<String, String> Function()? metadata,
    PostQuotesRequestOnBehalfOf Function()? onBehalfOf,
    PostQuotesRequestSubscriptionData Function()? subscriptionData,
    String Function()? testClock,
    PostQuotesRequestTransferData Function()? transferData,
  }) {
    return PostQuotesRequest(
