...
import 'package:collection/collection.dart';import 'post_accounts_account_persons_request_documents_company_authorization_files.dart';final class PostAccountsAccountPersonsRequestDocumentsCompanyAuthorization {const PostAccountsAccountPersonsRequestDocumentsCompanyAuthorization({this.files});
...
factory PostAccountsAccountPersonsRequestDocumentsCompanyAuthorization.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestDocumentsCompanyAuthorization(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPersonsRequestDocumentsCompanyAuthorizationFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
