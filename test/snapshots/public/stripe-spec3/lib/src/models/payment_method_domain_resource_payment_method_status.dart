...
final class PaymentMethodDomainResourcePaymentMethodStatus {
  const PaymentMethodDomainResourcePaymentMethodStatus({
    required this.status,
    this.statusDetails,
  });

  factory PaymentMethodDomainResourcePaymentMethodStatus.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaymentMethodDomainResourcePaymentMethodStatus(
      status: PaymentMethodDomainResourcePaymentMethodStatusStatus.fromJson(
        json['status'] as String,
      ),
      statusDetails: json['status_details'] != null
          ? PaymentMethodDomainResourcePaymentMethodStatusDetails.fromJson(
  ...
  PaymentMethodDomainResourcePaymentMethodStatus copyWith({
    PaymentMethodDomainResourcePaymentMethodStatusStatus? status,
    PaymentMethodDomainResourcePaymentMethodStatusDetails Function()?
    statusDetails,
  }) {
    return PaymentMethodDomainResourcePaymentMethodStatus(
  ...
  @override
  int get hashCode {
    return Object.hash(status, statusDetails);
  }

  @override
  String toString() {
    return 'PaymentMethodDomainResourcePaymentMethodStatus(status: $status, statusDetails: $statusDetails)';
  }
}
