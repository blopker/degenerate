...
final class PostTestHelpersCustomersCustomerFundCashBalanceRequest {
  const PostTestHelpersCustomersCustomerFundCashBalanceRequest({
  ...
  factory PostTestHelpersCustomersCustomerFundCashBalanceRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostTestHelpersCustomersCustomerFundCashBalanceRequest(
  ...
  PostTestHelpersCustomersCustomerFundCashBalanceRequest copyWith({
    int? amount,
    String? currency,
  ...
  @override
  String toString() {
    return 'PostTestHelpersCustomersCustomerFundCashBalanceRequest(amount: $amount, currency: $currency, expand: $expand, reference: $reference)';
  }
}
