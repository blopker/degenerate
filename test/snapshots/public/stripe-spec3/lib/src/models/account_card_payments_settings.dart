...
///
final class AccountCardPaymentsSettings {
  ...
  factory AccountCardPaymentsSettings.fromJson(Map<String, dynamic> json) {
    return AccountCardPaymentsSettings(
      ...
      statementDescriptorPrefixKana:
          json['statement_descriptor_prefix_kana'] as String?,
      statementDescriptorPrefixKanji:
          json['statement_descriptor_prefix_kanji'] as String?,
    );
  }
  ...
  AccountCardPaymentsSettings copyWith({
    AccountDeclineChargeOn Function()? declineOn,
    String? Function()? statementDescriptorPrefix,
    String? Function()? statementDescriptorPrefixKana,
    String? Function()? statementDescriptorPrefixKanji,
  }) {
    return AccountCardPaymentsSettings(
  ...
  @override
  String toString() {
    return 'AccountCardPaymentsSettings(declineOn: $declineOn, statementDescriptorPrefix: $statementDescriptorPrefix, statementDescriptorPrefixKana: $statementDescriptorPrefixKana, statementDescriptorPrefixKanji: $statementDescriptorPrefixKanji)';
  }
}
