...
final class CardAllowRedisplay {
  const CardAllowRedisplay._(this.value);

  factory CardAllowRedisplay.fromJson(String json) {
    return switch (json) {
      'always' => always,
      'limited' => limited,
  ...
  static const CardAllowRedisplay unspecified = CardAllowRedisplay._(
    'unspecified',
  );
  ...
  @override
  String toString() {
    return 'CardAllowRedisplay($value)';
  }
}
