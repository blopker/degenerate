...
import 'get_subscriptions_response_object.dart';
import 'subscription.dart';

///
final class GetSubscriptionsResponse {
  ...
  GetSubscriptionsResponse copyWith({
    ...
    bool? hasMore,
    GetSubscriptionsResponseObject? object,
    String? url,
  }) {
    return GetSubscriptionsResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetSubscriptionsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
