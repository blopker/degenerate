...
final class InlineObject1334 {const InlineObject1334({this.amountGte, this.resetBillingCycleAnchor, });

factory InlineObject1334.fromJson(Map<String, dynamic> json) { return InlineObject1334(
...
InlineObject1334 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject1334(
...
@override String toString() { return 'InlineObject1334(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
