...
///
final class TerminalConfigurationConfigurationResourceEnterpriseTlsWifi {
  const TerminalConfigurationConfigurationResourceEnterpriseTlsWifi({
  ...
  factory TerminalConfigurationConfigurationResourceEnterpriseTlsWifi.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('client_certificate_file') &&
        json['client_certificate_file'] is String &&
        json.containsKey('private_key_file') &&
        json['private_key_file'] is String &&
        json.containsKey('ssid') &&
        json['ssid'] is String;
  }

  TerminalConfigurationConfigurationResourceEnterpriseTlsWifi copyWith({
    String Function()? caCertificateFile,
    String? clientCertificateFile,
    String? privateKeyFile,
    String Function()? privateKeyFilePassword,
    String? ssid,
  }) {
    return TerminalConfigurationConfigurationResourceEnterpriseTlsWifi(
      caCertificateFile: caCertificateFile != null
          ? caCertificateFile()
          : this.caCertificateFile,
      clientCertificateFile:
          clientCertificateFile ?? this.clientCertificateFile,
      privateKeyFile: privateKeyFile ?? this.privateKeyFile,
      privateKeyFilePassword: privateKeyFilePassword != null
  ...
  @override
  String toString() {
    return 'TerminalConfigurationConfigurationResourceEnterpriseTlsWifi(caCertificateFile: $caCertificateFile, clientCertificateFile: $clientCertificateFile, privateKeyFile: $privateKeyFile, privateKeyFilePassword: $privateKeyFilePassword, ssid: $ssid)';
  }
}
