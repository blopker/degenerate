...
final class TerminalReaderReaderResourceRefundPaymentAction {
  ...
  factory TerminalReaderReaderResourceRefundPaymentAction.fromJson(
    Map<String, dynamic> json,
  ) {
    return TerminalReaderReaderResourceRefundPaymentAction(
      amount: json['amount'] != null ? (json['amount'] as num).toInt() : null,
      charge: json['charge'] != null
          ? TerminalReaderReaderResourceRefundPaymentActionCharge.fromJson(
      ...
      paymentIntent: json['payment_intent'] != null
          ? TerminalReaderReaderResourceRefundPaymentActionPaymentIntent.fromJson(
      ...
      refund: json['refund'] != null
          ? TerminalReaderReaderResourceRefundPaymentActionRefund.fromJson(
      ...
      refundPaymentConfig: json['refund_payment_config'] != null
          ? TerminalReaderReaderResourceRefundPaymentConfig.fromJson(
              json['refund_payment_config'] as Map<String, dynamic>,
            )
          : null,
  ...
  final TerminalReaderReaderResourceRefundPaymentActionPaymentIntent?
  paymentIntent;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (refundPaymentConfig != null)
        'refund_payment_config': refundPaymentConfig?.toJson(),
  ...
  TerminalReaderReaderResourceRefundPaymentAction copyWith({
    int Function()? amount,
    TerminalReaderReaderResourceRefundPaymentActionCharge Function()? charge,
    Map<String, String> Function()? metadata,
    TerminalReaderReaderResourceRefundPaymentActionPaymentIntent Function()?
    paymentIntent,
    TerminalReaderReaderResourceRefundPaymentActionReason Function()? reason,
    TerminalReaderReaderResourceRefundPaymentActionRefund Function()? refund,
    bool Function()? refundApplicationFee,
    TerminalReaderReaderResourceRefundPaymentConfig Function()?
    refundPaymentConfig,
    ...
    return TerminalReaderReaderResourceRefundPaymentAction(
      ...
      refundApplicationFee: refundApplicationFee != null
          ...
          : this.refundApplicationFee,
      refundPaymentConfig: refundPaymentConfig != null
          ? refundPaymentConfig()
          : this.refundPaymentConfig,
  ...
  @override
  String toString() {
    return 'TerminalReaderReaderResourceRefundPaymentAction(amount: $amount, charge: $charge, metadata: $metadata, paymentIntent: $paymentIntent, reason: $reason, refund: $refund, refundApplicationFee: $refundApplicationFee, refundPaymentConfig: $refundPaymentConfig, reverseTransfer: $reverseTransfer)';
  }
}
