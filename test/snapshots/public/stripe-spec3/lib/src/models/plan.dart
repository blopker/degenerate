...
import 'plan_transform_usage.dart';
...
final class Plan {
  ...
  factory Plan.fromJson(Map<String, dynamic> json) {
    return Plan(
      ...
      billingScheme: PlanBillingScheme.fromJson(
      ...
      tiersMode: json['tiers_mode'] != null
          ? PlanTiersMode.fromJson(json['tiers_mode'] as String)
          : null,
      transformUsage: json['transform_usage'] != null
          ? PlanTransformUsage.fromJson(
  ...
  Plan copyWith({
    ...
    PlanObject? object,
    PlanProduct? Function()? product,
    List<PlanTier> Function()? tiers,
    PlanTiersMode? Function()? tiersMode,
    PlanTransformUsage? Function()? transformUsage,
