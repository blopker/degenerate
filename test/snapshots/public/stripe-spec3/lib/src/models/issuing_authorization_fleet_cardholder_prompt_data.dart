...
///
final class IssuingAuthorizationFleetCardholderPromptData {
  const IssuingAuthorizationFleetCardholderPromptData({
    this.alphanumericId,
    this.driverId,
    this.odometer,
    this.unspecifiedId,
  ...
  factory IssuingAuthorizationFleetCardholderPromptData.fromJson(
  ...
  IssuingAuthorizationFleetCardholderPromptData copyWith({
    String? Function()? alphanumericId,
    ...
    return IssuingAuthorizationFleetCardholderPromptData(
      alphanumericId: alphanumericId != null
          ? alphanumericId()
          : this.alphanumericId,
  ...
  @override
  String toString() {
    return 'IssuingAuthorizationFleetCardholderPromptData(alphanumericId: $alphanumericId, driverId: $driverId, odometer: $odometer, unspecifiedId: $unspecifiedId, userId: $userId, vehicleNumber: $vehicleNumber)';
  }
}
