...
import 'tax_calculation_line_item_object.dart';
import 'tax_calculation_line_item_tax_behavior.dart';
import 'tax_product_resource_line_item_tax_breakdown.dart';

///
final class TaxCalculationLineItem {
  const TaxCalculationLineItem({
  ...
  factory TaxCalculationLineItem.fromJson(Map<String, dynamic> json) {
    return TaxCalculationLineItem(
      ...
      taxBehavior: TaxCalculationLineItemTaxBehavior.fromJson(
        json['tax_behavior'] as String,
      ),
      taxBreakdown: (json['tax_breakdown'] as List<dynamic>?)
          ?.map(
            (e) => TaxProductResourceLineItemTaxBreakdown.fromJson(
  ...
  TaxCalculationLineItem copyWith({
    int? amount,
    int? amountTax,
    String? id,
    bool? livemode,
    Map<String, String>? Function()? metadata,
    TaxCalculationLineItemObject? object,
    String? Function()? product,
    int? quantity,
    String? reference,
    TaxCalculationLineItemTaxBehavior? taxBehavior,
    List<TaxProductResourceLineItemTaxBreakdown>? Function()? taxBreakdown,
    String? taxCode,
  }) {
    return TaxCalculationLineItem(
  ...
  int get hashCode {
    return Object.hash(
      ...
      reference,
      taxBehavior,
      Object.hashAll(taxBreakdown ?? const []),
      taxCode,
    );
  }
  ...
  @override
  String toString() {
    return 'TaxCalculationLineItem(amount: $amount, amountTax: $amountTax, id: $id, livemode: $livemode, metadata: $metadata, object: $object, product: $product, quantity: $quantity, reference: $reference, taxBehavior: $taxBehavior, taxBreakdown: $taxBreakdown, taxCode: $taxCode)';
  }
}
