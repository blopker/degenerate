...
import 'package:collection/collection.dart';import 'post_billing_credit_grants_request_amount.dart';import 'post_billing_credit_grants_request_applicability_config.dart';import 'post_billing_credit_grants_request_category.dart';final class PostBillingCreditGrantsRequest {const PostBillingCreditGrantsRequest({required this.amount, required this.applicabilityConfig, this.category, this.customer, this.customerAccount, this.effectiveAt, this.expand, this.expiresAt, this.metadata, this.name, this.priority, });
