...
import 'post_invoices_invoice_request_rendering_pdf_page_size.dart';final class PostInvoicesInvoiceRequestRenderingPdf {const PostInvoicesInvoiceRequestRenderingPdf({this.pageSize});
