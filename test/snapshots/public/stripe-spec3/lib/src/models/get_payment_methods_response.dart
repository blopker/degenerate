...
import 'get_payment_methods_response_object.dart';
import 'payment_method.dart';

///
final class GetPaymentMethodsResponse {
  ...
  factory GetPaymentMethodsResponse.fromJson(Map<String, dynamic> json) {
    return GetPaymentMethodsResponse(
      ...
      object: GetPaymentMethodsResponseObject.fromJson(
  ...
  GetPaymentMethodsResponse copyWith({
    List<PaymentMethod>? data,
    bool? hasMore,
    GetPaymentMethodsResponseObject? object,
    String? url,
  }) {
    return GetPaymentMethodsResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetPaymentMethodsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
