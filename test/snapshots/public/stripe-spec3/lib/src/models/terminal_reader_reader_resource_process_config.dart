...
final class TerminalReaderReaderResourceProcessConfig {
  const TerminalReaderReaderResourceProcessConfig({
  ...
  factory TerminalReaderReaderResourceProcessConfig.fromJson(
  ...
  TerminalReaderReaderResourceProcessConfig copyWith({
  ...
  @override
  String toString() {
    return 'TerminalReaderReaderResourceProcessConfig(enableCustomerCancellation: $enableCustomerCancellation, returnUrl: $returnUrl, skipTipping: $skipTipping, tipping: $tipping)';
  }
}
