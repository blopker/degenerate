...
final class ChargeRefunds {
  ...
  factory ChargeRefunds.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'ChargeRefunds(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
