...
final class AccountSettings {
  ...
  factory AccountSettings.fromJson(Map<String, dynamic> json) {
    return AccountSettings(
      bacsDebitPayments: json['bacs_debit_payments'] != null
          ...
          : null,
      branding: AccountBrandingSettings.fromJson(
        json['branding'] as Map<String, dynamic>,
      ),
      cardIssuing: json['card_issuing'] != null
          ? AccountCardIssuingSettings.fromJson(
              json['card_issuing'] as Map<String, dynamic>,
            )
          : null,
      cardPayments: AccountCardPaymentsSettings.fromJson(
        json['card_payments'] as Map<String, dynamic>,
      ),
      dashboard: AccountDashboardSettings.fromJson(
      ...
      invoices: json['invoices'] != null
          ...
          : null,
      payments: AccountPaymentsSettings.fromJson(
      ...
      treasury: json['treasury'] != null
          ? AccountTreasurySettings.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('branding') &&
  ...
  AccountSettings copyWith({
    AccountBacsDebitPaymentsSettings Function()? bacsDebitPayments,
    AccountBrandingSettings? branding,
    AccountCardIssuingSettings Function()? cardIssuing,
    AccountCardPaymentsSettings? cardPayments,
    AccountDashboardSettings? dashboard,
    AccountInvoicesSettings Function()? invoices,
    AccountPaymentsSettings? payments,
    AccountPayoutSettings Function()? payouts,
    AccountSepaDebitPaymentsSettings Function()? sepaDebitPayments,
    AccountTreasurySettings Function()? treasury,
  }) {
    return AccountSettings(
  ...
  @override
  String toString() {
    return 'AccountSettings(bacsDebitPayments: $bacsDebitPayments, branding: $branding, cardIssuing: $cardIssuing, cardPayments: $cardPayments, dashboard: $dashboard, invoices: $invoices, payments: $payments, payouts: $payouts, sepaDebitPayments: $sepaDebitPayments, treasury: $treasury)';
  }
}
