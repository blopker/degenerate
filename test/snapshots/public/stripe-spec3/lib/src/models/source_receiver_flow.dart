...
///
final class SourceReceiverFlow {
  ...
  factory SourceReceiverFlow.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount_charged') &&
        json['amount_charged'] is num &&
        json.containsKey('amount_received') &&
        json['amount_received'] is num &&
        json.containsKey('amount_returned') &&
        json['amount_returned'] is num &&
        json.containsKey('refund_attributes_method') &&
        json['refund_attributes_method'] is String &&
        json.containsKey('refund_attributes_status') &&
        json['refund_attributes_status'] is String;
  }

  SourceReceiverFlow copyWith({
    ...
    return SourceReceiverFlow(
      ...
      refundAttributesMethod:
          refundAttributesMethod ?? this.refundAttributesMethod,
      refundAttributesStatus:
          refundAttributesStatus ?? this.refundAttributesStatus,
    );
  }
  ...
  @override
  String toString() {
    return 'SourceReceiverFlow(address: $address, amountCharged: $amountCharged, amountReceived: $amountReceived, amountReturned: $amountReturned, refundAttributesMethod: $refundAttributesMethod, refundAttributesStatus: $refundAttributesStatus)';
  }
}
