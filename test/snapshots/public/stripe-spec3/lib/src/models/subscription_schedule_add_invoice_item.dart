...
import 'discounts_resource_stackable_discount_with_discount_end.dart';
...
final class SubscriptionScheduleAddInvoiceItem {
  ...
  factory SubscriptionScheduleAddInvoiceItem.fromJson(
    Map<String, dynamic> json,
  ) {
    return SubscriptionScheduleAddInvoiceItem(
      discounts: (json['discounts'] as List<dynamic>)
          .map(
            (e) => DiscountsResourceStackableDiscountWithDiscountEnd.fromJson(
      ...
      period: SubscriptionScheduleAddInvoiceItemPeriod.fromJson(
        json['period'] as Map<String, dynamic>,
      ),
      price: SubscriptionScheduleAddInvoiceItemPrice.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('discounts') &&
        json.containsKey('period') &&
        json.containsKey('price');
  }

  SubscriptionScheduleAddInvoiceItem copyWith({
    List<DiscountsResourceStackableDiscountWithDiscountEnd>? discounts,
  ...
  @override
  String toString() {
    return 'SubscriptionScheduleAddInvoiceItem(discounts: $discounts, metadata: $metadata, period: $period, price: $price, quantity: $quantity, taxRates: $taxRates)';
  }
}
