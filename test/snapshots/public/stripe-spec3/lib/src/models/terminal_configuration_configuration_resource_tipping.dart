...
final class TerminalConfigurationConfigurationResourceTipping {
  const TerminalConfigurationConfigurationResourceTipping({
    this.aed,
    this.aud,
    this.cad,
    this.chf,
  ...
  factory TerminalConfigurationConfigurationResourceTipping.fromJson(
    ...
    return TerminalConfigurationConfigurationResourceTipping(
      ...
      gip: json['gip'] != null
          ? TerminalConfigurationConfigurationResourceCurrencySpecificConfig.fromJson(
              json['gip'] as Map<String, dynamic>,
            )
          : null,
      hkd: json['hkd'] != null
          ? TerminalConfigurationConfigurationResourceCurrencySpecificConfig.fromJson(
  ...
  TerminalConfigurationConfigurationResourceTipping copyWith({
    TerminalConfigurationConfigurationResourceCurrencySpecificConfig Function()?
    aed,
    TerminalConfigurationConfigurationResourceCurrencySpecificConfig Function()?
    aud,
    TerminalConfigurationConfigurationResourceCurrencySpecificConfig Function()?
  ...
  @override
  String toString() {
    return 'TerminalConfigurationConfigurationResourceTipping(aed: $aed, aud: $aud, cad: $cad, chf: $chf, czk: $czk, dkk: $dkk, eur: $eur, gbp: $gbp, gip: $gip, hkd: $hkd, huf: $huf, jpy: $jpy, mxn: $mxn, myr: $myr, nok: $nok, nzd: $nzd, pln: $pln, ron: $ron, sek: $sek, sgd: $sgd, usd: $usd)';
  }
}
