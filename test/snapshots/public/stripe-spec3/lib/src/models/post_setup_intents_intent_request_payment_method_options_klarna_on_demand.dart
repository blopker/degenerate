...
import 'post_setup_intents_intent_request_payment_method_options_klarna_on_demand_purchase_interval.dart';final class PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemand {const PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemand({this.averageAmount, this.maximumAmount, this.minimumAmount, this.purchaseInterval, this.purchaseIntervalCount, });
