...
import 'issuing_authorization_request_amount_details.dart';
import 'issuing_authorization_request_reason.dart';

///
final class IssuingAuthorizationRequest {
  const IssuingAuthorizationRequest({
  ...
  factory IssuingAuthorizationRequest.fromJson(Map<String, dynamic> json) {
    return IssuingAuthorizationRequest(
      amount: (json['amount'] as num).toInt(),
      amountDetails: json['amount_details'] != null
          ? IssuingAuthorizationRequestAmountDetails.fromJson(
      ...
      networkRiskScore: json['network_risk_score'] != null
          ...
          : null,
      reason: IssuingAuthorizationRequestReason.fromJson(
        json['reason'] as String,
      ),
      reasonMessage: json['reason_message'] as String?,
      requestedAt: json['requested_at'] != null
          ? (json['requested_at'] as num).toInt()
          : null,
    );
  }
  ...
  IssuingAuthorizationRequest copyWith({
    int? amount,
    IssuingAuthorizationRequestAmountDetails? Function()? amountDetails,
    bool? approved,
    ...
    String? Function()? reasonMessage,
    int? Function()? requestedAt,
  }) {
    return IssuingAuthorizationRequest(
