...
factory PostAccountsAccountPeoplePersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequest(
  additionalTosAcceptances: json['additional_tos_acceptances'] != null
        ? PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptances.fromJson(json['additional_tos_acceptances'] as Map<String, dynamic>)
        : null,
  address: json['address'] != null
        ? PostAccountsAccountPeoplePersonRequestAddress.fromJson(json['address'] as Map<String, dynamic>)
        : null,
  addressKana: json['address_kana'] != null
        ? PostAccountsAccountPeoplePersonRequestAddressKana.fromJson(json['address_kana'] as Map<String, dynamic>)
        : null,
  addressKanji: json['address_kanji'] != null
        ? PostAccountsAccountPeoplePersonRequestAddressKanji.fromJson(json['address_kanji'] as Map<String, dynamic>)
        : null,
  dob: json['dob'] != null
        ? PostAccountsAccountPeoplePersonRequestDob.fromJson(json['dob'] as Map<String, dynamic>)
        : null,
  documents: json['documents'] != null
        ? PostAccountsAccountPeoplePersonRequestDocuments.fromJson(json['documents'] as Map<String, dynamic>)
        : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null
        ? PostAccountsAccountPeoplePersonRequestFullNameAliases.fromJson(json['full_name_aliases'] as Map<String, dynamic>)
        : null,
  ...
  metadata: json['metadata'] != null
        ? PostAccountsAccountPeoplePersonRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
  ...
  registeredAddress: json['registered_address'] != null
        ? PostAccountsAccountPeoplePersonRequestRegisteredAddress.fromJson(json['registered_address'] as Map<String, dynamic>)
        : null,
  relationship: json['relationship'] != null
        ? PostAccountsAccountPeoplePersonRequestRelationship.fromJson(json['relationship'] as Map<String, dynamic>)
        : null,
  ssnLast4: json['ssn_last_4'] as String?,
  usCfpbData: json['us_cfpb_data'] != null
        ? PostAccountsAccountPeoplePersonRequestUsCfpbData.fromJson(json['us_cfpb_data'] as Map<String, dynamic>)
        : null,
  verification: json['verification'] != null
        ? PostAccountsAccountPeoplePersonRequestVerification.fromJson(json['verification'] as Map<String, dynamic>)
        : null,
); }
