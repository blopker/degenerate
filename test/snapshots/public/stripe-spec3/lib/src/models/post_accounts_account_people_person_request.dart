...
import 'post_accounts_account_people_person_request_additional_tos_acceptances.dart';
import 'post_accounts_account_people_person_request_address.dart';
import 'post_accounts_account_people_person_request_address_kana.dart';
import 'post_accounts_account_people_person_request_address_kanji.dart';
import 'post_accounts_account_people_person_request_dob.dart';
import 'post_accounts_account_people_person_request_documents.dart';
import 'post_accounts_account_people_person_request_full_name_aliases.dart';
import 'post_accounts_account_people_person_request_metadata.dart';
import 'post_accounts_account_people_person_request_political_exposure.dart';
import 'post_accounts_account_people_person_request_registered_address.dart';
import 'post_accounts_account_people_person_request_relationship.dart';
import 'post_accounts_account_people_person_request_us_cfpb_data.dart';
import 'post_accounts_account_people_person_request_verification.dart';
...
final class PostAccountsAccountPeoplePersonRequest {
  ...
  factory PostAccountsAccountPeoplePersonRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostAccountsAccountPeoplePersonRequest(
      additionalTosAcceptances: json['additional_tos_acceptances'] != null
          ? PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptances.fromJson(
              json['additional_tos_acceptances'] as Map<String, dynamic>,
            )
          : null,
      address: json['address'] != null
          ? PostAccountsAccountPeoplePersonRequestAddress.fromJson(
              json['address'] as Map<String, dynamic>,
            )
          : null,
      addressKana: json['address_kana'] != null
          ? PostAccountsAccountPeoplePersonRequestAddressKana.fromJson(
              json['address_kana'] as Map<String, dynamic>,
            )
          : null,
      addressKanji: json['address_kanji'] != null
          ? PostAccountsAccountPeoplePersonRequestAddressKanji.fromJson(
              json['address_kanji'] as Map<String, dynamic>,
            )
          : null,
      dob: json['dob'] != null
          ? PostAccountsAccountPeoplePersonRequestDob.fromJson(
              json['dob'] as Map<String, dynamic>,
            )
          : null,
      documents: json['documents'] != null
          ? PostAccountsAccountPeoplePersonRequestDocuments.fromJson(
      ...
      fullNameAliases: json['full_name_aliases'] != null
          ? PostAccountsAccountPeoplePersonRequestFullNameAliases.fromJson(
      ...
      metadata: json['metadata'] != null
          ? PostAccountsAccountPeoplePersonRequestMetadata.fromJson(
      ...
      politicalExposure: json['political_exposure'] != null
          ? PostAccountsAccountPeoplePersonRequestPoliticalExposure.fromJson(
              json['political_exposure'] as String,
            )
          : null,
      registeredAddress: json['registered_address'] != null
          ? PostAccountsAccountPeoplePersonRequestRegisteredAddress.fromJson(
              json['registered_address'] as Map<String, dynamic>,
            )
          : null,
      relationship: json['relationship'] != null
          ? PostAccountsAccountPeoplePersonRequestRelationship.fromJson(
              json['relationship'] as Map<String, dynamic>,
            )
          : null,
      ssnLast4: json['ssn_last_4'] as String?,
      usCfpbData: json['us_cfpb_data'] != null
          ? PostAccountsAccountPeoplePersonRequestUsCfpbData.fromJson(
              json['us_cfpb_data'] as Map<String, dynamic>,
            )
          : null,
      verification: json['verification'] != null
          ? PostAccountsAccountPeoplePersonRequestVerification.fromJson(
  ...
  final PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptances?
  ...
  final PostAccountsAccountPeoplePersonRequestPoliticalExposure?
  politicalExposure;

  /// The person's registered address.
  final PostAccountsAccountPeoplePersonRequestRegisteredAddress?
  registeredAddress;
  ...
  PostAccountsAccountPeoplePersonRequest copyWith({
    PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptances Function()?
    additionalTosAcceptances,
    PostAccountsAccountPeoplePersonRequestAddress Function()? address,
    PostAccountsAccountPeoplePersonRequestAddressKana Function()? addressKana,
    PostAccountsAccountPeoplePersonRequestAddressKanji Function()? addressKanji,
    PostAccountsAccountPeoplePersonRequestDob Function()? dob,
    PostAccountsAccountPeoplePersonRequestDocuments Function()? documents,
    String Function()? email,
    List<String> Function()? expand,
    String Function()? firstName,
    String Function()? firstNameKana,
    String Function()? firstNameKanji,
    PostAccountsAccountPeoplePersonRequestFullNameAliases Function()?
    fullNameAliases,
    ...
    PostAccountsAccountPeoplePersonRequestMetadata Function()? metadata,
    String Function()? nationality,
    String Function()? personToken,
    String Function()? phone,
    PostAccountsAccountPeoplePersonRequestPoliticalExposure Function()?
    politicalExposure,
    PostAccountsAccountPeoplePersonRequestRegisteredAddress Function()?
    registeredAddress,
    PostAccountsAccountPeoplePersonRequestRelationship Function()? relationship,
    String Function()? ssnLast4,
    PostAccountsAccountPeoplePersonRequestUsCfpbData Function()? usCfpbData,
    PostAccountsAccountPeoplePersonRequestVerification Function()? verification,
  }) {
    return PostAccountsAccountPeoplePersonRequest(
