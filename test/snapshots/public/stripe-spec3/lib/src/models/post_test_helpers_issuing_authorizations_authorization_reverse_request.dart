...
import 'package:collection/collection.dart';final class PostTestHelpersIssuingAuthorizationsAuthorizationReverseRequest {const PostTestHelpersIssuingAuthorizationsAuthorizationReverseRequest({this.expand, this.reverseAmount, });
