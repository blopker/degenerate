...
final class Charge {
  ...
  factory Charge.fromJson(Map<String, dynamic> json) {
    return Charge(
      ...
      application: json['application'] != null
          ? ChargeApplication.fromJson(
              json['application'] as Map<String, dynamic>,
            )
          : null,
      applicationFee: json['application_fee'] != null
          ? ChargeApplicationFee.fromJson(
              json['application_fee'] as Map<String, dynamic>,
            )
          : null,
      ...
      balanceTransaction: json['balance_transaction'] != null
          ? ChargeBalanceTransaction.fromJson(
      ...
      failureBalanceTransaction: json['failure_balance_transaction'] != null
          ? ChargeFailureBalanceTransaction.fromJson(
              json['failure_balance_transaction'] as Map<String, dynamic>,
            )
          : null,
      failureCode: json['failure_code'] as String?,
      failureMessage: json['failure_message'] as String?,
      fraudDetails: json['fraud_details'] != null
          ? ChargeFraudDetails2.fromJson(
              json['fraud_details'] as Map<String, dynamic>,
            )
          : null,
      ...
      sourceTransfer: json['source_transfer'] != null
          ? ChargeSourceTransfer.fromJson(
              json['source_transfer'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (failureBalanceTransaction != null)
        'failure_balance_transaction': failureBalanceTransaction?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        json['amount'] is num &&
        json.containsKey('amount_captured') &&
        json['amount_captured'] is num &&
        json.containsKey('amount_refunded') &&
        json['amount_refunded'] is num &&
        json.containsKey('billing_details') &&
        json.containsKey('captured') &&
        json['captured'] is bool &&
        json.containsKey('created') &&
        json['created'] is num &&
        json.containsKey('currency') &&
        json['currency'] is String &&
        json.containsKey('disputed') &&
        json['disputed'] is bool &&
        json.containsKey('id') &&
        json['id'] is String &&
        ...
        json.containsKey('paid') &&
        json['paid'] is bool &&
        json.containsKey('refunded') &&
        json['refunded'] is bool &&
  ...
  Charge copyWith({
    ...
    int? amountCaptured,
    int? amountRefunded,
    ChargeApplication? Function()? application,
    ChargeApplicationFee? Function()? applicationFee,
    int? Function()? applicationFeeAmount,
    ChargeBalanceTransaction? Function()? balanceTransaction,
    BillingDetails? billingDetails,
    String? Function()? calculatedStatementDescriptor,
    bool? captured,
    int? created,
    String? currency,
    ChargeCustomer? Function()? customer,
    String? Function()? description,
    bool? disputed,
    ChargeFailureBalanceTransaction? Function()? failureBalanceTransaction,
    String? Function()? failureCode,
    String? Function()? failureMessage,
    ChargeFraudDetails2? Function()? fraudDetails,
    String? id,
    bool? livemode,
    Map<String, String>? metadata,
    ChargeObject? object,
    ChargeOnBehalfOf? Function()? onBehalfOf,
    ChargeOutcome2? Function()? outcome,
    bool? paid,
    ChargePaymentIntent? Function()? paymentIntent,
    String? Function()? paymentMethod,
    ChargePaymentMethodDetails? Function()? paymentMethodDetails,
    ...
    String? Function()? receiptUrl,
    bool? refunded,
    ChargeRefunds? Function()? refunds,
    ChargeReview? Function()? review,
    ChargeShipping? Function()? shipping,
    ChargeSourceTransfer? Function()? sourceTransfer,
    String? Function()? statementDescriptor,
    String? Function()? statementDescriptorSuffix,
    ChargeStatus? status,
    ChargeTransfer Function()? transfer,
    ChargeTransferData2? Function()? transferData,
    ...
    return Charge(
      ...
      calculatedStatementDescriptor: calculatedStatementDescriptor != null
          ? calculatedStatementDescriptor()
          : this.calculatedStatementDescriptor,
      ...
      failureBalanceTransaction: failureBalanceTransaction != null
      ...
      sourceTransfer: sourceTransfer != null
          ? sourceTransfer()
          : this.sourceTransfer,
