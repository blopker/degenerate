...
import 'package:collection/collection.dart';import 'post_refunds_request_metadata.dart';import 'post_refunds_request_origin.dart';import 'post_refunds_request_reason.dart';final class PostRefundsRequest {const PostRefundsRequest({this.amount, this.charge, this.currency, this.customer, this.expand, this.instructionsEmail, this.metadata, this.origin, this.paymentIntent, this.reason, this.refundApplicationFee, this.reverseTransfer, });
...
factory PostRefundsRequest.fromJson(Map<String, dynamic> json) { return PostRefundsRequest(
  ...
  metadata: json['metadata'] != null
        ? PostRefundsRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
