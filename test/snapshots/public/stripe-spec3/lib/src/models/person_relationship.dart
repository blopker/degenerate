...
final class PersonRelationship {
  ...
  factory PersonRelationship.fromJson(Map<String, dynamic> json) {
    return PersonRelationship(
      ...
      percentOwnership: json['percent_ownership'] != null
          ? (json['percent_ownership'] as num).toDouble()
          : null,
  ...
  PersonRelationship copyWith({
    ...
    bool? Function()? owner,
    double? Function()? percentOwnership,
  ...
  @override
  String toString() {
    return 'PersonRelationship(authorizer: $authorizer, director: $director, executive: $executive, legalGuardian: $legalGuardian, owner: $owner, percentOwnership: $percentOwnership, representative: $representative, title: $title)';
  }
}
