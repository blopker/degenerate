...
///
final class TaxProductResourceTaxAssociationTransactionAttempts {
  const TaxProductResourceTaxAssociationTransactionAttempts({
    this.committed,
    this.errored,
  ...
  factory TaxProductResourceTaxAssociationTransactionAttempts.fromJson(
    Map<String, dynamic> json,
  ) {
    return TaxProductResourceTaxAssociationTransactionAttempts(
      committed: json['committed'] != null
          ? TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted.fromJson(
              json['committed'] as Map<String, dynamic>,
            )
          : null,
      errored: json['errored'] != null
          ? TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored.fromJson(
              json['errored'] as Map<String, dynamic>,
            )
          : null,
  ...
  final TaxProductResourceTaxAssociationTransactionAttemptsResourceCommitted?
  committed;

  final TaxProductResourceTaxAssociationTransactionAttemptsResourceErrored?
  errored;
  ...
  @override
  int get hashCode {
    return Object.hash(committed, errored, source, status);
  }

  @override
  String toString() {
    return 'TaxProductResourceTaxAssociationTransactionAttempts(committed: $committed, errored: $errored, source: $source, status: $status)';
  }
}
