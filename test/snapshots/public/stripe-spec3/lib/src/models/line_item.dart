...
import 'line_item_discounts.dart';
import 'line_item_object.dart';
import 'line_item_parent.dart';
import 'line_item_pricing.dart';
...
final class LineItem {
  ...
  factory LineItem.fromJson(Map<String, dynamic> json) {
    return LineItem(
      ...
      discounts: (json['discounts'] as List<dynamic>)
          .map((e) => LineItemDiscounts.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        ...
        json.containsKey('discountable') &&
        json['discountable'] is bool &&
  ...
  LineItem copyWith({
    ...
    List<DiscountsResourceDiscountAmount>? Function()? discountAmounts,
    bool? discountable,
    List<LineItemDiscounts>? discounts,
    String? id,
    String? Function()? invoice,
    bool? livemode,
    Map<String, String>? metadata,
    LineItemObject? object,
    LineItemParent? Function()? parent,
    InvoiceLineItemPeriod? period,
    List<InvoicesResourcePretaxCreditAmount>? Function()? pretaxCreditAmounts,
    LineItemPricing? Function()? pricing,
    int? Function()? quantity,
    LineItemSubscription? Function()? subscription,
    int? subtotal,
    List<BillingBillResourceInvoicingTaxesTax>? Function()? taxes,
  }) {
    return LineItem(
      amount: amount ?? this.amount,
      currency: currency ?? this.currency,
      description: description != null ? description() : this.description,
      discountAmounts: discountAmounts != null
          ? discountAmounts()
          : this.discountAmounts,
      ...
      pretaxCreditAmounts: pretaxCreditAmounts != null
          ? pretaxCreditAmounts()
          : this.pretaxCreditAmounts,
  ...
  int get hashCode {
    return Object.hash(
      ...
      currency,
      description,
      Object.hashAll(discountAmounts ?? const []),
      discountable,
      ...
      parent,
      period,
      Object.hashAll(pretaxCreditAmounts ?? const []),
      pricing,
      quantity,
      subscription,
      subtotal,
