...
import 'package:collection/collection.dart';import 'billing_bill_resource_invoicing_taxes_tax.dart';import 'discounts_resource_discount_amount.dart';import 'invoice_line_item_period.dart';import 'invoices_resource_pretax_credit_amount.dart';import 'line_item_discounts.dart';import 'line_item_object.dart';import 'line_item_parent.dart';import 'line_item_pricing.dart';import 'line_item_subscription.dart';/// Invoice Line Items represent the individual lines within an [invoice](https://docs.stripe.com/api/invoices) and only exist within the context of an invoice.
/// 
...
factory LineItem.fromJson(Map<String, dynamic> json) { return LineItem(
  ...
  discounts: (json['discounts'] as List<dynamic>).map((e) => LineItemDiscounts.fromJson(e as Map<String, dynamic>)).toList(),
