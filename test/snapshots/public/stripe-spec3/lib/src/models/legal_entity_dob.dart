...
///
final class LegalEntityDob {
  const LegalEntityDob({this.day, this.month, this.year});

  factory LegalEntityDob.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'LegalEntityDob(day: $day, month: $month, year: $year)';
  }
}
