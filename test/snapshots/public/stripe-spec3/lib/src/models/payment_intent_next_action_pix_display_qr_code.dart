...
///
final class PaymentIntentNextActionPixDisplayQrCode {
  ...
  factory PaymentIntentNextActionPixDisplayQrCode.fromJson(
  ...
  PaymentIntentNextActionPixDisplayQrCode copyWith({
    String Function()? data,
    int Function()? expiresAt,
    String Function()? hostedInstructionsUrl,
    String Function()? imageUrlPng,
    String Function()? imageUrlSvg,
  }) {
    return PaymentIntentNextActionPixDisplayQrCode(
  ...
  @override
  String toString() {
    return 'PaymentIntentNextActionPixDisplayQrCode(data: $data, expiresAt: $expiresAt, hostedInstructionsUrl: $hostedInstructionsUrl, imageUrlPng: $imageUrlPng, imageUrlSvg: $imageUrlSvg)';
  }
}
