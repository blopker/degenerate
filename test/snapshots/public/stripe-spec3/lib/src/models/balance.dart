...
final class Balance {
  ...
  factory Balance.fromJson(Map<String, dynamic> json) {
    return Balance(
      available: (json['available'] as List<dynamic>)
          ...
          .toList(),
      connectReserved: (json['connect_reserved'] as List<dynamic>?)
          ?.map((e) => BalanceAmount.fromJson(e as Map<String, dynamic>))
          .toList(),
      instantAvailable: (json['instant_available'] as List<dynamic>?)
          ?.map((e) => BalanceAmountNet.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      refundAndDisputePrefunding: json['refund_and_dispute_prefunding'] != null
          ? BalanceDetailUngated.fromJson(
              json['refund_and_dispute_prefunding'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (connectReserved != null)
        'connect_reserved': connectReserved?.map((e) => e.toJson()).toList(),
      if (instantAvailable != null)
        'instant_available': instantAvailable?.map((e) => e.toJson()).toList(),
      if (issuing != null) 'issuing': issuing?.toJson(),
      'livemode': livemode,
      'object': object.toJson(),
      'pending': pending.map((e) => e.toJson()).toList(),
      if (refundAndDisputePrefunding != null)
        'refund_and_dispute_prefunding': refundAndDisputePrefunding?.toJson(),
    };
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('available') &&
  ...
  Balance copyWith({
    ...
    List<BalanceAmount> Function()? connectReserved,
    List<BalanceAmountNet> Function()? instantAvailable,
    BalanceDetail Function()? issuing,
    bool? livemode,
    BalanceObject? object,
    List<BalanceAmount>? pending,
    BalanceDetailUngated Function()? refundAndDisputePrefunding,
  }) {
    return Balance(
      available: available ?? this.available,
      connectReserved: connectReserved != null
          ? connectReserved()
          : this.connectReserved,
      instantAvailable: instantAvailable != null
          ? instantAvailable()
          : this.instantAvailable,
      ...
      refundAndDisputePrefunding: refundAndDisputePrefunding != null
    ...
    return identical(this, other) ||
        other is Balance &&
            ...
            const ListEquality<dynamic>().equals(
              connectReserved,
              other.connectReserved,
            ) &&
            const ListEquality<dynamic>().equals(
              instantAvailable,
              other.instantAvailable,
            ) &&
            issuing == other.issuing &&
            livemode == other.livemode &&
            object == other.object &&
            const ListEquality<dynamic>().equals(pending, other.pending) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(connectReserved ?? const []),
      Object.hashAll(instantAvailable ?? const []),
      issuing,
      livemode,
      object,
  ...
  @override
  String toString() {
    return 'Balance(available: $available, connectReserved: $connectReserved, instantAvailable: $instantAvailable, issuing: $issuing, livemode: $livemode, object: $object, pending: $pending, refundAndDisputePrefunding: $refundAndDisputePrefunding)';
  }
}
