...
import 'post_tax_registrations_request_country_options_by_type.dart';final class PostTaxRegistrationsRequestCountryOptionsBy {const PostTaxRegistrationsRequestCountryOptionsBy({required this.type});
