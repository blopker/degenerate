...
///
final class AccountCapabilityRequirements {
  ...
  factory AccountCapabilityRequirements.fromJson(Map<String, dynamic> json) {
    return AccountCapabilityRequirements(
      ...
      disabledReason: json['disabled_reason'] != null
          ? AccountCapabilityRequirementsDisabledReason.fromJson(
  ...
  AccountCapabilityRequirements copyWith({
    List<AccountRequirementsAlternative>? Function()? alternatives,
    int? Function()? currentDeadline,
    List<String>? currentlyDue,
    AccountCapabilityRequirementsDisabledReason? Function()? disabledReason,
  ...
  @override
  String toString() {
    return 'AccountCapabilityRequirements(alternatives: $alternatives, currentDeadline: $currentDeadline, currentlyDue: $currentlyDue, disabledReason: $disabledReason, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
