...
import 'post_invoices_request_account_tax_ids.dart';
import 'post_invoices_request_automatic_tax.dart';
import 'post_invoices_request_collection_method.dart';
import 'post_invoices_request_custom_fields.dart';
import 'post_invoices_request_discounts.dart';
import 'post_invoices_request_from_invoice.dart';
import 'post_invoices_request_issuer.dart';
import 'post_invoices_request_metadata.dart';
import 'post_invoices_request_payment_settings.dart';
import 'post_invoices_request_pending_invoice_items_behavior.dart';
import 'post_invoices_request_rendering.dart';
import 'post_invoices_request_shipping_cost.dart';
import 'post_invoices_request_shipping_details.dart';
import 'post_invoices_request_transfer_data.dart';

final class PostInvoicesRequest {
  const PostInvoicesRequest({
    this.accountTaxIds,
  ...
  factory PostInvoicesRequest.fromJson(Map<String, dynamic> json) {
    return PostInvoicesRequest(
      accountTaxIds: json['account_tax_ids'] != null
          ? PostInvoicesRequestAccountTaxIds.fromJson(
      ...
      automaticTax: json['automatic_tax'] != null
          ? PostInvoicesRequestAutomaticTax.fromJson(
      ...
      collectionMethod: json['collection_method'] != null
          ? PostInvoicesRequestCollectionMethod.fromJson(
              json['collection_method'] as String,
            )
          : null,
      currency: json['currency'] as String?,
      customFields: json['custom_fields'] != null
          ? PostInvoicesRequestCustomFields.fromJson(
      ...
      discounts: json['discounts'] != null
          ? PostInvoicesRequestDiscounts.fromJson(
      ...
      fromInvoice: json['from_invoice'] != null
          ? PostInvoicesRequestFromInvoice.fromJson(
              json['from_invoice'] as Map<String, dynamic>,
            )
          : null,
      issuer: json['issuer'] != null
          ? PostInvoicesRequestIssuer.fromJson(
              json['issuer'] as Map<String, dynamic>,
            )
          : null,
      metadata: json['metadata'] != null
          ? PostInvoicesRequestMetadata.fromJson(
      ...
      paymentSettings: json['payment_settings'] != null
          ? PostInvoicesRequestPaymentSettings.fromJson(
              json['payment_settings'] as Map<String, dynamic>,
            )
          : null,
      pendingInvoiceItemsBehavior:
          json['pending_invoice_items_behavior'] != null
          ? PostInvoicesRequestPendingInvoiceItemsBehavior.fromJson(
              json['pending_invoice_items_behavior'] as String,
            )
          : null,
      rendering: json['rendering'] != null
          ? PostInvoicesRequestRendering.fromJson(
              json['rendering'] as Map<String, dynamic>,
            )
          : null,
      shippingCost: json['shipping_cost'] != null
          ? PostInvoicesRequestShippingCost.fromJson(
              json['shipping_cost'] as Map<String, dynamic>,
            )
          : null,
      shippingDetails: json['shipping_details'] != null
          ? PostInvoicesRequestShippingDetails.fromJson(
      ...
      transferData: json['transfer_data'] != null
          ? PostInvoicesRequestTransferData.fromJson(
  ...
  final PostInvoicesRequestPendingInvoiceItemsBehavior?
  pendingInvoiceItemsBehavior;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (pendingInvoiceItemsBehavior != null)
        'pending_invoice_items_behavior': pendingInvoiceItemsBehavior?.toJson(),
  ...
  PostInvoicesRequest copyWith({
    PostInvoicesRequestAccountTaxIds Function()? accountTaxIds,
    int Function()? applicationFeeAmount,
    bool Function()? autoAdvance,
    PostInvoicesRequestAutomaticTax Function()? automaticTax,
    int Function()? automaticallyFinalizesAt,
    PostInvoicesRequestCollectionMethod Function()? collectionMethod,
    String Function()? currency,
    PostInvoicesRequestCustomFields Function()? customFields,
    ...
    List<String> Function()? defaultTaxRates,
    String Function()? description,
    PostInvoicesRequestDiscounts Function()? discounts,
    int Function()? dueDate,
    int Function()? effectiveAt,
    List<String> Function()? expand,
    String Function()? footer,
    PostInvoicesRequestFromInvoice Function()? fromInvoice,
    PostInvoicesRequestIssuer Function()? issuer,
    PostInvoicesRequestMetadata Function()? metadata,
    String Function()? number,
    String Function()? onBehalfOf,
    PostInvoicesRequestPaymentSettings Function()? paymentSettings,
    PostInvoicesRequestPendingInvoiceItemsBehavior Function()?
    pendingInvoiceItemsBehavior,
    PostInvoicesRequestRendering Function()? rendering,
    PostInvoicesRequestShippingCost Function()? shippingCost,
    PostInvoicesRequestShippingDetails Function()? shippingDetails,
    String Function()? statementDescriptor,
    String Function()? subscription,
    PostInvoicesRequestTransferData Function()? transferData,
  }) {
    return PostInvoicesRequest(
      ...
      paymentSettings: paymentSettings != null
          ? paymentSettings()
          : this.paymentSettings,
      pendingInvoiceItemsBehavior: pendingInvoiceItemsBehavior != null
          ? pendingInvoiceItemsBehavior()
          : this.pendingInvoiceItemsBehavior,
