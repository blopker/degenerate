...
final class SourceTypeCardPresent {
  ...
  factory SourceTypeCardPresent.fromJson(Map<String, dynamic> json) {
    return SourceTypeCardPresent(
      ...
      evidenceTransactionCertificate:
          json['evidence_transaction_certificate'] as String?,
      ...
      terminalVerificationResults:
          json['terminal_verification_results'] as String?,
      transactionStatusInformation:
          json['transaction_status_information'] as String?,
    );
  }
  ...
  SourceTypeCardPresent copyWith({
    String Function()? applicationCryptogram,
    String Function()? applicationPreferredName,
    String? Function()? authorizationCode,
    String Function()? authorizationResponseCode,
    String? Function()? brand,
    String? Function()? country,
    String Function()? cvmType,
    String? Function()? dataType,
    String Function()? dedicatedFileName,
    String Function()? emvAuthData,
    String? Function()? evidenceCustomerSignature,
    String? Function()? evidenceTransactionCertificate,
    int? Function()? expMonth,
    int? Function()? expYear,
    String Function()? fingerprint,
    String? Function()? funding,
    String? Function()? last4,
    String? Function()? posDeviceId,
    String Function()? posEntryMode,
    String? Function()? readMethod,
    String? Function()? reader,
    String Function()? terminalVerificationResults,
    String Function()? transactionStatusInformation,
  }) {
    return SourceTypeCardPresent(
      applicationCryptogram: applicationCryptogram != null
      ...
      authorizationCode: authorizationCode != null
          ? authorizationCode()
          : this.authorizationCode,
      authorizationResponseCode: authorizationResponseCode != null
      ...
      dedicatedFileName: dedicatedFileName != null
          ? dedicatedFileName()
          : this.dedicatedFileName,
      emvAuthData: emvAuthData != null ? emvAuthData() : this.emvAuthData,
      evidenceCustomerSignature: evidenceCustomerSignature != null
          ? evidenceCustomerSignature()
          : this.evidenceCustomerSignature,
      evidenceTransactionCertificate: evidenceTransactionCertificate != null
          ? evidenceTransactionCertificate()
          : this.evidenceTransactionCertificate,
      ...
      terminalVerificationResults: terminalVerificationResults != null
          ? terminalVerificationResults()
          : this.terminalVerificationResults,
      transactionStatusInformation: transactionStatusInformation != null
          ? transactionStatusInformation()
          : this.transactionStatusInformation,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SourceTypeCardPresent &&
            ...
            evidenceTransactionCertificate ==
                other.evidenceTransactionCertificate &&
