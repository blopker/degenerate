...
import 'package:collection/collection.dart';import 'post_charges_charge_refund_request_metadata.dart';import 'post_charges_charge_refund_request_reason.dart';final class PostChargesChargeRefundRequest {const PostChargesChargeRefundRequest({this.amount, this.expand, this.instructionsEmail, this.metadata, this.paymentIntent, this.reason, this.refundApplicationFee, this.reverseTransfer, });
...
factory PostChargesChargeRefundRequest.fromJson(Map<String, dynamic> json) { return PostChargesChargeRefundRequest(
  ...
  metadata: json['metadata'] != null
        ? PostChargesChargeRefundRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
