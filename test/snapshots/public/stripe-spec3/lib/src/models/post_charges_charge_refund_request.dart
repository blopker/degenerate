...
import 'post_charges_charge_refund_request_metadata.dart';
import 'post_charges_charge_refund_request_reason.dart';

final class PostChargesChargeRefundRequest {
  const PostChargesChargeRefundRequest({
    this.amount,
    this.expand,
  ...
  factory PostChargesChargeRefundRequest.fromJson(Map<String, dynamic> json) {
    return PostChargesChargeRefundRequest(
      ...
      metadata: json['metadata'] != null
          ? PostChargesChargeRefundRequestMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            )
          : null,
      paymentIntent: json['payment_intent'] as String?,
      reason: json['reason'] != null
          ? PostChargesChargeRefundRequestReason.fromJson(
  ...
  PostChargesChargeRefundRequest copyWith({
    int Function()? amount,
    List<String> Function()? expand,
    String Function()? instructionsEmail,
    PostChargesChargeRefundRequestMetadata Function()? metadata,
    String Function()? paymentIntent,
    PostChargesChargeRefundRequestReason Function()? reason,
  ...
  @override
  String toString() {
    return 'PostChargesChargeRefundRequest(amount: $amount, expand: $expand, instructionsEmail: $instructionsEmail, metadata: $metadata, paymentIntent: $paymentIntent, reason: $reason, refundApplicationFee: $refundApplicationFee, reverseTransfer: $reverseTransfer)';
  }
}
