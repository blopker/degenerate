...
final class SourceTypeAcssDebit {
  ...
  factory SourceTypeAcssDebit.fromJson(Map<String, dynamic> json) {
  ...
  SourceTypeAcssDebit copyWith({
    String? Function()? bankAddressCity,
    String? Function()? bankAddressLine1,
    String? Function()? bankAddressLine2,
    String? Function()? bankAddressPostalCode,
    ...
    return SourceTypeAcssDebit(
      bankAddressCity: bankAddressCity != null
          ? bankAddressCity()
          : this.bankAddressCity,
      bankAddressLine1: bankAddressLine1 != null
          ? bankAddressLine1()
          : this.bankAddressLine1,
      bankAddressLine2: bankAddressLine2 != null
          ? bankAddressLine2()
          : this.bankAddressLine2,
      bankAddressPostalCode: bankAddressPostalCode != null
  ...
  @override
  String toString() {
    return 'SourceTypeAcssDebit(bankAddressCity: $bankAddressCity, bankAddressLine1: $bankAddressLine1, bankAddressLine2: $bankAddressLine2, bankAddressPostalCode: $bankAddressPostalCode, bankName: $bankName, category: $category, country: $country, fingerprint: $fingerprint, last4: $last4, routingNumber: $routingNumber)';
  }
}
