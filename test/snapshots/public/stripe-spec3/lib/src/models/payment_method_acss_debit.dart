...
///
final class PaymentMethodAcssDebit {
  ...
  factory PaymentMethodAcssDebit.fromJson(Map<String, dynamic> json) {
  ...
  PaymentMethodAcssDebit copyWith({
  ...
  @override
  String toString() {
    return 'PaymentMethodAcssDebit(bankName: $bankName, fingerprint: $fingerprint, institutionNumber: $institutionNumber, last4: $last4, transitNumber: $transitNumber)';
  }
}
