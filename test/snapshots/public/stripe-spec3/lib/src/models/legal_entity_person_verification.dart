...
import 'legal_entity_person_verification_additional_document.dart';
import 'legal_entity_person_verification_document.dart';

///
final class LegalEntityPersonVerification {
  const LegalEntityPersonVerification({
  ...
  factory LegalEntityPersonVerification.fromJson(Map<String, dynamic> json) {
    return LegalEntityPersonVerification(
      additionalDocument: json['additional_document'] != null
          ? LegalEntityPersonVerificationAdditionalDocument.fromJson(
  ...
  LegalEntityPersonVerification copyWith({
    LegalEntityPersonVerificationAdditionalDocument? Function()?
    additionalDocument,
    String? Function()? details,
    String? Function()? detailsCode,
    LegalEntityPersonVerificationDocument Function()? document,
    String? status,
  }) {
    return LegalEntityPersonVerification(
  ...
  @override
  String toString() {
    return 'LegalEntityPersonVerification(additionalDocument: $additionalDocument, details: $details, detailsCode: $detailsCode, document: $document, status: $status)';
  }
}
