...
///
final class ConnectEmbeddedDisputesListFeatures {
  const ConnectEmbeddedDisputesListFeatures({
  ...
  factory ConnectEmbeddedDisputesListFeatures.fromJson(
  ...
  ConnectEmbeddedDisputesListFeatures copyWith({
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedDisputesListFeatures(capturePayments: $capturePayments, destinationOnBehalfOfChargeManagement: $destinationOnBehalfOfChargeManagement, disputeManagement: $disputeManagement, refundManagement: $refundManagement)';
  }
}
