...
import 'package:collection/collection.dart';import 'post_charges_charge_refunds_request_metadata.dart';import 'post_charges_charge_refunds_request_origin.dart';import 'post_charges_charge_refunds_request_reason.dart';final class PostChargesChargeRefundsRequest {const PostChargesChargeRefundsRequest({this.amount, this.currency, this.customer, this.expand, this.instructionsEmail, this.metadata, this.origin, this.paymentIntent, this.reason, this.refundApplicationFee, this.reverseTransfer, });
