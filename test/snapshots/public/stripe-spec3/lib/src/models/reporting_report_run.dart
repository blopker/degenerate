...
import 'reporting_report_run_object.dart';
import 'reporting_report_run_result.dart';
...
final class ReportingReportRun {
  ...
  factory ReportingReportRun.fromJson(Map<String, dynamic> json) {
    return ReportingReportRun(
      ...
      result: json['result'] != null
          ? ReportingReportRunResult.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created') &&
        ...
        json['report_type'] is String &&
        json.containsKey('status') &&
        json['status'] is String;
  }

  ReportingReportRun copyWith({
    int? created,
    String? Function()? error,
    String? id,
    bool? livemode,
    ReportingReportRunObject? object,
    FinancialReportingFinanceReportRunRunParameters? parameters,
    String? reportType,
    ReportingReportRunResult? Function()? result,
    String? status,
  ...
  @override
  String toString() {
    return 'ReportingReportRun(created: $created, error: $error, id: $id, livemode: $livemode, object: $object, parameters: $parameters, reportType: $reportType, result: $result, status: $status, succeededAt: $succeededAt)';
  }
}
