...
import 'delete_subscription_items_item_request_payment_behavior.dart';
import 'delete_subscription_items_item_request_proration_behavior.dart';

final class DeleteSubscriptionItemsItemRequest {
  const DeleteSubscriptionItemsItemRequest({
    this.clearUsage,
  ...
  factory DeleteSubscriptionItemsItemRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return DeleteSubscriptionItemsItemRequest(
      clearUsage: json['clear_usage'] as bool?,
      paymentBehavior: json['payment_behavior'] != null
          ? DeleteSubscriptionItemsItemRequestPaymentBehavior.fromJson(
              json['payment_behavior'] as String,
            )
          : null,
      prorationBehavior: json['proration_behavior'] != null
          ? DeleteSubscriptionItemsItemRequestProrationBehavior.fromJson(
  ...
  DeleteSubscriptionItemsItemRequest copyWith({
    bool Function()? clearUsage,
    DeleteSubscriptionItemsItemRequestPaymentBehavior Function()?
    paymentBehavior,
    DeleteSubscriptionItemsItemRequestProrationBehavior Function()?
    prorationBehavior,
  ...
  @override
  String toString() {
    return 'DeleteSubscriptionItemsItemRequest(clearUsage: $clearUsage, paymentBehavior: $paymentBehavior, prorationBehavior: $prorationBehavior, prorationDate: $prorationDate)';
  }
}
