...
import 'package:collection/collection.dart';import 'post_tax_calculations_request_customer_details_address.dart';import 'post_tax_calculations_request_customer_details_address_source.dart';import 'post_tax_calculations_request_customer_details_tax_ids.dart';import 'post_tax_calculations_request_customer_details_taxability_override.dart';/// Details about the customer, including address and tax IDs.
...
factory PostTaxCalculationsRequestCustomerDetails.fromJson(Map<String, dynamic> json) { return PostTaxCalculationsRequestCustomerDetails(
  address: json['address'] != null
        ? PostTaxCalculationsRequestCustomerDetailsAddress.fromJson(json['address'] as Map<String, dynamic>)
        : null,
