...
///
final class OutboundPaymentsPaymentMethodDetails {
  ...
  factory OutboundPaymentsPaymentMethodDetails.fromJson(
    ...
    return OutboundPaymentsPaymentMethodDetails(
      ...
      financialAccount: json['financial_account'] != null
          ...
          : null,
      type: OutboundPaymentsPaymentMethodDetailsType.fromJson(
        json['type'] as String,
      ),
      usBankAccount: json['us_bank_account'] != null
          ? OutboundPaymentsPaymentMethodDetailsUsBankAccount.fromJson(
  ...
  OutboundPaymentsPaymentMethodDetails copyWith({
    TreasurySharedResourceBillingDetails? billingDetails,
    OutboundPaymentsPaymentMethodDetailsFinancialAccount Function()?
    financialAccount,
    OutboundPaymentsPaymentMethodDetailsType? type,
    OutboundPaymentsPaymentMethodDetailsUsBankAccount Function()? usBankAccount,
  }) {
    return OutboundPaymentsPaymentMethodDetails(
  ...
  @override
  String toString() {
    return 'OutboundPaymentsPaymentMethodDetails(billingDetails: $billingDetails, financialAccount: $financialAccount, type: $type, usBankAccount: $usBankAccount)';
  }
}
