...
///
final class IssuingTransactionTreasury {
  const IssuingTransactionTreasury({this.receivedCredit, this.receivedDebit});

  factory IssuingTransactionTreasury.fromJson(Map<String, dynamic> json) {
  ...
  IssuingTransactionTreasury copyWith({
    String? Function()? receivedCredit,
  ...
  @override
  int get hashCode {
    return Object.hash(receivedCredit, receivedDebit);
  }

  @override
  String toString() {
    return 'IssuingTransactionTreasury(receivedCredit: $receivedCredit, receivedDebit: $receivedDebit)';
  }
}
