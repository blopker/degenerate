...
import 'package:collection/collection.dart';final class PostTreasuryOutboundPaymentsIdCancelRequest {const PostTreasuryOutboundPaymentsIdCancelRequest({this.expand});
