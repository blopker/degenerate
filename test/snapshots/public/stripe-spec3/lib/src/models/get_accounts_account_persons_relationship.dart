...
final class GetAccountsAccountPersonsRelationship {
  const GetAccountsAccountPersonsRelationship({
    this.authorizer,
    this.director,
    this.executive,
    this.legalGuardian,
  ...
  factory GetAccountsAccountPersonsRelationship.fromJson(
    Map<String, dynamic> json,
  ) {
    return GetAccountsAccountPersonsRelationship(
  ...
  GetAccountsAccountPersonsRelationship copyWith({
  ...
  @override
  String toString() {
    return 'GetAccountsAccountPersonsRelationship(authorizer: $authorizer, director: $director, executive: $executive, legalGuardian: $legalGuardian, owner: $owner, representative: $representative)';
  }
}
