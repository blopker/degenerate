...
import 'post_payment_intents_request_amount_details.dart';
import 'post_payment_intents_request_automatic_payment_methods.dart';
import 'post_payment_intents_request_capture_method.dart';
import 'post_payment_intents_request_confirmation_method.dart';
import 'post_payment_intents_request_excluded_payment_method_types.dart';
import 'post_payment_intents_request_hooks.dart';
import 'post_payment_intents_request_mandate_data.dart';
import 'post_payment_intents_request_off_session.dart';
import 'post_payment_intents_request_payment_details.dart';
import 'post_payment_intents_request_payment_method_data.dart';
import 'post_payment_intents_request_payment_method_options.dart';
import 'post_payment_intents_request_radar_options.dart';
import 'post_payment_intents_request_setup_future_usage.dart';
import 'post_payment_intents_request_shipping.dart';
import 'post_payment_intents_request_transfer_data.dart';

final class PostPaymentIntentsRequest {
  const PostPaymentIntentsRequest({
  ...
  factory PostPaymentIntentsRequest.fromJson(Map<String, dynamic> json) {
    return PostPaymentIntentsRequest(
      amount: (json['amount'] as num).toInt(),
      amountDetails: json['amount_details'] != null
          ? PostPaymentIntentsRequestAmountDetails.fromJson(
      ...
      excludedPaymentMethodTypes:
          (json['excluded_payment_method_types'] as List<dynamic>?)
              ?.map(
                (e) =>
                    PostPaymentIntentsRequestExcludedPaymentMethodTypes.fromJson(
                      e as String,
                    ),
              )
              .toList(),
      ...
      offSession: json['off_session'] != null
          ? PostPaymentIntentsRequestOffSession.fromJson(
              json['off_session'] as Map<String, dynamic>,
            )
          : null,
      onBehalfOf: json['on_behalf_of'] as String?,
      paymentDetails: json['payment_details'] != null
          ? PostPaymentIntentsRequestPaymentDetails.fromJson(
      ...
      paymentMethodData: json['payment_method_data'] != null
          ? PostPaymentIntentsRequestPaymentMethodData.fromJson(
              json['payment_method_data'] as Map<String, dynamic>,
            )
          : null,
      paymentMethodOptions: json['payment_method_options'] != null
          ? PostPaymentIntentsRequestPaymentMethodOptions.fromJson(
      ...
      radarOptions: json['radar_options'] != null
          ? PostPaymentIntentsRequestRadarOptions.fromJson(
      ...
      setupFutureUsage: json['setup_future_usage'] != null
          ? PostPaymentIntentsRequestSetupFutureUsage.fromJson(
              json['setup_future_usage'] as String,
            )
          : null,
      shipping: json['shipping'] != null
          ? PostPaymentIntentsRequestShipping.fromJson(
      ...
      transferData: json['transfer_data'] != null
          ? PostPaymentIntentsRequestTransferData.fromJson(
  ...
  final PostPaymentIntentsRequestAutomaticPaymentMethods?
  ...
  final List<PostPaymentIntentsRequestExcludedPaymentMethodTypes>?
  excludedPaymentMethodTypes;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (confirmationMethod != null)
        'confirmation_method': confirmationMethod?.toJson(),
  ...
  PostPaymentIntentsRequest copyWith({
    int? amount,
    PostPaymentIntentsRequestAmountDetails Function()? amountDetails,
    int Function()? applicationFeeAmount,
    PostPaymentIntentsRequestAutomaticPaymentMethods Function()?
    automaticPaymentMethods,
    PostPaymentIntentsRequestCaptureMethod Function()? captureMethod,
    bool Function()? confirm,
    PostPaymentIntentsRequestConfirmationMethod Function()? confirmationMethod,
    ...
    List<PostPaymentIntentsRequestExcludedPaymentMethodTypes> Function()?
    excludedPaymentMethodTypes,
    List<String> Function()? expand,
    PostPaymentIntentsRequestHooks Function()? hooks,
    String Function()? mandate,
    PostPaymentIntentsRequestMandateData Function()? mandateData,
    Map<String, String> Function()? metadata,
    PostPaymentIntentsRequestOffSession Function()? offSession,
    String Function()? onBehalfOf,
    PostPaymentIntentsRequestPaymentDetails Function()? paymentDetails,
    String Function()? paymentMethod,
    String Function()? paymentMethodConfiguration,
    PostPaymentIntentsRequestPaymentMethodData Function()? paymentMethodData,
    PostPaymentIntentsRequestPaymentMethodOptions Function()?
    paymentMethodOptions,
    List<String> Function()? paymentMethodTypes,
    PostPaymentIntentsRequestRadarOptions Function()? radarOptions,
    String Function()? receiptEmail,
    String Function()? returnUrl,
    PostPaymentIntentsRequestSetupFutureUsage Function()? setupFutureUsage,
    PostPaymentIntentsRequestShipping Function()? shipping,
    String Function()? statementDescriptor,
    String Function()? statementDescriptorSuffix,
    PostPaymentIntentsRequestTransferData Function()? transferData,
    ...
    return PostPaymentIntentsRequest(
      ...
      statementDescriptor: statementDescriptor != null
          ? statementDescriptor()
          : this.statementDescriptor,
      statementDescriptorSuffix: statementDescriptorSuffix != null
