...
final class Token {
  ...
  @override
  String toString() {
    return 'Token(bankAccount: $bankAccount, card: $card, clientIp: $clientIp, created: $created, id: $id, livemode: $livemode, object: $object, type: $type, used: $used)';
  }
}
