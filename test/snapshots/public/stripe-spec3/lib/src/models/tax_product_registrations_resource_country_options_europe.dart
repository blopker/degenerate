...
///
final class TaxProductRegistrationsResourceCountryOptionsEurope {
  ...
  TaxProductRegistrationsResourceCountryOptionsEurope copyWith({
    TaxProductRegistrationsResourceCountryOptionsEuStandard Function()?
    standard,
    TaxProductRegistrationsResourceCountryOptionsEuropeType? type,
  }) {
    return TaxProductRegistrationsResourceCountryOptionsEurope(
  ...
  @override
  String toString() {
    return 'TaxProductRegistrationsResourceCountryOptionsEurope(standard: $standard, type: $type)';
  }
}
