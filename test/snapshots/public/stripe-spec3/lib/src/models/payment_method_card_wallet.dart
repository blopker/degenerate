...
///
final class PaymentMethodCardWallet {
  ...
  factory PaymentMethodCardWallet.fromJson(Map<String, dynamic> json) {
    return PaymentMethodCardWallet(
      amexExpressCheckout: json['amex_express_checkout'] != null
          ? PaymentMethodCardWalletAmexExpressCheckout.fromJson(
              json['amex_express_checkout'] as Map<String, dynamic>,
            )
          : null,
      applePay: json['apple_pay'] != null
          ? PaymentMethodCardWalletApplePay.fromJson(
              json['apple_pay'] as Map<String, dynamic>,
            )
          : null,
      dynamicLast4: json['dynamic_last4'] as String?,
      googlePay: json['google_pay'] != null
          ? PaymentMethodCardWalletGooglePay.fromJson(
              json['google_pay'] as Map<String, dynamic>,
            )
          : null,
      link: json['link'] != null
          ? PaymentMethodCardWalletLink.fromJson(
              json['link'] as Map<String, dynamic>,
            )
          : null,
      masterpass: json['masterpass'] != null
          ? PaymentMethodCardWalletMasterpass.fromJson(
              json['masterpass'] as Map<String, dynamic>,
            )
          : null,
      samsungPay: json['samsung_pay'] != null
          ? PaymentMethodCardWalletSamsungPay.fromJson(
      ...
      visaCheckout: json['visa_checkout'] != null
          ? PaymentMethodCardWalletVisaCheckout.fromJson(
              json['visa_checkout'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      if (amexExpressCheckout != null)
        'amex_express_checkout': amexExpressCheckout?.toJson(),
  ...
  PaymentMethodCardWallet copyWith({
    PaymentMethodCardWalletAmexExpressCheckout Function()? amexExpressCheckout,
    PaymentMethodCardWalletApplePay Function()? applePay,
    String? Function()? dynamicLast4,
    PaymentMethodCardWalletGooglePay Function()? googlePay,
    PaymentMethodCardWalletLink Function()? link,
    PaymentMethodCardWalletMasterpass Function()? masterpass,
    PaymentMethodCardWalletSamsungPay Function()? samsungPay,
    PaymentMethodCardWalletType? type,
    PaymentMethodCardWalletVisaCheckout Function()? visaCheckout,
  }) {
    return PaymentMethodCardWallet(
      amexExpressCheckout: amexExpressCheckout != null
          ? amexExpressCheckout()
          : this.amexExpressCheckout,
  ...
  @override
  String toString() {
    return 'PaymentMethodCardWallet(amexExpressCheckout: $amexExpressCheckout, applePay: $applePay, dynamicLast4: $dynamicLast4, googlePay: $googlePay, link: $link, masterpass: $masterpass, samsungPay: $samsungPay, type: $type, visaCheckout: $visaCheckout)';
  }
}
