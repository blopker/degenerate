...
final class CreditBalance {
  ...
  factory CreditBalance.fromJson(Map<String, dynamic> json) {
    return CreditBalance(
      availableBalance: BillingCreditGrantsResourceAmount.fromJson(
        json['available_balance'] as Map<String, dynamic>,
      ),
      ledgerBalance: BillingCreditGrantsResourceAmount.fromJson(
        json['ledger_balance'] as Map<String, dynamic>,
      ),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('available_balance') &&
  ...
  @override
  int get hashCode {
    return Object.hash(availableBalance, ledgerBalance);
  }

  @override
  String toString() {
    return 'CreditBalance(availableBalance: $availableBalance, ledgerBalance: $ledgerBalance)';
  }
}
