...
import 'treasury_transaction_entry_flow_details.dart';
import 'treasury_transaction_entry_flow_type.dart';
import 'treasury_transaction_entry_object.dart';
import 'treasury_transaction_entry_transaction.dart';
import 'treasury_transaction_entry_type.dart';
...
final class TreasuryTransactionEntry {
  const TreasuryTransactionEntry({
  ...
  factory TreasuryTransactionEntry.fromJson(Map<String, dynamic> json) {
    return TreasuryTransactionEntry(
      balanceImpact: TreasuryTransactionsResourceBalanceImpact.fromJson(
        json['balance_impact'] as Map<String, dynamic>,
      ),
      ...
      flowDetails: json['flow_details'] != null
          ? TreasuryTransactionEntryFlowDetails.fromJson(
              json['flow_details'] as Map<String, dynamic>,
            )
          : null,
      flowType: TreasuryTransactionEntryFlowType.fromJson(
        json['flow_type'] as String,
      ),
      id: json['id'] as String,
      livemode: json['livemode'] as bool,
      object: TreasuryTransactionEntryObject.fromJson(json['object'] as String),
      transaction: TreasuryTransactionEntryTransaction.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('balance_impact') &&
  ...
  TreasuryTransactionEntry copyWith({
    ...
    TreasuryTransactionEntryFlowDetails? Function()? flowDetails,
    TreasuryTransactionEntryFlowType? flowType,
    String? id,
    bool? livemode,
    TreasuryTransactionEntryObject? object,
    TreasuryTransactionEntryTransaction? transaction,
    TreasuryTransactionEntryType? type,
  }) {
    return TreasuryTransactionEntry(
  ...
  @override
  String toString() {
    return 'TreasuryTransactionEntry(balanceImpact: $balanceImpact, created: $created, currency: $currency, effectiveAt: $effectiveAt, financialAccount: $financialAccount, flow: $flow, flowDetails: $flowDetails, flowType: $flowType, id: $id, livemode: $livemode, object: $object, transaction: $transaction, type: $type)';
  }
}
