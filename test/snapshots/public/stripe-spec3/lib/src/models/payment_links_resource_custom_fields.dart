...
///
final class PaymentLinksResourceCustomFields {
  const PaymentLinksResourceCustomFields({
    this.dropdown,
    required this.key,
    required this.label,
    this.numeric,
  ...
  factory PaymentLinksResourceCustomFields.fromJson(Map<String, dynamic> json) {
    return PaymentLinksResourceCustomFields(
      ...
      label: PaymentLinksResourceCustomFieldsLabel.fromJson(
      ...
      text: json['text'] != null
          ? PaymentLinksResourceCustomFieldsText.fromJson(
              json['text'] as Map<String, dynamic>,
            )
          : null,
      type: PaymentLinksResourceCustomFieldsType.fromJson(
        json['type'] as String,
      ),
    );
  }
  ...
  PaymentLinksResourceCustomFields copyWith({
    PaymentLinksResourceCustomFieldsDropdown Function()? dropdown,
    String? key,
    PaymentLinksResourceCustomFieldsLabel? label,
    PaymentLinksResourceCustomFieldsNumeric Function()? numeric,
    bool? optional,
    PaymentLinksResourceCustomFieldsText Function()? text,
    PaymentLinksResourceCustomFieldsType? type,
  }) {
    return PaymentLinksResourceCustomFields(
  ...
  @override
  String toString() {
    return 'PaymentLinksResourceCustomFields(dropdown: $dropdown, key: $key, label: $label, numeric: $numeric, optional: $optional, text: $text, type: $type)';
  }
}
