...
///
final class PaymentIntentNextAction {
  ...
  factory PaymentIntentNextAction.fromJson(Map<String, dynamic> json) {
    return PaymentIntentNextAction(
      ...
      swishHandleRedirectOrDisplayQrCode:
          json['swish_handle_redirect_or_display_qr_code'] != null
      ...
      useStripeSdk: (json['use_stripe_sdk'] as Map<String, dynamic>?)?.map(
      ...
      wechatPayDisplayQrCode: json['wechat_pay_display_qr_code'] != null
          ? PaymentIntentNextActionWechatPayDisplayQrCode.fromJson(
              json['wechat_pay_display_qr_code'] as Map<String, dynamic>,
            )
          : null,
      wechatPayRedirectToAndroidApp:
          json['wechat_pay_redirect_to_android_app'] != null
          ? PaymentIntentNextActionWechatPayRedirectToAndroidApp.fromJson(
              json['wechat_pay_redirect_to_android_app']
                  as Map<String, dynamic>,
            )
          : null,
      wechatPayRedirectToIosApp: json['wechat_pay_redirect_to_ios_app'] != null
          ? PaymentIntentNextActionWechatPayRedirectToIosApp.fromJson(
              json['wechat_pay_redirect_to_ios_app'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  final PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode?
  cashappHandleRedirectOrDisplayQrCode;

  final PaymentIntentNextActionDisplayBankTransferInstructions?
  displayBankTransferInstructions;

  final PaymentIntentNextActionKonbini? konbiniDisplayDetails;

  final PaymentIntentNextActionDisplayMultibancoDetails?
  ...
  final PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode?
  swishHandleRedirectOrDisplayQrCode;
  ...
  final PaymentIntentNextActionWechatPayRedirectToAndroidApp?
  wechatPayRedirectToAndroidApp;

  final PaymentIntentNextActionWechatPayRedirectToIosApp?
  wechatPayRedirectToIosApp;

  Map<String, dynamic> toJson() {
    return {
      if (alipayHandleRedirect != null)
        'alipay_handle_redirect': alipayHandleRedirect?.toJson(),
      if (boletoDisplayDetails != null)
        'boleto_display_details': boletoDisplayDetails?.toJson(),
      if (cardAwaitNotification != null)
        'card_await_notification': cardAwaitNotification?.toJson(),
      if (cashappHandleRedirectOrDisplayQrCode != null)
        'cashapp_handle_redirect_or_display_qr_code':
            cashappHandleRedirectOrDisplayQrCode?.toJson(),
      ...
      if (konbiniDisplayDetails != null)
        'konbini_display_details': konbiniDisplayDetails?.toJson(),
      if (multibancoDisplayDetails != null)
        'multibanco_display_details': multibancoDisplayDetails?.toJson(),
      if (oxxoDisplayDetails != null)
        'oxxo_display_details': oxxoDisplayDetails?.toJson(),
      if (paynowDisplayQrCode != null)
        'paynow_display_qr_code': paynowDisplayQrCode?.toJson(),
      if (pixDisplayQrCode != null)
        'pix_display_qr_code': pixDisplayQrCode?.toJson(),
      if (promptpayDisplayQrCode != null)
        'promptpay_display_qr_code': promptpayDisplayQrCode?.toJson(),
      if (redirectToUrl != null) 'redirect_to_url': redirectToUrl?.toJson(),
      if (swishHandleRedirectOrDisplayQrCode != null)
        'swish_handle_redirect_or_display_qr_code':
            swishHandleRedirectOrDisplayQrCode?.toJson(),
      'type': type,
      'use_stripe_sdk': ?useStripeSdk,
      if (verifyWithMicrodeposits != null)
        'verify_with_microdeposits': verifyWithMicrodeposits?.toJson(),
      if (wechatPayDisplayQrCode != null)
        'wechat_pay_display_qr_code': wechatPayDisplayQrCode?.toJson(),
      ...
      if (wechatPayRedirectToIosApp != null)
        'wechat_pay_redirect_to_ios_app': wechatPayRedirectToIosApp?.toJson(),
    };
  }
  ...
  PaymentIntentNextAction copyWith({
    PaymentIntentNextActionAlipayHandleRedirect Function()?
    alipayHandleRedirect,
    PaymentIntentNextActionBoleto Function()? boletoDisplayDetails,
    PaymentIntentNextActionCardAwaitNotification Function()?
    cardAwaitNotification,
    PaymentIntentNextActionCashappHandleRedirectOrDisplayQrCode Function()?
    cashappHandleRedirectOrDisplayQrCode,
    PaymentIntentNextActionDisplayBankTransferInstructions Function()?
    displayBankTransferInstructions,
    PaymentIntentNextActionKonbini Function()? konbiniDisplayDetails,
    PaymentIntentNextActionDisplayMultibancoDetails Function()?
    multibancoDisplayDetails,
    PaymentIntentNextActionDisplayOxxoDetails Function()? oxxoDisplayDetails,
    PaymentIntentNextActionPaynowDisplayQrCode Function()? paynowDisplayQrCode,
    PaymentIntentNextActionPixDisplayQrCode Function()? pixDisplayQrCode,
    PaymentIntentNextActionPromptpayDisplayQrCode Function()?
    promptpayDisplayQrCode,
    PaymentIntentNextActionRedirectToUrl Function()? redirectToUrl,
    PaymentIntentNextActionSwishHandleRedirectOrDisplayQrCode Function()?
    swishHandleRedirectOrDisplayQrCode,
    String? type,
    Map<String, String> Function()? useStripeSdk,
    PaymentIntentNextActionVerifyWithMicrodeposits Function()?
    verifyWithMicrodeposits,
    PaymentIntentNextActionWechatPayDisplayQrCode Function()?
    wechatPayDisplayQrCode,
    PaymentIntentNextActionWechatPayRedirectToAndroidApp Function()?
    wechatPayRedirectToAndroidApp,
    PaymentIntentNextActionWechatPayRedirectToIosApp Function()?
    wechatPayRedirectToIosApp,
  }) {
    return PaymentIntentNextAction(
      alipayHandleRedirect: alipayHandleRedirect != null
          ? alipayHandleRedirect()
          : this.alipayHandleRedirect,
      boletoDisplayDetails: boletoDisplayDetails != null
          ? boletoDisplayDetails()
          : this.boletoDisplayDetails,
      cardAwaitNotification: cardAwaitNotification != null
          ? cardAwaitNotification()
          : this.cardAwaitNotification,
      cashappHandleRedirectOrDisplayQrCode:
          cashappHandleRedirectOrDisplayQrCode != null
          ? cashappHandleRedirectOrDisplayQrCode()
          : this.cashappHandleRedirectOrDisplayQrCode,
      displayBankTransferInstructions: displayBankTransferInstructions != null
          ? displayBankTransferInstructions()
          : this.displayBankTransferInstructions,
      konbiniDisplayDetails: konbiniDisplayDetails != null
          ? konbiniDisplayDetails()
          : this.konbiniDisplayDetails,
      multibancoDisplayDetails: multibancoDisplayDetails != null
          ? multibancoDisplayDetails()
          : this.multibancoDisplayDetails,
      oxxoDisplayDetails: oxxoDisplayDetails != null
          ? oxxoDisplayDetails()
          : this.oxxoDisplayDetails,
      paynowDisplayQrCode: paynowDisplayQrCode != null
          ? paynowDisplayQrCode()
          : this.paynowDisplayQrCode,
      pixDisplayQrCode: pixDisplayQrCode != null
          ? pixDisplayQrCode()
          : this.pixDisplayQrCode,
      promptpayDisplayQrCode: promptpayDisplayQrCode != null
          ? promptpayDisplayQrCode()
          : this.promptpayDisplayQrCode,
      redirectToUrl: redirectToUrl != null
          ...
          : this.redirectToUrl,
      swishHandleRedirectOrDisplayQrCode:
          swishHandleRedirectOrDisplayQrCode != null
          ? swishHandleRedirectOrDisplayQrCode()
          : this.swishHandleRedirectOrDisplayQrCode,
      type: type ?? this.type,
      useStripeSdk: useStripeSdk != null ? useStripeSdk() : this.useStripeSdk,
      verifyWithMicrodeposits: verifyWithMicrodeposits != null
          ? verifyWithMicrodeposits()
          : this.verifyWithMicrodeposits,
      wechatPayDisplayQrCode: wechatPayDisplayQrCode != null
          ? wechatPayDisplayQrCode()
          : this.wechatPayDisplayQrCode,
      wechatPayRedirectToAndroidApp: wechatPayRedirectToAndroidApp != null
          ? wechatPayRedirectToAndroidApp()
          : this.wechatPayRedirectToAndroidApp,
      wechatPayRedirectToIosApp: wechatPayRedirectToIosApp != null
          ? wechatPayRedirectToIosApp()
          : this.wechatPayRedirectToIosApp,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PaymentIntentNextAction &&
            ...
            cashappHandleRedirectOrDisplayQrCode ==
                other.cashappHandleRedirectOrDisplayQrCode &&
            displayBankTransferInstructions ==
                other.displayBankTransferInstructions &&
            ...
            swishHandleRedirectOrDisplayQrCode ==
                other.swishHandleRedirectOrDisplayQrCode &&
            type == other.type &&
            ...
            wechatPayRedirectToAndroidApp ==
                other.wechatPayRedirectToAndroidApp &&
