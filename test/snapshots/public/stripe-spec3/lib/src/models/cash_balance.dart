...
final class CashBalance {
  ...
  factory CashBalance.fromJson(Map<String, dynamic> json) {
    return CashBalance(
      ...
      settings: CustomerBalanceCustomerBalanceSettings.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('customer') &&
  ...
  CashBalance copyWith({
    Map<String, int>? Function()? available,
    String? customer,
  ...
  @override
  String toString() {
    return 'CashBalance(available: $available, customer: $customer, customerAccount: $customerAccount, livemode: $livemode, object: $object, settings: $settings)';
  }
}
