...
///
final class GelatoSessionDocumentOptions {
  ...
  factory GelatoSessionDocumentOptions.fromJson(Map<String, dynamic> json) {
    return GelatoSessionDocumentOptions(
      allowedTypes: (json['allowed_types'] as List<dynamic>?)
          ?.map(
            (e) =>
                GelatoSessionDocumentOptionsAllowedTypes.fromJson(e as String),
          )
          .toList(),
  ...
  GelatoSessionDocumentOptions copyWith({
    List<GelatoSessionDocumentOptionsAllowedTypes> Function()? allowedTypes,
  ...
  @override
  String toString() {
    return 'GelatoSessionDocumentOptions(allowedTypes: $allowedTypes, requireIdNumber: $requireIdNumber, requireLiveCapture: $requireLiveCapture, requireMatchingSelfie: $requireMatchingSelfie)';
  }
}
