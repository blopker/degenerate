...
import 'package:collection/collection.dart';import 'balance_transaction_balance_type.dart';import 'balance_transaction_object.dart';import 'balance_transaction_source.dart';import 'balance_transaction_type.dart';import 'fee.dart';/// Balance transactions represent funds moving through your Stripe account.
...
factory BalanceTransaction.fromJson(Map<String, dynamic> json) { return BalanceTransaction(
  ...
  source: json['source'] != null
        ? BalanceTransactionSource.fromJson(json['source'] as Map<String, dynamic>)
        : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BalanceTransaction &&
          ...
          fee == other.fee &&
          const ListEquality<dynamic>().equals(feeDetails, other.feeDetails) &&
          id == other.id &&
          net == other.net &&
          object == other.object &&
