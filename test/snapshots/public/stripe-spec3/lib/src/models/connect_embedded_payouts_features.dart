...
///
final class ConnectEmbeddedPayoutsFeatures {
  const ConnectEmbeddedPayoutsFeatures({
  ...
  factory ConnectEmbeddedPayoutsFeatures.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('disable_stripe_user_authentication') &&
        json['disable_stripe_user_authentication'] is bool &&
        json.containsKey('edit_payout_schedule') &&
        json['edit_payout_schedule'] is bool &&
        json.containsKey('external_account_collection') &&
        json['external_account_collection'] is bool &&
        json.containsKey('instant_payouts') &&
        json['instant_payouts'] is bool &&
        json.containsKey('standard_payouts') &&
        json['standard_payouts'] is bool;
  }

  ConnectEmbeddedPayoutsFeatures copyWith({
    ...
    return ConnectEmbeddedPayoutsFeatures(
      ...
      externalAccountCollection:
          externalAccountCollection ?? this.externalAccountCollection,
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedPayoutsFeatures(disableStripeUserAuthentication: $disableStripeUserAuthentication, editPayoutSchedule: $editPayoutSchedule, externalAccountCollection: $externalAccountCollection, instantPayouts: $instantPayouts, standardPayouts: $standardPayouts)';
  }
}
