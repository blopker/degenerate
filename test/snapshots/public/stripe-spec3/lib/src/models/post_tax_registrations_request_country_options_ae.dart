...
import 'post_tax_registrations_request_country_options_ae_standard.dart';import 'post_tax_registrations_request_country_options_ae_type.dart';final class PostTaxRegistrationsRequestCountryOptionsAe {const PostTaxRegistrationsRequestCountryOptionsAe({this.standard, required this.type, });
...
factory PostTaxRegistrationsRequestCountryOptionsAe.fromJson(Map<String, dynamic> json) { return PostTaxRegistrationsRequestCountryOptionsAe(
  standard: json['standard'] != null
        ? PostTaxRegistrationsRequestCountryOptionsAeStandard.fromJson(json['standard'] as Map<String, dynamic>)
        : null,
