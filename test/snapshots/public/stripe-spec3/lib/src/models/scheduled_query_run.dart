...
import 'scheduled_query_run_file.dart';
...
final class ScheduledQueryRun {
  ...
  factory ScheduledQueryRun.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created') &&
        json['created'] is num &&
        json.containsKey('data_load_time') &&
        json['data_load_time'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('livemode') &&
        json['livemode'] is bool &&
        json.containsKey('object') &&
        json.containsKey('result_available_until') &&
        json['result_available_until'] is num &&
  ...
  ScheduledQueryRun copyWith({
    int? created,
    int? dataLoadTime,
    SigmaScheduledQueryRunError Function()? error,
    ScheduledQueryRunFile? Function()? file,
    String? id,
    bool? livemode,
  ...
  @override
  String toString() {
    return 'ScheduledQueryRun(created: $created, dataLoadTime: $dataLoadTime, error: $error, file: $file, id: $id, livemode: $livemode, object: $object, resultAvailableUntil: $resultAvailableUntil, sql: $sql, status: $status, title: $title)';
  }
}
