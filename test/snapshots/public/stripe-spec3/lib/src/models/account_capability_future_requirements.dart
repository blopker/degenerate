...
import 'account_capability_future_requirements_disabled_reason.dart';
import 'account_requirements_alternative.dart';
import 'account_requirements_error.dart';

///
final class AccountCapabilityFutureRequirements {
  ...
  factory AccountCapabilityFutureRequirements.fromJson(
    ...
    return AccountCapabilityFutureRequirements(
      ...
      disabledReason: json['disabled_reason'] != null
          ? AccountCapabilityFutureRequirementsDisabledReason.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('currently_due') &&
  ...
  AccountCapabilityFutureRequirements copyWith({
    List<AccountRequirementsAlternative>? Function()? alternatives,
    int? Function()? currentDeadline,
    List<String>? currentlyDue,
    AccountCapabilityFutureRequirementsDisabledReason? Function()?
    disabledReason,
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(eventuallyDue),
      Object.hashAll(pastDue),
      Object.hashAll(pendingVerification),
    );
  }

  @override
  String toString() {
    return 'AccountCapabilityFutureRequirements(alternatives: $alternatives, currentDeadline: $currentDeadline, currentlyDue: $currentlyDue, disabledReason: $disabledReason, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
