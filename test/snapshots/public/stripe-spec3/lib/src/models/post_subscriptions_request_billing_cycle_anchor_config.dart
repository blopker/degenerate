...
final class PostSubscriptionsRequestBillingCycleAnchorConfig {
  const PostSubscriptionsRequestBillingCycleAnchorConfig({
  ...
  factory PostSubscriptionsRequestBillingCycleAnchorConfig.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostSubscriptionsRequestBillingCycleAnchorConfig(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('day_of_month') && json['day_of_month'] is num;
  }

  PostSubscriptionsRequestBillingCycleAnchorConfig copyWith({
    int? dayOfMonth,
    int Function()? hour,
    int Function()? minute,
    int Function()? month,
  ...
  @override
  int get hashCode {
    return Object.hash(dayOfMonth, hour, minute, month, second);
  }

  @override
  String toString() {
    return 'PostSubscriptionsRequestBillingCycleAnchorConfig(dayOfMonth: $dayOfMonth, hour: $hour, minute: $minute, month: $month, second: $second)';
  }
}
