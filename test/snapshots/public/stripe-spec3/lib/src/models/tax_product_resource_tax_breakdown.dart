...
///
final class TaxProductResourceTaxBreakdown {
  const TaxProductResourceTaxBreakdown({
  ...
  factory TaxProductResourceTaxBreakdown.fromJson(Map<String, dynamic> json) {
    return TaxProductResourceTaxBreakdown(
      amount: (json['amount'] as num).toInt(),
      inclusive: json['inclusive'] as bool,
      taxRateDetails: TaxProductResourceTaxRateDetails.fromJson(
        json['tax_rate_details'] as Map<String, dynamic>,
      ),
      taxabilityReason: TaxProductResourceTaxBreakdownTaxabilityReason.fromJson(
  ...
  TaxProductResourceTaxBreakdown copyWith({
    int? amount,
    bool? inclusive,
  ...
  @override
  String toString() {
    return 'TaxProductResourceTaxBreakdown(amount: $amount, inclusive: $inclusive, taxRateDetails: $taxRateDetails, taxabilityReason: $taxabilityReason, taxableAmount: $taxableAmount)';
  }
}
