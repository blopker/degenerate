...
///
final class ConnectEmbeddedIssuingCardFeatures {
  const ConnectEmbeddedIssuingCardFeatures({
  ...
  factory ConnectEmbeddedIssuingCardFeatures.fromJson(
  ...
  ConnectEmbeddedIssuingCardFeatures copyWith({
    bool? cardManagement,
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedIssuingCardFeatures(cardManagement: $cardManagement, cardSpendDisputeManagement: $cardSpendDisputeManagement, cardholderManagement: $cardholderManagement, spendControlManagement: $spendControlManagement)';
  }
}
