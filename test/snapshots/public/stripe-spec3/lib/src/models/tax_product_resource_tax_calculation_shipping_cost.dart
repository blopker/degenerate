...
///
final class TaxProductResourceTaxCalculationShippingCost {
  const TaxProductResourceTaxCalculationShippingCost({
  ...
  factory TaxProductResourceTaxCalculationShippingCost.fromJson(
    ...
    return TaxProductResourceTaxCalculationShippingCost(
      ...
      taxBehavior:
          TaxProductResourceTaxCalculationShippingCostTaxBehavior.fromJson(
  ...
  TaxProductResourceTaxCalculationShippingCost copyWith({
    int? amount,
    int? amountTax,
  ...
  @override
  String toString() {
    return 'TaxProductResourceTaxCalculationShippingCost(amount: $amount, amountTax: $amountTax, shippingRate: $shippingRate, taxBehavior: $taxBehavior, taxBreakdown: $taxBreakdown, taxCode: $taxCode)';
  }
}
