...
///
final class PromotionCodesResourceRestrictions {
  ...
  factory PromotionCodesResourceRestrictions.fromJson(
    ...
    return PromotionCodesResourceRestrictions(
      currencyOptions: (json['currency_options'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(
          k,
          PromotionCodeCurrencyOption.fromJson(v as Map<String, dynamic>),
        ),
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('first_time_transaction') &&
        json['first_time_transaction'] is bool;
  }

  PromotionCodesResourceRestrictions copyWith({
    Map<String, PromotionCodeCurrencyOption> Function()? currencyOptions,
  ...
  @override
  String toString() {
    return 'PromotionCodesResourceRestrictions(currencyOptions: $currencyOptions, firstTimeTransaction: $firstTimeTransaction, minimumAmount: $minimumAmount, minimumAmountCurrency: $minimumAmountCurrency)';
  }
}
