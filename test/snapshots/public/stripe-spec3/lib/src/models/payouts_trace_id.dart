...
///
final class PayoutsTraceId {
  const PayoutsTraceId({required this.status, this.value});

  factory PayoutsTraceId.fromJson(Map<String, dynamic> json) {
  ...
  PayoutsTraceId copyWith({String? status, String? Function()? value}) {
    return PayoutsTraceId(
  ...
  @override
  int get hashCode {
    return Object.hash(status, value);
  }

  @override
  String toString() {
    return 'PayoutsTraceId(status: $status, value: $value)';
  }
}
