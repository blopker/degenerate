...
final class ConnectEmbeddedAccountSessionCreateComponents {
  const ConnectEmbeddedAccountSessionCreateComponents({
  ...
  factory ConnectEmbeddedAccountSessionCreateComponents.fromJson(
    Map<String, dynamic> json,
  ) {
    return ConnectEmbeddedAccountSessionCreateComponents(
      accountManagement: ConnectEmbeddedAccountConfigClaim.fromJson(
        json['account_management'] as Map<String, dynamic>,
      ),
      accountOnboarding: ConnectEmbeddedAccountConfigClaim.fromJson(
        json['account_onboarding'] as Map<String, dynamic>,
      ),
      balances: ConnectEmbeddedPayoutsConfig.fromJson(
        json['balances'] as Map<String, dynamic>,
      ),
      disputesList: ConnectEmbeddedDisputesListConfig.fromJson(
        json['disputes_list'] as Map<String, dynamic>,
      ),
      documents: ConnectEmbeddedBaseConfigClaim.fromJson(
        json['documents'] as Map<String, dynamic>,
      ),
      financialAccount: ConnectEmbeddedFinancialAccountConfigClaim.fromJson(
        json['financial_account'] as Map<String, dynamic>,
      ),
      financialAccountTransactions:
          ConnectEmbeddedFinancialAccountTransactionsConfigClaim.fromJson(
            json['financial_account_transactions'] as Map<String, dynamic>,
          ),
      instantPayoutsPromotion:
          ConnectEmbeddedInstantPayoutsPromotionConfig.fromJson(
            json['instant_payouts_promotion'] as Map<String, dynamic>,
          ),
      issuingCard: ConnectEmbeddedIssuingCardConfigClaim.fromJson(
        json['issuing_card'] as Map<String, dynamic>,
      ),
      issuingCardsList: ConnectEmbeddedIssuingCardsListConfigClaim.fromJson(
        json['issuing_cards_list'] as Map<String, dynamic>,
      ),
      notificationBanner: ConnectEmbeddedAccountConfigClaim.fromJson(
        json['notification_banner'] as Map<String, dynamic>,
      ),
      paymentDetails: ConnectEmbeddedPaymentsConfigClaim.fromJson(
        json['payment_details'] as Map<String, dynamic>,
      ),
      paymentDisputes: ConnectEmbeddedPaymentDisputesConfig.fromJson(
        json['payment_disputes'] as Map<String, dynamic>,
      ),
      payments: ConnectEmbeddedPaymentsConfigClaim.fromJson(
        json['payments'] as Map<String, dynamic>,
      ),
      payoutDetails: ConnectEmbeddedBaseConfigClaim.fromJson(
        json['payout_details'] as Map<String, dynamic>,
      ),
      payouts: ConnectEmbeddedPayoutsConfig.fromJson(
        json['payouts'] as Map<String, dynamic>,
      ),
      payoutsList: ConnectEmbeddedBaseConfigClaim.fromJson(
        json['payouts_list'] as Map<String, dynamic>,
      ),
      taxRegistrations: ConnectEmbeddedBaseConfigClaim.fromJson(
        json['tax_registrations'] as Map<String, dynamic>,
      ),
      taxSettings: ConnectEmbeddedBaseConfigClaim.fromJson(
  ...
  final ConnectEmbeddedFinancialAccountTransactionsConfigClaim
  financialAccountTransactions;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account_management') &&
  ...
  ConnectEmbeddedAccountSessionCreateComponents copyWith({
    ...
    return ConnectEmbeddedAccountSessionCreateComponents(
      ...
      financialAccountTransactions:
          financialAccountTransactions ?? this.financialAccountTransactions,
      instantPayoutsPromotion:
          instantPayoutsPromotion ?? this.instantPayoutsPromotion,
