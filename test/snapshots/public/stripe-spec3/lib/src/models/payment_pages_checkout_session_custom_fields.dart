...
///
final class PaymentPagesCheckoutSessionCustomFields {
  const PaymentPagesCheckoutSessionCustomFields({
    this.dropdown,
    required this.key,
    required this.label,
    this.numeric,
  ...
  factory PaymentPagesCheckoutSessionCustomFields.fromJson(
    ...
    return PaymentPagesCheckoutSessionCustomFields(
      ...
      label: PaymentPagesCheckoutSessionCustomFieldsLabel.fromJson(
      ...
      text: json['text'] != null
          ? PaymentPagesCheckoutSessionCustomFieldsText.fromJson(
              json['text'] as Map<String, dynamic>,
            )
          : null,
      type: PaymentPagesCheckoutSessionCustomFieldsType.fromJson(
        json['type'] as String,
      ),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('key') &&
        ...
        json.containsKey('optional') &&
        json['optional'] is bool &&
        json.containsKey('type');
  }

  PaymentPagesCheckoutSessionCustomFields copyWith({
    PaymentPagesCheckoutSessionCustomFieldsDropdown Function()? dropdown,
    String? key,
    PaymentPagesCheckoutSessionCustomFieldsLabel? label,
    PaymentPagesCheckoutSessionCustomFieldsNumeric Function()? numeric,
    bool? optional,
    PaymentPagesCheckoutSessionCustomFieldsText Function()? text,
    PaymentPagesCheckoutSessionCustomFieldsType? type,
  }) {
    return PaymentPagesCheckoutSessionCustomFields(
  ...
  @override
  String toString() {
    return 'PaymentPagesCheckoutSessionCustomFields(dropdown: $dropdown, key: $key, label: $label, numeric: $numeric, optional: $optional, text: $text, type: $type)';
  }
}
