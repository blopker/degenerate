...
///
final class IssuingDisputeTreasury {
  const IssuingDisputeTreasury({
    this.debitReversal,
    required this.receivedDebit,
  });

  factory IssuingDisputeTreasury.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    return {'debit_reversal': ?debitReversal, 'received_debit': receivedDebit};
  }
  ...
  IssuingDisputeTreasury copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(debitReversal, receivedDebit);
  }

  @override
  String toString() {
    return 'IssuingDisputeTreasury(debitReversal: $debitReversal, receivedDebit: $receivedDebit)';
  }
}
