...
///
final class SourceMandateNotificationSepaDebitData {
  ...
  factory SourceMandateNotificationSepaDebitData.fromJson(
  ...
  SourceMandateNotificationSepaDebitData copyWith({
    String Function()? creditorIdentifier,
    String Function()? last4,
    String Function()? mandateReference,
  }) {
    return SourceMandateNotificationSepaDebitData(
      creditorIdentifier: creditorIdentifier != null
          ? creditorIdentifier()
          : this.creditorIdentifier,
  ...
  @override
  int get hashCode {
    return Object.hash(creditorIdentifier, last4, mandateReference);
  }

  @override
  String toString() {
    return 'SourceMandateNotificationSepaDebitData(creditorIdentifier: $creditorIdentifier, last4: $last4, mandateReference: $mandateReference)';
  }
}
