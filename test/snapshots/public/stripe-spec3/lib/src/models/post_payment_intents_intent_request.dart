...
import 'post_payment_intents_intent_request_amount_details.dart';
import 'post_payment_intents_intent_request_application_fee_amount.dart';
import 'post_payment_intents_intent_request_capture_method.dart';
import 'post_payment_intents_intent_request_excluded_payment_method_types.dart';
import 'post_payment_intents_intent_request_hooks.dart';
import 'post_payment_intents_intent_request_metadata.dart';
import 'post_payment_intents_intent_request_payment_details.dart';
import 'post_payment_intents_intent_request_payment_method_data.dart';
import 'post_payment_intents_intent_request_payment_method_options.dart';
import 'post_payment_intents_intent_request_receipt_email.dart';
import 'post_payment_intents_intent_request_setup_future_usage.dart';
import 'post_payment_intents_intent_request_shipping.dart';
import 'post_payment_intents_intent_request_transfer_data.dart';

final class PostPaymentIntentsIntentRequest {
  const PostPaymentIntentsIntentRequest({
    this.amount,
    this.amountDetails,
  ...
  factory PostPaymentIntentsIntentRequest.fromJson(Map<String, dynamic> json) {
    return PostPaymentIntentsIntentRequest(
      amount: json['amount'] != null ? (json['amount'] as num).toInt() : null,
      amountDetails: json['amount_details'] != null
          ? PostPaymentIntentsIntentRequestAmountDetails.fromJson(
              json['amount_details'] as Map<String, dynamic>,
            )
          : null,
      applicationFeeAmount: json['application_fee_amount'] != null
          ? PostPaymentIntentsIntentRequestApplicationFeeAmount.fromJson(
              json['application_fee_amount'] as Map<String, dynamic>,
            )
          : null,
      captureMethod: json['capture_method'] != null
          ? PostPaymentIntentsIntentRequestCaptureMethod.fromJson(
      ...
      excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null
          ? PostPaymentIntentsIntentRequestExcludedPaymentMethodTypes.fromJson(
      ...
      hooks: json['hooks'] != null
          ? PostPaymentIntentsIntentRequestHooks.fromJson(
              json['hooks'] as Map<String, dynamic>,
            )
          : null,
      metadata: json['metadata'] != null
          ? PostPaymentIntentsIntentRequestMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            )
          : null,
      paymentDetails: json['payment_details'] != null
          ? PostPaymentIntentsIntentRequestPaymentDetails.fromJson(
      ...
      paymentMethodData: json['payment_method_data'] != null
          ? PostPaymentIntentsIntentRequestPaymentMethodData.fromJson(
              json['payment_method_data'] as Map<String, dynamic>,
            )
          : null,
      paymentMethodOptions: json['payment_method_options'] != null
          ? PostPaymentIntentsIntentRequestPaymentMethodOptions.fromJson(
      ...
      receiptEmail: json['receipt_email'] != null
          ? PostPaymentIntentsIntentRequestReceiptEmail.fromJson(
              json['receipt_email'] as Map<String, dynamic>,
            )
          : null,
      setupFutureUsage: json['setup_future_usage'] != null
          ? PostPaymentIntentsIntentRequestSetupFutureUsage.fromJson(
              json['setup_future_usage'] as String,
            )
          : null,
      shipping: json['shipping'] != null
          ? PostPaymentIntentsIntentRequestShipping.fromJson(
      ...
      transferData: json['transfer_data'] != null
          ? PostPaymentIntentsIntentRequestTransferData.fromJson(
  ...
  final PostPaymentIntentsIntentRequestApplicationFeeAmount?
  ...
  final PostPaymentIntentsIntentRequestExcludedPaymentMethodTypes?
  ...
  final PostPaymentIntentsIntentRequestPaymentMethodOptions?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (applicationFeeAmount != null)
        'application_fee_amount': applicationFeeAmount?.toJson(),
  ...
  PostPaymentIntentsIntentRequest copyWith({
    int Function()? amount,
    PostPaymentIntentsIntentRequestAmountDetails Function()? amountDetails,
    PostPaymentIntentsIntentRequestApplicationFeeAmount Function()?
    applicationFeeAmount,
    PostPaymentIntentsIntentRequestCaptureMethod Function()? captureMethod,
    String Function()? currency,
    String Function()? customer,
    String Function()? customerAccount,
    String Function()? description,
    PostPaymentIntentsIntentRequestExcludedPaymentMethodTypes Function()?
    excludedPaymentMethodTypes,
    List<String> Function()? expand,
    PostPaymentIntentsIntentRequestHooks Function()? hooks,
    PostPaymentIntentsIntentRequestMetadata Function()? metadata,
    PostPaymentIntentsIntentRequestPaymentDetails Function()? paymentDetails,
    String Function()? paymentMethod,
    String Function()? paymentMethodConfiguration,
    PostPaymentIntentsIntentRequestPaymentMethodData Function()?
    paymentMethodData,
    PostPaymentIntentsIntentRequestPaymentMethodOptions Function()?
    paymentMethodOptions,
    List<String> Function()? paymentMethodTypes,
    PostPaymentIntentsIntentRequestReceiptEmail Function()? receiptEmail,
    PostPaymentIntentsIntentRequestSetupFutureUsage Function()?
    setupFutureUsage,
    PostPaymentIntentsIntentRequestShipping Function()? shipping,
    String Function()? statementDescriptor,
    String Function()? statementDescriptorSuffix,
    PostPaymentIntentsIntentRequestTransferData Function()? transferData,
