...
import 'inline_object1193.dart';
import 'post_prices_request_billing_scheme.dart';
import 'post_prices_request_custom_unit_amount.dart';
import 'post_prices_request_product_data.dart';
import 'post_prices_request_recurring.dart';
import 'post_prices_request_tax_behavior.dart';
import 'post_prices_request_tiers.dart';
import 'post_prices_request_tiers_mode.dart';
import 'post_prices_request_transform_quantity.dart';

final class PostPricesRequest {
  const PostPricesRequest({
    this.active,
    this.billingScheme,
  ...
  factory PostPricesRequest.fromJson(Map<String, dynamic> json) {
    return PostPricesRequest(
      active: json['active'] as bool?,
      billingScheme: json['billing_scheme'] != null
          ? PostPricesRequestBillingScheme.fromJson(
      ...
      currencyOptions: (json['currency_options'] as Map<String, dynamic>?)?.map(
        (k, v) =>
            MapEntry(k, InlineObject1193.fromJson(v as Map<String, dynamic>)),
      ),
      customUnitAmount: json['custom_unit_amount'] != null
          ? PostPricesRequestCustomUnitAmount.fromJson(
      ...
      productData: json['product_data'] != null
          ? PostPricesRequestProductData.fromJson(
              json['product_data'] as Map<String, dynamic>,
            )
          : null,
      recurring: json['recurring'] != null
          ? PostPricesRequestRecurring.fromJson(
              json['recurring'] as Map<String, dynamic>,
            )
          : null,
      taxBehavior: json['tax_behavior'] != null
          ? PostPricesRequestTaxBehavior.fromJson(
              json['tax_behavior'] as String,
            )
          : null,
      tiers: (json['tiers'] as List<dynamic>?)
          ?.map(
            (e) => PostPricesRequestTiers.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      tiersMode: json['tiers_mode'] != null
          ? PostPricesRequestTiersMode.fromJson(json['tiers_mode'] as String)
          : null,
      transferLookupKey: json['transfer_lookup_key'] as bool?,
      transformQuantity: json['transform_quantity'] != null
          ? PostPricesRequestTransformQuantity.fromJson(
  ...
  final Map<String, InlineObject1193>? currencyOptions;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (transformQuantity != null)
        'transform_quantity': transformQuantity?.toJson(),
  ...
  PostPricesRequest copyWith({
    bool Function()? active,
    PostPricesRequestBillingScheme Function()? billingScheme,
    String? currency,
    Map<String, InlineObject1193> Function()? currencyOptions,
    PostPricesRequestCustomUnitAmount Function()? customUnitAmount,
    List<String> Function()? expand,
    String Function()? lookupKey,
    Map<String, String> Function()? metadata,
    String Function()? nickname,
    String Function()? product,
    PostPricesRequestProductData Function()? productData,
    PostPricesRequestRecurring Function()? recurring,
    PostPricesRequestTaxBehavior Function()? taxBehavior,
    List<PostPricesRequestTiers> Function()? tiers,
    PostPricesRequestTiersMode Function()? tiersMode,
    bool Function()? transferLookupKey,
    PostPricesRequestTransformQuantity Function()? transformQuantity,
    ...
    return PostPricesRequest(
      ...
      transferLookupKey: transferLookupKey != null
          ? transferLookupKey()
          : this.transferLookupKey,
