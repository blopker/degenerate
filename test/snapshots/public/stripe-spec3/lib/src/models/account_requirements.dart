...
///
final class AccountRequirements {
  ...
  factory AccountRequirements.fromJson(Map<String, dynamic> json) {
    return AccountRequirements(
      ...
      disabledReason: json['disabled_reason'] != null
          ? AccountRequirementsDisabledReason.fromJson(
  ...
  @override
  String toString() {
    return 'AccountRequirements(alternatives: $alternatives, currentDeadline: $currentDeadline, currentlyDue: $currentlyDue, disabledReason: $disabledReason, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
