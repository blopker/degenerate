...
import 'post_accounts_account_request_business_profile.dart';
import 'post_accounts_account_request_business_type.dart';
import 'post_accounts_account_request_capabilities.dart';
import 'post_accounts_account_request_company.dart';
import 'post_accounts_account_request_documents.dart';
import 'post_accounts_account_request_groups.dart';
import 'post_accounts_account_request_individual.dart';
import 'post_accounts_account_request_metadata.dart';
import 'post_accounts_account_request_settings.dart';
import 'post_accounts_account_request_tos_acceptance.dart';

final class PostAccountsAccountRequest {
  const PostAccountsAccountRequest({
    this.accountToken,
  ...
  factory PostAccountsAccountRequest.fromJson(Map<String, dynamic> json) {
    return PostAccountsAccountRequest(
      accountToken: json['account_token'] as String?,
      businessProfile: json['business_profile'] != null
          ? PostAccountsAccountRequestBusinessProfile.fromJson(
              json['business_profile'] as Map<String, dynamic>,
            )
          : null,
      businessType: json['business_type'] != null
          ? PostAccountsAccountRequestBusinessType.fromJson(
              json['business_type'] as String,
            )
          : null,
      capabilities: json['capabilities'] != null
          ? PostAccountsAccountRequestCapabilities.fromJson(
              json['capabilities'] as Map<String, dynamic>,
            )
          : null,
      company: json['company'] != null
          ? PostAccountsAccountRequestCompany.fromJson(
              json['company'] as Map<String, dynamic>,
            )
          : null,
      defaultCurrency: json['default_currency'] as String?,
      documents: json['documents'] != null
          ? PostAccountsAccountRequestDocuments.fromJson(
      ...
      groups: json['groups'] != null
          ? PostAccountsAccountRequestGroups.fromJson(
              json['groups'] as Map<String, dynamic>,
            )
          : null,
      individual: json['individual'] != null
          ? PostAccountsAccountRequestIndividual.fromJson(
              json['individual'] as Map<String, dynamic>,
            )
          : null,
      metadata: json['metadata'] != null
          ? PostAccountsAccountRequestMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            )
          : null,
      settings: json['settings'] != null
          ? PostAccountsAccountRequestSettings.fromJson(
              json['settings'] as Map<String, dynamic>,
            )
          : null,
      tosAcceptance: json['tos_acceptance'] != null
          ? PostAccountsAccountRequestTosAcceptance.fromJson(
  ...
  PostAccountsAccountRequest copyWith({
    String Function()? accountToken,
    PostAccountsAccountRequestBusinessProfile Function()? businessProfile,
    PostAccountsAccountRequestBusinessType Function()? businessType,
    PostAccountsAccountRequestCapabilities Function()? capabilities,
    PostAccountsAccountRequestCompany Function()? company,
    String Function()? defaultCurrency,
    PostAccountsAccountRequestDocuments Function()? documents,
    String Function()? email,
    List<String> Function()? expand,
    String Function()? externalAccount,
    PostAccountsAccountRequestGroups Function()? groups,
    PostAccountsAccountRequestIndividual Function()? individual,
    PostAccountsAccountRequestMetadata Function()? metadata,
    PostAccountsAccountRequestSettings Function()? settings,
    PostAccountsAccountRequestTosAcceptance Function()? tosAcceptance,
  }) {
    return PostAccountsAccountRequest(
