...
import 'get_payouts_response_object.dart';
import 'payout.dart';

///
final class GetPayoutsResponse {
  const GetPayoutsResponse({
    required this.data,
  ...
  GetPayoutsResponse copyWith({
    List<Payout>? data,
    bool? hasMore,
    GetPayoutsResponseObject? object,
    String? url,
  }) {
    return GetPayoutsResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetPayoutsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
