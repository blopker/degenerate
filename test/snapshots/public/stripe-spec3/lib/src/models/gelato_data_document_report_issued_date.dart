...
/// Point in Time
final class GelatoDataDocumentReportIssuedDate {
  const GelatoDataDocumentReportIssuedDate({this.day, this.month, this.year});

  factory GelatoDataDocumentReportIssuedDate.fromJson(
  ...
  GelatoDataDocumentReportIssuedDate copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'GelatoDataDocumentReportIssuedDate(day: $day, month: $month, year: $year)';
  }
}
