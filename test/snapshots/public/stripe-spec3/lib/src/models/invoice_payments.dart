...
final class InvoicePayments {
  ...
  factory InvoicePayments.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'InvoicePayments(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
