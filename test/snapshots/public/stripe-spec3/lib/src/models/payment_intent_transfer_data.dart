...
final class PaymentIntentTransferData {
  const PaymentIntentTransferData({this.transferData});

  factory PaymentIntentTransferData.fromJson(Map<String, dynamic> json) {
    return PaymentIntentTransferData(
      transferData: TransferData.canParse(json)
