...
import 'terminal_configuration_configuration_resource_cellular_config.dart';
...
import 'terminal_configuration_object.dart';
...
final class TerminalConfiguration {
  ...
  factory TerminalConfiguration.fromJson(Map<String, dynamic> json) {
    return TerminalConfiguration(
      bbposWisepad3: json['bbpos_wisepad3'] != null
          ? TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig.fromJson(
      ...
      cellular: json['cellular'] != null
          ? TerminalConfigurationConfigurationResourceCellularConfig.fromJson(
      ...
      offline: json['offline'] != null
          ? TerminalConfigurationConfigurationResourceOfflineConfig.fromJson(
              json['offline'] as Map<String, dynamic>,
            )
          : null,
      rebootWindow: json['reboot_window'] != null
          ? TerminalConfigurationConfigurationResourceRebootWindow.fromJson(
      ...
      tipping: json['tipping'] != null
          ? TerminalConfigurationConfigurationResourceTipping.fromJson(
      ...
      verifoneP400: json['verifone_p400'] != null
          ...
          : null,
      wifi: json['wifi'] != null
          ? TerminalConfigurationConfigurationResourceWifiConfig.fromJson(
  ...
  final TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig?
  bbposWisepad3;
  ...
  TerminalConfiguration copyWith({
    ...
    Function()?
    bbposWiseposE,
    TerminalConfigurationConfigurationResourceCellularConfig Function()?
    cellular,
    String? id,
    bool? Function()? isAccountDefault,
    bool? livemode,
    String? Function()? name,
    TerminalConfigurationObject? object,
    TerminalConfigurationConfigurationResourceOfflineConfig Function()? offline,
    TerminalConfigurationConfigurationResourceRebootWindow Function()?
    rebootWindow,
    TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig
    Function()?
    stripeS700,
    ...
    Function()?
    stripeS710,
    TerminalConfigurationConfigurationResourceTipping Function()? tipping,
    TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig
    Function()?
    verifoneP400,
    TerminalConfigurationConfigurationResourceWifiConfig Function()? wifi,
  }) {
    return TerminalConfiguration(
      ...
      id: id ?? this.id,
      isAccountDefault: isAccountDefault != null
          ? isAccountDefault()
          : this.isAccountDefault,
