...
import 'payment_pages_checkout_session_customer_details_address.dart';
import 'payment_pages_checkout_session_customer_details_tax_exempt.dart';
import 'payment_pages_checkout_session_tax_id.dart';

///
final class PaymentPagesCheckoutSessionCustomerDetails {
  ...
  factory PaymentPagesCheckoutSessionCustomerDetails.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaymentPagesCheckoutSessionCustomerDetails(
      address: json['address'] != null
          ? PaymentPagesCheckoutSessionCustomerDetailsAddress.fromJson(
      ...
      taxExempt: json['tax_exempt'] != null
          ? PaymentPagesCheckoutSessionCustomerDetailsTaxExempt.fromJson(
              json['tax_exempt'] as String,
            )
          : null,
      taxIds: (json['tax_ids'] as List<dynamic>?)
          ?.map(
            (e) => PaymentPagesCheckoutSessionTaxId.fromJson(
  ...
  PaymentPagesCheckoutSessionCustomerDetails copyWith({
    PaymentPagesCheckoutSessionCustomerDetailsAddress? Function()? address,
    String? Function()? businessName,
    String? Function()? email,
    String? Function()? individualName,
    String? Function()? name,
    String? Function()? phone,
    PaymentPagesCheckoutSessionCustomerDetailsTaxExempt? Function()? taxExempt,
    List<PaymentPagesCheckoutSessionTaxId>? Function()? taxIds,
  }) {
    return PaymentPagesCheckoutSessionCustomerDetails(
  ...
  @override
  String toString() {
    return 'PaymentPagesCheckoutSessionCustomerDetails(address: $address, businessName: $businessName, email: $email, individualName: $individualName, name: $name, phone: $phone, taxExempt: $taxExempt, taxIds: $taxIds)';
  }
}
