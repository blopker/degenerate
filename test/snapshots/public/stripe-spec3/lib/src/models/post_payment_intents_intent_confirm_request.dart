...
import 'post_payment_intents_intent_confirm_request_amount_details.dart';
import 'post_payment_intents_intent_confirm_request_capture_method.dart';
import 'post_payment_intents_intent_confirm_request_excluded_payment_method_types.dart';
import 'post_payment_intents_intent_confirm_request_hooks.dart';
import 'post_payment_intents_intent_confirm_request_mandate_data.dart';
import 'post_payment_intents_intent_confirm_request_off_session.dart';
import 'post_payment_intents_intent_confirm_request_payment_details.dart';
import 'post_payment_intents_intent_confirm_request_payment_method_data.dart';
import 'post_payment_intents_intent_confirm_request_payment_method_options.dart';
import 'post_payment_intents_intent_confirm_request_radar_options.dart';
import 'post_payment_intents_intent_confirm_request_receipt_email.dart';
import 'post_payment_intents_intent_confirm_request_setup_future_usage.dart';
import 'post_payment_intents_intent_confirm_request_shipping.dart';

final class PostPaymentIntentsIntentConfirmRequest {
  const PostPaymentIntentsIntentConfirmRequest({
    this.amountDetails,
    this.captureMethod,
    this.clientSecret,
  ...
  factory PostPaymentIntentsIntentConfirmRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostPaymentIntentsIntentConfirmRequest(
      amountDetails: json['amount_details'] != null
          ? PostPaymentIntentsIntentConfirmRequestAmountDetails.fromJson(
              json['amount_details'] as Map<String, dynamic>,
            )
          : null,
      captureMethod: json['capture_method'] != null
          ? PostPaymentIntentsIntentConfirmRequestCaptureMethod.fromJson(
      ...
      excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null
          ? PostPaymentIntentsIntentConfirmRequestExcludedPaymentMethodTypes.fromJson(
              json['excluded_payment_method_types'] as Map<String, dynamic>,
            )
          : null,
      ...
      hooks: json['hooks'] != null
          ? PostPaymentIntentsIntentConfirmRequestHooks.fromJson(
              json['hooks'] as Map<String, dynamic>,
            )
          : null,
      mandate: json['mandate'] as String?,
      mandateData: json['mandate_data'] != null
          ? PostPaymentIntentsIntentConfirmRequestMandateData.fromJson(
              json['mandate_data'] as Map<String, dynamic>,
            )
          : null,
      offSession: json['off_session'] != null
          ? PostPaymentIntentsIntentConfirmRequestOffSession.fromJson(
              json['off_session'] as Map<String, dynamic>,
            )
          : null,
      paymentDetails: json['payment_details'] != null
          ? PostPaymentIntentsIntentConfirmRequestPaymentDetails.fromJson(
              json['payment_details'] as Map<String, dynamic>,
            )
          : null,
      paymentMethod: json['payment_method'] as String?,
      paymentMethodData: json['payment_method_data'] != null
          ? PostPaymentIntentsIntentConfirmRequestPaymentMethodData.fromJson(
              json['payment_method_data'] as Map<String, dynamic>,
            )
          : null,
      paymentMethodOptions: json['payment_method_options'] != null
          ? PostPaymentIntentsIntentConfirmRequestPaymentMethodOptions.fromJson(
      ...
      radarOptions: json['radar_options'] != null
          ? PostPaymentIntentsIntentConfirmRequestRadarOptions.fromJson(
              json['radar_options'] as Map<String, dynamic>,
            )
          : null,
      receiptEmail: json['receipt_email'] != null
          ? PostPaymentIntentsIntentConfirmRequestReceiptEmail.fromJson(
              json['receipt_email'] as Map<String, dynamic>,
            )
          : null,
      returnUrl: json['return_url'] as String?,
      setupFutureUsage: json['setup_future_usage'] != null
          ? PostPaymentIntentsIntentConfirmRequestSetupFutureUsage.fromJson(
              json['setup_future_usage'] as String,
            )
          : null,
      shipping: json['shipping'] != null
          ? PostPaymentIntentsIntentConfirmRequestShipping.fromJson(
  ...
  final PostPaymentIntentsIntentConfirmRequestExcludedPaymentMethodTypes?
  ...
  final PostPaymentIntentsIntentConfirmRequestPaymentMethodData?
  paymentMethodData;

  /// Payment method-specific configuration for this PaymentIntent.
  final PostPaymentIntentsIntentConfirmRequestPaymentMethodOptions?
  ...
  final PostPaymentIntentsIntentConfirmRequestSetupFutureUsage?
  setupFutureUsage;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (excludedPaymentMethodTypes != null)
        'excluded_payment_method_types': excludedPaymentMethodTypes?.toJson(),
      'expand': ?expand,
  ...
  PostPaymentIntentsIntentConfirmRequest copyWith({
    PostPaymentIntentsIntentConfirmRequestAmountDetails Function()?
    amountDetails,
    PostPaymentIntentsIntentConfirmRequestCaptureMethod Function()?
    captureMethod,
    String Function()? clientSecret,
    String Function()? confirmationToken,
    bool Function()? errorOnRequiresAction,
    PostPaymentIntentsIntentConfirmRequestExcludedPaymentMethodTypes Function()?
    excludedPaymentMethodTypes,
    List<String> Function()? expand,
    PostPaymentIntentsIntentConfirmRequestHooks Function()? hooks,
    String Function()? mandate,
    PostPaymentIntentsIntentConfirmRequestMandateData Function()? mandateData,
    PostPaymentIntentsIntentConfirmRequestOffSession Function()? offSession,
    PostPaymentIntentsIntentConfirmRequestPaymentDetails Function()?
    paymentDetails,
    String Function()? paymentMethod,
    PostPaymentIntentsIntentConfirmRequestPaymentMethodData Function()?
    paymentMethodData,
    PostPaymentIntentsIntentConfirmRequestPaymentMethodOptions Function()?
    paymentMethodOptions,
    List<String> Function()? paymentMethodTypes,
    PostPaymentIntentsIntentConfirmRequestRadarOptions Function()? radarOptions,
    PostPaymentIntentsIntentConfirmRequestReceiptEmail Function()? receiptEmail,
    String Function()? returnUrl,
    PostPaymentIntentsIntentConfirmRequestSetupFutureUsage Function()?
    setupFutureUsage,
    PostPaymentIntentsIntentConfirmRequestShipping Function()? shipping,
    bool Function()? useStripeSdk,
  }) {
    return PostPaymentIntentsIntentConfirmRequest(
      ...
      confirmationToken: confirmationToken != null
          ? confirmationToken()
          : this.confirmationToken,
      errorOnRequiresAction: errorOnRequiresAction != null
