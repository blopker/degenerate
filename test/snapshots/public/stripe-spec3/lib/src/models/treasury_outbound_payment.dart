...
import 'treasury_outbound_payment_destination_payment_method_details.dart';
import 'treasury_outbound_payment_end_user_details.dart';
import 'treasury_outbound_payment_object.dart';
import 'treasury_outbound_payment_returned_details.dart';
import 'treasury_outbound_payment_status.dart';
import 'treasury_outbound_payment_tracking_details.dart';
import 'treasury_outbound_payment_transaction.dart';
...
final class TreasuryOutboundPayment {
  ...
  factory TreasuryOutboundPayment.fromJson(Map<String, dynamic> json) {
    return TreasuryOutboundPayment(
      ...
      destinationPaymentMethodDetails:
          json['destination_payment_method_details'] != null
          ? TreasuryOutboundPaymentDestinationPaymentMethodDetails.fromJson(
              json['destination_payment_method_details']
                  as Map<String, dynamic>,
            )
          : null,
      endUserDetails: json['end_user_details'] != null
          ? TreasuryOutboundPaymentEndUserDetails.fromJson(
              json['end_user_details'] as Map<String, dynamic>,
            )
          : null,
      ...
      returnedDetails: json['returned_details'] != null
          ? TreasuryOutboundPaymentReturnedDetails.fromJson(
              json['returned_details'] as Map<String, dynamic>,
            )
          : null,
      ...
      trackingDetails: json['tracking_details'] != null
          ? TreasuryOutboundPaymentTrackingDetails.fromJson(
              json['tracking_details'] as Map<String, dynamic>,
            )
          : null,
      transaction: TreasuryOutboundPaymentTransaction.fromJson(
  ...
  final TreasuryOutboundPaymentDestinationPaymentMethodDetails?
  destinationPaymentMethodDetails;
  ...
  final TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions
  statusTransitions;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (destinationPaymentMethodDetails != null)
      ...
      if (returnedDetails != null)
        'returned_details': returnedDetails?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        json['amount'] is num &&
        json.containsKey('cancelable') &&
        json['cancelable'] is bool &&
        json.containsKey('created') &&
        json['created'] is num &&
        json.containsKey('currency') &&
        json['currency'] is String &&
        json.containsKey('expected_arrival_date') &&
        json['expected_arrival_date'] is num &&
        ...
        json.containsKey('statement_descriptor') &&
        json['statement_descriptor'] is String &&
        json.containsKey('status') &&
        json.containsKey('status_transitions') &&
        json.containsKey('transaction');
  }

  TreasuryOutboundPayment copyWith({
    int? amount,
    bool? cancelable,
    int? created,
    String? currency,
    ...
    String? Function()? destinationPaymentMethod,
    TreasuryOutboundPaymentDestinationPaymentMethodDetails? Function()?
    destinationPaymentMethodDetails,
    TreasuryOutboundPaymentEndUserDetails? Function()? endUserDetails,
    ...
    TreasuryOutboundPaymentObject? object,
    TreasuryOutboundPaymentReturnedDetails? Function()? returnedDetails,
    String? statementDescriptor,
    TreasuryOutboundPaymentStatus? status,
    TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions?
    statusTransitions,
    TreasuryOutboundPaymentTrackingDetails? Function()? trackingDetails,
    ...
    return TreasuryOutboundPayment(
      ...
      destinationPaymentMethod: destinationPaymentMethod != null
          ? destinationPaymentMethod()
          : this.destinationPaymentMethod,
      destinationPaymentMethodDetails: destinationPaymentMethodDetails != null
          ? destinationPaymentMethodDetails()
          : this.destinationPaymentMethodDetails,
      ...
      returnedDetails: returnedDetails != null
          ? returnedDetails()
          : this.returnedDetails,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is TreasuryOutboundPayment &&
            ...
            destinationPaymentMethodDetails ==
                other.destinationPaymentMethodDetails &&
