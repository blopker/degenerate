...
import 'package:collection/collection.dart';import 'post_accounts_account_persons_request_documents_passport_files.dart';final class PostAccountsAccountPersonsRequestDocumentsPassport {const PostAccountsAccountPersonsRequestDocumentsPassport({this.files});
...
factory PostAccountsAccountPersonsRequestDocumentsPassport.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestDocumentsPassport(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPersonsRequestDocumentsPassportFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
