...
final class SourceTransaction {
  ...
  factory SourceTransaction.fromJson(Map<String, dynamic> json) {
    return SourceTransaction(
      ...
      chfCreditTransfer: json['chf_credit_transfer'] != null
          ? SourceTransactionChfCreditTransferData.fromJson(
              json['chf_credit_transfer'] as Map<String, dynamic>,
            )
          : null,
      ...
      gbpCreditTransfer: json['gbp_credit_transfer'] != null
          ? SourceTransactionGbpCreditTransferData.fromJson(
              json['gbp_credit_transfer'] as Map<String, dynamic>,
            )
          : null,
      ...
      paperCheck: json['paper_check'] != null
          ? SourceTransactionPaperCheckData.fromJson(
              json['paper_check'] as Map<String, dynamic>,
            )
          : null,
      sepaCreditTransfer: json['sepa_credit_transfer'] != null
          ? SourceTransactionSepaCreditTransferData.fromJson(
              json['sepa_credit_transfer'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (chfCreditTransfer != null)
        'chf_credit_transfer': chfCreditTransfer?.toJson(),
      'created': created,
      'currency': currency,
      if (gbpCreditTransfer != null)
        'gbp_credit_transfer': gbpCreditTransfer?.toJson(),
      'id': id,
      'livemode': livemode,
      'object': object.toJson(),
      if (paperCheck != null) 'paper_check': paperCheck?.toJson(),
      if (sepaCreditTransfer != null)
        'sepa_credit_transfer': sepaCreditTransfer?.toJson(),
      'source': source,
      'status': status,
      'type': type.toJson(),
    };
  ...
  SourceTransaction copyWith({
    SourceTransactionAchCreditTransferData Function()? achCreditTransfer,
    int? amount,
    SourceTransactionChfCreditTransferData Function()? chfCreditTransfer,
    int? created,
    String? currency,
    SourceTransactionGbpCreditTransferData Function()? gbpCreditTransfer,
    String? id,
    bool? livemode,
    SourceTransactionObject? object,
    SourceTransactionPaperCheckData Function()? paperCheck,
    SourceTransactionSepaCreditTransferData Function()? sepaCreditTransfer,
    String? source,
    String? status,
    ...
    return SourceTransaction(
      ...
      chfCreditTransfer: chfCreditTransfer != null
          ? chfCreditTransfer()
          : this.chfCreditTransfer,
      created: created ?? this.created,
      currency: currency ?? this.currency,
      gbpCreditTransfer: gbpCreditTransfer != null
          ? gbpCreditTransfer()
          : this.gbpCreditTransfer,
      id: id ?? this.id,
