...
import 'package:collection/collection.dart';import 'invoice_line_item_period.dart';import 'invoiceitem_customer.dart';import 'invoiceitem_discounts.dart';import 'invoiceitem_invoice.dart';import 'invoiceitem_object.dart';import 'invoiceitem_parent.dart';import 'invoiceitem_pricing.dart';import 'invoiceitem_test_clock.dart';import 'proration_details.dart';import 'tax_rate.dart';/// Invoice Items represent the component lines of an [invoice](https://docs.stripe.com/api/invoices). When you create an invoice item with an `invoice` field, it is attached to the specified invoice and included as [an invoice line item](https://docs.stripe.com/api/invoices/line_item) within [invoice.lines](https://docs.stripe.com/api/invoices/object#invoice_object-lines).
/// 
...
factory Invoiceitem.fromJson(Map<String, dynamic> json) { return Invoiceitem(
  ...
  customer: InvoiceitemCustomer.fromJson(json['customer'] as Map<String, dynamic>),
