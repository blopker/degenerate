...
final class GetAccountsAccountPeopleRelationship {
  const GetAccountsAccountPeopleRelationship({
    this.authorizer,
    this.director,
    this.executive,
    this.legalGuardian,
  ...
  factory GetAccountsAccountPeopleRelationship.fromJson(
    Map<String, dynamic> json,
  ) {
    return GetAccountsAccountPeopleRelationship(
  ...
  GetAccountsAccountPeopleRelationship copyWith({
  ...
  @override
  String toString() {
    return 'GetAccountsAccountPeopleRelationship(authorizer: $authorizer, director: $director, executive: $executive, legalGuardian: $legalGuardian, owner: $owner, representative: $representative)';
  }
}
