...
import 'inline_object1214.dart';/// Settings that restrict the redemption of the promotion code.
...
factory PostPromotionCodesRequestRestrictions.fromJson(Map<String, dynamic> json) { return PostPromotionCodesRequestRestrictions(
  currencyOptions: (json['currency_options'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject1214.fromJson(v as Map<String, dynamic>))),
...
PostPromotionCodesRequestRestrictions copyWith({Map<String, InlineObject1214> Function()? currencyOptions, bool Function()? firstTimeTransaction, int Function()? minimumAmount, String Function()? minimumAmountCurrency, }) { return PostPromotionCodesRequestRestrictions(
