...
import 'account_business_profile_annual_revenue.dart';
import 'account_business_profile_minority_owned_business_designation.dart';
import 'account_business_profile_support_address.dart';
import 'account_monthly_estimated_revenue.dart';

///
final class AccountBusinessProfile {
  ...
  factory AccountBusinessProfile.fromJson(Map<String, dynamic> json) {
    return AccountBusinessProfile(
      annualRevenue: json['annual_revenue'] != null
          ? AccountBusinessProfileAnnualRevenue.fromJson(
      ...
      minorityOwnedBusinessDesignation:
          (json['minority_owned_business_designation'] as List<dynamic>?)
              ?.map(
                (e) =>
                    AccountBusinessProfileMinorityOwnedBusinessDesignation.fromJson(
                      e as String,
                    ),
              )
              .toList(),
  ...
  final List<AccountBusinessProfileMinorityOwnedBusinessDesignation>?
  minorityOwnedBusinessDesignation;
  ...
  AccountBusinessProfile copyWith({
    AccountBusinessProfileAnnualRevenue? Function()? annualRevenue,
    int? Function()? estimatedWorkerCount,
    String? Function()? mcc,
    List<AccountBusinessProfileMinorityOwnedBusinessDesignation>? Function()?
    minorityOwnedBusinessDesignation,
    AccountMonthlyEstimatedRevenue Function()? monthlyEstimatedRevenue,
    String? Function()? name,
    String? Function()? productDescription,
    AccountBusinessProfileSupportAddress? Function()? supportAddress,
