...
final class MandatePayto {
  ...
  factory MandatePayto.fromJson(Map<String, dynamic> json) {
    return MandatePayto(
      amount: json['amount'] != null ? (json['amount'] as num).toInt() : null,
      amountType: MandatePaytoAmountType.fromJson(
        json['amount_type'] as String,
      ),
      endDate: json['end_date'] as String?,
      paymentSchedule: MandatePaytoPaymentSchedule.fromJson(
      ...
      purpose: json['purpose'] != null
          ? MandatePaytoPurpose.fromJson(json['purpose'] as String)
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount_type') &&
        json.containsKey('payment_schedule');
  }

  MandatePayto copyWith({
    int? Function()? amount,
    ...
    MandatePaytoPurpose? Function()? purpose,
  ...
  @override
  String toString() {
    return 'MandatePayto(amount: $amount, amountType: $amountType, endDate: $endDate, paymentSchedule: $paymentSchedule, paymentsPerPeriod: $paymentsPerPeriod, purpose: $purpose, startDate: $startDate)';
  }
}
