...
import 'issuing_settlement_network.dart';
import 'issuing_settlement_object.dart';
import 'issuing_settlement_status.dart';
...
final class IssuingSettlement {
  const IssuingSettlement({
    required this.bin,
  ...
  factory IssuingSettlement.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('bin') &&
        ...
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('interchange_fees_amount') &&
        json['interchange_fees_amount'] is num &&
        ...
        json.containsKey('network_fees_amount') &&
        json['network_fees_amount'] is num &&
        json.containsKey('network_settlement_identifier') &&
        json['network_settlement_identifier'] is String &&
        json.containsKey('object') &&
        json.containsKey('settlement_service') &&
        json['settlement_service'] is String &&
        json.containsKey('status') &&
        json.containsKey('transaction_amount') &&
        json['transaction_amount'] is num &&
        json.containsKey('transaction_count') &&
        json['transaction_count'] is num;
  }

  IssuingSettlement copyWith({
    String? bin,
    int? clearingDate,
    int? created,
    String? currency,
    ...
    int? netTotalAmount,
    IssuingSettlementNetwork? network,
    int? networkFeesAmount,
    String? networkSettlementIdentifier,
    IssuingSettlementObject? object,
    String? settlementService,
    IssuingSettlementStatus? status,
    ...
    return IssuingSettlement(
      ...
      interchangeFeesAmount:
          interchangeFeesAmount ?? this.interchangeFeesAmount,
      ...
      networkSettlementIdentifier:
          networkSettlementIdentifier ?? this.networkSettlementIdentifier,
