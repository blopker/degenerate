...
import 'post_charges_charge_capture_request_transfer_data.dart';

final class PostChargesChargeCaptureRequest {
  const PostChargesChargeCaptureRequest({
    this.amount,
    this.applicationFee,
  ...
  factory PostChargesChargeCaptureRequest.fromJson(Map<String, dynamic> json) {
    return PostChargesChargeCaptureRequest(
      ...
      transferData: json['transfer_data'] != null
          ? PostChargesChargeCaptureRequestTransferData.fromJson(
  ...
  PostChargesChargeCaptureRequest copyWith({
    int Function()? amount,
    ...
    PostChargesChargeCaptureRequestTransferData Function()? transferData,
