...
import 'post_checkout_sessions_request_payment_method_options_sofort_setup_future_usage.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsSofort {const PostCheckoutSessionsRequestPaymentMethodOptionsSofort({this.setupFutureUsage});
