...
final class InlineObject238 {const InlineObject238({this.amountGte, this.resetBillingCycleAnchor, });
...
InlineObject238 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject238(
...
@override String toString() { return 'InlineObject238(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
