...
///
final class PortalFlowsFlowSubscriptionUpdateConfirm {
  const PortalFlowsFlowSubscriptionUpdateConfirm({
    this.discounts,
    required this.items,
    required this.subscription,
  });

  factory PortalFlowsFlowSubscriptionUpdateConfirm.fromJson(
    Map<String, dynamic> json,
  ) {
    return PortalFlowsFlowSubscriptionUpdateConfirm(
      discounts: (json['discounts'] as List<dynamic>?)
          ?.map(
            (e) => PortalFlowsSubscriptionUpdateConfirmDiscount.fromJson(
      ...
      items: (json['items'] as List<dynamic>)
          .map(
            (e) => PortalFlowsSubscriptionUpdateConfirmItem.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
  ...
  PortalFlowsFlowSubscriptionUpdateConfirm copyWith({
    List<PortalFlowsSubscriptionUpdateConfirmDiscount>? Function()? discounts,
  ...
  @override
  String toString() {
    return 'PortalFlowsFlowSubscriptionUpdateConfirm(discounts: $discounts, items: $items, subscription: $subscription)';
  }
}
