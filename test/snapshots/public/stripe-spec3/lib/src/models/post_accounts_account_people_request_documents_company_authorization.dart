...
import 'package:collection/collection.dart';import 'post_accounts_account_people_request_documents_company_authorization_files.dart';final class PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization {const PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization({this.files});
...
factory PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPeopleRequestDocumentsCompanyAuthorizationFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
