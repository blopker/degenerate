...
///
final class PaymentIntentNextActionPromptpayDisplayQrCode {
  ...
  factory PaymentIntentNextActionPromptpayDisplayQrCode.fromJson(
  ...
  PaymentIntentNextActionPromptpayDisplayQrCode copyWith({
    String? data,
  ...
  @override
  int get hashCode {
    return Object.hash(data, hostedInstructionsUrl, imageUrlPng, imageUrlSvg);
  }

  @override
  String toString() {
    return 'PaymentIntentNextActionPromptpayDisplayQrCode(data: $data, hostedInstructionsUrl: $hostedInstructionsUrl, imageUrlPng: $imageUrlPng, imageUrlSvg: $imageUrlSvg)';
  }
}
