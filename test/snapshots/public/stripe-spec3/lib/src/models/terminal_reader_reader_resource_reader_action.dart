...
final class TerminalReaderReaderResourceReaderAction {
  const TerminalReaderReaderResourceReaderAction({
    this.collectInputs,
  ...
  factory TerminalReaderReaderResourceReaderAction.fromJson(
    Map<String, dynamic> json,
  ) {
    return TerminalReaderReaderResourceReaderAction(
      collectInputs: json['collect_inputs'] != null
          ? TerminalReaderReaderResourceCollectInputsAction.fromJson(
              json['collect_inputs'] as Map<String, dynamic>,
            )
          : null,
      collectPaymentMethod: json['collect_payment_method'] != null
          ? TerminalReaderReaderResourceCollectPaymentMethodAction.fromJson(
              json['collect_payment_method'] as Map<String, dynamic>,
            )
          : null,
      confirmPaymentIntent: json['confirm_payment_intent'] != null
          ? TerminalReaderReaderResourceConfirmPaymentIntentAction.fromJson(
              json['confirm_payment_intent'] as Map<String, dynamic>,
            )
          : null,
  ...
  final TerminalReaderReaderResourceCollectPaymentMethodAction?
  collectPaymentMethod;

  final TerminalReaderReaderResourceConfirmPaymentIntentAction?
  ...
  final TerminalReaderReaderResourceProcessPaymentIntentAction?
  processPaymentIntent;

  final TerminalReaderReaderResourceProcessSetupIntentAction?
  processSetupIntent;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (collectPaymentMethod != null)
        'collect_payment_method': collectPaymentMethod?.toJson(),
      if (confirmPaymentIntent != null)
        'confirm_payment_intent': confirmPaymentIntent?.toJson(),
      'failure_code': ?failureCode,
      'failure_message': ?failureMessage,
      if (processPaymentIntent != null)
        'process_payment_intent': processPaymentIntent?.toJson(),
      if (processSetupIntent != null)
        'process_setup_intent': processSetupIntent?.toJson(),
      if (refundPayment != null) 'refund_payment': refundPayment?.toJson(),
      if (setReaderDisplay != null)
        'set_reader_display': setReaderDisplay?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('status') && json.containsKey('type');
  }

  TerminalReaderReaderResourceReaderAction copyWith({
    TerminalReaderReaderResourceCollectInputsAction Function()? collectInputs,
    TerminalReaderReaderResourceCollectPaymentMethodAction Function()?
    collectPaymentMethod,
    TerminalReaderReaderResourceConfirmPaymentIntentAction Function()?
    confirmPaymentIntent,
    String? Function()? failureCode,
    String? Function()? failureMessage,
    TerminalReaderReaderResourceProcessPaymentIntentAction Function()?
    processPaymentIntent,
    TerminalReaderReaderResourceProcessSetupIntentAction Function()?
    processSetupIntent,
    TerminalReaderReaderResourceRefundPaymentAction Function()? refundPayment,
    TerminalReaderReaderResourceSetReaderDisplayAction Function()?
    setReaderDisplay,
    TerminalReaderReaderResourceReaderActionStatus? status,
    TerminalReaderReaderResourceReaderActionType? type,
  }) {
    return TerminalReaderReaderResourceReaderAction(
      collectInputs: collectInputs != null
          ? collectInputs()
          : this.collectInputs,
      collectPaymentMethod: collectPaymentMethod != null
          ? collectPaymentMethod()
          : this.collectPaymentMethod,
      confirmPaymentIntent: confirmPaymentIntent != null
          ? confirmPaymentIntent()
          : this.confirmPaymentIntent,
      ...
      failureMessage: failureMessage != null
          ? failureMessage()
          : this.failureMessage,
      processPaymentIntent: processPaymentIntent != null
          ? processPaymentIntent()
          : this.processPaymentIntent,
      processSetupIntent: processSetupIntent != null
          ? processSetupIntent()
          : this.processSetupIntent,
      refundPayment: refundPayment != null
          ? refundPayment()
          : this.refundPayment,
      setReaderDisplay: setReaderDisplay != null
          ? setReaderDisplay()
          : this.setReaderDisplay,
