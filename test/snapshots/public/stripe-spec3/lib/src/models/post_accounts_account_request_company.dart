...
import 'post_accounts_account_request_company_address.dart';
import 'post_accounts_account_request_company_address_kana.dart';
import 'post_accounts_account_request_company_address_kanji.dart';
import 'post_accounts_account_request_company_directorship_declaration.dart';
import 'post_accounts_account_request_company_ownership_declaration.dart';
import 'post_accounts_account_request_company_ownership_exemption_reason.dart';
import 'post_accounts_account_request_company_registration_date.dart';
import 'post_accounts_account_request_company_representative_declaration.dart';
import 'post_accounts_account_request_company_structure.dart';
import 'post_accounts_account_request_company_verification.dart';
...
final class PostAccountsAccountRequestCompany {
  ...
  factory PostAccountsAccountRequestCompany.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostAccountsAccountRequestCompany(
      address: json['address'] != null
          ? PostAccountsAccountRequestCompanyAddress.fromJson(
              json['address'] as Map<String, dynamic>,
            )
          : null,
      addressKana: json['address_kana'] != null
          ? PostAccountsAccountRequestCompanyAddressKana.fromJson(
              json['address_kana'] as Map<String, dynamic>,
            )
          : null,
      addressKanji: json['address_kanji'] != null
          ? PostAccountsAccountRequestCompanyAddressKanji.fromJson(
      ...
      directorshipDeclaration: json['directorship_declaration'] != null
          ? PostAccountsAccountRequestCompanyDirectorshipDeclaration.fromJson(
      ...
      verification: json['verification'] != null
          ? PostAccountsAccountRequestCompanyVerification.fromJson(
  ...
  final PostAccountsAccountRequestCompanyDirectorshipDeclaration?
  ...
  final PostAccountsAccountRequestCompanyOwnershipDeclaration?
  ownershipDeclaration;

  final PostAccountsAccountRequestCompanyOwnershipExemptionReason?
  ...
  final PostAccountsAccountRequestCompanyRepresentativeDeclaration?
  ...
  PostAccountsAccountRequestCompany copyWith({
    PostAccountsAccountRequestCompanyAddress Function()? address,
    PostAccountsAccountRequestCompanyAddressKana Function()? addressKana,
    PostAccountsAccountRequestCompanyAddressKanji Function()? addressKanji,
    bool Function()? directorsProvided,
    PostAccountsAccountRequestCompanyDirectorshipDeclaration Function()?
    directorshipDeclaration,
    ...
    PostAccountsAccountRequestCompanyOwnershipDeclaration Function()?
    ownershipDeclaration,
    PostAccountsAccountRequestCompanyOwnershipExemptionReason Function()?
    ownershipExemptionReason,
    String Function()? phone,
    PostAccountsAccountRequestCompanyRegistrationDate Function()?
    registrationDate,
    String Function()? registrationNumber,
    PostAccountsAccountRequestCompanyRepresentativeDeclaration Function()?
    representativeDeclaration,
    PostAccountsAccountRequestCompanyStructure Function()? structure,
    String Function()? taxId,
    String Function()? taxIdRegistrar,
    String Function()? vatId,
    PostAccountsAccountRequestCompanyVerification Function()? verification,
  }) {
    return PostAccountsAccountRequestCompany(
