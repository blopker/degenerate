...
final class PostSubscriptionsRequestTrialEnd {
  const PostSubscriptionsRequestTrialEnd({this.inlineObject1419, this.$int});

  factory PostSubscriptionsRequestTrialEnd.fromJson(Object? json) {
    return PostSubscriptionsRequestTrialEnd(
  ...
  bool get isValid {
    return inlineObject1419 != null || $int != null;
  }
