...
import 'post_payment_links_payment_link_request_after_completion.dart';
import 'post_payment_links_payment_link_request_automatic_tax.dart';
import 'post_payment_links_payment_link_request_billing_address_collection.dart';
import 'post_payment_links_payment_link_request_custom_fields.dart';
import 'post_payment_links_payment_link_request_custom_text.dart';
import 'post_payment_links_payment_link_request_customer_creation.dart';
import 'post_payment_links_payment_link_request_inactive_message.dart';
import 'post_payment_links_payment_link_request_invoice_creation.dart';
import 'post_payment_links_payment_link_request_line_items.dart';
import 'post_payment_links_payment_link_request_name_collection.dart';
import 'post_payment_links_payment_link_request_optional_items.dart';
import 'post_payment_links_payment_link_request_payment_intent_data.dart';
import 'post_payment_links_payment_link_request_payment_method_collection.dart';
import 'post_payment_links_payment_link_request_payment_method_types.dart';
import 'post_payment_links_payment_link_request_phone_number_collection.dart';
import 'post_payment_links_payment_link_request_restrictions.dart';
import 'post_payment_links_payment_link_request_shipping_address_collection.dart';
import 'post_payment_links_payment_link_request_submit_type.dart';
import 'post_payment_links_payment_link_request_subscription_data.dart';
import 'post_payment_links_payment_link_request_tax_id_collection.dart';

final class PostPaymentLinksPaymentLinkRequest {
  const PostPaymentLinksPaymentLinkRequest({
    this.active,
  ...
  factory PostPaymentLinksPaymentLinkRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostPaymentLinksPaymentLinkRequest(
      active: json['active'] as bool?,
      afterCompletion: json['after_completion'] != null
          ? PostPaymentLinksPaymentLinkRequestAfterCompletion.fromJson(
      ...
      inactiveMessage: json['inactive_message'] != null
          ? PostPaymentLinksPaymentLinkRequestInactiveMessage.fromJson(
              json['inactive_message'] as Map<String, dynamic>,
            )
          : null,
      invoiceCreation: json['invoice_creation'] != null
          ? PostPaymentLinksPaymentLinkRequestInvoiceCreation.fromJson(
              json['invoice_creation'] as Map<String, dynamic>,
            )
          : null,
      lineItems: (json['line_items'] as List<dynamic>?)
          ?.map(
            (e) => PostPaymentLinksPaymentLinkRequestLineItems.fromJson(
  ...
  final PostPaymentLinksPaymentLinkRequestBillingAddressCollection?
  ...
  final PostPaymentLinksPaymentLinkRequestPaymentMethodCollection?
  paymentMethodCollection;

  /// The list of payment method types that customers can use. Pass an empty string to enable dynamic payment methods that use your [payment method settings](https://dashboard.stripe.com/settings/payment_methods).
  final PostPaymentLinksPaymentLinkRequestPaymentMethodTypes?
  paymentMethodTypes;

  /// Controls phone number collection settings during checkout.
  ///
  /// We recommend that you review your privacy policy and check with your legal contacts.
  final PostPaymentLinksPaymentLinkRequestPhoneNumberCollection?
  ...
  final PostPaymentLinksPaymentLinkRequestShippingAddressCollection?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (inactiveMessage != null)
        'inactive_message': inactiveMessage?.toJson(),
  ...
  PostPaymentLinksPaymentLinkRequest copyWith({
    bool Function()? active,
    PostPaymentLinksPaymentLinkRequestAfterCompletion Function()?
    afterCompletion,
    bool Function()? allowPromotionCodes,
    PostPaymentLinksPaymentLinkRequestAutomaticTax Function()? automaticTax,
    PostPaymentLinksPaymentLinkRequestBillingAddressCollection Function()?
    billingAddressCollection,
    PostPaymentLinksPaymentLinkRequestCustomFields Function()? customFields,
    PostPaymentLinksPaymentLinkRequestCustomText Function()? customText,
    PostPaymentLinksPaymentLinkRequestCustomerCreation Function()?
    customerCreation,
    List<String> Function()? expand,
    PostPaymentLinksPaymentLinkRequestInactiveMessage Function()?
    inactiveMessage,
    PostPaymentLinksPaymentLinkRequestInvoiceCreation Function()?
    invoiceCreation,
    List<PostPaymentLinksPaymentLinkRequestLineItems> Function()? lineItems,
    Map<String, String> Function()? metadata,
    PostPaymentLinksPaymentLinkRequestNameCollection Function()? nameCollection,
    PostPaymentLinksPaymentLinkRequestOptionalItems Function()? optionalItems,
    PostPaymentLinksPaymentLinkRequestPaymentIntentData Function()?
    paymentIntentData,
    PostPaymentLinksPaymentLinkRequestPaymentMethodCollection Function()?
    paymentMethodCollection,
    PostPaymentLinksPaymentLinkRequestPaymentMethodTypes Function()?
    paymentMethodTypes,
    PostPaymentLinksPaymentLinkRequestPhoneNumberCollection Function()?
    phoneNumberCollection,
    PostPaymentLinksPaymentLinkRequestRestrictions Function()? restrictions,
    PostPaymentLinksPaymentLinkRequestShippingAddressCollection Function()?
    shippingAddressCollection,
    PostPaymentLinksPaymentLinkRequestSubmitType Function()? submitType,
    PostPaymentLinksPaymentLinkRequestSubscriptionData Function()?
    subscriptionData,
    PostPaymentLinksPaymentLinkRequestTaxIdCollection Function()?
    taxIdCollection,
  }) {
    return PostPaymentLinksPaymentLinkRequest(
