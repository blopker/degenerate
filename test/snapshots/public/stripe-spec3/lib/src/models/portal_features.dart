...
final class PortalFeatures {
  ...
  factory PortalFeatures.fromJson(Map<String, dynamic> json) {
    return PortalFeatures(
      customerUpdate: PortalCustomerUpdate.fromJson(
        json['customer_update'] as Map<String, dynamic>,
      ),
      invoiceHistory: PortalInvoiceList.fromJson(
        json['invoice_history'] as Map<String, dynamic>,
      ),
      paymentMethodUpdate: PortalPaymentMethodUpdate.fromJson(
        json['payment_method_update'] as Map<String, dynamic>,
      ),
      subscriptionCancel: PortalSubscriptionCancel.fromJson(
        json['subscription_cancel'] as Map<String, dynamic>,
      ),
      subscriptionUpdate: PortalSubscriptionUpdate.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('customer_update') &&
  ...
  @override
  String toString() {
    return 'PortalFeatures(customerUpdate: $customerUpdate, invoiceHistory: $invoiceHistory, paymentMethodUpdate: $paymentMethodUpdate, subscriptionCancel: $subscriptionCancel, subscriptionUpdate: $subscriptionUpdate)';
  }
}
