...
import 'post_accounts_request_controller_fees_payer.dart';final class PostAccountsRequestControllerFees {const PostAccountsRequestControllerFees({this.payer});
