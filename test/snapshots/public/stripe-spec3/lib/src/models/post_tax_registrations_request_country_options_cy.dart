...
import 'post_tax_registrations_request_country_options_cy_standard.dart';import 'post_tax_registrations_request_country_options_cy_type.dart';final class PostTaxRegistrationsRequestCountryOptionsCy {const PostTaxRegistrationsRequestCountryOptionsCy({this.standard, required this.type, });
...
factory PostTaxRegistrationsRequestCountryOptionsCy.fromJson(Map<String, dynamic> json) { return PostTaxRegistrationsRequestCountryOptionsCy(
  standard: json['standard'] != null
        ? PostTaxRegistrationsRequestCountryOptionsCyStandard.fromJson(json['standard'] as Map<String, dynamic>)
        : null,
