...
final class SubscriptionsResourcePendingUpdate {
  ...
  factory SubscriptionsResourcePendingUpdate.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('expires_at') && json['expires_at'] is num;
  }

  SubscriptionsResourcePendingUpdate copyWith({
    int? Function()? billingCycleAnchor,
    int? expiresAt,
    List<SubscriptionItem>? Function()? subscriptionItems,
  ...
  int get hashCode {
    return Object.hash(
      billingCycleAnchor,
      expiresAt,
      Object.hashAll(subscriptionItems ?? const []),
      trialEnd,
      trialFromPlan,
    );
  }
  ...
  @override
  String toString() {
    return 'SubscriptionsResourcePendingUpdate(billingCycleAnchor: $billingCycleAnchor, expiresAt: $expiresAt, subscriptionItems: $subscriptionItems, trialEnd: $trialEnd, trialFromPlan: $trialFromPlan)';
  }
}
