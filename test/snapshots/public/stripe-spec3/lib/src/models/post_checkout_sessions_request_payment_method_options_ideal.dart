...
import 'post_checkout_sessions_request_payment_method_options_ideal_setup_future_usage.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsIdeal {const PostCheckoutSessionsRequestPaymentMethodOptionsIdeal({this.setupFutureUsage});
