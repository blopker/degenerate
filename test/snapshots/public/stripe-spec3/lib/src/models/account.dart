...
final class Account {
  ...
  factory Account.fromJson(Map<String, dynamic> json) {
    return Account(
      businessProfile: json['business_profile'] != null
          ? AccountBusinessProfile2.fromJson(
              json['business_profile'] as Map<String, dynamic>,
            )
          : null,
      businessType: json['business_type'] != null
          ? AccountBusinessType.fromJson(json['business_type'] as String)
          : null,
      ...
      company: json['company'] != null
          ? LegalEntityCompany.fromJson(json['company'] as Map<String, dynamic>)
          : null,
      ...
      externalAccounts: json['external_accounts'] != null
          ? AccountExternalAccounts.fromJson(
              json['external_accounts'] as Map<String, dynamic>,
            )
          : null,
      futureRequirements: json['future_requirements'] != null
          ? AccountFutureRequirements.fromJson(
              json['future_requirements'] as Map<String, dynamic>,
            )
          : null,
      groups: json['groups'] != null
          ? AccountGroups.fromJson(json['groups'] as Map<String, dynamic>)
          : null,
      id: json['id'] as String,
      individual: json['individual'] != null
          ? Person.fromJson(json['individual'] as Map<String, dynamic>)
          : null,
      ...
      settings: json['settings'] != null
          ? AccountSettings2.fromJson(json['settings'] as Map<String, dynamic>)
          : null,
      tosAcceptance: json['tos_acceptance'] != null
          ? AccountTosAcceptance.fromJson(
  ...
  Account copyWith({
    AccountBusinessProfile2? Function()? businessProfile,
    AccountBusinessType? Function()? businessType,
    AccountCapabilities Function()? capabilities,
    bool Function()? chargesEnabled,
    LegalEntityCompany Function()? company,
    AccountUnificationAccountController Function()? controller,
    String Function()? country,
    int Function()? created,
    String Function()? defaultCurrency,
    bool Function()? detailsSubmitted,
    String? Function()? email,
    AccountExternalAccounts Function()? externalAccounts,
    AccountFutureRequirements Function()? futureRequirements,
    AccountGroups? Function()? groups,
    String? id,
    Person Function()? individual,
    Map<String, String> Function()? metadata,
    AccountObject? object,
    bool Function()? payoutsEnabled,
    AccountRequirements Function()? requirements,
    AccountSettings2? Function()? settings,
    AccountTosAcceptance Function()? tosAcceptance,
    ...
    return Account(
      ...
      chargesEnabled: chargesEnabled != null
          ? chargesEnabled()
          : this.chargesEnabled,
      ...
      defaultCurrency: defaultCurrency != null
          ? defaultCurrency()
          : this.defaultCurrency,
      detailsSubmitted: detailsSubmitted != null
          ? detailsSubmitted()
          : this.detailsSubmitted,
      email: email != null ? email() : this.email,
      externalAccounts: externalAccounts != null
          ? externalAccounts()
          : this.externalAccounts,
      ...
      payoutsEnabled: payoutsEnabled != null
          ? payoutsEnabled()
          : this.payoutsEnabled,
