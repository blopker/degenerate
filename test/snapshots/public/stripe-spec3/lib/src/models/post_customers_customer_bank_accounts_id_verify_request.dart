...
import 'package:collection/collection.dart';final class PostCustomersCustomerBankAccountsIdVerifyRequest {const PostCustomersCustomerBankAccountsIdVerifyRequest({this.amounts, this.expand, });
