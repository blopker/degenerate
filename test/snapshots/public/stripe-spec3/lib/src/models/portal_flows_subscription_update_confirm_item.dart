...
///
final class PortalFlowsSubscriptionUpdateConfirmItem {
  const PortalFlowsSubscriptionUpdateConfirmItem({
    this.id,
    this.price,
    this.quantity,
  });

  factory PortalFlowsSubscriptionUpdateConfirmItem.fromJson(
  ...
  PortalFlowsSubscriptionUpdateConfirmItem copyWith({
    String? Function()? id,
  ...
  @override
  String toString() {
    return 'PortalFlowsSubscriptionUpdateConfirmItem(id: $id, price: $price, quantity: $quantity)';
  }
}
