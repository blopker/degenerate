...
import 'shipping_rate_delivery_estimate2.dart';
...
final class ShippingRate {
  ...
  factory ShippingRate.fromJson(Map<String, dynamic> json) {
    return ShippingRate(
      ...
      deliveryEstimate: json['delivery_estimate'] != null
          ? ShippingRateDeliveryEstimate2.fromJson(
      ...
      taxBehavior: json['tax_behavior'] != null
          ? ShippingRateTaxBehavior.fromJson(json['tax_behavior'] as String)
          : null,
      taxCode: json['tax_code'] != null
          ? ShippingRateTaxCode.fromJson(
  ...
  ShippingRate copyWith({
    bool? active,
    int? created,
    ShippingRateDeliveryEstimate2? Function()? deliveryEstimate,
    String? Function()? displayName,
    ShippingRateFixedAmount Function()? fixedAmount,
    String? id,
    bool? livemode,
    Map<String, String>? metadata,
    ShippingRateObject? object,
    ShippingRateTaxBehavior? Function()? taxBehavior,
    ShippingRateTaxCode? Function()? taxCode,
  ...
  @override
  String toString() {
    return 'ShippingRate(active: $active, created: $created, deliveryEstimate: $deliveryEstimate, displayName: $displayName, fixedAmount: $fixedAmount, id: $id, livemode: $livemode, metadata: $metadata, object: $object, taxBehavior: $taxBehavior, taxCode: $taxCode, type: $type)';
  }
}
