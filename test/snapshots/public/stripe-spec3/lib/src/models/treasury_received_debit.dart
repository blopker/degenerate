...
import 'treasury_received_debit_failure_code.dart';
import 'treasury_received_debit_network.dart';
import 'treasury_received_debit_object.dart';
import 'treasury_received_debit_reversal_details.dart';
import 'treasury_received_debit_status.dart';
import 'treasury_received_debit_transaction.dart';
...
final class TreasuryReceivedDebit {
  const TreasuryReceivedDebit({
  ...
  factory TreasuryReceivedDebit.fromJson(Map<String, dynamic> json) {
    return TreasuryReceivedDebit(
      ...
      failureCode: json['failure_code'] != null
          ? TreasuryReceivedDebitFailureCode.fromJson(
      ...
      reversalDetails: json['reversal_details'] != null
          ? TreasuryReceivedDebitReversalDetails.fromJson(
              json['reversal_details'] as Map<String, dynamic>,
            )
          : null,
      status: TreasuryReceivedDebitStatus.fromJson(json['status'] as String),
      transaction: json['transaction'] != null
          ? TreasuryReceivedDebitTransaction.fromJson(
  ...
  final TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails?
  initiatingPaymentMethodDetails;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (reversalDetails != null)
        'reversal_details': reversalDetails?.toJson(),
  ...
  TreasuryReceivedDebit copyWith({
    int? amount,
    int? created,
    String? currency,
    String? description,
    TreasuryReceivedDebitFailureCode? Function()? failureCode,
    ...
    bool? livemode,
    TreasuryReceivedDebitNetwork? network,
    TreasuryReceivedDebitObject? object,
    TreasuryReceivedDebitReversalDetails? Function()? reversalDetails,
    TreasuryReceivedDebitStatus? status,
    TreasuryReceivedDebitTransaction? Function()? transaction,
  }) {
    return TreasuryReceivedDebit(
      ...
      reversalDetails: reversalDetails != null
          ? reversalDetails()
          : this.reversalDetails,
