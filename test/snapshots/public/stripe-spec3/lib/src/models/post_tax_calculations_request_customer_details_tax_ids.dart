...
import 'post_tax_calculations_request_customer_details_tax_ids_type.dart';final class PostTaxCalculationsRequestCustomerDetailsTaxIds {const PostTaxCalculationsRequestCustomerDetailsTaxIds({required this.type, required this.value, });
