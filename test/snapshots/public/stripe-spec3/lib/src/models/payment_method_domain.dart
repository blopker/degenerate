...
final class PaymentMethodDomain {
  ...
  factory PaymentMethodDomain.fromJson(Map<String, dynamic> json) {
    return PaymentMethodDomain(
      amazonPay: PaymentMethodDomainResourcePaymentMethodStatus.fromJson(
      ...
      klarna: PaymentMethodDomainResourcePaymentMethodStatus.fromJson(
        json['klarna'] as Map<String, dynamic>,
      ),
      link: PaymentMethodDomainResourcePaymentMethodStatus.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amazon_pay') &&
        json.containsKey('apple_pay') &&
        json.containsKey('created') &&
        json['created'] is num &&
        json.containsKey('domain_name') &&
        json['domain_name'] is String &&
  ...
  @override
  String toString() {
    return 'PaymentMethodDomain(amazonPay: $amazonPay, applePay: $applePay, created: $created, domainName: $domainName, enabled: $enabled, googlePay: $googlePay, id: $id, klarna: $klarna, link: $link, livemode: $livemode, object: $object, paypal: $paypal)';
  }
}
