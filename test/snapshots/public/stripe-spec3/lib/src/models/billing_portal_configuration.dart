...
import 'billing_portal_configuration_application.dart';
import 'billing_portal_configuration_object.dart';
...
final class BillingPortalConfiguration {
  const BillingPortalConfiguration({
  ...
  factory BillingPortalConfiguration.fromJson(Map<String, dynamic> json) {
    return BillingPortalConfiguration(
      active: json['active'] as bool,
      application: json['application'] != null
          ? BillingPortalConfigurationApplication.fromJson(
              json['application'] as Map<String, dynamic>,
            )
          : null,
      businessProfile: PortalBusinessProfile.fromJson(
        json['business_profile'] as Map<String, dynamic>,
      ),
      created: (json['created'] as num).toInt(),
      defaultReturnUrl: json['default_return_url'] as String?,
      features: PortalFeatures.fromJson(
        json['features'] as Map<String, dynamic>,
      ),
      id: json['id'] as String,
      isDefault: json['is_default'] as bool,
      livemode: json['livemode'] as bool,
      loginPage: PortalLoginPage.fromJson(
      ...
      object: BillingPortalConfigurationObject.fromJson(
  ...
  BillingPortalConfiguration copyWith({
    bool? active,
    BillingPortalConfigurationApplication? Function()? application,
    PortalBusinessProfile? businessProfile,
    int? created,
    String? Function()? defaultReturnUrl,
    ...
    BillingPortalConfigurationObject? object,
    int? updated,
  }) {
    return BillingPortalConfiguration(
  ...
  @override
  String toString() {
    return 'BillingPortalConfiguration(active: $active, application: $application, businessProfile: $businessProfile, created: $created, defaultReturnUrl: $defaultReturnUrl, features: $features, id: $id, isDefault: $isDefault, livemode: $livemode, loginPage: $loginPage, metadata: $metadata, name: $name, object: $object, updated: $updated)';
  }
}
