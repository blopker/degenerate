...
final class TransferData {
  const TransferData({this.amount, required this.destination});

  factory TransferData.fromJson(Map<String, dynamic> json) {
    return TransferData(
      amount: json['amount'] != null ? (json['amount'] as num).toInt() : null,
      destination: TransferDataDestination.fromJson(
  ...
  @override
  String toString() {
    return 'TransferData(amount: $amount, destination: $destination)';
  }
}
