...
///
final class PersonFutureRequirements {
  ...
  factory PersonFutureRequirements.fromJson(Map<String, dynamic> json) {
  ...
  PersonFutureRequirements copyWith({
  ...
  @override
  String toString() {
    return 'PersonFutureRequirements(alternatives: $alternatives, currentlyDue: $currentlyDue, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
