...
import 'package:collection/collection.dart';import 'post_tax_rates_request_tax_type.dart';final class PostTaxRatesRequest {const PostTaxRatesRequest({this.active, this.country, this.description, required this.displayName, this.expand, required this.inclusive, this.jurisdiction, this.metadata, required this.percentage, this.state, this.taxType, });
