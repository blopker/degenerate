...
factory PostBalanceSettingsRequestPaymentsPayouts.fromJson(Map<String, dynamic> json) { return PostBalanceSettingsRequestPaymentsPayouts(
  minimumBalanceByCurrency: json['minimum_balance_by_currency'] != null
        ? PostBalanceSettingsRequestPaymentsPayoutsMinimumBalanceByCurrency.fromJson(json['minimum_balance_by_currency'] as Map<String, dynamic>)
        : null,
  schedule: json['schedule'] != null
        ? PostBalanceSettingsRequestPaymentsPayoutsSchedule.fromJson(json['schedule'] as Map<String, dynamic>)
        : null,
