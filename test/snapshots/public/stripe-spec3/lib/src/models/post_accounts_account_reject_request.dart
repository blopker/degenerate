...
import 'package:collection/collection.dart';final class PostAccountsAccountRejectRequest {const PostAccountsAccountRejectRequest({this.expand, required this.reason, });
