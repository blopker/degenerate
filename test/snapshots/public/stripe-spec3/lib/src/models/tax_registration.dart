...
import 'tax_registration_object.dart';
import 'tax_registration_status.dart';
...
final class TaxRegistration {
  ...
  @override
  String toString() {
    return 'TaxRegistration(activeFrom: $activeFrom, country: $country, countryOptions: $countryOptions, created: $created, expiresAt: $expiresAt, id: $id, livemode: $livemode, object: $object, status: $status)';
  }
}
