...
final class TreasuryFinancialAccountsResourceBalance {
  const TreasuryFinancialAccountsResourceBalance({
    required this.cash,
    required this.inboundPending,
    required this.outboundPending,
  });

  factory TreasuryFinancialAccountsResourceBalance.fromJson(
    ...
    return TreasuryFinancialAccountsResourceBalance(
      ...
      inboundPending: (json['inbound_pending'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, (v as num).toInt()),
      ),
      outboundPending: (json['outbound_pending'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, (v as num).toInt()),
      ),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('cash') &&
        json.containsKey('inbound_pending') &&
        json.containsKey('outbound_pending');
  }

  TreasuryFinancialAccountsResourceBalance copyWith({
    Map<String, int>? cash,
  ...
  @override
  int get hashCode {
    return Object.hash(cash, inboundPending, outboundPending);
  }

  @override
  String toString() {
    return 'TreasuryFinancialAccountsResourceBalance(cash: $cash, inboundPending: $inboundPending, outboundPending: $outboundPending)';
  }
}
