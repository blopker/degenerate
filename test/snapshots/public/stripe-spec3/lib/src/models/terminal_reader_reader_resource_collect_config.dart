...
final class TerminalReaderReaderResourceCollectConfig {
  const TerminalReaderReaderResourceCollectConfig({
    this.enableCustomerCancellation,
    this.skipTipping,
    this.tipping,
  });

  factory TerminalReaderReaderResourceCollectConfig.fromJson(
    ...
    return TerminalReaderReaderResourceCollectConfig(
      ...
      tipping: json['tipping'] != null
          ? TerminalReaderReaderResourceTippingConfig.fromJson(
  ...
  TerminalReaderReaderResourceCollectConfig copyWith({
    bool Function()? enableCustomerCancellation,
    bool Function()? skipTipping,
    TerminalReaderReaderResourceTippingConfig Function()? tipping,
  }) {
    return TerminalReaderReaderResourceCollectConfig(
  ...
  @override
  int get hashCode {
    return Object.hash(enableCustomerCancellation, skipTipping, tipping);
  }

  @override
  String toString() {
    return 'TerminalReaderReaderResourceCollectConfig(enableCustomerCancellation: $enableCustomerCancellation, skipTipping: $skipTipping, tipping: $tipping)';
  }
}
