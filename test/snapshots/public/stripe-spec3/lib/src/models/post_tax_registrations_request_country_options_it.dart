...
import 'post_tax_registrations_request_country_options_it_standard.dart';import 'post_tax_registrations_request_country_options_it_type.dart';final class PostTaxRegistrationsRequestCountryOptionsIt {const PostTaxRegistrationsRequestCountryOptionsIt({this.standard, required this.type, });
...
factory PostTaxRegistrationsRequestCountryOptionsIt.fromJson(Map<String, dynamic> json) { return PostTaxRegistrationsRequestCountryOptionsIt(
  standard: json['standard'] != null
        ? PostTaxRegistrationsRequestCountryOptionsItStandard.fromJson(json['standard'] as Map<String, dynamic>)
        : null,
