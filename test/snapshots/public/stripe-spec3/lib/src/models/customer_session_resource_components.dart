...
final class CustomerSessionResourceComponents {
  const CustomerSessionResourceComponents({
    required this.buyButton,
    required this.customerSheet,
    required this.mobilePaymentElement,
    required this.paymentElement,
    required this.pricingTable,
  });

  factory CustomerSessionResourceComponents.fromJson(
    ...
    return CustomerSessionResourceComponents(
      ...
      customerSheet:
          CustomerSessionResourceComponentsResourceCustomerSheet.fromJson(
            json['customer_sheet'] as Map<String, dynamic>,
          ),
      mobilePaymentElement:
          CustomerSessionResourceComponentsResourceMobilePaymentElement.fromJson(
            json['mobile_payment_element'] as Map<String, dynamic>,
          ),
      paymentElement:
          CustomerSessionResourceComponentsResourcePaymentElement.fromJson(
  ...
  final CustomerSessionResourceComponentsResourceMobilePaymentElement
  mobilePaymentElement;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('buy_button') &&
  ...
  CustomerSessionResourceComponents copyWith({
  ...
  @override
  String toString() {
    return 'CustomerSessionResourceComponents(buyButton: $buyButton, customerSheet: $customerSheet, mobilePaymentElement: $mobilePaymentElement, paymentElement: $paymentElement, pricingTable: $pricingTable)';
  }
}
