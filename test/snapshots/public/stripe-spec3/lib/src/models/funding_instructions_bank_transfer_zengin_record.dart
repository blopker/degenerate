...
final class FundingInstructionsBankTransferZenginRecord {
  ...
  factory FundingInstructionsBankTransferZenginRecord.fromJson(
  ...
  FundingInstructionsBankTransferZenginRecord copyWith({
  ...
  @override
  String toString() {
    return 'FundingInstructionsBankTransferZenginRecord(accountHolderAddress: $accountHolderAddress, accountHolderName: $accountHolderName, accountNumber: $accountNumber, accountType: $accountType, bankAddress: $bankAddress, bankCode: $bankCode, bankName: $bankName, branchCode: $branchCode, branchName: $branchName)';
  }
}
