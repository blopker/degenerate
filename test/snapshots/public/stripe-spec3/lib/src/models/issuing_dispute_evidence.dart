...
///
final class IssuingDisputeEvidence {
  ...
  factory IssuingDisputeEvidence.fromJson(Map<String, dynamic> json) {
    return IssuingDisputeEvidence(
      ...
      duplicate: json['duplicate'] != null
          ? IssuingDisputeDuplicateEvidence.fromJson(
              json['duplicate'] as Map<String, dynamic>,
            )
          : null,
      fraudulent: json['fraudulent'] != null
          ? IssuingDisputeFraudulentEvidence.fromJson(
      ...
      noValidAuthorization: json['no_valid_authorization'] != null
          ? IssuingDisputeNoValidAuthorizationEvidence.fromJson(
  ...
  final IssuingDisputeMerchandiseNotAsDescribedEvidence?
  ...
  IssuingDisputeEvidence copyWith({
    IssuingDisputeCanceledEvidence Function()? canceled,
    IssuingDisputeDuplicateEvidence Function()? duplicate,
    IssuingDisputeFraudulentEvidence Function()? fraudulent,
    IssuingDisputeMerchandiseNotAsDescribedEvidence Function()?
    merchandiseNotAsDescribed,
    IssuingDisputeNoValidAuthorizationEvidence Function()? noValidAuthorization,
    IssuingDisputeNotReceivedEvidence Function()? notReceived,
    IssuingDisputeOtherEvidence Function()? other,
    IssuingDisputeEvidenceReason? reason,
    IssuingDisputeServiceNotAsDescribedEvidence Function()?
  ...
  @override
  String toString() {
    return 'IssuingDisputeEvidence(canceled: $canceled, duplicate: $duplicate, fraudulent: $fraudulent, merchandiseNotAsDescribed: $merchandiseNotAsDescribed, noValidAuthorization: $noValidAuthorization, notReceived: $notReceived, other: $other, reason: $reason, serviceNotAsDescribed: $serviceNotAsDescribed)';
  }
}
