...
///
final class PaymentIntentNextActionKonbini {
  ...
  factory PaymentIntentNextActionKonbini.fromJson(Map<String, dynamic> json) {
    return PaymentIntentNextActionKonbini(
      expiresAt: (json['expires_at'] as num).toInt(),
      hostedVoucherUrl: json['hosted_voucher_url'] as String?,
      stores: PaymentIntentNextActionKonbiniStores.fromJson(
  ...
  PaymentIntentNextActionKonbini copyWith({
    int? expiresAt,
  ...
  @override
  int get hashCode {
    return Object.hash(expiresAt, hostedVoucherUrl, stores);
  }

  @override
  String toString() {
    return 'PaymentIntentNextActionKonbini(expiresAt: $expiresAt, hostedVoucherUrl: $hostedVoucherUrl, stores: $stores)';
  }
}
