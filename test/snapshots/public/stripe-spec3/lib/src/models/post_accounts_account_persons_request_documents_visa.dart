...
import 'package:collection/collection.dart';import 'post_accounts_account_persons_request_documents_visa_files.dart';final class PostAccountsAccountPersonsRequestDocumentsVisa {const PostAccountsAccountPersonsRequestDocumentsVisa({this.files});
...
factory PostAccountsAccountPersonsRequestDocumentsVisa.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestDocumentsVisa(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPersonsRequestDocumentsVisaFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
