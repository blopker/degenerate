...
final class Card {
  ...
  factory Card.fromJson(Map<String, dynamic> json) {
    return Card(
      ...
      allowRedisplay: json['allow_redisplay'] != null
          ? CardAllowRedisplay.fromJson(json['allow_redisplay'] as String)
          : null,
      availablePayoutMethods:
          (json['available_payout_methods'] as List<dynamic>?)
              ?.map((e) => CardAvailablePayoutMethods.fromJson(e as String))
              .toList(),
      ...
      regulatedStatus: json['regulated_status'] != null
          ? CardRegulatedStatus.fromJson(json['regulated_status'] as String)
          : null,
  ...
  Card copyWith({
    CardAccount? Function()? account,
    String? Function()? addressCity,
    String? Function()? addressCountry,
    String? Function()? addressLine1,
    String? Function()? addressLine1Check,
    String? Function()? addressLine2,
    String? Function()? addressState,
    String? Function()? addressZip,
    String? Function()? addressZipCheck,
    CardAllowRedisplay? Function()? allowRedisplay,
    List<CardAvailablePayoutMethods>? Function()? availablePayoutMethods,
    String? brand,
    String? Function()? country,
    String? Function()? currency,
    CardCustomer? Function()? customer,
    String? Function()? cvcCheck,
    bool? Function()? defaultForCurrency,
    String? Function()? dynamicLast4,
    int? expMonth,
    int? expYear,
    ...
    TokenCardNetworks Function()? networks,
    CardObject? object,
    CardRegulatedStatus? Function()? regulatedStatus,
    String? Function()? status,
    String? Function()? tokenizationMethod,
  }) {
    return Card(
      ...
      addressZipCheck: addressZipCheck != null
          ? addressZipCheck()
          : this.addressZipCheck,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      addressZipCheck,
      allowRedisplay,
      Object.hashAll(availablePayoutMethods ?? const []),
      brand,
      country,
      currency,
      customer,
