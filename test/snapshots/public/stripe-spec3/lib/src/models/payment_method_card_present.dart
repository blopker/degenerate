...
import 'payment_method_card_present_networks2.dart';
import 'payment_method_card_present_offline.dart';
import 'payment_method_card_present_read_method.dart';

///
final class PaymentMethodCardPresent {
  ...
  factory PaymentMethodCardPresent.fromJson(Map<String, dynamic> json) {
    return PaymentMethodCardPresent(
      ...
      networks: json['networks'] != null
          ? PaymentMethodCardPresentNetworks2.fromJson(
              json['networks'] as Map<String, dynamic>,
            )
          : null,
      offline: json['offline'] != null
          ? PaymentMethodCardPresentOffline.fromJson(
  ...
  PaymentMethodCardPresent copyWith({
    ...
    PaymentMethodCardPresentNetworks2? Function()? networks,
    PaymentMethodCardPresentOffline? Function()? offline,
    List<String>? Function()? preferredLocales,
    PaymentMethodCardPresentReadMethod? Function()? readMethod,
