...
import 'post_subscriptions_request_add_invoice_items_price_data_tax_behavior.dart';final class PostSubscriptionsRequestAddInvoiceItemsPriceData {const PostSubscriptionsRequestAddInvoiceItemsPriceData({required this.currency, required this.product, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
