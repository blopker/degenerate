...
final class InlineObject1519EnterpriseEapTls {
  const InlineObject1519EnterpriseEapTls({
  ...
  factory InlineObject1519EnterpriseEapTls.fromJson(Map<String, dynamic> json) {
    return InlineObject1519EnterpriseEapTls(
  ...
  InlineObject1519EnterpriseEapTls copyWith({
  ...
  @override
  String toString() {
    return 'InlineObject1519EnterpriseEapTls(caCertificateFile: $caCertificateFile, clientCertificateFile: $clientCertificateFile, privateKeyFile: $privateKeyFile, privateKeyFilePassword: $privateKeyFilePassword, ssid: $ssid)';
  }
}
