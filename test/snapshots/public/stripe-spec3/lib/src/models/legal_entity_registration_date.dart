...
///
final class LegalEntityRegistrationDate {
  const LegalEntityRegistrationDate({this.day, this.month, this.year});

  factory LegalEntityRegistrationDate.fromJson(Map<String, dynamic> json) {
  ...
  LegalEntityRegistrationDate copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'LegalEntityRegistrationDate(day: $day, month: $month, year: $year)';
  }
}
