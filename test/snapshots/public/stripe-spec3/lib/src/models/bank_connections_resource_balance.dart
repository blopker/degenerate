...
import 'resource_cash_balance.dart';
import 'resource_credit_balance.dart';

///
final class BankConnectionsResourceBalance {
  const BankConnectionsResourceBalance({
    required this.asOf,
    this.cash,
    this.credit,
  ...
  factory BankConnectionsResourceBalance.fromJson(Map<String, dynamic> json) {
    return BankConnectionsResourceBalance(
      ...
      credit: json['credit'] != null
          ? ResourceCreditBalance.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('as_of') &&
        json['as_of'] is num &&
        json.containsKey('current') &&
        json.containsKey('type');
  }

  BankConnectionsResourceBalance copyWith({
    int? asOf,
    ResourceCashBalance Function()? cash,
    ResourceCreditBalance Function()? credit,
    Map<String, int>? current,
    BankConnectionsResourceBalanceType? type,
  }) {
    return BankConnectionsResourceBalance(
      asOf: asOf ?? this.asOf,
  ...
  @override
  int get hashCode {
    return Object.hash(asOf, cash, credit, current, type);
  }

  @override
  String toString() {
    return 'BankConnectionsResourceBalance(asOf: $asOf, cash: $cash, credit: $credit, current: $current, type: $type)';
  }
}
