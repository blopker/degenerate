...
final class SetupAttemptPaymentMethodDetails {
  ...
  factory SetupAttemptPaymentMethodDetails.fromJson(Map<String, dynamic> json) {
    return SetupAttemptPaymentMethodDetails(
      ...
      amazonPay: json['amazon_pay'] != null
          ? SetupAttemptPaymentMethodDetailsAmazonPay.fromJson(
      ...
      boleto: json['boleto'] != null
          ? SetupAttemptPaymentMethodDetailsBoleto.fromJson(
      ...
      sofort: json['sofort'] != null
          ? SetupAttemptPaymentMethodDetailsSofort.fromJson(
  ...
  SetupAttemptPaymentMethodDetails copyWith({
    SetupAttemptPaymentMethodDetailsAcssDebit Function()? acssDebit,
    SetupAttemptPaymentMethodDetailsAmazonPay Function()? amazonPay,
    SetupAttemptPaymentMethodDetailsAuBecsDebit Function()? auBecsDebit,
    SetupAttemptPaymentMethodDetailsBacsDebit Function()? bacsDebit,
    SetupAttemptPaymentMethodDetailsBancontact Function()? bancontact,
    SetupAttemptPaymentMethodDetailsBoleto Function()? boleto,
    SetupAttemptPaymentMethodDetailsCard Function()? card,
    SetupAttemptPaymentMethodDetailsCardPresent Function()? cardPresent,
    SetupAttemptPaymentMethodDetailsCashapp Function()? cashapp,
    SetupAttemptPaymentMethodDetailsIdeal Function()? ideal,
    SetupAttemptPaymentMethodDetailsKakaoPay Function()? kakaoPay,
    SetupAttemptPaymentMethodDetailsKlarna Function()? klarna,
    SetupAttemptPaymentMethodDetailsKrCard Function()? krCard,
    SetupAttemptPaymentMethodDetailsLink Function()? link,
    SetupAttemptPaymentMethodDetailsNaverPay Function()? naverPay,
    SetupAttemptPaymentMethodDetailsNzBankAccount Function()? nzBankAccount,
    SetupAttemptPaymentMethodDetailsPaypal Function()? paypal,
    SetupAttemptPaymentMethodDetailsPayto Function()? payto,
    SetupAttemptPaymentMethodDetailsRevolutPay Function()? revolutPay,
    SetupAttemptPaymentMethodDetailsSepaDebit Function()? sepaDebit,
    SetupAttemptPaymentMethodDetailsSofort Function()? sofort,
    String? type,
    SetupAttemptPaymentMethodDetailsUsBankAccount Function()? usBankAccount,
  }) {
    return SetupAttemptPaymentMethodDetails(
