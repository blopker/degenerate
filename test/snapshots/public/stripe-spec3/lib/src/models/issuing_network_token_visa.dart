...
///
final class IssuingNetworkTokenVisa {
  const IssuingNetworkTokenVisa({
  ...
  factory IssuingNetworkTokenVisa.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('card_reference_id') &&
        json['card_reference_id'] is String &&
        json.containsKey('token_reference_id') &&
        json['token_reference_id'] is String &&
        json.containsKey('token_requestor_id') &&
        json['token_requestor_id'] is String;
  }

  IssuingNetworkTokenVisa copyWith({
    String? cardReferenceId,
    String? tokenReferenceId,
    String? tokenRequestorId,
    String Function()? tokenRiskScore,
  }) {
    return IssuingNetworkTokenVisa(
      ...
      tokenRiskScore: tokenRiskScore != null
          ? tokenRiskScore()
          : this.tokenRiskScore,
    );
  }
  ...
  @override
  String toString() {
    return 'IssuingNetworkTokenVisa(cardReferenceId: $cardReferenceId, tokenReferenceId: $tokenReferenceId, tokenRequestorId: $tokenRequestorId, tokenRiskScore: $tokenRiskScore)';
  }
}
