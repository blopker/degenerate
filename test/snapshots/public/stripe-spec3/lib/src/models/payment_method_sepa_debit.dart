...
///
final class PaymentMethodSepaDebit {
  ...
  factory PaymentMethodSepaDebit.fromJson(Map<String, dynamic> json) {
    return PaymentMethodSepaDebit(
      ...
      generatedFrom: json['generated_from'] != null
          ? PaymentMethodSepaDebitGeneratedFrom.fromJson(
  ...
  @override
  String toString() {
    return 'PaymentMethodSepaDebit(bankCode: $bankCode, branchCode: $branchCode, country: $country, fingerprint: $fingerprint, generatedFrom: $generatedFrom, last4: $last4)';
  }
}
