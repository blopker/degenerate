...
import 'subscription_schedule_current_phase2.dart';
...
final class SubscriptionSchedule {
  ...
  factory SubscriptionSchedule.fromJson(Map<String, dynamic> json) {
    return SubscriptionSchedule(
      application: json['application'] != null
          ? SubscriptionScheduleApplication.fromJson(
      ...
      currentPhase: json['current_phase'] != null
          ? SubscriptionScheduleCurrentPhase2.fromJson(
              json['current_phase'] as Map<String, dynamic>,
            )
          : null,
      customer: SubscriptionScheduleCustomer.fromJson(
      ...
      endBehavior: SubscriptionScheduleEndBehavior.fromJson(
      ...
      phases: (json['phases'] as List<dynamic>)
          .map(
            (e) => SubscriptionSchedulePhaseConfiguration.fromJson(
      ...
      subscription: json['subscription'] != null
          ? SubscriptionScheduleSubscription.fromJson(
              json['subscription'] as Map<String, dynamic>,
            )
          : null,
      testClock: json['test_clock'] != null
          ? SubscriptionScheduleTestClock.fromJson(
  ...
  SubscriptionSchedule copyWith({
    SubscriptionScheduleApplication? Function()? application,
    SubscriptionsResourceBillingMode? billingMode,
    int? Function()? canceledAt,
    int? Function()? completedAt,
    int? created,
    SubscriptionScheduleCurrentPhase2? Function()? currentPhase,
    ...
    int? Function()? releasedAt,
    String? Function()? releasedSubscription,
    SubscriptionScheduleStatus? status,
    SubscriptionScheduleSubscription? Function()? subscription,
    SubscriptionScheduleTestClock? Function()? testClock,
  }) {
    return SubscriptionSchedule(
      ...
      releasedSubscription: releasedSubscription != null
