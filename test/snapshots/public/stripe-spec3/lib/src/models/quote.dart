...
import 'quote_default_tax_rates.dart';
import 'quote_discounts.dart';
import 'quote_from_quote.dart';
...
import 'quote_transfer_data.dart';
...
final class Quote {
  ...
  factory Quote.fromJson(Map<String, dynamic> json) {
    return Quote(
      ...
      applicationFeePercent: json['application_fee_percent'] != null
          ...
          : null,
      automaticTax: QuotesResourceAutomaticTax.fromJson(
        json['automatic_tax'] as Map<String, dynamic>,
      ),
      collectionMethod: QuoteCollectionMethod.fromJson(
        json['collection_method'] as String,
      ),
      computed: QuotesResourceComputed.fromJson(
      ...
      defaultTaxRates: (json['default_tax_rates'] as List<dynamic>?)
          ?.map((e) => QuoteDefaultTaxRates.fromJson(e as Map<String, dynamic>))
          .toList(),
      description: json['description'] as String?,
      discounts: (json['discounts'] as List<dynamic>)
          .map((e) => QuoteDiscounts.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      invoice: json['invoice'] != null
          ...
          : null,
      invoiceSettings: InvoiceSettingQuoteSetting.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (subscriptionSchedule != null)
        'subscription_schedule': subscriptionSchedule?.toJson(),
  ...
  Quote copyWith({
    int? amountSubtotal,
    int? amountTotal,
    QuoteApplication? Function()? application,
    ...
    QuoteCustomer? Function()? customer,
    String? Function()? customerAccount,
    List<QuoteDefaultTaxRates> Function()? defaultTaxRates,
    String? Function()? description,
    List<QuoteDiscounts>? discounts,
    int? expiresAt,
    String? Function()? footer,
    QuoteFromQuote? Function()? fromQuote,
    String? Function()? header,
    String? id,
    QuoteInvoice? Function()? invoice,
    InvoiceSettingQuoteSetting? invoiceSettings,
    QuoteLineItems Function()? lineItems,
    bool? livemode,
    Map<String, String>? metadata,
    String? Function()? number,
    QuoteObject? object,
    QuoteOnBehalfOf? Function()? onBehalfOf,
    QuoteStatus? status,
    QuotesResourceStatusTransitions? statusTransitions,
    QuoteSubscription? Function()? subscription,
    QuotesResourceSubscriptionDataSubscriptionData? subscriptionData,
    QuoteSubscriptionSchedule? Function()? subscriptionSchedule,
    QuoteTestClock? Function()? testClock,
    QuotesResourceTotalDetails? totalDetails,
    QuoteTransferData? Function()? transferData,
  }) {
    return Quote(
