...
import 'inline_object859_on_demand_purchase_interval.dart';final class InlineObject859OnDemand {const InlineObject859OnDemand({this.averageAmount, this.maximumAmount, this.minimumAmount, this.purchaseInterval, this.purchaseIntervalCount, });
