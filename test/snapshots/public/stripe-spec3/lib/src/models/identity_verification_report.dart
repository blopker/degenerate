...
import 'identity_verification_report_object.dart';
import 'identity_verification_report_type.dart';
...
final class IdentityVerificationReport {
  ...
  factory IdentityVerificationReport.fromJson(Map<String, dynamic> json) {
    return IdentityVerificationReport(
      ...
      idNumber: json['id_number'] != null
          ? GelatoIdNumberReport.fromJson(
              json['id_number'] as Map<String, dynamic>,
            )
          : null,
      livemode: json['livemode'] as bool,
      object: IdentityVerificationReportObject.fromJson(
  ...
  IdentityVerificationReport copyWith({
    String? Function()? clientReferenceId,
    int? created,
    GelatoDocumentReport Function()? document,
    GelatoEmailReport Function()? email,
    String? id,
    GelatoIdNumberReport Function()? idNumber,
    bool? livemode,
    IdentityVerificationReportObject? object,
    GelatoVerificationReportOptions Function()? options,
    GelatoPhoneReport Function()? phone,
    GelatoSelfieReport Function()? selfie,
    IdentityVerificationReportType? type,
    String Function()? verificationFlow,
    String? Function()? verificationSession,
  }) {
    return IdentityVerificationReport(
  ...
  @override
  String toString() {
    return 'IdentityVerificationReport(clientReferenceId: $clientReferenceId, created: $created, document: $document, email: $email, id: $id, idNumber: $idNumber, livemode: $livemode, object: $object, options: $options, phone: $phone, selfie: $selfie, type: $type, verificationFlow: $verificationFlow, verificationSession: $verificationSession)';
  }
}
