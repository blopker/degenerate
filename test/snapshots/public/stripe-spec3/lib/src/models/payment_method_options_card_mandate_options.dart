...
///
final class PaymentMethodOptionsCardMandateOptions {
  const PaymentMethodOptionsCardMandateOptions({
  ...
  factory PaymentMethodOptionsCardMandateOptions.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaymentMethodOptionsCardMandateOptions(
      amount: (json['amount'] as num).toInt(),
      amountType: PaymentMethodOptionsCardMandateOptionsAmountType.fromJson(
      ...
      endDate: json['end_date'] != null
          ...
          : null,
      interval: PaymentMethodOptionsCardMandateOptionsInterval.fromJson(
      ...
      supportedTypes: (json['supported_types'] as List<dynamic>?)
          ?.map(
            (e) =>
                PaymentMethodOptionsCardMandateOptionsSupportedTypes.fromJson(
                  e as String,
                ),
          )
          .toList(),
  ...
  final List<PaymentMethodOptionsCardMandateOptionsSupportedTypes>?
  supportedTypes;
  ...
  PaymentMethodOptionsCardMandateOptions copyWith({
    int? amount,
    ...
    String? reference,
    int? startDate,
    List<PaymentMethodOptionsCardMandateOptionsSupportedTypes>? Function()?
    supportedTypes,
  }) {
    return PaymentMethodOptionsCardMandateOptions(
  ...
  @override
  String toString() {
    return 'PaymentMethodOptionsCardMandateOptions(amount: $amount, amountType: $amountType, description: $description, endDate: $endDate, interval: $interval, intervalCount: $intervalCount, reference: $reference, startDate: $startDate, supportedTypes: $supportedTypes)';
  }
}
