...
import 'post_payment_intents_intent_capture_request_amount_details.dart';
import 'post_payment_intents_intent_capture_request_hooks.dart';
import 'post_payment_intents_intent_capture_request_metadata.dart';
import 'post_payment_intents_intent_capture_request_payment_details.dart';
import 'post_payment_intents_intent_capture_request_transfer_data.dart';

final class PostPaymentIntentsIntentCaptureRequest {
  const PostPaymentIntentsIntentCaptureRequest({
    this.amountDetails,
  ...
  factory PostPaymentIntentsIntentCaptureRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostPaymentIntentsIntentCaptureRequest(
      amountDetails: json['amount_details'] != null
          ? PostPaymentIntentsIntentCaptureRequestAmountDetails.fromJson(
              json['amount_details'] as Map<String, dynamic>,
            )
          : null,
      amountToCapture: json['amount_to_capture'] != null
          ? (json['amount_to_capture'] as num).toInt()
          : null,
      ...
      hooks: json['hooks'] != null
          ? PostPaymentIntentsIntentCaptureRequestHooks.fromJson(
              json['hooks'] as Map<String, dynamic>,
            )
          : null,
      metadata: json['metadata'] != null
          ? PostPaymentIntentsIntentCaptureRequestMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            )
          : null,
      paymentDetails: json['payment_details'] != null
          ? PostPaymentIntentsIntentCaptureRequestPaymentDetails.fromJson(
      ...
      transferData: json['transfer_data'] != null
          ? PostPaymentIntentsIntentCaptureRequestTransferData.fromJson(
  ...
  PostPaymentIntentsIntentCaptureRequest copyWith({
    PostPaymentIntentsIntentCaptureRequestAmountDetails Function()?
    amountDetails,
    int Function()? amountToCapture,
    int Function()? applicationFeeAmount,
    List<String> Function()? expand,
    bool Function()? finalCapture,
    PostPaymentIntentsIntentCaptureRequestHooks Function()? hooks,
    PostPaymentIntentsIntentCaptureRequestMetadata Function()? metadata,
    PostPaymentIntentsIntentCaptureRequestPaymentDetails Function()?
    paymentDetails,
    String Function()? statementDescriptor,
    String Function()? statementDescriptorSuffix,
    PostPaymentIntentsIntentCaptureRequestTransferData Function()? transferData,
  }) {
    return PostPaymentIntentsIntentCaptureRequest(
      amountDetails: amountDetails != null
          ? amountDetails()
          : this.amountDetails,
      amountToCapture: amountToCapture != null
          ? amountToCapture()
          : this.amountToCapture,
