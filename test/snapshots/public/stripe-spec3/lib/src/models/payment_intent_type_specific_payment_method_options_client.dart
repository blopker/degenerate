...
///
final class PaymentIntentTypeSpecificPaymentMethodOptionsClient {
  const PaymentIntentTypeSpecificPaymentMethodOptionsClient({
    this.captureMethod,
    this.installments,
    this.mandateOptions,
  ...
  factory PaymentIntentTypeSpecificPaymentMethodOptionsClient.fromJson(
    ...
    return PaymentIntentTypeSpecificPaymentMethodOptionsClient(
      ...
      installments: json['installments'] != null
          ? PaymentFlowsInstallmentOptions.fromJson(
              json['installments'] as Map<String, dynamic>,
            )
          : null,
      mandateOptions: json['mandate_options'] != null
          ? PaymentIntentPaymentMethodOptionsMandateOptionsPayto.fromJson(
      ...
      routing: json['routing'] != null
          ? PaymentMethodOptionsCardPresentRouting.fromJson(
              json['routing'] as Map<String, dynamic>,
            )
          : null,
      setupFutureUsage: json['setup_future_usage'] != null
          ? PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage.fromJson(
              json['setup_future_usage'] as String,
            )
          : null,
      verificationMethod: json['verification_method'] != null
          ? PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod.fromJson(
  ...
  final PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod?
  captureMethod;
  ...
  final PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage?
  setupFutureUsage;

  /// Bank account verification method.
  final PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod?
  verificationMethod;
  ...
  PaymentIntentTypeSpecificPaymentMethodOptionsClient copyWith({
    PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod Function()?
    captureMethod,
    PaymentFlowsInstallmentOptions Function()? installments,
    PaymentIntentPaymentMethodOptionsMandateOptionsPayto Function()?
    mandateOptions,
    bool Function()? requestIncrementalAuthorizationSupport,
    bool Function()? requireCvcRecollection,
    PaymentMethodOptionsCardPresentRouting Function()? routing,
  ...
  @override
  String toString() {
    return 'PaymentIntentTypeSpecificPaymentMethodOptionsClient(captureMethod: $captureMethod, installments: $installments, mandateOptions: $mandateOptions, requestIncrementalAuthorizationSupport: $requestIncrementalAuthorizationSupport, requireCvcRecollection: $requireCvcRecollection, routing: $routing, setupFutureUsage: $setupFutureUsage, verificationMethod: $verificationMethod)';
  }
}
