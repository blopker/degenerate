...
import 'post_accounts_account_persons_person_request_additional_tos_acceptances.dart';
import 'post_accounts_account_persons_person_request_address.dart';
import 'post_accounts_account_persons_person_request_address_kana.dart';
import 'post_accounts_account_persons_person_request_address_kanji.dart';
import 'post_accounts_account_persons_person_request_dob.dart';
import 'post_accounts_account_persons_person_request_documents.dart';
import 'post_accounts_account_persons_person_request_full_name_aliases.dart';
import 'post_accounts_account_persons_person_request_metadata.dart';
import 'post_accounts_account_persons_person_request_political_exposure.dart';
import 'post_accounts_account_persons_person_request_registered_address.dart';
import 'post_accounts_account_persons_person_request_relationship.dart';
import 'post_accounts_account_persons_person_request_us_cfpb_data.dart';
import 'post_accounts_account_persons_person_request_verification.dart';

final class PostAccountsAccountPersonsPersonRequest {
  const PostAccountsAccountPersonsPersonRequest({
  ...
  factory PostAccountsAccountPersonsPersonRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostAccountsAccountPersonsPersonRequest(
      additionalTosAcceptances: json['additional_tos_acceptances'] != null
          ? PostAccountsAccountPersonsPersonRequestAdditionalTosAcceptances.fromJson(
              json['additional_tos_acceptances'] as Map<String, dynamic>,
            )
          : null,
      address: json['address'] != null
          ? PostAccountsAccountPersonsPersonRequestAddress.fromJson(
              json['address'] as Map<String, dynamic>,
            )
          : null,
      addressKana: json['address_kana'] != null
          ? PostAccountsAccountPersonsPersonRequestAddressKana.fromJson(
              json['address_kana'] as Map<String, dynamic>,
            )
          : null,
      addressKanji: json['address_kanji'] != null
          ? PostAccountsAccountPersonsPersonRequestAddressKanji.fromJson(
              json['address_kanji'] as Map<String, dynamic>,
            )
          : null,
      dob: json['dob'] != null
          ? PostAccountsAccountPersonsPersonRequestDob.fromJson(
              json['dob'] as Map<String, dynamic>,
            )
          : null,
      documents: json['documents'] != null
          ? PostAccountsAccountPersonsPersonRequestDocuments.fromJson(
      ...
      fullNameAliases: json['full_name_aliases'] != null
          ? PostAccountsAccountPersonsPersonRequestFullNameAliases.fromJson(
      ...
      metadata: json['metadata'] != null
          ? PostAccountsAccountPersonsPersonRequestMetadata.fromJson(
      ...
      politicalExposure: json['political_exposure'] != null
          ? PostAccountsAccountPersonsPersonRequestPoliticalExposure.fromJson(
              json['political_exposure'] as String,
            )
          : null,
      registeredAddress: json['registered_address'] != null
          ? PostAccountsAccountPersonsPersonRequestRegisteredAddress.fromJson(
              json['registered_address'] as Map<String, dynamic>,
            )
          : null,
      relationship: json['relationship'] != null
          ? PostAccountsAccountPersonsPersonRequestRelationship.fromJson(
              json['relationship'] as Map<String, dynamic>,
            )
          : null,
      ssnLast4: json['ssn_last_4'] as String?,
      usCfpbData: json['us_cfpb_data'] != null
          ? PostAccountsAccountPersonsPersonRequestUsCfpbData.fromJson(
              json['us_cfpb_data'] as Map<String, dynamic>,
            )
          : null,
      verification: json['verification'] != null
          ? PostAccountsAccountPersonsPersonRequestVerification.fromJson(
  ...
  final PostAccountsAccountPersonsPersonRequestAdditionalTosAcceptances?
  ...
  final PostAccountsAccountPersonsPersonRequestPoliticalExposure?
  politicalExposure;

  /// The person's registered address.
  final PostAccountsAccountPersonsPersonRequestRegisteredAddress?
  registeredAddress;
  ...
  PostAccountsAccountPersonsPersonRequest copyWith({
    PostAccountsAccountPersonsPersonRequestAdditionalTosAcceptances Function()?
    additionalTosAcceptances,
    PostAccountsAccountPersonsPersonRequestAddress Function()? address,
    PostAccountsAccountPersonsPersonRequestAddressKana Function()? addressKana,
    PostAccountsAccountPersonsPersonRequestAddressKanji Function()?
    addressKanji,
    PostAccountsAccountPersonsPersonRequestDob Function()? dob,
    PostAccountsAccountPersonsPersonRequestDocuments Function()? documents,
    String Function()? email,
    List<String> Function()? expand,
    String Function()? firstName,
    String Function()? firstNameKana,
    String Function()? firstNameKanji,
    PostAccountsAccountPersonsPersonRequestFullNameAliases Function()?
    fullNameAliases,
    ...
    PostAccountsAccountPersonsPersonRequestMetadata Function()? metadata,
    String Function()? nationality,
    String Function()? personToken,
    String Function()? phone,
    PostAccountsAccountPersonsPersonRequestPoliticalExposure Function()?
    politicalExposure,
    PostAccountsAccountPersonsPersonRequestRegisteredAddress Function()?
    registeredAddress,
    PostAccountsAccountPersonsPersonRequestRelationship Function()?
    relationship,
    String Function()? ssnLast4,
    PostAccountsAccountPersonsPersonRequestUsCfpbData Function()? usCfpbData,
    PostAccountsAccountPersonsPersonRequestVerification Function()?
    verification,
  }) {
    return PostAccountsAccountPersonsPersonRequest(
