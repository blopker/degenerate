...
/// Point in Time
final class GelatoDataDocumentReportDateOfBirth {
  const GelatoDataDocumentReportDateOfBirth({this.day, this.month, this.year});

  factory GelatoDataDocumentReportDateOfBirth.fromJson(
  ...
  GelatoDataDocumentReportDateOfBirth copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'GelatoDataDocumentReportDateOfBirth(day: $day, month: $month, year: $year)';
  }
}
