...
import 'terminal_reader_reader_resource_line_item.dart';

/// Represents a cart to be displayed on the reader
final class TerminalReaderReaderResourceCart {
  const TerminalReaderReaderResourceCart({
  ...
  factory TerminalReaderReaderResourceCart.fromJson(Map<String, dynamic> json) {
    return TerminalReaderReaderResourceCart(
      currency: json['currency'] as String,
      lineItems: (json['line_items'] as List<dynamic>)
          .map(
            (e) => TerminalReaderReaderResourceLineItem.fromJson(
  ...
  TerminalReaderReaderResourceCart copyWith({
    String? currency,
  ...
  @override
  String toString() {
    return 'TerminalReaderReaderResourceCart(currency: $currency, lineItems: $lineItems, tax: $tax, total: $total)';
  }
}
