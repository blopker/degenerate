...
import 'package:collection/collection.dart';final class DeleteCustomersCustomerBankAccountsIdRequest {const DeleteCustomersCustomerBankAccountsIdRequest({this.expand});
