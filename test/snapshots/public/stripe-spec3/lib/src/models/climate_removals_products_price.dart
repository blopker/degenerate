...
///
final class ClimateRemovalsProductsPrice {
  const ClimateRemovalsProductsPrice({
    required this.amountFees,
    required this.amountSubtotal,
    required this.amountTotal,
  });

  factory ClimateRemovalsProductsPrice.fromJson(Map<String, dynamic> json) {
  ...
  ClimateRemovalsProductsPrice copyWith({
    int? amountFees,
    int? amountSubtotal,
    int? amountTotal,
  }) {
  ...
  @override
  int get hashCode {
    return Object.hash(amountFees, amountSubtotal, amountTotal);
  }

  @override
  String toString() {
    return 'ClimateRemovalsProductsPrice(amountFees: $amountFees, amountSubtotal: $amountSubtotal, amountTotal: $amountTotal)';
  }
}
