...
///
final class PaymentFlowsPrivatePaymentMethodsKlarnaDob {
  const PaymentFlowsPrivatePaymentMethodsKlarnaDob({
    this.day,
    this.month,
    this.year,
  });

  factory PaymentFlowsPrivatePaymentMethodsKlarnaDob.fromJson(
  ...
  PaymentFlowsPrivatePaymentMethodsKlarnaDob copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'PaymentFlowsPrivatePaymentMethodsKlarnaDob(day: $day, month: $month, year: $year)';
  }
}
