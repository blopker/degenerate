...
///
final class InvoicePaymentMethodOptionsCard {
  const InvoicePaymentMethodOptionsCard({
    this.installments,
    this.requestThreeDSecure,
  });

  factory InvoicePaymentMethodOptionsCard.fromJson(Map<String, dynamic> json) {
    return InvoicePaymentMethodOptionsCard(
      installments: json['installments'] != null
          ? InvoiceInstallmentsCard.fromJson(
  ...
  InvoicePaymentMethodOptionsCard copyWith({
    InvoiceInstallmentsCard Function()? installments,
    InvoicePaymentMethodOptionsCardRequestThreeDSecure? Function()?
    requestThreeDSecure,
  }) {
    return InvoicePaymentMethodOptionsCard(
  ...
  @override
  String toString() {
    return 'InvoicePaymentMethodOptionsCard(installments: $installments, requestThreeDSecure: $requestThreeDSecure)';
  }
}
