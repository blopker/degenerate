...
///
final class PaymentIntentNextActionWechatPayDisplayQrCode {
  ...
  factory PaymentIntentNextActionWechatPayDisplayQrCode.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('data') &&
        json['data'] is String &&
        json.containsKey('hosted_instructions_url') &&
        json['hosted_instructions_url'] is String &&
        json.containsKey('image_data_url') &&
        json['image_data_url'] is String &&
        json.containsKey('image_url_png') &&
        json['image_url_png'] is String &&
        json.containsKey('image_url_svg') &&
        json['image_url_svg'] is String;
  }

  PaymentIntentNextActionWechatPayDisplayQrCode copyWith({
    String? data,
    ...
    return PaymentIntentNextActionWechatPayDisplayQrCode(
      ...
      hostedInstructionsUrl:
          hostedInstructionsUrl ?? this.hostedInstructionsUrl,
  ...
  @override
  String toString() {
    return 'PaymentIntentNextActionWechatPayDisplayQrCode(data: $data, hostedInstructionsUrl: $hostedInstructionsUrl, imageDataUrl: $imageDataUrl, imageUrlPng: $imageUrlPng, imageUrlSvg: $imageUrlSvg)';
  }
}
