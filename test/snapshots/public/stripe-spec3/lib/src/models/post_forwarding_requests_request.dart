...
import 'package:collection/collection.dart';import 'post_forwarding_requests_request_replacements.dart';import 'post_forwarding_requests_request_request.dart';final class PostForwardingRequestsRequest {const PostForwardingRequestsRequest({this.expand, this.metadata, required this.paymentMethod, required this.replacements, this.request, required this.url, });
