...
///
final class TreasuryReceivedCreditsResourceLinkedFlows {
  const TreasuryReceivedCreditsResourceLinkedFlows({
    this.creditReversal,
  ...
  factory TreasuryReceivedCreditsResourceLinkedFlows.fromJson(
    ...
    return TreasuryReceivedCreditsResourceLinkedFlows(
      ...
      sourceFlowDetails: json['source_flow_details'] != null
          ? TreasuryReceivedCreditsResourceLinkedFlowsSourceFlowDetails.fromJson(
              json['source_flow_details'] as Map<String, dynamic>,
            )
          : null,
  ...
  final TreasuryReceivedCreditsResourceLinkedFlowsSourceFlowDetails?
  sourceFlowDetails;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (sourceFlowDetails != null)
        'source_flow_details': sourceFlowDetails?.toJson(),
  ...
  TreasuryReceivedCreditsResourceLinkedFlows copyWith({
    String? Function()? creditReversal,
    String? Function()? issuingAuthorization,
    String? Function()? issuingTransaction,
    String? Function()? sourceFlow,
    TreasuryReceivedCreditsResourceLinkedFlowsSourceFlowDetails? Function()?
    sourceFlowDetails,
    String? Function()? sourceFlowType,
  }) {
    return TreasuryReceivedCreditsResourceLinkedFlows(
      ...
      sourceFlowDetails: sourceFlowDetails != null
          ? sourceFlowDetails()
          : this.sourceFlowDetails,
  ...
  @override
  String toString() {
    return 'TreasuryReceivedCreditsResourceLinkedFlows(creditReversal: $creditReversal, issuingAuthorization: $issuingAuthorization, issuingTransaction: $issuingTransaction, sourceFlow: $sourceFlow, sourceFlowDetails: $sourceFlowDetails, sourceFlowType: $sourceFlowType)';
  }
}
