...
///
final class AccountCardIssuingSettings {
  const AccountCardIssuingSettings({this.tosAcceptance});

  factory AccountCardIssuingSettings.fromJson(Map<String, dynamic> json) {
  ...
  AccountCardIssuingSettings copyWith({
    CardIssuingAccountTermsOfService Function()? tosAcceptance,
  }) {
    return AccountCardIssuingSettings(
  ...
  @override
  String toString() {
    return 'AccountCardIssuingSettings(tosAcceptance: $tosAcceptance)';
  }
}
