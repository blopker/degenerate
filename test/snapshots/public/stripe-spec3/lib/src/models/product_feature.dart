...
final class ProductFeature {
  ...
  factory ProductFeature.fromJson(Map<String, dynamic> json) {
    return ProductFeature(
      entitlementFeature: EntitlementsFeature.fromJson(
        json['entitlement_feature'] as Map<String, dynamic>,
      ),
  ...
  @override
  int get hashCode {
    return Object.hash(entitlementFeature, id, livemode, object);
  }

  @override
  String toString() {
    return 'ProductFeature(entitlementFeature: $entitlementFeature, id: $id, livemode: $livemode, object: $object)';
  }
}
