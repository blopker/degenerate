...
import 'billing_meter_event_time_window.dart';
import 'billing_meter_object.dart';
...
import 'billing_meter_status.dart';

/// Meters specify how to aggregate meter events over a billing period. Meter events represent the actions that customers take in your system. Meters attach to prices and form the basis of the bill.
///
/// Related guide: [Usage based billing](https://docs.stripe.com/billing/subscriptions/usage-based)
final class BillingMeter {
  const BillingMeter({
  ...
  factory BillingMeter.fromJson(Map<String, dynamic> json) {
    return BillingMeter(
      ...
      eventTimeWindow: json['event_time_window'] != null
          ? BillingMeterEventTimeWindow.fromJson(
      ...
      valueSettings: BillingMeterResourceBillingMeterValue.fromJson(
  ...
  @override
  String toString() {
    return 'BillingMeter(created: $created, customerMapping: $customerMapping, defaultAggregation: $defaultAggregation, displayName: $displayName, eventName: $eventName, eventTimeWindow: $eventTimeWindow, id: $id, livemode: $livemode, object: $object, status: $status, statusTransitions: $statusTransitions, updated: $updated, valueSettings: $valueSettings)';
  }
}
