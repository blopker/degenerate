...
import 'post_sources_request_flow.dart';
import 'post_sources_request_mandate.dart';
import 'post_sources_request_owner.dart';
import 'post_sources_request_receiver.dart';
import 'post_sources_request_redirect.dart';
import 'post_sources_request_source_order.dart';
import 'post_sources_request_usage.dart';

final class PostSourcesRequest {
  const PostSourcesRequest({
    this.amount,
    this.currency,
    this.customer,
    this.expand,
  ...
  factory PostSourcesRequest.fromJson(Map<String, dynamic> json) {
    return PostSourcesRequest(
      ...
      expand: (json['expand'] as List<dynamic>?)
          ...
          .toList(),
      flow: json['flow'] != null
          ? PostSourcesRequestFlow.fromJson(json['flow'] as String)
          : null,
      mandate: json['mandate'] != null
          ? PostSourcesRequestMandate.fromJson(
      ...
      owner: json['owner'] != null
          ? PostSourcesRequestOwner.fromJson(
              json['owner'] as Map<String, dynamic>,
            )
          : null,
      receiver: json['receiver'] != null
          ? PostSourcesRequestReceiver.fromJson(
              json['receiver'] as Map<String, dynamic>,
            )
          : null,
      redirect: json['redirect'] != null
          ? PostSourcesRequestRedirect.fromJson(
              json['redirect'] as Map<String, dynamic>,
            )
          : null,
      sourceOrder: json['source_order'] != null
          ? PostSourcesRequestSourceOrder.fromJson(
              json['source_order'] as Map<String, dynamic>,
            )
          : null,
      ...
      usage: json['usage'] != null
          ? PostSourcesRequestUsage.fromJson(json['usage'] as String)
          : null,
    );
  }
  ...
  PostSourcesRequest copyWith({
    int Function()? amount,
    String Function()? currency,
    String Function()? customer,
    List<String> Function()? expand,
    PostSourcesRequestFlow Function()? flow,
    PostSourcesRequestMandate Function()? mandate,
    Map<String, String> Function()? metadata,
    String Function()? originalSource,
    PostSourcesRequestOwner Function()? owner,
    PostSourcesRequestReceiver Function()? receiver,
    PostSourcesRequestRedirect Function()? redirect,
    PostSourcesRequestSourceOrder Function()? sourceOrder,
    String Function()? statementDescriptor,
    String Function()? token,
    String Function()? type,
    PostSourcesRequestUsage Function()? usage,
  }) {
    return PostSourcesRequest(
