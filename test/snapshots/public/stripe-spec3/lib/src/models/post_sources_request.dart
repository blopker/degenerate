...
import 'package:collection/collection.dart';import 'post_sources_request_flow.dart';import 'post_sources_request_mandate.dart';import 'post_sources_request_owner.dart';import 'post_sources_request_receiver.dart';import 'post_sources_request_redirect.dart';import 'post_sources_request_source_order.dart';import 'post_sources_request_usage.dart';final class PostSourcesRequest {const PostSourcesRequest({this.amount, this.currency, this.customer, this.expand, this.flow, this.mandate, this.metadata, this.originalSource, this.owner, this.receiver, this.redirect, this.sourceOrder, this.statementDescriptor, this.token, this.type, this.usage, });
