...
final class ChargeOutcome {
  ...
  factory ChargeOutcome.fromJson(Map<String, dynamic> json) {
    return ChargeOutcome(
      adviceCode: json['advice_code'] != null
          ? ChargeOutcomeAdviceCode.fromJson(json['advice_code'] as String)
          : null,
  ...
  ChargeOutcome copyWith({
    ChargeOutcomeAdviceCode? Function()? adviceCode,
    String? Function()? networkAdviceCode,
    String? Function()? networkDeclineCode,
    String? Function()? networkStatus,
    String? Function()? reason,
    String Function()? riskLevel,
    int Function()? riskScore,
    ChargeOutcomeRule Function()? rule,
    String? Function()? sellerMessage,
    String? type,
  }) {
    return ChargeOutcome(
  ...
  @override
  String toString() {
    return 'ChargeOutcome(adviceCode: $adviceCode, networkAdviceCode: $networkAdviceCode, networkDeclineCode: $networkDeclineCode, networkStatus: $networkStatus, reason: $reason, riskLevel: $riskLevel, riskScore: $riskScore, rule: $rule, sellerMessage: $sellerMessage, type: $type)';
  }
}
