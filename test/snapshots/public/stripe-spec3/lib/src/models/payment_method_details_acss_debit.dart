...
///
final class PaymentMethodDetailsAcssDebit {
  const PaymentMethodDetailsAcssDebit({
    this.bankName,
  ...
  factory PaymentMethodDetailsAcssDebit.fromJson(Map<String, dynamic> json) {
  ...
  PaymentMethodDetailsAcssDebit copyWith({
    ...
    return PaymentMethodDetailsAcssDebit(
      ...
      transitNumber: transitNumber != null
          ? transitNumber()
          : this.transitNumber,
    );
  }
  ...
  @override
  String toString() {
    return 'PaymentMethodDetailsAcssDebit(bankName: $bankName, expectedDebitDate: $expectedDebitDate, fingerprint: $fingerprint, institutionNumber: $institutionNumber, last4: $last4, mandate: $mandate, transitNumber: $transitNumber)';
  }
}
