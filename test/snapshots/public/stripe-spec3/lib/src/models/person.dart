...
import 'person_address_kana.dart';
import 'person_address_kanji.dart';
import 'person_future_requirements2.dart';
import 'person_object.dart';
import 'person_political_exposure.dart';
import 'person_relationship.dart';
import 'person_requirements2.dart';
import 'person_us_cfpb_data2.dart';
...
final class Person {
  ...
  factory Person.fromJson(Map<String, dynamic> json) {
    return Person(
      ...
      fullNameAliases: (json['full_name_aliases'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      futureRequirements: json['future_requirements'] != null
          ? PersonFutureRequirements2.fromJson(
              json['future_requirements'] as Map<String, dynamic>,
            )
          : null,
  ...
  Person copyWith({
    String? account,
    PersonAdditionalTosAcceptances Function()? additionalTosAcceptances,
    Address Function()? address,
    PersonAddressKana? Function()? addressKana,
    PersonAddressKanji? Function()? addressKanji,
    int? created,
    LegalEntityDob Function()? dob,
    String? Function()? email,
    String? Function()? firstName,
    String? Function()? firstNameKana,
    String? Function()? firstNameKanji,
    List<String> Function()? fullNameAliases,
    PersonFutureRequirements2? Function()? futureRequirements,
    String? Function()? gender,
    String? id,
    bool Function()? idNumberProvided,
    bool Function()? idNumberSecondaryProvided,
    ...
    PersonPoliticalExposure Function()? politicalExposure,
    Address Function()? registeredAddress,
    PersonRelationship Function()? relationship,
    PersonRequirements2? Function()? requirements,
    bool Function()? ssnLast4Provided,
    PersonUsCfpbData2? Function()? usCfpbData,
    LegalEntityPersonVerification Function()? verification,
  }) {
    return Person(
      ...
      id: id ?? this.id,
      idNumberProvided: idNumberProvided != null
          ? idNumberProvided()
          : this.idNumberProvided,
      idNumberSecondaryProvided: idNumberSecondaryProvided != null
      ...
      ssnLast4Provided: ssnLast4Provided != null
          ? ssnLast4Provided()
          : this.ssnLast4Provided,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      firstNameKana,
      firstNameKanji,
      Object.hashAll(fullNameAliases ?? const []),
      futureRequirements,
      gender,
      id,
      idNumberProvided,
