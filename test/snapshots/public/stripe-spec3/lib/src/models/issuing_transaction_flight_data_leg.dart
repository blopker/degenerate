...
///
final class IssuingTransactionFlightDataLeg {
  ...
  factory IssuingTransactionFlightDataLeg.fromJson(Map<String, dynamic> json) {
  ...
  IssuingTransactionFlightDataLeg copyWith({
  ...
  @override
  String toString() {
    return 'IssuingTransactionFlightDataLeg(arrivalAirportCode: $arrivalAirportCode, carrier: $carrier, departureAirportCode: $departureAirportCode, flightNumber: $flightNumber, serviceClass: $serviceClass, stopoverAllowed: $stopoverAllowed)';
  }
}
