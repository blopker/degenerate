...
///
final class MandatePaymentMethodDetails {
  ...
  factory MandatePaymentMethodDetails.fromJson(Map<String, dynamic> json) {
    return MandatePaymentMethodDetails(
      ...
      bacsDebit: json['bacs_debit'] != null
          ...
          : null,
      card: json['card'] != null
          ? CardMandatePaymentMethodDetails.fromJson(
  ...
  MandatePaymentMethodDetails copyWith({
    MandateAcssDebit Function()? acssDebit,
    MandateAmazonPay Function()? amazonPay,
    MandateAuBecsDebit Function()? auBecsDebit,
    MandateBacsDebit Function()? bacsDebit,
    CardMandatePaymentMethodDetails Function()? card,
    MandateCashapp Function()? cashapp,
    MandateKakaoPay Function()? kakaoPay,
    MandateKlarna Function()? klarna,
    MandateKrCard Function()? krCard,
    MandateLink Function()? link,
    MandateNaverPay Function()? naverPay,
    MandateNzBankAccount Function()? nzBankAccount,
    MandatePaypal Function()? paypal,
    MandatePayto Function()? payto,
    MandateRevolutPay Function()? revolutPay,
    MandateSepaDebit Function()? sepaDebit,
    String? type,
    MandateUsBankAccount Function()? usBankAccount,
  }) {
    return MandatePaymentMethodDetails(
