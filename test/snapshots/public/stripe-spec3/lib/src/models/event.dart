...
final class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
      ...
      data: NotificationEventData.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created') &&
        ...
        json.containsKey('pending_webhooks') &&
        json['pending_webhooks'] is num &&
  ...
  @override
  String toString() {
    return 'Event(account: $account, apiVersion: $apiVersion, context: $context, created: $created, data: $data, id: $id, livemode: $livemode, object: $object, pendingWebhooks: $pendingWebhooks, request: $request, type: $type)';
  }
}
