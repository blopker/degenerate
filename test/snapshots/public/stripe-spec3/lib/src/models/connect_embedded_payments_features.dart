...
///
final class ConnectEmbeddedPaymentsFeatures {
  const ConnectEmbeddedPaymentsFeatures({
  ...
  factory ConnectEmbeddedPaymentsFeatures.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('capture_payments') &&
        json['capture_payments'] is bool &&
        json.containsKey('destination_on_behalf_of_charge_management') &&
        json['destination_on_behalf_of_charge_management'] is bool &&
        json.containsKey('dispute_management') &&
        json['dispute_management'] is bool &&
        json.containsKey('refund_management') &&
        json['refund_management'] is bool;
  }

  ConnectEmbeddedPaymentsFeatures copyWith({
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedPaymentsFeatures(capturePayments: $capturePayments, destinationOnBehalfOfChargeManagement: $destinationOnBehalfOfChargeManagement, disputeManagement: $disputeManagement, refundManagement: $refundManagement)';
  }
}
