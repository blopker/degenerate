...
import 'package:collection/collection.dart';import 'post_billing_meter_event_adjustments_request_cancel.dart';import 'post_billing_meter_event_adjustments_request_type.dart';final class PostBillingMeterEventAdjustmentsRequest {const PostBillingMeterEventAdjustmentsRequest({this.cancel, required this.eventName, this.expand, required this.type, });
