...
final class SourceTypeAchCreditTransfer {
  const SourceTypeAchCreditTransfer({
    this.accountNumber,
    this.bankName,
    this.fingerprint,
  ...
  factory SourceTypeAchCreditTransfer.fromJson(Map<String, dynamic> json) {
  ...
  SourceTypeAchCreditTransfer copyWith({
    ...
    return SourceTypeAchCreditTransfer(
      ...
      refundAccountHolderName: refundAccountHolderName != null
          ...
          : this.refundAccountHolderName,
      refundAccountHolderType: refundAccountHolderType != null
          ? refundAccountHolderType()
          : this.refundAccountHolderType,
      refundRoutingNumber: refundRoutingNumber != null
          ? refundRoutingNumber()
          : this.refundRoutingNumber,
  ...
  @override
  String toString() {
    return 'SourceTypeAchCreditTransfer(accountNumber: $accountNumber, bankName: $bankName, fingerprint: $fingerprint, refundAccountHolderName: $refundAccountHolderName, refundAccountHolderType: $refundAccountHolderType, refundRoutingNumber: $refundRoutingNumber, routingNumber: $routingNumber, swiftCode: $swiftCode)';
  }
}
