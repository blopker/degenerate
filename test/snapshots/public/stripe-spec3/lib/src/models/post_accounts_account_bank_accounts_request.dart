...
import 'post_accounts_account_bank_accounts_request_bank_account.dart';

final class PostAccountsAccountBankAccountsRequest {
  const PostAccountsAccountBankAccountsRequest({
    this.bankAccount,
  ...
  factory PostAccountsAccountBankAccountsRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostAccountsAccountBankAccountsRequest(
      bankAccount: json['bank_account'] != null
          ? PostAccountsAccountBankAccountsRequestBankAccount.fromJson(
  ...
  PostAccountsAccountBankAccountsRequest copyWith({
    PostAccountsAccountBankAccountsRequestBankAccount Function()? bankAccount,
  ...
  @override
  String toString() {
    return 'PostAccountsAccountBankAccountsRequest(bankAccount: $bankAccount, defaultForCurrency: $defaultForCurrency, expand: $expand, externalAccount: $externalAccount, metadata: $metadata)';
  }
}
