...
final class ConfirmationTokensResourcePaymentMethodPreview {
  ...
  factory ConfirmationTokensResourcePaymentMethodPreview.fromJson(
    ...
    return ConfirmationTokensResourcePaymentMethodPreview(
      ...
      afterpayClearpay: json['afterpay_clearpay'] != null
          ? PaymentMethodAfterpayClearpay.fromJson(
              json['afterpay_clearpay'] as Map<String, dynamic>,
            )
          : null,
      alipay: json['alipay'] != null
          ? PaymentFlowsPrivatePaymentMethodsAlipay.fromJson(
              json['alipay'] as Map<String, dynamic>,
            )
          : null,
      allowRedisplay: json['allow_redisplay'] != null
          ? ConfirmationTokensResourcePaymentMethodPreviewAllowRedisplay.fromJson(
      ...
      amazonPay: json['amazon_pay'] != null
          ? PaymentMethodAmazonPay.fromJson(
      ...
      bancontact: json['bancontact'] != null
          ? PaymentMethodBancontact.fromJson(
      ...
      customer: json['customer'] != null
          ? ConfirmationTokensResourcePaymentMethodPreviewCustomer.fromJson(
              json['customer'] as Map<String, dynamic>,
            )
          : null,
      customerAccount: json['customer_account'] as String?,
      customerBalance: json['customer_balance'] != null
          ? PaymentMethodCustomerBalance.fromJson(
      ...
      kakaoPay: json['kakao_pay'] != null
          ? PaymentMethodKakaoPay.fromJson(
      ...
      payByBank: json['pay_by_bank'] != null
          ? PaymentMethodPayByBank.fromJson(
      ...
      twint: json['twint'] != null
          ...
          : null,
      type: ConfirmationTokensResourcePaymentMethodPreviewType.fromJson(
        json['type'] as String,
      ),
      ...
      wechatPay: json['wechat_pay'] != null
          ? PaymentMethodWechatPay.fromJson(
  ...
  final ConfirmationTokensResourcePaymentMethodPreviewAllowRedisplay?
  allowRedisplay;
  ...
  ConfirmationTokensResourcePaymentMethodPreview copyWith({
    PaymentMethodAcssDebit Function()? acssDebit,
    PaymentMethodAffirm Function()? affirm,
    PaymentMethodAfterpayClearpay Function()? afterpayClearpay,
    PaymentFlowsPrivatePaymentMethodsAlipay Function()? alipay,
    ConfirmationTokensResourcePaymentMethodPreviewAllowRedisplay Function()?
    allowRedisplay,
    PaymentMethodAlma Function()? alma,
    PaymentMethodAmazonPay Function()? amazonPay,
    PaymentMethodAuBecsDebit Function()? auBecsDebit,
    PaymentMethodBacsDebit Function()? bacsDebit,
    PaymentMethodBancontact Function()? bancontact,
    PaymentMethodBillie Function()? billie,
    BillingDetails? billingDetails,
    PaymentMethodBlik Function()? blik,
    PaymentMethodBoleto Function()? boleto,
    PaymentMethodCard Function()? card,
    PaymentMethodCardPresent Function()? cardPresent,
    PaymentMethodCashapp Function()? cashapp,
    PaymentMethodCrypto Function()? crypto,
    ConfirmationTokensResourcePaymentMethodPreviewCustomer? Function()?
    customer,
    String? Function()? customerAccount,
    PaymentMethodCustomerBalance Function()? customerBalance,
    PaymentMethodEps Function()? eps,
    PaymentMethodFpx Function()? fpx,
    PaymentMethodGiropay Function()? giropay,
    PaymentMethodGrabpay Function()? grabpay,
    PaymentMethodIdeal Function()? ideal,
    PaymentMethodInteracPresent Function()? interacPresent,
    PaymentMethodKakaoPay Function()? kakaoPay,
    PaymentMethodKlarna Function()? klarna,
    PaymentMethodKonbini Function()? konbini,
    PaymentMethodKrCard Function()? krCard,
    PaymentMethodLink Function()? link,
    PaymentMethodMbWay Function()? mbWay,
    PaymentMethodMobilepay Function()? mobilepay,
    PaymentMethodMultibanco Function()? multibanco,
    PaymentMethodNaverPay Function()? naverPay,
    PaymentMethodNzBankAccount Function()? nzBankAccount,
    PaymentMethodOxxo Function()? oxxo,
    PaymentMethodP24 Function()? p24,
    PaymentMethodPayByBank Function()? payByBank,
    PaymentMethodPayco Function()? payco,
    PaymentMethodPaynow Function()? paynow,
    PaymentMethodPaypal Function()? paypal,
    PaymentMethodPayto Function()? payto,
    PaymentMethodPix Function()? pix,
    PaymentMethodPromptpay Function()? promptpay,
    PaymentMethodRevolutPay Function()? revolutPay,
    PaymentMethodSamsungPay Function()? samsungPay,
    PaymentMethodSatispay Function()? satispay,
    PaymentMethodSepaDebit Function()? sepaDebit,
    PaymentMethodSofort Function()? sofort,
    PaymentMethodSwish Function()? swish,
    PaymentMethodTwint Function()? twint,
    ConfirmationTokensResourcePaymentMethodPreviewType? type,
    PaymentMethodUsBankAccount Function()? usBankAccount,
    PaymentMethodWechatPay Function()? wechatPay,
    PaymentMethodZip Function()? zip,
  }) {
    return ConfirmationTokensResourcePaymentMethodPreview(
