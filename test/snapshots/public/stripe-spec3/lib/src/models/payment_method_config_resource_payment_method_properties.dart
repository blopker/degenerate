...
///
final class PaymentMethodConfigResourcePaymentMethodProperties {
  ...
  PaymentMethodConfigResourcePaymentMethodProperties copyWith({
    bool? available,
  ...
  @override
  int get hashCode {
    return Object.hash(available, displayPreference);
  }

  @override
  String toString() {
    return 'PaymentMethodConfigResourcePaymentMethodProperties(available: $available, displayPreference: $displayPreference)';
  }
}
