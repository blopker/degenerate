...
final class InboundTransfers {
  ...
  factory InboundTransfers.fromJson(Map<String, dynamic> json) {
    return InboundTransfers(
      ...
      usBankAccount: json['us_bank_account'] != null
          ? InboundTransfersPaymentMethodDetailsUsBankAccount.fromJson(
  ...
  InboundTransfers copyWith({
    TreasurySharedResourceBillingDetails? billingDetails,
    InboundTransfersType? type,
    InboundTransfersPaymentMethodDetailsUsBankAccount Function()? usBankAccount,
  }) {
    return InboundTransfers(
  ...
  @override
  int get hashCode {
    return Object.hash(billingDetails, type, usBankAccount);
  }

  @override
  String toString() {
    return 'InboundTransfers(billingDetails: $billingDetails, type: $type, usBankAccount: $usBankAccount)';
  }
}
