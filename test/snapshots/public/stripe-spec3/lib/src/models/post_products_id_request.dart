...
import 'post_products_id_request_description.dart';
import 'post_products_id_request_images.dart';
import 'post_products_id_request_marketing_features.dart';
import 'post_products_id_request_metadata.dart';
import 'post_products_id_request_package_dimensions.dart';
import 'post_products_id_request_tax_code.dart';
import 'post_products_id_request_unit_label.dart';
import 'post_products_id_request_url.dart';

final class PostProductsIdRequest {
  const PostProductsIdRequest({
    this.active,
    this.defaultPrice,
    this.description,
    this.expand,
  ...
  factory PostProductsIdRequest.fromJson(Map<String, dynamic> json) {
    return PostProductsIdRequest(
      active: json['active'] as bool?,
      defaultPrice: json['default_price'] as String?,
      description: json['description'] != null
          ? PostProductsIdRequestDescription.fromJson(
      ...
      images: json['images'] != null
          ? PostProductsIdRequestImages.fromJson(
              json['images'] as Map<String, dynamic>,
            )
          : null,
      marketingFeatures: json['marketing_features'] != null
          ? PostProductsIdRequestMarketingFeatures.fromJson(
              json['marketing_features'] as Map<String, dynamic>,
            )
          : null,
      metadata: json['metadata'] != null
          ? PostProductsIdRequestMetadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            )
          : null,
      name: json['name'] as String?,
      packageDimensions: json['package_dimensions'] != null
          ? PostProductsIdRequestPackageDimensions.fromJson(
      ...
      taxCode: json['tax_code'] != null
          ? PostProductsIdRequestTaxCode.fromJson(
              json['tax_code'] as Map<String, dynamic>,
            )
          : null,
      unitLabel: json['unit_label'] != null
          ? PostProductsIdRequestUnitLabel.fromJson(
              json['unit_label'] as Map<String, dynamic>,
            )
          : null,
      url: json['url'] != null
          ? PostProductsIdRequestUrl.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (marketingFeatures != null)
        'marketing_features': marketingFeatures?.toJson(),
  ...
  PostProductsIdRequest copyWith({
    bool Function()? active,
    String Function()? defaultPrice,
    PostProductsIdRequestDescription Function()? description,
    List<String> Function()? expand,
    PostProductsIdRequestImages Function()? images,
    PostProductsIdRequestMarketingFeatures Function()? marketingFeatures,
    PostProductsIdRequestMetadata Function()? metadata,
    String Function()? name,
    PostProductsIdRequestPackageDimensions Function()? packageDimensions,
    bool Function()? shippable,
    String Function()? statementDescriptor,
    PostProductsIdRequestTaxCode Function()? taxCode,
    PostProductsIdRequestUnitLabel Function()? unitLabel,
    PostProductsIdRequestUrl Function()? url,
  }) {
    return PostProductsIdRequest(
      ...
      marketingFeatures: marketingFeatures != null
          ? marketingFeatures()
          : this.marketingFeatures,
