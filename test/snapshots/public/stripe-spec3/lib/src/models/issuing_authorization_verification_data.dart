...
import 'issuing_authorization_verification_data_authentication_exemption.dart';
...
import 'issuing_authorization_verification_data_three_d_secure.dart';

///
final class IssuingAuthorizationVerificationData {
  ...
  factory IssuingAuthorizationVerificationData.fromJson(
    ...
    return IssuingAuthorizationVerificationData(
      ...
      addressPostalCodeCheck:
          IssuingAuthorizationVerificationDataAddressPostalCodeCheck.fromJson(
            json['address_postal_code_check'] as String,
          ),
      authenticationExemption: json['authentication_exemption'] != null
          ? IssuingAuthorizationVerificationDataAuthenticationExemption.fromJson(
              json['authentication_exemption'] as Map<String, dynamic>,
            )
          : null,
      cvcCheck: IssuingAuthorizationVerificationDataCvcCheck.fromJson(
        json['cvc_check'] as String,
      ),
      expiryCheck: IssuingAuthorizationVerificationDataExpiryCheck.fromJson(
        json['expiry_check'] as String,
      ),
      postalCode: json['postal_code'] as String?,
      threeDSecure: json['three_d_secure'] != null
          ? IssuingAuthorizationVerificationDataThreeDSecure.fromJson(
  ...
  final IssuingAuthorizationVerificationDataAddressPostalCodeCheck
  addressPostalCodeCheck;

  /// The exemption applied to this authorization.
  final IssuingAuthorizationVerificationDataAuthenticationExemption?
  ...
  IssuingAuthorizationVerificationData copyWith({
    ...
    addressPostalCodeCheck,
    IssuingAuthorizationVerificationDataAuthenticationExemption? Function()?
    authenticationExemption,
    ...
    IssuingAuthorizationVerificationDataThreeDSecure? Function()? threeDSecure,
  }) {
    return IssuingAuthorizationVerificationData(
      addressLine1Check: addressLine1Check ?? this.addressLine1Check,
      addressPostalCodeCheck:
          addressPostalCodeCheck ?? this.addressPostalCodeCheck,
  ...
  @override
  String toString() {
    return 'IssuingAuthorizationVerificationData(addressLine1Check: $addressLine1Check, addressPostalCodeCheck: $addressPostalCodeCheck, authenticationExemption: $authenticationExemption, cvcCheck: $cvcCheck, expiryCheck: $expiryCheck, postalCode: $postalCode, threeDSecure: $threeDSecure)';
  }
}
