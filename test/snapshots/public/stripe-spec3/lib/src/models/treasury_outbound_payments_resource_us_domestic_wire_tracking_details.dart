...
///
final class TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails {
  const TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails({
    this.chips,
    this.imad,
    this.omad,
  });

  factory TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails.fromJson(
  ...
  TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails copyWith({
  ...
  @override
  String toString() {
    return 'TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails(chips: $chips, imad: $imad, omad: $omad)';
  }
}
