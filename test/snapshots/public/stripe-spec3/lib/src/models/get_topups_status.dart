...
final class GetTopupsStatus {
  const GetTopupsStatus._(this.value);

  factory GetTopupsStatus.fromJson(String json) {
    return switch (json) {
      'canceled' => canceled,
      'failed' => failed,
      'pending' => pending,
  ...
  static const List<GetTopupsStatus> values = [
    canceled,
    failed,
    pending,
    succeeded,
