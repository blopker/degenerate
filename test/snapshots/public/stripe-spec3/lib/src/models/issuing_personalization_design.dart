...
import 'issuing_personalization_design_card_logo.dart';
import 'issuing_personalization_design_carrier_text2.dart';
import 'issuing_personalization_design_object.dart';
import 'issuing_personalization_design_physical_bundle.dart';
import 'issuing_personalization_design_preferences.dart';
import 'issuing_personalization_design_rejection_reasons.dart';
import 'issuing_personalization_design_status.dart';

/// A Personalization Design is a logical grouping of a Physical Bundle, card logo, and carrier text that represents a product line.
final class IssuingPersonalizationDesign {
  const IssuingPersonalizationDesign({
    this.cardLogo,
    this.carrierText,
  ...
  factory IssuingPersonalizationDesign.fromJson(Map<String, dynamic> json) {
    return IssuingPersonalizationDesign(
      cardLogo: json['card_logo'] != null
          ? IssuingPersonalizationDesignCardLogo.fromJson(
              json['card_logo'] as Map<String, dynamic>,
            )
          : null,
      carrierText: json['carrier_text'] != null
          ? IssuingPersonalizationDesignCarrierText2.fromJson(
      ...
      object: IssuingPersonalizationDesignObject.fromJson(
        json['object'] as String,
      ),
      physicalBundle: IssuingPersonalizationDesignPhysicalBundle.fromJson(
        json['physical_bundle'] as Map<String, dynamic>,
      ),
      preferences: IssuingPersonalizationDesignPreferences.fromJson(
      ...
      status: IssuingPersonalizationDesignStatus.fromJson(
  ...
  IssuingPersonalizationDesign copyWith({
    IssuingPersonalizationDesignCardLogo? Function()? cardLogo,
    IssuingPersonalizationDesignCarrierText2? Function()? carrierText,
    int? created,
    String? id,
    bool? livemode,
    ...
    IssuingPersonalizationDesignObject? object,
  ...
  @override
  String toString() {
    return 'IssuingPersonalizationDesign(cardLogo: $cardLogo, carrierText: $carrierText, created: $created, id: $id, livemode: $livemode, lookupKey: $lookupKey, metadata: $metadata, name: $name, object: $object, physicalBundle: $physicalBundle, preferences: $preferences, rejectionReasons: $rejectionReasons, status: $status)';
  }
}
