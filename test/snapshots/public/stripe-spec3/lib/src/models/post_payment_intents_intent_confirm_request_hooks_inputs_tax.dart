...
import 'post_payment_intents_intent_confirm_request_hooks_inputs_tax_calculation.dart';final class PostPaymentIntentsIntentConfirmRequestHooksInputsTax {const PostPaymentIntentsIntentConfirmRequestHooksInputsTax({required this.calculation});
...
factory PostPaymentIntentsIntentConfirmRequestHooksInputsTax.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentConfirmRequestHooksInputsTax(
  calculation: PostPaymentIntentsIntentConfirmRequestHooksInputsTaxCalculation.fromJson(json['calculation'] as Map<String, dynamic>),
); }
