...
final class InvoicePayment {
  ...
  factory InvoicePayment.fromJson(Map<String, dynamic> json) {
    return InvoicePayment(
      ...
      invoice: InvoicePaymentInvoice.fromJson(
        json['invoice'] as Map<String, dynamic>,
      ),
      isDefault: json['is_default'] as bool,
      livemode: json['livemode'] as bool,
      object: InvoicePaymentObject.fromJson(json['object'] as String),
      payment: InvoicesPaymentsInvoicePaymentAssociatedPayment.fromJson(
        json['payment'] as Map<String, dynamic>,
      ),
      status: json['status'] as String,
      statusTransitions:
          InvoicesPaymentsInvoicePaymentStatusTransitions.fromJson(
  ...
  @override
  String toString() {
    return 'InvoicePayment(amountPaid: $amountPaid, amountRequested: $amountRequested, created: $created, currency: $currency, id: $id, invoice: $invoice, isDefault: $isDefault, livemode: $livemode, object: $object, payment: $payment, status: $status, statusTransitions: $statusTransitions)';
  }
}
