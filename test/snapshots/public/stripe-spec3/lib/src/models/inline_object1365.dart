...
final class InlineObject1365 {const InlineObject1365({this.amountGte, this.resetBillingCycleAnchor, });

factory InlineObject1365.fromJson(Map<String, dynamic> json) { return InlineObject1365(
...
InlineObject1365 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject1365(
...
@override String toString() { return 'InlineObject1365(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
