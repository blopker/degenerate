...
import 'post_invoices_create_preview_request_automatic_tax_liability_type.dart';final class PostInvoicesCreatePreviewRequestAutomaticTaxLiability {const PostInvoicesCreatePreviewRequestAutomaticTaxLiability({this.account, required this.type, });
