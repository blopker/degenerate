...
///
final class InvoicePaymentMethodOptionsCustomerBalance {
  const InvoicePaymentMethodOptionsCustomerBalance({
    this.bankTransfer,
    this.fundingType,
  });

  factory InvoicePaymentMethodOptionsCustomerBalance.fromJson(
    ...
    return InvoicePaymentMethodOptionsCustomerBalance(
      ...
      fundingType: json['funding_type'] != null
          ? InvoicePaymentMethodOptionsCustomerBalanceFundingType.fromJson(
  ...
  InvoicePaymentMethodOptionsCustomerBalance copyWith({
    InvoicePaymentMethodOptionsCustomerBalanceBankTransfer Function()?
    bankTransfer,
    InvoicePaymentMethodOptionsCustomerBalanceFundingType? Function()?
    fundingType,
  }) {
    return InvoicePaymentMethodOptionsCustomerBalance(
  ...
  @override
  String toString() {
    return 'InvoicePaymentMethodOptionsCustomerBalance(bankTransfer: $bankTransfer, fundingType: $fundingType)';
  }
}
