...
import 'bank_account_future_requirements.dart';
import 'bank_account_object.dart';
import 'bank_account_requirements.dart';
...
final class BankAccount {
    ...
    return BankAccount(
      ...
      availablePayoutMethods:
          (json['available_payout_methods'] as List<dynamic>?)
              ?.map(
                (e) => BankAccountAvailablePayoutMethods.fromJson(e as String),
              )
              .toList(),
      ...
      requirements: json['requirements'] != null
          ? BankAccountRequirements.fromJson(
  ...
  BankAccount copyWith({
    BankAccountAccount? Function()? account,
    String? Function()? accountHolderName,
    String? Function()? accountHolderType,
    String? Function()? accountType,
    List<BankAccountAvailablePayoutMethods>? Function()? availablePayoutMethods,
    String? Function()? bankName,
    String? country,
    String? currency,
    BankAccountCustomer? Function()? customer,
    bool? Function()? defaultForCurrency,
    String? Function()? fingerprint,
    BankAccountFutureRequirements? Function()? futureRequirements,
    String? id,
    String? last4,
    Map<String, String>? Function()? metadata,
    BankAccountObject? object,
    BankAccountRequirements? Function()? requirements,
