...
final class ForwardedRequestContext {
  const ForwardedRequestContext({
    required this.destinationDuration,
    required this.destinationIpAddress,
  });

  factory ForwardedRequestContext.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('destination_duration') &&
        json['destination_duration'] is num &&
        json.containsKey('destination_ip_address') &&
        json['destination_ip_address'] is String;
  }

  ForwardedRequestContext copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(destinationDuration, destinationIpAddress);
  }

  @override
  String toString() {
    return 'ForwardedRequestContext(destinationDuration: $destinationDuration, destinationIpAddress: $destinationIpAddress)';
  }
}
