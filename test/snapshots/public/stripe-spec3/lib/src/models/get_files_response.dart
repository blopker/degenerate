...
import 'file.dart';
import 'get_files_response_object.dart';
...
final class GetFilesResponse {
  ...
  GetFilesResponse copyWith({
    List<File>? data,
    bool? hasMore,
    GetFilesResponseObject? object,
    String? url,
  }) {
    return GetFilesResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetFilesResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
