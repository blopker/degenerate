...
///
final class PaymentIntentNextActionSwishQrCode {
  ...
  factory PaymentIntentNextActionSwishQrCode.fromJson(
  ...
  PaymentIntentNextActionSwishQrCode copyWith({
    String? data,
    String? imageUrlPng,
    String? imageUrlSvg,
  }) {
  ...
  @override
  int get hashCode {
    return Object.hash(data, imageUrlPng, imageUrlSvg);
  }

  @override
  String toString() {
    return 'PaymentIntentNextActionSwishQrCode(data: $data, imageUrlPng: $imageUrlPng, imageUrlSvg: $imageUrlSvg)';
  }
}
