...
///
final class IssuingCardholderIndividualDob {
  const IssuingCardholderIndividualDob({this.day, this.month, this.year});

  factory IssuingCardholderIndividualDob.fromJson(Map<String, dynamic> json) {
  ...
  IssuingCardholderIndividualDob copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'IssuingCardholderIndividualDob(day: $day, month: $month, year: $year)';
  }
}
