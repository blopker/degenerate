...
import 'post_invoices_create_preview_request_automatic_tax.dart';
import 'post_invoices_create_preview_request_customer_details.dart';
import 'post_invoices_create_preview_request_discounts.dart';
import 'post_invoices_create_preview_request_invoice_items.dart';
import 'post_invoices_create_preview_request_issuer.dart';
import 'post_invoices_create_preview_request_on_behalf_of.dart';
import 'post_invoices_create_preview_request_preview_mode.dart';
import 'post_invoices_create_preview_request_schedule_details.dart';
import 'post_invoices_create_preview_request_subscription_details.dart';

final class PostInvoicesCreatePreviewRequest {
  const PostInvoicesCreatePreviewRequest({
    this.automaticTax,
    this.currency,
    this.customer,
  ...
  factory PostInvoicesCreatePreviewRequest.fromJson(Map<String, dynamic> json) {
    return PostInvoicesCreatePreviewRequest(
      automaticTax: json['automatic_tax'] != null
          ? PostInvoicesCreatePreviewRequestAutomaticTax.fromJson(
      ...
      customerDetails: json['customer_details'] != null
          ? PostInvoicesCreatePreviewRequestCustomerDetails.fromJson(
              json['customer_details'] as Map<String, dynamic>,
            )
          : null,
      discounts: json['discounts'] != null
          ? PostInvoicesCreatePreviewRequestDiscounts.fromJson(
      ...
      invoiceItems: (json['invoice_items'] as List<dynamic>?)
          ?.map(
            (e) => PostInvoicesCreatePreviewRequestInvoiceItems.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      issuer: json['issuer'] != null
          ? PostInvoicesCreatePreviewRequestIssuer.fromJson(
              json['issuer'] as Map<String, dynamic>,
            )
          : null,
      onBehalfOf: json['on_behalf_of'] != null
          ? PostInvoicesCreatePreviewRequestOnBehalfOf.fromJson(
              json['on_behalf_of'] as Map<String, dynamic>,
            )
          : null,
      previewMode: json['preview_mode'] != null
          ? PostInvoicesCreatePreviewRequestPreviewMode.fromJson(
              json['preview_mode'] as String,
            )
          : null,
      schedule: json['schedule'] as String?,
      scheduleDetails: json['schedule_details'] != null
          ? PostInvoicesCreatePreviewRequestScheduleDetails.fromJson(
              json['schedule_details'] as Map<String, dynamic>,
            )
          : null,
      subscription: json['subscription'] as String?,
      subscriptionDetails: json['subscription_details'] != null
          ? PostInvoicesCreatePreviewRequestSubscriptionDetails.fromJson(
  ...
  final PostInvoicesCreatePreviewRequestSubscriptionDetails?
  subscriptionDetails;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (invoiceItems != null)
        'invoice_items': invoiceItems?.map((e) => e.toJson()).toList(),
  ...
  PostInvoicesCreatePreviewRequest copyWith({
    PostInvoicesCreatePreviewRequestAutomaticTax Function()? automaticTax,
    String Function()? currency,
    String Function()? customer,
    String Function()? customerAccount,
    PostInvoicesCreatePreviewRequestCustomerDetails Function()? customerDetails,
    PostInvoicesCreatePreviewRequestDiscounts Function()? discounts,
    List<String> Function()? expand,
    List<PostInvoicesCreatePreviewRequestInvoiceItems> Function()? invoiceItems,
    PostInvoicesCreatePreviewRequestIssuer Function()? issuer,
    PostInvoicesCreatePreviewRequestOnBehalfOf Function()? onBehalfOf,
    PostInvoicesCreatePreviewRequestPreviewMode Function()? previewMode,
    String Function()? schedule,
    PostInvoicesCreatePreviewRequestScheduleDetails Function()? scheduleDetails,
    String Function()? subscription,
    PostInvoicesCreatePreviewRequestSubscriptionDetails Function()?
    subscriptionDetails,
  }) {
    return PostInvoicesCreatePreviewRequest(
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(invoiceItems ?? const []),
      issuer,
      onBehalfOf,
      previewMode,
      schedule,
