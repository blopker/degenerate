...
import 'get_prices_recurring_interval.dart';import 'get_prices_recurring_usage_type.dart';final class GetPricesRecurring {const GetPricesRecurring({this.interval, this.meter, this.usageType, });
