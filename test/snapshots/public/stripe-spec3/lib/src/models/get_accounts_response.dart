...
import 'account.dart';
import 'get_accounts_response_object.dart';

///
final class GetAccountsResponse {
  ...
  GetAccountsResponse copyWith({
    List<Account>? data,
    bool? hasMore,
    GetAccountsResponseObject? object,
    String? url,
  }) {
    return GetAccountsResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetAccountsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
