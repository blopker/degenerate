...
import 'package:collection/collection.dart';import 'inline_object183.dart';import 'post_coupons_request_applies_to.dart';import 'post_coupons_request_duration.dart';import 'post_coupons_request_metadata.dart';final class PostCouponsRequest {const PostCouponsRequest({this.amountOff, this.appliesTo, this.currency, this.currencyOptions, this.duration, this.durationInMonths, this.expand, this.id, this.maxRedemptions, this.metadata, this.name, this.percentOff, this.redeemBy, });
