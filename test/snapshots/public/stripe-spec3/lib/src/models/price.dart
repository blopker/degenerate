...
final class Price {
  ...
  factory Price.fromJson(Map<String, dynamic> json) {
    return Price(
      ...
      billingScheme: PriceBillingScheme.fromJson(
      ...
      currencyOptions: (json['currency_options'] as Map<String, dynamic>?)?.map(
        (k, v) =>
            MapEntry(k, CurrencyOption.fromJson(v as Map<String, dynamic>)),
      ),
      customUnitAmount: json['custom_unit_amount'] != null
          ? PriceCustomUnitAmount.fromJson(
      ...
      taxBehavior: json['tax_behavior'] != null
          ? PriceTaxBehavior.fromJson(json['tax_behavior'] as String)
          : null,
      tiers: (json['tiers'] as List<dynamic>?)
          ?.map((e) => PriceTier.fromJson(e as Map<String, dynamic>))
          .toList(),
      tiersMode: json['tiers_mode'] != null
          ? PriceTiersMode.fromJson(json['tiers_mode'] as String)
          : null,
      transformQuantity: json['transform_quantity'] != null
          ? PriceTransformQuantity.fromJson(
  ...
  Price copyWith({
    ...
    int? created,
    String? currency,
    Map<String, CurrencyOption> Function()? currencyOptions,
    PriceCustomUnitAmount? Function()? customUnitAmount,
    String? id,
    bool? livemode,
    ...
    PriceRecurring? Function()? recurring,
    PriceTaxBehavior? Function()? taxBehavior,
    List<PriceTier> Function()? tiers,
    PriceTiersMode? Function()? tiersMode,
    PriceTransformQuantity? Function()? transformQuantity,
    PriceType? type,
