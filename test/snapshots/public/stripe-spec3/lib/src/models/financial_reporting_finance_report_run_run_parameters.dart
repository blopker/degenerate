...
///
final class FinancialReportingFinanceReportRunRunParameters {
  const FinancialReportingFinanceReportRunRunParameters({
    this.columns,
  ...
  factory FinancialReportingFinanceReportRunRunParameters.fromJson(
  ...
  FinancialReportingFinanceReportRunRunParameters copyWith({
    ...
    String Function()? reportingCategory,
  ...
  @override
  String toString() {
    return 'FinancialReportingFinanceReportRunRunParameters(columns: $columns, connectedAccount: $connectedAccount, currency: $currency, intervalEnd: $intervalEnd, intervalStart: $intervalStart, payout: $payout, reportingCategory: $reportingCategory, timezone: $timezone)';
  }
}
