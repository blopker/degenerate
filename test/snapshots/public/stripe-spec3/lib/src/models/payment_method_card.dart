...
import 'payment_method_card_checks2.dart';
import 'payment_method_card_generated_from.dart';
import 'payment_method_card_networks.dart';
import 'payment_method_card_regulated_status.dart';
import 'payment_method_card_three_d_secure_usage.dart';
import 'payment_method_card_wallet2.dart';

///
final class PaymentMethodCard {
  ...
  factory PaymentMethodCard.fromJson(Map<String, dynamic> json) {
    return PaymentMethodCard(
      ...
      checks: json['checks'] != null
          ? PaymentMethodCardChecks2.fromJson(
      ...
      generatedFrom: json['generated_from'] != null
          ? PaymentMethodCardGeneratedFrom.fromJson(
              json['generated_from'] as Map<String, dynamic>,
            )
          : null,
      last4: json['last4'] as String,
      networks: json['networks'] != null
          ? PaymentMethodCardNetworks.fromJson(
              json['networks'] as Map<String, dynamic>,
            )
          : null,
      regulatedStatus: json['regulated_status'] != null
          ? PaymentMethodCardRegulatedStatus.fromJson(
      ...
      wallet: json['wallet'] != null
          ? PaymentMethodCardWallet2.fromJson(
  ...
  PaymentMethodCard copyWith({
    String? brand,
    PaymentMethodCardChecks2? Function()? checks,
    String? Function()? country,
    String? Function()? displayBrand,
    int? expMonth,
    int? expYear,
    String? Function()? fingerprint,
    String? funding,
    PaymentMethodCardGeneratedFrom? Function()? generatedFrom,
    String? last4,
    PaymentMethodCardNetworks? Function()? networks,
    PaymentMethodCardRegulatedStatus? Function()? regulatedStatus,
    PaymentMethodCardThreeDSecureUsage? Function()? threeDSecureUsage,
    PaymentMethodCardWallet2? Function()? wallet,
  }) {
    return PaymentMethodCard(
      ...
      regulatedStatus: regulatedStatus != null
          ? regulatedStatus()
          : this.regulatedStatus,
      threeDSecureUsage: threeDSecureUsage != null
          ? threeDSecureUsage()
          : this.threeDSecureUsage,
