...
import 'post_tax_registrations_request_country_options_cd_standard.dart';import 'post_tax_registrations_request_country_options_cd_type.dart';final class PostTaxRegistrationsRequestCountryOptionsCd {const PostTaxRegistrationsRequestCountryOptionsCd({this.standard, required this.type, });
...
factory PostTaxRegistrationsRequestCountryOptionsCd.fromJson(Map<String, dynamic> json) { return PostTaxRegistrationsRequestCountryOptionsCd(
  standard: json['standard'] != null
        ? PostTaxRegistrationsRequestCountryOptionsCdStandard.fromJson(json['standard'] as Map<String, dynamic>)
        : null,
