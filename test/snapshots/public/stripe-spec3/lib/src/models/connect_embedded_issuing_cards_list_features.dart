...
///
final class ConnectEmbeddedIssuingCardsListFeatures {
  const ConnectEmbeddedIssuingCardsListFeatures({
  ...
  factory ConnectEmbeddedIssuingCardsListFeatures.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('card_management') &&
        json['card_management'] is bool &&
        json.containsKey('card_spend_dispute_management') &&
        json['card_spend_dispute_management'] is bool &&
        json.containsKey('cardholder_management') &&
        json['cardholder_management'] is bool &&
        json.containsKey('disable_stripe_user_authentication') &&
        json['disable_stripe_user_authentication'] is bool &&
        json.containsKey('spend_control_management') &&
        json['spend_control_management'] is bool;
  }

  ConnectEmbeddedIssuingCardsListFeatures copyWith({
    bool? cardManagement,
    ...
    return ConnectEmbeddedIssuingCardsListFeatures(
      ...
      cardSpendDisputeManagement:
          cardSpendDisputeManagement ?? this.cardSpendDisputeManagement,
      ...
      spendControlManagement:
          spendControlManagement ?? this.spendControlManagement,
    );
  }
  ...
  @override
  String toString() {
    return 'ConnectEmbeddedIssuingCardsListFeatures(cardManagement: $cardManagement, cardSpendDisputeManagement: $cardSpendDisputeManagement, cardholderManagement: $cardholderManagement, disableStripeUserAuthentication: $disableStripeUserAuthentication, spendControlManagement: $spendControlManagement)';
  }
}
