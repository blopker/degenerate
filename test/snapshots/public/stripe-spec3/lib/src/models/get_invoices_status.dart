...
final class GetInvoicesStatus {
  const GetInvoicesStatus._(this.value);

  factory GetInvoicesStatus.fromJson(String json) {
    return switch (json) {
      'draft' => draft,
      'open' => open,
      'paid' => paid,
  ...
  static const GetInvoicesStatus uncollectible = GetInvoicesStatus._(
    'uncollectible',
  );

  static const GetInvoicesStatus $void = GetInvoicesStatus._('void');

  static const List<GetInvoicesStatus> values = [
    draft,
    open,
    paid,
    uncollectible,
  ...
  @override
  String toString() {
    return 'GetInvoicesStatus($value)';
  }
}
