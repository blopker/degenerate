...
///
final class LegalEntityCompanyVerificationDocument {
  const LegalEntityCompanyVerificationDocument({
    this.back,
    this.details,
    this.detailsCode,
    this.front,
  ...
  factory LegalEntityCompanyVerificationDocument.fromJson(
    Map<String, dynamic> json,
  ) {
    return LegalEntityCompanyVerificationDocument(
      back: json['back'] != null
          ? LegalEntityCompanyVerificationDocumentBack.fromJson(
      ...
      front: json['front'] != null
          ? LegalEntityCompanyVerificationDocumentFront.fromJson(
  ...
  LegalEntityCompanyVerificationDocument copyWith({
    LegalEntityCompanyVerificationDocumentBack? Function()? back,
    String? Function()? details,
    String? Function()? detailsCode,
    LegalEntityCompanyVerificationDocumentFront? Function()? front,
  }) {
    return LegalEntityCompanyVerificationDocument(
  ...
  @override
  String toString() {
    return 'LegalEntityCompanyVerificationDocument(back: $back, details: $details, detailsCode: $detailsCode, front: $front)';
  }
}
