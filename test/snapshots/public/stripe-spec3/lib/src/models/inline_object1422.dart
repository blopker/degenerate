...
final class InlineObject1422 {const InlineObject1422({this.amountGte, this.resetBillingCycleAnchor, });

factory InlineObject1422.fromJson(Map<String, dynamic> json) { return InlineObject1422(
...
InlineObject1422 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject1422(
...
@override String toString() { return 'InlineObject1422(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
