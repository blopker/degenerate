...
import 'post_payouts_request_method.dart';
import 'post_payouts_request_source_type.dart';

final class PostPayoutsRequest {
  const PostPayoutsRequest({
  ...
  factory PostPayoutsRequest.fromJson(Map<String, dynamic> json) {
    return PostPayoutsRequest(
      ...
      method: json['method'] != null
          ? PostPayoutsRequestMethod.fromJson(json['method'] as String)
          : null,
      payoutMethod: json['payout_method'] as String?,
      sourceType: json['source_type'] != null
          ? PostPayoutsRequestSourceType.fromJson(json['source_type'] as String)
          : null,
  ...
  PostPayoutsRequest copyWith({
    ...
    PostPayoutsRequestMethod Function()? method,
    String Function()? payoutMethod,
    PostPayoutsRequestSourceType Function()? sourceType,
  ...
  @override
  String toString() {
    return 'PostPayoutsRequest(amount: $amount, currency: $currency, description: $description, destination: $destination, expand: $expand, metadata: $metadata, method: $method, payoutMethod: $payoutMethod, sourceType: $sourceType, statementDescriptor: $statementDescriptor)';
  }
}
