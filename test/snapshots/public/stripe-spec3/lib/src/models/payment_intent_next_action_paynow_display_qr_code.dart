...
///
final class PaymentIntentNextActionPaynowDisplayQrCode {
  ...
  factory PaymentIntentNextActionPaynowDisplayQrCode.fromJson(
  ...
  PaymentIntentNextActionPaynowDisplayQrCode copyWith({
    String? data,
  ...
  @override
  String toString() {
    return 'PaymentIntentNextActionPaynowDisplayQrCode(data: $data, hostedInstructionsUrl: $hostedInstructionsUrl, imageUrlPng: $imageUrlPng, imageUrlSvg: $imageUrlSvg)';
  }
}
