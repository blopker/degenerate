...
final class PostTreasuryInboundTransfersRequest {
  const PostTreasuryInboundTransfersRequest({
  ...
  factory PostTreasuryInboundTransfersRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostTreasuryInboundTransfersRequest(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('amount') &&
        ...
        json.containsKey('origin_payment_method') &&
        json['origin_payment_method'] is String;
  }

  PostTreasuryInboundTransfersRequest copyWith({
    int? amount,
    String? currency,
  ...
  @override
  String toString() {
    return 'PostTreasuryInboundTransfersRequest(amount: $amount, currency: $currency, description: $description, expand: $expand, financialAccount: $financialAccount, metadata: $metadata, originPaymentMethod: $originPaymentMethod, statementDescriptor: $statementDescriptor)';
  }
}
