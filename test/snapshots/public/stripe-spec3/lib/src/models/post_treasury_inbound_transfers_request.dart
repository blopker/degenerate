...
import 'package:collection/collection.dart';final class PostTreasuryInboundTransfersRequest {const PostTreasuryInboundTransfersRequest({required this.amount, required this.currency, this.description, this.expand, required this.financialAccount, this.metadata, required this.originPaymentMethod, this.statementDescriptor, });
