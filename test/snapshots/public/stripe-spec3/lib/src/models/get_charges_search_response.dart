...
import 'charge.dart';
import 'get_charges_search_response_object.dart';

///
final class GetChargesSearchResponse {
  const GetChargesSearchResponse({
    required this.data,
  ...
  factory GetChargesSearchResponse.fromJson(Map<String, dynamic> json) {
    return GetChargesSearchResponse(
  ...
  GetChargesSearchResponse copyWith({
    List<Charge>? data,
    bool? hasMore,
    String? Function()? nextPage,
    GetChargesSearchResponseObject? object,
  ...
  @override
  String toString() {
    return 'GetChargesSearchResponse(data: $data, hasMore: $hasMore, nextPage: $nextPage, object: $object, totalCount: $totalCount, url: $url)';
  }
}
