...
final class TaxIdType {
  const TaxIdType._(this.value);

  factory TaxIdType.fromJson(String json) {
    return switch (json) {
      'ad_nrt' => adNrt,
      'ae_trn' => aeTrn,
      'al_tin' => alTin,
  ...
  static const List<TaxIdType> values = [
    adNrt,
    aeTrn,
    alTin,
    amTin,
  ...
  bool operator ==(Object other) {
    return identical(this, other) || other is TaxIdType && other.value == value;
  }
