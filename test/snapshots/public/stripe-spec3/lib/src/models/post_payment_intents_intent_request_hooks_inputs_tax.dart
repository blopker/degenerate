...
import 'post_payment_intents_intent_request_hooks_inputs_tax_calculation.dart';final class PostPaymentIntentsIntentRequestHooksInputsTax {const PostPaymentIntentsIntentRequestHooksInputsTax({required this.calculation});
...
factory PostPaymentIntentsIntentRequestHooksInputsTax.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentRequestHooksInputsTax(
  calculation: PostPaymentIntentsIntentRequestHooksInputsTaxCalculation.fromJson(json['calculation'] as Map<String, dynamic>),
); }
