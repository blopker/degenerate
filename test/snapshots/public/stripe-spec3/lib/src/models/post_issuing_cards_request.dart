...
import 'post_issuing_cards_request_pin.dart';
import 'post_issuing_cards_request_replacement_reason.dart';
import 'post_issuing_cards_request_second_line.dart';
import 'post_issuing_cards_request_shipping.dart';
import 'post_issuing_cards_request_spending_controls.dart';
import 'post_issuing_cards_request_status.dart';
import 'post_issuing_cards_request_type.dart';

final class PostIssuingCardsRequest {
  const PostIssuingCardsRequest({
    this.cardholder,
  ...
  factory PostIssuingCardsRequest.fromJson(Map<String, dynamic> json) {
    return PostIssuingCardsRequest(
      cardholder: json['cardholder'] as String?,
      currency: json['currency'] as String,
      expMonth: json['exp_month'] != null
          ? (json['exp_month'] as num).toInt()
          : null,
      expYear: json['exp_year'] != null
          ? (json['exp_year'] as num).toInt()
          : null,
      ...
      pin: json['pin'] != null
          ? PostIssuingCardsRequestPin.fromJson(
      ...
      replacementReason: json['replacement_reason'] != null
          ? PostIssuingCardsRequestReplacementReason.fromJson(
              json['replacement_reason'] as String,
            )
          : null,
      secondLine: json['second_line'] != null
          ? PostIssuingCardsRequestSecondLine.fromJson(
              json['second_line'] as Map<String, dynamic>,
            )
          : null,
      shipping: json['shipping'] != null
          ? PostIssuingCardsRequestShipping.fromJson(
              json['shipping'] as Map<String, dynamic>,
            )
          : null,
      spendingControls: json['spending_controls'] != null
          ? PostIssuingCardsRequestSpendingControls.fromJson(
              json['spending_controls'] as Map<String, dynamic>,
            )
          : null,
      status: json['status'] != null
          ? PostIssuingCardsRequestStatus.fromJson(json['status'] as String)
          : null,
  ...
  PostIssuingCardsRequest copyWith({
    String Function()? cardholder,
    String? currency,
    int Function()? expMonth,
    int Function()? expYear,
    List<String> Function()? expand,
    String Function()? financialAccount,
    Map<String, String> Function()? metadata,
    String Function()? personalizationDesign,
    PostIssuingCardsRequestPin Function()? pin,
    String Function()? replacementFor,
    PostIssuingCardsRequestReplacementReason Function()? replacementReason,
    PostIssuingCardsRequestSecondLine Function()? secondLine,
    PostIssuingCardsRequestShipping Function()? shipping,
    PostIssuingCardsRequestSpendingControls Function()? spendingControls,
    PostIssuingCardsRequestStatus Function()? status,
    PostIssuingCardsRequestType? type,
  }) {
    return PostIssuingCardsRequest(
