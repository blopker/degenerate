...
final class SubscriptionStatus {
  ...
  factory SubscriptionStatus.fromJson(String json) {
    return switch (json) {
      'active' => active,
      'canceled' => canceled,
  ...
  static const SubscriptionStatus incomplete = SubscriptionStatus._(
    'incomplete',
  );

  static const SubscriptionStatus incompleteExpired = SubscriptionStatus._(
    'incomplete_expired',
  );
  ...
  static const List<SubscriptionStatus> values = [
    active,
    canceled,
    incomplete,
    incompleteExpired,
