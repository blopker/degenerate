...
///
final class PersonRequirements {
  ...
  factory PersonRequirements.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'PersonRequirements(alternatives: $alternatives, currentlyDue: $currentlyDue, errors: $errors, eventuallyDue: $eventuallyDue, pastDue: $pastDue, pendingVerification: $pendingVerification)';
  }
}
