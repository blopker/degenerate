...
import 'payment_method_details_us_bank_account_account_holder_type.dart';import 'payment_method_details_us_bank_account_account_type.dart';import 'payment_method_details_us_bank_account_mandate.dart';/// 
...
factory PaymentMethodDetailsUsBankAccount.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsUsBankAccount(
  ...
  mandate: json['mandate'] != null
        ? PaymentMethodDetailsUsBankAccountMandate.fromJson(json['mandate'] as Map<String, dynamic>)
        : null,
