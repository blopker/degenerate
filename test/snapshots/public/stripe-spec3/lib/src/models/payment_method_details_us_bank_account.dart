...
///
final class PaymentMethodDetailsUsBankAccount {
  const PaymentMethodDetailsUsBankAccount({
  ...
  factory PaymentMethodDetailsUsBankAccount.fromJson(
    Map<String, dynamic> json,
  ) {
    return PaymentMethodDetailsUsBankAccount(
      accountHolderType: json['account_holder_type'] != null
          ? PaymentMethodDetailsUsBankAccountAccountHolderType.fromJson(
              json['account_holder_type'] as String,
            )
          : null,
      accountType: json['account_type'] != null
          ? PaymentMethodDetailsUsBankAccountAccountType.fromJson(
      ...
      mandate: json['mandate'] != null
          ? PaymentMethodDetailsUsBankAccountMandate.fromJson(
  ...
  PaymentMethodDetailsUsBankAccount copyWith({
    PaymentMethodDetailsUsBankAccountAccountHolderType? Function()?
    accountHolderType,
    PaymentMethodDetailsUsBankAccountAccountType? Function()? accountType,
    String? Function()? bankName,
    String Function()? expectedDebitDate,
    String? Function()? fingerprint,
    String? Function()? last4,
    PaymentMethodDetailsUsBankAccountMandate Function()? mandate,
  ...
  @override
  String toString() {
    return 'PaymentMethodDetailsUsBankAccount(accountHolderType: $accountHolderType, accountType: $accountType, bankName: $bankName, expectedDebitDate: $expectedDebitDate, fingerprint: $fingerprint, last4: $last4, mandate: $mandate, paymentReference: $paymentReference, routingNumber: $routingNumber)';
  }
}
