...
import 'post_subscription_schedules_request_phases_duration_interval.dart';final class PostSubscriptionSchedulesRequestPhasesDuration {const PostSubscriptionSchedulesRequestPhasesDuration({required this.interval, this.intervalCount, });
