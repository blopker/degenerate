...
///
final class OutboundPaymentsPaymentMethodDetailsUsBankAccount {
  ...
  factory OutboundPaymentsPaymentMethodDetailsUsBankAccount.fromJson(
    Map<String, dynamic> json,
  ) {
    return OutboundPaymentsPaymentMethodDetailsUsBankAccount(
      accountHolderType: json['account_holder_type'] != null
          ? OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountHolderType.fromJson(
              json['account_holder_type'] as String,
            )
          : null,
      accountType: json['account_type'] != null
          ? OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountType.fromJson(
      ...
      mandate: json['mandate'] != null
          ? OutboundPaymentsPaymentMethodDetailsUsBankAccountMandate.fromJson(
  ...
  final OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountHolderType?
  accountHolderType;

  /// Account type: checkings or savings. Defaults to checking if omitted.
  final OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountType?
  accountType;
  ...
  OutboundPaymentsPaymentMethodDetailsUsBankAccount copyWith({
    OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountHolderType?
    Function()?
    accountHolderType,
    OutboundPaymentsPaymentMethodDetailsUsBankAccountAccountType? Function()?
    accountType,
    String? Function()? bankName,
    String? Function()? fingerprint,
    String? Function()? last4,
    OutboundPaymentsPaymentMethodDetailsUsBankAccountMandate Function()?
    mandate,
  ...
  @override
  String toString() {
    return 'OutboundPaymentsPaymentMethodDetailsUsBankAccount(accountHolderType: $accountHolderType, accountType: $accountType, bankName: $bankName, fingerprint: $fingerprint, last4: $last4, mandate: $mandate, network: $network, routingNumber: $routingNumber)';
  }
}
