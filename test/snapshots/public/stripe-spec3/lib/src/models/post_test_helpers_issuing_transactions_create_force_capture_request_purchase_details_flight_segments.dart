...
final class PostTestHelpersIssuingTransactionsCreateForceCaptureRequestPurchaseDetailsFlightSegments {
  ...
  factory PostTestHelpersIssuingTransactionsCreateForceCaptureRequestPurchaseDetailsFlightSegments.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostTestHelpersIssuingTransactionsCreateForceCaptureRequestPurchaseDetailsFlightSegments(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is PostTestHelpersIssuingTransactionsCreateForceCaptureRequestPurchaseDetailsFlightSegments &&
  ...
  @override
  String toString() {
    return 'PostTestHelpersIssuingTransactionsCreateForceCaptureRequestPurchaseDetailsFlightSegments(arrivalAirportCode: $arrivalAirportCode, carrier: $carrier, departureAirportCode: $departureAirportCode, flightNumber: $flightNumber, serviceClass: $serviceClass, stopoverAllowed: $stopoverAllowed)';
  }
}
