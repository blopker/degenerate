...
import 'radar_value_list_item_type.dart';
import 'radar_value_list_list_items.dart';
import 'radar_value_list_object.dart';

/// Value lists allow you to group values together which can then be referenced in rules.
///
/// Related guide: [Default Stripe lists](https://docs.stripe.com/radar/lists#managing-list-items)
final class RadarValueList {
  const RadarValueList({
    required this.alias,
  ...
  factory RadarValueList.fromJson(Map<String, dynamic> json) {
    return RadarValueList(
      ...
      listItems: RadarValueListListItems.fromJson(
        json['list_items'] as Map<String, dynamic>,
      ),
  ...
  RadarValueList copyWith({
    String? alias,
    int? created,
    String? createdBy,
    String? id,
    RadarValueListItemType? itemType,
    RadarValueListListItems? listItems,
    bool? livemode,
    Map<String, String>? metadata,
    String? name,
    RadarValueListObject? object,
  }) {
    return RadarValueList(
  ...
  @override
  String toString() {
    return 'RadarValueList(alias: $alias, created: $created, createdBy: $createdBy, id: $id, itemType: $itemType, listItems: $listItems, livemode: $livemode, metadata: $metadata, name: $name, object: $object)';
  }
}
