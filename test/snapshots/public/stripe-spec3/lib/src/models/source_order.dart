...
final class SourceOrder {
  ...
  factory SourceOrder.fromJson(Map<String, dynamic> json) {
    return SourceOrder(
      amount: (json['amount'] as num).toInt(),
      currency: json['currency'] as String,
      email: json['email'] as String?,
      items: (json['items'] as List<dynamic>?)
          ?.map((e) => SourceOrderItem.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  SourceOrder copyWith({
    ...
    List<SourceOrderItem>? Function()? items,
  ...
  @override
  String toString() {
    return 'SourceOrder(amount: $amount, currency: $currency, email: $email, items: $items, shipping: $shipping)';
  }
}
