...
final class SourceTypeCard {
  ...
  factory SourceTypeCard.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'SourceTypeCard(addressLine1Check: $addressLine1Check, addressZipCheck: $addressZipCheck, brand: $brand, country: $country, cvcCheck: $cvcCheck, dynamicLast4: $dynamicLast4, expMonth: $expMonth, expYear: $expYear, fingerprint: $fingerprint, funding: $funding, last4: $last4, name: $name, threeDSecure: $threeDSecure, tokenizationMethod: $tokenizationMethod)';
  }
}
