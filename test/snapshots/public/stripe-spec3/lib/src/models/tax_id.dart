...
import 'tax_id_owner.dart';
import 'tax_id_type.dart';
import 'tax_id_verification2.dart';
...
final class TaxId {
  ...
  TaxId copyWith({
    ...
    int? created,
    TaxIdCustomer? Function()? customer,
    String? Function()? customerAccount,
    String? id,
    bool? livemode,
    TaxIdObject? object,
    TaxIdOwner? Function()? owner,
    TaxIdType? type,
    String? value,
    TaxIdVerification2? Function()? verification,
  }) {
    return TaxId(
  ...
  @override
  String toString() {
    return 'TaxId(country: $country, created: $created, customer: $customer, customerAccount: $customerAccount, id: $id, livemode: $livemode, object: $object, owner: $owner, type: $type, value: $value, verification: $verification)';
  }
}
