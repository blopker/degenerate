...
import 'post_prices_request_tiers_up_to.dart';final class PostPricesRequestTiers {const PostPricesRequestTiers({this.flatAmount, this.flatAmountDecimal, this.unitAmount, this.unitAmountDecimal, required this.upTo, });
...
factory PostPricesRequestTiers.fromJson(Map<String, dynamic> json) { return PostPricesRequestTiers(
  ...
  upTo: PostPricesRequestTiersUpTo.fromJson(json['up_to'] as Map<String, dynamic>),
); }
