...
import 'payment_method_us_bank_account_networks.dart';
import 'payment_method_us_bank_account_status_details2.dart';

///
final class PaymentMethodUsBankAccount {
  const PaymentMethodUsBankAccount({
  ...
  factory PaymentMethodUsBankAccount.fromJson(Map<String, dynamic> json) {
    return PaymentMethodUsBankAccount(
      accountHolderType: json['account_holder_type'] != null
          ? PaymentMethodUsBankAccountAccountHolderType.fromJson(
              json['account_holder_type'] as String,
            )
          : null,
      accountType: json['account_type'] != null
          ? PaymentMethodUsBankAccountAccountType.fromJson(
      ...
      statusDetails: json['status_details'] != null
          ? PaymentMethodUsBankAccountStatusDetails2.fromJson(
  ...
  PaymentMethodUsBankAccount copyWith({
    PaymentMethodUsBankAccountAccountHolderType? Function()? accountHolderType,
    PaymentMethodUsBankAccountAccountType? Function()? accountType,
    String? Function()? bankName,
    String? Function()? financialConnectionsAccount,
    String? Function()? fingerprint,
    String? Function()? last4,
    PaymentMethodUsBankAccountNetworks? Function()? networks,
    String? Function()? routingNumber,
    PaymentMethodUsBankAccountStatusDetails2? Function()? statusDetails,
  }) {
    return PaymentMethodUsBankAccount(
  ...
  @override
  String toString() {
    return 'PaymentMethodUsBankAccount(accountHolderType: $accountHolderType, accountType: $accountType, bankName: $bankName, financialConnectionsAccount: $financialConnectionsAccount, fingerprint: $fingerprint, last4: $last4, networks: $networks, routingNumber: $routingNumber, statusDetails: $statusDetails)';
  }
}
