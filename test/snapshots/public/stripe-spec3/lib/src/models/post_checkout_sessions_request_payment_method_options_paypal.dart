...
import 'post_checkout_sessions_request_payment_method_options_paypal_capture_method.dart';import 'post_checkout_sessions_request_payment_method_options_paypal_preferred_locale.dart';import 'post_checkout_sessions_request_payment_method_options_paypal_setup_future_usage.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsPaypal {const PostCheckoutSessionsRequestPaymentMethodOptionsPaypal({this.captureMethod, this.preferredLocale, this.reference, this.riskCorrelationId, this.setupFutureUsage, });
