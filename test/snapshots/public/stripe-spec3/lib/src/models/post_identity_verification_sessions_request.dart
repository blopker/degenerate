...
import 'post_identity_verification_sessions_request_options.dart';
import 'post_identity_verification_sessions_request_provided_details.dart';
import 'post_identity_verification_sessions_request_related_person.dart';
import 'post_identity_verification_sessions_request_type.dart';

final class PostIdentityVerificationSessionsRequest {
  const PostIdentityVerificationSessionsRequest({
  ...
  factory PostIdentityVerificationSessionsRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostIdentityVerificationSessionsRequest(
      ...
      options: json['options'] != null
          ? PostIdentityVerificationSessionsRequestOptions.fromJson(
              json['options'] as Map<String, dynamic>,
            )
          : null,
      providedDetails: json['provided_details'] != null
          ? PostIdentityVerificationSessionsRequestProvidedDetails.fromJson(
      ...
      relatedPerson: json['related_person'] != null
          ? PostIdentityVerificationSessionsRequestRelatedPerson.fromJson(
              json['related_person'] as Map<String, dynamic>,
            )
          : null,
      returnUrl: json['return_url'] as String?,
      type: json['type'] != null
          ? PostIdentityVerificationSessionsRequestType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  PostIdentityVerificationSessionsRequest copyWith({
    String Function()? clientReferenceId,
    List<String> Function()? expand,
    Map<String, String> Function()? metadata,
    PostIdentityVerificationSessionsRequestOptions Function()? options,
    PostIdentityVerificationSessionsRequestProvidedDetails Function()?
    providedDetails,
    String Function()? relatedCustomer,
    String Function()? relatedCustomerAccount,
    PostIdentityVerificationSessionsRequestRelatedPerson Function()?
    relatedPerson,
    String Function()? returnUrl,
    PostIdentityVerificationSessionsRequestType Function()? type,
