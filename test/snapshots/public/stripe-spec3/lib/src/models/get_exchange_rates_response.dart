...
import 'get_exchange_rates_response_object.dart';

///
final class GetExchangeRatesResponse {
  ...
  factory GetExchangeRatesResponse.fromJson(Map<String, dynamic> json) {
  ...
  GetExchangeRatesResponse copyWith({
    ...
    bool? hasMore,
    GetExchangeRatesResponseObject? object,
    String? url,
  }) {
    return GetExchangeRatesResponse(
      data: data ?? this.data,
  ...
  @override
  String toString() {
    return 'GetExchangeRatesResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)';
  }
}
