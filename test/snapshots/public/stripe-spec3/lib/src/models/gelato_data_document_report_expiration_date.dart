...
/// Point in Time
final class GelatoDataDocumentReportExpirationDate {
  const GelatoDataDocumentReportExpirationDate({
    this.day,
    this.month,
    this.year,
  });

  factory GelatoDataDocumentReportExpirationDate.fromJson(
  ...
  GelatoDataDocumentReportExpirationDate copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'GelatoDataDocumentReportExpirationDate(day: $day, month: $month, year: $year)';
  }
}
