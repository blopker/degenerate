...
import 'package:collection/collection.dart';import 'post_test_helpers_treasury_received_debits_request_initiating_payment_method_details.dart';import 'post_test_helpers_treasury_received_debits_request_network.dart';final class PostTestHelpersTreasuryReceivedDebitsRequest {const PostTestHelpersTreasuryReceivedDebitsRequest({required this.amount, required this.currency, this.description, this.expand, required this.financialAccount, this.initiatingPaymentMethodDetails, required this.network, });
...
factory PostTestHelpersTreasuryReceivedDebitsRequest.fromJson(Map<String, dynamic> json) { return PostTestHelpersTreasuryReceivedDebitsRequest(
  ...
  initiatingPaymentMethodDetails: json['initiating_payment_method_details'] != null
        ? PostTestHelpersTreasuryReceivedDebitsRequestInitiatingPaymentMethodDetails.fromJson(json['initiating_payment_method_details'] as Map<String, dynamic>)
        : null,
