...
///
final class GelatoReportDocumentOptions {
  const GelatoReportDocumentOptions({
    this.allowedTypes,
  ...
  factory GelatoReportDocumentOptions.fromJson(Map<String, dynamic> json) {
    return GelatoReportDocumentOptions(
      allowedTypes: (json['allowed_types'] as List<dynamic>?)
          ?.map(
            (e) =>
                GelatoReportDocumentOptionsAllowedTypes.fromJson(e as String),
          )
          .toList(),
  ...
  GelatoReportDocumentOptions copyWith({
    List<GelatoReportDocumentOptionsAllowedTypes> Function()? allowedTypes,
  ...
  @override
  String toString() {
    return 'GelatoReportDocumentOptions(allowedTypes: $allowedTypes, requireIdNumber: $requireIdNumber, requireLiveCapture: $requireLiveCapture, requireMatchingSelfie: $requireMatchingSelfie)';
  }
}
