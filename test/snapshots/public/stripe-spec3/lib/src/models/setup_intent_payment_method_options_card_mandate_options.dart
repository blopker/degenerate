...
///
final class SetupIntentPaymentMethodOptionsCardMandateOptions {
  const SetupIntentPaymentMethodOptionsCardMandateOptions({
  ...
  factory SetupIntentPaymentMethodOptionsCardMandateOptions.fromJson(
    Map<String, dynamic> json,
  ) {
    return SetupIntentPaymentMethodOptionsCardMandateOptions(
      amount: (json['amount'] as num).toInt(),
      amountType:
          SetupIntentPaymentMethodOptionsCardMandateOptionsAmountType.fromJson(
      ...
      endDate: json['end_date'] != null
          ...
          : null,
      interval:
          SetupIntentPaymentMethodOptionsCardMandateOptionsInterval.fromJson(
      ...
      supportedTypes: (json['supported_types'] as List<dynamic>?)
          ?.map(
            (e) =>
                SetupIntentPaymentMethodOptionsCardMandateOptionsSupportedTypes.fromJson(
                  e as String,
                ),
          )
          .toList(),
  ...
  final List<SetupIntentPaymentMethodOptionsCardMandateOptionsSupportedTypes>?
  supportedTypes;
  ...
  SetupIntentPaymentMethodOptionsCardMandateOptions copyWith({
    int? amount,
    ...
    String? reference,
    int? startDate,
    List<SetupIntentPaymentMethodOptionsCardMandateOptionsSupportedTypes>?
    Function()?
    supportedTypes,
  }) {
    return SetupIntentPaymentMethodOptionsCardMandateOptions(
  ...
  @override
  String toString() {
    return 'SetupIntentPaymentMethodOptionsCardMandateOptions(amount: $amount, amountType: $amountType, currency: $currency, description: $description, endDate: $endDate, interval: $interval, intervalCount: $intervalCount, reference: $reference, startDate: $startDate, supportedTypes: $supportedTypes)';
  }
}
