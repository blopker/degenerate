...
/// Point in Time
final class GelatoDataVerifiedOutputsDate {
  const GelatoDataVerifiedOutputsDate({this.day, this.month, this.year});

  factory GelatoDataVerifiedOutputsDate.fromJson(Map<String, dynamic> json) {
  ...
  GelatoDataVerifiedOutputsDate copyWith({
    int? Function()? day,
    int? Function()? month,
    int? Function()? year,
  }) {
  ...
  @override
  String toString() {
    return 'GelatoDataVerifiedOutputsDate(day: $day, month: $month, year: $year)';
  }
}
