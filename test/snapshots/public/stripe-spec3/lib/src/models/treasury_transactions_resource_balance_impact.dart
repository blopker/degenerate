...
final class TreasuryTransactionsResourceBalanceImpact {
  const TreasuryTransactionsResourceBalanceImpact({
    required this.cash,
    required this.inboundPending,
    required this.outboundPending,
  });

  factory TreasuryTransactionsResourceBalanceImpact.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('cash') &&
        ...
        json['inbound_pending'] is num &&
        json.containsKey('outbound_pending') &&
        json['outbound_pending'] is num;
  }

  TreasuryTransactionsResourceBalanceImpact copyWith({
    int? cash,
    int? inboundPending,
    int? outboundPending,
  }) {
  ...
  @override
  String toString() {
    return 'TreasuryTransactionsResourceBalanceImpact(cash: $cash, inboundPending: $inboundPending, outboundPending: $outboundPending)';
  }
}
