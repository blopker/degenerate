...
import 'balance_settings_resource_payouts_schedule.dart';
import 'balance_settings_resource_payouts_status.dart';

///
final class BalanceSettingsResourcePayouts {
  const BalanceSettingsResourcePayouts({
  ...
  factory BalanceSettingsResourcePayouts.fromJson(Map<String, dynamic> json) {
    return BalanceSettingsResourcePayouts(
      minimumBalanceByCurrency:
          (json['minimum_balance_by_currency'] as Map<String, dynamic>?)?.map(
            (k, v) => MapEntry(k, (v as num).toInt()),
          ),
      schedule: json['schedule'] != null
          ? BalanceSettingsResourcePayoutsSchedule.fromJson(
              json['schedule'] as Map<String, dynamic>,
            )
          : null,
      statementDescriptor: json['statement_descriptor'] as String?,
      status: BalanceSettingsResourcePayoutsStatus.fromJson(
  ...
  BalanceSettingsResourcePayouts copyWith({
    Map<String, int>? Function()? minimumBalanceByCurrency,
    BalanceSettingsResourcePayoutsSchedule? Function()? schedule,
  ...
  @override
  String toString() {
    return 'BalanceSettingsResourcePayouts(minimumBalanceByCurrency: $minimumBalanceByCurrency, schedule: $schedule, statementDescriptor: $statementDescriptor, status: $status)';
  }
}
