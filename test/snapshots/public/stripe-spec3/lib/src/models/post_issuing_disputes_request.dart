...
import 'package:collection/collection.dart';import 'post_issuing_disputes_request_evidence.dart';import 'post_issuing_disputes_request_treasury.dart';final class PostIssuingDisputesRequest {const PostIssuingDisputesRequest({this.amount, this.evidence, this.expand, this.metadata, this.transaction, this.treasury, });
