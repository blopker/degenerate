...
final class PetsApi {
  ...
  ///
  /// `GET /pets`
  Future<ApiResult<List<Pet>>> listPets({int? limit}) async {
  ...
  ///
  /// `POST /pets`
  Future<ApiResult<void>> createPets({required Pet body}) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/pets',
  ...
  ///
  /// `GET /pets/{petId}`
  Future<ApiResult<Pet>> showPetById({required String petId}) async {
    final request = ApiRequest(
      method: 'GET',
