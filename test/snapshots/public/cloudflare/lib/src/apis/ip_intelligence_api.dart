...
/// IpIntelligenceApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class IpIntelligenceApi {
  const IpIntelligenceApi(this._config);
  ...
  Future<ApiResult<ResponseCommon39>> ipIntelligenceGetIpOverview({
    ...
    final request = ApiRequest(
      ...
      queryParameters: {'ipv4': ?ipv4, 'ipv6': ?ipv6},
    );
