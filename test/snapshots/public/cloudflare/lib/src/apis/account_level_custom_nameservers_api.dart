...
import '../models/dns_custom_nameservers_custom_ns_input.dart';
import '../models/response_common23.dart';

/// AccountLevelCustomNameserversApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AccountLevelCustomNameserversApi {
  const AccountLevelCustomNameserversApi(this._config);
  ...
  Future<ApiResult<ResponseCommon23>>
  accountLevelCustomNameserversListAccountCustomNameservers({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon23.fromJson(
  ...
  accountLevelCustomNameserversAddAccountCustomNameserver({
    required String accountId,
    required DnsCustomNameserversCustomNsInput body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/custom_ns',
  ...
  accountLevelCustomNameserversDeleteAccountCustomNameserver({
    required String customNsId,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/custom_ns/${Uri.encodeComponent(customNsId)}',
      headers: {..._config.defaultHeaders},
    );
