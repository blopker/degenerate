...
import '../models/workers_account_settings.dart';

/// WorkerAccountSettingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkerAccountSettingsApi {
  const WorkerAccountSettingsApi(this._config);
  ...
  workerAccountSettingsFetchWorkerAccountSettings({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/workers/account-settings',
  ...
  workerAccountSettingsCreateWorkerAccountSettings({
    required String accountId,
    required WorkersAccountSettings body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
