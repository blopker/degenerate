...
import '../models/pay_per_crawl_daric_config.dart';
import '../models/pay_per_crawl_get_config_response.dart';
import '../models/pay_per_crawl_query_zones_can_be_enabled_response.dart';
import '../models/pay_per_crawl_zones_can_be_enabled_payload.dart';

/// PpcConfigApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class PpcConfigApi {
  const PpcConfigApi(this._config);
  ...
  Future<ApiResult<NoResultResponse>> payPerCrawlSetZonesCanBeEnabled({
    required String accountId,
    required PayPerCrawlZonesCanBeEnabledPayload body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/pay-per-crawl/zones_can_be_enabled',
  ...
  Future<ApiResult<PayPerCrawlQueryZonesCanBeEnabledResponse>>
  payPerCrawlQueryZonesCanBeEnabled({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/pay-per-crawl/zones_can_be_enabled/query',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      body: jsonEncode(body.toJson()),
    );
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return PayPerCrawlQueryZonesCanBeEnabledResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<PayPerCrawlGetConfigResponse>> payPerCrawlGetConfig({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return PayPerCrawlGetConfigResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<PayPerCrawlGetConfigResponse>> payPerCrawlCreateConfig({
    required String zoneId,
    required PayPerCrawlDaricConfig body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/pay-per-crawl/configuration',
  ...
  Future<ApiResult<PayPerCrawlGetConfigResponse>> payPerCrawlPatchConfig({
    required String zoneId,
    required PayPerCrawlDaricConfig body,
  }) async {
    final request = ApiRequest(
