...
import '../models/stream_watermark_basic_upload.dart';

/// StreamWatermarkProfileApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class StreamWatermarkProfileApi {
  const StreamWatermarkProfileApi(this._config);
  ...
  streamWatermarkProfileCreateWatermarkProfilesViaBasicUpload({
    required String accountId,
    required StreamWatermarkBasicUpload body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/stream/watermarks',
  ...
  Future<ApiResult<ResponseCommon66>> streamWatermarkProfileDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/stream/watermarks/${Uri.encodeComponent(identifier)}',
      headers: {..._config.defaultHeaders},
    );
