...
import '../models/create_app_request.dart';
import '../models/create_app_response.dart';
import '../models/get_apps_response.dart';
...
final class AppsApi {
  ...
  Future<ApiResult<GetAppsResponse>> getApps({
  ...
  Future<ApiResult<CreateAppResponse>> createApp({
    required String accountId,
