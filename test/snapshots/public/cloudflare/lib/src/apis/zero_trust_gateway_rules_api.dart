...
import '../models/zero_trust_gateway_rules_create_zero_trust_gateway_rule_request.dart';
import '../models/zero_trust_gateway_rules_update_zero_trust_gateway_rule_request.dart';

/// ZeroTrustGatewayRulesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZeroTrustGatewayRulesApi {
  const ZeroTrustGatewayRulesApi(this._config);
  ...
  zeroTrustGatewayRulesCreateZeroTrustGatewayRule({
    required String accountId,
    required ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/gateway/rules',
  ...
  zeroTrustGatewayRulesZeroTrustGatewayRuleDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/rules/${Uri.encodeComponent(ruleId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  zeroTrustGatewayRulesUpdateZeroTrustGatewayRule({
    required String ruleId,
    required String accountId,
    required ZeroTrustGatewayRulesUpdateZeroTrustGatewayRuleRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  zeroTrustGatewayRulesResetExpirationZeroTrustGatewayRule({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/rules/${Uri.encodeComponent(ruleId)}/reset_expiration',
      headers: {..._config.defaultHeaders},
    );
