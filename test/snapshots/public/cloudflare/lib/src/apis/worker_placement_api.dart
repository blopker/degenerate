...
/// WorkerPlacementApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkerPlacementApi {
  const WorkerPlacementApi(this._config);
  ...
  Future<ApiResult<ResponseCommon80>> workerPlacementListRegions({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/workers/placement/regions',
