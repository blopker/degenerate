...
import '../models/m_tls_certificate_management_upload_m_tls_certificate_request.dart';
import '../models/response_common68.dart';

/// MTlsCertificateManagementApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MTlsCertificateManagementApi {
  const MTlsCertificateManagementApi(this._config);
  ...
  mTlsCertificateManagementUploadMTlsCertificate({
    required String accountId,
    required MTlsCertificateManagementUploadMTlsCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/mtls_certificates',
  ...
  mTlsCertificateManagementGetMTlsCertificate({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/mtls_certificates/${Uri.encodeComponent(mtlsCertificateId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  mTlsCertificateManagementListMTlsCertificateAssociations({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/mtls_certificates/${Uri.encodeComponent(mtlsCertificateId)}/associations',
      headers: {..._config.defaultHeaders},
    );
