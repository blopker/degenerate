...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/radar_get_netflows_summary_dimension.dart';import '../models/radar_get_netflows_summary_format.dart';import '../models/radar_get_netflows_summary_product.dart';import '../models/radar_get_netflows_summary_response.dart';import '../models/radar_get_netflows_timeseries_agg_interval.dart';import '../models/radar_get_netflows_timeseries_format.dart';import '../models/radar_get_netflows_timeseries_group_agg_interval.dart';import '../models/radar_get_netflows_timeseries_group_dimension.dart';import '../models/radar_get_netflows_timeseries_group_format.dart';import '../models/radar_get_netflows_timeseries_group_normalization.dart';import '../models/radar_get_netflows_timeseries_group_product.dart';import '../models/radar_get_netflows_timeseries_group_response.dart';import '../models/radar_get_netflows_timeseries_normalization.dart';import '../models/radar_get_netflows_timeseries_product.dart';import '../models/radar_get_netflows_timeseries_response.dart';import '../models/radar_get_netflows_top_ases_format.dart';import '../models/radar_get_netflows_top_ases_response.dart';import '../models/radar_get_netflows_top_locations_format.dart';import '../models/radar_get_netflows_top_locations_response.dart';/// RadarNetFlowsApi operations.
///
...
Future<ApiResult<RadarGetNetflowsSummaryResponse>> radarGetNetflowsSummary({required RadarGetNetflowsSummaryDimension dimension, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, List<String>? geoId, List<RadarGetNetflowsSummaryProduct>? product, int? limitPerGroup, RadarGetNetflowsSummaryFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetNetflowsTimeseriesResponse>> radarGetNetflowsTimeseries({RadarGetNetflowsTimeseriesAggInterval? aggInterval, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<RadarGetNetflowsTimeseriesProduct>? product, List<String>? asn, List<String>? location, List<String>? continent, List<String>? geoId, RadarGetNetflowsTimeseriesNormalization? normalization, RadarGetNetflowsTimeseriesFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetNetflowsTopLocationsResponse>> radarGetNetflowsTopLocations({int? limit, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, List<String>? geoId, RadarGetNetflowsTopLocationsFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
