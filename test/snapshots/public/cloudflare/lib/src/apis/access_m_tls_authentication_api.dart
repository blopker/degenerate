...
import '../models/access_mtls_authentication_add_an_mtls_certificate_request.dart';
import '../models/access_mtls_authentication_update_an_mtls_certificate_request.dart';
import '../models/access_mtls_authentication_update_an_mtls_certificate_settings_request.dart';
import '../models/response_common3.dart';

/// AccessMTlsAuthenticationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AccessMTlsAuthenticationApi {
  const AccessMTlsAuthenticationApi(this._config);
  ...
  accessMtlsAuthenticationAddAnMtlsCertificate({
    required String accountId,
    required AccessMtlsAuthenticationAddAnMtlsCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/access/certificates',
  ...
  accessMtlsAuthenticationGetAnMtlsCertificate({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/access/certificates/${Uri.encodeComponent(certificateId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  accessMtlsAuthenticationUpdateAnMtlsCertificate({
    required String certificateId,
    required String accountId,
    required AccessMtlsAuthenticationUpdateAnMtlsCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  accessMtlsAuthenticationListMtlsCertificatesHostnameSettings({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/access/certificates/settings',
      headers: {..._config.defaultHeaders},
    );
  ...
  accessMtlsAuthenticationUpdateAnMtlsCertificateSettings({
    required String accountId,
    required AccessMtlsAuthenticationUpdateAnMtlsCertificateSettingsRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
