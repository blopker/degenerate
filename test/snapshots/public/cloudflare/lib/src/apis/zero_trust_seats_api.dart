...
import '../models/access_seat.dart';
import '../models/response_common3.dart';

/// ZeroTrustSeatsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZeroTrustSeatsApi {
  const ZeroTrustSeatsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon3>> zeroTrustSeatsUpdateAUserSeat({
    required String accountId,
    required List<AccessSeat> body,
  }) async {
