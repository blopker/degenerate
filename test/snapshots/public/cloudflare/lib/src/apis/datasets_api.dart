...
import '../models/post_dataset_populate_response.dart';

/// DatasetsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DatasetsApi {
  const DatasetsApi(this._config);
  ...
  Future<ApiResult<PostDatasetPopulateResponse>> postDatasetPopulate({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/datasets/populate',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return PostDatasetPopulateResponse.fromJson(
