...
import '../models/devices_create_device_settings_policy_request.dart';
import '../models/devices_update_default_device_settings_policy_request.dart';
import '../models/devices_update_device_settings_policy_request.dart';
import '../models/response_common67.dart';
import '../models/teams_devices_devices_policy_certificates.dart';
import '../models/teams_devices_fallback_domain.dart';
import '../models/teams_devices_split_tunnel.dart';
import '../models/teams_devices_split_tunnel_include.dart';

/// DevicesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DevicesApi {
  const DevicesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon67>> devicesListDeviceSettingsPolicies({
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetDefaultDeviceSettingsPolicy({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon67>> devicesCreateDeviceSettingsPolicy({
    required String accountId,
    required DevicesCreateDeviceSettingsPolicyRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/devices/policy',
  ...
  Future<ApiResult<ResponseCommon67>> devicesUpdateDefaultDeviceSettingsPolicy({
    required String accountId,
    required DevicesUpdateDefaultDeviceSettingsPolicyRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/accounts/${Uri.encodeComponent(accountId)}/devices/policy',
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetDeviceSettingsPolicyById({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/${Uri.encodeComponent(policyId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon67>> devicesUpdateDeviceSettingsPolicy({
    required String policyId,
    required String accountId,
    required DevicesUpdateDeviceSettingsPolicyRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
  ...
  Future<ApiResult<ResponseCommon67>> devicesDeleteDeviceSettingsPolicy({
    required String policyId,
    required String accountId,
  }) async {
    final request = ApiRequest(
  ...
  devicesGetSplitTunnelExcludeListForADeviceSettingsPolicy({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/${Uri.encodeComponent(policyId)}/exclude',
      headers: {..._config.defaultHeaders},
    );
  ...
  devicesSetSplitTunnelExcludeListForADeviceSettingsPolicy({
    required String policyId,
    required String accountId,
    required List<TeamsDevicesSplitTunnel> body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  devicesGetLocalDomainFallbackListForADeviceSettingsPolicy({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/${Uri.encodeComponent(policyId)}/fallback_domains',
      headers: {..._config.defaultHeaders},
    );
  ...
  devicesSetLocalDomainFallbackListForADeviceSettingsPolicy({
    required String policyId,
    required String accountId,
    required List<TeamsDevicesFallbackDomain> body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  devicesGetSplitTunnelIncludeListForADeviceSettingsPolicy({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/${Uri.encodeComponent(policyId)}/include',
      headers: {..._config.defaultHeaders},
    );
  ...
  devicesSetSplitTunnelIncludeListForADeviceSettingsPolicy({
    required String policyId,
    required String accountId,
    required List<TeamsDevicesSplitTunnelInclude> body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetSplitTunnelExcludeList({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/exclude',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon67>> devicesSetSplitTunnelExcludeList({
    required String accountId,
    required List<TeamsDevicesSplitTunnel> body,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetLocalDomainFallbackList({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/fallback_domains',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon67>> devicesSetLocalDomainFallbackList({
    required String accountId,
    required List<TeamsDevicesFallbackDomain> body,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetSplitTunnelIncludeList({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/policy/include',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon67>> devicesSetSplitTunnelIncludeList({
    required String accountId,
    required List<TeamsDevicesSplitTunnelInclude> body,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<ResponseCommon67>> devicesGetPolicyCertificates({
  ...
  Future<ApiResult<ResponseCommon67>> devicesUpdatePolicyCertificates({
    required String zoneId,
    required TeamsDevicesDevicesPolicyCertificates body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/devices/policy/certificates',
