...
/// DomainHistoryApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DomainHistoryApi {
  const DomainHistoryApi(this._config);
  ...
  Future<ApiResult<ResponseCommon39>> domainHistoryGetDomainHistory({
