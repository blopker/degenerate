...
import '../models/fraud_fraud_settings.dart';
import '../models/response_common32.dart';

/// FraudDetectionApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class FraudDetectionApi {
  const FraudDetectionApi(this._config);
  ...
  Future<ApiResult<ResponseCommon32>> fraudDetectionZoneGetSettings({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon32.fromJson(
  ...
  Future<ApiResult<ResponseCommon32>> fraudDetectionZoneUpdateSettings({
    required String zoneId,
    required FraudFraudSettings body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path: '/zones/${Uri.encodeComponent(zoneId)}/fraud_detection/settings',
