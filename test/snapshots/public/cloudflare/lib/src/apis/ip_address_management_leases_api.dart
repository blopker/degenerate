...
/// IpAddressManagementLeasesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class IpAddressManagementLeasesApi {
  const IpAddressManagementLeasesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon4>> ipAddressManagementListLeases({
