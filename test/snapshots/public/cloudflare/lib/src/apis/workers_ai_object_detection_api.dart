...
/// WorkersAiObjectDetectionApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiObjectDetectionApi {
  const WorkersAiObjectDetectionApi(this._config);
  ...
  workersAiPostRunCfFacebookNonomniDetrResnet50({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/facebook/nonomni-detr-resnet-50',
