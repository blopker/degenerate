...
import '../models/get_country_read_response.dart';

/// CountryApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CountryApi {
  const CountryApi(this._config);
  ...
  Future<ApiResult<List<GetCountryReadResponse>>> getCountryRead({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/countries',
    ...
    return _execute(
      ...
      onSuccess: (response) {
        ...
        return json
            .map(
              (e) => GetCountryReadResponse.fromJson(e as Map<String, dynamic>),
            )
            .toList();
      },
    );
