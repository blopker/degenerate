...
/// PagesBuildCacheApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class PagesBuildCacheApi {
  const PagesBuildCacheApi(this._config);
  ...
  Future<ApiResult<ResponseCommon51>> pagesPurgeBuildCache({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/pages/projects/${Uri.encodeComponent(projectName)}/purge_build_cache',
