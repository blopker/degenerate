...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/delete_group_delete_response.dart';import '../models/delete_group_member_delete_response.dart';import '../models/get_group_list_response.dart';import '../models/get_group_member_list_response.dart';import '../models/get_group_read_response.dart';import '../models/post_group_create_request.dart';import '../models/post_group_create_response.dart';import '../models/post_group_member_create_request.dart';import '../models/post_group_member_create_response.dart';import '../models/put_group_update_request.dart';import '../models/put_group_update_response.dart';/// GroupsApi operations.
///
...
Future<ApiResult<List<GetGroupListResponse>>> getGroupList({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostGroupCreateResponse>> postGroupCreate({required String accountId, PostGroupCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/-/groups',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<GetGroupReadResponse>> getGroupRead({required String accountId, required String groupId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PutGroupUpdateResponse>> putGroupUpdate({required String accountId, required String groupId, PutGroupUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/-/groups/${Uri.encodeComponent(groupId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<DeleteGroupDeleteResponse>> deleteGroupDelete({required String accountId, required String groupId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/-/groups/${Uri.encodeComponent(groupId)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<GetGroupMemberListResponse>>> getGroupMemberList({required String accountId, required String groupId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostGroupMemberCreateResponse>> postGroupMemberCreate({required String accountId, required String groupId, PostGroupMemberCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/-/groups/${Uri.encodeComponent(groupId)}/members',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<DeleteGroupMemberDeleteResponse>> deleteGroupMemberDelete({required String accountId, required String groupId, required String memberId, }) async  { final request = ApiRequest(
  method: 'DELETE',
