...
import '../models/rulesets_request_rule.dart';
import '../models/rulesets_response.dart';
import '../models/rulesets_ruleset.dart';
import '../models/rulesets_ruleset_phase.dart';

/// AccountRulesetsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AccountRulesetsApi {
  const AccountRulesetsApi(this._config);
  ...
  Future<ApiResult<RulesetsResponse>> listAccountRulesets({
  ...
  Future<ApiResult<RulesetsResponse>> createAccountRuleset({
    required String accountId,
    required RulesetsRuleset body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/rulesets',
  ...
  Future<ApiResult<RulesetsResponse>> getAccountRuleset({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RulesetsResponse>> updateAccountRuleset({
    required String rulesetId,
    required String accountId,
    required RulesetsRuleset body,
  }) async {
  ...
  Future<ApiResult<void>> deleteAccountRuleset({
    required String rulesetId,
    required String accountId,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<RulesetsResponse>> createAccountRulesetRule({
    required String rulesetId,
    required String accountId,
    required RulesetsRequestRule body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}/rules',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      body: jsonEncode(body.toJson()),
    );
  ...
  Future<ApiResult<RulesetsResponse>> updateAccountRulesetRule({
    ...
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}/rules/${Uri.encodeComponent(ruleId)}',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      body: jsonEncode(body.toJson()),
    );
  ...
  Future<ApiResult<RulesetsResponse>> deleteAccountRulesetRule({
    required String ruleId,
    required String rulesetId,
    required String accountId,
  }) async {
  ...
  Future<ApiResult<RulesetsResponse>> listAccountRulesetVersions({
    required String rulesetId,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}/versions',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RulesetsResponse>> getAccountRulesetVersion({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}/versions/${Uri.encodeComponent(rulesetVersion)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> deleteAccountRulesetVersion({
    required String rulesetVersion,
    required String rulesetId,
    required String accountId,
  }) async {
  ...
  Future<ApiResult<RulesetsResponse>> listAccountRulesetVersionRulesByTag({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/${Uri.encodeComponent(rulesetId)}/versions/${Uri.encodeComponent(rulesetVersion)}/by_tag/${Uri.encodeComponent(ruleTag)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RulesetsResponse>> getAccountEntrypointRuleset({
    required RulesetsRulesetPhase rulesetPhase,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/phases/${Uri.encodeComponent(rulesetPhase.toString())}/entrypoint',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RulesetsResponse>> updateAccountEntrypointRuleset({
    required RulesetsRulesetPhase rulesetPhase,
    required String accountId,
    required RulesetsRuleset body,
  }) async {
  ...
  Future<ApiResult<RulesetsResponse>> listAccountEntrypointRulesetVersions({
    required RulesetsRulesetPhase rulesetPhase,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/phases/${Uri.encodeComponent(rulesetPhase.toString())}/entrypoint/versions',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RulesetsResponse>> getAccountEntrypointRulesetVersion({
    required String rulesetVersion,
    required RulesetsRulesetPhase rulesetPhase,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/rulesets/phases/${Uri.encodeComponent(rulesetPhase.toString())}/entrypoint/versions/${Uri.encodeComponent(rulesetVersion)}',
      headers: {..._config.defaultHeaders},
    );
