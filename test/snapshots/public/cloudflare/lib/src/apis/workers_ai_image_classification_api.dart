...
/// WorkersAiImageClassificationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiImageClassificationApi {
  const WorkersAiImageClassificationApi(this._config);
  ...
  workersAiPostRunCfMicrosoftNonomniResnet50({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/microsoft/nonomni-resnet-50',
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfMicrosoftResnet50({
    required String accountId,
    String? queueRequest,
    String? tags,
    Uint8List? body,
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/microsoft/resnet-50',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body),
    );
