...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/delete_event_reference_delete_request.dart';import '../models/delete_event_reference_delete_response.dart';import '../models/delete_event_tag_delete_request.dart';import '../models/delete_event_tag_delete_response.dart';import '../models/get_event_aggregate_dataset_id.dart';import '../models/get_event_aggregate_response.dart';import '../models/get_event_list_get_format.dart';import '../models/get_event_list_get_order.dart';import '../models/get_event_list_get_response.dart';import '../models/get_event_list_get_search.dart';import '../models/get_event_query_alert_list_response.dart';import '../models/get_event_query_alert_read_response.dart';import '../models/get_event_query_list_response.dart';import '../models/get_event_query_read_response.dart';import '../models/get_event_raw_read_ds_response.dart';import '../models/get_event_raw_read_response.dart';import '../models/get_event_read_response.dart';import '../models/get_event_relationships_direction.dart';import '../models/get_event_relationships_relationship_types.dart';import '../models/get_event_relationships_response.dart';import '../models/patch_event_query_alert_update_request.dart';import '../models/patch_event_query_alert_update_response.dart';import '../models/patch_event_query_update_request.dart';import '../models/patch_event_query_update_response.dart';import '../models/patch_event_raw_update_request.dart';import '../models/patch_event_raw_update_response.dart';import '../models/patch_event_update_request.dart';import '../models/patch_event_update_response.dart';import '../models/post_create_event_relationship_request.dart';import '../models/post_create_event_relationship_response.dart';import '../models/post_event_create_bulk_request.dart';import '../models/post_event_create_bulk_response202.dart';import '../models/post_event_create_request.dart';import '../models/post_event_create_response.dart';import '../models/post_event_do_revert_request.dart';import '../models/post_event_do_revert_response.dart';import '../models/post_event_graph_ql_response.dart';import '../models/post_event_move_to_new_ds_request.dart';import '../models/post_event_query_alert_create_request.dart';import '../models/post_event_query_alert_create_response.dart';import '../models/post_event_query_alert_update_request.dart';import '../models/post_event_query_alert_update_response.dart';import '../models/post_event_query_create_request.dart';import '../models/post_event_query_create_response.dart';import '../models/post_event_query_update_request.dart';import '../models/post_event_query_update_response.dart';import '../models/post_event_raw_update_request.dart';import '../models/post_event_raw_update_response.dart';import '../models/post_event_reference_create_request.dart';import '../models/post_event_reference_create_response.dart';import '../models/post_event_tag_create_request.dart';import '../models/post_event_tag_create_response.dart';import '../models/post_event_update_request.dart';import '../models/post_event_update_response.dart';/// EventApi operations.
///
...
Future<ApiResult<double>> deleteEventDelete({required String accountId, required String datasetId, required List<String> eventIds, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<PostEventDoRevertResponse>> postEventDoRevert({required String accountId, required String datasetId, PostEventDoRevertRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostEventUpdateResponse>> postEventUpdate({required String accountId, required String eventId, PostEventUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PatchEventUpdateResponse>> patchEventUpdate({required String accountId, required String eventId, PatchEventUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/${Uri.encodeComponent(eventId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<GetEventRawReadResponse>> getEventRawRead({required String accountId, required String eventId, required String rawId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostEventRawUpdateResponse>> postEventRawUpdate({required String accountId, required String eventId, required String rawId, PostEventRawUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/${Uri.encodeComponent(eventId)}/raw/${Uri.encodeComponent(rawId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<PatchEventRawUpdateResponse>> patchEventRawUpdate({required String accountId, required String eventId, required String rawId, PatchEventRawUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/${Uri.encodeComponent(eventId)}/raw/${Uri.encodeComponent(rawId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<List<GetEventRelationshipsResponse>>> getEventRelationships({required String accountId, required String eventId, GetEventRelationshipsDirection? direction, double? maxDepth, GetEventRelationshipsRelationshipTypes? relationshipTypes, List<String>? indicatorTypeIds, required String datasetId, bool? includeParent, double? page, double? pageSize, }) async  { final request = ApiRequest(
  method: 'GET',
  ...
  queryParameters: {
    ...
    if (relationshipTypes != null) 'relationshipTypes': relationshipTypes.toString(),
    if (indicatorTypeIds != null) 'indicatorTypeIds': indicatorTypeIds.toString(),
    'datasetId': datasetId,
...
Future<ApiResult<GetEventAggregateResponse>> getEventAggregate({required String accountId, required String aggregateBy, GetEventAggregateDatasetId? datasetId, String? startDate, String? endDate, bool? groupByDate, double? limit, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostEventCreateResponse>> postEventCreate({required String accountId, PostEventCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostEventCreateBulkResponse202>> postEventCreateBulk({required String accountId, PostEventCreateBulkRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<GetEventReadResponse>> getEventRead({required String accountId, required String datasetId, required String eventId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<double>> postEventMoveToNewDs({required String accountId, required String datasetId, bool? keepRawData, PostEventMoveToNewDsRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<DeleteEventTagDeleteResponse>> deleteEventTagDelete({required String accountId, required String eventId, DeleteEventTagDeleteRequest? body, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<PostEventTagCreateResponse>> postEventTagCreate({required String accountId, required String eventId, PostEventTagCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<GetEventQueryListResponse>>> getEventQueryList({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetEventQueryReadResponse>> getEventQueryRead({required String accountId, required int queryId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostEventQueryUpdateResponse>> postEventQueryUpdate({required String accountId, required int queryId, PostEventQueryUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/${Uri.encodeComponent(queryId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<PatchEventQueryUpdateResponse>> patchEventQueryUpdate({required String accountId, required int queryId, PatchEventQueryUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/${Uri.encodeComponent(queryId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> deleteEventQueryDelete({required String accountId, required int queryId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/${Uri.encodeComponent(queryId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<GetEventQueryAlertListResponse>>> getEventQueryAlertList({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetEventQueryAlertReadResponse>> getEventQueryAlertRead({required String accountId, required int alertId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PostEventQueryAlertUpdateResponse>> postEventQueryAlertUpdate({required String accountId, required int alertId, PostEventQueryAlertUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/alerts/${Uri.encodeComponent(alertId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<PatchEventQueryAlertUpdateResponse>> patchEventQueryAlertUpdate({required String accountId, required int alertId, PatchEventQueryAlertUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/alerts/${Uri.encodeComponent(alertId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> deleteEventQueryAlertDelete({required String accountId, required int alertId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/queries/alerts/${Uri.encodeComponent(alertId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<PostEventQueryAlertCreateResponse>> postEventQueryAlertCreate({required String accountId, PostEventQueryAlertCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostEventQueryCreateResponse>> postEventQueryCreate({required String accountId, PostEventQueryCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<GetEventRawReadDsResponse>> getEventRawReadDs({required String accountId, required String eventId, required String datasetId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<DeleteEventReferenceDeleteResponse>> deleteEventReferenceDelete({required String accountId, required String eventId, DeleteEventReferenceDeleteRequest? body, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<PostEventReferenceCreateResponse>> postEventReferenceCreate({required String accountId, required String eventId, PostEventReferenceCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostCreateEventRelationshipResponse>> postCreateEventRelationship({required String accountId, PostCreateEventRelationshipRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostEventGraphQlResponse>> postEventGraphQl({required String accountId}) async  { final request = ApiRequest(
  method: 'POST',
