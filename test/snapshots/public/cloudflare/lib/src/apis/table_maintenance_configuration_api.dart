...
import '../models/r2_data_catalog_maintenance_update_params.dart';
import '../models/response_single39.dart';

/// TableMaintenanceConfigurationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class TableMaintenanceConfigurationApi {
  const TableMaintenanceConfigurationApi(this._config);
  ...
  Future<ApiResult<ResponseSingle39>> getTableMaintenanceConfig({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}/namespaces/${Uri.encodeComponent(namespace)}/tables/${Uri.encodeComponent(tableName)}/maintenance-configs',
  ...
  Future<ApiResult<ResponseSingle39>> updateTableMaintenanceConfig({
    required String accountId,
    required String bucketName,
    required String namespace,
    required String tableName,
    required R2DataCatalogMaintenanceUpdateParams body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
