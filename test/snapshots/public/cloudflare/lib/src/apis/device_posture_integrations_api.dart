...
import '../models/device_posture_integrations_create_device_posture_integration_request.dart';
import '../models/device_posture_integrations_update_device_posture_integration_request.dart';
import '../models/response_common67.dart';

/// DevicePostureIntegrationsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DevicePostureIntegrationsApi {
  const DevicePostureIntegrationsApi(this._config);
  ...
  devicePostureIntegrationsListDevicePostureIntegrations({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/posture/integration',
  ...
  devicePostureIntegrationsCreateDevicePostureIntegration({
    required String accountId,
    required DevicePostureIntegrationsCreateDevicePostureIntegrationRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  devicePostureIntegrationsDevicePostureIntegrationDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/devices/posture/integration/${Uri.encodeComponent(integrationId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  devicePostureIntegrationsUpdateDevicePostureIntegration({
    required String integrationId,
    required String accountId,
    required DevicePostureIntegrationsUpdateDevicePostureIntegrationRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
