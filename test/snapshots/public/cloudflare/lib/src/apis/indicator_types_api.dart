...
import '../models/get_indicator_types_list_response.dart';

/// IndicatorTypesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class IndicatorTypesApi {
  const IndicatorTypesApi(this._config);
  ...
  Future<ApiResult<GetIndicatorTypesListResponse>> getIndicatorTypesList({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/indicator-types',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return GetIndicatorTypesListResponse.fromJson(
