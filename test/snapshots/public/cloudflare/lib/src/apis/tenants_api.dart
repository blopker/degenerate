...
import '../models/tenants_list_accounts_response.dart';
import '../models/tenants_list_entitlements_response.dart';
import '../models/tenants_list_memberships_response.dart';
import '../models/tenants_retrieve_tenant_response.dart';
import '../models/tenants_valid_account_types_response.dart';

/// TenantsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class TenantsApi {
  const TenantsApi(this._config);
  ...
  Future<ApiResult<TenantsRetrieveTenantResponse>> tenantsRetrieveTenant({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TenantsRetrieveTenantResponse.fromJson(
  ...
  Future<ApiResult<TenantsValidAccountTypesResponse>> tenantsValidAccountTypes({
    required String tenantId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TenantsValidAccountTypesResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<TenantsListAccountsResponse>> tenantsListAccounts({
    required String tenantId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TenantsListAccountsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<TenantsListEntitlementsResponse>> tenantsListEntitlements({
    required String tenantId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TenantsListEntitlementsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<TenantsListMembershipsResponse>> tenantsListMemberships({
    required String tenantId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TenantsListMembershipsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
