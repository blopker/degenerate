...
import '../models/email_create_destination_address_properties.dart';
import '../models/email_routing_destination_addresses_list_destination_addresses_direction.dart';
import '../models/response_common30.dart';

/// EmailRoutingDestinationAddressesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class EmailRoutingDestinationAddressesApi {
  const EmailRoutingDestinationAddressesApi(this._config);
  ...
  emailRoutingDestinationAddressesListDestinationAddresses({
    ...
    double? page,
    double? perPage,
    EmailRoutingDestinationAddressesListDestinationAddressesDirection?
    direction,
    bool? verified,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/email/routing/addresses',
  ...
  emailRoutingDestinationAddressesCreateADestinationAddress({
    required String accountId,
    required EmailCreateDestinationAddressProperties body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  emailRoutingDestinationAddressesGetADestinationAddress({
    required String destinationAddressIdentifier,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/email/routing/addresses/${Uri.encodeComponent(destinationAddressIdentifier)}',
      headers: {..._config.defaultHeaders},
    );
