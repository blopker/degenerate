...
import '../models/response_common52.dart';

/// CloudflareIPsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CloudflareIPsApi {
  const CloudflareIPsApi(this._config);
  ...
  ///
  /// `GET /ips`
  Future<ApiResult<ResponseCommon52>> cloudflareIpsCloudflareIpDetails({
    String? networks,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon52.fromJson(
