...
import '../models/response_common77.dart';
import '../models/waitingroom_create_rule.dart';
import '../models/waitingroom_patch_rule.dart';
import '../models/waitingroom_query_event.dart';
import '../models/waitingroom_query_preview.dart';
import '../models/waitingroom_query_waitingroom.dart';
import '../models/waitingroom_zone_settings.dart';

/// WaitingRoomApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WaitingRoomApi {
  const WaitingRoomApi(this._config);
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomListWaitingRoomsAccount({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon77.fromJson(
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomListWaitingRooms({
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomCreateWaitingRoom({
    required String zoneId,
    required WaitingroomQueryWaitingroom body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms',
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomUpdateWaitingRoom({
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomQueryWaitingroom body,
  }) async {
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomPatchWaitingRoom({
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomQueryWaitingroom body,
  }) async {
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomDeleteWaitingRoom({
    required String waitingRoomId,
    required String zoneId,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomListEvents({
    required String waitingRoomId,
    required String zoneId,
    double? page,
    double? perPage,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/events',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        if (page != null) 'page': page.toString(),
        if (perPage != null) 'per_page': perPage.toString(),
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomCreateEvent({
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomQueryEvent body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomEventDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/events/${Uri.encodeComponent(eventId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomUpdateEvent({
    required String eventId,
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomQueryEvent body,
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomPatchEvent({
    required String eventId,
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomQueryEvent body,
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomDeleteEvent({
    required String eventId,
    required String waitingRoomId,
    required String zoneId,
  }) async {
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomPreviewActiveEventDetails({
    required String eventId,
    required String waitingRoomId,
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/events/${Uri.encodeComponent(eventId)}/details',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomListWaitingRoomRules({
    required String waitingRoomId,
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/rules',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomCreateWaitingRoomRule({
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomCreateRule body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomReplaceWaitingRoomRules({
    required String waitingRoomId,
    required String zoneId,
    required List<WaitingroomCreateRule> body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomPatchWaitingRoomRule({
    required String ruleId,
    required String waitingRoomId,
    required String zoneId,
    required WaitingroomPatchRule body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/rules/${Uri.encodeComponent(ruleId)}',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      body: jsonEncode(body.toJson()),
    );
  ...
  Future<ApiResult<ResponseCommon77>> waitingRoomDeleteWaitingRoomRule({
    required String ruleId,
    required String waitingRoomId,
    required String zoneId,
  }) async {
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomGetWaitingRoomStatus({
    required String waitingRoomId,
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/${Uri.encodeComponent(waitingRoomId)}/status',
      headers: {..._config.defaultHeaders},
    );
  ...
  waitingRoomCreateACustomWaitingRoomPagePreview({
    required String zoneId,
    required WaitingroomQueryPreview body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomGetZoneSettings({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomUpdateZoneSettings({
    required String zoneId,
    required WaitingroomZoneSettings body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path: '/zones/${Uri.encodeComponent(zoneId)}/waiting_rooms/settings',
  ...
  Future<ApiResult<Map<String, String>>> waitingRoomPatchZoneSettings({
    required String zoneId,
    required WaitingroomZoneSettings body,
  }) async {
    final request = ApiRequest(
