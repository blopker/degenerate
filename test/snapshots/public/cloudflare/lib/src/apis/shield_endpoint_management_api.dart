...
import '../models/schemas_feature.dart';
import '../models/shield_basic_operation.dart';
import '../models/shield_endpoint_management_retrieve_information_about_all_operations_on_a_zone_direction.dart';
import '../models/shield_endpoint_management_retrieve_information_about_all_operations_on_a_zone_feature.dart';
import '../models/shield_endpoint_management_retrieve_information_about_all_operations_on_a_zone_order.dart';
import '../models/shield_endpoint_management_retrieve_information_about_an_operation_feature.dart';
import '../models/shield_object_with_operation_id.dart';

/// ShieldEndpointManagementApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ShieldEndpointManagementApi {
  const ShieldEndpointManagementApi(this._config);
  ...
  apiShieldEndpointManagementRetrieveInformationAboutAllOperationsOnAZone({
    ...
    int? page,
    int? perPage,
    ShieldEndpointManagementRetrieveInformationAboutAllOperationsOnAZoneOrder?
    order,
    ShieldEndpointManagementRetrieveInformationAboutAllOperationsOnAZoneDirection?
    direction,
    List<String>? host,
    List<String>? method,
    String? endpoint,
    List<
      ShieldEndpointManagementRetrieveInformationAboutAllOperationsOnAZoneFeature
    >?
    feature,
  }) async {
  ...
  apiShieldEndpointManagementAddOperationsToAZone({
    required String zoneId,
    required List<ShieldBasicOperation> body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/api_gateway/operations',
  ...
  apiShieldEndpointManagementDeleteMultipleOperations({
    required String zoneId,
    required List<ShieldObjectWithOperationId> body,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
      path: '/zones/${Uri.encodeComponent(zoneId)}/api_gateway/operations',
  ...
  apiShieldEndpointManagementRetrieveInformationAboutAnOperation({
    ...
    List<ShieldEndpointManagementRetrieveInformationAboutAnOperationFeature>?
    feature,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/api_gateway/operations/${Uri.encodeComponent(operationId)}',
      headers: {..._config.defaultHeaders},
      queryParameters: {if (feature != null) 'feature': feature.toString()},
    );
  ...
  apiShieldEndpointManagementAddOperationToAZone({
    required String zoneId,
    required ShieldBasicOperation body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
