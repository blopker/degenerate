...
/// DnsRecordsForAnAccountApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DnsRecordsForAnAccountApi {
  const DnsRecordsForAnAccountApi(this._config);
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAnAccountGetUsage({
