...
import '../models/addressing_create_binding_request.dart';
import '../models/response_common4.dart';

/// IpAddressManagementServiceBindingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class IpAddressManagementServiceBindingsApi {
  const IpAddressManagementServiceBindingsApi(this._config);
  ...
  ipAddressManagementServiceBindingsListServiceBindings({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/addressing/prefixes/${Uri.encodeComponent(prefixId)}/bindings',
  ...
  ipAddressManagementServiceBindingsCreateServiceBinding({
    required String accountId,
    required String prefixId,
    AddressingCreateBindingRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  ipAddressManagementServiceBindingsGetServiceBinding({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/addressing/prefixes/${Uri.encodeComponent(prefixId)}/bindings/${Uri.encodeComponent(bindingId)}',
      headers: {..._config.defaultHeaders},
    );
