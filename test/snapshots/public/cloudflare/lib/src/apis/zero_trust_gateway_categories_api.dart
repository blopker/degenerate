...
final class ZeroTrustGatewayCategoriesApi {
  const ZeroTrustGatewayCategoriesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon82>> zeroTrustGatewayCategoriesListCategories({
