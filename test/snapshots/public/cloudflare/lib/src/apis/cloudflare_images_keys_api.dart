...
final class CloudflareImagesKeysApi {
  const CloudflareImagesKeysApi(this._config);
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesKeysListSigningKeys({
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesKeysAddSigningKey({
    ...
    final request = ApiRequest(
      method: 'PUT',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/images/v1/keys/${Uri.encodeComponent(signingKeyName)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesKeysDeleteSigningKey({
    required String signingKeyName,
    required String accountId,
  }) async {
    final request = ApiRequest(
