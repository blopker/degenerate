...
/// TableManagementApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class TableManagementApi {
  const TableManagementApi(this._config);
  ...
  Future<ApiResult<ResponseSingle39>> listTables({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}/namespaces/${Uri.encodeComponent(namespace)}/tables',
