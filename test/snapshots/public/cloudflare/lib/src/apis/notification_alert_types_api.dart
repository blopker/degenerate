...
/// NotificationAlertTypesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class NotificationAlertTypesApi {
  const NotificationAlertTypesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon2>> notificationAlertTypesGetAlertTypes({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/alerting/v3/available_alerts',
