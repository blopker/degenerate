...
import '../models/magic_network_monitoring_configuration_create_account_configuration_request.dart';
import '../models/magic_network_monitoring_configuration_update_account_configuration_fields_request.dart';
import '../models/magic_network_monitoring_configuration_update_an_entire_account_configuration_request.dart';
import '../models/response_common46.dart';

/// MagicNetworkMonitoringConfigurationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MagicNetworkMonitoringConfigurationApi {
  const MagicNetworkMonitoringConfigurationApi(this._config);
  ...
  magicNetworkMonitoringConfigurationCreateAccountConfiguration({
    required String accountId,
    required MagicNetworkMonitoringConfigurationCreateAccountConfigurationRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  magicNetworkMonitoringConfigurationUpdateAnEntireAccountConfiguration({
    required String accountId,
    required MagicNetworkMonitoringConfigurationUpdateAnEntireAccountConfigurationRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
  ...
  magicNetworkMonitoringConfigurationUpdateAccountConfigurationFields({
    required String accountId,
    required MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
