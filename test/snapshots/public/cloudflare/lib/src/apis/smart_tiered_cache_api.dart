...
import '../models/cache_rules_smart_tiered_cache_patch.dart';
import '../models/response_common10.dart';

/// SmartTieredCacheApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class SmartTieredCacheApi {
  const SmartTieredCacheApi(this._config);
  ...
  smartTieredCacheGetSmartTieredCacheSetting({required String zoneId}) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/cache/tiered_cache_smart_topology_enable',
  ...
  smartTieredCachePatchSmartTieredCacheSetting({
    ...
    required CacheRulesSmartTieredCachePatch body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
