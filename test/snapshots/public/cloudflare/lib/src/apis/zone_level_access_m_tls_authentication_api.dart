...
import '../models/zone_level_access_mtls_authentication_add_an_mtls_certificate_request.dart';
import '../models/zone_level_access_mtls_authentication_update_an_mtls_certificate_request.dart';
import '../models/zone_level_access_mtls_authentication_update_an_mtls_certificate_settings_request.dart';

/// ZoneLevelAccessMTlsAuthenticationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneLevelAccessMTlsAuthenticationApi {
  const ZoneLevelAccessMTlsAuthenticationApi(this._config);
  ...
  zoneLevelAccessMtlsAuthenticationAddAnMtlsCertificate({
    required String zoneId,
    required ZoneLevelAccessMtlsAuthenticationAddAnMtlsCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/access/certificates',
  ...
  zoneLevelAccessMtlsAuthenticationGetAnMtlsCertificate({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/access/certificates/${Uri.encodeComponent(certificateId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  zoneLevelAccessMtlsAuthenticationUpdateAnMtlsCertificate({
    required String certificateId,
    required String zoneId,
    required ZoneLevelAccessMtlsAuthenticationUpdateAnMtlsCertificateRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
  ...
  zoneLevelAccessMtlsAuthenticationListMtlsCertificatesHostnameSettings({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/access/certificates/settings',
      headers: {..._config.defaultHeaders},
    );
  ...
  zoneLevelAccessMtlsAuthenticationUpdateAnMtlsCertificateSettings({
    required String zoneId,
    required ZoneLevelAccessMtlsAuthenticationUpdateAnMtlsCertificateSettingsRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
