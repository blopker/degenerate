...
import '../models/tls_certificates_and_hostnames_universal.dart';

/// UniversalSslSettingsForAZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class UniversalSslSettingsForAZoneApi {
  const UniversalSslSettingsForAZoneApi(this._config);
  ...
  universalSslSettingsForAZoneEditUniversalSslSettings({
    required String zoneId,
    required TlsCertificatesAndHostnamesUniversal body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/ssl/universal/settings',
