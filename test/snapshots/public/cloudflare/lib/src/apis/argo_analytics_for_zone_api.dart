...
import '../models/response_common7.dart';

/// ArgoAnalyticsForZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ArgoAnalyticsForZoneApi {
  const ArgoAnalyticsForZoneApi(this._config);
  ...
  Future<ApiResult<ResponseCommon7>> argoAnalyticsForZoneArgoAnalyticsForAZone({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon7.fromJson(
