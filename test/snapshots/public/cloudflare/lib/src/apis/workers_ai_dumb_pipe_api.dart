...
/// WorkersAiDumbPipeApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiDumbPipeApi {
  const WorkersAiDumbPipeApi(this._config);
  ...
  Future<ApiResult<void>> workersAiPostWebsocketRunCfPipecatAiSmartTurnV2({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/pipecat-ai/smart-turn-v2',
  ...
  Future<ApiResult<void>> workersAiPostWebsocketRunCfPipecatAiSmartTurnV3({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/pipecat-ai/smart-turn-v3',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> workersAiPostWebsocketRunCfTestHelloWorldCog({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/test/hello-world-cog',
      headers: {..._config.defaultHeaders},
    );
