...
Future<ApiResult<RadarGetCertificateAuthoritiesResponse>> radarGetCertificateAuthorities({int? limit, int? offset, RadarGetCertificateAuthoritiesFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetCertificateAuthorityDetailsResponse>> radarGetCertificateAuthorityDetails({required String caSlug, RadarGetCertificateAuthorityDetailsFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `GET /radar/ct/logs`
Future<ApiResult<RadarGetCertificateLogsResponse>> radarGetCertificateLogs({int? limit, int? offset, RadarGetCertificateLogsFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/radar/ct/logs',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<RadarGetCertificateLogDetailsResponse>> radarGetCertificateLogDetails({required String logSlug, RadarGetCertificateLogDetailsFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetCtTimeseriesResponse>> radarGetCtTimeseries({RadarGetCtTimeseriesAggInterval? aggInterval, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? ca, List<String>? caOwner, List<RadarGetCtTimeseriesDuration>? duration, List<RadarGetCtTimeseriesEntryType>? entryType, List<RadarGetCtTimeseriesExpirationStatus>? expirationStatus, List<bool>? hasIps, List<bool>? hasWildcards, List<String>? log, List<RadarGetCtTimeseriesLog>? logApi, List<String>? logOperator, List<RadarGetCtTimeseriesPublicKeyAlgorithm>? publicKeyAlgorithm, List<RadarGetCtTimeseriesSignatureAlgorithm>? signatureAlgorithm, List<String>? tld, List<RadarGetCtTimeseriesValidationLevel>? validationLevel, List<RadarGetCtTimeseriesUniqueEntries>? uniqueEntries, RadarGetCtTimeseriesFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
