...
Future<ApiResult<RadarGetTcpResetsTimeoutsSummaryResponse>> radarGetTcpResetsTimeoutsSummary({List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, RadarGetTcpResetsTimeoutsSummaryFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetTcpResetsTimeoutsTimeseriesGroupResponse>> radarGetTcpResetsTimeoutsTimeseriesGroup({RadarGetTcpResetsTimeoutsTimeseriesGroupAggInterval? aggInterval, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, RadarGetTcpResetsTimeoutsTimeseriesGroupFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
