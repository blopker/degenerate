...
import '../models/bundle_custom_detection.dart';
import '../models/bundle_status.dart';
import '../models/response_common74.dart';

/// LeakedCredentialChecksApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class LeakedCredentialChecksApi {
  const LeakedCredentialChecksApi(this._config);
  ...
  Future<ApiResult<ResponseCommon74>> wafProductApiLeakedCredentialsGetStatus({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon74.fromJson(
  ...
  Future<ApiResult<ResponseCommon74>> wafProductApiLeakedCredentialsSetStatus({
    required String zoneId,
    required BundleStatus body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/leaked-credential-checks',
  ...
  Future<ApiResult<ResponseCommon74>>
  wafProductApiLeakedCredentialsListDetections({required String zoneId}) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/leaked-credential-checks/detections',
      headers: {..._config.defaultHeaders},
    );
  ...
  wafProductApiLeakedCredentialsCreateDetection({
    required String zoneId,
    required BundleCustomDetection body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  wafProductApiLeakedCredentialsGetDetection({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/leaked-credential-checks/detections/${Uri.encodeComponent(detectionId)}',
      headers: {..._config.defaultHeaders},
    );
