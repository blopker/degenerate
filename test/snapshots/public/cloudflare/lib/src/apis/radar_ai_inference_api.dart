...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/radar_get_ai_inference_summary_dimension.dart';import '../models/radar_get_ai_inference_summary_format.dart';import '../models/radar_get_ai_inference_summary_response.dart';import '../models/radar_get_ai_inference_timeseries_group_agg_interval.dart';import '../models/radar_get_ai_inference_timeseries_group_dimension.dart';import '../models/radar_get_ai_inference_timeseries_group_format.dart';import '../models/radar_get_ai_inference_timeseries_group_normalization.dart';import '../models/radar_get_ai_inference_timeseries_group_response.dart';/// RadarAiInferenceApi operations.
///
...
Future<ApiResult<RadarGetAiInferenceSummaryResponse>> radarGetAiInferenceSummary({required RadarGetAiInferenceSummaryDimension dimension, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, int? limitPerGroup, RadarGetAiInferenceSummaryFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetAiInferenceTimeseriesGroupResponse>> radarGetAiInferenceTimeseriesGroup({required RadarGetAiInferenceTimeseriesGroupDimension dimension, RadarGetAiInferenceTimeseriesGroupAggInterval? aggInterval, List<String>? name, List<String>? dateRange, List<DateTime>? dateStart, List<DateTime>? dateEnd, List<String>? asn, List<String>? location, List<String>? continent, int? limitPerGroup, RadarGetAiInferenceTimeseriesGroupNormalization? normalization, RadarGetAiInferenceTimeseriesGroupFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
