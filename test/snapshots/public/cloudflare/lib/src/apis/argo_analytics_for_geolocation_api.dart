...
/// ArgoAnalyticsForGeolocationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ArgoAnalyticsForGeolocationApi {
  const ArgoAnalyticsForGeolocationApi(this._config);
  ...
  Future<ApiResult<ResponseCommon7>>
