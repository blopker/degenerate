...
import '../models/n5_img2img_request.dart';
import '../models/n5_inpainting_request.dart';
import '../models/workers_ai_post_run_cf_black_forest_labs_flux1_schnell_request.dart';
import '../models/workers_ai_post_run_cf_black_forest_labs_flux2_dev_request.dart';
import '../models/workers_ai_post_run_cf_black_forest_labs_flux2_klein4b_request.dart';
import '../models/workers_ai_post_run_cf_black_forest_labs_flux2_klein9b_request.dart';
import '../models/workers_ai_post_run_cf_bytedance_stable_diffusion_xl_lightning_request.dart';
import '../models/workers_ai_post_run_cf_leonardo_lucid_origin_request.dart';
import '../models/workers_ai_post_run_cf_leonardo_phoenix10_request.dart';
import '../models/workers_ai_post_run_cf_lykon_dreamshaper8_lcm_request.dart';
import '../models/workers_ai_post_run_cf_stabilityai_stable_diffusion_xl_base10_request.dart';

/// WorkersAiTextToImageApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiTextToImageApi {
  const WorkersAiTextToImageApi(this._config);
  ...
  workersAiPostRunCfBlackForestLabsFlux1Schnell({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBlackForestLabsFlux1SchnellRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/black-forest-labs/flux-1-schnell',
  ...
  workersAiPostRunCfBlackForestLabsFlux2Dev({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBlackForestLabsFlux2DevRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/black-forest-labs/flux-2-dev',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBlackForestLabsFlux2Klein4b({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBlackForestLabsFlux2Klein4bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/black-forest-labs/flux-2-klein-4b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBlackForestLabsFlux2Klein9b({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBlackForestLabsFlux2Klein9bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/black-forest-labs/flux-2-klein-9b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBytedanceStableDiffusionXlLightning({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/bytedance/stable-diffusion-xl-lightning',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfLeonardoLucidOrigin({
    required String accountId,
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfLeonardoLucidOriginRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/leonardo/lucid-origin',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfLeonardoPhoenix10({
    required String accountId,
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfLeonardoPhoenix10Request? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/leonardo/phoenix-1.0',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfLykonDreamshaper8Lcm({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfLykonDreamshaper8LcmRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/lykon/dreamshaper-8-lcm',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfRunwaymlStableDiffusionV15Img2img({
    ...
    String? queueRequest,
    String? tags,
    $5Img2imgRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/runwayml/stable-diffusion-v1-5-img2img',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfRunwaymlStableDiffusionV15Inpainting({
    ...
    String? queueRequest,
    String? tags,
    $5InpaintingRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/runwayml/stable-diffusion-v1-5-inpainting',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfStabilityaiStableDiffusionXlBase10({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfStabilityaiStableDiffusionXlBase10Request? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/stabilityai/stable-diffusion-xl-base-1.0',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<void>> workersAiPostWebsocketRunCfSvenTestPipeHttp({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/sven/test-pipe-http',
