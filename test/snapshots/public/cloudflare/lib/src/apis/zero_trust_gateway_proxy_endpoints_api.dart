...
import '../models/zero_trust_gateway_proxy_endpoints_create_proxy_endpoint_request.dart';
import '../models/zero_trust_gateway_proxy_endpoints_update_proxy_endpoint_request.dart';

/// ZeroTrustGatewayProxyEndpointsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZeroTrustGatewayProxyEndpointsApi {
  const ZeroTrustGatewayProxyEndpointsApi(this._config);
  ...
  zeroTrustGatewayProxyEndpointsListProxyEndpoints({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/proxy_endpoints',
  ...
  zeroTrustGatewayProxyEndpointsCreateProxyEndpoint({
    required String accountId,
    required ZeroTrustGatewayProxyEndpointsCreateProxyEndpointRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  zeroTrustGatewayProxyEndpointsProxyEndpointDetails({
    required String proxyEndpointId,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/proxy_endpoints/${Uri.encodeComponent(proxyEndpointId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  zeroTrustGatewayProxyEndpointsUpdateProxyEndpoint({
    required String proxyEndpointId,
    required String accountId,
    required ZeroTrustGatewayProxyEndpointsUpdateProxyEndpointRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
