...
import '../models/ip_address_management_prefix_delegation_create_prefix_delegation_request.dart';
...
final class IpAddressManagementPrefixDelegationApi {
  const IpAddressManagementPrefixDelegationApi(this._config);
  ...
  ipAddressManagementPrefixDelegationListPrefixDelegations({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/addressing/prefixes/${Uri.encodeComponent(prefixId)}/delegations',
  ...
  ipAddressManagementPrefixDelegationCreatePrefixDelegation({
    required String prefixId,
    required String accountId,
    required IpAddressManagementPrefixDelegationCreatePrefixDelegationRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  ipAddressManagementPrefixDelegationDeletePrefixDelegation({
    ...
    final request = ApiRequest(
      method: 'DELETE',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/addressing/prefixes/${Uri.encodeComponent(prefixId)}/delegations/${Uri.encodeComponent(delegationId)}',
      headers: {..._config.defaultHeaders},
    );
