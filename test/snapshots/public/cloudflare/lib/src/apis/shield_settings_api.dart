...
import '../models/shield_configuration.dart';

/// ShieldSettingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ShieldSettingsApi {
  const ShieldSettingsApi(this._config);
  ...
  apiShieldSettingsSetConfigurationProperties({
    required String zoneId,
    bool? normalize,
    required ShieldConfiguration body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path: '/zones/${Uri.encodeComponent(zoneId)}/api_gateway/configuration',
