...
import '../models/magic_site_update_request.dart';
import '../models/magic_sites_add_single_request.dart';
import '../models/response_common48.dart';

/// MagicSitesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MagicSitesApi {
  const MagicSitesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesListSites({
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesCreateSite({
    required String accountId,
    required MagicSitesAddSingleRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/magic/sites',
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesSiteDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/magic/sites/${Uri.encodeComponent(siteId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesUpdateSite({
    required String siteId,
    required String accountId,
    required MagicSiteUpdateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesPatchSite({
    required String siteId,
    required String accountId,
    required MagicSiteUpdateRequest body,
  }) async {
  ...
  Future<ApiResult<ResponseCommon48>> magicSitesDeleteSite({
    required String siteId,
    required String accountId,
  }) async {
    final request = ApiRequest(
