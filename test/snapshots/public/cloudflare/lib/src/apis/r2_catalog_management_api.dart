...
/// R2CatalogManagementApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class R2CatalogManagementApi {
  const R2CatalogManagementApi(this._config);
  ...
  Future<ApiResult<ResponseSingle39>> listCatalogs({
  ...
  Future<ApiResult<ResponseSingle39>> getCatalogDetails({
    required String accountId,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> disableCatalog({
    required String accountId,
    required String bucketName,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}/disable',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseSingle39>> enableCatalog({
    required String accountId,
    required String bucketName,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}/enable',
      headers: {..._config.defaultHeaders},
    );
