...
import '../models/workers_ai_post_run_cf_ai4bharat_indictrans2_en_indic1_b_request.dart';
import '../models/workers_ai_post_run_cf_ai4bharat_omni_indictrans2_en_indic1b_request.dart';
import '../models/workers_ai_post_run_cf_meta_m2m10012b_request.dart';

/// WorkersAiTranslationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiTranslationApi {
  const WorkersAiTranslationApi(this._config);
  ...
  workersAiPostRunCfAi4bharatIndictrans2EnIndic1B({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfAi4bharatIndictrans2EnIndic1BRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/ai4bharat/indictrans2-en-indic-1B',
  ...
  workersAiPostRunCfAi4bharatOmniIndictrans2EnIndic1b({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfAi4bharatOmniIndictrans2EnIndic1bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/ai4bharat/omni-indictrans2-en-indic-1b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfMetaM2m10012b({
    required String accountId,
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfMetaM2m10012bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/meta/m2m100-1.2b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
