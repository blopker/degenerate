...
/// ZoneRatePlanApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneRatePlanApi {
  const ZoneRatePlanApi(this._config);
  ...
  Future<ApiResult<ResponseCommon8>> zoneRatePlanListAvailablePlans({
  ...
  Future<ApiResult<ResponseCommon8>> zoneRatePlanAvailablePlanDetails({
    required String planIdentifier,
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/available_plans/${Uri.encodeComponent(planIdentifier)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon8>> zoneRatePlanListAvailableRatePlans({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
