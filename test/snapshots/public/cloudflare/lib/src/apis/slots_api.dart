...
import '../models/nsc_slot_info.dart';
import '../models/nsc_slot_list.dart';
...
final class SlotsApi {
  ...
  Future<ApiResult<NscSlotList>> listSlots({
  ...
  Future<ApiResult<NscSlotInfo>> getSlot({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/cni/slots/${Uri.encodeComponent(slot)}',
      headers: {..._config.defaultHeaders},
    );
