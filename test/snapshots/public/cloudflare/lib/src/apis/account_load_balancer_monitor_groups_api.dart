...
import '../models/load_balancing_monitor_group.dart';
import '../models/response_common42.dart';

/// AccountLoadBalancerMonitorGroupsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AccountLoadBalancerMonitorGroupsApi {
  const AccountLoadBalancerMonitorGroupsApi(this._config);
  ...
  accountLoadBalancerMonitorGroupsListMonitorGroups({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/load_balancers/monitor_groups',
  ...
  accountLoadBalancerMonitorGroupsCreateMonitorGroup({
    required String accountId,
    required LoadBalancingMonitorGroup body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  accountLoadBalancerMonitorGroupsMonitorGroupDetails({
    required String monitorGroupId,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/load_balancers/monitor_groups/${Uri.encodeComponent(monitorGroupId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  accountLoadBalancerMonitorGroupsListMonitorGroupReferences({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/load_balancers/monitor_groups/${Uri.encodeComponent(monitorGroupId)}/references',
      headers: {..._config.defaultHeaders},
    );
