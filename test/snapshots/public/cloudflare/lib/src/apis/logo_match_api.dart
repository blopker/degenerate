...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/image_file.dart';import '../models/logo.dart';import '../models/logo_match.dart';/// LogoMatchApi operations.
///
...
Future<ApiResult<LogoMatch>> getAccountsBrandProtectionLogoMatches({required String accountId, List<String>? logoId, String? offset, String? limit, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<LogoMatch>> getAccountsBrandProtectionLogoMatchesDownload({required String accountId, List<String>? logoId, String? offset, String? limit, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> getAccountsBrandProtectionLogos({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Logo>> postAccountsBrandProtectionLogos({required String accountId, String? tag, String? matchType, double? threshold, required ImageFile body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/logos',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<void>> getAccountsBrandProtectionLogos2({required String accountId, required String logoId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> deleteAccountsBrandProtectionLogos({required String accountId, required String logoId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/logos/${Uri.encodeComponent(logoId)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> postAccountsBrandProtectionScanLogo({required String accountId}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> postAccountsBrandProtectionScanPage({required String accountId}) async  { final request = ApiRequest(
  method: 'POST',
...
///
/// `GET /signed-url`
Future<ApiResult<void>> getSignedUrl() async  { final request = ApiRequest(
  method: 'GET',
  path: '/signed-url',
  headers: {..._config.defaultHeaders
  },
