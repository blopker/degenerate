...
import '../models/n5_request.dart';
import '../models/n5_request2.dart';
import '../models/n5_request3.dart';
import '../models/n5_request4.dart';
import '../models/n5_request5.dart';
import '../models/n5_request6.dart';
import '../models/n5_request7.dart';
import '../models/workers_ai_post_run_cf_baai_bge_m3_request.dart';
import '../models/workers_ai_post_run_cf_baai_omni_bge_m3_request.dart';
import '../models/workers_ai_post_run_cf_google_embeddinggemma300m_request.dart';
import '../models/workers_ai_post_run_cf_google_omni_embeddinggemma300m_request.dart';
import '../models/workers_ai_post_run_cf_pfnet_plamo_embedding1b_request.dart';
import '../models/workers_ai_post_run_cf_qwen_qwen3_embedding06b_request.dart';

/// WorkersAiTextEmbeddingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersAiTextEmbeddingsApi {
  const WorkersAiTextEmbeddingsApi(this._config);
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfBaaiBgeBaseEnV15({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/bge-base-en-v1.5',
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfBaaiBgeLargeEnV15({
    required String accountId,
    String? queueRequest,
    String? tags,
    $5Request2? body,
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/bge-large-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfBaaiBgeM3({
    required String accountId,
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBaaiBgeM3Request? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/bge-m3',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfBaaiBgeSmallEnV15({
    required String accountId,
    String? queueRequest,
    String? tags,
    $5Request3? body,
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/bge-small-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBaaiOmniBgeBaseEnV15({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/omni-bge-base-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBaaiOmniBgeLargeEnV15({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/omni-bge-large-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  Future<ApiResult<Map<String, String>>> workersAiPostRunCfBaaiOmniBgeM3({
    required String accountId,
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfBaaiOmniBgeM3Request? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/omni-bge-m3',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBaaiOmniBgeSmallEnV15({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/omni-bge-small-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfBaaiRayBgeLargeEnV15({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/baai/ray-bge-large-en-v1.5',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfGoogleEmbeddinggemma300m({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/google/embeddinggemma-300m',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfGoogleOmniEmbeddinggemma300m({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfGoogleOmniEmbeddinggemma300mRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/google/omni-embeddinggemma-300m',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfPfnetPlamoEmbedding1b({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfPfnetPlamoEmbedding1bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/pfnet/plamo-embedding-1b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
  ...
  workersAiPostRunCfQwenQwen3Embedding06b({
    ...
    String? queueRequest,
    String? tags,
    WorkersAiPostRunCfQwenQwen3Embedding06bRequest? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/qwen/qwen3-embedding-0.6b',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      queryParameters: {'queueRequest': ?queueRequest, 'tags': ?tags},
      body: jsonEncode(body?.toJson()),
    );
