...
/// AccessShortLivedCertificateCAsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AccessShortLivedCertificateCAsApi {
  const AccessShortLivedCertificateCAsApi(this._config);
  ...
  accessShortLivedCertificateCAsGetAShortLivedCertificateCa({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/access/apps/${Uri.encodeComponent(appId)}/ca',
