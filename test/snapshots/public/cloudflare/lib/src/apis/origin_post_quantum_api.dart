...
import '../models/zone_cache_settings_change_origin_post_quantum_encryption_setting_request.dart';

/// OriginPostQuantumApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class OriginPostQuantumApi {
  const OriginPostQuantumApi(this._config);
  ...
  zoneCacheSettingsGetOriginPostQuantumEncryptionSetting({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/cache/origin_post_quantum_encryption',
  ...
  zoneCacheSettingsChangeOriginPostQuantumEncryptionSetting({
    required String zoneId,
    required ZoneCacheSettingsChangeOriginPostQuantumEncryptionSettingRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
