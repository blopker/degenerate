...
Future<ApiResult<RealtimekitGenericSuccessResponse>> startRecording({required String accountId, required String appId, required StartRecordingRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<RealtimekitGenericSuccessResponse>> getOneRecording({required String accountId, required String appId, required String recordingId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RealtimekitGenericSuccessResponse>> pauseResumeStopRecording({required String accountId, required String appId, required String recordingId, required PauseResumeStopRecordingRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings/${Uri.encodeComponent(recordingId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<RealtimekitGenericSuccessResponse>> getActiveRecording({required String accountId, required String appId, required String meetingId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> startTrackRecordingForAMeeting({required String accountId, required String appId, required StartTrackRecordingForAMeetingRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
