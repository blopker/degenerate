...
import '../models/url_info.dart';
import '../models/url_submit.dart';

/// BrandProtectionApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class BrandProtectionApi {
  const BrandProtectionApi(this._config);
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionAlerts({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/alerts',
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionAlerts({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionAlertsClear({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/alerts/clear',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionAlertsRefute({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/alerts/refute',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionAlertsVerify({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/alerts/verify',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionBrands({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/brands',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> postAccountsBrandProtectionBrands({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> deleteAccountsBrandProtectionBrands({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionBrandsPatterns({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/brands/patterns',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> postAccountsBrandProtectionBrandsPatterns({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> deleteAccountsBrandProtectionBrandsPatterns({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionClear({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/clear',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionDomainInfo({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/domain-info',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionRecentSubmissions({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/recent-submissions',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionRefute({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/refute',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionSubmissionInfo({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/submission-info',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<UrlSubmit>> postAccountsBrandProtectionSubmit({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/submit',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> getAccountsBrandProtectionTrackedDomains({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/tracked-domains',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<UrlInfo>> getAccountsBrandProtectionUrlInfo({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/url-info',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> patchAccountsBrandProtectionVerify({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/verify',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<void>> postInternalSubmit() async {
    final request = ApiRequest(
      method: 'POST',
  ...
  ///
  /// `GET /live`
  Future<ApiResult<void>> getLive() async {
    final request = ApiRequest(
      method: 'GET',
      path: '/live',
      headers: {..._config.defaultHeaders},
  ...
  ///
  /// `GET /ready`
  Future<ApiResult<void>> getReady() async {
    final request = ApiRequest(
      method: 'GET',
      path: '/ready',
      headers: {..._config.defaultHeaders},
