...
import '../models/zone_cache_settings_change_cache_reserve_setting_request.dart';
import '../models/zone_cache_settings_change_regional_tiered_cache_setting_request.dart';
import '../models/zone_cache_settings_change_variants_setting_request.dart';

/// ZoneCacheSettingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneCacheSettingsApi {
  const ZoneCacheSettingsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsGetCacheReserveSetting({
  ...
  zoneCacheSettingsChangeCacheReserveSetting({
    required String zoneId,
    required ZoneCacheSettingsChangeCacheReserveSettingRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/cache/cache_reserve',
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsGetCacheReserveClear({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsStartCacheReserveClear({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  zoneCacheSettingsChangeRegionalTieredCacheSetting({
    required String zoneId,
    required ZoneCacheSettingsChangeRegionalTieredCacheSettingRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/cache/regional_tiered_cache',
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsGetVariantsSetting({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsChangeVariantsSetting({
    required String zoneId,
    required ZoneCacheSettingsChangeVariantsSettingRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/cache/variants',
  ...
  Future<ApiResult<ResponseCommon10>> zoneCacheSettingsDeleteVariantsSetting({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
