...
import '../models/cache_rules_patch.dart';
import '../models/response_common10.dart';

/// TieredCachingApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class TieredCachingApi {
  const TieredCachingApi(this._config);
  ...
  Future<ApiResult<ResponseCommon10>> tieredCachingGetTieredCachingSetting({
  ...
  Future<ApiResult<ResponseCommon10>> tieredCachingPatchTieredCachingSetting({
    required String zoneId,
    required CacheRulesPatch body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}/argo/tiered_caching',
