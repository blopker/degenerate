...
/// ZoneLevelAccessShortLivedCertificateCAsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneLevelAccessShortLivedCertificateCAsApi {
  const ZoneLevelAccessShortLivedCertificateCAsApi(this._config);
  ...
  zoneLevelAccessShortLivedCertificateCAsGetAShortLivedCertificateCa({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/access/apps/${Uri.encodeComponent(appId)}/ca',
