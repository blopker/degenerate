...
/// NotificationHistoryApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class NotificationHistoryApi {
  const NotificationHistoryApi(this._config);
  ...
  Future<ApiResult<ResponseCommon2>> notificationHistoryListHistory({
