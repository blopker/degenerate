...
import '../models/client_certificate_for_a_zone_create_client_certificate_request.dart';
import '../models/client_certificate_for_a_zone_edit_client_certificate_request.dart';
import '../models/response_common68.dart';
import '../models/tls_certificates_and_hostnames_hostname_association.dart';

/// ShieldClientCertificatesForAZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ShieldClientCertificatesForAZoneApi {
  const ShieldClientCertificatesForAZoneApi(this._config);
  ...
  clientCertificateForAZoneListHostnameAssociations({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/certificate_authorities/hostname_associations',
  ...
  clientCertificateForAZonePutHostnameAssociations({
    required String zoneId,
    required TlsCertificatesAndHostnamesHostnameAssociation body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  clientCertificateForAZoneCreateClientCertificate({
    required String zoneId,
    required ClientCertificateForAZoneCreateClientCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/client_certificates',
  ...
  clientCertificateForAZoneClientCertificateDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/client_certificates/${Uri.encodeComponent(clientCertificateId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  clientCertificateForAZoneEditClientCertificate({
    required String zoneId,
    required String clientCertificateId,
    required ClientCertificateForAZoneEditClientCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
