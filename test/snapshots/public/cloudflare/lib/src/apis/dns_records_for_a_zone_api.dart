...
import '../models/dns_records_direction.dart';
import '../models/dns_records_dns_record_patch.dart';
import '../models/dns_records_dns_record_post.dart';
import '../models/dns_records_dns_request_batch_object.dart';
import '../models/dns_records_dns_request_review_scan_object.dart';
import '../models/dns_records_for_a_zone_delete_dns_record_response.dart';
import '../models/dns_records_for_a_zone_import_dns_records_request.dart';
import '../models/dns_records_match.dart';
import '../models/dns_records_order.dart';
import '../models/dns_records_tag_match.dart';
import '../models/dns_records_type.dart';
import '../models/response_common25.dart';

/// DnsRecordsForAZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DnsRecordsForAZoneApi {
  const DnsRecordsForAZoneApi(this._config);
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneListDnsRecords({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon25.fromJson(
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneCreateDnsRecord({
    required String zoneId,
    required DnsRecordsDnsRecordPost body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/dns_records',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneDnsRecordDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/dns_records/${Uri.encodeComponent(dnsRecordId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneUpdateDnsRecord({
    required String dnsRecordId,
    required String zoneId,
    required DnsRecordsDnsRecordPost body,
  }) async {
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZonePatchDnsRecord({
    required String dnsRecordId,
    required String zoneId,
    required DnsRecordsDnsRecordPatch body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
  ...
  Future<ApiResult<DnsRecordsForAZoneDeleteDnsRecordResponse>>
  dnsRecordsForAZoneDeleteDnsRecord({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return DnsRecordsForAZoneDeleteDnsRecordResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneBatchDnsRecords({
    required String zoneId,
    required DnsRecordsDnsRequestBatchObject body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<void>> dnsRecordsForAZoneExportDnsRecords({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneImportDnsRecords({
    required String zoneId,
    required DnsRecordsForAZoneImportDnsRecordsRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneReviewDnsScan({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneApplyDnsScanResults({
    required String zoneId,
    required DnsRecordsDnsRequestReviewScanObject body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/dns_records/scan/review',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneTriggerDnsScan({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
  ...
  Future<ApiResult<ResponseCommon25>> dnsRecordsForAZoneGetUsage({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
