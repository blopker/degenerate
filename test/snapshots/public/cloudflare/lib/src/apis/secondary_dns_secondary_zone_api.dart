...
import '../models/secondary_dns_dns_secondary_secondary_zone.dart';

/// SecondaryDnsSecondaryZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class SecondaryDnsSecondaryZoneApi {
  const SecondaryDnsSecondaryZoneApi(this._config);
  ...
  Future<ApiResult<ResponseCommon58>> secondaryDnsSecondaryZoneForceAxfr({
  ...
  secondaryDnsSecondaryZoneCreateSecondaryZoneConfiguration({
    required String zoneId,
    required SecondaryDnsDnsSecondarySecondaryZone body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/secondary_dns/incoming',
