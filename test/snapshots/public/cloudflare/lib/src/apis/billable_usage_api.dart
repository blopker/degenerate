...
/// BillableUsageApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class BillableUsageApi {
  const BillableUsageApi(this._config);
  ...
  Future<ApiResult<UsageResponse>> billableUsageGetPaygoAccountUsage({
    required String accountId,
    String? from,
    String? to,
    int? lastYearPeriodStart,
    int? lastMonthPeriodStart,
  }) async {
    final request = ApiRequest(
      ...
      queryParameters: {
        ...
        if (lastYearPeriodStart != null)
          'last_year_period_start': lastYearPeriodStart.toString(),
        if (lastMonthPeriodStart != null)
          'last_month_period_start': lastMonthPeriodStart.toString(),
      },
    );
