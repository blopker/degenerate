...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/query.dart';import '../models/query_bulk.dart';import '../models/query_match.dart';/// DomainSearchApi operations.
///
...
Future<ApiResult<QueryMatch>> getAccountsBrandProtectionMatches({required String accountId, String? id, int? offset, int? limit, bool? includeDomainId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<QueryMatch>> getAccountsBrandProtectionMatchesDownload({required String accountId, String? id, int? offset, int? limit, bool? includeDomainId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> getAccountsBrandProtectionQueries({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> postAccountsBrandProtectionQueries({required String accountId, String? id, String? tag, bool? scan, required Query body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/queries',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<void>> patchAccountsBrandProtectionQueries({required String accountId}) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/queries',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> deleteAccountsBrandProtectionQueries({required String accountId, String? id, String? tag, bool? scan, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/brand-protection/queries',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> postAccountsBrandProtectionQueriesBulk({required String accountId, required QueryBulk body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> postAccountsBrandProtectionSearch({required String accountId}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> getAccountsBrandProtectionTotalQueries({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
