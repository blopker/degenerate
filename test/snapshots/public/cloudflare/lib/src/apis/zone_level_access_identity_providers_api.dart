...
import '../models/access_schemas_identity_providers.dart';
import '../models/response_common3.dart';

/// ZoneLevelAccessIdentityProvidersApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneLevelAccessIdentityProvidersApi {
  const ZoneLevelAccessIdentityProvidersApi(this._config);
  ...
  zoneLevelAccessIdentityProvidersAddAnAccessIdentityProvider({
    required String zoneId,
    required AccessSchemasIdentityProviders body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/access/identity_providers',
  ...
  zoneLevelAccessIdentityProvidersGetAnAccessIdentityProvider({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/access/identity_providers/${Uri.encodeComponent(identityProviderId)}',
      headers: {..._config.defaultHeaders},
    );
