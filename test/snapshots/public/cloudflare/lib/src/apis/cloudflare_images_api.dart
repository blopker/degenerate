...
import '../models/cloudflare_images_list_images_sort_order.dart';
import '../models/images_image_basic_upload.dart';
import '../models/images_image_direct_upload_request.dart';
import '../models/images_image_patch_request.dart';
import '../models/response_common36.dart';

/// CloudflareImagesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CloudflareImagesApi {
  const CloudflareImagesApi(this._config);
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesUploadAnImageViaUrl({
    required String accountId,
    required ImagesImageBasicUpload body,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon36.fromJson(
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesImageDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/images/v1/${Uri.encodeComponent(imageId)}',
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesUpdateImage({
    required String imageId,
    required String accountId,
    required ImagesImagePatchRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesDeleteImage({
    required String imageId,
    required String accountId,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<void>> cloudflareImagesBaseImage({
    required String imageId,
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/images/v1/${Uri.encodeComponent(imageId)}/blob',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesUsageStatistics({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon36>> cloudflareImagesListImagesV2({
    required String accountId,
    String? continuationToken,
    double? perPage,
    CloudflareImagesListImagesSortOrder? sortOrder,
    String? creator,
    String? metafieldoperator,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  cloudflareImagesCreateAuthenticatedDirectUploadUrlV2({
    required String accountId,
    required ImagesImageDirectUploadRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/images/v2/direct_upload',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
      body: jsonEncode(body.toJson()),
    );
