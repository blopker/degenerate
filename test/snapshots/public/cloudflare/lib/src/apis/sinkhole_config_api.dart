...
import '../models/response_common38.dart';

/// SinkholeConfigApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class SinkholeConfigApi {
  const SinkholeConfigApi(this._config);
  ...
  Future<ApiResult<ResponseCommon38>> sinkholeConfigGetSinkholes({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon38.fromJson(
