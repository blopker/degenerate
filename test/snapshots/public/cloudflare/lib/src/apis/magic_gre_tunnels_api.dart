...
import '../models/magic_create_gre_tunnel_request.dart';
import '../models/magic_gre_tunnel_add_single_request.dart';
import '../models/response_common48.dart';

/// MagicGreTunnelsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MagicGreTunnelsApi {
  const MagicGreTunnelsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsListGreTunnels({
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsCreateGreTunnels({
    required String accountId,
    bool? xMagicNewHcTarget,
    required MagicCreateGreTunnelRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/magic/gre_tunnels',
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsUpdateMultipleGreTunnels({
    required String accountId,
    bool? xMagicNewHcTarget,
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsListGreTunnelDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/magic/gre_tunnels/${Uri.encodeComponent(greTunnelId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsUpdateGreTunnel({
    required String greTunnelId,
    required String accountId,
    bool? xMagicNewHcTarget,
    required MagicGreTunnelAddSingleRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<ResponseCommon48>> magicGreTunnelsDeleteGreTunnel({
    required String greTunnelId,
    required String accountId,
    bool? xMagicNewHcTarget,
  }) async {
