...
import '../models/calls_app_editable_fields.dart';
import '../models/response_common11.dart';

/// CallsAppsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CallsAppsApi {
  const CallsAppsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon11>> callsAppsList({
  ...
  Future<ApiResult<ResponseCommon11>> callsAppsCreateANewApp({
    required String accountId,
    required CallsAppEditableFields body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/calls/apps',
  ...
  Future<ApiResult<ResponseCommon11>> callsAppsRetrieveAppDetails({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/calls/apps/${Uri.encodeComponent(appId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon11>> callsAppsUpdateAppDetails({
    required String appId,
    required String accountId,
    required CallsAppEditableFields body,
  }) async {
  ...
  Future<ApiResult<ResponseCommon11>> callsAppsDeleteApp({
    required String appId,
    required String accountId,
  }) async {
    final request = ApiRequest(
