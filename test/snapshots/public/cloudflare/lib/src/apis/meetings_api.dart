...
import '../models/add_participant_request.dart';
import '../models/create_meeting_request.dart';
import '../models/edit_participant_request.dart';
import '../models/realtimekit_generic_success_response.dart';
import '../models/realtimekit_paging_response.dart';
import '../models/replace_meeting_request.dart';
import '../models/update_meeting_request.dart';
...
final class MeetingsApi {
  ...
  Future<ApiResult<RealtimekitPagingResponse>> getAllMeetings({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/meetings',
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> createMeeting({
    required String accountId,
    required String appId,
    required CreateMeetingRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> getMeeting({
    required String accountId,
    required String appId,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/meetings/${Uri.encodeComponent(meetingId)}',
      headers: {..._config.defaultHeaders},
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> replaceMeeting({
    required String accountId,
    required String appId,
    required String meetingId,
    required ReplaceMeetingRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> updateMeeting({
    required String accountId,
    required String appId,
    required String meetingId,
  ...
  Future<ApiResult<RealtimekitPagingResponse>> getMeetingParticipants({
    required String accountId,
    required String appId,
    required String meetingId,
    double? pageNo,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/meetings/${Uri.encodeComponent(meetingId)}/participants',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        if (pageNo != null) 'page_no': pageNo.toString(),
        if (perPage != null) 'per_page': perPage.toString(),
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> addParticipant({
    required String accountId,
    required String appId,
    required String meetingId,
    required AddParticipantRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> getMeetingParticipant({
    required String accountId,
    required String appId,
    required String meetingId,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/meetings/${Uri.encodeComponent(meetingId)}/participants/${Uri.encodeComponent(participantId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> editParticipant({
    required String accountId,
    required String appId,
    required String meetingId,
    required String participantId,
    required EditParticipantRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
  ...
  Future<ApiResult<RealtimekitGenericSuccessResponse>> regenerateToken({
    required String accountId,
    required String appId,
    required String meetingId,
    required String participantId,
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/meetings/${Uri.encodeComponent(meetingId)}/participants/${Uri.encodeComponent(participantId)}/token',
      headers: {..._config.defaultHeaders},
    );
