...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/workers_ai_post_run_cf_deepgram_aura1_request.dart';import '../models/workers_ai_post_run_cf_deepgram_aura2_en_request.dart';import '../models/workers_ai_post_run_cf_deepgram_aura2_es_request.dart';import '../models/workers_ai_post_run_cf_myshell_ai_melotts_request.dart';/// WorkersAiTextToSpeechApi operations.
///
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura1({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfDeepgramAura1({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfDeepgramAura1Request? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/deepgram/aura-1',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura1Internal({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura2({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura2En({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfDeepgramAura2En({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfDeepgramAura2EnRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/deepgram/aura-2-en',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramAura2Es({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfDeepgramAura2Es({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfDeepgramAura2EsRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/deepgram/aura-2-es',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfMyshellAiMelotts({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfMyshellAiMelottsRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
