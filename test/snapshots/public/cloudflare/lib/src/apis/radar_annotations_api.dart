...
Future<ApiResult<RadarGetAnnotationsOutagesResponse>> radarGetAnnotationsOutages({int? limit, int? offset, String? dateRange, DateTime? dateStart, DateTime? dateEnd, int? asn, String? location, String? origin, RadarGetAnnotationsOutagesFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RadarGetAnnotationsOutagesTopResponse>> radarGetAnnotationsOutagesTop({int? limit, String? dateRange, DateTime? dateStart, DateTime? dateEnd, RadarGetAnnotationsOutagesTopFormat? format, }) async  { final request = ApiRequest(
  method: 'GET',
