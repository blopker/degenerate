...
import '../models/zero_trust_update_audit_ssh_settings_request.dart';

/// ZeroTrustSshSettingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZeroTrustSshSettingsApi {
  const ZeroTrustSshSettingsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon82>> zeroTrustGetAuditSshSettings({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/audit_ssh_settings',
  ...
  Future<ApiResult<ResponseCommon82>> zeroTrustUpdateAuditSshSettings({
    required String accountId,
    required ZeroTrustUpdateAuditSshSettingsRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
  ...
  Future<ApiResult<ResponseCommon82>> zeroTrustRotateSshAccountSeed({
    required String accountId,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/gateway/audit_ssh_settings/rotate_seed',
      headers: {..._config.defaultHeaders},
    );
