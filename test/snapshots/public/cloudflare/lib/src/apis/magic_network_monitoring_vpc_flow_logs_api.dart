...
/// MagicNetworkMonitoringVpcFlowLogsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MagicNetworkMonitoringVpcFlowLogsApi {
  const MagicNetworkMonitoringVpcFlowLogsApi(this._config);
