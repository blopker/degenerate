...
import '../models/builds_scm_provider_type.dart';
import '../models/response.dart';

/// GitHubIntegrationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class GitHubIntegrationApi {
  const GitHubIntegrationApi(this._config);
  ...
  Future<ApiResult<Response>> getWorkerConfigAutofill({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/builds/repos/${Uri.encodeComponent(providerType.toString())}/${Uri.encodeComponent(providerAccountId)}/${Uri.encodeComponent(repoId)}/config_autofill',
      headers: {..._config.defaultHeaders},
      queryParameters: {'branch': branch, 'root_directory': ?rootDirectory},
    );
