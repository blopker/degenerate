...
import '../models/origin_ca_create_certificate_request.dart';
import '../models/response_common68.dart';
import '../models/tls_certificates_and_hostnames_certificate_revoke_response.dart';

/// OriginCaApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class OriginCaApi {
  const OriginCaApi(this._config);
  ...
  ///
  /// `GET /certificates`
  Future<ApiResult<ResponseCommon68>> originCaListCertificates({
  ...
  ///
  /// `POST /certificates`
  Future<ApiResult<ResponseCommon68>> originCaCreateCertificate({
    required OriginCaCreateCertificateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/certificates',
  ...
  Future<ApiResult<ResponseCommon68>> originCaGetCertificate({
  ...
  Future<ApiResult<TlsCertificatesAndHostnamesCertificateRevokeResponse>>
  originCaRevokeCertificate({required String certificateId}) async {
    final request = ApiRequest(
      method: 'DELETE',
      path: '/certificates/${Uri.encodeComponent(certificateId)}',
      headers: {..._config.defaultHeaders},
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return TlsCertificatesAndHostnamesCertificateRevokeResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
