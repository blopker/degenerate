...
/// DnsFirewallAnalyticsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class DnsFirewallAnalyticsApi {
  const DnsFirewallAnalyticsApi(this._config);
  ...
  Future<ApiResult<ResponseCommon22>> dnsFirewallAnalyticsTable({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/dns_firewall/${Uri.encodeComponent(dnsFirewallId)}/dns_analytics/report',
  ...
  Future<ApiResult<ResponseCommon22>> dnsFirewallAnalyticsByTime({
    required String dnsFirewallId,
    required String accountId,
    String? metrics,
    String? dimensions,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/dns_firewall/${Uri.encodeComponent(dnsFirewallId)}/dns_analytics/report/bytime',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        'metrics': ?metrics,
        'dimensions': ?dimensions,
