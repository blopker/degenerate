...
import '../models/argo_config_patch.dart';
import '../models/response_single6.dart';

/// ArgoSmartRoutingApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ArgoSmartRoutingApi {
  const ArgoSmartRoutingApi(this._config);
  ...
  Future<ApiResult<ResponseSingle6>>
  argoSmartRoutingGetArgoSmartRoutingSetting({required String zoneId}) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseSingle6.fromJson(
