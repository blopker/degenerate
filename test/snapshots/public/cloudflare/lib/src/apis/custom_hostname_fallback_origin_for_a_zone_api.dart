...
import '../models/custom_hostname_fallback_origin_for_a_zone_update_fallback_origin_for_custom_hostnames_request.dart';
import '../models/response_common68.dart';

/// CustomHostnameFallbackOriginForAZoneApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CustomHostnameFallbackOriginForAZoneApi {
  const CustomHostnameFallbackOriginForAZoneApi(this._config);
  ...
  customHostnameFallbackOriginForAZoneGetFallbackOriginForCustomHostnames({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/custom_hostnames/fallback_origin',
  ...
  customHostnameFallbackOriginForAZoneUpdateFallbackOriginForCustomHostnames({
    required String zoneId,
    required CustomHostnameFallbackOriginForAZoneUpdateFallbackOriginForCustomHostnamesRequest
    body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
