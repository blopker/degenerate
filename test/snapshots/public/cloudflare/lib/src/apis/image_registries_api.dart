...
import '../models/cc_image_registry_credentials_configuration.dart';

/// ImageRegistriesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ImageRegistriesApi {
  const ImageRegistriesApi(this._config);
  ...
  Future<ApiResult<BaseResponse>> generateImageRegistryCredentials({
    required String accountId,
    required String domain,
    required CcImageRegistryCredentialsConfiguration body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/containers/registries/${Uri.encodeComponent(domain)}/credentials',
