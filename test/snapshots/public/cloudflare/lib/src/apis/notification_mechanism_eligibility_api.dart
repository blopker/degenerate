...
/// NotificationMechanismEligibilityApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class NotificationMechanismEligibilityApi {
  const NotificationMechanismEligibilityApi(this._config);
  ...
  notificationMechanismEligibilityGetDeliveryMechanismEligibility({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/alerting/v3/destinations/eligible',
