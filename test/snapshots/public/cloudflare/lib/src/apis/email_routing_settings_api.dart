...
import '../models/email_email_setting_dns_request_body.dart';
import '../models/email_routing_settings_disable_email_routing_dns_response.dart';
import '../models/email_routing_settings_email_routing_dns_settings_response.dart';
import '../models/response_common30.dart';

/// EmailRoutingSettingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class EmailRoutingSettingsApi {
  const EmailRoutingSettingsApi(this._config);
  ...
  emailRoutingSettingsGetEmailRoutingSettings({required String zoneId}) async {
  ...
  Future<ApiResult<EmailRoutingSettingsEmailRoutingDnsSettingsResponse>>
  emailRoutingSettingsEmailRoutingDnsSettings({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return EmailRoutingSettingsEmailRoutingDnsSettingsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  emailRoutingSettingsEnableEmailRoutingDns({
    required String zoneId,
    EmailEmailSettingDnsRequestBody? body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/email/routing/dns',
  ...
  Future<ApiResult<EmailRoutingSettingsDisableEmailRoutingDnsResponse>>
  emailRoutingSettingsDisableEmailRoutingDns({
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return EmailRoutingSettingsDisableEmailRoutingDnsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
