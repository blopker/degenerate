...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/delete_tag_delete_response.dart';import '../models/get_tag_indicators_list_response.dart';import '../models/get_tag_list_response.dart';import '../models/patch_tag_update_request.dart';import '../models/patch_tag_update_response.dart';import '../models/post_tag_create_request.dart';import '../models/post_tag_create_response.dart';/// TagApi operations.
///
...
Future<ApiResult<GetTagIndicatorsListResponse>> getTagIndicatorsList({required String accountId, required String tagUuid, required String datasetId, double? page, double? pageSize, String? indicatorType, List<String>? relatedEvent, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetTagListResponse>> getTagList({required String accountId, double? page, double? pageSize, String? search, String? categoryUuid, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PatchTagUpdateResponse>> patchTagUpdate({required String accountId, required String tagUuid, PatchTagUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
...
Future<ApiResult<DeleteTagDeleteResponse>> deleteTagDelete({required String accountId, required String tagUuid, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/tags/${Uri.encodeComponent(tagUuid)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<PostTagCreateResponse>> postTagCreate({required String accountId, PostTagCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
