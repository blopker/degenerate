...
import '../models/get_attacker_list_response.dart';

/// AttackerApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AttackerApi {
  const AttackerApi(this._config);
  ...
  Future<ApiResult<GetAttackerListResponse>> getAttackerList({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/attackers',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return GetAttackerListResponse.fromJson(
