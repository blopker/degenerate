...
import '../models/get_org_analytics_response.dart';
...
final class AnalyticsApi {
  ...
  Future<ApiResult<GetOrgAnalyticsResponse>> getOrgAnalytics({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/analytics/daywise',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return GetOrgAnalyticsResponse.fromJson(
