...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/workers_ai_get_model_schema_response.dart';import '../models/workers_ai_get_to_markdown_supported_response.dart';import '../models/workers_ai_post_run_model_request.dart';import '../models/workers_ai_post_run_model_response.dart';import '../models/workers_ai_post_to_markdown_request.dart';import '../models/workers_ai_post_to_markdown_response.dart';import '../models/workers_ai_search_author_response.dart';import '../models/workers_ai_search_model_response.dart';import '../models/workers_ai_search_task_response.dart';/// WorkersAiApi operations.
///
...
Future<ApiResult<WorkersAiSearchAuthorResponse>> workersAiSearchAuthor({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<WorkersAiGetModelSchemaResponse>> workersAiGetModelSchema({required String accountId, required String model, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<WorkersAiSearchModelResponse>> workersAiSearchModel({required String accountId, int? perPage, int? page, String? task, String? author, double? source, bool? hideExperimental, String? search, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<WorkersAiPostRunModelResponse>> workersAiPostRunModel({required String accountId, required String modelName, WorkersAiPostRunModelRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<WorkersAiSearchTaskResponse>> workersAiSearchTask({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<WorkersAiPostToMarkdownResponse>> workersAiPostToMarkdown({required String accountId, WorkersAiPostToMarkdownRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<WorkersAiGetToMarkdownSupportedResponse>> workersAiGetToMarkdownSupported({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
