...
import '../models/list_workers_order.dart';
import '../models/list_workers_order_by.dart';
import '../models/response.dart';
import '../models/response_common80.dart';
import '../models/workers_worker.dart';

/// WorkersApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class WorkersApi {
  const WorkersApi(this._config);
  ...
  Future<ApiResult<Response>> listBuildsByScript({
    required String accountId,
    required String externalScriptId,
    int? page,
    int? perPage,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/builds/workers/${Uri.encodeComponent(externalScriptId)}/builds',
  ...
  Future<ApiResult<Response>> listTriggersByScript({
    required String accountId,
    required String externalScriptId,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/builds/workers/${Uri.encodeComponent(externalScriptId)}/triggers',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon80>> listWorkers({
    required String accountId,
    int? page,
    int? perPage,
    ListWorkersOrderBy? orderBy,
    ListWorkersOrder? order,
  }) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<ResponseCommon80>> createWorker({
    required String accountId,
    required WorkersWorker body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/accounts/${Uri.encodeComponent(accountId)}/workers/workers',
  ...
  Future<ApiResult<ResponseCommon80>> getWorker({
    required String accountId,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/workers/workers/${Uri.encodeComponent(workerId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<ResponseCommon80>> updateWorker({
    required String accountId,
    required String workerId,
    required WorkersWorker body,
  }) async {
  ...
  Future<ApiResult<ResponseCommon80>> editWorker({
    required String accountId,
    required String workerId,
    required WorkersWorker body,
  }) async {
  ...
  Future<ApiResult<ResponseCommon80>> deleteWorker({
    required String accountId,
    required String workerId,
  }) async {
    final request = ApiRequest(
