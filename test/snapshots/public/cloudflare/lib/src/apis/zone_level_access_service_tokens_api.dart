...
import '../models/zone_level_access_service_tokens_create_a_service_token_request.dart';
import '../models/zone_level_access_service_tokens_update_a_service_token_request.dart';

/// ZoneLevelAccessServiceTokensApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class ZoneLevelAccessServiceTokensApi {
  const ZoneLevelAccessServiceTokensApi(this._config);
  ...
  zoneLevelAccessServiceTokensCreateAServiceToken({
    required String zoneId,
    required ZoneLevelAccessServiceTokensCreateAServiceTokenRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/access/service_tokens',
  ...
  zoneLevelAccessServiceTokensGetAServiceToken({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/zones/${Uri.encodeComponent(zoneId)}/access/service_tokens/${Uri.encodeComponent(serviceTokenId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  zoneLevelAccessServiceTokensUpdateAServiceToken({
    required String serviceTokenId,
    required String zoneId,
    required ZoneLevelAccessServiceTokensUpdateAServiceTokenRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path:
