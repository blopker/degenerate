...
import '../models/bot_management_feedback_report.dart';

/// FeedbackApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class FeedbackApi {
  const FeedbackApi(this._config);
  ...
  Future<ApiResult<List<BotManagementFeedbackReport>>>
  botManagementZoneFeedbackList({required String zoneId}) async {
    ...
    return _execute(
      ...
      onSuccess: (response) {
        ...
        return json
            .map(
              (e) => BotManagementFeedbackReport.fromJson(
  ...
  Future<ApiResult<void>> botManagementZoneFeedbackCreate({
    required String zoneId,
    required BotManagementFeedbackReport body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones/${Uri.encodeComponent(zoneId)}/bot_management/feedback',
