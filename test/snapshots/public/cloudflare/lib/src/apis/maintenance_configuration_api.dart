...
/// MaintenanceConfigurationApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class MaintenanceConfigurationApi {
  const MaintenanceConfigurationApi(this._config);
  ...
  Future<ApiResult<ResponseSingle39>> getMaintenanceConfig({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/accounts/${Uri.encodeComponent(accountId)}/r2-catalog/${Uri.encodeComponent(bucketName)}/maintenance-configs',
  ...
  Future<ApiResult<ResponseSingle39>> updateMaintenanceConfig({
    required String accountId,
    required String bucketName,
