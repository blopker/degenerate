...
import '../models/response_common83.dart';
import '../models/response_common85.dart';
import '../models/response_single_id.dart';
import '../models/zone_purge_request.dart';
import '../models/zones0_patch_request.dart';
import '../models/zones_get_direction.dart';
import '../models/zones_get_match.dart';
import '../models/zones_get_order.dart';
import '../models/zones_get_status.dart';
import '../models/zones_post_request.dart';
...
final class ZoneApi {
  ...
  ///
  /// `GET /zones`
  Future<ApiResult<ResponseCommon85>> zonesGet({
    String? name,
    ZonesGetStatus? status,
    String? accountId,
    String? accountName,
    double? page,
    double? perPage,
    ZonesGetOrder? order,
    ZonesGetDirection? direction,
    ZonesGetMatch? match,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon85.fromJson(
  ...
  ///
  /// `POST /zones`
  Future<ApiResult<ResponseCommon85>> zonesPost({
    required ZonesPostRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/zones',
  ...
  ///
  /// `GET /zones/{zone_id}`
  Future<ApiResult<ResponseCommon85>> zones0Get({
  ...
  ///
  /// `PATCH /zones/{zone_id}`
  Future<ApiResult<ResponseCommon85>> zones0Patch({
    required String zoneId,
    required Zones0PatchRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path: '/zones/${Uri.encodeComponent(zoneId)}',
  ...
  Future<ApiResult<ResponseCommon85>> zones0Delete({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
  ...
  Future<ApiResult<ResponseCommon83>> putZonesZoneIdActivationCheck({
    required String zoneId,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseCommon83.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<ResponseSingleId>> zonePurge({
    required String zoneId,
    required ZonePurgeRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ResponseSingleId.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
