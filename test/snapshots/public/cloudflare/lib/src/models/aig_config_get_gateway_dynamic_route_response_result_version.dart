...
import 'aig_config_get_gateway_dynamic_route_response_result_version_active.dart';final class AigConfigGetGatewayDynamicRouteResponseResultVersion {const AigConfigGetGatewayDynamicRouteResponseResultVersion({required this.active, this.comment, required this.createdAt, required this.data, required this.versionId, });
