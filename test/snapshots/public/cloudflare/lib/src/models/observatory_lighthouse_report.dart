...
import 'observatory_device_type.dart';
import 'observatory_lighthouse_report_error.dart';
import 'observatory_lighthouse_state.dart';

/// The Lighthouse report.
final class ObservatoryLighthouseReport {
  const ObservatoryLighthouseReport({
    this.cls,
    this.deviceType,
    this.error,
    this.fcp,
  ...
  factory ObservatoryLighthouseReport.fromJson(Map<String, dynamic> json) {
    return ObservatoryLighthouseReport(
      cls: json['cls'] != null ? (json['cls'] as num).toDouble() : null,
      deviceType: json['deviceType'] != null
          ? ObservatoryDeviceType.fromJson(json['deviceType'] as String)
          : null,
      error: json['error'] != null
          ? ObservatoryLighthouseReportError.fromJson(
      ...
      state: json['state'] != null
          ? ObservatoryLighthouseState.fromJson(json['state'] as String)
          : null,
  ...
  ObservatoryLighthouseReport copyWith({
    double Function()? cls,
    ObservatoryDeviceType Function()? deviceType,
    ObservatoryLighthouseReportError Function()? error,
    double Function()? fcp,
    String Function()? jsonReportUrl,
    double Function()? lcp,
    double Function()? performanceScore,
    double Function()? si,
    ObservatoryLighthouseState Function()? state,
    double Function()? tbt,
    double Function()? ttfb,
    double Function()? tti,
  }) {
    return ObservatoryLighthouseReport(
      ...
      jsonReportUrl: jsonReportUrl != null
          ? jsonReportUrl()
          : this.jsonReportUrl,
  ...
  @override
  String toString() {
    return 'ObservatoryLighthouseReport(cls: $cls, deviceType: $deviceType, error: $error, fcp: $fcp, jsonReportUrl: $jsonReportUrl, lcp: $lcp, performanceScore: $performanceScore, si: $si, state: $state, tbt: $tbt, ttfb: $ttfb, tti: $tti)';
  }
}
