...
final class DosNewSynProtectionRule {
  const DosNewSynProtectionRule({
  ...
  factory DosNewSynProtectionRule.fromJson(Map<String, dynamic> json) {
    return DosNewSynProtectionRule(
  ...
  DosNewSynProtectionRule copyWith({
  ...
  @override
  String toString() {
    return 'DosNewSynProtectionRule(burstSensitivity: $burstSensitivity, mitigationType: $mitigationType, mode: $mode, name: $name, rateSensitivity: $rateSensitivity, scope: $scope)';
  }
}
