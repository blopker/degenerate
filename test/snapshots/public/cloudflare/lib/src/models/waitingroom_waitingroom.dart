...
final class WaitingroomWaitingroom {
  const WaitingroomWaitingroom({
  ...
  factory WaitingroomWaitingroom.fromJson(Map<String, dynamic> json) {
    return WaitingroomWaitingroom(
      ...
      nextEventPrequeueStartTime:
          json['next_event_prequeue_start_time'] as String?,
  ...
  WaitingroomWaitingroom copyWith({
    ...
    String? Function()? nextEventPrequeueStartTime,
    String? Function()? nextEventStartTime,
    ...
    return WaitingroomWaitingroom(
      ...
      newUsersPerMinute: newUsersPerMinute != null
          ? newUsersPerMinute()
          : this.newUsersPerMinute,
      nextEventPrequeueStartTime: nextEventPrequeueStartTime != null
          ? nextEventPrequeueStartTime()
          : this.nextEventPrequeueStartTime,
      nextEventStartTime: nextEventStartTime != null
          ? nextEventStartTime()
          : this.nextEventStartTime,
