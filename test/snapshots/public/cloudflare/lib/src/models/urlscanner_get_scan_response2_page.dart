...
import 'urlscanner_get_scan_response2_page_screenshot.dart';

final class UrlscannerGetScanResponse2Page {
  const UrlscannerGetScanResponse2Page({
  ...
  factory UrlscannerGetScanResponse2Page.fromJson(Map<String, dynamic> json) {
    return UrlscannerGetScanResponse2Page(
      ...
      screenshot: json['screenshot'] != null
          ? UrlscannerGetScanResponse2PageScreenshot.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('apexDomain') &&
        json['apexDomain'] is String &&
        json.containsKey('asn') &&
        json['asn'] is String &&
        ...
        json.containsKey('server') &&
        json['server'] is String &&
        json.containsKey('status') &&
        json['status'] is String &&
        json.containsKey('title') &&
        json['title'] is String &&
        json.containsKey('tlsAgeDays') &&
        json['tlsAgeDays'] is num &&
        json.containsKey('tlsIssuer') &&
        json['tlsIssuer'] is String &&
        json.containsKey('tlsValidDays') &&
        json['tlsValidDays'] is num &&
        json.containsKey('tlsValidFrom') &&
        json['tlsValidFrom'] is String &&
        json.containsKey('url') &&
        json['url'] is String;
  }

  UrlscannerGetScanResponse2Page copyWith({
    String? apexDomain,
    String? asn,
    String? asnname,
    String? city,
    ...
    String? ip,
    String? mimeType,
    UrlscannerGetScanResponse2PageScreenshot Function()? screenshot,
    String? server,
    String? status,
    String? title,
    double? tlsAgeDays,
  ...
  @override
  String toString() {
    return 'UrlscannerGetScanResponse2Page(apexDomain: $apexDomain, asn: $asn, asnname: $asnname, city: $city, country: $country, domain: $domain, ip: $ip, mimeType: $mimeType, screenshot: $screenshot, server: $server, status: $status, title: $title, tlsAgeDays: $tlsAgeDays, tlsIssuer: $tlsIssuer, tlsValidDays: $tlsValidDays, tlsValidFrom: $tlsValidFrom, url: $url)';
  }
}
