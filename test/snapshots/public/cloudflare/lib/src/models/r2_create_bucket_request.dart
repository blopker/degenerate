...
import 'r2_bucket_location.dart';import 'r2_storage_class.dart';final class R2CreateBucketRequest {const R2CreateBucketRequest({this.locationHint, required this.name, this.storageClass, });
...
R2CreateBucketRequest copyWith({R2BucketLocation Function()? locationHint, String? name, R2StorageClass Function()? storageClass, }) { return R2CreateBucketRequest(
