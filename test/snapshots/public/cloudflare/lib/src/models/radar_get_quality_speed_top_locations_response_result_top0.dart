...
final class RadarGetQualitySpeedTopLocationsResponseResultTop0 {
  const RadarGetQualitySpeedTopLocationsResponseResultTop0({
  ...
  factory RadarGetQualitySpeedTopLocationsResponseResultTop0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetQualitySpeedTopLocationsResponseResultTop0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('bandwidthDownload') &&
        ...
        json.containsKey('clientCountryAlpha2') &&
        json['clientCountryAlpha2'] is String &&
        json.containsKey('clientCountryName') &&
        json['clientCountryName'] is String &&
  ...
  RadarGetQualitySpeedTopLocationsResponseResultTop0 copyWith({
    String? bandwidthDownload,
    String? bandwidthUpload,
    String? clientCountryAlpha2,
