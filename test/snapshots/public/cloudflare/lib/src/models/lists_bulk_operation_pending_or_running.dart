...
import 'lists_bulk_operation_pending_or_running_status.dart';final class ListsBulkOperationPendingOrRunning {const ListsBulkOperationPendingOrRunning({required this.id, required this.status, });
...
ListsBulkOperationPendingOrRunning copyWith({String? id, ListsBulkOperationPendingOrRunningStatus? status, }) { return ListsBulkOperationPendingOrRunning(
  id: id ?? this.id,
