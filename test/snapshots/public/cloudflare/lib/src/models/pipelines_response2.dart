...
import 'pipelines_response2_result.dart';final class PipelinesResponse2 {const PipelinesResponse2({required this.result, required this.success, });
...
PipelinesResponse2 copyWith({PipelinesResponse2Result? result, bool? success, }) { return PipelinesResponse2(
