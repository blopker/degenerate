...
import 'package:collection/collection.dart';final class ZeroTrustGatewayApplicationsReviewStatusResponseContent {const ZeroTrustGatewayApplicationsReviewStatusResponseContent({this.approvedApps, this.createdAt, this.inReviewApps, this.unapprovedApps, this.updatedAt, });
...
ZeroTrustGatewayApplicationsReviewStatusResponseContent copyWith({List<int> Function()? approvedApps, DateTime Function()? createdAt, List<int> Function()? inReviewApps, List<int> Function()? unapprovedApps, DateTime Function()? updatedAt, }) { return ZeroTrustGatewayApplicationsReviewStatusResponseContent(
