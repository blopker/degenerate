...
final class MagicCreateGreTunnelRequest {
  const MagicCreateGreTunnelRequest({
  ...
  factory MagicCreateGreTunnelRequest.fromJson(Map<String, dynamic> json) {
    return MagicCreateGreTunnelRequest(
  ...
  MagicCreateGreTunnelRequest copyWith({
