...
final class RadarGetBgpRoutesRealtimeResponseResultMetaCollectors {
  const RadarGetBgpRoutesRealtimeResponseResultMetaCollectors({
  ...
  factory RadarGetBgpRoutesRealtimeResponseResultMetaCollectors.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetBgpRoutesRealtimeResponseResultMetaCollectors(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('collector') &&
        json['collector'] is String &&
        json.containsKey('latest_realtime_ts') &&
        json['latest_realtime_ts'] is String &&
        json.containsKey('latest_rib_ts') &&
        json['latest_rib_ts'] is String &&
        json.containsKey('latest_updates_ts') &&
        json['latest_updates_ts'] is String &&
        json.containsKey('peers_count') &&
        json['peers_count'] is num &&
        json.containsKey('peers_v4_count') &&
        json['peers_v4_count'] is num &&
        json.containsKey('peers_v6_count') &&
        json['peers_v6_count'] is num;
  }

  RadarGetBgpRoutesRealtimeResponseResultMetaCollectors copyWith({
    String? collector,
    String? latestRealtimeTs,
    String? latestRibTs,
    String? latestUpdatesTs,
    int? peersCount,
    int? peersV4Count,
    int? peersV6Count,
  }) {
  ...
  @override
  String toString() {
    return 'RadarGetBgpRoutesRealtimeResponseResultMetaCollectors(collector: $collector, latestRealtimeTs: $latestRealtimeTs, latestRibTs: $latestRibTs, latestUpdatesTs: $latestUpdatesTs, peersCount: $peersCount, peersV4Count: $peersV4Count, peersV6Count: $peersV6Count)';
  }
}
