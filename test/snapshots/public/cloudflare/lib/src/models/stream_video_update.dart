...
import 'package:collection/collection.dart';final class StreamVideoUpdate {const StreamVideoUpdate({this.allowedOrigins, this.creator, this.maxDurationSeconds, this.meta, this.requireSignedUrLs, this.scheduledDeletion, this.thumbnailTimestampPct, this.uploadExpiry, });
...
StreamVideoUpdate copyWith({List<String> Function()? allowedOrigins, String Function()? creator, int Function()? maxDurationSeconds, Map<String, String> Function()? meta, bool Function()? requireSignedUrLs, DateTime Function()? scheduledDeletion, double Function()? thumbnailTimestampPct, DateTime Function()? uploadExpiry, }) { return StreamVideoUpdate(
