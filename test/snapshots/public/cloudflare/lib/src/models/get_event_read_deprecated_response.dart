...
final class GetEventReadDeprecatedResponse {
  const GetEventReadDeprecatedResponse({
  ...
  factory GetEventReadDeprecatedResponse.fromJson(Map<String, dynamic> json) {
    return GetEventReadDeprecatedResponse(
  ...
  GetEventReadDeprecatedResponse copyWith({
    String? attacker,
