...
import 'mq_worker_consumer_response_settings.dart';final class MqWorkerConsumerResponse {const MqWorkerConsumerResponse({this.consumerId, this.createdOn, this.deadLetterQueue, this.queueName, this.scriptName, this.settings, this.type, });
...
MqWorkerConsumerResponse copyWith({String Function()? consumerId, DateTime Function()? createdOn, String Function()? deadLetterQueue, String Function()? queueName, String Function()? scriptName, MqWorkerConsumerResponseSettings Function()? settings, String Function()? type, }) { return MqWorkerConsumerResponse(
