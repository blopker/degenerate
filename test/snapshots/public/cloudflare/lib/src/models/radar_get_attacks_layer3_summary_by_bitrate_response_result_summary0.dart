...
final class RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0 {
  const RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0({
  ...
  factory RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('_1_GBPS_TO_10_GBPS') &&
        json['_1_GBPS_TO_10_GBPS'] is String &&
        json.containsKey('_10_GBPS_TO_100_GBPS') &&
        json['_10_GBPS_TO_100_GBPS'] is String &&
        json.containsKey('_500_MBPS_TO_1_GBPS') &&
        json['_500_MBPS_TO_1_GBPS'] is String &&
        json.containsKey('OVER_100_GBPS') &&
        json['OVER_100_GBPS'] is String &&
        json.containsKey('UNDER_500_MBPS') &&
        json['UNDER_500_MBPS'] is String;
  }

  RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0 copyWith({
    String? $1GbpsTo10Gbps,
    String? $10GbpsTo100Gbps,
    String? $500MbpsTo1Gbps,
    String? over100Gbps,
    String? under500Mbps,
  }) {
    return RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0(
  ...
  @override
  String toString() {
    return 'RadarGetAttacksLayer3SummaryByBitrateResponseResultSummary0(\$1GbpsTo10Gbps: ${$1GbpsTo10Gbps}, \$10GbpsTo100Gbps: ${$10GbpsTo100Gbps}, \$500MbpsTo1Gbps: ${$500MbpsTo1Gbps}, over100Gbps: $over100Gbps, under500Mbps: $under500Mbps)';
  }
}
