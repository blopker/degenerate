...
import 'zaraz_timer_rule_action.dart';import 'zaraz_timer_rule_settings.dart';final class ZarazTimerRule {const ZarazTimerRule({required this.action, required this.id, required this.settings, });
