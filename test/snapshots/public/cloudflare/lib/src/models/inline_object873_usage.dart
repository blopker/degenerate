...
final class InlineObject873Usage {const InlineObject873Usage({this.completionTokens = 0.0, this.promptTokens = 0.0, this.totalTokens = 0.0, });

factory InlineObject873Usage.fromJson(Map<String, dynamic> json) { return InlineObject873Usage(
...
InlineObject873Usage copyWith({double Function()? completionTokens, double Function()? promptTokens, double Function()? totalTokens, }) { return InlineObject873Usage(
...
@override String toString() { return 'InlineObject873Usage(completionTokens: $completionTokens, promptTokens: $promptTokens, totalTokens: $totalTokens)'; } 
 }
