...
final class MconnSupportDevice {
  const MconnSupportDevice({
  ...
  factory MconnSupportDevice.fromJson(Map<String, dynamic> json) {
    return MconnSupportDevice(
  ...
  @override
  String toString() {
    return 'MconnSupportDevice(cryptKeyRotationFinishedAt: $cryptKeyRotationFinishedAt, cryptKeyRotationStartedAt: $cryptKeyRotationStartedAt, cryptKeyRotationStatusCode: $cryptKeyRotationStatusCode, deviceType: $deviceType, ekCert: $ekCert, id: $id, imagedAt: $imagedAt, lastUpdated: $lastUpdated, metadata: $metadata, pkiRotationFinishedAt: $pkiRotationFinishedAt, pkiRotationStartedAt: $pkiRotationStartedAt, pkiRotationStatusCode: $pkiRotationStatusCode, serialNumber: $serialNumber)';
  }
}
