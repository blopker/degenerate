...
final class MconnAdminConnector {
  const MconnAdminConnector({
  ...
  factory MconnAdminConnector.fromJson(Map<String, dynamic> json) {
    return MconnAdminConnector(
