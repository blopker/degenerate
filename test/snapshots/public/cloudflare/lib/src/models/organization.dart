...
final class Organization {
  ...
  Organization copyWith({
    ...
    String? name,
    OrganizationParent Function()? parent,
  ...
  @override
  int get hashCode {
    return Object.hash(createTime, id, meta, name, parent, profile);
  }

  @override
  String toString() {
    return 'Organization(createTime: $createTime, id: $id, meta: $meta, name: $name, parent: $parent, profile: $profile)';
  }
}
