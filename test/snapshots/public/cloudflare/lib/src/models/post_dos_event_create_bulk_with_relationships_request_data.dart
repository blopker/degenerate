...
import 'post_dos_event_create_bulk_with_relationships_request_data_indicators.dart';
import 'post_dos_event_create_bulk_with_relationships_request_data_raw.dart';

final class PostDosEventCreateBulkWithRelationshipsRequestData {
  const PostDosEventCreateBulkWithRelationshipsRequestData({
    this.accountId,
    this.attacker,
  ...
  factory PostDosEventCreateBulkWithRelationshipsRequestData.fromJson(
    Map<String, dynamic> json,
  ) {
    return PostDosEventCreateBulkWithRelationshipsRequestData(
      accountId: json['accountId'] != null
          ? (json['accountId'] as num).toDouble()
          : null,
      ...
      indicators: (json['indicators'] as List<dynamic>?)
          ?.map(
            (e) =>
                PostDosEventCreateBulkWithRelationshipsRequestDataIndicators.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      insight: json['insight'] as String?,
      raw: PostDosEventCreateBulkWithRelationshipsRequestDataRaw.fromJson(
  ...
  final List<PostDosEventCreateBulkWithRelationshipsRequestDataIndicators>?
  indicators;
  ...
  PostDosEventCreateBulkWithRelationshipsRequestData copyWith({
    double Function()? accountId,
    String? Function()? attacker,
    String Function()? attackerCountry,
    String? category,
    String Function()? datasetId,
    DateTime? date,
    String? event,
    String Function()? indicator,
    String Function()? indicatorType,
    List<PostDosEventCreateBulkWithRelationshipsRequestDataIndicators>
    Function()?
    indicators,
    String Function()? insight,
    PostDosEventCreateBulkWithRelationshipsRequestDataRaw? raw,
    List<String> Function()? tags,
    String Function()? targetCountry,
    String Function()? targetIndustry,
    String? tlp,
  }) {
    return PostDosEventCreateBulkWithRelationshipsRequestData(
      accountId: accountId != null ? accountId() : this.accountId,
      attacker: attacker != null ? attacker() : this.attacker,
      attackerCountry: attackerCountry != null
          ? attackerCountry()
          : this.attackerCountry,
  ...
  int get hashCode {
    return Object.hash(
      ...
      indicator,
      indicatorType,
      Object.hashAll(indicators ?? const []),
      insight,
      raw,
