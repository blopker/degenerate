...
final class AccountLoadBalancerPoolsUpdatePoolRequest {
  const AccountLoadBalancerPoolsUpdatePoolRequest({
    this.checkRegions,
    this.description,
    this.disabledAt,
    this.enabled,
  ...
  factory AccountLoadBalancerPoolsUpdatePoolRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountLoadBalancerPoolsUpdatePoolRequest(
  ...
  AccountLoadBalancerPoolsUpdatePoolRequest copyWith({
