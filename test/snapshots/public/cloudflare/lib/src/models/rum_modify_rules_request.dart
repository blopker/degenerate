...
import 'package:collection/collection.dart';import 'rum_modify_rules_request_rules.dart';final class RumModifyRulesRequest {const RumModifyRulesRequest({this.deleteRules, this.rules, });

factory RumModifyRulesRequest.fromJson(Map<String, dynamic> json) { return RumModifyRulesRequest(
  deleteRules: (json['delete_rules'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
RumModifyRulesRequest copyWith({List<String> Function()? deleteRules, List<RumModifyRulesRequestRules> Function()? rules, }) { return RumModifyRulesRequest(
