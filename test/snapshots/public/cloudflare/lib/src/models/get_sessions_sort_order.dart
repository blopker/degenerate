...
final class GetSessionsSortOrder {
  const GetSessionsSortOrder._(this.value);

  factory GetSessionsSortOrder.fromJson(String json) {
    return switch (json) {
      'ASC' => asc,
      'DESC' => desc,
  ...
  @override
  String toString() {
    return 'GetSessionsSortOrder($value)';
  }
}
