...
import 'package:collection/collection.dart';import 'bundle_messages2.dart';final class ResponseCommonFailure77 {const ResponseCommonFailure77({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure77 copyWith({List<BundleMessages2>? errors, List<BundleMessages2>? messages, Map<String, String>? Function()? result, bool? success, }) { return ResponseCommonFailure77(
