...
import 'zero_trust_gateway_binding_status.dart';import 'zero_trust_gateway_type.dart';final class ZeroTrustGatewayCertificates {const ZeroTrustGatewayCertificates({this.bindingStatus, this.certificate, this.createdAt, this.expiresOn, this.fingerprint, this.id, this.inUse, this.issuerOrg, this.issuerRaw, this.type, this.updatedAt, this.uploadedOn, });
...
ZeroTrustGatewayCertificates copyWith({ZeroTrustGatewayBindingStatus Function()? bindingStatus, String Function()? certificate, DateTime Function()? createdAt, DateTime Function()? expiresOn, String Function()? fingerprint, String Function()? id, bool Function()? inUse, String Function()? issuerOrg, String Function()? issuerRaw, ZeroTrustGatewayType Function()? type, DateTime Function()? updatedAt, DateTime Function()? uploadedOn, }) { return ZeroTrustGatewayCertificates(
