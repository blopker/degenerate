...
final class ZeroTrustGatewayDnsResolverSettings2 {
  const ZeroTrustGatewayDnsResolverSettings2({
    required this.ip,
    this.port,
  ...
  factory ZeroTrustGatewayDnsResolverSettings2.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayDnsResolverSettings2(
      ip: json['ip'] as String,
      port: json['port'] != null ? (json['port'] as num).toInt() : null,
      routeThroughPrivateNetwork:
          json['route_through_private_network'] as bool?,
  ...
  ZeroTrustGatewayDnsResolverSettings2 copyWith({
    String? ip,
    int Function()? port,
    bool Function()? routeThroughPrivateNetwork,
    String Function()? vnetId,
  }) {
    return ZeroTrustGatewayDnsResolverSettings2(
      ip: ip ?? this.ip,
      port: port != null ? port() : this.port,
      routeThroughPrivateNetwork: routeThroughPrivateNetwork != null
          ? routeThroughPrivateNetwork()
          : this.routeThroughPrivateNetwork,
  ...
  @override
  int get hashCode {
    return Object.hash(ip, port, routeThroughPrivateNetwork, vnetId);
  }

  @override
  String toString() {
    return 'ZeroTrustGatewayDnsResolverSettings2(ip: $ip, port: $port, routeThroughPrivateNetwork: $routeThroughPrivateNetwork, vnetId: $vnetId)';
  }
}
