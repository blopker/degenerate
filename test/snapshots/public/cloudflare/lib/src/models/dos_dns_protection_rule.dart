...
final class DosDnsProtectionRule {
  const DosDnsProtectionRule({
  ...
  factory DosDnsProtectionRule.fromJson(Map<String, dynamic> json) {
    return DosDnsProtectionRule(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('burst_sensitivity') &&
        json['burst_sensitivity'] is String &&
        ...
        json['name'] is String &&
        json.containsKey('profile_sensitivity') &&
        json['profile_sensitivity'] is String &&
        json.containsKey('rate_sensitivity') &&
        json['rate_sensitivity'] is String &&
        json.containsKey('scope') &&
        json['scope'] is String;
  }

  DosDnsProtectionRule copyWith({
    String? burstSensitivity,
    DateTime? createdOn,
    String? id,
    String? mode,
    DateTime? modifiedOn,
    String? name,
    String? profileSensitivity,
    String? rateSensitivity,
    String? scope,
  }) {
    return DosDnsProtectionRule(
  ...
  @override
  String toString() {
    return 'DosDnsProtectionRule(burstSensitivity: $burstSensitivity, createdOn: $createdOn, id: $id, mode: $mode, modifiedOn: $modifiedOn, name: $name, profileSensitivity: $profileSensitivity, rateSensitivity: $rateSensitivity, scope: $scope)';
  }
}
