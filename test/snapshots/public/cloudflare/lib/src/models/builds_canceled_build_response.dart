...
import 'builds_build_outcome.dart';final class BuildsCanceledBuildResponse {const BuildsCanceledBuildResponse({this.buildOutcome, this.buildUuid, this.stoppedOn, });
...
BuildsCanceledBuildResponse copyWith({BuildsBuildOutcome Function()? buildOutcome, String Function()? buildUuid, DateTime? Function()? stoppedOn, }) { return BuildsCanceledBuildResponse(
