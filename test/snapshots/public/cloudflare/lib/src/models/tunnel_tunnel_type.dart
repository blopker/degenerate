...
/// The type of tunnel.
final class TunnelTunnelType {
  const TunnelTunnelType._(this.value);

  factory TunnelTunnelType.fromJson(String json) {
    return switch (json) {
  ...
  static const TunnelTunnelType warpConnector = TunnelTunnelType._(
    'warp_connector',
  );
  ...
  static const List<TunnelTunnelType> values = [
    cfdTunnel,
    warpConnector,
    warp,
    magic,
