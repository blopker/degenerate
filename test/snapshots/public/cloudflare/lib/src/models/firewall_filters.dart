...
import 'firewall_filters_configuration_target.dart';import 'firewall_filters_match.dart';import 'firewall_schemas_mode.dart';final class FirewallFilters {const FirewallFilters({this.configurationTarget, this.configurationValue, this.match = FirewallFiltersMatch.all, this.mode, this.notes, });
