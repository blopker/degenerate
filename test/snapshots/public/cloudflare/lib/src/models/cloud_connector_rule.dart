...
import 'cloud_connector_provider.dart';import 'cloud_connector_rule_parameters.dart';final class CloudConnectorRule {const CloudConnectorRule({this.description, this.enabled, this.expression, this.id, this.parameters, this.provider, });
