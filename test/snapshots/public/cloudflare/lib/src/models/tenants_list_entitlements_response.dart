...
TenantsListEntitlementsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, InnateEntitlements? result, bool? success, }) { return TenantsListEntitlementsResponse(
