...
final class ZonesGetOrder {
  const ZonesGetOrder._(this.value);

  factory ZonesGetOrder.fromJson(String json) {
    return switch (json) {
      'name' => name$,
      'status' => status,
  ...
  static const List<ZonesGetOrder> values = [
    name$,
    status,
    accountId,
    accountName,
