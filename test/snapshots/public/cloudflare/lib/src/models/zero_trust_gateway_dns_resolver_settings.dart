...
final class ZeroTrustGatewayDnsResolverSettings {
  const ZeroTrustGatewayDnsResolverSettings({
    required this.ip,
    this.port,
  ...
  factory ZeroTrustGatewayDnsResolverSettings.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayDnsResolverSettings(
  ...
  ZeroTrustGatewayDnsResolverSettings copyWith({
    String? ip,
    int Function()? port,
  ...
  @override
  String toString() {
    return 'ZeroTrustGatewayDnsResolverSettings(ip: $ip, port: $port, routeThroughPrivateNetwork: $routeThroughPrivateNetwork, vnetId: $vnetId)';
  }
}
