...
final class PostEventQueryCreateRequest {
  const PostEventQueryCreateRequest({
  ...
  factory PostEventQueryCreateRequest.fromJson(Map<String, dynamic> json) {
    return PostEventQueryCreateRequest(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('alert_enabled') &&
  ...
  PostEventQueryCreateRequest copyWith({
    bool? alertEnabled,
  ...
  @override
  String toString() {
    return 'PostEventQueryCreateRequest(alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope)';
  }
}
