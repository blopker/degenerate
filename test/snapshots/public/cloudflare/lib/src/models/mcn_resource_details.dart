...
factory McnResourceDetails.fromJson(Map<String, dynamic> json) { return McnResourceDetails(
  ...
  deploymentProvider: json['deployment_provider'] as String,
  ...
  providerIds: (json['provider_ids'] as List<dynamic>).map((e) => e as String).toList(),
  ...
  state: (json['state'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('account_id') && json['account_id'] is String &&
      ...
      json.containsKey('deployment_provider') && json['deployment_provider'] is String &&
...
McnResourceDetails copyWith({String? accountId, McnCloudType? cloudType, Map<String,String>? config, String? deploymentProvider, String? id, bool? managed, List<McnCloudPlatformClient> Function()? managedBy, McnCost? monthlyCostEstimate, String? name, String? nativeId, Map<String,McnObservation>? observations, List<String>? providerIds, Map<String,String>? providerNamesById, String? region, String? resourceGroup, McnResourceType? resourceType, List<McnResourceDetailsSection>? sections, Map<String,String>? state, Map<String,String>? tags, String? updatedAt, String? url, }) { return McnResourceDetails(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is McnResourceDetails &&
          ...
          const ListEquality<dynamic>().equals(managedBy, other.managedBy) &&
          monthlyCostEstimate == other.monthlyCostEstimate &&
          name == other.name &&
          nativeId == other.nativeId &&
          observations == other.observations &&
          const ListEquality<dynamic>().equals(providerIds, other.providerIds) &&
          providerNamesById == other.providerNamesById &&
          region == other.region &&
          resourceGroup == other.resourceGroup &&
          resourceType == other.resourceType &&
          const ListEquality<dynamic>().equals(sections, other.sections) &&
          state == other.state &&
          tags == other.tags &&
