...
import 'mcn_cloud_type.dart';
import 'mcn_cost.dart';
import 'mcn_observation.dart';
import 'mcn_resource_details_section.dart';
import 'mcn_resource_type.dart';

final class McnResourceDetails {
  const McnResourceDetails({
  ...
  factory McnResourceDetails.fromJson(Map<String, dynamic> json) {
    return McnResourceDetails(
      ...
      managedBy: (json['managed_by'] as List<dynamic>?)
          ?.map(
            (e) => McnCloudPlatformClient.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      monthlyCostEstimate: McnCost.fromJson(
        json['monthly_cost_estimate'] as Map<String, dynamic>,
      ),
      name: json['name'] as String,
      nativeId: json['native_id'] as String,
      observations: (json['observations'] as Map<String, dynamic>).map(
        (k, v) =>
            MapEntry(k, McnObservation.fromJson(v as Map<String, dynamic>)),
      ),
      providerIds: (json['provider_ids'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      providerNamesById: (json['provider_names_by_id'] as Map<String, dynamic>)
      ...
      sections: (json['sections'] as List<dynamic>)
          .map(
            (e) =>
                McnResourceDetailsSection.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'managed': managed,
      if (managedBy != null)
        'managed_by': managedBy?.map((e) => e.toJson()).toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account_id') &&
        ...
        json['deployment_provider'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('managed') &&
        json['managed'] is bool &&
        json.containsKey('monthly_cost_estimate') &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('native_id') &&
        json['native_id'] is String &&
        ...
        json.containsKey('resource_group') &&
        json['resource_group'] is String &&
  ...
  McnResourceDetails copyWith({
    String? accountId,
    McnCloudType? cloudType,
    Map<String, String>? config,
    String? deploymentProvider,
    String? id,
    bool? managed,
    List<McnCloudPlatformClient> Function()? managedBy,
    McnCost? monthlyCostEstimate,
    String? name,
    String? nativeId,
    Map<String, McnObservation>? observations,
    List<String>? providerIds,
    Map<String, String>? providerNamesById,
    String? region,
    String? resourceGroup,
    McnResourceType? resourceType,
    List<McnResourceDetailsSection>? sections,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      id,
      managed,
      Object.hashAll(managedBy ?? const []),
      monthlyCostEstimate,
      name,
      nativeId,
      observations,
