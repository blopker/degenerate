...
final class Timeseries2 {
  ...
  factory Timeseries2.fromJson(Map<String, dynamic> json) {
    return Timeseries2(
  ...
  Timeseries2 copyWith({
    Bandwidth2 Function()? bandwidth,
    Pageviews Function()? pageviews,
    Requests Function()? requests,
    Since Function()? since,
    Threats Function()? threats,
    Uniques Function()? uniques,
  ...
  @override
  String toString() {
    return 'Timeseries2(bandwidth: $bandwidth, pageviews: $pageviews, requests: $requests, since: $since, threats: $threats, uniques: $uniques, until: $until)';
  }
}
