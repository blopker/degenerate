...
import 'package:collection/collection.dart';import 'alexandria_messages2.dart';final class ResponseCommonFailure6 {const ResponseCommonFailure6({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure6 copyWith({List<AlexandriaMessages2>? errors, List<AlexandriaMessages2>? messages, Map<String, String>? Function()? result, bool? success, }) { return ResponseCommonFailure6(
