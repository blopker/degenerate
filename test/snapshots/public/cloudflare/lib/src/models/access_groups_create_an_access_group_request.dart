...
import 'package:collection/collection.dart';import 'access_rule.dart';final class AccessGroupsCreateAnAccessGroupRequest {const AccessGroupsCreateAnAccessGroupRequest({this.exclude, required this.include, this.isDefault, required this.name, this.require, });
...
AccessGroupsCreateAnAccessGroupRequest copyWith({List<AccessRule> Function()? exclude, List<AccessRule>? include, bool Function()? isDefault, String? name, List<AccessRule> Function()? require, }) { return AccessGroupsCreateAnAccessGroupRequest(
