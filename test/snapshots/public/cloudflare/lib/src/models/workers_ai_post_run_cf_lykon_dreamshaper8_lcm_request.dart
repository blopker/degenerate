...
final class WorkersAiPostRunCfLykonDreamshaper8LcmRequest {
  const WorkersAiPostRunCfLykonDreamshaper8LcmRequest({
    this.guidance = 7.5,
    this.height,
    this.image,
    this.imageB64,
  ...
  factory WorkersAiPostRunCfLykonDreamshaper8LcmRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersAiPostRunCfLykonDreamshaper8LcmRequest(
  ...
  WorkersAiPostRunCfLykonDreamshaper8LcmRequest copyWith({
  ...
  @override
  String toString() {
    return 'WorkersAiPostRunCfLykonDreamshaper8LcmRequest(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)';
  }
}
