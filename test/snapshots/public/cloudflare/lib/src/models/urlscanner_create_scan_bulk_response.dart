...
import 'urlscanner_create_scan_bulk_response_options.dart';import 'urlscanner_create_scan_bulk_response_visibility.dart';final class UrlscannerCreateScanBulkResponse {const UrlscannerCreateScanBulkResponse({required this.api, this.options, required this.result, required this.url, required this.uuid, required this.visibility, });
