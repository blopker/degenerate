...
import 'package:collection/collection.dart';import 'r2_slurper_s3_like_creds_schema.dart';import 'r2_slurper_s3_source_schema_vendor.dart';final class R2SlurperS3SourceSchema {const R2SlurperS3SourceSchema({required this.bucket, this.endpoint, this.keys, this.pathPrefix, this.region, required this.secret, required this.vendor, });
