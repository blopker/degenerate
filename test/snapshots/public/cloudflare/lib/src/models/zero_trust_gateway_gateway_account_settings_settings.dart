...
import 'zero_trust_gateway_activity_log_settings.dart';
import 'zero_trust_gateway_anti_virus_settings.dart';
import 'zero_trust_gateway_block_page_settings.dart';
import 'zero_trust_gateway_body_scanning_settings.dart';
import 'zero_trust_gateway_browser_isolation_settings.dart';
import 'zero_trust_gateway_certificate_settings.dart';
import 'zero_trust_gateway_custom_certificate_settings.dart';
import 'zero_trust_gateway_extended_email_matching.dart';
import 'zero_trust_gateway_fips_settings.dart';
import 'zero_trust_gateway_host_selector_settings.dart';
import 'zero_trust_gateway_inspection_settings.dart';
import 'zero_trust_gateway_protocol_detection.dart';
import 'zero_trust_gateway_sandbox.dart';
import 'zero_trust_gateway_tls_settings.dart';
...
final class ZeroTrustGatewayGatewayAccountSettingsSettings {
  ...
  factory ZeroTrustGatewayGatewayAccountSettingsSettings.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayGatewayAccountSettingsSettings(
      activityLog: json['activity_log'] != null
          ? ZeroTrustGatewayActivityLogSettings.fromJson(
              json['activity_log'] as Map<String, dynamic>,
            )
          : null,
      antivirus: json['antivirus'] != null
          ? ZeroTrustGatewayAntiVirusSettings.fromJson(
              json['antivirus'] as Map<String, dynamic>,
            )
          : null,
      blockPage: json['block_page'] != null
          ? ZeroTrustGatewayBlockPageSettings.fromJson(
              json['block_page'] as Map<String, dynamic>,
            )
          : null,
      bodyScanning: json['body_scanning'] != null
          ? ZeroTrustGatewayBodyScanningSettings.fromJson(
              json['body_scanning'] as Map<String, dynamic>,
            )
          : null,
      browserIsolation: json['browser_isolation'] != null
          ? ZeroTrustGatewayBrowserIsolationSettings.fromJson(
              json['browser_isolation'] as Map<String, dynamic>,
            )
          : null,
      certificate: json['certificate'] != null
          ? ZeroTrustGatewayCertificateSettings.fromJson(
              json['certificate'] as Map<String, dynamic>,
            )
          : null,
      customCertificate: json['custom_certificate'] != null
          ? ZeroTrustGatewayCustomCertificateSettings.fromJson(
              json['custom_certificate'] as Map<String, dynamic>,
            )
          : null,
      extendedEmailMatching: json['extended_email_matching'] != null
          ? ZeroTrustGatewayExtendedEmailMatching.fromJson(
              json['extended_email_matching'] as Map<String, dynamic>,
            )
          : null,
      fips: json['fips'] != null
          ? ZeroTrustGatewayFipsSettings.fromJson(
              json['fips'] as Map<String, dynamic>,
            )
          : null,
      hostSelector: json['host_selector'] != null
          ? ZeroTrustGatewayHostSelectorSettings.fromJson(
              json['host_selector'] as Map<String, dynamic>,
            )
          : null,
      inspection: json['inspection'] != null
          ? ZeroTrustGatewayInspectionSettings.fromJson(
              json['inspection'] as Map<String, dynamic>,
            )
          : null,
      protocolDetection: json['protocol_detection'] != null
          ? ZeroTrustGatewayProtocolDetection.fromJson(
              json['protocol_detection'] as Map<String, dynamic>,
            )
          : null,
      sandbox: json['sandbox'] != null
          ? ZeroTrustGatewaySandbox.fromJson(
              json['sandbox'] as Map<String, dynamic>,
            )
          : null,
      tlsDecrypt: json['tls_decrypt'] != null
          ? ZeroTrustGatewayTlsSettings.fromJson(
              json['tls_decrypt'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (browserIsolation != null)
        'browser_isolation': browserIsolation?.toJson(),
      if (certificate != null) 'certificate': certificate?.toJson(),
      if (customCertificate != null)
        'custom_certificate': customCertificate?.toJson(),
      if (extendedEmailMatching != null)
        'extended_email_matching': extendedEmailMatching?.toJson(),
      ...
      if (protocolDetection != null)
        'protocol_detection': protocolDetection?.toJson(),
  ...
  ZeroTrustGatewayGatewayAccountSettingsSettings copyWith({
    ZeroTrustGatewayActivityLogSettings Function()? activityLog,
    ZeroTrustGatewayAntiVirusSettings Function()? antivirus,
    ZeroTrustGatewayBlockPageSettings Function()? blockPage,
    ZeroTrustGatewayBodyScanningSettings Function()? bodyScanning,
    ZeroTrustGatewayBrowserIsolationSettings Function()? browserIsolation,
    ZeroTrustGatewayCertificateSettings Function()? certificate,
    ZeroTrustGatewayCustomCertificateSettings Function()? customCertificate,
    ZeroTrustGatewayExtendedEmailMatching Function()? extendedEmailMatching,
    ZeroTrustGatewayFipsSettings Function()? fips,
    ZeroTrustGatewayHostSelectorSettings Function()? hostSelector,
    ZeroTrustGatewayInspectionSettings Function()? inspection,
    ZeroTrustGatewayProtocolDetection Function()? protocolDetection,
    ZeroTrustGatewaySandbox Function()? sandbox,
    ZeroTrustGatewayTlsSettings Function()? tlsDecrypt,
  }) {
    return ZeroTrustGatewayGatewayAccountSettingsSettings(
      ...
      browserIsolation: browserIsolation != null
          ? browserIsolation()
          : this.browserIsolation,
      ...
      customCertificate: customCertificate != null
          ? customCertificate()
          : this.customCertificate,
      extendedEmailMatching: extendedEmailMatching != null
      ...
      protocolDetection: protocolDetection != null
          ? protocolDetection()
          : this.protocolDetection,
