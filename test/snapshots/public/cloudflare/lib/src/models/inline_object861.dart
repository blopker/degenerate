...
final class InlineObject861 {const InlineObject861({this.frequencyPenalty, this.ignoreEos, required this.image, this.maxTokens = 512, this.presencePenalty, required this.prompt, this.repetitionPenalty, this.seed, this.temperature, this.topK, this.topP, });

factory InlineObject861.fromJson(Map<String, dynamic> json) { return InlineObject861(
...
InlineObject861 copyWith({double Function()? frequencyPenalty, bool Function()? ignoreEos, String? image, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, double Function()? repetitionPenalty, double Function()? seed, double Function()? temperature, double Function()? topK, double Function()? topP, }) { return InlineObject861(
...
@override String toString() { return 'InlineObject861(frequencyPenalty: $frequencyPenalty, ignoreEos: $ignoreEos, image: $image, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, repetitionPenalty: $repetitionPenalty, seed: $seed, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
