...
import 'package:collection/collection.dart';import 'teams_devices_service_mode.dart';import 'teams_devices_split_tunnel.dart';import 'teams_devices_split_tunnel_include.dart';final class DevicesUpdateDefaultDeviceSettingsPolicyRequest {const DevicesUpdateDefaultDeviceSettingsPolicyRequest({this.allowModeSwitch, this.allowUpdates, this.allowedToLeave, this.autoConnect, this.captivePortal, this.disableAutoFallback, this.exclude, this.excludeOfficeIps, this.include, this.lanAllowMinutes, this.lanAllowSubnetSize, this.registerInterfaceIpWithDns, this.sccmVpnBoundarySupport, this.serviceModeV2, this.supportUrl, this.switchLocked, this.tunnelProtocol, });
...
DevicesUpdateDefaultDeviceSettingsPolicyRequest copyWith({bool Function()? allowModeSwitch, bool Function()? allowUpdates, bool Function()? allowedToLeave, double Function()? autoConnect, double Function()? captivePortal, bool Function()? disableAutoFallback, List<TeamsDevicesSplitTunnel> Function()? exclude, bool Function()? excludeOfficeIps, List<TeamsDevicesSplitTunnelInclude> Function()? include, double Function()? lanAllowMinutes, double Function()? lanAllowSubnetSize, bool Function()? registerInterfaceIpWithDns, bool Function()? sccmVpnBoundarySupport, TeamsDevicesServiceMode Function()? serviceModeV2, String Function()? supportUrl, bool Function()? switchLocked, String Function()? tunnelProtocol, }) { return DevicesUpdateDefaultDeviceSettingsPolicyRequest(
