...
import 'destination_create_response_result_configuration_logpush_dataset.dart';import 'destination_create_response_result_configuration_type.dart';final class DestinationCreateResponseResultConfiguration {const DestinationCreateResponseResultConfiguration({required this.destinationConf, required this.logpushDataset, required this.logpushJob, required this.type, required this.url, });
...
factory DestinationCreateResponseResultConfiguration.fromJson(Map<String, dynamic> json) { return DestinationCreateResponseResultConfiguration(
  ...
  logpushDataset: DestinationCreateResponseResultConfigurationLogpushDataset.fromJson(json['logpushDataset'] as Map<String, dynamic>),
