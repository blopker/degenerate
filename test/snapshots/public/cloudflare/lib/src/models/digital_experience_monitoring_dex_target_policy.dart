...
final class DigitalExperienceMonitoringDexTargetPolicy {const DigitalExperienceMonitoringDexTargetPolicy({this.$default, required this.id, this.name, });
...
DigitalExperienceMonitoringDexTargetPolicy copyWith({bool Function()? $default, String? id, String Function()? name, }) { return DigitalExperienceMonitoringDexTargetPolicy(
