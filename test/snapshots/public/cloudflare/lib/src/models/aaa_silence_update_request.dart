...
final class AaaSilenceUpdateRequest {const AaaSilenceUpdateRequest({this.endTime, this.id, this.startTime, });
...
AaaSilenceUpdateRequest copyWith({String Function()? endTime, String Function()? id, String Function()? startTime, }) { return AaaSilenceUpdateRequest(
