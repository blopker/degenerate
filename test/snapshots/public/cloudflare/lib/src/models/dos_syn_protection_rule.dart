...
final class DosSynProtectionRule {
  const DosSynProtectionRule({
  ...
  factory DosSynProtectionRule.fromJson(Map<String, dynamic> json) {
    return DosSynProtectionRule(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('burst_sensitivity') &&
        ...
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('mitigation_type') &&
        json['mitigation_type'] is String &&
  ...
  @override
  String toString() {
    return 'DosSynProtectionRule(burstSensitivity: $burstSensitivity, createdOn: $createdOn, id: $id, mitigationType: $mitigationType, mode: $mode, modifiedOn: $modifiedOn, name: $name, rateSensitivity: $rateSensitivity, scope: $scope)';
  }
}
