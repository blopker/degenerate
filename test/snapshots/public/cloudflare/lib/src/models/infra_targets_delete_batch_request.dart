...
import 'package:collection/collection.dart';final class InfraTargetsDeleteBatchRequest {const InfraTargetsDeleteBatchRequest({required this.targetIds});
...
InfraTargetsDeleteBatchRequest copyWith({List<String>? targetIds}) { return InfraTargetsDeleteBatchRequest(
