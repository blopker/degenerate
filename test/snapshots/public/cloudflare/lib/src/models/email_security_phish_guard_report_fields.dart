...
import 'package:collection/collection.dart';final class EmailSecurityPhishGuardReportFields {const EmailSecurityPhishGuardReportFields({this.from, this.postfixId, required this.to, required this.ts, });
