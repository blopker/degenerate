...
import 'package:collection/collection.dart';import 'firewall_action.dart';import 'firewall_bypass2.dart';import 'firewall_match.dart';final class FirewallRatelimit {const FirewallRatelimit({this.action, this.bypass, this.description, this.disabled, this.id, this.match, this.period, this.threshold, });
...
factory FirewallRatelimit.fromJson(Map<String, dynamic> json) { return FirewallRatelimit(
  ...
  match: json['match'] != null
        ...
        : null,
  period: json['period'] != null ? (json['period'] as num).toDouble() : null,
...
FirewallRatelimit copyWith({FirewallAction Function()? action, List<FirewallBypass2> Function()? bypass, String Function()? description, bool Function()? disabled, String Function()? id, FirewallMatch Function()? match, double Function()? period, double Function()? threshold, }) { return FirewallRatelimit(
