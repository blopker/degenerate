...
import 'web3_target.dart';final class Web3CreateRequest {const Web3CreateRequest({this.description, this.dnslink, required this.name, required this.target, });
...
Web3CreateRequest copyWith({String Function()? description, String Function()? dnslink, String? name, Web3Target? target, }) { return Web3CreateRequest(
