...
import 'package:collection/collection.dart';import 'dlp_sensitivity_level.dart';final class DlpSensitivityGroup {const DlpSensitivityGroup({required this.createdAt, required this.description, required this.id, required this.levels, required this.name, this.templateId, required this.updatedAt, });
