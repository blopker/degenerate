...
import 'ai_search_create_instances_response_result_source_params_web_crawler_crawl_options_source.dart';final class AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerCrawlOptions {const AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerCrawlOptions({this.depth, this.includeExternalLinks = false, this.includeSubdomains = false, this.maxAge, this.source = AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerCrawlOptionsSource.all, });
