...
import 'package:collection/collection.dart';final class PostConfigCreateRequest {const PostConfigCreateRequest({this.frequency, required this.ips, this.ports, });
...
PostConfigCreateRequest copyWith({double Function()? frequency, List<String>? ips, List<String> Function()? ports, }) { return PostConfigCreateRequest(
