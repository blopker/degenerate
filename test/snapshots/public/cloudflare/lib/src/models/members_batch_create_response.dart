...
MembersBatchCreateResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<Member>? result, bool? success, }) { return MembersBatchCreateResponse(
