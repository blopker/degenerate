...
import 'package:collection/collection.dart';import 'mconn_snapshot_metadata.dart';final class MconnCustomerSnapshotsGetResult {const MconnCustomerSnapshotsGetResult({required this.count, this.cursor, required this.items, });
