...
import 'tunnel_origin_request_access.dart';

/// Configuration parameters for the public hostname specific connection settings between cloudflared and origin server.
final class TunnelOriginRequest {
  const TunnelOriginRequest({
    this.access,
    this.caPool,
    this.connectTimeout,
  ...
  factory TunnelOriginRequest.fromJson(Map<String, dynamic> json) {
    return TunnelOriginRequest(
      access: json['access'] != null
          ? TunnelOriginRequestAccess.fromJson(
              json['access'] as Map<String, dynamic>,
            )
          : null,
      caPool: json['caPool'] as String?,
      connectTimeout: json['connectTimeout'] != null
          ? (json['connectTimeout'] as num).toInt()
          : null,
      ...
      keepAliveConnections: json['keepAliveConnections'] != null
          ? (json['keepAliveConnections'] as num).toInt()
          : null,
      keepAliveTimeout: json['keepAliveTimeout'] != null
          ? (json['keepAliveTimeout'] as num).toInt()
          : null,
      ...
      tcpKeepAlive: json['tcpKeepAlive'] != null
          ? (json['tcpKeepAlive'] as num).toInt()
          : null,
      tlsTimeout: json['tlsTimeout'] != null
          ? (json['tlsTimeout'] as num).toInt()
          : null,
    );
  }
  ...
  TunnelOriginRequest copyWith({
    TunnelOriginRequestAccess Function()? access,
    String Function()? caPool,
    int Function()? connectTimeout,
    bool Function()? disableChunkedEncoding,
    bool Function()? http2Origin,
    String Function()? httpHostHeader,
    int Function()? keepAliveConnections,
    int Function()? keepAliveTimeout,
    bool Function()? matchSnItoHost,
    bool Function()? noHappyEyeballs,
    bool Function()? noTlsVerify,
    String Function()? originServerName,
    String Function()? proxyType,
    int Function()? tcpKeepAlive,
    int Function()? tlsTimeout,
  }) {
    return TunnelOriginRequest(
      ...
      connectTimeout: connectTimeout != null
          ? connectTimeout()
          : this.connectTimeout,
      disableChunkedEncoding: disableChunkedEncoding != null
          ? disableChunkedEncoding()
          : this.disableChunkedEncoding,
      http2Origin: http2Origin != null ? http2Origin() : this.http2Origin,
      httpHostHeader: httpHostHeader != null
          ? httpHostHeader()
          : this.httpHostHeader,
      keepAliveConnections: keepAliveConnections != null
          ? keepAliveConnections()
          : this.keepAliveConnections,
      keepAliveTimeout: keepAliveTimeout != null
          ? keepAliveTimeout()
          : this.keepAliveTimeout,
      matchSnItoHost: matchSnItoHost != null
          ? matchSnItoHost()
          : this.matchSnItoHost,
      noHappyEyeballs: noHappyEyeballs != null
          ? noHappyEyeballs()
          : this.noHappyEyeballs,
      noTlsVerify: noTlsVerify != null ? noTlsVerify() : this.noTlsVerify,
      originServerName: originServerName != null
          ? originServerName()
          : this.originServerName,
  ...
  @override
  String toString() {
    return 'TunnelOriginRequest(access: $access, caPool: $caPool, connectTimeout: $connectTimeout, disableChunkedEncoding: $disableChunkedEncoding, http2Origin: $http2Origin, httpHostHeader: $httpHostHeader, keepAliveConnections: $keepAliveConnections, keepAliveTimeout: $keepAliveTimeout, matchSnItoHost: $matchSnItoHost, noHappyEyeballs: $noHappyEyeballs, noTlsVerify: $noTlsVerify, originServerName: $originServerName, proxyType: $proxyType, tcpKeepAlive: $tcpKeepAlive, tlsTimeout: $tlsTimeout)';
  }
}
