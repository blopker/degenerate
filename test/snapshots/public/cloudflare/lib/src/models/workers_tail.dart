...
final class WorkersTail {const WorkersTail({required this.expiresAt, required this.id, required this.url, });
...
WorkersTail copyWith({String? expiresAt, String? id, String? url, }) { return WorkersTail(
