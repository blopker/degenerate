...
final class ShieldMethod {
  const ShieldMethod._(this.value);

  factory ShieldMethod.fromJson(String json) {
    return switch (json) {
      'GET' => $get,
      'POST' => post,
      'HEAD' => head,
  ...
  static const List<ShieldMethod> values = [
    $get,
    post,
    head,
    options,
