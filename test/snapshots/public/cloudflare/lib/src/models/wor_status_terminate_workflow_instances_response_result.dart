...
import 'wor_status_terminate_workflow_instances_response_result_status.dart';final class WorStatusTerminateWorkflowInstancesResponseResult {const WorStatusTerminateWorkflowInstancesResponseResult({required this.status});
