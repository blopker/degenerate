...
final class WorkersBindingKindService {const WorkersBindingKindService({this.entrypoint, this.environment = 'production', required this.name, required this.service, required this.type, });
...
WorkersBindingKindService copyWith({String Function()? entrypoint, String Function()? environment, String? name, String? service, String? type, }) { return WorkersBindingKindService(
