...
final class RealtimekitParticipantPeerStatsPeerStatsPrecallNetworkInformation {
  const RealtimekitParticipantPeerStatsPeerStatsPrecallNetworkInformation({
    this.backendRtt,
  ...
  factory RealtimekitParticipantPeerStatsPeerStatsPrecallNetworkInformation.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimekitParticipantPeerStatsPeerStatsPrecallNetworkInformation(
      ...
      fractionalLoss: json['fractional_loss'] != null
          ? (json['fractional_loss'] as num).toDouble()
          : null,
      jitter: json['jitter'] != null
          ? (json['jitter'] as num).toDouble()
          : null,
      ...
      throughtput: json['throughtput'] != null
          ? (json['throughtput'] as num).toDouble()
          : null,
  ...
  @override
  String toString() {
    return 'RealtimekitParticipantPeerStatsPeerStatsPrecallNetworkInformation(backendRtt: $backendRtt, effectiveNetworktype: $effectiveNetworktype, fractionalLoss: $fractionalLoss, jitter: $jitter, reflexiveConnectivity: $reflexiveConnectivity, relayConnectivity: $relayConnectivity, rtt: $rtt, throughtput: $throughtput, turnConnectivity: $turnConnectivity)';
  }
}
