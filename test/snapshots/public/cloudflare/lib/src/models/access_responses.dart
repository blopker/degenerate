...
final class AccessResponses {
  ...
  factory AccessResponses.fromJson(Map<String, dynamic> json) {
  ...
  AccessResponses copyWith({
    String Function()? cfResourceId,
    String Function()? errorDescription,
    String Function()? idpId,
    String Function()? idpResourceId,
    DateTime Function()? loggedAt,
    String Function()? requestBody,
    String Function()? requestMethod,
    String Function()? resourceGroupName,
    String Function()? resourceType,
    String Function()? resourceUserEmail,
    ...
    return AccessResponses(
      ...
      idpResourceId: idpResourceId != null
          ? idpResourceId()
          : this.idpResourceId,
      ...
      resourceUserEmail: resourceUserEmail != null
          ? resourceUserEmail()
          : this.resourceUserEmail,
  ...
  @override
  String toString() {
    return 'AccessResponses(cfResourceId: $cfResourceId, errorDescription: $errorDescription, idpId: $idpId, idpResourceId: $idpResourceId, loggedAt: $loggedAt, requestBody: $requestBody, requestMethod: $requestMethod, resourceGroupName: $resourceGroupName, resourceType: $resourceType, resourceUserEmail: $resourceUserEmail, status: $status)';
  }
}
