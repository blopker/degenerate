...
final class RequestsSslProtocols {
  const RequestsSslProtocols({
    this.tlSv1,
    this.tlSv11,
    this.tlSv12,
    this.tlSv13,
  ...
  factory RequestsSslProtocols.fromJson(Map<String, dynamic> json) {
    return RequestsSslProtocols(
  ...
  @override
  String toString() {
    return 'RequestsSslProtocols(tlSv1: $tlSv1, tlSv11: $tlSv11, tlSv12: $tlSv12, tlSv13: $tlSv13, none: $none)';
  }
}
