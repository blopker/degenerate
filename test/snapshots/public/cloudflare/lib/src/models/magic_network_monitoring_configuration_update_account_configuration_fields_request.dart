...
import 'package:collection/collection.dart';import 'magic_visibility_mnm_mnm_config_warp_device.dart';final class MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest {const MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest({this.defaultSampling, this.name, this.routerIps, this.warpDevices, });
...
factory MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest.fromJson(Map<String, dynamic> json) { return MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest(
  defaultSampling: json['default_sampling'] != null ? (json['default_sampling'] as num).toDouble() : null,
...
MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest copyWith({double Function()? defaultSampling, String Function()? name, List<String> Function()? routerIps, List<MagicVisibilityMnmMnmConfigWarpDevice> Function()? warpDevices, }) { return MagicNetworkMonitoringConfigurationUpdateAccountConfigurationFieldsRequest(
