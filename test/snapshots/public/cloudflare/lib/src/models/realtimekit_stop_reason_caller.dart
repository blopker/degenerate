...
import 'realtimekit_stop_reason_caller_type.dart';final class RealtimekitStopReasonCaller {const RealtimekitStopReasonCaller({this.name, this.type, this.userId, });
