...
final class BuildsUpsertRepoConnectionRequest {
  const BuildsUpsertRepoConnectionRequest({
  ...
  factory BuildsUpsertRepoConnectionRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return BuildsUpsertRepoConnectionRequest(
      providerAccountId: json['provider_account_id'] as String,
      providerAccountName: json['provider_account_name'] as String,
      providerType: BuildsScmProviderType.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('provider_account_id') &&
        json['provider_account_id'] is String &&
        json.containsKey('provider_account_name') &&
        json['provider_account_name'] is String &&
  ...
  BuildsUpsertRepoConnectionRequest copyWith({
    String? providerAccountId,
    String? providerAccountName,
    BuildsScmProviderType? providerType,
    String? repoId,
    String? repoName,
  }) {
    return BuildsUpsertRepoConnectionRequest(
  ...
  @override
  String toString() {
    return 'BuildsUpsertRepoConnectionRequest(providerAccountId: $providerAccountId, providerAccountName: $providerAccountName, providerType: $providerType, repoId: $repoId, repoName: $repoName)';
  }
}
