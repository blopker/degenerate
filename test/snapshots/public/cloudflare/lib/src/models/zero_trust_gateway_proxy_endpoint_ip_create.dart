...
import 'zero_trust_gateway_proxy_endpoint_ip_create_kind.dart';final class ZeroTrustGatewayProxyEndpointIpCreate {const ZeroTrustGatewayProxyEndpointIpCreate({this.kind, required this.name, });
...
ZeroTrustGatewayProxyEndpointIpCreate copyWith({ZeroTrustGatewayProxyEndpointIpCreateKind Function()? kind, String? name, }) { return ZeroTrustGatewayProxyEndpointIpCreate(
