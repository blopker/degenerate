...
import 'post_create_event_relationship_response_relationships_relationship_type.dart';final class PostCreateEventRelationshipResponseRelationships {const PostCreateEventRelationshipResponseRelationships({required this.childDatasetId, required this.childId, required this.parentDatasetId, required this.parentId, required this.relationshipType, });
