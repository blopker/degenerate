...
import 'bot_management_feedback_type.dart';
import 'bot_management_metric_requests.dart';

final class BotManagementFeedbackReport {
  const BotManagementFeedbackReport({
    this.createdAt,
  ...
  factory BotManagementFeedbackReport.fromJson(Map<String, dynamic> json) {
    return BotManagementFeedbackReport(
      createdAt: json['created_at'] != null
          ? DateTime.parse(json['created_at'] as String)
          : null,
      description: json['description'] as String,
      expression: json['expression'] as String,
      firstRequestSeenAt: DateTime.parse(
        json['first_request_seen_at'] as String,
      ),
      lastRequestSeenAt: DateTime.parse(json['last_request_seen_at'] as String),
      requests: (json['requests'] as num).toInt(),
      requestsByAttribute:
          (json['requests_by_attribute'] as Map<String, dynamic>).map(
            (k, v) => MapEntry(
              k,
              (v as List<dynamic>)
                  .map(
                    (e) => BotManagementMetricRequests.fromJson(
      ...
      requestsByScore: (json['requests_by_score'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, (v as num).toInt()),
      ),
      requestsByScoreSrc:
          (json['requests_by_score_src'] as Map<String, dynamic>).map(
            (k, v) => MapEntry(k, (v as num).toInt()),
          ),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'requests': requests,
      'requests_by_attribute': requestsByAttribute.map(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('description') &&
        ...
        json.containsKey('first_request_seen_at') &&
        json['first_request_seen_at'] is String &&
        json.containsKey('last_request_seen_at') &&
        json['last_request_seen_at'] is String &&
  ...
  BotManagementFeedbackReport copyWith({
    DateTime Function()? createdAt,
    String? description,
    String? expression,
    DateTime? firstRequestSeenAt,
    DateTime? lastRequestSeenAt,
    int? requests,
    Map<String, List<BotManagementMetricRequests>>? requestsByAttribute,
    Map<String, int>? requestsByScore,
    Map<String, int>? requestsByScoreSrc,
    String Function()? subtype,
    BotManagementFeedbackType? type,
  }) {
    return BotManagementFeedbackReport(
