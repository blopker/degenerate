...
import 'package:collection/collection.dart';final class VectorizeIndexGetVectorsByIdResponse2 {const VectorizeIndexGetVectorsByIdResponse2({this.id, this.metadata, this.namespace, this.values, });
...
VectorizeIndexGetVectorsByIdResponse2 copyWith({String Function()? id, Map<String, String> Function()? metadata, String? Function()? namespace, List<double> Function()? values, }) { return VectorizeIndexGetVectorsByIdResponse2(
