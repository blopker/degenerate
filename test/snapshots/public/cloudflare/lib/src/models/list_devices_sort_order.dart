...
final class ListDevicesSortOrder {
  const ListDevicesSortOrder._(this.value);

  factory ListDevicesSortOrder.fromJson(String json) {
    return switch (json) {
      'asc' => asc,
      'desc' => desc,
  ...
  @override
  String toString() {
    return 'ListDevicesSortOrder($value)';
  }
}
