...
final class ResponseCommon8Result {const ResponseCommon8Result({this.mapStringString, this.listString, this.string, });

factory ResponseCommon8Result.fromJson(Object? json) { return ResponseCommon8Result(
