...
import 'realtimekit_preset_permissions_chat.dart';
import 'realtimekit_preset_permissions_connected_meetings.dart';
import 'realtimekit_preset_permissions_media.dart';
import 'realtimekit_preset_permissions_plugins.dart';
import 'realtimekit_preset_permissions_polls.dart';
import 'realtimekit_preset_permissions_recorder_type.dart';
import 'realtimekit_preset_permissions_waiting_room_type.dart';

final class RealtimekitPresetPermissions {
  const RealtimekitPresetPermissions({
    ...
    required this.polls,
    this.recorderType = RealtimekitPresetPermissionsRecorderType.none,
    required this.showParticipantList,
    required this.waitingRoomType,
  });

  factory RealtimekitPresetPermissions.fromJson(Map<String, dynamic> json) {
    return RealtimekitPresetPermissions(
      acceptWaitingRequests: json['accept_waiting_requests'] as bool,
      canAcceptProductionRequests:
          json['can_accept_production_requests'] as bool,
      canChangeParticipantPermissions:
          json['can_change_participant_permissions'] as bool,
      ...
      chat: RealtimekitPresetPermissionsChat.fromJson(
        json['chat'] as Map<String, dynamic>,
      ),
      connectedMeetings: RealtimekitPresetPermissionsConnectedMeetings.fromJson(
        json['connected_meetings'] as Map<String, dynamic>,
      ),
      disableParticipantAudio: json['disable_participant_audio'] as bool,
      disableParticipantScreensharing:
          json['disable_participant_screensharing'] as bool,
      disableParticipantVideo: json['disable_participant_video'] as bool,
      hiddenParticipant: json['hidden_participant'] as bool,
      isRecorder: json.containsKey('is_recorder')
          ? json['is_recorder'] as bool
          : false,
      kickParticipant: json['kick_participant'] as bool,
      media: RealtimekitPresetPermissionsMedia.fromJson(
        json['media'] as Map<String, dynamic>,
      ),
      pinParticipant: json['pin_participant'] as bool,
      plugins: RealtimekitPresetPermissionsPlugins.fromJson(
        json['plugins'] as Map<String, dynamic>,
      ),
      polls: RealtimekitPresetPermissionsPolls.fromJson(
        json['polls'] as Map<String, dynamic>,
      ),
      recorderType: RealtimekitPresetPermissionsRecorderType.fromJson(
        json['recorder_type'] as String,
      ),
      showParticipantList: json['show_participant_list'] as bool,
      waitingRoomType: RealtimekitPresetPermissionsWaitingRoomType.fromJson(
        json['waiting_room_type'] as String,
      ),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('accept_waiting_requests') &&
        json['accept_waiting_requests'] is bool &&
        json.containsKey('can_accept_production_requests') &&
        json['can_accept_production_requests'] is bool &&
        json.containsKey('can_change_participant_permissions') &&
        json['can_change_participant_permissions'] is bool &&
        json.containsKey('can_edit_display_name') &&
        json['can_edit_display_name'] is bool &&
        json.containsKey('can_livestream') &&
        json['can_livestream'] is bool &&
        json.containsKey('can_record') &&
        json['can_record'] is bool &&
        json.containsKey('can_spotlight') &&
        json['can_spotlight'] is bool &&
        json.containsKey('chat') &&
        json.containsKey('connected_meetings') &&
        json.containsKey('disable_participant_audio') &&
        json['disable_participant_audio'] is bool &&
        json.containsKey('disable_participant_screensharing') &&
        json['disable_participant_screensharing'] is bool &&
        json.containsKey('disable_participant_video') &&
        json['disable_participant_video'] is bool &&
        json.containsKey('hidden_participant') &&
        json['hidden_participant'] is bool &&
        json.containsKey('kick_participant') &&
        json['kick_participant'] is bool &&
        json.containsKey('media') &&
        json.containsKey('pin_participant') &&
        json['pin_participant'] is bool &&
        json.containsKey('plugins') &&
        json.containsKey('polls') &&
        json.containsKey('recorder_type') &&
        json.containsKey('show_participant_list') &&
        json['show_participant_list'] is bool &&
        json.containsKey('waiting_room_type');
  }

  RealtimekitPresetPermissions copyWith({
    bool? acceptWaitingRequests,
    bool? canAcceptProductionRequests,
    bool? canChangeParticipantPermissions,
    bool? canEditDisplayName,
    bool? canLivestream,
    bool? canRecord,
    bool? canSpotlight,
    RealtimekitPresetPermissionsChat? chat,
    RealtimekitPresetPermissionsConnectedMeetings? connectedMeetings,
    bool? disableParticipantAudio,
    bool? disableParticipantScreensharing,
    bool? disableParticipantVideo,
    bool? hiddenParticipant,
    bool Function()? isRecorder,
    bool? kickParticipant,
    RealtimekitPresetPermissionsMedia? media,
    bool? pinParticipant,
    RealtimekitPresetPermissionsPlugins? plugins,
    RealtimekitPresetPermissionsPolls? polls,
    RealtimekitPresetPermissionsRecorderType? recorderType,
    bool? showParticipantList,
    RealtimekitPresetPermissionsWaitingRoomType? waitingRoomType,
  }) {
    return RealtimekitPresetPermissions(
      acceptWaitingRequests:
          acceptWaitingRequests ?? this.acceptWaitingRequests,
      canAcceptProductionRequests:
          canAcceptProductionRequests ?? this.canAcceptProductionRequests,
      canChangeParticipantPermissions:
          canChangeParticipantPermissions ??
      ...
      disableParticipantAudio:
          disableParticipantAudio ?? this.disableParticipantAudio,
      disableParticipantScreensharing:
          disableParticipantScreensharing ??
          this.disableParticipantScreensharing,
      disableParticipantVideo:
          disableParticipantVideo ?? this.disableParticipantVideo,
