...
final class AigConfigListGatewayLogsResponseResultInfo {
  const AigConfigListGatewayLogsResponseResultInfo({
    this.count,
    this.maxCost,
    this.maxDuration,
    this.maxTokensIn,
  ...
  factory AigConfigListGatewayLogsResponseResultInfo.fromJson(
    Map<String, dynamic> json,
  ) {
    return AigConfigListGatewayLogsResponseResultInfo(
      count: json['count'] != null ? (json['count'] as num).toDouble() : null,
      maxCost: json['max_cost'] != null
          ? (json['max_cost'] as num).toDouble()
          : null,
      maxDuration: json['max_duration'] != null
          ? (json['max_duration'] as num).toDouble()
          : null,
      maxTokensIn: json['max_tokens_in'] != null
          ? (json['max_tokens_in'] as num).toDouble()
          : null,
      maxTokensOut: json['max_tokens_out'] != null
          ? (json['max_tokens_out'] as num).toDouble()
          : null,
      maxTotalTokens: json['max_total_tokens'] != null
          ? (json['max_total_tokens'] as num).toDouble()
          : null,
      minCost: json['min_cost'] != null
          ? (json['min_cost'] as num).toDouble()
          : null,
      minDuration: json['min_duration'] != null
          ? (json['min_duration'] as num).toDouble()
          : null,
      minTokensIn: json['min_tokens_in'] != null
          ? (json['min_tokens_in'] as num).toDouble()
          : null,
      minTokensOut: json['min_tokens_out'] != null
          ? (json['min_tokens_out'] as num).toDouble()
          : null,
      minTotalTokens: json['min_total_tokens'] != null
          ? (json['min_total_tokens'] as num).toDouble()
          : null,
      page: json['page'] != null ? (json['page'] as num).toDouble() : null,
      perPage: json['per_page'] != null
          ? (json['per_page'] as num).toDouble()
          : null,
  ...
  AigConfigListGatewayLogsResponseResultInfo copyWith({
    double Function()? count,
    double Function()? maxCost,
    double Function()? maxDuration,
    double Function()? maxTokensIn,
    double Function()? maxTokensOut,
    double Function()? maxTotalTokens,
    double Function()? minCost,
    double Function()? minDuration,
    double Function()? minTokensIn,
    double Function()? minTokensOut,
    double Function()? minTotalTokens,
    double Function()? page,
    double Function()? perPage,
    double Function()? totalCount,
  }) {
    return AigConfigListGatewayLogsResponseResultInfo(
      ...
      minTotalTokens: minTotalTokens != null
          ? minTotalTokens()
          : this.minTotalTokens,
