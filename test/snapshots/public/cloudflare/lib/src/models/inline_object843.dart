...
import 'package:collection/collection.dart';final class InlineObject843 {const InlineObject843({required this.audio, this.sourceLang, this.targetLang, });
...
InlineObject843 copyWith({List<double>? audio, String Function()? sourceLang, String Function()? targetLang, }) { return InlineObject843(
...
@override String toString() { return 'InlineObject843(audio: $audio, sourceLang: $sourceLang, targetLang: $targetLang)'; } 
 }
