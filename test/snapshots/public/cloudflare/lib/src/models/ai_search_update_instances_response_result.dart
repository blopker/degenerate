...
import 'ai_search_update_instances_response_result_ai_search_model.dart';
import 'ai_search_update_instances_response_result_cache_threshold.dart';
import 'ai_search_update_instances_response_result_custom_metadata.dart';
import 'ai_search_update_instances_response_result_embedding_model.dart';
import 'ai_search_update_instances_response_result_fusion_method.dart';
import 'ai_search_update_instances_response_result_metadata.dart';
import 'ai_search_update_instances_response_result_public_endpoint_params.dart';
import 'ai_search_update_instances_response_result_reranking_model.dart';
import 'ai_search_update_instances_response_result_retrieval_options.dart';
import 'ai_search_update_instances_response_result_rewrite_model.dart';
import 'ai_search_update_instances_response_result_source_params.dart';
import 'ai_search_update_instances_response_result_type.dart';

final class AiSearchUpdateInstancesResponseResult {
  const AiSearchUpdateInstancesResponseResult({
    this.aiGatewayId,
    this.aiSearchModel,
    this.cache = true,
    this.cacheThreshold =
        AiSearchUpdateInstancesResponseResultCacheThreshold.closeEnough,
    ...
    this.embeddingModel,
    this.enable = true,
    this.fusionMethod = AiSearchUpdateInstancesResponseResultFusionMethod.rrf,
  ...
  factory AiSearchUpdateInstancesResponseResult.fromJson(
    Map<String, dynamic> json,
  ) {
    return AiSearchUpdateInstancesResponseResult(
      aiGatewayId: json['ai_gateway_id'] as String?,
      aiSearchModel: json['ai_search_model'] != null
          ? AiSearchUpdateInstancesResponseResultAiSearchModel.fromJson(
      ...
      cacheThreshold: json.containsKey('cache_threshold')
          ? AiSearchUpdateInstancesResponseResultCacheThreshold.fromJson(
      ...
      customMetadata: (json['custom_metadata'] as List<dynamic>?)
          ?.map(
            (e) => AiSearchUpdateInstancesResponseResultCustomMetadata.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      embeddingModel: json['embedding_model'] != null
          ? AiSearchUpdateInstancesResponseResultEmbeddingModel.fromJson(
      ...
      fusionMethod: json.containsKey('fusion_method')
          ? AiSearchUpdateInstancesResponseResultFusionMethod.fromJson(
              json['fusion_method'] as String,
            )
          : AiSearchUpdateInstancesResponseResultFusionMethod.rrf,
      ...
      metadata: json['metadata'] != null
          ? AiSearchUpdateInstancesResponseResultMetadata.fromJson(
      ...
      publicEndpointParams: json['public_endpoint_params'] != null
          ? AiSearchUpdateInstancesResponseResultPublicEndpointParams.fromJson(
      ...
      rerankingModel: json['reranking_model'] != null
          ? AiSearchUpdateInstancesResponseResultRerankingModel.fromJson(
              json['reranking_model'] as Map<String, dynamic>,
            )
          : null,
      retrievalOptions: json['retrieval_options'] != null
          ? AiSearchUpdateInstancesResponseResultRetrievalOptions.fromJson(
              json['retrieval_options'] as Map<String, dynamic>,
            )
          : null,
      rewriteModel: json['rewrite_model'] != null
          ? AiSearchUpdateInstancesResponseResultRewriteModel.fromJson(
      ...
      sourceParams: json['source_params'] != null
          ? AiSearchUpdateInstancesResponseResultSourceParams.fromJson(
      ...
      type: json['type'] != null
          ? AiSearchUpdateInstancesResponseResultType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final List<AiSearchUpdateInstancesResponseResultCustomMetadata>?
  customMetadata;
  ...
  final AiSearchUpdateInstancesResponseResultPublicEndpointParams?
  ...
  AiSearchUpdateInstancesResponseResult copyWith({
    String? Function()? aiGatewayId,
    AiSearchUpdateInstancesResponseResultAiSearchModel Function()?
    aiSearchModel,
    bool Function()? cache,
    AiSearchUpdateInstancesResponseResultCacheThreshold Function()?
    cacheThreshold,
    int Function()? chunkOverlap,
    int Function()? chunkSize,
    DateTime? createdAt,
    String? Function()? createdBy,
    List<AiSearchUpdateInstancesResponseResultCustomMetadata> Function()?
    customMetadata,
    AiSearchUpdateInstancesResponseResultEmbeddingModel Function()?
    embeddingModel,
    bool Function()? enable,
    AiSearchUpdateInstancesResponseResultFusionMethod Function()? fusionMethod,
    bool Function()? hybridSearchEnabled,
    String? id,
    DateTime? Function()? lastActivity,
    int Function()? maxNumResults,
    AiSearchUpdateInstancesResponseResultMetadata Function()? metadata,
    DateTime? modifiedAt,
    String? Function()? modifiedBy,
    bool Function()? paused,
    String? Function()? publicEndpointId,
    AiSearchUpdateInstancesResponseResultPublicEndpointParams Function()?
    publicEndpointParams,
    bool Function()? reranking,
    AiSearchUpdateInstancesResponseResultRerankingModel Function()?
    rerankingModel,
    AiSearchUpdateInstancesResponseResultRetrievalOptions? Function()?
    retrievalOptions,
    AiSearchUpdateInstancesResponseResultRewriteModel Function()? rewriteModel,
    bool Function()? rewriteQuery,
    double Function()? scoreThreshold,
    String Function()? source,
    AiSearchUpdateInstancesResponseResultSourceParams? Function()? sourceParams,
    String Function()? status,
    String Function()? tokenId,
    AiSearchUpdateInstancesResponseResultType Function()? type,
