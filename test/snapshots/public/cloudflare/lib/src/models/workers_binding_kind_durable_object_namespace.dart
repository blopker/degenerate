...
final class WorkersBindingKindDurableObjectNamespace {
  ...
  factory WorkersBindingKindDurableObjectNamespace.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersBindingKindDurableObjectNamespace(
  ...
  WorkersBindingKindDurableObjectNamespace copyWith({
  ...
  @override
  String toString() {
    return 'WorkersBindingKindDurableObjectNamespace(className: $className, dispatchNamespace: $dispatchNamespace, environment: $environment, name: $name, namespaceId: $namespaceId, scriptName: $scriptName, type: $type)';
  }
}
