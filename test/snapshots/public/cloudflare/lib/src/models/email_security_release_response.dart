...
import 'package:collection/collection.dart';final class EmailSecurityReleaseResponse {const EmailSecurityReleaseResponse({this.delivered, this.failed, this.undelivered, required this.id, required this.postfixId, });
...
EmailSecurityReleaseResponse copyWith({List<String>? Function()? delivered, List<String>? Function()? failed, List<String>? Function()? undelivered, String? id, String? postfixId, }) { return EmailSecurityReleaseResponse(
