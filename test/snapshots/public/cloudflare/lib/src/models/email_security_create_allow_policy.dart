...
final class EmailSecurityCreateAllowPolicy {
  const EmailSecurityCreateAllowPolicy({
    this.comments,
  ...
  factory EmailSecurityCreateAllowPolicy.fromJson(Map<String, dynamic> json) {
  ...
  EmailSecurityCreateAllowPolicy copyWith({
