...
import 'd1_query_meta_timings.dart';import 'd1_served_by_region.dart';final class D1QueryMeta {const D1QueryMeta({this.changedDb, this.changes, this.duration, this.lastRowId, this.rowsRead, this.rowsWritten, this.servedByColo, this.servedByPrimary, this.servedByRegion, this.sizeAfter, this.timings, });
...
D1QueryMeta copyWith({bool Function()? changedDb, double Function()? changes, double Function()? duration, double Function()? lastRowId, double Function()? rowsRead, double Function()? rowsWritten, String Function()? servedByColo, bool Function()? servedByPrimary, D1ServedByRegion Function()? servedByRegion, double Function()? sizeAfter, D1QueryMetaTimings Function()? timings, }) { return D1QueryMeta(
