...
final class RumResultInfo {
  ...
  factory RumResultInfo.fromJson(Map<String, dynamic> json) {
    return RumResultInfo(
  ...
  @override
  String toString() {
    return 'RumResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount, totalPages: $totalPages)';
  }
}
