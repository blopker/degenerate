...
import 'create_servers_response_result_auth_type.dart';

final class CreateServersResponseResult {
  const CreateServersResponseResult({
  ...
  factory CreateServersResponseResult.fromJson(Map<String, dynamic> json) {
    return CreateServersResponseResult(
      authType: CreateServersResponseResultAuthType.fromJson(
  ...
  CreateServersResponseResult copyWith({
    CreateServersResponseResultAuthType? authType,
