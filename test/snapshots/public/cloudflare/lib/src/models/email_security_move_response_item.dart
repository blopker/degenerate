...
final class EmailSecurityMoveResponseItem {
  const EmailSecurityMoveResponseItem({
  ...
  factory EmailSecurityMoveResponseItem.fromJson(Map<String, dynamic> json) {
    return EmailSecurityMoveResponseItem(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('completed_timestamp') &&
        json['completed_timestamp'] is String &&
  ...
  EmailSecurityMoveResponseItem copyWith({
  ...
  @override
  String toString() {
    return 'EmailSecurityMoveResponseItem(completedTimestamp: $completedTimestamp, destination: $destination, itemCount: $itemCount, messageId: $messageId, operation: $operation, recipient: $recipient, status: $status, success: $success)';
  }
}
