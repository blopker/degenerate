...
OrganizationsGetAccountsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<Account>? result, PageTokenResultInfo? resultInfo, bool? success, }) { return OrganizationsGetAccountsResponse(
