...
import 'patch_event_query_alert_update_request_frequency.dart';final class PatchEventQueryAlertUpdateRequest {const PatchEventQueryAlertUpdateRequest({this.enabled, this.frequency, this.notificationType, });
