...
final class AccessIdentityMtlsAuth {
  const AccessIdentityMtlsAuth({
    this.authStatus,
    this.certIssuerDn,
    this.certIssuerSki,
    this.certPresented,
  ...
  factory AccessIdentityMtlsAuth.fromJson(Map<String, dynamic> json) {
    return AccessIdentityMtlsAuth(
  ...
  AccessIdentityMtlsAuth copyWith({
    String Function()? authStatus,
    String Function()? certIssuerDn,
    String Function()? certIssuerSki,
    bool Function()? certPresented,
    String Function()? certSerial,
  }) {
    return AccessIdentityMtlsAuth(
      authStatus: authStatus != null ? authStatus() : this.authStatus,
      certIssuerDn: certIssuerDn != null ? certIssuerDn() : this.certIssuerDn,
      certIssuerSki: certIssuerSki != null
          ? certIssuerSki()
          : this.certIssuerSki,
      certPresented: certPresented != null
          ? certPresented()
          : this.certPresented,
  ...
  @override
  String toString() {
    return 'AccessIdentityMtlsAuth(authStatus: $authStatus, certIssuerDn: $certIssuerDn, certIssuerSki: $certIssuerSki, certPresented: $certPresented, certSerial: $certSerial)';
  }
}
