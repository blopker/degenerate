...
import 'post_commands_request_commands_command_args.dart';import 'post_commands_request_commands_command_type.dart';final class PostCommandsRequestCommands {const PostCommandsRequestCommands({this.commandArgs, required this.commandType, required this.deviceId, this.registrationId, required this.userEmail, });
