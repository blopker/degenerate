...
import 'package:collection/collection.dart';final class MagicLanDhcpRelay {const MagicLanDhcpRelay({this.serverAddresses});

factory MagicLanDhcpRelay.fromJson(Map<String, dynamic> json) { return MagicLanDhcpRelay(
  serverAddresses: (json['server_addresses'] as List<dynamic>?)?.map((e) => e as String).toList(),
); }
...
MagicLanDhcpRelay copyWith({List<String> Function()? serverAddresses}) { return MagicLanDhcpRelay(
