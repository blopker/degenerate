...
import 'stream_live_input_recording_settings.dart';final class StreamUpdateInputRequest {const StreamUpdateInputRequest({this.defaultCreator, this.deleteRecordingAfterDays, this.enabled, this.meta, this.recording, });
...
StreamUpdateInputRequest copyWith({String Function()? defaultCreator, double Function()? deleteRecordingAfterDays, bool Function()? enabled, Map<String, String> Function()? meta, StreamLiveInputRecordingSettings Function()? recording, }) { return StreamUpdateInputRequest(
