...
final class PagesBuildConfig {
  const PagesBuildConfig({
    this.buildCaching,
    this.buildCommand,
    this.destinationDir,
    this.rootDir,
  ...
  factory PagesBuildConfig.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('web_analytics_tag') &&
        json['web_analytics_tag'] is String &&
        json.containsKey('web_analytics_token') &&
        json['web_analytics_token'] is String;
  }

  PagesBuildConfig copyWith({
  ...
  @override
  String toString() {
    return 'PagesBuildConfig(buildCaching: $buildCaching, buildCommand: $buildCommand, destinationDir: $destinationDir, rootDir: $rootDir, webAnalyticsTag: $webAnalyticsTag, webAnalyticsToken: $webAnalyticsToken)';
  }
}
