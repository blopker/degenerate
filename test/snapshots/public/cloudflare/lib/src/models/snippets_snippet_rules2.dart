...
final class SnippetsSnippetRules2 {
  const SnippetsSnippetRules2({
    this.description = '',
    this.enabled = false,
  ...
  factory SnippetsSnippetRules2.fromJson(Map<String, dynamic> json) {
    return SnippetsSnippetRules2(
  ...
  SnippetsSnippetRules2 copyWith({
  ...
  @override
  String toString() {
    return 'SnippetsSnippetRules2(description: $description, enabled: $enabled, expression: $expression, id: $id, lastUpdated: $lastUpdated, snippetName: $snippetName)';
  }
}
