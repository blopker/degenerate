...
import 'destination_list_response404_errors_message.dart';final class DestinationListResponse404Errors {const DestinationListResponse404Errors({this.detail, required this.message, });
