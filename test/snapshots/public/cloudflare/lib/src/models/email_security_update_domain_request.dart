...
import 'package:collection/collection.dart';import 'email_security_delivery_mode.dart';import 'email_security_disposition_label.dart';import 'email_security_scannable_folder.dart';import 'email_security_update_domain_request_regions.dart';final class EmailSecurityUpdateDomainRequest {const EmailSecurityUpdateDomainRequest({this.allowedDeliveryModes, this.domain, this.dropDispositions, this.folder, this.integrationId, required this.ipRestrictions, this.lookbackHops, this.regions, this.requireTlsInbound, this.requireTlsOutbound, this.transport, });
