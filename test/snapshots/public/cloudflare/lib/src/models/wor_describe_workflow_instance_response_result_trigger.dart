...
import 'wor_describe_workflow_instance_response_result_trigger_source.dart';final class WorDescribeWorkflowInstanceResponseResultTrigger {const WorDescribeWorkflowInstanceResponseResultTrigger({required this.source});
