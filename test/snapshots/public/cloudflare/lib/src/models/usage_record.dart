...
final class UsageRecord {
  const UsageRecord({
    ...
    required this.contractedCost,
    required this.cumulatedContractedCost,
    required this.cumulatedPricingQuantity,
  ...
  factory UsageRecord.fromJson(Map<String, dynamic> json) {
    return UsageRecord(
      ...
      cumulatedContractedCost: (json['CumulatedContractedCost'] as num)
          .toDouble(),
      cumulatedPricingQuantity: (json['CumulatedPricingQuantity'] as num)
          .toInt(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('BillingCurrency') &&
        json['BillingCurrency'] is String &&
        json.containsKey('BillingPeriodStart') &&
        json['BillingPeriodStart'] is String &&
        json.containsKey('ChargePeriodEnd') &&
        json['ChargePeriodEnd'] is String &&
        json.containsKey('ChargePeriodStart') &&
        json['ChargePeriodStart'] is String &&
        json.containsKey('ConsumedQuantity') &&
        json['ConsumedQuantity'] is num &&
        json.containsKey('ConsumedUnit') &&
        json['ConsumedUnit'] is String &&
        json.containsKey('ContractedCost') &&
        json['ContractedCost'] is num &&
        json.containsKey('CumulatedContractedCost') &&
        json['CumulatedContractedCost'] is num &&
        json.containsKey('CumulatedPricingQuantity') &&
        json['CumulatedPricingQuantity'] is num &&
        json.containsKey('PricingQuantity') &&
        json['PricingQuantity'] is num &&
        json.containsKey('ServiceName') &&
  ...
  UsageRecord copyWith({
    ...
    return UsageRecord(
      ...
      cumulatedContractedCost:
          cumulatedContractedCost ?? this.cumulatedContractedCost,
      cumulatedPricingQuantity:
          cumulatedPricingQuantity ?? this.cumulatedPricingQuantity,
