...
import 'package:collection/collection.dart';import 'mconn_customer_device.dart';import 'mconn_day_of_week.dart';final class MconnCustomerConnector {const MconnCustomerConnector({required this.activated, this.device, required this.id, required this.interruptWindowDaysOfWeek, required this.interruptWindowDurationHours, required this.interruptWindowEmbargoDates, required this.interruptWindowHourOfDay, this.lastHeartbeat, this.lastSeenVersion, required this.lastUpdated, this.licenseKey, required this.notes, required this.timezone, });
