...
import 'package:collection/collection.dart';import 'zones0_patch_request_plan.dart';import 'zones0_patch_request_type.dart';final class Zones0PatchRequest {const Zones0PatchRequest({this.paused, this.plan, this.type, this.vanityNameServers, });
...
Zones0PatchRequest copyWith({bool Function()? paused, Zones0PatchRequestPlan Function()? plan, Zones0PatchRequestType Function()? type, List<String> Function()? vanityNameServers, }) { return Zones0PatchRequest(
