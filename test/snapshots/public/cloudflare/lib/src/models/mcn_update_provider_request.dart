...
final class McnUpdateProviderRequest {
  const McnUpdateProviderRequest({
    this.awsArn,
  ...
  factory McnUpdateProviderRequest.fromJson(Map<String, dynamic> json) {
    return McnUpdateProviderRequest(
  ...
  McnUpdateProviderRequest copyWith({
  ...
  @override
  String toString() {
    return 'McnUpdateProviderRequest(awsArn: $awsArn, azureSubscriptionId: $azureSubscriptionId, azureTenantId: $azureTenantId, description: $description, friendlyName: $friendlyName, gcpProjectId: $gcpProjectId, gcpServiceAccountEmail: $gcpServiceAccountEmail)';
  }
}
