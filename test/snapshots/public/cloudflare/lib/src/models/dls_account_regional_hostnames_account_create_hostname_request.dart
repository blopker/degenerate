...
final class DlsAccountRegionalHostnamesAccountCreateHostnameRequest {const DlsAccountRegionalHostnamesAccountCreateHostnameRequest({required this.hostname, required this.regionKey, this.routing, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('hostname') && json['hostname'] is String &&
      json.containsKey('region_key') && json['region_key'] is String; } 
DlsAccountRegionalHostnamesAccountCreateHostnameRequest copyWith({String? hostname, String? regionKey, String Function()? routing, }) { return DlsAccountRegionalHostnamesAccountCreateHostnameRequest(
