...
import 'workers_observability_query_parameters_group_bys_type.dart';final class WorkersObservabilityQueryParametersGroupBys {const WorkersObservabilityQueryParametersGroupBys({required this.type, required this.value, });
