...
import 'package:collection/collection.dart';import 'magic_lan_static_addressing.dart';import 'magic_nat.dart';import 'magic_routed_subnet.dart';final class MagicLan {const MagicLan({this.bondId, this.haLink, this.id, this.isBreakout, this.isPrioritized, this.name, this.nat, this.physport, this.routedSubnets, this.siteId, this.staticAddressing, this.vlanTag, });
...
MagicLan copyWith({int Function()? bondId, bool Function()? haLink, String Function()? id, bool Function()? isBreakout, bool Function()? isPrioritized, String Function()? name, MagicNat Function()? nat, int Function()? physport, List<MagicRoutedSubnet> Function()? routedSubnets, String Function()? siteId, MagicLanStaticAddressing Function()? staticAddressing, int Function()? vlanTag, }) { return MagicLan(
