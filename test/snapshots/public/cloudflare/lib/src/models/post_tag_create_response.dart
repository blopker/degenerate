...
final class PostTagCreateResponse {
  const PostTagCreateResponse({
    this.activeDuration,
    this.actorCategory,
  ...
  factory PostTagCreateResponse.fromJson(Map<String, dynamic> json) {
    return PostTagCreateResponse(
  ...
  PostTagCreateResponse copyWith({
