...
final class DosDnsProtectionRuleUpdate {
  const DosDnsProtectionRuleUpdate({
  ...
  factory DosDnsProtectionRuleUpdate.fromJson(Map<String, dynamic> json) {
    return DosDnsProtectionRuleUpdate(
  ...
  DosDnsProtectionRuleUpdate copyWith({
    String Function()? burstSensitivity,
    String Function()? mode,
    String Function()? profileSensitivity,
    ...
    return DosDnsProtectionRuleUpdate(
      ...
      profileSensitivity: profileSensitivity != null
          ? profileSensitivity()
          : this.profileSensitivity,
  ...
  @override
  String toString() {
    return 'DosDnsProtectionRuleUpdate(burstSensitivity: $burstSensitivity, mode: $mode, profileSensitivity: $profileSensitivity, rateSensitivity: $rateSensitivity)';
  }
}
