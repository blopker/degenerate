...
import 'package:collection/collection.dart';import 'load_balancing_monitor_group_member.dart';final class LoadBalancingMonitorGroup {const LoadBalancingMonitorGroup({this.createdAt, required this.description, required this.id, required this.members, this.updatedAt, });
...
LoadBalancingMonitorGroup copyWith({DateTime Function()? createdAt, String? description, String? id, List<LoadBalancingMonitorGroupMember>? members, DateTime Function()? updatedAt, }) { return LoadBalancingMonitorGroup(
