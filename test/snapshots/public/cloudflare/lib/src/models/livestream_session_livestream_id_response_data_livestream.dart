...
import 'livestream_session_livestream_id_response_data_livestream_status.dart';final class LivestreamSessionLivestreamIdResponseDataLivestream {const LivestreamSessionLivestreamIdResponseDataLivestream({this.createdAt, this.disabled, this.id, this.ingestServer, this.meetingId, this.name, this.playbackUrl, this.status, this.streamKey, this.updatedAt, });
