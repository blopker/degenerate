...
import 'package:collection/collection.dart';import 'iam_account.dart';import 'iam_permissions.dart';import 'iam_schemas_status.dart';final class IamMembership {const IamMembership({this.account, this.apiAccessEnabled, this.id, this.permissions, this.roles, this.status, });
...
IamMembership copyWith({IamAccount Function()? account, bool? Function()? apiAccessEnabled, String Function()? id, IamPermissions Function()? permissions, List<String> Function()? roles, IamSchemasStatus Function()? status, }) { return IamMembership(
