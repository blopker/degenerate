...
/// the Cache Key.
///
final class ZonesCacheKeyFieldsValueUser {
  const ZonesCacheKeyFieldsValueUser({this.deviceType, this.geo, this.lang});

  factory ZonesCacheKeyFieldsValueUser.fromJson(Map<String, dynamic> json) {
    return ZonesCacheKeyFieldsValueUser(
  ...
  ZonesCacheKeyFieldsValueUser copyWith({
  ...
  @override
  String toString() {
    return 'ZonesCacheKeyFieldsValueUser(deviceType: $deviceType, geo: $geo, lang: $lang)';
  }
}
