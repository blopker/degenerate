...
import 'package:collection/collection.dart';import 'r2_edit_custom_domain_response_min_tls.dart';final class R2EditCustomDomainResponse {const R2EditCustomDomainResponse({this.ciphers, required this.domain, this.enabled, this.minTls, });
