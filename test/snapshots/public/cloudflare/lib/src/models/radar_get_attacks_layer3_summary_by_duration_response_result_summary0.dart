...
final class RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0 {
  const RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0({
  ...
  factory RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('_1_HOUR_TO_3_HOURS') &&
        json['_1_HOUR_TO_3_HOURS'] is String &&
        json.containsKey('_10_MINS_TO_20_MINS') &&
        json['_10_MINS_TO_20_MINS'] is String &&
        json.containsKey('_20_MINS_TO_40_MINS') &&
        json['_20_MINS_TO_40_MINS'] is String &&
        json.containsKey('_40_MINS_TO_1_HOUR') &&
        json['_40_MINS_TO_1_HOUR'] is String &&
        json.containsKey('OVER_3_HOURS') &&
        json['OVER_3_HOURS'] is String &&
        json.containsKey('UNDER_10_MINS') &&
        json['UNDER_10_MINS'] is String;
  }

  RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0 copyWith({
    String? $1HourTo3Hours,
    String? $10MinsTo20Mins,
    String? $20MinsTo40Mins,
    String? $40MinsTo1Hour,
    String? over3Hours,
    String? under10Mins,
  }) {
    return RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0(
  ...
  @override
  String toString() {
    return 'RadarGetAttacksLayer3SummaryByDurationResponseResultSummary0(\$1HourTo3Hours: ${$1HourTo3Hours}, \$10MinsTo20Mins: ${$10MinsTo20Mins}, \$20MinsTo40Mins: ${$20MinsTo40Mins}, \$40MinsTo1Hour: ${$40MinsTo1Hour}, over3Hours: $over3Hours, under10Mins: $under10Mins)';
  }
}
