...
final class WorkersScriptAndVersionSettingsItemAnnotations {
  const WorkersScriptAndVersionSettingsItemAnnotations({
    this.workersMessage,
    this.workersTag,
    this.workersTriggeredBy,
  });

  factory WorkersScriptAndVersionSettingsItemAnnotations.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersScriptAndVersionSettingsItemAnnotations(
  ...
  WorkersScriptAndVersionSettingsItemAnnotations copyWith({
    String Function()? workersMessage,
    String Function()? workersTag,
    String Function()? workersTriggeredBy,
  }) {
    return WorkersScriptAndVersionSettingsItemAnnotations(
      workersMessage: workersMessage != null
          ? workersMessage()
          : this.workersMessage,
      workersTag: workersTag != null ? workersTag() : this.workersTag,
      workersTriggeredBy: workersTriggeredBy != null
          ? workersTriggeredBy()
          : this.workersTriggeredBy,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(workersMessage, workersTag, workersTriggeredBy);
  }

  @override
  String toString() {
    return 'WorkersScriptAndVersionSettingsItemAnnotations(workersMessage: $workersMessage, workersTag: $workersTag, workersTriggeredBy: $workersTriggeredBy)';
  }
}
