...
import 'rulesets_set_cache_settings_custom_cache_key.dart';

/// Which components of the request are included in or excluded from the cache key Cloudflare uses to store the response in cache.
final class RulesetsSetCacheSettingsCacheKey {
  const RulesetsSetCacheSettingsCacheKey({
  ...
  factory RulesetsSetCacheSettingsCacheKey.fromJson(Map<String, dynamic> json) {
    return RulesetsSetCacheSettingsCacheKey(
      ...
      customKey: json['custom_key'] != null
          ? RulesetsSetCacheSettingsCustomCacheKey.fromJson(
              json['custom_key'] as Map<String, dynamic>,
            )
          : null,
  ...
  RulesetsSetCacheSettingsCacheKey copyWith({
    bool Function()? cacheByDeviceType,
    bool Function()? cacheDeceptionArmor,
    RulesetsSetCacheSettingsCustomCacheKey Function()? customKey,
    bool Function()? ignoreQueryStringsOrder,
  }) {
    return RulesetsSetCacheSettingsCacheKey(
      cacheByDeviceType: cacheByDeviceType != null
          ? cacheByDeviceType()
          : this.cacheByDeviceType,
      cacheDeceptionArmor: cacheDeceptionArmor != null
          ? cacheDeceptionArmor()
          : this.cacheDeceptionArmor,
      customKey: customKey != null ? customKey() : this.customKey,
      ignoreQueryStringsOrder: ignoreQueryStringsOrder != null
  ...
  @override
  String toString() {
    return 'RulesetsSetCacheSettingsCacheKey(cacheByDeviceType: $cacheByDeviceType, cacheDeceptionArmor: $cacheDeceptionArmor, customKey: $customKey, ignoreQueryStringsOrder: $ignoreQueryStringsOrder)';
  }
}
