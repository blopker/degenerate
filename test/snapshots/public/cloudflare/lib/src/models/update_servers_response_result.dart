...
import 'update_servers_response_result_auth_type.dart';

final class UpdateServersResponseResult {
  const UpdateServersResponseResult({
  ...
  factory UpdateServersResponseResult.fromJson(Map<String, dynamic> json) {
    return UpdateServersResponseResult(
      authType: UpdateServersResponseResultAuthType.fromJson(
  ...
  UpdateServersResponseResult copyWith({
    UpdateServersResponseResultAuthType? authType,
