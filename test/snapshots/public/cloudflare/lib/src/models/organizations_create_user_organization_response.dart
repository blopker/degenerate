...
OrganizationsCreateUserOrganizationResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, Organization? result, bool? success, }) { return OrganizationsCreateUserOrganizationResponse(
