...
import 'zero_trust_gateway_rule_settings_audit_ssh.dart';
import 'zero_trust_gateway_rule_settings_biso_admin_controls.dart';
import 'zero_trust_gateway_rule_settings_block_page.dart';
import 'zero_trust_gateway_rule_settings_check_session.dart';
import 'zero_trust_gateway_rule_settings_dns_resolvers.dart';
import 'zero_trust_gateway_rule_settings_egress.dart';
import 'zero_trust_gateway_rule_settings_forensic_copy.dart';
import 'zero_trust_gateway_rule_settings_l4override.dart';
import 'zero_trust_gateway_rule_settings_notification_settings.dart';
import 'zero_trust_gateway_rule_settings_payload_log.dart';
import 'zero_trust_gateway_rule_settings_quarantine.dart';
import 'zero_trust_gateway_rule_settings_redirect.dart';
import 'zero_trust_gateway_rule_settings_resolve_dns_internally.dart';
import 'zero_trust_gateway_rule_settings_untrusted_cert.dart';

/// Defines settings for this rule. Settings apply only to specific rule types and must use compatible selectors. If Terraform detects drift, confirm the setting supports your rule type and check whether the API modifies the value. Use API-returned values in your configuration to prevent drift.
final class ZeroTrustGatewayRuleSettings {
  const ZeroTrustGatewayRuleSettings({
    this.addHeaders,
  ...
  factory ZeroTrustGatewayRuleSettings.fromJson(Map<String, dynamic> json) {
    return ZeroTrustGatewayRuleSettings(
      addHeaders: (json['add_headers'] as Map<String, dynamic>?)?.map(
        (k, v) =>
      ...
      auditSsh: json['audit_ssh'] != null
          ? ZeroTrustGatewayRuleSettingsAuditSsh.fromJson(
              json['audit_ssh'] as Map<String, dynamic>,
            )
          : null,
      bisoAdminControls: json['biso_admin_controls'] != null
          ? ZeroTrustGatewayRuleSettingsBisoAdminControls.fromJson(
              json['biso_admin_controls'] as Map<String, dynamic>,
            )
          : null,
      blockPage: json['block_page'] != null
          ? ZeroTrustGatewayRuleSettingsBlockPage.fromJson(
              json['block_page'] as Map<String, dynamic>,
            )
          : null,
      ...
      checkSession: json['check_session'] != null
          ? ZeroTrustGatewayRuleSettingsCheckSession.fromJson(
              json['check_session'] as Map<String, dynamic>,
            )
          : null,
      dnsResolvers: json['dns_resolvers'] != null
          ? ZeroTrustGatewayRuleSettingsDnsResolvers.fromJson(
              json['dns_resolvers'] as Map<String, dynamic>,
            )
          : null,
      egress: json['egress'] != null
          ? ZeroTrustGatewayRuleSettingsEgress.fromJson(
              json['egress'] as Map<String, dynamic>,
            )
          : null,
      forensicCopy: json['forensic_copy'] != null
          ? ZeroTrustGatewayRuleSettingsForensicCopy.fromJson(
              json['forensic_copy'] as Map<String, dynamic>,
            )
          : null,
      ignoreCnameCategoryMatches:
          json['ignore_cname_category_matches'] as bool?,
      insecureDisableDnssecValidation:
          json['insecure_disable_dnssec_validation'] as bool?,
      ipCategories: json['ip_categories'] as bool?,
      ipIndicatorFeeds: json['ip_indicator_feeds'] as bool?,
      l4override: json['l4override'] != null
          ? ZeroTrustGatewayRuleSettingsL4override.fromJson(
              json['l4override'] as Map<String, dynamic>,
            )
          : null,
      notificationSettings: json['notification_settings'] != null
          ? ZeroTrustGatewayRuleSettingsNotificationSettings.fromJson(
              json['notification_settings'] as Map<String, dynamic>,
            )
          : null,
      overrideHost: json['override_host'] as String?,
      overrideIps: (json['override_ips'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      payloadLog: json['payload_log'] != null
          ? ZeroTrustGatewayRuleSettingsPayloadLog.fromJson(
              json['payload_log'] as Map<String, dynamic>,
            )
          : null,
      quarantine: json['quarantine'] != null
          ? ZeroTrustGatewayRuleSettingsQuarantine.fromJson(
              json['quarantine'] as Map<String, dynamic>,
            )
          : null,
      redirect: json['redirect'] != null
          ? ZeroTrustGatewayRuleSettingsRedirect.fromJson(
              json['redirect'] as Map<String, dynamic>,
            )
          : null,
      resolveDnsInternally: json['resolve_dns_internally'] != null
          ? ZeroTrustGatewayRuleSettingsResolveDnsInternally.fromJson(
              json['resolve_dns_internally'] as Map<String, dynamic>,
            )
          : null,
      resolveDnsThroughCloudflare:
          json['resolve_dns_through_cloudflare'] as bool?,
      untrustedCert: json['untrusted_cert'] != null
          ? ZeroTrustGatewayRuleSettingsUntrustedCert.fromJson(
              json['untrusted_cert'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      if (addHeaders != null)
        'add_headers': addHeaders?.map((k, v) => MapEntry(k, v)),
  ...
  ZeroTrustGatewayRuleSettings copyWith({
    Map<String, List<String>>? Function()? addHeaders,
    bool? Function()? allowChildBypass,
    ZeroTrustGatewayRuleSettingsAuditSsh? Function()? auditSsh,
    ZeroTrustGatewayRuleSettingsBisoAdminControls Function()? bisoAdminControls,
    ZeroTrustGatewayRuleSettingsBlockPage? Function()? blockPage,
    bool Function()? blockPageEnabled,
    String? Function()? blockReason,
    bool? Function()? bypassParentRule,
    ZeroTrustGatewayRuleSettingsCheckSession? Function()? checkSession,
    ZeroTrustGatewayRuleSettingsDnsResolvers? Function()? dnsResolvers,
    ZeroTrustGatewayRuleSettingsEgress? Function()? egress,
    ZeroTrustGatewayRuleSettingsForensicCopy? Function()? forensicCopy,
    bool Function()? ignoreCnameCategoryMatches,
    bool Function()? insecureDisableDnssecValidation,
    bool Function()? ipCategories,
    bool Function()? ipIndicatorFeeds,
    ZeroTrustGatewayRuleSettingsL4override? Function()? l4override,
    ZeroTrustGatewayRuleSettingsNotificationSettings? Function()?
    notificationSettings,
    String Function()? overrideHost,
    List<String>? Function()? overrideIps,
    ZeroTrustGatewayRuleSettingsPayloadLog? Function()? payloadLog,
    ZeroTrustGatewayRuleSettingsQuarantine? Function()? quarantine,
    ZeroTrustGatewayRuleSettingsRedirect? Function()? redirect,
    ZeroTrustGatewayRuleSettingsResolveDnsInternally? Function()?
    resolveDnsInternally,
    bool? Function()? resolveDnsThroughCloudflare,
    ZeroTrustGatewayRuleSettingsUntrustedCert? Function()? untrustedCert,
  }) {
    return ZeroTrustGatewayRuleSettings(
      addHeaders: addHeaders != null ? addHeaders() : this.addHeaders,
      allowChildBypass: allowChildBypass != null
          ? allowChildBypass()
          : this.allowChildBypass,
      auditSsh: auditSsh != null ? auditSsh() : this.auditSsh,
      bisoAdminControls: bisoAdminControls != null
          ? bisoAdminControls()
          : this.bisoAdminControls,
      blockPage: blockPage != null ? blockPage() : this.blockPage,
      blockPageEnabled: blockPageEnabled != null
          ? blockPageEnabled()
          : this.blockPageEnabled,
      blockReason: blockReason != null ? blockReason() : this.blockReason,
      bypassParentRule: bypassParentRule != null
          ? bypassParentRule()
          : this.bypassParentRule,
      ...
      ignoreCnameCategoryMatches: ignoreCnameCategoryMatches != null
          ? ignoreCnameCategoryMatches()
          : this.ignoreCnameCategoryMatches,
      insecureDisableDnssecValidation: insecureDisableDnssecValidation != null
          ? insecureDisableDnssecValidation()
          : this.insecureDisableDnssecValidation,
      ipCategories: ipCategories != null ? ipCategories() : this.ipCategories,
      ipIndicatorFeeds: ipIndicatorFeeds != null
          ? ipIndicatorFeeds()
          : this.ipIndicatorFeeds,
      ...
      resolveDnsInternally: resolveDnsInternally != null
          ? resolveDnsInternally()
          : this.resolveDnsInternally,
      resolveDnsThroughCloudflare: resolveDnsThroughCloudflare != null
          ? resolveDnsThroughCloudflare()
          : this.resolveDnsThroughCloudflare,
      untrustedCert: untrustedCert != null
          ? untrustedCert()
          : this.untrustedCert,
    );
  }
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      notificationSettings,
      overrideHost,
      Object.hashAll(overrideIps ?? const []),
      payloadLog,
      quarantine,
      redirect,
      resolveDnsInternally,
