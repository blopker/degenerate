...
final class AddressingIpamDelegations {const AddressingIpamDelegations({this.cidr, this.createdAt, this.delegatedAccountId, this.id, this.modifiedAt, this.parentPrefixId, });
...
AddressingIpamDelegations copyWith({String Function()? cidr, DateTime Function()? createdAt, String Function()? delegatedAccountId, String Function()? id, DateTime Function()? modifiedAt, String Function()? parentPrefixId, }) { return AddressingIpamDelegations(
