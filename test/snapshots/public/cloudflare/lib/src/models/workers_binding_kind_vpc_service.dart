...
final class WorkersBindingKindVpcService {const WorkersBindingKindVpcService({required this.name, required this.serviceId, required this.type, });
...
WorkersBindingKindVpcService copyWith({String? name, String? serviceId, String? type, }) { return WorkersBindingKindVpcService(
  name: name ?? this.name,
