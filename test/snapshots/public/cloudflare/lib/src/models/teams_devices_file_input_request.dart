...
import 'teams_devices_file_input_request_operating_system.dart';final class TeamsDevicesFileInputRequest {const TeamsDevicesFileInputRequest({this.exists, required this.operatingSystem, required this.path, this.sha256, this.thumbprint, });
