...
import 'realtimekit_livestream_base_status.dart';

final class RealtimekitLivestreamBase {
  const RealtimekitLivestreamBase({
    this.createdAt,
    this.disabled,
    this.id,
    this.ingestServer,
  ...
  factory RealtimekitLivestreamBase.fromJson(Map<String, dynamic> json) {
    return RealtimekitLivestreamBase(
      ...
      status: json['status'] != null
          ? RealtimekitLivestreamBaseStatus.fromJson(json['status'] as String)
          : null,
  ...
  RealtimekitLivestreamBase copyWith({
    ...
    RealtimekitLivestreamBaseStatus Function()? status,
  ...
  @override
  String toString() {
    return 'RealtimekitLivestreamBase(createdAt: $createdAt, disabled: $disabled, id: $id, ingestServer: $ingestServer, meetingId: $meetingId, name: $name, orgId: $orgId, playbackUrl: $playbackUrl, status: $status, streamKey: $streamKey, updatedAt: $updatedAt)';
  }
}
