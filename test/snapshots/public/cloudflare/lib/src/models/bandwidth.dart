...
final class Bandwidth {
  const Bandwidth._(this.value);

  factory Bandwidth.fromJson(String json) {
    return switch (json) {
      '50M' => $50M,
      '100M' => $100M,
      '200M' => $200M,
  ...
  static const List<Bandwidth> values = [
    $50M,
    $100M,
    $200M,
    $300M,
  ...
  bool operator ==(Object other) {
    return identical(this, other) || other is Bandwidth && other.value == value;
  }
