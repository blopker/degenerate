...
import 'ai_search_update_instances_request_source_params_web_crawler_crawl_options_source.dart';final class AiSearchUpdateInstancesRequestSourceParamsWebCrawlerCrawlOptions {const AiSearchUpdateInstancesRequestSourceParamsWebCrawlerCrawlOptions({this.depth, this.includeExternalLinks = false, this.includeSubdomains = false, this.maxAge, this.source = AiSearchUpdateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource.all, });
