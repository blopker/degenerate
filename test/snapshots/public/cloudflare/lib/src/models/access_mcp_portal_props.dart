...
final class AccessMcpPortalProps {
  const AccessMcpPortalProps({
  ...
  factory AccessMcpPortalProps.fromJson(Map<String, dynamic> json) {
    return AccessMcpPortalProps(
