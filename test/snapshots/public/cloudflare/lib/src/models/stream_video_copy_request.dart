...
import 'package:collection/collection.dart';import 'stream_watermark_at_upload.dart';final class StreamVideoCopyRequest {const StreamVideoCopyRequest({this.allowedOrigins, this.creator, this.meta, this.requireSignedUrLs, this.scheduledDeletion, this.thumbnailTimestampPct, required this.url, this.watermark, });
...
StreamVideoCopyRequest copyWith({List<String> Function()? allowedOrigins, String Function()? creator, Map<String, String> Function()? meta, bool Function()? requireSignedUrLs, DateTime Function()? scheduledDeletion, double Function()? thumbnailTimestampPct, Uri? url, StreamWatermarkAtUpload Function()? watermark, }) { return StreamVideoCopyRequest(
