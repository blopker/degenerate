...
final class WorkersKvNamespace {const WorkersKvNamespace({required this.id, this.supportsUrlEncoding, required this.title, });
...
WorkersKvNamespace copyWith({String? id, bool Function()? supportsUrlEncoding, String? title, }) { return WorkersKvNamespace(
  id: id ?? this.id,
