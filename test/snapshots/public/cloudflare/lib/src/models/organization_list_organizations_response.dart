...
OrganizationListOrganizationsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<Organization>? result, PageTokenResultInfo? resultInfo, bool? success, }) { return OrganizationListOrganizationsResponse(
