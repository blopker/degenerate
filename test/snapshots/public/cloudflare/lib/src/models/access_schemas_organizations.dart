...
final class AccessSchemasOrganizations {
  const AccessSchemasOrganizations({
    this.authDomain,
    this.createdAt,
  ...
  factory AccessSchemasOrganizations.fromJson(Map<String, dynamic> json) {
    return AccessSchemasOrganizations(
  ...
  AccessSchemasOrganizations copyWith({
