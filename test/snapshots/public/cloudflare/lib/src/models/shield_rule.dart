...
final class ShieldRule {
  ...
  factory ShieldRule.fromJson(Map<String, dynamic> json) {
    return ShieldRule(
      ...
      lastUpdated: json['last_updated'] != null
          ...
          : null,
      selector: ShieldSelector.fromJson(
  ...
  @override
  String toString() {
    return 'ShieldRule(action: $action, createdAt: $createdAt, description: $description, enabled: $enabled, expression: $expression, id: $id, lastUpdated: $lastUpdated, selector: $selector, title: $title)';
  }
}
