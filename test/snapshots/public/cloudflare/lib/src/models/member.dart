...
import 'member_subject_user.dart';
...
final class Member {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('create_time') &&
        json['create_time'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('meta') &&
        json.containsKey('status') &&
        json.containsKey('update_time') &&
        json['update_time'] is String &&
  ...
  @override
  int get hashCode {
    return Object.hash(createTime, id, meta, status, updateTime, user);
  }

  @override
  String toString() {
    return 'Member(createTime: $createTime, id: $id, meta: $meta, status: $status, updateTime: $updateTime, user: $user)';
  }
}
