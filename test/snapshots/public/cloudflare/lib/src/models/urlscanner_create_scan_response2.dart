...
import 'urlscanner_create_scan_response2_options.dart';import 'urlscanner_create_scan_response2_visibility.dart';final class UrlscannerCreateScanResponse2 {const UrlscannerCreateScanResponse2({required this.api, required this.message, this.options, required this.result, required this.url, required this.uuid, required this.visibility, });
