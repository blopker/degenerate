...
final class DnsAnalyticsTimeDelta {
  const DnsAnalyticsTimeDelta._(this.value);

  factory DnsAnalyticsTimeDelta.fromJson(String json) {
    return switch (json) {
      'all' => all,
      'auto' => auto,
      'year' => year,
  ...
  static const DnsAnalyticsTimeDelta quarter = DnsAnalyticsTimeDelta._(
    'quarter',
  );
  ...
  static const DnsAnalyticsTimeDelta dekaminute = DnsAnalyticsTimeDelta._(
    'dekaminute',
  );

  static const DnsAnalyticsTimeDelta minute = DnsAnalyticsTimeDelta._('minute');

  static const List<DnsAnalyticsTimeDelta> values = [
    all,
    auto,
    year,
    quarter,
  ...
  @override
  String toString() {
    return 'DnsAnalyticsTimeDelta($value)';
  }
}
