...
final class TlsCertificatesAndHostnamesValidationRecord {
  const TlsCertificatesAndHostnamesValidationRecord({
    this.cname,
    this.cnameTarget,
    this.emails,
    this.httpBody,
  ...
  factory TlsCertificatesAndHostnamesValidationRecord.fromJson(
    Map<String, dynamic> json,
  ) {
    return TlsCertificatesAndHostnamesValidationRecord(
  ...
  TlsCertificatesAndHostnamesValidationRecord copyWith({
    String Function()? cname,
    String Function()? cnameTarget,
    List<String> Function()? emails,
    String Function()? httpBody,
    String Function()? httpUrl,
  ...
  @override
  String toString() {
    return 'TlsCertificatesAndHostnamesValidationRecord(cname: $cname, cnameTarget: $cnameTarget, emails: $emails, httpBody: $httpBody, httpUrl: $httpUrl, status: $status, txtName: $txtName, txtValue: $txtValue)';
  }
}
