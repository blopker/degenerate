...
import 'access_saml_saas_app_auth_type.dart';
import 'access_saml_saas_app_custom_attributes.dart';
import 'access_saml_saas_app_name_id_format.dart';

final class AccessSamlSaasApp {
  const AccessSamlSaasApp({
    this.authType,
  ...
  factory AccessSamlSaasApp.fromJson(Map<String, dynamic> json) {
    return AccessSamlSaasApp(
      authType: json['auth_type'] != null
          ? AccessSamlSaasAppAuthType.fromJson(json['auth_type'] as String)
          : null,
      ...
      customAttributes: (json['custom_attributes'] as List<dynamic>?)
          ?.map(
            (e) => AccessSamlSaasAppCustomAttributes.fromJson(
      ...
      nameIdFormat: json['name_id_format'] != null
          ? AccessSamlSaasAppNameIdFormat.fromJson(
      ...
      samlAttributeTransformJsonata:
          json['saml_attribute_transform_jsonata'] as String?,
  ...
  AccessSamlSaasApp copyWith({
    AccessSamlSaasAppAuthType Function()? authType,
    String Function()? consumerServiceUrl,
    DateTime Function()? createdAt,
    List<AccessSamlSaasAppCustomAttributes> Function()? customAttributes,
    String Function()? defaultRelayState,
    String Function()? idpEntityId,
    AccessSamlSaasAppNameIdFormat Function()? nameIdFormat,
    String Function()? nameIdTransformJsonata,
    String Function()? publicKey,
    String Function()? samlAttributeTransformJsonata,
    ...
    return AccessSamlSaasApp(
      ...
      customAttributes: customAttributes != null
          ? customAttributes()
          : this.customAttributes,
      defaultRelayState: defaultRelayState != null
          ? defaultRelayState()
          : this.defaultRelayState,
      ...
      samlAttributeTransformJsonata: samlAttributeTransformJsonata != null
          ? samlAttributeTransformJsonata()
          : this.samlAttributeTransformJsonata,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is AccessSamlSaasApp &&
            ...
            samlAttributeTransformJsonata ==
                other.samlAttributeTransformJsonata &&
  ...
  @override
  String toString() {
    return 'AccessSamlSaasApp(authType: $authType, consumerServiceUrl: $consumerServiceUrl, createdAt: $createdAt, customAttributes: $customAttributes, defaultRelayState: $defaultRelayState, idpEntityId: $idpEntityId, nameIdFormat: $nameIdFormat, nameIdTransformJsonata: $nameIdTransformJsonata, publicKey: $publicKey, samlAttributeTransformJsonata: $samlAttributeTransformJsonata, spEntityId: $spEntityId, ssoEndpoint: $ssoEndpoint, updatedAt: $updatedAt)';
  }
}
