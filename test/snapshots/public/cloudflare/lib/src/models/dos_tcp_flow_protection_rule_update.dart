...
final class DosTcpFlowProtectionRuleUpdate {
  const DosTcpFlowProtectionRuleUpdate({
    this.burstSensitivity,
    this.mode,
    this.rateSensitivity,
  });

  factory DosTcpFlowProtectionRuleUpdate.fromJson(Map<String, dynamic> json) {
    return DosTcpFlowProtectionRuleUpdate(
  ...
  DosTcpFlowProtectionRuleUpdate copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(burstSensitivity, mode, rateSensitivity);
  }

  @override
  String toString() {
    return 'DosTcpFlowProtectionRuleUpdate(burstSensitivity: $burstSensitivity, mode: $mode, rateSensitivity: $rateSensitivity)';
  }
}
