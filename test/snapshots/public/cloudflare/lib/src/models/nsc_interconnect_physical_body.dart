...
import 'nsc_facility_info.dart';final class NscInterconnectPhysicalBody {const NscInterconnectPhysicalBody({required this.account, required this.name, this.owner, required this.type, required this.facility, required this.site, required this.slotId, required this.speed, });
...
NscInterconnectPhysicalBody copyWith({String? account, String? name, String Function()? owner, String? type, NscFacilityInfo? facility, String? site, String? slotId, String? speed, }) { return NscInterconnectPhysicalBody(
