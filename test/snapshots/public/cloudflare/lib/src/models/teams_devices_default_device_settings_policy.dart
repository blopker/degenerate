...
import 'package:collection/collection.dart';import 'teams_devices_fallback_domain.dart';import 'teams_devices_service_mode.dart';import 'teams_devices_split_tunnel.dart';import 'teams_devices_split_tunnel_include.dart';final class TeamsDevicesDefaultDeviceSettingsPolicy {const TeamsDevicesDefaultDeviceSettingsPolicy({this.allowModeSwitch, this.allowUpdates, this.allowedToLeave, this.autoConnect, this.captivePortal, this.$default, this.disableAutoFallback, this.enabled = true, this.exclude, this.excludeOfficeIps, this.fallbackDomains, this.gatewayUniqueId, this.include, this.registerInterfaceIpWithDns, this.sccmVpnBoundarySupport, this.serviceModeV2, this.supportUrl, this.switchLocked, this.tunnelProtocol, });
...
TeamsDevicesDefaultDeviceSettingsPolicy copyWith({bool Function()? allowModeSwitch, bool Function()? allowUpdates, bool Function()? allowedToLeave, double Function()? autoConnect, double Function()? captivePortal, bool Function()? $default, bool Function()? disableAutoFallback, bool Function()? enabled, List<TeamsDevicesSplitTunnel> Function()? exclude, bool Function()? excludeOfficeIps, List<TeamsDevicesFallbackDomain> Function()? fallbackDomains, String Function()? gatewayUniqueId, List<TeamsDevicesSplitTunnelInclude> Function()? include, bool Function()? registerInterfaceIpWithDns, bool Function()? sccmVpnBoundarySupport, TeamsDevicesServiceMode Function()? serviceModeV2, String Function()? supportUrl, bool Function()? switchLocked, String Function()? tunnelProtocol, }) { return TeamsDevicesDefaultDeviceSettingsPolicy(
