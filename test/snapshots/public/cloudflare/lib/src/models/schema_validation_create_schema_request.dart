...
import 'schema_validation_create_schema_request_kind.dart';final class SchemaValidationCreateSchemaRequest {const SchemaValidationCreateSchemaRequest({required this.kind, required this.name, required this.source, required this.validationEnabled, });
