...
import 'hyperdrive_hyperdrive_scheme.dart';final class HyperdriveHyperdriveDatabase {const HyperdriveHyperdriveDatabase({this.database, this.password, this.scheme, this.user, });
