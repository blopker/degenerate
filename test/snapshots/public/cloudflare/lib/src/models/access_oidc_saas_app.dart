...
import 'access_oidc_saas_app_auth_type.dart';
import 'access_oidc_saas_app_custom_claims.dart';
import 'access_oidc_saas_app_grant_types.dart';
import 'access_oidc_saas_app_hybrid_and_implicit_options.dart';
import 'access_oidc_saas_app_refresh_token_options.dart';
import 'access_oidc_saas_app_scopes.dart';

final class AccessOidcSaasApp {
  const AccessOidcSaasApp({
  ...
  factory AccessOidcSaasApp.fromJson(Map<String, dynamic> json) {
    return AccessOidcSaasApp(
      ...
      authType: json['auth_type'] != null
          ? AccessOidcSaasAppAuthType.fromJson(json['auth_type'] as String)
          : null,
      ...
      refreshTokenOptions: json['refresh_token_options'] != null
          ? AccessOidcSaasAppRefreshTokenOptions.fromJson(
              json['refresh_token_options'] as Map<String, dynamic>,
            )
          : null,
      scopes: (json['scopes'] as List<dynamic>?)
          ?.map((e) => AccessOidcSaasAppScopes.fromJson(e as String))
          .toList(),
  ...
  AccessOidcSaasApp copyWith({
    String Function()? accessTokenLifetime,
    bool Function()? allowPkceWithoutClientSecret,
    String Function()? appLauncherUrl,
    AccessOidcSaasAppAuthType Function()? authType,
    String Function()? clientId,
    String Function()? clientSecret,
    DateTime Function()? createdAt,
    List<AccessOidcSaasAppCustomClaims> Function()? customClaims,
    List<AccessOidcSaasAppGrantTypes> Function()? grantTypes,
    String Function()? groupFilterRegex,
    AccessOidcSaasAppHybridAndImplicitOptions Function()?
    hybridAndImplicitOptions,
    String Function()? publicKey,
    List<String> Function()? redirectUris,
    AccessOidcSaasAppRefreshTokenOptions Function()? refreshTokenOptions,
    List<AccessOidcSaasAppScopes> Function()? scopes,
