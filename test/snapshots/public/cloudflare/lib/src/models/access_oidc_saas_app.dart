...
import 'package:collection/collection.dart';import 'access_oidc_saas_app_auth_type.dart';import 'access_oidc_saas_app_custom_claims.dart';import 'access_oidc_saas_app_grant_types.dart';import 'access_oidc_saas_app_hybrid_and_implicit_options.dart';import 'access_oidc_saas_app_refresh_token_options.dart';import 'access_oidc_saas_app_scopes.dart';final class AccessOidcSaasApp {const AccessOidcSaasApp({this.accessTokenLifetime, this.allowPkceWithoutClientSecret, this.appLauncherUrl, this.authType, this.clientId, this.clientSecret, this.createdAt, this.customClaims, this.grantTypes, this.groupFilterRegex, this.hybridAndImplicitOptions, this.publicKey, this.redirectUris, this.refreshTokenOptions, this.scopes, this.updatedAt, });
