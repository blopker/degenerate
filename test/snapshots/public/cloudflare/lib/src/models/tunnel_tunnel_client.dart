...
import 'package:collection/collection.dart';import 'tunnel_schemas_connection.dart';/// A client (typically cloudflared) that maintains connections to a Cloudflare data center.
...
factory TunnelTunnelClient.fromJson(Map<String, dynamic> json) { return TunnelTunnelClient(
  ...
  configVersion: json['config_version'] != null ? (json['config_version'] as num).toInt() : null,
  ...
  runAt: json['run_at'] != null ? DateTime.parse(json['run_at'] as String) : null,
...
TunnelTunnelClient copyWith({String Function()? arch, int Function()? configVersion, List<TunnelSchemasConnection> Function()? conns, List<String> Function()? features, String Function()? id, DateTime Function()? runAt, String Function()? version, }) { return TunnelTunnelClient(
