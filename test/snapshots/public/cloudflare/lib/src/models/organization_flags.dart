...
final class OrganizationFlags {
  const OrganizationFlags({
  ...
  factory OrganizationFlags.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account_creation') &&
        json['account_creation'] is String &&
        json.containsKey('account_deletion') &&
        json['account_deletion'] is String &&
        json.containsKey('account_migration') &&
        json['account_migration'] is String &&
        json.containsKey('account_mobility') &&
        json['account_mobility'] is String &&
        json.containsKey('sub_org_creation') &&
        json['sub_org_creation'] is String;
  }

  OrganizationFlags copyWith({
  ...
  @override
  String toString() {
    return 'OrganizationFlags(accountCreation: $accountCreation, accountDeletion: $accountDeletion, accountMigration: $accountMigration, accountMobility: $accountMobility, subOrgCreation: $subOrgCreation)';
  }
}
