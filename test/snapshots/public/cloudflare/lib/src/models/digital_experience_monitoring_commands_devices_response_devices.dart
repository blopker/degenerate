...
final class DigitalExperienceMonitoringCommandsDevicesResponseDevices {const DigitalExperienceMonitoringCommandsDevicesResponseDevices({this.deviceId, this.deviceName, this.eligible, this.ineligibleReason, this.personEmail, this.platform, this.registrationId, this.status, this.timestamp, this.version, });
...
DigitalExperienceMonitoringCommandsDevicesResponseDevices copyWith({String Function()? deviceId, String Function()? deviceName, bool Function()? eligible, String Function()? ineligibleReason, String Function()? personEmail, String Function()? platform, String Function()? registrationId, String Function()? status, String Function()? timestamp, String Function()? version, }) { return DigitalExperienceMonitoringCommandsDevicesResponseDevices(
