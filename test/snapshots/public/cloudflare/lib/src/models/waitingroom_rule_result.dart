...
import 'waitingroom_rule_action.dart';final class WaitingroomRuleResult {const WaitingroomRuleResult({this.action, this.description, this.enabled, this.expression, this.id, this.lastUpdated, this.version, });
...
WaitingroomRuleResult copyWith({WaitingroomRuleAction Function()? action, String Function()? description, bool Function()? enabled, String Function()? expression, String Function()? id, DateTime Function()? lastUpdated, String Function()? version, }) { return WaitingroomRuleResult(
