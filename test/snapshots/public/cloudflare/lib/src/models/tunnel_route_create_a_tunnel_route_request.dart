...
final class TunnelRouteCreateATunnelRouteRequest {const TunnelRouteCreateATunnelRouteRequest({this.comment, required this.network, required this.tunnelId, this.virtualNetworkId, });
...
TunnelRouteCreateATunnelRouteRequest copyWith({String Function()? comment, String? network, String? tunnelId, String Function()? virtualNetworkId, }) { return TunnelRouteCreateATunnelRouteRequest(
