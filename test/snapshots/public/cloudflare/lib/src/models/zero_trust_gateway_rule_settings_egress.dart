...
final class ZeroTrustGatewayRuleSettingsEgress {
  const ZeroTrustGatewayRuleSettingsEgress({
    this.ipv4,
    this.ipv4Fallback,
    this.ipv6,
  });

  factory ZeroTrustGatewayRuleSettingsEgress.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayRuleSettingsEgress(
  ...
  Map<String, dynamic> toJson() {
    return {'ipv4': ?ipv4, 'ipv4_fallback': ?ipv4Fallback, 'ipv6': ?ipv6};
  }
  ...
  ZeroTrustGatewayRuleSettingsEgress copyWith({
    String Function()? ipv4,
    String Function()? ipv4Fallback,
    String Function()? ipv6,
  }) {
    return ZeroTrustGatewayRuleSettingsEgress(
  ...
  @override
  int get hashCode {
    return Object.hash(ipv4, ipv4Fallback, ipv6);
  }

  @override
  String toString() {
    return 'ZeroTrustGatewayRuleSettingsEgress(ipv4: $ipv4, ipv4Fallback: $ipv4Fallback, ipv6: $ipv6)';
  }
}
