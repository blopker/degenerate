...
final class RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0 {
  const RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0({
  ...
  factory RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('later_in_flow') &&
        json['later_in_flow'] is String &&
        json.containsKey('no_match') &&
        json['no_match'] is String &&
        json.containsKey('post_ack') &&
        json['post_ack'] is String &&
        json.containsKey('post_psh') &&
        json['post_psh'] is String &&
        json.containsKey('post_syn') &&
        json['post_syn'] is String;
  }

  RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0 copyWith({
    String? laterInFlow,
    String? noMatch,
    String? postAck,
    String? postPsh,
  ...
  @override
  int get hashCode {
    return Object.hash(laterInFlow, noMatch, postAck, postPsh, postSyn);
  }

  @override
  String toString() {
    return 'RadarGetTcpResetsTimeoutsSummaryResponseResultSummary0(laterInFlow: $laterInFlow, noMatch: $noMatch, postAck: $postAck, postPsh: $postPsh, postSyn: $postSyn)';
  }
}
