...
final class DnsSettingsDirection {
  const DnsSettingsDirection._(this.value);

  factory DnsSettingsDirection.fromJson(String json) {
    return switch (json) {
      'asc' => asc,
      'desc' => desc,
  ...
  @override
  String toString() {
    return 'DnsSettingsDirection($value)';
  }
}
