...
import 'workers_ai_post_run_cf_deepgram_flux_request_encoding.dart';import 'workers_ai_post_run_cf_deepgram_flux_request_mip_opt_out.dart';final class WorkersAiPostRunCfDeepgramFluxRequest {const WorkersAiPostRunCfDeepgramFluxRequest({this.eagerEotThreshold, required this.encoding, this.eotThreshold = '0.7', this.eotTimeoutMs = '5000', this.keyterm, this.mipOptOut = WorkersAiPostRunCfDeepgramFluxRequestMipOptOut.$false, required this.sampleRate, this.tag, });
