...
final class ZeroTrustGatewayRules {
  const ZeroTrustGatewayRules({
  ...
  factory ZeroTrustGatewayRules.fromJson(Map<String, dynamic> json) {
    return ZeroTrustGatewayRules(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('action') &&
        ...
        json['traffic'] is String;
  }

  ZeroTrustGatewayRules copyWith({
    ...
    List<ZeroTrustGatewayFilters2>? filters,
    String Function()? id,
