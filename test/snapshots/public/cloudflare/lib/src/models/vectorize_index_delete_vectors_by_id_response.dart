...
import 'package:collection/collection.dart';final class VectorizeIndexDeleteVectorsByIdResponse {const VectorizeIndexDeleteVectorsByIdResponse({this.count, this.ids, });
...
VectorizeIndexDeleteVectorsByIdResponse copyWith({int Function()? count, List<String> Function()? ids, }) { return VectorizeIndexDeleteVectorsByIdResponse(
