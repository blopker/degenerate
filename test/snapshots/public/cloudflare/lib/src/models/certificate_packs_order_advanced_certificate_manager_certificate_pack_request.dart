...
import 'package:collection/collection.dart';import 'tls_certificates_and_hostnames_advanced_type.dart';import 'tls_certificates_and_hostnames_schemas_certificate_authority.dart';import 'tls_certificates_and_hostnames_validation_method.dart';final class CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest {const CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest({required this.certificateAuthority, this.cloudflareBranding, required this.hosts, required this.type, required this.validationMethod, required this.validityDays, });
...
CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest copyWith({TlsCertificatesAndHostnamesSchemasCertificateAuthority? certificateAuthority, bool Function()? cloudflareBranding, List<String>? hosts, TlsCertificatesAndHostnamesAdvancedType? type, TlsCertificatesAndHostnamesValidationMethod? validationMethod, int? validityDays, }) { return CertificatePacksOrderAdvancedCertificateManagerCertificatePackRequest(
