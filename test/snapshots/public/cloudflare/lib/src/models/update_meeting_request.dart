...
import 'realtimekit_ai_config.dart';import 'update_meeting_request_status.dart';final class UpdateMeetingRequest {const UpdateMeetingRequest({this.aiConfig, this.liveStreamOnStart = false, this.persistChat = false, this.recordOnStart = false, this.sessionKeepAliveTimeInSecs = 60.0, this.status, this.summarizeOnEnd = false, this.title, });
