...
import 'stream_access_rules.dart';

final class StreamSignedTokenRequest {
  const StreamSignedTokenRequest({
    this.accessRules,
  ...
  factory StreamSignedTokenRequest.fromJson(Map<String, dynamic> json) {
    return StreamSignedTokenRequest(
      accessRules: (json['accessRules'] as List<dynamic>?)
          ?.map((e) => StreamAccessRules.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Map<String, dynamic> toJson() {
    return {
      if (accessRules != null)
        'accessRules': accessRules?.map((e) => e.toJson()).toList(),
  ...
  StreamSignedTokenRequest copyWith({
    List<StreamAccessRules> Function()? accessRules,
    bool Function()? downloadable,
    int Function()? exp,
    String Function()? id,
    int Function()? nbf,
    String Function()? pem,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(accessRules ?? const []),
      downloadable,
      exp,
      id,
      nbf,
  ...
  @override
  String toString() {
    return 'StreamSignedTokenRequest(accessRules: $accessRules, downloadable: $downloadable, exp: $exp, id: $id, nbf: $nbf, pem: $pem)';
  }
}
