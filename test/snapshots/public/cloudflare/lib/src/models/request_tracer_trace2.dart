...
factory RequestTracerTrace2.fromJson(Map<String, dynamic> json) { return RequestTracerTrace2(
  ...
  actionParameters: (json['action_parameters'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
