...
final class PatchEventQueryUpdateRequest {
  const PatchEventQueryUpdateRequest({
    this.alertEnabled,
    this.alertRollupEnabled,
    this.name,
    this.queryJson,
    this.ruleEnabled,
    this.ruleScope,
  ...
  factory PatchEventQueryUpdateRequest.fromJson(Map<String, dynamic> json) {
    return PatchEventQueryUpdateRequest(
  ...
  PatchEventQueryUpdateRequest copyWith({
    bool Function()? alertEnabled,
    bool Function()? alertRollupEnabled,
    String Function()? name,
    String Function()? queryJson,
    bool Function()? ruleEnabled,
    String Function()? ruleScope,
  }) {
    return PatchEventQueryUpdateRequest(
      alertEnabled: alertEnabled != null ? alertEnabled() : this.alertEnabled,
      alertRollupEnabled: alertRollupEnabled != null
          ? alertRollupEnabled()
          : this.alertRollupEnabled,
  ...
  @override
  String toString() {
    return 'PatchEventQueryUpdateRequest(alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope)';
  }
}
