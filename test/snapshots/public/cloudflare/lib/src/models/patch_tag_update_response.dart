...
final class PatchTagUpdateResponse {
  const PatchTagUpdateResponse({
    this.activeDuration,
    this.actorCategory,
  ...
  factory PatchTagUpdateResponse.fromJson(Map<String, dynamic> json) {
    return PatchTagUpdateResponse(
      activeDuration: json['activeDuration'] as String?,
      actorCategory: json['actorCategory'] as String?,
      aliasGroupNames: (json['aliasGroupNames'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      aliasGroupNamesInternal:
          (json['aliasGroupNamesInternal'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      analyticPriority: json['analyticPriority'] != null
          ? (json['analyticPriority'] as num).toDouble()
          : null,
      ...
      externalReferenceLinks: (json['externalReferenceLinks'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  ...
  PatchTagUpdateResponse copyWith({
    String Function()? activeDuration,
    String Function()? actorCategory,
    List<String> Function()? aliasGroupNames,
    List<String> Function()? aliasGroupNamesInternal,
    double Function()? analyticPriority,
    String Function()? attributionConfidence,
    String Function()? attributionOrganization,
    String Function()? categoryName,
    String Function()? categoryUuid,
    List<String> Function()? externalReferenceLinks,
    String Function()? internalDescription,
    String Function()? motive,
    String Function()? opsecLevel,
    String Function()? originCountryIso,
    double Function()? priority,
    String Function()? sophisticationLevel,
    String? uuid,
    String? value,
  }) {
    return PatchTagUpdateResponse(
      activeDuration: activeDuration != null
          ? activeDuration()
          : this.activeDuration,
      actorCategory: actorCategory != null
          ? actorCategory()
          : this.actorCategory,
      aliasGroupNames: aliasGroupNames != null
          ? aliasGroupNames()
          : this.aliasGroupNames,
      aliasGroupNamesInternal: aliasGroupNamesInternal != null
          ? aliasGroupNamesInternal()
          : this.aliasGroupNamesInternal,
      analyticPriority: analyticPriority != null
          ? analyticPriority()
          : this.analyticPriority,
      attributionConfidence: attributionConfidence != null
          ? attributionConfidence()
          : this.attributionConfidence,
      attributionOrganization: attributionOrganization != null
      ...
      externalReferenceLinks: externalReferenceLinks != null
      ...
      originCountryIso: originCountryIso != null
          ? originCountryIso()
          : this.originCountryIso,
      priority: priority != null ? priority() : this.priority,
      sophisticationLevel: sophisticationLevel != null
          ? sophisticationLevel()
          : this.sophisticationLevel,
      uuid: uuid ?? this.uuid,
    ...
    return identical(this, other) ||
        other is PatchTagUpdateResponse &&
            ...
            const ListEquality<dynamic>().equals(
              aliasGroupNames,
              other.aliasGroupNames,
            ) &&
            const ListEquality<dynamic>().equals(
              aliasGroupNamesInternal,
              other.aliasGroupNamesInternal,
            ) &&
  ...
  int get hashCode {
    return Object.hash(
      activeDuration,
      actorCategory,
      Object.hashAll(aliasGroupNames ?? const []),
      Object.hashAll(aliasGroupNamesInternal ?? const []),
      analyticPriority,
      attributionConfidence,
      attributionOrganization,
      categoryName,
      categoryUuid,
      Object.hashAll(externalReferenceLinks ?? const []),
      internalDescription,
      motive,
      opsecLevel,
      originCountryIso,
