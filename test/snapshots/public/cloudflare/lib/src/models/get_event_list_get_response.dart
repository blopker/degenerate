...
final class GetEventListGetResponse {
  const GetEventListGetResponse({
  ...
  factory GetEventListGetResponse.fromJson(Map<String, dynamic> json) {
    return GetEventListGetResponse(
  ...
  GetEventListGetResponse copyWith({
    String? attacker,
