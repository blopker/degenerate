...
final class BandwidthByColo {
  const BandwidthByColo({this.all, this.cached, this.uncached});

  factory BandwidthByColo.fromJson(Map<String, dynamic> json) {
    return BandwidthByColo(
  ...
  Map<String, dynamic> toJson() {
    return {'all': ?all, 'cached': ?cached, 'uncached': ?uncached};
  }
  ...
  @override
  int get hashCode {
    return Object.hash(all, cached, uncached);
  }

  @override
  String toString() {
    return 'BandwidthByColo(all: $all, cached: $cached, uncached: $uncached)';
  }
}
