...
final class DosNewDnsProtectionRule {
  const DosNewDnsProtectionRule({
  ...
  factory DosNewDnsProtectionRule.fromJson(Map<String, dynamic> json) {
    return DosNewDnsProtectionRule(
  ...
  DosNewDnsProtectionRule copyWith({
  ...
  @override
  String toString() {
    return 'DosNewDnsProtectionRule(burstSensitivity: $burstSensitivity, mode: $mode, name: $name, profileSensitivity: $profileSensitivity, rateSensitivity: $rateSensitivity, scope: $scope)';
  }
}
