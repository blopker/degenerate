...
import 'stream_download_status.dart';final class StreamDownloads {const StreamDownloads({this.percentComplete, this.status, this.url, });

factory StreamDownloads.fromJson(Map<String, dynamic> json) { return StreamDownloads(
  percentComplete: json['percentComplete'] != null ? (json['percentComplete'] as num).toDouble() : null,
...
StreamDownloads copyWith({double Function()? percentComplete, StreamDownloadStatus Function()? status, Uri Function()? url, }) { return StreamDownloads(
