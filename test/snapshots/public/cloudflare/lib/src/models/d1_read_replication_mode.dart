...
final class D1ReadReplicationMode {
  const D1ReadReplicationMode._(this.value);

  factory D1ReadReplicationMode.fromJson(String json) {
    return switch (json) {
      'auto' => auto,
      'disabled' => disabled,
  ...
  static const D1ReadReplicationMode disabled = D1ReadReplicationMode._(
    'disabled',
  );
  ...
  @override
  String toString() {
    return 'D1ReadReplicationMode($value)';
  }
}
