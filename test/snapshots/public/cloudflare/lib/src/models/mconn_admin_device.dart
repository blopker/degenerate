...
final class MconnAdminDevice {
  const MconnAdminDevice({
  ...
  factory MconnAdminDevice.fromJson(Map<String, dynamic> json) {
    return MconnAdminDevice(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('crypt_key') &&
        json['crypt_key'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
  ...
  @override
  String toString() {
    return 'MconnAdminDevice(cryptKey: $cryptKey, cryptKeyRotationFinishedAt: $cryptKeyRotationFinishedAt, cryptKeyRotationOutput: $cryptKeyRotationOutput, cryptKeyRotationStartedAt: $cryptKeyRotationStartedAt, cryptKeyRotationStatusCode: $cryptKeyRotationStatusCode, deviceType: $deviceType, ekCert: $ekCert, id: $id, imagedAt: $imagedAt, lastCryptKey: $lastCryptKey, lastUpdated: $lastUpdated, metadata: $metadata, pkiRotationFinishedAt: $pkiRotationFinishedAt, pkiRotationOutput: $pkiRotationOutput, pkiRotationStartedAt: $pkiRotationStartedAt, pkiRotationStatusCode: $pkiRotationStatusCode, serialNumber: $serialNumber)';
  }
}
