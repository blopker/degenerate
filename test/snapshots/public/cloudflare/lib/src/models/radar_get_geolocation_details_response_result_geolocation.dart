...
import 'radar_get_geolocation_details_response_result_geolocation_parent.dart';import 'radar_get_geolocation_details_response_result_geolocation_type.dart';final class RadarGetGeolocationDetailsResponseResultGeolocation {const RadarGetGeolocationDetailsResponseResultGeolocation({this.code, required this.geoId, required this.latitude, required this.longitude, required this.name, required this.parent, required this.type, });
