...
final class R2ListBucketsDirection {
  const R2ListBucketsDirection._(this.value);

  factory R2ListBucketsDirection.fromJson(String json) {
    return switch (json) {
      'asc' => asc,
      'desc' => desc,
  ...
  @override
  String toString() {
    return 'R2ListBucketsDirection($value)';
  }
}
