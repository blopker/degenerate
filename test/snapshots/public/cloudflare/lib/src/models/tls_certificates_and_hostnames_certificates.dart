...
import 'package:collection/collection.dart';import 'tls_certificates_and_hostnames_request_type.dart';final class TlsCertificatesAndHostnamesCertificates {const TlsCertificatesAndHostnamesCertificates({this.certificate, required this.csr, this.expiresOn, required this.hostnames, this.id, required this.requestType, required this.requestedValidity, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('csr') && json['csr'] is String &&
      ...
      json.containsKey('requested_validity') && json['requested_validity'] is num; } 
TlsCertificatesAndHostnamesCertificates copyWith({String Function()? certificate, String? csr, String Function()? expiresOn, List<String>? hostnames, String Function()? id, TlsCertificatesAndHostnamesRequestType? requestType, double? requestedValidity, }) { return TlsCertificatesAndHostnamesCertificates(
