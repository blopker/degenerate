...
final class RealtimekitParticipantPeerStatsPeerStatsDeviceInfo {
  const RealtimekitParticipantPeerStatsPeerStatsDeviceInfo({
    this.browser,
    this.browserVersion,
    this.cpus,
    this.engine,
  ...
  factory RealtimekitParticipantPeerStatsPeerStatsDeviceInfo.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimekitParticipantPeerStatsPeerStatsDeviceInfo(
  ...
  RealtimekitParticipantPeerStatsPeerStatsDeviceInfo copyWith({
    String Function()? browser,
    String Function()? browserVersion,
    double Function()? cpus,
    String Function()? engine,
    bool Function()? isMobile,
    double Function()? memory,
    String Function()? os,
  ...
  @override
  String toString() {
    return 'RealtimekitParticipantPeerStatsPeerStatsDeviceInfo(browser: $browser, browserVersion: $browserVersion, cpus: $cpus, engine: $engine, isMobile: $isMobile, memory: $memory, os: $os, osVersion: $osVersion, sdkName: $sdkName, sdkVersion: $sdkVersion, userAgent: $userAgent, webglSupport: $webglSupport)';
  }
}
