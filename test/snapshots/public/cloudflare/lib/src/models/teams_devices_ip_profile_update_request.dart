...
final class TeamsDevicesIpProfileUpdateRequest {const TeamsDevicesIpProfileUpdateRequest({this.description, this.enabled, this.match, this.name, this.precedence, this.subnetId, });
...
TeamsDevicesIpProfileUpdateRequest copyWith({String Function()? description, bool Function()? enabled, String Function()? match, String Function()? name, int Function()? precedence, String Function()? subnetId, }) { return TeamsDevicesIpProfileUpdateRequest(
