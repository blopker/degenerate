...
final class ZonesImageResizingValue {
  const ZonesImageResizingValue._(this.value);

  factory ZonesImageResizingValue.fromJson(String json) {
    return switch (json) {
      'on' => $on,
      'off' => off,
      'open' => open,
  ...
  @override
  String toString() {
    return 'ZonesImageResizingValue($value)';
  }
}
