...
import 'email_security_mailsearch_message_findings.dart';
import 'email_security_mailsearch_message_post_delivery_operations.dart';
import 'email_security_mailsearch_message_properties.dart';
import 'email_security_mailsearch_message_validation.dart';
import 'email_security_message_delivery_mode.dart';

final class EmailSecurityMailsearchMessage {
  const EmailSecurityMailsearchMessage({
    ...
    this.messageId,
    this.postDeliveryOperations,
    required this.postfixId,
    this.postfixIdOutbound,
  ...
  factory EmailSecurityMailsearchMessage.fromJson(Map<String, dynamic> json) {
    return EmailSecurityMailsearchMessage(
      actionLog: json['action_log'] as String,
      alertId: json['alert_id'] as String?,
      clientRecipients: (json['client_recipients'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      deliveryMode: json['delivery_mode'] != null
          ? EmailSecurityMessageDeliveryMode.fromJson(
              json['delivery_mode'] as String,
            )
          : null,
      detectionReasons: (json['detection_reasons'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      edfHash: json['edf_hash'] as String?,
      envelopeFrom: json['envelope_from'] as String?,
      envelopeTo: (json['envelope_to'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      finalDisposition: json['final_disposition'] != null
          ? EmailSecurityDispositionLabel.fromJson(
              json['final_disposition'] as String,
            )
          : null,
      findings: (json['findings'] as List<dynamic>?)
          ?.map(
            (e) => EmailSecurityMailsearchMessageFindings.fromJson(
      ...
      postDeliveryOperations: (json['post_delivery_operations'] as List<dynamic>?)
          ?.map(
            (e) =>
                EmailSecurityMailsearchMessagePostDeliveryOperations.fromJson(
                  e as String,
                ),
          )
          .toList(),
      ...
      properties: EmailSecurityMailsearchMessageProperties.fromJson(
      ...
      toName: (json['to_name'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      ts: json['ts'] as String,
      validation: json['validation'] != null
          ? EmailSecurityMailsearchMessageValidation.fromJson(
  ...
  final List<EmailSecurityMailsearchMessagePostDeliveryOperations>?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (postDeliveryOperations != null)
        'post_delivery_operations': postDeliveryOperations
            ?.map((e) => e.toJson())
            .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('action_log') &&
        json['action_log'] is String &&
        json.containsKey('client_recipients') &&
        json.containsKey('detection_reasons') &&
        json.containsKey('is_phish_submission') &&
        json['is_phish_submission'] is bool &&
        json.containsKey('is_quarantined') &&
        json['is_quarantined'] is bool &&
        json.containsKey('postfix_id') &&
        json['postfix_id'] is String &&
  ...
  EmailSecurityMailsearchMessage copyWith({
    String? actionLog,
    String? Function()? alertId,
    List<String>? clientRecipients,
    EmailSecurityMessageDeliveryMode? Function()? deliveryMode,
    List<String>? detectionReasons,
    String? Function()? edfHash,
    String? Function()? envelopeFrom,
    List<String>? Function()? envelopeTo,
    EmailSecurityDispositionLabel? Function()? finalDisposition,
    List<EmailSecurityMailsearchMessageFindings>? Function()? findings,
    String? Function()? from,
    String? Function()? fromName,
    String? Function()? htmltextStructureHash,
    bool? isPhishSubmission,
    bool? isQuarantined,
    String? Function()? messageId,
    List<EmailSecurityMailsearchMessagePostDeliveryOperations> Function()?
    postDeliveryOperations,
    String? postfixId,
    String? Function()? postfixIdOutbound,
    EmailSecurityMailsearchMessageProperties? properties,
    String? Function()? replyto,
    String? Function()? sentDate,
    String? Function()? subject,
    List<String>? Function()? threatCategories,
    List<String>? Function()? to,
    List<String>? Function()? toName,
    String? ts,
    EmailSecurityMailsearchMessageValidation? Function()? validation,
    String? id,
  }) {
    return EmailSecurityMailsearchMessage(
      ...
      htmltextStructureHash: htmltextStructureHash != null
      ...
      postDeliveryOperations: postDeliveryOperations != null
          ? postDeliveryOperations()
          : this.postDeliveryOperations,
      postfixId: postfixId ?? this.postfixId,
      postfixIdOutbound: postfixIdOutbound != null
          ? postfixIdOutbound()
          : this.postfixIdOutbound,
      ...
      threatCategories: threatCategories != null
          ? threatCategories()
          : this.threatCategories,
    ...
    return identical(this, other) ||
        other is EmailSecurityMailsearchMessage &&
            ...
            const ListEquality<dynamic>().equals(
              clientRecipients,
              other.clientRecipients,
            ) &&
            deliveryMode == other.deliveryMode &&
            const ListEquality<dynamic>().equals(
              detectionReasons,
              other.detectionReasons,
            ) &&
            ...
            const ListEquality<dynamic>().equals(findings, other.findings) &&
            from == other.from &&
            ...
            const ListEquality<dynamic>().equals(
              threatCategories,
              other.threatCategories,
            ) &&
            const ListEquality<dynamic>().equals(to, other.to) &&
            const ListEquality<dynamic>().equals(toName, other.toName) &&
            ts == other.ts &&
  ...
  int get hashCode {
    return Object.hashAll([
      actionLog,
      alertId,
      Object.hashAll(clientRecipients),
      deliveryMode,
      Object.hashAll(detectionReasons),
      edfHash,
      envelopeFrom,
      Object.hashAll(envelopeTo ?? const []),
      finalDisposition,
      Object.hashAll(findings ?? const []),
      from,
      fromName,
      htmltextStructureHash,
      isPhishSubmission,
      isQuarantined,
      messageId,
      Object.hashAll(postDeliveryOperations ?? const []),
      postfixId,
      postfixIdOutbound,
      properties,
      replyto,
      sentDate,
      subject,
      Object.hashAll(threatCategories ?? const []),
      Object.hashAll(to ?? const []),
      Object.hashAll(toName ?? const []),
      ts,
      validation,
      id,
    ]);
