...
final class BuildsTriggerResponse {
  const BuildsTriggerResponse({
    this.branchExcludes,
    this.branchIncludes,
  ...
  factory BuildsTriggerResponse.fromJson(Map<String, dynamic> json) {
    return BuildsTriggerResponse(
  ...
  BuildsTriggerResponse copyWith({
