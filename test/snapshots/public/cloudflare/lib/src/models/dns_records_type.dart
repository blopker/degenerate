...
/// Record type.
final class DnsRecordsType {
  const DnsRecordsType._(this.value);

  factory DnsRecordsType.fromJson(String json) {
    return switch (json) {
      'A' => a,
      'AAAA' => aaaa,
      'CAA' => caa,
  ...
  static const List<DnsRecordsType> values = [
    a,
    aaaa,
    caa,
    cert,
