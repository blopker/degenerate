...
final class RatePlan2 {
  ...
  factory RatePlan2.fromJson(Map<String, dynamic> json) {
    return RatePlan2(
  ...
  RatePlan2 copyWith({
    ...
    String Function()? id,
    bool Function()? isContract,
    String Function()? publicName,
    String Function()? scope,
    List<String> Function()? sets,
  }) {
    return RatePlan2(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RatePlan2 &&
            ...
            scope == other.scope &&
            const ListEquality<dynamic>().equals(sets, other.sets);
  }
  ...
  int get hashCode {
    return Object.hash(
      ...
      publicName,
      scope,
      Object.hashAll(sets ?? const []),
    );
  }

  @override
  String toString() {
    return 'RatePlan2(currency: $currency, externallyManaged: $externallyManaged, id: $id, isContract: $isContract, publicName: $publicName, scope: $scope, sets: $sets)';
  }
}
