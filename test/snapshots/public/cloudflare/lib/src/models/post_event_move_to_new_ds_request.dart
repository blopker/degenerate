...
import 'package:collection/collection.dart';final class PostEventMoveToNewDsRequest {const PostEventMoveToNewDsRequest({required this.destDatasetId, this.eventIds, });
