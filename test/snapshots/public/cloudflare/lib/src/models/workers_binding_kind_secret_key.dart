...
import 'package:collection/collection.dart';import 'workers_binding_kind_secret_key_format.dart';import 'workers_binding_kind_secret_key_usages.dart';final class WorkersBindingKindSecretKey {const WorkersBindingKindSecretKey({required this.algorithm, required this.format, this.keyBase64, this.keyJwk, required this.name, required this.type, required this.usages, });
...
WorkersBindingKindSecretKey copyWith({Map<String,String>? algorithm, WorkersBindingKindSecretKeyFormat? format, String Function()? keyBase64, Map<String, String> Function()? keyJwk, String? name, String? type, List<WorkersBindingKindSecretKeyUsages>? usages, }) { return WorkersBindingKindSecretKey(
