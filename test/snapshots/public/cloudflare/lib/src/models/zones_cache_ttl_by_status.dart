...
import 'zones_cache_ttl_by_status_id.dart';

final class ZonesCacheTtlByStatus {
  const ZonesCacheTtlByStatus({this.id, this.value});

  factory ZonesCacheTtlByStatus.fromJson(Map<String, dynamic> json) {
    return ZonesCacheTtlByStatus(
      id: json['id'] != null
          ? ZonesCacheTtlByStatusId.fromJson(json['id'] as String)
          : null,
  ...
  ZonesCacheTtlByStatus copyWith({
    ZonesCacheTtlByStatusId Function()? id,
    Map<String, InlineObject185> Function()? value,
  }) {
    return ZonesCacheTtlByStatus(
  ...
  @override
  String toString() {
    return 'ZonesCacheTtlByStatus(id: $id, value: $value)';
  }
}
