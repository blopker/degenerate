...
final class RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0 {
  const RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0({
  ...
  factory RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('BrandImpersonation') &&
        json['BrandImpersonation'] is String &&
        json.containsKey('CredentialHarvester') &&
        json['CredentialHarvester'] is String &&
        json.containsKey('IdentityDeception') &&
        json['IdentityDeception'] is String &&
        json.containsKey('Link') &&
        json['Link'] is String;
  }

  RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0 copyWith({
    String? brandImpersonation,
    String? credentialHarvester,
    String? identityDeception,
    String? link,
  }) {
    return RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0(
  ...
  @override
  String toString() {
    return 'RadarGetEmailSecuritySummaryByThreatCategoryResponseResultSummary0(brandImpersonation: $brandImpersonation, credentialHarvester: $credentialHarvester, identityDeception: $identityDeception, link: $link)';
  }
}
