...
import 'shield_credentials_jwt_key_ec_common_kty.dart';final class ShieldCredentialsJwtKeyEcCommon {const ShieldCredentialsJwtKeyEcCommon({required this.kty, required this.x, required this.y, });
