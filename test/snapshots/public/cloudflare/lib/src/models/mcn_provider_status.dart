...
import 'mcn_cloud_platform_client.dart';
import 'mcn_provider_discovery_progress.dart';
import 'mcn_provider_discovery_status.dart';

final class McnProviderStatus {
  const McnProviderStatus({
  ...
  factory McnProviderStatus.fromJson(Map<String, dynamic> json) {
    return McnProviderStatus(
      ...
      discoveryProgress: McnProviderDiscoveryProgress.fromJson(
        json['discovery_progress'] as Map<String, dynamic>,
      ),
      discoveryProgressV2: McnProviderDiscoveryProgress.fromJson(
        json['discovery_progress_v2'] as Map<String, dynamic>,
      ),
      inUseBy: (json['in_use_by'] as List<dynamic>?)
          ?.map(
            (e) => McnCloudPlatformClient.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      lastDiscoveryCompletedAt: json['last_discovery_completed_at'] as String?,
      lastDiscoveryCompletedAtV2:
          json['last_discovery_completed_at_v2'] as String?,
      ...
      lastDiscoveryStatus: McnProviderDiscoveryStatus.fromJson(
        json['last_discovery_status'] as String,
      ),
      lastDiscoveryStatusV2: McnProviderDiscoveryStatus.fromJson(
        json['last_discovery_status_v2'] as String,
      ),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (inUseBy != null)
        'in_use_by': inUseBy?.map((e) => e.toJson()).toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('discovery_progress') &&
  ...
  McnProviderStatus copyWith({
    String Function()? credentialsGoodSince,
    String Function()? credentialsMissingSince,
    String Function()? credentialsRejectedSince,
    String Function()? discoveryMessage,
    String Function()? discoveryMessageV2,
    McnProviderDiscoveryProgress? discoveryProgress,
    McnProviderDiscoveryProgress? discoveryProgressV2,
    List<McnCloudPlatformClient> Function()? inUseBy,
    String Function()? lastDiscoveryCompletedAt,
    String Function()? lastDiscoveryCompletedAtV2,
    String Function()? lastDiscoveryStartedAt,
    String Function()? lastDiscoveryStartedAtV2,
    McnProviderDiscoveryStatus? lastDiscoveryStatus,
    McnProviderDiscoveryStatus? lastDiscoveryStatusV2,
    String Function()? lastUpdated,
    List<String>? regions,
  }) {
    return McnProviderStatus(
      credentialsGoodSince: credentialsGoodSince != null
          ? credentialsGoodSince()
          : this.credentialsGoodSince,
      credentialsMissingSince: credentialsMissingSince != null
          ? credentialsMissingSince()
          : this.credentialsMissingSince,
      credentialsRejectedSince: credentialsRejectedSince != null
          ? credentialsRejectedSince()
          : this.credentialsRejectedSince,
      discoveryMessage: discoveryMessage != null
          ? discoveryMessage()
          : this.discoveryMessage,
      discoveryMessageV2: discoveryMessageV2 != null
          ? discoveryMessageV2()
          : this.discoveryMessageV2,
      ...
      lastDiscoveryCompletedAt: lastDiscoveryCompletedAt != null
          ? lastDiscoveryCompletedAt()
          : this.lastDiscoveryCompletedAt,
      lastDiscoveryCompletedAtV2: lastDiscoveryCompletedAtV2 != null
          ? lastDiscoveryCompletedAtV2()
          : this.lastDiscoveryCompletedAtV2,
      lastDiscoveryStartedAt: lastDiscoveryStartedAt != null
          ? lastDiscoveryStartedAt()
          : this.lastDiscoveryStartedAt,
      lastDiscoveryStartedAtV2: lastDiscoveryStartedAtV2 != null
          ? lastDiscoveryStartedAtV2()
          : this.lastDiscoveryStartedAtV2,
      lastDiscoveryStatus: lastDiscoveryStatus ?? this.lastDiscoveryStatus,
      lastDiscoveryStatusV2:
          lastDiscoveryStatusV2 ?? this.lastDiscoveryStatusV2,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is McnProviderStatus &&
            ...
            const ListEquality<dynamic>().equals(inUseBy, other.inUseBy) &&
