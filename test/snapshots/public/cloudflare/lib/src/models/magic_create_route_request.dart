...
import 'magic_scope.dart';final class MagicCreateRouteRequest {const MagicCreateRouteRequest({this.description, required this.nexthop, required this.prefix, required this.priority, this.scope, this.weight, });
...
MagicCreateRouteRequest copyWith({String Function()? description, String? nexthop, String? prefix, int? priority, MagicScope Function()? scope, int Function()? weight, }) { return MagicCreateRouteRequest(
