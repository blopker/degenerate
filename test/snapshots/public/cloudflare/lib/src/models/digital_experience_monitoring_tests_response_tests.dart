...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_tests_response_tests_http_results.dart';import 'digital_experience_monitoring_tests_response_tests_http_results_by_colo.dart';import 'digital_experience_monitoring_tests_response_tests_kind.dart';import 'digital_experience_monitoring_tests_response_tests_target_policies.dart';import 'digital_experience_monitoring_tests_response_tests_traceroute_results.dart';import 'digital_experience_monitoring_tests_response_tests_traceroute_results_by_colo.dart';final class DigitalExperienceMonitoringTestsResponseTests {const DigitalExperienceMonitoringTestsResponseTests({required this.created, required this.description, required this.enabled, required this.host, this.httpResults, this.httpResultsByColo, required this.id, required this.interval, required this.kind, this.method, required this.name, this.targetPolicies, this.targeted, this.tracerouteResults, this.tracerouteResultsByColo, required this.updated, });
...
DigitalExperienceMonitoringTestsResponseTests copyWith({String? created, String? description, bool? enabled, String? host, DigitalExperienceMonitoringTestsResponseTestsHttpResults? Function()? httpResults, List<DigitalExperienceMonitoringTestsResponseTestsHttpResultsByColo> Function()? httpResultsByColo, String? id, String? interval, DigitalExperienceMonitoringTestsResponseTestsKind? kind, String Function()? method, String? name, List<DigitalExperienceMonitoringTestsResponseTestsTargetPolicies>? Function()? targetPolicies, bool Function()? targeted, DigitalExperienceMonitoringTestsResponseTestsTracerouteResults? Function()? tracerouteResults, List<DigitalExperienceMonitoringTestsResponseTestsTracerouteResultsByColo> Function()? tracerouteResultsByColo, String? updated, }) { return DigitalExperienceMonitoringTestsResponseTests(
