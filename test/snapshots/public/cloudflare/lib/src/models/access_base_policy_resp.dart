...
import 'package:collection/collection.dart';import 'access_decision.dart';import 'access_rule.dart';final class AccessBasePolicyResp {const AccessBasePolicyResp({this.createdAt, this.decision, this.exclude, this.id, this.include, this.name, this.require, this.updatedAt, });
...
AccessBasePolicyResp copyWith({DateTime Function()? createdAt, AccessDecision Function()? decision, List<AccessRule> Function()? exclude, String Function()? id, List<AccessRule> Function()? include, String Function()? name, List<AccessRule> Function()? require, DateTime Function()? updatedAt, }) { return AccessBasePolicyResp(
