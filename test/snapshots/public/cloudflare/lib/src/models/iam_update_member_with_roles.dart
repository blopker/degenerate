...
import 'package:collection/collection.dart';import 'iam_role.dart';import 'iam_update_member_with_roles_user.dart';final class IamUpdateMemberWithRoles {const IamUpdateMemberWithRoles({this.id, this.roles, this.status, this.user, });
...
IamUpdateMemberWithRoles copyWith({String Function()? id, List<IamRole> Function()? roles, String Function()? status, IamUpdateMemberWithRolesUser Function()? user, }) { return IamUpdateMemberWithRoles(
