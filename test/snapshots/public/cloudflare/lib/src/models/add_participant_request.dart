...
final class AddParticipantRequest {
  const AddParticipantRequest({
    ...
    this.name,
    this.picture,
    this.presetName = 'group_call_host',
  });
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('custom_participant_id') &&
  ...
  @override
  int get hashCode {
    return Object.hash(customParticipantId, name, picture, presetName);
  }

  @override
  String toString() {
    return 'AddParticipantRequest(customParticipantId: $customParticipantId, name: $name, picture: $picture, presetName: $presetName)';
  }
}
