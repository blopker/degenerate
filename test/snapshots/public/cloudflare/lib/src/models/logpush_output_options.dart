...
import 'logpush_output_options_output_type.dart';
import 'logpush_output_options_timestamp_format.dart';

/// The structured replacement for `logpull_options`. When including this field, the `logpull_option` field will be ignored.
final class LogpushOutputOptions {
  const LogpushOutputOptions({
    this.cve202144228,
    this.batchPrefix,
    this.batchSuffix,
    this.fieldDelimiter,
  ...
  factory LogpushOutputOptions.fromJson(Map<String, dynamic> json) {
    return LogpushOutputOptions(
      ...
      fieldNames: (json['field_names'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      outputType: json['output_type'] != null
          ? LogpushOutputOptionsOutputType.fromJson(
              json['output_type'] as String,
            )
          : null,
      ...
      sampleRate: json['sample_rate'] != null
          ...
          : null,
      timestampFormat: json['timestamp_format'] != null
          ? LogpushOutputOptionsTimestampFormat.fromJson(
              json['timestamp_format'] as String,
            )
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (timestampFormat != null)
        'timestamp_format': timestampFormat?.toJson(),
    };
  }
  ...
  LogpushOutputOptions copyWith({
    bool? Function()? cve202144228,
    String? Function()? batchPrefix,
    String? Function()? batchSuffix,
    String? Function()? fieldDelimiter,
    List<String> Function()? fieldNames,
    LogpushOutputOptionsOutputType Function()? outputType,
    String? Function()? recordDelimiter,
    String? Function()? recordPrefix,
    String? Function()? recordSuffix,
    String? Function()? recordTemplate,
    double? Function()? sampleRate,
    LogpushOutputOptionsTimestampFormat Function()? timestampFormat,
  }) {
    return LogpushOutputOptions(
  ...
  int get hashCode {
    return Object.hash(
      ...
      batchSuffix,
      fieldDelimiter,
      Object.hashAll(fieldNames ?? const []),
      outputType,
      recordDelimiter,
      recordPrefix,
      recordSuffix,
