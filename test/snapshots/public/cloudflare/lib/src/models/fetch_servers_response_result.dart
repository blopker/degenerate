...
import 'fetch_servers_response_result_auth_type.dart';

final class FetchServersResponseResult {
  const FetchServersResponseResult({
  ...
  factory FetchServersResponseResult.fromJson(Map<String, dynamic> json) {
    return FetchServersResponseResult(
      authType: FetchServersResponseResultAuthType.fromJson(
  ...
  FetchServersResponseResult copyWith({
    FetchServersResponseResultAuthType? authType,
  ...
  @override
  String toString() {
    return 'FetchServersResponseResult(authType: $authType, createdAt: $createdAt, createdBy: $createdBy, description: $description, error: $error, hostname: $hostname, id: $id, lastSuccessfulSync: $lastSuccessfulSync, lastSynced: $lastSynced, modifiedAt: $modifiedAt, modifiedBy: $modifiedBy, name: $name, prompts: $prompts, status: $status, tools: $tools)';
  }
}
