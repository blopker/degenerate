...
final class ZonesMinTlsVersionValue {
  const ZonesMinTlsVersionValue._(this.value);

  factory ZonesMinTlsVersionValue.fromJson(String json) {
    return switch (json) {
      '1.0' => $10,
      '1.1' => $11,
      '1.2' => $12,
  ...
  @override
  String toString() {
    return 'ZonesMinTlsVersionValue($value)';
  }
}
