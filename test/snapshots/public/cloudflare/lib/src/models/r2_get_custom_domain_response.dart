...
import 'package:collection/collection.dart';import 'r2_get_custom_domain_response_min_tls.dart';import 'r2_get_custom_domain_response_status.dart';final class R2GetCustomDomainResponse {const R2GetCustomDomainResponse({this.ciphers, required this.domain, required this.enabled, this.minTls, required this.status, this.zoneId, this.zoneName, });
