...
import 'package:collection/collection.dart';import 'zones_actions2.dart';import 'zones_status.dart';import 'zones_target.dart';final class PageRulesEditAPageRuleRequest {const PageRulesEditAPageRuleRequest({this.actions, this.priority, this.status, this.targets, });
...
PageRulesEditAPageRuleRequest copyWith({List<ZonesActions2> Function()? actions, int Function()? priority, ZonesStatus Function()? status, List<ZonesTarget> Function()? targets, }) { return PageRulesEditAPageRuleRequest(
