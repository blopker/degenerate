...
import 'iam_sso_connector_verification_info.dart';final class IamSsoConnector {const IamSsoConnector({this.createdOn, this.emailDomain, this.enabled, this.id, this.updatedOn, this.useFedrampLanguage, this.verification, });
...
IamSsoConnector copyWith({DateTime Function()? createdOn, String Function()? emailDomain, bool Function()? enabled, String Function()? id, DateTime Function()? updatedOn, bool Function()? useFedrampLanguage, IamSsoConnectorVerificationInfo Function()? verification, }) { return IamSsoConnector(
