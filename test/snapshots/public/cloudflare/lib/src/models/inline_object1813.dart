...
final class InlineObject1813 {
  const InlineObject1813({
  ...
  factory InlineObject1813.fromJson(Map<String, dynamic> json) {
    return InlineObject1813(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('gt_3d_lte_16d') &&
        json['gt_3d_lte_16d'] is String &&
        json.containsKey('gt_16d_lte_31d') &&
        json['gt_16d_lte_31d'] is String &&
        json.containsKey('gt_31d_lte_91d') &&
        json['gt_31d_lte_91d'] is String &&
        json.containsKey('gt_91d_lte_121d') &&
        json['gt_91d_lte_121d'] is String &&
        json.containsKey('gt_121d') &&
        json['gt_121d'] is String &&
        json.containsKey('lte_3d') &&
        json['lte_3d'] is String;
  }

  InlineObject1813 copyWith({
    String? gt3dLte16d,
    String? gt16dLte31d,
    String? gt31dLte91d,
    String? gt91dLte121d,
  ...
  @override
  String toString() {
    return 'InlineObject1813(gt3dLte16d: $gt3dLte16d, gt16dLte31d: $gt16dLte31d, gt31dLte91d: $gt31dLte91d, gt91dLte121d: $gt91dLte121d, gt121d: $gt121d, lte3d: $lte3d)';
  }
}
