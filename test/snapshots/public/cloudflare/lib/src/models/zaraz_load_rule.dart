...
import 'zaraz_load_rule_op.dart';final class ZarazLoadRule {const ZarazLoadRule({required this.id, required this.match, required this.op, required this.value, });
