...
final class RadarGetAsnsAsSetResponseResultAsSets {
  const RadarGetAsnsAsSetResponseResultAsSets({
  ...
  factory RadarGetAsnsAsSetResponseResultAsSets.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetAsnsAsSetResponseResultAsSets(
      ...
      hierarchicalAsn: json['hierarchical_asn'] != null
          ? (json['hierarchical_asn'] as num).toInt()
          : null,
      inferredAsn: json['inferred_asn'] != null
          ? (json['inferred_asn'] as num).toInt()
          : null,
      irrSources: (json['irr_sources'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      name: json['name'] as String,
      peeringdbAsn: json['peeringdb_asn'] != null
          ? (json['peeringdb_asn'] as num).toInt()
          : null,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('as_members_count') &&
        json['as_members_count'] is num &&
        json.containsKey('as_set_members_count') &&
        json['as_set_members_count'] is num &&
        json.containsKey('as_set_upstreams_count') &&
        json['as_set_upstreams_count'] is num &&
        json.containsKey('asn_cone_size') &&
        json['asn_cone_size'] is num &&
        json.containsKey('irr_sources') &&
        json.containsKey('name') &&
        json['name'] is String;
  }

  RadarGetAsnsAsSetResponseResultAsSets copyWith({
    int? asMembersCount,
    int? asSetMembersCount,
    int? asSetUpstreamsCount,
    int? asnConeSize,
    int Function()? hierarchicalAsn,
    int Function()? inferredAsn,
    List<String>? irrSources,
    String? name,
    int Function()? peeringdbAsn,
  }) {
    return RadarGetAsnsAsSetResponseResultAsSets(
      ...
      hierarchicalAsn: hierarchicalAsn != null
          ? hierarchicalAsn()
          : this.hierarchicalAsn,
  ...
  @override
  String toString() {
    return 'RadarGetAsnsAsSetResponseResultAsSets(asMembersCount: $asMembersCount, asSetMembersCount: $asSetMembersCount, asSetUpstreamsCount: $asSetUpstreamsCount, asnConeSize: $asnConeSize, hierarchicalAsn: $hierarchicalAsn, inferredAsn: $inferredAsn, irrSources: $irrSources, name: $name, peeringdbAsn: $peeringdbAsn)';
  }
}
