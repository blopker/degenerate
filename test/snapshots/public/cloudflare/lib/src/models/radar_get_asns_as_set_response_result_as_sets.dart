...
import 'package:collection/collection.dart';final class RadarGetAsnsAsSetResponseResultAsSets {const RadarGetAsnsAsSetResponseResultAsSets({required this.asMembersCount, required this.asSetMembersCount, required this.asSetUpstreamsCount, required this.asnConeSize, this.hierarchicalAsn, this.inferredAsn, required this.irrSources, required this.name, this.peeringdbAsn, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetAsnsAsSetResponseResultAsSets &&
          ...
          const ListEquality<dynamic>().equals(irrSources, other.irrSources) &&
          name == other.name &&
