...
final class PayPerCrawlResultInfo {
  const PayPerCrawlResultInfo({
    this.count,
    this.page,
    this.perPage,
    this.totalCount,
  ...
  factory PayPerCrawlResultInfo.fromJson(Map<String, dynamic> json) {
    return PayPerCrawlResultInfo(
  ...
  PayPerCrawlResultInfo copyWith({
    int Function()? count,
    int Function()? page,
  ...
  @override
  String toString() {
    return 'PayPerCrawlResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount, totalPages: $totalPages)';
  }
}
