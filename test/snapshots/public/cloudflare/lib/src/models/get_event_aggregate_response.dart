...
import 'get_event_aggregate_response_aggregations.dart';
import 'get_event_aggregate_response_date_range.dart';

final class GetEventAggregateResponse {
  const GetEventAggregateResponse({
  ...
  factory GetEventAggregateResponse.fromJson(Map<String, dynamic> json) {
    return GetEventAggregateResponse(
      aggregateBy: json['aggregateBy'] as String,
      aggregations: (json['aggregations'] as List<dynamic>)
          .map(
            (e) => GetEventAggregateResponseAggregations.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      dateRange: json['dateRange'] != null
          ? GetEventAggregateResponseDateRange.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('aggregateBy') &&
        json['aggregateBy'] is String &&
        json.containsKey('aggregations') &&
        json.containsKey('total') &&
        json['total'] is num;
  }

  GetEventAggregateResponse copyWith({
    String? aggregateBy,
    List<GetEventAggregateResponseAggregations>? aggregations,
    GetEventAggregateResponseDateRange Function()? dateRange,
    double? total,
  }) {
    return GetEventAggregateResponse(
  ...
  @override
  String toString() {
    return 'GetEventAggregateResponse(aggregateBy: $aggregateBy, aggregations: $aggregations, dateRange: $dateRange, total: $total)';
  }
}
