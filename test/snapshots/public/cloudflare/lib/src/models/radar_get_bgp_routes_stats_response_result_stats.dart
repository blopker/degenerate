...
final class RadarGetBgpRoutesStatsResponseResultStats {
  const RadarGetBgpRoutesStatsResponseResultStats({
    required this.distinctOrigins,
    required this.distinctOriginsIpv4,
    required this.distinctOriginsIpv6,
    required this.distinctPrefixes,
    required this.distinctPrefixesIpv4,
    required this.distinctPrefixesIpv6,
    required this.routesInvalid,
    required this.routesInvalidIpv4,
    required this.routesInvalidIpv6,
    required this.routesTotal,
    required this.routesTotalIpv4,
    required this.routesTotalIpv6,
    required this.routesUnknown,
    required this.routesUnknownIpv4,
    required this.routesUnknownIpv6,
    required this.routesValid,
    required this.routesValidIpv4,
    required this.routesValidIpv6,
  });

  factory RadarGetBgpRoutesStatsResponseResultStats.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetBgpRoutesStatsResponseResultStats(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('distinct_origins') &&
        json['distinct_origins'] is num &&
        json.containsKey('distinct_origins_ipv4') &&
        json['distinct_origins_ipv4'] is num &&
        json.containsKey('distinct_origins_ipv6') &&
        json['distinct_origins_ipv6'] is num &&
        json.containsKey('distinct_prefixes') &&
        json['distinct_prefixes'] is num &&
        json.containsKey('distinct_prefixes_ipv4') &&
        json['distinct_prefixes_ipv4'] is num &&
        json.containsKey('distinct_prefixes_ipv6') &&
        json['distinct_prefixes_ipv6'] is num &&
        json.containsKey('routes_invalid') &&
        json['routes_invalid'] is num &&
        json.containsKey('routes_invalid_ipv4') &&
        json['routes_invalid_ipv4'] is num &&
        json.containsKey('routes_invalid_ipv6') &&
        json['routes_invalid_ipv6'] is num &&
        json.containsKey('routes_total') &&
        json['routes_total'] is num &&
        json.containsKey('routes_total_ipv4') &&
        json['routes_total_ipv4'] is num &&
        json.containsKey('routes_total_ipv6') &&
        json['routes_total_ipv6'] is num &&
        json.containsKey('routes_unknown') &&
        json['routes_unknown'] is num &&
        json.containsKey('routes_unknown_ipv4') &&
        json['routes_unknown_ipv4'] is num &&
        json.containsKey('routes_unknown_ipv6') &&
        json['routes_unknown_ipv6'] is num &&
        json.containsKey('routes_valid') &&
        json['routes_valid'] is num &&
        json.containsKey('routes_valid_ipv4') &&
        json['routes_valid_ipv4'] is num &&
        json.containsKey('routes_valid_ipv6') &&
        json['routes_valid_ipv6'] is num;
  }

  RadarGetBgpRoutesStatsResponseResultStats copyWith({
    int? distinctOrigins,
    int? distinctOriginsIpv4,
    int? distinctOriginsIpv6,
    int? distinctPrefixes,
    int? distinctPrefixesIpv4,
    int? distinctPrefixesIpv6,
    int? routesInvalid,
    int? routesInvalidIpv4,
    int? routesInvalidIpv6,
    int? routesTotal,
    int? routesTotalIpv4,
    int? routesTotalIpv6,
    int? routesUnknown,
    int? routesUnknownIpv4,
    int? routesUnknownIpv6,
    int? routesValid,
    int? routesValidIpv4,
    int? routesValidIpv6,
  }) {
