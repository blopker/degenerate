...
AccountsGetAccountProfileResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, Profile? result, bool? success, }) { return AccountsGetAccountProfileResponse(
