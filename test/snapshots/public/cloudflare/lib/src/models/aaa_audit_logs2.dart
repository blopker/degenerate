...
import 'aaa_audit_logs2_account.dart';import 'aaa_audit_logs2_action.dart';import 'aaa_audit_logs2_actor.dart';import 'aaa_audit_logs2_raw.dart';import 'aaa_audit_logs2_resource.dart';import 'aaa_audit_logs2_zone.dart';final class AaaAuditLogs2 {const AaaAuditLogs2({this.account, this.action, this.actor, this.id, this.raw, this.resource, this.zone, });
...
AaaAuditLogs2 copyWith({AaaAuditLogs2Account Function()? account, AaaAuditLogs2Action Function()? action, AaaAuditLogs2Actor Function()? actor, String Function()? id, AaaAuditLogs2Raw Function()? raw, AaaAuditLogs2Resource Function()? resource, AaaAuditLogs2Zone Function()? zone, }) { return AaaAuditLogs2(
