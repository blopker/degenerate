...
import 'package:collection/collection.dart';import 'r2_r2_action.dart';final class R2Rule {const R2Rule({required this.actions, this.description, this.prefix, this.suffix, });
