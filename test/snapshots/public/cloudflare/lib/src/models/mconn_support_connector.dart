...
final class MconnSupportConnector {
  const MconnSupportConnector({
  ...
  factory MconnSupportConnector.fromJson(Map<String, dynamic> json) {
    return MconnSupportConnector(
