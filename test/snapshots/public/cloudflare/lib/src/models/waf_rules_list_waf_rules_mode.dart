...
final class WafRulesListWafRulesMode {
  const WafRulesListWafRulesMode._(this.value);

  factory WafRulesListWafRulesMode.fromJson(String json) {
    return switch (json) {
      'DIS' => dis,
      'CHL' => chl,
      'BLK' => blk,
  ...
  @override
  String toString() {
    return 'WafRulesListWafRulesMode($value)';
  }
}
