...
final class UrlscannerGetScanResponse2DataRequestsResponseResponseSecurityDetails {
  ...
  factory UrlscannerGetScanResponse2DataRequestsResponseResponseSecurityDetails.fromJson(
    Map<String, dynamic> json,
  ) {
    return UrlscannerGetScanResponse2DataRequestsResponseResponseSecurityDetails(
      ...
      sanList: (json['sanList'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      serverSignatureAlgorithm: (json['serverSignatureAlgorithm'] as num)
          .toDouble(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('certificateId') &&
        json['certificateId'] is num &&
        json.containsKey('certificateTransparencyCompliance') &&
        json['certificateTransparencyCompliance'] is String &&
        json.containsKey('cipher') &&
        json['cipher'] is String &&
        json.containsKey('encryptedClientHello') &&
        json['encryptedClientHello'] is bool &&
        json.containsKey('issuer') &&
        json['issuer'] is String &&
        json.containsKey('keyExchange') &&
        json['keyExchange'] is String &&
        json.containsKey('keyExchangeGroup') &&
        json['keyExchangeGroup'] is String &&
        json.containsKey('protocol') &&
        json['protocol'] is String &&
        json.containsKey('sanList') &&
        json.containsKey('serverSignatureAlgorithm') &&
        json['serverSignatureAlgorithm'] is num &&
  ...
  copyWith({
    ...
    String? protocol,
    List<String>? sanList,
    double? serverSignatureAlgorithm,
    String? subjectName,
    double? validFrom,
    double? validTo,
  }) {
    return UrlscannerGetScanResponse2DataRequestsResponseResponseSecurityDetails(
      ...
      serverSignatureAlgorithm:
          serverSignatureAlgorithm ?? this.serverSignatureAlgorithm,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is UrlscannerGetScanResponse2DataRequestsResponseResponseSecurityDetails &&
            ...
            const ListEquality<dynamic>().equals(sanList, other.sanList) &&
