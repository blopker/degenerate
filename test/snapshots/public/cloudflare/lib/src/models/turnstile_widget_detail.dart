...
import 'package:collection/collection.dart';import 'turnstile_clearance_level.dart';import 'turnstile_region.dart';import 'turnstile_widget_mode.dart';/// A Turnstile widget's detailed configuration
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('bot_fight_mode') && json['bot_fight_mode'] is bool &&
      json.containsKey('clearance_level') &&
      json.containsKey('created_on') && json['created_on'] is String &&
      json.containsKey('domains') &&
      json.containsKey('ephemeral_id') && json['ephemeral_id'] is bool &&
      json.containsKey('mode') &&
      json.containsKey('modified_on') && json['modified_on'] is String &&
      json.containsKey('name') && json['name'] is String &&
      json.containsKey('offlabel') && json['offlabel'] is bool &&
      json.containsKey('region') &&
      json.containsKey('secret') && json['secret'] is String &&
      json.containsKey('sitekey') && json['sitekey'] is String; } 
TurnstileWidgetDetail copyWith({bool? botFightMode, TurnstileClearanceLevel? clearanceLevel, DateTime? createdOn, List<String>? domains, bool? ephemeralId, TurnstileWidgetMode? mode, DateTime? modifiedOn, String? name, bool? offlabel, TurnstileRegion? region, String? secret, String? sitekey, }) { return TurnstileWidgetDetail(
