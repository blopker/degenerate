...
import 'package:collection/collection.dart';import 'urlscanner_get_scan_response_result_scan_meta_processors_tech_categories.dart';import 'urlscanner_get_scan_response_result_scan_meta_processors_tech_evidence.dart';final class UrlscannerGetScanResponseResultScanMetaProcessorsTech {const UrlscannerGetScanResponseResultScanMetaProcessorsTech({required this.categories, required this.confidence, this.description, required this.evidence, required this.icon, required this.name, required this.slug, required this.website, });
