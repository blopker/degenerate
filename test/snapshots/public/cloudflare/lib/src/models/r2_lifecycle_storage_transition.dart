...
import 'r2_lifecycle_storage_transition_condition.dart';import 'r2_lifecycle_storage_transition_storage_class.dart';final class R2LifecycleStorageTransition {const R2LifecycleStorageTransition({required this.condition, required this.storageClass, });

factory R2LifecycleStorageTransition.fromJson(Map<String, dynamic> json) { return R2LifecycleStorageTransition(
  condition: R2LifecycleStorageTransitionCondition.fromJson(json['condition']),
