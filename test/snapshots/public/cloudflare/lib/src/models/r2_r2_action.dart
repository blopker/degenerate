...
final class R2R2Action {
  const R2R2Action._(this.value);

  factory R2R2Action.fromJson(String json) {
    return switch (json) {
      'PutObject' => putObject,
  ...
  static const R2R2Action completeMultipartUpload = R2R2Action._(
    'CompleteMultipartUpload',
  );

  static const R2R2Action lifecycleDeletion = R2R2Action._('LifecycleDeletion');

  static const List<R2R2Action> values = [
    putObject,
    copyObject,
    deleteObject,
    completeMultipartUpload,
