...
import 'radar_get_bgp_hijacks_events_response_result_events_tags.dart';

final class RadarGetBgpHijacksEventsResponseResultEvents {
  const RadarGetBgpHijacksEventsResponseResultEvents({
  ...
  factory RadarGetBgpHijacksEventsResponseResultEvents.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetBgpHijacksEventsResponseResultEvents(
      ...
      peerAsns: (json['peer_asns'] as List<dynamic>)
      ...
      tags: (json['tags'] as List<dynamic>)
          .map(
            (e) => RadarGetBgpHijacksEventsResponseResultEventsTags.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      victimAsns: (json['victim_asns'] as List<dynamic>)
          .map((e) => (e as num).toInt())
          .toList(),
      victimCountries: (json['victim_countries'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('confidence_score') &&
        json['confidence_score'] is num &&
        json.containsKey('duration') &&
        json['duration'] is num &&
        json.containsKey('event_type') &&
        json['event_type'] is num &&
        json.containsKey('hijack_msgs_count') &&
        json['hijack_msgs_count'] is num &&
        json.containsKey('hijacker_asn') &&
        json['hijacker_asn'] is num &&
        json.containsKey('hijacker_country') &&
        json['hijacker_country'] is String &&
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('is_stale') &&
        json['is_stale'] is bool &&
        json.containsKey('max_hijack_ts') &&
        json['max_hijack_ts'] is String &&
        json.containsKey('max_msg_ts') &&
        json['max_msg_ts'] is String &&
        json.containsKey('min_hijack_ts') &&
        json['min_hijack_ts'] is String &&
        json.containsKey('on_going_count') &&
        json['on_going_count'] is num &&
        json.containsKey('peer_asns') &&
        json.containsKey('peer_ip_count') &&
        json['peer_ip_count'] is num &&
  ...
  RadarGetBgpHijacksEventsResponseResultEvents copyWith({
    int? confidenceScore,
    int? duration,
    int? eventType,
    int? hijackMsgsCount,
    int? hijackerAsn,
    String? hijackerCountry,
    int? id,
    bool? isStale,
    String? maxHijackTs,
    String? maxMsgTs,
    ...
    List<RadarGetBgpHijacksEventsResponseResultEventsTags>? tags,
    List<int>? victimAsns,
    List<String>? victimCountries,
  }) {
    return RadarGetBgpHijacksEventsResponseResultEvents(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RadarGetBgpHijacksEventsResponseResultEvents &&
            ...
            const ListEquality<dynamic>().equals(peerAsns, other.peerAsns) &&
