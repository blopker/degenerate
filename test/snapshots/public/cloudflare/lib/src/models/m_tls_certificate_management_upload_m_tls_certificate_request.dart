...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('ca') && json['ca'] is bool &&
      json.containsKey('certificates') && json['certificates'] is String; } 
MTlsCertificateManagementUploadMTlsCertificateRequest copyWith({bool? ca, String? certificates, String Function()? name, String Function()? privateKey, }) { return MTlsCertificateManagementUploadMTlsCertificateRequest(
  ca: ca ?? this.ca,
