...
final class RevokeDeviceResponse {
  ...
  @override
  String toString() {
    return 'RevokeDeviceResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
  }
}
