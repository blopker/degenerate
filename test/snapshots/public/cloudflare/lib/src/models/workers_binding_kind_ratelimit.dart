...
import 'workers_binding_kind_ratelimit_simple.dart';final class WorkersBindingKindRatelimit {const WorkersBindingKindRatelimit({required this.name, required this.namespaceId, required this.simple, required this.type, });
...
WorkersBindingKindRatelimit copyWith({String? name, String? namespaceId, WorkersBindingKindRatelimitSimple? simple, String? type, }) { return WorkersBindingKindRatelimit(
  name: name ?? this.name,
