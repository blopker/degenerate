...
import 'post_event_create_request_indicators.dart';
import 'post_event_create_request_raw.dart';

final class PostEventCreateRequest {
  const PostEventCreateRequest({
    this.accountId,
    this.attacker,
  ...
  factory PostEventCreateRequest.fromJson(Map<String, dynamic> json) {
    return PostEventCreateRequest(
      ...
      indicators: (json['indicators'] as List<dynamic>?)
          ?.map(
            (e) => PostEventCreateRequestIndicators.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      insight: json['insight'] as String?,
      raw: PostEventCreateRequestRaw.fromJson(
  ...
  PostEventCreateRequest copyWith({
    ...
    List<PostEventCreateRequestIndicators> Function()? indicators,
    String Function()? insight,
    PostEventCreateRequestRaw? raw,
