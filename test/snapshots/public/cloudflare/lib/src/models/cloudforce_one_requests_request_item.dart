...
final class CloudforceOneRequestsRequestItem {
  const CloudforceOneRequestsRequestItem({
    this.completed,
  ...
  factory CloudforceOneRequestsRequestItem.fromJson(Map<String, dynamic> json) {
    return CloudforceOneRequestsRequestItem(
  ...
  CloudforceOneRequestsRequestItem copyWith({
  ...
  @override
  String toString() {
    return 'CloudforceOneRequestsRequestItem(completed: $completed, content: $content, created: $created, id: $id, messageTokens: $messageTokens, priority: $priority, readableId: $readableId, request: $request, status: $status, summary: $summary, tlp: $tlp, tokens: $tokens, updated: $updated)';
  }
}
