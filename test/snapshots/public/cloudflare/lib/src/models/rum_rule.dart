...
final class RumRule {
  ...
  factory RumRule.fromJson(Map<String, dynamic> json) {
    return RumRule(
  ...
  @override
  String toString() {
    return 'RumRule(created: $created, host: $host, id: $id, inclusive: $inclusive, isPaused: $isPaused, paths: $paths, priority: $priority)';
  }
}
