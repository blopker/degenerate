...
import 'package:collection/collection.dart';final class RumRule {const RumRule({this.created, this.host, this.id, this.inclusive, this.isPaused, this.paths, this.priority, });
...
RumRule copyWith({DateTime Function()? created, String Function()? host, String Function()? id, bool Function()? inclusive, bool Function()? isPaused, List<String> Function()? paths, double Function()? priority, }) { return RumRule(
