...
final class AigConfigListGatewayLogsResponseResult {
  const AigConfigListGatewayLogsResponseResult({
  ...
  factory AigConfigListGatewayLogsResponseResult.fromJson(
    Map<String, dynamic> json,
  ) {
    return AigConfigListGatewayLogsResponseResult(
  ...
  AigConfigListGatewayLogsResponseResult copyWith({
    bool? cached,
  ...
  @override
  String toString() {
    return 'AigConfigListGatewayLogsResponseResult(cached: $cached, cost: $cost, createdAt: $createdAt, customCost: $customCost, duration: $duration, id: $id, metadata: $metadata, model: $model, modelType: $modelType, path: $path, provider: $provider, requestContentType: $requestContentType, requestType: $requestType, responseContentType: $responseContentType, statusCode: $statusCode, step: $step, success: $success, tokensIn: $tokensIn, tokensOut: $tokensOut)';
  }
}
