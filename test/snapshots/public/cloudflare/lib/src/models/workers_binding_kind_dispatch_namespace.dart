...
import 'workers_binding_kind_dispatch_namespace_outbound.dart';final class WorkersBindingKindDispatchNamespace {const WorkersBindingKindDispatchNamespace({required this.name, required this.namespace, this.outbound, required this.type, });
...
WorkersBindingKindDispatchNamespace copyWith({String? name, String? namespace, WorkersBindingKindDispatchNamespaceOutbound Function()? outbound, String? type, }) { return WorkersBindingKindDispatchNamespace(
  name: name ?? this.name,
