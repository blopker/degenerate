...
final class RadarGetBgpRouteLeakEventsResponseResultEvents {
  ...
  factory RadarGetBgpRouteLeakEventsResponseResultEvents.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetBgpRouteLeakEventsResponseResultEvents(
      ...
      leakSeg: (json['leak_seg'] as List<dynamic>)
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('countries') &&
        json.containsKey('detected_ts') &&
        json['detected_ts'] is String &&
        json.containsKey('finished') &&
        json['finished'] is bool &&
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('leak_asn') &&
        json['leak_asn'] is num &&
        json.containsKey('leak_count') &&
        json['leak_count'] is num &&
        json.containsKey('leak_seg') &&
        json.containsKey('leak_type') &&
        json['leak_type'] is num &&
        json.containsKey('max_ts') &&
        json['max_ts'] is String &&
        json.containsKey('min_ts') &&
        json['min_ts'] is String &&
        json.containsKey('origin_count') &&
        json['origin_count'] is num &&
        json.containsKey('peer_count') &&
        json['peer_count'] is num &&
        json.containsKey('prefix_count') &&
        json['prefix_count'] is num;
  }

  RadarGetBgpRouteLeakEventsResponseResultEvents copyWith({
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RadarGetBgpRouteLeakEventsResponseResultEvents &&
            ...
            const ListEquality<dynamic>().equals(leakSeg, other.leakSeg) &&
  ...
  @override
  String toString() {
    return 'RadarGetBgpRouteLeakEventsResponseResultEvents(countries: $countries, detectedTs: $detectedTs, finished: $finished, id: $id, leakAsn: $leakAsn, leakCount: $leakCount, leakSeg: $leakSeg, leakType: $leakType, maxTs: $maxTs, minTs: $minTs, originCount: $originCount, peerCount: $peerCount, prefixCount: $prefixCount)';
  }
}
