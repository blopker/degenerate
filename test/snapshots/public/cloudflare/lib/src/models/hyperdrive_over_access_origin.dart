...
final class HyperdriveOverAccessOrigin {
  const HyperdriveOverAccessOrigin({
    required this.accessClientId,
    required this.accessClientSecret,
    required this.host,
  });

  factory HyperdriveOverAccessOrigin.fromJson(Map<String, dynamic> json) {
    return HyperdriveOverAccessOrigin(
  ...
  HyperdriveOverAccessOrigin copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(accessClientId, accessClientSecret, host);
  }

  @override
  String toString() {
    return 'HyperdriveOverAccessOrigin(accessClientId: $accessClientId, accessClientSecret: $accessClientSecret, host: $host)';
  }
}
