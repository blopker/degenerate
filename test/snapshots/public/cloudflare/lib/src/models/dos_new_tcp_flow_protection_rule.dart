...
final class DosNewTcpFlowProtectionRule {
  const DosNewTcpFlowProtectionRule({
  ...
  factory DosNewTcpFlowProtectionRule.fromJson(Map<String, dynamic> json) {
    return DosNewTcpFlowProtectionRule(
  ...
  DosNewTcpFlowProtectionRule copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(burstSensitivity, mode, name, rateSensitivity, scope);
  }

  @override
  String toString() {
    return 'DosNewTcpFlowProtectionRule(burstSensitivity: $burstSensitivity, mode: $mode, name: $name, rateSensitivity: $rateSensitivity, scope: $scope)';
  }
}
