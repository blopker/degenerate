...
import 'package:collection/collection.dart';import 'radar_get_entities_asn_by_ip_response_result_asn_estimated_users.dart';import 'radar_get_entities_asn_by_ip_response_result_asn_related.dart';final class RadarGetEntitiesAsnByIpResponseResultAsn {const RadarGetEntitiesAsnByIpResponseResultAsn({this.aka, required this.asn, required this.country, required this.countryName, required this.estimatedUsers, required this.name, required this.orgName, required this.related, required this.source, required this.website, });
