...
OrganizationsDeleteResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, DeleteOrganizationResponse? result, bool? success, }) { return OrganizationsDeleteResponse(
