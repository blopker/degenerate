...
import 'aig_config_fetch_gateway_response_result_dlp.dart';
import 'aig_config_fetch_gateway_response_result_log_management_strategy.dart';
import 'aig_config_fetch_gateway_response_result_otel.dart';
import 'aig_config_fetch_gateway_response_result_rate_limiting_technique.dart';
import 'aig_config_fetch_gateway_response_result_stripe.dart';
import 'aig_config_fetch_gateway_response_result_workers_ai_billing_mode.dart';

final class AigConfigFetchGatewayResponseResult {
  const AigConfigFetchGatewayResponseResult({
    this.authentication,
    ...
    this.workersAiBillingMode =
        AigConfigFetchGatewayResponseResultWorkersAiBillingMode.postpaid,
    this.zdr,
  });

  factory AigConfigFetchGatewayResponseResult.fromJson(
    Map<String, dynamic> json,
  ) {
    return AigConfigFetchGatewayResponseResult(
      ...
      dlp: json['dlp'] != null
          ? AigConfigFetchGatewayResponseResultDlp.fromJson(
      ...
      logManagementStrategy: json['log_management_strategy'] != null
          ? AigConfigFetchGatewayResponseResultLogManagementStrategy.fromJson(
      ...
      otel: (json['otel'] as List<dynamic>?)
          ?.map(
            (e) => AigConfigFetchGatewayResponseResultOtel.fromJson(
      ...
      rateLimitingTechnique:
          AigConfigFetchGatewayResponseResultRateLimitingTechnique.fromJson(
            json['rate_limiting_technique'] as String,
          ),
      storeId: json['store_id'] as String?,
      stripe: json['stripe'] != null
          ? AigConfigFetchGatewayResponseResultStripe.fromJson(
              json['stripe'] as Map<String, dynamic>,
            )
          : null,
      workersAiBillingMode: json.containsKey('workers_ai_billing_mode')
          ? AigConfigFetchGatewayResponseResultWorkersAiBillingMode.fromJson(
  ...
  final AigConfigFetchGatewayResponseResultLogManagementStrategy?
  ...
  final AigConfigFetchGatewayResponseResultRateLimitingTechnique
  rateLimitingTechnique;
  ...
  final AigConfigFetchGatewayResponseResultWorkersAiBillingMode
  ...
  AigConfigFetchGatewayResponseResult copyWith({
    bool Function()? authentication,
    bool? cacheInvalidateOnUpdate,
    int? Function()? cacheTtl,
    bool? collectLogs,
    DateTime? createdAt,
    AigConfigFetchGatewayResponseResultDlp Function()? dlp,
    String? id,
    bool Function()? isDefault,
    int? Function()? logManagement,
    AigConfigFetchGatewayResponseResultLogManagementStrategy? Function()?
    logManagementStrategy,
    bool Function()? logpush,
    String? Function()? logpushPublicKey,
    DateTime? modifiedAt,
    List<AigConfigFetchGatewayResponseResultOtel>? Function()? otel,
    int? Function()? rateLimitingInterval,
    int? Function()? rateLimitingLimit,
    AigConfigFetchGatewayResponseResultRateLimitingTechnique?
    rateLimitingTechnique,
    String? Function()? storeId,
    AigConfigFetchGatewayResponseResultStripe? Function()? stripe,
    AigConfigFetchGatewayResponseResultWorkersAiBillingMode Function()?
    workersAiBillingMode,
    bool Function()? zdr,
  }) {
    return AigConfigFetchGatewayResponseResult(
