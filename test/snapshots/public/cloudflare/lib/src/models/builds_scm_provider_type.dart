...
final class BuildsScmProviderType {
  const BuildsScmProviderType._(this.value);

  factory BuildsScmProviderType.fromJson(String json) {
    return switch (json) {
      'github' => github,
  ...
  @override
  String toString() {
    return 'BuildsScmProviderType($value)';
  }
}
