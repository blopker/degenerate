...
///
final class ZonesCacheTtlByStatusId {
  const ZonesCacheTtlByStatusId._(this.value);

  factory ZonesCacheTtlByStatusId.fromJson(String json) {
    return switch (json) {
  ...
  static const ZonesCacheTtlByStatusId cacheTtlByStatus =
      ZonesCacheTtlByStatusId._('cache_ttl_by_status');
  ...
  @override
  String toString() {
    return 'ZonesCacheTtlByStatusId($value)';
  }
}
