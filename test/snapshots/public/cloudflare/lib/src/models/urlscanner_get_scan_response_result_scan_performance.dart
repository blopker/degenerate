...
final class UrlscannerGetScanResponseResultScanPerformance {
  const UrlscannerGetScanResponseResultScanPerformance({
    required this.connectEnd,
    required this.connectStart,
    required this.decodedBodySize,
    required this.domComplete,
    required this.domContentLoadedEventEnd,
    required this.domContentLoadedEventStart,
    required this.domInteractive,
    required this.domainLookupEnd,
    required this.domainLookupStart,
    required this.duration,
    required this.encodedBodySize,
    required this.entryType,
    required this.fetchStart,
    required this.initiatorType,
    required this.loadEventEnd,
    required this.loadEventStart,
    required this.name,
    required this.nextHopProtocol,
    required this.redirectCount,
    required this.redirectEnd,
    required this.redirectStart,
    ...
    required this.type,
    required this.unloadEventEnd,
    required this.unloadEventStart,
    required this.workerStart,
  });

  factory UrlscannerGetScanResponseResultScanPerformance.fromJson(
    ...
    return UrlscannerGetScanResponseResultScanPerformance(
      ...
      domContentLoadedEventEnd: (json['domContentLoadedEventEnd'] as num)
          .toDouble(),
      domContentLoadedEventStart: (json['domContentLoadedEventStart'] as num)
          .toDouble(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('connectEnd') &&
        json['connectEnd'] is num &&
        json.containsKey('connectStart') &&
        json['connectStart'] is num &&
        json.containsKey('decodedBodySize') &&
        json['decodedBodySize'] is num &&
        json.containsKey('domComplete') &&
        json['domComplete'] is num &&
        json.containsKey('domContentLoadedEventEnd') &&
        json['domContentLoadedEventEnd'] is num &&
        json.containsKey('domContentLoadedEventStart') &&
        json['domContentLoadedEventStart'] is num &&
        json.containsKey('domInteractive') &&
        json['domInteractive'] is num &&
        json.containsKey('domainLookupEnd') &&
        json['domainLookupEnd'] is num &&
        json.containsKey('domainLookupStart') &&
        json['domainLookupStart'] is num &&
        json.containsKey('duration') &&
        json['duration'] is num &&
        json.containsKey('encodedBodySize') &&
        json['encodedBodySize'] is num &&
        json.containsKey('entryType') &&
        json['entryType'] is String &&
        json.containsKey('fetchStart') &&
        json['fetchStart'] is num &&
        json.containsKey('initiatorType') &&
        json['initiatorType'] is String &&
        json.containsKey('loadEventEnd') &&
        json['loadEventEnd'] is num &&
        json.containsKey('loadEventStart') &&
        json['loadEventStart'] is num &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('nextHopProtocol') &&
        json['nextHopProtocol'] is String &&
        json.containsKey('redirectCount') &&
        json['redirectCount'] is num &&
        json.containsKey('redirectEnd') &&
        json['redirectEnd'] is num &&
        json.containsKey('redirectStart') &&
        json['redirectStart'] is num &&
        json.containsKey('requestStart') &&
        json['requestStart'] is num &&
        json.containsKey('responseEnd') &&
        json['responseEnd'] is num &&
        json.containsKey('responseStart') &&
        json['responseStart'] is num &&
        json.containsKey('secureConnectionStart') &&
        json['secureConnectionStart'] is num &&
        json.containsKey('startTime') &&
        json['startTime'] is num &&
        json.containsKey('transferSize') &&
        json['transferSize'] is num &&
        json.containsKey('type') &&
        json['type'] is String &&
        json.containsKey('unloadEventEnd') &&
        json['unloadEventEnd'] is num &&
        json.containsKey('unloadEventStart') &&
        json['unloadEventStart'] is num &&
        json.containsKey('workerStart') &&
        json['workerStart'] is num;
  }

  UrlscannerGetScanResponseResultScanPerformance copyWith({
    double? connectEnd,
    double? connectStart,
