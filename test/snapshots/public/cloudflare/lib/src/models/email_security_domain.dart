...
import 'package:collection/collection.dart';import 'email_security_delivery_mode.dart';import 'email_security_disposition_label.dart';import 'email_security_domain_authorization.dart';import 'email_security_domain_dmarc_status.dart';import 'email_security_domain_emails_processed.dart';import 'email_security_domain_inbox_provider.dart';import 'email_security_domain_regions.dart';import 'email_security_domain_spf_status.dart';import 'email_security_scannable_folder.dart';final class EmailSecurityDomain {const EmailSecurityDomain({required this.allowedDeliveryModes, this.authorization, required this.createdAt, this.dmarcStatus, required this.domain, required this.dropDispositions, this.emailsProcessed, this.folder, required this.id, this.inboxProvider, this.integrationId, required this.ipRestrictions, required this.lastModified, required this.lookbackHops, this.o365TenantId, required this.regions, this.requireTlsInbound, this.requireTlsOutbound, this.spfStatus, required this.transport, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EmailSecurityDomain &&
          const ListEquality<dynamic>().equals(allowedDeliveryModes, other.allowedDeliveryModes) &&
          authorization == other.authorization &&
          createdAt == other.createdAt &&
          dmarcStatus == other.dmarcStatus &&
          domain == other.domain &&
          const ListEquality<dynamic>().equals(dropDispositions, other.dropDispositions) &&
          emailsProcessed == other.emailsProcessed &&
          folder == other.folder &&
          id == other.id &&
          inboxProvider == other.inboxProvider &&
          integrationId == other.integrationId &&
          const ListEquality<dynamic>().equals(ipRestrictions, other.ipRestrictions) &&
