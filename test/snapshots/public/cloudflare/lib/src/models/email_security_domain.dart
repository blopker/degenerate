...
import 'email_security_delivery_mode.dart';
import 'email_security_disposition_label.dart';
import 'email_security_domain_authorization.dart';
import 'email_security_domain_dmarc_status.dart';
import 'email_security_domain_emails_processed.dart';
import 'email_security_domain_inbox_provider.dart';
import 'email_security_domain_regions.dart';
import 'email_security_domain_spf_status.dart';
import 'email_security_scannable_folder.dart';

final class EmailSecurityDomain {
  const EmailSecurityDomain({
  ...
  factory EmailSecurityDomain.fromJson(Map<String, dynamic> json) {
    return EmailSecurityDomain(
      allowedDeliveryModes: (json['allowed_delivery_modes'] as List<dynamic>)
          .map((e) => EmailSecurityDeliveryMode.fromJson(e as String))
          .toList(),
      authorization: json['authorization'] != null
          ? EmailSecurityDomainAuthorization.fromJson(
              json['authorization'] as Map<String, dynamic>,
            )
          : null,
      createdAt: DateTime.parse(json['created_at'] as String),
      dmarcStatus: json['dmarc_status'] != null
          ? EmailSecurityDomainDmarcStatus.fromJson(
              json['dmarc_status'] as String,
            )
          : null,
      domain: json['domain'] as String,
      dropDispositions: (json['drop_dispositions'] as List<dynamic>)
          .map((e) => EmailSecurityDispositionLabel.fromJson(e as String))
          .toList(),
      emailsProcessed: json['emails_processed'] != null
          ? EmailSecurityDomainEmailsProcessed.fromJson(
              json['emails_processed'] as Map<String, dynamic>,
            )
          : null,
      folder: json['folder'] != null
          ? EmailSecurityScannableFolder.fromJson(json['folder'] as String)
          : null,
      id: (json['id'] as num).toInt(),
      inboxProvider: json['inbox_provider'] != null
          ? EmailSecurityDomainInboxProvider.fromJson(
              json['inbox_provider'] as String,
            )
          : null,
      integrationId: json['integration_id'] as String?,
      ipRestrictions: (json['ip_restrictions'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      ...
      regions: (json['regions'] as List<dynamic>)
          .map((e) => EmailSecurityDomainRegions.fromJson(e as String))
          .toList(),
      requireTlsInbound: json['require_tls_inbound'] as bool?,
      requireTlsOutbound: json['require_tls_outbound'] as bool?,
      spfStatus: json['spf_status'] != null
          ? EmailSecurityDomainSpfStatus.fromJson(json['spf_status'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (emailsProcessed != null)
        'emails_processed': emailsProcessed?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('allowed_delivery_modes') &&
        ...
        json.containsKey('lookback_hops') &&
        json['lookback_hops'] is num &&
        json.containsKey('regions') &&
        json.containsKey('transport') &&
        json['transport'] is String;
  }

  EmailSecurityDomain copyWith({
    List<EmailSecurityDeliveryMode>? allowedDeliveryModes,
    EmailSecurityDomainAuthorization? Function()? authorization,
    DateTime? createdAt,
    EmailSecurityDomainDmarcStatus? Function()? dmarcStatus,
    String? domain,
    List<EmailSecurityDispositionLabel>? dropDispositions,
    EmailSecurityDomainEmailsProcessed? Function()? emailsProcessed,
    EmailSecurityScannableFolder? Function()? folder,
    int? id,
    EmailSecurityDomainInboxProvider? Function()? inboxProvider,
    String? Function()? integrationId,
    List<String>? ipRestrictions,
    DateTime? lastModified,
    int? lookbackHops,
    String? Function()? o365TenantId,
    List<EmailSecurityDomainRegions>? regions,
    bool? Function()? requireTlsInbound,
    bool? Function()? requireTlsOutbound,
    EmailSecurityDomainSpfStatus? Function()? spfStatus,
    String? transport,
  }) {
    return EmailSecurityDomain(
      ...
      emailsProcessed: emailsProcessed != null
          ? emailsProcessed()
          : this.emailsProcessed,
      folder: folder != null ? folder() : this.folder,
      id: id ?? this.id,
      inboxProvider: inboxProvider != null
          ? inboxProvider()
          : this.inboxProvider,
      ...
      requireTlsInbound: requireTlsInbound != null
          ? requireTlsInbound()
          : this.requireTlsInbound,
      requireTlsOutbound: requireTlsOutbound != null
          ? requireTlsOutbound()
          : this.requireTlsOutbound,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(allowedDeliveryModes),
      authorization,
      createdAt,
      dmarcStatus,
      domain,
      Object.hashAll(dropDispositions),
      emailsProcessed,
      folder,
      id,
      inboxProvider,
      integrationId,
      Object.hashAll(ipRestrictions),
      lastModified,
      lookbackHops,
      o365TenantId,
