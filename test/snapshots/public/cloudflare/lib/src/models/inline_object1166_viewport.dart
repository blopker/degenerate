...
final class InlineObject1166Viewport {const InlineObject1166Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });

factory InlineObject1166Viewport.fromJson(Map<String, dynamic> json) { return InlineObject1166Viewport(
...
InlineObject1166Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return InlineObject1166Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject1166Viewport &&
...
@override String toString() { return 'InlineObject1166Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
