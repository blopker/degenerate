...
final class R2SippySourceProvider {
  const R2SippySourceProvider._(this.value);

  factory R2SippySourceProvider.fromJson(String json) {
    return switch (json) {
      'aws' => aws,
      'gcs' => gcs,
      's3' => s3,
  ...
  @override
  String toString() {
    return 'R2SippySourceProvider($value)';
  }
}
