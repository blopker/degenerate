...
factory DlpCustomProfileUpdate.fromJson(Map<String, dynamic> json) { return DlpCustomProfileUpdate(
  ...
  entries: (json['entries'] as List<dynamic>?)?.map((e) => DlpProfileEntryUpdate.fromJson(e as Map<String, dynamic>)).toList(),
