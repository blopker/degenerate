...
final class WorkersBindingKindDataBlob {const WorkersBindingKindDataBlob({required this.name, required this.$part, required this.type, });
...
WorkersBindingKindDataBlob copyWith({String? name, String? $part, String? type, }) { return WorkersBindingKindDataBlob(
  name: name ?? this.name,
  $part: $part ?? this.$part,
  type: type ?? this.type,
); } 
