...
final class PatchEventUpdateResponse {
  const PatchEventUpdateResponse({
  ...
  factory PatchEventUpdateResponse.fromJson(Map<String, dynamic> json) {
    return PatchEventUpdateResponse(
  ...
  PatchEventUpdateResponse copyWith({
    String? attacker,
