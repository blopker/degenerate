...
final class PostEventQueryUpdateRequest {
  const PostEventQueryUpdateRequest({
    this.alertEnabled,
  ...
  factory PostEventQueryUpdateRequest.fromJson(Map<String, dynamic> json) {
    return PostEventQueryUpdateRequest(
  ...
  PostEventQueryUpdateRequest copyWith({
  ...
  @override
  String toString() {
    return 'PostEventQueryUpdateRequest(alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope)';
  }
}
