...
import 'package:collection/collection.dart';import 'post_indicator_create_bulk_request_indicators_related_events.dart';import 'post_indicator_create_bulk_request_indicators_tags.dart';final class PostIndicatorCreateBulkRequestIndicators {const PostIndicatorCreateBulkRequestIndicators({this.autoCreateType, required this.indicatorType, this.relatedEvents, this.tags, required this.value, });
...
factory PostIndicatorCreateBulkRequestIndicators.fromJson(Map<String, dynamic> json) { return PostIndicatorCreateBulkRequestIndicators(
  ...
  tags: (json['tags'] as List<dynamic>?)?.map((e) => PostIndicatorCreateBulkRequestIndicatorsTags.fromJson(e as Map<String, dynamic>)).toList(),
