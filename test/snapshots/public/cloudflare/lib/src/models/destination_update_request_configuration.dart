...
import 'destination_update_request_configuration_type.dart';final class DestinationUpdateRequestConfiguration {const DestinationUpdateRequestConfiguration({required this.headers, required this.type, required this.url, });
