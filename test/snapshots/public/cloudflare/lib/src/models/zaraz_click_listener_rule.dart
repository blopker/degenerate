...
import 'zaraz_click_listener_rule_action.dart';import 'zaraz_click_listener_rule_settings.dart';final class ZarazClickListenerRule {const ZarazClickListenerRule({required this.action, required this.id, required this.settings, });
