...
import 'package:collection/collection.dart';final class AccessMtlsAuthenticationAddAnMtlsCertificateRequest {const AccessMtlsAuthenticationAddAnMtlsCertificateRequest({this.associatedHostnames, required this.certificate, required this.name, });
...
AccessMtlsAuthenticationAddAnMtlsCertificateRequest copyWith({List<String> Function()? associatedHostnames, String? certificate, String? name, }) { return AccessMtlsAuthenticationAddAnMtlsCertificateRequest(
