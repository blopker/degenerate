...
final class TeamsDevicesPlatform {
  const TeamsDevicesPlatform._(this.value);

  factory TeamsDevicesPlatform.fromJson(String json) {
    return switch (json) {
      'windows' => windows,
      'mac' => mac,
      'linux' => linux,
  ...
  static const TeamsDevicesPlatform chromeos = TeamsDevicesPlatform._(
    'chromeos',
  );

  static const List<TeamsDevicesPlatform> values = [
    windows,
    mac,
    linux,
    android,
  ...
  @override
  String toString() {
    return 'TeamsDevicesPlatform($value)';
  }
}
