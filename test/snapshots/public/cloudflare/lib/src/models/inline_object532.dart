...
import 'inline_object532_image.dart';final class InlineObject532 {const InlineObject532({this.frequencyPenalty, this.image, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });
...
InlineObject532 copyWith({double Function()? frequencyPenalty, InlineObject532Image Function()? image, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject532(
...
@override String toString() { return 'InlineObject532(frequencyPenalty: $frequencyPenalty, image: $image, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
