...
import 'package:collection/collection.dart';import 'zero_trust_gateway_endpoints.dart';import 'zero_trust_gateway_ipv4_network.dart';final class ZeroTrustGatewayLocationsUpdateZeroTrustGatewayLocationRequest {const ZeroTrustGatewayLocationsUpdateZeroTrustGatewayLocationRequest({this.clientDefault, this.dnsDestinationIpsId, this.ecsSupport, this.endpoints, required this.name, this.networks, });
...
ZeroTrustGatewayLocationsUpdateZeroTrustGatewayLocationRequest copyWith({bool Function()? clientDefault, String Function()? dnsDestinationIpsId, bool Function()? ecsSupport, ZeroTrustGatewayEndpoints Function()? endpoints, String? name, List<ZeroTrustGatewayIpv4Network>? Function()? networks, }) { return ZeroTrustGatewayLocationsUpdateZeroTrustGatewayLocationRequest(
