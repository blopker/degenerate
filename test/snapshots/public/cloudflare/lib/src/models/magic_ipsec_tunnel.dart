...
import 'magic_psk_metadata.dart';

final class MagicIpsecTunnel {
  const MagicIpsecTunnel({
  ...
  factory MagicIpsecTunnel.fromJson(Map<String, dynamic> json) {
    return MagicIpsecTunnel(
      ...
      pskMetadata: json['psk_metadata'] != null
          ? MagicPskMetadata.fromJson(
              json['psk_metadata'] as Map<String, dynamic>,
            )
          : null,
  ...
  MagicIpsecTunnel copyWith({
    bool Function()? allowNullCipher,
    ...
    String? name,
    MagicPskMetadata Function()? pskMetadata,
    bool Function()? replayProtection,
  }) {
    return MagicIpsecTunnel(
      allowNullCipher: allowNullCipher != null
          ? allowNullCipher()
          : this.allowNullCipher,
