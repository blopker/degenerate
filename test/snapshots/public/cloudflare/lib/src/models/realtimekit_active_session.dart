...
import 'realtimekit_active_session_status.dart';
import 'realtimekit_active_session_type.dart';

final class RealtimekitActiveSession {
  const RealtimekitActiveSession({
  ...
  factory RealtimekitActiveSession.fromJson(Map<String, dynamic> json) {
    return RealtimekitActiveSession(
      associatedId: json['associated_id'] as String,
      breakoutRooms: (json['breakout_rooms'] as List<dynamic>?)
          ?.map(
            (e) => RealtimekitActiveSession.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      ...
      maxConcurrentParticipants: (json['max_concurrent_participants'] as num)
          .toDouble(),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (breakoutRooms != null)
        'breakout_rooms': breakoutRooms?.map((e) => e.toJson()).toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('associated_id') &&
        json['associated_id'] is String &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('live_participants') &&
        json['live_participants'] is num &&
        json.containsKey('max_concurrent_participants') &&
        json['max_concurrent_participants'] is num &&
        json.containsKey('meeting_display_name') &&
        json['meeting_display_name'] is String &&
        json.containsKey('minutes_consumed') &&
        json['minutes_consumed'] is num &&
  ...
  RealtimekitActiveSession copyWith({
    String? associatedId,
    List<RealtimekitActiveSession> Function()? breakoutRooms,
    String? createdAt,
    String Function()? endedAt,
    String? id,
    double? liveParticipants,
    double? maxConcurrentParticipants,
    String? meetingDisplayName,
    Map<String, String> Function()? meta,
    double? minutesConsumed,
    String? organizationId,
    String? startedAt,
    RealtimekitActiveSessionStatus? status,
    RealtimekitActiveSessionType? type,
    String? updatedAt,
  }) {
    return RealtimekitActiveSession(
      associatedId: associatedId ?? this.associatedId,
      breakoutRooms: breakoutRooms != null
          ? breakoutRooms()
          : this.breakoutRooms,
  ...
  int get hashCode {
    return Object.hash(
      associatedId,
      Object.hashAll(breakoutRooms ?? const []),
      createdAt,
      endedAt,
      id,
      liveParticipants,
