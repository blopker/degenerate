...
final class MagicNat {const MagicNat({this.staticPrefix});

factory MagicNat.fromJson(Map<String, dynamic> json) { return MagicNat(
  staticPrefix: json['static_prefix'] as String?,
); }
...
MagicNat copyWith({String Function()? staticPrefix}) { return MagicNat(
