...
final class DlpUserRiskInfo {
  const DlpUserRiskInfo({
    required this.email,
  ...
  factory DlpUserRiskInfo.fromJson(Map<String, dynamic> json) {
    return DlpUserRiskInfo(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('email') &&
        ...
        json.containsKey('event_count') &&
        json['event_count'] is num &&
        json.containsKey('last_event') &&
        json['last_event'] is String &&
  ...
  DlpUserRiskInfo copyWith({
    String? email,
    int? eventCount,
    DateTime? lastEvent,
    DlpRiskLevel? maxRiskLevel,
    String? name,
    String? userId,
  }) {
    return DlpUserRiskInfo(
  ...
  @override
  String toString() {
    return 'DlpUserRiskInfo(email: $email, eventCount: $eventCount, lastEvent: $lastEvent, maxRiskLevel: $maxRiskLevel, name: $name, userId: $userId)';
  }
}
