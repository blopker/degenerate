...
final class ZonesZonePlan {
  ...
  factory ZonesZonePlan.fromJson(Map<String, dynamic> json) {
    return ZonesZonePlan(
  ...
  @override
  String toString() {
    return 'ZonesZonePlan(canSubscribe: $canSubscribe, currency: $currency, externallyManaged: $externallyManaged, frequency: $frequency, id: $id, isSubscribed: $isSubscribed, legacyDiscount: $legacyDiscount, legacyId: $legacyId, name: $name, price: $price)';
  }
}
