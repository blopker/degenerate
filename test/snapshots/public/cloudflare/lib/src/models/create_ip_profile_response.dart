...
import 'package:collection/collection.dart';import 'response_message.dart';import 'teams_devices_ip_profile.dart';final class CreateIpProfileResponse {const CreateIpProfileResponse({required this.errors, required this.messages, required this.result, required this.success, });
