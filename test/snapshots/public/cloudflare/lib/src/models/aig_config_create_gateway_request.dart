...
import 'aig_config_create_gateway_request_log_management_strategy.dart';
import 'aig_config_create_gateway_request_rate_limiting_technique.dart';
import 'aig_config_create_gateway_request_workers_ai_billing_mode.dart';

final class AigConfigCreateGatewayRequest {
  const AigConfigCreateGatewayRequest({
    this.authentication,
    ...
    this.workersAiBillingMode =
        AigConfigCreateGatewayRequestWorkersAiBillingMode.postpaid,
    this.zdr,
  });

  factory AigConfigCreateGatewayRequest.fromJson(Map<String, dynamic> json) {
    return AigConfigCreateGatewayRequest(
      ...
      logManagementStrategy: json['log_management_strategy'] != null
          ? AigConfigCreateGatewayRequestLogManagementStrategy.fromJson(
      ...
      rateLimitingTechnique:
          AigConfigCreateGatewayRequestRateLimitingTechnique.fromJson(
            json['rate_limiting_technique'] as String,
          ),
      workersAiBillingMode: json.containsKey('workers_ai_billing_mode')
          ? AigConfigCreateGatewayRequestWorkersAiBillingMode.fromJson(
  ...
  final AigConfigCreateGatewayRequestLogManagementStrategy?
  ...
  final AigConfigCreateGatewayRequestRateLimitingTechnique
  rateLimitingTechnique;
  ...
  AigConfigCreateGatewayRequest copyWith({
    ...
    AigConfigCreateGatewayRequestLogManagementStrategy? Function()?
    logManagementStrategy,
    bool Function()? logpush,
    String? Function()? logpushPublicKey,
    int? Function()? rateLimitingInterval,
    int? Function()? rateLimitingLimit,
    AigConfigCreateGatewayRequestRateLimitingTechnique? rateLimitingTechnique,
    AigConfigCreateGatewayRequestWorkersAiBillingMode Function()?
