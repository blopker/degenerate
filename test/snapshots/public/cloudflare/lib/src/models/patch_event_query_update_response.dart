...
final class PatchEventQueryUpdateResponse {
  const PatchEventQueryUpdateResponse({
  ...
  factory PatchEventQueryUpdateResponse.fromJson(Map<String, dynamic> json) {
    return PatchEventQueryUpdateResponse(
  ...
  PatchEventQueryUpdateResponse copyWith({
    int? accountId,
    bool? alertEnabled,
  ...
  @override
  String toString() {
    return 'PatchEventQueryUpdateResponse(accountId: $accountId, alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, createdAt: $createdAt, id: $id, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope, updatedAt: $updatedAt, userEmail: $userEmail)';
  }
}
