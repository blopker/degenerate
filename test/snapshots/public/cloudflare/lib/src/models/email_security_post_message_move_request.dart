...
import 'email_security_post_message_move_request_destination.dart';final class EmailSecurityPostMessageMoveRequest {const EmailSecurityPostMessageMoveRequest({required this.destination});
