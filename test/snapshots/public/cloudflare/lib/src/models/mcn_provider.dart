...
import 'mcn_provider_lifecycle_state.dart';
import 'mcn_provider_status.dart';

final class McnProvider {
  const McnProvider({
    this.awsArn,
  ...
  factory McnProvider.fromJson(Map<String, dynamic> json) {
    return McnProvider(
      ...
      lifecycleState: McnProviderLifecycleState.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('cloud_type') &&
        json.containsKey('friendly_name') &&
        json['friendly_name'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
  ...
  McnProvider copyWith({
    String Function()? awsArn,
    String Function()? azureSubscriptionId,
    String Function()? azureTenantId,
    McnCloudType? cloudType,
    String Function()? description,
    String? friendlyName,
    String Function()? gcpProjectId,
    String Function()? gcpServiceAccountEmail,
    String? id,
    String? lastUpdated,
    McnProviderLifecycleState? lifecycleState,
    McnProviderDiscoveryStatus? state,
    McnProviderDiscoveryStatus? stateV2,
    McnProviderStatus Function()? status,
  }) {
    return McnProvider(
      ...
      gcpServiceAccountEmail: gcpServiceAccountEmail != null
