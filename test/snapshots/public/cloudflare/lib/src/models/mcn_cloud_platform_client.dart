...
import 'mcn_cloud_platform_client_client_type.dart';final class McnCloudPlatformClient {const McnCloudPlatformClient({required this.clientType, required this.id, required this.name, });
...
McnCloudPlatformClient copyWith({McnCloudPlatformClientClientType? clientType, String? id, String? name, }) { return McnCloudPlatformClient(
