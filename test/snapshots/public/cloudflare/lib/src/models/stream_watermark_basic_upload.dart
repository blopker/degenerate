...
final class StreamWatermarkBasicUpload {const StreamWatermarkBasicUpload({required this.file, this.name, this.opacity, this.padding, this.position, this.scale, });

factory StreamWatermarkBasicUpload.fromJson(Map<String, dynamic> json) { return StreamWatermarkBasicUpload(
  file: json['file'] as String,
  name: json['name'] as String?,
  opacity: json['opacity'] != null ? (json['opacity'] as num).toDouble() : null,
  padding: json['padding'] != null ? (json['padding'] as num).toDouble() : null,
...
StreamWatermarkBasicUpload copyWith({String? file, String Function()? name, double Function()? opacity, double Function()? padding, String Function()? position, double Function()? scale, }) { return StreamWatermarkBasicUpload(
  file: file ?? this.file,
