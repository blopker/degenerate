...
import 'package:collection/collection.dart';import 'magic_messages2.dart';final class MagicAppsResponseArray {const MagicAppsResponseArray({required this.errors, required this.messages, required this.result, required this.success, });
...
MagicAppsResponseArray copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, List<String>? Function()? result, bool? success, }) { return MagicAppsResponseArray(
