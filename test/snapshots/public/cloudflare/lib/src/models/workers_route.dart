...
final class WorkersRoute {const WorkersRoute({required this.id, required this.pattern, this.script, });
...
WorkersRoute copyWith({String? id, String? pattern, String Function()? script, }) { return WorkersRoute(
  id: id ?? this.id,
