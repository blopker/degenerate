...
import 'nsc_facility_info.dart';final class NscSlotInfo {const NscSlotInfo({this.account, required this.facility, required this.id, required this.occupied, required this.site, required this.speed, });
...
NscSlotInfo copyWith({String Function()? account, NscFacilityInfo? facility, String? id, bool? occupied, String? site, String? speed, }) { return NscSlotInfo(
