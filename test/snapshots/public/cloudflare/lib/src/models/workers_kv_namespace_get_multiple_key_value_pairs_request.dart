...
import 'package:collection/collection.dart';import 'workers_kv_namespace_get_multiple_key_value_pairs_request_type.dart';final class WorkersKvNamespaceGetMultipleKeyValuePairsRequest {const WorkersKvNamespaceGetMultipleKeyValuePairsRequest({required this.keys, this.type = WorkersKvNamespaceGetMultipleKeyValuePairsRequestType.text, this.withMetadata = false, });
...
WorkersKvNamespaceGetMultipleKeyValuePairsRequest copyWith({List<String>? keys, WorkersKvNamespaceGetMultipleKeyValuePairsRequestType Function()? type, bool Function()? withMetadata, }) { return WorkersKvNamespaceGetMultipleKeyValuePairsRequest(
  keys: keys ?? this.keys,
