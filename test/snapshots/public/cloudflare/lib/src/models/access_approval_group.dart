...
final class AccessApprovalGroup {
  const AccessApprovalGroup({
    required this.approvalsNeeded,
    this.emailAddresses,
    this.emailListUuid,
  });

  factory AccessApprovalGroup.fromJson(Map<String, dynamic> json) {
    return AccessApprovalGroup(
  ...
  @override
  String toString() {
    return 'AccessApprovalGroup(approvalsNeeded: $approvalsNeeded, emailAddresses: $emailAddresses, emailListUuid: $emailListUuid)';
  }
}
