...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_device_dex_test_schemas_data.dart';import 'digital_experience_monitoring_dex_target_policy.dart';final class DigitalExperienceMonitoringDeviceDexTestSchemasHttp {const DigitalExperienceMonitoringDeviceDexTestSchemasHttp({required this.data, this.description, required this.enabled, required this.interval, required this.name, this.targetPolicies, this.targeted, this.testId, });
...
DigitalExperienceMonitoringDeviceDexTestSchemasHttp copyWith({DigitalExperienceMonitoringDeviceDexTestSchemasData? data, String Function()? description, bool? enabled, String? interval, String? name, List<DigitalExperienceMonitoringDexTargetPolicy> Function()? targetPolicies, bool Function()? targeted, String Function()? testId, }) { return DigitalExperienceMonitoringDeviceDexTestSchemasHttp(
  data: data ?? this.data,
