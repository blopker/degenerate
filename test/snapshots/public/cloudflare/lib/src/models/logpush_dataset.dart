...
final class LogpushDataset {
  const LogpushDataset._(this.value);

  factory LogpushDataset.fromJson(String json) {
    return switch (json) {
  ...
  static const LogpushDataset accessRequests = LogpushDataset._(
    'access_requests',
  );
  ...
  static const LogpushDataset bisoUserActions = LogpushDataset._(
    'biso_user_actions',
  );

  static const LogpushDataset casbFindings = LogpushDataset._('casb_findings');

  static const LogpushDataset devicePostureResults = LogpushDataset._(
    'device_posture_results',
  );

  static const LogpushDataset dexApplicationTests = LogpushDataset._(
    'dex_application_tests',
  );

  static const LogpushDataset dexDeviceStateEvents = LogpushDataset._(
    'dex_device_state_events',
  );

  static const LogpushDataset dlpForensicCopies = LogpushDataset._(
    'dlp_forensic_copies',
  );

  static const LogpushDataset dnsFirewallLogs = LogpushDataset._(
    'dns_firewall_logs',
  );

  static const LogpushDataset dnsLogs = LogpushDataset._('dns_logs');

  static const LogpushDataset emailSecurityAlerts = LogpushDataset._(
    'email_security_alerts',
  );

  static const LogpushDataset firewallEvents = LogpushDataset._(
    'firewall_events',
  );
  ...
  static const LogpushDataset gatewayNetwork = LogpushDataset._(
    'gateway_network',
  );
  ...
  static const LogpushDataset magicIdsDetections = LogpushDataset._(
    'magic_ids_detections',
  );

  static const LogpushDataset nelReports = LogpushDataset._('nel_reports');

  static const LogpushDataset networkAnalyticsLogs = LogpushDataset._(
    'network_analytics_logs',
  );

  static const LogpushDataset pageShieldEvents = LogpushDataset._(
    'page_shield_events',
  );

  static const LogpushDataset sinkholeHttpLogs = LogpushDataset._(
    'sinkhole_http_logs',
  );

  static const LogpushDataset spectrumEvents = LogpushDataset._(
    'spectrum_events',
  );

  static const LogpushDataset sshLogs = LogpushDataset._('ssh_logs');

  static const LogpushDataset warpConfigChanges = LogpushDataset._(
    'warp_config_changes',
  );

  static const LogpushDataset warpToggleChanges = LogpushDataset._(
    'warp_toggle_changes',
  );

  static const LogpushDataset workersTraceEvents = LogpushDataset._(
    'workers_trace_events',
  );

  static const LogpushDataset zarazEvents = LogpushDataset._('zaraz_events');

  static const LogpushDataset zeroTrustNetworkSessions = LogpushDataset._(
    'zero_trust_network_sessions',
  );

  static const List<LogpushDataset> values = [
    accessRequests,
    auditLogs,
    auditLogsV2,
    bisoUserActions,
