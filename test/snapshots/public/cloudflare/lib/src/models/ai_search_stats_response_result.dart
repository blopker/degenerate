...
final class AiSearchStatsResponseResult {
  const AiSearchStatsResponseResult({
    this.completed,
    this.error,
    this.fileEmbedErrors,
    this.indexSourceErrors,
    this.lastActivity,
    this.queued,
    this.running,
    this.skipped,
  ...
  factory AiSearchStatsResponseResult.fromJson(Map<String, dynamic> json) {
    return AiSearchStatsResponseResult(
  ...
  AiSearchStatsResponseResult copyWith({
    int Function()? completed,
    int Function()? error,
    Map<String, String> Function()? fileEmbedErrors,
    Map<String, String> Function()? indexSourceErrors,
    DateTime Function()? lastActivity,
    int Function()? queued,
    int Function()? running,
    int Function()? skipped,
  }) {
    return AiSearchStatsResponseResult(
      completed: completed != null ? completed() : this.completed,
      error: error != null ? error() : this.error,
      fileEmbedErrors: fileEmbedErrors != null
          ? fileEmbedErrors()
          : this.fileEmbedErrors,
      indexSourceErrors: indexSourceErrors != null
          ? indexSourceErrors()
          : this.indexSourceErrors,
  ...
  @override
  String toString() {
    return 'AiSearchStatsResponseResult(completed: $completed, error: $error, fileEmbedErrors: $fileEmbedErrors, indexSourceErrors: $indexSourceErrors, lastActivity: $lastActivity, queued: $queued, running: $running, skipped: $skipped)';
  }
}
