...
import 'workers_ai_post_run_cf_google_embeddinggemma300m_request_text.dart';final class WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest {const WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest({required this.text});
...
factory WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest.fromJson(Map<String, dynamic> json) { return WorkersAiPostRunCfGoogleEmbeddinggemma300mRequest(
  text: WorkersAiPostRunCfGoogleEmbeddinggemma300mRequestText.fromJson(json['text']),
); }
