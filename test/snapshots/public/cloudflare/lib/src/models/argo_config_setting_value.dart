...
final class ArgoConfigSettingValue {
  const ArgoConfigSettingValue._(this.value);

  factory ArgoConfigSettingValue.fromJson(String json) {
    return switch (json) {
      'on' => $on,
      'off' => off,
  ...
  @override
  String toString() {
    return 'ArgoConfigSettingValue($value)';
  }
}
