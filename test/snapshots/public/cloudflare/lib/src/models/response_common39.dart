...
import 'package:collection/collection.dart';import 'intel_messages2.dart';import 'response_common39_result.dart';final class ResponseCommon39 {const ResponseCommon39({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon39.fromJson(Map<String, dynamic> json) { return ResponseCommon39(
  ...
  result: ResponseCommon39Result.fromJson(json['result'] as Map<String, dynamic>),
