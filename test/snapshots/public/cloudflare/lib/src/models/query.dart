...
final class Query {
  ...
  factory Query.fromJson(Map<String, dynamic> json) {
    return Query(
      maxTime: json['max_time'] != null
          ? DateTime.parse(json['max_time'] as String)
          : null,
      minTime: json['min_time'] != null
          ? DateTime.parse(json['min_time'] as String)
          : null,
  ...
  Query copyWith({
    DateTime? Function()? maxTime,
    DateTime? Function()? minTime,
    bool Function()? scan,
    String Function()? stringMatches,
    String Function()? tag,
  }) {
    return Query(
      ...
      stringMatches: stringMatches != null
          ? stringMatches()
          : this.stringMatches,
  ...
  @override
  int get hashCode {
    return Object.hash(maxTime, minTime, scan, stringMatches, tag);
  }

  @override
  String toString() {
    return 'Query(maxTime: $maxTime, minTime: $minTime, scan: $scan, stringMatches: $stringMatches, tag: $tag)';
  }
}
