...
final class WorkersBindingKindImages {const WorkersBindingKindImages({required this.name, required this.type, });
...
WorkersBindingKindImages copyWith({String? name, String? type, }) { return WorkersBindingKindImages(
  name: name ?? this.name,
  type: type ?? this.type,
); } 
