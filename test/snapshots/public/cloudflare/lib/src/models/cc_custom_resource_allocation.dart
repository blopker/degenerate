...
///
final class CcCustomResourceAllocation {
  const CcCustomResourceAllocation({
    required this.diskMb,
    required this.memoryMib,
    required this.vcpu,
  });

  factory CcCustomResourceAllocation.fromJson(Map<String, dynamic> json) {
    return CcCustomResourceAllocation(
  ...
  Map<String, dynamic> toJson() {
    return {'disk_mb': diskMb, 'memory_mib': memoryMib, 'vcpu': vcpu};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('disk_mb') &&
        json['disk_mb'] is num &&
        json.containsKey('memory_mib') &&
        json['memory_mib'] is num &&
        json.containsKey('vcpu') &&
        json['vcpu'] is num;
  }

  CcCustomResourceAllocation copyWith({
    int? diskMb,
    int? memoryMib,
    double? vcpu,
  }) {
  ...
  @override
  int get hashCode {
    return Object.hash(diskMb, memoryMib, vcpu);
  }

  @override
  String toString() {
    return 'CcCustomResourceAllocation(diskMb: $diskMb, memoryMib: $memoryMib, vcpu: $vcpu)';
  }
}
