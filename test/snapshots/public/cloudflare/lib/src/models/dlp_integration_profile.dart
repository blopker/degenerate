...
import 'package:collection/collection.dart';import 'dlp_entry.dart';final class DlpIntegrationProfile {const DlpIntegrationProfile({required this.createdAt, this.description, required this.entries, required this.id, required this.name, required this.sharedEntries, required this.updatedAt, });
