...
final class PagesProjectCreateProjectRequestBuildConfig {
  const PagesProjectCreateProjectRequestBuildConfig({
    this.buildCaching,
    this.buildCommand,
    this.destinationDir,
    this.rootDir,
  ...
  factory PagesProjectCreateProjectRequestBuildConfig.fromJson(
    Map<String, dynamic> json,
  ) {
    return PagesProjectCreateProjectRequestBuildConfig(
  ...
  PagesProjectCreateProjectRequestBuildConfig copyWith({
  ...
  @override
  String toString() {
    return 'PagesProjectCreateProjectRequestBuildConfig(buildCaching: $buildCaching, buildCommand: $buildCommand, destinationDir: $destinationDir, rootDir: $rootDir, webAnalyticsTag: $webAnalyticsTag, webAnalyticsToken: $webAnalyticsToken)';
  }
}
