...
/// Snapshot Tunnels
final class MconnSnapshotTunnel {
  const MconnSnapshotTunnel({
    this.connectorId,
    required this.healthState,
    required this.healthValue,
    required this.interfaceName,
    this.probedMtu,
    this.recentHealthyPings,
    this.recentUnhealthyPings,
    required this.tunnelId,
  });

  factory MconnSnapshotTunnel.fromJson(Map<String, dynamic> json) {
    return MconnSnapshotTunnel(
      ...
      probedMtu: json['probed_mtu'] != null
          ? (json['probed_mtu'] as num).toDouble()
          : null,
      recentHealthyPings: json['recent_healthy_pings'] != null
          ? (json['recent_healthy_pings'] as num).toDouble()
          : null,
      recentUnhealthyPings: json['recent_unhealthy_pings'] != null
          ? (json['recent_unhealthy_pings'] as num).toDouble()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('health_state') &&
        json['health_state'] is String &&
        json.containsKey('health_value') &&
        json['health_value'] is num &&
        json.containsKey('interface_name') &&
        json['interface_name'] is String &&
        json.containsKey('tunnel_id') &&
        json['tunnel_id'] is String;
  }

  MconnSnapshotTunnel copyWith({
    String Function()? connectorId,
    String? healthState,
    double? healthValue,
    String? interfaceName,
    double Function()? probedMtu,
    double Function()? recentHealthyPings,
    double Function()? recentUnhealthyPings,
    String? tunnelId,
  }) {
    return MconnSnapshotTunnel(
      ...
      recentHealthyPings: recentHealthyPings != null
          ? recentHealthyPings()
          : this.recentHealthyPings,
      recentUnhealthyPings: recentUnhealthyPings != null
          ? recentUnhealthyPings()
          : this.recentUnhealthyPings,
  ...
  @override
  String toString() {
    return 'MconnSnapshotTunnel(connectorId: $connectorId, healthState: $healthState, healthValue: $healthValue, interfaceName: $interfaceName, probedMtu: $probedMtu, recentHealthyPings: $recentHealthyPings, recentUnhealthyPings: $recentUnhealthyPings, tunnelId: $tunnelId)';
  }
}
