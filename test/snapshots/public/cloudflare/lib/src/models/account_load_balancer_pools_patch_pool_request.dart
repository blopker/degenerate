...
final class AccountLoadBalancerPoolsPatchPoolRequest {
  const AccountLoadBalancerPoolsPatchPoolRequest({
    this.checkRegions,
    this.description,
    this.disabledAt,
    this.enabled,
  ...
  factory AccountLoadBalancerPoolsPatchPoolRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountLoadBalancerPoolsPatchPoolRequest(
  ...
  AccountLoadBalancerPoolsPatchPoolRequest copyWith({
