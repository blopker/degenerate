...
import 'inline_object178.dart';

final class ZarazBaseTool {
  const ZarazBaseTool({
  ...
  factory ZarazBaseTool.fromJson(Map<String, dynamic> json) {
    return ZarazBaseTool(
      blockingTriggers: (json['blockingTriggers'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      defaultFields: (json['defaultFields'] as Map<String, dynamic>).map(
        (k, v) =>
            MapEntry(k, InlineObject178.fromJson(v as Map<String, dynamic>)),
      ),
  ...
  final Map<String, InlineObject178> defaultFields;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'defaultFields': defaultFields.map((k, v) => MapEntry(k, v.toJson())),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('blockingTriggers') &&
  ...
  ZarazBaseTool copyWith({
    List<String>? blockingTriggers,
    Map<String, InlineObject178>? defaultFields,
    String Function()? defaultPurpose,
    bool? enabled,
    String? name,
    String Function()? vendorName,
    String Function()? vendorPolicyUrl,
  }) {
    return ZarazBaseTool(
      ...
      vendorPolicyUrl: vendorPolicyUrl != null
          ? vendorPolicyUrl()
          : this.vendorPolicyUrl,
    );
  }
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(blockingTriggers),
      defaultFields,
      defaultPurpose,
      enabled,
      name,
  ...
  @override
  String toString() {
    return 'ZarazBaseTool(blockingTriggers: $blockingTriggers, defaultFields: $defaultFields, defaultPurpose: $defaultPurpose, enabled: $enabled, name: $name, vendorName: $vendorName, vendorPolicyUrl: $vendorPolicyUrl)';
  }
}
