...
import 'package:collection/collection.dart';import 'response_common78_result.dart';import 'web3_messages2.dart';final class ResponseCommon78 {const ResponseCommon78({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon78.fromJson(Map<String, dynamic> json) { return ResponseCommon78(
  ...
  result: ResponseCommon78Result.fromJson(json['result'] as Map<String, dynamic>),
