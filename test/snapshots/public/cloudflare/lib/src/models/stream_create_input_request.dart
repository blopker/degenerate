...
import 'stream_live_input_recording_settings.dart';final class StreamCreateInputRequest {const StreamCreateInputRequest({this.defaultCreator, this.deleteRecordingAfterDays, this.enabled, this.meta, this.recording, });
...
StreamCreateInputRequest copyWith({String Function()? defaultCreator, double Function()? deleteRecordingAfterDays, bool Function()? enabled, Map<String, String> Function()? meta, StreamLiveInputRecordingSettings Function()? recording, }) { return StreamCreateInputRequest(
