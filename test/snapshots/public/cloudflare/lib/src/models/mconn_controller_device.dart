...
final class MconnControllerDevice {
  const MconnControllerDevice({
  ...
  factory MconnControllerDevice.fromJson(Map<String, dynamic> json) {
    return MconnControllerDevice(
  ...
  MconnControllerDevice copyWith({
    String? cryptKey,
  ...
  @override
  String toString() {
    return 'MconnControllerDevice(cryptKey: $cryptKey, cryptKeyRotationFinishedAt: $cryptKeyRotationFinishedAt, id: $id, imagedAt: $imagedAt, lastCryptKey: $lastCryptKey, serialNumber: $serialNumber)';
  }
}
