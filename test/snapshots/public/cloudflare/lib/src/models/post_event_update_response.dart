...
final class PostEventUpdateResponse {
  const PostEventUpdateResponse({
  ...
  factory PostEventUpdateResponse.fromJson(Map<String, dynamic> json) {
    return PostEventUpdateResponse(
  ...
  PostEventUpdateResponse copyWith({
    String? attacker,
