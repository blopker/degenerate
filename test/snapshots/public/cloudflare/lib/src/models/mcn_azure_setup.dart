...
final class McnAzureSetup {
  ...
  factory McnAzureSetup.fromJson(Map<String, dynamic> json) {
    return McnAzureSetup(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('azure_consent_url') &&
        json['azure_consent_url'] is String &&
        json.containsKey('integration_identity_tag') &&
        json['integration_identity_tag'] is String &&
        json.containsKey('item_type') &&
        json['item_type'] is String &&
        json.containsKey('tag_cli_command') &&
        json['tag_cli_command'] is String;
  }

  McnAzureSetup copyWith({
    String? azureConsentUrl,
    String? integrationIdentityTag,
    String? itemType,
    String? tagCliCommand,
  }) {
    return McnAzureSetup(
      azureConsentUrl: azureConsentUrl ?? this.azureConsentUrl,
      integrationIdentityTag:
          integrationIdentityTag ?? this.integrationIdentityTag,
  ...
  @override
  String toString() {
    return 'McnAzureSetup(azureConsentUrl: $azureConsentUrl, integrationIdentityTag: $integrationIdentityTag, itemType: $itemType, tagCliCommand: $tagCliCommand)';
  }
}
