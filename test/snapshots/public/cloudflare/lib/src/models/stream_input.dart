...
final class StreamInput {
  const StreamInput({this.height, this.width});
  ...
  StreamInput copyWith({int Function()? height, int Function()? width}) {
    return StreamInput(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is StreamInput && height == other.height && width == other.width;
  }
  ...
  @override
  String toString() {
    return 'StreamInput(height: $height, width: $width)';
  }
}
