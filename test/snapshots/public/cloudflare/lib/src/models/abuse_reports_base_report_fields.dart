...
final class AbuseReportsBaseReportFields {const AbuseReportsBaseReportFields({required this.act, this.comments, this.company, required this.email, required this.email2, required this.name, this.reportedCountry, this.reportedUserAgent, this.tele, this.title, required this.urls, });
...
AbuseReportsBaseReportFields copyWith({String? act, String Function()? comments, String Function()? company, String? email, String? email2, String? name, String Function()? reportedCountry, String Function()? reportedUserAgent, String Function()? tele, String Function()? title, String? urls, }) { return AbuseReportsBaseReportFields(
  act: act ?? this.act,
