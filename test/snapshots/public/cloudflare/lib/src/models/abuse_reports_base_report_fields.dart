...
final class AbuseReportsBaseReportFields {
  const AbuseReportsBaseReportFields({
    required this.act,
    this.comments,
    this.company,
    required this.email,
  ...
  factory AbuseReportsBaseReportFields.fromJson(Map<String, dynamic> json) {
    return AbuseReportsBaseReportFields(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('act') &&
        json['act'] is String &&
        json.containsKey('email') &&
        json['email'] is String &&
        json.containsKey('email2') &&
        json['email2'] is String &&
  ...
  AbuseReportsBaseReportFields copyWith({
    String? act,
    ...
    String? email2,
    String? name,
    String Function()? reportedCountry,
    String Function()? reportedUserAgent,
    String Function()? tele,
    ...
    return AbuseReportsBaseReportFields(
      ...
      name: name ?? this.name,
      reportedCountry: reportedCountry != null
          ? reportedCountry()
          : this.reportedCountry,
      reportedUserAgent: reportedUserAgent != null
          ? reportedUserAgent()
          : this.reportedUserAgent,
  ...
  @override
  String toString() {
    return 'AbuseReportsBaseReportFields(act: $act, comments: $comments, company: $company, email: $email, email2: $email2, name: $name, reportedCountry: $reportedCountry, reportedUserAgent: $reportedUserAgent, tele: $tele, title: $title, urls: $urls)';
  }
}
