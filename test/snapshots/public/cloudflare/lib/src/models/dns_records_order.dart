...
final class DnsRecordsOrder {
  const DnsRecordsOrder._(this.value);

  factory DnsRecordsOrder.fromJson(String json) {
    return switch (json) {
      'type' => type,
      'name' => name$,
      'content' => content,
  ...
  static const List<DnsRecordsOrder> values = [
    type,
    name$,
    content,
    ttl,
