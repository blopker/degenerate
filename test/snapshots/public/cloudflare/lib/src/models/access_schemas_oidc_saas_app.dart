...
import 'access_schemas_oidc_saas_app_auth_type.dart';
import 'access_schemas_oidc_saas_app_custom_claims.dart';
import 'access_schemas_oidc_saas_app_grant_types.dart';
import 'access_schemas_oidc_saas_app_hybrid_and_implicit_options.dart';
import 'access_schemas_oidc_saas_app_refresh_token_options.dart';
import 'access_schemas_oidc_saas_app_scopes.dart';

final class AccessSchemasOidcSaasApp {
  const AccessSchemasOidcSaasApp({
  ...
  factory AccessSchemasOidcSaasApp.fromJson(Map<String, dynamic> json) {
    return AccessSchemasOidcSaasApp(
      accessTokenLifetime: json['access_token_lifetime'] as String?,
      allowPkceWithoutClientSecret:
          json['allow_pkce_without_client_secret'] as bool?,
      appLauncherUrl: json['app_launcher_url'] as String?,
      authType: json['auth_type'] != null
          ? AccessSchemasOidcSaasAppAuthType.fromJson(
      ...
      createdAt: json['created_at'] != null
          ...
          : null,
      customClaims: (json['custom_claims'] as List<dynamic>?)
          ?.map(
            (e) => AccessSchemasOidcSaasAppCustomClaims.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      grantTypes: (json['grant_types'] as List<dynamic>?)
          ?.map((e) => AccessSchemasOidcSaasAppGrantTypes.fromJson(e as String))
          .toList(),
      groupFilterRegex: json['group_filter_regex'] as String?,
      hybridAndImplicitOptions: json['hybrid_and_implicit_options'] != null
          ? AccessSchemasOidcSaasAppHybridAndImplicitOptions.fromJson(
              json['hybrid_and_implicit_options'] as Map<String, dynamic>,
            )
          : null,
      ...
      refreshTokenOptions: json['refresh_token_options'] != null
          ? AccessSchemasOidcSaasAppRefreshTokenOptions.fromJson(
              json['refresh_token_options'] as Map<String, dynamic>,
            )
          : null,
      scopes: (json['scopes'] as List<dynamic>?)
          ?.map((e) => AccessSchemasOidcSaasAppScopes.fromJson(e as String))
          .toList(),
  ...
  final AccessSchemasOidcSaasAppHybridAndImplicitOptions?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (grantTypes != null)
        'grant_types': grantTypes?.map((e) => e.toJson()).toList(),
  ...
  AccessSchemasOidcSaasApp copyWith({
    String Function()? accessTokenLifetime,
    bool Function()? allowPkceWithoutClientSecret,
    String Function()? appLauncherUrl,
    AccessSchemasOidcSaasAppAuthType Function()? authType,
    String Function()? clientId,
    String Function()? clientSecret,
    DateTime Function()? createdAt,
    List<AccessSchemasOidcSaasAppCustomClaims> Function()? customClaims,
    List<AccessSchemasOidcSaasAppGrantTypes> Function()? grantTypes,
    String Function()? groupFilterRegex,
    AccessSchemasOidcSaasAppHybridAndImplicitOptions Function()?
    hybridAndImplicitOptions,
    String Function()? publicKey,
    List<String> Function()? redirectUris,
    AccessSchemasOidcSaasAppRefreshTokenOptions Function()? refreshTokenOptions,
    List<AccessSchemasOidcSaasAppScopes> Function()? scopes,
    ...
    return AccessSchemasOidcSaasApp(
      accessTokenLifetime: accessTokenLifetime != null
          ? accessTokenLifetime()
          : this.accessTokenLifetime,
      allowPkceWithoutClientSecret: allowPkceWithoutClientSecret != null
          ? allowPkceWithoutClientSecret()
          : this.allowPkceWithoutClientSecret,
      appLauncherUrl: appLauncherUrl != null
          ? appLauncherUrl()
          : this.appLauncherUrl,
      ...
      groupFilterRegex: groupFilterRegex != null
          ? groupFilterRegex()
          : this.groupFilterRegex,
      hybridAndImplicitOptions: hybridAndImplicitOptions != null
          ? hybridAndImplicitOptions()
          : this.hybridAndImplicitOptions,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is AccessSchemasOidcSaasApp &&
            ...
            allowPkceWithoutClientSecret ==
                other.allowPkceWithoutClientSecret &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      clientSecret,
      createdAt,
      Object.hashAll(customClaims ?? const []),
      Object.hashAll(grantTypes ?? const []),
      groupFilterRegex,
      hybridAndImplicitOptions,
      publicKey,
      Object.hashAll(redirectUris ?? const []),
      refreshTokenOptions,
      Object.hashAll(scopes ?? const []),
      updatedAt,
    );
  }
