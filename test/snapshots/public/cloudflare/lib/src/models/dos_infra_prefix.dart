...
final class DosInfraPrefix {
  const DosInfraPrefix({
  ...
  factory DosInfraPrefix.fromJson(Map<String, dynamic> json) {
    return DosInfraPrefix(
  ...
  @override
  int get hashCode {
    return Object.hash(comment, createdOn, enabled, id, modifiedOn, prefix);
  }

  @override
  String toString() {
    return 'DosInfraPrefix(comment: $comment, createdOn: $createdOn, enabled: $enabled, id: $id, modifiedOn: $modifiedOn, prefix: $prefix)';
  }
}
