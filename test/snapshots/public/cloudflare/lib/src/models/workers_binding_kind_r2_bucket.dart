...
import 'workers_binding_kind_r2_bucket_jurisdiction.dart';final class WorkersBindingKindR2Bucket {const WorkersBindingKindR2Bucket({required this.bucketName, this.jurisdiction, required this.name, required this.type, });
...
WorkersBindingKindR2Bucket copyWith({String? bucketName, WorkersBindingKindR2BucketJurisdiction Function()? jurisdiction, String? name, String? type, }) { return WorkersBindingKindR2Bucket(
