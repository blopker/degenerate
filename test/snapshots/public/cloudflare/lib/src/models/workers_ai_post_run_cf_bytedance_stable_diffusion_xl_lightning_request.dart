...
final class WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest {
  const WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest({
    this.guidance = 7.5,
    this.height,
    this.image,
    this.imageB64,
  ...
  factory WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest(
      guidance: json.containsKey('guidance')
          ? (json['guidance'] as num).toDouble()
          : 7.5,
      ...
      numSteps: json.containsKey('num_steps')
          ? (json['num_steps'] as num).toInt()
          : 20,
      prompt: json['prompt'] as String,
      seed: json['seed'] != null ? (json['seed'] as num).toInt() : null,
      strength: json.containsKey('strength')
  ...
  WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest copyWith({
    double Function()? guidance,
    int Function()? height,
    List<double> Function()? image,
    String Function()? imageB64,
    List<double> Function()? mask,
    String Function()? negativePrompt,
    int Function()? numSteps,
    String? prompt,
    int Function()? seed,
    double Function()? strength,
    int Function()? width,
  }) {
    return WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest &&
            ...
            const ListEquality<dynamic>().equals(mask, other.mask) &&
  ...
  int get hashCode {
    return Object.hash(
      guidance,
      height,
      Object.hashAll(image ?? const []),
      imageB64,
      Object.hashAll(mask ?? const []),
      negativePrompt,
      numSteps,
      prompt,
      seed,
  ...
  @override
  String toString() {
    return 'WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)';
  }
}
