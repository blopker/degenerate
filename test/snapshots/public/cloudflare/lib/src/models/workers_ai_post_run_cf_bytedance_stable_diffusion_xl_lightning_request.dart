...
import 'package:collection/collection.dart';final class WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest {const WorkersAiPostRunCfBytedanceStableDiffusionXlLightningRequest({this.guidance = 7.5, this.height, this.image, this.imageB64, this.mask, this.negativePrompt, this.numSteps = 20, required this.prompt, this.seed, this.strength = 1.0, this.width, });
