...
final class BuildsBuildOutcome {
  const BuildsBuildOutcome._(this.value);

  factory BuildsBuildOutcome.fromJson(String json) {
    return switch (json) {
      'success' => success,
      'fail' => fail,
      'skipped' => skipped,
  ...
  static const BuildsBuildOutcome terminated = BuildsBuildOutcome._(
    'terminated',
  );

  static const List<BuildsBuildOutcome> values = [
    success,
    fail,
    skipped,
    cancelled,
  ...
  @override
  String toString() {
    return 'BuildsBuildOutcome($value)';
  }
}
