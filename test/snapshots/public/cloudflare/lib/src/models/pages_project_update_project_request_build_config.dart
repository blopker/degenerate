...
final class PagesProjectUpdateProjectRequestBuildConfig {
  const PagesProjectUpdateProjectRequestBuildConfig({
    this.buildCaching,
    this.buildCommand,
    this.destinationDir,
    this.rootDir,
  ...
  factory PagesProjectUpdateProjectRequestBuildConfig.fromJson(
    Map<String, dynamic> json,
  ) {
    return PagesProjectUpdateProjectRequestBuildConfig(
  ...
  PagesProjectUpdateProjectRequestBuildConfig copyWith({
    bool Function()? buildCaching,
    String Function()? buildCommand,
    String Function()? destinationDir,
    String Function()? rootDir,
    String? Function()? webAnalyticsTag,
    String? Function()? webAnalyticsToken,
  }) {
    return PagesProjectUpdateProjectRequestBuildConfig(
      ...
      webAnalyticsTag: webAnalyticsTag != null
          ? webAnalyticsTag()
          : this.webAnalyticsTag,
      webAnalyticsToken: webAnalyticsToken != null
          ? webAnalyticsToken()
          : this.webAnalyticsToken,
    );
  }
  ...
  @override
  String toString() {
    return 'PagesProjectUpdateProjectRequestBuildConfig(buildCaching: $buildCaching, buildCommand: $buildCommand, destinationDir: $destinationDir, rootDir: $rootDir, webAnalyticsTag: $webAnalyticsTag, webAnalyticsToken: $webAnalyticsToken)';
  }
}
