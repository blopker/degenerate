...
import 'start_livestreaming_response_data_status.dart';final class StartLivestreamingResponseData {const StartLivestreamingResponseData({this.id, this.ingestServer, this.playbackUrl, this.status, this.streamKey, });
