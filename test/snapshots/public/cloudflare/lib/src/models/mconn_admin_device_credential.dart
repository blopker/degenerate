...
final class MconnAdminDeviceCredential {const MconnAdminDeviceCredential({required this.deviceId, required this.id, required this.provisionedAt, required this.type, required this.value, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('device_id') && json['device_id'] is String &&
      json.containsKey('id') && json['id'] is String &&
      json.containsKey('provisioned_at') && json['provisioned_at'] is String &&
      json.containsKey('type') && json['type'] is String &&
      json.containsKey('value') && json['value'] is String; } 
MconnAdminDeviceCredential copyWith({String? deviceId, String? id, String? provisionedAt, String? type, String? value, }) { return MconnAdminDeviceCredential(
