...
final class DosSynProtectionRuleUpdate {
  const DosSynProtectionRuleUpdate({
  ...
  factory DosSynProtectionRuleUpdate.fromJson(Map<String, dynamic> json) {
    return DosSynProtectionRuleUpdate(
  ...
  DosSynProtectionRuleUpdate copyWith({
    String Function()? burstSensitivity,
    String Function()? mitigationType,
    String Function()? mode,
    String Function()? rateSensitivity,
  }) {
    return DosSynProtectionRuleUpdate(
      burstSensitivity: burstSensitivity != null
          ? burstSensitivity()
          : this.burstSensitivity,
      ...
      rateSensitivity: rateSensitivity != null
          ? rateSensitivity()
          : this.rateSensitivity,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(burstSensitivity, mitigationType, mode, rateSensitivity);
  }

  @override
  String toString() {
    return 'DosSynProtectionRuleUpdate(burstSensitivity: $burstSensitivity, mitigationType: $mitigationType, mode: $mode, rateSensitivity: $rateSensitivity)';
  }
}
