...
final class PayPerCrawlSource {
  const PayPerCrawlSource({
    this.parameter,
    this.parameterValueIndex,
    this.pointer,
  });

  factory PayPerCrawlSource.fromJson(Map<String, dynamic> json) {
    return PayPerCrawlSource(
      parameter: json['parameter'] as String?,
      parameterValueIndex: json['parameter_value_index'] != null
          ? (json['parameter_value_index'] as num).toInt()
          : null,
  ...
  PayPerCrawlSource copyWith({
    String Function()? parameter,
    int Function()? parameterValueIndex,
    List<String> Function()? pointer,
  }) {
    return PayPerCrawlSource(
      parameter: parameter != null ? parameter() : this.parameter,
      parameterValueIndex: parameterValueIndex != null
          ? parameterValueIndex()
          : this.parameterValueIndex,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PayPerCrawlSource &&
            ...
            const ListEquality<dynamic>().equals(pointer, other.pointer);
  }
  ...
  int get hashCode {
    return Object.hash(
      parameter,
      parameterValueIndex,
      Object.hashAll(pointer ?? const []),
    );
  }

  @override
  String toString() {
    return 'PayPerCrawlSource(parameter: $parameter, parameterValueIndex: $parameterValueIndex, pointer: $pointer)';
  }
}
