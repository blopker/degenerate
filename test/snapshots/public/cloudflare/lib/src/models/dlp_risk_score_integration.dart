...
final class DlpRiskScoreIntegration {
  ...
  factory DlpRiskScoreIntegration.fromJson(Map<String, dynamic> json) {
    return DlpRiskScoreIntegration(
      accountTag: json['account_tag'] as String,
      active: json['active'] as bool,
      createdAt: DateTime.parse(json['created_at'] as String),
      id: json['id'] as String,
      integrationType: DlpRiskScoreIntegrationType.fromJson(
        json['integration_type'] as String,
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account_tag') &&
        ...
        json.containsKey('reference_id') &&
        json['reference_id'] is String &&
        json.containsKey('tenant_url') &&
        json['tenant_url'] is String &&
        json.containsKey('well_known_url') &&
        json['well_known_url'] is String;
  }

  DlpRiskScoreIntegration copyWith({
    String? accountTag,
    bool? active,
    DateTime? createdAt,
    String? id,
    DlpRiskScoreIntegrationType? integrationType,
    String? referenceId,
    String? tenantUrl,
    String? wellKnownUrl,
  }) {
  ...
  @override
  String toString() {
    return 'DlpRiskScoreIntegration(accountTag: $accountTag, active: $active, createdAt: $createdAt, id: $id, integrationType: $integrationType, referenceId: $referenceId, tenantUrl: $tenantUrl, wellKnownUrl: $wellKnownUrl)';
  }
}
