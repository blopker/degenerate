...
import 'package:collection/collection.dart';/// The SSH-specific rules that define how users may connect to the targets secured by your application.
...
Map<String, dynamic> toJson() { return {
  'allow_email_alias': ?allowEmailAlias,
  'usernames': usernames,
}; } 
static bool canParse(Map<String, dynamic> json) { return json.containsKey('usernames'); } 
AccessConnectionRulesSsh copyWith({bool Function()? allowEmailAlias, List<String>? usernames, }) { return AccessConnectionRulesSsh(
