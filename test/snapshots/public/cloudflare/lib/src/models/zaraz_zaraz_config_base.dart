...
import 'inline_object181.dart';
import 'inline_object182.dart';
import 'zaraz_zaraz_config_base_analytics.dart';
import 'zaraz_zaraz_config_base_consent.dart';
import 'zaraz_zaraz_config_base_settings.dart';

/// Zaraz configuration
final class ZarazZarazConfigBase {
  const ZarazZarazConfigBase({
    this.analytics,
    this.consent,
  ...
  factory ZarazZarazConfigBase.fromJson(Map<String, dynamic> json) {
    return ZarazZarazConfigBase(
      analytics: json['analytics'] != null
          ? ZarazZarazConfigBaseAnalytics.fromJson(
              json['analytics'] as Map<String, dynamic>,
            )
          : null,
      consent: json['consent'] != null
          ? ZarazZarazConfigBaseConsent.fromJson(
      ...
      settings: ZarazZarazConfigBaseSettings.fromJson(
        json['settings'] as Map<String, dynamic>,
      ),
      triggers: (json['triggers'] as Map<String, dynamic>).map(
        (k, v) =>
            MapEntry(k, InlineObject181.fromJson(v as Map<String, dynamic>)),
      ),
      variables: (json['variables'] as Map<String, dynamic>).map(
        (k, v) =>
            MapEntry(k, InlineObject182.fromJson(v as Map<String, dynamic>)),
      ),
  ...
  final Map<String, InlineObject181> triggers;
  ...
  final Map<String, InlineObject182> variables;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('dataLayer') &&
        json['dataLayer'] is bool &&
        json.containsKey('debugKey') &&
        json['debugKey'] is String &&
        json.containsKey('settings') &&
        json.containsKey('triggers') &&
        json.containsKey('variables') &&
        json.containsKey('zarazVersion') &&
        json['zarazVersion'] is num;
  }

  ZarazZarazConfigBase copyWith({
    ZarazZarazConfigBaseAnalytics Function()? analytics,
    ZarazZarazConfigBaseConsent Function()? consent,
    bool? dataLayer,
    String? debugKey,
    bool Function()? historyChange,
    ZarazZarazConfigBaseSettings? settings,
    Map<String, InlineObject181>? triggers,
    Map<String, InlineObject182>? variables,
    int? zarazVersion,
  }) {
    return ZarazZarazConfigBase(
  ...
  @override
  String toString() {
    return 'ZarazZarazConfigBase(analytics: $analytics, consent: $consent, dataLayer: $dataLayer, debugKey: $debugKey, historyChange: $historyChange, settings: $settings, triggers: $triggers, variables: $variables, zarazVersion: $zarazVersion)';
  }
}
