...
final class TlsCertificatesAndHostnamesCertificateObjectPost {
  const TlsCertificatesAndHostnamesCertificateObjectPost({
    this.ca,
    this.certificates,
    this.expiresOn,
    this.id,
  ...
  factory TlsCertificatesAndHostnamesCertificateObjectPost.fromJson(
    Map<String, dynamic> json,
  ) {
    return TlsCertificatesAndHostnamesCertificateObjectPost(
      ca: json['ca'] as bool?,
  ...
  TlsCertificatesAndHostnamesCertificateObjectPost copyWith({
    bool Function()? ca,
  ...
  @override
  String toString() {
    return 'TlsCertificatesAndHostnamesCertificateObjectPost(ca: $ca, certificates: $certificates, expiresOn: $expiresOn, id: $id, issuer: $issuer, name: $name, serialNumber: $serialNumber, signature: $signature, updatedAt: $updatedAt, uploadedOn: $uploadedOn)';
  }
}
