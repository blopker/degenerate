...
DigitalExperienceMonitoringDevice copyWith({bool? Function()? alwaysOn, bool? Function()? batteryCharging, int? Function()? batteryCycles, double? Function()? batteryPct, String? colo, String? Function()? connectionType, double? Function()? cpuPct, List<List<DigitalExperienceMonitoringCpuPctByApp2>>? Function()? cpuPctByApp, String? deviceId, DigitalExperienceMonitoringIpInfo Function()? deviceIpv4, DigitalExperienceMonitoringIpInfo Function()? deviceIpv6, String Function()? deviceName, int? Function()? diskReadBps, double? Function()? diskUsagePct, int? Function()? diskWriteBps, String? Function()? dohSubdomain, double? Function()? estimatedLossPct, bool? Function()? firewallEnabled, DigitalExperienceMonitoringIpInfo Function()? gatewayIpv4, DigitalExperienceMonitoringIpInfo Function()? gatewayIpv6, double? Function()? handshakeLatencyMs, DigitalExperienceMonitoringIpInfo Function()? ispIpv4, DigitalExperienceMonitoringIpInfo Function()? ispIpv6, String? Function()? metal, String? mode, int? Function()? networkRcvdBps, int? Function()? networkSentBps, String? Function()? networkSsid, String Function()? personEmail, String? platform, int? Function()? ramAvailableKb, double? Function()? ramUsedPct, List<List<DigitalExperienceMonitoringRamUsedPctByApp2>>? Function()? ramUsedPctByApp, String? status, bool? Function()? switchLocked, String? timestamp, String? version, int? Function()? wifiStrengthDbm, }) { return DigitalExperienceMonitoringDevice(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DigitalExperienceMonitoringDevice &&
          ...
          cpuPct == other.cpuPct &&
          const ListEquality<dynamic>().equals(cpuPctByApp, other.cpuPctByApp) &&
          ...
          const ListEquality<dynamic>().equals(ramUsedPctByApp, other.ramUsedPctByApp) &&
          status == other.status &&
