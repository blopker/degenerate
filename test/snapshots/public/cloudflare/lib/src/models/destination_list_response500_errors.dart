...
import 'destination_list_response500_errors_message.dart';final class DestinationListResponse500Errors {const DestinationListResponse500Errors({this.detail, required this.message, });
