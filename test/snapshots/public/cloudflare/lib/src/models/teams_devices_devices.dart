...
import 'teams_devices_platform.dart';
import 'teams_devices_user.dart';

final class TeamsDevicesDevices {
  const TeamsDevicesDevices({
    this.created,
    this.deleted,
    this.deviceType,
    this.id,
  ...
  factory TeamsDevicesDevices.fromJson(Map<String, dynamic> json) {
    return TeamsDevicesDevices(
      created: json['created'] != null
          ? DateTime.parse(json['created'] as String)
          : null,
      deleted: json['deleted'] as bool?,
      deviceType: json['device_type'] != null
          ? TeamsDevicesPlatform.fromJson(json['device_type'] as String)
          : null,
  ...
  TeamsDevicesDevices copyWith({
    DateTime Function()? created,
    bool Function()? deleted,
    TeamsDevicesPlatform Function()? deviceType,
    String Function()? id,
    String Function()? ip,
    String Function()? key,
