...
final class AccessOauthConfigurationGrant {
  const AccessOauthConfigurationGrant({
    this.accessTokenLifetime,
    this.sessionDuration,
  });

  factory AccessOauthConfigurationGrant.fromJson(Map<String, dynamic> json) {
    return AccessOauthConfigurationGrant(
  ...
  AccessOauthConfigurationGrant copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(accessTokenLifetime, sessionDuration);
  }

  @override
  String toString() {
    return 'AccessOauthConfigurationGrant(accessTokenLifetime: $accessTokenLifetime, sessionDuration: $sessionDuration)';
  }
}
