...
factory IamTokenBase.fromJson(Map<String, dynamic> json) { return IamTokenBase(
  ...
  issuedOn: json['issued_on'] != null ? DateTime.parse(json['issued_on'] as String) : null,
  lastUsedOn: json['last_used_on'] != null ? DateTime.parse(json['last_used_on'] as String) : null,
  modifiedOn: json['modified_on'] != null ? DateTime.parse(json['modified_on'] as String) : null,
  name: json['name'] as String?,
  notBefore: json['not_before'] != null ? DateTime.parse(json['not_before'] as String) : null,
...
IamTokenBase copyWith({IamCondition Function()? condition, DateTime Function()? expiresOn, String Function()? id, DateTime Function()? issuedOn, DateTime Function()? lastUsedOn, DateTime Function()? modifiedOn, String Function()? name, DateTime Function()? notBefore, List<IamPolicyWithPermissionGroupsAndResources> Function()? policies, IamTokenStatus Function()? status, }) { return IamTokenBase(
