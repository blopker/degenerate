...
final class GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport {
  const GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport({
    ...
    this.localCandidateNetworkType,
    this.localCandidatePort,
    this.localCandidateProtocol,
    this.localCandidateRelatedAddress,
    ...
    this.packetsSent,
    this.remoteCandidateAddress,
    this.remoteCandidateId,
    this.remoteCandidatePort,
    this.remoteCandidateProtocol,
    this.remoteCandidateType,
    this.totalRoundTripTime,
  });

  factory GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport.fromJson(
    Map<String, dynamic> json,
  ) {
    return GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport(
      availableOutgoingBitrate: json['available_outgoing_bitrate'] != null
          ? (json['available_outgoing_bitrate'] as num).toInt()
          : null,
      bytesDiscardedOnSend: json['bytes_discarded_on_send'] != null
          ? (json['bytes_discarded_on_send'] as num).toInt()
          : null,
      bytesReceived: json['bytes_received'] != null
          ? (json['bytes_received'] as num).toInt()
          : null,
      bytesSent: json['bytes_sent'] != null
          ? (json['bytes_sent'] as num).toInt()
          : null,
      currentRoundTripTime: json['current_round_trip_time'] != null
          ? (json['current_round_trip_time'] as num).toDouble()
          : null,
      lastPacketReceivedTimestamp:
          json['last_packet_received_timestamp'] != null
          ? (json['last_packet_received_timestamp'] as num).toInt()
          : null,
      lastPacketSentTimestamp: json['last_packet_sent_timestamp'] != null
          ? (json['last_packet_sent_timestamp'] as num).toInt()
          : null,
      ...
      localCandidateNetworkType:
          json['local_candidate_network_type'] as String?,
      localCandidatePort: json['local_candidate_port'] != null
          ? (json['local_candidate_port'] as num).toInt()
          : null,
      localCandidateProtocol: json['local_candidate_protocol'] as String?,
      localCandidateRelatedAddress:
          json['local_candidate_related_address'] as String?,
      localCandidateRelatedPort: json['local_candidate_related_port'] != null
          ? (json['local_candidate_related_port'] as num).toInt()
          : null,
      localCandidateType: json['local_candidate_type'] as String?,
      nominated: json['nominated'] as bool?,
      packetsDiscardedOnSend: json['packets_discarded_on_send'] != null
          ? (json['packets_discarded_on_send'] as num).toInt()
          : null,
      packetsReceived: json['packets_received'] != null
          ? (json['packets_received'] as num).toInt()
          : null,
      ...
      remoteCandidatePort: json['remote_candidate_port'] != null
          ? (json['remote_candidate_port'] as num).toInt()
          : null,
      remoteCandidateProtocol: json['remote_candidate_protocol'] as String?,
      remoteCandidateType: json['remote_candidate_type'] as String?,
      totalRoundTripTime: json['total_round_trip_time'] != null
          ? (json['total_round_trip_time'] as num).toDouble()
          : null,
    );
  }
  ...
  copyWith({
    int Function()? availableOutgoingBitrate,
    int Function()? bytesDiscardedOnSend,
    int Function()? bytesReceived,
    int Function()? bytesSent,
    double Function()? currentRoundTripTime,
    int Function()? lastPacketReceivedTimestamp,
    int Function()? lastPacketSentTimestamp,
    String Function()? localCandidateAddress,
    String Function()? localCandidateId,
    String Function()? localCandidateNetworkType,
    int Function()? localCandidatePort,
    String Function()? localCandidateProtocol,
    String Function()? localCandidateRelatedAddress,
    int Function()? localCandidateRelatedPort,
    String Function()? localCandidateType,
    bool Function()? nominated,
    int Function()? packetsDiscardedOnSend,
    int Function()? packetsReceived,
    int Function()? packetsSent,
    String Function()? remoteCandidateAddress,
    String Function()? remoteCandidateId,
    int Function()? remoteCandidatePort,
    String Function()? remoteCandidateProtocol,
    String Function()? remoteCandidateType,
    double Function()? totalRoundTripTime,
  }) {
    return GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport(
      availableOutgoingBitrate: availableOutgoingBitrate != null
          ? availableOutgoingBitrate()
          : this.availableOutgoingBitrate,
      bytesDiscardedOnSend: bytesDiscardedOnSend != null
      ...
      currentRoundTripTime: currentRoundTripTime != null
          ? currentRoundTripTime()
          : this.currentRoundTripTime,
      lastPacketReceivedTimestamp: lastPacketReceivedTimestamp != null
          ? lastPacketReceivedTimestamp()
          : this.lastPacketReceivedTimestamp,
      lastPacketSentTimestamp: lastPacketSentTimestamp != null
          ? lastPacketSentTimestamp()
          : this.lastPacketSentTimestamp,
      localCandidateAddress: localCandidateAddress != null
          ? localCandidateAddress()
          : this.localCandidateAddress,
      localCandidateId: localCandidateId != null
          ? localCandidateId()
          : this.localCandidateId,
      localCandidateNetworkType: localCandidateNetworkType != null
          ? localCandidateNetworkType()
          : this.localCandidateNetworkType,
      localCandidatePort: localCandidatePort != null
          ? localCandidatePort()
          : this.localCandidatePort,
      localCandidateProtocol: localCandidateProtocol != null
          ? localCandidateProtocol()
          : this.localCandidateProtocol,
      localCandidateRelatedAddress: localCandidateRelatedAddress != null
          ? localCandidateRelatedAddress()
          : this.localCandidateRelatedAddress,
      localCandidateRelatedPort: localCandidateRelatedPort != null
          ? localCandidateRelatedPort()
          : this.localCandidateRelatedPort,
      localCandidateType: localCandidateType != null
          ? localCandidateType()
          : this.localCandidateType,
      nominated: nominated != null ? nominated() : this.nominated,
      packetsDiscardedOnSend: packetsDiscardedOnSend != null
      ...
      remoteCandidateAddress: remoteCandidateAddress != null
          ? remoteCandidateAddress()
          : this.remoteCandidateAddress,
      remoteCandidateId: remoteCandidateId != null
          ? remoteCandidateId()
          : this.remoteCandidateId,
      remoteCandidatePort: remoteCandidatePort != null
          ? remoteCandidatePort()
          : this.remoteCandidatePort,
      remoteCandidateProtocol: remoteCandidateProtocol != null
          ? remoteCandidateProtocol()
          : this.remoteCandidateProtocol,
      remoteCandidateType: remoteCandidateType != null
          ? remoteCandidateType()
          : this.remoteCandidateType,
      totalRoundTripTime: totalRoundTripTime != null
          ? totalRoundTripTime()
          : this.totalRoundTripTime,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is GetParticipantDataFromPeerIdResponseDataParticipantPeerReportMetadataCandidatePairsProducingTransport &&
            ...
            localCandidateRelatedAddress ==
                other.localCandidateRelatedAddress &&
