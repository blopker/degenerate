...
import 'realtimekit_recording_status.dart';

final class RealtimekitRecording {
  const RealtimekitRecording({
    required this.audioDownloadUrl,
    required this.downloadUrl,
    required this.downloadUrlExpiry,
  ...
  factory RealtimekitRecording.fromJson(Map<String, dynamic> json) {
    return RealtimekitRecording(
      ...
      recordingDuration: json['recording_duration'] != null
          ? (json['recording_duration'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('audio_download_url') &&
        json['audio_download_url'] is String &&
        json.containsKey('download_url') &&
        json['download_url'] is String &&
        json.containsKey('download_url_expiry') &&
        json['download_url_expiry'] is String &&
        json.containsKey('file_size') &&
        json['file_size'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('invoked_time') &&
        json['invoked_time'] is String &&
        json.containsKey('output_file_name') &&
        json['output_file_name'] is String &&
        json.containsKey('session_id') &&
        json['session_id'] is String &&
        json.containsKey('started_time') &&
        json['started_time'] is String &&
        json.containsKey('status') &&
        json.containsKey('stopped_time') &&
        json['stopped_time'] is String;
  }

  RealtimekitRecording copyWith({
    Uri? Function()? audioDownloadUrl,
    Uri? Function()? downloadUrl,
    DateTime? Function()? downloadUrlExpiry,
    double? Function()? fileSize,
    String? id,
    DateTime? invokedTime,
    String? outputFileName,
    int Function()? recordingDuration,
    String? Function()? sessionId,
    DateTime? Function()? startedTime,
    RealtimekitRecordingStatus? status,
    ...
    return RealtimekitRecording(
      ...
      downloadUrlExpiry: downloadUrlExpiry != null
          ? downloadUrlExpiry()
