...
import 'package:collection/collection.dart';import 'aig_config_update_gateway_request_dlp.dart';import 'aig_config_update_gateway_request_log_management_strategy.dart';import 'aig_config_update_gateway_request_otel.dart';import 'aig_config_update_gateway_request_rate_limiting_technique.dart';import 'aig_config_update_gateway_request_stripe.dart';import 'aig_config_update_gateway_request_workers_ai_billing_mode.dart';final class AigConfigUpdateGatewayRequest {const AigConfigUpdateGatewayRequest({this.authentication, required this.cacheInvalidateOnUpdate, required this.cacheTtl, required this.collectLogs, this.dlp, this.logManagement, this.logManagementStrategy, this.logpush, this.logpushPublicKey, this.otel, required this.rateLimitingInterval, required this.rateLimitingLimit, required this.rateLimitingTechnique, this.storeId, this.stripe, this.workersAiBillingMode = AigConfigUpdateGatewayRequestWorkersAiBillingMode.postpaid, this.zdr, });
