...
import 'package:collection/collection.dart';final class IntelWhois {const IntelWhois({this.createdDate, this.domain, this.nameservers, this.registrant, this.registrantCountry, this.registrantEmail, this.registrantOrg, this.registrar, this.updatedDate, });
...
IntelWhois copyWith({String Function()? createdDate, String Function()? domain, List<String> Function()? nameservers, String Function()? registrant, String Function()? registrantCountry, String Function()? registrantEmail, String Function()? registrantOrg, String Function()? registrar, String Function()? updatedDate, }) { return IntelWhois(
