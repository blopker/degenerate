...
import 'stream_media_status.dart';
import 'stream_playback.dart';
import 'stream_watermarks.dart';

final class StreamVideos {
  const StreamVideos({
    this.allowedOrigins,
    this.created,
    this.creator,
  ...
  factory StreamVideos.fromJson(Map<String, dynamic> json) {
    return StreamVideos(
      ...
      preview: json['preview'] != null
          ? Uri.parse(json['preview'] as String)
          : null,
      readyToStream: json['readyToStream'] as bool?,
      readyToStreamAt: json['readyToStreamAt'] != null
          ? DateTime.parse(json['readyToStreamAt'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (readyToStreamAt != null)
        'readyToStreamAt': readyToStreamAt?.toIso8601String(),
  ...
  StreamVideos copyWith({
    ...
    return StreamVideos(
      ...
      readyToStream: readyToStream != null
          ? readyToStream()
          : this.readyToStream,
      readyToStreamAt: readyToStreamAt != null
          ? readyToStreamAt()
          : this.readyToStreamAt,
