...
import 'fetch_gateways_response_result_servers_auth_type.dart';
import 'inline_object189.dart';
import 'inline_object190.dart';

final class FetchGatewaysResponseResultServers {
  const FetchGatewaysResponseResultServers({
  ...
  factory FetchGatewaysResponseResultServers.fromJson(
    Map<String, dynamic> json,
  ) {
    return FetchGatewaysResponseResultServers(
      authType: FetchGatewaysResponseResultServersAuthType.fromJson(
      ...
      updatedPrompts: (json['updated_prompts'] as List<dynamic>)
          .map(
            (e) => (e as Map<String, dynamic>).map(
              (k, v) => MapEntry(
                k,
                InlineObject189.fromJson(v as Map<String, dynamic>),
              ),
            ),
          )
          .toList(),
      updatedTools: (json['updated_tools'] as List<dynamic>)
          .map(
            (e) => (e as Map<String, dynamic>).map(
              (k, v) => MapEntry(
                k,
                InlineObject190.fromJson(v as Map<String, dynamic>),
              ),
            ),
          )
          .toList(),
  ...
  final List<Map<String, InlineObject190>> updatedTools;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('auth_type') &&
  ...
  FetchGatewaysResponseResultServers copyWith({
    FetchGatewaysResponseResultServersAuthType? authType,
    ...
    Uri? hostname,
    String? id,
    DateTime Function()? lastSuccessfulSync,
    ...
    List<Map<String, InlineObject189>>? updatedPrompts,
    List<Map<String, InlineObject190>>? updatedTools,
  }) {
    return FetchGatewaysResponseResultServers(
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(updatedPrompts),
      Object.hashAll(updatedTools),
    );
  }
