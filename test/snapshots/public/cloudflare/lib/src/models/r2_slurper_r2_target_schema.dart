...
import 'r2_slurper_jurisdiction.dart';import 'r2_slurper_r2_target_schema_vendor.dart';import 'r2_slurper_s3_like_creds_schema.dart';final class R2SlurperR2TargetSchema {const R2SlurperR2TargetSchema({required this.bucket, this.jurisdiction, required this.secret, required this.vendor, });
