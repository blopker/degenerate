...
final class LoadBalancingMonitorGroupMember {const LoadBalancingMonitorGroupMember({this.createdAt, required this.enabled, required this.monitorId, required this.monitoringOnly, required this.mustBeHealthy, this.updatedAt, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('enabled') && json['enabled'] is bool &&
      json.containsKey('monitor_id') && json['monitor_id'] is String &&
...
LoadBalancingMonitorGroupMember copyWith({DateTime Function()? createdAt, bool? enabled, String? monitorId, bool? monitoringOnly, bool? mustBeHealthy, DateTime Function()? updatedAt, }) { return LoadBalancingMonitorGroupMember(
