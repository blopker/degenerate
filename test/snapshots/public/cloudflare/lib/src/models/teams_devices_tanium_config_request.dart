...
final class TeamsDevicesTaniumConfigRequest {
  ...
  factory TeamsDevicesTaniumConfigRequest.fromJson(Map<String, dynamic> json) {
    return TeamsDevicesTaniumConfigRequest(
  ...
  TeamsDevicesTaniumConfigRequest copyWith({
    String Function()? accessClientId,
    String Function()? accessClientSecret,
    String? apiUrl,
    String? clientSecret,
  }) {
    return TeamsDevicesTaniumConfigRequest(
  ...
  @override
  String toString() {
    return 'TeamsDevicesTaniumConfigRequest(accessClientId: $accessClientId, accessClientSecret: $accessClientSecret, apiUrl: $apiUrl, clientSecret: $clientSecret)';
  }
}
