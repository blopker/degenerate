...
///
final class RealtimekitRecordingConfig {
  const RealtimekitRecordingConfig({
    this.audioConfig,
    this.fileNamePrefix,
  ...
  factory RealtimekitRecordingConfig.fromJson(Map<String, dynamic> json) {
    return RealtimekitRecordingConfig(
      ...
      liveStreamingConfig: json['live_streaming_config'] != null
          ? RealtimekitLivestreamingConfig.fromJson(
              json['live_streaming_config'] as Map<String, dynamic>,
            )
          : null,
      maxSeconds: json['max_seconds'] != null
          ? (json['max_seconds'] as num).toDouble()
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (liveStreamingConfig != null)
        'live_streaming_config': liveStreamingConfig?.toJson(),
  ...
  RealtimekitRecordingConfig copyWith({
    RealtimekitAudioConfig Function()? audioConfig,
    String Function()? fileNamePrefix,
    RealtimekitLivestreamingConfig Function()? liveStreamingConfig,
    double Function()? maxSeconds,
    ...
    return RealtimekitRecordingConfig(
      ...
      fileNamePrefix: fileNamePrefix != null
          ? fileNamePrefix()
          : this.fileNamePrefix,
      liveStreamingConfig: liveStreamingConfig != null
          ? liveStreamingConfig()
          : this.liveStreamingConfig,
  ...
  @override
  String toString() {
    return 'RealtimekitRecordingConfig(audioConfig: $audioConfig, fileNamePrefix: $fileNamePrefix, liveStreamingConfig: $liveStreamingConfig, maxSeconds: $maxSeconds, realtimekitBucketConfig: $realtimekitBucketConfig, storageConfig: $storageConfig, videoConfig: $videoConfig)';
  }
}
