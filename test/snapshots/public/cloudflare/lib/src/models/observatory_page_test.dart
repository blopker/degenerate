...
import 'observatory_labeled_region.dart';import 'observatory_lighthouse_report.dart';import 'observatory_schedule_frequency.dart';final class ObservatoryPageTest {const ObservatoryPageTest({this.date, this.desktopReport, this.id, this.mobileReport, this.region, this.scheduleFrequency, this.url, });
...
ObservatoryPageTest copyWith({DateTime Function()? date, ObservatoryLighthouseReport Function()? desktopReport, String Function()? id, ObservatoryLighthouseReport Function()? mobileReport, ObservatoryLabeledRegion Function()? region, ObservatoryScheduleFrequency Function()? scheduleFrequency, String Function()? url, }) { return ObservatoryPageTest(
