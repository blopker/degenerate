...
import 'package:collection/collection.dart';final class DnsAnalyticsQuery {const DnsAnalyticsQuery({required this.dimensions, this.filters, required this.limit, required this.metrics, required this.since, this.sort, required this.until, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('dimensions') &&
      ...
      json.containsKey('until') && json['until'] is String; } 
DnsAnalyticsQuery copyWith({List<String>? dimensions, String Function()? filters, int? limit, List<String>? metrics, DateTime? since, List<String> Function()? sort, DateTime? until, }) { return DnsAnalyticsQuery(
