...
final class IamPermissions {
  ...
  factory IamPermissions.fromJson(Map<String, dynamic> json) {
  ...
  IamPermissions copyWith({
    IamGrants Function()? analytics,
    IamGrants Function()? billing,
    IamGrants Function()? cachePurge,
    IamGrants Function()? dns,
    IamGrants Function()? dnsRecords,
    IamGrants Function()? lb,
    IamGrants Function()? logs,
    IamGrants Function()? organization,
    IamGrants Function()? ssl,
    IamGrants Function()? waf,
    IamGrants Function()? zoneSettings,
    IamGrants Function()? zones,
  }) {
    return IamPermissions(
  ...
  @override
  String toString() {
    return 'IamPermissions(analytics: $analytics, billing: $billing, cachePurge: $cachePurge, dns: $dns, dnsRecords: $dnsRecords, lb: $lb, logs: $logs, organization: $organization, ssl: $ssl, waf: $waf, zoneSettings: $zoneSettings, zones: $zones)';
  }
}
