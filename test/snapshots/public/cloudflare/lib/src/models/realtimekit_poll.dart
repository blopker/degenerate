...
import 'package:collection/collection.dart';import 'realtimekit_poll_options.dart';final class RealtimekitPoll {const RealtimekitPoll({this.anonymous, this.createdBy, this.hideVotes, required this.id, required this.options, required this.question, this.voted, });
