...
import 'package:collection/collection.dart';final class WorkersBindingKindSendEmail {const WorkersBindingKindSendEmail({this.allowedDestinationAddresses, this.allowedSenderAddresses, this.destinationAddress, required this.name, required this.type, });
...
WorkersBindingKindSendEmail copyWith({List<String> Function()? allowedDestinationAddresses, List<String> Function()? allowedSenderAddresses, String Function()? destinationAddress, String? name, String? type, }) { return WorkersBindingKindSendEmail(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersBindingKindSendEmail &&
          const ListEquality<dynamic>().equals(allowedDestinationAddresses, other.allowedDestinationAddresses) &&
          const ListEquality<dynamic>().equals(allowedSenderAddresses, other.allowedSenderAddresses) &&
