...
final class UsageResponse {
  ...
  UsageResponse copyWith({
    List<Message>? Function()? errors,
  ...
  @override
  String toString() {
    return 'UsageResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
  }
}
