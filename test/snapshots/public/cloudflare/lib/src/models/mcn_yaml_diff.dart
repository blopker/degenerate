...
final class McnYamlDiff {
  ...
  factory McnYamlDiff.fromJson(Map<String, dynamic> json) {
    return McnYamlDiff(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('diff') &&
        json['diff'] is String &&
        json.containsKey('left_description') &&
        json['left_description'] is String &&
        json.containsKey('left_yaml') &&
        json['left_yaml'] is String &&
        json.containsKey('right_description') &&
        json['right_description'] is String &&
        json.containsKey('right_yaml') &&
        json['right_yaml'] is String;
  }

  McnYamlDiff copyWith({
    String? diff,
  ...
  @override
  String toString() {
    return 'McnYamlDiff(diff: $diff, leftDescription: $leftDescription, leftYaml: $leftYaml, rightDescription: $rightDescription, rightYaml: $rightYaml)';
  }
}
