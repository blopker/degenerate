...
final class $5Img2imgRequest {
  const $5Img2imgRequest({
    this.guidance = 7.5,
    this.height,
    this.image,
    this.imageB64,
  ...
  factory $5Img2imgRequest.fromJson(Map<String, dynamic> json) {
    return $5Img2imgRequest(
  ...
  @override
  String toString() {
    return '\$5Img2imgRequest(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)';
  }
}
