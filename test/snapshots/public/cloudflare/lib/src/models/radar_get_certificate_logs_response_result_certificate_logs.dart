...
import 'radar_get_certificate_logs_response_result_certificate_logs_api.dart';
import 'radar_get_certificate_logs_response_result_certificate_logs_state.dart';

final class RadarGetCertificateLogsResponseResultCertificateLogs {
  const RadarGetCertificateLogsResponseResultCertificateLogs({
    required this.api,
  ...
  factory RadarGetCertificateLogsResponseResultCertificateLogs.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetCertificateLogsResponseResultCertificateLogs(
      api: RadarGetCertificateLogsResponseResultCertificateLogsApi.fromJson(
        json['api'] as String,
      ),
      ...
      state: RadarGetCertificateLogsResponseResultCertificateLogsState.fromJson(
  ...
  RadarGetCertificateLogsResponseResultCertificateLogs copyWith({
    RadarGetCertificateLogsResponseResultCertificateLogsApi? api,
    String? description,
    DateTime? endExclusive,
    String? $operator,
    String? slug,
    DateTime? startInclusive,
    RadarGetCertificateLogsResponseResultCertificateLogsState? state,
  ...
  @override
  String toString() {
    return 'RadarGetCertificateLogsResponseResultCertificateLogs(api: $api, description: $description, endExclusive: $endExclusive, \$operator: ${$operator}, slug: $slug, startInclusive: $startInclusive, state: $state, stateTimestamp: $stateTimestamp, url: $url)';
  }
}
