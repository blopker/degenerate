...
import 'urlscanner_get_scan_response2_stats_domain_stats.dart';
import 'urlscanner_get_scan_response2_stats_ip_stats.dart';
import 'urlscanner_get_scan_response2_stats_protocol_stats.dart';
import 'urlscanner_get_scan_response2_stats_resource_stats.dart';
import 'urlscanner_get_scan_response2_stats_server_stats.dart';
import 'urlscanner_get_scan_response2_stats_tls_stats.dart';

final class UrlscannerGetScanResponse2Stats {
  const UrlscannerGetScanResponse2Stats({
  ...
  factory UrlscannerGetScanResponse2Stats.fromJson(Map<String, dynamic> json) {
    return UrlscannerGetScanResponse2Stats(
      iPv6Percentage: (json['IPv6Percentage'] as num).toDouble(),
      domainStats: (json['domainStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsDomainStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ipStats: (json['ipStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsIpStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      malicious: (json['malicious'] as num).toDouble(),
      protocolStats: (json['protocolStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsProtocolStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      resourceStats: (json['resourceStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsResourceStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      serverStats: (json['serverStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsServerStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      tlsStats: (json['tlsStats'] as List<dynamic>)
          .map(
            (e) => UrlscannerGetScanResponse2StatsTlsStats.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('IPv6Percentage') &&
        json['IPv6Percentage'] is num &&
        json.containsKey('domainStats') &&
        json.containsKey('ipStats') &&
        json.containsKey('malicious') &&
        json['malicious'] is num &&
        json.containsKey('protocolStats') &&
        json.containsKey('resourceStats') &&
        json.containsKey('securePercentage') &&
        json['securePercentage'] is num &&
        json.containsKey('secureRequests') &&
        json['secureRequests'] is num &&
        json.containsKey('serverStats') &&
        json.containsKey('tlsStats') &&
        json.containsKey('totalLinks') &&
        json['totalLinks'] is num &&
        json.containsKey('uniqASNs') &&
        json['uniqASNs'] is num &&
        json.containsKey('uniqCountries') &&
        json['uniqCountries'] is num;
  }

  UrlscannerGetScanResponse2Stats copyWith({
    double? iPv6Percentage,
    List<UrlscannerGetScanResponse2StatsDomainStats>? domainStats,
    List<UrlscannerGetScanResponse2StatsIpStats>? ipStats,
    double? malicious,
    List<UrlscannerGetScanResponse2StatsProtocolStats>? protocolStats,
    List<UrlscannerGetScanResponse2StatsResourceStats>? resourceStats,
    double? securePercentage,
    double? secureRequests,
    List<UrlscannerGetScanResponse2StatsServerStats>? serverStats,
    List<UrlscannerGetScanResponse2StatsTlsStats>? tlsStats,
    double? totalLinks,
    double? uniqAsNs,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is UrlscannerGetScanResponse2Stats &&
            ...
            const ListEquality<dynamic>().equals(ipStats, other.ipStats) &&
            ...
            const ListEquality<dynamic>().equals(tlsStats, other.tlsStats) &&
  ...
  int get hashCode {
    return Object.hash(
      iPv6Percentage,
      Object.hashAll(domainStats),
      Object.hashAll(ipStats),
      malicious,
      Object.hashAll(protocolStats),
      Object.hashAll(resourceStats),
      securePercentage,
      secureRequests,
      Object.hashAll(serverStats),
      Object.hashAll(tlsStats),
      totalLinks,
      uniqAsNs,
      uniqCountries,
    );
