...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UrlscannerGetScanResponse2Stats &&
          ...
          const ListEquality<dynamic>().equals(domainStats, other.domainStats) &&
          const ListEquality<dynamic>().equals(ipStats, other.ipStats) &&
          malicious == other.malicious &&
          const ListEquality<dynamic>().equals(protocolStats, other.protocolStats) &&
          const ListEquality<dynamic>().equals(resourceStats, other.resourceStats) &&
          securePercentage == other.securePercentage &&
          secureRequests == other.secureRequests &&
          const ListEquality<dynamic>().equals(serverStats, other.serverStats) &&
