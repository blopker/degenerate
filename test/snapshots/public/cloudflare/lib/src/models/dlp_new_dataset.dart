...
final class DlpNewDataset {
  ...
  factory DlpNewDataset.fromJson(Map<String, dynamic> json) {
    return DlpNewDataset(
  ...
  @override
  String toString() {
    return 'DlpNewDataset(caseSensitive: $caseSensitive, description: $description, encodingVersion: $encodingVersion, name: $name, secret: $secret)';
  }
}
