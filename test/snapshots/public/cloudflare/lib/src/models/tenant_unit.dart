...
final class TenantUnit {
  ...
  factory TenantUnit.fromJson(Map<String, dynamic> json) {
    return TenantUnit(
      unitMemberships: (json['unit_memberships'] as List<dynamic>)
          .map(
          ...
          .toList(),
      unitMetadata: (json['unit_metadata'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, v as String),
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('unit_memberships') &&
        json.containsKey('unit_metadata') &&
        json.containsKey('unit_name') &&
        json['unit_name'] is String &&
        json.containsKey('unit_status') &&
        json['unit_status'] is String &&
        json.containsKey('unit_tag') &&
        json['unit_tag'] is String;
  }

  TenantUnit copyWith({
    List<Map<String, String>>? unitMemberships,
    Map<String, String>? unitMetadata,
    String? unitName,
    String? unitStatus,
    String? unitTag,
  }) {
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(unitMemberships),
      unitMetadata,
      unitName,
      unitStatus,
      unitTag,
  ...
  @override
  String toString() {
    return 'TenantUnit(unitMemberships: $unitMemberships, unitMetadata: $unitMetadata, unitName: $unitName, unitStatus: $unitStatus, unitTag: $unitTag)';
  }
}
