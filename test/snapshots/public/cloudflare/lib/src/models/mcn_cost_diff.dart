...
final class McnCostDiff {
  ...
  factory McnCostDiff.fromJson(Map<String, dynamic> json) {
    return McnCostDiff(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('currency') &&
        ...
        json.containsKey('current_monthly_cost') &&
        json['current_monthly_cost'] is num &&
        json.containsKey('diff') &&
        json['diff'] is num &&
        json.containsKey('proposed_monthly_cost') &&
        json['proposed_monthly_cost'] is num;
  }

  McnCostDiff copyWith({
    String? currency,
    double? currentMonthlyCost,
    double? diff,
    double? proposedMonthlyCost,
  }) {
    return McnCostDiff(
  ...
  @override
  int get hashCode {
    return Object.hash(currency, currentMonthlyCost, diff, proposedMonthlyCost);
  }

  @override
  String toString() {
    return 'McnCostDiff(currency: $currency, currentMonthlyCost: $currentMonthlyCost, diff: $diff, proposedMonthlyCost: $proposedMonthlyCost)';
  }
}
