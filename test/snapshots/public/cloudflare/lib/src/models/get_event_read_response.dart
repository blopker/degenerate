...
final class GetEventReadResponse {
  const GetEventReadResponse({
  ...
  factory GetEventReadResponse.fromJson(Map<String, dynamic> json) {
    return GetEventReadResponse(
