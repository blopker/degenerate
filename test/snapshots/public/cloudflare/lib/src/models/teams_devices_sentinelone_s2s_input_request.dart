...
import 'teams_devices_sentinelone_s2s_input_request_network_status.dart';import 'teams_devices_sentinelone_s2s_input_request_operational_state.dart';import 'teams_devices_sentinelone_s2s_input_request_operator.dart';final class TeamsDevicesSentineloneS2sInputRequest {const TeamsDevicesSentineloneS2sInputRequest({this.activeThreats, required this.connectionId, this.infected, this.isActive, this.networkStatus, this.operationalState, this.$operator, });
