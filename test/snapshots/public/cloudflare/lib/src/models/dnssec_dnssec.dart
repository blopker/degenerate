...
final class DnssecDnssec {
  ...
  factory DnssecDnssec.fromJson(Map<String, dynamic> json) {
    return DnssecDnssec(
      ...
      keyTag: json['key_tag'] != null
          ? (json['key_tag'] as num).toDouble()
          : null,
  ...
  DnssecDnssec copyWith({
    String? Function()? algorithm,
    String? Function()? digest,
    String? Function()? digestAlgorithm,
    String? Function()? digestType,
    bool Function()? dnssecMultiSigner,
    bool Function()? dnssecPresigned,
    bool Function()? dnssecUseNsec3,
    String? Function()? ds,
    double? Function()? flags,
    double? Function()? keyTag,
    ...
    return DnssecDnssec(
      ...
      dnssecMultiSigner: dnssecMultiSigner != null
          ? dnssecMultiSigner()
          : this.dnssecMultiSigner,
      dnssecPresigned: dnssecPresigned != null
          ? dnssecPresigned()
          : this.dnssecPresigned,
      dnssecUseNsec3: dnssecUseNsec3 != null
          ? dnssecUseNsec3()
          : this.dnssecUseNsec3,
  ...
  @override
  String toString() {
    return 'DnssecDnssec(algorithm: $algorithm, digest: $digest, digestAlgorithm: $digestAlgorithm, digestType: $digestType, dnssecMultiSigner: $dnssecMultiSigner, dnssecPresigned: $dnssecPresigned, dnssecUseNsec3: $dnssecUseNsec3, ds: $ds, flags: $flags, keyTag: $keyTag, keyType: $keyType, modifiedOn: $modifiedOn, publicKey: $publicKey, status: $status)';
  }
}
