...
final class GetTagListResponseTags {
  const GetTagListResponseTags({
    this.activeDuration,
    this.actorCategory,
  ...
  factory GetTagListResponseTags.fromJson(Map<String, dynamic> json) {
    return GetTagListResponseTags(
  ...
  GetTagListResponseTags copyWith({
