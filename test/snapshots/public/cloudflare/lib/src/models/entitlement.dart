...
import 'entitlement_allocation.dart';import 'feature.dart';final class Entitlement {const Entitlement({required this.allocation, required this.feature, });

factory Entitlement.fromJson(Map<String, dynamic> json) { return Entitlement(
  allocation: EntitlementAllocation.fromJson(json['allocation'] as Map<String, dynamic>),
