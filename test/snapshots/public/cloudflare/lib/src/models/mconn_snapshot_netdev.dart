...
/// Snapshot Netdev
final class MconnSnapshotNetdev {
  const MconnSnapshotNetdev({
    this.connectorId,
    required this.name,
  ...
  factory MconnSnapshotNetdev.fromJson(Map<String, dynamic> json) {
    return MconnSnapshotNetdev(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('recv_bytes') &&
        json['recv_bytes'] is num &&
        json.containsKey('recv_compressed') &&
        json['recv_compressed'] is num &&
        json.containsKey('recv_drop') &&
        json['recv_drop'] is num &&
        json.containsKey('recv_errs') &&
        json['recv_errs'] is num &&
        json.containsKey('recv_fifo') &&
        json['recv_fifo'] is num &&
        json.containsKey('recv_frame') &&
        json['recv_frame'] is num &&
        json.containsKey('recv_multicast') &&
        json['recv_multicast'] is num &&
        json.containsKey('recv_packets') &&
        json['recv_packets'] is num &&
        json.containsKey('sent_bytes') &&
        json['sent_bytes'] is num &&
        json.containsKey('sent_carrier') &&
        json['sent_carrier'] is num &&
        json.containsKey('sent_colls') &&
        json['sent_colls'] is num &&
        json.containsKey('sent_compressed') &&
        json['sent_compressed'] is num &&
        json.containsKey('sent_drop') &&
        json['sent_drop'] is num &&
        json.containsKey('sent_errs') &&
        json['sent_errs'] is num &&
        json.containsKey('sent_fifo') &&
        json['sent_fifo'] is num &&
        json.containsKey('sent_packets') &&
        json['sent_packets'] is num;
  }

  MconnSnapshotNetdev copyWith({
    String Function()? connectorId,
    String? name,
    double? recvBytes,
    double? recvCompressed,
    double? recvDrop,
    double? recvErrs,
    double? recvFifo,
    double? recvFrame,
    double? recvMulticast,
    double? recvPackets,
    double? sentBytes,
    double? sentCarrier,
    double? sentColls,
    double? sentCompressed,
    double? sentDrop,
    double? sentErrs,
    double? sentFifo,
    double? sentPackets,
