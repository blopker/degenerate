...
import 'destination_update_response404_errors_message.dart';final class DestinationUpdateResponse404Errors {const DestinationUpdateResponse404Errors({this.detail, required this.message, });
