...
final class MconnAdminDeviceFields {
  const MconnAdminDeviceFields({
    this.cryptKey,
  ...
  factory MconnAdminDeviceFields.fromJson(Map<String, dynamic> json) {
    return MconnAdminDeviceFields(
      cryptKey: json['crypt_key'] as String?,
      cryptKeyRotationFinishedAt:
          json['crypt_key_rotation_finished_at'] as String?,
      cryptKeyRotationOutput: json['crypt_key_rotation_output'] as String?,
      cryptKeyRotationStartedAt:
          json['crypt_key_rotation_started_at'] as String?,
      cryptKeyRotationStatusCode: json['crypt_key_rotation_status_code'] != null
          ? (json['crypt_key_rotation_status_code'] as num).toDouble()
          : null,
      ...
      pkiRotationStatusCode: json['pki_rotation_status_code'] != null
          ? (json['pki_rotation_status_code'] as num).toDouble()
          : null,
  ...
  MconnAdminDeviceFields copyWith({
    String Function()? cryptKey,
    String Function()? cryptKeyRotationFinishedAt,
    String Function()? cryptKeyRotationOutput,
    String Function()? cryptKeyRotationStartedAt,
    double Function()? cryptKeyRotationStatusCode,
    String Function()? deviceType,
    String Function()? ekCert,
    String Function()? imagedAt,
    String Function()? lastCryptKey,
    String Function()? lastUpdated,
    String Function()? metadata,
    String Function()? pkiRotationFinishedAt,
    String Function()? pkiRotationOutput,
    String Function()? pkiRotationStartedAt,
    double Function()? pkiRotationStatusCode,
    String Function()? serialNumber,
  }) {
    return MconnAdminDeviceFields(
      cryptKey: cryptKey != null ? cryptKey() : this.cryptKey,
      cryptKeyRotationFinishedAt: cryptKeyRotationFinishedAt != null
          ? cryptKeyRotationFinishedAt()
          : this.cryptKeyRotationFinishedAt,
      cryptKeyRotationOutput: cryptKeyRotationOutput != null
          ? cryptKeyRotationOutput()
          : this.cryptKeyRotationOutput,
      cryptKeyRotationStartedAt: cryptKeyRotationStartedAt != null
          ? cryptKeyRotationStartedAt()
          : this.cryptKeyRotationStartedAt,
      cryptKeyRotationStatusCode: cryptKeyRotationStatusCode != null
      ...
      pkiRotationFinishedAt: pkiRotationFinishedAt != null
          ? pkiRotationFinishedAt()
          : this.pkiRotationFinishedAt,
      pkiRotationOutput: pkiRotationOutput != null
          ? pkiRotationOutput()
          : this.pkiRotationOutput,
      pkiRotationStartedAt: pkiRotationStartedAt != null
          ? pkiRotationStartedAt()
          : this.pkiRotationStartedAt,
      pkiRotationStatusCode: pkiRotationStatusCode != null
  ...
  @override
  String toString() {
    return 'MconnAdminDeviceFields(cryptKey: $cryptKey, cryptKeyRotationFinishedAt: $cryptKeyRotationFinishedAt, cryptKeyRotationOutput: $cryptKeyRotationOutput, cryptKeyRotationStartedAt: $cryptKeyRotationStartedAt, cryptKeyRotationStatusCode: $cryptKeyRotationStatusCode, deviceType: $deviceType, ekCert: $ekCert, imagedAt: $imagedAt, lastCryptKey: $lastCryptKey, lastUpdated: $lastUpdated, metadata: $metadata, pkiRotationFinishedAt: $pkiRotationFinishedAt, pkiRotationOutput: $pkiRotationOutput, pkiRotationStartedAt: $pkiRotationStartedAt, pkiRotationStatusCode: $pkiRotationStatusCode, serialNumber: $serialNumber)';
  }
}
