...
import 'tls_certificates_and_hostnames_base.dart';
import 'tls_certificates_and_hostnames_bundle_method.dart';
import 'tls_certificates_and_hostnames_geo_restrictions.dart';
import 'tls_certificates_and_hostnames_status.dart';

final class TlsCertificatesAndHostnamesCustomCertificate {
  const TlsCertificatesAndHostnamesCustomCertificate({
    this.bundleMethod,
    this.expiresOn,
  ...
  factory TlsCertificatesAndHostnamesCustomCertificate.fromJson(
    Map<String, dynamic> json,
  ) {
    return TlsCertificatesAndHostnamesCustomCertificate(
      ...
      keylessServer: json['keyless_server'] != null
          ? TlsCertificatesAndHostnamesBase.fromJson(
              json['keyless_server'] as Map<String, dynamic>,
            )
          : null,
      ...
      status: json['status'] != null
          ? TlsCertificatesAndHostnamesStatus.fromJson(json['status'] as String)
          : null,
  ...
  TlsCertificatesAndHostnamesCustomCertificate copyWith({
    ...
    TlsCertificatesAndHostnamesBase Function()? keylessServer,
    DateTime Function()? modifiedOn,
    String Function()? policyRestrictions,
    double Function()? priority,
    String Function()? signature,
    TlsCertificatesAndHostnamesStatus Function()? status,
    ...
    return TlsCertificatesAndHostnamesCustomCertificate(
      ...
      keylessServer: keylessServer != null
          ? keylessServer()
          : this.keylessServer,
      modifiedOn: modifiedOn != null ? modifiedOn() : this.modifiedOn,
      policyRestrictions: policyRestrictions != null
          ? policyRestrictions()
          : this.policyRestrictions,
