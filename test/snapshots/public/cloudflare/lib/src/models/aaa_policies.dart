...
final class AaaPolicies {
  ...
  factory AaaPolicies.fromJson(Map<String, dynamic> json) {
    return AaaPolicies(
  ...
  @override
  String toString() {
    return 'AaaPolicies(alertInterval: $alertInterval, alertType: $alertType, created: $created, description: $description, enabled: $enabled, filters: $filters, id: $id, mechanisms: $mechanisms, modified: $modified, name: $name)';
  }
}
