...
/// Snapshot Disk
final class MconnSnapshotDisk {
  const MconnSnapshotDisk({
    this.connectorId,
    this.discards,
    this.discardsMerged,
    this.flushes,
  ...
  factory MconnSnapshotDisk.fromJson(Map<String, dynamic> json) {
    return MconnSnapshotDisk(
      connectorId: json['connector_id'] as String?,
      discards: json['discards'] != null
          ? (json['discards'] as num).toDouble()
          : null,
      discardsMerged: json['discards_merged'] != null
          ? (json['discards_merged'] as num).toDouble()
          : null,
      flushes: json['flushes'] != null
          ? (json['flushes'] as num).toDouble()
          : null,
      ...
      sectorsDiscarded: json['sectors_discarded'] != null
          ? (json['sectors_discarded'] as num).toDouble()
          : null,
      sectorsRead: (json['sectors_read'] as num).toDouble(),
      sectorsWritten: (json['sectors_written'] as num).toDouble(),
      timeDiscardingMs: json['time_discarding_ms'] != null
          ? (json['time_discarding_ms'] as num).toDouble()
          : null,
      timeFlushingMs: json['time_flushing_ms'] != null
          ? (json['time_flushing_ms'] as num).toDouble()
          : null,
      ...
      weightedTimeInProgressMs: (json['weighted_time_in_progress_ms'] as num)
          .toDouble(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('in_progress') &&
        json['in_progress'] is num &&
        json.containsKey('major') &&
        json['major'] is num &&
        json.containsKey('merged') &&
        json['merged'] is num &&
        json.containsKey('minor') &&
        json['minor'] is num &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('reads') &&
        json['reads'] is num &&
        json.containsKey('sectors_read') &&
        json['sectors_read'] is num &&
        json.containsKey('sectors_written') &&
        json['sectors_written'] is num &&
        json.containsKey('time_in_progress_ms') &&
        json['time_in_progress_ms'] is num &&
        json.containsKey('time_reading_ms') &&
        json['time_reading_ms'] is num &&
        json.containsKey('time_writing_ms') &&
        json['time_writing_ms'] is num &&
        json.containsKey('weighted_time_in_progress_ms') &&
        json['weighted_time_in_progress_ms'] is num &&
        json.containsKey('writes') &&
        json['writes'] is num &&
        json.containsKey('writes_merged') &&
        json['writes_merged'] is num;
  }

  MconnSnapshotDisk copyWith({
    String Function()? connectorId,
    double Function()? discards,
    double Function()? discardsMerged,
    double Function()? flushes,
    double? inProgress,
    double? major,
    double? merged,
    double? minor,
    String? name,
    double? reads,
    double Function()? sectorsDiscarded,
    double? sectorsRead,
    double? sectorsWritten,
    double Function()? timeDiscardingMs,
    double Function()? timeFlushingMs,
    double? timeInProgressMs,
    double? timeReadingMs,
    double? timeWritingMs,
    double? weightedTimeInProgressMs,
    double? writes,
    double? writesMerged,
  }) {
    return MconnSnapshotDisk(
      ...
      discardsMerged: discardsMerged != null
          ? discardsMerged()
          : this.discardsMerged,
      ...
      sectorsDiscarded: sectorsDiscarded != null
          ? sectorsDiscarded()
          : this.sectorsDiscarded,
      sectorsRead: sectorsRead ?? this.sectorsRead,
      sectorsWritten: sectorsWritten ?? this.sectorsWritten,
      timeDiscardingMs: timeDiscardingMs != null
          ? timeDiscardingMs()
          : this.timeDiscardingMs,
      timeFlushingMs: timeFlushingMs != null
          ? timeFlushingMs()
          : this.timeFlushingMs,
      ...
      weightedTimeInProgressMs:
          weightedTimeInProgressMs ?? this.weightedTimeInProgressMs,
