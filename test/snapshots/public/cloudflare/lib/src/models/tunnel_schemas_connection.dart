...
final class TunnelSchemasConnection {const TunnelSchemasConnection({this.clientId, this.clientVersion, this.coloName, this.id, this.isPendingReconnect, this.openedAt, this.originIp, this.uuid, });
...
TunnelSchemasConnection copyWith({String Function()? clientId, String Function()? clientVersion, String Function()? coloName, String Function()? id, bool Function()? isPendingReconnect, DateTime Function()? openedAt, String Function()? originIp, String Function()? uuid, }) { return TunnelSchemasConnection(
