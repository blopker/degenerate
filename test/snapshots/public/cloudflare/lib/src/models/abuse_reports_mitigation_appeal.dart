...
import 'abuse_reports_appeal_reason.dart';final class AbuseReportsMitigationAppeal {const AbuseReportsMitigationAppeal({required this.id, required this.reason, });
