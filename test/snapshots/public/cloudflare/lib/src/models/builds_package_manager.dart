...
final class BuildsPackageManager {
  const BuildsPackageManager._(this.value);

  factory BuildsPackageManager.fromJson(String json) {
    return switch (json) {
      'npm' => npm,
      'yarn' => yarn,
      'pnpm' => pnpm,
  ...
  @override
  String toString() {
    return 'BuildsPackageManager($value)';
  }
}
