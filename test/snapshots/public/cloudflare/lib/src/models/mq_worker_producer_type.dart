...
final class MqWorkerProducerType {
  const MqWorkerProducerType._(this.value);

  factory MqWorkerProducerType.fromJson(String json) {
    return switch (json) {
      'worker' => worker,
  ...
  @override
  String toString() {
    return 'MqWorkerProducerType($value)';
  }
}
