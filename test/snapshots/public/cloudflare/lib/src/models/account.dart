...
import 'account_settings.dart';import 'account_type.dart';final class Account {const Account({required this.createdOn, required this.id, required this.name, required this.settings, required this.type, });
