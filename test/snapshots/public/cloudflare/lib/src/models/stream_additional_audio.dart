...
import 'stream_audio_state.dart';final class StreamAdditionalAudio {const StreamAdditionalAudio({this.$default, this.label, this.status, this.uid, });
...
StreamAdditionalAudio copyWith({bool Function()? $default, String Function()? label, StreamAudioState Function()? status, String Function()? uid, }) { return StreamAdditionalAudio(
