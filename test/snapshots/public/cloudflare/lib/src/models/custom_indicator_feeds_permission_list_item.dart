...
final class CustomIndicatorFeedsPermissionListItem {const CustomIndicatorFeedsPermissionListItem({this.description, this.id, this.isAttributable, this.isDownloadable, this.isPublic, this.name, });
...
CustomIndicatorFeedsPermissionListItem copyWith({String Function()? description, int Function()? id, bool Function()? isAttributable, bool Function()? isDownloadable, bool Function()? isPublic, String Function()? name, }) { return CustomIndicatorFeedsPermissionListItem(
