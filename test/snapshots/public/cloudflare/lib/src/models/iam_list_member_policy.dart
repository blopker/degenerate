...
import 'package:collection/collection.dart';import 'iam_access.dart';import 'iam_permission_group.dart';import 'iam_resource_group.dart';final class IamListMemberPolicy {const IamListMemberPolicy({this.access, this.id, this.permissionGroups, this.resourceGroups, });
...
IamListMemberPolicy copyWith({IamAccess Function()? access, String Function()? id, List<IamPermissionGroup> Function()? permissionGroups, List<IamResourceGroup> Function()? resourceGroups, }) { return IamListMemberPolicy(
