...
final class MconnControllerUpgradeSlot {const MconnControllerUpgradeSlot({this.connectorId, required this.id, this.startedAt, });
...
MconnControllerUpgradeSlot copyWith({String Function()? connectorId, double? id, String Function()? startedAt, }) { return MconnControllerUpgradeSlot(
