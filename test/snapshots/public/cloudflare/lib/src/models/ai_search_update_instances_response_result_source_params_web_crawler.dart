...
import 'ai_search_update_instances_response_result_source_params_web_crawler_crawl_options.dart';import 'ai_search_update_instances_response_result_source_params_web_crawler_parse_options.dart';import 'ai_search_update_instances_response_result_source_params_web_crawler_parse_type.dart';import 'ai_search_update_instances_response_result_source_params_web_crawler_store_options.dart';final class AiSearchUpdateInstancesResponseResultSourceParamsWebCrawler {const AiSearchUpdateInstancesResponseResultSourceParamsWebCrawler({this.crawlOptions, this.parseOptions, this.parseType = AiSearchUpdateInstancesResponseResultSourceParamsWebCrawlerParseType.sitemap, this.storeOptions, });
...
factory AiSearchUpdateInstancesResponseResultSourceParamsWebCrawler.fromJson(Map<String, dynamic> json) { return AiSearchUpdateInstancesResponseResultSourceParamsWebCrawler(
  crawlOptions: json['crawl_options'] != null
        ? AiSearchUpdateInstancesResponseResultSourceParamsWebCrawlerCrawlOptions.fromJson(json['crawl_options'] as Map<String, dynamic>)
        : null,
  parseOptions: json['parse_options'] != null
        ? AiSearchUpdateInstancesResponseResultSourceParamsWebCrawlerParseOptions.fromJson(json['parse_options'] as Map<String, dynamic>)
        : null,
  ...
  storeOptions: json['store_options'] != null
        ? AiSearchUpdateInstancesResponseResultSourceParamsWebCrawlerStoreOptions.fromJson(json['store_options'] as Map<String, dynamic>)
        : null,
); }
