...
import 'addressing_provisioning.dart';final class AddressingServiceBinding {const AddressingServiceBinding({this.cidr, this.id, this.provisioning, this.serviceId, this.serviceName, });
...
AddressingServiceBinding copyWith({String Function()? cidr, String Function()? id, AddressingProvisioning Function()? provisioning, String Function()? serviceId, String Function()? serviceName, }) { return AddressingServiceBinding(
