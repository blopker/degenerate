...
import 'ai_search_instance_list_jobs_response_result_source.dart';final class AiSearchInstanceListJobsResponseResult {const AiSearchInstanceListJobsResponseResult({this.description, this.endReason, this.endedAt, required this.id, this.lastSeenAt, required this.source, this.startedAt, });
