...
final class AccessAllowedMethods2 {
  const AccessAllowedMethods2._(this.value);

  factory AccessAllowedMethods2.fromJson(String json) {
    return switch (json) {
      'GET' => $get,
      'POST' => post,
      'HEAD' => head,
  ...
  static const AccessAllowedMethods2 connect = AccessAllowedMethods2._(
    'CONNECT',
  );

  static const AccessAllowedMethods2 options = AccessAllowedMethods2._(
    'OPTIONS',
  );
  ...
  static const List<AccessAllowedMethods2> values = [
    $get,
    post,
    head,
    put,
  ...
  @override
  String toString() {
    return 'AccessAllowedMethods2($value)';
  }
}
