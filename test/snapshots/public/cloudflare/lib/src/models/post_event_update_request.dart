...
import 'post_event_update_request_raw.dart';

final class PostEventUpdateRequest {
  const PostEventUpdateRequest({
    this.attacker,
  ...
  factory PostEventUpdateRequest.fromJson(Map<String, dynamic> json) {
    return PostEventUpdateRequest(
      ...
      raw: json['raw'] != null
          ? PostEventUpdateRequestRaw.fromJson(
  ...
  PostEventUpdateRequest copyWith({
    ...
    PostEventUpdateRequestRaw Function()? raw,
  ...
  @override
  String toString() {
    return 'PostEventUpdateRequest(attacker: $attacker, attackerCountry: $attackerCountry, category: $category, createdAt: $createdAt, datasetId: $datasetId, date: $date, event: $event, indicator: $indicator, indicatorType: $indicatorType, insight: $insight, raw: $raw, targetCountry: $targetCountry, targetIndustry: $targetIndustry, tlp: $tlp)';
  }
}
