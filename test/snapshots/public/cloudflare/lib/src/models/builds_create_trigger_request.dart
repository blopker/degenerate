...
import 'package:collection/collection.dart';final class BuildsCreateTriggerRequest {const BuildsCreateTriggerRequest({required this.branchExcludes, required this.branchIncludes, this.buildCachingEnabled, required this.buildCommand, required this.buildTokenUuid, required this.deployCommand, required this.externalScriptId, required this.pathExcludes, required this.pathIncludes, required this.repoConnectionUuid, required this.rootDirectory, required this.triggerName, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('branch_excludes') &&
      ...
      json.containsKey('build_command') && json['build_command'] is String &&
      json.containsKey('build_token_uuid') && json['build_token_uuid'] is String &&
      json.containsKey('deploy_command') && json['deploy_command'] is String &&
      json.containsKey('external_script_id') && json['external_script_id'] is String &&
      json.containsKey('path_excludes') &&
      json.containsKey('path_includes') &&
      json.containsKey('repo_connection_uuid') && json['repo_connection_uuid'] is String &&
      json.containsKey('root_directory') && json['root_directory'] is String &&
      json.containsKey('trigger_name') && json['trigger_name'] is String; } 
BuildsCreateTriggerRequest copyWith({List<String>? branchExcludes, List<String>? branchIncludes, bool Function()? buildCachingEnabled, String? buildCommand, String? buildTokenUuid, String? deployCommand, String? externalScriptId, List<String>? pathExcludes, List<String>? pathIncludes, String? repoConnectionUuid, String? rootDirectory, String? triggerName, }) { return BuildsCreateTriggerRequest(
