...
import 'zaraz_zaraz_config_base_settings_context_enricher.dart';

/// General Zaraz settings.
final class ZarazZarazConfigBaseSettings {
  const ZarazZarazConfigBaseSettings({
  ...
  factory ZarazZarazConfigBaseSettings.fromJson(Map<String, dynamic> json) {
    return ZarazZarazConfigBaseSettings(
      autoInjectScript: json['autoInjectScript'] as bool,
      contextEnricher: json['contextEnricher'] != null
          ? ZarazZarazConfigBaseSettingsContextEnricher.fromJson(
              json['contextEnricher'] as Map<String, dynamic>,
            )
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('autoInjectScript') &&
        json['autoInjectScript'] is bool;
  }

  ZarazZarazConfigBaseSettings copyWith({
    bool? autoInjectScript,
    ZarazZarazConfigBaseSettingsContextEnricher Function()? contextEnricher,
    String Function()? cookieDomain,
    bool Function()? ecommerce,
    String Function()? eventsApiPath,
    bool Function()? hideExternalReferer,
    bool Function()? hideIpAddress,
    bool Function()? hideQueryParams,
    bool Function()? hideUserAgent,
    String Function()? initPath,
    bool Function()? injectIframes,
    String Function()? mcRootPath,
    String Function()? scriptPath,
    String Function()? trackPath,
  }) {
    return ZarazZarazConfigBaseSettings(
      autoInjectScript: autoInjectScript ?? this.autoInjectScript,
      contextEnricher: contextEnricher != null
          ? contextEnricher()
          : this.contextEnricher,
      cookieDomain: cookieDomain != null ? cookieDomain() : this.cookieDomain,
      ecommerce: ecommerce != null ? ecommerce() : this.ecommerce,
      eventsApiPath: eventsApiPath != null
          ? eventsApiPath()
          : this.eventsApiPath,
      hideExternalReferer: hideExternalReferer != null
          ? hideExternalReferer()
          : this.hideExternalReferer,
      hideIpAddress: hideIpAddress != null
          ? hideIpAddress()
          : this.hideIpAddress,
      hideQueryParams: hideQueryParams != null
          ? hideQueryParams()
          : this.hideQueryParams,
      hideUserAgent: hideUserAgent != null
          ? hideUserAgent()
          : this.hideUserAgent,
      initPath: initPath != null ? initPath() : this.initPath,
      injectIframes: injectIframes != null
          ? injectIframes()
          : this.injectIframes,
