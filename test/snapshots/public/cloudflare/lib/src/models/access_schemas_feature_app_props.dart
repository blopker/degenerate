...
import 'package:collection/collection.dart';import 'access_components_schemas_type.dart';final class AccessSchemasFeatureAppProps {const AccessSchemasFeatureAppProps({this.allowedIdps, this.autoRedirectToIdentity, this.domain, this.name, this.sessionDuration, required this.type, });
...
AccessSchemasFeatureAppProps copyWith({List<String> Function()? allowedIdps, bool Function()? autoRedirectToIdentity, String Function()? domain, String Function()? name, String Function()? sessionDuration, AccessComponentsSchemasType? type, }) { return AccessSchemasFeatureAppProps(
