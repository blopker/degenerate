...
import 'realtimekit_audio_config.dart';
import 'realtimekit_interactive_config.dart';
import 'realtimekit_livestreaming_config.dart';
import 'realtimekit_realtimekit_bucket_config.dart';
import 'realtimekit_storage_config.dart';
import 'realtimekit_video_config.dart';

final class StartRecordingRequest {
  const StartRecordingRequest({
    this.allowMultipleRecordings = false,
    this.audioConfig,
    this.fileNamePrefix,
  ...
  factory StartRecordingRequest.fromJson(Map<String, dynamic> json) {
    return StartRecordingRequest(
      allowMultipleRecordings: json.containsKey('allow_multiple_recordings')
          ? json['allow_multiple_recordings'] as bool
          : false,
      audioConfig: json['audio_config'] != null
          ? RealtimekitAudioConfig.fromJson(
              json['audio_config'] as Map<String, dynamic>,
            )
          : null,
      fileNamePrefix: json['file_name_prefix'] as String?,
      interactiveConfig: json['interactive_config'] != null
          ? RealtimekitInteractiveConfig.fromJson(
              json['interactive_config'] as Map<String, dynamic>,
            )
          : null,
      maxSeconds: json['max_seconds'] != null
          ? (json['max_seconds'] as num).toInt()
          : null,
      meetingId: json['meeting_id'] as String?,
      realtimekitBucketConfig: json['realtimekit_bucket_config'] != null
          ? RealtimekitRealtimekitBucketConfig.fromJson(
              json['realtimekit_bucket_config'] as Map<String, dynamic>,
            )
          : null,
      rtmpOutConfig: json['rtmp_out_config'] != null
          ? RealtimekitLivestreamingConfig.fromJson(
              json['rtmp_out_config'] as Map<String, dynamic>,
            )
          : null,
      ...
      videoConfig: json['video_config'] != null
          ? RealtimekitVideoConfig.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (interactiveConfig != null)
        'interactive_config': interactiveConfig?.toJson(),
      'max_seconds': ?maxSeconds,
      'meeting_id': ?meetingId,
      if (realtimekitBucketConfig != null)
        'realtimekit_bucket_config': realtimekitBucketConfig?.toJson(),
  ...
  StartRecordingRequest copyWith({
    bool Function()? allowMultipleRecordings,
    RealtimekitAudioConfig Function()? audioConfig,
    String Function()? fileNamePrefix,
    RealtimekitInteractiveConfig Function()? interactiveConfig,
    int Function()? maxSeconds,
    String Function()? meetingId,
    RealtimekitRealtimekitBucketConfig Function()? realtimekitBucketConfig,
    RealtimekitLivestreamingConfig Function()? rtmpOutConfig,
    RealtimekitStorageConfig Function()? storageConfig,
    Uri Function()? url,
    RealtimekitVideoConfig Function()? videoConfig,
  }) {
    return StartRecordingRequest(
      allowMultipleRecordings: allowMultipleRecordings != null
      ...
      realtimekitBucketConfig: realtimekitBucketConfig != null
          ? realtimekitBucketConfig()
          : this.realtimekitBucketConfig,
      rtmpOutConfig: rtmpOutConfig != null
          ? rtmpOutConfig()
          : this.rtmpOutConfig,
