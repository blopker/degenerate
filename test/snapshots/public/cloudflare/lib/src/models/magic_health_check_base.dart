...
import 'magic_health_check_base_rate.dart';import 'magic_health_check_base_target.dart';import 'magic_health_check_base_type.dart';final class MagicHealthCheckBase {const MagicHealthCheckBase({this.enabled = true, this.rate = MagicHealthCheckBaseRate.mid, this.target, this.type = MagicHealthCheckBaseType.reply, });
