...
final class R2DataCatalogTableDetails {
  const R2DataCatalogTableDetails({
    this.createdAt,
  ...
  factory R2DataCatalogTableDetails.fromJson(Map<String, dynamic> json) {
    return R2DataCatalogTableDetails(
      createdAt: json['created_at'] != null
          ? DateTime.parse(json['created_at'] as String)
          : null,
      identifier: R2DataCatalogTableIdentifier.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('identifier') &&
        json.containsKey('table_uuid') &&
        json['table_uuid'] is String;
  }

  R2DataCatalogTableDetails copyWith({
    DateTime? Function()? createdAt,
    R2DataCatalogTableIdentifier? identifier,
    String? Function()? location,
    String? Function()? metadataLocation,
    String? tableUuid,
    ...
    return R2DataCatalogTableDetails(
      ...
      metadataLocation: metadataLocation != null
          ? metadataLocation()
          : this.metadataLocation,
  ...
  @override
  String toString() {
    return 'R2DataCatalogTableDetails(createdAt: $createdAt, identifier: $identifier, location: $location, metadataLocation: $metadataLocation, tableUuid: $tableUuid, updatedAt: $updatedAt)';
  }
}
