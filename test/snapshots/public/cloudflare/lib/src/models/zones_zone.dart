...
import 'zones_type.dart';
import 'zones_zone_account.dart';
import 'zones_zone_meta.dart';
import 'zones_zone_owner.dart';
import 'zones_zone_plan.dart';
import 'zones_zone_status.dart';
import 'zones_zone_tenant.dart';
import 'zones_zone_tenant_unit.dart';
...
final class ZonesZone {
  const ZonesZone({
    ...
    this.tenantUnit,
    this.type,
    this.vanityNameServers = const [],
    this.verificationKey,
  });

  factory ZonesZone.fromJson(Map<String, dynamic> json) {
    return ZonesZone(
      account: ZonesZoneAccount.fromJson(
      ...
      status: json['status'] != null
          ? ZonesZoneStatus.fromJson(json['status'] as String)
          : null,
      tenant: json['tenant'] != null
          ? ZonesZoneTenant.fromJson(json['tenant'] as Map<String, dynamic>)
          : null,
      tenantUnit: json['tenant_unit'] != null
          ? ZonesZoneTenantUnit.fromJson(
              json['tenant_unit'] as Map<String, dynamic>,
            )
          : null,
      type: json['type'] != null
          ? ZonesType.fromJson(json['type'] as String)
          : null,
      vanityNameServers: json.containsKey('vanity_name_servers')
          ? (json['vanity_name_servers'] as List<dynamic>)
                .map((e) => e as String)
                .toList()
          : const [],
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account') &&
        json.containsKey('activated_on') &&
        json['activated_on'] is String &&
        json.containsKey('created_on') &&
        json['created_on'] is String &&
        json.containsKey('development_mode') &&
        json['development_mode'] is num &&
        json.containsKey('id') &&
        json['id'] is String &&
        ...
        json.containsKey('original_dnshost') &&
        json['original_dnshost'] is String &&
        json.containsKey('original_name_servers') &&
        json.containsKey('original_registrar') &&
        json['original_registrar'] is String &&
        json.containsKey('owner') &&
        json.containsKey('plan');
  }

  ZonesZone copyWith({
    ZonesZoneAccount? account,
    DateTime? Function()? activatedOn,
    String Function()? cnameSuffix,
    DateTime? createdOn,
    ...
    String? Function()? originalDnshost,
    List<String>? Function()? originalNameServers,
    String? Function()? originalRegistrar,
    ZonesZoneOwner? owner,
    bool Function()? paused,
    List<String> Function()? permissions,
    ZonesZonePlan? plan,
    ZonesZoneStatus Function()? status,
    ZonesZoneTenant Function()? tenant,
    ZonesZoneTenantUnit Function()? tenantUnit,
    ZonesType Function()? type,
    List<String> Function()? vanityNameServers,
    String Function()? verificationKey,
  }) {
    return ZonesZone(
      ...
      originalDnshost: originalDnshost != null
          ? originalDnshost()
          : this.originalDnshost,
      originalNameServers: originalNameServers != null
          ? originalNameServers()
          : this.originalNameServers,
      originalRegistrar: originalRegistrar != null
          ? originalRegistrar()
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      originalDnshost,
      Object.hashAll(originalNameServers ?? const []),
      originalRegistrar,
      owner,
      paused,
      ...
      tenantUnit,
      type,
      Object.hashAll(vanityNameServers),
      verificationKey,
    ]);
  }
