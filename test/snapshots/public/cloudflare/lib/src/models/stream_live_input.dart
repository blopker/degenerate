...
import 'stream_input_rtmps.dart';
import 'stream_input_srt.dart';
import 'stream_input_webrtc.dart';
import 'stream_live_input_recording_settings.dart';
import 'stream_live_input_status.dart';
import 'stream_playback_rtmps.dart';
import 'stream_playback_srt.dart';
import 'stream_playback_webrtc.dart';

/// Details about a live input.
final class StreamLiveInput {
  const StreamLiveInput({
    this.created,
  ...
  factory StreamLiveInput.fromJson(Map<String, dynamic> json) {
    return StreamLiveInput(
      ...
      rtmpsPlayback: json['rtmpsPlayback'] != null
          ? StreamPlaybackRtmps.fromJson(
              json['rtmpsPlayback'] as Map<String, dynamic>,
            )
          : null,
      srt: json['srt'] != null
      ...
      srtPlayback: json['srtPlayback'] != null
          ? StreamPlaybackSrt.fromJson(
              json['srtPlayback'] as Map<String, dynamic>,
            )
          : null,
      status: json['status'] != null
          ? StreamLiveInputStatus.fromJson(json['status'] as String)
          : null,
      ...
      webRtcPlayback: json['webRTCPlayback'] != null
          ? StreamPlaybackWebrtc.fromJson(
              json['webRTCPlayback'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  StreamLiveInput copyWith({
    ...
    StreamInputRtmps Function()? rtmps,
    StreamPlaybackRtmps Function()? rtmpsPlayback,
    StreamInputSrt Function()? srt,
    StreamPlaybackSrt Function()? srtPlayback,
    StreamLiveInputStatus? Function()? status,
    String Function()? uid,
    StreamInputWebrtc Function()? webRtc,
    StreamPlaybackWebrtc Function()? webRtcPlayback,
  }) {
    return StreamLiveInput(
      ...
      rtmpsPlayback: rtmpsPlayback != null
          ? rtmpsPlayback()
          : this.rtmpsPlayback,
      ...
      webRtcPlayback: webRtcPlayback != null
          ? webRtcPlayback()
          : this.webRtcPlayback,
    );
  }
  ...
  @override
  String toString() {
    return 'StreamLiveInput(created: $created, deleteRecordingAfterDays: $deleteRecordingAfterDays, enabled: $enabled, meta: $meta, modified: $modified, recording: $recording, rtmps: $rtmps, rtmpsPlayback: $rtmpsPlayback, srt: $srt, srtPlayback: $srtPlayback, status: $status, uid: $uid, webRtc: $webRtc, webRtcPlayback: $webRtcPlayback)';
  }
}
