...
final class Bandwidth2SslProtocols {
  const Bandwidth2SslProtocols({
    this.tlSv1,
    this.tlSv11,
    this.tlSv12,
    this.tlSv13,
  ...
  factory Bandwidth2SslProtocols.fromJson(Map<String, dynamic> json) {
    return Bandwidth2SslProtocols(
  ...
  Bandwidth2SslProtocols copyWith({
    int Function()? tlSv1,
    int Function()? tlSv11,
    int Function()? tlSv12,
    int Function()? tlSv13,
  ...
  @override
  int get hashCode {
    return Object.hash(tlSv1, tlSv11, tlSv12, tlSv13, none);
  }

  @override
  String toString() {
    return 'Bandwidth2SslProtocols(tlSv1: $tlSv1, tlSv11: $tlSv11, tlSv12: $tlSv12, tlSv13: $tlSv13, none: $none)';
  }
}
