...
import 'access_device_session.dart';
import 'access_geo.dart';
import 'access_identity_idp.dart';
import 'access_identity_mtls_auth.dart';
import 'access_schemas_device_posture_rule.dart';
...
final class AccessIdentity {
  ...
  factory AccessIdentity.fromJson(Map<String, dynamic> json) {
    return AccessIdentity(
      accountId: json['account_id'] as String?,
      authStatus: json['auth_status'] as String?,
      commonName: json['common_name'] as String?,
      deviceId: json['device_id'] as String?,
      deviceSessions: (json['device_sessions'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(
          k,
          AccessDeviceSession.fromJson(v as Map<String, dynamic>),
        ),
      ),
      devicePosture: (json['devicePosture'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(
          k,
          AccessSchemasDevicePostureRule.fromJson(v as Map<String, dynamic>),
        ),
      ),
      ...
      mtlsAuth: json['mtls_auth'] != null
          ? AccessIdentityMtlsAuth.fromJson(
              json['mtls_auth'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (deviceSessions != null)
        'device_sessions': deviceSessions?.map(
          (k, v) => MapEntry(k, v.toJson()),
        ),
      if (devicePosture != null)
        'devicePosture': devicePosture?.map((k, v) => MapEntry(k, v.toJson())),
      'email': ?email,
  ...
  AccessIdentity copyWith({
    String Function()? accountId,
    String Function()? authStatus,
    String Function()? commonName,
    String Function()? deviceId,
    Map<String, AccessDeviceSession> Function()? deviceSessions,
    Map<String, AccessSchemasDevicePostureRule> Function()? devicePosture,
    String Function()? email,
    AccessGeo Function()? geo,
    double Function()? iat,
    AccessIdentityIdp Function()? idp,
    String Function()? ip,
    bool Function()? isGateway,
    bool Function()? isWarp,
    AccessIdentityMtlsAuth Function()? mtlsAuth,
    String Function()? serviceTokenId,
    bool Function()? serviceTokenStatus,
    String Function()? userUuid,
    double Function()? version,
  }) {
    return AccessIdentity(
      ...
      deviceSessions: deviceSessions != null
          ? deviceSessions()
          : this.deviceSessions,
      ...
      serviceTokenId: serviceTokenId != null
          ? serviceTokenId()
          : this.serviceTokenId,
      serviceTokenStatus: serviceTokenStatus != null
          ? serviceTokenStatus()
          : this.serviceTokenStatus,
