...
final class NscBgpControl {
  ...
  factory NscBgpControl.fromJson(Map<String, dynamic> json) {
    return NscBgpControl(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('customer_asn') &&
        json['customer_asn'] is num &&
        json.containsKey('extra_prefixes');
  }

  NscBgpControl copyWith({
    int? customerAsn,
  ...
  @override
  int get hashCode {
    return Object.hash(customerAsn, Object.hashAll(extraPrefixes), md5Key);
  }

  @override
  String toString() {
    return 'NscBgpControl(customerAsn: $customerAsn, extraPrefixes: $extraPrefixes, md5Key: $md5Key)';
  }
}
