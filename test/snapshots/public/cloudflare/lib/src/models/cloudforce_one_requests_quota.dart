...
final class CloudforceOneRequestsQuota {const CloudforceOneRequestsQuota({this.anniversaryDate, this.quarterAnniversaryDate, this.quota, this.remaining, });
...
factory CloudforceOneRequestsQuota.fromJson(Map<String, dynamic> json) { return CloudforceOneRequestsQuota(
  ...
  quarterAnniversaryDate: json['quarter_anniversary_date'] != null ? DateTime.parse(json['quarter_anniversary_date'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  if (anniversaryDate != null) 'anniversary_date': anniversaryDate?.toIso8601String(),
  if (quarterAnniversaryDate != null) 'quarter_anniversary_date': quarterAnniversaryDate?.toIso8601String(),
  'quota': ?quota,
  'remaining': ?remaining,
}; } 
static bool canParse(Map<String, dynamic> json) { return true; } 
CloudforceOneRequestsQuota copyWith({DateTime Function()? anniversaryDate, DateTime Function()? quarterAnniversaryDate, int Function()? quota, int Function()? remaining, }) { return CloudforceOneRequestsQuota(
