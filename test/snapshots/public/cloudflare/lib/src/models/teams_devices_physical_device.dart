...
import 'teams_devices_registration_details.dart';
import 'teams_devices_user.dart';

/// A WARP Device.
final class TeamsDevicesPhysicalDevice {
  const TeamsDevicesPhysicalDevice({
  ...
  factory TeamsDevicesPhysicalDevice.fromJson(Map<String, dynamic> json) {
    return TeamsDevicesPhysicalDevice(
      ...
      lastSeenRegistration: json['last_seen_registration'] != null
          ? TeamsDevicesRegistrationDetails.fromJson(
              json['last_seen_registration'] as Map<String, dynamic>,
            )
          : null,
      lastSeenUser: json['last_seen_user'] != null
          ? TeamsDevicesUser.fromJson(
              json['last_seen_user'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (lastSeenRegistration != null)
        'last_seen_registration': lastSeenRegistration?.toJson(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('active_registrations') &&
        json['active_registrations'] is num &&
  ...
  TeamsDevicesPhysicalDevice copyWith({
    ...
    TeamsDevicesRegistrationDetails? Function()? lastSeenRegistration,
    TeamsDevicesUser? Function()? lastSeenUser,
    String? Function()? macAddress,
    String? Function()? manufacturer,
    String? Function()? model,
    String? name,
    String? Function()? osVersion,
    String? Function()? osVersionExtra,
    String? Function()? publicIp,
    ...
    return TeamsDevicesPhysicalDevice(
      ...
      lastSeenRegistration: lastSeenRegistration != null
      ...
      osVersionExtra: osVersionExtra != null
          ? osVersionExtra()
          : this.osVersionExtra,
  ...
  @override
  String toString() {
    return 'TeamsDevicesPhysicalDevice(activeRegistrations: $activeRegistrations, clientVersion: $clientVersion, createdAt: $createdAt, deletedAt: $deletedAt, deviceType: $deviceType, hardwareId: $hardwareId, id: $id, lastSeenAt: $lastSeenAt, lastSeenRegistration: $lastSeenRegistration, lastSeenUser: $lastSeenUser, macAddress: $macAddress, manufacturer: $manufacturer, model: $model, name: $name, osVersion: $osVersion, osVersionExtra: $osVersionExtra, publicIp: $publicIp, serialNumber: $serialNumber, updatedAt: $updatedAt)';
  }
}
