...
import 'package:collection/collection.dart';import 'magic_acl_update_request_protocols.dart';import 'magic_lan_acl_configuration.dart';final class MagicAclUpdateRequest {const MagicAclUpdateRequest({this.description, this.forwardLocally, this.lan1, this.lan2, this.name, this.protocols, this.unidirectional, });
...
MagicAclUpdateRequest copyWith({String Function()? description, bool Function()? forwardLocally, MagicLanAclConfiguration Function()? lan1, MagicLanAclConfiguration Function()? lan2, String Function()? name, List<MagicAclUpdateRequestProtocols> Function()? protocols, bool Function()? unidirectional, }) { return MagicAclUpdateRequest(
