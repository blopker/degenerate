...
import 'workers_version_item_short_metadata_source.dart';final class WorkersVersionItemShortMetadata {const WorkersVersionItemShortMetadata({this.authorEmail, this.authorId, this.createdOn, this.hasPreview, this.modifiedOn, this.source, });
