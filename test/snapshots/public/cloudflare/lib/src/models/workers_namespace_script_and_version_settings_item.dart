...
import 'workers_namespace_script_and_version_settings_item_migrations.dart';
...
///
final class WorkersNamespaceScriptAndVersionSettingsItem {
  const WorkersNamespaceScriptAndVersionSettingsItem({
    this.bindings,
  ...
  factory WorkersNamespaceScriptAndVersionSettingsItem.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersNamespaceScriptAndVersionSettingsItem(
      ...
      migrations: json['migrations'] != null
          ? WorkersNamespaceScriptAndVersionSettingsItemMigrations.fromJson(
              json['migrations'],
            )
          : null,
  ...
  WorkersNamespaceScriptAndVersionSettingsItem copyWith({
    ...
    WorkersNamespaceScriptAndVersionSettingsItemMigrations Function()?
    migrations,
