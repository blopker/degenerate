...
import 'package:collection/collection.dart';import 'workers_binding_item.dart';import 'workers_limits.dart';import 'workers_namespace_script_and_version_settings_item_migrations.dart';import 'workers_observability.dart';import 'workers_placement_info_no_status.dart';import 'workers_tail_consumers_script.dart';import 'workers_usage_model.dart';/// Script and version settings for Workers for Platforms namespace scripts. Same as script-and-version-settings-item but without annotations, which are not supported for namespace scripts.
/// 
...
WorkersNamespaceScriptAndVersionSettingsItem copyWith({List<WorkersBindingItem> Function()? bindings, String Function()? compatibilityDate, List<String> Function()? compatibilityFlags, WorkersLimits Function()? limits, bool Function()? logpush, WorkersNamespaceScriptAndVersionSettingsItemMigrations Function()? migrations, WorkersObservability Function()? observability, WorkersPlacementInfoNoStatus Function()? placement, List<String>? Function()? tags, List<WorkersTailConsumersScript>? Function()? tailConsumers, WorkersUsageModel Function()? usageModel, }) { return WorkersNamespaceScriptAndVersionSettingsItem(
