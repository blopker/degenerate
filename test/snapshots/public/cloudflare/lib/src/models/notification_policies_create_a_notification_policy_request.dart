...
import 'aaa_alert_type.dart';import 'aaa_filters.dart';import 'aaa_mechanisms.dart';final class NotificationPoliciesCreateANotificationPolicyRequest {const NotificationPoliciesCreateANotificationPolicyRequest({this.alertInterval, required this.alertType, this.description, required this.enabled, this.filters, required this.mechanisms, required this.name, });
...
NotificationPoliciesCreateANotificationPolicyRequest copyWith({String Function()? alertInterval, AaaAlertType? alertType, String Function()? description, bool? enabled, AaaFilters Function()? filters, AaaMechanisms? mechanisms, String? name, }) { return NotificationPoliciesCreateANotificationPolicyRequest(
