...
final class RadarGetDnsSummaryByResponseTtlResponseResultSummary0 {
  const RadarGetDnsSummaryByResponseTtlResponseResultSummary0({
  ...
  factory RadarGetDnsSummaryByResponseTtlResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetDnsSummaryByResponseTtlResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('gt_1d_lte_1w') &&
        json['gt_1d_lte_1w'] is String &&
        json.containsKey('gt_1h_lte_1d') &&
        json['gt_1h_lte_1d'] is String &&
        json.containsKey('gt_1m_lte_5m') &&
        json['gt_1m_lte_5m'] is String &&
        json.containsKey('gt_1w') &&
        json['gt_1w'] is String &&
        json.containsKey('gt_5m_lte_15m') &&
        json['gt_5m_lte_15m'] is String &&
        json.containsKey('gt_15m_lte_1h') &&
        json['gt_15m_lte_1h'] is String &&
        json.containsKey('lte_1m') &&
        json['lte_1m'] is String;
  }

  RadarGetDnsSummaryByResponseTtlResponseResultSummary0 copyWith({
    String? gt1dLte1w,
    String? gt1hLte1d,
    String? gt1mLte5m,
    String? gt1w,
  ...
  @override
  String toString() {
    return 'RadarGetDnsSummaryByResponseTtlResponseResultSummary0(gt1dLte1w: $gt1dLte1w, gt1hLte1d: $gt1hLte1d, gt1mLte5m: $gt1mLte5m, gt1w: $gt1w, gt5mLte15m: $gt5mLte15m, gt15mLte1h: $gt15mLte1h, lte1m: $lte1m)';
  }
}
