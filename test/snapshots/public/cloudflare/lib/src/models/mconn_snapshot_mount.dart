...
/// Snapshot Mount
final class MconnSnapshotMount {
  const MconnSnapshotMount({
    this.availableBytes,
    this.connectorId,
  ...
  factory MconnSnapshotMount.fromJson(Map<String, dynamic> json) {
    return MconnSnapshotMount(
      availableBytes: json['available_bytes'] != null
          ? (json['available_bytes'] as num).toDouble()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('file_system') &&
        json['file_system'] is String &&
        json.containsKey('kind') &&
        json['kind'] is String &&
        json.containsKey('mount_point') &&
        json['mount_point'] is String &&
        json.containsKey('name') &&
        json['name'] is String;
  }

  MconnSnapshotMount copyWith({
    double Function()? availableBytes,
    String Function()? connectorId,
    String? fileSystem,
    bool Function()? isReadOnly,
    bool Function()? isRemovable,
    String? kind,
    String? mountPoint,
    String? name,
    double Function()? totalBytes,
  }) {
    return MconnSnapshotMount(
  ...
  @override
  String toString() {
    return 'MconnSnapshotMount(availableBytes: $availableBytes, connectorId: $connectorId, fileSystem: $fileSystem, isReadOnly: $isReadOnly, isRemovable: $isRemovable, kind: $kind, mountPoint: $mountPoint, name: $name, totalBytes: $totalBytes)';
  }
}
