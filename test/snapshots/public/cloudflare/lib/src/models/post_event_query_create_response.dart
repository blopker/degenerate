...
final class PostEventQueryCreateResponse {
  const PostEventQueryCreateResponse({
  ...
  factory PostEventQueryCreateResponse.fromJson(Map<String, dynamic> json) {
    return PostEventQueryCreateResponse(
  ...
  PostEventQueryCreateResponse copyWith({
    int? accountId,
    bool? alertEnabled,
  ...
  @override
  String toString() {
    return 'PostEventQueryCreateResponse(accountId: $accountId, alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, createdAt: $createdAt, id: $id, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope, updatedAt: $updatedAt, userEmail: $userEmail)';
  }
}
