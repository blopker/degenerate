...
final class ZeroTrustUsersCreateUserRequest {const ZeroTrustUsersCreateUserRequest({required this.email, this.name, });
...
ZeroTrustUsersCreateUserRequest copyWith({String? email, String Function()? name, }) { return ZeroTrustUsersCreateUserRequest(
