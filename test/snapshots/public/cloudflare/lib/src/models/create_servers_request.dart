...
import 'create_servers_request_auth_type.dart';final class CreateServersRequest {const CreateServersRequest({this.authCredentials, required this.authType, this.description, required this.hostname, required this.id, required this.name, });
