...
final class DeleteDeviceResponse {
  ...
  @override
  String toString() {
    return 'DeleteDeviceResponse(errors: $errors, messages: $messages, result: $result, success: $success)';
  }
}
