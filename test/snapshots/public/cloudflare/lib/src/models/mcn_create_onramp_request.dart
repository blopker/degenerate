...
final class McnCreateOnrampRequest {
  ...
  factory McnCreateOnrampRequest.fromJson(Map<String, dynamic> json) {
    return McnCreateOnrampRequest(
      adoptedHubId: json['adopted_hub_id'] as String?,
      ...
      hubProviderId: json['hub_provider_id'] as String?,
  ...
  McnCreateOnrampRequest copyWith({
    String Function()? adoptedHubId,
    ...
    return McnCreateOnrampRequest(
      ...
      hubProviderId: hubProviderId != null
          ? hubProviderId()
          : this.hubProviderId,
