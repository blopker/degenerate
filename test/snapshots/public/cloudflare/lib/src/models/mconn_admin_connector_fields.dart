...
final class MconnAdminConnectorFields {
  const MconnAdminConnectorFields({
    this.accountId,
    this.activated,
    ...
    this.desiredVersion,
    this.deviceId,
    this.interruptWindowDaysOfWeek,
  ...
  factory MconnAdminConnectorFields.fromJson(Map<String, dynamic> json) {
    return MconnAdminConnectorFields(
      accountId: json['account_id'] != null
          ? (json['account_id'] as num).toDouble()
          : null,
      ...
      interruptWindowDurationHours:
          json['interrupt_window_duration_hours'] != null
      ...
      interruptWindowEmbargoDates:
          (json['interrupt_window_embargo_dates'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      interruptWindowHourOfDay: json['interrupt_window_hour_of_day'] != null
          ? (json['interrupt_window_hour_of_day'] as num).toDouble()
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'device_id': ?deviceId,
      if (interruptWindowDaysOfWeek != null)
  ...
  MconnAdminConnectorFields copyWith({
    double Function()? accountId,
    bool Function()? activated,
    String Function()? cloudflaredTunnelId,
    String Function()? cloudflaredTunnelToken,
    String Function()? cohortId,
    String Function()? desiredVersion,
    String Function()? deviceId,
    List<MconnDayOfWeek> Function()? interruptWindowDaysOfWeek,
    double Function()? interruptWindowDurationHours,
    List<String> Function()? interruptWindowEmbargoDates,
    double Function()? interruptWindowHourOfDay,
    String Function()? lastHeartbeat,
    String Function()? lastSeenVersion,
    String Function()? lastUpdated,
    String Function()? notes,
    String Function()? timezone,
    bool Function()? upgradeAsap,
  }) {
    return MconnAdminConnectorFields(
      accountId: accountId != null ? accountId() : this.accountId,
      activated: activated != null ? activated() : this.activated,
      cloudflaredTunnelId: cloudflaredTunnelId != null
          ? cloudflaredTunnelId()
          : this.cloudflaredTunnelId,
      cloudflaredTunnelToken: cloudflaredTunnelToken != null
      ...
      interruptWindowDaysOfWeek: interruptWindowDaysOfWeek != null
          ? interruptWindowDaysOfWeek()
          : this.interruptWindowDaysOfWeek,
      interruptWindowDurationHours: interruptWindowDurationHours != null
          ? interruptWindowDurationHours()
          : this.interruptWindowDurationHours,
      interruptWindowEmbargoDates: interruptWindowEmbargoDates != null
          ? interruptWindowEmbargoDates()
          : this.interruptWindowEmbargoDates,
      interruptWindowHourOfDay: interruptWindowHourOfDay != null
  ...
  int get hashCode {
    return Object.hash(
      ...
      desiredVersion,
      deviceId,
      Object.hashAll(interruptWindowDaysOfWeek ?? const []),
      interruptWindowDurationHours,
      Object.hashAll(interruptWindowEmbargoDates ?? const []),
      interruptWindowHourOfDay,
      lastHeartbeat,
      lastSeenVersion,
      lastUpdated,
