...
final class D1RawResultResponseResultsRows {
  const D1RawResultResponseResultsRows({
    this.$double,
    this.string,
    this.mapStringString,
  });

  factory D1RawResultResponseResultsRows.fromJson(Object? json) {
    return D1RawResultResponseResultsRows(
  ...
  bool get isValid {
    return $double != null || string != null || mapStringString != null;
  }
