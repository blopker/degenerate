...
final class ZonesEarlyHintsValue {
  const ZonesEarlyHintsValue._(this.value);

  factory ZonesEarlyHintsValue.fromJson(String json) {
    return switch (json) {
      'on' => $on,
      'off' => off,
  ...
  @override
  String toString() {
    return 'ZonesEarlyHintsValue($value)';
  }
}
