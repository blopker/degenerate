...
final class UrlscannerGetScanResponseResultScanIpsIp {
  const UrlscannerGetScanResponseResultScanIpsIp({
    required this.asn,
    required this.asnDescription,
    required this.asnLocationAlpha2,
    required this.asnName,
    required this.asnOrgName,
  ...
  factory UrlscannerGetScanResponseResultScanIpsIp.fromJson(
    Map<String, dynamic> json,
  ) {
    return UrlscannerGetScanResponseResultScanIpsIp(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('asn') &&
        json['asn'] is String &&
        json.containsKey('asnDescription') &&
        json['asnDescription'] is String &&
        json.containsKey('asnLocationAlpha2') &&
        json['asnLocationAlpha2'] is String &&
        json.containsKey('asnName') &&
        json['asnName'] is String &&
        json.containsKey('asnOrgName') &&
        json['asnOrgName'] is String &&
        json.containsKey('continent') &&
        json['continent'] is String &&
        json.containsKey('geonameId') &&
        json['geonameId'] is String &&
        json.containsKey('ip') &&
        json['ip'] is String &&
        json.containsKey('ipVersion') &&
        json['ipVersion'] is String &&
        json.containsKey('latitude') &&
        json['latitude'] is String &&
        json.containsKey('locationAlpha2') &&
  ...
  UrlscannerGetScanResponseResultScanIpsIp copyWith({
    String? asn,
    String? asnDescription,
