...
import 'package:collection/collection.dart';final class GetCategoryListResponse {const GetCategoryListResponse({required this.killChain, this.mitreAttack, required this.name, this.shortname, required this.uuid, });
