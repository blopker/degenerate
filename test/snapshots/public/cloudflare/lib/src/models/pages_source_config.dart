...
import 'pages_source_config_preview_deployment_setting.dart';

final class PagesSourceConfig {
  const PagesSourceConfig({
  ...
  factory PagesSourceConfig.fromJson(Map<String, dynamic> json) {
    return PagesSourceConfig(
      ...
      previewDeploymentSetting:
          PagesSourceConfigPreviewDeploymentSetting.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('deployments_enabled') &&
        json['deployments_enabled'] is bool &&
        json.containsKey('owner') &&
        json['owner'] is String &&
        json.containsKey('owner_id') &&
        json['owner_id'] is String &&
        json.containsKey('path_excludes') &&
        json.containsKey('path_includes') &&
        json.containsKey('pr_comments_enabled') &&
        json['pr_comments_enabled'] is bool &&
        ...
        json.containsKey('production_branch') &&
        json['production_branch'] is String &&
        json.containsKey('production_deployments_enabled') &&
        json['production_deployments_enabled'] is bool &&
        json.containsKey('repo_id') &&
        json['repo_id'] is String &&
        json.containsKey('repo_name') &&
        json['repo_name'] is String;
  }

  PagesSourceConfig copyWith({
    ...
    PagesSourceConfigPreviewDeploymentSetting? previewDeploymentSetting,
    ...
    return PagesSourceConfig(
      ...
      previewBranchExcludes:
          previewBranchExcludes ?? this.previewBranchExcludes,
      previewBranchIncludes:
          previewBranchIncludes ?? this.previewBranchIncludes,
      previewDeploymentSetting:
  ...
  int get hashCode {
    return Object.hash(
      ...
      prCommentsEnabled,
      Object.hashAll(previewBranchExcludes),
      Object.hashAll(previewBranchIncludes),
      previewDeploymentSetting,
      productionBranch,
      productionDeploymentsEnabled,
      repoId,
