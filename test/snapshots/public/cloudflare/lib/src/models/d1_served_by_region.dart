...
final class D1ServedByRegion {
  const D1ServedByRegion._(this.value);

  factory D1ServedByRegion.fromJson(String json) {
    return switch (json) {
      'WNAM' => wnam,
      'ENAM' => enam,
      'WEUR' => weur,
  ...
  static const List<D1ServedByRegion> values = [
    wnam,
    enam,
    weur,
    eeur,
