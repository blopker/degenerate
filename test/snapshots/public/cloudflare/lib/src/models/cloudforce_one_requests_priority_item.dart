...
CloudforceOneRequestsPriorityItem copyWith({DateTime? created, String? id, List<String>? labels, int? priority, String? requirement, CloudforceOneRequestsTlp? tlp, DateTime? updated, }) { return CloudforceOneRequestsPriorityItem(
