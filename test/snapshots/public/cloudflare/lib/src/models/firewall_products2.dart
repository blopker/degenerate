...
final class FirewallProducts2 {
  const FirewallProducts2._(this.value);

  factory FirewallProducts2.fromJson(String json) {
    return switch (json) {
  ...
  static const FirewallProducts2 zoneLockdown = FirewallProducts2._(
    'zoneLockdown',
  );
  ...
  static const FirewallProducts2 securityLevel = FirewallProducts2._(
    'securityLevel',
  );
  ...
  static const List<FirewallProducts2> values = [
    zoneLockdown,
    uaBlock,
    bic,
    hot,
  ...
  @override
  String toString() {
    return 'FirewallProducts2($value)';
  }
}
