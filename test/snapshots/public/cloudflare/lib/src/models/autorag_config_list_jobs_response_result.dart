...
import 'autorag_config_list_jobs_response_result_source.dart';final class AutoragConfigListJobsResponseResult {const AutoragConfigListJobsResponseResult({this.endReason, this.endedAt, required this.id, this.lastSeenAt, required this.source, this.startedAt, });
