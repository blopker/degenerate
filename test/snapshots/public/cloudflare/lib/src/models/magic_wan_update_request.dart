...
import 'magic_wan_static_addressing.dart';final class MagicWanUpdateRequest {const MagicWanUpdateRequest({this.name, this.physport, this.priority, this.staticAddressing, this.vlanTag, });
...
MagicWanUpdateRequest copyWith({String Function()? name, int Function()? physport, int Function()? priority, MagicWanStaticAddressing Function()? staticAddressing, int Function()? vlanTag, }) { return MagicWanUpdateRequest(
