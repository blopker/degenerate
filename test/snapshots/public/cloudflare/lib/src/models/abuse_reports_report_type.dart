...
final class AbuseReportsReportType {
  const AbuseReportsReportType._(this.value);

  factory AbuseReportsReportType.fromJson(String json) {
    return switch (json) {
      'PHISH' => phish,
      'GEN' => gen,
      'THREAT' => threat,
  ...
  static const AbuseReportsReportType threat = AbuseReportsReportType._(
    'THREAT',
  );
  ...
  static const AbuseReportsReportType regWho = AbuseReportsReportType._(
    'REG_WHO',
  );

  static const AbuseReportsReportType ncsei = AbuseReportsReportType._('NCSEI');

  static const AbuseReportsReportType network = AbuseReportsReportType._(
    'NETWORK',
  );

  static const List<AbuseReportsReportType> values = [
    phish,
    gen,
    threat,
    dmca,
  ...
  @override
  String toString() {
    return 'AbuseReportsReportType($value)';
  }
}
