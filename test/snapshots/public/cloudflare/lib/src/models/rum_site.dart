...
import 'package:collection/collection.dart';import 'rum_rule.dart';import 'rum_ruleset.dart';final class RumSite {const RumSite({this.autoInstall, this.created, this.rules, this.ruleset, this.siteTag, this.siteToken, this.snippet, });
...
RumSite copyWith({bool Function()? autoInstall, DateTime Function()? created, List<RumRule> Function()? rules, RumRuleset Function()? ruleset, String Function()? siteTag, String Function()? siteToken, String Function()? snippet, }) { return RumSite(
