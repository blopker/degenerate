...
import 'zero_trust_gateway_block_page_settings_mode.dart';

/// Specify block page layout settings.
final class ZeroTrustGatewayBlockPageSettings {
  const ZeroTrustGatewayBlockPageSettings({
    ...
    this.mailtoAddress,
    this.mailtoSubject,
    this.mode = ZeroTrustGatewayBlockPageSettingsMode.$empty,
    this.name,
    this.readOnly,
    this.sourceAccount,
    this.suppressFooter,
  ...
  factory ZeroTrustGatewayBlockPageSettings.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayBlockPageSettings(
      ...
      mode: json.containsKey('mode')
          ? ZeroTrustGatewayBlockPageSettingsMode.fromJson(
              json['mode'] as String,
            )
          : ZeroTrustGatewayBlockPageSettingsMode.$empty,
      ...
      targetUri: json['target_uri'] != null
          ? Uri.parse(json['target_uri'] as String)
          : null,
  ...
  ZeroTrustGatewayBlockPageSettings copyWith({
    String Function()? backgroundColor,
    bool? Function()? enabled,
    String Function()? footerText,
    String Function()? headerText,
    bool Function()? includeContext,
    String Function()? logoPath,
    String Function()? mailtoAddress,
    String Function()? mailtoSubject,
    ZeroTrustGatewayBlockPageSettingsMode Function()? mode,
    String Function()? name,
    bool? Function()? readOnly,
    String? Function()? sourceAccount,
    bool Function()? suppressFooter,
    Uri Function()? targetUri,
    ...
    return ZeroTrustGatewayBlockPageSettings(
      ...
      mailtoAddress: mailtoAddress != null
          ? mailtoAddress()
          : this.mailtoAddress,
      mailtoSubject: mailtoSubject != null
          ? mailtoSubject()
          : this.mailtoSubject,
      ...
      sourceAccount: sourceAccount != null
          ? sourceAccount()
          : this.sourceAccount,
      suppressFooter: suppressFooter != null
          ? suppressFooter()
          : this.suppressFooter,
  ...
  @override
  String toString() {
    return 'ZeroTrustGatewayBlockPageSettings(backgroundColor: $backgroundColor, enabled: $enabled, footerText: $footerText, headerText: $headerText, includeContext: $includeContext, logoPath: $logoPath, mailtoAddress: $mailtoAddress, mailtoSubject: $mailtoSubject, mode: $mode, name: $name, readOnly: $readOnly, sourceAccount: $sourceAccount, suppressFooter: $suppressFooter, targetUri: $targetUri, version: $version)';
  }
}
