...
final class ActiveLivestreamSessionDetailsResponseDataSession {
  const ActiveLivestreamSessionDetailsResponseDataSession({
    this.createdAt,
    this.errMessage,
    this.id,
    this.ingestSeconds,
  ...
  factory ActiveLivestreamSessionDetailsResponseDataSession.fromJson(
    Map<String, dynamic> json,
  ) {
    return ActiveLivestreamSessionDetailsResponseDataSession(
  ...
  @override
  String toString() {
    return 'ActiveLivestreamSessionDetailsResponseDataSession(createdAt: $createdAt, errMessage: $errMessage, id: $id, ingestSeconds: $ingestSeconds, invokedTime: $invokedTime, livestreamId: $livestreamId, startedTime: $startedTime, stoppedTime: $stoppedTime, updatedAt: $updatedAt, viewerSeconds: $viewerSeconds)';
  }
}
