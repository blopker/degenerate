...
import 'zaraz_variable_match_rule_action.dart';import 'zaraz_variable_match_rule_settings.dart';final class ZarazVariableMatchRule {const ZarazVariableMatchRule({required this.action, required this.id, required this.settings, });
