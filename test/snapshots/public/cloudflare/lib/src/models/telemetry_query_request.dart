...
import 'telemetry_query_request_parameters.dart';import 'telemetry_query_request_pattern_type.dart';import 'telemetry_query_request_timeframe.dart';import 'telemetry_query_request_view.dart';final class TelemetryQueryRequest {const TelemetryQueryRequest({this.chart, this.compare, this.dry = false, this.granularity, this.ignoreSeries = false, this.limit = 50.0, this.offset, this.offsetBy, this.offsetDirection, this.parameters, this.patternType, required this.queryId, required this.timeframe, this.view = TelemetryQueryRequestView.calculations, });
