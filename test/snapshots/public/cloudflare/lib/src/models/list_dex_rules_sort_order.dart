...
final class ListDexRulesSortOrder {
  const ListDexRulesSortOrder._(this.value);

  factory ListDexRulesSortOrder.fromJson(String json) {
    return switch (json) {
      'ASC' => asc,
      'DESC' => desc,
  ...
  @override
  String toString() {
    return 'ListDexRulesSortOrder($value)';
  }
}
