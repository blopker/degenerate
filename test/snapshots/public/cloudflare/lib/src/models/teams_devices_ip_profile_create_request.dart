...
final class TeamsDevicesIpProfileCreateRequest {const TeamsDevicesIpProfileCreateRequest({this.description, this.enabled = true, required this.match, required this.name, required this.precedence, required this.subnetId, });
...
TeamsDevicesIpProfileCreateRequest copyWith({String? Function()? description, bool Function()? enabled, String? match, String? name, int? precedence, String? subnetId, }) { return TeamsDevicesIpProfileCreateRequest(
