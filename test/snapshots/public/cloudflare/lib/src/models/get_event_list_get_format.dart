...
final class GetEventListGetFormat {
  const GetEventListGetFormat._(this.value);

  factory GetEventListGetFormat.fromJson(String json) {
    return switch (json) {
      'json' => json$,
      'stix2' => stix2,
  ...
  @override
  String toString() {
    return 'GetEventListGetFormat($value)';
  }
}
