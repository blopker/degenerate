...
import 'package:collection/collection.dart';import 'access_rule.dart';final class AccessComponentsSchemasGroups {const AccessComponentsSchemasGroups({this.createdAt, this.exclude, this.id, this.include, this.name, this.require, this.updatedAt, });
...
AccessComponentsSchemasGroups copyWith({DateTime Function()? createdAt, List<AccessRule> Function()? exclude, String Function()? id, List<AccessRule> Function()? include, String Function()? name, List<AccessRule> Function()? require, DateTime Function()? updatedAt, }) { return AccessComponentsSchemasGroups(
