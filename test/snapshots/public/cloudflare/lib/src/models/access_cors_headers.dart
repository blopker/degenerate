...
import 'package:collection/collection.dart';import 'access_allowed_methods2.dart';final class AccessCorsHeaders {const AccessCorsHeaders({this.allowAllHeaders, this.allowAllMethods, this.allowAllOrigins, this.allowCredentials, this.allowedHeaders, this.allowedMethods, this.allowedOrigins, this.maxAge, });
...
AccessCorsHeaders copyWith({bool Function()? allowAllHeaders, bool Function()? allowAllMethods, bool Function()? allowAllOrigins, bool Function()? allowCredentials, List<String> Function()? allowedHeaders, List<AccessAllowedMethods2> Function()? allowedMethods, List<String> Function()? allowedOrigins, double Function()? maxAge, }) { return AccessCorsHeaders(
