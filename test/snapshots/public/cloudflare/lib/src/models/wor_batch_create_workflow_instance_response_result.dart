...
import 'wor_batch_create_workflow_instance_response_result_status.dart';final class WorBatchCreateWorkflowInstanceResponseResult {const WorBatchCreateWorkflowInstanceResponseResult({required this.id, required this.status, required this.versionId, required this.workflowId, });
