...
import 'tls_certificates_and_hostnames_sslpost.dart';final class CustomHostnameForAZoneCreateCustomHostnameRequest {const CustomHostnameForAZoneCreateCustomHostnameRequest({this.customMetadata, required this.hostname, this.ssl, });
...
CustomHostnameForAZoneCreateCustomHostnameRequest copyWith({Map<String, String> Function()? customMetadata, String? hostname, TlsCertificatesAndHostnamesSslpost Function()? ssl, }) { return CustomHostnameForAZoneCreateCustomHostnameRequest(
