...
import 'package:collection/collection.dart';import 'telemetry_values_list_request_filters.dart';import 'telemetry_values_list_request_needle.dart';import 'telemetry_values_list_request_timeframe.dart';import 'telemetry_values_list_request_type.dart';final class TelemetryValuesListRequest {const TelemetryValuesListRequest({required this.datasets, this.filters = const [], required this.key, this.limit = 50.0, this.needle, required this.timeframe, required this.type, });
