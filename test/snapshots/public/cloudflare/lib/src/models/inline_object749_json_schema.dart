...
final class InlineObject749JsonSchema {const InlineObject749JsonSchema({this.description, required this.name, this.schema, this.strict, });
...
@override String toString() { return 'InlineObject749JsonSchema(description: $description, name: $name, schema: $schema, strict: $strict)'; } 
 }
