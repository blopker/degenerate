...
import 'package:collection/collection.dart';import 'workers_assets.dart';import 'workers_binding_item.dart';import 'workers_limits.dart';import 'workers_multipart_script_metadata_migrations.dart';import 'workers_observability.dart';import 'workers_placement_info.dart';import 'workers_tail_consumers_script.dart';import 'workers_usage_model.dart';/// JSON-encoded metadata about the uploaded parts and Worker configuration.
...
WorkersMultipartScriptMetadata copyWith({WorkersAssets Function()? assets, List<WorkersBindingItem> Function()? bindings, String Function()? bodyPart, String Function()? compatibilityDate, List<String> Function()? compatibilityFlags, bool Function()? keepAssets, List<String> Function()? keepBindings, WorkersLimits Function()? limits, bool Function()? logpush, String Function()? mainModule, WorkersMultipartScriptMetadataMigrations Function()? migrations, WorkersObservability Function()? observability, WorkersPlacementInfo Function()? placement, List<String> Function()? tags, List<WorkersTailConsumersScript>? Function()? tailConsumers, WorkersUsageModel Function()? usageModel, }) { return WorkersMultipartScriptMetadata(
