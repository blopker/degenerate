...
import 'inline_object859_image.dart';final class InlineObject859 {const InlineObject859({this.frequencyPenalty, required this.image, this.maxTokens = 512, this.presencePenalty, this.prompt, this.raw = false, this.repetitionPenalty, this.seed, this.temperature, this.topK, this.topP, });
...
InlineObject859 copyWith({double Function()? frequencyPenalty, InlineObject859Image? image, int Function()? maxTokens, double Function()? presencePenalty, String Function()? prompt, bool Function()? raw, double Function()? repetitionPenalty, double Function()? seed, double Function()? temperature, double Function()? topK, double Function()? topP, }) { return InlineObject859(
...
@override String toString() { return 'InlineObject859(frequencyPenalty: $frequencyPenalty, image: $image, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
