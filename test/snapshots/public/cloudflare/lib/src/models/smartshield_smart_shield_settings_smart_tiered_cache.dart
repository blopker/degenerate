...
import 'smartshield_smart_shield_settings_smart_tiered_cache_value.dart';final class SmartshieldSmartShieldSettingsSmartTieredCache {const SmartshieldSmartShieldSettingsSmartTieredCache({this.editable, this.id, this.modifiedOn, this.value, });
