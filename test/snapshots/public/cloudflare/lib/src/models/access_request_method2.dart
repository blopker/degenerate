...
final class AccessRequestMethod2 {
  const AccessRequestMethod2._(this.value);

  factory AccessRequestMethod2.fromJson(String json) {
    return switch (json) {
      'DELETE' => delete,
      'PATCH' => patch,
      'POST' => post,
  ...
  @override
  String toString() {
    return 'AccessRequestMethod2($value)';
  }
}
