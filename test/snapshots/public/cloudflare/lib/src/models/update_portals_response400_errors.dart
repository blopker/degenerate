...
import 'package:collection/collection.dart';final class UpdatePortalsResponse400Errors {const UpdatePortalsResponse400Errors({required this.code, required this.message, required this.path, });
