...
import 'telemetry_keys_list_request_key_needle_value.dart';/// Search for a specific substring in the keys.
...
factory TelemetryKeysListRequestKeyNeedle.fromJson(Map<String, dynamic> json) { return TelemetryKeysListRequestKeyNeedle(
  ...
  value: TelemetryKeysListRequestKeyNeedleValue.fromJson(json['value'] as Map<String, dynamic>),
); }
...
TelemetryKeysListRequestKeyNeedle copyWith({bool Function()? isRegex, bool Function()? matchCase, TelemetryKeysListRequestKeyNeedleValue? value, }) { return TelemetryKeysListRequestKeyNeedle(
