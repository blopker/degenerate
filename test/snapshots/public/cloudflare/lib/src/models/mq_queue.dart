...
import 'package:collection/collection.dart';import 'mq_consumer_response.dart';import 'mq_producer.dart';import 'mq_queue_settings.dart';final class MqQueue {const MqQueue({this.consumers, this.consumersTotalCount, this.createdOn, this.modifiedOn, this.producers, this.producersTotalCount, this.queueId, this.queueName, this.settings, });
...
factory MqQueue.fromJson(Map<String, dynamic> json) { return MqQueue(
  ...
  producers: (json['producers'] as List<dynamic>?)?.map((e) => MqProducer.fromJson(e as Map<String, dynamic>)).toList(),
...
MqQueue copyWith({List<MqConsumerResponse> Function()? consumers, double Function()? consumersTotalCount, String Function()? createdOn, String Function()? modifiedOn, List<MqProducer> Function()? producers, double Function()? producersTotalCount, String Function()? queueId, String Function()? queueName, MqQueueSettings Function()? settings, }) { return MqQueue(
