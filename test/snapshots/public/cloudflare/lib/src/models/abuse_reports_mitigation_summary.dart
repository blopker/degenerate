...
final class AbuseReportsMitigationSummary {
  const AbuseReportsMitigationSummary({
  ...
  factory AbuseReportsMitigationSummary.fromJson(Map<String, dynamic> json) {
    return AbuseReportsMitigationSummary(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('accepted_url_count') &&
        json['accepted_url_count'] is num &&
        json.containsKey('active_count') &&
        json['active_count'] is num &&
        json.containsKey('external_host_notified') &&
        json['external_host_notified'] is bool &&
        json.containsKey('in_review_count') &&
        json['in_review_count'] is num &&
        json.containsKey('pending_count') &&
        json['pending_count'] is num;
  }

  AbuseReportsMitigationSummary copyWith({
    int? acceptedUrlCount,
    int? activeCount,
    bool? externalHostNotified,
    int? inReviewCount,
    int? pendingCount,
  }) {
    return AbuseReportsMitigationSummary(
  ...
  @override
  String toString() {
    return 'AbuseReportsMitigationSummary(acceptedUrlCount: $acceptedUrlCount, activeCount: $activeCount, externalHostNotified: $externalHostNotified, inReviewCount: $inReviewCount, pendingCount: $pendingCount)';
  }
}
