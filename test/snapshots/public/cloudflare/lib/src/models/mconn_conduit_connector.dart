...
final class MconnConduitConnector {const MconnConduitConnector({required this.accountId});
...
MconnConduitConnector copyWith({String? accountId}) { return MconnConduitConnector(
