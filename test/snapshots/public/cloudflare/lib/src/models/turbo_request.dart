...
import 'turbo_request_audio.dart';

final class TurboRequest {
  const TurboRequest({
    required this.audio,
    this.beamSize = 5,
    this.compressionRatioThreshold = 2.4,
    this.conditionOnPreviousText = true,
    this.hallucinationSilenceThreshold,
    this.initialPrompt,
    this.language,
    ...
    this.vadFilter = false,
  });

  factory TurboRequest.fromJson(Map<String, dynamic> json) {
    return TurboRequest(
      audio: TurboRequestAudio.fromJson(json['audio'] as Map<String, dynamic>),
      beamSize: json.containsKey('beam_size')
          ? (json['beam_size'] as num).toInt()
          : 5,
      compressionRatioThreshold: json.containsKey('compression_ratio_threshold')
          ? (json['compression_ratio_threshold'] as num).toDouble()
          : 2.4,
      conditionOnPreviousText: json.containsKey('condition_on_previous_text')
          ? json['condition_on_previous_text'] as bool
          : true,
      hallucinationSilenceThreshold:
          json['hallucination_silence_threshold'] != null
          ? (json['hallucination_silence_threshold'] as num).toDouble()
          : null,
      initialPrompt: json['initial_prompt'] as String?,
      language: json['language'] as String?,
      logProbThreshold: json.containsKey('log_prob_threshold')
          ? (json['log_prob_threshold'] as num).toDouble()
          : -1.0,
      noSpeechThreshold: json.containsKey('no_speech_threshold')
          ? (json['no_speech_threshold'] as num).toDouble()
          : 0.6,
      prefix: json['prefix'] as String?,
      task: json.containsKey('task') ? json['task'] as String : 'transcribe',
      vadFilter: json.containsKey('vad_filter')
          ? json['vad_filter'] as bool
          : false,
    );
  }
  ...
  TurboRequest copyWith({
    TurboRequestAudio? audio,
    int Function()? beamSize,
    double Function()? compressionRatioThreshold,
    bool Function()? conditionOnPreviousText,
    double Function()? hallucinationSilenceThreshold,
    String Function()? initialPrompt,
    String Function()? language,
    double Function()? logProbThreshold,
    double Function()? noSpeechThreshold,
    String Function()? prefix,
    String Function()? task,
    bool Function()? vadFilter,
  }) {
    return TurboRequest(
      audio: audio ?? this.audio,
      beamSize: beamSize != null ? beamSize() : this.beamSize,
      compressionRatioThreshold: compressionRatioThreshold != null
          ? compressionRatioThreshold()
          : this.compressionRatioThreshold,
      conditionOnPreviousText: conditionOnPreviousText != null
          ? conditionOnPreviousText()
          : this.conditionOnPreviousText,
      hallucinationSilenceThreshold: hallucinationSilenceThreshold != null
          ? hallucinationSilenceThreshold()
          : this.hallucinationSilenceThreshold,
      ...
      logProbThreshold: logProbThreshold != null
          ? logProbThreshold()
          : this.logProbThreshold,
      noSpeechThreshold: noSpeechThreshold != null
          ? noSpeechThreshold()
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is TurboRequest &&
            ...
            hallucinationSilenceThreshold ==
                other.hallucinationSilenceThreshold &&
