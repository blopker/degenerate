...
import 'destination_update_response_result_configuration_logpush_dataset.dart';import 'destination_update_response_result_configuration_type.dart';final class DestinationUpdateResponseResultConfiguration {const DestinationUpdateResponseResultConfiguration({required this.destinationConf, required this.logpushDataset, required this.logpushJob, required this.type, required this.url, });
...
factory DestinationUpdateResponseResultConfiguration.fromJson(Map<String, dynamic> json) { return DestinationUpdateResponseResultConfiguration(
  ...
  logpushDataset: DestinationUpdateResponseResultConfigurationLogpushDataset.fromJson(json['logpushDataset'] as Map<String, dynamic>),
