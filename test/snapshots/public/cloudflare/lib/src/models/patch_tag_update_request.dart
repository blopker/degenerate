...
final class PatchTagUpdateRequest {
  const PatchTagUpdateRequest({
    this.activeDuration,
    this.actorCategory,
  ...
  factory PatchTagUpdateRequest.fromJson(Map<String, dynamic> json) {
    return PatchTagUpdateRequest(
  ...
  PatchTagUpdateRequest copyWith({
