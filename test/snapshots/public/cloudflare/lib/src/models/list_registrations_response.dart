...
import 'package:collection/collection.dart';import 'response_message.dart';import 'teams_devices_cursor_result_info.dart';import 'teams_devices_registration.dart';final class ListRegistrationsResponse {const ListRegistrationsResponse({required this.errors, required this.messages, required this.result, this.resultInfo, required this.success, });
