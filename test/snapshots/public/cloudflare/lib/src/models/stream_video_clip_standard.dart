...
final class StreamVideoClipStandard {
  const StreamVideoClipStandard({
    this.allowedOrigins,
  ...
  factory StreamVideoClipStandard.fromJson(Map<String, dynamic> json) {
    return StreamVideoClipStandard(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('clippedFromVideoUID') &&
        json['clippedFromVideoUID'] is String &&
        json.containsKey('endTimeSeconds') &&
        json['endTimeSeconds'] is num &&
        json.containsKey('startTimeSeconds') &&
        json['startTimeSeconds'] is num;
  }

  StreamVideoClipStandard copyWith({
    List<String> Function()? allowedOrigins,
    String? clippedFromVideoUid,
