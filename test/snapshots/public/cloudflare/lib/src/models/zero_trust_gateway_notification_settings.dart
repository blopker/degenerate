...
final class ZeroTrustGatewayNotificationSettings {
  const ZeroTrustGatewayNotificationSettings({
    this.enabled,
    this.includeContext,
    this.msg,
    this.supportUrl,
  ...
  factory ZeroTrustGatewayNotificationSettings.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayNotificationSettings(
  ...
  ZeroTrustGatewayNotificationSettings copyWith({
  ...
  @override
  String toString() {
    return 'ZeroTrustGatewayNotificationSettings(enabled: $enabled, includeContext: $includeContext, msg: $msg, supportUrl: $supportUrl)';
  }
}
