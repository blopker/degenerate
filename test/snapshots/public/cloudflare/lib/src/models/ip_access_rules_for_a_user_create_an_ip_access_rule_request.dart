...
import 'firewall_configuration.dart';import 'firewall_schemas_mode.dart';final class IpAccessRulesForAUserCreateAnIpAccessRuleRequest {const IpAccessRulesForAUserCreateAnIpAccessRuleRequest({required this.configuration, required this.mode, this.notes, });
...
IpAccessRulesForAUserCreateAnIpAccessRuleRequest copyWith({FirewallConfiguration? configuration, FirewallSchemasMode? mode, String Function()? notes, }) { return IpAccessRulesForAUserCreateAnIpAccessRuleRequest(
