...
factory GetParticipantDataFromPeerIdResponseDataParticipantQualityStats.fromJson(Map<String, dynamic> json) { return GetParticipantDataFromPeerIdResponseDataParticipantQualityStats(
  ...
  audioStats: (json['audio_stats'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String))).toList(),
  ...
  videoStats: (json['video_stats'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String))).toList(),
); }
