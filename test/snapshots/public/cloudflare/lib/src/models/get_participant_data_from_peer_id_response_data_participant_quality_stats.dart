...
final class GetParticipantDataFromPeerIdResponseDataParticipantQualityStats {
  const GetParticipantDataFromPeerIdResponseDataParticipantQualityStats({
    this.audioBandwidth,
    this.audioStats,
    this.averageQuality,
    this.end,
  ...
  factory GetParticipantDataFromPeerIdResponseDataParticipantQualityStats.fromJson(
    Map<String, dynamic> json,
  ) {
    return GetParticipantDataFromPeerIdResponseDataParticipantQualityStats(
      audioBandwidth: json['audio_bandwidth'] != null
          ? (json['audio_bandwidth'] as num).toInt()
          : null,
      audioStats: (json['audio_stats'] as List<dynamic>?)
          ?.map(
      ...
      averageQuality: json['average_quality'] != null
          ? (json['average_quality'] as num).toInt()
          : null,
      ...
      peerIds: (json['peer_ids'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      start: json['start'] as String?,
      totalAudioPackets: json['total_audio_packets'] != null
          ? (json['total_audio_packets'] as num).toInt()
          : null,
      totalAudioPacketsLost: json['total_audio_packets_lost'] != null
          ? (json['total_audio_packets_lost'] as num).toInt()
          : null,
      totalVideoPackets: json['total_video_packets'] != null
          ? (json['total_video_packets'] as num).toInt()
          : null,
      totalVideoPacketsLost: json['total_video_packets_lost'] != null
          ? (json['total_video_packets_lost'] as num).toInt()
          : null,
      videoBandwidth: json['video_bandwidth'] != null
          ? (json['video_bandwidth'] as num).toInt()
          : null,
      videoStats: (json['video_stats'] as List<dynamic>?)
          ?.map(
            (e) => (e as Map<String, dynamic>).map(
              (k, v) => MapEntry(k, v as String),
            ),
  ...
  final List<Map<String, String>>? audioStats;
  ...
  final List<Map<String, String>>? videoStats;
  ...
  GetParticipantDataFromPeerIdResponseDataParticipantQualityStats copyWith({
    int Function()? audioBandwidth,
    List<Map<String, String>> Function()? audioStats,
    int Function()? averageQuality,
    String? Function()? end,
    String Function()? firstAudioPacketReceived,
    String Function()? firstVideoPacketReceived,
    String Function()? lastAudioPacketReceived,
    String Function()? lastVideoPacketReceived,
    List<String> Function()? peerIds,
    String? Function()? start,
    int Function()? totalAudioPackets,
    int Function()? totalAudioPacketsLost,
    int Function()? totalVideoPackets,
    int Function()? totalVideoPacketsLost,
    int Function()? videoBandwidth,
    List<Map<String, String>> Function()? videoStats,
  }) {
    return GetParticipantDataFromPeerIdResponseDataParticipantQualityStats(
      audioBandwidth: audioBandwidth != null
          ? audioBandwidth()
          : this.audioBandwidth,
      ...
      firstAudioPacketReceived: firstAudioPacketReceived != null
          ? firstAudioPacketReceived()
          : this.firstAudioPacketReceived,
      firstVideoPacketReceived: firstVideoPacketReceived != null
          ? firstVideoPacketReceived()
          : this.firstVideoPacketReceived,
      lastAudioPacketReceived: lastAudioPacketReceived != null
          ? lastAudioPacketReceived()
          : this.lastAudioPacketReceived,
      lastVideoPacketReceived: lastVideoPacketReceived != null
          ? lastVideoPacketReceived()
          : this.lastVideoPacketReceived,
      peerIds: peerIds != null ? peerIds() : this.peerIds,
      start: start != null ? start() : this.start,
      totalAudioPackets: totalAudioPackets != null
          ? totalAudioPackets()
          : this.totalAudioPackets,
      totalAudioPacketsLost: totalAudioPacketsLost != null
          ? totalAudioPacketsLost()
          : this.totalAudioPacketsLost,
      totalVideoPackets: totalVideoPackets != null
          ? totalVideoPackets()
          : this.totalVideoPackets,
      totalVideoPacketsLost: totalVideoPacketsLost != null
          ? totalVideoPacketsLost()
          : this.totalVideoPacketsLost,
      videoBandwidth: videoBandwidth != null
          ? videoBandwidth()
          : this.videoBandwidth,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is GetParticipantDataFromPeerIdResponseDataParticipantQualityStats &&
            ...
            const ListEquality<dynamic>().equals(peerIds, other.peerIds) &&
            start == other.start &&
            ...
            const ListEquality<dynamic>().equals(videoStats, other.videoStats);
  }
  ...
  int get hashCode {
    return Object.hash(
      audioBandwidth,
      Object.hashAll(audioStats ?? const []),
      averageQuality,
      end,
      firstAudioPacketReceived,
      firstVideoPacketReceived,
