...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('created') && json['created'] is String &&
      ...
      json.containsKey('resource_account_id') && json['resource_account_id'] is String &&
...
ResourceSharingShareResourceObject copyWith({DateTime? created, String? id, Map<String,String>? meta, DateTime? modified, String? resourceAccountId, String? resourceId, ResourceSharingResourceType? resourceType, int? resourceVersion, ResourceSharingResourceStatus? status, }) { return ResourceSharingShareResourceObject(
