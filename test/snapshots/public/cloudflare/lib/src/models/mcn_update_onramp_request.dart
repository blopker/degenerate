...
import 'package:collection/collection.dart';final class McnUpdateOnrampRequest {const McnUpdateOnrampRequest({this.attachedHubs, this.attachedVpcs, this.description, this.installRoutesInCloud, this.installRoutesInMagicWan, this.manageHubToHubAttachments, this.manageVpcToHubAttachments, this.name, this.vpc, });
...
McnUpdateOnrampRequest copyWith({List<String> Function()? attachedHubs, List<String> Function()? attachedVpcs, String Function()? description, bool Function()? installRoutesInCloud, bool Function()? installRoutesInMagicWan, bool Function()? manageHubToHubAttachments, bool Function()? manageVpcToHubAttachments, String Function()? name, String Function()? vpc, }) { return McnUpdateOnrampRequest(
