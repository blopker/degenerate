...
factory WorkersNamespaceResponse.fromJson(Map<String, dynamic> json) { return WorkersNamespaceResponse(
  ...
  scriptCount: json['script_count'] != null ? (json['script_count'] as num).toInt() : null,
...
WorkersNamespaceResponse copyWith({String Function()? createdBy, DateTime Function()? createdOn, String Function()? modifiedBy, DateTime Function()? modifiedOn, String Function()? namespaceId, String Function()? namespaceName, int Function()? scriptCount, bool Function()? trustedWorkers, }) { return WorkersNamespaceResponse(
