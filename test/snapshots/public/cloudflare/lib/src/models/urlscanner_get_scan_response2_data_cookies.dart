...
final class UrlscannerGetScanResponse2DataCookies {
  const UrlscannerGetScanResponse2DataCookies({
  ...
  factory UrlscannerGetScanResponse2DataCookies.fromJson(
    Map<String, dynamic> json,
  ) {
    return UrlscannerGetScanResponse2DataCookies(
  ...
  UrlscannerGetScanResponse2DataCookies copyWith({
    String? domain,
    double? expires,
    bool? httpOnly,
    String? name,
  ...
  @override
  String toString() {
    return 'UrlscannerGetScanResponse2DataCookies(domain: $domain, expires: $expires, httpOnly: $httpOnly, name: $name, path: $path, priority: $priority, sameParty: $sameParty, secure: $secure, session: $session, size: $size, sourcePort: $sourcePort, sourceScheme: $sourceScheme, value: $value)';
  }
}
