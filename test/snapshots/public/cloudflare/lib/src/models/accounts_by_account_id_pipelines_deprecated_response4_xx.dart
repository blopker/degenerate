...
import 'package:collection/collection.dart';import 'accounts_by_account_id_pipelines_deprecated_response4_xx_errors.dart';final class AccountsByAccountIdPipelinesDeprecatedResponse4Xx {const AccountsByAccountIdPipelinesDeprecatedResponse4Xx({required this.errors, required this.results, required this.success, });
...
AccountsByAccountIdPipelinesDeprecatedResponse4Xx copyWith({List<AccountsByAccountIdPipelinesDeprecatedResponse4XxErrors>? errors, Map<String, String>? Function()? results, bool? success, }) { return AccountsByAccountIdPipelinesDeprecatedResponse4Xx(
