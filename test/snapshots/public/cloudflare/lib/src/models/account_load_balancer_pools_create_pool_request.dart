...
final class AccountLoadBalancerPoolsCreatePoolRequest {
  const AccountLoadBalancerPoolsCreatePoolRequest({
    this.description,
    this.enabled,
    this.latitude,
    this.loadShedding,
  ...
  factory AccountLoadBalancerPoolsCreatePoolRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountLoadBalancerPoolsCreatePoolRequest(
  ...
  AccountLoadBalancerPoolsCreatePoolRequest copyWith({
