...
final class EmailSecurityDomainEmailsProcessed {
  ...
  factory EmailSecurityDomainEmailsProcessed.fromJson(
    ...
    return EmailSecurityDomainEmailsProcessed(
      ...
      totalEmailsProcessedPrevious:
          (json['total_emails_processed_previous'] as num).toInt(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('timestamp') &&
        ...
        json.containsKey('total_emails_processed') &&
        json['total_emails_processed'] is num &&
        json.containsKey('total_emails_processed_previous') &&
        json['total_emails_processed_previous'] is num;
  }

  EmailSecurityDomainEmailsProcessed copyWith({
    DateTime? timestamp,
    ...
    return EmailSecurityDomainEmailsProcessed(
      ...
      totalEmailsProcessedPrevious:
          totalEmailsProcessedPrevious ?? this.totalEmailsProcessedPrevious,
    );
  }
  ...
  @override
  String toString() {
    return 'EmailSecurityDomainEmailsProcessed(timestamp: $timestamp, totalEmailsProcessed: $totalEmailsProcessed, totalEmailsProcessedPrevious: $totalEmailsProcessedPrevious)';
  }
}
