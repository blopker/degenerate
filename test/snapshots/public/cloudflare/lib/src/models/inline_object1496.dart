...
import 'package:collection/collection.dart';import 'inline_object1496_add_script_tag.dart';import 'inline_object1496_add_style_tag.dart';import 'inline_object1496_allow_resource_types.dart';import 'inline_object1496_authenticate.dart';import 'inline_object1496_cookies.dart';import 'inline_object1496_elements.dart';import 'inline_object1496_goto_options.dart';import 'inline_object1496_reject_resource_types.dart';import 'inline_object1496_viewport.dart';import 'inline_object1496_wait_for_selector.dart';final class InlineObject1496 {const InlineObject1496({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, required this.elements, this.emulateMediaType, this.gotoOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });
...
factory InlineObject1496.fromJson(Map<String, dynamic> json) { return InlineObject1496(
  ...
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1496AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
...
InlineObject1496 copyWith({double Function()? actionTimeout, List<InlineObject1496AddScriptTag> Function()? addScriptTag, List<InlineObject1496AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1496AllowResourceTypes> Function()? allowResourceTypes, InlineObject1496Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1496Cookies> Function()? cookies, List<InlineObject1496Elements>? elements, String Function()? emulateMediaType, InlineObject1496GotoOptions Function()? gotoOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1496RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, Uri? url, String Function()? userAgent, InlineObject1496Viewport Function()? viewport, InlineObject1496WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1496(
