...
import 'package:collection/collection.dart';import 'access_meta.dart';import 'access_users_emails.dart';final class AccessUsers {const AccessUsers({this.active, this.displayName, this.emails, this.externalId, this.id, this.meta, this.schemas, });
...
AccessUsers copyWith({bool Function()? active, String Function()? displayName, List<AccessUsersEmails> Function()? emails, String Function()? externalId, String Function()? id, AccessMeta Function()? meta, List<String> Function()? schemas, }) { return AccessUsers(
