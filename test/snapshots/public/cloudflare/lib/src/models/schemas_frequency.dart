...
final class SchemasFrequency {
  const SchemasFrequency._(this.value);

  factory SchemasFrequency.fromJson(String json) {
    return switch (json) {
      'weekly' => weekly,
      'monthly' => monthly,
      'quarterly' => quarterly,
  ...
  static const List<SchemasFrequency> values = [
    weekly,
    monthly,
    quarterly,
    yearly,
