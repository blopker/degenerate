...
import 'workers_ai_post_run_cf_pfnet_plamo_embedding1b_request_text.dart';final class WorkersAiPostRunCfPfnetPlamoEmbedding1bRequest {const WorkersAiPostRunCfPfnetPlamoEmbedding1bRequest({required this.text});
...
factory WorkersAiPostRunCfPfnetPlamoEmbedding1bRequest.fromJson(Map<String, dynamic> json) { return WorkersAiPostRunCfPfnetPlamoEmbedding1bRequest(
  text: WorkersAiPostRunCfPfnetPlamoEmbedding1bRequestText.fromJson(json['text']),
); }
