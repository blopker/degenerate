...
final class PostTagCreateRequest {
  const PostTagCreateRequest({
    this.activeDuration,
    this.actorCategory,
  ...
  factory PostTagCreateRequest.fromJson(Map<String, dynamic> json) {
    return PostTagCreateRequest(
