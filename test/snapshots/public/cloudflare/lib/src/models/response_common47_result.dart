...
final class ResponseCommon47Result {const ResponseCommon47Result({this.mapStringString, this.listString, this.string, });

factory ResponseCommon47Result.fromJson(Object? json) { return ResponseCommon47Result(
