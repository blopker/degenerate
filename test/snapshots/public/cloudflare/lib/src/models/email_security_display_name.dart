...
final class EmailSecurityDisplayName {
  const EmailSecurityDisplayName({
    required this.email,
  ...
  factory EmailSecurityDisplayName.fromJson(Map<String, dynamic> json) {
    return EmailSecurityDisplayName(
      email: json['email'] as String,
      isEmailRegex: json['is_email_regex'] as bool,
      name: json['name'] as String,
      comments: json['comments'] as String?,
      createdAt: DateTime.parse(json['created_at'] as String),
      directoryId: json['directory_id'] != null
          ? (json['directory_id'] as num).toInt()
          : null,
      directoryNodeId: json['directory_node_id'] != null
          ? (json['directory_node_id'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('email') &&
        ...
        json.containsKey('is_email_regex') &&
        json['is_email_regex'] is bool &&
  ...
  EmailSecurityDisplayName copyWith({
    String? email,
    bool? isEmailRegex,
    String? name,
    String? Function()? comments,
    DateTime? createdAt,
    int? Function()? directoryId,
    int? Function()? directoryNodeId,
    String? Function()? externalDirectoryNodeId,
    int? id,
    ...
    return EmailSecurityDisplayName(
      ...
      directoryNodeId: directoryNodeId != null
          ? directoryNodeId()
          : this.directoryNodeId,
      externalDirectoryNodeId: externalDirectoryNodeId != null
  ...
  @override
  String toString() {
    return 'EmailSecurityDisplayName(email: $email, isEmailRegex: $isEmailRegex, name: $name, comments: $comments, createdAt: $createdAt, directoryId: $directoryId, directoryNodeId: $directoryNodeId, externalDirectoryNodeId: $externalDirectoryNodeId, id: $id, lastModified: $lastModified, provenance: $provenance)';
  }
}
