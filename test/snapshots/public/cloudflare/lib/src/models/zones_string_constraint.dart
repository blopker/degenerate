...
/// String constraint.
final class ZonesStringConstraint {const ZonesStringConstraint({this.$operator = 'contains', required this.value, });
...
ZonesStringConstraint copyWith({String? $operator, String? value, }) { return ZonesStringConstraint(
