...
import 'digital_experience_monitoring_aggregate_time_period_units.dart';final class DigitalExperienceMonitoringAggregateTimePeriod {const DigitalExperienceMonitoringAggregateTimePeriod({required this.units, required this.value, });
