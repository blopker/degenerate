...
import 'aig_config_update_gateway_response_result_otel_content_type.dart';final class AigConfigUpdateGatewayResponseResultOtel {const AigConfigUpdateGatewayResponseResultOtel({required this.authorization, this.contentType = AigConfigUpdateGatewayResponseResultOtelContentType.json$, required this.headers, required this.url, });
