...
import 'dlp_dataset.dart';

final class DlpDatasetCreation {
  const DlpDatasetCreation({
  ...
  factory DlpDatasetCreation.fromJson(Map<String, dynamic> json) {
    return DlpDatasetCreation(
  ...
  @override
  int get hashCode {
    return Object.hash(dataset, encodingVersion, maxCells, secret, version);
  }

  @override
  String toString() {
    return 'DlpDatasetCreation(dataset: $dataset, encodingVersion: $encodingVersion, maxCells: $maxCells, secret: $secret, version: $version)';
  }
}
