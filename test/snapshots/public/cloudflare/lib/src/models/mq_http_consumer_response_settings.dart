...
final class MqHttpConsumerResponseSettings {const MqHttpConsumerResponseSettings({this.batchSize, this.maxRetries, this.retryDelay, this.visibilityTimeoutMs, });
...
MqHttpConsumerResponseSettings copyWith({double Function()? batchSize, double Function()? maxRetries, double Function()? retryDelay, double Function()? visibilityTimeoutMs, }) { return MqHttpConsumerResponseSettings(
