...
import 'package:collection/collection.dart';final class DlpNewWordListEntry {const DlpNewWordListEntry({required this.enabled, required this.name, required this.words, });
