...
import 'package:collection/collection.dart';import 'urlscanner_create_scan_response409_result_tasks_client_type.dart';import 'urlscanner_create_scan_response409_result_tasks_errors.dart';import 'urlscanner_create_scan_response409_result_tasks_scanned_from.dart';import 'urlscanner_create_scan_response409_result_tasks_status.dart';import 'urlscanner_create_scan_response409_result_tasks_visibility.dart';final class UrlscannerCreateScanResponse409ResultTasks {const UrlscannerCreateScanResponse409ResultTasks({required this.clientLocation, required this.clientType, required this.effectiveUrl, required this.errors, required this.scannedFrom, required this.status, required this.success, required this.time, required this.timeEnd, required this.url, required this.uuid, required this.visibility, });
