...
final class RadarGetQualitySpeedTopAsesResponseResultTop0 {
  const RadarGetQualitySpeedTopAsesResponseResultTop0({
  ...
  factory RadarGetQualitySpeedTopAsesResponseResultTop0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetQualitySpeedTopAsesResponseResultTop0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('bandwidthDownload') &&
        ...
        json.containsKey('clientASN') &&
        json['clientASN'] is num &&
        json.containsKey('clientASName') &&
        json['clientASName'] is String &&
        ...
        json.containsKey('numTests') &&
        json['numTests'] is num &&
        json.containsKey('rankPower') &&
        json['rankPower'] is num;
  }

  RadarGetQualitySpeedTopAsesResponseResultTop0 copyWith({
