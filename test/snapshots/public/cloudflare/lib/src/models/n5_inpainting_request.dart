...
final class $5InpaintingRequest {
  const $5InpaintingRequest({
    this.guidance = 7.5,
    this.height,
    this.image,
    this.imageB64,
  ...
  factory $5InpaintingRequest.fromJson(Map<String, dynamic> json) {
    return $5InpaintingRequest(
  ...
  @override
  String toString() {
    return '\$5InpaintingRequest(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)';
  }
}
