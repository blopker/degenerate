...
factory EmailDestinationAddressProperties.fromJson(Map<String, dynamic> json) { return EmailDestinationAddressProperties(
  ...
  verified: json['verified'] != null ? DateTime.parse(json['verified'] as String) : null,
); }
...
EmailDestinationAddressProperties copyWith({DateTime Function()? created, String Function()? email, String Function()? id, DateTime Function()? modified, String Function()? tag, DateTime Function()? verified, }) { return EmailDestinationAddressProperties(
