...
final class McnOnrampType {
  const McnOnrampType._(this.value);

  factory McnOnrampType.fromJson(String json) {
    return switch (json) {
  ...
  static const McnOnrampType onrampTypeSingle = McnOnrampType._(
    'OnrampTypeSingle',
  );
