...
final class RadarGetQualitySpeedSummaryResponseResultSummary0 {
  const RadarGetQualitySpeedSummaryResponseResultSummary0({
  ...
  factory RadarGetQualitySpeedSummaryResponseResultSummary0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetQualitySpeedSummaryResponseResultSummary0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('bandwidthDownload') &&
        json['bandwidthDownload'] is String &&
        json.containsKey('bandwidthUpload') &&
        json['bandwidthUpload'] is String &&
        json.containsKey('jitterIdle') &&
        json['jitterIdle'] is String &&
        json.containsKey('jitterLoaded') &&
        json['jitterLoaded'] is String &&
        json.containsKey('latencyIdle') &&
        json['latencyIdle'] is String &&
        json.containsKey('latencyLoaded') &&
        json['latencyLoaded'] is String &&
        json.containsKey('packetLoss') &&
        json['packetLoss'] is String;
  }

  RadarGetQualitySpeedSummaryResponseResultSummary0 copyWith({
    String? bandwidthDownload,
    String? bandwidthUpload,
    String? jitterIdle,
    String? jitterLoaded,
    String? latencyIdle,
    String? latencyLoaded,
    String? packetLoss,
  }) {
    return RadarGetQualitySpeedSummaryResponseResultSummary0(
  ...
  @override
  String toString() {
    return 'RadarGetQualitySpeedSummaryResponseResultSummary0(bandwidthDownload: $bandwidthDownload, bandwidthUpload: $bandwidthUpload, jitterIdle: $jitterIdle, jitterLoaded: $jitterLoaded, latencyIdle: $latencyIdle, latencyLoaded: $latencyLoaded, packetLoss: $packetLoss)';
  }
}
