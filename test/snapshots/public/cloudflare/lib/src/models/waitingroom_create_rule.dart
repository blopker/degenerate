...
import 'waitingroom_rule_action.dart';final class WaitingroomCreateRule {const WaitingroomCreateRule({required this.action, this.description, this.enabled, required this.expression, });
...
WaitingroomCreateRule copyWith({WaitingroomRuleAction? action, String Function()? description, bool Function()? enabled, String? expression, }) { return WaitingroomCreateRule(
