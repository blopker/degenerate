...
import 'package:collection/collection.dart';import 'builds_build_seed_repo_input_file.dart';import 'builds_scm_provider_type.dart';final class BuildsBuildSeedRepoInput {const BuildsBuildSeedRepoInput({required this.branch, this.files, required this.owner, required this.path, required this.provider, required this.repository, });
...
BuildsBuildSeedRepoInput copyWith({String? branch, List<BuildsBuildSeedRepoInputFile> Function()? files, String? owner, String? path, BuildsScmProviderType? provider, String? repository, }) { return BuildsBuildSeedRepoInput(
