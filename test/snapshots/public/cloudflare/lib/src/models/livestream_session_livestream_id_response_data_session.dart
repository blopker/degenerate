...
final class LivestreamSessionLivestreamIdResponseDataSession {
  const LivestreamSessionLivestreamIdResponseDataSession({
    this.createdAt,
    this.errMessage,
    this.id,
    this.ingestSeconds,
  ...
  factory LivestreamSessionLivestreamIdResponseDataSession.fromJson(
    Map<String, dynamic> json,
  ) {
    return LivestreamSessionLivestreamIdResponseDataSession(
      ...
      ingestSeconds: json['ingest_seconds'] != null
          ...
          : null,
      invokedTime: json['invoked_time'] != null
          ? DateTime.parse(json['invoked_time'] as String)
          : null,
  ...
  LivestreamSessionLivestreamIdResponseDataSession copyWith({
    DateTime Function()? createdAt,
    String Function()? errMessage,
    String Function()? id,
    double Function()? ingestSeconds,
    DateTime Function()? invokedTime,
    String Function()? livestreamId,
    DateTime Function()? startedTime,
  ...
  @override
  String toString() {
    return 'LivestreamSessionLivestreamIdResponseDataSession(createdAt: $createdAt, errMessage: $errMessage, id: $id, ingestSeconds: $ingestSeconds, invokedTime: $invokedTime, livestreamId: $livestreamId, startedTime: $startedTime, stoppedTime: $stoppedTime, updatedAt: $updatedAt, viewerSeconds: $viewerSeconds)';
  }
}
