...
final class TeamsDevicesType {
  const TeamsDevicesType._(this.value);

  factory TeamsDevicesType.fromJson(String json) {
    return switch (json) {
      'file' => file,
  ...
  static const TeamsDevicesType diskEncryption = TeamsDevicesType._(
    'disk_encryption',
  );

  static const TeamsDevicesType serialNumber = TeamsDevicesType._(
    'serial_number',
  );
  ...
  static const TeamsDevicesType domainJoined = TeamsDevicesType._(
    'domain_joined',
  );

  static const TeamsDevicesType clientCertificate = TeamsDevicesType._(
    'client_certificate',
  );

  static const TeamsDevicesType clientCertificateV2 = TeamsDevicesType._(
    'client_certificate_v2',
  );

  static const TeamsDevicesType antivirus = TeamsDevicesType._('antivirus');

  static const TeamsDevicesType uniqueClientId = TeamsDevicesType._(
    'unique_client_id',
  );
  ...
  static const TeamsDevicesType crowdstrikeS2s = TeamsDevicesType._(
    'crowdstrike_s2s',
  );

  static const TeamsDevicesType intune = TeamsDevicesType._('intune');

  static const TeamsDevicesType workspaceOne = TeamsDevicesType._(
    'workspace_one',
  );

  static const TeamsDevicesType sentineloneS2s = TeamsDevicesType._(
    'sentinelone_s2s',
  );

  static const TeamsDevicesType customS2s = TeamsDevicesType._('custom_s2s');

  static const List<TeamsDevicesType> values = [
    file,
    application,
    tanium,
    gateway,
