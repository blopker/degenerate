...
import 'package:collection/collection.dart';final class VectorizeIndexUpsertResponse {const VectorizeIndexUpsertResponse({this.count, this.ids, });
...
VectorizeIndexUpsertResponse copyWith({int Function()? count, List<String> Function()? ids, }) { return VectorizeIndexUpsertResponse(
