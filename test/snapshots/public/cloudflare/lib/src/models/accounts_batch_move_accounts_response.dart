...
AccountsBatchMoveAccountsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, BatchAccountMoveResponse? result, bool? success, }) { return AccountsBatchMoveAccountsResponse(
