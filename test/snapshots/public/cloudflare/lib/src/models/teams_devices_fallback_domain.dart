...
import 'package:collection/collection.dart';final class TeamsDevicesFallbackDomain {const TeamsDevicesFallbackDomain({this.description, this.dnsServer, required this.suffix, });

factory TeamsDevicesFallbackDomain.fromJson(Map<String, dynamic> json) { return TeamsDevicesFallbackDomain(
  description: json['description'] as String?,
  dnsServer: (json['dns_server'] as List<dynamic>?)?.map((e) => e as String).toList(),
...
TeamsDevicesFallbackDomain copyWith({String Function()? description, List<String> Function()? dnsServer, String? suffix, }) { return TeamsDevicesFallbackDomain(
