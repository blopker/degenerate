...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_traceroute_test_result_network_path_response_hops.dart';final class DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse {const DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse({this.deviceName, required this.hops, required this.resultId, this.testId, this.testName, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('hops') &&
      json.containsKey('resultId') && json['resultId'] is String; } 
DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse copyWith({String Function()? deviceName, List<DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHops>? hops, String? resultId, String Function()? testId, String Function()? testName, }) { return DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse(
