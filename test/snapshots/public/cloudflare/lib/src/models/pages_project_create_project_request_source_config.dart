...
import 'pages_project_create_project_request_source_config_preview_deployment_setting.dart';

final class PagesProjectCreateProjectRequestSourceConfig {
  const PagesProjectCreateProjectRequestSourceConfig({
  ...
  factory PagesProjectCreateProjectRequestSourceConfig.fromJson(
    Map<String, dynamic> json,
  ) {
    return PagesProjectCreateProjectRequestSourceConfig(
      ...
      previewBranchExcludes: (json['preview_branch_excludes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      previewBranchIncludes: (json['preview_branch_includes'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      previewDeploymentSetting: json['preview_deployment_setting'] != null
          ? PagesProjectCreateProjectRequestSourceConfigPreviewDeploymentSetting.fromJson(
              json['preview_deployment_setting'] as String,
            )
          : null,
      productionBranch: json['production_branch'] as String?,
      productionDeploymentsEnabled:
          json['production_deployments_enabled'] as bool?,
  ...
  final PagesProjectCreateProjectRequestSourceConfigPreviewDeploymentSetting?
  ...
  PagesProjectCreateProjectRequestSourceConfig copyWith({
    bool Function()? deploymentsEnabled,
    String Function()? owner,
    String Function()? ownerId,
    List<String> Function()? pathExcludes,
    List<String> Function()? pathIncludes,
    bool Function()? prCommentsEnabled,
    List<String> Function()? previewBranchExcludes,
    List<String> Function()? previewBranchIncludes,
    PagesProjectCreateProjectRequestSourceConfigPreviewDeploymentSetting
    Function()?
    previewDeploymentSetting,
    String Function()? productionBranch,
    bool Function()? productionDeploymentsEnabled,
    String Function()? repoId,
    String Function()? repoName,
  }) {
    return PagesProjectCreateProjectRequestSourceConfig(
      deploymentsEnabled: deploymentsEnabled != null
          ? deploymentsEnabled()
          : this.deploymentsEnabled,
      ...
      prCommentsEnabled: prCommentsEnabled != null
          ? prCommentsEnabled()
          : this.prCommentsEnabled,
      previewBranchExcludes: previewBranchExcludes != null
          ? previewBranchExcludes()
          : this.previewBranchExcludes,
      previewBranchIncludes: previewBranchIncludes != null
          ? previewBranchIncludes()
          : this.previewBranchIncludes,
      previewDeploymentSetting: previewDeploymentSetting != null
          ? previewDeploymentSetting()
          : this.previewDeploymentSetting,
      productionBranch: productionBranch != null
          ? productionBranch()
          : this.productionBranch,
      productionDeploymentsEnabled: productionDeploymentsEnabled != null
          ? productionDeploymentsEnabled()
          : this.productionDeploymentsEnabled,
  ...
  int get hashCode {
    return Object.hash(
      ...
      prCommentsEnabled,
      Object.hashAll(previewBranchExcludes ?? const []),
      Object.hashAll(previewBranchIncludes ?? const []),
      previewDeploymentSetting,
      productionBranch,
      productionDeploymentsEnabled,
      repoId,
