...
import 'package:collection/collection.dart';import 'pages_project_create_project_request_source_config_preview_deployment_setting.dart';final class PagesProjectCreateProjectRequestSourceConfig {const PagesProjectCreateProjectRequestSourceConfig({this.deploymentsEnabled, this.owner, this.ownerId, this.pathExcludes, this.pathIncludes, this.prCommentsEnabled, this.previewBranchExcludes, this.previewBranchIncludes, this.previewDeploymentSetting, this.productionBranch, this.productionDeploymentsEnabled, this.repoId, this.repoName, });
