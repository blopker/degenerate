...
import 'package:collection/collection.dart';import 'r2_cors_rule_allowed.dart';final class R2CorsRule {const R2CorsRule({required this.allowed, this.exposeHeaders, this.id, this.maxAgeSeconds, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is R2CorsRule &&
          ...
          const ListEquality<dynamic>().equals(exposeHeaders, other.exposeHeaders) &&
          id == other.id &&
