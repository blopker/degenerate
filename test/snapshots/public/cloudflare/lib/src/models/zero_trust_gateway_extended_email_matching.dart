...
final class ZeroTrustGatewayExtendedEmailMatching {
  const ZeroTrustGatewayExtendedEmailMatching({
    this.enabled,
    this.readOnly,
    this.sourceAccount,
    this.version,
  ...
  factory ZeroTrustGatewayExtendedEmailMatching.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayExtendedEmailMatching(
  ...
  ZeroTrustGatewayExtendedEmailMatching copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(enabled, readOnly, sourceAccount, version);
  }

  @override
  String toString() {
    return 'ZeroTrustGatewayExtendedEmailMatching(enabled: $enabled, readOnly: $readOnly, sourceAccount: $sourceAccount, version: $version)';
  }
}
