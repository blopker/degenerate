...
import 'nsc_bgp_control.dart';import 'nsc_magic_settings.dart';final class NscCniCreate {const NscCniCreate({required this.account, this.bgp, required this.interconnect, required this.magic, });
...
NscCniCreate copyWith({String? account, NscBgpControl Function()? bgp, String? interconnect, NscMagicSettings? magic, }) { return NscCniCreate(
