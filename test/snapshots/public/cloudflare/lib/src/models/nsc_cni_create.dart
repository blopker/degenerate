...
final class NscCniCreate {
  ...
  factory NscCniCreate.fromJson(Map<String, dynamic> json) {
    return NscCniCreate(
  ...
  @override
  int get hashCode {
    return Object.hash(account, bgp, interconnect, magic);
  }

  @override
  String toString() {
    return 'NscCniCreate(account: $account, bgp: $bgp, interconnect: $interconnect, magic: $magic)';
  }
}
