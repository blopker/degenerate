...
import 'package:collection/collection.dart';import 'access_type.dart';final class AccessBookmarkProps {const AccessBookmarkProps({this.appLauncherVisible, this.domain, this.logoUrl, this.name, this.tags, this.type, });
...
AccessBookmarkProps copyWith({bool Function()? appLauncherVisible, String Function()? domain, String Function()? logoUrl, String Function()? name, List<String> Function()? tags, AccessType Function()? type, }) { return AccessBookmarkProps(
