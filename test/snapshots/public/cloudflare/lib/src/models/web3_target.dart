...
final class Web3Target {
  const Web3Target._(this.value);

  factory Web3Target.fromJson(String json) {
    return switch (json) {
      'ethereum' => ethereum,
      'ipfs' => ipfs,
  ...
  static const Web3Target ipfsUniversalPath = Web3Target._(
    'ipfs_universal_path',
  );
