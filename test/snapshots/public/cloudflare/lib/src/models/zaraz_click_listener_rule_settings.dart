...
import 'zaraz_click_listener_rule_settings_type.dart';final class ZarazClickListenerRuleSettings {const ZarazClickListenerRuleSettings({required this.selector, required this.type, required this.waitForTags, });
