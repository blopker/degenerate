...
import 'smartshield_smart_shield_settings_regional_tiered_cache_value.dart';final class SmartshieldSmartShieldSettingsRegionalTieredCache {const SmartshieldSmartShieldSettingsRegionalTieredCache({this.editable, this.id, this.value, });
