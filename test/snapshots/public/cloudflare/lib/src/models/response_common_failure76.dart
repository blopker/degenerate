...
import 'package:collection/collection.dart';import 'waf_managed_rules_messages2.dart';final class ResponseCommonFailure76 {const ResponseCommonFailure76({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure76 copyWith({List<WafManagedRulesMessages2>? errors, List<WafManagedRulesMessages2>? messages, Map<String, String>? Function()? result, bool? success, }) { return ResponseCommonFailure76(
