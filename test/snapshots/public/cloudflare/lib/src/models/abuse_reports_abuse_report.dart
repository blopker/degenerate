...
import 'abuse_reports_mitigation_summary.dart';
import 'abuse_reports_report_status.dart';
import 'abuse_reports_report_type.dart';
import 'abuse_reports_submitter_details.dart';

final class AbuseReportsAbuseReport {
  const AbuseReportsAbuseReport({
    required this.cdate,
  ...
  factory AbuseReportsAbuseReport.fromJson(Map<String, dynamic> json) {
    return AbuseReportsAbuseReport(
      cdate: json['cdate'] as String,
      domain: json['domain'] as String,
      id: json['id'] as String,
      justification: json['justification'] as String?,
      mitigationSummary: AbuseReportsMitigationSummary.fromJson(
        json['mitigation_summary'] as Map<String, dynamic>,
      ),
      ...
      submitter: json['submitter'] != null
          ? AbuseReportsSubmitterDetails.fromJson(
  ...
  AbuseReportsAbuseReport copyWith({
    ...
    AbuseReportsMitigationSummary? mitigationSummary,
    String Function()? originalWork,
    AbuseReportsReportStatus? status,
    AbuseReportsSubmitterDetails Function()? submitter,
    AbuseReportsReportType? type,
    List<String> Function()? urls,
  }) {
    return AbuseReportsAbuseReport(
  ...
  @override
  String toString() {
    return 'AbuseReportsAbuseReport(cdate: $cdate, domain: $domain, id: $id, justification: $justification, mitigationSummary: $mitigationSummary, originalWork: $originalWork, status: $status, submitter: $submitter, type: $type, urls: $urls)';
  }
}
