...
final class ListsCreateAListRequest {const ListsCreateAListRequest({this.description, required this.kind, required this.name, });
...
ListsCreateAListRequest copyWith({String Function()? description, String? kind, String? name, }) { return ListsCreateAListRequest(
