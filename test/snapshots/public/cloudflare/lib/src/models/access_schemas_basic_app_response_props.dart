...
import 'access_schemas_scim_config.dart';final class AccessSchemasBasicAppResponseProps {const AccessSchemasBasicAppResponseProps({this.aud, this.createdAt, this.id, this.scimConfig, this.updatedAt, });
...
AccessSchemasBasicAppResponseProps copyWith({String Function()? aud, DateTime Function()? createdAt, String Function()? id, AccessSchemasScimConfig Function()? scimConfig, DateTime Function()? updatedAt, }) { return AccessSchemasBasicAppResponseProps(
