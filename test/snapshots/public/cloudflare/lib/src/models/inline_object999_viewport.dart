...
final class InlineObject999Viewport {const InlineObject999Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });

factory InlineObject999Viewport.fromJson(Map<String, dynamic> json) { return InlineObject999Viewport(
...
InlineObject999Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return InlineObject999Viewport(
...
@override String toString() { return 'InlineObject999Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
