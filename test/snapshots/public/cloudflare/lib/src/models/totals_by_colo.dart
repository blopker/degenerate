...
final class TotalsByColo {
  ...
  factory TotalsByColo.fromJson(Map<String, dynamic> json) {
    return TotalsByColo(
  ...
  @override
  String toString() {
    return 'TotalsByColo(bandwidth: $bandwidth, requests: $requests, since: $since, threats: $threats, until: $until)';
  }
}
