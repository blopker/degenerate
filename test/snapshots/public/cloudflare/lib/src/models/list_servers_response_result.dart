...
import 'list_servers_response_result_auth_type.dart';

final class ListServersResponseResult {
  const ListServersResponseResult({
  ...
  factory ListServersResponseResult.fromJson(Map<String, dynamic> json) {
    return ListServersResponseResult(
      authType: ListServersResponseResultAuthType.fromJson(
  ...
  ListServersResponseResult copyWith({
    ListServersResponseResultAuthType? authType,
  ...
  @override
  String toString() {
    return 'ListServersResponseResult(authType: $authType, createdAt: $createdAt, createdBy: $createdBy, description: $description, error: $error, hostname: $hostname, id: $id, lastSuccessfulSync: $lastSuccessfulSync, lastSynced: $lastSynced, modifiedAt: $modifiedAt, modifiedBy: $modifiedBy, name: $name, prompts: $prompts, status: $status, tools: $tools)';
  }
}
