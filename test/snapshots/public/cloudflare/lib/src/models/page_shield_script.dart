...
PageShieldScript copyWith({DateTime? addedAt, int? Function()? cryptominingScore, int? Function()? dataflowScore, bool Function()? domainReportedMalicious, String? Function()? fetchedAt, String Function()? firstPageUrl, DateTime? firstSeenAt, String? Function()? hash, String? host, String? id, int? Function()? jsIntegrityScore, DateTime? lastSeenAt, int? Function()? magecartScore, List<String> Function()? maliciousDomainCategories, List<String> Function()? maliciousUrlCategories, int? Function()? malwareScore, int? Function()? obfuscationScore, List<String> Function()? pageUrls, String? url, bool? urlContainsCdnCgiPath, bool Function()? urlReportedMalicious, }) { return PageShieldScript(
