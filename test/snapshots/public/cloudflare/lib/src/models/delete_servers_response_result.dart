...
import 'delete_servers_response_result_auth_type.dart';

final class DeleteServersResponseResult {
  const DeleteServersResponseResult({
  ...
  factory DeleteServersResponseResult.fromJson(Map<String, dynamic> json) {
    return DeleteServersResponseResult(
      authType: DeleteServersResponseResultAuthType.fromJson(
  ...
  DeleteServersResponseResult copyWith({
    DeleteServersResponseResultAuthType? authType,
  ...
  @override
  String toString() {
    return 'DeleteServersResponseResult(authType: $authType, createdAt: $createdAt, createdBy: $createdBy, description: $description, error: $error, hostname: $hostname, id: $id, lastSuccessfulSync: $lastSuccessfulSync, lastSynced: $lastSynced, modifiedAt: $modifiedAt, modifiedBy: $modifiedBy, name: $name, prompts: $prompts, status: $status, tools: $tools)';
  }
}
