...
import 'firewall_detection_mode.dart';import 'firewall_status.dart';final class FirewallPackageDefinition {const FirewallPackageDefinition({required this.description, required this.detectionMode, required this.id, required this.name, this.status, required this.zoneId, });
...
FirewallPackageDefinition copyWith({String? description, FirewallDetectionMode? detectionMode, String? id, String? name, FirewallStatus Function()? status, String? zoneId, }) { return FirewallPackageDefinition(
