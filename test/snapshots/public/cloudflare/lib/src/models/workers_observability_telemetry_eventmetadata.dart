...
final class WorkersObservabilityTelemetryEvent$metadata {
  const WorkersObservabilityTelemetryEvent$metadata({
    this.account,
    this.cloudService,
    this.coldStart,
    this.cost,
  ...
  factory WorkersObservabilityTelemetryEvent$metadata.fromJson(
    Map<String, dynamic> json,
  ) {
    return WorkersObservabilityTelemetryEvent$metadata(
      account: json['account'] as String?,
      cloudService: json['cloudService'] as String?,
      coldStart: json['coldStart'] != null
          ? (json['coldStart'] as num).toInt()
          : null,
      ...
      statusCode: json['statusCode'] != null
          ...
          : null,
      traceDuration: json['traceDuration'] != null
          ? (json['traceDuration'] as num).toInt()
          : null,
  ...
  WorkersObservabilityTelemetryEvent$metadata copyWith({
    String Function()? account,
    String Function()? cloudService,
    int Function()? coldStart,
    int Function()? cost,
    int Function()? duration,
    int Function()? endTime,
    String Function()? error,
    String Function()? errorTemplate,
    String Function()? fingerprint,
    String? id,
    String Function()? level,
    String Function()? message,
    String Function()? messageTemplate,
    String Function()? metricName,
    String Function()? origin,
    String Function()? parentSpanId,
    String Function()? provider,
    String Function()? region,
    String Function()? requestId,
    String Function()? service,
    String Function()? spanId,
    String Function()? spanName,
    String Function()? stackId,
    int Function()? startTime,
    int Function()? statusCode,
    int Function()? traceDuration,
    String Function()? traceId,
    String Function()? transactionName,
    ...
    return WorkersObservabilityTelemetryEvent$metadata(
      ...
      traceDuration: traceDuration != null
          ? traceDuration()
          : this.traceDuration,
