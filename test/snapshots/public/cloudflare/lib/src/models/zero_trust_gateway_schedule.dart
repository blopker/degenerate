...
final class ZeroTrustGatewaySchedule {
  const ZeroTrustGatewaySchedule({
    this.fri,
    this.mon,
    this.sat,
    this.sun,
  ...
  factory ZeroTrustGatewaySchedule.fromJson(Map<String, dynamic> json) {
    return ZeroTrustGatewaySchedule(
  ...
  ZeroTrustGatewaySchedule copyWith({
    String Function()? fri,
    String Function()? mon,
    String Function()? sat,
    String Function()? sun,
  ...
  @override
  int get hashCode {
    return Object.hash(fri, mon, sat, sun, thu, timeZone, tue, wed);
  }

  @override
  String toString() {
    return 'ZeroTrustGatewaySchedule(fri: $fri, mon: $mon, sat: $sat, sun: $sun, thu: $thu, timeZone: $timeZone, tue: $tue, wed: $wed)';
  }
}
