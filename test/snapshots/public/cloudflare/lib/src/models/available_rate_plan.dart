...
import 'schemas_frequency.dart';final class AvailableRatePlan {const AvailableRatePlan({this.canSubscribe, this.currency, this.externallyManaged, this.frequency, this.id, this.isSubscribed, this.legacyDiscount, this.legacyId, this.name, this.price, });
...
AvailableRatePlan copyWith({bool Function()? canSubscribe, String Function()? currency, bool Function()? externallyManaged, SchemasFrequency Function()? frequency, String Function()? id, bool Function()? isSubscribed, bool Function()? legacyDiscount, String Function()? legacyId, String Function()? name, double Function()? price, }) { return AvailableRatePlan(
