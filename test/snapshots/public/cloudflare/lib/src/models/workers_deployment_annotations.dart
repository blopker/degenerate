...
final class WorkersDeploymentAnnotations {
  ...
  factory WorkersDeploymentAnnotations.fromJson(Map<String, dynamic> json) {
  ...
  WorkersDeploymentAnnotations copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(workersMessage, workersTriggeredBy);
  }

  @override
  String toString() {
    return 'WorkersDeploymentAnnotations(workersMessage: $workersMessage, workersTriggeredBy: $workersTriggeredBy)';
  }
}
