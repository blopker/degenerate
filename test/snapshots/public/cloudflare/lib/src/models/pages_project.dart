...
import 'pages_build_config.dart';
import 'pages_deployment.dart';
import 'pages_project_deployment_configs.dart';
import 'pages_source.dart';

final class PagesProject {
  const PagesProject({
    this.buildConfig,
  ...
  factory PagesProject.fromJson(Map<String, dynamic> json) {
    return PagesProject(
      buildConfig: json['build_config'] != null
          ? PagesBuildConfig.fromJson(
              json['build_config'] as Map<String, dynamic>,
            )
          : null,
      canonicalDeployment: PagesDeployment.fromJson(
        json['canonical_deployment'] as Map<String, dynamic>,
      ),
      createdOn: DateTime.parse(json['created_on'] as String),
      deploymentConfigs: PagesProjectDeploymentConfigs.fromJson(
        json['deployment_configs'] as Map<String, dynamic>,
      ),
      ...
      latestDeployment: PagesDeployment.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('canonical_deployment') &&
        json.containsKey('created_on') &&
        json['created_on'] is String &&
        json.containsKey('deployment_configs') &&
        json.containsKey('framework') &&
        json['framework'] is String &&
        json.containsKey('framework_version') &&
        json['framework_version'] is String &&
        json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('latest_deployment') &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('preview_script_name') &&
        json['preview_script_name'] is String &&
        json.containsKey('production_branch') &&
        json['production_branch'] is String &&
        json.containsKey('production_script_name') &&
        json['production_script_name'] is String &&
        json.containsKey('uses_functions') &&
        json['uses_functions'] is bool;
  }

  PagesProject copyWith({
    PagesBuildConfig Function()? buildConfig,
    PagesDeployment? Function()? canonicalDeployment,
    DateTime? createdOn,
    ...
    String? id,
    PagesDeployment? Function()? latestDeployment,
    String? name,
    String? previewScriptName,
    String? productionBranch,
    String? productionScriptName,
    PagesSource Function()? source,
    String Function()? subdomain,
    bool? Function()? usesFunctions,
  }) {
    return PagesProject(
      buildConfig: buildConfig != null ? buildConfig() : this.buildConfig,
      canonicalDeployment: canonicalDeployment != null
          ? canonicalDeployment()
      ...
      usesFunctions: usesFunctions != null
          ? usesFunctions()
          : this.usesFunctions,
    );
  }
