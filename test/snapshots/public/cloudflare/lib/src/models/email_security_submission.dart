...
import 'email_security_submission_customer_status.dart';

final class EmailSecuritySubmission {
  const EmailSecuritySubmission({
    this.customerStatus,
  ...
  factory EmailSecuritySubmission.fromJson(Map<String, dynamic> json) {
    return EmailSecuritySubmission(
      customerStatus: json['customer_status'] != null
          ? EmailSecuritySubmissionCustomerStatus.fromJson(
              json['customer_status'] as String,
            )
          : null,
      originalDisposition: json['original_disposition'] != null
          ? EmailSecurityDispositionLabel.fromJson(
              json['original_disposition'] as String,
            )
          : null,
      originalEdfHash: json['original_edf_hash'] as String?,
      outcome: json['outcome'] as String?,
      outcomeDisposition: json['outcome_disposition'] != null
          ? EmailSecurityDispositionLabel.fromJson(
              json['outcome_disposition'] as String,
            )
          : null,
      requestedBy: json['requested_by'] as String?,
      requestedDisposition: json['requested_disposition'] != null
          ? EmailSecurityDispositionLabel.fromJson(
              json['requested_disposition'] as String,
            )
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('requested_ts') &&
        json['requested_ts'] is String &&
        json.containsKey('submission_id') &&
        json['submission_id'] is String;
  }

  EmailSecuritySubmission copyWith({
    EmailSecuritySubmissionCustomerStatus Function()? customerStatus,
    EmailSecurityDispositionLabel? Function()? originalDisposition,
    String? Function()? originalEdfHash,
    String? Function()? outcome,
    EmailSecurityDispositionLabel? Function()? outcomeDisposition,
    String? Function()? requestedBy,
    EmailSecurityDispositionLabel? Function()? requestedDisposition,
    ...
    return EmailSecuritySubmission(
      customerStatus: customerStatus != null
          ? customerStatus()
          : this.customerStatus,
      originalDisposition: originalDisposition != null
          ? originalDisposition()
          : this.originalDisposition,
      originalEdfHash: originalEdfHash != null
          ? originalEdfHash()
          : this.originalEdfHash,
      ...
      requestedDisposition: requestedDisposition != null
