...
import 'email_security_disposition_label.dart';import 'email_security_submission_customer_status.dart';final class EmailSecuritySubmission {const EmailSecuritySubmission({this.customerStatus, this.originalDisposition, this.originalEdfHash, this.outcome, this.outcomeDisposition, this.requestedBy, this.requestedDisposition, required this.requestedTs, this.status, this.subject, required this.submissionId, this.type, });
