...
import 'radar_get_certificate_log_details_response_result_certificate_log_api.dart';
import 'radar_get_certificate_log_details_response_result_certificate_log_performance.dart';
import 'radar_get_certificate_log_details_response_result_certificate_log_related.dart';
import 'radar_get_certificate_log_details_response_result_certificate_log_state.dart';

final class RadarGetCertificateLogDetailsResponseResultCertificateLog {
  const RadarGetCertificateLogDetailsResponseResultCertificateLog({
    required this.api,
    ...
    required this.submittableCertCount,
    required this.submittedCertCount,
    required this.url,
  });

  factory RadarGetCertificateLogDetailsResponseResultCertificateLog.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetCertificateLogDetailsResponseResultCertificateLog(
      api:
          RadarGetCertificateLogDetailsResponseResultCertificateLogApi.fromJson(
            json['api'] as String,
          ),
      ...
      performance:
          RadarGetCertificateLogDetailsResponseResultCertificateLogPerformance.fromJson(
            json['performance'] as Map<String, dynamic>,
          ),
      related: (json['related'] as List<dynamic>)
          .map(
            (e) =>
                RadarGetCertificateLogDetailsResponseResultCertificateLogRelated.fromJson(
      ...
      state:
          RadarGetCertificateLogDetailsResponseResultCertificateLogState.fromJson(
  ...
  final RadarGetCertificateLogDetailsResponseResultCertificateLogPerformance?
  performance;

  /// Logs from the same operator.
  final List<RadarGetCertificateLogDetailsResponseResultCertificateLogRelated>
  related;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('api') &&
        json.containsKey('avgThroughput') &&
        json['avgThroughput'] is num &&
        json.containsKey('description') &&
        json['description'] is String &&
        json.containsKey('endExclusive') &&
        json['endExclusive'] is String &&
        json.containsKey('lastUpdate') &&
        json['lastUpdate'] is String &&
        ...
        json['slug'] is String &&
        json.containsKey('startInclusive') &&
        json['startInclusive'] is String &&
        json.containsKey('state') &&
        json.containsKey('stateTimestamp') &&
        json['stateTimestamp'] is String &&
        json.containsKey('submittableCertCount') &&
        json['submittableCertCount'] is String &&
        json.containsKey('submittedCertCount') &&
        json['submittedCertCount'] is String &&
        json.containsKey('url') &&
        json['url'] is String;
  }

  RadarGetCertificateLogDetailsResponseResultCertificateLog copyWith({
    RadarGetCertificateLogDetailsResponseResultCertificateLogApi? api,
    ...
    Function()?
    performance,
    List<RadarGetCertificateLogDetailsResponseResultCertificateLogRelated>?
    related,
    String? slug,
    DateTime? startInclusive,
    RadarGetCertificateLogDetailsResponseResultCertificateLogState? state,
    DateTime? stateTimestamp,
    String? Function()? submittableCertCount,
    String? Function()? submittedCertCount,
    String? url,
  }) {
    return RadarGetCertificateLogDetailsResponseResultCertificateLog(
      api: api ?? this.api,
      ...
      submittableCertCount: submittableCertCount != null
          ? submittableCertCount()
          : this.submittableCertCount,
      submittedCertCount: submittedCertCount != null
          ? submittedCertCount()
