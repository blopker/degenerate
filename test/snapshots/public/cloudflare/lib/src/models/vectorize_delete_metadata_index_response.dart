...
final class VectorizeDeleteMetadataIndexResponse {const VectorizeDeleteMetadataIndexResponse({this.mutationId});
...
VectorizeDeleteMetadataIndexResponse copyWith({String Function()? mutationId}) { return VectorizeDeleteMetadataIndexResponse(
