...
final class EmailSecurityAllowPolicy {
  const EmailSecurityAllowPolicy({
    this.comments,
  ...
  factory EmailSecurityAllowPolicy.fromJson(Map<String, dynamic> json) {
    return EmailSecurityAllowPolicy(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('is_acceptable_sender') &&
        json['is_acceptable_sender'] is bool &&
        json.containsKey('is_exempt_recipient') &&
        json['is_exempt_recipient'] is bool &&
        json.containsKey('is_regex') &&
        json['is_regex'] is bool &&
        json.containsKey('is_trusted_sender') &&
        json['is_trusted_sender'] is bool &&
        json.containsKey('pattern') &&
        json['pattern'] is String &&
        json.containsKey('pattern_type') &&
        json.containsKey('verify_sender') &&
        json['verify_sender'] is bool &&
  ...
  EmailSecurityAllowPolicy copyWith({
    String? Function()? comments,
    bool? isAcceptableSender,
    bool? isExemptRecipient,
    bool Function()? isRecipient,
    bool? isRegex,
    bool Function()? isSender,
    bool Function()? isSpoof,
