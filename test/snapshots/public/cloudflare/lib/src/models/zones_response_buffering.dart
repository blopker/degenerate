...
import 'zones_response_buffering_id.dart';import 'zones_response_buffering_value.dart';final class ZonesResponseBuffering {const ZonesResponseBuffering({this.id, this.value, });
