...
final class PaginationMetadata {
  ...
  PaginationMetadata copyWith({
    int Function()? firstPage,
    int Function()? lastPage,
    int Function()? nextPage,
    int Function()? page,
    int Function()? previousPage,
    int Function()? total,
  ...
  @override
  String toString() {
    return 'PaginationMetadata(firstPage: $firstPage, lastPage: $lastPage, nextPage: $nextPage, page: $page, previousPage: $previousPage, total: $total, totalPages: $totalPages)';
  }
}
