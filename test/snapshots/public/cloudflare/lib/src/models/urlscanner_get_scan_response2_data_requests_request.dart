...
import 'urlscanner_get_scan_response2_data_requests_request_initiator.dart';
import 'urlscanner_get_scan_response2_data_requests_request_redirect_response.dart';
import 'urlscanner_get_scan_response2_data_requests_request_request.dart';

final class UrlscannerGetScanResponse2DataRequestsRequest {
  const UrlscannerGetScanResponse2DataRequestsRequest({
  ...
  factory UrlscannerGetScanResponse2DataRequestsRequest.fromJson(
    ...
    return UrlscannerGetScanResponse2DataRequestsRequest(
      ...
      initiator:
          UrlscannerGetScanResponse2DataRequestsRequestInitiator.fromJson(
      ...
      redirectResponse: json['redirectResponse'] != null
          ? UrlscannerGetScanResponse2DataRequestsRequestRedirectResponse.fromJson(
              json['redirectResponse'] as Map<String, dynamic>,
            )
          : null,
      request: UrlscannerGetScanResponse2DataRequestsRequestRequest.fromJson(
  ...
  final UrlscannerGetScanResponse2DataRequestsRequestRedirectResponse?
  redirectResponse;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (redirectResponse != null)
        'redirectResponse': redirectResponse?.toJson(),
  ...
  UrlscannerGetScanResponse2DataRequestsRequest copyWith({
    String? documentUrl,
    String Function()? frameId,
    bool? hasUserGesture,
    UrlscannerGetScanResponse2DataRequestsRequestInitiator? initiator,
    String Function()? loaderId,
    bool Function()? primaryRequest,
    bool? redirectHasExtraInfo,
    UrlscannerGetScanResponse2DataRequestsRequestRedirectResponse Function()?
    redirectResponse,
    UrlscannerGetScanResponse2DataRequestsRequestRequest? request,
    String? requestId,
    String? type,
    double? wallTime,
  }) {
    return UrlscannerGetScanResponse2DataRequestsRequest(
      ...
      primaryRequest: primaryRequest != null
          ? primaryRequest()
          : this.primaryRequest,
