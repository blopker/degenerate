...
import 'r2_data_catalog_namespace_details.dart';

/// Contains the list of namespaces with optional pagination.
final class R2DataCatalogNamespaceListResponse {
  const R2DataCatalogNamespaceListResponse({
    this.details,
    this.namespaceUuids,
  ...
  factory R2DataCatalogNamespaceListResponse.fromJson(
    Map<String, dynamic> json,
  ) {
    return R2DataCatalogNamespaceListResponse(
      details: (json['details'] as List<dynamic>?)
          ?.map(
            (e) => R2DataCatalogNamespaceDetails.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      namespaceUuids: (json['namespace_uuids'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('namespaces');
  }

  R2DataCatalogNamespaceListResponse copyWith({
    List<R2DataCatalogNamespaceDetails>? Function()? details,
    List<String>? Function()? namespaceUuids,
    List<List<String>>? namespaces,
    String? Function()? nextPageToken,
  }) {
    return R2DataCatalogNamespaceListResponse(
      details: details != null ? details() : this.details,
      namespaceUuids: namespaceUuids != null
          ? namespaceUuids()
          : this.namespaceUuids,
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(namespaceUuids ?? const []),
  ...
  @override
  String toString() {
    return 'R2DataCatalogNamespaceListResponse(details: $details, namespaceUuids: $namespaceUuids, namespaces: $namespaces, nextPageToken: $nextPageToken)';
  }
}
