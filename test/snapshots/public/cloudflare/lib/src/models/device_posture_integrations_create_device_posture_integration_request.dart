...
import 'teams_devices_config_request.dart';import 'teams_devices_schemas_type.dart';final class DevicePostureIntegrationsCreateDevicePostureIntegrationRequest {const DevicePostureIntegrationsCreateDevicePostureIntegrationRequest({required this.config, required this.interval, required this.name, required this.type, });
...
DevicePostureIntegrationsCreateDevicePostureIntegrationRequest copyWith({TeamsDevicesConfigRequest? config, String? interval, String? name, TeamsDevicesSchemasType? type, }) { return DevicePostureIntegrationsCreateDevicePostureIntegrationRequest(
