...
final class RadarGetBgpRoutesAsnsResponseResultAsns {
  const RadarGetBgpRoutesAsnsResponseResultAsns({
    required this.asn,
  ...
  factory RadarGetBgpRoutesAsnsResponseResultAsns.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetBgpRoutesAsnsResponseResultAsns(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('asn') &&
        json['asn'] is num &&
        json.containsKey('coneSize') &&
        json['coneSize'] is num &&
        json.containsKey('country') &&
        json['country'] is String &&
        json.containsKey('ipv4Count') &&
        json['ipv4Count'] is num &&
        json.containsKey('ipv6Count') &&
        json['ipv6Count'] is String &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('pfxsCount') &&
        json['pfxsCount'] is num &&
        json.containsKey('rpkiInvalid') &&
        json['rpkiInvalid'] is num &&
        json.containsKey('rpkiUnknown') &&
        json['rpkiUnknown'] is num &&
        json.containsKey('rpkiValid') &&
        json['rpkiValid'] is num;
  }

  RadarGetBgpRoutesAsnsResponseResultAsns copyWith({
    int? asn,
    int? coneSize,
    String? country,
    int? ipv4Count,
  ...
  @override
  String toString() {
    return 'RadarGetBgpRoutesAsnsResponseResultAsns(asn: $asn, coneSize: $coneSize, country: $country, ipv4Count: $ipv4Count, ipv6Count: $ipv6Count, name: $name, pfxsCount: $pfxsCount, rpkiInvalid: $rpkiInvalid, rpkiUnknown: $rpkiUnknown, rpkiValid: $rpkiValid)';
  }
}
