...
final class StreamCopyAudioTrack {const StreamCopyAudioTrack({required this.label, this.url, });
...
StreamCopyAudioTrack copyWith({String? label, Uri Function()? url, }) { return StreamCopyAudioTrack(
