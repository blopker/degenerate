...
import 'package:collection/collection.dart';final class ZeroTrustApplicationsReviewStatusUpdateRequest {const ZeroTrustApplicationsReviewStatusUpdateRequest({required this.approvedApps, required this.inReviewApps, required this.unapprovedApps, });
