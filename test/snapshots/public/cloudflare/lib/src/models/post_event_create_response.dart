...
final class PostEventCreateResponse {
  const PostEventCreateResponse({
  ...
  factory PostEventCreateResponse.fromJson(Map<String, dynamic> json) {
  ...
  PostEventCreateResponse copyWith({
    String? attacker,
