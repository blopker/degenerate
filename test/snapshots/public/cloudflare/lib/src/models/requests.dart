...
import 'requests_ssl.dart';
import 'requests_ssl_protocols.dart';
...
final class Requests {
  ...
  factory Requests.fromJson(Map<String, dynamic> json) {
    return Requests(
      ...
      contentType: (json['content_type'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, v as String),
      ),
      country: (json['country'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, v as String),
      ),
      httpStatus: (json['http_status'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, v as String),
      ),
      ssl: json['ssl'] != null
      ...
      sslProtocols: json['ssl_protocols'] != null
          ? RequestsSslProtocols.fromJson(
              json['ssl_protocols'] as Map<String, dynamic>,
            )
          : null,
      uncached: json['uncached'] != null
          ? (json['uncached'] as num).toInt()
          : null,
    );
  }
  ...
  Requests copyWith({
    int Function()? all,
    int Function()? cached,
    Map<String, String> Function()? contentType,
    Map<String, String> Function()? country,
    Map<String, String> Function()? httpStatus,
    RequestsSsl Function()? ssl,
    RequestsSslProtocols Function()? sslProtocols,
    int Function()? uncached,
  }) {
    return Requests(
  ...
  @override
  String toString() {
    return 'Requests(all: $all, cached: $cached, contentType: $contentType, country: $country, httpStatus: $httpStatus, ssl: $ssl, sslProtocols: $sslProtocols, uncached: $uncached)';
  }
}
