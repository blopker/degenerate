...
final class LivestreamSessionDetailsResponseDataSessions {
  const LivestreamSessionDetailsResponseDataSessions({
    this.createdAt,
    this.errMessage,
    this.id,
    this.ingestSeconds,
  ...
  factory LivestreamSessionDetailsResponseDataSessions.fromJson(
    Map<String, dynamic> json,
  ) {
    return LivestreamSessionDetailsResponseDataSessions(
  ...
  LivestreamSessionDetailsResponseDataSessions copyWith({
  ...
  @override
  String toString() {
    return 'LivestreamSessionDetailsResponseDataSessions(createdAt: $createdAt, errMessage: $errMessage, id: $id, ingestSeconds: $ingestSeconds, invokedTime: $invokedTime, livestreamId: $livestreamId, startedTime: $startedTime, stoppedTime: $stoppedTime, updatedAt: $updatedAt)';
  }
}
