...
final class FirewallRule {
  ...
  factory FirewallRule.fromJson(Map<String, dynamic> json) {
    return FirewallRule(
      allowedModes: (json['allowed_modes'] as List<dynamic>)
          .map((e) => FirewallSchemasMode.fromJson(e as String))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('allowed_modes') &&
  ...
  @override
  String toString() {
    return 'FirewallRule(allowedModes: $allowedModes, configuration: $configuration, createdOn: $createdOn, id: $id, mode: $mode, modifiedOn: $modifiedOn, notes: $notes)';
  }
}
