...
import 'package:collection/collection.dart';import 'firewall_configuration.dart';import 'firewall_schemas_mode.dart';final class FirewallRule {const FirewallRule({required this.allowedModes, required this.configuration, this.createdOn, required this.id, required this.mode, this.modifiedOn, this.notes, });
...
FirewallRule copyWith({List<FirewallSchemasMode>? allowedModes, FirewallConfiguration? configuration, DateTime Function()? createdOn, String? id, FirewallSchemasMode? mode, DateTime Function()? modifiedOn, String Function()? notes, }) { return FirewallRule(
