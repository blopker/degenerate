...
final class WorkersBindingKindAi {const WorkersBindingKindAi({required this.name, required this.type, });
...
WorkersBindingKindAi copyWith({String? name, String? type, }) { return WorkersBindingKindAi(
  name: name ?? this.name,
  type: type ?? this.type,
); } 
