...
final class MagicHealthCheckBaseRate {
  const MagicHealthCheckBaseRate._(this.value);

  factory MagicHealthCheckBaseRate.fromJson(String json) {
    return switch (json) {
      'low' => low,
      'mid' => mid,
      'high' => high,
  ...
  static const MagicHealthCheckBaseRate high = MagicHealthCheckBaseRate._(
    'high',
  );
  ...
  @override
  String toString() {
    return 'MagicHealthCheckBaseRate($value)';
  }
}
