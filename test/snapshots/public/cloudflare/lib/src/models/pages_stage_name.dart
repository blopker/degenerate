...
final class PagesStageName {
  const PagesStageName._(this.value);

  factory PagesStageName.fromJson(String json) {
    return switch (json) {
      'queued' => queued,
  ...
  static const List<PagesStageName> values = [
    queued,
    initialize,
    cloneRepo,
    build,
