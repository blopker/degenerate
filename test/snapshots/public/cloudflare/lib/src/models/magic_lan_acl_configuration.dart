...
import 'package:collection/collection.dart';import 'magic_acl_subnet.dart';final class MagicLanAclConfiguration {const MagicLanAclConfiguration({required this.lanId, this.lanName, this.portRanges, this.ports, this.subnets, });
...
factory MagicLanAclConfiguration.fromJson(Map<String, dynamic> json) { return MagicLanAclConfiguration(
  ...
  portRanges: (json['port_ranges'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ports: (json['ports'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
  subnets: (json['subnets'] as List<dynamic>?)?.map((e) => MagicAclSubnet.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
MagicLanAclConfiguration copyWith({String? lanId, String Function()? lanName, List<String> Function()? portRanges, List<int> Function()? ports, List<MagicAclSubnet> Function()? subnets, }) { return MagicLanAclConfiguration(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is MagicLanAclConfiguration &&
          ...
          const ListEquality<dynamic>().equals(portRanges, other.portRanges) &&
