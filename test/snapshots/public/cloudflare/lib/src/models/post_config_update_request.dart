...
import 'package:collection/collection.dart';final class PostConfigUpdateRequest {const PostConfigUpdateRequest({this.frequency, this.ips, this.ports, });
...
PostConfigUpdateRequest copyWith({double Function()? frequency, List<String> Function()? ips, List<String> Function()? ports, }) { return PostConfigUpdateRequest(
