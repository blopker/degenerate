...
TenantsValidAccountTypesResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<String>? result, bool? success, }) { return TenantsValidAccountTypesResponse(
