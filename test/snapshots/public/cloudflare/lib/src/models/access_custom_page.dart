...
import 'access_schemas_type.dart';final class AccessCustomPage {const AccessCustomPage({this.appCount, this.createdAt, required this.customHtml, required this.name, required this.type, this.uid, this.updatedAt, });
...
AccessCustomPage copyWith({int Function()? appCount, DateTime Function()? createdAt, String? customHtml, String? name, AccessSchemasType? type, String Function()? uid, DateTime Function()? updatedAt, }) { return AccessCustomPage(
