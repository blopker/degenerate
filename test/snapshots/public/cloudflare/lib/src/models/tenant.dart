...
factory Tenant.fromJson(Map<String, dynamic> json) { return Tenant(
  ...
  tenantNetwork: (json['tenant_network'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
...
Tenant copyWith({DateTime? cdate, String Function()? customerId, DateTime? edate, TenantTenantContacts? tenantContacts, List<String>? tenantLabels, TenantTenantMetadata? tenantMetadata, String? tenantName, Map<String,String>? tenantNetwork, String? tenantStatus, String? tenantTag, String? tenantType, List<TenantUnit>? tenantUnits, }) { return Tenant(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Tenant &&
          ...
          const ListEquality<dynamic>().equals(tenantLabels, other.tenantLabels) &&
          ...
          const ListEquality<dynamic>().equals(tenantUnits, other.tenantUnits); } 
