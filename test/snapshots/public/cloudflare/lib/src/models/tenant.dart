...
import 'tenant_tenant_contacts.dart';
import 'tenant_tenant_metadata.dart';
import 'tenant_unit.dart';
...
final class Tenant {
  ...
  factory Tenant.fromJson(Map<String, dynamic> json) {
    return Tenant(
      ...
      tenantContacts: TenantTenantContacts.fromJson(
        json['tenant_contacts'] as Map<String, dynamic>,
      ),
      tenantLabels: (json['tenant_labels'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      tenantMetadata: TenantTenantMetadata.fromJson(
        json['tenant_metadata'] as Map<String, dynamic>,
      ),
      tenantName: json['tenant_name'] as String,
      tenantNetwork: (json['tenant_network'] as Map<String, dynamic>).map(
        (k, v) => MapEntry(k, v as String),
      ),
      tenantStatus: json['tenant_status'] as String,
      tenantTag: json['tenant_tag'] as String,
      tenantType: json['tenant_type'] as String,
      tenantUnits: (json['tenant_units'] as List<dynamic>)
  ...
  final Map<String, String> tenantNetwork;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('cdate') &&
        json['cdate'] is String &&
        json.containsKey('edate') &&
        json['edate'] is String &&
        json.containsKey('tenant_contacts') &&
        json.containsKey('tenant_labels') &&
        json.containsKey('tenant_metadata') &&
        json.containsKey('tenant_name') &&
        json['tenant_name'] is String &&
        json.containsKey('tenant_network') &&
        json.containsKey('tenant_status') &&
        json['tenant_status'] is String &&
        json.containsKey('tenant_tag') &&
        json['tenant_tag'] is String &&
        json.containsKey('tenant_type') &&
        json['tenant_type'] is String &&
  ...
  Tenant copyWith({
    ...
    DateTime? edate,
    TenantTenantContacts? tenantContacts,
    List<String>? tenantLabels,
    TenantTenantMetadata? tenantMetadata,
    String? tenantName,
    Map<String, String>? tenantNetwork,
    String? tenantStatus,
    String? tenantTag,
    String? tenantType,
  ...
  int get hashCode {
    return Object.hash(
      ...
      tenantTag,
      tenantType,
      Object.hashAll(tenantUnits),
    );
  }

  @override
  String toString() {
    return 'Tenant(cdate: $cdate, customerId: $customerId, edate: $edate, tenantContacts: $tenantContacts, tenantLabels: $tenantLabels, tenantMetadata: $tenantMetadata, tenantName: $tenantName, tenantNetwork: $tenantNetwork, tenantStatus: $tenantStatus, tenantTag: $tenantTag, tenantType: $tenantType, tenantUnits: $tenantUnits)';
  }
}
