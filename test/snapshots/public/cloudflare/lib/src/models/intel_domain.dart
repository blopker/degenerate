...
import 'package:collection/collection.dart';import 'intel_additional_information.dart';import 'intel_application.dart';import 'intel_category_with_super_category_id.dart';import 'intel_content_categories2.dart';import 'intel_resolves_to_ref.dart';final class IntelDomain {const IntelDomain({this.additionalInformation, this.application, this.contentCategories, this.domain, this.inheritedContentCategories, this.inheritedFrom, this.inheritedRiskTypes, this.popularityRank, this.resolvesToRefs, this.riskScore, this.riskTypes, });
...
factory IntelDomain.fromJson(Map<String, dynamic> json) { return IntelDomain(
  ...
  popularityRank: json['popularity_rank'] != null ? (json['popularity_rank'] as num).toInt() : null,
...
IntelDomain copyWith({IntelAdditionalInformation Function()? additionalInformation, IntelApplication Function()? application, List<IntelContentCategories2> Function()? contentCategories, String Function()? domain, List<IntelCategoryWithSuperCategoryId> Function()? inheritedContentCategories, String Function()? inheritedFrom, List<IntelCategoryWithSuperCategoryId> Function()? inheritedRiskTypes, int Function()? popularityRank, List<IntelResolvesToRef> Function()? resolvesToRefs, double Function()? riskScore, List<IntelCategoryWithSuperCategoryId> Function()? riskTypes, }) { return IntelDomain(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IntelDomain &&
          ...
          const ListEquality<dynamic>().equals(contentCategories, other.contentCategories) &&
          domain == other.domain &&
          const ListEquality<dynamic>().equals(inheritedContentCategories, other.inheritedContentCategories) &&
          inheritedFrom == other.inheritedFrom &&
          const ListEquality<dynamic>().equals(inheritedRiskTypes, other.inheritedRiskTypes) &&
          popularityRank == other.popularityRank &&
          const ListEquality<dynamic>().equals(resolvesToRefs, other.resolvesToRefs) &&
