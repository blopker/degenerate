...
import 'infra_ip_info.dart';final class InfraTarget {const InfraTarget({required this.createdAt, required this.hostname, required this.id, required this.ip, required this.modifiedAt, });
...
InfraTarget copyWith({DateTime? createdAt, String? hostname, String? id, InfraIpInfo? ip, DateTime? modifiedAt, }) { return InfraTarget(
