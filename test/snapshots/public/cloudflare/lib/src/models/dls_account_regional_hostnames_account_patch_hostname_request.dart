...
final class DlsAccountRegionalHostnamesAccountPatchHostnameRequest {const DlsAccountRegionalHostnamesAccountPatchHostnameRequest({required this.regionKey});
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('region_key') && json['region_key'] is String; } 
DlsAccountRegionalHostnamesAccountPatchHostnameRequest copyWith({String? regionKey}) { return DlsAccountRegionalHostnamesAccountPatchHostnameRequest(
