...
import 'email_email_setting_status.dart';final class EmailEmailSettingsProperties {const EmailEmailSettingsProperties({this.created, required this.enabled, required this.id, this.modified, required this.name, this.skipWizard, this.status, this.tag, });
...
EmailEmailSettingsProperties copyWith({DateTime Function()? created, bool? enabled, String? id, DateTime Function()? modified, String? name, bool Function()? skipWizard, EmailEmailSettingStatus Function()? status, String Function()? tag, }) { return EmailEmailSettingsProperties(
