...
final class RulesetsRuleExposedCredentialCheck {
  const RulesetsRuleExposedCredentialCheck({
    required this.passwordExpression,
    required this.usernameExpression,
  });

  factory RulesetsRuleExposedCredentialCheck.fromJson(
    Map<String, dynamic> json,
  ) {
    return RulesetsRuleExposedCredentialCheck(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('password_expression') &&
        json['password_expression'] is String &&
        json.containsKey('username_expression') &&
        json['username_expression'] is String;
  }

  RulesetsRuleExposedCredentialCheck copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(passwordExpression, usernameExpression);
  }

  @override
  String toString() {
    return 'RulesetsRuleExposedCredentialCheck(passwordExpression: $passwordExpression, usernameExpression: $usernameExpression)';
  }
}
