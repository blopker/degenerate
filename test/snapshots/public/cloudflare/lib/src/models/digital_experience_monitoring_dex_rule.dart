...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_dex_targeted_test.dart';final class DigitalExperienceMonitoringDexRule {const DigitalExperienceMonitoringDexRule({required this.createdAt, this.description, required this.id, required this.match, required this.name, this.targetedTests, this.updatedAt, });
...
DigitalExperienceMonitoringDexRule copyWith({String? createdAt, String Function()? description, String? id, String? match, String? name, List<DigitalExperienceMonitoringDexTargetedTest> Function()? targetedTests, String Function()? updatedAt, }) { return DigitalExperienceMonitoringDexRule(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DigitalExperienceMonitoringDexRule &&
          ...
          match == other.match &&
          name == other.name &&
          const ListEquality<dynamic>().equals(targetedTests, other.targetedTests) &&
