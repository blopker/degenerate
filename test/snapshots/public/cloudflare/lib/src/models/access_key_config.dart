...
factory AccessKeyConfig.fromJson(Map<String, dynamic> json) { return AccessKeyConfig(
  daysUntilNextRotation: json['days_until_next_rotation'] != null ? (json['days_until_next_rotation'] as num).toDouble() : null,
  keyRotationIntervalDays: json['key_rotation_interval_days'] != null ? (json['key_rotation_interval_days'] as num).toDouble() : null,
  lastKeyRotationAt: json['last_key_rotation_at'] != null ? DateTime.parse(json['last_key_rotation_at'] as String) : null,
); }
...
Map<String, dynamic> toJson() { return {
  ...
  if (lastKeyRotationAt != null) 'last_key_rotation_at': lastKeyRotationAt?.toIso8601String(),
}; } 
static bool canParse(Map<String, dynamic> json) { return true; } 
AccessKeyConfig copyWith({double Function()? daysUntilNextRotation, double Function()? keyRotationIntervalDays, DateTime Function()? lastKeyRotationAt, }) { return AccessKeyConfig(
