...
import 'pages_deployment_deployment_trigger.dart';
import 'pages_deployment_environment.dart';
import 'pages_source.dart';
import 'pages_stage.dart';

final class PagesDeployment {
  ...
  factory PagesDeployment.fromJson(Map<String, dynamic> json) {
    return PagesDeployment(
      aliases: (json['aliases'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      buildConfig: PagesBuildConfig.fromJson(
        json['build_config'] as Map<String, dynamic>,
      ),
      createdOn: DateTime.parse(json['created_on'] as String),
      deploymentTrigger: PagesDeploymentDeploymentTrigger.fromJson(
      ...
      environment: PagesDeploymentEnvironment.fromJson(
        json['environment'] as String,
      ),
      id: json['id'] as String,
      isSkipped: json['is_skipped'] as bool,
      latestStage: PagesStage.fromJson(
      ...
      stages: (json['stages'] as List<dynamic>)
          .map((e) => PagesStage.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('aliases') &&
  ...
  PagesDeployment copyWith({
    List<String>? Function()? aliases,
    PagesBuildConfig? buildConfig,
    DateTime? createdOn,
    PagesDeploymentDeploymentTrigger? deploymentTrigger,
    Map<String, InlineObject117>? Function()? envVars,
    PagesDeploymentEnvironment? environment,
    String? id,
    bool? isSkipped,
    PagesStage? latestStage,
    DateTime? modifiedOn,
    String? projectId,
    String? projectName,
    String? shortId,
