...
import 'wor_batch_terminate_workflow_instances_response_result_status.dart';final class WorBatchTerminateWorkflowInstancesResponseResult {const WorBatchTerminateWorkflowInstancesResponseResult({required this.instancesTerminated, required this.status, });
