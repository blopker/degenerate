...
import 'pages_deployment_create_deployment_request_commit_dirty.dart';

final class PagesDeploymentCreateDeploymentRequest {
  const PagesDeploymentCreateDeploymentRequest({
    this.headers,
    this.redirects,
    this.routesJson,
    this.workerBundle,
    ...
    this.commitHash,
    this.commitMessage,
    this.functionsFilepathRoutingConfigJson,
    this.manifest,
    this.pagesBuildOutputDir,
    this.wranglerConfigHash,
  });

  factory PagesDeploymentCreateDeploymentRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return PagesDeploymentCreateDeploymentRequest(
      headers: json['_headers'] != null
          ? base64Decode(json['_headers'] as String)
          : null,
      redirects: json['_redirects'] != null
          ? base64Decode(json['_redirects'] as String)
          : null,
      routesJson: json['_routes.json'] != null
          ? base64Decode(json['_routes.json'] as String)
          : null,
      workerBundle: json['_worker.bundle'] != null
          ? base64Decode(json['_worker.bundle'] as String)
          : null,
      workerJs: json['_worker.js'] != null
          ? base64Decode(json['_worker.js'] as String)
          : null,
      branch: json['branch'] as String?,
      commitDirty: json['commit_dirty'] != null
          ? PagesDeploymentCreateDeploymentRequestCommitDirty.fromJson(
              json['commit_dirty'] as String,
            )
          : null,
      commitHash: json['commit_hash'] as String?,
      commitMessage: json['commit_message'] as String?,
      functionsFilepathRoutingConfigJson:
          json['functions-filepath-routing-config.json'] != null
          ? base64Decode(
              json['functions-filepath-routing-config.json'] as String,
            )
          : null,
  ...
  PagesDeploymentCreateDeploymentRequest copyWith({
    Uint8List Function()? headers,
    Uint8List Function()? redirects,
    Uint8List Function()? routesJson,
    Uint8List Function()? workerBundle,
    Uint8List Function()? workerJs,
    String Function()? branch,
    PagesDeploymentCreateDeploymentRequestCommitDirty Function()? commitDirty,
    String Function()? commitHash,
    String Function()? commitMessage,
    Uint8List Function()? functionsFilepathRoutingConfigJson,
    String Function()? manifest,
    String Function()? pagesBuildOutputDir,
    ...
    return PagesDeploymentCreateDeploymentRequest(
      ...
      commitMessage: commitMessage != null
          ...
          : this.commitMessage,
      functionsFilepathRoutingConfigJson:
          functionsFilepathRoutingConfigJson != null
          ? functionsFilepathRoutingConfigJson()
          : this.functionsFilepathRoutingConfigJson,
      manifest: manifest != null ? manifest() : this.manifest,
      pagesBuildOutputDir: pagesBuildOutputDir != null
          ? pagesBuildOutputDir()
          : this.pagesBuildOutputDir,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PagesDeploymentCreateDeploymentRequest &&
            ...
            functionsFilepathRoutingConfigJson ==
                other.functionsFilepathRoutingConfigJson &&
