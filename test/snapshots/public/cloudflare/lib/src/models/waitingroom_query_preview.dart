...
final class WaitingroomQueryPreview {const WaitingroomQueryPreview({required this.customHtml});
...
WaitingroomQueryPreview copyWith({String? customHtml}) { return WaitingroomQueryPreview(
