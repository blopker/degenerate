...
factory AaaAuditLogs2Resource.fromJson(Map<String, dynamic> json) { return AaaAuditLogs2Resource(
  ...
  request: (json['request'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  response: (json['response'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  scope: (json['scope'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
...
AaaAuditLogs2Resource copyWith({String Function()? id, String Function()? product, Map<String, String> Function()? request, Map<String, String> Function()? response, Map<String, String> Function()? scope, String Function()? type, }) { return AaaAuditLogs2Resource(
