...
import 'package:collection/collection.dart';import 'response_message.dart';import 'teams_devices_ip_profile.dart';import 'teams_devices_pagination_info.dart';final class ListIpProfilesResponse {const ListIpProfilesResponse({required this.errors, required this.messages, required this.result, this.resultInfo, required this.success, });
...
factory ListIpProfilesResponse.fromJson(Map<String, dynamic> json) { return ListIpProfilesResponse(
  ...
  resultInfo: json['result_info'] != null
        ? TeamsDevicesPaginationInfo.fromJson(json['result_info'] as Map<String, dynamic>)
        : null,
