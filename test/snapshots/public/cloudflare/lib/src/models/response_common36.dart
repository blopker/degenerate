...
import 'package:collection/collection.dart';import 'images_messages2.dart';import 'response_common36_result.dart';final class ResponseCommon36 {const ResponseCommon36({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon36.fromJson(Map<String, dynamic> json) { return ResponseCommon36(
  ...
  result: ResponseCommon36Result.fromJson(json['result'] as Map<String, dynamic>),
