...
final class RadarGetAttacksLayer7TopAttacksResponseResultTop0 {
  const RadarGetAttacksLayer7TopAttacksResponseResultTop0({
  ...
  factory RadarGetAttacksLayer7TopAttacksResponseResultTop0.fromJson(
    Map<String, dynamic> json,
  ) {
    return RadarGetAttacksLayer7TopAttacksResponseResultTop0(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('originCountryAlpha2') &&
        json['originCountryAlpha2'] is String &&
        json.containsKey('originCountryName') &&
        json['originCountryName'] is String &&
        json.containsKey('targetCountryAlpha2') &&
        json['targetCountryAlpha2'] is String &&
        json.containsKey('targetCountryName') &&
        json['targetCountryName'] is String &&
        json.containsKey('value') &&
        json['value'] is String;
  }

  RadarGetAttacksLayer7TopAttacksResponseResultTop0 copyWith({
    String? originCountryAlpha2,
    String? originCountryName,
    String? targetCountryAlpha2,
  ...
  @override
  String toString() {
    return 'RadarGetAttacksLayer7TopAttacksResponseResultTop0(originCountryAlpha2: $originCountryAlpha2, originCountryName: $originCountryName, targetCountryAlpha2: $targetCountryAlpha2, targetCountryName: $targetCountryName, value: $value)';
  }
}
