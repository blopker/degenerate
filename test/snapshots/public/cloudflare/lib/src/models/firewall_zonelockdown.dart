...
import 'package:collection/collection.dart';import 'firewall_configurations2.dart';final class FirewallZonelockdown {const FirewallZonelockdown({required this.configurations, required this.createdOn, required this.description, required this.id, required this.modifiedOn, required this.paused, required this.urls, });
...
FirewallZonelockdown copyWith({List<FirewallConfigurations2>? configurations, DateTime? createdOn, String? description, String? id, DateTime? modifiedOn, bool? paused, List<String>? urls, }) { return FirewallZonelockdown(
