...
import 'shield_old_kind.dart';final class ShieldOldPublicSchema {const ShieldOldPublicSchema({required this.createdAt, required this.kind, required this.name, required this.schemaId, this.source, this.validationEnabled, });
...
ShieldOldPublicSchema copyWith({DateTime? createdAt, ShieldOldKind? kind, String? name, String? schemaId, String Function()? source, bool Function()? validationEnabled, }) { return ShieldOldPublicSchema(
