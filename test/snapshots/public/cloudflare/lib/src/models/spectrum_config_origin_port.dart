...
final class SpectrumConfigOriginPort {const SpectrumConfigOriginPort({this.$int, this.string, });

factory SpectrumConfigOriginPort.fromJson(Object? json) { return SpectrumConfigOriginPort(
