...
final class ZeroTrustGatewayRuleSettingsNotificationSettings {
  const ZeroTrustGatewayRuleSettingsNotificationSettings({
    this.enabled,
    this.includeContext,
    this.msg,
    this.supportUrl,
  ...
  factory ZeroTrustGatewayRuleSettingsNotificationSettings.fromJson(
    Map<String, dynamic> json,
  ) {
    return ZeroTrustGatewayRuleSettingsNotificationSettings(
  ...
  ZeroTrustGatewayRuleSettingsNotificationSettings copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(enabled, includeContext, msg, supportUrl);
  }

  @override
  String toString() {
    return 'ZeroTrustGatewayRuleSettingsNotificationSettings(enabled: $enabled, includeContext: $includeContext, msg: $msg, supportUrl: $supportUrl)';
  }
}
