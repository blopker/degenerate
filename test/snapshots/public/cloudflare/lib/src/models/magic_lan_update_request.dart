...
import 'package:collection/collection.dart';import 'magic_lan_static_addressing.dart';import 'magic_nat.dart';import 'magic_routed_subnet.dart';final class MagicLanUpdateRequest {const MagicLanUpdateRequest({this.bondId, this.isBreakout, this.isPrioritized, this.name, this.nat, this.physport, this.routedSubnets, this.staticAddressing, this.vlanTag, });
...
MagicLanUpdateRequest copyWith({int Function()? bondId, bool Function()? isBreakout, bool Function()? isPrioritized, String Function()? name, MagicNat Function()? nat, int Function()? physport, List<MagicRoutedSubnet> Function()? routedSubnets, MagicLanStaticAddressing Function()? staticAddressing, int Function()? vlanTag, }) { return MagicLanUpdateRequest(
