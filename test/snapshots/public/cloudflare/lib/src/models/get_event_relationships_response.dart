...
final class GetEventRelationshipsResponse {
  const GetEventRelationshipsResponse({
  ...
  factory GetEventRelationshipsResponse.fromJson(Map<String, dynamic> json) {
    return GetEventRelationshipsResponse(
      ...
      mitreAttack: (json['mitreAttack'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      ...
      referenced: (json['referenced'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      referencedIds: (json['referencedIds'] as List<dynamic>)
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('attacker') &&
        json['attacker'] is String &&
        json.containsKey('attackerCountry') &&
        json['attackerCountry'] is String &&
        ...
        json['hasChildren'] is bool &&
        json.containsKey('indicator') &&
        json['indicator'] is String &&
        json.containsKey('indicatorType') &&
        json['indicatorType'] is String &&
        json.containsKey('indicatorTypeId') &&
        json['indicatorTypeId'] is num &&
        json.containsKey('killChain') &&
        json['killChain'] is num &&
        json.containsKey('mitreAttack') &&
        json.containsKey('numReferenced') &&
        json['numReferenced'] is num &&
        json.containsKey('numReferences') &&
        json['numReferences'] is num &&
        json.containsKey('rawId') &&
        json['rawId'] is String &&
        ...
        json.containsKey('targetCountry') &&
        json['targetCountry'] is String &&
        json.containsKey('targetIndustry') &&
        json['targetIndustry'] is String &&
  ...
  GetEventRelationshipsResponse copyWith({
    String? attacker,
    ...
    double? indicatorTypeId,
    String Function()? insight,
    double? killChain,
    List<String>? mitreAttack,
    double? numReferenced,
    double? numReferences,
    String? rawId,
    List<String>? referenced,
    List<double>? referencedIds,
    List<String>? references,
    List<double>? referencesIds,
    String Function()? releasabilityId,
    List<String>? tags,
    ...
    return GetEventRelationshipsResponse(
      ...
      releasabilityId: releasabilityId != null
          ? releasabilityId()
          : this.releasabilityId,
      tags: tags ?? this.tags,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      insight,
      killChain,
      Object.hashAll(mitreAttack),
      numReferenced,
      numReferences,
      rawId,
      Object.hashAll(referenced),
      Object.hashAll(referencedIds),
      Object.hashAll(references),
      Object.hashAll(referencesIds),
      releasabilityId,
      Object.hashAll(tags),
      targetCountry,
      targetIndustry,
