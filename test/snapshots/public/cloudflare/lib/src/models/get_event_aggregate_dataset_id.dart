...
final class GetEventAggregateDatasetId {const GetEventAggregateDatasetId({this.string, this.listString, });

factory GetEventAggregateDatasetId.fromJson(Object? json) { return GetEventAggregateDatasetId(
