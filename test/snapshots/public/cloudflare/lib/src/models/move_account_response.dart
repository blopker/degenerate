...
final class MoveAccountResponse {
  const MoveAccountResponse({
    required this.accountId,
    required this.destinationOrganizationId,
    required this.sourceOrganizationId,
  });

  factory MoveAccountResponse.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('account_id') &&
        ...
        json.containsKey('source_organization_id') &&
        json['source_organization_id'] is String;
  }

  MoveAccountResponse copyWith({
    String? accountId,
  ...
  @override
  String toString() {
    return 'MoveAccountResponse(accountId: $accountId, destinationOrganizationId: $destinationOrganizationId, sourceOrganizationId: $sourceOrganizationId)';
  }
}
