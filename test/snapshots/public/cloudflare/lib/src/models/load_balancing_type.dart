...
final class LoadBalancingType {
  const LoadBalancingType._(this.value);

  factory LoadBalancingType.fromJson(String json) {
    return switch (json) {
      'http' => http,
      'https' => https,
      'tcp' => tcp,
  ...
  static const List<LoadBalancingType> values = [
    http,
    https,
    tcp,
    udpIcmp,
  ...
  @override
  String toString() {
    return 'LoadBalancingType($value)';
  }
}
