...
import 'package:collection/collection.dart';import 'aig_config_get_gateway_dynamic_route_version_response_result_active.dart';import 'aig_config_get_gateway_dynamic_route_version_response_result_elements.dart';final class AigConfigGetGatewayDynamicRouteVersionResponseResult {const AigConfigGetGatewayDynamicRouteVersionResponseResult({required this.active, this.comment, required this.createdAt, required this.data, required this.elements, required this.gatewayId, required this.id, required this.modifiedAt, required this.name, required this.versionId, });
...
factory AigConfigGetGatewayDynamicRouteVersionResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigGetGatewayDynamicRouteVersionResponseResult(
  ...
  elements: (json['elements'] as List<dynamic>).map((e) => AigConfigGetGatewayDynamicRouteVersionResponseResultElements.fromJson(e)).toList(),
