...
import 'bandwidth2_ssl.dart';
import 'bandwidth2_ssl_protocols.dart';

/// Breakdown of totals for bandwidth in the form of bytes.
final class Bandwidth2 {
  const Bandwidth2({
    this.all,
    this.cached,
    this.contentType,
  ...
  factory Bandwidth2.fromJson(Map<String, dynamic> json) {
    return Bandwidth2(
      ...
      sslProtocols: json['ssl_protocols'] != null
          ? Bandwidth2SslProtocols.fromJson(
  ...
  Bandwidth2 copyWith({
    ...
    Bandwidth2Ssl Function()? ssl,
    Bandwidth2SslProtocols Function()? sslProtocols,
  ...
  @override
  String toString() {
    return 'Bandwidth2(all: $all, cached: $cached, contentType: $contentType, country: $country, ssl: $ssl, sslProtocols: $sslProtocols, uncached: $uncached)';
  }
}
