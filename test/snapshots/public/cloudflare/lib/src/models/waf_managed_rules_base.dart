...
import 'waf_managed_rules_base_group.dart';final class WafManagedRulesBase {const WafManagedRulesBase({this.description, this.group, this.id, this.packageId, this.priority, });
...
WafManagedRulesBase copyWith({String Function()? description, WafManagedRulesBaseGroup Function()? group, String Function()? id, String Function()? packageId, String Function()? priority, }) { return WafManagedRulesBase(
