...
import 'realtimekit_update_preset_permissions_chat.dart';
import 'realtimekit_update_preset_permissions_connected_meetings.dart';
import 'realtimekit_update_preset_permissions_media.dart';
import 'realtimekit_update_preset_permissions_plugins.dart';
import 'realtimekit_update_preset_permissions_polls.dart';
import 'realtimekit_update_preset_permissions_recorder_type.dart';
import 'realtimekit_update_preset_permissions_waiting_room_type.dart';

final class RealtimekitUpdatePresetPermissions {
  const RealtimekitUpdatePresetPermissions({
    ...
    this.plugins,
    this.polls,
    this.recorderType = RealtimekitUpdatePresetPermissionsRecorderType.none,
    this.showParticipantList,
    this.waitingRoomType,
  });

  factory RealtimekitUpdatePresetPermissions.fromJson(
    Map<String, dynamic> json,
  ) {
    return RealtimekitUpdatePresetPermissions(
      ...
      chat: json['chat'] != null
          ? RealtimekitUpdatePresetPermissionsChat.fromJson(
              json['chat'] as Map<String, dynamic>,
            )
          : null,
      connectedMeetings: json['connected_meetings'] != null
          ? RealtimekitUpdatePresetPermissionsConnectedMeetings.fromJson(
      ...
      media: json['media'] != null
          ? RealtimekitUpdatePresetPermissionsMedia.fromJson(
              json['media'] as Map<String, dynamic>,
            )
          : null,
      pinParticipant: json['pin_participant'] as bool?,
      plugins: json['plugins'] != null
          ? RealtimekitUpdatePresetPermissionsPlugins.fromJson(
              json['plugins'] as Map<String, dynamic>,
            )
          : null,
      polls: json['polls'] != null
          ? RealtimekitUpdatePresetPermissionsPolls.fromJson(
              json['polls'] as Map<String, dynamic>,
            )
          : null,
      recorderType: json.containsKey('recorder_type')
          ? RealtimekitUpdatePresetPermissionsRecorderType.fromJson(
              json['recorder_type'] as String,
            )
          : RealtimekitUpdatePresetPermissionsRecorderType.none,
      showParticipantList: json['show_participant_list'] as bool?,
      waitingRoomType: json['waiting_room_type'] != null
          ? RealtimekitUpdatePresetPermissionsWaitingRoomType.fromJson(
  ...
  RealtimekitUpdatePresetPermissions copyWith({
    bool Function()? acceptWaitingRequests,
    bool Function()? canAcceptProductionRequests,
    bool Function()? canChangeParticipantPermissions,
    bool Function()? canEditDisplayName,
    bool Function()? canLivestream,
    bool Function()? canRecord,
    bool Function()? canSpotlight,
    RealtimekitUpdatePresetPermissionsChat Function()? chat,
    RealtimekitUpdatePresetPermissionsConnectedMeetings Function()?
    connectedMeetings,
    bool Function()? disableParticipantAudio,
    bool Function()? disableParticipantScreensharing,
    bool Function()? disableParticipantVideo,
    bool Function()? hiddenParticipant,
    bool Function()? isRecorder,
    bool Function()? kickParticipant,
    RealtimekitUpdatePresetPermissionsMedia Function()? media,
    bool Function()? pinParticipant,
    RealtimekitUpdatePresetPermissionsPlugins Function()? plugins,
    RealtimekitUpdatePresetPermissionsPolls Function()? polls,
    RealtimekitUpdatePresetPermissionsRecorderType Function()? recorderType,
    bool Function()? showParticipantList,
    RealtimekitUpdatePresetPermissionsWaitingRoomType Function()?
    waitingRoomType,
  }) {
    return RealtimekitUpdatePresetPermissions(
      acceptWaitingRequests: acceptWaitingRequests != null
          ? acceptWaitingRequests()
          : this.acceptWaitingRequests,
      canAcceptProductionRequests: canAcceptProductionRequests != null
          ? canAcceptProductionRequests()
          : this.canAcceptProductionRequests,
      canChangeParticipantPermissions: canChangeParticipantPermissions != null
          ? canChangeParticipantPermissions()
          : this.canChangeParticipantPermissions,
      canEditDisplayName: canEditDisplayName != null
          ? canEditDisplayName()
          : this.canEditDisplayName,
      canLivestream: canLivestream != null
          ? canLivestream()
          : this.canLivestream,
      ...
      connectedMeetings: connectedMeetings != null
          ? connectedMeetings()
          : this.connectedMeetings,
      disableParticipantAudio: disableParticipantAudio != null
          ? disableParticipantAudio()
          : this.disableParticipantAudio,
      disableParticipantScreensharing: disableParticipantScreensharing != null
          ? disableParticipantScreensharing()
          : this.disableParticipantScreensharing,
      disableParticipantVideo: disableParticipantVideo != null
          ? disableParticipantVideo()
          : this.disableParticipantVideo,
      hiddenParticipant: hiddenParticipant != null
          ? hiddenParticipant()
          : this.hiddenParticipant,
      isRecorder: isRecorder != null ? isRecorder() : this.isRecorder,
      kickParticipant: kickParticipant != null
          ? kickParticipant()
          : this.kickParticipant,
      media: media != null ? media() : this.media,
      pinParticipant: pinParticipant != null
          ? pinParticipant()
          : this.pinParticipant,
      ...
      showParticipantList: showParticipantList != null
          ? showParticipantList()
          : this.showParticipantList,
