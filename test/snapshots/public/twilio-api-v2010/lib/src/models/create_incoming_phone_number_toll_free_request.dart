...
import 'create_incoming_phone_number_toll_free_request_sms_fallback_method.dart';import 'create_incoming_phone_number_toll_free_request_sms_method.dart';import 'create_incoming_phone_number_toll_free_request_status_callback_method.dart';import 'create_incoming_phone_number_toll_free_request_voice_fallback_method.dart';import 'create_incoming_phone_number_toll_free_request_voice_method.dart';import 'incoming_phone_number_toll_free_enum_emergency_status.dart';import 'incoming_phone_number_toll_free_enum_voice_receive_mode.dart';final class CreateIncomingPhoneNumberTollFreeRequest {const CreateIncomingPhoneNumberTollFreeRequest({required this.phoneNumber, this.apiVersion, this.friendlyName, this.smsApplicationSid, this.smsFallbackMethod, this.smsFallbackUrl, this.smsMethod, this.smsUrl, this.statusCallback, this.statusCallbackMethod, this.voiceApplicationSid, this.voiceCallerIdLookup, this.voiceFallbackMethod, this.voiceFallbackUrl, this.voiceMethod, this.voiceUrl, this.identitySid, this.addressSid, this.emergencyStatus, this.emergencyAddressSid, this.trunkSid, this.voiceReceiveMode, this.bundleSid, });
