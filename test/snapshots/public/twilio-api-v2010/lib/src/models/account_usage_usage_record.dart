...
final class AccountUsageUsageRecord {
  const AccountUsageUsageRecord({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecord.fromJson(Map<String, dynamic> json) {
    return AccountUsageUsageRecord(
  ...
  AccountUsageUsageRecord copyWith({
  ...
  @override
  String toString() {
    return 'AccountUsageUsageRecord(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)';
  }
}
