...
final class AccountUsageUsageRecordUsageRecordToday {
  const AccountUsageUsageRecordUsageRecordToday({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordToday.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordToday(
  ...
  AccountUsageUsageRecordUsageRecordToday copyWith({
  ...
  @override
  String toString() {
    return 'AccountUsageUsageRecordUsageRecordToday(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)';
  }
}
