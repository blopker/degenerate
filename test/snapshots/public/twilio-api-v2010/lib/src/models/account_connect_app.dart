...
import 'package:collection/collection.dart';import 'account_connect_app_deauthorize_callback_method.dart';import 'connect_app_enum_permission.dart';final class AccountConnectApp {const AccountConnectApp({this.accountSid, this.authorizeRedirectUrl, this.companyName, this.deauthorizeCallbackMethod, this.deauthorizeCallbackUrl, this.description, this.friendlyName, this.homepageUrl, this.permissions, this.sid, this.uri, });
