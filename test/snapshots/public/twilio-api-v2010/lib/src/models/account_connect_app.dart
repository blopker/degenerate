...
import 'account_connect_app_deauthorize_callback_method.dart';
import 'connect_app_enum_permission.dart';

final class AccountConnectApp {
  const AccountConnectApp({
    this.accountSid,
  ...
  factory AccountConnectApp.fromJson(Map<String, dynamic> json) {
    return AccountConnectApp(
      accountSid: json['account_sid'] as String?,
      authorizeRedirectUrl: json['authorize_redirect_url'] != null
          ? Uri.parse(json['authorize_redirect_url'] as String)
          : null,
      companyName: json['company_name'] as String?,
      deauthorizeCallbackMethod: json['deauthorize_callback_method'] != null
          ? AccountConnectAppDeauthorizeCallbackMethod.fromJson(
              json['deauthorize_callback_method'] as String,
            )
          : null,
      deauthorizeCallbackUrl: json['deauthorize_callback_url'] != null
          ? Uri.parse(json['deauthorize_callback_url'] as String)
          : null,
      description: json['description'] as String?,
      friendlyName: json['friendly_name'] as String?,
      homepageUrl: json['homepage_url'] != null
          ? Uri.parse(json['homepage_url'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (authorizeRedirectUrl != null)
        'authorize_redirect_url': authorizeRedirectUrl?.toString(),
      'company_name': ?companyName,
      if (deauthorizeCallbackMethod != null)
        'deauthorize_callback_method': deauthorizeCallbackMethod?.toJson(),
      if (deauthorizeCallbackUrl != null)
        'deauthorize_callback_url': deauthorizeCallbackUrl?.toString(),
