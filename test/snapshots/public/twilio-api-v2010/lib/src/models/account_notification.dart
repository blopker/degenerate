...
import 'account_notification_request_method.dart';
...
final class AccountNotification {
  ...
  factory AccountNotification.fromJson(Map<String, dynamic> json) {
    return AccountNotification(
      ...
      requestMethod: json['request_method'] != null
          ? AccountNotificationRequestMethod.fromJson(
  ...
  AccountNotification copyWith({
    ...
    AccountNotificationRequestMethod? Function()? requestMethod,
  ...
  @override
  String toString() {
    return 'AccountNotification(accountSid: $accountSid, apiVersion: $apiVersion, callSid: $callSid, dateCreated: $dateCreated, dateUpdated: $dateUpdated, errorCode: $errorCode, log: $log, messageDate: $messageDate, messageText: $messageText, moreInfo: $moreInfo, requestMethod: $requestMethod, requestUrl: $requestUrl, sid: $sid, uri: $uri)';
  }
}
