...
final class ListAddressResponse {
  const ListAddressResponse({
    this.addresses,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  ListAddressResponse copyWith({
    List<AccountAddress> Function()? addresses,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListAddressResponse(addresses: $addresses, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
