...
import 'participant_enum_status.dart';

final class AccountConferenceParticipant {
  const AccountConferenceParticipant({
    this.accountSid,
    this.callSid,
    this.label,
    this.callSidToCoach,
  ...
  factory AccountConferenceParticipant.fromJson(Map<String, dynamic> json) {
    return AccountConferenceParticipant(
      ...
      status: json['status'] != null
          ? ParticipantEnumStatus.fromJson(json['status'] as String)
          : null,
  ...
  AccountConferenceParticipant copyWith({
