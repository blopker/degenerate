...
import 'create_validation_request_request_status_callback_method.dart';

final class CreateValidationRequestRequest {
  const CreateValidationRequestRequest({
  ...
  factory CreateValidationRequestRequest.fromJson(Map<String, dynamic> json) {
    return CreateValidationRequestRequest(
      phoneNumber: json['PhoneNumber'] as String,
      friendlyName: json['FriendlyName'] as String?,
      callDelay: json['CallDelay'] != null
          ? (json['CallDelay'] as num).toInt()
          : null,
      ...
      statusCallbackMethod: json['StatusCallbackMethod'] != null
          ? CreateValidationRequestRequestStatusCallbackMethod.fromJson(
  ...
  final CreateValidationRequestRequestStatusCallbackMethod?
  ...
  CreateValidationRequestRequest copyWith({
    String? phoneNumber,
    String Function()? friendlyName,
    int Function()? callDelay,
    String Function()? $extension,
    Uri Function()? statusCallback,
    CreateValidationRequestRequestStatusCallbackMethod Function()?
    statusCallbackMethod,
  }) {
    return CreateValidationRequestRequest(
  ...
  @override
  String toString() {
    return 'CreateValidationRequestRequest(phoneNumber: $phoneNumber, friendlyName: $friendlyName, callDelay: $callDelay, \$extension: ${$extension}, statusCallback: $statusCallback, statusCallbackMethod: $statusCallbackMethod)';
  }
}
