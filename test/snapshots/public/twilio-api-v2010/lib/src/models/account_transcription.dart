...
import 'transcription_enum_status.dart';

final class AccountTranscription {
  const AccountTranscription({
    this.accountSid,
    this.apiVersion,
    this.dateCreated,
    this.dateUpdated,
  ...
  factory AccountTranscription.fromJson(Map<String, dynamic> json) {
    return AccountTranscription(
      ...
      status: json['status'] != null
          ? TranscriptionEnumStatus.fromJson(json['status'] as String)
          : null,
  ...
  AccountTranscription copyWith({
    ...
    String? Function()? sid,
    TranscriptionEnumStatus Function()? status,
  ...
  @override
  String toString() {
    return 'AccountTranscription(accountSid: $accountSid, apiVersion: $apiVersion, dateCreated: $dateCreated, dateUpdated: $dateUpdated, duration: $duration, price: $price, priceUnit: $priceUnit, recordingSid: $recordingSid, sid: $sid, status: $status, transcriptionText: $transcriptionText, type: $type, uri: $uri)';
  }
}
