...
import 'account_short_code_sms_fallback_method.dart';import 'account_short_code_sms_method.dart';final class AccountShortCode {const AccountShortCode({this.accountSid, this.apiVersion, this.dateCreated, this.dateUpdated, this.friendlyName, this.shortCode, this.sid, this.smsFallbackMethod, this.smsFallbackUrl, this.smsMethod, this.smsUrl, this.uri, });
