...
import 'account_address_dependent_phone_number_sms_fallback_method.dart';import 'account_address_dependent_phone_number_sms_method.dart';import 'account_address_dependent_phone_number_status_callback_method.dart';import 'account_address_dependent_phone_number_voice_fallback_method.dart';import 'account_address_dependent_phone_number_voice_method.dart';import 'dependent_phone_number_enum_address_requirement.dart';import 'dependent_phone_number_enum_emergency_status.dart';final class AccountAddressDependentPhoneNumber {const AccountAddressDependentPhoneNumber({this.sid, this.accountSid, this.friendlyName, this.phoneNumber, this.voiceUrl, this.voiceMethod, this.voiceFallbackMethod, this.voiceFallbackUrl, this.voiceCallerIdLookup, this.dateCreated, this.dateUpdated, this.smsFallbackMethod, this.smsFallbackUrl, this.smsMethod, this.smsUrl, this.addressRequirements, this.capabilities, this.statusCallback, this.statusCallbackMethod, this.apiVersion, this.smsApplicationSid, this.voiceApplicationSid, this.trunkSid, this.emergencyStatus, this.emergencyAddressSid, this.uri, });
