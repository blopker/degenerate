...
final class AccountUsageUsageRecordUsageRecordThisMonth {
  const AccountUsageUsageRecordUsageRecordThisMonth({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordThisMonth.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordThisMonth(
  ...
  @override
  String toString() {
    return 'AccountUsageUsageRecordUsageRecordThisMonth(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)';
  }
}
