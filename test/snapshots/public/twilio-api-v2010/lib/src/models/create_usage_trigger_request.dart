...
import 'create_usage_trigger_request_callback_method.dart';
import 'usage_trigger_enum_recurring.dart';
import 'usage_trigger_enum_trigger_field.dart';

final class CreateUsageTriggerRequest {
  const CreateUsageTriggerRequest({
  ...
  factory CreateUsageTriggerRequest.fromJson(Map<String, dynamic> json) {
    return CreateUsageTriggerRequest(
      ...
      callbackMethod: json['CallbackMethod'] != null
          ? CreateUsageTriggerRequestCallbackMethod.fromJson(
      ...
      recurring: json['Recurring'] != null
          ...
          : null,
      triggerBy: json['TriggerBy'] != null
          ? UsageTriggerEnumTriggerField.fromJson(json['TriggerBy'] as String)
          : null,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('CallbackUrl') &&
        json['CallbackUrl'] is String &&
        json.containsKey('TriggerValue') &&
        json['TriggerValue'] is String &&
        json.containsKey('UsageCategory') &&
        json['UsageCategory'] is String;
  }

  CreateUsageTriggerRequest copyWith({
    Uri? callbackUrl,
    String? triggerValue,
    String? usageCategory,
    CreateUsageTriggerRequestCallbackMethod Function()? callbackMethod,
  ...
  @override
  String toString() {
    return 'CreateUsageTriggerRequest(callbackUrl: $callbackUrl, triggerValue: $triggerValue, usageCategory: $usageCategory, callbackMethod: $callbackMethod, friendlyName: $friendlyName, recurring: $recurring, triggerBy: $triggerBy)';
  }
}
