...
import 'account_call_call_notification_request_method.dart';

final class AccountCallCallNotification {
  const AccountCallCallNotification({
    this.accountSid,
    this.apiVersion,
    this.callSid,
    this.dateCreated,
  ...
  factory AccountCallCallNotification.fromJson(Map<String, dynamic> json) {
    return AccountCallCallNotification(
      ...
      requestMethod: json['request_method'] != null
          ? AccountCallCallNotificationRequestMethod.fromJson(
  ...
  AccountCallCallNotification copyWith({
    ...
    AccountCallCallNotificationRequestMethod? Function()? requestMethod,
  ...
  @override
  String toString() {
    return 'AccountCallCallNotification(accountSid: $accountSid, apiVersion: $apiVersion, callSid: $callSid, dateCreated: $dateCreated, dateUpdated: $dateUpdated, errorCode: $errorCode, log: $log, messageDate: $messageDate, messageText: $messageText, moreInfo: $moreInfo, requestMethod: $requestMethod, requestUrl: $requestUrl, sid: $sid, uri: $uri)';
  }
}
