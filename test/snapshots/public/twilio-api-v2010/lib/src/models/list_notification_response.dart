...
final class ListNotificationResponse {
  ...
  factory ListNotificationResponse.fromJson(Map<String, dynamic> json) {
    return ListNotificationResponse(
      notifications: (json['notifications'] as List<dynamic>?)
          ?.map((e) => AccountNotification.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ListNotificationResponse copyWith({
    List<AccountNotification> Function()? notifications,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListNotificationResponse(notifications: $notifications, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
