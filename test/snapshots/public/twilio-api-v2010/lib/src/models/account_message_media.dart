...
final class AccountMessageMedia {
  const AccountMessageMedia({
    this.accountSid,
    this.contentType,
    this.dateCreated,
    this.dateUpdated,
  ...
  factory AccountMessageMedia.fromJson(Map<String, dynamic> json) {
    return AccountMessageMedia(
  ...
  @override
  String toString() {
    return 'AccountMessageMedia(accountSid: $accountSid, contentType: $contentType, dateCreated: $dateCreated, dateUpdated: $dateUpdated, parentSid: $parentSid, sid: $sid, uri: $uri)';
  }
}
