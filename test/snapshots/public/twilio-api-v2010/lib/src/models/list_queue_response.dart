...
import 'account_queue.dart';

final class ListQueueResponse {
  const ListQueueResponse({
    this.queues,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListQueueResponse.fromJson(Map<String, dynamic> json) {
    return ListQueueResponse(
      queues: (json['queues'] as List<dynamic>?)
          ?.map((e) => AccountQueue.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ListQueueResponse copyWith({
    List<AccountQueue> Function()? queues,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListQueueResponse(queues: $queues, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
