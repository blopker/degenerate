...
import 'message_feedback_enum_outcome.dart';

final class AccountMessageMessageFeedback {
  const AccountMessageMessageFeedback({
    this.accountSid,
    this.messageSid,
    this.outcome,
    this.dateCreated,
  ...
  factory AccountMessageMessageFeedback.fromJson(Map<String, dynamic> json) {
    return AccountMessageMessageFeedback(
      accountSid: json['account_sid'] as String?,
      messageSid: json['message_sid'] as String?,
      outcome: json['outcome'] != null
          ? MessageFeedbackEnumOutcome.fromJson(json['outcome'] as String)
          : null,
  ...
  AccountMessageMessageFeedback copyWith({
    String? Function()? accountSid,
    String? Function()? messageSid,
    MessageFeedbackEnumOutcome Function()? outcome,
  ...
  @override
  String toString() {
    return 'AccountMessageMessageFeedback(accountSid: $accountSid, messageSid: $messageSid, outcome: $outcome, dateCreated: $dateCreated, dateUpdated: $dateUpdated, uri: $uri)';
  }
}
