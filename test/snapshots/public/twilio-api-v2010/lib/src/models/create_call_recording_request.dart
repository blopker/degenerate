...
import 'package:collection/collection.dart';import 'create_call_recording_request_recording_status_callback_method.dart';final class CreateCallRecordingRequest {const CreateCallRecordingRequest({this.recordingStatusCallbackEvent, this.recordingStatusCallback, this.recordingStatusCallbackMethod, this.trim, this.recordingChannels, this.recordingTrack, });
