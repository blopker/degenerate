...
final class AccountUsageUsageRecordUsageRecordLastMonth {
  const AccountUsageUsageRecordUsageRecordLastMonth({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordLastMonth.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordLastMonth(
