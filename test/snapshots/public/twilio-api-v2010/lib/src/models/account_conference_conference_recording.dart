...
import 'conference_recording_enum_source.dart';
import 'conference_recording_enum_status.dart';

final class AccountConferenceConferenceRecording {
  const AccountConferenceConferenceRecording({
    this.accountSid,
    this.apiVersion,
    this.callSid,
    this.conferenceSid,
  ...
  factory AccountConferenceConferenceRecording.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountConferenceConferenceRecording(
      ...
      status: json['status'] != null
          ? ConferenceRecordingEnumStatus.fromJson(json['status'] as String)
          : null,
      channels: json.containsKey('channels')
          ? (json['channels'] as num).toInt()
          : 0,
      source: json['source'] != null
          ? ConferenceRecordingEnumSource.fromJson(json['source'] as String)
          : null,
  ...
  AccountConferenceConferenceRecording copyWith({
    ...
    ConferenceRecordingEnumStatus Function()? status,
    int Function()? channels,
    ConferenceRecordingEnumSource Function()? source,
