...
final class AccountValidationRequest {
  ...
  factory AccountValidationRequest.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'AccountValidationRequest(accountSid: $accountSid, callSid: $callSid, friendlyName: $friendlyName, phoneNumber: $phoneNumber, validationCode: $validationCode)';
  }
}
