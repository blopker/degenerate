...
import 'account_usage_usage_trigger_callback_method.dart';
import 'usage_trigger_enum_recurring.dart';
import 'usage_trigger_enum_trigger_field.dart';

final class AccountUsageUsageTrigger {
  const AccountUsageUsageTrigger({
    this.accountSid,
    this.apiVersion,
    this.callbackMethod,
    this.callbackUrl,
  ...
  factory AccountUsageUsageTrigger.fromJson(Map<String, dynamic> json) {
    return AccountUsageUsageTrigger(
      accountSid: json['account_sid'] as String?,
      apiVersion: json['api_version'] as String?,
      callbackMethod: json['callback_method'] != null
          ? AccountUsageUsageTriggerCallbackMethod.fromJson(
              json['callback_method'] as String,
            )
          : null,
      callbackUrl: json['callback_url'] != null
          ? Uri.parse(json['callback_url'] as String)
          : null,
      ...
      recurring: json['recurring'] != null
          ? UsageTriggerEnumRecurring.fromJson(json['recurring'] as String)
          : null,
      sid: json['sid'] as String?,
      triggerBy: json['trigger_by'] != null
          ? UsageTriggerEnumTriggerField.fromJson(json['trigger_by'] as String)
          : null,
  ...
  AccountUsageUsageTrigger copyWith({
    String? Function()? accountSid,
    String? Function()? apiVersion,
    AccountUsageUsageTriggerCallbackMethod? Function()? callbackMethod,
    Uri? Function()? callbackUrl,
    String? Function()? currentValue,
    String? Function()? dateCreated,
    String? Function()? dateFired,
    String? Function()? dateUpdated,
    String? Function()? friendlyName,
    UsageTriggerEnumRecurring Function()? recurring,
    String? Function()? sid,
    UsageTriggerEnumTriggerField Function()? triggerBy,
    String? Function()? triggerValue,
    String? Function()? uri,
    String? Function()? usageCategory,
    String? Function()? usageRecordUri,
  }) {
    return AccountUsageUsageTrigger(
      ...
      usageCategory: usageCategory != null
          ? usageCategory()
          : this.usageCategory,
      usageRecordUri: usageRecordUri != null
          ? usageRecordUri()
          : this.usageRecordUri,
    );
  }
  ...
  @override
  String toString() {
    return 'AccountUsageUsageTrigger(accountSid: $accountSid, apiVersion: $apiVersion, callbackMethod: $callbackMethod, callbackUrl: $callbackUrl, currentValue: $currentValue, dateCreated: $dateCreated, dateFired: $dateFired, dateUpdated: $dateUpdated, friendlyName: $friendlyName, recurring: $recurring, sid: $sid, triggerBy: $triggerBy, triggerValue: $triggerValue, uri: $uri, usageCategory: $usageCategory, usageRecordUri: $usageRecordUri)';
  }
}
