...
final class AccountNewKey {
  ...
  factory AccountNewKey.fromJson(Map<String, dynamic> json) {
    return AccountNewKey(
  ...
  @override
  String toString() {
    return 'AccountNewKey(sid: $sid, friendlyName: $friendlyName, dateCreated: $dateCreated, dateUpdated: $dateUpdated, secret: $secret)';
  }
}
