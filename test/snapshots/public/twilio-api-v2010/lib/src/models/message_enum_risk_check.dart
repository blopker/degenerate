...
final class MessageEnumRiskCheck {
  const MessageEnumRiskCheck._(this.value);

  factory MessageEnumRiskCheck.fromJson(String json) {
    return switch (json) {
      'enable' => enable,
      'disable' => disable,
  ...
  @override
  String toString() {
    return 'MessageEnumRiskCheck($value)';
  }
}
