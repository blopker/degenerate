...
import 'account_incoming_phone_number_incoming_phone_number_mobile_capabilities.dart';
import 'account_incoming_phone_number_incoming_phone_number_mobile_sms_fallback_method.dart';
import 'account_incoming_phone_number_incoming_phone_number_mobile_sms_method.dart';
import 'account_incoming_phone_number_incoming_phone_number_mobile_status_callback_method.dart';
import 'account_incoming_phone_number_incoming_phone_number_mobile_voice_fallback_method.dart';
import 'account_incoming_phone_number_incoming_phone_number_mobile_voice_method.dart';
import 'incoming_phone_number_mobile_enum_address_requirement.dart';
import 'incoming_phone_number_mobile_enum_emergency_address_status.dart';
import 'incoming_phone_number_mobile_enum_emergency_status.dart';
import 'incoming_phone_number_mobile_enum_voice_receive_mode.dart';

final class AccountIncomingPhoneNumberIncomingPhoneNumberMobile {
  const AccountIncomingPhoneNumberIncomingPhoneNumberMobile({
    this.accountSid,
    this.addressSid,
  ...
  factory AccountIncomingPhoneNumberIncomingPhoneNumberMobile.fromJson(
    ...
    return AccountIncomingPhoneNumberIncomingPhoneNumberMobile(
      ...
      addressRequirements: json['address_requirements'] != null
          ? IncomingPhoneNumberMobileEnumAddressRequirement.fromJson(
      ...
      capabilities: json['capabilities'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileCapabilities.fromJson(
      ...
      smsFallbackMethod: json['sms_fallback_method'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileSmsFallbackMethod.fromJson(
      ...
      smsMethod: json['sms_method'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileSmsMethod.fromJson(
      ...
      statusCallbackMethod: json['status_callback_method'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileStatusCallbackMethod.fromJson(
      ...
      voiceReceiveMode: json['voice_receive_mode'] != null
          ? IncomingPhoneNumberMobileEnumVoiceReceiveMode.fromJson(
      ...
      voiceFallbackMethod: json['voice_fallback_method'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileVoiceFallbackMethod.fromJson(
      ...
      voiceMethod: json['voice_method'] != null
          ? AccountIncomingPhoneNumberIncomingPhoneNumberMobileVoiceMethod.fromJson(
      ...
      emergencyStatus: json['emergency_status'] != null
          ? IncomingPhoneNumberMobileEnumEmergencyStatus.fromJson(
      ...
      emergencyAddressStatus: json['emergency_address_status'] != null
          ? IncomingPhoneNumberMobileEnumEmergencyAddressStatus.fromJson(
  ...
  final AccountIncomingPhoneNumberIncomingPhoneNumberMobileCapabilities?
  capabilities;
  ...
  final AccountIncomingPhoneNumberIncomingPhoneNumberMobileSmsFallbackMethod?
  smsFallbackMethod;
  ...
  final AccountIncomingPhoneNumberIncomingPhoneNumberMobileStatusCallbackMethod?
  ...
  final AccountIncomingPhoneNumberIncomingPhoneNumberMobileVoiceFallbackMethod?
  voiceFallbackMethod;
  ...
  final AccountIncomingPhoneNumberIncomingPhoneNumberMobileVoiceMethod?
  voiceMethod;
  ...
  final IncomingPhoneNumberMobileEnumEmergencyAddressStatus?
  ...
  AccountIncomingPhoneNumberIncomingPhoneNumberMobile copyWith({
    String? Function()? accountSid,
    String? Function()? addressSid,
    IncomingPhoneNumberMobileEnumAddressRequirement Function()?
    addressRequirements,
    String? Function()? apiVersion,
    bool? Function()? beta,
    AccountIncomingPhoneNumberIncomingPhoneNumberMobileCapabilities? Function()?
    capabilities,
    ...
    AccountIncomingPhoneNumberIncomingPhoneNumberMobileSmsMethod? Function()?
    smsMethod,
    Uri? Function()? smsUrl,
    ...
    String? Function()? uri,
    IncomingPhoneNumberMobileEnumVoiceReceiveMode Function()? voiceReceiveMode,
    ...
    AccountIncomingPhoneNumberIncomingPhoneNumberMobileVoiceMethod? Function()?
    voiceMethod,
    Uri? Function()? voiceUrl,
    IncomingPhoneNumberMobileEnumEmergencyStatus Function()? emergencyStatus,
    String? Function()? emergencyAddressSid,
    IncomingPhoneNumberMobileEnumEmergencyAddressStatus Function()?
    emergencyAddressStatus,
