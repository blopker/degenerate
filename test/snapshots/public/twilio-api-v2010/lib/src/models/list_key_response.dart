...
final class ListKeyResponse {
  const ListKeyResponse({
    this.keys,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListKeyResponse.fromJson(Map<String, dynamic> json) {
  ...
  ListKeyResponse copyWith({
    List<AccountKey> Function()? keys,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListKeyResponse(keys: $keys, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
