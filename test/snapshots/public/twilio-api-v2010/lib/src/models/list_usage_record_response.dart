...
import 'account_usage_usage_record.dart';

final class ListUsageRecordResponse {
  const ListUsageRecordResponse({
    this.usageRecords,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListUsageRecordResponse.fromJson(Map<String, dynamic> json) {
    return ListUsageRecordResponse(
      usageRecords: (json['usage_records'] as List<dynamic>?)
          ?.map(
            (e) => AccountUsageUsageRecord.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  ListUsageRecordResponse copyWith({
    List<AccountUsageUsageRecord> Function()? usageRecords,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListUsageRecordResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
