...
import 'message_enum_address_retention.dart';
import 'message_enum_content_retention.dart';
import 'message_enum_risk_check.dart';
import 'message_enum_schedule_type.dart';
import 'message_enum_traffic_type.dart';
...
final class CreateMessageRequest {
  const CreateMessageRequest({
    ...
    this.validityPeriod,
    this.forceDelivery,
    this.contentRetention,
    this.addressRetention,
    this.smartEncoded,
  ...
  factory CreateMessageRequest.fromJson(Map<String, dynamic> json) {
    return CreateMessageRequest(
      ...
      validityPeriod: json['ValidityPeriod'] != null
          ? (json['ValidityPeriod'] as num).toInt()
          : null,
      forceDelivery: json['ForceDelivery'] as bool?,
      contentRetention: json['ContentRetention'] != null
          ? MessageEnumContentRetention.fromJson(
              json['ContentRetention'] as String,
            )
          : null,
      addressRetention: json['AddressRetention'] != null
          ? MessageEnumAddressRetention.fromJson(
              json['AddressRetention'] as String,
            )
          : null,
      smartEncoded: json['SmartEncoded'] as bool?,
      persistentAction: (json['PersistentAction'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      trafficType: json['TrafficType'] != null
          ? MessageEnumTrafficType.fromJson(json['TrafficType'] as String)
          : null,
      shortenUrls: json['ShortenUrls'] as bool?,
      scheduleType: json['ScheduleType'] != null
          ? MessageEnumScheduleType.fromJson(json['ScheduleType'] as String)
          : null,
      ...
      riskCheck: json['RiskCheck'] != null
          ? MessageEnumRiskCheck.fromJson(json['RiskCheck'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (contentRetention != null)
        'ContentRetention': contentRetention?.toJson(),
      if (addressRetention != null)
        'AddressRetention': addressRetention?.toJson(),
      ...
      'Body': ?body,
      if (mediaUrl != null)
        'MediaUrl': mediaUrl?.map((e) => e.toString()).toList(),
      'ContentSid': ?contentSid,
    };
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('To') && json['To'] is String;
  }
  ...
  CreateMessageRequest copyWith({
    ...
    bool Function()? provideFeedback,
    int Function()? attempt,
    int Function()? validityPeriod,
    bool Function()? forceDelivery,
    MessageEnumContentRetention Function()? contentRetention,
    MessageEnumAddressRetention Function()? addressRetention,
    bool Function()? smartEncoded,
    List<String> Function()? persistentAction,
    MessageEnumTrafficType Function()? trafficType,
    bool Function()? shortenUrls,
    MessageEnumScheduleType Function()? scheduleType,
    DateTime Function()? sendAt,
    bool Function()? sendAsMms,
    String Function()? contentVariables,
    MessageEnumRiskCheck Function()? riskCheck,
    String Function()? from,
    String Function()? messagingServiceSid,
    String Function()? body,
    List<Uri> Function()? mediaUrl,
    String Function()? contentSid,
  }) {
    return CreateMessageRequest(
      to: to ?? this.to,
      ...
      provideFeedback: provideFeedback != null
          ? provideFeedback()
          : this.provideFeedback,
      ...
      validityPeriod: validityPeriod != null
          ? validityPeriod()
          : this.validityPeriod,
      forceDelivery: forceDelivery != null
          ? forceDelivery()
          : this.forceDelivery,
      contentRetention: contentRetention != null
          ? contentRetention()
          : this.contentRetention,
      addressRetention: addressRetention != null
          ? addressRetention()
          : this.addressRetention,
      smartEncoded: smartEncoded != null ? smartEncoded() : this.smartEncoded,
      persistentAction: persistentAction != null
          ? persistentAction()
          : this.persistentAction,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CreateMessageRequest &&
            ...
            body == other.body &&
            const ListEquality<dynamic>().equals(mediaUrl, other.mediaUrl) &&
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      addressRetention,
      smartEncoded,
      Object.hashAll(persistentAction ?? const []),
      trafficType,
      shortenUrls,
      scheduleType,
      sendAt,
