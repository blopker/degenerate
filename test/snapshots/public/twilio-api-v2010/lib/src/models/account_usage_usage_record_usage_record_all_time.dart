...
final class AccountUsageUsageRecordUsageRecordAllTime {
  const AccountUsageUsageRecordUsageRecordAllTime({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordAllTime.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordAllTime(
  ...
  AccountUsageUsageRecordUsageRecordAllTime copyWith({
