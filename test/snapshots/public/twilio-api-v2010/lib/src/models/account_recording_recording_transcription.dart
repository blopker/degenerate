...
import 'recording_transcription_enum_status.dart';

final class AccountRecordingRecordingTranscription {
  const AccountRecordingRecordingTranscription({
    this.accountSid,
    this.apiVersion,
    this.dateCreated,
    this.dateUpdated,
  ...
  factory AccountRecordingRecordingTranscription.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountRecordingRecordingTranscription(
      ...
      status: json['status'] != null
          ? RecordingTranscriptionEnumStatus.fromJson(json['status'] as String)
          : null,
  ...
  AccountRecordingRecordingTranscription copyWith({
    ...
    String? Function()? recordingSid,
    String? Function()? sid,
    RecordingTranscriptionEnumStatus Function()? status,
    String? Function()? transcriptionText,
  ...
  @override
  String toString() {
    return 'AccountRecordingRecordingTranscription(accountSid: $accountSid, apiVersion: $apiVersion, dateCreated: $dateCreated, dateUpdated: $dateUpdated, duration: $duration, price: $price, priceUnit: $priceUnit, recordingSid: $recordingSid, sid: $sid, status: $status, transcriptionText: $transcriptionText, type: $type, uri: $uri)';
  }
}
