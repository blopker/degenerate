...
import 'call_recording_enum_source.dart';
import 'call_recording_enum_status.dart';

final class AccountCallCallRecording {
  const AccountCallCallRecording({
    this.accountSid,
    this.apiVersion,
    this.callSid,
    this.conferenceSid,
  ...
  factory AccountCallCallRecording.fromJson(Map<String, dynamic> json) {
    return AccountCallCallRecording(
      ...
      status: json['status'] != null
          ? CallRecordingEnumStatus.fromJson(json['status'] as String)
          : null,
      channels: json.containsKey('channels')
          ? (json['channels'] as num).toInt()
          : 0,
      source: json['source'] != null
          ? CallRecordingEnumSource.fromJson(json['source'] as String)
          : null,
  ...
  AccountCallCallRecording copyWith({
    ...
    CallRecordingEnumStatus Function()? status,
    int Function()? channels,
    CallRecordingEnumSource Function()? source,
