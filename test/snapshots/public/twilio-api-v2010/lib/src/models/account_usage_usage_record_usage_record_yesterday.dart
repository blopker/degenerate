...
final class AccountUsageUsageRecordUsageRecordYesterday {
  const AccountUsageUsageRecordUsageRecordYesterday({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordYesterday.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordYesterday(
  ...
  AccountUsageUsageRecordUsageRecordYesterday copyWith({
