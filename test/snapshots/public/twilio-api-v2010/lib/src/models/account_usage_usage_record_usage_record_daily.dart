...
final class AccountUsageUsageRecordUsageRecordDaily {
  const AccountUsageUsageRecordUsageRecordDaily({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordDaily.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordDaily(
  ...
  AccountUsageUsageRecordUsageRecordDaily copyWith({
  ...
  @override
  String toString() {
    return 'AccountUsageUsageRecordUsageRecordDaily(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)';
  }
}
