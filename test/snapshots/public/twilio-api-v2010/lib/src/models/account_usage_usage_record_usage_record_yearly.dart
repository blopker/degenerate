...
final class AccountUsageUsageRecordUsageRecordYearly {
  const AccountUsageUsageRecordUsageRecordYearly({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordYearly.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordYearly(
  ...
  AccountUsageUsageRecordUsageRecordYearly copyWith({
  ...
  @override
  String toString() {
    return 'AccountUsageUsageRecordUsageRecordYearly(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)';
  }
}
