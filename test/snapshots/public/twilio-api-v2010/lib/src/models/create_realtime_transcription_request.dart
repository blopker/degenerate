...
import 'create_realtime_transcription_request_status_callback_method.dart';
import 'realtime_transcription_enum_track.dart';
...
final class CreateRealtimeTranscriptionRequest {
  const CreateRealtimeTranscriptionRequest({
    ...
    this.inboundTrackLabel,
    this.outboundTrackLabel,
    this.partialResults,
    this.languageCode,
    ...
    this.enableProviderData,
  });

  factory CreateRealtimeTranscriptionRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return CreateRealtimeTranscriptionRequest(
      name: json['Name'] as String?,
      track: json['Track'] != null
          ? RealtimeTranscriptionEnumTrack.fromJson(json['Track'] as String)
          : null,
      statusCallbackUrl: json['StatusCallbackUrl'] != null
          ? Uri.parse(json['StatusCallbackUrl'] as String)
          : null,
      statusCallbackMethod: json['StatusCallbackMethod'] != null
          ? CreateRealtimeTranscriptionRequestStatusCallbackMethod.fromJson(
  ...
  final CreateRealtimeTranscriptionRequestStatusCallbackMethod?
  ...
  CreateRealtimeTranscriptionRequest copyWith({
    String Function()? name,
    RealtimeTranscriptionEnumTrack Function()? track,
    Uri Function()? statusCallbackUrl,
    CreateRealtimeTranscriptionRequestStatusCallbackMethod Function()?
    statusCallbackMethod,
    String Function()? inboundTrackLabel,
    String Function()? outboundTrackLabel,
    bool Function()? partialResults,
    String Function()? languageCode,
    String Function()? transcriptionEngine,
    bool Function()? profanityFilter,
    String Function()? speechModel,
    String Function()? hints,
    bool Function()? enableAutomaticPunctuation,
    String Function()? intelligenceService,
    bool Function()? enableProviderData,
  }) {
    return CreateRealtimeTranscriptionRequest(
      ...
      statusCallbackMethod: statusCallbackMethod != null
          ? statusCallbackMethod()
          : this.statusCallbackMethod,
      inboundTrackLabel: inboundTrackLabel != null
          ? inboundTrackLabel()
          : this.inboundTrackLabel,
      outboundTrackLabel: outboundTrackLabel != null
          ? outboundTrackLabel()
          : this.outboundTrackLabel,
      ...
      enableAutomaticPunctuation: enableAutomaticPunctuation != null
          ? enableAutomaticPunctuation()
          : this.enableAutomaticPunctuation,
      intelligenceService: intelligenceService != null
          ? intelligenceService()
          : this.intelligenceService,
      enableProviderData: enableProviderData != null
          ? enableProviderData()
          : this.enableProviderData,
    );
  }
