...
final class AccountAvailablePhoneNumberCountry {
  const AccountAvailablePhoneNumberCountry({
    this.countryCode,
    this.country,
    this.uri,
    this.beta,
  ...
  factory AccountAvailablePhoneNumberCountry.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountAvailablePhoneNumberCountry(
  ...
  AccountAvailablePhoneNumberCountry copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(countryCode, country, uri, beta, subresourceUris);
  }

  @override
  String toString() {
    return 'AccountAvailablePhoneNumberCountry(countryCode: $countryCode, country: $country, uri: $uri, beta: $beta, subresourceUris: $subresourceUris)';
  }
}
