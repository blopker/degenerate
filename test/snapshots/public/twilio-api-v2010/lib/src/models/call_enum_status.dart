...
final class CallEnumStatus {
  const CallEnumStatus._(this.value);

  factory CallEnumStatus.fromJson(String json) {
    return switch (json) {
      'queued' => queued,
      'ringing' => ringing,
  ...
  static const List<CallEnumStatus> values = [
    queued,
    ringing,
    inProgress,
    completed,
