...
import 'call_enum_status.dart';

final class AccountCall {
  const AccountCall({
    this.sid,
    this.dateCreated,
    this.dateUpdated,
  ...
  factory AccountCall.fromJson(Map<String, dynamic> json) {
    return AccountCall(
      ...
      status: json['status'] != null
          ? CallEnumStatus.fromJson(json['status'] as String)
          : null,
  ...
  AccountCall copyWith({
    ...
    String? Function()? to,
    String? Function()? toFormatted,
    String? Function()? from,
    String? Function()? fromFormatted,
    String? Function()? phoneNumberSid,
    CallEnumStatus Function()? status,
    ...
    String? Function()? answeredBy,
    String? Function()? apiVersion,
    String? Function()? forwardedFrom,
    String? Function()? groupSid,
    String? Function()? callerName,
    String? Function()? queueTime,
    ...
    return AccountCall(
      ...
      fromFormatted: fromFormatted != null
          ? fromFormatted()
          : this.fromFormatted,
