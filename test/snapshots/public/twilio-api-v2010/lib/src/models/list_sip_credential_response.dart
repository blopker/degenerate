...
import 'account_sip_sip_credential_list_sip_credential.dart';

final class ListSipCredentialResponse {
  const ListSipCredentialResponse({
    this.credentials,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListSipCredentialResponse.fromJson(Map<String, dynamic> json) {
    return ListSipCredentialResponse(
      credentials: (json['credentials'] as List<dynamic>?)
          ?.map(
            (e) => AccountSipSipCredentialListSipCredential.fromJson(
  ...
  ListSipCredentialResponse copyWith({
    List<AccountSipSipCredentialListSipCredential> Function()? credentials,
    int Function()? end,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(credentials ?? const []),
      end,
      firstPageUri,
      nextPageUri,
      page,
  ...
  @override
  String toString() {
    return 'ListSipCredentialResponse(credentials: $credentials, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
