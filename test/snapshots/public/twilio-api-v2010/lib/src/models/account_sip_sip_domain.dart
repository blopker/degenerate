...
import 'account_sip_sip_domain_voice_fallback_method.dart';
import 'account_sip_sip_domain_voice_method.dart';
import 'account_sip_sip_domain_voice_status_callback_method.dart';

final class AccountSipSipDomain {
  const AccountSipSipDomain({
    this.accountSid,
    this.apiVersion,
    this.authType,
    this.dateCreated,
    ...
    this.voiceMethod,
    this.voiceStatusCallbackMethod,
    this.voiceStatusCallbackUrl,
    this.voiceUrl,
    this.subresourceUris,
    this.sipRegistration,
    this.emergencyCallingEnabled,
    this.secure,
    this.byocTrunkSid,
    this.emergencyCallerSid,
  });

  factory AccountSipSipDomain.fromJson(Map<String, dynamic> json) {
    return AccountSipSipDomain(
      ...
      voiceFallbackMethod: json['voice_fallback_method'] != null
          ? AccountSipSipDomainVoiceFallbackMethod.fromJson(
      ...
      voiceMethod: json['voice_method'] != null
          ? AccountSipSipDomainVoiceMethod.fromJson(
              json['voice_method'] as String,
            )
          : null,
      voiceStatusCallbackMethod: json['voice_status_callback_method'] != null
          ? AccountSipSipDomainVoiceStatusCallbackMethod.fromJson(
              json['voice_status_callback_method'] as String,
            )
          : null,
      voiceStatusCallbackUrl: json['voice_status_callback_url'] != null
          ? Uri.parse(json['voice_status_callback_url'] as String)
          : null,
      voiceUrl: json['voice_url'] != null
          ? Uri.parse(json['voice_url'] as String)
          : null,
      subresourceUris: (json['subresource_uris'] as Map<String, dynamic>?)?.map(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (voiceStatusCallbackMethod != null)
        'voice_status_callback_method': voiceStatusCallbackMethod?.toJson(),
      if (voiceStatusCallbackUrl != null)
        'voice_status_callback_url': voiceStatusCallbackUrl?.toString(),
  ...
  AccountSipSipDomain copyWith({
    ...
    String? Function()? domainName,
    String? Function()? friendlyName,
    String? Function()? sid,
    String? Function()? uri,
    AccountSipSipDomainVoiceFallbackMethod? Function()? voiceFallbackMethod,
    Uri? Function()? voiceFallbackUrl,
    AccountSipSipDomainVoiceMethod? Function()? voiceMethod,
    AccountSipSipDomainVoiceStatusCallbackMethod? Function()?
    voiceStatusCallbackMethod,
    Uri? Function()? voiceStatusCallbackUrl,
    Uri? Function()? voiceUrl,
    Map<String, String>? Function()? subresourceUris,
    bool? Function()? sipRegistration,
    bool? Function()? emergencyCallingEnabled,
    bool? Function()? secure,
    String? Function()? byocTrunkSid,
    String? Function()? emergencyCallerSid,
  }) {
    return AccountSipSipDomain(
      ...
      voiceStatusCallbackMethod: voiceStatusCallbackMethod != null
          ? voiceStatusCallbackMethod()
          : this.voiceStatusCallbackMethod,
      voiceStatusCallbackUrl: voiceStatusCallbackUrl != null
          ? voiceStatusCallbackUrl()
          : this.voiceStatusCallbackUrl,
      voiceUrl: voiceUrl != null ? voiceUrl() : this.voiceUrl,
      subresourceUris: subresourceUris != null
          ? subresourceUris()
          : this.subresourceUris,
      sipRegistration: sipRegistration != null
          ? sipRegistration()
          : this.sipRegistration,
      emergencyCallingEnabled: emergencyCallingEnabled != null
      ...
      emergencyCallerSid: emergencyCallerSid != null
          ? emergencyCallerSid()
          : this.emergencyCallerSid,
    );
  }
  ...
  @override
  String toString() {
    return 'AccountSipSipDomain(accountSid: $accountSid, apiVersion: $apiVersion, authType: $authType, dateCreated: $dateCreated, dateUpdated: $dateUpdated, domainName: $domainName, friendlyName: $friendlyName, sid: $sid, uri: $uri, voiceFallbackMethod: $voiceFallbackMethod, voiceFallbackUrl: $voiceFallbackUrl, voiceMethod: $voiceMethod, voiceStatusCallbackMethod: $voiceStatusCallbackMethod, voiceStatusCallbackUrl: $voiceStatusCallbackUrl, voiceUrl: $voiceUrl, subresourceUris: $subresourceUris, sipRegistration: $sipRegistration, emergencyCallingEnabled: $emergencyCallingEnabled, secure: $secure, byocTrunkSid: $byocTrunkSid, emergencyCallerSid: $emergencyCallerSid)';
  }
}
