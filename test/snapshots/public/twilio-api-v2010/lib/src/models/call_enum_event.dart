...
final class CallEnumEvent {
  const CallEnumEvent._(this.value);

  factory CallEnumEvent.fromJson(String json) {
    return switch (json) {
      'initiated' => initiated,
      'ringing' => ringing,
      'answered' => answered,
  ...
  static const List<CallEnumEvent> values = [
    initiated,
    ringing,
    answered,
    completed,
