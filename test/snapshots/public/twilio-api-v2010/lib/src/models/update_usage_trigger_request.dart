...
import 'update_usage_trigger_request_callback_method.dart';final class UpdateUsageTriggerRequest {const UpdateUsageTriggerRequest({this.callbackMethod, this.callbackUrl, this.friendlyName, });
