...
import 'create_user_defined_message_subscription_request_method.dart';final class CreateUserDefinedMessageSubscriptionRequest {const CreateUserDefinedMessageSubscriptionRequest({required this.callback, this.idempotencyKey, this.method, });
