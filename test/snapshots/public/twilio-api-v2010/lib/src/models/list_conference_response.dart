...
import 'package:collection/collection.dart';import 'account_conference.dart';final class ListConferenceResponse {const ListConferenceResponse({this.conferences, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListConferenceResponse &&
          const ListEquality<dynamic>().equals(conferences, other.conferences) &&
          end == other.end &&
