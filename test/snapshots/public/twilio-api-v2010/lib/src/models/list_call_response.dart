...
import 'account_call.dart';

final class ListCallResponse {
  const ListCallResponse({
    this.calls,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListCallResponse.fromJson(Map<String, dynamic> json) {
    return ListCallResponse(
      calls: (json['calls'] as List<dynamic>?)
          ?.map((e) => AccountCall.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ListCallResponse copyWith({
    List<AccountCall> Function()? calls,
    int Function()? end,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ListCallResponse &&
            const ListEquality<dynamic>().equals(calls, other.calls) &&
            end == other.end &&
  ...
  @override
  String toString() {
    return 'ListCallResponse(calls: $calls, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
