...
final class AccountUsageUsageRecordUsageRecordMonthly {
  const AccountUsageUsageRecordUsageRecordMonthly({
    this.accountSid,
    this.apiVersion,
    this.asOf,
    this.category,
  ...
  factory AccountUsageUsageRecordUsageRecordMonthly.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountUsageUsageRecordUsageRecordMonthly(
  ...
  AccountUsageUsageRecordUsageRecordMonthly copyWith({
