...
final class ListAccountResponse {
  const ListAccountResponse({
    this.accounts,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListAccountResponse.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'ListAccountResponse(accounts: $accounts, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
