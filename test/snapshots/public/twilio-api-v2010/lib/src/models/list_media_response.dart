...
import 'account_message_media.dart';

final class ListMediaResponse {
  ...
  factory ListMediaResponse.fromJson(Map<String, dynamic> json) {
    return ListMediaResponse(
      mediaList: (json['media_list'] as List<dynamic>?)
          ?.map((e) => AccountMessageMedia.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ListMediaResponse copyWith({
    List<AccountMessageMedia> Function()? mediaList,
    int Function()? end,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ListMediaResponse &&
            const ListEquality<dynamic>().equals(mediaList, other.mediaList) &&
            end == other.end &&
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(mediaList ?? const []),
      end,
      firstPageUri,
      nextPageUri,
      page,
  ...
  @override
  String toString() {
    return 'ListMediaResponse(mediaList: $mediaList, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
