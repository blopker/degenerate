...
import 'account_recording.dart';

final class ListRecordingResponse {
  const ListRecordingResponse({
    this.recordings,
    this.end,
    this.firstPageUri,
    this.nextPageUri,
  ...
  factory ListRecordingResponse.fromJson(Map<String, dynamic> json) {
    return ListRecordingResponse(
      recordings: (json['recordings'] as List<dynamic>?)
          ?.map((e) => AccountRecording.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ListRecordingResponse copyWith({
    List<AccountRecording> Function()? recordings,
    int Function()? end,
  ...
  @override
  String toString() {
    return 'ListRecordingResponse(recordings: $recordings, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)';
  }
}
