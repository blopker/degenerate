...
import 'recording_enum_source.dart';
import 'recording_enum_status.dart';

final class AccountRecording {
  ...
  factory AccountRecording.fromJson(Map<String, dynamic> json) {
    return AccountRecording(
      ...
      status: json['status'] != null
          ? RecordingEnumStatus.fromJson(json['status'] as String)
          : null,
      channels: json['channels'] != null
          ? (json['channels'] as num).toInt()
          : null,
      source: json['source'] != null
          ? RecordingEnumSource.fromJson(json['source'] as String)
          : null,
      ...
      mediaUrl: json['media_url'] != null
          ? Uri.parse(json['media_url'] as String)
          : null,
    );
  }
  ...
  AccountRecording copyWith({
    ...
    RecordingEnumStatus Function()? status,
    int? Function()? channels,
    RecordingEnumSource Function()? source,
    int? Function()? errorCode,
    String? Function()? uri,
    String? Function()? encryptionDetails,
    Map<String, String>? Function()? subresourceUris,
    Uri? Function()? mediaUrl,
  }) {
    return AccountRecording(
