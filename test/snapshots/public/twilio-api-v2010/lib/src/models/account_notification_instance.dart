...
import 'account_notification_instance_request_method.dart';

final class AccountNotificationInstance {
  const AccountNotificationInstance({
    this.accountSid,
    this.apiVersion,
    this.callSid,
    this.dateCreated,
  ...
  factory AccountNotificationInstance.fromJson(Map<String, dynamic> json) {
    return AccountNotificationInstance(
      ...
      requestMethod: json['request_method'] != null
          ? AccountNotificationInstanceRequestMethod.fromJson(
  ...
  AccountNotificationInstance copyWith({
    ...
    AccountNotificationInstanceRequestMethod? Function()? requestMethod,
  ...
  @override
  String toString() {
    return 'AccountNotificationInstance(accountSid: $accountSid, apiVersion: $apiVersion, callSid: $callSid, dateCreated: $dateCreated, dateUpdated: $dateUpdated, errorCode: $errorCode, log: $log, messageDate: $messageDate, messageText: $messageText, moreInfo: $moreInfo, requestMethod: $requestMethod, requestUrl: $requestUrl, requestVariables: $requestVariables, responseBody: $responseBody, responseHeaders: $responseHeaders, sid: $sid, uri: $uri)';
  }
}
