...
final class CreateAddressRequest {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('CustomerName') &&
        json['CustomerName'] is String &&
        json.containsKey('Street') &&
        json['Street'] is String &&
        json.containsKey('City') &&
        json['City'] is String &&
        json.containsKey('Region') &&
        json['Region'] is String &&
        json.containsKey('PostalCode') &&
        json['PostalCode'] is String &&
        json.containsKey('IsoCountry') &&
        json['IsoCountry'] is String;
  }

  CreateAddressRequest copyWith({
    String? customerName,
    String? street,
    String? city,
    String? region,
    ...
    bool Function()? emergencyEnabled,
    bool Function()? autoCorrectAddress,
    String Function()? streetSecondary,
  }) {
    return CreateAddressRequest(
      ...
      emergencyEnabled: emergencyEnabled != null
          ? emergencyEnabled()
          : this.emergencyEnabled,
      autoCorrectAddress: autoCorrectAddress != null
          ? autoCorrectAddress()
          : this.autoCorrectAddress,
      streetSecondary: streetSecondary != null
          ? streetSecondary()
          : this.streetSecondary,
    );
  }
  ...
  @override
  String toString() {
    return 'CreateAddressRequest(customerName: $customerName, street: $street, city: $city, region: $region, postalCode: $postalCode, isoCountry: $isoCountry, friendlyName: $friendlyName, emergencyEnabled: $emergencyEnabled, autoCorrectAddress: $autoCorrectAddress, streetSecondary: $streetSecondary)';
  }
}
