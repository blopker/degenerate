...
import 'account_available_phone_number_country_available_phone_number_machine_to_machine_capabilities.dart';

final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine {
  const AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine({
    this.friendlyName,
    this.phoneNumber,
    this.lata,
    this.locality,
  ...
  factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine(
      ...
      capabilities: json['capabilities'] != null
          ? AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineCapabilities.fromJson(
  ...
  final AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineCapabilities?
  capabilities;
  ...
  copyWith({
    ...
    String? Function()? lata,
    String? Function()? locality,
    String? Function()? rateCenter,
    double? Function()? latitude,
    double? Function()? longitude,
    String? Function()? region,
    String? Function()? postalCode,
    String? Function()? isoCountry,
    String? Function()? addressRequirements,
    bool? Function()? beta,
    AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineCapabilities?
    Function()?
    capabilities,
  }) {
    return AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine &&
