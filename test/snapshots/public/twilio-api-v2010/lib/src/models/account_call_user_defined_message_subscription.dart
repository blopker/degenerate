...
final class AccountCallUserDefinedMessageSubscription {
  ...
  factory AccountCallUserDefinedMessageSubscription.fromJson(
    Map<String, dynamic> json,
  ) {
    return AccountCallUserDefinedMessageSubscription(
  ...
  AccountCallUserDefinedMessageSubscription copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(accountSid, callSid, sid, dateCreated, uri);
  }

  @override
  String toString() {
    return 'AccountCallUserDefinedMessageSubscription(accountSid: $accountSid, callSid: $callSid, sid: $sid, dateCreated: $dateCreated, uri: $uri)';
  }
}
