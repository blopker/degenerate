...
final class CreateSipCredentialRequest {
  const CreateSipCredentialRequest({
    required this.username,
    required this.password,
  });

  factory CreateSipCredentialRequest.fromJson(Map<String, dynamic> json) {
  ...
  CreateSipCredentialRequest copyWith({String? username, String? password}) {
    return CreateSipCredentialRequest(
  ...
  @override
  String toString() {
    return 'CreateSipCredentialRequest(username: $username, password: $password)';
  }
}
