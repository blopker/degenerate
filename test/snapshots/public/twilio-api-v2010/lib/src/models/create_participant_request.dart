...
import 'create_participant_request_amd_status_callback_method.dart';
import 'create_participant_request_conference_recording_status_callback_method.dart';
import 'create_participant_request_conference_status_callback_method.dart';
import 'create_participant_request_recording_status_callback_method.dart';
import 'create_participant_request_status_callback_method.dart';
import 'create_participant_request_wait_method.dart';
...
final class CreateParticipantRequest {
  const CreateParticipantRequest({
    ...
    this.conferenceStatusCallbackMethod,
    this.conferenceStatusCallbackEvent,
    ...
    this.amdStatusCallback,
    this.amdStatusCallbackMethod,
    this.trim,
    this.callToken,
    this.clientNotificationUrl,
  ...
  factory CreateParticipantRequest.fromJson(Map<String, dynamic> json) {
    return CreateParticipantRequest(
      ...
      statusCallbackMethod: json['StatusCallbackMethod'] != null
          ? CreateParticipantRequestStatusCallbackMethod.fromJson(
              json['StatusCallbackMethod'] as String,
            )
          : null,
      statusCallbackEvent: (json['StatusCallbackEvent'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      ...
      waitUrl: json['WaitUrl'] != null
          ? Uri.parse(json['WaitUrl'] as String)
          : null,
      waitMethod: json['WaitMethod'] != null
          ? CreateParticipantRequestWaitMethod.fromJson(
              json['WaitMethod'] as String,
            )
          : null,
      ...
      conferenceStatusCallback: json['ConferenceStatusCallback'] != null
          ? Uri.parse(json['ConferenceStatusCallback'] as String)
          : null,
      conferenceStatusCallbackMethod:
          json['ConferenceStatusCallbackMethod'] != null
          ? CreateParticipantRequestConferenceStatusCallbackMethod.fromJson(
              json['ConferenceStatusCallbackMethod'] as String,
            )
          : null,
      conferenceStatusCallbackEvent:
          (json['ConferenceStatusCallbackEvent'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      recordingChannels: json['RecordingChannels'] as String?,
      recordingStatusCallback: json['RecordingStatusCallback'] != null
          ? Uri.parse(json['RecordingStatusCallback'] as String)
          : null,
      recordingStatusCallbackMethod:
          json['RecordingStatusCallbackMethod'] != null
          ? CreateParticipantRequestRecordingStatusCallbackMethod.fromJson(
              json['RecordingStatusCallbackMethod'] as String,
            )
          : null,
      ...
      conferenceRecordingStatusCallback:
          json['ConferenceRecordingStatusCallback'] != null
          ? Uri.parse(json['ConferenceRecordingStatusCallback'] as String)
          : null,
      conferenceRecordingStatusCallbackMethod:
          json['ConferenceRecordingStatusCallbackMethod'] != null
          ? CreateParticipantRequestConferenceRecordingStatusCallbackMethod.fromJson(
              json['ConferenceRecordingStatusCallbackMethod'] as String,
            )
          : null,
      recordingStatusCallbackEvent:
          (json['RecordingStatusCallbackEvent'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      conferenceRecordingStatusCallbackEvent:
          (json['ConferenceRecordingStatusCallbackEvent'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      ...
      machineDetectionTimeout: json['MachineDetectionTimeout'] != null
          ? (json['MachineDetectionTimeout'] as num).toInt()
          : null,
      machineDetectionSpeechThreshold:
          json['MachineDetectionSpeechThreshold'] != null
          ? (json['MachineDetectionSpeechThreshold'] as num).toInt()
          : null,
      machineDetectionSpeechEndThreshold:
          json['MachineDetectionSpeechEndThreshold'] != null
          ? (json['MachineDetectionSpeechEndThreshold'] as num).toInt()
          : null,
      machineDetectionSilenceTimeout:
          json['MachineDetectionSilenceTimeout'] != null
          ? (json['MachineDetectionSilenceTimeout'] as num).toInt()
          : null,
      amdStatusCallback: json['AmdStatusCallback'] != null
          ? Uri.parse(json['AmdStatusCallback'] as String)
          : null,
      amdStatusCallbackMethod: json['AmdStatusCallbackMethod'] != null
          ? CreateParticipantRequestAmdStatusCallbackMethod.fromJson(
              json['AmdStatusCallbackMethod'] as String,
            )
          : null,
      trim: json['Trim'] as String?,
      callToken: json['CallToken'] as String?,
      clientNotificationUrl: json['ClientNotificationUrl'] != null
          ? Uri.parse(json['ClientNotificationUrl'] as String)
          : null,
  ...
  final CreateParticipantRequestConferenceStatusCallbackMethod?
  conferenceStatusCallbackMethod;
  ...
  final CreateParticipantRequestRecordingStatusCallbackMethod?
  recordingStatusCallbackMethod;
  ...
  final CreateParticipantRequestConferenceRecordingStatusCallbackMethod?
  conferenceRecordingStatusCallbackMethod;
  ...
  final CreateParticipantRequestAmdStatusCallbackMethod?
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (conferenceStatusCallback != null)
        'ConferenceStatusCallback': conferenceStatusCallback?.toString(),
      ...
      if (conferenceRecordingStatusCallbackMethod != null)
        'ConferenceRecordingStatusCallbackMethod':
            conferenceRecordingStatusCallbackMethod?.toJson(),
      ...
      if (amdStatusCallback != null)
        'AmdStatusCallback': amdStatusCallback?.toString(),
      if (amdStatusCallbackMethod != null)
        'AmdStatusCallbackMethod': amdStatusCallbackMethod?.toJson(),
      'Trim': ?trim,
      'CallToken': ?callToken,
      if (clientNotificationUrl != null)
        'ClientNotificationUrl': clientNotificationUrl?.toString(),
  ...
  CreateParticipantRequest copyWith({
    ...
    CreateParticipantRequestStatusCallbackMethod Function()?
    statusCallbackMethod,
    List<String> Function()? statusCallbackEvent,
    String Function()? label,
    int Function()? timeout,
    bool Function()? record,
    bool Function()? muted,
    String Function()? beep,
    bool Function()? startConferenceOnEnter,
    bool Function()? endConferenceOnExit,
    Uri Function()? waitUrl,
    CreateParticipantRequestWaitMethod Function()? waitMethod,
    bool Function()? earlyMedia,
    int Function()? maxParticipants,
    String Function()? conferenceRecord,
    String Function()? conferenceTrim,
    Uri Function()? conferenceStatusCallback,
    CreateParticipantRequestConferenceStatusCallbackMethod Function()?
    conferenceStatusCallbackMethod,
    List<String> Function()? conferenceStatusCallbackEvent,
    String Function()? recordingChannels,
    Uri Function()? recordingStatusCallback,
    CreateParticipantRequestRecordingStatusCallbackMethod Function()?
    recordingStatusCallbackMethod,
    String Function()? sipAuthUsername,
    String Function()? sipAuthPassword,
    String Function()? region,
    Uri Function()? conferenceRecordingStatusCallback,
    CreateParticipantRequestConferenceRecordingStatusCallbackMethod Function()?
    conferenceRecordingStatusCallbackMethod,
    List<String> Function()? recordingStatusCallbackEvent,
    List<String> Function()? conferenceRecordingStatusCallbackEvent,
    bool Function()? coaching,
    String Function()? callSidToCoach,
    String Function()? jitterBufferSize,
    String Function()? byoc,
    String Function()? callerId,
    String Function()? callReason,
    String Function()? recordingTrack,
    int Function()? timeLimit,
    String Function()? machineDetection,
    int Function()? machineDetectionTimeout,
    int Function()? machineDetectionSpeechThreshold,
    int Function()? machineDetectionSpeechEndThreshold,
    int Function()? machineDetectionSilenceTimeout,
    Uri Function()? amdStatusCallback,
    CreateParticipantRequestAmdStatusCallbackMethod Function()?
    amdStatusCallbackMethod,
    String Function()? trim,
    String Function()? callToken,
    Uri Function()? clientNotificationUrl,
    String Function()? callerDisplayName,
  }) {
    return CreateParticipantRequest(
      from: from ?? this.from,
      to: to ?? this.to,
      ...
      statusCallbackMethod: statusCallbackMethod != null
          ? statusCallbackMethod()
          : this.statusCallbackMethod,
      statusCallbackEvent: statusCallbackEvent != null
          ? statusCallbackEvent()
          : this.statusCallbackEvent,
      ...
      startConferenceOnEnter: startConferenceOnEnter != null
          ? startConferenceOnEnter()
          : this.startConferenceOnEnter,
      endConferenceOnExit: endConferenceOnExit != null
          ? endConferenceOnExit()
          : this.endConferenceOnExit,
      ...
      conferenceRecord: conferenceRecord != null
          ? conferenceRecord()
          : this.conferenceRecord,
      conferenceTrim: conferenceTrim != null
          ? conferenceTrim()
          : this.conferenceTrim,
      conferenceStatusCallback: conferenceStatusCallback != null
          ? conferenceStatusCallback()
          : this.conferenceStatusCallback,
      conferenceStatusCallbackMethod: conferenceStatusCallbackMethod != null
          ? conferenceStatusCallbackMethod()
          : this.conferenceStatusCallbackMethod,
      conferenceStatusCallbackEvent: conferenceStatusCallbackEvent != null
          ? conferenceStatusCallbackEvent()
          : this.conferenceStatusCallbackEvent,
      recordingChannels: recordingChannels != null
          ? recordingChannels()
          : this.recordingChannels,
      recordingStatusCallback: recordingStatusCallback != null
          ? recordingStatusCallback()
          : this.recordingStatusCallback,
      recordingStatusCallbackMethod: recordingStatusCallbackMethod != null
          ? recordingStatusCallbackMethod()
          : this.recordingStatusCallbackMethod,
      sipAuthUsername: sipAuthUsername != null
          ? sipAuthUsername()
          : this.sipAuthUsername,
      sipAuthPassword: sipAuthPassword != null
          ? sipAuthPassword()
          : this.sipAuthPassword,
      region: region != null ? region() : this.region,
      conferenceRecordingStatusCallback:
          conferenceRecordingStatusCallback != null
          ? conferenceRecordingStatusCallback()
          : this.conferenceRecordingStatusCallback,
      conferenceRecordingStatusCallbackMethod:
          ...
          ? conferenceRecordingStatusCallbackMethod()
          : this.conferenceRecordingStatusCallbackMethod,
      recordingStatusCallbackEvent: recordingStatusCallbackEvent != null
          ? recordingStatusCallbackEvent()
          : this.recordingStatusCallbackEvent,
      conferenceRecordingStatusCallbackEvent:
      ...
      callSidToCoach: callSidToCoach != null
          ? callSidToCoach()
          : this.callSidToCoach,
      jitterBufferSize: jitterBufferSize != null
          ? jitterBufferSize()
          : this.jitterBufferSize,
      ...
      machineDetection: machineDetection != null
          ? machineDetection()
          : this.machineDetection,
      machineDetectionTimeout: machineDetectionTimeout != null
          ? machineDetectionTimeout()
          : this.machineDetectionTimeout,
      machineDetectionSpeechThreshold: machineDetectionSpeechThreshold != null
          ? machineDetectionSpeechThreshold()
          : this.machineDetectionSpeechThreshold,
      machineDetectionSpeechEndThreshold:
          ...
          ? machineDetectionSpeechEndThreshold()
          : this.machineDetectionSpeechEndThreshold,
      machineDetectionSilenceTimeout: machineDetectionSilenceTimeout != null
          ? machineDetectionSilenceTimeout()
          : this.machineDetectionSilenceTimeout,
      amdStatusCallback: amdStatusCallback != null
          ? amdStatusCallback()
          : this.amdStatusCallback,
      amdStatusCallbackMethod: amdStatusCallbackMethod != null
          ? amdStatusCallbackMethod()
          : this.amdStatusCallbackMethod,
      trim: trim != null ? trim() : this.trim,
      callToken: callToken != null ? callToken() : this.callToken,
      clientNotificationUrl: clientNotificationUrl != null
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CreateParticipantRequest &&
            ...
            conferenceStatusCallbackMethod ==
                other.conferenceStatusCallbackMethod &&
            const ListEquality<dynamic>().equals(
              conferenceStatusCallbackEvent,
              other.conferenceStatusCallbackEvent,
            ) &&
            recordingChannels == other.recordingChannels &&
            recordingStatusCallback == other.recordingStatusCallback &&
            recordingStatusCallbackMethod ==
                other.recordingStatusCallbackMethod &&
            ...
            const ListEquality<dynamic>().equals(
              recordingStatusCallbackEvent,
              other.recordingStatusCallbackEvent,
            ) &&
            const ListEquality<dynamic>().equals(
              conferenceRecordingStatusCallbackEvent,
            ...
            machineDetectionSpeechThreshold ==
                other.machineDetectionSpeechThreshold &&
            machineDetectionSpeechEndThreshold ==
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      statusCallback,
      statusCallbackMethod,
      Object.hashAll(statusCallbackEvent ?? const []),
      label,
      timeout,
      record,
      muted,
      ...
      conferenceStatusCallback,
      conferenceStatusCallbackMethod,
      Object.hashAll(conferenceStatusCallbackEvent ?? const []),
      recordingChannels,
      recordingStatusCallback,
      recordingStatusCallbackMethod,
      sipAuthUsername,
      ...
      conferenceRecordingStatusCallback,
      conferenceRecordingStatusCallbackMethod,
      Object.hashAll(recordingStatusCallbackEvent ?? const []),
      Object.hashAll(conferenceRecordingStatusCallbackEvent ?? const []),
      coaching,
      callSidToCoach,
      jitterBufferSize,
      byoc,
