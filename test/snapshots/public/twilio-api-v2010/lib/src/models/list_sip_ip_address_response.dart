...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSipIpAddressResponse &&
          const ListEquality<dynamic>().equals(ipAddresses, other.ipAddresses) &&
          end == other.end &&
