...
import 'call_enum_update_status.dart';import 'update_call_request_fallback_method.dart';import 'update_call_request_method.dart';import 'update_call_request_status_callback_method.dart';final class UpdateCallRequest {const UpdateCallRequest({this.url, this.method, this.status, this.fallbackUrl, this.fallbackMethod, this.statusCallback, this.statusCallbackMethod, this.twiml, this.timeLimit, });
