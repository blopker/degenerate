...
import 'stream_enum_status.dart';final class AccountCallStream {const AccountCallStream({this.sid, this.accountSid, this.callSid, this.name, this.status, this.dateUpdated, this.uri, });
