...
import 'payments_enum_bank_account_type.dart';
import 'payments_enum_payment_method.dart';
import 'payments_enum_token_type.dart';

final class CreatePaymentsRequest {
  const CreatePaymentsRequest({
    ...
    this.description,
    this.input,
    this.minPostalCodeLength,
    this.parameter,
    this.paymentConnector,
    this.paymentMethod,
    this.postalCode,
    this.securityCode,
    this.timeout,
  ...
  factory CreatePaymentsRequest.fromJson(Map<String, dynamic> json) {
    return CreatePaymentsRequest(
      ...
      bankAccountType: json['BankAccountType'] != null
          ? PaymentsEnumBankAccountType.fromJson(
              json['BankAccountType'] as String,
            )
          : null,
      ...
      minPostalCodeLength: json['MinPostalCodeLength'] != null
          ? (json['MinPostalCodeLength'] as num).toInt()
          : null,
      parameter: json['Parameter'] as String?,
      paymentConnector: json['PaymentConnector'] as String?,
      paymentMethod: json['PaymentMethod'] != null
          ? PaymentsEnumPaymentMethod.fromJson(json['PaymentMethod'] as String)
          : null,
      ...
      tokenType: json['TokenType'] != null
          ? PaymentsEnumTokenType.fromJson(json['TokenType'] as String)
          : null,
  ...
  CreatePaymentsRequest copyWith({
    String? idempotencyKey,
    Uri? statusCallback,
    PaymentsEnumBankAccountType Function()? bankAccountType,
    double Function()? chargeAmount,
    String Function()? currency,
    String Function()? description,
    String Function()? input,
    int Function()? minPostalCodeLength,
    String Function()? parameter,
    String Function()? paymentConnector,
    PaymentsEnumPaymentMethod Function()? paymentMethod,
    bool Function()? postalCode,
    bool Function()? securityCode,
    int Function()? timeout,
    PaymentsEnumTokenType Function()? tokenType,
    String Function()? validCardTypes,
  }) {
    return CreatePaymentsRequest(
      ...
      minPostalCodeLength: minPostalCodeLength != null
          ? minPostalCodeLength()
          : this.minPostalCodeLength,
      parameter: parameter != null ? parameter() : this.parameter,
      paymentConnector: paymentConnector != null
          ? paymentConnector()
          : this.paymentConnector,
      ...
      validCardTypes: validCardTypes != null
          ? validCardTypes()
          : this.validCardTypes,
    );
  }
