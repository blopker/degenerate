...
import '../models/list_available_phone_number_mobile_response.dart';

/// Api20100401MobileApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401MobileApi {
  const Api20100401MobileApi(this._config);
  ...
  Future<ApiResult<ListAvailablePhoneNumberMobileResponse>>
  listAvailablePhoneNumberMobile({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/Mobile.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberMobileResponse.fromJson(
