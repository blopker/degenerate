...
import '../models/list_available_phone_number_shared_cost_response.dart';

/// Api20100401SharedCostApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401SharedCostApi {
  const Api20100401SharedCostApi(this._config);
  ...
  listAvailablePhoneNumberSharedCost({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/SharedCost.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberSharedCostResponse.fromJson(
