...
import '../models/account_new_key.dart';
import '../models/create_new_key_request.dart';

/// Api20100401NewKeyApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401NewKeyApi {
  const Api20100401NewKeyApi(this._config);
  ...
  Future<ApiResult<AccountNewKey>> createNewKey({
    required String accountSid,
    CreateNewKeyRequest? body,
  }) async {
