...
import '../models/list_message_response.dart';
import '../models/update_message_request.dart';

/// Api20100401MessageApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401MessageApi {
  const Api20100401MessageApi(this._config);
  ...
  Future<ApiResult<ListMessageResponse>> listMessage({
    required String accountSid,
    String? to,
    String? from,
    DateTime? dateSent,
    DateTime? dateSentBefore,
    DateTime? dateSentAfter,
    int? pageSize,
    int? page,
    String? pageToken,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Messages.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListMessageResponse.fromJson(
  ...
  Future<ApiResult<AccountMessage>> createMessage({
    required String accountSid,
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return AccountMessage.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<AccountMessage>> fetchMessage({
    required String accountSid,
    required String sid,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Messages/${Uri.encodeComponent(sid)}.json',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<AccountMessage>> updateMessage({
    required String accountSid,
    required String sid,
