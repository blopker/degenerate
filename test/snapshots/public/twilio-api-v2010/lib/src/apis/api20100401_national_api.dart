...
import '../models/list_available_phone_number_national_response.dart';

/// Api20100401NationalApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401NationalApi {
  const Api20100401NationalApi(this._config);
  ...
  listAvailablePhoneNumberNational({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/National.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberNationalResponse.fromJson(
