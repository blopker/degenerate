...
/// Api20100401BalanceApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401BalanceApi {
  const Api20100401BalanceApi(this._config);
  ...
  Future<ApiResult<AccountBalance>> fetchBalance({
    required String accountSid,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Balance.json',
