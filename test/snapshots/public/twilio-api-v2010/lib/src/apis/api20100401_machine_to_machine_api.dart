...
import '../models/list_available_phone_number_machine_to_machine_response.dart';

/// Api20100401MachineToMachineApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401MachineToMachineApi {
  const Api20100401MachineToMachineApi(this._config);
  ...
  Future<ApiResult<ListAvailablePhoneNumberMachineToMachineResponse>>
  listAvailablePhoneNumberMachineToMachine({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/MachineToMachine.json',
      ...
      queryParameters: {
        ...
        if (excludeAllAddressRequired != null)
          'ExcludeAllAddressRequired': excludeAllAddressRequired.toString(),
        if (excludeLocalAddressRequired != null)
          'ExcludeLocalAddressRequired': excludeLocalAddressRequired.toString(),
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberMachineToMachineResponse.fromJson(
