...
import '../models/list_available_phone_number_local_response.dart';

/// Api20100401LocalApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401LocalApi {
  const Api20100401LocalApi(this._config);
  ...
  Future<ApiResult<ListAvailablePhoneNumberLocalResponse>>
  listAvailablePhoneNumberLocal({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/Local.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberLocalResponse.fromJson(
