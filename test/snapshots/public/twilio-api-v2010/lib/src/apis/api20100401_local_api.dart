...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/list_available_phone_number_local_response.dart';/// Api20100401LocalApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401LocalApi {const Api20100401LocalApi(this._config);
...
Future<ApiResult<ListAvailablePhoneNumberLocalResponse>> listAvailablePhoneNumberLocal({required String accountSid, required String countryCode, int? areaCode, String? contains, bool? smsEnabled, bool? mmsEnabled, bool? voiceEnabled, bool? excludeAllAddressRequired, bool? excludeLocalAddressRequired, bool? excludeForeignAddressRequired, bool? beta, String? nearNumber, String? nearLatLong, int? distance, String? inPostalCode, String? inRegion, String? inRateCenter, String? inLata, String? inLocality, bool? faxEnabled, int? pageSize, int? page, String? pageToken, }) async  { final request = ApiRequest(
  method: 'GET',
