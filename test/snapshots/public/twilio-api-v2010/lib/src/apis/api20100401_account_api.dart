...
import '../models/account_enum_status.dart';
import '../models/create_account_request.dart';
import '../models/list_account_response.dart';
import '../models/update_account_request.dart';

/// Api20100401AccountApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401AccountApi {
  const Api20100401AccountApi(this._config);
  ...
  Future<ApiResult<ListAccountResponse>> listAccount({
    String? friendlyName,
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAccountResponse.fromJson(
  ...
  Future<ApiResult<Account>> createAccount({CreateAccountRequest? body}) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/2010-04-01/Accounts.json',
  ...
  Future<ApiResult<Account>> fetchAccount({required String sid}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<Account>> updateAccount({
    required String sid,
