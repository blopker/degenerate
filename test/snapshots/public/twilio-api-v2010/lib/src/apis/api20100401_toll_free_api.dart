...
import '../models/list_available_phone_number_toll_free_response.dart';

/// Api20100401TollFreeApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401TollFreeApi {
  const Api20100401TollFreeApi(this._config);
  ...
  listAvailablePhoneNumberTollFree({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/TollFree.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberTollFreeResponse.fromJson(
