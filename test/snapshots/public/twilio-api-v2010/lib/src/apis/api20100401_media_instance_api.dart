...
import '../models/account_message_media.dart';

/// Api20100401MediaInstanceApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401MediaInstanceApi {
  const Api20100401MediaInstanceApi(this._config);
  ...
  Future<ApiResult<AccountMessageMedia>> fetchMedia({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Messages/${Uri.encodeComponent(messageSid)}/Media/${Uri.encodeComponent(sid)}.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return AccountMessageMedia.fromJson(
  ...
  Future<ApiResult<void>> deleteMedia({
    required String accountSid,
    required String messageSid,
    required String sid,
  }) async {
