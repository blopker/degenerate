...
import '../models/list_call_event_response.dart';

/// Api20100401EventApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401EventApi {
  const Api20100401EventApi(this._config);
  ...
  Future<ApiResult<ListCallEventResponse>> listCallEvent({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Calls/${Uri.encodeComponent(callSid)}/Events.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListCallEventResponse.fromJson(
