...
import '../models/list_media_response.dart';

/// Api20100401MediaApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401MediaApi {
  const Api20100401MediaApi(this._config);
  ...
  Future<ApiResult<ListMediaResponse>> listMedia({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Messages/${Uri.encodeComponent(messageSid)}/Media.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListMediaResponse.fromJson(
