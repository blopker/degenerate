...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/list_media_response.dart';/// Api20100401MediaApi operations.
///
...
Future<ApiResult<ListMediaResponse>> listMedia({required String accountSid, required String messageSid, DateTime? dateCreated, DateTime? dateCreatedBefore, DateTime? dateCreatedAfter, int? pageSize, int? page, String? pageToken, }) async  { final request = ApiRequest(
  method: 'GET',
