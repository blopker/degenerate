...
import '../models/list_address_response.dart';
import '../models/update_address_request.dart';

/// Api20100401AddressApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401AddressApi {
  const Api20100401AddressApi(this._config);
  ...
  Future<ApiResult<ListAddressResponse>> listAddress({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Addresses.json',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        'CustomerName': ?customerName,
        'FriendlyName': ?friendlyName,
        if (emergencyEnabled != null)
          'EmergencyEnabled': emergencyEnabled.toString(),
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAddressResponse.fromJson(
  ...
  Future<ApiResult<AccountAddress>> createAddress({
    required String accountSid,
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return AccountAddress.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<AccountAddress>> fetchAddress({
    required String accountSid,
    required String sid,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Addresses/${Uri.encodeComponent(sid)}.json',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<AccountAddress>> updateAddress({
    required String accountSid,
    required String sid,
  ...
  Future<ApiResult<void>> deleteAddress({
    required String accountSid,
    required String sid,
  }) async {
    final request = ApiRequest(
