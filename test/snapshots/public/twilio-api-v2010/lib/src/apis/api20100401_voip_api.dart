...
import '../models/list_available_phone_number_voip_response.dart';

/// Api20100401VoipApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401VoipApi {
  const Api20100401VoipApi(this._config);
  ...
  Future<ApiResult<ListAvailablePhoneNumberVoipResponse>>
  listAvailablePhoneNumberVoip({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/AvailablePhoneNumbers/${Uri.encodeComponent(countryCode)}/Voip.json',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return ListAvailablePhoneNumberVoipResponse.fromJson(
