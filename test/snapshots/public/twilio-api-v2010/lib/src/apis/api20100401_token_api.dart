...
import '../models/create_token_request.dart';

/// Api20100401TokenApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401TokenApi {
  const Api20100401TokenApi(this._config);
  ...
  Future<ApiResult<AccountToken>> createToken({
    ...
    final request = ApiRequest(
      method: 'POST',
      path:
          '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/Tokens.json',
