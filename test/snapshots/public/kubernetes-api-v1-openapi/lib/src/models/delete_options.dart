...
final class DeleteOptions {
  ...
  factory DeleteOptions.fromJson(Map<String, dynamic> json) {
    return DeleteOptions(
      ...
      dryRun: (json['dryRun'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      gracePeriodSeconds: json['gracePeriodSeconds'] != null
          ? (json['gracePeriodSeconds'] as num).toInt()
          : null,
      ignoreStoreReadErrorWithClusterBreakingPotential:
          json['ignoreStoreReadErrorWithClusterBreakingPotential'] as bool?,
  ...
  DeleteOptions copyWith({
    String Function()? apiVersion,
    List<String> Function()? dryRun,
    int Function()? gracePeriodSeconds,
    bool Function()? ignoreStoreReadErrorWithClusterBreakingPotential,
    String Function()? kind,
    bool Function()? orphanDependents,
    Preconditions Function()? preconditions,
    String Function()? propagationPolicy,
  }) {
    return DeleteOptions(
      apiVersion: apiVersion != null ? apiVersion() : this.apiVersion,
      dryRun: dryRun != null ? dryRun() : this.dryRun,
      gracePeriodSeconds: gracePeriodSeconds != null
          ? gracePeriodSeconds()
          : this.gracePeriodSeconds,
      ignoreStoreReadErrorWithClusterBreakingPotential:
          ignoreStoreReadErrorWithClusterBreakingPotential != null
          ? ignoreStoreReadErrorWithClusterBreakingPotential()
          : this.ignoreStoreReadErrorWithClusterBreakingPotential,
      kind: kind != null ? kind() : this.kind,
      orphanDependents: orphanDependents != null
          ? orphanDependents()
          : this.orphanDependents,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is DeleteOptions &&
            ...
            const ListEquality<dynamic>().equals(dryRun, other.dryRun) &&
            gracePeriodSeconds == other.gracePeriodSeconds &&
            ignoreStoreReadErrorWithClusterBreakingPotential ==
                other.ignoreStoreReadErrorWithClusterBreakingPotential &&
            kind == other.kind &&
  ...
  @override
  String toString() {
    return 'DeleteOptions(apiVersion: $apiVersion, dryRun: $dryRun, gracePeriodSeconds: $gracePeriodSeconds, ignoreStoreReadErrorWithClusterBreakingPotential: $ignoreStoreReadErrorWithClusterBreakingPotential, kind: $kind, orphanDependents: $orphanDependents, preconditions: $preconditions, propagationPolicy: $propagationPolicy)';
  }
}
