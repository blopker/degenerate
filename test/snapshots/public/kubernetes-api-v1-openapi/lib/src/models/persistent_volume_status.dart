...
final class PersistentVolumeStatus {
  ...
  Map<String, dynamic> toJson() {
    return {
      if (lastPhaseTransitionTime != null)
        'lastPhaseTransitionTime': lastPhaseTransitionTime?.toIso8601String(),
      'message': ?message,
      'phase': ?phase,
      'reason': ?reason,
    };
  ...
  PersistentVolumeStatus copyWith({
    DateTime Function()? lastPhaseTransitionTime,
    String Function()? message,
    String Function()? phase,
    String Function()? reason,
  }) {
    return PersistentVolumeStatus(
      lastPhaseTransitionTime: lastPhaseTransitionTime != null
  ...
  @override
  int get hashCode {
    return Object.hash(lastPhaseTransitionTime, message, phase, reason);
  }
