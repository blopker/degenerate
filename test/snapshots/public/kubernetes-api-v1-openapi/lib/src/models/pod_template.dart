...
final class PodTemplate {
  const PodTemplate({this.apiVersion, this.kind, this.metadata, this.template});
  ...
  @override
  int get hashCode {
    return Object.hash(apiVersion, kind, metadata, template);
  }
