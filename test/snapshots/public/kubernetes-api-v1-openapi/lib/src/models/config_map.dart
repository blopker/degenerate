...
final class ConfigMap {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (binaryData != null)
        'binaryData': binaryData?.map((k, v) => MapEntry(k, base64Encode(v))),
      'data': ?data,
      'immutable': ?immutable,
      'kind': ?kind,
  ...
  ConfigMap copyWith({
    ...
    Map<String, Uint8List> Function()? binaryData,
  ...
  @override
  int get hashCode {
    return Object.hash(apiVersion, binaryData, data, immutable, kind, metadata);
  }
