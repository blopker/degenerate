...
final class ClusterTrustBundleProjection {
  const ClusterTrustBundleProjection({
    this.labelSelector,
    this.name,
    this.optional,
    this.path = '',
  ...
  ClusterTrustBundleProjection copyWith({
    LabelSelector Function()? labelSelector,
    String Function()? name,
    bool Function()? optional,
    String? path,
    String Function()? signerName,
  }) {
    return ClusterTrustBundleProjection(
  ...
  @override
  int get hashCode {
    return Object.hash(labelSelector, name, optional, path, signerName);
  }

  @override
  String toString() {
    return 'ClusterTrustBundleProjection(labelSelector: $labelSelector, name: $name, optional: $optional, path: $path, signerName: $signerName)';
  }
}
