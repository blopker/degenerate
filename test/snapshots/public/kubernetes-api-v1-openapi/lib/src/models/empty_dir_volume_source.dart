...
final class EmptyDirVolumeSource {
  const EmptyDirVolumeSource({this.medium, this.sizeLimit});
  ...
  EmptyDirVolumeSource copyWith({
    String Function()? medium,
    ResourceQuantity Function()? sizeLimit,
  }) {
    return EmptyDirVolumeSource(
  ...
  @override
  int get hashCode {
    return Object.hash(medium, sizeLimit);
  }
