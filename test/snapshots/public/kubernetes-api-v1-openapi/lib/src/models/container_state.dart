...
final class ContainerState {
  const ContainerState({this.running, this.terminated, this.waiting});
  ...
  ContainerState copyWith({
    ContainerStateRunning Function()? running,
    ContainerStateTerminated Function()? terminated,
    ContainerStateWaiting Function()? waiting,
  }) {
    return ContainerState(
  ...
  @override
  int get hashCode {
    return Object.hash(running, terminated, waiting);
  }
