...
final class NodeSelector {
  const NodeSelector({required this.nodeSelectorTerms});
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('nodeSelectorTerms');
  }

  NodeSelector copyWith({List<NodeSelectorTerm>? nodeSelectorTerms}) {
    return NodeSelector(
    ...
    return identical(this, other) ||
        other is NodeSelector &&
            const ListEquality<dynamic>().equals(
              nodeSelectorTerms,
              other.nodeSelectorTerms,
            );
  }

  @override
  int get hashCode {
    return Object.hashAll(nodeSelectorTerms).hashCode;
  }
