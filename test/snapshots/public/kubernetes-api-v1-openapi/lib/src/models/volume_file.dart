...
final class VolumeFile {
  ...
  factory VolumeFile.fromJson(Map<String, dynamic> json) {
    return VolumeFile(
  ...
  @override
  int get hashCode {
    return Object.hash(fieldRef, mode, path, resourceFieldRef);
  }

  @override
  String toString() {
    return 'VolumeFile(fieldRef: $fieldRef, mode: $mode, path: $path, resourceFieldRef: $resourceFieldRef)';
  }
}
