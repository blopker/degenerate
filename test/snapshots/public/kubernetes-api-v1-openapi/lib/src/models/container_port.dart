...
final class ContainerPort {
  ...
  factory ContainerPort.fromJson(Map<String, dynamic> json) {
    return ContainerPort(
      ...
      hostPort: json['hostPort'] != null
          ? (json['hostPort'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('containerPort') && json['containerPort'] is num;
  }

  ContainerPort copyWith({
    int? containerPort,
    String Function()? hostIp,
    int Function()? hostPort,
  ...
  @override
  int get hashCode {
    return Object.hash(containerPort, hostIp, hostPort, name, protocol);
  }
