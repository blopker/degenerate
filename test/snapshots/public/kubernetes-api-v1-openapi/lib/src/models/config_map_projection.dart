...
final class ConfigMapProjection {
  const ConfigMapProjection({this.items, this.name = '', this.optional});
  ...
  ConfigMapProjection copyWith({
    List<KeyToPath> Function()? items,
  ...
  @override
  int get hashCode {
    return Object.hash(Object.hashAll(items ?? const []), name, optional);
  }
