...
final class LoadBalancerStatus {
  const LoadBalancerStatus({this.ingress});
  ...
  LoadBalancerStatus copyWith({List<LoadBalancerIngress> Function()? ingress}) {
    return LoadBalancerStatus(
  ...
  @override
  int get hashCode {
    return Object.hashAll(ingress ?? const []).hashCode;
  }
