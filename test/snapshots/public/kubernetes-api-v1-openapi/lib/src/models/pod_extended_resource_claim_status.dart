...
final class PodExtendedResourceClaimStatus {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('requestMappings') &&
        json.containsKey('resourceClaimName') &&
        json['resourceClaimName'] is String;
  }

  PodExtendedResourceClaimStatus copyWith({
    List<ContainerExtendedResourceRequest>? requestMappings,
  ...
  @override
  int get hashCode {
    return Object.hash(Object.hashAll(requestMappings), resourceClaimName);
  }

  @override
  String toString() {
    return 'PodExtendedResourceClaimStatus(requestMappings: $requestMappings, resourceClaimName: $resourceClaimName)';
  }
}
