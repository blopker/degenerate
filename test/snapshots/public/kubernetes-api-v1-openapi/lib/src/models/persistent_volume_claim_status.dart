...
final class PersistentVolumeClaimStatus {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (modifyVolumeStatus != null)
        'modifyVolumeStatus': modifyVolumeStatus?.toJson(),
      'phase': ?phase,
    };
  }
  ...
  PersistentVolumeClaimStatus copyWith({
    List<String> Function()? accessModes,
    Map<String, String> Function()? allocatedResourceStatuses,
    Map<String, ResourceQuantity> Function()? allocatedResources,
    Map<String, ResourceQuantity> Function()? capacity,
    List<PersistentVolumeClaimCondition> Function()? conditions,
    String Function()? currentVolumeAttributesClassName,
    ModifyVolumeStatus Function()? modifyVolumeStatus,
    String Function()? phase,
  }) {
    return PersistentVolumeClaimStatus(
      accessModes: accessModes != null ? accessModes() : this.accessModes,
      allocatedResourceStatuses: allocatedResourceStatuses != null
          ? allocatedResourceStatuses()
          : this.allocatedResourceStatuses,
      ...
      currentVolumeAttributesClassName: currentVolumeAttributesClassName != null
          ? currentVolumeAttributesClassName()
          : this.currentVolumeAttributesClassName,
