...
final class ResourceQuotaSpec {
  const ResourceQuotaSpec({this.hard, this.scopeSelector, this.scopes});
  ...
  ResourceQuotaSpec copyWith({
    Map<String, ResourceQuantity> Function()? hard,
    ScopeSelector Function()? scopeSelector,
  ...
  @override
  int get hashCode {
    return Object.hash(hard, scopeSelector, Object.hashAll(scopes ?? const []));
  }
