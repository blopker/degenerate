...
final class Event {
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
      ...
      related: json['related'] != null
          ...
          : null,
      reportingComponent: json.containsKey('reportingComponent')
          ? json['reportingComponent'] as String
          : '',
      reportingInstance: json.containsKey('reportingInstance')
          ? json['reportingInstance'] as String
          : '',
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('involvedObject') && json.containsKey('metadata');
  }
  ...
  Event copyWith({
    ...
    int Function()? count,
    DateTime Function()? eventTime,
    DateTime Function()? firstTimestamp,
    ...
    ObjectReference Function()? related,
    String Function()? reportingComponent,
    String Function()? reportingInstance,
    EventSeries Function()? series,
    ...
    return Event(
      ...
      reportingComponent: reportingComponent != null
          ? reportingComponent()
          : this.reportingComponent,
      reportingInstance: reportingInstance != null
          ? reportingInstance()
          : this.reportingInstance,
  ...
  @override
  String toString() {
    return 'Event(action: $action, apiVersion: $apiVersion, count: $count, eventTime: $eventTime, firstTimestamp: $firstTimestamp, involvedObject: $involvedObject, kind: $kind, lastTimestamp: $lastTimestamp, message: $message, metadata: $metadata, reason: $reason, related: $related, reportingComponent: $reportingComponent, reportingInstance: $reportingInstance, series: $series, source: $source, type: $type)';
  }
}
