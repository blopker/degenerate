...
final class PodCondition {
  ...
  @override
  String toString() {
    return 'PodCondition(lastProbeTime: $lastProbeTime, lastTransitionTime: $lastTransitionTime, message: $message, observedGeneration: $observedGeneration, reason: $reason, status: $status, type: $type)';
  }
}
