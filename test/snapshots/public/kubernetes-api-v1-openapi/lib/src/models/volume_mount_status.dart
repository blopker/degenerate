...
final class VolumeMountStatus {
  ...
  factory VolumeMountStatus.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('mountPath') &&
        json['mountPath'] is String &&
        json.containsKey('name') &&
        json['name'] is String;
  }

  VolumeMountStatus copyWith({
    String? mountPath,
    String? name,
    bool Function()? readOnly,
    String Function()? recursiveReadOnly,
    VolumeStatus Function()? volumeStatus,
  }) {
    return VolumeMountStatus(
      mountPath: mountPath ?? this.mountPath,
      name: name ?? this.name,
      readOnly: readOnly != null ? readOnly() : this.readOnly,
      recursiveReadOnly: recursiveReadOnly != null
          ? recursiveReadOnly()
          : this.recursiveReadOnly,
  ...
  @override
  String toString() {
    return 'VolumeMountStatus(mountPath: $mountPath, name: $name, readOnly: $readOnly, recursiveReadOnly: $recursiveReadOnly, volumeStatus: $volumeStatus)';
  }
}
