...
final class EndpointAddress {
  ...
  EndpointAddress copyWith({
    String Function()? hostname,
    String? ip,
    String Function()? nodeName,
    ObjectReference Function()? targetRef,
  }) {
    return EndpointAddress(
  ...
  @override
  int get hashCode {
    return Object.hash(hostname, ip, nodeName, targetRef);
  }

  @override
  String toString() {
    return 'EndpointAddress(hostname: $hostname, ip: $ip, nodeName: $nodeName, targetRef: $targetRef)';
  }
}
