...
final class EndpointSubset {
  const EndpointSubset({this.addresses, this.notReadyAddresses, this.ports});
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (notReadyAddresses != null)
        'notReadyAddresses': notReadyAddresses?.map((e) => e.toJson()).toList(),
  ...
  EndpointSubset copyWith({
    List<EndpointAddress> Function()? addresses,
    List<EndpointAddress> Function()? notReadyAddresses,
    List<EndpointPort> Function()? ports,
  }) {
    return EndpointSubset(
      addresses: addresses != null ? addresses() : this.addresses,
      notReadyAddresses: notReadyAddresses != null
          ? notReadyAddresses()
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(notReadyAddresses ?? const []),
