...
factory ManagedFieldsEntry.fromJson(Map<String, dynamic> json) { return ManagedFieldsEntry(
  ...
  fieldsV1: (json['fieldsV1'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
...
final Map<String,String>? fieldsV1;
...
ManagedFieldsEntry copyWith({String Function()? apiVersion, String Function()? fieldsType, Map<String, String> Function()? fieldsV1, String Function()? manager, String Function()? operation, String Function()? subresource, DateTime Function()? time, }) { return ManagedFieldsEntry(
