...
import 'io_k8s_apimachinery_pkg_util_intstr_int_or_string.dart';
...
final class ServicePort {
  ...
  factory ServicePort.fromJson(Map<String, dynamic> json) {
    return ServicePort(
      ...
      nodePort: json['nodePort'] != null
          ? (json['nodePort'] as num).toInt()
          : null,
      ...
      targetPort: json['targetPort'] != null
          ? IoK8sApimachineryPkgUtilIntstrIntOrString.fromJson(
              json['targetPort'] as Map<String, dynamic>,
            )
          : null,
    );
  }
  ...
  ServicePort copyWith({
    String Function()? appProtocol,
    String Function()? name,
    int Function()? nodePort,
    int? port,
    String Function()? protocol,
    IoK8sApimachineryPkgUtilIntstrIntOrString Function()? targetPort,
  }) {
    return ServicePort(
  ...
  @override
  int get hashCode {
    return Object.hash(appProtocol, name, nodePort, port, protocol, targetPort);
  }

  @override
  String toString() {
    return 'ServicePort(appProtocol: $appProtocol, name: $name, nodePort: $nodePort, port: $port, protocol: $protocol, targetPort: $targetPort)';
  }
}
