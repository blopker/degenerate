...
final class PodSecurityContext {
  ...
  PodSecurityContext copyWith({
    AppArmorProfile Function()? appArmorProfile,
    int Function()? fsGroup,
    String Function()? fsGroupChangePolicy,
    int Function()? runAsGroup,
    bool Function()? runAsNonRoot,
    int Function()? runAsUser,
    String Function()? seLinuxChangePolicy,
    SeLinuxOptions Function()? seLinuxOptions,
    SeccompProfile Function()? seccompProfile,
    List<int> Function()? supplementalGroups,
    String Function()? supplementalGroupsPolicy,
    List<Sysctl> Function()? sysctls,
    WindowsSecurityContextOptions Function()? windowsOptions,
  }) {
    return PodSecurityContext(
      ...
      fsGroupChangePolicy: fsGroupChangePolicy != null
          ? fsGroupChangePolicy()
          : this.fsGroupChangePolicy,
      ...
      seLinuxChangePolicy: seLinuxChangePolicy != null
          ? seLinuxChangePolicy()
          : this.seLinuxChangePolicy,
      ...
      seccompProfile: seccompProfile != null
          ? seccompProfile()
          : this.seccompProfile,
      supplementalGroups: supplementalGroups != null
          ? supplementalGroups()
          : this.supplementalGroups,
      supplementalGroupsPolicy: supplementalGroupsPolicy != null
          ? supplementalGroupsPolicy()
          : this.supplementalGroupsPolicy,
      sysctls: sysctls != null ? sysctls() : this.sysctls,
      windowsOptions: windowsOptions != null
          ? windowsOptions()
          : this.windowsOptions,
    );
  }
    ...
    return identical(this, other) ||
        other is PodSecurityContext &&
            ...
            const ListEquality<dynamic>().equals(
              supplementalGroups,
              other.supplementalGroups,
            ) &&
            supplementalGroupsPolicy == other.supplementalGroupsPolicy &&
            const ListEquality<dynamic>().equals(sysctls, other.sysctls) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      seLinuxOptions,
      seccompProfile,
      Object.hashAll(supplementalGroups ?? const []),
      supplementalGroupsPolicy,
      Object.hashAll(sysctls ?? const []),
      windowsOptions,
    );
  }
