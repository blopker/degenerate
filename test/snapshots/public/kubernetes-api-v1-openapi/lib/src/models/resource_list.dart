...
final class ResourceList {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('groupVersion') &&
        json['groupVersion'] is String &&
  ...
  @override
  String toString() {
    return 'ResourceList(apiVersion: $apiVersion, groupVersion: $groupVersion, kind: $kind, resources: $resources)';
  }
}
