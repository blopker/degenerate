...
final class NodeSystemInfo {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('architecture') &&
        json['architecture'] is String &&
        json.containsKey('bootID') &&
        json['bootID'] is String &&
        json.containsKey('containerRuntimeVersion') &&
        json['containerRuntimeVersion'] is String &&
        json.containsKey('kernelVersion') &&
        json['kernelVersion'] is String &&
        json.containsKey('kubeProxyVersion') &&
        json['kubeProxyVersion'] is String &&
        json.containsKey('kubeletVersion') &&
        json['kubeletVersion'] is String &&
        json.containsKey('machineID') &&
        json['machineID'] is String &&
        json.containsKey('operatingSystem') &&
        json['operatingSystem'] is String &&
        json.containsKey('osImage') &&
        json['osImage'] is String &&
        json.containsKey('systemUUID') &&
        json['systemUUID'] is String;
  }

  NodeSystemInfo copyWith({
    String? architecture,
    String? bootId,
