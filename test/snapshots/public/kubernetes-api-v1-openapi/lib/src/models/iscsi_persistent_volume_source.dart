...
final class IscsiPersistentVolumeSource {
  ...
  factory IscsiPersistentVolumeSource.fromJson(Map<String, dynamic> json) {
    return IscsiPersistentVolumeSource(
      ...
      iscsiInterface: json.containsKey('iscsiInterface')
          ? json['iscsiInterface'] as String
          : 'default',
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('iqn') &&
        json['iqn'] is String &&
        json.containsKey('lun') &&
        json['lun'] is num &&
        json.containsKey('targetPortal') &&
        json['targetPortal'] is String;
  }

  IscsiPersistentVolumeSource copyWith({
    bool Function()? chapAuthDiscovery,
    bool Function()? chapAuthSession,
    String Function()? fsType,
    String Function()? initiatorName,
    String? iqn,
    String Function()? iscsiInterface,
    int? lun,
    List<String> Function()? portals,
    bool Function()? readOnly,
    SecretReference Function()? secretRef,
    String? targetPortal,
  }) {
    return IscsiPersistentVolumeSource(
      chapAuthDiscovery: chapAuthDiscovery != null
          ? chapAuthDiscovery()
          : this.chapAuthDiscovery,
      chapAuthSession: chapAuthSession != null
          ? chapAuthSession()
          : this.chapAuthSession,
      ...
      initiatorName: initiatorName != null
          ...
          : this.initiatorName,
      iqn: iqn ?? this.iqn,
      iscsiInterface: iscsiInterface != null
          ? iscsiInterface()
          : this.iscsiInterface,
      lun: lun ?? this.lun,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is IscsiPersistentVolumeSource &&
            ...
            lun == other.lun &&
            const ListEquality<dynamic>().equals(portals, other.portals) &&
  ...
  @override
  String toString() {
    return 'IscsiPersistentVolumeSource(chapAuthDiscovery: $chapAuthDiscovery, chapAuthSession: $chapAuthSession, fsType: $fsType, initiatorName: $initiatorName, iqn: $iqn, iscsiInterface: $iscsiInterface, lun: $lun, portals: $portals, readOnly: $readOnly, secretRef: $secretRef, targetPortal: $targetPortal)';
  }
}
