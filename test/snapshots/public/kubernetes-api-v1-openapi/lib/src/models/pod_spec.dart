...
final class PodSpec {
  ...
  factory PodSpec.fromJson(Map<String, dynamic> json) {
    return PodSpec(
      activeDeadlineSeconds: json['activeDeadlineSeconds'] != null
          ? (json['activeDeadlineSeconds'] as num).toInt()
          : null,
      ...
      os: json['os'] != null
          ...
          : null,
      overhead: (json['overhead'] as Map<String, dynamic>?)?.map(
        (k, v) =>
      ...
      terminationGracePeriodSeconds:
          json['terminationGracePeriodSeconds'] != null
      ...
      workloadRef: json['workloadRef'] != null
          ? WorkloadReference.fromJson(
              json['workloadRef'] as Map<String, dynamic>,
            )
          : null,
    );
  }
    ...
    return {
      ...
      if (ephemeralContainers != null)
        'ephemeralContainers': ephemeralContainers
            ...
            .toList(),
      if (hostAliases != null)
        'hostAliases': hostAliases?.map((e) => e.toJson()).toList(),
      'hostIPC': ?hostIpc,
      ...
      if (initContainers != null)
        'initContainers': initContainers?.map((e) => e.toJson()).toList(),
      'nodeName': ?nodeName,
      'nodeSelector': ?nodeSelector,
      if (os != null) 'os': os?.toJson(),
      if (overhead != null)
        'overhead': overhead?.map((k, v) => MapEntry(k, v.toJson())),
      'preemptionPolicy': ?preemptionPolicy,
      'priority': ?priority,
      'priorityClassName': ?priorityClassName,
      if (readinessGates != null)
        'readinessGates': readinessGates?.map((e) => e.toJson()).toList(),
      if (resourceClaims != null)
        'resourceClaims': resourceClaims?.map((e) => e.toJson()).toList(),
      if (resources != null) 'resources': resources?.toJson(),
      'restartPolicy': ?restartPolicy,
      'runtimeClassName': ?runtimeClassName,
      'schedulerName': ?schedulerName,
      if (schedulingGates != null)
        'schedulingGates': schedulingGates?.map((e) => e.toJson()).toList(),
      ...
      if (tolerations != null)
        'tolerations': tolerations?.map((e) => e.toJson()).toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('containers');
  }

  PodSpec copyWith({
    int Function()? activeDeadlineSeconds,
    Affinity Function()? affinity,
    bool Function()? automountServiceAccountToken,
    List<Container>? containers,
    PodDnsConfig Function()? dnsConfig,
    String Function()? dnsPolicy,
    bool Function()? enableServiceLinks,
    List<EphemeralContainer> Function()? ephemeralContainers,
    List<HostAlias> Function()? hostAliases,
    bool Function()? hostIpc,
    bool Function()? hostNetwork,
    bool Function()? hostPid,
    bool Function()? hostUsers,
    String Function()? hostname,
    String Function()? hostnameOverride,
    List<LocalObjectReference> Function()? imagePullSecrets,
    List<Container> Function()? initContainers,
    String Function()? nodeName,
    Map<String, String> Function()? nodeSelector,
    PodOs Function()? os,
    Map<String, ResourceQuantity> Function()? overhead,
    String Function()? preemptionPolicy,
    int Function()? priority,
    String Function()? priorityClassName,
    List<PodReadinessGate> Function()? readinessGates,
    List<PodResourceClaim> Function()? resourceClaims,
    ResourceRequirements Function()? resources,
    String Function()? restartPolicy,
    String Function()? runtimeClassName,
    String Function()? schedulerName,
    List<PodSchedulingGate> Function()? schedulingGates,
    PodSecurityContext Function()? securityContext,
    String Function()? serviceAccount,
    String Function()? serviceAccountName,
    bool Function()? setHostnameAsFqdn,
    bool Function()? shareProcessNamespace,
    String Function()? subdomain,
    int Function()? terminationGracePeriodSeconds,
    List<Toleration> Function()? tolerations,
    List<TopologySpreadConstraint> Function()? topologySpreadConstraints,
    List<Volume> Function()? volumes,
    WorkloadReference Function()? workloadRef,
  }) {
    return PodSpec(
      ...
      enableServiceLinks: enableServiceLinks != null
          ? enableServiceLinks()
          : this.enableServiceLinks,
      ...
      preemptionPolicy: preemptionPolicy != null
          ? preemptionPolicy()
          : this.preemptionPolicy,
      priority: priority != null ? priority() : this.priority,
      priorityClassName: priorityClassName != null
          ? priorityClassName()
          : this.priorityClassName,
      ...
      serviceAccountName: serviceAccountName != null
          ? serviceAccountName()
          : this.serviceAccountName,
      setHostnameAsFqdn: setHostnameAsFqdn != null
          ? setHostnameAsFqdn()
          : this.setHostnameAsFqdn,
      shareProcessNamespace: shareProcessNamespace != null
          ? shareProcessNamespace()
          : this.shareProcessNamespace,
      subdomain: subdomain != null ? subdomain() : this.subdomain,
      terminationGracePeriodSeconds: terminationGracePeriodSeconds != null
          ? terminationGracePeriodSeconds()
          : this.terminationGracePeriodSeconds,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PodSpec &&
            ...
            const ListEquality<dynamic>().equals(
              topologySpreadConstraints,
              other.topologySpreadConstraints,
            ) &&
            const ListEquality<dynamic>().equals(volumes, other.volumes) &&
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      dnsPolicy,
      enableServiceLinks,
      Object.hashAll(ephemeralContainers ?? const []),
      Object.hashAll(hostAliases ?? const []),
      hostIpc,
      hostNetwork,
      hostPid,
      hostUsers,
      hostname,
      hostnameOverride,
      Object.hashAll(imagePullSecrets ?? const []),
      Object.hashAll(initContainers ?? const []),
      nodeName,
      nodeSelector,
      os,
      overhead,
      ...
      priority,
      priorityClassName,
      Object.hashAll(readinessGates ?? const []),
      Object.hashAll(resourceClaims ?? const []),
      resources,
      restartPolicy,
      runtimeClassName,
      schedulerName,
      Object.hashAll(schedulingGates ?? const []),
      securityContext,
      serviceAccount,
      serviceAccountName,
      setHostnameAsFqdn,
      ...
      subdomain,
      terminationGracePeriodSeconds,
      Object.hashAll(tolerations ?? const []),
      Object.hashAll(topologySpreadConstraints ?? const []),
      Object.hashAll(volumes ?? const []),
      workloadRef,
    ]);
  }
