...
final class CsiPersistentVolumeSource {
  ...
  Map<String, dynamic> toJson() {
    return {
      if (controllerExpandSecretRef != null)
        'controllerExpandSecretRef': controllerExpandSecretRef?.toJson(),
      if (controllerPublishSecretRef != null)
        'controllerPublishSecretRef': controllerPublishSecretRef?.toJson(),
      'driver': driver,
      'fsType': ?fsType,
      if (nodeExpandSecretRef != null)
        'nodeExpandSecretRef': nodeExpandSecretRef?.toJson(),
      if (nodePublishSecretRef != null)
        'nodePublishSecretRef': nodePublishSecretRef?.toJson(),
      if (nodeStageSecretRef != null)
        'nodeStageSecretRef': nodeStageSecretRef?.toJson(),
      'readOnly': ?readOnly,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('driver') &&
        json['driver'] is String &&
        json.containsKey('volumeHandle') &&
        json['volumeHandle'] is String;
  }

  CsiPersistentVolumeSource copyWith({
    SecretReference Function()? controllerExpandSecretRef,
    SecretReference Function()? controllerPublishSecretRef,
    String? driver,
    String Function()? fsType,
    SecretReference Function()? nodeExpandSecretRef,
    SecretReference Function()? nodePublishSecretRef,
    SecretReference Function()? nodeStageSecretRef,
    bool Function()? readOnly,
    Map<String, String> Function()? volumeAttributes,
    String? volumeHandle,
  }) {
    return CsiPersistentVolumeSource(
      controllerExpandSecretRef: controllerExpandSecretRef != null
          ? controllerExpandSecretRef()
          : this.controllerExpandSecretRef,
      controllerPublishSecretRef: controllerPublishSecretRef != null
          ? controllerPublishSecretRef()
          : this.controllerPublishSecretRef,
      driver: driver ?? this.driver,
      fsType: fsType != null ? fsType() : this.fsType,
      nodeExpandSecretRef: nodeExpandSecretRef != null
          ? nodeExpandSecretRef()
          : this.nodeExpandSecretRef,
      nodePublishSecretRef: nodePublishSecretRef != null
          ? nodePublishSecretRef()
          : this.nodePublishSecretRef,
      nodeStageSecretRef: nodeStageSecretRef != null
          ? nodeStageSecretRef()
          : this.nodeStageSecretRef,
      readOnly: readOnly != null ? readOnly() : this.readOnly,
      volumeAttributes: volumeAttributes != null
          ? volumeAttributes()
          : this.volumeAttributes,
