...
factory TokenRequestStatus.fromJson(Map<String, dynamic> json) { return TokenRequestStatus(
  expirationTimestamp: json['expirationTimestamp'] != null ? DateTime.parse(json['expirationTimestamp'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  if (expirationTimestamp != null) 'expirationTimestamp': expirationTimestamp?.toIso8601String(),
  'token': token,
}; } 
static bool canParse(Map<String, dynamic> json) { return true; } 
TokenRequestStatus copyWith({DateTime Function()? expirationTimestamp, String Function()? token, }) { return TokenRequestStatus(
