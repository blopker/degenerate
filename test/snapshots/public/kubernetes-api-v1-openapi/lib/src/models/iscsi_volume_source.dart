...
final class IscsiVolumeSource {
  ...
  IscsiVolumeSource copyWith({
    ...
    LocalObjectReference Function()? secretRef,
    String? targetPortal,
  }) {
    return IscsiVolumeSource(
  ...
  @override
  String toString() {
    return 'IscsiVolumeSource(chapAuthDiscovery: $chapAuthDiscovery, chapAuthSession: $chapAuthSession, fsType: $fsType, initiatorName: $initiatorName, iqn: $iqn, iscsiInterface: $iscsiInterface, lun: $lun, portals: $portals, readOnly: $readOnly, secretRef: $secretRef, targetPortal: $targetPortal)';
  }
}
