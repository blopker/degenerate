...
final class CsiVolumeSource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('driver') && json['driver'] is String;
  }

  CsiVolumeSource copyWith({
    String? driver,
    String Function()? fsType,
    LocalObjectReference Function()? nodePublishSecretRef,
