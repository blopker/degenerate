...
final class HttpGetAction {
  ...
  HttpGetAction copyWith({
    String Function()? host,
    List<HttpHeader> Function()? httpHeaders,
  ...
  int get hashCode {
    return Object.hash(
      host,
      Object.hashAll(httpHeaders ?? const []),
      path,
      port,
      scheme,
    );
  ...
  @override
  String toString() {
    return 'HttpGetAction(host: $host, httpHeaders: $httpHeaders, path: $path, port: $port, scheme: $scheme)';
  }
}
