...
import 'package:collection/collection.dart';import 'http_header.dart';import 'io_k8s_apimachinery_pkg_util_intstr_int_or_string.dart';/// HTTPGetAction describes an action based on HTTP Get requests.
...
factory HttpGetAction.fromJson(Map<String, dynamic> json) { return HttpGetAction(
  ...
  port: IoK8sApimachineryPkgUtilIntstrIntOrString.fromJson(json['port'] as Map<String, dynamic>),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is HttpGetAction &&
          host == other.host &&
          const ListEquality<dynamic>().equals(httpHeaders, other.httpHeaders) &&
          path == other.path &&
          port == other.port &&
          scheme == other.scheme; } 
