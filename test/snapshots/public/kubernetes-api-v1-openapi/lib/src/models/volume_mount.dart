...
final class VolumeMount {
  ...
  VolumeMount copyWith({
    String? mountPath,
    String Function()? mountPropagation,
    String? name,
    bool Function()? readOnly,
    String Function()? recursiveReadOnly,
    String Function()? subPath,
    String Function()? subPathExpr,
  }) {
    return VolumeMount(
  ...
  @override
  String toString() {
    return 'VolumeMount(mountPath: $mountPath, mountPropagation: $mountPropagation, name: $name, readOnly: $readOnly, recursiveReadOnly: $recursiveReadOnly, subPath: $subPath, subPathExpr: $subPathExpr)';
  }
}
