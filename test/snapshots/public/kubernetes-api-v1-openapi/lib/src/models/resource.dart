...
final class Resource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('kind') &&
        ...
        json['name'] is String &&
        json.containsKey('namespaced') &&
        json['namespaced'] is bool &&
        json.containsKey('singularName') &&
        json['singularName'] is String &&
  ...
  Resource copyWith({
    ...
    String? name,
    bool? namespaced,
    List<String> Function()? shortNames,
    String? singularName,
    String Function()? storageVersionHash,
    List<String>? verbs,
    ...
    return Resource(
      ...
      storageVersionHash: storageVersionHash != null
          ? storageVersionHash()
          : this.storageVersionHash,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is Resource &&
            ...
            const ListEquality<dynamic>().equals(verbs, other.verbs) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      name,
      namespaced,
      Object.hashAll(shortNames ?? const []),
      singularName,
      storageVersionHash,
      Object.hashAll(verbs),
      version,
    );
  }
  ...
  @override
  String toString() {
    return 'Resource(categories: $categories, group: $group, kind: $kind, name: $name, namespaced: $namespaced, shortNames: $shortNames, singularName: $singularName, storageVersionHash: $storageVersionHash, verbs: $verbs, version: $version)';
  }
}
