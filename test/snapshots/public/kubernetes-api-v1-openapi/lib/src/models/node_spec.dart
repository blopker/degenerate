...
final class NodeSpec {
  ...
  NodeSpec copyWith({
    NodeConfigSource Function()? configSource,
    String Function()? externalId,
    String Function()? podCidr,
    List<String> Function()? podCidRs,
    String Function()? providerId,
    List<Taint> Function()? taints,
    bool Function()? unschedulable,
  }) {
    return NodeSpec(
      ...
      unschedulable: unschedulable != null
          ? unschedulable()
          : this.unschedulable,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is NodeSpec &&
            ...
            const ListEquality<dynamic>().equals(podCidRs, other.podCidRs) &&
            providerId == other.providerId &&
            const ListEquality<dynamic>().equals(taints, other.taints) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      externalId,
      podCidr,
      Object.hashAll(podCidRs ?? const []),
      providerId,
      Object.hashAll(taints ?? const []),
      unschedulable,
    );
  }
  ...
  @override
  String toString() {
    return 'NodeSpec(configSource: $configSource, externalId: $externalId, podCidr: $podCidr, podCidRs: $podCidRs, providerId: $providerId, taints: $taints, unschedulable: $unschedulable)';
  }
}
