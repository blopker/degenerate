...
final class VolumeProjection {
  ...
  factory VolumeProjection.fromJson(Map<String, dynamic> json) {
    return VolumeProjection(
      ...
      podCertificate: json['podCertificate'] != null
          ? PodCertificateProjection.fromJson(
              json['podCertificate'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      if (clusterTrustBundle != null)
        'clusterTrustBundle': clusterTrustBundle?.toJson(),
  ...
  VolumeProjection copyWith({
    ClusterTrustBundleProjection Function()? clusterTrustBundle,
    ConfigMapProjection Function()? configMap,
    Projection Function()? downwardApi,
    PodCertificateProjection Function()? podCertificate,
    SecretProjection Function()? secret,
    ServiceAccountTokenProjection Function()? serviceAccountToken,
  }) {
    return VolumeProjection(
      clusterTrustBundle: clusterTrustBundle != null
          ? clusterTrustBundle()
          : this.clusterTrustBundle,
      configMap: configMap != null ? configMap() : this.configMap,
      downwardApi: downwardApi != null ? downwardApi() : this.downwardApi,
      podCertificate: podCertificate != null
          ? podCertificate()
          : this.podCertificate,
      secret: secret != null ? secret() : this.secret,
      serviceAccountToken: serviceAccountToken != null
          ? serviceAccountToken()
          : this.serviceAccountToken,
    );
  }
  ...
  @override
  String toString() {
    return 'VolumeProjection(clusterTrustBundle: $clusterTrustBundle, configMap: $configMap, downwardApi: $downwardApi, podCertificate: $podCertificate, secret: $secret, serviceAccountToken: $serviceAccountToken)';
  }
}
