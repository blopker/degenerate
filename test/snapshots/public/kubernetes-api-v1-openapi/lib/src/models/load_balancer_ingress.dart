...
final class LoadBalancerIngress {
  const LoadBalancerIngress({this.hostname, this.ip, this.ipMode, this.ports});
  ...
  LoadBalancerIngress copyWith({
    String Function()? hostname,
    String Function()? ip,
    String Function()? ipMode,
    List<PortStatus> Function()? ports,
  }) {
    return LoadBalancerIngress(
  ...
  @override
  int get hashCode {
    return Object.hash(hostname, ip, ipMode, Object.hashAll(ports ?? const []));
  }
