...
final class ProjectedVolumeSource {
  const ProjectedVolumeSource({this.defaultMode, this.sources});
  ...
  ProjectedVolumeSource copyWith({
    int Function()? defaultMode,
    List<VolumeProjection> Function()? sources,
  }) {
    return ProjectedVolumeSource(
  ...
  @override
  int get hashCode {
    return Object.hash(defaultMode, Object.hashAll(sources ?? const []));
  }
