...
final class Probe {
  ...
  factory Probe.fromJson(Map<String, dynamic> json) {
    return Probe(
      exec: json['exec'] != null
          ...
          : null,
      failureThreshold: json['failureThreshold'] != null
          ? (json['failureThreshold'] as num).toInt()
          : null,
      grpc: json['grpc'] != null
      ...
      httpGet: json['httpGet'] != null
          ...
          : null,
      initialDelaySeconds: json['initialDelaySeconds'] != null
          ? (json['initialDelaySeconds'] as num).toInt()
          : null,
      periodSeconds: json['periodSeconds'] != null
          ? (json['periodSeconds'] as num).toInt()
          : null,
      successThreshold: json['successThreshold'] != null
          ? (json['successThreshold'] as num).toInt()
          : null,
  ...
  Probe copyWith({
    ...
    int Function()? failureThreshold,
    GrpcAction Function()? grpc,
    HttpGetAction Function()? httpGet,
    int Function()? initialDelaySeconds,
    int Function()? periodSeconds,
    int Function()? successThreshold,
    ...
    return Probe(
      ...
      failureThreshold: failureThreshold != null
          ? failureThreshold()
          : this.failureThreshold,
      grpc: grpc != null ? grpc() : this.grpc,
      httpGet: httpGet != null ? httpGet() : this.httpGet,
      initialDelaySeconds: initialDelaySeconds != null
          ? initialDelaySeconds()
          : this.initialDelaySeconds,
