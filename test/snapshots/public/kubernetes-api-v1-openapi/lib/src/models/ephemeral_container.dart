...
final class EphemeralContainer {
  ...
  factory EphemeralContainer.fromJson(Map<String, dynamic> json) {
    return EphemeralContainer(
      ...
      restartPolicyRules: (json['restartPolicyRules'] as List<dynamic>?)
          ?.map((e) => ContainerRestartRule.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (resizePolicy != null)
        'resizePolicy': resizePolicy?.map((e) => e.toJson()).toList(),
      ...
      if (volumeDevices != null)
        'volumeDevices': volumeDevices?.map((e) => e.toJson()).toList(),
  ...
  EphemeralContainer copyWith({
    List<String> Function()? args,
    List<String> Function()? command,
    List<EnvVar> Function()? env,
    List<EnvFromSource> Function()? envFrom,
    String Function()? image,
    String Function()? imagePullPolicy,
    Lifecycle Function()? lifecycle,
    Probe Function()? livenessProbe,
    String? name,
    List<ContainerPort> Function()? ports,
    Probe Function()? readinessProbe,
    List<ContainerResizePolicy> Function()? resizePolicy,
    ResourceRequirements Function()? resources,
    String Function()? restartPolicy,
    List<ContainerRestartRule> Function()? restartPolicyRules,
    SecurityContext Function()? securityContext,
    Probe Function()? startupProbe,
    bool Function()? stdin,
    bool Function()? stdinOnce,
    String Function()? targetContainerName,
    String Function()? terminationMessagePath,
    String Function()? terminationMessagePolicy,
    bool Function()? tty,
    List<VolumeDevice> Function()? volumeDevices,
    List<VolumeMount> Function()? volumeMounts,
    ...
    return EphemeralContainer(
      ...
      restartPolicy: restartPolicy != null
          ? restartPolicy()
          : this.restartPolicy,
      restartPolicyRules: restartPolicyRules != null
          ? restartPolicyRules()
          : this.restartPolicyRules,
      ...
      targetContainerName: targetContainerName != null
          ? targetContainerName()
          : this.targetContainerName,
      terminationMessagePath: terminationMessagePath != null
          ? terminationMessagePath()
          : this.terminationMessagePath,
      terminationMessagePolicy: terminationMessagePolicy != null
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is EphemeralContainer &&
            const ListEquality<dynamic>().equals(args, other.args) &&
            const ListEquality<dynamic>().equals(command, other.command) &&
            const ListEquality<dynamic>().equals(env, other.env) &&
            const ListEquality<dynamic>().equals(envFrom, other.envFrom) &&
            image == other.image &&
  ...
  int get hashCode {
    return Object.hashAll([
      Object.hashAll(args ?? const []),
      Object.hashAll(command ?? const []),
      Object.hashAll(env ?? const []),
      Object.hashAll(envFrom ?? const []),
      image,
      imagePullPolicy,
      lifecycle,
      livenessProbe,
      ...
      readinessProbe,
      Object.hashAll(resizePolicy ?? const []),
      resources,
      restartPolicy,
      Object.hashAll(restartPolicyRules ?? const []),
      securityContext,
      startupProbe,
      stdin,
      stdinOnce,
      ...
      terminationMessagePolicy,
      tty,
      Object.hashAll(volumeDevices ?? const []),
      Object.hashAll(volumeMounts ?? const []),
      workingDir,
    ]);
  }
