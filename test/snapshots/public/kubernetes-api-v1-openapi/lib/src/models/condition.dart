...
final class Condition {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('lastTransitionTime') &&
        json['lastTransitionTime'] is String &&
  ...
  @override
  String toString() {
    return 'Condition(lastTransitionTime: $lastTransitionTime, message: $message, observedGeneration: $observedGeneration, reason: $reason, status: $status, type: $type)';
  }
}
