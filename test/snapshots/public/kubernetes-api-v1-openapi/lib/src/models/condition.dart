...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('lastTransitionTime') && json['lastTransitionTime'] is String &&
      json.containsKey('message') && json['message'] is String &&
      json.containsKey('reason') && json['reason'] is String &&
      json.containsKey('status') && json['status'] is String &&
      json.containsKey('type') && json['type'] is String; } 
Condition copyWith({DateTime? lastTransitionTime, String? message, int Function()? observedGeneration, String? reason, String? status, String? type, }) { return Condition(
