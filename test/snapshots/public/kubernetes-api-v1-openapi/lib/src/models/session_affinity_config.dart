...
import 'client_ip_config.dart';

/// SessionAffinityConfig represents the configurations of session affinity.
final class SessionAffinityConfig {
  const SessionAffinityConfig({this.clientIp});
  ...
  SessionAffinityConfig copyWith({ClientIpConfig Function()? clientIp}) {
    return SessionAffinityConfig(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is SessionAffinityConfig && clientIp == other.clientIp;
  }
