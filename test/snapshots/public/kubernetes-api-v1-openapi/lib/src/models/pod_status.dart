...
import 'package:collection/collection.dart';import 'container_status.dart';import 'host_ip.dart';import 'pod_condition.dart';import 'pod_extended_resource_claim_status.dart';import 'pod_ip.dart';import 'pod_resource_claim_status.dart';import 'resource_quantity.dart';import 'resource_requirements.dart';/// PodStatus represents information about the status of a pod. Status may trail the actual state of a system, especially if the node that hosts the pod cannot contact the control plane.
...
factory PodStatus.fromJson(Map<String, dynamic> json) { return PodStatus(
  allocatedResources: (json['allocatedResources'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, ResourceQuantity.fromJson(v as Map<String, dynamic>))),
...
PodStatus copyWith({Map<String, ResourceQuantity> Function()? allocatedResources, List<PodCondition> Function()? conditions, List<ContainerStatus> Function()? containerStatuses, List<ContainerStatus> Function()? ephemeralContainerStatuses, PodExtendedResourceClaimStatus Function()? extendedResourceClaimStatus, String Function()? hostIp, List<HostIp> Function()? hostIPs, List<ContainerStatus> Function()? initContainerStatuses, String Function()? message, String Function()? nominatedNodeName, int Function()? observedGeneration, String Function()? phase, String Function()? podIp, List<PodIp> Function()? podIPs, String Function()? qosClass, String Function()? reason, String Function()? resize, List<PodResourceClaimStatus> Function()? resourceClaimStatuses, ResourceRequirements Function()? resources, DateTime Function()? startTime, }) { return PodStatus(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PodStatus &&
          ...
          const ListEquality<dynamic>().equals(containerStatuses, other.containerStatuses) &&
          const ListEquality<dynamic>().equals(ephemeralContainerStatuses, other.ephemeralContainerStatuses) &&
          extendedResourceClaimStatus == other.extendedResourceClaimStatus &&
          hostIp == other.hostIp &&
          const ListEquality<dynamic>().equals(hostIPs, other.hostIPs) &&
          const ListEquality<dynamic>().equals(initContainerStatuses, other.initContainerStatuses) &&
          ...
          reason == other.reason &&
          resize == other.resize &&
          const ListEquality<dynamic>().equals(resourceClaimStatuses, other.resourceClaimStatuses) &&
