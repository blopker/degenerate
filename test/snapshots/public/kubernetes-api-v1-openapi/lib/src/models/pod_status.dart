...
final class PodStatus {
    ...
    return PodStatus(
      allocatedResources: (json['allocatedResources'] as Map<String, dynamic>?)
          ?.map(
            (k, v) => MapEntry(
              k,
              ResourceQuantity.fromJson(v as Map<String, dynamic>),
            ),
          ),
      ...
      extendedResourceClaimStatus: json['extendedResourceClaimStatus'] != null
          ? PodExtendedResourceClaimStatus.fromJson(
      ...
      observedGeneration: json['observedGeneration'] != null
          ? (json['observedGeneration'] as num).toInt()
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      if (allocatedResources != null)
        'allocatedResources': allocatedResources?.map(
      ...
      if (extendedResourceClaimStatus != null)
        'extendedResourceClaimStatus': extendedResourceClaimStatus?.toJson(),
      'hostIP': ?hostIp,
  ...
  PodStatus copyWith({
    Map<String, ResourceQuantity> Function()? allocatedResources,
    List<PodCondition> Function()? conditions,
    List<ContainerStatus> Function()? containerStatuses,
    List<ContainerStatus> Function()? ephemeralContainerStatuses,
    PodExtendedResourceClaimStatus Function()? extendedResourceClaimStatus,
    String Function()? hostIp,
    List<HostIp> Function()? hostIPs,
    List<ContainerStatus> Function()? initContainerStatuses,
    String Function()? message,
    String Function()? nominatedNodeName,
    int Function()? observedGeneration,
    String Function()? phase,
    String Function()? podIp,
    List<PodIp> Function()? podIPs,
    String Function()? qosClass,
    String Function()? reason,
    String Function()? resize,
    List<PodResourceClaimStatus> Function()? resourceClaimStatuses,
    ...
    return PodStatus(
      ...
      containerStatuses: containerStatuses != null
          ? containerStatuses()
          : this.containerStatuses,
      ephemeralContainerStatuses: ephemeralContainerStatuses != null
          ? ephemeralContainerStatuses()
          : this.ephemeralContainerStatuses,
      extendedResourceClaimStatus: extendedResourceClaimStatus != null
          ? extendedResourceClaimStatus()
          : this.extendedResourceClaimStatus,
      hostIp: hostIp != null ? hostIp() : this.hostIp,
      hostIPs: hostIPs != null ? hostIPs() : this.hostIPs,
      initContainerStatuses: initContainerStatuses != null
          ? initContainerStatuses()
          : this.initContainerStatuses,
      message: message != null ? message() : this.message,
      nominatedNodeName: nominatedNodeName != null
          ? nominatedNodeName()
          : this.nominatedNodeName,
      ...
      resourceClaimStatuses: resourceClaimStatuses != null
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PodStatus &&
            ...
            const ListEquality<dynamic>().equals(
              containerStatuses,
              other.containerStatuses,
            ) &&
            const ListEquality<dynamic>().equals(
              ephemeralContainerStatuses,
              other.ephemeralContainerStatuses,
            ) &&
            extendedResourceClaimStatus == other.extendedResourceClaimStatus &&
            hostIp == other.hostIp &&
            const ListEquality<dynamic>().equals(hostIPs, other.hostIPs) &&
            const ListEquality<dynamic>().equals(
              initContainerStatuses,
              other.initContainerStatuses,
            ) &&
            ...
            phase == other.phase &&
            podIp == other.podIp &&
            const ListEquality<dynamic>().equals(podIPs, other.podIPs) &&
            qosClass == other.qosClass &&
            reason == other.reason &&
            resize == other.resize &&
            const ListEquality<dynamic>().equals(
              resourceClaimStatuses,
              other.resourceClaimStatuses,
            ) &&
  ...
  int get hashCode {
    return Object.hash(
      allocatedResources,
      Object.hashAll(conditions ?? const []),
      Object.hashAll(containerStatuses ?? const []),
      Object.hashAll(ephemeralContainerStatuses ?? const []),
      extendedResourceClaimStatus,
      hostIp,
      Object.hashAll(hostIPs ?? const []),
      Object.hashAll(initContainerStatuses ?? const []),
      message,
      nominatedNodeName,
      observedGeneration,
      phase,
      podIp,
      Object.hashAll(podIPs ?? const []),
      qosClass,
      reason,
      resize,
      Object.hashAll(resourceClaimStatuses ?? const []),
      resources,
      startTime,
    );
  }
