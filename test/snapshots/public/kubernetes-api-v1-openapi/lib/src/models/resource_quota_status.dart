...
import 'resource_quantity.dart';/// ResourceQuotaStatus defines the enforced hard limits and observed use.
...
factory ResourceQuotaStatus.fromJson(Map<String, dynamic> json) { return ResourceQuotaStatus(
  ...
  used: (json['used'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, ResourceQuantity.fromJson(v as Map<String, dynamic>))),
); }
