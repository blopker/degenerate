...
import 'managed_fields_entry.dart';
...
final class ObjectMeta {
  ...
  factory ObjectMeta.fromJson(Map<String, dynamic> json) {
    return ObjectMeta(
      ...
      creationTimestamp: json['creationTimestamp'] != null
          ...
          : null,
      deletionGracePeriodSeconds: json['deletionGracePeriodSeconds'] != null
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (managedFields != null)
        'managedFields': managedFields?.map((e) => e.toJson()).toList(),
      'name': ?name,
      'namespace': ?namespace,
  ...
  ObjectMeta copyWith({
    Map<String, String> Function()? annotations,
    DateTime Function()? creationTimestamp,
    int Function()? deletionGracePeriodSeconds,
    DateTime Function()? deletionTimestamp,
    List<String> Function()? finalizers,
    String Function()? generateName,
    int Function()? generation,
    Map<String, String> Function()? labels,
    List<ManagedFieldsEntry> Function()? managedFields,
    String Function()? name,
    String Function()? namespace,
    List<OwnerReference> Function()? ownerReferences,
    String Function()? resourceVersion,
    String Function()? selfLink,
    String Function()? uid,
  }) {
    return ObjectMeta(
      ...
      creationTimestamp: creationTimestamp != null
          ? creationTimestamp()
          : this.creationTimestamp,
      deletionGracePeriodSeconds: deletionGracePeriodSeconds != null
          ? deletionGracePeriodSeconds()
          : this.deletionGracePeriodSeconds,
      deletionTimestamp: deletionTimestamp != null
          ? deletionTimestamp()
          : this.deletionTimestamp,
  ...
  int get hashCode {
    return Object.hash(
      ...
      deletionGracePeriodSeconds,
      deletionTimestamp,
      Object.hashAll(finalizers ?? const []),
      generateName,
      generation,
      labels,
      Object.hashAll(managedFields ?? const []),
      name,
      namespace,
      Object.hashAll(ownerReferences ?? const []),
      resourceVersion,
      selfLink,
      uid,
    );
