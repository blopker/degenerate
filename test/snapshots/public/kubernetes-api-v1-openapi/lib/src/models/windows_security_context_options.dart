...
final class WindowsSecurityContextOptions {
  ...
  WindowsSecurityContextOptions copyWith({
    String Function()? gmsaCredentialSpec,
    String Function()? gmsaCredentialSpecName,
    bool Function()? hostProcess,
    String Function()? runAsUserName,
  }) {
    return WindowsSecurityContextOptions(
      gmsaCredentialSpec: gmsaCredentialSpec != null
          ? gmsaCredentialSpec()
          : this.gmsaCredentialSpec,
      gmsaCredentialSpecName: gmsaCredentialSpecName != null
          ? gmsaCredentialSpecName()
          : this.gmsaCredentialSpecName,
      hostProcess: hostProcess != null ? hostProcess() : this.hostProcess,
      runAsUserName: runAsUserName != null
          ? runAsUserName()
          : this.runAsUserName,
    );
  }
