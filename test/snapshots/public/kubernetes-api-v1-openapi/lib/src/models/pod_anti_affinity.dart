...
final class PodAntiAffinity {
  ...
  PodAntiAffinity copyWith({
    List<WeightedPodAffinityTerm> Function()?
    preferredDuringSchedulingIgnoredDuringExecution,
    List<PodAffinityTerm> Function()?
    requiredDuringSchedulingIgnoredDuringExecution,
  }) {
    return PodAntiAffinity(
      preferredDuringSchedulingIgnoredDuringExecution:
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(
        preferredDuringSchedulingIgnoredDuringExecution ?? const [],
      ),
      Object.hashAll(
        requiredDuringSchedulingIgnoredDuringExecution ?? const [],
      ),
    );
  }
