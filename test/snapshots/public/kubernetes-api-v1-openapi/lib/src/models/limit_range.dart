...
final class LimitRange {
  const LimitRange({this.apiVersion, this.kind, this.metadata, this.spec});
  ...
  @override
  int get hashCode {
    return Object.hash(apiVersion, kind, metadata, spec);
  }
