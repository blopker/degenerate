...
final class ModifyVolumeStatus {
  ...
  ModifyVolumeStatus copyWith({
    String? status,
    String Function()? targetVolumeAttributesClassName,
  }) {
    return ModifyVolumeStatus(
      status: status ?? this.status,
      targetVolumeAttributesClassName: targetVolumeAttributesClassName != null
          ? targetVolumeAttributesClassName()
          : this.targetVolumeAttributesClassName,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(status, targetVolumeAttributesClassName);
  }
