...
final class ContainerStatus {
  ...
  factory ContainerStatus.fromJson(Map<String, dynamic> json) {
    return ContainerStatus(
      ...
      allocatedResourcesStatus:
          (json['allocatedResourcesStatus'] as List<dynamic>?)
      ...
      volumeMounts: (json['volumeMounts'] as List<dynamic>?)
          ?.map((e) => VolumeMountStatus.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('image') &&
        ...
        json.containsKey('imageID') &&
        json['imageID'] is String &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('ready') &&
        json['ready'] is bool &&
        json.containsKey('restartCount') &&
        json['restartCount'] is num;
  }

  ContainerStatus copyWith({
    Map<String, ResourceQuantity> Function()? allocatedResources,
    List<ResourceStatus> Function()? allocatedResourcesStatus,
    String Function()? containerId,
    String? image,
    String? imageId,
    ContainerState Function()? lastState,
    String? name,
    bool? ready,
    ResourceRequirements Function()? resources,
    int? restartCount,
    bool Function()? started,
    ContainerState Function()? state,
    String Function()? stopSignal,
    ContainerUser Function()? user,
    List<VolumeMountStatus> Function()? volumeMounts,
  }) {
    return ContainerStatus(
      allocatedResources: allocatedResources != null
          ? allocatedResources()
          : this.allocatedResources,
      allocatedResourcesStatus: allocatedResourcesStatus != null
          ? allocatedResourcesStatus()
          : this.allocatedResourcesStatus,
    ...
    return identical(this, other) ||
        other is ContainerStatus &&
            ...
            const ListEquality<dynamic>().equals(
              allocatedResourcesStatus,
              other.allocatedResourcesStatus,
            ) &&
  ...
  int get hashCode {
    return Object.hash(
      allocatedResources,
      Object.hashAll(allocatedResourcesStatus ?? const []),
      containerId,
      image,
      imageId,
      lastState,
  ...
  @override
  String toString() {
    return 'ContainerStatus(allocatedResources: $allocatedResources, allocatedResourcesStatus: $allocatedResourcesStatus, containerId: $containerId, image: $image, imageId: $imageId, lastState: $lastState, name: $name, ready: $ready, resources: $resources, restartCount: $restartCount, started: $started, state: $state, stopSignal: $stopSignal, user: $user, volumeMounts: $volumeMounts)';
  }
}
