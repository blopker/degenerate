...
final class GlusterfsVolumeSource {
  ...
  Map<String, dynamic> toJson() {
    return {'endpoints': endpoints, 'path': path, 'readOnly': ?readOnly};
  }
  ...
  GlusterfsVolumeSource copyWith({
    String? endpoints,
    String? path,
  ...
  @override
  int get hashCode {
    return Object.hash(endpoints, path, readOnly);
  }
