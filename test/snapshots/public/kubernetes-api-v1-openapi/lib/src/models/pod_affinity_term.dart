...
final class PodAffinityTerm {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('topologyKey') && json['topologyKey'] is String;
  }

  PodAffinityTerm copyWith({
    LabelSelector Function()? labelSelector,
    List<String> Function()? matchLabelKeys,
    List<String> Function()? mismatchLabelKeys,
    LabelSelector Function()? namespaceSelector,
    List<String> Function()? namespaces,
    String? topologyKey,
  }) {
    return PodAffinityTerm(
      ...
      matchLabelKeys: matchLabelKeys != null
          ? matchLabelKeys()
          : this.matchLabelKeys,
      mismatchLabelKeys: mismatchLabelKeys != null
          ? mismatchLabelKeys()
          : this.mismatchLabelKeys,
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(mismatchLabelKeys ?? const []),
      namespaceSelector,
      Object.hashAll(namespaces ?? const []),
      topologyKey,
    );
  }
  ...
  @override
  String toString() {
    return 'PodAffinityTerm(labelSelector: $labelSelector, matchLabelKeys: $matchLabelKeys, mismatchLabelKeys: $mismatchLabelKeys, namespaceSelector: $namespaceSelector, namespaces: $namespaces, topologyKey: $topologyKey)';
  }
}
