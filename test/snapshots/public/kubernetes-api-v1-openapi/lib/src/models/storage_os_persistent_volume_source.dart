...
final class StorageOsPersistentVolumeSource {
  ...
  StorageOsPersistentVolumeSource copyWith({
    String Function()? fsType,
    bool Function()? readOnly,
    ObjectReference Function()? secretRef,
    String Function()? volumeName,
    String Function()? volumeNamespace,
  }) {
    return StorageOsPersistentVolumeSource(
      ...
      volumeNamespace: volumeNamespace != null
          ? volumeNamespace()
          : this.volumeNamespace,
    );
  }
