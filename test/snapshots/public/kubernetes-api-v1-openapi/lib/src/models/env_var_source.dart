...
final class EnvVarSource {
  ...
  EnvVarSource copyWith({
    ConfigMapKeySelector Function()? configMapKeyRef,
    ObjectFieldSelector Function()? fieldRef,
    FileKeySelector Function()? fileKeyRef,
    ResourceFieldSelector Function()? resourceFieldRef,
    SecretKeySelector Function()? secretKeyRef,
  }) {
    return EnvVarSource(
  ...
  @override
  String toString() {
    return 'EnvVarSource(configMapKeyRef: $configMapKeyRef, fieldRef: $fieldRef, fileKeyRef: $fileKeyRef, resourceFieldRef: $resourceFieldRef, secretKeyRef: $secretKeyRef)';
  }
}
