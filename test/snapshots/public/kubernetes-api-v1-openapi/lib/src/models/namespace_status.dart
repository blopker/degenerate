...
final class NamespaceStatus {
  const NamespaceStatus({this.conditions, this.phase});
  ...
  NamespaceStatus copyWith({
    List<NamespaceCondition> Function()? conditions,
  ...
  @override
  int get hashCode {
    return Object.hash(Object.hashAll(conditions ?? const []), phase);
  }
