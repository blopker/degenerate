...
final class PersistentVolumeClaimTemplate {
  const PersistentVolumeClaimTemplate({this.metadata, required this.spec});
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('spec');
  }

  PersistentVolumeClaimTemplate copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(metadata, spec);
  }
