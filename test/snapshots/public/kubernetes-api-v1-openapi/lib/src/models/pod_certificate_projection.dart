...
final class PodCertificateProjection {
  ...
  factory PodCertificateProjection.fromJson(Map<String, dynamic> json) {
    return PodCertificateProjection(
      ...
      maxExpirationSeconds: json['maxExpirationSeconds'] != null
          ? (json['maxExpirationSeconds'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('keyType') &&
        json['keyType'] is String &&
        json.containsKey('signerName') &&
        json['signerName'] is String;
  }

  PodCertificateProjection copyWith({
    String Function()? certificateChainPath,
    String Function()? credentialBundlePath,
    String Function()? keyPath,
    String? keyType,
    int Function()? maxExpirationSeconds,
    String? signerName,
    Map<String, String> Function()? userAnnotations,
  }) {
    return PodCertificateProjection(
      certificateChainPath: certificateChainPath != null
          ? certificateChainPath()
          : this.certificateChainPath,
      credentialBundlePath: credentialBundlePath != null
          ? credentialBundlePath()
          : this.credentialBundlePath,
      keyPath: keyPath != null ? keyPath() : this.keyPath,
      keyType: keyType ?? this.keyType,
      maxExpirationSeconds: maxExpirationSeconds != null
  ...
  @override
  String toString() {
    return 'PodCertificateProjection(certificateChainPath: $certificateChainPath, credentialBundlePath: $credentialBundlePath, keyPath: $keyPath, keyType: $keyType, maxExpirationSeconds: $maxExpirationSeconds, signerName: $signerName, userAnnotations: $userAnnotations)';
  }
}
