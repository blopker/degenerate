...
final class TokenRequest {
  ...
  TokenRequest copyWith({
    ...
    TokenRequestSpec Function()? spec,
    TokenRequestStatus Function()? status,
  }) {
    return TokenRequest(
  ...
  @override
  String toString() {
    return 'TokenRequest(apiVersion: $apiVersion, kind: $kind, metadata: $metadata, spec: $spec, status: $status)';
  }
}
