...
final class PersistentVolumeList {
  ...
  @override
  String toString() {
    return 'PersistentVolumeList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)';
  }
}
