...
final class LabelSelector {
  const LabelSelector({this.matchExpressions, this.matchLabels});
  ...
  LabelSelector copyWith({
    List<LabelSelectorRequirement> Function()? matchExpressions,
    Map<String, String> Function()? matchLabels,
  }) {
    return LabelSelector(
