...
final class ReplicationControllerList {
  ...
  ReplicationControllerList copyWith({
  ...
  @override
  String toString() {
    return 'ReplicationControllerList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)';
  }
}
