...
final class ScaleIoPersistentVolumeSource {
  const ScaleIoPersistentVolumeSource({
    ...
    this.sslEnabled,
    this.storageMode = 'ThinProvisioned',
    this.storagePool,
    this.system = '',
    this.volumeName,
  });
  ...
  factory ScaleIoPersistentVolumeSource.fromJson(Map<String, dynamic> json) {
    return ScaleIoPersistentVolumeSource(
      ...
      storageMode: json.containsKey('storageMode')
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('gateway') &&
        json['gateway'] is String &&
        json.containsKey('secretRef') &&
        json.containsKey('system') &&
        json['system'] is String;
  }

  ScaleIoPersistentVolumeSource copyWith({
    String Function()? fsType,
    String? gateway,
    String Function()? protectionDomain,
    bool Function()? readOnly,
    SecretReference? secretRef,
    bool Function()? sslEnabled,
    String Function()? storageMode,
    String Function()? storagePool,
    String? system,
    String Function()? volumeName,
  }) {
    return ScaleIoPersistentVolumeSource(
  ...
  @override
  String toString() {
    return 'ScaleIoPersistentVolumeSource(fsType: $fsType, gateway: $gateway, protectionDomain: $protectionDomain, readOnly: $readOnly, secretRef: $secretRef, sslEnabled: $sslEnabled, storageMode: $storageMode, storagePool: $storagePool, system: $system, volumeName: $volumeName)';
  }
}
