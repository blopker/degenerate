...
final class CinderVolumeSource {
  ...
  @override
  String toString() {
    return 'CinderVolumeSource(fsType: $fsType, readOnly: $readOnly, secretRef: $secretRef, volumeId: $volumeId)';
  }
}
