...
final class NodeAffinity {
  ...
  NodeAffinity copyWith({
    List<PreferredSchedulingTerm> Function()?
    preferredDuringSchedulingIgnoredDuringExecution,
    NodeSelector Function()? requiredDuringSchedulingIgnoredDuringExecution,
  }) {
    return NodeAffinity(
      preferredDuringSchedulingIgnoredDuringExecution:
