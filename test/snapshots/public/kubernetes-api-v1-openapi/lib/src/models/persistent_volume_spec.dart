...
import 'rbd_persistent_volume_source.dart';
import 'resource_quantity.dart';
import 'scale_io_persistent_volume_source.dart';
import 'storage_os_persistent_volume_source.dart';
import 'volume_node_affinity.dart';
import 'vsphere_virtual_disk_volume_source.dart';

/// PersistentVolumeSpec is the specification of a persistent volume.
final class PersistentVolumeSpec {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (capacity != null)
        'capacity': capacity?.map((k, v) => MapEntry(k, v.toJson())),
      ...
      if (photonPersistentDisk != null)
        'photonPersistentDisk': photonPersistentDisk?.toJson(),
  ...
  PersistentVolumeSpec copyWith({
    List<String> Function()? accessModes,
    AwsElasticBlockStoreVolumeSource Function()? awsElasticBlockStore,
    AzureDiskVolumeSource Function()? azureDisk,
    AzureFilePersistentVolumeSource Function()? azureFile,
    Map<String, ResourceQuantity> Function()? capacity,
    CephFsPersistentVolumeSource Function()? cephfs,
    CinderPersistentVolumeSource Function()? cinder,
    ObjectReference Function()? claimRef,
    CsiPersistentVolumeSource Function()? csi,
    FcVolumeSource Function()? fc,
    FlexPersistentVolumeSource Function()? flexVolume,
    FlockerVolumeSource Function()? flocker,
    GcePersistentDiskVolumeSource Function()? gcePersistentDisk,
    GlusterfsPersistentVolumeSource Function()? glusterfs,
    HostPathVolumeSource Function()? hostPath,
    IscsiPersistentVolumeSource Function()? iscsi,
    LocalVolumeSource Function()? local,
    List<String> Function()? mountOptions,
    NfsVolumeSource Function()? nfs,
    VolumeNodeAffinity Function()? nodeAffinity,
    String Function()? persistentVolumeReclaimPolicy,
    PhotonPersistentDiskVolumeSource Function()? photonPersistentDisk,
    PortworxVolumeSource Function()? portworxVolume,
    QuobyteVolumeSource Function()? quobyte,
    RbdPersistentVolumeSource Function()? rbd,
    ScaleIoPersistentVolumeSource Function()? scaleIo,
    String Function()? storageClassName,
    StorageOsPersistentVolumeSource Function()? storageos,
    String Function()? volumeAttributesClassName,
    String Function()? volumeMode,
    VsphereVirtualDiskVolumeSource Function()? vsphereVolume,
  }) {
    return PersistentVolumeSpec(
      ...
      gcePersistentDisk: gcePersistentDisk != null
          ? gcePersistentDisk()
          : this.gcePersistentDisk,
      ...
      persistentVolumeReclaimPolicy: persistentVolumeReclaimPolicy != null
          ? persistentVolumeReclaimPolicy()
          : this.persistentVolumeReclaimPolicy,
      photonPersistentDisk: photonPersistentDisk != null
          ? photonPersistentDisk()
          : this.photonPersistentDisk,
      portworxVolume: portworxVolume != null
          ? portworxVolume()
          : this.portworxVolume,
      ...
      volumeAttributesClassName: volumeAttributesClassName != null
          ? volumeAttributesClassName()
          : this.volumeAttributesClassName,
      volumeMode: volumeMode != null ? volumeMode() : this.volumeMode,
      vsphereVolume: vsphereVolume != null
          ? vsphereVolume()
          : this.vsphereVolume,
    );
  }
  ...
  int get hashCode {
    return Object.hashAll([
      Object.hashAll(accessModes ?? const []),
      awsElasticBlockStore,
      azureDisk,
      azureFile,
      capacity,
      ...
      iscsi,
      local,
      Object.hashAll(mountOptions ?? const []),
      nfs,
      nodeAffinity,
      persistentVolumeReclaimPolicy,
      photonPersistentDisk,
