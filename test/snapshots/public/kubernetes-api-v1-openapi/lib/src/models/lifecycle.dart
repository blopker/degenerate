...
final class Lifecycle {
  const Lifecycle({this.postStart, this.preStop, this.stopSignal});
  ...
  Lifecycle copyWith({
    LifecycleHandler Function()? postStart,
    LifecycleHandler Function()? preStop,
  ...
  @override
  int get hashCode {
    return Object.hash(postStart, preStop, stopSignal);
  }

  @override
  String toString() {
    return 'Lifecycle(postStart: $postStart, preStop: $preStop, stopSignal: $stopSignal)';
  }
}
