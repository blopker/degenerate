...
final class FileKeySelector {
  ...
  factory FileKeySelector.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('key') &&
        ...
        json['path'] is String &&
        json.containsKey('volumeName') &&
        json['volumeName'] is String;
  }

  FileKeySelector copyWith({
    String? key,
  ...
  @override
  int get hashCode {
    return Object.hash(key, optional, path, volumeName);
  }

  @override
  String toString() {
    return 'FileKeySelector(key: $key, optional: $optional, path: $path, volumeName: $volumeName)';
  }
}
