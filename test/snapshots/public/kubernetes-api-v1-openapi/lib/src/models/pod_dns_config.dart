...
final class PodDnsConfig {
  const PodDnsConfig({this.nameservers, this.options, this.searches});
  ...
  PodDnsConfig copyWith({
    List<String> Function()? nameservers,
    List<PodDnsConfigOption> Function()? options,
    List<String> Function()? searches,
  }) {
    return PodDnsConfig(
