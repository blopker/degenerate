...
final class PersistentVolumeClaimList {
  ...
  PersistentVolumeClaimList copyWith({
  ...
  @override
  String toString() {
    return 'PersistentVolumeClaimList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)';
  }
}
