...
final class FlockerVolumeSource {
  const FlockerVolumeSource({this.datasetName, this.datasetUuid});
  ...
  Map<String, dynamic> toJson() {
    return {'datasetName': ?datasetName, 'datasetUUID': ?datasetUuid};
  }
  ...
  FlockerVolumeSource copyWith({
    String Function()? datasetName,
    String Function()? datasetUuid,
  }) {
    return FlockerVolumeSource(
  ...
  @override
  int get hashCode {
    return Object.hash(datasetName, datasetUuid);
  }
