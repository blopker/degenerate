...
final class ContainerResizePolicy {
  ...
  Map<String, dynamic> toJson() {
    return {'resourceName': resourceName, 'restartPolicy': restartPolicy};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('resourceName') &&
        json['resourceName'] is String &&
        json.containsKey('restartPolicy') &&
        json['restartPolicy'] is String;
  }

  ContainerResizePolicy copyWith({
    String? resourceName,
  ...
  @override
  int get hashCode {
    return Object.hash(resourceName, restartPolicy);
  }
