...
final class AzureDiskVolumeSource {
  const AzureDiskVolumeSource({
    this.cachingMode = 'ReadWrite',
    this.diskName = '',
    this.diskUri = '',
    this.fsType = 'ext4',
    this.kind = 'Shared',
  ...
  factory AzureDiskVolumeSource.fromJson(Map<String, dynamic> json) {
    return AzureDiskVolumeSource(
      cachingMode: json.containsKey('cachingMode')
          ? json['cachingMode'] as String
          : 'ReadWrite',
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('diskName') &&
        json['diskName'] is String &&
        json.containsKey('diskURI') &&
        json['diskURI'] is String;
  }

  AzureDiskVolumeSource copyWith({
    String Function()? cachingMode,
    String? diskName,
    String? diskUri,
  ...
  @override
  int get hashCode {
    return Object.hash(cachingMode, diskName, diskUri, fsType, kind, readOnly);
  }

  @override
  String toString() {
    return 'AzureDiskVolumeSource(cachingMode: $cachingMode, diskName: $diskName, diskUri: $diskUri, fsType: $fsType, kind: $kind, readOnly: $readOnly)';
  }
}
