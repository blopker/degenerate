...
factory EventSeries.fromJson(Map<String, dynamic> json) { return EventSeries(
  ...
  lastObservedTime: json['lastObservedTime'] != null ? DateTime.parse(json['lastObservedTime'] as String) : null,
); }
...
Map<String, dynamic> toJson() { return {
  'count': ?count,
  if (lastObservedTime != null) 'lastObservedTime': lastObservedTime?.toIso8601String(),
}; } 
static bool canParse(Map<String, dynamic> json) { return true; } 
EventSeries copyWith({int Function()? count, DateTime Function()? lastObservedTime, }) { return EventSeries(
