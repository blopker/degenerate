...
final class AzureFilePersistentVolumeSource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('secretName') &&
        json['secretName'] is String &&
        json.containsKey('shareName') &&
        json['shareName'] is String;
  }

  AzureFilePersistentVolumeSource copyWith({
    bool Function()? readOnly,
    String? secretName,
    String Function()? secretNamespace,
    String? shareName,
  }) {
    return AzureFilePersistentVolumeSource(
      readOnly: readOnly != null ? readOnly() : this.readOnly,
      secretName: secretName ?? this.secretName,
      secretNamespace: secretNamespace != null
          ? secretNamespace()
          : this.secretNamespace,
  ...
  @override
  int get hashCode {
    return Object.hash(readOnly, secretName, secretNamespace, shareName);
  }

  @override
  String toString() {
    return 'AzureFilePersistentVolumeSource(readOnly: $readOnly, secretName: $secretName, secretNamespace: $secretNamespace, shareName: $shareName)';
  }
}
