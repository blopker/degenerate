...
final class Affinity {
  const Affinity({this.nodeAffinity, this.podAffinity, this.podAntiAffinity});
  ...
  Affinity copyWith({
    NodeAffinity Function()? nodeAffinity,
    PodAffinity Function()? podAffinity,
    PodAntiAffinity Function()? podAntiAffinity,
  }) {
    return Affinity(
  ...
  @override
  int get hashCode {
    return Object.hash(nodeAffinity, podAffinity, podAntiAffinity);
  }
