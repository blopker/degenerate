...
final class BoundObjectReference {
  const BoundObjectReference({this.apiVersion, this.kind, this.name, this.uid});
  ...
  @override
  int get hashCode {
    return Object.hash(apiVersion, kind, name, uid);
  }
