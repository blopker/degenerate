...
final class ResourceHealth {
  const ResourceHealth({this.health, this.message, this.resourceId = ''});
  ...
  Map<String, dynamic> toJson() {
    return {'health': ?health, 'message': ?message, 'resourceID': resourceId};
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('resourceID') && json['resourceID'] is String;
  }

  ResourceHealth copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(health, message, resourceId);
  }

  @override
  String toString() {
    return 'ResourceHealth(health: $health, message: $message, resourceId: $resourceId)';
  }
}
