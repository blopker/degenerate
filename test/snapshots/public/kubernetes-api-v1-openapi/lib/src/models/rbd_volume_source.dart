...
final class RbdVolumeSource {
  ...
  @override
  String toString() {
    return 'RbdVolumeSource(fsType: $fsType, image: $image, keyring: $keyring, monitors: $monitors, pool: $pool, readOnly: $readOnly, secretRef: $secretRef, user: $user)';
  }
}
