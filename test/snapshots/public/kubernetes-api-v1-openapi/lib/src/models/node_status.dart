...
final class NodeStatus {
  ...
  factory NodeStatus.fromJson(Map<String, dynamic> json) {
    return NodeStatus(
      addresses: (json['addresses'] as List<dynamic>?)
          ...
          .toList(),
      allocatable: (json['allocatable'] as Map<String, dynamic>?)?.map(
        (k, v) =>
      ...
      runtimeHandlers: (json['runtimeHandlers'] as List<dynamic>?)
          ?.map((e) => NodeRuntimeHandler.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (allocatable != null)
        'allocatable': allocatable?.map((k, v) => MapEntry(k, v.toJson())),
      if (capacity != null)
      ...
      if (runtimeHandlers != null)
        'runtimeHandlers': runtimeHandlers?.map((e) => e.toJson()).toList(),
      if (volumesAttached != null)
        'volumesAttached': volumesAttached?.map((e) => e.toJson()).toList(),
  ...
  NodeStatus copyWith({
    List<NodeAddress> Function()? addresses,
    Map<String, ResourceQuantity> Function()? allocatable,
    Map<String, ResourceQuantity> Function()? capacity,
    List<NodeCondition> Function()? conditions,
    NodeConfigStatus Function()? config,
    NodeDaemonEndpoints Function()? daemonEndpoints,
    List<String> Function()? declaredFeatures,
    NodeFeatures Function()? features,
    List<ContainerImage> Function()? images,
    NodeSystemInfo Function()? nodeInfo,
    String Function()? phase,
    List<NodeRuntimeHandler> Function()? runtimeHandlers,
    List<AttachedVolume> Function()? volumesAttached,
    List<String> Function()? volumesInUse,
  }) {
    return NodeStatus(
      ...
      daemonEndpoints: daemonEndpoints != null
          ? daemonEndpoints()
          : this.daemonEndpoints,
      declaredFeatures: declaredFeatures != null
          ? declaredFeatures()
          : this.declaredFeatures,
      ...
      runtimeHandlers: runtimeHandlers != null
          ? runtimeHandlers()
          : this.runtimeHandlers,
      volumesAttached: volumesAttached != null
          ? volumesAttached()
          : this.volumesAttached,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is NodeStatus &&
            const ListEquality<dynamic>().equals(addresses, other.addresses) &&
            ...
            const ListEquality<dynamic>().equals(
              runtimeHandlers,
              other.runtimeHandlers,
            ) &&
            const ListEquality<dynamic>().equals(
              volumesAttached,
              other.volumesAttached,
            ) &&
            const ListEquality<dynamic>().equals(
              volumesInUse,
              other.volumesInUse,
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(addresses ?? const []),
      allocatable,
      capacity,
      Object.hashAll(conditions ?? const []),
      config,
      daemonEndpoints,
      Object.hashAll(declaredFeatures ?? const []),
      features,
      Object.hashAll(images ?? const []),
      nodeInfo,
      phase,
      Object.hashAll(runtimeHandlers ?? const []),
      Object.hashAll(volumesAttached ?? const []),
      Object.hashAll(volumesInUse ?? const []),
    );
  }

  @override
  String toString() {
    return 'NodeStatus(addresses: $addresses, allocatable: $allocatable, capacity: $capacity, conditions: $conditions, config: $config, daemonEndpoints: $daemonEndpoints, declaredFeatures: $declaredFeatures, features: $features, images: $images, nodeInfo: $nodeInfo, phase: $phase, runtimeHandlers: $runtimeHandlers, volumesAttached: $volumesAttached, volumesInUse: $volumesInUse)';
  }
}
