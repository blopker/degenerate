...
final class RbdPersistentVolumeSource {
  const RbdPersistentVolumeSource({
    this.fsType,
    this.image = '',
    this.keyring = '/etc/ceph/keyring',
  ...
  factory RbdPersistentVolumeSource.fromJson(Map<String, dynamic> json) {
    return RbdPersistentVolumeSource(
      ...
      keyring: json.containsKey('keyring')
          ? json['keyring'] as String
          : '/etc/ceph/keyring',
  ...
  RbdPersistentVolumeSource copyWith({
    String Function()? fsType,
    String? image,
    String Function()? keyring,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is RbdPersistentVolumeSource &&
            ...
            const ListEquality<dynamic>().equals(monitors, other.monitors) &&
            pool == other.pool &&
  ...
  @override
  String toString() {
    return 'RbdPersistentVolumeSource(fsType: $fsType, image: $image, keyring: $keyring, monitors: $monitors, pool: $pool, readOnly: $readOnly, secretRef: $secretRef, user: $user)';
  }
}
