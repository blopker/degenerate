...
final class ReplicationControllerCondition {
  ...
  ReplicationControllerCondition copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(lastTransitionTime, message, reason, status, type);
  }

  @override
  String toString() {
    return 'ReplicationControllerCondition(lastTransitionTime: $lastTransitionTime, message: $message, reason: $reason, status: $status, type: $type)';
  }
}
