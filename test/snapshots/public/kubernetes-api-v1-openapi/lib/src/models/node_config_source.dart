...
final class NodeConfigSource {
  const NodeConfigSource({this.configMap});
  ...
  NodeConfigSource copyWith({ConfigMapNodeConfigSource Function()? configMap}) {
    return NodeConfigSource(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is NodeConfigSource && configMap == other.configMap;
  }
