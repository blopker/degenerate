...
final class TopologySpreadConstraint {
  ...
  factory TopologySpreadConstraint.fromJson(Map<String, dynamic> json) {
    return TopologySpreadConstraint(
      ...
      minDomains: json['minDomains'] != null
          ? (json['minDomains'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('maxSkew') &&
        json['maxSkew'] is num &&
        json.containsKey('topologyKey') &&
        json['topologyKey'] is String &&
        json.containsKey('whenUnsatisfiable') &&
        json['whenUnsatisfiable'] is String;
  }

  TopologySpreadConstraint copyWith({
    LabelSelector Function()? labelSelector,
    List<String> Function()? matchLabelKeys,
    int? maxSkew,
    int Function()? minDomains,
    String Function()? nodeAffinityPolicy,
    String Function()? nodeTaintsPolicy,
    String? topologyKey,
    ...
    return TopologySpreadConstraint(
      labelSelector: labelSelector != null
          ? labelSelector()
          : this.labelSelector,
      matchLabelKeys: matchLabelKeys != null
          ? matchLabelKeys()
          : this.matchLabelKeys,
      maxSkew: maxSkew ?? this.maxSkew,
      minDomains: minDomains != null ? minDomains() : this.minDomains,
      nodeAffinityPolicy: nodeAffinityPolicy != null
          ? nodeAffinityPolicy()
          : this.nodeAffinityPolicy,
      nodeTaintsPolicy: nodeTaintsPolicy != null
          ? nodeTaintsPolicy()
          : this.nodeTaintsPolicy,
  ...
  int get hashCode {
    return Object.hash(
      labelSelector,
      Object.hashAll(matchLabelKeys ?? const []),
      maxSkew,
      minDomains,
      nodeAffinityPolicy,
      nodeTaintsPolicy,
  ...
  @override
  String toString() {
    return 'TopologySpreadConstraint(labelSelector: $labelSelector, matchLabelKeys: $matchLabelKeys, maxSkew: $maxSkew, minDomains: $minDomains, nodeAffinityPolicy: $nodeAffinityPolicy, nodeTaintsPolicy: $nodeTaintsPolicy, topologyKey: $topologyKey, whenUnsatisfiable: $whenUnsatisfiable)';
  }
}
