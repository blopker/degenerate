...
final class ReplicationControllerSpec {
  const ReplicationControllerSpec({
    this.minReadySeconds = 0,
    this.replicas = 1,
    this.selector,
    this.template,
  });
  ...
  factory ReplicationControllerSpec.fromJson(Map<String, dynamic> json) {
    return ReplicationControllerSpec(
      minReadySeconds: json.containsKey('minReadySeconds')
          ? (json['minReadySeconds'] as num).toInt()
          : 0,
      replicas: json.containsKey('replicas')
          ? (json['replicas'] as num).toInt()
          : 1,
  ...
  ReplicationControllerSpec copyWith({
    int Function()? minReadySeconds,
    int Function()? replicas,
    Map<String, String> Function()? selector,
    PodTemplateSpec Function()? template,
  }) {
    return ReplicationControllerSpec(
      minReadySeconds: minReadySeconds != null
          ? minReadySeconds()
  ...
  @override
  int get hashCode {
    return Object.hash(minReadySeconds, replicas, selector, template);
  }
