...
final class FcVolumeSource {
  ...
  factory FcVolumeSource.fromJson(Map<String, dynamic> json) {
    return FcVolumeSource(
      ...
      targetWwNs: (json['targetWWNs'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      wwids: (json['wwids'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
    );
  }
  ...
  FcVolumeSource copyWith({
    String Function()? fsType,
    int Function()? lun,
    bool Function()? readOnly,
    List<String> Function()? targetWwNs,
    List<String> Function()? wwids,
  }) {
    return FcVolumeSource(
  ...
  int get hashCode {
    return Object.hash(
      ...
      lun,
      readOnly,
      Object.hashAll(targetWwNs ?? const []),
      Object.hashAll(wwids ?? const []),
    );
  }
