...
final class ScopeSelector {
  const ScopeSelector({this.matchExpressions});
  ...
  ScopeSelector copyWith({
    List<ScopedResourceSelectorRequirement> Function()? matchExpressions,
  }) {
    return ScopeSelector(
  ...
  @override
  int get hashCode {
    return Object.hashAll(matchExpressions ?? const []).hashCode;
  }
