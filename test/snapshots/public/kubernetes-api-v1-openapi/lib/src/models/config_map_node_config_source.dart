...
final class ConfigMapNodeConfigSource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('kubeletConfigKey') &&
        json['kubeletConfigKey'] is String &&
  ...
  ConfigMapNodeConfigSource copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(kubeletConfigKey, name, namespace, resourceVersion, uid);
  }

  @override
  String toString() {
    return 'ConfigMapNodeConfigSource(kubeletConfigKey: $kubeletConfigKey, name: $name, namespace: $namespace, resourceVersion: $resourceVersion, uid: $uid)';
  }
}
