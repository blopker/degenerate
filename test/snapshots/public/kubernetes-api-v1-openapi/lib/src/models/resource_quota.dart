...
final class ResourceQuota {
  ...
  factory ResourceQuota.fromJson(Map<String, dynamic> json) {
    return ResourceQuota(
      ...
      status: json['status'] != null
          ? ResourceQuotaStatus.fromJson(json['status'] as Map<String, dynamic>)
          : null,
    );
  }
  ...
  ResourceQuota copyWith({
    String Function()? apiVersion,
    String Function()? kind,
    ObjectMeta Function()? metadata,
    ResourceQuotaSpec Function()? spec,
    ResourceQuotaStatus Function()? status,
  }) {
    return ResourceQuota(
  ...
  @override
  int get hashCode {
    return Object.hash(apiVersion, kind, metadata, spec, status);
  }
