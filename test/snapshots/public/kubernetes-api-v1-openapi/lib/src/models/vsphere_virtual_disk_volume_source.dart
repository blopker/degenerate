...
final class VsphereVirtualDiskVolumeSource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('volumePath') && json['volumePath'] is String;
  }

  VsphereVirtualDiskVolumeSource copyWith({
    String Function()? fsType,
    String Function()? storagePolicyId,
    String Function()? storagePolicyName,
    String? volumePath,
  }) {
    return VsphereVirtualDiskVolumeSource(
      fsType: fsType != null ? fsType() : this.fsType,
      storagePolicyId: storagePolicyId != null
          ? storagePolicyId()
          : this.storagePolicyId,
      storagePolicyName: storagePolicyName != null
          ? storagePolicyName()
          : this.storagePolicyName,
  ...
  @override
  int get hashCode {
    return Object.hash(fsType, storagePolicyId, storagePolicyName, volumePath);
  }

  @override
  String toString() {
    return 'VsphereVirtualDiskVolumeSource(fsType: $fsType, storagePolicyId: $storagePolicyId, storagePolicyName: $storagePolicyName, volumePath: $volumePath)';
  }
}
