...
final class WorkloadReference {
  ...
  factory WorkloadReference.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('podGroup') &&
        json['podGroup'] is String;
  }

  WorkloadReference copyWith({
    String? name,
    String? podGroup,
    String Function()? podGroupReplicaKey,
  }) {
    return WorkloadReference(
      name: name ?? this.name,
      podGroup: podGroup ?? this.podGroup,
      podGroupReplicaKey: podGroupReplicaKey != null
          ? podGroupReplicaKey()
          : this.podGroupReplicaKey,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(name, podGroup, podGroupReplicaKey);
  }

  @override
  String toString() {
    return 'WorkloadReference(name: $name, podGroup: $podGroup, podGroupReplicaKey: $podGroupReplicaKey)';
  }
}
