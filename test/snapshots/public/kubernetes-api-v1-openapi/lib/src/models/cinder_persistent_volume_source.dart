...
final class CinderPersistentVolumeSource {
  ...
  CinderPersistentVolumeSource copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(fsType, readOnly, secretRef, volumeId);
  }

  @override
  String toString() {
    return 'CinderPersistentVolumeSource(fsType: $fsType, readOnly: $readOnly, secretRef: $secretRef, volumeId: $volumeId)';
  }
}
