...
final class QuobyteVolumeSource {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('registry') &&
        json['registry'] is String &&
        json.containsKey('volume') &&
        json['volume'] is String;
  }

  QuobyteVolumeSource copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(group, readOnly, registry, tenant, user, volume);
  }

  @override
  String toString() {
    return 'QuobyteVolumeSource(group: $group, readOnly: $readOnly, registry: $registry, tenant: $tenant, user: $user, volume: $volume)';
  }
}
