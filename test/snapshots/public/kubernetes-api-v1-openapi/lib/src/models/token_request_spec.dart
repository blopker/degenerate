...
final class TokenRequestSpec {
  ...
  factory TokenRequestSpec.fromJson(Map<String, dynamic> json) {
    return TokenRequestSpec(
      ...
      boundObjectRef: json['boundObjectRef'] != null
          ...
          : null,
      expirationSeconds: json['expirationSeconds'] != null
          ? (json['expirationSeconds'] as num).toInt()
          : null,
    );
  }
  ...
  TokenRequestSpec copyWith({
    List<String> Function()? audiences,
    BoundObjectReference Function()? boundObjectRef,
    int Function()? expirationSeconds,
  }) {
    return TokenRequestSpec(
      audiences: audiences != null ? audiences() : this.audiences,
      boundObjectRef: boundObjectRef != null
          ? boundObjectRef()
          : this.boundObjectRef,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is TokenRequestSpec &&
            const ListEquality<dynamic>().equals(audiences, other.audiences) &&
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(audiences ?? const []),
      boundObjectRef,
      expirationSeconds,
    );
  }
