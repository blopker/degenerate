...
import '../models/code_of_conduct.dart';

/// CodesOfConductApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CodesOfConductApi {
  const CodesOfConductApi(this._config);
  ...
  Future<ApiResult<List<CodeOfConduct>>>
  codesOfConductGetAllCodesOfConduct() async {
    ...
    return _execute(
      ...
      onSuccess: (response) {
        ...
        return json
            .map((e) => CodeOfConduct.fromJson(e as Map<String, dynamic>))
            .toList();
      },
    );
  }
  ...
  Future<ApiResult<CodeOfConduct>> codesOfConductGetConductCode({
    required String key,
  }) async {
    final request = ApiRequest(
      method: 'GET',
