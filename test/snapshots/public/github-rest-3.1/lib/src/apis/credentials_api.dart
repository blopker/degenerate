...
import '../models/credentials_revoke_request.dart';

/// CredentialsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CredentialsApi {
  const CredentialsApi(this._config);
  ...
  Future<ApiResult<Map<String, String>>> credentialsRevoke({
    required CredentialsRevokeRequest body,
  }) async {
