...
import '../models/copilot_add_copilot_seats_for_teams_request.dart';
import '../models/copilot_add_copilot_seats_for_teams_response.dart';
import '../models/copilot_add_copilot_seats_for_users_request.dart';
import '../models/copilot_add_copilot_seats_for_users_response.dart';
import '../models/copilot_cancel_copilot_seat_assignment_for_teams_request.dart';
import '../models/copilot_cancel_copilot_seat_assignment_for_teams_response.dart';
import '../models/copilot_cancel_copilot_seat_assignment_for_users_request.dart';
import '../models/copilot_cancel_copilot_seat_assignment_for_users_response.dart';
import '../models/copilot_list_copilot_seats_response.dart';
import '../models/copilot_organization_details.dart';
import '../models/copilot_seat_details.dart';
import '../models/copilot_set_copilot_content_exclusion_for_organization_response.dart';
import '../models/copilot_usage_metrics_day.dart';
import '../models/inline_object97.dart';

/// CopilotApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class CopilotApi {
  const CopilotApi(this._config);
  ...
  Future<ApiResult<CopilotOrganizationDetails>>
  copilotGetCopilotOrganizationDetails({required String org}) async {
  ...
  Future<ApiResult<CopilotListCopilotSeatsResponse>> copilotListCopilotSeats({
    required String org,
    int? page,
    int? perPage,
  }) async {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotListCopilotSeatsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<CopilotAddCopilotSeatsForTeamsResponse>>
  copilotAddCopilotSeatsForTeams({
    required String org,
    required CopilotAddCopilotSeatsForTeamsRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotAddCopilotSeatsForTeamsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<CopilotCancelCopilotSeatAssignmentForTeamsResponse>>
  copilotCancelCopilotSeatAssignmentForTeams({
    required String org,
    required CopilotCancelCopilotSeatAssignmentForTeamsRequest body,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
      path: '/orgs/${Uri.encodeComponent(org)}/copilot/billing/selected_teams',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotCancelCopilotSeatAssignmentForTeamsResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<CopilotAddCopilotSeatsForUsersResponse>>
  copilotAddCopilotSeatsForUsers({
    required String org,
    required CopilotAddCopilotSeatsForUsersRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotAddCopilotSeatsForUsersResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<CopilotCancelCopilotSeatAssignmentForUsersResponse>>
  copilotCancelCopilotSeatAssignmentForUsers({
    required String org,
    required CopilotCancelCopilotSeatAssignmentForUsersRequest body,
  }) async {
    final request = ApiRequest(
      method: 'DELETE',
      path: '/orgs/${Uri.encodeComponent(org)}/copilot/billing/selected_users',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotCancelCopilotSeatAssignmentForUsersResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<Map<String, List<String>>>>
  copilotContentExclusionForOrganization({required String org}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<CopilotSetCopilotContentExclusionForOrganizationResponse>>
  copilotSetCopilotContentExclusionForOrganization({
    required String org,
    required Map<String, List<InlineObject97>> body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path: '/orgs/${Uri.encodeComponent(org)}/copilot/content_exclusion',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return CopilotSetCopilotContentExclusionForOrganizationResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<List<CopilotUsageMetricsDay>>>
  ...
  Future<ApiResult<CopilotSeatDetails>> copilotGetCopilotSeatDetailsForUser({
    required String org,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/orgs/${Uri.encodeComponent(org)}/members/${Uri.encodeComponent(username)}/copilot',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<List<CopilotUsageMetricsDay>>> copilotMetricsForTeam({
    required String org,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/orgs/${Uri.encodeComponent(org)}/team/${Uri.encodeComponent(teamSlug)}/copilot/metrics',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        'since': ?since,
        'until': ?until,
