...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/search_code_order.dart';import '../models/search_code_response.dart';import '../models/search_code_sort.dart';import '../models/search_commits_order.dart';import '../models/search_commits_response.dart';import '../models/search_commits_sort.dart';import '../models/search_issues_and_pull_requests_order.dart';import '../models/search_issues_and_pull_requests_response.dart';import '../models/search_issues_and_pull_requests_sort.dart';import '../models/search_labels_order.dart';import '../models/search_labels_response.dart';import '../models/search_labels_sort.dart';import '../models/search_repos_order.dart';import '../models/search_repos_response.dart';import '../models/search_repos_sort.dart';import '../models/search_topics_response.dart';import '../models/search_users_order.dart';import '../models/search_users_response.dart';import '../models/search_users_sort.dart';/// SearchApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class SearchApi {const SearchApi(this._config);
...
///
/// `GET /search/code`
Future<ApiResult<SearchCodeResponse>> searchCode({required String q, SearchCodeSort? sort, SearchCodeOrder? order, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/code',
...
///
/// `GET /search/commits`
Future<ApiResult<SearchCommitsResponse>> searchCommits({required String q, SearchCommitsSort? sort, SearchCommitsOrder? order, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/commits',
  headers: {..._config.defaultHeaders
  },
...
///
/// `GET /search/issues`
Future<ApiResult<SearchIssuesAndPullRequestsResponse>> searchIssuesAndPullRequests({required String q, SearchIssuesAndPullRequestsSort? sort, SearchIssuesAndPullRequestsOrder? order, int? perPage, int? page, String? advancedSearch, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/issues',
  headers: {..._config.defaultHeaders
  },
...
///
/// `GET /search/labels`
Future<ApiResult<SearchLabelsResponse>> searchLabels({required int repositoryId, required String q, SearchLabelsSort? sort, SearchLabelsOrder? order, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/labels',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<SearchReposResponse>> searchRepos({required String q, SearchReposSort? sort, SearchReposOrder? order, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `GET /search/topics`
Future<ApiResult<SearchTopicsResponse>> searchTopics({required String q, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/topics',
  headers: {..._config.defaultHeaders
  },
...
///
/// `GET /search/users`
Future<ApiResult<SearchUsersResponse>> searchUsers({required String q, SearchUsersSort? sort, SearchUsersOrder? order, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/search/users',
  headers: {..._config.defaultHeaders
  },
