...
import '../models/license_simple.dart';

/// LicensesApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class LicensesApi {
  const LicensesApi(this._config);
  ...
  ///
  /// `GET /licenses`
  Future<ApiResult<List<LicenseSimple>>> licensesGetAllCommonlyUsed({
    bool? featured,
    int? perPage,
    int? page,
  }) async {
    ...
    return _execute(
      ...
      onSuccess: (response) {
        ...
        return json
            .map((e) => LicenseSimple.fromJson(e as Map<String, dynamic>))
            .toList();
      },
    );
  }
  ...
  Future<ApiResult<License>> licensesGet({required String license}) async {
    final request = ApiRequest(
      method: 'GET',
  ...
  Future<ApiResult<LicenseContent>> licensesGetForRepo({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/license',
      headers: {..._config.defaultHeaders},
