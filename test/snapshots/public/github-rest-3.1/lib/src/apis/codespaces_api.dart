...
Future<ApiResult<CodespacesListInOrganizationResponse>> codespacesListInOrganization({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesListOrgSecretsResponse>> codespacesListOrgSecrets({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesPublicKey>> codespacesGetOrgPublicKey({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesOrgSecret>> codespacesGetOrgSecret({required String org, required String secretName, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<EmptyObject>> codespacesCreateOrUpdateOrgSecret({required String org, required String secretName, required CodespacesCreateOrUpdateOrgSecretRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<void>> codespacesDeleteOrgSecret({required String org, required String secretName, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodespacesListSelectedReposForOrgSecretResponse>> codespacesListSelectedReposForOrgSecret({required String org, required String secretName, int? page, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> codespacesSetSelectedReposForOrgSecret({required String org, required String secretName, required CodespacesSetSelectedReposForOrgSecretRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/codespaces/secrets/${Uri.encodeComponent(secretName)}/repositories',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> codespacesAddSelectedRepoToOrgSecret({required String org, required String secretName, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> codespacesRemoveSelectedRepoFromOrgSecret({required String org, required String secretName, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/codespaces/secrets/${Uri.encodeComponent(secretName)}/repositories/${Uri.encodeComponent(repositoryId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodespacesGetCodespacesForUserInOrgResponse>> codespacesGetCodespacesForUserInOrg({required String org, required String username, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> codespacesDeleteFromOrganization({required String org, required String username, required String codespaceName, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<Codespace>> codespacesStopInOrganization({required String org, required String username, required String codespaceName, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<CodespacesListInRepositoryForAuthenticatedUserResponse>> codespacesListInRepositoryForAuthenticatedUser({required String owner, required String repo, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Codespace>> codespacesCreateWithRepoForAuthenticatedUser({required String owner, required String repo, required CodespacesCreateWithRepoForAuthenticatedUserRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/codespaces',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<CodespacesListDevcontainersInRepositoryForAuthenticatedUserResponse>> codespacesListDevcontainersInRepositoryForAuthenticatedUser({required String owner, required String repo, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesRepoMachinesForAuthenticatedUserResponse>> codespacesRepoMachinesForAuthenticatedUser({required String owner, required String repo, String? location, String? clientIp, String? ref, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesPreFlightWithRepoForAuthenticatedUserResponse>> codespacesPreFlightWithRepoForAuthenticatedUser({required String owner, required String repo, String? ref, String? clientIp, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesPermissionsCheckForDevcontainer>> codespacesCheckPermissionsForDevcontainer({required String owner, required String repo, required String ref, required String devcontainerPath, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesListRepoSecretsResponse>> codespacesListRepoSecrets({required String owner, required String repo, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesPublicKey>> codespacesGetRepoPublicKey({required String owner, required String repo, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RepoCodespacesSecret>> codespacesGetRepoSecret({required String owner, required String repo, required String secretName, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<EmptyObject>> codespacesCreateOrUpdateRepoSecret({required String owner, required String repo, required String secretName, required CodespacesCreateOrUpdateRepoSecretRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> codespacesDeleteRepoSecret({required String owner, required String repo, required String secretName, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<Codespace>> codespacesCreateWithPrForAuthenticatedUser({required String owner, required String repo, required int pullNumber, required CodespacesCreateWithPrForAuthenticatedUserRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
///
/// `GET /user/codespaces`
Future<ApiResult<CodespacesListForAuthenticatedUserResponse>> codespacesListForAuthenticatedUser({int? perPage, int? page, int? repositoryId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Codespace>> codespacesCreateForAuthenticatedUser({required CodespacesCreateForAuthenticatedUserRequest body}) async  { final request = ApiRequest(
  method: 'POST',
  path: '/user/codespaces',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<CodespacesListSecretsForAuthenticatedUserResponse>> codespacesListSecretsForAuthenticatedUser({int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesUserPublicKey>> codespacesGetPublicKeyForAuthenticatedUser() async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesSecret>> codespacesGetSecretForAuthenticatedUser({required String secretName}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<EmptyObject>> codespacesCreateOrUpdateSecretForAuthenticatedUser({required String secretName, required CodespacesCreateOrUpdateSecretForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/user/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> codespacesDeleteSecretForAuthenticatedUser({required String secretName}) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/user/codespaces/secrets/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodespacesListRepositoriesForSecretForAuthenticatedUserResponse>> codespacesListRepositoriesForSecretForAuthenticatedUser({required String secretName}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> codespacesSetRepositoriesForSecretForAuthenticatedUser({required String secretName, required CodespacesSetRepositoriesForSecretForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/user/codespaces/secrets/${Uri.encodeComponent(secretName)}/repositories',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> codespacesAddRepositoryForSecretForAuthenticatedUser({required String secretName, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> codespacesRemoveRepositoryForSecretForAuthenticatedUser({required String secretName, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/user/codespaces/secrets/${Uri.encodeComponent(secretName)}/repositories/${Uri.encodeComponent(repositoryId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<Codespace>> codespacesGetForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Codespace>> codespacesUpdateForAuthenticatedUser({required String codespaceName, CodespacesUpdateForAuthenticatedUserRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/user/codespaces/${Uri.encodeComponent(codespaceName)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Map<String, String>>> codespacesDeleteForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/user/codespaces/${Uri.encodeComponent(codespaceName)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodespaceExportDetails>> codespacesExportForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<CodespaceExportDetails>> codespacesGetExportDetailsForAuthenticatedUser({required String codespaceName, required String exportId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespacesCodespaceMachinesForAuthenticatedUserResponse>> codespacesCodespaceMachinesForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodespaceWithFullRepository>> codespacesPublishForAuthenticatedUser({required String codespaceName, required CodespacesPublishForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<Codespace>> codespacesStartForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<Codespace>> codespacesStopForAuthenticatedUser({required String codespaceName}) async  { final request = ApiRequest(
  method: 'POST',
