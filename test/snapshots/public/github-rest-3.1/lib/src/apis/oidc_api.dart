...
import '../models/oidc_custom_sub.dart';
...
final class OidcApi {
  ...
  Future<ApiResult<OidcCustomSub>> oidcGetOidcCustomSubTemplateForOrg({
    required String org,
  }) async {
  ...
  Future<ApiResult<EmptyObject>> oidcUpdateOidcCustomSubTemplateForOrg({
    required String org,
    required OidcCustomSub body,
  }) async {
    final request = ApiRequest(
      method: 'PUT',
      path: '/orgs/${Uri.encodeComponent(org)}/actions/oidc/customization/sub',
