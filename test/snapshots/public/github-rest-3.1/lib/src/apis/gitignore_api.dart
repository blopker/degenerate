...
import '../models/gitignore_template.dart';

/// GitignoreApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class GitignoreApi {
  const GitignoreApi(this._config);
  ...
  Future<ApiResult<List<String>>> gitignoreGetAllTemplates() async {
  ...
  Future<ApiResult<GitignoreTemplate>> gitignoreGetTemplate({
