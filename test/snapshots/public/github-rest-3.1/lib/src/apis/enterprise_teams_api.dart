...
import '../models/enterprise_team.dart';
import '../models/enterprise_teams_create_request.dart';
import '../models/enterprise_teams_update_request.dart';

/// EnterpriseTeamsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class EnterpriseTeamsApi {
  const EnterpriseTeamsApi(this._config);
  ...
  Future<ApiResult<List<EnterpriseTeam>>> enterpriseTeamsList({
    ...
    return _execute(
      ...
      onSuccess: (response) {
        ...
        return json
            .map((e) => EnterpriseTeam.fromJson(e as Map<String, dynamic>))
            .toList();
      },
    );
  }
  ...
  Future<ApiResult<EnterpriseTeam>> enterpriseTeamsCreate({
    required String enterprise,
    required EnterpriseTeamsCreateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/enterprises/${Uri.encodeComponent(enterprise)}/teams',
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return EnterpriseTeam.fromJson(
  ...
  Future<ApiResult<EnterpriseTeam>> enterpriseTeamsGet({
    required String enterprise,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/enterprises/${Uri.encodeComponent(enterprise)}/teams/${Uri.encodeComponent(teamSlug)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<EnterpriseTeam>> enterpriseTeamsUpdate({
    required String enterprise,
    required String teamSlug,
    required EnterpriseTeamsUpdateRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
  ...
  Future<ApiResult<void>> enterpriseTeamsDelete({
    required String enterprise,
    required String teamSlug,
  }) async {
    final request = ApiRequest(
