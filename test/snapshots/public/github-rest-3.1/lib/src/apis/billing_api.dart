...
import '../models/billing_get_all_budgets_org_scope.dart';
import '../models/billing_premium_request_usage_report_org.dart';
import '../models/billing_premium_request_usage_report_user.dart';
import '../models/billing_update_budget_org_request.dart';
import '../models/billing_update_budget_org_response.dart';
import '../models/billing_usage_report.dart';
import '../models/billing_usage_report_user.dart';
import '../models/billing_usage_summary_report_org.dart';
import '../models/billing_usage_summary_report_user.dart';
import '../models/delete_budget.dart';
import '../models/get_all_budgets.dart';
import '../models/get_budget.dart';
...
final class BillingApi {
  ...
  Future<ApiResult<GetAllBudgets>> billingGetAllBudgetsOrg({
    required String org,
    int? page,
    int? perPage,
    BillingGetAllBudgetsOrgScope? scope,
  }) async {
    final request = ApiRequest(
      method: 'GET',
      path:
          '/organizations/${Uri.encodeComponent(org)}/settings/billing/budgets',
  ...
  Future<ApiResult<GetBudget>> billingGetBudgetOrg({
    required String org,
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/organizations/${Uri.encodeComponent(org)}/settings/billing/budgets/${Uri.encodeComponent(budgetId)}',
      headers: {..._config.defaultHeaders},
    );
  ...
  Future<ApiResult<BillingUpdateBudgetOrgResponse>> billingUpdateBudgetOrg({
    required String org,
    required String budgetId,
    required BillingUpdateBudgetOrgRequest body,
  }) async {
    final request = ApiRequest(
      method: 'PATCH',
      path:
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return BillingUpdateBudgetOrgResponse.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<DeleteBudget>> billingDeleteBudgetOrg({
    required String org,
    required String budgetId,
  }) async {
    final request = ApiRequest(
  ...
  Future<ApiResult<BillingPremiumRequestUsageReportOrg>>
  billingGetGithubBillingPremiumRequestUsageReportOrg({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/organizations/${Uri.encodeComponent(org)}/settings/billing/premium_request/usage',
      headers: {..._config.defaultHeaders},
      queryParameters: {
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return BillingPremiumRequestUsageReportOrg.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  Future<ApiResult<BillingUsageReport>> billingGetGithubBillingUsageReportOrg({
    required String org,
    int? year,
    int? month,
    int? day,
  ...
  Future<ApiResult<BillingUsageSummaryReportOrg>>
  billingGetGithubBillingUsageSummaryReportOrg({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/organizations/${Uri.encodeComponent(org)}/settings/billing/usage/summary',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        if (year != null) 'year': year.toString(),
        if (month != null) 'month': month.toString(),
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return BillingUsageSummaryReportOrg.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  billingGetGithubBillingPremiumRequestUsageReportUser({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/users/${Uri.encodeComponent(username)}/settings/billing/premium_request/usage',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        if (year != null) 'year': year.toString(),
        if (month != null) 'month': month.toString(),
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return BillingPremiumRequestUsageReportUser.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
  ...
  billingGetGithubBillingUsageSummaryReportUser({
    ...
    final request = ApiRequest(
      method: 'GET',
      path:
          '/users/${Uri.encodeComponent(username)}/settings/billing/usage/summary',
      headers: {..._config.defaultHeaders},
      queryParameters: {
        if (year != null) 'year': year.toString(),
        if (month != null) 'month': month.toString(),
    ...
    return _execute(
      request,
      onSuccess: (response) {
        return BillingUsageSummaryReportUser.fromJson(
          jsonDecode(response.body) as Map<String, dynamic>,
        );
      },
    );
