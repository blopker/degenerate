...
final class MetaApi {
  ...
  ///
  /// `GET /`
  Future<ApiResult<Root>> metaRoot() async {
  ...
  ///
  /// `GET /meta`
  Future<ApiResult<Overview>> metaGet() async {
    final request = ApiRequest(
      method: 'GET',
      path: '/meta',
      headers: {..._config.defaultHeaders},
  ...
  ///
  /// `GET /octocat`
  Future<ApiResult<void>> metaGetOctocat({String? s}) async {
    final request = ApiRequest(
      method: 'GET',
      path: '/octocat',
      headers: {..._config.defaultHeaders},
  ...
  ///
  /// `GET /versions`
  Future<ApiResult<List<String>>> metaGetAllVersions() async {
    final request = ApiRequest(
      method: 'GET',
      path: '/versions',
      headers: {..._config.defaultHeaders},
  ...
  ///
  /// `GET /zen`
  Future<ApiResult<void>> metaGetZen() async {
    final request = ApiRequest(
      method: 'GET',
      path: '/zen',
      headers: {..._config.defaultHeaders},
