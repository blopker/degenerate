...
///
/// `GET /organizations`
Future<ApiResult<List<OrganizationSimple>>> orgsList({int? since, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/organizations',
...
///
/// `GET /orgs/{org}`
Future<ApiResult<OrganizationFull>> orgsGet({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `PATCH /orgs/{org}`
Future<ApiResult<OrganizationFull>> orgsUpdate({required String org, OrgsUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}',
  headers: {..._config.defaultHeaders
...
///
/// `DELETE /orgs/{org}`
Future<ApiResult<Map<String, String>>> orgsDelete({required String org}) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<OrgsCreateArtifactDeploymentRecordResponse>> orgsCreateArtifactDeploymentRecord({required String org, required OrgsCreateArtifactDeploymentRecordRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<OrgsSetClusterDeploymentRecordsResponse>> orgsSetClusterDeploymentRecords({required String org, required String cluster, required OrgsSetClusterDeploymentRecordsRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<OrgsCreateArtifactStorageRecordResponse>> orgsCreateArtifactStorageRecord({required String org, required OrgsCreateArtifactStorageRecordRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<OrgsListArtifactDeploymentRecordsResponse>> orgsListArtifactDeploymentRecords({required String org, required String subjectDigest, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgsListArtifactStorageRecordsResponse>> orgsListArtifactStorageRecords({required String org, required String subjectDigest, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgsListAttestationsBulkResponse>> orgsListAttestationsBulk({required String org, int? perPage, String? before, String? after, required OrgsListAttestationsBulkRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> orgsDeleteAttestationsBulk({required String org, required OrgsDeleteAttestationsBulkRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> orgsDeleteAttestationsBySubjectDigest({required String org, required String subjectDigest, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<List<OrgsListAttestationRepositoriesResponse>>> orgsListAttestationRepositories({required String org, int? perPage, String? before, String? after, String? predicateType, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsDeleteAttestationsById({required String org, required int attestationId, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<OrgsListAttestationsResponse>> orgsListAttestations({required String org, required String subjectDigest, int? perPage, String? before, String? after, String? predicateType, }) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `GET /orgs/{org}/blocks`
Future<ApiResult<List<SimpleUser>>> orgsListBlockedUsers({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsCheckBlockedUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsBlockUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/blocks/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> orgsUnblockUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/blocks/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<OrganizationInvitation>>> orgsListFailedInvitations({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `GET /orgs/{org}/hooks`
Future<ApiResult<List<OrgHook>>> orgsListWebhooks({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
///
/// `POST /orgs/{org}/hooks`
Future<ApiResult<OrgHook>> orgsCreateWebhook({required String org, required OrgsCreateWebhookRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/hooks',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<OrgHook>> orgsGetWebhook({required String org, required int hookId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgHook>> orgsUpdateWebhook({required String org, required int hookId, OrgsUpdateWebhookRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/hooks/${Uri.encodeComponent(hookId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsDeleteWebhook({required String org, required int hookId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/hooks/${Uri.encodeComponent(hookId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<WebhookConfig>> orgsGetWebhookConfigForOrg({required String org, required int hookId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<WebhookConfig>> orgsUpdateWebhookConfigForOrg({required String org, required int hookId, OrgsUpdateWebhookConfigForOrgRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/hooks/${Uri.encodeComponent(hookId.toString())}/config',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<List<HookDeliveryItem>>> orgsListWebhookDeliveries({required String org, required int hookId, int? perPage, String? cursor, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<HookDelivery>> orgsGetWebhookDelivery({required String org, required int hookId, required int deliveryId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> orgsRedeliverWebhookDelivery({required String org, required int hookId, required int deliveryId, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> orgsPingWebhook({required String org, required int hookId, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<InsightsSubjectStats2>>> apiInsightsGetSubjectStats({required String org, required String minTimestamp, String? maxTimestamp, int? page, int? perPage, InsightsGetSubjectStatsDirection? direction, List<InsightsGetSubjectStatsSort>? sort, String? subjectNameSubstring, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<InsightsSummaryStats>> apiInsightsGetSummaryStats({required String org, required String minTimestamp, String? maxTimestamp, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<InsightsSummaryStats>> apiInsightsGetSummaryStatsByUser({required String org, required String userId, required String minTimestamp, String? maxTimestamp, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<InsightsSummaryStats>> apiInsightsGetSummaryStatsByActor({required String org, required InsightsGetSummaryStatsByActorActorType actorType, required int actorId, required String minTimestamp, String? maxTimestamp, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<InsightsTimeStats2>>> apiInsightsGetTimeStats({required String org, required String minTimestamp, String? maxTimestamp, required String timestampIncrement, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<InsightsTimeStats2>>> apiInsightsGetTimeStatsByUser({required String org, required String userId, required String minTimestamp, String? maxTimestamp, required String timestampIncrement, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<InsightsTimeStats2>>> apiInsightsGetTimeStatsByActor({required String org, required InsightsGetTimeStatsByActorActorType actorType, required int actorId, required String minTimestamp, String? maxTimestamp, required String timestampIncrement, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<InsightsUserStats2>>> apiInsightsGetUserStats({required String org, required String userId, required String minTimestamp, String? maxTimestamp, int? page, int? perPage, InsightsGetUserStatsDirection? direction, List<InsightsGetUserStatsSort>? sort, String? actorNameSubstring, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgsListAppInstallationsResponse>> orgsListAppInstallations({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<OrganizationInvitation>>> orgsListPendingInvitations({required String org, int? perPage, int? page, OrgsListPendingInvitationsRole? role, OrgsListPendingInvitationsInvitationSource? invitationSource, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrganizationInvitation>> orgsCreateInvitation({required String org, OrgsCreateInvitationRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/invitations',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsCancelInvitation({required String org, required int invitationId, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<List<Team>>> orgsListInvitationTeams({required String org, required int invitationId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<IssueType>>> orgsListIssueTypes({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<IssueType>> orgsCreateIssueType({required String org, required OrganizationCreateIssueType body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/issue-types',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<IssueType>> orgsUpdateIssueType({required String org, required int issueTypeId, required OrganizationUpdateIssueType body, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> orgsDeleteIssueType({required String org, required int issueTypeId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/issue-types/${Uri.encodeComponent(issueTypeId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<SimpleUser>>> orgsListMembers({required String org, OrgsListMembersFilter? filter, OrgsListMembersRole? role, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsCheckMembershipForUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsRemoveMember({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/members/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<OrgMembership>> orgsGetMembershipForUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgMembership>> orgsSetMembershipForUser({required String org, required String username, OrgsSetMembershipForUserRequest? body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/memberships/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsRemoveMembershipForUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/memberships/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<OrgsListOrgRolesResponse>> orgsListOrgRoles({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsRevokeAllOrgRolesTeam({required String org, required String teamSlug, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<void>> orgsAssignTeamToOrgRole({required String org, required String teamSlug, required int roleId, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> orgsRevokeOrgRoleTeam({required String org, required String teamSlug, required int roleId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/organization-roles/teams/${Uri.encodeComponent(teamSlug)}/${Uri.encodeComponent(roleId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> orgsRevokeAllOrgRolesUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
...
Future<ApiResult<void>> orgsAssignUserToOrgRole({required String org, required String username, required int roleId, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> orgsRevokeOrgRoleUser({required String org, required String username, required int roleId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/organization-roles/users/${Uri.encodeComponent(username)}/${Uri.encodeComponent(roleId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<OrganizationRole>> orgsGetOrgRole({required String org, required int roleId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<TeamRoleAssignment>>> orgsListOrgRoleTeams({required String org, required int roleId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<UserRoleAssignment>>> orgsListOrgRoleUsers({required String org, required int roleId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<SimpleUser>>> orgsListOutsideCollaborators({required String org, OrgsListOutsideCollaboratorsFilter? filter, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgsConvertMemberToOutsideCollaboratorResponse202>> orgsConvertMemberToOutsideCollaborator({required String org, required String username, OrgsConvertMemberToOutsideCollaboratorRequest? body, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> orgsRemoveOutsideCollaborator({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/outside_collaborators/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<Map<String, String>>> orgsReviewPatGrantRequestsInBulk({required String org, required OrgsReviewPatGrantRequestsInBulkRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/personal-access-token-requests',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsReviewPatGrantRequest({required String org, required int patRequestId, required OrgsReviewPatGrantRequestRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<MinimalRepository>>> orgsListPatGrantRequestRepositories({required String org, required int patRequestId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> orgsUpdatePatAccesses({required String org, required OrgsUpdatePatAccessesRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/personal-access-tokens',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsUpdatePatAccess({required String org, required int patId, required OrgsUpdatePatAccessRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<MinimalRepository>>> orgsListPatGrantRepositories({required String org, required int patId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<CustomProperty>>> orgsCustomPropertiesForReposGetOrganizationDefinitions({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<CustomProperty>>> orgsCustomPropertiesForReposCreateOrUpdateOrganizationDefinitions({required String org, required OrgsCustomPropertiesForReposCreateOrUpdateOrganizationDefinitionsRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/properties/schema',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<CustomProperty>> orgsCustomPropertiesForReposGetOrganizationDefinition({required String org, required String customPropertyName, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CustomProperty>> orgsCustomPropertiesForReposCreateOrUpdateOrganizationDefinition({required String org, required String customPropertyName, required CustomPropertySetPayload body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/properties/schema/${Uri.encodeComponent(customPropertyName)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsCustomPropertiesForReposDeleteOrganizationDefinition({required String org, required String customPropertyName, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/properties/schema/${Uri.encodeComponent(customPropertyName)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<OrgRepoCustomPropertyValues>>> orgsCustomPropertiesForReposGetOrganizationValues({required String org, int? perPage, int? page, String? repositoryQuery, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsCustomPropertiesForReposCreateOrUpdateOrganizationValues({required String org, required OrgsCustomPropertiesForReposCreateOrUpdateOrganizationValuesRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/properties/values',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<List<SimpleUser>>> orgsListPublicMembers({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsCheckPublicMembershipForUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsSetPublicMembershipForAuthenticatedUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/public_members/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<void>> orgsRemovePublicMembershipForAuthenticatedUser({required String org, required String username, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/public_members/${Uri.encodeComponent(username)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<RulesetVersion>>> orgsGetOrgRulesetHistory({required String org, required int rulesetId, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<RulesetVersion>> orgsGetOrgRulesetVersion({required String org, required int rulesetId, required int versionId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ImmutableReleasesOrganizationSettings>> orgsGetImmutableReleasesSettings({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsSetImmutableReleasesSettings({required String org, required OrgsSetImmutableReleasesSettingsRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/settings/immutable-releases',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<OrgsGetImmutableReleasesSettingsRepositoriesResponse>> orgsGetImmutableReleasesSettingsRepositories({required String org, int? page, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> orgsSetImmutableReleasesSettingsRepositories({required String org, required OrgsSetImmutableReleasesSettingsRepositoriesRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/orgs/${Uri.encodeComponent(org)}/settings/immutable-releases/repositories',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> orgsEnableSelectedRepositoryImmutableReleasesOrganization({required String org, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'PUT',
...
Future<ApiResult<void>> orgsDisableSelectedRepositoryImmutableReleasesOrganization({required String org, required int repositoryId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/settings/immutable-releases/repositories/${Uri.encodeComponent(repositoryId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<OrgMembership>>> orgsListMembershipsForAuthenticatedUser({OrgsListMembershipsForAuthenticatedUserState? state, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgMembership>> orgsGetMembershipForAuthenticatedUser({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgMembership>> orgsUpdateMembershipForAuthenticatedUser({required String org, required OrgsUpdateMembershipForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/user/memberships/orgs/${Uri.encodeComponent(org)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
///
/// `GET /user/orgs`
Future<ApiResult<List<OrganizationSimple>>> orgsListForAuthenticatedUser({int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/user/orgs',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<OrganizationSimple>>> orgsListForUser({required String username, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
