...
import 'repos_update_request_security_and_analysis_advanced_security.dart';
import 'repos_update_request_security_and_analysis_code_security.dart';
import 'repos_update_request_security_and_analysis_secret_scanning.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_ai_detection.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_delegated_alert_dismissal.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_delegated_bypass.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_delegated_bypass_options.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_non_provider_patterns.dart';
import 'repos_update_request_security_and_analysis_secret_scanning_push_protection.dart';
...
final class ReposUpdateRequestSecurityAndAnalysis {
  ...
  factory ReposUpdateRequestSecurityAndAnalysis.fromJson(
    ...
    return ReposUpdateRequestSecurityAndAnalysis(
      advancedSecurity: json['advanced_security'] != null
          ? ReposUpdateRequestSecurityAndAnalysisAdvancedSecurity.fromJson(
              json['advanced_security'] as Map<String, dynamic>,
            )
          : null,
      codeSecurity: json['code_security'] != null
          ? ReposUpdateRequestSecurityAndAnalysisCodeSecurity.fromJson(
              json['code_security'] as Map<String, dynamic>,
            )
          : null,
      secretScanning: json['secret_scanning'] != null
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanning.fromJson(
              json['secret_scanning'] as Map<String, dynamic>,
            )
          : null,
      secretScanningPushProtection:
          json['secret_scanning_push_protection'] != null
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningPushProtection.fromJson(
      ...
      secretScanningAiDetection: json['secret_scanning_ai_detection'] != null
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningAiDetection.fromJson(
              json['secret_scanning_ai_detection'] as Map<String, dynamic>,
            )
          : null,
      secretScanningNonProviderPatterns:
          json['secret_scanning_non_provider_patterns'] != null
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningNonProviderPatterns.fromJson(
      ...
      secretScanningDelegatedAlertDismissal:
          ...
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedAlertDismissal.fromJson(
      ...
      secretScanningDelegatedBypass:
          ...
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedBypass.fromJson(
      ...
      secretScanningDelegatedBypassOptions:
          ...
          ? ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedBypassOptions.fromJson(
  ...
  final ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedAlertDismissal?
  secretScanningDelegatedAlertDismissal;

  /// Use the `status` property to enable or disable secret scanning delegated bypass for this repository.
  final ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedBypass?
  secretScanningDelegatedBypass;
  ...
  final ReposUpdateRequestSecurityAndAnalysisSecretScanningDelegatedBypassOptions?
  secretScanningDelegatedBypassOptions;
  ...
  ReposUpdateRequestSecurityAndAnalysis copyWith({
    ReposUpdateRequestSecurityAndAnalysisAdvancedSecurity Function()?
    advancedSecurity,
    ReposUpdateRequestSecurityAndAnalysisCodeSecurity Function()? codeSecurity,
    ReposUpdateRequestSecurityAndAnalysisSecretScanning Function()?
    secretScanning,
    ReposUpdateRequestSecurityAndAnalysisSecretScanningPushProtection
    Function()?
    secretScanningPushProtection,
    ReposUpdateRequestSecurityAndAnalysisSecretScanningAiDetection Function()?
    secretScanningAiDetection,
