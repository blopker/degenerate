...
import 'gist_commit_change_status.dart';
...
final class GistCommit {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        ...
        json.containsKey('committed_at') &&
        json['committed_at'] is String;
  }
  ...
  @override
  int get hashCode {
    return Object.hash(url, version, user, changeStatus, committedAt);
  }
