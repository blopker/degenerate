...
import 'webhook_workflow_run_in_progress_workflow_run_head_repository_owner_type.dart';
...
final class WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner {
  ...
  factory WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner copyWith({
    ...
    WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType Function()?
    type,
    Uri Function()? url,
  }) {
    return WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner(
  ...
  @override
  String toString() {
    return 'WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
