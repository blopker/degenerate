...
final class MarketplacePurchaseMarketplacePurchase {
  ...
  factory MarketplacePurchaseMarketplacePurchase.fromJson(
    ...
    return MarketplacePurchaseMarketplacePurchase(
      ...
      plan: json['plan'] != null
          ? MarketplaceListingPlan.fromJson(
  ...
  MarketplacePurchaseMarketplacePurchase copyWith({
    String Function()? billingCycle,
    ...
    MarketplaceListingPlan Function()? plan,
  }) {
    return MarketplacePurchaseMarketplacePurchase(
