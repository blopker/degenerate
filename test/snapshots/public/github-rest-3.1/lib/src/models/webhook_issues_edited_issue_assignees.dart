...
import 'webhook_issues_edited_issue_assignees_type.dart';

final class WebhookIssuesEditedIssueAssignees {
  const WebhookIssuesEditedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesEditedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesEditedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesEditedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesEditedIssueAssignees copyWith({
    ...
    WebhookIssuesEditedIssueAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesEditedIssueAssignees(
