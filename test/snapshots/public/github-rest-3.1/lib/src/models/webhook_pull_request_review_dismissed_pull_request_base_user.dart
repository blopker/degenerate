...
import 'webhook_pull_request_review_dismissed_pull_request_base_user_type.dart';

final class WebhookPullRequestReviewDismissedPullRequestBaseUser {
  const WebhookPullRequestReviewDismissedPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewDismissedPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewDismissedPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewDismissedPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewDismissedPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestReviewDismissedPullRequestBaseUserType Function()? type,
    Uri Function()? url,
