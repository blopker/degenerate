...
import 'webhook_pull_request_labeled_pull_request_base_user_type.dart';

final class WebhookPullRequestLabeledPullRequestBaseUser {
  const WebhookPullRequestLabeledPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestLabeledPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestLabeledPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestLabeledPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestLabeledPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestLabeledPullRequestBaseUserType Function()? type,
    Uri Function()? url,
