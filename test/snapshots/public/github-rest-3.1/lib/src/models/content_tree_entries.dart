...
import 'content_tree_entries_links.dart';

final class ContentTreeEntries {
  const ContentTreeEntries({
    required this.type,
    required this.size,
    required this.name,
    required this.path,
  ...
  factory ContentTreeEntries.fromJson(Map<String, dynamic> json) {
    return ContentTreeEntries(
      ...
      links: ContentTreeEntriesLinks.fromJson(
  ...
  @override
  String toString() {
    return 'ContentTreeEntries(type: $type, size: $size, name: $name, path: $path, sha: $sha, url: $url, gitUrl: $gitUrl, htmlUrl: $htmlUrl, downloadUrl: $downloadUrl, links: $links)';
  }
}
