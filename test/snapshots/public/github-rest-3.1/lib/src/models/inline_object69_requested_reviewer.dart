...
import 'inline_object69_requested_reviewer_type.dart';
...
final class InlineObject69RequestedReviewer {
  ...
  factory InlineObject69RequestedReviewer.fromJson(Map<String, dynamic> json) {
    return InlineObject69RequestedReviewer(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69RequestedReviewerType.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject69RequestedReviewer copyWith({
    ...
    InlineObject69RequestedReviewerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69RequestedReviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
