...
import 'rate_limit_overview_resources.dart';
...
final class RateLimitOverview {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('resources') && json.containsKey('rate');
  }

  RateLimitOverview copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(resources, rate);
  }
