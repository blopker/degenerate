...
import 'inline_object72_pull_request_base_repo_created_at.dart';
import 'inline_object72_pull_request_base_repo_license.dart';
import 'inline_object72_pull_request_base_repo_merge_commit_message.dart';
import 'inline_object72_pull_request_base_repo_merge_commit_title.dart';
import 'inline_object72_pull_request_base_repo_owner.dart';
import 'inline_object72_pull_request_base_repo_permissions.dart';
import 'inline_object72_pull_request_base_repo_pull_request_creation_policy.dart';
import 'inline_object72_pull_request_base_repo_pushed_at.dart';
import 'inline_object72_pull_request_base_repo_squash_merge_commit_message.dart';
import 'inline_object72_pull_request_base_repo_squash_merge_commit_title.dart';
import 'inline_object72_pull_request_base_repo_visibility.dart';

/// A git repository
final class InlineObject72PullRequestBaseRepo {
  const InlineObject72PullRequestBaseRepo({
  ...
  factory InlineObject72PullRequestBaseRepo.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestBaseRepo(
      ...
      createdAt: InlineObject72PullRequestBaseRepoCreatedAt.fromJson(
        json['created_at'],
      ),
      ...
      pullRequestCreationPolicy: json['pull_request_creation_policy'] != null
          ? InlineObject72PullRequestBaseRepoPullRequestCreationPolicy.fromJson(
      ...
      license: InlineObject72PullRequestBaseRepoLicense.fromJson(
      ...
      mergeCommitMessage: json['merge_commit_message'] != null
          ? InlineObject72PullRequestBaseRepoMergeCommitMessage.fromJson(
              json['merge_commit_message'] as String,
            )
          : null,
      mergeCommitTitle: json['merge_commit_title'] != null
          ? InlineObject72PullRequestBaseRepoMergeCommitTitle.fromJson(
      ...
      owner: InlineObject72PullRequestBaseRepoOwner.fromJson(
        json['owner'] as Map<String, dynamic>,
      ),
      permissions: json['permissions'] != null
          ? InlineObject72PullRequestBaseRepoPermissions.fromJson(
      ...
      pushedAt: InlineObject72PullRequestBaseRepoPushedAt.fromJson(
        json['pushed_at'],
      ),
      ...
      squashMergeCommitMessage: json['squash_merge_commit_message'] != null
          ? InlineObject72PullRequestBaseRepoSquashMergeCommitMessage.fromJson(
              json['squash_merge_commit_message'] as String,
            )
          : null,
      squashMergeCommitTitle: json['squash_merge_commit_title'] != null
          ? InlineObject72PullRequestBaseRepoSquashMergeCommitTitle.fromJson(
      ...
      useSquashPrTitleAsDefault:
          ...
          : false,
      visibility: InlineObject72PullRequestBaseRepoVisibility.fromJson(
  ...
  final InlineObject72PullRequestBaseRepoPullRequestCreationPolicy?
  ...
  /// - `BLANK` - default to a blank commit message.
  final InlineObject72PullRequestBaseRepoSquashMergeCommitMessage?
  ...
  final InlineObject72PullRequestBaseRepoSquashMergeCommitTitle?
  ...
  InlineObject72PullRequestBaseRepo copyWith({
    ...
    String? contentsUrl,
    Uri? contributorsUrl,
    InlineObject72PullRequestBaseRepoCreatedAt? createdAt,
    ...
    InlineObject72PullRequestBaseRepoPullRequestCreationPolicy Function()?
    pullRequestCreationPolicy,
    ...
    Uri? languagesUrl,
    InlineObject72PullRequestBaseRepoLicense? Function()? license,
    String Function()? masterBranch,
    InlineObject72PullRequestBaseRepoMergeCommitMessage Function()?
    mergeCommitMessage,
    InlineObject72PullRequestBaseRepoMergeCommitTitle Function()?
    mergeCommitTitle,
    Uri? mergesUrl,
    ...
    InlineObject72PullRequestBaseRepoOwner? Function()? owner,
    InlineObject72PullRequestBaseRepoPermissions Function()? permissions,
    bool? private,
    bool Function()? public,
    String? pullsUrl,
    InlineObject72PullRequestBaseRepoPushedAt? Function()? pushedAt,
    String? releasesUrl,
    String? Function()? roleName,
    int? size,
    InlineObject72PullRequestBaseRepoSquashMergeCommitMessage Function()?
    squashMergeCommitMessage,
    InlineObject72PullRequestBaseRepoSquashMergeCommitTitle Function()?
    squashMergeCommitTitle,
    String? sshUrl,
    ...
    InlineObject72PullRequestBaseRepoVisibility? visibility,
    int? watchers,
    int? watchersCount,
