...
import 'webhook_pull_request_unassigned_pull_request_assignee_type.dart';

final class WebhookPullRequestUnassignedPullRequestAssignee {
  const WebhookPullRequestUnassignedPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestAssignee copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestAssigneeType Function()? type,
    Uri Function()? url,
