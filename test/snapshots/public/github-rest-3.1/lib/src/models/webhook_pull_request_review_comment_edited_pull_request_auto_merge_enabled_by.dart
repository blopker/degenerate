...
import 'webhook_pull_request_review_comment_edited_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
