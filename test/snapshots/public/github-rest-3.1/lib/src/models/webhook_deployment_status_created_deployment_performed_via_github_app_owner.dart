...
import 'webhook_deployment_status_created_deployment_performed_via_github_app_owner_type.dart';

final class WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner {
  const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType?
  type;
  ...
  WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner copyWith({
  ...
  @override
  String toString() {
    return 'WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
