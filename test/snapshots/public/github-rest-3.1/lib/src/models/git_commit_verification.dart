...
final class GitCommitVerification {
  ...
  GitCommitVerification copyWith({
    bool? verified,
    String? reason,
  ...
  @override
  String toString() {
    return 'GitCommitVerification(verified: $verified, reason: $reason, signature: $signature, payload: $payload, verifiedAt: $verifiedAt)';
  }
}
