...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_team_created_action.dart';import 'webhook_team_created_repository.dart';import 'webhooks_team1.dart';final class WebhookTeamCreated {const WebhookTeamCreated({required this.action, this.enterprise, this.installation, required this.organization, this.repository, required this.sender, required this.team, });
...
factory WebhookTeamCreated.fromJson(Map<String, dynamic> json) { return WebhookTeamCreated(
  ...
  repository: json['repository'] != null
        ? WebhookTeamCreatedRepository.fromJson(json['repository'] as Map<String, dynamic>)
        : null,
