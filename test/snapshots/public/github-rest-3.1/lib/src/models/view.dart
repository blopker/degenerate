...
import 'view_layout.dart';
import 'view_sort_by.dart';
...
final class View {
  ...
  factory View.fromJson(Map<String, dynamic> json) {
    return View(
      ...
      groupBy: (json['group_by'] as List<dynamic>)
          .map((e) => (e as num).toInt())
          .toList(),
      verticalGroupBy: (json['vertical_group_by'] as List<dynamic>)
          .map((e) => (e as num).toInt())
          .toList(),
    );
  }
  ...
  View copyWith({
    ...
    List<int>? visibleFields,
    List<List<ViewSortBy>>? sortBy,
    List<int>? groupBy,
    List<int>? verticalGroupBy,
  }) {
    return View(
      id: id ?? this.id,
  ...
  int get hashCode {
    return Object.hash(
      ...
      updatedAt,
      filter,
      Object.hashAll(visibleFields),
      Object.hashAll(sortBy),
      Object.hashAll(groupBy),
      Object.hashAll(verticalGroupBy),
    );
  }

  @override
  String toString() {
    return 'View(id: $id, number: $number, name: $name, layout: $layout, nodeId: $nodeId, projectUrl: $projectUrl, htmlUrl: $htmlUrl, creator: $creator, createdAt: $createdAt, updatedAt: $updatedAt, filter: $filter, visibleFields: $visibleFields, sortBy: $sortBy, groupBy: $groupBy, verticalGroupBy: $verticalGroupBy)';
  }
}
