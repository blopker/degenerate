...
final class WebhookIssueCommentCreatedIssueReactions {
  const WebhookIssueCommentCreatedIssueReactions({
    this.plus1,
    this.minus1,
    this.confused,
    this.eyes,
  ...
  factory WebhookIssueCommentCreatedIssueReactions.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentCreatedIssueReactions(
  ...
  WebhookIssueCommentCreatedIssueReactions copyWith({
    int Function()? plus1,
    int Function()? minus1,
  ...
  @override
  String toString() {
    return 'WebhookIssueCommentCreatedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
