...
final class OrgsUpdateWebhookConfigForOrgRequest {
  ...
  OrgsUpdateWebhookConfigForOrgRequest copyWith({
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'OrgsUpdateWebhookConfigForOrgRequest(url: $url, contentType: $contentType, secret: $secret, insecureSsl: $insecureSsl)';
  }
}
