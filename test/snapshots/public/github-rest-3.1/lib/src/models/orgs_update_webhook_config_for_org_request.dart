...
import 'webhook_config_insecure_ssl.dart';final class OrgsUpdateWebhookConfigForOrgRequest {const OrgsUpdateWebhookConfigForOrgRequest({this.url, this.contentType, this.secret, this.insecureSsl, });
...
OrgsUpdateWebhookConfigForOrgRequest copyWith({Uri Function()? url, String Function()? contentType, String Function()? secret, WebhookConfigInsecureSsl Function()? insecureSsl, }) { return OrgsUpdateWebhookConfigForOrgRequest(
