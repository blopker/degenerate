...
final class WebhookRepositoryTransferredChangesOwnerFromOrganization {
  const WebhookRepositoryTransferredChangesOwnerFromOrganization({
  ...
  factory WebhookRepositoryTransferredChangesOwnerFromOrganization.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookRepositoryTransferredChangesOwnerFromOrganization(
  ...
  WebhookRepositoryTransferredChangesOwnerFromOrganization copyWith({
    Uri? avatarUrl,
  ...
  @override
  String toString() {
    return 'WebhookRepositoryTransferredChangesOwnerFromOrganization(avatarUrl: $avatarUrl, description: $description, eventsUrl: $eventsUrl, hooksUrl: $hooksUrl, htmlUrl: $htmlUrl, id: $id, issuesUrl: $issuesUrl, login: $login, membersUrl: $membersUrl, nodeId: $nodeId, publicMembersUrl: $publicMembersUrl, reposUrl: $reposUrl, url: $url)';
  }
}
