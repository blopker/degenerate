...
final class DependencyGraphDiff2Vulnerabilities {
  const DependencyGraphDiff2Vulnerabilities({
  ...
  factory DependencyGraphDiff2Vulnerabilities.fromJson(
    Map<String, dynamic> json,
  ) {
    return DependencyGraphDiff2Vulnerabilities(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('severity') &&
        json['severity'] is String &&
        json.containsKey('advisory_ghsa_id') &&
        json['advisory_ghsa_id'] is String &&
        json.containsKey('advisory_summary') &&
        json['advisory_summary'] is String &&
        json.containsKey('advisory_url') &&
        json['advisory_url'] is String;
  }

  DependencyGraphDiff2Vulnerabilities copyWith({
    String? severity,
  ...
  @override
  int get hashCode {
    return Object.hash(severity, advisoryGhsaId, advisorySummary, advisoryUrl);
  }

  @override
  String toString() {
    return 'DependencyGraphDiff2Vulnerabilities(severity: $severity, advisoryGhsaId: $advisoryGhsaId, advisorySummary: $advisorySummary, advisoryUrl: $advisoryUrl)';
  }
}
