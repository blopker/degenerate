...
import 'contributor_activity_weeks.dart';
  ...
  factory ContributorActivity.fromJson(Map<String, dynamic> json) {
    return ContributorActivity(
      ...
      weeks: (json['weeks'] as List<dynamic>)
          .map(
            (e) => ContributorActivityWeeks.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ContributorActivity &&
            author == other.author &&
            total == other.total &&
            const ListEquality<dynamic>().equals(weeks, other.weeks);
  }

  @override
  int get hashCode {
    return Object.hash(author, total, Object.hashAll(weeks));
  }
