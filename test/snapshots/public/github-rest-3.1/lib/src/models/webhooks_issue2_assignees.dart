...
import 'webhooks_issue2_assignees_type.dart';

final class WebhooksIssue2Assignees {
  const WebhooksIssue2Assignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssue2Assignees.fromJson(Map<String, dynamic> json) {
    return WebhooksIssue2Assignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssue2AssigneesType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssue2Assignees copyWith({
    ...
    WebhooksIssue2AssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksIssue2Assignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
