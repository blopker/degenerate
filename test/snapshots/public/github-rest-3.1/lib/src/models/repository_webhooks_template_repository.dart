...
import 'repository_webhooks_template_repository_merge_commit_message.dart';
import 'repository_webhooks_template_repository_merge_commit_title.dart';
import 'repository_webhooks_template_repository_owner.dart';
import 'repository_webhooks_template_repository_permissions.dart';
import 'repository_webhooks_template_repository_squash_merge_commit_message.dart';
import 'repository_webhooks_template_repository_squash_merge_commit_title.dart';

final class RepositoryWebhooksTemplateRepository {
  const RepositoryWebhooksTemplateRepository({
    this.id,
    this.nodeId,
    this.name,
    this.fullName,
  ...
  factory RepositoryWebhooksTemplateRepository.fromJson(
    ...
    return RepositoryWebhooksTemplateRepository(
      ...
      owner: json['owner'] != null
          ? RepositoryWebhooksTemplateRepositoryOwner.fromJson(
      ...
      permissions: json['permissions'] != null
          ? RepositoryWebhooksTemplateRepositoryPermissions.fromJson(
  ...
  final RepositoryWebhooksTemplateRepositorySquashMergeCommitTitle?
  ...
  final RepositoryWebhooksTemplateRepositorySquashMergeCommitMessage?
  ...
  /// - `PR_BODY` - default to the pull request's body.
  /// - `BLANK` - default to a blank commit message.
  final RepositoryWebhooksTemplateRepositoryMergeCommitMessage?
  mergeCommitMessage;
  ...
  RepositoryWebhooksTemplateRepository copyWith({
    int Function()? id,
    String Function()? nodeId,
    String Function()? name,
    String Function()? fullName,
    RepositoryWebhooksTemplateRepositoryOwner Function()? owner,
    bool Function()? private,
    String Function()? htmlUrl,
    String Function()? description,
    bool Function()? fork,
    String Function()? url,
    String Function()? archiveUrl,
    String Function()? assigneesUrl,
    String Function()? blobsUrl,
    String Function()? branchesUrl,
    String Function()? collaboratorsUrl,
    String Function()? commentsUrl,
    String Function()? commitsUrl,
    String Function()? compareUrl,
    String Function()? contentsUrl,
    String Function()? contributorsUrl,
    String Function()? deploymentsUrl,
    String Function()? downloadsUrl,
    String Function()? eventsUrl,
    String Function()? forksUrl,
    String Function()? gitCommitsUrl,
    String Function()? gitRefsUrl,
    String Function()? gitTagsUrl,
    String Function()? gitUrl,
    String Function()? issueCommentUrl,
    String Function()? issueEventsUrl,
    String Function()? issuesUrl,
    String Function()? keysUrl,
    String Function()? labelsUrl,
    String Function()? languagesUrl,
    String Function()? mergesUrl,
    String Function()? milestonesUrl,
    String Function()? notificationsUrl,
    String Function()? pullsUrl,
    String Function()? releasesUrl,
    String Function()? sshUrl,
    String Function()? stargazersUrl,
    String Function()? statusesUrl,
    String Function()? subscribersUrl,
    String Function()? subscriptionUrl,
    String Function()? tagsUrl,
    String Function()? teamsUrl,
    String Function()? treesUrl,
    String Function()? cloneUrl,
    String Function()? mirrorUrl,
    String Function()? hooksUrl,
    String Function()? svnUrl,
    String Function()? homepage,
    String Function()? language,
    int Function()? forksCount,
    int Function()? stargazersCount,
    int Function()? watchersCount,
    int Function()? size,
    String Function()? defaultBranch,
    int Function()? openIssuesCount,
    bool Function()? isTemplate,
    List<String> Function()? topics,
    bool Function()? hasIssues,
    bool Function()? hasProjects,
    bool Function()? hasWiki,
    bool Function()? hasPages,
    bool Function()? hasDownloads,
    bool Function()? archived,
    bool Function()? disabled,
    String Function()? visibility,
    String Function()? pushedAt,
    String Function()? createdAt,
    String Function()? updatedAt,
    RepositoryWebhooksTemplateRepositoryPermissions Function()? permissions,
    ...
    RepositoryWebhooksTemplateRepositorySquashMergeCommitTitle Function()?
    squashMergeCommitTitle,
    RepositoryWebhooksTemplateRepositorySquashMergeCommitMessage Function()?
    squashMergeCommitMessage,
    RepositoryWebhooksTemplateRepositoryMergeCommitTitle Function()?
    mergeCommitTitle,
    RepositoryWebhooksTemplateRepositoryMergeCommitMessage Function()?
    mergeCommitMessage,
    ...
    return RepositoryWebhooksTemplateRepository(
      ...
      collaboratorsUrl: collaboratorsUrl != null
          ? collaboratorsUrl()
          : this.collaboratorsUrl,
      ...
      contributorsUrl: contributorsUrl != null
          ? contributorsUrl()
          : this.contributorsUrl,
      deploymentsUrl: deploymentsUrl != null
          ? deploymentsUrl()
          : this.deploymentsUrl,
      ...
      gitCommitsUrl: gitCommitsUrl != null
          ? gitCommitsUrl()
          : this.gitCommitsUrl,
      ...
      issueCommentUrl: issueCommentUrl != null
          ? issueCommentUrl()
          : this.issueCommentUrl,
      issueEventsUrl: issueEventsUrl != null
          ? issueEventsUrl()
          : this.issueEventsUrl,
      ...
      milestonesUrl: milestonesUrl != null
          ? milestonesUrl()
          : this.milestonesUrl,
      ...
      stargazersUrl: stargazersUrl != null
          ? stargazersUrl()
          : this.stargazersUrl,
      statusesUrl: statusesUrl != null ? statusesUrl() : this.statusesUrl,
      subscribersUrl: subscribersUrl != null
          ? subscribersUrl()
          : this.subscribersUrl,
      ...
      stargazersCount: stargazersCount != null
          ? stargazersCount()
          : this.stargazersCount,
      watchersCount: watchersCount != null
          ? watchersCount()
          : this.watchersCount,
      ...
      defaultBranch: defaultBranch != null
          ? defaultBranch()
          : this.defaultBranch,
      openIssuesCount: openIssuesCount != null
          ? openIssuesCount()
          : this.openIssuesCount,
