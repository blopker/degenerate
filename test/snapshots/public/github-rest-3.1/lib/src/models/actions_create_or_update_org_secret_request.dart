...
import 'actions_create_or_update_org_secret_request_visibility.dart';

final class ActionsCreateOrUpdateOrgSecretRequest {
  ...
  ActionsCreateOrUpdateOrgSecretRequest copyWith({
  ...
  @override
  String toString() {
    return 'ActionsCreateOrUpdateOrgSecretRequest(encryptedValue: $encryptedValue, keyId: $keyId, visibility: $visibility, selectedRepositoryIds: $selectedRepositoryIds)';
  }
}
