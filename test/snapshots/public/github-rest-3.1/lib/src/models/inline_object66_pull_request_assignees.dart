...
import 'inline_object66_pull_request_assignees_type.dart';

final class InlineObject66PullRequestAssignees {
  const InlineObject66PullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestAssignees copyWith({
    ...
    InlineObject66PullRequestAssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject66PullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
