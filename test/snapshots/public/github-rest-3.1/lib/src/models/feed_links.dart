...
final class FeedLinks {
    ...
    return FeedLinks(
      ...
      currentUserOrganizations:
          (json['current_user_organizations'] as List<dynamic>?)
              ?.map((e) => LinkWithType.fromJson(e as Map<String, dynamic>))
              .toList(),
      ...
      repositoryDiscussionsCategory:
          json['repository_discussions_category'] != null
          ? LinkWithType.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('timeline') && json.containsKey('user');
  }

  FeedLinks copyWith({
    LinkWithType? timeline,
    LinkWithType? user,
    LinkWithType Function()? securityAdvisories,
    LinkWithType Function()? currentUser,
    LinkWithType Function()? currentUserPublic,
    LinkWithType Function()? currentUserActor,
    LinkWithType Function()? currentUserOrganization,
    List<LinkWithType> Function()? currentUserOrganizations,
    LinkWithType Function()? repositoryDiscussions,
    LinkWithType Function()? repositoryDiscussionsCategory,
  }) {
    return FeedLinks(
      timeline: timeline ?? this.timeline,
      user: user ?? this.user,
      securityAdvisories: securityAdvisories != null
          ? securityAdvisories()
          : this.securityAdvisories,
      currentUser: currentUser != null ? currentUser() : this.currentUser,
      currentUserPublic: currentUserPublic != null
          ? currentUserPublic()
          : this.currentUserPublic,
      currentUserActor: currentUserActor != null
          ? currentUserActor()
          : this.currentUserActor,
      currentUserOrganization: currentUserOrganization != null
          ? currentUserOrganization()
          : this.currentUserOrganization,
      currentUserOrganizations: currentUserOrganizations != null
          ? currentUserOrganizations()
          : this.currentUserOrganizations,
      repositoryDiscussions: repositoryDiscussions != null
          ? repositoryDiscussions()
          : this.repositoryDiscussions,
      repositoryDiscussionsCategory: repositoryDiscussionsCategory != null
          ? repositoryDiscussionsCategory()
          : this.repositoryDiscussionsCategory,
    );
  }
  ...
  int get hashCode {
    return Object.hash(
      ...
      currentUserActor,
      currentUserOrganization,
      Object.hashAll(currentUserOrganizations ?? const []),
      repositoryDiscussions,
      repositoryDiscussionsCategory,
    );
  }
