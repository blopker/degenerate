...
final class SecretScanningLocationPullRequestReview {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('pull_request_review_url') &&
        json['pull_request_review_url'] is String;
  }

  SecretScanningLocationPullRequestReview copyWith({
    Uri? pullRequestReviewUrl,
  }) {
    return SecretScanningLocationPullRequestReview(
  ...
  @override
  int get hashCode {
    return pullRequestReviewUrl.hashCode;
  }

  @override
  String toString() {
    return 'SecretScanningLocationPullRequestReview(pullRequestReviewUrl: $pullRequestReviewUrl)';
  }
}
