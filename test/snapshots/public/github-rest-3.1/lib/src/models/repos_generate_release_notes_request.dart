...
final class ReposGenerateReleaseNotesRequest {
  ...
  ReposGenerateReleaseNotesRequest copyWith({
    String? tagName,
    String Function()? targetCommitish,
    String Function()? previousTagName,
    String Function()? configurationFilePath,
  }) {
    return ReposGenerateReleaseNotesRequest(
      ...
      previousTagName: previousTagName != null
          ? previousTagName()
          : this.previousTagName,
      configurationFilePath: configurationFilePath != null
  ...
  @override
  String toString() {
    return 'ReposGenerateReleaseNotesRequest(tagName: $tagName, targetCommitish: $targetCommitish, previousTagName: $previousTagName, configurationFilePath: $configurationFilePath)';
  }
}
