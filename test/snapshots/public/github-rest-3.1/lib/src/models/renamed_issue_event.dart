...
import 'renamed_issue_event_rename.dart';
import 'simple_user.dart';

/// Renamed Issue Event
final class RenamedIssueEvent {
  ...
  @override
  String toString() {
    return 'RenamedIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, rename: $rename)';
  }
}
