...
import 'hook_delivery_request.dart';
import 'hook_delivery_response.dart';
...
final class HookDelivery {
  ...
  factory HookDelivery.fromJson(Map<String, dynamic> json) {
    return HookDelivery(
      ...
      throttledAt: json['throttled_at'] != null
          ? DateTime.parse(json['throttled_at'] as String)
          : null,
  ...
  HookDelivery copyWith({
    ...
    int? Function()? installationId,
    int? Function()? repositoryId,
    DateTime? Function()? throttledAt,
    String Function()? url,
  ...
  @override
  String toString() {
    return 'HookDelivery(id: $id, guid: $guid, deliveredAt: $deliveredAt, redelivery: $redelivery, duration: $duration, status: $status, statusCode: $statusCode, event: $event, action: $action, installationId: $installationId, repositoryId: $repositoryId, throttledAt: $throttledAt, url: $url, request: $request, response: $response)';
  }
}
