...
import 'community_profile_files.dart';
...
final class CommunityProfile {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('health_percentage') &&
        json['health_percentage'] is num &&
        json.containsKey('description') &&
        json['description'] is String &&
        json.containsKey('documentation') &&
  ...
  CommunityProfile copyWith({
    ...
    bool Function()? contentReportsEnabled,
  }) {
    return CommunityProfile(
      ...
      contentReportsEnabled: contentReportsEnabled != null
  ...
  @override
  String toString() {
    return 'CommunityProfile(healthPercentage: $healthPercentage, description: $description, documentation: $documentation, files: $files, updatedAt: $updatedAt, contentReportsEnabled: $contentReportsEnabled)';
  }
}
