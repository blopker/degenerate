...
import 'inline_object72_pull_request_head_repo_created_at.dart';
import 'inline_object72_pull_request_head_repo_license.dart';
import 'inline_object72_pull_request_head_repo_merge_commit_message.dart';
import 'inline_object72_pull_request_head_repo_merge_commit_title.dart';
import 'inline_object72_pull_request_head_repo_owner.dart';
import 'inline_object72_pull_request_head_repo_permissions.dart';
import 'inline_object72_pull_request_head_repo_pull_request_creation_policy.dart';
import 'inline_object72_pull_request_head_repo_pushed_at.dart';
import 'inline_object72_pull_request_head_repo_squash_merge_commit_message.dart';
import 'inline_object72_pull_request_head_repo_squash_merge_commit_title.dart';
import 'inline_object72_pull_request_head_repo_visibility.dart';

/// A git repository
final class InlineObject72PullRequestHeadRepo {
  const InlineObject72PullRequestHeadRepo({
  ...
  factory InlineObject72PullRequestHeadRepo.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestHeadRepo(
      ...
      createdAt: InlineObject72PullRequestHeadRepoCreatedAt.fromJson(
        json['created_at'],
      ),
      ...
      pullRequestCreationPolicy: json['pull_request_creation_policy'] != null
          ? InlineObject72PullRequestHeadRepoPullRequestCreationPolicy.fromJson(
      ...
      license: InlineObject72PullRequestHeadRepoLicense.fromJson(
      ...
      mergeCommitMessage: json['merge_commit_message'] != null
          ? InlineObject72PullRequestHeadRepoMergeCommitMessage.fromJson(
              json['merge_commit_message'] as String,
            )
          : null,
      mergeCommitTitle: json['merge_commit_title'] != null
          ? InlineObject72PullRequestHeadRepoMergeCommitTitle.fromJson(
      ...
      owner: InlineObject72PullRequestHeadRepoOwner.fromJson(
        json['owner'] as Map<String, dynamic>,
      ),
      permissions: json['permissions'] != null
          ? InlineObject72PullRequestHeadRepoPermissions.fromJson(
      ...
      pushedAt: InlineObject72PullRequestHeadRepoPushedAt.fromJson(
        json['pushed_at'],
      ),
      ...
      squashMergeCommitMessage: json['squash_merge_commit_message'] != null
          ? InlineObject72PullRequestHeadRepoSquashMergeCommitMessage.fromJson(
              json['squash_merge_commit_message'] as String,
            )
          : null,
      squashMergeCommitTitle: json['squash_merge_commit_title'] != null
          ? InlineObject72PullRequestHeadRepoSquashMergeCommitTitle.fromJson(
      ...
      useSquashPrTitleAsDefault:
          ...
          : false,
      visibility: InlineObject72PullRequestHeadRepoVisibility.fromJson(
  ...
  final InlineObject72PullRequestHeadRepoPullRequestCreationPolicy?
  ...
  /// - `BLANK` - default to a blank commit message.
  final InlineObject72PullRequestHeadRepoSquashMergeCommitMessage?
  ...
  final InlineObject72PullRequestHeadRepoSquashMergeCommitTitle?
  ...
  InlineObject72PullRequestHeadRepo copyWith({
    ...
    String? contentsUrl,
    Uri? contributorsUrl,
    InlineObject72PullRequestHeadRepoCreatedAt? createdAt,
    ...
    InlineObject72PullRequestHeadRepoPullRequestCreationPolicy Function()?
    pullRequestCreationPolicy,
    ...
    Uri? languagesUrl,
    InlineObject72PullRequestHeadRepoLicense? Function()? license,
    String Function()? masterBranch,
    InlineObject72PullRequestHeadRepoMergeCommitMessage Function()?
    mergeCommitMessage,
    InlineObject72PullRequestHeadRepoMergeCommitTitle Function()?
    mergeCommitTitle,
    Uri? mergesUrl,
    ...
    InlineObject72PullRequestHeadRepoOwner? Function()? owner,
    InlineObject72PullRequestHeadRepoPermissions Function()? permissions,
    bool? private,
    bool Function()? public,
    String? pullsUrl,
    InlineObject72PullRequestHeadRepoPushedAt? Function()? pushedAt,
    String? releasesUrl,
    String? Function()? roleName,
    int? size,
    InlineObject72PullRequestHeadRepoSquashMergeCommitMessage Function()?
    squashMergeCommitMessage,
    InlineObject72PullRequestHeadRepoSquashMergeCommitTitle Function()?
    squashMergeCommitTitle,
    String? sshUrl,
    ...
    InlineObject72PullRequestHeadRepoVisibility? visibility,
    int? watchers,
    int? watchersCount,
