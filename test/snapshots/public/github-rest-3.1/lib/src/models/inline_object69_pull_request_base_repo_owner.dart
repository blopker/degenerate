...
import 'inline_object69_pull_request_base_repo_owner_type.dart';

final class InlineObject69PullRequestBaseRepoOwner {
  const InlineObject69PullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestBaseRepoOwner copyWith({
    ...
    InlineObject69PullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69PullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
