...
import 'webhook_issues_opened_changes_old_repository_owner_type.dart';

final class WebhookIssuesOpenedChangesOldRepositoryOwner {
  const WebhookIssuesOpenedChangesOldRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedChangesOldRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedChangesOldRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedChangesOldRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedChangesOldRepositoryOwner copyWith({
    ...
    WebhookIssuesOpenedChangesOldRepositoryOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesOpenedChangesOldRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
