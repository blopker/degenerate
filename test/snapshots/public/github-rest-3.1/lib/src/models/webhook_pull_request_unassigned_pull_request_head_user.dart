...
import 'webhook_pull_request_unassigned_pull_request_head_user_type.dart';

final class WebhookPullRequestUnassignedPullRequestHeadUser {
  const WebhookPullRequestUnassignedPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestHeadUserType Function()? type,
    Uri Function()? url,
