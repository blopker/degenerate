...
import 'webhook_issues_opened_issue_performed_via_github_app_owner_type.dart';

final class WebhookIssuesOpenedIssuePerformedViaGithubAppOwner {
  const WebhookIssuesOpenedIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesOpenedIssuePerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
