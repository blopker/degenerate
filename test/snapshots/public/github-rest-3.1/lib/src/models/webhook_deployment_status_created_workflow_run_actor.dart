...
import 'webhook_deployment_status_created_workflow_run_actor_type.dart';

final class WebhookDeploymentStatusCreatedWorkflowRunActor {
  const WebhookDeploymentStatusCreatedWorkflowRunActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentStatusCreatedWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentStatusCreatedWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentStatusCreatedWorkflowRunActor copyWith({
    ...
    WebhookDeploymentStatusCreatedWorkflowRunActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentStatusCreatedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
