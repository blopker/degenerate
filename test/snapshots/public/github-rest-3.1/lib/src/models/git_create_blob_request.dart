...
final class GitCreateBlobRequest {
  ...
  @override
  int get hashCode {
    return Object.hash(content, encoding);
  }

  @override
  String toString() {
    return 'GitCreateBlobRequest(content: $content, encoding: $encoding)';
  }
}
