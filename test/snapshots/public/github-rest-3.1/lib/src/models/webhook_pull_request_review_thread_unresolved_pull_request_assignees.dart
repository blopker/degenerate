...
import 'webhook_pull_request_review_thread_unresolved_pull_request_assignees_type.dart';

final class WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees {
  const WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees copyWith({
    ...
    WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneesType Function()?
    type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees(
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadUnresolvedPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
