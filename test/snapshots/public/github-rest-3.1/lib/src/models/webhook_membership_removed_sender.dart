...
import 'webhook_membership_removed_sender_type.dart';

final class WebhookMembershipRemovedSender {
  const WebhookMembershipRemovedSender({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookMembershipRemovedSender.fromJson(Map<String, dynamic> json) {
    return WebhookMembershipRemovedSender(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookMembershipRemovedSenderType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookMembershipRemovedSender copyWith({
    ...
    WebhookMembershipRemovedSenderType Function()? type,
    Uri Function()? url,
