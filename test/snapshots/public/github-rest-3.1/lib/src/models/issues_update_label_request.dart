...
final class IssuesUpdateLabelRequest {
  ...
  IssuesUpdateLabelRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(newName, color, description);
  }

  @override
  String toString() {
    return 'IssuesUpdateLabelRequest(newName: $newName, color: $color, description: $description)';
  }
}
