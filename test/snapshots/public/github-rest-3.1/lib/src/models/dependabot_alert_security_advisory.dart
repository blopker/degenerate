...
import 'dependabot_alert_security_advisory_cvss.dart';
import 'dependabot_alert_security_advisory_cwes.dart';
import 'dependabot_alert_security_advisory_identifiers.dart';
import 'dependabot_alert_security_advisory_references.dart';
import 'dependabot_alert_security_advisory_severity.dart';
...
final class DependabotAlertSecurityAdvisory {
  ...
  factory DependabotAlertSecurityAdvisory.fromJson(Map<String, dynamic> json) {
    return DependabotAlertSecurityAdvisory(
      ...
      cwes: (json['cwes'] as List<dynamic>)
          .map(
            (e) => DependabotAlertSecurityAdvisoryCwes.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      identifiers: (json['identifiers'] as List<dynamic>)
          .map(
            (e) => DependabotAlertSecurityAdvisoryIdentifiers.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      references: (json['references'] as List<dynamic>)
          .map(
            (e) => DependabotAlertSecurityAdvisoryReferences.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
  ...
  DependabotAlertSecurityAdvisory copyWith({
    String? ghsaId,
    String? Function()? cveId,
    String? summary,
    String? description,
    List<DependabotAlertSecurityVulnerability>? vulnerabilities,
    DependabotAlertSecurityAdvisorySeverity? severity,
    DependabotAlertSecurityAdvisoryCvss? cvss,
    CvssSeverities Function()? cvssSeverities,
    SecurityAdvisoryEpss Function()? epss,
    List<DependabotAlertSecurityAdvisoryCwes>? cwes,
    List<DependabotAlertSecurityAdvisoryIdentifiers>? identifiers,
    List<DependabotAlertSecurityAdvisoryReferences>? references,
