...
import 'code_security_create_configuration_for_enterprise_request_advanced_security.dart';
import 'code_security_create_configuration_for_enterprise_request_code_scanning_default_setup.dart';
import 'code_security_create_configuration_for_enterprise_request_code_scanning_delegated_alert_dismissal.dart';
import 'code_security_create_configuration_for_enterprise_request_code_security.dart';
import 'code_security_create_configuration_for_enterprise_request_dependabot_alerts.dart';
import 'code_security_create_configuration_for_enterprise_request_dependabot_security_updates.dart';
import 'code_security_create_configuration_for_enterprise_request_dependency_graph.dart';
import 'code_security_create_configuration_for_enterprise_request_dependency_graph_autosubmit_action.dart';
import 'code_security_create_configuration_for_enterprise_request_dependency_graph_autosubmit_action_options.dart';
import 'code_security_create_configuration_for_enterprise_request_enforcement.dart';
import 'code_security_create_configuration_for_enterprise_request_private_vulnerability_reporting.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_protection.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_delegated_alert_dismissal.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_extended_metadata.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_generic_secrets.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_non_provider_patterns.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_push_protection.dart';
import 'code_security_create_configuration_for_enterprise_request_secret_scanning_validity_checks.dart';
...
final class CodeSecurityCreateConfigurationForEnterpriseRequest {
  const CodeSecurityCreateConfigurationForEnterpriseRequest({
    ...
    this.advancedSecurity =
        CodeSecurityCreateConfigurationForEnterpriseRequestAdvancedSecurity
            .disabled,
    this.codeSecurity,
    ...
    this.secretScanningGenericSecrets =
        CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningGenericSecrets
            .disabled,
    ...
    this.secretScanningExtendedMetadata =
        CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningExtendedMetadata
            .disabled,
    this.privateVulnerabilityReporting =
        CodeSecurityCreateConfigurationForEnterpriseRequestPrivateVulnerabilityReporting
            .disabled,
    this.enforcement =
        CodeSecurityCreateConfigurationForEnterpriseRequestEnforcement.enforced,
  });
  ...
  factory CodeSecurityCreateConfigurationForEnterpriseRequest.fromJson(
    ...
    return CodeSecurityCreateConfigurationForEnterpriseRequest(
      ...
      advancedSecurity: json.containsKey('advanced_security')
          ? CodeSecurityCreateConfigurationForEnterpriseRequestAdvancedSecurity.fromJson(
              json['advanced_security'] as String,
            )
          : CodeSecurityCreateConfigurationForEnterpriseRequestAdvancedSecurity
                .disabled,
      codeSecurity: json['code_security'] != null
          ? CodeSecurityCreateConfigurationForEnterpriseRequestCodeSecurity.fromJson(
      ...
      dependencyGraphAutosubmitAction:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestDependencyGraphAutosubmitAction.fromJson(
      ...
      dependencyGraphAutosubmitActionOptions:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestDependencyGraphAutosubmitActionOptions.fromJson(
      ...
      dependabotSecurityUpdates: json.containsKey('dependabot_security_updates')
          ? CodeSecurityCreateConfigurationForEnterpriseRequestDependabotSecurityUpdates.fromJson(
      ...
      codeScanningDefaultSetup: json.containsKey('code_scanning_default_setup')
          ? CodeSecurityCreateConfigurationForEnterpriseRequestCodeScanningDefaultSetup.fromJson(
      ...
      codeScanningDelegatedAlertDismissal:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestCodeScanningDelegatedAlertDismissal.fromJson(
              json['code_scanning_delegated_alert_dismissal'] as String,
            )
          : CodeSecurityCreateConfigurationForEnterpriseRequestCodeScanningDelegatedAlertDismissal
                .disabled,
      secretProtection: json['secret_protection'] != null
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretProtection.fromJson(
              json['secret_protection'] as String,
            )
          : null,
      secretScanning: json.containsKey('secret_scanning')
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanning.fromJson(
      ...
      secretScanningPushProtection:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningPushProtection.fromJson(
      ...
      secretScanningValidityChecks:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningValidityChecks.fromJson(
      ...
      secretScanningNonProviderPatterns:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningNonProviderPatterns.fromJson(
      ...
      secretScanningGenericSecrets:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningGenericSecrets.fromJson(
      ...
      secretScanningDelegatedAlertDismissal:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningDelegatedAlertDismissal.fromJson(
      ...
      secretScanningExtendedMetadata:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningExtendedMetadata.fromJson(
      ...
      privateVulnerabilityReporting:
          ...
          ? CodeSecurityCreateConfigurationForEnterpriseRequestPrivateVulnerabilityReporting.fromJson(
              json['private_vulnerability_reporting'] as String,
            )
          : CodeSecurityCreateConfigurationForEnterpriseRequestPrivateVulnerabilityReporting
                .disabled,
      enforcement: json.containsKey('enforcement')
          ? CodeSecurityCreateConfigurationForEnterpriseRequestEnforcement.fromJson(
              json['enforcement'] as String,
            )
          : CodeSecurityCreateConfigurationForEnterpriseRequestEnforcement
                .enforced,
    );
  }
  ...
  final CodeSecurityCreateConfigurationForEnterpriseRequestCodeSecurity?
  codeSecurity;
  ...
  final CodeSecurityCreateConfigurationForEnterpriseRequestSecretProtection?
  secretProtection;
  ...
  final CodeSecurityCreateConfigurationForEnterpriseRequestSecretScanningExtendedMetadata
  secretScanningExtendedMetadata;
  ...
  CodeSecurityCreateConfigurationForEnterpriseRequest copyWith({
    String? name,
    String? description,
    CodeSecurityCreateConfigurationForEnterpriseRequestAdvancedSecurity
    Function()?
    advancedSecurity,
    CodeSecurityCreateConfigurationForEnterpriseRequestCodeSecurity Function()?
    codeSecurity,
    CodeSecurityCreateConfigurationForEnterpriseRequestDependencyGraph
    Function()?
    dependencyGraph,
    ...
    Function()?
    privateVulnerabilityReporting,
    CodeSecurityCreateConfigurationForEnterpriseRequestEnforcement Function()?
    enforcement,
  }) {
    return CodeSecurityCreateConfigurationForEnterpriseRequest(
      name: name ?? this.name,
