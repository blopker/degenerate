...
import 'file_commit_content_links.dart';

final class FileCommitContent {
  ...
  factory FileCommitContent.fromJson(Map<String, dynamic> json) {
    return FileCommitContent(
      ...
      links: json['_links'] != null
          ? FileCommitContentLinks.fromJson(
  ...
  FileCommitContent copyWith({
    ...
    FileCommitContentLinks Function()? links,
  }) {
    return FileCommitContent(
