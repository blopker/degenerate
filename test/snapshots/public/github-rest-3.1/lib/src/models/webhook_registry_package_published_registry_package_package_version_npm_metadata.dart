...
import 'webhook_registry_package_published_registry_package_package_version_npm_metadata_author.dart';
import 'webhook_registry_package_published_registry_package_package_version_npm_metadata_bugs.dart';
import 'webhook_registry_package_published_registry_package_package_version_npm_metadata_directories.dart';
import 'webhook_registry_package_published_registry_package_package_version_npm_metadata_dist.dart';
import 'webhook_registry_package_published_registry_package_package_version_npm_metadata_repository.dart';

final class WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata {
  const WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata({
    this.name,
    this.version,
    this.npmUser,
    this.author,
  ...
  factory WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata.fromJson(
    ...
    return WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata(
      ...
      author: json['author'] != null
          ? WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataAuthor.fromJson(
              json['author'],
            )
          : null,
      bugs: json['bugs'] != null
          ? WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataBugs.fromJson(
              json['bugs'],
            )
          : null,
      ...
      optionalDependencies:
          (json['optional_dependencies'] as Map<String, dynamic>?)?.map(
            (k, v) => MapEntry(k, v as String),
          ),
      description: json['description'] as String?,
      dist: json['dist'] != null
          ? WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDist.fromJson(
              json['dist'],
            )
          : null,
      ...
      repository: json['repository'] != null
          ? WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataRepository.fromJson(
              json['repository'],
            )
          : null,
      ...
      man: (json['man'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, v as String),
      ),
      directories: json['directories'] != null
          ? WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDirectories.fromJson(
              json['directories'],
            )
          : null,
      ...
      releaseId: json['release_id'] != null
          ? (json['release_id'] as num).toInt()
          : null,
      commitOid: json['commit_oid'] as String?,
      publishedViaActions: json['published_via_actions'] as bool?,
      deletedById: json['deleted_by_id'] != null
          ? (json['deleted_by_id'] as num).toInt()
          : null,
    );
  }
  ...
  final WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataAuthor?
  author;

  final WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataBugs?
  bugs;
  ...
  final WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDist?
  dist;
  ...
  final WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataRepository?
  repository;
  ...
  final WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDirectories?
  directories;
  ...
  copyWith({
    ...
    String Function()? npmUser,
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataAuthor?
    Function()?
    author,
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataBugs?
    Function()?
    bugs,
    Map<String, String> Function()? dependencies,
    Map<String, String> Function()? devDependencies,
    Map<String, String> Function()? peerDependencies,
    Map<String, String> Function()? optionalDependencies,
    String Function()? description,
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDist?
    Function()?
    dist,
    String Function()? gitHead,
    ...
    Function()?
    repository,
    Map<String, String> Function()? scripts,
    String Function()? id,
    String Function()? nodeVersion,
    String Function()? npmVersion,
    bool Function()? hasShrinkwrap,
    List<String> Function()? maintainers,
    List<String> Function()? contributors,
    Map<String, String> Function()? engines,
    List<String> Function()? keywords,
    List<String> Function()? files,
    Map<String, String> Function()? bin,
    Map<String, String> Function()? man,
    WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadataDirectories?
    Function()?
    directories,
    List<String> Function()? os,
    List<String> Function()? cpu,
    String Function()? readme,
    String Function()? installationCommand,
    int Function()? releaseId,
    String Function()? commitOid,
    bool Function()? publishedViaActions,
    int Function()? deletedById,
  }) {
    return WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata(
      ...
      hasShrinkwrap: hasShrinkwrap != null
          ? hasShrinkwrap()
          : this.hasShrinkwrap,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is WebhookRegistryPackagePublishedRegistryPackagePackageVersionNpmMetadata &&
            name == other.name &&
            ...
            const ListEquality<dynamic>().equals(os, other.os) &&
            const ListEquality<dynamic>().equals(cpu, other.cpu) &&
            readme == other.readme &&
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      Object.hashAll(contributors ?? const []),
      engines,
      Object.hashAll(keywords ?? const []),
      Object.hashAll(files ?? const []),
      bin,
      man,
      directories,
      Object.hashAll(os ?? const []),
      Object.hashAll(cpu ?? const []),
      readme,
      installationCommand,
      releaseId,
      commitOid,
