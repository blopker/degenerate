...
final class RepositoryCodeSearchIndexStatus {
  ...
  factory RepositoryCodeSearchIndexStatus.fromJson(Map<String, dynamic> json) {
    return RepositoryCodeSearchIndexStatus(
  ...
  RepositoryCodeSearchIndexStatus copyWith({
    bool Function()? lexicalSearchOk,
    String Function()? lexicalCommitSha,
  }) {
    return RepositoryCodeSearchIndexStatus(
      lexicalSearchOk: lexicalSearchOk != null
          ? lexicalSearchOk()
          : this.lexicalSearchOk,
      lexicalCommitSha: lexicalCommitSha != null
          ? lexicalCommitSha()
          : this.lexicalCommitSha,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(lexicalSearchOk, lexicalCommitSha);
  }

  @override
  String toString() {
    return 'RepositoryCodeSearchIndexStatus(lexicalSearchOk: $lexicalSearchOk, lexicalCommitSha: $lexicalCommitSha)';
  }
}
