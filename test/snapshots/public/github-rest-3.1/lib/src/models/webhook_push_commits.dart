...
import 'package:collection/collection.dart';import 'webhook_push_commits_author.dart';import 'webhook_push_commits_committer.dart';final class WebhookPushCommits {const WebhookPushCommits({this.added, required this.author, required this.committer, required this.distinct, required this.id, required this.message, this.modified, this.removed, required this.timestamp, required this.treeId, required this.url, });
