...
import 'webhook_issues_demilestoned_issue_user_type.dart';

final class WebhookIssuesDemilestonedIssueUser {
  const WebhookIssuesDemilestonedIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesDemilestonedIssueUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesDemilestonedIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesDemilestonedIssueUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesDemilestonedIssueUser copyWith({
    ...
    WebhookIssuesDemilestonedIssueUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesDemilestonedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
