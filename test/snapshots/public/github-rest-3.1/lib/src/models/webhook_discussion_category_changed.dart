...
import 'discussion.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_discussion_category_changed_action.dart';import 'webhook_discussion_category_changed_changes.dart';final class WebhookDiscussionCategoryChanged {const WebhookDiscussionCategoryChanged({required this.action, required this.changes, required this.discussion, this.enterprise, this.installation, this.organization, required this.repository, required this.sender, });
