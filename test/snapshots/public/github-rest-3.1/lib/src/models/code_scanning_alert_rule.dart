...
import 'code_scanning_alert_rule_security_severity_level.dart';
import 'code_scanning_alert_rule_severity.dart';
...
final class CodeScanningAlertRule {
  ...
  factory CodeScanningAlertRule.fromJson(Map<String, dynamic> json) {
    return CodeScanningAlertRule(
      ...
      severity: json['severity'] != null
          ? CodeScanningAlertRuleSeverity.fromJson(json['severity'] as String)
          : null,
      securitySeverityLevel: json['security_severity_level'] != null
          ? CodeScanningAlertRuleSecuritySeverityLevel.fromJson(
  ...
  CodeScanningAlertRule copyWith({
    String? Function()? id,
    String Function()? name,
    CodeScanningAlertRuleSeverity? Function()? severity,
    CodeScanningAlertRuleSecuritySeverityLevel? Function()?
  ...
  @override
  String toString() {
    return 'CodeScanningAlertRule(id: $id, name: $name, severity: $severity, securitySeverityLevel: $securitySeverityLevel, description: $description, fullDescription: $fullDescription, tags: $tags, help: $help, helpUri: $helpUri)';
  }
}
