...
import 'webhook_issues_reopened_issue_assignees_type.dart';

final class WebhookIssuesReopenedIssueAssignees {
  const WebhookIssuesReopenedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesReopenedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesReopenedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesReopenedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesReopenedIssueAssignees copyWith({
    ...
    WebhookIssuesReopenedIssueAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesReopenedIssueAssignees(
  ...
  @override
  String toString() {
    return 'WebhookIssuesReopenedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
