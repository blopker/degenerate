...
import 'webhook_pull_request_unlocked_pull_request_active_lock_reason.dart';
import 'webhook_pull_request_unlocked_pull_request_assignee.dart';
import 'webhook_pull_request_unlocked_pull_request_assignees.dart';
import 'webhook_pull_request_unlocked_pull_request_author_association.dart';
import 'webhook_pull_request_unlocked_pull_request_auto_merge.dart';
import 'webhook_pull_request_unlocked_pull_request_base.dart';
import 'webhook_pull_request_unlocked_pull_request_head.dart';
import 'webhook_pull_request_unlocked_pull_request_labels.dart';
import 'webhook_pull_request_unlocked_pull_request_links.dart';
import 'webhook_pull_request_unlocked_pull_request_merged_by.dart';
import 'webhook_pull_request_unlocked_pull_request_milestone.dart';
import 'webhook_pull_request_unlocked_pull_request_requested_reviewers.dart';
import 'webhook_pull_request_unlocked_pull_request_requested_teams.dart';
import 'webhook_pull_request_unlocked_pull_request_state.dart';
import 'webhook_pull_request_unlocked_pull_request_user.dart';

final class WebhookPullRequestUnlockedPullRequest {
  const WebhookPullRequestUnlockedPullRequest({
    required this.links,
  ...
  factory WebhookPullRequestUnlockedPullRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlockedPullRequest(
      links: WebhookPullRequestUnlockedPullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason:
          WebhookPullRequestUnlockedPullRequestActiveLockReason.fromJson(
            json['active_lock_reason'] as String,
          ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: WebhookPullRequestUnlockedPullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestUnlockedPullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation:
          WebhookPullRequestUnlockedPullRequestAuthorAssociation.fromJson(
            json['author_association'] as String,
          ),
      autoMerge: WebhookPullRequestUnlockedPullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: WebhookPullRequestUnlockedPullRequestBase.fromJson(
      ...
      head: WebhookPullRequestUnlockedPullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestUnlockedPullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? WebhookPullRequestUnlockedPullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: WebhookPullRequestUnlockedPullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestUnlockedPullRequestRequestedReviewers.fromJson(
                  e,
                ),
          )
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestUnlockedPullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      state: WebhookPullRequestUnlockedPullRequestState.fromJson(
      ...
      user: WebhookPullRequestUnlockedPullRequestUser.fromJson(
  ...
  final WebhookPullRequestUnlockedPullRequestAuthorAssociation
  authorAssociation;
  ...
  final List<WebhookPullRequestUnlockedPullRequestRequestedReviewers>
  requestedReviewers;

  final List<WebhookPullRequestUnlockedPullRequestRequestedTeams>
  requestedTeams;
  ...
  WebhookPullRequestUnlockedPullRequest copyWith({
    WebhookPullRequestUnlockedPullRequestLinks? links,
    WebhookPullRequestUnlockedPullRequestActiveLockReason? Function()?
    activeLockReason,
    int Function()? additions,
    WebhookPullRequestUnlockedPullRequestAssignee? Function()? assignee,
    List<WebhookPullRequestUnlockedPullRequestAssignees?>? assignees,
    WebhookPullRequestUnlockedPullRequestAuthorAssociation? authorAssociation,
    WebhookPullRequestUnlockedPullRequestAutoMerge? Function()? autoMerge,
    WebhookPullRequestUnlockedPullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    WebhookPullRequestUnlockedPullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<WebhookPullRequestUnlockedPullRequestLabels>? labels,
    bool? locked,
    ...
    WebhookPullRequestUnlockedPullRequestMergedBy? Function()? mergedBy,
    WebhookPullRequestUnlockedPullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<WebhookPullRequestUnlockedPullRequestRequestedReviewers>?
    requestedReviewers,
    List<WebhookPullRequestUnlockedPullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    WebhookPullRequestUnlockedPullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    WebhookPullRequestUnlockedPullRequestUser? Function()? user,
  }) {
    return WebhookPullRequestUnlockedPullRequest(
