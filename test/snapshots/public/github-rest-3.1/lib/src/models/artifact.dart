...
import 'artifact_workflow_run.dart';
...
final class Artifact {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['name'] is String &&
        json.containsKey('size_in_bytes') &&
        json['size_in_bytes'] is num &&
        json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('archive_download_url') &&
        json['archive_download_url'] is String &&
        json.containsKey('expired') &&
        json['expired'] is bool &&
  ...
  Artifact copyWith({
    ...
    ArtifactWorkflowRun? Function()? workflowRun,
  }) {
    return Artifact(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'Artifact(id: $id, nodeId: $nodeId, name: $name, sizeInBytes: $sizeInBytes, url: $url, archiveDownloadUrl: $archiveDownloadUrl, expired: $expired, createdAt: $createdAt, expiresAt: $expiresAt, updatedAt: $updatedAt, digest: $digest, workflowRun: $workflowRun)';
  }
}
