...
import 'timeline_reviewed_event_links_html.dart';
import 'timeline_reviewed_event_links_pull_request.dart';

final class TimelineReviewedEventLinks {
  ...
  TimelineReviewedEventLinks copyWith({
    TimelineReviewedEventLinksHtml? html,
    TimelineReviewedEventLinksPullRequest? pullRequest,
  }) {
    return TimelineReviewedEventLinks(
      html: html ?? this.html,
  ...
  @override
  String toString() {
    return 'TimelineReviewedEventLinks(html: $html, pullRequest: $pullRequest)';
  }
}
