...
final class ActionsCreateWorkflowDispatchRequest {
  const ActionsCreateWorkflowDispatchRequest({
    required this.ref,
    this.inputs,
    this.returnRunDetails,
  });
  ...
  ActionsCreateWorkflowDispatchRequest copyWith({
    String? ref,
    Map<String, String> Function()? inputs,
    bool Function()? returnRunDetails,
  }) {
    return ActionsCreateWorkflowDispatchRequest(
      ref: ref ?? this.ref,
      inputs: inputs != null ? inputs() : this.inputs,
      returnRunDetails: returnRunDetails != null
          ? returnRunDetails()
          : this.returnRunDetails,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(ref, inputs, returnRunDetails);
  }

  @override
  String toString() {
    return 'ActionsCreateWorkflowDispatchRequest(ref: $ref, inputs: $inputs, returnRunDetails: $returnRunDetails)';
  }
}
