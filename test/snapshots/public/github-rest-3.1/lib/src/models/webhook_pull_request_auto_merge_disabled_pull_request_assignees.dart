...
import 'webhook_pull_request_auto_merge_disabled_pull_request_assignees_type.dart';

final class WebhookPullRequestAutoMergeDisabledPullRequestAssignees {
  const WebhookPullRequestAutoMergeDisabledPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeDisabledPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeDisabledPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeDisabledPullRequestAssignees copyWith({
    ...
    WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType Function()?
    type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestAutoMergeDisabledPullRequestAssignees(
