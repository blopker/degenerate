...
final class PullRequestReviewCommentEventCommentReactions {
  const PullRequestReviewCommentEventCommentReactions({
    this.plus1,
    this.minus1,
    this.confused,
    this.eyes,
  ...
  factory PullRequestReviewCommentEventCommentReactions.fromJson(
    Map<String, dynamic> json,
  ) {
    return PullRequestReviewCommentEventCommentReactions(
      plus1: json['+1'] != null ? (json['+1'] as num).toInt() : null,
      minus1: json['-1'] != null ? (json['-1'] as num).toInt() : null,
      confused: json['confused'] != null
          ? (json['confused'] as num).toInt()
          : null,
  ...
  PullRequestReviewCommentEventCommentReactions copyWith({
    int Function()? plus1,
    int Function()? minus1,
    int Function()? confused,
    int Function()? eyes,
    int Function()? heart,
    int Function()? hooray,
    int Function()? laugh,
  ...
  @override
  String toString() {
    return 'PullRequestReviewCommentEventCommentReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
