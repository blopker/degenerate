...
import 'webhook_issues_transferred_changes_new_issue_user_type.dart';

final class WebhookIssuesTransferredChangesNewIssueUser {
  const WebhookIssuesTransferredChangesNewIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesTransferredChangesNewIssueUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesTransferredChangesNewIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesTransferredChangesNewIssueUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesTransferredChangesNewIssueUser copyWith({
    ...
    WebhookIssuesTransferredChangesNewIssueUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesTransferredChangesNewIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
