...
import 'webhooks_issue2_user_type.dart';

final class WebhooksIssue2User {
  const WebhooksIssue2User({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssue2User.fromJson(Map<String, dynamic> json) {
    return WebhooksIssue2User(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssue2UserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssue2User copyWith({
    ...
    WebhooksIssue2UserType Function()? type,
    Uri Function()? url,
