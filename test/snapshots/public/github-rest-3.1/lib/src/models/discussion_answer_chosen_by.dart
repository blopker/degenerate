...
import 'discussion_answer_chosen_by_type.dart';

final class DiscussionAnswerChosenBy {
  const DiscussionAnswerChosenBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory DiscussionAnswerChosenBy.fromJson(Map<String, dynamic> json) {
    return DiscussionAnswerChosenBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? DiscussionAnswerChosenByType.fromJson(json['type'] as String)
          : null,
  ...
  DiscussionAnswerChosenBy copyWith({
    ...
    DiscussionAnswerChosenByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'DiscussionAnswerChosenBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
