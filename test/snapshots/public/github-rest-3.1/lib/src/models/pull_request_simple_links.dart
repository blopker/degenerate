...
final class PullRequestSimpleLinks {
  const PullRequestSimpleLinks({
  ...
  factory PullRequestSimpleLinks.fromJson(Map<String, dynamic> json) {
  ...
  PullRequestSimpleLinks copyWith({
    Link? comments,
    Link? commits,
    Link? statuses,
    Link? html,
