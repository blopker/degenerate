...
import 'package:collection/collection.dart';import 'dependabot_alert_dismissal_request_simple.dart';import 'dependabot_alert_security_advisory.dart';import 'dependabot_alert_security_vulnerability.dart';import 'dependabot_alert_with_repository_dependency.dart';import 'dependabot_alert_with_repository_dismissed_reason.dart';import 'dependabot_alert_with_repository_state.dart';import 'simple_repository.dart';import 'simple_user.dart';/// A Dependabot alert.
...
factory DependabotAlertWithRepository.fromJson(Map<String, dynamic> json) { return DependabotAlertWithRepository(
  ...
  dismissedReason: DependabotAlertWithRepositoryDismissedReason.fromJson(json['dismissed_reason'] as String),
  dismissedComment: json['dismissed_comment'] as String,
  fixedAt: DateTime.parse(json['fixed_at'] as String),
  autoDismissedAt: json['auto_dismissed_at'] != null ? DateTime.parse(json['auto_dismissed_at'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  ...
  if (autoDismissedAt != null) 'auto_dismissed_at': autoDismissedAt?.toIso8601String(),
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('number') && json['number'] is num &&
      ...
      json.containsKey('fixed_at') && json['fixed_at'] is String &&
      json.containsKey('repository'); } 
DependabotAlertWithRepository copyWith({int? number, DependabotAlertWithRepositoryState? state, DependabotAlertWithRepositoryDependency? dependency, DependabotAlertSecurityAdvisory? securityAdvisory, DependabotAlertSecurityVulnerability? securityVulnerability, Uri? url, Uri? htmlUrl, DateTime? createdAt, DateTime? updatedAt, DateTime? Function()? dismissedAt, SimpleUser? Function()? dismissedBy, DependabotAlertWithRepositoryDismissedReason? Function()? dismissedReason, String? Function()? dismissedComment, DateTime? Function()? fixedAt, DateTime? Function()? autoDismissedAt, DependabotAlertDismissalRequestSimple Function()? dismissalRequest, List<SimpleUser> Function()? assignees, SimpleRepository? repository, }) { return DependabotAlertWithRepository(
