...
import 'rule_suite_evaluation_result.dart';
import 'rule_suite_result.dart';
import 'rule_suite_rule_evaluations.dart';
...
final class RuleSuite {
  ...
  factory RuleSuite.fromJson(Map<String, dynamic> json) {
    return RuleSuite(
      ...
      actorId: json['actor_id'] != null
          ? (json['actor_id'] as num).toInt()
          : null,
      ...
      result: json['result'] != null
          ? RuleSuiteResult.fromJson(json['result'] as String)
          : null,
      evaluationResult: json['evaluation_result'] != null
          ? RuleSuiteEvaluationResult.fromJson(
              json['evaluation_result'] as String,
            )
          : null,
      ruleEvaluations: (json['rule_evaluations'] as List<dynamic>?)
          ?.map(
            (e) => RuleSuiteRuleEvaluations.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
  ...
  RuleSuite copyWith({
    ...
    String Function()? beforeSha,
    String Function()? afterSha,
    String Function()? ref,
    int Function()? repositoryId,
    String Function()? repositoryName,
    DateTime Function()? pushedAt,
    RuleSuiteResult Function()? result,
    RuleSuiteEvaluationResult? Function()? evaluationResult,
    List<RuleSuiteRuleEvaluations> Function()? ruleEvaluations,
  }) {
    return RuleSuite(
      ...
      evaluationResult: evaluationResult != null
          ? evaluationResult()
          : this.evaluationResult,
      ruleEvaluations: ruleEvaluations != null
          ? ruleEvaluations()
          : this.ruleEvaluations,
    );
  }
  ...
  int get hashCode {
    return Object.hash(
      ...
      result,
      evaluationResult,
      Object.hashAll(ruleEvaluations ?? const []),
    );
  }

  @override
  String toString() {
    return 'RuleSuite(id: $id, actorId: $actorId, actorName: $actorName, beforeSha: $beforeSha, afterSha: $afterSha, ref: $ref, repositoryId: $repositoryId, repositoryName: $repositoryName, pushedAt: $pushedAt, result: $result, evaluationResult: $evaluationResult, ruleEvaluations: $ruleEvaluations)';
  }
}
