...
import 'job_steps_status.dart';final class JobSteps {const JobSteps({required this.status, required this.conclusion, required this.name, required this.number, this.startedAt, this.completedAt, });
