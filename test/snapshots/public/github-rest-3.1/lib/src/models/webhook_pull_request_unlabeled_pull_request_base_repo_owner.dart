...
import 'webhook_pull_request_unlabeled_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestUnlabeledPullRequestBaseRepoOwner {
  const WebhookPullRequestUnlabeledPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlabeledPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlabeledPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlabeledPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlabeledPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestUnlabeledPullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
