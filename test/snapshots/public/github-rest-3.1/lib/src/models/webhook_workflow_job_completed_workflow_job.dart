...
import 'webhook_workflow_job_completed_workflow_job_conclusion.dart';
...
final class WebhookWorkflowJobCompletedWorkflowJob {
  const WebhookWorkflowJobCompletedWorkflowJob({
  ...
  factory WebhookWorkflowJobCompletedWorkflowJob.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowJobCompletedWorkflowJob(
      checkRunUrl: json['check_run_url'] as String,
      completedAt: json['completed_at'] as String,
      conclusion: WebhookWorkflowJobCompletedWorkflowJobConclusion.fromJson(
  ...
  WebhookWorkflowJobCompletedWorkflowJob copyWith({
    String? checkRunUrl,
    String? completedAt,
    WebhookWorkflowJobCompletedWorkflowJobConclusion? conclusion,
    String? createdAt,
    String? headSha,
    String? htmlUrl,
    int? id,
