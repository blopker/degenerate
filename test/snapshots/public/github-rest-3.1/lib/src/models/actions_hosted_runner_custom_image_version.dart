...
final class ActionsHostedRunnerCustomImageVersion {
  const ActionsHostedRunnerCustomImageVersion({
  ...
  factory ActionsHostedRunnerCustomImageVersion.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('version') &&
        ...
        json.containsKey('state_details') &&
        json['state_details'] is String;
  }

  ActionsHostedRunnerCustomImageVersion copyWith({
    String? version,
    String? state,
    int? sizeGb,
    String? createdOn,
  ...
  @override
  int get hashCode {
    return Object.hash(version, state, sizeGb, createdOn, stateDetails);
  }

  @override
  String toString() {
    return 'ActionsHostedRunnerCustomImageVersion(version: $version, state: $state, sizeGb: $sizeGb, createdOn: $createdOn, stateDetails: $stateDetails)';
  }
}
