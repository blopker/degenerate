...
final class CheckRunConclusion {
  ...
  static const CheckRunConclusion actionRequired = CheckRunConclusion._(
    'action_required',
  );

  static const CheckRunConclusion $null = CheckRunConclusion._('null');

  static const List<CheckRunConclusion> values = [
    success,
    failure,
    neutral,
    cancelled,
  ...
  @override
  String toString() {
    return 'CheckRunConclusion($value)';
  }
}
