...
import 'orgs_create_artifact_deployment_record_request_runtime_risks.dart';
import 'orgs_create_artifact_deployment_record_request_status.dart';

final class OrgsCreateArtifactDeploymentRecordRequest {
  const OrgsCreateArtifactDeploymentRecordRequest({
    required this.name,
    required this.digest,
    this.version,
    required this.status,
    required this.logicalEnvironment,
  ...
  factory OrgsCreateArtifactDeploymentRecordRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return OrgsCreateArtifactDeploymentRecordRequest(
      name: json['name'] as String,
      digest: json['digest'] as String,
      version: json['version'] as String?,
      status: OrgsCreateArtifactDeploymentRecordRequestStatus.fromJson(
      ...
      runtimeRisks: (json['runtime_risks'] as List<dynamic>?)
          ?.map(
            (e) =>
                OrgsCreateArtifactDeploymentRecordRequestRuntimeRisks.fromJson(
                  e as String,
                ),
          )
          .toList(),
  ...
  final List<OrgsCreateArtifactDeploymentRecordRequestRuntimeRisks>?
  runtimeRisks;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (runtimeRisks != null)
        'runtime_risks': runtimeRisks?.map((e) => e.toJson()).toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('digest') &&
        json['digest'] is String &&
        json.containsKey('status') &&
        json.containsKey('logical_environment') &&
        json['logical_environment'] is String &&
        json.containsKey('deployment_name') &&
        json['deployment_name'] is String;
  }

  OrgsCreateArtifactDeploymentRecordRequest copyWith({
    String? name,
    String? digest,
    String Function()? version,
    OrgsCreateArtifactDeploymentRecordRequestStatus? status,
    String? logicalEnvironment,
    String Function()? physicalEnvironment,
    String Function()? cluster,
    String? deploymentName,
    Map<String, String> Function()? tags,
    List<OrgsCreateArtifactDeploymentRecordRequestRuntimeRisks> Function()?
    runtimeRisks,
    String Function()? githubRepository,
  }) {
    return OrgsCreateArtifactDeploymentRecordRequest(
      name: name ?? this.name,
  ...
  int get hashCode {
    return Object.hash(
      ...
      deploymentName,
      tags,
      Object.hashAll(runtimeRisks ?? const []),
      githubRepository,
    );
  }
  ...
  @override
  String toString() {
    return 'OrgsCreateArtifactDeploymentRecordRequest(name: $name, digest: $digest, version: $version, status: $status, logicalEnvironment: $logicalEnvironment, physicalEnvironment: $physicalEnvironment, cluster: $cluster, deploymentName: $deploymentName, tags: $tags, runtimeRisks: $runtimeRisks, githubRepository: $githubRepository)';
  }
}
