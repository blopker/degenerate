...
import 'webhook_pull_request_dequeued_pull_request_base_user_type.dart';

final class WebhookPullRequestDequeuedPullRequestBaseUser {
  const WebhookPullRequestDequeuedPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestDequeuedPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestDequeuedPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestDequeuedPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestDequeuedPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestDequeuedPullRequestBaseUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestDequeuedPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
