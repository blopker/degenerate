...
import 'webhook_pull_request_review_dismissed_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
