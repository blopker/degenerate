...
import 'teams_update_in_org_request_notification_setting.dart';
import 'teams_update_in_org_request_permission.dart';
import 'teams_update_in_org_request_privacy.dart';

final class TeamsUpdateInOrgRequest {
  ...
  factory TeamsUpdateInOrgRequest.fromJson(Map<String, dynamic> json) {
    return TeamsUpdateInOrgRequest(
      ...
      privacy: json['privacy'] != null
          ? TeamsUpdateInOrgRequestPrivacy.fromJson(json['privacy'] as String)
          : null,
      notificationSetting: json['notification_setting'] != null
          ? TeamsUpdateInOrgRequestNotificationSetting.fromJson(
              json['notification_setting'] as String,
            )
          : null,
      permission: json.containsKey('permission')
          ? TeamsUpdateInOrgRequestPermission.fromJson(
  ...
  TeamsUpdateInOrgRequest copyWith({
    ...
    TeamsUpdateInOrgRequestPrivacy Function()? privacy,
    TeamsUpdateInOrgRequestNotificationSetting Function()? notificationSetting,
    TeamsUpdateInOrgRequestPermission Function()? permission,
  ...
  @override
  String toString() {
    return 'TeamsUpdateInOrgRequest(name: $name, description: $description, privacy: $privacy, notificationSetting: $notificationSetting, permission: $permission, parentTeamId: $parentTeamId)';
  }
}
