...
import 'webhook_issue_comment_unpinned_issue_assignee_type.dart';

final class WebhookIssueCommentUnpinnedIssueAssignee {
  const WebhookIssueCommentUnpinnedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssueCommentUnpinnedIssueAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentUnpinnedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssueCommentUnpinnedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssueCommentUnpinnedIssueAssignee copyWith({
    ...
    WebhookIssueCommentUnpinnedIssueAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssueCommentUnpinnedIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
