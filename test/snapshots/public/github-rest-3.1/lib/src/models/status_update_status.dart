...
/// The current status.
final class StatusUpdateStatus {
  const StatusUpdateStatus._(this.value);

  factory StatusUpdateStatus.fromJson(String json) {
    return switch (json) {
      'INACTIVE' => inactive,
      'ON_TRACK' => onTrack,
      'AT_RISK' => atRisk,
  ...
  static const List<StatusUpdateStatus> values = [
    inactive,
    onTrack,
    atRisk,
    offTrack,
  ...
  @override
  String toString() {
    return 'StatusUpdateStatus($value)';
  }
}
