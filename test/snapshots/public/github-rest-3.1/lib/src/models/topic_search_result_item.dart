...
import 'topic_search_result_item_aliases.dart';
import 'topic_search_result_item_related.dart';
...
final class TopicSearchResultItem {
  ...
  factory TopicSearchResultItem.fromJson(Map<String, dynamic> json) {
    return TopicSearchResultItem(
      ...
      repositoryCount: json['repository_count'] != null
          ? (json['repository_count'] as num).toInt()
          : null,
      logoUrl: json['logo_url'] != null
          ? Uri.parse(json['logo_url'] as String)
          : null,
      ...
      related: (json['related'] as List<dynamic>?)
          ?.map(
            (e) => TopicSearchResultItemRelated.fromJson(
      ...
      aliases: (json['aliases'] as List<dynamic>?)
          ?.map(
            (e) => TopicSearchResultItemAliases.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        ...
        json.containsKey('created_by') &&
        json['created_by'] is String &&
        json.containsKey('released') &&
        json['released'] is String &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('updated_at') &&
        json['updated_at'] is String &&
        json.containsKey('featured') &&
        json['featured'] is bool &&
        json.containsKey('curated') &&
        json['curated'] is bool &&
        json.containsKey('score') &&
        json['score'] is num;
  }

  TopicSearchResultItem copyWith({
    String? name,
    ...
    Uri? Function()? logoUrl,
    List<SearchResultTextMatches2> Function()? textMatches,
    List<TopicSearchResultItemRelated>? Function()? related,
    List<TopicSearchResultItemAliases>? Function()? aliases,
  }) {
    return TopicSearchResultItem(
      name: name ?? this.name,
