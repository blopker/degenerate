...
final class CheckRunWithSimpleCheckSuiteOutput {
  const CheckRunWithSimpleCheckSuiteOutput({
  ...
  factory CheckRunWithSimpleCheckSuiteOutput.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('annotations_count') &&
        json['annotations_count'] is num &&
        json.containsKey('annotations_url') &&
        json['annotations_url'] is String &&
  ...
  CheckRunWithSimpleCheckSuiteOutput copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(annotationsCount, annotationsUrl, summary, text, title);
  }

  @override
  String toString() {
    return 'CheckRunWithSimpleCheckSuiteOutput(annotationsCount: $annotationsCount, annotationsUrl: $annotationsUrl, summary: $summary, text: $text, title: $title)';
  }
}
