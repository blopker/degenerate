...
import 'webhook_sub_issues_sub_issue_removed_action.dart';

final class WebhookSubIssuesSubIssueRemoved {
  ...
  factory WebhookSubIssuesSubIssueRemoved.fromJson(Map<String, dynamic> json) {
    return WebhookSubIssuesSubIssueRemoved(
      action: WebhookSubIssuesSubIssueRemovedAction.fromJson(
  ...
  WebhookSubIssuesSubIssueRemoved copyWith({
    WebhookSubIssuesSubIssueRemovedAction? action,
    double? subIssueId,
    Issue? subIssue,
  ...
  @override
  String toString() {
    return 'WebhookSubIssuesSubIssueRemoved(action: $action, subIssueId: $subIssueId, subIssue: $subIssue, subIssueRepo: $subIssueRepo, parentIssueId: $parentIssueId, parentIssue: $parentIssue, installation: $installation, organization: $organization, repository: $repository, sender: $sender)';
  }
}
