...
import 'commit_search_result_item.dart';

final class SearchCommitsResponse {
  ...
  SearchCommitsResponse copyWith({
    int? totalCount,
  ...
  @override
  String toString() {
    return 'SearchCommitsResponse(totalCount: $totalCount, incompleteResults: $incompleteResults, items: $items)';
  }
}
