...
import 'package:collection/collection.dart';import 'commit_search_result_item.dart';final class SearchCommitsResponse {const SearchCommitsResponse({required this.totalCount, required this.incompleteResults, required this.items, });
