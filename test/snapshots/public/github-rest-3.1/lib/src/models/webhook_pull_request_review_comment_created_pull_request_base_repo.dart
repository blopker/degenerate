...
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_created_at.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_license.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_merge_commit_message.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_merge_commit_title.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_owner.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_permissions.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_pull_request_creation_policy.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_pushed_at.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_squash_merge_commit_message.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_squash_merge_commit_title.dart';
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_visibility.dart';

/// A git repository
final class WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo {
  const WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo({
    ...
    this.hasPullRequests = true,
    this.pullRequestCreationPolicy,
  ...
  factory WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo(
      allowAutoMerge: json.containsKey('allow_auto_merge')
          ? json['allow_auto_merge'] as bool
          : false,
      allowForking: json['allow_forking'] as bool?,
      allowMergeCommit: json.containsKey('allow_merge_commit')
          ? json['allow_merge_commit'] as bool
          : true,
      allowRebaseMerge: json.containsKey('allow_rebase_merge')
          ? json['allow_rebase_merge'] as bool
          : true,
      allowSquashMerge: json.containsKey('allow_squash_merge')
      ...
      createdAt:
          WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoCreatedAt.fromJson(
            json['created_at'],
          ),
      defaultBranch: json['default_branch'] as String,
      deleteBranchOnMerge: json.containsKey('delete_branch_on_merge')
      ...
      hasPullRequests: json.containsKey('has_pull_requests')
          ? json['has_pull_requests'] as bool
          : true,
      pullRequestCreationPolicy: json['pull_request_creation_policy'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPullRequestCreationPolicy.fromJson(
      ...
      license:
          WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicense.fromJson(
      ...
      mergeCommitMessage: json['merge_commit_message'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitMessage.fromJson(
              json['merge_commit_message'] as String,
            )
          : null,
      mergeCommitTitle: json['merge_commit_title'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitTitle.fromJson(
      ...
      owner:
          WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner.fromJson(
            json['owner'] as Map<String, dynamic>,
          ),
      permissions: json['permissions'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPermissions.fromJson(
      ...
      pushedAt:
          WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAt.fromJson(
            json['pushed_at'],
          ),
      ...
      squashMergeCommitMessage: json['squash_merge_commit_message'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitMessage.fromJson(
              json['squash_merge_commit_message'] as String,
            )
          : null,
      squashMergeCommitTitle: json['squash_merge_commit_title'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitTitle.fromJson(
              json['squash_merge_commit_title'] as String,
            )
          : null,
      sshUrl: json['ssh_url'] as String,
      stargazers: json['stargazers'] != null
          ? (json['stargazers'] as num).toInt()
          : null,
      ...
      useSquashPrTitleAsDefault:
          json.containsKey('use_squash_pr_title_as_default')
          ? json['use_squash_pr_title_as_default'] as bool
          : false,
      visibility:
          WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoVisibility.fromJson(
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoCreatedAt
  createdAt;
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPullRequestCreationPolicy?
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoLicense?
  license;
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitMessage?
  mergeCommitMessage;
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitTitle?
  mergeCommitTitle;
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPermissions?
  permissions;
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAt?
  pushedAt;
  ...
  /// - `BLANK` - default to a blank commit message.
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitMessage?
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitTitle?
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoVisibility
  visibility;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (pullRequestCreationPolicy != null)
        'pull_request_creation_policy': pullRequestCreationPolicy?.toJson(),
      'homepage': ?homepage,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('archive_url') &&
        json['archive_url'] is String &&
        json.containsKey('archived') &&
        json['archived'] is bool &&
        json.containsKey('assignees_url') &&
        json['assignees_url'] is String &&
        json.containsKey('blobs_url') &&
        json['blobs_url'] is String &&
        json.containsKey('branches_url') &&
        json['branches_url'] is String &&
        json.containsKey('clone_url') &&
        json['clone_url'] is String &&
        json.containsKey('collaborators_url') &&
        json['collaborators_url'] is String &&
        json.containsKey('comments_url') &&
        json['comments_url'] is String &&
        json.containsKey('commits_url') &&
        json['commits_url'] is String &&
        json.containsKey('compare_url') &&
        json['compare_url'] is String &&
        json.containsKey('contents_url') &&
        json['contents_url'] is String &&
        json.containsKey('contributors_url') &&
        json['contributors_url'] is String &&
        json.containsKey('created_at') &&
        json.containsKey('default_branch') &&
        json['default_branch'] is String &&
        json.containsKey('deployments_url') &&
        json['deployments_url'] is String &&
        json.containsKey('description') &&
        json['description'] is String &&
        json.containsKey('downloads_url') &&
        json['downloads_url'] is String &&
        json.containsKey('events_url') &&
        json['events_url'] is String &&
        json.containsKey('fork') &&
        json['fork'] is bool &&
        json.containsKey('forks') &&
        json['forks'] is num &&
        json.containsKey('forks_count') &&
        json['forks_count'] is num &&
        json.containsKey('forks_url') &&
        json['forks_url'] is String &&
        json.containsKey('full_name') &&
        json['full_name'] is String &&
        json.containsKey('git_commits_url') &&
        json['git_commits_url'] is String &&
        json.containsKey('git_refs_url') &&
        json['git_refs_url'] is String &&
        json.containsKey('git_tags_url') &&
        json['git_tags_url'] is String &&
        json.containsKey('git_url') &&
        json['git_url'] is String &&
        json.containsKey('has_downloads') &&
        json['has_downloads'] is bool &&
        json.containsKey('has_issues') &&
        json['has_issues'] is bool &&
        json.containsKey('has_pages') &&
        json['has_pages'] is bool &&
        json.containsKey('has_projects') &&
        json['has_projects'] is bool &&
        json.containsKey('has_wiki') &&
        json['has_wiki'] is bool &&
        json.containsKey('has_discussions') &&
        json['has_discussions'] is bool &&
        json.containsKey('homepage') &&
        json['homepage'] is String &&
        json.containsKey('hooks_url') &&
        json['hooks_url'] is String &&
        json.containsKey('html_url') &&
        json['html_url'] is String &&
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('issue_comment_url') &&
        json['issue_comment_url'] is String &&
        json.containsKey('issue_events_url') &&
        json['issue_events_url'] is String &&
        json.containsKey('issues_url') &&
        json['issues_url'] is String &&
        json.containsKey('keys_url') &&
        json['keys_url'] is String &&
        json.containsKey('labels_url') &&
        json['labels_url'] is String &&
        json.containsKey('language') &&
        json['language'] is String &&
        json.containsKey('languages_url') &&
        json['languages_url'] is String &&
        json.containsKey('license') &&
        json.containsKey('merges_url') &&
        json['merges_url'] is String &&
        json.containsKey('milestones_url') &&
        json['milestones_url'] is String &&
        json.containsKey('mirror_url') &&
        json['mirror_url'] is String &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('node_id') &&
        json['node_id'] is String &&
        json.containsKey('notifications_url') &&
        json['notifications_url'] is String &&
        json.containsKey('open_issues') &&
        json['open_issues'] is num &&
        json.containsKey('open_issues_count') &&
        json['open_issues_count'] is num &&
        json.containsKey('owner') &&
        json.containsKey('private') &&
        json['private'] is bool &&
        json.containsKey('pulls_url') &&
        json['pulls_url'] is String &&
        json.containsKey('pushed_at') &&
        json.containsKey('releases_url') &&
        json['releases_url'] is String &&
        json.containsKey('size') &&
        json['size'] is num &&
        json.containsKey('ssh_url') &&
        json['ssh_url'] is String &&
        json.containsKey('stargazers_count') &&
        json['stargazers_count'] is num &&
        json.containsKey('stargazers_url') &&
        json['stargazers_url'] is String &&
        json.containsKey('statuses_url') &&
        json['statuses_url'] is String &&
        json.containsKey('subscribers_url') &&
        json['subscribers_url'] is String &&
        json.containsKey('subscription_url') &&
        json['subscription_url'] is String &&
        json.containsKey('svn_url') &&
        json['svn_url'] is String &&
        json.containsKey('tags_url') &&
        json['tags_url'] is String &&
        json.containsKey('teams_url') &&
        json['teams_url'] is String &&
        json.containsKey('topics') &&
        json.containsKey('trees_url') &&
        json['trees_url'] is String &&
        json.containsKey('updated_at') &&
        json['updated_at'] is String &&
        json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('visibility') &&
        json.containsKey('watchers') &&
        json['watchers'] is num &&
        json.containsKey('watchers_count') &&
        json['watchers_count'] is num;
  }

  WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo copyWith({
    bool Function()? allowAutoMerge,
    bool Function()? allowForking,
    bool Function()? allowMergeCommit,
    bool Function()? allowRebaseMerge,
    bool Function()? allowSquashMerge,
    bool Function()? allowUpdateBranch,
    String? archiveUrl,
    bool? archived,
    String? assigneesUrl,
    String? blobsUrl,
    ...
    String? contentsUrl,
    Uri? contributorsUrl,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoCreatedAt?
    createdAt,
    String? defaultBranch,
    bool Function()? deleteBranchOnMerge,
    Uri? deploymentsUrl,
    ...
    Function()?
    license,
    String Function()? masterBranch,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitMessage
    Function()?
    mergeCommitMessage,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoMergeCommitTitle
    Function()?
    mergeCommitTitle,
    Uri? mergesUrl,
    String? milestonesUrl,
    Uri? Function()? mirrorUrl,
    String? name,
    String? nodeId,
    String? notificationsUrl,
    int? openIssues,
    int? openIssuesCount,
    String Function()? organization,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner? Function()?
    owner,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPermissions
    Function()?
    permissions,
    bool? private,
    bool Function()? public,
    String? pullsUrl,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoPushedAt?
    Function()?
    pushedAt,
    String? releasesUrl,
    String? Function()? roleName,
    int? size,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitMessage
    Function()?
    squashMergeCommitMessage,
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoSquashMergeCommitTitle
    Function()?
    squashMergeCommitTitle,
    String? sshUrl,
    int Function()? stargazers,
    int? stargazersCount,
    Uri? stargazersUrl,
    String? statusesUrl,
    Uri? subscribersUrl,
    ...
    int? watchers,
    int? watchersCount,
    bool Function()? webCommitSignoffRequired,
  }) {
    return WebhookPullRequestReviewCommentCreatedPullRequestBaseRepo(
      allowAutoMerge: allowAutoMerge != null
          ? allowAutoMerge()
          : this.allowAutoMerge,
      allowForking: allowForking != null ? allowForking() : this.allowForking,
      allowMergeCommit: allowMergeCommit != null
          ? allowMergeCommit()
          : this.allowMergeCommit,
      allowRebaseMerge: allowRebaseMerge != null
          ? allowRebaseMerge()
          : this.allowRebaseMerge,
      allowSquashMerge: allowSquashMerge != null
          ? allowSquashMerge()
          : this.allowSquashMerge,
      allowUpdateBranch: allowUpdateBranch != null
          ? allowUpdateBranch()
          : this.allowUpdateBranch,
      ...
      deleteBranchOnMerge: deleteBranchOnMerge != null
          ? deleteBranchOnMerge()
      ...
      hasPullRequests: hasPullRequests != null
          ? hasPullRequests()
      ...
      url: url ?? this.url,
      useSquashPrTitleAsDefault: useSquashPrTitleAsDefault != null
          ? useSquashPrTitleAsDefault()
          : this.useSquashPrTitleAsDefault,
      visibility: visibility ?? this.visibility,
      watchers: watchers ?? this.watchers,
      watchersCount: watchersCount ?? this.watchersCount,
      webCommitSignoffRequired: webCommitSignoffRequired != null
