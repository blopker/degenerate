...
final class DraftIssue {
  ...
  @override
  int get hashCode {
    return Object.hash(id, nodeId, title, body, user, createdAt, updatedAt);
  }

  @override
  String toString() {
    return 'DraftIssue(id: $id, nodeId: $nodeId, title: $title, body: $body, user: $user, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
