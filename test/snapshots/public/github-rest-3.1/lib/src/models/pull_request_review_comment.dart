...
import 'pull_request_review_comment_links.dart';
import 'pull_request_review_comment_side.dart';
import 'pull_request_review_comment_start_side.dart';
import 'pull_request_review_comment_subject_type.dart';
...
final class PullRequestReviewComment {
  ...
  factory PullRequestReviewComment.fromJson(Map<String, dynamic> json) {
    return PullRequestReviewComment(
      ...
      startLine: json['start_line'] != null
          ...
          : null,
      originalStartLine: json['original_start_line'] != null
          ? (json['original_start_line'] as num).toInt()
          : null,
      startSide: json.containsKey('start_side')
          ? PullRequestReviewCommentStartSide.fromJson(
              json['start_side'] as String,
            )
          : PullRequestReviewCommentStartSide.right,
      line: json['line'] != null ? (json['line'] as num).toInt() : null,
      originalLine: json['original_line'] != null
          ? (json['original_line'] as num).toInt()
          : null,
      side: json.containsKey('side')
          ? PullRequestReviewCommentSide.fromJson(json['side'] as String)
          : PullRequestReviewCommentSide.right,
      subjectType: json['subject_type'] != null
          ? PullRequestReviewCommentSubjectType.fromJson(
  ...
  PullRequestReviewComment copyWith({
    String? url,
    ...
    PullRequestReviewCommentStartSide? Function()? startSide,
    int Function()? line,
    int Function()? originalLine,
    PullRequestReviewCommentSide Function()? side,
    PullRequestReviewCommentSubjectType Function()? subjectType,
