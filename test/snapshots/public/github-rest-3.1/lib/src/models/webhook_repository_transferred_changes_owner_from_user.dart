...
import 'webhook_repository_transferred_changes_owner_from_user_type.dart';

final class WebhookRepositoryTransferredChangesOwnerFromUser {
  const WebhookRepositoryTransferredChangesOwnerFromUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookRepositoryTransferredChangesOwnerFromUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookRepositoryTransferredChangesOwnerFromUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookRepositoryTransferredChangesOwnerFromUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookRepositoryTransferredChangesOwnerFromUser copyWith({
    ...
    WebhookRepositoryTransferredChangesOwnerFromUserType Function()? type,
    Uri Function()? url,
