...
final class CodeSearchResultItem {
  ...
  factory CodeSearchResultItem.fromJson(Map<String, dynamic> json) {
    return CodeSearchResultItem(
      ...
      lastModifiedAt: json['last_modified_at'] != null
          ...
          : null,
      lineNumbers: (json['line_numbers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  ...
  CodeSearchResultItem copyWith({
    ...
    double? score,
    int Function()? fileSize,
    String? Function()? language,
    DateTime Function()? lastModifiedAt,
    List<String> Function()? lineNumbers,
  ...
  int get hashCode {
    return Object.hash(
      ...
      language,
      lastModifiedAt,
      Object.hashAll(lineNumbers ?? const []),
