...
final class NetworkSettings {
  ...
  @override
  int get hashCode {
    return Object.hash(id, networkConfigurationId, name, subnetId, region);
  }

  @override
  String toString() {
    return 'NetworkSettings(id: $id, networkConfigurationId: $networkConfigurationId, name: $name, subnetId: $subnetId, region: $region)';
  }
}
