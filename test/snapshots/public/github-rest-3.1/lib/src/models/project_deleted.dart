...
import 'organization_simple_webhooks.dart';import 'project_deleted_action.dart';import 'projects.dart';import 'simple_installation.dart';import 'simple_user.dart';final class ProjectDeleted {const ProjectDeleted({required this.action, this.installation, required this.organization, required this.projectsV2, required this.sender, });
