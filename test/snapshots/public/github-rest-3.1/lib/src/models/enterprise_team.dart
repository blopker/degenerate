...
final class EnterpriseTeam {
  ...
  EnterpriseTeam copyWith({
    int? id,
    String? name,
    String Function()? description,
    String? slug,
    Uri? url,
    String Function()? syncToOrganizations,
    String Function()? organizationSelectionType,
  ...
  @override
  String toString() {
    return 'EnterpriseTeam(id: $id, name: $name, description: $description, slug: $slug, url: $url, syncToOrganizations: $syncToOrganizations, organizationSelectionType: $organizationSelectionType, groupId: $groupId, groupName: $groupName, htmlUrl: $htmlUrl, membersUrl: $membersUrl, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
