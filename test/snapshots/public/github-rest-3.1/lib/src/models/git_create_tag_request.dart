...
import 'git_create_tag_request_tagger.dart';
import 'git_create_tag_request_type.dart';

final class GitCreateTagRequest {
  ...
  factory GitCreateTagRequest.fromJson(Map<String, dynamic> json) {
    return GitCreateTagRequest(
      ...
      tagger: json['tagger'] != null
          ? GitCreateTagRequestTagger.fromJson(
  ...
  GitCreateTagRequest copyWith({
    String? tag,
    String? message,
    String? object,
    GitCreateTagRequestType? type,
    GitCreateTagRequestTagger Function()? tagger,
  }) {
    return GitCreateTagRequest(
      tag: tag ?? this.tag,
  ...
  @override
  int get hashCode {
    return Object.hash(tag, message, object, type, tagger);
  }

  @override
  String toString() {
    return 'GitCreateTagRequest(tag: $tag, message: $message, object: $object, type: $type, tagger: $tagger)';
  }
}
