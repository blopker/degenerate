...
import 'inline_object63_pull_request_milestone_creator_type.dart';

final class InlineObject63PullRequestMilestoneCreator {
  const InlineObject63PullRequestMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestMilestoneCreator copyWith({
    ...
    InlineObject63PullRequestMilestoneCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject63PullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
