...
import 'webhooks_pull_request5_head_user_type.dart';

final class WebhooksPullRequest5HeadUser {
  const WebhooksPullRequest5HeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5HeadUser.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5HeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5HeadUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksPullRequest5HeadUser copyWith({
    ...
    WebhooksPullRequest5HeadUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksPullRequest5HeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
