...
import 'webhook_pull_request_enqueued_pull_request_assignee_type.dart';

final class WebhookPullRequestEnqueuedPullRequestAssignee {
  const WebhookPullRequestEnqueuedPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestEnqueuedPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestEnqueuedPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestEnqueuedPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestEnqueuedPullRequestAssignee copyWith({
    ...
    WebhookPullRequestEnqueuedPullRequestAssigneeType Function()? type,
    Uri Function()? url,
