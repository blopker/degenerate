...
import 'secret_scanning_alert_resolution.dart';
import 'secret_scanning_alert_state.dart';
import 'secret_scanning_alert_validity.dart';
import 'secret_scanning_first_detected_location.dart';
...
final class SecretScanningAlert {
  ...
  factory SecretScanningAlert.fromJson(Map<String, dynamic> json) {
    return SecretScanningAlert(
      ...
      state: json['state'] != null
          ? SecretScanningAlertState.fromJson(json['state'] as String)
          : null,
      resolution: json['resolution'] != null
          ? SecretScanningAlertResolution.fromJson(json['resolution'] as String)
          : null,
      ...
      validity: json['validity'] != null
          ? SecretScanningAlertValidity.fromJson(json['validity'] as String)
          : null,
      ...
      firstLocationDetected: json['first_location_detected'] != null
          ? SecretScanningFirstDetectedLocation.fromJson(
  ...
  SecretScanningAlert copyWith({
    ...
    SecretScanningAlertState Function()? state,
    SecretScanningAlertResolution? Function()? resolution,
    ...
    SecretScanningAlertValidity Function()? validity,
    bool? Function()? publiclyLeaked,
    bool? Function()? multiRepo,
    bool? Function()? isBase64Encoded,
    SecretScanningFirstDetectedLocation? Function()? firstLocationDetected,
    bool Function()? hasMoreLocations,
    ...
    return SecretScanningAlert(
      ...
      isBase64Encoded: isBase64Encoded != null
          ? isBase64Encoded()
          : this.isBase64Encoded,
      firstLocationDetected: firstLocationDetected != null
          ? firstLocationDetected()
          : this.firstLocationDetected,
      hasMoreLocations: hasMoreLocations != null
          ? hasMoreLocations()
          : this.hasMoreLocations,
