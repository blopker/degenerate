...
import 'webhooks_reviewers2_reviewer_type.dart';

final class WebhooksReviewers2Reviewer {
  const WebhooksReviewers2Reviewer({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksReviewers2Reviewer.fromJson(Map<String, dynamic> json) {
    return WebhooksReviewers2Reviewer(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksReviewers2ReviewerType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksReviewers2Reviewer copyWith({
    ...
    WebhooksReviewers2ReviewerType Function()? type,
    Uri Function()? url,
  }) {
    return WebhooksReviewers2Reviewer(
  ...
  @override
  String toString() {
    return 'WebhooksReviewers2Reviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
