...
import 'package:collection/collection.dart';import 'orgs_set_cluster_deployment_records_request_deployments_runtime_risks.dart';import 'orgs_set_cluster_deployment_records_request_deployments_status.dart';final class OrgsSetClusterDeploymentRecordsRequestDeployments {const OrgsSetClusterDeploymentRecordsRequestDeployments({required this.name, required this.digest, this.version, this.status, required this.deploymentName, this.githubRepository, this.tags, this.runtimeRisks, });
