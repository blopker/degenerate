...
import 'inline_object69_pull_request_assignee_type.dart';

final class InlineObject69PullRequestAssignee {
  const InlineObject69PullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestAssignee copyWith({
    ...
    InlineObject69PullRequestAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
