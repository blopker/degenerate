...
import 'pull_request_review_comment_event_comment_user_type.dart';

final class PullRequestReviewCommentEventCommentUser {
  const PullRequestReviewCommentEventCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory PullRequestReviewCommentEventCommentUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return PullRequestReviewCommentEventCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? PullRequestReviewCommentEventCommentUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  PullRequestReviewCommentEventCommentUser copyWith({
    ...
    PullRequestReviewCommentEventCommentUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'PullRequestReviewCommentEventCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
