...
import 'webhook_issues_locked_issue_assignee_type.dart';

final class WebhookIssuesLockedIssueAssignee {
  const WebhookIssuesLockedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesLockedIssueAssignee.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesLockedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesLockedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesLockedIssueAssignee copyWith({
    ...
    WebhookIssuesLockedIssueAssigneeType Function()? type,
    Uri Function()? url,
