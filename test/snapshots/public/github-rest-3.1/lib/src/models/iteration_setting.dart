...
final class IterationSetting {
  const IterationSetting({
    required this.id,
    required this.title,
    this.titleHtml,
    this.duration,
  ...
  factory IterationSetting.fromJson(Map<String, dynamic> json) {
  ...
  IterationSetting copyWith({
    String? id,
    String? title,
    String Function()? titleHtml,
  ...
  @override
  int get hashCode {
    return Object.hash(id, title, titleHtml, duration, startDate, completed);
  }

  @override
  String toString() {
    return 'IterationSetting(id: $id, title: $title, titleHtml: $titleHtml, duration: $duration, startDate: $startDate, completed: $completed)';
  }
}
