...
import 'webhook_pull_request_dequeued_pull_request_auto_merge_enabled_by_type.dart';
...
final class WebhookPullRequestDequeuedPullRequestAutoMergeEnabledBy {
  ...
  factory WebhookPullRequestDequeuedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestDequeuedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestDequeuedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestDequeuedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestDequeuedPullRequestAutoMergeEnabledByType Function()?
    type,
    Uri Function()? url,
