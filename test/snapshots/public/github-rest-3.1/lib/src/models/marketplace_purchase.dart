...
import 'marketplace_purchase_marketplace_pending_change.dart';
import 'marketplace_purchase_marketplace_purchase.dart';
...
final class MarketplacePurchase {
  ...
  factory MarketplacePurchase.fromJson(Map<String, dynamic> json) {
    return MarketplacePurchase(
      ...
      marketplacePendingChange: json['marketplace_pending_change'] != null
          ? MarketplacePurchaseMarketplacePendingChange.fromJson(
  ...
  MarketplacePurchase copyWith({
    ...
    MarketplacePurchaseMarketplacePendingChange? Function()?
    ...
    return MarketplacePurchase(
      ...
      marketplacePendingChange: marketplacePendingChange != null
          ? marketplacePendingChange()
          : this.marketplacePendingChange,
  ...
  @override
  String toString() {
    return 'MarketplacePurchase(url: $url, type: $type, id: $id, login: $login, organizationBillingEmail: $organizationBillingEmail, email: $email, marketplacePendingChange: $marketplacePendingChange, marketplacePurchase: $marketplacePurchase)';
  }
}
