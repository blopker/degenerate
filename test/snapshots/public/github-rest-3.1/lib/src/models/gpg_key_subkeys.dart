...
import 'gpg_key_subkeys_emails.dart';

final class GpgKeySubkeys {
  const GpgKeySubkeys({
    this.id,
    this.primaryKeyId,
    this.keyId,
  ...
  factory GpgKeySubkeys.fromJson(Map<String, dynamic> json) {
    return GpgKeySubkeys(
      id: json['id'] != null ? (json['id'] as num).toInt() : null,
      primaryKeyId: json['primary_key_id'] != null
          ? (json['primary_key_id'] as num).toInt()
          : null,
      keyId: json['key_id'] as String?,
      publicKey: json['public_key'] as String?,
      emails: (json['emails'] as List<dynamic>?)
          ?.map((e) => GpgKeySubkeysEmails.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  GpgKeySubkeys copyWith({
    int Function()? id,
    int Function()? primaryKeyId,
    String Function()? keyId,
    String Function()? publicKey,
    List<GpgKeySubkeysEmails> Function()? emails,
    List<String> Function()? subkeys,
    bool Function()? canSign,
    bool Function()? canEncryptComms,
    bool Function()? canEncryptStorage,
    bool Function()? canCertify,
    ...
    return GpgKeySubkeys(
      ...
      canEncryptComms: canEncryptComms != null
          ? canEncryptComms()
          : this.canEncryptComms,
      canEncryptStorage: canEncryptStorage != null
          ? canEncryptStorage()
          : this.canEncryptStorage,
  ...
  int get hashCode {
    return Object.hash(
      ...
      keyId,
      publicKey,
      Object.hashAll(emails ?? const []),
      Object.hashAll(subkeys ?? const []),
      canSign,
      canEncryptComms,
      canEncryptStorage,
      canCertify,
  ...
  @override
  String toString() {
    return 'GpgKeySubkeys(id: $id, primaryKeyId: $primaryKeyId, keyId: $keyId, publicKey: $publicKey, emails: $emails, subkeys: $subkeys, canSign: $canSign, canEncryptComms: $canEncryptComms, canEncryptStorage: $canEncryptStorage, canCertify: $canCertify, createdAt: $createdAt, expiresAt: $expiresAt, rawKey: $rawKey, revoked: $revoked)';
  }
}
