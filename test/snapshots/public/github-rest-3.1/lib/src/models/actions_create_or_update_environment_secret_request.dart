...
final class ActionsCreateOrUpdateEnvironmentSecretRequest {
  const ActionsCreateOrUpdateEnvironmentSecretRequest({
  ...
  ActionsCreateOrUpdateEnvironmentSecretRequest copyWith({
  ...
  @override
  String toString() {
    return 'ActionsCreateOrUpdateEnvironmentSecretRequest(encryptedValue: $encryptedValue, keyId: $keyId)';
  }
}
