...
final class IssuesListFilter {
  const IssuesListFilter._(this.value);

  factory IssuesListFilter.fromJson(String json) {
    return switch (json) {
      'assigned' => assigned,
      'created' => created,
      'mentioned' => mentioned,
  ...
  static const List<IssuesListFilter> values = [
    assigned,
    created,
    mentioned,
    subscribed,
