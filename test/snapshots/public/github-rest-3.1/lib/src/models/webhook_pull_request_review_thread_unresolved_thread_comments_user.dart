...
import 'webhook_pull_request_review_thread_unresolved_thread_comments_user_type.dart';

final class WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser {
  const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser copyWith({
    ...
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
