...
final class InlineObject63PullRequestHeadUser {
  const InlineObject63PullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestHeadUser copyWith({
    ...
    InlineObject63PullRequestHeadUserType Function()? type,
    Uri Function()? url,
