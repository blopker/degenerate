...
final class Projects {
  ...
  factory Projects.fromJson(Map<String, dynamic> json) {
    return Projects(
      ...
      deletedBy: SimpleUser.fromJson(
        json['deleted_by'] as Map<String, dynamic>,
      ),
      state: json['state'] != null
          ? ProjectsState.fromJson(json['state'] as String)
          : null,
      latestStatusUpdate: json['latest_status_update'] != null
          ? StatusUpdate.fromJson(
              json['latest_status_update'] as Map<String, dynamic>,
            )
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (latestStatusUpdate != null)
        'latest_status_update': latestStatusUpdate?.toJson(),
  ...
  Projects copyWith({
    ...
    SimpleUser? Function()? deletedBy,
    ProjectsState Function()? state,
    StatusUpdate? Function()? latestStatusUpdate,
