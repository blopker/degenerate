...
import 'webhook_status_commit_author_type.dart';

final class WebhookStatusCommitAuthor {
  const WebhookStatusCommitAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookStatusCommitAuthor.fromJson(Map<String, dynamic> json) {
    return WebhookStatusCommitAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookStatusCommitAuthorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookStatusCommitAuthor copyWith({
    ...
    WebhookStatusCommitAuthorType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookStatusCommitAuthor(
