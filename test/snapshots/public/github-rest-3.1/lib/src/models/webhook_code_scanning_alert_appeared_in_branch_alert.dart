...
import 'webhook_code_scanning_alert_appeared_in_branch_alert_dismissed_by.dart';
import 'webhook_code_scanning_alert_appeared_in_branch_alert_dismissed_reason.dart';
import 'webhook_code_scanning_alert_appeared_in_branch_alert_most_recent_instance.dart';
import 'webhook_code_scanning_alert_appeared_in_branch_alert_rule.dart';
import 'webhook_code_scanning_alert_appeared_in_branch_alert_state.dart';
import 'webhook_code_scanning_alert_appeared_in_branch_alert_tool.dart';

/// The code scanning alert involved in the event.
final class WebhookCodeScanningAlertAppearedInBranchAlert {
  const WebhookCodeScanningAlertAppearedInBranchAlert({
    this.assignees,
  ...
  factory WebhookCodeScanningAlertAppearedInBranchAlert.fromJson(
    ...
    return WebhookCodeScanningAlertAppearedInBranchAlert(
      ...
      dismissedBy:
          WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy.fromJson(
            json['dismissed_by'] as Map<String, dynamic>,
          ),
      dismissedComment: json['dismissed_comment'] as String?,
      dismissedReason:
          WebhookCodeScanningAlertAppearedInBranchAlertDismissedReason.fromJson(
            json['dismissed_reason'] as String,
          ),
      fixedAt: json['fixed_at'] as String?,
      htmlUrl: Uri.parse(json['html_url'] as String),
      mostRecentInstance: json['most_recent_instance'] != null
          ? WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstance.fromJson(
              json['most_recent_instance'] as Map<String, dynamic>,
            )
          : null,
      number: (json['number'] as num).toInt(),
      rule: WebhookCodeScanningAlertAppearedInBranchAlertRule.fromJson(
        json['rule'] as Map<String, dynamic>,
      ),
      state: WebhookCodeScanningAlertAppearedInBranchAlertState.fromJson(
        json['state'] as String,
      ),
      tool: WebhookCodeScanningAlertAppearedInBranchAlertTool.fromJson(
  ...
  final WebhookCodeScanningAlertAppearedInBranchAlertDismissedReason?
  dismissedReason;
  ...
  final WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstance?
  mostRecentInstance;
  ...
  WebhookCodeScanningAlertAppearedInBranchAlert copyWith({
    List<SimpleUser> Function()? assignees,
    DateTime? createdAt,
    DateTime? Function()? dismissedAt,
    WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy? Function()?
    dismissedBy,
    String? Function()? dismissedComment,
    WebhookCodeScanningAlertAppearedInBranchAlertDismissedReason? Function()?
    dismissedReason,
    String? Function()? fixedAt,
    Uri? htmlUrl,
    WebhookCodeScanningAlertAppearedInBranchAlertMostRecentInstance? Function()?
    mostRecentInstance,
    int? number,
    WebhookCodeScanningAlertAppearedInBranchAlertRule? rule,
    WebhookCodeScanningAlertAppearedInBranchAlertState? Function()? state,
