...
import 'repos_create_deployment_status_request_state.dart';

final class ReposCreateDeploymentStatusRequest {
  ...
  factory ReposCreateDeploymentStatusRequest.fromJson(
    ...
    return ReposCreateDeploymentStatusRequest(
      ...
      targetUrl: json.containsKey('target_url')
      ...
      environmentUrl: json.containsKey('environment_url')
          ? json['environment_url'] as String
          : '',
  ...
  ReposCreateDeploymentStatusRequest copyWith({
  ...
  @override
  String toString() {
    return 'ReposCreateDeploymentStatusRequest(state: $state, targetUrl: $targetUrl, logUrl: $logUrl, description: $description, environment: $environment, environmentUrl: $environmentUrl, autoInactive: $autoInactive)';
  }
}
