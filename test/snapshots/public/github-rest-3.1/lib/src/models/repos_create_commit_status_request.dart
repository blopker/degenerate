...
import 'repos_create_commit_status_request_state.dart';

final class ReposCreateCommitStatusRequest {
  ...
  factory ReposCreateCommitStatusRequest.fromJson(Map<String, dynamic> json) {
    return ReposCreateCommitStatusRequest(
      ...
      context: json.containsKey('context')
  ...
  ReposCreateCommitStatusRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(state, targetUrl, description, context);
  }

  @override
  String toString() {
    return 'ReposCreateCommitStatusRequest(state: $state, targetUrl: $targetUrl, description: $description, context: $context)';
  }
}
