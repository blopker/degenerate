...
import 'repos_create_commit_status_request_state.dart';final class ReposCreateCommitStatusRequest {const ReposCreateCommitStatusRequest({required this.state, this.targetUrl, this.description, this.context = 'default', });
