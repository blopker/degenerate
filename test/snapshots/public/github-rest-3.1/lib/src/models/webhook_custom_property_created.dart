...
import 'custom_property.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_custom_property_created_action.dart';final class WebhookCustomPropertyCreated {const WebhookCustomPropertyCreated({required this.action, required this.definition, this.enterprise, this.installation, this.organization, this.sender, });
