...
import 'webhook_pull_request_enqueued_pull_request_assignees_type.dart';

final class WebhookPullRequestEnqueuedPullRequestAssignees {
  const WebhookPullRequestEnqueuedPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestEnqueuedPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestEnqueuedPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestEnqueuedPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestEnqueuedPullRequestAssignees copyWith({
    ...
    WebhookPullRequestEnqueuedPullRequestAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestEnqueuedPullRequestAssignees(
  ...
  @override
  String toString() {
    return 'WebhookPullRequestEnqueuedPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
