...
import 'webhook_pull_request_review_comment_deleted_pull_request_assignees_type.dart';

final class WebhookPullRequestReviewCommentDeletedPullRequestAssignees {
  const WebhookPullRequestReviewCommentDeletedPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentDeletedPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentDeletedPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewCommentDeletedPullRequestAssignees copyWith({
    ...
    WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType Function()?
    type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestReviewCommentDeletedPullRequestAssignees(
