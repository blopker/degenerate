...
final class ActionsCacheUsageByRepository {
  ...
  factory ActionsCacheUsageByRepository.fromJson(Map<String, dynamic> json) {
    return ActionsCacheUsageByRepository(
      ...
      activeCachesSizeInBytes: (json['active_caches_size_in_bytes'] as num)
          .toInt(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('full_name') &&
        ...
        json.containsKey('active_caches_size_in_bytes') &&
        json['active_caches_size_in_bytes'] is num &&
        json.containsKey('active_caches_count') &&
        json['active_caches_count'] is num;
  }

  ActionsCacheUsageByRepository copyWith({
    String? fullName,
    ...
    return ActionsCacheUsageByRepository(
      ...
      activeCachesSizeInBytes:
          activeCachesSizeInBytes ?? this.activeCachesSizeInBytes,
  ...
  @override
  int get hashCode {
    return Object.hash(fullName, activeCachesSizeInBytes, activeCachesCount);
  }

  @override
  String toString() {
    return 'ActionsCacheUsageByRepository(fullName: $fullName, activeCachesSizeInBytes: $activeCachesSizeInBytes, activeCachesCount: $activeCachesCount)';
  }
}
