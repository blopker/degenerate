...
final class CopilotOrganizationSeatBreakdown {
  ...
  factory CopilotOrganizationSeatBreakdown.fromJson(Map<String, dynamic> json) {
    return CopilotOrganizationSeatBreakdown(
      ...
      addedThisCycle: json['added_this_cycle'] != null
          ? (json['added_this_cycle'] as num).toInt()
          : null,
      pendingCancellation: json['pending_cancellation'] != null
          ? (json['pending_cancellation'] as num).toInt()
          : null,
      pendingInvitation: json['pending_invitation'] != null
          ? (json['pending_invitation'] as num).toInt()
          : null,
      activeThisCycle: json['active_this_cycle'] != null
          ? (json['active_this_cycle'] as num).toInt()
          : null,
      inactiveThisCycle: json['inactive_this_cycle'] != null
          ? (json['inactive_this_cycle'] as num).toInt()
          : null,
    );
  }
  ...
  CopilotOrganizationSeatBreakdown copyWith({
    int Function()? total,
    int Function()? addedThisCycle,
    int Function()? pendingCancellation,
    int Function()? pendingInvitation,
    int Function()? activeThisCycle,
    int Function()? inactiveThisCycle,
  }) {
    return CopilotOrganizationSeatBreakdown(
      total: total != null ? total() : this.total,
      addedThisCycle: addedThisCycle != null
          ? addedThisCycle()
          : this.addedThisCycle,
      ...
      pendingInvitation: pendingInvitation != null
          ? pendingInvitation()
          : this.pendingInvitation,
      activeThisCycle: activeThisCycle != null
          ? activeThisCycle()
          : this.activeThisCycle,
      inactiveThisCycle: inactiveThisCycle != null
          ? inactiveThisCycle()
          : this.inactiveThisCycle,
    );
  }
  ...
  @override
  String toString() {
    return 'CopilotOrganizationSeatBreakdown(total: $total, addedThisCycle: $addedThisCycle, pendingCancellation: $pendingCancellation, pendingInvitation: $pendingInvitation, activeThisCycle: $activeThisCycle, inactiveThisCycle: $inactiveThisCycle)';
  }
}
