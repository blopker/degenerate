...
import 'webhook_pull_request_unlabeled_pull_request_base_user_type.dart';

final class WebhookPullRequestUnlabeledPullRequestBaseUser {
  const WebhookPullRequestUnlabeledPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlabeledPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlabeledPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlabeledPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlabeledPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestUnlabeledPullRequestBaseUserType Function()? type,
    Uri Function()? url,
