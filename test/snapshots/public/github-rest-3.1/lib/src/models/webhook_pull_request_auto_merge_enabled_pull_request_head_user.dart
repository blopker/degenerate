...
import 'webhook_pull_request_auto_merge_enabled_pull_request_head_user_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestHeadUser {
  const WebhookPullRequestAutoMergeEnabledPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestHeadUserType Function()? type,
    Uri Function()? url,
