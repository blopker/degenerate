...
import 'webhooks_team_notification_setting.dart';
import 'webhooks_team_parent.dart';
import 'webhooks_team_privacy.dart';
import 'webhooks_team_type.dart';

/// Groups of organization members that gives permissions on specified repositories.
final class WebhooksTeam {
  const WebhooksTeam({
    this.deleted,
    this.description,
    this.htmlUrl,
  ...
  factory WebhooksTeam.fromJson(Map<String, dynamic> json) {
    return WebhooksTeam(
      ...
      privacy: json['privacy'] != null
          ? WebhooksTeamPrivacy.fromJson(json['privacy'] as String)
          : null,
      notificationSetting: json['notification_setting'] != null
          ? WebhooksTeamNotificationSetting.fromJson(
      ...
      type: json['type'] != null
          ? WebhooksTeamType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksTeam copyWith({
    ...
    WebhooksTeamParent? Function()? parent,
    String Function()? permission,
    WebhooksTeamPrivacy Function()? privacy,
    WebhooksTeamNotificationSetting Function()? notificationSetting,
    Uri Function()? repositoriesUrl,
    String Function()? slug,
    Uri Function()? url,
    WebhooksTeamType Function()? type,
  ...
  @override
  String toString() {
    return 'WebhooksTeam(deleted: $deleted, description: $description, htmlUrl: $htmlUrl, id: $id, membersUrl: $membersUrl, name: $name, nodeId: $nodeId, parent: $parent, permission: $permission, privacy: $privacy, notificationSetting: $notificationSetting, repositoriesUrl: $repositoriesUrl, slug: $slug, url: $url, type: $type, organizationId: $organizationId, enterpriseId: $enterpriseId)';
  }
}
