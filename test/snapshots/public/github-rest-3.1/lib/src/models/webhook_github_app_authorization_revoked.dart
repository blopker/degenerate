...
import 'simple_user.dart';import 'webhook_github_app_authorization_revoked_action.dart';final class WebhookGithubAppAuthorizationRevoked {const WebhookGithubAppAuthorizationRevoked({required this.action, required this.sender, });
