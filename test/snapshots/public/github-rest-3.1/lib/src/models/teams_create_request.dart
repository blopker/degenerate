...
import 'package:collection/collection.dart';import 'teams_create_request_notification_setting.dart';import 'teams_create_request_permission.dart';import 'teams_create_request_privacy.dart';final class TeamsCreateRequest {const TeamsCreateRequest({required this.name, this.description, this.maintainers, this.repoNames, this.privacy, this.notificationSetting, this.permission = TeamsCreateRequestPermission.pull, this.parentTeamId, });
