...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_member_added_action.dart';import 'webhook_member_added_changes.dart';import 'webhooks_user.dart';final class WebhookMemberAdded {const WebhookMemberAdded({required this.action, this.changes, this.enterprise, this.installation, required this.member, this.organization, required this.repository, required this.sender, });
...
factory WebhookMemberAdded.fromJson(Map<String, dynamic> json) { return WebhookMemberAdded(
  ...
  changes: json['changes'] != null
        ? WebhookMemberAddedChanges.fromJson(json['changes'] as Map<String, dynamic>)
        : null,
