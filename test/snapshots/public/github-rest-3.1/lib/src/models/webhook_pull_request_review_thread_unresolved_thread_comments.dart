...
import 'webhook_pull_request_review_thread_unresolved_thread_comments_author_association.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_links.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_reactions.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_side.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_start_side.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_subject_type.dart';
import 'webhook_pull_request_review_thread_unresolved_thread_comments_user.dart';
...
final class WebhookPullRequestReviewThreadUnresolvedThreadComments {
  const WebhookPullRequestReviewThreadUnresolvedThreadComments({
    required this.links,
    ...
    this.startSide =
        WebhookPullRequestReviewThreadUnresolvedThreadCommentsStartSide.right,
    this.subjectType,
  ...
  factory WebhookPullRequestReviewThreadUnresolvedThreadComments.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadUnresolvedThreadComments(
      links:
          WebhookPullRequestReviewThreadUnresolvedThreadCommentsLinks.fromJson(
            json['_links'] as Map<String, dynamic>,
          ),
      authorAssociation:
          WebhookPullRequestReviewThreadUnresolvedThreadCommentsAuthorAssociation.fromJson(
      ...
      reactions:
          WebhookPullRequestReviewThreadUnresolvedThreadCommentsReactions.fromJson(
            json['reactions'] as Map<String, dynamic>,
          ),
      side: WebhookPullRequestReviewThreadUnresolvedThreadCommentsSide.fromJson(
        json['side'] as String,
      ),
      startLine: (json['start_line'] as num).toInt(),
      startSide:
          WebhookPullRequestReviewThreadUnresolvedThreadCommentsStartSide.fromJson(
            json['start_side'] as String,
          ),
      subjectType: json['subject_type'] != null
          ? WebhookPullRequestReviewThreadUnresolvedThreadCommentsSubjectType.fromJson(
              json['subject_type'] as String,
            )
          : null,
      updatedAt: DateTime.parse(json['updated_at'] as String),
      url: Uri.parse(json['url'] as String),
      user: WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser.fromJson(
  ...
  final WebhookPullRequestReviewThreadUnresolvedThreadCommentsAuthorAssociation
  authorAssociation;
  ...
  final WebhookPullRequestReviewThreadUnresolvedThreadCommentsReactions
  reactions;
  ...
  /// The side of the first line of the range for a multi-line comment.
  final WebhookPullRequestReviewThreadUnresolvedThreadCommentsStartSide?
  startSide;

  /// The level at which the comment is targeted, can be a diff line or a file.
  final WebhookPullRequestReviewThreadUnresolvedThreadCommentsSubjectType?
  subjectType;
  ...
  WebhookPullRequestReviewThreadUnresolvedThreadComments copyWith({
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsLinks? links,
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsAuthorAssociation?
    authorAssociation,
    String? body,
    String? commitId,
    DateTime? createdAt,
    ...
    Uri? pullRequestUrl,
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsReactions? reactions,
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsSide? side,
    int? Function()? startLine,
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsStartSide? Function()?
    startSide,
    ...
    DateTime? updatedAt,
    Uri? url,
    WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser? Function()?
    user,
  }) {
    return WebhookPullRequestReviewThreadUnresolvedThreadComments(
