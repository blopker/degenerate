...
import 'deployment_branch_policy_settings.dart';
import 'repos_create_or_update_environment_request_reviewers.dart';

final class ReposCreateOrUpdateEnvironmentRequest {
  ...
  factory ReposCreateOrUpdateEnvironmentRequest.fromJson(
    ...
    return ReposCreateOrUpdateEnvironmentRequest(
      ...
      reviewers: (json['reviewers'] as List<dynamic>?)
          ?.map(
            (e) => ReposCreateOrUpdateEnvironmentRequestReviewers.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      deploymentBranchPolicy: json['deployment_branch_policy'] != null
          ? DeploymentBranchPolicySettings.fromJson(
  ...
  ReposCreateOrUpdateEnvironmentRequest copyWith({
    int Function()? waitTimer,
    bool Function()? preventSelfReview,
    List<ReposCreateOrUpdateEnvironmentRequestReviewers>? Function()? reviewers,
    DeploymentBranchPolicySettings Function()? deploymentBranchPolicy,
  }) {
    return ReposCreateOrUpdateEnvironmentRequest(
  ...
  @override
  String toString() {
    return 'ReposCreateOrUpdateEnvironmentRequest(waitTimer: $waitTimer, preventSelfReview: $preventSelfReview, reviewers: $reviewers, deploymentBranchPolicy: $deploymentBranchPolicy)';
  }
}
