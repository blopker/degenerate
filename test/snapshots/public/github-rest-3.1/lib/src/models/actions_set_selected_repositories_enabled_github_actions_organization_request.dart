...
final class ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest {
  ...
  copyWith({List<int>? selectedRepositoryIds}) {
    return ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest(
  ...
  @override
  String toString() {
    return 'ActionsSetSelectedRepositoriesEnabledGithubActionsOrganizationRequest(selectedRepositoryIds: $selectedRepositoryIds)';
  }
}
