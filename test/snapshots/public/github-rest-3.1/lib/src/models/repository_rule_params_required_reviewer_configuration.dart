...
import 'repository_rule_params_reviewer.dart';

/// A reviewing team, and file patterns describing which files they must approve changes to.
final class RepositoryRuleParamsRequiredReviewerConfiguration {
  const RepositoryRuleParamsRequiredReviewerConfiguration({
    required this.filePatterns,
    required this.minimumApprovals,
    required this.reviewer,
  });

  factory RepositoryRuleParamsRequiredReviewerConfiguration.fromJson(
    ...
    return RepositoryRuleParamsRequiredReviewerConfiguration(
      ...
      reviewer: RepositoryRuleParamsReviewer.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('file_patterns') &&
        json.containsKey('minimum_approvals') &&
        json['minimum_approvals'] is num &&
        json.containsKey('reviewer');
  }

  RepositoryRuleParamsRequiredReviewerConfiguration copyWith({
    List<String>? filePatterns,
    int? minimumApprovals,
    RepositoryRuleParamsReviewer? reviewer,
  }) {
    return RepositoryRuleParamsRequiredReviewerConfiguration(
  ...
  @override
  String toString() {
    return 'RepositoryRuleParamsRequiredReviewerConfiguration(filePatterns: $filePatterns, minimumApprovals: $minimumApprovals, reviewer: $reviewer)';
  }
}
