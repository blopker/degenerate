...
import 'webhook_code_scanning_alert_updated_assignment_alert_dismissed_by_type.dart';

final class WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy {
  const WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy copyWith({
    ...
    WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedByType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookCodeScanningAlertUpdatedAssignmentAlertDismissedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
