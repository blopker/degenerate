...
import 'webhook_code_scanning_alert_reopened_by_user_alert_rule_severity.dart';final class WebhookCodeScanningAlertReopenedByUserAlertRule {const WebhookCodeScanningAlertReopenedByUserAlertRule({required this.description, required this.id, required this.severity, });
