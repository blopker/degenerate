...
import 'webhooks_sponsorship_sponsor_type.dart';

final class WebhooksSponsorshipSponsor {
  const WebhooksSponsorshipSponsor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksSponsorshipSponsor.fromJson(Map<String, dynamic> json) {
    return WebhooksSponsorshipSponsor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksSponsorshipSponsorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksSponsorshipSponsor copyWith({
    ...
    WebhooksSponsorshipSponsorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksSponsorshipSponsor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
