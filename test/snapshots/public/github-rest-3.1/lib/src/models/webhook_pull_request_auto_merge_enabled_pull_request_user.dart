...
import 'webhook_pull_request_auto_merge_enabled_pull_request_user_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestUser {
  const WebhookPullRequestAutoMergeEnabledPullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestUser copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestUserType Function()? type,
    Uri Function()? url,
