...
import 'webhook_issues_transferred_changes_new_issue_milestone_creator_type.dart';

final class WebhookIssuesTransferredChangesNewIssueMilestoneCreator {
  const WebhookIssuesTransferredChangesNewIssueMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesTransferredChangesNewIssueMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesTransferredChangesNewIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesTransferredChangesNewIssueMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesTransferredChangesNewIssueMilestoneCreator copyWith({
    ...
    WebhookIssuesTransferredChangesNewIssueMilestoneCreatorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesTransferredChangesNewIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
