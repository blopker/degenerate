...
final class LabelSearchResultItem {
  ...
  LabelSearchResultItem copyWith({
    int? id,
    String? nodeId,
    Uri? url,
    String? name,
  ...
  @override
  String toString() {
    return 'LabelSearchResultItem(id: $id, nodeId: $nodeId, url: $url, name: $name, color: $color, \$default: ${$default}, description: $description, score: $score, textMatches: $textMatches)';
  }
}
