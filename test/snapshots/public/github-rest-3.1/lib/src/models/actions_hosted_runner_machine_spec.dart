...
final class ActionsHostedRunnerMachineSpec {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('cpu_cores') &&
        json['cpu_cores'] is num &&
        json.containsKey('memory_gb') &&
        json['memory_gb'] is num &&
        json.containsKey('storage_gb') &&
        json['storage_gb'] is num;
  }

  ActionsHostedRunnerMachineSpec copyWith({
    String? id,
    int? cpuCores,
    int? memoryGb,
    int? storageGb,
  ...
  @override
  int get hashCode {
    return Object.hash(id, cpuCores, memoryGb, storageGb);
  }

  @override
  String toString() {
    return 'ActionsHostedRunnerMachineSpec(id: $id, cpuCores: $cpuCores, memoryGb: $memoryGb, storageGb: $storageGb)';
  }
}
