...
import 'inline_object123_geo.dart';final class InlineObject123 {const InlineObject123({required this.repositoryId, this.ref, this.location, this.geo, this.clientIp, this.machine, this.devcontainerPath, this.multiRepoPermissionsOptOut, this.workingDirectory, this.idleTimeoutMinutes, this.displayName, this.retentionPeriodMinutes, });
