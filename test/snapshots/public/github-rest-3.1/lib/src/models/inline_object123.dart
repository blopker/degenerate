...
import 'inline_object123_geo.dart';
...
final class InlineObject123 {
  ...
  factory InlineObject123.fromJson(Map<String, dynamic> json) {
    return InlineObject123(
      ...
      geo: json['geo'] != null
          ? InlineObject123Geo.fromJson(json['geo'] as String)
          : null,
      ...
      idleTimeoutMinutes: json['idle_timeout_minutes'] != null
          ? (json['idle_timeout_minutes'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('repository_id') && json['repository_id'] is num;
  }

  InlineObject123 copyWith({
    int? repositoryId,
    String Function()? ref,
    String Function()? location,
    InlineObject123Geo Function()? geo,
    String Function()? clientIp,
    String Function()? machine,
    String Function()? devcontainerPath,
    bool Function()? multiRepoPermissionsOptOut,
    ...
    return InlineObject123(
      ...
      devcontainerPath: devcontainerPath != null
          ? devcontainerPath()
          : this.devcontainerPath,
      multiRepoPermissionsOptOut: multiRepoPermissionsOptOut != null
          ? multiRepoPermissionsOptOut()
          : this.multiRepoPermissionsOptOut,
