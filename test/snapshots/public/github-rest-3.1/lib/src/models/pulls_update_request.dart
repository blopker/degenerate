...
import 'pulls_update_request_state.dart';

final class PullsUpdateRequest {
  ...
  factory PullsUpdateRequest.fromJson(Map<String, dynamic> json) {
    return PullsUpdateRequest(
      ...
      state: json['state'] != null
          ? PullsUpdateRequestState.fromJson(json['state'] as String)
          : null,
  ...
  PullsUpdateRequest copyWith({
    String Function()? title,
    String Function()? body,
    PullsUpdateRequestState Function()? state,
  ...
  @override
  int get hashCode {
    return Object.hash(title, body, state, base, maintainerCanModify);
  }

  @override
  String toString() {
    return 'PullsUpdateRequest(title: $title, body: $body, state: $state, base: $base, maintainerCanModify: $maintainerCanModify)';
  }
}
