...
import 'item_content_type.dart';
import 'simple_user.dart';

/// An item belonging to a project
final class ItemWithContent {
  ...
  factory ItemWithContent.fromJson(Map<String, dynamic> json) {
    return ItemWithContent(
      id: (json['id'] as num).toDouble(),
      nodeId: json['node_id'] as String?,
      projectUrl: json['project_url'] != null
          ? Uri.parse(json['project_url'] as String)
          : null,
      ...
      itemUrl: json['item_url'] != null
          ? Uri.parse(json['item_url'] as String)
          : null,
  ...
  ItemWithContent copyWith({
    double? id,
    String Function()? nodeId,
    Uri Function()? projectUrl,
    ItemContentType? contentType,
    Map<String, String>? Function()? content,
    SimpleUser Function()? creator,
    DateTime? createdAt,
    DateTime? updatedAt,
    DateTime? Function()? archivedAt,
    Uri? Function()? itemUrl,
    List<Map<String, String>> Function()? fields,
  }) {
    return ItemWithContent(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'ItemWithContent(id: $id, nodeId: $nodeId, projectUrl: $projectUrl, contentType: $contentType, content: $content, creator: $creator, createdAt: $createdAt, updatedAt: $updatedAt, archivedAt: $archivedAt, itemUrl: $itemUrl, fields: $fields)';
  }
}
