...
import 'webhook_pull_request_review_comment_edited_pull_request_user_type.dart';

final class WebhookPullRequestReviewCommentEditedPullRequestUser {
  const WebhookPullRequestReviewCommentEditedPullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentEditedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentEditedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentEditedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewCommentEditedPullRequestUser copyWith({
    ...
    WebhookPullRequestReviewCommentEditedPullRequestUserType Function()? type,
