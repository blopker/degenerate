...
import 'inline_object63_pull_request_user_type.dart';

final class InlineObject63PullRequestUser {
  const InlineObject63PullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestUser.fromJson(Map<String, dynamic> json) {
    return InlineObject63PullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestUserType.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject63PullRequestUser copyWith({
    ...
    InlineObject63PullRequestUserType Function()? type,
    Uri Function()? url,
