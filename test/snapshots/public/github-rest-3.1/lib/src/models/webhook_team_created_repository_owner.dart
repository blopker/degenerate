...
import 'webhook_team_created_repository_owner_type.dart';

final class WebhookTeamCreatedRepositoryOwner {
  const WebhookTeamCreatedRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookTeamCreatedRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookTeamCreatedRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookTeamCreatedRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookTeamCreatedRepositoryOwner copyWith({
    ...
    WebhookTeamCreatedRepositoryOwnerType Function()? type,
    Uri Function()? url,
