...
import 'webhook_issues_reopened_issue_milestone_creator_type.dart';

final class WebhookIssuesReopenedIssueMilestoneCreator {
  const WebhookIssuesReopenedIssueMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesReopenedIssueMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesReopenedIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesReopenedIssueMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesReopenedIssueMilestoneCreator copyWith({
    ...
    WebhookIssuesReopenedIssueMilestoneCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesReopenedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
