...
import 'webhook_team_added_to_repository_repository_owner_type.dart';

final class WebhookTeamAddedToRepositoryRepositoryOwner {
  const WebhookTeamAddedToRepositoryRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookTeamAddedToRepositoryRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookTeamAddedToRepositoryRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookTeamAddedToRepositoryRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookTeamAddedToRepositoryRepositoryOwner copyWith({
    ...
    WebhookTeamAddedToRepositoryRepositoryOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookTeamAddedToRepositoryRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
