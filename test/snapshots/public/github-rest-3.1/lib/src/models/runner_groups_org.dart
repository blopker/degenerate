...
import 'package:collection/collection.dart';final class RunnerGroupsOrg {const RunnerGroupsOrg({required this.id, required this.name, required this.visibility, required this.$default, this.selectedRepositoriesUrl, required this.runnersUrl, this.hostedRunnersUrl, this.networkConfigurationId, required this.inherited, this.inheritedAllowsPublicRepositories, required this.allowsPublicRepositories, this.workflowRestrictionsReadOnly = false, this.restrictedToWorkflows = false, this.selectedWorkflows, });
