...
final class RunnerGroupsOrg {
  ...
  factory RunnerGroupsOrg.fromJson(Map<String, dynamic> json) {
    return RunnerGroupsOrg(
      ...
      workflowRestrictionsReadOnly:
          json.containsKey('workflow_restrictions_read_only')
          ? json['workflow_restrictions_read_only'] as bool
          : false,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('runners_url') &&
        json['runners_url'] is String &&
        json.containsKey('inherited') &&
        json['inherited'] is bool &&
        json.containsKey('allows_public_repositories') &&
        json['allows_public_repositories'] is bool;
  }
  ...
  RunnerGroupsOrg copyWith({
    ...
    String? runnersUrl,
    String Function()? hostedRunnersUrl,
    String Function()? networkConfigurationId,
    bool? inherited,
    bool Function()? inheritedAllowsPublicRepositories,
    bool? allowsPublicRepositories,
    bool Function()? workflowRestrictionsReadOnly,
    ...
    return RunnerGroupsOrg(
      ...
      hostedRunnersUrl: hostedRunnersUrl != null
          ? hostedRunnersUrl()
          : this.hostedRunnersUrl,
      ...
      inheritedAllowsPublicRepositories:
          inheritedAllowsPublicRepositories != null
          ? inheritedAllowsPublicRepositories()
          : this.inheritedAllowsPublicRepositories,
      allowsPublicRepositories:
          allowsPublicRepositories ?? this.allowsPublicRepositories,
      workflowRestrictionsReadOnly: workflowRestrictionsReadOnly != null
          ? workflowRestrictionsReadOnly()
