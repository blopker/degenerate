...
final class ActionsCacheUsageOrgEnterprise {
  ...
  factory ActionsCacheUsageOrgEnterprise.fromJson(Map<String, dynamic> json) {
    return ActionsCacheUsageOrgEnterprise(
      totalActiveCachesCount: (json['total_active_caches_count'] as num)
          .toInt(),
      totalActiveCachesSizeInBytes:
          (json['total_active_caches_size_in_bytes'] as num).toInt(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('total_active_caches_count') &&
        json['total_active_caches_count'] is num &&
        json.containsKey('total_active_caches_size_in_bytes') &&
        json['total_active_caches_size_in_bytes'] is num;
  }

  ActionsCacheUsageOrgEnterprise copyWith({
    int? totalActiveCachesCount,
    int? totalActiveCachesSizeInBytes,
  }) {
    return ActionsCacheUsageOrgEnterprise(
      totalActiveCachesCount:
          totalActiveCachesCount ?? this.totalActiveCachesCount,
      totalActiveCachesSizeInBytes:
          totalActiveCachesSizeInBytes ?? this.totalActiveCachesSizeInBytes,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(totalActiveCachesCount, totalActiveCachesSizeInBytes);
  }

  @override
  String toString() {
    return 'ActionsCacheUsageOrgEnterprise(totalActiveCachesCount: $totalActiveCachesCount, totalActiveCachesSizeInBytes: $totalActiveCachesSizeInBytes)';
  }
}
