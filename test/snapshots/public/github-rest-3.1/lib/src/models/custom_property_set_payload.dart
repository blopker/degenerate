...
import 'custom_property_set_payload_default_value.dart';
import 'custom_property_set_payload_value_type.dart';
import 'custom_property_set_payload_values_editable_by.dart';

/// Custom property set payload
final class CustomPropertySetPayload {
  ...
  factory CustomPropertySetPayload.fromJson(Map<String, dynamic> json) {
    return CustomPropertySetPayload(
      ...
      valuesEditableBy: json['values_editable_by'] != null
          ? CustomPropertySetPayloadValuesEditableBy.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('value_type');
  }

  CustomPropertySetPayload copyWith({
    CustomPropertySetPayloadValueType? valueType,
    bool Function()? $required,
    CustomPropertySetPayloadDefaultValue? Function()? defaultValue,
    String? Function()? description,
    List<String>? Function()? allowedValues,
    CustomPropertySetPayloadValuesEditableBy? Function()? valuesEditableBy,
  ...
  @override
  String toString() {
    return 'CustomPropertySetPayload(valueType: $valueType, \$required: ${$required}, defaultValue: $defaultValue, description: $description, allowedValues: $allowedValues, valuesEditableBy: $valuesEditableBy, requireExplicitValues: $requireExplicitValues)';
  }
}
