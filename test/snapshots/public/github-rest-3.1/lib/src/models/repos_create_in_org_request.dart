...
import 'repos_create_in_org_request_merge_commit_message.dart';import 'repos_create_in_org_request_merge_commit_title.dart';import 'repos_create_in_org_request_squash_merge_commit_message.dart';import 'repos_create_in_org_request_squash_merge_commit_title.dart';import 'repos_create_in_org_request_visibility.dart';final class ReposCreateInOrgRequest {const ReposCreateInOrgRequest({required this.name, this.description, this.homepage, this.private = false, this.visibility, this.hasIssues = true, this.hasProjects = true, this.hasWiki = true, this.hasDownloads = true, this.isTemplate = false, this.teamId, this.autoInit = false, this.gitignoreTemplate, this.licenseTemplate, this.allowSquashMerge = true, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowAutoMerge = false, this.deleteBranchOnMerge = false, this.useSquashPrTitleAsDefault = false, this.squashMergeCommitTitle, this.squashMergeCommitMessage, this.mergeCommitTitle, this.mergeCommitMessage, this.customProperties, });
