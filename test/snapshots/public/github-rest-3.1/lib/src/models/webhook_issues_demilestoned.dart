...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_issues_demilestoned_action.dart';import 'webhook_issues_demilestoned_issue.dart';import 'webhooks_milestone.dart';final class WebhookIssuesDemilestoned {const WebhookIssuesDemilestoned({required this.action, this.enterprise, this.installation, required this.issue, this.milestone, this.organization, required this.repository, required this.sender, });
...
factory WebhookIssuesDemilestoned.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestoned(
  ...
  milestone: json['milestone'] != null
        ? WebhooksMilestone.fromJson(json['milestone'] as Map<String, dynamic>)
        : null,
