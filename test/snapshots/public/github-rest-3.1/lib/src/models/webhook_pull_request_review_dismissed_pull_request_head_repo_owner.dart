...
import 'webhook_pull_request_review_dismissed_pull_request_head_repo_owner_type.dart';

final class WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner {
  const WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner copyWith({
    ...
    WebhookPullRequestReviewDismissedPullRequestHeadRepoOwnerType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
