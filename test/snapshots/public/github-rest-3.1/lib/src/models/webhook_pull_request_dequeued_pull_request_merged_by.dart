...
import 'webhook_pull_request_dequeued_pull_request_merged_by_type.dart';

final class WebhookPullRequestDequeuedPullRequestMergedBy {
  const WebhookPullRequestDequeuedPullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestDequeuedPullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestDequeuedPullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestDequeuedPullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestDequeuedPullRequestMergedBy copyWith({
    ...
    WebhookPullRequestDequeuedPullRequestMergedByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestDequeuedPullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
