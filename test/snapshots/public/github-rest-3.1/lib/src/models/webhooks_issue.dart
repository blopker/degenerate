...
import 'package:collection/collection.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_type.dart';import 'sub_issues_summary.dart';import 'webhooks_issue_active_lock_reason.dart';import 'webhooks_issue_assignee.dart';import 'webhooks_issue_assignees.dart';import 'webhooks_issue_author_association.dart';import 'webhooks_issue_labels.dart';import 'webhooks_issue_milestone.dart';import 'webhooks_issue_performed_via_github_app.dart';import 'webhooks_issue_pull_request.dart';import 'webhooks_issue_reactions.dart';import 'webhooks_issue_state.dart';import 'webhooks_issue_user.dart';/// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
...
factory WebhooksIssue.fromJson(Map<String, dynamic> json) { return WebhooksIssue(
  activeLockReason: WebhooksIssueActiveLockReason.fromJson(json['active_lock_reason'] as String),
  assignee: json['assignee'] != null
        ? WebhooksIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>)
        : null,
  ...
  milestone: WebhooksIssueMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  performedViaGithubApp: json['performed_via_github_app'] != null
        ? WebhooksIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>)
        : null,
  pullRequest: json['pull_request'] != null
        ? WebhooksIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>)
        : null,
