...
import 'pull_request_minimal_base.dart';
import 'pull_request_minimal_head.dart';
...
final class PullRequestMinimal {
  ...
  PullRequestMinimal copyWith({
    int? id,
    int? number,
    String? url,
    PullRequestMinimalHead? head,
    PullRequestMinimalBase? base,
  }) {
    return PullRequestMinimal(
      id: id ?? this.id,
  ...
  @override
  int get hashCode {
    return Object.hash(id, number, url, head, base);
  }
