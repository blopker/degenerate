...
import 'simple_check_suite_conclusion.dart';
import 'simple_check_suite_status.dart';

/// A suite of checks performed on the code of a given code change
final class SimpleCheckSuite {
  const SimpleCheckSuite({
    this.after,
    this.app,
    this.before,
    this.conclusion,
  ...
  factory SimpleCheckSuite.fromJson(Map<String, dynamic> json) {
    return SimpleCheckSuite(
      ...
      conclusion: json['conclusion'] != null
          ? SimpleCheckSuiteConclusion.fromJson(json['conclusion'] as String)
          : null,
      ...
      status: json['status'] != null
          ? SimpleCheckSuiteStatus.fromJson(json['status'] as String)
          : null,
  ...
  SimpleCheckSuite copyWith({
    String? Function()? after,
    Integration Function()? app,
    String? Function()? before,
    SimpleCheckSuiteConclusion? Function()? conclusion,
    DateTime Function()? createdAt,
    String? Function()? headBranch,
    String Function()? headSha,
    int Function()? id,
    String Function()? nodeId,
    List<PullRequestMinimal> Function()? pullRequests,
    MinimalRepository Function()? repository,
    SimpleCheckSuiteStatus Function()? status,
  ...
  @override
  String toString() {
    return 'SimpleCheckSuite(after: $after, app: $app, before: $before, conclusion: $conclusion, createdAt: $createdAt, headBranch: $headBranch, headSha: $headSha, id: $id, nodeId: $nodeId, pullRequests: $pullRequests, repository: $repository, status: $status, updatedAt: $updatedAt, url: $url)';
  }
}
