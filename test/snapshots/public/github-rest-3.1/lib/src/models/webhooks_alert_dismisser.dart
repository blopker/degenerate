...
import 'webhooks_alert_dismisser_type.dart';

final class WebhooksAlertDismisser {
  const WebhooksAlertDismisser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksAlertDismisser.fromJson(Map<String, dynamic> json) {
    return WebhooksAlertDismisser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksAlertDismisserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksAlertDismisser copyWith({
    ...
    WebhooksAlertDismisserType Function()? type,
    Uri Function()? url,
  }) {
    return WebhooksAlertDismisser(
  ...
  @override
  String toString() {
    return 'WebhooksAlertDismisser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
