...
import 'import_project_choices.dart';
...
final class Import {
  ...
  factory Import.fromJson(Map<String, dynamic> json) {
    return Import(
      ...
      importPercent: json['import_percent'] != null
          ? (json['import_percent'] as num).toInt()
          : null,
      commitCount: json['commit_count'] != null
          ? (json['commit_count'] as num).toInt()
          : null,
      pushPercent: json['push_percent'] != null
          ? (json['push_percent'] as num).toInt()
          : null,
      hasLargeFiles: json['has_large_files'] as bool?,
      largeFilesSize: json['large_files_size'] != null
          ? (json['large_files_size'] as num).toInt()
          : null,
      largeFilesCount: json['large_files_count'] != null
          ? (json['large_files_count'] as num).toInt()
          : null,
      projectChoices: (json['project_choices'] as List<dynamic>?)
          ?.map((e) => ImportProjectChoices.fromJson(e as Map<String, dynamic>))
          .toList(),
      message: json['message'] as String?,
      authorsCount: json['authors_count'] != null
          ? (json['authors_count'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('vcs') &&
        json['vcs'] is String &&
        json.containsKey('vcs_url') &&
        json['vcs_url'] is String &&
        json.containsKey('status') &&
        json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('html_url') &&
        json['html_url'] is String &&
        json.containsKey('authors_url') &&
        json['authors_url'] is String &&
  ...
  Import copyWith({
    String? Function()? vcs,
    bool Function()? useLfs,
    String? vcsUrl,
    String Function()? svcRoot,
    String Function()? tfvcProject,
    ImportStatus? status,
    String? Function()? statusText,
    String? Function()? failedStep,
    String? Function()? errorMessage,
    int? Function()? importPercent,
    int? Function()? commitCount,
    int? Function()? pushPercent,
    bool Function()? hasLargeFiles,
    int Function()? largeFilesSize,
    int Function()? largeFilesCount,
    List<ImportProjectChoices> Function()? projectChoices,
    String Function()? message,
    int? Function()? authorsCount,
    Uri? url,
    Uri? htmlUrl,
    Uri? authorsUrl,
    Uri? repositoryUrl,
    String Function()? svnRoot,
  }) {
    return Import(
      ...
      importPercent: importPercent != null
          ? importPercent()
          : this.importPercent,
      commitCount: commitCount != null ? commitCount() : this.commitCount,
      pushPercent: pushPercent != null ? pushPercent() : this.pushPercent,
      hasLargeFiles: hasLargeFiles != null
          ? hasLargeFiles()
          : this.hasLargeFiles,
      largeFilesSize: largeFilesSize != null
          ? largeFilesSize()
          : this.largeFilesSize,
      largeFilesCount: largeFilesCount != null
          ? largeFilesCount()
          : this.largeFilesCount,
      projectChoices: projectChoices != null
          ? projectChoices()
          : this.projectChoices,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      largeFilesSize,
      largeFilesCount,
      Object.hashAll(projectChoices ?? const []),
      message,
      authorsCount,
      url,
      htmlUrl,
