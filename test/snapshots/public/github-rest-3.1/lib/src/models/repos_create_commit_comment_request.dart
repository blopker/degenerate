...
final class ReposCreateCommitCommentRequest {
  ...
  ReposCreateCommitCommentRequest copyWith({
    String? body,
  ...
  @override
  int get hashCode {
    return Object.hash(body, path, position, line);
  }

  @override
  String toString() {
    return 'ReposCreateCommitCommentRequest(body: $body, path: $path, position: $position, line: $line)';
  }
}
