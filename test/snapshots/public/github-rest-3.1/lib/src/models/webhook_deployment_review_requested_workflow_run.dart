...
import 'package:collection/collection.dart';import 'webhook_deployment_review_requested_workflow_run_actor.dart';import 'webhook_deployment_review_requested_workflow_run_conclusion.dart';import 'webhook_deployment_review_requested_workflow_run_head_repository.dart';import 'webhook_deployment_review_requested_workflow_run_pull_requests.dart';import 'webhook_deployment_review_requested_workflow_run_referenced_workflows.dart';import 'webhook_deployment_review_requested_workflow_run_repository.dart';import 'webhook_deployment_review_requested_workflow_run_status.dart';import 'webhook_deployment_review_requested_workflow_run_triggering_actor.dart';final class WebhookDeploymentReviewRequestedWorkflowRun {const WebhookDeploymentReviewRequestedWorkflowRun({required this.actor, this.artifactsUrl, this.cancelUrl, required this.checkSuiteId, required this.checkSuiteNodeId, this.checkSuiteUrl, required this.conclusion, required this.createdAt, required this.event, required this.headBranch, this.headCommit, this.headRepository, required this.headSha, required this.htmlUrl, required this.id, this.jobsUrl, this.logsUrl, required this.name, required this.nodeId, required this.path, this.previousAttemptUrl, required this.pullRequests, this.referencedWorkflows, this.repository, this.rerunUrl, required this.runAttempt, required this.runNumber, required this.runStartedAt, required this.status, required this.triggeringActor, required this.updatedAt, required this.url, required this.workflowId, this.workflowUrl, required this.displayTitle, });
