...
import 'webhook_deployment_review_requested_workflow_run_actor.dart';
import 'webhook_deployment_review_requested_workflow_run_conclusion.dart';
import 'webhook_deployment_review_requested_workflow_run_head_repository.dart';
import 'webhook_deployment_review_requested_workflow_run_pull_requests.dart';
import 'webhook_deployment_review_requested_workflow_run_referenced_workflows.dart';
import 'webhook_deployment_review_requested_workflow_run_repository.dart';
import 'webhook_deployment_review_requested_workflow_run_status.dart';
import 'webhook_deployment_review_requested_workflow_run_triggering_actor.dart';

final class WebhookDeploymentReviewRequestedWorkflowRun {
  const WebhookDeploymentReviewRequestedWorkflowRun({
    required this.actor,
    this.artifactsUrl,
    this.cancelUrl,
  ...
  factory WebhookDeploymentReviewRequestedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRequestedWorkflowRun(
      actor: WebhookDeploymentReviewRequestedWorkflowRunActor.fromJson(
      ...
      conclusion:
          WebhookDeploymentReviewRequestedWorkflowRunConclusion.fromJson(
            json['conclusion'] as String,
          ),
      createdAt: DateTime.parse(json['created_at'] as String),
      event: json['event'] as String,
      headBranch: json['head_branch'] as String,
      headCommit: (json['head_commit'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, v as String),
      ),
      headRepository: json['head_repository'] != null
          ? WebhookDeploymentReviewRequestedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) =>
                WebhookDeploymentReviewRequestedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookDeploymentReviewRequestedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: json['repository'] != null
          ? WebhookDeploymentReviewRequestedWorkflowRunRepository.fromJson(
      ...
      status: WebhookDeploymentReviewRequestedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor.fromJson(
  ...
  final WebhookDeploymentReviewRequestedWorkflowRunHeadRepository?
  headRepository;
  ...
  final List<WebhookDeploymentReviewRequestedWorkflowRunPullRequests>
  pullRequests;

  final List<WebhookDeploymentReviewRequestedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  final WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor?
  triggeringActor;
  ...
  WebhookDeploymentReviewRequestedWorkflowRun copyWith({
    WebhookDeploymentReviewRequestedWorkflowRunActor? Function()? actor,
    String Function()? artifactsUrl,
    String Function()? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    String Function()? checkSuiteUrl,
    WebhookDeploymentReviewRequestedWorkflowRunConclusion? Function()?
    conclusion,
    DateTime? createdAt,
    String? event,
    String? headBranch,
    Map<String, String>? Function()? headCommit,
    WebhookDeploymentReviewRequestedWorkflowRunHeadRepository Function()?
    headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    String Function()? jobsUrl,
    String Function()? logsUrl,
    String? name,
    String? nodeId,
    String? path,
    String? Function()? previousAttemptUrl,
    List<WebhookDeploymentReviewRequestedWorkflowRunPullRequests>? pullRequests,
    List<WebhookDeploymentReviewRequestedWorkflowRunReferencedWorkflows>?
    Function()?
    referencedWorkflows,
    WebhookDeploymentReviewRequestedWorkflowRunRepository Function()?
    repository,
    String Function()? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookDeploymentReviewRequestedWorkflowRunStatus? status,
    WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
    String Function()? workflowUrl,
    String? displayTitle,
  }) {
    return WebhookDeploymentReviewRequestedWorkflowRun(
      ...
      checkSuiteUrl: checkSuiteUrl != null
          ? checkSuiteUrl()
          : this.checkSuiteUrl,
