...
import 'simple_commit_author.dart';
import 'simple_commit_committer.dart';
...
final class SimpleCommit {
  ...
  factory SimpleCommit.fromJson(Map<String, dynamic> json) {
    return SimpleCommit(
      ...
      author: SimpleCommitAuthor.fromJson(
        json['author'] as Map<String, dynamic>,
      ),
      committer: SimpleCommitCommitter.fromJson(
  ...
  SimpleCommit copyWith({
    String? id,
    String? treeId,
    String? message,
    DateTime? timestamp,
    SimpleCommitAuthor? Function()? author,
    SimpleCommitCommitter? Function()? committer,
  }) {
    return SimpleCommit(
      id: id ?? this.id,
  ...
  @override
  int get hashCode {
    return Object.hash(id, treeId, message, timestamp, author, committer);
  }
