...
import 'code_scanning_autofix_status.dart';

final class CodeScanningAutofix {
  ...
  CodeScanningAutofix copyWith({
    CodeScanningAutofixStatus? status,
  ...
  @override
  int get hashCode {
    return Object.hash(status, description, startedAt);
  }

  @override
  String toString() {
    return 'CodeScanningAutofix(status: $status, description: $description, startedAt: $startedAt)';
  }
}
