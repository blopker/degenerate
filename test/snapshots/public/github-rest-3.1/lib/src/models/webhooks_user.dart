...
import 'webhooks_user_type.dart';
...
final class WebhooksUser {
  ...
  factory WebhooksUser.fromJson(Map<String, dynamic> json) {
    return WebhooksUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksUser copyWith({
    ...
    WebhooksUserType Function()? type,
    Uri Function()? url,
