...
import 'dependency_graph_diff2_change_type.dart';
import 'dependency_graph_diff2_scope.dart';
import 'dependency_graph_diff2_vulnerabilities.dart';

final class DependencyGraphDiff2 {
  const DependencyGraphDiff2({
  ...
  factory DependencyGraphDiff2.fromJson(Map<String, dynamic> json) {
    return DependencyGraphDiff2(
      changeType: DependencyGraphDiff2ChangeType.fromJson(
      ...
      vulnerabilities: (json['vulnerabilities'] as List<dynamic>)
          .map(
            (e) => DependencyGraphDiff2Vulnerabilities.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('change_type') &&
        json.containsKey('manifest') &&
        json['manifest'] is String &&
        ...
        json['license'] is String &&
        json.containsKey('source_repository_url') &&
        json['source_repository_url'] is String &&
        json.containsKey('vulnerabilities') &&
        json.containsKey('scope');
  }

  DependencyGraphDiff2 copyWith({
    DependencyGraphDiff2ChangeType? changeType,
    String? manifest,
    String? ecosystem,
    String? name,
    String? version,
    ...
    String? Function()? sourceRepositoryUrl,
    List<DependencyGraphDiff2Vulnerabilities>? vulnerabilities,
    DependencyGraphDiff2Scope? scope,
  }) {
    return DependencyGraphDiff2(
      ...
      sourceRepositoryUrl: sourceRepositoryUrl != null
          ? sourceRepositoryUrl()
  ...
  @override
  String toString() {
    return 'DependencyGraphDiff2(changeType: $changeType, manifest: $manifest, ecosystem: $ecosystem, name: $name, version: $version, packageUrl: $packageUrl, license: $license, sourceRepositoryUrl: $sourceRepositoryUrl, vulnerabilities: $vulnerabilities, scope: $scope)';
  }
}
