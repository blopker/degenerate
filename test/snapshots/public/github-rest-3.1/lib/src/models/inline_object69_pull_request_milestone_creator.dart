...
import 'inline_object69_pull_request_milestone_creator_type.dart';

final class InlineObject69PullRequestMilestoneCreator {
  const InlineObject69PullRequestMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestMilestoneCreator copyWith({
    ...
    InlineObject69PullRequestMilestoneCreatorType Function()? type,
    Uri Function()? url,
