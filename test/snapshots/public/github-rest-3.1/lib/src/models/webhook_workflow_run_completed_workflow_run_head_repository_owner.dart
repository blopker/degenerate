...
import 'webhook_workflow_run_completed_workflow_run_head_repository_owner_type.dart';

final class WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner {
  const WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner copyWith({
    ...
    WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwnerType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
