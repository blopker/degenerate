...
import 'security_and_analysis_advanced_security.dart';
import 'security_and_analysis_code_security.dart';
import 'security_and_analysis_dependabot_security_updates.dart';
import 'security_and_analysis_secret_scanning.dart';
import 'security_and_analysis_secret_scanning_ai_detection.dart';
import 'security_and_analysis_secret_scanning_delegated_alert_dismissal.dart';
import 'security_and_analysis_secret_scanning_delegated_bypass.dart';
import 'security_and_analysis_secret_scanning_delegated_bypass_options.dart';
import 'security_and_analysis_secret_scanning_non_provider_patterns.dart';
import 'security_and_analysis_secret_scanning_push_protection.dart';
...
final class SecurityAndAnalysis {
  ...
  factory SecurityAndAnalysis.fromJson(Map<String, dynamic> json) {
    return SecurityAndAnalysis(
      ...
      secretScanningDelegatedAlertDismissal:
          ...
          ? SecurityAndAnalysisSecretScanningDelegatedAlertDismissal.fromJson(
      ...
      secretScanningDelegatedBypass:
          ...
          ? SecurityAndAnalysisSecretScanningDelegatedBypass.fromJson(
      ...
      secretScanningDelegatedBypassOptions:
          ...
          ? SecurityAndAnalysisSecretScanningDelegatedBypassOptions.fromJson(
  ...
  final SecurityAndAnalysisSecretScanningDelegatedAlertDismissal?
  secretScanningDelegatedAlertDismissal;

  final SecurityAndAnalysisSecretScanningDelegatedBypass?
  secretScanningDelegatedBypass;

  final SecurityAndAnalysisSecretScanningDelegatedBypassOptions?
  secretScanningDelegatedBypassOptions;
  ...
  SecurityAndAnalysis copyWith({
    SecurityAndAnalysisAdvancedSecurity Function()? advancedSecurity,
    SecurityAndAnalysisCodeSecurity Function()? codeSecurity,
    SecurityAndAnalysisDependabotSecurityUpdates Function()?
    dependabotSecurityUpdates,
    SecurityAndAnalysisSecretScanning Function()? secretScanning,
    SecurityAndAnalysisSecretScanningPushProtection Function()?
    secretScanningPushProtection,
    SecurityAndAnalysisSecretScanningNonProviderPatterns Function()?
    secretScanningNonProviderPatterns,
    SecurityAndAnalysisSecretScanningAiDetection Function()?
    secretScanningAiDetection,
    SecurityAndAnalysisSecretScanningDelegatedAlertDismissal Function()?
    secretScanningDelegatedAlertDismissal,
    SecurityAndAnalysisSecretScanningDelegatedBypass Function()?
    secretScanningDelegatedBypass,
    SecurityAndAnalysisSecretScanningDelegatedBypassOptions Function()?
    secretScanningDelegatedBypassOptions,
  }) {
    return SecurityAndAnalysis(
      ...
      secretScanningNonProviderPatterns:
          ...
          ? secretScanningNonProviderPatterns()
          : this.secretScanningNonProviderPatterns,
      secretScanningAiDetection: secretScanningAiDetection != null
          ? secretScanningAiDetection()
          : this.secretScanningAiDetection,
      secretScanningDelegatedAlertDismissal:
  ...
  @override
  String toString() {
    return 'SecurityAndAnalysis(advancedSecurity: $advancedSecurity, codeSecurity: $codeSecurity, dependabotSecurityUpdates: $dependabotSecurityUpdates, secretScanning: $secretScanning, secretScanningPushProtection: $secretScanningPushProtection, secretScanningNonProviderPatterns: $secretScanningNonProviderPatterns, secretScanningAiDetection: $secretScanningAiDetection, secretScanningDelegatedAlertDismissal: $secretScanningDelegatedAlertDismissal, secretScanningDelegatedBypass: $secretScanningDelegatedBypass, secretScanningDelegatedBypassOptions: $secretScanningDelegatedBypassOptions)';
  }
}
