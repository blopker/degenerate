...
final class PagesHealthCheckAltDomain {
  ...
  PagesHealthCheckAltDomain copyWith({
    String Function()? host,
    String Function()? uri,
    String Function()? nameservers,
    bool Function()? dnsResolves,
    bool? Function()? isProxied,
    bool? Function()? isCloudflareIp,
    bool? Function()? isFastlyIp,
    bool? Function()? isOldIpAddress,
    bool? Function()? isARecord,
    bool? Function()? hasCnameRecord,
    bool? Function()? hasMxRecordsPresent,
    bool Function()? isValidDomain,
    bool Function()? isApexDomain,
    bool? Function()? shouldBeARecord,
    bool? Function()? isCnameToGithubUserDomain,
    bool? Function()? isCnameToPagesDotGithubDotCom,
    bool? Function()? isCnameToFastly,
    bool? Function()? isPointedToGithubPagesIp,
    bool? Function()? isNonGithubPagesIpPresent,
    bool Function()? isPagesDomain,
    bool? Function()? isServedByPages,
    bool Function()? isValid,
    String? Function()? reason,
    bool Function()? respondsToHttps,
    bool Function()? enforcesHttps,
    String? Function()? httpsError,
    bool? Function()? isHttpsEligible,
    String? Function()? caaError,
  }) {
    return PagesHealthCheckAltDomain(
      ...
      isCloudflareIp: isCloudflareIp != null
          ? isCloudflareIp()
          : this.isCloudflareIp,
      isFastlyIp: isFastlyIp != null ? isFastlyIp() : this.isFastlyIp,
      isOldIpAddress: isOldIpAddress != null
          ? isOldIpAddress()
          : this.isOldIpAddress,
      isARecord: isARecord != null ? isARecord() : this.isARecord,
      hasCnameRecord: hasCnameRecord != null
          ? hasCnameRecord()
          : this.hasCnameRecord,
      hasMxRecordsPresent: hasMxRecordsPresent != null
          ? hasMxRecordsPresent()
          : this.hasMxRecordsPresent,
      isValidDomain: isValidDomain != null
          ? isValidDomain()
          : this.isValidDomain,
      isApexDomain: isApexDomain != null ? isApexDomain() : this.isApexDomain,
      shouldBeARecord: shouldBeARecord != null
          ? shouldBeARecord()
          : this.shouldBeARecord,
      isCnameToGithubUserDomain: isCnameToGithubUserDomain != null
          ? isCnameToGithubUserDomain()
          : this.isCnameToGithubUserDomain,
      isCnameToPagesDotGithubDotCom: isCnameToPagesDotGithubDotCom != null
          ? isCnameToPagesDotGithubDotCom()
          : this.isCnameToPagesDotGithubDotCom,
      isCnameToFastly: isCnameToFastly != null
          ? isCnameToFastly()
          : this.isCnameToFastly,
      isPointedToGithubPagesIp: isPointedToGithubPagesIp != null
          ? isPointedToGithubPagesIp()
          : this.isPointedToGithubPagesIp,
      isNonGithubPagesIpPresent: isNonGithubPagesIpPresent != null
          ? isNonGithubPagesIpPresent()
          : this.isNonGithubPagesIpPresent,
      isPagesDomain: isPagesDomain != null
          ? isPagesDomain()
          : this.isPagesDomain,
      isServedByPages: isServedByPages != null
          ? isServedByPages()
          : this.isServedByPages,
      isValid: isValid != null ? isValid() : this.isValid,
      reason: reason != null ? reason() : this.reason,
      respondsToHttps: respondsToHttps != null
          ? respondsToHttps()
          : this.respondsToHttps,
      enforcesHttps: enforcesHttps != null
          ? enforcesHttps()
          : this.enforcesHttps,
      httpsError: httpsError != null ? httpsError() : this.httpsError,
      isHttpsEligible: isHttpsEligible != null
          ? isHttpsEligible()
          : this.isHttpsEligible,
