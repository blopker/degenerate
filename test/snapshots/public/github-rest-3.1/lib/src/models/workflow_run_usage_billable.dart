...
import 'workflow_run_usage_billable_macos.dart';
import 'workflow_run_usage_billable_ubuntu.dart';
import 'workflow_run_usage_billable_windows.dart';

final class WorkflowRunUsageBillable {
  ...
  factory WorkflowRunUsageBillable.fromJson(Map<String, dynamic> json) {
    return WorkflowRunUsageBillable(
      ubuntu: json['UBUNTU'] != null
          ? WorkflowRunUsageBillableUbuntu.fromJson(
              json['UBUNTU'] as Map<String, dynamic>,
            )
          : null,
      macos: json['MACOS'] != null
          ? WorkflowRunUsageBillableMacos.fromJson(
              json['MACOS'] as Map<String, dynamic>,
            )
          : null,
      windows: json['WINDOWS'] != null
          ? WorkflowRunUsageBillableWindows.fromJson(
  ...
  WorkflowRunUsageBillable copyWith({
    WorkflowRunUsageBillableUbuntu Function()? ubuntu,
    WorkflowRunUsageBillableMacos Function()? macos,
    WorkflowRunUsageBillableWindows Function()? windows,
  }) {
    return WorkflowRunUsageBillable(
  ...
  @override
  int get hashCode {
    return Object.hash(ubuntu, macos, windows);
  }
