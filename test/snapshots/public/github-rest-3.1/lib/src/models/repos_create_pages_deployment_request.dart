...
final class ReposCreatePagesDeploymentRequest {
  ...
  factory ReposCreatePagesDeploymentRequest.fromJson(
    ...
    return ReposCreatePagesDeploymentRequest(
      artifactId: json['artifact_id'] != null
          ? (json['artifact_id'] as num).toDouble()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('pages_build_version') &&
        json['pages_build_version'] is String &&
        json.containsKey('oidc_token') &&
        json['oidc_token'] is String;
  }

  ReposCreatePagesDeploymentRequest copyWith({
    double Function()? artifactId,
  ...
  @override
  String toString() {
    return 'ReposCreatePagesDeploymentRequest(artifactId: $artifactId, artifactUrl: $artifactUrl, environment: $environment, pagesBuildVersion: $pagesBuildVersion, oidcToken: $oidcToken)';
  }
}
