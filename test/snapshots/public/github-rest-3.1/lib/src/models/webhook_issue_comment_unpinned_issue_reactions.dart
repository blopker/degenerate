...
final class WebhookIssueCommentUnpinnedIssueReactions {
  const WebhookIssueCommentUnpinnedIssueReactions({
    this.plus1,
    this.minus1,
    this.confused,
    this.eyes,
  ...
  factory WebhookIssueCommentUnpinnedIssueReactions.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentUnpinnedIssueReactions(
  ...
  WebhookIssueCommentUnpinnedIssueReactions copyWith({
    int Function()? plus1,
    int Function()? minus1,
  ...
  @override
  String toString() {
    return 'WebhookIssueCommentUnpinnedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
