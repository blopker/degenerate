...
import 'organization_full_plan.dart';
...
final class OrganizationFull {
  ...
  factory OrganizationFull.fromJson(Map<String, dynamic> json) {
    return OrganizationFull(
      ...
      totalPrivateRepos: json['total_private_repos'] != null
          ? (json['total_private_repos'] as num).toInt()
          : null,
      ownedPrivateRepos: json['owned_private_repos'] != null
          ? (json['owned_private_repos'] as num).toInt()
          : null,
      privateGists: json['private_gists'] != null
          ? (json['private_gists'] as num).toInt()
          : null,
      diskUsage: json['disk_usage'] != null
          ? (json['disk_usage'] as num).toInt()
          : null,
      collaborators: json['collaborators'] != null
          ? (json['collaborators'] as num).toInt()
          : null,
      ...
      secretScanningPushProtectionCustomLinkEnabled:
          json['secret_scanning_push_protection_custom_link_enabled'] as bool?,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('login') &&
        ...
        json['url'] is String &&
        json.containsKey('repos_url') &&
        json['repos_url'] is String &&
        ...
        json.containsKey('public_members_url') &&
        json['public_members_url'] is String &&
        json.containsKey('avatar_url') &&
        json['avatar_url'] is String &&
        json.containsKey('description') &&
        json['description'] is String &&
        json.containsKey('has_organization_projects') &&
        json['has_organization_projects'] is bool &&
        json.containsKey('has_repository_projects') &&
        json['has_repository_projects'] is bool &&
        json.containsKey('public_repos') &&
        json['public_repos'] is num &&
        json.containsKey('public_gists') &&
        json['public_gists'] is num &&
        json.containsKey('followers') &&
        json['followers'] is num &&
        json.containsKey('following') &&
        json['following'] is num &&
  ...
  OrganizationFull copyWith({
    ...
    String? Function()? twitterUsername,
    ...
    Uri? htmlUrl,
    String? type,
    int Function()? totalPrivateRepos,
    int Function()? ownedPrivateRepos,
    int? Function()? privateGists,
    int? Function()? diskUsage,
    int? Function()? collaborators,
    String? Function()? billingEmail,
    OrganizationFullPlan Function()? plan,
    String? Function()? defaultRepositoryPermission,
    String? Function()? defaultRepositoryBranch,
    bool? Function()? membersCanCreateRepositories,
    bool? Function()? twoFactorRequirementEnabled,
    String Function()? membersAllowedRepositoryCreationType,
    ...
    bool Function()? membersCanCreatePages,
    bool Function()? membersCanCreatePublicPages,
    bool Function()? membersCanCreatePrivatePages,
    bool Function()? membersCanDeleteRepositories,
    bool Function()? membersCanChangeRepoVisibility,
    bool Function()? membersCanInviteOutsideCollaborators,
    bool Function()? membersCanDeleteIssues,
    bool Function()? displayCommenterFullNameSettingEnabled,
    bool Function()? readersCanCreateDiscussions,
    bool Function()? membersCanCreateTeams,
    bool Function()? membersCanViewDependencyInsights,
    bool? Function()? membersCanForkPrivateRepositories,
    bool Function()? webCommitSignoffRequired,
    bool Function()? advancedSecurityEnabledForNewRepositories,
    bool Function()? dependabotAlertsEnabledForNewRepositories,
    bool Function()? dependabotSecurityUpdatesEnabledForNewRepositories,
    bool Function()? dependencyGraphEnabledForNewRepositories,
    bool Function()? secretScanningEnabledForNewRepositories,
    bool Function()? secretScanningPushProtectionEnabledForNewRepositories,
    bool Function()? secretScanningPushProtectionCustomLinkEnabled,
    String? Function()? secretScanningPushProtectionCustomLink,
    DateTime? createdAt,
    DateTime? updatedAt,
    DateTime? Function()? archivedAt,
    bool Function()? deployKeysEnabledForRepositories,
  }) {
    return OrganizationFull(
      ...
      hasOrganizationProjects:
          hasOrganizationProjects ?? this.hasOrganizationProjects,
      hasRepositoryProjects:
          hasRepositoryProjects ?? this.hasRepositoryProjects,
      ...
      type: type ?? this.type,
      totalPrivateRepos: totalPrivateRepos != null
          ? totalPrivateRepos()
          : this.totalPrivateRepos,
      ownedPrivateRepos: ownedPrivateRepos != null
          ? ownedPrivateRepos()
          : this.ownedPrivateRepos,
      ...
      defaultRepositoryBranch: defaultRepositoryBranch != null
          ...
          : this.defaultRepositoryBranch,
      membersCanCreateRepositories: membersCanCreateRepositories != null
          ? membersCanCreateRepositories()
          : this.membersCanCreateRepositories,
      twoFactorRequirementEnabled: twoFactorRequirementEnabled != null
          ? twoFactorRequirementEnabled()
          : this.twoFactorRequirementEnabled,
      membersAllowedRepositoryCreationType:
      ...
      membersCanCreateInternalRepositories:
          ...
          ? membersCanCreateInternalRepositories()
          : this.membersCanCreateInternalRepositories,
      membersCanCreatePages: membersCanCreatePages != null
          ? membersCanCreatePages()
          : this.membersCanCreatePages,
      membersCanCreatePublicPages: membersCanCreatePublicPages != null
          ? membersCanCreatePublicPages()
          : this.membersCanCreatePublicPages,
      membersCanCreatePrivatePages: membersCanCreatePrivatePages != null
          ? membersCanCreatePrivatePages()
          : this.membersCanCreatePrivatePages,
      membersCanDeleteRepositories: membersCanDeleteRepositories != null
          ? membersCanDeleteRepositories()
          : this.membersCanDeleteRepositories,
      membersCanChangeRepoVisibility: membersCanChangeRepoVisibility != null
          ? membersCanChangeRepoVisibility()
          : this.membersCanChangeRepoVisibility,
      membersCanInviteOutsideCollaborators:
          membersCanInviteOutsideCollaborators != null
          ? membersCanInviteOutsideCollaborators()
          : this.membersCanInviteOutsideCollaborators,
      membersCanDeleteIssues: membersCanDeleteIssues != null
          ? membersCanDeleteIssues()
          : this.membersCanDeleteIssues,
      displayCommenterFullNameSettingEnabled:
          displayCommenterFullNameSettingEnabled != null
          ? displayCommenterFullNameSettingEnabled()
          : this.displayCommenterFullNameSettingEnabled,
      readersCanCreateDiscussions: readersCanCreateDiscussions != null
          ? readersCanCreateDiscussions()
          : this.readersCanCreateDiscussions,
      membersCanCreateTeams: membersCanCreateTeams != null
          ? membersCanCreateTeams()
          : this.membersCanCreateTeams,
      membersCanViewDependencyInsights: membersCanViewDependencyInsights != null
          ? membersCanViewDependencyInsights()
          : this.membersCanViewDependencyInsights,
      membersCanForkPrivateRepositories:
      ...
      webCommitSignoffRequired: webCommitSignoffRequired != null
          ...
          : this.webCommitSignoffRequired,
      advancedSecurityEnabledForNewRepositories:
          advancedSecurityEnabledForNewRepositories != null
          ? advancedSecurityEnabledForNewRepositories()
          : this.advancedSecurityEnabledForNewRepositories,
      dependabotAlertsEnabledForNewRepositories:
          dependabotAlertsEnabledForNewRepositories != null
          ? dependabotAlertsEnabledForNewRepositories()
          : this.dependabotAlertsEnabledForNewRepositories,
      dependabotSecurityUpdatesEnabledForNewRepositories:
          dependabotSecurityUpdatesEnabledForNewRepositories != null
          ? dependabotSecurityUpdatesEnabledForNewRepositories()
          : this.dependabotSecurityUpdatesEnabledForNewRepositories,
      dependencyGraphEnabledForNewRepositories:
          dependencyGraphEnabledForNewRepositories != null
          ? dependencyGraphEnabledForNewRepositories()
          : this.dependencyGraphEnabledForNewRepositories,
      secretScanningEnabledForNewRepositories:
          secretScanningEnabledForNewRepositories != null
          ? secretScanningEnabledForNewRepositories()
          : this.secretScanningEnabledForNewRepositories,
      secretScanningPushProtectionEnabledForNewRepositories:
          secretScanningPushProtectionEnabledForNewRepositories != null
          ? secretScanningPushProtectionEnabledForNewRepositories()
          : this.secretScanningPushProtectionEnabledForNewRepositories,
      secretScanningPushProtectionCustomLinkEnabled:
          secretScanningPushProtectionCustomLinkEnabled != null
          ? secretScanningPushProtectionCustomLinkEnabled()
          : this.secretScanningPushProtectionCustomLinkEnabled,
      secretScanningPushProtectionCustomLink:
      ...
      deployKeysEnabledForRepositories: deployKeysEnabledForRepositories != null
          ? deployKeysEnabledForRepositories()
          : this.deployKeysEnabledForRepositories,
    );
  }
