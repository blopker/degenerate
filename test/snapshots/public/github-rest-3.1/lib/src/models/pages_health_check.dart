...
import 'pages_health_check_alt_domain.dart';
import 'pages_health_check_domain.dart';
...
final class PagesHealthCheck {
  ...
  factory PagesHealthCheck.fromJson(Map<String, dynamic> json) {
    return PagesHealthCheck(
      domain: json['domain'] != null
          ? PagesHealthCheckDomain.fromJson(
              json['domain'] as Map<String, dynamic>,
            )
          : null,
      altDomain: json['alt_domain'] != null
          ? PagesHealthCheckAltDomain.fromJson(
  ...
  PagesHealthCheck copyWith({
    PagesHealthCheckDomain Function()? domain,
    PagesHealthCheckAltDomain? Function()? altDomain,
  }) {
    return PagesHealthCheck(
  ...
  @override
  int get hashCode {
    return Object.hash(domain, altDomain);
  }

  @override
  String toString() {
    return 'PagesHealthCheck(domain: $domain, altDomain: $altDomain)';
  }
}
