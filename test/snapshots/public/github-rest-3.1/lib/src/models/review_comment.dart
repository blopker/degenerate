...
import 'review_comment_links.dart';
import 'review_comment_side.dart';
import 'review_comment_start_side.dart';
import 'review_comment_subject_type.dart';
...
final class ReviewComment {
  ...
  factory ReviewComment.fromJson(Map<String, dynamic> json) {
    return ReviewComment(
      ...
      side: json.containsKey('side')
          ? ReviewCommentSide.fromJson(json['side'] as String)
          : ReviewCommentSide.right,
      startSide: json.containsKey('start_side')
          ? ReviewCommentStartSide.fromJson(json['start_side'] as String)
      ...
      subjectType: json['subject_type'] != null
          ? ReviewCommentSubjectType.fromJson(json['subject_type'] as String)
          : null,
    );
  }
  ...
  ReviewComment copyWith({
    ...
    ReviewCommentSide Function()? side,
    ReviewCommentStartSide? Function()? startSide,
    int Function()? line,
    int Function()? originalLine,
    int? Function()? startLine,
    int? Function()? originalStartLine,
    ReviewCommentSubjectType Function()? subjectType,
  }) {
    return ReviewComment(
      url: url ?? this.url,
