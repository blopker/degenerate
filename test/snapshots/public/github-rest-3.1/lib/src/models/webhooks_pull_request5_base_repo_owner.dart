...
import 'webhooks_pull_request5_base_repo_owner_type.dart';

final class WebhooksPullRequest5BaseRepoOwner {
  const WebhooksPullRequest5BaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5BaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhooksPullRequest5BaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5BaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhooksPullRequest5BaseRepoOwner copyWith({
    ...
    WebhooksPullRequest5BaseRepoOwnerType Function()? type,
    Uri Function()? url,
