...
import 'actions_update_self_hosted_runner_group_for_org_request_visibility.dart';

final class ActionsUpdateSelfHostedRunnerGroupForOrgRequest {
  ...
  ActionsUpdateSelfHostedRunnerGroupForOrgRequest copyWith({
    String? name,
    ActionsUpdateSelfHostedRunnerGroupForOrgRequestVisibility Function()?
    visibility,
  ...
  @override
  String toString() {
    return 'ActionsUpdateSelfHostedRunnerGroupForOrgRequest(name: $name, visibility: $visibility, allowsPublicRepositories: $allowsPublicRepositories, restrictedToWorkflows: $restrictedToWorkflows, selectedWorkflows: $selectedWorkflows, networkConfigurationId: $networkConfigurationId)';
  }
}
