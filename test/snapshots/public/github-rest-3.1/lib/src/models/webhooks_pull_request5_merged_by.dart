...
import 'webhooks_pull_request5_merged_by_type.dart';

final class WebhooksPullRequest5MergedBy {
  const WebhooksPullRequest5MergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5MergedBy.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5MergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5MergedByType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksPullRequest5MergedBy copyWith({
    ...
    WebhooksPullRequest5MergedByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksPullRequest5MergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
