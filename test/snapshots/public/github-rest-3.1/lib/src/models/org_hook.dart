...
final class OrgHook {
  ...
  @override
  String toString() {
    return 'OrgHook(id: $id, url: $url, pingUrl: $pingUrl, deliveriesUrl: $deliveriesUrl, name: $name, events: $events, active: $active, config: $config, updatedAt: $updatedAt, createdAt: $createdAt, type: $type)';
  }
}
