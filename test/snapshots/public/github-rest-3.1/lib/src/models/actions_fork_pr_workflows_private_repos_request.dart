...
final class ActionsForkPrWorkflowsPrivateReposRequest {
  const ActionsForkPrWorkflowsPrivateReposRequest({
    required this.runWorkflowsFromForkPullRequests,
    this.sendWriteTokensToWorkflows,
    this.sendSecretsAndVariables,
    this.requireApprovalForForkPrWorkflows,
  });

  factory ActionsForkPrWorkflowsPrivateReposRequest.fromJson(
  ...
  ActionsForkPrWorkflowsPrivateReposRequest copyWith({
    bool? runWorkflowsFromForkPullRequests,
    bool Function()? sendWriteTokensToWorkflows,
    bool Function()? sendSecretsAndVariables,
    bool Function()? requireApprovalForForkPrWorkflows,
  }) {
    return ActionsForkPrWorkflowsPrivateReposRequest(
      runWorkflowsFromForkPullRequests:
          runWorkflowsFromForkPullRequests ??
          this.runWorkflowsFromForkPullRequests,
      sendWriteTokensToWorkflows: sendWriteTokensToWorkflows != null
          ? sendWriteTokensToWorkflows()
          : this.sendWriteTokensToWorkflows,
      sendSecretsAndVariables: sendSecretsAndVariables != null
          ? sendSecretsAndVariables()
          : this.sendSecretsAndVariables,
      requireApprovalForForkPrWorkflows:
          requireApprovalForForkPrWorkflows != null
          ? requireApprovalForForkPrWorkflows()
          : this.requireApprovalForForkPrWorkflows,
    );
  }
  ...
  @override
  String toString() {
    return 'ActionsForkPrWorkflowsPrivateReposRequest(runWorkflowsFromForkPullRequests: $runWorkflowsFromForkPullRequests, sendWriteTokensToWorkflows: $sendWriteTokensToWorkflows, sendSecretsAndVariables: $sendSecretsAndVariables, requireApprovalForForkPrWorkflows: $requireApprovalForForkPrWorkflows)';
  }
}
