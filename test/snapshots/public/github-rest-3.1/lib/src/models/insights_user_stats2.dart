...
final class InsightsUserStats2 {
  const InsightsUserStats2({
    this.actorType,
    this.actorName,
    this.actorId,
    this.integrationId,
  ...
  factory InsightsUserStats2.fromJson(Map<String, dynamic> json) {
    return InsightsUserStats2(
      ...
      integrationId: json['integration_id'] != null
          ? (json['integration_id'] as num).toInt()
          : null,
      oauthApplicationId: json['oauth_application_id'] != null
          ? (json['oauth_application_id'] as num).toInt()
          : null,
  ...
  InsightsUserStats2 copyWith({
    String Function()? actorType,
    String Function()? actorName,
    int Function()? actorId,
    int? Function()? integrationId,
    int? Function()? oauthApplicationId,
