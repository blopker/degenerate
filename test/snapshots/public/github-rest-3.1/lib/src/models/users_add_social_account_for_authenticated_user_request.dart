...
import 'package:collection/collection.dart';final class UsersAddSocialAccountForAuthenticatedUserRequest {const UsersAddSocialAccountForAuthenticatedUserRequest({required this.accountUrls});
