...
import 'repos_update_release_request_make_latest.dart';

final class ReposUpdateReleaseRequest {
  ...
  factory ReposUpdateReleaseRequest.fromJson(Map<String, dynamic> json) {
    return ReposUpdateReleaseRequest(
      ...
      makeLatest: json['make_latest'] != null
          ? ReposUpdateReleaseRequestMakeLatest.fromJson(
  ...
  ReposUpdateReleaseRequest copyWith({
    ...
    ReposUpdateReleaseRequestMakeLatest Function()? makeLatest,
  ...
  @override
  String toString() {
    return 'ReposUpdateReleaseRequest(tagName: $tagName, targetCommitish: $targetCommitish, name: $name, body: $body, draft: $draft, prerelease: $prerelease, makeLatest: $makeLatest, discussionCategoryName: $discussionCategoryName)';
  }
}
