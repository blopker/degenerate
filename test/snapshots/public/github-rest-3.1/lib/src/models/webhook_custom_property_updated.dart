...
import 'custom_property.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_custom_property_updated_action.dart';final class WebhookCustomPropertyUpdated {const WebhookCustomPropertyUpdated({required this.action, required this.definition, this.enterprise, this.installation, this.organization, this.sender, });
