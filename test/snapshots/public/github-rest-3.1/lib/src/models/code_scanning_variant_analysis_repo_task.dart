...
final class CodeScanningVariantAnalysisRepoTask {
  ...
  CodeScanningVariantAnalysisRepoTask copyWith({
    ...
    String Function()? databaseCommitSha,
    String Function()? sourceLocationPrefix,
    ...
    return CodeScanningVariantAnalysisRepoTask(
      ...
      failureMessage: failureMessage != null
          ? failureMessage()
          : this.failureMessage,
      databaseCommitSha: databaseCommitSha != null
          ? databaseCommitSha()
          : this.databaseCommitSha,
      sourceLocationPrefix: sourceLocationPrefix != null
  ...
  @override
  String toString() {
    return 'CodeScanningVariantAnalysisRepoTask(repository: $repository, analysisStatus: $analysisStatus, artifactSizeInBytes: $artifactSizeInBytes, resultCount: $resultCount, failureMessage: $failureMessage, databaseCommitSha: $databaseCommitSha, sourceLocationPrefix: $sourceLocationPrefix, artifactUrl: $artifactUrl)';
  }
}
