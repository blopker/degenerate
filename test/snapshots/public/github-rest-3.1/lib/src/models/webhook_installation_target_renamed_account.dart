...
final class WebhookInstallationTargetRenamedAccount {
  const WebhookInstallationTargetRenamedAccount({
    this.archivedAt,
  ...
  factory WebhookInstallationTargetRenamedAccount.fromJson(
    ...
    return WebhookInstallationTargetRenamedAccount(
      ...
      publicGists: json['public_gists'] != null
  ...
  WebhookInstallationTargetRenamedAccount copyWith({
    String? Function()? archivedAt,
    String? avatarUrl,
    String Function()? createdAt,
    String? Function()? description,
    String Function()? eventsUrl,
    int Function()? followers,
    String Function()? followersUrl,
    int Function()? following,
    ...
    int Function()? publicGists,
    String Function()? publicMembersUrl,
    int Function()? publicRepos,
