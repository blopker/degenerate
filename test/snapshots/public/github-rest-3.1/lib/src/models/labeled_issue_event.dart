...
import 'labeled_issue_event_label.dart';
import 'simple_user.dart';

/// Labeled Issue Event
final class LabeledIssueEvent {
  ...
  @override
  String toString() {
    return 'LabeledIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, label: $label)';
  }
}
