...
import 'webhooks_user_mannequin_type.dart';

final class WebhooksUserMannequin {
  const WebhooksUserMannequin({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksUserMannequin.fromJson(Map<String, dynamic> json) {
    return WebhooksUserMannequin(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksUserMannequinType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksUserMannequin copyWith({
    ...
    WebhooksUserMannequinType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksUserMannequin(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
