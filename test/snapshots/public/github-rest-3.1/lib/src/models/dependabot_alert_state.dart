...
final class DependabotAlertState {
  ...
  static const DependabotAlertState autoDismissed = DependabotAlertState._(
    'auto_dismissed',
  );

  static const DependabotAlertState dismissed = DependabotAlertState._(
    'dismissed',
  );
  ...
  static const List<DependabotAlertState> values = [
    autoDismissed,
    dismissed,
    fixed,
    open,
  ...
  @override
  String toString() {
    return 'DependabotAlertState($value)';
  }
}
