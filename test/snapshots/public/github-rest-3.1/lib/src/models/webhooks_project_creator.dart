...
import 'webhooks_project_creator_type.dart';

final class WebhooksProjectCreator {
  const WebhooksProjectCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksProjectCreator.fromJson(Map<String, dynamic> json) {
    return WebhooksProjectCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksProjectCreatorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksProjectCreator copyWith({
    ...
    WebhooksProjectCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksProjectCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
