...
import 'webhook_pull_request_unassigned_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestUnassignedPullRequestBaseRepoOwner {
  const WebhookPullRequestUnassignedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
