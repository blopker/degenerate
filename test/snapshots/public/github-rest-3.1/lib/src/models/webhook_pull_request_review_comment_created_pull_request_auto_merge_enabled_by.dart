...
import 'webhook_pull_request_review_comment_created_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestReviewCommentCreatedPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
