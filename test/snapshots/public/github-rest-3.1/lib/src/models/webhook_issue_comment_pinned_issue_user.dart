...
final class WebhookIssueCommentPinnedIssueUser {
  const WebhookIssueCommentPinnedIssueUser({
    this.avatarUrl,
    this.eventsUrl,
    this.followersUrl,
    this.followingUrl,
  ...
  factory WebhookIssueCommentPinnedIssueUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentPinnedIssueUser(
  ...
  WebhookIssueCommentPinnedIssueUser copyWith({
