...
final class CodeScanningAutofixCommitsResponse {
  ...
  Map<String, dynamic> toJson() {
    return {'target_ref': ?targetRef, 'sha': ?sha};
  }
  ...
  CodeScanningAutofixCommitsResponse copyWith({
    String Function()? targetRef,
    String Function()? sha,
  }) {
    return CodeScanningAutofixCommitsResponse(
  ...
  @override
  int get hashCode {
    return Object.hash(targetRef, sha);
  }

  @override
  String toString() {
    return 'CodeScanningAutofixCommitsResponse(targetRef: $targetRef, sha: $sha)';
  }
}
