...
import 'webhook_pull_request_synchronize_pull_request_milestone_creator_type.dart';

final class WebhookPullRequestSynchronizePullRequestMilestoneCreator {
  const WebhookPullRequestSynchronizePullRequestMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestSynchronizePullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestSynchronizePullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestSynchronizePullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestSynchronizePullRequestMilestoneCreator copyWith({
    ...
    WebhookPullRequestSynchronizePullRequestMilestoneCreatorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestSynchronizePullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
