...
import 'content_submodule_links.dart';
import 'content_submodule_type.dart';
...
final class ContentSubmodule {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        json.containsKey('submodule_git_url') &&
        json['submodule_git_url'] is String &&
  ...
  ContentSubmodule copyWith({
    ContentSubmoduleType? type,
    Uri? submoduleGitUrl,
    int? size,
    String? name,
    String? path,
