...
import 'webhook_deployment_review_approved_workflow_run_actor_type.dart';
...
final class WebhookDeploymentReviewApprovedWorkflowRunActor {
  ...
  factory WebhookDeploymentReviewApprovedWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewApprovedWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewApprovedWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewApprovedWorkflowRunActor copyWith({
    ...
    WebhookDeploymentReviewApprovedWorkflowRunActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentReviewApprovedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
