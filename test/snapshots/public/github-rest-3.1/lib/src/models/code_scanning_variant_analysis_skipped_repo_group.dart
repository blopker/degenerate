...
final class CodeScanningVariantAnalysisSkippedRepoGroup {
  ...
  CodeScanningVariantAnalysisSkippedRepoGroup copyWith({
    int? repositoryCount,
    List<CodeScanningVariantAnalysisRepository>? repositories,
  }) {
    return CodeScanningVariantAnalysisSkippedRepoGroup(
  ...
  @override
  int get hashCode {
    return Object.hash(repositoryCount, Object.hashAll(repositories));
  }

  @override
  String toString() {
    return 'CodeScanningVariantAnalysisSkippedRepoGroup(repositoryCount: $repositoryCount, repositories: $repositories)';
  }
}
