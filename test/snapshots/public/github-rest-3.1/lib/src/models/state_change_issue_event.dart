...
final class StateChangeIssueEvent {
  ...
  StateChangeIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
  ...
  @override
  String toString() {
    return 'StateChangeIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, stateReason: $stateReason)';
  }
}
