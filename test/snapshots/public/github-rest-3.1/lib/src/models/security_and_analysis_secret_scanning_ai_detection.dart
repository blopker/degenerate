...
import 'security_and_analysis_secret_scanning_ai_detection_status.dart';final class SecurityAndAnalysisSecretScanningAiDetection {const SecurityAndAnalysisSecretScanningAiDetection({this.status});
