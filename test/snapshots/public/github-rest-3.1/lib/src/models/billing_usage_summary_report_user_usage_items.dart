...
final class BillingUsageSummaryReportUserUsageItems {
  const BillingUsageSummaryReportUserUsageItems({
  ...
  factory BillingUsageSummaryReportUserUsageItems.fromJson(
    Map<String, dynamic> json,
  ) {
    return BillingUsageSummaryReportUserUsageItems(
  ...
  BillingUsageSummaryReportUserUsageItems copyWith({
    String? product,
    String? sku,
    String? unitType,
    double? pricePerUnit,
  ...
  @override
  String toString() {
    return 'BillingUsageSummaryReportUserUsageItems(product: $product, sku: $sku, unitType: $unitType, pricePerUnit: $pricePerUnit, grossQuantity: $grossQuantity, grossAmount: $grossAmount, discountQuantity: $discountQuantity, discountAmount: $discountAmount, netQuantity: $netQuantity, netAmount: $netAmount)';
  }
}
