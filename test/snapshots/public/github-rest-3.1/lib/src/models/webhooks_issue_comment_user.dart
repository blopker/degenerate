...
import 'webhooks_issue_comment_user_type.dart';

final class WebhooksIssueCommentUser {
  const WebhooksIssueCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssueCommentUser.fromJson(Map<String, dynamic> json) {
    return WebhooksIssueCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssueCommentUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssueCommentUser copyWith({
    ...
    WebhooksIssueCommentUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksIssueCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
