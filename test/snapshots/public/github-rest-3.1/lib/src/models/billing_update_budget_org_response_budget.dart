...
import 'billing_update_budget_org_response_budget_budget_alerting.dart';
import 'billing_update_budget_org_response_budget_budget_scope.dart';
import 'billing_update_budget_org_response_budget_budget_type.dart';

final class BillingUpdateBudgetOrgResponseBudget {
  const BillingUpdateBudgetOrgResponseBudget({
    this.id,
    this.budgetAmount,
  ...
  factory BillingUpdateBudgetOrgResponseBudget.fromJson(
    Map<String, dynamic> json,
  ) {
    return BillingUpdateBudgetOrgResponseBudget(
      ...
      budgetAlerting: json['budget_alerting'] != null
          ? BillingUpdateBudgetOrgResponseBudgetBudgetAlerting.fromJson(
              json['budget_alerting'] as Map<String, dynamic>,
            )
          : null,
      budgetScope: json['budget_scope'] != null
          ? BillingUpdateBudgetOrgResponseBudgetBudgetScope.fromJson(
              json['budget_scope'] as String,
            )
          : null,
      budgetEntityName: json.containsKey('budget_entity_name')
          ? json['budget_entity_name'] as String
          : '',
      budgetType: json['budget_type'] != null
          ? BillingUpdateBudgetOrgResponseBudgetBudgetType.fromJson(
  ...
  BillingUpdateBudgetOrgResponseBudget copyWith({
    String Function()? id,
    double Function()? budgetAmount,
    bool Function()? preventFurtherUsage,
    BillingUpdateBudgetOrgResponseBudgetBudgetAlerting Function()?
    budgetAlerting,
    BillingUpdateBudgetOrgResponseBudgetBudgetScope Function()? budgetScope,
    String Function()? budgetEntityName,
    BillingUpdateBudgetOrgResponseBudgetBudgetType Function()? budgetType,
  ...
  @override
  String toString() {
    return 'BillingUpdateBudgetOrgResponseBudget(id: $id, budgetAmount: $budgetAmount, preventFurtherUsage: $preventFurtherUsage, budgetAlerting: $budgetAlerting, budgetScope: $budgetScope, budgetEntityName: $budgetEntityName, budgetType: $budgetType, budgetProductSku: $budgetProductSku)';
  }
}
