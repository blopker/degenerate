...
import 'webhook_pull_request_review_edited_pull_request_assignee_type.dart';

final class WebhookPullRequestReviewEditedPullRequestAssignee {
  const WebhookPullRequestReviewEditedPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewEditedPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewEditedPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewEditedPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewEditedPullRequestAssignee copyWith({
    ...
    WebhookPullRequestReviewEditedPullRequestAssigneeType Function()? type,
    Uri Function()? url,
