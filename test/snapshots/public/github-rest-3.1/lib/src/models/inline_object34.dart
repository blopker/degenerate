...
import 'inline_object34_type.dart';
...
final class InlineObject34 {
  ...
  factory InlineObject34.fromJson(Map<String, dynamic> json) {
    return InlineObject34(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject34Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject34 copyWith({
    ...
    InlineObject34Type Function()? type,
    Uri Function()? url,
  }) {
    return InlineObject34(
  ...
  @override
  String toString() {
    return 'InlineObject34(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
