...
import 'webhooks_answer_user_type.dart';

final class WebhooksAnswerUser {
  const WebhooksAnswerUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksAnswerUser.fromJson(Map<String, dynamic> json) {
    return WebhooksAnswerUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksAnswerUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksAnswerUser copyWith({
    ...
    WebhooksAnswerUserType Function()? type,
    Uri Function()? url,
