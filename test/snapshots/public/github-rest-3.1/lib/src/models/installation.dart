...
import 'installation_account.dart';
import 'installation_repository_selection.dart';
...
final class Installation {
  ...
  factory Installation.fromJson(Map<String, dynamic> json) {
    return Installation(
      ...
      account: InstallationAccount.fromJson(
      ...
      suspendedBy: SimpleUser.fromJson(
        json['suspended_by'] as Map<String, dynamic>,
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('access_tokens_url') &&
        json['access_tokens_url'] is String &&
        json.containsKey('repositories_url') &&
        json['repositories_url'] is String &&
        json.containsKey('html_url') &&
        json['html_url'] is String &&
        json.containsKey('app_id') &&
        json['app_id'] is num &&
        json.containsKey('target_id') &&
        json['target_id'] is num &&
        json.containsKey('target_type') &&
        json['target_type'] is String &&
        ...
        json.containsKey('app_slug') &&
        json['app_slug'] is String &&
        json.containsKey('suspended_by') &&
        json.containsKey('suspended_at') &&
        json['suspended_at'] is String;
  }

  Installation copyWith({
    int? id,
    InstallationAccount? Function()? account,
    ...
    String? appSlug,
    SimpleUser? Function()? suspendedBy,
    DateTime? Function()? suspendedAt,
  ...
  @override
  String toString() {
    return 'Installation(id: $id, account: $account, repositorySelection: $repositorySelection, accessTokensUrl: $accessTokensUrl, repositoriesUrl: $repositoriesUrl, htmlUrl: $htmlUrl, appId: $appId, clientId: $clientId, targetId: $targetId, targetType: $targetType, permissions: $permissions, events: $events, createdAt: $createdAt, updatedAt: $updatedAt, singleFileName: $singleFileName, hasMultipleSingleFiles: $hasMultipleSingleFiles, singleFilePaths: $singleFilePaths, appSlug: $appSlug, suspendedBy: $suspendedBy, suspendedAt: $suspendedAt, contactEmail: $contactEmail)';
  }
}
