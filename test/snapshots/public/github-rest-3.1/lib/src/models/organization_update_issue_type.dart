...
import 'organization_update_issue_type_color.dart';final class OrganizationUpdateIssueType {const OrganizationUpdateIssueType({required this.name, required this.isEnabled, this.description, this.color, });
