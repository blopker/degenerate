...
final class MarketplacePurchaseMarketplacePendingChange {
  ...
  MarketplacePurchaseMarketplacePendingChange copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(isInstalled, effectiveDate, unitCount, id, plan);
  }
