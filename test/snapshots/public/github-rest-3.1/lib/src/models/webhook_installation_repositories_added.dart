...
import 'webhook_installation_repositories_added_action.dart';
import 'webhook_installation_repositories_added_repositories_removed.dart';
import 'webhooks_repositories_added2.dart';
import 'webhooks_repository_selection.dart';
import 'webhooks_user.dart';

final class WebhookInstallationRepositoriesAdded {
  const WebhookInstallationRepositoriesAdded({
  ...
  factory WebhookInstallationRepositoriesAdded.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookInstallationRepositoriesAdded(
      action: WebhookInstallationRepositoriesAddedAction.fromJson(
      ...
      repositoriesAdded: (json['repositories_added'] as List<dynamic>)
          .map(
            (e) =>
                WebhooksRepositoriesAdded2.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      repositoriesRemoved: (json['repositories_removed'] as List<dynamic>)
          .map(
            (e) =>
                WebhookInstallationRepositoriesAddedRepositoriesRemoved.fromJson(
      ...
      repository: json['repository'] != null
          ...
          : null,
      repositorySelection: WebhooksRepositorySelection.fromJson(
        json['repository_selection'] as String,
      ),
      requester: WebhooksUser.fromJson(
  ...
  final List<WebhookInstallationRepositoriesAddedRepositoriesRemoved>
  repositoriesRemoved;
  ...
  WebhookInstallationRepositoriesAdded copyWith({
    WebhookInstallationRepositoriesAddedAction? action,
    EnterpriseWebhooks Function()? enterprise,
    Installation? installation,
    OrganizationSimpleWebhooks Function()? organization,
    List<WebhooksRepositoriesAdded2>? repositoriesAdded,
    List<WebhookInstallationRepositoriesAddedRepositoriesRemoved>?
    repositoriesRemoved,
    ...
    return identical(this, other) ||
        other is WebhookInstallationRepositoriesAdded &&
            ...
            const ListEquality<dynamic>().equals(
              repositoriesAdded,
              other.repositoriesAdded,
            ) &&
            const ListEquality<dynamic>().equals(
              repositoriesRemoved,
              other.repositoriesRemoved,
            ) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      installation,
      organization,
      Object.hashAll(repositoriesAdded),
      Object.hashAll(repositoriesRemoved),
      repository,
      repositorySelection,
      requester,
      sender,
