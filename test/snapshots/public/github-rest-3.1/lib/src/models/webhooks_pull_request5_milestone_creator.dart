...
import 'webhooks_pull_request5_milestone_creator_type.dart';

final class WebhooksPullRequest5MilestoneCreator {
  const WebhooksPullRequest5MilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5MilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhooksPullRequest5MilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5MilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhooksPullRequest5MilestoneCreator copyWith({
    ...
    WebhooksPullRequest5MilestoneCreatorType Function()? type,
    Uri Function()? url,
