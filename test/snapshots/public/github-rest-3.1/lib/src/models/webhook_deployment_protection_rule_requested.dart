...
import 'webhook_deployment_protection_rule_requested_action.dart';

final class WebhookDeploymentProtectionRuleRequested {
  const WebhookDeploymentProtectionRuleRequested({
    this.action,
    this.environment,
    this.event,
    this.sha,
    this.ref,
    this.deploymentCallbackUrl,
    this.deployment,
    this.pullRequests,
    this.repository,
    this.organization,
  ...
  factory WebhookDeploymentProtectionRuleRequested.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentProtectionRuleRequested(
      action: json['action'] != null
          ? WebhookDeploymentProtectionRuleRequestedAction.fromJson(
      ...
      deploymentCallbackUrl: json['deployment_callback_url'] != null
          ? Uri.parse(json['deployment_callback_url'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (deploymentCallbackUrl != null)
        'deployment_callback_url': deploymentCallbackUrl?.toString(),
  ...
  WebhookDeploymentProtectionRuleRequested copyWith({
    WebhookDeploymentProtectionRuleRequestedAction Function()? action,
    String Function()? environment,
    String Function()? event,
    String Function()? sha,
    String Function()? ref,
    Uri Function()? deploymentCallbackUrl,
    Deployment? Function()? deployment,
    List<PullRequest> Function()? pullRequests,
    ...
    return WebhookDeploymentProtectionRuleRequested(
      ...
      deploymentCallbackUrl: deploymentCallbackUrl != null
  ...
  @override
  String toString() {
    return 'WebhookDeploymentProtectionRuleRequested(action: $action, environment: $environment, event: $event, sha: $sha, ref: $ref, deploymentCallbackUrl: $deploymentCallbackUrl, deployment: $deployment, pullRequests: $pullRequests, repository: $repository, organization: $organization, installation: $installation, sender: $sender)';
  }
}
