...
import 'secret_scanning_push_protection_bypass_reason.dart';

final class SecretScanningPushProtectionBypass {
  ...
  factory SecretScanningPushProtectionBypass.fromJson(
    ...
    return SecretScanningPushProtectionBypass(
      reason: json['reason'] != null
          ? SecretScanningPushProtectionBypassReason.fromJson(
  ...
  SecretScanningPushProtectionBypass copyWith({
    SecretScanningPushProtectionBypassReason Function()? reason,
    DateTime? Function()? expireAt,
  ...
  @override
  int get hashCode {
    return Object.hash(reason, expireAt, tokenType);
  }

  @override
  String toString() {
    return 'SecretScanningPushProtectionBypass(reason: $reason, expireAt: $expireAt, tokenType: $tokenType)';
  }
}
