...
import 'webhook_issues_edited_issue_performed_via_github_app_owner_type.dart';

final class WebhookIssuesEditedIssuePerformedViaGithubAppOwner {
  const WebhookIssuesEditedIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesEditedIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesEditedIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesEditedIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType Function()? type,
    Uri Function()? url,
