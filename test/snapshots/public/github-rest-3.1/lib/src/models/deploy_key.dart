...
final class DeployKey {
  ...
  @override
  String toString() {
    return 'DeployKey(id: $id, key: $key, url: $url, title: $title, verified: $verified, createdAt: $createdAt, readOnly: $readOnly, addedBy: $addedBy, lastUsed: $lastUsed, enabled: $enabled)';
  }
}
