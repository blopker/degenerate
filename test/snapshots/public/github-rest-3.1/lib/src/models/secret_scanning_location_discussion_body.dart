...
final class SecretScanningLocationDiscussionBody {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('discussion_body_url') &&
        json['discussion_body_url'] is String;
  }

  SecretScanningLocationDiscussionBody copyWith({Uri? discussionBodyUrl}) {
    return SecretScanningLocationDiscussionBody(
  ...
  @override
  int get hashCode {
    return discussionBodyUrl.hashCode;
  }

  @override
  String toString() {
    return 'SecretScanningLocationDiscussionBody(discussionBodyUrl: $discussionBodyUrl)';
  }
}
