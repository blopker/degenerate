...
final class WebhookIssuesClosedIssueReactions {
  const WebhookIssuesClosedIssueReactions({
    this.plus1,
    this.minus1,
    this.confused,
    this.eyes,
  ...
  factory WebhookIssuesClosedIssueReactions.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesClosedIssueReactions(
  ...
  WebhookIssuesClosedIssueReactions copyWith({
    int Function()? plus1,
    int Function()? minus1,
  ...
  @override
  String toString() {
    return 'WebhookIssuesClosedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
