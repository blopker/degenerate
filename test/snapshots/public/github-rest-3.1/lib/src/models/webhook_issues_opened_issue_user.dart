...
import 'webhook_issues_opened_issue_user_type.dart';

final class WebhookIssuesOpenedIssueUser {
  const WebhookIssuesOpenedIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesOpenedIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedIssueUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookIssuesOpenedIssueUser copyWith({
    ...
    WebhookIssuesOpenedIssueUserType Function()? type,
    Uri Function()? url,
