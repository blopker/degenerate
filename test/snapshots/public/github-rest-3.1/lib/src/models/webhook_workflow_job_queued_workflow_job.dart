...
import 'webhook_workflow_job_queued_workflow_job_status.dart';
import 'webhook_workflow_job_queued_workflow_job_steps.dart';

final class WebhookWorkflowJobQueuedWorkflowJob {
  const WebhookWorkflowJobQueuedWorkflowJob({
  ...
  factory WebhookWorkflowJobQueuedWorkflowJob.fromJson(
    ...
    return WebhookWorkflowJobQueuedWorkflowJob(
      ...
      status: WebhookWorkflowJobQueuedWorkflowJobStatus.fromJson(
      ...
      steps: (json['steps'] as List<dynamic>)
          .map(
            (e) => WebhookWorkflowJobQueuedWorkflowJobSteps.fromJson(
  ...
  WebhookWorkflowJobQueuedWorkflowJob copyWith({
    ...
    DateTime? startedAt,
    WebhookWorkflowJobQueuedWorkflowJobStatus? status,
    String? Function()? headBranch,
    String? Function()? workflowName,
    List<WebhookWorkflowJobQueuedWorkflowJobSteps>? steps,
    Uri? url,
  }) {
    return WebhookWorkflowJobQueuedWorkflowJob(
  ...
  @override
  String toString() {
    return 'WebhookWorkflowJobQueuedWorkflowJob(checkRunUrl: $checkRunUrl, completedAt: $completedAt, conclusion: $conclusion, createdAt: $createdAt, headSha: $headSha, htmlUrl: $htmlUrl, id: $id, labels: $labels, name: $name, nodeId: $nodeId, runAttempt: $runAttempt, runId: $runId, runUrl: $runUrl, runnerGroupId: $runnerGroupId, runnerGroupName: $runnerGroupName, runnerId: $runnerId, runnerName: $runnerName, startedAt: $startedAt, status: $status, headBranch: $headBranch, workflowName: $workflowName, steps: $steps, url: $url)';
  }
}
