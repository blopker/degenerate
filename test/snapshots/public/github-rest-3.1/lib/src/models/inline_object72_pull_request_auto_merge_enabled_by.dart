...
import 'inline_object72_pull_request_auto_merge_enabled_by_type.dart';

final class InlineObject72PullRequestAutoMergeEnabledBy {
  const InlineObject72PullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestAutoMergeEnabledBy copyWith({
    ...
    InlineObject72PullRequestAutoMergeEnabledByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject72PullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
