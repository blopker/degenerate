...
import 'webhooks_release_assets_uploader_type.dart';

final class WebhooksReleaseAssetsUploader {
  const WebhooksReleaseAssetsUploader({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksReleaseAssetsUploader.fromJson(Map<String, dynamic> json) {
    return WebhooksReleaseAssetsUploader(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksReleaseAssetsUploaderType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksReleaseAssetsUploader copyWith({
    ...
    WebhooksReleaseAssetsUploaderType Function()? type,
    Uri Function()? url,
  }) {
    return WebhooksReleaseAssetsUploader(
