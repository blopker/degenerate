...
final class WebhookForkForkeeOwner {
  const WebhookForkForkeeOwner({
    this.avatarUrl,
    this.eventsUrl,
    this.followersUrl,
    this.followingUrl,
  ...
  factory WebhookForkForkeeOwner.fromJson(Map<String, dynamic> json) {
    return WebhookForkForkeeOwner(
  ...
  WebhookForkForkeeOwner copyWith({
