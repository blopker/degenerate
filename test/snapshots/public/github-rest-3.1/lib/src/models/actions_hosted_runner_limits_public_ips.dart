...
final class ActionsHostedRunnerLimitsPublicIps {
  ...
  factory ActionsHostedRunnerLimitsPublicIps.fromJson(
    ...
    return ActionsHostedRunnerLimitsPublicIps(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('maximum') &&
        json['maximum'] is num &&
        json.containsKey('current_usage') &&
        json['current_usage'] is num;
  }

  ActionsHostedRunnerLimitsPublicIps copyWith({
    int? maximum,
    int? currentUsage,
  }) {
    return ActionsHostedRunnerLimitsPublicIps(
  ...
  @override
  int get hashCode {
    return Object.hash(maximum, currentUsage);
  }

  @override
  String toString() {
    return 'ActionsHostedRunnerLimitsPublicIps(maximum: $maximum, currentUsage: $currentUsage)';
  }
}
