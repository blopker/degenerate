...
final class CodeScanningAutofixCommits {
  ...
  CodeScanningAutofixCommits copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(targetRef, message);
  }

  @override
  String toString() {
    return 'CodeScanningAutofixCommits(targetRef: $targetRef, message: $message)';
  }
}
