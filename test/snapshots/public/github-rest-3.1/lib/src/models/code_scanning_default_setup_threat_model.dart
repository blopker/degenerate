...
final class CodeScanningDefaultSetupThreatModel {
  ...
  static const CodeScanningDefaultSetupThreatModel remote =
      CodeScanningDefaultSetupThreatModel._('remote');

  static const CodeScanningDefaultSetupThreatModel remoteAndLocal =
      CodeScanningDefaultSetupThreatModel._('remote_and_local');

  static const List<CodeScanningDefaultSetupThreatModel> values = [
    remote,
    remoteAndLocal,
  ];
  ...
  @override
  String toString() {
    return 'CodeScanningDefaultSetupThreatModel($value)';
  }
}
