...
import 'webhook_pull_request_assigned_pull_request_head_repo_owner_type.dart';

final class WebhookPullRequestAssignedPullRequestHeadRepoOwner {
  const WebhookPullRequestAssignedPullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAssignedPullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAssignedPullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAssignedPullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAssignedPullRequestHeadRepoOwner copyWith({
    ...
    WebhookPullRequestAssignedPullRequestHeadRepoOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAssignedPullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
