...
import 'webhook_pull_request_review_submitted_pull_request_assignees_type.dart';

final class WebhookPullRequestReviewSubmittedPullRequestAssignees {
  const WebhookPullRequestReviewSubmittedPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewSubmittedPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewSubmittedPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewSubmittedPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewSubmittedPullRequestAssignees copyWith({
    ...
    WebhookPullRequestReviewSubmittedPullRequestAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestReviewSubmittedPullRequestAssignees(
