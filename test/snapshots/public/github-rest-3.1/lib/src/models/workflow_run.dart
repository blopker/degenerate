...
final class WorkflowRun {
  ...
  factory WorkflowRun.fromJson(Map<String, dynamic> json) {
    return WorkflowRun(
      ...
      checkSuiteId: json['check_suite_id'] != null
          ? (json['check_suite_id'] as num).toInt()
          : null,
      ...
      runAttempt: json['run_attempt'] != null
      ...
      headRepositoryId: json['head_repository_id'] != null
          ? (json['head_repository_id'] as num).toInt()
          : null,
  ...
  WorkflowRun copyWith({
    ...
    String? nodeId,
    int Function()? checkSuiteId,
    String Function()? checkSuiteNodeId,
    String? Function()? headBranch,
    String? headSha,
    String? path,
    int? runNumber,
    int Function()? runAttempt,
    List<ReferencedWorkflow>? Function()? referencedWorkflows,
    String? event,
    ...
    String? url,
    String? htmlUrl,
    List<PullRequestMinimal>? Function()? pullRequests,
    DateTime? createdAt,
    DateTime? updatedAt,
    SimpleUser Function()? actor,
    SimpleUser Function()? triggeringActor,
    DateTime Function()? runStartedAt,
    String? jobsUrl,
    String? logsUrl,
    ...
    String? workflowUrl,
    SimpleCommit? Function()? headCommit,
    MinimalRepository? repository,
    MinimalRepository? headRepository,
    int Function()? headRepositoryId,
    String? displayTitle,
  }) {
    return WorkflowRun(
      id: id ?? this.id,
      ...
      checkSuiteNodeId: checkSuiteNodeId != null
          ? checkSuiteNodeId()
          : this.checkSuiteNodeId,
      ...
      headRepositoryId: headRepositoryId != null
          ? headRepositoryId()
          : this.headRepositoryId,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      url,
      htmlUrl,
      Object.hashAll(pullRequests ?? const []),
      createdAt,
      updatedAt,
      actor,
      triggeringActor,
