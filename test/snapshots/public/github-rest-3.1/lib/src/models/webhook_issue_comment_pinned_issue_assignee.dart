...
import 'webhook_issue_comment_pinned_issue_assignee_type.dart';

final class WebhookIssueCommentPinnedIssueAssignee {
  const WebhookIssueCommentPinnedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssueCommentPinnedIssueAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentPinnedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssueCommentPinnedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssueCommentPinnedIssueAssignee copyWith({
    ...
    WebhookIssueCommentPinnedIssueAssigneeType Function()? type,
    Uri Function()? url,
