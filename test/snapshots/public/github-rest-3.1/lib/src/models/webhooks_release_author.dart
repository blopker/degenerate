...
import 'webhooks_release_author_type.dart';

final class WebhooksReleaseAuthor {
  const WebhooksReleaseAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksReleaseAuthor.fromJson(Map<String, dynamic> json) {
    return WebhooksReleaseAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksReleaseAuthorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksReleaseAuthor copyWith({
    ...
    WebhooksReleaseAuthorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
