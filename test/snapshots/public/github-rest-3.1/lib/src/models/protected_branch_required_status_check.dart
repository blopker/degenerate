...
import 'protected_branch_required_status_check_checks.dart';
...
final class ProtectedBranchRequiredStatusCheck {
  ...
  factory ProtectedBranchRequiredStatusCheck.fromJson(
    ...
    return ProtectedBranchRequiredStatusCheck(
      ...
      checks: (json['checks'] as List<dynamic>)
          .map(
            (e) => ProtectedBranchRequiredStatusCheckChecks.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('contexts') && json.containsKey('checks');
  }

  ProtectedBranchRequiredStatusCheck copyWith({
    String Function()? url,
    String Function()? enforcementLevel,
    List<String>? contexts,
    List<ProtectedBranchRequiredStatusCheckChecks>? checks,
    String Function()? contextsUrl,
  ...
  @override
  String toString() {
    return 'ProtectedBranchRequiredStatusCheck(url: $url, enforcementLevel: $enforcementLevel, contexts: $contexts, checks: $checks, contextsUrl: $contextsUrl, strict: $strict)';
  }
}
