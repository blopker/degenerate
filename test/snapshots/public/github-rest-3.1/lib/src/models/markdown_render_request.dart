...
import 'markdown_render_request_mode.dart';

final class MarkdownRenderRequest {
  ...
  factory MarkdownRenderRequest.fromJson(Map<String, dynamic> json) {
    return MarkdownRenderRequest(
      ...
      mode: json.containsKey('mode')
          ? MarkdownRenderRequestMode.fromJson(json['mode'] as String)
  ...
  MarkdownRenderRequest copyWith({
    String? text,
    MarkdownRenderRequestMode Function()? mode,
  ...
  @override
  int get hashCode {
    return Object.hash(text, mode, context);
  }

  @override
  String toString() {
    return 'MarkdownRenderRequest(text: $text, mode: $mode, context: $context)';
  }
}
