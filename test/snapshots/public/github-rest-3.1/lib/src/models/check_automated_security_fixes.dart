...
final class CheckAutomatedSecurityFixes {
  ...
  CheckAutomatedSecurityFixes copyWith({bool? enabled, bool? paused}) {
    return CheckAutomatedSecurityFixes(
  ...
  @override
  int get hashCode {
    return Object.hash(enabled, paused);
  }

  @override
  String toString() {
    return 'CheckAutomatedSecurityFixes(enabled: $enabled, paused: $paused)';
  }
}
