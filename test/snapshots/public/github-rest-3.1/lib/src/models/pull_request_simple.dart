...
import 'pull_request_simple_base.dart';
import 'pull_request_simple_head.dart';
import 'pull_request_simple_labels.dart';
import 'pull_request_simple_links.dart';
...
final class PullRequestSimple {
  ...
  factory PullRequestSimple.fromJson(Map<String, dynamic> json) {
    return PullRequestSimple(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => PullRequestSimpleLabels.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  PullRequestSimple copyWith({
    ...
    List<Team> Function()? requestedTeams,
