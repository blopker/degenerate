...
import 'review_custom_gates_state_required_state.dart';
...
final class ReviewCustomGatesStateRequired {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('environment_name') &&
        json['environment_name'] is String &&
        json.containsKey('state');
  }

  ReviewCustomGatesStateRequired copyWith({
    String? environmentName,
    ReviewCustomGatesStateRequiredState? state,
  ...
  @override
  int get hashCode {
    return Object.hash(environmentName, state, comment);
  }

  @override
  String toString() {
    return 'ReviewCustomGatesStateRequired(environmentName: $environmentName, state: $state, comment: $comment)';
  }
}
