...
import 'git_create_tree_request_tree_mode.dart';import 'git_create_tree_request_tree_type.dart';final class GitCreateTreeRequestTree {const GitCreateTreeRequestTree({this.path, this.mode, this.type, this.sha, this.content, });
