...
import 'inline_object75_type.dart';

final class InlineObject75 {
  const InlineObject75({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject75.fromJson(Map<String, dynamic> json) {
    return InlineObject75(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject75Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject75 copyWith({
    ...
    InlineObject75Type Function()? type,
    Uri Function()? url,
