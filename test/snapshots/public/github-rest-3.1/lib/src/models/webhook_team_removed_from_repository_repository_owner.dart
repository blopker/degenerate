...
import 'webhook_team_removed_from_repository_repository_owner_type.dart';

final class WebhookTeamRemovedFromRepositoryRepositoryOwner {
  const WebhookTeamRemovedFromRepositoryRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookTeamRemovedFromRepositoryRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookTeamRemovedFromRepositoryRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookTeamRemovedFromRepositoryRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookTeamRemovedFromRepositoryRepositoryOwner copyWith({
    ...
    WebhookTeamRemovedFromRepositoryRepositoryOwnerType Function()? type,
    Uri Function()? url,
