...
import 'code_scanning_analysis_tool.dart';final class CodeScanningAnalysis {const CodeScanningAnalysis({required this.ref, required this.commitSha, required this.analysisKey, required this.environment, this.category, required this.error, required this.createdAt, required this.resultsCount, required this.rulesCount, required this.id, required this.url, required this.sarifId, required this.tool, required this.deletable, required this.warning, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('ref') && json['ref'] is String &&
      ...
      json.containsKey('analysis_key') && json['analysis_key'] is String &&
      ...
      json.containsKey('sarif_id') && json['sarif_id'] is String &&
      json.containsKey('tool') &&
      json.containsKey('deletable') && json['deletable'] is bool &&
      json.containsKey('warning') && json['warning'] is String; } 
CodeScanningAnalysis copyWith({String? ref, String? commitSha, String? analysisKey, String? environment, String Function()? category, String? error, DateTime? createdAt, int? resultsCount, int? rulesCount, int? id, Uri? url, String? sarifId, CodeScanningAnalysisTool? tool, bool? deletable, String? warning, }) { return CodeScanningAnalysis(
  ref: ref ?? this.ref,
