...
import 'webhook_pull_request_review_comment_created_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner {
  const WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerType?
  type;
  ...
  WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestReviewCommentCreatedPullRequestBaseRepoOwnerType
    Function()?
    type,
    Uri Function()? url,
