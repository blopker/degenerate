...
final class WebhooksPullRequest5Assignees {
  const WebhooksPullRequest5Assignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5Assignees.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5Assignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5AssigneesType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksPullRequest5Assignees copyWith({
    ...
    WebhooksPullRequest5AssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhooksPullRequest5Assignees(
