...
import 'webhook_issues_opened_issue_milestone_creator_type.dart';

final class WebhookIssuesOpenedIssueMilestoneCreator {
  const WebhookIssuesOpenedIssueMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedIssueMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedIssueMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedIssueMilestoneCreator copyWith({
    ...
    WebhookIssuesOpenedIssueMilestoneCreatorType Function()? type,
    Uri Function()? url,
