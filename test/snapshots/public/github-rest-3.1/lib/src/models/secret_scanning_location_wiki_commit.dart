...
final class SecretScanningLocationWikiCommit {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('path') &&
        ...
        json.containsKey('end_line') &&
        json['end_line'] is num &&
        json.containsKey('start_column') &&
        json['start_column'] is num &&
        json.containsKey('end_column') &&
        json['end_column'] is num &&
        json.containsKey('blob_sha') &&
        json['blob_sha'] is String &&
        json.containsKey('page_url') &&
        json['page_url'] is String &&
  ...
  SecretScanningLocationWikiCommit copyWith({
    String? path,
    double? startLine,
    double? endLine,
    double? startColumn,
  ...
  @override
  String toString() {
    return 'SecretScanningLocationWikiCommit(path: $path, startLine: $startLine, endLine: $endLine, startColumn: $startColumn, endColumn: $endColumn, blobSha: $blobSha, pageUrl: $pageUrl, commitSha: $commitSha, commitUrl: $commitUrl)';
  }
}
