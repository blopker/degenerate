...
import 'package:collection/collection.dart';import 'private_registries_update_org_private_registry_request_registry_type.dart';import 'private_registries_update_org_private_registry_request_visibility.dart';final class PrivateRegistriesUpdateOrgPrivateRegistryRequest {const PrivateRegistriesUpdateOrgPrivateRegistryRequest({this.registryType, this.url, this.username, this.replacesBase = false, this.encryptedValue, this.keyId, this.visibility, this.selectedRepositoryIds, });
