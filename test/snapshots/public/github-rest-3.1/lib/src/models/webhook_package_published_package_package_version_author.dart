...
import 'webhook_package_published_package_package_version_author_type.dart';

final class WebhookPackagePublishedPackagePackageVersionAuthor {
  const WebhookPackagePublishedPackagePackageVersionAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackagePublishedPackagePackageVersionAuthor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackagePublishedPackagePackageVersionAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackagePublishedPackagePackageVersionAuthorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackagePublishedPackagePackageVersionAuthor copyWith({
    ...
    WebhookPackagePublishedPackagePackageVersionAuthorType Function()? type,
    Uri Function()? url,
