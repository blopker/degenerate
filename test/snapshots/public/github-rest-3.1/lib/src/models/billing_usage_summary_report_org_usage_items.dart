...
final class BillingUsageSummaryReportOrgUsageItems {
  const BillingUsageSummaryReportOrgUsageItems({
  ...
  factory BillingUsageSummaryReportOrgUsageItems.fromJson(
    Map<String, dynamic> json,
  ) {
    return BillingUsageSummaryReportOrgUsageItems(
  ...
  BillingUsageSummaryReportOrgUsageItems copyWith({
    String? product,
    String? sku,
    String? unitType,
    double? pricePerUnit,
  ...
  @override
  String toString() {
    return 'BillingUsageSummaryReportOrgUsageItems(product: $product, sku: $sku, unitType: $unitType, pricePerUnit: $pricePerUnit, grossQuantity: $grossQuantity, grossAmount: $grossAmount, discountQuantity: $discountQuantity, discountAmount: $discountAmount, netQuantity: $netQuantity, netAmount: $netAmount)';
  }
}
