...
final class UsersUpdateAuthenticatedRequest {
  ...
  UsersUpdateAuthenticatedRequest copyWith({
  ...
  @override
  String toString() {
    return 'UsersUpdateAuthenticatedRequest(name: $name, email: $email, blog: $blog, twitterUsername: $twitterUsername, company: $company, location: $location, hireable: $hireable, bio: $bio)';
  }
}
