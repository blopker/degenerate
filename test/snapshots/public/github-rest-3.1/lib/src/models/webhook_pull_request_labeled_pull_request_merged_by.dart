...
import 'webhook_pull_request_labeled_pull_request_merged_by_type.dart';

final class WebhookPullRequestLabeledPullRequestMergedBy {
  const WebhookPullRequestLabeledPullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestLabeledPullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestLabeledPullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestLabeledPullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestLabeledPullRequestMergedBy copyWith({
    ...
    WebhookPullRequestLabeledPullRequestMergedByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestLabeledPullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
