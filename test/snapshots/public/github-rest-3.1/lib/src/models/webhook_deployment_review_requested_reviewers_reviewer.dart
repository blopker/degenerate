...
import 'webhook_deployment_review_requested_reviewers_reviewer_type.dart';

final class WebhookDeploymentReviewRequestedReviewersReviewer {
  const WebhookDeploymentReviewRequestedReviewersReviewer({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewRequestedReviewersReviewer.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRequestedReviewersReviewer(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewRequestedReviewersReviewerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') && json['id'] is num;
  }

  WebhookDeploymentReviewRequestedReviewersReviewer copyWith({
    ...
    WebhookDeploymentReviewRequestedReviewersReviewerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentReviewRequestedReviewersReviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
