...
import 'webhook_pull_request_auto_merge_disabled_pull_request_head_user_type.dart';

final class WebhookPullRequestAutoMergeDisabledPullRequestHeadUser {
  const WebhookPullRequestAutoMergeDisabledPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeDisabledPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeDisabledPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeDisabledPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType Function()? type,
    Uri Function()? url,
