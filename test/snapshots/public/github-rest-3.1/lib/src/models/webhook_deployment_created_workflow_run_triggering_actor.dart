...
import 'webhook_deployment_created_workflow_run_triggering_actor_type.dart';

final class WebhookDeploymentCreatedWorkflowRunTriggeringActor {
  const WebhookDeploymentCreatedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentCreatedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentCreatedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentCreatedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentCreatedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookDeploymentCreatedWorkflowRunTriggeringActorType Function()? type,
    Uri Function()? url,
