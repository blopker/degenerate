...
import 'webhook_deployment_created_deployment_creator_type.dart';

final class WebhookDeploymentCreatedDeploymentCreator {
  const WebhookDeploymentCreatedDeploymentCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentCreatedDeploymentCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentCreatedDeploymentCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentCreatedDeploymentCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentCreatedDeploymentCreator copyWith({
    ...
    WebhookDeploymentCreatedDeploymentCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentCreatedDeploymentCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
