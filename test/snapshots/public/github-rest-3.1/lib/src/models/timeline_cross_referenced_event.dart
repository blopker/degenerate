...
import 'timeline_cross_referenced_event_source.dart';
...
final class TimelineCrossReferencedEvent {
  ...
  TimelineCrossReferencedEvent copyWith({
    String? event,
  ...
  @override
  int get hashCode {
    return Object.hash(event, actor, createdAt, updatedAt, source);
  }

  @override
  String toString() {
    return 'TimelineCrossReferencedEvent(event: $event, actor: $actor, createdAt: $createdAt, updatedAt: $updatedAt, source: $source)';
  }
}
