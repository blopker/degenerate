...
final class CopilotDotcomPullRequestsRepositoriesModels {
  const CopilotDotcomPullRequestsRepositoriesModels({
    this.name,
    this.isCustomModel,
  ...
  factory CopilotDotcomPullRequestsRepositoriesModels.fromJson(
    Map<String, dynamic> json,
  ) {
    return CopilotDotcomPullRequestsRepositoriesModels(
      name: json['name'] as String?,
      isCustomModel: json['is_custom_model'] as bool?,
      customModelTrainingDate: json['custom_model_training_date'] as String?,
      totalPrSummariesCreated: json['total_pr_summaries_created'] != null
          ? (json['total_pr_summaries_created'] as num).toInt()
          : null,
  ...
  CopilotDotcomPullRequestsRepositoriesModels copyWith({
    String Function()? name,
    bool Function()? isCustomModel,
    String? Function()? customModelTrainingDate,
    int Function()? totalPrSummariesCreated,
    ...
    return CopilotDotcomPullRequestsRepositoriesModels(
      ...
      customModelTrainingDate: customModelTrainingDate != null
          ...
          : this.customModelTrainingDate,
      totalPrSummariesCreated: totalPrSummariesCreated != null
  ...
  @override
  String toString() {
    return 'CopilotDotcomPullRequestsRepositoriesModels(name: $name, isCustomModel: $isCustomModel, customModelTrainingDate: $customModelTrainingDate, totalPrSummariesCreated: $totalPrSummariesCreated, totalEngagedUsers: $totalEngagedUsers)';
  }
}
