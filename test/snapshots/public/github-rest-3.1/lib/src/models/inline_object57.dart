...
import 'inline_object57_type.dart';

final class InlineObject57 {
  const InlineObject57({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject57.fromJson(Map<String, dynamic> json) {
    return InlineObject57(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject57Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject57 copyWith({
    ...
    InlineObject57Type Function()? type,
    Uri Function()? url,
