...
import 'campaign_summary_alert_stats.dart';
...
final class CampaignSummary {
  ...
  factory CampaignSummary.fromJson(Map<String, dynamic> json) {
    return CampaignSummary(
      ...
      alertStats: json['alert_stats'] != null
          ? CampaignSummaryAlertStats.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('number') &&
        ...
        json.containsKey('ends_at') &&
        json['ends_at'] is String &&
        json.containsKey('state') &&
        json.containsKey('contact_link') &&
        json['contact_link'] is String;
  }
  ...
  CampaignSummary copyWith({
    ...
    String? description,
    List<SimpleUser>? managers,
    List<Team> Function()? teamManagers,
    DateTime Function()? publishedAt,
    DateTime? endsAt,
    DateTime? Function()? closedAt,
    CampaignState? state,
    Uri? Function()? contactLink,
    CampaignSummaryAlertStats Function()? alertStats,
  }) {
    return CampaignSummary(
  ...
  @override
  String toString() {
    return 'CampaignSummary(number: $number, createdAt: $createdAt, updatedAt: $updatedAt, name: $name, description: $description, managers: $managers, teamManagers: $teamManagers, publishedAt: $publishedAt, endsAt: $endsAt, closedAt: $closedAt, state: $state, contactLink: $contactLink, alertStats: $alertStats)';
  }
}
