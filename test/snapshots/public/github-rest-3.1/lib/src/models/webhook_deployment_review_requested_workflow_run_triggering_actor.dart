...
import 'webhook_deployment_review_requested_workflow_run_triggering_actor_type.dart';

final class WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor {
  const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType Function()?
    type,
    Uri Function()? url,
