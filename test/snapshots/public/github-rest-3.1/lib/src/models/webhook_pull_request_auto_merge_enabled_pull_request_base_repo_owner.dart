...
import 'webhook_pull_request_auto_merge_enabled_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner {
  const WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwnerType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAutoMergeEnabledPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
