...
import 'inline_object63_pull_request_assignee_type.dart';

final class InlineObject63PullRequestAssignee {
  const InlineObject63PullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestAssignee copyWith({
    ...
    InlineObject63PullRequestAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject63PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
