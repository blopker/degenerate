...
final class AuthorAssociation {
  ...
  static const AuthorAssociation collaborator = AuthorAssociation._(
    'COLLABORATOR',
  );

  static const AuthorAssociation contributor = AuthorAssociation._(
    'CONTRIBUTOR',
  );

  static const AuthorAssociation firstTimer = AuthorAssociation._(
    'FIRST_TIMER',
  );

  static const AuthorAssociation firstTimeContributor = AuthorAssociation._(
  ...
  static const List<AuthorAssociation> values = [
    collaborator,
    contributor,
    firstTimer,
  ...
  @override
  String toString() {
    return 'AuthorAssociation($value)';
  }
}
