...
import 'webhooks_release1_assets.dart';
import 'webhooks_release1_author.dart';
import 'webhooks_release1_reactions.dart';

/// The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object.
final class WebhooksRelease1 {
  const WebhooksRelease1({
  ...
  factory WebhooksRelease1.fromJson(Map<String, dynamic> json) {
    return WebhooksRelease1(
      assets: (json['assets'] as List<dynamic>)
          .map(
            (e) => WebhooksRelease1Assets.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      assetsUrl: Uri.parse(json['assets_url'] as String),
      author: WebhooksRelease1Author.fromJson(
      ...
      reactions: json['reactions'] != null
          ? WebhooksRelease1Reactions.fromJson(
  ...
  WebhooksRelease1 copyWith({
    List<WebhooksRelease1Assets?>? assets,
    Uri? assetsUrl,
    WebhooksRelease1Author? Function()? author,
    ...
    WebhooksRelease1Reactions Function()? reactions,
    String? tagName,
  ...
  @override
  String toString() {
    return 'WebhooksRelease1(assets: $assets, assetsUrl: $assetsUrl, author: $author, body: $body, createdAt: $createdAt, discussionUrl: $discussionUrl, draft: $draft, htmlUrl: $htmlUrl, id: $id, immutable: $immutable, name: $name, nodeId: $nodeId, prerelease: $prerelease, publishedAt: $publishedAt, reactions: $reactions, tagName: $tagName, tarballUrl: $tarballUrl, targetCommitish: $targetCommitish, updatedAt: $updatedAt, uploadUrl: $uploadUrl, url: $url, zipballUrl: $zipballUrl)';
  }
}
