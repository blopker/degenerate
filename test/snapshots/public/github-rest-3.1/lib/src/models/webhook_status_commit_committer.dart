...
import 'webhook_status_commit_committer_type.dart';

final class WebhookStatusCommitCommitter {
  const WebhookStatusCommitCommitter({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookStatusCommitCommitter.fromJson(Map<String, dynamic> json) {
    return WebhookStatusCommitCommitter(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookStatusCommitCommitterType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookStatusCommitCommitter copyWith({
    ...
    WebhookStatusCommitCommitterType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookStatusCommitCommitter(
  ...
  @override
  String toString() {
    return 'WebhookStatusCommitCommitter(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
