...
final class DiscussionCategory {
  ...
  @override
  String toString() {
    return 'DiscussionCategory(createdAt: $createdAt, description: $description, emoji: $emoji, id: $id, isAnswerable: $isAnswerable, name: $name, nodeId: $nodeId, repositoryId: $repositoryId, slug: $slug, updatedAt: $updatedAt)';
  }
}
