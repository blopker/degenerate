...
import 'user_role_assignment_assignment.dart';
...
final class UserRoleAssignment {
  ...
  factory UserRoleAssignment.fromJson(Map<String, dynamic> json) {
    return UserRoleAssignment(
      assignment: json['assignment'] != null
          ? UserRoleAssignmentAssignment.fromJson(json['assignment'] as String)
          : null,
      inheritedFrom: (json['inherited_from'] as List<dynamic>?)
  ...
  UserRoleAssignment copyWith({
    UserRoleAssignmentAssignment Function()? assignment,
    List<TeamSimple> Function()? inheritedFrom,
  ...
  int get hashCode {
    return Object.hashAll([
      assignment,
      Object.hashAll(inheritedFrom ?? const []),
      name,
      email,
      login,
      id,
