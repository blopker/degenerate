...
import 'package:collection/collection.dart';import 'team_simple.dart';import 'user_role_assignment_assignment.dart';/// The Relationship a User has with a role.
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UserRoleAssignment &&
          ...
          const ListEquality<dynamic>().equals(inheritedFrom, other.inheritedFrom) &&
          name == other.name &&
          email == other.email &&
          login == other.login &&
          id == other.id &&
