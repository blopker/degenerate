...
final class RepositoryCollaboratorPermission {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('permission') &&
  ...
  RepositoryCollaboratorPermission copyWith({
    String? permission,
    String? roleName,
  ...
  @override
  int get hashCode {
    return Object.hash(permission, roleName, user);
  }

  @override
  String toString() {
    return 'RepositoryCollaboratorPermission(permission: $permission, roleName: $roleName, user: $user)';
  }
}
