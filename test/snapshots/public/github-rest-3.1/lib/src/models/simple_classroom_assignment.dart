...
import 'simple_classroom.dart';
import 'simple_classroom_assignment_type.dart';

/// A GitHub Classroom assignment
final class SimpleClassroomAssignment {
  ...
  factory SimpleClassroomAssignment.fromJson(Map<String, dynamic> json) {
    return SimpleClassroomAssignment(
      ...
      maxTeams: json['max_teams'] != null
          ? (json['max_teams'] as num).toInt()
          : null,
      maxMembers: json['max_members'] != null
          ? (json['max_members'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('public_repo') &&
        json['public_repo'] is bool &&
        json.containsKey('title') &&
        json['title'] is String &&
        json.containsKey('type') &&
        json.containsKey('invite_link') &&
        json['invite_link'] is String &&
        json.containsKey('invitations_enabled') &&
        json['invitations_enabled'] is bool &&
        json.containsKey('slug') &&
        json['slug'] is String &&
        json.containsKey('students_are_repo_admins') &&
        json['students_are_repo_admins'] is bool &&
        json.containsKey('feedback_pull_requests_enabled') &&
        json['feedback_pull_requests_enabled'] is bool &&
        json.containsKey('editor') &&
        json['editor'] is String &&
        json.containsKey('accepted') &&
        json['accepted'] is num &&
        json.containsKey('submitted') &&
        json['submitted'] is num &&
        json.containsKey('passing') &&
        json['passing'] is num &&
  ...
  SimpleClassroomAssignment copyWith({
    int? id,
    bool? publicRepo,
    String? title,
    SimpleClassroomAssignmentType? type,
    String? inviteLink,
    bool? invitationsEnabled,
    String? slug,
    bool? studentsAreRepoAdmins,
    bool? feedbackPullRequestsEnabled,
    int? Function()? maxTeams,
    ...
    return SimpleClassroomAssignment(
      ...
      studentsAreRepoAdmins:
          studentsAreRepoAdmins ?? this.studentsAreRepoAdmins,
      feedbackPullRequestsEnabled:
          feedbackPullRequestsEnabled ?? this.feedbackPullRequestsEnabled,
