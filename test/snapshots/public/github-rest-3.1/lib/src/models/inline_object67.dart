...
import 'inline_object67_type.dart';

final class InlineObject67 {
  const InlineObject67({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject67.fromJson(Map<String, dynamic> json) {
    return InlineObject67(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject67Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject67 copyWith({
    ...
    InlineObject67Type Function()? type,
    Uri Function()? url,
