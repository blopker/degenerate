...
final class SnapshotJob {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is String &&
        json.containsKey('correlator') &&
        json['correlator'] is String;
  }
  ...
  @override
  int get hashCode {
    return Object.hash(id, correlator, htmlUrl);
  }

  @override
  String toString() {
    return 'SnapshotJob(id: $id, correlator: $correlator, htmlUrl: $htmlUrl)';
  }
}
