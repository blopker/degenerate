...
import 'pull_request_review_event_review.dart';

final class PullRequestReviewEvent {
  ...
  factory PullRequestReviewEvent.fromJson(Map<String, dynamic> json) {
    return PullRequestReviewEvent(
      ...
      review: PullRequestReviewEventReview.fromJson(
  ...
  PullRequestReviewEvent copyWith({
    String? action,
  ...
  @override
  int get hashCode {
    return Object.hash(action, review, pullRequest);
  }

  @override
  String toString() {
    return 'PullRequestReviewEvent(action: $action, review: $review, pullRequest: $pullRequest)';
  }
}
