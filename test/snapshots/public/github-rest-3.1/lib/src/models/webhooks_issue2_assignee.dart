...
import 'webhooks_issue2_assignee_type.dart';

final class WebhooksIssue2Assignee {
  const WebhooksIssue2Assignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssue2Assignee.fromJson(Map<String, dynamic> json) {
    return WebhooksIssue2Assignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssue2AssigneeType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssue2Assignee copyWith({
    ...
    WebhooksIssue2AssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksIssue2Assignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
