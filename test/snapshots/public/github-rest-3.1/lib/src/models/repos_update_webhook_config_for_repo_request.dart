...
import 'webhook_config_insecure_ssl.dart';final class ReposUpdateWebhookConfigForRepoRequest {const ReposUpdateWebhookConfigForRepoRequest({this.url, this.contentType, this.secret, this.insecureSsl, });
...
ReposUpdateWebhookConfigForRepoRequest copyWith({Uri Function()? url, String Function()? contentType, String Function()? secret, WebhookConfigInsecureSsl Function()? insecureSsl, }) { return ReposUpdateWebhookConfigForRepoRequest(
