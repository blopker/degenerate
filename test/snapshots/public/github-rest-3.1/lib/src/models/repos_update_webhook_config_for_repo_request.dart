...
final class ReposUpdateWebhookConfigForRepoRequest {
  ...
  ReposUpdateWebhookConfigForRepoRequest copyWith({
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'ReposUpdateWebhookConfigForRepoRequest(url: $url, contentType: $contentType, secret: $secret, insecureSsl: $insecureSsl)';
  }
}
