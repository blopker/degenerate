...
import 'content_tree_entries.dart';
import 'content_tree_links.dart';
...
final class ContentTree {
  ...
  factory ContentTree.fromJson(Map<String, dynamic> json) {
    return ContentTree(
      ...
      entries: (json['entries'] as List<dynamic>?)
          ?.map((e) => ContentTreeEntries.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  ContentTree copyWith({
    ...
    List<ContentTreeEntries> Function()? entries,
  ...
  @override
  String toString() {
    return 'ContentTree(type: $type, size: $size, name: $name, path: $path, sha: $sha, content: $content, url: $url, gitUrl: $gitUrl, htmlUrl: $htmlUrl, downloadUrl: $downloadUrl, entries: $entries, encoding: $encoding, links: $links)';
  }
}
