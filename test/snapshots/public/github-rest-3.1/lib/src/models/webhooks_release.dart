...
import 'webhooks_release_assets.dart';
import 'webhooks_release_author.dart';
import 'webhooks_release_reactions.dart';

/// The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object.
final class WebhooksRelease {
  const WebhooksRelease({
  ...
  factory WebhooksRelease.fromJson(Map<String, dynamic> json) {
    return WebhooksRelease(
      assets: (json['assets'] as List<dynamic>)
          .map((e) => WebhooksReleaseAssets.fromJson(e as Map<String, dynamic>))
          .toList(),
      assetsUrl: Uri.parse(json['assets_url'] as String),
      author: WebhooksReleaseAuthor.fromJson(
      ...
      reactions: json['reactions'] != null
          ? WebhooksReleaseReactions.fromJson(
  ...
  WebhooksRelease copyWith({
    List<WebhooksReleaseAssets>? assets,
    Uri? assetsUrl,
    WebhooksReleaseAuthor? Function()? author,
    ...
    WebhooksReleaseReactions Function()? reactions,
    String? tagName,
  ...
  @override
  String toString() {
    return 'WebhooksRelease(assets: $assets, assetsUrl: $assetsUrl, author: $author, body: $body, createdAt: $createdAt, updatedAt: $updatedAt, discussionUrl: $discussionUrl, draft: $draft, htmlUrl: $htmlUrl, id: $id, immutable: $immutable, name: $name, nodeId: $nodeId, prerelease: $prerelease, publishedAt: $publishedAt, reactions: $reactions, tagName: $tagName, tarballUrl: $tarballUrl, targetCommitish: $targetCommitish, uploadUrl: $uploadUrl, url: $url, zipballUrl: $zipballUrl)';
  }
}
