...
import 'webhook_deployment_status_created_workflow_run_actor.dart';
import 'webhook_deployment_status_created_workflow_run_conclusion.dart';
import 'webhook_deployment_status_created_workflow_run_head_repository.dart';
import 'webhook_deployment_status_created_workflow_run_pull_requests.dart';
import 'webhook_deployment_status_created_workflow_run_referenced_workflows.dart';
import 'webhook_deployment_status_created_workflow_run_repository.dart';
import 'webhook_deployment_status_created_workflow_run_status.dart';
import 'webhook_deployment_status_created_workflow_run_triggering_actor.dart';

final class WebhookDeploymentStatusCreatedWorkflowRun {
  const WebhookDeploymentStatusCreatedWorkflowRun({
    required this.actor,
    this.artifactsUrl,
    this.cancelUrl,
  ...
  factory WebhookDeploymentStatusCreatedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedWorkflowRun(
      actor: WebhookDeploymentStatusCreatedWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookDeploymentStatusCreatedWorkflowRunConclusion.fromJson(
      ...
      headRepository: json['head_repository'] != null
          ? WebhookDeploymentStatusCreatedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) =>
                WebhookDeploymentStatusCreatedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: json['repository'] != null
          ? WebhookDeploymentStatusCreatedWorkflowRunRepository.fromJson(
      ...
      status: WebhookDeploymentStatusCreatedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor.fromJson(
  ...
  final List<WebhookDeploymentStatusCreatedWorkflowRunPullRequests>
  pullRequests;

  final List<WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  final WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor?
  triggeringActor;
  ...
  WebhookDeploymentStatusCreatedWorkflowRun copyWith({
    WebhookDeploymentStatusCreatedWorkflowRunActor? Function()? actor,
    String Function()? artifactsUrl,
    String Function()? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    String Function()? checkSuiteUrl,
    WebhookDeploymentStatusCreatedWorkflowRunConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? displayTitle,
    String? event,
    String? headBranch,
    String? Function()? headCommit,
    WebhookDeploymentStatusCreatedWorkflowRunHeadRepository Function()?
    headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    ...
    List<WebhookDeploymentStatusCreatedWorkflowRunPullRequests>? pullRequests,
    List<WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows>?
    Function()?
    referencedWorkflows,
    WebhookDeploymentStatusCreatedWorkflowRunRepository Function()? repository,
    String Function()? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookDeploymentStatusCreatedWorkflowRunStatus? status,
    WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
