...
final class CodespaceExportDetails {
  ...
  CodespaceExportDetails copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(state, completedAt, branch, sha, id, exportUrl, htmlUrl);
  }

  @override
  String toString() {
    return 'CodespaceExportDetails(state: $state, completedAt: $completedAt, branch: $branch, sha: $sha, id: $id, exportUrl: $exportUrl, htmlUrl: $htmlUrl)';
  }
}
