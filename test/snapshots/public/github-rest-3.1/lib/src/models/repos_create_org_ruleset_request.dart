...
import 'repos_create_org_ruleset_request_target.dart';
import 'repository_rule_enforcement.dart';
import 'repository_ruleset_bypass_actor.dart';

final class ReposCreateOrgRulesetRequest {
  ...
  factory ReposCreateOrgRulesetRequest.fromJson(Map<String, dynamic> json) {
    return ReposCreateOrgRulesetRequest(
      ...
      target: json.containsKey('target')
          ? ReposCreateOrgRulesetRequestTarget.fromJson(
  ...
  ReposCreateOrgRulesetRequest copyWith({
    String? name,
    ReposCreateOrgRulesetRequestTarget Function()? target,
  ...
  @override
  String toString() {
    return 'ReposCreateOrgRulesetRequest(name: $name, target: $target, enforcement: $enforcement, bypassActors: $bypassActors, conditions: $conditions, rules: $rules)';
  }
}
