...
import 'package:collection/collection.dart';import 'org_rules.dart';import 'org_ruleset_conditions.dart';import 'repos_create_org_ruleset_request_target.dart';import 'repository_rule_enforcement.dart';import 'repository_ruleset_bypass_actor.dart';final class ReposCreateOrgRulesetRequest {const ReposCreateOrgRulesetRequest({required this.name, this.target = ReposCreateOrgRulesetRequestTarget.branch, required this.enforcement, this.bypassActors, this.conditions, this.rules, });
...
factory ReposCreateOrgRulesetRequest.fromJson(Map<String, dynamic> json) { return ReposCreateOrgRulesetRequest(
  ...
  conditions: json['conditions'] != null
        ? OrgRulesetConditions.fromJson(json['conditions'] as Map<String, dynamic>)
        : null,
