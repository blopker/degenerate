...
import 'webhook_pull_request_auto_merge_enabled_pull_request_assignees_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestAssignees {
  const WebhookPullRequestAutoMergeEnabledPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestAssignees copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestAutoMergeEnabledPullRequestAssignees(
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAutoMergeEnabledPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
