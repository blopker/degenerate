...
import 'inline_object77_type.dart';

final class InlineObject77 {
  const InlineObject77({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject77.fromJson(Map<String, dynamic> json) {
    return InlineObject77(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject77Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject77 copyWith({
    ...
    InlineObject77Type Function()? type,
    Uri Function()? url,
