...
final class ReposUpdateReleaseAssetRequest {
  ...
  ReposUpdateReleaseAssetRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(name, label, state);
  }

  @override
  String toString() {
    return 'ReposUpdateReleaseAssetRequest(name: $name, label: $label, state: $state)';
  }
}
