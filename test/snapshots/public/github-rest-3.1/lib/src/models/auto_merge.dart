...
import 'auto_merge_merge_method.dart';
...
final class AutoMerge {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('enabled_by') &&
  ...
  AutoMerge copyWith({
    ...
    AutoMergeMergeMethod? mergeMethod,
    String? commitTitle,
  ...
  @override
  int get hashCode {
    return Object.hash(enabledBy, mergeMethod, commitTitle, commitMessage);
  }

  @override
  String toString() {
    return 'AutoMerge(enabledBy: $enabledBy, mergeMethod: $mergeMethod, commitTitle: $commitTitle, commitMessage: $commitMessage)';
  }
}
