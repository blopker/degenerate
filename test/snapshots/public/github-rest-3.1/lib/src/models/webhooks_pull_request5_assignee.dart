...
import 'webhooks_pull_request5_assignee_type.dart';

final class WebhooksPullRequest5Assignee {
  const WebhooksPullRequest5Assignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5Assignee.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5Assignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5AssigneeType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksPullRequest5Assignee copyWith({
    ...
    WebhooksPullRequest5AssigneeType Function()? type,
    Uri Function()? url,
