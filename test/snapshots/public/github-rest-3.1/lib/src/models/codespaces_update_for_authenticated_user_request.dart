...
import 'package:collection/collection.dart';final class CodespacesUpdateForAuthenticatedUserRequest {const CodespacesUpdateForAuthenticatedUserRequest({this.machine, this.displayName, this.recentFolders, });
