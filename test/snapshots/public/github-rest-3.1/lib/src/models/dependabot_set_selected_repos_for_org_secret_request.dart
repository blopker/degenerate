...
import 'package:collection/collection.dart';final class DependabotSetSelectedReposForOrgSecretRequest {const DependabotSetSelectedReposForOrgSecretRequest({required this.selectedRepositoryIds});
