...
final class ContributorActivityWeeks {
  const ContributorActivityWeeks({this.w, this.a, this.d, this.c});

  factory ContributorActivityWeeks.fromJson(Map<String, dynamic> json) {
  ...
  ContributorActivityWeeks copyWith({
    int Function()? w,
    int Function()? a,
    int Function()? d,
    int Function()? c,
