...
final class ItemEdited {
  ...
  factory ItemEdited.fromJson(Map<String, dynamic> json) {
    return ItemEdited(
  ...
  ItemEdited copyWith({
    ItemEditedAction? action,
    ItemEditedChanges Function()? changes,
  ...
  @override
  String toString() {
    return 'ItemEdited(action: $action, changes: $changes, installation: $installation, organization: $organization, projectsV2Item: $projectsV2Item, sender: $sender)';
  }
}
