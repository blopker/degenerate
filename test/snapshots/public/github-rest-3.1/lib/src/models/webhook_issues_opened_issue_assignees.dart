...
import 'webhook_issues_opened_issue_assignees_type.dart';

final class WebhookIssuesOpenedIssueAssignees {
  const WebhookIssuesOpenedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedIssueAssignees copyWith({
    ...
    WebhookIssuesOpenedIssueAssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesOpenedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
