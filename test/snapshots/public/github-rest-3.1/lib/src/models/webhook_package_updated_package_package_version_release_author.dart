...
import 'webhook_package_updated_package_package_version_release_author_type.dart';

final class WebhookPackageUpdatedPackagePackageVersionReleaseAuthor {
  const WebhookPackageUpdatedPackagePackageVersionReleaseAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackageUpdatedPackagePackageVersionReleaseAuthor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackageUpdatedPackagePackageVersionReleaseAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackageUpdatedPackagePackageVersionReleaseAuthorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackageUpdatedPackagePackageVersionReleaseAuthor copyWith({
    ...
    WebhookPackageUpdatedPackagePackageVersionReleaseAuthorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPackageUpdatedPackagePackageVersionReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
