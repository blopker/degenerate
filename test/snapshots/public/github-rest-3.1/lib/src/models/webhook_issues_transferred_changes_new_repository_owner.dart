...
import 'webhook_issues_transferred_changes_new_repository_owner_type.dart';

final class WebhookIssuesTransferredChangesNewRepositoryOwner {
  const WebhookIssuesTransferredChangesNewRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesTransferredChangesNewRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesTransferredChangesNewRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesTransferredChangesNewRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesTransferredChangesNewRepositoryOwner copyWith({
    ...
    WebhookIssuesTransferredChangesNewRepositoryOwnerType Function()? type,
    Uri Function()? url,
