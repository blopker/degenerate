...
import 'migrations_start_import_request_vcs.dart';

final class MigrationsStartImportRequest {
  ...
  factory MigrationsStartImportRequest.fromJson(Map<String, dynamic> json) {
    return MigrationsStartImportRequest(
      ...
      vcs: json['vcs'] != null
          ? MigrationsStartImportRequestVcs.fromJson(json['vcs'] as String)
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('vcs_url') && json['vcs_url'] is String;
  }

  MigrationsStartImportRequest copyWith({
    String? vcsUrl,
    MigrationsStartImportRequestVcs Function()? vcs,
    String Function()? vcsUsername,
    String Function()? vcsPassword,
  ...
  @override
  int get hashCode {
    return Object.hash(vcsUrl, vcs, vcsUsername, vcsPassword, tfvcProject);
  }

  @override
  String toString() {
    return 'MigrationsStartImportRequest(vcsUrl: $vcsUrl, vcs: $vcs, vcsUsername: $vcsUsername, vcsPassword: $vcsPassword, tfvcProject: $tfvcProject)';
  }
}
