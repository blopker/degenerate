...
import 'timeline_reviewed_event_links.dart';
...
final class TimelineReviewedEvent {
  ...
  factory TimelineReviewedEvent.fromJson(Map<String, dynamic> json) {
    return TimelineReviewedEvent(
      ...
      links: TimelineReviewedEventLinks.fromJson(
  ...
  TimelineReviewedEvent copyWith({
    String? event,
    int? id,
    String? nodeId,
    SimpleUser? user,
  ...
  @override
  String toString() {
    return 'TimelineReviewedEvent(event: $event, id: $id, nodeId: $nodeId, user: $user, body: $body, state: $state, htmlUrl: $htmlUrl, pullRequestUrl: $pullRequestUrl, links: $links, submittedAt: $submittedAt, updatedAt: $updatedAt, commitId: $commitId, bodyHtml: $bodyHtml, bodyText: $bodyText, authorAssociation: $authorAssociation)';
  }
}
