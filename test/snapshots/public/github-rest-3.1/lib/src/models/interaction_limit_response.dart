...
final class InteractionLimitResponse {
  ...
  InteractionLimitResponse copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(limit, origin, expiresAt);
  }

  @override
  String toString() {
    return 'InteractionLimitResponse(limit: $limit, origin: $origin, expiresAt: $expiresAt)';
  }
}
