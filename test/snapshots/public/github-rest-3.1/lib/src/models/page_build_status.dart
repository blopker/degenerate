...
final class PageBuildStatus {
  ...
  PageBuildStatus copyWith({Uri? url, String? status}) {
    return PageBuildStatus(url: url ?? this.url, status: status ?? this.status);
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PageBuildStatus && url == other.url && status == other.status;
  }

  @override
  int get hashCode {
    return Object.hash(url, status);
  }
