...
final class CreateEvent {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('ref') &&
        ...
        json['ref_type'] is String &&
        json.containsKey('full_ref') &&
        json['full_ref'] is String &&
  ...
  @override
  String toString() {
    return 'CreateEvent(ref: $ref, refType: $refType, fullRef: $fullRef, masterBranch: $masterBranch, description: $description, pusherType: $pusherType)';
  }
}
