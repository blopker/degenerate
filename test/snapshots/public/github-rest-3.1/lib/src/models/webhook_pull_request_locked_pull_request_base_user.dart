...
import 'webhook_pull_request_locked_pull_request_base_user_type.dart';

final class WebhookPullRequestLockedPullRequestBaseUser {
  const WebhookPullRequestLockedPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestLockedPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestLockedPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestLockedPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestLockedPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestLockedPullRequestBaseUserType Function()? type,
    Uri Function()? url,
