...
final class ActionsGetDefaultWorkflowPermissions {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('default_workflow_permissions') &&
        json.containsKey('can_approve_pull_request_reviews') &&
        json['can_approve_pull_request_reviews'] is bool;
  }

  ActionsGetDefaultWorkflowPermissions copyWith({
    ActionsDefaultWorkflowPermissions? defaultWorkflowPermissions,
    bool? canApprovePullRequestReviews,
  }) {
    return ActionsGetDefaultWorkflowPermissions(
      defaultWorkflowPermissions:
          defaultWorkflowPermissions ?? this.defaultWorkflowPermissions,
      canApprovePullRequestReviews:
          canApprovePullRequestReviews ?? this.canApprovePullRequestReviews,
    );
  }
  ...
  @override
  String toString() {
    return 'ActionsGetDefaultWorkflowPermissions(defaultWorkflowPermissions: $defaultWorkflowPermissions, canApprovePullRequestReviews: $canApprovePullRequestReviews)';
  }
}
