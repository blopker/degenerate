...
import 'webhook_issues_labeled_issue_assignees_type.dart';

final class WebhookIssuesLabeledIssueAssignees {
  const WebhookIssuesLabeledIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesLabeledIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesLabeledIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesLabeledIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesLabeledIssueAssignees copyWith({
    ...
    WebhookIssuesLabeledIssueAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesLabeledIssueAssignees(
