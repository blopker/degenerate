...
import 'inline_object69_pull_request_active_lock_reason.dart';
import 'inline_object69_pull_request_assignee.dart';
import 'inline_object69_pull_request_assignees.dart';
import 'inline_object69_pull_request_author_association.dart';
import 'inline_object69_pull_request_auto_merge.dart';
import 'inline_object69_pull_request_base.dart';
import 'inline_object69_pull_request_head.dart';
import 'inline_object69_pull_request_labels.dart';
import 'inline_object69_pull_request_links.dart';
import 'inline_object69_pull_request_merged_by.dart';
import 'inline_object69_pull_request_milestone.dart';
import 'inline_object69_pull_request_requested_reviewers.dart';
import 'inline_object69_pull_request_requested_teams.dart';
import 'inline_object69_pull_request_state.dart';
import 'inline_object69_pull_request_user.dart';

final class InlineObject69PullRequest {
  const InlineObject69PullRequest({
    required this.links,
  ...
  factory InlineObject69PullRequest.fromJson(Map<String, dynamic> json) {
    return InlineObject69PullRequest(
      links: InlineObject69PullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason: InlineObject69PullRequestActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: InlineObject69PullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => InlineObject69PullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: InlineObject69PullRequestAuthorAssociation.fromJson(
        json['author_association'] as String,
      ),
      autoMerge: InlineObject69PullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: InlineObject69PullRequestBase.fromJson(
      ...
      head: InlineObject69PullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => InlineObject69PullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? InlineObject69PullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: InlineObject69PullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map((e) => InlineObject69PullRequestRequestedReviewers.fromJson(e))
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => InlineObject69PullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      user: InlineObject69PullRequestUser.fromJson(
  ...
  InlineObject69PullRequest copyWith({
    InlineObject69PullRequestLinks? links,
    InlineObject69PullRequestActiveLockReason? Function()? activeLockReason,
    int Function()? additions,
    InlineObject69PullRequestAssignee? Function()? assignee,
    List<InlineObject69PullRequestAssignees?>? assignees,
    InlineObject69PullRequestAuthorAssociation? authorAssociation,
    InlineObject69PullRequestAutoMerge? Function()? autoMerge,
    InlineObject69PullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    InlineObject69PullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<InlineObject69PullRequestLabels>? labels,
    bool? locked,
    ...
    InlineObject69PullRequestMergedBy? Function()? mergedBy,
    InlineObject69PullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<InlineObject69PullRequestRequestedReviewers>? requestedReviewers,
    List<InlineObject69PullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    InlineObject69PullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    InlineObject69PullRequestUser? Function()? user,
  }) {
    return InlineObject69PullRequest(
