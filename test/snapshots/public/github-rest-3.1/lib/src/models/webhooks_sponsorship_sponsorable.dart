...
import 'webhooks_sponsorship_sponsorable_type.dart';

final class WebhooksSponsorshipSponsorable {
  const WebhooksSponsorshipSponsorable({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksSponsorshipSponsorable.fromJson(Map<String, dynamic> json) {
    return WebhooksSponsorshipSponsorable(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksSponsorshipSponsorableType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksSponsorshipSponsorable copyWith({
    ...
    WebhooksSponsorshipSponsorableType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksSponsorshipSponsorable(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
