...
import 'webhook_pull_request_review_comment_deleted_pull_request_user_type.dart';
...
final class WebhookPullRequestReviewCommentDeletedPullRequestUser {
  ...
  factory WebhookPullRequestReviewCommentDeletedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentDeletedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentDeletedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewCommentDeletedPullRequestUser copyWith({
    ...
    WebhookPullRequestReviewCommentDeletedPullRequestUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewCommentDeletedPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
