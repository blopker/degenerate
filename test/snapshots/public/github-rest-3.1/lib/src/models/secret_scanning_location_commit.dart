...
final class SecretScanningLocationCommit {
  ...
  SecretScanningLocationCommit copyWith({
    String? path,
    double? startLine,
    double? endLine,
    double? startColumn,
  ...
  @override
  String toString() {
    return 'SecretScanningLocationCommit(path: $path, startLine: $startLine, endLine: $endLine, startColumn: $startColumn, endColumn: $endColumn, blobSha: $blobSha, blobUrl: $blobUrl, commitSha: $commitSha, commitUrl: $commitUrl)';
  }
}
