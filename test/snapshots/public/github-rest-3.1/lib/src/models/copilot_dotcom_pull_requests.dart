...
import 'copilot_dotcom_pull_requests_repositories.dart';

/// Usage metrics for Copilot for pull requests.
final class CopilotDotcomPullRequests {
  const CopilotDotcomPullRequests({this.totalEngagedUsers, this.repositories});
  ...
  factory CopilotDotcomPullRequests.fromJson(Map<String, dynamic> json) {
    return CopilotDotcomPullRequests(
      ...
      repositories: (json['repositories'] as List<dynamic>?)
          ?.map(
            (e) => CopilotDotcomPullRequestsRepositories.fromJson(
  ...
  CopilotDotcomPullRequests copyWith({
    int Function()? totalEngagedUsers,
    List<CopilotDotcomPullRequestsRepositories> Function()? repositories,
  }) {
    return CopilotDotcomPullRequests(
  ...
  @override
  String toString() {
    return 'CopilotDotcomPullRequests(totalEngagedUsers: $totalEngagedUsers, repositories: $repositories)';
  }
}
