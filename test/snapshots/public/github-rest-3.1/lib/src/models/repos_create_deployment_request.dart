...
import 'repos_create_deployment_request_payload.dart';

final class ReposCreateDeploymentRequest {
  ...
  factory ReposCreateDeploymentRequest.fromJson(Map<String, dynamic> json) {
    return ReposCreateDeploymentRequest(
      ...
      autoMerge: json.containsKey('auto_merge')
          ? json['auto_merge'] as bool
          : true,
      requiredContexts: (json['required_contexts'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      ...
      description: json.containsKey('description')
          ...
          : '',
      transientEnvironment: json.containsKey('transient_environment')
          ? json['transient_environment'] as bool
          : false,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('ref') && json['ref'] is String;
  }

  ReposCreateDeploymentRequest copyWith({
    String? ref,
    String Function()? task,
    bool Function()? autoMerge,
    List<String> Function()? requiredContexts,
    ReposCreateDeploymentRequestPayload Function()? payload,
  ...
  int get hashCode {
    return Object.hash(
      ...
      task,
      autoMerge,
      Object.hashAll(requiredContexts ?? const []),
      payload,
      environment,
      description,
      transientEnvironment,
  ...
  @override
  String toString() {
    return 'ReposCreateDeploymentRequest(ref: $ref, task: $task, autoMerge: $autoMerge, requiredContexts: $requiredContexts, payload: $payload, environment: $environment, description: $description, transientEnvironment: $transientEnvironment, productionEnvironment: $productionEnvironment)';
  }
}
