...
import 'classroom_assignment_type.dart';
import 'simple_classroom_repository.dart';

/// A GitHub Classroom assignment
final class ClassroomAssignment {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('max_teams') &&
        json['max_teams'] is num &&
        json.containsKey('max_members') &&
        json['max_members'] is num &&
  ...
  ClassroomAssignment copyWith({
    ...
    return ClassroomAssignment(
      ...
      starterCodeRepository:
          starterCodeRepository ?? this.starterCodeRepository,
