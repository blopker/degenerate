...
import 'inline_object66_pull_request_head_repo_owner_type.dart';

final class InlineObject66PullRequestHeadRepoOwner {
  const InlineObject66PullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestHeadRepoOwner copyWith({
    ...
    InlineObject66PullRequestHeadRepoOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject66PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
