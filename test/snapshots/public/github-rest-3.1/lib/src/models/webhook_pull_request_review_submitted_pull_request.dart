...
import 'webhook_pull_request_review_submitted_pull_request_active_lock_reason.dart';
import 'webhook_pull_request_review_submitted_pull_request_assignee.dart';
import 'webhook_pull_request_review_submitted_pull_request_assignees.dart';
import 'webhook_pull_request_review_submitted_pull_request_author_association.dart';
import 'webhook_pull_request_review_submitted_pull_request_auto_merge.dart';
import 'webhook_pull_request_review_submitted_pull_request_base.dart';
import 'webhook_pull_request_review_submitted_pull_request_head.dart';
import 'webhook_pull_request_review_submitted_pull_request_labels.dart';
import 'webhook_pull_request_review_submitted_pull_request_links.dart';
import 'webhook_pull_request_review_submitted_pull_request_milestone.dart';
import 'webhook_pull_request_review_submitted_pull_request_requested_reviewers.dart';
import 'webhook_pull_request_review_submitted_pull_request_requested_teams.dart';
import 'webhook_pull_request_review_submitted_pull_request_state.dart';
import 'webhook_pull_request_review_submitted_pull_request_user.dart';

final class WebhookPullRequestReviewSubmittedPullRequest {
  const WebhookPullRequestReviewSubmittedPullRequest({
    required this.links,
  ...
  factory WebhookPullRequestReviewSubmittedPullRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewSubmittedPullRequest(
      links: WebhookPullRequestReviewSubmittedPullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason:
          WebhookPullRequestReviewSubmittedPullRequestActiveLockReason.fromJson(
            json['active_lock_reason'] as String,
          ),
      assignee: WebhookPullRequestReviewSubmittedPullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestReviewSubmittedPullRequestAssignees.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      authorAssociation:
          WebhookPullRequestReviewSubmittedPullRequestAuthorAssociation.fromJson(
            json['author_association'] as String,
          ),
      autoMerge: WebhookPullRequestReviewSubmittedPullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: WebhookPullRequestReviewSubmittedPullRequestBase.fromJson(
      ...
      head: WebhookPullRequestReviewSubmittedPullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestReviewSubmittedPullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      milestone: WebhookPullRequestReviewSubmittedPullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestReviewSubmittedPullRequestRequestedReviewers.fromJson(
                  e,
                ),
          )
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestReviewSubmittedPullRequestRequestedTeams.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      ...
      state: WebhookPullRequestReviewSubmittedPullRequestState.fromJson(
      ...
      user: WebhookPullRequestReviewSubmittedPullRequestUser.fromJson(
  ...
  final WebhookPullRequestReviewSubmittedPullRequestActiveLockReason?
  activeLockReason;
  ...
  final WebhookPullRequestReviewSubmittedPullRequestAuthorAssociation
  authorAssociation;
  ...
  final List<WebhookPullRequestReviewSubmittedPullRequestRequestedReviewers>
  requestedReviewers;

  final List<WebhookPullRequestReviewSubmittedPullRequestRequestedTeams>
  requestedTeams;
  ...
  WebhookPullRequestReviewSubmittedPullRequest copyWith({
    WebhookPullRequestReviewSubmittedPullRequestLinks? links,
    WebhookPullRequestReviewSubmittedPullRequestActiveLockReason? Function()?
    activeLockReason,
    WebhookPullRequestReviewSubmittedPullRequestAssignee? Function()? assignee,
    List<WebhookPullRequestReviewSubmittedPullRequestAssignees?>? assignees,
    WebhookPullRequestReviewSubmittedPullRequestAuthorAssociation?
    authorAssociation,
    WebhookPullRequestReviewSubmittedPullRequestAutoMerge? Function()?
    autoMerge,
    WebhookPullRequestReviewSubmittedPullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    WebhookPullRequestReviewSubmittedPullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<WebhookPullRequestReviewSubmittedPullRequestLabels>? labels,
    bool? locked,
    String? Function()? mergeCommitSha,
    String? Function()? mergedAt,
    WebhookPullRequestReviewSubmittedPullRequestMilestone? Function()?
    milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    List<WebhookPullRequestReviewSubmittedPullRequestRequestedReviewers>?
    requestedReviewers,
    List<WebhookPullRequestReviewSubmittedPullRequestRequestedTeams>?
    requestedTeams,
    String? reviewCommentUrl,
    Uri? reviewCommentsUrl,
    WebhookPullRequestReviewSubmittedPullRequestState? state,
    Uri? statusesUrl,
    String? title,
    String? updatedAt,
    Uri? url,
    WebhookPullRequestReviewSubmittedPullRequestUser? Function()? user,
  }) {
    return WebhookPullRequestReviewSubmittedPullRequest(
