...
import 'inline_object70_type.dart';

final class InlineObject70 {
  const InlineObject70({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject70.fromJson(Map<String, dynamic> json) {
    return InlineObject70(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject70Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject70 copyWith({
    ...
    InlineObject70Type Function()? type,
    Uri Function()? url,
