...
import 'network_configuration_compute_service.dart';
...
final class NetworkConfiguration {
  const NetworkConfiguration({
    ...
    this.failoverNetworkSettingsIds,
    this.failoverNetworkEnabled,
  ...
  factory NetworkConfiguration.fromJson(Map<String, dynamic> json) {
    return NetworkConfiguration(
      ...
      computeService: json['compute_service'] != null
          ? NetworkConfigurationComputeService.fromJson(
              json['compute_service'] as String,
            )
          : null,
      networkSettingsIds: (json['network_settings_ids'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      failoverNetworkSettingsIds:
          (json['failover_network_settings_ids'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
  ...
  NetworkConfiguration copyWith({
    String? id,
    String? name,
    NetworkConfigurationComputeService Function()? computeService,
    List<String> Function()? networkSettingsIds,
    List<String> Function()? failoverNetworkSettingsIds,
    bool Function()? failoverNetworkEnabled,
    ...
    return NetworkConfiguration(
      ...
      computeService: computeService != null
          ? computeService()
          : this.computeService,
      networkSettingsIds: networkSettingsIds != null
          ? networkSettingsIds()
          : this.networkSettingsIds,
      failoverNetworkSettingsIds: failoverNetworkSettingsIds != null
          ? failoverNetworkSettingsIds()
          : this.failoverNetworkSettingsIds,
      failoverNetworkEnabled: failoverNetworkEnabled != null
    ...
    return identical(this, other) ||
        other is NetworkConfiguration &&
            ...
            const ListEquality<dynamic>().equals(
              networkSettingsIds,
              other.networkSettingsIds,
            ) &&
            const ListEquality<dynamic>().equals(
              failoverNetworkSettingsIds,
              other.failoverNetworkSettingsIds,
            ) &&
  ...
  int get hashCode {
    return Object.hash(
      ...
      name,
      computeService,
      Object.hashAll(networkSettingsIds ?? const []),
      Object.hashAll(failoverNetworkSettingsIds ?? const []),
      failoverNetworkEnabled,
      createdOn,
    );
  }
  ...
  @override
  String toString() {
    return 'NetworkConfiguration(id: $id, name: $name, computeService: $computeService, networkSettingsIds: $networkSettingsIds, failoverNetworkSettingsIds: $failoverNetworkSettingsIds, failoverNetworkEnabled: $failoverNetworkEnabled, createdOn: $createdOn)';
  }
}
