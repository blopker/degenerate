...
final class MergeGroup {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('head_sha') &&
        json['head_sha'] is String &&
        json.containsKey('head_ref') &&
        json['head_ref'] is String &&
        json.containsKey('base_sha') &&
        json['base_sha'] is String &&
  ...
  @override
  int get hashCode {
    return Object.hash(headSha, headRef, baseSha, baseRef, headCommit);
  }

  @override
  String toString() {
    return 'MergeGroup(headSha: $headSha, headRef: $headRef, baseSha: $baseSha, baseRef: $baseRef, headCommit: $headCommit)';
  }
}
