...
import 'webhooks_alert_dismisser.dart';
import 'webhooks_alert_state.dart';

/// The security alert of the vulnerable dependency.
final class WebhooksAlert {
  const WebhooksAlert({
    required this.affectedPackageName,
  ...
  factory WebhooksAlert.fromJson(Map<String, dynamic> json) {
    return WebhooksAlert(
      ...
      dismisser: json['dismisser'] != null
          ? WebhooksAlertDismisser.fromJson(
              json['dismisser'] as Map<String, dynamic>,
            )
          : null,
      externalIdentifier: json['external_identifier'] as String,
      externalReference: Uri.parse(json['external_reference'] as String),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('affected_package_name') &&
        json['affected_package_name'] is String &&
        json.containsKey('affected_range') &&
        json['affected_range'] is String &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('external_identifier') &&
        json['external_identifier'] is String &&
        json.containsKey('external_reference') &&
        json['external_reference'] is String &&
  ...
  WebhooksAlert copyWith({
    String? affectedPackageName,
    String? affectedRange,
    String? createdAt,
    String Function()? dismissReason,
    String Function()? dismissedAt,
    WebhooksAlertDismisser? Function()? dismisser,
    String? externalIdentifier,
    Uri? Function()? externalReference,
    String Function()? fixReason,
    DateTime Function()? fixedAt,
    String Function()? fixedIn,
    String? ghsaId,
    int? id,
    String? nodeId,
    int? number,
    String? severity,
    WebhooksAlertState? state,
  }) {
    return WebhooksAlert(
