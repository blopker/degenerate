...
import 'webhooks_alert_dismisser.dart';import 'webhooks_alert_state.dart';/// The security alert of the vulnerable dependency.
...
factory WebhooksAlert.fromJson(Map<String, dynamic> json) { return WebhooksAlert(
  ...
  dismisser: json['dismisser'] != null
        ? WebhooksAlertDismisser.fromJson(json['dismisser'] as Map<String, dynamic>)
        : null,
