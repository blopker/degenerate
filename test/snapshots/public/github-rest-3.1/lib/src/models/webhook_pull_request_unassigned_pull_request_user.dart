...
import 'webhook_pull_request_unassigned_pull_request_user_type.dart';

final class WebhookPullRequestUnassignedPullRequestUser {
  const WebhookPullRequestUnassignedPullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestUser copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestUserType Function()? type,
    Uri Function()? url,
