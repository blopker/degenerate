...
import 'webhook_pull_request_locked_pull_request_head_user_type.dart';

final class WebhookPullRequestLockedPullRequestHeadUser {
  const WebhookPullRequestLockedPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestLockedPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestLockedPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestLockedPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestLockedPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestLockedPullRequestHeadUserType Function()? type,
    Uri Function()? url,
