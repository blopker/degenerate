...
final class GitUpdateRefRequest {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('sha') && json['sha'] is String;
  }

  GitUpdateRefRequest copyWith({String? sha, bool Function()? force}) {
    return GitUpdateRefRequest(
      sha: sha ?? this.sha,
  ...
  @override
  int get hashCode {
    return Object.hash(sha, force);
  }

  @override
  String toString() {
    return 'GitUpdateRefRequest(sha: $sha, force: $force)';
  }
}
