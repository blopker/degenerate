...
import 'inline_object79_type.dart';

final class InlineObject79 {
  const InlineObject79({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject79.fromJson(Map<String, dynamic> json) {
    return InlineObject79(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject79Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject79 copyWith({
    ...
    InlineObject79Type Function()? type,
    Uri Function()? url,
