...
import 'package:collection/collection.dart';import 'actions_create_org_variable_request_visibility.dart';final class ActionsCreateOrgVariableRequest {const ActionsCreateOrgVariableRequest({required this.name, required this.value, required this.visibility, this.selectedRepositoryIds, });
