...
final class ThreadSubject {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('title') &&
        ...
        json['url'] is String &&
        json.containsKey('latest_comment_url') &&
        json['latest_comment_url'] is String &&
        json.containsKey('type') &&
        json['type'] is String;
  }

  ThreadSubject copyWith({
    String? title,
    String? url,
  ...
  @override
  int get hashCode {
    return Object.hash(title, url, latestCommentUrl, type);
  }
