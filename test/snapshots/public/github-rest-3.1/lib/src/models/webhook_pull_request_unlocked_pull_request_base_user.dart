...
import 'webhook_pull_request_unlocked_pull_request_base_user_type.dart';

final class WebhookPullRequestUnlockedPullRequestBaseUser {
  const WebhookPullRequestUnlockedPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlockedPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlockedPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlockedPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlockedPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestUnlockedPullRequestBaseUserType Function()? type,
    Uri Function()? url,
