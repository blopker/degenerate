...
import 'webhook_release_prereleased_release_author_type.dart';

final class WebhookReleasePrereleasedReleaseAuthor {
  const WebhookReleasePrereleasedReleaseAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookReleasePrereleasedReleaseAuthor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookReleasePrereleasedReleaseAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookReleasePrereleasedReleaseAuthorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookReleasePrereleasedReleaseAuthor copyWith({
    ...
    WebhookReleasePrereleasedReleaseAuthorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookReleasePrereleasedReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
