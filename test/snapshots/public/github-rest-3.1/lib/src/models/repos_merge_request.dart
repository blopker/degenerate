...
final class ReposMergeRequest {
  ...
  @override
  int get hashCode {
    return Object.hash(base, head, commitMessage);
  }

  @override
  String toString() {
    return 'ReposMergeRequest(base: $base, head: $head, commitMessage: $commitMessage)';
  }
}
