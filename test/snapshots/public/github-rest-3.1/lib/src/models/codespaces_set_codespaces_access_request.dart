...
import 'package:collection/collection.dart';import 'codespaces_set_codespaces_access_request_visibility.dart';final class CodespacesSetCodespacesAccessRequest {const CodespacesSetCodespacesAccessRequest({required this.visibility, this.selectedUsernames, });
