...
import 'inline_object59_type.dart';

final class InlineObject59 {
  const InlineObject59({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject59.fromJson(Map<String, dynamic> json) {
    return InlineObject59(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject59Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject59 copyWith({
    ...
    InlineObject59Type Function()? type,
    Uri Function()? url,
