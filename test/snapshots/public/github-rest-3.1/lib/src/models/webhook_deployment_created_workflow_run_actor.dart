...
import 'webhook_deployment_created_workflow_run_actor_type.dart';

final class WebhookDeploymentCreatedWorkflowRunActor {
  const WebhookDeploymentCreatedWorkflowRunActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentCreatedWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentCreatedWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentCreatedWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentCreatedWorkflowRunActor copyWith({
    ...
    WebhookDeploymentCreatedWorkflowRunActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentCreatedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
