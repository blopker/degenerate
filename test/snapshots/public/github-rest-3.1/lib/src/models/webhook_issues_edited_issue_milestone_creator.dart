...
import 'webhook_issues_edited_issue_milestone_creator_type.dart';
...
final class WebhookIssuesEditedIssueMilestoneCreator {
  ...
  factory WebhookIssuesEditedIssueMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesEditedIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesEditedIssueMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesEditedIssueMilestoneCreator copyWith({
    ...
    WebhookIssuesEditedIssueMilestoneCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesEditedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
