...
final class SecretScanningScan {
  ...
  @override
  int get hashCode {
    return Object.hash(type, status, completedAt, startedAt);
  }

  @override
  String toString() {
    return 'SecretScanningScan(type: $type, status: $status, completedAt: $completedAt, startedAt: $startedAt)';
  }
}
