...
final class PullsCreateRequest {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('head') &&
        json['head'] is String &&
        json.containsKey('base') &&
        json['base'] is String;
  }

  PullsCreateRequest copyWith({
    String Function()? title,
    String? head,
    String Function()? headRepo,
    String? base,
  ...
  @override
  String toString() {
    return 'PullsCreateRequest(title: $title, head: $head, headRepo: $headRepo, base: $base, body: $body, maintainerCanModify: $maintainerCanModify, draft: $draft, issue: $issue)';
  }
}
