...
import 'webhook_package_updated_package_package_version_author_type.dart';

final class WebhookPackageUpdatedPackagePackageVersionAuthor {
  const WebhookPackageUpdatedPackagePackageVersionAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackageUpdatedPackagePackageVersionAuthor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackageUpdatedPackagePackageVersionAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackageUpdatedPackagePackageVersionAuthorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackageUpdatedPackagePackageVersionAuthor copyWith({
    ...
    WebhookPackageUpdatedPackagePackageVersionAuthorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPackageUpdatedPackagePackageVersionAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
