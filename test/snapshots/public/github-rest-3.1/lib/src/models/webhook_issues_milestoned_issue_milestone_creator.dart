...
import 'webhook_issues_milestoned_issue_milestone_creator_type.dart';

final class WebhookIssuesMilestonedIssueMilestoneCreator {
  const WebhookIssuesMilestonedIssueMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesMilestonedIssueMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesMilestonedIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesMilestonedIssueMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesMilestonedIssueMilestoneCreator copyWith({
    ...
    WebhookIssuesMilestonedIssueMilestoneCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesMilestonedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
