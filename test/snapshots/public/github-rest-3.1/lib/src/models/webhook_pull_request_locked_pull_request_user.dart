...
import 'webhook_pull_request_locked_pull_request_user_type.dart';
...
final class WebhookPullRequestLockedPullRequestUser {
  ...
  factory WebhookPullRequestLockedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestLockedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestLockedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestLockedPullRequestUser copyWith({
    ...
    WebhookPullRequestLockedPullRequestUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestLockedPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
