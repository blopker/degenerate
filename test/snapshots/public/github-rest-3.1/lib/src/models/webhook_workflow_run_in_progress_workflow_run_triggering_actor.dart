...
import 'webhook_workflow_run_in_progress_workflow_run_triggering_actor_type.dart';

final class WebhookWorkflowRunInProgressWorkflowRunTriggeringActor {
  const WebhookWorkflowRunInProgressWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookWorkflowRunInProgressWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunInProgressWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunInProgressWorkflowRunTriggeringActor copyWith({
    ...
    WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookWorkflowRunInProgressWorkflowRunTriggeringActor(
