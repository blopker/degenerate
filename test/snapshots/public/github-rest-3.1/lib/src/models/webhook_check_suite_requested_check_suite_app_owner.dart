...
import 'webhook_check_suite_requested_check_suite_app_owner_type.dart';

final class WebhookCheckSuiteRequestedCheckSuiteAppOwner {
  const WebhookCheckSuiteRequestedCheckSuiteAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCheckSuiteRequestedCheckSuiteAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCheckSuiteRequestedCheckSuiteAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCheckSuiteRequestedCheckSuiteAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCheckSuiteRequestedCheckSuiteAppOwner copyWith({
    ...
    WebhookCheckSuiteRequestedCheckSuiteAppOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookCheckSuiteRequestedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
