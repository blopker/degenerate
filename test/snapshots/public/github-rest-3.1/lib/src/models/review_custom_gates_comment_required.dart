...
final class ReviewCustomGatesCommentRequired {
  ...
  ReviewCustomGatesCommentRequired copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(environmentName, comment);
  }

  @override
  String toString() {
    return 'ReviewCustomGatesCommentRequired(environmentName: $environmentName, comment: $comment)';
  }
}
