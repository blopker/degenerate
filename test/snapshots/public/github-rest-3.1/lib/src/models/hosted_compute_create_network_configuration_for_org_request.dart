...
import 'hosted_compute_create_network_configuration_for_org_request_compute_service.dart';

final class HostedComputeCreateNetworkConfigurationForOrgRequest {
  ...
  factory HostedComputeCreateNetworkConfigurationForOrgRequest.fromJson(
    ...
    return HostedComputeCreateNetworkConfigurationForOrgRequest(
      name: json['name'] as String,
      computeService: json['compute_service'] != null
          ? HostedComputeCreateNetworkConfigurationForOrgRequestComputeService.fromJson(
  ...
  HostedComputeCreateNetworkConfigurationForOrgRequest copyWith({
    String? name,
    HostedComputeCreateNetworkConfigurationForOrgRequestComputeService
    Function()?
    computeService,
    List<String>? networkSettingsIds,
  }) {
    return HostedComputeCreateNetworkConfigurationForOrgRequest(
      name: name ?? this.name,
  ...
  int get hashCode {
    return Object.hash(
      name,
      computeService,
      Object.hashAll(networkSettingsIds),
    );
  }

  @override
  String toString() {
    return 'HostedComputeCreateNetworkConfigurationForOrgRequest(name: $name, computeService: $computeService, networkSettingsIds: $networkSettingsIds)';
  }
}
