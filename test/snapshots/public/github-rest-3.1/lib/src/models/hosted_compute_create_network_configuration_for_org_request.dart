...
import 'package:collection/collection.dart';import 'hosted_compute_create_network_configuration_for_org_request_compute_service.dart';final class HostedComputeCreateNetworkConfigurationForOrgRequest {const HostedComputeCreateNetworkConfigurationForOrgRequest({required this.name, this.computeService, required this.networkSettingsIds, });
