...
import 'webhook_pull_request_review_edited_pull_request_milestone_creator_type.dart';
...
final class WebhookPullRequestReviewEditedPullRequestMilestoneCreator {
  ...
  factory WebhookPullRequestReviewEditedPullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewEditedPullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewEditedPullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewEditedPullRequestMilestoneCreator copyWith({
    ...
    WebhookPullRequestReviewEditedPullRequestMilestoneCreatorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewEditedPullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
