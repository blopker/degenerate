...
import 'content_file_links.dart';
import 'content_file_type.dart';
...
final class ContentFile {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        json.containsKey('encoding') &&
        json['encoding'] is String &&
  ...
  ContentFile copyWith({
    ...
    ContentFileLinks? links,
    String Function()? target,
    String Function()? submoduleGitUrl,
  }) {
    return ContentFile(
      type: type ?? this.type,
      ...
      submoduleGitUrl: submoduleGitUrl != null
          ? submoduleGitUrl()
          : this.submoduleGitUrl,
    );
  }
