...
import 'inline_object66_pull_request_active_lock_reason.dart';
import 'inline_object66_pull_request_assignee.dart';
import 'inline_object66_pull_request_assignees.dart';
import 'inline_object66_pull_request_author_association.dart';
import 'inline_object66_pull_request_auto_merge.dart';
import 'inline_object66_pull_request_base.dart';
import 'inline_object66_pull_request_head.dart';
import 'inline_object66_pull_request_labels.dart';
import 'inline_object66_pull_request_links.dart';
import 'inline_object66_pull_request_merged_by.dart';
import 'inline_object66_pull_request_milestone.dart';
import 'inline_object66_pull_request_requested_reviewers.dart';
import 'inline_object66_pull_request_requested_teams.dart';
import 'inline_object66_pull_request_state.dart';
import 'inline_object66_pull_request_user.dart';

final class InlineObject66PullRequest {
  const InlineObject66PullRequest({
    required this.links,
  ...
  factory InlineObject66PullRequest.fromJson(Map<String, dynamic> json) {
    return InlineObject66PullRequest(
      links: InlineObject66PullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason: InlineObject66PullRequestActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: InlineObject66PullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => InlineObject66PullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: InlineObject66PullRequestAuthorAssociation.fromJson(
        json['author_association'] as String,
      ),
      autoMerge: InlineObject66PullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: InlineObject66PullRequestBase.fromJson(
      ...
      head: InlineObject66PullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => InlineObject66PullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? InlineObject66PullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: InlineObject66PullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map((e) => InlineObject66PullRequestRequestedReviewers.fromJson(e))
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => InlineObject66PullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      user: InlineObject66PullRequestUser.fromJson(
  ...
  InlineObject66PullRequest copyWith({
    InlineObject66PullRequestLinks? links,
    InlineObject66PullRequestActiveLockReason? Function()? activeLockReason,
    int Function()? additions,
    InlineObject66PullRequestAssignee? Function()? assignee,
    List<InlineObject66PullRequestAssignees?>? assignees,
    InlineObject66PullRequestAuthorAssociation? authorAssociation,
    InlineObject66PullRequestAutoMerge? Function()? autoMerge,
    InlineObject66PullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    InlineObject66PullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<InlineObject66PullRequestLabels>? labels,
    bool? locked,
    ...
    InlineObject66PullRequestMergedBy? Function()? mergedBy,
    InlineObject66PullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<InlineObject66PullRequestRequestedReviewers>? requestedReviewers,
    List<InlineObject66PullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    InlineObject66PullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    InlineObject66PullRequestUser? Function()? user,
  }) {
    return InlineObject66PullRequest(
