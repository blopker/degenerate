...
final class ImportStatus {
  ...
  static const ImportStatus detectionFoundMultiple = ImportStatus._(
    'detection_found_multiple',
  );

  static const ImportStatus detectionFoundNothing = ImportStatus._(
    'detection_found_nothing',
  );

  static const ImportStatus detectionNeedsAuth = ImportStatus._(
    'detection_needs_auth',
  );

  static const List<ImportStatus> values = [
    auth,
    error,
    none,
    detecting,
