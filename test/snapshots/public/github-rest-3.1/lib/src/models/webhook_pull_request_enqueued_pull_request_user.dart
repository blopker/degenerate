...
import 'webhook_pull_request_enqueued_pull_request_user_type.dart';

final class WebhookPullRequestEnqueuedPullRequestUser {
  const WebhookPullRequestEnqueuedPullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestEnqueuedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestEnqueuedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestEnqueuedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestEnqueuedPullRequestUser copyWith({
    ...
    WebhookPullRequestEnqueuedPullRequestUserType Function()? type,
    Uri Function()? url,
