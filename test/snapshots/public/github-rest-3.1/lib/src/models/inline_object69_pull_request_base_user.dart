...
import 'inline_object69_pull_request_base_user_type.dart';

final class InlineObject69PullRequestBaseUser {
  const InlineObject69PullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestBaseUser copyWith({
    ...
    InlineObject69PullRequestBaseUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69PullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
