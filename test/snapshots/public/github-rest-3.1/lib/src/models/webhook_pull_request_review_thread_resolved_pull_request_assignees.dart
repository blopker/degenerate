...
import 'webhook_pull_request_review_thread_resolved_pull_request_assignees_type.dart';

final class WebhookPullRequestReviewThreadResolvedPullRequestAssignees {
  const WebhookPullRequestReviewThreadResolvedPullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadResolvedPullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadResolvedPullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewThreadResolvedPullRequestAssignees copyWith({
    ...
    WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType Function()?
    type,
    Uri Function()? url,
  }) {
    return WebhookPullRequestReviewThreadResolvedPullRequestAssignees(
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadResolvedPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
