...
import 'webhook_pull_request_unassigned_pull_request_base_user_type.dart';

final class WebhookPullRequestUnassignedPullRequestBaseUser {
  const WebhookPullRequestUnassignedPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestBaseUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestUnassignedPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
