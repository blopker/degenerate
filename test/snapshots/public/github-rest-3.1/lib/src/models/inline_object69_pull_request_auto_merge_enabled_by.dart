...
import 'inline_object69_pull_request_auto_merge_enabled_by_type.dart';

final class InlineObject69PullRequestAutoMergeEnabledBy {
  const InlineObject69PullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestAutoMergeEnabledBy copyWith({
    ...
    InlineObject69PullRequestAutoMergeEnabledByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69PullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
