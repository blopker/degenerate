...
import 'issues_create_request_labels.dart';
import 'issues_create_request_milestone.dart';
import 'issues_create_request_title.dart';

final class IssuesCreateRequest {
  ...
  factory IssuesCreateRequest.fromJson(Map<String, dynamic> json) {
    return IssuesCreateRequest(
      ...
      labels: (json['labels'] as List<dynamic>?)
          ?.map((e) => IssuesCreateRequestLabels.fromJson(e))
          .toList(),
  ...
  IssuesCreateRequest copyWith({
    IssuesCreateRequestTitle? title,
    String Function()? body,
    String? Function()? assignee,
    IssuesCreateRequestMilestone? Function()? milestone,
    List<IssuesCreateRequestLabels> Function()? labels,
  ...
  @override
  String toString() {
    return 'IssuesCreateRequest(title: $title, body: $body, assignee: $assignee, milestone: $milestone, labels: $labels, assignees: $assignees, type: $type)';
  }
}
