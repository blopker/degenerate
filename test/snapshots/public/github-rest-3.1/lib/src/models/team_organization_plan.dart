...
final class TeamOrganizationPlan {
  ...
  factory TeamOrganizationPlan.fromJson(Map<String, dynamic> json) {
    return TeamOrganizationPlan(
      ...
      filledSeats: json['filled_seats'] != null
          ? (json['filled_seats'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        ...
        json['space'] is num &&
        json.containsKey('private_repos') &&
        json['private_repos'] is num;
  }

  TeamOrganizationPlan copyWith({
    String? name,
    int? space,
    int? privateRepos,
    int Function()? filledSeats,
    int Function()? seats,
  }) {
    return TeamOrganizationPlan(
      name: name ?? this.name,
  ...
  @override
  int get hashCode {
    return Object.hash(name, space, privateRepos, filledSeats, seats);
  }

  @override
  String toString() {
    return 'TeamOrganizationPlan(name: $name, space: $space, privateRepos: $privateRepos, filledSeats: $filledSeats, seats: $seats)';
  }
}
