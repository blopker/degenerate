...
import 'webhook_pull_request_assigned_pull_request_assignee_type.dart';

final class WebhookPullRequestAssignedPullRequestAssignee {
  const WebhookPullRequestAssignedPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAssignedPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAssignedPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAssignedPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAssignedPullRequestAssignee copyWith({
    ...
    WebhookPullRequestAssignedPullRequestAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAssignedPullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
