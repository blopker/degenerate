...
import 'webhooks_pull_request5_user_type.dart';

final class WebhooksPullRequest5User {
  const WebhooksPullRequest5User({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5User.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5User(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5UserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksPullRequest5User copyWith({
    ...
    WebhooksPullRequest5UserType Function()? type,
    Uri Function()? url,
