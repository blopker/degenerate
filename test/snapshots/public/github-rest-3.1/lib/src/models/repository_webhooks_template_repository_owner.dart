...
final class RepositoryWebhooksTemplateRepositoryOwner {
  const RepositoryWebhooksTemplateRepositoryOwner({
    this.login,
    this.id,
    this.nodeId,
    this.avatarUrl,
  ...
  factory RepositoryWebhooksTemplateRepositoryOwner.fromJson(
  ...
  RepositoryWebhooksTemplateRepositoryOwner copyWith({
