...
import 'repository_rule_commit_author_email_pattern_parameters_operator.dart';final class RepositoryRuleCommitAuthorEmailPatternParameters {const RepositoryRuleCommitAuthorEmailPatternParameters({this.name, this.negate, required this.$operator, required this.pattern, });
