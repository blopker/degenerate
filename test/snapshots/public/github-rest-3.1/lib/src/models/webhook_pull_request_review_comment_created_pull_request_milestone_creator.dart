...
import 'webhook_pull_request_review_comment_created_pull_request_milestone_creator_type.dart';

final class WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator {
  const WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorType?
  type;
  ...
  WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator copyWith({
    ...
    WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreatorType
    Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewCommentCreatedPullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
