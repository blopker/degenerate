...
import 'inline_object53_type.dart';

final class InlineObject53 {
  const InlineObject53({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject53.fromJson(Map<String, dynamic> json) {
    return InlineObject53(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject53Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject53 copyWith({
    ...
    InlineObject53Type Function()? type,
    Uri Function()? url,
