...
import 'webhook_team_edited_repository_created_at.dart';
import 'webhook_team_edited_repository_license.dart';
import 'webhook_team_edited_repository_owner.dart';
import 'webhook_team_edited_repository_permissions.dart';
import 'webhook_team_edited_repository_pushed_at.dart';
import 'webhook_team_edited_repository_visibility.dart';

/// A git repository
final class WebhookTeamEditedRepository {
  const WebhookTeamEditedRepository({
  ...
  factory WebhookTeamEditedRepository.fromJson(Map<String, dynamic> json) {
    return WebhookTeamEditedRepository(
      ...
      createdAt: WebhookTeamEditedRepositoryCreatedAt.fromJson(
        json['created_at'],
      ),
      ...
      license: WebhookTeamEditedRepositoryLicense.fromJson(
      ...
      owner: WebhookTeamEditedRepositoryOwner.fromJson(
        json['owner'] as Map<String, dynamic>,
      ),
      permissions: json['permissions'] != null
          ? WebhookTeamEditedRepositoryPermissions.fromJson(
      ...
      pushedAt: WebhookTeamEditedRepositoryPushedAt.fromJson(json['pushed_at']),
      ...
      visibility: WebhookTeamEditedRepositoryVisibility.fromJson(
  ...
  final WebhookTeamEditedRepositoryCreatedAt createdAt;
  ...
  final WebhookTeamEditedRepositoryPushedAt? pushedAt;
  ...
  WebhookTeamEditedRepository copyWith({
    ...
    String? contentsUrl,
    Uri? contributorsUrl,
    WebhookTeamEditedRepositoryCreatedAt? createdAt,
    ...
    Uri? languagesUrl,
    WebhookTeamEditedRepositoryLicense? Function()? license,
    ...
    WebhookTeamEditedRepositoryOwner? Function()? owner,
    WebhookTeamEditedRepositoryPermissions Function()? permissions,
    bool? private,
    bool Function()? public,
    String? pullsUrl,
    WebhookTeamEditedRepositoryPushedAt? Function()? pushedAt,
    String? releasesUrl,
    ...
    DateTime? updatedAt,
    Uri? url,
    WebhookTeamEditedRepositoryVisibility? visibility,
    int? watchers,
    int? watchersCount,
  }) {
    return WebhookTeamEditedRepository(
