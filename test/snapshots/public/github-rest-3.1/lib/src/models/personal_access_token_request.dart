...
import 'personal_access_token_request_permissions_added.dart';
import 'personal_access_token_request_permissions_result.dart';
import 'personal_access_token_request_permissions_upgraded.dart';
import 'personal_access_token_request_repositories.dart';
import 'personal_access_token_request_repository_selection.dart';
import 'simple_user.dart';

/// Details of a Personal Access Token Request.
final class PersonalAccessTokenRequest {
  const PersonalAccessTokenRequest({
    required this.id,
    required this.owner,
    required this.permissionsAdded,
    required this.permissionsUpgraded,
  ...
  factory PersonalAccessTokenRequest.fromJson(Map<String, dynamic> json) {
    return PersonalAccessTokenRequest(
      id: (json['id'] as num).toInt(),
      owner: SimpleUser.fromJson(json['owner'] as Map<String, dynamic>),
      permissionsAdded: PersonalAccessTokenRequestPermissionsAdded.fromJson(
        json['permissions_added'] as Map<String, dynamic>,
      ),
      permissionsUpgraded:
          PersonalAccessTokenRequestPermissionsUpgraded.fromJson(
            json['permissions_upgraded'] as Map<String, dynamic>,
          ),
      permissionsResult: PersonalAccessTokenRequestPermissionsResult.fromJson(
        json['permissions_result'] as Map<String, dynamic>,
      ),
      repositorySelection:
          PersonalAccessTokenRequestRepositorySelection.fromJson(
      ...
      repositories: (json['repositories'] as List<dynamic>)
          .map(
            (e) => PersonalAccessTokenRequestRepositories.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('repository_count') &&
        json['repository_count'] is num &&
        json.containsKey('repositories') &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('token_id') &&
        json['token_id'] is num &&
        json.containsKey('token_name') &&
        json['token_name'] is String &&
        json.containsKey('token_expired') &&
        json['token_expired'] is bool &&
        json.containsKey('token_expires_at') &&
        json['token_expires_at'] is String &&
        json.containsKey('token_last_used_at') &&
        json['token_last_used_at'] is String;
  }

  PersonalAccessTokenRequest copyWith({
    int? id,
    SimpleUser? owner,
    ...
    PersonalAccessTokenRequestRepositorySelection? repositorySelection,
    int? Function()? repositoryCount,
    List<PersonalAccessTokenRequestRepositories>? Function()? repositories,
    String? createdAt,
    int? tokenId,
    String? tokenName,
    bool? tokenExpired,
    String? Function()? tokenExpiresAt,
    String? Function()? tokenLastUsedAt,
  }) {
    return PersonalAccessTokenRequest(
      id: id ?? this.id,
      ...
      repositoryCount: repositoryCount != null
          ? repositoryCount()
      ...
      tokenExpiresAt: tokenExpiresAt != null
          ? tokenExpiresAt()
          : this.tokenExpiresAt,
      tokenLastUsedAt: tokenLastUsedAt != null
          ? tokenLastUsedAt()
