...
import 'webhook_pull_request_review_comment_deleted_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
