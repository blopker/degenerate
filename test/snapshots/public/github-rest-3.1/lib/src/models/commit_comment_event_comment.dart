...
final class CommitCommentEventComment {
  const CommitCommentEventComment({
    this.htmlUrl,
    this.url,
    this.id,
    this.nodeId,
  ...
  factory CommitCommentEventComment.fromJson(Map<String, dynamic> json) {
    return CommitCommentEventComment(
  ...
  CommitCommentEventComment copyWith({
  ...
  @override
  String toString() {
    return 'CommitCommentEventComment(htmlUrl: $htmlUrl, url: $url, id: $id, nodeId: $nodeId, body: $body, path: $path, position: $position, line: $line, commitId: $commitId, user: $user, createdAt: $createdAt, updatedAt: $updatedAt, reactions: $reactions)';
  }
}
