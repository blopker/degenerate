...
import 'codespaces_org_secret_visibility.dart';
...
final class CodespacesOrgSecret {
  ...
  CodespacesOrgSecret copyWith({
    String? name,
    DateTime? createdAt,
    DateTime? updatedAt,
    CodespacesOrgSecretVisibility? visibility,
  ...
  @override
  String toString() {
    return 'CodespacesOrgSecret(name: $name, createdAt: $createdAt, updatedAt: $updatedAt, visibility: $visibility, selectedRepositoriesUrl: $selectedRepositoriesUrl)';
  }
}
