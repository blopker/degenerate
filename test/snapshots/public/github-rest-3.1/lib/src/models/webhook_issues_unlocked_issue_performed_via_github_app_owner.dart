...
import 'webhook_issues_unlocked_issue_performed_via_github_app_owner_type.dart';

final class WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner {
  const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType Function()? type,
    Uri Function()? url,
