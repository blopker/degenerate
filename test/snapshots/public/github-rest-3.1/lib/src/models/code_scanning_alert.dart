...
CodeScanningAlert copyWith({int? number, DateTime? createdAt, DateTime Function()? updatedAt, Uri? url, Uri? htmlUrl, Uri? instancesUrl, CodeScanningAlertState? Function()? state, DateTime? Function()? fixedAt, SimpleUser? Function()? dismissedBy, DateTime? Function()? dismissedAt, CodeScanningAlertDismissedReason? Function()? dismissedReason, String? Function()? dismissedComment, CodeScanningAlertRule? rule, CodeScanningAnalysisTool? tool, CodeScanningAlertInstance? mostRecentInstance, SimpleUser? Function()? dismissalApprovedBy, List<SimpleUser> Function()? assignees, }) { return CodeScanningAlert(
