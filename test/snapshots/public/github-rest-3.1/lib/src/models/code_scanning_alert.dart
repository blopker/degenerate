...
import 'code_scanning_alert_rule.dart';
...
final class CodeScanningAlert {
  ...
  factory CodeScanningAlert.fromJson(Map<String, dynamic> json) {
    return CodeScanningAlert(
      ...
      rule: CodeScanningAlertRule.fromJson(
