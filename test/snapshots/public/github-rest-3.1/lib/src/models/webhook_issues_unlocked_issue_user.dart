...
import 'webhook_issues_unlocked_issue_user_type.dart';

final class WebhookIssuesUnlockedIssueUser {
  const WebhookIssuesUnlockedIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesUnlockedIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesUnlockedIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesUnlockedIssueUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookIssuesUnlockedIssueUser copyWith({
    ...
    WebhookIssuesUnlockedIssueUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesUnlockedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
