...
import 'branch_restriction_policy_apps.dart';
import 'branch_restriction_policy_users.dart';
import 'team.dart';
...
final class BranchRestrictionPolicy {
  ...
  factory BranchRestrictionPolicy.fromJson(Map<String, dynamic> json) {
    return BranchRestrictionPolicy(
      ...
      users: (json['users'] as List<dynamic>)
          .map(
            (e) => BranchRestrictionPolicyUsers.fromJson(
      ...
      apps: (json['apps'] as List<dynamic>)
          .map(
            (e) =>
                BranchRestrictionPolicyApps.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        ...
        json.containsKey('apps_url') &&
        json['apps_url'] is String &&
        json.containsKey('users') &&
        json.containsKey('teams') &&
        json.containsKey('apps');
  }

  BranchRestrictionPolicy copyWith({
    Uri? url,
    Uri? usersUrl,
    Uri? teamsUrl,
    Uri? appsUrl,
