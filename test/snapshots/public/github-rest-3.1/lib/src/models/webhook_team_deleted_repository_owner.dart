...
final class WebhookTeamDeletedRepositoryOwner {
  const WebhookTeamDeletedRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookTeamDeletedRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookTeamDeletedRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookTeamDeletedRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookTeamDeletedRepositoryOwner copyWith({
    ...
    WebhookTeamDeletedRepositoryOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookTeamDeletedRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
