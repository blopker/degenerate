...
final class ImportProjectChoices {
  const ImportProjectChoices({this.vcs, this.tfvcProject, this.humanName});

  factory ImportProjectChoices.fromJson(Map<String, dynamic> json) {
  ...
  ImportProjectChoices copyWith({
    String Function()? vcs,
    String Function()? tfvcProject,
    String Function()? humanName,
  }) {
    return ImportProjectChoices(
  ...
  @override
  int get hashCode {
    return Object.hash(vcs, tfvcProject, humanName);
  }
