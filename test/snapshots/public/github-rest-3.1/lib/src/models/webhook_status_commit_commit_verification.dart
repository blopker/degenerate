...
import 'webhook_status_commit_commit_verification_reason.dart';final class WebhookStatusCommitCommitVerification {const WebhookStatusCommitCommitVerification({required this.payload, required this.reason, required this.signature, required this.verified, required this.verifiedAt, });
