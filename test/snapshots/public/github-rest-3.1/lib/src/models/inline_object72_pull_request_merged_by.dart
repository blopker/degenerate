...
import 'inline_object72_pull_request_merged_by_type.dart';

final class InlineObject72PullRequestMergedBy {
  const InlineObject72PullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestMergedBy copyWith({
    ...
    InlineObject72PullRequestMergedByType Function()? type,
    Uri Function()? url,
