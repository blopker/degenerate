...
import 'orgs_review_pat_grant_request_request_action.dart';final class OrgsReviewPatGrantRequestRequest {const OrgsReviewPatGrantRequestRequest({required this.action, this.reason, });
