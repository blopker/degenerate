...
final class RepositoryRuleUpdateParameters {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('update_allows_fetch_and_merge') &&
        json['update_allows_fetch_and_merge'] is bool;
  }

  RepositoryRuleUpdateParameters copyWith({bool? updateAllowsFetchAndMerge}) {
    return RepositoryRuleUpdateParameters(
      updateAllowsFetchAndMerge:
          updateAllowsFetchAndMerge ?? this.updateAllowsFetchAndMerge,
    );
  }
  ...
  @override
  int get hashCode {
    return updateAllowsFetchAndMerge.hashCode;
  }

  @override
  String toString() {
    return 'RepositoryRuleUpdateParameters(updateAllowsFetchAndMerge: $updateAllowsFetchAndMerge)';
  }
}
