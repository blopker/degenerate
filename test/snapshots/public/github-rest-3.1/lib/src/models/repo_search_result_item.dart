...
import 'repo_search_result_item_permissions.dart';
import 'repo_search_result_item_pull_request_creation_policy.dart';
import 'search_result_text_matches2.dart';
...
final class RepoSearchResultItem {
  ...
  factory RepoSearchResultItem.fromJson(Map<String, dynamic> json) {
    return RepoSearchResultItem(
      ...
      pullRequestCreationPolicy: json['pull_request_creation_policy'] != null
          ? RepoSearchResultItemPullRequestCreationPolicy.fromJson(
      ...
      permissions: json['permissions'] != null
          ? RepoSearchResultItemPermissions.fromJson(
              json['permissions'] as Map<String, dynamic>,
            )
          : null,
      textMatches: (json['text_matches'] as List<dynamic>?)
          ?.map(
            (e) => SearchResultTextMatches2.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  final RepoSearchResultItemPullRequestCreationPolicy?
  ...
  RepoSearchResultItem copyWith({
    int? id,
    String? nodeId,
    String? name,
    String? fullName,
    SimpleUser? Function()? owner,
    bool? private,
    Uri? htmlUrl,
    ...
    RepoSearchResultItemPullRequestCreationPolicy Function()?
    pullRequestCreationPolicy,
    bool? archived,
    bool? disabled,
    String Function()? visibility,
    LicenseSimple? Function()? license,
    RepoSearchResultItemPermissions Function()? permissions,
    List<SearchResultTextMatches2> Function()? textMatches,
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      license,
      permissions,
      Object.hashAll(textMatches ?? const []),
      tempCloneToken,
      allowMergeCommit,
      allowSquashMerge,
      allowRebaseMerge,
