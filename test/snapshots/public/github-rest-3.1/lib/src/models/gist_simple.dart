...
import 'gist_history.dart';
import 'gist_simple_fork_of.dart';
import 'gist_simple_forks.dart';
...
final class GistSimple {
  ...
  factory GistSimple.fromJson(Map<String, dynamic> json) {
    return GistSimple(
      forks: (json['forks'] as List<dynamic>?)
          ?.map((e) => GistSimpleForks.fromJson(e as Map<String, dynamic>))
          .toList(),
      history: (json['history'] as List<dynamic>?)
          ?.map((e) => GistHistory.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      files: (json['files'] as Map<String, dynamic>?)?.map(
        (k, v) =>
            MapEntry(k, InlineObject4.fromJson(v as Map<String, dynamic>)),
      ),
  ...
  GistSimple copyWith({
    List<GistSimpleForks>? Function()? forks,
    List<GistHistory>? Function()? history,
    GistSimpleForkOf? Function()? forkOf,
    String Function()? url,
    String Function()? forksUrl,
    String Function()? commitsUrl,
    String Function()? id,
    String Function()? nodeId,
    String Function()? gitPullUrl,
    String Function()? gitPushUrl,
    String Function()? htmlUrl,
    Map<String, InlineObject4> Function()? files,
    bool Function()? public,
    String Function()? createdAt,
    String Function()? updatedAt,
    String? Function()? description,
    int Function()? comments,
    bool Function()? commentsEnabled,
    ...
    return GistSimple(
      ...
      commentsEnabled: commentsEnabled != null
          ? commentsEnabled()
          : this.commentsEnabled,
  ...
  int get hashCode {
    return Object.hashAll([
      Object.hashAll(forks ?? const []),
      Object.hashAll(history ?? const []),
      forkOf,
      url,
      forksUrl,
      commitsUrl,
