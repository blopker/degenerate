...
final class AuthorizationApp {
  ...
  AuthorizationApp copyWith({String? clientId, String? name, Uri? url}) {
    return AuthorizationApp(
  ...
  @override
  int get hashCode {
    return Object.hash(clientId, name, url);
  }

  @override
  String toString() {
    return 'AuthorizationApp(clientId: $clientId, name: $name, url: $url)';
  }
}
