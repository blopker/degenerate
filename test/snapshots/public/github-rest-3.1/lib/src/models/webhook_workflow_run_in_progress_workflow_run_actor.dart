...
import 'webhook_workflow_run_in_progress_workflow_run_actor_type.dart';

final class WebhookWorkflowRunInProgressWorkflowRunActor {
  const WebhookWorkflowRunInProgressWorkflowRunActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookWorkflowRunInProgressWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunInProgressWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunInProgressWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunInProgressWorkflowRunActor copyWith({
    ...
    WebhookWorkflowRunInProgressWorkflowRunActorType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookWorkflowRunInProgressWorkflowRunActor(
