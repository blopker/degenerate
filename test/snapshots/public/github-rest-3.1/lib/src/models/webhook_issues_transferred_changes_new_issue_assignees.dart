...
import 'webhook_issues_transferred_changes_new_issue_assignees_type.dart';

final class WebhookIssuesTransferredChangesNewIssueAssignees {
  const WebhookIssuesTransferredChangesNewIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesTransferredChangesNewIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesTransferredChangesNewIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesTransferredChangesNewIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesTransferredChangesNewIssueAssignees copyWith({
    ...
    WebhookIssuesTransferredChangesNewIssueAssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesTransferredChangesNewIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
