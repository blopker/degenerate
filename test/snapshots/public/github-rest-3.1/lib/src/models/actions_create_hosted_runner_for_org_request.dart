...
import 'actions_create_hosted_runner_for_org_request_image.dart';

final class ActionsCreateHostedRunnerForOrgRequest {
  ...
  factory ActionsCreateHostedRunnerForOrgRequest.fromJson(
    ...
    return ActionsCreateHostedRunnerForOrgRequest(
      ...
      maximumRunners: json['maximum_runners'] != null
          ? (json['maximum_runners'] as num).toInt()
          : null,
      enableStaticIp: json['enable_static_ip'] as bool?,
      imageGen: json.containsKey('image_gen')
          ? json['image_gen'] as bool
          : false,
    );
  }
  ...
  ActionsCreateHostedRunnerForOrgRequest copyWith({
    String? name,
    ActionsCreateHostedRunnerForOrgRequestImage? image,
    String? size,
    int? runnerGroupId,
    int Function()? maximumRunners,
    bool Function()? enableStaticIp,
    ...
    return ActionsCreateHostedRunnerForOrgRequest(
      ...
      maximumRunners: maximumRunners != null
          ? maximumRunners()
          : this.maximumRunners,
      enableStaticIp: enableStaticIp != null
          ? enableStaticIp()
          : this.enableStaticIp,
  ...
  @override
  String toString() {
    return 'ActionsCreateHostedRunnerForOrgRequest(name: $name, image: $image, size: $size, runnerGroupId: $runnerGroupId, maximumRunners: $maximumRunners, enableStaticIp: $enableStaticIp, imageGen: $imageGen)';
  }
}
