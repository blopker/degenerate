...
import 'webhook_project_card_deleted_project_card_creator_type.dart';

final class WebhookProjectCardDeletedProjectCardCreator {
  const WebhookProjectCardDeletedProjectCardCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookProjectCardDeletedProjectCardCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookProjectCardDeletedProjectCardCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookProjectCardDeletedProjectCardCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookProjectCardDeletedProjectCardCreator copyWith({
    ...
    WebhookProjectCardDeletedProjectCardCreatorType Function()? type,
    Uri Function()? url,
