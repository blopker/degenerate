...
import 'unlabeled_issue_event_label.dart';
...
final class UnlabeledIssueEvent {
  ...
  @override
  String toString() {
    return 'UnlabeledIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, label: $label)';
  }
}
