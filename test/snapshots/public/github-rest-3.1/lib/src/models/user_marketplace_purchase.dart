...
import 'marketplace_account.dart';
import 'marketplace_listing_plan.dart';
...
final class UserMarketplacePurchase {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('billing_cycle') &&
  ...
  UserMarketplacePurchase copyWith({
    String? billingCycle,
    DateTime? Function()? nextBillingDate,
    int? Function()? unitCount,
    bool? onFreeTrial,
    DateTime? Function()? freeTrialEndsOn,
