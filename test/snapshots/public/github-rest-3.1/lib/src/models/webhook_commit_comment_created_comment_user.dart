...
import 'webhook_commit_comment_created_comment_user_type.dart';

final class WebhookCommitCommentCreatedCommentUser {
  const WebhookCommitCommentCreatedCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCommitCommentCreatedCommentUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCommitCommentCreatedCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCommitCommentCreatedCommentUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCommitCommentCreatedCommentUser copyWith({
    ...
    WebhookCommitCommentCreatedCommentUserType Function()? type,
    Uri Function()? url,
