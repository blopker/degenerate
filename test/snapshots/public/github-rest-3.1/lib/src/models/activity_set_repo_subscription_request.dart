...
final class ActivitySetRepoSubscriptionRequest {
  ...
  ActivitySetRepoSubscriptionRequest copyWith({
    bool Function()? subscribed,
    bool Function()? ignored,
  }) {
    return ActivitySetRepoSubscriptionRequest(
  ...
  @override
  int get hashCode {
    return Object.hash(subscribed, ignored);
  }

  @override
  String toString() {
    return 'ActivitySetRepoSubscriptionRequest(subscribed: $subscribed, ignored: $ignored)';
  }
}
