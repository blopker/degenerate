...
import 'webhook_deployment_status_created_deployment_creator_type.dart';

final class WebhookDeploymentStatusCreatedDeploymentCreator {
  const WebhookDeploymentStatusCreatedDeploymentCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentStatusCreatedDeploymentCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedDeploymentCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentStatusCreatedDeploymentCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentStatusCreatedDeploymentCreator copyWith({
    ...
    WebhookDeploymentStatusCreatedDeploymentCreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentStatusCreatedDeploymentCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
