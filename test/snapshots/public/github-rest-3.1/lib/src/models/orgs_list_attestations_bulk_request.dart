...
final class OrgsListAttestationsBulkRequest {
  ...
  factory OrgsListAttestationsBulkRequest.fromJson(Map<String, dynamic> json) {
    return OrgsListAttestationsBulkRequest(
  ...
  OrgsListAttestationsBulkRequest copyWith({
  ...
  @override
  String toString() {
    return 'OrgsListAttestationsBulkRequest(subjectDigests: $subjectDigests, predicateType: $predicateType)';
  }
}
