...
import 'webhook_issues_locked_issue_user_type.dart';

final class WebhookIssuesLockedIssueUser {
  const WebhookIssuesLockedIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesLockedIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesLockedIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesLockedIssueUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookIssuesLockedIssueUser copyWith({
    ...
    WebhookIssuesLockedIssueUserType Function()? type,
    Uri Function()? url,
