...
import 'webhook_deployment_review_rejected_workflow_run_actor.dart';
import 'webhook_deployment_review_rejected_workflow_run_conclusion.dart';
import 'webhook_deployment_review_rejected_workflow_run_head_repository.dart';
import 'webhook_deployment_review_rejected_workflow_run_pull_requests.dart';
import 'webhook_deployment_review_rejected_workflow_run_referenced_workflows.dart';
import 'webhook_deployment_review_rejected_workflow_run_repository.dart';
import 'webhook_deployment_review_rejected_workflow_run_status.dart';
import 'webhook_deployment_review_rejected_workflow_run_triggering_actor.dart';

final class WebhookDeploymentReviewRejectedWorkflowRun {
  const WebhookDeploymentReviewRejectedWorkflowRun({
    required this.actor,
    this.artifactsUrl,
    this.cancelUrl,
  ...
  factory WebhookDeploymentReviewRejectedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRejectedWorkflowRun(
      actor: WebhookDeploymentReviewRejectedWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookDeploymentReviewRejectedWorkflowRunConclusion.fromJson(
      ...
      headRepository: json['head_repository'] != null
          ? WebhookDeploymentReviewRejectedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) =>
                WebhookDeploymentReviewRejectedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookDeploymentReviewRejectedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: json['repository'] != null
          ? WebhookDeploymentReviewRejectedWorkflowRunRepository.fromJson(
      ...
      status: WebhookDeploymentReviewRejectedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor.fromJson(
  ...
  final WebhookDeploymentReviewRejectedWorkflowRunHeadRepository?
  headRepository;
  ...
  final List<WebhookDeploymentReviewRejectedWorkflowRunPullRequests>
  pullRequests;

  final List<WebhookDeploymentReviewRejectedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  final WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor?
  triggeringActor;
  ...
  WebhookDeploymentReviewRejectedWorkflowRun copyWith({
    WebhookDeploymentReviewRejectedWorkflowRunActor? Function()? actor,
    String Function()? artifactsUrl,
    String Function()? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    String Function()? checkSuiteUrl,
    WebhookDeploymentReviewRejectedWorkflowRunConclusion? Function()?
    conclusion,
    DateTime? createdAt,
    String? event,
    String? headBranch,
    Map<String, String>? Function()? headCommit,
    WebhookDeploymentReviewRejectedWorkflowRunHeadRepository Function()?
    headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    ...
    List<WebhookDeploymentReviewRejectedWorkflowRunPullRequests>? pullRequests,
    List<WebhookDeploymentReviewRejectedWorkflowRunReferencedWorkflows>?
    Function()?
    referencedWorkflows,
    WebhookDeploymentReviewRejectedWorkflowRunRepository Function()? repository,
    String Function()? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookDeploymentReviewRejectedWorkflowRunStatus? status,
    WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
