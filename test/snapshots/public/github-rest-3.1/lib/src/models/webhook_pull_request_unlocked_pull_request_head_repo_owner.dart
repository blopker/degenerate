...
import 'webhook_pull_request_unlocked_pull_request_head_repo_owner_type.dart';

final class WebhookPullRequestUnlockedPullRequestHeadRepoOwner {
  const WebhookPullRequestUnlockedPullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlockedPullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlockedPullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlockedPullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlockedPullRequestHeadRepoOwner copyWith({
    ...
    WebhookPullRequestUnlockedPullRequestHeadRepoOwnerType Function()? type,
    Uri Function()? url,
