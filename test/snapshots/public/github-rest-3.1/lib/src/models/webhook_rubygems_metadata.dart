...
import 'webhook_rubygems_metadata_version_info.dart';

final class WebhookRubygemsMetadata {
  const WebhookRubygemsMetadata({
    this.name,
    this.description,
    this.readme,
    this.homepage,
  ...
  factory WebhookRubygemsMetadata.fromJson(Map<String, dynamic> json) {
    return WebhookRubygemsMetadata(
      ...
      versionInfo: json['version_info'] != null
          ? WebhookRubygemsMetadataVersionInfo.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (dependencies != null)
        'dependencies': dependencies?.map((e) => e).toList(),
  ...
  int get hashCode {
    return Object.hash(
      ...
      metadata,
      repo,
      Object.hashAll(dependencies ?? const []),
      commitOid,
    );
  }
  ...
  @override
  String toString() {
    return 'WebhookRubygemsMetadata(name: $name, description: $description, readme: $readme, homepage: $homepage, versionInfo: $versionInfo, platform: $platform, metadata: $metadata, repo: $repo, dependencies: $dependencies, commitOid: $commitOid)';
  }
}
