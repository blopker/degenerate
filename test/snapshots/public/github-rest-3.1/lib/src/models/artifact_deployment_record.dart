...
import 'artifact_deployment_record_runtime_risks.dart';

/// Artifact Metadata Deployment Record
final class ArtifactDeploymentRecord {
  const ArtifactDeploymentRecord({
    this.id,
    this.digest,
    this.logicalEnvironment,
  ...
  factory ArtifactDeploymentRecord.fromJson(Map<String, dynamic> json) {
    return ArtifactDeploymentRecord(
      ...
      runtimeRisks: (json['runtime_risks'] as List<dynamic>?)
          ?.map(
            (e) => ArtifactDeploymentRecordRuntimeRisks.fromJson(e as String),
          )
          .toList(),
      createdAt: json['created_at'] as String?,
      updatedAt: json['updated_at'] as String?,
      attestationId: json['attestation_id'] != null
          ? (json['attestation_id'] as num).toInt()
          : null,
    );
  }
  ...
  ArtifactDeploymentRecord copyWith({
    int Function()? id,
    String Function()? digest,
    String Function()? logicalEnvironment,
    String Function()? physicalEnvironment,
    String Function()? cluster,
    String Function()? deploymentName,
    Map<String, String> Function()? tags,
    List<ArtifactDeploymentRecordRuntimeRisks> Function()? runtimeRisks,
    String Function()? createdAt,
    String Function()? updatedAt,
    int? Function()? attestationId,
  }) {
    return ArtifactDeploymentRecord(
      id: id != null ? id() : this.id,
      digest: digest != null ? digest() : this.digest,
      logicalEnvironment: logicalEnvironment != null
          ? logicalEnvironment()
          : this.logicalEnvironment,
  ...
  @override
  String toString() {
    return 'ArtifactDeploymentRecord(id: $id, digest: $digest, logicalEnvironment: $logicalEnvironment, physicalEnvironment: $physicalEnvironment, cluster: $cluster, deploymentName: $deploymentName, tags: $tags, runtimeRisks: $runtimeRisks, createdAt: $createdAt, updatedAt: $updatedAt, attestationId: $attestationId)';
  }
}
