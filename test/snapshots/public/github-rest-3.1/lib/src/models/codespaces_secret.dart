...
import 'codespaces_secret_visibility.dart';
...
final class CodespacesSecret {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('name') &&
        ...
        json.containsKey('selected_repositories_url') &&
        json['selected_repositories_url'] is String;
  }

  CodespacesSecret copyWith({
    String? name,
    DateTime? createdAt,
    DateTime? updatedAt,
    CodespacesSecretVisibility? visibility,
    ...
    return CodespacesSecret(
      ...
      selectedRepositoriesUrl:
          selectedRepositoriesUrl ?? this.selectedRepositoriesUrl,
    );
  }
  ...
  @override
  String toString() {
    return 'CodespacesSecret(name: $name, createdAt: $createdAt, updatedAt: $updatedAt, visibility: $visibility, selectedRepositoriesUrl: $selectedRepositoriesUrl)';
  }
}
