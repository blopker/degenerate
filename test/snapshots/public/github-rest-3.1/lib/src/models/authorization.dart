...
import 'authorization_app.dart';
import 'scoped_installation.dart';
...
final class Authorization {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('token_last_eight') &&
        json['token_last_eight'] is String &&
        json.containsKey('hashed_token') &&
        json['hashed_token'] is String &&
        json.containsKey('app') &&
        json.containsKey('note') &&
        json['note'] is String &&
        json.containsKey('note_url') &&
        json['note_url'] is String &&
        json.containsKey('updated_at') &&
        json['updated_at'] is String &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('fingerprint') &&
  ...
  Authorization copyWith({
    ...
    String? token,
    String? Function()? tokenLastEight,
    String? Function()? hashedToken,
    AuthorizationApp? app,
    String? Function()? note,
    Uri? Function()? noteUrl,
    DateTime? updatedAt,
    DateTime? createdAt,
    String? Function()? fingerprint,
    SimpleUser? Function()? user,
    ScopedInstallation? Function()? installation,
    ...
    return Authorization(
      ...
      tokenLastEight: tokenLastEight != null
          ? tokenLastEight()
          : this.tokenLastEight,
  ...
  @override
  String toString() {
    return 'Authorization(id: $id, url: $url, scopes: $scopes, token: $token, tokenLastEight: $tokenLastEight, hashedToken: $hashedToken, app: $app, note: $note, noteUrl: $noteUrl, updatedAt: $updatedAt, createdAt: $createdAt, fingerprint: $fingerprint, user: $user, installation: $installation, expiresAt: $expiresAt)';
  }
}
