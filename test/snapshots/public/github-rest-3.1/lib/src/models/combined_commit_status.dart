...
import 'simple_commit_status.dart';
  ...
  factory CombinedCommitStatus.fromJson(Map<String, dynamic> json) {
    return CombinedCommitStatus(
      ...
      statuses: (json['statuses'] as List<dynamic>)
          .map((e) => SimpleCommitStatus.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is CombinedCommitStatus &&
            state == other.state &&
            const ListEquality<dynamic>().equals(statuses, other.statuses) &&
            sha == other.sha &&
