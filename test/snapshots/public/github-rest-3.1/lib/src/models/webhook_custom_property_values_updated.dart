...
import 'package:collection/collection.dart';import 'custom_property_value.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_custom_property_values_updated_action.dart';final class WebhookCustomPropertyValuesUpdated {const WebhookCustomPropertyValuesUpdated({required this.action, this.enterprise, this.installation, required this.repository, required this.organization, this.sender, required this.newPropertyValues, required this.oldPropertyValues, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCustomPropertyValuesUpdated &&
          ...
          sender == other.sender &&
          const ListEquality<dynamic>().equals(newPropertyValues, other.newPropertyValues) &&
          const ListEquality<dynamic>().equals(oldPropertyValues, other.oldPropertyValues); } 
