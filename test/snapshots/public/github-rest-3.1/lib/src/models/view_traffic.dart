...
final class ViewTraffic {
  ...
  ViewTraffic copyWith({int? count, int? uniques, List<Traffic>? views}) {
    return ViewTraffic(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ViewTraffic &&
            ...
            const ListEquality<dynamic>().equals(views, other.views);
  }

  @override
  int get hashCode {
    return Object.hash(count, uniques, Object.hashAll(views));
  }
