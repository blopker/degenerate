...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_marketplace_purchase_changed_action.dart';import 'webhook_marketplace_purchase_changed_previous_marketplace_purchase.dart';import 'webhooks_marketplace_purchase.dart';final class WebhookMarketplacePurchaseChanged {const WebhookMarketplacePurchaseChanged({required this.action, required this.effectiveDate, this.enterprise, this.installation, required this.marketplacePurchase, this.organization, this.previousMarketplacePurchase, this.repository, required this.sender, });
...
factory WebhookMarketplacePurchaseChanged.fromJson(Map<String, dynamic> json) { return WebhookMarketplacePurchaseChanged(
  ...
  previousMarketplacePurchase: json['previous_marketplace_purchase'] != null
        ? WebhookMarketplacePurchaseChangedPreviousMarketplacePurchase.fromJson(json['previous_marketplace_purchase'] as Map<String, dynamic>)
        : null,
