...
import 'inline_object72_pull_request_base_user_type.dart';

final class InlineObject72PullRequestBaseUser {
  const InlineObject72PullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestBaseUser copyWith({
    ...
    InlineObject72PullRequestBaseUserType Function()? type,
    Uri Function()? url,
