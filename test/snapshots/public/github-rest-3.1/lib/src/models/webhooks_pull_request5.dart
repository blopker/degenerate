...
factory WebhooksPullRequest5.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5(
  ...
  activeLockReason: WebhooksPullRequest5ActiveLockReason.fromJson(json['active_lock_reason'] as String),
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: WebhooksPullRequest5Assignee.fromJson(json['assignee'] as Map<String, dynamic>),
  ...
  autoMerge: WebhooksPullRequest5AutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>),
  ...
  mergedBy: json['merged_by'] != null
        ? WebhooksPullRequest5MergedBy.fromJson(json['merged_by'] as Map<String, dynamic>)
        : null,
  milestone: WebhooksPullRequest5Milestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  patchUrl: Uri.parse(json['patch_url'] as String),
  rebaseable: json['rebaseable'] as bool?,
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => WebhooksPullRequest5RequestedReviewers.fromJson(e)).toList(),
  ...
  user: WebhooksPullRequest5User.fromJson(json['user'] as Map<String, dynamic>),
); }
