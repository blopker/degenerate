...
import 'webhooks_pull_request5_active_lock_reason.dart';
import 'webhooks_pull_request5_assignee.dart';
import 'webhooks_pull_request5_assignees.dart';
import 'webhooks_pull_request5_author_association.dart';
import 'webhooks_pull_request5_auto_merge.dart';
import 'webhooks_pull_request5_base.dart';
import 'webhooks_pull_request5_head.dart';
import 'webhooks_pull_request5_labels.dart';
import 'webhooks_pull_request5_links.dart';
import 'webhooks_pull_request5_merged_by.dart';
import 'webhooks_pull_request5_milestone.dart';
import 'webhooks_pull_request5_requested_reviewers.dart';
import 'webhooks_pull_request5_requested_teams.dart';
import 'webhooks_pull_request5_state.dart';
import 'webhooks_pull_request5_user.dart';

final class WebhooksPullRequest5 {
  const WebhooksPullRequest5({
    required this.links,
  ...
  factory WebhooksPullRequest5.fromJson(Map<String, dynamic> json) {
    return WebhooksPullRequest5(
      links: WebhooksPullRequest5Links.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason: WebhooksPullRequest5ActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: WebhooksPullRequest5Assignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => WebhooksPullRequest5Assignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: WebhooksPullRequest5AuthorAssociation.fromJson(
        json['author_association'] as String,
      ),
      autoMerge: WebhooksPullRequest5AutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: WebhooksPullRequest5Base.fromJson(
      ...
      head: WebhooksPullRequest5Head.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) =>
                WebhooksPullRequest5Labels.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? WebhooksPullRequest5MergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: WebhooksPullRequest5Milestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map((e) => WebhooksPullRequest5RequestedReviewers.fromJson(e))
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => WebhooksPullRequest5RequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      user: WebhooksPullRequest5User.fromJson(
  ...
  WebhooksPullRequest5 copyWith({
    WebhooksPullRequest5Links? links,
    WebhooksPullRequest5ActiveLockReason? Function()? activeLockReason,
    int Function()? additions,
    WebhooksPullRequest5Assignee? Function()? assignee,
    List<WebhooksPullRequest5Assignees?>? assignees,
    WebhooksPullRequest5AuthorAssociation? authorAssociation,
    ...
    Uri? diffUrl,
    bool? draft,
    WebhooksPullRequest5Head? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<WebhooksPullRequest5Labels>? labels,
    bool? locked,
    ...
    WebhooksPullRequest5MergedBy? Function()? mergedBy,
    WebhooksPullRequest5Milestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<WebhooksPullRequest5RequestedReviewers>? requestedReviewers,
    List<WebhooksPullRequest5RequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    WebhooksPullRequest5State? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    WebhooksPullRequest5User? Function()? user,
  }) {
    return WebhooksPullRequest5(
