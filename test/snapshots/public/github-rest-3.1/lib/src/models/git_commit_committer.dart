...
final class GitCommitCommitter {
  ...
  GitCommitCommitter copyWith({DateTime? date, String? email, String? name}) {
    return GitCommitCommitter(
      date: date ?? this.date,
  ...
  @override
  String toString() {
    return 'GitCommitCommitter(date: $date, email: $email, name: $name)';
  }
}
