...
final class CustomDeploymentRuleApp {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['slug'] is String &&
        json.containsKey('integration_url') &&
        json['integration_url'] is String &&
        json.containsKey('node_id') &&
        json['node_id'] is String;
  }

  CustomDeploymentRuleApp copyWith({
    int? id,
    String? slug,
  ...
  @override
  int get hashCode {
    return Object.hash(id, slug, integrationUrl, nodeId);
  }

  @override
  String toString() {
    return 'CustomDeploymentRuleApp(id: $id, slug: $slug, integrationUrl: $integrationUrl, nodeId: $nodeId)';
  }
}
