...
import 'page_deployment_id.dart';/// The GitHub Pages deployment status.
...
PageDeployment copyWith({PageDeploymentId? id, Uri? statusUrl, Uri? pageUrl, Uri Function()? previewUrl, }) { return PageDeployment(
  id: id ?? this.id,
