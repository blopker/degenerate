...
import 'page_deployment_id.dart';
...
final class PageDeployment {
  ...
  factory PageDeployment.fromJson(Map<String, dynamic> json) {
    return PageDeployment(
      id: PageDeploymentId.fromJson(json['id']),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json.containsKey('status_url') &&
        json['status_url'] is String &&
        json.containsKey('page_url') &&
        json['page_url'] is String;
  }

  PageDeployment copyWith({
    PageDeploymentId? id,
    Uri? statusUrl,
    Uri? pageUrl,
    Uri Function()? previewUrl,
  }) {
    return PageDeployment(
      id: id ?? this.id,
  ...
  @override
  int get hashCode {
    return Object.hash(id, statusUrl, pageUrl, previewUrl);
  }

  @override
  String toString() {
    return 'PageDeployment(id: $id, statusUrl: $statusUrl, pageUrl: $pageUrl, previewUrl: $previewUrl)';
  }
}
