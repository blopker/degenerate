...
import 'package:collection/collection.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_status_branches.dart';import 'webhook_status_commit.dart';import 'webhook_status_state.dart';final class WebhookStatus {const WebhookStatus({this.avatarUrl, required this.branches, required this.commit, required this.context, required this.createdAt, required this.description, this.enterprise, required this.id, this.installation, required this.name, this.organization, required this.repository, required this.sender, required this.sha, required this.state, required this.targetUrl, required this.updatedAt, });
