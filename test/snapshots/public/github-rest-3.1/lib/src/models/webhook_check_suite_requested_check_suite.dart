...
import 'webhook_check_suite_requested_check_suite_app.dart';
import 'webhook_check_suite_requested_check_suite_conclusion.dart';
import 'webhook_check_suite_requested_check_suite_head_commit.dart';
import 'webhook_check_suite_requested_check_suite_pull_requests.dart';
import 'webhook_check_suite_requested_check_suite_status.dart';

/// The [check_suite](https://docs.github.com/rest/checks/suites#get-a-check-suite).
final class WebhookCheckSuiteRequestedCheckSuite {
  const WebhookCheckSuiteRequestedCheckSuite({
    required this.after,
    required this.app,
  ...
  factory WebhookCheckSuiteRequestedCheckSuite.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCheckSuiteRequestedCheckSuite(
      after: json['after'] as String,
      app: WebhookCheckSuiteRequestedCheckSuiteApp.fromJson(
        json['app'] as Map<String, dynamic>,
      ),
      before: json['before'] as String,
      checkRunsUrl: Uri.parse(json['check_runs_url'] as String),
      conclusion: WebhookCheckSuiteRequestedCheckSuiteConclusion.fromJson(
        json['conclusion'] as String,
      ),
      createdAt: DateTime.parse(json['created_at'] as String),
      headBranch: json['head_branch'] as String,
      headCommit: WebhookCheckSuiteRequestedCheckSuiteHeadCommit.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookCheckSuiteRequestedCheckSuitePullRequests.fromJson(
      ...
      status: WebhookCheckSuiteRequestedCheckSuiteStatus.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('after') &&
        json['after'] is String &&
        json.containsKey('app') &&
        json.containsKey('before') &&
        json['before'] is String &&
        json.containsKey('check_runs_url') &&
        json['check_runs_url'] is String &&
        ...
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('latest_check_runs_count') &&
        json['latest_check_runs_count'] is num &&
  ...
  WebhookCheckSuiteRequestedCheckSuite copyWith({
    String? Function()? after,
    WebhookCheckSuiteRequestedCheckSuiteApp? app,
    String? Function()? before,
    Uri? checkRunsUrl,
    WebhookCheckSuiteRequestedCheckSuiteConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? Function()? headBranch,
    WebhookCheckSuiteRequestedCheckSuiteHeadCommit? headCommit,
    String? headSha,
    int? id,
    int? latestCheckRunsCount,
    String? nodeId,
    List<WebhookCheckSuiteRequestedCheckSuitePullRequests>? pullRequests,
    bool Function()? rerequestable,
    bool Function()? runsRerequestable,
    WebhookCheckSuiteRequestedCheckSuiteStatus? Function()? status,
    DateTime? updatedAt,
    Uri? url,
  }) {
    return WebhookCheckSuiteRequestedCheckSuite(
      ...
      rerequestable: rerequestable != null
          ? rerequestable()
          : this.rerequestable,
      runsRerequestable: runsRerequestable != null
          ? runsRerequestable()
          : this.runsRerequestable,
  ...
  @override
  String toString() {
    return 'WebhookCheckSuiteRequestedCheckSuite(after: $after, app: $app, before: $before, checkRunsUrl: $checkRunsUrl, conclusion: $conclusion, createdAt: $createdAt, headBranch: $headBranch, headCommit: $headCommit, headSha: $headSha, id: $id, latestCheckRunsCount: $latestCheckRunsCount, nodeId: $nodeId, pullRequests: $pullRequests, rerequestable: $rerequestable, runsRerequestable: $runsRerequestable, status: $status, updatedAt: $updatedAt, url: $url)';
  }
}
