...
import 'demilestoned_issue_event_milestone.dart';
import 'integration.dart';
import 'simple_user.dart';

/// Demilestoned Issue Event
final class DemilestonedIssueEvent {
  const DemilestonedIssueEvent({
    required this.id,
  ...
  DemilestonedIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
    ...
    DemilestonedIssueEventMilestone? milestone,
  }) {
    return DemilestonedIssueEvent(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'DemilestonedIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, milestone: $milestone)';
  }
}
