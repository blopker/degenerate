...
import 'status_check_policy_checks.dart';
...
final class StatusCheckPolicy {
  ...
  factory StatusCheckPolicy.fromJson(Map<String, dynamic> json) {
    return StatusCheckPolicy(
      ...
      checks: (json['checks'] as List<dynamic>)
          .map(
            (e) => StatusCheckPolicyChecks.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        ...
        json.containsKey('contexts_url') &&
        json['contexts_url'] is String;
  }

  StatusCheckPolicy copyWith({
    Uri? url,
    bool? strict,
    List<String>? contexts,
    List<StatusCheckPolicyChecks>? checks,
    Uri? contextsUrl,
  }) {
    return StatusCheckPolicy(
      url: url ?? this.url,
  ...
  @override
  String toString() {
    return 'StatusCheckPolicy(url: $url, strict: $strict, contexts: $contexts, checks: $checks, contextsUrl: $contextsUrl)';
  }
}
