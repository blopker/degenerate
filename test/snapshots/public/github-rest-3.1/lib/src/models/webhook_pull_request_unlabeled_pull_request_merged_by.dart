...
import 'webhook_pull_request_unlabeled_pull_request_merged_by_type.dart';

final class WebhookPullRequestUnlabeledPullRequestMergedBy {
  const WebhookPullRequestUnlabeledPullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlabeledPullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlabeledPullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlabeledPullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlabeledPullRequestMergedBy copyWith({
    ...
    WebhookPullRequestUnlabeledPullRequestMergedByType Function()? type,
    Uri Function()? url,
