...
import 'global_advisory_identifiers_type.dart';final class GlobalAdvisoryIdentifiers {const GlobalAdvisoryIdentifiers({required this.type, required this.value, });
