...
final class IssuesReprioritizeSubIssueRequest {
  ...
  factory IssuesReprioritizeSubIssueRequest.fromJson(
    ...
    return IssuesReprioritizeSubIssueRequest(
      ...
      afterId: json['after_id'] != null
          ...
          : null,
      beforeId: json['before_id'] != null
          ? (json['before_id'] as num).toInt()
          : null,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('sub_issue_id') && json['sub_issue_id'] is num;
  }

  IssuesReprioritizeSubIssueRequest copyWith({
    int? subIssueId,
    int Function()? afterId,
    int Function()? beforeId,
  }) {
    return IssuesReprioritizeSubIssueRequest(
  ...
  @override
  int get hashCode {
    return Object.hash(subIssueId, afterId, beforeId);
  }

  @override
  String toString() {
    return 'IssuesReprioritizeSubIssueRequest(subIssueId: $subIssueId, afterId: $afterId, beforeId: $beforeId)';
  }
}
