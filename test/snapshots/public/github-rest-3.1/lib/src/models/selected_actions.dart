...
final class SelectedActions {
  ...
  factory SelectedActions.fromJson(Map<String, dynamic> json) {
    return SelectedActions(
      ...
      patternsAllowed: (json['patterns_allowed'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
    );
  }
  ...
  SelectedActions copyWith({
    bool Function()? githubOwnedAllowed,
    bool Function()? verifiedAllowed,
    List<String> Function()? patternsAllowed,
  }) {
    return SelectedActions(
      githubOwnedAllowed: githubOwnedAllowed != null
          ? githubOwnedAllowed()
          : this.githubOwnedAllowed,
      verifiedAllowed: verifiedAllowed != null
          ? verifiedAllowed()
          : this.verifiedAllowed,
      patternsAllowed: patternsAllowed != null
          ? patternsAllowed()
          : this.patternsAllowed,
    );
  }
  ...
  int get hashCode {
    return Object.hash(
      githubOwnedAllowed,
      verifiedAllowed,
      Object.hashAll(patternsAllowed ?? const []),
    );
  }
