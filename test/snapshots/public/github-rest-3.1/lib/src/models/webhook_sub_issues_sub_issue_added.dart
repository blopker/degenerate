...
import 'webhook_sub_issues_sub_issue_added_action.dart';

final class WebhookSubIssuesSubIssueAdded {
  const WebhookSubIssuesSubIssueAdded({
    required this.action,
    required this.subIssueId,
    required this.subIssue,
    required this.subIssueRepo,
  ...
  factory WebhookSubIssuesSubIssueAdded.fromJson(Map<String, dynamic> json) {
    return WebhookSubIssuesSubIssueAdded(
      action: WebhookSubIssuesSubIssueAddedAction.fromJson(
        json['action'] as String,
      ),
      subIssueId: (json['sub_issue_id'] as num).toDouble(),
      subIssue: Issue.fromJson(json['sub_issue'] as Map<String, dynamic>),
      subIssueRepo: Repository.fromJson(
        json['sub_issue_repo'] as Map<String, dynamic>,
      ),
  ...
  WebhookSubIssuesSubIssueAdded copyWith({
    WebhookSubIssuesSubIssueAddedAction? action,
    double? subIssueId,
    Issue? subIssue,
  ...
  @override
  String toString() {
    return 'WebhookSubIssuesSubIssueAdded(action: $action, subIssueId: $subIssueId, subIssue: $subIssue, subIssueRepo: $subIssueRepo, parentIssueId: $parentIssueId, parentIssue: $parentIssue, installation: $installation, organization: $organization, repository: $repository, sender: $sender)';
  }
}
