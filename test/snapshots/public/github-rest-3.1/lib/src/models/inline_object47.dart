...
final class InlineObject47 {
  ...
  factory InlineObject47.fromJson(Map<String, dynamic> json) {
    return InlineObject47(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject47Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject47 copyWith({
    ...
    InlineObject47Type Function()? type,
    Uri Function()? url,
