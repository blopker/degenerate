...
import 'webhook_pull_request_auto_merge_enabled_pull_request_base_user_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestBaseUser {
  const WebhookPullRequestAutoMergeEnabledPullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestBaseUser copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestBaseUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAutoMergeEnabledPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
