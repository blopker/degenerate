...
final class ActionsHostedRunnerCustomImage {
  const ActionsHostedRunnerCustomImage({
    required this.id,
    required this.platform,
    required this.totalVersionsSize,
    required this.name,
  ...
  factory ActionsHostedRunnerCustomImage.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('total_versions_size') &&
        json['total_versions_size'] is num &&
        json.containsKey('name') &&
        json['name'] is String &&
        json.containsKey('source') &&
        json['source'] is String &&
        json.containsKey('versions_count') &&
        json['versions_count'] is num &&
        json.containsKey('latest_version') &&
        json['latest_version'] is String &&
        json.containsKey('state') &&
        json['state'] is String;
  }

  ActionsHostedRunnerCustomImage copyWith({
    int? id,
    String? platform,
  ...
  @override
  String toString() {
    return 'ActionsHostedRunnerCustomImage(id: $id, platform: $platform, totalVersionsSize: $totalVersionsSize, name: $name, source: $source, versionsCount: $versionsCount, latestVersion: $latestVersion, state: $state)';
  }
}
