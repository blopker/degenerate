...
final class DeploymentBranchPolicySettings {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('protected_branches') &&
        json['protected_branches'] is bool &&
        json.containsKey('custom_branch_policies') &&
        json['custom_branch_policies'] is bool;
  }

  DeploymentBranchPolicySettings copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(protectedBranches, customBranchPolicies);
  }

  @override
  String toString() {
    return 'DeploymentBranchPolicySettings(protectedBranches: $protectedBranches, customBranchPolicies: $customBranchPolicies)';
  }
}
