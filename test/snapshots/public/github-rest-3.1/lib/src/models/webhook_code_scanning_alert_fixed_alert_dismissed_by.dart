...
import 'webhook_code_scanning_alert_fixed_alert_dismissed_by_type.dart';

final class WebhookCodeScanningAlertFixedAlertDismissedBy {
  const WebhookCodeScanningAlertFixedAlertDismissedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCodeScanningAlertFixedAlertDismissedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCodeScanningAlertFixedAlertDismissedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCodeScanningAlertFixedAlertDismissedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCodeScanningAlertFixedAlertDismissedBy copyWith({
    ...
    WebhookCodeScanningAlertFixedAlertDismissedByType Function()? type,
    Uri Function()? url,
