...
import 'codespaces_create_or_update_org_secret_request_visibility.dart';

final class CodespacesCreateOrUpdateOrgSecretRequest {
  ...
  CodespacesCreateOrUpdateOrgSecretRequest copyWith({
  ...
  @override
  String toString() {
    return 'CodespacesCreateOrUpdateOrgSecretRequest(encryptedValue: $encryptedValue, keyId: $keyId, visibility: $visibility, selectedRepositoryIds: $selectedRepositoryIds)';
  }
}
