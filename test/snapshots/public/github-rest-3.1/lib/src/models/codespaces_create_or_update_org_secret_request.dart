...
import 'package:collection/collection.dart';import 'codespaces_create_or_update_org_secret_request_visibility.dart';final class CodespacesCreateOrUpdateOrgSecretRequest {const CodespacesCreateOrUpdateOrgSecretRequest({this.encryptedValue, this.keyId, required this.visibility, this.selectedRepositoryIds, });
