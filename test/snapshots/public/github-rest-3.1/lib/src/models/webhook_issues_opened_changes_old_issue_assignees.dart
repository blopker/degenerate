...
import 'webhook_issues_opened_changes_old_issue_assignees_type.dart';

final class WebhookIssuesOpenedChangesOldIssueAssignees {
  const WebhookIssuesOpenedChangesOldIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedChangesOldIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedChangesOldIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedChangesOldIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedChangesOldIssueAssignees copyWith({
    ...
    WebhookIssuesOpenedChangesOldIssueAssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesOpenedChangesOldIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
