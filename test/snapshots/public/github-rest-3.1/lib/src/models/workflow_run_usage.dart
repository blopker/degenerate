...
import 'workflow_run_usage_billable.dart';
...
final class WorkflowRunUsage {
  ...
  factory WorkflowRunUsage.fromJson(Map<String, dynamic> json) {
    return WorkflowRunUsage(
      ...
      runDurationMs: json['run_duration_ms'] != null
          ? (json['run_duration_ms'] as num).toInt()
          : null,
    );
  }
  ...
  WorkflowRunUsage copyWith({
    WorkflowRunUsageBillable? billable,
    int Function()? runDurationMs,
  }) {
    return WorkflowRunUsage(
      billable: billable ?? this.billable,
      runDurationMs: runDurationMs != null
          ? runDurationMs()
          : this.runDurationMs,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(billable, runDurationMs);
  }
