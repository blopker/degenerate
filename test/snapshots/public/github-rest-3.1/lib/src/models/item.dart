...
final class Item {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('content_node_id') &&
        json['content_node_id'] is String &&
  ...
  @override
  String toString() {
    return 'Item(id: $id, nodeId: $nodeId, projectNodeId: $projectNodeId, contentNodeId: $contentNodeId, contentType: $contentType, creator: $creator, createdAt: $createdAt, updatedAt: $updatedAt, archivedAt: $archivedAt)';
  }
}
