...
final class CodeScanningUploadSarifRequest {
  ...
  factory CodeScanningUploadSarifRequest.fromJson(Map<String, dynamic> json) {
    return CodeScanningUploadSarifRequest(
      ...
      checkoutUri: json['checkout_uri'] != null
          ? Uri.parse(json['checkout_uri'] as String)
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('commit_sha') &&
        json['commit_sha'] is String &&
        json.containsKey('ref') &&
        json['ref'] is String &&
        json.containsKey('sarif') &&
        json['sarif'] is String;
  }

  CodeScanningUploadSarifRequest copyWith({
    String? commitSha,
    String? ref,
    String? sarif,
    Uri Function()? checkoutUri,
  ...
  @override
  String toString() {
    return 'CodeScanningUploadSarifRequest(commitSha: $commitSha, ref: $ref, sarif: $sarif, checkoutUri: $checkoutUri, startedAt: $startedAt, toolName: $toolName, validate: $validate)';
  }
}
