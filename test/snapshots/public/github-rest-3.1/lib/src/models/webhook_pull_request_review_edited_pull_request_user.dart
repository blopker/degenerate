...
import 'webhook_pull_request_review_edited_pull_request_user_type.dart';

final class WebhookPullRequestReviewEditedPullRequestUser {
  const WebhookPullRequestReviewEditedPullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewEditedPullRequestUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewEditedPullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewEditedPullRequestUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewEditedPullRequestUser copyWith({
    ...
    WebhookPullRequestReviewEditedPullRequestUserType Function()? type,
    Uri Function()? url,
