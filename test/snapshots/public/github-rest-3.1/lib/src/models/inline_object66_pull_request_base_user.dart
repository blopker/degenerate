...
final class InlineObject66PullRequestBaseUser {
  const InlineObject66PullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestBaseUser copyWith({
    ...
    InlineObject66PullRequestBaseUserType Function()? type,
    Uri Function()? url,
