...
import 'webhook_pull_request_auto_merge_enabled_pull_request_active_lock_reason.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_assignee.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_assignees.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_author_association.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_auto_merge.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_base.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_head.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_labels.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_links.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_merged_by.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_milestone.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_requested_reviewers.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_requested_teams.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_state.dart';
import 'webhook_pull_request_auto_merge_enabled_pull_request_user.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequest {
  const WebhookPullRequestAutoMergeEnabledPullRequest({
    required this.links,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequest(
      links: WebhookPullRequestAutoMergeEnabledPullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason:
          WebhookPullRequestAutoMergeEnabledPullRequestActiveLockReason.fromJson(
            json['active_lock_reason'] as String,
          ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: WebhookPullRequestAutoMergeEnabledPullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestAutoMergeEnabledPullRequestAssignees.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      authorAssociation:
          WebhookPullRequestAutoMergeEnabledPullRequestAuthorAssociation.fromJson(
            json['author_association'] as String,
          ),
      autoMerge:
          WebhookPullRequestAutoMergeEnabledPullRequestAutoMerge.fromJson(
            json['auto_merge'] as Map<String, dynamic>,
          ),
      base: WebhookPullRequestAutoMergeEnabledPullRequestBase.fromJson(
      ...
      head: WebhookPullRequestAutoMergeEnabledPullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestAutoMergeEnabledPullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone:
          WebhookPullRequestAutoMergeEnabledPullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestAutoMergeEnabledPullRequestRequestedReviewers.fromJson(
                  e,
                ),
          )
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeams.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      ...
      state: WebhookPullRequestAutoMergeEnabledPullRequestState.fromJson(
      ...
      user: WebhookPullRequestAutoMergeEnabledPullRequestUser.fromJson(
  ...
  final WebhookPullRequestAutoMergeEnabledPullRequestActiveLockReason?
  activeLockReason;
  ...
  final WebhookPullRequestAutoMergeEnabledPullRequestAuthorAssociation
  authorAssociation;
  ...
  final List<WebhookPullRequestAutoMergeEnabledPullRequestRequestedReviewers>
  requestedReviewers;

  final List<WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeams>
  requestedTeams;
  ...
  WebhookPullRequestAutoMergeEnabledPullRequest copyWith({
    WebhookPullRequestAutoMergeEnabledPullRequestLinks? links,
    WebhookPullRequestAutoMergeEnabledPullRequestActiveLockReason? Function()?
    activeLockReason,
    int Function()? additions,
    WebhookPullRequestAutoMergeEnabledPullRequestAssignee? Function()? assignee,
    List<WebhookPullRequestAutoMergeEnabledPullRequestAssignees?>? assignees,
    WebhookPullRequestAutoMergeEnabledPullRequestAuthorAssociation?
    authorAssociation,
    WebhookPullRequestAutoMergeEnabledPullRequestAutoMerge? Function()?
    autoMerge,
    WebhookPullRequestAutoMergeEnabledPullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    WebhookPullRequestAutoMergeEnabledPullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<WebhookPullRequestAutoMergeEnabledPullRequestLabels>? labels,
    bool? locked,
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestMergedBy? Function()? mergedBy,
    WebhookPullRequestAutoMergeEnabledPullRequestMilestone? Function()?
    milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<WebhookPullRequestAutoMergeEnabledPullRequestRequestedReviewers>?
    requestedReviewers,
    List<WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeams>?
    requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    WebhookPullRequestAutoMergeEnabledPullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    WebhookPullRequestAutoMergeEnabledPullRequestUser? Function()? user,
  }) {
    return WebhookPullRequestAutoMergeEnabledPullRequest(
