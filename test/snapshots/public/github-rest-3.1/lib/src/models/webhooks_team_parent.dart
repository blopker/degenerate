...
import 'webhooks_team_parent_notification_setting.dart';
import 'webhooks_team_parent_privacy.dart';
import 'webhooks_team_parent_type.dart';

final class WebhooksTeamParent {
  const WebhooksTeamParent({
  ...
  factory WebhooksTeamParent.fromJson(Map<String, dynamic> json) {
    return WebhooksTeamParent(
      ...
      notificationSetting: WebhooksTeamParentNotificationSetting.fromJson(
  ...
  WebhooksTeamParent copyWith({
    ...
    String? nodeId,
    String? permission,
    WebhooksTeamParentPrivacy? privacy,
    WebhooksTeamParentNotificationSetting? notificationSetting,
    Uri? repositoriesUrl,
    String? slug,
    Uri? url,
    WebhooksTeamParentType? type,
