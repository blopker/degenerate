...
import 'migrations_update_import_request_vcs.dart';final class MigrationsUpdateImportRequest {const MigrationsUpdateImportRequest({this.vcsUsername, this.vcsPassword, this.vcs, this.tfvcProject, });
