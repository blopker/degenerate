...
final class FieldConfiguration {
  ...
  FieldConfiguration copyWith({
    int Function()? startDay,
    int Function()? duration,
    List<IterationSettings> Function()? iterations,
  }) {
    return FieldConfiguration(
  ...
  @override
  String toString() {
    return 'FieldConfiguration(startDay: $startDay, duration: $duration, iterations: $iterations)';
  }
}
