...
import 'security_and_analysis_secret_scanning_status.dart';final class SecurityAndAnalysisSecretScanning {const SecurityAndAnalysisSecretScanning({this.status});
