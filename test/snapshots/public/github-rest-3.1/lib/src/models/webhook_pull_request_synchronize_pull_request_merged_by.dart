...
import 'webhook_pull_request_synchronize_pull_request_merged_by_type.dart';

final class WebhookPullRequestSynchronizePullRequestMergedBy {
  const WebhookPullRequestSynchronizePullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestSynchronizePullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestSynchronizePullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestSynchronizePullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestSynchronizePullRequestMergedBy copyWith({
    ...
    WebhookPullRequestSynchronizePullRequestMergedByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestSynchronizePullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
