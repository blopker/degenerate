...
import 'inline_object69_pull_request_head_user_type.dart';

final class InlineObject69PullRequestHeadUser {
  const InlineObject69PullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestHeadUser copyWith({
    ...
    InlineObject69PullRequestHeadUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject69PullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
