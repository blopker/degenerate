...
final class SecretScanningLocationIssueBody {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('issue_body_url') &&
        json['issue_body_url'] is String;
  }

  SecretScanningLocationIssueBody copyWith({Uri? issueBodyUrl}) {
    return SecretScanningLocationIssueBody(
