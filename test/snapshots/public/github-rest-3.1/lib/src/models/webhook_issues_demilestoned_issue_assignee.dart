...
import 'webhook_issues_demilestoned_issue_assignee_type.dart';

final class WebhookIssuesDemilestonedIssueAssignee {
  const WebhookIssuesDemilestonedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesDemilestonedIssueAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesDemilestonedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesDemilestonedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesDemilestonedIssueAssignee copyWith({
    ...
    WebhookIssuesDemilestonedIssueAssigneeType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesDemilestonedIssueAssignee(
