...
import 'package:collection/collection.dart';import 'search_result_text_matches2_matches.dart';final class SearchResultTextMatches2 {const SearchResultTextMatches2({this.objectUrl, this.objectType, this.property, this.fragment, this.matches, });
