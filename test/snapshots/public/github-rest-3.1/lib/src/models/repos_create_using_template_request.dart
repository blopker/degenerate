...
final class ReposCreateUsingTemplateRequest {
  ...
  factory ReposCreateUsingTemplateRequest.fromJson(Map<String, dynamic> json) {
    return ReposCreateUsingTemplateRequest(
      ...
      includeAllBranches: json.containsKey('include_all_branches')
          ? json['include_all_branches'] as bool
          : false,
  ...
  ReposCreateUsingTemplateRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(owner, name, description, includeAllBranches, private);
  }

  @override
  String toString() {
    return 'ReposCreateUsingTemplateRequest(owner: $owner, name: $name, description: $description, includeAllBranches: $includeAllBranches, private: $private)';
  }
}
