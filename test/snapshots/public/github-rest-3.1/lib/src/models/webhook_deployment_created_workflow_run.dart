...
import 'webhook_deployment_created_workflow_run_actor.dart';
import 'webhook_deployment_created_workflow_run_conclusion.dart';
import 'webhook_deployment_created_workflow_run_head_repository.dart';
import 'webhook_deployment_created_workflow_run_pull_requests.dart';
import 'webhook_deployment_created_workflow_run_referenced_workflows.dart';
import 'webhook_deployment_created_workflow_run_repository.dart';
import 'webhook_deployment_created_workflow_run_status.dart';
import 'webhook_deployment_created_workflow_run_triggering_actor.dart';

final class WebhookDeploymentCreatedWorkflowRun {
  const WebhookDeploymentCreatedWorkflowRun({
    required this.actor,
    this.artifactsUrl,
    this.cancelUrl,
  ...
  factory WebhookDeploymentCreatedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentCreatedWorkflowRun(
      actor: WebhookDeploymentCreatedWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookDeploymentCreatedWorkflowRunConclusion.fromJson(
      ...
      headRepository: json['head_repository'] != null
          ? WebhookDeploymentCreatedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookDeploymentCreatedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookDeploymentCreatedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: json['repository'] != null
          ? WebhookDeploymentCreatedWorkflowRunRepository.fromJson(
      ...
      status: WebhookDeploymentCreatedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor: json['triggering_actor'] != null
          ? WebhookDeploymentCreatedWorkflowRunTriggeringActor.fromJson(
  ...
  final List<WebhookDeploymentCreatedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  WebhookDeploymentCreatedWorkflowRun copyWith({
    WebhookDeploymentCreatedWorkflowRunActor? Function()? actor,
    String Function()? artifactsUrl,
    String Function()? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    String Function()? checkSuiteUrl,
    WebhookDeploymentCreatedWorkflowRunConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? displayTitle,
    String? event,
    String? headBranch,
    String? Function()? headCommit,
    WebhookDeploymentCreatedWorkflowRunHeadRepository Function()?
    headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    ...
    List<WebhookDeploymentCreatedWorkflowRunPullRequests>? pullRequests,
    List<WebhookDeploymentCreatedWorkflowRunReferencedWorkflows>? Function()?
    referencedWorkflows,
    WebhookDeploymentCreatedWorkflowRunRepository Function()? repository,
    String Function()? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookDeploymentCreatedWorkflowRunStatus? status,
    WebhookDeploymentCreatedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
