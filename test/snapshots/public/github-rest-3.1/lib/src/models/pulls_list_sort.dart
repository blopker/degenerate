...
final class PullsListSort {
  const PullsListSort._(this.value);

  factory PullsListSort.fromJson(String json) {
    return switch (json) {
      'created' => created,
      'updated' => updated,
  ...
  static const List<PullsListSort> values = [
    created,
    updated,
    popularity,
    longRunning,
