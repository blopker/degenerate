...
import 'webhooks_team1_notification_setting.dart';
import 'webhooks_team1_parent.dart';
import 'webhooks_team1_privacy.dart';
import 'webhooks_team1_type.dart';
...
final class WebhooksTeam1 {
  ...
  factory WebhooksTeam1.fromJson(Map<String, dynamic> json) {
    return WebhooksTeam1(
      ...
      parent: json['parent'] != null
          ? WebhooksTeam1Parent.fromJson(json['parent'] as Map<String, dynamic>)
          : null,
      permission: json['permission'] as String?,
      privacy: json['privacy'] != null
          ? WebhooksTeam1Privacy.fromJson(json['privacy'] as String)
          : null,
      notificationSetting: json['notification_setting'] != null
          ? WebhooksTeam1NotificationSetting.fromJson(
      ...
      type: json['type'] != null
          ? WebhooksTeam1Type.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksTeam1 copyWith({
    ...
    WebhooksTeam1Parent? Function()? parent,
    String Function()? permission,
    WebhooksTeam1Privacy Function()? privacy,
    WebhooksTeam1NotificationSetting Function()? notificationSetting,
    Uri Function()? repositoriesUrl,
    String Function()? slug,
    Uri Function()? url,
    WebhooksTeam1Type Function()? type,
