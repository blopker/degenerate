...
import 'repository_invitation_permissions.dart';
...
final class RepositoryInvitation {
  ...
  factory RepositoryInvitation.fromJson(Map<String, dynamic> json) {
    return RepositoryInvitation(
      ...
      invitee: SimpleUser.fromJson(json['invitee'] as Map<String, dynamic>),
  ...
  RepositoryInvitation copyWith({
    int? id,
    MinimalRepository? repository,
    SimpleUser? Function()? invitee,
    SimpleUser? Function()? inviter,
    RepositoryInvitationPermissions? permissions,
    DateTime? createdAt,
  ...
  @override
  String toString() {
    return 'RepositoryInvitation(id: $id, repository: $repository, invitee: $invitee, inviter: $inviter, permissions: $permissions, createdAt: $createdAt, expired: $expired, url: $url, htmlUrl: $htmlUrl, nodeId: $nodeId)';
  }
}
