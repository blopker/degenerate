...
final class Release {
  ...
  factory Release.fromJson(Map<String, dynamic> json) {
    return Release(
      ...
      mentionsCount: json['mentions_count'] != null
          ? (json['mentions_count'] as num).toInt()
          : null,
  ...
  Release copyWith({
    ...
    return Release(
      ...
      mentionsCount: mentionsCount != null
          ? mentionsCount()
          : this.mentionsCount,
