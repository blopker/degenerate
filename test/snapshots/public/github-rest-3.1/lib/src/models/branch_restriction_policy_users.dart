...
final class BranchRestrictionPolicyUsers {
  const BranchRestrictionPolicyUsers({
    this.login,
    this.id,
    this.nodeId,
    this.avatarUrl,
  ...
  factory BranchRestrictionPolicyUsers.fromJson(Map<String, dynamic> json) {
  ...
  BranchRestrictionPolicyUsers copyWith({
