...
import 'repository_rule_params_status_check_configuration.dart';

final class RepositoryRuleRequiredStatusChecksParameters {
  ...
  RepositoryRuleRequiredStatusChecksParameters copyWith({
    bool Function()? doNotEnforceOnCreate,
    List<RepositoryRuleParamsStatusCheckConfiguration>? requiredStatusChecks,
  ...
  @override
  String toString() {
    return 'RepositoryRuleRequiredStatusChecksParameters(doNotEnforceOnCreate: $doNotEnforceOnCreate, requiredStatusChecks: $requiredStatusChecks, strictRequiredStatusChecksPolicy: $strictRequiredStatusChecksPolicy)';
  }
}
