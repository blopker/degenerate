...
import 'environment_protection_rules.dart';
...
final class Environment {
  ...
  factory Environment.fromJson(Map<String, dynamic> json) {
    return Environment(
      ...
      protectionRules: (json['protection_rules'] as List<dynamic>?)
          ?.map(
            (e) =>
                EnvironmentProtectionRules.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
  ...
  Environment copyWith({
    ...
    DateTime? createdAt,
    DateTime? updatedAt,
    List<EnvironmentProtectionRules> Function()? protectionRules,
  ...
  int get hashCode {
    return Object.hash(
      ...
      createdAt,
      updatedAt,
      Object.hashAll(protectionRules ?? const []),
      deploymentBranchPolicy,
    );
  }
  ...
  @override
  String toString() {
    return 'Environment(id: $id, nodeId: $nodeId, name: $name, url: $url, htmlUrl: $htmlUrl, createdAt: $createdAt, updatedAt: $updatedAt, protectionRules: $protectionRules, deploymentBranchPolicy: $deploymentBranchPolicy)';
  }
}
