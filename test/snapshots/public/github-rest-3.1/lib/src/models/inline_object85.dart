...
import 'inline_object85_type.dart';

final class InlineObject85 {
  const InlineObject85({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject85.fromJson(Map<String, dynamic> json) {
    return InlineObject85(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject85Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject85 copyWith({
    ...
    InlineObject85Type Function()? type,
    Uri Function()? url,
