...
import 'webhooks_issue_assignee_type.dart';

final class WebhooksIssueAssignee {
  const WebhooksIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssueAssignee.fromJson(Map<String, dynamic> json) {
    return WebhooksIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssueAssigneeType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssueAssignee copyWith({
    ...
    WebhooksIssueAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
