...
import 'webhook_workflow_run_requested_workflow_run_actor.dart';
import 'webhook_workflow_run_requested_workflow_run_conclusion.dart';
import 'webhook_workflow_run_requested_workflow_run_head_commit.dart';
import 'webhook_workflow_run_requested_workflow_run_head_repository.dart';
import 'webhook_workflow_run_requested_workflow_run_pull_requests.dart';
import 'webhook_workflow_run_requested_workflow_run_referenced_workflows.dart';
import 'webhook_workflow_run_requested_workflow_run_repository.dart';
import 'webhook_workflow_run_requested_workflow_run_status.dart';
import 'webhook_workflow_run_requested_workflow_run_triggering_actor.dart';

final class WebhookWorkflowRunRequestedWorkflowRun {
  const WebhookWorkflowRunRequestedWorkflowRun({
    required this.actor,
    required this.artifactsUrl,
    required this.cancelUrl,
    required this.checkSuiteId,
    required this.checkSuiteNodeId,
  ...
  factory WebhookWorkflowRunRequestedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunRequestedWorkflowRun(
      actor: WebhookWorkflowRunRequestedWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookWorkflowRunRequestedWorkflowRunConclusion.fromJson(
        json['conclusion'] as String,
      ),
      createdAt: DateTime.parse(json['created_at'] as String),
      event: json['event'] as String,
      headBranch: json['head_branch'] as String,
      headCommit: WebhookWorkflowRunRequestedWorkflowRunHeadCommit.fromJson(
        json['head_commit'] as Map<String, dynamic>,
      ),
      headRepository:
          WebhookWorkflowRunRequestedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookWorkflowRunRequestedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookWorkflowRunRequestedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: WebhookWorkflowRunRequestedWorkflowRunRepository.fromJson(
      ...
      status: WebhookWorkflowRunRequestedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookWorkflowRunRequestedWorkflowRunTriggeringActor.fromJson(
  ...
  final List<WebhookWorkflowRunRequestedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('actor') &&
        json.containsKey('artifacts_url') &&
        json['artifacts_url'] is String &&
        json.containsKey('cancel_url') &&
        json['cancel_url'] is String &&
        json.containsKey('check_suite_id') &&
        json['check_suite_id'] is num &&
        json.containsKey('check_suite_node_id') &&
        json['check_suite_node_id'] is String &&
        json.containsKey('check_suite_url') &&
        json['check_suite_url'] is String &&
        json.containsKey('conclusion') &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('event') &&
        json['event'] is String &&
        json.containsKey('head_branch') &&
        json['head_branch'] is String &&
        json.containsKey('head_commit') &&
        json.containsKey('head_repository') &&
        json.containsKey('head_sha') &&
        json['head_sha'] is String &&
        json.containsKey('html_url') &&
        json['html_url'] is String &&
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('jobs_url') &&
        json['jobs_url'] is String &&
        json.containsKey('logs_url') &&
        json['logs_url'] is String &&
        ...
        json['path'] is String &&
        json.containsKey('previous_attempt_url') &&
        json['previous_attempt_url'] is String &&
        json.containsKey('pull_requests') &&
        json.containsKey('repository') &&
        json.containsKey('rerun_url') &&
        json['rerun_url'] is String &&
        json.containsKey('run_attempt') &&
        json['run_attempt'] is num &&
        json.containsKey('run_number') &&
        json['run_number'] is num &&
        json.containsKey('run_started_at') &&
        json['run_started_at'] is String &&
        ...
        json['workflow_id'] is num &&
        json.containsKey('workflow_url') &&
        json['workflow_url'] is String &&
        json.containsKey('display_title') &&
        json['display_title'] is String;
  }

  WebhookWorkflowRunRequestedWorkflowRun copyWith({
    WebhookWorkflowRunRequestedWorkflowRunActor? Function()? actor,
    Uri? artifactsUrl,
    Uri? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    Uri? checkSuiteUrl,
    WebhookWorkflowRunRequestedWorkflowRunConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? event,
    String? Function()? headBranch,
    WebhookWorkflowRunRequestedWorkflowRunHeadCommit? headCommit,
    WebhookWorkflowRunRequestedWorkflowRunHeadRepository? headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    Uri? jobsUrl,
    ...
    String? nodeId,
    String? path,
    Uri? Function()? previousAttemptUrl,
    List<WebhookWorkflowRunRequestedWorkflowRunPullRequests>? pullRequests,
    List<WebhookWorkflowRunRequestedWorkflowRunReferencedWorkflows>? Function()?
    referencedWorkflows,
    WebhookWorkflowRunRequestedWorkflowRunRepository? repository,
    Uri? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookWorkflowRunRequestedWorkflowRunStatus? status,
    WebhookWorkflowRunRequestedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
    ...
    return WebhookWorkflowRunRequestedWorkflowRun(
      ...
      path: path ?? this.path,
      previousAttemptUrl: previousAttemptUrl != null
          ? previousAttemptUrl()
          : this.previousAttemptUrl,
      pullRequests: pullRequests ?? this.pullRequests,
      referencedWorkflows: referencedWorkflows != null
          ? referencedWorkflows()
          : this.referencedWorkflows,
      ...
      triggeringActor: triggeringActor != null
          ? triggeringActor()
  ...
  int get hashCode {
    return Object.hashAll([
      ...
      Object.hashAll(referencedWorkflows ?? const []),
      repository,
      rerunUrl,
      runAttempt,
      runNumber,
