...
import 'package:collection/collection.dart';import 'webhook_workflow_run_requested_workflow_run_actor.dart';import 'webhook_workflow_run_requested_workflow_run_conclusion.dart';import 'webhook_workflow_run_requested_workflow_run_head_commit.dart';import 'webhook_workflow_run_requested_workflow_run_head_repository.dart';import 'webhook_workflow_run_requested_workflow_run_pull_requests.dart';import 'webhook_workflow_run_requested_workflow_run_referenced_workflows.dart';import 'webhook_workflow_run_requested_workflow_run_repository.dart';import 'webhook_workflow_run_requested_workflow_run_status.dart';import 'webhook_workflow_run_requested_workflow_run_triggering_actor.dart';final class WebhookWorkflowRunRequestedWorkflowRun {const WebhookWorkflowRunRequestedWorkflowRun({required this.actor, required this.artifactsUrl, required this.cancelUrl, required this.checkSuiteId, required this.checkSuiteNodeId, required this.checkSuiteUrl, required this.conclusion, required this.createdAt, required this.event, required this.headBranch, required this.headCommit, required this.headRepository, required this.headSha, required this.htmlUrl, required this.id, required this.jobsUrl, required this.logsUrl, required this.name, required this.nodeId, required this.path, required this.previousAttemptUrl, required this.pullRequests, this.referencedWorkflows, required this.repository, required this.rerunUrl, required this.runAttempt, required this.runNumber, required this.runStartedAt, required this.status, required this.triggeringActor, required this.updatedAt, required this.url, required this.workflowId, required this.workflowUrl, required this.displayTitle, });
