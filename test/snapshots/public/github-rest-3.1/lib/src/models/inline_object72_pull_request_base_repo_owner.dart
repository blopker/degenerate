...
import 'inline_object72_pull_request_base_repo_owner_type.dart';

final class InlineObject72PullRequestBaseRepoOwner {
  const InlineObject72PullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestBaseRepoOwner copyWith({
    ...
    InlineObject72PullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
