...
import 'webhook_pull_request_review_comment_edited_pull_request_head_repo_owner_type.dart';final class WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner {const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
