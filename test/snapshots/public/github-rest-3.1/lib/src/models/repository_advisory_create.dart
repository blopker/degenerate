...
import 'package:collection/collection.dart';import 'repository_advisory_create_credits.dart';import 'repository_advisory_create_severity.dart';import 'repository_advisory_create_vulnerabilities.dart';final class RepositoryAdvisoryCreate {const RepositoryAdvisoryCreate({required this.summary, required this.description, this.cveId, required this.vulnerabilities, this.cweIds, this.credits, this.severity, this.cvssVectorString, this.startPrivateFork = false, });
