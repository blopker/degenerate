...
import 'added_to_project_issue_event_project_card.dart';
import 'integration.dart';
import 'simple_user.dart';

/// Added to Project Issue Event
final class AddedToProjectIssueEvent {
  ...
  factory AddedToProjectIssueEvent.fromJson(Map<String, dynamic> json) {
    return AddedToProjectIssueEvent(
      ...
      projectCard: json['project_card'] != null
          ? AddedToProjectIssueEventProjectCard.fromJson(
  ...
  AddedToProjectIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
    ...
    AddedToProjectIssueEventProjectCard Function()? projectCard,
  }) {
    return AddedToProjectIssueEvent(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'AddedToProjectIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, projectCard: $projectCard)';
  }
}
