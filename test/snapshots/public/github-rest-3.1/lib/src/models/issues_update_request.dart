...
import 'issues_update_request_labels.dart';
import 'issues_update_request_milestone.dart';
import 'issues_update_request_state.dart';
import 'issues_update_request_state_reason.dart';
import 'issues_update_request_title.dart';

final class IssuesUpdateRequest {
  ...
  factory IssuesUpdateRequest.fromJson(Map<String, dynamic> json) {
    return IssuesUpdateRequest(
      ...
      state: json['state'] != null
          ? IssuesUpdateRequestState.fromJson(json['state'] as String)
          : null,
      stateReason: json['state_reason'] != null
          ? IssuesUpdateRequestStateReason.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>?)
          ?.map((e) => IssuesUpdateRequestLabels.fromJson(e))
          .toList(),
  ...
  IssuesUpdateRequest copyWith({
    IssuesUpdateRequestTitle? Function()? title,
    String? Function()? body,
    String? Function()? assignee,
    IssuesUpdateRequestState Function()? state,
    IssuesUpdateRequestStateReason? Function()? stateReason,
    IssuesUpdateRequestMilestone? Function()? milestone,
    List<IssuesUpdateRequestLabels> Function()? labels,
    List<String> Function()? assignees,
  ...
  @override
  String toString() {
    return 'IssuesUpdateRequest(title: $title, body: $body, assignee: $assignee, state: $state, stateReason: $stateReason, milestone: $milestone, labels: $labels, assignees: $assignees, type: $type)';
  }
}
