...
final class ActivitySetThreadSubscriptionRequest {
  ...
  ActivitySetThreadSubscriptionRequest copyWith({bool Function()? ignored}) {
    return ActivitySetThreadSubscriptionRequest(
  ...
  @override
  int get hashCode {
    return ignored.hashCode;
  }

  @override
  String toString() {
    return 'ActivitySetThreadSubscriptionRequest(ignored: $ignored)';
  }
}
