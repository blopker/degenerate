...
import 'webhook_organization_member_invited_invitation_inviter_type.dart';

final class WebhookOrganizationMemberInvitedInvitationInviter {
  const WebhookOrganizationMemberInvitedInvitationInviter({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookOrganizationMemberInvitedInvitationInviter.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookOrganizationMemberInvitedInvitationInviter(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookOrganizationMemberInvitedInvitationInviterType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookOrganizationMemberInvitedInvitationInviter copyWith({
    ...
    WebhookOrganizationMemberInvitedInvitationInviterType Function()? type,
    Uri Function()? url,
