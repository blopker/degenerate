...
import 'reactions_create_for_issue_request_content.dart';final class ReactionsCreateForIssueRequest {const ReactionsCreateForIssueRequest({required this.content});
