...
import 'codespace_git_status.dart';
import 'codespace_location.dart';
import 'codespace_machine.dart';
import 'codespace_runtime_constraints.dart';
import 'codespace_state.dart';
...
final class Codespace {
  ...
  factory Codespace.fromJson(Map<String, dynamic> json) {
    return Codespace(
      ...
      runtimeConstraints: json['runtime_constraints'] != null
          ? CodespaceRuntimeConstraints.fromJson(
  ...
  Codespace copyWith({
    ...
    CodespaceRuntimeConstraints Function()? runtimeConstraints,
    ...
    String? Function()? lastKnownStopNotice,
  }) {
    return Codespace(
      id: id ?? this.id,
      name: name ?? this.name,
      ...
      retentionExpiresAt: retentionExpiresAt != null
          ? retentionExpiresAt()
          : this.retentionExpiresAt,
      lastKnownStopNotice: lastKnownStopNotice != null
          ? lastKnownStopNotice()
          : this.lastKnownStopNotice,
    );
  }
