...
final class ClassroomAssignmentGrade {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('assignment_name') &&
        json['assignment_name'] is String &&
        json.containsKey('assignment_url') &&
        json['assignment_url'] is String &&
        json.containsKey('starter_code_url') &&
        json['starter_code_url'] is String &&
        json.containsKey('github_username') &&
        json['github_username'] is String &&
        json.containsKey('roster_identifier') &&
        json['roster_identifier'] is String &&
        json.containsKey('student_repository_name') &&
        json['student_repository_name'] is String &&
        json.containsKey('student_repository_url') &&
        json['student_repository_url'] is String &&
        json.containsKey('submission_timestamp') &&
        json['submission_timestamp'] is String &&
        json.containsKey('points_awarded') &&
        json['points_awarded'] is num &&
        json.containsKey('points_available') &&
        json['points_available'] is num;
  }

  ClassroomAssignmentGrade copyWith({
    ...
    return ClassroomAssignmentGrade(
      ...
      studentRepositoryName:
          studentRepositoryName ?? this.studentRepositoryName,
  ...
  @override
  String toString() {
    return 'ClassroomAssignmentGrade(assignmentName: $assignmentName, assignmentUrl: $assignmentUrl, starterCodeUrl: $starterCodeUrl, githubUsername: $githubUsername, rosterIdentifier: $rosterIdentifier, studentRepositoryName: $studentRepositoryName, studentRepositoryUrl: $studentRepositoryUrl, submissionTimestamp: $submissionTimestamp, pointsAwarded: $pointsAwarded, pointsAvailable: $pointsAvailable, groupName: $groupName)';
  }
}
