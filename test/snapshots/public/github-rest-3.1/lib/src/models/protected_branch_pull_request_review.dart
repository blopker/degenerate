...
import 'protected_branch_pull_request_review_bypass_pull_request_allowances.dart';
import 'protected_branch_pull_request_review_dismissal_restrictions.dart';
...
final class ProtectedBranchPullRequestReview {
  ...
  factory ProtectedBranchPullRequestReview.fromJson(Map<String, dynamic> json) {
    return ProtectedBranchPullRequestReview(
      ...
      dismissalRestrictions: json['dismissal_restrictions'] != null
          ? ProtectedBranchPullRequestReviewDismissalRestrictions.fromJson(
              json['dismissal_restrictions'] as Map<String, dynamic>,
            )
          : null,
      bypassPullRequestAllowances:
          json['bypass_pull_request_allowances'] != null
          ? ProtectedBranchPullRequestReviewBypassPullRequestAllowances.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('dismiss_stale_reviews') &&
        json['dismiss_stale_reviews'] is bool &&
        json.containsKey('require_code_owner_reviews') &&
        json['require_code_owner_reviews'] is bool;
  }

  ProtectedBranchPullRequestReview copyWith({
    Uri Function()? url,
    ProtectedBranchPullRequestReviewDismissalRestrictions Function()?
    dismissalRestrictions,
    ProtectedBranchPullRequestReviewBypassPullRequestAllowances Function()?
    bypassPullRequestAllowances,
    ...
    return ProtectedBranchPullRequestReview(
      ...
      requireCodeOwnerReviews:
          requireCodeOwnerReviews ?? this.requireCodeOwnerReviews,
