...
import 'webhooks_release1_assets_uploader_type.dart';
...
final class WebhooksRelease1AssetsUploader {
  ...
  factory WebhooksRelease1AssetsUploader.fromJson(Map<String, dynamic> json) {
    return WebhooksRelease1AssetsUploader(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksRelease1AssetsUploaderType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksRelease1AssetsUploader copyWith({
    ...
    WebhooksRelease1AssetsUploaderType Function()? type,
    Uri Function()? url,
  }) {
    return WebhooksRelease1AssetsUploader(
  ...
  @override
  String toString() {
    return 'WebhooksRelease1AssetsUploader(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
