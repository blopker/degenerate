...
import 'webhook_pull_request_auto_merge_enabled_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
