...
import 'inline_object49_type.dart';

final class InlineObject49 {
  const InlineObject49({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject49.fromJson(Map<String, dynamic> json) {
    return InlineObject49(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject49Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject49 copyWith({
    ...
    InlineObject49Type Function()? type,
    Uri Function()? url,
