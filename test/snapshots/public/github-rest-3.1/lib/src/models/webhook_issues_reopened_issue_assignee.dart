...
import 'webhook_issues_reopened_issue_assignee_type.dart';

final class WebhookIssuesReopenedIssueAssignee {
  const WebhookIssuesReopenedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesReopenedIssueAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesReopenedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesReopenedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesReopenedIssueAssignee copyWith({
    ...
    WebhookIssuesReopenedIssueAssigneeType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesReopenedIssueAssignee(
