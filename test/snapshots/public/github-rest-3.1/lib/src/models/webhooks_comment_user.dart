...
import 'webhooks_comment_user_type.dart';

final class WebhooksCommentUser {
  const WebhooksCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksCommentUser.fromJson(Map<String, dynamic> json) {
    return WebhooksCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksCommentUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksCommentUser copyWith({
    ...
    WebhooksCommentUserType Function()? type,
    Uri Function()? url,
