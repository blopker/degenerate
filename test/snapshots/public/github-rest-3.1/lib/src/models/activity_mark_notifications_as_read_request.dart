...
final class ActivityMarkNotificationsAsReadRequest {
  ...
  ActivityMarkNotificationsAsReadRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(lastReadAt, read);
  }

  @override
  String toString() {
    return 'ActivityMarkNotificationsAsReadRequest(lastReadAt: $lastReadAt, read: $read)';
  }
}
