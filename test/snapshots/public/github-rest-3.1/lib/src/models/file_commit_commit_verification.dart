...
final class FileCommitCommitVerification {
  ...
  FileCommitCommitVerification copyWith({
  ...
  @override
  String toString() {
    return 'FileCommitCommitVerification(verified: $verified, reason: $reason, signature: $signature, payload: $payload, verifiedAt: $verifiedAt)';
  }
}
