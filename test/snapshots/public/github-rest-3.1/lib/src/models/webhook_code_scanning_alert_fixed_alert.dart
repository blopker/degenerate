...
import 'webhook_code_scanning_alert_fixed_alert_dismissed_by.dart';
import 'webhook_code_scanning_alert_fixed_alert_dismissed_reason.dart';
import 'webhook_code_scanning_alert_fixed_alert_most_recent_instance.dart';
import 'webhook_code_scanning_alert_fixed_alert_rule.dart';
import 'webhook_code_scanning_alert_fixed_alert_state.dart';
import 'webhook_code_scanning_alert_fixed_alert_tool.dart';

/// The code scanning alert involved in the event.
final class WebhookCodeScanningAlertFixedAlert {
  const WebhookCodeScanningAlertFixedAlert({
    this.assignees,
  ...
  factory WebhookCodeScanningAlertFixedAlert.fromJson(
    ...
    return WebhookCodeScanningAlertFixedAlert(
      ...
      dismissedBy: WebhookCodeScanningAlertFixedAlertDismissedBy.fromJson(
        json['dismissed_by'] as Map<String, dynamic>,
      ),
      dismissedComment: json['dismissed_comment'] as String?,
      dismissedReason:
          WebhookCodeScanningAlertFixedAlertDismissedReason.fromJson(
            json['dismissed_reason'] as String,
          ),
      fixedAt: json['fixed_at'] as String?,
      htmlUrl: Uri.parse(json['html_url'] as String),
      instancesUrl: json['instances_url'] != null
          ? Uri.parse(json['instances_url'] as String)
          : null,
      mostRecentInstance: json['most_recent_instance'] != null
          ? WebhookCodeScanningAlertFixedAlertMostRecentInstance.fromJson(
              json['most_recent_instance'] as Map<String, dynamic>,
            )
          : null,
      number: (json['number'] as num).toInt(),
      rule: WebhookCodeScanningAlertFixedAlertRule.fromJson(
        json['rule'] as Map<String, dynamic>,
      ),
      state: WebhookCodeScanningAlertFixedAlertState.fromJson(
        json['state'] as String,
      ),
      tool: WebhookCodeScanningAlertFixedAlertTool.fromJson(
  ...
  final WebhookCodeScanningAlertFixedAlertMostRecentInstance?
  mostRecentInstance;
  ...
  WebhookCodeScanningAlertFixedAlert copyWith({
    List<SimpleUser> Function()? assignees,
    DateTime? createdAt,
    DateTime? Function()? dismissedAt,
    WebhookCodeScanningAlertFixedAlertDismissedBy? Function()? dismissedBy,
    String? Function()? dismissedComment,
    WebhookCodeScanningAlertFixedAlertDismissedReason? Function()?
    dismissedReason,
    String? Function()? fixedAt,
    Uri? htmlUrl,
    Uri Function()? instancesUrl,
    WebhookCodeScanningAlertFixedAlertMostRecentInstance? Function()?
    mostRecentInstance,
    int? number,
    WebhookCodeScanningAlertFixedAlertRule? rule,
    WebhookCodeScanningAlertFixedAlertState? Function()? state,
    WebhookCodeScanningAlertFixedAlertTool? tool,
    Uri? url,
  }) {
    return WebhookCodeScanningAlertFixedAlert(
