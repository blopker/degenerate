...
import 'dependabot_create_or_update_org_secret_request_selected_repository_ids.dart';
import 'dependabot_create_or_update_org_secret_request_visibility.dart';

final class DependabotCreateOrUpdateOrgSecretRequest {
  ...
  factory DependabotCreateOrUpdateOrgSecretRequest.fromJson(
    ...
    return DependabotCreateOrUpdateOrgSecretRequest(
      ...
      selectedRepositoryIds: (json['selected_repository_ids'] as List<dynamic>?)
          ?.map(
            (e) =>
                DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds.fromJson(
  ...
  final List<DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds>?
  ...
  DependabotCreateOrUpdateOrgSecretRequest copyWith({
    String Function()? encryptedValue,
    String Function()? keyId,
    DependabotCreateOrUpdateOrgSecretRequestVisibility? visibility,
    List<DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds>
    Function()?
    selectedRepositoryIds,
  }) {
    return DependabotCreateOrUpdateOrgSecretRequest(
  ...
  @override
  String toString() {
    return 'DependabotCreateOrUpdateOrgSecretRequest(encryptedValue: $encryptedValue, keyId: $keyId, visibility: $visibility, selectedRepositoryIds: $selectedRepositoryIds)';
  }
}
