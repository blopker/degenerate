...
import 'converted_note_to_issue_issue_event_project_card.dart';
...
final class ConvertedNoteToIssueIssueEvent {
  ...
  factory ConvertedNoteToIssueIssueEvent.fromJson(Map<String, dynamic> json) {
    return ConvertedNoteToIssueIssueEvent(
      ...
      projectCard: json['project_card'] != null
          ? ConvertedNoteToIssueIssueEventProjectCard.fromJson(
  ...
  ConvertedNoteToIssueIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
    ...
    ConvertedNoteToIssueIssueEventProjectCard Function()? projectCard,
  }) {
    return ConvertedNoteToIssueIssueEvent(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'ConvertedNoteToIssueIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, projectCard: $projectCard)';
  }
}
