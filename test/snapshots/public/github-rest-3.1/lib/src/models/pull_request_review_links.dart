...
import 'pull_request_review_links_html.dart';
import 'pull_request_review_links_pull_request.dart';

final class PullRequestReviewLinks {
  ...
  PullRequestReviewLinks copyWith({
    PullRequestReviewLinksHtml? html,
    PullRequestReviewLinksPullRequest? pullRequest,
  }) {
    return PullRequestReviewLinks(
      html: html ?? this.html,
