...
import 'webhooks_release1_author_type.dart';

final class WebhooksRelease1Author {
  const WebhooksRelease1Author({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksRelease1Author.fromJson(Map<String, dynamic> json) {
    return WebhooksRelease1Author(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksRelease1AuthorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksRelease1Author copyWith({
    ...
    WebhooksRelease1AuthorType Function()? type,
    Uri Function()? url,
