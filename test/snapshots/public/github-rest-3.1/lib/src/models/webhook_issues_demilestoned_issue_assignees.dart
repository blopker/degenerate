...
import 'webhook_issues_demilestoned_issue_assignees_type.dart';

final class WebhookIssuesDemilestonedIssueAssignees {
  const WebhookIssuesDemilestonedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesDemilestonedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesDemilestonedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesDemilestonedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesDemilestonedIssueAssignees copyWith({
    ...
    WebhookIssuesDemilestonedIssueAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesDemilestonedIssueAssignees(
  ...
  @override
  String toString() {
    return 'WebhookIssuesDemilestonedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
