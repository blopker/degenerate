...
import 'webhook_deployment_status_created_deployment_status_performed_via_github_app_owner_type.dart';
...
final class WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner {
  ...
  factory WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwnerType?
  type;
  ...
  copyWith({
    Uri Function()? avatarUrl,
    bool Function()? deleted,
    String? Function()? email,
    String Function()? eventsUrl,
    Uri Function()? followersUrl,
    String Function()? followingUrl,
    String Function()? gistsUrl,
    ...
    Uri Function()? organizationsUrl,
    Uri Function()? receivedEventsUrl,
    Uri Function()? reposUrl,
    bool Function()? siteAdmin,
    String Function()? starredUrl,
    Uri Function()? subscriptionsUrl,
    WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwnerType
    Function()?
    type,
    Uri Function()? url,
    ...
    return WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner(
      ...
      organizationsUrl: organizationsUrl != null
          ? organizationsUrl()
          : this.organizationsUrl,
      receivedEventsUrl: receivedEventsUrl != null
          ? receivedEventsUrl()
          : this.receivedEventsUrl,
      ...
      subscriptionsUrl: subscriptionsUrl != null
          ? subscriptionsUrl()
          : this.subscriptionsUrl,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other
                is WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner &&
  ...
  @override
  String toString() {
    return 'WebhookDeploymentStatusCreatedDeploymentStatusPerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
