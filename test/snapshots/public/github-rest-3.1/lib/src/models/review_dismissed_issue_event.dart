...
import 'review_dismissed_issue_event_dismissed_review.dart';
...
final class ReviewDismissedIssueEvent {
  ...
  ReviewDismissedIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
  ...
  @override
  String toString() {
    return 'ReviewDismissedIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, dismissedReview: $dismissedReview)';
  }
}
