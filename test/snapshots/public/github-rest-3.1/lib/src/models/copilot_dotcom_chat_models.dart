...
final class CopilotDotcomChatModels {
  const CopilotDotcomChatModels({
    this.name,
    this.isCustomModel,
  ...
  factory CopilotDotcomChatModels.fromJson(Map<String, dynamic> json) {
    return CopilotDotcomChatModels(
  ...
  CopilotDotcomChatModels copyWith({
  ...
  @override
  String toString() {
    return 'CopilotDotcomChatModels(name: $name, isCustomModel: $isCustomModel, customModelTrainingDate: $customModelTrainingDate, totalEngagedUsers: $totalEngagedUsers, totalChats: $totalChats)';
  }
}
