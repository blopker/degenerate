...
import 'gist_history_change_status.dart';
...
final class GistHistory {
  ...
  factory GistHistory.fromJson(Map<String, dynamic> json) {
    return GistHistory(
      ...
      changeStatus: json['change_status'] != null
          ? GistHistoryChangeStatus.fromJson(
  ...
  GistHistory copyWith({
    SimpleUser? Function()? user,
    String Function()? version,
    DateTime Function()? committedAt,
    GistHistoryChangeStatus Function()? changeStatus,
    Uri Function()? url,
  }) {
    return GistHistory(
  ...
  @override
  int get hashCode {
    return Object.hash(user, version, committedAt, changeStatus, url);
  }

  @override
  String toString() {
    return 'GistHistory(user: $user, version: $version, committedAt: $committedAt, changeStatus: $changeStatus, url: $url)';
  }
}
