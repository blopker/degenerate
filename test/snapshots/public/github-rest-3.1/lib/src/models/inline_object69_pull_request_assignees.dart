...
import 'inline_object69_pull_request_assignees_type.dart';

final class InlineObject69PullRequestAssignees {
  const InlineObject69PullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestAssignees copyWith({
    ...
    InlineObject69PullRequestAssigneesType Function()? type,
    Uri Function()? url,
