...
import 'inline_object66_pull_request_merged_by_type.dart';

final class InlineObject66PullRequestMergedBy {
  const InlineObject66PullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestMergedBy copyWith({
    ...
    InlineObject66PullRequestMergedByType Function()? type,
    Uri Function()? url,
