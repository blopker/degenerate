...
import 'webhook_code_scanning_alert_reopened_by_user_alert_most_recent_instance.dart';
import 'webhook_code_scanning_alert_reopened_by_user_alert_rule.dart';
import 'webhook_code_scanning_alert_reopened_by_user_alert_state.dart';
import 'webhook_code_scanning_alert_reopened_by_user_alert_tool.dart';

/// The code scanning alert involved in the event.
final class WebhookCodeScanningAlertReopenedByUserAlert {
  const WebhookCodeScanningAlertReopenedByUserAlert({
    this.assignees,
  ...
  factory WebhookCodeScanningAlertReopenedByUserAlert.fromJson(
    ...
    return WebhookCodeScanningAlertReopenedByUserAlert(
      ...
      mostRecentInstance: json['most_recent_instance'] != null
          ? WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance.fromJson(
              json['most_recent_instance'] as Map<String, dynamic>,
            )
          : null,
      number: (json['number'] as num).toInt(),
      rule: WebhookCodeScanningAlertReopenedByUserAlertRule.fromJson(
        json['rule'] as Map<String, dynamic>,
      ),
      state: WebhookCodeScanningAlertReopenedByUserAlertState.fromJson(
        json['state'] as String,
      ),
      tool: WebhookCodeScanningAlertReopenedByUserAlertTool.fromJson(
  ...
  final WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance?
  mostRecentInstance;
  ...
  WebhookCodeScanningAlertReopenedByUserAlert copyWith({
    List<SimpleUser> Function()? assignees,
    DateTime? createdAt,
    String? Function()? dismissedAt,
    String? Function()? dismissedBy,
    String? Function()? dismissedComment,
    String? Function()? dismissedReason,
    String? Function()? fixedAt,
    Uri? htmlUrl,
    WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance? Function()?
    mostRecentInstance,
    int? number,
    WebhookCodeScanningAlertReopenedByUserAlertRule? rule,
    WebhookCodeScanningAlertReopenedByUserAlertState? Function()? state,
    WebhookCodeScanningAlertReopenedByUserAlertTool? tool,
    Uri? url,
  }) {
    return WebhookCodeScanningAlertReopenedByUserAlert(
