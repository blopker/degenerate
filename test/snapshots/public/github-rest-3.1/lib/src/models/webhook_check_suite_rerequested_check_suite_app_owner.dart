...
import 'webhook_check_suite_rerequested_check_suite_app_owner_type.dart';

final class WebhookCheckSuiteRerequestedCheckSuiteAppOwner {
  const WebhookCheckSuiteRerequestedCheckSuiteAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCheckSuiteRerequestedCheckSuiteAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCheckSuiteRerequestedCheckSuiteAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCheckSuiteRerequestedCheckSuiteAppOwner copyWith({
    ...
    WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookCheckSuiteRerequestedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
