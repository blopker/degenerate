...
import 'webhook_pull_request_unlocked_pull_request_assignee_type.dart';

final class WebhookPullRequestUnlockedPullRequestAssignee {
  const WebhookPullRequestUnlockedPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlockedPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlockedPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlockedPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlockedPullRequestAssignee copyWith({
    ...
    WebhookPullRequestUnlockedPullRequestAssigneeType Function()? type,
    Uri Function()? url,
