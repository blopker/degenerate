...
final class CodeScanningCodeqlDatabase {
  ...
  CodeScanningCodeqlDatabase copyWith({
    int? id,
    String? name,
    String? language,
    SimpleUser? uploader,
  ...
  @override
  String toString() {
    return 'CodeScanningCodeqlDatabase(id: $id, name: $name, language: $language, uploader: $uploader, contentType: $contentType, size: $size, createdAt: $createdAt, updatedAt: $updatedAt, url: $url, commitOid: $commitOid)';
  }
}
