...
import 'package:collection/collection.dart';final class UsersListAttestationsBulkRequest {const UsersListAttestationsBulkRequest({required this.subjectDigests, this.predicateType, });
