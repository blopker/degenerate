...
import 'org_private_registry_configuration_with_selected_repositories_registry_type.dart';
import 'org_private_registry_configuration_with_selected_repositories_visibility.dart';
...
final class OrgPrivateRegistryConfigurationWithSelectedRepositories {
  ...
  OrgPrivateRegistryConfigurationWithSelectedRepositories copyWith({
    String? name,
  ...
  @override
  String toString() {
    return 'OrgPrivateRegistryConfigurationWithSelectedRepositories(name: $name, registryType: $registryType, url: $url, username: $username, replacesBase: $replacesBase, visibility: $visibility, selectedRepositoryIds: $selectedRepositoryIds, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
