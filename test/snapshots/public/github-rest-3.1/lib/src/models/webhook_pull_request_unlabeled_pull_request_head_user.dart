...
import 'webhook_pull_request_unlabeled_pull_request_head_user_type.dart';

final class WebhookPullRequestUnlabeledPullRequestHeadUser {
  const WebhookPullRequestUnlabeledPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlabeledPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlabeledPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlabeledPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlabeledPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestUnlabeledPullRequestHeadUserType Function()? type,
    Uri Function()? url,
