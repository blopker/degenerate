...
import 'webhook_pull_request_unlabeled_pull_request_assignee_type.dart';

final class WebhookPullRequestUnlabeledPullRequestAssignee {
  const WebhookPullRequestUnlabeledPullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnlabeledPullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlabeledPullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnlabeledPullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnlabeledPullRequestAssignee copyWith({
    ...
    WebhookPullRequestUnlabeledPullRequestAssigneeType Function()? type,
    Uri Function()? url,
