...
import 'branch_protection.dart';
import 'short_branch_commit.dart';
...
final class ShortBranch {
  ...
  factory ShortBranch.fromJson(Map<String, dynamic> json) {
    return ShortBranch(
      ...
      protection: json['protection'] != null
          ? BranchProtection.fromJson(
              json['protection'] as Map<String, dynamic>,
            )
          : null,
      protectionUrl: json['protection_url'] != null
          ? Uri.parse(json['protection_url'] as String)
          : null,
    );
  }
  ...
  ShortBranch copyWith({
    String? name,
    ShortBranchCommit? commit,
    bool? protected,
    BranchProtection Function()? protection,
    Uri Function()? protectionUrl,
  }) {
    return ShortBranch(
      name: name ?? this.name,
  ...
  @override
  int get hashCode {
    return Object.hash(name, commit, protected, protection, protectionUrl);
  }
