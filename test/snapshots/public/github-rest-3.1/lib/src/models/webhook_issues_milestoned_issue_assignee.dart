...
import 'webhook_issues_milestoned_issue_assignee_type.dart';

final class WebhookIssuesMilestonedIssueAssignee {
  const WebhookIssuesMilestonedIssueAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesMilestonedIssueAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesMilestonedIssueAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesMilestonedIssueAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesMilestonedIssueAssignee copyWith({
    ...
    WebhookIssuesMilestonedIssueAssigneeType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesMilestonedIssueAssignee(
