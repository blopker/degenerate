...
final class GetAllBudgets {
  ...
  factory GetAllBudgets.fromJson(Map<String, dynamic> json) {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('budgets');
  }

  GetAllBudgets copyWith({
    List<Budget>? budgets,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is GetAllBudgets &&
            const ListEquality<dynamic>().equals(budgets, other.budgets) &&
  ...
  @override
  int get hashCode {
    return Object.hash(Object.hashAll(budgets), hasNextPage, totalCount);
  }

  @override
  String toString() {
    return 'GetAllBudgets(budgets: $budgets, hasNextPage: $hasNextPage, totalCount: $totalCount)';
  }
}
