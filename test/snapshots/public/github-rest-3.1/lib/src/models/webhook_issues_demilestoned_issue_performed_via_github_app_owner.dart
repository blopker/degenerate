...
import 'webhook_issues_demilestoned_issue_performed_via_github_app_owner_type.dart';

final class WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner {
  const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
