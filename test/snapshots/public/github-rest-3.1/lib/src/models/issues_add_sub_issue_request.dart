...
final class IssuesAddSubIssueRequest {
  ...
  IssuesAddSubIssueRequest copyWith({
    int? subIssueId,
    bool Function()? replaceParent,
  }) {
    return IssuesAddSubIssueRequest(
      subIssueId: subIssueId ?? this.subIssueId,
      replaceParent: replaceParent != null
          ? replaceParent()
          : this.replaceParent,
    );
  }
  ...
  @override
  int get hashCode {
    return Object.hash(subIssueId, replaceParent);
  }

  @override
  String toString() {
    return 'IssuesAddSubIssueRequest(subIssueId: $subIssueId, replaceParent: $replaceParent)';
  }
}
