...
import 'webhook_organization_member_invited_invitation_inviter.dart';

/// The invitation for the user or email if the action is `member_invited`.
final class WebhookOrganizationMemberInvitedInvitation {
  const WebhookOrganizationMemberInvitedInvitation({
  ...
  factory WebhookOrganizationMemberInvitedInvitation.fromJson(
    ...
    return WebhookOrganizationMemberInvitedInvitation(
      ...
      inviter: WebhookOrganizationMemberInvitedInvitationInviter.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created_at') &&
        ...
        json['failed_at'] is String &&
        json.containsKey('failed_reason') &&
        json['failed_reason'] is String &&
        json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('invitation_teams_url') &&
        json['invitation_teams_url'] is String &&
        ...
        json['role'] is String &&
        json.containsKey('team_count') &&
        json['team_count'] is num;
  }

  WebhookOrganizationMemberInvitedInvitation copyWith({
    DateTime? createdAt,
    String? Function()? email,
    DateTime? Function()? failedAt,
    String? Function()? failedReason,
    double? id,
    Uri? invitationTeamsUrl,
    WebhookOrganizationMemberInvitedInvitationInviter? Function()? inviter,
    String? Function()? login,
    String? nodeId,
    String? role,
    double? teamCount,
    String Function()? invitationSource,
  }) {
    return WebhookOrganizationMemberInvitedInvitation(
  ...
  @override
  String toString() {
    return 'WebhookOrganizationMemberInvitedInvitation(createdAt: $createdAt, email: $email, failedAt: $failedAt, failedReason: $failedReason, id: $id, invitationTeamsUrl: $invitationTeamsUrl, inviter: $inviter, login: $login, nodeId: $nodeId, role: $role, teamCount: $teamCount, invitationSource: $invitationSource)';
  }
}
