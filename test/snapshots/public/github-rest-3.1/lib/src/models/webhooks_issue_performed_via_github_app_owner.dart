...
import 'webhooks_issue_performed_via_github_app_owner_type.dart';

final class WebhooksIssuePerformedViaGithubAppOwner {
  const WebhooksIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhooksIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhooksIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhooksIssuePerformedViaGithubAppOwnerType Function()? type,
    Uri Function()? url,
