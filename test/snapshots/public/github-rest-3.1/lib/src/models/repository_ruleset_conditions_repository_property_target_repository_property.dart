...
import 'repository_ruleset_conditions_repository_property_spec.dart';

final class RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty {
  ...
  copyWith({
    List<RepositoryRulesetConditionsRepositoryPropertySpec> Function()? include,
    List<RepositoryRulesetConditionsRepositoryPropertySpec> Function()? exclude,
  }) {
    return RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty(
  ...
  @override
  String toString() {
    return 'RepositoryRulesetConditionsRepositoryPropertyTargetRepositoryProperty(include: $include, exclude: $exclude)';
  }
}
