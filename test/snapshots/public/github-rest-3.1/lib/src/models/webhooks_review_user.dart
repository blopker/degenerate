...
import 'webhooks_review_user_type.dart';

final class WebhooksReviewUser {
  const WebhooksReviewUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksReviewUser.fromJson(Map<String, dynamic> json) {
    return WebhooksReviewUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksReviewUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksReviewUser copyWith({
    ...
    WebhooksReviewUserType Function()? type,
    Uri Function()? url,
