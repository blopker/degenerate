...
import 'inline_object72_pull_request_user_type.dart';

final class InlineObject72PullRequestUser {
  const InlineObject72PullRequestUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestUser.fromJson(Map<String, dynamic> json) {
    return InlineObject72PullRequestUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestUserType.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject72PullRequestUser copyWith({
    ...
    InlineObject72PullRequestUserType Function()? type,
    Uri Function()? url,
