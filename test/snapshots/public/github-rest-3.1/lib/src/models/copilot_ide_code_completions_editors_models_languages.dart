...
final class CopilotIdeCodeCompletionsEditorsModelsLanguages {
  const CopilotIdeCodeCompletionsEditorsModelsLanguages({
    this.name,
  ...
  factory CopilotIdeCodeCompletionsEditorsModelsLanguages.fromJson(
    Map<String, dynamic> json,
  ) {
    return CopilotIdeCodeCompletionsEditorsModelsLanguages(
      name: json['name'] as String?,
      totalEngagedUsers: json['total_engaged_users'] != null
          ? (json['total_engaged_users'] as num).toInt()
          : null,
      totalCodeSuggestions: json['total_code_suggestions'] != null
          ? (json['total_code_suggestions'] as num).toInt()
          : null,
      totalCodeAcceptances: json['total_code_acceptances'] != null
          ? (json['total_code_acceptances'] as num).toInt()
          : null,
      totalCodeLinesSuggested: json['total_code_lines_suggested'] != null
          ? (json['total_code_lines_suggested'] as num).toInt()
          : null,
      totalCodeLinesAccepted: json['total_code_lines_accepted'] != null
          ? (json['total_code_lines_accepted'] as num).toInt()
          : null,
    );
  }
  ...
  CopilotIdeCodeCompletionsEditorsModelsLanguages copyWith({
    String Function()? name,
    int Function()? totalEngagedUsers,
    int Function()? totalCodeSuggestions,
    int Function()? totalCodeAcceptances,
    int Function()? totalCodeLinesSuggested,
    int Function()? totalCodeLinesAccepted,
  }) {
    return CopilotIdeCodeCompletionsEditorsModelsLanguages(
      name: name != null ? name() : this.name,
      totalEngagedUsers: totalEngagedUsers != null
          ? totalEngagedUsers()
          : this.totalEngagedUsers,
      totalCodeSuggestions: totalCodeSuggestions != null
          ? totalCodeSuggestions()
          : this.totalCodeSuggestions,
      totalCodeAcceptances: totalCodeAcceptances != null
          ? totalCodeAcceptances()
          : this.totalCodeAcceptances,
      totalCodeLinesSuggested: totalCodeLinesSuggested != null
          ? totalCodeLinesSuggested()
          : this.totalCodeLinesSuggested,
      totalCodeLinesAccepted: totalCodeLinesAccepted != null
  ...
  @override
  String toString() {
    return 'CopilotIdeCodeCompletionsEditorsModelsLanguages(name: $name, totalEngagedUsers: $totalEngagedUsers, totalCodeSuggestions: $totalCodeSuggestions, totalCodeAcceptances: $totalCodeAcceptances, totalCodeLinesSuggested: $totalCodeLinesSuggested, totalCodeLinesAccepted: $totalCodeLinesAccepted)';
  }
}
