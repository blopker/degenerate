...
import 'issues_create_milestone_request_state.dart';

final class IssuesCreateMilestoneRequest {
  ...
  factory IssuesCreateMilestoneRequest.fromJson(Map<String, dynamic> json) {
    return IssuesCreateMilestoneRequest(
      ...
      state: json.containsKey('state')
          ? IssuesCreateMilestoneRequestState.fromJson(json['state'] as String)
  ...
  IssuesCreateMilestoneRequest copyWith({
    String? title,
    IssuesCreateMilestoneRequestState Function()? state,
  ...
  @override
  String toString() {
    return 'IssuesCreateMilestoneRequest(title: $title, state: $state, description: $description, dueOn: $dueOn)';
  }
}
