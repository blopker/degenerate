...
import 'get_budget_budget_alerting.dart';import 'get_budget_budget_scope.dart';import 'get_budget_budget_type.dart';final class GetBudget {const GetBudget({required this.id, required this.budgetScope, required this.budgetEntityName, required this.budgetAmount, required this.preventFurtherUsage, required this.budgetProductSku, required this.budgetType, required this.budgetAlerting, });
