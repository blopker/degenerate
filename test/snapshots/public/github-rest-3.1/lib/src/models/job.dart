...
import 'job_conclusion.dart';
import 'job_status.dart';
import 'job_steps.dart';
...
final class Job {
  ...
  factory Job.fromJson(Map<String, dynamic> json) {
    return Job(
      ...
      steps: (json['steps'] as List<dynamic>?)
          ?.map((e) => JobSteps.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['name'] is String &&
        json.containsKey('check_run_url') &&
  ...
  Job copyWith({
    ...
    JobStatus? status,
    JobConclusion? Function()? conclusion,
    DateTime? createdAt,
    DateTime? startedAt,
    DateTime? Function()? completedAt,
    String? name,
    List<JobSteps> Function()? steps,
    String? checkRunUrl,
    List<String>? labels,
