...
final class LockedIssueEvent {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('lock_reason') &&
        json['lock_reason'] is String;
  }

  LockedIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
  ...
  @override
  String toString() {
    return 'LockedIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, lockReason: $lockReason)';
  }
}
