...
import 'organization_actions_variable_visibility.dart';
...
final class OrganizationActionsVariable {
  ...
  factory OrganizationActionsVariable.fromJson(Map<String, dynamic> json) {
    return OrganizationActionsVariable(
      ...
      selectedRepositoriesUrl: json['selected_repositories_url'] != null
          ? Uri.parse(json['selected_repositories_url'] as String)
          : null,
    );
  }
  ...
  OrganizationActionsVariable copyWith({
    String? name,
    String? value,
    DateTime? createdAt,
    DateTime? updatedAt,
    OrganizationActionsVariableVisibility? visibility,
    Uri Function()? selectedRepositoriesUrl,
  }) {
    return OrganizationActionsVariable(
      name: name ?? this.name,
  ...
  @override
  String toString() {
    return 'OrganizationActionsVariable(name: $name, value: $value, createdAt: $createdAt, updatedAt: $updatedAt, visibility: $visibility, selectedRepositoriesUrl: $selectedRepositoriesUrl)';
  }
}
