...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_team_removed_from_repository_action.dart';import 'webhook_team_removed_from_repository_repository.dart';import 'webhooks_team1.dart';final class WebhookTeamRemovedFromRepository {const WebhookTeamRemovedFromRepository({required this.action, this.enterprise, this.installation, required this.organization, this.repository, required this.sender, required this.team, });
...
factory WebhookTeamRemovedFromRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamRemovedFromRepository(
  ...
  repository: json['repository'] != null
        ? WebhookTeamRemovedFromRepositoryRepository.fromJson(json['repository'] as Map<String, dynamic>)
        : null,
