...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_ruleset.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_repository_ruleset_edited_action.dart';import 'webhook_repository_ruleset_edited_changes.dart';final class WebhookRepositoryRulesetEdited {const WebhookRepositoryRulesetEdited({required this.action, this.enterprise, this.installation, this.organization, this.repository, required this.repositoryRuleset, this.changes, required this.sender, });
...
factory WebhookRepositoryRulesetEdited.fromJson(Map<String, dynamic> json) { return WebhookRepositoryRulesetEdited(
  ...
  changes: json['changes'] != null
        ? WebhookRepositoryRulesetEditedChanges.fromJson(json['changes'] as Map<String, dynamic>)
        : null,
