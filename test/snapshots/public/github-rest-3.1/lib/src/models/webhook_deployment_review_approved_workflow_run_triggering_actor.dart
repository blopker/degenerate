...
import 'webhook_deployment_review_approved_workflow_run_triggering_actor_type.dart';

final class WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor {
  const WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewApprovedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookDeploymentReviewApprovedWorkflowRunTriggeringActorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentReviewApprovedWorkflowRunTriggeringActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
