...
final class RunnerApplication {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('os') &&
        json['os'] is String &&
        json.containsKey('architecture') &&
  ...
  RunnerApplication copyWith({
    String? os,
    String? architecture,
    String? downloadUrl,
    String? filename,
    String Function()? tempDownloadToken,
    String Function()? sha256Checksum,
  }) {
    return RunnerApplication(
      os: os ?? this.os,
      ...
      tempDownloadToken: tempDownloadToken != null
          ? tempDownloadToken()
          : this.tempDownloadToken,
  ...
  @override
  String toString() {
    return 'RunnerApplication(os: $os, architecture: $architecture, downloadUrl: $downloadUrl, filename: $filename, tempDownloadToken: $tempDownloadToken, sha256Checksum: $sha256Checksum)';
  }
}
