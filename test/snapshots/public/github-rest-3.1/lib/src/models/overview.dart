...
import 'overview_domains.dart';
import 'overview_ssh_key_fingerprints.dart';
...
final class Overview {
  ...
  factory Overview.fromJson(Map<String, dynamic> json) {
    return Overview(
      ...
      sshKeyFingerprints: json['ssh_key_fingerprints'] != null
          ? OverviewSshKeyFingerprints.fromJson(
      ...
      githubEnterpriseImporter:
          (json['github_enterprise_importer'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList(),
      ...
      pages: (json['pages'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      importer: (json['importer'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      actions: (json['actions'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      actionsMacos: (json['actions_macos'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      codespaces: (json['codespaces'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      dependabot: (json['dependabot'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
      copilot: (json['copilot'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('verifiable_password_authentication') &&
        json['verifiable_password_authentication'] is bool;
  }

  Overview copyWith({
    bool? verifiablePasswordAuthentication,
    OverviewSshKeyFingerprints Function()? sshKeyFingerprints,
    List<String> Function()? sshKeys,
    List<String> Function()? hooks,
    List<String> Function()? githubEnterpriseImporter,
    List<String> Function()? web,
    List<String> Function()? api,
    List<String> Function()? git,
    List<String> Function()? packages,
    List<String> Function()? pages,
    List<String> Function()? importer,
    List<String> Function()? actions,
    List<String> Function()? actionsMacos,
    List<String> Function()? codespaces,
    List<String> Function()? dependabot,
    List<String> Function()? copilot,
    OverviewDomains Function()? domains,
  }) {
    return Overview(
      verifiablePasswordAuthentication:
          verifiablePasswordAuthentication ??
          this.verifiablePasswordAuthentication,
      sshKeyFingerprints: sshKeyFingerprints != null
          ? sshKeyFingerprints()
          : this.sshKeyFingerprints,
      sshKeys: sshKeys != null ? sshKeys() : this.sshKeys,
      hooks: hooks != null ? hooks() : this.hooks,
      githubEnterpriseImporter: githubEnterpriseImporter != null
          ? githubEnterpriseImporter()
          : this.githubEnterpriseImporter,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is Overview &&
            ...
            const ListEquality<dynamic>().equals(sshKeys, other.sshKeys) &&
            const ListEquality<dynamic>().equals(hooks, other.hooks) &&
            const ListEquality<dynamic>().equals(
              githubEnterpriseImporter,
              other.githubEnterpriseImporter,
            ) &&
            const ListEquality<dynamic>().equals(web, other.web) &&
            const ListEquality<dynamic>().equals(api, other.api) &&
            const ListEquality<dynamic>().equals(git, other.git) &&
            const ListEquality<dynamic>().equals(packages, other.packages) &&
            const ListEquality<dynamic>().equals(pages, other.pages) &&
            const ListEquality<dynamic>().equals(importer, other.importer) &&
  ...
  int get hashCode {
    return Object.hash(
      verifiablePasswordAuthentication,
      sshKeyFingerprints,
      Object.hashAll(sshKeys ?? const []),
      Object.hashAll(hooks ?? const []),
      Object.hashAll(githubEnterpriseImporter ?? const []),
      Object.hashAll(web ?? const []),
      Object.hashAll(api ?? const []),
      Object.hashAll(git ?? const []),
      Object.hashAll(packages ?? const []),
      Object.hashAll(pages ?? const []),
      Object.hashAll(importer ?? const []),
      Object.hashAll(actions ?? const []),
      Object.hashAll(actionsMacos ?? const []),
      Object.hashAll(codespaces ?? const []),
      Object.hashAll(dependabot ?? const []),
      Object.hashAll(copilot ?? const []),
      domains,
    );
  }
