...
import 'check_suite_preference_preferences.dart';
...
final class CheckSuitePreference {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('preferences') && json.containsKey('repository');
  }

  CheckSuitePreference copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(preferences, repository);
  }
