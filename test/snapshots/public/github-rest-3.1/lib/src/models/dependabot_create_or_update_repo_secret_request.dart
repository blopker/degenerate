...
final class DependabotCreateOrUpdateRepoSecretRequest {
  ...
  DependabotCreateOrUpdateRepoSecretRequest copyWith({
  ...
  @override
  String toString() {
    return 'DependabotCreateOrUpdateRepoSecretRequest(encryptedValue: $encryptedValue, keyId: $keyId)';
  }
}
