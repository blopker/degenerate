...
final class SimpleClassroom {
  ...
  @override
  int get hashCode {
    return Object.hash(id, name, archived, url);
  }

  @override
  String toString() {
    return 'SimpleClassroom(id: $id, name: $name, archived: $archived, url: $url)';
  }
}
