...
final class ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('users_url') &&
        json['users_url'] is String &&
  ...
  ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions copyWith({
    Uri? url,
    Uri? usersUrl,
    Uri? teamsUrl,
  ...
  @override
  String toString() {
    return 'ProtectedBranchRequiredPullRequestReviewsDismissalRestrictions(url: $url, usersUrl: $usersUrl, teamsUrl: $teamsUrl, users: $users, teams: $teams, apps: $apps)';
  }
}
