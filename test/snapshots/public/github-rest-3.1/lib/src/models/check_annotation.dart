...
final class CheckAnnotation {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('path') &&
        ...
        json.containsKey('annotation_level') &&
        json['annotation_level'] is String &&
        json.containsKey('title') &&
        json['title'] is String &&
        json.containsKey('message') &&
        json['message'] is String &&
        json.containsKey('raw_details') &&
        json['raw_details'] is String &&
        json.containsKey('blob_href') &&
        json['blob_href'] is String;
  }

  CheckAnnotation copyWith({
    String? path,
    int? startLine,
    int? endLine,
    int? Function()? startColumn,
    int? Function()? endColumn,
    String? Function()? annotationLevel,
