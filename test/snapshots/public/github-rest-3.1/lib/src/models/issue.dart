...
import 'issue_state_reason.dart';
import 'issue_type.dart';
import 'milestone.dart';
import 'reaction_rollup.dart';
...
final class Issue {
  ...
  factory Issue.fromJson(Map<String, dynamic> json) {
    return Issue(
      ...
      stateReason: json['state_reason'] != null
          ? IssueStateReason.fromJson(json['state_reason'] as String)
          : null,
      title: json['title'] as String,
      body: json['body'] as String?,
      user: SimpleUser.fromJson(json['user'] as Map<String, dynamic>),
      labels: (json['labels'] as List<dynamic>)
          .map((e) => IssueLabels.fromJson(e))
          .toList(),
      ...
      closedBy: json['closed_by'] != null
          ? SimpleUser.fromJson(json['closed_by'] as Map<String, dynamic>)
          : null,
      ...
      authorAssociation: json['author_association'] != null
          ? AuthorAssociation.fromJson(json['author_association'] as String)
          : null,
      ...
      subIssuesSummary: json['sub_issues_summary'] != null
          ...
          : null,
      parentIssueUrl: json['parent_issue_url'] != null
          ? Uri.parse(json['parent_issue_url'] as String)
          : null,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (parentIssueUrl != null)
        'parent_issue_url': parentIssueUrl?.toString(),
