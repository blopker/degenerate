...
import 'webhook_deployment_review_rejected_workflow_run_triggering_actor_type.dart';

final class WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor {
  const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType Function()?
    type,
    Uri Function()? url,
