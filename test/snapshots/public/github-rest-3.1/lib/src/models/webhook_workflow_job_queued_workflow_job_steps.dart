...
import 'webhook_workflow_job_queued_workflow_job_steps_conclusion.dart';import 'webhook_workflow_job_queued_workflow_job_steps_status.dart';final class WebhookWorkflowJobQueuedWorkflowJobSteps {const WebhookWorkflowJobQueuedWorkflowJobSteps({required this.completedAt, required this.conclusion, required this.name, required this.number, required this.startedAt, required this.status, });
