...
import 'inline_object63_requested_reviewer_type.dart';

final class InlineObject63RequestedReviewer {
  const InlineObject63RequestedReviewer({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63RequestedReviewer.fromJson(Map<String, dynamic> json) {
    return InlineObject63RequestedReviewer(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63RequestedReviewerType.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject63RequestedReviewer copyWith({
    ...
    InlineObject63RequestedReviewerType Function()? type,
    Uri Function()? url,
