...
final class CopilotIdeChatEditorsModels {
  const CopilotIdeChatEditorsModels({
    this.name,
    this.isCustomModel,
  ...
  factory CopilotIdeChatEditorsModels.fromJson(Map<String, dynamic> json) {
    return CopilotIdeChatEditorsModels(
      ...
      totalEngagedUsers: json['total_engaged_users'] != null
          ...
          : null,
      totalChats: json['total_chats'] != null
          ? (json['total_chats'] as num).toInt()
          : null,
      totalChatInsertionEvents: json['total_chat_insertion_events'] != null
          ? (json['total_chat_insertion_events'] as num).toInt()
          : null,
      totalChatCopyEvents: json['total_chat_copy_events'] != null
          ? (json['total_chat_copy_events'] as num).toInt()
          : null,
    );
  }
  ...
  CopilotIdeChatEditorsModels copyWith({
    String Function()? name,
    bool Function()? isCustomModel,
    String? Function()? customModelTrainingDate,
    int Function()? totalEngagedUsers,
    int Function()? totalChats,
    int Function()? totalChatInsertionEvents,
    int Function()? totalChatCopyEvents,
  }) {
    return CopilotIdeChatEditorsModels(
      name: name != null ? name() : this.name,
      isCustomModel: isCustomModel != null
          ? isCustomModel()
          : this.isCustomModel,
      customModelTrainingDate: customModelTrainingDate != null
      ...
      totalChatInsertionEvents: totalChatInsertionEvents != null
          ? totalChatInsertionEvents()
          : this.totalChatInsertionEvents,
      totalChatCopyEvents: totalChatCopyEvents != null
          ? totalChatCopyEvents()
          : this.totalChatCopyEvents,
    );
  }
  ...
  @override
  String toString() {
    return 'CopilotIdeChatEditorsModels(name: $name, isCustomModel: $isCustomModel, customModelTrainingDate: $customModelTrainingDate, totalEngagedUsers: $totalEngagedUsers, totalChats: $totalChats, totalChatInsertionEvents: $totalChatInsertionEvents, totalChatCopyEvents: $totalChatCopyEvents)';
  }
}
