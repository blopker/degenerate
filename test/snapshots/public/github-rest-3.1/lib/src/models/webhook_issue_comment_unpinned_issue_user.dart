...
final class WebhookIssueCommentUnpinnedIssueUser {
  const WebhookIssueCommentUnpinnedIssueUser({
    this.avatarUrl,
    this.eventsUrl,
    this.followersUrl,
    this.followingUrl,
  ...
  factory WebhookIssueCommentUnpinnedIssueUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentUnpinnedIssueUser(
  ...
  WebhookIssueCommentUnpinnedIssueUser copyWith({
