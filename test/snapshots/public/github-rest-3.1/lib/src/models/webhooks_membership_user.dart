...
import 'webhooks_membership_user_type.dart';

final class WebhooksMembershipUser {
  const WebhooksMembershipUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksMembershipUser.fromJson(Map<String, dynamic> json) {
    return WebhooksMembershipUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksMembershipUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksMembershipUser copyWith({
    ...
    WebhooksMembershipUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksMembershipUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
