...
import 'repos_update_pull_request_review_protection_request_bypass_pull_request_allowances.dart';
import 'repos_update_pull_request_review_protection_request_dismissal_restrictions.dart';

final class ReposUpdatePullRequestReviewProtectionRequest {
  ...
  factory ReposUpdatePullRequestReviewProtectionRequest.fromJson(
    ...
    return ReposUpdatePullRequestReviewProtectionRequest(
      dismissalRestrictions: json['dismissal_restrictions'] != null
          ? ReposUpdatePullRequestReviewProtectionRequestDismissalRestrictions.fromJson(
      ...
      requiredApprovingReviewCount:
          json['required_approving_review_count'] != null
          ? (json['required_approving_review_count'] as num).toInt()
          : null,
      requireLastPushApproval: json.containsKey('require_last_push_approval')
          ? json['require_last_push_approval'] as bool
          : false,
      bypassPullRequestAllowances:
          json['bypass_pull_request_allowances'] != null
          ? ReposUpdatePullRequestReviewProtectionRequestBypassPullRequestAllowances.fromJson(
  ...
  ReposUpdatePullRequestReviewProtectionRequest copyWith({
    ...
    return ReposUpdatePullRequestReviewProtectionRequest(
      dismissalRestrictions: dismissalRestrictions != null
          ? dismissalRestrictions()
          : this.dismissalRestrictions,
      dismissStaleReviews: dismissStaleReviews != null
          ? dismissStaleReviews()
          : this.dismissStaleReviews,
      requireCodeOwnerReviews: requireCodeOwnerReviews != null
  ...
  @override
  String toString() {
    return 'ReposUpdatePullRequestReviewProtectionRequest(dismissalRestrictions: $dismissalRestrictions, dismissStaleReviews: $dismissStaleReviews, requireCodeOwnerReviews: $requireCodeOwnerReviews, requiredApprovingReviewCount: $requiredApprovingReviewCount, requireLastPushApproval: $requireLastPushApproval, bypassPullRequestAllowances: $bypassPullRequestAllowances)';
  }
}
