...
final class CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos {
  ...
  factory CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos.fromJson(
    ...
    return CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos(
      ...
      repositoryFullNames: (json['repository_full_names'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('repository_count') &&
        json['repository_count'] is num &&
        json.containsKey('repository_full_names');
  }

  CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos copyWith({
    int? repositoryCount,
    ...
    return identical(this, other) ||
        other is CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos &&
            ...
            const ListEquality<dynamic>().equals(
              repositoryFullNames,
              other.repositoryFullNames,
            );
  }

  @override
  int get hashCode {
    return Object.hash(repositoryCount, Object.hashAll(repositoryFullNames));
  }

  @override
  String toString() {
    return 'CodeScanningVariantAnalysisSkippedRepositoriesNotFoundRepos(repositoryCount: $repositoryCount, repositoryFullNames: $repositoryFullNames)';
  }
}
