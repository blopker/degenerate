...
import 'webhook_check_suite_rerequested_check_suite_app.dart';
import 'webhook_check_suite_rerequested_check_suite_conclusion.dart';
import 'webhook_check_suite_rerequested_check_suite_head_commit.dart';
import 'webhook_check_suite_rerequested_check_suite_pull_requests.dart';
import 'webhook_check_suite_rerequested_check_suite_status.dart';

/// The [check_suite](https://docs.github.com/rest/checks/suites#get-a-check-suite).
final class WebhookCheckSuiteRerequestedCheckSuite {
  const WebhookCheckSuiteRerequestedCheckSuite({
    required this.after,
    required this.app,
  ...
  factory WebhookCheckSuiteRerequestedCheckSuite.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCheckSuiteRerequestedCheckSuite(
      after: json['after'] as String,
      app: WebhookCheckSuiteRerequestedCheckSuiteApp.fromJson(
        json['app'] as Map<String, dynamic>,
      ),
      before: json['before'] as String,
      checkRunsUrl: Uri.parse(json['check_runs_url'] as String),
      conclusion: WebhookCheckSuiteRerequestedCheckSuiteConclusion.fromJson(
        json['conclusion'] as String,
      ),
      createdAt: DateTime.parse(json['created_at'] as String),
      headBranch: json['head_branch'] as String,
      headCommit: WebhookCheckSuiteRerequestedCheckSuiteHeadCommit.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookCheckSuiteRerequestedCheckSuitePullRequests.fromJson(
      ...
      status: WebhookCheckSuiteRerequestedCheckSuiteStatus.fromJson(
  ...
  WebhookCheckSuiteRerequestedCheckSuite copyWith({
    String? Function()? after,
    WebhookCheckSuiteRerequestedCheckSuiteApp? app,
    String? Function()? before,
    Uri? checkRunsUrl,
    WebhookCheckSuiteRerequestedCheckSuiteConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? Function()? headBranch,
    WebhookCheckSuiteRerequestedCheckSuiteHeadCommit? headCommit,
    String? headSha,
    int? id,
    int? latestCheckRunsCount,
    String? nodeId,
    List<WebhookCheckSuiteRerequestedCheckSuitePullRequests>? pullRequests,
  ...
  @override
  String toString() {
    return 'WebhookCheckSuiteRerequestedCheckSuite(after: $after, app: $app, before: $before, checkRunsUrl: $checkRunsUrl, conclusion: $conclusion, createdAt: $createdAt, headBranch: $headBranch, headCommit: $headCommit, headSha: $headSha, id: $id, latestCheckRunsCount: $latestCheckRunsCount, nodeId: $nodeId, pullRequests: $pullRequests, rerequestable: $rerequestable, runsRerequestable: $runsRerequestable, status: $status, updatedAt: $updatedAt, url: $url)';
  }
}
