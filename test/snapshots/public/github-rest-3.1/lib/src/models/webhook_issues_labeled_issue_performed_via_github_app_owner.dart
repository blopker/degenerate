...
import 'webhook_issues_labeled_issue_performed_via_github_app_owner_type.dart';

final class WebhookIssuesLabeledIssuePerformedViaGithubAppOwner {
  const WebhookIssuesLabeledIssuePerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesLabeledIssuePerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesLabeledIssuePerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesLabeledIssuePerformedViaGithubAppOwner copyWith({
    ...
    WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType Function()? type,
    Uri Function()? url,
