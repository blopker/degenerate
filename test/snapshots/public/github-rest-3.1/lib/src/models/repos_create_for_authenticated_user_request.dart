...
import 'repos_create_for_authenticated_user_request_merge_commit_message.dart';import 'repos_create_for_authenticated_user_request_merge_commit_title.dart';import 'repos_create_for_authenticated_user_request_squash_merge_commit_message.dart';import 'repos_create_for_authenticated_user_request_squash_merge_commit_title.dart';final class ReposCreateForAuthenticatedUserRequest {const ReposCreateForAuthenticatedUserRequest({required this.name, this.description, this.homepage, this.private = false, this.hasIssues = true, this.hasProjects = true, this.hasWiki = true, this.hasDiscussions = false, this.teamId, this.autoInit = false, this.gitignoreTemplate, this.licenseTemplate, this.allowSquashMerge = true, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowAutoMerge = false, this.deleteBranchOnMerge = false, this.squashMergeCommitTitle, this.squashMergeCommitMessage, this.mergeCommitTitle, this.mergeCommitMessage, this.hasDownloads = true, this.isTemplate = false, });
