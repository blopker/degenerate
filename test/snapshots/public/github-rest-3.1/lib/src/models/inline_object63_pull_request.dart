...
import 'inline_object63_pull_request_active_lock_reason.dart';
import 'inline_object63_pull_request_assignee.dart';
import 'inline_object63_pull_request_assignees.dart';
import 'inline_object63_pull_request_author_association.dart';
import 'inline_object63_pull_request_auto_merge.dart';
import 'inline_object63_pull_request_base.dart';
import 'inline_object63_pull_request_head.dart';
import 'inline_object63_pull_request_labels.dart';
import 'inline_object63_pull_request_links.dart';
import 'inline_object63_pull_request_merged_by.dart';
import 'inline_object63_pull_request_milestone.dart';
import 'inline_object63_pull_request_requested_reviewers.dart';
import 'inline_object63_pull_request_requested_teams.dart';
import 'inline_object63_pull_request_state.dart';
import 'inline_object63_pull_request_user.dart';

final class InlineObject63PullRequest {
  const InlineObject63PullRequest({
    required this.links,
  ...
  factory InlineObject63PullRequest.fromJson(Map<String, dynamic> json) {
    return InlineObject63PullRequest(
      links: InlineObject63PullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason: InlineObject63PullRequestActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: InlineObject63PullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => InlineObject63PullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: InlineObject63PullRequestAuthorAssociation.fromJson(
        json['author_association'] as String,
      ),
      autoMerge: InlineObject63PullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: InlineObject63PullRequestBase.fromJson(
      ...
      head: InlineObject63PullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => InlineObject63PullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? InlineObject63PullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: InlineObject63PullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map((e) => InlineObject63PullRequestRequestedReviewers.fromJson(e))
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => InlineObject63PullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      user: InlineObject63PullRequestUser.fromJson(
  ...
  InlineObject63PullRequest copyWith({
    InlineObject63PullRequestLinks? links,
    InlineObject63PullRequestActiveLockReason? Function()? activeLockReason,
    int Function()? additions,
    InlineObject63PullRequestAssignee? Function()? assignee,
    List<InlineObject63PullRequestAssignees?>? assignees,
    InlineObject63PullRequestAuthorAssociation? authorAssociation,
    InlineObject63PullRequestAutoMerge? Function()? autoMerge,
    InlineObject63PullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    InlineObject63PullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<InlineObject63PullRequestLabels>? labels,
    bool? locked,
    ...
    InlineObject63PullRequestMergedBy? Function()? mergedBy,
    InlineObject63PullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<InlineObject63PullRequestRequestedReviewers>? requestedReviewers,
    List<InlineObject63PullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    InlineObject63PullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    InlineObject63PullRequestUser? Function()? user,
  }) {
    return InlineObject63PullRequest(
