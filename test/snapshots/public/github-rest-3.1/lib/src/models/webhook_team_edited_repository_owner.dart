...
import 'webhook_team_edited_repository_owner_type.dart';

final class WebhookTeamEditedRepositoryOwner {
  const WebhookTeamEditedRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookTeamEditedRepositoryOwner.fromJson(Map<String, dynamic> json) {
    return WebhookTeamEditedRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookTeamEditedRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookTeamEditedRepositoryOwner copyWith({
    ...
    WebhookTeamEditedRepositoryOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookTeamEditedRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
