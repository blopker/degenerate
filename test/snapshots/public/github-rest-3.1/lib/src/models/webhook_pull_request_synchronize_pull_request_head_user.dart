...
import 'webhook_pull_request_synchronize_pull_request_head_user_type.dart';

final class WebhookPullRequestSynchronizePullRequestHeadUser {
  const WebhookPullRequestSynchronizePullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestSynchronizePullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestSynchronizePullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestSynchronizePullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestSynchronizePullRequestHeadUser copyWith({
    ...
    WebhookPullRequestSynchronizePullRequestHeadUserType Function()? type,
    Uri Function()? url,
