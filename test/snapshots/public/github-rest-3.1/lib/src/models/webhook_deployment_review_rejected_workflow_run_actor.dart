...
import 'webhook_deployment_review_rejected_workflow_run_actor_type.dart';

final class WebhookDeploymentReviewRejectedWorkflowRunActor {
  const WebhookDeploymentReviewRejectedWorkflowRunActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewRejectedWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRejectedWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewRejectedWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewRejectedWorkflowRunActor copyWith({
    ...
    WebhookDeploymentReviewRejectedWorkflowRunActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentReviewRejectedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
