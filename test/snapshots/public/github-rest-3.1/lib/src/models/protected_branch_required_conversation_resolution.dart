...
final class ProtectedBranchRequiredConversationResolution {
  ...
  ProtectedBranchRequiredConversationResolution copyWith({
  ...
  @override
  String toString() {
    return 'ProtectedBranchRequiredConversationResolution(enabled: $enabled)';
  }
}
