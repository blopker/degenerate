...
final class TimelineCommitCommentedEvent {
  ...
  TimelineCommitCommentedEvent copyWith({
    String Function()? event,
    String Function()? nodeId,
    String Function()? commitId,
    List<CommitComment> Function()? comments,
  }) {
    return TimelineCommitCommentedEvent(
  ...
  @override
  String toString() {
    return 'TimelineCommitCommentedEvent(event: $event, nodeId: $nodeId, commitId: $commitId, comments: $comments)';
  }
}
