...
import 'inline_object87_type.dart';

final class InlineObject87 {
  const InlineObject87({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject87.fromJson(Map<String, dynamic> json) {
    return InlineObject87(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject87Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject87 copyWith({
    ...
    InlineObject87Type Function()? type,
    Uri Function()? url,
