...
final class SecretScanningLocationIssueTitle {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('issue_title_url') &&
        json['issue_title_url'] is String;
  }

  SecretScanningLocationIssueTitle copyWith({Uri? issueTitleUrl}) {
    return SecretScanningLocationIssueTitle(
