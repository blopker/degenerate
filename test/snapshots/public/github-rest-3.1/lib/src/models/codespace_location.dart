...
final class CodespaceLocation {
  ...
  static const CodespaceLocation southEastAsia = CodespaceLocation._(
    'SouthEastAsia',
  );
  ...
  static const List<CodespaceLocation> values = [
    eastUs,
    southEastAsia,
    westEurope,
    westUs2,
  ...
  @override
  String toString() {
    return 'CodespaceLocation($value)';
  }
}
