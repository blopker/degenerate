...
import 'marketplace_listing_plan_price_model.dart';
...
final class MarketplaceListingPlan {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('accounts_url') &&
        json['accounts_url'] is String &&
        json.containsKey('id') &&
        json['id'] is num &&
  ...
  MarketplaceListingPlan copyWith({
    Uri? url,
    Uri? accountsUrl,
    int? id,
    int? number,
    ...
    MarketplaceListingPlanPriceModel? priceModel,
    bool? hasFreeTrial,
