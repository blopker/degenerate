...
final class ReposReplaceAllTopicsRequest {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('names');
  }

  ReposReplaceAllTopicsRequest copyWith({List<String>? names}) {
    return ReposReplaceAllTopicsRequest(names: names ?? this.names);
  }
  ...
  @override
  int get hashCode {
    return Object.hashAll(names).hashCode;
  }

  @override
  String toString() {
    return 'ReposReplaceAllTopicsRequest(names: $names)';
  }
}
