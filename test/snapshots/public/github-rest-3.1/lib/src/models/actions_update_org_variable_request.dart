...
import 'package:collection/collection.dart';import 'actions_update_org_variable_request_visibility.dart';final class ActionsUpdateOrgVariableRequest {const ActionsUpdateOrgVariableRequest({this.name, this.value, this.visibility, this.selectedRepositoryIds, });
