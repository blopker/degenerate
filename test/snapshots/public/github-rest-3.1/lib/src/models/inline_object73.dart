...
import 'inline_object73_type.dart';

final class InlineObject73 {
  const InlineObject73({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject73.fromJson(Map<String, dynamic> json) {
    return InlineObject73(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject73Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject73 copyWith({
    ...
    InlineObject73Type Function()? type,
    Uri Function()? url,
