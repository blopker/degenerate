...
import 'package:collection/collection.dart';import 'repository_rule_params_required_reviewer_configuration.dart';import 'repository_rule_pull_request_parameters_allowed_merge_methods.dart';final class RepositoryRulePullRequestParameters {const RepositoryRulePullRequestParameters({this.allowedMergeMethods, required this.dismissStaleReviewsOnPush, required this.requireCodeOwnerReview, required this.requireLastPushApproval, required this.requiredApprovingReviewCount, required this.requiredReviewThreadResolution, this.requiredReviewers, });
