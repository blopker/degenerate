...
import 'repository_rule_params_required_reviewer_configuration.dart';
import 'repository_rule_pull_request_parameters_allowed_merge_methods.dart';

final class RepositoryRulePullRequestParameters {
  ...
  factory RepositoryRulePullRequestParameters.fromJson(
    ...
    return RepositoryRulePullRequestParameters(
      allowedMergeMethods: (json['allowed_merge_methods'] as List<dynamic>?)
          ?.map(
            (e) =>
                RepositoryRulePullRequestParametersAllowedMergeMethods.fromJson(
                  e as String,
                ),
          )
          .toList(),
      ...
      requiredReviewers: (json['required_reviewers'] as List<dynamic>?)
          ?.map(
            (e) => RepositoryRuleParamsRequiredReviewerConfiguration.fromJson(
  ...
  final List<RepositoryRulePullRequestParametersAllowedMergeMethods>?
  allowedMergeMethods;
  ...
  final List<RepositoryRuleParamsRequiredReviewerConfiguration>?
  requiredReviewers;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('dismiss_stale_reviews_on_push') &&
        ...
        json.containsKey('require_last_push_approval') &&
        json['require_last_push_approval'] is bool &&
        json.containsKey('required_approving_review_count') &&
        json['required_approving_review_count'] is num &&
        json.containsKey('required_review_thread_resolution') &&
        json['required_review_thread_resolution'] is bool;
  }

  RepositoryRulePullRequestParameters copyWith({
    List<RepositoryRulePullRequestParametersAllowedMergeMethods> Function()?
    allowedMergeMethods,
    ...
    List<RepositoryRuleParamsRequiredReviewerConfiguration> Function()?
    requiredReviewers,
  }) {
    return RepositoryRulePullRequestParameters(
      ...
      requireLastPushApproval:
          requireLastPushApproval ?? this.requireLastPushApproval,
      requiredApprovingReviewCount:
          requiredApprovingReviewCount ?? this.requiredApprovingReviewCount,
      requiredReviewThreadResolution:
          requiredReviewThreadResolution ?? this.requiredReviewThreadResolution,
      requiredReviewers: requiredReviewers != null
          ? requiredReviewers()
          : this.requiredReviewers,
    );
  }
  ...
  int get hashCode {
    return Object.hash(
      Object.hashAll(allowedMergeMethods ?? const []),
      dismissStaleReviewsOnPush,
      requireCodeOwnerReview,
      requireLastPushApproval,
      requiredApprovingReviewCount,
      requiredReviewThreadResolution,
      Object.hashAll(requiredReviewers ?? const []),
    );
  }
