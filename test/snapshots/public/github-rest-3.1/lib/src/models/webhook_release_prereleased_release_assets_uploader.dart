...
import 'webhook_release_prereleased_release_assets_uploader_type.dart';

final class WebhookReleasePrereleasedReleaseAssetsUploader {
  const WebhookReleasePrereleasedReleaseAssetsUploader({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookReleasePrereleasedReleaseAssetsUploader.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookReleasePrereleasedReleaseAssetsUploader(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookReleasePrereleasedReleaseAssetsUploaderType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookReleasePrereleasedReleaseAssetsUploader copyWith({
    ...
    WebhookReleasePrereleasedReleaseAssetsUploaderType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookReleasePrereleasedReleaseAssetsUploader(
  ...
  @override
  String toString() {
    return 'WebhookReleasePrereleasedReleaseAssetsUploader(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)';
  }
}
