...
import 'inline_object72_pull_request_assignee_type.dart';

final class InlineObject72PullRequestAssignee {
  const InlineObject72PullRequestAssignee({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestAssignee.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestAssignee(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestAssigneeType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestAssignee copyWith({
    ...
    InlineObject72PullRequestAssigneeType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject72PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
