...
import 'inline_object69_pull_request_merged_by_type.dart';

final class InlineObject69PullRequestMergedBy {
  const InlineObject69PullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject69PullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject69PullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject69PullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject69PullRequestMergedBy copyWith({
    ...
    InlineObject69PullRequestMergedByType Function()? type,
    Uri Function()? url,
