...
import 'inline_object51_type.dart';

final class InlineObject51 {
  const InlineObject51({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject51.fromJson(Map<String, dynamic> json) {
    return InlineObject51(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject51Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject51 copyWith({
    ...
    InlineObject51Type Function()? type,
    Uri Function()? url,
