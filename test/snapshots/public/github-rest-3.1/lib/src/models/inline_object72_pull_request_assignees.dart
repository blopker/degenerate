...
import 'inline_object72_pull_request_assignees_type.dart';

final class InlineObject72PullRequestAssignees {
  const InlineObject72PullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestAssignees copyWith({
    ...
    InlineObject72PullRequestAssigneesType Function()? type,
    Uri Function()? url,
