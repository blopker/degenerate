...
import 'git_create_commit_request_author.dart';
import 'git_create_commit_request_committer.dart';

final class GitCreateCommitRequest {
  ...
  factory GitCreateCommitRequest.fromJson(Map<String, dynamic> json) {
    return GitCreateCommitRequest(
      ...
      author: json['author'] != null
          ? GitCreateCommitRequestAuthor.fromJson(
              json['author'] as Map<String, dynamic>,
            )
          : null,
      committer: json['committer'] != null
          ? GitCreateCommitRequestCommitter.fromJson(
  ...
  GitCreateCommitRequest copyWith({
    String? message,
    String? tree,
    List<String> Function()? parents,
    GitCreateCommitRequestAuthor Function()? author,
    GitCreateCommitRequestCommitter Function()? committer,
  ...
  @override
  String toString() {
    return 'GitCreateCommitRequest(message: $message, tree: $tree, parents: $parents, author: $author, committer: $committer, signature: $signature)';
  }
}
