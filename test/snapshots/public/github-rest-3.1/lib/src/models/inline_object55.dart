...
final class InlineObject55 {
  ...
  factory InlineObject55.fromJson(Map<String, dynamic> json) {
    return InlineObject55(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject55Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject55 copyWith({
    ...
    InlineObject55Type Function()? type,
    Uri Function()? url,
