...
import 'webhook_deployment_status_created_workflow_run_triggering_actor_type.dart';

final class WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor {
  const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType Function()?
    type,
    Uri Function()? url,
