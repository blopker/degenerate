...
import 'discussion_user_type.dart';

final class DiscussionUser {
  ...
  factory DiscussionUser.fromJson(Map<String, dynamic> json) {
    return DiscussionUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? DiscussionUserType.fromJson(json['type'] as String)
          : null,
  ...
  DiscussionUser copyWith({
    ...
    DiscussionUserType Function()? type,
    Uri Function()? url,
