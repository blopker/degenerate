...
import 'webhook_issues_deleted_issue_assignees_type.dart';

final class WebhookIssuesDeletedIssueAssignees {
  const WebhookIssuesDeletedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesDeletedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesDeletedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesDeletedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesDeletedIssueAssignees copyWith({
    ...
    WebhookIssuesDeletedIssueAssigneesType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesDeletedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
