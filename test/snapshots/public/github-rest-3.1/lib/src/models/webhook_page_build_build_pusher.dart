...
import 'webhook_page_build_build_pusher_type.dart';

final class WebhookPageBuildBuildPusher {
  const WebhookPageBuildBuildPusher({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPageBuildBuildPusher.fromJson(Map<String, dynamic> json) {
    return WebhookPageBuildBuildPusher(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPageBuildBuildPusherType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookPageBuildBuildPusher copyWith({
    ...
    WebhookPageBuildBuildPusherType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPageBuildBuildPusher(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
