...
import 'allowed_actions.dart';import 'enabled_repositories.dart';final class ActionsSetGithubActionsPermissionsOrganizationRequest {const ActionsSetGithubActionsPermissionsOrganizationRequest({required this.enabledRepositories, this.allowedActions, this.shaPinningRequired, });
...
ActionsSetGithubActionsPermissionsOrganizationRequest copyWith({EnabledRepositories? enabledRepositories, AllowedActions Function()? allowedActions, bool Function()? shaPinningRequired, }) { return ActionsSetGithubActionsPermissionsOrganizationRequest(
