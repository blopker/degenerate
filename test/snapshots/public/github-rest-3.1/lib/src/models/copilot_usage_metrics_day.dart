...
import 'copilot_dotcom_chat.dart';
import 'copilot_dotcom_pull_requests.dart';
import 'copilot_ide_chat.dart';
import 'copilot_ide_code_completions.dart';

/// Copilot usage metrics for a given day.
final class CopilotUsageMetricsDay {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (copilotDotcomPullRequests != null)
        'copilot_dotcom_pull_requests': copilotDotcomPullRequests?.toJson(),
    };
  }

  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('date') && json['date'] is String;
  }

  CopilotUsageMetricsDay copyWith({
    String? date,
    int Function()? totalActiveUsers,
    int Function()? totalEngagedUsers,
    CopilotIdeCodeCompletions Function()? copilotIdeCodeCompletions,
    CopilotIdeChat Function()? copilotIdeChat,
    CopilotDotcomChat Function()? copilotDotcomChat,
    CopilotDotcomPullRequests Function()? copilotDotcomPullRequests,
  }) {
    return CopilotUsageMetricsDay(
      date: date ?? this.date,
      ...
      totalEngagedUsers: totalEngagedUsers != null
          ? totalEngagedUsers()
          : this.totalEngagedUsers,
      copilotIdeCodeCompletions: copilotIdeCodeCompletions != null
          ? copilotIdeCodeCompletions()
          : this.copilotIdeCodeCompletions,
      copilotIdeChat: copilotIdeChat != null
          ? copilotIdeChat()
          : this.copilotIdeChat,
      copilotDotcomChat: copilotDotcomChat != null
          ? copilotDotcomChat()
          : this.copilotDotcomChat,
      copilotDotcomPullRequests: copilotDotcomPullRequests != null
  ...
  @override
  String toString() {
    return 'CopilotUsageMetricsDay(date: $date, totalActiveUsers: $totalActiveUsers, totalEngagedUsers: $totalEngagedUsers, copilotIdeCodeCompletions: $copilotIdeCodeCompletions, copilotIdeChat: $copilotIdeChat, copilotDotcomChat: $copilotDotcomChat, copilotDotcomPullRequests: $copilotDotcomPullRequests)';
  }
}
