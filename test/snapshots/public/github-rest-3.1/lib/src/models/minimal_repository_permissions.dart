...
final class MinimalRepositoryPermissions {
  ...
  MinimalRepositoryPermissions copyWith({
    bool Function()? admin,
  ...
  @override
  String toString() {
    return 'MinimalRepositoryPermissions(admin: $admin, maintain: $maintain, push: $push, triage: $triage, pull: $pull)';
  }
}
