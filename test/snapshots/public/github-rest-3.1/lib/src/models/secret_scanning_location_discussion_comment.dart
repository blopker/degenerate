...
final class SecretScanningLocationDiscussionComment {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('discussion_comment_url') &&
        json['discussion_comment_url'] is String;
  }

  SecretScanningLocationDiscussionComment copyWith({
    Uri? discussionCommentUrl,
  }) {
    return SecretScanningLocationDiscussionComment(
  ...
  @override
  int get hashCode {
    return discussionCommentUrl.hashCode;
  }

  @override
  String toString() {
    return 'SecretScanningLocationDiscussionComment(discussionCommentUrl: $discussionCommentUrl)';
  }
}
