...
import 'webhook_workflow_run_completed_workflow_run_actor.dart';
import 'webhook_workflow_run_completed_workflow_run_conclusion.dart';
import 'webhook_workflow_run_completed_workflow_run_head_commit.dart';
import 'webhook_workflow_run_completed_workflow_run_head_repository.dart';
import 'webhook_workflow_run_completed_workflow_run_pull_requests.dart';
import 'webhook_workflow_run_completed_workflow_run_referenced_workflows.dart';
import 'webhook_workflow_run_completed_workflow_run_repository.dart';
import 'webhook_workflow_run_completed_workflow_run_status.dart';
import 'webhook_workflow_run_completed_workflow_run_triggering_actor.dart';

final class WebhookWorkflowRunCompletedWorkflowRun {
  const WebhookWorkflowRunCompletedWorkflowRun({
    required this.actor,
  ...
  factory WebhookWorkflowRunCompletedWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunCompletedWorkflowRun(
      actor: WebhookWorkflowRunCompletedWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookWorkflowRunCompletedWorkflowRunConclusion.fromJson(
        json['conclusion'] as String,
      ),
      createdAt: DateTime.parse(json['created_at'] as String),
      event: json['event'] as String,
      headBranch: json['head_branch'] as String,
      headCommit: WebhookWorkflowRunCompletedWorkflowRunHeadCommit.fromJson(
        json['head_commit'] as Map<String, dynamic>,
      ),
      headRepository:
          WebhookWorkflowRunCompletedWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookWorkflowRunCompletedWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookWorkflowRunCompletedWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: WebhookWorkflowRunCompletedWorkflowRunRepository.fromJson(
      ...
      status: WebhookWorkflowRunCompletedWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookWorkflowRunCompletedWorkflowRunTriggeringActor.fromJson(
  ...
  final List<WebhookWorkflowRunCompletedWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  WebhookWorkflowRunCompletedWorkflowRun copyWith({
    WebhookWorkflowRunCompletedWorkflowRunActor? Function()? actor,
    Uri? artifactsUrl,
    Uri? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    Uri? checkSuiteUrl,
    WebhookWorkflowRunCompletedWorkflowRunConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? event,
    String? Function()? headBranch,
    WebhookWorkflowRunCompletedWorkflowRunHeadCommit? headCommit,
    WebhookWorkflowRunCompletedWorkflowRunHeadRepository? headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    Uri? jobsUrl,
    ...
    List<WebhookWorkflowRunCompletedWorkflowRunPullRequests?>? pullRequests,
    List<WebhookWorkflowRunCompletedWorkflowRunReferencedWorkflows>? Function()?
    referencedWorkflows,
    WebhookWorkflowRunCompletedWorkflowRunRepository? repository,
    Uri? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookWorkflowRunCompletedWorkflowRunStatus? status,
    WebhookWorkflowRunCompletedWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
