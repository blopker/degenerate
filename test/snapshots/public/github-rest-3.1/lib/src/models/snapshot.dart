...
import 'snapshot_detector.dart';
import 'snapshot_job.dart';
...
final class Snapshot {
  ...
  factory Snapshot.fromJson(Map<String, dynamic> json) {
    return Snapshot(
      ...
      manifests: (json['manifests'] as Map<String, dynamic>?)?.map(
        (k, v) => MapEntry(k, Manifest.fromJson(v as Map<String, dynamic>)),
      ),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (manifests != null)
        'manifests': manifests?.map((k, v) => MapEntry(k, v.toJson())),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('version') &&
        ...
        json.containsKey('scanned') &&
        json['scanned'] is String;
  }
  ...
  Snapshot copyWith({
    ...
    Map<String, Manifest> Function()? manifests,
    DateTime? scanned,
  }) {
    return Snapshot(
  ...
  @override
  String toString() {
    return 'Snapshot(version: $version, job: $job, sha: $sha, ref: $ref, detector: $detector, metadata: $metadata, manifests: $manifests, scanned: $scanned)';
  }
}
