...
import 'budget_budget_alerting.dart';import 'budget_budget_type.dart';final class Budget {const Budget({required this.id, required this.budgetType, required this.budgetAmount, required this.preventFurtherUsage, required this.budgetScope, this.budgetEntityName, required this.budgetProductSku, required this.budgetAlerting, });
