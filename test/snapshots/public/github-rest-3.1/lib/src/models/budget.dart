...
import 'budget_budget_alerting.dart';
import 'budget_budget_type.dart';
...
final class Budget {
  ...
  factory Budget.fromJson(Map<String, dynamic> json) {
    return Budget(
      ...
      budgetAlerting: BudgetBudgetAlerting.fromJson(
  ...
  @override
  String toString() {
    return 'Budget(id: $id, budgetType: $budgetType, budgetAmount: $budgetAmount, preventFurtherUsage: $preventFurtherUsage, budgetScope: $budgetScope, budgetEntityName: $budgetEntityName, budgetProductSku: $budgetProductSku, budgetAlerting: $budgetAlerting)';
  }
}
