...
import 'inline_object43_type.dart';

final class InlineObject43 {
  const InlineObject43({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject43.fromJson(Map<String, dynamic> json) {
    return InlineObject43(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject43Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject43 copyWith({
    ...
    InlineObject43Type Function()? type,
    Uri Function()? url,
