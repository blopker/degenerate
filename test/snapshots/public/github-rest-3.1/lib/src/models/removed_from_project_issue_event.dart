...
import 'removed_from_project_issue_event_project_card.dart';
import 'simple_user.dart';

/// Removed from Project Issue Event
final class RemovedFromProjectIssueEvent {
  ...
  factory RemovedFromProjectIssueEvent.fromJson(Map<String, dynamic> json) {
    return RemovedFromProjectIssueEvent(
      ...
      projectCard: json['project_card'] != null
          ? RemovedFromProjectIssueEventProjectCard.fromJson(
  ...
  RemovedFromProjectIssueEvent copyWith({
    int? id,
    String? nodeId,
    String? url,
    SimpleUser? actor,
    ...
    RemovedFromProjectIssueEventProjectCard Function()? projectCard,
  }) {
    return RemovedFromProjectIssueEvent(
      id: id ?? this.id,
  ...
  @override
  String toString() {
    return 'RemovedFromProjectIssueEvent(id: $id, nodeId: $nodeId, url: $url, actor: $actor, event: $event, commitId: $commitId, commitUrl: $commitUrl, createdAt: $createdAt, performedViaGithubApp: $performedViaGithubApp, projectCard: $projectCard)';
  }
}
