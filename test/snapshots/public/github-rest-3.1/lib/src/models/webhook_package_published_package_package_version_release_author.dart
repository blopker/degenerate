...
import 'webhook_package_published_package_package_version_release_author_type.dart';

final class WebhookPackagePublishedPackagePackageVersionReleaseAuthor {
  const WebhookPackagePublishedPackagePackageVersionReleaseAuthor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackagePublishedPackagePackageVersionReleaseAuthor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackagePublishedPackagePackageVersionReleaseAuthor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackagePublishedPackagePackageVersionReleaseAuthorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackagePublishedPackagePackageVersionReleaseAuthor copyWith({
    ...
    WebhookPackagePublishedPackagePackageVersionReleaseAuthorType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPackagePublishedPackagePackageVersionReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
