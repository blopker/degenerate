...
final class FieldDataType {
  const FieldDataType._(this.value);

  factory FieldDataType.fromJson(String json) {
    return switch (json) {
      'assignees' => assignees,
  ...
  static const FieldDataType linkedPullRequests = FieldDataType._(
  ...
  static const FieldDataType subIssuesProgress = FieldDataType._(
    'sub_issues_progress',
  );

  static const List<FieldDataType> values = [
    assignees,
    linkedPullRequests,
    reviewers,
    labels,
