...
import 'webhook_issues_labeled_issue_user_type.dart';

final class WebhookIssuesLabeledIssueUser {
  const WebhookIssuesLabeledIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesLabeledIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesLabeledIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesLabeledIssueUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookIssuesLabeledIssueUser copyWith({
    ...
    WebhookIssuesLabeledIssueUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesLabeledIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
