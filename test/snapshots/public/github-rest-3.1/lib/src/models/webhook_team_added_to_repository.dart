...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_team_added_to_repository_action.dart';import 'webhook_team_added_to_repository_repository.dart';import 'webhooks_team1.dart';final class WebhookTeamAddedToRepository {const WebhookTeamAddedToRepository({required this.action, this.enterprise, this.installation, required this.organization, this.repository, this.sender, required this.team, });
...
factory WebhookTeamAddedToRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamAddedToRepository(
  ...
  repository: json['repository'] != null
        ? WebhookTeamAddedToRepositoryRepository.fromJson(json['repository'] as Map<String, dynamic>)
        : null,
