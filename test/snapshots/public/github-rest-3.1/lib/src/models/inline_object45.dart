...
final class InlineObject45 {
  ...
  factory InlineObject45.fromJson(Map<String, dynamic> json) {
    return InlineObject45(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject45Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject45 copyWith({
    ...
    InlineObject45Type Function()? type,
    Uri Function()? url,
