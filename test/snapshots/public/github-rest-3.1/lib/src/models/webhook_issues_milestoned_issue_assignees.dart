...
import 'webhook_issues_milestoned_issue_assignees_type.dart';

final class WebhookIssuesMilestonedIssueAssignees {
  const WebhookIssuesMilestonedIssueAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesMilestonedIssueAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesMilestonedIssueAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesMilestonedIssueAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesMilestonedIssueAssignees copyWith({
    ...
    WebhookIssuesMilestonedIssueAssigneesType Function()? type,
    Uri Function()? url,
  }) {
    return WebhookIssuesMilestonedIssueAssignees(
