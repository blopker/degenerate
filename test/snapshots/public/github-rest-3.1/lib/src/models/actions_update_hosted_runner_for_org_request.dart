...
final class ActionsUpdateHostedRunnerForOrgRequest {
  ...
  factory ActionsUpdateHostedRunnerForOrgRequest.fromJson(
    ...
    return ActionsUpdateHostedRunnerForOrgRequest(
  ...
  ActionsUpdateHostedRunnerForOrgRequest copyWith({
  ...
  @override
  String toString() {
    return 'ActionsUpdateHostedRunnerForOrgRequest(name: $name, runnerGroupId: $runnerGroupId, maximumRunners: $maximumRunners, enableStaticIp: $enableStaticIp, size: $size, imageId: $imageId, imageVersion: $imageVersion)';
  }
}
