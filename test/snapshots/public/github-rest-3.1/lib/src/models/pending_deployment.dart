...
import 'pending_deployment_environment.dart';
import 'pending_deployment_reviewers.dart';
...
final class PendingDeployment {
  ...
  factory PendingDeployment.fromJson(Map<String, dynamic> json) {
    return PendingDeployment(
      ...
      waitTimerStartedAt: DateTime.parse(
        json['wait_timer_started_at'] as String,
      ),
      currentUserCanApprove: json['current_user_can_approve'] as bool,
      reviewers: (json['reviewers'] as List<dynamic>)
          .map(
            (e) =>
                PendingDeploymentReviewers.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('environment') &&
        json.containsKey('wait_timer') &&
        json['wait_timer'] is num &&
        json.containsKey('wait_timer_started_at') &&
        json['wait_timer_started_at'] is String &&
        json.containsKey('current_user_can_approve') &&
        json['current_user_can_approve'] is bool &&
        json.containsKey('reviewers');
  }

  PendingDeployment copyWith({
    PendingDeploymentEnvironment? environment,
    int? waitTimer,
    DateTime? Function()? waitTimerStartedAt,
    bool? currentUserCanApprove,
    List<PendingDeploymentReviewers>? reviewers,
  }) {
    return PendingDeployment(
      environment: environment ?? this.environment,
      waitTimer: waitTimer ?? this.waitTimer,
      waitTimerStartedAt: waitTimerStartedAt != null
          ? waitTimerStartedAt()
          : this.waitTimerStartedAt,
      currentUserCanApprove:
          currentUserCanApprove ?? this.currentUserCanApprove,
  ...
  @override
  String toString() {
    return 'PendingDeployment(environment: $environment, waitTimer: $waitTimer, waitTimerStartedAt: $waitTimerStartedAt, currentUserCanApprove: $currentUserCanApprove, reviewers: $reviewers)';
  }
}
