...
import 'inline_object81_type.dart';

final class InlineObject81 {
  const InlineObject81({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject81.fromJson(Map<String, dynamic> json) {
    return InlineObject81(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject81Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject81 copyWith({
    ...
    InlineObject81Type Function()? type,
    Uri Function()? url,
