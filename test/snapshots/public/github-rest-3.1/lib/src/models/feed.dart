...
final class Feed {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('timeline_url') &&
        json['timeline_url'] is String &&
  ...
  Feed copyWith({
    String? timelineUrl,
    String? userUrl,
    String Function()? currentUserPublicUrl,
    String Function()? currentUserUrl,
    String Function()? currentUserActorUrl,
    String Function()? currentUserOrganizationUrl,
    List<Uri> Function()? currentUserOrganizationUrls,
    String Function()? securityAdvisoriesUrl,
    String Function()? repositoryDiscussionsUrl,
    String Function()? repositoryDiscussionsCategoryUrl,
    FeedLinks? links,
  }) {
    return Feed(
      timelineUrl: timelineUrl ?? this.timelineUrl,
      userUrl: userUrl ?? this.userUrl,
      currentUserPublicUrl: currentUserPublicUrl != null
          ? currentUserPublicUrl()
          : this.currentUserPublicUrl,
      currentUserUrl: currentUserUrl != null
          ? currentUserUrl()
          : this.currentUserUrl,
      currentUserActorUrl: currentUserActorUrl != null
          ? currentUserActorUrl()
          : this.currentUserActorUrl,
      currentUserOrganizationUrl: currentUserOrganizationUrl != null
          ? currentUserOrganizationUrl()
          : this.currentUserOrganizationUrl,
      currentUserOrganizationUrls: currentUserOrganizationUrls != null
          ? currentUserOrganizationUrls()
          : this.currentUserOrganizationUrls,
      securityAdvisoriesUrl: securityAdvisoriesUrl != null
          ? securityAdvisoriesUrl()
          : this.securityAdvisoriesUrl,
      repositoryDiscussionsUrl: repositoryDiscussionsUrl != null
          ? repositoryDiscussionsUrl()
          : this.repositoryDiscussionsUrl,
      repositoryDiscussionsCategoryUrl: repositoryDiscussionsCategoryUrl != null
          ? repositoryDiscussionsCategoryUrl()
          : this.repositoryDiscussionsCategoryUrl,
  ...
  int get hashCode {
    return Object.hash(
      ...
      currentUserActorUrl,
      currentUserOrganizationUrl,
      Object.hashAll(currentUserOrganizationUrls ?? const []),
      securityAdvisoriesUrl,
      repositoryDiscussionsUrl,
      repositoryDiscussionsCategoryUrl,
      links,
  ...
  @override
  String toString() {
    return 'Feed(timelineUrl: $timelineUrl, userUrl: $userUrl, currentUserPublicUrl: $currentUserPublicUrl, currentUserUrl: $currentUserUrl, currentUserActorUrl: $currentUserActorUrl, currentUserOrganizationUrl: $currentUserOrganizationUrl, currentUserOrganizationUrls: $currentUserOrganizationUrls, securityAdvisoriesUrl: $securityAdvisoriesUrl, repositoryDiscussionsUrl: $repositoryDiscussionsUrl, repositoryDiscussionsCategoryUrl: $repositoryDiscussionsCategoryUrl, links: $links)';
  }
}
