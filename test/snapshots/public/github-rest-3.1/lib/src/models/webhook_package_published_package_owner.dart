...
import 'webhook_package_published_package_owner_type.dart';

final class WebhookPackagePublishedPackageOwner {
  const WebhookPackagePublishedPackageOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackagePublishedPackageOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackagePublishedPackageOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackagePublishedPackageOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackagePublishedPackageOwner copyWith({
    ...
    WebhookPackagePublishedPackageOwnerType Function()? type,
    Uri Function()? url,
