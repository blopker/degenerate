...
import 'package:collection/collection.dart';import 'enterprise_webhooks.dart';import 'installation.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_user.dart';import 'webhook_installation_repositories_removed_action.dart';import 'webhook_installation_repositories_removed_repositories_removed.dart';import 'webhooks_repositories_added2.dart';import 'webhooks_repository_selection.dart';import 'webhooks_user.dart';final class WebhookInstallationRepositoriesRemoved {const WebhookInstallationRepositoriesRemoved({required this.action, this.enterprise, required this.installation, this.organization, required this.repositoriesAdded, required this.repositoriesRemoved, this.repository, required this.repositorySelection, required this.requester, required this.sender, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookInstallationRepositoriesRemoved &&
          ...
          const ListEquality<dynamic>().equals(repositoriesAdded, other.repositoriesAdded) &&
          const ListEquality<dynamic>().equals(repositoriesRemoved, other.repositoriesRemoved) &&
