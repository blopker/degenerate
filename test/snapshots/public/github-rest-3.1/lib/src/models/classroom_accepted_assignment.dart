...
import 'simple_classroom_assignment.dart';
import 'simple_classroom_repository.dart';
import 'simple_classroom_user.dart';

/// A GitHub Classroom accepted assignment
final class ClassroomAcceptedAssignment {
  ...
  factory ClassroomAcceptedAssignment.fromJson(Map<String, dynamic> json) {
    return ClassroomAcceptedAssignment(
      ...
      students: (json['students'] as List<dynamic>)
          .map((e) => SimpleClassroomUser.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['submitted'] is bool &&
        json.containsKey('passing') &&
        json['passing'] is bool &&
        json.containsKey('commit_count') &&
        json['commit_count'] is num &&
  ...
  ClassroomAcceptedAssignment copyWith({
    int? id,
    bool? submitted,
    bool? passing,
    int? commitCount,
    String? grade,
    List<SimpleClassroomUser>? students,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is ClassroomAcceptedAssignment &&
            ...
            grade == other.grade &&
            const ListEquality<dynamic>().equals(students, other.students) &&
  ...
  @override
  String toString() {
    return 'ClassroomAcceptedAssignment(id: $id, submitted: $submitted, passing: $passing, commitCount: $commitCount, grade: $grade, students: $students, repository: $repository, assignment: $assignment)';
  }
}
