...
import 'gpg_key_emails.dart';
import 'gpg_key_subkeys.dart';
...
final class GpgKey {
  ...
  factory GpgKey.fromJson(Map<String, dynamic> json) {
    return GpgKey(
      ...
      emails: (json['emails'] as List<dynamic>)
          .map((e) => GpgKeyEmails.fromJson(e as Map<String, dynamic>))
          .toList(),
      subkeys: (json['subkeys'] as List<dynamic>)
          .map((e) => GpgKeySubkeys.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('primary_key_id') &&
        json['primary_key_id'] is num &&
        ...
        json.containsKey('can_sign') &&
        json['can_sign'] is bool &&
        json.containsKey('can_encrypt_comms') &&
        json['can_encrypt_comms'] is bool &&
        json.containsKey('can_encrypt_storage') &&
        json['can_encrypt_storage'] is bool &&
        json.containsKey('can_certify') &&
        json['can_certify'] is bool &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('expires_at') &&
        json['expires_at'] is String &&
        json.containsKey('revoked') &&
        json['revoked'] is bool &&
        json.containsKey('raw_key') &&
        json['raw_key'] is String;
  }

  GpgKey copyWith({
    int? id,
    String? Function()? name,
    int? Function()? primaryKeyId,
    String? keyId,
    String? publicKey,
  ...
  @override
  String toString() {
    return 'GpgKey(id: $id, name: $name, primaryKeyId: $primaryKeyId, keyId: $keyId, publicKey: $publicKey, emails: $emails, subkeys: $subkeys, canSign: $canSign, canEncryptComms: $canEncryptComms, canEncryptStorage: $canEncryptStorage, canCertify: $canCertify, createdAt: $createdAt, expiresAt: $expiresAt, revoked: $revoked, rawKey: $rawKey)';
  }
}
