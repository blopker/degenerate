...
import 'webhook_deployment_review_requested_workflow_run_actor_type.dart';

final class WebhookDeploymentReviewRequestedWorkflowRunActor {
  const WebhookDeploymentReviewRequestedWorkflowRunActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentReviewRequestedWorkflowRunActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentReviewRequestedWorkflowRunActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentReviewRequestedWorkflowRunActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentReviewRequestedWorkflowRunActor copyWith({
    ...
    WebhookDeploymentReviewRequestedWorkflowRunActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentReviewRequestedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
