...
import 'webhook_pull_request_unlocked_pull_request_milestone_creator.dart';
import 'webhook_pull_request_unlocked_pull_request_milestone_state.dart';

/// A collection of related issues and pull requests.
final class WebhookPullRequestUnlockedPullRequestMilestone {
  const WebhookPullRequestUnlockedPullRequestMilestone({
  ...
  factory WebhookPullRequestUnlockedPullRequestMilestone.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnlockedPullRequestMilestone(
      closedAt: DateTime.parse(json['closed_at'] as String),
      closedIssues: (json['closed_issues'] as num).toInt(),
      createdAt: DateTime.parse(json['created_at'] as String),
      creator: WebhookPullRequestUnlockedPullRequestMilestoneCreator.fromJson(
      ...
      state: WebhookPullRequestUnlockedPullRequestMilestoneState.fromJson(
  ...
  WebhookPullRequestUnlockedPullRequestMilestone copyWith({
    DateTime? Function()? closedAt,
    int? closedIssues,
    DateTime? createdAt,
    WebhookPullRequestUnlockedPullRequestMilestoneCreator? Function()? creator,
    ...
    int? number,
    int? openIssues,
    WebhookPullRequestUnlockedPullRequestMilestoneState? state,
    String? title,
    DateTime? updatedAt,
    Uri? url,
  }) {
