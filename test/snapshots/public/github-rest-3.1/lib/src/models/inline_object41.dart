...
import 'inline_object41_type.dart';

final class InlineObject41 {
  const InlineObject41({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject41.fromJson(Map<String, dynamic> json) {
    return InlineObject41(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject41Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject41 copyWith({
    ...
    InlineObject41Type Function()? type,
    Uri Function()? url,
