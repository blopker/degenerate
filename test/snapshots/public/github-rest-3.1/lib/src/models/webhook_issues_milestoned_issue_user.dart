...
import 'webhook_issues_milestoned_issue_user_type.dart';

final class WebhookIssuesMilestonedIssueUser {
  const WebhookIssuesMilestonedIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesMilestonedIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesMilestonedIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesMilestonedIssueUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesMilestonedIssueUser copyWith({
    ...
    WebhookIssuesMilestonedIssueUserType Function()? type,
    Uri Function()? url,
