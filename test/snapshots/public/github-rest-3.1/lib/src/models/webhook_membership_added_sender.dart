...
import 'webhook_membership_added_sender_type.dart';

final class WebhookMembershipAddedSender {
  const WebhookMembershipAddedSender({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookMembershipAddedSender.fromJson(Map<String, dynamic> json) {
    return WebhookMembershipAddedSender(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookMembershipAddedSenderType.fromJson(json['type'] as String)
          : null,
  ...
  WebhookMembershipAddedSender copyWith({
    ...
    WebhookMembershipAddedSenderType Function()? type,
    Uri Function()? url,
