...
final class WebhookIssueCommentDeletedIssueReactions {
  const WebhookIssueCommentDeletedIssueReactions({
    this.plus1,
    this.minus1,
    this.confused,
    this.eyes,
  ...
  factory WebhookIssueCommentDeletedIssueReactions.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentDeletedIssueReactions(
  ...
  WebhookIssueCommentDeletedIssueReactions copyWith({
    int Function()? plus1,
    int Function()? minus1,
  ...
  @override
  String toString() {
    return 'WebhookIssueCommentDeletedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
