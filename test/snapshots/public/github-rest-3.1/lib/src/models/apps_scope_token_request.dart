...
final class AppsScopeTokenRequest {
  ...
  AppsScopeTokenRequest copyWith({
    String? accessToken,
    String Function()? target,
    int Function()? targetId,
    List<String> Function()? repositories,
    List<int> Function()? repositoryIds,
    AppPermissions Function()? permissions,
  }) {
    return AppsScopeTokenRequest(
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(repositoryIds ?? const []),
      permissions,
    );
  }
  ...
  @override
  String toString() {
    return 'AppsScopeTokenRequest(accessToken: $accessToken, target: $target, targetId: $targetId, repositories: $repositories, repositoryIds: $repositoryIds, permissions: $permissions)';
  }
}
