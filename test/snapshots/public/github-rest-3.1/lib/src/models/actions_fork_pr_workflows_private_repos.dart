...
final class ActionsForkPrWorkflowsPrivateRepos {
  const ActionsForkPrWorkflowsPrivateRepos({
    required this.runWorkflowsFromForkPullRequests,
    required this.sendWriteTokensToWorkflows,
    required this.sendSecretsAndVariables,
    required this.requireApprovalForForkPrWorkflows,
  });

  factory ActionsForkPrWorkflowsPrivateRepos.fromJson(
    Map<String, dynamic> json,
  ) {
    return ActionsForkPrWorkflowsPrivateRepos(
      runWorkflowsFromForkPullRequests:
          json['run_workflows_from_fork_pull_requests'] as bool,
      sendWriteTokensToWorkflows:
          json['send_write_tokens_to_workflows'] as bool,
      sendSecretsAndVariables: json['send_secrets_and_variables'] as bool,
      requireApprovalForForkPrWorkflows:
          json['require_approval_for_fork_pr_workflows'] as bool,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('run_workflows_from_fork_pull_requests') &&
        json['run_workflows_from_fork_pull_requests'] is bool &&
        json.containsKey('send_write_tokens_to_workflows') &&
        json['send_write_tokens_to_workflows'] is bool &&
        json.containsKey('send_secrets_and_variables') &&
        json['send_secrets_and_variables'] is bool &&
        json.containsKey('require_approval_for_fork_pr_workflows') &&
        json['require_approval_for_fork_pr_workflows'] is bool;
  }

  ActionsForkPrWorkflowsPrivateRepos copyWith({
    ...
    return ActionsForkPrWorkflowsPrivateRepos(
      ...
      sendWriteTokensToWorkflows:
          sendWriteTokensToWorkflows ?? this.sendWriteTokensToWorkflows,
      sendSecretsAndVariables:
          sendSecretsAndVariables ?? this.sendSecretsAndVariables,
      requireApprovalForForkPrWorkflows:
          requireApprovalForForkPrWorkflows ??
  ...
  @override
  String toString() {
    return 'ActionsForkPrWorkflowsPrivateRepos(runWorkflowsFromForkPullRequests: $runWorkflowsFromForkPullRequests, sendWriteTokensToWorkflows: $sendWriteTokensToWorkflows, sendSecretsAndVariables: $sendSecretsAndVariables, requireApprovalForForkPrWorkflows: $requireApprovalForForkPrWorkflows)';
  }
}
