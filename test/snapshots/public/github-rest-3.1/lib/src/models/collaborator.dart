...
import 'collaborator_permissions.dart';
...
final class Collaborator {
  ...
  factory Collaborator.fromJson(Map<String, dynamic> json) {
    return Collaborator(
      ...
      permissions: json['permissions'] != null
          ? CollaboratorPermissions.fromJson(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('login') &&
        ...
        json.containsKey('role_name') &&
        json['role_name'] is String;
  }
  ...
  Collaborator copyWith({
    ...
    String? type,
    bool? siteAdmin,
    CollaboratorPermissions Function()? permissions,
    String? roleName,
