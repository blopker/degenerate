...
import 'webhook_deployment_status_created_deployment_creator.dart';
import 'webhook_deployment_status_created_deployment_payload.dart';
import 'webhook_deployment_status_created_deployment_performed_via_github_app.dart';

/// The [deployment](https://docs.github.com/rest/deployments/deployments#list-deployments).
final class WebhookDeploymentStatusCreatedDeployment {
  const WebhookDeploymentStatusCreatedDeployment({
    ...
    required this.originalEnvironment,
  ...
  factory WebhookDeploymentStatusCreatedDeployment.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentStatusCreatedDeployment(
      createdAt: json['created_at'] as String,
      creator: WebhookDeploymentStatusCreatedDeploymentCreator.fromJson(
      ...
      payload: WebhookDeploymentStatusCreatedDeploymentPayload.fromJson(
        json['payload'],
      ),
      performedViaGithubApp: json['performed_via_github_app'] != null
          ? WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubApp.fromJson(
  ...
  final WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubApp?
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('created_at') &&
        ...
        json.containsKey('original_environment') &&
        json['original_environment'] is String &&
  ...
  WebhookDeploymentStatusCreatedDeployment copyWith({
    String? createdAt,
    WebhookDeploymentStatusCreatedDeploymentCreator? Function()? creator,
    String? Function()? description,
    String? environment,
    int? id,
    String? nodeId,
    String? originalEnvironment,
    WebhookDeploymentStatusCreatedDeploymentPayload? Function()? payload,
    WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubApp? Function()?
    performedViaGithubApp,
    ...
    Uri? statusesUrl,
    String? task,
    bool Function()? transientEnvironment,
    String? updatedAt,
    Uri? url,
  }) {
    return WebhookDeploymentStatusCreatedDeployment(
      ...
      performedViaGithubApp: performedViaGithubApp != null
          ? performedViaGithubApp()
          : this.performedViaGithubApp,
      productionEnvironment: productionEnvironment != null
      ...
      task: task ?? this.task,
      transientEnvironment: transientEnvironment != null
