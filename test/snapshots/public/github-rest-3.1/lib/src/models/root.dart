...
final class Root {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('current_user_url') &&
        json['current_user_url'] is String &&
        json.containsKey('current_user_authorizations_html_url') &&
        json['current_user_authorizations_html_url'] is String &&
        json.containsKey('authorizations_url') &&
        json['authorizations_url'] is String &&
        json.containsKey('code_search_url') &&
        json['code_search_url'] is String &&
        json.containsKey('commit_search_url') &&
        json['commit_search_url'] is String &&
        json.containsKey('emails_url') &&
        json['emails_url'] is String &&
        json.containsKey('emojis_url') &&
        json['emojis_url'] is String &&
        json.containsKey('events_url') &&
        json['events_url'] is String &&
        json.containsKey('feeds_url') &&
        json['feeds_url'] is String &&
        json.containsKey('followers_url') &&
        json['followers_url'] is String &&
        json.containsKey('following_url') &&
        json['following_url'] is String &&
        json.containsKey('gists_url') &&
        json['gists_url'] is String &&
        json.containsKey('issue_search_url') &&
        json['issue_search_url'] is String &&
        json.containsKey('issues_url') &&
        json['issues_url'] is String &&
        json.containsKey('keys_url') &&
        json['keys_url'] is String &&
        json.containsKey('label_search_url') &&
        json['label_search_url'] is String &&
        json.containsKey('notifications_url') &&
        json['notifications_url'] is String &&
        json.containsKey('organization_url') &&
        json['organization_url'] is String &&
        json.containsKey('organization_repositories_url') &&
        json['organization_repositories_url'] is String &&
        json.containsKey('organization_teams_url') &&
        json['organization_teams_url'] is String &&
        json.containsKey('public_gists_url') &&
        json['public_gists_url'] is String &&
        json.containsKey('rate_limit_url') &&
        json['rate_limit_url'] is String &&
        json.containsKey('repository_url') &&
        json['repository_url'] is String &&
        json.containsKey('repository_search_url') &&
        json['repository_search_url'] is String &&
        json.containsKey('current_user_repositories_url') &&
        json['current_user_repositories_url'] is String &&
        json.containsKey('starred_url') &&
        json['starred_url'] is String &&
        json.containsKey('starred_gists_url') &&
        json['starred_gists_url'] is String &&
        json.containsKey('user_url') &&
        json['user_url'] is String &&
        json.containsKey('user_organizations_url') &&
        json['user_organizations_url'] is String &&
        json.containsKey('user_repositories_url') &&
        json['user_repositories_url'] is String &&
        json.containsKey('user_search_url') &&
        json['user_search_url'] is String;
  }
  ...
  Root copyWith({
    ...
    String Function()? topicSearchUrl,
    String? userUrl,
    ...
    return Root(
      ...
      topicSearchUrl: topicSearchUrl != null
          ? topicSearchUrl()
          : this.topicSearchUrl,
