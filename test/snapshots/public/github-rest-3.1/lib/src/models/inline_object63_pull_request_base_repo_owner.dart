...
import 'inline_object63_pull_request_base_repo_owner_type.dart';

final class InlineObject63PullRequestBaseRepoOwner {
  const InlineObject63PullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestBaseRepoOwner copyWith({
    ...
    InlineObject63PullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
