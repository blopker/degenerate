...
import 'webhook_pull_request_review_thread_resolved_thread_comments_user_type.dart';
...
final class WebhookPullRequestReviewThreadResolvedThreadCommentsUser {
  ...
  factory WebhookPullRequestReviewThreadResolvedThreadCommentsUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadResolvedThreadCommentsUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadResolvedThreadCommentsUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewThreadResolvedThreadCommentsUser copyWith({
    ...
    WebhookPullRequestReviewThreadResolvedThreadCommentsUserType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadResolvedThreadCommentsUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
