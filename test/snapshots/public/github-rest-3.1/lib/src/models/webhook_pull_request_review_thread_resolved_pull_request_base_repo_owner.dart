...
import 'webhook_pull_request_review_thread_resolved_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner {
  const WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerType?
  type;
  ...
  WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwnerType
    Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadResolvedPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
