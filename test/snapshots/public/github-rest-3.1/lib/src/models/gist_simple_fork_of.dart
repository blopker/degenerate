...
import 'package:collection/collection.dart';import 'inline_object3.dart';import 'simple_user.dart';/// Gist
...
factory GistSimpleForkOf.fromJson(Map<String, dynamic> json) { return GistSimpleForkOf(
  ...
  files: (json['files'] as Map<String, dynamic>).map((k, v) => MapEntry(k, InlineObject3.fromJson(v as Map<String, dynamic>))),
...
GistSimpleForkOf copyWith({Uri? url, Uri? forksUrl, Uri? commitsUrl, String? id, String? nodeId, Uri? gitPullUrl, Uri? gitPushUrl, Uri? htmlUrl, Map<String,InlineObject3>? files, bool? public, DateTime? createdAt, DateTime? updatedAt, String? Function()? description, int? comments, bool Function()? commentsEnabled, SimpleUser? Function()? user, Uri? commentsUrl, SimpleUser? Function()? owner, bool Function()? truncated, List<String> Function()? forks, List<String> Function()? history, }) { return GistSimpleForkOf(
  url: url ?? this.url,
