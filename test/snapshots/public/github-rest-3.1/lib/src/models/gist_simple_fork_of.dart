...
final class GistSimpleForkOf {
  ...
  factory GistSimpleForkOf.fromJson(Map<String, dynamic> json) {
    return GistSimpleForkOf(
      ...
      files: (json['files'] as Map<String, dynamic>).map(
        (k, v) =>
            MapEntry(k, InlineObject3.fromJson(v as Map<String, dynamic>)),
      ),
  ...
  final Map<String, InlineObject3> files;
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('url') &&
        ...
        json.containsKey('git_pull_url') &&
        json['git_pull_url'] is String &&
        json.containsKey('git_push_url') &&
        json['git_push_url'] is String &&
  ...
  GistSimpleForkOf copyWith({
    ...
    Uri? gitPushUrl,
    Uri? htmlUrl,
    Map<String, InlineObject3>? files,
    bool? public,
    DateTime? createdAt,
    DateTime? updatedAt,
    ...
    List<String> Function()? forks,
    List<String> Function()? history,
  }) {
    return GistSimpleForkOf(
      url: url ?? this.url,
