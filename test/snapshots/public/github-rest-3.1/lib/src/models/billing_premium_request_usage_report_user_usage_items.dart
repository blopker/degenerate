...
final class BillingPremiumRequestUsageReportUserUsageItems {
  const BillingPremiumRequestUsageReportUserUsageItems({
  ...
  factory BillingPremiumRequestUsageReportUserUsageItems.fromJson(
    Map<String, dynamic> json,
  ) {
    return BillingPremiumRequestUsageReportUserUsageItems(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('product') &&
        json['product'] is String &&
        json.containsKey('sku') &&
        json['sku'] is String &&
        json.containsKey('model') &&
        json['model'] is String &&
        json.containsKey('unitType') &&
        json['unitType'] is String &&
        json.containsKey('pricePerUnit') &&
        json['pricePerUnit'] is num &&
        json.containsKey('grossQuantity') &&
        json['grossQuantity'] is num &&
        json.containsKey('grossAmount') &&
        json['grossAmount'] is num &&
        json.containsKey('discountQuantity') &&
        json['discountQuantity'] is num &&
        json.containsKey('discountAmount') &&
        json['discountAmount'] is num &&
        json.containsKey('netQuantity') &&
        json['netQuantity'] is num &&
        json.containsKey('netAmount') &&
        json['netAmount'] is num;
  }

  BillingPremiumRequestUsageReportUserUsageItems copyWith({
    String? product,
    String? sku,
    String? model,
    String? unitType,
  ...
  @override
  String toString() {
    return 'BillingPremiumRequestUsageReportUserUsageItems(product: $product, sku: $sku, model: $model, unitType: $unitType, pricePerUnit: $pricePerUnit, grossQuantity: $grossQuantity, grossAmount: $grossAmount, discountQuantity: $discountQuantity, discountAmount: $discountAmount, netQuantity: $netQuantity, netAmount: $netAmount)';
  }
}
