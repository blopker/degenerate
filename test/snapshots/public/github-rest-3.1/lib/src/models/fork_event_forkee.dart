...
import 'fork_event_forkee_pull_request_creation_policy.dart';
import 'license_simple.dart';
import 'simple_user.dart';

final class ForkEventForkee {
  const ForkEventForkee({
    this.id,
    this.nodeId,
    this.name,
    this.fullName,
  ...
  factory ForkEventForkee.fromJson(Map<String, dynamic> json) {
    return ForkEventForkee(
      ...
      pullRequestCreationPolicy: json['pull_request_creation_policy'] != null
          ? ForkEventForkeePullRequestCreationPolicy.fromJson(
  ...
  ForkEventForkee copyWith({
    ...
    ForkEventForkeePullRequestCreationPolicy Function()?
