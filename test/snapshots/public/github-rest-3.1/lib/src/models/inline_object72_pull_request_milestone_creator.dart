...
import 'inline_object72_pull_request_milestone_creator_type.dart';

final class InlineObject72PullRequestMilestoneCreator {
  const InlineObject72PullRequestMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject72PullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject72PullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject72PullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject72PullRequestMilestoneCreator copyWith({
    ...
    InlineObject72PullRequestMilestoneCreatorType Function()? type,
    Uri Function()? url,
