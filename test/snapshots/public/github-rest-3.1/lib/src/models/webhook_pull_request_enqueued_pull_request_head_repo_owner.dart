...
import 'webhook_pull_request_enqueued_pull_request_head_repo_owner_type.dart';

final class WebhookPullRequestEnqueuedPullRequestHeadRepoOwner {
  const WebhookPullRequestEnqueuedPullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestEnqueuedPullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestEnqueuedPullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestEnqueuedPullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestEnqueuedPullRequestHeadRepoOwner copyWith({
    ...
    WebhookPullRequestEnqueuedPullRequestHeadRepoOwnerType Function()? type,
    Uri Function()? url,
