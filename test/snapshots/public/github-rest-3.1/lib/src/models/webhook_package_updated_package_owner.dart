...
import 'webhook_package_updated_package_owner_type.dart';

final class WebhookPackageUpdatedPackageOwner {
  const WebhookPackageUpdatedPackageOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPackageUpdatedPackageOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPackageUpdatedPackageOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPackageUpdatedPackageOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPackageUpdatedPackageOwner copyWith({
    ...
    WebhookPackageUpdatedPackageOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPackageUpdatedPackageOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
