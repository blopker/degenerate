...
final class RateLimitOverviewResources {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('core') && json.containsKey('search');
  }

  RateLimitOverviewResources copyWith({
    RateLimit? core,
    RateLimit Function()? graphql,
    RateLimit? search,
    RateLimit Function()? codeSearch,
    RateLimit Function()? sourceImport,
    RateLimit Function()? integrationManifest,
    RateLimit Function()? codeScanningUpload,
    RateLimit Function()? actionsRunnerRegistration,
    RateLimit Function()? scim,
    RateLimit Function()? dependencySnapshots,
    RateLimit Function()? dependencySbom,
    RateLimit Function()? codeScanningAutofix,
  }) {
    return RateLimitOverviewResources(
      core: core ?? this.core,
      ...
      integrationManifest: integrationManifest != null
          ? integrationManifest()
          : this.integrationManifest,
      codeScanningUpload: codeScanningUpload != null
          ? codeScanningUpload()
          : this.codeScanningUpload,
      actionsRunnerRegistration: actionsRunnerRegistration != null
          ? actionsRunnerRegistration()
          : this.actionsRunnerRegistration,
      scim: scim != null ? scim() : this.scim,
      dependencySnapshots: dependencySnapshots != null
          ? dependencySnapshots()
          : this.dependencySnapshots,
      dependencySbom: dependencySbom != null
          ? dependencySbom()
          : this.dependencySbom,
      codeScanningAutofix: codeScanningAutofix != null
          ? codeScanningAutofix()
          : this.codeScanningAutofix,
    );
  }
