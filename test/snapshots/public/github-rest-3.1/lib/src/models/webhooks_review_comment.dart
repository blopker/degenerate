...
import 'webhooks_review_comment_author_association.dart';
import 'webhooks_review_comment_links.dart';
import 'webhooks_review_comment_reactions.dart';
import 'webhooks_review_comment_side.dart';
import 'webhooks_review_comment_start_side.dart';
import 'webhooks_review_comment_subject_type.dart';
import 'webhooks_review_comment_user.dart';

/// The [comment](https://docs.github.com/rest/pulls/comments#get-a-review-comment-for-a-pull-request) itself.
final class WebhooksReviewComment {
  const WebhooksReviewComment({
    required this.links,
    ...
    this.startSide = WebhooksReviewCommentStartSide.right,
    this.subjectType,
  ...
  factory WebhooksReviewComment.fromJson(Map<String, dynamic> json) {
    return WebhooksReviewComment(
      links: WebhooksReviewCommentLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      authorAssociation: WebhooksReviewCommentAuthorAssociation.fromJson(
  ...
  WebhooksReviewComment copyWith({
    WebhooksReviewCommentLinks? links,
    WebhooksReviewCommentAuthorAssociation? authorAssociation,
    String? body,
    String? commitId,
    DateTime? createdAt,
    String? diffHunk,
    ...
    Uri? pullRequestUrl,
    WebhooksReviewCommentReactions? reactions,
    WebhooksReviewCommentSide? side,
    int? Function()? startLine,
    WebhooksReviewCommentStartSide? Function()? startSide,
    WebhooksReviewCommentSubjectType Function()? subjectType,
    DateTime? updatedAt,
    Uri? url,
    WebhooksReviewCommentUser? Function()? user,
  }) {
    return WebhooksReviewComment(
  ...
  @override
  String toString() {
    return 'WebhooksReviewComment(links: $links, authorAssociation: $authorAssociation, body: $body, commitId: $commitId, createdAt: $createdAt, diffHunk: $diffHunk, htmlUrl: $htmlUrl, id: $id, inReplyToId: $inReplyToId, line: $line, nodeId: $nodeId, originalCommitId: $originalCommitId, originalLine: $originalLine, originalPosition: $originalPosition, originalStartLine: $originalStartLine, path: $path, position: $position, pullRequestReviewId: $pullRequestReviewId, pullRequestUrl: $pullRequestUrl, reactions: $reactions, side: $side, startLine: $startLine, startSide: $startSide, subjectType: $subjectType, updatedAt: $updatedAt, url: $url, user: $user)';
  }
}
