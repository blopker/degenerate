...
import 'webhook_pull_request_review_comment_deleted_pull_request_milestone_creator_type.dart';
...
final class WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreator {
  ...
  factory WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreator.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorType?
  type;
  ...
  WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreator copyWith({
    ...
    WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreatorType
    Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewCommentDeletedPullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
