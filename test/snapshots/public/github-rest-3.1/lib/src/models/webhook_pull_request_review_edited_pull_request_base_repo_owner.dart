...
import 'webhook_pull_request_review_edited_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestReviewEditedPullRequestBaseRepoOwner {
  const WebhookPullRequestReviewEditedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewEditedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewEditedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewEditedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewEditedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestReviewEditedPullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
