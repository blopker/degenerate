...
import 'inline_object63_pull_request_assignees_type.dart';

final class InlineObject63PullRequestAssignees {
  const InlineObject63PullRequestAssignees({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestAssignees.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestAssignees(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestAssigneesType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestAssignees copyWith({
    ...
    InlineObject63PullRequestAssigneesType Function()? type,
    Uri Function()? url,
