...
import 'webhook_deployment_created_deployment_performed_via_github_app_owner_type.dart';

final class WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner {
  const WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner copyWith({
    ...
    WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerType Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
