...
import 'integration_installation_request_account.dart';
import 'simple_user.dart';

/// Request to install an integration on a target
final class IntegrationInstallationRequest {
  ...
  IntegrationInstallationRequest copyWith({
    int? id,
    String Function()? nodeId,
    IntegrationInstallationRequestAccount? account,
  ...
  @override
  int get hashCode {
    return Object.hash(id, nodeId, account, requester, createdAt);
  }

  @override
  String toString() {
    return 'IntegrationInstallationRequest(id: $id, nodeId: $nodeId, account: $account, requester: $requester, createdAt: $createdAt)';
  }
}
