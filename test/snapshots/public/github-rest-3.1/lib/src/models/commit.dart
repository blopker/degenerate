...
import 'commit_commit.dart';
import 'commit_committer.dart';
import 'commit_parents.dart';
...
final class Commit {
  ...
  factory Commit.fromJson(Map<String, dynamic> json) {
    return Commit(
      ...
      parents: (json['parents'] as List<dynamic>)
          .map((e) => CommitParents.fromJson(e as Map<String, dynamic>))
          .toList(),
  ...
  Commit copyWith({
    ...
    Uri? commentsUrl,
    CommitCommit? commit,
    CommitAuthor? Function()? author,
    CommitCommitter? Function()? committer,
    List<CommitParents>? parents,
    CommitStats Function()? stats,
