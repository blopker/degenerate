...
import 'webhooks_issue_milestone_creator_type.dart';

final class WebhooksIssueMilestoneCreator {
  const WebhooksIssueMilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssueMilestoneCreator.fromJson(Map<String, dynamic> json) {
    return WebhooksIssueMilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssueMilestoneCreatorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssueMilestoneCreator copyWith({
    ...
    WebhooksIssueMilestoneCreatorType Function()? type,
    Uri Function()? url,
