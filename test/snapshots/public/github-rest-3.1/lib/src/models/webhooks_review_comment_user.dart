...
import 'webhooks_review_comment_user_type.dart';

final class WebhooksReviewCommentUser {
  const WebhooksReviewCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksReviewCommentUser.fromJson(Map<String, dynamic> json) {
    return WebhooksReviewCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksReviewCommentUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksReviewCommentUser copyWith({
    ...
    WebhooksReviewCommentUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksReviewCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
