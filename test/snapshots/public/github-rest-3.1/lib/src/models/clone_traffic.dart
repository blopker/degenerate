...
final class CloneTraffic {
  ...
  factory CloneTraffic.fromJson(Map<String, dynamic> json) {
    return CloneTraffic(
      ...
      clones: (json['clones'] as List<dynamic>)
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('count') &&
        json['count'] is num &&
        json.containsKey('uniques') &&
        json['uniques'] is num &&
        json.containsKey('clones');
  }

  CloneTraffic copyWith({int? count, int? uniques, List<Traffic>? clones}) {
    return CloneTraffic(
  ...
  @override
  int get hashCode {
    return Object.hash(count, uniques, Object.hashAll(clones));
  }
