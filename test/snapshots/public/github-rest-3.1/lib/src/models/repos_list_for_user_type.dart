...
final class ReposListForUserType {
  const ReposListForUserType._(this.value);

  factory ReposListForUserType.fromJson(String json) {
    return switch (json) {
      'all' => all,
      'owner' => owner,
      'member' => member,
  ...
  @override
  String toString() {
    return 'ReposListForUserType($value)';
  }
}
