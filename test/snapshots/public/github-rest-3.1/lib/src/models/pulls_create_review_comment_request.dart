...
import 'pulls_create_review_comment_request_side.dart';
import 'pulls_create_review_comment_request_start_side.dart';
import 'pulls_create_review_comment_request_subject_type.dart';

final class PullsCreateReviewCommentRequest {
  ...
  factory PullsCreateReviewCommentRequest.fromJson(Map<String, dynamic> json) {
    return PullsCreateReviewCommentRequest(
      ...
      position: json['position'] != null
          ...
          : null,
      side: json['side'] != null
          ? PullsCreateReviewCommentRequestSide.fromJson(json['side'] as String)
          : null,
      line: json['line'] != null ? (json['line'] as num).toInt() : null,
      startLine: json['start_line'] != null
          ? (json['start_line'] as num).toInt()
          : null,
      startSide: json['start_side'] != null
          ? PullsCreateReviewCommentRequestStartSide.fromJson(
              json['start_side'] as String,
            )
          : null,
      inReplyTo: json['in_reply_to'] != null
          ? (json['in_reply_to'] as num).toInt()
          : null,
      subjectType: json['subject_type'] != null
          ? PullsCreateReviewCommentRequestSubjectType.fromJson(
  ...
  PullsCreateReviewCommentRequest copyWith({
    String? body,
    String? commitId,
    String? path,
    int Function()? position,
    PullsCreateReviewCommentRequestSide Function()? side,
    int Function()? line,
    int Function()? startLine,
    PullsCreateReviewCommentRequestStartSide Function()? startSide,
    int Function()? inReplyTo,
    PullsCreateReviewCommentRequestSubjectType Function()? subjectType,
  }) {
    return PullsCreateReviewCommentRequest(
      body: body ?? this.body,
  ...
  @override
  String toString() {
    return 'PullsCreateReviewCommentRequest(body: $body, commitId: $commitId, path: $path, position: $position, side: $side, line: $line, startLine: $startLine, startSide: $startSide, inReplyTo: $inReplyTo, subjectType: $subjectType)';
  }
}
