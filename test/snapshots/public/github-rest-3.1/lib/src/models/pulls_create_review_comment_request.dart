...
import 'pulls_create_review_comment_request_side.dart';import 'pulls_create_review_comment_request_start_side.dart';import 'pulls_create_review_comment_request_subject_type.dart';final class PullsCreateReviewCommentRequest {const PullsCreateReviewCommentRequest({required this.body, required this.commitId, required this.path, this.position, this.side, this.line, this.startLine, this.startSide, this.inReplyTo, this.subjectType, });
