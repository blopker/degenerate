...
import 'package_package_type.dart';
...
final class Package {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json.containsKey('version_count') &&
        json['version_count'] is num &&
  ...
  Package copyWith({
    int? id,
    String? name,
    PackagePackageType? packageType,
    String? url,
    String? htmlUrl,
    int? versionCount,
  ...
  @override
  String toString() {
    return 'Package(id: $id, name: $name, packageType: $packageType, url: $url, htmlUrl: $htmlUrl, versionCount: $versionCount, visibility: $visibility, owner: $owner, repository: $repository, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
