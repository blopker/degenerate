...
import 'webhooks_issue_user_type.dart';

final class WebhooksIssueUser {
  const WebhooksIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssueUser.fromJson(Map<String, dynamic> json) {
    return WebhooksIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssueUserType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssueUser copyWith({
    ...
    WebhooksIssueUserType Function()? type,
    Uri Function()? url,
