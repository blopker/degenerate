...
import 'inline_object61_type.dart';

final class InlineObject61 {
  const InlineObject61({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject61.fromJson(Map<String, dynamic> json) {
    return InlineObject61(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject61Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject61 copyWith({
    ...
    InlineObject61Type Function()? type,
    Uri Function()? url,
