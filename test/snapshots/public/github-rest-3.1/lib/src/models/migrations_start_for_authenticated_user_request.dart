...
import 'migrations_start_for_authenticated_user_request_exclude.dart';

final class MigrationsStartForAuthenticatedUserRequest {
  ...
  factory MigrationsStartForAuthenticatedUserRequest.fromJson(
    ...
    return MigrationsStartForAuthenticatedUserRequest(
      ...
      exclude: (json['exclude'] as List<dynamic>?)
          ?.map(
            (e) => MigrationsStartForAuthenticatedUserRequestExclude.fromJson(
              e as String,
            ),
          )
          .toList(),
  ...
  MigrationsStartForAuthenticatedUserRequest copyWith({
    ...
    List<MigrationsStartForAuthenticatedUserRequestExclude> Function()? exclude,
  ...
  @override
  String toString() {
    return 'MigrationsStartForAuthenticatedUserRequest(lockRepositories: $lockRepositories, excludeMetadata: $excludeMetadata, excludeGitData: $excludeGitData, excludeAttachments: $excludeAttachments, excludeReleases: $excludeReleases, excludeOwnerProjects: $excludeOwnerProjects, orgMetadataOnly: $orgMetadataOnly, exclude: $exclude, repositories: $repositories)';
  }
}
