...
import 'check_run_check_suite.dart';
import 'check_run_conclusion.dart';
import 'check_run_output.dart';
import 'check_run_status.dart';
...
final class CheckRun {
  ...
  factory CheckRun.fromJson(Map<String, dynamic> json) {
    return CheckRun(
      ...
      checkSuite: CheckRunCheckSuite.fromJson(
  ...
  CheckRun copyWith({
    ...
    CheckRunConclusion? Function()? conclusion,
    DateTime? Function()? startedAt,
    DateTime? Function()? completedAt,
    CheckRunOutput? output,
    String? name,
    CheckRunCheckSuite? Function()? checkSuite,
