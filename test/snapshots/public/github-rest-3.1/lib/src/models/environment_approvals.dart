...
import 'package:collection/collection.dart';import 'environment_approvals_environments.dart';import 'environment_approvals_state.dart';import 'simple_user.dart';/// An entry in the reviews log for environment deployments
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EnvironmentApprovals &&
          const ListEquality<dynamic>().equals(environments, other.environments) &&
          state == other.state &&
          user == other.user &&
