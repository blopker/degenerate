...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_issues_opened_action.dart';import 'webhook_issues_opened_changes.dart';import 'webhook_issues_opened_issue.dart';final class WebhookIssuesOpened {const WebhookIssuesOpened({required this.action, this.changes, this.enterprise, this.installation, required this.issue, this.organization, required this.repository, required this.sender, });
...
factory WebhookIssuesOpened.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpened(
  ...
  changes: json['changes'] != null
        ? WebhookIssuesOpenedChanges.fromJson(json['changes'] as Map<String, dynamic>)
        : null,
