...
import 'secret_scanning_pattern_override_default_setting.dart';
import 'secret_scanning_pattern_override_enterprise_setting.dart';
import 'secret_scanning_pattern_override_setting.dart';

final class SecretScanningPatternOverride {
  const SecretScanningPatternOverride({
    this.tokenType,
    this.customPatternVersion,
    this.slug,
    this.displayName,
    this.alertTotal,
    this.alertTotalPercentage,
    this.falsePositives,
    this.falsePositiveRate,
    this.bypassRate,
    this.defaultSetting,
    this.enterpriseSetting,
    this.setting,
  });

  factory SecretScanningPatternOverride.fromJson(Map<String, dynamic> json) {
    return SecretScanningPatternOverride(
      tokenType: json['token_type'] as String?,
      customPatternVersion: json['custom_pattern_version'] as String?,
      slug: json['slug'] as String?,
      displayName: json['display_name'] as String?,
      alertTotal: json['alert_total'] != null
          ? (json['alert_total'] as num).toInt()
          : null,
      alertTotalPercentage: json['alert_total_percentage'] != null
          ? (json['alert_total_percentage'] as num).toInt()
          : null,
      falsePositives: json['false_positives'] != null
          ? (json['false_positives'] as num).toInt()
          : null,
      falsePositiveRate: json['false_positive_rate'] != null
          ? (json['false_positive_rate'] as num).toInt()
          : null,
      bypassRate: json['bypass_rate'] != null
          ? (json['bypass_rate'] as num).toInt()
          : null,
      defaultSetting: json['default_setting'] != null
          ? SecretScanningPatternOverrideDefaultSetting.fromJson(
              json['default_setting'] as String,
            )
          : null,
      enterpriseSetting: json['enterprise_setting'] != null
          ? SecretScanningPatternOverrideEnterpriseSetting.fromJson(
              json['enterprise_setting'] as String,
            )
          : null,
      setting: json['setting'] != null
          ? SecretScanningPatternOverrideSetting.fromJson(
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (enterpriseSetting != null)
        'enterprise_setting': enterpriseSetting?.toJson(),
  ...
  SecretScanningPatternOverride copyWith({
    String Function()? tokenType,
    String? Function()? customPatternVersion,
    String Function()? slug,
    String Function()? displayName,
    int Function()? alertTotal,
    int Function()? alertTotalPercentage,
    int Function()? falsePositives,
    int Function()? falsePositiveRate,
    int Function()? bypassRate,
    SecretScanningPatternOverrideDefaultSetting Function()? defaultSetting,
    SecretScanningPatternOverrideEnterpriseSetting? Function()?
    enterpriseSetting,
    SecretScanningPatternOverrideSetting Function()? setting,
  }) {
    return SecretScanningPatternOverride(
      tokenType: tokenType != null ? tokenType() : this.tokenType,
      customPatternVersion: customPatternVersion != null
          ? customPatternVersion()
          : this.customPatternVersion,
      slug: slug != null ? slug() : this.slug,
      displayName: displayName != null ? displayName() : this.displayName,
      alertTotal: alertTotal != null ? alertTotal() : this.alertTotal,
      alertTotalPercentage: alertTotalPercentage != null
      ...
      defaultSetting: defaultSetting != null
          ? defaultSetting()
          : this.defaultSetting,
      enterpriseSetting: enterpriseSetting != null
          ? enterpriseSetting()
          : this.enterpriseSetting,
