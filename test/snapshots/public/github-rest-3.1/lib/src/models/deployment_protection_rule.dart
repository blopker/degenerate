...
final class DeploymentProtectionRule {
  ...
  DeploymentProtectionRule copyWith({
    int? id,
    String? nodeId,
    bool? enabled,
  ...
  @override
  int get hashCode {
    return Object.hash(id, nodeId, enabled, app);
  }

  @override
  String toString() {
    return 'DeploymentProtectionRule(id: $id, nodeId: $nodeId, enabled: $enabled, app: $app)';
  }
}
