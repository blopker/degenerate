...
final class Hook {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('type') &&
        ...
        json['url'] is String &&
        json.containsKey('test_url') &&
        json['test_url'] is String &&
        json.containsKey('ping_url') &&
        json['ping_url'] is String &&
  ...
  @override
  String toString() {
    return 'Hook(type: $type, id: $id, name: $name, active: $active, events: $events, config: $config, updatedAt: $updatedAt, createdAt: $createdAt, url: $url, testUrl: $testUrl, pingUrl: $pingUrl, deliveriesUrl: $deliveriesUrl, lastResponse: $lastResponse)';
  }
}
