...
import 'organization_dependabot_secret_visibility.dart';
...
final class OrganizationDependabotSecret {
  ...
  OrganizationDependabotSecret copyWith({
    String? name,
    DateTime? createdAt,
    DateTime? updatedAt,
    OrganizationDependabotSecretVisibility? visibility,
  ...
  @override
  String toString() {
    return 'OrganizationDependabotSecret(name: $name, createdAt: $createdAt, updatedAt: $updatedAt, visibility: $visibility, selectedRepositoriesUrl: $selectedRepositoriesUrl)';
  }
}
