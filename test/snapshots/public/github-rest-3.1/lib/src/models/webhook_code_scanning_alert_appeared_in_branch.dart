...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_code_scanning_alert_appeared_in_branch_action.dart';import 'webhook_code_scanning_alert_appeared_in_branch_alert.dart';final class WebhookCodeScanningAlertAppearedInBranch {const WebhookCodeScanningAlertAppearedInBranch({required this.action, required this.alert, required this.commitOid, this.enterprise, this.installation, this.organization, required this.ref, required this.repository, required this.sender, });
...
WebhookCodeScanningAlertAppearedInBranch copyWith({WebhookCodeScanningAlertAppearedInBranchAction? action, WebhookCodeScanningAlertAppearedInBranchAlert? alert, String? commitOid, EnterpriseWebhooks Function()? enterprise, SimpleInstallation Function()? installation, OrganizationSimpleWebhooks Function()? organization, String? ref, RepositoryWebhooks? repository, SimpleUser? sender, }) { return WebhookCodeScanningAlertAppearedInBranch(
