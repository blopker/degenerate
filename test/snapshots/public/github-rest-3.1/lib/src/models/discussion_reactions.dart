...
final class DiscussionReactions {
  ...
  factory DiscussionReactions.fromJson(Map<String, dynamic> json) {
  ...
  @override
  String toString() {
    return 'DiscussionReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)';
  }
}
