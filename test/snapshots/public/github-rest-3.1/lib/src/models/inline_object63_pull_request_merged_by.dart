...
import 'inline_object63_pull_request_merged_by_type.dart';

final class InlineObject63PullRequestMergedBy {
  const InlineObject63PullRequestMergedBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestMergedBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestMergedBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestMergedByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestMergedBy copyWith({
    ...
    InlineObject63PullRequestMergedByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject63PullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
