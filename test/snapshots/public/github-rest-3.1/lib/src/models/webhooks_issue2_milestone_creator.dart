...
import 'webhooks_issue2_milestone_creator_type.dart';

final class WebhooksIssue2MilestoneCreator {
  const WebhooksIssue2MilestoneCreator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksIssue2MilestoneCreator.fromJson(Map<String, dynamic> json) {
    return WebhooksIssue2MilestoneCreator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksIssue2MilestoneCreatorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksIssue2MilestoneCreator copyWith({
    ...
    WebhooksIssue2MilestoneCreatorType Function()? type,
    Uri Function()? url,
