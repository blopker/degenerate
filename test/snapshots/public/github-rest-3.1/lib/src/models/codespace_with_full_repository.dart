...
import 'codespace_machine.dart';
import 'codespace_with_full_repository_git_status.dart';
import 'codespace_with_full_repository_location.dart';
import 'codespace_with_full_repository_runtime_constraints.dart';
import 'codespace_with_full_repository_state.dart';
import 'full_repository.dart';
...
final class CodespaceWithFullRepository {
  ...
  factory CodespaceWithFullRepository.fromJson(Map<String, dynamic> json) {
    return CodespaceWithFullRepository(
      ...
      machine: CodespaceMachine.fromJson(
      ...
      publishUrl: json['publish_url'] != null
          ? Uri.parse(json['publish_url'] as String)
          : null,
      pullsUrl: Uri.parse(json['pulls_url'] as String),
      recentFolders: (json['recent_folders'] as List<dynamic>)
          .map((e) => e as String)
          .toList(),
      runtimeConstraints: json['runtime_constraints'] != null
          ? CodespaceWithFullRepositoryRuntimeConstraints.fromJson(
      ...
      retentionPeriodMinutes: json['retention_period_minutes'] != null
          ? (json['retention_period_minutes'] as num).toInt()
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        ...
        json['name'] is String &&
        json.containsKey('environment_id') &&
        json['environment_id'] is String &&
        json.containsKey('owner') &&
        json.containsKey('billable_owner') &&
        json.containsKey('repository') &&
        json.containsKey('machine') &&
        json.containsKey('prebuild') &&
        json['prebuild'] is bool &&
        json.containsKey('created_at') &&
        json['created_at'] is String &&
        json.containsKey('updated_at') &&
        json['updated_at'] is String &&
        json.containsKey('last_used_at') &&
        json['last_used_at'] is String &&
        json.containsKey('state') &&
        json.containsKey('url') &&
        json['url'] is String &&
        json.containsKey('git_status') &&
        json.containsKey('location') &&
        json.containsKey('idle_timeout_minutes') &&
        json['idle_timeout_minutes'] is num &&
        json.containsKey('web_url') &&
        json['web_url'] is String &&
        json.containsKey('machines_url') &&
        json['machines_url'] is String &&
        json.containsKey('start_url') &&
        json['start_url'] is String &&
        json.containsKey('stop_url') &&
        json['stop_url'] is String &&
        json.containsKey('pulls_url') &&
        json['pulls_url'] is String &&
        json.containsKey('recent_folders');
  }

  CodespaceWithFullRepository copyWith({
    int? id,
    String? name,
    String? Function()? displayName,
    String? Function()? environmentId,
    SimpleUser? owner,
    SimpleUser? billableOwner,
    FullRepository? repository,
    CodespaceMachine? Function()? machine,
    String? Function()? devcontainerPath,
    bool? Function()? prebuild,
    DateTime? createdAt,
    DateTime? updatedAt,
    DateTime? lastUsedAt,
    CodespaceWithFullRepositoryState? state,
    Uri? url,
    CodespaceWithFullRepositoryGitStatus? gitStatus,
    CodespaceWithFullRepositoryLocation? location,
    int? Function()? idleTimeoutMinutes,
    Uri? webUrl,
    Uri? machinesUrl,
    Uri? startUrl,
    Uri? stopUrl,
    Uri? Function()? publishUrl,
    Uri? Function()? pullsUrl,
    List<String>? recentFolders,
    CodespaceWithFullRepositoryRuntimeConstraints Function()?
    runtimeConstraints,
    bool? Function()? pendingOperation,
    String? Function()? pendingOperationDisabledReason,
    String? Function()? idleTimeoutNotice,
    int? Function()? retentionPeriodMinutes,
    DateTime? Function()? retentionExpiresAt,
  }) {
    return CodespaceWithFullRepository(
      id: id ?? this.id,
      name: name ?? this.name,
      ...
      pendingOperation: pendingOperation != null
          ? pendingOperation()
          : this.pendingOperation,
      pendingOperationDisabledReason: pendingOperationDisabledReason != null
          ? pendingOperationDisabledReason()
          : this.pendingOperationDisabledReason,
      idleTimeoutNotice: idleTimeoutNotice != null
          ? idleTimeoutNotice()
          : this.idleTimeoutNotice,
      retentionPeriodMinutes: retentionPeriodMinutes != null
