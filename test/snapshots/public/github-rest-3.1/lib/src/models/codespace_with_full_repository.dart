...
import 'package:collection/collection.dart';import 'codespace_machine.dart';import 'codespace_with_full_repository_git_status.dart';import 'codespace_with_full_repository_location.dart';import 'codespace_with_full_repository_runtime_constraints.dart';import 'codespace_with_full_repository_state.dart';import 'full_repository.dart';import 'simple_user.dart';/// A codespace.
...
factory CodespaceWithFullRepository.fromJson(Map<String, dynamic> json) { return CodespaceWithFullRepository(
  ...
  machine: CodespaceMachine.fromJson(json['machine'] as Map<String, dynamic>),
  ...
  runtimeConstraints: json['runtime_constraints'] != null
        ? CodespaceWithFullRepositoryRuntimeConstraints.fromJson(json['runtime_constraints'] as Map<String, dynamic>)
        : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CodespaceWithFullRepository &&
          ...
          const ListEquality<dynamic>().equals(recentFolders, other.recentFolders) &&
