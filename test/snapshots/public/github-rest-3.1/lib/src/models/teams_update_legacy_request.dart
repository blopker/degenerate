...
import 'teams_update_legacy_request_notification_setting.dart';
import 'teams_update_legacy_request_permission.dart';
import 'teams_update_legacy_request_privacy.dart';

final class TeamsUpdateLegacyRequest {
  ...
  factory TeamsUpdateLegacyRequest.fromJson(Map<String, dynamic> json) {
    return TeamsUpdateLegacyRequest(
      ...
      privacy: json['privacy'] != null
          ? TeamsUpdateLegacyRequestPrivacy.fromJson(json['privacy'] as String)
          : null,
      notificationSetting: json['notification_setting'] != null
          ? TeamsUpdateLegacyRequestNotificationSetting.fromJson(
              json['notification_setting'] as String,
            )
          : null,
      permission: json.containsKey('permission')
          ? TeamsUpdateLegacyRequestPermission.fromJson(
  ...
  TeamsUpdateLegacyRequest copyWith({
    String? name,
    String Function()? description,
    TeamsUpdateLegacyRequestPrivacy Function()? privacy,
    TeamsUpdateLegacyRequestNotificationSetting Function()? notificationSetting,
    TeamsUpdateLegacyRequestPermission Function()? permission,
  ...
  @override
  String toString() {
    return 'TeamsUpdateLegacyRequest(name: $name, description: $description, privacy: $privacy, notificationSetting: $notificationSetting, permission: $permission, parentTeamId: $parentTeamId)';
  }
}
