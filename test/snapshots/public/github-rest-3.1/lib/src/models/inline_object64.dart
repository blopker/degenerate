...
import 'inline_object64_type.dart';

final class InlineObject64 {
  const InlineObject64({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject64.fromJson(Map<String, dynamic> json) {
    return InlineObject64(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject64Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject64 copyWith({
    ...
    InlineObject64Type Function()? type,
    Uri Function()? url,
