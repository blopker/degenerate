...
final class ReposListForOrgType {
  const ReposListForOrgType._(this.value);

  factory ReposListForOrgType.fromJson(String json) {
    return switch (json) {
      'all' => all,
      'public' => public,
      'private' => private,
  ...
  static const List<ReposListForOrgType> values = [
    all,
    public,
    private,
    forks,
  ...
  @override
  String toString() {
    return 'ReposListForOrgType($value)';
  }
}
