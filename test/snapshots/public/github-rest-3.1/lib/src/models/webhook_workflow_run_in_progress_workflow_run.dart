...
factory WebhookWorkflowRunInProgressWorkflowRun.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunInProgressWorkflowRun(
  actor: WebhookWorkflowRunInProgressWorkflowRunActor.fromJson(json['actor'] as Map<String, dynamic>),
  ...
  conclusion: WebhookWorkflowRunInProgressWorkflowRunConclusion.fromJson(json['conclusion'] as String),
  ...
  triggeringActor: WebhookWorkflowRunInProgressWorkflowRunTriggeringActor.fromJson(json['triggering_actor'] as Map<String, dynamic>),
