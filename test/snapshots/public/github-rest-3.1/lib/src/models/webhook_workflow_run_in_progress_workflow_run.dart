...
import 'webhook_workflow_run_in_progress_workflow_run_actor.dart';
import 'webhook_workflow_run_in_progress_workflow_run_conclusion.dart';
import 'webhook_workflow_run_in_progress_workflow_run_head_commit.dart';
import 'webhook_workflow_run_in_progress_workflow_run_head_repository.dart';
import 'webhook_workflow_run_in_progress_workflow_run_pull_requests.dart';
import 'webhook_workflow_run_in_progress_workflow_run_referenced_workflows.dart';
import 'webhook_workflow_run_in_progress_workflow_run_repository.dart';
import 'webhook_workflow_run_in_progress_workflow_run_status.dart';
import 'webhook_workflow_run_in_progress_workflow_run_triggering_actor.dart';

final class WebhookWorkflowRunInProgressWorkflowRun {
  const WebhookWorkflowRunInProgressWorkflowRun({
    required this.actor,
  ...
  factory WebhookWorkflowRunInProgressWorkflowRun.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunInProgressWorkflowRun(
      actor: WebhookWorkflowRunInProgressWorkflowRunActor.fromJson(
      ...
      conclusion: WebhookWorkflowRunInProgressWorkflowRunConclusion.fromJson(
        json['conclusion'] as String,
      ),
      createdAt: DateTime.parse(json['created_at'] as String),
      event: json['event'] as String,
      headBranch: json['head_branch'] as String,
      headCommit: WebhookWorkflowRunInProgressWorkflowRunHeadCommit.fromJson(
        json['head_commit'] as Map<String, dynamic>,
      ),
      headRepository:
          WebhookWorkflowRunInProgressWorkflowRunHeadRepository.fromJson(
      ...
      pullRequests: (json['pull_requests'] as List<dynamic>)
          .map(
            (e) => WebhookWorkflowRunInProgressWorkflowRunPullRequests.fromJson(
      ...
      referencedWorkflows: (json['referenced_workflows'] as List<dynamic>?)
          ?.map(
            (e) =>
                WebhookWorkflowRunInProgressWorkflowRunReferencedWorkflows.fromJson(
                  e as Map<String, dynamic>,
                ),
          )
          .toList(),
      repository: WebhookWorkflowRunInProgressWorkflowRunRepository.fromJson(
      ...
      status: WebhookWorkflowRunInProgressWorkflowRunStatus.fromJson(
        json['status'] as String,
      ),
      triggeringActor:
          WebhookWorkflowRunInProgressWorkflowRunTriggeringActor.fromJson(
  ...
  final List<WebhookWorkflowRunInProgressWorkflowRunReferencedWorkflows>?
  referencedWorkflows;
  ...
  WebhookWorkflowRunInProgressWorkflowRun copyWith({
    WebhookWorkflowRunInProgressWorkflowRunActor? Function()? actor,
    Uri? artifactsUrl,
    Uri? cancelUrl,
    int? checkSuiteId,
    String? checkSuiteNodeId,
    Uri? checkSuiteUrl,
    WebhookWorkflowRunInProgressWorkflowRunConclusion? Function()? conclusion,
    DateTime? createdAt,
    String? event,
    String? Function()? headBranch,
    WebhookWorkflowRunInProgressWorkflowRunHeadCommit? headCommit,
    WebhookWorkflowRunInProgressWorkflowRunHeadRepository? headRepository,
    String? headSha,
    Uri? htmlUrl,
    int? id,
    Uri? jobsUrl,
    ...
    List<WebhookWorkflowRunInProgressWorkflowRunPullRequests?>? pullRequests,
    List<WebhookWorkflowRunInProgressWorkflowRunReferencedWorkflows>?
    Function()?
    referencedWorkflows,
    WebhookWorkflowRunInProgressWorkflowRunRepository? repository,
    Uri? rerunUrl,
    int? runAttempt,
    int? runNumber,
    DateTime? runStartedAt,
    WebhookWorkflowRunInProgressWorkflowRunStatus? status,
    WebhookWorkflowRunInProgressWorkflowRunTriggeringActor? Function()?
    triggeringActor,
    DateTime? updatedAt,
    Uri? url,
    int? workflowId,
