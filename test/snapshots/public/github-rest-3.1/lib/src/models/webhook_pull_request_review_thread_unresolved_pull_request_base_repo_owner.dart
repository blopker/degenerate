...
import 'webhook_pull_request_review_thread_unresolved_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner {
  const WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerType?
  type;
  ...
  WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwnerType
    Function()?
    type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
