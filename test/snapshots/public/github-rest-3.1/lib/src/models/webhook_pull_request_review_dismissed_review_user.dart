...
import 'webhook_pull_request_review_dismissed_review_user_type.dart';

final class WebhookPullRequestReviewDismissedReviewUser {
  const WebhookPullRequestReviewDismissedReviewUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewDismissedReviewUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewDismissedReviewUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewDismissedReviewUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewDismissedReviewUser copyWith({
    ...
    WebhookPullRequestReviewDismissedReviewUserType Function()? type,
    Uri Function()? url,
