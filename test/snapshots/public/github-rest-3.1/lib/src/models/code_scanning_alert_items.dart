...
import 'code_scanning_alert_dismissed_reason.dart';
import 'code_scanning_alert_instance.dart';
import 'code_scanning_alert_rule_summary.dart';
...
final class CodeScanningAlertItems {
  ...
  factory CodeScanningAlertItems.fromJson(Map<String, dynamic> json) {
    return CodeScanningAlertItems(
      ...
      dismissedReason: CodeScanningAlertDismissedReason.fromJson(
  ...
  CodeScanningAlertItems copyWith({
    int? number,
    DateTime? createdAt,
    ...
    CodeScanningAlertDismissedReason? Function()? dismissedReason,
    ...
    SimpleUser? Function()? dismissalApprovedBy,
