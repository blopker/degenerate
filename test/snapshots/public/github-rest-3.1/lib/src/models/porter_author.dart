...
final class PorterAuthor {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('id') &&
        json['id'] is num &&
        json.containsKey('remote_id') &&
        json['remote_id'] is String &&
        json.containsKey('remote_name') &&
        json['remote_name'] is String &&
        ...
        json['url'] is String &&
        json.containsKey('import_url') &&
        json['import_url'] is String;
  }

  PorterAuthor copyWith({
    int? id,
    String? remoteId,
    String? remoteName,
    String? email,
  ...
  @override
  int get hashCode {
    return Object.hash(id, remoteId, remoteName, email, name, url, importUrl);
  }
