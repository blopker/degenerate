...
import 'package:collection/collection.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_type.dart';import 'sub_issues_summary.dart';import 'webhook_issues_deleted_issue_active_lock_reason.dart';import 'webhook_issues_deleted_issue_assignee.dart';import 'webhook_issues_deleted_issue_assignees.dart';import 'webhook_issues_deleted_issue_author_association.dart';import 'webhook_issues_deleted_issue_labels.dart';import 'webhook_issues_deleted_issue_milestone.dart';import 'webhook_issues_deleted_issue_performed_via_github_app.dart';import 'webhook_issues_deleted_issue_pull_request.dart';import 'webhook_issues_deleted_issue_reactions.dart';import 'webhook_issues_deleted_issue_state.dart';import 'webhook_issues_deleted_issue_user.dart';/// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
...
factory WebhookIssuesDeletedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssue(
  ...
  assignee: json['assignee'] != null
        ? WebhookIssuesDeletedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>)
        : null,
  ...
  performedViaGithubApp: json['performed_via_github_app'] != null
        ? WebhookIssuesDeletedIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>)
        : null,
  pullRequest: json['pull_request'] != null
        ? WebhookIssuesDeletedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>)
        : null,
