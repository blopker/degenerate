...
import 'webhook_issues_deleted_issue_active_lock_reason.dart';
import 'webhook_issues_deleted_issue_assignee.dart';
import 'webhook_issues_deleted_issue_assignees.dart';
import 'webhook_issues_deleted_issue_author_association.dart';
import 'webhook_issues_deleted_issue_labels.dart';
import 'webhook_issues_deleted_issue_milestone.dart';
import 'webhook_issues_deleted_issue_performed_via_github_app.dart';
import 'webhook_issues_deleted_issue_pull_request.dart';
import 'webhook_issues_deleted_issue_reactions.dart';
import 'webhook_issues_deleted_issue_state.dart';
import 'webhook_issues_deleted_issue_user.dart';

/// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
final class WebhookIssuesDeletedIssue {
  const WebhookIssuesDeletedIssue({
  ...
  factory WebhookIssuesDeletedIssue.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesDeletedIssue(
      activeLockReason: WebhookIssuesDeletedIssueActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      assignee: json['assignee'] != null
          ? WebhookIssuesDeletedIssueAssignee.fromJson(
              json['assignee'] as Map<String, dynamic>,
            )
          : null,
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => WebhookIssuesDeletedIssueAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: WebhookIssuesDeletedIssueAuthorAssociation.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>?)
          ?.map(
            (e) => WebhookIssuesDeletedIssueLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      milestone: WebhookIssuesDeletedIssueMilestone.fromJson(
        json['milestone'] as Map<String, dynamic>,
      ),
      nodeId: json['node_id'] as String,
      number: (json['number'] as num).toInt(),
      performedViaGithubApp: json['performed_via_github_app'] != null
          ? WebhookIssuesDeletedIssuePerformedViaGithubApp.fromJson(
              json['performed_via_github_app'] as Map<String, dynamic>,
            )
          : null,
      pullRequest: json['pull_request'] != null
          ? WebhookIssuesDeletedIssuePullRequest.fromJson(
              json['pull_request'] as Map<String, dynamic>,
            )
          : null,
      reactions: WebhookIssuesDeletedIssueReactions.fromJson(
      ...
      state: json['state'] != null
          ? WebhookIssuesDeletedIssueState.fromJson(json['state'] as String)
          : null,
      ...
      user: WebhookIssuesDeletedIssueUser.fromJson(
  ...
  WebhookIssuesDeletedIssue copyWith({
    WebhookIssuesDeletedIssueActiveLockReason? Function()? activeLockReason,
    WebhookIssuesDeletedIssueAssignee? Function()? assignee,
    List<WebhookIssuesDeletedIssueAssignees?>? assignees,
    WebhookIssuesDeletedIssueAuthorAssociation? authorAssociation,
    ...
    Uri? htmlUrl,
    int? id,
    List<WebhookIssuesDeletedIssueLabels> Function()? labels,
    String? labelsUrl,
    bool Function()? locked,
    WebhookIssuesDeletedIssueMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    WebhookIssuesDeletedIssuePerformedViaGithubApp? Function()?
    performedViaGithubApp,
    WebhookIssuesDeletedIssuePullRequest Function()? pullRequest,
    ...
    WebhookIssuesDeletedIssueState Function()? state,
    ...
    DateTime? updatedAt,
    Uri? url,
    WebhookIssuesDeletedIssueUser? Function()? user,
  }) {
    return WebhookIssuesDeletedIssue(
