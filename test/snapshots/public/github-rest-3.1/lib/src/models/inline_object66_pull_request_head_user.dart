...
import 'inline_object66_pull_request_head_user_type.dart';

final class InlineObject66PullRequestHeadUser {
  const InlineObject66PullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestHeadUser copyWith({
    ...
    InlineObject66PullRequestHeadUserType Function()? type,
    Uri Function()? url,
