...
import 'webhook_pull_request_review_submitted_pull_request_head_user_type.dart';

final class WebhookPullRequestReviewSubmittedPullRequestHeadUser {
  const WebhookPullRequestReviewSubmittedPullRequestHeadUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewSubmittedPullRequestHeadUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewSubmittedPullRequestHeadUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewSubmittedPullRequestHeadUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestReviewSubmittedPullRequestHeadUser copyWith({
    ...
    WebhookPullRequestReviewSubmittedPullRequestHeadUserType Function()? type,
    Uri Function()? url,
