...
import 'webhook_pull_request_dequeued_pull_request_base_repo_owner_type.dart';

final class WebhookPullRequestDequeuedPullRequestBaseRepoOwner {
  const WebhookPullRequestDequeuedPullRequestBaseRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestDequeuedPullRequestBaseRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestDequeuedPullRequestBaseRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestDequeuedPullRequestBaseRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestDequeuedPullRequestBaseRepoOwner copyWith({
    ...
    WebhookPullRequestDequeuedPullRequestBaseRepoOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookPullRequestDequeuedPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
