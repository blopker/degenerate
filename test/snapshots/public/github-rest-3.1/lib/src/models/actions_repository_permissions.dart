...
import 'allowed_actions.dart';final class ActionsRepositoryPermissions {const ActionsRepositoryPermissions({required this.enabled, this.allowedActions, this.selectedActionsUrl, this.shaPinningRequired, });
...
ActionsRepositoryPermissions copyWith({bool? enabled, AllowedActions Function()? allowedActions, String Function()? selectedActionsUrl, bool Function()? shaPinningRequired, }) { return ActionsRepositoryPermissions(
