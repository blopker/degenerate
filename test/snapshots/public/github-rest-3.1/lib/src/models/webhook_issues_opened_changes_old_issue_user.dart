...
import 'webhook_issues_opened_changes_old_issue_user_type.dart';

final class WebhookIssuesOpenedChangesOldIssueUser {
  const WebhookIssuesOpenedChangesOldIssueUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssuesOpenedChangesOldIssueUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssuesOpenedChangesOldIssueUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssuesOpenedChangesOldIssueUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssuesOpenedChangesOldIssueUser copyWith({
    ...
    WebhookIssuesOpenedChangesOldIssueUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookIssuesOpenedChangesOldIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
