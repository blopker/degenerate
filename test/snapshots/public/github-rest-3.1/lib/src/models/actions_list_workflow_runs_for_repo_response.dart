...
final class ActionsListWorkflowRunsForRepoResponse {
  const ActionsListWorkflowRunsForRepoResponse({
    required this.totalCount,
    required this.workflowRuns,
  });

  factory ActionsListWorkflowRunsForRepoResponse.fromJson(
  ...
  ActionsListWorkflowRunsForRepoResponse copyWith({
    int? totalCount,
  ...
  @override
  int get hashCode {
    return Object.hash(totalCount, Object.hashAll(workflowRuns));
  }

  @override
  String toString() {
    return 'ActionsListWorkflowRunsForRepoResponse(totalCount: $totalCount, workflowRuns: $workflowRuns)';
  }
}
