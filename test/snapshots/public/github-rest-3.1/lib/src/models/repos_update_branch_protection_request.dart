...
import 'repos_update_branch_protection_request_required_pull_request_reviews.dart';
import 'repos_update_branch_protection_request_required_status_checks.dart';
import 'repos_update_branch_protection_request_restrictions.dart';

final class ReposUpdateBranchProtectionRequest {
  ...
  factory ReposUpdateBranchProtectionRequest.fromJson(
    ...
    return ReposUpdateBranchProtectionRequest(
      requiredStatusChecks:
          ReposUpdateBranchProtectionRequestRequiredStatusChecks.fromJson(
            json['required_status_checks'] as Map<String, dynamic>,
          ),
      enforceAdmins: json['enforce_admins'] as bool,
      requiredPullRequestReviews:
          ReposUpdateBranchProtectionRequestRequiredPullRequestReviews.fromJson(
            json['required_pull_request_reviews'] as Map<String, dynamic>,
          ),
      restrictions: ReposUpdateBranchProtectionRequestRestrictions.fromJson(
      ...
      lockBranch: json.containsKey('lock_branch')
          ? json['lock_branch'] as bool
          : false,
      allowForkSyncing: json.containsKey('allow_fork_syncing')
          ? json['allow_fork_syncing'] as bool
          : false,
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('required_status_checks') &&
        json.containsKey('enforce_admins') &&
        json['enforce_admins'] is bool &&
        json.containsKey('required_pull_request_reviews') &&
        json.containsKey('restrictions');
  }

  ReposUpdateBranchProtectionRequest copyWith({
    ReposUpdateBranchProtectionRequestRequiredStatusChecks? Function()?
    requiredStatusChecks,
    bool? Function()? enforceAdmins,
    ReposUpdateBranchProtectionRequestRequiredPullRequestReviews? Function()?
    requiredPullRequestReviews,
    ReposUpdateBranchProtectionRequestRestrictions? Function()? restrictions,
    bool Function()? requiredLinearHistory,
    bool? Function()? allowForcePushes,
    bool Function()? allowDeletions,
    bool Function()? blockCreations,
    bool Function()? requiredConversationResolution,
    bool Function()? lockBranch,
    bool Function()? allowForkSyncing,
  }) {
    return ReposUpdateBranchProtectionRequest(
