...
import 'webhook_workflow_run_requested_workflow_run_triggering_actor_type.dart';

final class WebhookWorkflowRunRequestedWorkflowRunTriggeringActor {
  const WebhookWorkflowRunRequestedWorkflowRunTriggeringActor({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookWorkflowRunRequestedWorkflowRunTriggeringActor.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunRequestedWorkflowRunTriggeringActor(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunRequestedWorkflowRunTriggeringActor copyWith({
    ...
    WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookWorkflowRunRequestedWorkflowRunTriggeringActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
