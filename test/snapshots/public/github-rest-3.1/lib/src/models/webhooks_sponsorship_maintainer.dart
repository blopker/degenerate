...
final class WebhooksSponsorshipMaintainer {
  const WebhooksSponsorshipMaintainer({
    this.avatarUrl,
    this.eventsUrl,
    this.followersUrl,
    this.followingUrl,
  ...
  factory WebhooksSponsorshipMaintainer.fromJson(Map<String, dynamic> json) {
  ...
  WebhooksSponsorshipMaintainer copyWith({
