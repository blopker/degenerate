...
import 'inline_object63_pull_request_base_user_type.dart';

final class InlineObject63PullRequestBaseUser {
  const InlineObject63PullRequestBaseUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject63PullRequestBaseUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject63PullRequestBaseUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject63PullRequestBaseUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject63PullRequestBaseUser copyWith({
    ...
    InlineObject63PullRequestBaseUserType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'InlineObject63PullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
