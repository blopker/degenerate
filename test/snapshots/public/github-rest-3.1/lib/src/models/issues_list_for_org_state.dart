...
final class IssuesListForOrgState {
  const IssuesListForOrgState._(this.value);

  factory IssuesListForOrgState.fromJson(String json) {
    return switch (json) {
      'open' => open,
      'closed' => closed,
      'all' => all,
  ...
  @override
  String toString() {
    return 'IssuesListForOrgState($value)';
  }
}
