...
import 'inline_object72_pull_request_active_lock_reason.dart';
import 'inline_object72_pull_request_assignee.dart';
import 'inline_object72_pull_request_assignees.dart';
import 'inline_object72_pull_request_author_association.dart';
import 'inline_object72_pull_request_auto_merge.dart';
import 'inline_object72_pull_request_base.dart';
import 'inline_object72_pull_request_head.dart';
import 'inline_object72_pull_request_labels.dart';
import 'inline_object72_pull_request_links.dart';
import 'inline_object72_pull_request_merged_by.dart';
import 'inline_object72_pull_request_milestone.dart';
import 'inline_object72_pull_request_requested_reviewers.dart';
import 'inline_object72_pull_request_requested_teams.dart';
import 'inline_object72_pull_request_state.dart';
import 'inline_object72_pull_request_user.dart';

final class InlineObject72PullRequest {
  const InlineObject72PullRequest({
    required this.links,
  ...
  factory InlineObject72PullRequest.fromJson(Map<String, dynamic> json) {
    return InlineObject72PullRequest(
      links: InlineObject72PullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason: InlineObject72PullRequestActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: InlineObject72PullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => InlineObject72PullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: InlineObject72PullRequestAuthorAssociation.fromJson(
        json['author_association'] as String,
      ),
      autoMerge: InlineObject72PullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: InlineObject72PullRequestBase.fromJson(
      ...
      head: InlineObject72PullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => InlineObject72PullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? InlineObject72PullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: InlineObject72PullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map((e) => InlineObject72PullRequestRequestedReviewers.fromJson(e))
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => InlineObject72PullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      user: InlineObject72PullRequestUser.fromJson(
  ...
  InlineObject72PullRequest copyWith({
    InlineObject72PullRequestLinks? links,
    InlineObject72PullRequestActiveLockReason? Function()? activeLockReason,
    int Function()? additions,
    InlineObject72PullRequestAssignee? Function()? assignee,
    List<InlineObject72PullRequestAssignees?>? assignees,
    InlineObject72PullRequestAuthorAssociation? authorAssociation,
    InlineObject72PullRequestAutoMerge? Function()? autoMerge,
    InlineObject72PullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    InlineObject72PullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<InlineObject72PullRequestLabels>? labels,
    bool? locked,
    ...
    InlineObject72PullRequestMergedBy? Function()? mergedBy,
    InlineObject72PullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<InlineObject72PullRequestRequestedReviewers>? requestedReviewers,
    List<InlineObject72PullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    InlineObject72PullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    InlineObject72PullRequestUser? Function()? user,
  }) {
    return InlineObject72PullRequest(
