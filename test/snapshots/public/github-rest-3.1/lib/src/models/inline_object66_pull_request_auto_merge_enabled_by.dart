...
import 'inline_object66_pull_request_auto_merge_enabled_by_type.dart';

final class InlineObject66PullRequestAutoMergeEnabledBy {
  const InlineObject66PullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject66PullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return InlineObject66PullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject66PullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  InlineObject66PullRequestAutoMergeEnabledBy copyWith({
    ...
    InlineObject66PullRequestAutoMergeEnabledByType Function()? type,
    Uri Function()? url,
