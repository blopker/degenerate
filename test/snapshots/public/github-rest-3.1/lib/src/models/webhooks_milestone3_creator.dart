...
import 'webhooks_milestone3_creator_type.dart';

final class WebhooksMilestone3Creator {
  const WebhooksMilestone3Creator({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksMilestone3Creator.fromJson(Map<String, dynamic> json) {
    return WebhooksMilestone3Creator(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksMilestone3CreatorType.fromJson(json['type'] as String)
          : null,
  ...
  WebhooksMilestone3Creator copyWith({
    ...
    WebhooksMilestone3CreatorType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksMilestone3Creator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
