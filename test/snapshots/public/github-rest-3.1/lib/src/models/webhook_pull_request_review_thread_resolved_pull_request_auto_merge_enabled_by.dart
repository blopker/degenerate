...
import 'webhook_pull_request_review_thread_resolved_pull_request_auto_merge_enabled_by_type.dart';

final class WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy {
  const WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  final WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType?
  type;
  ...
  WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy copyWith({
    ...
    WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType
    Function()?
    type,
    Uri Function()? url,
