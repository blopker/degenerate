...
import 'timeline_committed_event_author.dart';
import 'timeline_committed_event_committer.dart';
import 'timeline_committed_event_parents.dart';
import 'timeline_committed_event_tree.dart';
import 'timeline_committed_event_verification.dart';
...
final class TimelineCommittedEvent {
  ...
  factory TimelineCommittedEvent.fromJson(Map<String, dynamic> json) {
    return TimelineCommittedEvent(
      ...
      parents: (json['parents'] as List<dynamic>)
          .map(
            (e) => TimelineCommittedEventParents.fromJson(
  ...
  TimelineCommittedEvent copyWith({
    String Function()? event,
    String? sha,
    String? nodeId,
    Uri? url,
    TimelineCommittedEventAuthor? author,
    TimelineCommittedEventCommitter? committer,
    String? message,
    TimelineCommittedEventTree? tree,
    List<TimelineCommittedEventParents>? parents,
  ...
  @override
  String toString() {
    return 'TimelineCommittedEvent(event: $event, sha: $sha, nodeId: $nodeId, url: $url, author: $author, committer: $committer, message: $message, tree: $tree, parents: $parents, verification: $verification, htmlUrl: $htmlUrl)';
  }
}
