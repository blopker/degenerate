...
import 'webhook_sub_issues_parent_issue_added_action.dart';

final class WebhookSubIssuesParentIssueAdded {
  const WebhookSubIssuesParentIssueAdded({
    required this.action,
    required this.parentIssueId,
    required this.parentIssue,
    required this.parentIssueRepo,
  ...
  factory WebhookSubIssuesParentIssueAdded.fromJson(Map<String, dynamic> json) {
    return WebhookSubIssuesParentIssueAdded(
      action: WebhookSubIssuesParentIssueAddedAction.fromJson(
        json['action'] as String,
      ),
      parentIssueId: (json['parent_issue_id'] as num).toDouble(),
      parentIssue: Issue.fromJson(json['parent_issue'] as Map<String, dynamic>),
      parentIssueRepo: Repository.fromJson(
        json['parent_issue_repo'] as Map<String, dynamic>,
      ),
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('action') &&
        json.containsKey('parent_issue_id') &&
        json['parent_issue_id'] is num &&
        json.containsKey('parent_issue') &&
        json.containsKey('parent_issue_repo') &&
        json.containsKey('sub_issue_id') &&
        json['sub_issue_id'] is num &&
        json.containsKey('sub_issue');
  }

  WebhookSubIssuesParentIssueAdded copyWith({
    WebhookSubIssuesParentIssueAddedAction? action,
  ...
  @override
  String toString() {
    return 'WebhookSubIssuesParentIssueAdded(action: $action, parentIssueId: $parentIssueId, parentIssue: $parentIssue, parentIssueRepo: $parentIssueRepo, subIssueId: $subIssueId, subIssue: $subIssue, installation: $installation, organization: $organization, repository: $repository, sender: $sender)';
  }
}
