...
import 'repository_rule_merge_queue_parameters_grouping_strategy.dart';
import 'repository_rule_merge_queue_parameters_merge_method.dart';
...
final class RepositoryRuleMergeQueueParameters {
  ...
  factory RepositoryRuleMergeQueueParameters.fromJson(
    ...
    return RepositoryRuleMergeQueueParameters(
      checkResponseTimeoutMinutes:
          (json['check_response_timeout_minutes'] as num).toInt(),
      groupingStrategy:
      ...
      minEntriesToMergeWaitMinutes:
          (json['min_entries_to_merge_wait_minutes'] as num).toInt(),
    );
  }
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('check_response_timeout_minutes') &&
        json['check_response_timeout_minutes'] is num &&
        json.containsKey('grouping_strategy') &&
        json.containsKey('max_entries_to_build') &&
        json['max_entries_to_build'] is num &&
        json.containsKey('max_entries_to_merge') &&
        json['max_entries_to_merge'] is num &&
        json.containsKey('merge_method') &&
        json.containsKey('min_entries_to_merge') &&
        json['min_entries_to_merge'] is num &&
        json.containsKey('min_entries_to_merge_wait_minutes') &&
        json['min_entries_to_merge_wait_minutes'] is num;
  }

  RepositoryRuleMergeQueueParameters copyWith({
    int? checkResponseTimeoutMinutes,
    RepositoryRuleMergeQueueParametersGroupingStrategy? groupingStrategy,
    int? maxEntriesToBuild,
    int? maxEntriesToMerge,
    RepositoryRuleMergeQueueParametersMergeMethod? mergeMethod,
    int? minEntriesToMerge,
    int? minEntriesToMergeWaitMinutes,
  }) {
    return RepositoryRuleMergeQueueParameters(
      checkResponseTimeoutMinutes:
          checkResponseTimeoutMinutes ?? this.checkResponseTimeoutMinutes,
  ...
  @override
  String toString() {
    return 'RepositoryRuleMergeQueueParameters(checkResponseTimeoutMinutes: $checkResponseTimeoutMinutes, groupingStrategy: $groupingStrategy, maxEntriesToBuild: $maxEntriesToBuild, maxEntriesToMerge: $maxEntriesToMerge, mergeMethod: $mergeMethod, minEntriesToMerge: $minEntriesToMerge, minEntriesToMergeWaitMinutes: $minEntriesToMergeWaitMinutes)';
  }
}
