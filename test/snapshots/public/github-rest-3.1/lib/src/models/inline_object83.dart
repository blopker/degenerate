...
import 'inline_object83_type.dart';

final class InlineObject83 {
  const InlineObject83({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory InlineObject83.fromJson(Map<String, dynamic> json) {
    return InlineObject83(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? InlineObject83Type.fromJson(json['type'] as String)
          : null,
  ...
  InlineObject83 copyWith({
    ...
    InlineObject83Type Function()? type,
    Uri Function()? url,
