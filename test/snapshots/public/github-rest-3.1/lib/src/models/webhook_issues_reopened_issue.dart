...
import 'webhook_issues_reopened_issue_active_lock_reason.dart';
import 'webhook_issues_reopened_issue_assignee.dart';
import 'webhook_issues_reopened_issue_assignees.dart';
import 'webhook_issues_reopened_issue_author_association.dart';
import 'webhook_issues_reopened_issue_labels.dart';
import 'webhook_issues_reopened_issue_milestone.dart';
import 'webhook_issues_reopened_issue_performed_via_github_app.dart';
import 'webhook_issues_reopened_issue_pull_request.dart';
import 'webhook_issues_reopened_issue_reactions.dart';
import 'webhook_issues_reopened_issue_state.dart';
import 'webhook_issues_reopened_issue_user.dart';

/// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
final class WebhookIssuesReopenedIssue {
  const WebhookIssuesReopenedIssue({
  ...
  factory WebhookIssuesReopenedIssue.fromJson(Map<String, dynamic> json) {
    return WebhookIssuesReopenedIssue(
      activeLockReason: WebhookIssuesReopenedIssueActiveLockReason.fromJson(
        json['active_lock_reason'] as String,
      ),
      assignee: json['assignee'] != null
          ? WebhookIssuesReopenedIssueAssignee.fromJson(
              json['assignee'] as Map<String, dynamic>,
            )
          : null,
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => WebhookIssuesReopenedIssueAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation: WebhookIssuesReopenedIssueAuthorAssociation.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>?)
          ?.map(
            (e) => WebhookIssuesReopenedIssueLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      milestone: WebhookIssuesReopenedIssueMilestone.fromJson(
        json['milestone'] as Map<String, dynamic>,
      ),
      nodeId: json['node_id'] as String,
      number: (json['number'] as num).toInt(),
      performedViaGithubApp: json['performed_via_github_app'] != null
          ? WebhookIssuesReopenedIssuePerformedViaGithubApp.fromJson(
              json['performed_via_github_app'] as Map<String, dynamic>,
            )
          : null,
      pullRequest: json['pull_request'] != null
          ? WebhookIssuesReopenedIssuePullRequest.fromJson(
              json['pull_request'] as Map<String, dynamic>,
            )
          : null,
      reactions: WebhookIssuesReopenedIssueReactions.fromJson(
      ...
      user: WebhookIssuesReopenedIssueUser.fromJson(
  ...
  WebhookIssuesReopenedIssue copyWith({
    WebhookIssuesReopenedIssueActiveLockReason? Function()? activeLockReason,
    WebhookIssuesReopenedIssueAssignee? Function()? assignee,
    List<WebhookIssuesReopenedIssueAssignees?>? assignees,
    WebhookIssuesReopenedIssueAuthorAssociation? authorAssociation,
    ...
    Uri? htmlUrl,
    int? id,
    List<WebhookIssuesReopenedIssueLabels> Function()? labels,
    String? labelsUrl,
    bool Function()? locked,
    WebhookIssuesReopenedIssueMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    WebhookIssuesReopenedIssuePerformedViaGithubApp? Function()?
    performedViaGithubApp,
    WebhookIssuesReopenedIssuePullRequest Function()? pullRequest,
    WebhookIssuesReopenedIssueReactions? reactions,
    Uri? repositoryUrl,
    ...
    WebhookIssuesReopenedIssueState? state,
    String? Function()? stateReason,
    Uri Function()? timelineUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    WebhookIssuesReopenedIssueUser? Function()? user,
