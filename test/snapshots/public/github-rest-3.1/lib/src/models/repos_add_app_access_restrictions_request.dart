...
import 'package:collection/collection.dart';final class ReposAddAppAccessRestrictionsRequest {const ReposAddAppAccessRestrictionsRequest({required this.apps});
