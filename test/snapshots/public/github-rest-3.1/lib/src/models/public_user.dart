...
final class PublicUser {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('login') &&
        ...
        json.containsKey('hireable') &&
        json['hireable'] is bool &&
        json.containsKey('bio') &&
        json['bio'] is String &&
