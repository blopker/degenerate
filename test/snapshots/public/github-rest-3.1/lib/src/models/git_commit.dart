...
import 'git_commit_author.dart';
import 'git_commit_committer.dart';
import 'git_commit_parents.dart';
import 'git_commit_tree.dart';
import 'git_commit_verification.dart';
  ...
  factory GitCommit.fromJson(Map<String, dynamic> json) {
    return GitCommit(
      ...
      parents: (json['parents'] as List<dynamic>)
          .map((e) => GitCommitParents.fromJson(e as Map<String, dynamic>))
          .toList(),
