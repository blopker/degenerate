...
final class DeploymentSimple {
  ...
  DeploymentSimple copyWith({
    Uri? url,
    int? id,
    String? nodeId,
    String? task,
    String Function()? originalEnvironment,
    String? environment,
    ...
    return DeploymentSimple(
      ...
      task: task ?? this.task,
      originalEnvironment: originalEnvironment != null
          ? originalEnvironment()
          : this.originalEnvironment,
  ...
  @override
  String toString() {
    return 'DeploymentSimple(url: $url, id: $id, nodeId: $nodeId, task: $task, originalEnvironment: $originalEnvironment, environment: $environment, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, statusesUrl: $statusesUrl, repositoryUrl: $repositoryUrl, transientEnvironment: $transientEnvironment, productionEnvironment: $productionEnvironment, performedViaGithubApp: $performedViaGithubApp)';
  }
}
