...
import 'webhook_workflow_run_completed_workflow_run_repository_owner_type.dart';

final class WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner {
  const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner copyWith({
    ...
    WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
