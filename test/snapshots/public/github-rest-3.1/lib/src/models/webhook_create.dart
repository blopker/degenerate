...
import 'webhook_create_ref_type.dart';
...
final class WebhookCreate {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('description') &&
        ...
        json.containsKey('master_branch') &&
        json['master_branch'] is String &&
        json.containsKey('pusher_type') &&
        json['pusher_type'] is String &&
  ...
  @override
  String toString() {
    return 'WebhookCreate(description: $description, enterprise: $enterprise, installation: $installation, masterBranch: $masterBranch, organization: $organization, pusherType: $pusherType, ref: $ref, refType: $refType, repository: $repository, sender: $sender)';
  }
}
