...
final class PublicUserPlan {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('collaborators') &&
  ...
  @override
  int get hashCode {
    return Object.hash(collaborators, name, space, privateRepos);
  }

  @override
  String toString() {
    return 'PublicUserPlan(collaborators: $collaborators, name: $name, space: $space, privateRepos: $privateRepos)';
  }
}
