...
import 'package:collection/collection.dart';import 'code_scanning_alert_classification.dart';import 'code_scanning_alert_instance_message.dart';import 'code_scanning_alert_location.dart';import 'code_scanning_alert_state.dart';final class CodeScanningAlertInstance {const CodeScanningAlertInstance({this.ref, this.analysisKey, this.environment, this.category, this.state, this.commitSha, this.message, this.location, this.htmlUrl, this.classifications, });
...
factory CodeScanningAlertInstance.fromJson(Map<String, dynamic> json) { return CodeScanningAlertInstance(
  ...
  message: json['message'] != null
        ? CodeScanningAlertInstanceMessage.fromJson(json['message'] as Map<String, dynamic>)
        : null,
...
CodeScanningAlertInstance copyWith({String Function()? ref, String Function()? analysisKey, String Function()? environment, String Function()? category, CodeScanningAlertState? Function()? state, String Function()? commitSha, CodeScanningAlertInstanceMessage Function()? message, CodeScanningAlertLocation Function()? location, String Function()? htmlUrl, List<CodeScanningAlertClassification> Function()? classifications, }) { return CodeScanningAlertInstance(
