...
import 'actions_create_self_hosted_runner_group_for_org_request_visibility.dart';

final class ActionsCreateSelfHostedRunnerGroupForOrgRequest {
  ...
  factory ActionsCreateSelfHostedRunnerGroupForOrgRequest.fromJson(
    ...
    return ActionsCreateSelfHostedRunnerGroupForOrgRequest(
      ...
      runners: (json['runners'] as List<dynamic>?)
          ?.map((e) => (e as num).toInt())
          .toList(),
      allowsPublicRepositories: json.containsKey('allows_public_repositories')
          ? json['allows_public_repositories'] as bool
          : false,
      restrictedToWorkflows: json.containsKey('restricted_to_workflows')
          ? json['restricted_to_workflows'] as bool
          : false,
      selectedWorkflows: (json['selected_workflows'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  ...
  ActionsCreateSelfHostedRunnerGroupForOrgRequest copyWith({
    String? name,
    ActionsCreateSelfHostedRunnerGroupForOrgRequestVisibility Function()?
    visibility,
    List<int> Function()? selectedRepositoryIds,
    List<int> Function()? runners,
    bool Function()? allowsPublicRepositories,
    bool Function()? restrictedToWorkflows,
    List<String> Function()? selectedWorkflows,
    ...
    return ActionsCreateSelfHostedRunnerGroupForOrgRequest(
      ...
      allowsPublicRepositories: allowsPublicRepositories != null
          ? allowsPublicRepositories()
          : this.allowsPublicRepositories,
      restrictedToWorkflows: restrictedToWorkflows != null
          ? restrictedToWorkflows()
          : this.restrictedToWorkflows,
      selectedWorkflows: selectedWorkflows != null
          ? selectedWorkflows()
          : this.selectedWorkflows,
      networkConfigurationId: networkConfigurationId != null
  ...
  int get hashCode {
    return Object.hash(
      ...
      Object.hashAll(runners ?? const []),
      allowsPublicRepositories,
      restrictedToWorkflows,
      Object.hashAll(selectedWorkflows ?? const []),
      networkConfigurationId,
    );
  }
