...
import 'webhook_workflow_run_completed_workflow_run_triggering_actor_type.dart';final class WebhookWorkflowRunCompletedWorkflowRunTriggeringActor {const WebhookWorkflowRunCompletedWorkflowRunTriggeringActor({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
