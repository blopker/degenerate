...
final class ThreadSubscription {
  ...
  factory ThreadSubscription.fromJson(Map<String, dynamic> json) {
    return ThreadSubscription(
      ...
      threadUrl: json['thread_url'] != null
          ? Uri.parse(json['thread_url'] as String)
          : null,
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('subscribed') &&
        json['subscribed'] is bool &&
        json.containsKey('ignored') &&
        json['ignored'] is bool &&
  ...
  ThreadSubscription copyWith({
    bool? subscribed,
    bool? ignored,
    String? Function()? reason,
    DateTime? Function()? createdAt,
    Uri? url,
    Uri Function()? threadUrl,
