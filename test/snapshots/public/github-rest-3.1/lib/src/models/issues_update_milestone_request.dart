...
import 'issues_update_milestone_request_state.dart';

final class IssuesUpdateMilestoneRequest {
  ...
  factory IssuesUpdateMilestoneRequest.fromJson(Map<String, dynamic> json) {
    return IssuesUpdateMilestoneRequest(
      ...
      state: json.containsKey('state')
          ? IssuesUpdateMilestoneRequestState.fromJson(json['state'] as String)
  ...
  IssuesUpdateMilestoneRequest copyWith({
    String Function()? title,
    IssuesUpdateMilestoneRequestState Function()? state,
  ...
  @override
  int get hashCode {
    return Object.hash(title, state, description, dueOn);
  }

  @override
  String toString() {
    return 'IssuesUpdateMilestoneRequest(title: $title, state: $state, description: $description, dueOn: $dueOn)';
  }
}
