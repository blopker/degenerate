...
final class CheckSuiteConclusion {
  ...
  static const CheckSuiteConclusion cancelled = CheckSuiteConclusion._(
    'cancelled',
  );

  static const CheckSuiteConclusion skipped = CheckSuiteConclusion._('skipped');

  static const CheckSuiteConclusion timedOut = CheckSuiteConclusion._(
    'timed_out',
  );

  static const CheckSuiteConclusion actionRequired = CheckSuiteConclusion._(
    'action_required',
  );

  static const CheckSuiteConclusion startupFailure = CheckSuiteConclusion._(
    'startup_failure',
  );
  ...
  static const List<CheckSuiteConclusion> values = [
    success,
    failure,
    neutral,
    cancelled,
  ...
  @override
  String toString() {
    return 'CheckSuiteConclusion($value)';
  }
}
