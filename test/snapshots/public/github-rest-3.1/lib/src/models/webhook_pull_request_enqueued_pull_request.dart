...
import 'webhook_pull_request_enqueued_pull_request_active_lock_reason.dart';
import 'webhook_pull_request_enqueued_pull_request_assignee.dart';
import 'webhook_pull_request_enqueued_pull_request_assignees.dart';
import 'webhook_pull_request_enqueued_pull_request_author_association.dart';
import 'webhook_pull_request_enqueued_pull_request_auto_merge.dart';
import 'webhook_pull_request_enqueued_pull_request_base.dart';
import 'webhook_pull_request_enqueued_pull_request_head.dart';
import 'webhook_pull_request_enqueued_pull_request_labels.dart';
import 'webhook_pull_request_enqueued_pull_request_links.dart';
import 'webhook_pull_request_enqueued_pull_request_merged_by.dart';
import 'webhook_pull_request_enqueued_pull_request_milestone.dart';
import 'webhook_pull_request_enqueued_pull_request_requested_reviewers.dart';
import 'webhook_pull_request_enqueued_pull_request_requested_teams.dart';
import 'webhook_pull_request_enqueued_pull_request_state.dart';
import 'webhook_pull_request_enqueued_pull_request_user.dart';

final class WebhookPullRequestEnqueuedPullRequest {
  const WebhookPullRequestEnqueuedPullRequest({
    required this.links,
  ...
  factory WebhookPullRequestEnqueuedPullRequest.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestEnqueuedPullRequest(
      links: WebhookPullRequestEnqueuedPullRequestLinks.fromJson(
        json['_links'] as Map<String, dynamic>,
      ),
      activeLockReason:
          WebhookPullRequestEnqueuedPullRequestActiveLockReason.fromJson(
            json['active_lock_reason'] as String,
          ),
      additions: json['additions'] != null
          ? (json['additions'] as num).toInt()
          : null,
      assignee: WebhookPullRequestEnqueuedPullRequestAssignee.fromJson(
        json['assignee'] as Map<String, dynamic>,
      ),
      assignees: (json['assignees'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestEnqueuedPullRequestAssignees.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      authorAssociation:
          WebhookPullRequestEnqueuedPullRequestAuthorAssociation.fromJson(
            json['author_association'] as String,
          ),
      autoMerge: WebhookPullRequestEnqueuedPullRequestAutoMerge.fromJson(
        json['auto_merge'] as Map<String, dynamic>,
      ),
      base: WebhookPullRequestEnqueuedPullRequestBase.fromJson(
      ...
      head: WebhookPullRequestEnqueuedPullRequestHead.fromJson(
      ...
      labels: (json['labels'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestEnqueuedPullRequestLabels.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      mergedBy: json['merged_by'] != null
          ? WebhookPullRequestEnqueuedPullRequestMergedBy.fromJson(
              json['merged_by'] as Map<String, dynamic>,
            )
          : null,
      milestone: WebhookPullRequestEnqueuedPullRequestMilestone.fromJson(
      ...
      requestedReviewers: (json['requested_reviewers'] as List<dynamic>)
          .map(
            (e) =>
                WebhookPullRequestEnqueuedPullRequestRequestedReviewers.fromJson(
                  e,
                ),
          )
          .toList(),
      requestedTeams: (json['requested_teams'] as List<dynamic>)
          .map(
            (e) => WebhookPullRequestEnqueuedPullRequestRequestedTeams.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
      ...
      state: WebhookPullRequestEnqueuedPullRequestState.fromJson(
      ...
      user: WebhookPullRequestEnqueuedPullRequestUser.fromJson(
  ...
  final WebhookPullRequestEnqueuedPullRequestAuthorAssociation
  authorAssociation;
  ...
  final List<WebhookPullRequestEnqueuedPullRequestRequestedReviewers>
  requestedReviewers;

  final List<WebhookPullRequestEnqueuedPullRequestRequestedTeams>
  requestedTeams;
  ...
  WebhookPullRequestEnqueuedPullRequest copyWith({
    WebhookPullRequestEnqueuedPullRequestLinks? links,
    WebhookPullRequestEnqueuedPullRequestActiveLockReason? Function()?
    activeLockReason,
    int Function()? additions,
    WebhookPullRequestEnqueuedPullRequestAssignee? Function()? assignee,
    List<WebhookPullRequestEnqueuedPullRequestAssignees?>? assignees,
    WebhookPullRequestEnqueuedPullRequestAuthorAssociation? authorAssociation,
    WebhookPullRequestEnqueuedPullRequestAutoMerge? Function()? autoMerge,
    WebhookPullRequestEnqueuedPullRequestBase? base,
    ...
    Uri? diffUrl,
    bool? draft,
    WebhookPullRequestEnqueuedPullRequestHead? head,
    Uri? htmlUrl,
    int? id,
    Uri? issueUrl,
    List<WebhookPullRequestEnqueuedPullRequestLabels>? labels,
    bool? locked,
    ...
    WebhookPullRequestEnqueuedPullRequestMergedBy? Function()? mergedBy,
    WebhookPullRequestEnqueuedPullRequestMilestone? Function()? milestone,
    String? nodeId,
    int? number,
    Uri? patchUrl,
    bool? Function()? rebaseable,
    List<WebhookPullRequestEnqueuedPullRequestRequestedReviewers>?
    requestedReviewers,
    List<WebhookPullRequestEnqueuedPullRequestRequestedTeams>? requestedTeams,
    String? reviewCommentUrl,
    int Function()? reviewComments,
    Uri? reviewCommentsUrl,
    WebhookPullRequestEnqueuedPullRequestState? state,
    Uri? statusesUrl,
    String? title,
    DateTime? updatedAt,
    Uri? url,
    WebhookPullRequestEnqueuedPullRequestUser? Function()? user,
  }) {
    return WebhookPullRequestEnqueuedPullRequest(
