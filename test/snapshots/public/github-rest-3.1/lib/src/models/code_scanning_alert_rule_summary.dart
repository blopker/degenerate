...
import 'package:collection/collection.dart';import 'code_scanning_alert_rule_summary_security_severity_level.dart';import 'code_scanning_alert_rule_summary_severity.dart';final class CodeScanningAlertRuleSummary {const CodeScanningAlertRuleSummary({this.id, this.name, this.severity, this.securitySeverityLevel, this.description, this.fullDescription, this.tags, this.help, this.helpUri, });
