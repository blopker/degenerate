...
import 'code_scanning_alert_rule_summary_security_severity_level.dart';
import 'code_scanning_alert_rule_summary_severity.dart';
...
final class CodeScanningAlertRuleSummary {
  ...
  factory CodeScanningAlertRuleSummary.fromJson(Map<String, dynamic> json) {
    return CodeScanningAlertRuleSummary(
      ...
      severity: json['severity'] != null
          ? CodeScanningAlertRuleSummarySeverity.fromJson(
              json['severity'] as String,
            )
          : null,
      securitySeverityLevel: json['security_severity_level'] != null
  ...
  CodeScanningAlertRuleSummary copyWith({
    String? Function()? id,
    String Function()? name,
    CodeScanningAlertRuleSummarySeverity? Function()? severity,
    CodeScanningAlertRuleSummarySecuritySeverityLevel? Function()?
    securitySeverityLevel,
    ...
    return CodeScanningAlertRuleSummary(
      ...
      securitySeverityLevel: securitySeverityLevel != null
          ? securitySeverityLevel()
          : this.securitySeverityLevel,
  ...
  @override
  String toString() {
    return 'CodeScanningAlertRuleSummary(id: $id, name: $name, severity: $severity, securitySeverityLevel: $securitySeverityLevel, description: $description, fullDescription: $fullDescription, tags: $tags, help: $help, helpUri: $helpUri)';
  }
}
