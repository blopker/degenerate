...
import 'webhook_check_suite_completed_check_suite_app_owner_type.dart';

final class WebhookCheckSuiteCompletedCheckSuiteAppOwner {
  const WebhookCheckSuiteCompletedCheckSuiteAppOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookCheckSuiteCompletedCheckSuiteAppOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookCheckSuiteCompletedCheckSuiteAppOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookCheckSuiteCompletedCheckSuiteAppOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookCheckSuiteCompletedCheckSuiteAppOwner copyWith({
    ...
    WebhookCheckSuiteCompletedCheckSuiteAppOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhookCheckSuiteCompletedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
