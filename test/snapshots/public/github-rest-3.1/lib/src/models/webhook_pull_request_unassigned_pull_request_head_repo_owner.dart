...
import 'webhook_pull_request_unassigned_pull_request_head_repo_owner_type.dart';

final class WebhookPullRequestUnassignedPullRequestHeadRepoOwner {
  const WebhookPullRequestUnassignedPullRequestHeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookPullRequestUnassignedPullRequestHeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookPullRequestUnassignedPullRequestHeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookPullRequestUnassignedPullRequestHeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookPullRequestUnassignedPullRequestHeadRepoOwner copyWith({
    ...
    WebhookPullRequestUnassignedPullRequestHeadRepoOwnerType Function()? type,
    Uri Function()? url,
