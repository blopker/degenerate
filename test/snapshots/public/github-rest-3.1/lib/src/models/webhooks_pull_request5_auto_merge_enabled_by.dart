...
import 'webhooks_pull_request5_auto_merge_enabled_by_type.dart';

final class WebhooksPullRequest5AutoMergeEnabledBy {
  const WebhooksPullRequest5AutoMergeEnabledBy({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5AutoMergeEnabledBy.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhooksPullRequest5AutoMergeEnabledBy(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5AutoMergeEnabledByType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhooksPullRequest5AutoMergeEnabledBy copyWith({
    ...
    WebhooksPullRequest5AutoMergeEnabledByType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksPullRequest5AutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
