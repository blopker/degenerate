...
import 'package:collection/collection.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_type.dart';import 'sub_issues_summary.dart';import 'webhook_issues_opened_issue_active_lock_reason.dart';import 'webhook_issues_opened_issue_assignee.dart';import 'webhook_issues_opened_issue_assignees.dart';import 'webhook_issues_opened_issue_author_association.dart';import 'webhook_issues_opened_issue_labels.dart';import 'webhook_issues_opened_issue_milestone.dart';import 'webhook_issues_opened_issue_performed_via_github_app.dart';import 'webhook_issues_opened_issue_pull_request.dart';import 'webhook_issues_opened_issue_reactions.dart';import 'webhook_issues_opened_issue_state.dart';import 'webhook_issues_opened_issue_user.dart';/// The [issue](https://docs.github.com/rest/issues/issues#get-an-issue) itself.
...
factory WebhookIssuesOpenedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedIssue(
  activeLockReason: WebhookIssuesOpenedIssueActiveLockReason.fromJson(json['active_lock_reason'] as String),
  assignee: json['assignee'] != null
        ? WebhookIssuesOpenedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>)
        : null,
  ...
  milestone: WebhookIssuesOpenedIssueMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  performedViaGithubApp: json['performed_via_github_app'] != null
        ? WebhookIssuesOpenedIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>)
        : null,
  pullRequest: json['pull_request'] != null
        ? WebhookIssuesOpenedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>)
        : null,
  ...
  pinnedComment: json['pinned_comment'] != null
        ...
        : null,
  user: WebhookIssuesOpenedIssueUser.fromJson(json['user'] as Map<String, dynamic>),
); }
