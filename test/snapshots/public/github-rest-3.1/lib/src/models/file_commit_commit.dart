...
import 'file_commit_commit_author.dart';
import 'file_commit_commit_committer.dart';
import 'file_commit_commit_parents.dart';
import 'file_commit_commit_tree.dart';
import 'file_commit_commit_verification.dart';

final class FileCommitCommit {
  ...
  factory FileCommitCommit.fromJson(Map<String, dynamic> json) {
    return FileCommitCommit(
      ...
      author: json['author'] != null
          ? FileCommitCommitAuthor.fromJson(
              json['author'] as Map<String, dynamic>,
            )
          : null,
      committer: json['committer'] != null
          ? FileCommitCommitCommitter.fromJson(
      ...
      parents: (json['parents'] as List<dynamic>?)
          ?.map(
            (e) => FileCommitCommitParents.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      verification: json['verification'] != null
          ? FileCommitCommitVerification.fromJson(
  ...
  FileCommitCommit copyWith({
    String Function()? sha,
    String Function()? nodeId,
    String Function()? url,
    String Function()? htmlUrl,
    FileCommitCommitAuthor Function()? author,
    FileCommitCommitCommitter Function()? committer,
    String Function()? message,
    FileCommitCommitTree Function()? tree,
    List<FileCommitCommitParents> Function()? parents,
    FileCommitCommitVerification Function()? verification,
  }) {
    return FileCommitCommit(
