...
import 'commit_search_result_item_commit.dart';
import 'commit_search_result_item_parents.dart';
...
final class CommitSearchResultItem {
  ...
  factory CommitSearchResultItem.fromJson(Map<String, dynamic> json) {
    return CommitSearchResultItem(
      ...
      parents: (json['parents'] as List<dynamic>)
          .map(
            (e) => CommitSearchResultItemParents.fromJson(
  ...
  CommitSearchResultItem copyWith({
    Uri? url,
    String? sha,
    Uri? htmlUrl,
    Uri? commentsUrl,
