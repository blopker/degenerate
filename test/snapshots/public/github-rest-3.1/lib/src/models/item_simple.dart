...
import 'item_simple_content.dart';
import 'simple_user.dart';

/// An item belonging to a project
final class ItemSimple {
  const ItemSimple({
    required this.id,
    this.nodeId,
    this.content,
  ...
  ItemSimple copyWith({
    ...
    ItemSimpleContent Function()? content,
  ...
  @override
  String toString() {
    return 'ItemSimple(id: $id, nodeId: $nodeId, content: $content, contentType: $contentType, creator: $creator, createdAt: $createdAt, updatedAt: $updatedAt, archivedAt: $archivedAt, projectUrl: $projectUrl, itemUrl: $itemUrl)';
  }
}
