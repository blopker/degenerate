...
import 'webhooks_pull_request5_head_repo_owner_type.dart';

final class WebhooksPullRequest5HeadRepoOwner {
  const WebhooksPullRequest5HeadRepoOwner({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhooksPullRequest5HeadRepoOwner.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhooksPullRequest5HeadRepoOwner(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhooksPullRequest5HeadRepoOwnerType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhooksPullRequest5HeadRepoOwner copyWith({
    ...
    WebhooksPullRequest5HeadRepoOwnerType Function()? type,
    Uri Function()? url,
  ...
  @override
  String toString() {
    return 'WebhooksPullRequest5HeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)';
  }
}
