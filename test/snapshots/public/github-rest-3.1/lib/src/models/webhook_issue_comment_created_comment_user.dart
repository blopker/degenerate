...
import 'webhook_issue_comment_created_comment_user_type.dart';

final class WebhookIssueCommentCreatedCommentUser {
  const WebhookIssueCommentCreatedCommentUser({
    this.avatarUrl,
    this.deleted,
    this.email,
    this.eventsUrl,
  ...
  factory WebhookIssueCommentCreatedCommentUser.fromJson(
    Map<String, dynamic> json,
  ) {
    return WebhookIssueCommentCreatedCommentUser(
      ...
      subscriptionsUrl: json['subscriptions_url'] != null
          ...
          : null,
      type: json['type'] != null
          ? WebhookIssueCommentCreatedCommentUserType.fromJson(
              json['type'] as String,
            )
          : null,
  ...
  WebhookIssueCommentCreatedCommentUser copyWith({
    ...
    WebhookIssueCommentCreatedCommentUserType Function()? type,
    Uri Function()? url,
