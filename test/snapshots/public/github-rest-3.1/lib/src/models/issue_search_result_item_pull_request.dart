...
final class IssueSearchResultItemPullRequest {
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('diff_url') &&
  ...
  IssueSearchResultItemPullRequest copyWith({
  ...
  @override
  int get hashCode {
    return Object.hash(mergedAt, diffUrl, htmlUrl, patchUrl, url);
  }

  @override
  String toString() {
    return 'IssueSearchResultItemPullRequest(mergedAt: $mergedAt, diffUrl: $diffUrl, htmlUrl: $htmlUrl, patchUrl: $patchUrl, url: $url)';
  }
}
