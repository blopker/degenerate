...
import '../models/send_notification_response.dart';
import '../models/shape.dart';
import '../models/string_or_int.dart';
...
final class DefaultApi {
  ...
  ///
  /// `GET /shapes`
  Future<ApiResult<List<Shape>>> listShapes() async {
  ...
  ///
  /// `POST /shapes`
  Future<ApiResult<Shape>> createShape({required Shape body}) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/shapes',
  ...
  ///
  /// `POST /orders`
  Future<ApiResult<Order>> createOrder({required Order body}) async {
    final request = ApiRequest(
      method: 'POST',
      path: '/orders',
      headers: {..._config.defaultHeaders, 'Content-Type': 'application/json'},
  ...
  ///
  /// `POST /notifications`
  Future<ApiResult<SendNotificationResponse>> sendNotification({
  ...
  Future<ApiResult<Map<String, String>>> getPetMetadata({
