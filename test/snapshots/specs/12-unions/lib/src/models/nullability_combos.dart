...
final class NullabilityCombos {
  const NullabilityCombos({
    required this.requiredNonNullable,
    required this.requiredNullable,
    this.optionalNonNullable,
    this.optionalNullable,
  });

  factory NullabilityCombos.fromJson(Map<String, dynamic> json) {
    return NullabilityCombos(
  ...
  static bool canParse(Map<String, dynamic> json) {
    return json.containsKey('requiredNonNullable') &&
        json['requiredNonNullable'] is String &&
        json.containsKey('requiredNullable') &&
        json['requiredNullable'] is String;
  }

  NullabilityCombos copyWith({
    String? requiredNonNullable,
    String? Function()? requiredNullable,
    String Function()? optionalNonNullable,
    String? Function()? optionalNullable,
  }) {
    return NullabilityCombos(
      requiredNonNullable: requiredNonNullable ?? this.requiredNonNullable,
      requiredNullable: requiredNullable != null
          ? requiredNullable()
          : this.requiredNullable,
      optionalNonNullable: optionalNonNullable != null
          ? optionalNonNullable()
          : this.optionalNonNullable,
  ...
  @override
  String toString() {
    return 'NullabilityCombos(requiredNonNullable: $requiredNonNullable, requiredNullable: $requiredNullable, optionalNonNullable: $optionalNonNullable, optionalNullable: $optionalNullable)';
  }
}
