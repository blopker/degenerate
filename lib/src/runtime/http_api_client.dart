/// Source code for the `package:http` adapter.
///
/// This is stored as a string constant because the generator itself does not
/// depend on `package:http`. The string is written verbatim into the generated
/// client output directory.
const httpApiClientSource = r'''
