...
import 'package:collection/collection.dart';import 'address.dart';import 'nullability_combos.dart';import 'order_item.dart';import 'order_status.dart';final class Order {const Order({required this.id, this.status, required this.items, this.shippingAddress, this.metadata, this.nullabilitySample, });
