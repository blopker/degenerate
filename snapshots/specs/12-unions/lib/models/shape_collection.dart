...
import 'package:collection/collection.dart';import 'shape.dart';final class ShapeCollection {const ShapeCollection({required this.name, required this.shapes, this.tags, });
