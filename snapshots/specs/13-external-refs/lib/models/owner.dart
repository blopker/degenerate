...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pet.dart';@immutable final class Owner {const Owner({required this.name, this.email, this.pets, });
