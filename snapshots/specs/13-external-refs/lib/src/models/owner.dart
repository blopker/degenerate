...
import 'package:collection/collection.dart';import 'pet.dart';final class Owner {const Owner({required this.name, this.email, this.pets, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Owner &&
          name == other.name &&
          email == other.email &&
          const ListEquality<dynamic>().equals(pets, other.pets); } 
