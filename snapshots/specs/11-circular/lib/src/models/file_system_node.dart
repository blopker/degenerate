...
import 'package:collection/collection.dart';import 'file_system_node_kind.dart';final class FileSystemNode {const FileSystemNode({required this.name, required this.kind, this.sizeBytes, this.children, this.symlinkTarget, this.metadata, });
