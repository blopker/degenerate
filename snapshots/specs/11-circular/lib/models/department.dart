...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'employee.dart';final class Department {const Department({required this.id, required this.name, this.head, this.members, });
