...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/event_request.dart';import '../models/join_response.dart';import '../models/remove_participant_payload.dart';import '../models/remove_reason.dart';import '../models/room_state.dart';/// RoomsApi operations.
///
...
Future<ApiResult<RoomState>> totemRoomsApiPostEvent({required String sessionSlug, required EventRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<RoomState>> totemRoomsApiGetState({required String sessionSlug}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<JoinResponse>> totemRoomsApiJoinRoom({required String sessionSlug}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> totemRoomsApiMute({required String sessionSlug, required String participantIdentity, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> totemRoomsApiMuteAll({required String sessionSlug}) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<RemoveParticipantPayload>> totemRoomsApiRemove({required String sessionSlug, required String participantIdentity, RemoveReason? reason, }) async  { final request = ApiRequest(
  method: 'POST',
