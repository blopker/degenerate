...
import 'package:collection/collection.dart';import 'mobile_space_detail_schema.dart';final class PagedMobileSpaceDetailSchema {const PagedMobileSpaceDetailSchema({required this.items, required this.count, });
