...
import 'package:collection/collection.dart';import 'blog_post_list_schema.dart';final class PagedBlogPostListSchema {const PagedBlogPostListSchema({required this.items, required this.count, });
