...
import 'public_user_schema.dart';final class BlogPostListSchema {const BlogPostListSchema({this.author, this.headerImageUrl, required this.title, this.subtitle, this.datePublished, this.slug, this.publish = false, this.readTime = 1, this.summary, });

factory BlogPostListSchema.fromJson(Map<String, dynamic> json) { return BlogPostListSchema(
...
BlogPostListSchema copyWith({PublicUserSchema? Function()? author, String? Function()? headerImageUrl, String? title, String? Function()? subtitle, DateTime Function()? datePublished, String? Function()? slug, bool Function()? publish, int Function()? readTime, String? Function()? summary, }) { return BlogPostListSchema(
...
@override int get hashCode { return Object.hash(author, headerImageUrl, title, subtitle, datePublished, slug, publish, readTime, summary); } 
@override String toString() { return 'BlogPostListSchema(author: $author, headerImageUrl: $headerImageUrl, title: $title, subtitle: $subtitle, datePublished: $datePublished, slug: $slug, publish: $publish, readTime: $readTime, summary: $summary)'; } 
 }
