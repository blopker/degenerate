...
return execute(
  ...
  onError: (response) {
    return DependabotListAlertsForEnterpriseError.parse(response);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return DependabotListAlertsForOrgError.parse(response);
  },
);
 } 
...
return execute(
  request,
  onSuccess: (response) {
    return DependabotCreateOrUpdateOrgSecretSuccess.parse(response);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return DependabotListAlertsForRepoError.parse(response);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return DependabotGetAlertError.parse(response);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return DependabotUpdateAlertError.parse(response);
  },
);
 } 
...
return execute(
  request,
  onSuccess: (response) {
    return DependabotCreateOrUpdateRepoSecretSuccess.parse(response);
  },
);
 } 
