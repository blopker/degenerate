...
return execute(
  ...
  onError: (response) {
    return SearchCodeError.parse(response);
  },
);
 } 
/// Search commits
...
return execute(
  ...
  onError: (response) {
    return SearchIssuesAndPullRequestsError.parse(response);
  },
);
 } 
/// Search labels
...
return execute(
  ...
  onError: (response) {
    return SearchLabelsError.parse(response);
  },
);
 } 
/// Search repositories
...
return execute(
  ...
  onError: (response) {
    return SearchReposError.parse(response);
  },
);
 } 
/// Search topics
...
return execute(
  ...
  onError: (response) {
    return SearchUsersError.parse(response);
  },
);
 } 
 }
