...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType {const WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType._(this.value);

factory WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType bot = WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType._('Bot');

static const WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType user = WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType._('User');

static const WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType organization = WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookWorkflowRunRequestedWorkflowRunTriggeringActor {const WebhookWorkflowRunRequestedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunRequestedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunRequestedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType? type;
...
WebhookWorkflowRunRequestedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunRequestedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunRequestedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunRequestedWorkflowRunTriggeringActor &&
...
@override String toString() { return 'WebhookWorkflowRunRequestedWorkflowRunTriggeringActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
