...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';final class WebhookRepositoryPrivatizedAction {const WebhookRepositoryPrivatizedAction._(this.value);
...
@override String toString() { return 'WebhookRepositoryPrivatizedAction($value)'; } 
 }
final class WebhookRepositoryPrivatized {const WebhookRepositoryPrivatized({required this.action, this.enterprise, this.installation, this.organization, required this.repository, required this.sender, });
...
@override String toString() { return 'WebhookRepositoryPrivatized(action: $action, enterprise: $enterprise, installation: $installation, organization: $organization, repository: $repository, sender: $sender)'; } 
 }
