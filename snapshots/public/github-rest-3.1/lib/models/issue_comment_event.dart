...
import 'issue.dart';import 'issue_comment.dart';final class IssueCommentEvent {const IssueCommentEvent({required this.action, required this.issue, required this.comment, });
