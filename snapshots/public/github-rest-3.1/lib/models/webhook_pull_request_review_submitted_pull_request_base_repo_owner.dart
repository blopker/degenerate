...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType {const WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType bot = WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType user = WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType organization = WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner {const WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewSubmittedPullRequestBaseRepoOwner &&
