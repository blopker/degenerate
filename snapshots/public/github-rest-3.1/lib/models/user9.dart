...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User9Type {const User9Type._(this.value);

factory User9Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User9Type bot = User9Type._('Bot');

static const User9Type user = User9Type._('User');

static const User9Type organization = User9Type._('Organization');

static const User9Type mannequin = User9Type._('Mannequin');

static const List<User9Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User9Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User9Type($value)'; } 
 }
@immutable final class User9 {const User9({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User9.fromJson(Map<String, dynamic> json) { return User9(
  ...
  type: json['type'] != null ? User9Type.fromJson(json['type'] as String) : null,
...
User9 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User9Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User9(
