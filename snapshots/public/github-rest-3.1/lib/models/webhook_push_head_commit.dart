...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_push_head_commit_author.dart';import 'webhook_push_head_commit_committer.dart';final class WebhookPushHeadCommit {const WebhookPushHeadCommit({this.added, required this.author, required this.committer, required this.distinct, required this.id, required this.message, this.modified, this.removed, required this.timestamp, required this.treeId, required this.url, });
