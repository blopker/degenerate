...
final class WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType {const WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType bot = WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType user = WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType organization = WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType._('Organization');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType($value)'; } 
 }
final class WebhookPullRequestReviewCommentDeletedPullRequestAssignee {const WebhookPullRequestReviewCommentDeletedPullRequestAssignee({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentDeletedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestAssignee copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestAssigneeType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewCommentDeletedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestAssignee &&
