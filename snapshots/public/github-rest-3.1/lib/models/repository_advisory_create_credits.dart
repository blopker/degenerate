...
import 'security_advisory_credit_types.dart';final class RepositoryAdvisoryCreateCredits {const RepositoryAdvisoryCreateCredits({required this.login, required this.type, });
