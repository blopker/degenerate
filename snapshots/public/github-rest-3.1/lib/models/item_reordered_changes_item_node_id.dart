...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ItemReorderedChangesItemNodeId {const ItemReorderedChangesItemNodeId({this.from, this.to, });
