...
static const WebhookPullRequestUnassignedPullRequestMergedByType bot = WebhookPullRequestUnassignedPullRequestMergedByType._('Bot');

static const WebhookPullRequestUnassignedPullRequestMergedByType user = WebhookPullRequestUnassignedPullRequestMergedByType._('User');

static const WebhookPullRequestUnassignedPullRequestMergedByType organization = WebhookPullRequestUnassignedPullRequestMergedByType._('Organization');

static const WebhookPullRequestUnassignedPullRequestMergedByType mannequin = WebhookPullRequestUnassignedPullRequestMergedByType._('Mannequin');

static const List<WebhookPullRequestUnassignedPullRequestMergedByType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestMergedByType($value)'; } 
 }
@immutable final class WebhookPullRequestUnassignedPullRequestMergedBy {const WebhookPullRequestUnassignedPullRequestMergedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory WebhookPullRequestUnassignedPullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestMergedByType? type;
...
WebhookPullRequestUnassignedPullRequestMergedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestMergedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestMergedBy &&
...
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
