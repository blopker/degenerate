...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType {const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType bot = WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType user = WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._('User');

static const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType organization = WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._('Organization');

static const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType mannequin = WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer {const WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType? type;
...
WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequestedRequestedReviewer &&
