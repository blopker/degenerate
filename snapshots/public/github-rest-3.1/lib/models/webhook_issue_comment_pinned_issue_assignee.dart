...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentPinnedIssueAssigneeType {const WebhookIssueCommentPinnedIssueAssigneeType._(this.value);

factory WebhookIssueCommentPinnedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssueCommentPinnedIssueAssigneeType bot = WebhookIssueCommentPinnedIssueAssigneeType._('Bot');

static const WebhookIssueCommentPinnedIssueAssigneeType user = WebhookIssueCommentPinnedIssueAssigneeType._('User');

static const WebhookIssueCommentPinnedIssueAssigneeType organization = WebhookIssueCommentPinnedIssueAssigneeType._('Organization');

static const WebhookIssueCommentPinnedIssueAssigneeType mannequin = WebhookIssueCommentPinnedIssueAssigneeType._('Mannequin');

static const List<WebhookIssueCommentPinnedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentPinnedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentPinnedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssueCommentPinnedIssueAssignee {const WebhookIssueCommentPinnedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentPinnedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentPinnedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssueCommentPinnedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentPinnedIssueAssigneeType? type;
...
WebhookIssueCommentPinnedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentPinnedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentPinnedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentPinnedIssueAssignee &&
