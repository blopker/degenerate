...
factory WebhookSecurityAdvisoryWithdrawnSecurityAdvisory.fromJson(Map<String, dynamic> json) { return WebhookSecurityAdvisoryWithdrawnSecurityAdvisory(
  ...
  identifiers: (json['identifiers'] as List<dynamic>).map((e) => WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryIdentifiers.fromJson(e as Map<String, dynamic>)).toList(),
  publishedAt: json['published_at'] as String,
  references: (json['references'] as List<dynamic>).map((e) => WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryReferences.fromJson(e as Map<String, dynamic>)).toList(),
  severity: json['severity'] as String,
  summary: json['summary'] as String,
  updatedAt: json['updated_at'] as String,
  vulnerabilities: (json['vulnerabilities'] as List<dynamic>).map((e) => WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryVulnerabilities.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryIdentifiers> identifiers;

final String publishedAt;

final List<WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryReferences> references;
...
final List<WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryVulnerabilities> vulnerabilities;
