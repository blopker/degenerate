...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User7Type {const User7Type._(this.value);

factory User7Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User7Type bot = User7Type._('Bot');

static const User7Type user = User7Type._('User');

static const User7Type organization = User7Type._('Organization');

static const User7Type mannequin = User7Type._('Mannequin');

static const List<User7Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User7Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User7Type($value)'; } 
 }
@immutable final class User7 {const User7({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User7.fromJson(Map<String, dynamic> json) { return User7(
  ...
  type: json['type'] != null ? User7Type.fromJson(json['type'] as String) : null,
...
User7 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User7Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User7(
