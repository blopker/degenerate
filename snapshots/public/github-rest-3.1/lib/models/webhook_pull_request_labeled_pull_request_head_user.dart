...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestHeadUserType {const WebhookPullRequestLabeledPullRequestHeadUserType._(this.value);

factory WebhookPullRequestLabeledPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestLabeledPullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestLabeledPullRequestHeadUserType bot = WebhookPullRequestLabeledPullRequestHeadUserType._('Bot');

static const WebhookPullRequestLabeledPullRequestHeadUserType user = WebhookPullRequestLabeledPullRequestHeadUserType._('User');

static const WebhookPullRequestLabeledPullRequestHeadUserType organization = WebhookPullRequestLabeledPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestLabeledPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestHeadUser {const WebhookPullRequestLabeledPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestHeadUserType? type;
...
WebhookPullRequestLabeledPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestHeadUser &&
...
@override String toString() { return 'WebhookPullRequestLabeledPullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
