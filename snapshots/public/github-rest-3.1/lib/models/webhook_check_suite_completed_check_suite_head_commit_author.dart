...
final class WebhookCheckSuiteCompletedCheckSuiteHeadCommitAuthor {const WebhookCheckSuiteCompletedCheckSuiteHeadCommitAuthor({this.date, required this.email, required this.name, this.username, });
