...
LicenseContentLinks copyWith({Uri? Function()? git, Uri? Function()? html, Uri? self, }) { return LicenseContentLinks(
  git: git != null ? git() : this.git,
  html: html != null ? html() : this.html,
  self: self ?? this.self,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is LicenseContentLinks &&
          git == other.git &&
          html == other.html &&
          self == other.self; } 
@override int get hashCode { return Object.hash(git, html, self); } 
@override String toString() { return 'LicenseContentLinks(git: $git, html: $html, self: $self)'; } 
 }
