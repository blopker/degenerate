...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLabeledIssueAssigneesType {const WebhookIssuesLabeledIssueAssigneesType._(this.value);

factory WebhookIssuesLabeledIssueAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesLabeledIssueAssigneesType._(json),
}; }

static const WebhookIssuesLabeledIssueAssigneesType bot = WebhookIssuesLabeledIssueAssigneesType._('Bot');

static const WebhookIssuesLabeledIssueAssigneesType user = WebhookIssuesLabeledIssueAssigneesType._('User');

static const WebhookIssuesLabeledIssueAssigneesType organization = WebhookIssuesLabeledIssueAssigneesType._('Organization');

static const WebhookIssuesLabeledIssueAssigneesType mannequin = WebhookIssuesLabeledIssueAssigneesType._('Mannequin');

static const List<WebhookIssuesLabeledIssueAssigneesType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesLabeledIssueAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesLabeledIssueAssigneesType($value)'; } 
 }
@immutable final class WebhookIssuesLabeledIssueAssignees {const WebhookIssuesLabeledIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssuesLabeledIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesLabeledIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesLabeledIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLabeledIssueAssigneesType? type;
...
WebhookIssuesLabeledIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLabeledIssueAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookIssuesLabeledIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLabeledIssueAssignees &&
