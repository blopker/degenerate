...
@immutable final class Team18 {const Team18({required this.id, required this.name, this.deleted, this.description = const Omittable.absent(), this.htmlUrl, this.membersUrl, this.nodeId, this.parent = const Omittable.absent(), this.permission, this.privacy, this.repositoriesUrl, this.slug, this.url, });
...
factory Team18.fromJson(Map<String, dynamic> json) { return Team18(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? Team18Parent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<Team18Parent?> parent;
...
Team18 copyWith({bool? Function()? deleted, Omittable<String?>? description, Uri? Function()? htmlUrl, int? id, String? Function()? membersUrl, String? name, String? Function()? nodeId, Omittable<Team18Parent?>? parent, String? Function()? permission, Team18Privacy? Function()? privacy, Uri? Function()? repositoriesUrl, String? Function()? slug, Uri? Function()? url, }) { return Team18(
