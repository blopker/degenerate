...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'runner_label.dart';@immutable final class ActionsListLabelsForSelfHostedRunnerForRepoResponse {const ActionsListLabelsForSelfHostedRunnerForRepoResponse({required this.totalCount, required this.labels, });
...
@override String toString() { return 'ActionsListLabelsForSelfHostedRunnerForRepoResponse(totalCount: $totalCount, labels: $labels)'; } 
 }
