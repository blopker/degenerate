...
final WebhookPackageUpdatedPackageOwner? owner;

final String packageType;

final WebhookPackageUpdatedPackagePackageVersion packageVersion;

final WebhookPackageUpdatedPackageRegistry? registry;
...
WebhookPackageUpdatedPackage copyWith({String? createdAt, String? Function()? description, String? ecosystem, Uri? htmlUrl, int? id, String? name, String? namespace, WebhookPackageUpdatedPackageOwner? Function()? owner, String? packageType, WebhookPackageUpdatedPackagePackageVersion? packageVersion, WebhookPackageUpdatedPackageRegistry? Function()? registry, String? updatedAt, }) { return WebhookPackageUpdatedPackage(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPackageUpdatedPackage &&
...
@override String toString() { return 'WebhookPackageUpdatedPackage(createdAt: $createdAt, description: $description, ecosystem: $ecosystem, htmlUrl: $htmlUrl, id: $id, name: $name, namespace: $namespace, owner: $owner, packageType: $packageType, packageVersion: $packageVersion, registry: $registry, updatedAt: $updatedAt)'; } 
 }
