...
import 'package:collection/collection.dart';import 'issue.dart';import 'label.dart';import 'simple_user.dart';final class IssuesEvent {const IssuesEvent({required this.action, required this.issue, this.assignee, this.assignees, this.label, this.labels, });
