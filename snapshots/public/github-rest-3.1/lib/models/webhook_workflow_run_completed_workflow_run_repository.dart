...
factory WebhookWorkflowRunCompletedWorkflowRunRepository.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunRepository(
  ...
  owner: json['owner'] != null ? WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
...
final WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner? owner;
