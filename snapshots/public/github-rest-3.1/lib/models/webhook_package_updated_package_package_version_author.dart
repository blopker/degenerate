...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPackageUpdatedPackagePackageVersionAuthorType {const WebhookPackageUpdatedPackagePackageVersionAuthorType._(this.value);

factory WebhookPackageUpdatedPackagePackageVersionAuthorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPackageUpdatedPackagePackageVersionAuthorType._(json),
}; }

static const WebhookPackageUpdatedPackagePackageVersionAuthorType bot = WebhookPackageUpdatedPackagePackageVersionAuthorType._('Bot');

static const WebhookPackageUpdatedPackagePackageVersionAuthorType user = WebhookPackageUpdatedPackagePackageVersionAuthorType._('User');

static const WebhookPackageUpdatedPackagePackageVersionAuthorType organization = WebhookPackageUpdatedPackagePackageVersionAuthorType._('Organization');

static const List<WebhookPackageUpdatedPackagePackageVersionAuthorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPackageUpdatedPackagePackageVersionAuthorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPackageUpdatedPackagePackageVersionAuthorType($value)'; } 
 }
@immutable final class WebhookPackageUpdatedPackagePackageVersionAuthor {const WebhookPackageUpdatedPackagePackageVersionAuthor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPackageUpdatedPackagePackageVersionAuthor.fromJson(Map<String, dynamic> json) { return WebhookPackageUpdatedPackagePackageVersionAuthor(
  ...
  type: json['type'] != null ? WebhookPackageUpdatedPackagePackageVersionAuthorType.fromJson(json['type'] as String) : null,
...
final WebhookPackageUpdatedPackagePackageVersionAuthorType? type;
...
WebhookPackageUpdatedPackagePackageVersionAuthor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPackageUpdatedPackagePackageVersionAuthorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPackageUpdatedPackagePackageVersionAuthor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPackageUpdatedPackagePackageVersionAuthor &&
...
@override String toString() { return 'WebhookPackageUpdatedPackagePackageVersionAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
