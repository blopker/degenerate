...
return  ActionsSetCustomOidcSubClaimForRepoError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); } else if (responseMediaTypeMatches(contentType, 'application/scim+json', )) {
final json = jsonDecode(response.body);
return  ActionsSetCustomOidcSubClaimForRepoError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>)); } else {
final json = jsonDecode(response.body);
return  ActionsSetCustomOidcSubClaimForRepoError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); }case 404:
final json = jsonDecode(response.body);
return  ActionsSetCustomOidcSubClaimForRepoError404(BasicError.fromJson(json as Map<String, dynamic>));case 422:
final json = jsonDecode(response.body);
return  ActionsSetCustomOidcSubClaimForRepoError422(ValidationErrorSimple.fromJson(json as Map<String, dynamic>));default:
