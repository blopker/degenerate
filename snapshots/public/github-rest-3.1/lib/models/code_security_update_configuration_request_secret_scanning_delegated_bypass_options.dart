...
@immutable final class CodeSecurityUpdateConfigurationRequestSecretScanningDelegatedBypassOptions {const CodeSecurityUpdateConfigurationRequestSecretScanningDelegatedBypassOptions({this.reviewers});
