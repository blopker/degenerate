...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType {const WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType._(this.value);

factory WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType._(json),
}; }

static const WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType bot = WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType._('Bot');

static const WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType user = WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType._('User');

static const WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType organization = WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType($value)'; } 
 }
@immutable final class WebhookIssuesOpenedIssuePerformedViaGithubAppOwner {const WebhookIssuesOpenedIssuePerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesOpenedIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesOpenedIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedIssuePerformedViaGithubAppOwner &&
...
@override String toString() { return 'WebhookIssuesOpenedIssuePerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
