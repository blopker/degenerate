...
import 'webhook_pull_request_unlocked_pull_request_auto_merge_enabled_by.dart';/// The merge method to use.
final class WebhookPullRequestUnlockedPullRequestAutoMergeMergeMethod {const WebhookPullRequestUnlockedPullRequestAutoMergeMergeMethod._(this.value);
...
final class WebhookPullRequestUnlockedPullRequestAutoMerge {const WebhookPullRequestUnlockedPullRequestAutoMerge({required this.commitMessage, required this.commitTitle, required this.enabledBy, required this.mergeMethod, });
