...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType {const WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType._(this.value);

factory WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType bot = WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType._('Bot');

static const WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType user = WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType._('User');

static const WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType organization = WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestAutoMergeDisabledPullRequestHeadUser {const WebhookPullRequestAutoMergeDisabledPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAutoMergeDisabledPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType? type;
...
WebhookPullRequestAutoMergeDisabledPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAutoMergeDisabledPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAutoMergeDisabledPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequestHeadUser &&
