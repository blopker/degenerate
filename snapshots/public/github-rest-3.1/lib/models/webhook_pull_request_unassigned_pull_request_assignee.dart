...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnassignedPullRequestAssigneeType {const WebhookPullRequestUnassignedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestUnassignedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestUnassignedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestAssigneeType bot = WebhookPullRequestUnassignedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestUnassignedPullRequestAssigneeType user = WebhookPullRequestUnassignedPullRequestAssigneeType._('User');

static const WebhookPullRequestUnassignedPullRequestAssigneeType organization = WebhookPullRequestUnassignedPullRequestAssigneeType._('Organization');

static const WebhookPullRequestUnassignedPullRequestAssigneeType mannequin = WebhookPullRequestUnassignedPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestUnassignedPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestUnassignedPullRequestAssignee {const WebhookPullRequestUnassignedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnassignedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestAssigneeType? type;
...
WebhookPullRequestUnassignedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestAssignee &&
