...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_dismissed_pull_request_head_repo_license.dart';import 'webhook_pull_request_review_dismissed_pull_request_head_repo_owner.dart';import 'webhook_pull_request_review_dismissed_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
final class WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility {const WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility public = WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility private = WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility internal = WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewDismissedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewDismissedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewDismissedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewDismissedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewDismissedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestReviewDismissedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewDismissedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewDismissedPullRequestHeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewDismissedPullRequestHeadRepo &&
