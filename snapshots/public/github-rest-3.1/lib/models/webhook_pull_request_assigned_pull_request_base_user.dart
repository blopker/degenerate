...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAssignedPullRequestBaseUserType {const WebhookPullRequestAssignedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestAssignedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestAssignedPullRequestBaseUserType bot = WebhookPullRequestAssignedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestAssignedPullRequestBaseUserType user = WebhookPullRequestAssignedPullRequestBaseUserType._('User');

static const WebhookPullRequestAssignedPullRequestBaseUserType organization = WebhookPullRequestAssignedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestAssignedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestAssignedPullRequestBaseUser {const WebhookPullRequestAssignedPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAssignedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAssignedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestAssignedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAssignedPullRequestBaseUserType? type;
...
WebhookPullRequestAssignedPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAssignedPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAssignedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAssignedPullRequestBaseUser &&
...
@override String toString() { return 'WebhookPullRequestAssignedPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
