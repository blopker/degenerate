...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestBaseUserType {const WebhookPullRequestLabeledPullRequestBaseUserType._(this.value);

factory WebhookPullRequestLabeledPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestLabeledPullRequestBaseUserType bot = WebhookPullRequestLabeledPullRequestBaseUserType._('Bot');

static const WebhookPullRequestLabeledPullRequestBaseUserType user = WebhookPullRequestLabeledPullRequestBaseUserType._('User');

static const WebhookPullRequestLabeledPullRequestBaseUserType organization = WebhookPullRequestLabeledPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestLabeledPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestBaseUser {const WebhookPullRequestLabeledPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestBaseUserType? type;
...
WebhookPullRequestLabeledPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestBaseUser &&
