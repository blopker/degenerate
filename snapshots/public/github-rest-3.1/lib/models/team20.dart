...
factory Team20.fromJson(Map<String, dynamic> json) { return Team20(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? Team20Parent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<Team20Parent?> parent;
...
Team20 copyWith({bool? Function()? deleted, String? Function()? description, Uri? htmlUrl, int? id, String? membersUrl, String? name, String? nodeId, Omittable<Team20Parent?>? parent, String? permission, Team20Privacy? privacy, Uri? repositoriesUrl, String? slug, Uri? url, }) { return Team20(
