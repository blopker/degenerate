...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookReleaseEditedChangesBody {const WebhookReleaseEditedChangesBody({required this.from});
