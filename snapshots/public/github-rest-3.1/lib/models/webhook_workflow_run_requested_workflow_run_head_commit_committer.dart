...
WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter copyWith({DateTime Function()? date, String? Function()? email, String? name, String Function()? username, }) { return WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter &&
          date == other.date &&
          email == other.email &&
          name == other.name &&
          username == other.username; } 
@override int get hashCode { return Object.hash(date, email, name, username); } 
@override String toString() { return 'WebhookWorkflowRunRequestedWorkflowRunHeadCommitCommitter(date: $date, email: $email, name: $name, username: $username)'; } 
 }
