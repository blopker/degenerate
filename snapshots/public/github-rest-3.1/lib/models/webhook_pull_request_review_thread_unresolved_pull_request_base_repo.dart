...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_thread_unresolved_pull_request_base_repo_license.dart';import 'webhook_pull_request_review_thread_unresolved_pull_request_base_repo_owner.dart';import 'webhook_pull_request_review_thread_unresolved_pull_request_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy {const WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy all = WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
/// A git repository
final class WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo {const WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo({this.allowAutoMerge = false, this.allowForking, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowSquashMerge = true, this.allowUpdateBranch, required this.archiveUrl, this.archived = false, required this.assigneesUrl, required this.blobsUrl, required this.branchesUrl, required this.cloneUrl, required this.collaboratorsUrl, required this.commentsUrl, required this.commitsUrl, required this.compareUrl, required this.contentsUrl, required this.contributorsUrl, required this.createdAt, required this.defaultBranch, this.deleteBranchOnMerge = false, required this.deploymentsUrl, required this.description, this.disabled, required this.downloadsUrl, required this.eventsUrl, required this.fork, required this.forks, required this.forksCount, required this.forksUrl, required this.fullName, required this.gitCommitsUrl, required this.gitRefsUrl, required this.gitTagsUrl, required this.gitUrl, this.hasDownloads = true, this.hasIssues = true, required this.hasPages, this.hasProjects = true, this.hasWiki = true, this.hasDiscussions = false, this.hasPullRequests = true, this.pullRequestCreationPolicy, required this.homepage, required this.hooksUrl, required this.htmlUrl, required this.id, this.isTemplate, required this.issueCommentUrl, required this.issueEventsUrl, required this.issuesUrl, required this.keysUrl, required this.labelsUrl, required this.language, required this.languagesUrl, required this.license, this.masterBranch, required this.mergesUrl, required this.milestonesUrl, required this.mirrorUrl, required this.name, required this.nodeId, required this.notificationsUrl, required this.openIssues, required this.openIssuesCount, this.organization, required this.owner, this.permissions, required this.private, this.public, required this.pullsUrl, required this.pushedAt, required this.releasesUrl, this.roleName, required this.size, required this.sshUrl, this.stargazers, required this.stargazersCount, required this.stargazersUrl, required this.statusesUrl, required this.subscribersUrl, required this.subscriptionUrl, required this.svnUrl, required this.tagsUrl, required this.teamsUrl, required this.topics, required this.treesUrl, required this.updatedAt, required this.url, required this.visibility, required this.watchers, required this.watchersCount, this.webCommitSignoffRequired, });

factory WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  ...
  visibility: WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense? license;
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner? owner;

final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions? permissions;
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadUnresolvedPullRequestBaseRepo &&
