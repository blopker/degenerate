...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType {const WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType._(this.value);
...
@immutable final class WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner {const WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType? type;
...
WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunRequestedWorkflowRunHeadRepositoryOwner &&
