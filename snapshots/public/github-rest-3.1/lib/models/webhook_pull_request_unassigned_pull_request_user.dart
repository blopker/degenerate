...
final class WebhookPullRequestUnassignedPullRequestUserType {const WebhookPullRequestUnassignedPullRequestUserType._(this.value);
...
final class WebhookPullRequestUnassignedPullRequestUser {const WebhookPullRequestUnassignedPullRequestUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
