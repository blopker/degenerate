...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnassignedPullRequestUserType {const WebhookPullRequestUnassignedPullRequestUserType._(this.value);

factory WebhookPullRequestUnassignedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestUnassignedPullRequestUserType._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestUserType bot = WebhookPullRequestUnassignedPullRequestUserType._('Bot');

static const WebhookPullRequestUnassignedPullRequestUserType user = WebhookPullRequestUnassignedPullRequestUserType._('User');

static const WebhookPullRequestUnassignedPullRequestUserType organization = WebhookPullRequestUnassignedPullRequestUserType._('Organization');

static const WebhookPullRequestUnassignedPullRequestUserType mannequin = WebhookPullRequestUnassignedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestUnassignedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestUnassignedPullRequestUser {const WebhookPullRequestUnassignedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnassignedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestUserType? type;
...
WebhookPullRequestUnassignedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestUser &&
