...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentUnpinnedIssuePullRequest {const WebhookIssueCommentUnpinnedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });
...
WebhookIssueCommentUnpinnedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssueCommentUnpinnedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentUnpinnedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssueCommentUnpinnedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
