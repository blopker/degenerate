...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User8Type {const User8Type._(this.value);

factory User8Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User8Type bot = User8Type._('Bot');

static const User8Type user = User8Type._('User');

static const User8Type organization = User8Type._('Organization');

static const User8Type mannequin = User8Type._('Mannequin');

static const List<User8Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User8Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User8Type($value)'; } 
 }
@immutable final class User8 {const User8({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User8.fromJson(Map<String, dynamic> json) { return User8(
  ...
  type: json['type'] != null ? User8Type.fromJson(json['type'] as String) : null,
...
User8 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User8Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User8(
