...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType bot = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType user = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType organization = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMergeEnabledBy &&
