...
PullRequestSimpleLinks copyWith({Link? comments, Link? commits, Link? statuses, Link? html, Link? issue, Link? reviewComments, Link? reviewComment, Link? self, }) { return PullRequestSimpleLinks(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PullRequestSimpleLinks &&
...
@override String toString() { return 'PullRequestSimpleLinks(comments: $comments, commits: $commits, statuses: $statuses, html: $html, issue: $issue, reviewComments: $reviewComments, reviewComment: $reviewComment, self: $self)'; } 
 }
