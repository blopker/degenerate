...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestMergedByType {const WebhookPullRequestLabeledPullRequestMergedByType._(this.value);

factory WebhookPullRequestLabeledPullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestLabeledPullRequestMergedByType bot = WebhookPullRequestLabeledPullRequestMergedByType._('Bot');

static const WebhookPullRequestLabeledPullRequestMergedByType user = WebhookPullRequestLabeledPullRequestMergedByType._('User');

static const WebhookPullRequestLabeledPullRequestMergedByType organization = WebhookPullRequestLabeledPullRequestMergedByType._('Organization');

static const WebhookPullRequestLabeledPullRequestMergedByType mannequin = WebhookPullRequestLabeledPullRequestMergedByType._('Mannequin');

static const List<WebhookPullRequestLabeledPullRequestMergedByType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestMergedByType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestMergedBy {const WebhookPullRequestLabeledPullRequestMergedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestMergedByType? type;
...
WebhookPullRequestLabeledPullRequestMergedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestMergedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestMergedBy &&
...
@override String toString() { return 'WebhookPullRequestLabeledPullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
