...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedIssueMilestoneCreatorType {const WebhookIssuesOpenedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesOpenedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesOpenedIssueMilestoneCreatorType bot = WebhookIssuesOpenedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesOpenedIssueMilestoneCreatorType user = WebhookIssuesOpenedIssueMilestoneCreatorType._('User');

static const WebhookIssuesOpenedIssueMilestoneCreatorType organization = WebhookIssuesOpenedIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesOpenedIssueMilestoneCreatorType mannequin = WebhookIssuesOpenedIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesOpenedIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesOpenedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesOpenedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesOpenedIssueMilestoneCreator {const WebhookIssuesOpenedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesOpenedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedIssueMilestoneCreatorType? type;
...
WebhookIssuesOpenedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedIssueMilestoneCreator &&
