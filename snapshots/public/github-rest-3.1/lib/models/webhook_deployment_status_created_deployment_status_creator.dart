...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentStatusCreatedDeploymentStatusCreatorType {const WebhookDeploymentStatusCreatedDeploymentStatusCreatorType._(this.value);

factory WebhookDeploymentStatusCreatedDeploymentStatusCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookDeploymentStatusCreatedDeploymentStatusCreatorType bot = WebhookDeploymentStatusCreatedDeploymentStatusCreatorType._('Bot');

static const WebhookDeploymentStatusCreatedDeploymentStatusCreatorType user = WebhookDeploymentStatusCreatedDeploymentStatusCreatorType._('User');

static const WebhookDeploymentStatusCreatedDeploymentStatusCreatorType organization = WebhookDeploymentStatusCreatedDeploymentStatusCreatorType._('Organization');

static const List<WebhookDeploymentStatusCreatedDeploymentStatusCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedDeploymentStatusCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedDeploymentStatusCreatorType($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedDeploymentStatusCreator {const WebhookDeploymentStatusCreatedDeploymentStatusCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentStatusCreatedDeploymentStatusCreator.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedDeploymentStatusCreator(
  ...
  type: json['type'] != null ? WebhookDeploymentStatusCreatedDeploymentStatusCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentStatusCreatedDeploymentStatusCreatorType? type;
...
WebhookDeploymentStatusCreatedDeploymentStatusCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentStatusCreatedDeploymentStatusCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentStatusCreatedDeploymentStatusCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedDeploymentStatusCreator &&
