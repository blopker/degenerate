...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_issues_transferred_changes_new_repository_license.dart';import 'webhook_issues_transferred_changes_new_repository_owner.dart';import 'webhook_issues_transferred_changes_new_repository_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
@immutable final class WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy {const WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy._(this.value);

factory WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy.fromJson(String json) {return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy._(json),
};}

static const WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy all = WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy._('all');

static const WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy collaboratorsOnly = WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy($value)';}
}
@immutable final class WebhookIssuesTransferredChangesNewRepositoryVisibility {const WebhookIssuesTransferredChangesNewRepositoryVisibility._(this.value);

factory WebhookIssuesTransferredChangesNewRepositoryVisibility.fromJson(String json) {return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookIssuesTransferredChangesNewRepositoryVisibility public = WebhookIssuesTransferredChangesNewRepositoryVisibility._('public');

static const WebhookIssuesTransferredChangesNewRepositoryVisibility private = WebhookIssuesTransferredChangesNewRepositoryVisibility._('private');

static const WebhookIssuesTransferredChangesNewRepositoryVisibility internal = WebhookIssuesTransferredChangesNewRepositoryVisibility._('internal');

static const List<WebhookIssuesTransferredChangesNewRepositoryVisibility> values = [public, private, internal];
...
bool get isUnknown {return !values.contains(this);}
@override bool operator ==(Object other) {return identical(this, other) ||
    other is WebhookIssuesTransferredChangesNewRepositoryVisibility && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'WebhookIssuesTransferredChangesNewRepositoryVisibility($value)';}
}
/// A git repository
@immutable final class WebhookIssuesTransferredChangesNewRepository {const WebhookIssuesTransferredChangesNewRepository({required this.fullName, required this.watchersCount, required this.watchers, required this.visibility, required this.url, required this.updatedAt, required this.archiveUrl, required this.archived, required this.assigneesUrl, required this.blobsUrl, required this.branchesUrl, required this.cloneUrl, required this.collaboratorsUrl, required this.commentsUrl, required this.commitsUrl, required this.compareUrl, required this.contentsUrl, required this.contributorsUrl, required this.createdAt, required this.treesUrl, required this.defaultBranch, required this.topics, required this.deploymentsUrl, required this.description, required this.teamsUrl, required this.downloadsUrl, required this.eventsUrl, required this.fork, required this.forks, required this.forksCount, required this.forksUrl, required this.tagsUrl, required this.gitCommitsUrl, required this.gitRefsUrl, required this.gitTagsUrl, required this.gitUrl, required this.hasDownloads, required this.hasIssues, required this.hasPages, required this.hasProjects, required this.hasWiki, required this.hasDiscussions, required this.svnUrl, required this.subscriptionUrl, required this.homepage, required this.hooksUrl, required this.htmlUrl, required this.id, required this.subscribersUrl, required this.issueCommentUrl, required this.issueEventsUrl, required this.issuesUrl, required this.keysUrl, required this.labelsUrl, required this.language, required this.languagesUrl, required this.license, required this.statusesUrl, required this.mergesUrl, required this.milestonesUrl, required this.mirrorUrl, required this.stargazersUrl, required this.nodeId, required this.notificationsUrl, required this.openIssues, required this.openIssuesCount, required this.stargazersCount, required this.owner, required this.sshUrl, required this.private, required this.size, required this.pullsUrl, required this.pushedAt, required this.name, required this.releasesUrl, this.public, this.permissions, this.stargazers, this.organization, this.webCommitSignoffRequired, this.masterBranch, this.isTemplate, this.pullRequestCreationPolicy, this.hasPullRequests, this.allowAutoMerge, this.disabled, this.deleteBranchOnMerge, this.customProperties, this.allowUpdateBranch, this.allowSquashMerge, this.allowRebaseMerge, this.allowMergeCommit, this.allowForking, this.roleName = const Omittable.absent(), });

factory WebhookIssuesTransferredChangesNewRepository.fromJson(Map<String, dynamic> json) {return WebhookIssuesTransferredChangesNewRepository(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookIssuesTransferredChangesNewRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookIssuesTransferredChangesNewRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  ...
  visibility: WebhookIssuesTransferredChangesNewRepositoryVisibility.fromJson(json['visibility'] as String),
...
final WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookIssuesTransferredChangesNewRepositoryLicense? license;
...
final WebhookIssuesTransferredChangesNewRepositoryOwner? owner;

final WebhookIssuesTransferredChangesNewRepositoryPermissions? permissions;
...
final WebhookIssuesTransferredChangesNewRepositoryVisibility visibility;
...
WebhookIssuesTransferredChangesNewRepository copyWith({bool? Function()? allowAutoMerge, bool? Function()? allowForking, bool? Function()? allowMergeCommit, bool? Function()? allowRebaseMerge, bool? Function()? allowSquashMerge, bool? Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, Map<String, dynamic>? Function()? customProperties, String? defaultBranch, bool? Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool? Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool? Function()? hasPullRequests, WebhookIssuesTransferredChangesNewRepositoryPullRequestCreationPolicy? Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool? Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookIssuesTransferredChangesNewRepositoryLicense? Function()? license, String? Function()? masterBranch, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String? Function()? organization, WebhookIssuesTransferredChangesNewRepositoryOwner? Function()? owner, WebhookIssuesTransferredChangesNewRepositoryPermissions? Function()? permissions, bool? private, bool? Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, Omittable<String?>? roleName, int? size, String? sshUrl, int? Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, WebhookIssuesTransferredChangesNewRepositoryVisibility? visibility, int? watchers, int? watchersCount, bool? Function()? webCommitSignoffRequired, }) {return WebhookIssuesTransferredChangesNewRepository(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is WebhookIssuesTransferredChangesNewRepository &&
