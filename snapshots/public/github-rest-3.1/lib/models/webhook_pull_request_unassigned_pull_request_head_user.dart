...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnassignedPullRequestHeadUserType {const WebhookPullRequestUnassignedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestUnassignedPullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestHeadUserType bot = WebhookPullRequestUnassignedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestUnassignedPullRequestHeadUserType user = WebhookPullRequestUnassignedPullRequestHeadUserType._('User');

static const WebhookPullRequestUnassignedPullRequestHeadUserType organization = WebhookPullRequestUnassignedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestUnassignedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestUnassignedPullRequestHeadUser {const WebhookPullRequestUnassignedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnassignedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestHeadUserType? type;
...
WebhookPullRequestUnassignedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestHeadUser &&
