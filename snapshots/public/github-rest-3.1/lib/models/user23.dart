...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User23Type {const User23Type._(this.value);

factory User23Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User23Type bot = User23Type._('Bot');

static const User23Type user = User23Type._('User');

static const User23Type organization = User23Type._('Organization');

static const User23Type mannequin = User23Type._('Mannequin');

static const List<User23Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User23Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User23Type($value)'; } 
 }
@immutable final class User23 {const User23({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User23.fromJson(Map<String, dynamic> json) { return User23(
  ...
  type: json['type'] != null ? User23Type.fromJson(json['type'] as String) : null,
...
User23 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User23Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User23(
