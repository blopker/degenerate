...
return  CopilotAddCopilotSeatsForTeamsError401(BasicError.fromJson(json as Map<String, dynamic>));case 403:
final json = jsonDecode(response.body);
return  CopilotAddCopilotSeatsForTeamsError403(BasicError.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  CopilotAddCopilotSeatsForTeamsError404(BasicError.fromJson(json as Map<String, dynamic>));case 422:
return  const CopilotAddCopilotSeatsForTeamsError422();case 500:
final json = jsonDecode(response.body);
return  CopilotAddCopilotSeatsForTeamsError500(BasicError.fromJson(json as Map<String, dynamic>));default:
