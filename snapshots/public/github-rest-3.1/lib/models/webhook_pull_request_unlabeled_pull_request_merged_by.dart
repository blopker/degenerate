...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlabeledPullRequestMergedByType {const WebhookPullRequestUnlabeledPullRequestMergedByType._(this.value);

factory WebhookPullRequestUnlabeledPullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestUnlabeledPullRequestMergedByType bot = WebhookPullRequestUnlabeledPullRequestMergedByType._('Bot');

static const WebhookPullRequestUnlabeledPullRequestMergedByType user = WebhookPullRequestUnlabeledPullRequestMergedByType._('User');

static const WebhookPullRequestUnlabeledPullRequestMergedByType organization = WebhookPullRequestUnlabeledPullRequestMergedByType._('Organization');

static const List<WebhookPullRequestUnlabeledPullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestMergedByType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlabeledPullRequestMergedBy {const WebhookPullRequestUnlabeledPullRequestMergedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlabeledPullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlabeledPullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlabeledPullRequestMergedByType? type;
...
WebhookPullRequestUnlabeledPullRequestMergedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlabeledPullRequestMergedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlabeledPullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestMergedBy &&
