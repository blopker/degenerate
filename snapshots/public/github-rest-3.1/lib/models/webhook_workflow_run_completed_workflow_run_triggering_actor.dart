...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType {const WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType._(this.value);

factory WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType bot = WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType._('Bot');

static const WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType user = WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType._('User');

static const WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType organization = WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookWorkflowRunCompletedWorkflowRunTriggeringActor {const WebhookWorkflowRunCompletedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunCompletedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType? type;
...
WebhookWorkflowRunCompletedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunCompletedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunCompletedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunCompletedWorkflowRunTriggeringActor &&
