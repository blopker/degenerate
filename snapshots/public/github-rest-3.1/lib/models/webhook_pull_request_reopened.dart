...
final WebhookPullRequestReopenedAction action;
...
WebhookPullRequestReopened copyWith({WebhookPullRequestReopenedAction? action, EnterpriseWebhooks Function()? enterprise, SimpleInstallation Function()? installation, WebhooksNumber? number, OrganizationSimpleWebhooks Function()? organization, PullRequest? pullRequest, RepositoryWebhooks? repository, SimpleUser? sender, }) { return WebhookPullRequestReopened(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReopened &&
          action == other.action &&
...
@override String toString() { return 'WebhookPullRequestReopened(action: $action, enterprise: $enterprise, installation: $installation, number: $number, organization: $organization, pullRequest: $pullRequest, repository: $repository, sender: $sender)'; } 
 }
