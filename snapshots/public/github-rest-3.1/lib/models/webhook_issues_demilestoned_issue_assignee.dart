...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDemilestonedIssueAssigneeType {const WebhookIssuesDemilestonedIssueAssigneeType._(this.value);

factory WebhookIssuesDemilestonedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesDemilestonedIssueAssigneeType bot = WebhookIssuesDemilestonedIssueAssigneeType._('Bot');

static const WebhookIssuesDemilestonedIssueAssigneeType user = WebhookIssuesDemilestonedIssueAssigneeType._('User');

static const WebhookIssuesDemilestonedIssueAssigneeType organization = WebhookIssuesDemilestonedIssueAssigneeType._('Organization');

static const WebhookIssuesDemilestonedIssueAssigneeType mannequin = WebhookIssuesDemilestonedIssueAssigneeType._('Mannequin');

static const List<WebhookIssuesDemilestonedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesDemilestonedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssuesDemilestonedIssueAssignee {const WebhookIssuesDemilestonedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssuesDemilestonedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesDemilestonedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDemilestonedIssueAssigneeType? type;
...
WebhookIssuesDemilestonedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDemilestonedIssueAssigneeType? Function()? type, Uri? Function()? url, }) { return WebhookIssuesDemilestonedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDemilestonedIssueAssignee &&
