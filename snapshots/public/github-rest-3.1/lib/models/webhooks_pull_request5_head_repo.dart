...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_pull_request5_head_repo_license.dart';import 'webhooks_pull_request5_head_repo_owner.dart';import 'webhooks_pull_request5_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhooksPullRequest5HeadRepoPullRequestCreationPolicy {const WebhooksPullRequest5HeadRepoPullRequestCreationPolicy._(this.value);

factory WebhooksPullRequest5HeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhooksPullRequest5HeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhooksPullRequest5HeadRepoPullRequestCreationPolicy all = WebhooksPullRequest5HeadRepoPullRequestCreationPolicy._('all');

static const WebhooksPullRequest5HeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhooksPullRequest5HeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhooksPullRequest5HeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5HeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5HeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhooksPullRequest5HeadRepoMergeCommitMessage {const WebhooksPullRequest5HeadRepoMergeCommitMessage._(this.value);

factory WebhooksPullRequest5HeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
...
static const WebhooksPullRequest5HeadRepoMergeCommitMessage prBody = WebhooksPullRequest5HeadRepoMergeCommitMessage._('PR_BODY');

static const WebhooksPullRequest5HeadRepoMergeCommitMessage prTitle = WebhooksPullRequest5HeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhooksPullRequest5HeadRepoMergeCommitMessage blank = WebhooksPullRequest5HeadRepoMergeCommitMessage._('BLANK');

static const List<WebhooksPullRequest5HeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5HeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5HeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhooksPullRequest5HeadRepoMergeCommitTitle {const WebhooksPullRequest5HeadRepoMergeCommitTitle._(this.value);

factory WebhooksPullRequest5HeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhooksPullRequest5HeadRepoMergeCommitTitle._(json),
}; }

static const WebhooksPullRequest5HeadRepoMergeCommitTitle prTitle = WebhooksPullRequest5HeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhooksPullRequest5HeadRepoMergeCommitTitle mergeMessage = WebhooksPullRequest5HeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhooksPullRequest5HeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5HeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5HeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhooksPullRequest5HeadRepoSquashMergeCommitMessage {const WebhooksPullRequest5HeadRepoSquashMergeCommitMessage._(this.value);

factory WebhooksPullRequest5HeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhooksPullRequest5HeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhooksPullRequest5HeadRepoSquashMergeCommitMessage prBody = WebhooksPullRequest5HeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhooksPullRequest5HeadRepoSquashMergeCommitMessage commitMessages = WebhooksPullRequest5HeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhooksPullRequest5HeadRepoSquashMergeCommitMessage blank = WebhooksPullRequest5HeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhooksPullRequest5HeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5HeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5HeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhooksPullRequest5HeadRepoSquashMergeCommitTitle {const WebhooksPullRequest5HeadRepoSquashMergeCommitTitle._(this.value);

factory WebhooksPullRequest5HeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhooksPullRequest5HeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhooksPullRequest5HeadRepoSquashMergeCommitTitle prTitle = WebhooksPullRequest5HeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhooksPullRequest5HeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhooksPullRequest5HeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhooksPullRequest5HeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5HeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5HeadRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory WebhooksPullRequest5HeadRepo.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5HeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhooksPullRequest5HeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhooksPullRequest5HeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhooksPullRequest5HeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhooksPullRequest5HeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhooksPullRequest5HeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhooksPullRequest5HeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhooksPullRequest5HeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhooksPullRequest5HeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhooksPullRequest5HeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhooksPullRequest5HeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhooksPullRequest5HeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhooksPullRequest5HeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhooksPullRequest5HeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhooksPullRequest5HeadRepoOwner? owner;

final WebhooksPullRequest5HeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhooksPullRequest5HeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhooksPullRequest5HeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhooksPullRequest5HeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5HeadRepo &&
