...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestEnqueuedPullRequestBaseUserType {const WebhookPullRequestEnqueuedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestEnqueuedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestEnqueuedPullRequestBaseUserType bot = WebhookPullRequestEnqueuedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestBaseUserType user = WebhookPullRequestEnqueuedPullRequestBaseUserType._('User');

static const WebhookPullRequestEnqueuedPullRequestBaseUserType organization = WebhookPullRequestEnqueuedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestEnqueuedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestBaseUser {const WebhookPullRequestEnqueuedPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestEnqueuedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestBaseUserType? type;
...
WebhookPullRequestEnqueuedPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestEnqueuedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestBaseUser &&
...
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
