...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType bot = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType._('Bot');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType user = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType._('User');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType organization = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType? type;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer &&
...
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedRequestedReviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
