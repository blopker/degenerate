...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentCreatedWorkflowRunTriggeringActorType {const WebhookDeploymentCreatedWorkflowRunTriggeringActorType._(this.value);

factory WebhookDeploymentCreatedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookDeploymentCreatedWorkflowRunTriggeringActorType bot = WebhookDeploymentCreatedWorkflowRunTriggeringActorType._('Bot');

static const WebhookDeploymentCreatedWorkflowRunTriggeringActorType user = WebhookDeploymentCreatedWorkflowRunTriggeringActorType._('User');

static const WebhookDeploymentCreatedWorkflowRunTriggeringActorType organization = WebhookDeploymentCreatedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookDeploymentCreatedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentCreatedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentCreatedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookDeploymentCreatedWorkflowRunTriggeringActor {const WebhookDeploymentCreatedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentCreatedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentCreatedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookDeploymentCreatedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentCreatedWorkflowRunTriggeringActorType? type;
...
WebhookDeploymentCreatedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentCreatedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentCreatedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentCreatedWorkflowRunTriggeringActor &&
