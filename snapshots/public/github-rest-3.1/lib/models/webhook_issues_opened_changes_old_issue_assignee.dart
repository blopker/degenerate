...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedChangesOldIssueAssigneeType {const WebhookIssuesOpenedChangesOldIssueAssigneeType._(this.value);
...
factory WebhookIssuesOpenedChangesOldIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedChangesOldIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedChangesOldIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedChangesOldIssueAssigneeType? type;
...
WebhookIssuesOpenedChangesOldIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedChangesOldIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedChangesOldIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedChangesOldIssueAssignee &&
