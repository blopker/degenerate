...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewRequestedReviewersReviewerType {const WebhookDeploymentReviewRequestedReviewersReviewerType._(this.value);

factory WebhookDeploymentReviewRequestedReviewersReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookDeploymentReviewRequestedReviewersReviewerType bot = WebhookDeploymentReviewRequestedReviewersReviewerType._('Bot');

static const WebhookDeploymentReviewRequestedReviewersReviewerType user = WebhookDeploymentReviewRequestedReviewersReviewerType._('User');

static const WebhookDeploymentReviewRequestedReviewersReviewerType organization = WebhookDeploymentReviewRequestedReviewersReviewerType._('Organization');

static const List<WebhookDeploymentReviewRequestedReviewersReviewerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewRequestedReviewersReviewerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewRequestedReviewersReviewerType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewRequestedReviewersReviewer {const WebhookDeploymentReviewRequestedReviewersReviewer({required this.id, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewRequestedReviewersReviewer.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewRequestedReviewersReviewer(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewRequestedReviewersReviewerType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewRequestedReviewersReviewerType? type;
...
WebhookDeploymentReviewRequestedReviewersReviewer copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? Function()? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewRequestedReviewersReviewerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewRequestedReviewersReviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewRequestedReviewersReviewer &&
...
@override String toString() { return 'WebhookDeploymentReviewRequestedReviewersReviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
