...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerType {const WebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerType._(this.value);
...
factory WebhookWorkflowRunRequestedWorkflowRunRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunRequestedWorkflowRunRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerType? type;
...
WebhookWorkflowRunRequestedWorkflowRunRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunRequestedWorkflowRunRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunRequestedWorkflowRunRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunRequestedWorkflowRunRepositoryOwner &&
