...
final class IntegrationPermissions {const IntegrationPermissions({this.issues, this.checks, this.metadata, this.contents, this.deployments, });
...
@override String toString() { return 'IntegrationPermissions(issues: $issues, checks: $checks, metadata: $metadata, contents: $contents, deployments: $deployments)'; } 
 }
