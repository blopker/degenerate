...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_locked_pull_request_head_repo_license.dart';import 'webhook_pull_request_locked_pull_request_head_repo_owner.dart';import 'webhook_pull_request_locked_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestLockedPullRequestHeadRepoVisibility {const WebhookPullRequestLockedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestLockedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestLockedPullRequestHeadRepoVisibility public = WebhookPullRequestLockedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestLockedPullRequestHeadRepoVisibility private = WebhookPullRequestLockedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestLockedPullRequestHeadRepoVisibility internal = WebhookPullRequestLockedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestLockedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestLockedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLockedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestLockedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestLockedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestLockedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestLockedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestLockedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestLockedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestLockedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestLockedPullRequestHeadRepoVisibility visibility;
...
WebhookPullRequestLockedPullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestLockedPullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestLockedPullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestLockedPullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestLockedPullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestLockedPullRequestHeadRepoOwner? Function()? owner, WebhookPullRequestLockedPullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestLockedPullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestLockedPullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestLockedPullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLockedPullRequestHeadRepo &&
