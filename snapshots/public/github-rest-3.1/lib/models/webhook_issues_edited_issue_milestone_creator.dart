...
static const WebhookIssuesEditedIssueMilestoneCreatorType bot = WebhookIssuesEditedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesEditedIssueMilestoneCreatorType user = WebhookIssuesEditedIssueMilestoneCreatorType._('User');

static const WebhookIssuesEditedIssueMilestoneCreatorType organization = WebhookIssuesEditedIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesEditedIssueMilestoneCreatorType mannequin = WebhookIssuesEditedIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesEditedIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesEditedIssueMilestoneCreatorType && other.value == value; } 
...
factory WebhookIssuesEditedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesEditedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesEditedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesEditedIssueMilestoneCreatorType? type;
...
WebhookIssuesEditedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesEditedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesEditedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesEditedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesEditedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
