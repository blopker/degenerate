...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlockedPullRequestHeadUserType {const WebhookPullRequestUnlockedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestUnlockedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestUnlockedPullRequestHeadUserType bot = WebhookPullRequestUnlockedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestUnlockedPullRequestHeadUserType user = WebhookPullRequestUnlockedPullRequestHeadUserType._('User');

static const WebhookPullRequestUnlockedPullRequestHeadUserType organization = WebhookPullRequestUnlockedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestUnlockedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlockedPullRequestHeadUser {const WebhookPullRequestUnlockedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlockedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlockedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlockedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlockedPullRequestHeadUserType? type;
...
WebhookPullRequestUnlockedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlockedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlockedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlockedPullRequestHeadUser &&
...
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
