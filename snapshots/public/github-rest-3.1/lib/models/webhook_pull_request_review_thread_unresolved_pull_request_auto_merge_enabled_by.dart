...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType {const WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType bot = WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType user = WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType organization = WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy {const WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadUnresolvedPullRequestAutoMergeEnabledBy &&
