...
import 'rule_suite_pull_request_pull_request_reviews_user.dart';final class RuleSuitePullRequestPullRequestReviews {const RuleSuitePullRequestPullRequestReviews({this.id, this.user, this.state, });
