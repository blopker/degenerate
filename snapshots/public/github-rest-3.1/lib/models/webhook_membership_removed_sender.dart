...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookMembershipRemovedSenderType {const WebhookMembershipRemovedSenderType._(this.value);

factory WebhookMembershipRemovedSenderType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookMembershipRemovedSenderType._(json),
}; }

static const WebhookMembershipRemovedSenderType bot = WebhookMembershipRemovedSenderType._('Bot');

static const WebhookMembershipRemovedSenderType user = WebhookMembershipRemovedSenderType._('User');

static const WebhookMembershipRemovedSenderType organization = WebhookMembershipRemovedSenderType._('Organization');

static const List<WebhookMembershipRemovedSenderType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookMembershipRemovedSenderType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookMembershipRemovedSenderType($value)'; } 
 }
@immutable final class WebhookMembershipRemovedSender {const WebhookMembershipRemovedSender({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookMembershipRemovedSender.fromJson(Map<String, dynamic> json) { return WebhookMembershipRemovedSender(
  ...
  type: json['type'] != null ? WebhookMembershipRemovedSenderType.fromJson(json['type'] as String) : null,
...
final WebhookMembershipRemovedSenderType? type;
...
WebhookMembershipRemovedSender copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookMembershipRemovedSenderType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookMembershipRemovedSender(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookMembershipRemovedSender &&
