...
return CodespacesCreateWithRepoForAuthenticatedUserError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>));
}
if (responseMediaTypeMatches(contentType, 'application/scim+json')) {
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>));
}
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>));
...
case 401:
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError401(BasicError.fromJson(json as Map<String, dynamic>));
case 403:
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError403(BasicError.fromJson(json as Map<String, dynamic>));
case 404:
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError404(BasicError.fromJson(json as Map<String, dynamic>));
case 503:
final json = jsonDecode(response.body);
return CodespacesCreateWithRepoForAuthenticatedUserError503(CodespacesCreateWithRepoForAuthenticatedUserResponse503.fromJson(json as Map<String, dynamic>));
default:
