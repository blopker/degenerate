...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPushRepositoryOwnerType {const WebhookPushRepositoryOwnerType._(this.value);

factory WebhookPushRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPushRepositoryOwnerType._(json),
}; }

static const WebhookPushRepositoryOwnerType bot = WebhookPushRepositoryOwnerType._('Bot');

static const WebhookPushRepositoryOwnerType user = WebhookPushRepositoryOwnerType._('User');

static const WebhookPushRepositoryOwnerType organization = WebhookPushRepositoryOwnerType._('Organization');

static const List<WebhookPushRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPushRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPushRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookPushRepositoryOwner {const WebhookPushRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPushRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookPushRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookPushRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPushRepositoryOwnerType? type;
...
WebhookPushRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPushRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPushRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPushRepositoryOwner &&
...
@override String toString() { return 'WebhookPushRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
