...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewEditedPullRequestAssigneeType {const WebhookPullRequestReviewEditedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewEditedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestReviewEditedPullRequestAssigneeType bot = WebhookPullRequestReviewEditedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewEditedPullRequestAssigneeType user = WebhookPullRequestReviewEditedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewEditedPullRequestAssigneeType organization = WebhookPullRequestReviewEditedPullRequestAssigneeType._('Organization');

static const WebhookPullRequestReviewEditedPullRequestAssigneeType mannequin = WebhookPullRequestReviewEditedPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestReviewEditedPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewEditedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewEditedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewEditedPullRequestAssignee {const WebhookPullRequestReviewEditedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewEditedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewEditedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewEditedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewEditedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewEditedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewEditedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewEditedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewEditedPullRequestAssignee &&
