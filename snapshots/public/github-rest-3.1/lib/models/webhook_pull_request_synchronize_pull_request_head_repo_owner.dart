...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType {const WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType bot = WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType user = WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType organization = WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestSynchronizePullRequestHeadRepoOwner {const WebhookPullRequestSynchronizePullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestSynchronizePullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestSynchronizePullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestSynchronizePullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestSynchronizePullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestHeadRepoOwner &&
...
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
