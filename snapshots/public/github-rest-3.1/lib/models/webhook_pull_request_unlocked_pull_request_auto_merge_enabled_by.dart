...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType {const WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType bot = WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType user = WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType organization = WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy {const WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlockedPullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy &&
