...
return  ActionsSetPrivateRepoForkPrWorkflowsSettingsRepositoryError404(BasicError.fromJson(json as Map<String, dynamic>));case 422:
final json = jsonDecode(response.body);
return  ActionsSetPrivateRepoForkPrWorkflowsSettingsRepositoryError422(ValidationError.fromJson(json as Map<String, dynamic>));default:
