...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class BudgetBudgetAlerting {const BudgetBudgetAlerting({required this.willAlert, required this.alertRecipients, });
