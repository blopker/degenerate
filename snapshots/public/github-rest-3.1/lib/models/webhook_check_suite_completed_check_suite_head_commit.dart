...
factory WebhookCheckSuiteCompletedCheckSuiteHeadCommit.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteCompletedCheckSuiteHeadCommit(
  ...
  committer: WebhookCheckSuiteCompletedCheckSuiteHeadCommitCommitter.fromJson(json['committer'] as Map<String, dynamic>),
...
WebhookCheckSuiteCompletedCheckSuiteHeadCommit copyWith({WebhookCheckSuiteCompletedCheckSuiteHeadCommitAuthor? author, WebhookCheckSuiteCompletedCheckSuiteHeadCommitCommitter? committer, String? id, String? message, String? timestamp, String? treeId, }) { return WebhookCheckSuiteCompletedCheckSuiteHeadCommit(
...
@override String toString() { return 'WebhookCheckSuiteCompletedCheckSuiteHeadCommit(author: $author, committer: $committer, id: $id, message: $message, timestamp: $timestamp, treeId: $treeId)'; } 
 }
