...
final class PullRequestReviewCommentEventCommentUserType {const PullRequestReviewCommentEventCommentUserType._(this.value);

factory PullRequestReviewCommentEventCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const PullRequestReviewCommentEventCommentUserType bot = PullRequestReviewCommentEventCommentUserType._('Bot');

static const PullRequestReviewCommentEventCommentUserType user = PullRequestReviewCommentEventCommentUserType._('User');

static const PullRequestReviewCommentEventCommentUserType organization = PullRequestReviewCommentEventCommentUserType._('Organization');

static const List<PullRequestReviewCommentEventCommentUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is PullRequestReviewCommentEventCommentUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'PullRequestReviewCommentEventCommentUserType($value)'; } 
 }
final class PullRequestReviewCommentEventCommentUser {const PullRequestReviewCommentEventCommentUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory PullRequestReviewCommentEventCommentUser.fromJson(Map<String, dynamic> json) { return PullRequestReviewCommentEventCommentUser(
  ...
  type: json['type'] != null ? PullRequestReviewCommentEventCommentUserType.fromJson(json['type'] as String) : null,
...
final PullRequestReviewCommentEventCommentUserType? type;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PullRequestReviewCommentEventCommentUser &&
...
@override String toString() { return 'PullRequestReviewCommentEventCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
