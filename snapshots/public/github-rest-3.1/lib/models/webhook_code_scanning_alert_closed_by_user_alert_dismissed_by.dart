...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCodeScanningAlertClosedByUserAlertDismissedByType {const WebhookCodeScanningAlertClosedByUserAlertDismissedByType._(this.value);

factory WebhookCodeScanningAlertClosedByUserAlertDismissedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCodeScanningAlertClosedByUserAlertDismissedByType._(json),
}; }

static const WebhookCodeScanningAlertClosedByUserAlertDismissedByType bot = WebhookCodeScanningAlertClosedByUserAlertDismissedByType._('Bot');

static const WebhookCodeScanningAlertClosedByUserAlertDismissedByType user = WebhookCodeScanningAlertClosedByUserAlertDismissedByType._('User');

static const WebhookCodeScanningAlertClosedByUserAlertDismissedByType organization = WebhookCodeScanningAlertClosedByUserAlertDismissedByType._('Organization');

static const List<WebhookCodeScanningAlertClosedByUserAlertDismissedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCodeScanningAlertClosedByUserAlertDismissedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCodeScanningAlertClosedByUserAlertDismissedByType($value)'; } 
 }
@immutable final class WebhookCodeScanningAlertClosedByUserAlertDismissedBy {const WebhookCodeScanningAlertClosedByUserAlertDismissedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCodeScanningAlertClosedByUserAlertDismissedBy.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertClosedByUserAlertDismissedBy(
  ...
  type: json['type'] != null ? WebhookCodeScanningAlertClosedByUserAlertDismissedByType.fromJson(json['type'] as String) : null,
...
final WebhookCodeScanningAlertClosedByUserAlertDismissedByType? type;
...
WebhookCodeScanningAlertClosedByUserAlertDismissedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCodeScanningAlertClosedByUserAlertDismissedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCodeScanningAlertClosedByUserAlertDismissedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCodeScanningAlertClosedByUserAlertDismissedBy &&
