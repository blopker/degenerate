...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_submitted_pull_request_auto_merge_enabled_by.dart';/// The merge method to use.
@immutable final class WebhookPullRequestReviewSubmittedPullRequestAutoMergeMergeMethod {const WebhookPullRequestReviewSubmittedPullRequestAutoMergeMergeMethod._(this.value);
...
@immutable final class WebhookPullRequestReviewSubmittedPullRequestAutoMerge {const WebhookPullRequestReviewSubmittedPullRequestAutoMerge({required this.commitMessage, required this.commitTitle, required this.enabledBy, required this.mergeMethod, });
