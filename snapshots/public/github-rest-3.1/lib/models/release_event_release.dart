...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'reaction_rollup.dart';import 'release_asset.dart';import 'simple_user.dart';final class ReleaseEventRelease {const ReleaseEventRelease({required this.url, required this.htmlUrl, required this.assetsUrl, required this.uploadUrl, required this.tarballUrl, required this.zipballUrl, required this.id, required this.nodeId, required this.tagName, required this.targetCommitish, required this.name, this.body, required this.draft, required this.prerelease, this.immutable, required this.createdAt, required this.publishedAt, this.updatedAt, required this.author, required this.assets, this.bodyHtml, this.bodyText, this.mentionsCount, this.discussionUrl, this.reactions, this.isShortDescriptionHtmlTruncated, this.shortDescriptionHtml, });
...
final bool? isShortDescriptionHtmlTruncated;
