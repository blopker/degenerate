...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User19Type {const User19Type._(this.value);

factory User19Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User19Type bot = User19Type._('Bot');

static const User19Type user = User19Type._('User');

static const User19Type organization = User19Type._('Organization');

static const User19Type mannequin = User19Type._('Mannequin');

static const List<User19Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User19Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User19Type($value)'; } 
 }
@immutable final class User19 {const User19({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User19.fromJson(Map<String, dynamic> json) { return User19(
  ...
  type: json['type'] != null ? User19Type.fromJson(json['type'] as String) : null,
...
User19 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User19Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User19(
