...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestAssigneesType {const WebhookPullRequestLabeledPullRequestAssigneesType._(this.value);

factory WebhookPullRequestLabeledPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestLabeledPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestLabeledPullRequestAssigneesType bot = WebhookPullRequestLabeledPullRequestAssigneesType._('Bot');

static const WebhookPullRequestLabeledPullRequestAssigneesType user = WebhookPullRequestLabeledPullRequestAssigneesType._('User');

static const WebhookPullRequestLabeledPullRequestAssigneesType organization = WebhookPullRequestLabeledPullRequestAssigneesType._('Organization');

static const WebhookPullRequestLabeledPullRequestAssigneesType mannequin = WebhookPullRequestLabeledPullRequestAssigneesType._('Mannequin');

static const List<WebhookPullRequestLabeledPullRequestAssigneesType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestAssignees {const WebhookPullRequestLabeledPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookPullRequestLabeledPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestAssigneesType? type;
...
WebhookPullRequestLabeledPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestLabeledPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestAssignees &&
...
@override String toString() { return 'WebhookPullRequestLabeledPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
