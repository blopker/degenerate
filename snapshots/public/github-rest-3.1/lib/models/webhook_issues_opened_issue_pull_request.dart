...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedIssuePullRequest {const WebhookIssuesOpenedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
...
WebhookIssuesOpenedIssuePullRequest copyWith({Uri Function()? diffUrl, Uri Function()? htmlUrl, DateTime? Function()? mergedAt, Uri Function()? patchUrl, Uri Function()? url, }) { return WebhookIssuesOpenedIssuePullRequest(
