...
final class WebhookIssuesOpenedIssuePullRequest {const WebhookIssuesOpenedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
