...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ProjectEditedChangesPublic {const ProjectEditedChangesPublic({this.from, this.to, });
