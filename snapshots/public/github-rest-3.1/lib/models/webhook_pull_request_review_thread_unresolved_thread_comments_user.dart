...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType {const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType._(this.value);

factory WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType._(json),
}; }

static const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType bot = WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType._('Bot');

static const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType user = WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType._('User');

static const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType organization = WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType._('Organization');

static const List<WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser {const WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType? type;
...
WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadUnresolvedThreadCommentsUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser &&
...
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedThreadCommentsUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
