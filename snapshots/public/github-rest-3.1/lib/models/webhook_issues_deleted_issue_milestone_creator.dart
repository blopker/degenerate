...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDeletedIssueMilestoneCreatorType {const WebhookIssuesDeletedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesDeletedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesDeletedIssueMilestoneCreatorType._(json),
}; }

static const WebhookIssuesDeletedIssueMilestoneCreatorType bot = WebhookIssuesDeletedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesDeletedIssueMilestoneCreatorType user = WebhookIssuesDeletedIssueMilestoneCreatorType._('User');

static const WebhookIssuesDeletedIssueMilestoneCreatorType organization = WebhookIssuesDeletedIssueMilestoneCreatorType._('Organization');

static const List<WebhookIssuesDeletedIssueMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDeletedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesDeletedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesDeletedIssueMilestoneCreator {const WebhookIssuesDeletedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesDeletedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesDeletedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDeletedIssueMilestoneCreatorType? type;
...
WebhookIssuesDeletedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDeletedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDeletedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDeletedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesDeletedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
