...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType bot = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType user = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType._('User');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType organization = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType? type;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee &&
