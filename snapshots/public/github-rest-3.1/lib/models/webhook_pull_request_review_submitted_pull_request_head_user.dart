...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewSubmittedPullRequestHeadUserType {const WebhookPullRequestReviewSubmittedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewSubmittedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestReviewSubmittedPullRequestHeadUserType bot = WebhookPullRequestReviewSubmittedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewSubmittedPullRequestHeadUserType user = WebhookPullRequestReviewSubmittedPullRequestHeadUserType._('User');

static const WebhookPullRequestReviewSubmittedPullRequestHeadUserType organization = WebhookPullRequestReviewSubmittedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewSubmittedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewSubmittedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewSubmittedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewSubmittedPullRequestHeadUser {const WebhookPullRequestReviewSubmittedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewSubmittedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewSubmittedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewSubmittedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewSubmittedPullRequestHeadUserType? type;
...
WebhookPullRequestReviewSubmittedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewSubmittedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewSubmittedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewSubmittedPullRequestHeadUser &&
