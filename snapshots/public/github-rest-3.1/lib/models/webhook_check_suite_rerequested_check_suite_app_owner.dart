...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType {const WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType._(this.value);

factory WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType._(json),
}; }

static const WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType bot = WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType._('Bot');

static const WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType user = WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType._('User');

static const WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType organization = WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType._('Organization');

static const List<WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType($value)'; } 
 }
@immutable final class WebhookCheckSuiteRerequestedCheckSuiteAppOwner {const WebhookCheckSuiteRerequestedCheckSuiteAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCheckSuiteRerequestedCheckSuiteAppOwner.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteRerequestedCheckSuiteAppOwner(
  ...
  type: json['type'] != null ? WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType? type;
...
WebhookCheckSuiteRerequestedCheckSuiteAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCheckSuiteRerequestedCheckSuiteAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCheckSuiteRerequestedCheckSuiteAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCheckSuiteRerequestedCheckSuiteAppOwner &&
...
@override String toString() { return 'WebhookCheckSuiteRerequestedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
