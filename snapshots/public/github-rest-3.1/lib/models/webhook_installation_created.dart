...
@immutable final class WebhookInstallationCreated {const WebhookInstallationCreated({required this.action, required this.installation, required this.sender, this.enterprise, this.organization, this.repositories, this.repository, this.requester = const Omittable.absent(), });
...
factory WebhookInstallationCreated.fromJson(Map<String, dynamic> json) { return WebhookInstallationCreated(
  ...
  requester: json.containsKey('requester') ? Omittable(json['requester'] != null ? WebhooksUser.fromJson(json['requester'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhooksUser?> requester;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookInstallationCreated &&
          action == other.action &&
...
@override String toString() { return 'WebhookInstallationCreated(action: $action, enterprise: $enterprise, installation: $installation, organization: $organization, repositories: $repositories, repository: $repository, requester: $requester, sender: $sender)'; } 
 }
