...
final class WebhookInstallationTargetRenamedAccount {const WebhookInstallationTargetRenamedAccount({this.archivedAt, required this.avatarUrl, this.createdAt, this.description, this.eventsUrl, this.followers, this.followersUrl, this.following, this.followingUrl, this.gistsUrl, this.gravatarId, this.hasOrganizationProjects, this.hasRepositoryProjects, this.hooksUrl, required this.htmlUrl, required this.id, this.isVerified, this.issuesUrl, this.login, this.membersUrl, this.name, required this.nodeId, this.organizationsUrl, this.publicGists, this.publicMembersUrl, this.publicRepos, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.slug, this.starredUrl, this.subscriptionsUrl, this.type, this.updatedAt, this.url, this.websiteUrl, this.userViewType, });
