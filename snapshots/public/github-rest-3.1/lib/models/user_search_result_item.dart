...
final class UserSearchResultItem {const UserSearchResultItem({required this.login, required this.id, required this.nodeId, required this.avatarUrl, required this.gravatarId, required this.url, required this.htmlUrl, required this.followersUrl, required this.subscriptionsUrl, required this.organizationsUrl, required this.reposUrl, required this.receivedEventsUrl, required this.type, required this.score, required this.followingUrl, required this.gistsUrl, required this.starredUrl, required this.eventsUrl, this.publicRepos, this.publicGists, this.followers, this.following, this.createdAt, this.updatedAt, this.name, this.bio, this.email, this.location, required this.siteAdmin, this.hireable, this.textMatches, this.blog, this.company, this.suspendedAt, this.userViewType, });
