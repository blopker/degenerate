...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType {const WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType user = WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner {const WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadResolvedPullRequestHeadRepoOwner &&
