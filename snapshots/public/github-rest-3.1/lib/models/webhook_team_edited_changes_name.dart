...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamEditedChangesName {const WebhookTeamEditedChangesName({required this.from});
