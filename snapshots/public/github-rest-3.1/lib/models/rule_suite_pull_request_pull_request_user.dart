...
RuleSuitePullRequestPullRequestUser copyWith({int Function()? id, String Function()? login, String Function()? type, }) { return RuleSuitePullRequestPullRequestUser(
  id: id != null ? id() : this.id,
  login: login != null ? login() : this.login,
  type: type != null ? type() : this.type,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RuleSuitePullRequestPullRequestUser &&
          id == other.id &&
          login == other.login &&
          type == other.type; } 
@override int get hashCode { return Object.hash(id, login, type); } 
@override String toString() { return 'RuleSuitePullRequestPullRequestUser(id: $id, login: $login, type: $type)'; } 
 }
