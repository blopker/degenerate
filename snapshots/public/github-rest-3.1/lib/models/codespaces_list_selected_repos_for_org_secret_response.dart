...
CodespacesListSelectedReposForOrgSecretResponse copyWith({int? totalCount, List<MinimalRepository>? repositories, }) { return CodespacesListSelectedReposForOrgSecretResponse(
  totalCount: totalCount ?? this.totalCount,
  repositories: repositories ?? this.repositories,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CodespacesListSelectedReposForOrgSecretResponse &&
...
@override String toString() { return 'CodespacesListSelectedReposForOrgSecretResponse(totalCount: $totalCount, repositories: $repositories)'; } 
 }
