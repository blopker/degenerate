...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType {const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType._(this.value);

factory WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType._(json),
}; }

static const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType bot = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType._('Bot');

static const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType user = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType._('User');

static const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType organization = WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor {const WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType? type;
...
WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewRejectedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewRejectedWorkflowRunTriggeringActor &&
