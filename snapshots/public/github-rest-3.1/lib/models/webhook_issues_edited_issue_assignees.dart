...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesEditedIssueAssigneesType {const WebhookIssuesEditedIssueAssigneesType._(this.value);
...
@immutable final class WebhookIssuesEditedIssueAssignees {const WebhookIssuesEditedIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssuesEditedIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesEditedIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesEditedIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesEditedIssueAssigneesType? type;
...
WebhookIssuesEditedIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesEditedIssueAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookIssuesEditedIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesEditedIssueAssignees &&
