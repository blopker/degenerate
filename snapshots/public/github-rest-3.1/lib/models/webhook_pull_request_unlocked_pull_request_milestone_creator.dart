...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlockedPullRequestMilestoneCreatorType {const WebhookPullRequestUnlockedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestUnlockedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestUnlockedPullRequestMilestoneCreatorType bot = WebhookPullRequestUnlockedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestUnlockedPullRequestMilestoneCreatorType user = WebhookPullRequestUnlockedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestUnlockedPullRequestMilestoneCreatorType organization = WebhookPullRequestUnlockedPullRequestMilestoneCreatorType._('Organization');

static const List<WebhookPullRequestUnlockedPullRequestMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlockedPullRequestMilestoneCreator {const WebhookPullRequestUnlockedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlockedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlockedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlockedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlockedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestUnlockedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlockedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlockedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlockedPullRequestMilestoneCreator &&
