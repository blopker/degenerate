...
final class WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType {const WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType._(this.value);

factory WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType._(json),
}; }

static const WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType bot = WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType._('Bot');

static const WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType user = WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType._('User');

static const WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType organization = WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType._('Organization');

static const List<WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType> values = [bot, user, organization];
...
factory WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwnerType? type;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner &&
...
@override String toString() { return 'WebhookWorkflowRunInProgressWorkflowRunHeadRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
