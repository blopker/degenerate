...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_push_repository_license.dart';import 'webhook_push_repository_owner.dart';import 'webhook_push_repository_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
@immutable final class WebhookPushRepositoryPullRequestCreationPolicy {const WebhookPushRepositoryPullRequestCreationPolicy._(this.value);

factory WebhookPushRepositoryPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPushRepositoryPullRequestCreationPolicy._(json),
}; }

static const WebhookPushRepositoryPullRequestCreationPolicy all = WebhookPushRepositoryPullRequestCreationPolicy._('all');

static const WebhookPushRepositoryPullRequestCreationPolicy collaboratorsOnly = WebhookPushRepositoryPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPushRepositoryPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPushRepositoryPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPushRepositoryPullRequestCreationPolicy($value)'; } 
 }
@immutable final class WebhookPushRepositoryVisibility {const WebhookPushRepositoryVisibility._(this.value);

factory WebhookPushRepositoryVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPushRepositoryVisibility public = WebhookPushRepositoryVisibility._('public');

static const WebhookPushRepositoryVisibility private = WebhookPushRepositoryVisibility._('private');

static const WebhookPushRepositoryVisibility internal = WebhookPushRepositoryVisibility._('internal');

static const List<WebhookPushRepositoryVisibility> values = [public, private, internal];
...
factory WebhookPushRepository.fromJson(Map<String, dynamic> json) { return WebhookPushRepository(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPushRepositoryPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPushRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookPushRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPushRepositoryPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  visibility: WebhookPushRepositoryVisibility.fromJson(json['visibility'] as String),
...
final WebhookPushRepositoryPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPushRepositoryLicense? license;
...
final WebhookPushRepositoryOwner? owner;

final WebhookPushRepositoryPermissions? permissions;
...
final WebhookPushRepositoryVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPushRepository &&
