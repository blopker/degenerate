...
final class OrgsListAttestationsBulkResponsePageInfo {const OrgsListAttestationsBulkResponsePageInfo({this.hasNext, this.hasPrevious, this.next, this.previous, });
