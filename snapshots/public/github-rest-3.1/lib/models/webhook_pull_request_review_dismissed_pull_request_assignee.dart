...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewDismissedPullRequestAssigneeType {const WebhookPullRequestReviewDismissedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewDismissedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestAssigneeType bot = WebhookPullRequestReviewDismissedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewDismissedPullRequestAssigneeType user = WebhookPullRequestReviewDismissedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewDismissedPullRequestAssigneeType organization = WebhookPullRequestReviewDismissedPullRequestAssigneeType._('Organization');

static const WebhookPullRequestReviewDismissedPullRequestAssigneeType mannequin = WebhookPullRequestReviewDismissedPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestReviewDismissedPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewDismissedPullRequestAssignee {const WebhookPullRequestReviewDismissedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewDismissedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewDismissedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewDismissedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewDismissedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewDismissedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewDismissedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewDismissedPullRequestAssignee &&
