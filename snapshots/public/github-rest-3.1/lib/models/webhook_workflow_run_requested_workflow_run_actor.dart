...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunRequestedWorkflowRunActorType {const WebhookWorkflowRunRequestedWorkflowRunActorType._(this.value);

factory WebhookWorkflowRunRequestedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookWorkflowRunRequestedWorkflowRunActorType bot = WebhookWorkflowRunRequestedWorkflowRunActorType._('Bot');

static const WebhookWorkflowRunRequestedWorkflowRunActorType user = WebhookWorkflowRunRequestedWorkflowRunActorType._('User');

static const WebhookWorkflowRunRequestedWorkflowRunActorType organization = WebhookWorkflowRunRequestedWorkflowRunActorType._('Organization');

static const List<WebhookWorkflowRunRequestedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunRequestedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunRequestedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookWorkflowRunRequestedWorkflowRunActor {const WebhookWorkflowRunRequestedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunRequestedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunRequestedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookWorkflowRunRequestedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunRequestedWorkflowRunActorType? type;
...
WebhookWorkflowRunRequestedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunRequestedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunRequestedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunRequestedWorkflowRunActor &&
...
@override String toString() { return 'WebhookWorkflowRunRequestedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
