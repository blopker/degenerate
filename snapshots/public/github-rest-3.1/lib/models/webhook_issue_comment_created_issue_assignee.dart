...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentCreatedIssueAssigneeType {const WebhookIssueCommentCreatedIssueAssigneeType._(this.value);

factory WebhookIssueCommentCreatedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssueCommentCreatedIssueAssigneeType bot = WebhookIssueCommentCreatedIssueAssigneeType._('Bot');

static const WebhookIssueCommentCreatedIssueAssigneeType user = WebhookIssueCommentCreatedIssueAssigneeType._('User');

static const WebhookIssueCommentCreatedIssueAssigneeType organization = WebhookIssueCommentCreatedIssueAssigneeType._('Organization');

static const WebhookIssueCommentCreatedIssueAssigneeType mannequin = WebhookIssueCommentCreatedIssueAssigneeType._('Mannequin');

static const List<WebhookIssueCommentCreatedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentCreatedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentCreatedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssueCommentCreatedIssueAssignee {const WebhookIssueCommentCreatedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentCreatedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentCreatedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssueCommentCreatedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentCreatedIssueAssigneeType? type;
...
WebhookIssueCommentCreatedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentCreatedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentCreatedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentCreatedIssueAssignee &&
...
@override String toString() { return 'WebhookIssueCommentCreatedIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
