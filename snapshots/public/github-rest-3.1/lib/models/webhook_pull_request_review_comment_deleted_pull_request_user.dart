...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestUserType {const WebhookPullRequestReviewCommentDeletedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestUserType bot = WebhookPullRequestReviewCommentDeletedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestUserType user = WebhookPullRequestReviewCommentDeletedPullRequestUserType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestUserType organization = WebhookPullRequestReviewCommentDeletedPullRequestUserType._('Organization');

static const WebhookPullRequestReviewCommentDeletedPullRequestUserType mannequin = WebhookPullRequestReviewCommentDeletedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestUser {const WebhookPullRequestReviewCommentDeletedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentDeletedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestUserType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentDeletedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestUser &&
...
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
