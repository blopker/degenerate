...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhooks_membership.dart';final class WebhookOrganizationMemberAddedAction {const WebhookOrganizationMemberAddedAction._(this.value);
...
final class WebhookOrganizationMemberAdded {const WebhookOrganizationMemberAdded({required this.action, this.enterprise, this.installation, required this.membership, required this.organization, this.repository, required this.sender, });
