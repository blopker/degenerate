...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentEditedIssueUser {const WebhookIssueCommentEditedIssueUser({this.avatarUrl, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssueCommentEditedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentEditedIssueUser(
...
WebhookIssueCommentEditedIssueUser copyWith({String Function()? avatarUrl, String Function()? eventsUrl, String Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, String Function()? htmlUrl, int Function()? id, String Function()? login, String Function()? nodeId, String Function()? organizationsUrl, String Function()? receivedEventsUrl, String Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, String Function()? subscriptionsUrl, String Function()? type, String Function()? url, }) { return WebhookIssueCommentEditedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentEditedIssueUser &&
...
@override String toString() { return 'WebhookIssueCommentEditedIssueUser(avatarUrl: $avatarUrl, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
