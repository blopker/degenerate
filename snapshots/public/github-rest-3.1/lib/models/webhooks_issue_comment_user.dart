...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksIssueCommentUserType {const WebhooksIssueCommentUserType._(this.value);

factory WebhooksIssueCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksIssueCommentUserType bot = WebhooksIssueCommentUserType._('Bot');

static const WebhooksIssueCommentUserType user = WebhooksIssueCommentUserType._('User');

static const WebhooksIssueCommentUserType organization = WebhooksIssueCommentUserType._('Organization');

static const WebhooksIssueCommentUserType mannequin = WebhooksIssueCommentUserType._('Mannequin');

static const List<WebhooksIssueCommentUserType> values = [bot, user, organization, mannequin];
...
@override String toString() { return 'WebhooksIssueCommentUserType($value)'; } 
 }
@immutable final class WebhooksIssueCommentUser {const WebhooksIssueCommentUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksIssueCommentUser.fromJson(Map<String, dynamic> json) { return WebhooksIssueCommentUser(
  ...
  type: json['type'] != null ? WebhooksIssueCommentUserType.fromJson(json['type'] as String) : null,
...
final WebhooksIssueCommentUserType? type;
...
WebhooksIssueCommentUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksIssueCommentUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksIssueCommentUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksIssueCommentUser &&
...
@override String toString() { return 'WebhooksIssueCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
