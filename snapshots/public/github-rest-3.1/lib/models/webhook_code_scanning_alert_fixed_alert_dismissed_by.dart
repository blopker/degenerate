...
static const WebhookCodeScanningAlertFixedAlertDismissedByType bot = WebhookCodeScanningAlertFixedAlertDismissedByType._('Bot');

static const WebhookCodeScanningAlertFixedAlertDismissedByType user = WebhookCodeScanningAlertFixedAlertDismissedByType._('User');

static const WebhookCodeScanningAlertFixedAlertDismissedByType organization = WebhookCodeScanningAlertFixedAlertDismissedByType._('Organization');

static const List<WebhookCodeScanningAlertFixedAlertDismissedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCodeScanningAlertFixedAlertDismissedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCodeScanningAlertFixedAlertDismissedByType($value)'; } 
 }
@immutable final class WebhookCodeScanningAlertFixedAlertDismissedBy {const WebhookCodeScanningAlertFixedAlertDismissedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory WebhookCodeScanningAlertFixedAlertDismissedBy.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertFixedAlertDismissedBy(
  ...
  type: json['type'] != null ? WebhookCodeScanningAlertFixedAlertDismissedByType.fromJson(json['type'] as String) : null,
...
final WebhookCodeScanningAlertFixedAlertDismissedByType? type;
...
WebhookCodeScanningAlertFixedAlertDismissedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCodeScanningAlertFixedAlertDismissedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCodeScanningAlertFixedAlertDismissedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCodeScanningAlertFixedAlertDismissedBy &&
