...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User21Type {const User21Type._(this.value);

factory User21Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User21Type bot = User21Type._('Bot');

static const User21Type user = User21Type._('User');

static const User21Type organization = User21Type._('Organization');

static const User21Type mannequin = User21Type._('Mannequin');

static const List<User21Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User21Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User21Type($value)'; } 
 }
@immutable final class User21 {const User21({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User21.fromJson(Map<String, dynamic> json) { return User21(
  ...
  type: json['type'] != null ? User21Type.fromJson(json['type'] as String) : null,
...
User21 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User21Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User21(
