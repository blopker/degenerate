...
case 302:
return const ReposGetContentError302();
case 304:
return const ReposGetContentError304();
case 403:
final json = jsonDecode(response.body);
return ReposGetContentError403(BasicError.fromJson(json as Map<String, dynamic>));
case 404:
final json = jsonDecode(response.body);
return ReposGetContentError404(BasicError.fromJson(json as Map<String, dynamic>));
default:
