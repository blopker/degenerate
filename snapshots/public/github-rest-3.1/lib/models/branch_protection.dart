...
import 'branch_protection_allow_deletions.dart';import 'branch_protection_allow_force_pushes.dart';import 'branch_protection_allow_fork_syncing.dart';import 'branch_protection_block_creations.dart';import 'branch_protection_lock_branch.dart';import 'branch_protection_required_conversation_resolution.dart';import 'branch_protection_required_linear_history.dart';import 'branch_protection_required_signatures.dart';import 'branch_restriction_policy.dart';import 'protected_branch_admin_enforced.dart';import 'protected_branch_pull_request_review.dart';import 'protected_branch_required_status_check.dart';/// Branch Protection
final class BranchProtection {const BranchProtection({this.url, this.enabled, this.requiredStatusChecks, this.enforceAdmins, this.requiredPullRequestReviews, this.restrictions, this.requiredLinearHistory, this.allowForcePushes, this.allowDeletions, this.blockCreations, this.requiredConversationResolution, this.name, this.protectionUrl, this.requiredSignatures, this.lockBranch, this.allowForkSyncing, });
...
final BranchProtectionRequiredConversationResolution? requiredConversationResolution;
