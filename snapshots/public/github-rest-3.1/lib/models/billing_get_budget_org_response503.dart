...
BillingGetBudgetOrgResponse503 copyWith({String Function()? code, String Function()? message, String Function()? documentationUrl, }) { return BillingGetBudgetOrgResponse503(
  code: code != null ? code() : this.code,
  message: message != null ? message() : this.message,
  documentationUrl: documentationUrl != null ? documentationUrl() : this.documentationUrl,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BillingGetBudgetOrgResponse503 &&
          code == other.code &&
          message == other.message &&
          documentationUrl == other.documentationUrl; } 
@override int get hashCode { return Object.hash(code, message, documentationUrl); } 
@override String toString() { return 'BillingGetBudgetOrgResponse503(code: $code, message: $message, documentationUrl: $documentationUrl)'; } 
 }
