...
@immutable final class WebhookStatusCommitCommitCommitter {const WebhookStatusCommitCommitCommitter({required this.date, required this.email, required this.name, this.username, });
