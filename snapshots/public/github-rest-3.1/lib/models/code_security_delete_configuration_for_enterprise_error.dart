...
return  CodeSecurityDeleteConfigurationForEnterpriseError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); } else if (responseMediaTypeMatches(contentType, 'application/scim+json', )) {
final json = jsonDecode(response.body);
return  CodeSecurityDeleteConfigurationForEnterpriseError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>)); } else {
final json = jsonDecode(response.body);
return  CodeSecurityDeleteConfigurationForEnterpriseError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); }case 403:
final json = jsonDecode(response.body);
return  CodeSecurityDeleteConfigurationForEnterpriseError403(BasicError.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  CodeSecurityDeleteConfigurationForEnterpriseError404(BasicError.fromJson(json as Map<String, dynamic>));case 409:
final json = jsonDecode(response.body);
return  CodeSecurityDeleteConfigurationForEnterpriseError409(BasicError.fromJson(json as Map<String, dynamic>));default:
