...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_synchronize_pull_request_base_repo_license.dart';import 'webhook_pull_request_synchronize_pull_request_base_repo_owner.dart';import 'webhook_pull_request_synchronize_pull_request_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestSynchronizePullRequestBaseRepoVisibility {const WebhookPullRequestSynchronizePullRequestBaseRepoVisibility._(this.value);

factory WebhookPullRequestSynchronizePullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestSynchronizePullRequestBaseRepoVisibility public = WebhookPullRequestSynchronizePullRequestBaseRepoVisibility._('public');

static const WebhookPullRequestSynchronizePullRequestBaseRepoVisibility private = WebhookPullRequestSynchronizePullRequestBaseRepoVisibility._('private');

static const WebhookPullRequestSynchronizePullRequestBaseRepoVisibility internal = WebhookPullRequestSynchronizePullRequestBaseRepoVisibility._('internal');

static const List<WebhookPullRequestSynchronizePullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestSynchronizePullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestBaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestSynchronizePullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestSynchronizePullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestSynchronizePullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestSynchronizePullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestSynchronizePullRequestBaseRepoOwner? owner;

final WebhookPullRequestSynchronizePullRequestBaseRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestSynchronizePullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestSynchronizePullRequestBaseRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestBaseRepo &&
