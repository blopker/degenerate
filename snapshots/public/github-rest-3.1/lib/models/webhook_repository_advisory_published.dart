...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_advisory.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';final class WebhookRepositoryAdvisoryPublishedAction {const WebhookRepositoryAdvisoryPublishedAction._(this.value);
...
final class WebhookRepositoryAdvisoryPublished {const WebhookRepositoryAdvisoryPublished({required this.action, this.enterprise, this.installation, this.organization, required this.repository, required this.repositoryAdvisory, this.sender, });
