...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksPullRequest5BaseRepoOwnerType {const WebhooksPullRequest5BaseRepoOwnerType._(this.value);

factory WebhooksPullRequest5BaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksPullRequest5BaseRepoOwnerType bot = WebhooksPullRequest5BaseRepoOwnerType._('Bot');

static const WebhooksPullRequest5BaseRepoOwnerType user = WebhooksPullRequest5BaseRepoOwnerType._('User');

static const WebhooksPullRequest5BaseRepoOwnerType organization = WebhooksPullRequest5BaseRepoOwnerType._('Organization');

static const List<WebhooksPullRequest5BaseRepoOwnerType> values = [bot, user, organization];
...
factory WebhooksPullRequest5BaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5BaseRepoOwner(
  ...
  type: json['type'] != null ? WebhooksPullRequest5BaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhooksPullRequest5BaseRepoOwnerType? type;
...
WebhooksPullRequest5BaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksPullRequest5BaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksPullRequest5BaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5BaseRepoOwner &&
