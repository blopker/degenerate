...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPageBuildBuildPusherType {const WebhookPageBuildBuildPusherType._(this.value);

factory WebhookPageBuildBuildPusherType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPageBuildBuildPusherType bot = WebhookPageBuildBuildPusherType._('Bot');

static const WebhookPageBuildBuildPusherType user = WebhookPageBuildBuildPusherType._('User');

static const WebhookPageBuildBuildPusherType organization = WebhookPageBuildBuildPusherType._('Organization');

static const List<WebhookPageBuildBuildPusherType> values = [bot, user, organization];
...
factory WebhookPageBuildBuildPusher.fromJson(Map<String, dynamic> json) { return WebhookPageBuildBuildPusher(
  ...
  type: json['type'] != null ? WebhookPageBuildBuildPusherType.fromJson(json['type'] as String) : null,
...
final WebhookPageBuildBuildPusherType? type;
...
WebhookPageBuildBuildPusher copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPageBuildBuildPusherType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPageBuildBuildPusher(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPageBuildBuildPusher &&
...
@override String toString() { return 'WebhookPageBuildBuildPusher(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
