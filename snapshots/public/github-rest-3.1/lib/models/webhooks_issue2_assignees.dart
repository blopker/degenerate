...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksIssue2AssigneesType {const WebhooksIssue2AssigneesType._(this.value);

factory WebhooksIssue2AssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksIssue2AssigneesType bot = WebhooksIssue2AssigneesType._('Bot');

static const WebhooksIssue2AssigneesType user = WebhooksIssue2AssigneesType._('User');

static const WebhooksIssue2AssigneesType organization = WebhooksIssue2AssigneesType._('Organization');

static const List<WebhooksIssue2AssigneesType> values = [bot, user, organization];
...
@override String toString() { return 'WebhooksIssue2AssigneesType($value)'; } 
 }
@immutable final class WebhooksIssue2Assignees {const WebhooksIssue2Assignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksIssue2Assignees.fromJson(Map<String, dynamic> json) { return WebhooksIssue2Assignees(
  ...
  type: json['type'] != null ? WebhooksIssue2AssigneesType.fromJson(json['type'] as String) : null,
...
final WebhooksIssue2AssigneesType? type;
...
WebhooksIssue2Assignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksIssue2AssigneesType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksIssue2Assignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksIssue2Assignees &&
...
@override String toString() { return 'WebhooksIssue2Assignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
