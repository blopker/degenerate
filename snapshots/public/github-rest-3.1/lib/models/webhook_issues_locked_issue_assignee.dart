...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLockedIssueAssigneeType {const WebhookIssuesLockedIssueAssigneeType._(this.value);

factory WebhookIssuesLockedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLockedIssueAssigneeType bot = WebhookIssuesLockedIssueAssigneeType._('Bot');

static const WebhookIssuesLockedIssueAssigneeType user = WebhookIssuesLockedIssueAssigneeType._('User');

static const WebhookIssuesLockedIssueAssigneeType organization = WebhookIssuesLockedIssueAssigneeType._('Organization');

static const List<WebhookIssuesLockedIssueAssigneeType> values = [bot, user, organization];
...
factory WebhookIssuesLockedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesLockedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesLockedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLockedIssueAssigneeType? type;
...
WebhookIssuesLockedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLockedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLockedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLockedIssueAssignee &&
