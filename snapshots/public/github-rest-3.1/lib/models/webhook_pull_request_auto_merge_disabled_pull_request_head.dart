...
/// A git repository
final WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo repo;

final String sha;

final WebhookPullRequestAutoMergeDisabledPullRequestHeadUser? user;
...
WebhookPullRequestAutoMergeDisabledPullRequestHead copyWith({String? label, String? ref, WebhookPullRequestAutoMergeDisabledPullRequestHeadRepo? repo, String? sha, WebhookPullRequestAutoMergeDisabledPullRequestHeadUser? Function()? user, }) { return WebhookPullRequestAutoMergeDisabledPullRequestHead(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequestHead &&
          label == other.label &&
          ref == other.ref &&
          repo == other.repo &&
          sha == other.sha &&
...
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestHead(label: $label, ref: $ref, repo: $repo, sha: $sha, user: $user)'; } 
 }
