...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookStatusCommitCommitterType {const WebhookStatusCommitCommitterType._(this.value);

factory WebhookStatusCommitCommitterType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookStatusCommitCommitterType bot = WebhookStatusCommitCommitterType._('Bot');

static const WebhookStatusCommitCommitterType user = WebhookStatusCommitCommitterType._('User');

static const WebhookStatusCommitCommitterType organization = WebhookStatusCommitCommitterType._('Organization');

static const List<WebhookStatusCommitCommitterType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookStatusCommitCommitterType($value)'; } 
 }
@immutable final class WebhookStatusCommitCommitter {const WebhookStatusCommitCommitter({this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookStatusCommitCommitter.fromJson(Map<String, dynamic> json) { return WebhookStatusCommitCommitter(
  ...
  type: json['type'] != null ? WebhookStatusCommitCommitterType.fromJson(json['type'] as String) : null,
...
final WebhookStatusCommitCommitterType? type;
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'avatar_url', 'deleted', 'email', 'events_url', 'followers_url', 'following_url', 'gists_url', 'gravatar_id', 'html_url', 'id', 'login', 'name', 'node_id', 'organizations_url', 'received_events_url', 'repos_url', 'site_admin', 'starred_url', 'subscriptions_url', 'type', 'url'}.contains(key)); } 
WebhookStatusCommitCommitter copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? Function()? id, String? Function()? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookStatusCommitCommitterType? Function()? type, Uri? Function()? url, }) { return WebhookStatusCommitCommitter(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookStatusCommitCommitter &&
...
@override String toString() { return 'WebhookStatusCommitCommitter(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
