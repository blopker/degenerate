...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookProjectEditedChangesBody {const WebhookProjectEditedChangesBody({required this.from});
