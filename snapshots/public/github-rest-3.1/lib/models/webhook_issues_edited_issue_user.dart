...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesEditedIssueUserType {const WebhookIssuesEditedIssueUserType._(this.value);

factory WebhookIssuesEditedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesEditedIssueUserType bot = WebhookIssuesEditedIssueUserType._('Bot');

static const WebhookIssuesEditedIssueUserType user = WebhookIssuesEditedIssueUserType._('User');

static const WebhookIssuesEditedIssueUserType organization = WebhookIssuesEditedIssueUserType._('Organization');

static const WebhookIssuesEditedIssueUserType mannequin = WebhookIssuesEditedIssueUserType._('Mannequin');

static const List<WebhookIssuesEditedIssueUserType> values = [bot, user, organization, mannequin];
...
@override String toString() { return 'WebhookIssuesEditedIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesEditedIssueUser {const WebhookIssuesEditedIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesEditedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesEditedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesEditedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesEditedIssueUserType? type;
...
WebhookIssuesEditedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesEditedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesEditedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesEditedIssueUser &&
...
@override String toString() { return 'WebhookIssuesEditedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
