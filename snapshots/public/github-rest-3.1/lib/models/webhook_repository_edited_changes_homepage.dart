...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookRepositoryEditedChangesHomepage {const WebhookRepositoryEditedChangesHomepage({required this.from});
