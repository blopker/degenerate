...
ContentSymlinkLinks copyWith({Uri? Function()? git, Uri? Function()? html, Uri? self, }) { return ContentSymlinkLinks(
  git: git != null ? git() : this.git,
  html: html != null ? html() : this.html,
  self: self ?? this.self,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ContentSymlinkLinks &&
          git == other.git &&
          html == other.html &&
          self == other.self; } 
@override int get hashCode { return Object.hash(git, html, self); } 
@override String toString() { return 'ContentSymlinkLinks(git: $git, html: $html, self: $self)'; } 
 }
