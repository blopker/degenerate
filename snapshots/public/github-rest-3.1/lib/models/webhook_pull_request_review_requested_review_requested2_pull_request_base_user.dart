...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType bot = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType user = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType._('User');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType organization = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType? type;
...
WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseUser &&
