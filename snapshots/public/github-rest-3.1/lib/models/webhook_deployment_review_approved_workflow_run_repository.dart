...
factory WebhookDeploymentReviewApprovedWorkflowRunRepository.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewApprovedWorkflowRunRepository(
  ...
  owner: json['owner'] != null ? WebhookDeploymentReviewApprovedWorkflowRunRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
...
final WebhookDeploymentReviewApprovedWorkflowRunRepositoryOwner? owner;
