...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLockedPullRequestHeadUserType {const WebhookPullRequestLockedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestLockedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestLockedPullRequestHeadUserType bot = WebhookPullRequestLockedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestLockedPullRequestHeadUserType user = WebhookPullRequestLockedPullRequestHeadUserType._('User');

static const WebhookPullRequestLockedPullRequestHeadUserType organization = WebhookPullRequestLockedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestLockedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestLockedPullRequestHeadUser {const WebhookPullRequestLockedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLockedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLockedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestLockedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLockedPullRequestHeadUserType? type;
...
WebhookPullRequestLockedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLockedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLockedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLockedPullRequestHeadUser &&
