...
final class WebhookIssuesDeletedIssuePullRequest {const WebhookIssuesDeletedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
