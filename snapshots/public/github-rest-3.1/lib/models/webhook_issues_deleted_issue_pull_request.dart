...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDeletedIssuePullRequest {const WebhookIssuesDeletedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssuesDeletedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssuePullRequest(
...
WebhookIssuesDeletedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssuesDeletedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDeletedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssuesDeletedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
