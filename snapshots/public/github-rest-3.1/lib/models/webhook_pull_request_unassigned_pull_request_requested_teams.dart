...
factory WebhookPullRequestUnassignedPullRequestRequestedTeams.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestRequestedTeams(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? WebhookPullRequestUnassignedPullRequestRequestedTeamsParent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookPullRequestUnassignedPullRequestRequestedTeamsParent?> parent;
...
WebhookPullRequestUnassignedPullRequestRequestedTeams copyWith({bool? Function()? deleted, Omittable<String?>? description, Uri? Function()? htmlUrl, int? id, String? Function()? membersUrl, String? name, String? Function()? nodeId, Omittable<WebhookPullRequestUnassignedPullRequestRequestedTeamsParent?>? parent, String? Function()? permission, WebhookPullRequestUnassignedPullRequestRequestedTeamsPrivacy? Function()? privacy, Uri? Function()? repositoriesUrl, String? Function()? slug, Uri? Function()? url, }) { return WebhookPullRequestUnassignedPullRequestRequestedTeams(
