...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestSynchronizePullRequestBaseUserType {const WebhookPullRequestSynchronizePullRequestBaseUserType._(this.value);

factory WebhookPullRequestSynchronizePullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestSynchronizePullRequestBaseUserType bot = WebhookPullRequestSynchronizePullRequestBaseUserType._('Bot');

static const WebhookPullRequestSynchronizePullRequestBaseUserType user = WebhookPullRequestSynchronizePullRequestBaseUserType._('User');

static const WebhookPullRequestSynchronizePullRequestBaseUserType organization = WebhookPullRequestSynchronizePullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestSynchronizePullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestSynchronizePullRequestBaseUser {const WebhookPullRequestSynchronizePullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestSynchronizePullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestSynchronizePullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestSynchronizePullRequestBaseUserType? type;
...
WebhookPullRequestSynchronizePullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestSynchronizePullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestSynchronizePullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestBaseUser &&
...
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
