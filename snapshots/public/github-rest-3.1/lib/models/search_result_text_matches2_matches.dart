...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class SearchResultTextMatches2Matches {const SearchResultTextMatches2Matches({this.text, this.indices, });
