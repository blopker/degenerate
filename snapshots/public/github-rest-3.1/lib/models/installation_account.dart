...
final class InstallationAccount {
  const InstallationAccount({this.simpleUser = const Omittable.absent(),
this.enterprise = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InstallationAccount._({required this.rawValue, required this.simpleUser,
required this.enterprise,});
  factory InstallationAccount.fromJson(Object? json) => InstallationAccount._(
...
final Omittable<Enterprise> enterprise;
  ...
  bool get isValid => (rawValue.isPresent && rawValue.value == null) || simpleUser.isPresent || enterprise.isPresent;
...
if (enterprise.isPresent) enterprise.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InstallationAccount && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InstallationAccount(${toJson()})';
}
