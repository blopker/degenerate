...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType user = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner &&
