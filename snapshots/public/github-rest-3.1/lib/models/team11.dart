...
@immutable final class Team11 {const Team11({required this.id, required this.name, this.deleted, this.description = const Omittable.absent(), this.htmlUrl, this.membersUrl, this.nodeId, this.parent = const Omittable.absent(), this.permission, this.privacy, this.repositoriesUrl, this.slug, this.url, });
...
factory Team11.fromJson(Map<String, dynamic> json) { return Team11(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? Team11Parent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<Team11Parent?> parent;
...
Team11 copyWith({bool? Function()? deleted, Omittable<String?>? description, Uri? Function()? htmlUrl, int? id, String? Function()? membersUrl, String? name, String? Function()? nodeId, Omittable<Team11Parent?>? parent, String? Function()? permission, Team11Privacy? Function()? privacy, Uri? Function()? repositoriesUrl, String? Function()? slug, Uri? Function()? url, }) { return Team11(
