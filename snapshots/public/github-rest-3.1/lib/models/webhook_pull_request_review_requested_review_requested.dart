...
final class WebhookPullRequestReviewRequestedReviewRequested {const WebhookPullRequestReviewRequestedReviewRequested({required this.action, this.enterprise, this.installation, required this.number, this.organization, required this.pullRequest, required this.repository, required this.requestedReviewer, required this.sender, });
