...
return  GitCreateTagError409(BasicError.fromJson(json as Map<String, dynamic>));case 422:
final json = jsonDecode(response.body);
return  GitCreateTagError422(ValidationError.fromJson(json as Map<String, dynamic>));default:
