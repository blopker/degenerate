...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesUnlockedIssueAssigneesType {const WebhookIssuesUnlockedIssueAssigneesType._(this.value);

factory WebhookIssuesUnlockedIssueAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesUnlockedIssueAssigneesType bot = WebhookIssuesUnlockedIssueAssigneesType._('Bot');

static const WebhookIssuesUnlockedIssueAssigneesType user = WebhookIssuesUnlockedIssueAssigneesType._('User');

static const WebhookIssuesUnlockedIssueAssigneesType organization = WebhookIssuesUnlockedIssueAssigneesType._('Organization');

static const List<WebhookIssuesUnlockedIssueAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesUnlockedIssueAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesUnlockedIssueAssigneesType($value)'; } 
 }
@immutable final class WebhookIssuesUnlockedIssueAssignees {const WebhookIssuesUnlockedIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesUnlockedIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesUnlockedIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesUnlockedIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesUnlockedIssueAssigneesType? type;
...
WebhookIssuesUnlockedIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesUnlockedIssueAssigneesType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesUnlockedIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssueAssignees &&
...
@override String toString() { return 'WebhookIssuesUnlockedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
