...
WebhookIssueCommentCreatedIssue copyWith({String? Function()? activeLockReason, WebhookIssueCommentCreatedIssueAssignee? Function()? assignee, List<Map<String,dynamic>?>? assignees, String? authorAssociation, String? Function()? body, String? Function()? closedAt, int? comments, String? commentsUrl, String? createdAt, bool? Function()? draft, String? eventsUrl, String? htmlUrl, int? id, List<WebhookIssueCommentCreatedIssueLabels>? labels, String? labelsUrl, bool? locked, Map<String, dynamic>? Function()? milestone, String? nodeId, int? number, Omittable<Map<String,dynamic>?>? performedViaGithubApp, WebhookIssueCommentCreatedIssuePullRequest? Function()? pullRequest, WebhookIssueCommentCreatedIssueReactions? reactions, String? repositoryUrl, SubIssuesSummary? Function()? subIssuesSummary, IssueDependenciesSummary? Function()? issueDependenciesSummary, WebhookIssueCommentCreatedIssueState? state, Omittable<String?>? stateReason, String? Function()? timelineUrl, String? title, Omittable<IssueType?>? type, String? updatedAt, String? url, WebhookIssueCommentCreatedIssueUser? user, }) {return WebhookIssueCommentCreatedIssue(
