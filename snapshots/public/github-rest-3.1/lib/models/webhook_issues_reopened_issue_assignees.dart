...
final class WebhookIssuesReopenedIssueAssigneesType {const WebhookIssuesReopenedIssueAssigneesType._(this.value);
...
static const WebhookIssuesReopenedIssueAssigneesType user = WebhookIssuesReopenedIssueAssigneesType._('User');

static const WebhookIssuesReopenedIssueAssigneesType organization = WebhookIssuesReopenedIssueAssigneesType._('Organization');

static const WebhookIssuesReopenedIssueAssigneesType mannequin = WebhookIssuesReopenedIssueAssigneesType._('Mannequin');

static const List<WebhookIssuesReopenedIssueAssigneesType> values = [bot, user, organization, mannequin];
...
final WebhookIssuesReopenedIssueAssigneesType? type;
...
WebhookIssuesReopenedIssueAssignees copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookIssuesReopenedIssueAssigneesType Function()? type, Uri Function()? url, }) { return WebhookIssuesReopenedIssueAssignees(
