...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType {const WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType bot = WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType user = WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType organization = WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestAssignees {const WebhookPullRequestReviewCommentDeletedPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookPullRequestReviewCommentDeletedPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestReviewCommentDeletedPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestAssignees &&
