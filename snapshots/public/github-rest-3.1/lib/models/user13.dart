...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User13Type {const User13Type._(this.value);

factory User13Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User13Type bot = User13Type._('Bot');

static const User13Type user = User13Type._('User');

static const User13Type organization = User13Type._('Organization');

static const User13Type mannequin = User13Type._('Mannequin');

static const List<User13Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User13Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User13Type($value)'; } 
 }
@immutable final class User13 {const User13({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User13.fromJson(Map<String, dynamic> json) { return User13(
  ...
  type: json['type'] != null ? User13Type.fromJson(json['type'] as String) : null,
...
User13 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User13Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User13(
