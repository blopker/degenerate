...
return BillingGetGithubBillingPremiumRequestUsageReportUserError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>));
}
if (responseMediaTypeMatches(contentType, 'application/scim+json')) {
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>));
}
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>));
...
case 403:
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError403(BasicError.fromJson(json as Map<String, dynamic>));
case 404:
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError404(BasicError.fromJson(json as Map<String, dynamic>));
case 500:
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError500(BasicError.fromJson(json as Map<String, dynamic>));
case 503:
final json = jsonDecode(response.body);
return BillingGetGithubBillingPremiumRequestUsageReportUserError503(BillingGetGithubBillingPremiumRequestUsageReportUserResponse503.fromJson(json as Map<String, dynamic>));
default:
