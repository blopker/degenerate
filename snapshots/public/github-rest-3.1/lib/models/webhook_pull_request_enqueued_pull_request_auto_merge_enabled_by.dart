...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType {const WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType bot = WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType user = WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType organization = WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy {const WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy &&
...
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
