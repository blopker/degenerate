...
factory Team25ParentPrivacy.fromJson(String json) { return switch (json) {
  ...
  'closed' => closed,
  'secret' => secret,
  _ => Team25ParentPrivacy._(json),
}; }

static const Team25ParentPrivacy open = Team25ParentPrivacy._('open');

static const Team25ParentPrivacy closed = Team25ParentPrivacy._('closed');

static const Team25ParentPrivacy secret = Team25ParentPrivacy._('secret');

static const List<Team25ParentPrivacy> values = [open, closed, secret];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is Team25ParentPrivacy && other.value == value; } 
...
factory Team25Parent.fromJson(Map<String, dynamic> json) { return Team25Parent(
  ...
  privacy: Team25ParentPrivacy.fromJson(json['privacy'] as String),
...
final Team25ParentPrivacy privacy;
...
Team25Parent copyWith({String? Function()? description, Uri? htmlUrl, int? id, String? membersUrl, String? name, String? nodeId, String? permission, Team25ParentPrivacy? privacy, Uri? repositoriesUrl, String? slug, Uri? url, }) { return Team25Parent(
...
@override String toString() { return 'Team25Parent(description: $description, htmlUrl: $htmlUrl, id: $id, membersUrl: $membersUrl, name: $name, nodeId: $nodeId, permission: $permission, privacy: $privacy, repositoriesUrl: $repositoriesUrl, slug: $slug, url: $url)'; } 
 }
