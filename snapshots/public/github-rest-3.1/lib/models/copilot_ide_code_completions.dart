...
final class CopilotIdeCodeCompletions {const CopilotIdeCodeCompletions({this.totalEngagedUsers, this.languages, this.editors, this.additionalProperties = const {}, });
