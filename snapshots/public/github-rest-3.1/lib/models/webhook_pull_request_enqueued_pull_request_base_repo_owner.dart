...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType {const WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType bot = WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType user = WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType organization = WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestBaseRepoOwner {const WebhookPullRequestEnqueuedPullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestEnqueuedPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestEnqueuedPullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestEnqueuedPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestBaseRepoOwner &&
...
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
