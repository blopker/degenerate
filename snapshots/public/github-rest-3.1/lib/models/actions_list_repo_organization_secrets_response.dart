...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'actions_secret.dart';@immutable final class ActionsListRepoOrganizationSecretsResponse {const ActionsListRepoOrganizationSecretsResponse({required this.totalCount, required this.secrets, });
...
@override String toString() { return 'ActionsListRepoOrganizationSecretsResponse(totalCount: $totalCount, secrets: $secrets)'; } 
 }
