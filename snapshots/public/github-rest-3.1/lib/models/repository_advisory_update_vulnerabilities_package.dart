...
@immutable final class RepositoryAdvisoryUpdateVulnerabilitiesPackage {const RepositoryAdvisoryUpdateVulnerabilitiesPackage({required this.ecosystem, this.name, });
