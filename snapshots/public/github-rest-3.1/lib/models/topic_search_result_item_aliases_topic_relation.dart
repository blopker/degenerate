...
TopicSearchResultItemAliasesTopicRelation copyWith({int Function()? id, String Function()? name, int Function()? topicId, String Function()? relationType, }) { return TopicSearchResultItemAliasesTopicRelation(
...
@override String toString() { return 'TopicSearchResultItemAliasesTopicRelation(id: $id, name: $name, topicId: $topicId, relationType: $relationType)'; } 
 }
