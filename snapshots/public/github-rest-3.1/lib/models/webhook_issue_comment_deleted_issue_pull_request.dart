...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentDeletedIssuePullRequest {const WebhookIssueCommentDeletedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssueCommentDeletedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentDeletedIssuePullRequest(
...
WebhookIssueCommentDeletedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssueCommentDeletedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentDeletedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssueCommentDeletedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
