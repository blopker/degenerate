...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewSubmittedPullRequestAssigneeType {const WebhookPullRequestReviewSubmittedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewSubmittedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewSubmittedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewSubmittedPullRequestAssigneeType bot = WebhookPullRequestReviewSubmittedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewSubmittedPullRequestAssigneeType user = WebhookPullRequestReviewSubmittedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewSubmittedPullRequestAssigneeType organization = WebhookPullRequestReviewSubmittedPullRequestAssigneeType._('Organization');

static const WebhookPullRequestReviewSubmittedPullRequestAssigneeType mannequin = WebhookPullRequestReviewSubmittedPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestReviewSubmittedPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewSubmittedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewSubmittedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewSubmittedPullRequestAssignee {const WebhookPullRequestReviewSubmittedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewSubmittedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewSubmittedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewSubmittedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewSubmittedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewSubmittedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewSubmittedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewSubmittedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewSubmittedPullRequestAssignee &&
