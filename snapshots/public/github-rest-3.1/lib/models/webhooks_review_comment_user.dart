...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksReviewCommentUserType {const WebhooksReviewCommentUserType._(this.value);

factory WebhooksReviewCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhooksReviewCommentUserType._(json),
}; }

static const WebhooksReviewCommentUserType bot = WebhooksReviewCommentUserType._('Bot');

static const WebhooksReviewCommentUserType user = WebhooksReviewCommentUserType._('User');

static const WebhooksReviewCommentUserType organization = WebhooksReviewCommentUserType._('Organization');

static const List<WebhooksReviewCommentUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksReviewCommentUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksReviewCommentUserType($value)'; } 
 }
@immutable final class WebhooksReviewCommentUser {const WebhooksReviewCommentUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksReviewCommentUser.fromJson(Map<String, dynamic> json) { return WebhooksReviewCommentUser(
  ...
  type: json['type'] != null ? WebhooksReviewCommentUserType.fromJson(json['type'] as String) : null,
...
final WebhooksReviewCommentUserType? type;
...
WebhooksReviewCommentUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksReviewCommentUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksReviewCommentUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksReviewCommentUser &&
...
@override String toString() { return 'WebhooksReviewCommentUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
