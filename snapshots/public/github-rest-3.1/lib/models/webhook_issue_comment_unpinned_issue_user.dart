...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentUnpinnedIssueUser {const WebhookIssueCommentUnpinnedIssueUser({this.avatarUrl, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentUnpinnedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentUnpinnedIssueUser(
...
WebhookIssueCommentUnpinnedIssueUser copyWith({String Function()? avatarUrl, String Function()? eventsUrl, String Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, String Function()? htmlUrl, int Function()? id, String Function()? login, String Function()? nodeId, String Function()? organizationsUrl, String Function()? receivedEventsUrl, String Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, String Function()? subscriptionsUrl, String Function()? type, String Function()? url, String Function()? userViewType, }) { return WebhookIssueCommentUnpinnedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentUnpinnedIssueUser &&
