...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDeletedIssueUserType {const WebhookIssuesDeletedIssueUserType._(this.value);

factory WebhookIssuesDeletedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesDeletedIssueUserType bot = WebhookIssuesDeletedIssueUserType._('Bot');

static const WebhookIssuesDeletedIssueUserType user = WebhookIssuesDeletedIssueUserType._('User');

static const WebhookIssuesDeletedIssueUserType organization = WebhookIssuesDeletedIssueUserType._('Organization');

static const List<WebhookIssuesDeletedIssueUserType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookIssuesDeletedIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesDeletedIssueUser {const WebhookIssuesDeletedIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesDeletedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesDeletedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDeletedIssueUserType? type;
...
WebhookIssuesDeletedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDeletedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDeletedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDeletedIssueUser &&
...
@override String toString() { return 'WebhookIssuesDeletedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
