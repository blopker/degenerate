...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_pull_request5_base_repo_license.dart';import 'webhooks_pull_request5_base_repo_owner.dart';import 'webhooks_pull_request5_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhooksPullRequest5BaseRepoPullRequestCreationPolicy {const WebhooksPullRequest5BaseRepoPullRequestCreationPolicy._(this.value);

factory WebhooksPullRequest5BaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhooksPullRequest5BaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhooksPullRequest5BaseRepoPullRequestCreationPolicy all = WebhooksPullRequest5BaseRepoPullRequestCreationPolicy._('all');

static const WebhooksPullRequest5BaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhooksPullRequest5BaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhooksPullRequest5BaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5BaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5BaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhooksPullRequest5BaseRepoSquashMergeCommitMessage {const WebhooksPullRequest5BaseRepoSquashMergeCommitMessage._(this.value);

factory WebhooksPullRequest5BaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const WebhooksPullRequest5BaseRepoSquashMergeCommitMessage prBody = WebhooksPullRequest5BaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhooksPullRequest5BaseRepoSquashMergeCommitMessage commitMessages = WebhooksPullRequest5BaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhooksPullRequest5BaseRepoSquashMergeCommitMessage blank = WebhooksPullRequest5BaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhooksPullRequest5BaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5BaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5BaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhooksPullRequest5BaseRepoSquashMergeCommitTitle {const WebhooksPullRequest5BaseRepoSquashMergeCommitTitle._(this.value);

factory WebhooksPullRequest5BaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhooksPullRequest5BaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhooksPullRequest5BaseRepoSquashMergeCommitTitle prTitle = WebhooksPullRequest5BaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhooksPullRequest5BaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhooksPullRequest5BaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhooksPullRequest5BaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5BaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5BaseRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory WebhooksPullRequest5BaseRepo.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5BaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhooksPullRequest5BaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhooksPullRequest5BaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhooksPullRequest5BaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhooksPullRequest5BaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhooksPullRequest5BaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhooksPullRequest5BaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhooksPullRequest5BaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhooksPullRequest5BaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhooksPullRequest5BaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhooksPullRequest5BaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhooksPullRequest5BaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhooksPullRequest5BaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhooksPullRequest5BaseRepoOwner? owner;

final WebhooksPullRequest5BaseRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhooksPullRequest5BaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhooksPullRequest5BaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhooksPullRequest5BaseRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5BaseRepo &&
