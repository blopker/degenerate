...
factory WebhookWorkflowRunCompletedWorkflowRunHeadCommit.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunHeadCommit(
  ...
  committer: WebhookWorkflowRunCompletedWorkflowRunHeadCommitCommitter.fromJson(json['committer'] as Map<String, dynamic>),
...
final WebhookWorkflowRunCompletedWorkflowRunHeadCommitAuthor author;

/// Metaproperties for Git author/committer information.
final WebhookWorkflowRunCompletedWorkflowRunHeadCommitCommitter committer;
...
WebhookWorkflowRunCompletedWorkflowRunHeadCommit copyWith({WebhookWorkflowRunCompletedWorkflowRunHeadCommitAuthor? author, WebhookWorkflowRunCompletedWorkflowRunHeadCommitCommitter? committer, String? id, String? message, String? timestamp, String? treeId, }) { return WebhookWorkflowRunCompletedWorkflowRunHeadCommit(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunCompletedWorkflowRunHeadCommit &&
          author == other.author &&
...
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunHeadCommit(author: $author, committer: $committer, id: $id, message: $message, timestamp: $timestamp, treeId: $treeId)'; } 
 }
