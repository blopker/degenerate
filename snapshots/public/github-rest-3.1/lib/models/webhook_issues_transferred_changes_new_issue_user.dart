...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesTransferredChangesNewIssueUserType {const WebhookIssuesTransferredChangesNewIssueUserType._(this.value);

factory WebhookIssuesTransferredChangesNewIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesTransferredChangesNewIssueUserType bot = WebhookIssuesTransferredChangesNewIssueUserType._('Bot');

static const WebhookIssuesTransferredChangesNewIssueUserType user = WebhookIssuesTransferredChangesNewIssueUserType._('User');

static const WebhookIssuesTransferredChangesNewIssueUserType organization = WebhookIssuesTransferredChangesNewIssueUserType._('Organization');

static const List<WebhookIssuesTransferredChangesNewIssueUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesTransferredChangesNewIssueUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesTransferredChangesNewIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesTransferredChangesNewIssueUser {const WebhookIssuesTransferredChangesNewIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesTransferredChangesNewIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesTransferredChangesNewIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesTransferredChangesNewIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesTransferredChangesNewIssueUserType? type;
...
WebhookIssuesTransferredChangesNewIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesTransferredChangesNewIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesTransferredChangesNewIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesTransferredChangesNewIssueUser &&
...
@override String toString() { return 'WebhookIssuesTransferredChangesNewIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
