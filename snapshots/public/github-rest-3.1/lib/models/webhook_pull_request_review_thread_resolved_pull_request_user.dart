...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestUserType {const WebhookPullRequestReviewThreadResolvedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewThreadResolvedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestReviewThreadResolvedPullRequestUserType bot = WebhookPullRequestReviewThreadResolvedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewThreadResolvedPullRequestUserType user = WebhookPullRequestReviewThreadResolvedPullRequestUserType._('User');

static const WebhookPullRequestReviewThreadResolvedPullRequestUserType organization = WebhookPullRequestReviewThreadResolvedPullRequestUserType._('Organization');

static const WebhookPullRequestReviewThreadResolvedPullRequestUserType mannequin = WebhookPullRequestReviewThreadResolvedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewThreadResolvedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadResolvedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadResolvedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestUser {const WebhookPullRequestReviewThreadResolvedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadResolvedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadResolvedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadResolvedPullRequestUserType? type;
...
WebhookPullRequestReviewThreadResolvedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadResolvedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadResolvedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadResolvedPullRequestUser &&
