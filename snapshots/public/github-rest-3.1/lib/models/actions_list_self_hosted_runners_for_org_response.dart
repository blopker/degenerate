...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'runner.dart';@immutable final class ActionsListSelfHostedRunnersForOrgResponse {const ActionsListSelfHostedRunnersForOrgResponse({required this.totalCount, required this.runners, });
