...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_request_removed_review_request_removed_pull_request_head_repo_license.dart';import 'webhook_pull_request_review_request_removed_review_request_removed_pull_request_head_repo_owner.dart';import 'webhook_pull_request_review_request_removed_review_request_removed_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility public = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility private = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility internal = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility($value)'; } 
 }
/// A git repository
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo({this.allowAutoMerge = false, this.allowForking, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowSquashMerge = true, this.allowUpdateBranch, required this.archiveUrl, this.archived = false, required this.assigneesUrl, required this.blobsUrl, required this.branchesUrl, required this.cloneUrl, required this.collaboratorsUrl, required this.commentsUrl, required this.commitsUrl, required this.compareUrl, required this.contentsUrl, required this.contributorsUrl, required this.createdAt, required this.defaultBranch, this.deleteBranchOnMerge = false, required this.deploymentsUrl, required this.description, this.disabled, required this.downloadsUrl, required this.eventsUrl, required this.fork, required this.forks, required this.forksCount, required this.forksUrl, required this.fullName, required this.gitCommitsUrl, required this.gitRefsUrl, required this.gitTagsUrl, required this.gitUrl, this.hasDownloads = true, this.hasIssues = true, required this.hasPages, this.hasProjects = true, this.hasWiki = true, this.hasDiscussions = false, this.hasPullRequests = true, this.pullRequestCreationPolicy, required this.homepage, required this.hooksUrl, required this.htmlUrl, required this.id, this.isTemplate, required this.issueCommentUrl, required this.issueEventsUrl, required this.issuesUrl, required this.keysUrl, required this.labelsUrl, required this.language, required this.languagesUrl, required this.license, this.masterBranch, this.mergeCommitMessage, this.mergeCommitTitle, required this.mergesUrl, required this.milestonesUrl, required this.mirrorUrl, required this.name, required this.nodeId, required this.notificationsUrl, required this.openIssues, required this.openIssuesCount, this.organization, required this.owner, this.permissions, required this.private, this.public, required this.pullsUrl, required this.pushedAt, required this.releasesUrl, this.roleName, required this.size, this.squashMergeCommitMessage, this.squashMergeCommitTitle, required this.sshUrl, this.stargazers, required this.stargazersCount, required this.stargazersUrl, required this.statusesUrl, required this.subscribersUrl, required this.subscriptionUrl, required this.svnUrl, required this.tagsUrl, required this.teamsUrl, required this.topics, required this.treesUrl, required this.updatedAt, required this.url, this.useSquashPrTitleAsDefault = false, required this.visibility, required this.watchers, required this.watchersCount, this.webCommitSignoffRequired, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility visibility;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner? Function()? owner, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo &&
