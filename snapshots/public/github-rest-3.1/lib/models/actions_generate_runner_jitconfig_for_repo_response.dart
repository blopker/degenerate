...
import 'runner.dart';final class ActionsGenerateRunnerJitconfigForRepoResponse {const ActionsGenerateRunnerJitconfigForRepoResponse({required this.runner, required this.encodedJitConfig, });
