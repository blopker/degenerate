...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLockedIssueUserType {const WebhookIssuesLockedIssueUserType._(this.value);

factory WebhookIssuesLockedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLockedIssueUserType bot = WebhookIssuesLockedIssueUserType._('Bot');

static const WebhookIssuesLockedIssueUserType user = WebhookIssuesLockedIssueUserType._('User');

static const WebhookIssuesLockedIssueUserType organization = WebhookIssuesLockedIssueUserType._('Organization');

static const List<WebhookIssuesLockedIssueUserType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookIssuesLockedIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesLockedIssueUser {const WebhookIssuesLockedIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLockedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesLockedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesLockedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLockedIssueUserType? type;
...
WebhookIssuesLockedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLockedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLockedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLockedIssueUser &&
