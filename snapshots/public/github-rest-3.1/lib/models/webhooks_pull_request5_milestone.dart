...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_pull_request5_milestone_creator.dart';/// The state of the milestone.
@immutable final class WebhooksPullRequest5MilestoneState {const WebhooksPullRequest5MilestoneState._(this.value);
...
factory WebhooksPullRequest5Milestone.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5Milestone(
  ...
  state: WebhooksPullRequest5MilestoneState.fromJson(json['state'] as String),
...
final WebhooksPullRequest5MilestoneCreator? creator;
...
final WebhooksPullRequest5MilestoneState state;
...
WebhooksPullRequest5Milestone copyWith({DateTime? Function()? closedAt, int? closedIssues, DateTime? createdAt, WebhooksPullRequest5MilestoneCreator? Function()? creator, String? Function()? description, DateTime? Function()? dueOn, Uri? htmlUrl, int? id, Uri? labelsUrl, String? nodeId, int? number, int? openIssues, WebhooksPullRequest5MilestoneState? state, String? title, DateTime? updatedAt, Uri? url, }) { return WebhooksPullRequest5Milestone(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5Milestone &&
