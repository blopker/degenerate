...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamCreatedRepositoryOwnerType {const WebhookTeamCreatedRepositoryOwnerType._(this.value);

factory WebhookTeamCreatedRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookTeamCreatedRepositoryOwnerType._(json),
}; }

static const WebhookTeamCreatedRepositoryOwnerType bot = WebhookTeamCreatedRepositoryOwnerType._('Bot');

static const WebhookTeamCreatedRepositoryOwnerType user = WebhookTeamCreatedRepositoryOwnerType._('User');

static const WebhookTeamCreatedRepositoryOwnerType organization = WebhookTeamCreatedRepositoryOwnerType._('Organization');

static const List<WebhookTeamCreatedRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookTeamCreatedRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookTeamCreatedRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookTeamCreatedRepositoryOwner {const WebhookTeamCreatedRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookTeamCreatedRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookTeamCreatedRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookTeamCreatedRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookTeamCreatedRepositoryOwnerType? type;
...
WebhookTeamCreatedRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookTeamCreatedRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookTeamCreatedRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamCreatedRepositoryOwner &&
