...
case 304:
return  const ProjectsListForOrgError304();case 401:
final json = jsonDecode(response.body);
return  ProjectsListForOrgError401(BasicError.fromJson(json as Map<String, dynamic>));case 403:
final json = jsonDecode(response.body);
return  ProjectsListForOrgError403(BasicError.fromJson(json as Map<String, dynamic>));default:
