...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class StatusUpdateEditedChangesBody {const StatusUpdateEditedChangesBody({this.from = const Omittable.absent(), this.to = const Omittable.absent(), });
...
StatusUpdateEditedChangesBody copyWith({Omittable<String?>? from, Omittable<String?>? to, }) { return StatusUpdateEditedChangesBody(
  from: from ?? this.from,
  to: to ?? this.to,
); } 
