...
factory WebhooksPullRequest5.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5(
  ...
  mergedBy: json.containsKey('merged_by') ? Omittable(json['merged_by'] != null ? WebhooksPullRequest5MergedBy.fromJson(json['merged_by'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhooksPullRequest5MergedBy?> mergedBy;
