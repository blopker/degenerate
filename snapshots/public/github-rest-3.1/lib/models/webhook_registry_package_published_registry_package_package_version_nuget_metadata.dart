...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_registry_package_published_registry_package_package_version_nuget_metadata_id.dart';import 'webhook_registry_package_published_registry_package_package_version_nuget_metadata_value.dart';import 'webhook_registry_package_published_registry_package_package_version_nuget_metadata_value_variant4.dart';@immutable final class WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadata {const WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadata({this.id, this.name, this.value, });
