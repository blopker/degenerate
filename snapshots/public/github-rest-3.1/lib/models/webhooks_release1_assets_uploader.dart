...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksRelease1AssetsUploaderType {const WebhooksRelease1AssetsUploaderType._(this.value);

factory WebhooksRelease1AssetsUploaderType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksRelease1AssetsUploaderType bot = WebhooksRelease1AssetsUploaderType._('Bot');

static const WebhooksRelease1AssetsUploaderType user = WebhooksRelease1AssetsUploaderType._('User');

static const WebhooksRelease1AssetsUploaderType organization = WebhooksRelease1AssetsUploaderType._('Organization');

static const List<WebhooksRelease1AssetsUploaderType> values = [bot, user, organization];
...
factory WebhooksRelease1AssetsUploader.fromJson(Map<String, dynamic> json) { return WebhooksRelease1AssetsUploader(
  ...
  type: json['type'] != null ? WebhooksRelease1AssetsUploaderType.fromJson(json['type'] as String) : null,
...
final WebhooksRelease1AssetsUploaderType? type;
...
WebhooksRelease1AssetsUploader copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksRelease1AssetsUploaderType? Function()? type, Uri? Function()? url, }) { return WebhooksRelease1AssetsUploader(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksRelease1AssetsUploader &&
...
@override String toString() { return 'WebhooksRelease1AssetsUploader(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
