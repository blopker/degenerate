...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamAddedToRepositoryRepositoryOwnerType {const WebhookTeamAddedToRepositoryRepositoryOwnerType._(this.value);

factory WebhookTeamAddedToRepositoryRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookTeamAddedToRepositoryRepositoryOwnerType._(json),
}; }

static const WebhookTeamAddedToRepositoryRepositoryOwnerType bot = WebhookTeamAddedToRepositoryRepositoryOwnerType._('Bot');

static const WebhookTeamAddedToRepositoryRepositoryOwnerType user = WebhookTeamAddedToRepositoryRepositoryOwnerType._('User');

static const WebhookTeamAddedToRepositoryRepositoryOwnerType organization = WebhookTeamAddedToRepositoryRepositoryOwnerType._('Organization');

static const List<WebhookTeamAddedToRepositoryRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookTeamAddedToRepositoryRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookTeamAddedToRepositoryRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookTeamAddedToRepositoryRepositoryOwner {const WebhookTeamAddedToRepositoryRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookTeamAddedToRepositoryRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookTeamAddedToRepositoryRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookTeamAddedToRepositoryRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookTeamAddedToRepositoryRepositoryOwnerType? type;
...
WebhookTeamAddedToRepositoryRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookTeamAddedToRepositoryRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookTeamAddedToRepositoryRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamAddedToRepositoryRepositoryOwner &&
...
@override String toString() { return 'WebhookTeamAddedToRepositoryRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
