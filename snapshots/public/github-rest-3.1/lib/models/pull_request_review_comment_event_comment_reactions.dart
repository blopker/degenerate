...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PullRequestReviewCommentEventCommentReactions {const PullRequestReviewCommentEventCommentReactions({this.plus1, this.minus1, this.confused, this.eyes, this.heart, this.hooray, this.laugh, this.rocket, this.totalCount, this.url, });

factory PullRequestReviewCommentEventCommentReactions.fromJson(Map<String, dynamic> json) { return PullRequestReviewCommentEventCommentReactions(
...
PullRequestReviewCommentEventCommentReactions copyWith({int Function()? plus1, int Function()? minus1, int Function()? confused, int Function()? eyes, int Function()? heart, int Function()? hooray, int Function()? laugh, int Function()? rocket, int Function()? totalCount, Uri Function()? url, }) { return PullRequestReviewCommentEventCommentReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PullRequestReviewCommentEventCommentReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'PullRequestReviewCommentEventCommentReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
