...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentStatusCreatedDeploymentCreatorType {const WebhookDeploymentStatusCreatedDeploymentCreatorType._(this.value);

factory WebhookDeploymentStatusCreatedDeploymentCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentStatusCreatedDeploymentCreatorType._(json),
}; }

static const WebhookDeploymentStatusCreatedDeploymentCreatorType bot = WebhookDeploymentStatusCreatedDeploymentCreatorType._('Bot');

static const WebhookDeploymentStatusCreatedDeploymentCreatorType user = WebhookDeploymentStatusCreatedDeploymentCreatorType._('User');

static const WebhookDeploymentStatusCreatedDeploymentCreatorType organization = WebhookDeploymentStatusCreatedDeploymentCreatorType._('Organization');

static const List<WebhookDeploymentStatusCreatedDeploymentCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedDeploymentCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedDeploymentCreatorType($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedDeploymentCreator {const WebhookDeploymentStatusCreatedDeploymentCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentStatusCreatedDeploymentCreator.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedDeploymentCreator(
  ...
  type: json['type'] != null ? WebhookDeploymentStatusCreatedDeploymentCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentStatusCreatedDeploymentCreatorType? type;
...
WebhookDeploymentStatusCreatedDeploymentCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentStatusCreatedDeploymentCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentStatusCreatedDeploymentCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedDeploymentCreator &&
...
@override String toString() { return 'WebhookDeploymentStatusCreatedDeploymentCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
