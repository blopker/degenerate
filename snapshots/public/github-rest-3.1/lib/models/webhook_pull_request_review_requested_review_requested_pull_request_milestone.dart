...
import 'webhook_pull_request_review_requested_review_requested_pull_request_milestone_creator.dart';/// The state of the milestone.
final class WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState {const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState._(this.value);
...
static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState closed = WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState._('closed');

static const List<WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState> values = [open, closed];
...
factory WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestone.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestone(
  ...
  creator: json['creator'] != null ? WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneCreator.fromJson(json['creator'] as Map<String, dynamic>) : null,
  ...
  state: WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState.fromJson(json['state'] as String),
...
final WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneCreator? creator;
...
final WebhookPullRequestReviewRequestedReviewRequestedPullRequestMilestoneState state;
