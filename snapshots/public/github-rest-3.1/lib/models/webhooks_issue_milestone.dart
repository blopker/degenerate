...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_issue_milestone_creator.dart';/// The state of the milestone.
@immutable final class WebhooksIssueMilestoneState {const WebhooksIssueMilestoneState._(this.value);
...
factory WebhooksIssueMilestone.fromJson(Map<String, dynamic> json) { return WebhooksIssueMilestone(
  ...
  creator: json['creator'] != null ? WebhooksIssueMilestoneCreator.fromJson(json['creator'] as Map<String, dynamic>) : null,
  ...
  state: WebhooksIssueMilestoneState.fromJson(json['state'] as String),
...
final WebhooksIssueMilestoneCreator? creator;
...
final WebhooksIssueMilestoneState state;
...
WebhooksIssueMilestone copyWith({DateTime? Function()? closedAt, int? closedIssues, DateTime? createdAt, WebhooksIssueMilestoneCreator? Function()? creator, String? Function()? description, DateTime? Function()? dueOn, Uri? htmlUrl, int? id, Uri? labelsUrl, String? nodeId, int? number, int? openIssues, WebhooksIssueMilestoneState? state, String? title, DateTime? updatedAt, Uri? url, }) { return WebhooksIssueMilestone(
