...
static const WebhookIssueCommentEditedIssueState open = WebhookIssueCommentEditedIssueState._('open');

static const WebhookIssueCommentEditedIssueState closed = WebhookIssueCommentEditedIssueState._('closed');

static const List<WebhookIssueCommentEditedIssueState> values = [open, closed];
...
factory WebhookIssueCommentEditedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentEditedIssue(
  ...
  assignee: json['assignee'] != null ? WebhookIssueCommentEditedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null,
  ...
  labels: (json['labels'] as List<dynamic>).map((e) => WebhookIssueCommentEditedIssueLabels.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  pullRequest: json['pull_request'] != null ? WebhookIssueCommentEditedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>) : null,
  reactions: WebhookIssueCommentEditedIssueReactions.fromJson(json['reactions'] as Map<String, dynamic>),
  ...
  state: WebhookIssueCommentEditedIssueState.fromJson(json['state'] as String),
  ...
  user: WebhookIssueCommentEditedIssueUser.fromJson(json['user'] as Map<String, dynamic>),
); }

final String? activeLockReason;

final WebhookIssueCommentEditedIssueAssignee? assignee;
...
final List<WebhookIssueCommentEditedIssueLabels> labels;
...
final WebhookIssueCommentEditedIssuePullRequest? pullRequest;

final WebhookIssueCommentEditedIssueReactions reactions;
...
final WebhookIssueCommentEditedIssueState state;
...
final WebhookIssueCommentEditedIssueUser user;
...
WebhookIssueCommentEditedIssue copyWith({String? Function()? activeLockReason, WebhookIssueCommentEditedIssueAssignee? Function()? assignee, List<Map<String,dynamic>?>? assignees, String? authorAssociation, String? Function()? body, String? Function()? closedAt, int? comments, String? commentsUrl, String? createdAt, bool? Function()? draft, String? eventsUrl, String? htmlUrl, int? id, List<WebhookIssueCommentEditedIssueLabels>? labels, String? labelsUrl, bool? locked, Map<String, dynamic>? Function()? milestone, String? nodeId, int? number, Omittable<Map<String,dynamic>?>? performedViaGithubApp, WebhookIssueCommentEditedIssuePullRequest? Function()? pullRequest, WebhookIssueCommentEditedIssueReactions? reactions, String? repositoryUrl, SubIssuesSummary? Function()? subIssuesSummary, IssueDependenciesSummary? Function()? issueDependenciesSummary, WebhookIssueCommentEditedIssueState? state, Omittable<String?>? stateReason, String? Function()? timelineUrl, String? title, Omittable<IssueType?>? type, String? updatedAt, String? url, WebhookIssueCommentEditedIssueUser? user, }) { return WebhookIssueCommentEditedIssue(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentEditedIssue &&
