...
return  DependabotCreateOrUpdateOrgSecretSuccess201(EmptyObject.fromJson(json as Map<String, dynamic>));case 204:
return  const DependabotCreateOrUpdateOrgSecretSuccess204();default:
