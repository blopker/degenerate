...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ContentTreeEntriesLinks {const ContentTreeEntriesLinks({required this.git, required this.html, required this.self, });
