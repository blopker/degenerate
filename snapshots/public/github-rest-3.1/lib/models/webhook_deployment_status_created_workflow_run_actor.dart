...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentStatusCreatedWorkflowRunActorType {const WebhookDeploymentStatusCreatedWorkflowRunActorType._(this.value);

factory WebhookDeploymentStatusCreatedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentStatusCreatedWorkflowRunActorType._(json),
}; }

static const WebhookDeploymentStatusCreatedWorkflowRunActorType bot = WebhookDeploymentStatusCreatedWorkflowRunActorType._('Bot');

static const WebhookDeploymentStatusCreatedWorkflowRunActorType user = WebhookDeploymentStatusCreatedWorkflowRunActorType._('User');

static const WebhookDeploymentStatusCreatedWorkflowRunActorType organization = WebhookDeploymentStatusCreatedWorkflowRunActorType._('Organization');

static const List<WebhookDeploymentStatusCreatedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedWorkflowRunActor {const WebhookDeploymentStatusCreatedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentStatusCreatedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookDeploymentStatusCreatedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentStatusCreatedWorkflowRunActorType? type;
...
WebhookDeploymentStatusCreatedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentStatusCreatedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentStatusCreatedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedWorkflowRunActor &&
...
@override String toString() { return 'WebhookDeploymentStatusCreatedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
