...
final class WebhookCheckRunCreatedFormEncoded {const WebhookCheckRunCreatedFormEncoded({required this.payload});
...
@override String toString() { return 'WebhookCheckRunCreatedFormEncoded(payload: $payload)'; } 
 }
