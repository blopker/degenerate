...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentEditedIssueAssigneeType {const WebhookIssueCommentEditedIssueAssigneeType._(this.value);

factory WebhookIssueCommentEditedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssueCommentEditedIssueAssigneeType bot = WebhookIssueCommentEditedIssueAssigneeType._('Bot');

static const WebhookIssueCommentEditedIssueAssigneeType user = WebhookIssueCommentEditedIssueAssigneeType._('User');

static const WebhookIssueCommentEditedIssueAssigneeType organization = WebhookIssueCommentEditedIssueAssigneeType._('Organization');

static const WebhookIssueCommentEditedIssueAssigneeType mannequin = WebhookIssueCommentEditedIssueAssigneeType._('Mannequin');

static const List<WebhookIssueCommentEditedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentEditedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentEditedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssueCommentEditedIssueAssignee {const WebhookIssueCommentEditedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentEditedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentEditedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssueCommentEditedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentEditedIssueAssigneeType? type;
...
WebhookIssueCommentEditedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentEditedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentEditedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentEditedIssueAssignee &&
