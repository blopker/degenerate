...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewDismissedPullRequestBaseUserType {const WebhookPullRequestReviewDismissedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewDismissedPullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewDismissedPullRequestBaseUserType bot = WebhookPullRequestReviewDismissedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewDismissedPullRequestBaseUserType user = WebhookPullRequestReviewDismissedPullRequestBaseUserType._('User');

static const WebhookPullRequestReviewDismissedPullRequestBaseUserType organization = WebhookPullRequestReviewDismissedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewDismissedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewDismissedPullRequestBaseUser {const WebhookPullRequestReviewDismissedPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewDismissedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewDismissedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewDismissedPullRequestBaseUserType? type;
...
WebhookPullRequestReviewDismissedPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewDismissedPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewDismissedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewDismissedPullRequestBaseUser &&
