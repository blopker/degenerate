...
final class WebhookIssuesLabeledIssuePullRequest {const WebhookIssuesLabeledIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
