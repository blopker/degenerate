...
import 'enterprise_webhooks.dart';import 'issue_type.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhooks_issue.dart';final class WebhookIssuesUntypedAction {const WebhookIssuesUntypedAction._(this.value);
...
final class WebhookIssuesUntyped {const WebhookIssuesUntyped({required this.action, this.enterprise, this.installation, required this.issue, required this.type, this.organization, required this.repository, required this.sender, });
