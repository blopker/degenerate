...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesMilestonedIssueAssigneesType {const WebhookIssuesMilestonedIssueAssigneesType._(this.value);

factory WebhookIssuesMilestonedIssueAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesMilestonedIssueAssigneesType._(json),
}; }

static const WebhookIssuesMilestonedIssueAssigneesType bot = WebhookIssuesMilestonedIssueAssigneesType._('Bot');

static const WebhookIssuesMilestonedIssueAssigneesType user = WebhookIssuesMilestonedIssueAssigneesType._('User');

static const WebhookIssuesMilestonedIssueAssigneesType organization = WebhookIssuesMilestonedIssueAssigneesType._('Organization');

static const List<WebhookIssuesMilestonedIssueAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesMilestonedIssueAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesMilestonedIssueAssigneesType($value)'; } 
 }
@immutable final class WebhookIssuesMilestonedIssueAssignees {const WebhookIssuesMilestonedIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssuesMilestonedIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesMilestonedIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesMilestonedIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesMilestonedIssueAssigneesType? type;
...
WebhookIssuesMilestonedIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesMilestonedIssueAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookIssuesMilestonedIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesMilestonedIssueAssignees &&
