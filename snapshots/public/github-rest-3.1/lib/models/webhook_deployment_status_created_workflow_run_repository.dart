...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_deployment_status_created_workflow_run_repository_owner.dart';@immutable final class WebhookDeploymentStatusCreatedWorkflowRunRepository {const WebhookDeploymentStatusCreatedWorkflowRunRepository({this.forksUrl, this.assigneesUrl, this.blobsUrl, this.branchesUrl, this.collaboratorsUrl, this.commentsUrl, this.commitsUrl, this.compareUrl, this.contentsUrl, this.contributorsUrl, this.deploymentsUrl, this.description, this.downloadsUrl, this.eventsUrl, this.fork, this.archiveUrl, this.fullName, this.gitCommitsUrl, this.gitRefsUrl, this.gitTagsUrl, this.hooksUrl, this.htmlUrl, this.id, this.issueCommentUrl, this.issueEventsUrl, this.issuesUrl, this.keysUrl, this.labelsUrl, this.languagesUrl, this.url, this.milestonesUrl, this.name, this.nodeId, this.notificationsUrl, this.owner, this.private, this.pullsUrl, this.releasesUrl, this.stargazersUrl, this.statusesUrl, this.subscribersUrl, this.subscriptionUrl, this.tagsUrl, this.teamsUrl, this.treesUrl, this.mergesUrl, });

factory WebhookDeploymentStatusCreatedWorkflowRunRepository.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedWorkflowRunRepository(
  ...
  owner: json['owner'] != null ? WebhookDeploymentStatusCreatedWorkflowRunRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
...
final WebhookDeploymentStatusCreatedWorkflowRunRepositoryOwner? owner;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedWorkflowRunRepository &&
