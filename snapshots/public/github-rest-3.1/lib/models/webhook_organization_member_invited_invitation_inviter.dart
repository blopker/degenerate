...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookOrganizationMemberInvitedInvitationInviterType {const WebhookOrganizationMemberInvitedInvitationInviterType._(this.value);

factory WebhookOrganizationMemberInvitedInvitationInviterType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookOrganizationMemberInvitedInvitationInviterType bot = WebhookOrganizationMemberInvitedInvitationInviterType._('Bot');

static const WebhookOrganizationMemberInvitedInvitationInviterType user = WebhookOrganizationMemberInvitedInvitationInviterType._('User');

static const WebhookOrganizationMemberInvitedInvitationInviterType organization = WebhookOrganizationMemberInvitedInvitationInviterType._('Organization');

static const List<WebhookOrganizationMemberInvitedInvitationInviterType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookOrganizationMemberInvitedInvitationInviterType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookOrganizationMemberInvitedInvitationInviterType($value)'; } 
 }
@immutable final class WebhookOrganizationMemberInvitedInvitationInviter {const WebhookOrganizationMemberInvitedInvitationInviter({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookOrganizationMemberInvitedInvitationInviter.fromJson(Map<String, dynamic> json) { return WebhookOrganizationMemberInvitedInvitationInviter(
  ...
  type: json['type'] != null ? WebhookOrganizationMemberInvitedInvitationInviterType.fromJson(json['type'] as String) : null,
...
final WebhookOrganizationMemberInvitedInvitationInviterType? type;
...
WebhookOrganizationMemberInvitedInvitationInviter copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookOrganizationMemberInvitedInvitationInviterType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookOrganizationMemberInvitedInvitationInviter(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookOrganizationMemberInvitedInvitationInviter &&
