...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType {const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType bot = WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType user = WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType organization = WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator {const WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewSubmittedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewSubmittedPullRequestMilestoneCreator &&
