...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType {const WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType bot = WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType user = WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType organization = WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner {const WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestBaseRepoOwner &&
