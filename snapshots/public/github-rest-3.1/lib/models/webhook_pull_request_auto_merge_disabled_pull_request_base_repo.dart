...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_auto_merge_disabled_pull_request_base_repo_license.dart';import 'webhook_pull_request_auto_merge_disabled_pull_request_base_repo_owner.dart';import 'webhook_pull_request_auto_merge_disabled_pull_request_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
...
factory WebhookPullRequestAutoMergeDisabledPullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequestBaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoOwner? owner;

final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestAutoMergeDisabledPullRequestBaseRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequestBaseRepo &&
