...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'actions_variable.dart';@immutable final class ActionsListRepoOrganizationVariablesResponse {const ActionsListRepoOrganizationVariablesResponse({required this.totalCount, required this.variables, });
...
@override String toString() { return 'ActionsListRepoOrganizationVariablesResponse(totalCount: $totalCount, variables: $variables)'; } 
 }
