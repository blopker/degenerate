...
final class WorkflowRun {const WorkflowRun({required this.id, this.name, required this.nodeId, this.checkSuiteId, this.checkSuiteNodeId, required this.headBranch, required this.headSha, required this.path, required this.runNumber, this.runAttempt, this.referencedWorkflows, required this.event, required this.status, required this.conclusion, required this.workflowId, required this.url, required this.htmlUrl, required this.pullRequests, required this.createdAt, required this.updatedAt, this.actor, this.triggeringActor, this.runStartedAt, required this.jobsUrl, required this.logsUrl, required this.checkSuiteUrl, required this.artifactsUrl, required this.cancelUrl, required this.rerunUrl, this.previousAttemptUrl, required this.workflowUrl, required this.headCommit, required this.repository, required this.headRepository, this.headRepositoryId, required this.displayTitle, });
