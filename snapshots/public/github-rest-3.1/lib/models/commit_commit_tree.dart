...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class CommitCommitTree {const CommitCommitTree({required this.sha, required this.url, });
