...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksPullRequest5AutoMergeEnabledByType {const WebhooksPullRequest5AutoMergeEnabledByType._(this.value);

factory WebhooksPullRequest5AutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhooksPullRequest5AutoMergeEnabledByType._(json),
}; }

static const WebhooksPullRequest5AutoMergeEnabledByType bot = WebhooksPullRequest5AutoMergeEnabledByType._('Bot');

static const WebhooksPullRequest5AutoMergeEnabledByType user = WebhooksPullRequest5AutoMergeEnabledByType._('User');

static const WebhooksPullRequest5AutoMergeEnabledByType organization = WebhooksPullRequest5AutoMergeEnabledByType._('Organization');

static const List<WebhooksPullRequest5AutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5AutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5AutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhooksPullRequest5AutoMergeEnabledBy {const WebhooksPullRequest5AutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksPullRequest5AutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5AutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhooksPullRequest5AutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhooksPullRequest5AutoMergeEnabledByType? type;
...
WebhooksPullRequest5AutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksPullRequest5AutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksPullRequest5AutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5AutoMergeEnabledBy &&
...
@override String toString() { return 'WebhooksPullRequest5AutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
