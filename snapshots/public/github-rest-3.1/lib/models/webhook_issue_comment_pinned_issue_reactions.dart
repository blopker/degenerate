...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentPinnedIssueReactions {const WebhookIssueCommentPinnedIssueReactions({this.plus1, this.minus1, this.confused, this.eyes, this.heart, this.hooray, this.laugh, this.rocket, this.totalCount, this.url, });

factory WebhookIssueCommentPinnedIssueReactions.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentPinnedIssueReactions(
...
WebhookIssueCommentPinnedIssueReactions copyWith({int Function()? plus1, int Function()? minus1, int Function()? confused, int Function()? eyes, int Function()? heart, int Function()? hooray, int Function()? laugh, int Function()? rocket, int Function()? totalCount, String Function()? url, }) { return WebhookIssueCommentPinnedIssueReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentPinnedIssueReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhookIssueCommentPinnedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
