...
WebhookStatusCommitCommitAuthor copyWith({String? date, String? email, String? name, String Function()? username, }) { return WebhookStatusCommitCommitAuthor(
  date: date ?? this.date,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookStatusCommitCommitAuthor &&
          date == other.date &&
          email == other.email &&
          name == other.name &&
          username == other.username; } 
@override int get hashCode { return Object.hash(date, email, name, username); } 
@override String toString() { return 'WebhookStatusCommitCommitAuthor(date: $date, email: $email, name: $name, username: $username)'; } 
 }
