...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentEditedPullRequestAssigneesType {const WebhookPullRequestReviewCommentEditedPullRequestAssigneesType._(this.value);

factory WebhookPullRequestReviewCommentEditedPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentEditedPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestReviewCommentEditedPullRequestAssigneesType bot = WebhookPullRequestReviewCommentEditedPullRequestAssigneesType._('Bot');

static const WebhookPullRequestReviewCommentEditedPullRequestAssigneesType user = WebhookPullRequestReviewCommentEditedPullRequestAssigneesType._('User');

static const WebhookPullRequestReviewCommentEditedPullRequestAssigneesType organization = WebhookPullRequestReviewCommentEditedPullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestReviewCommentEditedPullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentEditedPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentEditedPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentEditedPullRequestAssignees {const WebhookPullRequestReviewCommentEditedPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentEditedPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentEditedPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentEditedPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentEditedPullRequestAssigneesType? type;
...
WebhookPullRequestReviewCommentEditedPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentEditedPullRequestAssigneesType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentEditedPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentEditedPullRequestAssignees &&
