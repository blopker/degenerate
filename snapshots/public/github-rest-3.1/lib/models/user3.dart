...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User3Type {const User3Type._(this.value);

factory User3Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User3Type bot = User3Type._('Bot');

static const User3Type user = User3Type._('User');

static const User3Type organization = User3Type._('Organization');

static const User3Type mannequin = User3Type._('Mannequin');

static const List<User3Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User3Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User3Type($value)'; } 
 }
@immutable final class User3 {const User3({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User3.fromJson(Map<String, dynamic> json) { return User3(
  ...
  type: json['type'] != null ? User3Type.fromJson(json['type'] as String) : null,
...
User3 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User3Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User3(
