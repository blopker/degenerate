...
import 'package:collection/collection.dart';import 'repository_rule_params_required_reviewer_configuration.dart';final class RepositoryRulePullRequestParametersAllowedMergeMethods {const RepositoryRulePullRequestParametersAllowedMergeMethods._(this.value);
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RepositoryRulePullRequestParameters &&
          const ListEquality<dynamic>().equals(allowedMergeMethods, other.allowedMergeMethods) &&
          ...
          const ListEquality<dynamic>().equals(requiredReviewers, other.requiredReviewers); } 
