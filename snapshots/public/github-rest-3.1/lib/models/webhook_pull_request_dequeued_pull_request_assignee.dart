...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestDequeuedPullRequestAssigneeType {const WebhookPullRequestDequeuedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestDequeuedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestDequeuedPullRequestAssigneeType bot = WebhookPullRequestDequeuedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestDequeuedPullRequestAssigneeType user = WebhookPullRequestDequeuedPullRequestAssigneeType._('User');

static const WebhookPullRequestDequeuedPullRequestAssigneeType organization = WebhookPullRequestDequeuedPullRequestAssigneeType._('Organization');

static const List<WebhookPullRequestDequeuedPullRequestAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestDequeuedPullRequestAssignee {const WebhookPullRequestDequeuedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestDequeuedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestDequeuedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestDequeuedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestDequeuedPullRequestAssigneeType? type;
...
WebhookPullRequestDequeuedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestDequeuedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestDequeuedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestDequeuedPullRequestAssignee &&
...
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
