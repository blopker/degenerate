...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType {const WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType bot = WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType user = WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType organization = WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType._('Organization');

static const List<WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee {const WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadUnresolvedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadUnresolvedPullRequestAssignee &&
