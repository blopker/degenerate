...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewApprovedWorkflowRunActorType {const WebhookDeploymentReviewApprovedWorkflowRunActorType._(this.value);

factory WebhookDeploymentReviewApprovedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentReviewApprovedWorkflowRunActorType._(json),
}; }

static const WebhookDeploymentReviewApprovedWorkflowRunActorType bot = WebhookDeploymentReviewApprovedWorkflowRunActorType._('Bot');

static const WebhookDeploymentReviewApprovedWorkflowRunActorType user = WebhookDeploymentReviewApprovedWorkflowRunActorType._('User');

static const WebhookDeploymentReviewApprovedWorkflowRunActorType organization = WebhookDeploymentReviewApprovedWorkflowRunActorType._('Organization');

static const List<WebhookDeploymentReviewApprovedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewApprovedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewApprovedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewApprovedWorkflowRunActor {const WebhookDeploymentReviewApprovedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewApprovedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewApprovedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewApprovedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewApprovedWorkflowRunActorType? type;
...
WebhookDeploymentReviewApprovedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewApprovedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewApprovedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewApprovedWorkflowRunActor &&
...
@override String toString() { return 'WebhookDeploymentReviewApprovedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
