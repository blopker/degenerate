...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentEditedIssuePullRequest {const WebhookIssueCommentEditedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssueCommentEditedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentEditedIssuePullRequest(
...
WebhookIssueCommentEditedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssueCommentEditedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentEditedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssueCommentEditedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
