...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_dequeued_pull_request_head_repo_license.dart';import 'webhook_pull_request_dequeued_pull_request_head_repo_owner.dart';import 'webhook_pull_request_dequeued_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestDequeuedPullRequestHeadRepoVisibility {const WebhookPullRequestDequeuedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestDequeuedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestDequeuedPullRequestHeadRepoVisibility public = WebhookPullRequestDequeuedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestDequeuedPullRequestHeadRepoVisibility private = WebhookPullRequestDequeuedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestDequeuedPullRequestHeadRepoVisibility internal = WebhookPullRequestDequeuedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestDequeuedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestDequeuedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestDequeuedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestDequeuedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestDequeuedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestDequeuedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestDequeuedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestDequeuedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestDequeuedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestDequeuedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestDequeuedPullRequestHeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestDequeuedPullRequestHeadRepo &&
