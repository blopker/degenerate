...
WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense copyWith({String? key, String? name, String? nodeId, String? spdxId, Uri? Function()? url, }) { return WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense(
  key: key ?? this.key,
  name: name ?? this.name,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense &&
          key == other.key &&
          name == other.name &&
          nodeId == other.nodeId &&
          spdxId == other.spdxId &&
...
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestHeadRepoLicense(key: $key, name: $name, nodeId: $nodeId, spdxId: $spdxId, url: $url)'; } 
 }
