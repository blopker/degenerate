...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksApprover {const WebhooksApprover({this.avatarUrl, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksApprover.fromJson(Map<String, dynamic> json) { return WebhooksApprover(
...
WebhooksApprover copyWith({String Function()? avatarUrl, String Function()? eventsUrl, String Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, String Function()? htmlUrl, int Function()? id, String Function()? login, String Function()? nodeId, String Function()? organizationsUrl, String Function()? receivedEventsUrl, String Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, String Function()? subscriptionsUrl, String Function()? type, String Function()? url, String Function()? userViewType, }) { return WebhooksApprover(
...
@override String toString() { return 'WebhooksApprover(avatarUrl: $avatarUrl, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
