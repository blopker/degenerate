...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesMilestonedIssueReactions {const WebhookIssuesMilestonedIssueReactions({required this.plus1, required this.minus1, required this.confused, required this.eyes, required this.heart, required this.hooray, required this.laugh, required this.rocket, required this.totalCount, required this.url, });

factory WebhookIssuesMilestonedIssueReactions.fromJson(Map<String, dynamic> json) { return WebhookIssuesMilestonedIssueReactions(
...
WebhookIssuesMilestonedIssueReactions copyWith({int? plus1, int? minus1, int? confused, int? eyes, int? heart, int? hooray, int? laugh, int? rocket, int? totalCount, Uri? url, }) { return WebhookIssuesMilestonedIssueReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesMilestonedIssueReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhookIssuesMilestonedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
