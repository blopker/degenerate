...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType {const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType bot = WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType user = WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType organization = WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator {const WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentEditedPullRequestMilestoneCreator &&
