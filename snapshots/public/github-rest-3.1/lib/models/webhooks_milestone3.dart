...
factory WebhooksMilestone3State.fromJson(String json) { return switch (json) {
  'open' => open,
  'closed' => closed,
  _ => WebhooksMilestone3State._(json),
}; }

static const WebhooksMilestone3State open = WebhooksMilestone3State._('open');

static const WebhooksMilestone3State closed = WebhooksMilestone3State._('closed');

static const List<WebhooksMilestone3State> values = [open, closed];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksMilestone3State && other.value == value; } 
...
factory WebhooksMilestone3.fromJson(Map<String, dynamic> json) { return WebhooksMilestone3(
  ...
  state: WebhooksMilestone3State.fromJson(json['state'] as String),
...
final WebhooksMilestone3State state;
...
WebhooksMilestone3 copyWith({DateTime? Function()? closedAt, int? closedIssues, DateTime? createdAt, WebhooksMilestone3Creator? Function()? creator, String? Function()? description, DateTime? Function()? dueOn, Uri? htmlUrl, int? id, Uri? labelsUrl, String? nodeId, int? number, int? openIssues, WebhooksMilestone3State? state, String? title, DateTime? updatedAt, Uri? url, }) { return WebhooksMilestone3(
