...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType {const WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType bot = WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType user = WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType organization = WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestHeadUser {const WebhookPullRequestReviewCommentDeletedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentDeletedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentDeletedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestHeadUser &&
...
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
