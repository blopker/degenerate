...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestBaseRepoOwnerType {const WebhookPullRequestLabeledPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestLabeledPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestLabeledPullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestLabeledPullRequestBaseRepoOwnerType bot = WebhookPullRequestLabeledPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestLabeledPullRequestBaseRepoOwnerType user = WebhookPullRequestLabeledPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestLabeledPullRequestBaseRepoOwnerType organization = WebhookPullRequestLabeledPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestLabeledPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestBaseRepoOwner {const WebhookPullRequestLabeledPullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestLabeledPullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestBaseRepoOwner &&
...
@override String toString() { return 'WebhookPullRequestLabeledPullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
