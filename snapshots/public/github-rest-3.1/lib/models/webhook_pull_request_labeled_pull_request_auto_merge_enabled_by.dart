...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType {const WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType bot = WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType user = WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType organization = WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy {const WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy &&
