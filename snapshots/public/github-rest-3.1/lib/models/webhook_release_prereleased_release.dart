...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_release_prereleased_release_assets.dart';import 'webhook_release_prereleased_release_author.dart';import 'webhook_release_prereleased_release_reactions.dart';/// The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object.
final class WebhookReleasePrereleasedRelease {const WebhookReleasePrereleasedRelease({required this.assets, required this.assetsUrl, required this.author, required this.body, required this.createdAt, this.discussionUrl, required this.draft, required this.htmlUrl, required this.id, required this.immutable, required this.name, required this.nodeId, required this.prerelease, required this.publishedAt, this.reactions, required this.tagName, required this.tarballUrl, required this.targetCommitish, required this.uploadUrl, required this.updatedAt, required this.url, required this.zipballUrl, });

factory WebhookReleasePrereleasedRelease.fromJson(Map<String, dynamic> json) { return WebhookReleasePrereleasedRelease(
  assets: (json['assets'] as List<dynamic>).map((e) => WebhookReleasePrereleasedReleaseAssets.fromJson(e as Map<String, dynamic>)).toList(),
  assetsUrl: Uri.parse(json['assets_url'] as String),
  author: json['author'] != null ? WebhookReleasePrereleasedReleaseAuthor.fromJson(json['author'] as Map<String, dynamic>) : null,
...
final List<WebhookReleasePrereleasedReleaseAssets?> assets;

final Uri assetsUrl;

final WebhookReleasePrereleasedReleaseAuthor? author;
...
final WebhookReleasePrereleasedReleaseReactions? reactions;
...
WebhookReleasePrereleasedRelease copyWith({List<WebhookReleasePrereleasedReleaseAssets?>? assets, Uri? assetsUrl, WebhookReleasePrereleasedReleaseAuthor? Function()? author, String? Function()? body, DateTime? Function()? createdAt, Uri Function()? discussionUrl, bool? draft, Uri? htmlUrl, int? id, bool? immutable, String? Function()? name, String? nodeId, bool? prerelease, DateTime? Function()? publishedAt, WebhookReleasePrereleasedReleaseReactions Function()? reactions, String? tagName, Uri? Function()? tarballUrl, String? targetCommitish, String? uploadUrl, DateTime? Function()? updatedAt, Uri? url, Uri? Function()? zipballUrl, }) { return WebhookReleasePrereleasedRelease(
