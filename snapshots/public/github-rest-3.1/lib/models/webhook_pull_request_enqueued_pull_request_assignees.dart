...
factory WebhookPullRequestEnqueuedPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  ...
  _ => WebhookPullRequestEnqueuedPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestEnqueuedPullRequestAssigneesType bot = WebhookPullRequestEnqueuedPullRequestAssigneesType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestAssigneesType user = WebhookPullRequestEnqueuedPullRequestAssigneesType._('User');

static const WebhookPullRequestEnqueuedPullRequestAssigneesType organization = WebhookPullRequestEnqueuedPullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestEnqueuedPullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestAssignees {const WebhookPullRequestEnqueuedPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });
...
factory WebhookPullRequestEnqueuedPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestAssigneesType? type;
...
WebhookPullRequestEnqueuedPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestEnqueuedPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestAssignees &&
...
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
