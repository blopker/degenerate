...
import 'package:collection/collection.dart';final class WebhookBranchProtectionRuleEditedChangesRequiredStatusChecks {const WebhookBranchProtectionRuleEditedChangesRequiredStatusChecks({required this.from});
