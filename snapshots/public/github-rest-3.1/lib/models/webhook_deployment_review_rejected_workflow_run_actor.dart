...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewRejectedWorkflowRunActorType {const WebhookDeploymentReviewRejectedWorkflowRunActorType._(this.value);

factory WebhookDeploymentReviewRejectedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentReviewRejectedWorkflowRunActorType._(json),
}; }

static const WebhookDeploymentReviewRejectedWorkflowRunActorType bot = WebhookDeploymentReviewRejectedWorkflowRunActorType._('Bot');

static const WebhookDeploymentReviewRejectedWorkflowRunActorType user = WebhookDeploymentReviewRejectedWorkflowRunActorType._('User');

static const WebhookDeploymentReviewRejectedWorkflowRunActorType organization = WebhookDeploymentReviewRejectedWorkflowRunActorType._('Organization');

static const List<WebhookDeploymentReviewRejectedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewRejectedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewRejectedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewRejectedWorkflowRunActor {const WebhookDeploymentReviewRejectedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewRejectedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewRejectedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewRejectedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewRejectedWorkflowRunActorType? type;
...
WebhookDeploymentReviewRejectedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewRejectedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewRejectedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewRejectedWorkflowRunActor &&
...
@override String toString() { return 'WebhookDeploymentReviewRejectedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
