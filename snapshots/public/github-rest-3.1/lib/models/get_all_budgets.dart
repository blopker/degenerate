...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'budget.dart';final class GetAllBudgets {const GetAllBudgets({required this.budgets, this.hasNextPage, this.totalCount, });
