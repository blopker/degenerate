...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_team_deleted_repository_license.dart';import 'webhook_team_deleted_repository_owner.dart';import 'webhook_team_deleted_repository_permissions.dart';final class WebhookTeamDeletedRepositoryVisibility {const WebhookTeamDeletedRepositoryVisibility._(this.value);
...
static const WebhookTeamDeletedRepositoryVisibility private = WebhookTeamDeletedRepositoryVisibility._('private');

static const WebhookTeamDeletedRepositoryVisibility internal = WebhookTeamDeletedRepositoryVisibility._('internal');

static const List<WebhookTeamDeletedRepositoryVisibility> values = [public, private, internal];
...
factory WebhookTeamDeletedRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamDeletedRepository(
  ...
  license: json['license'] != null ? WebhookTeamDeletedRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookTeamDeletedRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookTeamDeletedRepositoryPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
...
final WebhookTeamDeletedRepositoryLicense? license;
...
final WebhookTeamDeletedRepositoryOwner? owner;

final WebhookTeamDeletedRepositoryPermissions? permissions;
...
final WebhookTeamDeletedRepositoryVisibility visibility;
