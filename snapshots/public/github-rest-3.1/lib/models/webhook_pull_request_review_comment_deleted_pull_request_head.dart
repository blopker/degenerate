...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_comment_deleted_pull_request_head_repo.dart';import 'webhook_pull_request_review_comment_deleted_pull_request_head_user.dart';@immutable final class WebhookPullRequestReviewCommentDeletedPullRequestHead {const WebhookPullRequestReviewCommentDeletedPullRequestHead({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
