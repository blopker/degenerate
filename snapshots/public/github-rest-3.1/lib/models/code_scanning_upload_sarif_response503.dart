...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class CodeScanningUploadSarifResponse503 {const CodeScanningUploadSarifResponse503({this.code, this.message, this.documentationUrl, });
