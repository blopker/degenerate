...
final class WebhookCheckSuiteRequestedCheckSuitePullRequestsBaseRepo {const WebhookCheckSuiteRequestedCheckSuitePullRequestsBaseRepo({required this.id, required this.name, required this.url, });
