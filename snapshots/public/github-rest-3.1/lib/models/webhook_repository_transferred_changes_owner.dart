...
import 'webhook_repository_transferred_changes_owner_from.dart';final class WebhookRepositoryTransferredChangesOwner {const WebhookRepositoryTransferredChangesOwner({required this.from});
