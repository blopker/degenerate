...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDeletedIssueAssigneeType {const WebhookIssuesDeletedIssueAssigneeType._(this.value);

factory WebhookIssuesDeletedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesDeletedIssueAssigneeType bot = WebhookIssuesDeletedIssueAssigneeType._('Bot');

static const WebhookIssuesDeletedIssueAssigneeType user = WebhookIssuesDeletedIssueAssigneeType._('User');

static const WebhookIssuesDeletedIssueAssigneeType organization = WebhookIssuesDeletedIssueAssigneeType._('Organization');

static const List<WebhookIssuesDeletedIssueAssigneeType> values = [bot, user, organization];
...
factory WebhookIssuesDeletedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesDeletedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDeletedIssueAssigneeType? type;
...
WebhookIssuesDeletedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDeletedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDeletedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDeletedIssueAssignee &&
...
@override String toString() { return 'WebhookIssuesDeletedIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
