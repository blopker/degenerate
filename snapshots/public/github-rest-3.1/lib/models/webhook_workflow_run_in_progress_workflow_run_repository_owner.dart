...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType {const WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType._(this.value);

factory WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType._(json),
}; }

static const WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType bot = WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType._('Bot');

static const WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType user = WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType._('User');

static const WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType organization = WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType._('Organization');

static const List<WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner {const WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType? type;
...
WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunInProgressWorkflowRunRepositoryOwnerType? Function()? type, Uri? Function()? url, }) { return WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunInProgressWorkflowRunRepositoryOwner &&
