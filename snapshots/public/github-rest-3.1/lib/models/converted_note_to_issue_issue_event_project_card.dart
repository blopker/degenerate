...
ConvertedNoteToIssueIssueEventProjectCard copyWith({int? id, Uri? url, int? projectId, Uri? projectUrl, String? columnName, String Function()? previousColumnName, }) { return ConvertedNoteToIssueIssueEventProjectCard(
  id: id ?? this.id,
  url: url ?? this.url,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ConvertedNoteToIssueIssueEventProjectCard &&
          id == other.id &&
          url == other.url &&
...
@override String toString() { return 'ConvertedNoteToIssueIssueEventProjectCard(id: $id, url: $url, projectId: $projectId, projectUrl: $projectUrl, columnName: $columnName, previousColumnName: $previousColumnName)'; } 
 }
