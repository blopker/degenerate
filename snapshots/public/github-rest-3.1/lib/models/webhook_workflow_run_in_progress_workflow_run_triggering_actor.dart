...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType {const WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType._(this.value);
...
factory WebhookWorkflowRunInProgressWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunInProgressWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType? type;
...
WebhookWorkflowRunInProgressWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, }) { return WebhookWorkflowRunInProgressWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunInProgressWorkflowRunTriggeringActor &&
