...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPackagePublishedPackagePackageVersionAuthorType {const WebhookPackagePublishedPackagePackageVersionAuthorType._(this.value);

factory WebhookPackagePublishedPackagePackageVersionAuthorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPackagePublishedPackagePackageVersionAuthorType._(json),
}; }

static const WebhookPackagePublishedPackagePackageVersionAuthorType bot = WebhookPackagePublishedPackagePackageVersionAuthorType._('Bot');

static const WebhookPackagePublishedPackagePackageVersionAuthorType user = WebhookPackagePublishedPackagePackageVersionAuthorType._('User');

static const WebhookPackagePublishedPackagePackageVersionAuthorType organization = WebhookPackagePublishedPackagePackageVersionAuthorType._('Organization');

static const List<WebhookPackagePublishedPackagePackageVersionAuthorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPackagePublishedPackagePackageVersionAuthorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPackagePublishedPackagePackageVersionAuthorType($value)'; } 
 }
@immutable final class WebhookPackagePublishedPackagePackageVersionAuthor {const WebhookPackagePublishedPackagePackageVersionAuthor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPackagePublishedPackagePackageVersionAuthor.fromJson(Map<String, dynamic> json) { return WebhookPackagePublishedPackagePackageVersionAuthor(
  ...
  type: json['type'] != null ? WebhookPackagePublishedPackagePackageVersionAuthorType.fromJson(json['type'] as String) : null,
...
final WebhookPackagePublishedPackagePackageVersionAuthorType? type;
...
WebhookPackagePublishedPackagePackageVersionAuthor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPackagePublishedPackagePackageVersionAuthorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPackagePublishedPackagePackageVersionAuthor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPackagePublishedPackagePackageVersionAuthor &&
