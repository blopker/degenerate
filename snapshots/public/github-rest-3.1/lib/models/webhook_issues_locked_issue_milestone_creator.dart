...
final class WebhookIssuesLockedIssueMilestoneCreatorType {const WebhookIssuesLockedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesLockedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLockedIssueMilestoneCreatorType bot = WebhookIssuesLockedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesLockedIssueMilestoneCreatorType user = WebhookIssuesLockedIssueMilestoneCreatorType._('User');

static const WebhookIssuesLockedIssueMilestoneCreatorType organization = WebhookIssuesLockedIssueMilestoneCreatorType._('Organization');

static const List<WebhookIssuesLockedIssueMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesLockedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesLockedIssueMilestoneCreatorType($value)'; } 
 }
final class WebhookIssuesLockedIssueMilestoneCreator {const WebhookIssuesLockedIssueMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLockedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesLockedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesLockedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLockedIssueMilestoneCreatorType? type;
...
WebhookIssuesLockedIssueMilestoneCreator copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookIssuesLockedIssueMilestoneCreatorType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookIssuesLockedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLockedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesLockedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
