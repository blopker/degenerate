...
ProtectedBranchRequiredSignatures copyWith({Uri? url, bool? enabled, }) { return ProtectedBranchRequiredSignatures(
  url: url ?? this.url,
...
@override String toString() { return 'ProtectedBranchRequiredSignatures(url: $url, enabled: $enabled)'; } 
 }
