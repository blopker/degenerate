...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAssignedPullRequestUserType {const WebhookPullRequestAssignedPullRequestUserType._(this.value);

factory WebhookPullRequestAssignedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestAssignedPullRequestUserType bot = WebhookPullRequestAssignedPullRequestUserType._('Bot');

static const WebhookPullRequestAssignedPullRequestUserType user = WebhookPullRequestAssignedPullRequestUserType._('User');

static const WebhookPullRequestAssignedPullRequestUserType organization = WebhookPullRequestAssignedPullRequestUserType._('Organization');

static const WebhookPullRequestAssignedPullRequestUserType mannequin = WebhookPullRequestAssignedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestAssignedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestAssignedPullRequestUser {const WebhookPullRequestAssignedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAssignedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAssignedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestAssignedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAssignedPullRequestUserType? type;
...
WebhookPullRequestAssignedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAssignedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAssignedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAssignedPullRequestUser &&
...
@override String toString() { return 'WebhookPullRequestAssignedPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
