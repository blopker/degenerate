...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType {const WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType bot = WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType user = WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType organization = WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType._('Organization');

static const List<WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator {const WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadResolvedPullRequestMilestoneCreator &&
