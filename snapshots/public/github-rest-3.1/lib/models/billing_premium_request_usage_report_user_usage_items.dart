...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class BillingPremiumRequestUsageReportUserUsageItems {const BillingPremiumRequestUsageReportUserUsageItems({required this.product, required this.sku, required this.model, required this.unitType, required this.pricePerUnit, required this.grossQuantity, required this.grossAmount, required this.discountQuantity, required this.discountAmount, required this.netQuantity, required this.netAmount, });

factory BillingPremiumRequestUsageReportUserUsageItems.fromJson(Map<String, dynamic> json) { return BillingPremiumRequestUsageReportUserUsageItems(
...
BillingPremiumRequestUsageReportUserUsageItems copyWith({String? product, String? sku, String? model, String? unitType, double? pricePerUnit, double? grossQuantity, double? grossAmount, double? discountQuantity, double? discountAmount, double? netQuantity, double? netAmount, }) { return BillingPremiumRequestUsageReportUserUsageItems(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BillingPremiumRequestUsageReportUserUsageItems &&
...
@override String toString() { return 'BillingPremiumRequestUsageReportUserUsageItems(product: $product, sku: $sku, model: $model, unitType: $unitType, pricePerUnit: $pricePerUnit, grossQuantity: $grossQuantity, grossAmount: $grossAmount, discountQuantity: $discountQuantity, discountAmount: $discountAmount, netQuantity: $netQuantity, netAmount: $netAmount)'; } 
 }
