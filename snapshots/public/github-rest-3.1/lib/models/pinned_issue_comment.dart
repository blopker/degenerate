...
import 'simple_user.dart';/// Context around who pinned an issue comment and when it was pinned.
final class PinnedIssueComment {const PinnedIssueComment({required this.pinnedAt, required this.pinnedBy, });
