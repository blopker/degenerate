...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType {const WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType bot = WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType user = WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType organization = WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner {const WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeEnabledPullRequestHeadRepoOwner &&
