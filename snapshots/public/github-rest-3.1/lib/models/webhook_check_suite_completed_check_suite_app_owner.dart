...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCheckSuiteCompletedCheckSuiteAppOwnerType {const WebhookCheckSuiteCompletedCheckSuiteAppOwnerType._(this.value);

factory WebhookCheckSuiteCompletedCheckSuiteAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCheckSuiteCompletedCheckSuiteAppOwnerType._(json),
}; }

static const WebhookCheckSuiteCompletedCheckSuiteAppOwnerType bot = WebhookCheckSuiteCompletedCheckSuiteAppOwnerType._('Bot');

static const WebhookCheckSuiteCompletedCheckSuiteAppOwnerType user = WebhookCheckSuiteCompletedCheckSuiteAppOwnerType._('User');

static const WebhookCheckSuiteCompletedCheckSuiteAppOwnerType organization = WebhookCheckSuiteCompletedCheckSuiteAppOwnerType._('Organization');

static const List<WebhookCheckSuiteCompletedCheckSuiteAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCheckSuiteCompletedCheckSuiteAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCheckSuiteCompletedCheckSuiteAppOwnerType($value)'; } 
 }
@immutable final class WebhookCheckSuiteCompletedCheckSuiteAppOwner {const WebhookCheckSuiteCompletedCheckSuiteAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCheckSuiteCompletedCheckSuiteAppOwner.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteCompletedCheckSuiteAppOwner(
  ...
  type: json['type'] != null ? WebhookCheckSuiteCompletedCheckSuiteAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookCheckSuiteCompletedCheckSuiteAppOwnerType? type;
...
WebhookCheckSuiteCompletedCheckSuiteAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCheckSuiteCompletedCheckSuiteAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCheckSuiteCompletedCheckSuiteAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCheckSuiteCompletedCheckSuiteAppOwner &&
...
@override String toString() { return 'WebhookCheckSuiteCompletedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
