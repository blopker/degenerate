...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCodeScanningAlertFixedAlertTool {const WebhookCodeScanningAlertFixedAlertTool({required this.name, required this.version, this.guid = const Omittable.absent(), });
...
WebhookCodeScanningAlertFixedAlertTool copyWith({Omittable<String?>? guid, String? name, String? Function()? version, }) { return WebhookCodeScanningAlertFixedAlertTool(
  guid: guid ?? this.guid,
  name: name ?? this.name,
