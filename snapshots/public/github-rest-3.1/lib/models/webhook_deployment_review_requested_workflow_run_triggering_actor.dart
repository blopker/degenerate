...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType {const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType._(this.value);

factory WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType._(json),
}; }

static const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType bot = WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType._('Bot');

static const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType user = WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType._('User');

static const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType organization = WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor {const WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType? type;
...
WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewRequestedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewRequestedWorkflowRunTriggeringActor &&
