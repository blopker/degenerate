...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlabeledPullRequestAssigneeType {const WebhookPullRequestUnlabeledPullRequestAssigneeType._(this.value);

factory WebhookPullRequestUnlabeledPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestUnlabeledPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestAssigneeType bot = WebhookPullRequestUnlabeledPullRequestAssigneeType._('Bot');

static const WebhookPullRequestUnlabeledPullRequestAssigneeType user = WebhookPullRequestUnlabeledPullRequestAssigneeType._('User');

static const WebhookPullRequestUnlabeledPullRequestAssigneeType organization = WebhookPullRequestUnlabeledPullRequestAssigneeType._('Organization');

static const WebhookPullRequestUnlabeledPullRequestAssigneeType mannequin = WebhookPullRequestUnlabeledPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestUnlabeledPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlabeledPullRequestAssignee {const WebhookPullRequestUnlabeledPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlabeledPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlabeledPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlabeledPullRequestAssigneeType? type;
...
WebhookPullRequestUnlabeledPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlabeledPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlabeledPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestAssignee &&
