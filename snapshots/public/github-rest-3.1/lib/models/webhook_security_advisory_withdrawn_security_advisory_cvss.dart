...
final class WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryCvss {const WebhookSecurityAdvisoryWithdrawnSecurityAdvisoryCvss({required this.score, required this.vectorString, });
