...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesReopenedIssueUserType {const WebhookIssuesReopenedIssueUserType._(this.value);

factory WebhookIssuesReopenedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesReopenedIssueUserType._(json),
}; }

static const WebhookIssuesReopenedIssueUserType bot = WebhookIssuesReopenedIssueUserType._('Bot');

static const WebhookIssuesReopenedIssueUserType user = WebhookIssuesReopenedIssueUserType._('User');

static const WebhookIssuesReopenedIssueUserType organization = WebhookIssuesReopenedIssueUserType._('Organization');

static const WebhookIssuesReopenedIssueUserType mannequin = WebhookIssuesReopenedIssueUserType._('Mannequin');

static const List<WebhookIssuesReopenedIssueUserType> values = [bot, user, organization, mannequin];
...
factory WebhookIssuesReopenedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesReopenedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesReopenedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesReopenedIssueUserType? type;
...
WebhookIssuesReopenedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesReopenedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesReopenedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesReopenedIssueUser &&
...
@override String toString() { return 'WebhookIssuesReopenedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
