...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ProtectedBranchRequiredConversationResolution {const ProtectedBranchRequiredConversationResolution({this.enabled});
