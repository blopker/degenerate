...
final class ReposUpdatePullRequestReviewProtectionRequestDismissalRestrictions {const ReposUpdatePullRequestReviewProtectionRequestDismissalRestrictions({this.users, this.teams, this.apps, });
