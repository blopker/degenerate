...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_unlabeled_pull_request_base_repo_license.dart';import 'webhook_pull_request_unlabeled_pull_request_base_repo_owner.dart';import 'webhook_pull_request_unlabeled_pull_request_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy {const WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy all = WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory WebhookPullRequestUnlabeledPullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestBaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestUnlabeledPullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestUnlabeledPullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestUnlabeledPullRequestBaseRepoOwner? owner;

final WebhookPullRequestUnlabeledPullRequestBaseRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestUnlabeledPullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestUnlabeledPullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestUnlabeledPullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestUnlabeledPullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestUnlabeledPullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestUnlabeledPullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestUnlabeledPullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestUnlabeledPullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestUnlabeledPullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestUnlabeledPullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestBaseRepo &&
