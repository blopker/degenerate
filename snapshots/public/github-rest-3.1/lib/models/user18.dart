...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User18Type {const User18Type._(this.value);

factory User18Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User18Type bot = User18Type._('Bot');

static const User18Type user = User18Type._('User');

static const User18Type organization = User18Type._('Organization');

static const User18Type mannequin = User18Type._('Mannequin');

static const List<User18Type> values = [bot, user, organization, mannequin];
...
factory User18.fromJson(Map<String, dynamic> json) { return User18(
  ...
  type: json['type'] != null ? User18Type.fromJson(json['type'] as String) : null,
...
User18 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User18Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User18(
