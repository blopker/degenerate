...
final class CodeScanningGetDefaultSetupResponse503 {const CodeScanningGetDefaultSetupResponse503({this.code, this.message, this.documentationUrl, });
...
@override String toString() { return 'CodeScanningGetDefaultSetupResponse503(code: $code, message: $message, documentationUrl: $documentationUrl)'; } 
 }
