...
final class WebhookDeploymentReviewApproved {const WebhookDeploymentReviewApproved({required this.action, this.approver, this.comment, this.enterprise, this.installation, required this.organization, required this.repository, this.reviewers, required this.sender, required this.since, this.workflowJobRun, this.workflowJobRuns, required this.workflowRun, });
