...
return  ActionsSetActionsCacheStorageLimitForOrganizationError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); } else if (responseMediaTypeMatches(contentType, 'application/scim+json', )) {
final json = jsonDecode(response.body);
return  ActionsSetActionsCacheStorageLimitForOrganizationError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>)); } else {
final json = jsonDecode(response.body);
return  ActionsSetActionsCacheStorageLimitForOrganizationError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); }case 403:
final json = jsonDecode(response.body);
return  ActionsSetActionsCacheStorageLimitForOrganizationError403(BasicError.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  ActionsSetActionsCacheStorageLimitForOrganizationError404(BasicError.fromJson(json as Map<String, dynamic>));default:
