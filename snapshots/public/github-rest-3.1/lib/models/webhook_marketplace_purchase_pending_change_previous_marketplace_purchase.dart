...
import 'webhook_marketplace_purchase_pending_change_previous_marketplace_purchase_account.dart';import 'webhook_marketplace_purchase_pending_change_previous_marketplace_purchase_plan.dart';final class WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchase {const WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchase({required this.account, required this.billingCycle, required this.freeTrialEndsOn, this.nextBillingDate, required this.onFreeTrial, required this.plan, required this.unitCount, });
...
final WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchaseAccount account;
...
final WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchasePlan plan;
