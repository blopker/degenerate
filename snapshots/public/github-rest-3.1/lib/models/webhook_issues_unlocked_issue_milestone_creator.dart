...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesUnlockedIssueMilestoneCreatorType {const WebhookIssuesUnlockedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesUnlockedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesUnlockedIssueMilestoneCreatorType bot = WebhookIssuesUnlockedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesUnlockedIssueMilestoneCreatorType user = WebhookIssuesUnlockedIssueMilestoneCreatorType._('User');

static const WebhookIssuesUnlockedIssueMilestoneCreatorType organization = WebhookIssuesUnlockedIssueMilestoneCreatorType._('Organization');

static const List<WebhookIssuesUnlockedIssueMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesUnlockedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesUnlockedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesUnlockedIssueMilestoneCreator {const WebhookIssuesUnlockedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesUnlockedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesUnlockedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesUnlockedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesUnlockedIssueMilestoneCreatorType? type;
...
WebhookIssuesUnlockedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesUnlockedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesUnlockedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesUnlockedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
