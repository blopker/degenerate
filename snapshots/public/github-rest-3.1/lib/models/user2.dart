...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User2Type {const User2Type._(this.value);

factory User2Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User2Type bot = User2Type._('Bot');

static const User2Type user = User2Type._('User');

static const User2Type organization = User2Type._('Organization');

static const User2Type mannequin = User2Type._('Mannequin');

static const List<User2Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User2Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User2Type($value)'; } 
 }
@immutable final class User2 {const User2({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User2.fromJson(Map<String, dynamic> json) { return User2(
  ...
  type: json['type'] != null ? User2Type.fromJson(json['type'] as String) : null,
...
User2 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User2Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User2(
