...
factory WebhookPackageUpdatedPackagePackageVersion.fromJson(Map<String, dynamic> json) { return WebhookPackageUpdatedPackagePackageVersion(
  ...
  dockerMetadata: (json['docker_metadata'] as List<dynamic>?)?.map((e) => WebhookPackageUpdatedPackagePackageVersionDockerMetadata.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<WebhookPackageUpdatedPackagePackageVersionDockerMetadata>? dockerMetadata;
