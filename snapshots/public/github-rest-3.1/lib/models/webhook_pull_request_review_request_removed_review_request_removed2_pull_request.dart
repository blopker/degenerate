...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'team16.dart';import 'user15.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_assignee.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_assignees.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_auto_merge.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_base.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_head.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_labels.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_links.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_merged_by.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_milestone.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_requested_reviewers.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_requested_teams.dart';import 'webhook_pull_request_review_request_removed_review_request_removed2_pull_request_user.dart';final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason.fromJson(String json) { return switch (json) {
  'resolved' => resolved,
  'off-topic' => offTopic,
  'too heated' => tooHeated,
  'spam' => spam,
  'null' => $null,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason resolved = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._('resolved');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason offTopic = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._('off-topic');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason tooHeated = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._('too heated');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason spam = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._('spam');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason $null = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason._('null');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason> values = [resolved, offTopic, tooHeated, spam, $null];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason($value)'; } 
 }
/// How the author is associated with the repository.
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation.fromJson(String json) { return switch (json) {
  ...
  'NONE' => none,
  'OWNER' => owner,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation collaborator = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('COLLABORATOR');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation contributor = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('CONTRIBUTOR');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation firstTimer = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('FIRST_TIMER');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation firstTimeContributor = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('FIRST_TIME_CONTRIBUTOR');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation mannequin = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('MANNEQUIN');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation member = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('MEMBER');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation none = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('NONE');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation owner = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation._('OWNER');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation> values = [collaborator, contributor, firstTimer, firstTimeContributor, mannequin, member, none, owner];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation($value)'; } 
 }
/// State of this Pull Request. Either `open` or `closed`.
final class WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState {const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState.fromJson(String json) { return switch (json) {
  'open' => open,
  'closed' => closed,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState open = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState._('open');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState closed = WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState._('closed');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState> values = [open, closed];
...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequest(
  ...
  head: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestHead.fromJson(json['head'] as Map<String, dynamic>),
  htmlUrl: Uri.parse(json['html_url'] as String),
  id: (json['id'] as num).toInt(),
  issueUrl: Uri.parse(json['issue_url'] as String),
  labels: (json['labels'] as List<dynamic>).map((e) => WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestLabels.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  state: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState.fromJson(json['state'] as String),
  statusesUrl: Uri.parse(json['statuses_url'] as String),
  title: json['title'] as String,
  updatedAt: DateTime.parse(json['updated_at'] as String),
  url: Uri.parse(json['url'] as String),
  user: json['user'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestUser.fromJson(json['user'] as Map<String, dynamic>) : null,
); }

final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestLinks links;

final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason? activeLockReason;

final int? additions;

final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee? assignee;

final List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignees?> assignees;

/// How the author is associated with the repository.
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAuthorAssociation authorAssociation;

/// The status of auto merging a pull request.
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMerge? autoMerge;

final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestBase base;
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestHead head;
...
final List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestLabels> labels;
...
final List<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestRequestedTeams> requestedTeams;
...
/// State of this Pull Request. Either `open` or `closed`.
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestState state;
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestUser? user;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequest &&
          links == other.links &&
