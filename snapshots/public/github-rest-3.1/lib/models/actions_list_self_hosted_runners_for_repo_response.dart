...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'runner.dart';@immutable final class ActionsListSelfHostedRunnersForRepoResponse {const ActionsListSelfHostedRunnersForRepoResponse({required this.totalCount, required this.runners, });
...
@override String toString() { return 'ActionsListSelfHostedRunnersForRepoResponse(totalCount: $totalCount, runners: $runners)'; } 
 }
