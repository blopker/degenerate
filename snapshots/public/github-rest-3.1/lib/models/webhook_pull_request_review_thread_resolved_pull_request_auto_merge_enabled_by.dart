...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType {const WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType._(this.value);
...
factory WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy &&
