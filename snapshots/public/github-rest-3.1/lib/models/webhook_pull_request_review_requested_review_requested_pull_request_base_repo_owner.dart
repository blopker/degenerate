...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType {const WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType bot = WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType user = WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType organization = WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner {const WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequestedPullRequestBaseRepoOwner &&
