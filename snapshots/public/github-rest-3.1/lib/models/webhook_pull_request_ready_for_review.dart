...
final class WebhookPullRequestReadyForReview {const WebhookPullRequestReadyForReview({required this.action, this.enterprise, this.installation, required this.number, this.organization, required this.pullRequest, required this.repository, required this.sender, });
