...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLockedIssueAssigneesType {const WebhookIssuesLockedIssueAssigneesType._(this.value);

factory WebhookIssuesLockedIssueAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLockedIssueAssigneesType bot = WebhookIssuesLockedIssueAssigneesType._('Bot');

static const WebhookIssuesLockedIssueAssigneesType user = WebhookIssuesLockedIssueAssigneesType._('User');

static const WebhookIssuesLockedIssueAssigneesType organization = WebhookIssuesLockedIssueAssigneesType._('Organization');

static const List<WebhookIssuesLockedIssueAssigneesType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookIssuesLockedIssueAssigneesType($value)'; } 
 }
@immutable final class WebhookIssuesLockedIssueAssignees {const WebhookIssuesLockedIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLockedIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesLockedIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesLockedIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLockedIssueAssigneesType? type;
...
WebhookIssuesLockedIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLockedIssueAssigneesType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLockedIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLockedIssueAssignees &&
...
@override String toString() { return 'WebhookIssuesLockedIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
