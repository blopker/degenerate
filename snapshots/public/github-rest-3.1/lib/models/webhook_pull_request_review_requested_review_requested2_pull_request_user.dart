...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType bot = WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType user = WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._('User');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType organization = WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._('Organization');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType mannequin = WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType? type;
...
WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequested2PullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestUser &&
