...
final class ProtectedBranchRequiredStatusCheck {const ProtectedBranchRequiredStatusCheck({this.url, this.enforcementLevel, required this.contexts, required this.checks, this.contextsUrl, this.strict, });
