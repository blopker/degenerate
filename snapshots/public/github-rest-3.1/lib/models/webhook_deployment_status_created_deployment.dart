...
factory WebhookDeploymentStatusCreatedDeployment.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedDeployment(
  ...
  payload: json['payload'] != null ? OneOf2.parse(json['payload'], fromA: (v) => v as String, fromB: (v) => v as Map<String, dynamic>,) : null,
  performedViaGithubApp: json.containsKey('performed_via_github_app') ? Omittable(json['performed_via_github_app'] != null ? WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final WebhookDeploymentStatusCreatedDeploymentCreator? creator;
...
final WebhookDeploymentStatusCreatedDeploymentPayload? payload;

/// GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
final Omittable<WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubApp?> performedViaGithubApp;
