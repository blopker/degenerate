...
final class PullsUpdateError422 extends PullsUpdateError {const PullsUpdateError422(this.data);
...
final class PullsUpdateErrorUnknown extends PullsUpdateError {const PullsUpdateErrorUnknown(this.response);
