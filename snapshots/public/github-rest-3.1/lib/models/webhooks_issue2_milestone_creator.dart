...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksIssue2MilestoneCreatorType {const WebhooksIssue2MilestoneCreatorType._(this.value);

factory WebhooksIssue2MilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksIssue2MilestoneCreatorType bot = WebhooksIssue2MilestoneCreatorType._('Bot');

static const WebhooksIssue2MilestoneCreatorType user = WebhooksIssue2MilestoneCreatorType._('User');

static const WebhooksIssue2MilestoneCreatorType organization = WebhooksIssue2MilestoneCreatorType._('Organization');

static const List<WebhooksIssue2MilestoneCreatorType> values = [bot, user, organization];
...
factory WebhooksIssue2MilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhooksIssue2MilestoneCreator(
  ...
  type: json['type'] != null ? WebhooksIssue2MilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhooksIssue2MilestoneCreatorType? type;
...
WebhooksIssue2MilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksIssue2MilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksIssue2MilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksIssue2MilestoneCreator &&
