...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesMilestonedIssueMilestoneCreatorType {const WebhookIssuesMilestonedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesMilestonedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesMilestonedIssueMilestoneCreatorType._(json),
}; }

static const WebhookIssuesMilestonedIssueMilestoneCreatorType bot = WebhookIssuesMilestonedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesMilestonedIssueMilestoneCreatorType user = WebhookIssuesMilestonedIssueMilestoneCreatorType._('User');

static const WebhookIssuesMilestonedIssueMilestoneCreatorType organization = WebhookIssuesMilestonedIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesMilestonedIssueMilestoneCreatorType mannequin = WebhookIssuesMilestonedIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesMilestonedIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesMilestonedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesMilestonedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesMilestonedIssueMilestoneCreator {const WebhookIssuesMilestonedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesMilestonedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesMilestonedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesMilestonedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesMilestonedIssueMilestoneCreatorType? type;
...
WebhookIssuesMilestonedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesMilestonedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesMilestonedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesMilestonedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesMilestonedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
