...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamEditedRepositoryOwnerType {const WebhookTeamEditedRepositoryOwnerType._(this.value);

factory WebhookTeamEditedRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookTeamEditedRepositoryOwnerType bot = WebhookTeamEditedRepositoryOwnerType._('Bot');

static const WebhookTeamEditedRepositoryOwnerType user = WebhookTeamEditedRepositoryOwnerType._('User');

static const WebhookTeamEditedRepositoryOwnerType organization = WebhookTeamEditedRepositoryOwnerType._('Organization');

static const List<WebhookTeamEditedRepositoryOwnerType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookTeamEditedRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookTeamEditedRepositoryOwner {const WebhookTeamEditedRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookTeamEditedRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookTeamEditedRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookTeamEditedRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookTeamEditedRepositoryOwnerType? type;
...
WebhookTeamEditedRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookTeamEditedRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookTeamEditedRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamEditedRepositoryOwner &&
...
@override String toString() { return 'WebhookTeamEditedRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
