...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType bot = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType user = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType._('User');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType organization = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser {const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType? type;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestUser &&
