...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType {const WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType._(this.value);

factory WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType bot = WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType._('Bot');

static const WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType user = WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType._('User');

static const WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType organization = WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadResolvedPullRequestAssignees {const WebhookPullRequestReviewThreadResolvedPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookPullRequestReviewThreadResolvedPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType? type;
...
WebhookPullRequestReviewThreadResolvedPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadResolvedPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestReviewThreadResolvedPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadResolvedPullRequestAssignees &&
...
@override String toString() { return 'WebhookPullRequestReviewThreadResolvedPullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
