...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User15Type {const User15Type._(this.value);

factory User15Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User15Type bot = User15Type._('Bot');

static const User15Type user = User15Type._('User');

static const User15Type organization = User15Type._('Organization');

static const List<User15Type> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User15Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User15Type($value)'; } 
 }
@immutable final class User15 {const User15({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User15.fromJson(Map<String, dynamic> json) { return User15(
  ...
  type: json['type'] != null ? User15Type.fromJson(json['type'] as String) : null,
...
User15 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User15Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User15(
