...
@immutable final class WebhookStatusCommitAuthor {const WebhookStatusCommitAuthor({this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.id, this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });
...
factory WebhookStatusCommitAuthor.fromJson(Map<String, dynamic> json) { return WebhookStatusCommitAuthor(
  ...
  type: json['type'] != null ? WebhookStatusCommitAuthorType.fromJson(json['type'] as String) : null,
...
final WebhookStatusCommitAuthorType? type;
...
WebhookStatusCommitAuthor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? Function()? id, String? Function()? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookStatusCommitAuthorType? Function()? type, Uri? Function()? url, }) { return WebhookStatusCommitAuthor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookStatusCommitAuthor &&
