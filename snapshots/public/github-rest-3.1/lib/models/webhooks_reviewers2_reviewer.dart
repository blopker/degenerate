...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksReviewers2ReviewerType {const WebhooksReviewers2ReviewerType._(this.value);

factory WebhooksReviewers2ReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhooksReviewers2ReviewerType._(json),
}; }

static const WebhooksReviewers2ReviewerType bot = WebhooksReviewers2ReviewerType._('Bot');

static const WebhooksReviewers2ReviewerType user = WebhooksReviewers2ReviewerType._('User');

static const WebhooksReviewers2ReviewerType organization = WebhooksReviewers2ReviewerType._('Organization');

static const List<WebhooksReviewers2ReviewerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksReviewers2ReviewerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksReviewers2ReviewerType($value)'; } 
 }
@immutable final class WebhooksReviewers2Reviewer {const WebhooksReviewers2Reviewer({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhooksReviewers2Reviewer.fromJson(Map<String, dynamic> json) { return WebhooksReviewers2Reviewer(
  ...
  type: json['type'] != null ? WebhooksReviewers2ReviewerType.fromJson(json['type'] as String) : null,
...
final WebhooksReviewers2ReviewerType? type;
...
WebhooksReviewers2Reviewer copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksReviewers2ReviewerType? Function()? type, Uri? Function()? url, }) { return WebhooksReviewers2Reviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksReviewers2Reviewer &&
...
@override String toString() { return 'WebhooksReviewers2Reviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
