...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_assigned_pull_request_head_repo_license.dart';import 'webhook_pull_request_assigned_pull_request_head_repo_owner.dart';import 'webhook_pull_request_assigned_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
final class WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestAssignedPullRequestHeadRepoVisibility {const WebhookPullRequestAssignedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestAssignedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestAssignedPullRequestHeadRepoVisibility public = WebhookPullRequestAssignedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestAssignedPullRequestHeadRepoVisibility private = WebhookPullRequestAssignedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestAssignedPullRequestHeadRepoVisibility internal = WebhookPullRequestAssignedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestAssignedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestAssignedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAssignedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestAssignedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestAssignedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestAssignedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestAssignedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestAssignedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestAssignedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestAssignedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestAssignedPullRequestHeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAssignedPullRequestHeadRepo &&
