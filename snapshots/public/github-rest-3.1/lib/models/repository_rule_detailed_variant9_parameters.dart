...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'repository_rule_params_status_check_configuration.dart';@immutable final class RepositoryRuleDetailedVariant9Parameters {const RepositoryRuleDetailedVariant9Parameters({required this.requiredStatusChecks, required this.strictRequiredStatusChecksPolicy, this.doNotEnforceOnCreate, });

factory RepositoryRuleDetailedVariant9Parameters.fromJson(Map<String, dynamic> json) { return RepositoryRuleDetailedVariant9Parameters(
...
RepositoryRuleDetailedVariant9Parameters copyWith({bool? Function()? doNotEnforceOnCreate, List<RepositoryRuleParamsStatusCheckConfiguration>? requiredStatusChecks, bool? strictRequiredStatusChecksPolicy, }) { return RepositoryRuleDetailedVariant9Parameters(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RepositoryRuleDetailedVariant9Parameters &&
...
@override String toString() { return 'RepositoryRuleDetailedVariant9Parameters(doNotEnforceOnCreate: $doNotEnforceOnCreate, requiredStatusChecks: $requiredStatusChecks, strictRequiredStatusChecksPolicy: $strictRequiredStatusChecksPolicy)'; } 
 }
