...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksPullRequest5MilestoneCreatorType {const WebhooksPullRequest5MilestoneCreatorType._(this.value);

factory WebhooksPullRequest5MilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksPullRequest5MilestoneCreatorType bot = WebhooksPullRequest5MilestoneCreatorType._('Bot');

static const WebhooksPullRequest5MilestoneCreatorType user = WebhooksPullRequest5MilestoneCreatorType._('User');

static const WebhooksPullRequest5MilestoneCreatorType organization = WebhooksPullRequest5MilestoneCreatorType._('Organization');

static const WebhooksPullRequest5MilestoneCreatorType mannequin = WebhooksPullRequest5MilestoneCreatorType._('Mannequin');

static const List<WebhooksPullRequest5MilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhooksPullRequest5MilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhooksPullRequest5MilestoneCreatorType($value)'; } 
 }
@immutable final class WebhooksPullRequest5MilestoneCreator {const WebhooksPullRequest5MilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksPullRequest5MilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5MilestoneCreator(
  ...
  type: json['type'] != null ? WebhooksPullRequest5MilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhooksPullRequest5MilestoneCreatorType? type;
...
WebhooksPullRequest5MilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksPullRequest5MilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksPullRequest5MilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5MilestoneCreator &&
