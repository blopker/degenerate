...
case 304:
return const CodeSecurityGetDefaultConfigurationsError304();
case 403:
final json = jsonDecode(response.body);
return CodeSecurityGetDefaultConfigurationsError403(BasicError.fromJson(json as Map<String, dynamic>));
case 404:
final json = jsonDecode(response.body);
return CodeSecurityGetDefaultConfigurationsError404(BasicError.fromJson(json as Map<String, dynamic>));
default:
