...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentPinnedIssuePullRequest {const WebhookIssueCommentPinnedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssueCommentPinnedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentPinnedIssuePullRequest(
...
WebhookIssueCommentPinnedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssueCommentPinnedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentPinnedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssueCommentPinnedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
