...
final class WebhookIssueCommentPinnedIssuePullRequest {const WebhookIssueCommentPinnedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
