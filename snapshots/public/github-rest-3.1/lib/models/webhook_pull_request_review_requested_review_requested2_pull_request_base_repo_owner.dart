...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType bot = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType user = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType organization = WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestBaseRepoOwner &&
