...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_issues_closed_issue.dart';/// The action that was performed.
final class WebhookIssuesClosedAction {const WebhookIssuesClosedAction._(this.value);
...
final class WebhookIssuesClosed {const WebhookIssuesClosed({required this.action, this.enterprise, this.installation, required this.issue, this.organization, required this.repository, required this.sender, });
...
@override String toString() { return 'WebhookIssuesClosed(action: $action, enterprise: $enterprise, installation: $installation, issue: $issue, organization: $organization, repository: $repository, sender: $sender)'; } 
 }
