...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType {const WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType._(this.value);

factory WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType bot = WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType._('Bot');

static const WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType user = WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType._('User');

static const WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType organization = WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType($value)'; } 
 }
@immutable final class WebhookIssuesLabeledIssuePerformedViaGithubAppOwner {const WebhookIssuesLabeledIssuePerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLabeledIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesLabeledIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesLabeledIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLabeledIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLabeledIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLabeledIssuePerformedViaGithubAppOwner &&
