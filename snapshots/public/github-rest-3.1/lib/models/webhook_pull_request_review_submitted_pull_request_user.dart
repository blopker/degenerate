...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewSubmittedPullRequestUserType {const WebhookPullRequestReviewSubmittedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewSubmittedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewSubmittedPullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewSubmittedPullRequestUserType bot = WebhookPullRequestReviewSubmittedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewSubmittedPullRequestUserType user = WebhookPullRequestReviewSubmittedPullRequestUserType._('User');

static const WebhookPullRequestReviewSubmittedPullRequestUserType organization = WebhookPullRequestReviewSubmittedPullRequestUserType._('Organization');

static const WebhookPullRequestReviewSubmittedPullRequestUserType mannequin = WebhookPullRequestReviewSubmittedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewSubmittedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewSubmittedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewSubmittedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewSubmittedPullRequestUser {const WebhookPullRequestReviewSubmittedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewSubmittedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewSubmittedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewSubmittedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewSubmittedPullRequestUserType? type;
...
WebhookPullRequestReviewSubmittedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewSubmittedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewSubmittedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewSubmittedPullRequestUser &&
