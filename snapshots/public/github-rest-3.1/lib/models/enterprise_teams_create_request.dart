...
@immutable final class EnterpriseTeamsCreateRequest {const EnterpriseTeamsCreateRequest({required this.name, this.description = const Omittable.absent(), this.syncToOrganizations, this.organizationSelectionType, this.groupId = const Omittable.absent(), });
...
factory EnterpriseTeamsCreateRequest.fromJson(Map<String, dynamic> json) { return EnterpriseTeamsCreateRequest(
  ...
  syncToOrganizations: json['sync_to_organizations'] != null ? EnterpriseTeamsCreateRequestSyncToOrganizations.fromJson(json['sync_to_organizations'] as String) : null,
  organizationSelectionType: json['organization_selection_type'] != null ? EnterpriseTeamsCreateRequestOrganizationSelectionType.fromJson(json['organization_selection_type'] as String) : null,
...
EnterpriseTeamsCreateRequestSyncToOrganizations get syncToOrganizationsOrDefault { return syncToOrganizations ?? EnterpriseTeamsCreateRequestSyncToOrganizations.fromJson('disabled'); } 
/// The value with the schema default applied when absent.
EnterpriseTeamsCreateRequestOrganizationSelectionType get organizationSelectionTypeOrDefault { return organizationSelectionType ?? EnterpriseTeamsCreateRequestOrganizationSelectionType.fromJson('disabled'); } 
