...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerType {const WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerType._(this.value);
...
factory WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedChangesOldIssuePerformedViaGithubAppOwner &&
