...
final class WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType {const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType bot = WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType user = WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType organization = WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType mannequin = WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType($value)'; } 
 }
final class WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator {const WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreatorType? type;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator &&
...
@override String toString() { return 'WebhookPullRequestAutoMergeEnabledPullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
