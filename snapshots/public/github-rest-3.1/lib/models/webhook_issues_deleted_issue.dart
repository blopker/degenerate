...
factory WebhookIssuesDeletedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesDeletedIssue(
  ...
  assignee: json.containsKey('assignee') ? Omittable(json['assignee'] != null ? WebhookIssuesDeletedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  ...
  performedViaGithubApp: json.containsKey('performed_via_github_app') ? Omittable(json['performed_via_github_app'] != null ? WebhookIssuesDeletedIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookIssuesDeletedIssueAssignee?> assignee;
...
final Omittable<WebhookIssuesDeletedIssuePerformedViaGithubApp?> performedViaGithubApp;
