...
final class WebhookIssuesReopenedIssueReactions {const WebhookIssuesReopenedIssueReactions({required this.plus1, required this.minus1, required this.confused, required this.eyes, required this.heart, required this.hooray, required this.laugh, required this.rocket, required this.totalCount, required this.url, });

factory WebhookIssuesReopenedIssueReactions.fromJson(Map<String, dynamic> json) { return WebhookIssuesReopenedIssueReactions(
...
WebhookIssuesReopenedIssueReactions copyWith({int? plus1, int? minus1, int? confused, int? eyes, int? heart, int? hooray, int? laugh, int? rocket, int? totalCount, Uri? url, }) { return WebhookIssuesReopenedIssueReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesReopenedIssueReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhookIssuesReopenedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
