...
WebhookIssueCommentDeletedIssueReactions copyWith({int Function()? plus1, int Function()? minus1, int Function()? confused, int Function()? eyes, int Function()? heart, int Function()? hooray, int Function()? laugh, int Function()? rocket, int Function()? totalCount, String Function()? url, }) { return WebhookIssueCommentDeletedIssueReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentDeletedIssueReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhookIssueCommentDeletedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
