...
final class WebhookRepositoryRulesetEditedChangesRulesUpdatedChangesRuleType {const WebhookRepositoryRulesetEditedChangesRulesUpdatedChangesRuleType({this.from});
