...
factory GistSimpleForkOf.fromJson(Map<String, dynamic> json) { return GistSimpleForkOf(
  ...
  files: (json['files'] as Map<String, dynamic>).map((k, v) => MapEntry(k, GistSimpleForkOfFilesValue.fromJson(v as Map<String, dynamic>))),
...
final Map<String,GistSimpleForkOfFilesValue> files;
