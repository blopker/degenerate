...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class SecurityAndAnalysisSecretScanningDelegatedBypassStatus {const SecurityAndAnalysisSecretScanningDelegatedBypassStatus._(this.value);
...
@immutable final class SecurityAndAnalysisSecretScanningDelegatedBypass {const SecurityAndAnalysisSecretScanningDelegatedBypass({this.status});
