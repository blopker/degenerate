...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType {const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType._(this.value);

factory WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType bot = WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType._('Bot');

static const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType user = WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType._('User');

static const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType organization = WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType($value)'; } 
 }
@immutable final class WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner {const WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner &&
...
@override String toString() { return 'WebhookIssuesDemilestonedIssuePerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
