...
final class Team16ParentPrivacy {const Team16ParentPrivacy._(this.value);
...
static const Team16ParentPrivacy closed = Team16ParentPrivacy._('closed');

static const Team16ParentPrivacy secret = Team16ParentPrivacy._('secret');

static const List<Team16ParentPrivacy> values = [open, closed, secret];
...
final class Team16Parent {const Team16Parent({required this.description, required this.htmlUrl, required this.id, required this.membersUrl, required this.name, required this.nodeId, required this.permission, required this.privacy, required this.repositoriesUrl, required this.slug, required this.url, });
...
factory Team16Parent.fromJson(Map<String, dynamic> json) { return Team16Parent(
  ...
  privacy: Team16ParentPrivacy.fromJson(json['privacy'] as String),
...
final Team16ParentPrivacy privacy;
