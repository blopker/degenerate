...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAssignedPullRequestMilestoneCreatorType {const WebhookPullRequestAssignedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestAssignedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestAssignedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestAssignedPullRequestMilestoneCreatorType bot = WebhookPullRequestAssignedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestAssignedPullRequestMilestoneCreatorType user = WebhookPullRequestAssignedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestAssignedPullRequestMilestoneCreatorType organization = WebhookPullRequestAssignedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestAssignedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestAssignedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestAssignedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAssignedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAssignedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestAssignedPullRequestMilestoneCreator {const WebhookPullRequestAssignedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAssignedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAssignedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestAssignedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAssignedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestAssignedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAssignedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAssignedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAssignedPullRequestMilestoneCreator &&
