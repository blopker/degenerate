...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentCreatedPullRequestUserType {const WebhookPullRequestReviewCommentCreatedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewCommentCreatedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewCommentCreatedPullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewCommentCreatedPullRequestUserType bot = WebhookPullRequestReviewCommentCreatedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewCommentCreatedPullRequestUserType user = WebhookPullRequestReviewCommentCreatedPullRequestUserType._('User');

static const WebhookPullRequestReviewCommentCreatedPullRequestUserType organization = WebhookPullRequestReviewCommentCreatedPullRequestUserType._('Organization');

static const WebhookPullRequestReviewCommentCreatedPullRequestUserType mannequin = WebhookPullRequestReviewCommentCreatedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewCommentCreatedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentCreatedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentCreatedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentCreatedPullRequestUser {const WebhookPullRequestReviewCommentCreatedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentCreatedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentCreatedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentCreatedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentCreatedPullRequestUserType? type;
...
WebhookPullRequestReviewCommentCreatedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentCreatedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentCreatedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentCreatedPullRequestUser &&
...
@override String toString() { return 'WebhookPullRequestReviewCommentCreatedPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
