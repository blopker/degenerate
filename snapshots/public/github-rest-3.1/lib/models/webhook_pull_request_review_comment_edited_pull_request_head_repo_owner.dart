...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType {const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType user = WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner {const WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentEditedPullRequestHeadRepoOwner &&
