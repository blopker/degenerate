...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewEditedPullRequestUserType {const WebhookPullRequestReviewEditedPullRequestUserType._(this.value);

factory WebhookPullRequestReviewEditedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewEditedPullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewEditedPullRequestUserType bot = WebhookPullRequestReviewEditedPullRequestUserType._('Bot');

static const WebhookPullRequestReviewEditedPullRequestUserType user = WebhookPullRequestReviewEditedPullRequestUserType._('User');

static const WebhookPullRequestReviewEditedPullRequestUserType organization = WebhookPullRequestReviewEditedPullRequestUserType._('Organization');

static const WebhookPullRequestReviewEditedPullRequestUserType mannequin = WebhookPullRequestReviewEditedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewEditedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewEditedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewEditedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewEditedPullRequestUser {const WebhookPullRequestReviewEditedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewEditedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewEditedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewEditedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewEditedPullRequestUserType? type;
...
WebhookPullRequestReviewEditedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewEditedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewEditedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewEditedPullRequestUser &&
