...
factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  ...
  _ => WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType user = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType && other.value == value; } 
...
factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner &&
...
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
