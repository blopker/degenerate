...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesUnlockedIssueUserType {const WebhookIssuesUnlockedIssueUserType._(this.value);

factory WebhookIssuesUnlockedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesUnlockedIssueUserType._(json),
}; }

static const WebhookIssuesUnlockedIssueUserType bot = WebhookIssuesUnlockedIssueUserType._('Bot');

static const WebhookIssuesUnlockedIssueUserType user = WebhookIssuesUnlockedIssueUserType._('User');

static const WebhookIssuesUnlockedIssueUserType organization = WebhookIssuesUnlockedIssueUserType._('Organization');

static const List<WebhookIssuesUnlockedIssueUserType> values = [bot, user, organization];
...
factory WebhookIssuesUnlockedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesUnlockedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesUnlockedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesUnlockedIssueUserType? type;
...
WebhookIssuesUnlockedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesUnlockedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesUnlockedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssueUser &&
...
@override String toString() { return 'WebhookIssuesUnlockedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
