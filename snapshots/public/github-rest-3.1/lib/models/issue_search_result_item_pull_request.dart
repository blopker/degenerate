...
final class IssueSearchResultItemPullRequest {const IssueSearchResultItemPullRequest({this.mergedAt, required this.diffUrl, required this.htmlUrl, required this.patchUrl, required this.url, });
