...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class IssueSearchResultItemPullRequest {const IssueSearchResultItemPullRequest({required this.diffUrl, required this.htmlUrl, required this.patchUrl, required this.url, this.mergedAt, });

factory IssueSearchResultItemPullRequest.fromJson(Map<String, dynamic> json) { return IssueSearchResultItemPullRequest(
...
IssueSearchResultItemPullRequest copyWith({DateTime? Function()? mergedAt, Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Uri? Function()? patchUrl, Uri? Function()? url, }) { return IssueSearchResultItemPullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IssueSearchResultItemPullRequest &&
...
@override String toString() { return 'IssueSearchResultItemPullRequest(mergedAt: $mergedAt, diffUrl: $diffUrl, htmlUrl: $htmlUrl, patchUrl: $patchUrl, url: $url)'; } 
 }
