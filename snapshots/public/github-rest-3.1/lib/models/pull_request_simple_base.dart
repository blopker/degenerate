...
import 'repository.dart';import 'simple_user.dart';final class PullRequestSimpleBase {const PullRequestSimpleBase({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
