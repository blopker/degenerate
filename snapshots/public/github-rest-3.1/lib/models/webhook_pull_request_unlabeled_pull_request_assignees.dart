...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlabeledPullRequestAssigneesType {const WebhookPullRequestUnlabeledPullRequestAssigneesType._(this.value);
...
factory WebhookPullRequestUnlabeledPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlabeledPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlabeledPullRequestAssigneesType? type;
...
WebhookPullRequestUnlabeledPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlabeledPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestUnlabeledPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestAssignees &&
