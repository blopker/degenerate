...
final class WebhookPullRequestUnassignedPullRequestHeadRepoPermissions {const WebhookPullRequestUnassignedPullRequestHeadRepoPermissions({required this.admin, this.maintain, required this.pull, required this.push, this.triage, });
