...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType {const WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType._(this.value);

factory WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType._(json),
}; }

static const WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType bot = WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType._('Bot');

static const WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType user = WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType._('User');

static const WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType organization = WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType._('Organization');

static const List<WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType($value)'; } 
 }
@immutable final class WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy {const WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy(
  ...
  type: json['type'] != null ? WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType.fromJson(json['type'] as String) : null,
...
final WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType? type;
...
WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCodeScanningAlertClosedByUserAlertDismissalApprovedBy &&
