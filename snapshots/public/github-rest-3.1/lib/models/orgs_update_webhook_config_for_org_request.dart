...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_config_content_type.dart';import 'webhook_config_insecure_ssl.dart';import 'webhook_config_secret.dart';import 'webhook_config_url.dart';final class OrgsUpdateWebhookConfigForOrgRequest {const OrgsUpdateWebhookConfigForOrgRequest({this.url, this.contentType, this.secret, this.insecureSsl, });
