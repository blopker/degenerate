...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType bot = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType user = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType._('User');

static const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType organization = WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser {const WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType? type;
...
WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequested2PullRequestHeadUser &&
