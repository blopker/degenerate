...
import 'package:collection/collection.dart';import 'orgs_create_webhook_request_config.dart';final class OrgsCreateWebhookRequest {const OrgsCreateWebhookRequest({required this.name, required this.config, this.events, this.active = true, });
