...
@immutable final class WebhookPushPusher {const WebhookPushPusher({required this.name, this.date, this.email = const Omittable.absent(), this.username, });
...
WebhookPushPusher copyWith({DateTime? Function()? date, Omittable<String?>? email, String? name, String? Function()? username, }) { return WebhookPushPusher(
