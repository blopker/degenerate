...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksPullRequest5AssigneesType {const WebhooksPullRequest5AssigneesType._(this.value);
...
@immutable final class WebhooksPullRequest5Assignees {const WebhooksPullRequest5Assignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhooksPullRequest5Assignees.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5Assignees(
  ...
  type: json['type'] != null ? WebhooksPullRequest5AssigneesType.fromJson(json['type'] as String) : null,
...
final WebhooksPullRequest5AssigneesType? type;
...
WebhooksPullRequest5Assignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksPullRequest5AssigneesType? Function()? type, Uri? Function()? url, }) { return WebhooksPullRequest5Assignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5Assignees &&
