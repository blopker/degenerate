...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedChangesOldIssueUserType {const WebhookIssuesOpenedChangesOldIssueUserType._(this.value);

factory WebhookIssuesOpenedChangesOldIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesOpenedChangesOldIssueUserType bot = WebhookIssuesOpenedChangesOldIssueUserType._('Bot');

static const WebhookIssuesOpenedChangesOldIssueUserType user = WebhookIssuesOpenedChangesOldIssueUserType._('User');

static const WebhookIssuesOpenedChangesOldIssueUserType organization = WebhookIssuesOpenedChangesOldIssueUserType._('Organization');

static const List<WebhookIssuesOpenedChangesOldIssueUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesOpenedChangesOldIssueUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesOpenedChangesOldIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesOpenedChangesOldIssueUser {const WebhookIssuesOpenedChangesOldIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesOpenedChangesOldIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedChangesOldIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedChangesOldIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedChangesOldIssueUserType? type;
...
WebhookIssuesOpenedChangesOldIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedChangesOldIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedChangesOldIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedChangesOldIssueUser &&
...
@override String toString() { return 'WebhookIssuesOpenedChangesOldIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
