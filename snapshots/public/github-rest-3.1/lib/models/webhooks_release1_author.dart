...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksRelease1AuthorType {const WebhooksRelease1AuthorType._(this.value);

factory WebhooksRelease1AuthorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhooksRelease1AuthorType._(json),
}; }

static const WebhooksRelease1AuthorType bot = WebhooksRelease1AuthorType._('Bot');

static const WebhooksRelease1AuthorType user = WebhooksRelease1AuthorType._('User');

static const WebhooksRelease1AuthorType organization = WebhooksRelease1AuthorType._('Organization');

static const List<WebhooksRelease1AuthorType> values = [bot, user, organization];
...
factory WebhooksRelease1Author.fromJson(Map<String, dynamic> json) { return WebhooksRelease1Author(
  ...
  type: json['type'] != null ? WebhooksRelease1AuthorType.fromJson(json['type'] as String) : null,
...
final WebhooksRelease1AuthorType? type;
...
WebhooksRelease1Author copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksRelease1AuthorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksRelease1Author(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksRelease1Author &&
