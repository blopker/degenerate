...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType {const WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType user = WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner {const WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewThreadUnresolvedPullRequestHeadRepoOwner &&
