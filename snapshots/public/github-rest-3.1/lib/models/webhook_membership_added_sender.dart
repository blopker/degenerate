...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookMembershipAddedSenderType {const WebhookMembershipAddedSenderType._(this.value);

factory WebhookMembershipAddedSenderType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookMembershipAddedSenderType bot = WebhookMembershipAddedSenderType._('Bot');

static const WebhookMembershipAddedSenderType user = WebhookMembershipAddedSenderType._('User');

static const WebhookMembershipAddedSenderType organization = WebhookMembershipAddedSenderType._('Organization');

static const List<WebhookMembershipAddedSenderType> values = [bot, user, organization];
...
factory WebhookMembershipAddedSender.fromJson(Map<String, dynamic> json) { return WebhookMembershipAddedSender(
  ...
  type: json['type'] != null ? WebhookMembershipAddedSenderType.fromJson(json['type'] as String) : null,
...
final WebhookMembershipAddedSenderType? type;
...
WebhookMembershipAddedSender copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookMembershipAddedSenderType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookMembershipAddedSender(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookMembershipAddedSender &&
