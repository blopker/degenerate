...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewDismissedPullRequestHeadUserType {const WebhookPullRequestReviewDismissedPullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewDismissedPullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestReviewDismissedPullRequestHeadUserType bot = WebhookPullRequestReviewDismissedPullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewDismissedPullRequestHeadUserType user = WebhookPullRequestReviewDismissedPullRequestHeadUserType._('User');

static const WebhookPullRequestReviewDismissedPullRequestHeadUserType organization = WebhookPullRequestReviewDismissedPullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewDismissedPullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedPullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestHeadUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewDismissedPullRequestHeadUser {const WebhookPullRequestReviewDismissedPullRequestHeadUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewDismissedPullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedPullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewDismissedPullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewDismissedPullRequestHeadUserType? type;
...
WebhookPullRequestReviewDismissedPullRequestHeadUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewDismissedPullRequestHeadUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewDismissedPullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewDismissedPullRequestHeadUser &&
...
@override String toString() { return 'WebhookPullRequestReviewDismissedPullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
