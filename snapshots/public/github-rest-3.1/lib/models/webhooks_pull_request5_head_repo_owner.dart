...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksPullRequest5HeadRepoOwnerType {const WebhooksPullRequest5HeadRepoOwnerType._(this.value);

factory WebhooksPullRequest5HeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksPullRequest5HeadRepoOwnerType bot = WebhooksPullRequest5HeadRepoOwnerType._('Bot');

static const WebhooksPullRequest5HeadRepoOwnerType user = WebhooksPullRequest5HeadRepoOwnerType._('User');

static const WebhooksPullRequest5HeadRepoOwnerType organization = WebhooksPullRequest5HeadRepoOwnerType._('Organization');

static const List<WebhooksPullRequest5HeadRepoOwnerType> values = [bot, user, organization];
...
@override String toString() { return 'WebhooksPullRequest5HeadRepoOwnerType($value)'; } 
 }
@immutable final class WebhooksPullRequest5HeadRepoOwner {const WebhooksPullRequest5HeadRepoOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksPullRequest5HeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5HeadRepoOwner(
  ...
  type: json['type'] != null ? WebhooksPullRequest5HeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhooksPullRequest5HeadRepoOwnerType? type;
...
WebhooksPullRequest5HeadRepoOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksPullRequest5HeadRepoOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksPullRequest5HeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPullRequest5HeadRepoOwner &&
...
@override String toString() { return 'WebhooksPullRequest5HeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
