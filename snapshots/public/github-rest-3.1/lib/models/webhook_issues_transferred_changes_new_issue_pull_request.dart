...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesTransferredChangesNewIssuePullRequest {const WebhookIssuesTransferredChangesNewIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssuesTransferredChangesNewIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssuesTransferredChangesNewIssuePullRequest(
...
WebhookIssuesTransferredChangesNewIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssuesTransferredChangesNewIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesTransferredChangesNewIssuePullRequest &&
...
@override String toString() { return 'WebhookIssuesTransferredChangesNewIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
