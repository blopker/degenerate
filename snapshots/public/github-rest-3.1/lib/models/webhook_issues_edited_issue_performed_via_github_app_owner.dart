...
static const WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType bot = WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType._('Bot');

static const WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType user = WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType._('User');

static const WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType organization = WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType && other.value == value; } 
...
factory WebhookIssuesEditedIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesEditedIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesEditedIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesEditedIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesEditedIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesEditedIssuePerformedViaGithubAppOwner &&
