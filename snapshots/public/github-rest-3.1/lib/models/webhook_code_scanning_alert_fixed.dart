...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_code_scanning_alert_fixed_alert.dart';import 'webhooks_code_scanning_commit_oid.dart';import 'webhooks_code_scanning_ref.dart';final class WebhookCodeScanningAlertFixedAction {const WebhookCodeScanningAlertFixedAction._(this.value);
...
final class WebhookCodeScanningAlertFixed {const WebhookCodeScanningAlertFixed({required this.action, required this.alert, required this.commitOid, this.enterprise, this.installation, this.organization, required this.ref, required this.repository, required this.sender, });
