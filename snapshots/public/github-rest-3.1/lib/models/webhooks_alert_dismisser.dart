...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksAlertDismisserType {const WebhooksAlertDismisserType._(this.value);

factory WebhooksAlertDismisserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksAlertDismisserType bot = WebhooksAlertDismisserType._('Bot');

static const WebhooksAlertDismisserType user = WebhooksAlertDismisserType._('User');

static const WebhooksAlertDismisserType organization = WebhooksAlertDismisserType._('Organization');

static const List<WebhooksAlertDismisserType> values = [bot, user, organization];
...
@override String toString() { return 'WebhooksAlertDismisserType($value)'; } 
 }
@immutable final class WebhooksAlertDismisser {const WebhooksAlertDismisser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhooksAlertDismisser.fromJson(Map<String, dynamic> json) { return WebhooksAlertDismisser(
  ...
  type: json['type'] != null ? WebhooksAlertDismisserType.fromJson(json['type'] as String) : null,
...
final WebhooksAlertDismisserType? type;
...
WebhooksAlertDismisser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksAlertDismisserType? Function()? type, Uri? Function()? url, }) { return WebhooksAlertDismisser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksAlertDismisser &&
...
@override String toString() { return 'WebhooksAlertDismisser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
