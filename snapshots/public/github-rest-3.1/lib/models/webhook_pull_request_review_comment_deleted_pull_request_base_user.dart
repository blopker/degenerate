...
final class WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType {const WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType bot = WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType user = WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType._('User');

static const WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType organization = WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType($value)'; } 
 }
final class WebhookPullRequestReviewCommentDeletedPullRequestBaseUser {const WebhookPullRequestReviewCommentDeletedPullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentDeletedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentDeletedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType? type;
...
WebhookPullRequestReviewCommentDeletedPullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewCommentDeletedPullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewCommentDeletedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentDeletedPullRequestBaseUser &&
