...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestSynchronizePullRequestAssigneesType {const WebhookPullRequestSynchronizePullRequestAssigneesType._(this.value);
...
factory WebhookPullRequestSynchronizePullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestSynchronizePullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestSynchronizePullRequestAssigneesType? type;
...
WebhookPullRequestSynchronizePullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestSynchronizePullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestSynchronizePullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestAssignees &&
