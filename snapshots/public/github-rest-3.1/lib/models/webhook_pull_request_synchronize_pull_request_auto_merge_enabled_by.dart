...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType {const WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType bot = WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType user = WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType organization = WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType($value)'; } 
 }
@immutable final class WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy {const WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestSynchronizePullRequestAutoMergeEnabledByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy &&
...
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
