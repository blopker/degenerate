...
return  SecretScanningUpdateOrgPatternConfigsError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); } else if (responseMediaTypeMatches(contentType, 'application/scim+json', )) {
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError400ApplicationScimJson(ScimError.fromJson(json as Map<String, dynamic>)); } else {
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError400ApplicationJson(BasicError.fromJson(json as Map<String, dynamic>)); }case 403:
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError403(BasicError.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError404(BasicError.fromJson(json as Map<String, dynamic>));case 409:
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError409(BasicError.fromJson(json as Map<String, dynamic>));case 422:
final json = jsonDecode(response.body);
return  SecretScanningUpdateOrgPatternConfigsError422(ValidationError.fromJson(json as Map<String, dynamic>));default:
