...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType {const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType._(this.value);

factory WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType._(json),
}; }

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType bot = WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType._('Bot');

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType user = WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType._('User');

static const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType organization = WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType._('Organization');

static const List<WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy {const WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType? type;
...
WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedReviewRequestedPullRequestMergedBy &&
