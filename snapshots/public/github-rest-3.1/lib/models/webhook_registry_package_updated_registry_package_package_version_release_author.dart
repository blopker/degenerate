...
final class WebhookRegistryPackageUpdatedRegistryPackagePackageVersionReleaseAuthor {const WebhookRegistryPackageUpdatedRegistryPackagePackageVersionReleaseAuthor({required this.avatarUrl, required this.eventsUrl, required this.followersUrl, required this.followingUrl, required this.gistsUrl, required this.gravatarId, required this.htmlUrl, required this.id, required this.login, required this.nodeId, required this.organizationsUrl, required this.receivedEventsUrl, required this.reposUrl, required this.siteAdmin, required this.starredUrl, required this.subscriptionsUrl, required this.type, required this.url, this.userViewType, });
