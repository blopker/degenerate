...
factory WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeams.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeams(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeamsParent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookPullRequestAutoMergeEnabledPullRequestRequestedTeamsParent?> parent;
