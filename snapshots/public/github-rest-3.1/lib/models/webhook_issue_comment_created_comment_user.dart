...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentCreatedCommentUserType {const WebhookIssueCommentCreatedCommentUserType._(this.value);

factory WebhookIssueCommentCreatedCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssueCommentCreatedCommentUserType._(json),
}; }

static const WebhookIssueCommentCreatedCommentUserType bot = WebhookIssueCommentCreatedCommentUserType._('Bot');

static const WebhookIssueCommentCreatedCommentUserType user = WebhookIssueCommentCreatedCommentUserType._('User');

static const WebhookIssueCommentCreatedCommentUserType organization = WebhookIssueCommentCreatedCommentUserType._('Organization');

static const List<WebhookIssueCommentCreatedCommentUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentCreatedCommentUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentCreatedCommentUserType($value)'; } 
 }
@immutable final class WebhookIssueCommentCreatedCommentUser {const WebhookIssueCommentCreatedCommentUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentCreatedCommentUser.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentCreatedCommentUser(
  ...
  type: json['type'] != null ? WebhookIssueCommentCreatedCommentUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentCreatedCommentUserType? type;
...
WebhookIssueCommentCreatedCommentUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentCreatedCommentUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentCreatedCommentUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentCreatedCommentUser &&
