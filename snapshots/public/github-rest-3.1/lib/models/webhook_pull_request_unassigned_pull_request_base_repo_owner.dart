...
final class WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType {const WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType._(this.value);

factory WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType bot = WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType._('Bot');

static const WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType user = WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType._('User');

static const WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType organization = WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType._('Organization');

static const List<WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType($value)'; } 
 }
final class WebhookPullRequestUnassignedPullRequestBaseRepoOwner {const WebhookPullRequestUnassignedPullRequestBaseRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnassignedPullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType? type;
...
WebhookPullRequestUnassignedPullRequestBaseRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestBaseRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestBaseRepoOwner &&
