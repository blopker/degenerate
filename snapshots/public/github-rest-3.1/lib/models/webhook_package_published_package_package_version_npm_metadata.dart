...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class WebhookPackagePublishedPackagePackageVersionNpmMetadata {const WebhookPackagePublishedPackagePackageVersionNpmMetadata({this.name, this.version, this.npmUser, this.author, this.bugs, this.dependencies, this.devDependencies, this.peerDependencies, this.optionalDependencies, this.description, this.dist, this.gitHead, this.homepage, this.license, this.main, this.repository, this.scripts, this.id, this.nodeVersion, this.npmVersion, this.hasShrinkwrap, this.maintainers, this.contributors, this.engines, this.keywords, this.files, this.bin, this.man, this.directories, this.os, this.cpu, this.readme, this.installationCommand, this.releaseId, this.commitOid, this.publishedViaActions, this.deletedById, });
...
factory WebhookPackagePublishedPackagePackageVersionNpmMetadata.fromJson(Map<String, dynamic> json) { return WebhookPackagePublishedPackagePackageVersionNpmMetadata(
  ...
  author: (json['author'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v)),
  bugs: (json['bugs'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v)),
  ...
  dist: (json['dist'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v)),
  gitHead: json['git_head'] as String?,
  homepage: json['homepage'] as String?,
  license: json['license'] as String?,
  main: json['main'] as String?,
  repository: (json['repository'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v)),
  ...
  maintainers: (json['maintainers'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v))).toList(),
  contributors: (json['contributors'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v))).toList(),
  ...
  directories: (json['directories'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v)),
