...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_edited_pull_request_head_repo_license.dart';import 'webhook_pull_request_review_edited_pull_request_head_repo_owner.dart';import 'webhook_pull_request_review_edited_pull_request_head_repo_permissions.dart';final class WebhookPullRequestReviewEditedPullRequestHeadRepoVisibility {const WebhookPullRequestReviewEditedPullRequestHeadRepoVisibility._(this.value);
...
/// A git repository
final class WebhookPullRequestReviewEditedPullRequestHeadRepo {const WebhookPullRequestReviewEditedPullRequestHeadRepo({this.allowAutoMerge = false, this.allowForking, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowSquashMerge = true, this.allowUpdateBranch, required this.archiveUrl, this.archived = false, required this.assigneesUrl, required this.blobsUrl, required this.branchesUrl, required this.cloneUrl, required this.collaboratorsUrl, required this.commentsUrl, required this.commitsUrl, required this.compareUrl, required this.contentsUrl, required this.contributorsUrl, required this.createdAt, required this.defaultBranch, this.deleteBranchOnMerge = false, required this.deploymentsUrl, required this.description, this.disabled, required this.downloadsUrl, required this.eventsUrl, required this.fork, required this.forks, required this.forksCount, required this.forksUrl, required this.fullName, required this.gitCommitsUrl, required this.gitRefsUrl, required this.gitTagsUrl, required this.gitUrl, this.hasDownloads = true, this.hasIssues = true, required this.hasPages, this.hasProjects = true, this.hasWiki = true, required this.homepage, required this.hooksUrl, required this.htmlUrl, required this.id, this.isTemplate, required this.issueCommentUrl, required this.issueEventsUrl, required this.issuesUrl, required this.keysUrl, required this.labelsUrl, required this.language, required this.languagesUrl, required this.license, this.masterBranch, required this.mergesUrl, required this.milestonesUrl, required this.mirrorUrl, required this.name, required this.nodeId, required this.notificationsUrl, required this.openIssues, required this.openIssuesCount, this.organization, required this.owner, this.permissions, required this.private, this.public, required this.pullsUrl, required this.pushedAt, required this.releasesUrl, this.roleName, required this.size, required this.sshUrl, this.stargazers, required this.stargazersCount, required this.stargazersUrl, required this.statusesUrl, required this.subscribersUrl, required this.subscriptionUrl, required this.svnUrl, required this.tagsUrl, required this.teamsUrl, required this.topics, required this.treesUrl, required this.updatedAt, required this.url, required this.visibility, required this.watchers, required this.watchersCount, });

factory WebhookPullRequestReviewEditedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewEditedPullRequestHeadRepo(
  ...
  license: json['license'] != null ? WebhookPullRequestReviewEditedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestReviewEditedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestReviewEditedPullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  visibility: WebhookPullRequestReviewEditedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewEditedPullRequestHeadRepoLicense? license;
...
final WebhookPullRequestReviewEditedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestReviewEditedPullRequestHeadRepoPermissions? permissions;
...
final WebhookPullRequestReviewEditedPullRequestHeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewEditedPullRequestHeadRepo &&
