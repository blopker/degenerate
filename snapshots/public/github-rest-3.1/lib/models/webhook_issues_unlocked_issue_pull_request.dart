...
final class WebhookIssuesUnlockedIssuePullRequest {const WebhookIssuesUnlockedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
