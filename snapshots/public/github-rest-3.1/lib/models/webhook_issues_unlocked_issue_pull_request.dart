...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesUnlockedIssuePullRequest {const WebhookIssuesUnlockedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssuesUnlockedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssuesUnlockedIssuePullRequest(
...
WebhookIssuesUnlockedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssuesUnlockedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssuesUnlockedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
