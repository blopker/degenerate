...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedChangesOldIssueAssigneesType {const WebhookIssuesOpenedChangesOldIssueAssigneesType._(this.value);

factory WebhookIssuesOpenedChangesOldIssueAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesOpenedChangesOldIssueAssigneesType._(json),
}; }

static const WebhookIssuesOpenedChangesOldIssueAssigneesType bot = WebhookIssuesOpenedChangesOldIssueAssigneesType._('Bot');

static const WebhookIssuesOpenedChangesOldIssueAssigneesType user = WebhookIssuesOpenedChangesOldIssueAssigneesType._('User');

static const WebhookIssuesOpenedChangesOldIssueAssigneesType organization = WebhookIssuesOpenedChangesOldIssueAssigneesType._('Organization');

static const List<WebhookIssuesOpenedChangesOldIssueAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesOpenedChangesOldIssueAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesOpenedChangesOldIssueAssigneesType($value)'; } 
 }
@immutable final class WebhookIssuesOpenedChangesOldIssueAssignees {const WebhookIssuesOpenedChangesOldIssueAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesOpenedChangesOldIssueAssignees.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedChangesOldIssueAssignees(
  ...
  type: json['type'] != null ? WebhookIssuesOpenedChangesOldIssueAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesOpenedChangesOldIssueAssigneesType? type;
...
WebhookIssuesOpenedChangesOldIssueAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesOpenedChangesOldIssueAssigneesType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesOpenedChangesOldIssueAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedChangesOldIssueAssignees &&
...
@override String toString() { return 'WebhookIssuesOpenedChangesOldIssueAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
