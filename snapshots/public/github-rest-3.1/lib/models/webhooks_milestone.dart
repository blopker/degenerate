...
import 'webhooks_milestone_creator.dart';/// The state of the milestone.
final class WebhooksMilestoneState {const WebhooksMilestoneState._(this.value);
