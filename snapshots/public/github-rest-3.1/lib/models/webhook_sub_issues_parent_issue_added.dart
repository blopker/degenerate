...
import 'issue.dart';import 'organization_simple_webhooks.dart';import 'repository.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';final class WebhookSubIssuesParentIssueAddedAction {const WebhookSubIssuesParentIssueAddedAction._(this.value);
...
final class WebhookSubIssuesParentIssueAdded {const WebhookSubIssuesParentIssueAdded({required this.action, required this.parentIssueId, required this.parentIssue, required this.parentIssueRepo, required this.subIssueId, required this.subIssue, this.installation, this.organization, this.repository, this.sender, });
