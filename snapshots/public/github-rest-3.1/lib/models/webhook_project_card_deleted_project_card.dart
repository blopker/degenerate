...
factory WebhookProjectCardDeletedProjectCard.fromJson(Map<String, dynamic> json) { return WebhookProjectCardDeletedProjectCard(
  ...
  creator: json['creator'] != null ? WebhookProjectCardDeletedProjectCardCreator.fromJson(json['creator'] as Map<String, dynamic>) : null,
...
final WebhookProjectCardDeletedProjectCardCreator? creator;
