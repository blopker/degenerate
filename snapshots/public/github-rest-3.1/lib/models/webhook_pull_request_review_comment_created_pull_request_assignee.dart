...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType {const WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType bot = WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType user = WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._('User');

static const WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType organization = WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._('Organization');

static const WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType mannequin = WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewCommentCreatedPullRequestAssignee {const WebhookPullRequestReviewCommentCreatedPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewCommentCreatedPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentCreatedPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType? type;
...
WebhookPullRequestReviewCommentCreatedPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewCommentCreatedPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewCommentCreatedPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewCommentCreatedPullRequestAssignee &&
