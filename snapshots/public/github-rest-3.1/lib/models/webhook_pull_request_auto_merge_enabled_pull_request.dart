...
factory WebhookPullRequestAutoMergeEnabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequest(
  ...
  mergedBy: json.containsKey('merged_by') ? Omittable(json['merged_by'] != null ? WebhookPullRequestAutoMergeEnabledPullRequestMergedBy.fromJson(json['merged_by'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookPullRequestAutoMergeEnabledPullRequestMergedBy?> mergedBy;
