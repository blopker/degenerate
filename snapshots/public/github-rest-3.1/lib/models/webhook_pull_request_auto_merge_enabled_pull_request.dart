...
factory WebhookPullRequestAutoMergeEnabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequest(
  ...
  assignees: (json['assignees'] as List<dynamic>).map((e) => WebhookPullRequestAutoMergeEnabledPullRequestAssignees.fromJson(e as Map<String, dynamic>)).toList(),
