...
final class WebhookIssuesEditedIssuePullRequest {const WebhookIssuesEditedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
