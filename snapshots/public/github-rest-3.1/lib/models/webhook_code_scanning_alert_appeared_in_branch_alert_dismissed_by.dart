...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCodeScanningAlertAppearedInBranchAlertDismissedByType {const WebhookCodeScanningAlertAppearedInBranchAlertDismissedByType._(this.value);
...
factory WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy(
  ...
  type: json['type'] != null ? WebhookCodeScanningAlertAppearedInBranchAlertDismissedByType.fromJson(json['type'] as String) : null,
...
final WebhookCodeScanningAlertAppearedInBranchAlertDismissedByType? type;
...
WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCodeScanningAlertAppearedInBranchAlertDismissedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCodeScanningAlertAppearedInBranchAlertDismissedBy &&
