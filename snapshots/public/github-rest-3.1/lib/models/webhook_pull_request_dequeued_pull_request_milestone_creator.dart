...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestDequeuedPullRequestMilestoneCreatorType {const WebhookPullRequestDequeuedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestDequeuedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestDequeuedPullRequestMilestoneCreatorType bot = WebhookPullRequestDequeuedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestDequeuedPullRequestMilestoneCreatorType user = WebhookPullRequestDequeuedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestDequeuedPullRequestMilestoneCreatorType organization = WebhookPullRequestDequeuedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestDequeuedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestDequeuedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestDequeuedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestDequeuedPullRequestMilestoneCreator {const WebhookPullRequestDequeuedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestDequeuedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestDequeuedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestDequeuedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestDequeuedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestDequeuedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestDequeuedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestDequeuedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestDequeuedPullRequestMilestoneCreator &&
