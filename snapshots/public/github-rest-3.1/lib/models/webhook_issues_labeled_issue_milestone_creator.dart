...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLabeledIssueMilestoneCreatorType {const WebhookIssuesLabeledIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesLabeledIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesLabeledIssueMilestoneCreatorType._(json),
}; }

static const WebhookIssuesLabeledIssueMilestoneCreatorType bot = WebhookIssuesLabeledIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesLabeledIssueMilestoneCreatorType user = WebhookIssuesLabeledIssueMilestoneCreatorType._('User');

static const WebhookIssuesLabeledIssueMilestoneCreatorType organization = WebhookIssuesLabeledIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesLabeledIssueMilestoneCreatorType mannequin = WebhookIssuesLabeledIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesLabeledIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesLabeledIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesLabeledIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesLabeledIssueMilestoneCreator {const WebhookIssuesLabeledIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLabeledIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesLabeledIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesLabeledIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLabeledIssueMilestoneCreatorType? type;
...
WebhookIssuesLabeledIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLabeledIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLabeledIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLabeledIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesLabeledIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
