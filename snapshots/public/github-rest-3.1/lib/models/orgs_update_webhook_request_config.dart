...
final class OrgsUpdateWebhookRequestConfig {const OrgsUpdateWebhookRequestConfig({required this.url, this.contentType, this.secret, this.insecureSsl, });
...
@override String toString() { return 'OrgsUpdateWebhookRequestConfig(url: $url, contentType: $contentType, secret: $secret, insecureSsl: $insecureSsl)'; } 
 }
