...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User24Type {const User24Type._(this.value);

factory User24Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User24Type bot = User24Type._('Bot');

static const User24Type user = User24Type._('User');

static const User24Type organization = User24Type._('Organization');

static const List<User24Type> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User24Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User24Type($value)'; } 
 }
@immutable final class User24 {const User24({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User24.fromJson(Map<String, dynamic> json) { return User24(
  ...
  type: json['type'] != null ? User24Type.fromJson(json['type'] as String) : null,
...
User24 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User24Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User24(
