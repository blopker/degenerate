...
factory WebhooksIssue.fromJson(Map<String, dynamic> json) { return WebhooksIssue(
  ...
  performedViaGithubApp: json.containsKey('performed_via_github_app') ? Omittable(json['performed_via_github_app'] != null ? WebhooksIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhooksIssueAssignee?> assignee;
...
final Omittable<WebhooksIssuePerformedViaGithubApp?> performedViaGithubApp;
