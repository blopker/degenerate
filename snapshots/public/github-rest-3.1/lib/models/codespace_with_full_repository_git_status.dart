...
final class CodespaceWithFullRepositoryGitStatus {const CodespaceWithFullRepositoryGitStatus({this.ahead, this.behind, this.hasUnpushedChanges, this.hasUncommittedChanges, this.ref, });
