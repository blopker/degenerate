...
@immutable final class CodespaceWithFullRepositoryGitStatus {const CodespaceWithFullRepositoryGitStatus({this.ahead, this.behind, this.hasUnpushedChanges, this.hasUncommittedChanges, this.ref, });

factory CodespaceWithFullRepositoryGitStatus.fromJson(Map<String, dynamic> json) { return CodespaceWithFullRepositoryGitStatus(
...
CodespaceWithFullRepositoryGitStatus copyWith({int Function()? ahead, int Function()? behind, bool Function()? hasUnpushedChanges, bool Function()? hasUncommittedChanges, String Function()? ref, }) { return CodespaceWithFullRepositoryGitStatus(
...
@override String toString() { return 'CodespaceWithFullRepositoryGitStatus(ahead: $ahead, behind: $behind, hasUnpushedChanges: $hasUnpushedChanges, hasUncommittedChanges: $hasUncommittedChanges, ref: $ref)'; } 
 }
