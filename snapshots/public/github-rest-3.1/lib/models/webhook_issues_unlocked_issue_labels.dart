...
WebhookIssuesUnlockedIssueLabels copyWith({String? color, bool? $default, String? Function()? description, int? id, String? name, String? nodeId, Uri? url, }) { return WebhookIssuesUnlockedIssueLabels(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssueLabels &&
          color == other.color &&
...
@override String toString() { return 'WebhookIssuesUnlockedIssueLabels(color: $color, \$default: ${$default}, description: $description, id: $id, name: $name, nodeId: $nodeId, url: $url)'; } 
 }
