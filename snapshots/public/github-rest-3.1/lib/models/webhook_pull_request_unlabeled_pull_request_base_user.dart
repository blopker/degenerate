...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlabeledPullRequestBaseUserType {const WebhookPullRequestUnlabeledPullRequestBaseUserType._(this.value);

factory WebhookPullRequestUnlabeledPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestUnlabeledPullRequestBaseUserType bot = WebhookPullRequestUnlabeledPullRequestBaseUserType._('Bot');

static const WebhookPullRequestUnlabeledPullRequestBaseUserType user = WebhookPullRequestUnlabeledPullRequestBaseUserType._('User');

static const WebhookPullRequestUnlabeledPullRequestBaseUserType organization = WebhookPullRequestUnlabeledPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestUnlabeledPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlabeledPullRequestBaseUser {const WebhookPullRequestUnlabeledPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlabeledPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlabeledPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlabeledPullRequestBaseUserType? type;
...
WebhookPullRequestUnlabeledPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlabeledPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlabeledPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestBaseUser &&
