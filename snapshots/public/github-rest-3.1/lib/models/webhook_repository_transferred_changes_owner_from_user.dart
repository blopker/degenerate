...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookRepositoryTransferredChangesOwnerFromUserType {const WebhookRepositoryTransferredChangesOwnerFromUserType._(this.value);

factory WebhookRepositoryTransferredChangesOwnerFromUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookRepositoryTransferredChangesOwnerFromUserType._(json),
}; }

static const WebhookRepositoryTransferredChangesOwnerFromUserType bot = WebhookRepositoryTransferredChangesOwnerFromUserType._('Bot');

static const WebhookRepositoryTransferredChangesOwnerFromUserType user = WebhookRepositoryTransferredChangesOwnerFromUserType._('User');

static const WebhookRepositoryTransferredChangesOwnerFromUserType organization = WebhookRepositoryTransferredChangesOwnerFromUserType._('Organization');

static const List<WebhookRepositoryTransferredChangesOwnerFromUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookRepositoryTransferredChangesOwnerFromUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookRepositoryTransferredChangesOwnerFromUserType($value)'; } 
 }
@immutable final class WebhookRepositoryTransferredChangesOwnerFromUser {const WebhookRepositoryTransferredChangesOwnerFromUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookRepositoryTransferredChangesOwnerFromUser.fromJson(Map<String, dynamic> json) { return WebhookRepositoryTransferredChangesOwnerFromUser(
  ...
  type: json['type'] != null ? WebhookRepositoryTransferredChangesOwnerFromUserType.fromJson(json['type'] as String) : null,
...
final WebhookRepositoryTransferredChangesOwnerFromUserType? type;
...
WebhookRepositoryTransferredChangesOwnerFromUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookRepositoryTransferredChangesOwnerFromUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookRepositoryTransferredChangesOwnerFromUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookRepositoryTransferredChangesOwnerFromUser &&
