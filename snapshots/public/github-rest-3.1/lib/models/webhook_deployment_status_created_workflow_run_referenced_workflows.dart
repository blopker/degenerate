...
final class WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows {const WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows({required this.path, this.ref, required this.sha, });
