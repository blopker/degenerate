...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class BillingUsageSummaryReportUserUsageItems {const BillingUsageSummaryReportUserUsageItems({required this.product, required this.sku, required this.unitType, required this.pricePerUnit, required this.grossQuantity, required this.grossAmount, required this.discountQuantity, required this.discountAmount, required this.netQuantity, required this.netAmount, });

factory BillingUsageSummaryReportUserUsageItems.fromJson(Map<String, dynamic> json) { return BillingUsageSummaryReportUserUsageItems(
...
BillingUsageSummaryReportUserUsageItems copyWith({String? product, String? sku, String? unitType, double? pricePerUnit, double? grossQuantity, double? grossAmount, double? discountQuantity, double? discountAmount, double? netQuantity, double? netAmount, }) { return BillingUsageSummaryReportUserUsageItems(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BillingUsageSummaryReportUserUsageItems &&
...
@override String toString() { return 'BillingUsageSummaryReportUserUsageItems(product: $product, sku: $sku, unitType: $unitType, pricePerUnit: $pricePerUnit, grossQuantity: $grossQuantity, grossAmount: $grossAmount, discountQuantity: $discountQuantity, discountAmount: $discountAmount, netQuantity: $netQuantity, netAmount: $netAmount)'; } 
 }
