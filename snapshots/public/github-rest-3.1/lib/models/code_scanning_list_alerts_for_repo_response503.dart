...
final class CodeScanningListAlertsForRepoResponse503 {const CodeScanningListAlertsForRepoResponse503({this.code, this.message, this.documentationUrl, });
...
@override String toString() { return 'CodeScanningListAlertsForRepoResponse503(code: $code, message: $message, documentationUrl: $documentationUrl)'; } 
 }
