...
import 'webhook_workflow_run_completed_workflow_run_head_repository_owner.dart';final class WebhookWorkflowRunCompletedWorkflowRunHeadRepository {const WebhookWorkflowRunCompletedWorkflowRunHeadRepository({required this.archiveUrl, required this.assigneesUrl, required this.blobsUrl, required this.branchesUrl, required this.collaboratorsUrl, required this.commentsUrl, required this.commitsUrl, required this.compareUrl, required this.contentsUrl, required this.contributorsUrl, required this.deploymentsUrl, required this.description, required this.downloadsUrl, required this.eventsUrl, required this.fork, required this.forksUrl, required this.fullName, required this.gitCommitsUrl, required this.gitRefsUrl, required this.gitTagsUrl, required this.hooksUrl, required this.htmlUrl, required this.id, required this.issueCommentUrl, required this.issueEventsUrl, required this.issuesUrl, required this.keysUrl, required this.labelsUrl, required this.languagesUrl, required this.mergesUrl, required this.milestonesUrl, required this.name, required this.nodeId, required this.notificationsUrl, required this.owner, required this.private, required this.pullsUrl, required this.releasesUrl, required this.stargazersUrl, required this.statusesUrl, required this.subscribersUrl, required this.subscriptionUrl, required this.tagsUrl, required this.teamsUrl, required this.treesUrl, required this.url, });

factory WebhookWorkflowRunCompletedWorkflowRunHeadRepository.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunHeadRepository(
  ...
  owner: json['owner'] != null ? WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
...
final WebhookWorkflowRunCompletedWorkflowRunHeadRepositoryOwner? owner;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunCompletedWorkflowRunHeadRepository &&
