...
case 304:
return  const GistsListForksError304();case 403:
final json = jsonDecode(response.body);
return  GistsListForksError403(BasicError.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  GistsListForksError404(BasicError.fromJson(json as Map<String, dynamic>));default:
