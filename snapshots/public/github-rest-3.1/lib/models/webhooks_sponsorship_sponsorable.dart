...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksSponsorshipSponsorableType {const WebhooksSponsorshipSponsorableType._(this.value);

factory WebhooksSponsorshipSponsorableType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksSponsorshipSponsorableType bot = WebhooksSponsorshipSponsorableType._('Bot');

static const WebhooksSponsorshipSponsorableType user = WebhooksSponsorshipSponsorableType._('User');

static const WebhooksSponsorshipSponsorableType organization = WebhooksSponsorshipSponsorableType._('Organization');

static const List<WebhooksSponsorshipSponsorableType> values = [bot, user, organization];
...
@override String toString() { return 'WebhooksSponsorshipSponsorableType($value)'; } 
 }
@immutable final class WebhooksSponsorshipSponsorable {const WebhooksSponsorshipSponsorable({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksSponsorshipSponsorable.fromJson(Map<String, dynamic> json) { return WebhooksSponsorshipSponsorable(
  ...
  type: json['type'] != null ? WebhooksSponsorshipSponsorableType.fromJson(json['type'] as String) : null,
...
final WebhooksSponsorshipSponsorableType? type;
...
WebhooksSponsorshipSponsorable copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksSponsorshipSponsorableType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksSponsorshipSponsorable(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksSponsorshipSponsorable &&
...
@override String toString() { return 'WebhooksSponsorshipSponsorable(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
