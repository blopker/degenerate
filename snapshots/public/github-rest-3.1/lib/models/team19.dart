...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'team19_parent.dart';@immutable final class Team19Privacy {const Team19Privacy._(this.value);
...
factory Team19.fromJson(Map<String, dynamic> json) { return Team19(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? Team19Parent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<Team19Parent?> parent;
...
Team19 copyWith({bool? Function()? deleted, String? Function()? description, Uri? htmlUrl, int? id, String? membersUrl, String? name, String? nodeId, Omittable<Team19Parent?>? parent, String? permission, Team19Privacy? privacy, Uri? repositoriesUrl, String? slug, Uri? url, }) { return Team19(
