...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ProjectEditedChangesShortDescription {const ProjectEditedChangesShortDescription({this.from = const Omittable.absent(), this.to = const Omittable.absent(), });
...
ProjectEditedChangesShortDescription copyWith({Omittable<String?>? from, Omittable<String?>? to, }) { return ProjectEditedChangesShortDescription(
  from: from ?? this.from,
  to: to ?? this.to,
); } 
