...
import 'package:collection/collection.dart';import 'secret_scanning_scan.dart';final class SecretScanningScanHistory {const SecretScanningScanHistory({this.incrementalScans, this.patternUpdateScans, this.backfillScans, this.customPatternBackfillScans, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SecretScanningScanHistory &&
          const ListEquality<dynamic>().equals(incrementalScans, other.incrementalScans) &&
          const ListEquality<dynamic>().equals(patternUpdateScans, other.patternUpdateScans) &&
          const ListEquality<dynamic>().equals(backfillScans, other.backfillScans) &&
          const ListEquality<dynamic>().equals(customPatternBackfillScans, other.customPatternBackfillScans); } 
