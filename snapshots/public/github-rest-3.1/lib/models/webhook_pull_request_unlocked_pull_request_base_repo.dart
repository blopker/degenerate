...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_unlocked_pull_request_base_repo_license.dart';import 'webhook_pull_request_unlocked_pull_request_base_repo_owner.dart';import 'webhook_pull_request_unlocked_pull_request_base_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
final class WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestUnlockedPullRequestBaseRepoVisibility {const WebhookPullRequestUnlockedPullRequestBaseRepoVisibility._(this.value);

factory WebhookPullRequestUnlockedPullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestUnlockedPullRequestBaseRepoVisibility public = WebhookPullRequestUnlockedPullRequestBaseRepoVisibility._('public');

static const WebhookPullRequestUnlockedPullRequestBaseRepoVisibility private = WebhookPullRequestUnlockedPullRequestBaseRepoVisibility._('private');

static const WebhookPullRequestUnlockedPullRequestBaseRepoVisibility internal = WebhookPullRequestUnlockedPullRequestBaseRepoVisibility._('internal');

static const List<WebhookPullRequestUnlockedPullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestUnlockedPullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlockedPullRequestBaseRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestUnlockedPullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestUnlockedPullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestUnlockedPullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestUnlockedPullRequestBaseRepoOwner? owner;

final WebhookPullRequestUnlockedPullRequestBaseRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestUnlockedPullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestUnlockedPullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, dynamic createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestUnlockedPullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestUnlockedPullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestUnlockedPullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestUnlockedPullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestUnlockedPullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, dynamic Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestUnlockedPullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestUnlockedPullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestUnlockedPullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlockedPullRequestBaseRepo &&
