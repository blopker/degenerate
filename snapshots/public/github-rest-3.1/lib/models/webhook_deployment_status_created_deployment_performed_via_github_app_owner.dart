...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType {const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType._(this.value);

factory WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType._(json),
}; }

static const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType bot = WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType._('Bot');

static const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType user = WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType._('User');

static const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType organization = WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner {const WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType? type;
...
WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner &&
...
@override String toString() { return 'WebhookDeploymentStatusCreatedDeploymentPerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
