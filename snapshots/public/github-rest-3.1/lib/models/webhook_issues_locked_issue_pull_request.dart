...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLockedIssuePullRequest {const WebhookIssuesLockedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssuesLockedIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssuesLockedIssuePullRequest(
...
WebhookIssuesLockedIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssuesLockedIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLockedIssuePullRequest &&
...
@override String toString() { return 'WebhookIssuesLockedIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
