...
final class WebhookIssuesLockedIssuePullRequest {const WebhookIssuesLockedIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt, this.patchUrl, this.url, });
