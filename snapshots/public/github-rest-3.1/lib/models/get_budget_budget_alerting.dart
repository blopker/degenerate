...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class GetBudgetBudgetAlerting {const GetBudgetBudgetAlerting({this.willAlert, this.alertRecipients, });
