...
import 'webhooks_pull_request5_base_repo.dart';import 'webhooks_pull_request5_base_user.dart';final class WebhooksPullRequest5Base {const WebhooksPullRequest5Base({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
...
WebhooksPullRequest5Base copyWith({String? label, String? ref, WebhooksPullRequest5BaseRepo? repo, String? sha, WebhooksPullRequest5BaseUser? Function()? user, }) { return WebhooksPullRequest5Base(
