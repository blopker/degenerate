...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_pull_request5_base_repo.dart';import 'webhooks_pull_request5_base_user.dart';@immutable final class WebhooksPullRequest5Base {const WebhooksPullRequest5Base({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
