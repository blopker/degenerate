...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesLabeledIssueAssigneeType {const WebhookIssuesLabeledIssueAssigneeType._(this.value);

factory WebhookIssuesLabeledIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesLabeledIssueAssigneeType bot = WebhookIssuesLabeledIssueAssigneeType._('Bot');

static const WebhookIssuesLabeledIssueAssigneeType user = WebhookIssuesLabeledIssueAssigneeType._('User');

static const WebhookIssuesLabeledIssueAssigneeType organization = WebhookIssuesLabeledIssueAssigneeType._('Organization');

static const WebhookIssuesLabeledIssueAssigneeType mannequin = WebhookIssuesLabeledIssueAssigneeType._('Mannequin');

static const List<WebhookIssuesLabeledIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override String toString() { return 'WebhookIssuesLabeledIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssuesLabeledIssueAssignee {const WebhookIssuesLabeledIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesLabeledIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesLabeledIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesLabeledIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesLabeledIssueAssigneeType? type;
...
WebhookIssuesLabeledIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesLabeledIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesLabeledIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesLabeledIssueAssignee &&
...
@override String toString() { return 'WebhookIssuesLabeledIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
