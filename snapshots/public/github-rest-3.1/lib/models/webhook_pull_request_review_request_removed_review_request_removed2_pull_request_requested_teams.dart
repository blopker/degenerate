...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestRequestedTeams.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestRequestedTeams(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestRequestedTeamsParent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestRequestedTeamsParent?> parent;
