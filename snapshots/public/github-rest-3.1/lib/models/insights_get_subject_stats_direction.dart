...
final class InsightsGetSubjectStatsDirection {const InsightsGetSubjectStatsDirection._(this.value);
...
@override String toString() { return 'InsightsGetSubjectStatsDirection($value)'; } 
 }
