...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunCompletedWorkflowRunActorType {const WebhookWorkflowRunCompletedWorkflowRunActorType._(this.value);

factory WebhookWorkflowRunCompletedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookWorkflowRunCompletedWorkflowRunActorType._(json),
}; }

static const WebhookWorkflowRunCompletedWorkflowRunActorType bot = WebhookWorkflowRunCompletedWorkflowRunActorType._('Bot');

static const WebhookWorkflowRunCompletedWorkflowRunActorType user = WebhookWorkflowRunCompletedWorkflowRunActorType._('User');

static const WebhookWorkflowRunCompletedWorkflowRunActorType organization = WebhookWorkflowRunCompletedWorkflowRunActorType._('Organization');

static const List<WebhookWorkflowRunCompletedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunCompletedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookWorkflowRunCompletedWorkflowRunActor {const WebhookWorkflowRunCompletedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunCompletedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookWorkflowRunCompletedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunCompletedWorkflowRunActorType? type;
...
WebhookWorkflowRunCompletedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunCompletedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunCompletedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunCompletedWorkflowRunActor &&
...
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
