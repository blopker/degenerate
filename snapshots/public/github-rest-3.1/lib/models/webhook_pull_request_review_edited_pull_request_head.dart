...
import 'webhook_pull_request_review_edited_pull_request_head_repo.dart';import 'webhook_pull_request_review_edited_pull_request_head_user.dart';final class WebhookPullRequestReviewEditedPullRequestHead {const WebhookPullRequestReviewEditedPullRequestHead({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
