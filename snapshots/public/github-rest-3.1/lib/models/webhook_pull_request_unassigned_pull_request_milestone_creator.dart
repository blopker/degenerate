...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnassignedPullRequestMilestoneCreatorType {const WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestUnassignedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestMilestoneCreatorType bot = WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestUnassignedPullRequestMilestoneCreatorType user = WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestUnassignedPullRequestMilestoneCreatorType organization = WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestUnassignedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestUnassignedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestUnassignedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestUnassignedPullRequestMilestoneCreator {const WebhookPullRequestUnassignedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnassignedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestUnassignedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnassignedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestUnassignedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnassignedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnassignedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestMilestoneCreator &&
