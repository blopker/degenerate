...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCommitCommentCreatedCommentUserType {const WebhookCommitCommentCreatedCommentUserType._(this.value);

factory WebhookCommitCommentCreatedCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCommitCommentCreatedCommentUserType._(json),
}; }

static const WebhookCommitCommentCreatedCommentUserType bot = WebhookCommitCommentCreatedCommentUserType._('Bot');

static const WebhookCommitCommentCreatedCommentUserType user = WebhookCommitCommentCreatedCommentUserType._('User');

static const WebhookCommitCommentCreatedCommentUserType organization = WebhookCommitCommentCreatedCommentUserType._('Organization');

static const List<WebhookCommitCommentCreatedCommentUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCommitCommentCreatedCommentUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCommitCommentCreatedCommentUserType($value)'; } 
 }
@immutable final class WebhookCommitCommentCreatedCommentUser {const WebhookCommitCommentCreatedCommentUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCommitCommentCreatedCommentUser.fromJson(Map<String, dynamic> json) { return WebhookCommitCommentCreatedCommentUser(
  ...
  type: json['type'] != null ? WebhookCommitCommentCreatedCommentUserType.fromJson(json['type'] as String) : null,
...
final WebhookCommitCommentCreatedCommentUserType? type;
...
WebhookCommitCommentCreatedCommentUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCommitCommentCreatedCommentUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCommitCommentCreatedCommentUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCommitCommentCreatedCommentUser &&
