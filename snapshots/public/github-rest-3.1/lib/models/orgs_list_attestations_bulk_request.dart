...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class OrgsListAttestationsBulkRequest {const OrgsListAttestationsBulkRequest({required this.subjectDigests, this.predicateType, });
