...
factory InsightsUserStats2.fromJson(Map<String, dynamic> json) { return InsightsUserStats2(
  ...
  integrationId: json.containsKey('integration_id') ? Omittable(json['integration_id'] != null ? (json['integration_id'] as num).toInt() : null) : const Omittable.absent(),
  oauthApplicationId: json.containsKey('oauth_application_id') ? Omittable(json['oauth_application_id'] != null ? (json['oauth_application_id'] as num).toInt() : null) : const Omittable.absent(),
...
final Omittable<int?> integrationId;

final Omittable<int?> oauthApplicationId;
...
Map<String, dynamic> toJson() { return {
  ...
  if (oauthApplicationId.isPresent) 'oauth_application_id': oauthApplicationId.value,
...
InsightsUserStats2 copyWith({String? Function()? actorType, String? Function()? actorName, int? Function()? actorId, Omittable<int?>? integrationId, Omittable<int?>? oauthApplicationId, int? Function()? totalRequestCount, int? Function()? rateLimitedRequestCount, Omittable<String?>? lastRateLimitedTimestamp, String? Function()? lastRequestTimestamp, }) { return InsightsUserStats2(
  ...
  oauthApplicationId: oauthApplicationId ?? this.oauthApplicationId,
