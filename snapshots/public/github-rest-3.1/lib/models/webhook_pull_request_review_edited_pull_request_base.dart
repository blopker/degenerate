...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_review_edited_pull_request_base_repo.dart';import 'webhook_pull_request_review_edited_pull_request_base_user.dart';@immutable final class WebhookPullRequestReviewEditedPullRequestBase {const WebhookPullRequestReviewEditedPullRequestBase({required this.label, required this.ref, required this.repo, required this.sha, required this.user, });
