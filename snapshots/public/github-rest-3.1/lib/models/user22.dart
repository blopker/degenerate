...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User22Type {const User22Type._(this.value);

factory User22Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User22Type bot = User22Type._('Bot');

static const User22Type user = User22Type._('User');

static const User22Type organization = User22Type._('Organization');

static const User22Type mannequin = User22Type._('Mannequin');

static const List<User22Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User22Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User22Type($value)'; } 
 }
@immutable final class User22 {const User22({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User22.fromJson(Map<String, dynamic> json) { return User22(
  ...
  type: json['type'] != null ? User22Type.fromJson(json['type'] as String) : null,
...
User22 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User22Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User22(
