...
factory Team10.fromJson(Map<String, dynamic> json) { return Team10(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? Team10Parent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<Team10Parent?> parent;
...
Team10 copyWith({bool? Function()? deleted, String? Function()? description, Uri? htmlUrl, int? id, String? membersUrl, String? name, String? nodeId, Omittable<Team10Parent?>? parent, String? permission, Team10Privacy? privacy, Uri? repositoriesUrl, String? slug, Uri? url, }) { return Team10(
...
@override String toString() { return 'Team10(deleted: $deleted, description: $description, htmlUrl: $htmlUrl, id: $id, membersUrl: $membersUrl, name: $name, nodeId: $nodeId, parent: $parent, permission: $permission, privacy: $privacy, repositoriesUrl: $repositoriesUrl, slug: $slug, url: $url)'; } 
 }
