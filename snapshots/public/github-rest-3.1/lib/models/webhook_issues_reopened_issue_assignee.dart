...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesReopenedIssueAssigneeType {const WebhookIssuesReopenedIssueAssigneeType._(this.value);

factory WebhookIssuesReopenedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesReopenedIssueAssigneeType bot = WebhookIssuesReopenedIssueAssigneeType._('Bot');

static const WebhookIssuesReopenedIssueAssigneeType user = WebhookIssuesReopenedIssueAssigneeType._('User');

static const WebhookIssuesReopenedIssueAssigneeType organization = WebhookIssuesReopenedIssueAssigneeType._('Organization');

static const List<WebhookIssuesReopenedIssueAssigneeType> values = [bot, user, organization];
...
@override String toString() { return 'WebhookIssuesReopenedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssuesReopenedIssueAssignee {const WebhookIssuesReopenedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookIssuesReopenedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesReopenedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesReopenedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesReopenedIssueAssigneeType? type;
...
WebhookIssuesReopenedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesReopenedIssueAssigneeType? Function()? type, Uri? Function()? url, }) { return WebhookIssuesReopenedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesReopenedIssueAssignee &&
