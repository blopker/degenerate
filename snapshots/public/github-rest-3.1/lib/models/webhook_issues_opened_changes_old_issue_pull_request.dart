...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesOpenedChangesOldIssuePullRequest {const WebhookIssuesOpenedChangesOldIssuePullRequest({this.diffUrl, this.htmlUrl, this.mergedAt = const Omittable.absent(), this.patchUrl, this.url, });

factory WebhookIssuesOpenedChangesOldIssuePullRequest.fromJson(Map<String, dynamic> json) { return WebhookIssuesOpenedChangesOldIssuePullRequest(
...
WebhookIssuesOpenedChangesOldIssuePullRequest copyWith({Uri? Function()? diffUrl, Uri? Function()? htmlUrl, Omittable<DateTime?>? mergedAt, Uri? Function()? patchUrl, Uri? Function()? url, }) { return WebhookIssuesOpenedChangesOldIssuePullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesOpenedChangesOldIssuePullRequest &&
...
@override String toString() { return 'WebhookIssuesOpenedChangesOldIssuePullRequest(diffUrl: $diffUrl, htmlUrl: $htmlUrl, mergedAt: $mergedAt, patchUrl: $patchUrl, url: $url)'; } 
 }
