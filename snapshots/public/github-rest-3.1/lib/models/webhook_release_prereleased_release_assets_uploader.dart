...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookReleasePrereleasedReleaseAssetsUploaderType {const WebhookReleasePrereleasedReleaseAssetsUploaderType._(this.value);

factory WebhookReleasePrereleasedReleaseAssetsUploaderType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookReleasePrereleasedReleaseAssetsUploaderType._(json),
}; }

static const WebhookReleasePrereleasedReleaseAssetsUploaderType bot = WebhookReleasePrereleasedReleaseAssetsUploaderType._('Bot');

static const WebhookReleasePrereleasedReleaseAssetsUploaderType user = WebhookReleasePrereleasedReleaseAssetsUploaderType._('User');

static const WebhookReleasePrereleasedReleaseAssetsUploaderType organization = WebhookReleasePrereleasedReleaseAssetsUploaderType._('Organization');

static const List<WebhookReleasePrereleasedReleaseAssetsUploaderType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookReleasePrereleasedReleaseAssetsUploaderType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookReleasePrereleasedReleaseAssetsUploaderType($value)'; } 
 }
@immutable final class WebhookReleasePrereleasedReleaseAssetsUploader {const WebhookReleasePrereleasedReleaseAssetsUploader({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookReleasePrereleasedReleaseAssetsUploader.fromJson(Map<String, dynamic> json) { return WebhookReleasePrereleasedReleaseAssetsUploader(
  ...
  type: json['type'] != null ? WebhookReleasePrereleasedReleaseAssetsUploaderType.fromJson(json['type'] as String) : null,
...
final WebhookReleasePrereleasedReleaseAssetsUploaderType? type;
...
WebhookReleasePrereleasedReleaseAssetsUploader copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookReleasePrereleasedReleaseAssetsUploaderType? Function()? type, Uri? Function()? url, }) { return WebhookReleasePrereleasedReleaseAssetsUploader(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookReleasePrereleasedReleaseAssetsUploader &&
...
@override String toString() { return 'WebhookReleasePrereleasedReleaseAssetsUploader(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url)'; } 
 }
