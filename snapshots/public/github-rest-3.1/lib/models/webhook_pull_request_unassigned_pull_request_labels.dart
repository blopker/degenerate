...
WebhookPullRequestUnassignedPullRequestLabels copyWith({String? color, bool? $default, String? Function()? description, int? id, String? name, String? nodeId, Uri? url, }) { return WebhookPullRequestUnassignedPullRequestLabels(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestLabels &&
          color == other.color &&
...
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestLabels(color: $color, \$default: ${$default}, description: $description, id: $id, name: $name, nodeId: $nodeId, url: $url)'; } 
 }
