...
factory WebhookPullRequestAutoMergeDisabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequest(
  ...
  assignees: (json['assignees'] as List<dynamic>).map((e) => WebhookPullRequestAutoMergeDisabledPullRequestAssignees.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  mergedBy: json['merged_by'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestMergedBy.fromJson(json['merged_by'] as Map<String, dynamic>) : null,
...
final WebhookPullRequestAutoMergeDisabledPullRequestMergedBy? mergedBy;
