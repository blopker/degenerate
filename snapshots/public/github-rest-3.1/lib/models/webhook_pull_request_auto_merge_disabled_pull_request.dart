...
factory WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason.fromJson(String json) { return switch (json) {
  ...
  'spam' => spam,
  'null' => $null,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason resolved = WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._('resolved');

static const WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason offTopic = WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._('off-topic');

static const WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason tooHeated = WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._('too heated');

static const WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason spam = WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._('spam');

static const WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason $null = WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason._('null');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason> values = [resolved, offTopic, tooHeated, spam, $null];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason && other.value == value; } 
...
factory WebhookPullRequestAutoMergeDisabledPullRequestState.fromJson(String json) { return switch (json) {
  'open' => open,
  'closed' => closed,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestState._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestState open = WebhookPullRequestAutoMergeDisabledPullRequestState._('open');

static const WebhookPullRequestAutoMergeDisabledPullRequestState closed = WebhookPullRequestAutoMergeDisabledPullRequestState._('closed');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestState> values = [open, closed];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestState && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
...
factory WebhookPullRequestAutoMergeDisabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequest(
  ...
  activeLockReason: json['active_lock_reason'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason.fromJson(json['active_lock_reason'] as String) : null,
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: json['assignee'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null,
  assignees: (json['assignees'] as List<dynamic>).map((e) => e == null ? null : WebhookPullRequestAutoMergeDisabledPullRequestAssignees.fromJson(e as Map<String, dynamic>)).toList(),
  authorAssociation: WebhookPullRequestAutoMergeDisabledPullRequestAuthorAssociation.fromJson(json['author_association'] as String),
  autoMerge: json['auto_merge'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestAutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>) : null,
  base: WebhookPullRequestAutoMergeDisabledPullRequestBase.fromJson(json['base'] as Map<String, dynamic>),
  ...
  head: WebhookPullRequestAutoMergeDisabledPullRequestHead.fromJson(json['head'] as Map<String, dynamic>),
  htmlUrl: Uri.parse(json['html_url'] as String),
  id: (json['id'] as num).toInt(),
  issueUrl: Uri.parse(json['issue_url'] as String),
  labels: (json['labels'] as List<dynamic>).map((e) => WebhookPullRequestAutoMergeDisabledPullRequestLabels.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  mergedBy: json.containsKey('merged_by') ? Omittable(json['merged_by'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestMergedBy.fromJson(json['merged_by'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  milestone: json['milestone'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestMilestone.fromJson(json['milestone'] as Map<String, dynamic>) : null,
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User3.fromJson(v as Map<String, dynamic>), fromB: (v) => Team4.fromJson(v as Map<String, dynamic>),)).toList(),
  requestedTeams: (json['requested_teams'] as List<dynamic>).map((e) => WebhookPullRequestAutoMergeDisabledPullRequestRequestedTeams.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  state: WebhookPullRequestAutoMergeDisabledPullRequestState.fromJson(json['state'] as String),
  statusesUrl: Uri.parse(json['statuses_url'] as String),
  title: json['title'] as String,
  updatedAt: DateTime.parse(json['updated_at'] as String),
  url: Uri.parse(json['url'] as String),
  user: json['user'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestUser.fromJson(json['user'] as Map<String, dynamic>) : null,
); }

final WebhookPullRequestAutoMergeDisabledPullRequestLinks links;

final WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason? activeLockReason;

final int? additions;

final WebhookPullRequestAutoMergeDisabledPullRequestAssignee? assignee;

final List<WebhookPullRequestAutoMergeDisabledPullRequestAssignees?> assignees;

/// How the author is associated with the repository.
final WebhookPullRequestAutoMergeDisabledPullRequestAuthorAssociation authorAssociation;

/// The status of auto merging a pull request.
final WebhookPullRequestAutoMergeDisabledPullRequestAutoMerge? autoMerge;

final WebhookPullRequestAutoMergeDisabledPullRequestBase base;
...
final WebhookPullRequestAutoMergeDisabledPullRequestHead head;
...
final List<WebhookPullRequestAutoMergeDisabledPullRequestLabels> labels;
...
final Omittable<WebhookPullRequestAutoMergeDisabledPullRequestMergedBy?> mergedBy;

/// A collection of related issues and pull requests.
final WebhookPullRequestAutoMergeDisabledPullRequestMilestone? milestone;
...
final List<WebhookPullRequestAutoMergeDisabledPullRequestRequestedReviewers> requestedReviewers;

final List<WebhookPullRequestAutoMergeDisabledPullRequestRequestedTeams> requestedTeams;
...
/// State of this Pull Request. Either `open` or `closed`.
final WebhookPullRequestAutoMergeDisabledPullRequestState state;
...
final WebhookPullRequestAutoMergeDisabledPullRequestUser? user;
...
WebhookPullRequestAutoMergeDisabledPullRequest copyWith({WebhookPullRequestAutoMergeDisabledPullRequestLinks? links, WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason? Function()? activeLockReason, int? Function()? additions, WebhookPullRequestAutoMergeDisabledPullRequestAssignee? Function()? assignee, List<WebhookPullRequestAutoMergeDisabledPullRequestAssignees?>? assignees, WebhookPullRequestAutoMergeDisabledPullRequestAuthorAssociation? authorAssociation, WebhookPullRequestAutoMergeDisabledPullRequestAutoMerge? Function()? autoMerge, WebhookPullRequestAutoMergeDisabledPullRequestBase? base, String? Function()? body, int? Function()? changedFiles, DateTime? Function()? closedAt, int? Function()? comments, Uri? commentsUrl, int? Function()? commits, Uri? commitsUrl, DateTime? createdAt, int? Function()? deletions, Uri? diffUrl, bool? draft, WebhookPullRequestAutoMergeDisabledPullRequestHead? head, Uri? htmlUrl, int? id, Uri? issueUrl, List<WebhookPullRequestAutoMergeDisabledPullRequestLabels>? labels, bool? locked, bool? Function()? maintainerCanModify, String? Function()? mergeCommitSha, Omittable<bool?>? mergeable, String? Function()? mergeableState, Omittable<bool?>? merged, DateTime? Function()? mergedAt, Omittable<WebhookPullRequestAutoMergeDisabledPullRequestMergedBy?>? mergedBy, WebhookPullRequestAutoMergeDisabledPullRequestMilestone? Function()? milestone, String? nodeId, int? number, Uri? patchUrl, Omittable<bool?>? rebaseable, List<WebhookPullRequestAutoMergeDisabledPullRequestRequestedReviewers>? requestedReviewers, List<WebhookPullRequestAutoMergeDisabledPullRequestRequestedTeams>? requestedTeams, String? reviewCommentUrl, int? Function()? reviewComments, Uri? reviewCommentsUrl, WebhookPullRequestAutoMergeDisabledPullRequestState? state, Uri? statusesUrl, String? title, DateTime? updatedAt, Uri? url, WebhookPullRequestAutoMergeDisabledPullRequestUser? Function()? user, }) { return WebhookPullRequestAutoMergeDisabledPullRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequest &&
          links == other.links &&
