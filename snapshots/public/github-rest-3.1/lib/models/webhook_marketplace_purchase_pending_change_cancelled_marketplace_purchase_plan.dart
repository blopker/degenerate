...
factory WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel.fromJson(String json) { return switch (json) {
  ...
  'FLAT_RATE' => flatRate,
  'PER_UNIT' => perUnit,
  _ => WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel._(json),
}; }

static const WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel free = WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel._('FREE');

static const WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel flatRate = WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel._('FLAT_RATE');

static const WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel perUnit = WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel._('PER_UNIT');

static const List<WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel> values = [free, flatRate, perUnit];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel && other.value == value; } 
...
final WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel priceModel;
...
WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlan copyWith({List<String>? bullets, String? description, bool? hasFreeTrial, int? id, int? monthlyPriceInCents, String? name, WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlanPriceModel? priceModel, String? Function()? unitName, int? yearlyPriceInCents, }) { return WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlan(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlan &&
