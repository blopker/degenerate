...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesTransferredChangesNewIssueAssigneeType {const WebhookIssuesTransferredChangesNewIssueAssigneeType._(this.value);

factory WebhookIssuesTransferredChangesNewIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookIssuesTransferredChangesNewIssueAssigneeType._(json),
}; }

static const WebhookIssuesTransferredChangesNewIssueAssigneeType bot = WebhookIssuesTransferredChangesNewIssueAssigneeType._('Bot');

static const WebhookIssuesTransferredChangesNewIssueAssigneeType user = WebhookIssuesTransferredChangesNewIssueAssigneeType._('User');

static const WebhookIssuesTransferredChangesNewIssueAssigneeType organization = WebhookIssuesTransferredChangesNewIssueAssigneeType._('Organization');

static const List<WebhookIssuesTransferredChangesNewIssueAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesTransferredChangesNewIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesTransferredChangesNewIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssuesTransferredChangesNewIssueAssignee {const WebhookIssuesTransferredChangesNewIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesTransferredChangesNewIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssuesTransferredChangesNewIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssuesTransferredChangesNewIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesTransferredChangesNewIssueAssigneeType? type;
...
WebhookIssuesTransferredChangesNewIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesTransferredChangesNewIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesTransferredChangesNewIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesTransferredChangesNewIssueAssignee &&
