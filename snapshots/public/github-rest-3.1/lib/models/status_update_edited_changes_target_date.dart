...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class StatusUpdateEditedChangesTargetDate {const StatusUpdateEditedChangesTargetDate({this.from, this.to, });
