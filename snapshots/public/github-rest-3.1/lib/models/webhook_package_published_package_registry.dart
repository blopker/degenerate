...
final class WebhookPackagePublishedPackageRegistry {const WebhookPackagePublishedPackageRegistry({required this.aboutUrl, required this.name, required this.type, required this.url, required this.vendor, });
