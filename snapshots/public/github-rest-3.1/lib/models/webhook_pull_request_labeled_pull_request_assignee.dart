...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLabeledPullRequestAssigneeType {const WebhookPullRequestLabeledPullRequestAssigneeType._(this.value);

factory WebhookPullRequestLabeledPullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestLabeledPullRequestAssigneeType bot = WebhookPullRequestLabeledPullRequestAssigneeType._('Bot');

static const WebhookPullRequestLabeledPullRequestAssigneeType user = WebhookPullRequestLabeledPullRequestAssigneeType._('User');

static const WebhookPullRequestLabeledPullRequestAssigneeType organization = WebhookPullRequestLabeledPullRequestAssigneeType._('Organization');

static const WebhookPullRequestLabeledPullRequestAssigneeType mannequin = WebhookPullRequestLabeledPullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestLabeledPullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLabeledPullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLabeledPullRequestAssigneeType($value)'; } 
 }
@immutable final class WebhookPullRequestLabeledPullRequestAssignee {const WebhookPullRequestLabeledPullRequestAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLabeledPullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLabeledPullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestLabeledPullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLabeledPullRequestAssigneeType? type;
...
WebhookPullRequestLabeledPullRequestAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLabeledPullRequestAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLabeledPullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLabeledPullRequestAssignee &&
...
@override String toString() { return 'WebhookPullRequestLabeledPullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
