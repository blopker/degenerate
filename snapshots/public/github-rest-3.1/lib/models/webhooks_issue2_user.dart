...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksIssue2UserType {const WebhooksIssue2UserType._(this.value);

factory WebhooksIssue2UserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhooksIssue2UserType organization = WebhooksIssue2UserType._('Organization');
...
@override String toString() { return 'WebhooksIssue2UserType($value)'; } 
 }
@immutable final class WebhooksIssue2User {const WebhooksIssue2User({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksIssue2User.fromJson(Map<String, dynamic> json) { return WebhooksIssue2User(
  ...
  type: json['type'] != null ? WebhooksIssue2UserType.fromJson(json['type'] as String) : null,
...
final WebhooksIssue2UserType? type;
...
WebhooksIssue2User copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksIssue2UserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksIssue2User(
