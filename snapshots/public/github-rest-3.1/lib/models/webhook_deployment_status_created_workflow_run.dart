...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_deployment_status_created_workflow_run_actor.dart';import 'webhook_deployment_status_created_workflow_run_head_repository.dart';import 'webhook_deployment_status_created_workflow_run_pull_requests.dart';import 'webhook_deployment_status_created_workflow_run_referenced_workflows.dart';import 'webhook_deployment_status_created_workflow_run_repository.dart';import 'webhook_deployment_status_created_workflow_run_triggering_actor.dart';@immutable final class WebhookDeploymentStatusCreatedWorkflowRunConclusion {const WebhookDeploymentStatusCreatedWorkflowRunConclusion._(this.value);

factory WebhookDeploymentStatusCreatedWorkflowRunConclusion.fromJson(String json) { return switch (json) {
  'success' => success,
  'failure' => failure,
  'neutral' => neutral,
  'cancelled' => cancelled,
...
static const WebhookDeploymentStatusCreatedWorkflowRunConclusion success = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('success');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion failure = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('failure');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion neutral = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('neutral');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion cancelled = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('cancelled');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion timedOut = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('timed_out');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion actionRequired = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('action_required');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion stale = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('stale');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion $null = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('null');

static const WebhookDeploymentStatusCreatedWorkflowRunConclusion startupFailure = WebhookDeploymentStatusCreatedWorkflowRunConclusion._('startup_failure');

static const List<WebhookDeploymentStatusCreatedWorkflowRunConclusion> values = [success, failure, neutral, cancelled, timedOut, actionRequired, stale, $null, startupFailure];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedWorkflowRunConclusion && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedWorkflowRunConclusion($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedWorkflowRunStatus {const WebhookDeploymentStatusCreatedWorkflowRunStatus._(this.value);
...
factory WebhookDeploymentStatusCreatedWorkflowRun.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedWorkflowRun(
  actor: json['actor'] != null ? WebhookDeploymentStatusCreatedWorkflowRunActor.fromJson(json['actor'] as Map<String, dynamic>) : null,
  ...
  conclusion: json['conclusion'] != null ? WebhookDeploymentStatusCreatedWorkflowRunConclusion.fromJson(json['conclusion'] as String) : null,
  createdAt: DateTime.parse(json['created_at'] as String),
  displayTitle: json['display_title'] as String,
  event: json['event'] as String,
  headBranch: json['head_branch'] as String,
  headCommit: json.containsKey('head_commit') ? Omittable(json['head_commit']) : const Omittable.absent(),
  ...
  previousAttemptUrl: json.containsKey('previous_attempt_url') ? Omittable(json['previous_attempt_url']) : const Omittable.absent(),
  ...
  referencedWorkflows: json.containsKey('referenced_workflows') ? Omittable((json['referenced_workflows'] as List<dynamic>?)?.map((e) => WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows.fromJson(e as Map<String, dynamic>)).toList()) : const Omittable.absent(),
  ...
  status: WebhookDeploymentStatusCreatedWorkflowRunStatus.fromJson(json['status'] as String),
  triggeringActor: json['triggering_actor'] != null ? WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor.fromJson(json['triggering_actor'] as Map<String, dynamic>) : null,
...
final WebhookDeploymentStatusCreatedWorkflowRunActor? actor;
...
final WebhookDeploymentStatusCreatedWorkflowRunConclusion? conclusion;
...
final Omittable<dynamic> headCommit;
...
final Omittable<dynamic> previousAttemptUrl;

final List<WebhookDeploymentStatusCreatedWorkflowRunPullRequests> pullRequests;

final Omittable<List<WebhookDeploymentStatusCreatedWorkflowRunReferencedWorkflows>?> referencedWorkflows;

final WebhookDeploymentStatusCreatedWorkflowRunRepository? repository;
...
final WebhookDeploymentStatusCreatedWorkflowRunStatus status;

final WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor? triggeringActor;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedWorkflowRun &&
          actor == other.actor &&
