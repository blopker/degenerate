...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksCommentUserType {const WebhooksCommentUserType._(this.value);

factory WebhooksCommentUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhooksCommentUserType._(json),
}; }

static const WebhooksCommentUserType bot = WebhooksCommentUserType._('Bot');

static const WebhooksCommentUserType user = WebhooksCommentUserType._('User');

static const WebhooksCommentUserType organization = WebhooksCommentUserType._('Organization');

static const List<WebhooksCommentUserType> values = [bot, user, organization];
...
factory WebhooksCommentUser.fromJson(Map<String, dynamic> json) { return WebhooksCommentUser(
  ...
  type: json['type'] != null ? WebhooksCommentUserType.fromJson(json['type'] as String) : null,
...
final WebhooksCommentUserType? type;
...
WebhooksCommentUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksCommentUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksCommentUser(
