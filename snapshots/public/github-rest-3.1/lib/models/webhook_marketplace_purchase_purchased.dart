...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhooks_marketplace_purchase.dart';import 'webhooks_previous_marketplace_purchase.dart';final class WebhookMarketplacePurchasePurchasedAction {const WebhookMarketplacePurchasePurchasedAction._(this.value);
...
final class WebhookMarketplacePurchasePurchased {const WebhookMarketplacePurchasePurchased({required this.action, required this.effectiveDate, this.enterprise, this.installation, required this.marketplacePurchase, this.organization, this.previousMarketplacePurchase, this.repository, required this.sender, });
