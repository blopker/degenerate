...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'runner_label.dart';final class ActionsSetCustomLabelsForSelfHostedRunnerForRepoResponse {const ActionsSetCustomLabelsForSelfHostedRunnerForRepoResponse({required this.totalCount, required this.labels, });
