...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestEnqueuedPullRequestUserType {const WebhookPullRequestEnqueuedPullRequestUserType._(this.value);

factory WebhookPullRequestEnqueuedPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestEnqueuedPullRequestUserType bot = WebhookPullRequestEnqueuedPullRequestUserType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestUserType user = WebhookPullRequestEnqueuedPullRequestUserType._('User');

static const WebhookPullRequestEnqueuedPullRequestUserType organization = WebhookPullRequestEnqueuedPullRequestUserType._('Organization');

static const WebhookPullRequestEnqueuedPullRequestUserType mannequin = WebhookPullRequestEnqueuedPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestEnqueuedPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestUser {const WebhookPullRequestEnqueuedPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestEnqueuedPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestUserType? type;
...
WebhookPullRequestEnqueuedPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestEnqueuedPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestUser &&
