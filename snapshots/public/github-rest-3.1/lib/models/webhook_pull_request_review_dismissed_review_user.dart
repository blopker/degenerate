...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestReviewDismissedReviewUserType {const WebhookPullRequestReviewDismissedReviewUserType._(this.value);

factory WebhookPullRequestReviewDismissedReviewUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestReviewDismissedReviewUserType bot = WebhookPullRequestReviewDismissedReviewUserType._('Bot');

static const WebhookPullRequestReviewDismissedReviewUserType user = WebhookPullRequestReviewDismissedReviewUserType._('User');

static const WebhookPullRequestReviewDismissedReviewUserType organization = WebhookPullRequestReviewDismissedReviewUserType._('Organization');

static const WebhookPullRequestReviewDismissedReviewUserType mannequin = WebhookPullRequestReviewDismissedReviewUserType._('Mannequin');

static const List<WebhookPullRequestReviewDismissedReviewUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewDismissedReviewUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewDismissedReviewUserType($value)'; } 
 }
@immutable final class WebhookPullRequestReviewDismissedReviewUser {const WebhookPullRequestReviewDismissedReviewUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewDismissedReviewUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedReviewUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewDismissedReviewUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewDismissedReviewUserType? type;
...
WebhookPullRequestReviewDismissedReviewUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestReviewDismissedReviewUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestReviewDismissedReviewUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewDismissedReviewUser &&
