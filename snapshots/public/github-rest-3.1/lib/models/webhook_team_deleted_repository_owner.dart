...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamDeletedRepositoryOwnerType {const WebhookTeamDeletedRepositoryOwnerType._(this.value);

factory WebhookTeamDeletedRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookTeamDeletedRepositoryOwnerType._(json),
}; }

static const WebhookTeamDeletedRepositoryOwnerType bot = WebhookTeamDeletedRepositoryOwnerType._('Bot');

static const WebhookTeamDeletedRepositoryOwnerType user = WebhookTeamDeletedRepositoryOwnerType._('User');

static const WebhookTeamDeletedRepositoryOwnerType organization = WebhookTeamDeletedRepositoryOwnerType._('Organization');

static const List<WebhookTeamDeletedRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookTeamDeletedRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookTeamDeletedRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookTeamDeletedRepositoryOwner {const WebhookTeamDeletedRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookTeamDeletedRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookTeamDeletedRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookTeamDeletedRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookTeamDeletedRepositoryOwnerType? type;
...
WebhookTeamDeletedRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookTeamDeletedRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookTeamDeletedRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamDeletedRepositoryOwner &&
...
@override String toString() { return 'WebhookTeamDeletedRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
