...
factory WebhookPullRequestEnqueuedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequest(
  ...
  mergedBy: json.containsKey('merged_by') ? Omittable(json['merged_by'] != null ? WebhookPullRequestEnqueuedPullRequestMergedBy.fromJson(json['merged_by'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookPullRequestEnqueuedPullRequestMergedBy?> mergedBy;
