...
final class WebhookPullRequestEnqueuedPullRequestAuthorAssociation {const WebhookPullRequestEnqueuedPullRequestAuthorAssociation._(this.value);
...
final class WebhookPullRequestEnqueuedPullRequestState {const WebhookPullRequestEnqueuedPullRequestState._(this.value);
...
factory WebhookPullRequestEnqueuedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequest(
  ...
  assignees: (json['assignees'] as List<dynamic>).map((e) => WebhookPullRequestEnqueuedPullRequestAssignees.fromJson(e as Map<String, dynamic>)).toList(),
