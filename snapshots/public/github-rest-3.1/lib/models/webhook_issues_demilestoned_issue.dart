...
static const WebhookIssuesDemilestonedIssueActiveLockReason resolved = WebhookIssuesDemilestonedIssueActiveLockReason._('resolved');

static const WebhookIssuesDemilestonedIssueActiveLockReason offTopic = WebhookIssuesDemilestonedIssueActiveLockReason._('off-topic');

static const WebhookIssuesDemilestonedIssueActiveLockReason tooHeated = WebhookIssuesDemilestonedIssueActiveLockReason._('too heated');

static const WebhookIssuesDemilestonedIssueActiveLockReason spam = WebhookIssuesDemilestonedIssueActiveLockReason._('spam');

static const WebhookIssuesDemilestonedIssueActiveLockReason $null = WebhookIssuesDemilestonedIssueActiveLockReason._('null');

static const List<WebhookIssuesDemilestonedIssueActiveLockReason> values = [resolved, offTopic, tooHeated, spam, $null];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssueActiveLockReason && other.value == value; } 
...
static const WebhookIssuesDemilestonedIssueAuthorAssociation collaborator = WebhookIssuesDemilestonedIssueAuthorAssociation._('COLLABORATOR');

static const WebhookIssuesDemilestonedIssueAuthorAssociation contributor = WebhookIssuesDemilestonedIssueAuthorAssociation._('CONTRIBUTOR');

static const WebhookIssuesDemilestonedIssueAuthorAssociation firstTimer = WebhookIssuesDemilestonedIssueAuthorAssociation._('FIRST_TIMER');

static const WebhookIssuesDemilestonedIssueAuthorAssociation firstTimeContributor = WebhookIssuesDemilestonedIssueAuthorAssociation._('FIRST_TIME_CONTRIBUTOR');

static const WebhookIssuesDemilestonedIssueAuthorAssociation mannequin = WebhookIssuesDemilestonedIssueAuthorAssociation._('MANNEQUIN');

static const WebhookIssuesDemilestonedIssueAuthorAssociation member = WebhookIssuesDemilestonedIssueAuthorAssociation._('MEMBER');

static const WebhookIssuesDemilestonedIssueAuthorAssociation none = WebhookIssuesDemilestonedIssueAuthorAssociation._('NONE');

static const WebhookIssuesDemilestonedIssueAuthorAssociation owner = WebhookIssuesDemilestonedIssueAuthorAssociation._('OWNER');

static const List<WebhookIssuesDemilestonedIssueAuthorAssociation> values = [collaborator, contributor, firstTimer, firstTimeContributor, mannequin, member, none, owner];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssueAuthorAssociation && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
...
static const WebhookIssuesDemilestonedIssueState open = WebhookIssuesDemilestonedIssueState._('open');

static const WebhookIssuesDemilestonedIssueState closed = WebhookIssuesDemilestonedIssueState._('closed');

static const List<WebhookIssuesDemilestonedIssueState> values = [open, closed];
...
factory WebhookIssuesDemilestonedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssue(
  ...
  assignee: json.containsKey('assignee') ? Omittable(json['assignee'] != null ? WebhookIssuesDemilestonedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  assignees: (json['assignees'] as List<dynamic>).map((e) => e == null ? null : WebhookIssuesDemilestonedIssueAssignees.fromJson(e as Map<String, dynamic>)).toList(),
  authorAssociation: WebhookIssuesDemilestonedIssueAuthorAssociation.fromJson(json['author_association'] as String),
  ...
  milestone: json['milestone'] != null ? WebhookIssuesDemilestonedIssueMilestone.fromJson(json['milestone'] as Map<String, dynamic>) : null,
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  performedViaGithubApp: json.containsKey('performed_via_github_app') ? Omittable(json['performed_via_github_app'] != null ? WebhookIssuesDemilestonedIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  pullRequest: json['pull_request'] != null ? WebhookIssuesDemilestonedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>) : null,
  reactions: WebhookIssuesDemilestonedIssueReactions.fromJson(json['reactions'] as Map<String, dynamic>),
  ...
  state: json['state'] != null ? WebhookIssuesDemilestonedIssueState.fromJson(json['state'] as String) : null,
  ...
  user: json['user'] != null ? WebhookIssuesDemilestonedIssueUser.fromJson(json['user'] as Map<String, dynamic>) : null,
); }

final WebhookIssuesDemilestonedIssueActiveLockReason? activeLockReason;

final Omittable<WebhookIssuesDemilestonedIssueAssignee?> assignee;

final List<WebhookIssuesDemilestonedIssueAssignees?> assignees;

/// How the author is associated with the repository.
final WebhookIssuesDemilestonedIssueAuthorAssociation authorAssociation;
...
final WebhookIssuesDemilestonedIssueMilestone? milestone;
...
final Omittable<WebhookIssuesDemilestonedIssuePerformedViaGithubApp?> performedViaGithubApp;

final WebhookIssuesDemilestonedIssuePullRequest? pullRequest;

final WebhookIssuesDemilestonedIssueReactions reactions;
...
/// State of the issue; either 'open' or 'closed'
final WebhookIssuesDemilestonedIssueState? state;
...
final WebhookIssuesDemilestonedIssueUser? user;
...
WebhookIssuesDemilestonedIssue copyWith({WebhookIssuesDemilestonedIssueActiveLockReason? Function()? activeLockReason, Omittable<WebhookIssuesDemilestonedIssueAssignee?>? assignee, List<WebhookIssuesDemilestonedIssueAssignees?>? assignees, WebhookIssuesDemilestonedIssueAuthorAssociation? authorAssociation, String? Function()? body, DateTime? Function()? closedAt, int? comments, Uri? commentsUrl, DateTime? createdAt, bool? Function()? draft, Uri? eventsUrl, Uri? htmlUrl, int? id, List<WebhookIssuesDemilestonedIssueLabels?>? Function()? labels, String? labelsUrl, bool? Function()? locked, WebhookIssuesDemilestonedIssueMilestone? Function()? milestone, String? nodeId, int? number, Omittable<WebhookIssuesDemilestonedIssuePerformedViaGithubApp?>? performedViaGithubApp, WebhookIssuesDemilestonedIssuePullRequest? Function()? pullRequest, WebhookIssuesDemilestonedIssueReactions? reactions, Uri? repositoryUrl, Omittable<IssueComment?>? pinnedComment, SubIssuesSummary? Function()? subIssuesSummary, IssueDependenciesSummary? Function()? issueDependenciesSummary, List<IssueFieldValue>? Function()? issueFieldValues, WebhookIssuesDemilestonedIssueState? Function()? state, Omittable<String?>? stateReason, Uri? Function()? timelineUrl, String? title, Omittable<IssueType?>? type, DateTime? updatedAt, Uri? url, WebhookIssuesDemilestonedIssueUser? Function()? user, }) { return WebhookIssuesDemilestonedIssue(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDemilestonedIssue &&
