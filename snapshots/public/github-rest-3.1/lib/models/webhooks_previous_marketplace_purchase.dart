...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_previous_marketplace_purchase_account.dart';import 'webhooks_previous_marketplace_purchase_plan.dart';@immutable final class WebhooksPreviousMarketplacePurchase {const WebhooksPreviousMarketplacePurchase({required this.account, required this.billingCycle, required this.freeTrialEndsOn, required this.onFreeTrial, required this.plan, required this.unitCount, this.nextBillingDate = const Omittable.absent(), });
...
WebhooksPreviousMarketplacePurchase copyWith({WebhooksPreviousMarketplacePurchaseAccount? account, String? billingCycle, dynamic Function()? freeTrialEndsOn, Omittable<String?>? nextBillingDate, bool? onFreeTrial, WebhooksPreviousMarketplacePurchasePlan? plan, int? unitCount, }) { return WebhooksPreviousMarketplacePurchase(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksPreviousMarketplacePurchase &&
...
@override String toString() { return 'WebhooksPreviousMarketplacePurchase(account: $account, billingCycle: $billingCycle, freeTrialEndsOn: $freeTrialEndsOn, nextBillingDate: $nextBillingDate, onFreeTrial: $onFreeTrial, plan: $plan, unitCount: $unitCount)'; } 
 }
