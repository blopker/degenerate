...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType {const WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType._(this.value);

factory WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType bot = WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType._('Bot');

static const WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType user = WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType._('User');

static const WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType organization = WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType($value)'; } 
 }
@immutable final class WebhookPullRequestAutoMergeDisabledPullRequestAssignees {const WebhookPullRequestAutoMergeDisabledPullRequestAssignees({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, });

factory WebhookPullRequestAutoMergeDisabledPullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType? type;
...
WebhookPullRequestAutoMergeDisabledPullRequestAssignees copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAutoMergeDisabledPullRequestAssigneesType? Function()? type, Uri? Function()? url, }) { return WebhookPullRequestAutoMergeDisabledPullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeDisabledPullRequestAssignees &&
