...
import 'webhook_pull_request_enqueued_pull_request_auto_merge_enabled_by.dart';/// The merge method to use.
final class WebhookPullRequestEnqueuedPullRequestAutoMergeMergeMethod {const WebhookPullRequestEnqueuedPullRequestAutoMergeMergeMethod._(this.value);
...
final class WebhookPullRequestEnqueuedPullRequestAutoMerge {const WebhookPullRequestEnqueuedPullRequestAutoMerge({required this.commitMessage, required this.commitTitle, required this.enabledBy, required this.mergeMethod, });
