...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentUnpinnedIssueAssigneeType {const WebhookIssueCommentUnpinnedIssueAssigneeType._(this.value);

factory WebhookIssueCommentUnpinnedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssueCommentUnpinnedIssueAssigneeType bot = WebhookIssueCommentUnpinnedIssueAssigneeType._('Bot');

static const WebhookIssueCommentUnpinnedIssueAssigneeType user = WebhookIssueCommentUnpinnedIssueAssigneeType._('User');

static const WebhookIssueCommentUnpinnedIssueAssigneeType organization = WebhookIssueCommentUnpinnedIssueAssigneeType._('Organization');

static const WebhookIssueCommentUnpinnedIssueAssigneeType mannequin = WebhookIssueCommentUnpinnedIssueAssigneeType._('Mannequin');

static const List<WebhookIssueCommentUnpinnedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentUnpinnedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentUnpinnedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssueCommentUnpinnedIssueAssignee {const WebhookIssueCommentUnpinnedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentUnpinnedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentUnpinnedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssueCommentUnpinnedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentUnpinnedIssueAssigneeType? type;
...
WebhookIssueCommentUnpinnedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentUnpinnedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentUnpinnedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentUnpinnedIssueAssignee &&
...
@override String toString() { return 'WebhookIssueCommentUnpinnedIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
