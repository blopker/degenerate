...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType {const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType._(this.value);

factory WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType bot = WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType._('Bot');

static const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType user = WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType._('User');

static const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType organization = WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType._('Organization');

static const List<WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType($value)'; } 
 }
@immutable final class WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner {const WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType? type;
...
WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookWorkflowRunCompletedWorkflowRunRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner &&
...
@override String toString() { return 'WebhookWorkflowRunCompletedWorkflowRunRepositoryOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
