...
final class WebhookInstallationRepositoriesAddedRepositoriesRemoved {const WebhookInstallationRepositoriesAddedRepositoriesRemoved({this.fullName, this.id, this.name, this.nodeId, this.private, });
