...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_team_edited_repository_license.dart';import 'webhook_team_edited_repository_owner.dart';import 'webhook_team_edited_repository_permissions.dart';final class WebhookTeamEditedRepositoryVisibility {const WebhookTeamEditedRepositoryVisibility._(this.value);
...
factory WebhookTeamEditedRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamEditedRepository(
  ...
  license: json['license'] != null ? WebhookTeamEditedRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  ...
  owner: json['owner'] != null ? WebhookTeamEditedRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  permissions: json['permissions'] != null ? WebhookTeamEditedRepositoryPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  ...
  visibility: WebhookTeamEditedRepositoryVisibility.fromJson(json['visibility'] as String),
...
final WebhookTeamEditedRepositoryLicense? license;
...
final WebhookTeamEditedRepositoryOwner? owner;

final WebhookTeamEditedRepositoryPermissions? permissions;
...
final WebhookTeamEditedRepositoryVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamEditedRepository &&
