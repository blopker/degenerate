...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User17Type {const User17Type._(this.value);

factory User17Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User17Type bot = User17Type._('Bot');

static const User17Type user = User17Type._('User');

static const User17Type organization = User17Type._('Organization');

static const List<User17Type> values = [bot, user, organization];
...
factory User17.fromJson(Map<String, dynamic> json) { return User17(
  ...
  type: json['type'] != null ? User17Type.fromJson(json['type'] as String) : null,
...
User17 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User17Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User17(
