...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestLockedPullRequestBaseUserType {const WebhookPullRequestLockedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestLockedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestLockedPullRequestBaseUserType bot = WebhookPullRequestLockedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestLockedPullRequestBaseUserType user = WebhookPullRequestLockedPullRequestBaseUserType._('User');

static const WebhookPullRequestLockedPullRequestBaseUserType organization = WebhookPullRequestLockedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestLockedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestLockedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestLockedPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestLockedPullRequestBaseUser {const WebhookPullRequestLockedPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestLockedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestLockedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestLockedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestLockedPullRequestBaseUserType? type;
...
WebhookPullRequestLockedPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestLockedPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestLockedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestLockedPullRequestBaseUser &&
