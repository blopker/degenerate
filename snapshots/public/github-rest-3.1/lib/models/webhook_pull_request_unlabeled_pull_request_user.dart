...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestUnlabeledPullRequestUserType {const WebhookPullRequestUnlabeledPullRequestUserType._(this.value);

factory WebhookPullRequestUnlabeledPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestUnlabeledPullRequestUserType._(json),
}; }

static const WebhookPullRequestUnlabeledPullRequestUserType bot = WebhookPullRequestUnlabeledPullRequestUserType._('Bot');

static const WebhookPullRequestUnlabeledPullRequestUserType user = WebhookPullRequestUnlabeledPullRequestUserType._('User');

static const WebhookPullRequestUnlabeledPullRequestUserType organization = WebhookPullRequestUnlabeledPullRequestUserType._('Organization');

static const WebhookPullRequestUnlabeledPullRequestUserType mannequin = WebhookPullRequestUnlabeledPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestUnlabeledPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnlabeledPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestUnlabeledPullRequestUser {const WebhookPullRequestUnlabeledPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestUnlabeledPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnlabeledPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestUnlabeledPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestUnlabeledPullRequestUserType? type;
...
WebhookPullRequestUnlabeledPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestUnlabeledPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestUnlabeledPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnlabeledPullRequestUser &&
...
@override String toString() { return 'WebhookPullRequestUnlabeledPullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
