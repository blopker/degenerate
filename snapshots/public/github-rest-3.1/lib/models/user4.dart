...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class User4Type {const User4Type._(this.value);

factory User4Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const User4Type bot = User4Type._('Bot');

static const User4Type user = User4Type._('User');

static const User4Type organization = User4Type._('Organization');

static const User4Type mannequin = User4Type._('Mannequin');

static const List<User4Type> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is User4Type && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'User4Type($value)'; } 
 }
@immutable final class User4 {const User4({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory User4.fromJson(Map<String, dynamic> json) { return User4(
  ...
  type: json['type'] != null ? User4Type.fromJson(json['type'] as String) : null,
...
User4 copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, User4Type? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return User4(
