...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookCheckSuiteRequestedCheckSuiteAppOwnerType {const WebhookCheckSuiteRequestedCheckSuiteAppOwnerType._(this.value);

factory WebhookCheckSuiteRequestedCheckSuiteAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookCheckSuiteRequestedCheckSuiteAppOwnerType._(json),
}; }

static const WebhookCheckSuiteRequestedCheckSuiteAppOwnerType bot = WebhookCheckSuiteRequestedCheckSuiteAppOwnerType._('Bot');

static const WebhookCheckSuiteRequestedCheckSuiteAppOwnerType user = WebhookCheckSuiteRequestedCheckSuiteAppOwnerType._('User');

static const WebhookCheckSuiteRequestedCheckSuiteAppOwnerType organization = WebhookCheckSuiteRequestedCheckSuiteAppOwnerType._('Organization');

static const List<WebhookCheckSuiteRequestedCheckSuiteAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookCheckSuiteRequestedCheckSuiteAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookCheckSuiteRequestedCheckSuiteAppOwnerType($value)'; } 
 }
@immutable final class WebhookCheckSuiteRequestedCheckSuiteAppOwner {const WebhookCheckSuiteRequestedCheckSuiteAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookCheckSuiteRequestedCheckSuiteAppOwner.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteRequestedCheckSuiteAppOwner(
  ...
  type: json['type'] != null ? WebhookCheckSuiteRequestedCheckSuiteAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookCheckSuiteRequestedCheckSuiteAppOwnerType? type;
...
WebhookCheckSuiteRequestedCheckSuiteAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookCheckSuiteRequestedCheckSuiteAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookCheckSuiteRequestedCheckSuiteAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookCheckSuiteRequestedCheckSuiteAppOwner &&
...
@override String toString() { return 'WebhookCheckSuiteRequestedCheckSuiteAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
