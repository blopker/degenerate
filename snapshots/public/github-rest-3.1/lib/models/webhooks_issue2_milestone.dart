...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhooks_issue2_milestone_creator.dart';/// The state of the milestone.
@immutable final class WebhooksIssue2MilestoneState {const WebhooksIssue2MilestoneState._(this.value);
