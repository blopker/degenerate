...
import 'webhooks_issue2_milestone_creator.dart';/// The state of the milestone.
...
factory WebhooksIssue2Milestone.fromJson(Map<String, dynamic> json) { return WebhooksIssue2Milestone(
  ...
  creator: json['creator'] != null ? WebhooksIssue2MilestoneCreator.fromJson(json['creator'] as Map<String, dynamic>) : null,
  ...
  state: WebhooksIssue2MilestoneState.fromJson(json['state'] as String),
...
final WebhooksIssue2MilestoneCreator? creator;
...
final WebhooksIssue2MilestoneState state;
...
WebhooksIssue2Milestone copyWith({DateTime? Function()? closedAt, int? closedIssues, DateTime? createdAt, WebhooksIssue2MilestoneCreator? Function()? creator, String? Function()? description, DateTime? Function()? dueOn, Uri? htmlUrl, int? id, Uri? labelsUrl, String? nodeId, int? number, int? openIssues, WebhooksIssue2MilestoneState? state, String? title, DateTime? updatedAt, Uri? url, }) { return WebhooksIssue2Milestone(
