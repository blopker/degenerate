...
final class CodeScanningDeleteAnalysisResponse503 {const CodeScanningDeleteAnalysisResponse503({this.code, this.message, this.documentationUrl, });
...
@override String toString() { return 'CodeScanningDeleteAnalysisResponse503(code: $code, message: $message, documentationUrl: $documentationUrl)'; } 
 }
