...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentCreatedDeploymentCreatorType {const WebhookDeploymentCreatedDeploymentCreatorType._(this.value);

factory WebhookDeploymentCreatedDeploymentCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentCreatedDeploymentCreatorType._(json),
}; }

static const WebhookDeploymentCreatedDeploymentCreatorType bot = WebhookDeploymentCreatedDeploymentCreatorType._('Bot');

static const WebhookDeploymentCreatedDeploymentCreatorType user = WebhookDeploymentCreatedDeploymentCreatorType._('User');

static const WebhookDeploymentCreatedDeploymentCreatorType organization = WebhookDeploymentCreatedDeploymentCreatorType._('Organization');

static const List<WebhookDeploymentCreatedDeploymentCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentCreatedDeploymentCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentCreatedDeploymentCreatorType($value)'; } 
 }
@immutable final class WebhookDeploymentCreatedDeploymentCreator {const WebhookDeploymentCreatedDeploymentCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentCreatedDeploymentCreator.fromJson(Map<String, dynamic> json) { return WebhookDeploymentCreatedDeploymentCreator(
  ...
  type: json['type'] != null ? WebhookDeploymentCreatedDeploymentCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentCreatedDeploymentCreatorType? type;
...
WebhookDeploymentCreatedDeploymentCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentCreatedDeploymentCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentCreatedDeploymentCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentCreatedDeploymentCreator &&
...
@override String toString() { return 'WebhookDeploymentCreatedDeploymentCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
