...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RepositoryPermissions {const RepositoryPermissions({required this.admin, required this.pull, required this.push, this.triage, this.maintain, });
...
RepositoryPermissions copyWith({bool? admin, bool? pull, bool Function()? triage, bool? push, bool Function()? maintain, }) { return RepositoryPermissions(
...
@override String toString() { return 'RepositoryPermissions(admin: $admin, pull: $pull, triage: $triage, push: $push, maintain: $maintain)'; } 
 }
