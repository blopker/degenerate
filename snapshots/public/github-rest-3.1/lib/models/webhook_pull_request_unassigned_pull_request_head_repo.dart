...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_pull_request_unassigned_pull_request_head_repo_license.dart';import 'webhook_pull_request_unassigned_pull_request_head_repo_owner.dart';import 'webhook_pull_request_unassigned_pull_request_head_repo_permissions.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestUnassignedPullRequestHeadRepoVisibility {const WebhookPullRequestUnassignedPullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestUnassignedPullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const WebhookPullRequestUnassignedPullRequestHeadRepoVisibility public = WebhookPullRequestUnassignedPullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestUnassignedPullRequestHeadRepoVisibility private = WebhookPullRequestUnassignedPullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestUnassignedPullRequestHeadRepoVisibility internal = WebhookPullRequestUnassignedPullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestUnassignedPullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestUnassignedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestUnassignedPullRequestHeadRepo(
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: json['license'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>) : null,
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: json['owner'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>) : null,
  ...
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestUnassignedPullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestUnassignedPullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestUnassignedPullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestUnassignedPullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestUnassignedPullRequestHeadRepoOwner? owner;

final WebhookPullRequestUnassignedPullRequestHeadRepoPermissions? permissions;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestUnassignedPullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestUnassignedPullRequestHeadRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestUnassignedPullRequestHeadRepo &&
