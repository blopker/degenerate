...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestAutoMergeEnabledPullRequestUserType {const WebhookPullRequestAutoMergeEnabledPullRequestUserType._(this.value);

factory WebhookPullRequestAutoMergeEnabledPullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestAutoMergeEnabledPullRequestUserType._(json),
}; }

static const WebhookPullRequestAutoMergeEnabledPullRequestUserType bot = WebhookPullRequestAutoMergeEnabledPullRequestUserType._('Bot');

static const WebhookPullRequestAutoMergeEnabledPullRequestUserType user = WebhookPullRequestAutoMergeEnabledPullRequestUserType._('User');

static const WebhookPullRequestAutoMergeEnabledPullRequestUserType organization = WebhookPullRequestAutoMergeEnabledPullRequestUserType._('Organization');

static const WebhookPullRequestAutoMergeEnabledPullRequestUserType mannequin = WebhookPullRequestAutoMergeEnabledPullRequestUserType._('Mannequin');

static const List<WebhookPullRequestAutoMergeEnabledPullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestAutoMergeEnabledPullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestAutoMergeEnabledPullRequestUserType($value)'; } 
 }
@immutable final class WebhookPullRequestAutoMergeEnabledPullRequestUser {const WebhookPullRequestAutoMergeEnabledPullRequestUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestAutoMergeEnabledPullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestAutoMergeEnabledPullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestAutoMergeEnabledPullRequestUserType? type;
...
WebhookPullRequestAutoMergeEnabledPullRequestUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestAutoMergeEnabledPullRequestUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestAutoMergeEnabledPullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestAutoMergeEnabledPullRequestUser &&
