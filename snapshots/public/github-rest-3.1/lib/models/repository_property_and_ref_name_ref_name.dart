...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RepositoryPropertyAndRefNameRefName {const RepositoryPropertyAndRefNameRefName({this.include, this.exclude, });

factory RepositoryPropertyAndRefNameRefName.fromJson(Map<String, dynamic> json) { return RepositoryPropertyAndRefNameRefName(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RepositoryPropertyAndRefNameRefName &&
...
@override String toString() { return 'RepositoryPropertyAndRefNameRefName(include: $include, exclude: $exclude)'; } 
 }
