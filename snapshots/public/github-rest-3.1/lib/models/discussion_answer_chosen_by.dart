...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class DiscussionAnswerChosenByType {const DiscussionAnswerChosenByType._(this.value);

factory DiscussionAnswerChosenByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const DiscussionAnswerChosenByType bot = DiscussionAnswerChosenByType._('Bot');

static const DiscussionAnswerChosenByType user = DiscussionAnswerChosenByType._('User');

static const DiscussionAnswerChosenByType organization = DiscussionAnswerChosenByType._('Organization');

static const List<DiscussionAnswerChosenByType> values = [bot, user, organization];
...
@override String toString() { return 'DiscussionAnswerChosenByType($value)'; } 
 }
@immutable final class DiscussionAnswerChosenBy {const DiscussionAnswerChosenBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory DiscussionAnswerChosenBy.fromJson(Map<String, dynamic> json) { return DiscussionAnswerChosenBy(
  ...
  type: json['type'] != null ? DiscussionAnswerChosenByType.fromJson(json['type'] as String) : null,
...
final DiscussionAnswerChosenByType? type;
...
DiscussionAnswerChosenBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, DiscussionAnswerChosenByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return DiscussionAnswerChosenBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DiscussionAnswerChosenBy &&
...
@override String toString() { return 'DiscussionAnswerChosenBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
