...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType {const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType._(this.value);

factory WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType bot = WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType._('Bot');

static const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType user = WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType._('User');

static const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType organization = WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType._('Organization');

static const List<WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType($value)'; } 
 }
@immutable final class WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner {const WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType? type;
...
WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesUnlockedIssuePerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesUnlockedIssuePerformedViaGithubAppOwner &&
