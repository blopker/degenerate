...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'webhook_deployment_review_approved_workflow_run_head_repository_owner.dart';@immutable final class WebhookDeploymentReviewApprovedWorkflowRunHeadRepository {const WebhookDeploymentReviewApprovedWorkflowRunHeadRepository({this.forksUrl, this.assigneesUrl, this.blobsUrl, this.branchesUrl, this.collaboratorsUrl, this.commentsUrl, this.commitsUrl, this.compareUrl, this.contentsUrl, this.contributorsUrl, this.deploymentsUrl, this.description = const Omittable.absent(), this.downloadsUrl, this.eventsUrl, this.fork, this.archiveUrl, this.fullName, this.gitCommitsUrl, this.gitRefsUrl, this.gitTagsUrl, this.hooksUrl, this.htmlUrl, this.id, this.issueCommentUrl, this.issueEventsUrl, this.issuesUrl, this.keysUrl, this.labelsUrl, this.languagesUrl, this.url, this.milestonesUrl, this.name, this.nodeId, this.notificationsUrl, this.owner, this.private, this.pullsUrl, this.releasesUrl, this.stargazersUrl, this.statusesUrl, this.subscribersUrl, this.subscriptionUrl, this.tagsUrl, this.teamsUrl, this.treesUrl, this.mergesUrl, });

factory WebhookDeploymentReviewApprovedWorkflowRunHeadRepository.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewApprovedWorkflowRunHeadRepository(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewApprovedWorkflowRunHeadRepository &&
