...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy.fromJson(String json) { return switch (json) {
  ...
  'closed' => closed,
  'secret' => secret,
  _ => WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy open = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy._('open');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy closed = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy._('closed');

static const WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy secret = WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy._('secret');

static const List<WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy> values = [open, closed, secret];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy && other.value == value; } 
...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParent.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParent(
  ...
  privacy: WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy.fromJson(json['privacy'] as String),
...
final WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy privacy;
...
WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParent copyWith({String? Function()? description, Uri? htmlUrl, int? id, String? membersUrl, String? name, String? nodeId, String? permission, WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParentPrivacy? privacy, Uri? repositoriesUrl, String? slug, Uri? url, }) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParent(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestRequestedTeamsParent &&
