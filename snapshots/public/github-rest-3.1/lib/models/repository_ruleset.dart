...
factory RepositoryRuleset.fromJson(Map<String, dynamic> json) { return RepositoryRuleset(
  ...
  conditions: json.containsKey('conditions') ? Omittable(json['conditions'] != null ? RepositoryRulesetConditions2.fromJson(json['conditions']) : null) : const Omittable.absent(),
