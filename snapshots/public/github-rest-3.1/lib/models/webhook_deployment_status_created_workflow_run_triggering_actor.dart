...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType {const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType._(this.value);

factory WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType._(json),
}; }

static const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType bot = WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType._('Bot');

static const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType user = WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType._('User');

static const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType organization = WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType._('Organization');

static const List<WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType($value)'; } 
 }
@immutable final class WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor {const WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor(
  ...
  type: json['type'] != null ? WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType? type;
...
WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentStatusCreatedWorkflowRunTriggeringActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor &&
