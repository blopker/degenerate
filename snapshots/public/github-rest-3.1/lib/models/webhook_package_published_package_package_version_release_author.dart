...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPackagePublishedPackagePackageVersionReleaseAuthorType {const WebhookPackagePublishedPackagePackageVersionReleaseAuthorType._(this.value);
...
factory WebhookPackagePublishedPackagePackageVersionReleaseAuthor.fromJson(Map<String, dynamic> json) { return WebhookPackagePublishedPackagePackageVersionReleaseAuthor(
  ...
  type: json['type'] != null ? WebhookPackagePublishedPackagePackageVersionReleaseAuthorType.fromJson(json['type'] as String) : null,
...
final WebhookPackagePublishedPackagePackageVersionReleaseAuthorType? type;
...
WebhookPackagePublishedPackagePackageVersionReleaseAuthor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPackagePublishedPackagePackageVersionReleaseAuthorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPackagePublishedPackagePackageVersionReleaseAuthor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPackagePublishedPackagePackageVersionReleaseAuthor &&
...
@override String toString() { return 'WebhookPackagePublishedPackagePackageVersionReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
