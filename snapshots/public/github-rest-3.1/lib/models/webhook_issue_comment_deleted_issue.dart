...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'issue_dependencies_summary.dart';import 'issue_type.dart';import 'sub_issues_summary.dart';import 'webhook_issue_comment_deleted_issue_assignee.dart';import 'webhook_issue_comment_deleted_issue_labels.dart';import 'webhook_issue_comment_deleted_issue_pull_request.dart';import 'webhook_issue_comment_deleted_issue_reactions.dart';import 'webhook_issue_comment_deleted_issue_user.dart';/// State of the issue; either 'open' or 'closed'
@immutable final class WebhookIssueCommentDeletedIssueState {const WebhookIssueCommentDeletedIssueState._(this.value);

factory WebhookIssueCommentDeletedIssueState.fromJson(String json) {return switch (json) {
  'open' => open,
  'closed' => closed,
  _ => WebhookIssueCommentDeletedIssueState._(json),
};}

static const WebhookIssueCommentDeletedIssueState open = WebhookIssueCommentDeletedIssueState._('open');

static const WebhookIssueCommentDeletedIssueState closed = WebhookIssueCommentDeletedIssueState._('closed');

static const List<WebhookIssueCommentDeletedIssueState> values = [open, closed];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is WebhookIssueCommentDeletedIssueState && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'WebhookIssueCommentDeletedIssueState($value)';}
}
...
factory WebhookIssueCommentDeletedIssue.fromJson(Map<String, dynamic> json) {return WebhookIssueCommentDeletedIssue(
  ...
  assignee: json['assignee'] != null ? WebhookIssueCommentDeletedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null,
  ...
  labels: (json['labels'] as List<dynamic>).map((e) => WebhookIssueCommentDeletedIssueLabels.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  pullRequest: json['pull_request'] != null ? WebhookIssueCommentDeletedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>) : null,
  reactions: WebhookIssueCommentDeletedIssueReactions.fromJson(json['reactions'] as Map<String, dynamic>),
  ...
  state: WebhookIssueCommentDeletedIssueState.fromJson(json['state'] as String),
...
final WebhookIssueCommentDeletedIssueAssignee? assignee;
...
final List<WebhookIssueCommentDeletedIssueLabels> labels;
...
final WebhookIssueCommentDeletedIssuePullRequest? pullRequest;

final WebhookIssueCommentDeletedIssueReactions reactions;
...
final WebhookIssueCommentDeletedIssueState state;
...
WebhookIssueCommentDeletedIssue copyWith({String? Function()? activeLockReason, WebhookIssueCommentDeletedIssueAssignee? Function()? assignee, List<Map<String,dynamic>?>? assignees, String? authorAssociation, String? Function()? body, String? Function()? closedAt, int? comments, String? commentsUrl, String? createdAt, bool? Function()? draft, String? eventsUrl, String? htmlUrl, int? id, List<WebhookIssueCommentDeletedIssueLabels>? labels, String? labelsUrl, bool? locked, Map<String, dynamic>? Function()? milestone, String? nodeId, int? number, Omittable<Map<String,dynamic>?>? performedViaGithubApp, WebhookIssueCommentDeletedIssuePullRequest? Function()? pullRequest, WebhookIssueCommentDeletedIssueReactions? reactions, String? repositoryUrl, SubIssuesSummary? Function()? subIssuesSummary, IssueDependenciesSummary? Function()? issueDependenciesSummary, WebhookIssueCommentDeletedIssueState? state, Omittable<String?>? stateReason, String? Function()? timelineUrl, String? title, Omittable<IssueType?>? type, String? updatedAt, String? url, WebhookIssueCommentDeletedIssueUser? user, }) {return WebhookIssueCommentDeletedIssue(
