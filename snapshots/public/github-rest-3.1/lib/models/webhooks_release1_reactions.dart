...
final class WebhooksRelease1Reactions {const WebhooksRelease1Reactions({required this.plus1, required this.minus1, required this.confused, required this.eyes, required this.heart, required this.hooray, required this.laugh, required this.rocket, required this.totalCount, required this.url, });

factory WebhooksRelease1Reactions.fromJson(Map<String, dynamic> json) { return WebhooksRelease1Reactions(
...
WebhooksRelease1Reactions copyWith({int? plus1, int? minus1, int? confused, int? eyes, int? heart, int? hooray, int? laugh, int? rocket, int? totalCount, Uri? url, }) { return WebhooksRelease1Reactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksRelease1Reactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhooksRelease1Reactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
