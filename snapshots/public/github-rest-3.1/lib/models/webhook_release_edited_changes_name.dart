...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookReleaseEditedChangesName {const WebhookReleaseEditedChangesName({required this.from});
