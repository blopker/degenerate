...
final class WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstanceLocation {const WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstanceLocation({this.endColumn, this.endLine, this.path, this.startColumn, this.startLine, });
