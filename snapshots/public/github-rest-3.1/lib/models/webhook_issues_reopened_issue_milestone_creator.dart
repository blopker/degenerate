...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesReopenedIssueMilestoneCreatorType {const WebhookIssuesReopenedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesReopenedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookIssuesReopenedIssueMilestoneCreatorType bot = WebhookIssuesReopenedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesReopenedIssueMilestoneCreatorType user = WebhookIssuesReopenedIssueMilestoneCreatorType._('User');

static const WebhookIssuesReopenedIssueMilestoneCreatorType organization = WebhookIssuesReopenedIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesReopenedIssueMilestoneCreatorType mannequin = WebhookIssuesReopenedIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesReopenedIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesReopenedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesReopenedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesReopenedIssueMilestoneCreator {const WebhookIssuesReopenedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesReopenedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesReopenedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesReopenedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesReopenedIssueMilestoneCreatorType? type;
...
WebhookIssuesReopenedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesReopenedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesReopenedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesReopenedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesReopenedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
