...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDemilestonedIssueUserType {const WebhookIssuesDemilestonedIssueUserType._(this.value);

factory WebhookIssuesDemilestonedIssueUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesDemilestonedIssueUserType._(json),
}; }

static const WebhookIssuesDemilestonedIssueUserType bot = WebhookIssuesDemilestonedIssueUserType._('Bot');

static const WebhookIssuesDemilestonedIssueUserType user = WebhookIssuesDemilestonedIssueUserType._('User');

static const WebhookIssuesDemilestonedIssueUserType organization = WebhookIssuesDemilestonedIssueUserType._('Organization');

static const WebhookIssuesDemilestonedIssueUserType mannequin = WebhookIssuesDemilestonedIssueUserType._('Mannequin');

static const List<WebhookIssuesDemilestonedIssueUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssueUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesDemilestonedIssueUserType($value)'; } 
 }
@immutable final class WebhookIssuesDemilestonedIssueUser {const WebhookIssuesDemilestonedIssueUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesDemilestonedIssueUser.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssueUser(
  ...
  type: json['type'] != null ? WebhookIssuesDemilestonedIssueUserType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDemilestonedIssueUserType? type;
...
WebhookIssuesDemilestonedIssueUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDemilestonedIssueUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDemilestonedIssueUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDemilestonedIssueUser &&
...
@override String toString() { return 'WebhookIssuesDemilestonedIssueUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
