...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesDemilestonedIssueMilestoneCreatorType {const WebhookIssuesDemilestonedIssueMilestoneCreatorType._(this.value);

factory WebhookIssuesDemilestonedIssueMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssuesDemilestonedIssueMilestoneCreatorType._(json),
}; }

static const WebhookIssuesDemilestonedIssueMilestoneCreatorType bot = WebhookIssuesDemilestonedIssueMilestoneCreatorType._('Bot');

static const WebhookIssuesDemilestonedIssueMilestoneCreatorType user = WebhookIssuesDemilestonedIssueMilestoneCreatorType._('User');

static const WebhookIssuesDemilestonedIssueMilestoneCreatorType organization = WebhookIssuesDemilestonedIssueMilestoneCreatorType._('Organization');

static const WebhookIssuesDemilestonedIssueMilestoneCreatorType mannequin = WebhookIssuesDemilestonedIssueMilestoneCreatorType._('Mannequin');

static const List<WebhookIssuesDemilestonedIssueMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssuesDemilestonedIssueMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssuesDemilestonedIssueMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookIssuesDemilestonedIssueMilestoneCreator {const WebhookIssuesDemilestonedIssueMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssuesDemilestonedIssueMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssueMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookIssuesDemilestonedIssueMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesDemilestonedIssueMilestoneCreatorType? type;
...
WebhookIssuesDemilestonedIssueMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesDemilestonedIssueMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesDemilestonedIssueMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesDemilestonedIssueMilestoneCreator &&
...
@override String toString() { return 'WebhookIssuesDemilestonedIssueMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
