...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhooksIssue2PerformedViaGithubAppOwnerType {const WebhooksIssue2PerformedViaGithubAppOwnerType._(this.value);
...
@immutable final class WebhooksIssue2PerformedViaGithubAppOwner {const WebhooksIssue2PerformedViaGithubAppOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhooksIssue2PerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhooksIssue2PerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhooksIssue2PerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhooksIssue2PerformedViaGithubAppOwnerType? type;
...
WebhooksIssue2PerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhooksIssue2PerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhooksIssue2PerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksIssue2PerformedViaGithubAppOwner &&
...
@override String toString() { return 'WebhooksIssue2PerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
