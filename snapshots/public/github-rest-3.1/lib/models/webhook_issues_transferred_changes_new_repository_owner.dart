...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssuesTransferredChangesNewRepositoryOwnerType {const WebhookIssuesTransferredChangesNewRepositoryOwnerType._(this.value);
...
factory WebhookIssuesTransferredChangesNewRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookIssuesTransferredChangesNewRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookIssuesTransferredChangesNewRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookIssuesTransferredChangesNewRepositoryOwnerType? type;
...
WebhookIssuesTransferredChangesNewRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssuesTransferredChangesNewRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssuesTransferredChangesNewRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssuesTransferredChangesNewRepositoryOwner &&
