...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookDeploymentReviewRequestedWorkflowRunActorType {const WebhookDeploymentReviewRequestedWorkflowRunActorType._(this.value);

factory WebhookDeploymentReviewRequestedWorkflowRunActorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookDeploymentReviewRequestedWorkflowRunActorType bot = WebhookDeploymentReviewRequestedWorkflowRunActorType._('Bot');

static const WebhookDeploymentReviewRequestedWorkflowRunActorType user = WebhookDeploymentReviewRequestedWorkflowRunActorType._('User');

static const WebhookDeploymentReviewRequestedWorkflowRunActorType organization = WebhookDeploymentReviewRequestedWorkflowRunActorType._('Organization');

static const List<WebhookDeploymentReviewRequestedWorkflowRunActorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookDeploymentReviewRequestedWorkflowRunActorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookDeploymentReviewRequestedWorkflowRunActorType($value)'; } 
 }
@immutable final class WebhookDeploymentReviewRequestedWorkflowRunActor {const WebhookDeploymentReviewRequestedWorkflowRunActor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookDeploymentReviewRequestedWorkflowRunActor.fromJson(Map<String, dynamic> json) { return WebhookDeploymentReviewRequestedWorkflowRunActor(
  ...
  type: json['type'] != null ? WebhookDeploymentReviewRequestedWorkflowRunActorType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentReviewRequestedWorkflowRunActorType? type;
...
WebhookDeploymentReviewRequestedWorkflowRunActor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentReviewRequestedWorkflowRunActorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentReviewRequestedWorkflowRunActor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentReviewRequestedWorkflowRunActor &&
...
@override String toString() { return 'WebhookDeploymentReviewRequestedWorkflowRunActor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
