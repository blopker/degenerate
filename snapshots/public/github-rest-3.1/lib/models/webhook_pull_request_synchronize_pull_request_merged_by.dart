...
final class WebhookPullRequestSynchronizePullRequestMergedByType {const WebhookPullRequestSynchronizePullRequestMergedByType._(this.value);

factory WebhookPullRequestSynchronizePullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookPullRequestSynchronizePullRequestMergedByType bot = WebhookPullRequestSynchronizePullRequestMergedByType._('Bot');

static const WebhookPullRequestSynchronizePullRequestMergedByType user = WebhookPullRequestSynchronizePullRequestMergedByType._('User');

static const WebhookPullRequestSynchronizePullRequestMergedByType organization = WebhookPullRequestSynchronizePullRequestMergedByType._('Organization');

static const List<WebhookPullRequestSynchronizePullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestSynchronizePullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestMergedByType($value)'; } 
 }
final class WebhookPullRequestSynchronizePullRequestMergedBy {const WebhookPullRequestSynchronizePullRequestMergedBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestSynchronizePullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestSynchronizePullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestSynchronizePullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestSynchronizePullRequestMergedByType? type;
...
WebhookPullRequestSynchronizePullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestSynchronizePullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestSynchronizePullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestSynchronizePullRequestMergedBy &&
...
@override String toString() { return 'WebhookPullRequestSynchronizePullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
