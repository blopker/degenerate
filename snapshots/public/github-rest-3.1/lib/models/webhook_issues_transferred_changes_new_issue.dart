...
factory WebhookIssuesTransferredChangesNewIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesTransferredChangesNewIssue(
  ...
  assignee: json.containsKey('assignee') ? Omittable(json['assignee'] != null ? WebhookIssuesTransferredChangesNewIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  ...
  performedViaGithubApp: json.containsKey('performed_via_github_app') ? Omittable(json['performed_via_github_app'] != null ? WebhookIssuesTransferredChangesNewIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<WebhookIssuesTransferredChangesNewIssueAssignee?> assignee;
...
final Omittable<WebhookIssuesTransferredChangesNewIssuePerformedViaGithubApp?> performedViaGithubApp;
