...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentCreatedIssueReactions {const WebhookIssueCommentCreatedIssueReactions({this.plus1, this.minus1, this.confused, this.eyes, this.heart, this.hooray, this.laugh, this.rocket, this.totalCount, this.url, });

factory WebhookIssueCommentCreatedIssueReactions.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentCreatedIssueReactions(
...
WebhookIssueCommentCreatedIssueReactions copyWith({int Function()? plus1, int Function()? minus1, int Function()? confused, int Function()? eyes, int Function()? heart, int Function()? hooray, int Function()? laugh, int Function()? rocket, int Function()? totalCount, String Function()? url, }) { return WebhookIssueCommentCreatedIssueReactions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentCreatedIssueReactions &&
          plus1 == other.plus1 &&
          minus1 == other.minus1 &&
...
@override String toString() { return 'WebhookIssueCommentCreatedIssueReactions(plus1: $plus1, minus1: $minus1, confused: $confused, eyes: $eyes, heart: $heart, hooray: $hooray, laugh: $laugh, rocket: $rocket, totalCount: $totalCount, url: $url)'; } 
 }
