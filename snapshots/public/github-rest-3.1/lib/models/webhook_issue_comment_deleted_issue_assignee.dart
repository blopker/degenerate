...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookIssueCommentDeletedIssueAssigneeType {const WebhookIssueCommentDeletedIssueAssigneeType._(this.value);

factory WebhookIssueCommentDeletedIssueAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookIssueCommentDeletedIssueAssigneeType._(json),
}; }

static const WebhookIssueCommentDeletedIssueAssigneeType bot = WebhookIssueCommentDeletedIssueAssigneeType._('Bot');

static const WebhookIssueCommentDeletedIssueAssigneeType user = WebhookIssueCommentDeletedIssueAssigneeType._('User');

static const WebhookIssueCommentDeletedIssueAssigneeType organization = WebhookIssueCommentDeletedIssueAssigneeType._('Organization');

static const WebhookIssueCommentDeletedIssueAssigneeType mannequin = WebhookIssueCommentDeletedIssueAssigneeType._('Mannequin');

static const List<WebhookIssueCommentDeletedIssueAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookIssueCommentDeletedIssueAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookIssueCommentDeletedIssueAssigneeType($value)'; } 
 }
@immutable final class WebhookIssueCommentDeletedIssueAssignee {const WebhookIssueCommentDeletedIssueAssignee({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookIssueCommentDeletedIssueAssignee.fromJson(Map<String, dynamic> json) { return WebhookIssueCommentDeletedIssueAssignee(
  ...
  type: json['type'] != null ? WebhookIssueCommentDeletedIssueAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookIssueCommentDeletedIssueAssigneeType? type;
...
WebhookIssueCommentDeletedIssueAssignee copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookIssueCommentDeletedIssueAssigneeType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookIssueCommentDeletedIssueAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookIssueCommentDeletedIssueAssignee &&
...
@override String toString() { return 'WebhookIssueCommentDeletedIssueAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
