...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookReleasePrereleasedReleaseAuthorType {const WebhookReleasePrereleasedReleaseAuthorType._(this.value);

factory WebhookReleasePrereleasedReleaseAuthorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const WebhookReleasePrereleasedReleaseAuthorType bot = WebhookReleasePrereleasedReleaseAuthorType._('Bot');

static const WebhookReleasePrereleasedReleaseAuthorType user = WebhookReleasePrereleasedReleaseAuthorType._('User');

static const WebhookReleasePrereleasedReleaseAuthorType organization = WebhookReleasePrereleasedReleaseAuthorType._('Organization');

static const List<WebhookReleasePrereleasedReleaseAuthorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookReleasePrereleasedReleaseAuthorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookReleasePrereleasedReleaseAuthorType($value)'; } 
 }
@immutable final class WebhookReleasePrereleasedReleaseAuthor {const WebhookReleasePrereleasedReleaseAuthor({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookReleasePrereleasedReleaseAuthor.fromJson(Map<String, dynamic> json) { return WebhookReleasePrereleasedReleaseAuthor(
  ...
  type: json['type'] != null ? WebhookReleasePrereleasedReleaseAuthorType.fromJson(json['type'] as String) : null,
...
final WebhookReleasePrereleasedReleaseAuthorType? type;
...
WebhookReleasePrereleasedReleaseAuthor copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookReleasePrereleasedReleaseAuthorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookReleasePrereleasedReleaseAuthor(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookReleasePrereleasedReleaseAuthor &&
...
@override String toString() { return 'WebhookReleasePrereleasedReleaseAuthor(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
