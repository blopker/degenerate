...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'code_search_result_item.dart';final class SearchCodeResponse {const SearchCodeResponse({required this.totalCount, required this.incompleteResults, required this.items, });
