...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookTeamRemovedFromRepositoryRepositoryOwnerType {const WebhookTeamRemovedFromRepositoryRepositoryOwnerType._(this.value);
...
@immutable final class WebhookTeamRemovedFromRepositoryRepositoryOwner {const WebhookTeamRemovedFromRepositoryRepositoryOwner({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookTeamRemovedFromRepositoryRepositoryOwner.fromJson(Map<String, dynamic> json) { return WebhookTeamRemovedFromRepositoryRepositoryOwner(
  ...
  type: json['type'] != null ? WebhookTeamRemovedFromRepositoryRepositoryOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookTeamRemovedFromRepositoryRepositoryOwnerType? type;
...
WebhookTeamRemovedFromRepositoryRepositoryOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookTeamRemovedFromRepositoryRepositoryOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookTeamRemovedFromRepositoryRepositoryOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookTeamRemovedFromRepositoryRepositoryOwner &&
