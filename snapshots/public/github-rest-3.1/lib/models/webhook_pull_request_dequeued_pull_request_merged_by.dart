...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestDequeuedPullRequestMergedByType {const WebhookPullRequestDequeuedPullRequestMergedByType._(this.value);

factory WebhookPullRequestDequeuedPullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestDequeuedPullRequestMergedByType._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestMergedByType bot = WebhookPullRequestDequeuedPullRequestMergedByType._('Bot');

static const WebhookPullRequestDequeuedPullRequestMergedByType user = WebhookPullRequestDequeuedPullRequestMergedByType._('User');

static const WebhookPullRequestDequeuedPullRequestMergedByType organization = WebhookPullRequestDequeuedPullRequestMergedByType._('Organization');

static const List<WebhookPullRequestDequeuedPullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestMergedByType($value)'; } 
 }
@immutable final class WebhookPullRequestDequeuedPullRequestMergedBy {const WebhookPullRequestDequeuedPullRequestMergedBy({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestDequeuedPullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestDequeuedPullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestDequeuedPullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestDequeuedPullRequestMergedByType? type;
...
WebhookPullRequestDequeuedPullRequestMergedBy copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestDequeuedPullRequestMergedByType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestDequeuedPullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestDequeuedPullRequestMergedBy &&
...
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
