...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType {const WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType bot = WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType user = WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType organization = WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType mannequin = WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType($value)'; } 
 }
@immutable final class WebhookPullRequestEnqueuedPullRequestMilestoneCreator {const WebhookPullRequestEnqueuedPullRequestMilestoneCreator({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestEnqueuedPullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType? type;
...
WebhookPullRequestEnqueuedPullRequestMilestoneCreator copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestEnqueuedPullRequestMilestoneCreatorType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestEnqueuedPullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestEnqueuedPullRequestMilestoneCreator &&
...
@override String toString() { return 'WebhookPullRequestEnqueuedPullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
