...
import 'package:collection/collection.dart';import 'link_with_type.dart';final class FeedLinks {const FeedLinks({required this.timeline, required this.user, this.securityAdvisories, this.currentUser, this.currentUserPublic, this.currentUserActor, this.currentUserOrganization, this.currentUserOrganizations, this.repositoryDiscussions, this.repositoryDiscussionsCategory, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is FeedLinks &&
          ...
          const ListEquality<dynamic>().equals(currentUserOrganizations, other.currentUserOrganizations) &&
