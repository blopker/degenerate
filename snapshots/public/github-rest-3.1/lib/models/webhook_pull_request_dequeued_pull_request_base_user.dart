...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WebhookPullRequestDequeuedPullRequestBaseUserType {const WebhookPullRequestDequeuedPullRequestBaseUserType._(this.value);

factory WebhookPullRequestDequeuedPullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestDequeuedPullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestDequeuedPullRequestBaseUserType bot = WebhookPullRequestDequeuedPullRequestBaseUserType._('Bot');

static const WebhookPullRequestDequeuedPullRequestBaseUserType user = WebhookPullRequestDequeuedPullRequestBaseUserType._('User');

static const WebhookPullRequestDequeuedPullRequestBaseUserType organization = WebhookPullRequestDequeuedPullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestDequeuedPullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestDequeuedPullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestBaseUserType($value)'; } 
 }
@immutable final class WebhookPullRequestDequeuedPullRequestBaseUser {const WebhookPullRequestDequeuedPullRequestBaseUser({required this.id, required this.login, this.avatarUrl, this.deleted, this.email = const Omittable.absent(), this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestDequeuedPullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestDequeuedPullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestDequeuedPullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestDequeuedPullRequestBaseUserType? type;
...
WebhookPullRequestDequeuedPullRequestBaseUser copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookPullRequestDequeuedPullRequestBaseUserType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookPullRequestDequeuedPullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestDequeuedPullRequestBaseUser &&
...
@override String toString() { return 'WebhookPullRequestDequeuedPullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
