...
factory WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner.fromJson(Map<String, dynamic> json) { return WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner(
  ...
  type: json['type'] != null ? WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerType? type;
...
WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner copyWith({Uri? Function()? avatarUrl, bool? Function()? deleted, Omittable<String?>? email, String? Function()? eventsUrl, Uri? Function()? followersUrl, String? Function()? followingUrl, String? Function()? gistsUrl, String? Function()? gravatarId, Uri? Function()? htmlUrl, int? id, String? login, String? Function()? name, String? Function()? nodeId, Uri? Function()? organizationsUrl, Uri? Function()? receivedEventsUrl, Uri? Function()? reposUrl, bool? Function()? siteAdmin, String? Function()? starredUrl, Uri? Function()? subscriptionsUrl, WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwnerType? Function()? type, Uri? Function()? url, String? Function()? userViewType, }) { return WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner &&
...
@override String toString() { return 'WebhookDeploymentCreatedDeploymentPerformedViaGithubAppOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
