...
Future<ApiResult<List<Projects>, BasicError>> projectsListForOrg({required String org, String? q, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Projects, BasicError>> projectsGetForOrg({required int projectNumber, required String org, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple, BasicError>> projectsCreateDraftItemForOrg({required String org, required int projectNumber, required ProjectsCreateDraftItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<Field>, BasicError>> projectsListFieldsForOrg({required int projectNumber, required String org, int? perPage, String? before, String? after, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Field, BasicError>> projectsAddFieldForOrg({required int projectNumber, required String org, required ProjectsAddFieldForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/fields',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Field, BasicError>> projectsGetFieldForOrg({required int projectNumber, required int fieldId, required String org, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<ItemWithContent>, BasicError>> projectsListItemsForOrg({required int projectNumber, required String org, String? q, ProjectsListItemsForOrgFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple, BasicError>> projectsAddItemForOrg({required String org, required int projectNumber, required ProjectsAddItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<ItemWithContent, BasicError>> projectsGetOrgItem({required int projectNumber, required String org, required int itemId, ProjectsGetOrgItemFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemWithContent, BasicError>> projectsUpdateItemForOrg({required int projectNumber, required String org, required int itemId, required ProjectsUpdateItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void, BasicError>> projectsDeleteItemForOrg({required int projectNumber, required String org, required int itemId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<View, BasicError>> projectsCreateViewForOrg({required String org, required int projectNumber, required ProjectsCreateViewForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<ItemWithContent>, BasicError>> projectsListViewItemsForOrg({required int projectNumber, required String org, required int viewNumber, ProjectsListViewItemsForOrgFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple, BasicError>> projectsCreateDraftItemForAuthenticatedUser({required String userId, required int projectNumber, required ProjectsCreateDraftItemForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<View, BasicError>> projectsCreateViewForUser({required String userId, required int projectNumber, required ProjectsCreateViewForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<Projects>, BasicError>> projectsListForUser({required String username, String? q, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Projects, BasicError>> projectsGetForUser({required int projectNumber, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<Field>, BasicError>> projectsListFieldsForUser({required int projectNumber, required String username, int? perPage, String? before, String? after, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Field, BasicError>> projectsAddFieldForUser({required String username, required int projectNumber, required ProjectsAddFieldForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/fields',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Field, BasicError>> projectsGetFieldForUser({required int projectNumber, required int fieldId, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<ItemWithContent>, BasicError>> projectsListItemsForUser({required int projectNumber, required String username, String? before, String? after, int? perPage, String? q, ProjectsListItemsForUserFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple, BasicError>> projectsAddItemForUser({required String username, required int projectNumber, required ProjectsAddItemForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<ItemWithContent, BasicError>> projectsGetUserItem({required int projectNumber, required String username, required int itemId, ProjectsGetUserItemFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemWithContent, BasicError>> projectsUpdateItemForUser({required int projectNumber, required String username, required int itemId, required ProjectsUpdateItemForUserRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void, BasicError>> projectsDeleteItemForUser({required int projectNumber, required String username, required int itemId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<ItemWithContent>, BasicError>> projectsListViewItemsForUser({required int projectNumber, required String username, required int viewNumber, ProjectsListViewItemsForUserFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
