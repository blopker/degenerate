...
Future<ApiResult<List<Projects>>> projectsListForOrg({required String org, String? q, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Projects>> projectsGetForOrg({required int projectNumber, required String org, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple>> projectsCreateDraftItemForOrg({required String org, required int projectNumber, required ProjectsCreateDraftItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<Field>>> projectsListFieldsForOrg({required int projectNumber, required String org, int? perPage, String? before, String? after, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Field>> projectsAddFieldForOrg({required int projectNumber, required String org, required ProjectsAddFieldForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/fields',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Field>> projectsGetFieldForOrg({required int projectNumber, required int fieldId, required String org, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<ItemWithContent>>> projectsListItemsForOrg({required int projectNumber, required String org, String? q, ProjectsListItemsForOrgFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple>> projectsAddItemForOrg({required String org, required int projectNumber, required ProjectsAddItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<ItemWithContent>> projectsGetOrgItem({required int projectNumber, required String org, required int itemId, ProjectsGetOrgItemFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemWithContent>> projectsUpdateItemForOrg({required int projectNumber, required String org, required int itemId, required ProjectsUpdateItemForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> projectsDeleteItemForOrg({required int projectNumber, required String org, required int itemId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<View>> projectsCreateViewForOrg({required String org, required int projectNumber, required ProjectsCreateViewForOrgRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<ItemWithContent>>> projectsListViewItemsForOrg({required int projectNumber, required String org, required int viewNumber, ProjectsListViewItemsForOrgFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple>> projectsCreateDraftItemForAuthenticatedUser({required String userId, required int projectNumber, required ProjectsCreateDraftItemForAuthenticatedUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<View>> projectsCreateViewForUser({required String userId, required int projectNumber, required ProjectsCreateViewForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<Projects>>> projectsListForUser({required String username, String? q, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Projects>> projectsGetForUser({required int projectNumber, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<Field>>> projectsListFieldsForUser({required int projectNumber, required String username, int? perPage, String? before, String? after, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Field>> projectsAddFieldForUser({required String username, required int projectNumber, required ProjectsAddFieldForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/fields',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<Field>> projectsGetFieldForUser({required int projectNumber, required int fieldId, required String username, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<List<ItemWithContent>>> projectsListItemsForUser({required int projectNumber, required String username, String? before, String? after, int? perPage, String? q, ProjectsListItemsForUserFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemSimple>> projectsAddItemForUser({required String username, required int projectNumber, required ProjectsAddItemForUserRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<ItemWithContent>> projectsGetUserItem({required int projectNumber, required String username, required int itemId, ProjectsGetUserItemFields? fields, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<ItemWithContent>> projectsUpdateItemForUser({required int projectNumber, required String username, required int itemId, required ProjectsUpdateItemForUserRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> projectsDeleteItemForUser({required int projectNumber, required String username, required int itemId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/users/${Uri.encodeComponent(username)}/projectsV2/${Uri.encodeComponent(projectNumber.toString())}/items/${Uri.encodeComponent(itemId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<ItemWithContent>>> projectsListViewItemsForUser({required int projectNumber, required String username, required int viewNumber, ProjectsListViewItemsForUserFields? fields, String? before, String? after, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
