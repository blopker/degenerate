...
Future<ApiResult<PrivateRegistriesListOrgPrivateRegistriesResponse>> privateRegistriesListOrgPrivateRegistries({required String org, int? perPage, int? page, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgPrivateRegistryConfigurationWithSelectedRepositories>> privateRegistriesCreateOrgPrivateRegistry({required String org, required PrivateRegistriesCreateOrgPrivateRegistryRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/orgs/${Uri.encodeComponent(org)}/private-registries',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<PrivateRegistriesGetOrgPublicKeyResponse>> privateRegistriesGetOrgPublicKey({required String org}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<OrgPrivateRegistryConfiguration>> privateRegistriesGetOrgPrivateRegistry({required String org, required String secretName, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> privateRegistriesUpdateOrgPrivateRegistry({required String org, required String secretName, required PrivateRegistriesUpdateOrgPrivateRegistryRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/orgs/${Uri.encodeComponent(org)}/private-registries/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> privateRegistriesDeleteOrgPrivateRegistry({required String org, required String secretName, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/orgs/${Uri.encodeComponent(org)}/private-registries/${Uri.encodeComponent(secretName)}',
  headers: {..._config.defaultHeaders
  },
