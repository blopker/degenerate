...
final class EmojisApi {const EmojisApi(this._config);
...
///
/// `GET /emojis`
Future<ApiResult<Map<String, String>, Never>> emojisGet({RequestOptions? options}) async  { final headers = <String, String>{..._config.defaultHeaders};
