...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/basic_error.dart';import '../models/rate_limit_overview.dart';/// RateLimitApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class RateLimitApi {const RateLimitApi(this._config);
...
///
/// `GET /rate_limit`
Future<ApiResult<RateLimitOverview, BasicError>> rateLimitGet({RequestOptions? options}) async  { final headers = <String, String>{..._config.defaultHeaders};
