...
Future<ApiResult<SecretScanningAlert, SecretScanningGetAlertResponse503>> secretScanningGetAlert({required String owner, required String repo, required int alertNumber, bool? hideSecret, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<SecretScanningAlert, SecretScanningUpdateAlertResponse503>> secretScanningUpdateAlert({required String owner, required String repo, required int alertNumber, required SecretScanningUpdateAlertRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/secret-scanning/alerts/${Uri.encodeComponent(alertNumber.toString())}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<List<SecretScanningLocation>, SecretScanningListLocationsForAlertResponse503>> secretScanningListLocationsForAlert({required String owner, required String repo, required int alertNumber, int? page, int? perPage, }) async  { final request = ApiRequest(
  method: 'GET',
