...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/code_scanning_alert.dart';import '../models/code_scanning_alert_instance_list.dart';import '../models/code_scanning_alert_items.dart';import '../models/code_scanning_alert_severity.dart';import '../models/code_scanning_alert_state_query.dart';import '../models/code_scanning_analysis.dart';import '../models/code_scanning_analysis_deletion.dart';import '../models/code_scanning_autofix.dart';import '../models/code_scanning_autofix_commits.dart';import '../models/code_scanning_autofix_commits_response.dart';import '../models/code_scanning_codeql_database.dart';import '../models/code_scanning_create_variant_analysis_request.dart';import '../models/code_scanning_default_setup.dart';import '../models/code_scanning_default_setup_update.dart';import '../models/code_scanning_list_alerts_for_org_direction.dart';import '../models/code_scanning_list_alerts_for_org_sort.dart';import '../models/code_scanning_list_alerts_for_repo_direction.dart';import '../models/code_scanning_list_alerts_for_repo_sort.dart';import '../models/code_scanning_list_recent_analyses_direction.dart';import '../models/code_scanning_list_recent_analyses_sort.dart';import '../models/code_scanning_organization_alert_items.dart';import '../models/code_scanning_sarifs_receipt.dart';import '../models/code_scanning_sarifs_status.dart';import '../models/code_scanning_update_alert_request.dart';import '../models/code_scanning_upload_sarif_request.dart';import '../models/code_scanning_variant_analysis.dart';import '../models/code_scanning_variant_analysis_repo_task.dart';import '../models/empty_object.dart';/// CodeScanningApi operations.
///
...
Future<ApiResult<CodeScanningAlert>> codeScanningGetAlert({required String owner, required String repo, required int alertNumber, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningAlert>> codeScanningUpdateAlert({required String owner, required String repo, required int alertNumber, required CodeScanningUpdateAlertRequest body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/code-scanning/alerts/${Uri.encodeComponent(alertNumber.toString())}',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<CodeScanningAutofix>> codeScanningGetAutofix({required String owner, required String repo, required int alertNumber, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningAutofix>> codeScanningCreateAutofix({required String owner, required String repo, required int alertNumber, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/code-scanning/alerts/${Uri.encodeComponent(alertNumber.toString())}/autofix',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodeScanningAutofixCommitsResponse>> codeScanningCommitAutofix({required String owner, required String repo, required int alertNumber, CodeScanningAutofixCommits? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<CodeScanningAlertInstanceList>>> codeScanningListAlertInstances({required String owner, required String repo, required int alertNumber, int? page, int? perPage, String? ref, int? pr, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningAnalysis>> codeScanningGetAnalysis({required String owner, required String repo, required int analysisId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningAnalysisDeletion>> codeScanningDeleteAnalysis({required String owner, required String repo, required int analysisId, String? confirmDelete, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/code-scanning/analyses/${Uri.encodeComponent(analysisId.toString())}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<List<CodeScanningCodeqlDatabase>>> codeScanningListCodeqlDatabases({required String owner, required String repo, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningCodeqlDatabase>> codeScanningGetCodeqlDatabase({required String owner, required String repo, required String language, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> codeScanningDeleteCodeqlDatabase({required String owner, required String repo, required String language, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/code-scanning/codeql/databases/${Uri.encodeComponent(language)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<CodeScanningVariantAnalysis>> codeScanningCreateVariantAnalysis({required String owner, required String repo, required CodeScanningCreateVariantAnalysisRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<CodeScanningVariantAnalysis>> codeScanningGetVariantAnalysis({required String owner, required String repo, required int codeqlVariantAnalysisId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningVariantAnalysisRepoTask>> codeScanningGetVariantAnalysisRepoTask({required String owner, required String repo, required int codeqlVariantAnalysisId, required String repoOwner, required String repoName, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<CodeScanningDefaultSetup>> codeScanningGetDefaultSetup({required String owner, required String repo, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<EmptyObject>> codeScanningUpdateDefaultSetup({required String owner, required String repo, required CodeScanningDefaultSetupUpdate body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/repos/${Uri.encodeComponent(owner)}/${Uri.encodeComponent(repo)}/code-scanning/default-setup',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<CodeScanningSarifsReceipt>> codeScanningUploadSarif({required String owner, required String repo, required CodeScanningUploadSarifRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<CodeScanningSarifsStatus>> codeScanningGetSarif({required String owner, required String repo, required String sarifId, }) async  { final request = ApiRequest(
  method: 'GET',
