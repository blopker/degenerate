...
factory WebhookPullRequestReviewThreadResolvedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewThreadResolvedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User19.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User19.canParse(v), fromB: (v) => Team20.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team20.canParse(v),)).toList(),
