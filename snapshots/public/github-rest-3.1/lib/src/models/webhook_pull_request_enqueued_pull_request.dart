...
factory WebhookPullRequestEnqueuedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequest(
  ...
  activeLockReason: WebhookPullRequestEnqueuedPullRequestActiveLockReason.fromJson(json['active_lock_reason'] as String),
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: WebhookPullRequestEnqueuedPullRequestAssignee.fromJson(json['assignee'] as Map<String, dynamic>),
  ...
  autoMerge: WebhookPullRequestEnqueuedPullRequestAutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>),
  ...
  milestone: WebhookPullRequestEnqueuedPullRequestMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  patchUrl: Uri.parse(json['patch_url'] as String),
  rebaseable: json['rebaseable'] as bool?,
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User6.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User6.canParse(v), fromB: (v) => Team7.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team7.canParse(v),)).toList(),
  ...
  user: WebhookPullRequestEnqueuedPullRequestUser.fromJson(json['user'] as Map<String, dynamic>),
); }
