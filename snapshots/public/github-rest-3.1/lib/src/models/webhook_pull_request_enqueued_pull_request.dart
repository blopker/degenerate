...
factory WebhookPullRequestEnqueuedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestEnqueuedPullRequest(
  ...
  mergedBy: json['merged_by'] != null
        ? WebhookPullRequestEnqueuedPullRequestMergedBy.fromJson(json['merged_by'] as Map<String, dynamic>)
        : null,
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => WebhookPullRequestEnqueuedPullRequestRequestedReviewers.fromJson(e)).toList(),
