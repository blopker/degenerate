...
import 'repository_rule_committer_email_pattern_parameters_operator.dart';final class RepositoryRuleCommitterEmailPatternParameters {const RepositoryRuleCommitterEmailPatternParameters({this.name, this.negate, required this.$operator, required this.pattern, });
