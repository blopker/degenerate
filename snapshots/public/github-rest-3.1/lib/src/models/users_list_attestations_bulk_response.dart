...
import 'inline_object128.dart';import 'users_list_attestations_bulk_response_page_info.dart';final class UsersListAttestationsBulkResponse {const UsersListAttestationsBulkResponse({this.attestationsSubjectDigests, this.pageInfo, });

factory UsersListAttestationsBulkResponse.fromJson(Map<String, dynamic> json) { return UsersListAttestationsBulkResponse(
  attestationsSubjectDigests: (json['attestations_subject_digests'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, (v as List<dynamic>).map((e) => InlineObject128.fromJson(e as Map<String, dynamic>)).toList())),
  pageInfo: json['page_info'] != null
        ? UsersListAttestationsBulkResponsePageInfo.fromJson(json['page_info'] as Map<String, dynamic>)
        : null,
); }
...
UsersListAttestationsBulkResponse copyWith({Map<String, List<InlineObject128>> Function()? attestationsSubjectDigests, UsersListAttestationsBulkResponsePageInfo Function()? pageInfo, }) { return UsersListAttestationsBulkResponse(
