...
import 'package:collection/collection.dart';import 'inline_object66_pull_request_base_repo_created_at.dart';import 'inline_object66_pull_request_base_repo_license.dart';import 'inline_object66_pull_request_base_repo_owner.dart';import 'inline_object66_pull_request_base_repo_permissions.dart';import 'inline_object66_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class InlineObject66PullRequestBaseRepoPullRequestCreationPolicy {const InlineObject66PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory InlineObject66PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => InlineObject66PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const InlineObject66PullRequestBaseRepoPullRequestCreationPolicy all = InlineObject66PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const InlineObject66PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = InlineObject66PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<InlineObject66PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class InlineObject66PullRequestBaseRepoMergeCommitTitle {const InlineObject66PullRequestBaseRepoMergeCommitTitle._(this.value);

factory InlineObject66PullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => InlineObject66PullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const InlineObject66PullRequestBaseRepoMergeCommitTitle prTitle = InlineObject66PullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const InlineObject66PullRequestBaseRepoMergeCommitTitle mergeMessage = InlineObject66PullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<InlineObject66PullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class InlineObject66PullRequestBaseRepoSquashMergeCommitMessage {const InlineObject66PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory InlineObject66PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const InlineObject66PullRequestBaseRepoSquashMergeCommitMessage prBody = InlineObject66PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject66PullRequestBaseRepoSquashMergeCommitMessage commitMessages = InlineObject66PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject66PullRequestBaseRepoSquashMergeCommitMessage blank = InlineObject66PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject66PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class InlineObject66PullRequestBaseRepoSquashMergeCommitTitle {const InlineObject66PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory InlineObject66PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject66PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject66PullRequestBaseRepoSquashMergeCommitTitle prTitle = InlineObject66PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject66PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject66PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject66PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class InlineObject66PullRequestBaseRepoVisibility {const InlineObject66PullRequestBaseRepoVisibility._(this.value);

factory InlineObject66PullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const InlineObject66PullRequestBaseRepoVisibility public = InlineObject66PullRequestBaseRepoVisibility._('public');

static const InlineObject66PullRequestBaseRepoVisibility private = InlineObject66PullRequestBaseRepoVisibility._('private');

static const InlineObject66PullRequestBaseRepoVisibility internal = InlineObject66PullRequestBaseRepoVisibility._('internal');

static const List<InlineObject66PullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory InlineObject66PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestBaseRepo(
  ...
  createdAt: InlineObject66PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject66PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject66PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject66PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject66PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject66PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject66PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject66PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject66PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject66PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject66PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject66PullRequestBaseRepoCreatedAt createdAt;
...
final InlineObject66PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject66PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject66PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject66PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject66PullRequestBaseRepoOwner? owner;

final InlineObject66PullRequestBaseRepoPermissions? permissions;
...
final InlineObject66PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject66PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject66PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject66PullRequestBaseRepoVisibility visibility;
...
InlineObject66PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject66PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject66PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject66PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, InlineObject66PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject66PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject66PullRequestBaseRepoOwner? Function()? owner, InlineObject66PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject66PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject66PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject66PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject66PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject66PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestBaseRepo &&
