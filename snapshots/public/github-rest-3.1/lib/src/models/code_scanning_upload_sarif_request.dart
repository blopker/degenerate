...
import 'code_scanning_analysis_commit_sha.dart';import 'code_scanning_analysis_sarif_file.dart';import 'code_scanning_ref_full.dart';final class CodeScanningUploadSarifRequest {const CodeScanningUploadSarifRequest({required this.commitSha, required this.ref, required this.sarif, this.checkoutUri, this.startedAt, this.toolName, this.validate, });
