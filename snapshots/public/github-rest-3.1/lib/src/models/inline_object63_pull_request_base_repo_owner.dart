...
final class InlineObject63PullRequestBaseRepoOwnerType {const InlineObject63PullRequestBaseRepoOwnerType._(this.value);

factory InlineObject63PullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestBaseRepoOwnerType._(json),
}; }

static const InlineObject63PullRequestBaseRepoOwnerType bot = InlineObject63PullRequestBaseRepoOwnerType._('Bot');

static const InlineObject63PullRequestBaseRepoOwnerType user = InlineObject63PullRequestBaseRepoOwnerType._('User');

static const InlineObject63PullRequestBaseRepoOwnerType organization = InlineObject63PullRequestBaseRepoOwnerType._('Organization');

static const List<InlineObject63PullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestBaseRepoOwnerType($value)'; } 
 }
final class InlineObject63PullRequestBaseRepoOwner {const InlineObject63PullRequestBaseRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? InlineObject63PullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestBaseRepoOwnerType? type;
...
InlineObject63PullRequestBaseRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestBaseRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestBaseRepoOwner &&
