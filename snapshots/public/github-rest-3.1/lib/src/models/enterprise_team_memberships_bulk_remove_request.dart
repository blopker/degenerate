...
import 'package:collection/collection.dart';final class EnterpriseTeamMembershipsBulkRemoveRequest {const EnterpriseTeamMembershipsBulkRemoveRequest({required this.usernames});
