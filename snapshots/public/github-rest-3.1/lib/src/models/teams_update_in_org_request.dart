...
import 'teams_update_in_org_request_notification_setting.dart';import 'teams_update_in_org_request_permission.dart';import 'teams_update_in_org_request_privacy.dart';final class TeamsUpdateInOrgRequest {const TeamsUpdateInOrgRequest({this.name, this.description, this.privacy, this.notificationSetting, this.permission = TeamsUpdateInOrgRequestPermission.pull, this.parentTeamId, });
