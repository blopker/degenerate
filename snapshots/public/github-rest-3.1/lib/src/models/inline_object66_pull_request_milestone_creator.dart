...
final class InlineObject66PullRequestMilestoneCreatorType {const InlineObject66PullRequestMilestoneCreatorType._(this.value);

factory InlineObject66PullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject66PullRequestMilestoneCreatorType bot = InlineObject66PullRequestMilestoneCreatorType._('Bot');

static const InlineObject66PullRequestMilestoneCreatorType user = InlineObject66PullRequestMilestoneCreatorType._('User');

static const InlineObject66PullRequestMilestoneCreatorType organization = InlineObject66PullRequestMilestoneCreatorType._('Organization');

static const List<InlineObject66PullRequestMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestMilestoneCreatorType($value)'; } 
 }
final class InlineObject66PullRequestMilestoneCreator {const InlineObject66PullRequestMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? InlineObject66PullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestMilestoneCreatorType? type;
...
InlineObject66PullRequestMilestoneCreator copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestMilestoneCreatorType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestMilestoneCreator &&
...
@override String toString() { return 'InlineObject66PullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
