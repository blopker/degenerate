...
final class InlineObject63PullRequestAutoMergeEnabledByType {const InlineObject63PullRequestAutoMergeEnabledByType._(this.value);

factory InlineObject63PullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject63PullRequestAutoMergeEnabledByType bot = InlineObject63PullRequestAutoMergeEnabledByType._('Bot');

static const InlineObject63PullRequestAutoMergeEnabledByType user = InlineObject63PullRequestAutoMergeEnabledByType._('User');

static const InlineObject63PullRequestAutoMergeEnabledByType organization = InlineObject63PullRequestAutoMergeEnabledByType._('Organization');

static const List<InlineObject63PullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestAutoMergeEnabledByType($value)'; } 
 }
final class InlineObject63PullRequestAutoMergeEnabledBy {const InlineObject63PullRequestAutoMergeEnabledBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? InlineObject63PullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestAutoMergeEnabledByType? type;
...
InlineObject63PullRequestAutoMergeEnabledBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestAutoMergeEnabledByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestAutoMergeEnabledBy &&
...
@override String toString() { return 'InlineObject63PullRequestAutoMergeEnabledBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
