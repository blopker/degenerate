...
import 'package:collection/collection.dart';import 'webhook_workflow_job_in_progress_workflow_job_status.dart';import 'webhook_workflow_job_in_progress_workflow_job_steps.dart';/// The workflow job. Many `workflow_job` keys, such as `head_sha`, `conclusion`, and `started_at` are the same as those in a [`check_run`](#check_run) object.
