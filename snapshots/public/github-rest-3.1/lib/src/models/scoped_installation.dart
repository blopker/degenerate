...
import 'package:collection/collection.dart';import 'app_permissions.dart';import 'scoped_installation_repository_selection.dart';import 'simple_user.dart';final class ScopedInstallation {const ScopedInstallation({required this.permissions, required this.repositorySelection, required this.singleFileName, this.hasMultipleSingleFiles, this.singleFilePaths, required this.repositoriesUrl, required this.account, });
