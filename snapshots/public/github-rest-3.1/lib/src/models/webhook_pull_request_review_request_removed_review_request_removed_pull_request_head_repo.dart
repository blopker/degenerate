...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo(
  ...
  license: WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  mirrorUrl: Uri.parse(json['mirror_url'] as String),
  ...
  owner: WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  ...
  pushedAt: json['pushed_at'] as Object,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedReviewRequestRemovedPullRequestHeadRepo &&
          ...
          const ListEquality<dynamic>().equals(topics, other.topics) &&
