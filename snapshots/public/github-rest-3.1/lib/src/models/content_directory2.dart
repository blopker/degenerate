...
import 'content_directory2_links.dart';import 'content_directory2_type.dart';final class ContentDirectory2 {const ContentDirectory2({required this.type, required this.size, required this.name, required this.path, this.content, required this.sha, required this.url, required this.gitUrl, required this.htmlUrl, required this.downloadUrl, required this.links, });
