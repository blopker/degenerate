...
final class InlineObject69PullRequestHeadUserType {const InlineObject69PullRequestHeadUserType._(this.value);

factory InlineObject69PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject69PullRequestHeadUserType._(json),
}; }

static const InlineObject69PullRequestHeadUserType bot = InlineObject69PullRequestHeadUserType._('Bot');

static const InlineObject69PullRequestHeadUserType user = InlineObject69PullRequestHeadUserType._('User');

static const InlineObject69PullRequestHeadUserType organization = InlineObject69PullRequestHeadUserType._('Organization');

static const List<InlineObject69PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestHeadUserType($value)'; } 
 }
final class InlineObject69PullRequestHeadUser {const InlineObject69PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject69PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestHeadUser(
  ...
  type: json['type'] != null ? InlineObject69PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestHeadUserType? type;
...
InlineObject69PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestHeadUser &&
...
@override String toString() { return 'InlineObject69PullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
