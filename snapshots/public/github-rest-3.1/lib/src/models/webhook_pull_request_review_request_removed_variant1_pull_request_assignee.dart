...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType bot = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType user = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType organization = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType? type;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneeType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignee &&
