...
import 'package:collection/collection.dart';final class CodeSecurityDetachConfigurationRequest {const CodeSecurityDetachConfigurationRequest({this.selectedRepositoryIds});
