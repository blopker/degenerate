...
import 'gists_create_request_files_value.dart';import 'gists_create_request_public.dart';final class GistsCreateRequest {const GistsCreateRequest({this.description, required this.files, this.public, });
