...
import 'package:collection/collection.dart';import 'webhook_pull_request_review_request_removed_variant1_pull_request_head_repo_created_at.dart';import 'webhook_pull_request_review_request_removed_variant1_pull_request_head_repo_license.dart';import 'webhook_pull_request_review_request_removed_variant1_pull_request_head_repo_owner.dart';import 'webhook_pull_request_review_request_removed_variant1_pull_request_head_repo_permissions.dart';import 'webhook_pull_request_review_request_removed_variant1_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility public = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility private = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility internal = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo(
  ...
  createdAt: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoCreatedAt createdAt;
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoOwner? owner;

final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPermissions? permissions;
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility visibility;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoOwner? Function()? owner, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadRepo &&
