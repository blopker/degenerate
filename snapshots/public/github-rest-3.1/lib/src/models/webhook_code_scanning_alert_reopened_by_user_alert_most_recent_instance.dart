...
import 'package:collection/collection.dart';import 'webhook_code_scanning_alert_reopened_by_user_alert_most_recent_instance_location.dart';import 'webhook_code_scanning_alert_reopened_by_user_alert_most_recent_instance_message.dart';import 'webhook_code_scanning_alert_reopened_by_user_alert_most_recent_instance_state.dart';final class WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance {const WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance({required this.analysisKey, this.category, this.classifications, this.commitSha, required this.environment, this.location, this.message, required this.ref, required this.state, });
...
factory WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstance(
  ...
  location: json['location'] != null
        ? WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstanceLocation.fromJson(json['location'] as Map<String, dynamic>)
        : null,
  message: json['message'] != null
        ? WebhookCodeScanningAlertReopenedByUserAlertMostRecentInstanceMessage.fromJson(json['message'] as Map<String, dynamic>)
        : null,
