...
import 'package:collection/collection.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_base_repo_created_at.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_base_repo_license.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_base_repo_owner.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_base_repo_permissions.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility public = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility._('public');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility private = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility._('private');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility internal = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepo(
  ...
  createdAt: WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoCreatedAt createdAt;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoOwner? owner;

final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPermissions? permissions;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseRepo &&
