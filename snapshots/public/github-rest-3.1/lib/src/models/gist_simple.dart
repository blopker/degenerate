...
import 'package:collection/collection.dart';import 'gist_history.dart';import 'gist_simple_fork_of.dart';import 'gist_simple_forks.dart';import 'inline_object4.dart';import 'simple_user.dart';/// Gist Simple
...
factory GistSimple.fromJson(Map<String, dynamic> json) { return GistSimple(
  ...
  files: (json['files'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject4.fromJson(v as Map<String, dynamic>))),
...
final Map<String,InlineObject4?>? files;
...
GistSimple copyWith({List<GistSimpleForks>? Function()? forks, List<GistHistory>? Function()? history, GistSimpleForkOf? Function()? forkOf, String Function()? url, String Function()? forksUrl, String Function()? commitsUrl, String Function()? id, String Function()? nodeId, String Function()? gitPullUrl, String Function()? gitPushUrl, String Function()? htmlUrl, Map<String, InlineObject4> Function()? files, bool Function()? public, String Function()? createdAt, String Function()? updatedAt, String? Function()? description, int Function()? comments, bool Function()? commentsEnabled, String? Function()? user, String Function()? commentsUrl, SimpleUser Function()? owner, bool Function()? truncated, }) { return GistSimple(
