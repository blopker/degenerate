...
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType bot = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType user = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType organization = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType? type;
...
WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadUser &&
