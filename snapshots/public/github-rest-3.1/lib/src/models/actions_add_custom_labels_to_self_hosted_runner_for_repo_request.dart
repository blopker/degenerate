...
import 'package:collection/collection.dart';final class ActionsAddCustomLabelsToSelfHostedRunnerForRepoRequest {const ActionsAddCustomLabelsToSelfHostedRunnerForRepoRequest({required this.labels});
