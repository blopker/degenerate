...
final class InlineObject72PullRequestHeadRepoOwnerType {const InlineObject72PullRequestHeadRepoOwnerType._(this.value);

factory InlineObject72PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject72PullRequestHeadRepoOwnerType._(json),
}; }

static const InlineObject72PullRequestHeadRepoOwnerType bot = InlineObject72PullRequestHeadRepoOwnerType._('Bot');

static const InlineObject72PullRequestHeadRepoOwnerType user = InlineObject72PullRequestHeadRepoOwnerType._('User');

static const InlineObject72PullRequestHeadRepoOwnerType organization = InlineObject72PullRequestHeadRepoOwnerType._('Organization');

static const List<InlineObject72PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestHeadRepoOwnerType($value)'; } 
 }
final class InlineObject72PullRequestHeadRepoOwner {const InlineObject72PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject72PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? InlineObject72PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestHeadRepoOwnerType? type;
...
InlineObject72PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestHeadRepoOwner &&
...
@override String toString() { return 'InlineObject72PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
