...
factory WebhookDeploymentStatusCreatedWorkflowRun.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedWorkflowRun(
  actor: WebhookDeploymentStatusCreatedWorkflowRunActor.fromJson(json['actor'] as Map<String, dynamic>),
  ...
  conclusion: WebhookDeploymentStatusCreatedWorkflowRunConclusion.fromJson(json['conclusion'] as String),
  ...
  triggeringActor: WebhookDeploymentStatusCreatedWorkflowRunTriggeringActor.fromJson(json['triggering_actor'] as Map<String, dynamic>),
