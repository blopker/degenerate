...
final class InlineObject66PullRequestHeadUserType {const InlineObject66PullRequestHeadUserType._(this.value);

factory InlineObject66PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject66PullRequestHeadUserType._(json),
}; }

static const InlineObject66PullRequestHeadUserType bot = InlineObject66PullRequestHeadUserType._('Bot');

static const InlineObject66PullRequestHeadUserType user = InlineObject66PullRequestHeadUserType._('User');

static const InlineObject66PullRequestHeadUserType organization = InlineObject66PullRequestHeadUserType._('Organization');

static const List<InlineObject66PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestHeadUserType($value)'; } 
 }
final class InlineObject66PullRequestHeadUser {const InlineObject66PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestHeadUser(
  ...
  type: json['type'] != null ? InlineObject66PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestHeadUserType? type;
...
InlineObject66PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestHeadUser &&
