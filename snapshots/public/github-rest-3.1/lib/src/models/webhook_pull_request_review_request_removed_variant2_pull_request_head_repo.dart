...
import 'package:collection/collection.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_head_repo_created_at.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_head_repo_license.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_head_repo_owner.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_head_repo_permissions.dart';import 'webhook_pull_request_review_request_removed_variant2_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility public = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility._('public');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility private = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility._('private');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility internal = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepo(
  ...
  createdAt: WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoCreatedAt createdAt;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner? owner;

final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPermissions? permissions;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility visibility;
...
WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner? Function()? owner, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepo &&
