...
static const InlineObject59Type bot = InlineObject59Type._('Bot');

static const InlineObject59Type user = InlineObject59Type._('User');

static const InlineObject59Type organization = InlineObject59Type._('Organization');

static const InlineObject59Type mannequin = InlineObject59Type._('Mannequin');

static const List<InlineObject59Type> values = [bot, user, organization, mannequin];
...
final class InlineObject59 {const InlineObject59({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory InlineObject59.fromJson(Map<String, dynamic> json) { return InlineObject59(
  ...
  type: json['type'] != null ? InlineObject59Type.fromJson(json['type'] as String) : null,
...
InlineObject59 copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject59Type Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject59(
