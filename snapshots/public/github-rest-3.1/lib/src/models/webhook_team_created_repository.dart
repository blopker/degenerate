...
import 'package:collection/collection.dart';import 'webhook_team_created_repository_created_at.dart';import 'webhook_team_created_repository_license.dart';import 'webhook_team_created_repository_owner.dart';import 'webhook_team_created_repository_permissions.dart';import 'webhook_team_created_repository_pushed_at.dart';final class WebhookTeamCreatedRepositoryVisibility {const WebhookTeamCreatedRepositoryVisibility._(this.value);
...
factory WebhookTeamCreatedRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamCreatedRepository(
  ...
  createdAt: WebhookTeamCreatedRepositoryCreatedAt.fromJson(json['created_at']),
  ...
  license: WebhookTeamCreatedRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  owner: WebhookTeamCreatedRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>),
  ...
  pushedAt: WebhookTeamCreatedRepositoryPushedAt.fromJson(json['pushed_at']),
