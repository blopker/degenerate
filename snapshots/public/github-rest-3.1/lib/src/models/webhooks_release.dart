...
import 'package:collection/collection.dart';import 'webhooks_release_assets.dart';import 'webhooks_release_author.dart';import 'webhooks_release_reactions.dart';/// The [release](https://docs.github.com/rest/releases/releases/#get-a-release) object.
...
factory WebhooksRelease.fromJson(Map<String, dynamic> json) { return WebhooksRelease(
  ...
  author: WebhooksReleaseAuthor.fromJson(json['author'] as Map<String, dynamic>),
  ...
  reactions: json['reactions'] != null
        ? WebhooksReleaseReactions.fromJson(json['reactions'] as Map<String, dynamic>)
        : null,
