...
import 'package:collection/collection.dart';import 'private_registries_create_org_private_registry_request_registry_type.dart';import 'private_registries_create_org_private_registry_request_visibility.dart';final class PrivateRegistriesCreateOrgPrivateRegistryRequest {const PrivateRegistriesCreateOrgPrivateRegistryRequest({required this.registryType, required this.url, this.username, this.replacesBase = false, required this.encryptedValue, required this.keyId, required this.visibility, this.selectedRepositoryIds, });
