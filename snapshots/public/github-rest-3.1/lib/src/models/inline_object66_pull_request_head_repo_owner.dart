...
final class InlineObject66PullRequestHeadRepoOwnerType {const InlineObject66PullRequestHeadRepoOwnerType._(this.value);

factory InlineObject66PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject66PullRequestHeadRepoOwnerType bot = InlineObject66PullRequestHeadRepoOwnerType._('Bot');

static const InlineObject66PullRequestHeadRepoOwnerType user = InlineObject66PullRequestHeadRepoOwnerType._('User');

static const InlineObject66PullRequestHeadRepoOwnerType organization = InlineObject66PullRequestHeadRepoOwnerType._('Organization');

static const List<InlineObject66PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestHeadRepoOwnerType($value)'; } 
 }
final class InlineObject66PullRequestHeadRepoOwner {const InlineObject66PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? InlineObject66PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestHeadRepoOwnerType? type;
...
InlineObject66PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestHeadRepoOwner &&
...
@override String toString() { return 'InlineObject66PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
