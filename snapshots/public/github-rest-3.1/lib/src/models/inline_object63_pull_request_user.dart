...
final class InlineObject63PullRequestUserType {const InlineObject63PullRequestUserType._(this.value);

factory InlineObject63PullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject63PullRequestUserType bot = InlineObject63PullRequestUserType._('Bot');

static const InlineObject63PullRequestUserType user = InlineObject63PullRequestUserType._('User');

static const InlineObject63PullRequestUserType organization = InlineObject63PullRequestUserType._('Organization');

static const List<InlineObject63PullRequestUserType> values = [bot, user, organization];
...
factory InlineObject63PullRequestUser.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestUser(
  ...
  type: json['type'] != null ? InlineObject63PullRequestUserType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestUserType? type;
...
InlineObject63PullRequestUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestUser &&
