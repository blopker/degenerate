...
final class InlineObject83Type {const InlineObject83Type._(this.value);

factory InlineObject83Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject83Type organization = InlineObject83Type._('Organization');

static const InlineObject83Type mannequin = InlineObject83Type._('Mannequin');

static const List<InlineObject83Type> values = [bot, user, organization, mannequin];
...
@override String toString() { return 'InlineObject83Type($value)'; } 
 }
final class InlineObject83 {const InlineObject83({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory InlineObject83.fromJson(Map<String, dynamic> json) { return InlineObject83(
  ...
  type: json['type'] != null ? InlineObject83Type.fromJson(json['type'] as String) : null,
...
InlineObject83 copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject83Type Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject83(
...
@override String toString() { return 'InlineObject83(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
