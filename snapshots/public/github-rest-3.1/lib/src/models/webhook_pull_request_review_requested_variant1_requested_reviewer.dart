...
final class WebhookPullRequestReviewRequestedVariant1RequestedReviewerType {const WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1RequestedReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1RequestedReviewerType bot = WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1RequestedReviewerType user = WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._('User');

static const WebhookPullRequestReviewRequestedVariant1RequestedReviewerType organization = WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._('Organization');

static const WebhookPullRequestReviewRequestedVariant1RequestedReviewerType mannequin = WebhookPullRequestReviewRequestedVariant1RequestedReviewerType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedVariant1RequestedReviewerType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1RequestedReviewerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1RequestedReviewerType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1RequestedReviewer {const WebhookPullRequestReviewRequestedVariant1RequestedReviewer({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1RequestedReviewer.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1RequestedReviewer(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1RequestedReviewerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1RequestedReviewerType? type;
...
WebhookPullRequestReviewRequestedVariant1RequestedReviewer copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1RequestedReviewerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1RequestedReviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1RequestedReviewer &&
