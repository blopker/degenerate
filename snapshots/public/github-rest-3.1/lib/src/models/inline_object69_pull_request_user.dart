...
final class InlineObject69PullRequestUserType {const InlineObject69PullRequestUserType._(this.value);

factory InlineObject69PullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => InlineObject69PullRequestUserType._(json),
}; }

static const InlineObject69PullRequestUserType bot = InlineObject69PullRequestUserType._('Bot');

static const InlineObject69PullRequestUserType user = InlineObject69PullRequestUserType._('User');

static const InlineObject69PullRequestUserType organization = InlineObject69PullRequestUserType._('Organization');

static const InlineObject69PullRequestUserType mannequin = InlineObject69PullRequestUserType._('Mannequin');

static const List<InlineObject69PullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestUserType($value)'; } 
 }
final class InlineObject69PullRequestUser {const InlineObject69PullRequestUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject69PullRequestUser.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestUser(
  ...
  type: json['type'] != null ? InlineObject69PullRequestUserType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestUserType? type;
...
InlineObject69PullRequestUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestUser &&
...
@override String toString() { return 'InlineObject69PullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
