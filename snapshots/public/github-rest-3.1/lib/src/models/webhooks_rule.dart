...
import 'package:collection/collection.dart';final class WebhooksRuleAllowDeletionsEnforcementLevel {const WebhooksRuleAllowDeletionsEnforcementLevel._(this.value);
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhooksRule &&
          ...
          const ListEquality<dynamic>().equals(authorizedActorNames, other.authorizedActorNames) &&
          ...
          const ListEquality<dynamic>().equals(requiredStatusChecks, other.requiredStatusChecks) &&
