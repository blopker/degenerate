...
import 'package:collection/collection.dart';import 'actions_create_or_update_org_secret_request_visibility.dart';final class ActionsCreateOrUpdateOrgSecretRequest {const ActionsCreateOrUpdateOrgSecretRequest({required this.encryptedValue, required this.keyId, required this.visibility, this.selectedRepositoryIds, });
