...
import 'package:collection/collection.dart';import 'webhook_code_scanning_alert_reopened_alert_rule_severity.dart';final class WebhookCodeScanningAlertReopenedAlertRule {const WebhookCodeScanningAlertReopenedAlertRule({required this.description, this.fullDescription, this.help, this.helpUri, required this.id, this.name, required this.severity, this.tags, });
