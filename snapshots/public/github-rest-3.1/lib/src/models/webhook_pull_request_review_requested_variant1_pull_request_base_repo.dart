...
import 'package:collection/collection.dart';import 'webhook_pull_request_review_requested_variant1_pull_request_base_repo_created_at.dart';import 'webhook_pull_request_review_requested_variant1_pull_request_base_repo_license.dart';import 'webhook_pull_request_review_requested_variant1_pull_request_base_repo_owner.dart';import 'webhook_pull_request_review_requested_variant1_pull_request_base_repo_permissions.dart';import 'webhook_pull_request_review_requested_variant1_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility public = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility._('public');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility private = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility._('private');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility internal = WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo(
  ...
  createdAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt createdAt;
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner? owner;

final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions? permissions;
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseRepo &&
