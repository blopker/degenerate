...
final class InlineObject72PullRequestAssigneeType {const InlineObject72PullRequestAssigneeType._(this.value);

factory InlineObject72PullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => InlineObject72PullRequestAssigneeType._(json),
}; }

static const InlineObject72PullRequestAssigneeType bot = InlineObject72PullRequestAssigneeType._('Bot');

static const InlineObject72PullRequestAssigneeType user = InlineObject72PullRequestAssigneeType._('User');

static const InlineObject72PullRequestAssigneeType organization = InlineObject72PullRequestAssigneeType._('Organization');

static const InlineObject72PullRequestAssigneeType mannequin = InlineObject72PullRequestAssigneeType._('Mannequin');

static const List<InlineObject72PullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestAssigneeType($value)'; } 
 }
final class InlineObject72PullRequestAssignee {const InlineObject72PullRequestAssignee({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject72PullRequestAssignee.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestAssignee(
  ...
  type: json['type'] != null ? InlineObject72PullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestAssigneeType? type;
...
InlineObject72PullRequestAssignee copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestAssigneeType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestAssignee &&
...
@override String toString() { return 'InlineObject72PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
