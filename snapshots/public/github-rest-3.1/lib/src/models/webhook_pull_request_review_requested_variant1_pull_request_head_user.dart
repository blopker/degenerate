...
final class WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType {const WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType bot = WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType user = WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType._('User');

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType organization = WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser {const WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType? type;
...
WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestHeadUser &&
