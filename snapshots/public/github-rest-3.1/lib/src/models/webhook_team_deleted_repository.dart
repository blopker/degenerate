...
import 'package:collection/collection.dart';import 'webhook_team_deleted_repository_created_at.dart';import 'webhook_team_deleted_repository_license.dart';import 'webhook_team_deleted_repository_owner.dart';import 'webhook_team_deleted_repository_permissions.dart';import 'webhook_team_deleted_repository_pushed_at.dart';final class WebhookTeamDeletedRepositoryVisibility {const WebhookTeamDeletedRepositoryVisibility._(this.value);
...
factory WebhookTeamDeletedRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamDeletedRepository(
  ...
  createdAt: WebhookTeamDeletedRepositoryCreatedAt.fromJson(json['created_at']),
  ...
  license: WebhookTeamDeletedRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  owner: WebhookTeamDeletedRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>),
  ...
  pushedAt: WebhookTeamDeletedRepositoryPushedAt.fromJson(json['pushed_at']),
