...
final class WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType {const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType bot = WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType user = WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType organization = WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._('Organization');

static const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType mannequin = WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator {const WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType? type;
...
WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreatorType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestMilestoneCreator &&
