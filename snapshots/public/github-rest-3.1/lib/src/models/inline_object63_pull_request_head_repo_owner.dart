...
final class InlineObject63PullRequestHeadRepoOwnerType {const InlineObject63PullRequestHeadRepoOwnerType._(this.value);

factory InlineObject63PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestHeadRepoOwnerType._(json),
}; }

static const InlineObject63PullRequestHeadRepoOwnerType bot = InlineObject63PullRequestHeadRepoOwnerType._('Bot');

static const InlineObject63PullRequestHeadRepoOwnerType user = InlineObject63PullRequestHeadRepoOwnerType._('User');

static const InlineObject63PullRequestHeadRepoOwnerType organization = InlineObject63PullRequestHeadRepoOwnerType._('Organization');

static const List<InlineObject63PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestHeadRepoOwnerType($value)'; } 
 }
final class InlineObject63PullRequestHeadRepoOwner {const InlineObject63PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? InlineObject63PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestHeadRepoOwnerType? type;
...
InlineObject63PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestHeadRepoOwner &&
...
@override String toString() { return 'InlineObject63PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
