...
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType bot = WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType user = WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType._('User');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType organization = WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType? type;
...
WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseUser &&
