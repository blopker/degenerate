...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'repos_create_deployment_request_payload.dart';final class ReposCreateDeploymentRequest {const ReposCreateDeploymentRequest({required this.ref, this.task = 'deploy', this.autoMerge = true, this.requiredContexts, this.payload, this.environment = 'production', this.description = '', this.transientEnvironment = false, this.productionEnvironment, });
...
factory ReposCreateDeploymentRequest.fromJson(Map<String, dynamic> json) { return ReposCreateDeploymentRequest(
  ...
  payload: json['payload'] != null ? OneOf2.parse(json['payload'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v)), canParseA: (v) => v is Map, fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ReposCreateDeploymentRequest &&
          ...
          const ListEquality<dynamic>().equals(requiredContexts, other.requiredContexts) &&
