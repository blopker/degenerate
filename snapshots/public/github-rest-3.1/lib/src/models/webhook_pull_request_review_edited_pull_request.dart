...
factory WebhookPullRequestReviewEditedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewEditedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User13.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User13.canParse(v), fromB: (v) => Team14.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team14.canParse(v),)).toList(),
