...
import 'manifest.dart';import 'metadata_value.dart';import 'snapshot_detector.dart';import 'snapshot_job.dart';/// Create a new snapshot of a repository's dependencies.
...
Snapshot copyWith({int? version, SnapshotJob? job, String? sha, String? ref, SnapshotDetector? detector, Map<String, MetadataValue> Function()? metadata, Map<String, Manifest> Function()? manifests, DateTime? scanned, }) { return Snapshot(
