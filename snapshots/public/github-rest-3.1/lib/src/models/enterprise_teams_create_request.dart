...
import 'enterprise_teams_create_request_organization_selection_type.dart';import 'enterprise_teams_create_request_sync_to_organizations.dart';final class EnterpriseTeamsCreateRequest {const EnterpriseTeamsCreateRequest({required this.name, this.description, this.syncToOrganizations = EnterpriseTeamsCreateRequestSyncToOrganizations.disabled, this.organizationSelectionType = EnterpriseTeamsCreateRequestOrganizationSelectionType.disabled, this.groupId, });
