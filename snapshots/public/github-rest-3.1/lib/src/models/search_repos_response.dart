...
import 'package:collection/collection.dart';import 'repo_search_result_item.dart';final class SearchReposResponse {const SearchReposResponse({required this.totalCount, required this.incompleteResults, required this.items, });
