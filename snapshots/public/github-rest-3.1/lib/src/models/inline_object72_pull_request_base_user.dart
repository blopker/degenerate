...
final class InlineObject72PullRequestBaseUserType {const InlineObject72PullRequestBaseUserType._(this.value);

factory InlineObject72PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject72PullRequestBaseUserType._(json),
}; }

static const InlineObject72PullRequestBaseUserType bot = InlineObject72PullRequestBaseUserType._('Bot');

static const InlineObject72PullRequestBaseUserType user = InlineObject72PullRequestBaseUserType._('User');

static const InlineObject72PullRequestBaseUserType organization = InlineObject72PullRequestBaseUserType._('Organization');

static const List<InlineObject72PullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestBaseUserType($value)'; } 
 }
final class InlineObject72PullRequestBaseUser {const InlineObject72PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject72PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestBaseUser(
  ...
  type: json['type'] != null ? InlineObject72PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestBaseUserType? type;
...
InlineObject72PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestBaseUser &&
