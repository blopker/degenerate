...
import 'check_run_with_simple_check_suite.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_check_run_requested_action_action.dart';import 'webhook_check_run_requested_action_requested_action.dart';final class WebhookCheckRunRequestedAction {const WebhookCheckRunRequestedAction({required this.action, required this.checkRun, this.installation, this.enterprise, this.organization, required this.repository, this.requestedAction, required this.sender, });
...
factory WebhookCheckRunRequestedAction.fromJson(Map<String, dynamic> json) { return WebhookCheckRunRequestedAction(
  ...
  requestedAction: json['requested_action'] != null
        ? WebhookCheckRunRequestedActionRequestedAction.fromJson(json['requested_action'] as Map<String, dynamic>)
        : null,
