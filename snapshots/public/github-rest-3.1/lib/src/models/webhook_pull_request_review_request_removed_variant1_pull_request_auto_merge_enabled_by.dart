...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType bot = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType user = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType organization = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAutoMergeEnabledBy &&
