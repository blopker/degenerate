...
import 'package:collection/collection.dart';import 'webhook_pull_request_review_requested_variant2_pull_request_base_repo_created_at.dart';import 'webhook_pull_request_review_requested_variant2_pull_request_base_repo_license.dart';import 'webhook_pull_request_review_requested_variant2_pull_request_base_repo_owner.dart';import 'webhook_pull_request_review_requested_variant2_pull_request_base_repo_permissions.dart';import 'webhook_pull_request_review_requested_variant2_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy all = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage prBody = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage prTitle = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage blank = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle prTitle = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle mergeMessage = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage prBody = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage commitMessages = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage blank = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle prTitle = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility {const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility public = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility._('public');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility private = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility._('private');

static const WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility internal = WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility._('internal');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepo(
  ...
  createdAt: WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoCreatedAt createdAt;
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoOwner? owner;

final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPermissions? permissions;
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility visibility;
...
WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoOwner? Function()? owner, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestBaseRepo &&
