...
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType bot = WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType user = WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType._('User');

static const WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType organization = WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser {const WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType? type;
...
WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestBaseUser &&
