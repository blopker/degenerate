...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_marketplace_purchase_pending_change_action.dart';import 'webhook_marketplace_purchase_pending_change_previous_marketplace_purchase.dart';import 'webhooks_marketplace_purchase.dart';final class WebhookMarketplacePurchasePendingChange {const WebhookMarketplacePurchasePendingChange({required this.action, required this.effectiveDate, this.enterprise, this.installation, required this.marketplacePurchase, this.organization, this.previousMarketplacePurchase, this.repository, required this.sender, });
...
factory WebhookMarketplacePurchasePendingChange.fromJson(Map<String, dynamic> json) { return WebhookMarketplacePurchasePendingChange(
  ...
  previousMarketplacePurchase: json['previous_marketplace_purchase'] != null
        ? WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchase.fromJson(json['previous_marketplace_purchase'] as Map<String, dynamic>)
        : null,
