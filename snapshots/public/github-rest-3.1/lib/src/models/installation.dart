...
import 'package:collection/collection.dart';import 'app_permissions.dart';import 'installation_account.dart';import 'simple_user.dart';/// Describe whether all repositories have been selected or there's a selection involved
...
factory Installation.fromJson(Map<String, dynamic> json) { return Installation(
  ...
  account: InstallationAccount.fromJson(json['account'] as Map<String, dynamic>),
