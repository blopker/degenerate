...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'copilot_seat_details_assigning_team.dart';import 'organization_simple.dart';import 'simple_user.dart';/// The Copilot plan of the organization, or the parent enterprise, when applicable.
...
factory CopilotSeatDetails.fromJson(Map<String, dynamic> json) { return CopilotSeatDetails(
  ...
  assigningTeam: json['assigning_team'] != null ? OneOf2.parse(json['assigning_team'], fromA: (v) => Team.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Team.canParse(v), fromB: (v) => EnterpriseTeam.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EnterpriseTeam.canParse(v),) : null,
