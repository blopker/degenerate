...
import 'package:collection/collection.dart';import 'budget.dart';final class GetAllBudgets {const GetAllBudgets({required this.budgets, this.hasNextPage, this.totalCount, });
