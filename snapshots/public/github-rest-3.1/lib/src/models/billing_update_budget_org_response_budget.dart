...
import 'billing_update_budget_org_response_budget_budget_alerting.dart';import 'billing_update_budget_org_response_budget_budget_scope.dart';import 'billing_update_budget_org_response_budget_budget_type.dart';final class BillingUpdateBudgetOrgResponseBudget {const BillingUpdateBudgetOrgResponseBudget({this.id, this.budgetAmount, this.preventFurtherUsage, this.budgetAlerting, this.budgetScope, this.budgetEntityName = '', this.budgetType, this.budgetProductSku, });
