...
import 'package:collection/collection.dart';import 'inline_object63_pull_request_base_repo_created_at.dart';import 'inline_object63_pull_request_base_repo_license.dart';import 'inline_object63_pull_request_base_repo_owner.dart';import 'inline_object63_pull_request_base_repo_permissions.dart';import 'inline_object63_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class InlineObject63PullRequestBaseRepoPullRequestCreationPolicy {const InlineObject63PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory InlineObject63PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => InlineObject63PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const InlineObject63PullRequestBaseRepoPullRequestCreationPolicy all = InlineObject63PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const InlineObject63PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = InlineObject63PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<InlineObject63PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class InlineObject63PullRequestBaseRepoMergeCommitTitle {const InlineObject63PullRequestBaseRepoMergeCommitTitle._(this.value);

factory InlineObject63PullRequestBaseRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => InlineObject63PullRequestBaseRepoMergeCommitTitle._(json),
}; }

static const InlineObject63PullRequestBaseRepoMergeCommitTitle prTitle = InlineObject63PullRequestBaseRepoMergeCommitTitle._('PR_TITLE');

static const InlineObject63PullRequestBaseRepoMergeCommitTitle mergeMessage = InlineObject63PullRequestBaseRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<InlineObject63PullRequestBaseRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestBaseRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestBaseRepoMergeCommitTitle($value)'; } 
 }
/// The default value for a squash merge commit message.
final class InlineObject63PullRequestBaseRepoSquashMergeCommitMessage {const InlineObject63PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory InlineObject63PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const InlineObject63PullRequestBaseRepoSquashMergeCommitMessage prBody = InlineObject63PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject63PullRequestBaseRepoSquashMergeCommitMessage commitMessages = InlineObject63PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject63PullRequestBaseRepoSquashMergeCommitMessage blank = InlineObject63PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject63PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title.
final class InlineObject63PullRequestBaseRepoSquashMergeCommitTitle {const InlineObject63PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory InlineObject63PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject63PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject63PullRequestBaseRepoSquashMergeCommitTitle prTitle = InlineObject63PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject63PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject63PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject63PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory InlineObject63PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestBaseRepo(
  ...
  createdAt: InlineObject63PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject63PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject63PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject63PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject63PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject63PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject63PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject63PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject63PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject63PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject63PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject63PullRequestBaseRepoCreatedAt createdAt;
...
final InlineObject63PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject63PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject63PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject63PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject63PullRequestBaseRepoOwner? owner;

final InlineObject63PullRequestBaseRepoPermissions? permissions;
...
final InlineObject63PullRequestBaseRepoPushedAt? pushedAt;
...
/// The default value for a squash merge commit message.
final InlineObject63PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title.
final InlineObject63PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject63PullRequestBaseRepoVisibility visibility;
...
InlineObject63PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject63PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject63PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject63PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, InlineObject63PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject63PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject63PullRequestBaseRepoOwner? Function()? owner, InlineObject63PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject63PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject63PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject63PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject63PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject63PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestBaseRepo &&
