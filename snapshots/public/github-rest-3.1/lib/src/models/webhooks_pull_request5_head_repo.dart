...
import 'package:collection/collection.dart';import 'webhooks_pull_request5_head_repo_created_at.dart';import 'webhooks_pull_request5_head_repo_license.dart';import 'webhooks_pull_request5_head_repo_owner.dart';import 'webhooks_pull_request5_head_repo_permissions.dart';import 'webhooks_pull_request5_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
factory WebhooksPullRequest5HeadRepo.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5HeadRepo(
  ...
  createdAt: WebhooksPullRequest5HeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  license: WebhooksPullRequest5HeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  owner: WebhooksPullRequest5HeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  ...
  pushedAt: WebhooksPullRequest5HeadRepoPushedAt.fromJson(json['pushed_at']),
...
final WebhooksPullRequest5HeadRepoCreatedAt createdAt;
...
final WebhooksPullRequest5HeadRepoPushedAt? pushedAt;
