...
final class InlineObject72PullRequestHeadUserType {const InlineObject72PullRequestHeadUserType._(this.value);

factory InlineObject72PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject72PullRequestHeadUserType bot = InlineObject72PullRequestHeadUserType._('Bot');

static const InlineObject72PullRequestHeadUserType user = InlineObject72PullRequestHeadUserType._('User');

static const InlineObject72PullRequestHeadUserType organization = InlineObject72PullRequestHeadUserType._('Organization');

static const List<InlineObject72PullRequestHeadUserType> values = [bot, user, organization];
...
factory InlineObject72PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestHeadUser(
  ...
  type: json['type'] != null ? InlineObject72PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestHeadUserType? type;
...
InlineObject72PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestHeadUser &&
...
@override String toString() { return 'InlineObject72PullRequestHeadUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
