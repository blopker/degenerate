...
import 'package:collection/collection.dart';import 'dependabot_create_or_update_org_secret_request_selected_repository_ids.dart';/// Which type of organization repositories have access to the organization secret. `selected` means only the repositories specified by `selected_repository_ids` can access the secret.
...
factory DependabotCreateOrUpdateOrgSecretRequest.fromJson(Map<String, dynamic> json) { return DependabotCreateOrUpdateOrgSecretRequest(
  ...
  selectedRepositoryIds: (json['selected_repository_ids'] as List<dynamic>?)?.map((e) => DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
final List<DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds>? selectedRepositoryIds;

Map<String, dynamic> toJson() { return {
  'encrypted_value': ?encryptedValue,
  'key_id': ?keyId,
  'visibility': visibility.toJson(),
  if (selectedRepositoryIds != null) 'selected_repository_ids': selectedRepositoryIds?.map((e) => e.toJson()).toList(),
}; } 
static bool canParse(Map<String, dynamic> json) { return json.containsKey('visibility'); } 
DependabotCreateOrUpdateOrgSecretRequest copyWith({String Function()? encryptedValue, String Function()? keyId, DependabotCreateOrUpdateOrgSecretRequestVisibility? visibility, List<DependabotCreateOrUpdateOrgSecretRequestSelectedRepositoryIds> Function()? selectedRepositoryIds, }) { return DependabotCreateOrUpdateOrgSecretRequest(
