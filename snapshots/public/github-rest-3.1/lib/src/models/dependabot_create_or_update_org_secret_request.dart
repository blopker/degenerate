...
import 'package:collection/collection.dart';import 'dependabot_create_or_update_org_secret_request_selected_repository_ids.dart';import 'dependabot_create_or_update_org_secret_request_visibility.dart';final class DependabotCreateOrUpdateOrgSecretRequest {const DependabotCreateOrUpdateOrgSecretRequest({this.encryptedValue, this.keyId, required this.visibility, this.selectedRepositoryIds, });
