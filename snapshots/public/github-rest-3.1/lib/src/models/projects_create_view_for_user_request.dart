...
import 'package:collection/collection.dart';import 'projects_create_view_for_user_request_layout.dart';final class ProjectsCreateViewForUserRequest {const ProjectsCreateViewForUserRequest({required this.name, required this.layout, this.filter, this.visibleFields, });
