...
final class InlineObject63PullRequestBaseUserType {const InlineObject63PullRequestBaseUserType._(this.value);

factory InlineObject63PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject63PullRequestBaseUserType bot = InlineObject63PullRequestBaseUserType._('Bot');

static const InlineObject63PullRequestBaseUserType user = InlineObject63PullRequestBaseUserType._('User');

static const InlineObject63PullRequestBaseUserType organization = InlineObject63PullRequestBaseUserType._('Organization');

static const List<InlineObject63PullRequestBaseUserType> values = [bot, user, organization];
...
@override String toString() { return 'InlineObject63PullRequestBaseUserType($value)'; } 
 }
final class InlineObject63PullRequestBaseUser {const InlineObject63PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestBaseUser(
  ...
  type: json['type'] != null ? InlineObject63PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestBaseUserType? type;
...
InlineObject63PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestBaseUser &&
...
@override String toString() { return 'InlineObject63PullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
