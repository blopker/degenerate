...
import 'item.dart';import 'item_archived_action.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhooks_project_changes.dart';final class ItemArchived {const ItemArchived({required this.action, required this.changes, this.installation, required this.organization, required this.projectsV2Item, required this.sender, });
