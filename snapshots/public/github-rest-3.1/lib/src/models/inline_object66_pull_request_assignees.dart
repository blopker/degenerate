...
final class InlineObject66PullRequestAssigneesType {const InlineObject66PullRequestAssigneesType._(this.value);

factory InlineObject66PullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject66PullRequestAssigneesType bot = InlineObject66PullRequestAssigneesType._('Bot');

static const InlineObject66PullRequestAssigneesType user = InlineObject66PullRequestAssigneesType._('User');

static const InlineObject66PullRequestAssigneesType organization = InlineObject66PullRequestAssigneesType._('Organization');

static const List<InlineObject66PullRequestAssigneesType> values = [bot, user, organization];
...
@override String toString() { return 'InlineObject66PullRequestAssigneesType($value)'; } 
 }
final class InlineObject66PullRequestAssignees {const InlineObject66PullRequestAssignees({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestAssignees.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestAssignees(
  ...
  type: json['type'] != null ? InlineObject66PullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestAssigneesType? type;
...
InlineObject66PullRequestAssignees copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestAssigneesType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestAssignees &&
...
@override String toString() { return 'InlineObject66PullRequestAssignees(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
