...
import 'package:collection/collection.dart';import 'code_scanning_alert_classification.dart';import 'code_scanning_alert_instance_list_message.dart';import 'code_scanning_alert_instance_state.dart';import 'code_scanning_alert_location.dart';final class CodeScanningAlertInstanceList {const CodeScanningAlertInstanceList({this.ref, this.analysisKey, this.environment, this.category, this.state, this.commitSha, this.message, this.location, this.htmlUrl, this.classifications, });
...
CodeScanningAlertInstanceList copyWith({String Function()? ref, String Function()? analysisKey, String Function()? environment, String Function()? category, CodeScanningAlertInstanceState? Function()? state, String Function()? commitSha, CodeScanningAlertInstanceListMessage Function()? message, CodeScanningAlertLocation Function()? location, String Function()? htmlUrl, List<CodeScanningAlertClassification> Function()? classifications, }) { return CodeScanningAlertInstanceList(
