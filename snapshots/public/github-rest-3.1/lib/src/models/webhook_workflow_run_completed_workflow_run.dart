...
factory WebhookWorkflowRunCompletedWorkflowRun.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunCompletedWorkflowRun(
  actor: WebhookWorkflowRunCompletedWorkflowRunActor.fromJson(json['actor'] as Map<String, dynamic>),
  ...
  conclusion: WebhookWorkflowRunCompletedWorkflowRunConclusion.fromJson(json['conclusion'] as String),
  ...
  triggeringActor: WebhookWorkflowRunCompletedWorkflowRunTriggeringActor.fromJson(json['triggering_actor'] as Map<String, dynamic>),
