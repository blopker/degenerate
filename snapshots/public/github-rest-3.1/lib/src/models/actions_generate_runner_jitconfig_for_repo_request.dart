...
import 'package:collection/collection.dart';final class ActionsGenerateRunnerJitconfigForRepoRequest {const ActionsGenerateRunnerJitconfigForRepoRequest({required this.name, required this.runnerGroupId, required this.labels, this.workFolder = '_work', });
