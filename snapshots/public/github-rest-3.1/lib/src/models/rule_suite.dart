...
import 'package:collection/collection.dart';import 'rule_suite_rule_evaluations.dart';/// The result of the rule evaluations for rules with the `active` enforcement status.
