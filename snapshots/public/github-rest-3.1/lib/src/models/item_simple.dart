...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'item_content_type.dart';import 'item_simple_content.dart';import 'simple_user.dart';/// An item belonging to a project
...
factory ItemSimple.fromJson(Map<String, dynamic> json) { return ItemSimple(
  ...
  content: json['content'] != null ? OneOf3.parse(json['content'], fromA: (v) => Issue.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Issue.canParse(v), fromB: (v) => PullRequestSimple.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PullRequestSimple.canParse(v), fromC: (v) => DraftIssue.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DraftIssue.canParse(v),) : null,
