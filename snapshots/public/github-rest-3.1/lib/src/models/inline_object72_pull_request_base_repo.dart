...
import 'package:collection/collection.dart';import 'inline_object72_pull_request_base_repo_created_at.dart';import 'inline_object72_pull_request_base_repo_license.dart';import 'inline_object72_pull_request_base_repo_owner.dart';import 'inline_object72_pull_request_base_repo_permissions.dart';import 'inline_object72_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class InlineObject72PullRequestBaseRepoPullRequestCreationPolicy {const InlineObject72PullRequestBaseRepoPullRequestCreationPolicy._(this.value);

factory InlineObject72PullRequestBaseRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => InlineObject72PullRequestBaseRepoPullRequestCreationPolicy._(json),
}; }

static const InlineObject72PullRequestBaseRepoPullRequestCreationPolicy all = InlineObject72PullRequestBaseRepoPullRequestCreationPolicy._('all');

static const InlineObject72PullRequestBaseRepoPullRequestCreationPolicy collaboratorsOnly = InlineObject72PullRequestBaseRepoPullRequestCreationPolicy._('collaborators_only');

static const List<InlineObject72PullRequestBaseRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestBaseRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestBaseRepoPullRequestCreationPolicy($value)'; } 
 }
...
final class InlineObject72PullRequestBaseRepoMergeCommitMessage {const InlineObject72PullRequestBaseRepoMergeCommitMessage._(this.value);

factory InlineObject72PullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
...
static const InlineObject72PullRequestBaseRepoMergeCommitMessage prBody = InlineObject72PullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const InlineObject72PullRequestBaseRepoMergeCommitMessage prTitle = InlineObject72PullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const InlineObject72PullRequestBaseRepoMergeCommitMessage blank = InlineObject72PullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<InlineObject72PullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class InlineObject72PullRequestBaseRepoSquashMergeCommitMessage {const InlineObject72PullRequestBaseRepoSquashMergeCommitMessage._(this.value);

factory InlineObject72PullRequestBaseRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'COMMIT_MESSAGES' => commitMessages,
  'BLANK' => blank,
  _ => InlineObject72PullRequestBaseRepoSquashMergeCommitMessage._(json),
}; }

static const InlineObject72PullRequestBaseRepoSquashMergeCommitMessage prBody = InlineObject72PullRequestBaseRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject72PullRequestBaseRepoSquashMergeCommitMessage commitMessages = InlineObject72PullRequestBaseRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject72PullRequestBaseRepoSquashMergeCommitMessage blank = InlineObject72PullRequestBaseRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject72PullRequestBaseRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestBaseRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestBaseRepoSquashMergeCommitMessage($value)'; } 
 }
...
factory InlineObject72PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestBaseRepo(
  ...
  createdAt: InlineObject72PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject72PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject72PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject72PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject72PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject72PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject72PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject72PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject72PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject72PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject72PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject72PullRequestBaseRepoCreatedAt createdAt;
...
final InlineObject72PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject72PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject72PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject72PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject72PullRequestBaseRepoOwner? owner;

final InlineObject72PullRequestBaseRepoPermissions? permissions;
...
final InlineObject72PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject72PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject72PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject72PullRequestBaseRepoVisibility visibility;
...
InlineObject72PullRequestBaseRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject72PullRequestBaseRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject72PullRequestBaseRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject72PullRequestBaseRepoLicense? Function()? license, String Function()? masterBranch, InlineObject72PullRequestBaseRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject72PullRequestBaseRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject72PullRequestBaseRepoOwner? Function()? owner, InlineObject72PullRequestBaseRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject72PullRequestBaseRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject72PullRequestBaseRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject72PullRequestBaseRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject72PullRequestBaseRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject72PullRequestBaseRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestBaseRepo &&
