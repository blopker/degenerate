...
import 'inline_object94_bundle_dsse_envelope.dart';import 'inline_object94_bundle_verification_material.dart';/// The bundle of the attestation.
final class InlineObject94Bundle {const InlineObject94Bundle({this.mediaType, this.verificationMaterial, this.dsseEnvelope, });
...
InlineObject94Bundle copyWith({String Function()? mediaType, InlineObject94BundleVerificationMaterial Function()? verificationMaterial, InlineObject94BundleDsseEnvelope Function()? dsseEnvelope, }) { return InlineObject94Bundle(
...
@override String toString() { return 'InlineObject94Bundle(mediaType: $mediaType, verificationMaterial: $verificationMaterial, dsseEnvelope: $dsseEnvelope)'; } 
 }
