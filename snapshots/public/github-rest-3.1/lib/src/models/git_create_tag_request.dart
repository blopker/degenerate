...
import 'git_create_tag_request_tagger.dart';import 'git_create_tag_request_type.dart';final class GitCreateTagRequest {const GitCreateTagRequest({required this.tag, required this.message, required this.object, required this.type, this.tagger, });
