...
final class InlineObject72PullRequestBaseRepoOwnerType {const InlineObject72PullRequestBaseRepoOwnerType._(this.value);

factory InlineObject72PullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject72PullRequestBaseRepoOwnerType bot = InlineObject72PullRequestBaseRepoOwnerType._('Bot');

static const InlineObject72PullRequestBaseRepoOwnerType user = InlineObject72PullRequestBaseRepoOwnerType._('User');

static const InlineObject72PullRequestBaseRepoOwnerType organization = InlineObject72PullRequestBaseRepoOwnerType._('Organization');

static const List<InlineObject72PullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestBaseRepoOwnerType($value)'; } 
 }
final class InlineObject72PullRequestBaseRepoOwner {const InlineObject72PullRequestBaseRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject72PullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? InlineObject72PullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestBaseRepoOwnerType? type;
...
InlineObject72PullRequestBaseRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestBaseRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestBaseRepoOwner &&
