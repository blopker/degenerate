...
final class InlineObject69PullRequestBaseUser {const InlineObject69PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject69PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestBaseUser(
  ...
  type: json['type'] != null ? InlineObject69PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestBaseUserType? type;
...
InlineObject69PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestBaseUser &&
...
@override String toString() { return 'InlineObject69PullRequestBaseUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
