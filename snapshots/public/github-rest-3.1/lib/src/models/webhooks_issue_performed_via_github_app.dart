...
import 'package:collection/collection.dart';import 'webhooks_issue_performed_via_github_app_events.dart';import 'webhooks_issue_performed_via_github_app_owner.dart';import 'webhooks_issue_performed_via_github_app_permissions.dart';/// GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
...
factory WebhooksIssuePerformedViaGithubApp.fromJson(Map<String, dynamic> json) { return WebhooksIssuePerformedViaGithubApp(
  ...
  owner: WebhooksIssuePerformedViaGithubAppOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null
        ? WebhooksIssuePerformedViaGithubAppPermissions.fromJson(json['permissions'] as Map<String, dynamic>)
        : null,
