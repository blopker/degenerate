...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'item.dart';import 'item_edited_changes.dart';import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';final class ItemEditedAction {const ItemEditedAction._(this.value);
...
factory ItemEdited.fromJson(Map<String, dynamic> json) { return ItemEdited(
  ...
  changes: json['changes'] != null ? OneOf2.parse(json['changes'], fromA: (v) => ItemEditedChangesVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ItemEditedChangesVariant1.canParse(v), fromB: (v) => ItemEditedChangesVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ItemEditedChangesVariant2.canParse(v),) : null,
