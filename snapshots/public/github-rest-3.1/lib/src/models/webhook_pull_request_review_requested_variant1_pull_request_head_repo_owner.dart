...
final class WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType {const WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType user = WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner {const WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestHeadRepoOwner &&
