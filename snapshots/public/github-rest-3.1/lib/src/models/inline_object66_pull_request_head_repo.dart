...
import 'package:collection/collection.dart';import 'inline_object66_pull_request_head_repo_created_at.dart';import 'inline_object66_pull_request_head_repo_license.dart';import 'inline_object66_pull_request_head_repo_owner.dart';import 'inline_object66_pull_request_head_repo_permissions.dart';import 'inline_object66_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
final class InlineObject66PullRequestHeadRepoPullRequestCreationPolicy {const InlineObject66PullRequestHeadRepoPullRequestCreationPolicy._(this.value);

factory InlineObject66PullRequestHeadRepoPullRequestCreationPolicy.fromJson(String json) { return switch (json) {
  'all' => all,
  'collaborators_only' => collaboratorsOnly,
  _ => InlineObject66PullRequestHeadRepoPullRequestCreationPolicy._(json),
}; }

static const InlineObject66PullRequestHeadRepoPullRequestCreationPolicy all = InlineObject66PullRequestHeadRepoPullRequestCreationPolicy._('all');

static const InlineObject66PullRequestHeadRepoPullRequestCreationPolicy collaboratorsOnly = InlineObject66PullRequestHeadRepoPullRequestCreationPolicy._('collaborators_only');

static const List<InlineObject66PullRequestHeadRepoPullRequestCreationPolicy> values = [all, collaboratorsOnly];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestHeadRepoPullRequestCreationPolicy && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestHeadRepoPullRequestCreationPolicy($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class InlineObject66PullRequestHeadRepoSquashMergeCommitMessage {const InlineObject66PullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory InlineObject66PullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const InlineObject66PullRequestHeadRepoSquashMergeCommitMessage prBody = InlineObject66PullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject66PullRequestHeadRepoSquashMergeCommitMessage commitMessages = InlineObject66PullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject66PullRequestHeadRepoSquashMergeCommitMessage blank = InlineObject66PullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject66PullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class InlineObject66PullRequestHeadRepoSquashMergeCommitTitle {const InlineObject66PullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory InlineObject66PullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject66PullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject66PullRequestHeadRepoSquashMergeCommitTitle prTitle = InlineObject66PullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject66PullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject66PullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject66PullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory InlineObject66PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestHeadRepo(
  ...
  createdAt: InlineObject66PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject66PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject66PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject66PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject66PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject66PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject66PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject66PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject66PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject66PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject66PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject66PullRequestHeadRepoCreatedAt createdAt;
...
final InlineObject66PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject66PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject66PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject66PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject66PullRequestHeadRepoOwner? owner;

final InlineObject66PullRequestHeadRepoPermissions? permissions;
...
final InlineObject66PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject66PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject66PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject66PullRequestHeadRepoVisibility visibility;
...
InlineObject66PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject66PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject66PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject66PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, InlineObject66PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject66PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject66PullRequestHeadRepoOwner? Function()? owner, InlineObject66PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject66PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject66PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject66PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject66PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject66PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestHeadRepo &&
