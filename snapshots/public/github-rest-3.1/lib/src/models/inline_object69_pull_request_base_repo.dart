...
import 'package:collection/collection.dart';import 'inline_object69_pull_request_base_repo_created_at.dart';import 'inline_object69_pull_request_base_repo_license.dart';import 'inline_object69_pull_request_base_repo_owner.dart';import 'inline_object69_pull_request_base_repo_permissions.dart';import 'inline_object69_pull_request_base_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class InlineObject69PullRequestBaseRepoMergeCommitMessage {const InlineObject69PullRequestBaseRepoMergeCommitMessage._(this.value);

factory InlineObject69PullRequestBaseRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => InlineObject69PullRequestBaseRepoMergeCommitMessage._(json),
}; }

static const InlineObject69PullRequestBaseRepoMergeCommitMessage prBody = InlineObject69PullRequestBaseRepoMergeCommitMessage._('PR_BODY');

static const InlineObject69PullRequestBaseRepoMergeCommitMessage prTitle = InlineObject69PullRequestBaseRepoMergeCommitMessage._('PR_TITLE');

static const InlineObject69PullRequestBaseRepoMergeCommitMessage blank = InlineObject69PullRequestBaseRepoMergeCommitMessage._('BLANK');

static const List<InlineObject69PullRequestBaseRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestBaseRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestBaseRepoMergeCommitMessage($value)'; } 
 }
...
final class InlineObject69PullRequestBaseRepoSquashMergeCommitTitle {const InlineObject69PullRequestBaseRepoSquashMergeCommitTitle._(this.value);

factory InlineObject69PullRequestBaseRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject69PullRequestBaseRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject69PullRequestBaseRepoSquashMergeCommitTitle prTitle = InlineObject69PullRequestBaseRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject69PullRequestBaseRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject69PullRequestBaseRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject69PullRequestBaseRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestBaseRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestBaseRepoSquashMergeCommitTitle($value)'; } 
 }
final class InlineObject69PullRequestBaseRepoVisibility {const InlineObject69PullRequestBaseRepoVisibility._(this.value);

factory InlineObject69PullRequestBaseRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
...
static const InlineObject69PullRequestBaseRepoVisibility public = InlineObject69PullRequestBaseRepoVisibility._('public');

static const InlineObject69PullRequestBaseRepoVisibility private = InlineObject69PullRequestBaseRepoVisibility._('private');

static const InlineObject69PullRequestBaseRepoVisibility internal = InlineObject69PullRequestBaseRepoVisibility._('internal');

static const List<InlineObject69PullRequestBaseRepoVisibility> values = [public, private, internal];
...
factory InlineObject69PullRequestBaseRepo.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestBaseRepo(
  ...
  createdAt: InlineObject69PullRequestBaseRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject69PullRequestBaseRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject69PullRequestBaseRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject69PullRequestBaseRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject69PullRequestBaseRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject69PullRequestBaseRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject69PullRequestBaseRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject69PullRequestBaseRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject69PullRequestBaseRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject69PullRequestBaseRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject69PullRequestBaseRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject69PullRequestBaseRepoCreatedAt createdAt;
...
final InlineObject69PullRequestBaseRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject69PullRequestBaseRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject69PullRequestBaseRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject69PullRequestBaseRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject69PullRequestBaseRepoOwner? owner;

final InlineObject69PullRequestBaseRepoPermissions? permissions;
...
final InlineObject69PullRequestBaseRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject69PullRequestBaseRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject69PullRequestBaseRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject69PullRequestBaseRepoVisibility visibility;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestBaseRepo &&
