...
import 'package:collection/collection.dart';import 'user_search_result_item.dart';final class SearchUsersResponse {const SearchUsersResponse({required this.totalCount, required this.incompleteResults, required this.items, });
