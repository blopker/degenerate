...
import 'package:collection/collection.dart';import 'file_commit_commit_author.dart';import 'file_commit_commit_committer.dart';import 'file_commit_commit_parents.dart';import 'file_commit_commit_tree.dart';import 'file_commit_commit_verification.dart';final class FileCommitCommit {const FileCommitCommit({this.sha, this.nodeId, this.url, this.htmlUrl, this.author, this.committer, this.message, this.tree, this.parents, this.verification, });
