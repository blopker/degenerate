...
import 'package:collection/collection.dart';import 'webhook_check_suite_requested_check_suite_app_owner.dart';import 'webhook_check_suite_requested_check_suite_app_permissions.dart';final class WebhookCheckSuiteRequestedCheckSuiteAppEvents {const WebhookCheckSuiteRequestedCheckSuiteAppEvents._(this.value);
...
factory WebhookCheckSuiteRequestedCheckSuiteApp.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteRequestedCheckSuiteApp(
  ...
  permissions: json['permissions'] != null
        ? WebhookCheckSuiteRequestedCheckSuiteAppPermissions.fromJson(json['permissions'] as Map<String, dynamic>)
        : null,
