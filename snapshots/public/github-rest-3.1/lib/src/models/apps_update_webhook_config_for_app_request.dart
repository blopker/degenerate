...
import 'webhook_config_content_type.dart';import 'webhook_config_insecure_ssl.dart';import 'webhook_config_secret.dart';import 'webhook_config_url.dart';final class AppsUpdateWebhookConfigForAppRequest {const AppsUpdateWebhookConfigForAppRequest({this.url, this.contentType, this.secret, this.insecureSsl, });
