...
import 'package:collection/collection.dart';import 'inline_object69_pull_request_head_repo_created_at.dart';import 'inline_object69_pull_request_head_repo_license.dart';import 'inline_object69_pull_request_head_repo_owner.dart';import 'inline_object69_pull_request_head_repo_permissions.dart';import 'inline_object69_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class InlineObject69PullRequestHeadRepoMergeCommitMessage {const InlineObject69PullRequestHeadRepoMergeCommitMessage._(this.value);

factory InlineObject69PullRequestHeadRepoMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
  'PR_TITLE' => prTitle,
  'BLANK' => blank,
  _ => InlineObject69PullRequestHeadRepoMergeCommitMessage._(json),
}; }

static const InlineObject69PullRequestHeadRepoMergeCommitMessage prBody = InlineObject69PullRequestHeadRepoMergeCommitMessage._('PR_BODY');

static const InlineObject69PullRequestHeadRepoMergeCommitMessage prTitle = InlineObject69PullRequestHeadRepoMergeCommitMessage._('PR_TITLE');

static const InlineObject69PullRequestHeadRepoMergeCommitMessage blank = InlineObject69PullRequestHeadRepoMergeCommitMessage._('BLANK');

static const List<InlineObject69PullRequestHeadRepoMergeCommitMessage> values = [prBody, prTitle, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestHeadRepoMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestHeadRepoMergeCommitMessage($value)'; } 
 }
/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final class InlineObject69PullRequestHeadRepoMergeCommitTitle {const InlineObject69PullRequestHeadRepoMergeCommitTitle._(this.value);

factory InlineObject69PullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => InlineObject69PullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const InlineObject69PullRequestHeadRepoMergeCommitTitle prTitle = InlineObject69PullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const InlineObject69PullRequestHeadRepoMergeCommitTitle mergeMessage = InlineObject69PullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<InlineObject69PullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
/// - `BLANK` - default to a blank commit message.
final class InlineObject69PullRequestHeadRepoSquashMergeCommitMessage {const InlineObject69PullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory InlineObject69PullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const InlineObject69PullRequestHeadRepoSquashMergeCommitMessage prBody = InlineObject69PullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject69PullRequestHeadRepoSquashMergeCommitMessage commitMessages = InlineObject69PullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject69PullRequestHeadRepoSquashMergeCommitMessage blank = InlineObject69PullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject69PullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
...
factory InlineObject69PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestHeadRepo(
  ...
  createdAt: InlineObject69PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject69PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject69PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject69PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject69PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject69PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject69PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject69PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject69PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject69PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject69PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject69PullRequestHeadRepoCreatedAt createdAt;
...
final InlineObject69PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject69PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject69PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject69PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject69PullRequestHeadRepoOwner? owner;

final InlineObject69PullRequestHeadRepoPermissions? permissions;
...
final InlineObject69PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject69PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject69PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject69PullRequestHeadRepoVisibility visibility;
...
InlineObject69PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject69PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject69PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject69PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, InlineObject69PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject69PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject69PullRequestHeadRepoOwner? Function()? owner, InlineObject69PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject69PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject69PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject69PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject69PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject69PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestHeadRepo &&
