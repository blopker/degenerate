...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_delete_ref_type.dart';final class WebhookDelete {const WebhookDelete({this.enterprise, this.installation, this.organization, required this.pusherType, required this.ref, required this.refType, required this.repository, required this.sender, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('pusher_type') && json['pusher_type'] is String &&
      json.containsKey('ref') && json['ref'] is String &&
      json.containsKey('ref_type') &&
      json.containsKey('repository') &&
      json.containsKey('sender'); } 
WebhookDelete copyWith({EnterpriseWebhooks Function()? enterprise, SimpleInstallation Function()? installation, OrganizationSimpleWebhooks Function()? organization, String? pusherType, String? ref, WebhookDeleteRefType? refType, RepositoryWebhooks? repository, SimpleUser? sender, }) { return WebhookDelete(
