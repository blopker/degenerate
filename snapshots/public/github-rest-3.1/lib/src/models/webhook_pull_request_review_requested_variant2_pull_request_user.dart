...
final class WebhookPullRequestReviewRequestedVariant2PullRequestUserType {const WebhookPullRequestReviewRequestedVariant2PullRequestUserType._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestUserType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestUserType bot = WebhookPullRequestReviewRequestedVariant2PullRequestUserType._('Bot');

static const WebhookPullRequestReviewRequestedVariant2PullRequestUserType user = WebhookPullRequestReviewRequestedVariant2PullRequestUserType._('User');

static const WebhookPullRequestReviewRequestedVariant2PullRequestUserType organization = WebhookPullRequestReviewRequestedVariant2PullRequestUserType._('Organization');

static const WebhookPullRequestReviewRequestedVariant2PullRequestUserType mannequin = WebhookPullRequestReviewRequestedVariant2PullRequestUserType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestUserType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestUser {const WebhookPullRequestReviewRequestedVariant2PullRequestUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant2PullRequestUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant2PullRequestUserType? type;
...
WebhookPullRequestReviewRequestedVariant2PullRequestUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestUser &&
...
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestUser(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
