...
final class InlineObject69PullRequestHeadRepoOwnerType {const InlineObject69PullRequestHeadRepoOwnerType._(this.value);

factory InlineObject69PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject69PullRequestHeadRepoOwnerType bot = InlineObject69PullRequestHeadRepoOwnerType._('Bot');

static const InlineObject69PullRequestHeadRepoOwnerType user = InlineObject69PullRequestHeadRepoOwnerType._('User');

static const InlineObject69PullRequestHeadRepoOwnerType organization = InlineObject69PullRequestHeadRepoOwnerType._('Organization');

static const List<InlineObject69PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject69PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject69PullRequestHeadRepoOwnerType($value)'; } 
 }
final class InlineObject69PullRequestHeadRepoOwner {const InlineObject69PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject69PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? InlineObject69PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestHeadRepoOwnerType? type;
...
InlineObject69PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestHeadRepoOwner &&
...
@override String toString() { return 'InlineObject69PullRequestHeadRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
