...
import 'package:collection/collection.dart';final class OrgsListAttestationsBulkRequest {const OrgsListAttestationsBulkRequest({required this.subjectDigests, this.predicateType, });
