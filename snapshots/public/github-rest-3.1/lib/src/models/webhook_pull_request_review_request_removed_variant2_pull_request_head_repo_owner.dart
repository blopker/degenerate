...
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType bot = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType user = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType organization = WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType? type;
...
WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestHeadRepoOwner &&
