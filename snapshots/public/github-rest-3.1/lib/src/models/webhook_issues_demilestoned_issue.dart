...
factory WebhookIssuesDemilestonedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesDemilestonedIssue(
  activeLockReason: WebhookIssuesDemilestonedIssueActiveLockReason.fromJson(json['active_lock_reason'] as String),
  ...
  milestone: WebhookIssuesDemilestonedIssueMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  ...
  user: WebhookIssuesDemilestonedIssueUser.fromJson(json['user'] as Map<String, dynamic>),
); }
