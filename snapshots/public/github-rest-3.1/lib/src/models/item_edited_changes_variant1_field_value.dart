...
factory ItemEditedChangesVariant1FieldValue.fromJson(Map<String, dynamic> json) { return ItemEditedChangesVariant1FieldValue(
  ...
  from: json['from'] != null ? OneOf4.parse(json['from'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num, fromC: (v) => SingleSelectOption.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && SingleSelectOption.canParse(v), fromD: (v) => IterationSetting.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && IterationSetting.canParse(v),) : null,
  to: json['to'] != null ? OneOf4.parse(json['to'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num, fromC: (v) => SingleSelectOption.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && SingleSelectOption.canParse(v), fromD: (v) => IterationSetting.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && IterationSetting.canParse(v),) : null,
); }
