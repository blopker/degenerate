...
import 'package:collection/collection.dart';import 'inline_object63_pull_request_head_repo_created_at.dart';import 'inline_object63_pull_request_head_repo_license.dart';import 'inline_object63_pull_request_head_repo_owner.dart';import 'inline_object63_pull_request_head_repo_permissions.dart';import 'inline_object63_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
final class InlineObject63PullRequestHeadRepoMergeCommitTitle {const InlineObject63PullRequestHeadRepoMergeCommitTitle._(this.value);

factory InlineObject63PullRequestHeadRepoMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'MERGE_MESSAGE' => mergeMessage,
  _ => InlineObject63PullRequestHeadRepoMergeCommitTitle._(json),
}; }

static const InlineObject63PullRequestHeadRepoMergeCommitTitle prTitle = InlineObject63PullRequestHeadRepoMergeCommitTitle._('PR_TITLE');

static const InlineObject63PullRequestHeadRepoMergeCommitTitle mergeMessage = InlineObject63PullRequestHeadRepoMergeCommitTitle._('MERGE_MESSAGE');

static const List<InlineObject63PullRequestHeadRepoMergeCommitTitle> values = [prTitle, mergeMessage];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestHeadRepoMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestHeadRepoMergeCommitTitle($value)'; } 
 }
...
final class InlineObject63PullRequestHeadRepoSquashMergeCommitTitle {const InlineObject63PullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory InlineObject63PullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject63PullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject63PullRequestHeadRepoSquashMergeCommitTitle prTitle = InlineObject63PullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject63PullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject63PullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject63PullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
...
factory InlineObject63PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestHeadRepo(
  ...
  createdAt: InlineObject63PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject63PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject63PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject63PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject63PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject63PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject63PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject63PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject63PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject63PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject63PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject63PullRequestHeadRepoCreatedAt createdAt;
...
final InlineObject63PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject63PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject63PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject63PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject63PullRequestHeadRepoOwner? owner;

final InlineObject63PullRequestHeadRepoPermissions? permissions;
...
final InlineObject63PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject63PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject63PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject63PullRequestHeadRepoVisibility visibility;
...
InlineObject63PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject63PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject63PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject63PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, InlineObject63PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject63PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject63PullRequestHeadRepoOwner? Function()? owner, InlineObject63PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject63PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject63PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject63PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject63PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject63PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestHeadRepo &&
