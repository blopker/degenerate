...
factory WebhookDeploymentStatusCreatedDeployment.fromJson(Map<String, dynamic> json) { return WebhookDeploymentStatusCreatedDeployment(
  ...
  payload: OneOf2.parse(json['payload'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v)), canParseB: (v) => v is Map,),
