...
import 'package:collection/collection.dart';import 'app_permissions.dart';final class AppsScopeTokenRequest {const AppsScopeTokenRequest({required this.accessToken, this.target, this.targetId, this.repositories, this.repositoryIds, this.permissions, });
