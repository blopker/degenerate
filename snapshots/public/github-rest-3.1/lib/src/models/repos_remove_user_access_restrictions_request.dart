...
import 'package:collection/collection.dart';final class ReposRemoveUserAccessRestrictionsRequest {const ReposRemoveUserAccessRestrictionsRequest({required this.users});
