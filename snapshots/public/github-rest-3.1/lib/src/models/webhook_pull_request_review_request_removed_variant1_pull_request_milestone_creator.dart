...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType bot = WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType user = WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType organization = WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType? type;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreatorType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestMilestoneCreator &&
