...
import 'merge_group.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_merge_group_checks_requested_action.dart';final class WebhookMergeGroupChecksRequested {const WebhookMergeGroupChecksRequested({required this.action, this.installation, required this.mergeGroup, this.organization, this.repository, this.sender, });
