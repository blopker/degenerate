...
import 'package:collection/collection.dart';import 'code_scanning_sarifs_status_processing_status.dart';final class CodeScanningSarifsStatus {const CodeScanningSarifsStatus({this.processingStatus, this.analysesUrl, this.errors, });
