...
import 'package:collection/collection.dart';import 'projects_create_view_for_org_request_layout.dart';final class ProjectsCreateViewForOrgRequest {const ProjectsCreateViewForOrgRequest({required this.name, required this.layout, this.filter, this.visibleFields, });
