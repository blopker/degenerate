...
import 'package:collection/collection.dart';final class ReposSetUserAccessRestrictionsRequest {const ReposSetUserAccessRestrictionsRequest({required this.users});
