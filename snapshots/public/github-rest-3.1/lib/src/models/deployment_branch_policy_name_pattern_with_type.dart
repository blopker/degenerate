...
import 'deployment_branch_policy_name_pattern_with_type_type.dart';final class DeploymentBranchPolicyNamePatternWithType {const DeploymentBranchPolicyNamePatternWithType({required this.name, this.type, });
