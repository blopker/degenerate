...
import 'integration_installation_request_account.dart';import 'simple_user.dart';/// Request to install an integration on a target
...
factory IntegrationInstallationRequest.fromJson(Map<String, dynamic> json) { return IntegrationInstallationRequest(
  ...
  account: IntegrationInstallationRequestAccount.fromJson(json['account'] as Map<String, dynamic>),
