...
final class WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType {const WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType bot = WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._('Bot');

static const WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType user = WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._('User');

static const WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType organization = WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._('Organization');

static const WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType mannequin = WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestAssignees {const WebhookPullRequestReviewRequestedVariant2PullRequestAssignees({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant2PullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType? type;
...
WebhookPullRequestReviewRequestedVariant2PullRequestAssignees copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestAssigneesType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestAssignees &&
