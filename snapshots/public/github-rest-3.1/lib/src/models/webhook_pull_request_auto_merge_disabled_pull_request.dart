...
factory WebhookPullRequestAutoMergeDisabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequest(
  ...
  activeLockReason: WebhookPullRequestAutoMergeDisabledPullRequestActiveLockReason.fromJson(json['active_lock_reason'] as String),
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: WebhookPullRequestAutoMergeDisabledPullRequestAssignee.fromJson(json['assignee'] as Map<String, dynamic>),
  ...
  autoMerge: WebhookPullRequestAutoMergeDisabledPullRequestAutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>),
  ...
  milestone: WebhookPullRequestAutoMergeDisabledPullRequestMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  patchUrl: Uri.parse(json['patch_url'] as String),
  rebaseable: json['rebaseable'] as bool?,
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User3.canParse(v), fromB: (v) => Team4.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team4.canParse(v),)).toList(),
  ...
  user: WebhookPullRequestAutoMergeDisabledPullRequestUser.fromJson(json['user'] as Map<String, dynamic>),
); }
