...
factory WebhookPullRequestAutoMergeDisabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeDisabledPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => WebhookPullRequestAutoMergeDisabledPullRequestRequestedReviewers.fromJson(e)).toList(),
