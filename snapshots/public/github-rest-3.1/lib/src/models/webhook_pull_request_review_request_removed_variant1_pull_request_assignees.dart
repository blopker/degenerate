...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType bot = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType user = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType organization = WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType? type;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssigneesType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestAssignees &&
