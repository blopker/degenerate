...
import 'package:collection/collection.dart';import 'webhook_team_edited_repository_created_at.dart';import 'webhook_team_edited_repository_license.dart';import 'webhook_team_edited_repository_owner.dart';import 'webhook_team_edited_repository_permissions.dart';import 'webhook_team_edited_repository_pushed_at.dart';final class WebhookTeamEditedRepositoryVisibility {const WebhookTeamEditedRepositoryVisibility._(this.value);
...
factory WebhookTeamEditedRepository.fromJson(Map<String, dynamic> json) { return WebhookTeamEditedRepository(
  ...
  createdAt: WebhookTeamEditedRepositoryCreatedAt.fromJson(json['created_at']),
  ...
  license: WebhookTeamEditedRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  owner: WebhookTeamEditedRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>),
