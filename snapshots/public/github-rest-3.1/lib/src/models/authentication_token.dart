...
import 'package:collection/collection.dart';import 'repository.dart';/// Describe whether all repositories have been selected or there's a selection involved
...
AuthenticationToken copyWith({String? token, DateTime? expiresAt, Map<String, String> Function()? permissions, List<Repository> Function()? repositories, String? Function()? singleFile, AuthenticationTokenRepositorySelection Function()? repositorySelection, }) { return AuthenticationToken(
