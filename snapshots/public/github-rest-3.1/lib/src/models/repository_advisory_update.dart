...
import 'package:collection/collection.dart';import 'repository_advisory_update_credits.dart';import 'repository_advisory_update_severity.dart';import 'repository_advisory_update_state.dart';import 'repository_advisory_update_vulnerabilities.dart';final class RepositoryAdvisoryUpdate {const RepositoryAdvisoryUpdate({this.summary, this.description, this.cveId, this.vulnerabilities, this.cweIds, this.credits, this.severity, this.cvssVectorString, this.state, this.collaboratingUsers, this.collaboratingTeams, });
