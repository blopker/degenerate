...
import 'package:collection/collection.dart';import 'inline_object72_pull_request_head_repo_created_at.dart';import 'inline_object72_pull_request_head_repo_license.dart';import 'inline_object72_pull_request_head_repo_owner.dart';import 'inline_object72_pull_request_head_repo_permissions.dart';import 'inline_object72_pull_request_head_repo_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
/// - `BLANK` - default to a blank commit message.
final class InlineObject72PullRequestHeadRepoSquashMergeCommitMessage {const InlineObject72PullRequestHeadRepoSquashMergeCommitMessage._(this.value);

factory InlineObject72PullRequestHeadRepoSquashMergeCommitMessage.fromJson(String json) { return switch (json) {
  'PR_BODY' => prBody,
...
static const InlineObject72PullRequestHeadRepoSquashMergeCommitMessage prBody = InlineObject72PullRequestHeadRepoSquashMergeCommitMessage._('PR_BODY');

static const InlineObject72PullRequestHeadRepoSquashMergeCommitMessage commitMessages = InlineObject72PullRequestHeadRepoSquashMergeCommitMessage._('COMMIT_MESSAGES');

static const InlineObject72PullRequestHeadRepoSquashMergeCommitMessage blank = InlineObject72PullRequestHeadRepoSquashMergeCommitMessage._('BLANK');

static const List<InlineObject72PullRequestHeadRepoSquashMergeCommitMessage> values = [prBody, commitMessages, blank];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestHeadRepoSquashMergeCommitMessage && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestHeadRepoSquashMergeCommitMessage($value)'; } 
 }
/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final class InlineObject72PullRequestHeadRepoSquashMergeCommitTitle {const InlineObject72PullRequestHeadRepoSquashMergeCommitTitle._(this.value);

factory InlineObject72PullRequestHeadRepoSquashMergeCommitTitle.fromJson(String json) { return switch (json) {
  'PR_TITLE' => prTitle,
  'COMMIT_OR_PR_TITLE' => commitOrPrTitle,
  _ => InlineObject72PullRequestHeadRepoSquashMergeCommitTitle._(json),
}; }

static const InlineObject72PullRequestHeadRepoSquashMergeCommitTitle prTitle = InlineObject72PullRequestHeadRepoSquashMergeCommitTitle._('PR_TITLE');

static const InlineObject72PullRequestHeadRepoSquashMergeCommitTitle commitOrPrTitle = InlineObject72PullRequestHeadRepoSquashMergeCommitTitle._('COMMIT_OR_PR_TITLE');

static const List<InlineObject72PullRequestHeadRepoSquashMergeCommitTitle> values = [prTitle, commitOrPrTitle];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject72PullRequestHeadRepoSquashMergeCommitTitle && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject72PullRequestHeadRepoSquashMergeCommitTitle($value)'; } 
 }
final class InlineObject72PullRequestHeadRepoVisibility {const InlineObject72PullRequestHeadRepoVisibility._(this.value);

factory InlineObject72PullRequestHeadRepoVisibility.fromJson(String json) { return switch (json) {
  'public' => public,
  'private' => private,
  'internal' => internal,
  _ => InlineObject72PullRequestHeadRepoVisibility._(json),
}; }

static const InlineObject72PullRequestHeadRepoVisibility public = InlineObject72PullRequestHeadRepoVisibility._('public');

static const InlineObject72PullRequestHeadRepoVisibility private = InlineObject72PullRequestHeadRepoVisibility._('private');

static const InlineObject72PullRequestHeadRepoVisibility internal = InlineObject72PullRequestHeadRepoVisibility._('internal');

static const List<InlineObject72PullRequestHeadRepoVisibility> values = [public, private, internal];
...
factory InlineObject72PullRequestHeadRepo.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestHeadRepo(
  ...
  createdAt: InlineObject72PullRequestHeadRepoCreatedAt.fromJson(json['created_at']),
  ...
  pullRequestCreationPolicy: json['pull_request_creation_policy'] != null ? InlineObject72PullRequestHeadRepoPullRequestCreationPolicy.fromJson(json['pull_request_creation_policy'] as String) : null,
  ...
  license: InlineObject72PullRequestHeadRepoLicense.fromJson(json['license'] as Map<String, dynamic>),
  masterBranch: json['master_branch'] as String?,
  mergeCommitMessage: json['merge_commit_message'] != null ? InlineObject72PullRequestHeadRepoMergeCommitMessage.fromJson(json['merge_commit_message'] as String) : null,
  mergeCommitTitle: json['merge_commit_title'] != null ? InlineObject72PullRequestHeadRepoMergeCommitTitle.fromJson(json['merge_commit_title'] as String) : null,
  ...
  owner: InlineObject72PullRequestHeadRepoOwner.fromJson(json['owner'] as Map<String, dynamic>),
  permissions: json['permissions'] != null ? InlineObject72PullRequestHeadRepoPermissions.fromJson(json['permissions'] as Map<String, dynamic>) : null,
  private: json['private'] as bool,
  public: json['public'] as bool?,
  pullsUrl: json['pulls_url'] as String,
  pushedAt: InlineObject72PullRequestHeadRepoPushedAt.fromJson(json['pushed_at']),
  releasesUrl: json['releases_url'] as String,
  roleName: json['role_name'] as String?,
  size: (json['size'] as num).toInt(),
  squashMergeCommitMessage: json['squash_merge_commit_message'] != null ? InlineObject72PullRequestHeadRepoSquashMergeCommitMessage.fromJson(json['squash_merge_commit_message'] as String) : null,
  squashMergeCommitTitle: json['squash_merge_commit_title'] != null ? InlineObject72PullRequestHeadRepoSquashMergeCommitTitle.fromJson(json['squash_merge_commit_title'] as String) : null,
  ...
  visibility: InlineObject72PullRequestHeadRepoVisibility.fromJson(json['visibility'] as String),
...
final InlineObject72PullRequestHeadRepoCreatedAt createdAt;
...
final InlineObject72PullRequestHeadRepoPullRequestCreationPolicy? pullRequestCreationPolicy;
...
final InlineObject72PullRequestHeadRepoLicense? license;
...
/// - `PR_BODY` - default to the pull request's body.
/// - `BLANK` - default to a blank commit message.
final InlineObject72PullRequestHeadRepoMergeCommitMessage? mergeCommitMessage;

/// The default value for a merge commit title.
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `MERGE_MESSAGE` - default to the classic title for a merge message (e.g., Merge pull request #123 from branch-name).
final InlineObject72PullRequestHeadRepoMergeCommitTitle? mergeCommitTitle;
...
final InlineObject72PullRequestHeadRepoOwner? owner;

final InlineObject72PullRequestHeadRepoPermissions? permissions;
...
final InlineObject72PullRequestHeadRepoPushedAt? pushedAt;
...
/// - `COMMIT_MESSAGES` - default to the branch's commit messages.
/// - `BLANK` - default to a blank commit message.
final InlineObject72PullRequestHeadRepoSquashMergeCommitMessage? squashMergeCommitMessage;

/// The default value for a squash merge commit title:
/// 
/// - `PR_TITLE` - default to the pull request's title.
/// - `COMMIT_OR_PR_TITLE` - default to the commit's title (if only one commit) or the pull request's title (when more than one commit).
final InlineObject72PullRequestHeadRepoSquashMergeCommitTitle? squashMergeCommitTitle;
...
final InlineObject72PullRequestHeadRepoVisibility visibility;
...
InlineObject72PullRequestHeadRepo copyWith({bool Function()? allowAutoMerge, bool Function()? allowForking, bool Function()? allowMergeCommit, bool Function()? allowRebaseMerge, bool Function()? allowSquashMerge, bool Function()? allowUpdateBranch, String? archiveUrl, bool? archived, String? assigneesUrl, String? blobsUrl, String? branchesUrl, Uri? cloneUrl, String? collaboratorsUrl, String? commentsUrl, String? commitsUrl, String? compareUrl, String? contentsUrl, Uri? contributorsUrl, InlineObject72PullRequestHeadRepoCreatedAt? createdAt, String? defaultBranch, bool Function()? deleteBranchOnMerge, Uri? deploymentsUrl, String? Function()? description, bool Function()? disabled, Uri? downloadsUrl, Uri? eventsUrl, bool? fork, int? forks, int? forksCount, Uri? forksUrl, String? fullName, String? gitCommitsUrl, String? gitRefsUrl, String? gitTagsUrl, Uri? gitUrl, bool? hasDownloads, bool? hasIssues, bool? hasPages, bool? hasProjects, bool? hasWiki, bool? hasDiscussions, bool Function()? hasPullRequests, InlineObject72PullRequestHeadRepoPullRequestCreationPolicy Function()? pullRequestCreationPolicy, String? Function()? homepage, Uri? hooksUrl, Uri? htmlUrl, int? id, bool Function()? isTemplate, String? issueCommentUrl, String? issueEventsUrl, String? issuesUrl, String? keysUrl, String? labelsUrl, String? Function()? language, Uri? languagesUrl, InlineObject72PullRequestHeadRepoLicense? Function()? license, String Function()? masterBranch, InlineObject72PullRequestHeadRepoMergeCommitMessage Function()? mergeCommitMessage, InlineObject72PullRequestHeadRepoMergeCommitTitle Function()? mergeCommitTitle, Uri? mergesUrl, String? milestonesUrl, Uri? Function()? mirrorUrl, String? name, String? nodeId, String? notificationsUrl, int? openIssues, int? openIssuesCount, String Function()? organization, InlineObject72PullRequestHeadRepoOwner? Function()? owner, InlineObject72PullRequestHeadRepoPermissions Function()? permissions, bool? private, bool Function()? public, String? pullsUrl, InlineObject72PullRequestHeadRepoPushedAt? Function()? pushedAt, String? releasesUrl, String? Function()? roleName, int? size, InlineObject72PullRequestHeadRepoSquashMergeCommitMessage Function()? squashMergeCommitMessage, InlineObject72PullRequestHeadRepoSquashMergeCommitTitle Function()? squashMergeCommitTitle, String? sshUrl, int Function()? stargazers, int? stargazersCount, Uri? stargazersUrl, String? statusesUrl, Uri? subscribersUrl, Uri? subscriptionUrl, Uri? svnUrl, Uri? tagsUrl, Uri? teamsUrl, List<String>? topics, String? treesUrl, DateTime? updatedAt, Uri? url, bool Function()? useSquashPrTitleAsDefault, InlineObject72PullRequestHeadRepoVisibility? visibility, int? watchers, int? watchersCount, bool Function()? webCommitSignoffRequired, }) { return InlineObject72PullRequestHeadRepo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestHeadRepo &&
