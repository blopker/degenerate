...
import 'package:collection/collection.dart';import 'webhook_code_scanning_alert_closed_by_user_alert_most_recent_instance_location.dart';import 'webhook_code_scanning_alert_closed_by_user_alert_most_recent_instance_message.dart';import 'webhook_code_scanning_alert_closed_by_user_alert_most_recent_instance_state.dart';final class WebhookCodeScanningAlertClosedByUserAlertMostRecentInstance {const WebhookCodeScanningAlertClosedByUserAlertMostRecentInstance({required this.analysisKey, this.category, this.classifications, this.commitSha, required this.environment, this.location, this.message, required this.ref, required this.state, });
