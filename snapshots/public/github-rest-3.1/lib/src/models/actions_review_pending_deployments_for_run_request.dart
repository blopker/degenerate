...
import 'package:collection/collection.dart';import 'actions_review_pending_deployments_for_run_request_state.dart';final class ActionsReviewPendingDeploymentsForRunRequest {const ActionsReviewPendingDeploymentsForRunRequest({required this.environmentIds, required this.state, required this.comment, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ActionsReviewPendingDeploymentsForRunRequest &&
          const ListEquality<dynamic>().equals(environmentIds, other.environmentIds) &&
          state == other.state &&
