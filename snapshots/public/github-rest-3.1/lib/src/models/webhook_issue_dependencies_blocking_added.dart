...
import 'issue.dart';import 'organization_simple_webhooks.dart';import 'repository.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_issue_dependencies_blocking_added_action.dart';final class WebhookIssueDependenciesBlockingAdded {const WebhookIssueDependenciesBlockingAdded({required this.action, this.blockedIssueId, this.blockedIssue, this.blockedIssueRepo, this.blockingIssueId, this.blockingIssue, this.installation, required this.organization, required this.repository, required this.sender, });
...
factory WebhookIssueDependenciesBlockingAdded.fromJson(Map<String, dynamic> json) { return WebhookIssueDependenciesBlockingAdded(
  ...
  blockedIssueRepo: json['blocked_issue_repo'] != null
        ? Repository.fromJson(json['blocked_issue_repo'] as Map<String, dynamic>)
        : null,
