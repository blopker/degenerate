...
factory WebhookPullRequestReviewDismissedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewDismissedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User12.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User12.canParse(v), fromB: (v) => Team13.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team13.canParse(v),)).toList(),
