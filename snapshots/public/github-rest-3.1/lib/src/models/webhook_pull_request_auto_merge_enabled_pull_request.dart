...
factory WebhookPullRequestAutoMergeEnabledPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestAutoMergeEnabledPullRequest(
  ...
  activeLockReason: WebhookPullRequestAutoMergeEnabledPullRequestActiveLockReason.fromJson(json['active_lock_reason'] as String),
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: WebhookPullRequestAutoMergeEnabledPullRequestAssignee.fromJson(json['assignee'] as Map<String, dynamic>),
  ...
  autoMerge: WebhookPullRequestAutoMergeEnabledPullRequestAutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>),
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User4.canParse(v), fromB: (v) => Team5.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team5.canParse(v),)).toList(),
  ...
  user: WebhookPullRequestAutoMergeEnabledPullRequestUser.fromJson(json['user'] as Map<String, dynamic>),
); }
