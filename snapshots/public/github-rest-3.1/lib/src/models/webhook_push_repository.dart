...
import 'package:collection/collection.dart';import 'webhook_push_repository_created_at.dart';import 'webhook_push_repository_license.dart';import 'webhook_push_repository_owner.dart';import 'webhook_push_repository_permissions.dart';import 'webhook_push_repository_pushed_at.dart';/// The policy controlling who can create pull requests: all or collaborators_only.
...
factory WebhookPushRepository.fromJson(Map<String, dynamic> json) { return WebhookPushRepository(
  ...
  createdAt: WebhookPushRepositoryCreatedAt.fromJson(json['created_at']),
  ...
  license: WebhookPushRepositoryLicense.fromJson(json['license'] as Map<String, dynamic>),
  ...
  owner: WebhookPushRepositoryOwner.fromJson(json['owner'] as Map<String, dynamic>),
  ...
  pushedAt: WebhookPushRepositoryPushedAt.fromJson(json['pushed_at']),
...
final WebhookPushRepositoryCreatedAt createdAt;
...
final WebhookPushRepositoryPushedAt? pushedAt;
