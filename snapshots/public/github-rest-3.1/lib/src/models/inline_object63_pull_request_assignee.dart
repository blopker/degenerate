...
final class InlineObject63PullRequestAssigneeType {const InlineObject63PullRequestAssigneeType._(this.value);

factory InlineObject63PullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestAssigneeType._(json),
}; }

static const InlineObject63PullRequestAssigneeType bot = InlineObject63PullRequestAssigneeType._('Bot');

static const InlineObject63PullRequestAssigneeType user = InlineObject63PullRequestAssigneeType._('User');

static const InlineObject63PullRequestAssigneeType organization = InlineObject63PullRequestAssigneeType._('Organization');

static const List<InlineObject63PullRequestAssigneeType> values = [bot, user, organization];
...
factory InlineObject63PullRequestAssignee.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestAssignee(
  ...
  type: json['type'] != null ? InlineObject63PullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestAssigneeType? type;
...
InlineObject63PullRequestAssignee copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestAssigneeType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestAssignee &&
...
@override String toString() { return 'InlineObject63PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
