...
final class EventPayloadMapStringObject extends EventPayload {const EventPayloadMapStringObject(this._value);

final Map<String,Object?> _value;

@override Map<String,Object?> get value { return _value; } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is EventPayloadMapStringObject && _value == other._value; } 
@override int get hashCode { return _value.hashCode; } 
@override String toString() { return 'EventPayload.map<String,Object>($_value)'; } 
 }
