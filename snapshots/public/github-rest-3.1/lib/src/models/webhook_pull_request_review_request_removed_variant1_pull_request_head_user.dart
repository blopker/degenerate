...
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType bot = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType user = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType organization = WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser {const WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType? type;
...
WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant1PullRequestHeadUser &&
