...
factory WebhookPullRequestReviewCommentEditedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentEditedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User11.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User11.canParse(v), fromB: (v) => Team12.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team12.canParse(v),)).toList(),
