...
import 'package:collection/collection.dart';import 'orgs_update_pat_accesses_request_action.dart';final class OrgsUpdatePatAccessesRequest {const OrgsUpdatePatAccessesRequest({required this.action, required this.patIds, });
