...
import 'package:collection/collection.dart';import 'simple_user.dart';import 'webhook_code_scanning_alert_reopened_alert_most_recent_instance.dart';import 'webhook_code_scanning_alert_reopened_alert_rule.dart';import 'webhook_code_scanning_alert_reopened_alert_state.dart';import 'webhook_code_scanning_alert_reopened_alert_tool.dart';/// The code scanning alert involved in the event.
...
factory WebhookCodeScanningAlertReopenedAlert.fromJson(Map<String, dynamic> json) { return WebhookCodeScanningAlertReopenedAlert(
  ...
  mostRecentInstance: json['most_recent_instance'] != null
        ? WebhookCodeScanningAlertReopenedAlertMostRecentInstance.fromJson(json['most_recent_instance'] as Map<String, dynamic>)
        : null,
  number: (json['number'] as num).toInt(),
  rule: WebhookCodeScanningAlertReopenedAlertRule.fromJson(json['rule'] as Map<String, dynamic>),
  state: WebhookCodeScanningAlertReopenedAlertState.fromJson(json['state'] as String),
