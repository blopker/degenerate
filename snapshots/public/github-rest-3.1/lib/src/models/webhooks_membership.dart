...
import 'package:collection/collection.dart';import 'webhooks_membership_user.dart';/// The membership between the user and the organization. Not present when the action is `member_invited`.
