...
factory ItemReorderedChanges.fromJson(Map<String, dynamic> json) { return ItemReorderedChanges(
  previousProjectsV2ItemNodeId: json['previous_projects_v2_item_node_id'] != null
        ? ItemReorderedChangesItemNodeId.fromJson(json['previous_projects_v2_item_node_id'] as Map<String, dynamic>)
        : null,
); }
