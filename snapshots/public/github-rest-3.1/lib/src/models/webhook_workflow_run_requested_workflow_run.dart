...
factory WebhookWorkflowRunRequestedWorkflowRun.fromJson(Map<String, dynamic> json) { return WebhookWorkflowRunRequestedWorkflowRun(
  actor: WebhookWorkflowRunRequestedWorkflowRunActor.fromJson(json['actor'] as Map<String, dynamic>),
  ...
  conclusion: WebhookWorkflowRunRequestedWorkflowRunConclusion.fromJson(json['conclusion'] as String),
  ...
  previousAttemptUrl: Uri.parse(json['previous_attempt_url'] as String),
  ...
  triggeringActor: WebhookWorkflowRunRequestedWorkflowRunTriggeringActor.fromJson(json['triggering_actor'] as Map<String, dynamic>),
