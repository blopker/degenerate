...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'integration_owner.dart';import 'integration_permissions.dart';/// GitHub apps are a new way to extend GitHub. They can be installed directly on organizations and user accounts and granted access to specific repositories. They come with granular permissions and built-in webhooks. GitHub apps are first class actors within GitHub.
...
factory Integration.fromJson(Map<String, dynamic> json) { return Integration(
  ...
  owner: OneOf2.parse(json['owner'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SimpleUser.canParse(v), fromB: (v) => Enterprise.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Enterprise.canParse(v),),
