...
import 'package:collection/collection.dart';final class WebhooksMarketplacePurchasePlanPriceModel {const WebhooksMarketplacePurchasePlanPriceModel._(this.value);
