...
import 'webhook_deployment_created_deployment_creator.dart';import 'webhook_deployment_created_deployment_payload.dart';import 'webhook_deployment_created_deployment_performed_via_github_app.dart';/// The [deployment](https://docs.github.com/rest/deployments/deployments#list-deployments).
...
factory WebhookDeploymentCreatedDeployment.fromJson(Map<String, dynamic> json) { return WebhookDeploymentCreatedDeployment(
  ...
  payload: WebhookDeploymentCreatedDeploymentPayload.fromJson(json['payload']),
  performedViaGithubApp: json['performed_via_github_app'] != null
        ? WebhookDeploymentCreatedDeploymentPerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>)
        : null,
