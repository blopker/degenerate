...
final class WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType {const WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType bot = WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType._('Bot');

static const WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType user = WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType._('User');

static const WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType organization = WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy {const WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType? type;
...
WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestAutoMergeEnabledBy &&
