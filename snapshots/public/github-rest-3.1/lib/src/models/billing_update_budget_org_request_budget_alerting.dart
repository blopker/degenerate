...
import 'package:collection/collection.dart';final class BillingUpdateBudgetOrgRequestBudgetAlerting {const BillingUpdateBudgetOrgRequestBudgetAlerting({this.willAlert, this.alertRecipients, });
