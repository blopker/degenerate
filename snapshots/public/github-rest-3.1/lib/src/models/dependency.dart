...
import 'package:collection/collection.dart';import 'metadata_value.dart';/// A notation of whether a dependency is requested directly by this manifest or is a dependency of another dependency.
...
factory Dependency.fromJson(Map<String, dynamic> json) { return Dependency(
  ...
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, MetadataValue.fromJson(v as Map<String, dynamic>))),
...
Dependency copyWith({String Function()? packageUrl, Map<String, MetadataValue> Function()? metadata, DependencyRelationship Function()? relationship, DependencyScope Function()? scope, List<String> Function()? dependencies, }) { return Dependency(
