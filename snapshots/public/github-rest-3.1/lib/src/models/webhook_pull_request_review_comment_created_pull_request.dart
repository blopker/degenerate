...
factory WebhookPullRequestReviewCommentCreatedPullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewCommentCreatedPullRequest(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User9.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User9.canParse(v), fromB: (v) => Team10.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team10.canParse(v),)).toList(),
