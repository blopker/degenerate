...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'deployment_branch_policy_settings.dart';import 'environment_protection_rules.dart';/// Details of a deployment environment
...
factory Environment.fromJson(Map<String, dynamic> json) { return Environment(
  ...
  protectionRules: (json['protection_rules'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => EnvironmentProtectionRulesVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EnvironmentProtectionRulesVariant1.canParse(v), fromB: (v) => EnvironmentProtectionRulesVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EnvironmentProtectionRulesVariant2.canParse(v), fromC: (v) => EnvironmentProtectionRulesVariant3.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && EnvironmentProtectionRulesVariant3.canParse(v),)).toList(),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Environment &&
          ...
          const ListEquality<dynamic>().equals(protectionRules, other.protectionRules) &&
