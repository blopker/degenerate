...
import 'package:collection/collection.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_type.dart';import 'sub_issues_summary.dart';import 'webhook_issues_reopened_issue_assignee.dart';import 'webhook_issues_reopened_issue_assignees.dart';import 'webhook_issues_reopened_issue_labels.dart';import 'webhook_issues_reopened_issue_milestone.dart';import 'webhook_issues_reopened_issue_performed_via_github_app.dart';import 'webhook_issues_reopened_issue_pull_request.dart';import 'webhook_issues_reopened_issue_reactions.dart';import 'webhook_issues_reopened_issue_user.dart';final class WebhookIssuesReopenedIssueActiveLockReason {const WebhookIssuesReopenedIssueActiveLockReason._(this.value);
...
factory WebhookIssuesReopenedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesReopenedIssue(
  activeLockReason: WebhookIssuesReopenedIssueActiveLockReason.fromJson(json['active_lock_reason'] as String),
  assignee: json['assignee'] != null
        ? WebhookIssuesReopenedIssueAssignee.fromJson(json['assignee'] as Map<String, dynamic>)
        : null,
  ...
  milestone: WebhookIssuesReopenedIssueMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  performedViaGithubApp: json['performed_via_github_app'] != null
        ? WebhookIssuesReopenedIssuePerformedViaGithubApp.fromJson(json['performed_via_github_app'] as Map<String, dynamic>)
        : null,
  pullRequest: json['pull_request'] != null
        ? WebhookIssuesReopenedIssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>)
        : null,
  ...
  user: WebhookIssuesReopenedIssueUser.fromJson(json['user'] as Map<String, dynamic>),
  type: json['type'] != null
