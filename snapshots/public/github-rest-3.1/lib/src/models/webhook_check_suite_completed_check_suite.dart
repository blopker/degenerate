...
import 'package:collection/collection.dart';import 'webhook_check_suite_completed_check_suite_app.dart';import 'webhook_check_suite_completed_check_suite_head_commit.dart';import 'webhook_check_suite_completed_check_suite_pull_requests.dart';/// The summary conclusion for all check runs that are part of the check suite. This value will be `null` until the check run has `completed`.
...
factory WebhookCheckSuiteCompletedCheckSuite.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteCompletedCheckSuite(
  ...
  conclusion: WebhookCheckSuiteCompletedCheckSuiteConclusion.fromJson(json['conclusion'] as String),
  ...
  status: WebhookCheckSuiteCompletedCheckSuiteStatus.fromJson(json['status'] as String),
