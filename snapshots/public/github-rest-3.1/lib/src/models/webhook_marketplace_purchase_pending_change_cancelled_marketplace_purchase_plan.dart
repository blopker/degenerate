...
import 'package:collection/collection.dart';import 'webhook_marketplace_purchase_pending_change_cancelled_marketplace_purchase_plan_price_model.dart';final class WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlan {const WebhookMarketplacePurchasePendingChangeCancelledMarketplacePurchasePlan({required this.bullets, required this.description, required this.hasFreeTrial, required this.id, required this.monthlyPriceInCents, required this.name, required this.priceModel, required this.unitName, required this.yearlyPriceInCents, });
