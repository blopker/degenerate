...
factory WebhookIssuesClosedIssue.fromJson(Map<String, dynamic> json) { return WebhookIssuesClosedIssue(
  ...
  assignee: (json['assignee'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as Object)),
  ...
  labels: (json['labels'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v as Object))).toList(),
