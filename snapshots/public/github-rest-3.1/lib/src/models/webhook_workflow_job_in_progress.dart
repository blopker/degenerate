...
import 'deployment.dart';import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_workflow_job_in_progress_action.dart';import 'webhook_workflow_job_in_progress_workflow_job.dart';final class WebhookWorkflowJobInProgress {const WebhookWorkflowJobInProgress({required this.action, this.enterprise, this.installation, this.organization, required this.repository, required this.sender, required this.workflowJob, this.deployment, });
