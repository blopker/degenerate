...
final class InlineObject63PullRequestHeadUserType {const InlineObject63PullRequestHeadUserType._(this.value);

factory InlineObject63PullRequestHeadUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestHeadUserType._(json),
}; }

static const InlineObject63PullRequestHeadUserType bot = InlineObject63PullRequestHeadUserType._('Bot');

static const InlineObject63PullRequestHeadUserType user = InlineObject63PullRequestHeadUserType._('User');

static const InlineObject63PullRequestHeadUserType organization = InlineObject63PullRequestHeadUserType._('Organization');

static const List<InlineObject63PullRequestHeadUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestHeadUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestHeadUserType($value)'; } 
 }
final class InlineObject63PullRequestHeadUser {const InlineObject63PullRequestHeadUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestHeadUser.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestHeadUser(
  ...
  type: json['type'] != null ? InlineObject63PullRequestHeadUserType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestHeadUserType? type;
...
InlineObject63PullRequestHeadUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestHeadUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestHeadUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestHeadUser &&
