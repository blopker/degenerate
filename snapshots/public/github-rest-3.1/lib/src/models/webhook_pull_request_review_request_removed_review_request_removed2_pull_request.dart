...
factory WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequest.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequest(
  ...
  activeLockReason: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestActiveLockReason.fromJson(json['active_lock_reason'] as String),
  additions: json['additions'] != null ? (json['additions'] as num).toInt() : null,
  assignee: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAssignee.fromJson(json['assignee'] as Map<String, dynamic>),
  ...
  autoMerge: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestAutoMerge.fromJson(json['auto_merge'] as Map<String, dynamic>),
  ...
  milestone: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestMilestone.fromJson(json['milestone'] as Map<String, dynamic>),
  nodeId: json['node_id'] as String,
  number: (json['number'] as num).toInt(),
  patchUrl: Uri.parse(json['patch_url'] as String),
  rebaseable: json['rebaseable'] as bool?,
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User15.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User15.canParse(v), fromB: (v) => Team16.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team16.canParse(v),)).toList(),
  ...
  user: WebhookPullRequestReviewRequestRemovedReviewRequestRemoved2PullRequestUser.fromJson(json['user'] as Map<String, dynamic>),
); }
