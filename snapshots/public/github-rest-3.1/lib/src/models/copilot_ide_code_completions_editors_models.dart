...
import 'package:collection/collection.dart';import 'copilot_ide_code_completions_editors_models_languages.dart';final class CopilotIdeCodeCompletionsEditorsModels {const CopilotIdeCodeCompletionsEditorsModels({this.name, this.isCustomModel, this.customModelTrainingDate, this.totalEngagedUsers, this.languages, });
