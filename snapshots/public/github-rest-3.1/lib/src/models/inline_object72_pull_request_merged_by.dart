...
final class InlineObject72PullRequestMergedByType {const InlineObject72PullRequestMergedByType._(this.value);

factory InlineObject72PullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject72PullRequestMergedByType bot = InlineObject72PullRequestMergedByType._('Bot');

static const InlineObject72PullRequestMergedByType user = InlineObject72PullRequestMergedByType._('User');

static const InlineObject72PullRequestMergedByType organization = InlineObject72PullRequestMergedByType._('Organization');

static const List<InlineObject72PullRequestMergedByType> values = [bot, user, organization];
...
@override String toString() { return 'InlineObject72PullRequestMergedByType($value)'; } 
 }
final class InlineObject72PullRequestMergedBy {const InlineObject72PullRequestMergedBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject72PullRequestMergedBy.fromJson(Map<String, dynamic> json) { return InlineObject72PullRequestMergedBy(
  ...
  type: json['type'] != null ? InlineObject72PullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final InlineObject72PullRequestMergedByType? type;
...
InlineObject72PullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject72PullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject72PullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject72PullRequestMergedBy &&
