...
final class InlineObject63PullRequestMilestoneCreatorType {const InlineObject63PullRequestMilestoneCreatorType._(this.value);

factory InlineObject63PullRequestMilestoneCreatorType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestMilestoneCreatorType._(json),
}; }

static const InlineObject63PullRequestMilestoneCreatorType bot = InlineObject63PullRequestMilestoneCreatorType._('Bot');

static const InlineObject63PullRequestMilestoneCreatorType user = InlineObject63PullRequestMilestoneCreatorType._('User');

static const InlineObject63PullRequestMilestoneCreatorType organization = InlineObject63PullRequestMilestoneCreatorType._('Organization');

static const List<InlineObject63PullRequestMilestoneCreatorType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestMilestoneCreatorType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestMilestoneCreatorType($value)'; } 
 }
final class InlineObject63PullRequestMilestoneCreator {const InlineObject63PullRequestMilestoneCreator({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestMilestoneCreator.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestMilestoneCreator(
  ...
  type: json['type'] != null ? InlineObject63PullRequestMilestoneCreatorType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestMilestoneCreatorType? type;
...
InlineObject63PullRequestMilestoneCreator copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestMilestoneCreatorType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestMilestoneCreator(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestMilestoneCreator &&
...
@override String toString() { return 'InlineObject63PullRequestMilestoneCreator(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
