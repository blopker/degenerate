...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'deployment_reviewer_type.dart';import 'environment_protection_rules_variant2_reviewers_reviewer.dart';final class EnvironmentProtectionRulesVariant2Reviewers {const EnvironmentProtectionRulesVariant2Reviewers({this.type, this.reviewer, });
...
factory EnvironmentProtectionRulesVariant2Reviewers.fromJson(Map<String, dynamic> json) { return EnvironmentProtectionRulesVariant2Reviewers(
  ...
  reviewer: json['reviewer'] != null ? OneOf2.parse(json['reviewer'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SimpleUser.canParse(v), fromB: (v) => Team.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team.canParse(v),) : null,
); }
