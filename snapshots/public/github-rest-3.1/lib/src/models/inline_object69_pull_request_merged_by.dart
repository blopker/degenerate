...
final class InlineObject69PullRequestMergedByType {const InlineObject69PullRequestMergedByType._(this.value);

factory InlineObject69PullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject69PullRequestMergedByType bot = InlineObject69PullRequestMergedByType._('Bot');

static const InlineObject69PullRequestMergedByType user = InlineObject69PullRequestMergedByType._('User');

static const InlineObject69PullRequestMergedByType organization = InlineObject69PullRequestMergedByType._('Organization');

static const List<InlineObject69PullRequestMergedByType> values = [bot, user, organization];
...
factory InlineObject69PullRequestMergedBy.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestMergedBy(
  ...
  type: json['type'] != null ? InlineObject69PullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestMergedByType? type;
...
InlineObject69PullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestMergedBy &&
