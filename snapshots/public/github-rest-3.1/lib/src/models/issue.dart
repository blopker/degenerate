...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'author_association.dart';import 'integration.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_labels.dart';import 'issue_pull_request.dart';import 'issue_type.dart';import 'milestone.dart';import 'reaction_rollup.dart';import 'repository.dart';import 'simple_user.dart';import 'sub_issues_summary.dart';/// The reason for the current state
...
factory Issue.fromJson(Map<String, dynamic> json) { return Issue(
  ...
  labels: (json['labels'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssueLabelsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssueLabelsVariant2.canParse(v),)).toList(),
