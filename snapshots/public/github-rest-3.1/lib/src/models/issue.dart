...
import 'package:collection/collection.dart';import 'author_association.dart';import 'integration.dart';import 'issue_comment.dart';import 'issue_dependencies_summary.dart';import 'issue_field_value.dart';import 'issue_labels.dart';import 'issue_pull_request.dart';import 'issue_state_reason.dart';import 'issue_type.dart';import 'milestone.dart';import 'reaction_rollup.dart';import 'repository.dart';import 'simple_user.dart';import 'sub_issues_summary.dart';/// Issues are a great way to keep track of tasks, enhancements, and bugs for your projects.
...
factory Issue.fromJson(Map<String, dynamic> json) { return Issue(
  ...
  labels: (json['labels'] as List<dynamic>).map((e) => IssueLabels.fromJson(e)).toList(),
  ...
  pullRequest: json['pull_request'] != null
        ? IssuePullRequest.fromJson(json['pull_request'] as Map<String, dynamic>)
        : null,
