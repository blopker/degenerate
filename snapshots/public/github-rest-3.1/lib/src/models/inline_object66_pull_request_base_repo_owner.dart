...
final class InlineObject66PullRequestBaseRepoOwnerType {const InlineObject66PullRequestBaseRepoOwnerType._(this.value);

factory InlineObject66PullRequestBaseRepoOwnerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject66PullRequestBaseRepoOwnerType._(json),
}; }

static const InlineObject66PullRequestBaseRepoOwnerType bot = InlineObject66PullRequestBaseRepoOwnerType._('Bot');

static const InlineObject66PullRequestBaseRepoOwnerType user = InlineObject66PullRequestBaseRepoOwnerType._('User');

static const InlineObject66PullRequestBaseRepoOwnerType organization = InlineObject66PullRequestBaseRepoOwnerType._('Organization');

static const List<InlineObject66PullRequestBaseRepoOwnerType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestBaseRepoOwnerType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestBaseRepoOwnerType($value)'; } 
 }
final class InlineObject66PullRequestBaseRepoOwner {const InlineObject66PullRequestBaseRepoOwner({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestBaseRepoOwner.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestBaseRepoOwner(
  ...
  type: json['type'] != null ? InlineObject66PullRequestBaseRepoOwnerType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestBaseRepoOwnerType? type;
...
InlineObject66PullRequestBaseRepoOwner copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestBaseRepoOwnerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestBaseRepoOwner(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestBaseRepoOwner &&
...
@override String toString() { return 'InlineObject66PullRequestBaseRepoOwner(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
