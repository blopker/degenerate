...
import 'teams_update_legacy_request_notification_setting.dart';import 'teams_update_legacy_request_permission.dart';import 'teams_update_legacy_request_privacy.dart';final class TeamsUpdateLegacyRequest {const TeamsUpdateLegacyRequest({required this.name, this.description, this.privacy, this.notificationSetting, this.permission = TeamsUpdateLegacyRequestPermission.pull, this.parentTeamId, });
