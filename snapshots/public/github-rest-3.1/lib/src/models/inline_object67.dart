...
final class InlineObject67Type {const InlineObject67Type._(this.value);

factory InlineObject67Type.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject67Type organization = InlineObject67Type._('Organization');
...
@override String toString() { return 'InlineObject67Type($value)'; } 
 }
final class InlineObject67 {const InlineObject67({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory InlineObject67.fromJson(Map<String, dynamic> json) { return InlineObject67(
  ...
  type: json['type'] != null ? InlineObject67Type.fromJson(json['type'] as String) : null,
...
InlineObject67 copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject67Type Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject67(
