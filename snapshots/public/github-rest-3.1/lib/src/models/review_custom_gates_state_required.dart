...
import 'review_custom_gates_state_required_state.dart';final class ReviewCustomGatesStateRequired {const ReviewCustomGatesStateRequired({required this.environmentName, required this.state, this.comment, });
