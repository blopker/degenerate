...
import 'enterprise_webhooks.dart';import 'milestone.dart';import 'organization_simple_webhooks.dart';import 'repository_webhooks.dart';import 'simple_user.dart';import 'webhook_pull_request_demilestoned_action.dart';import 'webhooks_pull_request5.dart';final class WebhookPullRequestDemilestoned {const WebhookPullRequestDemilestoned({required this.action, this.enterprise, this.milestone, required this.number, this.organization, required this.pullRequest, required this.repository, this.sender, });
...
WebhookPullRequestDemilestoned copyWith({WebhookPullRequestDemilestonedAction? action, EnterpriseWebhooks Function()? enterprise, Milestone Function()? milestone, int? number, OrganizationSimpleWebhooks Function()? organization, WebhooksPullRequest5? pullRequest, RepositoryWebhooks? repository, SimpleUser Function()? sender, }) { return WebhookPullRequestDemilestoned(
