...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'commit_author.dart';import 'commit_commit.dart';import 'commit_committer.dart';import 'commit_parents.dart';import 'commit_stats.dart';import 'diff_entry.dart';/// Commit
...
factory Commit.fromJson(Map<String, dynamic> json) { return Commit(
  ...
  author: OneOf2.parse(json['author'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SimpleUser.canParse(v), fromB: (v) => EmptyObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EmptyObject.canParse(v),),
  committer: OneOf2.parse(json['committer'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SimpleUser.canParse(v), fromB: (v) => EmptyObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EmptyObject.canParse(v),),
