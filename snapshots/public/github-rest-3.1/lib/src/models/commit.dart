...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'commit_author.dart';import 'commit_commit.dart';import 'commit_committer.dart';import 'commit_parents.dart';import 'commit_stats.dart';import 'diff_entry.dart';import 'empty_object.dart';import 'simple_user.dart';/// Commit
...
factory Commit.fromJson(Map<String, dynamic> json) { return Commit(
  ...
  author: OneOf2.parse(json['author'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), fromB: (v) => EmptyObject.fromJson(v as Map<String, dynamic>),),
  committer: OneOf2.parse(json['committer'], fromA: (v) => SimpleUser.fromJson(v as Map<String, dynamic>), fromB: (v) => EmptyObject.fromJson(v as Map<String, dynamic>),),
