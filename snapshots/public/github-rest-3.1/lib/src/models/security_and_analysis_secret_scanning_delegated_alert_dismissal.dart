...
import 'security_and_analysis_secret_scanning_delegated_alert_dismissal_status.dart';final class SecurityAndAnalysisSecretScanningDelegatedAlertDismissal {const SecurityAndAnalysisSecretScanningDelegatedAlertDismissal({this.status});
