...
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType._(this.value);

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType._(json),
}; }

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType bot = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType._('Bot');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType user = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType._('User');

static const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType organization = WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType._('Organization');

static const List<WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType($value)'; } 
 }
final class WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser {const WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType? type;
...
WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUserType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestRemovedVariant2PullRequestBaseUser &&
