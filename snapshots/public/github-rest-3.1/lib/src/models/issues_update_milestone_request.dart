...
import 'issues_update_milestone_request_state.dart';final class IssuesUpdateMilestoneRequest {const IssuesUpdateMilestoneRequest({this.title, this.state = IssuesUpdateMilestoneRequestState.open, this.description, this.dueOn, });
