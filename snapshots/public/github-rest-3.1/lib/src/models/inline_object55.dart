...
static const InlineObject55Type bot = InlineObject55Type._('Bot');

static const InlineObject55Type user = InlineObject55Type._('User');

static const InlineObject55Type organization = InlineObject55Type._('Organization');

static const List<InlineObject55Type> values = [bot, user, organization];
...
final class InlineObject55 {const InlineObject55({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });
...
factory InlineObject55.fromJson(Map<String, dynamic> json) { return InlineObject55(
  ...
  type: json['type'] != null ? InlineObject55Type.fromJson(json['type'] as String) : null,
...
InlineObject55 copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject55Type Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject55(
