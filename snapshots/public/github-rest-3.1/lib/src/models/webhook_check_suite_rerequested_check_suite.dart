...
import 'package:collection/collection.dart';import 'webhook_check_suite_rerequested_check_suite_app.dart';import 'webhook_check_suite_rerequested_check_suite_head_commit.dart';import 'webhook_check_suite_rerequested_check_suite_pull_requests.dart';/// The summary conclusion for all check runs that are part of the check suite. This value will be `null` until the check run has completed.
...
factory WebhookCheckSuiteRerequestedCheckSuite.fromJson(Map<String, dynamic> json) { return WebhookCheckSuiteRerequestedCheckSuite(
  ...
  conclusion: WebhookCheckSuiteRerequestedCheckSuiteConclusion.fromJson(json['conclusion'] as String),
  ...
  status: WebhookCheckSuiteRerequestedCheckSuiteStatus.fromJson(json['status'] as String),
