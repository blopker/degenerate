...
import 'webhook_workflow_job_waiting_workflow_job_steps_conclusion.dart';import 'webhook_workflow_job_waiting_workflow_job_steps_status.dart';final class WebhookWorkflowJobWaitingWorkflowJobSteps {const WebhookWorkflowJobWaitingWorkflowJobSteps({required this.completedAt, required this.conclusion, required this.name, required this.number, required this.startedAt, required this.status, });
