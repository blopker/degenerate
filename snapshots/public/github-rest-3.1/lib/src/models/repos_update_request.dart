...
import 'repos_update_request_merge_commit_message.dart';import 'repos_update_request_merge_commit_title.dart';import 'repos_update_request_security_and_analysis.dart';import 'repos_update_request_squash_merge_commit_message.dart';import 'repos_update_request_squash_merge_commit_title.dart';import 'repos_update_request_visibility.dart';final class ReposUpdateRequest {const ReposUpdateRequest({this.name, this.description, this.homepage, this.private = false, this.visibility, this.securityAndAnalysis, this.hasIssues = true, this.hasProjects = true, this.hasWiki = true, this.isTemplate = false, this.defaultBranch, this.allowSquashMerge = true, this.allowMergeCommit = true, this.allowRebaseMerge = true, this.allowAutoMerge = false, this.deleteBranchOnMerge = false, this.allowUpdateBranch = false, this.useSquashPrTitleAsDefault = false, this.squashMergeCommitTitle, this.squashMergeCommitMessage, this.mergeCommitTitle, this.mergeCommitMessage, this.archived = false, this.allowForking = false, this.webCommitSignoffRequired = false, });
