...
final class WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType {const WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType._(this.value);

factory WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType bot = WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType._('Bot');

static const WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType user = WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType._('User');

static const WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType organization = WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType._('Organization');

static const List<WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy {const WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType? type;
...
WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant2PullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy &&
...
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant2PullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
