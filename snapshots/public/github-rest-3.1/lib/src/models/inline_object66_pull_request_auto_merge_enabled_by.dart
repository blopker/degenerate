...
final class InlineObject66PullRequestAutoMergeEnabledByType {const InlineObject66PullRequestAutoMergeEnabledByType._(this.value);

factory InlineObject66PullRequestAutoMergeEnabledByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject66PullRequestAutoMergeEnabledByType._(json),
}; }

static const InlineObject66PullRequestAutoMergeEnabledByType bot = InlineObject66PullRequestAutoMergeEnabledByType._('Bot');

static const InlineObject66PullRequestAutoMergeEnabledByType user = InlineObject66PullRequestAutoMergeEnabledByType._('User');

static const InlineObject66PullRequestAutoMergeEnabledByType organization = InlineObject66PullRequestAutoMergeEnabledByType._('Organization');

static const List<InlineObject66PullRequestAutoMergeEnabledByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestAutoMergeEnabledByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestAutoMergeEnabledByType($value)'; } 
 }
final class InlineObject66PullRequestAutoMergeEnabledBy {const InlineObject66PullRequestAutoMergeEnabledBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestAutoMergeEnabledBy.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestAutoMergeEnabledBy(
  ...
  type: json['type'] != null ? InlineObject66PullRequestAutoMergeEnabledByType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestAutoMergeEnabledByType? type;
...
InlineObject66PullRequestAutoMergeEnabledBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestAutoMergeEnabledByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestAutoMergeEnabledBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestAutoMergeEnabledBy &&
