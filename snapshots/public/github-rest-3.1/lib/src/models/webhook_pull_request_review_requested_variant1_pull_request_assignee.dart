...
final class WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType {const WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._(this.value);

factory WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  'Mannequin' => mannequin,
  _ => WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._(json),
}; }

static const WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType bot = WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._('Bot');

static const WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType user = WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._('User');

static const WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType organization = WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._('Organization');

static const WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType mannequin = WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType._('Mannequin');

static const List<WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType> values = [bot, user, organization, mannequin];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType($value)'; } 
 }
final class WebhookPullRequestReviewRequestedVariant1PullRequestAssignee {const WebhookPullRequestReviewRequestedVariant1PullRequestAssignee({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory WebhookPullRequestReviewRequestedVariant1PullRequestAssignee.fromJson(Map<String, dynamic> json) { return WebhookPullRequestReviewRequestedVariant1PullRequestAssignee(
  ...
  type: json['type'] != null ? WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType.fromJson(json['type'] as String) : null,
...
final WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType? type;
...
WebhookPullRequestReviewRequestedVariant1PullRequestAssignee copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, WebhookPullRequestReviewRequestedVariant1PullRequestAssigneeType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return WebhookPullRequestReviewRequestedVariant1PullRequestAssignee(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WebhookPullRequestReviewRequestedVariant1PullRequestAssignee &&
...
@override String toString() { return 'WebhookPullRequestReviewRequestedVariant1PullRequestAssignee(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
