...
import 'secret_scanning_alert_resolution.dart';import 'secret_scanning_alert_state.dart';import 'secret_scanning_alert_validity.dart';import 'secret_scanning_first_detected_location.dart';import 'simple_user.dart';final class SecretScanningAlert {const SecretScanningAlert({this.number, this.createdAt, this.updatedAt, this.url, this.htmlUrl, this.locationsUrl, this.state, this.resolution, this.resolvedAt, this.resolvedBy, this.resolutionComment, this.secretType, this.secretTypeDisplayName, this.secret, this.pushProtectionBypassed, this.pushProtectionBypassedBy, this.pushProtectionBypassedAt, this.pushProtectionBypassRequestReviewer, this.pushProtectionBypassRequestReviewerComment, this.pushProtectionBypassRequestComment, this.pushProtectionBypassRequestHtmlUrl, this.validity, this.publiclyLeaked, this.multiRepo, this.isBase64Encoded, this.firstLocationDetected, this.hasMoreLocations, this.assignedTo, });
...
factory SecretScanningAlert.fromJson(Map<String, dynamic> json) { return SecretScanningAlert(
  ...
  firstLocationDetected: json['first_location_detected'] != null
        ? SecretScanningFirstDetectedLocation.fromJson(json['first_location_detected'] as Map<String, dynamic>)
        : null,
