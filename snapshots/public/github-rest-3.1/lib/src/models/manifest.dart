...
import 'dependency.dart';import 'manifest_file.dart';import 'metadata_value.dart';final class Manifest {const Manifest({required this.name, this.file, this.metadata, this.resolved, });
...
Manifest copyWith({String? name, ManifestFile Function()? file, Map<String, MetadataValue> Function()? metadata, Map<String, Dependency> Function()? resolved, }) { return Manifest(
  name: name ?? this.name,
