...
import 'dependency.dart';import 'inline_object8.dart';import 'manifest_file.dart';final class Manifest {const Manifest({required this.name, this.file, this.metadata, this.resolved, });
...
Manifest copyWith({String? name, ManifestFile Function()? file, Map<String, InlineObject8> Function()? metadata, Map<String, Dependency> Function()? resolved, }) { return Manifest(
  name: name ?? this.name,
