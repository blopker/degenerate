...
factory WebhooksPullRequest5.fromJson(Map<String, dynamic> json) { return WebhooksPullRequest5(
  ...
  requestedReviewers: (json['requested_reviewers'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => User.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && User.canParse(v), fromB: (v) => Team2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Team2.canParse(v),)).toList(),
