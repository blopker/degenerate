...
final class InlineObject69PullRequestAssigneesType {const InlineObject69PullRequestAssigneesType._(this.value);

factory InlineObject69PullRequestAssigneesType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject69PullRequestAssigneesType bot = InlineObject69PullRequestAssigneesType._('Bot');

static const InlineObject69PullRequestAssigneesType user = InlineObject69PullRequestAssigneesType._('User');

static const InlineObject69PullRequestAssigneesType organization = InlineObject69PullRequestAssigneesType._('Organization');

static const InlineObject69PullRequestAssigneesType mannequin = InlineObject69PullRequestAssigneesType._('Mannequin');

static const List<InlineObject69PullRequestAssigneesType> values = [bot, user, organization, mannequin];
...
factory InlineObject69PullRequestAssignees.fromJson(Map<String, dynamic> json) { return InlineObject69PullRequestAssignees(
  ...
  type: json['type'] != null ? InlineObject69PullRequestAssigneesType.fromJson(json['type'] as String) : null,
...
final InlineObject69PullRequestAssigneesType? type;
...
InlineObject69PullRequestAssignees copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69PullRequestAssigneesType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69PullRequestAssignees(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69PullRequestAssignees &&
