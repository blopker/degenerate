...
factory WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadata.fromJson(Map<String, dynamic> json) { return WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadata(
  id: json['id'] != null ? OneOf3.parse(json['id'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v)), canParseB: (v) => v is Map, fromC: (v) => (v as num).toInt(), canParseC: (v) => v is num,) : null,
  name: json['name'] as String?,
  value: json['value'] != null ? OneOf4.parse(json['value'], fromA: (v) => v as bool, canParseA: (v) => v is bool, fromB: (v) => v as String, canParseB: (v) => v is String, fromC: (v) => (v as num).toInt(), canParseC: (v) => v is num, fromD: (v) => WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataValueVariant4.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && WebhookRegistryPackagePublishedRegistryPackagePackageVersionNugetMetadataValueVariant4.canParse(v),) : null,
); }
