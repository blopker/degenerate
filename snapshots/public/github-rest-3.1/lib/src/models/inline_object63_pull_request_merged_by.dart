...
final class InlineObject63PullRequestMergedByType {const InlineObject63PullRequestMergedByType._(this.value);

factory InlineObject63PullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject63PullRequestMergedByType._(json),
}; }

static const InlineObject63PullRequestMergedByType bot = InlineObject63PullRequestMergedByType._('Bot');

static const InlineObject63PullRequestMergedByType user = InlineObject63PullRequestMergedByType._('User');

static const InlineObject63PullRequestMergedByType organization = InlineObject63PullRequestMergedByType._('Organization');

static const List<InlineObject63PullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject63PullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject63PullRequestMergedByType($value)'; } 
 }
final class InlineObject63PullRequestMergedBy {const InlineObject63PullRequestMergedBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject63PullRequestMergedBy.fromJson(Map<String, dynamic> json) { return InlineObject63PullRequestMergedBy(
  ...
  type: json['type'] != null ? InlineObject63PullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final InlineObject63PullRequestMergedByType? type;
...
InlineObject63PullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject63PullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject63PullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject63PullRequestMergedBy &&
...
@override String toString() { return 'InlineObject63PullRequestMergedBy(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
