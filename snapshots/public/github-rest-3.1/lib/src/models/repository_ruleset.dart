...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'repository_rule.dart';import 'repository_rule_enforcement.dart';import 'repository_ruleset_bypass_actor.dart';import 'repository_ruleset_conditions2.dart';import 'repository_ruleset_links.dart';/// The target of the ruleset
...
factory RepositoryRuleset.fromJson(Map<String, dynamic> json) { return RepositoryRuleset(
  ...
  conditions: json['conditions'] != null ? OneOf2.parse(json['conditions'], fromA: (v) => RepositoryRulesetConditions.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RepositoryRulesetConditions.canParse(v), fromB: (v) => OrgRulesetConditions.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && OrgRulesetConditions.canParse(v),) : null,
