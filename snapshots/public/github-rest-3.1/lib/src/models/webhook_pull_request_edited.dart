...
import 'enterprise_webhooks.dart';import 'organization_simple_webhooks.dart';import 'pull_request.dart';import 'repository_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'webhook_pull_request_edited_action.dart';import 'webhook_pull_request_edited_changes.dart';final class WebhookPullRequestEdited {const WebhookPullRequestEdited({required this.action, required this.changes, this.enterprise, this.installation, required this.number, this.organization, required this.pullRequest, required this.repository, this.sender, });
...
WebhookPullRequestEdited copyWith({WebhookPullRequestEditedAction? action, WebhookPullRequestEditedChanges? changes, EnterpriseWebhooks Function()? enterprise, SimpleInstallation Function()? installation, int? number, OrganizationSimpleWebhooks Function()? organization, PullRequest? pullRequest, RepositoryWebhooks? repository, SimpleUser Function()? sender, }) { return WebhookPullRequestEdited(
