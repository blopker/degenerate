...
import 'package:collection/collection.dart';import 'base_gist_files_value.dart';import 'simple_user.dart';/// Base Gist
...
factory BaseGist.fromJson(Map<String, dynamic> json) { return BaseGist(
  ...
  forks: (json['forks'] as List<dynamic>?)?.map((e) => e as Object).toList(),
  history: (json['history'] as List<dynamic>?)?.map((e) => e as Object).toList(),
); }
