...
import 'package:collection/collection.dart';final class CodespacesCreateOrUpdateSecretForAuthenticatedUserRequest {const CodespacesCreateOrUpdateSecretForAuthenticatedUserRequest({this.encryptedValue, required this.keyId, this.selectedRepositoryIds, });
