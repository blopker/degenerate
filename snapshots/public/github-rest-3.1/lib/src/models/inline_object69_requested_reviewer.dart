...
final class InlineObject69RequestedReviewerType {const InlineObject69RequestedReviewerType._(this.value);

factory InlineObject69RequestedReviewerType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
...
static const InlineObject69RequestedReviewerType bot = InlineObject69RequestedReviewerType._('Bot');

static const InlineObject69RequestedReviewerType user = InlineObject69RequestedReviewerType._('User');

static const InlineObject69RequestedReviewerType organization = InlineObject69RequestedReviewerType._('Organization');

static const InlineObject69RequestedReviewerType mannequin = InlineObject69RequestedReviewerType._('Mannequin');

static const List<InlineObject69RequestedReviewerType> values = [bot, user, organization, mannequin];
...
factory InlineObject69RequestedReviewer.fromJson(Map<String, dynamic> json) { return InlineObject69RequestedReviewer(
  ...
  type: json['type'] != null ? InlineObject69RequestedReviewerType.fromJson(json['type'] as String) : null,
...
final InlineObject69RequestedReviewerType? type;
...
InlineObject69RequestedReviewer copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject69RequestedReviewerType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject69RequestedReviewer(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject69RequestedReviewer &&
...
@override String toString() { return 'InlineObject69RequestedReviewer(avatarUrl: $avatarUrl, deleted: $deleted, email: $email, eventsUrl: $eventsUrl, followersUrl: $followersUrl, followingUrl: $followingUrl, gistsUrl: $gistsUrl, gravatarId: $gravatarId, htmlUrl: $htmlUrl, id: $id, login: $login, name: $name, nodeId: $nodeId, organizationsUrl: $organizationsUrl, receivedEventsUrl: $receivedEventsUrl, reposUrl: $reposUrl, siteAdmin: $siteAdmin, starredUrl: $starredUrl, subscriptionsUrl: $subscriptionsUrl, type: $type, url: $url, userViewType: $userViewType)'; } 
 }
