...
final class InlineObject66PullRequestMergedByType {const InlineObject66PullRequestMergedByType._(this.value);

factory InlineObject66PullRequestMergedByType.fromJson(String json) { return switch (json) {
  'Bot' => bot,
  'User' => user,
  'Organization' => organization,
  _ => InlineObject66PullRequestMergedByType._(json),
}; }

static const InlineObject66PullRequestMergedByType bot = InlineObject66PullRequestMergedByType._('Bot');

static const InlineObject66PullRequestMergedByType user = InlineObject66PullRequestMergedByType._('User');

static const InlineObject66PullRequestMergedByType organization = InlineObject66PullRequestMergedByType._('Organization');

static const List<InlineObject66PullRequestMergedByType> values = [bot, user, organization];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InlineObject66PullRequestMergedByType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'InlineObject66PullRequestMergedByType($value)'; } 
 }
final class InlineObject66PullRequestMergedBy {const InlineObject66PullRequestMergedBy({this.avatarUrl, this.deleted, this.email, this.eventsUrl, this.followersUrl, this.followingUrl, this.gistsUrl, this.gravatarId, this.htmlUrl, required this.id, required this.login, this.name, this.nodeId, this.organizationsUrl, this.receivedEventsUrl, this.reposUrl, this.siteAdmin, this.starredUrl, this.subscriptionsUrl, this.type, this.url, this.userViewType, });

factory InlineObject66PullRequestMergedBy.fromJson(Map<String, dynamic> json) { return InlineObject66PullRequestMergedBy(
  ...
  type: json['type'] != null ? InlineObject66PullRequestMergedByType.fromJson(json['type'] as String) : null,
...
final InlineObject66PullRequestMergedByType? type;
...
InlineObject66PullRequestMergedBy copyWith({Uri Function()? avatarUrl, bool Function()? deleted, String? Function()? email, String Function()? eventsUrl, Uri Function()? followersUrl, String Function()? followingUrl, String Function()? gistsUrl, String Function()? gravatarId, Uri Function()? htmlUrl, int? id, String? login, String Function()? name, String Function()? nodeId, Uri Function()? organizationsUrl, Uri Function()? receivedEventsUrl, Uri Function()? reposUrl, bool Function()? siteAdmin, String Function()? starredUrl, Uri Function()? subscriptionsUrl, InlineObject66PullRequestMergedByType Function()? type, Uri Function()? url, String Function()? userViewType, }) { return InlineObject66PullRequestMergedBy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject66PullRequestMergedBy &&
