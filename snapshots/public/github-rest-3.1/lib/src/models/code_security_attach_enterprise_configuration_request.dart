...
import 'code_security_attach_enterprise_configuration_request_scope.dart';final class CodeSecurityAttachEnterpriseConfigurationRequest {const CodeSecurityAttachEnterpriseConfigurationRequest({required this.scope});
