...
import 'organization_simple_webhooks.dart';import 'simple_installation.dart';import 'simple_user.dart';import 'status_update.dart';import 'status_update_deleted_action.dart';final class StatusUpdateDeleted {const StatusUpdateDeleted({required this.action, this.installation, required this.organization, required this.projectsV2StatusUpdate, required this.sender, });
