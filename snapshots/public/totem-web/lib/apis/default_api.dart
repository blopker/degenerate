...
return  PublicUserSchema.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 404:
final json = jsonDecode(response.body);
return  Message.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// User Avatar Update
///
