...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ProfileAvatarTypeEnum {const ProfileAvatarTypeEnum._(this.value);
...
@override String toString() { return 'ProfileAvatarTypeEnum($value)'; } 
 }
