...
import 'public_user_schema.dart';final class SpaceSchema {const SpaceSchema({required this.author, required this.title, this.slug, required this.dateCreated, required this.dateModified, required this.subtitle, });
