...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/error_response.dart';import '../models/key3.dart';import '../models/key_delete_response.dart';import '../models/key_list_response.dart';import '../models/project.dart';import '../models/project_create_request.dart';import '../models/project_list_response.dart';import '../models/project_rate_limit.dart';import '../models/project_rate_limit_list_response.dart';import '../models/project_rate_limit_update_request.dart';import '../models/project_service_account.dart';import '../models/project_service_account_create_request.dart';import '../models/project_service_account_create_response.dart';import '../models/project_service_account_delete_response.dart';import '../models/project_service_account_list_response.dart';import '../models/project_update_request.dart';import '../models/project_user.dart';import '../models/project_user_create_request.dart';import '../models/project_user_delete_response.dart';import '../models/project_user_list_response.dart';import '../models/project_user_update_request.dart';/// ProjectsApi operations.
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  Project.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  KeyDeleteResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectRateLimit.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectServiceAccountListResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectServiceAccountCreateResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectUserListResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectUser.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ProjectUserDeleteResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  ErrorResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
