...
import 'realtime_beta_server_event_input_audio_buffer_speech_stopped_type.dart';/// Returned in `server_vad` mode when the server detects the end of speech in
