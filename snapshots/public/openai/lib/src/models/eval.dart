...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'eval_data_source_config.dart';import 'eval_testing_criteria.dart';/// The object type.
...
factory Eval.fromJson(Map<String, dynamic> json) { return Eval(
  ...
  dataSourceConfig: OneOf3.parse(json['data_source_config'], fromA: (v) => EvalCustomDataSourceConfig.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EvalCustomDataSourceConfig.canParse(v), fromB: (v) => EvalLogsDataSourceConfig.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EvalLogsDataSourceConfig.canParse(v), fromC: (v) => EvalStoredCompletionsDataSourceConfig.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && EvalStoredCompletionsDataSourceConfig.canParse(v),),
  testingCriteria: (json['testing_criteria'] as List<dynamic>).map((e) => OneOf5.parse(e, fromA: (v) => GraderLabelModel.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && GraderLabelModel.canParse(v), fromB: (v) => GraderStringCheck.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && GraderStringCheck.canParse(v), fromC: (v) => GraderTextSimilarity.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && GraderTextSimilarity.canParse(v), fromD: (v) => GraderPython.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && GraderPython.canParse(v), fromE: (v) => GraderScoreModel.fromJson(v as Map<String, dynamic>), canParseE: (v) => v is Map<String, dynamic> && GraderScoreModel.canParse(v),)).toList(),
