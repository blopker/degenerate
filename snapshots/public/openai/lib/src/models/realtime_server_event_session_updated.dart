...
import 'realtime_server_event_session_updated_session.dart';/// The event type, must be `session.updated`.
...
factory RealtimeServerEventSessionUpdated.fromJson(Map<String, dynamic> json) { return RealtimeServerEventSessionUpdated(
  ...
  session: RealtimeServerEventSessionUpdatedSession.fromJson(json['session']),
); }
