...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtime_server_event_session_updated_session.dart';/// The event type, must be `session.updated`.
