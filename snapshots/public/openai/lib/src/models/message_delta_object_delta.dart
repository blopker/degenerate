...
import 'package:collection/collection.dart';import 'message_delta_object_delta_content.dart';/// The entity that produced the message. One of `user` or `assistant`.
