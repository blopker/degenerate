...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_vector_store_request_chunking_strategy.dart';import 'vector_store_expiration_after.dart';final class CreateVectorStoreRequest {const CreateVectorStoreRequest({this.fileIds, this.name, this.description, this.expiresAfter, this.chunkingStrategy, this.metadata, });
...
factory CreateVectorStoreRequest.fromJson(Map<String, dynamic> json) { return CreateVectorStoreRequest(
  ...
  chunkingStrategy: json['chunking_strategy'] != null ? OneOf2.parse(json['chunking_strategy'], fromA: (v) => AutoChunkingStrategyRequestParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AutoChunkingStrategyRequestParam.canParse(v), fromB: (v) => StaticChunkingStrategyRequestParam.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && StaticChunkingStrategyRequestParam.canParse(v),) : null,
