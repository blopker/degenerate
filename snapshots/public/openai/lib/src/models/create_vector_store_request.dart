...
import 'package:collection/collection.dart';import 'create_vector_store_request_chunking_strategy.dart';import 'vector_store_expiration_after.dart';final class CreateVectorStoreRequest {const CreateVectorStoreRequest({this.fileIds, this.name, this.description, this.expiresAfter, this.chunkingStrategy, this.metadata, });
