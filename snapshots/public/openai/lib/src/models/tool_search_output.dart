...
import 'package:collection/collection.dart';import 'function_call_output_status_enum.dart';import 'tool.dart';import 'tool_search_execution_type.dart';final class ToolSearchOutput {const ToolSearchOutput({this.type = 'tool_search_output', required this.id, required this.callId, required this.execution, required this.tools, required this.status, this.createdBy, });
