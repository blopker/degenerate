...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'run_step_details_tool_calls_code_object_code_interpreter_outputs.dart';/// The Code Interpreter tool call definition.
...
factory RunStepDetailsToolCallsCodeObjectCodeInterpreter.fromJson(Map<String, dynamic> json) { return RunStepDetailsToolCallsCodeObjectCodeInterpreter(
  ...
  outputs: (json['outputs'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => RunStepDetailsToolCallsCodeOutputLogsObject.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RunStepDetailsToolCallsCodeOutputLogsObject.canParse(v), fromB: (v) => RunStepDetailsToolCallsCodeOutputImageObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RunStepDetailsToolCallsCodeOutputImageObject.canParse(v),)).toList(),
); }
