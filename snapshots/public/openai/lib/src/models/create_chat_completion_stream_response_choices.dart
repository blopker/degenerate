...
import 'chat_completion_stream_response_delta.dart';import 'create_chat_completion_stream_response_choices_finish_reason.dart';import 'create_chat_completion_stream_response_choices_logprobs.dart';final class CreateChatCompletionStreamResponseChoices {const CreateChatCompletionStreamResponseChoices({required this.delta, this.logprobs, required this.finishReason, required this.index, });
