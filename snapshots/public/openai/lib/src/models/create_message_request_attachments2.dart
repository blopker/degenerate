...
import 'package:collection/collection.dart';import 'create_message_request_attachments2_tools.dart';final class CreateMessageRequestAttachments2 {const CreateMessageRequestAttachments2({this.fileId, this.tools, });

factory CreateMessageRequestAttachments2.fromJson(Map<String, dynamic> json) { return CreateMessageRequestAttachments2(
  fileId: json['file_id'] as String?,
  tools: (json['tools'] as List<dynamic>?)?.map((e) => CreateMessageRequestAttachments2Tools.fromJson(e)).toList(),
); }
