...
factory CreateThreadAndRunRequest.fromJson(Map<String, dynamic> json) { return CreateThreadAndRunRequest(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateThreadAndRunRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
