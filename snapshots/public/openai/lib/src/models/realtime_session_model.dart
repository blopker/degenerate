...
final class RealtimeSessionModelVariant2 {const RealtimeSessionModelVariant2._(this.value);
...
/// 
final class RealtimeSessionModel {const RealtimeSessionModel({this.string, this.realtimeSessionModelVariant2, });

factory RealtimeSessionModel.fromJson(Object? json) { return RealtimeSessionModel(
  string: json is String ? json : null,
  realtimeSessionModelVariant2: json is String ? RealtimeSessionModelVariant2.fromJson(json) : null,
); }

final String? string;

final RealtimeSessionModelVariant2? realtimeSessionModelVariant2;

/// At least one variant must be present.
bool get isValid { return string != null || realtimeSessionModelVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'string': ?string,
  if (realtimeSessionModelVariant2 != null) 'realtimeSessionModelVariant2': realtimeSessionModelVariant2!.toJson(),
}; } 
 }
