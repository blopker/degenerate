...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_transcription_response_json_logprobs.dart';import 'create_transcription_response_json_usage.dart';/// Represents a transcription response returned by model, based on the provided input.
...
factory CreateTranscriptionResponseJson.fromJson(Map<String, dynamic> json) { return CreateTranscriptionResponseJson(
  ...
  usage: json['usage'] != null ? OneOf2.parse(json['usage'], fromA: (v) => TranscriptTextUsageTokens.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TranscriptTextUsageTokens.canParse(v), fromB: (v) => TranscriptTextUsageDuration.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TranscriptTextUsageDuration.canParse(v),) : null,
); }
