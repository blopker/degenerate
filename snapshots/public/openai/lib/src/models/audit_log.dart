...
factory AuditLog.fromJson(Map<String, dynamic> json) { return AuditLog(
  ...
  loginSucceeded: (json['login.succeeded'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as Object)),
  loginFailed: json['login.failed'] != null ? AuditLogLoginFailed.fromJson(json['login.failed'] as Map<String, dynamic>) : null,
  logoutSucceeded: (json['logout.succeeded'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as Object)),
