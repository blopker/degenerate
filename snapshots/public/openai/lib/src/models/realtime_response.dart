...
factory RealtimeResponse.fromJson(Map<String, dynamic> json) { return RealtimeResponse(
  ...
  maxOutputTokens: json['max_output_tokens'] != null ? OneOf2.parse(json['max_output_tokens'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => RealtimeResponseMaxOutputTokensVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
