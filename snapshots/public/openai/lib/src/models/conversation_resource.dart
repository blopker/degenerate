...
import 'conversation_resource_object.dart';final class ConversationResource {const ConversationResource({required this.id, this.object = ConversationResourceObject.conversation, required this.metadata, required this.createdAt, });
