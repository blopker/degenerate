...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'grader_multi_graders.dart';/// The object type, which is always `multi`.
...
factory GraderMulti.fromJson(Map<String, dynamic> json) { return GraderMulti(
  ...
  graders: OneOf5.parse(json['graders'], fromA: (v) => GraderStringCheck.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && GraderStringCheck.canParse(v), fromB: (v) => GraderTextSimilarity.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && GraderTextSimilarity.canParse(v), fromC: (v) => GraderPython.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && GraderPython.canParse(v), fromD: (v) => GraderScoreModel.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && GraderScoreModel.canParse(v), fromE: (v) => GraderLabelModel.fromJson(v as Map<String, dynamic>), canParseE: (v) => v is Map<String, dynamic> && GraderLabelModel.canParse(v),),
