...
import 'package:collection/collection.dart';import 'function_call_item_status.dart';import 'tool.dart';import 'tool_search_execution_type.dart';final class ToolSearchOutputItemParam {const ToolSearchOutputItemParam({this.id, this.callId, this.type = 'tool_search_output', this.execution, required this.tools, this.status, });
