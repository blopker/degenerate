...
factory CreateImageEditRequest.fromJson(Map<String, dynamic> json) { return CreateImageEditRequest(
  image: OneOf2.parse(json['image'], fromA: (v) => base64Decode(v as String), fromB: (v) => (v as List<dynamic>).map((e) => base64Decode(e as String)).toList(), canParseB: (v) => v is List,),
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateImageEditRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
