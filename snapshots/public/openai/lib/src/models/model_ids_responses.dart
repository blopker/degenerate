...
import 'model_ids_shared.dart';final class ResponsesOnlyModel {const ResponsesOnlyModel._(this.value);
...
final class ModelIdsResponses {const ModelIdsResponses({this.modelIdsShared, this.responsesOnlyModel, });
...
return ModelIdsResponses(
  ...
  responsesOnlyModel: json is String ? ResponsesOnlyModel.fromJson(json) : null,
); }

final ModelIdsShared? modelIdsShared;

final ResponsesOnlyModel? responsesOnlyModel;

/// At least one variant must be present.
bool get isValid { return modelIdsShared != null || responsesOnlyModel != null; } 
Map<String, dynamic> toJson() { return {
  if (modelIdsShared != null) 'modelIdsShared': modelIdsShared!.toJson(),
  if (responsesOnlyModel != null) 'responsesOnlyModel': responsesOnlyModel!.toJson(),
}; } 
 }
