...
import 'inline_object117.dart';import 'workflow_tracing_param.dart';/// Workflow reference and overrides applied to the chat session.
...
WorkflowParam copyWith({String? id, String Function()? version, Map<String, InlineObject117> Function()? stateVariables, WorkflowTracingParam Function()? tracing, }) { return WorkflowParam(
  id: id ?? this.id,
