...
import 'workflow_param_state_variables_value.dart';import 'workflow_tracing_param.dart';/// Workflow reference and overrides applied to the chat session.
...
factory WorkflowParam.fromJson(Map<String, dynamic> json) { return WorkflowParam(
  ...
  stateVariables: (json['state_variables'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, WorkflowParamStateVariablesValue.fromJson(v))),
...
final Map<String,WorkflowParamStateVariablesValue>? stateVariables;
...
Map<String, dynamic> toJson() { return {
  'id': id,
  'version': ?version,
  if (stateVariables != null) 'state_variables': stateVariables?.map((k, v) => MapEntry(k, v.toJson())),
  if (tracing != null) 'tracing': tracing?.toJson(),
}; } 
static bool canParse(Map<String, dynamic> json) { return json.containsKey('id') && json['id'] is String; } 
WorkflowParam copyWith({String? id, String Function()? version, Map<String, WorkflowParamStateVariablesValue> Function()? stateVariables, WorkflowTracingParam Function()? tracing, }) { return WorkflowParam(
  id: id ?? this.id,
