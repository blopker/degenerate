...
import 'package:collection/collection.dart';import 'container_auto_param_network_policy.dart';import 'container_auto_param_skills.dart';import 'container_auto_param_type.dart';import 'container_memory_limit.dart';final class ContainerAutoParam {const ContainerAutoParam({this.type = ContainerAutoParamType.containerAuto, this.fileIds, this.memoryLimit, this.networkPolicy, this.skills, });
