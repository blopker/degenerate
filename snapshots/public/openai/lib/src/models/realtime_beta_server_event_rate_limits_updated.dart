...
import 'package:collection/collection.dart';import 'realtime_beta_server_event_rate_limits_updated_rate_limits.dart';/// The event type, must be `rate_limits.updated`.
