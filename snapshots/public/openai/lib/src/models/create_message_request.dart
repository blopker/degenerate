...
import 'package:collection/collection.dart';import 'create_message_request_attachments2.dart';import 'create_message_request_content.dart';/// The role of the entity that is creating the message. Allowed values include:
...
factory CreateMessageRequest.fromJson(Map<String, dynamic> json) { return CreateMessageRequest(
  ...
  content: CreateMessageRequestContent.fromJson(json['content']),
