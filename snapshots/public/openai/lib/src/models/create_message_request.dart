...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_message_request_attachments2.dart';import 'create_message_request_content.dart';/// The role of the entity that is creating the message. Allowed values include:
...
factory CreateMessageRequest.fromJson(Map<String, dynamic> json) { return CreateMessageRequest(
  ...
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => OneOf3.parse(e, fromA: (v) => MessageContentImageFileObject.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && MessageContentImageFileObject.canParse(v), fromB: (v) => MessageContentImageUrlObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && MessageContentImageUrlObject.canParse(v), fromC: (v) => MessageRequestContentTextObject.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && MessageRequestContentTextObject.canParse(v),)).toList(), canParseB: (v) => v is List,),
