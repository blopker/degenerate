...
import 'package:collection/collection.dart';import 'create_embedding_response_object.dart';import 'create_embedding_response_usage.dart';import 'embedding.dart';final class CreateEmbeddingResponse {const CreateEmbeddingResponse({required this.data, required this.model, required this.object, required this.usage, });
