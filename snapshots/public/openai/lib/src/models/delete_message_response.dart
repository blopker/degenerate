...
import 'delete_message_response_object.dart';final class DeleteMessageResponse {const DeleteMessageResponse({required this.id, required this.deleted, required this.object, });
