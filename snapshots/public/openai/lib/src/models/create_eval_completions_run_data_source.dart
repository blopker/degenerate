...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_eval_completions_run_data_source_input_messages.dart';import 'create_eval_completions_run_data_source_sampling_params.dart';import 'create_eval_completions_run_data_source_source.dart';/// The type of run data source. Always `completions`.
...
factory CreateEvalCompletionsRunDataSource.fromJson(Map<String, dynamic> json) { return CreateEvalCompletionsRunDataSource(
  ...
  inputMessages: json['input_messages'] != null ? OneOf2.parse(json['input_messages'], fromA: (v) => TemplateInputMessages.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TemplateInputMessages.canParse(v), fromB: (v) => ItemReferenceInputMessages.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ItemReferenceInputMessages.canParse(v),) : null,
  ...
  source: OneOf3.parse(json['source'], fromA: (v) => EvalJsonlFileContentSource.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EvalJsonlFileContentSource.canParse(v), fromB: (v) => EvalJsonlFileIdSource.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EvalJsonlFileIdSource.canParse(v), fromC: (v) => EvalStoredCompletionsSource.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && EvalStoredCompletionsSource.canParse(v),),
); }
