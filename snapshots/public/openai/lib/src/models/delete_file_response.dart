...
import 'delete_file_response_object.dart';final class DeleteFileResponse {const DeleteFileResponse({required this.id, required this.object, required this.deleted, });
