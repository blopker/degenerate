...
import 'package:collection/collection.dart';final class ModifyThreadRequestToolResourcesCodeInterpreter {const ModifyThreadRequestToolResourcesCodeInterpreter({this.fileIds = const []});
