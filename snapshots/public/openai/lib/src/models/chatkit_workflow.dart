...
import 'chatkit_workflow_state_variables_value.dart';import 'chatkit_workflow_tracing.dart';/// Workflow metadata and state returned for the session.
...
factory ChatkitWorkflow.fromJson(Map<String, dynamic> json) { return ChatkitWorkflow(
  ...
  stateVariables: (json['state_variables'] as Map<String, dynamic>).map((k, v) => MapEntry(k, ChatkitWorkflowStateVariablesValue.fromJson(v))),
...
final Map<String,ChatkitWorkflowStateVariablesValue>? stateVariables;
...
ChatkitWorkflow copyWith({String? id, String? Function()? version, Map<String, ChatkitWorkflowStateVariablesValue>? Function()? stateVariables, ChatkitWorkflowTracing? tracing, }) { return ChatkitWorkflow(
  id: id ?? this.id,
