...
import 'chatkit_workflow_tracing.dart';import 'inline_object116.dart';/// Workflow metadata and state returned for the session.
...
factory ChatkitWorkflow.fromJson(Map<String, dynamic> json) { return ChatkitWorkflow(
  ...
  stateVariables: (json['state_variables'] as Map<String, dynamic>).map((k, v) => MapEntry(k, InlineObject116.fromJson(v))),
...
final Map<String,InlineObject116>? stateVariables;
...
ChatkitWorkflow copyWith({String? id, String? Function()? version, Map<String, InlineObject116>? Function()? stateVariables, ChatkitWorkflowTracing? tracing, }) { return ChatkitWorkflow(
  id: id ?? this.id,
