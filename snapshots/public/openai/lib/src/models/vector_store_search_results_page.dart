...
import 'package:collection/collection.dart';import 'vector_store_search_result_item.dart';import 'vector_store_search_results_page_object.dart';final class VectorStoreSearchResultsPage {const VectorStoreSearchResultsPage({required this.object, required this.searchQuery, required this.data, required this.hasMore, required this.nextPage, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is VectorStoreSearchResultsPage &&
          object == other.object &&
          const ListEquality<dynamic>().equals(searchQuery, other.searchQuery) &&
