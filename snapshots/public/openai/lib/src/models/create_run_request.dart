...
factory CreateRunRequest.fromJson(Map<String, dynamic> json) { return CreateRunRequest(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => CreateRunRequestTools.fromJson(e)).toList(),
