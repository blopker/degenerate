...
factory CreateImageRequest.fromJson(Map<String, dynamic> json) { return CreateImageRequest(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateImageRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
