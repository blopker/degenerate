...
import 'package:collection/collection.dart';import 'realtime_conversation_item_message_system_content.dart';/// Identifier for the API object being returned - always `realtime.item`. Optional when creating a new item.
