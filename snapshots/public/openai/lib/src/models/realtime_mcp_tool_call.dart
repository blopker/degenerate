...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtime_mcp_tool_call_error.dart';/// The type of the item. Always `mcp_call`.
...
factory RealtimeMcpToolCall.fromJson(Map<String, dynamic> json) { return RealtimeMcpToolCall(
  ...
  error: json['error'] != null ? OneOf3.parse(json['error'], fromA: (v) => RealtimeMcpProtocolError.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RealtimeMcpProtocolError.canParse(v), fromB: (v) => RealtimeMcpToolExecutionError.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RealtimeMcpToolExecutionError.canParse(v), fromC: (v) => RealtimeMcphttpError.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && RealtimeMcphttpError.canParse(v),) : null,
); }
