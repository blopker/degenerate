...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'prompt.dart';import 'realtime_session_create_response_ga_audio.dart';import 'realtime_session_create_response_ga_client_secret.dart';import 'realtime_session_create_response_ga_max_output_tokens.dart';import 'realtime_session_create_response_ga_model.dart';import 'realtime_session_create_response_ga_tool_choice.dart';import 'realtime_session_create_response_ga_tools.dart';import 'realtime_session_create_response_ga_tracing.dart';import 'realtime_truncation.dart';import 'realtime_truncation.dart';import 'retention_ratio_truncation.dart';/// The type of session to create. Always `realtime` for the Realtime API.
/// 
...
factory RealtimeSessionCreateResponseGa.fromJson(Map<String, dynamic> json) { return RealtimeSessionCreateResponseGa(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => RealtimeSessionCreateResponseGaModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  tracing: json['tracing'] != null ? OneOf2.parse(json['tracing'], fromA: (v) => Auto.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => TracingConfiguration5.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TracingConfiguration5.canParse(v),) : null,
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => RealtimeFunctionTool.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RealtimeFunctionTool.canParse(v), fromB: (v) => McpTool.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && McpTool.canParse(v),)).toList(),
  toolChoice: json['tool_choice'] != null ? OneOf3.parse(json['tool_choice'], fromA: (v) => ToolChoiceMode.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => ToolChoiceFunction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ToolChoiceFunction.canParse(v), fromC: (v) => ToolChoiceMcp.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ToolChoiceMcp.canParse(v),) : null,
  maxOutputTokens: json['max_output_tokens'] != null ? OneOf2.parse(json['max_output_tokens'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => RealtimeSessionCreateResponseGaMaxOutputTokensVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
