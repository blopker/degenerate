...
import 'package:collection/collection.dart';import 'key.dart';final class KeyList {const KeyList({this.object, this.data, this.hasMore, this.firstId, this.lastId, });
