...
import 'package:collection/collection.dart';import 'message_content_text_object_text_annotations.dart';final class MessageContentTextObjectText {const MessageContentTextObjectText({required this.value, required this.annotations, });

factory MessageContentTextObjectText.fromJson(Map<String, dynamic> json) { return MessageContentTextObjectText(
  value: json['value'] as String,
  annotations: (json['annotations'] as List<dynamic>).map((e) => MessageContentTextObjectTextAnnotations.fromJson(e)).toList(),
); }
