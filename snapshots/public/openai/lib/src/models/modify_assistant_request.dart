...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'modify_assistant_request_model.dart';import 'modify_assistant_request_tool_resources.dart';import 'modify_assistant_request_tools.dart';import 'reasoning_effort.dart';import 'response_format_json_object.dart';import 'response_format_json_schema.dart';import 'response_format_option.dart';import 'response_format_option.dart';import 'response_format_text.dart';final class ModifyAssistantRequest {const ModifyAssistantRequest({this.model, this.reasoningEffort, this.name, this.description, this.instructions, this.tools = const [], this.toolResources, this.metadata, this.temperature, this.topP, this.responseFormat, });

factory ModifyAssistantRequest.fromJson(Map<String, dynamic> json) { return ModifyAssistantRequest(
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AssistantSupportedModels.fromJson(v as String), canParseB: (v) => v is String,) : null,
