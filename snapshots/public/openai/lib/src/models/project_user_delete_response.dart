...
import 'project_user_delete_response_object.dart';final class ProjectUserDeleteResponse {const ProjectUserDeleteResponse({required this.object, required this.id, required this.deleted, });
