...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'chat_completion_tool.dart';import 'create_eval_completions_run_data_source_sampling_params_response_format.dart';import 'reasoning_effort.dart';final class CreateEvalCompletionsRunDataSourceSamplingParams {const CreateEvalCompletionsRunDataSourceSamplingParams({this.reasoningEffort, this.temperature = 1.0, this.maxCompletionTokens, this.topP = 1.0, this.seed = 42, this.responseFormat, this.tools, });
...
factory CreateEvalCompletionsRunDataSourceSamplingParams.fromJson(Map<String, dynamic> json) { return CreateEvalCompletionsRunDataSourceSamplingParams(
  ...
  responseFormat: json['response_format'] != null ? OneOf3.parse(json['response_format'], fromA: (v) => ResponseFormatText.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ResponseFormatText.canParse(v), fromB: (v) => ResponseFormatJsonSchema.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ResponseFormatJsonSchema.canParse(v), fromC: (v) => ResponseFormatJsonObject.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ResponseFormatJsonObject.canParse(v),) : null,
