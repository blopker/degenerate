...
import 'container_resource_expires_after.dart';import 'container_resource_memory_limit.dart';import 'container_resource_network_policy.dart';final class ContainerResource {const ContainerResource({required this.id, required this.object, required this.name, required this.createdAt, required this.status, this.lastActiveAt, this.expiresAfter, this.memoryLimit, this.networkPolicy, });
