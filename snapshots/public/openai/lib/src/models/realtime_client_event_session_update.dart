...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtime_client_event_session_update_session.dart';/// The event type, must be `session.update`.
