...
import 'realtime_client_event_session_update_session.dart';/// The event type, must be `session.update`.
...
factory RealtimeClientEventSessionUpdate.fromJson(Map<String, dynamic> json) { return RealtimeClientEventSessionUpdate(
  ...
  session: RealtimeClientEventSessionUpdateSession.fromJson(json['session']),
); }
