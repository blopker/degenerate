...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model2.dart';import 'eval_run_data_source.dart';import 'eval_run_per_model_usage.dart';import 'eval_run_per_testing_criteria_results.dart';import 'eval_run_result_counts.dart';/// The type of the object. Always "eval.run".
...
factory EvalRun.fromJson(Map<String, dynamic> json) { return EvalRun(
  ...
  dataSource: OneOf3.parse(json['data_source'], fromA: (v) => CreateEvalJsonlRunDataSource.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CreateEvalJsonlRunDataSource.canParse(v), fromB: (v) => CreateEvalCompletionsRunDataSource.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CreateEvalCompletionsRunDataSource.canParse(v), fromC: (v) => CreateEvalResponsesRunDataSource.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && CreateEvalResponsesRunDataSource.canParse(v),),
