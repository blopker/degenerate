...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_speech_request_model.dart';import 'voice_ids_or_custom_voice.dart';import 'voice_ids_or_custom_voice_variant2.dart';import 'voice_ids_shared.dart';import 'voice_ids_shared.dart';/// The format to audio in. Supported formats are `mp3`, `opus`, `aac`, `flac`, `wav`, and `pcm`.
...
factory CreateSpeechRequest.fromJson(Map<String, dynamic> json) { return CreateSpeechRequest(
  model: OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateSpeechRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,),
