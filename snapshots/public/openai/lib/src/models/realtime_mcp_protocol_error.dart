...
import 'realtime_mcp_protocol_error_type.dart';final class RealtimeMcpProtocolError {const RealtimeMcpProtocolError({required this.type, required this.code, required this.message, });
