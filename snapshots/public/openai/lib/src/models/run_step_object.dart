...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'run_step_completion_usage.dart';import 'run_step_object_last_error.dart';import 'run_step_object_step_details.dart';/// The object type, which is always `thread.run.step`.
...
factory RunStepObject.fromJson(Map<String, dynamic> json) { return RunStepObject(
  ...
  stepDetails: OneOf2.parse(json['step_details'], fromA: (v) => RunStepDetailsMessageCreationObject.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RunStepDetailsMessageCreationObject.canParse(v), fromB: (v) => RunStepDetailsToolCallsObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RunStepDetailsToolCallsObject.canParse(v),),
