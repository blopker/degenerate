...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_eval_jsonl_run_data_source_source.dart';/// The type of data source. Always `jsonl`.
...
factory CreateEvalJsonlRunDataSource.fromJson(Map<String, dynamic> json) { return CreateEvalJsonlRunDataSource(
  ...
  source: OneOf2.parse(json['source'], fromA: (v) => EvalJsonlFileContentSource.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EvalJsonlFileContentSource.canParse(v), fromB: (v) => EvalJsonlFileIdSource.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EvalJsonlFileIdSource.canParse(v),),
); }
