...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'chat_completion_request_system_message_content.dart';/// Developer-provided instructions that the model should follow, regardless of
...
factory ChatCompletionRequestSystemMessage.fromJson(Map<String, dynamic> json) { return ChatCompletionRequestSystemMessage(
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => ChatCompletionRequestSystemMessageContentPart.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
