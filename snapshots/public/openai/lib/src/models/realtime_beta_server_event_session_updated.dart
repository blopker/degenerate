...
import 'realtime_beta_server_event_session_updated_type.dart';import 'realtime_session.dart';/// Returned when a session is updated with a `session.update` event, unless
/// there is an error.
/// 
