...
import 'mcp_tool_allowed_tools.dart';import 'mcp_tool_require_approval.dart';/// Identifier for service connectors, like those available in ChatGPT. One of
...
factory McpTool.fromJson(Map<String, dynamic> json) { return McpTool(
  ...
  allowedTools: json['allowed_tools'] != null ? McpToolAllowedTools.fromJson(json['allowed_tools']) : null,
  requireApproval: json['require_approval'] != null ? McpToolRequireApproval.fromJson(json['require_approval']) : null,
