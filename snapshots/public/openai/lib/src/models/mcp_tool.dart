...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcp_tool_allowed_tools.dart';import 'mcp_tool_require_approval.dart';/// Identifier for service connectors, like those available in ChatGPT. One of
...
factory McpTool.fromJson(Map<String, dynamic> json) { return McpTool(
  ...
  allowedTools: json['allowed_tools'] != null ? OneOf2.parse(json['allowed_tools'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => McpToolFilter.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && McpToolFilter.canParse(v),) : null,
  requireApproval: json['require_approval'] != null ? OneOf2.parse(json['require_approval'], fromA: (v) => McpToolApprovalFilter.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && McpToolApprovalFilter.canParse(v), fromB: (v) => McpToolApprovalSetting.fromJson(v as String), canParseB: (v) => v is String,) : null,
