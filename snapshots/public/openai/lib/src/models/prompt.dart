...
import 'inline_object90.dart';/// Reference to a prompt template and its variables.
...
factory Prompt.fromJson(Map<String, dynamic> json) { return Prompt(
  ...
  variables: (json['variables'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject90.fromJson(v))),
); }
...
Prompt copyWith({String? id, String? Function()? version, Map<String, InlineObject90>? Function()? variables, }) { return Prompt(
  id: id ?? this.id,
