...
import 'package:collection/collection.dart';import 'create_eval_request_data_source_config.dart';import 'create_eval_request_testing_criteria.dart';final class CreateEvalRequest {const CreateEvalRequest({this.name, this.metadata, required this.dataSourceConfig, required this.testingCriteria, });

factory CreateEvalRequest.fromJson(Map<String, dynamic> json) { return CreateEvalRequest(
  name: json['name'] as String?,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  dataSourceConfig: CreateEvalRequestDataSourceConfig.fromJson(json['data_source_config']),
  testingCriteria: (json['testing_criteria'] as List<dynamic>).map((e) => CreateEvalRequestTestingCriteria.fromJson(e)).toList(),
); }
