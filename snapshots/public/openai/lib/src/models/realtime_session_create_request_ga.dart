...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'prompt.dart';import 'realtime_session_create_request_ga_audio.dart';import 'realtime_session_create_request_ga_max_output_tokens.dart';import 'realtime_session_create_request_ga_model.dart';import 'realtime_session_create_request_ga_tool_choice.dart';import 'realtime_session_create_request_ga_tools.dart';import 'realtime_session_create_request_ga_tracing.dart';import 'realtime_truncation.dart';import 'realtime_truncation.dart';import 'retention_ratio_truncation.dart';/// The type of session to create. Always `realtime` for the Realtime API.
/// 
...
factory RealtimeSessionCreateRequestGa.fromJson(Map<String, dynamic> json) { return RealtimeSessionCreateRequestGa(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => RealtimeSessionCreateRequestGaModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  tracing: json['tracing'] != null ? OneOf2.parse(json['tracing'], fromA: (v) => Auto.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => TracingConfiguration3.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TracingConfiguration3.canParse(v),) : null,
  ...
  maxOutputTokens: json['max_output_tokens'] != null ? OneOf2.parse(json['max_output_tokens'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => RealtimeSessionCreateRequestGaMaxOutputTokensVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
