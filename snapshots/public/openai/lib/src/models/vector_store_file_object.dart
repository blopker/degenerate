...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'vector_store_file_object_chunking_strategy.dart';import 'vector_store_file_object_last_error.dart';/// The object type, which is always `vector_store.file`.
...
factory VectorStoreFileObject.fromJson(Map<String, dynamic> json) { return VectorStoreFileObject(
  ...
  chunkingStrategy: json['chunking_strategy'] != null ? OneOf2.parse(json['chunking_strategy'], fromA: (v) => StaticChunkingStrategyResponseParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && StaticChunkingStrategyResponseParam.canParse(v), fromB: (v) => OtherChunkingStrategyResponseParam.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && OtherChunkingStrategyResponseParam.canParse(v),) : null,
