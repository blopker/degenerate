...
import 'inline_object110.dart';import 'vector_store_file_object_chunking_strategy.dart';import 'vector_store_file_object_last_error.dart';import 'vector_store_file_object_object.dart';import 'vector_store_file_object_status.dart';/// A list of files attached to a vector store.
...
factory VectorStoreFileObject.fromJson(Map<String, dynamic> json) { return VectorStoreFileObject(
  ...
  chunkingStrategy: json['chunking_strategy'] != null
        ? VectorStoreFileObjectChunkingStrategy.fromJson(json['chunking_strategy'])
        : null,
