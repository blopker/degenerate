...
import 'package:collection/collection.dart';import 'realtime_transcription_session_create_request_ga_audio.dart';/// The type of session to create. Always `transcription` for transcription sessions.
/// 
