...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'run_step_delta_step_details_tool_calls_code_object_code_interpreter_outputs.dart';/// The Code Interpreter tool call definition.
...
factory RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter.fromJson(Map<String, dynamic> json) { return RunStepDeltaStepDetailsToolCallsCodeObjectCodeInterpreter(
  ...
  outputs: (json['outputs'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RunStepDeltaStepDetailsToolCallsCodeOutputLogsObject.canParse(v), fromB: (v) => RunStepDeltaStepDetailsToolCallsCodeOutputImageObject.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RunStepDeltaStepDetailsToolCallsCodeOutputImageObject.canParse(v),)).toList(),
); }
