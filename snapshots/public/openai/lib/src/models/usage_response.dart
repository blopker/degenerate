...
import 'package:collection/collection.dart';import 'usage_response_object.dart';import 'usage_time_bucket.dart';final class UsageResponse {const UsageResponse({required this.object, required this.data, required this.hasMore, required this.nextPage, });
