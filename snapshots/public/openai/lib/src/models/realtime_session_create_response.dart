...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtime_function_tool.dart';import 'realtime_session_create_response_audio.dart';import 'realtime_session_create_response_max_output_tokens.dart';import 'realtime_session_create_response_tracing.dart';import 'realtime_session_create_response_turn_detection.dart';final class RealtimeSessionCreateResponseInclude {const RealtimeSessionCreateResponseInclude._(this.value);
...
factory RealtimeSessionCreateResponse.fromJson(Map<String, dynamic> json) { return RealtimeSessionCreateResponse(
  ...
  tracing: json['tracing'] != null ? OneOf2.parse(json['tracing'], fromA: (v) => RealtimeSessionCreateResponseTracingVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => TracingConfiguration4.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TracingConfiguration4.canParse(v),) : null,
  ...
  maxOutputTokens: json['max_output_tokens'] != null ? OneOf2.parse(json['max_output_tokens'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => RealtimeSessionCreateResponseMaxOutputTokensVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
