...
import 'dart:convert';import 'dart:typed_data';import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_transcription_request_chunking_strategy.dart';import 'create_transcription_request_model.dart';/// The format of the output, in one of these options: `json`, `text`, `srt`, `verbose_json`, `vtt`, or `diarized_json`. For `gpt-4o-transcribe` and `gpt-4o-mini-transcribe`, the only supported format is `json`. For `gpt-4o-transcribe-diarize`, the supported formats are `json`, `text`, and `diarized_json`, with `diarized_json` required to receive speaker annotations.
/// 
...
factory CreateTranscriptionRequest.fromJson(Map<String, dynamic> json) { return CreateTranscriptionRequest(
  ...
  model: OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateTranscriptionRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,),
  ...
  chunkingStrategy: json['chunking_strategy'] != null ? OneOf2.parse(json['chunking_strategy'], fromA: (v) => CreateTranscriptionRequestChunkingStrategyVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => VadConfig.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && VadConfig.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CreateTranscriptionRequest &&
          ...
          const ListEquality<dynamic>().equals(timestampGranularities, other.timestampGranularities) &&
          stream == other.stream &&
          chunkingStrategy == other.chunkingStrategy &&
          const ListEquality<dynamic>().equals(knownSpeakerNames, other.knownSpeakerNames) &&
          const ListEquality<dynamic>().equals(knownSpeakerReferences, other.knownSpeakerReferences); } 
