...
factory AudioTranscription.fromJson(Map<String, dynamic> json) { return AudioTranscription(
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AudioTranscriptionModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
