...
factory FineTuneDpoHyperparameters.fromJson(Map<String, dynamic> json) { return FineTuneDpoHyperparameters(
  beta: json['beta'] != null ? OneOf2.parse(json['beta'], fromA: (v) => FineTuneDpoHyperparametersBetaVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toDouble(), canParseB: (v) => v is num,) : null,
  batchSize: json['batch_size'] != null ? OneOf2.parse(json['batch_size'], fromA: (v) => FineTuneDpoHyperparametersBatchSizeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  learningRateMultiplier: json['learning_rate_multiplier'] != null ? OneOf2.parse(json['learning_rate_multiplier'], fromA: (v) => FineTuneDpoHyperparametersLearningRateMultiplierVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toDouble(), canParseB: (v) => v is num,) : null,
  nEpochs: json['n_epochs'] != null ? OneOf2.parse(json['n_epochs'], fromA: (v) => FineTuneDpoHyperparametersNEpochsVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
); }
