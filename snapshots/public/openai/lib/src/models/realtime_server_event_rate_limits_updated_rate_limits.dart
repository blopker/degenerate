...
import 'realtime_server_event_rate_limits_updated_rate_limits_name.dart';final class RealtimeServerEventRateLimitsUpdatedRateLimits {const RealtimeServerEventRateLimitsUpdatedRateLimits({this.name, this.limit, this.remaining, this.resetSeconds, });
