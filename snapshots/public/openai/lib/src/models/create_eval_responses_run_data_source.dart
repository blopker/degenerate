...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_eval_responses_run_data_source_input_messages.dart';import 'create_eval_responses_run_data_source_sampling_params.dart';import 'create_eval_responses_run_data_source_source.dart';/// The type of run data source. Always `responses`.
...
factory CreateEvalResponsesRunDataSource.fromJson(Map<String, dynamic> json) { return CreateEvalResponsesRunDataSource(
  ...
  inputMessages: json['input_messages'] != null ? OneOf2.parse(json['input_messages'], fromA: (v) => InputMessagesTemplate.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InputMessagesTemplate.canParse(v), fromB: (v) => InputMessagesItemReference.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && InputMessagesItemReference.canParse(v),) : null,
