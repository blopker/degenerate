...
import 'delete_assistant_response_object.dart';final class DeleteAssistantResponse {const DeleteAssistantResponse({required this.id, required this.deleted, required this.object, });
