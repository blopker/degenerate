...
import 'package:collection/collection.dart';import 'voice_consent_list_resource_object.dart';import 'voice_consent_resource.dart';final class VoiceConsentListResource {const VoiceConsentListResource({required this.object, required this.data, this.firstId, this.lastId, required this.hasMore, });
