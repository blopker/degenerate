...
import 'package:collection/collection.dart';import 'code_interpreter_tool_call_outputs2.dart';/// The status of the code interpreter tool call. Valid values are `in_progress`, `completed`, `incomplete`, `interpreting`, and `failed`.
/// 
