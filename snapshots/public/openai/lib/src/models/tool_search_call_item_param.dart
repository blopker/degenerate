...
import 'empty_model_param.dart';import 'function_call_item_status.dart';import 'tool_search_execution_type.dart';final class ToolSearchCallItemParam {const ToolSearchCallItemParam({this.id, this.callId, this.type = 'tool_search_call', this.execution, required this.arguments, this.status, });
