...
EvalRunOutputItemResult copyWith({String? name, String Function()? type, double? score, bool? passed, Map<String, String>? Function()? sample, }) { return EvalRunOutputItemResult(
  name: name ?? this.name,
