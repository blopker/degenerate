...
import 'package:collection/collection.dart';import 'vector_store_file_attributes_value.dart';import 'vector_store_search_result_content_object.dart';final class VectorStoreSearchResultItem {const VectorStoreSearchResultItem({required this.fileId, required this.filename, required this.score, required this.attributes, required this.content, });
...
VectorStoreSearchResultItem copyWith({String? fileId, String? filename, double? score, Map<String, VectorStoreFileAttributesValue>? Function()? attributes, List<VectorStoreSearchResultContentObject>? content, }) { return VectorStoreSearchResultItem(
