...
import 'package:collection/collection.dart';import 'container_network_policy_domain_secret_param.dart';/// Allow outbound network access only to specified domains. Always `allowlist`.
