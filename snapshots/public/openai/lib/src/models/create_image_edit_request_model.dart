...
final class CreateImageEditRequestModelVariant2 {const CreateImageEditRequestModelVariant2._(this.value);
...
final class CreateImageEditRequestModel {const CreateImageEditRequestModel({this.string, this.createImageEditRequestModelVariant2, });
...
factory CreateImageEditRequestModel.fromJson(Object? json) { return CreateImageEditRequestModel(
  ...
  createImageEditRequestModelVariant2: json is String ? CreateImageEditRequestModelVariant2.fromJson(json) : null,
); }

final String? string;

final CreateImageEditRequestModelVariant2? createImageEditRequestModelVariant2;

/// At least one variant must be present.
bool get isValid { return string != null || createImageEditRequestModelVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'string': ?string,
  if (createImageEditRequestModelVariant2 != null) 'createImageEditRequestModelVariant2': createImageEditRequestModelVariant2!.toJson(),
}; } 
 }
