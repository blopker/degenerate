...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'input_messages_template_template.dart';/// The type of input messages. Always `template`.
...
factory InputMessagesTemplate.fromJson(Map<String, dynamic> json) { return InputMessagesTemplate(
  ...
  template: (json['template'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => ChatMessage.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ChatMessage.canParse(v), fromB: (v) => EvalItem.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EvalItem.canParse(v),)).toList(),
); }
