...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'function_call_item_status.dart';import 'function_call_output_item_param_output.dart';/// The output of a function tool call.
...
factory FunctionCallOutputItemParam.fromJson(Map<String, dynamic> json) { return FunctionCallOutputItemParam(
  ...
  output: OneOf2.parse(json['output'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => FunctionCallOutputItemParamOutputVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
