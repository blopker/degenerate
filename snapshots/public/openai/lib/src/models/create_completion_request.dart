...
factory CreateCompletionRequest.fromJson(Map<String, dynamic> json) { return CreateCompletionRequest(
  ...
  maxTokens: json.containsKey('max_tokens') ? (json['max_tokens'] as num).toInt() : 16,
