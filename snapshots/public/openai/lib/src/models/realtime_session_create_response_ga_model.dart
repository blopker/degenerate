...
final class RealtimeSessionCreateResponseGaModelVariant2 {const RealtimeSessionCreateResponseGaModelVariant2._(this.value);
...
/// 
final class RealtimeSessionCreateResponseGaModel {const RealtimeSessionCreateResponseGaModel({this.string, this.realtimeSessionCreateResponseGaModelVariant2, });
...
factory RealtimeSessionCreateResponseGaModel.fromJson(Object? json) { return RealtimeSessionCreateResponseGaModel(
  ...
  realtimeSessionCreateResponseGaModelVariant2: json is String ? RealtimeSessionCreateResponseGaModelVariant2.fromJson(json) : null,
); }

final String? string;

final RealtimeSessionCreateResponseGaModelVariant2? realtimeSessionCreateResponseGaModelVariant2;

/// At least one variant must be present.
bool get isValid { return string != null || realtimeSessionCreateResponseGaModelVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'string': ?string,
  if (realtimeSessionCreateResponseGaModelVariant2 != null) 'realtimeSessionCreateResponseGaModelVariant2': realtimeSessionCreateResponseGaModelVariant2!.toJson(),
}; } 
 }
