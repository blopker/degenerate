...
import 'package:collection/collection.dart';import 'batch.dart';import 'list_batches_response_object.dart';final class ListBatchesResponse {const ListBatchesResponse({required this.data, this.firstId, this.lastId, required this.hasMore, required this.object, });
