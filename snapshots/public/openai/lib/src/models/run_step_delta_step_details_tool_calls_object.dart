...
import 'package:collection/collection.dart';import 'run_step_delta_step_details_tool_calls_object_tool_calls.dart';import 'run_step_delta_step_details_tool_calls_object_type.dart';/// Details of the tool call.
...
factory RunStepDeltaStepDetailsToolCallsObject.fromJson(Map<String, dynamic> json) { return RunStepDeltaStepDetailsToolCallsObject(
  ...
  toolCalls: (json['tool_calls'] as List<dynamic>?)?.map((e) => RunStepDeltaStepDetailsToolCallsObjectToolCalls.fromJson(e)).toList(),
); }
