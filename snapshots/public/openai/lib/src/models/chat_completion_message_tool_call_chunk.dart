...
import 'chat_completion_message_tool_call_chunk_function.dart';import 'chat_completion_message_tool_call_chunk_type.dart';final class ChatCompletionMessageToolCallChunk {const ChatCompletionMessageToolCallChunk({required this.index, this.id, this.type, this.function, });
