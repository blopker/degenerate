...
import 'realtime_function_tool_type.dart';final class RealtimeFunctionTool {const RealtimeFunctionTool({this.type, this.name, this.description, this.parameters, });
