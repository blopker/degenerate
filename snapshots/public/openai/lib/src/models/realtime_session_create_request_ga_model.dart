...
final class RealtimeSessionCreateRequestGaModelVariant2 {const RealtimeSessionCreateRequestGaModelVariant2._(this.value);
...
/// 
final class RealtimeSessionCreateRequestGaModel {const RealtimeSessionCreateRequestGaModel({this.string, this.realtimeSessionCreateRequestGaModelVariant2, });
...
factory RealtimeSessionCreateRequestGaModel.fromJson(Object? json) { return RealtimeSessionCreateRequestGaModel(
  ...
  realtimeSessionCreateRequestGaModelVariant2: json is String ? RealtimeSessionCreateRequestGaModelVariant2.fromJson(json) : null,
); }

final String? string;

final RealtimeSessionCreateRequestGaModelVariant2? realtimeSessionCreateRequestGaModelVariant2;

/// At least one variant must be present.
bool get isValid { return string != null || realtimeSessionCreateRequestGaModelVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'string': ?string,
  if (realtimeSessionCreateRequestGaModelVariant2 != null) 'realtimeSessionCreateRequestGaModelVariant2': realtimeSessionCreateRequestGaModelVariant2!.toJson(),
}; } 
 }
