...
import 'package:collection/collection.dart';final class TranscriptTextDeltaEventLogprobs {const TranscriptTextDeltaEventLogprobs({this.token, this.logprob, this.bytes, });
