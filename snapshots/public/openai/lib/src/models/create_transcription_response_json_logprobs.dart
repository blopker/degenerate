...
import 'package:collection/collection.dart';final class CreateTranscriptionResponseJsonLogprobs {const CreateTranscriptionResponseJsonLogprobs({this.token, this.logprob, this.bytes, });
