...
import 'chat_completion_request_developer_message_content.dart';/// Developer-provided instructions that the model should follow, regardless of
...
factory ChatCompletionRequestDeveloperMessage.fromJson(Map<String, dynamic> json) { return ChatCompletionRequestDeveloperMessage(
  content: ChatCompletionRequestDeveloperMessageContent.fromJson(json['content']),
