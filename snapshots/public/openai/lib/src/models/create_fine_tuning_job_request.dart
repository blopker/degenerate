...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'create_fine_tuning_job_request_hyperparameters.dart';import 'create_fine_tuning_job_request_integrations.dart';import 'create_fine_tuning_job_request_model.dart';import 'fine_tune_method.dart';final class CreateFineTuningJobRequest {const CreateFineTuningJobRequest({required this.model, required this.trainingFile, this.hyperparameters, this.suffix, this.validationFile, this.integrations, this.seed, this.method, this.metadata, });

factory CreateFineTuningJobRequest.fromJson(Map<String, dynamic> json) { return CreateFineTuningJobRequest(
  model: OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateFineTuningJobRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CreateFineTuningJobRequest &&
          ...
          const ListEquality<dynamic>().equals(integrations, other.integrations) &&
          seed == other.seed &&
          method == other.method &&
