...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'chat_completion_request_tool_message_content.dart';final class ChatCompletionRequestToolMessage {const ChatCompletionRequestToolMessage({required this.role, required this.content, required this.toolCallId, });

factory ChatCompletionRequestToolMessage.fromJson(Map<String, dynamic> json) { return ChatCompletionRequestToolMessage(
  role: json['role'] as String,
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => ChatCompletionRequestToolMessageContentPart.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
