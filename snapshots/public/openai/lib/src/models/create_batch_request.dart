...
import 'batch_file_expiration_after.dart';import 'create_batch_request_completion_window.dart';import 'create_batch_request_endpoint.dart';final class CreateBatchRequest {const CreateBatchRequest({required this.inputFileId, required this.endpoint, required this.completionWindow, this.metadata, this.outputExpiresAfter, });
