...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtime_create_client_secret_request_expires_after.dart';import 'realtime_create_client_secret_request_session.dart';/// Create a session and client secret for the Realtime API. The request can specify
...
factory RealtimeCreateClientSecretRequest.fromJson(Map<String, dynamic> json) { return RealtimeCreateClientSecretRequest(
  ...
  session: json['session'] != null ? OneOf2.parse(json['session'], fromA: (v) => RealtimeSessionCreateRequestGa.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RealtimeSessionCreateRequestGa.canParse(v), fromB: (v) => RealtimeTranscriptionSessionCreateRequestGa.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RealtimeTranscriptionSessionCreateRequestGa.canParse(v),) : null,
); }
