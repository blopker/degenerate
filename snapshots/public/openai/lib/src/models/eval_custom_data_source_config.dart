...
import 'eval_custom_data_source_config_type.dart';/// A CustomDataSourceConfig which specifies the schema of your `item` and optionally `sample` namespaces.
...
EvalCustomDataSourceConfig copyWith({EvalCustomDataSourceConfigType? type, Map<String,String>? schema, }) { return EvalCustomDataSourceConfig(
  type: type ?? this.type,
