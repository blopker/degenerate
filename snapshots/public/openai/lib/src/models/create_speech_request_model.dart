...
final class CreateSpeechRequestModelVariant2 {const CreateSpeechRequestModelVariant2._(this.value);
...
/// 
final class CreateSpeechRequestModel {const CreateSpeechRequestModel({this.string, this.createSpeechRequestModelVariant2, });

factory CreateSpeechRequestModel.fromJson(Object? json) { return CreateSpeechRequestModel(
  string: json is String ? json : null,
  createSpeechRequestModelVariant2: json is String ? CreateSpeechRequestModelVariant2.fromJson(json) : null,
); }

final String? string;

final CreateSpeechRequestModelVariant2? createSpeechRequestModelVariant2;

/// At least one variant must be present.
bool get isValid { return string != null || createSpeechRequestModelVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'string': ?string,
  if (createSpeechRequestModelVariant2 != null) 'createSpeechRequestModelVariant2': createSpeechRequestModelVariant2!.toJson(),
}; } 
 }
