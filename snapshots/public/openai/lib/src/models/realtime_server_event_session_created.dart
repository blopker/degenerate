...
import 'realtime_server_event_session_created_session.dart';import 'realtime_server_event_session_created_type.dart';/// Returned when a Session is created. Emitted automatically when a new
...
factory RealtimeServerEventSessionCreated.fromJson(Map<String, dynamic> json) { return RealtimeServerEventSessionCreated(
  ...
  session: RealtimeServerEventSessionCreatedSession.fromJson(json['session']),
); }
