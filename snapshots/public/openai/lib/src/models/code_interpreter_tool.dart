...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'code_interpreter_tool_container.dart';/// A tool that runs Python code to help generate a response to a prompt.
/// 
...
factory CodeInterpreterTool.fromJson(Map<String, dynamic> json) { return CodeInterpreterTool(
  ...
  container: OneOf2.parse(json['container'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AutoCodeInterpreterToolParam.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AutoCodeInterpreterToolParam.canParse(v),),
); }
