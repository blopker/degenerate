...
import 'deleted_skill_resource_object.dart';final class DeletedSkillResource {const DeletedSkillResource({this.object = DeletedSkillResourceObject.skillDeleted, required this.deleted, required this.id, });
