...
factory CreateTranslationRequest.fromJson(Map<String, dynamic> json) { return CreateTranslationRequest(
  ...
  model: OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreateTranslationRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,),
