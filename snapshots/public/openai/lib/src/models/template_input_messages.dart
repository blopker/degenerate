...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'template_input_messages_template.dart';/// The type of input messages. Always `template`.
...
factory TemplateInputMessages.fromJson(Map<String, dynamic> json) { return TemplateInputMessages(
  ...
  template: (json['template'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => EasyInputMessage.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EasyInputMessage.canParse(v), fromB: (v) => EvalItem.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EvalItem.canParse(v),)).toList(),
); }
