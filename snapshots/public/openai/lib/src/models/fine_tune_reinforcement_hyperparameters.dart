...
factory FineTuneReinforcementHyperparameters.fromJson(Map<String, dynamic> json) { return FineTuneReinforcementHyperparameters(
  batchSize: json['batch_size'] != null ? OneOf2.parse(json['batch_size'], fromA: (v) => FineTuneReinforcementHyperparametersBatchSizeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  learningRateMultiplier: json['learning_rate_multiplier'] != null ? OneOf2.parse(json['learning_rate_multiplier'], fromA: (v) => FineTuneReinforcementHyperparametersLearningRateMultiplierVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toDouble(), canParseB: (v) => v is num,) : null,
  nEpochs: json['n_epochs'] != null ? OneOf2.parse(json['n_epochs'], fromA: (v) => FineTuneReinforcementHyperparametersNEpochsVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  ...
  computeMultiplier: json['compute_multiplier'] != null ? OneOf2.parse(json['compute_multiplier'], fromA: (v) => FineTuneReinforcementHyperparametersComputeMultiplierVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toDouble(), canParseB: (v) => v is num,) : null,
  evalInterval: json['eval_interval'] != null ? OneOf2.parse(json['eval_interval'], fromA: (v) => FineTuneReinforcementHyperparametersEvalIntervalVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  evalSamples: json['eval_samples'] != null ? OneOf2.parse(json['eval_samples'], fromA: (v) => FineTuneReinforcementHyperparametersEvalSamplesVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
); }
