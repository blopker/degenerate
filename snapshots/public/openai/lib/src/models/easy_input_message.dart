...
import 'easy_input_message_content.dart';import 'message_phase.dart';/// The role of the message input. One of `user`, `assistant`, `system`, or
/// `developer`.
/// 
...
factory EasyInputMessage.fromJson(Map<String, dynamic> json) { return EasyInputMessage(
  ...
  content: EasyInputMessageContent.fromJson(json['content']),
