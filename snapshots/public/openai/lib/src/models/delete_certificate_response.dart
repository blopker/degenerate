...
import 'delete_certificate_response_object.dart';final class DeleteCertificateResponse {const DeleteCertificateResponse({required this.object, required this.id, });
