...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'compact_response_method_public_body_input.dart';import 'model_ids_compaction.dart';import 'model_ids_responses.dart';import 'model_ids_shared.dart';import 'model_ids_shared.dart';import 'model_ids_responses.dart';final class CompactResponseMethodPublicBody {const CompactResponseMethodPublicBody({required this.model, this.input, this.previousResponseId, this.instructions, this.promptCacheKey, });
...
factory CompactResponseMethodPublicBody.fromJson(Map<String, dynamic> json) { return CompactResponseMethodPublicBody(
  ...
  input: json['input'] != null ? OneOf2.parse(json['input'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => InputItem.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,) : null,
