...
import 'compact_response_method_public_body_input.dart';import 'model_ids_compaction.dart';final class CompactResponseMethodPublicBody {const CompactResponseMethodPublicBody({required this.model, this.input, this.previousResponseId, this.instructions, this.promptCacheKey, });
