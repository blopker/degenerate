...
factory RealtimeSession.fromJson(Map<String, dynamic> json) { return RealtimeSession(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => RealtimeSessionModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  tracing: json['tracing'] != null ? OneOf2.parse(json['tracing'], fromA: (v) => RealtimeSessionTracingVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => TracingConfiguration.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TracingConfiguration.canParse(v),) : null,
  ...
  maxResponseOutputTokens: json['max_response_output_tokens'] != null ? OneOf2.parse(json['max_response_output_tokens'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => RealtimeSessionMaxResponseOutputTokensVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
