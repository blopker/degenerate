...
factory FineTuneSupervisedHyperparameters.fromJson(Map<String, dynamic> json) { return FineTuneSupervisedHyperparameters(
  batchSize: json['batch_size'] != null ? OneOf2.parse(json['batch_size'], fromA: (v) => FineTuneSupervisedHyperparametersBatchSizeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  learningRateMultiplier: json['learning_rate_multiplier'] != null ? OneOf2.parse(json['learning_rate_multiplier'], fromA: (v) => FineTuneSupervisedHyperparametersLearningRateMultiplierVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toDouble(), canParseB: (v) => v is num,) : null,
  nEpochs: json['n_epochs'] != null ? OneOf2.parse(json['n_epochs'], fromA: (v) => FineTuneSupervisedHyperparametersNEpochsVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
); }
