...
import 'package:collection/collection.dart';import 'project.dart';import 'project_list_response_object.dart';final class ProjectListResponse {const ProjectListResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
