...
static const RealtimeServerEventResponseFunctionCallArgumentsDeltaType responseFunctionCallArgumentsDelta = RealtimeServerEventResponseFunctionCallArgumentsDeltaType._('response.function_call_arguments.delta');

static const List<RealtimeServerEventResponseFunctionCallArgumentsDeltaType> values = [responseFunctionCallArgumentsDelta];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is RealtimeServerEventResponseFunctionCallArgumentsDeltaType && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'RealtimeServerEventResponseFunctionCallArgumentsDeltaType($value)'; } 
 }
...
factory RealtimeServerEventResponseFunctionCallArgumentsDelta.fromJson(Map<String, dynamic> json) { return RealtimeServerEventResponseFunctionCallArgumentsDelta(
  ...
  type: RealtimeServerEventResponseFunctionCallArgumentsDeltaType.fromJson(json['type'] as String),
...
RealtimeServerEventResponseFunctionCallArgumentsDelta copyWith({String? eventId, RealtimeServerEventResponseFunctionCallArgumentsDeltaType? type, String? responseId, String? itemId, int? outputIndex, String? callId, String? delta, }) { return RealtimeServerEventResponseFunctionCallArgumentsDelta(
