...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class CreateTranscriptionResponseJsonLogprobs {const CreateTranscriptionResponseJsonLogprobs({this.token, this.logprob, this.bytes, });
