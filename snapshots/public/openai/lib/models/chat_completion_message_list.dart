...
/// 
@immutable final class ChatCompletionMessageList {const ChatCompletionMessageList({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
