...
ResponseFileSearchCallCompletedEvent copyWith({String? type, int? outputIndex, String? itemId, int? sequenceNumber, }) {return ResponseFileSearchCallCompletedEvent(
  type: type ?? this.type,
