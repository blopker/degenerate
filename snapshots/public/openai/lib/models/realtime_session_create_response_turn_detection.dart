...
/// 
@immutable final class RealtimeSessionCreateResponseTurnDetection {const RealtimeSessionCreateResponseTurnDetection({this.type, this.threshold, this.prefixPaddingMs, this.silenceDurationMs, });

factory RealtimeSessionCreateResponseTurnDetection.fromJson(Map<String, dynamic> json) { return RealtimeSessionCreateResponseTurnDetection(
...
RealtimeSessionCreateResponseTurnDetection copyWith({String Function()? type, double Function()? threshold, int Function()? prefixPaddingMs, int Function()? silenceDurationMs, }) { return RealtimeSessionCreateResponseTurnDetection(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RealtimeSessionCreateResponseTurnDetection &&
          type == other.type &&
...
@override String toString() { return 'RealtimeSessionCreateResponseTurnDetection(type: $type, threshold: $threshold, prefixPaddingMs: $prefixPaddingMs, silenceDurationMs: $silenceDurationMs)'; } 
 }
