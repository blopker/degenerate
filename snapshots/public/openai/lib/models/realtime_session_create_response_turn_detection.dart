...
/// 
final class RealtimeSessionCreateResponseTurnDetection {const RealtimeSessionCreateResponseTurnDetection({this.type, this.threshold, this.prefixPaddingMs, this.silenceDurationMs, });
