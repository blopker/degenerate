...
@immutable final class ToolSearchCall {const ToolSearchCall({required this.type, required this.id, required this.callId, required this.execution, required this.arguments, required this.status, this.createdBy, });
