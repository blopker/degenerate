...
import 'package:collection/collection.dart';import 'realtime_conversation_item_with_reference_content.dart';/// The type of the item (`message`, `function_call`, `function_call_output`, `item_reference`).
/// 
