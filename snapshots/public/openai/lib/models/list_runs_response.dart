...
import 'package:collection/collection.dart';import 'run_object.dart';final class ListRunsResponse {const ListRunsResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
