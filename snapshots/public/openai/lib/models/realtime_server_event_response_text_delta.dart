...
static const RealtimeServerEventResponseTextDeltaType responseOutputTextDelta = RealtimeServerEventResponseTextDeltaType._('response.output_text.delta');

static const List<RealtimeServerEventResponseTextDeltaType> values = [responseOutputTextDelta];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is RealtimeServerEventResponseTextDeltaType && other.value == value; } 
...
factory RealtimeServerEventResponseTextDelta.fromJson(Map<String, dynamic> json) { return RealtimeServerEventResponseTextDelta(
  ...
  type: RealtimeServerEventResponseTextDeltaType.fromJson(json['type'] as String),
...
/// The event type, must be `response.output_text.delta`.
final RealtimeServerEventResponseTextDeltaType type;
...
RealtimeServerEventResponseTextDelta copyWith({String? eventId, RealtimeServerEventResponseTextDeltaType? type, String? responseId, String? itemId, int? outputIndex, int? contentIndex, String? delta, }) { return RealtimeServerEventResponseTextDelta(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RealtimeServerEventResponseTextDelta &&
...
@override String toString() { return 'RealtimeServerEventResponseTextDelta(eventId: $eventId, type: $type, responseId: $responseId, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, delta: $delta)'; } 
 }
