...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'chat_completion_message_tool_calls2.dart';import 'chat_completion_response_message_annotations.dart';import 'chat_completion_response_message_audio.dart';import 'chat_completion_response_message_function_call.dart';/// The role of the author of this message.
...
@immutable final class ChatCompletionResponseMessage {const ChatCompletionResponseMessage({required this.content, required this.refusal, required this.role, this.toolCalls, this.annotations, this.functionCall, this.audio = const Omittable.absent(), });
...
factory ChatCompletionResponseMessage.fromJson(Map<String, dynamic> json) { return ChatCompletionResponseMessage(
  ...
  audio: json.containsKey('audio') ? Omittable(json['audio'] != null ? ChatCompletionResponseMessageAudio.fromJson(json['audio'] as Map<String, dynamic>) : null) : const Omittable.absent(),
); }
...
/// 
final Omittable<ChatCompletionResponseMessageAudio?> audio;
