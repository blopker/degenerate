...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'audio_transcription.dart';import 'realtime_audio_formats.dart';import 'realtime_session_create_response_audio_input_noise_reduction.dart';import 'realtime_session_create_response_audio_input_turn_detection.dart';@immutable final class RealtimeSessionCreateResponseAudioInput {const RealtimeSessionCreateResponseAudioInput({this.format, this.transcription, this.noiseReduction, this.turnDetection, });
