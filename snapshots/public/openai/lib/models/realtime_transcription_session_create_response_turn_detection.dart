...
/// 
@immutable final class RealtimeTranscriptionSessionCreateResponseTurnDetection {const RealtimeTranscriptionSessionCreateResponseTurnDetection({this.type, this.threshold, this.prefixPaddingMs, this.silenceDurationMs, });

factory RealtimeTranscriptionSessionCreateResponseTurnDetection.fromJson(Map<String, dynamic> json) { return RealtimeTranscriptionSessionCreateResponseTurnDetection(
...
RealtimeTranscriptionSessionCreateResponseTurnDetection copyWith({String Function()? type, double Function()? threshold, int Function()? prefixPaddingMs, int Function()? silenceDurationMs, }) { return RealtimeTranscriptionSessionCreateResponseTurnDetection(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RealtimeTranscriptionSessionCreateResponseTurnDetection &&
          type == other.type &&
...
@override String toString() { return 'RealtimeTranscriptionSessionCreateResponseTurnDetection(type: $type, threshold: $threshold, prefixPaddingMs: $prefixPaddingMs, silenceDurationMs: $silenceDurationMs)'; } 
 }
