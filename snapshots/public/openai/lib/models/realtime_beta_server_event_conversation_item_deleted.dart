...
/// 
final class RealtimeBetaServerEventConversationItemDeleted {const RealtimeBetaServerEventConversationItemDeleted({required this.eventId, required this.type, required this.itemId, });
