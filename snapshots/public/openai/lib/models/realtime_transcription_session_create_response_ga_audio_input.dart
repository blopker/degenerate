...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'audio_transcription.dart';import 'pcm_audio_format.dart';import 'pcma_audio_format.dart';import 'pcmu_audio_format.dart';import 'realtime_audio_formats.dart';import 'realtime_transcription_session_create_response_ga_audio_input_noise_reduction.dart';import 'realtime_transcription_session_create_response_ga_audio_input_turn_detection.dart';final class RealtimeTranscriptionSessionCreateResponseGaAudioInput {const RealtimeTranscriptionSessionCreateResponseGaAudioInput({this.format, this.transcription, this.noiseReduction, this.turnDetection, });
...
/// 
final RealtimeTranscriptionSessionCreateResponseGaAudioInputNoiseReduction? noiseReduction;
