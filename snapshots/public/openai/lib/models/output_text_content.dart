...
@immutable final class OutputTextContent {const OutputTextContent({required this.type, required this.text, required this.annotations, required this.logprobs, });
