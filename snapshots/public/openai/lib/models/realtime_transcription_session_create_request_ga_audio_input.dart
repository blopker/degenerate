...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'audio_transcription.dart';import 'pcm_audio_format.dart';import 'pcma_audio_format.dart';import 'pcmu_audio_format.dart';import 'realtime_audio_formats.dart';import 'realtime_transcription_session_create_request_ga_audio_input_noise_reduction.dart';import 'realtime_turn_detection.dart';@immutable final class RealtimeTranscriptionSessionCreateRequestGaAudioInput {const RealtimeTranscriptionSessionCreateRequestGaAudioInput({this.format, this.transcription, this.noiseReduction, this.turnDetection, });
...
/// 
final RealtimeTranscriptionSessionCreateRequestGaAudioInputNoiseReduction? noiseReduction;
...
RealtimeTranscriptionSessionCreateRequestGaAudioInput copyWith({RealtimeAudioFormats Function()? format, AudioTranscription Function()? transcription, RealtimeTranscriptionSessionCreateRequestGaAudioInputNoiseReduction Function()? noiseReduction, RealtimeTurnDetection Function()? turnDetection, }) { return RealtimeTranscriptionSessionCreateRequestGaAudioInput(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RealtimeTranscriptionSessionCreateRequestGaAudioInput &&
          format == other.format &&
...
@override String toString() { return 'RealtimeTranscriptionSessionCreateRequestGaAudioInput(format: $format, transcription: $transcription, noiseReduction: $noiseReduction, turnDetection: $turnDetection)'; } 
 }
