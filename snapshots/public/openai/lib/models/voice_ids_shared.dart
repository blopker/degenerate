...
final class VoiceIdsShared {
  const VoiceIdsShared({this.string = const Omittable.absent(),
this.voiceIdsSharedVariant2 = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const VoiceIdsShared._({required this.rawValue, required this.string,
required this.voiceIdsSharedVariant2,});
  factory VoiceIdsShared.fromJson(Object? json) => VoiceIdsShared._(
    rawValue: Omittable(json),
    string: parseAnyOfVariant<String>(json, (value) => value! as String),
voiceIdsSharedVariant2: parseAnyOfVariant<VoiceIdsSharedVariant2>(json, (value) => VoiceIdsSharedVariant2.fromJson(value! as String)),
  );

  /// Original wire value when decoded. Typed views do not replace this payload.
  final Omittable<Object?> rawValue;
  final Omittable<String> string;
final Omittable<VoiceIdsSharedVariant2> voiceIdsSharedVariant2;

  /// Whether at least one known variant matched.
  bool get isValid => string.isPresent || voiceIdsSharedVariant2.isPresent;
  bool get isUnknown => rawValue.isPresent && !isValid;

  /// Decoded values round-trip exactly; constructed views must agree.
  Object? toJson() => rawValue.isPresent ? rawValue.value : mergeAnyOf([
    if (string.isPresent) string.value,
if (voiceIdsSharedVariant2.isPresent) voiceIdsSharedVariant2.value?.toJson(),
  ]);

  @override
  bool operator ==(Object other) => identical(this, other) ||
      other is VoiceIdsShared && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'VoiceIdsShared(${toJson()})';
}
