...
@immutable final class DeletedSkillVersionResource {const DeletedSkillVersionResource({required this.object, required this.deleted, required this.id, required this.version, });
