...
@immutable final class InputImageContent {const InputImageContent({required this.type, required this.detail, this.imageUrl = const Omittable.absent(), this.fileId = const Omittable.absent(), });
