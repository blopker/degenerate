...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'compact_response_method_public_body_input.dart';import 'input_item.dart';import 'model_ids_compaction.dart';@immutable final class CompactResponseMethodPublicBody {const CompactResponseMethodPublicBody({required this.model, this.input = const Omittable.absent(), this.previousResponseId = const Omittable.absent(), this.instructions = const Omittable.absent(), this.promptCacheKey = const Omittable.absent(), });

factory CompactResponseMethodPublicBody.fromJson(Map<String, dynamic> json) {return CompactResponseMethodPublicBody(
  model: json['model'] != null ? ModelIdsCompaction.fromJson(json['model']) : null,
...
CompactResponseMethodPublicBody copyWith({ModelIdsCompaction? Function()? model, Omittable<CompactResponseMethodPublicBodyInput?>? input, Omittable<String?>? previousResponseId, Omittable<String?>? instructions, Omittable<String?>? promptCacheKey, }) {return CompactResponseMethodPublicBody(
