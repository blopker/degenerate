...
/// 
@immutable final class TracingConfiguration4 {const TracingConfiguration4({this.workflowName, this.groupId, this.metadata, });

factory TracingConfiguration4.fromJson(Map<String, dynamic> json) { return TracingConfiguration4(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is TracingConfiguration4 &&
          workflowName == other.workflowName &&
          groupId == other.groupId &&
          metadata == other.metadata; } 
@override int get hashCode { return Object.hash(workflowName, groupId, metadata); } 
@override String toString() { return 'TracingConfiguration4(workflowName: $workflowName, groupId: $groupId, metadata: $metadata)'; } 
 }
