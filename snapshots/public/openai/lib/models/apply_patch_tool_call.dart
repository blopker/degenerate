...
@immutable final class ApplyPatchToolCall {const ApplyPatchToolCall({required this.type, required this.id, required this.callId, required this.status, required this.operation, this.createdBy, });
