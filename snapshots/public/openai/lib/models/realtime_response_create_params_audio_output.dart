...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pcm_audio_format.dart';import 'pcma_audio_format.dart';import 'pcmu_audio_format.dart';import 'realtime_audio_formats.dart';import 'voice_ids_or_custom_voice.dart';import 'voice_ids_or_custom_voice_variant2.dart';import 'voice_ids_shared.dart';@immutable final class RealtimeResponseCreateParamsAudioOutput {const RealtimeResponseCreateParamsAudioOutput({this.format, this.voice, });
