...
@immutable final class AuditLogCheckpointPermissionCreatedData {const AuditLogCheckpointPermissionCreatedData({this.projectId, this.fineTunedModelCheckpoint, });
