...
EvalRunPerModelUsage copyWith({String? modelName, int? invocationCount, int? promptTokens, int? completionTokens, int? totalTokens, int? cachedTokens, }) { return EvalRunPerModelUsage(
...
@override String toString() { return 'EvalRunPerModelUsage(modelName: $modelName, invocationCount: $invocationCount, promptTokens: $promptTokens, completionTokens: $completionTokens, totalTokens: $totalTokens, cachedTokens: $cachedTokens)'; } 
 }
