...
factory RealtimeServerEventResponseContentPartDone.fromJson(Map<String, dynamic> json) { return RealtimeServerEventResponseContentPartDone(
  ...
  $part: RealtimeServerEventResponseContentPartDonePart.fromJson(json['part'] as Map<String, dynamic>),
); }
...
final RealtimeServerEventResponseContentPartDonePart $part;
...
@override String toString() { return 'RealtimeServerEventResponseContentPartDone(eventId: $eventId, type: $type, responseId: $responseId, itemId: $itemId, outputIndex: $outputIndex, contentIndex: $contentIndex, \$part: ${$part})'; } 
 }
