...
/// 
@immutable
final class ModifyAssistantRequestModel {
  const ModifyAssistantRequestModel({this.string = const Omittable.absent(),
this.assistantSupportedModels = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ModifyAssistantRequestModel._({required this.rawValue, required this.string,
required this.assistantSupportedModels,});
  factory ModifyAssistantRequestModel.fromJson(Object? json) => ModifyAssistantRequestModel._(
...
if (assistantSupportedModels.isPresent) assistantSupportedModels.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ModifyAssistantRequestModel && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ModifyAssistantRequestModel(${toJson()})';
}
