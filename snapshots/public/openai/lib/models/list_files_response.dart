...
import 'package:collection/collection.dart';import 'open_ai_file.dart';final class ListFilesResponse {const ListFilesResponse({required this.object, required this.data, required this.firstId, required this.lastId, required this.hasMore, });
