...
import 'realtime_beta_response_usage_input_token_details.dart';import 'realtime_beta_response_usage_output_token_details.dart';/// Usage statistics for the Response, this will correspond to billing. A
/// Realtime API session will maintain a conversation context and append new
/// Items to the Conversation, thus output from previous turns (text and
/// audio tokens) will become the input for later turns.
/// 
final class RealtimeBetaResponseUsage {const RealtimeBetaResponseUsage({this.totalTokens, this.inputTokens, this.outputTokens, this.inputTokenDetails, this.outputTokenDetails, });
...
factory RealtimeBetaResponseUsage.fromJson(Map<String, dynamic> json) { return RealtimeBetaResponseUsage(
  ...
  inputTokenDetails: json['input_token_details'] != null ? RealtimeBetaResponseUsageInputTokenDetails.fromJson(json['input_token_details'] as Map<String, dynamic>) : null,
  outputTokenDetails: json['output_token_details'] != null ? RealtimeBetaResponseUsageOutputTokenDetails.fromJson(json['output_token_details'] as Map<String, dynamic>) : null,
); }
...
final RealtimeBetaResponseUsageInputTokenDetails? inputTokenDetails;

/// Details about the output tokens used in the Response.
final RealtimeBetaResponseUsageOutputTokenDetails? outputTokenDetails;
