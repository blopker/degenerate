...
@immutable final class ApplyPatchToolCallItemParam {const ApplyPatchToolCallItemParam({required this.callId, required this.status, required this.operation, this.type = 'apply_patch_call', this.id = const Omittable.absent(), });
...
ApplyPatchToolCallItemParam copyWith({String? type, Omittable<String?>? id, String? callId, ApplyPatchCallStatus? status, ApplyPatchOperationParam? operation, }) { return ApplyPatchToolCallItemParam(
  type: type ?? this.type,
  id: id ?? this.id,
