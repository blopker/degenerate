...
import 'realtime_beta_server_event_error_error.dart';/// The event type, must be `error`.
final class RealtimeBetaServerEventErrorType {const RealtimeBetaServerEventErrorType._(this.value);
