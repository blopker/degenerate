...
@immutable final class ListFineTuningCheckpointPermissionResponse {const ListFineTuningCheckpointPermissionResponse({required this.data, required this.object, required this.hasMore, this.firstId = const Omittable.absent(), this.lastId = const Omittable.absent(), });
...
ListFineTuningCheckpointPermissionResponse copyWith({List<FineTuningCheckpointPermission>? data, ListFineTuningCheckpointPermissionResponseObject? object, Omittable<String?>? firstId, Omittable<String?>? lastId, bool? hasMore, }) { return ListFineTuningCheckpointPermissionResponse(
  data: data ?? this.data,
...
@override String toString() { return 'ListFineTuningCheckpointPermissionResponse(data: $data, object: $object, firstId: $firstId, lastId: $lastId, hasMore: $hasMore)'; } 
 }
