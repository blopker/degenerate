...
/// 
final class RealtimeSessionCreateRequestTurnDetection {const RealtimeSessionCreateRequestTurnDetection({this.type, this.threshold, this.prefixPaddingMs, this.silenceDurationMs, });
