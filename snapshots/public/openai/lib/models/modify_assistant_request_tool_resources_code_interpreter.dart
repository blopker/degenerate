...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ModifyAssistantRequestToolResourcesCodeInterpreter {const ModifyAssistantRequestToolResourcesCodeInterpreter({this.fileIds = const []});
