...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'audio_transcription_model.dart';final class AudioTranscription {const AudioTranscription({this.model, this.language, this.prompt, });
