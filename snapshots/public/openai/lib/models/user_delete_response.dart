...
final class UserDeleteResponseObject {const UserDeleteResponseObject._(this.value);
...
final class UserDeleteResponse {const UserDeleteResponse({required this.object, required this.id, required this.deleted, });
