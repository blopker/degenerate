...
return  json['result'] != null ? IntelPassiveDnsByIp.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  PassiveDnsByIpGetPassiveDnsByIpResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
