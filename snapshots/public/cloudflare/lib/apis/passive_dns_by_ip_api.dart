...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/intel_components_schemas_single_response.dart';import '../models/intel_identifier.dart';import '../models/intel_passive_dns_by_ip.dart';import '../models/intel_start_end_params.dart';/// PassiveDnsByIpApi operations.
///
...
Future<ApiResult<IntelPassiveDnsByIp?, IntelComponentsSchemasSingleResponse>> passiveDnsByIpGetPassiveDnsByIp({required IntelIdentifier accountId, IntelStartEndParams? startEndParams, String? ipv4, double? page, double? perPage, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
