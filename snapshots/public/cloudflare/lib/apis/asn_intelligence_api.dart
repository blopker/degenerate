...
return  json['result'] != null ? IntelAsn.fromJson(json['result'] as num) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AsnIntelligenceGetAsnOverviewResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Get ASN Subnets
///
/// Get ASN Subnets.
...
return  AsnIntelligenceGetAsnSubnetsResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AsnIntelligenceGetAsnSubnetsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
