...
Future<ApiResult<BotManagementBotManagementResponseBodyResult?, BotManagementBotManagementResponseBody>> botManagementForAZoneGetConfig({required BotManagementIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<BotManagementBotManagementResponseBodyResult?, BotManagementBotManagementResponseBody>> botManagementForAZoneUpdateConfig({required BotManagementIdentifier zoneId, required BotManagementConfigSingle body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
