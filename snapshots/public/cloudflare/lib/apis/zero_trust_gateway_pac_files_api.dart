...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/zero_trust_gateway_components_schemas_uuid.dart';import '../models/zero_trust_gateway_pacfile.dart';import '../models/zero_trust_gateway_pacfiles_components_schemas_response_collection_result.dart';import '../models/zero_trust_gateway_pacfiles_create_pacfile_request.dart';import '../models/zero_trust_gateway_pacfiles_create_pacfile_response4xx.dart';import '../models/zero_trust_gateway_pacfiles_delete_response4xx.dart';import '../models/zero_trust_gateway_pacfiles_details_response4xx.dart';import '../models/zero_trust_gateway_pacfiles_list_response4xx.dart';import '../models/zero_trust_gateway_pacfiles_update_request.dart';import '../models/zero_trust_gateway_pacfiles_update_response4xx.dart';import '../models/zero_trust_gateway_schemas_identifier.dart';/// ZeroTrustGatewayPacFilesApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => ZeroTrustGatewayPacfilesComponentsSchemasResponseCollectionResult.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayPacfilesListResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create a PAC file
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? ZeroTrustGatewayPacfile.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayPacfilesCreatePacfileResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Get a PAC file
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayPacfilesDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayPacfilesUpdateResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete a PAC file
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayPacfilesDeleteResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
