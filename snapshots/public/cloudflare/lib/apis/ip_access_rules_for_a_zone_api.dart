...
return  IpAccessRulesForAZoneListIpAccessRulesResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAccessRulesForAZoneCreateAnIpAccessRuleResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAccessRulesForAZoneUpdateAnIpAccessRuleResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAccessRulesForAZoneDeleteAnIpAccessRuleResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
