...
return  (json['result'] as List<dynamic>?)?.map((e) => DnsFirewallDnsFirewallClusterResponse.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallListDnsFirewallClustersResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? DnsFirewallDnsFirewallClusterResponse.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallCreateDnsFirewallClusterResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallDnsFirewallClusterDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallUpdateDnsFirewallClusterResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? DnsFirewallDeleteDnsFirewallClusterResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallDeleteDnsFirewallClusterResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? DnsFirewallDnsFirewallReverseDns.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallShowDnsFirewallClusterReverseDnsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsFirewallUpdateDnsFirewallClusterReverseDnsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
