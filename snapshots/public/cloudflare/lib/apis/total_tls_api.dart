...
Future<ApiResult<TlsCertificatesAndHostnamesTotalTlsSettingsResponseResult?, TlsCertificatesAndHostnamesTotalTlsSettingsResponse>> totalTlsSettingsDetails({required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
