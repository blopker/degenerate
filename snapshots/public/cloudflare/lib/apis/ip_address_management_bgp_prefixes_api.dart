...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/addressing_account_identifier.dart';import '../models/addressing_bgp_prefix_create.dart';import '../models/addressing_bgp_prefix_identifier.dart';import '../models/addressing_bgp_prefix_update_advertisement.dart';import '../models/addressing_ipam_bgp_prefixes.dart';import '../models/addressing_prefix_identifier.dart';import '../models/ip_address_management_prefixes_create_bgp_prefix_response4xx.dart';import '../models/ip_address_management_prefixes_fetch_bgp_prefix_response4xx.dart';import '../models/ip_address_management_prefixes_list_bgp_prefixes_response4xx.dart';import '../models/ip_address_management_prefixes_update_bgp_prefix_response4xx.dart';import '../models/response_common4.dart';import '../models/response_common_failure5.dart';/// IpAddressManagementBgpPrefixesApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => AddressingIpamBgpPrefixes.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesListBgpPrefixesResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create BGP Prefix
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? AddressingIpamBgpPrefixes.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesCreateBgpPrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Fetch BGP Prefix
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesFetchBgpPrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update BGP Prefix
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesUpdateBgpPrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete BGP Prefix
///
