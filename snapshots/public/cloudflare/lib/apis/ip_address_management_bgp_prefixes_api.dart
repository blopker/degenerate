...
Future<ApiResult<List<AddressingIpamBgpPrefixes>?, AddressingResponseCollectionBgp>> ipAddressManagementPrefixesListBgpPrefixes({required AddressingAccountIdentifier accountId, required AddressingPrefixIdentifier prefixId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return AddressingResponseCollectionBgp.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// Create BGP Prefix
...
Future<ApiResult<AddressingIpamBgpPrefixes?, AddressingSingleResponseBgp>> ipAddressManagementPrefixesCreateBgpPrefix({required AddressingAccountIdentifier accountId, required AddressingPrefixIdentifier prefixId, required AddressingBgpPrefixCreate body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return AddressingSingleResponseBgp.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// Fetch BGP Prefix
