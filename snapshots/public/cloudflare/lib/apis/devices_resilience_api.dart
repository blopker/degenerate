...
return  TeamsDevicesGlobalWarpOverride.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure70.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
