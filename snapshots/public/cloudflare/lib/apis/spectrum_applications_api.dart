...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure67.dart';import '../models/response_single_id5_result.dart';import '../models/spectrum_applications_list_spectrum_applications_direction.dart';import '../models/spectrum_applications_list_spectrum_applications_order.dart';import '../models/spectrum_config_app_config.dart';import '../models/spectrum_config_app_config_collection_result.dart';import '../models/spectrum_config_app_config_single_result.dart';import '../models/spectrum_config_identifier.dart';import '../models/spectrum_config_paygo_app_config.dart';import '../models/spectrum_config_update_app_config_request.dart';/// SpectrumApplicationsApi operations.
///
...
return  json['result'] != null ? OneOf2.parse(json['result'], fromA: (v) => (v as List<dynamic>).map((e) => SpectrumConfigAppConfig.fromJson(e as Map<String, dynamic>)).toList(), fromB: (v) => (v as List<dynamic>).map((e) => SpectrumConfigPaygoAppConfig.fromJson(e as Map<String, dynamic>)).toList(),) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure67.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? OneOf2.parse(json['result'], fromA: (v) => SpectrumConfigAppConfig.fromJson(v as Map<String, dynamic>), fromB: (v) => SpectrumConfigPaygoAppConfig.fromJson(v as Map<String, dynamic>),) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure67.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? ResponseSingleId5Result.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure67.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
