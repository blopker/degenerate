...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/custom_origin_trust_store_create_request.dart';import '../models/tls_certificates_and_hostnames_custom_trust_store.dart';import '../models/tls_certificates_and_hostnames_custom_trust_store_response_collection.dart';import '../models/tls_certificates_and_hostnames_custom_trust_store_response_id_only_result.dart';import '../models/tls_certificates_and_hostnames_custom_trust_store_response_single.dart';import '../models/tls_certificates_and_hostnames_identifier.dart';/// CustomOriginTrustStoreApi operations.
///
...
Future<ApiResult<TlsCertificatesAndHostnamesCustomTrustStore?, TlsCertificatesAndHostnamesCustomTrustStoreResponseSingle>> customOriginTrustStoreCreate({required TlsCertificatesAndHostnamesIdentifier zoneId, required CustomOriginTrustStoreCreateRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<TlsCertificatesAndHostnamesCustomTrustStore?, TlsCertificatesAndHostnamesCustomTrustStoreResponseSingle>> customOriginTrustStoreDetails({required TlsCertificatesAndHostnamesIdentifier customOriginTrustStoreId, required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnlyResult?, TlsCertificatesAndHostnamesIdentifier>> customOriginTrustStoreDelete({required TlsCertificatesAndHostnamesIdentifier customOriginTrustStoreId, required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesIdentifier.fromJson(jsonDecode(response.body) as String);
  },
);
 } 
 }
