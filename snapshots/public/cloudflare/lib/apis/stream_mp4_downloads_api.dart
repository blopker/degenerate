...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure69.dart';import '../models/stream_download_type.dart';import '../models/stream_downloads.dart';import '../models/stream_downloads_response_result.dart';import '../models/stream_identifier.dart';import '../models/stream_schemas_identifier.dart';/// StreamMp4DownloadsApi operations.
///
...
return  json['result'] != null ? StreamDownloadsResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? StreamDownloads.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure69.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId.toString())}/stream/${Uri.encodeComponent(identifier.toString())}/downloads/${Uri.encodeComponent(downloadType.value)}',
  headers: headers,
  options: options,
);
