...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure7.dart';import '../models/shield_identifier.dart';import '../models/shield_request_expression_templates_fallthrough.dart';import '../models/shield_response_expression_templates_fallthrough.dart';/// ShieldWafExpressionTemplatesApi operations.
///
...
return  ShieldResponseExpressionTemplatesFallthrough.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
