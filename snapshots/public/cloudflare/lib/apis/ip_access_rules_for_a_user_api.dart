...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/firewall_rule.dart';import '../models/firewall_rule_collection_response.dart';import '../models/firewall_rule_identifier.dart';import '../models/firewall_rule_single_id_response.dart';import '../models/firewall_rule_single_id_response_result.dart';import '../models/firewall_rule_single_response.dart';import '../models/firewall_schemas_mode.dart';import '../models/ip_access_rules_for_a_user_create_an_ip_access_rule_request.dart';import '../models/ip_access_rules_for_a_user_list_ip_access_rules_configuration_target.dart';import '../models/ip_access_rules_for_a_user_list_ip_access_rules_direction.dart';import '../models/ip_access_rules_for_a_user_list_ip_access_rules_match.dart';import '../models/ip_access_rules_for_a_user_list_ip_access_rules_order.dart';import '../models/ip_access_rules_for_a_user_update_an_ip_access_rule_request.dart';/// IpAccessRulesForAUserApi operations.
///
...
Future<ApiResult<FirewallRule?, FirewallRuleSingleResponse>> ipAccessRulesForAUserCreateAnIpAccessRule({required IpAccessRulesForAUserCreateAnIpAccessRuleRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<FirewallRule?, FirewallRuleSingleResponse>> ipAccessRulesForAUserUpdateAnIpAccessRule({required FirewallRuleIdentifier ruleId, required IpAccessRulesForAUserUpdateAnIpAccessRuleRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<FirewallRuleSingleIdResponseResult?, FirewallRuleSingleIdResponse>> ipAccessRulesForAUserDeleteAnIpAccessRule({required FirewallRuleIdentifier ruleId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
