...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/addressing_account_identifier.dart';import '../models/addressing_address_map_identifier.dart';import '../models/addressing_address_maps.dart';import '../models/addressing_full_response_result.dart';import '../models/addressing_ip_address.dart';import '../models/addressing_zone_identifier.dart';import '../models/ip_address_management_address_maps_add_a_zone_membership_to_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_add_an_account_membership_to_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_add_an_ip_to_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_address_map_details_response4_xx.dart';import '../models/ip_address_management_address_maps_create_address_map_request.dart';import '../models/ip_address_management_address_maps_create_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_delete_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_list_address_maps_response4_xx.dart';import '../models/ip_address_management_address_maps_remove_a_zone_membership_from_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_remove_an_account_membership_from_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_remove_an_ip_from_an_address_map_response4_xx.dart';import '../models/ip_address_management_address_maps_update_address_map_request.dart';import '../models/ip_address_management_address_maps_update_address_map_response4_xx.dart';import '../models/response_collection4.dart';/// IpAddressManagementAddressMapsApi operations.
///
...
return IpAddressManagementAddressMapsListAddressMapsResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsCreateAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsAddressMapDetailsResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsUpdateAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
return await execute(
  ...
  onSuccess: (response) {
final json = jsonDecode(response.body);
return ResponseCollection4.fromJson(json as Map<String, dynamic>);
  },
  onError: (response) {
switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsDeleteAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsAddAnAccountMembershipToAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsRemoveAnAccountMembershipFromAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsAddAnIpToAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsRemoveAnIpFromAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return IpAddressManagementAddressMapsRemoveAZoneMembershipFromAnAddressMapResponse4Xx.fromJson(json as Map<String, dynamic>);
default:
return null;
}
