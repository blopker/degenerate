...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/per_hostname_authenticated_origin_pull_enable_or_disable_a_hostname_for_client_authentication_request.dart';import '../models/per_hostname_authenticated_origin_pull_upload_a_hostname_client_certificate_request.dart';import '../models/tls_certificates_and_hostnames_hostname_aop_response_collection.dart';import '../models/tls_certificates_and_hostnames_hostname_aop_single_response.dart';import '../models/tls_certificates_and_hostnames_hostname_authenticated_origin_pull.dart';import '../models/tls_certificates_and_hostnames_hostname_authenticated_origin_pull_components_schemas_certificate_response_collection.dart';import '../models/tls_certificates_and_hostnames_hostname_authenticated_origin_pull_components_schemas_certificate_response_single.dart';import '../models/tls_certificates_and_hostnames_hostname_certid_object.dart';import '../models/tls_certificates_and_hostnames_identifier.dart';import '../models/tls_certificates_and_hostnames_schemas_certificate_object.dart';import '../models/tls_certificates_and_hostnames_schemas_hostname.dart';/// PerHostnameAuthenticatedOriginPullApi operations.
///
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesHostnameAopResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesHostnameCertidObject?, TlsCertificatesAndHostnamesHostnameAopSingleResponse>> perHostnameAuthenticatedOriginPullGetTheHostnameStatusForClientAuthentication({required TlsCertificatesAndHostnamesSchemasHostname hostname, required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesHostnameAopSingleResponse.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// List Certificates
...
Future<ApiResult<List<TlsCertificatesAndHostnamesSchemasCertificateObject>?, TlsCertificatesAndHostnamesHostnameAuthenticatedOriginPullComponentsSchemasCertificateResponseCollection>> perHostnameAuthenticatedOriginPullListCertificates({required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesHostnameAuthenticatedOriginPullComponentsSchemasCertificateResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesSchemasCertificateObject?, TlsCertificatesAndHostnamesHostnameAuthenticatedOriginPullComponentsSchemasCertificateResponseSingle>> perHostnameAuthenticatedOriginPullUploadAHostnameClientCertificate({required TlsCertificatesAndHostnamesIdentifier zoneId, required PerHostnameAuthenticatedOriginPullUploadAHostnameClientCertificateRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesHostnameAuthenticatedOriginPullComponentsSchemasCertificateResponseSingle.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
