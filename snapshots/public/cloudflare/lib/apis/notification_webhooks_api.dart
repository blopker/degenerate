...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/aaa_account_id.dart';import '../models/aaa_id_response_result.dart';import '../models/aaa_webhook_id.dart';import '../models/aaa_webhooks_response.dart';import '../models/notification_webhooks_create_a_webhook_request.dart';import '../models/notification_webhooks_create_a_webhook_response4xx.dart';import '../models/notification_webhooks_get_a_webhook_response4xx.dart';import '../models/notification_webhooks_list_webhooks_response4xx.dart';import '../models/notification_webhooks_update_a_webhook_request.dart';import '../models/notification_webhooks_update_a_webhook_response4xx.dart';import '../models/response_common2.dart';import '../models/response_common_failure2.dart';/// NotificationWebhooksApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => AaaWebhooksResponse.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  NotificationWebhooksListWebhooksResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create a webhook
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  NotificationWebhooksCreateAWebhookResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Get a webhook
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? AaaWebhooksResponse.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  NotificationWebhooksGetAWebhookResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update a webhook
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  NotificationWebhooksUpdateAWebhookResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete a webhook
///
