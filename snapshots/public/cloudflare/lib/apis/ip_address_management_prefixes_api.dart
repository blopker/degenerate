...
import 'dart:async';import 'dart:convert';import 'dart:typed_data';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/addressing_account_identifier.dart';import '../models/addressing_ipam_prefixes.dart';import '../models/addressing_loa_document_identifier.dart';import '../models/addressing_loa_upload_response_result.dart';import '../models/addressing_prefix_identifier.dart';import '../models/ip_address_management_prefixes_add_prefix_request.dart';import '../models/ip_address_management_prefixes_add_prefix_response4xx.dart';import '../models/ip_address_management_prefixes_delete_prefix_response4xx.dart';import '../models/ip_address_management_prefixes_list_prefixes_response4xx.dart';import '../models/ip_address_management_prefixes_prefix_details_response4xx.dart';import '../models/ip_address_management_prefixes_update_prefix_description_request.dart';import '../models/ip_address_management_prefixes_update_prefix_description_response4xx.dart';import '../models/ip_address_management_prefixes_upload_loa_document_request.dart';import '../models/ip_address_management_prefixes_upload_loa_document_response4xx.dart';import '../models/ip_address_management_prefixes_validate_prefix_response4xx.dart';import '../models/response_common4.dart';import '../models/response_common_failure5.dart';/// IpAddressManagementPrefixesApi operations.
///
...
return  json['result'] != null ? AddressingLoaUploadResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesUploadLoaDocumentResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure5.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// List Prefixes
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>?)?.map((e) => AddressingIpamPrefixes.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesListPrefixesResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Add Prefix
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? AddressingIpamPrefixes.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesAddPrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Prefix Details
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesPrefixDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesUpdatePrefixDescriptionResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete Prefix
///
...
return  ResponseCommon4.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesDeletePrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Validate Prefix
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  IpAddressManagementPrefixesValidatePrefixResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
