...
Future<ApiResult<List<TlsCertificatesAndHostnamesBase>?, TlsCertificatesAndHostnamesKeylessResponseCollection>> keylessSslForAZoneListKeylessSslConfigurations({required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<TlsCertificatesAndHostnamesKeylessResponseSingleIdResult?, TlsCertificatesAndHostnamesKeylessResponseSingleId>> keylessSslForAZoneDeleteKeylessSslConfiguration({required TlsCertificatesAndHostnamesIdentifier keylessCertificateId, required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
