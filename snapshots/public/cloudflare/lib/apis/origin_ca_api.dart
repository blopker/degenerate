...
///
/// `POST /certificates`
Future<ApiResult<TlsCertificatesAndHostnamesCertificates?, TlsCertificatesAndHostnamesSchemasCertificateResponseSingle>> originCaCreateCertificate({required OriginCaCreateCertificateRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<TlsCertificatesAndHostnamesCertificates?, TlsCertificatesAndHostnamesSchemasCertificateResponseSingle>> originCaGetCertificate({required TlsCertificatesAndHostnamesIdentifier certificateId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<TlsCertificatesAndHostnamesCertificateRevokeResponseResult?, TlsCertificatesAndHostnamesCertificateRevokeResponse>> originCaRevokeCertificate({required TlsCertificatesAndHostnamesIdentifier certificateId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
