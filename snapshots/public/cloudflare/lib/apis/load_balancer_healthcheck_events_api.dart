...
return  (json['result'] as List<dynamic>).map((e) => LoadBalancingAnalytics.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerHealthcheckEventsListHealthcheckEventsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
