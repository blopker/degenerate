...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/load_balancing_components_schemas_response_collection.dart';import '../models/load_balancing_origin_healthy2.dart';import '../models/load_balancing_pool_name.dart';import '../models/load_balancing_schemas_identifier.dart';import '../models/load_balancing_until.dart';/// LoadBalancerHealthcheckEventsApi operations.
///
...
return execute(
  request,
  onSuccess: (response) {
    return LoadBalancingComponentsSchemasResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
