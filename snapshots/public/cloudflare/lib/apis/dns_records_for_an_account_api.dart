...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/dns_records_dns_response_account_usage_result.dart';import '../models/dns_records_for_an_account_get_usage_response4xx.dart';import '../models/dns_records_identifier.dart';/// DnsRecordsForAnAccountApi operations.
///
...
return  json['result'] != null ? DnsRecordsDnsResponseAccountUsageResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DnsRecordsForAnAccountGetUsageResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
