...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/dns_records_dns_response_account_usage.dart';import '../models/dns_records_dns_response_account_usage_result.dart';import '../models/dns_records_identifier.dart';/// DnsRecordsForAnAccountApi operations.
///
...
Future<ApiResult<DnsRecordsDnsResponseAccountUsageResult?, DnsRecordsDnsResponseAccountUsage>> dnsRecordsForAnAccountGetUsage({required DnsRecordsIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
