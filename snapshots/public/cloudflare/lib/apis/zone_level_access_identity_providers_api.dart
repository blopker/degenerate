...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/access_id_response_result.dart';import '../models/access_identifier.dart';import '../models/access_identity_providers_components_schemas_response_collection_result.dart';import '../models/access_schemas_identity_provider.dart';import '../models/access_schemas_identity_providers.dart';import '../models/access_uuid.dart';import '../models/response_common_failure4.dart';/// ZoneLevelAccessIdentityProvidersApi operations.
///
...
Future<ApiResult<List<AccessIdentityProvidersComponentsSchemasResponseCollectionResult>?, ResponseCommonFailure4>> zoneLevelAccessIdentityProvidersListAccessIdentityProviders({required AccessIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<AccessSchemasIdentityProviders?, ResponseCommonFailure4>> zoneLevelAccessIdentityProvidersAddAnAccessIdentityProvider({required AccessIdentifier zoneId, required AccessSchemasIdentityProviders body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<AccessSchemasIdentityProviders?, ResponseCommonFailure4>> zoneLevelAccessIdentityProvidersGetAnAccessIdentityProvider({required AccessUuid identityProviderId, required AccessIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<AccessSchemasIdentityProviders?, ResponseCommonFailure4>> zoneLevelAccessIdentityProvidersUpdateAnAccessIdentityProvider({required AccessUuid identityProviderId, required AccessIdentifier zoneId, required AccessSchemasIdentityProviders body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
