...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/argo_analytics_for_geolocation_argo_analytics_for_a_zone_at_different_po_ps_response4xx.dart';import '../models/argo_analytics_identifier.dart';/// ArgoAnalyticsForGeolocationApi operations.
///
...
return  ArgoAnalyticsForGeolocationArgoAnalyticsForAZoneAtDifferentPoPsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
