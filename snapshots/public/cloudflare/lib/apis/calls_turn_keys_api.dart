...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/calls_account_identifier.dart';import '../models/calls_identifier.dart';import '../models/calls_turn_key_editable_fields.dart';import '../models/calls_turn_key_object.dart';import '../models/calls_turn_key_with_key.dart';import '../models/response_common_failure16.dart';/// CallsTurnKeysApi operations.
///
...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure16.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
