...
Future<ApiResult<SchemaValidationCreateSchemaResponse, ResponseCommonFailure7>> schemaValidationCreateSchema({required ShieldIdentifier zoneId, required SchemaValidationCreateSchemaRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
