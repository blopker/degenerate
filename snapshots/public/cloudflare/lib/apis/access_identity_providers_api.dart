...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/access_cf_resource_id.dart';import '../models/access_email.dart';import '../models/access_groups.dart';import '../models/access_groups_name.dart';import '../models/access_id_response_result.dart';import '../models/access_identifier.dart';import '../models/access_identity_providers.dart';import '../models/access_identity_providers_request.dart';import '../models/access_idp_resource_id.dart';import '../models/access_response_collection_result.dart';import '../models/access_username.dart';import '../models/access_users.dart';import '../models/access_users_cf_resource_id.dart';import '../models/access_users_idp_resource_id.dart';import '../models/access_users_name.dart';import '../models/access_uuid.dart';import '../models/response_common_failure4.dart';/// AccessIdentityProvidersApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map(AccessResponseCollectionResult.fromJson).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? AccessIdentityProviders.fromJson(json['result']) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure4.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>?)?.map((e) => AccessGroups.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure4.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>?)?.map((e) => AccessUsers.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure4.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
