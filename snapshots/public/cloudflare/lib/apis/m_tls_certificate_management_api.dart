...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/m_tls_certificate_management_upload_m_tls_certificate_request.dart';import '../models/tls_certificates_and_hostnames_association_object.dart';import '../models/tls_certificates_and_hostnames_association_response_collection.dart';import '../models/tls_certificates_and_hostnames_certificate_object_post.dart';import '../models/tls_certificates_and_hostnames_certificate_response_single_post.dart';import '../models/tls_certificates_and_hostnames_components_schemas_certificate_object.dart';import '../models/tls_certificates_and_hostnames_identifier.dart';import '../models/tls_certificates_and_hostnames_mtls_management_components_schemas_certificate_response_collection.dart';import '../models/tls_certificates_and_hostnames_mtls_management_components_schemas_certificate_response_single.dart';/// MTlsCertificateManagementApi operations.
///
...
Future<ApiResult<List<TlsCertificatesAndHostnamesComponentsSchemasCertificateObject>?, TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseCollection>> mTlsCertificateManagementListMTlsCertificates({required TlsCertificatesAndHostnamesIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesCertificateResponseSinglePost.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseSingle.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesComponentsSchemasCertificateObject?, TlsCertificatesAndHostnamesMtlsManagementComponentsSchemasCertificateResponseSingle>> mTlsCertificateManagementDeleteMTlsCertificate({required TlsCertificatesAndHostnamesIdentifier mtlsCertificateId, required TlsCertificatesAndHostnamesIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesAssociationResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
