...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/client_certificate_for_a_zone_create_client_certificate_request.dart';import '../models/client_certificate_for_a_zone_edit_client_certificate_request.dart';import '../models/response_common_failure71.dart';import '../models/tls_certificates_and_hostnames_client_certificate.dart';import '../models/tls_certificates_and_hostnames_client_certificate_response_single.dart';import '../models/tls_certificates_and_hostnames_hostname_association.dart';import '../models/tls_certificates_and_hostnames_hostname_associations_response_result.dart';import '../models/tls_certificates_and_hostnames_identifier.dart';/// ShieldClientCertificatesForAZoneApi operations.
///
...
Future<ApiResult<TlsCertificatesAndHostnamesHostnameAssociationsResponseResult?, ResponseCommonFailure71>> clientCertificateForAZoneListHostnameAssociations({required TlsCertificatesAndHostnamesIdentifier zoneId, String? mtlsCertificateId, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure71.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<List<TlsCertificatesAndHostnamesClientCertificate>?, ResponseCommonFailure71>> clientCertificateForAZoneListClientCertificates({required TlsCertificatesAndHostnamesIdentifier zoneId, dynamic status, double? page, double? perPage, int? limit, int? offset, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (status != null) {
...
Future<ApiResult<TlsCertificatesAndHostnamesClientCertificate?, TlsCertificatesAndHostnamesClientCertificateResponseSingle>> clientCertificateForAZoneCreateClientCertificate({required TlsCertificatesAndHostnamesIdentifier zoneId, required ClientCertificateForAZoneCreateClientCertificateRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<TlsCertificatesAndHostnamesClientCertificate?, ResponseCommonFailure71>> clientCertificateForAZoneEditClientCertificate({required TlsCertificatesAndHostnamesIdentifier zoneId, required TlsCertificatesAndHostnamesIdentifier clientCertificateId, required ClientCertificateForAZoneEditClientCertificateRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<TlsCertificatesAndHostnamesClientCertificate?, ResponseCommonFailure71>> clientCertificateForAZoneDeleteClientCertificate({required TlsCertificatesAndHostnamesIdentifier zoneId, required TlsCertificatesAndHostnamesIdentifier clientCertificateId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
