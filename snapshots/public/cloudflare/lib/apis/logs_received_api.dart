...
return ResponseCommonFailure44.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
return await execute(
  ...
  onSuccess: (response) {
final json = jsonDecode(response.body);
return LogshareLogsResponseJsonLines.fromJson(json);
  },
  onError: (response) {
switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return ResponseCommonFailure46.fromJson(json as Map<String, dynamic>);
default:
return null;
}
...
return await execute(
  ...
  onSuccess: (response) {
final json = jsonDecode(response.body);
return LogshareFieldsResponse.fromJson(json as Map<String, dynamic>);
  },
  onError: (response) {
switch (response.statusCode) {
case >= 400 && < 500:
