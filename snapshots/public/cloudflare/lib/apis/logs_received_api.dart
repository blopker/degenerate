...
Future<ApiResult<LogcontrolRetentionFlag?, ResponseCommonFailure44>> getZonesZoneIdLogsControlRetentionFlag({required LogcontrolIdentifier zoneId, RequestOptions? options, }) async {final headers = <String, String>{...apiConfig.defaultHeaders};
...
return  json['result'] != null ? LogcontrolRetentionFlag.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure44.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
Future<ApiResult<LogcontrolRetentionFlag?, ResponseCommonFailure44>> postZonesZoneIdLogsControlRetentionFlag({required LogcontrolIdentifier zoneId, required LogcontrolRetentionFlag? body, RequestOptions? options, }) async {final headers = <String, String>{...apiConfig.defaultHeaders};
...
return  LogshareLogsResponseJsonLines.fromJson(json);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure46.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Get logs received
///
...
Future<ApiResult<LogshareFieldsResponse, ResponseCommonFailure46>> getZonesZoneIdLogsReceivedFields({required LogshareIdentifier zoneId, RequestOptions? options, }) async {final headers = <String, String>{...apiConfig.defaultHeaders};
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  LogshareFieldsResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure46.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
