...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/access_access_requests.dart';import '../models/access_components_schemas_email.dart';import '../models/access_identifier.dart';import '../models/access_user_id.dart';import '../models/response_common_failure4.dart';/// AccessAuthenticationLogsApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => AccessAccessRequests.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
