...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/brapi_post_content_error.dart';import '../models/brapi_post_content_request.dart';import '../models/brapi_post_json_error.dart';import '../models/brapi_post_json_request.dart';import '../models/brapi_post_links_error.dart';import '../models/brapi_post_links_request.dart';import '../models/brapi_post_markdown_error.dart';import '../models/brapi_post_markdown_request.dart';import '../models/brapi_post_pdf_error.dart';import '../models/brapi_post_pdf_request.dart';import '../models/brapi_post_scrape_error.dart';import '../models/brapi_post_scrape_request.dart';import '../models/brapi_post_scrape_response_result.dart';import '../models/brapi_post_screenshot_error.dart';import '../models/brapi_post_screenshot_request.dart';import '../models/brapi_post_screenshot_success.dart';import '../models/brapi_post_snapshot_error.dart';import '../models/brapi_post_snapshot_request.dart';import '../models/brapi_post_snapshot_response_result.dart';/// BrapiApi operations.
///
...
return  json['result'] as String?;}, onError: BrapiPostContentError.parse, );}
/// Get json.
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as Map<String, dynamic>?));}, onError: BrapiPostJsonError.parse, );}
/// Get Links.
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>).map((e) => e as String).toList();}, onError: BrapiPostLinksError.parse, );}
/// Get markdown.
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] as String?;}, onError: BrapiPostMarkdownError.parse, );}
/// Get PDF.
///
...
return   await execute(request, onSuccess: (response) {return  response.body;}, onError: BrapiPostPdfError.parse, );}
/// Scrape elements.
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>).map((e) => BrapiPostScrapeResponseResult.fromJson(e as Map<String, dynamic>)).toList();}, onError: BrapiPostScrapeError.parse, );}
/// Get screenshot.
///
...
return   await execute(request, onSuccess: BrapiPostScreenshotSuccess.parse, onError: BrapiPostScreenshotError.parse, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? BrapiPostSnapshotResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: BrapiPostSnapshotError.parse, );}
}
