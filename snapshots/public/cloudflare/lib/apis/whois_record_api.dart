...
return  json['result'] != null ? CloudforceOneWhoisWhois.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  WhoisRecordGetWhoisRecordResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
