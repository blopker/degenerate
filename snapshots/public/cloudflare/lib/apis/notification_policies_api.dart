...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/aaa_account_id.dart';import '../models/aaa_id_response.dart';import '../models/aaa_id_response_result.dart';import '../models/aaa_policies.dart';import '../models/aaa_policy_id.dart';import '../models/aaa_single_response.dart';import '../models/notification_policies_create_a_notification_policy_request.dart';import '../models/notification_policies_update_a_notification_policy_request.dart';import '../models/response_collection.dart';import '../models/response_common_failure2.dart';/// NotificationPoliciesApi operations.
///
...
Future<ApiResult<AaaIdResponseResult?, AaaIdResponse>> notificationPoliciesCreateANotificationPolicy({required AaaAccountId accountId, required NotificationPoliciesCreateANotificationPolicyRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<AaaPolicies?, AaaSingleResponse>> notificationPoliciesGetANotificationPolicy({required AaaAccountId accountId, required AaaPolicyId policyId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCollection, ResponseCollection>> notificationPoliciesDeleteANotificationPolicy({required AaaAccountId accountId, required AaaPolicyId policyId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
