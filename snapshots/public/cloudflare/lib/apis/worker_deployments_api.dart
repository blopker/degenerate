...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common80.dart';import '../models/response_common_failure82.dart';import '../models/worker_deployments_list_deployments_response_result.dart';import '../models/workers_deployment.dart';import '../models/workers_identifier.dart';import '../models/workers_script_name.dart';/// WorkerDeploymentsApi operations.
///
...
Future<ApiResult<WorkersDeployment, ResponseCommonFailure82>> workerDeploymentsCreateDeployment({required WorkersIdentifier accountId, required WorkersScriptName scriptName, required WorkersDeployment body, bool? force, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
