...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common80.dart';import '../models/response_common_failure82.dart';import '../models/worker_deployments_list_deployments_response_result.dart';import '../models/workers_deployment.dart';import '../models/workers_deployment_request.dart';import '../models/workers_identifier.dart';import '../models/workers_script_name.dart';/// WorkerDeploymentsApi operations.
///
...
return  WorkerDeploymentsListDeploymentsResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  WorkersDeployment.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure82.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return  ResponseCommon80.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure82.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
