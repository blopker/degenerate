...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/telemetry_keys_list_error.dart';import '../models/telemetry_keys_list_request.dart';import '../models/telemetry_keys_list_response_result.dart';/// KeysApi operations.
///
...
return  (json['result'] as List<dynamic>).map((e) => TelemetryKeysListResponseResult.fromJson(e as Map<String, dynamic>)).toList();}, onError: TelemetryKeysListError.parse, );}
}
