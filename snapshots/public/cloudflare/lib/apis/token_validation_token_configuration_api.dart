...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure7.dart';import '../models/shield_credentials.dart';import '../models/shield_identifier.dart';import '../models/shield_token_configuration.dart';import '../models/shield_uuid.dart';import '../models/token_validation_config_create_request.dart';import '../models/token_validation_config_credentials_update_response.dart';import '../models/token_validation_config_delete_response_result.dart';import '../models/token_validation_config_edit_request.dart';import '../models/token_validation_config_edit_response_result.dart';/// TokenValidationTokenConfigurationApi operations.
///
...
return  (json['result'] as List<dynamic>).map((e) => ShieldTokenConfiguration.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  ShieldTokenConfiguration.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure7.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  TokenValidationConfigEditResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure7.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  TokenValidationConfigDeleteResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure7.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return  TokenValidationConfigCredentialsUpdateResponse.fromJson(json as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure7.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
