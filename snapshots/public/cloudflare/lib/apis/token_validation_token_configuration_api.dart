...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common6.dart';import '../models/response_common_failure7.dart';import '../models/shield_credentials.dart';import '../models/shield_identifier.dart';import '../models/shield_token_configuration.dart';import '../models/shield_uuid.dart';import '../models/token_validation_config_create_request.dart';import '../models/token_validation_config_delete_response_result.dart';import '../models/token_validation_config_edit_request.dart';import '../models/token_validation_config_edit_response_result.dart';/// TokenValidationTokenConfigurationApi operations.
///
...
Future<ApiResult<ResponseCommon6, ResponseCommonFailure7>> tokenValidationConfigCredentialsUpdate({required ShieldIdentifier zoneId, required ShieldUuid configId, required ShieldCredentials body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
