...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/infra_account_tag.dart';import '../models/infra_service_config.dart';import '../models/infra_service_type.dart';import '../models/response_common_failure40.dart';/// ConnectivityServicesApi operations.
///
...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure40.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<InfraServiceConfig?, ResponseCommonFailure40>> connectivityServicesPost({required InfraAccountTag accountId, required InfraServiceConfig body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<InfraServiceConfig?, ResponseCommonFailure40>> connectivityServicesPut({required String accountId, required String serviceId, required InfraServiceConfig body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
