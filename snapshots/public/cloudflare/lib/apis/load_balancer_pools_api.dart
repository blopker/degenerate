...
return  LoadBalancerPoolsListPoolsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create Pool
///
/// Create a new pool.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsCreatePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Patch Pools
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsPatchPoolsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Pool Details
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsPoolDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsUpdatePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Patch Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsPatchPoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsDeletePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Pool Health Details
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsPoolHealthDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Preview Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsPreviewPoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerPoolsListPoolReferencesResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
