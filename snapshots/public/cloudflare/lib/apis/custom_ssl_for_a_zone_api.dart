...
return execute(
  request,
  onSuccess: (response) {
    return TlsCertificatesAndHostnamesCertificateResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
return execute(
  request,
  onSuccess: (response) {
    return TlsCertificatesAndHostnamesCertificateResponseSingle.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesCertificateResponseSingle, Never>> customSslForAZoneEditSslConfiguration({required TlsCertificatesAndHostnamesIdentifier customCertificateId, required TlsCertificatesAndHostnamesIdentifier zoneId, required CustomSslForAZoneEditSslConfigurationRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<TlsCertificatesAndHostnamesCertificateResponseIdOnly, Never>> customSslForAZoneDeleteSslConfiguration({required TlsCertificatesAndHostnamesIdentifier customCertificateId, required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  request,
  onSuccess: (response) {
    return TlsCertificatesAndHostnamesCertificateResponseIdOnly.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
