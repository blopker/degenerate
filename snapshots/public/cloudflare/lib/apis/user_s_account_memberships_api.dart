...
return OneOf2.parse(json, fromA: (v) => IamCollectionMembershipResponse.fromJson(v as Map<String, dynamic>), fromB: (v) => IamCollectionMembershipResponseWithPolicies.fromJson(v as Map<String, dynamic>),);
  },
  onError: (response) {
