...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/iam_invite_components_schemas_identifier.dart';import '../models/iam_user_invite.dart';import '../models/response_common_failure38.dart';import '../models/user_s_invites_respond_to_invitation_request.dart';/// UserSInvitesApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => IamUserInvite.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? IamUserInvite.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure38.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
