...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/aaa_account_id.dart';import '../models/aaa_before.dart';import '../models/aaa_history.dart';import '../models/aaa_per_page.dart';import '../models/notification_history_list_history_response4xx.dart';/// NotificationHistoryApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => AaaHistory.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  NotificationHistoryListHistoryResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
