...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/alexandria_application.dart';import '../models/alexandria_create_application_request.dart';import '../models/alexandria_update_application_version_request.dart';import '../models/create_application_response4xx.dart';import '../models/get_application_by_id_response4xx.dart';import '../models/get_applications_response4xx.dart';import '../models/update_application_version_response4xx.dart';/// ApplicationsApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => AlexandriaApplication.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  GetApplicationsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create application
///
/// Create application.
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? AlexandriaApplication.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  CreateApplicationResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  GetApplicationByIdResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  UpdateApplicationVersionResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
