...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/cache_identifier.dart';import '../models/cache_result.dart';import '../models/cache_schemas_patch.dart';import '../models/response_common_failure15.dart';/// AutomaticSslTlsApi operations.
///
...
return  CacheResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure15.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
