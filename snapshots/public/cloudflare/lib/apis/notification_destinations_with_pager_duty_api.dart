...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/aaa_account_id.dart';import '../models/aaa_id_response.dart';import '../models/aaa_id_response_result.dart';import '../models/aaa_integration_token.dart';import '../models/aaa_pagerduty.dart';import '../models/aaa_sensitive_id_response_result.dart';import '../models/response_common2.dart';import '../models/response_common_failure2.dart';/// NotificationDestinationsWithPagerDutyApi operations.
///
...
Future<ApiResult<AaaSensitiveIdResponseResult?, AaaIdResponse>> notificationDestinationsWithPagerDutyConnectPagerDuty({required AaaAccountId accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<AaaIdResponseResult?, AaaIdResponse>> notificationDestinationsWithPagerDutyConnectPagerDutyToken({required AaaAccountId accountId, required AaaIntegrationToken tokenId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
