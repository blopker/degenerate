...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/tls_certificates_and_hostnames_dcv_delegation_response.dart';import '../models/tls_certificates_and_hostnames_identifier.dart';import '../models/tls_certificates_and_hostnames_uuid_object.dart';/// DcvDelegationApi operations.
///
...
Future<ApiResult<TlsCertificatesAndHostnamesUuidObject?, TlsCertificatesAndHostnamesDcvDelegationResponse>> dcvDelegationUuidGet({required TlsCertificatesAndHostnamesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
