...
return  json['result'] != null ? TlsCertificatesAndHostnamesUuidObject.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  DcvDelegationUuidGetResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
