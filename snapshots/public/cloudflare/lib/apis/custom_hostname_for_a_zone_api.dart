...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesCustomHostnameResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return TlsCertificatesAndHostnamesCustomHostnameResponseSingle.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesCustomhostname?, TlsCertificatesAndHostnamesCustomHostnameResponseSingle>> customHostnameForAZoneEditCustomHostname({required TlsCertificatesAndHostnamesIdentifier customHostnameId, required TlsCertificatesAndHostnamesIdentifier zoneId, required CustomHostnameForAZoneEditCustomHostnameRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
return execute(
  ...
  onError: (response) {
    return CustomHostnameForAZoneDeleteCustomHostnameAndAnyIssuedSslCertificatesResponse4xx.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<TlsCertificatesAndHostnamesCustomhostname?, TlsCertificatesAndHostnamesCustomHostnameResponseSingle>> customHostnameForAZoneEditCustomCertificateCustomHostname({required TlsCertificatesAndHostnamesIdentifier customHostnameId, required TlsCertificatesAndHostnamesIdentifier certificatePackId, required TlsCertificatesAndHostnamesIdentifier certificateId, required TlsCertificatesAndHostnamesIdentifier zoneId, required TlsCertificatesAndHostnamesCustomCertAndKey body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
return execute(
  ...
  onError: (response) {
    return CustomHostnameForAZoneDeleteSingleCertificateAndKeyInACustomHostnameResponse4xx.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
