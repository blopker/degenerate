...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/radar_get_entities_location_by_alpha2_format.dart';import '../models/radar_get_entities_location_by_alpha2_response404.dart';import '../models/radar_get_entities_location_by_alpha2_response_result.dart';import '../models/radar_get_entities_locations_continent.dart';import '../models/radar_get_entities_locations_format.dart';import '../models/radar_get_entities_locations_response400.dart';import '../models/radar_get_entities_locations_response_result.dart';/// RadarLocationsApi operations.
///
...
return  RadarGetEntitiesLocationsResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 400:
final json = jsonDecode(response.body);
return  RadarGetEntitiesLocationsResponse400.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  RadarGetEntitiesLocationByAlpha2ResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case 404:
final json = jsonDecode(response.body);
return  RadarGetEntitiesLocationByAlpha2Response404.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
