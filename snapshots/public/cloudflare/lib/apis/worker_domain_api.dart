...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common80.dart';import '../models/worker_domain_attach_to_domain_request.dart';import '../models/workers_account_identifier.dart';import '../models/workers_domain_identifier.dart';import '../models/workers_schemas_service.dart';import '../models/workers_zone_identifier.dart';import '../models/workers_zone_name.dart';/// WorkerDomainApi operations.
///
...
Future<ApiResult<ResponseCommon80, Never>> workerDomainAttachToDomain({required WorkersAccountIdentifier accountId, required WorkerDomainAttachToDomainRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon80, Never>> workerDomainGetADomain({required WorkersAccountIdentifier accountId, required WorkersDomainIdentifier domainId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
