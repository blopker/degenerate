...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/builds_account_id.dart';import '../models/builds_branch.dart';import '../models/builds_config_autofill_response.dart';import '../models/builds_provider_account_id.dart';import '../models/builds_repo_id.dart';import '../models/builds_root_directory.dart';import '../models/builds_scm_provider_type.dart';/// GitHubIntegrationApi operations.
///
...
final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId.toString())}/builds/repos/${Uri.encodeComponent(providerType.value)}/${Uri.encodeComponent(providerAccountId.toString())}/${Uri.encodeComponent(repoId.toString())}/config_autofill',
  headers: headers,
