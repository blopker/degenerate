...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure3.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// Get user audit logs
