...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/device_dex_test_details_kind.dart';import '../models/digital_experience_monitoring_account_identifier.dart';import '../models/digital_experience_monitoring_device_dex_test_schemas_http.dart';import '../models/digital_experience_monitoring_dex_delete_response_collection_result.dart';import '../models/digital_experience_monitoring_dex_response_collection.dart';import '../models/digital_experience_monitoring_dex_single_response.dart';import '../models/digital_experience_monitoring_schemas_test_id.dart';import '../models/digital_experience_monitoring_uuid.dart';/// DeviceDexTestsApi operations.
///
...
Future<ApiResult<List<DigitalExperienceMonitoringDeviceDexTestSchemasHttp>?, DigitalExperienceMonitoringDexSingleResponse>> deviceDexTestDetails({required DigitalExperienceMonitoringAccountIdentifier accountId, double? page, double? perPage, String? testName, DeviceDexTestDetailsKind? kind, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
...
Future<ApiResult<DigitalExperienceMonitoringDeviceDexTestSchemasHttp?, DigitalExperienceMonitoringDexSingleResponse>> deviceDexTestCreateDeviceDexTest({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringDeviceDexTestSchemasHttp body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<DigitalExperienceMonitoringDeviceDexTestSchemasHttp?, DigitalExperienceMonitoringDexSingleResponse>> deviceDexTestUpdateDeviceDexTest({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid dexTestId, required DigitalExperienceMonitoringDeviceDexTestSchemasHttp body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
