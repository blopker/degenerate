...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/device_dex_test_details_kind.dart';import '../models/digital_experience_monitoring_account_identifier.dart';import '../models/digital_experience_monitoring_device_dex_test_schemas_http.dart';import '../models/digital_experience_monitoring_dex_delete_response_collection.dart';import '../models/digital_experience_monitoring_dex_response_collection.dart';import '../models/digital_experience_monitoring_dex_single_response.dart';import '../models/digital_experience_monitoring_schemas_test_id.dart';import '../models/digital_experience_monitoring_uuid.dart';/// DeviceDexTestsApi operations.
///
...
return execute(
  request,
  onSuccess: (response) {
    return DigitalExperienceMonitoringDexResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<DigitalExperienceMonitoringDexSingleResponse, Never>> deviceDexTestCreateDeviceDexTest({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringDeviceDexTestSchemasHttp body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  request,
  onSuccess: (response) {
    return DigitalExperienceMonitoringDexSingleResponse.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// Get Device DEX test
...
Future<ApiResult<DigitalExperienceMonitoringDexSingleResponse, Never>> deviceDexTestGetDeviceDexTest({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringSchemasTestId dexTestId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<DigitalExperienceMonitoringDexDeleteResponseCollection, Never>> deviceDexTestDeleteDeviceDexTest({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid dexTestId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  request,
  onSuccess: (response) {
    return DigitalExperienceMonitoringDexDeleteResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
