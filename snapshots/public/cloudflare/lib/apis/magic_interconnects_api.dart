...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/magic_components_schemas_modified_tunnels_collection_response.dart';import '../models/magic_components_schemas_modified_tunnels_collection_response_result.dart';import '../models/magic_components_schemas_tunnel_modified_response.dart';import '../models/magic_components_schemas_tunnel_modified_response_result.dart';import '../models/magic_components_schemas_tunnel_single_response.dart';import '../models/magic_components_schemas_tunnel_single_response_result.dart';import '../models/magic_components_schemas_tunnels_collection_response.dart';import '../models/magic_components_schemas_tunnels_collection_response_result.dart';import '../models/magic_identifier.dart';import '../models/magic_interconnect_tunnel_update_request.dart';/// MagicInterconnectsApi operations.
///
...
Future<ApiResult<MagicComponentsSchemasTunnelsCollectionResponseResult?, MagicComponentsSchemasTunnelsCollectionResponse>> magicInterconnectsListInterconnects({required MagicIdentifier accountId, bool? xMagicNewHcTarget, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<MagicComponentsSchemasTunnelModifiedResponseResult?, MagicComponentsSchemasTunnelModifiedResponse>> magicInterconnectsUpdateInterconnect({required MagicIdentifier cfInterconnectId, required MagicIdentifier accountId, required MagicInterconnectTunnelUpdateRequest body, bool? xMagicNewHcTarget, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
if (xMagicNewHcTarget != null) {
  headers['x-magic-new-hc-target'] = xMagicNewHcTarget.toString();
}
