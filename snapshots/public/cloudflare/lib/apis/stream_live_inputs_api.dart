...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common66.dart';import '../models/stream_create_input_request.dart';import '../models/stream_create_output_request.dart';import '../models/stream_include_counts.dart';import '../models/stream_live_input_identifier.dart';import '../models/stream_output_identifier.dart';import '../models/stream_schemas_identifier.dart';import '../models/stream_update_input_request.dart';import '../models/stream_update_output_request.dart';/// StreamLiveInputsApi operations.
///
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsListLiveInputs({required StreamSchemasIdentifier accountId, StreamIncludeCounts? includeCounts, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsCreateALiveInput({required StreamSchemasIdentifier accountId, required StreamCreateInputRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsRetrieveALiveInput({required StreamLiveInputIdentifier liveInputIdentifier, required StreamSchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsUpdateALiveInput({required StreamLiveInputIdentifier liveInputIdentifier, required StreamSchemasIdentifier accountId, required StreamUpdateInputRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsDisableALiveInput({required StreamLiveInputIdentifier liveInputIdentifier, required StreamSchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsEnableALiveInput({required StreamLiveInputIdentifier liveInputIdentifier, required StreamSchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ResponseCommon66, Never>> streamLiveInputsListAllOutputsAssociatedWithASpecifiedLiveInput({required StreamLiveInputIdentifier liveInputIdentifier, required StreamSchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
