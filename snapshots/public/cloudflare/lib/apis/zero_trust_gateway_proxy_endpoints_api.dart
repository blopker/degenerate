...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/zero_trust_gateway_components_schemas_uuid.dart';import '../models/zero_trust_gateway_proxy_endpoints.dart';import '../models/zero_trust_gateway_proxy_endpoints_create_proxy_endpoint_request.dart';import '../models/zero_trust_gateway_proxy_endpoints_create_proxy_endpoint_response4xx.dart';import '../models/zero_trust_gateway_proxy_endpoints_delete_proxy_endpoint_response4xx.dart';import '../models/zero_trust_gateway_proxy_endpoints_list_proxy_endpoints_response4xx.dart';import '../models/zero_trust_gateway_proxy_endpoints_proxy_endpoint_details_response4xx.dart';import '../models/zero_trust_gateway_proxy_endpoints_update_proxy_endpoint_request.dart';import '../models/zero_trust_gateway_proxy_endpoints_update_proxy_endpoint_response4xx.dart';import '../models/zero_trust_gateway_schemas_identifier.dart';/// ZeroTrustGatewayProxyEndpointsApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => ZeroTrustGatewayProxyEndpoints.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayProxyEndpointsListProxyEndpointsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? ZeroTrustGatewayProxyEndpoints.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayProxyEndpointsCreateProxyEndpointResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayProxyEndpointsProxyEndpointDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayProxyEndpointsUpdateProxyEndpointResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ZeroTrustGatewayProxyEndpointsDeleteProxyEndpointResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
