...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/zero_trust_gateway_empty_response.dart';import '../models/zero_trust_gateway_items2.dart';import '../models/zero_trust_gateway_list_item_response_collection.dart';import '../models/zero_trust_gateway_list_single_response.dart';import '../models/zero_trust_gateway_lists.dart';import '../models/zero_trust_gateway_schemas_identifier.dart';import '../models/zero_trust_gateway_schemas_response_collection.dart';import '../models/zero_trust_gateway_schemas_type.dart';import '../models/zero_trust_gateway_schemas_uuid.dart';import '../models/zero_trust_gateway_single_response_with_list_items.dart';import '../models/zero_trust_gateway_single_response_with_list_items_result.dart';import '../models/zero_trust_lists_create_zero_trust_list_request.dart';import '../models/zero_trust_lists_patch_zero_trust_list_request.dart';import '../models/zero_trust_lists_update_zero_trust_list_request.dart';/// ZeroTrustListsApi operations.
///
...
Future<ApiResult<List<ZeroTrustGatewayLists>?, ZeroTrustGatewaySchemasResponseCollection>> zeroTrustListsListZeroTrustLists({required ZeroTrustGatewaySchemasIdentifier accountId, ZeroTrustGatewaySchemasType? type, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
...
Future<ApiResult<ZeroTrustGatewayLists?, ZeroTrustGatewayListSingleResponse>> zeroTrustListsZeroTrustListDetails({required ZeroTrustGatewaySchemasUuid listId, required ZeroTrustGatewaySchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<ZeroTrustGatewayLists?, ZeroTrustGatewayListSingleResponse>> zeroTrustListsUpdateZeroTrustList({required ZeroTrustGatewaySchemasUuid listId, required ZeroTrustGatewaySchemasIdentifier accountId, required ZeroTrustListsUpdateZeroTrustListRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<Map<String, dynamic>?, ZeroTrustGatewayEmptyResponse>> zeroTrustListsDeleteZeroTrustList({required ZeroTrustGatewaySchemasUuid listId, required ZeroTrustGatewaySchemasIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
