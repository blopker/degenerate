...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/intel_domain_history.dart';import '../models/intel_identifier.dart';import '../models/intel_response.dart';/// DomainHistoryApi operations.
///
...
Future<ApiResult<List<IntelDomainHistory>?, IntelResponse>> domainHistoryGetDomainHistory({required IntelIdentifier accountId, String? domain, RequestOptions? options, }) async  { final queryParameters = <String, String>{...apiConfig.defaultQueryParameters};
