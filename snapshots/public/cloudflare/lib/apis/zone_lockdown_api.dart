...
return execute(
  ...
  onError: (response) {
    return FirewallZonelockdownResponseCollection.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<FirewallZonelockdown, FirewallZonelockdownResponseSingle>> zoneLockdownCreateAZoneLockdownRule({required FirewallIdentifier zoneId, required ZoneLockdownCreateAZoneLockdownRuleRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return FirewallZonelockdownResponseSingle.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
Future<ApiResult<FirewallZonelockdown, FirewallZonelockdownResponseSingle>> zoneLockdownGetAZoneLockdownRule({required FirewallLockdownsComponentsSchemasId lockDownsId, required FirewallIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
Future<ApiResult<FirewallZonelockdown, FirewallZonelockdownResponseSingle>> zoneLockdownUpdateAZoneLockdownRule({required FirewallLockdownsComponentsSchemasId lockDownsId, required FirewallIdentifier zoneId, required ZoneLockdownUpdateAZoneLockdownRuleRequest body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
headers['Content-Type'] = 'application/json';
...
Future<ApiResult<ZoneLockdownDeleteAZoneLockdownRuleResponseResult?, ResponseCommonFailure34>> zoneLockdownDeleteAZoneLockdownRule({required FirewallLockdownsComponentsSchemasId lockDownsId, required FirewallIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure34.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
