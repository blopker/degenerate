...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/cache_rules_identifier.dart';import '../models/cache_rules_result_object.dart';import '../models/response_common_failure14.dart';import '../models/zone_cache_settings_change_origin_post_quantum_encryption_setting_request.dart';/// OriginPostQuantumApi operations.
///
...
Future<ApiResult<CacheRulesResultObject?, ResponseCommonFailure14>> zoneCacheSettingsGetOriginPostQuantumEncryptionSetting({required CacheRulesIdentifier zoneId, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
