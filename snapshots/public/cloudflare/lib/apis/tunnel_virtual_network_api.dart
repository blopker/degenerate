...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/tunnel_account_id.dart';import '../models/tunnel_virtual_network.dart';import '../models/tunnel_virtual_network_create_a_virtual_network_request.dart';import '../models/tunnel_virtual_network_create_a_virtual_network_response4xx.dart';import '../models/tunnel_virtual_network_delete_response4xx.dart';import '../models/tunnel_virtual_network_get_request.dart';import '../models/tunnel_virtual_network_get_response4xx.dart';import '../models/tunnel_virtual_network_id.dart';import '../models/tunnel_virtual_network_list_virtual_networks_response4xx.dart';import '../models/tunnel_virtual_network_name.dart';import '../models/tunnel_virtual_network_update_request.dart';import '../models/tunnel_virtual_network_update_response4xx.dart';/// TunnelVirtualNetworkApi operations.
///
...
return  (json['result'] as List<dynamic>).map((e) => TunnelVirtualNetwork.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  TunnelVirtualNetworkListVirtualNetworksResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  TunnelVirtualNetwork.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  TunnelVirtualNetworkCreateAVirtualNetworkResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  TunnelVirtualNetworkGetResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  TunnelVirtualNetworkUpdateResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  TunnelVirtualNetworkDeleteResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
