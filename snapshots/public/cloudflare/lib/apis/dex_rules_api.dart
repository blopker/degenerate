...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/digital_experience_monitoring_account_identifier.dart';import '../models/digital_experience_monitoring_create_rule_body.dart';import '../models/digital_experience_monitoring_dex_rule.dart';import '../models/digital_experience_monitoring_list_rules_response.dart';import '../models/digital_experience_monitoring_patch_rule_body.dart';import '../models/digital_experience_monitoring_uuid.dart';import '../models/list_dex_rules_sort_by.dart';import '../models/list_dex_rules_sort_order.dart';import '../models/response_common_failure24.dart';/// DexRulesApi operations.
///
...
return  json['result'] != null ? DigitalExperienceMonitoringListRulesResponse.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? DigitalExperienceMonitoringDexRule.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure24.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] as bool?;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure24.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
