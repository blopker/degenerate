...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/account_load_balancer_pools_create_pool_request.dart';import '../models/account_load_balancer_pools_create_pool_response4xx.dart';import '../models/account_load_balancer_pools_delete_pool_response4xx.dart';import '../models/account_load_balancer_pools_list_pool_references_response4xx.dart';import '../models/account_load_balancer_pools_list_pools_response4xx.dart';import '../models/account_load_balancer_pools_patch_pool_request.dart';import '../models/account_load_balancer_pools_patch_pool_response4xx.dart';import '../models/account_load_balancer_pools_patch_pools_request.dart';import '../models/account_load_balancer_pools_patch_pools_response4xx.dart';import '../models/account_load_balancer_pools_pool_details_response4xx.dart';import '../models/account_load_balancer_pools_pool_health_details_response4xx.dart';import '../models/account_load_balancer_pools_preview_pool_response4xx.dart';import '../models/account_load_balancer_pools_update_pool_request.dart';import '../models/account_load_balancer_pools_update_pool_response4xx.dart';import '../models/load_balancing_components_schemas_identifier.dart';import '../models/load_balancing_health_details_result.dart';import '../models/load_balancing_monitor_editable.dart';import '../models/load_balancing_pool.dart';import '../models/load_balancing_pools_references_response_result.dart';import '../models/load_balancing_preview_response_result.dart';import '../models/load_balancing_schemas_id_response_result.dart';import '../models/load_balancing_schemas_identifier.dart';/// AccountLoadBalancerPoolsApi operations.
///
...
return  (json['result'] as List<dynamic>).map((e) => LoadBalancingPool.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsListPoolsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create Pool
///
/// Create a new pool.
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  LoadBalancingPool.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsCreatePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Patch Pools
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsPatchPoolsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Pool Details
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsPoolDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsUpdatePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Patch Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsPatchPoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete Pool
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  LoadBalancingSchemasIdResponseResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsDeletePoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Pool Health Details
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  LoadBalancingHealthDetailsResult.fromJson(json['result'] as Map<String, dynamic>);}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsPoolHealthDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Preview Pool
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsPreviewPoolResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  (json['result'] as List<dynamic>).map((e) => LoadBalancingPoolsReferencesResponseResult.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  AccountLoadBalancerPoolsListPoolReferencesResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
