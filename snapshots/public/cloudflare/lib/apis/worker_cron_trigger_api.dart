...
Future<ApiResult<WorkerCronTriggerUpdateCronTriggersResponseResult, ResponseCommonFailure82>> workerCronTriggerUpdateCronTriggers({required WorkersIdentifier accountId, required WorkersScriptName scriptName, required List<WorkersSchedule> body, RequestOptions? options, }) async  { final headers = <String, String>{...apiConfig.defaultHeaders};
