...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure69.dart';import '../models/stream_account_identifier.dart';import '../models/stream_additional_audio.dart';import '../models/stream_audio_identifier.dart';import '../models/stream_copy_audio_track.dart';import '../models/stream_deleted_response.dart';import '../models/stream_edit_audio_track.dart';import '../models/stream_identifier.dart';/// StreamAudioTracksApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => StreamAdditionalAudio.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? StreamAdditionalAudio.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure69.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  StreamDeletedResponse.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
