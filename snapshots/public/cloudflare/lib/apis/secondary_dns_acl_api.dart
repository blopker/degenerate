...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/secondary_dns_account_identifier.dart';import '../models/secondary_dns_acl.dart';import '../models/secondary_dns_acl_acl_details_response4xx.dart';import '../models/secondary_dns_acl_create_acl_request.dart';import '../models/secondary_dns_acl_create_acl_response4xx.dart';import '../models/secondary_dns_acl_delete_acl_response4xx.dart';import '../models/secondary_dns_acl_list_ac_ls_response4xx.dart';import '../models/secondary_dns_acl_request.dart';import '../models/secondary_dns_acl_update_acl_response4xx.dart';import '../models/secondary_dns_components_schemas_id_response_result.dart';import '../models/secondary_dns_components_schemas_identifier.dart';/// SecondaryDnsAclApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => SecondaryDnsAcl.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsAclListAcLsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create ACL
///
/// Create ACL.
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? SecondaryDnsAcl.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsAclCreateAclResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// ACL Details
///
/// Get ACL.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsAclAclDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update ACL
///
/// Modify ACL.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsAclUpdateAclResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete ACL
///
/// Delete ACL.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsAclDeleteAclResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
