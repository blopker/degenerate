...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common_failure69.dart';import '../models/stream_caption_basic_upload.dart';import '../models/stream_captions.dart';import '../models/stream_identifier.dart';import '../models/stream_language.dart';import '../models/stream_schemas_identifier.dart';/// StreamSubtitlesCaptionsApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => StreamCaptions.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? StreamCaptions.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  ResponseCommonFailure69.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
