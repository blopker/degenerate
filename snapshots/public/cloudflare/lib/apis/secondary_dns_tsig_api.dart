...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/secondary_dns_account_identifier.dart';import '../models/secondary_dns_schemas_id_response_result.dart';import '../models/secondary_dns_schemas_identifier.dart';import '../models/secondary_dns_tsig.dart';import '../models/secondary_dns_tsig_create_tsig_response4xx.dart';import '../models/secondary_dns_tsig_delete_tsig_response4xx.dart';import '../models/secondary_dns_tsig_list_tsi_gs_response4xx.dart';import '../models/secondary_dns_tsig_request.dart';import '../models/secondary_dns_tsig_tsig_details_response4xx.dart';import '../models/secondary_dns_tsig_update_tsig_response4xx.dart';/// SecondaryDnsTsigApi operations.
///
...
return  (json['result'] as List<dynamic>?)?.map((e) => SecondaryDnsTsig.fromJson(e as Map<String, dynamic>)).toList();}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsTsigListTsiGsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Create TSIG
///
/// Create TSIG.
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? SecondaryDnsTsig.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsTsigCreateTsigResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// TSIG Details
///
/// Get TSIG.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsTsigTsigDetailsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Update TSIG
///
/// Modify TSIG.
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsTsigUpdateTsigResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Delete TSIG
///
/// Delete TSIG.
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body) as Map<String, dynamic>;
return  json['result'] != null ? SecondaryDnsSchemasIdResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null;}, onError: (response) {switch (response.statusCode) {
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  SecondaryDnsTsigDeleteTsigResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
