...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure81.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
/// Create a Namespace
...
return execute(
  ...
  onError: (response) {
    return WorkersKvNamespaceWriteMultipleKeyValuePairsResponse4xx.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
...
return execute(
  ...
  onError: (response) {
    return WorkersKvNamespaceDeleteMultipleKeyValuePairsResponse4xx.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
