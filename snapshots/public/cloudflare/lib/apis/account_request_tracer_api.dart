...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/account_request_tracer_request_trace_request.dart';import '../models/account_request_tracer_request_trace_response_result.dart';import '../models/request_tracer_identifier.dart';import '../models/response_common_failure57.dart';/// AccountRequestTracerApi operations.
///
...
return execute(
  ...
  onError: (response) {
    return ResponseCommonFailure57.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
