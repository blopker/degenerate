...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/load_balancer_regions_get_region_response4xx.dart';import '../models/load_balancer_regions_list_regions_response4xx.dart';import '../models/load_balancing_components_schemas_identifier.dart';import '../models/load_balancing_region_code.dart';import '../models/load_balancing_subdivision_code_a2.dart';/// LoadBalancerRegionsApi operations.
///
...
return  LoadBalancerRegionsListRegionsResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
/// Get Region
///
...
case >= 400 && < 500:
final json = jsonDecode(response.body);
return  LoadBalancerRegionsGetRegionResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
