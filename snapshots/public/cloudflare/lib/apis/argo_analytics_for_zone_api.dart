...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/argo_analytics_for_zone_argo_analytics_for_a_zone_response4xx.dart';import '../models/argo_analytics_identifier.dart';/// ArgoAnalyticsForZoneApi operations.
///
...
return  ArgoAnalyticsForZoneArgoAnalyticsForAZoneResponse4xx.fromJson(json as Map<String, dynamic>);default:
return  null; }}, );}
}
