...
final class D1ReadReplicationDetails {const D1ReadReplicationDetails({required this.mode});
...
@override String toString() { return 'D1ReadReplicationDetails(mode: $mode)'; } 
 }
