...
@immutable final class GetPresetsPresetIdResponseDataConfigMediaAudio {const GetPresetsPresetIdResponseDataConfigMediaAudio({this.enableHighBitrate = false, this.enableStereo = false, });
