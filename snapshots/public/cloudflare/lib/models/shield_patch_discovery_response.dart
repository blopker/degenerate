...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'shield_messages2.dart';import 'shield_patch_discovery_response_result.dart';final class ShieldPatchDiscoveryResponse {const ShieldPatchDiscoveryResponse({required this.errors, required this.messages, required this.success, required this.result, });
