...
final class RadarGetAttacksLayer3TimeseriesGroupByIndustryResponseResultMetaUnits {const RadarGetAttacksLayer3TimeseriesGroupByIndustryResponseResultMetaUnits({required this.name, required this.value, });
