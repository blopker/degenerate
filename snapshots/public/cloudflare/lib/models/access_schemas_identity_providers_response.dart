...
this.accessSchemasYandexResponse = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const AccessSchemasIdentityProvidersResponse._({required this.rawValue, required this.accessSchemasAzureAdResponse,
...
required this.accessSchemasYandexResponse,});
  factory AccessSchemasIdentityProvidersResponse.fromJson(Object? json) => AccessSchemasIdentityProvidersResponse._(
...
if (accessSchemasYandexResponse.isPresent) accessSchemasYandexResponse.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is AccessSchemasIdentityProvidersResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'AccessSchemasIdentityProvidersResponse(${toJson()})';
}
