...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'urlscanner_get_response_text_response400_errors.dart';import 'urlscanner_get_response_text_response400_messages.dart';@immutable final class UrlscannerGetResponseTextResponse400 {const UrlscannerGetResponseTextResponse400({required this.errors, required this.messages, required this.success, });
