...
@immutable final class PatchPresetsPresetIdResponseDataConfigMediaAudio {const PatchPresetsPresetIdResponseDataConfigMediaAudio({this.enableHighBitrate = false, this.enableStereo = false, });
