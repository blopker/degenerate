...
factory AigConfigUpdateGatewayRequestStripe.fromJson(Map<String, dynamic> json) { return AigConfigUpdateGatewayRequestStripe(
  ...
  usageEvents: (json['usage_events'] as List<dynamic>).map((e) => AigConfigUpdateGatewayRequestStripeUsageEvents.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
AigConfigUpdateGatewayRequestStripe copyWith({String? authorization, List<AigConfigUpdateGatewayRequestStripeUsageEvents>? usageEvents, }) { return AigConfigUpdateGatewayRequestStripe(
...
@override String toString() { return 'AigConfigUpdateGatewayRequestStripe(authorization: $authorization, usageEvents: $usageEvents)'; } 
 }
