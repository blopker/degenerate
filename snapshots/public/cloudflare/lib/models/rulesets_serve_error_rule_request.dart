...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'action_parameters_asset2.dart';import 'action_parameters_content2.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';import 'rulesets_serve_error_rule_request_action_parameters.dart';@immutable final class RulesetsServeErrorRuleRequest {const RulesetsServeErrorRuleRequest({this.action = const Omittable.absent(), this.actionParameters, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsServeErrorRuleRequest.fromJson(Map<String, dynamic> json) { return RulesetsServeErrorRuleRequest(
  action: json.containsKey('action') ? Omittable(json['action']) : const Omittable.absent(),
  actionParameters: json['action_parameters'] != null ? OneOf2.parse(json['action_parameters'], fromA: (v) => ActionParametersContent2.fromJson(v as Map<String, dynamic>), fromB: (v) => ActionParametersAsset2.fromJson(v as Map<String, dynamic>),) : null,
...
final RulesetsServeErrorRuleRequestActionParameters? actionParameters;
...
RulesetsServeErrorRuleRequest copyWith({Omittable<dynamic>? action, RulesetsServeErrorRuleRequestActionParameters? Function()? actionParameters, Omittable<dynamic>? description, RulesetsRuleEnabled? Function()? enabled, RulesetsRuleExposedCredentialCheck? Function()? exposedCredentialCheck, String? Function()? expression, RulesetsRuleId? Function()? id, RulesetsRuleLogging? Function()? logging, RulesetsRuleRatelimit? Function()? ratelimit, String? Function()? ref, }) { return RulesetsServeErrorRuleRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RulesetsServeErrorRuleRequest &&
          action == other.action &&
...
@override String toString() { return 'RulesetsServeErrorRuleRequest(action: $action, actionParameters: $actionParameters, description: $description, enabled: $enabled, exposedCredentialCheck: $exposedCredentialCheck, expression: $expression, id: $id, logging: $logging, ratelimit: $ratelimit, ref: $ref)'; } 
 }
