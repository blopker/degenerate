...
final class BrapiPostPdfRequestVariant2CookiesPriority {const BrapiPostPdfRequestVariant2CookiesPriority._(this.value);
...
final class BrapiPostPdfRequestVariant2CookiesSameSite {const BrapiPostPdfRequestVariant2CookiesSameSite._(this.value);
...
final class BrapiPostPdfRequestVariant2CookiesSourceScheme {const BrapiPostPdfRequestVariant2CookiesSourceScheme._(this.value);
...
final class BrapiPostPdfRequestVariant2Cookies {const BrapiPostPdfRequestVariant2Cookies({this.domain, this.expires, this.httpOnly, required this.name, this.partitionKey, this.path, this.priority, this.sameParty, this.sameSite, this.secure, this.sourcePort, this.sourceScheme, this.url, required this.value, });
