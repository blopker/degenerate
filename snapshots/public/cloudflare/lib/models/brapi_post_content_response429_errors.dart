...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class BrapiPostContentResponse429Errors {const BrapiPostContentResponse429Errors({required this.code, required this.message, });
