...
@immutable final class Prompt42ResponseFormat {const Prompt42ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt42ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt42ResponseFormatType? Function()? type, }) { return Prompt42ResponseFormat(
