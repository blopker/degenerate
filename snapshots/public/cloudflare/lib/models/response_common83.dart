...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zone_activation_messages2.dart';final class ResponseCommon83 {const ResponseCommon83({required this.errors, required this.messages, required this.success, });
...
ResponseCommon83 copyWith({List<ZoneActivationMessages2>? errors, List<ZoneActivationMessages2>? messages, bool? success, }) { return ResponseCommon83(
  errors: errors ?? this.errors,
  messages: messages ?? this.messages,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseCommon83 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success); } 
@override String toString() { return 'ResponseCommon83(errors: $errors, messages: $messages, success: $success)'; } 
 }
