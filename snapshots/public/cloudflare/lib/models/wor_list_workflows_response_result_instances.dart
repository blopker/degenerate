...
final class WorListWorkflowsResponseResultInstances {const WorListWorkflowsResponseResultInstances({this.complete, this.errored, this.paused, this.queued, this.running, this.terminated, this.waiting, this.waitingForPause, });
