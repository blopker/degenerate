...
@immutable final class SelfHostedApplicationPoliciesVariant3 {const SelfHostedApplicationPoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory SelfHostedApplicationPoliciesVariant3.fromJson(Map<String, dynamic> json) { return SelfHostedApplicationPoliciesVariant3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SelfHostedApplicationPoliciesVariant3 &&
