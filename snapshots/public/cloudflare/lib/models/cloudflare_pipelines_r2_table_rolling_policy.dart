...
@immutable final class CloudflarePipelinesR2TableRollingPolicy {const CloudflarePipelinesR2TableRollingPolicy({this.fileSizeBytes, this.inactivitySeconds, this.intervalSeconds, });

factory CloudflarePipelinesR2TableRollingPolicy.fromJson(Map<String, dynamic> json) { return CloudflarePipelinesR2TableRollingPolicy(
...
CloudflarePipelinesR2TableRollingPolicy copyWith({int Function()? fileSizeBytes, int Function()? inactivitySeconds, int Function()? intervalSeconds, }) { return CloudflarePipelinesR2TableRollingPolicy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CloudflarePipelinesR2TableRollingPolicy &&
...
@override String toString() { return 'CloudflarePipelinesR2TableRollingPolicy(fileSizeBytes: $fileSizeBytes, inactivitySeconds: $inactivitySeconds, intervalSeconds: $intervalSeconds)'; } 
 }
