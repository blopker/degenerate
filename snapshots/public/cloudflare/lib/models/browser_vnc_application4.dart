...
factory BrowserVncApplication4.fromJson(Map<String, dynamic> json) {return BrowserVncApplication4(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => BrowserVncApplication4PoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
);}
...
final List<BrowserVncApplication4Policies>? policies;
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is BrowserVncApplication4 &&
