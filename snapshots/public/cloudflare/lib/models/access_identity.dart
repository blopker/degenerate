...
import 'access_device_session.dart';import 'access_geo.dart';import 'access_identity_idp.dart';import 'access_identity_mtls_auth.dart';import 'access_schemas_device_posture_rule.dart';final class AccessIdentity {const AccessIdentity({this.accountId, this.authStatus, this.commonName, this.deviceId, this.deviceSessions, this.devicePosture, this.email, this.geo, this.iat, this.idp, this.ip, this.isGateway, this.isWarp, this.mtlsAuth, this.serviceTokenId, this.serviceTokenStatus, this.userUuid, this.version, });
