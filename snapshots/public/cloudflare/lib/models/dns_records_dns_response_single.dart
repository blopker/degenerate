...
DnsRecordsDnsResponseSingle copyWith({Map<String, dynamic> Function()? result}) { return DnsRecordsDnsResponseSingle(
...
@override String toString() { return 'DnsRecordsDnsResponseSingle(result: $result)'; } 
 }
