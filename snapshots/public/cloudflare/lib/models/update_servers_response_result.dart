...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class UpdateServersResponseResultAuthType {const UpdateServersResponseResultAuthType._(this.value);
...
final class UpdateServersResponseResult {const UpdateServersResponseResult({required this.authType, this.createdAt, this.createdBy, this.description, this.error, required this.hostname, required this.id, this.lastSuccessfulSync, this.lastSynced, this.modifiedAt, this.modifiedBy, required this.name, required this.prompts, this.status = 'waiting', required this.tools, });
