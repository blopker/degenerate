...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_origins_timeseries_group_response400_errors.dart';final class RadarGetOriginsTimeseriesGroupResponse400 {const RadarGetOriginsTimeseriesGroupResponse400({required this.errors, required this.result, required this.success, });
