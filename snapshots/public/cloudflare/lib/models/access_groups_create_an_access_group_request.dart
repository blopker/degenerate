...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_groups_components_schemas_name.dart';import 'access_is_default.dart';import 'access_rule.dart';final class AccessGroupsCreateAnAccessGroupRequest {const AccessGroupsCreateAnAccessGroupRequest({this.exclude, required this.include, this.isDefault, required this.name, this.require, });
