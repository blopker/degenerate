...
@immutable final class ZonesContentConverter {const ZonesContentConverter({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesContentConverter copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesContentConverterValue? value, }) { return ZonesContentConverter(
