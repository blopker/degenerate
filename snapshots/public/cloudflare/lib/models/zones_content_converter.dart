...
@immutable final class ZonesContentConverter {const ZonesContentConverter({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
