...
import 'ai_search_instance_search_response_result.dart';final class AiSearchInstanceSearchResponse {const AiSearchInstanceSearchResponse({required this.result, required this.success, });
