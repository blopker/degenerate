...
@immutable final class BrapiPostMarkdownRequestVariant2Viewport {const BrapiPostMarkdownRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostMarkdownRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostMarkdownRequestVariant2Viewport(
...
BrapiPostMarkdownRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostMarkdownRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostMarkdownRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostMarkdownRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
