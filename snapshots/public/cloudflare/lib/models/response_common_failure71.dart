...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class ResponseCommonFailure71 {const ResponseCommonFailure71({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'ResponseCommonFailure71(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
