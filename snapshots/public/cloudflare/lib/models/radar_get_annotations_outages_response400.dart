...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_annotations_outages_response400_errors.dart';@immutable final class RadarGetAnnotationsOutagesResponse400 {const RadarGetAnnotationsOutagesResponse400({required this.errors, required this.result, required this.success, });
