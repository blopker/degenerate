...
final List<RadarGetTcpResetsTimeoutsSummaryResponseResultMetaConfidenceInfoAnnotations> annotations;
...
RadarGetTcpResetsTimeoutsSummaryResponseResultMetaConfidenceInfo copyWith({List<RadarGetTcpResetsTimeoutsSummaryResponseResultMetaConfidenceInfoAnnotations>? annotations, int? level, }) { return RadarGetTcpResetsTimeoutsSummaryResponseResultMetaConfidenceInfo(
...
@override String toString() { return 'RadarGetTcpResetsTimeoutsSummaryResponseResultMetaConfidenceInfo(annotations: $annotations, level: $level)'; } 
 }
