...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'load_balancing_messages2.dart';import 'load_balancing_monitor.dart';import 'load_balancing_result_info.dart';@immutable final class LoadBalancingMonitorResponseCollection {const LoadBalancingMonitorResponseCollection({required this.errors, required this.messages, required this.success, required this.resultInfo, required this.result, });
...
LoadBalancingMonitorResponseCollection copyWith({List<LoadBalancingMessages2>? errors, List<LoadBalancingMessages2>? messages, bool? success, LoadBalancingResultInfo? resultInfo, List<LoadBalancingMonitor>? result, }) {return LoadBalancingMonitorResponseCollection(
...
@override String toString() {return 'LoadBalancingMonitorResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';}
}
