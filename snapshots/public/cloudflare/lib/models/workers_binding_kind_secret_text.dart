...
import 'workers_binding_name.dart';final class WorkersBindingKindSecretText {const WorkersBindingKindSecretText({required this.name, required this.text, required this.type, });
