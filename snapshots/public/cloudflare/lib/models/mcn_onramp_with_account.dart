...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_account_id.dart';import 'mcn_cost.dart';import 'mcn_cost_diff.dart';import 'mcn_onramp_cloud_type.dart';import 'mcn_onramp_id.dart';import 'mcn_onramp_status.dart';import 'mcn_onramp_type.dart';import 'mcn_resource_details.dart';import 'mcn_resource_diff.dart';import 'mcn_resource_id.dart';final class McnOnrampWithAccount {const McnOnrampWithAccount({this.attachedHubs, this.attachedVpcs, this.cloudAsn, required this.cloudType, this.description, required this.dynamicRouting, this.hub, required this.id, required this.installRoutesInCloud, required this.installRoutesInMagicWan, this.lastAppliedAt, this.lastExportedAt, this.lastPlannedAt, this.manageHubToHubAttachments, this.manageVpcToHubAttachments, required this.name, this.plannedMonthlyCostEstimate, this.plannedResources, this.plannedResourcesUnavailable, this.postApplyMonthlyCostEstimate, this.postApplyResources, this.postApplyResourcesUnavailable, this.region, this.status, required this.type, required this.updatedAt, this.vpc, this.vpcsById, this.vpcsByIdUnavailable, required this.accountId, });
