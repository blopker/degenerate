...
@immutable
final class ResponseCommon69Result {
  const ResponseCommon69Result({this.mapStringdynamic = const Omittable.absent(),
this.listdynamic = const Omittable.absent(),
this.string = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseCommon69Result._({required this.rawValue, required this.mapStringdynamic,
required this.listdynamic,
required this.string,});
  factory ResponseCommon69Result.fromJson(Object? json) => ResponseCommon69Result._(
...
if (string.isPresent) string.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseCommon69Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseCommon69Result(${toJson()})';
}
