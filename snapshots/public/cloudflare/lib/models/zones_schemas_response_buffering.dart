...
@immutable final class ZonesSchemasResponseBuffering {const ZonesSchemasResponseBuffering({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
