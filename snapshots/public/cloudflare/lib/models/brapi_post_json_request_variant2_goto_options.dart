...
@immutable final class BrapiPostJsonRequestVariant2GotoOptions {const BrapiPostJsonRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostJsonRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) {return BrapiPostJsonRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostJsonRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
);}
