...
@immutable final class BrapiPostJsonRequestVariant2GotoOptions {const BrapiPostJsonRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
