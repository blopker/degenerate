...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages11_tools_variant1_parameters.dart';@immutable final class Messages11ToolsVariant1 {const Messages11ToolsVariant1({required this.description, required this.name, required this.parameters, });
