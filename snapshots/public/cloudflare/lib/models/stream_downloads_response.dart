...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'stream_downloads_response_result.dart';import 'stream_messages2.dart';@immutable final class StreamDownloadsResponse {const StreamDownloadsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
StreamDownloadsResponse copyWith({List<StreamMessages2>? errors, List<StreamMessages2>? messages, bool? success, StreamDownloadsResponseResult? Function()? result, }) { return StreamDownloadsResponse(
...
@override String toString() { return 'StreamDownloadsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
