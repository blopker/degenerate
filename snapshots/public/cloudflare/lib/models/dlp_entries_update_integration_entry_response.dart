...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_integration_entry.dart';import 'dlp_messages2.dart';@immutable final class DlpEntriesUpdateIntegrationEntryResponse {const DlpEntriesUpdateIntegrationEntryResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'DlpEntriesUpdateIntegrationEntryResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
