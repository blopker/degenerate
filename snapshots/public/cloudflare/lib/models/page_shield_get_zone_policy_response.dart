...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'page_shield_messages2.dart';import 'page_shield_policy_with_id.dart';@immutable final class PageShieldGetZonePolicyResponse {const PageShieldGetZonePolicyResponse({required this.success, required this.result, this.errors, this.messages, });
...
PageShieldGetZonePolicyResponse copyWith({List<PageShieldMessages2>? Function()? errors, List<PageShieldMessages2>? Function()? messages, bool? success, PageShieldPolicyWithId? result, }) { return PageShieldGetZonePolicyResponse(
...
@override String toString() { return 'PageShieldGetZonePolicyResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
