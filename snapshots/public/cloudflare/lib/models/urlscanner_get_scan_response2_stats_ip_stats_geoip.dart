...
UrlscannerGetScanResponse2StatsIpStatsGeoip copyWith({String? city, String? country, String? countryName, List<double>? ll, String? region, }) { return UrlscannerGetScanResponse2StatsIpStatsGeoip(
  city: city ?? this.city,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UrlscannerGetScanResponse2StatsIpStatsGeoip &&
          city == other.city &&
...
@override String toString() { return 'UrlscannerGetScanResponse2StatsIpStatsGeoip(city: $city, country: $country, countryName: $countryName, ll: $ll, region: $region)'; } 
 }
