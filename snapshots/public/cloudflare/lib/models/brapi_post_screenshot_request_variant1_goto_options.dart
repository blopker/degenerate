...
@immutable final class BrapiPostScreenshotRequestVariant1GotoOptions {const BrapiPostScreenshotRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostScreenshotRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostScreenshotRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
); }
