...
factory LoadBalancingMonitorReferencesResponse.fromJson(Map<String, dynamic> json) { return LoadBalancingMonitorReferencesResponse(
  ...
  result: (json['result'] as List<dynamic>).map((e) => LoadBalancingMonitorReferencesResponseResult.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
final List<LoadBalancingMonitorReferencesResponseResult> result;
...
LoadBalancingMonitorReferencesResponse copyWith({List<LoadBalancingMessages2>? errors, List<LoadBalancingMessages2>? messages, bool? success, List<LoadBalancingMonitorReferencesResponseResult>? result, }) { return LoadBalancingMonitorReferencesResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is LoadBalancingMonitorReferencesResponse &&
...
@override String toString() { return 'LoadBalancingMonitorReferencesResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
