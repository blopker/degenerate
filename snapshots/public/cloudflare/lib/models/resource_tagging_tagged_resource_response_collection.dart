...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'resource_tagging_cursor_result_info.dart';import 'resource_tagging_messages2.dart';import 'resource_tagging_tagged_resource_object.dart';@immutable final class ResourceTaggingTaggedResourceResponseCollection {const ResourceTaggingTaggedResourceResponseCollection({required this.errors, required this.messages, required this.success, this.result, this.resultInfo, });
