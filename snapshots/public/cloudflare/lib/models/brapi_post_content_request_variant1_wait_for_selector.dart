...
BrapiPostContentRequestVariant1WaitForSelector copyWith({bool Function()? hidden, String? selector, double Function()? timeout, bool Function()? visible, }) { return BrapiPostContentRequestVariant1WaitForSelector(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostContentRequestVariant1WaitForSelector &&
          hidden == other.hidden &&
          selector == other.selector &&
          timeout == other.timeout &&
          visible == other.visible; } 
@override int get hashCode { return Object.hash(hidden, selector, timeout, visible); } 
@override String toString() { return 'BrapiPostContentRequestVariant1WaitForSelector(hidden: $hidden, selector: $selector, timeout: $timeout, visible: $visible)'; } 
 }
