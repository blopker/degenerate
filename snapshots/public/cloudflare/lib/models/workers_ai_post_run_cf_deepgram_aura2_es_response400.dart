...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_ai_post_run_cf_deepgram_aura2_es_response400_errors.dart';final class WorkersAiPostRunCfDeepgramAura2EsResponse400 {const WorkersAiPostRunCfDeepgramAura2EsResponse400({required this.errors, required this.result, required this.success, });
