...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_queue.dart';import 'queues_list_response_result_info.dart';final class QueuesListResponse {const QueuesListResponse({this.errors, this.messages, this.success, this.result, this.resultInfo, });
