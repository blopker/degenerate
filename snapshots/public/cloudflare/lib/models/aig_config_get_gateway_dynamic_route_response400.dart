...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_get_gateway_dynamic_route_response400_errors.dart';final class AigConfigGetGatewayDynamicRouteResponse400 {const AigConfigGetGatewayDynamicRouteResponse400({required this.errors, required this.result, required this.success, });
