...
final class AigConfigGetGatewayDynamicRouteVersionResponse400Errors {const AigConfigGetGatewayDynamicRouteVersionResponse400Errors({required this.message});
