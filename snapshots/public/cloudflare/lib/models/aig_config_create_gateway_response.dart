...
import 'aig_config_create_gateway_response_result.dart';final class AigConfigCreateGatewayResponse {const AigConfigCreateGatewayResponse({required this.result, required this.success, });
