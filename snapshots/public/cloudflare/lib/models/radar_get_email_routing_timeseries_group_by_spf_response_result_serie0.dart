...
RadarGetEmailRoutingTimeseriesGroupBySpfResponseResultSerie0 copyWith({List<String>? fail, List<String>? none, List<String>? pass, }) { return RadarGetEmailRoutingTimeseriesGroupBySpfResponseResultSerie0(
  fail: fail ?? this.fail,
  none: none ?? this.none,
  pass: pass ?? this.pass,
); } 
...
@override String toString() { return 'RadarGetEmailRoutingTimeseriesGroupBySpfResponseResultSerie0(fail: $fail, none: $none, pass: $pass)'; } 
 }
