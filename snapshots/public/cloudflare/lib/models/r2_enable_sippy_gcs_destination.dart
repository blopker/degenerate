...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class R2EnableSippyGcsDestinationProvider {const R2EnableSippyGcsDestinationProvider._(this.value);
...
@immutable final class R2EnableSippyGcsDestination {const R2EnableSippyGcsDestination({this.accessKeyId, this.provider, this.secretAccessKey, });
