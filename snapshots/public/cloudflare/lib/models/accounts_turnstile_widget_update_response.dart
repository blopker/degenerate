...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'turnstile_messages2.dart';import 'turnstile_widget_detail.dart';@immutable final class AccountsTurnstileWidgetUpdateResponse {const AccountsTurnstileWidgetUpdateResponse({required this.errors, required this.messages, required this.success, this.result, });
