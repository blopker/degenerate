...
final class Prompt19ResponseFormatType {const Prompt19ResponseFormatType._(this.value);
...
final class Prompt19ResponseFormat {const Prompt19ResponseFormat({this.jsonSchema, this.type, });
