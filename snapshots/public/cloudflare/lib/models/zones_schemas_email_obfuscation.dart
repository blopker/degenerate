...
@immutable final class ZonesSchemasEmailObfuscation {const ZonesSchemasEmailObfuscation({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesSchemasEmailObfuscation copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesEmailObfuscationValue? value, }) { return ZonesSchemasEmailObfuscation(
