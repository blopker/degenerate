...
@immutable final class ZonesSchemasEmailObfuscation {const ZonesSchemasEmailObfuscation({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
