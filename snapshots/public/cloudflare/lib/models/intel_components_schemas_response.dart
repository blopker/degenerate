...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_ip_list.dart';import 'intel_messages2.dart';import 'intel_result_info.dart';@immutable final class IntelComponentsSchemasResponse {const IntelComponentsSchemasResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
IntelComponentsSchemasResponse copyWith({List<IntelMessages2>? errors, List<IntelMessages2>? messages, List<IntelIpList>? result, bool? success, IntelResultInfo Function()? resultInfo, }) { return IntelComponentsSchemasResponse(
...
@override String toString() { return 'IntelComponentsSchemasResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
