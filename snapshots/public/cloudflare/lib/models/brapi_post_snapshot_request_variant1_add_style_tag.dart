...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class BrapiPostSnapshotRequestVariant1AddStyleTag {const BrapiPostSnapshotRequestVariant1AddStyleTag({this.content, this.url, });
