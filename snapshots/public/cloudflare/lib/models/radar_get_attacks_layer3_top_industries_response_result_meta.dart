...
final class RadarGetAttacksLayer3TopIndustriesResponseResultMetaNormalization {const RadarGetAttacksLayer3TopIndustriesResponseResultMetaNormalization._(this.value);
...
final class RadarGetAttacksLayer3TopIndustriesResponseResultMeta {const RadarGetAttacksLayer3TopIndustriesResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
