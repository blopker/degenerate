...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages29ResponseFormatType {const Messages29ResponseFormatType._(this.value);
...
@immutable final class Messages29ResponseFormat {const Messages29ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages29ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages29ResponseFormatType? Function()? type, }) { return Messages29ResponseFormat(
