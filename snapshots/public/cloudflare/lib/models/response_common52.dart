...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'public_ip_messages2.dart';@immutable final class ResponseCommon52 {const ResponseCommon52({required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ResponseCommon52(errors: $errors, messages: $messages, success: $success)'; } 
 }
