...
import 'logpush_destination_conf.dart';final class PostAccountsAccountIdLogpushOwnershipRequest {const PostAccountsAccountIdLogpushOwnershipRequest({required this.destinationConf});
