...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_leaked_credential_checks_summary_by_bot_class_response400_errors.dart';final class RadarGetLeakedCredentialChecksSummaryByBotClassResponse400 {const RadarGetLeakedCredentialChecksSummaryByBotClassResponse400({required this.errors, required this.result, required this.success, });
