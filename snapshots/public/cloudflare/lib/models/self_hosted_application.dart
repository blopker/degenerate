...
factory SelfHostedApplication.fromJson(Map<String, dynamic> json) { return SelfHostedApplication(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => SelfHostedApplicationPoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
); }
...
final List<SelfHostedApplicationPolicies>? policies;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SelfHostedApplication &&
