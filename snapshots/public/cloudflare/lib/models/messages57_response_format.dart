...
final class Messages57ResponseFormatType {const Messages57ResponseFormatType._(this.value);
...
static const Messages57ResponseFormatType jsonSchema = Messages57ResponseFormatType._('json_schema');

static const List<Messages57ResponseFormatType> values = [jsonObject, jsonSchema];
...
final class Messages57ResponseFormat {const Messages57ResponseFormat({this.jsonSchema, this.type, });
...
Messages57ResponseFormat copyWith({dynamic Function()? jsonSchema, Messages57ResponseFormatType Function()? type, }) { return Messages57ResponseFormat(
