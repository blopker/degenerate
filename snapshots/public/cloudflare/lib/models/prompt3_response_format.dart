...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt3ResponseFormatType {const Prompt3ResponseFormatType._(this.value);
...
@immutable final class Prompt3ResponseFormat {const Prompt3ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt3ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt3ResponseFormatType? Function()? type, }) { return Prompt3ResponseFormat(
