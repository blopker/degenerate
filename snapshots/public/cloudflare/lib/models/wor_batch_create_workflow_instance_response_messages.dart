...
final class WorBatchCreateWorkflowInstanceResponseMessages {const WorBatchCreateWorkflowInstanceResponseMessages({required this.code, required this.message, });
