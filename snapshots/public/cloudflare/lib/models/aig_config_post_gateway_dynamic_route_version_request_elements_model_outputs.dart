...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_post_gateway_dynamic_route_version_request_elements_model_outputs_fallback.dart';import 'aig_config_post_gateway_dynamic_route_version_request_elements_model_outputs_success.dart';@immutable final class AigConfigPostGatewayDynamicRouteVersionRequestElementsModelOutputs {const AigConfigPostGatewayDynamicRouteVersionRequestElementsModelOutputs({required this.fallback, required this.success, });
