...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetAiInferenceTimeseriesGroupResponse400Errors {const RadarGetAiInferenceTimeseriesGroupResponse400Errors({required this.message});
