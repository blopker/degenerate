...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_components_schemas_uuid.dart';import 'zero_trust_gateway_contents.dart';import 'zero_trust_gateway_pacfiles_components_schemas_description.dart';import 'zero_trust_gateway_pacfiles_components_schemas_name.dart';import 'zero_trust_gateway_read_only_timestamp.dart';import 'zero_trust_gateway_slug.dart';import 'zero_trust_gateway_url.dart';@immutable final class ZeroTrustGatewayPacfile {const ZeroTrustGatewayPacfile({this.contents, this.createdAt, this.description, this.id, this.name, this.slug, this.updatedAt, this.url, });
