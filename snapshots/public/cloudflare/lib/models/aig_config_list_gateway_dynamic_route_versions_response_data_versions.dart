...
@immutable final class AigConfigListGatewayDynamicRouteVersionsResponseDataVersions {const AigConfigListGatewayDynamicRouteVersionsResponseDataVersions({required this.active, required this.createdAt, required this.data, required this.versionId, this.comment, });
