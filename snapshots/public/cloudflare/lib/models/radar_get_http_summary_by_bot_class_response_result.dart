...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_summary_by_bot_class_response_result_meta.dart';import 'radar_get_http_summary_by_bot_class_response_result_summary0.dart';@immutable final class RadarGetHttpSummaryByBotClassResponseResult {const RadarGetHttpSummaryByBotClassResponseResult({required this.meta, required this.summary0, });
