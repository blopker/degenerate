...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waf_managed_rules_messages2.dart';@immutable final class ResponseCommonFailure76 {const ResponseCommonFailure76({required this.errors, required this.messages, required this.result, required this.success, });
