...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_hostname_route.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';@immutable final class TunnelHostnameRouteResponseCollection {const TunnelHostnameRouteResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelHostnameRouteResponseCollection copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelHostnameRoute>? result, bool? success, TunnelResultInfo? Function()? resultInfo, }) { return TunnelHostnameRouteResponseCollection(
...
@override String toString() { return 'TunnelHostnameRouteResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
