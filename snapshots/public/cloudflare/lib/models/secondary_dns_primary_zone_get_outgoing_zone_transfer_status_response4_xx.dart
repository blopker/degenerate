...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'secondary_dns_messages2.dart';@immutable final class SecondaryDnsPrimaryZoneGetOutgoingZoneTransferStatusResponse4Xx {const SecondaryDnsPrimaryZoneGetOutgoingZoneTransferStatusResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'SecondaryDnsPrimaryZoneGetOutgoingZoneTransferStatusResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
