...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';import 'iam_token_base.dart';@immutable final class IamCollectionTokensResponse {const IamCollectionTokensResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionTokensResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamTokenBase>? Function()? result, }) { return IamCollectionTokensResponse(
...
@override String toString() { return 'IamCollectionTokensResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
