...
final class EmailSecurityBatchSendingDomainRestrictionsResponseResultDeletes {const EmailSecurityBatchSendingDomainRestrictionsResponseResultDeletes({required this.id});
