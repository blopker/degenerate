...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bundle_custom_scan.dart';import 'bundle_messages2.dart';@immutable final class BundleResponseCustomScanCollection {const BundleResponseCustomScanCollection({required this.errors, required this.messages, required this.result, required this.success, });
...
BundleResponseCustomScanCollection copyWith({List<BundleMessages2>? errors, List<BundleMessages2>? messages, List<BundleCustomScan>? result, bool? success, }) { return BundleResponseCustomScanCollection(
...
@override String toString() { return 'BundleResponseCustomScanCollection(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
