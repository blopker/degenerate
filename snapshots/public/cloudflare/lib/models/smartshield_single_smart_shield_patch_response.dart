...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'smartshield_messages2.dart';import 'smartshield_smart_shield_settings_patch_response.dart';@immutable final class SmartshieldSingleSmartShieldPatchResponse {const SmartshieldSingleSmartShieldPatchResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
SmartshieldSingleSmartShieldPatchResponse copyWith({List<SmartshieldMessages2>? errors, List<SmartshieldMessages2>? messages, SmartshieldSmartShieldSettingsPatchResponse? result, bool? success, }) { return SmartshieldSingleSmartShieldPatchResponse(
...
@override String toString() { return 'SmartshieldSingleSmartShieldPatchResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
