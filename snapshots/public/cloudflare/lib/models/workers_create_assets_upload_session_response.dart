...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_create_assets_upload_session_response_result.dart';import 'workers_messages2.dart';final class WorkersCreateAssetsUploadSessionResponse {const WorkersCreateAssetsUploadSessionResponse({required this.errors, required this.messages, required this.success, this.result, });
