...
final class DnsRecordsDnsRecordPost {
  const DnsRecordsDnsRecordPost({this.dnsRecordsDnsRecordWithoutData = const Omittable.absent(),
this.dnsRecordsDnsRecordWithData = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DnsRecordsDnsRecordPost._({required this.rawValue, required this.dnsRecordsDnsRecordWithoutData,
required this.dnsRecordsDnsRecordWithData,});
  factory DnsRecordsDnsRecordPost.fromJson(Object? json) => DnsRecordsDnsRecordPost._(
...
if (dnsRecordsDnsRecordWithData.isPresent) dnsRecordsDnsRecordWithData.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DnsRecordsDnsRecordPost && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DnsRecordsDnsRecordPost(${toJson()})';
}
