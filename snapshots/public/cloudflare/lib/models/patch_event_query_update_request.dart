...
final class PatchEventQueryUpdateRequest {const PatchEventQueryUpdateRequest({this.alertEnabled, this.alertRollupEnabled, this.name, this.queryJson, this.ruleEnabled, this.ruleScope, });
