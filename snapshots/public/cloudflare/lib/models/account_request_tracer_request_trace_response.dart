...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_request_tracer_request_trace_response_result.dart';import 'request_tracer_messages2.dart';final class AccountRequestTracerRequestTraceResponse {const AccountRequestTracerRequestTraceResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'AccountRequestTracerRequestTraceResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
