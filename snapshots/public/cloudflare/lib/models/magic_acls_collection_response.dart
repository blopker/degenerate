...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_acl.dart';import 'magic_messages2.dart';@immutable final class MagicAclsCollectionResponse {const MagicAclsCollectionResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
MagicAclsCollectionResponse copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, List<MagicAcl>? result, bool? success, }) { return MagicAclsCollectionResponse(
...
@override String toString() { return 'MagicAclsCollectionResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
