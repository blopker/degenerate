...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'botnet_threat_feed_get_full_report_response_result.dart';import 'dos_messages2.dart';@immutable final class BotnetThreatFeedGetFullReportResponse {const BotnetThreatFeedGetFullReportResponse({required this.errors, required this.messages, required this.success, this.result, });
