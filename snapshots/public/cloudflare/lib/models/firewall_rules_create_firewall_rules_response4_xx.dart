...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';@immutable final class FirewallRulesCreateFirewallRulesResponse4Xx {const FirewallRulesCreateFirewallRulesResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() { return 'FirewallRulesCreateFirewallRulesResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
