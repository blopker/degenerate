...
@immutable final class ZonesTransformationsAllowedOrigins {const ZonesTransformationsAllowedOrigins({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
