...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostCategoryUpdateRequest {const PostCategoryUpdateRequest({this.killChain, this.mitreAttack, this.name, this.shortname, });
