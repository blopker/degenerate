...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_delete_providers_response404_errors.dart';@immutable final class AigConfigDeleteProvidersResponse404 {const AigConfigDeleteProvidersResponse404({required this.errors, required this.success, });
