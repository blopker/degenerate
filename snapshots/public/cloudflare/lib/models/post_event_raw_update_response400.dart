...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_event_raw_update_response400_errors.dart';final class PostEventRawUpdateResponse400 {const PostEventRawUpdateResponse400({required this.errors, required this.result, required this.success, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostEventRawUpdateResponse400 &&
          listEquals(errors, other.errors) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), result, success); } 
@override String toString() { return 'PostEventRawUpdateResponse400(errors: $errors, result: $result, success: $success)'; } 
 }
