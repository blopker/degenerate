...
final class RadarGetOriginsSummaryResponseResultMetaDateRange {const RadarGetOriginsSummaryResponseResultMetaDateRange({required this.endTime, required this.startTime, });
