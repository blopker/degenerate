...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt8 {const Prompt8({required this.prompt, this.frequencyPenalty, this.guidedJson, this.maxTokens, this.presencePenalty, this.raw, this.repetitionPenalty, this.seed, this.stream, this.temperature, this.topK, this.topP, });
...
Prompt8 copyWith({double? Function()? frequencyPenalty, Map<String, dynamic>? Function()? guidedJson, int? Function()? maxTokens, double? Function()? presencePenalty, String? prompt, bool? Function()? raw, double? Function()? repetitionPenalty, int? Function()? seed, bool? Function()? stream, double? Function()? temperature, int? Function()? topK, double? Function()? topP, }) { return Prompt8(
...
@override String toString() { return 'Prompt8(frequencyPenalty: $frequencyPenalty, guidedJson: $guidedJson, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
