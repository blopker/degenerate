...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'billing_history.dart';import 'messages5.dart';import 'result_info.dart';@immutable final class BillingHistoryCollection {const BillingHistoryCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
BillingHistoryCollection copyWith({List<Messages5>? errors, List<Messages5>? messages, List<BillingHistory>? result, bool? success, ResultInfo Function()? resultInfo, }) { return BillingHistoryCollection(
...
@override String toString() { return 'BillingHistoryCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
