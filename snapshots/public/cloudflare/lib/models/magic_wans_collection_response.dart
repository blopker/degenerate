...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_messages2.dart';import 'magic_wan.dart';@immutable final class MagicWansCollectionResponse {const MagicWansCollectionResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
MagicWansCollectionResponse copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, List<MagicWan>? result, bool? success, }) { return MagicWansCollectionResponse(
...
@override String toString() { return 'MagicWansCollectionResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
