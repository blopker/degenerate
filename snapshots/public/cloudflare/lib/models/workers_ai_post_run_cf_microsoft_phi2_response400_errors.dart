...
WorkersAiPostRunCfMicrosoftPhi2Response400Errors copyWith({String? code, String? message, }) { return WorkersAiPostRunCfMicrosoftPhi2Response400Errors(
  code: code ?? this.code,
  message: message ?? this.message,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersAiPostRunCfMicrosoftPhi2Response400Errors &&
          code == other.code &&
          message == other.message; } 
@override int get hashCode { return Object.hash(code, message); } 
@override String toString() { return 'WorkersAiPostRunCfMicrosoftPhi2Response400Errors(code: $code, message: $message)'; } 
 }
