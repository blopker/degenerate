...
import 'radar_get_http_timeseries_group_by_bot_class_response_result.dart';final class RadarGetHttpTimeseriesGroupByBotClassResponse {const RadarGetHttpTimeseriesGroupByBotClassResponse({required this.result, required this.success, });
