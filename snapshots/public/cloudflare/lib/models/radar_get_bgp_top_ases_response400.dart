...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bgp_top_ases_response400_errors.dart';@immutable final class RadarGetBgpTopAsesResponse400 {const RadarGetBgpTopAsesResponse400({required this.errors, required this.result, required this.success, });
