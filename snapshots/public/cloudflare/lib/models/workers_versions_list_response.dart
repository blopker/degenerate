...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_versions_list_response_result.dart';@immutable final class WorkersVersionsListResponse {const WorkersVersionsListResponse({required this.errors, required this.messages, required this.success, required this.result, });
