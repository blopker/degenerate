...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_schemas_messages2.dart';import 'user_s_account_memberships_delete_membership_response_result.dart';@immutable final class UserSAccountMembershipsDeleteMembershipResponse {const UserSAccountMembershipsDeleteMembershipResponse({required this.errors, required this.messages, required this.success, this.result, });
...
UserSAccountMembershipsDeleteMembershipResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, UserSAccountMembershipsDeleteMembershipResponseResult? Function()? result, }) { return UserSAccountMembershipsDeleteMembershipResponse(
...
@override String toString() { return 'UserSAccountMembershipsDeleteMembershipResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
