...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';import 'tunnel_virtual_network.dart';@immutable final class TunnelVnetResponseCollection {const TunnelVnetResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelVnetResponseCollection copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelVirtualNetwork>? result, bool? success, TunnelResultInfo? Function()? resultInfo, }) { return TunnelVnetResponseCollection(
...
@override String toString() { return 'TunnelVnetResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
