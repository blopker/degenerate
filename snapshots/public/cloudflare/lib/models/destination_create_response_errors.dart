...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class DestinationCreateResponseErrors {const DestinationCreateResponseErrors({required this.message});
