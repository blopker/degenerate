...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';import 'tunnel_tunnel_client.dart';@immutable final class TunnelTunnelConnectionsResponse {const TunnelTunnelConnectionsResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelTunnelConnectionsResponse copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelTunnelClient>? result, bool? success, TunnelResultInfo? Function()? resultInfo, }) { return TunnelTunnelConnectionsResponse(
...
@override String toString() { return 'TunnelTunnelConnectionsResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
