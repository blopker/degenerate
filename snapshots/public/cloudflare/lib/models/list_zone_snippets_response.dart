...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'snippets_message.dart';import 'snippets_result_info.dart';import 'snippets_snippet.dart';final class ListZoneSnippetsResponse {const ListZoneSnippetsResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
