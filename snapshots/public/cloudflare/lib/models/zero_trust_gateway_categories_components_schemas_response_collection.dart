...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_categories.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_result_info.dart';@immutable final class ZeroTrustGatewayCategoriesComponentsSchemasResponseCollection {const ZeroTrustGatewayCategoriesComponentsSchemasResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
@override String toString() { return 'ZeroTrustGatewayCategoriesComponentsSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
