...
final class ZeroTrustGatewayDnsResolverSettings {const ZeroTrustGatewayDnsResolverSettings({required this.ip, this.port, this.routeThroughPrivateNetwork, this.vnetId, });
