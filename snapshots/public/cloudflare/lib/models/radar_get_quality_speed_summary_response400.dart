...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_quality_speed_summary_response400_errors.dart';final class RadarGetQualitySpeedSummaryResponse400 {const RadarGetQualitySpeedSummaryResponse400({required this.errors, required this.result, required this.success, });
