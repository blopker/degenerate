...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultMetaUnits {const RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultMetaUnits({required this.name, required this.value, });
