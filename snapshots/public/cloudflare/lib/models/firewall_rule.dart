...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_asn_configuration.dart';import 'firewall_cidr_configuration.dart';import 'firewall_configuration.dart';import 'firewall_country_configuration.dart';import 'firewall_ip_configuration.dart';import 'firewall_ipv6_configuration.dart';import 'firewall_notes.dart';import 'firewall_schemas_identifier.dart';import 'firewall_schemas_mode.dart';@immutable final class FirewallRule {const FirewallRule({required this.allowedModes, required this.configuration, required this.id, required this.mode, this.createdOn, this.modifiedOn, this.notes, });
