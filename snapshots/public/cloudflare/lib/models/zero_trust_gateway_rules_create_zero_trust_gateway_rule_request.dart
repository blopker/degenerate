...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_action.dart';import 'zero_trust_gateway_components_schemas_name.dart';import 'zero_trust_gateway_device_posture.dart';import 'zero_trust_gateway_enabled.dart';import 'zero_trust_gateway_expiration.dart';import 'zero_trust_gateway_filters2.dart';import 'zero_trust_gateway_identity.dart';import 'zero_trust_gateway_precedence.dart';import 'zero_trust_gateway_rule_settings.dart';import 'zero_trust_gateway_schedule.dart';import 'zero_trust_gateway_schemas_description.dart';import 'zero_trust_gateway_traffic.dart';final class ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequest {const ZeroTrustGatewayRulesCreateZeroTrustGatewayRuleRequest({required this.action, this.description, this.devicePosture, this.enabled, this.expiration, this.filters, this.identity, required this.name, this.precedence, this.ruleSettings, this.schedule, this.traffic, });
