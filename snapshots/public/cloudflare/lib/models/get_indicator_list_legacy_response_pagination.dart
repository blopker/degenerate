...
final class GetIndicatorListLegacyResponsePagination {const GetIndicatorListLegacyResponsePagination({required this.page, required this.pageSize, required this.totalCount, required this.totalPages, });
