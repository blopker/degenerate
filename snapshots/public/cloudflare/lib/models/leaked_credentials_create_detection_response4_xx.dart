...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bundle_messages2.dart';@immutable final class LeakedCredentialsCreateDetectionResponse4Xx {const LeakedCredentialsCreateDetectionResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'LeakedCredentialsCreateDetectionResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
