...
static const DeleteServersResponseResultAuthType oauth = DeleteServersResponseResultAuthType._('oauth');

static const DeleteServersResponseResultAuthType bearer = DeleteServersResponseResultAuthType._('bearer');

static const DeleteServersResponseResultAuthType unauthenticated = DeleteServersResponseResultAuthType._('unauthenticated');

static const List<DeleteServersResponseResultAuthType> values = [oauth, bearer, unauthenticated];
...
@immutable final class DeleteServersResponseResult {const DeleteServersResponseResult({required this.authType, required this.hostname, required this.id, required this.name, required this.prompts, required this.tools, this.createdAt, this.createdBy, this.description = const Omittable.absent(), this.error, this.lastSuccessfulSync, this.lastSynced, this.modifiedAt, this.modifiedBy, this.status = 'waiting', });
...
DeleteServersResponseResult copyWith({DeleteServersResponseResultAuthType? authType, DateTime? Function()? createdAt, String? Function()? createdBy, Omittable<String?>? description, String? Function()? error, Uri? hostname, String? id, DateTime? Function()? lastSuccessfulSync, DateTime? Function()? lastSynced, DateTime? Function()? modifiedAt, String? Function()? modifiedBy, String? name, List<Map<String,dynamic>>? prompts, String Function()? status, List<Map<String,dynamic>>? tools, }) { return DeleteServersResponseResult(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DeleteServersResponseResult &&
...
@override String toString() { return 'DeleteServersResponseResult(authType: $authType, createdAt: $createdAt, createdBy: $createdBy, description: $description, error: $error, hostname: $hostname, id: $id, lastSuccessfulSync: $lastSuccessfulSync, lastSynced: $lastSynced, modifiedAt: $modifiedAt, modifiedBy: $modifiedBy, name: $name, prompts: $prompts, status: $status, tools: $tools)'; } 
 }
