...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_domain.dart';import 'workers_messages2.dart';@immutable final class WorkersDomainResponseSingle {const WorkersDomainResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'WorkersDomainResponseSingle(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
