...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloud_connector_messages2.dart';final class ResponseCommon12 {const ResponseCommon12({required this.errors, required this.messages, required this.success, });
...
ResponseCommon12 copyWith({List<CloudConnectorMessages2>? errors, List<CloudConnectorMessages2>? messages, bool? success, }) { return ResponseCommon12(
  errors: errors ?? this.errors,
  messages: messages ?? this.messages,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseCommon12 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success); } 
@override String toString() { return 'ResponseCommon12(errors: $errors, messages: $messages, success: $success)'; } 
 }
