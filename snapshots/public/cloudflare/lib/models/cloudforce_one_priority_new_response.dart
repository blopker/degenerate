...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudforce_one_requests_messages2.dart';import 'cloudforce_one_requests_priority_item.dart';final class CloudforceOnePriorityNewResponse {const CloudforceOnePriorityNewResponse({required this.errors, required this.messages, required this.success, this.result, });
