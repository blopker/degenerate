...
final class RadarGetBgpHijacksEventsResponseResultAsnInfo {const RadarGetBgpHijacksEventsResponseResultAsnInfo({required this.asn, required this.countryCode, required this.orgName, });
