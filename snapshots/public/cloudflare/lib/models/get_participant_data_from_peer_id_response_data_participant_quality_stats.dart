...
factory GetParticipantDataFromPeerIdResponseDataParticipantQualityStats.fromJson(Map<String, dynamic> json) { return GetParticipantDataFromPeerIdResponseDataParticipantQualityStats(
  ...
  end: json.containsKey('end') ? Omittable(json['end'] as String?) : const Omittable.absent(),
  ...
  start: json.containsKey('start') ? Omittable(json['start'] as String?) : const Omittable.absent(),
...
Map<String, dynamic> toJson() { return {
  ...
  'peer_ids': ?peerIds,
  if (start.isPresent) 'start': start.value,
