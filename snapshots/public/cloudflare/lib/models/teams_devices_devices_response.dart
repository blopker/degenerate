...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_devices.dart';import 'teams_devices_messages2.dart';import 'teams_devices_result_info.dart';@immutable final class TeamsDevicesDevicesResponse {const TeamsDevicesDevicesResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TeamsDevicesDevicesResponse copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesDevices>? result, bool? success, TeamsDevicesResultInfo Function()? resultInfo, }) { return TeamsDevicesDevicesResponse(
...
@override String toString() { return 'TeamsDevicesDevicesResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
