...
import 'aig_config_fetch_evaluations_response_result.dart';final class AigConfigFetchEvaluationsResponse {const AigConfigFetchEvaluationsResponse({required this.result, required this.success, });
