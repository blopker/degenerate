...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_timeseries_group_by_http_version_response_result_meta_confidence_info_annotations.dart';final class RadarGetHttpTimeseriesGroupByHttpVersionResponseResultMetaConfidenceInfo {const RadarGetHttpTimeseriesGroupByHttpVersionResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
