...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'alexandria_messages2.dart';@immutable final class ResponseCommonFailure6 {const ResponseCommonFailure6({required this.errors, required this.messages, required this.result, required this.success, });
