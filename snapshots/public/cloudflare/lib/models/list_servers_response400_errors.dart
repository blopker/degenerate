...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ListServersResponse400Errors {const ListServersResponse400Errors({required this.message});
