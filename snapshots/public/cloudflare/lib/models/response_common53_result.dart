...
final class ResponseCommon53Result {
  const ResponseCommon53Result({this.mapStringdynamic = const Omittable.absent(),
this.listMapStringdynamic = const Omittable.absent(),
this.string = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseCommon53Result._({required this.rawValue, required this.mapStringdynamic,
required this.listMapStringdynamic,
required this.string,});
  factory ResponseCommon53Result.fromJson(Object? json) => ResponseCommon53Result._(
...
if (string.isPresent) string.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseCommon53Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseCommon53Result(${toJson()})';
}
