...
@immutable final class ZonesHotlinkProtection {const ZonesHotlinkProtection({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesHotlinkProtection copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesHotlinkProtectionValue? value, }) { return ZonesHotlinkProtection(
