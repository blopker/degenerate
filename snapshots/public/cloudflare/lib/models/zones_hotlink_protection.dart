...
@immutable final class ZonesHotlinkProtection {const ZonesHotlinkProtection({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
