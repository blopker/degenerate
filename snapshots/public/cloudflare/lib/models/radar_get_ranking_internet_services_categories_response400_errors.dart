...
final class RadarGetRankingInternetServicesCategoriesResponse400Errors {const RadarGetRankingInternetServicesCategoriesResponse400Errors({required this.message});
