...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_create_gateway_response_result_stripe_usage_events.dart';@immutable final class AigConfigCreateGatewayResponseResultStripe {const AigConfigCreateGatewayResponseResultStripe({required this.authorization, required this.usageEvents, });
