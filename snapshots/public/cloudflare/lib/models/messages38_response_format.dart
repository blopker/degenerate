...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages38ResponseFormatType {const Messages38ResponseFormatType._(this.value);
...
@immutable final class Messages38ResponseFormat {const Messages38ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages38ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages38ResponseFormatType? Function()? type, }) { return Messages38ResponseFormat(
