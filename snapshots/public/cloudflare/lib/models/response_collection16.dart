...
factory ResponseCollection16.fromJson(Map<String, dynamic> json) { return ResponseCollection16(
  ...
  resultInfo: json['result_info'] != null ? ResponseCollection16ResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
); }
...
final ResponseCollection16ResultInfo? resultInfo;
...
ResponseCollection16 copyWith({List<DosMessages2>? errors, List<DosMessages2>? messages, bool? success, ResponseCollection16ResultInfo Function()? resultInfo, }) { return ResponseCollection16(
...
@override String toString() { return 'ResponseCollection16(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)'; } 
 }
