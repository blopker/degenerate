...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'fraud_messages2.dart';@immutable final class ResponseCommonFailure35 {const ResponseCommonFailure35({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'ResponseCommonFailure35(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
