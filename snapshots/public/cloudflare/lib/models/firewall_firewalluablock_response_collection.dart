...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_firewalluablock.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';@immutable final class FirewallFirewalluablockResponseCollection {const FirewallFirewalluablockResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallFirewalluablockResponseCollection copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallFirewalluablock>? result, bool? success, FirewallResultInfo Function()? resultInfo, }) { return FirewallFirewalluablockResponseCollection(
...
@override String toString() { return 'FirewallFirewalluablockResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
