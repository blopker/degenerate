...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTimeseriesGroupResponse400Errors {const RadarGetHttpTimeseriesGroupResponse400Errors({required this.message});
