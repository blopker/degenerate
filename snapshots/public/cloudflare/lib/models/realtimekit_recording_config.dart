...
/// 
@immutable final class RealtimekitRecordingConfig {const RealtimekitRecordingConfig({this.audioConfig, this.fileNamePrefix, this.liveStreamingConfig, this.maxSeconds, this.realtimekitBucketConfig, this.storageConfig = const Omittable.absent(), this.videoConfig, });
