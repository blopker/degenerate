...
final class ZoneCacheSettingsChangeRegionalTieredCacheSettingRequest {const ZoneCacheSettingsChangeRegionalTieredCacheSettingRequest({required this.value});
