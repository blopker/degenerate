...
factory Web3HostnameEditWeb3HostnameResponse5Xx.fromJson(Map<String, dynamic> json) { return Web3HostnameEditWeb3HostnameResponse5Xx(
  ...
  resultInfo: json.containsKey('result_info') ? Omittable(json['result_info'] != null ? Web3HostnameEditWeb3HostnameResponse5XxResultInfo.fromJson(json['result_info']) : null) : const Omittable.absent(),
); }
...
final Omittable<Web3HostnameEditWeb3HostnameResponse5XxResultInfo?> resultInfo;
...
Web3HostnameEditWeb3HostnameResponse5Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, Omittable<Web3HostnameEditWeb3HostnameResponse5XxResultInfo?>? resultInfo, }) { return Web3HostnameEditWeb3HostnameResponse5Xx(
...
@override String toString() { return 'Web3HostnameEditWeb3HostnameResponse5Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
