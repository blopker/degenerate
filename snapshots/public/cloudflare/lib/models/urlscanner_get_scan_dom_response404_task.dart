...
final class UrlscannerGetScanDomResponse404Task {const UrlscannerGetScanDomResponse404Task({required this.status, required this.time, required this.url, required this.uuid, required this.visibility, });
