...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'hyperdrive_messages2.dart';@immutable final class ResponseCommon34 {const ResponseCommon34({required this.errors, required this.messages, required this.result, required this.success, });
