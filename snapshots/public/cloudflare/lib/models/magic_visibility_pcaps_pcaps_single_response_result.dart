...
@immutable
final class MagicVisibilityPcapsPcapsSingleResponseResult {
  const MagicVisibilityPcapsPcapsSingleResponseResult({this.magicVisibilityPcapsPcapsResponseSimple = const Omittable.absent(),
this.magicVisibilityPcapsPcapsResponseFull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const MagicVisibilityPcapsPcapsSingleResponseResult._({required this.rawValue, required this.magicVisibilityPcapsPcapsResponseSimple,
required this.magicVisibilityPcapsPcapsResponseFull,});
  factory MagicVisibilityPcapsPcapsSingleResponseResult.fromJson(Object? json) => MagicVisibilityPcapsPcapsSingleResponseResult._(
...
if (magicVisibilityPcapsPcapsResponseFull.isPresent) magicVisibilityPcapsPcapsResponseFull.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is MagicVisibilityPcapsPcapsSingleResponseResult && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'MagicVisibilityPcapsPcapsSingleResponseResult(${toJson()})';
}
