...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_fetch_evaluations_response404_errors.dart';final class AigConfigFetchEvaluationsResponse404 {const AigConfigFetchEvaluationsResponse404({required this.errors, required this.success, });
