...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_binding_name.dart';@immutable final class WorkersBindingKindWasmModule {const WorkersBindingKindWasmModule({required this.name, required this.$part, required this.type, });
