...
final class GetEventRawReadDsResponse {const GetEventRawReadDsResponse({required this.accountId, required this.created, required this.data, required this.id, required this.source, required this.tlp, });
