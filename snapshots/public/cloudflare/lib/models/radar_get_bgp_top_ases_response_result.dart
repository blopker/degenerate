...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bgp_top_ases_response_result_meta.dart';import 'radar_get_bgp_top_ases_response_result_top0.dart';final class RadarGetBgpTopAsesResponseResult {const RadarGetBgpTopAsesResponseResult({required this.meta, required this.top0, });
