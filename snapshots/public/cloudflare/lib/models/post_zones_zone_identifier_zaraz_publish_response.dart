...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zaraz_messages2.dart';final class PostZonesZoneIdentifierZarazPublishResponse {const PostZonesZoneIdentifierZarazPublishResponse({required this.errors, required this.messages, required this.success, required this.result, });
