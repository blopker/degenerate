...
@immutable final class BrapiPostLinksRequestVariant2GotoOptions {const BrapiPostLinksRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
