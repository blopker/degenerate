...
@immutable final class ZonesSchemasTrueClientIpHeader {const ZonesSchemasTrueClientIpHeader({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
