...
@immutable final class ZonesSchemasTrueClientIpHeader {const ZonesSchemasTrueClientIpHeader({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasTrueClientIpHeader copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesTrueClientIpHeaderValue? value, }) { return ZonesSchemasTrueClientIpHeader(
