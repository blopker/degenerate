...
@immutable final class ZarazZarazConfigReturnSettingsContextEnricher {const ZarazZarazConfigReturnSettingsContextEnricher({required this.escapedWorkerName, required this.workerTag, });
