...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_request_rule_request.dart';import 'rulesets_ruleset_kind.dart';import 'rulesets_ruleset_phase.dart';@immutable final class UpdateZoneRulesetRequest {const UpdateZoneRulesetRequest({this.description, this.name, this.kind, this.phase, this.rules, });
...
UpdateZoneRulesetRequest copyWith({String? Function()? description, String? Function()? name, RulesetsRulesetKind? Function()? kind, RulesetsRulesetPhase? Function()? phase, List<RulesetsRequestRuleRequest>? Function()? rules, }) {return UpdateZoneRulesetRequest(
...
@override String toString() {return 'UpdateZoneRulesetRequest(description: $description, name: $name, kind: $kind, phase: $phase, rules: $rules)';}
}
