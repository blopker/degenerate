...
final class BrapiPostContentRequestVariant2Authenticate {const BrapiPostContentRequestVariant2Authenticate({required this.password, required this.username, });
