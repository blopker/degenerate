...
import 'magic_visibility_mnm_mnm_config.dart';final class MagicVisibilityMnmMnmConfigSingleResponse {const MagicVisibilityMnmMnmConfigSingleResponse({this.result});
