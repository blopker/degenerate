...
import 'workers_binding_name.dart';final class WorkersBindingKindVersionMetadata {const WorkersBindingKindVersionMetadata({required this.name, required this.type, });
