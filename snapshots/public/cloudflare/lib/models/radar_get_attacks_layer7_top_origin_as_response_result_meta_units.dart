...
final class RadarGetAttacksLayer7TopOriginAsResponseResultMetaUnits {const RadarGetAttacksLayer7TopOriginAsResponseResultMetaUnits({required this.name, required this.value, });
