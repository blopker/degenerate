...
@immutable final class ZonesPrivacyPass {const ZonesPrivacyPass({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesPrivacyPass copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesPrivacyPassValue? value, }) { return ZonesPrivacyPass(
