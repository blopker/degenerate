...
@immutable final class ZonesPrivacyPass {const ZonesPrivacyPass({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
