...
factory RadarGetDnsTopAsesResponseResult.fromJson(Map<String, dynamic> json) { return RadarGetDnsTopAsesResponseResult(
  ...
  top0: (json['top_0'] as List<dynamic>).map((e) => RadarGetDnsTopAsesResponseResultTop0.fromJson(e as Map<String, dynamic>)).toList(),
); }

/// Metadata for the results.
final RadarGetDnsTopAsesResponseResultMeta meta;

final List<RadarGetDnsTopAsesResponseResultTop0> top0;
...
RadarGetDnsTopAsesResponseResult copyWith({RadarGetDnsTopAsesResponseResultMeta? meta, List<RadarGetDnsTopAsesResponseResultTop0>? top0, }) { return RadarGetDnsTopAsesResponseResult(
  meta: meta ?? this.meta,
  top0: top0 ?? this.top0,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetDnsTopAsesResponseResult &&
          meta == other.meta &&
          listEquals(top0, other.top0); } 
@override int get hashCode { return Object.hash(meta, Object.hashAll(top0)); } 
@override String toString() { return 'RadarGetDnsTopAsesResponseResult(meta: $meta, top0: $top0)'; } 
 }
