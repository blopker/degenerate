...
import 'radar_get_bot_details_response_result.dart';final class RadarGetBotDetailsResponse {const RadarGetBotDetailsResponse({required this.result, required this.success, });
