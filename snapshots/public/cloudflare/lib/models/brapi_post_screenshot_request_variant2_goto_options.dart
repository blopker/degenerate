...
@immutable final class BrapiPostScreenshotRequestVariant2GotoOptions {const BrapiPostScreenshotRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
...
factory BrapiPostScreenshotRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? OneOf5.parse(json['waitUntil'], fromA: (v) => BrapiPostScreenshotRequestVariant2GotoOptionsWaitUntilVariant1.fromJson(v as String), fromB: (v) => BrapiPostScreenshotRequestVariant2GotoOptionsWaitUntilVariant2.fromJson(v as String), fromC: (v) => BrapiPostScreenshotRequestVariant2GotoOptionsWaitUntilVariant3.fromJson(v as String), fromD: (v) => BrapiPostScreenshotRequestVariant2GotoOptionsWaitUntilVariant4.fromJson(v as String), fromE: (v) => (v as List<dynamic>).map((e) => BrapiPostScreenshotRequestVariant2GotoOptionsWaitUntilVariant5.fromJson(e as String)).toList(),) : null,
); }
