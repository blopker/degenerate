...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_messages2.dart';import 'dlp_predefined_entry.dart';@immutable final class DlpEntriesCreatePredefinedEntryResponse {const DlpEntriesCreatePredefinedEntryResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpEntriesCreatePredefinedEntryResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, DlpPredefinedEntry? Function()? result, }) { return DlpEntriesCreatePredefinedEntryResponse(
...
@override String toString() { return 'DlpEntriesCreatePredefinedEntryResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
