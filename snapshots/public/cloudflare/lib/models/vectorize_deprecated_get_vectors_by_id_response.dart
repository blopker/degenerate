...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'vectorize_index_get_vectors_by_id_response2.dart';import 'vectorize_messages2.dart';@immutable final class VectorizeDeprecatedGetVectorsByIdResponse {const VectorizeDeprecatedGetVectorsByIdResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
VectorizeDeprecatedGetVectorsByIdResponse copyWith({List<VectorizeMessages2>? errors, List<VectorizeMessages2>? messages, List<VectorizeIndexGetVectorsByIdResponse2>? result, bool? success, }) { return VectorizeDeprecatedGetVectorsByIdResponse(
...
@override String toString() { return 'VectorizeDeprecatedGetVectorsByIdResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
