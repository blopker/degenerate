...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages33Functions {const Messages33Functions({required this.code, required this.name, });
