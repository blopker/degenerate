...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'allow_mode_switch', 'allow_updates', 'allowed_to_leave', 'auto_connect', 'captive_portal', 'disable_auto_fallback', 'exclude', 'exclude_office_ips', 'include', 'lan_allow_minutes', 'lan_allow_subnet_size', 'register_interface_ip_with_dns', 'sccm_vpn_boundary_support', 'service_mode_v2', 'support_url', 'switch_locked', 'tunnel_protocol'}.contains(key)); } 
