...
final class RadarGetHttpTimeseriesGroupByPostQuantumResponseResultMetaUnits {const RadarGetHttpTimeseriesGroupByPostQuantumResponseResultMetaUnits({required this.name, required this.value, });
