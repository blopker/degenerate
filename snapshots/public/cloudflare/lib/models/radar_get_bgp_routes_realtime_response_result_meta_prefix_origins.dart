...
RadarGetBgpRoutesRealtimeResponseResultMetaPrefixOrigins copyWith({int? origin, String? prefix, String? rpkiValidation, int? totalPeers, int? totalVisible, double? visibility, }) { return RadarGetBgpRoutesRealtimeResponseResultMetaPrefixOrigins(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetBgpRoutesRealtimeResponseResultMetaPrefixOrigins &&
          origin == other.origin &&
          prefix == other.prefix &&
...
@override String toString() { return 'RadarGetBgpRoutesRealtimeResponseResultMetaPrefixOrigins(origin: $origin, prefix: $prefix, rpkiValidation: $rpkiValidation, totalPeers: $totalPeers, totalVisible: $totalVisible, visibility: $visibility)'; } 
 }
