...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_result_info.dart';import 'iam_role.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionRoleResponse {const IamCollectionRoleResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionRoleResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamRole>? Function()? result, }) { return IamCollectionRoleResponse(
...
@override String toString() { return 'IamCollectionRoleResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
