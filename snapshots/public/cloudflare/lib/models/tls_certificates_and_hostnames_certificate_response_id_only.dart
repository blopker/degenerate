...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_certificate_response_id_only_result.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesCertificateResponseIdOnly {const TlsCertificatesAndHostnamesCertificateResponseIdOnly({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesCertificateResponseIdOnly copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesCertificateResponseIdOnlyResult? Function()? result, }) { return TlsCertificatesAndHostnamesCertificateResponseIdOnly(
...
@override String toString() { return 'TlsCertificatesAndHostnamesCertificateResponseIdOnly(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
