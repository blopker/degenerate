...
@immutable final class CacheRulesVariantsResponseValueResult {const CacheRulesVariantsResponseValueResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
CacheRulesVariantsResponseValueResult copyWith({CacheRulesVariantsResponseValueResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesVariantsValue? value, }) { return CacheRulesVariantsResponseValueResult(
  id: id ?? this.id,
