...
@immutable final class ZonesSchemasSecurityLevel {const ZonesSchemasSecurityLevel({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
