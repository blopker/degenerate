...
@immutable final class RadarGetHttpSummaryByTlsVersionResponseResultMetaNormalization {const RadarGetHttpSummaryByTlsVersionResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetHttpSummaryByTlsVersionResponseResultMeta {const RadarGetHttpSummaryByTlsVersionResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
