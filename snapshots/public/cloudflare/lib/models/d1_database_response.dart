...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'd1_created_at.dart';import 'd1_database_identifier.dart';import 'd1_database_name.dart';import 'd1_database_version.dart';import 'd1_jurisdiction_nullable.dart';@immutable final class D1DatabaseResponse {const D1DatabaseResponse({this.createdAt, this.jurisdiction = const Omittable.absent(), this.name, this.uuid, this.version, });
...
D1DatabaseResponse copyWith({D1CreatedAt? Function()? createdAt, Omittable<D1JurisdictionNullable?>? jurisdiction, D1DatabaseName? Function()? name, D1DatabaseIdentifier? Function()? uuid, D1DatabaseVersion? Function()? version, }) { return D1DatabaseResponse(
