...
import 'workers_binding_name.dart';final class WorkersBindingKindMtlsCertificate {const WorkersBindingKindMtlsCertificate({required this.certificateId, required this.name, required this.type, });
