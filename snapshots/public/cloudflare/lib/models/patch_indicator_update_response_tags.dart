...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PatchIndicatorUpdateResponseTags {const PatchIndicatorUpdateResponseTags({this.categoryName, this.uuid, this.value, });
