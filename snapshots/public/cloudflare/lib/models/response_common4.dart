...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';@immutable final class ResponseCommon4 {const ResponseCommon4({required this.errors, required this.messages, required this.success, });
