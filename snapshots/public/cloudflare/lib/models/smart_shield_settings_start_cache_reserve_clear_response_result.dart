...
@immutable final class SmartShieldSettingsStartCacheReserveClearResponseResult {const SmartShieldSettingsStartCacheReserveClearResponseResult({required this.id, required this.startTs, required this.state, this.modifiedOn = const Omittable.absent(), this.endTs, });
...
SmartShieldSettingsStartCacheReserveClearResponseResult copyWith({SmartShieldSettingsStartCacheReserveClearResponseResultId? id, Omittable<DateTime?>? modifiedOn, SmartshieldCacheReserveClearEndTs? Function()? endTs, SmartshieldCacheReserveClearStartTs? startTs, SmartshieldCacheReserveClearState? state, }) { return SmartShieldSettingsStartCacheReserveClearResponseResult(
  id: id ?? this.id,
