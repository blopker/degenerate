...
factory AigConfigCreateGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigCreateGatewayResponseResult(
  ...
  logManagementStrategy: json.containsKey('log_management_strategy') ? Omittable(json['log_management_strategy'] != null ? AigConfigCreateGatewayResponseResultLogManagementStrategy.fromJson(json['log_management_strategy'] as String) : null) : const Omittable.absent(),
  ...
  otel: json.containsKey('otel') ? Omittable((json['otel'] as List<dynamic>?)?.map((e) => AigConfigCreateGatewayResponseResultOtel.fromJson(e as Map<String, dynamic>)).toList()) : const Omittable.absent(),
...
final Omittable<AigConfigCreateGatewayResponseResultLogManagementStrategy?> logManagementStrategy;
...
final Omittable<List<AigConfigCreateGatewayResponseResultOtel>?> otel;
...
final Omittable<AigConfigCreateGatewayResponseResultStripe?> stripe;
