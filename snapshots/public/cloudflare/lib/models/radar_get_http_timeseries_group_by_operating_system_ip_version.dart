...
final class RadarGetHttpTimeseriesGroupByOperatingSystemIpVersion {const RadarGetHttpTimeseriesGroupByOperatingSystemIpVersion._(this.value);
...
@override String toString() { return 'RadarGetHttpTimeseriesGroupByOperatingSystemIpVersion($value)'; } 
 }
