...
final class EmailSecurityListDomainsOrder {const EmailSecurityListDomainsOrder._(this.value);
...
@override String toString() { return 'EmailSecurityListDomainsOrder($value)'; } 
 }
