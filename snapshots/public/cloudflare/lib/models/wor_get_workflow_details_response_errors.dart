...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorGetWorkflowDetailsResponseErrors {const WorGetWorkflowDetailsResponseErrors({required this.code, required this.message, });
