...
return  BrapiPostSnapshotError400(BrapiPostSnapshotResponse400.fromJson(json as Map<String, dynamic>));case 422:
final json = jsonDecode(response.body);
return  BrapiPostSnapshotError422(BrapiPostSnapshotResponse422.fromJson(json as Map<String, dynamic>));case 429:
final json = jsonDecode(response.body);
return  BrapiPostSnapshotError429(BrapiPostSnapshotResponse429.fromJson(json as Map<String, dynamic>));case 500:
final json = jsonDecode(response.body);
return  BrapiPostSnapshotError500(BrapiPostSnapshotResponse500.fromJson(json as Map<String, dynamic>));default:
