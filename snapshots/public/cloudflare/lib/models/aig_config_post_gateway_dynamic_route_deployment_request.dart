...
final class AigConfigPostGatewayDynamicRouteDeploymentRequest {const AigConfigPostGatewayDynamicRouteDeploymentRequest({required this.comment, required this.versionId, });
