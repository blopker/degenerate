...
WorkersAiPostRunCfLykonDreamshaper8LcmResponse400Errors copyWith({String? code, String? message, }) { return WorkersAiPostRunCfLykonDreamshaper8LcmResponse400Errors(
  code: code ?? this.code,
...
@override String toString() { return 'WorkersAiPostRunCfLykonDreamshaper8LcmResponse400Errors(code: $code, message: $message)'; } 
 }
