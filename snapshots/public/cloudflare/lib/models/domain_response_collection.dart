...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'domain_properties.dart';import 'messages32.dart';import 'result_info2.dart';@immutable final class DomainResponseCollection {const DomainResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
DomainResponseCollection copyWith({List<Messages32>? errors, List<Messages32>? messages, List<DomainProperties>? result, bool? success, ResultInfo2 Function()? resultInfo, }) { return DomainResponseCollection(
...
@override String toString() { return 'DomainResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
