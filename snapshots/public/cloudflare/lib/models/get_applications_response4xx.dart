...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'alexandria_messages2.dart';import 'get_applications_response4xx_result_info.dart';@immutable final class GetApplicationsResponse4xx {const GetApplicationsResponse4xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
