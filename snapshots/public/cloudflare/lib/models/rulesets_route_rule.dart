...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_route_rule_action_parameters.dart';import 'rulesets_rule_category.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';@immutable final class RulesetsRouteRule {const RulesetsRouteRule({required this.lastUpdated, required this.version, this.action = const Omittable.absent(), this.actionParameters, this.categories, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsRouteRule.fromJson(Map<String, dynamic> json) { return RulesetsRouteRule(
  action: json.containsKey('action') ? Omittable(json['action']) : const Omittable.absent(),
  actionParameters: json['action_parameters'] != null ? RulesetsRouteRuleActionParameters.fromJson(json['action_parameters'] as Map<String, dynamic>) : null,
...
final RulesetsRouteRuleActionParameters? actionParameters;
...
@override String toString() { return 'RulesetsRouteRule(action: $action, actionParameters: $actionParameters, categories: $categories, description: $description, enabled: $enabled, exposedCredentialCheck: $exposedCredentialCheck, expression: $expression, id: $id, lastUpdated: $lastUpdated, logging: $logging, ratelimit: $ratelimit, ref: $ref, version: $version)'; } 
 }
