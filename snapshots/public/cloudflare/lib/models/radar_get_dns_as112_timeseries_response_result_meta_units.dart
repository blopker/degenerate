...
final class RadarGetDnsAs112TimeseriesResponseResultMetaUnits {const RadarGetDnsAs112TimeseriesResponseResultMetaUnits({required this.name, required this.value, });
