...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logcontrol_messages2.dart';@immutable final class ResponseCommon43 {const ResponseCommon43({required this.errors, required this.messages, required this.success, });
