...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer7_summary_by_industry_response_result_meta.dart';@immutable final class RadarGetAttacksLayer7SummaryByIndustryResponseResult {const RadarGetAttacksLayer7SummaryByIndustryResponseResult({required this.meta, required this.summary0, });
