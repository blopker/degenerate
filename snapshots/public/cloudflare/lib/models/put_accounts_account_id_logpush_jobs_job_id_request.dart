...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logpush_destination_conf.dart';import 'logpush_enabled.dart';import 'logpush_filter.dart';import 'logpush_frequency.dart';import 'logpush_kind.dart';import 'logpush_logpull_options.dart';import 'logpush_max_upload_bytes.dart';import 'logpush_max_upload_interval_seconds.dart';import 'logpush_max_upload_records.dart';import 'logpush_name.dart';import 'logpush_output_options.dart';import 'logpush_ownership_challenge.dart';@immutable final class PutAccountsAccountIdLogpushJobsJobIdRequest {const PutAccountsAccountIdLogpushJobsJobIdRequest({this.destinationConf, this.enabled, this.filter = const Omittable.absent(), this.frequency = const Omittable.absent(), this.kind, this.logpullOptions = const Omittable.absent(), this.maxUploadBytes = const Omittable.absent(), this.maxUploadIntervalSeconds = const Omittable.absent(), this.maxUploadRecords = const Omittable.absent(), this.name = const Omittable.absent(), this.outputOptions = const Omittable.absent(), this.ownershipChallenge, });

factory PutAccountsAccountIdLogpushJobsJobIdRequest.fromJson(Map<String, dynamic> json) { return PutAccountsAccountIdLogpushJobsJobIdRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PutAccountsAccountIdLogpushJobsJobIdRequest &&
