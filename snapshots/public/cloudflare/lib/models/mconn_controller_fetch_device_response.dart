...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_controller_device.dart';@immutable final class MconnControllerFetchDeviceResponse {const MconnControllerFetchDeviceResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnControllerFetchDeviceResponse.fromJson(Map<String, dynamic> json) {return MconnControllerFetchDeviceResponse(
  ...
  result: MconnControllerDevice.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnControllerFetchDeviceResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerDevice? result, }) {return MconnControllerFetchDeviceResponse(
...
@override String toString() {return 'MconnControllerFetchDeviceResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
