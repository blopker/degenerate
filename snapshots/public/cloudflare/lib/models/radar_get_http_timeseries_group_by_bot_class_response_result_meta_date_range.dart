...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTimeseriesGroupByBotClassResponseResultMetaDateRange {const RadarGetHttpTimeseriesGroupByBotClassResponseResultMetaDateRange({required this.endTime, required this.startTime, });
