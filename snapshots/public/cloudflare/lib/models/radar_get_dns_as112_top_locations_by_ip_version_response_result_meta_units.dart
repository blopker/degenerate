...
final class RadarGetDnsAs112TopLocationsByIpVersionResponseResultMetaUnits {const RadarGetDnsAs112TopLocationsByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
