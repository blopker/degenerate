...
@immutable final class ZonesOrangeToOrange {const ZonesOrangeToOrange({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
