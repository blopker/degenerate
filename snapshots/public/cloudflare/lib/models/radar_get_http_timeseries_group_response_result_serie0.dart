...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTimeseriesGroupResponseResultSerie0 {const RadarGetHttpTimeseriesGroupResponseResultSerie0({required this.timestamps, this.additionalProperties = const {}, });
...
RadarGetHttpTimeseriesGroupResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetHttpTimeseriesGroupResponseResultSerie0(
