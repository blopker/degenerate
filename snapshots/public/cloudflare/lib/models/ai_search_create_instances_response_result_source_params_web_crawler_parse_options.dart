...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_create_instances_response_result_source_params_web_crawler_parse_options_content_selector.dart';@immutable final class AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions {const AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions({this.contentSelector, this.includeHeaders, this.includeImages = false, this.specificSitemaps, this.useBrowserRendering = false, });

factory AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions(
  contentSelector: (json['content_selector'] as List<dynamic>?)?.map((e) => AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptionsContentSelector.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptionsContentSelector>? contentSelector;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions &&
...
@override String toString() { return 'AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerParseOptions(contentSelector: $contentSelector, includeHeaders: $includeHeaders, includeImages: $includeImages, specificSitemaps: $specificSitemaps, useBrowserRendering: $useBrowserRendering)'; } 
 }
