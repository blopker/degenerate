...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt14ResponseFormatType {const Prompt14ResponseFormatType._(this.value);
...
@immutable final class Prompt14ResponseFormat {const Prompt14ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt14ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt14ResponseFormatType? Function()? type, }) { return Prompt14ResponseFormat(
