...
@immutable final class RadarGetDnsAs112TimeseriesByQueryTypeResponseResultMetaNormalization {const RadarGetDnsAs112TimeseriesByQueryTypeResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetDnsAs112TimeseriesByQueryTypeResponseResultMeta {const RadarGetDnsAs112TimeseriesByQueryTypeResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
