...
@immutable final class SetCacheTagsExpression {const SetCacheTagsExpression({required this.expression, required this.operation, });

factory SetCacheTagsExpression.fromJson(Map<String, dynamic> json) { return SetCacheTagsExpression(
...
SetCacheTagsExpression copyWith({RulesetsSetCacheTagsExpression? expression, RulesetsSetCacheTagsOperation? operation, }) { return SetCacheTagsExpression(
  expression: expression ?? this.expression,
  operation: operation ?? this.operation,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SetCacheTagsExpression &&
          expression == other.expression &&
          operation == other.operation; } 
@override int get hashCode { return Object.hash(expression, operation); } 
@override String toString() { return 'SetCacheTagsExpression(expression: $expression, operation: $operation)'; } 
 }
