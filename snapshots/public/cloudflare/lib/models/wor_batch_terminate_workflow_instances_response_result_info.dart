...
WorBatchTerminateWorkflowInstancesResponseResultInfo copyWith({double? count, String Function()? cursor, double Function()? page, double? perPage, double? totalCount, }) { return WorBatchTerminateWorkflowInstancesResponseResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorBatchTerminateWorkflowInstancesResponseResultInfo &&
          count == other.count &&
          cursor == other.cursor &&
          page == other.page &&
...
@override String toString() { return 'WorBatchTerminateWorkflowInstancesResponseResultInfo(count: $count, cursor: $cursor, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
