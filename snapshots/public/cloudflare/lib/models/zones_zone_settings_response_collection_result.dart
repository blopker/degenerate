...
this.zonesImageResizing = const Omittable.absent(),
...
this.zonesTransformations = const Omittable.absent(),
this.zonesTransformationsAllowedOrigins = const Omittable.absent(),
...
this.zonesWebsockets = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZonesZoneSettingsResponseCollectionResult._({required this.rawValue, required this.zones0rtt,
...
required this.zonesImageResizing,
...
required this.zonesTransformations,
required this.zonesTransformationsAllowedOrigins,
...
required this.zonesWebsockets,});
  factory ZonesZoneSettingsResponseCollectionResult.fromJson(Object? json) => ZonesZoneSettingsResponseCollectionResult._(
...
zonesImageResizing: parseAnyOfVariant<ZonesImageResizing>(json, (value) => ZonesImageResizing.fromJson(value! as Map<String, dynamic>)),
...
zonesTransformations: parseAnyOfVariant<ZonesTransformations>(json, (value) => ZonesTransformations.fromJson(value! as Map<String, dynamic>)),
zonesTransformationsAllowedOrigins: parseAnyOfVariant<ZonesTransformationsAllowedOrigins>(json, (value) => ZonesTransformationsAllowedOrigins.fromJson(value! as Map<String, dynamic>)),
...
final Omittable<ZonesImageResizing> zonesImageResizing;
...
final Omittable<ZonesTransformations> zonesTransformations;
final Omittable<ZonesTransformationsAllowedOrigins> zonesTransformationsAllowedOrigins;
...
if (zonesImageResizing.isPresent) zonesImageResizing.value?.toJson(),
...
if (zonesTransformations.isPresent) zonesTransformations.value?.toJson(),
if (zonesTransformationsAllowedOrigins.isPresent) zonesTransformationsAllowedOrigins.value?.toJson(),
...
if (zonesWebsockets.isPresent) zonesWebsockets.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZonesZoneSettingsResponseCollectionResult && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZonesZoneSettingsResponseCollectionResult(${toJson()})';
}
