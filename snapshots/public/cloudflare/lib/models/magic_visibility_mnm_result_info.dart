...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class MagicVisibilityMnmResultInfo {const MagicVisibilityMnmResultInfo({this.count, this.page, this.perPage, this.totalCount, });
