...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_messages2.dart';@immutable final class ResponseCommonFailure25 {const ResponseCommonFailure25({required this.errors, required this.messages, required this.result, required this.success, });
