...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_secret.dart';@immutable final class NamespaceWorkerListScriptSecretsResponse {const NamespaceWorkerListScriptSecretsResponse({required this.errors, required this.messages, required this.success, required this.result, });
