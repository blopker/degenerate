...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_secret_response.dart';@immutable final class NamespaceWorkerListScriptSecretsResponse {const NamespaceWorkerListScriptSecretsResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
factory NamespaceWorkerListScriptSecretsResponse.fromJson(Map<String, dynamic> json) {return NamespaceWorkerListScriptSecretsResponse(
  ...
  result: (json['result'] as List<dynamic>).map((e) => WorkersSecretResponse.fromJson(e as Map<String, dynamic>)).toList(),
);}
...
final List<WorkersSecretResponse> result;
...
NamespaceWorkerListScriptSecretsResponse copyWith({List<WorkersMessages2>? errors, List<WorkersMessages2>? messages, bool? success, List<WorkersSecretResponse>? result, }) {return NamespaceWorkerListScriptSecretsResponse(
