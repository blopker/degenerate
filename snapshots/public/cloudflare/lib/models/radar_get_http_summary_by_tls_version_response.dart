...
import 'radar_get_http_summary_by_tls_version_response_result.dart';final class RadarGetHttpSummaryByTlsVersionResponse {const RadarGetHttpSummaryByTlsVersionResponse({required this.result, required this.success, });
