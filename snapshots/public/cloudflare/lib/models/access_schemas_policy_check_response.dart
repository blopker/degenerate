...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'access_schemas_policy_check_response_result.dart';@immutable final class AccessSchemasPolicyCheckResponse {const AccessSchemasPolicyCheckResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessSchemasPolicyCheckResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessSchemasPolicyCheckResponseResult? Function()? result, }) { return AccessSchemasPolicyCheckResponse(
...
@override String toString() { return 'AccessSchemasPolicyCheckResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
