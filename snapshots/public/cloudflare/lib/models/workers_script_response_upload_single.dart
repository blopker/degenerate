...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_script_response_upload.dart';@immutable final class WorkersScriptResponseUploadSingle {const WorkersScriptResponseUploadSingle({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'WorkersScriptResponseUploadSingle(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
