...
import 'radar_get_search_global_response_result.dart';final class RadarGetSearchGlobalResponse {const RadarGetSearchGlobalResponse({required this.result, required this.success, });
