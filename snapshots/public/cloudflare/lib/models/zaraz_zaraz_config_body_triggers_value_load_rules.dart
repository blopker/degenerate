...
@immutable
final class ZarazZarazConfigBodyTriggersValueLoadRules {
  const ZarazZarazConfigBodyTriggersValueLoadRules({this.zarazLoadRule = const Omittable.absent(),
...
this.zarazElementVisibilityRule = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigBodyTriggersValueLoadRules._({required this.rawValue, required this.zarazLoadRule,
...
required this.zarazElementVisibilityRule,});
  factory ZarazZarazConfigBodyTriggersValueLoadRules.fromJson(Object? json) => ZarazZarazConfigBodyTriggersValueLoadRules._(
...
if (zarazElementVisibilityRule.isPresent) zarazElementVisibilityRule.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigBodyTriggersValueLoadRules && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigBodyTriggersValueLoadRules(${toJson()})';
}
