...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logshare_messages2.dart';@immutable final class ResponseCommonFailure46 {const ResponseCommonFailure46({required this.errors, required this.messages, required this.result, required this.success, });
