...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';import 'tunnel_tunnel_link.dart';@immutable final class TunnelTunnelLinksResponse {const TunnelTunnelLinksResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelTunnelLinksResponse copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelTunnelLink>? result, bool? success, TunnelResultInfo Function()? resultInfo, }) { return TunnelTunnelLinksResponse(
...
@override String toString() { return 'TunnelTunnelLinksResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
