...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'argo_config_messages2.dart';import 'argo_config_result_object.dart';final class ResponseSingle6 {const ResponseSingle6({required this.errors, required this.messages, required this.result, required this.success, });
