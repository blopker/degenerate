...
import 'custom_indicator_feeds_indicator_feed_item.dart';final class CustomIndicatorFeedsUpdatePublicFieldResponse {const CustomIndicatorFeedsUpdatePublicFieldResponse({this.result});
