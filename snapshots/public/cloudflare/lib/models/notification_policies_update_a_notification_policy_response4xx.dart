...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aaa_components_schemas_messages2.dart';import 'notification_policies_update_a_notification_policy_response4xx_result.dart';@immutable final class NotificationPoliciesUpdateANotificationPolicyResponse4xx {const NotificationPoliciesUpdateANotificationPolicyResponse4xx({required this.errors, required this.messages, required this.success, this.result, });
