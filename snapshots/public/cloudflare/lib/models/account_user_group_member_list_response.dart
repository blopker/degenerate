...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';import 'iam_user_group_member.dart';@immutable final class AccountUserGroupMemberListResponse {const AccountUserGroupMemberListResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
AccountUserGroupMemberListResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamUserGroupMember>? Function()? result, }) { return AccountUserGroupMemberListResponse(
...
@override String toString() { return 'AccountUserGroupMemberListResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
