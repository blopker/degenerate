...
@immutable final class AccessIdentityProviderScimConfig {const AccessIdentityProviderScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessIdentityProviderScimConfig.fromJson(Map<String, dynamic> json) {return AccessIdentityProviderScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessIdentityProviderScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessIdentityProviderScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessIdentityProviderScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessIdentityProviderScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessIdentityProviderScimConfig copyWith({bool? Function()? enabled, AccessIdentityProviderScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessIdentityProviderScimConfig(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AccessIdentityProviderScimConfig &&
...
@override String toString() {return 'AccessIdentityProviderScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
