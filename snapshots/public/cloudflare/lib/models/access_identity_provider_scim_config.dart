...
factory AccessIdentityProviderScimConfig.fromJson(Map<String, dynamic> json) { return AccessIdentityProviderScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessIdentityProviderScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessIdentityProviderScimConfigIdentityUpdateBehavior.noAction,
