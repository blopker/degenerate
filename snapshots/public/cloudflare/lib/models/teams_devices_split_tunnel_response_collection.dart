...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_exclude_split_tunnel_with_address.dart';import 'teams_devices_exclude_split_tunnel_with_host.dart';import 'teams_devices_messages2.dart';import 'teams_devices_result_info.dart';import 'teams_devices_split_tunnel.dart';@immutable final class TeamsDevicesSplitTunnelResponseCollection {const TeamsDevicesSplitTunnelResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TeamsDevicesSplitTunnelResponseCollection copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesSplitTunnel>? result, bool? success, TeamsDevicesResultInfo? Function()? resultInfo, }) { return TeamsDevicesSplitTunnelResponseCollection(
...
@override String toString() { return 'TeamsDevicesSplitTunnelResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
