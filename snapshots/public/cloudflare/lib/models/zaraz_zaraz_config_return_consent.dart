...
final Map<String,ZarazZarazConfigReturnConsentPurposesValue>? purposes;

/// Object where keys are purpose alpha-numeric IDs
final Map<String,ZarazZarazConfigReturnConsentPurposesWithTranslationsValue>? purposesWithTranslations;
