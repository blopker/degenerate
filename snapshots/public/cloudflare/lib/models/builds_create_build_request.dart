...
@immutable
final class BuildsCreateBuildRequest {
  const BuildsCreateBuildRequest({this.$dynamic = const Omittable.absent(),
this.$dynamic2 = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const BuildsCreateBuildRequest._({required this.rawValue, required this.$dynamic,
required this.$dynamic2,});
  factory BuildsCreateBuildRequest.fromJson(Object? json) => BuildsCreateBuildRequest._(
...
if ($dynamic2.isPresent) $dynamic2.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is BuildsCreateBuildRequest && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'BuildsCreateBuildRequest(${toJson()})';
}
