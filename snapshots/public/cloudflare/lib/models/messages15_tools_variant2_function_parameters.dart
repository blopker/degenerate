...
final Map<String,Messages15ToolsVariant2FunctionParametersPropertiesValue> properties;
...
Messages15ToolsVariant2FunctionParameters copyWith({Map<String,Messages15ToolsVariant2FunctionParametersPropertiesValue>? properties, List<String> Function()? $required, String? type, }) { return Messages15ToolsVariant2FunctionParameters(
  properties: properties ?? this.properties,
  $required: $required != null ? $required() : this.$required,
  type: type ?? this.type,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Messages15ToolsVariant2FunctionParameters &&
...
@override String toString() { return 'Messages15ToolsVariant2FunctionParameters(properties: $properties, \$required: ${$required}, type: $type)'; } 
 }
