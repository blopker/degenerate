...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'zero_trust_organization_update_your_zero_trust_organization_doh_settings_response_result.dart';@immutable final class ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponse {const ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponseResult? Function()? result, }) { return ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponse(
...
@override String toString() { return 'ZeroTrustOrganizationUpdateYourZeroTrustOrganizationDohSettingsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
