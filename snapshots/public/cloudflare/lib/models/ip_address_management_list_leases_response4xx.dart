...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';import 'ip_address_management_list_leases_response4xx_result_info.dart';@immutable final class IpAddressManagementListLeasesResponse4xx {const IpAddressManagementListLeasesResponse4xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
