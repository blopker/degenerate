...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_csr.dart';import 'tls_certificates_and_hostnames_identifier.dart';import 'tls_certificates_and_hostnames_request_type.dart';import 'tls_certificates_and_hostnames_requested_validity.dart';/// The Origin CA certificate. Will be newline-encoded.
...
factory TlsCertificatesAndHostnamesCertificates.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesCertificates(
  ...
  requestedValidity: TlsCertificatesAndHostnamesRequestedValidity.fromJson(json['requested_validity'] as num),
); }
