...
factory ZoneLevelAuthenticatedOriginPullsListCertificatesResponse4Xx.fromJson(Map<String, dynamic> json) { return ZoneLevelAuthenticatedOriginPullsListCertificatesResponse4Xx(
  ...
  resultInfo: json['result_info'] != null ? ZoneLevelAuthenticatedOriginPullsListCertificatesResponse4XxResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final ZoneLevelAuthenticatedOriginPullsListCertificatesResponse4XxResultInfo? resultInfo;
...
@override String toString() { return 'ZoneLevelAuthenticatedOriginPullsListCertificatesResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
