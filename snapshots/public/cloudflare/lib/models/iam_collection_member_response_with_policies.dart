...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_member_with_policies.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionMemberResponseWithPolicies {const IamCollectionMemberResponseWithPolicies({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionMemberResponseWithPolicies copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamMemberWithPolicies>? Function()? result, }) { return IamCollectionMemberResponseWithPolicies(
...
@override String toString() { return 'IamCollectionMemberResponseWithPolicies(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
