...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'delete_tag_category_delete_response404_errors.dart';final class DeleteTagCategoryDeleteResponse404 {const DeleteTagCategoryDeleteResponse404({required this.errors, required this.result, required this.success, });
