...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_schemas_messages2.dart';import 'iam_user_group_member.dart';@immutable final class AccountUserGroupMemberDeleteResponse {const AccountUserGroupMemberDeleteResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccountUserGroupMemberDeleteResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamUserGroupMember? Function()? result, }) { return AccountUserGroupMemberDeleteResponse(
...
@override String toString() { return 'AccountUserGroupMemberDeleteResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
