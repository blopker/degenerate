...
final class RadarGetHttpSummaryByIpVersionResponseResultMetaUnits {const RadarGetHttpSummaryByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
