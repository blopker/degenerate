...
@immutable final class BrapiPostContentRequestVariant2Viewport {const BrapiPostContentRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostContentRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostContentRequestVariant2Viewport(
...
BrapiPostContentRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostContentRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostContentRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostContentRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
