...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_transit_endpoint_health_check_response.dart';import 'magic_transit_messages2.dart';final class MagicTransitEndpointHealthCheckResponseCollection {const MagicTransitEndpointHealthCheckResponseCollection({required this.errors, required this.messages, required this.success, this.result, });
