...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'access_schemas_service_tokens.dart';@immutable final class AccessServiceTokensComponentsSchemasSingleResponse {const AccessServiceTokensComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'AccessServiceTokensComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
