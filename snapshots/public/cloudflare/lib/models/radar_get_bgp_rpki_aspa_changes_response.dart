...
import 'radar_get_bgp_rpki_aspa_changes_response_result.dart';final class RadarGetBgpRpkiAspaChangesResponse {const RadarGetBgpRpkiAspaChangesResponse({required this.result, required this.success, });
