...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'digital_experience_monitoring_messages2.dart';import 'digital_experience_monitoring_traceroute_test_network_path_response.dart';@immutable final class DexEndpointsTracerouteTestNetworkPathResponse {const DexEndpointsTracerouteTestNetworkPathResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'DexEndpointsTracerouteTestNetworkPathResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
