...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'turnstile_messages2.dart';import 'turnstile_result_info.dart';import 'turnstile_widget_list.dart';@immutable final class AccountsTurnstileWidgetsListResponse {const AccountsTurnstileWidgetsListResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
