...
final class RadarGetAttacksLayer3TimeseriesGroupByProtocolResponseResultMetaDateRange {const RadarGetAttacksLayer3TimeseriesGroupByProtocolResponseResultMetaDateRange({required this.endTime, required this.startTime, });
