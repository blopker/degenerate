...
import 'package:collection/collection.dart';import 'aig_config_list_gateway_dynamic_route_deployments_response_data_deployments.dart';final class AigConfigListGatewayDynamicRouteDeploymentsResponseData {const AigConfigListGatewayDynamicRouteDeploymentsResponseData({required this.deployments, required this.orderBy, required this.orderByDirection, required this.page, required this.perPage, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AigConfigListGatewayDynamicRouteDeploymentsResponseData &&
          const ListEquality<dynamic>().equals(deployments, other.deployments) &&
