...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_dns_timeseries_response400_errors.dart';final class RadarGetDnsTimeseriesResponse400 {const RadarGetDnsTimeseriesResponse400({required this.errors, required this.result, required this.success, });
