...
import 'access_schemas_certificates.dart';final class AccessGatewayCaComponentsSchemasSingleResponse {const AccessGatewayCaComponentsSchemasSingleResponse({this.result});
