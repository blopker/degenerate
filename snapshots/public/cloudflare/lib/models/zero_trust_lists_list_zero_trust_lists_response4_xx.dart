...
@override String toString() { return 'ZeroTrustListsListZeroTrustListsResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
