...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ai_inference_summary_response_result_meta_confidence_info_annotations.dart';final class RadarGetAiInferenceSummaryResponseResultMetaConfidenceInfo {const RadarGetAiInferenceSummaryResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
