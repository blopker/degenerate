...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ranking_domain_timeseries_response_result.dart';@immutable final class RadarGetRankingDomainTimeseriesResponse {const RadarGetRankingDomainTimeseriesResponse({required this.result, required this.success, });
...
@override String toString() { return 'RadarGetRankingDomainTimeseriesResponse(result: $result, success: $success)'; } 
 }
