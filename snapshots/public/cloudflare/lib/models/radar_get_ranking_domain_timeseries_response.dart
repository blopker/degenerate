...
import 'radar_get_ranking_domain_timeseries_response_result.dart';final class RadarGetRankingDomainTimeseriesResponse {const RadarGetRankingDomainTimeseriesResponse({required this.result, required this.success, });
