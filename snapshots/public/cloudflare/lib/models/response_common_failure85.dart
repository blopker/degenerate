...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zone_activation_messages2.dart';final class ResponseCommonFailure85 {const ResponseCommonFailure85({required this.errors, required this.messages, required this.result, required this.success, });
