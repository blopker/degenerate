...
@immutable
final class ResponseSingle22Result {
  const ResponseSingle22Result({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseSingle22Result._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory ResponseSingle22Result.fromJson(Object? json) => ResponseSingle22Result._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseSingle22Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseSingle22Result(${toJson()})';
}
