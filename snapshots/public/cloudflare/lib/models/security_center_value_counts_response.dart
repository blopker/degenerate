...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'security_center_messages2.dart';import 'security_center_value_counts_response_result.dart';final class SecurityCenterValueCountsResponse {const SecurityCenterValueCountsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
factory SecurityCenterValueCountsResponse.fromJson(Map<String, dynamic> json) { return SecurityCenterValueCountsResponse(
  ...
  result: json['result'] != null ? SecurityCenterValueCountsResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null,
); }
...
final SecurityCenterValueCountsResponseResult? result;
...
SecurityCenterValueCountsResponse copyWith({List<SecurityCenterMessages2>? errors, List<SecurityCenterMessages2>? messages, bool? success, SecurityCenterValueCountsResponseResult Function()? result, }) { return SecurityCenterValueCountsResponse(
