...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'security_center_messages2.dart';import 'security_center_value_counts_response_result_variant1.dart';final class SecurityCenterValueCountsResponse {const SecurityCenterValueCountsResponse({required this.errors, required this.messages, required this.success, this.result, });
