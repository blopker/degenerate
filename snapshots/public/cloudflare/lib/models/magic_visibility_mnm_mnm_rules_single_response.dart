...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_visibility_mnm_messages2.dart';import 'magic_visibility_mnm_mnm_rule.dart';@immutable final class MagicVisibilityMnmMnmRulesSingleResponse {const MagicVisibilityMnmMnmRulesSingleResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'MagicVisibilityMnmMnmRulesSingleResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
