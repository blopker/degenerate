...
import 'magic_visibility_mnm_mnm_rule.dart';final class MagicVisibilityMnmMnmRulesSingleResponse {const MagicVisibilityMnmMnmRulesSingleResponse({this.result});
