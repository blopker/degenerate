...
final class RadarGetEmailSecurityTimeseriesGroupByDmarcResponseResultMetaDateRange {const RadarGetEmailSecurityTimeseriesGroupByDmarcResponseResultMetaDateRange({required this.endTime, required this.startTime, });
