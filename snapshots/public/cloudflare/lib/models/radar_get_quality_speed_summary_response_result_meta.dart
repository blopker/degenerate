...
@immutable final class RadarGetQualitySpeedSummaryResponseResultMetaNormalization {const RadarGetQualitySpeedSummaryResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetQualitySpeedSummaryResponseResultMeta {const RadarGetQualitySpeedSummaryResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
