...
@immutable final class Prompt29ResponseFormat {const Prompt29ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt29ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt29ResponseFormatType? Function()? type, }) { return Prompt29ResponseFormat(
