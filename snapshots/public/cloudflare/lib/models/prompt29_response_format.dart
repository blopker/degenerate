...
final class Prompt29ResponseFormatType {const Prompt29ResponseFormatType._(this.value);
...
final class Prompt29ResponseFormat {const Prompt29ResponseFormat({this.jsonSchema, this.type, });
