...
factory ZarazZarazConfigBody.fromJson(Map<String, dynamic> json) { return ZarazZarazConfigBody(
  ...
  tools: (json['tools'] as Map<String, dynamic>).map((k, v) => MapEntry(k, ZarazZarazConfigBodyToolsValue.fromJson(v))),
); }
