...
final class UrlscannerCreateScanResponse4292Errors {const UrlscannerCreateScanResponse4292Errors({required this.detail, required this.status, required this.title, });
