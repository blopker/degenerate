...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetEventRawReadDsResponse500Errors {const GetEventRawReadDsResponse500Errors({required this.message});
