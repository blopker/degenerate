...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pages_domain.dart';import 'pages_messages2.dart';@immutable final class PagesDomainsPatchDomainResponse {const PagesDomainsPatchDomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
