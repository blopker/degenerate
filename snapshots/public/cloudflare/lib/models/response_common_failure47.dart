...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_transit_messages2.dart';final class ResponseCommonFailure47 {const ResponseCommonFailure47({required this.errors, required this.messages, required this.result, required this.success, });
