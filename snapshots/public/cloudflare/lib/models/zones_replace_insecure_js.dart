...
/// 
@immutable final class ZonesReplaceInsecureJs {const ZonesReplaceInsecureJs({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesReplaceInsecureJs copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesReplaceInsecureJsValue? value, }) { return ZonesReplaceInsecureJs(
