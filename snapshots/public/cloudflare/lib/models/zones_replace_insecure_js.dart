...
/// 
@immutable final class ZonesReplaceInsecureJs {const ZonesReplaceInsecureJs({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
