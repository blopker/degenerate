...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages47_functions.dart';import 'messages47_messages.dart';import 'messages47_tools.dart';import 'messages47_tools_variant1.dart';import 'messages47_tools_variant2.dart';@immutable final class Messages47 {const Messages47({required this.messages, this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });
...
factory Messages47.fromJson(Map<String, dynamic> json) { return Messages47(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages47ToolsVariant1.fromJson(v as Map<String, dynamic>), fromB: (v) => Messages47ToolsVariant2.fromJson(v as Map<String, dynamic>),)).toList(),
...
final List<Messages47Functions>? functions;
...
final List<Messages47Messages> messages;
...
final List<Messages47Tools>? tools;
...
@override String toString() { return 'Messages47(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
