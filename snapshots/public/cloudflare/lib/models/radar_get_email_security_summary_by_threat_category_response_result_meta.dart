...
@immutable final class RadarGetEmailSecuritySummaryByThreatCategoryResponseResultMetaNormalization {const RadarGetEmailSecuritySummaryByThreatCategoryResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailSecuritySummaryByThreatCategoryResponseResultMeta {const RadarGetEmailSecuritySummaryByThreatCategoryResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
