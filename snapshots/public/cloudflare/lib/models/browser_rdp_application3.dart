...
factory BrowserRdpApplication3.fromJson(Map<String, dynamic> json) {return BrowserRdpApplication3(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => BrowserRdpApplication3PoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
);}
...
final List<BrowserRdpApplication3Policies>? policies;
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is BrowserRdpApplication3 &&
