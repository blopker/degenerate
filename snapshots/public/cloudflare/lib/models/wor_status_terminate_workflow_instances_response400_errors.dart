...
final class WorStatusTerminateWorkflowInstancesResponse400Errors {const WorStatusTerminateWorkflowInstancesResponse400Errors({required this.code, required this.message, });
