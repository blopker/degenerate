...
final class DestinationListResponse401ErrorsMessage {const DestinationListResponse401ErrorsMessage._(this.value);
...
final class DestinationListResponse401Errors {const DestinationListResponse401Errors({this.detail, required this.message, });
