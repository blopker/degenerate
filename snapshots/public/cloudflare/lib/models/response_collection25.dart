...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_schemas_messages2.dart';import 'intel_schemas_result_info.dart';@immutable final class ResponseCollection25 {const ResponseCollection25({required this.errors, required this.messages, required this.success, this.resultInfo, });
