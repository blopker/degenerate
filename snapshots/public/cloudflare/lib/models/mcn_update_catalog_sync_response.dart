...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_catalog_sync.dart';import 'mcn_error.dart';@immutable final class McnUpdateCatalogSyncResponse {const McnUpdateCatalogSyncResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
McnUpdateCatalogSyncResponse copyWith({List<McnError>? messages, bool? success, List<McnError>? errors, McnCatalogSync? result, }) {return McnUpdateCatalogSyncResponse(
...
@override String toString() {return 'McnUpdateCatalogSyncResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
