...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_ruleset_id.dart';import 'rulesets_ruleset_kind.dart';import 'rulesets_ruleset_phase.dart';import 'rulesets_ruleset_version.dart';@immutable final class ListAccountEntrypointRulesetVersionsResponseResult {const ListAccountEntrypointRulesetVersionsResponseResult({required this.id, required this.lastUpdated, required this.name, required this.version, required this.kind, required this.phase, this.description = '', });
