...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';@immutable final class IpAddressManagementPrefixesUpdatePrefixDescriptionResponse4Xx {const IpAddressManagementPrefixesUpdatePrefixDescriptionResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'IpAddressManagementPrefixesUpdatePrefixDescriptionResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
