...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_message.dart';import 'email_security_update_trusted_domain_response_result.dart';@immutable final class EmailSecurityUpdateTrustedDomainResponse {const EmailSecurityUpdateTrustedDomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
