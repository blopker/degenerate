...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer3_summary_by_vertical_response400_errors.dart';final class RadarGetAttacksLayer3SummaryByVerticalResponse400 {const RadarGetAttacksLayer3SummaryByVerticalResponse400({required this.errors, required this.result, required this.success, });
