...
final class AccountsByAccountIdPipelinesDeprecatedResponseResultInfo {const AccountsByAccountIdPipelinesDeprecatedResponseResultInfo({required this.count, required this.page, required this.perPage, required this.totalCount, });
