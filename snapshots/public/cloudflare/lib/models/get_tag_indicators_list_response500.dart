...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_tag_indicators_list_response500_errors.dart';final class GetTagIndicatorsListResponse500 {const GetTagIndicatorsListResponse500({required this.errors, required this.result, required this.success, });
