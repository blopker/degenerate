...
@immutable final class DnsRecordsDsRecordRequestData {const DnsRecordsDsRecordRequestData({this.algorithm, this.digest, this.digestType, this.keyTag, });

factory DnsRecordsDsRecordRequestData.fromJson(Map<String, dynamic> json) { return DnsRecordsDsRecordRequestData(
...
DnsRecordsDsRecordRequestData copyWith({double? Function()? algorithm, String? Function()? digest, double? Function()? digestType, double? Function()? keyTag, }) { return DnsRecordsDsRecordRequestData(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DnsRecordsDsRecordRequestData &&
          algorithm == other.algorithm &&
          digest == other.digest &&
          digestType == other.digestType &&
          keyTag == other.keyTag; } 
@override int get hashCode { return Object.hash(algorithm, digest, digestType, keyTag); } 
@override String toString() { return 'DnsRecordsDsRecordRequestData(algorithm: $algorithm, digest: $digest, digestType: $digestType, keyTag: $keyTag)'; } 
 }
