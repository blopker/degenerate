...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_membership.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionMembershipResponse {const IamCollectionMembershipResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionMembershipResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamMembership>? Function()? result, }) { return IamCollectionMembershipResponse(
...
@override String toString() { return 'IamCollectionMembershipResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
