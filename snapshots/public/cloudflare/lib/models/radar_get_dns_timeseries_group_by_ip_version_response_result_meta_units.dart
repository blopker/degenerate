...
final class RadarGetDnsTimeseriesGroupByIpVersionResponseResultMetaUnits {const RadarGetDnsTimeseriesGroupByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
