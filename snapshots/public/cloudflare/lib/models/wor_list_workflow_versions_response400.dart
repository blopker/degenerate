...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'wor_list_workflow_versions_response400_errors.dart';final class WorListWorkflowVersionsResponse400 {const WorListWorkflowVersionsResponse400({required this.errors, required this.messages, required this.result, required this.success, });
