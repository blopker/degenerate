...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorkersAiPostRunCfLeonardoLucidOriginResponse400Errors {const WorkersAiPostRunCfLeonardoLucidOriginResponse400Errors({required this.code, required this.message, });
