...
import 'package:collection/collection.dart';final class RadarGetAttacksLayer3TimeseriesGroupByDurationResponseResultSerie0 {const RadarGetAttacksLayer3TimeseriesGroupByDurationResponseResultSerie0({required this.$1HourTo3Hours, required this.$10MinsTo20Mins, required this.$20MinsTo40Mins, required this.$40MinsTo1Hour, required this.over3Hours, required this.under10Mins, required this.timestamps, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetAttacksLayer3TimeseriesGroupByDurationResponseResultSerie0 &&
          const ListEquality<dynamic>().equals($1HourTo3Hours, other.$1HourTo3Hours) &&
          const ListEquality<dynamic>().equals($10MinsTo20Mins, other.$10MinsTo20Mins) &&
          const ListEquality<dynamic>().equals($20MinsTo40Mins, other.$20MinsTo40Mins) &&
          const ListEquality<dynamic>().equals($40MinsTo1Hour, other.$40MinsTo1Hour) &&
          const ListEquality<dynamic>().equals(over3Hours, other.over3Hours) &&
          const ListEquality<dynamic>().equals(under10Mins, other.under10Mins) &&
