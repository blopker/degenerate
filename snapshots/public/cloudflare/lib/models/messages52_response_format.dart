...
final class Messages52ResponseFormatType {const Messages52ResponseFormatType._(this.value);
...
final class Messages52ResponseFormat {const Messages52ResponseFormat({this.jsonSchema, this.type, });
