...
final class WorChangeStatusWorkflowInstanceResponseErrors {const WorChangeStatusWorkflowInstanceResponseErrors({required this.code, required this.message, });
