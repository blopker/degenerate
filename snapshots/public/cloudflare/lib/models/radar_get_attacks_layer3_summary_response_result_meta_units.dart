...
final class RadarGetAttacksLayer3SummaryResponseResultMetaUnits {const RadarGetAttacksLayer3SummaryResponseResultMetaUnits({required this.name, required this.value, });
