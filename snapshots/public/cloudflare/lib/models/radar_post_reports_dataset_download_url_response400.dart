...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_post_reports_dataset_download_url_response400_errors.dart';@immutable final class RadarPostReportsDatasetDownloadUrlResponse400 {const RadarPostReportsDatasetDownloadUrlResponse400({required this.errors, required this.result, required this.success, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarPostReportsDatasetDownloadUrlResponse400 &&
          listEquals(errors, other.errors) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), result, success); } 
@override String toString() { return 'RadarPostReportsDatasetDownloadUrlResponse400(errors: $errors, result: $result, success: $success)'; } 
 }
