...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpSummaryByHttpProtocolResponseResultMetaDateRange {const RadarGetHttpSummaryByHttpProtocolResponseResultMetaDateRange({required this.endTime, required this.startTime, });
