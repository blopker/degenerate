...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class GetCategoryListCompleteResponse {const GetCategoryListCompleteResponse({required this.killChain, this.mitreAttack, required this.name, this.shortname, required this.uuid, });
