...
final class RadarGetDnsAs112TimeseriesByEdnsResponseResultMetaUnits {const RadarGetDnsAs112TimeseriesByEdnsResponseResultMetaUnits({required this.name, required this.value, });
