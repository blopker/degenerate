...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages36ResponseFormatType {const Messages36ResponseFormatType._(this.value);
...
@immutable final class Messages36ResponseFormat {const Messages36ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages36ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages36ResponseFormatType? Function()? type, }) { return Messages36ResponseFormat(
