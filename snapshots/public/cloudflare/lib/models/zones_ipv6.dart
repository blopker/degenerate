...
@immutable final class ZonesIpv6 {const ZonesIpv6({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesIpv6 copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesIpv6Value? value, }) { return ZonesIpv6(
