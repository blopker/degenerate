...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';final class MconnGoodResponse {const MconnGoodResponse({required this.messages, required this.success, required this.errors, });
