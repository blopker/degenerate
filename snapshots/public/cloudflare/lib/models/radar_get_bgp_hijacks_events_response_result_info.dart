...
RadarGetBgpHijacksEventsResponseResultInfo copyWith({int? count, int? page, int? perPage, int? totalCount, }) { return RadarGetBgpHijacksEventsResponseResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetBgpHijacksEventsResponseResultInfo &&
          count == other.count &&
          page == other.page &&
          perPage == other.perPage &&
          totalCount == other.totalCount; } 
@override int get hashCode { return Object.hash(count, page, perPage, totalCount); } 
@override String toString() { return 'RadarGetBgpHijacksEventsResponseResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
