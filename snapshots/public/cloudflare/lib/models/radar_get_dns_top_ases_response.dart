...
import 'radar_get_dns_top_ases_response_result.dart';final class RadarGetDnsTopAsesResponse {const RadarGetDnsTopAsesResponse({required this.result, required this.success, });
