...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'nsc_interconnect.dart';final class NscInterconnectList {const NscInterconnectList({required this.items, this.next, });
