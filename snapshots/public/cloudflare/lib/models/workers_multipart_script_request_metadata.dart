...
factory WorkersMultipartScriptRequestMetadata.fromJson(Map<String, dynamic> json) { return WorkersMultipartScriptRequestMetadata(
  ...
  placement: json['placement'] != null ? OneOf8.parse(json['placement'], fromA: (v) => WorkersPlacementInfoRequestSmart.fromJson(v as Map<String, dynamic>), fromB: (v) => WorkersPlacementInfoRequestVariant2.fromJson(v as Map<String, dynamic>), fromC: (v) => WorkersPlacementInfoRequestVariant3.fromJson(v as Map<String, dynamic>), fromD: (v) => WorkersPlacementInfoRequestVariant4.fromJson(v as Map<String, dynamic>), fromE: (v) => WorkersPlacementInfoRequestTargeted.fromJson(v as Map<String, dynamic>), fromF: (v) => WorkersPlacementInfoRequestTargeted2.fromJson(v as Map<String, dynamic>), fromG: (v) => WorkersPlacementInfoRequestTargeted3.fromJson(v as Map<String, dynamic>), fromH: (v) => WorkersPlacementInfoRequestTargeted4.fromJson(v as Map<String, dynamic>),) : null,
...
final WorkersMultipartScriptRequestMetadataMigrations? migrations;

final WorkersObservability? observability;

final WorkersPlacementInfoRequest? placement;
