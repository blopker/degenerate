...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';import 'firewall_rule.dart';@immutable final class FirewallRuleCollectionResponse {const FirewallRuleCollectionResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallRuleCollectionResponse copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallRule>? result, bool? success, FirewallResultInfo Function()? resultInfo, }) { return FirewallRuleCollectionResponse(
...
@override String toString() { return 'FirewallRuleCollectionResponse(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
