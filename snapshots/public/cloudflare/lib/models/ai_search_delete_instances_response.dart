...
import 'ai_search_delete_instances_response_result.dart';final class AiSearchDeleteInstancesResponse {const AiSearchDeleteInstancesResponse({required this.result, required this.success, });
