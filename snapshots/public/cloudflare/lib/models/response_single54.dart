...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bundle_messages2.dart';import 'response_single54_result.dart';@immutable final class ResponseSingle54 {const ResponseSingle54({required this.errors, required this.messages, required this.result, required this.success, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseSingle54 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), result, success); } 
@override String toString() { return 'ResponseSingle54(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
