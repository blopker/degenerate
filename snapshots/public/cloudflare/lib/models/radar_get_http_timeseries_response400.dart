...
final List<RadarGetHttpTimeseriesResponse400Errors> errors;
...
RadarGetHttpTimeseriesResponse400 copyWith({List<RadarGetHttpTimeseriesResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetHttpTimeseriesResponse400(
