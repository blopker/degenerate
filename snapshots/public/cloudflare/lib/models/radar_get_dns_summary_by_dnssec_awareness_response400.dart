...
final List<RadarGetDnsSummaryByDnssecAwarenessResponse400Errors> errors;
...
RadarGetDnsSummaryByDnssecAwarenessResponse400 copyWith({List<RadarGetDnsSummaryByDnssecAwarenessResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetDnsSummaryByDnssecAwarenessResponse400(
  errors: errors ?? this.errors,
  result: result ?? this.result,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetDnsSummaryByDnssecAwarenessResponse400 &&
          listEquals(errors, other.errors) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), result, success); } 
@override String toString() { return 'RadarGetDnsSummaryByDnssecAwarenessResponse400(errors: $errors, result: $result, success: $success)'; } 
 }
