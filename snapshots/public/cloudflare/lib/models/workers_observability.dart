...
import 'workers_observability_logs.dart';/// Observability settings for the Worker.
final class WorkersObservability {const WorkersObservability({required this.enabled, this.headSamplingRate, this.logs, });
