...
final class EmailSecurityGetDomainResponseResultInboxProvider {const EmailSecurityGetDomainResponseResultInboxProvider._(this.value);
...
final class EmailSecurityGetDomainResponseResultRegions {const EmailSecurityGetDomainResponseResultRegions._(this.value);
...
final class EmailSecurityGetDomainResponseResultSpfStatus {const EmailSecurityGetDomainResponseResultSpfStatus._(this.value);
...
factory EmailSecurityGetDomainResponseResult.fromJson(Map<String, dynamic> json) { return EmailSecurityGetDomainResponseResult(
  ...
  authorization: json['authorization'] != null ? EmailSecurityGetDomainResponseResultAuthorization.fromJson(json['authorization'] as Map<String, dynamic>) : null,
  ...
  inboxProvider: json['inbox_provider'] != null ? EmailSecurityGetDomainResponseResultInboxProvider.fromJson(json['inbox_provider'] as String) : null,
  ...
  spfStatus: json['spf_status'] != null ? EmailSecurityGetDomainResponseResultSpfStatus.fromJson(json['spf_status'] as String) : null,
  transport: json['transport'] as String,
); }

final List<EmailSecurityDeliveryMode> allowedDeliveryModes;

final EmailSecurityGetDomainResponseResultAuthorization? authorization;

final DateTime createdAt;

final EmailSecurityGetDomainResponseResultDmarcStatus? dmarcStatus;

final String domain;

final List<EmailSecurityDispositionLabel?> dropDispositions;

final EmailSecurityGetDomainResponseResultEmailsProcessed? emailsProcessed;
...
final EmailSecurityGetDomainResponseResultInboxProvider? inboxProvider;
...
final EmailSecurityGetDomainResponseResultSpfStatus? spfStatus;
...
EmailSecurityGetDomainResponseResult copyWith({List<EmailSecurityDeliveryMode>? allowedDeliveryModes, EmailSecurityGetDomainResponseResultAuthorization? Function()? authorization, DateTime? createdAt, EmailSecurityGetDomainResponseResultDmarcStatus? Function()? dmarcStatus, String? domain, List<EmailSecurityDispositionLabel?>? dropDispositions, EmailSecurityGetDomainResponseResultEmailsProcessed? Function()? emailsProcessed, EmailSecurityScannableFolder? Function()? folder, int? id, EmailSecurityGetDomainResponseResultInboxProvider? Function()? inboxProvider, String? Function()? integrationId, List<String>? ipRestrictions, DateTime? lastModified, int? lookbackHops, String? Function()? o365TenantId, List<EmailSecurityGetDomainResponseResultRegions>? regions, bool? Function()? requireTlsInbound, bool? Function()? requireTlsOutbound, EmailSecurityGetDomainResponseResultSpfStatus? Function()? spfStatus, String? transport, }) { return EmailSecurityGetDomainResponseResult(
