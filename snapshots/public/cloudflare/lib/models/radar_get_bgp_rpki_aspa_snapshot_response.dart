...
import 'radar_get_bgp_rpki_aspa_snapshot_response_result.dart';final class RadarGetBgpRpkiAspaSnapshotResponse {const RadarGetBgpRpkiAspaSnapshotResponse({required this.result, required this.success, });
