...
@immutable final class BrapiPostSnapshotRequestVariant2Viewport {const BrapiPostSnapshotRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostSnapshotRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant2Viewport(
...
BrapiPostSnapshotRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostSnapshotRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostSnapshotRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostSnapshotRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
