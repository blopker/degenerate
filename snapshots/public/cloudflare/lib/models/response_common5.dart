...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'alexandria_messages2.dart';@immutable final class ResponseCommon5 {const ResponseCommon5({required this.errors, required this.messages, required this.success, });
