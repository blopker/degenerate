...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_customer_connector.dart';@immutable final class MconnCustomerConnectorFetchResponse {const MconnCustomerConnectorFetchResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnCustomerConnectorFetchResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnCustomerConnector? result, }) {return MconnCustomerConnectorFetchResponse(
...
@override String toString() {return 'MconnCustomerConnectorFetchResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
