...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_bucket_lock_rule.dart';@immutable final class R2BucketLockRuleConfig {const R2BucketLockRuleConfig({this.rules});
