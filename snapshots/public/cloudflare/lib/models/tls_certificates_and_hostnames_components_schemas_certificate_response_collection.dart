...
factory TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollection.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollection(
  ...
  resultInfo: json['result_info'] != null ? TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollectionResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollectionResultInfo? resultInfo;
...
TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollection copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollectionResultInfo? Function()? resultInfo, List<TlsCertificatesAndHostnamesZoneAuthenticatedOriginPull>? Function()? result, }) { return TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollection(
...
@override String toString() { return 'TlsCertificatesAndHostnamesComponentsSchemasCertificateResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
