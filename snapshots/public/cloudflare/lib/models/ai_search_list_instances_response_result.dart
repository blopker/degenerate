...
@immutable final class AiSearchListInstancesResponseResult {const AiSearchListInstancesResponseResult({required this.vectorizeName, required this.createdAt, required this.id, required this.modifiedAt, this.fusionMethod = AiSearchListInstancesResponseResultFusionMethod.rrf, this.chunkSize = 256, this.aiSearchModel, this.createdBy, this.customMetadata, this.embeddingModel, this.enable = true, this.aiGatewayId, this.hybridSearchEnabled = false, this.cache = true, this.lastActivity, this.maxNumResults = 10, this.metadata, this.cacheThreshold = AiSearchListInstancesResponseResultCacheThreshold.closeEnough, this.modifiedBy, this.paused = false, this.publicEndpointId, this.chunkOverlap = 10, this.reranking = false, this.rerankingModel, this.retrievalOptions, this.rewriteModel, this.rewriteQuery = false, this.scoreThreshold = 0.4, this.source, this.sourceParams, this.status = 'waiting', this.tokenId, this.type, this.publicEndpointParams, });
