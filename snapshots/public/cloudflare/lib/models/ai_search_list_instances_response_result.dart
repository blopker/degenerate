...
static const AiSearchListInstancesResponseResultRerankingModel $empty = AiSearchListInstancesResponseResultRerankingModel._('');

static const List<AiSearchListInstancesResponseResultRerankingModel> values = [cfBaaiBgeRerankerBase, $empty];
...
final class AiSearchListInstancesResponseResultCacheThreshold {const AiSearchListInstancesResponseResultCacheThreshold._(this.value);
...
static const AiSearchListInstancesResponseResultCacheThreshold closeEnough = AiSearchListInstancesResponseResultCacheThreshold._('close_enough');

static const AiSearchListInstancesResponseResultCacheThreshold flexibleFriend = AiSearchListInstancesResponseResultCacheThreshold._('flexible_friend');

static const AiSearchListInstancesResponseResultCacheThreshold anythingGoes = AiSearchListInstancesResponseResultCacheThreshold._('anything_goes');

static const List<AiSearchListInstancesResponseResultCacheThreshold> values = [superStrictMatch, closeEnough, flexibleFriend, anythingGoes];
...
final class AiSearchListInstancesResponseResultFusionMethod {const AiSearchListInstancesResponseResultFusionMethod._(this.value);
...
static const AiSearchListInstancesResponseResultFusionMethod rrf = AiSearchListInstancesResponseResultFusionMethod._('rrf');

static const List<AiSearchListInstancesResponseResultFusionMethod> values = [max, rrf];
...
final class AiSearchListInstancesResponseResultType {const AiSearchListInstancesResponseResultType._(this.value);
...
static const AiSearchListInstancesResponseResultType webCrawler = AiSearchListInstancesResponseResultType._('web-crawler');

static const List<AiSearchListInstancesResponseResultType> values = [r2, webCrawler];
...
final class AiSearchListInstancesResponseResult {const AiSearchListInstancesResponseResult({this.aiGatewayId, this.aiSearchModel, this.cache = true, this.cacheThreshold = AiSearchListInstancesResponseResultCacheThreshold.closeEnough, this.chunkOverlap = 10, this.chunkSize = 256, required this.createdAt, this.createdBy, this.customMetadata, this.embeddingModel, this.enable = true, this.fusionMethod = AiSearchListInstancesResponseResultFusionMethod.rrf, this.hybridSearchEnabled = false, required this.id, this.lastActivity, this.maxNumResults = 10, this.metadata, required this.modifiedAt, this.modifiedBy, this.paused = false, this.publicEndpointId, this.publicEndpointParams, this.reranking = false, this.rerankingModel, this.retrievalOptions, this.rewriteModel, this.rewriteQuery = false, this.scoreThreshold = 0.4, this.source, this.sourceParams, this.status = 'waiting', this.tokenId, this.type, required this.vectorizeName, });
...
factory AiSearchListInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchListInstancesResponseResult(
  ...
  aiSearchModel: json['ai_search_model'] != null ? OneOf2.parse(json['ai_search_model'], fromA: (v) => AiSearchListInstancesResponseResultAiSearchModelVariant1.fromJson(v as String), fromB: (v) => AiSearchListInstancesResponseResultAiSearchModelVariant2.fromJson(v as String),) : null,
  cache: json.containsKey('cache') ? json['cache'] as bool : true,
  cacheThreshold: json.containsKey('cache_threshold') ? AiSearchListInstancesResponseResultCacheThreshold.fromJson(json['cache_threshold'] as String) : AiSearchListInstancesResponseResultCacheThreshold.closeEnough,
  ...
  customMetadata: (json['custom_metadata'] as List<dynamic>?)?.map((e) => AiSearchListInstancesResponseResultCustomMetadata.fromJson(e as Map<String, dynamic>)).toList(),
  embeddingModel: json['embedding_model'] != null ? OneOf2.parse(json['embedding_model'], fromA: (v) => AiSearchListInstancesResponseResultEmbeddingModelVariant1.fromJson(v as String), fromB: (v) => AiSearchListInstancesResponseResultEmbeddingModelVariant2.fromJson(v as String),) : null,
  enable: json.containsKey('enable') ? json['enable'] as bool : true,
  fusionMethod: json.containsKey('fusion_method') ? AiSearchListInstancesResponseResultFusionMethod.fromJson(json['fusion_method'] as String) : AiSearchListInstancesResponseResultFusionMethod.rrf,
  ...
  metadata: json['metadata'] != null ? AiSearchListInstancesResponseResultMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
  ...
  publicEndpointParams: json['public_endpoint_params'] != null ? AiSearchListInstancesResponseResultPublicEndpointParams.fromJson(json['public_endpoint_params'] as Map<String, dynamic>) : null,
  reranking: json.containsKey('reranking') ? json['reranking'] as bool : false,
  rerankingModel: json['reranking_model'] != null ? AiSearchListInstancesResponseResultRerankingModel.fromJson(json['reranking_model'] as String) : null,
  retrievalOptions: json['retrieval_options'] != null ? AiSearchListInstancesResponseResultRetrievalOptions.fromJson(json['retrieval_options'] as Map<String, dynamic>) : null,
  rewriteModel: json['rewrite_model'] != null ? OneOf2.parse(json['rewrite_model'], fromA: (v) => AiSearchListInstancesResponseResultRewriteModelVariant1.fromJson(v as String), fromB: (v) => AiSearchListInstancesResponseResultRewriteModelVariant2.fromJson(v as String),) : null,
  ...
  sourceParams: json['source_params'] != null ? AiSearchListInstancesResponseResultSourceParams.fromJson(json['source_params'] as Map<String, dynamic>) : null,
...
final AiSearchListInstancesResponseResultAiSearchModel? aiSearchModel;

final bool cache;

final AiSearchListInstancesResponseResultCacheThreshold cacheThreshold;
...
final List<AiSearchListInstancesResponseResultCustomMetadata>? customMetadata;

final AiSearchListInstancesResponseResultEmbeddingModel? embeddingModel;

final bool enable;

final AiSearchListInstancesResponseResultFusionMethod fusionMethod;
...
final AiSearchListInstancesResponseResultMetadata? metadata;
...
final AiSearchListInstancesResponseResultPublicEndpointParams? publicEndpointParams;

final bool reranking;

final AiSearchListInstancesResponseResultRerankingModel? rerankingModel;

final AiSearchListInstancesResponseResultRetrievalOptions? retrievalOptions;

final AiSearchListInstancesResponseResultRewriteModel? rewriteModel;
...
final AiSearchListInstancesResponseResultSourceParams? sourceParams;

final String status;

final String? tokenId;

final AiSearchListInstancesResponseResultType? type;
...
AiSearchListInstancesResponseResult copyWith({String? Function()? aiGatewayId, AiSearchListInstancesResponseResultAiSearchModel Function()? aiSearchModel, bool Function()? cache, AiSearchListInstancesResponseResultCacheThreshold Function()? cacheThreshold, int Function()? chunkOverlap, int Function()? chunkSize, DateTime? createdAt, String? Function()? createdBy, List<AiSearchListInstancesResponseResultCustomMetadata> Function()? customMetadata, AiSearchListInstancesResponseResultEmbeddingModel Function()? embeddingModel, bool Function()? enable, AiSearchListInstancesResponseResultFusionMethod Function()? fusionMethod, bool Function()? hybridSearchEnabled, String? id, DateTime? Function()? lastActivity, int Function()? maxNumResults, AiSearchListInstancesResponseResultMetadata Function()? metadata, DateTime? modifiedAt, String? Function()? modifiedBy, bool Function()? paused, String? Function()? publicEndpointId, AiSearchListInstancesResponseResultPublicEndpointParams Function()? publicEndpointParams, bool Function()? reranking, AiSearchListInstancesResponseResultRerankingModel Function()? rerankingModel, AiSearchListInstancesResponseResultRetrievalOptions? Function()? retrievalOptions, AiSearchListInstancesResponseResultRewriteModel Function()? rewriteModel, bool Function()? rewriteQuery, double Function()? scoreThreshold, String Function()? source, AiSearchListInstancesResponseResultSourceParams? Function()? sourceParams, String Function()? status, String Function()? tokenId, AiSearchListInstancesResponseResultType Function()? type, String? vectorizeName, }) { return AiSearchListInstancesResponseResult(
