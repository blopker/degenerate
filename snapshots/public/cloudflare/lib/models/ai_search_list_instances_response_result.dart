...
@immutable final class AiSearchListInstancesResponseResult {const AiSearchListInstancesResponseResult({required this.vectorizeName, required this.createdAt, required this.id, required this.modifiedAt, this.fusionMethod = AiSearchListInstancesResponseResultFusionMethod.rrf, this.chunkSize = 256, this.aiSearchModel, this.createdBy = const Omittable.absent(), this.customMetadata, this.embeddingModel, this.enable = true, this.aiGatewayId = const Omittable.absent(), this.hybridSearchEnabled = false, this.cache = true, this.lastActivity = const Omittable.absent(), this.maxNumResults = 10, this.metadata, this.cacheThreshold = AiSearchListInstancesResponseResultCacheThreshold.closeEnough, this.modifiedBy = const Omittable.absent(), this.paused = false, this.publicEndpointId = const Omittable.absent(), this.chunkOverlap = 10, this.reranking = false, this.rerankingModel, this.retrievalOptions = const Omittable.absent(), this.rewriteModel, this.rewriteQuery = false, this.scoreThreshold = 0.4, this.source, this.sourceParams = const Omittable.absent(), this.status = 'waiting', this.tokenId, this.type, this.publicEndpointParams, });
...
factory AiSearchListInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchListInstancesResponseResult(
  ...
  retrievalOptions: json.containsKey('retrieval_options') ? Omittable(json['retrieval_options'] != null ? AiSearchListInstancesResponseResultRetrievalOptions.fromJson(json['retrieval_options'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  ...
  sourceParams: json.containsKey('source_params') ? Omittable(json['source_params'] != null ? AiSearchListInstancesResponseResultSourceParams.fromJson(json['source_params'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<AiSearchListInstancesResponseResultRetrievalOptions?> retrievalOptions;
...
final Omittable<AiSearchListInstancesResponseResultSourceParams?> sourceParams;
