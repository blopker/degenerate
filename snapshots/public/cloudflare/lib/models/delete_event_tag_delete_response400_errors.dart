...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class DeleteEventTagDeleteResponse400Errors {const DeleteEventTagDeleteResponse400Errors({required this.message});
