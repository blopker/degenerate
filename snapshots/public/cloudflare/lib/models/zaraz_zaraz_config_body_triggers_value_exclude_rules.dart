...
@immutable
final class ZarazZarazConfigBodyTriggersValueExcludeRules {
  const ZarazZarazConfigBodyTriggersValueExcludeRules({this.zarazLoadRule = const Omittable.absent(),
...
this.zarazElementVisibilityRule = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigBodyTriggersValueExcludeRules._({required this.rawValue, required this.zarazLoadRule,
...
required this.zarazElementVisibilityRule,});
  factory ZarazZarazConfigBodyTriggersValueExcludeRules.fromJson(Object? json) => ZarazZarazConfigBodyTriggersValueExcludeRules._(
...
if (zarazElementVisibilityRule.isPresent) zarazElementVisibilityRule.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigBodyTriggersValueExcludeRules && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigBodyTriggersValueExcludeRules(${toJson()})';
}
