...
import 'workers_binding_name.dart';final class WorkersBindingKindVpcService {const WorkersBindingKindVpcService({required this.name, required this.serviceId, required this.type, });
