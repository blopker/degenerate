...
@immutable final class CacheRulesCacheReserveResponseValueResult {const CacheRulesCacheReserveResponseValueResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
CacheRulesCacheReserveResponseValueResult copyWith({CacheRulesCacheReserveResponseValueResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesCacheReserveValue? value, }) { return CacheRulesCacheReserveResponseValueResult(
  id: id ?? this.id,
