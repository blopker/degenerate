...
@immutable final class ZonesSchemasCacheLevel {const ZonesSchemasCacheLevel({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
