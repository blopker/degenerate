...
@immutable final class ZonesSchemasCacheLevel {const ZonesSchemasCacheLevel({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasCacheLevel copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesCacheLevelValue? value, }) { return ZonesSchemasCacheLevel(
