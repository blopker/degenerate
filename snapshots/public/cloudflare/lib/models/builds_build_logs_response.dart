...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'builds_cursor.dart';final class BuildsBuildLogsResponse {const BuildsBuildLogsResponse({this.cursor, this.lines, this.truncated, });
