...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_app_policy_link.dart';import 'access_custom_deny_url.dart';import 'access_custom_non_identity_deny_url.dart';import 'access_schemas_auto_redirect_to_identity.dart';import 'access_schemas_session_duration.dart';import 'access_schemas_uuid.dart';import 'access_type.dart';import 'gateway_identity_proxy_endpoint_application_policies.dart';import 'gateway_identity_proxy_endpoint_application_policies_variant3.dart';@immutable final class GatewayIdentityProxyEndpointApplication {const GatewayIdentityProxyEndpointApplication({required this.type, this.allowedIdps, this.autoRedirectToIdentity, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.domain = const Omittable.absent(), this.name = const Omittable.absent(), this.sessionDuration, this.policies, });

factory GatewayIdentityProxyEndpointApplication.fromJson(Map<String, dynamic> json) { return GatewayIdentityProxyEndpointApplication(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => GatewayIdentityProxyEndpointApplicationPoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
); }
...
final List<GatewayIdentityProxyEndpointApplicationPolicies>? policies;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GatewayIdentityProxyEndpointApplication &&
...
@override String toString() { return 'GatewayIdentityProxyEndpointApplication(allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, customDenyUrl: $customDenyUrl, customNonIdentityDenyUrl: $customNonIdentityDenyUrl, customPages: $customPages, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type, policies: $policies)'; } 
 }
