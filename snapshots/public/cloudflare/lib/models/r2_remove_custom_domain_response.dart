...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class R2RemoveCustomDomainResponse {const R2RemoveCustomDomainResponse({required this.domain});
