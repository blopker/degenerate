...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_phishing_url_info.dart';import 'intel_schemas_messages2.dart';@immutable final class IntelPhishingUrlInfoComponentsSchemasSingleResponse {const IntelPhishingUrlInfoComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'IntelPhishingUrlInfoComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
