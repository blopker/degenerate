...
@immutable final class AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion {const AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion({required this.active, required this.createdAt, required this.data, required this.versionId, this.comment = const Omittable.absent(), });
...
AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion copyWith({AigConfigListGatewayDynamicRoutesResponseDataRoutesVersionActive? active, Omittable<String?>? comment, String? createdAt, String? data, String? versionId, }) { return AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion(
