...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logshare_messages2_source.dart';@immutable final class LogshareMessages2 {const LogshareMessages2({required this.code, required this.message, this.documentationUrl, this.source, });
