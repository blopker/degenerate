...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AiSearchListTokensResponseResult {const AiSearchListTokensResponseResult({required this.cfApiId, required this.createdAt, required this.id, required this.modifiedAt, required this.name, this.createdBy = const Omittable.absent(), this.enabled, this.legacy, this.modifiedBy = const Omittable.absent(), });
