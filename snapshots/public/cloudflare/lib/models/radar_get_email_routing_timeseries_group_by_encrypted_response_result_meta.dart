...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMetaAggInterval {const RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMetaNormalization {const RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMeta {const RadarGetEmailRoutingTimeseriesGroupByEncryptedResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
