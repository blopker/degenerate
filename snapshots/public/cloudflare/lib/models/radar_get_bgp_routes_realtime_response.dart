...
import 'radar_get_bgp_routes_realtime_response_result.dart';final class RadarGetBgpRoutesRealtimeResponse {const RadarGetBgpRoutesRealtimeResponse({required this.result, required this.success, });
