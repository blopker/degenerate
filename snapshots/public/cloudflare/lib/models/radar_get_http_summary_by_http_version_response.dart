...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_summary_by_http_version_response_result.dart';@immutable final class RadarGetHttpSummaryByHttpVersionResponse {const RadarGetHttpSummaryByHttpVersionResponse({required this.result, required this.success, });
