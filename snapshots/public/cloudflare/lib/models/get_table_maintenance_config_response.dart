...
factory GetTableMaintenanceConfigResponse.fromJson(Map<String, dynamic> json) { return GetTableMaintenanceConfigResponse(
  ...
  result: json['result'] != null ? R2DataCatalogTableMaintenanceConfigResponse.fromJson(json['result'] as Map<String, dynamic>) : null,
); }
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetTableMaintenanceConfigResponse &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success &&
          result == other.result; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result); } 
@override String toString() { return 'GetTableMaintenanceConfigResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
