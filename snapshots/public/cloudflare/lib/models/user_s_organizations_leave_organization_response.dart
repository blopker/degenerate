...
import 'iam_common_components_schemas_identifier.dart';final class UserSOrganizationsLeaveOrganizationResponse {const UserSOrganizationsLeaveOrganizationResponse({this.id});
