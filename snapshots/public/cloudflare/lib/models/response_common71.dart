...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'turnstile_messages2.dart';final class ResponseCommon71 {const ResponseCommon71({required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ResponseCommon71(errors: $errors, messages: $messages, success: $success)'; } 
 }
