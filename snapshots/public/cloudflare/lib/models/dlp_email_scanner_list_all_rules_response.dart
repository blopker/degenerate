...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_email_rule.dart';import 'dlp_messages2.dart';@immutable final class DlpEmailScannerListAllRulesResponse {const DlpEmailScannerListAllRulesResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpEmailScannerListAllRulesResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, List<DlpEmailRule>? Function()? result, }) { return DlpEmailScannerListAllRulesResponse(
...
@override String toString() { return 'DlpEmailScannerListAllRulesResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
