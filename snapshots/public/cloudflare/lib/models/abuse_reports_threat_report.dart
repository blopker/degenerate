...
/// 
@immutable final class AbuseReportsThreatReportHostNotification {const AbuseReportsThreatReportHostNotification._(this.value);

factory AbuseReportsThreatReportHostNotification.fromJson(String json) { return switch (json) {
  'send' => send,
  'send-anon' => sendAnon,
  _ => AbuseReportsThreatReportHostNotification._(json),
}; }

static const AbuseReportsThreatReportHostNotification send = AbuseReportsThreatReportHostNotification._('send');

static const AbuseReportsThreatReportHostNotification sendAnon = AbuseReportsThreatReportHostNotification._('send-anon');

static const List<AbuseReportsThreatReportHostNotification> values = [send, sendAnon];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AbuseReportsThreatReportHostNotification && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'AbuseReportsThreatReportHostNotification($value)'; } 
 }
/// Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.
/// 
@immutable final class AbuseReportsThreatReportOwnerNotification {const AbuseReportsThreatReportOwnerNotification._(this.value);

factory AbuseReportsThreatReportOwnerNotification.fromJson(String json) { return switch (json) {
  'send' => send,
  'send-anon' => sendAnon,
  _ => AbuseReportsThreatReportOwnerNotification._(json),
}; }

static const AbuseReportsThreatReportOwnerNotification send = AbuseReportsThreatReportOwnerNotification._('send');

static const AbuseReportsThreatReportOwnerNotification sendAnon = AbuseReportsThreatReportOwnerNotification._('send-anon');

static const List<AbuseReportsThreatReportOwnerNotification> values = [send, sendAnon];
...
bool get isUnknown { return !values.contains(this); } 
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AbuseReportsThreatReportOwnerNotification && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'AbuseReportsThreatReportOwnerNotification($value)'; } 
 }
@immutable final class AbuseReportsThreatReport {const AbuseReportsThreatReport({required this.act, required this.email, required this.email2, required this.name, required this.urls, required this.hostNotification, required this.justification, required this.ownerNotification, this.comments, this.company, this.reportedCountry, this.reportedUserAgent, this.tele, this.title, });

factory AbuseReportsThreatReport.fromJson(Map<String, dynamic> json) { return AbuseReportsThreatReport(
  act: json['act'],
  ...
  hostNotification: AbuseReportsThreatReportHostNotification.fromJson(json['host_notification'] as String),
  justification: json['justification'] as String,
  ownerNotification: AbuseReportsThreatReportOwnerNotification.fromJson(json['owner_notification'] as String),
); }
...
/// Notification type based on the abuse type. NOTE: Copyright (DMCA) and Trademark reports cannot be anonymous.
/// 
final AbuseReportsThreatReportHostNotification hostNotification;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AbuseReportsThreatReport &&
          act == other.act &&
...
@override int get hashCode { return Object.hash(act, comments, company, email, email2, name, reportedCountry, reportedUserAgent, tele, title, urls, hostNotification, justification, ownerNotification); } 
@override String toString() { return 'AbuseReportsThreatReport(act: $act, comments: $comments, company: $company, email: $email, email2: $email2, name: $name, reportedCountry: $reportedCountry, reportedUserAgent: $reportedUserAgent, tele: $tele, title: $title, urls: $urls, hostNotification: $hostNotification, justification: $justification, ownerNotification: $ownerNotification)'; } 
 }
