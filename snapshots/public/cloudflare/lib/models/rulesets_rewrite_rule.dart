...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_rewrite_rule_action_parameters.dart';import 'rulesets_rule_category.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';@immutable final class RulesetsRewriteRule {const RulesetsRewriteRule({required this.lastUpdated, required this.version, this.action = const Omittable.absent(), this.actionParameters, this.categories, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsRewriteRule.fromJson(Map<String, dynamic> json) { return RulesetsRewriteRule(
  action: json.containsKey('action') ? Omittable(json['action']) : const Omittable.absent(),
  actionParameters: json['action_parameters'] != null ? RulesetsRewriteRuleActionParameters.fromJson(json['action_parameters'] as Map<String, dynamic>) : null,
...
final RulesetsRewriteRuleActionParameters? actionParameters;
...
RulesetsRewriteRule copyWith({Omittable<dynamic>? action, RulesetsRewriteRuleActionParameters? Function()? actionParameters, List<RulesetsRuleCategory>? Function()? categories, Omittable<dynamic>? description, RulesetsRuleEnabled? Function()? enabled, RulesetsRuleExposedCredentialCheck? Function()? exposedCredentialCheck, String? Function()? expression, RulesetsRuleId? Function()? id, DateTime? lastUpdated, RulesetsRuleLogging? Function()? logging, RulesetsRuleRatelimit? Function()? ratelimit, String? Function()? ref, String? version, }) { return RulesetsRewriteRule(
