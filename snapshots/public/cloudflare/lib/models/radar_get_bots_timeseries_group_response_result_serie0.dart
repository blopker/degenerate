...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetBotsTimeseriesGroupResponseResultSerie0 {const RadarGetBotsTimeseriesGroupResponseResultSerie0({required this.timestamps, this.additionalProperties = const {}, });
...
RadarGetBotsTimeseriesGroupResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetBotsTimeseriesGroupResponseResultSerie0(
...
@override String toString() { return 'RadarGetBotsTimeseriesGroupResponseResultSerie0(timestamps: $timestamps, additionalProperties: $additionalProperties)'; } 
 }
