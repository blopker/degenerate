...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_records_comment.dart';import 'dns_records_loc_record_data.dart';import 'dns_records_name.dart';import 'dns_records_proxied.dart';import 'dns_records_settings.dart';import 'dns_records_ttl.dart';/// Record type.
final class DnsRecordsLocRecordType {const DnsRecordsLocRecordType._(this.value);
...
@override String toString() { return 'DnsRecordsLocRecordType($value)'; } 
 }
final class DnsRecordsLocRecord {const DnsRecordsLocRecord({this.comment, this.name, this.proxied, this.settings, this.tags, this.ttl, this.content, this.data, this.type, });
...
@override String toString() { return 'DnsRecordsLocRecord(comment: $comment, name: $name, proxied: $proxied, settings: $settings, tags: $tags, ttl: $ttl, content: $content, data: $data, type: $type)'; } 
 }
