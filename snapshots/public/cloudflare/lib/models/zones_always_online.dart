...
@immutable final class ZonesAlwaysOnline {const ZonesAlwaysOnline({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
