...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AiSearchCreateTokensResponseResult {const AiSearchCreateTokensResponseResult({required this.cfApiId, required this.createdAt, required this.id, required this.modifiedAt, required this.name, this.createdBy = const Omittable.absent(), this.enabled = true, this.legacy = true, this.modifiedBy = const Omittable.absent(), });
...
AiSearchCreateTokensResponseResult copyWith({String? cfApiId, DateTime? createdAt, Omittable<String?>? createdBy, bool Function()? enabled, String? id, bool Function()? legacy, DateTime? modifiedAt, Omittable<String?>? modifiedBy, String? name, }) { return AiSearchCreateTokensResponseResult(
