...
import 'access_allow_iframe.dart';import 'access_skip_interstitial.dart';final class AccessAppSettingsRequest {const AccessAppSettingsRequest({this.allowIframe, this.skipInterstitial, });
