...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_dataset.dart';import 'dlp_messages2.dart';@immutable final class DlpDatasetsReadAllResponse {const DlpDatasetsReadAllResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpDatasetsReadAllResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, List<DlpDataset>? Function()? result, }) { return DlpDatasetsReadAllResponse(
...
@override String toString() { return 'DlpDatasetsReadAllResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
