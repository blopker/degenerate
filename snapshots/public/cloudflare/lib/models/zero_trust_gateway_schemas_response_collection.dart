...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_lists.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_result_info.dart';@immutable final class ZeroTrustGatewaySchemasResponseCollection {const ZeroTrustGatewaySchemasResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
ZeroTrustGatewaySchemasResponseCollection copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayResultInfo? Function()? resultInfo, List<ZeroTrustGatewayLists>? Function()? result, }) { return ZeroTrustGatewaySchemasResponseCollection(
...
@override String toString() { return 'ZeroTrustGatewaySchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
