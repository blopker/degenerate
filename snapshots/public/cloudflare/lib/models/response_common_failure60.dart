...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rum_schemas_messages2.dart';final class ResponseCommonFailure60 {const ResponseCommonFailure60({required this.errors, required this.messages, required this.result, required this.success, });
