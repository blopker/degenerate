...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_entry.dart';import 'dlp_entry.dart';import 'dlp_messages2.dart';import 'document_fingerprint_entry.dart';import 'exact_data_entry.dart';import 'integration_entry.dart';import 'predefined_entry.dart';import 'word_list_entry.dart';@immutable final class DlpEntriesUpdateEntryResponse {const DlpEntriesUpdateEntryResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpEntriesUpdateEntryResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, DlpEntry? Function()? result, }) { return DlpEntriesUpdateEntryResponse(
...
@override String toString() { return 'DlpEntriesUpdateEntryResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
