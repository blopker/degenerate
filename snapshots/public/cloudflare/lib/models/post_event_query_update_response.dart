...
final class PostEventQueryUpdateResponse {const PostEventQueryUpdateResponse({required this.accountId, required this.alertEnabled, required this.alertRollupEnabled, required this.createdAt, required this.id, required this.name, required this.queryJson, required this.ruleEnabled, this.ruleScope, required this.updatedAt, required this.userEmail, });

factory PostEventQueryUpdateResponse.fromJson(Map<String, dynamic> json) { return PostEventQueryUpdateResponse(
...
PostEventQueryUpdateResponse copyWith({int? accountId, bool? alertEnabled, bool? alertRollupEnabled, String? createdAt, int? id, String? name, String? queryJson, bool? ruleEnabled, String Function()? ruleScope, String? updatedAt, String? userEmail, }) { return PostEventQueryUpdateResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostEventQueryUpdateResponse &&
...
@override String toString() { return 'PostEventQueryUpdateResponse(accountId: $accountId, alertEnabled: $alertEnabled, alertRollupEnabled: $alertRollupEnabled, createdAt: $createdAt, id: $id, name: $name, queryJson: $queryJson, ruleEnabled: $ruleEnabled, ruleScope: $ruleScope, updatedAt: $updatedAt, userEmail: $userEmail)'; } 
 }
