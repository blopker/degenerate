...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_custom_trust_store_response_id_only_result.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnly {const TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnly({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnly copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnlyResult? Function()? result, }) { return TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnly(
...
@override String toString() { return 'TlsCertificatesAndHostnamesCustomTrustStoreResponseIdOnly(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
