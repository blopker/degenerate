...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logpush_get_ownership_response_result.dart';import 'logpush_messages2.dart';@immutable final class LogpushGetOwnershipResponse {const LogpushGetOwnershipResponse({required this.errors, required this.messages, required this.success, this.result, });
