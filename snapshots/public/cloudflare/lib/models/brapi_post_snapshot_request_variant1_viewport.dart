...
@immutable final class BrapiPostSnapshotRequestVariant1Viewport {const BrapiPostSnapshotRequestVariant1Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostSnapshotRequestVariant1Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant1Viewport(
...
BrapiPostSnapshotRequestVariant1Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostSnapshotRequestVariant1Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostSnapshotRequestVariant1Viewport &&
...
@override String toString() { return 'BrapiPostSnapshotRequestVariant1Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
