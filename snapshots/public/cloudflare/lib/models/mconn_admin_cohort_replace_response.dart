...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_cohort.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminCohortReplaceResponse {const MconnAdminCohortReplaceResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminCohortReplaceResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminCohort? result, }) {return MconnAdminCohortReplaceResponse(
...
@override String toString() {return 'MconnAdminCohortReplaceResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
