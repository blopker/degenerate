...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings {const DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings({required this.canAlterConnectedMeetings, required this.canSwitchConnectedMeetings, required this.canSwitchToParentMeeting, });

factory DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings.fromJson(Map<String, dynamic> json) { return DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings copyWith({bool? canAlterConnectedMeetings, bool? canSwitchConnectedMeetings, bool? canSwitchToParentMeeting, }) { return DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings &&
...
@override String toString() { return 'DeletePresetsPresetIdResponseDataPermissionsConnectedMeetings(canAlterConnectedMeetings: $canAlterConnectedMeetings, canSwitchConnectedMeetings: $canSwitchConnectedMeetings, canSwitchToParentMeeting: $canSwitchToParentMeeting)'; } 
 }
