...
@immutable
final class BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue {
  const BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue({this.string = const Omittable.absent(),
...
this.listString = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue._({required this.rawValue, required this.string,
required this.$double,
required this.$bool,
required this.mapStringdynamic,
required this.listString,});
  factory BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue.fromJson(Object? json) => BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue._(
...
if (listString.isPresent) listString.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue(${toJson()})';
}
