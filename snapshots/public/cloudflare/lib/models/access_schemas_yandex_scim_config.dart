...
static const AccessSchemasYandexScimConfigIdentityUpdateBehavior reauth = AccessSchemasYandexScimConfigIdentityUpdateBehavior._('reauth');

static const AccessSchemasYandexScimConfigIdentityUpdateBehavior noAction = AccessSchemasYandexScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessSchemasYandexScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@immutable final class AccessSchemasYandexScimConfig {const AccessSchemasYandexScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessSchemasYandexScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessSchemasYandexScimConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasYandexScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessSchemasYandexScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessSchemasYandexScimConfigIdentityUpdateBehavior.noAction,
...
final AccessSchemasYandexScimConfigIdentityUpdateBehavior identityUpdateBehavior;
