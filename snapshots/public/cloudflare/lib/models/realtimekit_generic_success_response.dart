...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RealtimekitGenericSuccessResponse {const RealtimekitGenericSuccessResponse({required this.success, this.data, });
