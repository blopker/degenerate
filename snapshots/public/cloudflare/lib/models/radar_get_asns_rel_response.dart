...
import 'radar_get_asns_rel_response_result.dart';final class RadarGetAsnsRelResponse {const RadarGetAsnsRelResponse({required this.result, required this.success, });
