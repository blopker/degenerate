...
@immutable final class ZonesTransformations {const ZonesTransformations({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
