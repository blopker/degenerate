...
import 'post_dataset_populate_response_properties_datasets_items_properties_indicator_types_properties_errors_items.dart';final class PostDatasetPopulateResponsePropertiesDatasetsItemsPropertiesIndicatorTypesPropertiesErrors {const PostDatasetPopulateResponsePropertiesDatasetsItemsPropertiesIndicatorTypesPropertiesErrors({required this.items, required this.type, });
