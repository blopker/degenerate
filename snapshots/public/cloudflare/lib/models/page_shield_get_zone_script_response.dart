...
import 'page_shield_get_zone_script_response_result.dart';final class PageShieldGetZoneScriptResponse {const PageShieldGetZoneScriptResponse({required this.result});
