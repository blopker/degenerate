...
final class RadarGetEmailRoutingSummaryByArcResponseResultMeta {const RadarGetEmailRoutingSummaryByArcResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
