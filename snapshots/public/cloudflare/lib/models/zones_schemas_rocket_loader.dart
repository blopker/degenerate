...
@immutable final class ZonesSchemasRocketLoader {const ZonesSchemasRocketLoader({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
