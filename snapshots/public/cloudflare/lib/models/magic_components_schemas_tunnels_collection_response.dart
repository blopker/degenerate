...
import 'magic_components_schemas_tunnels_collection_response_result.dart';final class MagicComponentsSchemasTunnelsCollectionResponse {const MagicComponentsSchemasTunnelsCollectionResponse({this.result});
