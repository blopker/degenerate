...
final class RadarGetTcpResetsTimeoutsTimeseriesGroupResponseResultMetaUnits {const RadarGetTcpResetsTimeoutsTimeseriesGroupResponseResultMetaUnits({required this.name, required this.value, });
