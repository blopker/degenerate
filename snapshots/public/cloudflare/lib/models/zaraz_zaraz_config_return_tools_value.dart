...
@immutable
final class ZarazZarazConfigReturnToolsValue {
  const ZarazZarazConfigReturnToolsValue({this.zarazManagedComponent = const Omittable.absent(),
this.zarazCustomManagedComponent = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigReturnToolsValue._({required this.rawValue, required this.zarazManagedComponent,
required this.zarazCustomManagedComponent,});
  factory ZarazZarazConfigReturnToolsValue.fromJson(Object? json) => ZarazZarazConfigReturnToolsValue._(
...
if (zarazCustomManagedComponent.isPresent) zarazCustomManagedComponent.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigReturnToolsValue && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigReturnToolsValue(${toJson()})';
}
