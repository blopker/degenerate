...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_app_response.dart';import 'access_messages2.dart';@immutable final class AccessAppsComponentsSchemasSingleResponse {const AccessAppsComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessAppsComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessAppResponse? Function()? result, }) { return AccessAppsComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessAppsComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
