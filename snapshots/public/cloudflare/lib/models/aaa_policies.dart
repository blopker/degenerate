...
import 'aaa_alert_interval.dart';import 'aaa_alert_type.dart';import 'aaa_enabled.dart';import 'aaa_filters.dart';import 'aaa_mechanisms.dart';import 'aaa_policy_id.dart';import 'aaa_schemas_description.dart';import 'aaa_schemas_name.dart';extension type AaaTimestamp(DateTime value) {
factory AaaTimestamp.fromJson(String json) => AaaTimestamp(DateTime.parse(json));

String toJson() => value.toIso8601String();

}
final class AaaPolicies {const AaaPolicies({this.alertInterval, this.alertType, this.created, this.description, this.enabled, this.filters, this.id, this.mechanisms, this.modified, this.name, });
