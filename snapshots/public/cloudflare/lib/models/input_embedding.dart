...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'input_embedding_text.dart';@immutable final class InputEmbedding {const InputEmbedding({required this.text, this.truncateInputs, });
