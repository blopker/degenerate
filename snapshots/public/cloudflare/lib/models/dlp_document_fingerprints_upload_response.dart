...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_document_fingerprint_upload.dart';import 'dlp_messages2.dart';@immutable final class DlpDocumentFingerprintsUploadResponse {const DlpDocumentFingerprintsUploadResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpDocumentFingerprintsUploadResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, DlpDocumentFingerprintUpload? Function()? result, }) { return DlpDocumentFingerprintsUploadResponse(
...
@override String toString() { return 'DlpDocumentFingerprintsUploadResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
