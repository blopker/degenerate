...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_ai_post_run_hf_thebloke_deepseek_coder67b_instruct_awq_response400_errors.dart';final class WorkersAiPostRunHfTheblokeDeepseekCoder67bInstructAwqResponse400 {const WorkersAiPostRunHfTheblokeDeepseekCoder67bInstructAwqResponse400({required this.errors, required this.result, required this.success, });
