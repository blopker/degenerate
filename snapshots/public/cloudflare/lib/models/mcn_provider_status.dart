...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_cloud_platform_client.dart';import 'mcn_provider_discovery_progress.dart';import 'mcn_provider_discovery_status.dart';final class McnProviderStatus {const McnProviderStatus({this.credentialsGoodSince, this.credentialsMissingSince, this.credentialsRejectedSince, this.discoveryMessage, this.discoveryMessageV2, required this.discoveryProgress, required this.discoveryProgressV2, this.inUseBy, this.lastDiscoveryCompletedAt, this.lastDiscoveryCompletedAtV2, this.lastDiscoveryStartedAt, this.lastDiscoveryStartedAtV2, required this.lastDiscoveryStatus, required this.lastDiscoveryStatusV2, this.lastUpdated, required this.regions, });
