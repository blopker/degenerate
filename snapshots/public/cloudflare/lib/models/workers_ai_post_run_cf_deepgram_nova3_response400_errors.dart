...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorkersAiPostRunCfDeepgramNova3Response400Errors {const WorkersAiPostRunCfDeepgramNova3Response400Errors({required this.code, required this.message, });
