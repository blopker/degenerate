...
final class ZarazZarazConfigBodyTriggersValue {const ZarazZarazConfigBodyTriggersValue({this.description, required this.excludeRules, required this.loadRules, required this.name, this.system, });
