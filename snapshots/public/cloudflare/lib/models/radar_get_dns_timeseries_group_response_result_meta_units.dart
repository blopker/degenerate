...
final class RadarGetDnsTimeseriesGroupResponseResultMetaUnits {const RadarGetDnsTimeseriesGroupResponseResultMetaUnits({required this.name, required this.value, });
