...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_account.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamResponseCollectionAccounts {const IamResponseCollectionAccounts({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamResponseCollectionAccounts copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamAccount>? Function()? result, }) { return IamResponseCollectionAccounts(
...
@override String toString() { return 'IamResponseCollectionAccounts(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
