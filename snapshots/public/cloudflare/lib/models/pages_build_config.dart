...
final class PagesBuildConfig {const PagesBuildConfig({this.buildCaching, this.buildCommand, this.destinationDir, this.rootDir, required this.webAnalyticsTag, required this.webAnalyticsToken, });
