...
@immutable final class RadarGetHttpTopBrowsersResponseResultMetaNormalization {const RadarGetHttpTopBrowsersResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetHttpTopBrowsersResponseResultMeta {const RadarGetHttpTopBrowsersResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
