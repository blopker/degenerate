...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetAttacksLayer7TimeseriesGroupByHttpMethodResponseResultSerie0 {const RadarGetAttacksLayer7TimeseriesGroupByHttpMethodResponseResultSerie0({required this.timestamps, this.additionalProperties = const {}, });
...
RadarGetAttacksLayer7TimeseriesGroupByHttpMethodResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetAttacksLayer7TimeseriesGroupByHttpMethodResponseResultSerie0(
