...
factory AigConfigFetchGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigFetchGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? AigConfigFetchGatewayResponseResultDlp.fromJson(json['dlp']) : null,
  ...
  logManagementStrategy: json.containsKey('log_management_strategy') ? Omittable(json['log_management_strategy'] != null ? AigConfigFetchGatewayResponseResultLogManagementStrategy.fromJson(json['log_management_strategy'] as String) : null) : const Omittable.absent(),
  ...
  otel: json.containsKey('otel') ? Omittable((json['otel'] as List<dynamic>?)?.map((e) => AigConfigFetchGatewayResponseResultOtel.fromJson(e as Map<String, dynamic>)).toList()) : const Omittable.absent(),
  ...
  stripe: json.containsKey('stripe') ? Omittable(json['stripe'] != null ? AigConfigFetchGatewayResponseResultStripe.fromJson(json['stripe'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  workersAiBillingMode: json['workers_ai_billing_mode'] != null ? AigConfigFetchGatewayResponseResultWorkersAiBillingMode.fromJson(json['workers_ai_billing_mode'] as String) : null,
...
final Omittable<AigConfigFetchGatewayResponseResultLogManagementStrategy?> logManagementStrategy;
...
final Omittable<List<AigConfigFetchGatewayResponseResultOtel>?> otel;
...
final Omittable<AigConfigFetchGatewayResponseResultStripe?> stripe;
...
AigConfigFetchGatewayResponseResultWorkersAiBillingMode get workersAiBillingModeOrDefault { return workersAiBillingMode ?? AigConfigFetchGatewayResponseResultWorkersAiBillingMode.fromJson('postpaid'); } 
