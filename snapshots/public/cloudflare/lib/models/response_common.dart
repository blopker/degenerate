...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aaa_messages2.dart';final class ResponseCommon {const ResponseCommon({required this.errors, required this.messages, required this.success, });
