...
final class AiSearchCreateInstancesRequestCustomMetadata {const AiSearchCreateInstancesRequestCustomMetadata({required this.dataType, required this.fieldName, });
