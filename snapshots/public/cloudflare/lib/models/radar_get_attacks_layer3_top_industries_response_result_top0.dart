...
final class RadarGetAttacksLayer3TopIndustriesResponseResultTop0 {const RadarGetAttacksLayer3TopIndustriesResponseResultTop0({required this.name, required this.value, });
