...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ResponseCollection5ResultInfo {const ResponseCollection5ResultInfo({this.count, this.page, this.perPage, this.totalCount, });
