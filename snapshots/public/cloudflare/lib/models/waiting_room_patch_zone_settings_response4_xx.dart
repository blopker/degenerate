...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waitingroom_messages2.dart';@immutable final class WaitingRoomPatchZoneSettingsResponse4Xx {const WaitingRoomPatchZoneSettingsResponse4Xx({required this.result, required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'WaitingRoomPatchZoneSettingsResponse4Xx(result: $result, errors: $errors, messages: $messages, success: $success)'; } 
 }
