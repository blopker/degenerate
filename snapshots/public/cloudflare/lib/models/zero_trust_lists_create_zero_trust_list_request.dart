...
import 'package:collection/collection.dart';import 'zero_trust_gateway_description.dart';import 'zero_trust_gateway_items_input2.dart';import 'zero_trust_gateway_name.dart';import 'zero_trust_gateway_schemas_type.dart';final class ZeroTrustListsCreateZeroTrustListRequest {const ZeroTrustListsCreateZeroTrustListRequest({this.description, this.items, required this.name, required this.type, });
