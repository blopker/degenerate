...
final class RadarGetAttacksLayer7TimeseriesGroupByIndustryResponseResultMetaUnits {const RadarGetAttacksLayer7TimeseriesGroupByIndustryResponseResultMetaUnits({required this.name, required this.value, });
