...
@immutable final class RadarGetRobotsTxtTopDomainCategoriesByFilesParsedResponseResultMetaNormalization {const RadarGetRobotsTxtTopDomainCategoriesByFilesParsedResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetRobotsTxtTopDomainCategoriesByFilesParsedResponseResultMeta {const RadarGetRobotsTxtTopDomainCategoriesByFilesParsedResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
