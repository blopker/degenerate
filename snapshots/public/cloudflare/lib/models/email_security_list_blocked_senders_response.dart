...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_blocked_sender.dart';import 'email_security_message.dart';import 'email_security_result_info.dart';final class EmailSecurityListBlockedSendersResponse {const EmailSecurityListBlockedSendersResponse({required this.errors, required this.messages, required this.success, required this.result, required this.resultInfo, });
...
@override String toString() { return 'EmailSecurityListBlockedSendersResponse(errors: $errors, messages: $messages, success: $success, result: $result, resultInfo: $resultInfo)'; } 
 }
