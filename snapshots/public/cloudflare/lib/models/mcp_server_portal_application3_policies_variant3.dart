...
@immutable final class McpServerPortalApplication3PoliciesVariant3 {const McpServerPortalApplication3PoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory McpServerPortalApplication3PoliciesVariant3.fromJson(Map<String, dynamic> json) {return McpServerPortalApplication3PoliciesVariant3(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is McpServerPortalApplication3PoliciesVariant3 &&
