...
return  AiSearchUpdateInstancesError400(AiSearchUpdateInstancesResponse400.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  AiSearchUpdateInstancesError404(AiSearchUpdateInstancesResponse404.fromJson(json as Map<String, dynamic>));default:
