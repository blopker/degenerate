...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rum_messages2.dart';import 'rum_site.dart';final class RumSiteResponseSingle {const RumSiteResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
