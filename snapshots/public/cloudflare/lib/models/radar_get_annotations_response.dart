...
import 'radar_get_annotations_response_result.dart';final class RadarGetAnnotationsResponse {const RadarGetAnnotationsResponse({required this.result, required this.success, });
