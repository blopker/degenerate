...
import 'pay_per_crawl_error_source.dart';final class PayPerCrawlRestError {const PayPerCrawlRestError({this.code, this.documentationUrl, this.error, this.source, });
