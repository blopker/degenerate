...
final class UrlscannerGetScanHarResponseResultHarLogCreator {const UrlscannerGetScanHarResponseResultHarLogCreator({required this.comment, required this.name, required this.version, });
