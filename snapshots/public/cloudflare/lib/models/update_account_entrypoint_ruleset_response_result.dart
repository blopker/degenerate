...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_request_rule.dart';import 'rulesets_ruleset_id.dart';import 'rulesets_ruleset_kind.dart';import 'rulesets_ruleset_phase.dart';import 'rulesets_ruleset_version.dart';@immutable final class UpdateAccountEntrypointRulesetResponseResult {const UpdateAccountEntrypointRulesetResponseResult({required this.id, required this.lastUpdated, required this.name, required this.version, required this.kind, required this.phase, required this.rules, this.description = '', });

factory UpdateAccountEntrypointRulesetResponseResult.fromJson(Map<String, dynamic> json) { return UpdateAccountEntrypointRulesetResponseResult(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UpdateAccountEntrypointRulesetResponseResult &&
...
@override String toString() { return 'UpdateAccountEntrypointRulesetResponseResult(description: $description, id: $id, lastUpdated: $lastUpdated, name: $name, version: $version, kind: $kind, phase: $phase, rules: $rules)'; } 
 }
