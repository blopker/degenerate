...
factory EmailSecurityGetMessageResponseResult.fromJson(Map<String, dynamic> json) { return EmailSecurityGetMessageResponseResult(
  ...
  findings: json.containsKey('findings') ? Omittable((json['findings'] as List<dynamic>?)?.map((e) => EmailSecurityGetMessageResponseResultFindings.fromJson(e as Map<String, dynamic>)).toList()) : const Omittable.absent(),
  ...
  validation: json.containsKey('validation') ? Omittable(json['validation'] != null ? EmailSecurityGetMessageResponseResultValidation.fromJson(json['validation'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<List<EmailSecurityGetMessageResponseResultFindings>?> findings;
...
final Omittable<EmailSecurityGetMessageResponseResultValidation?> validation;
...
EmailSecurityGetMessageResponseResult copyWith({dynamic Function()? actionLog, Omittable<String?>? alertId, List<String>? clientRecipients, Omittable<EmailSecurityMessageDeliveryMode?>? deliveryMode, List<String>? detectionReasons, Omittable<String?>? edfHash, Omittable<String?>? envelopeFrom, Omittable<List<String>?>? envelopeTo, Omittable<EmailSecurityDispositionLabel?>? finalDisposition, Omittable<List<EmailSecurityGetMessageResponseResultFindings>?>? findings, Omittable<String?>? from, Omittable<String?>? fromName, Omittable<String?>? htmltextStructureHash, bool? isPhishSubmission, bool? isQuarantined, Omittable<String?>? messageId, List<EmailSecurityGetMessageResponseResultPostDeliveryOperations>? Function()? postDeliveryOperations, EmailSecurityPostfixId? postfixId, Omittable<String?>? postfixIdOutbound, EmailSecurityGetMessageResponseResultProperties? properties, Omittable<String?>? replyto, Omittable<String?>? sentDate, Omittable<String?>? subject, Omittable<List<String>?>? threatCategories, Omittable<List<String>?>? to, Omittable<List<String>?>? toName, String? ts, Omittable<EmailSecurityGetMessageResponseResultValidation?>? validation, String? id, }) { return EmailSecurityGetMessageResponseResult(
