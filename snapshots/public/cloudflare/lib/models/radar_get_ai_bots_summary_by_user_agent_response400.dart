...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ai_bots_summary_by_user_agent_response400_errors.dart';@immutable final class RadarGetAiBotsSummaryByUserAgentResponse400 {const RadarGetAiBotsSummaryByUserAgentResponse400({required this.errors, required this.result, required this.success, });
