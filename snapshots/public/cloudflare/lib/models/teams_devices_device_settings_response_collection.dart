...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_device_settings_policy.dart';import 'teams_devices_messages2.dart';import 'teams_devices_result_info.dart';@immutable final class TeamsDevicesDeviceSettingsResponseCollection {const TeamsDevicesDeviceSettingsResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TeamsDevicesDeviceSettingsResponseCollection copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesDeviceSettingsPolicy>? result, bool? success, TeamsDevicesResultInfo Function()? resultInfo, }) { return TeamsDevicesDeviceSettingsResponseCollection(
...
@override String toString() { return 'TeamsDevicesDeviceSettingsResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
