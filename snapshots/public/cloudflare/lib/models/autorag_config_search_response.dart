...
import 'autorag_config_search_response_result.dart';final class AutoragConfigSearchResponse {const AutoragConfigSearchResponse({required this.result, required this.success, });
