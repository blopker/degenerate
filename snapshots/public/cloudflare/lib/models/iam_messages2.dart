...
final class IamMessages2 {const IamMessages2({required this.code, required this.message, });
...
@override String toString() { return 'IamMessages2(code: $code, message: $message)'; } 
 }
