...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'response_message.dart';import 'teams_devices_cursor_result_info.dart';@immutable final class RevokeRegistrationsResponse {const RevokeRegistrationsResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
