...
/// mTLS binding.
final class PagesDeploymentConfigValuesRequestMtlsCertificatesValue {const PagesDeploymentConfigValuesRequestMtlsCertificatesValue({required this.certificateId});
