...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class $5InpaintingRequest {const $5InpaintingRequest({required this.prompt, this.guidance, this.height, this.image, this.imageB64, this.mask, this.negativePrompt, this.numSteps, this.seed, this.strength, this.width, });
