...
factory WorGetWorkflowDetailsResponseResult.fromJson(Map<String, dynamic> json) { return WorGetWorkflowDetailsResponseResult(
  ...
  instances: WorGetWorkflowDetailsResponseResultInstances.fromJson(json['instances'] as Map<String, dynamic>),
...
final WorGetWorkflowDetailsResponseResultInstances instances;
