...
final class RadarGetDnsTimeseriesGroupByDnssecResponseResultMetaUnits {const RadarGetDnsTimeseriesGroupByDnssecResponseResultMetaUnits({required this.name, required this.value, });
