...
@immutable final class LoadBalancingAdaptiveRouting {const LoadBalancingAdaptiveRouting({this.failoverAcrossPools});

factory LoadBalancingAdaptiveRouting.fromJson(Map<String, dynamic> json) {return LoadBalancingAdaptiveRouting(
  failoverAcrossPools: json['failover_across_pools'] as bool?,
);}
...
bool get failoverAcrossPoolsOrDefault {return failoverAcrossPools ?? false;}
