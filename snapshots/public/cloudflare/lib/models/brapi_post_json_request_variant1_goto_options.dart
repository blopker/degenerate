...
@immutable final class BrapiPostJsonRequestVariant1GotoOptions {const BrapiPostJsonRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
...
factory BrapiPostJsonRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? OneOf5.parse(json['waitUntil'], fromA: (v) => BrapiPostJsonRequestVariant1GotoOptionsWaitUntilVariant1.fromJson(v as String), fromB: (v) => BrapiPostJsonRequestVariant1GotoOptionsWaitUntilVariant2.fromJson(v as String), fromC: (v) => BrapiPostJsonRequestVariant1GotoOptionsWaitUntilVariant3.fromJson(v as String), fromD: (v) => BrapiPostJsonRequestVariant1GotoOptionsWaitUntilVariant4.fromJson(v as String), fromE: (v) => (v as List<dynamic>).map((e) => BrapiPostJsonRequestVariant1GotoOptionsWaitUntilVariant5.fromJson(e as String)).toList(),) : null,
); }
