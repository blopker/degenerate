...
final class WorBatchTerminateWorkflowInstancesResponseMessages {const WorBatchTerminateWorkflowInstancesResponseMessages({required this.code, required this.message, });
