...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';@immutable final class ZoneLockdownUpdateAZoneLockdownRuleResponse4Xx {const ZoneLockdownUpdateAZoneLockdownRuleResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'ZoneLockdownUpdateAZoneLockdownRuleResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
