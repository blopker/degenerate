...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_records_dns_response_zone_usage_result.dart';import 'dns_records_messages2.dart';@immutable final class DnsRecordsDnsResponseZoneUsage {const DnsRecordsDnsResponseZoneUsage({required this.errors, required this.messages, required this.success, this.result, });
...
DnsRecordsDnsResponseZoneUsage copyWith({List<DnsRecordsMessages2>? errors, List<DnsRecordsMessages2>? messages, bool? success, DnsRecordsDnsResponseZoneUsageResult? Function()? result, }) { return DnsRecordsDnsResponseZoneUsage(
...
@override String toString() { return 'DnsRecordsDnsResponseZoneUsage(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
