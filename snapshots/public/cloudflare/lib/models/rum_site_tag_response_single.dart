...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rum_messages2.dart';import 'rum_site_tag_response_single_result.dart';final class RumSiteTagResponseSingle {const RumSiteTagResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
