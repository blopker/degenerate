...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'zero_trust_organization_get_your_zero_trust_organization_doh_settings_response_result.dart';@immutable final class ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponse {const ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponseResult? Function()? result, }) { return ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponse(
...
@override String toString() { return 'ZeroTrustOrganizationGetYourZeroTrustOrganizationDohSettingsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
