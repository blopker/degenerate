...
import 'mconn_admin_macros_provision_physical_connector_result.dart';final class MconnAdminMacrosProvisionPhysicalConnectorResponse {const MconnAdminMacrosProvisionPhysicalConnectorResponse({this.result});
