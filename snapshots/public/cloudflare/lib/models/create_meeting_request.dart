...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtimekit_ai_config.dart';import 'realtimekit_recording_config.dart';@immutable final class CreateMeetingRequest {const CreateMeetingRequest({this.aiConfig, this.liveStreamOnStart = const Omittable.absent(), this.persistChat, this.recordOnStart = const Omittable.absent(), this.recordingConfig, this.sessionKeepAliveTimeInSecs, this.summarizeOnEnd, this.title = const Omittable.absent(), });
...
CreateMeetingRequest copyWith({RealtimekitAiConfig? Function()? aiConfig, Omittable<bool?>? liveStreamOnStart, bool? Function()? persistChat, Omittable<bool?>? recordOnStart, RealtimekitRecordingConfig? Function()? recordingConfig, double? Function()? sessionKeepAliveTimeInSecs, bool? Function()? summarizeOnEnd, Omittable<String?>? title, }) {return CreateMeetingRequest(
