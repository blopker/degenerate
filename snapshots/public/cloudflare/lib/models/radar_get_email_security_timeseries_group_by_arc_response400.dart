...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_email_security_timeseries_group_by_arc_response400_errors.dart';final class RadarGetEmailSecurityTimeseriesGroupByArcResponse400 {const RadarGetEmailSecurityTimeseriesGroupByArcResponse400({required this.errors, required this.result, required this.success, });
