...
final class RealtimekitPagingResponsePaging {const RealtimekitPagingResponsePaging({required this.endOffset, required this.startOffset, required this.totalCount, });
