...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dos_expression_filter.dart';import 'dos_expression_filter_list_response_result_info.dart';import 'dos_messages2.dart';@immutable final class DosExpressionFilterListResponse {const DosExpressionFilterListResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
factory DosExpressionFilterListResponse.fromJson(Map<String, dynamic> json) { return DosExpressionFilterListResponse(
  ...
  resultInfo: json['result_info'] != null ? DosExpressionFilterListResponseResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final DosExpressionFilterListResponseResultInfo? resultInfo;
...
@override String toString() { return 'DosExpressionFilterListResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
