...
final DnsFirewallMessages2Source? source;
...
DnsFirewallMessages2 copyWith({int? code, String Function()? documentationUrl, String? message, DnsFirewallMessages2Source Function()? source, }) { return DnsFirewallMessages2(
  code: code ?? this.code,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DnsFirewallMessages2 &&
          code == other.code &&
          documentationUrl == other.documentationUrl &&
          message == other.message &&
          source == other.source; } 
@override int get hashCode { return Object.hash(code, documentationUrl, message, source); } 
@override String toString() { return 'DnsFirewallMessages2(code: $code, documentationUrl: $documentationUrl, message: $message, source: $source)'; } 
 }
