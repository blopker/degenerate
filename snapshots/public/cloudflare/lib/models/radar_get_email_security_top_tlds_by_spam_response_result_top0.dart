...
final class RadarGetEmailSecurityTopTldsBySpamResponseResultTop0 {const RadarGetEmailSecurityTopTldsBySpamResponseResultTop0({required this.name, required this.value, });
