...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultSerie0 {const RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultSerie0({required this.timestamps, this.additionalProperties = const {}, });
...
RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResultSerie0(
