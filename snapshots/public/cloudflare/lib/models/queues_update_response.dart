...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_queue.dart';final class QueuesUpdateResponse {const QueuesUpdateResponse({this.errors, this.messages, this.success, this.result, });
...
QueuesUpdateResponse copyWith({List<ErrorModel22> Function()? errors, List<String> Function()? messages, bool Function()? success, MqQueue Function()? result, }) { return QueuesUpdateResponse(
...
@override String toString() { return 'QueuesUpdateResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
