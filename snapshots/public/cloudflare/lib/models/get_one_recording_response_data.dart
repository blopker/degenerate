...
static const GetOneRecordingResponseDataStatus recording = GetOneRecordingResponseDataStatus._('RECORDING');

static const GetOneRecordingResponseDataStatus uploading = GetOneRecordingResponseDataStatus._('UPLOADING');

static const GetOneRecordingResponseDataStatus uploaded = GetOneRecordingResponseDataStatus._('UPLOADED');

static const GetOneRecordingResponseDataStatus errored = GetOneRecordingResponseDataStatus._('ERRORED');

static const GetOneRecordingResponseDataStatus paused = GetOneRecordingResponseDataStatus._('PAUSED');

static const List<GetOneRecordingResponseDataStatus> values = [invoked, recording, uploading, uploaded, errored, paused];
...
factory GetOneRecordingResponseData.fromJson(Map<String, dynamic> json) { return GetOneRecordingResponseData(
  ...
  status: GetOneRecordingResponseDataStatus.fromJson(json['status'] as String),
...
final GetOneRecordingResponseDataStatus status;
...
GetOneRecordingResponseData copyWith({Uri? Function()? audioDownloadUrl, Uri? Function()? downloadUrl, DateTime? Function()? downloadUrlExpiry, double? Function()? fileSize, String? id, DateTime? invokedTime, String? outputFileName, int? Function()? recordingDuration, String? Function()? sessionId, DateTime? Function()? startedTime, GetOneRecordingResponseDataStatus? status, DateTime? Function()? stoppedTime, RealtimekitStartReason? Function()? startReason, RealtimekitStopReason? Function()? stopReason, RealtimekitStorageConfig? Function()? storageConfig, }) { return GetOneRecordingResponseData(
