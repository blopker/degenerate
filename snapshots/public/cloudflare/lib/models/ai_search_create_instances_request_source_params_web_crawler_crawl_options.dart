...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource {const AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource._(this.value);
...
@immutable final class AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptions {const AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptions({this.depth, this.includeExternalLinks, this.includeSubdomains, this.maxAge, this.source, });
...
factory AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptions.fromJson(Map<String, dynamic> json) {return AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptions(
  ...
  source: json['source'] != null ? AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource.fromJson(json['source'] as String) : null,
);}
...
/// The value with the schema default applied when absent.
AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource get sourceOrDefault {return source ?? AiSearchCreateInstancesRequestSourceParamsWebCrawlerCrawlOptionsSource.fromJson('all');}
