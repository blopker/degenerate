...
import 'package:collection/collection.dart';import 'brapi_post_markdown_response_errors.dart';final class BrapiPostMarkdownResponse {const BrapiPostMarkdownResponse({this.errors, this.result, required this.success, });
