...
@immutable final class ZonesSchemasIpGeolocation {const ZonesSchemasIpGeolocation({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
