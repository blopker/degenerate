...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'hyperdrive_hyperdrive_scheme.dart';@immutable final class AccessProtectedDatabaseBehindCloudflareTunnel3 {const AccessProtectedDatabaseBehindCloudflareTunnel3({required this.database, required this.password, required this.scheme, required this.user, required this.accessClientId, required this.accessClientSecret, required this.host, });

factory AccessProtectedDatabaseBehindCloudflareTunnel3.fromJson(Map<String, dynamic> json) { return AccessProtectedDatabaseBehindCloudflareTunnel3(
...
AccessProtectedDatabaseBehindCloudflareTunnel3 copyWith({String? database, String? password, HyperdriveHyperdriveScheme? scheme, String? user, String? accessClientId, String? accessClientSecret, String? host, }) { return AccessProtectedDatabaseBehindCloudflareTunnel3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccessProtectedDatabaseBehindCloudflareTunnel3 &&
...
@override String toString() { return 'AccessProtectedDatabaseBehindCloudflareTunnel3(database: $database, password: $password, scheme: $scheme, user: $user, accessClientId: $accessClientId, accessClientSecret: $accessClientSecret, host: $host)'; } 
 }
