...
final class ZeroTrustGatewayCertificateSettings {const ZeroTrustGatewayCertificateSettings({required this.id});
...
@override String toString() { return 'ZeroTrustGatewayCertificateSettings(id: $id)'; } 
 }
