...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bundle_messages2.dart';@immutable final class ResponseCommonFailure77 {const ResponseCommonFailure77({required this.errors, required this.messages, required this.result, required this.success, });
