...
final class PagesPlainTextEnvVar {const PagesPlainTextEnvVar({required this.type, required this.value, });
...
@override String toString() { return 'PagesPlainTextEnvVar(type: $type, value: $value)'; } 
 }
