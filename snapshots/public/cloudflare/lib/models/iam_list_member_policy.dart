...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_access.dart';import 'iam_permission_group.dart';import 'iam_policy_identifier.dart';import 'iam_resource_group.dart';final class IamListMemberPolicy {const IamListMemberPolicy({this.access, this.id, this.permissionGroups, this.resourceGroups, });
