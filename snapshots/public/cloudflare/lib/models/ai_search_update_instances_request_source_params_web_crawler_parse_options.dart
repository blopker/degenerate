...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_update_instances_request_source_params_web_crawler_parse_options_content_selector.dart';@immutable final class AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions {const AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions({this.contentSelector, this.includeHeaders, this.includeImages, this.specificSitemaps, this.useBrowserRendering, });
...
final List<AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptionsContentSelector>? contentSelector;
...
AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions copyWith({List<AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptionsContentSelector>? Function()? contentSelector, Map<String, String>? Function()? includeHeaders, bool? Function()? includeImages, List<Uri>? Function()? specificSitemaps, bool? Function()? useBrowserRendering, }) { return AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions &&
...
@override String toString() { return 'AiSearchUpdateInstancesRequestSourceParamsWebCrawlerParseOptions(contentSelector: $contentSelector, includeHeaders: $includeHeaders, includeImages: $includeImages, specificSitemaps: $specificSitemaps, useBrowserRendering: $useBrowserRendering)'; } 
 }
