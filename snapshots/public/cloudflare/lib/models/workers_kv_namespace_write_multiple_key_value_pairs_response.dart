...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_kv_bulk_result.dart';import 'workers_kv_messages2.dart';@immutable final class WorkersKvNamespaceWriteMultipleKeyValuePairsResponse {const WorkersKvNamespaceWriteMultipleKeyValuePairsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
WorkersKvNamespaceWriteMultipleKeyValuePairsResponse copyWith({List<WorkersKvMessages2>? errors, List<WorkersKvMessages2>? messages, bool? success, WorkersKvBulkResult Function()? result, }) { return WorkersKvNamespaceWriteMultipleKeyValuePairsResponse(
...
@override String toString() { return 'WorkersKvNamespaceWriteMultipleKeyValuePairsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
