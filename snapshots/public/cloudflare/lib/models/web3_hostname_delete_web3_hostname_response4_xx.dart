...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'web3_messages2.dart';import 'web3_result_info.dart';@immutable final class Web3HostnameDeleteWeb3HostnameResponse4Xx {const Web3HostnameDeleteWeb3HostnameResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });

factory Web3HostnameDeleteWeb3HostnameResponse4Xx.fromJson(Map<String, dynamic> json) { return Web3HostnameDeleteWeb3HostnameResponse4Xx(
...
Web3HostnameDeleteWeb3HostnameResponse4Xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, Web3ResultInfo? Function()? resultInfo, }) { return Web3HostnameDeleteWeb3HostnameResponse4Xx(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Web3HostnameDeleteWeb3HostnameResponse4Xx &&
...
@override String toString() { return 'Web3HostnameDeleteWeb3HostnameResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
