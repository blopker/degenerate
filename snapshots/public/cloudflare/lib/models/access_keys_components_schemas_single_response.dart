...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_key_config.dart';import 'access_messages2.dart';@immutable final class AccessKeysComponentsSchemasSingleResponse {const AccessKeysComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessKeysComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessKeyConfig? Function()? result, }) { return AccessKeysComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessKeysComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
