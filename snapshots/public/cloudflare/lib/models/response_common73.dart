...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waf_managed_rules_messages2.dart';@immutable final class ResponseCommon73 {const ResponseCommon73({required this.errors, required this.messages, required this.success, });
