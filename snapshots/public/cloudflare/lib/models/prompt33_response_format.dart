...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt33ResponseFormatType {const Prompt33ResponseFormatType._(this.value);
...
@immutable final class Prompt33ResponseFormat {const Prompt33ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt33ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt33ResponseFormatType? Function()? type, }) { return Prompt33ResponseFormat(
