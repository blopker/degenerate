...
factory PostEventCreateBulkRequestData.fromJson(Map<String, dynamic> json) { return PostEventCreateBulkRequestData(
  ...
  indicators: (json['indicators'] as List<dynamic>?)?.map((e) => PostEventCreateBulkRequestDataIndicators.fromJson(e as Map<String, dynamic>)).toList(),
  insight: json['insight'] as String?,
  raw: PostEventCreateBulkRequestDataRaw.fromJson(json['raw'] as Map<String, dynamic>),
...
final List<PostEventCreateBulkRequestDataIndicators>? indicators;

final String? insight;

final PostEventCreateBulkRequestDataRaw raw;
...
PostEventCreateBulkRequestData copyWith({double? Function()? accountId, Omittable<String?>? attacker, String? Function()? attackerCountry, String? category, String? Function()? datasetId, DateTime? date, String? event, String? Function()? indicator, String? Function()? indicatorType, List<PostEventCreateBulkRequestDataIndicators>? Function()? indicators, String? Function()? insight, PostEventCreateBulkRequestDataRaw? raw, List<String>? Function()? tags, String? Function()? targetCountry, String? Function()? targetIndustry, String? tlp, }) { return PostEventCreateBulkRequestData(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostEventCreateBulkRequestData &&
