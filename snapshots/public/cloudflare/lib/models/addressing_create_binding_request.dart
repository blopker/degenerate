...
import 'addressing_cidr.dart';import 'addressing_service_identifier.dart';final class AddressingCreateBindingRequest {const AddressingCreateBindingRequest({required this.cidr, required this.serviceId, });
