...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_support_cohort.dart';@immutable final class MconnSupportCohortListResponse {const MconnSupportCohortListResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnSupportCohortListResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, List<MconnSupportCohort>? result, }) {return MconnSupportCohortListResponse(
...
@override String toString() {return 'MconnSupportCohortListResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
