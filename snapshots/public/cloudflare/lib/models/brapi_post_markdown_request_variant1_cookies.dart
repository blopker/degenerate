...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class BrapiPostMarkdownRequestVariant1CookiesPriority {const BrapiPostMarkdownRequestVariant1CookiesPriority._(this.value);
...
@immutable final class BrapiPostMarkdownRequestVariant1CookiesSameSite {const BrapiPostMarkdownRequestVariant1CookiesSameSite._(this.value);
...
@immutable final class BrapiPostMarkdownRequestVariant1CookiesSourceScheme {const BrapiPostMarkdownRequestVariant1CookiesSourceScheme._(this.value);
...
@immutable final class BrapiPostMarkdownRequestVariant1Cookies {const BrapiPostMarkdownRequestVariant1Cookies({required this.name, required this.value, this.domain, this.expires, this.httpOnly, this.partitionKey, this.path, this.priority, this.sameParty, this.sameSite, this.secure, this.sourcePort, this.sourceScheme, this.url, });
