...
import 'access_schemas_azure_ad.dart';import 'access_schemas_centrify.dart';import 'access_schemas_facebook.dart';import 'access_schemas_github.dart';import 'access_schemas_google.dart';import 'access_schemas_google_apps.dart';import 'access_schemas_linkedin.dart';import 'access_schemas_oidc.dart';import 'access_schemas_okta.dart';import 'access_schemas_onelogin.dart';import 'access_schemas_onetimepin.dart';import 'access_schemas_pingone.dart';import 'access_schemas_saml.dart';import 'access_schemas_yandex.dart';final class AccessIdentityProvidersComponentsSchemasResponseCollectionResult {const AccessIdentityProvidersComponentsSchemasResponseCollectionResult({this.accessSchemasAzureAd, this.accessSchemasCentrify, this.accessSchemasFacebook, this.accessSchemasGithub, this.accessSchemasGoogle, this.accessSchemasGoogleApps, this.accessSchemasLinkedin, this.accessSchemasOidc, this.accessSchemasOkta, this.accessSchemasOnelogin, this.accessSchemasPingone, this.accessSchemasSaml, this.accessSchemasYandex, this.accessSchemasOnetimepin, });
...
factory AccessIdentityProvidersComponentsSchemasResponseCollectionResult.fromJson(Map<String, dynamic> json) { return AccessIdentityProvidersComponentsSchemasResponseCollectionResult(
  ...
  accessSchemasOnetimepin: AccessSchemasOnetimepin.canParse(json) ? AccessSchemasOnetimepin.fromJson(json) : null,
); }
...
final AccessSchemasOnetimepin? accessSchemasOnetimepin;

/// At least one variant must be present.
bool get isValid { return accessSchemasAzureAd != null || accessSchemasCentrify != null || accessSchemasFacebook != null || accessSchemasGithub != null || accessSchemasGoogle != null || accessSchemasGoogleApps != null || accessSchemasLinkedin != null || accessSchemasOidc != null || accessSchemasOkta != null || accessSchemasOnelogin != null || accessSchemasPingone != null || accessSchemasSaml != null || accessSchemasYandex != null || accessSchemasOnetimepin != null; } 
Map<String, dynamic> toJson() { return {
  ...
  ...?accessSchemasOnetimepin?.toJson(),
}; } 
 }
