...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class WorkersAiPostRunCfLykonDreamshaper8LcmRequest {const WorkersAiPostRunCfLykonDreamshaper8LcmRequest({this.guidance = 7.5, this.height, this.image, this.imageB64, this.mask, this.negativePrompt, this.numSteps = 20, required this.prompt, this.seed, this.strength = 1.0, this.width, });

factory WorkersAiPostRunCfLykonDreamshaper8LcmRequest.fromJson(Map<String, dynamic> json) { return WorkersAiPostRunCfLykonDreamshaper8LcmRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersAiPostRunCfLykonDreamshaper8LcmRequest &&
...
@override String toString() { return 'WorkersAiPostRunCfLykonDreamshaper8LcmRequest(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)'; } 
 }
