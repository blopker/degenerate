...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_completed_upload_assets_response_result.dart';import 'workers_messages2.dart';final class WorkersCompletedUploadAssetsResponse {const WorkersCompletedUploadAssetsResponse({required this.errors, required this.messages, required this.success, this.result, });
