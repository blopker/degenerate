...
@immutable final class ZonesServerSideExclude {const ZonesServerSideExclude({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
