...
final class RadarGetAnnotationsOutagesTopResponseResultAnnotations {const RadarGetAnnotationsOutagesTopResponseResultAnnotations({required this.clientCountryAlpha2, required this.clientCountryName, required this.value, });
