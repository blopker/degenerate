...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages35_functions.dart';import 'messages35_messages.dart';import 'messages35_tools.dart';import 'messages35_tools_variant1.dart';import 'messages35_tools_variant2.dart';@immutable final class Messages35 {const Messages35({required this.messages, this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });

factory Messages35.fromJson(Map<String, dynamic> json) { return Messages35(
  frequencyPenalty: json['frequency_penalty'] != null ? (json['frequency_penalty'] as num).toDouble() : null,
  functions: (json['functions'] as List<dynamic>?)?.map((e) => Messages35Functions.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => Messages35Messages.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages35ToolsVariant1.fromJson(v as Map<String, dynamic>), fromB: (v) => Messages35ToolsVariant2.fromJson(v as Map<String, dynamic>),)).toList(),
...
final List<Messages35Functions>? functions;
...
final List<Messages35Messages> messages;
...
final List<Messages35Tools>? tools;
...
Messages35 copyWith({double Function()? frequencyPenalty, List<Messages35Functions> Function()? functions, Map<String, dynamic> Function()? guidedJson, int Function()? maxTokens, List<Messages35Messages>? messages, double Function()? presencePenalty, bool Function()? raw, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, List<Messages35Tools> Function()? tools, int Function()? topK, double Function()? topP, }) { return Messages35(
...
@override String toString() { return 'Messages35(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
