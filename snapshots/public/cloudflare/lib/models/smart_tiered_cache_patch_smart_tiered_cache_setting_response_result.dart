...
@immutable final class SmartTieredCachePatchSmartTieredCacheSettingResponseResult {const SmartTieredCachePatchSmartTieredCacheSettingResponseResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
SmartTieredCachePatchSmartTieredCacheSettingResponseResult copyWith({SmartTieredCachePatchSmartTieredCacheSettingResponseResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesSmartTieredCacheValue? value, }) { return SmartTieredCachePatchSmartTieredCacheSettingResponseResult(
  id: id ?? this.id,
