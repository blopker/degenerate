...
final class AutoragConfigListJobsResponseResult {const AutoragConfigListJobsResponseResult({this.endReason, this.endedAt, required this.id, this.lastSeenAt, required this.source, this.startedAt, });
