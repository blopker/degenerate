...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class EmailSecurityDeleteBlockedSenderResponseResult {const EmailSecurityDeleteBlockedSenderResponseResult({required this.id});
