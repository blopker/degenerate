...
import 'mcn_catalog_sync_update_mode.dart';final class McnUpdateCatalogSyncRequest {const McnUpdateCatalogSyncRequest({this.description, this.name, this.policy, this.updateMode, });
