...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is McpServerApplication2 &&
          aud == other.aud &&
...
@override int get hashCode { return Object.hashAll([aud, createdAt, id, updatedAt, allowAuthenticateViaWarp, Object.hashAll(allowedIdps ?? const []), autoRedirectToIdentity, customDenyMessage, customDenyUrl, customNonIdentityDenyUrl, Object.hashAll(customPages ?? const []), Object.hashAll(destinations ?? const []), httpOnlyCookieAttribute, logoUrl, name, oauthConfiguration, optionsPreflightBypass, sameSiteCookieAttribute, scimConfig, sessionDuration, Object.hashAll(tags ?? const []), type, Object.hashAll(policies ?? const [])]); } 
@override String toString() { return 'McpServerApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, allowAuthenticateViaWarp: $allowAuthenticateViaWarp, allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, customDenyMessage: $customDenyMessage, customDenyUrl: $customDenyUrl, customNonIdentityDenyUrl: $customNonIdentityDenyUrl, customPages: $customPages, destinations: $destinations, httpOnlyCookieAttribute: $httpOnlyCookieAttribute, logoUrl: $logoUrl, name: $name, oauthConfiguration: $oauthConfiguration, optionsPreflightBypass: $optionsPreflightBypass, sameSiteCookieAttribute: $sameSiteCookieAttribute, scimConfig: $scimConfig, sessionDuration: $sessionDuration, tags: $tags, type: $type, policies: $policies)'; } 
 }
