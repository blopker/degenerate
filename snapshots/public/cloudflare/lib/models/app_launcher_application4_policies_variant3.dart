...
@immutable final class AppLauncherApplication4PoliciesVariant3 {const AppLauncherApplication4PoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory AppLauncherApplication4PoliciesVariant3.fromJson(Map<String, dynamic> json) {return AppLauncherApplication4PoliciesVariant3(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AppLauncherApplication4PoliciesVariant3 &&
