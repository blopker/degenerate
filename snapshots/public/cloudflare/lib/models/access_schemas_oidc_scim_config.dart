...
@immutable final class AccessSchemasOidcScimConfig {const AccessSchemasOidcScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessSchemasOidcScimConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasOidcScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessSchemasOidcScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
/// The value with the schema default applied when absent.
AccessSchemasOidcScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault { return identityUpdateBehavior ?? AccessSchemasOidcScimConfigIdentityUpdateBehavior.fromJson('no_action'); } 
/// The value with the schema default applied when absent.
