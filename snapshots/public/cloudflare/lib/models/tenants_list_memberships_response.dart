...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'message3.dart';import 'tenant_membership.dart';final class TenantsListMembershipsResponse {const TenantsListMembershipsResponse({required this.errors, required this.messages, required this.result, required this.success, });
