...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account.dart';import 'message3.dart';import 'page_token_result_info.dart';@immutable final class OrganizationsGetAccountsResponse {const OrganizationsGetAccountsResponse({required this.errors, required this.messages, required this.result, required this.resultInfo, required this.success, });
...
OrganizationsGetAccountsResponse copyWith({List<Map<String,dynamic>>? errors, List<Message3>? messages, List<Account>? result, PageTokenResultInfo? resultInfo, bool? success, }) { return OrganizationsGetAccountsResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is OrganizationsGetAccountsResponse &&
...
@override String toString() { return 'OrganizationsGetAccountsResponse(errors: $errors, messages: $messages, result: $result, resultInfo: $resultInfo, success: $success)'; } 
 }
