...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account.dart';import 'message3.dart';import 'page_token_result_info.dart';final class OrganizationsGetAccountsResponse {const OrganizationsGetAccountsResponse({required this.errors, required this.messages, required this.result, required this.resultInfo, required this.success, });
