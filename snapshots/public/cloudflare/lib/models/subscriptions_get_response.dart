...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_event_subscription.dart';final class SubscriptionsGetResponse {const SubscriptionsGetResponse({this.errors, this.messages, this.success, this.result, });
