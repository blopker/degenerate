...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AccessSchemasOidcRequestConfig {const AccessSchemasOidcRequestConfig({this.clientId, this.clientSecret, this.authUrl, this.certsUrl, this.claims, this.scopes, this.tokenUrl, });

factory AccessSchemasOidcRequestConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasOidcRequestConfig(
...
AccessSchemasOidcRequestConfig copyWith({String? Function()? clientId, String? Function()? clientSecret, String? Function()? authUrl, String? Function()? certsUrl, List<String>? Function()? claims, List<String>? Function()? scopes, String? Function()? tokenUrl, }) { return AccessSchemasOidcRequestConfig(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccessSchemasOidcRequestConfig &&
...
@override String toString() { return 'AccessSchemasOidcRequestConfig(clientId: $clientId, clientSecret: $clientSecret, authUrl: $authUrl, certsUrl: $certsUrl, claims: $claims, scopes: $scopes, tokenUrl: $tokenUrl)'; } 
 }
