...
import 'radar_get_reports_datasets_response_result.dart';final class RadarGetReportsDatasetsResponse {const RadarGetReportsDatasetsResponse({required this.result, required this.success, });
