...
@immutable final class BrapiPostJsonRequestVariant1Viewport {const BrapiPostJsonRequestVariant1Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostJsonRequestVariant1Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant1Viewport(
...
BrapiPostJsonRequestVariant1Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostJsonRequestVariant1Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostJsonRequestVariant1Viewport &&
...
@override String toString() { return 'BrapiPostJsonRequestVariant1Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
