...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_message.dart';import 'email_security_move_response_item.dart';@immutable final class EmailSecurityPostBulkMessageMoveResponse {const EmailSecurityPostBulkMessageMoveResponse({required this.errors, required this.messages, required this.success, required this.result, });
