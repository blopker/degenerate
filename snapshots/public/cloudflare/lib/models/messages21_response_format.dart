...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages21ResponseFormatType {const Messages21ResponseFormatType._(this.value);
...
@immutable final class Messages21ResponseFormat {const Messages21ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages21ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages21ResponseFormatType? Function()? type, }) { return Messages21ResponseFormat(
