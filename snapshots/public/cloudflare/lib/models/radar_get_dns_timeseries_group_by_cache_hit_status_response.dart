...
import 'radar_get_dns_timeseries_group_by_cache_hit_status_response_result.dart';final class RadarGetDnsTimeseriesGroupByCacheHitStatusResponse {const RadarGetDnsTimeseriesGroupByCacheHitStatusResponse({required this.result, required this.success, });
