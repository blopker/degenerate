...
@immutable final class BrapiPostContentRequestVariant1Authenticate {const BrapiPostContentRequestVariant1Authenticate({required this.password, required this.username, });
