...
import 'radar_get_certificate_logs_response_result.dart';final class RadarGetCertificateLogsResponse {const RadarGetCertificateLogsResponse({required this.result, required this.success, });
