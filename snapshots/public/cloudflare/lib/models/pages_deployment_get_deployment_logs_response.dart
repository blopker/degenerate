...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'pages_deployment_log.dart';import 'pages_messages2.dart';final class PagesDeploymentGetDeploymentLogsResponse {const PagesDeploymentGetDeploymentLogsResponse({required this.errors, required this.messages, required this.success, required this.result, });
