...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'shield_global_settings.dart';import 'shield_messages2.dart';@immutable final class SchemaValidationUpdateSettingsResponse {const SchemaValidationUpdateSettingsResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
SchemaValidationUpdateSettingsResponse copyWith({List<ShieldMessages2>? errors, List<ShieldMessages2>? messages, bool? success, ShieldGlobalSettings? result, }) {return SchemaValidationUpdateSettingsResponse(
...
@override String toString() {return 'SchemaValidationUpdateSettingsResponse(errors: $errors, messages: $messages, success: $success, result: $result)';}
}
