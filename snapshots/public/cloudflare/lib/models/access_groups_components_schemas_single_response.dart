...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'access_schemas_groups.dart';@immutable final class AccessGroupsComponentsSchemasSingleResponse {const AccessGroupsComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessGroupsComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessSchemasGroups? Function()? result, }) { return AccessGroupsComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessGroupsComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
