...
final class PostGroupMemberCreateResponse {const PostGroupMemberCreateResponse({required this.accountId, this.createdAt, required this.groupId, this.updatedAt, required this.uuid, });
