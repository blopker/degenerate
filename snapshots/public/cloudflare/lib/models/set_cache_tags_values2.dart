...
@immutable final class SetCacheTagsValues2 {const SetCacheTagsValues2({required this.operation, required this.values, });

factory SetCacheTagsValues2.fromJson(Map<String, dynamic> json) {return SetCacheTagsValues2(
...
SetCacheTagsValues2 copyWith({RulesetsSetCacheTagsOperation? operation, List<String>? values, }) {return SetCacheTagsValues2(
  operation: operation ?? this.operation,
  values: values ?? this.values,
);}
@override bool operator ==(Object other) {return identical(this, other) ||
      other is SetCacheTagsValues2 &&
          operation == other.operation &&
          listEquals(values, other.values);}
@override int get hashCode {return Object.hash(operation, Object.hashAll(values));}
@override String toString() {return 'SetCacheTagsValues2(operation: $operation, values: $values)';}
}
