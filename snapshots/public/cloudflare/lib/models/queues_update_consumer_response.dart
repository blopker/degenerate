...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_consumer_response.dart';@immutable final class QueuesUpdateConsumerResponse {const QueuesUpdateConsumerResponse({this.errors, this.messages, this.success, this.result, });

factory QueuesUpdateConsumerResponse.fromJson(Map<String, dynamic> json) { return QueuesUpdateConsumerResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is QueuesUpdateConsumerResponse &&
...
@override String toString() { return 'QueuesUpdateConsumerResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
