...
@immutable final class Messages31ToolsVariant1Parameters {const Messages31ToolsVariant1Parameters({required this.properties, required this.type, this.$required, });
