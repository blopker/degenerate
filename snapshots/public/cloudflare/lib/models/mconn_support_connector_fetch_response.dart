...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_support_connector.dart';@immutable final class MconnSupportConnectorFetchResponse {const MconnSupportConnectorFetchResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnSupportConnectorFetchResponse.fromJson(Map<String, dynamic> json) {return MconnSupportConnectorFetchResponse(
  ...
  result: MconnSupportConnector.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnSupportConnectorFetchResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnSupportConnector? result, }) {return MconnSupportConnectorFetchResponse(
...
@override String toString() {return 'MconnSupportConnectorFetchResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
