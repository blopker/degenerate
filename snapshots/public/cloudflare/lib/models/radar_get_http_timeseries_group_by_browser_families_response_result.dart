...
import 'radar_get_http_timeseries_group_by_browser_families_response_result_meta.dart';import 'radar_get_http_timeseries_group_by_browser_families_response_result_serie0.dart';final class RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResult {const RadarGetHttpTimeseriesGroupByBrowserFamiliesResponseResult({required this.meta, required this.serie0, });
