...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ResponseCollection16ResultInfo {const ResponseCollection16ResultInfo({this.count, this.page, this.perPage, this.totalCount, });
