...
final class Messages50ResponseFormatType {const Messages50ResponseFormatType._(this.value);
...
final class Messages50ResponseFormat {const Messages50ResponseFormat({this.jsonSchema, this.type, });
