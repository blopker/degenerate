...
import 'aig_config_create_evaluations_response_result.dart';final class AigConfigCreateEvaluationsResponse {const AigConfigCreateEvaluationsResponse({required this.result, required this.success, });
