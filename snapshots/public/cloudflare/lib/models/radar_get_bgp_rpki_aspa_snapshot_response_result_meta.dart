...
final class RadarGetBgpRpkiAspaSnapshotResponseResultMeta {const RadarGetBgpRpkiAspaSnapshotResponseResultMeta({required this.dataTime, required this.queryTime, required this.totalCount, });
