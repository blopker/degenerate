...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_asn_configuration.dart';import 'firewall_cidr_configuration.dart';import 'firewall_components_schemas_identifier.dart';import 'firewall_configuration.dart';import 'firewall_country_configuration.dart';import 'firewall_description.dart';import 'firewall_ip_configuration.dart';import 'firewall_ipv6_configuration.dart';import 'firewall_schemas_mode.dart';import 'firewall_schemas_paused.dart';final class UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest {const UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest({required this.configuration, this.description, required this.id, required this.mode, this.paused, });
