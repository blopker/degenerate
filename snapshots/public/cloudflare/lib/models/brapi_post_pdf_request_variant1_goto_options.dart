...
@immutable final class BrapiPostPdfRequestVariant1GotoOptions {const BrapiPostPdfRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
