...
@immutable final class BrapiPostPdfRequestVariant1GotoOptions {const BrapiPostPdfRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostPdfRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostPdfRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
); }
