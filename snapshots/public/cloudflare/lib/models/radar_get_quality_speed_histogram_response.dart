...
import 'radar_get_quality_speed_histogram_response_result.dart';final class RadarGetQualitySpeedHistogramResponse {const RadarGetQualitySpeedHistogramResponse({required this.result, required this.success, });
