...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_cohort.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminCohortCreateResponse {const MconnAdminCohortCreateResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminCohortCreateResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminCohort? result, }) {return MconnAdminCohortCreateResponse(
...
@override String toString() {return 'MconnAdminCohortCreateResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
