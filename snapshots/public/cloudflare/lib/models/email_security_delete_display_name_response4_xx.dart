...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_message.dart';final class EmailSecurityDeleteDisplayNameResponse4Xx {const EmailSecurityDeleteDisplayNameResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
