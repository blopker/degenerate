...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_settings_messages2.dart';import 'dns_views_for_an_account_delete_internal_dns_view_response4xx_result.dart';@immutable final class DnsViewsForAnAccountDeleteInternalDnsViewResponse4xx {const DnsViewsForAnAccountDeleteInternalDnsViewResponse4xx({required this.errors, required this.messages, required this.result, required this.success, });
