...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_ai_post_run_cf_black_forest_labs_flux2_klein9b_response400_errors.dart';final class WorkersAiPostRunCfBlackForestLabsFlux2Klein9bResponse400 {const WorkersAiPostRunCfBlackForestLabsFlux2Klein9bResponse400({required this.errors, required this.result, required this.success, });
