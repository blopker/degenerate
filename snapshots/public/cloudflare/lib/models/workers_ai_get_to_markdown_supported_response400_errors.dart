...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorkersAiGetToMarkdownSupportedResponse400Errors {const WorkersAiGetToMarkdownSupportedResponse400Errors({required this.message});
