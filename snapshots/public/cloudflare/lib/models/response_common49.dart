...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'observatory_messages2.dart';final class ResponseCommon49 {const ResponseCommon49({required this.errors, required this.messages, required this.success, });
