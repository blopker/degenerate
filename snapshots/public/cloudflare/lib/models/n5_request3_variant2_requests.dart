...
@immutable final class $5Request3Variant2Requests {const $5Request3Variant2Requests({required this.text, this.pooling, });

factory $5Request3Variant2Requests.fromJson(Map<String, dynamic> json) {return $5Request3Variant2Requests(
  pooling: json['pooling'] != null ? $5Request3Variant2RequestsPooling.fromJson(json['pooling'] as String) : null,
...
$5Request3Variant2RequestsPooling get poolingOrDefault {return pooling ?? $5Request3Variant2RequestsPooling.fromJson('mean');}
