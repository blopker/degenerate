...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'prompt43_prediction_content_content.dart';@immutable final class Prompt43PredictionContentType {const Prompt43PredictionContentType._(this.value);
...
@immutable final class Prompt43PredictionContent {const Prompt43PredictionContent({required this.content, required this.type, });

factory Prompt43PredictionContent.fromJson(Map<String, dynamic> json) { return Prompt43PredictionContent(
  content: Prompt43PredictionContentContent.fromJson(json['content']),
