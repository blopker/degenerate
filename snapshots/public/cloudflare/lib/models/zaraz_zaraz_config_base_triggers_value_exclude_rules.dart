...
@immutable
final class ZarazZarazConfigBaseTriggersValueExcludeRules {
  const ZarazZarazConfigBaseTriggersValueExcludeRules({this.zarazLoadRule = const Omittable.absent(),
...
this.zarazElementVisibilityRule = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigBaseTriggersValueExcludeRules._({required this.rawValue, required this.zarazLoadRule,
...
required this.zarazElementVisibilityRule,});
  factory ZarazZarazConfigBaseTriggersValueExcludeRules.fromJson(Object? json) => ZarazZarazConfigBaseTriggersValueExcludeRules._(
...
if (zarazElementVisibilityRule.isPresent) zarazElementVisibilityRule.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigBaseTriggersValueExcludeRules && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigBaseTriggersValueExcludeRules(${toJson()})';
}
