...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cache_rules_messages2.dart';import 'cache_rules_result_object.dart';final class CacheRulesZoneCacheSettingsResponseSingle {const CacheRulesZoneCacheSettingsResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
