...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_loa_upload_response_result.dart';import 'addressing_messages2.dart';@immutable final class AddressingLoaUploadResponse {const AddressingLoaUploadResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AddressingLoaUploadResponse copyWith({List<AddressingMessages2>? errors, List<AddressingMessages2>? messages, bool? success, AddressingLoaUploadResponseResult? Function()? result, }) { return AddressingLoaUploadResponse(
...
@override String toString() { return 'AddressingLoaUploadResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
