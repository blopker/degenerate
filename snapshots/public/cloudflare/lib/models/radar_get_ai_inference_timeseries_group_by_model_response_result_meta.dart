...
@immutable final class RadarGetAiInferenceTimeseriesGroupByModelResponseResultMetaAggInterval {const RadarGetAiInferenceTimeseriesGroupByModelResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetAiInferenceTimeseriesGroupByModelResponseResultMetaNormalization {const RadarGetAiInferenceTimeseriesGroupByModelResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetAiInferenceTimeseriesGroupByModelResponseResultMeta {const RadarGetAiInferenceTimeseriesGroupByModelResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
