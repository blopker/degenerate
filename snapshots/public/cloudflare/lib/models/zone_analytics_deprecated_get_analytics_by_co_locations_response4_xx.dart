...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages42.dart';import 'query_response.dart';@immutable final class ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse4Xx {const ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.query, });
...
@override String toString() { return 'ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, query: $query)'; } 
 }
