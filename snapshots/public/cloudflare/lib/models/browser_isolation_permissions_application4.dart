...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_app_policy_link.dart';import 'access_apps_components_schemas_name.dart';import 'access_custom_deny_url.dart';import 'access_custom_non_identity_deny_url.dart';import 'access_domain.dart';import 'access_schemas_auto_redirect_to_identity.dart';import 'access_schemas_session_duration.dart';import 'access_schemas_uuid.dart';import 'access_type.dart';import 'browser_isolation_permissions_application4_policies.dart';import 'browser_isolation_permissions_application4_policies_variant3.dart';@immutable final class BrowserIsolationPermissionsApplication4 {const BrowserIsolationPermissionsApplication4({required this.type, this.allowedIdps, this.autoRedirectToIdentity, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.domain, this.name, this.sessionDuration, this.policies, });

factory BrowserIsolationPermissionsApplication4.fromJson(Map<String, dynamic> json) { return BrowserIsolationPermissionsApplication4(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => BrowserIsolationPermissionsApplication4PoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
); }
...
final List<BrowserIsolationPermissionsApplication4Policies>? policies;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrowserIsolationPermissionsApplication4 &&
...
@override String toString() { return 'BrowserIsolationPermissionsApplication4(allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, customDenyUrl: $customDenyUrl, customNonIdentityDenyUrl: $customNonIdentityDenyUrl, customPages: $customPages, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type, policies: $policies)'; } 
 }
