...
final List<RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfoAnnotations> annotations;
...
RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfo copyWith({List<RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfoAnnotations>? annotations, int? level, }) { return RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfo(
  annotations: annotations ?? this.annotations,
  level: level ?? this.level,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfo &&
          listEquals(annotations, other.annotations) &&
          level == other.level; } 
@override int get hashCode { return Object.hash(Object.hashAll(annotations), level); } 
@override String toString() { return 'RadarGetLeakedCredentialChecksTimeseriesGroupByBotClassResponseResultMetaConfidenceInfo(annotations: $annotations, level: $level)'; } 
 }
