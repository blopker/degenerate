...
import 'prompt17_response_format.dart';final class Prompt17 {const Prompt17({this.frequencyPenalty, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });

factory Prompt17.fromJson(Map<String, dynamic> json) { return Prompt17(
  ...
  responseFormat: json['response_format'] != null ? Prompt17ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final Prompt17ResponseFormat? responseFormat;
...
Prompt17 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, Prompt17ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return Prompt17(
...
@override String toString() { return 'Prompt17(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
