...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_messages2.dart';import 'intel_result_info.dart';@immutable final class IpListGetIpListsResponse4Xx {const IpListGetIpListsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });

factory IpListGetIpListsResponse4Xx.fromJson(Map<String, dynamic> json) { return IpListGetIpListsResponse4Xx(
...
IpListGetIpListsResponse4Xx copyWith({List<IntelMessages2>? errors, List<IntelMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, IntelResultInfo? Function()? resultInfo, }) { return IpListGetIpListsResponse4Xx(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IpListGetIpListsResponse4Xx &&
...
@override String toString() { return 'IpListGetIpListsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
