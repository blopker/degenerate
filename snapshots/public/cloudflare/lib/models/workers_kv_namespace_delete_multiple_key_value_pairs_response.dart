...
import 'workers_kv_bulk_result.dart';final class WorkersKvNamespaceDeleteMultipleKeyValuePairsResponse {const WorkersKvNamespaceDeleteMultipleKeyValuePairsResponse({this.result});
