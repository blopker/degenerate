...
@immutable final class ZonesImageResizing {const ZonesImageResizing({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
