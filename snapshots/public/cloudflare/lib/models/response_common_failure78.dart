...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bundle_messages2.dart';final class ResponseCommonFailure78 {const ResponseCommonFailure78({required this.errors, required this.messages, required this.result, required this.success, });
