...
factory ResponseCommon7.fromJson(Map<String, dynamic> json) {return ResponseCommon7(
  ...
  result: ResponseCommon7Result.fromJson(json['result']),
...
@override String toString() {return 'ResponseCommon7(errors: $errors, messages: $messages, result: $result, success: $success)';}
}
