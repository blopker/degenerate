...
@immutable final class BrapiPostMarkdownRequestVariant1Viewport {const BrapiPostMarkdownRequestVariant1Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostMarkdownRequestVariant1Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostMarkdownRequestVariant1Viewport(
...
BrapiPostMarkdownRequestVariant1Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostMarkdownRequestVariant1Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostMarkdownRequestVariant1Viewport &&
...
@override String toString() { return 'BrapiPostMarkdownRequestVariant1Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
