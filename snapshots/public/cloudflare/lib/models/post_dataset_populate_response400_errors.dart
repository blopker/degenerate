...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostDatasetPopulateResponse400Errors {const PostDatasetPopulateResponse400Errors({required this.message});
