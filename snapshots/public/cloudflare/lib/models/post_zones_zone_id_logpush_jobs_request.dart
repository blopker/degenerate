...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logpush_dataset.dart';import 'logpush_destination_conf.dart';import 'logpush_enabled.dart';import 'logpush_filter.dart';import 'logpush_frequency.dart';import 'logpush_kind.dart';import 'logpush_logpull_options.dart';import 'logpush_max_upload_bytes.dart';import 'logpush_max_upload_interval_seconds.dart';import 'logpush_max_upload_records.dart';import 'logpush_name.dart';import 'logpush_output_options.dart';import 'logpush_ownership_challenge.dart';@immutable final class PostZonesZoneIdLogpushJobsRequest {const PostZonesZoneIdLogpushJobsRequest({required this.destinationConf, this.dataset = const Omittable.absent(), this.enabled, this.filter = const Omittable.absent(), this.frequency = const Omittable.absent(), this.kind, this.logpullOptions = const Omittable.absent(), this.maxUploadBytes = const Omittable.absent(), this.maxUploadIntervalSeconds = const Omittable.absent(), this.maxUploadRecords = const Omittable.absent(), this.name = const Omittable.absent(), this.outputOptions = const Omittable.absent(), this.ownershipChallenge, });

factory PostZonesZoneIdLogpushJobsRequest.fromJson(Map<String, dynamic> json) {return PostZonesZoneIdLogpushJobsRequest(
