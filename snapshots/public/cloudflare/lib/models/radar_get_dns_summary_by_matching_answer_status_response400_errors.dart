...
final class RadarGetDnsSummaryByMatchingAnswerStatusResponse400Errors {const RadarGetDnsSummaryByMatchingAnswerStatusResponse400Errors({required this.message});
