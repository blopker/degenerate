...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'public_ip_messages2.dart';@immutable final class ResponseCommonFailure54 {const ResponseCommonFailure54({required this.errors, required this.messages, required this.result, required this.success, });
