...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_schemas_subdomain.dart';final class WorkerSubdomainGetSubdomainResponse {const WorkerSubdomainGetSubdomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'WorkerSubdomainGetSubdomainResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
