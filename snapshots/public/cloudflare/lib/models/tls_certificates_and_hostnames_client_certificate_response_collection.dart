...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_client_certificate.dart';import 'tls_certificates_and_hostnames_client_certificate_response_collection_result_info.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesClientCertificateResponseCollection {const TlsCertificatesAndHostnamesClientCertificateResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
factory TlsCertificatesAndHostnamesClientCertificateResponseCollection.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesClientCertificateResponseCollection(
  ...
  resultInfo: json['result_info'] != null ? TlsCertificatesAndHostnamesClientCertificateResponseCollectionResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final TlsCertificatesAndHostnamesClientCertificateResponseCollectionResultInfo? resultInfo;
...
TlsCertificatesAndHostnamesClientCertificateResponseCollection copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesClientCertificateResponseCollectionResultInfo? Function()? resultInfo, List<TlsCertificatesAndHostnamesClientCertificate>? Function()? result, }) { return TlsCertificatesAndHostnamesClientCertificateResponseCollection(
...
@override String toString() { return 'TlsCertificatesAndHostnamesClientCertificateResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
