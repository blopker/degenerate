...
factory R2SippyDestinationProvider.fromJson(String json) { return switch (json) {
  'r2' => r2,
  _ => R2SippyDestinationProvider._(json),
}; }

static const R2SippyDestinationProvider r2 = R2SippyDestinationProvider._('r2');

static const List<R2SippyDestinationProvider> values = [r2];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is R2SippyDestinationProvider && other.value == value; } 
...
factory R2SippyDestination.fromJson(Map<String, dynamic> json) { return R2SippyDestination(
  ...
  provider: json['provider'] != null ? R2SippyDestinationProvider.fromJson(json['provider'] as String) : null,
); }
...
final R2SippyDestinationProvider? provider;
