...
import 'workers_binding_name.dart';final class WorkersBindingKindPipelines {const WorkersBindingKindPipelines({required this.name, required this.pipeline, required this.type, });
