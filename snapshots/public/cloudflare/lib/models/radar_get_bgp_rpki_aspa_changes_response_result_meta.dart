...
final class RadarGetBgpRpkiAspaChangesResponseResultMeta {const RadarGetBgpRpkiAspaChangesResponseResultMeta({required this.dataTime, required this.queryTime, });
