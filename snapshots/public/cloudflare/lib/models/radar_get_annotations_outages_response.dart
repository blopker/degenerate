...
import 'radar_get_annotations_outages_response_result.dart';final class RadarGetAnnotationsOutagesResponse {const RadarGetAnnotationsOutagesResponse({required this.result, required this.success, });
