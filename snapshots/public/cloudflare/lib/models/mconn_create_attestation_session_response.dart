...
MconnCreateAttestationSessionResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerAttestationSession? result, }) {return MconnCreateAttestationSessionResponse(
...
@override String toString() {return 'MconnCreateAttestationSessionResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
