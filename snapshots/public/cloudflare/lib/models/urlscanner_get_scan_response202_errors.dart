...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class UrlscannerGetScanResponse202Errors {const UrlscannerGetScanResponse202Errors({required this.message});
