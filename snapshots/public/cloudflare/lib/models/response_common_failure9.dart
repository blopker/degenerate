...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'argo_config_messages2.dart';@immutable final class ResponseCommonFailure9 {const ResponseCommonFailure9({required this.errors, required this.messages, required this.result, required this.success, });
