...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_update_gateway_response_result_dlp_variant2_policies.dart';@immutable final class AigConfigUpdateGatewayResponseResultDlpVariant2 {const AigConfigUpdateGatewayResponseResultDlpVariant2({required this.enabled, required this.policies, });
