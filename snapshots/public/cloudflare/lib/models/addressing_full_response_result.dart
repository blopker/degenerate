...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_address_map_identifier.dart';import 'addressing_address_maps_ip.dart';import 'addressing_address_maps_membership.dart';import 'addressing_can_delete.dart';import 'addressing_can_modify_ips.dart';import 'addressing_default_sni.dart';import 'addressing_enabled.dart';import 'addressing_schemas_description.dart';import 'addressing_timestamp.dart';final class AddressingFullResponseResult {const AddressingFullResponseResult({this.canDelete, this.canModifyIps, this.createdAt, this.defaultSni, this.description, this.enabled, this.id, this.modifiedAt, this.ips, this.memberships, });
