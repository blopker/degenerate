...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_device_dex_test_schemas_http.dart';import 'teams_devices_messages2.dart';@immutable final class TeamsDevicesDexResponseCollection {const TeamsDevicesDexResponseCollection({required this.errors, required this.messages, required this.result, required this.success, });
...
TeamsDevicesDexResponseCollection copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesDeviceDexTestSchemasHttp>? result, bool? success, }) { return TeamsDevicesDexResponseCollection(
...
@override String toString() { return 'TeamsDevicesDexResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
