...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetEmailSecuritySummaryResponseResultMetaUnits {const RadarGetEmailSecuritySummaryResponseResultMetaUnits({required this.name, required this.value, });
