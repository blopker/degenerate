...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_bond_id.dart';import 'magic_lan_static_addressing.dart';import 'magic_nat.dart';import 'magic_port.dart';import 'magic_routed_subnet.dart';import 'magic_vlan_tag.dart';@immutable final class MagicLanUpdateRequest {const MagicLanUpdateRequest({this.bondId, this.isBreakout, this.isPrioritized, this.name, this.nat, this.physport, this.routedSubnets, this.staticAddressing, this.vlanTag, });

factory MagicLanUpdateRequest.fromJson(Map<String, dynamic> json) { return MagicLanUpdateRequest(
