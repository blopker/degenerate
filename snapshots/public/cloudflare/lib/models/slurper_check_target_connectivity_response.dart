...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model32.dart';import 'r2_slurper_connectivity_response.dart';final class SlurperCheckTargetConnectivityResponse {const SlurperCheckTargetConnectivityResponse({this.errors, this.messages, this.success, this.result, });
