...
@immutable final class RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMetaAggInterval {const RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMetaNormalization {const RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMeta {const RadarGetDnsAs112TimeseriesGroupByEdnsResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
