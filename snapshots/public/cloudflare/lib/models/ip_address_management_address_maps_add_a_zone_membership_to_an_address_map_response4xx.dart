...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';import 'ip_address_management_address_maps_add_a_zone_membership_to_an_address_map_response4xx_result_info.dart';@immutable final class IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4xx {const IpAddressManagementAddressMapsAddAZoneMembershipToAnAddressMapResponse4xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
