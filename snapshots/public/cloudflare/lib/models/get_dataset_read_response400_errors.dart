...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetDatasetReadResponse400Errors {const GetDatasetReadResponse400Errors({required this.message});
