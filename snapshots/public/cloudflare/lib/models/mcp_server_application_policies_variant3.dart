...
@immutable final class McpServerApplicationPoliciesVariant3 {const McpServerApplicationPoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory McpServerApplicationPoliciesVariant3.fromJson(Map<String, dynamic> json) { return McpServerApplicationPoliciesVariant3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is McpServerApplicationPoliciesVariant3 &&
