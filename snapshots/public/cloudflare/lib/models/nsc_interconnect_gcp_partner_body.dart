...
import 'bandwidth.dart';final class NscInterconnectGcpPartnerBody {const NscInterconnectGcpPartnerBody({required this.account, required this.name, this.owner, required this.type, required this.region, this.speed, });
