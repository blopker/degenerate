...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetNetflowsTimeseriesResponseResultMetaDateRange {const RadarGetNetflowsTimeseriesResponseResultMetaDateRange({required this.endTime, required this.startTime, });
