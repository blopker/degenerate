...
@immutable final class ZonesWebsockets {const ZonesWebsockets({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });

factory ZonesWebsockets.fromJson(Map<String, dynamic> json) { return ZonesWebsockets(
...
ZonesWebsockets copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesWebsocketsValue? value, }) { return ZonesWebsockets(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ZonesWebsockets &&
          editable == other.editable &&
          id == other.id &&
          modifiedOn == other.modifiedOn &&
          value == other.value; } 
@override int get hashCode { return Object.hash(editable, id, modifiedOn, value); } 
@override String toString() { return 'ZonesWebsockets(editable: $editable, id: $id, modifiedOn: $modifiedOn, value: $value)'; } 
 }
