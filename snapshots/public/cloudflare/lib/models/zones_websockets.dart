...
@immutable final class ZonesWebsockets {const ZonesWebsockets({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesWebsockets copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesWebsocketsValue? value, }) { return ZonesWebsockets(
