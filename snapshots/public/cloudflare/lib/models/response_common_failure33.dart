...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dos_messages2.dart';@immutable final class ResponseCommonFailure33 {const ResponseCommonFailure33({required this.errors, required this.messages, required this.result, required this.success, });
