...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'lists_messages2.dart';@immutable final class ListsGetAListResponse4Xx {const ListsGetAListResponse4Xx({required this.result, required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ListsGetAListResponse4Xx(result: $result, errors: $errors, messages: $messages, success: $success)'; } 
 }
