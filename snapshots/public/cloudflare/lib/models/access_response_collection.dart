...
factory AccessResponseCollection.fromJson(Map<String, dynamic> json) { return AccessResponseCollection(
  ...
  result: (json['result'] as List<dynamic>?)?.map(AccessResponseCollectionResult.fromJson).toList(),
); }
...
final AccessResponseCollectionResultInfo? resultInfo;
...
AccessResponseCollection copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessResponseCollectionResultInfo? Function()? resultInfo, List<AccessResponseCollectionResult>? Function()? result, }) { return AccessResponseCollection(
...
@override String toString() { return 'AccessResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
