...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetEntitiesAsnByIpResponse404 {const RadarGetEntitiesAsnByIpResponse404({required this.error});
