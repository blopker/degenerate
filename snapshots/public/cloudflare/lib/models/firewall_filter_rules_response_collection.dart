...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_filter_rule_response.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';@immutable final class FirewallFilterRulesResponseCollection {const FirewallFilterRulesResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallFilterRulesResponseCollection copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallFilterRuleResponse>? result, bool? success, FirewallResultInfo? Function()? resultInfo, }) { return FirewallFilterRulesResponseCollection(
...
@override String toString() { return 'FirewallFilterRulesResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
