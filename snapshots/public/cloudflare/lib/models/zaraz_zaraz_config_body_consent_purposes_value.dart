...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ZarazZarazConfigBodyConsentPurposesValue {const ZarazZarazConfigBodyConsentPurposesValue({required this.description, required this.name, });
