...
final class WorkersAiPostRunCfBytedanceStableDiffusionXlLightningResponse400Errors {const WorkersAiPostRunCfBytedanceStableDiffusionXlLightningResponse400Errors({required this.code, required this.message, });
