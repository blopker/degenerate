...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_profile.dart';import 'dlp_messages2.dart';import 'dlp_profile.dart';import 'integration_profile.dart';import 'predefined_profile.dart';@immutable final class DlpProfilesCreatePredefinedProfileResponse {const DlpProfilesCreatePredefinedProfileResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'DlpProfilesCreatePredefinedProfileResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
