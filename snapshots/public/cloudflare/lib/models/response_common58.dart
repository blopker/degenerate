...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'secondary_dns_messages2.dart';@immutable final class ResponseCommon58 {const ResponseCommon58({required this.errors, required this.messages, required this.success, });
