...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_visibility_mnm_messages2.dart';@immutable final class ResponseCommonFailure48 {const ResponseCommonFailure48({required this.errors, required this.messages, required this.result, required this.success, });
