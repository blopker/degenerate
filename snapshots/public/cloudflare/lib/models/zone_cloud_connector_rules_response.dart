...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloud_connector_messages2.dart';import 'cloud_connector_rule.dart';final class ZoneCloudConnectorRulesResponse {const ZoneCloudConnectorRulesResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZoneCloudConnectorRulesResponse copyWith({List<CloudConnectorMessages2>? errors, List<CloudConnectorMessages2>? messages, bool? success, List<CloudConnectorRule> Function()? result, }) { return ZoneCloudConnectorRulesResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ZoneCloudConnectorRulesResponse &&
...
@override String toString() { return 'ZoneCloudConnectorRulesResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
