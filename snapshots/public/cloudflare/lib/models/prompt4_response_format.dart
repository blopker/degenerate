...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt4ResponseFormatType {const Prompt4ResponseFormatType._(this.value);
...
@immutable final class Prompt4ResponseFormat {const Prompt4ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt4ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt4ResponseFormatType? Function()? type, }) { return Prompt4ResponseFormat(
