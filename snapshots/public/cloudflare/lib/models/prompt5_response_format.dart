...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt5ResponseFormatType {const Prompt5ResponseFormatType._(this.value);
...
@immutable final class Prompt5ResponseFormat {const Prompt5ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt5ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt5ResponseFormatType? Function()? type, }) { return Prompt5ResponseFormat(
