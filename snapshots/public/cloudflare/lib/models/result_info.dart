...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ResultInfo {const ResultInfo({this.count, this.page, this.perPage, this.totalCount, });

factory ResultInfo.fromJson(Map<String, dynamic> json) { return ResultInfo(
...
ResultInfo copyWith({double Function()? count, double Function()? page, double Function()? perPage, double Function()? totalCount, }) { return ResultInfo(
...
@override String toString() { return 'ResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
