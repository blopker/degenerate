...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages54Functions {const Messages54Functions({required this.code, required this.name, });
