...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_messages2.dart';import 'response_collection10_result_info.dart';final class ResponseCollection10 {const ResponseCollection10({required this.errors, required this.messages, required this.success, this.resultInfo, });
