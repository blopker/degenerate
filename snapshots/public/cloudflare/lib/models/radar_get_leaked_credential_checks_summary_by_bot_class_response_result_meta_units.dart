...
final class RadarGetLeakedCredentialChecksSummaryByBotClassResponseResultMetaUnits {const RadarGetLeakedCredentialChecksSummaryByBotClassResponseResultMetaUnits({required this.name, required this.value, });
