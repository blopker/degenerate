...
factory PromptInner.fromJson(Map<String, dynamic> json) {return PromptInner(
  ...
  responseFormat: json['response_format'] != null ? PromptInnerResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final PromptInnerResponseFormat? responseFormat;
