...
import 'radar_get_ranking_top_domains_response_result.dart';final class RadarGetRankingTopDomainsResponse {const RadarGetRankingTopDomainsResponse({required this.result, required this.success, });
