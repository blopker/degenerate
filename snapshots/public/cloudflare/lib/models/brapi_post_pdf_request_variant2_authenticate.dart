...
@immutable final class BrapiPostPdfRequestVariant2Authenticate {const BrapiPostPdfRequestVariant2Authenticate({required this.password, required this.username, });
