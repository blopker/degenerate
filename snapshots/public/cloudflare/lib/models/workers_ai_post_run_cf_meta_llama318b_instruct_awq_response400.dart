...
final List<WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400Errors> errors;
...
WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400 copyWith({List<WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400(
  errors: errors ?? this.errors,
  result: result ?? this.result,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400 &&
          listEquals(errors, other.errors) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), result, success); } 
@override String toString() { return 'WorkersAiPostRunCfMetaLlama318bInstructAwqResponse400(errors: $errors, result: $result, success: $success)'; } 
 }
