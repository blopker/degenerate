...
TlsCertificatesAndHostnamesPerHostnameSettingsResponseCollectionResultInfo copyWith({Omittable<dynamic>? count, Omittable<dynamic>? page, Omittable<dynamic>? perPage, Omittable<dynamic>? totalCount, double? Function()? totalPages, }) { return TlsCertificatesAndHostnamesPerHostnameSettingsResponseCollectionResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is TlsCertificatesAndHostnamesPerHostnameSettingsResponseCollectionResultInfo &&
          count == other.count &&
          page == other.page &&
...
@override String toString() { return 'TlsCertificatesAndHostnamesPerHostnameSettingsResponseCollectionResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount, totalPages: $totalPages)'; } 
 }
