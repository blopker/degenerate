...
final List<RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfoAnnotations> annotations;
...
RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfo copyWith({List<RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfoAnnotations>? annotations, int? level, }) { return RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfo(
  annotations: annotations ?? this.annotations,
  level: level ?? this.level,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfo &&
          listEquals(annotations, other.annotations) &&
          level == other.level; } 
@override int get hashCode { return Object.hash(Object.hashAll(annotations), level); } 
@override String toString() { return 'RadarGetHttpTopLocationsByOperatingSystemResponseResultMetaConfidenceInfo(annotations: $annotations, level: $level)'; } 
 }
