...
AigConfigFetchGatewayResponse404Errors copyWith({double? code, String? message, }) { return AigConfigFetchGatewayResponse404Errors(
  code: code ?? this.code,
  message: message ?? this.message,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AigConfigFetchGatewayResponse404Errors &&
          code == other.code &&
          message == other.message; } 
@override int get hashCode { return Object.hash(code, message); } 
@override String toString() { return 'AigConfigFetchGatewayResponse404Errors(code: $code, message: $message)'; } 
 }
