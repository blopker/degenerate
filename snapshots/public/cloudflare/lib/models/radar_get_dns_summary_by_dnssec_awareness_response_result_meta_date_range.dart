...
final class RadarGetDnsSummaryByDnssecAwarenessResponseResultMetaDateRange {const RadarGetDnsSummaryByDnssecAwarenessResponseResultMetaDateRange({required this.endTime, required this.startTime, });
