...
@immutable final class RadarGetEmailSecuritySummaryByTlsVersionResponseResultMetaNormalization {const RadarGetEmailSecuritySummaryByTlsVersionResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailSecuritySummaryByTlsVersionResponseResultMeta {const RadarGetEmailSecuritySummaryByTlsVersionResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
