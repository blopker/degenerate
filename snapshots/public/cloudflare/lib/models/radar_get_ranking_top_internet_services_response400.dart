...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ranking_top_internet_services_response400_errors.dart';final class RadarGetRankingTopInternetServicesResponse400 {const RadarGetRankingTopInternetServicesResponse400({required this.errors, required this.result, required this.success, });
