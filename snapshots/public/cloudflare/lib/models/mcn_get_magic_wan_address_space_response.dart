...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_error.dart';import 'mcn_magic_wan_address_space.dart';@immutable final class McnGetMagicWanAddressSpaceResponse {const McnGetMagicWanAddressSpaceResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
McnGetMagicWanAddressSpaceResponse copyWith({List<McnError>? messages, bool? success, List<McnError>? errors, McnMagicWanAddressSpace? result, }) {return McnGetMagicWanAddressSpaceResponse(
...
@override String toString() {return 'McnGetMagicWanAddressSpaceResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
