...
@immutable final class BrapiPostContentRequestVariant1Viewport {const BrapiPostContentRequestVariant1Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostContentRequestVariant1Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostContentRequestVariant1Viewport(
...
BrapiPostContentRequestVariant1Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostContentRequestVariant1Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostContentRequestVariant1Viewport &&
...
@override String toString() { return 'BrapiPostContentRequestVariant1Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
