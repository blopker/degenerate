...
final class DigitalExperienceMonitoringDevice {const DigitalExperienceMonitoringDevice({this.alwaysOn, this.batteryCharging, this.batteryCycles, this.batteryPct, required this.colo, this.connectionType, this.cpuPct, this.cpuPctByApp, required this.deviceId, this.deviceIpv4, this.deviceIpv6, this.deviceName, this.diskReadBps, this.diskUsagePct, this.diskWriteBps, this.dohSubdomain, this.estimatedLossPct, this.firewallEnabled, this.gatewayIpv4, this.gatewayIpv6, this.handshakeLatencyMs, this.ispIpv4, this.ispIpv6, this.metal, required this.mode, this.networkRcvdBps, this.networkSentBps, this.networkSsid, this.personEmail, required this.platform, this.ramAvailableKb, this.ramUsedPct, this.ramUsedPctByApp, required this.status, this.switchLocked, required this.timestamp, required this.version, this.wifiStrengthDbm, });
