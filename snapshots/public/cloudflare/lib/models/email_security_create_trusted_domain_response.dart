...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_create_trusted_domain_response_result.dart';import 'email_security_message.dart';import 'email_security_trusted_domain.dart';final class EmailSecurityCreateTrustedDomainResponse {const EmailSecurityCreateTrustedDomainResponse({required this.errors, required this.messages, required this.success, required this.result, });
