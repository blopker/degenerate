...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetEmailRoutingTimeseriesGroupResponseResultSerie0 {const RadarGetEmailRoutingTimeseriesGroupResponseResultSerie0({required this.timestamps, this.additionalProperties = const {}, });
...
RadarGetEmailRoutingTimeseriesGroupResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetEmailRoutingTimeseriesGroupResponseResultSerie0(
