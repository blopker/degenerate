...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_custom_nameservers_messages2.dart';@immutable final class ResponseCommon23 {const ResponseCommon23({required this.errors, required this.messages, required this.success, });
