...
factory BrowserSshApplication4.fromJson(Map<String, dynamic> json) {return BrowserSshApplication4(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => BrowserSshApplication4PoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
);}
...
final List<BrowserSshApplication4Policies>? policies;
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is BrowserSshApplication4 &&
