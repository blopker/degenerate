...
import 'email_security_blocked_sender_id.dart';import 'email_security_pattern_type.dart';final class EmailSecurityBlockedSender {const EmailSecurityBlockedSender({this.comments, required this.isRegex, required this.pattern, required this.patternType, required this.createdAt, required this.id, required this.lastModified, });
