...
return  AiSearchInstanceChangeJobStatusError400(AiSearchInstanceChangeJobStatusResponse400.fromJson(json as Map<String, dynamic>));case 500:
final json = jsonDecode(response.body);
return  AiSearchInstanceChangeJobStatusError500(AiSearchInstanceChangeJobStatusResponse500.fromJson(json as Map<String, dynamic>));default:
