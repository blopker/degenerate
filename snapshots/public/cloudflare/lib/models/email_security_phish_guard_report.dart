...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_disposition_label.dart';import 'email_security_phish_guard_report_fields.dart';import 'email_security_phish_guard_report_tag.dart';@immutable final class EmailSecurityPhishGuardReport {const EmailSecurityPhishGuardReport({required this.content, required this.createdAt, required this.disposition, required this.fields, required this.id, required this.priority, required this.title, required this.ts, required this.updatedAt, this.tags = const Omittable.absent(), });
...
factory EmailSecurityPhishGuardReport.fromJson(Map<String, dynamic> json) { return EmailSecurityPhishGuardReport(
  ...
  tags: json.containsKey('tags') ? Omittable((json['tags'] as List<dynamic>?)?.map((e) => EmailSecurityPhishGuardReportTag.fromJson(e as Map<String, dynamic>)).toList()) : const Omittable.absent(),
...
final Omittable<List<EmailSecurityPhishGuardReportTag>?> tags;
...
EmailSecurityPhishGuardReport copyWith({String? content, DateTime? createdAt, EmailSecurityDispositionLabel? Function()? disposition, EmailSecurityPhishGuardReportFields? fields, int? id, String? priority, Omittable<List<EmailSecurityPhishGuardReportTag>?>? tags, String? title, DateTime? ts, DateTime? updatedAt, }) { return EmailSecurityPhishGuardReport(
...
@override int get hashCode { return Object.hash(content, createdAt, disposition, fields, id, priority, Object.hashAll(tags.value ?? const []), title, ts, updatedAt); } 
