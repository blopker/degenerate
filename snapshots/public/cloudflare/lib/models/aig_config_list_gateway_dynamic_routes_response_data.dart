...
factory AigConfigListGatewayDynamicRoutesResponseData.fromJson(Map<String, dynamic> json) { return AigConfigListGatewayDynamicRoutesResponseData(
  ...
  routes: (json['routes'] as List<dynamic>).map((e) => AigConfigListGatewayDynamicRoutesResponseDataRoutes.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
final List<AigConfigListGatewayDynamicRoutesResponseDataRoutes> routes;
...
AigConfigListGatewayDynamicRoutesResponseData copyWith({String? orderBy, String? orderByDirection, double? page, double? perPage, List<AigConfigListGatewayDynamicRoutesResponseDataRoutes>? routes, }) { return AigConfigListGatewayDynamicRoutesResponseData(
