...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_custom_page.dart';import 'access_messages2.dart';@immutable final class AccessCustomPagesComponentsSchemasSingleResponse {const AccessCustomPagesComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessCustomPagesComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessCustomPage? Function()? result, }) { return AccessCustomPagesComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessCustomPagesComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
