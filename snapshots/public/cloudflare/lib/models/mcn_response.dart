...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_error.dart';@immutable final class McnResponse {const McnResponse({required this.messages, required this.success, });
