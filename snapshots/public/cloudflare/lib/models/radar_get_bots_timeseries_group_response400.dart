...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bots_timeseries_group_response400_errors.dart';@immutable final class RadarGetBotsTimeseriesGroupResponse400 {const RadarGetBotsTimeseriesGroupResponse400({required this.errors, required this.result, required this.success, });
