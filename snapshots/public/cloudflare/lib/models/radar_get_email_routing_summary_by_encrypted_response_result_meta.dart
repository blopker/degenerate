...
@immutable final class RadarGetEmailRoutingSummaryByEncryptedResponseResultMetaNormalization {const RadarGetEmailRoutingSummaryByEncryptedResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailRoutingSummaryByEncryptedResponseResultMeta {const RadarGetEmailRoutingSummaryByEncryptedResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
