...
final class BrapiPostPdfRequestVariant2GotoOptions {const BrapiPostPdfRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
