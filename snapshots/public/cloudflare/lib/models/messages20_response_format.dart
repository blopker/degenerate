...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages20ResponseFormatType {const Messages20ResponseFormatType._(this.value);
...
@immutable final class Messages20ResponseFormat {const Messages20ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages20ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages20ResponseFormatType? Function()? type, }) { return Messages20ResponseFormat(
