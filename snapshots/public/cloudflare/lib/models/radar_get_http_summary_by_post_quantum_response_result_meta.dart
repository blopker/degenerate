...
final class RadarGetHttpSummaryByPostQuantumResponseResultMeta {const RadarGetHttpSummaryByPostQuantumResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
