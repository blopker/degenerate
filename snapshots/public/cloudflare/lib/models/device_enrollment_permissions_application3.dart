...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_apps_components_schemas_session_duration.dart';import 'access_schemas_aud.dart';import 'access_schemas_auto_redirect_to_identity.dart';import 'access_schemas_scim_config.dart';import 'access_timestamp.dart';import 'access_uuid.dart';@immutable final class DeviceEnrollmentPermissionsApplication3 {const DeviceEnrollmentPermissionsApplication3({required this.type, this.aud, this.createdAt, this.id, this.scimConfig, this.updatedAt, this.allowedIdps, this.autoRedirectToIdentity, this.domain = const Omittable.absent(), this.name = const Omittable.absent(), this.sessionDuration, });

factory DeviceEnrollmentPermissionsApplication3.fromJson(Map<String, dynamic> json) { return DeviceEnrollmentPermissionsApplication3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DeviceEnrollmentPermissionsApplication3 &&
          aud == other.aud &&
...
@override String toString() { return 'DeviceEnrollmentPermissionsApplication3(aud: $aud, createdAt: $createdAt, id: $id, scimConfig: $scimConfig, updatedAt: $updatedAt, allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type)'; } 
 }
