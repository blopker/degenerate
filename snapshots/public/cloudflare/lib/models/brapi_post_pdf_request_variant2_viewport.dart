...
final class BrapiPostPdfRequestVariant2Viewport {const BrapiPostPdfRequestVariant2Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });
