...
@immutable final class BrapiPostPdfRequestVariant2Viewport {const BrapiPostPdfRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostPdfRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant2Viewport(
...
BrapiPostPdfRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostPdfRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostPdfRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostPdfRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
