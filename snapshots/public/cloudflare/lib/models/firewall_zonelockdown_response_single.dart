...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_zonelockdown.dart';@immutable final class FirewallZonelockdownResponseSingle {const FirewallZonelockdownResponseSingle({required this.errors, required this.messages, required this.result, required this.success, });
...
FirewallZonelockdownResponseSingle copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, FirewallZonelockdown? result, bool? success, }) { return FirewallZonelockdownResponseSingle(
...
@override String toString() { return 'FirewallZonelockdownResponseSingle(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
