...
final class ZarazZarazConfigBodyConsentPurposesWithTranslationsValue {const ZarazZarazConfigBodyConsentPurposesWithTranslationsValue({required this.description, required this.name, required this.order, });
