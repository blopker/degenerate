...
import 'radar_get_http_timeseries_group_by_http_protocol_response_result.dart';final class RadarGetHttpTimeseriesGroupByHttpProtocolResponse {const RadarGetHttpTimeseriesGroupByHttpProtocolResponse({required this.result, required this.success, });
