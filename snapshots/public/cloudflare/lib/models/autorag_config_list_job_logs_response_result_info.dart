...
AutoragConfigListJobLogsResponseResultInfo copyWith({int? count, int? page, int? perPage, int? totalCount, }) { return AutoragConfigListJobLogsResponseResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AutoragConfigListJobLogsResponseResultInfo &&
          count == other.count &&
          page == other.page &&
          perPage == other.perPage &&
          totalCount == other.totalCount; } 
@override int get hashCode { return Object.hash(count, page, perPage, totalCount); } 
@override String toString() { return 'AutoragConfigListJobLogsResponseResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
