...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetOriginsTimeseriesResponse400Errors {const RadarGetOriginsTimeseriesResponse400Errors({required this.message});
