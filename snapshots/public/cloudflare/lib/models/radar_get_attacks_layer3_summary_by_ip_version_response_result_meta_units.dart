...
final class RadarGetAttacksLayer3SummaryByIpVersionResponseResultMetaUnits {const RadarGetAttacksLayer3SummaryByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
