...
UrlscannerSearchScansResponse2ResultsStats copyWith({double? dataLength, double? requests, double? uniqCountries, double? uniqIPs, }) { return UrlscannerSearchScansResponse2ResultsStats(
...
@override String toString() { return 'UrlscannerSearchScansResponse2ResultsStats(dataLength: $dataLength, requests: $requests, uniqCountries: $uniqCountries, uniqIPs: $uniqIPs)'; } 
 }
