...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_account_id.dart';import 'mconn_day_of_week.dart';import 'mconn_embargo_date.dart';import 'mconn_uuid.dart';final class MconnAdminConnector {const MconnAdminConnector({required this.accountId, required this.activated, this.cloudflaredTunnelId, this.cloudflaredTunnelToken, this.cohortId, this.desiredVersion, this.deviceId, required this.id, required this.interruptWindowDaysOfWeek, required this.interruptWindowDurationHours, required this.interruptWindowEmbargoDates, required this.interruptWindowHourOfDay, this.lastHeartbeat, this.lastSeenVersion, required this.lastUpdated, required this.notes, required this.timezone, required this.upgradeAsap, });
