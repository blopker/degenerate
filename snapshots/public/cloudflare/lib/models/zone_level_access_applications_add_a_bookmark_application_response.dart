...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_apps.dart';import 'access_messages2.dart';@immutable final class ZoneLevelAccessApplicationsAddABookmarkApplicationResponse {const ZoneLevelAccessApplicationsAddABookmarkApplicationResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZoneLevelAccessApplicationsAddABookmarkApplicationResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessApps? Function()? result, }) {return ZoneLevelAccessApplicationsAddABookmarkApplicationResponse(
...
@override String toString() {return 'ZoneLevelAccessApplicationsAddABookmarkApplicationResponse(errors: $errors, messages: $messages, success: $success, result: $result)';}
}
