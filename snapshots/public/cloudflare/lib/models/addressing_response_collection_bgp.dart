...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_ipam_bgp_prefixes.dart';import 'addressing_messages2.dart';@immutable final class AddressingResponseCollectionBgp {const AddressingResponseCollectionBgp({required this.errors, required this.messages, required this.success, this.result, });
...
AddressingResponseCollectionBgp copyWith({List<AddressingMessages2>? errors, List<AddressingMessages2>? messages, bool? success, List<AddressingIpamBgpPrefixes>? Function()? result, }) { return AddressingResponseCollectionBgp(
...
@override String toString() { return 'AddressingResponseCollectionBgp(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
