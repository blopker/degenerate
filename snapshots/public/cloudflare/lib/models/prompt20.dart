...
import 'prompt20_response_format.dart';final class Prompt20 {const Prompt20({this.frequencyPenalty, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });

factory Prompt20.fromJson(Map<String, dynamic> json) { return Prompt20(
  ...
  responseFormat: json['response_format'] != null ? Prompt20ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final Prompt20ResponseFormat? responseFormat;
...
Prompt20 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, Prompt20ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return Prompt20(
...
@override String toString() { return 'Prompt20(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
