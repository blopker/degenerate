...
factory ResponseSingle61.fromJson(Map<String, dynamic> json) {return ResponseSingle61(
  ...
  result: json['result'] != null ? ResponseSingle61Result.fromJson(json['result']) : null,
...
ResponseSingle61 copyWith({List<Messages42>? errors, List<Messages42>? messages, ResponseSingle61Result? Function()? result, bool? success, }) {return ResponseSingle61(
