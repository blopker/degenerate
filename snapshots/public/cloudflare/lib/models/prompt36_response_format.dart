...
@immutable final class Prompt36ResponseFormat {const Prompt36ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt36ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt36ResponseFormatType? Function()? type, }) { return Prompt36ResponseFormat(
