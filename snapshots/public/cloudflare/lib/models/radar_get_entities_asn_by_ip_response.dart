...
import 'radar_get_entities_asn_by_ip_response_result.dart';final class RadarGetEntitiesAsnByIpResponse {const RadarGetEntitiesAsnByIpResponse({required this.result, required this.success, });
