...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudforce_one_requests_messages2.dart';import 'cloudforce_one_requests_request_item.dart';@immutable final class CloudforceOnePriorityUpdateResponse {const CloudforceOnePriorityUpdateResponse({required this.errors, required this.messages, required this.success, this.result, });

factory CloudforceOnePriorityUpdateResponse.fromJson(Map<String, dynamic> json) { return CloudforceOnePriorityUpdateResponse(
...
CloudforceOnePriorityUpdateResponse copyWith({List<CloudforceOneRequestsMessages2>? errors, List<CloudforceOneRequestsMessages2>? messages, bool? success, CloudforceOneRequestsRequestItem Function()? result, }) { return CloudforceOnePriorityUpdateResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CloudforceOnePriorityUpdateResponse &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success &&
          result == other.result; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result); } 
@override String toString() { return 'CloudforceOnePriorityUpdateResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
