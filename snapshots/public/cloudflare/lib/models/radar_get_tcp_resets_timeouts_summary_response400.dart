...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_tcp_resets_timeouts_summary_response400_errors.dart';final class RadarGetTcpResetsTimeoutsSummaryResponse400 {const RadarGetTcpResetsTimeoutsSummaryResponse400({required this.errors, required this.result, required this.success, });
