...
factory UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInherited.fromJson(Map<String, dynamic> json) { return UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInherited(
  ...
  risks: (json['risks'] as List<dynamic>).map((e) => UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInheritedRisks.fromJson(e as Map<String, dynamic>)).toList(),
); }

final List<UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInheritedContent> content;

final String from;

final List<UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInheritedRisks> risks;
...
UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInherited copyWith({List<UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInheritedContent>? content, String? from, List<UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInheritedRisks>? risks, }) { return UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInherited(
...
@override String toString() { return 'UrlscannerGetScanResponse2MetaProcessorsUrlCategoriesDataInherited(content: $content, from: $from, risks: $risks)'; } 
 }
