...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';import 'tunnel_teamnet.dart';@immutable final class TunnelTeamnetResponseCollection {const TunnelTeamnetResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelTeamnetResponseCollection copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelTeamnet>? result, bool? success, TunnelResultInfo? Function()? resultInfo, }) { return TunnelTeamnetResponseCollection(
...
@override String toString() { return 'TunnelTeamnetResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
