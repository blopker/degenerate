...
final class RadarGetDnsSummaryByMatchingAnswerStatusResponseResultMetaUnits {const RadarGetDnsSummaryByMatchingAnswerStatusResponseResultMetaUnits({required this.name, required this.value, });
