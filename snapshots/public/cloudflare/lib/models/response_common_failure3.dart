...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'response_common_failure3_errors.dart';import 'response_common_failure3_messages.dart';final class ResponseCommonFailure3 {const ResponseCommonFailure3({required this.errors, this.messages, required this.success, });
...
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages ?? const []), success); } 
@override String toString() { return 'ResponseCommonFailure3(errors: $errors, messages: $messages, success: $success)'; } 
 }
