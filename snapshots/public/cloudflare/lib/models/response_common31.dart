...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'response_common31_result.dart';final class ResponseCommon31 {const ResponseCommon31({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommon31 copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, ResponseCommon31Result? result, bool? success, }) { return ResponseCommon31(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseCommon31 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), result, success); } 
@override String toString() { return 'ResponseCommon31(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
