...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages27_functions.dart';import 'messages27_messages.dart';import 'messages27_response_format.dart';import 'messages27_tools.dart';import 'messages27_tools_variant1.dart';import 'messages27_tools_variant2.dart';@immutable final class Messages27 {const Messages27({required this.messages, this.frequencyPenalty, this.functions, this.maxTokens = 256, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });

factory Messages27.fromJson(Map<String, dynamic> json) { return Messages27(
  frequencyPenalty: json['frequency_penalty'] != null ? (json['frequency_penalty'] as num).toDouble() : null,
  functions: (json['functions'] as List<dynamic>?)?.map((e) => Messages27Functions.fromJson(e as Map<String, dynamic>)).toList(),
  maxTokens: json.containsKey('max_tokens') ? (json['max_tokens'] as num).toInt() : 256,
  messages: (json['messages'] as List<dynamic>).map((e) => Messages27Messages.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  responseFormat: json['response_format'] != null ? Messages27ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages27ToolsVariant1.fromJson(v as Map<String, dynamic>), fromB: (v) => Messages27ToolsVariant2.fromJson(v as Map<String, dynamic>),)).toList(),
...
final List<Messages27Functions>? functions;

/// The maximum number of tokens to generate in the response.
final int maxTokens;

/// An array of message objects representing the conversation history.
final List<Messages27Messages> messages;
...
final Messages27ResponseFormat? responseFormat;
...
final List<Messages27Tools>? tools;
...
@override String toString() { return 'Messages27(frequencyPenalty: $frequencyPenalty, functions: $functions, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
