...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_organization.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionOrganizationResponse {const IamCollectionOrganizationResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionOrganizationResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamOrganization>? Function()? result, }) { return IamCollectionOrganizationResponse(
...
@override String toString() { return 'IamCollectionOrganizationResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
