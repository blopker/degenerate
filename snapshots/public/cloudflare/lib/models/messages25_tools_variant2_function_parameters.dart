...
@immutable final class Messages25ToolsVariant2FunctionParameters {const Messages25ToolsVariant2FunctionParameters({required this.properties, required this.type, this.$required, });
