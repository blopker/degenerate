...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_errors2.dart';final class ResponseFailure {const ResponseFailure({required this.errors, required this.messages, required this.result, required this.success, });
