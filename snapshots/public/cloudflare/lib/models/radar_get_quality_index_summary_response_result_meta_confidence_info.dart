...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_quality_index_summary_response_result_meta_confidence_info_annotations.dart';final class RadarGetQualityIndexSummaryResponseResultMetaConfidenceInfo {const RadarGetQualityIndexSummaryResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
