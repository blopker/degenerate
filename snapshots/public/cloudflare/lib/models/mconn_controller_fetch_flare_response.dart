...
MconnControllerFetchFlareResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerFlare? result, }) {return MconnControllerFetchFlareResponse(
...
@override String toString() {return 'MconnControllerFetchFlareResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
