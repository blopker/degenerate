...
import 'firewall_components_schemas_identifier.dart';final class FirewallRulesUpdatePriorityOfAFirewallRuleRequest {const FirewallRulesUpdatePriorityOfAFirewallRuleRequest({required this.id});
