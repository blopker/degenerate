...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_schemas_messages2.dart';@immutable final class ResponseCommon40 {const ResponseCommon40({required this.errors, required this.messages, required this.success, });
