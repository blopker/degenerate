...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';import 'rulesets_set_cache_control_rule_request_action_parameters.dart';@immutable final class RulesetsSetCacheControlRuleRequest {const RulesetsSetCacheControlRuleRequest({this.action = const Omittable.absent(), this.actionParameters, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsSetCacheControlRuleRequest.fromJson(Map<String, dynamic> json) {return RulesetsSetCacheControlRuleRequest(
  action: json.containsKey('action') ? Omittable(json['action']) : const Omittable.absent(),
  actionParameters: json['action_parameters'] != null ? RulesetsSetCacheControlRuleRequestActionParameters.fromJson(json['action_parameters'] as Map<String, dynamic>) : null,
...
final RulesetsSetCacheControlRuleRequestActionParameters? actionParameters;
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is RulesetsSetCacheControlRuleRequest &&
          action == other.action &&
...
@override String toString() {return 'RulesetsSetCacheControlRuleRequest(action: $action, actionParameters: $actionParameters, description: $description, enabled: $enabled, exposedCredentialCheck: $exposedCredentialCheck, expression: $expression, id: $id, logging: $logging, ratelimit: $ratelimit, ref: $ref)';}
}
