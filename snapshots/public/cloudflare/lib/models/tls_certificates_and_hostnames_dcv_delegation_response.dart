...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_messages2.dart';import 'tls_certificates_and_hostnames_uuid_object.dart';@immutable final class TlsCertificatesAndHostnamesDcvDelegationResponse {const TlsCertificatesAndHostnamesDcvDelegationResponse({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesDcvDelegationResponse copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesUuidObject? Function()? result, }) { return TlsCertificatesAndHostnamesDcvDelegationResponse(
...
@override String toString() { return 'TlsCertificatesAndHostnamesDcvDelegationResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
