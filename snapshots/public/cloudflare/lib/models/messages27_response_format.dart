...
@immutable final class Messages27ResponseFormat {const Messages27ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages27ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages27ResponseFormatType? Function()? type, }) { return Messages27ResponseFormat(
