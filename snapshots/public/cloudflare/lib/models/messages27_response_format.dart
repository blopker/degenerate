...
final class Messages27ResponseFormatType {const Messages27ResponseFormatType._(this.value);
...
final class Messages27ResponseFormat {const Messages27ResponseFormat({this.jsonSchema, this.type, });
