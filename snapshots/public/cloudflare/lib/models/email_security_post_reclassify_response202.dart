...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_message.dart';final class EmailSecurityPostReclassifyResponse202 {const EmailSecurityPostReclassifyResponse202({required this.errors, required this.messages, required this.success, required this.result, });
