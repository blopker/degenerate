...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages51ToolChoiceVariant1FunctionFunction {const Messages51ToolChoiceVariant1FunctionFunction({required this.name});
