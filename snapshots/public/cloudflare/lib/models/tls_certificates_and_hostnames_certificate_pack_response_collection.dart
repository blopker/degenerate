...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_certificate_pack.dart';import 'tls_certificates_and_hostnames_certificate_pack_response_collection_result_info.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesCertificatePackResponseCollection {const TlsCertificatesAndHostnamesCertificatePackResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
factory TlsCertificatesAndHostnamesCertificatePackResponseCollection.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesCertificatePackResponseCollection(
  ...
  resultInfo: json['result_info'] != null ? TlsCertificatesAndHostnamesCertificatePackResponseCollectionResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final TlsCertificatesAndHostnamesCertificatePackResponseCollectionResultInfo? resultInfo;
...
TlsCertificatesAndHostnamesCertificatePackResponseCollection copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesCertificatePackResponseCollectionResultInfo? Function()? resultInfo, List<TlsCertificatesAndHostnamesCertificatePack>? Function()? result, }) { return TlsCertificatesAndHostnamesCertificatePackResponseCollection(
...
@override String toString() { return 'TlsCertificatesAndHostnamesCertificatePackResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
