...
RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesLocationDetails copyWith({String? code, String? name, }) { return RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesLocationDetails(
  code: code ?? this.code,
  name: name ?? this.name,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesLocationDetails &&
          code == other.code &&
          name == other.name; } 
@override int get hashCode { return Object.hash(code, name); } 
@override String toString() { return 'RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesLocationDetails(code: $code, name: $name)'; } 
 }
