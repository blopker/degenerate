...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages5.dart';import 'result_info.dart';final class ResponseCollection7 {const ResponseCollection7({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
