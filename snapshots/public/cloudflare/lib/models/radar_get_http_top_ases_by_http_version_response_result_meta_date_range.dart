...
final class RadarGetHttpTopAsesByHttpVersionResponseResultMetaDateRange {const RadarGetHttpTopAsesByHttpVersionResponseResultMetaDateRange({required this.endTime, required this.startTime, });
