...
final class RadarGetDnsAs112TimeseriesGroupByDnssecResponseResultMetaUnits {const RadarGetDnsAs112TimeseriesGroupByDnssecResponseResultMetaUnits({required this.name, required this.value, });
