...
final class AiSearchInstanceListJobLogsResponseResultInfo {const AiSearchInstanceListJobLogsResponseResultInfo({required this.count, required this.page, required this.perPage, required this.totalCount, });
