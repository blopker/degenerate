...
AccessUsersComponentsSchemasResponseCollection copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessUsersComponentsSchemasResponseCollectionResultInfo? Function()? resultInfo, List<AccessSchemasUsers>? Function()? result, }) { return AccessUsersComponentsSchemasResponseCollection(
...
@override String toString() { return 'AccessUsersComponentsSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
