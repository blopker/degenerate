...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_tag.dart';final class NamespaceWorkerGetScriptTagsResponse {const NamespaceWorkerGetScriptTagsResponse({required this.errors, required this.messages, required this.success, this.result, });
