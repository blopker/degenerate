...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_tag.dart';@immutable final class NamespaceWorkerGetScriptTagsResponse {const NamespaceWorkerGetScriptTagsResponse({required this.errors, required this.messages, required this.success, this.result, });

factory NamespaceWorkerGetScriptTagsResponse.fromJson(Map<String, dynamic> json) { return NamespaceWorkerGetScriptTagsResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is NamespaceWorkerGetScriptTagsResponse &&
...
@override String toString() { return 'NamespaceWorkerGetScriptTagsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
