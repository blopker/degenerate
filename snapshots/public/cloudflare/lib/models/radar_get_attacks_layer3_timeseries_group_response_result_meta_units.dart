...
final class RadarGetAttacksLayer3TimeseriesGroupResponseResultMetaUnits {const RadarGetAttacksLayer3TimeseriesGroupResponseResultMetaUnits({required this.name, required this.value, });
