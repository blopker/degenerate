...
import 'radar_get_attacks_layer3_top_attacks_response_result.dart';final class RadarGetAttacksLayer3TopAttacksResponse {const RadarGetAttacksLayer3TopAttacksResponse({required this.result, required this.success, });
