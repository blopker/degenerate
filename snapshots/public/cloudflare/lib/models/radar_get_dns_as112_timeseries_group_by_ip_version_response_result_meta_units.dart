...
final class RadarGetDnsAs112TimeseriesGroupByIpVersionResponseResultMetaUnits {const RadarGetDnsAs112TimeseriesGroupByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
