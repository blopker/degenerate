...
final class RadarGetHttpTopAsesByDeviceTypeOs {const RadarGetHttpTopAsesByDeviceTypeOs._(this.value);
...
@override String toString() { return 'RadarGetHttpTopAsesByDeviceTypeOs($value)'; } 
 }
