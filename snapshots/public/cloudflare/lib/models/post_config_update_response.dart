...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages22.dart';import 'scan_config.dart';final class PostConfigUpdateResponse {const PostConfigUpdateResponse({required this.errors, required this.messages, required this.success, this.result, });
