...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorkersScriptResponseCollectionResultNamedHandlers {const WorkersScriptResponseCollectionResultNamedHandlers({this.handlers, this.name, });
