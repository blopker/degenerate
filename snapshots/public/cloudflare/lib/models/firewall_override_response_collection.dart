...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_override.dart';import 'firewall_result_info.dart';@immutable final class FirewallOverrideResponseCollection {const FirewallOverrideResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallOverrideResponseCollection copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallOverride>? result, bool? success, FirewallResultInfo Function()? resultInfo, }) { return FirewallOverrideResponseCollection(
...
@override String toString() { return 'FirewallOverrideResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
