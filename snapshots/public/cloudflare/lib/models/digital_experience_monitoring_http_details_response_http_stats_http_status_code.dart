...
DigitalExperienceMonitoringHttpDetailsResponseHttpStatsHttpStatusCode copyWith({int? status200, int? status300, int? status400, int? status500, String? timestamp, }) { return DigitalExperienceMonitoringHttpDetailsResponseHttpStatsHttpStatusCode(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DigitalExperienceMonitoringHttpDetailsResponseHttpStatsHttpStatusCode &&
...
@override String toString() { return 'DigitalExperienceMonitoringHttpDetailsResponseHttpStatsHttpStatusCode(status200: $status200, status300: $status300, status400: $status400, status500: $status500, timestamp: $timestamp)'; } 
 }
