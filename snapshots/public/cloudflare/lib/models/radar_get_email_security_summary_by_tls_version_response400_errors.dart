...
final class RadarGetEmailSecuritySummaryByTlsVersionResponse400Errors {const RadarGetEmailSecuritySummaryByTlsVersionResponse400Errors({required this.message});
