...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_queue.dart';@immutable final class QueuesPurgeResponse {const QueuesPurgeResponse({this.errors, this.messages, this.success, this.result, });
...
@override String toString() { return 'QueuesPurgeResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
