...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_queue.dart';final class QueuesPurgeResponse {const QueuesPurgeResponse({this.errors, this.messages, this.success, this.result, });
