...
@immutable
final class ShieldSchemaValidationExtractOperationsFromSchemaResponseResult {
  const ShieldSchemaValidationExtractOperationsFromSchemaResponseResult({this.shieldOperationOrNull = const Omittable.absent(),
this.shieldBasicOperation = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ShieldSchemaValidationExtractOperationsFromSchemaResponseResult._({required this.rawValue, required this.shieldOperationOrNull,
required this.shieldBasicOperation,});
  factory ShieldSchemaValidationExtractOperationsFromSchemaResponseResult.fromJson(Object? json) => ShieldSchemaValidationExtractOperationsFromSchemaResponseResult._(
...
if (shieldBasicOperation.isPresent) shieldBasicOperation.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ShieldSchemaValidationExtractOperationsFromSchemaResponseResult && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ShieldSchemaValidationExtractOperationsFromSchemaResponseResult(${toJson()})';
}
