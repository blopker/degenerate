...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'healthchecks_healthchecks.dart';import 'healthchecks_messages2.dart';import 'healthchecks_result_info.dart';@immutable final class HealthchecksResponseCollection {const HealthchecksResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
HealthchecksResponseCollection copyWith({List<HealthchecksMessages2>? errors, List<HealthchecksMessages2>? messages, List<HealthchecksHealthchecks>? result, bool? success, HealthchecksResultInfo? Function()? resultInfo, }) { return HealthchecksResponseCollection(
...
@override String toString() { return 'HealthchecksResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
