...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_conduit_connector.dart';@immutable final class MconnConduitFetchConnectorResponse {const MconnConduitFetchConnectorResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnConduitFetchConnectorResponse.fromJson(Map<String, dynamic> json) {return MconnConduitFetchConnectorResponse(
  ...
  result: MconnConduitConnector.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnConduitFetchConnectorResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnConduitConnector? result, }) {return MconnConduitFetchConnectorResponse(
...
@override String toString() {return 'MconnConduitFetchConnectorResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
