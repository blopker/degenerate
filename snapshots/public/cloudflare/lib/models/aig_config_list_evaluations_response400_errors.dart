...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AigConfigListEvaluationsResponse400Errors {const AigConfigListEvaluationsResponse400Errors({required this.message});
