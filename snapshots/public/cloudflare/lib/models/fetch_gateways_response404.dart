...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'fetch_gateways_response404_errors.dart';@immutable final class FetchGatewaysResponse404 {const FetchGatewaysResponse404({required this.errors, required this.success, });
