...
@immutable final class ZonesRedirectsForAiTraining {const ZonesRedirectsForAiTraining({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
