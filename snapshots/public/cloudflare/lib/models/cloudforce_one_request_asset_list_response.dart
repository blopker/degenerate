...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudforce_one_requests_messages2.dart';import 'cloudforce_one_requests_request_asset_item.dart';@immutable final class CloudforceOneRequestAssetListResponse {const CloudforceOneRequestAssetListResponse({required this.errors, required this.messages, required this.success, this.result, });

factory CloudforceOneRequestAssetListResponse.fromJson(Map<String, dynamic> json) { return CloudforceOneRequestAssetListResponse(
...
CloudforceOneRequestAssetListResponse copyWith({List<CloudforceOneRequestsMessages2>? errors, List<CloudforceOneRequestsMessages2>? messages, bool? success, List<CloudforceOneRequestsRequestAssetItem> Function()? result, }) { return CloudforceOneRequestAssetListResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CloudforceOneRequestAssetListResponse &&
...
@override String toString() { return 'CloudforceOneRequestAssetListResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
