...
factory ResponseCollection17.fromJson(Map<String, dynamic> json) { return ResponseCollection17(
  ...
  resultInfo: json['result_info'] != null ? ResponseCollection17ResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
); }
...
final ResponseCollection17ResultInfo? resultInfo;
...
ResponseCollection17 copyWith({List<EmailMessages2>? errors, List<EmailMessages2>? messages, bool? success, ResponseCollection17ResultInfo Function()? resultInfo, }) { return ResponseCollection17(
...
@override String toString() { return 'ResponseCollection17(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)'; } 
 }
