...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'response_message.dart';import 'teams_devices_registration.dart';final class GetRegistrationResponse {const GetRegistrationResponse({required this.errors, required this.messages, required this.result, required this.success, });
