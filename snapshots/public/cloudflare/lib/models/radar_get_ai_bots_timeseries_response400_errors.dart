...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetAiBotsTimeseriesResponse400Errors {const RadarGetAiBotsTimeseriesResponse400Errors({required this.message});
