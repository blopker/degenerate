...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'message3.dart';import 'organization.dart';final class OrganizationsCreateUserOrganizationResponse {const OrganizationsCreateUserOrganizationResponse({required this.errors, required this.messages, required this.result, required this.success, });
