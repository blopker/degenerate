...
import 'radar_get_quality_speed_top_ases_response_result.dart';final class RadarGetQualitySpeedTopAsesResponse {const RadarGetQualitySpeedTopAsesResponse({required this.result, required this.success, });
