...
final class Prompt7ResponseFormatType {const Prompt7ResponseFormatType._(this.value);
...
final class Prompt7ResponseFormat {const Prompt7ResponseFormat({this.jsonSchema, this.type, });
