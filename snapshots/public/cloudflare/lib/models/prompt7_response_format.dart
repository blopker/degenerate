...
@immutable final class Prompt7ResponseFormat {const Prompt7ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt7ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt7ResponseFormatType? Function()? type, }) { return Prompt7ResponseFormat(
