...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_controller_attestation_session.dart';@immutable final class MconnControllerEndAttestationSessionResponse {const MconnControllerEndAttestationSessionResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnControllerEndAttestationSessionResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerAttestationSession? result, }) {return MconnControllerEndAttestationSessionResponse(
...
@override String toString() {return 'MconnControllerEndAttestationSessionResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
