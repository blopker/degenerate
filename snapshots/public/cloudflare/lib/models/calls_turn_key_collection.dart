...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'calls_messages2.dart';import 'calls_turn_key_object.dart';@immutable final class CallsTurnKeyCollection {const CallsTurnKeyCollection({required this.errors, required this.messages, required this.success, this.result, });
