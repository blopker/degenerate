...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostEventCreateResponse400Errors {const PostEventCreateResponse400Errors({required this.message});
