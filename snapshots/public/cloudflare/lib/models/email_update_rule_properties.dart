...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_rule_action.dart';import 'email_rule_enabled.dart';import 'email_rule_matcher.dart';import 'email_rule_name.dart';import 'email_rule_priority.dart';@immutable final class EmailUpdateRuleProperties {const EmailUpdateRuleProperties({required this.actions, required this.matchers, this.enabled, this.name, this.priority, });
