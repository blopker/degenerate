...
import 'digital_experience_monitoring_aggregate_time_period.dart';final class DigitalExperienceMonitoringAggregateStat {const DigitalExperienceMonitoringAggregateStat({this.avgMs, this.deltaPct, required this.timePeriod, });
