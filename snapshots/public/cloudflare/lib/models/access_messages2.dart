...
import 'access_messages2_source.dart';final class AccessMessages2 {const AccessMessages2({required this.code, this.documentationUrl, required this.message, this.source, });
