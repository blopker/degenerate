...
import 'radar_get_origins_timeseries_response_result.dart';final class RadarGetOriginsTimeseriesResponse {const RadarGetOriginsTimeseriesResponse({required this.result, required this.success, });
