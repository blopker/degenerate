...
factory PauseResumeStopRecordingResponseDataStatus.fromJson(String json) { return switch (json) {
  ...
  'ERRORED' => errored,
  'PAUSED' => paused,
  _ => PauseResumeStopRecordingResponseDataStatus._(json),
}; }

static const PauseResumeStopRecordingResponseDataStatus invoked = PauseResumeStopRecordingResponseDataStatus._('INVOKED');

static const PauseResumeStopRecordingResponseDataStatus recording = PauseResumeStopRecordingResponseDataStatus._('RECORDING');

static const PauseResumeStopRecordingResponseDataStatus uploading = PauseResumeStopRecordingResponseDataStatus._('UPLOADING');

static const PauseResumeStopRecordingResponseDataStatus uploaded = PauseResumeStopRecordingResponseDataStatus._('UPLOADED');

static const PauseResumeStopRecordingResponseDataStatus errored = PauseResumeStopRecordingResponseDataStatus._('ERRORED');

static const PauseResumeStopRecordingResponseDataStatus paused = PauseResumeStopRecordingResponseDataStatus._('PAUSED');

static const List<PauseResumeStopRecordingResponseDataStatus> values = [invoked, recording, uploading, uploaded, errored, paused];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is PauseResumeStopRecordingResponseDataStatus && other.value == value; } 
...
factory PauseResumeStopRecordingResponseData.fromJson(Map<String, dynamic> json) { return PauseResumeStopRecordingResponseData(
  ...
  status: PauseResumeStopRecordingResponseDataStatus.fromJson(json['status'] as String),
...
final PauseResumeStopRecordingResponseDataStatus status;
...
@override String toString() { return 'PauseResumeStopRecordingResponseData(audioDownloadUrl: $audioDownloadUrl, downloadUrl: $downloadUrl, downloadUrlExpiry: $downloadUrlExpiry, fileSize: $fileSize, id: $id, invokedTime: $invokedTime, outputFileName: $outputFileName, recordingDuration: $recordingDuration, sessionId: $sessionId, startedTime: $startedTime, status: $status, stoppedTime: $stoppedTime, startReason: $startReason, stopReason: $stopReason, storageConfig: $storageConfig)'; } 
 }
