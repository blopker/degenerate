...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Prompt54ResponseFormatType {const Prompt54ResponseFormatType._(this.value);
...
@immutable final class Prompt54ResponseFormat {const Prompt54ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt54ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt54ResponseFormatType? Function()? type, }) { return Prompt54ResponseFormat(
