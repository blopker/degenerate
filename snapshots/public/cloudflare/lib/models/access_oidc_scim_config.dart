...
@immutable final class AccessOidcScimConfig {const AccessOidcScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessOidcScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessOidcScimConfig.fromJson(Map<String, dynamic> json) { return AccessOidcScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessOidcScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessOidcScimConfigIdentityUpdateBehavior.noAction,
