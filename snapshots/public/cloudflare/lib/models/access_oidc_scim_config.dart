...
@immutable final class AccessOidcScimConfigIdentityUpdateBehavior {const AccessOidcScimConfigIdentityUpdateBehavior._(this.value);

factory AccessOidcScimConfigIdentityUpdateBehavior.fromJson(String json) {return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessOidcScimConfigIdentityUpdateBehavior._(json),
};}

static const AccessOidcScimConfigIdentityUpdateBehavior automatic = AccessOidcScimConfigIdentityUpdateBehavior._('automatic');

static const AccessOidcScimConfigIdentityUpdateBehavior reauth = AccessOidcScimConfigIdentityUpdateBehavior._('reauth');

static const AccessOidcScimConfigIdentityUpdateBehavior noAction = AccessOidcScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessOidcScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is AccessOidcScimConfigIdentityUpdateBehavior && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'AccessOidcScimConfigIdentityUpdateBehavior($value)';}
}
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessOidcScimConfig {const AccessOidcScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessOidcScimConfig.fromJson(Map<String, dynamic> json) {return AccessOidcScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessOidcScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessOidcScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessOidcScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessOidcScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessOidcScimConfig copyWith({bool? Function()? enabled, AccessOidcScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessOidcScimConfig(
...
@override String toString() {return 'AccessOidcScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
