...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_custom_profile.dart';import 'dlp_messages2.dart';@immutable final class DlpProfilesListAllCustomProfilesResponse {const DlpProfilesListAllCustomProfilesResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpProfilesListAllCustomProfilesResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, List<DlpCustomProfile>? Function()? result, }) { return DlpProfilesListAllCustomProfilesResponse(
...
@override String toString() { return 'DlpProfilesListAllCustomProfilesResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
