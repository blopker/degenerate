...
import 'rulesets_ruleset_id.dart';import 'rulesets_ruleset_kind.dart';import 'rulesets_ruleset_phase.dart';import 'rulesets_ruleset_version.dart';final class ListZoneEntrypointRulesetVersionsResponseResult {const ListZoneEntrypointRulesetVersionsResponseResult({this.description = '', required this.id, required this.lastUpdated, required this.name, required this.version, required this.kind, required this.phase, });
