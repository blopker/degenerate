...
import 'package:collection/collection.dart';final class ShieldOldSchemaUploadLogEvent {const ShieldOldSchemaUploadLogEvent({required this.code, this.locations, this.message, });
