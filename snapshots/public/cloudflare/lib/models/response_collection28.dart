...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_visibility_pcaps_messages2.dart';import 'magic_visibility_pcaps_result_info.dart';final class ResponseCollection28 {const ResponseCollection28({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
