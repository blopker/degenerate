...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_proxy_endpoints.dart';@immutable final class ZeroTrustGatewayProxyEndpointsComponentsSchemasSingleResponse {const ZeroTrustGatewayProxyEndpointsComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZeroTrustGatewayProxyEndpointsComponentsSchemasSingleResponse copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayProxyEndpoints? Function()? result, }) { return ZeroTrustGatewayProxyEndpointsComponentsSchemasSingleResponse(
...
@override String toString() { return 'ZeroTrustGatewayProxyEndpointsComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
