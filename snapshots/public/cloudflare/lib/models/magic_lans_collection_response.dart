...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_lan.dart';import 'magic_messages2.dart';@immutable final class MagicLansCollectionResponse {const MagicLansCollectionResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
MagicLansCollectionResponse copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, List<MagicLan>? result, bool? success, }) { return MagicLansCollectionResponse(
...
@override String toString() { return 'MagicLansCollectionResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
