...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_namespace_response.dart';final class WorkersNamespaceListResponse {const WorkersNamespaceListResponse({required this.errors, required this.messages, required this.success, this.result, });
