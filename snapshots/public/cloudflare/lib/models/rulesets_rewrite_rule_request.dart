...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_rewrite_rule_request_action_parameters.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';@immutable final class RulesetsRewriteRuleRequest {const RulesetsRewriteRuleRequest({this.action = const Omittable.absent(), this.actionParameters, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsRewriteRuleRequest.fromJson(Map<String, dynamic> json) { return RulesetsRewriteRuleRequest(
  action: json.containsKey('action') ? Omittable(json['action']) : const Omittable.absent(),
  actionParameters: json['action_parameters'] != null ? RulesetsRewriteRuleRequestActionParameters.fromJson(json['action_parameters'] as Map<String, dynamic>) : null,
...
final RulesetsRewriteRuleRequestActionParameters? actionParameters;
...
RulesetsRewriteRuleRequest copyWith({Omittable<dynamic>? action, RulesetsRewriteRuleRequestActionParameters? Function()? actionParameters, Omittable<dynamic>? description, RulesetsRuleEnabled? Function()? enabled, RulesetsRuleExposedCredentialCheck? Function()? exposedCredentialCheck, String? Function()? expression, RulesetsRuleId? Function()? id, RulesetsRuleLogging? Function()? logging, RulesetsRuleRatelimit? Function()? ratelimit, String? Function()? ref, }) { return RulesetsRewriteRuleRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RulesetsRewriteRuleRequest &&
          action == other.action &&
...
@override String toString() { return 'RulesetsRewriteRuleRequest(action: $action, actionParameters: $actionParameters, description: $description, enabled: $enabled, exposedCredentialCheck: $exposedCredentialCheck, expression: $expression, id: $id, logging: $logging, ratelimit: $ratelimit, ref: $ref)'; } 
 }
