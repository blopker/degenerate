...
@immutable final class AccessGithubScimConfig {const AccessGithubScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessGithubScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessGithubScimConfig.fromJson(Map<String, dynamic> json) { return AccessGithubScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessGithubScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessGithubScimConfigIdentityUpdateBehavior.noAction,
