...
@immutable final class AccessGithubScimConfigIdentityUpdateBehavior {const AccessGithubScimConfigIdentityUpdateBehavior._(this.value);

factory AccessGithubScimConfigIdentityUpdateBehavior.fromJson(String json) {return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessGithubScimConfigIdentityUpdateBehavior._(json),
};}

static const AccessGithubScimConfigIdentityUpdateBehavior automatic = AccessGithubScimConfigIdentityUpdateBehavior._('automatic');

static const AccessGithubScimConfigIdentityUpdateBehavior reauth = AccessGithubScimConfigIdentityUpdateBehavior._('reauth');

static const AccessGithubScimConfigIdentityUpdateBehavior noAction = AccessGithubScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessGithubScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is AccessGithubScimConfigIdentityUpdateBehavior && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'AccessGithubScimConfigIdentityUpdateBehavior($value)';}
}
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessGithubScimConfig {const AccessGithubScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessGithubScimConfig.fromJson(Map<String, dynamic> json) {return AccessGithubScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessGithubScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessGithubScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessGithubScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessGithubScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessGithubScimConfig copyWith({bool? Function()? enabled, AccessGithubScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessGithubScimConfig(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AccessGithubScimConfig &&
...
@override String toString() {return 'AccessGithubScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
