...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_entry.dart';import 'dlp_confidence.dart';import 'dlp_context_awareness.dart';import 'dlp_entry.dart';import 'document_fingerprint_entry.dart';import 'exact_data_entry.dart';import 'integration_entry.dart';import 'predefined_entry.dart';import 'word_list_entry.dart';final class DlpCustomProfile {const DlpCustomProfile({this.aiContextEnabled = false, this.allowedMatchCount = 0, this.confidenceThreshold = DlpConfidence.low, this.contextAwareness, required this.createdAt, this.dataClasses, this.dataTags, this.description, this.entries, required this.id, required this.name, this.ocrEnabled = false, this.sensitivityLevels, this.sharedEntries, required this.updatedAt, });
