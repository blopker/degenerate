...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_controller_connector.dart';@immutable final class MconnControllerFetchConnectorResponse {const MconnControllerFetchConnectorResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnControllerFetchConnectorResponse.fromJson(Map<String, dynamic> json) {return MconnControllerFetchConnectorResponse(
  ...
  result: MconnControllerConnector.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnControllerFetchConnectorResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerConnector? result, }) {return MconnControllerFetchConnectorResponse(
...
@override String toString() {return 'MconnControllerFetchConnectorResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
