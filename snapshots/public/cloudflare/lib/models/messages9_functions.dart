...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages9Functions {const Messages9Functions({required this.code, required this.name, });
