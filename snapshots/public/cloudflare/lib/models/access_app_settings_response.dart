...
import 'access_allow_iframe.dart';import 'access_skip_interstitial.dart';final class AccessAppSettingsResponse {const AccessAppSettingsResponse({this.allowIframe, this.skipInterstitial, });
