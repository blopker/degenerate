...
import 'cloudflare_pipelines_connection_schema.dart';import 'cloudflare_pipelines_format.dart';import 'streams_by_stream_id_response_result_http.dart';import 'streams_by_stream_id_response_result_worker_binding.dart';final class StreamsByStreamIdResponseResult {const StreamsByStreamIdResponseResult({required this.createdAt, this.endpoint, this.format, required this.http, required this.id, required this.modifiedAt, required this.name, this.schema, required this.version, required this.workerBinding, });
...
factory StreamsByStreamIdResponseResult.fromJson(Map<String, dynamic> json) { return StreamsByStreamIdResponseResult(
  ...
  http: StreamsByStreamIdResponseResultHttp.fromJson(json['http'] as Map<String, dynamic>),
  ...
  workerBinding: StreamsByStreamIdResponseResultWorkerBinding.fromJson(json['worker_binding'] as Map<String, dynamic>),
); }
...
final StreamsByStreamIdResponseResultHttp http;
...
final StreamsByStreamIdResponseResultWorkerBinding workerBinding;
...
StreamsByStreamIdResponseResult copyWith({DateTime? createdAt, Uri Function()? endpoint, CloudflarePipelinesFormat Function()? format, StreamsByStreamIdResponseResultHttp? http, String? id, DateTime? modifiedAt, String? name, CloudflarePipelinesConnectionSchema Function()? schema, int? version, StreamsByStreamIdResponseResultWorkerBinding? workerBinding, }) { return StreamsByStreamIdResponseResult(
