...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudflare_pipelines_connection_schema.dart';import 'cloudflare_pipelines_format.dart';import 'streams_by_stream_id_response_result_http.dart';import 'streams_by_stream_id_response_result_worker_binding.dart';@immutable final class StreamsByStreamIdResponseResult {const StreamsByStreamIdResponseResult({required this.createdAt, required this.http, required this.id, required this.modifiedAt, required this.name, required this.version, required this.workerBinding, this.endpoint, this.format, this.schema, });
