...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_update_providers_response404_errors.dart';@immutable final class AigConfigUpdateProvidersResponse404 {const AigConfigUpdateProvidersResponse404({required this.errors, required this.success, });
