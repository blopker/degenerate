...
final class AigConfigGetGatewayDynamicRouteVersionResponseResultElementsStartOutputsNext {const AigConfigGetGatewayDynamicRouteVersionResponseResultElementsStartOutputsNext({required this.elementId});
