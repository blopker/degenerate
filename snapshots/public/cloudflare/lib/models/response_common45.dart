...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_transit_messages2.dart';@immutable final class ResponseCommon45 {const ResponseCommon45({required this.errors, required this.messages, required this.success, });
