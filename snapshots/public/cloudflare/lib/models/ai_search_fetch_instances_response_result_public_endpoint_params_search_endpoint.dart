...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AiSearchFetchInstancesResponseResultPublicEndpointParamsSearchEndpoint {const AiSearchFetchInstancesResponseResultPublicEndpointParamsSearchEndpoint({this.disabled});
