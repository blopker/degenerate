...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RealtimekitPresetUiDesignTokensColorsBackground {const RealtimekitPresetUiDesignTokensColorsBackground({required this.$600, required this.$700, required this.$800, required this.$900, required this.$1000, });
