...
final class AiSearchUpdateInstancesResponseResultPublicEndpointParamsRateLimit {const AiSearchUpdateInstancesResponseResultPublicEndpointParamsRateLimit({this.periodMs, this.requests, this.technique, });
