...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';@immutable final class ResponseCommon3 {const ResponseCommon3({required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ResponseCommon3(errors: $errors, messages: $messages, success: $success)'; } 
 }
