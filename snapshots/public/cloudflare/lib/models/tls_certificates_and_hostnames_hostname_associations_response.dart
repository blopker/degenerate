...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_hostname_associations_response_result.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesHostnameAssociationsResponse {const TlsCertificatesAndHostnamesHostnameAssociationsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesHostnameAssociationsResponse copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesHostnameAssociationsResponseResult? Function()? result, }) { return TlsCertificatesAndHostnamesHostnameAssociationsResponse(
...
@override String toString() { return 'TlsCertificatesAndHostnamesHostnameAssociationsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
