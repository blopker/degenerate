...
import 'dlp_dataset_upload_status.dart';final class DlpDatasetColumn {const DlpDatasetColumn({required this.entryId, required this.headerName, required this.numCells, required this.uploadStatus, });
