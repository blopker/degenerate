...
@immutable final class ZonesChallengeTtl {const ZonesChallengeTtl({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesChallengeTtl copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesChallengeTtlValue? value, }) { return ZonesChallengeTtl(
