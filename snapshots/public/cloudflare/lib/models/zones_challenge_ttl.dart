...
@immutable final class ZonesChallengeTtl {const ZonesChallengeTtl({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
