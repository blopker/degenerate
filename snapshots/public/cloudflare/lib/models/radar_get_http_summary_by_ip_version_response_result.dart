...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_summary_by_ip_version_response_result_meta.dart';import 'radar_get_http_summary_by_ip_version_response_result_summary0.dart';@immutable final class RadarGetHttpSummaryByIpVersionResponseResult {const RadarGetHttpSummaryByIpVersionResponseResult({required this.meta, required this.summary0, });
