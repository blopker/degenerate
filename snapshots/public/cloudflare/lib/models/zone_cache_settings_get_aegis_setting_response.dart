...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cache_rules_aegis.dart';import 'cache_rules_messages2.dart';@immutable final class ZoneCacheSettingsGetAegisSettingResponse {const ZoneCacheSettingsGetAegisSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'ZoneCacheSettingsGetAegisSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
