...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_certificates.dart';import 'access_messages2.dart';@immutable final class AccessCertificatesComponentsSchemasSingleResponse {const AccessCertificatesComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessCertificatesComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessCertificates? Function()? result, }) { return AccessCertificatesComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessCertificatesComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
