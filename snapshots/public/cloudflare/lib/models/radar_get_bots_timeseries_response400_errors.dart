...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetBotsTimeseriesResponse400Errors {const RadarGetBotsTimeseriesResponse400Errors({required this.message});
