...
final class RadarGetDnsTimeseriesGroupByIpVersionResponseResultMetaDateRange {const RadarGetDnsTimeseriesGroupByIpVersionResponseResultMetaDateRange({required this.endTime, required this.startTime, });
