...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_indicator_feeds_messages2.dart';@immutable final class CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx {const CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'CustomIndicatorFeedsGetIndicatorFeedMetadataResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
