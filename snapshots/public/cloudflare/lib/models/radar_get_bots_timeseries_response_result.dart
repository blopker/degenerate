...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bots_timeseries_response_result_meta.dart';import 'radar_get_bots_timeseries_response_result_value.dart';final class RadarGetBotsTimeseriesResponseResult {const RadarGetBotsTimeseriesResponseResult({required this.meta, this.additionalProperties = const {}, });
