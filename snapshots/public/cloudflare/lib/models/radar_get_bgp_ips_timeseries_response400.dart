...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bgp_ips_timeseries_response400_errors.dart';final class RadarGetBgpIpsTimeseriesResponse400 {const RadarGetBgpIpsTimeseriesResponse400({required this.errors, required this.result, required this.success, });
