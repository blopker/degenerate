...
factory MessagesInner.fromJson(Map<String, dynamic> json) { return MessagesInner(
  ...
  responseFormat: json['response_format'] != null ? MessagesInnerResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final List<MessagesInnerMessages> messages;
...
final MessagesInnerResponseFormat? responseFormat;
...
final List<MessagesInnerTools>? tools;
