...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cache_rules_messages2.dart';import 'cache_rules_origin_max_http_version.dart';@immutable final class ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse {const ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse copyWith({List<CacheRulesMessages2>? errors, List<CacheRulesMessages2>? messages, bool? success, CacheRulesOriginMaxHttpVersion? Function()? result, }) { return ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse(
...
@override String toString() { return 'ZoneCacheSettingsChangeOriginMaxHttpVersionSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
