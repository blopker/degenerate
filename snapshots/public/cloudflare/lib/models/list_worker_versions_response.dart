...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'list_worker_versions_response_result_info.dart';import 'workers_messages2.dart';import 'workers_version_response.dart';@immutable final class ListWorkerVersionsResponse {const ListWorkerVersionsResponse({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
...
factory ListWorkerVersionsResponse.fromJson(Map<String, dynamic> json) {return ListWorkerVersionsResponse(
  ...
  result: (json['result'] as List<dynamic>).map((e) => WorkersVersionResponse.fromJson(e as Map<String, dynamic>)).toList(),
);}
...
final List<WorkersVersionResponse> result;
...
ListWorkerVersionsResponse copyWith({List<WorkersMessages2>? errors, List<WorkersMessages2>? messages, bool? success, ListWorkerVersionsResponseResultInfo? Function()? resultInfo, List<WorkersVersionResponse>? result, }) {return ListWorkerVersionsResponse(
