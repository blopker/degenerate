...
import 'custom_indicator_feeds_permissions_update.dart';final class CustomIndicatorFeedsPermissionsResponse {const CustomIndicatorFeedsPermissionsResponse({this.result});
