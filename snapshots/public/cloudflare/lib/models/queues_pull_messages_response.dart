...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'queues_pull_messages_response_result.dart';final class QueuesPullMessagesResponse {const QueuesPullMessagesResponse({this.errors, this.messages, this.success, this.result, });
