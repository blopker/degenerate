...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_device_posture_rules.dart';import 'teams_devices_messages2.dart';import 'teams_devices_result_info.dart';@immutable final class TeamsDevicesResponseCollection {const TeamsDevicesResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TeamsDevicesResponseCollection copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesDevicePostureRules>? result, bool? success, TeamsDevicesResultInfo Function()? resultInfo, }) { return TeamsDevicesResponseCollection(
...
@override String toString() { return 'TeamsDevicesResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
