...
@immutable final class RadarGetHttpTopBrowserFamiliesResponseResultMetaNormalization {const RadarGetHttpTopBrowserFamiliesResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetHttpTopBrowserFamiliesResponseResultMeta {const RadarGetHttpTopBrowserFamiliesResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
