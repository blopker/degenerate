...
final class RadarGetAiInferenceTimeseriesGroupByTaskResponseResultMetaUnits {const RadarGetAiInferenceTimeseriesGroupByTaskResponseResultMetaUnits({required this.name, required this.value, });
