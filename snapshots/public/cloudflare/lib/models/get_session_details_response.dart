...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_session_details_response_data.dart';@immutable final class GetSessionDetailsResponse {const GetSessionDetailsResponse({this.data, this.success, });
