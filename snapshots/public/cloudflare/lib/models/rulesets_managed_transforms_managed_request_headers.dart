...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_managed_transform_id.dart';@immutable final class RulesetsManagedTransformsManagedRequestHeaders {const RulesetsManagedTransformsManagedRequestHeaders({required this.enabled, required this.hasConflict, required this.id, this.conflictsWith, });

factory RulesetsManagedTransformsManagedRequestHeaders.fromJson(Map<String, dynamic> json) { return RulesetsManagedTransformsManagedRequestHeaders(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RulesetsManagedTransformsManagedRequestHeaders &&
...
@override String toString() { return 'RulesetsManagedTransformsManagedRequestHeaders(conflictsWith: $conflictsWith, enabled: $enabled, hasConflict: $hasConflict, id: $id)'; } 
 }
