...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';import 'ip_address_management_address_maps_add_an_ip_to_an_address_map_response4xx_result_info.dart';@immutable final class IpAddressManagementAddressMapsAddAnIpToAnAddressMapResponse4xx {const IpAddressManagementAddressMapsAddAnIpToAnAddressMapResponse4xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
