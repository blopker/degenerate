...
TlsCertificatesAndHostnamesCertificateAnalyzeResponse copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, Map<String, dynamic>? Function()? result, }) { return TlsCertificatesAndHostnamesCertificateAnalyzeResponse(
...
@override String toString() { return 'TlsCertificatesAndHostnamesCertificateAnalyzeResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
