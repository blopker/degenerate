...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_destination_address_properties.dart';import 'email_messages2.dart';@immutable final class EmailDestinationAddressResponseSingle {const EmailDestinationAddressResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'EmailDestinationAddressResponseSingle(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
