...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_profile.dart';import 'dlp_messages2.dart';import 'dlp_profile.dart';import 'integration_profile.dart';import 'predefined_profile.dart';@immutable final class DlpProfilesGetCustomProfileResponse {const DlpProfilesGetCustomProfileResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpProfilesGetCustomProfileResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, DlpProfile? Function()? result, }) { return DlpProfilesGetCustomProfileResponse(
...
@override String toString() { return 'DlpProfilesGetCustomProfileResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
