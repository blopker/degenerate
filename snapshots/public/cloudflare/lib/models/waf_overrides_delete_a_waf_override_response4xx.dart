...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'waf_overrides_delete_a_waf_override_response4xx_result.dart';@immutable final class WafOverridesDeleteAWafOverrideResponse4xx {const WafOverridesDeleteAWafOverrideResponse4xx({required this.errors, required this.messages, required this.result, required this.success, });
