...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_settings_messages2.dart';final class ResponseCommon26 {const ResponseCommon26({required this.errors, required this.messages, required this.success, });
...
ResponseCommon26 copyWith({List<DnsSettingsMessages2>? errors, List<DnsSettingsMessages2>? messages, bool? success, }) { return ResponseCommon26(
  errors: errors ?? this.errors,
  messages: messages ?? this.messages,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseCommon26 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success); } 
@override String toString() { return 'ResponseCommon26(errors: $errors, messages: $messages, success: $success)'; } 
 }
