...
@immutable final class AccessOktaScimConfigIdentityUpdateBehavior {const AccessOktaScimConfigIdentityUpdateBehavior._(this.value);

factory AccessOktaScimConfigIdentityUpdateBehavior.fromJson(String json) {return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessOktaScimConfigIdentityUpdateBehavior._(json),
};}

static const AccessOktaScimConfigIdentityUpdateBehavior automatic = AccessOktaScimConfigIdentityUpdateBehavior._('automatic');

static const AccessOktaScimConfigIdentityUpdateBehavior reauth = AccessOktaScimConfigIdentityUpdateBehavior._('reauth');

static const AccessOktaScimConfigIdentityUpdateBehavior noAction = AccessOktaScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessOktaScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is AccessOktaScimConfigIdentityUpdateBehavior && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'AccessOktaScimConfigIdentityUpdateBehavior($value)';}
}
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessOktaScimConfig {const AccessOktaScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessOktaScimConfig.fromJson(Map<String, dynamic> json) {return AccessOktaScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessOktaScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessOktaScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessOktaScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessOktaScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessOktaScimConfig copyWith({bool? Function()? enabled, AccessOktaScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessOktaScimConfig(
...
@override String toString() {return 'AccessOktaScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
