...
@immutable final class AccessOktaScimConfig {const AccessOktaScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessOktaScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessOktaScimConfig.fromJson(Map<String, dynamic> json) { return AccessOktaScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessOktaScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessOktaScimConfigIdentityUpdateBehavior.noAction,
