...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'load_balancing_load_balancer.dart';import 'load_balancing_messages2.dart';import 'load_balancing_result_info.dart';@immutable final class LoadBalancingLoadBalancerComponentsSchemasResponseCollection {const LoadBalancingLoadBalancerComponentsSchemasResponseCollection({required this.errors, required this.messages, required this.success, required this.resultInfo, required this.result, });
...
LoadBalancingLoadBalancerComponentsSchemasResponseCollection copyWith({List<LoadBalancingMessages2>? errors, List<LoadBalancingMessages2>? messages, bool? success, LoadBalancingResultInfo? resultInfo, List<LoadBalancingLoadBalancer>? result, }) {return LoadBalancingLoadBalancerComponentsSchemasResponseCollection(
...
@override String toString() {return 'LoadBalancingLoadBalancerComponentsSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)';}
}
