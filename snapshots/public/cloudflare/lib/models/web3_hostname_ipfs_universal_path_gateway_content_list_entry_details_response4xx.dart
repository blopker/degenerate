...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'web3_hostname_ipfs_universal_path_gateway_content_list_entry_details_response4xx_result_info.dart';import 'web3_messages2.dart';@immutable final class Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx {const Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo = const Omittable.absent(), });
...
factory Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx.fromJson(Map<String, dynamic> json) { return Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx(
  ...
  resultInfo: json.containsKey('result_info') ? Omittable(json['result_info'] != null ? Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xxResultInfo.fromJson(json['result_info']) : null) : const Omittable.absent(),
); }
...
final Omittable<Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xxResultInfo?> resultInfo;
...
Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx copyWith({List<Web3Messages2>? errors, List<Web3Messages2>? messages, Map<String, dynamic>? Function()? result, bool? success, Omittable<Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xxResultInfo?>? resultInfo, }) { return Web3HostnameIpfsUniversalPathGatewayContentListEntryDetailsResponse4xx(
