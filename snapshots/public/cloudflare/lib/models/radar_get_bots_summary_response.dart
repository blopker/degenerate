...
import 'radar_get_bots_summary_response_result.dart';final class RadarGetBotsSummaryResponse {const RadarGetBotsSummaryResponse({required this.result, required this.success, });
