...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_support_cohort.dart';@immutable final class MconnSupportCohortFetchResponse {const MconnSupportCohortFetchResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnSupportCohortFetchResponse.fromJson(Map<String, dynamic> json) {return MconnSupportCohortFetchResponse(
  ...
  result: MconnSupportCohort.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnSupportCohortFetchResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnSupportCohort? result, }) {return MconnSupportCohortFetchResponse(
...
@override String toString() {return 'MconnSupportCohortFetchResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
