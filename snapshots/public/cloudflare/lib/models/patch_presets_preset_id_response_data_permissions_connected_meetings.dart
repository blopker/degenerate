...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings {const PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings({required this.canAlterConnectedMeetings, required this.canSwitchConnectedMeetings, required this.canSwitchToParentMeeting, });

factory PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings.fromJson(Map<String, dynamic> json) { return PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings copyWith({bool? canAlterConnectedMeetings, bool? canSwitchConnectedMeetings, bool? canSwitchToParentMeeting, }) { return PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings &&
...
@override String toString() { return 'PatchPresetsPresetIdResponseDataPermissionsConnectedMeetings(canAlterConnectedMeetings: $canAlterConnectedMeetings, canSwitchConnectedMeetings: $canSwitchConnectedMeetings, canSwitchToParentMeeting: $canSwitchToParentMeeting)'; } 
 }
