...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_bookmarks.dart';import 'access_messages2.dart';@immutable final class AccessBookmarksComponentsSchemasSingleResponse {const AccessBookmarksComponentsSchemasSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessBookmarksComponentsSchemasSingleResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessBookmarks? Function()? result, }) { return AccessBookmarksComponentsSchemasSingleResponse(
...
@override String toString() { return 'AccessBookmarksComponentsSchemasSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
