...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMetaAggInterval {const RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMetaNormalization {const RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMeta {const RadarGetEmailRoutingTimeseriesGroupByDkimResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
