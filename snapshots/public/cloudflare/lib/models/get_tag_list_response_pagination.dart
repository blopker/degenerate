...
final class GetTagListResponsePagination {const GetTagListResponsePagination({required this.page, required this.pageSize, required this.totalCount, required this.totalPages, });
