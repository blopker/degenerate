...
EmailSecurityUpdateDisplayNameResponseResult copyWith({String? email, bool? isEmailRegex, String? name, Omittable<String?>? comments, DateTime? createdAt, Omittable<int?>? directoryId, Omittable<int?>? directoryNodeId, Omittable<String?>? externalDirectoryNodeId, int? id, DateTime? lastModified, Omittable<String?>? provenance, }) { return EmailSecurityUpdateDisplayNameResponseResult(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EmailSecurityUpdateDisplayNameResponseResult &&
          email == other.email &&
...
@override String toString() { return 'EmailSecurityUpdateDisplayNameResponseResult(email: $email, isEmailRegex: $isEmailRegex, name: $name, comments: $comments, createdAt: $createdAt, directoryId: $directoryId, directoryNodeId: $directoryNodeId, externalDirectoryNodeId: $externalDirectoryNodeId, id: $id, lastModified: $lastModified, provenance: $provenance)'; } 
 }
