...
@immutable final class Messages37ResponseFormat {const Messages37ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages37ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages37ResponseFormatType? Function()? type, }) { return Messages37ResponseFormat(
