...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dos_messages2.dart';@immutable final class ResponseCommon28 {const ResponseCommon28({required this.errors, required this.messages, required this.success, });
