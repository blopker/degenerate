...
@immutable final class ZoneCacheSettingsGetVariantsSettingResponseResult {const ZoneCacheSettingsGetVariantsSettingResponseResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
ZoneCacheSettingsGetVariantsSettingResponseResult copyWith({ZoneCacheSettingsGetVariantsSettingResponseResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesVariantsValue? value, }) { return ZoneCacheSettingsGetVariantsSettingResponseResult(
  id: id ?? this.id,
