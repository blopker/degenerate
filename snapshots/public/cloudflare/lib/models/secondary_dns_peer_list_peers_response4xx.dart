...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'secondary_dns_messages2.dart';import 'secondary_dns_peer_list_peers_response4xx_result_info.dart';@immutable final class SecondaryDnsPeerListPeersResponse4xx {const SecondaryDnsPeerListPeersResponse4xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
