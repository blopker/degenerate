...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';import 'iam_user_invite.dart';@immutable final class IamSchemasCollectionInviteResponse {const IamSchemasCollectionInviteResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamSchemasCollectionInviteResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamUserInvite>? Function()? result, }) { return IamSchemasCollectionInviteResponse(
...
@override String toString() { return 'IamSchemasCollectionInviteResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
