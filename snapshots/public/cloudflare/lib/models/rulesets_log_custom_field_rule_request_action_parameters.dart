...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_log_custom_field_cookie_fields2.dart';import 'rulesets_log_custom_field_raw_response_fields2.dart';import 'rulesets_log_custom_field_request_fields2.dart';import 'rulesets_log_custom_field_response_fields2.dart';import 'rulesets_log_custom_field_transformed_request_fields2.dart';@immutable final class RulesetsLogCustomFieldRuleRequestActionParameters {const RulesetsLogCustomFieldRuleRequestActionParameters({this.cookieFields, this.rawResponseFields, this.requestFields, this.responseFields, this.transformedRequestFields, });

factory RulesetsLogCustomFieldRuleRequestActionParameters.fromJson(Map<String, dynamic> json) { return RulesetsLogCustomFieldRuleRequestActionParameters(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RulesetsLogCustomFieldRuleRequestActionParameters &&
...
@override String toString() { return 'RulesetsLogCustomFieldRuleRequestActionParameters(cookieFields: $cookieFields, rawResponseFields: $rawResponseFields, requestFields: $requestFields, responseFields: $responseFields, transformedRequestFields: $transformedRequestFields)'; } 
 }
