...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetApplicationsResponse4XxResultInfo {const GetApplicationsResponse4XxResultInfo({this.count, this.page, this.perPage, this.totalCount, });

factory GetApplicationsResponse4XxResultInfo.fromJson(Map<String, dynamic> json) { return GetApplicationsResponse4XxResultInfo(
...
GetApplicationsResponse4XxResultInfo copyWith({double? Function()? count, double? Function()? page, double? Function()? perPage, double? Function()? totalCount, }) { return GetApplicationsResponse4XxResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetApplicationsResponse4XxResultInfo &&
          count == other.count &&
          page == other.page &&
          perPage == other.perPage &&
          totalCount == other.totalCount; } 
@override int get hashCode { return Object.hash(count, page, perPage, totalCount); } 
@override String toString() { return 'GetApplicationsResponse4XxResultInfo(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
