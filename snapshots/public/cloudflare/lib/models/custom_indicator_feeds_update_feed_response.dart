...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_indicator_feeds_schemas_messages2.dart';import 'custom_indicator_feeds_update_feed.dart';@immutable final class CustomIndicatorFeedsUpdateFeedResponse {const CustomIndicatorFeedsUpdateFeedResponse({required this.errors, required this.messages, required this.success, this.result, });
...
CustomIndicatorFeedsUpdateFeedResponse copyWith({List<CustomIndicatorFeedsSchemasMessages2>? errors, List<CustomIndicatorFeedsSchemasMessages2>? messages, bool? success, CustomIndicatorFeedsUpdateFeed? Function()? result, }) { return CustomIndicatorFeedsUpdateFeedResponse(
...
@override String toString() { return 'CustomIndicatorFeedsUpdateFeedResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
