...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'calls_messages2.dart';@immutable final class ResponseCommonFailure16 {const ResponseCommonFailure16({required this.errors, required this.messages, required this.result, required this.success, });
