...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_deployment.dart';import 'workers_messages2.dart';@immutable final class WorkerDeploymentsGetDeploymentResponse {const WorkerDeploymentsGetDeploymentResponse({required this.errors, required this.messages, required this.success, required this.result, });
