...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_presets_preset_id_response_data.dart';@immutable final class GetPresetsPresetIdResponse {const GetPresetsPresetIdResponse({required this.data, required this.success, });
