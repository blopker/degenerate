...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorkersAiPostRunHfTheblokeZephyr7bBetaAwqResponse400Errors {const WorkersAiPostRunHfTheblokeZephyr7bBetaAwqResponse400Errors({required this.code, required this.message, });
