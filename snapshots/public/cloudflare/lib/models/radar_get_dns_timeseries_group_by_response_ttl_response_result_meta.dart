...
@immutable final class RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMetaAggInterval {const RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMetaNormalization {const RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMeta {const RadarGetDnsTimeseriesGroupByResponseTtlResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
