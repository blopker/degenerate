...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTopLocationsByHttpProtocolResponseResultMetaUnits {const RadarGetHttpTopLocationsByHttpProtocolResponseResultMetaUnits({required this.name, required this.value, });
