...
@immutable final class BrapiPostLinksRequestVariant2Viewport {const BrapiPostLinksRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostLinksRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostLinksRequestVariant2Viewport(
...
BrapiPostLinksRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostLinksRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostLinksRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostLinksRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
