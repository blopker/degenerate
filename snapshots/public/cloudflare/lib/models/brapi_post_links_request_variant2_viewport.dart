...
final class BrapiPostLinksRequestVariant2Viewport {const BrapiPostLinksRequestVariant2Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });
