...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_components_schemas_hostname.dart';import 'tls_certificates_and_hostnames_hostname_tls_settings_components_schemas_created_at.dart';import 'tls_certificates_and_hostnames_hostname_tls_settings_components_schemas_status.dart';import 'tls_certificates_and_hostnames_hostname_tls_settings_components_schemas_updated_at.dart';import 'tls_certificates_and_hostnames_value.dart';@immutable final class TlsCertificatesAndHostnamesSettingObject {const TlsCertificatesAndHostnamesSettingObject({this.createdAt, this.hostname, this.status, this.updatedAt, this.value, });

factory TlsCertificatesAndHostnamesSettingObject.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesSettingObject(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is TlsCertificatesAndHostnamesSettingObject &&
...
@override String toString() { return 'TlsCertificatesAndHostnamesSettingObject(createdAt: $createdAt, hostname: $hostname, status: $status, updatedAt: $updatedAt, value: $value)'; } 
 }
