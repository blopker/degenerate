...
import 'dlp_pattern.dart';final class DlpNewEntry {const DlpNewEntry({this.description, required this.enabled, required this.name, required this.pattern, this.profileId, });
