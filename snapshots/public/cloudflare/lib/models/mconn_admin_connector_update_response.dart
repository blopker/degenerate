...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_connector.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminConnectorUpdateResponse {const MconnAdminConnectorUpdateResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminConnectorUpdateResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminConnector? result, }) {return MconnAdminConnectorUpdateResponse(
...
@override String toString() {return 'MconnAdminConnectorUpdateResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
