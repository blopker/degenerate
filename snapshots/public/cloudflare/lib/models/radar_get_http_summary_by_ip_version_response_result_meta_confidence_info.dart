...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_summary_by_ip_version_response_result_meta_confidence_info_annotations.dart';@immutable final class RadarGetHttpSummaryByIpVersionResponseResultMetaConfidenceInfo {const RadarGetHttpSummaryByIpVersionResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
