...
import 'radar_get_asns_as_set_response_result.dart';final class RadarGetAsnsAsSetResponse {const RadarGetAsnsAsSetResponse({required this.result, required this.success, });
