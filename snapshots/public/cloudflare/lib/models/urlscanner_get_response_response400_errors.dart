...
UrlscannerGetResponseResponse400Errors copyWith({String? detail, int? status, String? title, }) { return UrlscannerGetResponseResponse400Errors(
  detail: detail ?? this.detail,
  status: status ?? this.status,
  title: title ?? this.title,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UrlscannerGetResponseResponse400Errors &&
          detail == other.detail &&
          status == other.status &&
          title == other.title; } 
@override int get hashCode { return Object.hash(detail, status, title); } 
@override String toString() { return 'UrlscannerGetResponseResponse400Errors(detail: $detail, status: $status, title: $title)'; } 
 }
