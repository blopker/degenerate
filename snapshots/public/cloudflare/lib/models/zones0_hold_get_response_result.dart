...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Zones0HoldGetResponseResult {const Zones0HoldGetResponseResult({this.hold, this.holdAfter, this.includeSubdomains, });
