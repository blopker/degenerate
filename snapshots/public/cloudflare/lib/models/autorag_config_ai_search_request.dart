...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'autorag_config_ai_search_request_filters.dart';import 'autorag_config_ai_search_request_filters_variant1.dart';import 'autorag_config_ai_search_request_filters_variant2.dart';import 'autorag_config_ai_search_request_model.dart';import 'autorag_config_ai_search_request_ranking_options.dart';import 'autorag_config_ai_search_request_reranking.dart';@immutable final class AutoragConfigAiSearchRequest {const AutoragConfigAiSearchRequest({required this.query, this.filters, this.maxNumResults = 10, this.model, this.rankingOptions, this.reranking, this.rewriteQuery = false, this.stream = false, this.systemPrompt, });

factory AutoragConfigAiSearchRequest.fromJson(Map<String, dynamic> json) { return AutoragConfigAiSearchRequest(
  filters: json['filters'] != null ? OneOf2.parse(json['filters'], fromA: (v) => AutoragConfigAiSearchRequestFiltersVariant1.fromJson(v as Map<String, dynamic>), fromB: (v) => AutoragConfigAiSearchRequestFiltersVariant2.fromJson(v as Map<String, dynamic>),) : null,
  maxNumResults: json.containsKey('max_num_results') ? (json['max_num_results'] as num).toInt() : 10,
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => AutoragConfigAiSearchRequestModelVariant1.fromJson(v as String), fromB: (v) => AutoragConfigAiSearchRequestModelVariant2.fromJson(v as String),) : null,
