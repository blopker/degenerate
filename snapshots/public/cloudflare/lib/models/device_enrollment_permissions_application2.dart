...
@immutable final class DeviceEnrollmentPermissionsApplication2 {const DeviceEnrollmentPermissionsApplication2({required this.type, this.aud, this.createdAt, this.id, this.updatedAt, this.allowedIdps, this.autoRedirectToIdentity, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.domain = const Omittable.absent(), this.name = const Omittable.absent(), this.sessionDuration, this.policies, });

factory DeviceEnrollmentPermissionsApplication2.fromJson(Map<String, dynamic> json) { return DeviceEnrollmentPermissionsApplication2(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DeviceEnrollmentPermissionsApplication2 &&
          aud == other.aud &&
...
@override String toString() { return 'DeviceEnrollmentPermissionsApplication2(aud: $aud, createdAt: $createdAt, id: $id, updatedAt: $updatedAt, allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, customDenyUrl: $customDenyUrl, customNonIdentityDenyUrl: $customNonIdentityDenyUrl, customPages: $customPages, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type, policies: $policies)'; } 
 }
