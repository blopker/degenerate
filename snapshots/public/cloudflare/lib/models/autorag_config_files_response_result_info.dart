...
final class AutoragConfigFilesResponseResultInfo {const AutoragConfigFilesResponseResultInfo({required this.count, required this.page, this.perPage = 20, required this.totalCount, });
