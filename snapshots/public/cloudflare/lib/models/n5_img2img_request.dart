...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class $5Img2imgRequest {const $5Img2imgRequest({this.guidance = 7.5, this.height, this.image, this.imageB64, this.mask, this.negativePrompt, this.numSteps = 20, required this.prompt, this.seed, this.strength = 1.0, this.width, });
