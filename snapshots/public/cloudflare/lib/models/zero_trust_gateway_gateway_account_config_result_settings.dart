...
factory ZeroTrustGatewayGatewayAccountConfigResultSettings.fromJson(Map<String, dynamic> json) {return ZeroTrustGatewayGatewayAccountConfigResultSettings(
  ...
  blockPage: json.containsKey('block_page') ? Omittable(json['block_page'] != null ? ZeroTrustGatewayBlockPageSettings.fromJson(json['block_page'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  ...
  customCertificate: json.containsKey('custom_certificate') ? Omittable(json['custom_certificate'] != null ? ZeroTrustGatewayCustomCertificateSettings.fromJson(json['custom_certificate'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  extendedEmailMatching: json.containsKey('extended_email_matching') ? Omittable(json['extended_email_matching'] != null ? ZeroTrustGatewayExtendedEmailMatching.fromJson(json['extended_email_matching'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<ZeroTrustGatewayBlockPageSettings?> blockPage;
...
final Omittable<ZeroTrustGatewayCustomCertificateSettings?> customCertificate;

final Omittable<ZeroTrustGatewayExtendedEmailMatching?> extendedEmailMatching;
...
ZeroTrustGatewayGatewayAccountConfigResultSettings copyWith({Omittable<ZeroTrustGatewayActivityLogSettings?>? activityLog, Omittable<ZeroTrustGatewayAntiVirusSettings?>? antivirus, Omittable<ZeroTrustGatewayBlockPageSettings?>? blockPage, Omittable<ZeroTrustGatewayBodyScanningSettings?>? bodyScanning, Omittable<ZeroTrustGatewayBrowserIsolationSettings?>? browserIsolation, Omittable<ZeroTrustGatewayCertificateSettings?>? certificate, Omittable<ZeroTrustGatewayCustomCertificateSettings?>? customCertificate, Omittable<ZeroTrustGatewayExtendedEmailMatching?>? extendedEmailMatching, Omittable<ZeroTrustGatewayFipsSettings?>? fips, Omittable<ZeroTrustGatewayHostSelectorSettings?>? hostSelector, Omittable<ZeroTrustGatewayInspectionSettings?>? inspection, Omittable<ZeroTrustGatewayProtocolDetection?>? protocolDetection, Omittable<ZeroTrustGatewaySandbox?>? sandbox, Omittable<ZeroTrustGatewayTlsSettings?>? tlsDecrypt, }) {return ZeroTrustGatewayGatewayAccountConfigResultSettings(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is ZeroTrustGatewayGatewayAccountConfigResultSettings &&
