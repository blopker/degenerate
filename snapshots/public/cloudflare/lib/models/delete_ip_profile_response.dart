...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'delete_ip_profile_response_result.dart';import 'response_message.dart';final class DeleteIpProfileResponse {const DeleteIpProfileResponse({required this.errors, required this.messages, required this.result, required this.success, });
