...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'stream_keys.dart';import 'stream_messages2.dart';@immutable final class StreamKeyGenerationResponse {const StreamKeyGenerationResponse({required this.errors, required this.messages, required this.success, this.result, });
