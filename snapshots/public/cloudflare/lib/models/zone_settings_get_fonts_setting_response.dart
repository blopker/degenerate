...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'speed_cloudflare_fonts.dart';import 'speed_messages2.dart';@immutable final class ZoneSettingsGetFontsSettingResponse {const ZoneSettingsGetFontsSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZoneSettingsGetFontsSettingResponse copyWith({List<SpeedMessages2>? errors, List<SpeedMessages2>? messages, bool? success, SpeedCloudflareFonts? Function()? result, }) { return ZoneSettingsGetFontsSettingResponse(
