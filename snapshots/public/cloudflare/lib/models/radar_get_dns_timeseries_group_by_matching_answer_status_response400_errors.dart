...
final class RadarGetDnsTimeseriesGroupByMatchingAnswerStatusResponse400Errors {const RadarGetDnsTimeseriesGroupByMatchingAnswerStatusResponse400Errors({required this.message});
