...
import 'radar_get_attacks_layer3_timeseries_group_by_bitrate_response_result.dart';final class RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse {const RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse({required this.result, required this.success, });
...
@override String toString() { return 'RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse(result: $result, success: $success)'; } 
 }
