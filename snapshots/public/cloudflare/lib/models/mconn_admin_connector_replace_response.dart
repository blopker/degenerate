...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_connector.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminConnectorReplaceResponse {const MconnAdminConnectorReplaceResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminConnectorReplaceResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminConnector? result, }) {return MconnAdminConnectorReplaceResponse(
...
@override String toString() {return 'MconnAdminConnectorReplaceResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
