...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_kv_messages2.dart';import 'workers_kv_namespace.dart';final class WorkersKvNamespaceRenameANamespaceResponse {const WorkersKvNamespaceRenameANamespaceResponse({required this.errors, required this.messages, required this.success, required this.result, });
