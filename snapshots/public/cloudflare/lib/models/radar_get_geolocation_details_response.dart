...
import 'radar_get_geolocation_details_response_result.dart';final class RadarGetGeolocationDetailsResponse {const RadarGetGeolocationDetailsResponse({required this.result, required this.success, });
