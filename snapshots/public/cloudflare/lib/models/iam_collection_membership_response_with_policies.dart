...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_membership_with_policies.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionMembershipResponseWithPolicies {const IamCollectionMembershipResponseWithPolicies({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionMembershipResponseWithPolicies copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamMembershipWithPolicies>? Function()? result, }) { return IamCollectionMembershipResponseWithPolicies(
...
@override String toString() { return 'IamCollectionMembershipResponseWithPolicies(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
