...
@immutable
final class ZarazZarazConfigReturnTriggersValueExcludeRules {
  const ZarazZarazConfigReturnTriggersValueExcludeRules({this.zarazLoadRule = const Omittable.absent(),
...
this.zarazElementVisibilityRule = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigReturnTriggersValueExcludeRules._({required this.rawValue, required this.zarazLoadRule,
...
required this.zarazElementVisibilityRule,});
  factory ZarazZarazConfigReturnTriggersValueExcludeRules.fromJson(Object? json) => ZarazZarazConfigReturnTriggersValueExcludeRules._(
...
if (zarazElementVisibilityRule.isPresent) zarazElementVisibilityRule.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigReturnTriggersValueExcludeRules && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigReturnTriggersValueExcludeRules(${toJson()})';
}
