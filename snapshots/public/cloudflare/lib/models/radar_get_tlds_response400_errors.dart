...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetTldsResponse400Errors {const RadarGetTldsResponse400Errors({required this.message});
