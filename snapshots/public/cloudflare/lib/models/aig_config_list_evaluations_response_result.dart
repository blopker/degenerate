...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_list_evaluations_response_result_datasets.dart';import 'aig_config_list_evaluations_response_result_results.dart';@immutable final class AigConfigListEvaluationsResponseResult {const AigConfigListEvaluationsResponseResult({required this.createdAt, required this.datasets, required this.gatewayId, required this.id, required this.modifiedAt, required this.name, required this.processed, required this.results, required this.totalLogs, });
