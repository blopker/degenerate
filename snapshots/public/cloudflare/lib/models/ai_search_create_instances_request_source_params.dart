...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_create_instances_request_source_params_web_crawler.dart';@immutable final class AiSearchCreateInstancesRequestSourceParams {const AiSearchCreateInstancesRequestSourceParams({this.excludeItems, this.includeItems, this.prefix, this.r2Jurisdiction = 'default', this.webCrawler, });

factory AiSearchCreateInstancesRequestSourceParams.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesRequestSourceParams(
  ...
  webCrawler: json['web_crawler'] != null ? AiSearchCreateInstancesRequestSourceParamsWebCrawler.fromJson(json['web_crawler'] as Map<String, dynamic>) : null,
); }
...
final AiSearchCreateInstancesRequestSourceParamsWebCrawler? webCrawler;
...
AiSearchCreateInstancesRequestSourceParams copyWith({List<String> Function()? excludeItems, List<String> Function()? includeItems, String Function()? prefix, String Function()? r2Jurisdiction, AiSearchCreateInstancesRequestSourceParamsWebCrawler Function()? webCrawler, }) { return AiSearchCreateInstancesRequestSourceParams(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AiSearchCreateInstancesRequestSourceParams &&
...
@override String toString() { return 'AiSearchCreateInstancesRequestSourceParams(excludeItems: $excludeItems, includeItems: $includeItems, prefix: $prefix, r2Jurisdiction: $r2Jurisdiction, webCrawler: $webCrawler)'; } 
 }
