...
final class RadarGetHttpTimeseriesGroupByPostQuantumHttpVersion {const RadarGetHttpTimeseriesGroupByPostQuantumHttpVersion._(this.value);
...
@override String toString() { return 'RadarGetHttpTimeseriesGroupByPostQuantumHttpVersion($value)'; } 
 }
