...
import 'mq_http_consumer_request_settings.dart';import 'mq_queue_name.dart';final class MqHttpConsumerRequest {const MqHttpConsumerRequest({this.deadLetterQueue, this.settings, required this.type, });
