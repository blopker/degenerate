...
import 'package:collection/collection.dart';import 'mconn_event_metadata.dart';final class MconnCustomerEventsGetResult {const MconnCustomerEventsGetResult({required this.count, this.cursor, required this.items, });
