...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_ratelimit.dart';import 'firewall_result_info.dart';@immutable final class FirewallRatelimitResponseCollection {const FirewallRatelimitResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() { return 'FirewallRatelimitResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
