...
import 'radar_get_quality_index_timeseries_group_response_result.dart';final class RadarGetQualityIndexTimeseriesGroupResponse {const RadarGetQualityIndexTimeseriesGroupResponse({required this.result, required this.success, });
