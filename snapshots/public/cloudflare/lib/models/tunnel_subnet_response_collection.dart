...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';import 'tunnel_subnet.dart';@immutable final class TunnelSubnetResponseCollection {const TunnelSubnetResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() { return 'TunnelSubnetResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
