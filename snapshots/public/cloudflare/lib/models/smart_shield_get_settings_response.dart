...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'smartshield_messages2.dart';import 'smartshield_smart_shield_settings_get_response.dart';@immutable final class SmartShieldGetSettingsResponse {const SmartShieldGetSettingsResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() {return 'SmartShieldGetSettingsResponse(errors: $errors, messages: $messages, result: $result, success: $success)';}
}
