...
import 'radar_get_bgp_top_prefixes_response_result.dart';final class RadarGetBgpTopPrefixesResponse {const RadarGetBgpTopPrefixesResponse({required this.result, required this.success, });
