...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AigConfigDeleteGatewayLogsResponse400Errors {const AigConfigDeleteGatewayLogsResponse400Errors({required this.message});
