...
import 'radar_get_attacks_layer7_timeseries_group_by_managed_rules_response_result.dart';final class RadarGetAttacksLayer7TimeseriesGroupByManagedRulesResponse {const RadarGetAttacksLayer7TimeseriesGroupByManagedRulesResponse({required this.result, required this.success, });
