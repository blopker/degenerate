...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_dataset_column.dart';import 'dlp_messages2.dart';@immutable final class DlpDatasetsDefineColumnsResponse {const DlpDatasetsDefineColumnsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpDatasetsDefineColumnsResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, List<DlpDatasetColumn>? Function()? result, }) { return DlpDatasetsDefineColumnsResponse(
...
@override String toString() { return 'DlpDatasetsDefineColumnsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
