...
final class DnsRecordsTxtRecordType {const DnsRecordsTxtRecordType._(this.value);
...
static const List<DnsRecordsTxtRecordType> values = [txt];
...
final class DnsRecordsTxtRecord {const DnsRecordsTxtRecord({this.comment, this.name, this.proxied, this.settings, this.tags, this.ttl, this.content, this.type, });
