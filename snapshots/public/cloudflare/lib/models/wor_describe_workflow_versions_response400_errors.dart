...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class WorDescribeWorkflowVersionsResponse400Errors {const WorDescribeWorkflowVersionsResponse400Errors({required this.code, required this.message, });
