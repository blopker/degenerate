...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_profile.dart';import 'dlp_profile.dart';import 'integration_profile.dart';import 'predefined_profile.dart';@immutable final class DlpProfilesUpdatePredefinedProfileResponse {const DlpProfilesUpdatePredefinedProfileResponse({this.result});
...
@override String toString() { return 'DlpProfilesUpdatePredefinedProfileResponse(result: $result)'; } 
 }
