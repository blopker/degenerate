...
final class RadarGetBgpRoutesAsnsResponseResultMeta {const RadarGetBgpRoutesAsnsResponseResultMeta({required this.dataTime, required this.queryTime, required this.totalPeers, });
