...
final class WorkersObservabilityLogs {const WorkersObservabilityLogs({this.destinations, required this.enabled, this.headSamplingRate, required this.invocationLogs, this.persist = true, });
