...
@immutable final class GatewayIdentityProxyEndpointApplicationPoliciesVariant3 {const GatewayIdentityProxyEndpointApplicationPoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory GatewayIdentityProxyEndpointApplicationPoliciesVariant3.fromJson(Map<String, dynamic> json) { return GatewayIdentityProxyEndpointApplicationPoliciesVariant3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GatewayIdentityProxyEndpointApplicationPoliciesVariant3 &&
