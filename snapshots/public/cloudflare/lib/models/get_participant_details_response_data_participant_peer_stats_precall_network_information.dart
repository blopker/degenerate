...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation {const GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation({this.backendRtt, this.effectiveNetworktype, this.fractionalLoss, this.jitter, this.reflexiveConnectivity, this.relayConnectivity, this.rtt, this.throughtput, this.turnConnectivity, });

factory GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation.fromJson(Map<String, dynamic> json) { return GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation(
...
GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation copyWith({double? Function()? backendRtt, String? Function()? effectiveNetworktype, double? Function()? fractionalLoss, double? Function()? jitter, bool? Function()? reflexiveConnectivity, bool? Function()? relayConnectivity, double? Function()? rtt, double? Function()? throughtput, bool? Function()? turnConnectivity, }) { return GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation &&
...
@override String toString() { return 'GetParticipantDetailsResponseDataParticipantPeerStatsPrecallNetworkInformation(backendRtt: $backendRtt, effectiveNetworktype: $effectiveNetworktype, fractionalLoss: $fractionalLoss, jitter: $jitter, reflexiveConnectivity: $reflexiveConnectivity, relayConnectivity: $relayConnectivity, rtt: $rtt, throughtput: $throughtput, turnConnectivity: $turnConnectivity)'; } 
 }
