...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'allow_authenticate_via_warp', 'auth_domain', 'auto_redirect_to_identity', 'custom_pages', 'deny_unmatched_requests', 'deny_unmatched_requests_exempted_zone_names', 'is_ui_read_only', 'login_design', 'mfa_config', 'mfa_required_for_all_apps', 'name', 'session_duration', 'ui_read_only_toggle_reason', 'user_seat_expiration_inactive_time', 'warp_auth_session_duration'}.contains(key)); } 
ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest copyWith({AccessAllowAuthenticateViaWarp Function()? allowAuthenticateViaWarp, AccessAuthDomain Function()? authDomain, AccessAutoRedirectToIdentity Function()? autoRedirectToIdentity, AccessCustomPages Function()? customPages, AccessDenyUnmatchedRequests Function()? denyUnmatchedRequests, List<String> Function()? denyUnmatchedRequestsExemptedZoneNames, AccessIsUiReadOnly Function()? isUiReadOnly, AccessLoginDesign Function()? loginDesign, AccessOrgMfaConfig Function()? mfaConfig, AccessMfaRequiredForAllApps Function()? mfaRequiredForAllApps, AccessName Function()? name, AccessSessionDuration Function()? sessionDuration, AccessUiReadOnlyToggleReason Function()? uiReadOnlyToggleReason, AccessUserSeatExpirationInactiveTime Function()? userSeatExpirationInactiveTime, AccessWarpAuthSessionDuration Function()? warpAuthSessionDuration, }) { return ZeroTrustOrganizationUpdateYourZeroTrustOrganizationRequest(
