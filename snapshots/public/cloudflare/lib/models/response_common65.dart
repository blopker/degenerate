...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'speed_messages2.dart';@immutable final class ResponseCommon65 {const ResponseCommon65({required this.errors, required this.messages, required this.success, });
