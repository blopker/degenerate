...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ai_inference_timeseries_group_response400_errors.dart';final class RadarGetAiInferenceTimeseriesGroupResponse400 {const RadarGetAiInferenceTimeseriesGroupResponse400({required this.errors, required this.result, required this.success, });
