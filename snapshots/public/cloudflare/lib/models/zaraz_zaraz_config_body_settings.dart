...
factory ZarazZarazConfigBodySettings.fromJson(Map<String, dynamic> json) { return ZarazZarazConfigBodySettings(
  ...
  contextEnricher: json['contextEnricher'] != null ? ZarazZarazConfigBodySettingsContextEnricher.fromJson(json['contextEnricher'] as Map<String, dynamic>) : null,
...
final ZarazZarazConfigBodySettingsContextEnricher? contextEnricher;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ZarazZarazConfigBodySettings &&
...
@override String toString() { return 'ZarazZarazConfigBodySettings(autoInjectScript: $autoInjectScript, contextEnricher: $contextEnricher, cookieDomain: $cookieDomain, ecommerce: $ecommerce, eventsApiPath: $eventsApiPath, hideExternalReferer: $hideExternalReferer, hideIpAddress: $hideIpAddress, hideQueryParams: $hideQueryParams, hideUserAgent: $hideUserAgent, initPath: $initPath, injectIframes: $injectIframes, mcRootPath: $mcRootPath, scriptPath: $scriptPath, trackPath: $trackPath)'; } 
 }
