...
@immutable final class ZonesSchemasBrowserCacheTtl {const ZonesSchemasBrowserCacheTtl({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasBrowserCacheTtl copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesBrowserCacheTtlValue? value, }) { return ZonesSchemasBrowserCacheTtl(
