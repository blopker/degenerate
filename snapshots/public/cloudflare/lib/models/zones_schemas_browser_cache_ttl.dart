...
@immutable final class ZonesSchemasBrowserCacheTtl {const ZonesSchemasBrowserCacheTtl({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
