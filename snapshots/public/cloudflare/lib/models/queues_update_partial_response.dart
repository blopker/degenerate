...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';import 'mq_queue.dart';@immutable final class QueuesUpdatePartialResponse {const QueuesUpdatePartialResponse({this.errors, this.messages, this.success, this.result, });

factory QueuesUpdatePartialResponse.fromJson(Map<String, dynamic> json) { return QueuesUpdatePartialResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is QueuesUpdatePartialResponse &&
...
@override String toString() { return 'QueuesUpdatePartialResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
