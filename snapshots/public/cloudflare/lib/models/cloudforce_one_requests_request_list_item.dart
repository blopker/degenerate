...
import 'cloudforce_one_requests_priority.dart';import 'cloudforce_one_requests_request_readable_id.dart';import 'cloudforce_one_requests_request_status.dart';import 'cloudforce_one_requests_request_summary.dart';import 'cloudforce_one_requests_request_type.dart';import 'cloudforce_one_requests_time.dart';import 'cloudforce_one_requests_tlp.dart';import 'cloudforce_one_requests_uuid.dart';final class CloudforceOneRequestsRequestListItem {const CloudforceOneRequestsRequestListItem({this.completed, required this.created, required this.id, this.messageTokens, required this.priority, this.readableId, required this.request, this.status, required this.summary, required this.tlp, this.tokens, required this.updated, });
