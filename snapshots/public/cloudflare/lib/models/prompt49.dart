...
import 'prompt49_response_format.dart';final class Prompt49 {const Prompt49({this.frequencyPenalty, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });
...
factory Prompt49.fromJson(Map<String, dynamic> json) { return Prompt49(
  ...
  responseFormat: json['response_format'] != null ? Prompt49ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final Prompt49ResponseFormat? responseFormat;
