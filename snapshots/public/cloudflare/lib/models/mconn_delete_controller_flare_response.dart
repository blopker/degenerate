...
factory MconnDeleteControllerFlareResponse.fromJson(Map<String, dynamic> json) {return MconnDeleteControllerFlareResponse(
  ...
  result: MconnControllerFlare.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnDeleteControllerFlareResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerFlare? result, }) {return MconnDeleteControllerFlareResponse(
...
@override String toString() {return 'MconnDeleteControllerFlareResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
