...
return  PatchEventQueryAlertUpdateError400(PatchEventQueryAlertUpdateResponse400.fromJson(json as Map<String, dynamic>));case 404:
final json = jsonDecode(response.body);
return  PatchEventQueryAlertUpdateError404(PatchEventQueryAlertUpdateResponse404.fromJson(json as Map<String, dynamic>));default:
