...
final class BrapiPostScreenshotRequestVariant2AddScriptTag {const BrapiPostScreenshotRequestVariant2AddScriptTag({this.content, this.id, this.type, this.url, });
