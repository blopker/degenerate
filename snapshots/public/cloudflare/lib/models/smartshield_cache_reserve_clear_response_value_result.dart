...
final class SmartshieldCacheReserveClearResponseValueResult {const SmartshieldCacheReserveClearResponseValueResult({this.endTs, required this.startTs, required this.state, });
