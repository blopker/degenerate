...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'digital_experience_monitoring_fleet_status_live_response_result.dart';import 'digital_experience_monitoring_messages2.dart';@immutable final class DigitalExperienceMonitoringFleetStatusLiveResponse {const DigitalExperienceMonitoringFleetStatusLiveResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DigitalExperienceMonitoringFleetStatusLiveResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, DigitalExperienceMonitoringFleetStatusLiveResponseResult? Function()? result, }) { return DigitalExperienceMonitoringFleetStatusLiveResponse(
...
@override String toString() { return 'DigitalExperienceMonitoringFleetStatusLiveResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
