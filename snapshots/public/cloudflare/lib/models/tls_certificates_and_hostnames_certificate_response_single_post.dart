...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_certificate_object_post.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesCertificateResponseSinglePost {const TlsCertificatesAndHostnamesCertificateResponseSinglePost({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'TlsCertificatesAndHostnamesCertificateResponseSinglePost(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
