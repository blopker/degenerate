...
final class AddParticipantRequest {const AddParticipantRequest({required this.customParticipantId, this.name, this.picture, this.presetName = 'group_call_host', });
