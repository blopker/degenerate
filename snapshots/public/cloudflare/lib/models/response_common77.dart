...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waitingroom_messages2.dart';@immutable final class ResponseCommon77 {const ResponseCommon77({required this.errors, required this.messages, required this.success, });
