...
import 'radar_get_email_security_timeseries_group_by_spoof_response_result.dart';final class RadarGetEmailSecurityTimeseriesGroupBySpoofResponse {const RadarGetEmailSecurityTimeseriesGroupBySpoofResponse({required this.result, required this.success, });
...
@override String toString() { return 'RadarGetEmailSecurityTimeseriesGroupBySpoofResponse(result: $result, success: $success)'; } 
 }
