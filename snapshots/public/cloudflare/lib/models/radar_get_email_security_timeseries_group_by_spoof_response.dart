...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_email_security_timeseries_group_by_spoof_response_result.dart';@immutable final class RadarGetEmailSecurityTimeseriesGroupBySpoofResponse {const RadarGetEmailSecurityTimeseriesGroupBySpoofResponse({required this.result, required this.success, });
