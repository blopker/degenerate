...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_email_security_summary_by_spoof_response400_errors.dart';final class RadarGetEmailSecuritySummaryBySpoofResponse400 {const RadarGetEmailSecuritySummaryBySpoofResponse400({required this.errors, required this.result, required this.success, });
