...
import 'radar_get_post_quantum_tls_support_response_result.dart';final class RadarGetPostQuantumTlsSupportResponse {const RadarGetPostQuantumTlsSupportResponse({required this.result, required this.success, });
