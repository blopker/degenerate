...
factory MconnAdminMacrosReportExceptionSuccess.fromJson(Map<String, dynamic> json) { return MconnAdminMacrosReportExceptionSuccess(
  ...
  result: MconnAdminMacrosReportExceptionResult.fromJson(json['result'] as Map<String, dynamic>),
); }
...
MconnAdminMacrosReportExceptionSuccess copyWith({List<MconnCodedMessage> Function()? errors, List<MconnCodedMessage> Function()? messages, bool? success, MconnAdminMacrosReportExceptionResult? result, }) { return MconnAdminMacrosReportExceptionSuccess(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is MconnAdminMacrosReportExceptionSuccess &&
...
@override String toString() { return 'MconnAdminMacrosReportExceptionSuccess(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
