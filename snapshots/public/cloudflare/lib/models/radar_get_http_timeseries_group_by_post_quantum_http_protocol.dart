...
final class RadarGetHttpTimeseriesGroupByPostQuantumHttpProtocol {const RadarGetHttpTimeseriesGroupByPostQuantumHttpProtocol._(this.value);
...
@override String toString() { return 'RadarGetHttpTimeseriesGroupByPostQuantumHttpProtocol($value)'; } 
 }
