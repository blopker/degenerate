...
import 'dns_firewall_dns_firewall_cluster_response.dart';final class DnsFirewallDnsFirewallSingleResponse {const DnsFirewallDnsFirewallSingleResponse({this.result});
