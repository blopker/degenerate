...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer3_timeseries_group_by_bitrate_response400_errors.dart';final class RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse400 {const RadarGetAttacksLayer3TimeseriesGroupByBitrateResponse400({required this.errors, required this.result, required this.success, });
