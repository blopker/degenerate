...
import 'ai_search_create_instances_response_result.dart';final class AiSearchCreateInstancesResponse {const AiSearchCreateInstancesResponse({required this.result, required this.success, });
