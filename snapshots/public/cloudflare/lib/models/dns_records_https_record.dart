...
final class DnsRecordsHttpsRecordType {const DnsRecordsHttpsRecordType._(this.value);
...
final class DnsRecordsHttpsRecord {const DnsRecordsHttpsRecord({this.comment, this.name, this.proxied, this.settings, this.tags, this.ttl, this.content, this.data, this.type, });
