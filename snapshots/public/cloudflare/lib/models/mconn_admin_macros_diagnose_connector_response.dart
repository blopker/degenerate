...
import 'mconn_admin_macros_diagnose_connector_result.dart';final class MconnAdminMacrosDiagnoseConnectorResponse {const MconnAdminMacrosDiagnoseConnectorResponse({this.result});
