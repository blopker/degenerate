...
final class WorSendEventWorkflowInstanceResponse400Errors {const WorSendEventWorkflowInstanceResponse400Errors({required this.code, required this.message, });
