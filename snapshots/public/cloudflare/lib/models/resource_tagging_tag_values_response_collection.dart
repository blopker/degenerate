...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'resource_tagging_cursor_result_info.dart';import 'resource_tagging_messages2.dart';final class ResourceTaggingTagValuesResponseCollection {const ResourceTaggingTagValuesResponseCollection({required this.errors, required this.messages, required this.success, this.result, this.resultInfo, });
