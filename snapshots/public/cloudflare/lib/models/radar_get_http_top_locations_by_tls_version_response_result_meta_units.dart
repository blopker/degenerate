...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpTopLocationsByTlsVersionResponseResultMetaUnits {const RadarGetHttpTopLocationsByTlsVersionResponseResultMetaUnits({required this.name, required this.value, });
