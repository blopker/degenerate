...
final Map<String,Messages24ToolsVariant1ParametersPropertiesValue> properties;
...
Messages24ToolsVariant1Parameters copyWith({Map<String,Messages24ToolsVariant1ParametersPropertiesValue>? properties, List<String> Function()? $required, String? type, }) { return Messages24ToolsVariant1Parameters(
  properties: properties ?? this.properties,
  $required: $required != null ? $required() : this.$required,
  type: type ?? this.type,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Messages24ToolsVariant1Parameters &&
...
@override String toString() { return 'Messages24ToolsVariant1Parameters(properties: $properties, \$required: ${$required}, type: $type)'; } 
 }
