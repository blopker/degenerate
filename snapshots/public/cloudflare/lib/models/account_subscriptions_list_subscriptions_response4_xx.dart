...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages5.dart';import 'result_info.dart';@immutable final class AccountSubscriptionsListSubscriptionsResponse4Xx {const AccountSubscriptionsListSubscriptionsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
@override String toString() { return 'AccountSubscriptionsListSubscriptionsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
