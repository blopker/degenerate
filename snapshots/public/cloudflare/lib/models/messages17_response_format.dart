...
final class Messages17ResponseFormatType {const Messages17ResponseFormatType._(this.value);
...
final class Messages17ResponseFormat {const Messages17ResponseFormat({this.jsonSchema, this.type, });
