...
factory UrlscannerSearchScansResponse2Results.fromJson(Map<String, dynamic> json) { return UrlscannerSearchScansResponse2Results(
  ...
  page: UrlscannerSearchScansResponse2ResultsPage.fromJson(json['page'] as Map<String, dynamic>),
  result: json['result'] as String,
  stats: UrlscannerSearchScansResponse2ResultsStats.fromJson(json['stats'] as Map<String, dynamic>),
  task: UrlscannerSearchScansResponse2ResultsTask.fromJson(json['task'] as Map<String, dynamic>),
  verdicts: UrlscannerSearchScansResponse2ResultsVerdicts.fromJson(json['verdicts'] as Map<String, dynamic>),
); }
...
UrlscannerSearchScansResponse2Results copyWith({String? id, UrlscannerSearchScansResponse2ResultsPage? page, String? result, UrlscannerSearchScansResponse2ResultsStats? stats, UrlscannerSearchScansResponse2ResultsTask? task, UrlscannerSearchScansResponse2ResultsVerdicts? verdicts, }) { return UrlscannerSearchScansResponse2Results(
  id: id ?? this.id,
  page: page ?? this.page,
