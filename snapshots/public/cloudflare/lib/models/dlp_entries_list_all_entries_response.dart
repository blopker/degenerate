...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_entry_with_upload_status.dart';import 'dlp_messages2.dart';@immutable final class DlpEntriesListAllEntriesResponse {const DlpEntriesListAllEntriesResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpEntriesListAllEntriesResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, List<DlpEntryWithUploadStatus>? Function()? result, }) { return DlpEntriesListAllEntriesResponse(
...
@override String toString() { return 'DlpEntriesListAllEntriesResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
