...
import 'workers_ai_list_finetunes_response_result.dart';final class WorkersAiListFinetunesResponse {const WorkersAiListFinetunesResponse({required this.result, required this.success, });
