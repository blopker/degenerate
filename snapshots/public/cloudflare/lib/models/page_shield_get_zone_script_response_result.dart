...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'page_shield_cryptomining_score.dart';import 'page_shield_dataflow_score.dart';import 'page_shield_fetched_at.dart';import 'page_shield_hash.dart';import 'page_shield_id.dart';import 'page_shield_js_integrity_score.dart';import 'page_shield_magecart_score.dart';import 'page_shield_malware_score.dart';import 'page_shield_obfuscation_score.dart';import 'page_shield_version.dart';final class PageShieldGetZoneScriptResponseResult {const PageShieldGetZoneScriptResponseResult({required this.addedAt, this.cryptominingScore, this.dataflowScore, this.domainReportedMalicious, this.fetchedAt, this.firstPageUrl, required this.firstSeenAt, this.hash, required this.host, required this.id, this.jsIntegrityScore, required this.lastSeenAt, this.magecartScore, this.maliciousDomainCategories, this.maliciousUrlCategories, this.malwareScore, this.obfuscationScore, this.pageUrls, required this.url, required this.urlContainsCdnCgiPath, this.urlReportedMalicious, this.versions, });
