...
@immutable
final class Responses2Input {
  const Responses2Input({this.string = const Omittable.absent(),
this.listdynamic = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Responses2Input._({required this.rawValue, required this.string,
required this.listdynamic,});
  factory Responses2Input.fromJson(Object? json) => Responses2Input._(
...
if (listdynamic.isPresent) listdynamic.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Responses2Input && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Responses2Input(${toJson()})';
}
