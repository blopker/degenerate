...
final class RadarGetHttpTopAsesByBrowserFamilyResponseResultTop0 {const RadarGetHttpTopAsesByBrowserFamilyResponseResultTop0({required this.clientAsn, required this.clientAsName, required this.value, });
