...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zaraz_messages2.dart';import 'zaraz_zaraz_config_history_response_result_value.dart';final class ZarazZarazConfigHistoryResponse {const ZarazZarazConfigHistoryResponse({required this.errors, required this.messages, required this.success, required this.result, });
