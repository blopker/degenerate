...
@immutable final class ZonesH2Prioritization {const ZonesH2Prioritization({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
