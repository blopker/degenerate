...
final class UrlscannerCreateScanBulkResponse400Errors {const UrlscannerCreateScanBulkResponse400Errors({required this.detail, required this.status, required this.title, });
