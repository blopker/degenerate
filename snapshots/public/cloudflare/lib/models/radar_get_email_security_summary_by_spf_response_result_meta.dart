...
final class RadarGetEmailSecuritySummaryBySpfResponseResultMetaNormalization {const RadarGetEmailSecuritySummaryBySpfResponseResultMetaNormalization._(this.value);
...
final class RadarGetEmailSecuritySummaryBySpfResponseResultMeta {const RadarGetEmailSecuritySummaryBySpfResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
