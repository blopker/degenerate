...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_top_ases_by_device_type_response_result_meta.dart';import 'radar_get_http_top_ases_by_device_type_response_result_top0.dart';@immutable final class RadarGetHttpTopAsesByDeviceTypeResponseResult {const RadarGetHttpTopAsesByDeviceTypeResponseResult({required this.meta, required this.top0, });
