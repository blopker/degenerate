...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';import 'access_reusable_policies_components_schemas_id_response_result.dart';@immutable final class AccessReusablePoliciesComponentsSchemasIdResponse {const AccessReusablePoliciesComponentsSchemasIdResponse({required this.errors, required this.messages, required this.success, this.result, });
...
AccessReusablePoliciesComponentsSchemasIdResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, AccessReusablePoliciesComponentsSchemasIdResponseResult? Function()? result, }) { return AccessReusablePoliciesComponentsSchemasIdResponse(
...
@override String toString() { return 'AccessReusablePoliciesComponentsSchemasIdResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
