...
UpdatePortalsResponse404Errors copyWith({double? code, String? message, }) { return UpdatePortalsResponse404Errors(
  code: code ?? this.code,
...
@override String toString() { return 'UpdatePortalsResponse404Errors(code: $code, message: $message)'; } 
 }
