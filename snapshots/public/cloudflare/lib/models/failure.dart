...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model22.dart';@immutable final class Failure {const Failure({this.errors, this.messages, this.success, });
