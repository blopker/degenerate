...
MconnAdminConnectorDeleteResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminConnector? result, }) {return MconnAdminConnectorDeleteResponse(
...
@override String toString() {return 'MconnAdminConnectorDeleteResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
