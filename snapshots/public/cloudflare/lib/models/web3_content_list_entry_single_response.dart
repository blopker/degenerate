...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'web3_content_list_entry.dart';import 'web3_content_list_entry_single_response_result_info.dart';import 'web3_messages2.dart';@immutable final class Web3ContentListEntrySingleResponse {const Web3ContentListEntrySingleResponse({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
final Web3ContentListEntrySingleResponseResultInfo? resultInfo;
