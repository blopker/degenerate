...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_app_types.dart';import 'zero_trust_gateway_application.dart';import 'zero_trust_gateway_application_type.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_result_info.dart';@immutable final class ZeroTrustGatewayAppTypesComponentsSchemasResponseCollection {const ZeroTrustGatewayAppTypesComponentsSchemasResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
@override String toString() { return 'ZeroTrustGatewayAppTypesComponentsSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
