...
final class BrapiPostPdfRequestVariant1Viewport {const BrapiPostPdfRequestVariant1Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });
