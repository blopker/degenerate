...
@immutable final class BrapiPostPdfRequestVariant1Viewport {const BrapiPostPdfRequestVariant1Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostPdfRequestVariant1Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant1Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostPdfRequestVariant1Viewport &&
...
@override String toString() { return 'BrapiPostPdfRequestVariant1Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
