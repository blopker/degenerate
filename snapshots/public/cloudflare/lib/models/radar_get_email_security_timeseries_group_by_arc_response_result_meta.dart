...
@immutable final class RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMetaAggInterval {const RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMetaNormalization {const RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMeta {const RadarGetEmailSecurityTimeseriesGroupByArcResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
