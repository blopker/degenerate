...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_messages2.dart';@immutable final class DlpRiskScoreResetPostResponse {const DlpRiskScoreResetPostResponse({required this.errors, required this.messages, required this.success, this.result = const Omittable.absent(), });
...
DlpRiskScoreResetPostResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, Omittable<Map<String,dynamic>?>? result, }) { return DlpRiskScoreResetPostResponse(
...
@override String toString() { return 'DlpRiskScoreResetPostResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
