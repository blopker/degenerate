...
import 'email_security_disposition_label.dart';final class EmailSecurityAttachment {const EmailSecurityAttachment({this.contentType, this.detection, this.encrypted, this.name, required this.size, });
