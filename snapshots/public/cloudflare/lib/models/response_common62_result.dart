...
@immutable
final class ResponseCommon62Result {
  const ResponseCommon62Result({this.mapStringdynamic = const Omittable.absent(),
this.listdynamic = const Omittable.absent(),
this.string = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseCommon62Result._({required this.rawValue, required this.mapStringdynamic,
required this.listdynamic,
required this.string,});
  factory ResponseCommon62Result.fromJson(Object? json) => ResponseCommon62Result._(
...
if (string.isPresent) string.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseCommon62Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseCommon62Result(${toJson()})';
}
