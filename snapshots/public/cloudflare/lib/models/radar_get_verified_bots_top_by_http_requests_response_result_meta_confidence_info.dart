...
final List<RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfoAnnotations> annotations;
...
RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfo copyWith({List<RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfoAnnotations>? annotations, int? level, }) { return RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfo(
  annotations: annotations ?? this.annotations,
  level: level ?? this.level,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfo &&
          listEquals(annotations, other.annotations) &&
          level == other.level; } 
@override int get hashCode { return Object.hash(Object.hashAll(annotations), level); } 
@override String toString() { return 'RadarGetVerifiedBotsTopByHttpRequestsResponseResultMetaConfidenceInfo(annotations: $annotations, level: $level)'; } 
 }
