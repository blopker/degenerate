...
@immutable final class BrowserRdpApplication3PoliciesVariant3 {const BrowserRdpApplication3PoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory BrowserRdpApplication3PoliciesVariant3.fromJson(Map<String, dynamic> json) { return BrowserRdpApplication3PoliciesVariant3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrowserRdpApplication3PoliciesVariant3 &&
