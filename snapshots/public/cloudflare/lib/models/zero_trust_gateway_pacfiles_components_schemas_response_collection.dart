...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_pacfiles_components_schemas_response_collection_result.dart';import 'zero_trust_gateway_result_info.dart';@immutable final class ZeroTrustGatewayPacfilesComponentsSchemasResponseCollection {const ZeroTrustGatewayPacfilesComponentsSchemasResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
ZeroTrustGatewayPacfilesComponentsSchemasResponseCollection copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayResultInfo? Function()? resultInfo, List<ZeroTrustGatewayPacfilesComponentsSchemasResponseCollectionResult>? Function()? result, }) { return ZeroTrustGatewayPacfilesComponentsSchemasResponseCollection(
...
@override String toString() { return 'ZeroTrustGatewayPacfilesComponentsSchemasResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
