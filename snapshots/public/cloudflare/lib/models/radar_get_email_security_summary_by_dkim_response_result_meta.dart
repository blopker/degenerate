...
@immutable final class RadarGetEmailSecuritySummaryByDkimResponseResultMetaNormalization {const RadarGetEmailSecuritySummaryByDkimResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetEmailSecuritySummaryByDkimResponseResultMeta {const RadarGetEmailSecuritySummaryByDkimResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
