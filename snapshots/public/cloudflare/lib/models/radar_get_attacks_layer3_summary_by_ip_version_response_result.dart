...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer3_summary_by_ip_version_response_result_meta.dart';import 'radar_get_attacks_layer3_summary_by_ip_version_response_result_summary0.dart';@immutable final class RadarGetAttacksLayer3SummaryByIpVersionResponseResult {const RadarGetAttacksLayer3SummaryByIpVersionResponseResult({required this.meta, required this.summary0, });
