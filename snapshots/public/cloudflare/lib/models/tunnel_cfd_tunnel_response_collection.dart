...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tunnel_cfd_tunnel.dart';import 'tunnel_messages2.dart';import 'tunnel_result_info.dart';@immutable final class TunnelCfdTunnelResponseCollection {const TunnelCfdTunnelResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TunnelCfdTunnelResponseCollection copyWith({List<TunnelMessages2>? errors, List<TunnelMessages2>? messages, List<TunnelCfdTunnel>? result, bool? success, TunnelResultInfo? Function()? resultInfo, }) { return TunnelCfdTunnelResponseCollection(
...
@override String toString() { return 'TunnelCfdTunnelResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
