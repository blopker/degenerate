...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'security_center_messages2.dart';@immutable final class ResponseCommon61 {const ResponseCommon61({required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ResponseCommon61(errors: $errors, messages: $messages, success: $success)'; } 
 }
