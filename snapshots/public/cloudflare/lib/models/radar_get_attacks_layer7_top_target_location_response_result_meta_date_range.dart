...
final class RadarGetAttacksLayer7TopTargetLocationResponseResultMetaDateRange {const RadarGetAttacksLayer7TopTargetLocationResponseResultMetaDateRange({required this.endTime, required this.startTime, });
