...
@immutable final class AccessSchemasAzureAdScimConfig {const AccessSchemasAzureAdScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessSchemasAzureAdScimConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasAzureAdScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessSchemasAzureAdScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
/// The value with the schema default applied when absent.
AccessSchemasAzureAdScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault { return identityUpdateBehavior ?? AccessSchemasAzureAdScimConfigIdentityUpdateBehavior.fromJson('no_action'); } 
/// The value with the schema default applied when absent.
