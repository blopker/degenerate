...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class RadarGetDnsTimeseriesGroupByResponseCodeResponseResultSerie0 {const RadarGetDnsTimeseriesGroupByResponseCodeResponseResultSerie0({required this.timestamps});
...
RadarGetDnsTimeseriesGroupByResponseCodeResponseResultSerie0 copyWith({List<DateTime>? timestamps}) { return RadarGetDnsTimeseriesGroupByResponseCodeResponseResultSerie0(
...
@override String toString() { return 'RadarGetDnsTimeseriesGroupByResponseCodeResponseResultSerie0(timestamps: $timestamps)'; } 
 }
