...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_dns_timeseries_group_by_dnssec_response_result_meta.dart';import 'radar_get_dns_timeseries_group_by_dnssec_response_result_serie0.dart';@immutable final class RadarGetDnsTimeseriesGroupByDnssecResponseResult {const RadarGetDnsTimeseriesGroupByDnssecResponseResult({required this.meta, required this.serie0, });
