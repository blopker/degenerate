...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_target_industry_list_by_dataset_response400_errors.dart';final class GetTargetIndustryListByDatasetResponse400 {const GetTargetIndustryListByDatasetResponse400({required this.errors, required this.result, required this.success, });
