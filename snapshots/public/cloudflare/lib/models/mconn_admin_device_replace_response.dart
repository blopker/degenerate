...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_device.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminDeviceReplaceResponse {const MconnAdminDeviceReplaceResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminDeviceReplaceResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminDevice? result, }) {return MconnAdminDeviceReplaceResponse(
...
@override String toString() {return 'MconnAdminDeviceReplaceResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
