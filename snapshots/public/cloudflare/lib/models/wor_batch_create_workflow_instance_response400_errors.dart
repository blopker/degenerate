...
final class WorBatchCreateWorkflowInstanceResponse400Errors {const WorBatchCreateWorkflowInstanceResponse400Errors({required this.code, required this.message, });
