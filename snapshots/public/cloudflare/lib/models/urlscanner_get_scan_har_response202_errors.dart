...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class UrlscannerGetScanHarResponse202Errors {const UrlscannerGetScanHarResponse202Errors({required this.message});
