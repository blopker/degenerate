...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class RadarGetRankingDomainTimeseriesResponseResultSerie0 {const RadarGetRankingDomainTimeseriesResponseResultSerie0({required this.timestamps});
...
RadarGetRankingDomainTimeseriesResponseResultSerie0 copyWith({List<DateTime>? timestamps}) { return RadarGetRankingDomainTimeseriesResponseResultSerie0(
...
@override String toString() { return 'RadarGetRankingDomainTimeseriesResponseResultSerie0(timestamps: $timestamps)'; } 
 }
