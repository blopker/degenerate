...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'page_shield_connection.dart';import 'page_shield_messages2.dart';@immutable final class PageShieldGetZoneConnectionResponse {const PageShieldGetZoneConnectionResponse({required this.success, required this.result, this.errors, this.messages, });
...
PageShieldGetZoneConnectionResponse copyWith({List<PageShieldMessages2>? Function()? errors, List<PageShieldMessages2>? Function()? messages, bool? success, PageShieldConnection? result, }) { return PageShieldGetZoneConnectionResponse(
...
@override String toString() { return 'PageShieldGetZoneConnectionResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
