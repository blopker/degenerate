...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetEmailRoutingSummaryResponse400Errors {const RadarGetEmailRoutingSummaryResponse400Errors({required this.message});
