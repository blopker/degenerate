...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_apps_components_schemas_name.dart';import 'access_apps_components_schemas_session_duration.dart';import 'access_components_schemas_domain.dart';import 'access_schemas_auto_redirect_to_identity.dart';import 'access_schemas_scim_config.dart';import 'access_timestamp.dart';import 'access_uuid.dart';@immutable final class BrowserIsolationPermissionsApplication5 {const BrowserIsolationPermissionsApplication5({required this.type, this.createdAt, this.id, this.scimConfig, this.updatedAt, this.allowedIdps, this.autoRedirectToIdentity, this.domain, this.name, this.sessionDuration, });

factory BrowserIsolationPermissionsApplication5.fromJson(Map<String, dynamic> json) { return BrowserIsolationPermissionsApplication5(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrowserIsolationPermissionsApplication5 &&
...
@override String toString() { return 'BrowserIsolationPermissionsApplication5(createdAt: $createdAt, id: $id, scimConfig: $scimConfig, updatedAt: $updatedAt, allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type)'; } 
 }
