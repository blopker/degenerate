...
@immutable final class ZonesSchemasEdgeCacheTtl {const ZonesSchemasEdgeCacheTtl({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasEdgeCacheTtl copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesEdgeCacheTtlValue? value, }) { return ZonesSchemasEdgeCacheTtl(
