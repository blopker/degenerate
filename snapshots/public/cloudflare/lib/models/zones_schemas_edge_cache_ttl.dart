...
@immutable final class ZonesSchemasEdgeCacheTtl {const ZonesSchemasEdgeCacheTtl({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
