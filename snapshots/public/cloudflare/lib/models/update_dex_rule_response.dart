...
UpdateDexRuleResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, DigitalExperienceMonitoringDexRule? Function()? result, }) { return UpdateDexRuleResponse(
...
@override String toString() { return 'UpdateDexRuleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
