...
@immutable final class ZonesSchemasSsl {const ZonesSchemasSsl({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesSchemasSsl copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesSslValue? value, }) { return ZonesSchemasSsl(
