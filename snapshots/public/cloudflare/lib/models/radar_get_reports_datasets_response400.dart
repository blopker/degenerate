...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_reports_datasets_response400_errors.dart';final class RadarGetReportsDatasetsResponse400 {const RadarGetReportsDatasetsResponse400({required this.errors, required this.result, required this.success, });
