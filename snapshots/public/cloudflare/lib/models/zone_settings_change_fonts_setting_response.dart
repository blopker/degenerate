...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'speed_base.dart';import 'speed_messages2.dart';final class ZoneSettingsChangeFontsSettingResponse {const ZoneSettingsChangeFontsSettingResponse({required this.errors, required this.messages, required this.success, this.result, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ZoneSettingsChangeFontsSettingResponse &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success &&
          result == other.result; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result); } 
@override String toString() { return 'ZoneSettingsChangeFontsSettingResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
