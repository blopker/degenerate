...
WorDeleteWorkflowResponse404Errors copyWith({double? code, String? message, }) { return WorDeleteWorkflowResponse404Errors(
  code: code ?? this.code,
  message: message ?? this.message,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorDeleteWorkflowResponse404Errors &&
          code == other.code &&
          message == other.message; } 
@override int get hashCode { return Object.hash(code, message); } 
@override String toString() { return 'WorDeleteWorkflowResponse404Errors(code: $code, message: $message)'; } 
 }
