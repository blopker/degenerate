...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_indicator_feeds_indicator_feed_item.dart';import 'custom_indicator_feeds_schemas_messages2.dart';@immutable final class CustomIndicatorFeedsCreateFeedResponse {const CustomIndicatorFeedsCreateFeedResponse({required this.errors, required this.messages, required this.success, this.result, });
...
CustomIndicatorFeedsCreateFeedResponse copyWith({List<CustomIndicatorFeedsSchemasMessages2>? errors, List<CustomIndicatorFeedsSchemasMessages2>? messages, bool? success, CustomIndicatorFeedsIndicatorFeedItem? Function()? result, }) { return CustomIndicatorFeedsCreateFeedResponse(
...
@override String toString() { return 'CustomIndicatorFeedsCreateFeedResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
