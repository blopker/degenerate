...
factory EmailSecurityUpdateBlockedSenderResponse.fromJson(Map<String, dynamic> json) { return EmailSecurityUpdateBlockedSenderResponse(
  ...
  result: EmailSecurityUpdateBlockedSenderResponseResult.fromJson(json['result'] as Map<String, dynamic>),
); }
...
final EmailSecurityUpdateBlockedSenderResponseResult result;
...
EmailSecurityUpdateBlockedSenderResponse copyWith({List<EmailSecurityMessage>? errors, List<EmailSecurityMessage>? messages, bool? success, EmailSecurityUpdateBlockedSenderResponseResult? result, }) { return EmailSecurityUpdateBlockedSenderResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EmailSecurityUpdateBlockedSenderResponse &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success &&
          result == other.result; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result); } 
@override String toString() { return 'EmailSecurityUpdateBlockedSenderResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
