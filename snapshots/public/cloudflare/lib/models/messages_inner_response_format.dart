...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class MessagesInnerResponseFormatType {const MessagesInnerResponseFormatType._(this.value);
...
@immutable final class MessagesInnerResponseFormat {const MessagesInnerResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
MessagesInnerResponseFormat copyWith({Omittable<dynamic>? jsonSchema, MessagesInnerResponseFormatType? Function()? type, }) { return MessagesInnerResponseFormat(
