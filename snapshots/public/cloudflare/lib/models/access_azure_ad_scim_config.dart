...
@immutable final class AccessAzureAdScimConfig {const AccessAzureAdScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessAzureAdScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessAzureAdScimConfig.fromJson(Map<String, dynamic> json) { return AccessAzureAdScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessAzureAdScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessAzureAdScimConfigIdentityUpdateBehavior.noAction,
