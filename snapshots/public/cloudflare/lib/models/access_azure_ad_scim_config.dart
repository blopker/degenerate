...
@immutable final class AccessAzureAdScimConfigIdentityUpdateBehavior {const AccessAzureAdScimConfigIdentityUpdateBehavior._(this.value);

factory AccessAzureAdScimConfigIdentityUpdateBehavior.fromJson(String json) {return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessAzureAdScimConfigIdentityUpdateBehavior._(json),
};}

static const AccessAzureAdScimConfigIdentityUpdateBehavior automatic = AccessAzureAdScimConfigIdentityUpdateBehavior._('automatic');

static const AccessAzureAdScimConfigIdentityUpdateBehavior reauth = AccessAzureAdScimConfigIdentityUpdateBehavior._('reauth');

static const AccessAzureAdScimConfigIdentityUpdateBehavior noAction = AccessAzureAdScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessAzureAdScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is AccessAzureAdScimConfigIdentityUpdateBehavior && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'AccessAzureAdScimConfigIdentityUpdateBehavior($value)';}
}
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessAzureAdScimConfig {const AccessAzureAdScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessAzureAdScimConfig.fromJson(Map<String, dynamic> json) {return AccessAzureAdScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessAzureAdScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessAzureAdScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessAzureAdScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessAzureAdScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessAzureAdScimConfig copyWith({bool? Function()? enabled, AccessAzureAdScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessAzureAdScimConfig(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AccessAzureAdScimConfig &&
...
@override String toString() {return 'AccessAzureAdScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
