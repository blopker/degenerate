...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_recorded_event.dart';final class MconnCustomerEventGetSuccess {const MconnCustomerEventGetSuccess({this.errors, this.messages, required this.success, required this.result, });
