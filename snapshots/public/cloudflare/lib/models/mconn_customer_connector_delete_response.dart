...
MconnCustomerConnectorDeleteResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnCustomerConnector? result, }) {return MconnCustomerConnectorDeleteResponse(
...
@override String toString() {return 'MconnCustomerConnectorDeleteResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
