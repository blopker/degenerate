...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_messages2.dart';import 'workers_placement_regions_response.dart';final class WorkerPlacementListRegionsResponse {const WorkerPlacementListRegionsResponse({required this.errors, required this.messages, required this.success, required this.result, });
