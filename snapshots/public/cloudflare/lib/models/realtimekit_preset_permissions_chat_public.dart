...
final class RealtimekitPresetPermissionsChatPublic {const RealtimekitPresetPermissionsChatPublic({required this.canSend, required this.files, required this.text, });
