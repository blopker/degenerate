...
@immutable final class SmartshieldSmartShieldSettingsGetResponseRegionalTieredCacheValue {const SmartshieldSmartShieldSettingsGetResponseRegionalTieredCacheValue._(this.value);
...
@immutable final class SmartshieldSmartShieldSettingsGetResponseRegionalTieredCache {const SmartshieldSmartShieldSettingsGetResponseRegionalTieredCache({this.editable, this.id, this.value, });
