...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_filter.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';@immutable final class FirewallFilterResponseCollection {const FirewallFilterResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallFilterResponseCollection copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallFilter>? result, bool? success, FirewallResultInfo? Function()? resultInfo, }) { return FirewallFilterResponseCollection(
...
@override String toString() { return 'FirewallFilterResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
