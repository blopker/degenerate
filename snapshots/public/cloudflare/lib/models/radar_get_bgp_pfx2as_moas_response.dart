...
import 'radar_get_bgp_pfx2as_moas_response_result.dart';final class RadarGetBgpPfx2asMoasResponse {const RadarGetBgpPfx2asMoasResponse({required this.result, required this.success, });
