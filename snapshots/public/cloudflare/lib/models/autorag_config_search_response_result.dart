...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'autorag_config_search_response_result_data.dart';@immutable final class AutoragConfigSearchResponseResult {const AutoragConfigSearchResponseResult({required this.searchQuery, this.data, this.hasMore, this.nextPage = const Omittable.absent(), this.object, });
