...
final class RadarGetDnsTimeseriesGroupResponseResultMetaDateRange {const RadarGetDnsTimeseriesGroupResponseResultMetaDateRange({required this.endTime, required this.startTime, });
