...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PatchEventQueryUpdateResponse {const PatchEventQueryUpdateResponse({required this.accountId, required this.alertEnabled, required this.alertRollupEnabled, required this.createdAt, required this.id, required this.name, required this.queryJson, required this.ruleEnabled, required this.updatedAt, required this.userEmail, this.ruleScope, });

factory PatchEventQueryUpdateResponse.fromJson(Map<String, dynamic> json) { return PatchEventQueryUpdateResponse(
