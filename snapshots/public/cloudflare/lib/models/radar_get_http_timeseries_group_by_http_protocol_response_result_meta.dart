...
@immutable final class RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMetaAggInterval {const RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMetaNormalization {const RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMeta {const RadarGetHttpTimeseriesGroupByHttpProtocolResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
