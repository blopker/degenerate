...
import 'access_common_name_rule_common_name.dart';/// Matches a specific common name.
final class AccessCommonNameRule {const AccessCommonNameRule({required this.commonName});
