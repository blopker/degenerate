...
final class RadarGetHttpTimeseriesGroupByBotClassResponseResultMetaUnits {const RadarGetHttpTimeseriesGroupByBotClassResponseResultMetaUnits({required this.name, required this.value, });
