...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zaraz_messages2_source.dart';@immutable final class ZarazMessages2 {const ZarazMessages2({required this.code, required this.message, this.documentationUrl, this.source, });
