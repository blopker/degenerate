...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetIndicatorListLegacyResponseIndicatorsTags {const GetIndicatorListLegacyResponseIndicatorsTags({this.categoryName, this.uuid, this.value, });
