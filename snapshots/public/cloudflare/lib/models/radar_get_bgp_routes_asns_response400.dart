...
final List<RadarGetBgpRoutesAsnsResponse400Errors> errors;
...
RadarGetBgpRoutesAsnsResponse400 copyWith({List<RadarGetBgpRoutesAsnsResponse400Errors>? errors, Map<String,dynamic>? result, bool? success, }) { return RadarGetBgpRoutesAsnsResponse400(
  errors: errors ?? this.errors,
  result: result ?? this.result,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetBgpRoutesAsnsResponse400 &&
          listEquals(errors, other.errors) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), result, success); } 
@override String toString() { return 'RadarGetBgpRoutesAsnsResponse400(errors: $errors, result: $result, success: $success)'; } 
 }
