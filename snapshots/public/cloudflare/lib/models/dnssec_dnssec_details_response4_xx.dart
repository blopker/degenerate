...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dnssec_messages2.dart';@immutable final class DnssecDnssecDetailsResponse4Xx {const DnssecDnssecDetailsResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, });
...
@override String toString() { return 'DnssecDnssecDetailsResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
