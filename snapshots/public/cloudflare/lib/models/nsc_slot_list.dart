...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'nsc_slot_info.dart';final class NscSlotList {const NscSlotList({required this.items, this.next, });
