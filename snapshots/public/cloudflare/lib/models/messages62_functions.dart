...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages62Functions {const Messages62Functions({required this.code, required this.name, });
