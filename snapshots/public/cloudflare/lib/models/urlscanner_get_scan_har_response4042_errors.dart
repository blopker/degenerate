...
final class UrlscannerGetScanHarResponse4042Errors {const UrlscannerGetScanHarResponse4042Errors({required this.detail, required this.status, required this.title, });
