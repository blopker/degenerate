...
final class WorkersObservabilityQueryResultsCompareAggregatesGroups {const WorkersObservabilityQueryResultsCompareAggregatesGroups({required this.key, required this.value, });
