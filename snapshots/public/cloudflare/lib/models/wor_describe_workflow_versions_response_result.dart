...
import 'wor_describe_workflow_versions_response_result_limits.dart';final class WorDescribeWorkflowVersionsResponseResult {const WorDescribeWorkflowVersionsResponseResult({required this.className, required this.createdOn, required this.hasDag, required this.id, this.limits, required this.modifiedOn, required this.workflowId, });
...
final WorDescribeWorkflowVersionsResponseResultLimits? limits;
...
WorDescribeWorkflowVersionsResponseResult copyWith({String? className, DateTime? createdOn, bool? hasDag, String? id, WorDescribeWorkflowVersionsResponseResultLimits Function()? limits, DateTime? modifiedOn, String? workflowId, }) { return WorDescribeWorkflowVersionsResponseResult(
