...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_request_rule.dart';import 'rulesets_ruleset_id.dart';import 'rulesets_ruleset_version.dart';final class UpdateZoneEntrypointRulesetRequest {const UpdateZoneEntrypointRulesetRequest({this.description = '', required this.id, required this.lastUpdated, this.name, required this.version, this.rules, });
