...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bgp_ips_timeseries_response_result.dart';@immutable final class RadarGetBgpIpsTimeseriesResponse {const RadarGetBgpIpsTimeseriesResponse({required this.result, required this.success, });
