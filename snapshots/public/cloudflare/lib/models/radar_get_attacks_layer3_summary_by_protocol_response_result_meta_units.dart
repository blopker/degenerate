...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetAttacksLayer3SummaryByProtocolResponseResultMetaUnits {const RadarGetAttacksLayer3SummaryByProtocolResponseResultMetaUnits({required this.name, required this.value, });
