...
factory ShieldOperation.fromJson(Map<String, dynamic> json) { return ShieldOperation(
  ...
  features: json['features'] != null ? ShieldOperationFeatures.fromJson(json['features']) : null,
); }
