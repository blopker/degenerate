...
final class AbuseReportsMitigationAppealResultResultInfo {const AbuseReportsMitigationAppealResultResultInfo({required this.count, required this.page, required this.perPage, required this.totalCount, required this.totalPages, });
