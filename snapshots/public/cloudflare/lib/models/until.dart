...
@immutable
final class Until {
  const Until({this.string = const Omittable.absent(),
this.$int = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Until._({required this.rawValue, required this.string,
required this.$int,});
  factory Until.fromJson(Object? json) => Until._(
...
if ($int.isPresent) $int.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Until && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Until(${toJson()})';
}
