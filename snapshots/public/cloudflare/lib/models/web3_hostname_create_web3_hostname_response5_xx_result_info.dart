...
@immutable
final class Web3HostnameCreateWeb3HostnameResponse5XxResultInfo {
  const Web3HostnameCreateWeb3HostnameResponse5XxResultInfo({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Web3HostnameCreateWeb3HostnameResponse5XxResultInfo._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory Web3HostnameCreateWeb3HostnameResponse5XxResultInfo.fromJson(Object? json) => Web3HostnameCreateWeb3HostnameResponse5XxResultInfo._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Web3HostnameCreateWeb3HostnameResponse5XxResultInfo && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Web3HostnameCreateWeb3HostnameResponse5XxResultInfo(${toJson()})';
}
