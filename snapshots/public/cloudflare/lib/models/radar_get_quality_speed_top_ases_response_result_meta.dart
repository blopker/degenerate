...
@immutable final class RadarGetQualitySpeedTopAsesResponseResultMetaNormalization {const RadarGetQualitySpeedTopAsesResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetQualitySpeedTopAsesResponseResultMeta {const RadarGetQualitySpeedTopAsesResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
