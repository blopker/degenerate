...
factory DosMessages2.fromJson(Map<String, dynamic> json) { return DosMessages2(
  ...
  source: json['source'] != null ? DosMessages2Source.fromJson(json['source'] as Map<String, dynamic>) : null,
); }
...
final DosMessages2Source? source;
...
DosMessages2 copyWith({int? code, String Function()? documentationUrl, String? message, DosMessages2Source Function()? source, }) { return DosMessages2(
  code: code ?? this.code,
