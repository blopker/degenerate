...
import 'radar_get_dns_summary_by_dnssec_response_result.dart';final class RadarGetDnsSummaryByDnssecResponse {const RadarGetDnsSummaryByDnssecResponse({required this.result, required this.success, });
