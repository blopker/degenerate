...
factory AiSearchUpdateInstancesRequestSourceParams.fromJson(Map<String, dynamic> json) { return AiSearchUpdateInstancesRequestSourceParams(
  ...
  webCrawler: json['web_crawler'] != null ? AiSearchUpdateInstancesRequestSourceParamsWebCrawler.fromJson(json['web_crawler'] as Map<String, dynamic>) : null,
); }
...
final AiSearchUpdateInstancesRequestSourceParamsWebCrawler? webCrawler;
...
AiSearchUpdateInstancesRequestSourceParams copyWith({List<String> Function()? excludeItems, List<String> Function()? includeItems, String Function()? prefix, String Function()? r2Jurisdiction, AiSearchUpdateInstancesRequestSourceParamsWebCrawler Function()? webCrawler, }) { return AiSearchUpdateInstancesRequestSourceParams(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AiSearchUpdateInstancesRequestSourceParams &&
...
@override String toString() { return 'AiSearchUpdateInstancesRequestSourceParams(excludeItems: $excludeItems, includeItems: $includeItems, prefix: $prefix, r2Jurisdiction: $r2Jurisdiction, webCrawler: $webCrawler)'; } 
 }
