...
@immutable final class ZonesSchemasBrowserCheck {const ZonesSchemasBrowserCheck({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
