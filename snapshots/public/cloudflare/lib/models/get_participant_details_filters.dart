...
final class GetParticipantDetailsFilters {const GetParticipantDetailsFilters._(this.value);
...
@override String toString() { return 'GetParticipantDetailsFilters($value)'; } 
 }
