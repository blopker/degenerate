...
@immutable final class AccessYandexScimConfig {const AccessYandexScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessYandexScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessYandexScimConfig.fromJson(Map<String, dynamic> json) { return AccessYandexScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessYandexScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessYandexScimConfigIdentityUpdateBehavior.noAction,
