...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_support_connector.dart';@immutable final class MconnSupportConnectorListResponse {const MconnSupportConnectorListResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnSupportConnectorListResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, List<MconnSupportConnector>? result, }) {return MconnSupportConnectorListResponse(
...
@override String toString() {return 'MconnSupportConnectorListResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
