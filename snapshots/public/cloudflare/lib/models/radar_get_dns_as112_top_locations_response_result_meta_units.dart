...
final class RadarGetDnsAs112TopLocationsResponseResultMetaUnits {const RadarGetDnsAs112TopLocationsResponseResultMetaUnits({required this.name, required this.value, });
