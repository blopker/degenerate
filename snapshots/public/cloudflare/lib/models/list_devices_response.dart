...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'response_message.dart';import 'teams_devices_cursor_result_info.dart';import 'teams_devices_physical_device.dart';final class ListDevicesResponse {const ListDevicesResponse({required this.errors, required this.messages, required this.result, this.resultInfo, required this.success, });
