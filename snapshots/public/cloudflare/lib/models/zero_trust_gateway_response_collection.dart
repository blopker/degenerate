...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_certificates.dart';import 'zero_trust_gateway_messages2.dart';import 'zero_trust_gateway_result_info.dart';@immutable final class ZeroTrustGatewayResponseCollection {const ZeroTrustGatewayResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
ZeroTrustGatewayResponseCollection copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayResultInfo? Function()? resultInfo, List<ZeroTrustGatewayCertificates>? Function()? result, }) { return ZeroTrustGatewayResponseCollection(
...
@override String toString() { return 'ZeroTrustGatewayResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
