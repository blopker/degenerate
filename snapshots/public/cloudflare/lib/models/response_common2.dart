...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aaa_components_schemas_messages2.dart';final class ResponseCommon2 {const ResponseCommon2({required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'ResponseCommon2(errors: $errors, messages: $messages, success: $success)'; } 
 }
