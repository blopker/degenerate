...
final List<RadarGetDnsTopLocationsResponseResultMetaConfidenceInfoAnnotations> annotations;
...
RadarGetDnsTopLocationsResponseResultMetaConfidenceInfo copyWith({List<RadarGetDnsTopLocationsResponseResultMetaConfidenceInfoAnnotations>? annotations, int? level, }) { return RadarGetDnsTopLocationsResponseResultMetaConfidenceInfo(
  annotations: annotations ?? this.annotations,
  level: level ?? this.level,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetDnsTopLocationsResponseResultMetaConfidenceInfo &&
          listEquals(annotations, other.annotations) &&
          level == other.level; } 
@override int get hashCode { return Object.hash(Object.hashAll(annotations), level); } 
@override String toString() { return 'RadarGetDnsTopLocationsResponseResultMetaConfidenceInfo(annotations: $annotations, level: $level)'; } 
 }
