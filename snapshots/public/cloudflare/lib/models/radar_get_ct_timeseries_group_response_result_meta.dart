...
final class RadarGetCtTimeseriesGroupResponseResultMetaNormalization {const RadarGetCtTimeseriesGroupResponseResultMetaNormalization._(this.value);
...
final class RadarGetCtTimeseriesGroupResponseResultMeta {const RadarGetCtTimeseriesGroupResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
