...
@immutable final class ZonesSchemasAlwaysUseHttps {const ZonesSchemasAlwaysUseHttps({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
