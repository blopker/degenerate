...
@immutable final class ZonesSchemasAlwaysUseHttps {const ZonesSchemasAlwaysUseHttps({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasAlwaysUseHttps copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesAlwaysUseHttpsValue? value, }) { return ZonesSchemasAlwaysUseHttps(
