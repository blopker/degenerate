...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_bgp_rpki_aspa_changes_response400_errors.dart';final class RadarGetBgpRpkiAspaChangesResponse400 {const RadarGetBgpRpkiAspaChangesResponse400({required this.errors, required this.result, required this.success, });
