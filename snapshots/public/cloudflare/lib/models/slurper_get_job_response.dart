...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'error_model32.dart';import 'r2_slurper_job_response.dart';@immutable final class SlurperGetJobResponse {const SlurperGetJobResponse({this.errors, this.messages, this.success, this.result, });
