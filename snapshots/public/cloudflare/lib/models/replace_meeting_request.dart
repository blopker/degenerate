...
import 'realtimekit_ai_config.dart';import 'realtimekit_recording_config.dart';final class ReplaceMeetingRequest {const ReplaceMeetingRequest({this.aiConfig, this.liveStreamOnStart = false, this.persistChat = false, this.recordOnStart = false, this.recordingConfig, this.sessionKeepAliveTimeInSecs = 60.0, this.summarizeOnEnd = false, this.title, });
