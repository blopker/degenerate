...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';import 'iam_sso_connector.dart';@immutable final class IamSsoConnectorCollectionResponse {const IamSsoConnectorCollectionResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamSsoConnectorCollectionResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamSsoConnector>? Function()? result, }) { return IamSsoConnectorCollectionResponse(
...
@override String toString() { return 'IamSsoConnectorCollectionResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
