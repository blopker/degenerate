...
@immutable final class AiSearchFetchInstancesResponseResultRetrievalOptions {const AiSearchFetchInstancesResponseResultRetrievalOptions({this.boostBy, this.keywordMatchMode, });
...
factory AiSearchFetchInstancesResponseResultRetrievalOptions.fromJson(Map<String, dynamic> json) { return AiSearchFetchInstancesResponseResultRetrievalOptions(
  ...
  keywordMatchMode: json['keyword_match_mode'] != null ? AiSearchFetchInstancesResponseResultRetrievalOptionsKeywordMatchMode.fromJson(json['keyword_match_mode'] as String) : null,
); }
...
AiSearchFetchInstancesResponseResultRetrievalOptionsKeywordMatchMode get keywordMatchModeOrDefault { return keywordMatchMode ?? AiSearchFetchInstancesResponseResultRetrievalOptionsKeywordMatchMode.fromJson('exact_match'); } 
