...
ZeroTrustGatewayListSingleResponse copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayLists? Function()? result, }) { return ZeroTrustGatewayListSingleResponse(
...
@override String toString() { return 'ZeroTrustGatewayListSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
