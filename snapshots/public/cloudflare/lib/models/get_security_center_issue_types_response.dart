...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'security_center_messages2.dart';@immutable final class GetSecurityCenterIssueTypesResponse {const GetSecurityCenterIssueTypesResponse({required this.errors, required this.messages, required this.success, this.result, });
