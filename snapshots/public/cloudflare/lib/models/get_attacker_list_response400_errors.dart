...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetAttackerListResponse400Errors {const GetAttackerListResponse400Errors({required this.message});
