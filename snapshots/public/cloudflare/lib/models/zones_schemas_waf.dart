...
@immutable final class ZonesSchemasWaf {const ZonesSchemasWaf({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasWaf copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesWafValue? value, }) { return ZonesSchemasWaf(
