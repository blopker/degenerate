...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zero_trust_gateway_certificates.dart';import 'zero_trust_gateway_messages2.dart';@immutable final class ZeroTrustGatewaySingleResponse {const ZeroTrustGatewaySingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
ZeroTrustGatewaySingleResponse copyWith({List<ZeroTrustGatewayMessages2>? errors, List<ZeroTrustGatewayMessages2>? messages, bool? success, ZeroTrustGatewayCertificates? Function()? result, }) { return ZeroTrustGatewaySingleResponse(
...
@override String toString() { return 'ZeroTrustGatewaySingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
