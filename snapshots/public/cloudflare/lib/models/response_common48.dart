...
factory ResponseCommon48.fromJson(Map<String, dynamic> json) { return ResponseCommon48(
  ...
  result: ResponseCommon48Result.fromJson(json['result']),
...
final ResponseCommon48Result result;
...
ResponseCommon48 copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, ResponseCommon48Result? result, bool? success, }) { return ResponseCommon48(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ResponseCommon48 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), result, success); } 
@override String toString() { return 'ResponseCommon48(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
