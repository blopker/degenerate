...
@immutable final class ZonesTlsClientAuth {const ZonesTlsClientAuth({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
