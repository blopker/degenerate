...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_messages2.dart';import 'dlp_risk_score_integration.dart';@immutable final class DlpZtRiskScoreIntegrationGetResponse {const DlpZtRiskScoreIntegrationGetResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DlpZtRiskScoreIntegrationGetResponse copyWith({List<DlpMessages2>? errors, List<DlpMessages2>? messages, bool? success, DlpRiskScoreIntegration? Function()? result, }) { return DlpZtRiskScoreIntegrationGetResponse(
...
@override String toString() { return 'DlpZtRiskScoreIntegrationGetResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
