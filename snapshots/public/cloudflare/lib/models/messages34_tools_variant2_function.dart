...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages34_tools_variant2_function_parameters.dart';/// Details of the function tool.
@immutable final class Messages34ToolsVariant2Function {const Messages34ToolsVariant2Function({required this.description, required this.name, required this.parameters, });
