...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_association_object.dart';import 'tls_certificates_and_hostnames_association_response_collection_result_info.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesAssociationResponseCollection {const TlsCertificatesAndHostnamesAssociationResponseCollection({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
factory TlsCertificatesAndHostnamesAssociationResponseCollection.fromJson(Map<String, dynamic> json) { return TlsCertificatesAndHostnamesAssociationResponseCollection(
  ...
  resultInfo: json['result_info'] != null ? TlsCertificatesAndHostnamesAssociationResponseCollectionResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final TlsCertificatesAndHostnamesAssociationResponseCollectionResultInfo? resultInfo;
...
TlsCertificatesAndHostnamesAssociationResponseCollection copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesAssociationResponseCollectionResultInfo? Function()? resultInfo, List<TlsCertificatesAndHostnamesAssociationObject>? Function()? result, }) { return TlsCertificatesAndHostnamesAssociationResponseCollection(
...
@override String toString() { return 'TlsCertificatesAndHostnamesAssociationResponseCollection(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
