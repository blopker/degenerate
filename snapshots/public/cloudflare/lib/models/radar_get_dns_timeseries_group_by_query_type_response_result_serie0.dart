...
RadarGetDnsTimeseriesGroupByQueryTypeResponseResultSerie0 copyWith({List<DateTime>? timestamps, Map<String, List<String>>? additionalProperties, }) { return RadarGetDnsTimeseriesGroupByQueryTypeResponseResultSerie0(
...
@override String toString() { return 'RadarGetDnsTimeseriesGroupByQueryTypeResponseResultSerie0(timestamps: $timestamps, additionalProperties: $additionalProperties)'; } 
 }
