...
final class RadarGetEmailSecurityTimeseriesGroupByThreatCategoryResponse400Errors {const RadarGetEmailSecurityTimeseriesGroupByThreatCategoryResponse400Errors({required this.message});
