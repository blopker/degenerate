...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';@immutable final class UserAgentBlockingRulesCreateAUserAgentBlockingRuleResponse4Xx {const UserAgentBlockingRulesCreateAUserAgentBlockingRuleResponse4Xx({required this.result, required this.errors, required this.messages, required this.success, });
...
@override String toString() { return 'UserAgentBlockingRulesCreateAUserAgentBlockingRuleResponse4Xx(result: $result, errors: $errors, messages: $messages, success: $success)'; } 
 }
