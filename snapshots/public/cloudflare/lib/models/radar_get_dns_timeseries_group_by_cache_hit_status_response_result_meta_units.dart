...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetDnsTimeseriesGroupByCacheHitStatusResponseResultMetaUnits {const RadarGetDnsTimeseriesGroupByCacheHitStatusResponseResultMetaUnits({required this.name, required this.value, });
