...
import 'email_security_pattern_type.dart';final class EmailSecurityCreateAllowPolicy {const EmailSecurityCreateAllowPolicy({this.comments, required this.isAcceptableSender, required this.isExemptRecipient, this.isRecipient, required this.isRegex, this.isSender, this.isSpoof, required this.isTrustedSender, required this.pattern, required this.patternType, required this.verifySender, });
