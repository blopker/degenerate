...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class CreateAppResponseDataApp {const CreateAppResponseDataApp({this.createdAt, this.id, this.name, });
