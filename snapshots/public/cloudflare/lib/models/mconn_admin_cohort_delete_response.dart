...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_cohort.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminCohortDeleteResponse {const MconnAdminCohortDeleteResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminCohortDeleteResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminCohort? result, }) {return MconnAdminCohortDeleteResponse(
...
@override String toString() {return 'MconnAdminCohortDeleteResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
