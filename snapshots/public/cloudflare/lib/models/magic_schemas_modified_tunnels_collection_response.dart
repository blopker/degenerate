...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_messages2.dart';import 'magic_schemas_modified_tunnels_collection_response_result.dart';@immutable final class MagicSchemasModifiedTunnelsCollectionResponse {const MagicSchemasModifiedTunnelsCollectionResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
factory MagicSchemasModifiedTunnelsCollectionResponse.fromJson(Map<String, dynamic> json) { return MagicSchemasModifiedTunnelsCollectionResponse(
  ...
  result: MagicSchemasModifiedTunnelsCollectionResponseResult.fromJson(json['result'] as Map<String, dynamic>),
...
MagicSchemasModifiedTunnelsCollectionResponse copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, MagicSchemasModifiedTunnelsCollectionResponseResult? result, bool? success, }) { return MagicSchemasModifiedTunnelsCollectionResponse(
...
@override String toString() { return 'MagicSchemasModifiedTunnelsCollectionResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
