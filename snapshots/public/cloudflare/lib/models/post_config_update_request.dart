...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'frequency2.dart';final class PostConfigUpdateRequest {const PostConfigUpdateRequest({this.frequency, this.ips, this.ports, });
