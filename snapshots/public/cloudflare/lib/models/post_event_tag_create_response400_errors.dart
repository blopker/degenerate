...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostEventTagCreateResponse400Errors {const PostEventTagCreateResponse400Errors({required this.message});
