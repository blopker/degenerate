...
factory AiSearchCreateInstancesResponseResultRerankingModel.fromJson(String json) { return switch (json) {
  ...
  '' => $empty,
  _ => AiSearchCreateInstancesResponseResultRerankingModel._(json),
}; }

static const AiSearchCreateInstancesResponseResultRerankingModel cfBaaiBgeRerankerBase = AiSearchCreateInstancesResponseResultRerankingModel._('@cf/baai/bge-reranker-base');

static const AiSearchCreateInstancesResponseResultRerankingModel $empty = AiSearchCreateInstancesResponseResultRerankingModel._('');

static const List<AiSearchCreateInstancesResponseResultRerankingModel> values = [cfBaaiBgeRerankerBase, $empty];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AiSearchCreateInstancesResponseResultRerankingModel && other.value == value; } 
...
@immutable final class AiSearchCreateInstancesResponseResult {const AiSearchCreateInstancesResponseResult({required this.vectorizeName, required this.createdAt, required this.id, required this.modifiedAt, this.fusionMethod = AiSearchCreateInstancesResponseResultFusionMethod.rrf, this.chunkSize = 256, this.aiSearchModel, this.createdBy = const Omittable.absent(), this.customMetadata, this.embeddingModel, this.enable = true, this.aiGatewayId = const Omittable.absent(), this.hybridSearchEnabled = false, this.cache = true, this.lastActivity = const Omittable.absent(), this.maxNumResults = 10, this.metadata, this.cacheThreshold = AiSearchCreateInstancesResponseResultCacheThreshold.closeEnough, this.modifiedBy = const Omittable.absent(), this.paused = false, this.publicEndpointId = const Omittable.absent(), this.chunkOverlap = 10, this.reranking = false, this.rerankingModel, this.retrievalOptions = const Omittable.absent(), this.rewriteModel, this.rewriteQuery = false, this.scoreThreshold = 0.4, this.source, this.sourceParams = const Omittable.absent(), this.status = 'waiting', this.tokenId, this.type, this.publicEndpointParams, });
...
factory AiSearchCreateInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesResponseResult(
  ...
  aiSearchModel: json['ai_search_model'] != null ? OneOf2.parse(json['ai_search_model'], fromA: (v) => AiSearchCreateInstancesResponseResultAiSearchModelVariant1.fromJson(v as String), fromB: (v) => AiSearchCreateInstancesResponseResultAiSearchModelVariant2.fromJson(v as String),) : null,
  cache: json.containsKey('cache') ? json['cache'] as bool : true,
  cacheThreshold: json.containsKey('cache_threshold') ? AiSearchCreateInstancesResponseResultCacheThreshold.fromJson(json['cache_threshold'] as String) : AiSearchCreateInstancesResponseResultCacheThreshold.closeEnough,
  ...
  customMetadata: (json['custom_metadata'] as List<dynamic>?)?.map((e) => AiSearchCreateInstancesResponseResultCustomMetadata.fromJson(e as Map<String, dynamic>)).toList(),
  embeddingModel: json['embedding_model'] != null ? OneOf2.parse(json['embedding_model'], fromA: (v) => AiSearchCreateInstancesResponseResultEmbeddingModelVariant1.fromJson(v as String), fromB: (v) => AiSearchCreateInstancesResponseResultEmbeddingModelVariant2.fromJson(v as String),) : null,
  enable: json.containsKey('enable') ? json['enable'] as bool : true,
  fusionMethod: json.containsKey('fusion_method') ? AiSearchCreateInstancesResponseResultFusionMethod.fromJson(json['fusion_method'] as String) : AiSearchCreateInstancesResponseResultFusionMethod.rrf,
  ...
  metadata: json['metadata'] != null ? AiSearchCreateInstancesResponseResultMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
  ...
  publicEndpointParams: json['public_endpoint_params'] != null ? AiSearchCreateInstancesResponseResultPublicEndpointParams.fromJson(json['public_endpoint_params'] as Map<String, dynamic>) : null,
  reranking: json.containsKey('reranking') ? json['reranking'] as bool : false,
  rerankingModel: json['reranking_model'] != null ? AiSearchCreateInstancesResponseResultRerankingModel.fromJson(json['reranking_model'] as String) : null,
  retrievalOptions: json.containsKey('retrieval_options') ? Omittable(json['retrieval_options'] != null ? AiSearchCreateInstancesResponseResultRetrievalOptions.fromJson(json['retrieval_options'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  rewriteModel: json['rewrite_model'] != null ? OneOf2.parse(json['rewrite_model'], fromA: (v) => AiSearchCreateInstancesResponseResultRewriteModelVariant1.fromJson(v as String), fromB: (v) => AiSearchCreateInstancesResponseResultRewriteModelVariant2.fromJson(v as String),) : null,
  ...
  sourceParams: json.containsKey('source_params') ? Omittable(json['source_params'] != null ? AiSearchCreateInstancesResponseResultSourceParams.fromJson(json['source_params'] as Map<String, dynamic>) : null) : const Omittable.absent(),
  status: json.containsKey('status') ? json['status'] as String : 'waiting',
  tokenId: json['token_id'] as String?,
  type: json['type'] != null ? AiSearchCreateInstancesResponseResultType.fromJson(json['type'] as String) : null,
  vectorizeName: json['vectorize_name'] as String,
); }

final Omittable<String?> aiGatewayId;

final AiSearchCreateInstancesResponseResultAiSearchModel? aiSearchModel;

final bool cache;

final AiSearchCreateInstancesResponseResultCacheThreshold cacheThreshold;
...
final List<AiSearchCreateInstancesResponseResultCustomMetadata>? customMetadata;

final AiSearchCreateInstancesResponseResultEmbeddingModel? embeddingModel;

final bool enable;

final AiSearchCreateInstancesResponseResultFusionMethod fusionMethod;
...
final AiSearchCreateInstancesResponseResultMetadata? metadata;
...
final AiSearchCreateInstancesResponseResultPublicEndpointParams? publicEndpointParams;

final bool reranking;

final AiSearchCreateInstancesResponseResultRerankingModel? rerankingModel;

final Omittable<AiSearchCreateInstancesResponseResultRetrievalOptions?> retrievalOptions;

final AiSearchCreateInstancesResponseResultRewriteModel? rewriteModel;
...
final Omittable<AiSearchCreateInstancesResponseResultSourceParams?> sourceParams;

final String status;

final String? tokenId;

final AiSearchCreateInstancesResponseResultType? type;
...
AiSearchCreateInstancesResponseResult copyWith({Omittable<String?>? aiGatewayId, AiSearchCreateInstancesResponseResultAiSearchModel? Function()? aiSearchModel, bool Function()? cache, AiSearchCreateInstancesResponseResultCacheThreshold Function()? cacheThreshold, int Function()? chunkOverlap, int Function()? chunkSize, DateTime? createdAt, Omittable<String?>? createdBy, List<AiSearchCreateInstancesResponseResultCustomMetadata>? Function()? customMetadata, AiSearchCreateInstancesResponseResultEmbeddingModel? Function()? embeddingModel, bool Function()? enable, AiSearchCreateInstancesResponseResultFusionMethod Function()? fusionMethod, bool Function()? hybridSearchEnabled, String? id, Omittable<DateTime?>? lastActivity, int Function()? maxNumResults, AiSearchCreateInstancesResponseResultMetadata? Function()? metadata, DateTime? modifiedAt, Omittable<String?>? modifiedBy, bool Function()? paused, Omittable<String?>? publicEndpointId, AiSearchCreateInstancesResponseResultPublicEndpointParams? Function()? publicEndpointParams, bool Function()? reranking, AiSearchCreateInstancesResponseResultRerankingModel? Function()? rerankingModel, Omittable<AiSearchCreateInstancesResponseResultRetrievalOptions?>? retrievalOptions, AiSearchCreateInstancesResponseResultRewriteModel? Function()? rewriteModel, bool Function()? rewriteQuery, double Function()? scoreThreshold, String? Function()? source, Omittable<AiSearchCreateInstancesResponseResultSourceParams?>? sourceParams, String Function()? status, String? Function()? tokenId, AiSearchCreateInstancesResponseResultType? Function()? type, String? vectorizeName, }) { return AiSearchCreateInstancesResponseResult(
