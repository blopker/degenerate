...
@immutable final class BrapiPostContentRequestVariant1GotoOptions {const BrapiPostContentRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostContentRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostContentRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostContentRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
); }
