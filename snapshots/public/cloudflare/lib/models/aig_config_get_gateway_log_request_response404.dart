...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_get_gateway_log_request_response404_errors.dart';final class AigConfigGetGatewayLogRequestResponse404 {const AigConfigGetGatewayLogRequestResponse404({required this.errors, required this.success, });
