...
@immutable final class Prompt17ResponseFormat {const Prompt17ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt17ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt17ResponseFormatType? Function()? type, }) { return Prompt17ResponseFormat(
