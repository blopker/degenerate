...
final class Prompt17ResponseFormatType {const Prompt17ResponseFormatType._(this.value);
...
final class Prompt17ResponseFormat {const Prompt17ResponseFormat({this.jsonSchema, this.type, });
