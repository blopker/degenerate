...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'addressing_messages2.dart';import 'ip_address_management_address_maps_list_address_maps_response4_xx_result_info.dart';@immutable final class IpAddressManagementAddressMapsListAddressMapsResponse4Xx {const IpAddressManagementAddressMapsListAddressMapsResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
