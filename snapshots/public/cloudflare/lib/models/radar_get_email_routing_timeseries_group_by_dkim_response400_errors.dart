...
final class RadarGetEmailRoutingTimeseriesGroupByDkimResponse400Errors {const RadarGetEmailRoutingTimeseriesGroupByDkimResponse400Errors({required this.message});
