...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'message3.dart';final class ErrorResponse {const ErrorResponse({required this.errors, required this.messages, this.result, required this.success, });
