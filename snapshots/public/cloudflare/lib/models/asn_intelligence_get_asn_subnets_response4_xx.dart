...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'intel_asn.dart';import 'intel_count.dart';import 'intel_messages2.dart';import 'intel_page.dart';import 'intel_per_page.dart';final class AsnIntelligenceGetAsnSubnetsResponse4Xx {const AsnIntelligenceGetAsnSubnetsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, this.asn, this.count, this.ipCountTotal, this.page, this.perPage, this.subnets, });
