...
BrapiPostScreenshotRequestVariant1ScreenshotOptionsClip copyWith({double? height, double Function()? scale, double? width, double? x, double? y, }) { return BrapiPostScreenshotRequestVariant1ScreenshotOptionsClip(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostScreenshotRequestVariant1ScreenshotOptionsClip &&
          height == other.height &&
          scale == other.scale &&
          width == other.width &&
          x == other.x &&
...
@override String toString() { return 'BrapiPostScreenshotRequestVariant1ScreenshotOptionsClip(height: $height, scale: $scale, width: $width, x: $x, y: $y)'; } 
 }
