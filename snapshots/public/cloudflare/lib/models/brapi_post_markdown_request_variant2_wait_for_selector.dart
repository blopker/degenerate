...
@immutable final class BrapiPostMarkdownRequestVariant2WaitForSelector {const BrapiPostMarkdownRequestVariant2WaitForSelector({required this.selector, this.hidden, this.timeout, this.visible, });
