...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_filter_rule_response.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';@immutable final class FirewallFilterRulesResponseCollectionDelete {const FirewallFilterRulesResponseCollectionDelete({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallFilterRulesResponseCollectionDelete copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallFilterRuleResponse>? result, bool? success, FirewallResultInfo Function()? resultInfo, }) { return FirewallFilterRulesResponseCollectionDelete(
...
@override String toString() { return 'FirewallFilterRulesResponseCollectionDelete(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
