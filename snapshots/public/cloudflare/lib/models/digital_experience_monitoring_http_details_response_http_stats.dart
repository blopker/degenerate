...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'digital_experience_monitoring_http_details_response_http_stats_http_status_code.dart';import 'digital_experience_monitoring_test_stat_over_time.dart';import 'digital_experience_monitoring_test_stat_pct_over_time.dart';final class DigitalExperienceMonitoringHttpDetailsResponseHttpStats {const DigitalExperienceMonitoringHttpDetailsResponseHttpStats({required this.availabilityPct, required this.dnsResponseTimeMs, required this.httpStatusCode, required this.resourceFetchTimeMs, required this.serverResponseTimeMs, required this.uniqueDevicesTotal, });
