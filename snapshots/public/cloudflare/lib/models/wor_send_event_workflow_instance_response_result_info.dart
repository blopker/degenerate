...
WorSendEventWorkflowInstanceResponseResultInfo copyWith({double? count, String Function()? cursor, double Function()? page, double? perPage, double? totalCount, }) { return WorSendEventWorkflowInstanceResponseResultInfo(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorSendEventWorkflowInstanceResponseResultInfo &&
          count == other.count &&
          cursor == other.cursor &&
          page == other.page &&
...
@override String toString() { return 'WorSendEventWorkflowInstanceResponseResultInfo(count: $count, cursor: $cursor, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
