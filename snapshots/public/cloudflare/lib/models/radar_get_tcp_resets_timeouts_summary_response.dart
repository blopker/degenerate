...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_tcp_resets_timeouts_summary_response_result.dart';@immutable final class RadarGetTcpResetsTimeoutsSummaryResponse {const RadarGetTcpResetsTimeoutsSummaryResponse({required this.result, required this.success, });
...
@override String toString() { return 'RadarGetTcpResetsTimeoutsSummaryResponse(result: $result, success: $success)'; } 
 }
