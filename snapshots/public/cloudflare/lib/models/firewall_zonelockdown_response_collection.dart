...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'firewall_messages2.dart';import 'firewall_result_info.dart';import 'firewall_zonelockdown.dart';@immutable final class FirewallZonelockdownResponseCollection {const FirewallZonelockdownResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
FirewallZonelockdownResponseCollection copyWith({List<FirewallMessages2>? errors, List<FirewallMessages2>? messages, List<FirewallZonelockdown>? result, bool? success, FirewallResultInfo? Function()? resultInfo, }) { return FirewallZonelockdownResponseCollection(
...
@override String toString() { return 'FirewallZonelockdownResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
