...
@immutable
final class ResponseCommon36Result {
  const ResponseCommon36Result({this.mapStringdynamic = const Omittable.absent(),
this.listdynamic = const Omittable.absent(),
this.string = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseCommon36Result._({required this.rawValue, required this.mapStringdynamic,
required this.listdynamic,
required this.string,});
  factory ResponseCommon36Result.fromJson(Object? json) => ResponseCommon36Result._(
...
if (string.isPresent) string.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseCommon36Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseCommon36Result(${toJson()})';
}
