...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_post_gateway_dynamic_route_version_response_result_elements_conditional_outputs_false.dart';import 'aig_config_post_gateway_dynamic_route_version_response_result_elements_conditional_outputs_true.dart';@immutable final class AigConfigPostGatewayDynamicRouteVersionResponseResultElementsConditionalOutputs {const AigConfigPostGatewayDynamicRouteVersionResponseResultElementsConditionalOutputs({required this.$false, required this.$true, });
