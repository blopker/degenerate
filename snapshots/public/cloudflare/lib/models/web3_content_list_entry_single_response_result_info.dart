...
@immutable
final class Web3ContentListEntrySingleResponseResultInfo {
  const Web3ContentListEntrySingleResponseResultInfo({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Web3ContentListEntrySingleResponseResultInfo._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory Web3ContentListEntrySingleResponseResultInfo.fromJson(Object? json) => Web3ContentListEntrySingleResponseResultInfo._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Web3ContentListEntrySingleResponseResultInfo && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Web3ContentListEntrySingleResponseResultInfo(${toJson()})';
}
