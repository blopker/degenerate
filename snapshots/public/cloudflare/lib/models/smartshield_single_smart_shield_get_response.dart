...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'smartshield_messages2.dart';import 'smartshield_smart_shield_settings_get_response.dart';@immutable final class SmartshieldSingleSmartShieldGetResponse {const SmartshieldSingleSmartShieldGetResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
SmartshieldSingleSmartShieldGetResponse copyWith({List<SmartshieldMessages2>? errors, List<SmartshieldMessages2>? messages, SmartshieldSmartShieldSettingsGetResponse? result, bool? success, }) { return SmartshieldSingleSmartShieldGetResponse(
...
@override String toString() { return 'SmartshieldSingleSmartShieldGetResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
