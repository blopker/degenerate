...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_analytics_messages2.dart';import 'dns_analytics_report.dart';@immutable final class DnsFirewallAnalyticsTableResponse {const DnsFirewallAnalyticsTableResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DnsFirewallAnalyticsTableResponse copyWith({List<DnsAnalyticsMessages2>? errors, List<DnsAnalyticsMessages2>? messages, bool? success, DnsAnalyticsReport? Function()? result, }) { return DnsFirewallAnalyticsTableResponse(
