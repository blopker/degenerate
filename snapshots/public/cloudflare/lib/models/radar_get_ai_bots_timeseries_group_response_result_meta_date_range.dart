...
final class RadarGetAiBotsTimeseriesGroupResponseResultMetaDateRange {const RadarGetAiBotsTimeseriesGroupResponseResultMetaDateRange({required this.endTime, required this.startTime, });
