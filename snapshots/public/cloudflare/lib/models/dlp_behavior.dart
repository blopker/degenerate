...
import 'dlp_risk_level.dart';final class DlpBehavior {const DlpBehavior({required this.description, required this.enabled, required this.name, required this.riskLevel, });
