...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AccessPingoneRequestConfig {const AccessPingoneRequestConfig({this.clientId, this.clientSecret, this.claims, this.emailClaimName, this.pingEnvId, });

factory AccessPingoneRequestConfig.fromJson(Map<String, dynamic> json) { return AccessPingoneRequestConfig(
...
AccessPingoneRequestConfig copyWith({String? Function()? clientId, String? Function()? clientSecret, List<String>? Function()? claims, String? Function()? emailClaimName, String? Function()? pingEnvId, }) { return AccessPingoneRequestConfig(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccessPingoneRequestConfig &&
...
@override String toString() { return 'AccessPingoneRequestConfig(clientId: $clientId, clientSecret: $clientSecret, claims: $claims, emailClaimName: $emailClaimName, pingEnvId: $pingEnvId)'; } 
 }
