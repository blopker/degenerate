...
final class RadarGetRankingTopDomainsResponseResultMetaDateRange {const RadarGetRankingTopDomainsResponseResultMetaDateRange({required this.endTime, required this.startTime, });
