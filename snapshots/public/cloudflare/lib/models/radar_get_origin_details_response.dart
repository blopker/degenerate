...
import 'radar_get_origin_details_response_result.dart';final class RadarGetOriginDetailsResponse {const RadarGetOriginDetailsResponse({required this.result, required this.success, });
