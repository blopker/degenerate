...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_origin_details_response_result.dart';@immutable final class RadarGetOriginDetailsResponse {const RadarGetOriginDetailsResponse({required this.result, required this.success, });
