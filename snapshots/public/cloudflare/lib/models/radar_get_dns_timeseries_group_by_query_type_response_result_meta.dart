...
@immutable final class RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMetaAggInterval {const RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMetaAggInterval._(this.value);
...
@immutable final class RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMetaNormalization {const RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMeta {const RadarGetDnsTimeseriesGroupByQueryTypeResponseResultMeta({required this.aggInterval, required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
