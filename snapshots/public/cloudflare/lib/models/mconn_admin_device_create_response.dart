...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_device.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminDeviceCreateResponse {const MconnAdminDeviceCreateResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminDeviceCreateResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminDevice? result, }) {return MconnAdminDeviceCreateResponse(
...
@override String toString() {return 'MconnAdminDeviceCreateResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
