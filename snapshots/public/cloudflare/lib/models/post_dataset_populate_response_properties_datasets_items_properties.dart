...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_attackers.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_categories.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_dataset_id.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_indicator_types.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_processing_time_ms.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_target_industries.dart';import 'post_dataset_populate_response_properties_datasets_items_properties_total_processed.dart';@immutable final class PostDatasetPopulateResponsePropertiesDatasetsItemsProperties {const PostDatasetPopulateResponsePropertiesDatasetsItemsProperties({required this.attackers, required this.categories, required this.datasetId, required this.indicatorTypes, required this.processingTimeMs, required this.targetIndustries, required this.totalProcessed, });
