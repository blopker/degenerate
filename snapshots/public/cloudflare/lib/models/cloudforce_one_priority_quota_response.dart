...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudforce_one_requests_messages2.dart';import 'cloudforce_one_requests_quota.dart';@immutable final class CloudforceOnePriorityQuotaResponse {const CloudforceOnePriorityQuotaResponse({required this.errors, required this.messages, required this.success, this.result, });

factory CloudforceOnePriorityQuotaResponse.fromJson(Map<String, dynamic> json) { return CloudforceOnePriorityQuotaResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CloudforceOnePriorityQuotaResponse &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          success == other.success &&
          result == other.result; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), success, result); } 
@override String toString() { return 'CloudforceOnePriorityQuotaResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
