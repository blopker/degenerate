...
final class RadarGetEmailSecuritySummaryBySpoofResponseResultMetaNormalization {const RadarGetEmailSecuritySummaryBySpoofResponseResultMetaNormalization._(this.value);
...
final class RadarGetEmailSecuritySummaryBySpoofResponseResultMeta {const RadarGetEmailSecuritySummaryBySpoofResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
