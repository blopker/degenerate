...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_ai_post_run_cf_google_omni_embeddinggemma300m_response400_errors.dart';@immutable final class WorkersAiPostRunCfGoogleOmniEmbeddinggemma300mResponse400 {const WorkersAiPostRunCfGoogleOmniEmbeddinggemma300mResponse400({required this.errors, required this.result, required this.success, });
