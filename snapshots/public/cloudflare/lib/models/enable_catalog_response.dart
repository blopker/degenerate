...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_data_catalog_catalog_activation_response.dart';import 'response_errors3.dart';import 'response_messages2.dart';import 'response_success.dart';final class EnableCatalogResponse {const EnableCatalogResponse({required this.errors, required this.messages, required this.success, this.result, });
