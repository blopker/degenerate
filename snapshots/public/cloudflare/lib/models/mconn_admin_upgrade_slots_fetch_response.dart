...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_upgrade_slot.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminUpgradeSlotsFetchResponse {const MconnAdminUpgradeSlotsFetchResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminUpgradeSlotsFetchResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, List<MconnAdminUpgradeSlot>? result, }) {return MconnAdminUpgradeSlotsFetchResponse(
...
@override String toString() {return 'MconnAdminUpgradeSlotsFetchResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
