...
@immutable final class BookmarkApplication4PoliciesVariant3 {const BookmarkApplication4PoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory BookmarkApplication4PoliciesVariant3.fromJson(Map<String, dynamic> json) { return BookmarkApplication4PoliciesVariant3(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BookmarkApplication4PoliciesVariant3 &&
