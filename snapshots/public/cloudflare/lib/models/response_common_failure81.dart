...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_kv_messages2.dart';@immutable final class ResponseCommonFailure81 {const ResponseCommonFailure81({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'ResponseCommonFailure81(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
