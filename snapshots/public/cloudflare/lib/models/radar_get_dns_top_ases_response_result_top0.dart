...
final class RadarGetDnsTopAsesResponseResultTop0 {const RadarGetDnsTopAsesResponseResultTop0({required this.clientAsn, required this.clientAsName, required this.value, });
