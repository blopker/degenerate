...
@immutable final class RadarGetAttacksLayer3SummaryByVectorResponseResultMetaNormalization {const RadarGetAttacksLayer3SummaryByVectorResponseResultMetaNormalization._(this.value);
...
@immutable final class RadarGetAttacksLayer3SummaryByVectorResponseResultMeta {const RadarGetAttacksLayer3SummaryByVectorResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
