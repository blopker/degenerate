...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class GetPresetsPresetIdResponseDataPermissionsConnectedMeetings {const GetPresetsPresetIdResponseDataPermissionsConnectedMeetings({required this.canAlterConnectedMeetings, required this.canSwitchConnectedMeetings, required this.canSwitchToParentMeeting, });

factory GetPresetsPresetIdResponseDataPermissionsConnectedMeetings.fromJson(Map<String, dynamic> json) { return GetPresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
GetPresetsPresetIdResponseDataPermissionsConnectedMeetings copyWith({bool? canAlterConnectedMeetings, bool? canSwitchConnectedMeetings, bool? canSwitchToParentMeeting, }) { return GetPresetsPresetIdResponseDataPermissionsConnectedMeetings(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetPresetsPresetIdResponseDataPermissionsConnectedMeetings &&
...
@override String toString() { return 'GetPresetsPresetIdResponseDataPermissionsConnectedMeetings(canAlterConnectedMeetings: $canAlterConnectedMeetings, canSwitchConnectedMeetings: $canSwitchConnectedMeetings, canSwitchToParentMeeting: $canSwitchToParentMeeting)'; } 
 }
