...
@immutable final class ZonesMinTlsVersion {const ZonesMinTlsVersion({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesMinTlsVersion copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesMinTlsVersionValue? value, }) { return ZonesMinTlsVersion(
