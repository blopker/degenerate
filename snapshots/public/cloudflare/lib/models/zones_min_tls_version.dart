...
@immutable final class ZonesMinTlsVersion {const ZonesMinTlsVersion({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
