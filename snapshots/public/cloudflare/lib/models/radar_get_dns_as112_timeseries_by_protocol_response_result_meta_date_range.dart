...
final class RadarGetDnsAs112TimeseriesByProtocolResponseResultMetaDateRange {const RadarGetDnsAs112TimeseriesByProtocolResponseResultMetaDateRange({required this.endTime, required this.startTime, });
