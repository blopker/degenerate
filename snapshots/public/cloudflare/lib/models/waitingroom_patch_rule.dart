...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waitingroom_rule_action.dart';import 'waitingroom_rule_description.dart';import 'waitingroom_rule_enabled.dart';import 'waitingroom_rule_expression.dart';import 'waitingroom_rule_position.dart';import 'waitingroom_rule_position_variant1.dart';import 'waitingroom_rule_position_variant2.dart';import 'waitingroom_rule_position_variant3.dart';@immutable final class WaitingroomPatchRule {const WaitingroomPatchRule({required this.action, required this.expression, this.description, this.enabled, this.position, });
