...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_message.dart';final class EmailSecurityUpdateAllowPolicyResponse4Xx {const EmailSecurityUpdateAllowPolicyResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
