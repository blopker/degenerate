...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_connector.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminConnectorListResponse {const MconnAdminConnectorListResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminConnectorListResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, List<MconnAdminConnector>? result, }) {return MconnAdminConnectorListResponse(
...
@override String toString() {return 'MconnAdminConnectorListResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
