...
import 'dlp_dataset_upload_status.dart';final class DlpDatasetUpload {const DlpDatasetUpload({required this.numCells, required this.status, required this.version, });
