...
@immutable final class BrapiPostScrapeRequestVariant2Viewport {const BrapiPostScrapeRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostScrapeRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostScrapeRequestVariant2Viewport(
...
BrapiPostScrapeRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostScrapeRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostScrapeRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostScrapeRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
