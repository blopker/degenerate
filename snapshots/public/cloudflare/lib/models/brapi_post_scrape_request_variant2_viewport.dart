...
final class BrapiPostScrapeRequestVariant2Viewport {const BrapiPostScrapeRequestVariant2Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });
