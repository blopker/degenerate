...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AccessOneloginRequestConfig {const AccessOneloginRequestConfig({this.clientId, this.clientSecret, this.claims, this.emailClaimName, this.oneloginAccount, });

factory AccessOneloginRequestConfig.fromJson(Map<String, dynamic> json) {return AccessOneloginRequestConfig(
...
AccessOneloginRequestConfig copyWith({String? Function()? clientId, String? Function()? clientSecret, List<String>? Function()? claims, String? Function()? emailClaimName, String? Function()? oneloginAccount, }) {return AccessOneloginRequestConfig(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AccessOneloginRequestConfig &&
...
@override String toString() {return 'AccessOneloginRequestConfig(clientId: $clientId, clientSecret: $clientSecret, claims: $claims, emailClaimName: $emailClaimName, oneloginAccount: $oneloginAccount)';}
}
