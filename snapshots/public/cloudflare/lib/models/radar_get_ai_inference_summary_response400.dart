...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ai_inference_summary_response400_errors.dart';@immutable final class RadarGetAiInferenceSummaryResponse400 {const RadarGetAiInferenceSummaryResponse400({required this.errors, required this.result, required this.success, });
