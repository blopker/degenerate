...
final List<AigConfigFetchDatasetResponse404Errors> errors;
...
AigConfigFetchDatasetResponse404 copyWith({List<AigConfigFetchDatasetResponse404Errors>? errors, bool? success, }) { return AigConfigFetchDatasetResponse404(
  errors: errors ?? this.errors,
  success: success ?? this.success,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AigConfigFetchDatasetResponse404 &&
          listEquals(errors, other.errors) &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), success); } 
@override String toString() { return 'AigConfigFetchDatasetResponse404(errors: $errors, success: $success)'; } 
 }
