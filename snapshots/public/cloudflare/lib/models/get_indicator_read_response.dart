...
factory GetIndicatorReadResponse.fromJson(Map<String, dynamic> json) { return GetIndicatorReadResponse(
  ...
  relatedEvents: (json['relatedEvents'] as List<dynamic>?)?.map((e) => GetIndicatorReadResponseRelatedEvents.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<GetIndicatorReadResponseRelatedEvents>? relatedEvents;
