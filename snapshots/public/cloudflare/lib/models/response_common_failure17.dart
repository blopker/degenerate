...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloud_connector_messages2.dart';@immutable final class ResponseCommonFailure17 {const ResponseCommonFailure17({required this.errors, required this.messages, required this.result, required this.success, });
