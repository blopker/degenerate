...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_messages2.dart';import 'tls_certificates_and_hostnames_setting_object_delete.dart';@immutable final class TlsCertificatesAndHostnamesPerHostnameSettingsResponseDelete {const TlsCertificatesAndHostnamesPerHostnameSettingsResponseDelete({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesPerHostnameSettingsResponseDelete copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesSettingObjectDelete? Function()? result, }) { return TlsCertificatesAndHostnamesPerHostnameSettingsResponseDelete(
...
@override String toString() { return 'TlsCertificatesAndHostnamesPerHostnameSettingsResponseDelete(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
