...
factory ResponseCollection3.fromJson(Map<String, dynamic> json) { return ResponseCollection3(
  ...
  resultInfo: json['result_info'] != null ? ResponseCollection3ResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
); }
...
final ResponseCollection3ResultInfo? resultInfo;
...
ResponseCollection3 copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, ResponseCollection3ResultInfo Function()? resultInfo, }) { return ResponseCollection3(
...
@override String toString() { return 'ResponseCollection3(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)'; } 
 }
