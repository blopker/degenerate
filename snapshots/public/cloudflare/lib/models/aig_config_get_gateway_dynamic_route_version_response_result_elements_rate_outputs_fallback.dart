...
final class AigConfigGetGatewayDynamicRouteVersionResponseResultElementsRateOutputsFallback {const AigConfigGetGatewayDynamicRouteVersionResponseResultElementsRateOutputsFallback({required this.elementId});
