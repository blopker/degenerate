...
import 'workers_binding_name.dart';final class WorkersBindingKindPlainText {const WorkersBindingKindPlainText({required this.name, required this.text, required this.type, });
