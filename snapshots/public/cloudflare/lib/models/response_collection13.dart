...
factory ResponseCollection13.fromJson(Map<String, dynamic> json) { return ResponseCollection13(
  ...
  resultInfo: json['result_info'] != null ? ResponseCollection13ResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
); }
...
final ResponseCollection13ResultInfo? resultInfo;
...
ResponseCollection13 copyWith({List<DnsFirewallMessages2>? errors, List<DnsFirewallMessages2>? messages, bool? success, ResponseCollection13ResultInfo Function()? resultInfo, }) { return ResponseCollection13(
...
@override String toString() { return 'ResponseCollection13(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo)'; } 
 }
