...
final class DlpDatasetsCreateRequest {const DlpDatasetsCreateRequest({this.caseSensitive, this.description, this.encodingVersion, required this.name, this.secret, });
