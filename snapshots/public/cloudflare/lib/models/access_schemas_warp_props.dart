...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_apps_components_schemas_session_duration.dart';import 'access_schemas_auto_redirect_to_identity.dart';@immutable final class AccessSchemasWarpProps {const AccessSchemasWarpProps({required this.type, this.allowedIdps, this.autoRedirectToIdentity, this.domain = const Omittable.absent(), this.name = const Omittable.absent(), this.sessionDuration, });
...
AccessSchemasWarpProps copyWith({List<String>? Function()? allowedIdps, AccessSchemasAutoRedirectToIdentity? Function()? autoRedirectToIdentity, Omittable<dynamic>? domain, Omittable<dynamic>? name, AccessAppsComponentsSchemasSessionDuration? Function()? sessionDuration, String? type, }) { return AccessSchemasWarpProps(
