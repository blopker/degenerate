...
final class AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptionsStorageType {const AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptionsStorageType._(this.value);
...
factory AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptions.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptions(
  ...
  storageType: json.containsKey('storage_type') ? AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptionsStorageType.fromJson(json['storage_type'] as String) : AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptionsStorageType.r2,
); }
