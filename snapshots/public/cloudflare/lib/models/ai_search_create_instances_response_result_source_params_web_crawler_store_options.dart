...
@immutable final class AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptions {const AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptions({required this.storageId, this.r2Jurisdiction = 'default', this.storageType = AiSearchCreateInstancesResponseResultSourceParamsWebCrawlerStoreOptionsStorageType.r2, });
