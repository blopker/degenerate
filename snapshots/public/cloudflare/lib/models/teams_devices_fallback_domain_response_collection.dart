...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'teams_devices_fallback_domain.dart';import 'teams_devices_messages2.dart';import 'teams_devices_result_info.dart';@immutable final class TeamsDevicesFallbackDomainResponseCollection {const TeamsDevicesFallbackDomainResponseCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
TeamsDevicesFallbackDomainResponseCollection copyWith({List<TeamsDevicesMessages2>? errors, List<TeamsDevicesMessages2>? messages, List<TeamsDevicesFallbackDomain>? result, bool? success, TeamsDevicesResultInfo Function()? resultInfo, }) { return TeamsDevicesFallbackDomainResponseCollection(
...
@override String toString() { return 'TeamsDevicesFallbackDomainResponseCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
