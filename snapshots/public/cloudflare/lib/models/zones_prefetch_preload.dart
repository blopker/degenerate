...
@immutable final class ZonesPrefetchPreload {const ZonesPrefetchPreload({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
