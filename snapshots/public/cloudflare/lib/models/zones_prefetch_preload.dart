...
@immutable final class ZonesPrefetchPreload {const ZonesPrefetchPreload({required this.id, required this.value, this.editable = true, this.modifiedOn = const Omittable.absent(), });
...
ZonesPrefetchPreload copyWith({bool Function()? editable, dynamic Function()? id, Omittable<DateTime?>? modifiedOn, ZonesPrefetchPreloadValue? value, }) { return ZonesPrefetchPreload(
