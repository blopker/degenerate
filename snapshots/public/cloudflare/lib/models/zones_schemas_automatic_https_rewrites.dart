...
@immutable final class ZonesSchemasAutomaticHttpsRewrites {const ZonesSchemasAutomaticHttpsRewrites({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
