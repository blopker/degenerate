...
@immutable final class ZonesSchemasAutomaticHttpsRewrites {const ZonesSchemasAutomaticHttpsRewrites({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesSchemasAutomaticHttpsRewrites copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesAutomaticHttpsRewritesValue? value, }) { return ZonesSchemasAutomaticHttpsRewrites(
