...
@immutable final class DnsRecordsDnskeyRecordRequestData {const DnsRecordsDnskeyRecordRequestData({this.algorithm, this.flags, this.protocol, this.publicKey, });

factory DnsRecordsDnskeyRecordRequestData.fromJson(Map<String, dynamic> json) { return DnsRecordsDnskeyRecordRequestData(
...
DnsRecordsDnskeyRecordRequestData copyWith({double? Function()? algorithm, double? Function()? flags, double? Function()? protocol, String? Function()? publicKey, }) { return DnsRecordsDnskeyRecordRequestData(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DnsRecordsDnskeyRecordRequestData &&
          algorithm == other.algorithm &&
          flags == other.flags &&
          protocol == other.protocol &&
          publicKey == other.publicKey; } 
@override int get hashCode { return Object.hash(algorithm, flags, protocol, publicKey); } 
@override String toString() { return 'DnsRecordsDnskeyRecordRequestData(algorithm: $algorithm, flags: $flags, protocol: $protocol, publicKey: $publicKey)'; } 
 }
