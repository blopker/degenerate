...
WorListWorkflowsResponseErrors copyWith({double? code, String? message, }) { return WorListWorkflowsResponseErrors(
  code: code ?? this.code,
...
@override String toString() { return 'WorListWorkflowsResponseErrors(code: $code, message: $message)'; } 
 }
