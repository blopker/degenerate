...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'iam_permission_group.dart';import 'iam_result_info.dart';import 'iam_schemas_messages2.dart';@immutable final class IamCollectionPermissionGroupsResponse {const IamCollectionPermissionGroupsResponse({required this.errors, required this.messages, required this.success, this.resultInfo, this.result, });
...
IamCollectionPermissionGroupsResponse copyWith({List<IamSchemasMessages2>? errors, List<IamSchemasMessages2>? messages, bool? success, IamResultInfo? Function()? resultInfo, List<IamPermissionGroup>? Function()? result, }) { return IamCollectionPermissionGroupsResponse(
...
@override String toString() { return 'IamCollectionPermissionGroupsResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
