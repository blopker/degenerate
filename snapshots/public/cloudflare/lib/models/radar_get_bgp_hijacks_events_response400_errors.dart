...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetBgpHijacksEventsResponse400Errors {const RadarGetBgpHijacksEventsResponse400Errors({required this.message});
