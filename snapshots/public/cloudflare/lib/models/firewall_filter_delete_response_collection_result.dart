...
import 'firewall_filters_components_schemas_id.dart';final class FirewallFilterDeleteResponseCollectionResult {const FirewallFilterDeleteResponseCollectionResult({this.id});
