...
import 'package:collection/collection.dart';final class InfraResolverNetwork {const InfraResolverNetwork({this.resolverIps, required this.tunnelId, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InfraResolverNetwork &&
          const ListEquality<dynamic>().equals(resolverIps, other.resolverIps) &&
