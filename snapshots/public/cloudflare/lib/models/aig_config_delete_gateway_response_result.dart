...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_delete_gateway_response_result_dlp.dart';import 'aig_config_delete_gateway_response_result_otel.dart';import 'aig_config_delete_gateway_response_result_stripe.dart';@immutable final class AigConfigDeleteGatewayResponseResultLogManagementStrategy {const AigConfigDeleteGatewayResponseResultLogManagementStrategy._(this.value);
...
@immutable final class AigConfigDeleteGatewayResponseResultRateLimitingTechnique {const AigConfigDeleteGatewayResponseResultRateLimitingTechnique._(this.value);
...
@immutable final class AigConfigDeleteGatewayResponseResultWorkersAiBillingMode {const AigConfigDeleteGatewayResponseResultWorkersAiBillingMode._(this.value);
...
factory AigConfigDeleteGatewayResponseResult.fromJson(Map<String, dynamic> json) {return AigConfigDeleteGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? AigConfigDeleteGatewayResponseResultDlp.fromJson(json['dlp']) : null,
  ...
  workersAiBillingMode: json['workers_ai_billing_mode'] != null ? AigConfigDeleteGatewayResponseResultWorkersAiBillingMode.fromJson(json['workers_ai_billing_mode'] as String) : null,
...
AigConfigDeleteGatewayResponseResultWorkersAiBillingMode get workersAiBillingModeOrDefault {return workersAiBillingMode ?? AigConfigDeleteGatewayResponseResultWorkersAiBillingMode.fromJson('postpaid');}
