...
@immutable final class BrapiPostScrapeRequestVariant2GotoOptions {const BrapiPostScrapeRequestVariant2GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostScrapeRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScrapeRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostScrapeRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
); }
