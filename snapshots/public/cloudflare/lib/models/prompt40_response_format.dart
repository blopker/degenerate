...
final class Prompt40ResponseFormatType {const Prompt40ResponseFormatType._(this.value);
...
final class Prompt40ResponseFormat {const Prompt40ResponseFormat({this.jsonSchema, this.type, });
