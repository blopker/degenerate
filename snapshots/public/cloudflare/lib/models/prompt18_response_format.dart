...
@immutable final class Prompt18ResponseFormat {const Prompt18ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt18ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt18ResponseFormatType? Function()? type, }) { return Prompt18ResponseFormat(
