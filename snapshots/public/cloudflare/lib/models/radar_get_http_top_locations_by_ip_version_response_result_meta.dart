...
final class RadarGetHttpTopLocationsByIpVersionResponseResultMetaNormalization {const RadarGetHttpTopLocationsByIpVersionResponseResultMetaNormalization._(this.value);
...
final class RadarGetHttpTopLocationsByIpVersionResponseResultMeta {const RadarGetHttpTopLocationsByIpVersionResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
