...
@immutable final class AccessPingoneScimConfigIdentityUpdateBehavior {const AccessPingoneScimConfigIdentityUpdateBehavior._(this.value);

factory AccessPingoneScimConfigIdentityUpdateBehavior.fromJson(String json) { return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessPingoneScimConfigIdentityUpdateBehavior._(json),
}; }

static const AccessPingoneScimConfigIdentityUpdateBehavior automatic = AccessPingoneScimConfigIdentityUpdateBehavior._('automatic');

static const AccessPingoneScimConfigIdentityUpdateBehavior reauth = AccessPingoneScimConfigIdentityUpdateBehavior._('reauth');

static const AccessPingoneScimConfigIdentityUpdateBehavior noAction = AccessPingoneScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessPingoneScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AccessPingoneScimConfigIdentityUpdateBehavior && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'AccessPingoneScimConfigIdentityUpdateBehavior($value)'; } 
 }
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessPingoneScimConfig {const AccessPingoneScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessPingoneScimConfig.fromJson(Map<String, dynamic> json) { return AccessPingoneScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessPingoneScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessPingoneScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessPingoneScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault { return identityUpdateBehavior ?? AccessPingoneScimConfigIdentityUpdateBehavior.fromJson('no_action'); } 
/// The value with the schema default applied when absent.
...
AccessPingoneScimConfig copyWith({bool? Function()? enabled, AccessPingoneScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) { return AccessPingoneScimConfig(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccessPingoneScimConfig &&
...
@override String toString() { return 'AccessPingoneScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)'; } 
 }
