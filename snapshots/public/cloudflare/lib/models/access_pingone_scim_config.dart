...
@immutable final class AccessPingoneScimConfig {const AccessPingoneScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessPingoneScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessPingoneScimConfig.fromJson(Map<String, dynamic> json) { return AccessPingoneScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessPingoneScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessPingoneScimConfigIdentityUpdateBehavior.noAction,
