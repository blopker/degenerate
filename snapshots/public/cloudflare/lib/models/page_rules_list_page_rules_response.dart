...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'zones_page_rule.dart';import 'zones_schemas_messages2.dart';final class PageRulesListPageRulesResponse {const PageRulesListPageRulesResponse({required this.errors, required this.messages, required this.success, this.result, });
