...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Messages10ResponseFormatType {const Messages10ResponseFormatType._(this.value);
...
@immutable final class Messages10ResponseFormat {const Messages10ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Messages10ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Messages10ResponseFormatType? Function()? type, }) { return Messages10ResponseFormat(
