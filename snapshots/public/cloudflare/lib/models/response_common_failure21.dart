...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_indicator_feeds_messages2.dart';final class ResponseCommonFailure21 {const ResponseCommonFailure21({required this.errors, required this.messages, required this.result, required this.success, });
