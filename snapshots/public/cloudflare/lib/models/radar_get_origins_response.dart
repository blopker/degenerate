...
import 'radar_get_origins_response_result.dart';final class RadarGetOriginsResponse {const RadarGetOriginsResponse({required this.result, required this.success, });
