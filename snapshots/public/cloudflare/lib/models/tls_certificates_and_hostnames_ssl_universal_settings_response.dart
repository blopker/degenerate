...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_messages2.dart';import 'tls_certificates_and_hostnames_universal.dart';@immutable final class TlsCertificatesAndHostnamesSslUniversalSettingsResponse {const TlsCertificatesAndHostnamesSslUniversalSettingsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesSslUniversalSettingsResponse copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesUniversal? Function()? result, }) { return TlsCertificatesAndHostnamesSslUniversalSettingsResponse(
...
@override String toString() { return 'TlsCertificatesAndHostnamesSslUniversalSettingsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
