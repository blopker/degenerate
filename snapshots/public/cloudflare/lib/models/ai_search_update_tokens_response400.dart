...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_update_tokens_response400_errors.dart';@immutable final class AiSearchUpdateTokensResponse400 {const AiSearchUpdateTokensResponse400({required this.errors, required this.success, });
