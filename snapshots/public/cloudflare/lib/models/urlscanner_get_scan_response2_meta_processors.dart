...
import 'urlscanner_get_scan_response2_meta_processors_asn.dart';import 'urlscanner_get_scan_response2_meta_processors_dns.dart';import 'urlscanner_get_scan_response2_meta_processors_domain_categories.dart';import 'urlscanner_get_scan_response2_meta_processors_geoip.dart';import 'urlscanner_get_scan_response2_meta_processors_phishing.dart';import 'urlscanner_get_scan_response2_meta_processors_radar_rank.dart';import 'urlscanner_get_scan_response2_meta_processors_robots_txt.dart';import 'urlscanner_get_scan_response2_meta_processors_url_categories.dart';import 'urlscanner_get_scan_response2_meta_processors_wappa.dart';final class UrlscannerGetScanResponse2MetaProcessors {const UrlscannerGetScanResponse2MetaProcessors({required this.asn, required this.dns, required this.domainCategories, required this.geoip, required this.phishing, required this.radarRank, this.robotsTxt, this.urlCategories, required this.wappa, });
...
factory UrlscannerGetScanResponse2MetaProcessors.fromJson(Map<String, dynamic> json) { return UrlscannerGetScanResponse2MetaProcessors(
  asn: UrlscannerGetScanResponse2MetaProcessorsAsn.fromJson(json['asn'] as Map<String, dynamic>),
  dns: UrlscannerGetScanResponse2MetaProcessorsDns.fromJson(json['dns'] as Map<String, dynamic>),
  domainCategories: UrlscannerGetScanResponse2MetaProcessorsDomainCategories.fromJson(json['domainCategories'] as Map<String, dynamic>),
...
final UrlscannerGetScanResponse2MetaProcessorsDomainCategories domainCategories;
