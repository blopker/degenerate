...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'argo_analytics_messages2.dart';@immutable final class ArgoAnalyticsForGeolocationArgoAnalyticsForAZoneAtDifferentPoPsResponse4Xx {const ArgoAnalyticsForGeolocationArgoAnalyticsForAZoneAtDifferentPoPsResponse4Xx({required this.errors, required this.messages, required this.result, required this.success, });
...
@override String toString() { return 'ArgoAnalyticsForGeolocationArgoAnalyticsForAZoneAtDifferentPoPsResponse4Xx(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
