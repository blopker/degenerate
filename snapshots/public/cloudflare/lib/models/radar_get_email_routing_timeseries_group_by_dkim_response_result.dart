...
import 'radar_get_email_routing_timeseries_group_by_dkim_response_result_meta.dart';import 'radar_get_email_routing_timeseries_group_by_dkim_response_result_serie0.dart';final class RadarGetEmailRoutingTimeseriesGroupByDkimResponseResult {const RadarGetEmailRoutingTimeseriesGroupByDkimResponseResult({required this.meta, required this.serie0, });
