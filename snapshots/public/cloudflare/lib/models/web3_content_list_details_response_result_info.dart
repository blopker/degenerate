...
@immutable
final class Web3ContentListDetailsResponseResultInfo {
  const Web3ContentListDetailsResponseResultInfo({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Web3ContentListDetailsResponseResultInfo._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory Web3ContentListDetailsResponseResultInfo.fromJson(Object? json) => Web3ContentListDetailsResponseResultInfo._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Web3ContentListDetailsResponseResultInfo && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Web3ContentListDetailsResponseResultInfo(${toJson()})';
}
