...
final class ListsMessages2 {const ListsMessages2({required this.code, required this.message, });
...
@override String toString() { return 'ListsMessages2(code: $code, message: $message)'; } 
 }
