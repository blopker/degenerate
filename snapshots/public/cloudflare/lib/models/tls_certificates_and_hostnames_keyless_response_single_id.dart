...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_keyless_response_single_id_result.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesKeylessResponseSingleId {const TlsCertificatesAndHostnamesKeylessResponseSingleId({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesKeylessResponseSingleId copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesKeylessResponseSingleIdResult? Function()? result, }) { return TlsCertificatesAndHostnamesKeylessResponseSingleId(
...
@override String toString() { return 'TlsCertificatesAndHostnamesKeylessResponseSingleId(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
