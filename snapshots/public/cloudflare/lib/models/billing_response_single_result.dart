...
import 'components_schemas_identifier.dart';final class BillingResponseSingleResult {const BillingResponseSingleResult({this.accountType, this.address, this.address2, this.balance, this.cardExpiryMonth, this.cardExpiryYear, this.cardNumber, this.city, this.company, this.country, this.createdOn, this.deviceData, this.editedOn, this.enterpriseBillingEmail, this.enterprisePrimaryEmail, this.firstName, this.id, this.isPartner, this.lastName, this.nextBillDate, this.paymentAddress, this.paymentAddress2, this.paymentCity, this.paymentCountry, this.paymentEmail, this.paymentFirstName, this.paymentGateway, this.paymentLastName, this.paymentNonce, this.paymentState, this.paymentZipcode, this.primaryEmail, this.state, this.taxIdType, this.telephone, this.useLegacy, this.validationCode, this.vat, this.zipcode, });
