...
import 'radar_get_attacks_layer3_timeseries_group_by_ip_version_response_result.dart';final class RadarGetAttacksLayer3TimeseriesGroupByIpVersionResponse {const RadarGetAttacksLayer3TimeseriesGroupByIpVersionResponse({required this.result, required this.success, });
