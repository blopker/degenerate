...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'magic_visibility_pcaps_messages2.dart';import 'magic_visibility_pcaps_pcaps_ownership_response.dart';import 'magic_visibility_pcaps_result_info.dart';@immutable final class MagicVisibilityPcapsPcapsOwnershipCollection {const MagicVisibilityPcapsPcapsOwnershipCollection({required this.errors, required this.messages, required this.result, required this.success, this.resultInfo, });
...
MagicVisibilityPcapsPcapsOwnershipCollection copyWith({List<MagicVisibilityPcapsMessages2>? errors, List<MagicVisibilityPcapsMessages2>? messages, List<MagicVisibilityPcapsPcapsOwnershipResponse>? Function()? result, bool? success, MagicVisibilityPcapsResultInfo? Function()? resultInfo, }) { return MagicVisibilityPcapsPcapsOwnershipCollection(
...
@override String toString() { return 'MagicVisibilityPcapsPcapsOwnershipCollection(errors: $errors, messages: $messages, result: $result, success: $success, resultInfo: $resultInfo)'; } 
 }
