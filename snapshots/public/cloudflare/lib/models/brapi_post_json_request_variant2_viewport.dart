...
final class BrapiPostJsonRequestVariant2Viewport {const BrapiPostJsonRequestVariant2Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });
