...
@immutable final class BrapiPostJsonRequestVariant2Viewport {const BrapiPostJsonRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostJsonRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant2Viewport(
...
BrapiPostJsonRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostJsonRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostJsonRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostJsonRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
