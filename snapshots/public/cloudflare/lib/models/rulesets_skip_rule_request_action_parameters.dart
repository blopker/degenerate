...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_rule_id.dart';import 'rulesets_ruleset_id.dart';import 'rulesets_ruleset_phase.dart';import 'rulesets_skip_phase.dart';import 'rulesets_skip_products2.dart';import 'rulesets_skip_ruleset.dart';@immutable final class RulesetsSkipRuleRequestActionParameters {const RulesetsSkipRuleRequestActionParameters({this.phase, this.phases, this.products, this.rules, this.ruleset, this.rulesets, });

factory RulesetsSkipRuleRequestActionParameters.fromJson(Map<String, dynamic> json) {return RulesetsSkipRuleRequestActionParameters(
...
RulesetsSkipRuleRequestActionParameters copyWith({RulesetsSkipPhase? Function()? phase, List<RulesetsRulesetPhase>? Function()? phases, List<RulesetsSkipProducts2>? Function()? products, Map<String, List<RulesetsRuleId>>? Function()? rules, RulesetsSkipRuleset? Function()? ruleset, List<RulesetsRulesetId>? Function()? rulesets, }) {return RulesetsSkipRuleRequestActionParameters(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is RulesetsSkipRuleRequestActionParameters &&
          phase == other.phase &&
...
@override String toString() {return 'RulesetsSkipRuleRequestActionParameters(phase: $phase, phases: $phases, products: $products, rules: $rules, ruleset: $ruleset, rulesets: $rulesets)';}
}
