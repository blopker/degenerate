...
final class RadarGetCtTimeseriesGroupResponseResultMetaDateRange {const RadarGetCtTimeseriesGroupResponseResultMetaDateRange({required this.endTime, required this.startTime, });
