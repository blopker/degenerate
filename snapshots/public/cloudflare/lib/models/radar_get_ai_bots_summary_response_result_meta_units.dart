...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetAiBotsSummaryResponseResultMetaUnits {const RadarGetAiBotsSummaryResponseResultMetaUnits({required this.name, required this.value, });
