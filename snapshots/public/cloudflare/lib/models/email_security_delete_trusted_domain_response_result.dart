...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class EmailSecurityDeleteTrustedDomainResponseResult {const EmailSecurityDeleteTrustedDomainResponseResult({required this.id});
