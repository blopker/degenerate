...
final class BrapiPostJsonRequestVariant1WaitForSelector {const BrapiPostJsonRequestVariant1WaitForSelector({this.hidden, required this.selector, this.timeout, this.visible, });
