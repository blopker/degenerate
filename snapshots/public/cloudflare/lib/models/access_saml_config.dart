...
final List<AccessSamlConfigHeaderAttributes>? headerAttributes;
...
@override String toString() { return 'AccessSamlConfig(attributes: $attributes, emailAttributeName: $emailAttributeName, headerAttributes: $headerAttributes, idpPublicCerts: $idpPublicCerts, issuerUrl: $issuerUrl, signRequest: $signRequest, ssoTargetUrl: $ssoTargetUrl)'; } 
 }
