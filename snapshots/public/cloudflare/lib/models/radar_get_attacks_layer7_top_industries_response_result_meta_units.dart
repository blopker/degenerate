...
final class RadarGetAttacksLayer7TopIndustriesResponseResultMetaUnits {const RadarGetAttacksLayer7TopIndustriesResponseResultMetaUnits({required this.name, required this.value, });
