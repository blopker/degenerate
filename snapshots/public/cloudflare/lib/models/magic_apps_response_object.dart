...
MagicAppsResponseObject copyWith({List<MagicMessages2>? errors, List<MagicMessages2>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return MagicAppsResponseObject(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is MagicAppsResponseObject &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), result, success); } 
@override String toString() { return 'MagicAppsResponseObject(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
