...
@immutable
final class Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo {
  const Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo.fromJson(Object? json) => Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Web3HostnameWeb3HostnameDetailsResponse5xxResultInfo(${toJson()})';
}
