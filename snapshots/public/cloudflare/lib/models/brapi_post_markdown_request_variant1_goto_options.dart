...
final class BrapiPostMarkdownRequestVariant1GotoOptions {const BrapiPostMarkdownRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
