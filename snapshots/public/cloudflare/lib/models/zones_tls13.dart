...
@immutable final class ZonesTls13 {const ZonesTls13({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesTls13 copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesTls13Value? value, }) { return ZonesTls13(
