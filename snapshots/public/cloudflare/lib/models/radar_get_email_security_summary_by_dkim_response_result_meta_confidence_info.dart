...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_email_security_summary_by_dkim_response_result_meta_confidence_info_annotations.dart';@immutable final class RadarGetEmailSecuritySummaryByDkimResponseResultMetaConfidenceInfo {const RadarGetEmailSecuritySummaryByDkimResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
