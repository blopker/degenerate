...
factory UrlscannerGetScanResponseResultScanMetaProcessors.fromJson(Map<String, dynamic> json) { return UrlscannerGetScanResponseResultScanMetaProcessors(
  ...
  rank: UrlscannerGetScanResponseResultScanMetaProcessorsRank.fromJson(json['rank'] as Map<String, dynamic>),
  tech: (json['tech'] as List<dynamic>).map((e) => UrlscannerGetScanResponseResultScanMetaProcessorsTech.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
UrlscannerGetScanResponseResultScanMetaProcessors copyWith({UrlscannerGetScanResponseResultScanMetaProcessorsCategories? categories, List<String>? phishing, UrlscannerGetScanResponseResultScanMetaProcessorsRank? rank, List<UrlscannerGetScanResponseResultScanMetaProcessorsTech>? tech, }) { return UrlscannerGetScanResponseResultScanMetaProcessors(
...
@override String toString() { return 'UrlscannerGetScanResponseResultScanMetaProcessors(categories: $categories, phishing: $phishing, rank: $rank, tech: $tech)'; } 
 }
