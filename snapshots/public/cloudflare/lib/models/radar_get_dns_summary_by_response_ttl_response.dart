...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_dns_summary_by_response_ttl_response_result.dart';@immutable final class RadarGetDnsSummaryByResponseTtlResponse {const RadarGetDnsSummaryByResponseTtlResponse({required this.result, required this.success, });
