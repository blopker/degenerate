...
final class RadarGetDnsSummaryByResponseCodeResponseResultMetaNormalization {const RadarGetDnsSummaryByResponseCodeResponseResultMetaNormalization._(this.value);
...
final class RadarGetDnsSummaryByResponseCodeResponseResultMeta {const RadarGetDnsSummaryByResponseCodeResponseResultMeta({required this.confidenceInfo, required this.dateRange, required this.lastUpdated, required this.normalization, required this.units, });
