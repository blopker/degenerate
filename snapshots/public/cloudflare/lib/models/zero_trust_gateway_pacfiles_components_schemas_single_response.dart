...
import 'zero_trust_gateway_pacfile.dart';final class ZeroTrustGatewayPacfilesComponentsSchemasSingleResponse {const ZeroTrustGatewayPacfilesComponentsSchemasSingleResponse({this.result});
