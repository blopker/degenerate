...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class UrlscannerCreateScanResponse4002Errors {const UrlscannerCreateScanResponse4002Errors({required this.detail, required this.status, required this.title, });
