...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rum_messages2.dart';import 'rum_result_info.dart';import 'rum_site.dart';final class RumSitesResponseCollection {const RumSitesResponseCollection({required this.errors, required this.messages, required this.success, this.result, this.resultInfo, });
