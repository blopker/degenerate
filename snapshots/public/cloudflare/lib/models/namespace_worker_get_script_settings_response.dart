...
NamespaceWorkerGetScriptSettingsResponse copyWith({List<WorkersMessages2>? errors, List<WorkersMessages2>? messages, bool? success, WorkersNamespaceScriptAndVersionSettingsItemResponse? Function()? result, }) {return NamespaceWorkerGetScriptSettingsResponse(
