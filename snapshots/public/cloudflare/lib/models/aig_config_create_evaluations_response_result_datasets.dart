...
factory AigConfigCreateEvaluationsResponseResultDatasets.fromJson(Map<String, dynamic> json) { return AigConfigCreateEvaluationsResponseResultDatasets(
  ...
  filters: (json['filters'] as List<dynamic>).map((e) => AigConfigCreateEvaluationsResponseResultDatasetsFilters.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AigConfigCreateEvaluationsResponseResultDatasetsFilters> filters;
...
AigConfigCreateEvaluationsResponseResultDatasets copyWith({String? accountId, String? accountTag, DateTime? createdAt, bool? enable, List<AigConfigCreateEvaluationsResponseResultDatasetsFilters>? filters, String? gatewayId, String? id, DateTime? modifiedAt, String? name, }) { return AigConfigCreateEvaluationsResponseResultDatasets(
