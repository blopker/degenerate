...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aaa_components_schemas_messages2.dart';import 'aaa_policies.dart';@immutable final class NotificationPoliciesGetANotificationPolicyResponse4Xx {const NotificationPoliciesGetANotificationPolicyResponse4Xx({required this.errors, required this.messages, required this.success, this.result, });
...
@override String toString() { return 'NotificationPoliciesGetANotificationPolicyResponse4Xx(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
