...
factory WorkersScriptResponseCollection.fromJson(Map<String, dynamic> json) { return WorkersScriptResponseCollection(
  ...
  result: (json['result'] as List<dynamic>).map((e) => WorkersScriptResponseCollectionResult.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
final List<WorkersScriptResponseCollectionResult> result;
...
WorkersScriptResponseCollection copyWith({List<WorkersMessages2>? errors, List<WorkersMessages2>? messages, bool? success, List<WorkersScriptResponseCollectionResult>? result, }) { return WorkersScriptResponseCollection(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersScriptResponseCollection &&
...
@override String toString() { return 'WorkersScriptResponseCollection(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
