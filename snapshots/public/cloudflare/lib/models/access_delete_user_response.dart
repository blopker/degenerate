...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_messages2.dart';@immutable final class AccessDeleteUserResponse {const AccessDeleteUserResponse({required this.errors, required this.messages, required this.success, this.result = const Omittable.absent(), });
...
AccessDeleteUserResponse copyWith({List<AccessMessages2>? errors, List<AccessMessages2>? messages, bool? success, Omittable<Map<String,dynamic>?>? result, }) { return AccessDeleteUserResponse(
...
@override String toString() { return 'AccessDeleteUserResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
