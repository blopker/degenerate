...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_update_instances_response_result_source_params_web_crawler.dart';@immutable final class AiSearchUpdateInstancesResponseResultSourceParams {const AiSearchUpdateInstancesResponseResultSourceParams({this.excludeItems, this.includeItems, this.prefix, this.r2Jurisdiction = 'default', this.webCrawler, });
