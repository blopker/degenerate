...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logpush_logpush_job.dart';import 'logpush_messages2.dart';@immutable final class LogpushLogpushJobResponseSingle {const LogpushLogpushJobResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
