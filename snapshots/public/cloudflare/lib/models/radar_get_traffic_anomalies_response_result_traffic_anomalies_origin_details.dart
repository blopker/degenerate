...
final class RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesOriginDetails {const RadarGetTrafficAnomaliesResponseResultTrafficAnomaliesOriginDetails({required this.name, required this.origin, });
