...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_app_policy_link.dart';import 'access_custom_deny_url.dart';import 'access_custom_non_identity_deny_url.dart';import 'access_schemas_auto_redirect_to_identity.dart';import 'access_schemas_session_duration.dart';import 'access_schemas_uuid.dart';import 'access_type.dart';import 'device_enrollment_permissions_application_policies.dart';import 'device_enrollment_permissions_application_policies_variant3.dart';@immutable final class DeviceEnrollmentPermissionsApplication {const DeviceEnrollmentPermissionsApplication({required this.type, this.allowedIdps, this.autoRedirectToIdentity, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.domain = const Omittable.absent(), this.name = const Omittable.absent(), this.sessionDuration, this.policies, });
...
factory DeviceEnrollmentPermissionsApplication.fromJson(Map<String, dynamic> json) { return DeviceEnrollmentPermissionsApplication(
  ...
  policies: (json['policies'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => AccessAppPolicyLink.fromJson(v as Map<String, dynamic>), fromB: (v) => AccessSchemasUuid.fromJson(v as String), fromC: (v) => DeviceEnrollmentPermissionsApplicationPoliciesVariant3.fromJson(v as Map<String, dynamic>),)).toList(),
); }
...
final List<DeviceEnrollmentPermissionsApplicationPolicies>? policies;
...
@override String toString() { return 'DeviceEnrollmentPermissionsApplication(allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, customDenyUrl: $customDenyUrl, customNonIdentityDenyUrl: $customNonIdentityDenyUrl, customPages: $customPages, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type, policies: $policies)'; } 
 }
