...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_ai_post_run_cf_deepgram_nova3_response400_errors.dart';final class WorkersAiPostRunCfDeepgramNova3Response400 {const WorkersAiPostRunCfDeepgramNova3Response400({required this.errors, required this.result, required this.success, });
