...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'spectrum_analytics_messages2.dart';@immutable final class ResponseCommon63 {const ResponseCommon63({required this.errors, required this.messages, required this.success, });
