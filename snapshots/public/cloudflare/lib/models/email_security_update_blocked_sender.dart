...
import 'email_security_pattern_type.dart';final class EmailSecurityUpdateBlockedSender {const EmailSecurityUpdateBlockedSender({this.comments, this.isRegex, this.pattern, this.patternType, });
