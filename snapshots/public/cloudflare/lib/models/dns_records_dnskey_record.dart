...
factory DnsRecordsDnskeyRecord.fromJson(Map<String, dynamic> json) { return DnsRecordsDnskeyRecord(
  ...
  data: json['data'] != null ? DnsRecordsDnskeyRecordData.fromJson(json['data'] as Map<String, dynamic>) : null,
  type: json['type'] != null ? DnsRecordsDnskeyRecordType.fromJson(json['type'] as String) : null,
); }
...
final DnsRecordsDnskeyRecordData? data;

/// Record type.
final DnsRecordsDnskeyRecordType? type;
...
DnsRecordsDnskeyRecord copyWith({DnsRecordsComment Function()? comment, DnsRecordsName Function()? name, DnsRecordsProxied Function()? proxied, DnsRecordsSettings Function()? settings, List<String> Function()? tags, DnsRecordsTtl Function()? ttl, String Function()? content, DnsRecordsDnskeyRecordData Function()? data, DnsRecordsDnskeyRecordType Function()? type, }) { return DnsRecordsDnskeyRecord(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DnsRecordsDnskeyRecord &&
...
@override String toString() { return 'DnsRecordsDnskeyRecord(comment: $comment, name: $name, proxied: $proxied, settings: $settings, tags: $tags, ttl: $ttl, content: $content, data: $data, type: $type)'; } 
 }
