...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_apps_components_schemas_name.dart';import 'access_apps_components_schemas_session_duration.dart';import 'access_components_schemas_domain.dart';import 'access_schemas_auto_redirect_to_identity.dart';@immutable final class AccessSchemasAppLauncherPropsRequest {const AccessSchemasAppLauncherPropsRequest({required this.type, this.allowedIdps, this.autoRedirectToIdentity, this.domain, this.name, this.sessionDuration, });

factory AccessSchemasAppLauncherPropsRequest.fromJson(Map<String, dynamic> json) { return AccessSchemasAppLauncherPropsRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccessSchemasAppLauncherPropsRequest &&
...
@override String toString() { return 'AccessSchemasAppLauncherPropsRequest(allowedIdps: $allowedIdps, autoRedirectToIdentity: $autoRedirectToIdentity, domain: $domain, name: $name, sessionDuration: $sessionDuration, type: $type)'; } 
 }
