...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waf_managed_rules_messages2.dart';import 'waf_managed_rules_result_info.dart';@immutable final class WafRuleGroupsListWafRuleGroupsResponse4Xx {const WafRuleGroupsListWafRuleGroupsResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });

factory WafRuleGroupsListWafRuleGroupsResponse4Xx.fromJson(Map<String, dynamic> json) { return WafRuleGroupsListWafRuleGroupsResponse4Xx(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WafRuleGroupsListWafRuleGroupsResponse4Xx &&
...
@override String toString() { return 'WafRuleGroupsListWafRuleGroupsResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
