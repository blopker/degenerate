...
@immutable final class AccessGoogleScimConfigIdentityUpdateBehavior {const AccessGoogleScimConfigIdentityUpdateBehavior._(this.value);

factory AccessGoogleScimConfigIdentityUpdateBehavior.fromJson(String json) {return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessGoogleScimConfigIdentityUpdateBehavior._(json),
};}

static const AccessGoogleScimConfigIdentityUpdateBehavior automatic = AccessGoogleScimConfigIdentityUpdateBehavior._('automatic');

static const AccessGoogleScimConfigIdentityUpdateBehavior reauth = AccessGoogleScimConfigIdentityUpdateBehavior._('reauth');

static const AccessGoogleScimConfigIdentityUpdateBehavior noAction = AccessGoogleScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessGoogleScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) {return identical(this, other) ||
    other is AccessGoogleScimConfigIdentityUpdateBehavior && other.value == value;}
@override int get hashCode {return value.hashCode;}
@override String toString() {return 'AccessGoogleScimConfigIdentityUpdateBehavior($value)';}
}
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessGoogleScimConfig {const AccessGoogleScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessGoogleScimConfig.fromJson(Map<String, dynamic> json) {return AccessGoogleScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessGoogleScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessGoogleScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessGoogleScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault {return identityUpdateBehavior ?? AccessGoogleScimConfigIdentityUpdateBehavior.fromJson('no_action');}
/// The value with the schema default applied when absent.
...
AccessGoogleScimConfig copyWith({bool? Function()? enabled, AccessGoogleScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) {return AccessGoogleScimConfig(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is AccessGoogleScimConfig &&
...
@override String toString() {return 'AccessGoogleScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)';}
}
