...
@immutable final class AccessGoogleScimConfig {const AccessGoogleScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessGoogleScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessGoogleScimConfig.fromJson(Map<String, dynamic> json) { return AccessGoogleScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessGoogleScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessGoogleScimConfigIdentityUpdateBehavior.noAction,
