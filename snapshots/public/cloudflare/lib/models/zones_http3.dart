...
@immutable final class ZonesHttp3 {const ZonesHttp3({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesHttp3 copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesHttp3Value? value, }) { return ZonesHttp3(
