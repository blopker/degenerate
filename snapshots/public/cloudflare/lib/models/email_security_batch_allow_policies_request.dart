...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_batch_allow_policies_request_deletes.dart';import 'email_security_create_allow_policy.dart';import 'email_security_update_allow_policy.dart';final class EmailSecurityBatchAllowPoliciesRequest {const EmailSecurityBatchAllowPoliciesRequest({required this.deletes, required this.patches, required this.posts, required this.puts, });
...
factory EmailSecurityBatchAllowPoliciesRequest.fromJson(Map<String, dynamic> json) { return EmailSecurityBatchAllowPoliciesRequest(
  ...
  patches: (json['patches'] as List<dynamic>).map((e) => EmailSecurityUpdateAllowPolicy.fromJson(e as Map<String, dynamic>)).toList(),
  posts: (json['posts'] as List<dynamic>).map((e) => EmailSecurityCreateAllowPolicy.fromJson(e as Map<String, dynamic>)).toList(),
  puts: (json['puts'] as List<dynamic>).map((e) => EmailSecurityCreateAllowPolicy.fromJson(e as Map<String, dynamic>)).toList(),
); }
...
EmailSecurityBatchAllowPoliciesRequest copyWith({List<EmailSecurityBatchAllowPoliciesRequestDeletes>? deletes, List<EmailSecurityUpdateAllowPolicy>? patches, List<EmailSecurityCreateAllowPolicy>? posts, List<EmailSecurityCreateAllowPolicy>? puts, }) { return EmailSecurityBatchAllowPoliciesRequest(
