...
@immutable final class Prompt47ResponseFormat {const Prompt47ResponseFormat({this.jsonSchema = const Omittable.absent(), this.type, });
...
Prompt47ResponseFormat copyWith({Omittable<dynamic>? jsonSchema, Prompt47ResponseFormatType? Function()? type, }) { return Prompt47ResponseFormat(
