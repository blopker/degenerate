...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'urlscanner_get_scan_response2_data_requests_response_response_security_details.dart';import 'urlscanner_get_scan_response2_data_requests_response_response_security_headers.dart';final class UrlscannerGetScanResponse2DataRequestsResponseResponse {const UrlscannerGetScanResponse2DataRequestsResponseResponse({required this.charset, this.headers, required this.mimeType, required this.protocol, required this.remoteIpAddress, required this.remotePort, required this.securityDetails, required this.securityHeaders, required this.securityState, required this.status, required this.statusText, required this.url, });
