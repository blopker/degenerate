...
import 'logpush_id.dart';final class DeleteAccountsAccountIdLogpushJobsJobIdResponseResult {const DeleteAccountsAccountIdLogpushJobsJobIdResponseResult({this.id});
