...
@immutable final class ZonesPseudoIpv4 {const ZonesPseudoIpv4({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesPseudoIpv4 copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesPseudoIpv4Value? value, }) { return ZonesPseudoIpv4(
