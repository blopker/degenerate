...
factory RadarGetAttacksLayer3TopAttacksResponseResult.fromJson(Map<String, dynamic> json) { return RadarGetAttacksLayer3TopAttacksResponseResult(
  ...
  top0: (json['top_0'] as List<dynamic>).map((e) => RadarGetAttacksLayer3TopAttacksResponseResultTop0.fromJson(e as Map<String, dynamic>)).toList(),
); }

/// Metadata for the results.
final RadarGetAttacksLayer3TopAttacksResponseResultMeta meta;

final List<RadarGetAttacksLayer3TopAttacksResponseResultTop0> top0;
...
RadarGetAttacksLayer3TopAttacksResponseResult copyWith({RadarGetAttacksLayer3TopAttacksResponseResultMeta? meta, List<RadarGetAttacksLayer3TopAttacksResponseResultTop0>? top0, }) { return RadarGetAttacksLayer3TopAttacksResponseResult(
  meta: meta ?? this.meta,
  top0: top0 ?? this.top0,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetAttacksLayer3TopAttacksResponseResult &&
          meta == other.meta &&
          listEquals(top0, other.top0); } 
@override int get hashCode { return Object.hash(meta, Object.hashAll(top0)); } 
@override String toString() { return 'RadarGetAttacksLayer3TopAttacksResponseResult(meta: $meta, top0: $top0)'; } 
 }
