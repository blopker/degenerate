...
@immutable final class TieredCachingGetTieredCachingSettingResponseResult {const TieredCachingGetTieredCachingSettingResponseResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
TieredCachingGetTieredCachingSettingResponseResult copyWith({TieredCachingGetTieredCachingSettingResponseResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesTieredCacheValue? value, }) { return TieredCachingGetTieredCachingSettingResponseResult(
  id: id ?? this.id,
