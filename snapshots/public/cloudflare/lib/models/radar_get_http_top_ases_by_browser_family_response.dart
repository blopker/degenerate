...
import 'radar_get_http_top_ases_by_browser_family_response_result.dart';final class RadarGetHttpTopAsesByBrowserFamilyResponse {const RadarGetHttpTopAsesByBrowserFamilyResponse({required this.result, required this.success, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetHttpTopAsesByBrowserFamilyResponse &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(result, success); } 
@override String toString() { return 'RadarGetHttpTopAsesByBrowserFamilyResponse(result: $result, success: $success)'; } 
 }
