...
import 'radar_get_leaked_credential_checks_summary_response_result_meta.dart';final class RadarGetLeakedCredentialChecksSummaryResponseResult {const RadarGetLeakedCredentialChecksSummaryResponseResult({required this.meta, required this.summary0, });
