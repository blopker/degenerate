...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'email_security_get_message_raw_response_result.dart';import 'email_security_message.dart';final class EmailSecurityGetMessageRawResponse {const EmailSecurityGetMessageRawResponse({required this.errors, required this.messages, required this.success, required this.result, });
