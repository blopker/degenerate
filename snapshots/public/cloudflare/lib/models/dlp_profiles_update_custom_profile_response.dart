...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_profile.dart';import 'dlp_profile.dart';import 'integration_profile.dart';import 'predefined_profile.dart';@immutable final class DlpProfilesUpdateCustomProfileResponse {const DlpProfilesUpdateCustomProfileResponse({this.result});
...
@override String toString() { return 'DlpProfilesUpdateCustomProfileResponse(result: $result)'; } 
 }
