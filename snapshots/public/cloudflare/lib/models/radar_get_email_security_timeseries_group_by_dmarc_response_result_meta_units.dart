...
final class RadarGetEmailSecurityTimeseriesGroupByDmarcResponseResultMetaUnits {const RadarGetEmailSecurityTimeseriesGroupByDmarcResponseResultMetaUnits({required this.name, required this.value, });
