...
final class RadarGetEmailRoutingSummaryByIpVersionResponseResultMetaUnits {const RadarGetEmailRoutingSummaryByIpVersionResponseResultMetaUnits({required this.name, required this.value, });
