...
import 'messages22_source.dart';final class Messages22 {const Messages22({required this.code, this.documentationUrl, required this.message, this.source, });
...
@override String toString() { return 'Messages22(code: $code, documentationUrl: $documentationUrl, message: $message, source: $source)'; } 
 }
