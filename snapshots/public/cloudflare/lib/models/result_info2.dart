...
final class ResultInfo2 {const ResultInfo2({this.count, this.page, this.perPage, this.totalCount, });
...
@override String toString() { return 'ResultInfo2(count: $count, page: $page, perPage: $perPage, totalCount: $totalCount)'; } 
 }
