...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ranking_top_internet_services_response_result_meta_confidence_info_annotations.dart';final class RadarGetRankingTopInternetServicesResponseResultMetaConfidenceInfo {const RadarGetRankingTopInternetServicesResponseResultMetaConfidenceInfo({required this.annotations, required this.level, });
