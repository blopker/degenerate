...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'logpush_instant_logs_job.dart';import 'logpush_messages2.dart';final class LogpushInstantLogsJobResponseCollection {const LogpushInstantLogsJobResponseCollection({required this.errors, required this.messages, required this.success, this.result, });
