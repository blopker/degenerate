...
@immutable final class ZonesMaxUpload {const ZonesMaxUpload({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
ZonesMaxUpload copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, ZonesMaxUploadValue? value, }) { return ZonesMaxUpload(
