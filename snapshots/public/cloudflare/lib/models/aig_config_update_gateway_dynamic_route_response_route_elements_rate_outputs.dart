...
import 'aig_config_update_gateway_dynamic_route_response_route_elements_rate_outputs_fallback.dart';import 'aig_config_update_gateway_dynamic_route_response_route_elements_rate_outputs_success.dart';final class AigConfigUpdateGatewayDynamicRouteResponseRouteElementsRateOutputs {const AigConfigUpdateGatewayDynamicRouteResponseRouteElementsRateOutputs({required this.fallback, required this.success, });
