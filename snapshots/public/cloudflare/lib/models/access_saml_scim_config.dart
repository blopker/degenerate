...
@immutable final class AccessSamlScimConfigIdentityUpdateBehavior {const AccessSamlScimConfigIdentityUpdateBehavior._(this.value);

factory AccessSamlScimConfigIdentityUpdateBehavior.fromJson(String json) { return switch (json) {
  'automatic' => automatic,
  'reauth' => reauth,
  'no_action' => noAction,
  _ => AccessSamlScimConfigIdentityUpdateBehavior._(json),
}; }

static const AccessSamlScimConfigIdentityUpdateBehavior automatic = AccessSamlScimConfigIdentityUpdateBehavior._('automatic');

static const AccessSamlScimConfigIdentityUpdateBehavior reauth = AccessSamlScimConfigIdentityUpdateBehavior._('reauth');

static const AccessSamlScimConfigIdentityUpdateBehavior noAction = AccessSamlScimConfigIdentityUpdateBehavior._('no_action');

static const List<AccessSamlScimConfigIdentityUpdateBehavior> values = [automatic, reauth, noAction];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AccessSamlScimConfigIdentityUpdateBehavior && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'AccessSamlScimConfigIdentityUpdateBehavior($value)'; } 
 }
/// The configuration settings for enabling a System for Cross-Domain Identity Management (SCIM) with the identity provider.
@immutable final class AccessSamlScimConfig {const AccessSamlScimConfig({this.enabled, this.identityUpdateBehavior, this.scimBaseUrl, this.seatDeprovision, this.secret, this.userDeprovision, });

factory AccessSamlScimConfig.fromJson(Map<String, dynamic> json) { return AccessSamlScimConfig(
  enabled: json['enabled'] as bool?,
  identityUpdateBehavior: json['identity_update_behavior'] != null ? AccessSamlScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : null,
...
final AccessSamlScimConfigIdentityUpdateBehavior? identityUpdateBehavior;
...
/// The value with the schema default applied when absent.
AccessSamlScimConfigIdentityUpdateBehavior get identityUpdateBehaviorOrDefault { return identityUpdateBehavior ?? AccessSamlScimConfigIdentityUpdateBehavior.fromJson('no_action'); } 
/// The value with the schema default applied when absent.
...
AccessSamlScimConfig copyWith({bool? Function()? enabled, AccessSamlScimConfigIdentityUpdateBehavior? Function()? identityUpdateBehavior, String? Function()? scimBaseUrl, bool? Function()? seatDeprovision, String? Function()? secret, bool? Function()? userDeprovision, }) { return AccessSamlScimConfig(
...
@override String toString() { return 'AccessSamlScimConfig(enabled: $enabled, identityUpdateBehavior: $identityUpdateBehavior, scimBaseUrl: $scimBaseUrl, seatDeprovision: $seatDeprovision, secret: $secret, userDeprovision: $userDeprovision)'; } 
 }
