...
@immutable final class AccessSamlScimConfig {const AccessSamlScimConfig({this.enabled = false, this.identityUpdateBehavior = AccessSamlScimConfigIdentityUpdateBehavior.noAction, this.scimBaseUrl, this.seatDeprovision = false, this.secret, this.userDeprovision = false, });
...
factory AccessSamlScimConfig.fromJson(Map<String, dynamic> json) { return AccessSamlScimConfig(
  ...
  identityUpdateBehavior: json.containsKey('identity_update_behavior') ? AccessSamlScimConfigIdentityUpdateBehavior.fromJson(json['identity_update_behavior'] as String) : AccessSamlScimConfigIdentityUpdateBehavior.noAction,
