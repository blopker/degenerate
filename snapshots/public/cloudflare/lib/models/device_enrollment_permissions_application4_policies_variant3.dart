...
@immutable final class DeviceEnrollmentPermissionsApplication4PoliciesVariant3 {const DeviceEnrollmentPermissionsApplication4PoliciesVariant3({required this.decision, required this.include, required this.name, this.precedence, this.approvalGroups, this.approvalRequired, this.connectionRules, this.isolationRequired, this.mfaConfig, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.sessionDuration, this.exclude, this.require, this.id, });

factory DeviceEnrollmentPermissionsApplication4PoliciesVariant3.fromJson(Map<String, dynamic> json) {return DeviceEnrollmentPermissionsApplication4PoliciesVariant3(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is DeviceEnrollmentPermissionsApplication4PoliciesVariant3 &&
