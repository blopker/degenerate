...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dlp_custom_entry.dart';import 'dlp_document_fingerprint_entry.dart';import 'dlp_entry.dart';import 'dlp_exact_data_entry.dart';import 'dlp_integration_entry.dart';import 'dlp_predefined_entry.dart';import 'dlp_word_list_entry.dart';final class DlpPredefinedProfileConfig {const DlpPredefinedProfileConfig({this.aiContextEnabled = false, required this.allowedMatchCount, this.confidenceThreshold = 'low', required this.enabledEntries, required this.entries, required this.id, required this.name, this.ocrEnabled = false, this.openAccess, });
