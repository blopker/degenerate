...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bot_management_feedback_type.dart';import 'bot_management_metric_requests.dart';@immutable final class BotManagementFeedbackReportRequest {const BotManagementFeedbackReportRequest({required this.description, required this.expression, required this.firstRequestSeenAt, required this.lastRequestSeenAt, required this.requests, required this.requestsByAttribute, required this.requestsByScore, required this.requestsByScoreSrc, required this.type, this.subtype, });

factory BotManagementFeedbackReportRequest.fromJson(Map<String, dynamic> json) {return BotManagementFeedbackReportRequest(
...
@override bool operator ==(Object other) {return identical(this, other) ||
      other is BotManagementFeedbackReportRequest &&
          ...
          type == other.type;}
@override int get hashCode {return Object.hash(description, expression, firstRequestSeenAt, lastRequestSeenAt, requests, requestsByAttribute, requestsByScore, requestsByScoreSrc, subtype, type);}
@override String toString() {return 'BotManagementFeedbackReportRequest(description: $description, expression: $expression, firstRequestSeenAt: $firstRequestSeenAt, lastRequestSeenAt: $lastRequestSeenAt, requests: $requests, requestsByAttribute: $requestsByAttribute, requestsByScore: $requestsByScore, requestsByScoreSrc: $requestsByScoreSrc, subtype: $subtype, type: $type)';}
}
