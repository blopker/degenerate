...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_connector.dart';import 'mconn_coded_message.dart';@immutable final class MconnCreateConnectorResponse {const MconnCreateConnectorResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnCreateConnectorResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminConnector? result, }) {return MconnCreateConnectorResponse(
...
@override String toString() {return 'MconnCreateConnectorResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
