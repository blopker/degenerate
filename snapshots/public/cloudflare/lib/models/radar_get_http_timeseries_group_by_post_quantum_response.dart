...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_http_timeseries_group_by_post_quantum_response_result.dart';@immutable final class RadarGetHttpTimeseriesGroupByPostQuantumResponse {const RadarGetHttpTimeseriesGroupByPostQuantumResponse({required this.result, required this.success, });
