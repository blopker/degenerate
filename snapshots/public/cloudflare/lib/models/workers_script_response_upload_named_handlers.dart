...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class WorkersScriptResponseUploadNamedHandlers {const WorkersScriptResponseUploadNamedHandlers({this.handlers, this.name, });
