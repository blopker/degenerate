...
import 'dlp_payload_log_setting.dart';final class DlpPayloadLogPutResponse {const DlpPayloadLogPutResponse({this.result});
...
@override String toString() { return 'DlpPayloadLogPutResponse(result: $result)'; } 
 }
