...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'digital_experience_monitoring_messages2.dart';import 'digital_experience_monitoring_traceroute_details_response.dart';@immutable final class DexEndpointsTracerouteTestDetailsResponse {const DexEndpointsTracerouteTestDetailsResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DexEndpointsTracerouteTestDetailsResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, DigitalExperienceMonitoringTracerouteDetailsResponse? Function()? result, }) { return DexEndpointsTracerouteTestDetailsResponse(
...
@override String toString() { return 'DexEndpointsTracerouteTestDetailsResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
