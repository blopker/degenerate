...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aaa_components_schemas_messages2.dart';import 'aaa_silence.dart';final class AaaSilenceComponentsSchemasResponseCollection {const AaaSilenceComponentsSchemasResponseCollection({required this.errors, required this.messages, required this.success, this.result, });
