...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'waf_managed_rules_messages2.dart';import 'waf_managed_rules_result_info.dart';@immutable final class WafRulesListWafRulesResponse4Xx {const WafRulesListWafRulesResponse4Xx({required this.errors, required this.messages, required this.success, required this.result, this.resultInfo, });
...
@override String toString() { return 'WafRulesListWafRulesResponse4Xx(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
