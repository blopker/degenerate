...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_admin_device.dart';import 'mconn_coded_message.dart';@immutable final class MconnAdminDeviceFetchResponse {const MconnAdminDeviceFetchResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnAdminDeviceFetchResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnAdminDevice? result, }) {return MconnAdminDeviceFetchResponse(
...
@override String toString() {return 'MconnAdminDeviceFetchResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
