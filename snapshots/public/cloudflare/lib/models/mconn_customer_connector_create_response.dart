...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_customer_connector.dart';@immutable final class MconnCustomerConnectorCreateResponse {const MconnCustomerConnectorCreateResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
factory MconnCustomerConnectorCreateResponse.fromJson(Map<String, dynamic> json) {return MconnCustomerConnectorCreateResponse(
  ...
  result: MconnCustomerConnector.fromJson(json['result'] as Map<String, dynamic>),
);}
...
MconnCustomerConnectorCreateResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnCustomerConnector? result, }) {return MconnCustomerConnectorCreateResponse(
...
@override String toString() {return 'MconnCustomerConnectorCreateResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
