...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'digital_experience_monitoring_device_dex_test_schemas_http.dart';import 'digital_experience_monitoring_messages2.dart';@immutable final class DigitalExperienceMonitoringDexSingleResponse {const DigitalExperienceMonitoringDexSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
DigitalExperienceMonitoringDexSingleResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, DigitalExperienceMonitoringDeviceDexTestSchemasHttp? Function()? result, }) { return DigitalExperienceMonitoringDexSingleResponse(
...
@override String toString() { return 'DigitalExperienceMonitoringDexSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
