...
@immutable final class BrapiPostSnapshotRequestVariant1GotoOptions {const BrapiPostSnapshotRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout, this.waitUntil, });
...
factory BrapiPostSnapshotRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostSnapshotRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil']) : null,
); }
