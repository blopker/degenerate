...
@immutable final class BrapiPostSnapshotRequestVariant1GotoOptions {const BrapiPostSnapshotRequestVariant1GotoOptions({this.referer, this.referrerPolicy, this.timeout = 30000.0, this.waitUntil, });
