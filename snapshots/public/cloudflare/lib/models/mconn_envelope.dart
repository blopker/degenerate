...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';@immutable final class MconnEnvelope {const MconnEnvelope({required this.success, this.errors, this.messages, });
