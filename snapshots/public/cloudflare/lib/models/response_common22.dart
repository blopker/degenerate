...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'dns_analytics_messages2.dart';@immutable final class ResponseCommon22 {const ResponseCommon22({required this.errors, required this.messages, required this.success, });
