...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'healthchecks_messages2.dart';@immutable final class ResponseCommonFailure36 {const ResponseCommonFailure36({required this.errors, required this.messages, required this.result, required this.success, });
