...
final class RadarGetDnsTopLocationsResponseResultMetaUnits {const RadarGetDnsTopLocationsResponseResultMetaUnits({required this.name, required this.value, });
