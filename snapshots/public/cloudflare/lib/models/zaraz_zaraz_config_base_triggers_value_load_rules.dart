...
@immutable
final class ZarazZarazConfigBaseTriggersValueLoadRules {
  const ZarazZarazConfigBaseTriggersValueLoadRules({this.zarazLoadRule = const Omittable.absent(),
...
this.zarazElementVisibilityRule = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ZarazZarazConfigBaseTriggersValueLoadRules._({required this.rawValue, required this.zarazLoadRule,
...
required this.zarazElementVisibilityRule,});
  factory ZarazZarazConfigBaseTriggersValueLoadRules.fromJson(Object? json) => ZarazZarazConfigBaseTriggersValueLoadRules._(
...
if (zarazElementVisibilityRule.isPresent) zarazElementVisibilityRule.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ZarazZarazConfigBaseTriggersValueLoadRules && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ZarazZarazConfigBaseTriggersValueLoadRules(${toJson()})';
}
