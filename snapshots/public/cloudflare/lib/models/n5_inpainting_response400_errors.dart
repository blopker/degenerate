...
$5InpaintingResponse400Errors copyWith({String? code, String? message, }) { return $5InpaintingResponse400Errors(
  code: code ?? this.code,
  message: message ?? this.message,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is $5InpaintingResponse400Errors &&
          code == other.code &&
          message == other.message; } 
@override int get hashCode { return Object.hash(code, message); } 
@override String toString() { return '\$5InpaintingResponse400Errors(code: $code, message: $message)'; } 
 }
