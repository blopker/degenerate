...
final class RadarGetEmailSecuritySummaryBySpamResponseResultMetaDateRange {const RadarGetEmailSecuritySummaryBySpamResponseResultMetaDateRange({required this.endTime, required this.startTime, });
