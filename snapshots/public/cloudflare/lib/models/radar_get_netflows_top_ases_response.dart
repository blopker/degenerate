...
import 'radar_get_netflows_top_ases_response_result.dart';final class RadarGetNetflowsTopAsesResponse {const RadarGetNetflowsTopAsesResponse({required this.result, required this.success, });
