...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'response_message.dart';@immutable final class DeleteDeviceResponse {const DeleteDeviceResponse({required this.errors, required this.messages, required this.success, this.result = const Omittable.absent(), });
...
DeleteDeviceResponse copyWith({List<ResponseMessage>? errors, List<ResponseMessage>? messages, Omittable<Map<String,dynamic>?>? result, bool? success, }) { return DeleteDeviceResponse(
...
@override String toString() { return 'DeleteDeviceResponse(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
