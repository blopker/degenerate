...
@immutable final class ZonesSecurityHeader {const ZonesSecurityHeader({required this.id, required this.value, this.editable, this.modifiedOn = const Omittable.absent(), });
