...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RadarGetHttpSummaryResponse400Errors {const RadarGetHttpSummaryResponse400Errors({required this.message});
