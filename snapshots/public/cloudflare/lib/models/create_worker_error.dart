...
return  CreateWorkerError400(CreateWorkerResponse400.fromJson(json as Map<String, dynamic>));case 401:
final json = jsonDecode(response.body);
return  CreateWorkerError401(CreateWorkerResponse401.fromJson(json as Map<String, dynamic>));case 403:
final json = jsonDecode(response.body);
return  CreateWorkerError403(CreateWorkerResponse403.fromJson(json as Map<String, dynamic>));case 409:
final json = jsonDecode(response.body);
return  CreateWorkerError409(CreateWorkerResponse409.fromJson(json as Map<String, dynamic>));case 500:
final json = jsonDecode(response.body);
return  CreateWorkerError500(CreateWorkerResponse500.fromJson(json as Map<String, dynamic>));default:
