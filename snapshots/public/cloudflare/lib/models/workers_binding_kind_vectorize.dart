...
import 'workers_binding_name.dart';final class WorkersBindingKindVectorize {const WorkersBindingKindVectorize({required this.indexName, required this.name, required this.type, });
