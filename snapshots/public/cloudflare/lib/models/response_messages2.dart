...
final class ResponseMessages2 {const ResponseMessages2({required this.code, required this.message, });
...
@override String toString() { return 'ResponseMessages2(code: $code, message: $message)'; } 
 }
