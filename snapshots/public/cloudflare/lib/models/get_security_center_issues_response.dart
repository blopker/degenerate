...
factory GetSecurityCenterIssuesResponse.fromJson(Map<String, dynamic> json) { return GetSecurityCenterIssuesResponse(
  ...
  result: json['result'] != null ? GetSecurityCenterIssuesResponseResult.fromJson(json['result'] as Map<String, dynamic>) : null,
); }
...
final GetSecurityCenterIssuesResponseResult? result;
...
GetSecurityCenterIssuesResponse copyWith({List<SecurityCenterMessages2>? errors, List<SecurityCenterMessages2>? messages, bool? success, GetSecurityCenterIssuesResponseResult Function()? result, }) { return GetSecurityCenterIssuesResponse(
