...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AiSearchFetchTokensResponseResult {const AiSearchFetchTokensResponseResult({required this.cfApiId, required this.createdAt, required this.id, required this.modifiedAt, required this.name, this.createdBy = const Omittable.absent(), this.enabled = true, this.legacy = true, this.modifiedBy = const Omittable.absent(), });
...
AiSearchFetchTokensResponseResult copyWith({String? cfApiId, DateTime? createdAt, Omittable<String?>? createdBy, bool Function()? enabled, String? id, bool Function()? legacy, DateTime? modifiedAt, Omittable<String?>? modifiedBy, String? name, }) { return AiSearchFetchTokensResponseResult(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AiSearchFetchTokensResponseResult &&
...
@override String toString() { return 'AiSearchFetchTokensResponseResult(cfApiId: $cfApiId, createdAt: $createdAt, createdBy: $createdBy, enabled: $enabled, id: $id, legacy: $legacy, modifiedAt: $modifiedAt, modifiedBy: $modifiedBy, name: $name)'; } 
 }
