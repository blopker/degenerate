...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_ranking_internet_services_timeseries_response400_errors.dart';final class RadarGetRankingInternetServicesTimeseriesResponse400 {const RadarGetRankingInternetServicesTimeseriesResponse400({required this.errors, required this.result, required this.success, });
