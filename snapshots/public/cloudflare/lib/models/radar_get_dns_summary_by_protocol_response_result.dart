...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_dns_summary_by_protocol_response_result_meta.dart';import 'radar_get_dns_summary_by_protocol_response_result_summary0.dart';@immutable final class RadarGetDnsSummaryByProtocolResponseResult {const RadarGetDnsSummaryByProtocolResponseResult({required this.meta, required this.summary0, });
