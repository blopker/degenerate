...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer3_summary_by_protocol_response_result.dart';@immutable final class RadarGetAttacksLayer3SummaryByProtocolResponse {const RadarGetAttacksLayer3SummaryByProtocolResponse({required this.result, required this.success, });
