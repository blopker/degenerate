...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'radar_get_attacks_layer3_summary_by_ip_version_response_result.dart';@immutable final class RadarGetAttacksLayer3SummaryByIpVersionResponse {const RadarGetAttacksLayer3SummaryByIpVersionResponse({required this.result, required this.success, });
