...
import 'radar_get_attacks_layer3_summary_by_ip_version_response_result.dart';final class RadarGetAttacksLayer3SummaryByIpVersionResponse {const RadarGetAttacksLayer3SummaryByIpVersionResponse({required this.result, required this.success, });
