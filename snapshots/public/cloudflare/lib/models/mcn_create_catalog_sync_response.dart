...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mcn_catalog_sync.dart';import 'mcn_error.dart';@immutable final class McnCreateCatalogSyncResponse {const McnCreateCatalogSyncResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
McnCreateCatalogSyncResponse copyWith({List<McnError>? messages, bool? success, List<McnError>? errors, McnCatalogSync? result, }) {return McnCreateCatalogSyncResponse(
...
@override String toString() {return 'McnCreateCatalogSyncResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
