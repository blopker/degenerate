...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_snapshot.dart';final class MconnCustomerSnapshotsGetLatestResult {const MconnCustomerSnapshotsGetLatestResult({required this.count, required this.items, });
