...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtimekit_generic_error_response_error.dart';@immutable final class RealtimekitGenericErrorResponse {const RealtimekitGenericErrorResponse({required this.error, required this.success, });
