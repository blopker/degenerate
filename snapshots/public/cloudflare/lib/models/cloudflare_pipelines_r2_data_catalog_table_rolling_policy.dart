...
@immutable final class CloudflarePipelinesR2DataCatalogTableRollingPolicy {const CloudflarePipelinesR2DataCatalogTableRollingPolicy({this.fileSizeBytes, this.inactivitySeconds, this.intervalSeconds, });

factory CloudflarePipelinesR2DataCatalogTableRollingPolicy.fromJson(Map<String, dynamic> json) { return CloudflarePipelinesR2DataCatalogTableRollingPolicy(
...
CloudflarePipelinesR2DataCatalogTableRollingPolicy copyWith({int Function()? fileSizeBytes, int Function()? inactivitySeconds, int Function()? intervalSeconds, }) { return CloudflarePipelinesR2DataCatalogTableRollingPolicy(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CloudflarePipelinesR2DataCatalogTableRollingPolicy &&
...
@override String toString() { return 'CloudflarePipelinesR2DataCatalogTableRollingPolicy(fileSizeBytes: $fileSizeBytes, inactivitySeconds: $inactivitySeconds, intervalSeconds: $intervalSeconds)'; } 
 }
