...
@immutable final class Zones0rtt {const Zones0rtt({required this.id, required this.value, this.editable = true, this.modifiedOn, });
...
Zones0rtt copyWith({bool Function()? editable, dynamic Function()? id, DateTime? Function()? modifiedOn, Zones0rttValue? value, }) { return Zones0rtt(
