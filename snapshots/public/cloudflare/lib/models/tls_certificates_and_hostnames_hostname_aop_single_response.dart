...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'tls_certificates_and_hostnames_hostname_certid_object.dart';import 'tls_certificates_and_hostnames_messages2.dart';@immutable final class TlsCertificatesAndHostnamesHostnameAopSingleResponse {const TlsCertificatesAndHostnamesHostnameAopSingleResponse({required this.errors, required this.messages, required this.success, this.result, });
...
TlsCertificatesAndHostnamesHostnameAopSingleResponse copyWith({List<TlsCertificatesAndHostnamesMessages2>? errors, List<TlsCertificatesAndHostnamesMessages2>? messages, bool? success, TlsCertificatesAndHostnamesHostnameCertidObject? Function()? result, }) { return TlsCertificatesAndHostnamesHostnameAopSingleResponse(
...
@override String toString() { return 'TlsCertificatesAndHostnamesHostnameAopSingleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
