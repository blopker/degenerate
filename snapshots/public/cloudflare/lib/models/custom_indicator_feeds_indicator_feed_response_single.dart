...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'custom_indicator_feeds_indicator_feed_item.dart';import 'custom_indicator_feeds_schemas_messages2.dart';@immutable final class CustomIndicatorFeedsIndicatorFeedResponseSingle {const CustomIndicatorFeedsIndicatorFeedResponseSingle({required this.errors, required this.messages, required this.success, this.result, });
...
CustomIndicatorFeedsIndicatorFeedResponseSingle copyWith({List<CustomIndicatorFeedsSchemasMessages2>? errors, List<CustomIndicatorFeedsSchemasMessages2>? messages, bool? success, CustomIndicatorFeedsIndicatorFeedItem? Function()? result, }) { return CustomIndicatorFeedsIndicatorFeedResponseSingle(
...
@override String toString() { return 'CustomIndicatorFeedsIndicatorFeedResponseSingle(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
