...
@immutable final class BrapiPostScreenshotRequestVariant2Viewport {const BrapiPostScreenshotRequestVariant2Viewport({required this.height, required this.width, this.deviceScaleFactor, this.hasTouch, this.isLandscape, this.isMobile, });

factory BrapiPostScreenshotRequestVariant2Viewport.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant2Viewport(
...
BrapiPostScreenshotRequestVariant2Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return BrapiPostScreenshotRequestVariant2Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BrapiPostScreenshotRequestVariant2Viewport &&
...
@override String toString() { return 'BrapiPostScreenshotRequestVariant2Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
