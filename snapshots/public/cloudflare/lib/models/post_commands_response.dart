...
factory PostCommandsResponse.fromJson(Map<String, dynamic> json) { return PostCommandsResponse(
  ...
  resultInfo: json['result_info'] != null ? PostCommandsResponseResultInfo.fromJson(json['result_info'] as Map<String, dynamic>) : null,
...
final PostCommandsResponseResultInfo? resultInfo;
...
PostCommandsResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, PostCommandsResponseResultInfo? Function()? resultInfo, DigitalExperienceMonitoringPostCommandsResponse? Function()? result, }) { return PostCommandsResponse(
...
@override String toString() { return 'PostCommandsResponse(errors: $errors, messages: $messages, success: $success, resultInfo: $resultInfo, result: $result)'; } 
 }
