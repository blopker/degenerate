...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'rulesets_rule_enabled.dart';import 'rulesets_rule_exposed_credential_check.dart';import 'rulesets_rule_id.dart';import 'rulesets_rule_logging.dart';import 'rulesets_rule_ratelimit.dart';@immutable final class RulesetsForceConnectionCloseRuleRequest {const RulesetsForceConnectionCloseRuleRequest({this.action = const Omittable.absent(), this.actionParameters, this.description = const Omittable.absent(), this.enabled, this.exposedCredentialCheck, this.expression, this.id, this.logging, this.ratelimit, this.ref, });

factory RulesetsForceConnectionCloseRuleRequest.fromJson(Map<String, dynamic> json) { return RulesetsForceConnectionCloseRuleRequest(
...
RulesetsForceConnectionCloseRuleRequest copyWith({Omittable<dynamic>? action, Map<String, dynamic>? Function()? actionParameters, Omittable<dynamic>? description, RulesetsRuleEnabled? Function()? enabled, RulesetsRuleExposedCredentialCheck? Function()? exposedCredentialCheck, String? Function()? expression, RulesetsRuleId? Function()? id, RulesetsRuleLogging? Function()? logging, RulesetsRuleRatelimit? Function()? ratelimit, String? Function()? ref, }) { return RulesetsForceConnectionCloseRuleRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RulesetsForceConnectionCloseRuleRequest &&
          action == other.action &&
...
@override String toString() { return 'RulesetsForceConnectionCloseRuleRequest(action: $action, actionParameters: $actionParameters, description: $description, enabled: $enabled, exposedCredentialCheck: $exposedCredentialCheck, expression: $expression, id: $id, logging: $logging, ratelimit: $ratelimit, ref: $ref)'; } 
 }
