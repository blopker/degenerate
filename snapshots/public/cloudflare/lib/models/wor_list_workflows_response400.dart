...
final List<WorListWorkflowsResponse400Errors> errors;
...
WorListWorkflowsResponse400 copyWith({List<WorListWorkflowsResponse400Errors>? errors, List<String>? messages, Map<String, dynamic>? Function()? result, bool? success, }) { return WorListWorkflowsResponse400(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorListWorkflowsResponse400 &&
          listEquals(errors, other.errors) &&
          listEquals(messages, other.messages) &&
          result == other.result &&
          success == other.success; } 
@override int get hashCode { return Object.hash(Object.hashAll(errors), Object.hashAll(messages), result, success); } 
@override String toString() { return 'WorListWorkflowsResponse400(errors: $errors, messages: $messages, result: $result, success: $success)'; } 
 }
