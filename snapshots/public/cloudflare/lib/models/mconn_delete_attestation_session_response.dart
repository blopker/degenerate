...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'mconn_coded_message.dart';import 'mconn_controller_attestation_session.dart';@immutable final class MconnDeleteAttestationSessionResponse {const MconnDeleteAttestationSessionResponse({required this.messages, required this.success, required this.errors, required this.result, });
...
MconnDeleteAttestationSessionResponse copyWith({List<MconnCodedMessage>? messages, bool? success, List<MconnCodedMessage>? errors, MconnControllerAttestationSession? result, }) {return MconnDeleteAttestationSessionResponse(
...
@override String toString() {return 'MconnDeleteAttestationSessionResponse(messages: $messages, success: $success, errors: $errors, result: $result)';}
}
