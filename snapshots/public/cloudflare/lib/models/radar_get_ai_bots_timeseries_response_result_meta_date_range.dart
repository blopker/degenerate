...
final class RadarGetAiBotsTimeseriesResponseResultMetaDateRange {const RadarGetAiBotsTimeseriesResponseResultMetaDateRange({required this.endTime, required this.startTime, });
