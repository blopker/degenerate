...
@immutable
final class ResponseCommon86Result {
  const ResponseCommon86Result({this.mapStringdynamic = const Omittable.absent(),
this.listdynamic = const Omittable.absent(),
this.string = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ResponseCommon86Result._({required this.rawValue, required this.mapStringdynamic,
required this.listdynamic,
required this.string,});
  factory ResponseCommon86Result.fromJson(Object? json) => ResponseCommon86Result._(
...
if (string.isPresent) string.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ResponseCommon86Result && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ResponseCommon86Result(${toJson()})';
}
