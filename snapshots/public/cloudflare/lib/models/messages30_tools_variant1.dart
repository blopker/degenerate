...
factory Messages30ToolsVariant1.fromJson(Map<String, dynamic> json) { return Messages30ToolsVariant1(
  ...
  parameters: Messages30ToolsVariant1Parameters.fromJson(json['parameters'] as Map<String, dynamic>),
); }
...
final Messages30ToolsVariant1Parameters parameters;
...
Messages30ToolsVariant1 copyWith({String? description, String? name, Messages30ToolsVariant1Parameters? parameters, }) { return Messages30ToolsVariant1(
  description: description ?? this.description,
  name: name ?? this.name,
  parameters: parameters ?? this.parameters,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Messages30ToolsVariant1 &&
          description == other.description &&
          name == other.name &&
          parameters == other.parameters; } 
@override int get hashCode { return Object.hash(description, name, parameters); } 
@override String toString() { return 'Messages30ToolsVariant1(description: $description, name: $name, parameters: $parameters)'; } 
 }
