...
CreateDexRuleResponse copyWith({List<DigitalExperienceMonitoringMessages2>? errors, List<DigitalExperienceMonitoringMessages2>? messages, bool? success, DigitalExperienceMonitoringDexRule? Function()? result, }) { return CreateDexRuleResponse(
...
@override String toString() { return 'CreateDexRuleResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
