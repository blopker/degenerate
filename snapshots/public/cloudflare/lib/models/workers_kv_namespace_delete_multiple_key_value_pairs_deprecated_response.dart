...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_kv_bulk_result.dart';import 'workers_kv_messages2.dart';@immutable final class WorkersKvNamespaceDeleteMultipleKeyValuePairsDeprecatedResponse {const WorkersKvNamespaceDeleteMultipleKeyValuePairsDeprecatedResponse({required this.errors, required this.messages, required this.success, this.result, });
...
WorkersKvNamespaceDeleteMultipleKeyValuePairsDeprecatedResponse copyWith({List<WorkersKvMessages2>? errors, List<WorkersKvMessages2>? messages, bool? success, WorkersKvBulkResult Function()? result, }) { return WorkersKvNamespaceDeleteMultipleKeyValuePairsDeprecatedResponse(
...
@override String toString() { return 'WorkersKvNamespaceDeleteMultipleKeyValuePairsDeprecatedResponse(errors: $errors, messages: $messages, success: $success, result: $result)'; } 
 }
