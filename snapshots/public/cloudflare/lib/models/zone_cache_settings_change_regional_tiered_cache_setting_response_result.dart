...
@immutable final class ZoneCacheSettingsChangeRegionalTieredCacheSettingResponseResult {const ZoneCacheSettingsChangeRegionalTieredCacheSettingResponseResult({required this.id, required this.value, this.modifiedOn = const Omittable.absent(), });
...
ZoneCacheSettingsChangeRegionalTieredCacheSettingResponseResult copyWith({ZoneCacheSettingsChangeRegionalTieredCacheSettingResponseResultId? id, Omittable<DateTime?>? modifiedOn, CacheRulesRegionalTieredCacheValue? value, }) { return ZoneCacheSettingsChangeRegionalTieredCacheSettingResponseResult(
  id: id ?? this.id,
