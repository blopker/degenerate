...
@immutable
final class Web3SingleResponseResultInfo {
  const Web3SingleResponseResultInfo({this.mapStringdynamicOrNull = const Omittable.absent(),
this.stringOrNull = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const Web3SingleResponseResultInfo._({required this.rawValue, required this.mapStringdynamicOrNull,
required this.stringOrNull,});
  factory Web3SingleResponseResultInfo.fromJson(Object? json) => Web3SingleResponseResultInfo._(
...
if (stringOrNull.isPresent) stringOrNull.value,
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is Web3SingleResponseResultInfo && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'Web3SingleResponseResultInfo(${toJson()})';
}
