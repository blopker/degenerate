...
final class WorkersBindingKindMtlsCertificate {const WorkersBindingKindMtlsCertificate({required this.certificateId, required this.name, required this.type, });
...
WorkersBindingKindMtlsCertificate copyWith({String? certificateId, String? name, String? type, }) { return WorkersBindingKindMtlsCertificate(
