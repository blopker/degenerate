...
factory HyperdriveHyperdriveConfig.fromJson(Map<String, dynamic> json) { return HyperdriveHyperdriveConfig(
  ...
  origin: OneOf2.parse(json['origin'], fromA: (v) => HyperdriveHyperdriveDatabase.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && HyperdriveHyperdriveDatabase.canParse(v), fromB: (v) => HyperdriveHyperdriveDatabase.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && HyperdriveHyperdriveDatabase.canParse(v),),
