...
import 'messages37_messages_content.dart';final class Messages37Messages {const Messages37Messages({required this.content, required this.role, });

factory Messages37Messages.fromJson(Map<String, dynamic> json) { return Messages37Messages(
  content: Messages37MessagesContent.fromJson(json['content']),
