...
import 'nsc_cloudflare_site.dart';import 'nsc_facility_info.dart';final class NscInterconnectPhysicalBody {const NscInterconnectPhysicalBody({required this.account, required this.name, this.owner, required this.type, required this.facility, required this.site, required this.slotId, required this.speed, });
