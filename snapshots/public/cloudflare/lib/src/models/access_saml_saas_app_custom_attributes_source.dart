...
import 'package:collection/collection.dart';import 'access_saml_saas_app_custom_attributes_source_name_by_idp.dart';final class AccessSamlSaasAppCustomAttributesSource {const AccessSamlSaasAppCustomAttributesSource({this.name, this.nameByIdp, });
