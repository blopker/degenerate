...
import 'package:collection/collection.dart';import 'access_schemas_saml_saas_app_auth_type.dart';import 'access_schemas_saml_saas_app_custom_attributes.dart';import 'access_schemas_saml_saas_app_name_id_format.dart';import 'access_timestamp.dart';final class AccessSchemasSamlSaasApp {const AccessSchemasSamlSaasApp({this.authType, this.consumerServiceUrl, this.createdAt, this.customAttributes, this.idpEntityId, this.nameIdFormat, this.nameIdTransformJsonata, this.publicKey, this.spEntityId, this.ssoEndpoint, this.updatedAt, });
