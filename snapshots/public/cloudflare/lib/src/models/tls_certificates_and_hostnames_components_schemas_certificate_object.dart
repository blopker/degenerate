...
final class TlsCertificatesAndHostnamesComponentsSchemasCertificateObject {const TlsCertificatesAndHostnamesComponentsSchemasCertificateObject({this.ca, this.certificates, this.expiresOn, this.id, this.issuer, this.name, this.serialNumber, this.signature, this.uploadedOn, });
...
TlsCertificatesAndHostnamesComponentsSchemasCertificateObject copyWith({bool Function()? ca, String Function()? certificates, DateTime Function()? expiresOn, String Function()? id, String Function()? issuer, String Function()? name, String Function()? serialNumber, String Function()? signature, DateTime Function()? uploadedOn, }) { return TlsCertificatesAndHostnamesComponentsSchemasCertificateObject(
