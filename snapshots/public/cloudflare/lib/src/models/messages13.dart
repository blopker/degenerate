...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages13_functions.dart';import 'messages13_messages.dart';import 'messages13_tools.dart';final class Messages13 {const Messages13({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages13.fromJson(Map<String, dynamic> json) { return Messages13(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages13ToolsVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Messages13ToolsVariant1.canParse(v), fromB: (v) => Messages13ToolsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages13ToolsVariant2.canParse(v),)).toList(),
...
Messages13 copyWith({double Function()? frequencyPenalty, List<Messages13Functions> Function()? functions, Map<String, Object> Function()? guidedJson, int Function()? maxTokens, List<Messages13Messages>? messages, double Function()? presencePenalty, bool Function()? raw, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, List<Messages13Tools> Function()? tools, int Function()? topK, double Function()? topP, }) { return Messages13(
