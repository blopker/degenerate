...
factory Messages13.fromJson(Map<String, dynamic> json) { return Messages13(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages13Tools.fromJson(e)).toList(),
