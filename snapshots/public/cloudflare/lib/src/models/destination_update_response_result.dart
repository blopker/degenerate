...
import 'package:collection/collection.dart';import 'destination_update_response_result_configuration.dart';final class DestinationUpdateResponseResult {const DestinationUpdateResponseResult({required this.configuration, required this.enabled, required this.name, required this.scripts, required this.slug, });
