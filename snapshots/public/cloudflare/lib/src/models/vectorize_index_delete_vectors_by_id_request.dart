...
import 'package:collection/collection.dart';final class VectorizeIndexDeleteVectorsByIdRequest {const VectorizeIndexDeleteVectorsByIdRequest({this.ids});
...
VectorizeIndexDeleteVectorsByIdRequest copyWith({List<String> Function()? ids}) { return VectorizeIndexDeleteVectorsByIdRequest(
