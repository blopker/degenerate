...
import 'package:collection/collection.dart';import 'magic_visibility_mnm_messages2.dart';final class ResponseCommonFailure48 {const ResponseCommonFailure48({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure48 copyWith({List<MagicVisibilityMnmMessages2>? errors, List<MagicVisibilityMnmMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure48(
