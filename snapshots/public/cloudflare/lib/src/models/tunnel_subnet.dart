...
import 'tunnel_created_at.dart';import 'tunnel_deleted_at.dart';import 'tunnel_subnet_comment.dart';import 'tunnel_subnet_id.dart';import 'tunnel_subnet_ip_network.dart';import 'tunnel_subnet_is_default_network.dart';import 'tunnel_subnet_name.dart';import 'tunnel_subnet_type.dart';final class TunnelSubnet {const TunnelSubnet({this.comment, this.createdAt, this.deletedAt, this.id, this.isDefaultNetwork, this.name, this.network, this.subnetType, });
