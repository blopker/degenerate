...
final class InlineObject1276Viewport {const InlineObject1276Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });

factory InlineObject1276Viewport.fromJson(Map<String, dynamic> json) { return InlineObject1276Viewport(
...
InlineObject1276Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return InlineObject1276Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject1276Viewport &&
...
@override String toString() { return 'InlineObject1276Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
