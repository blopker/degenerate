...
import 'package:collection/collection.dart';import 'shield_timestamp.dart';import 'shield_uuid.dart';final class ShieldSchemaHosts {const ShieldSchemaHosts({required this.createdAt, required this.hosts, required this.name, required this.schemaId, });
