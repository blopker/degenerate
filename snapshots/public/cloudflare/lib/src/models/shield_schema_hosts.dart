...
import 'package:collection/collection.dart';final class ShieldSchemaHosts {const ShieldSchemaHosts({required this.createdAt, required this.hosts, required this.name, required this.schemaId, });
...
ShieldSchemaHosts copyWith({DateTime? createdAt, List<String>? hosts, String? name, String? schemaId, }) { return ShieldSchemaHosts(
