...
import 'wor_delete_workflow_response_result_status.dart';final class WorDeleteWorkflowResponseResult {const WorDeleteWorkflowResponseResult({required this.status, required this.success, });
