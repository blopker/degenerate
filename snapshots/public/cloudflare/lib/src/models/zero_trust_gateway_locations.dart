...
import 'package:collection/collection.dart';import 'zero_trust_gateway_endpoints.dart';import 'zero_trust_gateway_ipv4_network.dart';final class ZeroTrustGatewayLocations {const ZeroTrustGatewayLocations({this.clientDefault, this.createdAt, this.dnsDestinationIpsId, this.dnsDestinationIpv6BlockId, this.dohSubdomain, this.ecsSupport, this.endpoints, this.id, this.ip, this.ipv4Destination, this.ipv4DestinationBackup, this.name, this.networks, this.updatedAt, });
...
factory ZeroTrustGatewayLocations.fromJson(Map<String, dynamic> json) { return ZeroTrustGatewayLocations(
  ...
  dnsDestinationIpv6BlockId: json['dns_destination_ipv6_block_id'] as String?,
...
ZeroTrustGatewayLocations copyWith({bool Function()? clientDefault, DateTime Function()? createdAt, String Function()? dnsDestinationIpsId, String? Function()? dnsDestinationIpv6BlockId, String Function()? dohSubdomain, bool Function()? ecsSupport, ZeroTrustGatewayEndpoints Function()? endpoints, String Function()? id, String Function()? ip, String Function()? ipv4Destination, String Function()? ipv4DestinationBackup, String Function()? name, List<ZeroTrustGatewayIpv4Network>? Function()? networks, DateTime Function()? updatedAt, }) { return ZeroTrustGatewayLocations(
