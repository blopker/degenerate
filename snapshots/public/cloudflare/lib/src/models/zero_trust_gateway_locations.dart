...
import 'package:collection/collection.dart';import 'zero_trust_gateway_client_default.dart';import 'zero_trust_gateway_components_schemas_uuid.dart';import 'zero_trust_gateway_dns_destination_ips_id_read.dart';import 'zero_trust_gateway_dns_destination_ipv6_block_id.dart';import 'zero_trust_gateway_ecs_support.dart';import 'zero_trust_gateway_endpoints.dart';import 'zero_trust_gateway_ip.dart';import 'zero_trust_gateway_ipv4_network.dart';import 'zero_trust_gateway_read_only_timestamp.dart';import 'zero_trust_gateway_schemas_name.dart';import 'zero_trust_gateway_subdomain.dart';final class ZeroTrustGatewayLocations {const ZeroTrustGatewayLocations({this.clientDefault, this.createdAt, this.dnsDestinationIpsId, this.dnsDestinationIpv6BlockId, this.dohSubdomain, this.ecsSupport, this.endpoints, this.id, this.ip, this.ipv4Destination, this.ipv4DestinationBackup, this.name, this.networks, this.updatedAt, });
