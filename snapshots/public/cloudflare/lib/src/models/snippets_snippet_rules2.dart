...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('expression') && json['expression'] is String &&
      ...
      json.containsKey('snippet_name') && json['snippet_name'] is String; } 
SnippetsSnippetRules2 copyWith({String Function()? description, bool Function()? enabled, String? expression, String? id, DateTime? lastUpdated, String? snippetName, }) { return SnippetsSnippetRules2(
