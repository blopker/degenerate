...
import 'package:collection/collection.dart';import 'post_indicator_create_request_related_events.dart';import 'post_indicator_create_request_tags.dart';final class PostIndicatorCreateRequest {const PostIndicatorCreateRequest({this.autoCreateType, required this.indicatorType, this.relatedEvents, this.tags, required this.value, });
...
factory PostIndicatorCreateRequest.fromJson(Map<String, dynamic> json) { return PostIndicatorCreateRequest(
  ...
  tags: (json['tags'] as List<dynamic>?)?.map((e) => PostIndicatorCreateRequestTags.fromJson(e as Map<String, dynamic>)).toList(),
