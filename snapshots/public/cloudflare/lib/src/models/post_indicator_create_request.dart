...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_indicator_create_request_related_events.dart';import 'post_indicator_create_request_tags.dart';import 'post_indicator_create_request_tags_variant2.dart';final class PostIndicatorCreateRequest {const PostIndicatorCreateRequest({this.autoCreateType, required this.indicatorType, this.relatedEvents, this.tags, required this.value, });
