...
import 'package:collection/collection.dart';import 'inline_object1729_add_script_tag.dart';import 'inline_object1729_add_style_tag.dart';import 'inline_object1729_allow_resource_types.dart';import 'inline_object1729_authenticate.dart';import 'inline_object1729_cookies.dart';import 'inline_object1729_goto_options.dart';import 'inline_object1729_reject_resource_types.dart';import 'inline_object1729_screenshot_options.dart';import 'inline_object1729_viewport.dart';import 'inline_object1729_wait_for_selector.dart';final class InlineObject1729 {const InlineObject1729({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.screenshotOptions, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1729.fromJson(Map<String, dynamic> json) { return InlineObject1729(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1729AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1729AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1729AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1729Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1729Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject1729GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1729RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  screenshotOptions: json['screenshotOptions'] != null ? InlineObject1729ScreenshotOptions.fromJson(json['screenshotOptions'] as Map<String, dynamic>) : null,
  ...
  viewport: json['viewport'] != null ? InlineObject1729Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1729WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
InlineObject1729 copyWith({double Function()? actionTimeout, List<InlineObject1729AddScriptTag> Function()? addScriptTag, List<InlineObject1729AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1729AllowResourceTypes> Function()? allowResourceTypes, InlineObject1729Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1729Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject1729GotoOptions Function()? gotoOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1729RejectResourceTypes> Function()? rejectResourceTypes, InlineObject1729ScreenshotOptions Function()? screenshotOptions, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, Uri? url, String Function()? userAgent, InlineObject1729Viewport Function()? viewport, InlineObject1729WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1729(
