...
import 'package:collection/collection.dart';import 'workers_observability.dart';import 'workers_placement_info.dart';import 'workers_placement_mode.dart';import 'workers_placement_status.dart';import 'workers_script_response_named_handlers.dart';import 'workers_tail_consumers_script.dart';import 'workers_usage_model.dart';final class WorkersScriptResponse {const WorkersScriptResponse({this.compatibilityDate, this.compatibilityFlags, this.createdOn, this.etag, this.handlers, this.hasAssets, this.hasModules, this.id, this.lastDeployedFrom, this.logpush, this.migrationTag, this.modifiedOn, this.namedHandlers, this.observability, this.placement, this.placementMode, this.placementStatus, this.tag, this.tags, this.tailConsumers, this.usageModel, });
...
WorkersScriptResponse copyWith({String Function()? compatibilityDate, List<String> Function()? compatibilityFlags, DateTime Function()? createdOn, String Function()? etag, List<String> Function()? handlers, bool Function()? hasAssets, bool Function()? hasModules, String Function()? id, String Function()? lastDeployedFrom, bool Function()? logpush, String Function()? migrationTag, DateTime Function()? modifiedOn, List<WorkersScriptResponseNamedHandlers> Function()? namedHandlers, WorkersObservability Function()? observability, WorkersPlacementInfo Function()? placement, WorkersPlacementMode Function()? placementMode, WorkersPlacementStatus Function()? placementStatus, String Function()? tag, List<String>? Function()? tags, List<WorkersTailConsumersScript>? Function()? tailConsumers, WorkersUsageModel Function()? usageModel, }) { return WorkersScriptResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is WorkersScriptResponse &&
          ...
          const ListEquality<dynamic>().equals(namedHandlers, other.namedHandlers) &&
