...
import 'firewall_action.dart';import 'firewall_match.dart';final class RateLimitsForAZoneUpdateARateLimitRequest {const RateLimitsForAZoneUpdateARateLimitRequest({required this.action, required this.match, required this.period, required this.threshold, });
...
RateLimitsForAZoneUpdateARateLimitRequest copyWith({FirewallAction? action, FirewallMatch? match, double? period, double? threshold, }) { return RateLimitsForAZoneUpdateARateLimitRequest(
