...
import 'package:collection/collection.dart';import 'magic_bond_id.dart';import 'magic_identifier.dart';import 'magic_lan_static_addressing.dart';import 'magic_nat.dart';import 'magic_port.dart';import 'magic_routed_subnet.dart';import 'magic_vlan_tag.dart';final class MagicLan {const MagicLan({this.bondId, this.haLink, this.id, this.isBreakout, this.isPrioritized, this.name, this.nat, this.physport, this.routedSubnets, this.siteId, this.staticAddressing, this.vlanTag, });
