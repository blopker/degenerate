...
import 'messages10_messages_content.dart';final class Messages10Messages {const Messages10Messages({required this.content, required this.role, });

factory Messages10Messages.fromJson(Map<String, dynamic> json) { return Messages10Messages(
  content: Messages10MessagesContent.fromJson(json['content']),
