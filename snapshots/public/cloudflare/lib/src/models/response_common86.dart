...
import 'package:collection/collection.dart';import 'response_common86_result.dart';import 'zones_messages2.dart';final class ResponseCommon86 {const ResponseCommon86({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon86.fromJson(Map<String, dynamic> json) { return ResponseCommon86(
  ...
  result: ResponseCommon86Result.fromJson(json['result'] as Map<String, dynamic>),
