...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'prompt43_prediction_content_content.dart';final class Prompt43PredictionContentType {const Prompt43PredictionContentType._(this.value);
...
factory Prompt43PredictionContent.fromJson(Map<String, dynamic> json) { return Prompt43PredictionContent(
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => Prompt43PredictionContentContentVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
