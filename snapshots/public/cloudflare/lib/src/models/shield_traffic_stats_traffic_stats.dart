...
final class ShieldTrafficStatsTrafficStats {const ShieldTrafficStatsTrafficStats({required this.lastUpdated, required this.periodSeconds, required this.requests, });
...
ShieldTrafficStatsTrafficStats copyWith({DateTime? lastUpdated, int? periodSeconds, double? requests, }) { return ShieldTrafficStatsTrafficStats(
