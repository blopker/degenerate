...
import 'package:collection/collection.dart';import 'brapi_post_screenshot_request_variant2_add_script_tag.dart';import 'brapi_post_screenshot_request_variant2_add_style_tag.dart';import 'brapi_post_screenshot_request_variant2_allow_resource_types.dart';import 'brapi_post_screenshot_request_variant2_authenticate.dart';import 'brapi_post_screenshot_request_variant2_cookies.dart';import 'brapi_post_screenshot_request_variant2_goto_options.dart';import 'brapi_post_screenshot_request_variant2_reject_resource_types.dart';import 'brapi_post_screenshot_request_variant2_screenshot_options.dart';import 'brapi_post_screenshot_request_variant2_viewport.dart';import 'brapi_post_screenshot_request_variant2_wait_for_selector.dart';final class BrapiPostScreenshotRequestVariant2 {const BrapiPostScreenshotRequestVariant2({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.screenshotOptions, this.scrollPage, this.selector, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });
...
factory BrapiPostScreenshotRequestVariant2.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant2(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostScreenshotRequestVariant2AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostScreenshotRequestVariant2RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
