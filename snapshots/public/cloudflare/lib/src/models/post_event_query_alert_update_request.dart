...
import 'post_event_query_alert_update_request_frequency.dart';final class PostEventQueryAlertUpdateRequest {const PostEventQueryAlertUpdateRequest({this.enabled, this.frequency, this.notificationType, });
