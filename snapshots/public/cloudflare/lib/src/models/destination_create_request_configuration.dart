...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'destination_create_request_configuration_logpush_dataset.dart';final class DestinationCreateRequestConfigurationType {const DestinationCreateRequestConfigurationType._(this.value);
...
factory DestinationCreateRequestConfiguration.fromJson(Map<String, dynamic> json) { return DestinationCreateRequestConfiguration(
  ...
  logpushDataset: OneOf2.parse(json['logpushDataset'], fromA: (v) => DestinationCreateRequestConfigurationLogpushDatasetVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => DestinationCreateRequestConfigurationLogpushDatasetVariant2.fromJson(v as String), canParseB: (v) => v is String,),
