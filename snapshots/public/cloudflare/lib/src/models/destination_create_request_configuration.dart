...
import 'destination_create_request_configuration_logpush_dataset.dart';final class DestinationCreateRequestConfigurationType {const DestinationCreateRequestConfigurationType._(this.value);
...
factory DestinationCreateRequestConfiguration.fromJson(Map<String, dynamic> json) { return DestinationCreateRequestConfiguration(
  ...
  logpushDataset: DestinationCreateRequestConfigurationLogpushDataset.fromJson(json['logpushDataset'] as Map<String, dynamic>),
