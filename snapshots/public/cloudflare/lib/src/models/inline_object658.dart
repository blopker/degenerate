...
import 'inline_object658_response_format.dart';final class InlineObject658 {const InlineObject658({this.frequencyPenalty, this.lora, this.maxTokens = 2000, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });
...
factory InlineObject658.fromJson(Map<String, dynamic> json) { return InlineObject658(
  ...
  responseFormat: json['response_format'] != null ? InlineObject658ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final InlineObject658ResponseFormat? responseFormat;
...
InlineObject658 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject658ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject658(
...
@override String toString() { return 'InlineObject658(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
