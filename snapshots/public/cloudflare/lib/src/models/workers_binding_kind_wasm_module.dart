...
final class WorkersBindingKindWasmModule {const WorkersBindingKindWasmModule({required this.name, required this.$part, required this.type, });
...
WorkersBindingKindWasmModule copyWith({String? name, String? $part, String? type, }) { return WorkersBindingKindWasmModule(
  name: name ?? this.name,
  $part: $part ?? this.$part,
  type: type ?? this.type,
); } 
