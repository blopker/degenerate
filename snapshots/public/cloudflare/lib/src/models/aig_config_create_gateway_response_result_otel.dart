...
import 'aig_config_create_gateway_response_result_otel_content_type.dart';final class AigConfigCreateGatewayResponseResultOtel {const AigConfigCreateGatewayResponseResultOtel({required this.authorization, this.contentType = AigConfigCreateGatewayResponseResultOtelContentType.$json, required this.headers, required this.url, });
