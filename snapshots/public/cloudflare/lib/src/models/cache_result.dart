...
import 'cache_result_value.dart';final class CacheResult {const CacheResult({required this.editable, required this.id, required this.modifiedOn, this.nextScheduledScan, required this.value, });
