...
import 'package:collection/collection.dart';import 'access_rule.dart';import 'access_schemas_approval_group.dart';import 'access_schemas_decision.dart';final class ZoneLevelAccessPoliciesCreateAnAccessPolicyRequest {const ZoneLevelAccessPoliciesCreateAnAccessPolicyRequest({this.approvalGroups, this.approvalRequired, required this.decision, this.exclude, required this.include, this.isolationRequired, required this.name, this.precedence, this.purposeJustificationPrompt, this.purposeJustificationRequired, this.require, });
