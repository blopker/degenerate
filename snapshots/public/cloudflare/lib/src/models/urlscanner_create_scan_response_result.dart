...
import 'urlscanner_create_scan_response_result_visibility.dart';final class UrlscannerCreateScanResponseResult {const UrlscannerCreateScanResponseResult({required this.time, required this.url, required this.uuid, required this.visibility, });
