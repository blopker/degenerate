...
import 'package:collection/collection.dart';import 'load_balancing_origin_analytics.dart';final class LoadBalancingAnalytics {const LoadBalancingAnalytics({this.id = 1, this.origins, this.pool, this.timestamp, });
...
factory LoadBalancingAnalytics.fromJson(Map<String, dynamic> json) { return LoadBalancingAnalytics(
  ...
  pool: (json['pool'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
...
LoadBalancingAnalytics copyWith({int Function()? id, List<LoadBalancingOriginAnalytics> Function()? origins, Map<String, String> Function()? pool, DateTime Function()? timestamp, }) { return LoadBalancingAnalytics(
