...
import 'package:collection/collection.dart';import 'inline_object1331_add_script_tag.dart';import 'inline_object1331_add_style_tag.dart';import 'inline_object1331_allow_resource_types.dart';import 'inline_object1331_authenticate.dart';import 'inline_object1331_cookies.dart';import 'inline_object1331_goto_options.dart';import 'inline_object1331_pdf_options.dart';import 'inline_object1331_reject_resource_types.dart';import 'inline_object1331_viewport.dart';import 'inline_object1331_wait_for_selector.dart';final class InlineObject1331 {const InlineObject1331({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, required this.html, this.pdfOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1331.fromJson(Map<String, dynamic> json) { return InlineObject1331(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1331AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1331AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1331AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1331Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1331Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject1331GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  html: json['html'] as String,
  pdfOptions: json['pdfOptions'] != null ? InlineObject1331PdfOptions.fromJson(json['pdfOptions'] as Map<String, dynamic>) : null,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1331RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  viewport: json['viewport'] != null ? InlineObject1331Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1331WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
InlineObject1331 copyWith({double Function()? actionTimeout, List<InlineObject1331AddScriptTag> Function()? addScriptTag, List<InlineObject1331AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1331AllowResourceTypes> Function()? allowResourceTypes, InlineObject1331Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1331Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject1331GotoOptions Function()? gotoOptions, String? html, InlineObject1331PdfOptions Function()? pdfOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1331RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, String Function()? userAgent, InlineObject1331Viewport Function()? viewport, InlineObject1331WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1331(
