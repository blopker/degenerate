...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'turbo_request_audio.dart';final class TurboRequest {const TurboRequest({required this.audio, this.beamSize = 5, this.compressionRatioThreshold = 2.4, this.conditionOnPreviousText = true, this.hallucinationSilenceThreshold, this.initialPrompt, this.language, this.logProbThreshold = -1.0, this.noSpeechThreshold = 0.6, this.prefix, this.task = 'transcribe', this.vadFilter = false, });

factory TurboRequest.fromJson(Map<String, dynamic> json) { return TurboRequest(
  audio: OneOf2.parse(json['audio'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TurboRequestAudioVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TurboRequestAudioVariant2.canParse(v),),
