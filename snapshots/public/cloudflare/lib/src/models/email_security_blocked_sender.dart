...
import 'email_security_pattern_type.dart';final class EmailSecurityBlockedSender {const EmailSecurityBlockedSender({this.comments, required this.isRegex, required this.pattern, required this.patternType, required this.createdAt, required this.id, required this.lastModified, });
...
EmailSecurityBlockedSender copyWith({String? Function()? comments, bool? isRegex, String? pattern, EmailSecurityPatternType? Function()? patternType, DateTime? createdAt, int? id, DateTime? lastModified, }) { return EmailSecurityBlockedSender(
