...
factory BrapiPostSnapshotRequestVariant2.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant2(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostSnapshotRequestVariant2AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostSnapshotRequestVariant2RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
