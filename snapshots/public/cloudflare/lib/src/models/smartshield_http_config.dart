...
import 'package:collection/collection.dart';/// The HTTP method to use for the health check.
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SmartshieldHttpConfig &&
          ...
          const ListEquality<dynamic>().equals(expectedCodes, other.expectedCodes) &&
