...
factory HyperdriveHyperdriveConfigPatch.fromJson(Map<String, dynamic> json) { return HyperdriveHyperdriveConfigPatch(
  ...
  origin: json['origin'] != null ? OneOf2.parse(json['origin'], fromA: (v) => HyperdriveHyperdriveDatabase.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && HyperdriveHyperdriveDatabase.canParse(v), fromB: (v) => OneOf2.parse(v, fromA: (v) => HyperdriveInternetOrigin.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && HyperdriveInternetOrigin.canParse(v), fromB: (v) => HyperdriveOverAccessOrigin.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && HyperdriveOverAccessOrigin.canParse(v),),) : null,
