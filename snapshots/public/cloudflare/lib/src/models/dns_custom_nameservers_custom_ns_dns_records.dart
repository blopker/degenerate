...
import 'dns_custom_nameservers_custom_ns_dns_records_type.dart';final class DnsCustomNameserversCustomNsDnsRecords {const DnsCustomNameserversCustomNsDnsRecords({this.type, this.value, });
