...
import 'package:collection/collection.dart';import 'realtimekit_webhook.dart';final class RealtimekitWebhooksListSuccessResponse {const RealtimekitWebhooksListSuccessResponse({required this.data, required this.success, });
