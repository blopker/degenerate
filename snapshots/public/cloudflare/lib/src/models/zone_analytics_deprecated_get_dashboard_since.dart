...
final class ZoneAnalyticsDeprecatedGetDashboardSince {const ZoneAnalyticsDeprecatedGetDashboardSince({this.string, this.$int, });

factory ZoneAnalyticsDeprecatedGetDashboardSince.fromJson(Object? json) { return ZoneAnalyticsDeprecatedGetDashboardSince(
