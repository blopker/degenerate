...
import 'package:collection/collection.dart';import 'magic_visibility_pcaps_messages2.dart';final class ResponseCommonFailure49 {const ResponseCommonFailure49({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure49 copyWith({List<MagicVisibilityPcapsMessages2>? errors, List<MagicVisibilityPcapsMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure49(
