...
final class ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsSince {const ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsSince({this.string, this.$int, });

factory ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsSince.fromJson(Object? json) { return ZoneAnalyticsDeprecatedGetAnalyticsByCoLocationsSince(
