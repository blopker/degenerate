...
import 'schemas_zone.dart';final class BillingHistory {const BillingHistory({required this.action, required this.amount, required this.currency, required this.description, required this.id, required this.occurredAt, required this.type, required this.zone, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') && json['action'] is String &&
      ...
      json.containsKey('occurred_at') && json['occurred_at'] is String &&
      json.containsKey('type') && json['type'] is String &&
      json.containsKey('zone'); } 
BillingHistory copyWith({String? action, double? amount, String? currency, String? description, String? id, DateTime? occurredAt, String? type, SchemasZone? zone, }) { return BillingHistory(
