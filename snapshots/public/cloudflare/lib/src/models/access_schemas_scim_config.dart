...
factory AccessSchemasScimConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasScimConfig(
  authentication: json['authentication'] != null ? OneOf2.parse(json['authentication'], fromA: (v) => AccessSchemasScimConfigSingleAuthentication.fromJson(v as Map<String, dynamic>), fromB: (v) => (v as List<dynamic>).map((e) => AccessSchemasScimConfigSingleAuthentication.fromJson(e as Map<String, dynamic>)).toList(),) : null,
