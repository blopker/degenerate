...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_schemas_scim_config_authentication.dart';import 'access_scim_config_mapping.dart';/// Configuration for provisioning to this application via SCIM. This is currently in closed beta.
...
factory AccessSchemasScimConfig.fromJson(Map<String, dynamic> json) { return AccessSchemasScimConfig(
  authentication: json['authentication'] != null ? OneOf2.parse(json['authentication'], fromA: (v) => AccessSchemasScimConfigSingleAuthentication.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AccessSchemasScimConfigSingleAuthentication.canParse(v), fromB: (v) => (v as List<dynamic>).map((e) => AccessSchemasScimConfigSingleAuthentication.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,) : null,
