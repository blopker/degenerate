...
import 'package:collection/collection.dart';import 'r2_slurper_jurisdiction.dart';import 'r2_slurper_r2_source_schema_vendor.dart';import 'r2_slurper_s3_like_creds_schema.dart';final class R2SlurperR2SourceSchema {const R2SlurperR2SourceSchema({required this.bucket, this.jurisdiction, this.keys, this.pathPrefix, required this.secret, required this.vendor, });
