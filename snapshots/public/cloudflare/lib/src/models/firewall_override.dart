...
import 'package:collection/collection.dart';import 'firewall_components_schemas_description.dart';import 'firewall_overrides_id.dart';import 'firewall_paused.dart';import 'firewall_priority.dart';import 'firewall_rewrite_action.dart';import 'firewall_waf_action.dart';final class FirewallOverride {const FirewallOverride({this.description, this.groups, this.id, this.paused, this.priority, this.rewriteAction, this.rules, this.urls, });
