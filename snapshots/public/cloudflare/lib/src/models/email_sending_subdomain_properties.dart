...
final class EmailSendingSubdomainProperties {const EmailSendingSubdomainProperties({this.created, this.emailSendingDkimSelector, required this.emailSendingEnabled, this.emailSendingReturnPathDomain, this.enabled, this.modified, required this.name, required this.tag, });
...
EmailSendingSubdomainProperties copyWith({DateTime Function()? created, String Function()? emailSendingDkimSelector, bool? emailSendingEnabled, String Function()? emailSendingReturnPathDomain, bool Function()? enabled, DateTime Function()? modified, String? name, String? tag, }) { return EmailSendingSubdomainProperties(
