...
import 'package:collection/collection.dart';import 'addressing_created_at.dart';import 'addressing_lease_id.dart';import 'addressing_lease_owner_id.dart';import 'addressing_modified_at.dart';import 'addressing_schemas_cidr.dart';final class AddressingLease {const AddressingLease({this.activeFrom, this.cidrs, this.createdAt, this.id, this.modifiedAt, this.ownerId, this.purpose, });
