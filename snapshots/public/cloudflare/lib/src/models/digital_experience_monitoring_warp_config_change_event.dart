...
import 'digital_experience_monitoring_warp_config_details.dart';final class DigitalExperienceMonitoringWarpConfigChangeEvent {const DigitalExperienceMonitoringWarpConfigChangeEvent({this.deviceId, this.deviceRegistration, this.from, this.hostname, this.serialNumber, this.timestamp, this.to, this.userEmail, });
...
DigitalExperienceMonitoringWarpConfigChangeEvent copyWith({String Function()? deviceId, String Function()? deviceRegistration, DigitalExperienceMonitoringWarpConfigDetails Function()? from, String Function()? hostname, String Function()? serialNumber, String Function()? timestamp, DigitalExperienceMonitoringWarpConfigDetails Function()? to, String Function()? userEmail, }) { return DigitalExperienceMonitoringWarpConfigChangeEvent(
