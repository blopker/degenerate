...
import 'package:collection/collection.dart';import 'get_indicator_list_legacy_response_indicators_related_events.dart';import 'get_indicator_list_legacy_response_indicators_tags.dart';final class GetIndicatorListLegacyResponseIndicators {const GetIndicatorListLegacyResponseIndicators({required this.createdAt, this.datasetId, required this.indicatorType, this.relatedEvents, this.tags, required this.updatedAt, required this.uuid, required this.value, });
