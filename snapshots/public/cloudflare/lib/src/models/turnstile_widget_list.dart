...
import 'package:collection/collection.dart';import 'turnstile_clearance_level.dart';import 'turnstile_region.dart';import 'turnstile_widget_mode.dart';/// A Turnstile Widgets configuration as it appears in listings
...
TurnstileWidgetList copyWith({bool? botFightMode, TurnstileClearanceLevel? clearanceLevel, DateTime? createdOn, List<String>? domains, bool? ephemeralId, TurnstileWidgetMode? mode, DateTime? modifiedOn, String? name, bool? offlabel, TurnstileRegion? region, String? sitekey, }) { return TurnstileWidgetList(
