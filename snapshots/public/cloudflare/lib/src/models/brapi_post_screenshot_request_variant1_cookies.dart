...
factory BrapiPostScreenshotRequestVariant1Cookies.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant1Cookies(
  ...
  priority: json['priority'] != null ? BrapiPostScreenshotRequestVariant1CookiesPriority.fromJson(json['priority'] as Map<String, dynamic>) : null,
  sameParty: json['sameParty'] as bool?,
  sameSite: json['sameSite'] != null ? BrapiPostScreenshotRequestVariant1CookiesSameSite.fromJson(json['sameSite'] as Map<String, dynamic>) : null,
  secure: json['secure'] as bool?,
  sourcePort: json['sourcePort'] != null ? (json['sourcePort'] as num).toDouble() : null,
  sourceScheme: json['sourceScheme'] != null ? BrapiPostScreenshotRequestVariant1CookiesSourceScheme.fromJson(json['sourceScheme'] as Map<String, dynamic>) : null,
