...
import 'package:collection/collection.dart';import 'argo_config_messages2.dart';final class ResponseCommonFailure9 {const ResponseCommonFailure9({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure9 copyWith({List<ArgoConfigMessages2>? errors, List<ArgoConfigMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure9(
