...
import 'package:collection/collection.dart';import 'dlp_confidence.dart';import 'dlp_context_awareness.dart';import 'dlp_entry.dart';final class DlpCustomProfile {const DlpCustomProfile({this.aiContextEnabled = false, this.allowedMatchCount = 0, this.confidenceThreshold = DlpConfidence.low, this.contextAwareness, required this.createdAt, this.dataClasses, this.dataTags, this.description, this.entries, required this.id, required this.name, this.ocrEnabled = false, this.sensitivityLevels, this.sharedEntries, required this.updatedAt, });
