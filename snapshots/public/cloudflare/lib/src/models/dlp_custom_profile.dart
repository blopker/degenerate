...
factory DlpCustomProfile.fromJson(Map<String, dynamic> json) { return DlpCustomProfile(
  ...
  sharedEntries: (json['shared_entries'] as List<dynamic>?)?.map((e) => DlpEntry.fromJson(e as Map<String, dynamic>)).toList(),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DlpCustomProfile &&
          ...
          const ListEquality<dynamic>().equals(dataClasses, other.dataClasses) &&
          ...
          const ListEquality<dynamic>().equals(sensitivityLevels, other.sensitivityLevels) &&
          const ListEquality<dynamic>().equals(sharedEntries, other.sharedEntries) &&
