...
import 'package:collection/collection.dart';final class McnUpdateMagicWanAddressSpaceRequest {const McnUpdateMagicWanAddressSpaceRequest({required this.prefixes});
...
McnUpdateMagicWanAddressSpaceRequest copyWith({List<String>? prefixes}) { return McnUpdateMagicWanAddressSpaceRequest(
