...
import 'access_saml_saas_app_custom_attributes_name_format.dart';import 'access_saml_saas_app_custom_attributes_source.dart';final class AccessSamlSaasAppCustomAttributes {const AccessSamlSaasAppCustomAttributes({this.friendlyName, this.name, this.nameFormat, this.$required, this.source, });
