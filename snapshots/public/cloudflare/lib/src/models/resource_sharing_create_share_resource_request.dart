...
import 'resource_sharing_resource_type.dart';final class ResourceSharingCreateShareResourceRequest {const ResourceSharingCreateShareResourceRequest({required this.meta, required this.resourceAccountId, required this.resourceId, required this.resourceType, });
...
ResourceSharingCreateShareResourceRequest copyWith({Map<String,String>? meta, String? resourceAccountId, String? resourceId, ResourceSharingResourceType? resourceType, }) { return ResourceSharingCreateShareResourceRequest(
  meta: meta ?? this.meta,
