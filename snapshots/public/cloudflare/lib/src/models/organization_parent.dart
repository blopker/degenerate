...
final class OrganizationParent {const OrganizationParent({required this.id, required this.name, });
...
OrganizationParent copyWith({String? id, String? name, }) { return OrganizationParent(
  id: id ?? this.id,
  name: name ?? this.name,
); } 
