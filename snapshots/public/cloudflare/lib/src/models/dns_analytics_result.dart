...
import 'package:collection/collection.dart';import 'dns_analytics_data2.dart';import 'dns_analytics_query.dart';final class DnsAnalyticsResult {const DnsAnalyticsResult({required this.data, required this.dataLag, required this.max, required this.min, required this.query, required this.rows, required this.totals, });
