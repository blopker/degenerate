...
import 'package:collection/collection.dart';import 'iam_invite_components_schemas_identifier.dart';import 'iam_invited_by.dart';import 'iam_invited_member_email.dart';import 'iam_invited_on.dart';import 'iam_schemas_expires_on.dart';final class IamUserInvite {const IamUserInvite({this.expiresOn, this.id, this.invitedBy, this.invitedMemberEmail, required this.invitedMemberId, this.invitedOn, required this.organizationId, this.organizationIsEnforcingTwofactor, this.organizationName, this.roles, this.status, });
