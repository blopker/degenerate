...
import 'package:collection/collection.dart';import 'inline_object435_functions.dart';import 'inline_object435_messages.dart';import 'inline_object435_tools.dart';final class InlineObject435 {const InlineObject435({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory InlineObject435.fromJson(Map<String, dynamic> json) { return InlineObject435(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => InlineObject435Tools.fromJson(e)).toList(),
...
@override String toString() { return 'InlineObject435(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
