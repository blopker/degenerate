...
import 'package:collection/collection.dart';import 'bundle_messages2.dart';import 'response_common75_result.dart';final class ResponseCommon75 {const ResponseCommon75({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon75.fromJson(Map<String, dynamic> json) { return ResponseCommon75(
  ...
  result: ResponseCommon75Result.fromJson(json['result'] as Map<String, dynamic>),
