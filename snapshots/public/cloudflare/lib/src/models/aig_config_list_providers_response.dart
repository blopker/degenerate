...
import 'package:collection/collection.dart';import 'aig_config_list_providers_response_result.dart';final class AigConfigListProvidersResponse {const AigConfigListProvidersResponse({required this.result, required this.success, });
