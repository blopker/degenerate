...
import 'package:collection/collection.dart';import 'workers_observability_telemetry_eventworkers_variant2_diagnostics_channel_events.dart';import 'workers_observability_telemetry_eventworkers_variant2_event_value.dart';import 'workers_observability_telemetry_eventworkers_variant2_script_version.dart';final class WorkersObservabilityTelemetryEvent$workersVariant2EventType {const WorkersObservabilityTelemetryEvent$workersVariant2EventType._(this.value);
...
factory WorkersObservabilityTelemetryEvent$workersVariant2.fromJson(Map<String, dynamic> json) { return WorkersObservabilityTelemetryEvent$workersVariant2(
  ...
  event: (json['event'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, WorkersObservabilityTelemetryEvent$workersVariant2EventValue.fromJson(v as Map<String, dynamic>))),
...
final Map<String,WorkersObservabilityTelemetryEvent$workersVariant2EventValue>? event;
...
WorkersObservabilityTelemetryEvent$workersVariant2 copyWith({double? cpuTimeMs, List<WorkersObservabilityTelemetryEvent$workersVariant2DiagnosticsChannelEvents> Function()? diagnosticsChannelEvents, String Function()? dispatchNamespace, String Function()? durableObjectId, String Function()? entrypoint, Map<String, WorkersObservabilityTelemetryEvent$workersVariant2EventValue> Function()? event, WorkersObservabilityTelemetryEvent$workersVariant2EventType? eventType, WorkersObservabilityTelemetryEvent$workersVariant2ExecutionModel Function()? executionModel, String? outcome, String? requestId, String? scriptName, WorkersObservabilityTelemetryEvent$workersVariant2ScriptVersion Function()? scriptVersion, bool Function()? truncated, double? wallTimeMs, }) { return WorkersObservabilityTelemetryEvent$workersVariant2(
