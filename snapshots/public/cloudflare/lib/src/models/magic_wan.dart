...
import 'magic_identifier.dart';import 'magic_port.dart';import 'magic_vlan_tag.dart';import 'magic_wan_health_check_rate.dart';import 'magic_wan_static_addressing.dart';final class MagicWan {const MagicWan({this.healthCheckRate = MagicWanHealthCheckRate.mid, this.id, this.name, this.physport, this.priority, this.siteId, this.staticAddressing, this.vlanTag, });
