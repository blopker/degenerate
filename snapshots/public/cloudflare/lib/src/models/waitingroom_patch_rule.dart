...
import 'waitingroom_rule_action.dart';import 'waitingroom_rule_position.dart';final class WaitingroomPatchRule {const WaitingroomPatchRule({required this.action, this.description, this.enabled, required this.expression, this.position, });
...
WaitingroomPatchRule copyWith({WaitingroomRuleAction? action, String Function()? description, bool Function()? enabled, String? expression, WaitingroomRulePosition Function()? position, }) { return WaitingroomPatchRule(
