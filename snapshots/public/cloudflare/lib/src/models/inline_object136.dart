...
final class InlineObject136 {const InlineObject136({this.cloudflareOnly, required this.operation, });

factory InlineObject136.fromJson(Map<String, dynamic> json) { return InlineObject136(
...
InlineObject136 copyWith({RulesetsSetCacheControlCloudflareOnly Function()? cloudflareOnly, RulesetsSetCacheControlOperation? operation, }) { return InlineObject136(
...
@override String toString() { return 'InlineObject136(cloudflareOnly: $cloudflareOnly, operation: $operation)'; } 
 }
