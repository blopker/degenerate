...
import 'package:collection/collection.dart';final class AutomaticSpeechRecognitionVariant2 {const AutomaticSpeechRecognitionVariant2({required this.audio, this.sourceLang, this.targetLang, });
