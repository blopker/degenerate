...
factory BrapiPostMarkdownRequestVariant2Cookies.fromJson(Map<String, dynamic> json) { return BrapiPostMarkdownRequestVariant2Cookies(
  ...
  priority: json['priority'] != null ? BrapiPostMarkdownRequestVariant2CookiesPriority.fromJson(json['priority'] as Map<String, dynamic>) : null,
  sameParty: json['sameParty'] as bool?,
  sameSite: json['sameSite'] != null ? BrapiPostMarkdownRequestVariant2CookiesSameSite.fromJson(json['sameSite'] as Map<String, dynamic>) : null,
  secure: json['secure'] as bool?,
  sourcePort: json['sourcePort'] != null ? (json['sourcePort'] as num).toDouble() : null,
  sourceScheme: json['sourceScheme'] != null ? BrapiPostMarkdownRequestVariant2CookiesSourceScheme.fromJson(json['sourceScheme'] as Map<String, dynamic>) : null,
