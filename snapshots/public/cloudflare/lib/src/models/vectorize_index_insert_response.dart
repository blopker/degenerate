...
import 'package:collection/collection.dart';final class VectorizeIndexInsertResponse {const VectorizeIndexInsertResponse({this.count, this.ids, });
...
VectorizeIndexInsertResponse copyWith({int Function()? count, List<String> Function()? ids, }) { return VectorizeIndexInsertResponse(
