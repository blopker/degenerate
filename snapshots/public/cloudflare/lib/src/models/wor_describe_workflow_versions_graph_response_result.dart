...
factory WorDescribeWorkflowVersionsGraphResponseResult.fromJson(Map<String, dynamic> json) { return WorDescribeWorkflowVersionsGraphResponseResult(
  ...
  dag: (json['dag'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
...
WorDescribeWorkflowVersionsGraphResponseResult copyWith({String? className, DateTime? createdOn, Map<String, String>? Function()? dag, String? id, DateTime? modifiedOn, String? workflowId, }) { return WorDescribeWorkflowVersionsGraphResponseResult(
