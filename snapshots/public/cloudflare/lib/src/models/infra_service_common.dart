...
import 'infra_service_host.dart';import 'infra_service_type.dart';final class InfraServiceCommon {const InfraServiceCommon({this.createdAt, required this.host, required this.name, this.serviceId, required this.type, this.updatedAt, });
