...
import 'teams_devices_config_request.dart';import 'teams_devices_schemas_type.dart';final class DevicePostureIntegrationsUpdateDevicePostureIntegrationRequest {const DevicePostureIntegrationsUpdateDevicePostureIntegrationRequest({this.config, this.interval, this.name, this.type, });
...
DevicePostureIntegrationsUpdateDevicePostureIntegrationRequest copyWith({TeamsDevicesConfigRequest Function()? config, String Function()? interval, String Function()? name, TeamsDevicesSchemasType Function()? type, }) { return DevicePostureIntegrationsUpdateDevicePostureIntegrationRequest(
