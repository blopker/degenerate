...
import 'teams_devices_components_schemas_type.dart';import 'teams_devices_schemas_config_request.dart';final class DeviceManagedNetworksCreateDeviceManagedNetworkRequest {const DeviceManagedNetworksCreateDeviceManagedNetworkRequest({required this.config, required this.name, required this.type, });
...
DeviceManagedNetworksCreateDeviceManagedNetworkRequest copyWith({TeamsDevicesSchemasConfigRequest? config, String? name, TeamsDevicesComponentsSchemasType? type, }) { return DeviceManagedNetworksCreateDeviceManagedNetworkRequest(
