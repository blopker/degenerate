...
import 'brapi_post_json_request_variant2_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostJsonRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostJsonRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
