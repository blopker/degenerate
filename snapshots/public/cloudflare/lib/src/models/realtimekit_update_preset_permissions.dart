...
import 'realtimekit_update_preset_permissions_chat.dart';import 'realtimekit_update_preset_permissions_connected_meetings.dart';import 'realtimekit_update_preset_permissions_media.dart';import 'realtimekit_update_preset_permissions_plugins.dart';import 'realtimekit_update_preset_permissions_polls.dart';import 'realtimekit_update_preset_permissions_recorder_type.dart';import 'realtimekit_update_preset_permissions_waiting_room_type.dart';final class RealtimekitUpdatePresetPermissions {const RealtimekitUpdatePresetPermissions({this.acceptWaitingRequests, this.canAcceptProductionRequests, this.canChangeParticipantPermissions, this.canEditDisplayName, this.canLivestream, this.canRecord, this.canSpotlight, this.chat, this.connectedMeetings, this.disableParticipantAudio, this.disableParticipantScreensharing, this.disableParticipantVideo, this.hiddenParticipant, this.isRecorder = false, this.kickParticipant, this.media, this.pinParticipant, this.plugins, this.polls, this.recorderType = RealtimekitUpdatePresetPermissionsRecorderType.none, this.showParticipantList, this.waitingRoomType, });
