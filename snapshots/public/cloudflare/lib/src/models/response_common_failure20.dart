...
import 'package:collection/collection.dart';import 'cloudforce_one_whois_messages2.dart';final class ResponseCommonFailure20 {const ResponseCommonFailure20({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure20 copyWith({List<CloudforceOneWhoisMessages2>? errors, List<CloudforceOneWhoisMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure20(
