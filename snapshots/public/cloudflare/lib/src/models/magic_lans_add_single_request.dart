...
import 'package:collection/collection.dart';import 'magic_bond_id.dart';import 'magic_lan_static_addressing.dart';import 'magic_nat.dart';import 'magic_port.dart';import 'magic_routed_subnet.dart';import 'magic_vlan_tag.dart';final class MagicLansAddSingleRequest {const MagicLansAddSingleRequest({this.bondId, this.haLink, this.isBreakout, this.isPrioritized, this.name, this.nat, this.physport, this.routedSubnets, this.staticAddressing, this.vlanTag, });
