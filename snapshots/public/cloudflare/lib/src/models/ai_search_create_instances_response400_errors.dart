...
import 'package:collection/collection.dart';final class AiSearchCreateInstancesResponse400Errors {const AiSearchCreateInstancesResponse400Errors({required this.code, required this.message, required this.path, });
