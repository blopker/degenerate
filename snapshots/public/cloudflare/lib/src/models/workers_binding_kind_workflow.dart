...
final class WorkersBindingKindWorkflow {const WorkersBindingKindWorkflow({this.className, required this.name, this.scriptName, required this.type, required this.workflowName, });
...
WorkersBindingKindWorkflow copyWith({String Function()? className, String? name, String Function()? scriptName, String? type, String? workflowName, }) { return WorkersBindingKindWorkflow(
