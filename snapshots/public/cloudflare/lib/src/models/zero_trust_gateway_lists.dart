...
import 'package:collection/collection.dart';import 'zero_trust_gateway_count.dart';import 'zero_trust_gateway_description.dart';import 'zero_trust_gateway_items2.dart';import 'zero_trust_gateway_name.dart';import 'zero_trust_gateway_read_only_timestamp.dart';import 'zero_trust_gateway_schemas_type.dart';import 'zero_trust_gateway_schemas_uuid.dart';final class ZeroTrustGatewayLists {const ZeroTrustGatewayLists({this.count, this.createdAt, this.description, this.id, this.items, this.name, this.type, this.updatedAt, });
