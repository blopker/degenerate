...
import 'package:collection/collection.dart';import 'aig_config_create_dataset_response_result_filters.dart';final class AigConfigCreateDatasetResponseResult {const AigConfigCreateDatasetResponseResult({required this.createdAt, required this.enable, required this.filters, required this.gatewayId, required this.id, required this.modifiedAt, required this.name, });
