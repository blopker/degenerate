...
import 'package:collection/collection.dart';import 'inline_object1276_add_script_tag.dart';import 'inline_object1276_add_style_tag.dart';import 'inline_object1276_allow_resource_types.dart';import 'inline_object1276_authenticate.dart';import 'inline_object1276_cookies.dart';import 'inline_object1276_goto_options.dart';import 'inline_object1276_reject_resource_types.dart';import 'inline_object1276_viewport.dart';import 'inline_object1276_wait_for_selector.dart';final class InlineObject1276 {const InlineObject1276({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, required this.html, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1276.fromJson(Map<String, dynamic> json) { return InlineObject1276(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1276AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1276AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1276AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1276Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1276Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject1276GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  html: json['html'] as String,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1276RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  viewport: json['viewport'] != null ? InlineObject1276Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1276WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
InlineObject1276 copyWith({double Function()? actionTimeout, List<InlineObject1276AddScriptTag> Function()? addScriptTag, List<InlineObject1276AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1276AllowResourceTypes> Function()? allowResourceTypes, InlineObject1276Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1276Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject1276GotoOptions Function()? gotoOptions, String? html, List<String> Function()? rejectRequestPattern, List<InlineObject1276RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, String Function()? userAgent, InlineObject1276Viewport Function()? viewport, InlineObject1276WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1276(
