...
import 'package:collection/collection.dart';import 'async_batch3_requests.dart';final class AsyncBatch3 {const AsyncBatch3({required this.requests});

factory AsyncBatch3.fromJson(Map<String, dynamic> json) { return AsyncBatch3(
  requests: (json['requests'] as List<dynamic>).map((e) => AsyncBatch3Requests.fromJson(e)).toList(),
); }
