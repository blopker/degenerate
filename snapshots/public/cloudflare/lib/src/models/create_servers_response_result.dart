...
import 'package:collection/collection.dart';final class CreateServersResponseResultAuthType {const CreateServersResponseResultAuthType._(this.value);
...
CreateServersResponseResult copyWith({CreateServersResponseResultAuthType? authType, DateTime Function()? createdAt, String Function()? createdBy, String? Function()? description, String Function()? error, Uri? hostname, String? id, DateTime Function()? lastSuccessfulSync, DateTime Function()? lastSynced, DateTime Function()? modifiedAt, String Function()? modifiedBy, String? name, List<Map<String,String>>? prompts, String Function()? status, List<Map<String,String>>? tools, }) { return CreateServersResponseResult(
