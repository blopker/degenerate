...
import 'workers_kv_any.dart';final class WorkersKvBulkWrite2 {const WorkersKvBulkWrite2({this.base64 = false, this.expiration, this.expirationTtl, required this.key, this.metadata, required this.value, });
...
factory WorkersKvBulkWrite2.fromJson(Map<String, dynamic> json) { return WorkersKvBulkWrite2(
  ...
  expirationTtl: json['expiration_ttl'] != null ? (json['expiration_ttl'] as num).toDouble() : null,
...
WorkersKvBulkWrite2 copyWith({bool Function()? base64, double Function()? expiration, double Function()? expirationTtl, String? key, WorkersKvAny Function()? metadata, String? value, }) { return WorkersKvBulkWrite2(
