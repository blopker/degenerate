...
import 'custom_pages_state.dart';final class CustomPagesForAnAccountUpdateACustomPageRequest {const CustomPagesForAnAccountUpdateACustomPageRequest({required this.state, required this.url, });
...
CustomPagesForAnAccountUpdateACustomPageRequest copyWith({CustomPagesState? state, Uri? url, }) { return CustomPagesForAnAccountUpdateACustomPageRequest(
