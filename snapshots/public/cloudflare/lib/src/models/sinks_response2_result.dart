...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'cloudflare_pipelines_connection_schema.dart';import 'cloudflare_pipelines_format.dart';import 'sinks_response2_result_config.dart';/// Specifies the type of sink.
...
factory SinksResponse2Result.fromJson(Map<String, dynamic> json) { return SinksResponse2Result(
  config: json['config'] != null ? OneOf2.parse(json['config'], fromA: (v) => CloudflarePipelinesR2Table.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CloudflarePipelinesR2Table.canParse(v), fromB: (v) => CloudflarePipelinesR2DataCatalogTable.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CloudflarePipelinesR2DataCatalogTable.canParse(v),) : null,
