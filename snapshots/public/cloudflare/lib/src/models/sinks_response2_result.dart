...
import 'cloudflare_pipelines_connection_schema.dart';import 'cloudflare_pipelines_format.dart';import 'sinks_response2_result_config.dart';import 'sinks_response2_result_type.dart';final class SinksResponse2Result {const SinksResponse2Result({this.config, required this.createdAt, this.format, required this.id, required this.modifiedAt, required this.name, this.schema, required this.type, });
