...
import 'package:collection/collection.dart';import 'iam_condition.dart';import 'iam_policy_with_permission_groups_and_resources.dart';final class IamCreatePayload {const IamCreatePayload({this.condition, this.expiresOn, required this.name, this.notBefore, required this.policies, });
...
IamCreatePayload copyWith({IamCondition Function()? condition, DateTime Function()? expiresOn, String? name, DateTime Function()? notBefore, List<IamPolicyWithPermissionGroupsAndResources>? policies, }) { return IamCreatePayload(
