...
import 'package:collection/collection.dart';import 'dlp_dataset_column.dart';import 'dlp_dataset_upload.dart';import 'dlp_dataset_upload_status.dart';final class DlpDataset {const DlpDataset({this.caseSensitive, required this.columns, required this.createdAt, this.description, required this.encodingVersion, required this.id, required this.name, required this.numCells, required this.secret, required this.status, required this.updatedAt, required this.uploads, });
