...
import 'package:collection/collection.dart';import 'magic_visibility_mnm_mnm_rule_duration.dart';final class MagicNetworkMonitoringRulesUpdateRulesRequest {const MagicNetworkMonitoringRulesUpdateRulesRequest({this.automaticAdvertisement, this.bandwidth, required this.duration, this.id, required this.name, this.packetThreshold, this.prefixes, });
...
MagicNetworkMonitoringRulesUpdateRulesRequest copyWith({bool? Function()? automaticAdvertisement, double Function()? bandwidth, MagicVisibilityMnmMnmRuleDuration? duration, String Function()? id, String? name, double Function()? packetThreshold, List<String> Function()? prefixes, }) { return MagicNetworkMonitoringRulesUpdateRulesRequest(
