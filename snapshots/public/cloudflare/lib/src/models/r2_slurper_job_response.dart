...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_slurper_job_response_source.dart';import 'r2_slurper_job_response_target.dart';import 'r2_slurper_job_status.dart';final class R2SlurperJobResponse {const R2SlurperJobResponse({this.createdAt, this.finishedAt, this.id, this.overwrite, this.source, this.status, this.target, });
...
factory R2SlurperJobResponse.fromJson(Map<String, dynamic> json) { return R2SlurperJobResponse(
  ...
  source: json['source'] != null ? OneOf3.parse(json['source'], fromA: (v) => S3SourceResponseSchema.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && S3SourceResponseSchema.canParse(v), fromB: (v) => GcsSourceResponseSchema.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && GcsSourceResponseSchema.canParse(v), fromC: (v) => R2SourceResponseSchema.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && R2SourceResponseSchema.canParse(v),) : null,
