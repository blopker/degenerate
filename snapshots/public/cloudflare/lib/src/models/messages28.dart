...
import 'package:collection/collection.dart';import 'messages28_functions.dart';import 'messages28_image.dart';import 'messages28_messages.dart';import 'messages28_tools.dart';final class Messages28 {const Messages28({this.frequencyPenalty, this.functions, this.image, this.maxTokens = 256, required this.messages, this.presencePenalty, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages28.fromJson(Map<String, dynamic> json) { return Messages28(
  ...
  image: json['image'] != null ? Messages28Image.fromJson(json['image']) : null,
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages28Tools.fromJson(e)).toList(),
