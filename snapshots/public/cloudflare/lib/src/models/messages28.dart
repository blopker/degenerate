...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages28_functions.dart';import 'messages28_image.dart';import 'messages28_messages.dart';import 'messages28_tools.dart';final class Messages28 {const Messages28({this.frequencyPenalty, this.functions, this.image, this.maxTokens = 256, required this.messages, this.presencePenalty, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages28.fromJson(Map<String, dynamic> json) { return Messages28(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages28ToolsVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Messages28ToolsVariant1.canParse(v), fromB: (v) => Messages28ToolsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages28ToolsVariant2.canParse(v),)).toList(),
