...
final class InlineObject719Function {const InlineObject719Function({this.description, required this.name, this.parameters, this.strict, });
...
@override String toString() { return 'InlineObject719Function(description: $description, name: $name, parameters: $parameters, strict: $strict)'; } 
 }
