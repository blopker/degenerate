...
import 'package:collection/collection.dart';import 'urlscanner_get_scan_har_response_result_har_log_entries_request_headers.dart';final class UrlscannerGetScanHarResponseResultHarLogEntriesRequest {const UrlscannerGetScanHarResponseResultHarLogEntriesRequest({required this.bodySize, required this.headers, required this.headersSize, required this.httpVersion, required this.method, required this.url, });
