...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages51_messages_system_content.dart';final class Messages51MessagesSystemRole {const Messages51MessagesSystemRole._(this.value);
...
factory Messages51MessagesSystem.fromJson(Map<String, dynamic> json) { return Messages51MessagesSystem(
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => Messages51MessagesSystemContentVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
