...
import 'package:collection/collection.dart';import 'request_tracer_messages2.dart';final class ResponseCommonFailure57 {const ResponseCommonFailure57({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure57 copyWith({List<RequestTracerMessages2>? errors, List<RequestTracerMessages2>? messages, Map<String, String>? Function()? result, bool? success, }) { return ResponseCommonFailure57(
