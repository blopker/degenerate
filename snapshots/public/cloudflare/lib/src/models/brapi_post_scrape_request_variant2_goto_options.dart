...
factory BrapiPostScrapeRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScrapeRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? OneOf5.parse(json['waitUntil'], fromA: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant3.fromJson(v as String), canParseC: (v) => v is String, fromD: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant4.fromJson(v as String), canParseD: (v) => v is String, fromE: (v) => (v as List<dynamic>).map((e) => OneOf4.parse(e, fromA: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant5Variant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant5Variant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant5Variant3.fromJson(v as String), canParseC: (v) => v is String, fromD: (v) => BrapiPostScrapeRequestVariant2GotoOptionsWaitUntilVariant5Variant4.fromJson(v as String), canParseD: (v) => v is String,)).toList(), canParseE: (v) => v is List,) : null,
); }
