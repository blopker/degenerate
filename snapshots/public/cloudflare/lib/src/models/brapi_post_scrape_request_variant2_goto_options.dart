...
import 'brapi_post_scrape_request_variant2_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostScrapeRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScrapeRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostScrapeRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
