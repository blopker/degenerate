...
import 'input_embedding_text.dart';final class InputEmbedding {const InputEmbedding({required this.text, this.truncateInputs = false, });

factory InputEmbedding.fromJson(Map<String, dynamic> json) { return InputEmbedding(
  text: InputEmbeddingText.fromJson(json['text']),
