...
import 'zaraz_scroll_depth_rule_action.dart';import 'zaraz_scroll_depth_rule_settings.dart';final class ZarazScrollDepthRule {const ZarazScrollDepthRule({required this.action, required this.id, required this.settings, });
