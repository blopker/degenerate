...
import 'zero_trust_gateway_class.dart';final class ZeroTrustGatewaySubcategory {const ZeroTrustGatewaySubcategory({this.beta, this.$class, this.description, this.id, this.name, });
...
ZeroTrustGatewaySubcategory copyWith({bool Function()? beta, ZeroTrustGatewayClass Function()? $class, String Function()? description, int Function()? id, String Function()? name, }) { return ZeroTrustGatewaySubcategory(
