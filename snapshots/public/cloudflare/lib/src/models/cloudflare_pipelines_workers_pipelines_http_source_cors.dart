...
import 'package:collection/collection.dart';final class CloudflarePipelinesWorkersPipelinesHttpSourceCors {const CloudflarePipelinesWorkersPipelinesHttpSourceCors({this.origins});
