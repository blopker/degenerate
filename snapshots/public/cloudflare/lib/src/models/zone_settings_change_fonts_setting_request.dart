...
import 'speed_cloudflare_fonts_value.dart';final class ZoneSettingsChangeFontsSettingRequest {const ZoneSettingsChangeFontsSettingRequest({required this.value});
