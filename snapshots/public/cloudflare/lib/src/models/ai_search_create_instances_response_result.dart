...
factory AiSearchCreateInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesResponseResult(
  ...
  rerankingModel: json['reranking_model'] != null ? OneOf2.parse(json['reranking_model'], fromA: (v) => AiSearchCreateInstancesResponseResultRerankingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchCreateInstancesResponseResultRerankingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
