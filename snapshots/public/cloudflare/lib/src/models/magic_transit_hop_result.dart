...
import 'package:collection/collection.dart';import 'magic_transit_node_result.dart';final class MagicTransitHopResult {const MagicTransitHopResult({this.nodes, this.packetsLost, this.packetsSent, this.packetsTtl, });
...
factory MagicTransitHopResult.fromJson(Map<String, dynamic> json) { return MagicTransitHopResult(
  ...
  packetsTtl: json['packets_ttl'] != null ? (json['packets_ttl'] as num).toInt() : null,
); }
...
MagicTransitHopResult copyWith({List<MagicTransitNodeResult> Function()? nodes, int Function()? packetsLost, int Function()? packetsSent, int Function()? packetsTtl, }) { return MagicTransitHopResult(
