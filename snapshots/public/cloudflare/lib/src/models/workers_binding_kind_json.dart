...
final class WorkersBindingKindJson {const WorkersBindingKindJson({required this.json, required this.name, required this.type, });
...
WorkersBindingKindJson copyWith({Map<String,String>? json, String? name, String? type, }) { return WorkersBindingKindJson(
  json: json ?? this.json,
  name: name ?? this.name,
  type: type ?? this.type,
); } 
