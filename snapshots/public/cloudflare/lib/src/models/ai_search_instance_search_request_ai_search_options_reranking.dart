...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_instance_search_request_ai_search_options_reranking_model.dart';final class AiSearchInstanceSearchRequestAiSearchOptionsReranking {const AiSearchInstanceSearchRequestAiSearchOptionsReranking({this.enabled, this.matchThreshold = 0.4, this.model, });
...
factory AiSearchInstanceSearchRequestAiSearchOptionsReranking.fromJson(Map<String, dynamic> json) { return AiSearchInstanceSearchRequestAiSearchOptionsReranking(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => AiSearchInstanceSearchRequestAiSearchOptionsRerankingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchInstanceSearchRequestAiSearchOptionsRerankingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
