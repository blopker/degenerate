...
import 'package:collection/collection.dart';import 'workers_binding_name.dart';final class WorkersBindingKindSendEmail {const WorkersBindingKindSendEmail({this.allowedDestinationAddresses, this.allowedSenderAddresses, this.destinationAddress, required this.name, required this.type, });
