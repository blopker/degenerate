...
import 'package:collection/collection.dart';import 'messages10_functions.dart';import 'messages10_messages.dart';import 'messages10_response_format.dart';import 'messages10_tools.dart';final class Messages10 {const Messages10({this.frequencyPenalty, this.functions, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages10.fromJson(Map<String, dynamic> json) { return Messages10(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages10Tools.fromJson(e)).toList(),
