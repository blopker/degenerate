...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages10_functions.dart';import 'messages10_messages.dart';import 'messages10_response_format.dart';import 'messages10_tools.dart';final class Messages10 {const Messages10({this.frequencyPenalty, this.functions, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages10.fromJson(Map<String, dynamic> json) { return Messages10(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages10ToolsVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Messages10ToolsVariant1.canParse(v), fromB: (v) => Messages10ToolsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages10ToolsVariant2.canParse(v),)).toList(),
