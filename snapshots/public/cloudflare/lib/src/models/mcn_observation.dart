...
final class McnObservation {const McnObservation({required this.firstObservedAt, required this.lastObservedAt, required this.providerId, required this.resourceId, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('first_observed_at') && json['first_observed_at'] is String &&
      ...
      json.containsKey('provider_id') && json['provider_id'] is String &&
      json.containsKey('resource_id') && json['resource_id'] is String; } 
McnObservation copyWith({String? firstObservedAt, String? lastObservedAt, String? providerId, String? resourceId, }) { return McnObservation(
