...
import 'inline_object548_response_format.dart';final class InlineObject548 {const InlineObject548({this.frequencyPenalty, this.guidedJson, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.15, this.topK, this.topP, });

factory InlineObject548.fromJson(Map<String, dynamic> json) { return InlineObject548(
  ...
  responseFormat: json['response_format'] != null ? InlineObject548ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final InlineObject548ResponseFormat? responseFormat;
...
InlineObject548 copyWith({double Function()? frequencyPenalty, Map<String, Object> Function()? guidedJson, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject548ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject548(
...
@override String toString() { return 'InlineObject548(frequencyPenalty: $frequencyPenalty, guidedJson: $guidedJson, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
