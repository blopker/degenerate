...
import 'brapi_post_links_request_variant2_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostLinksRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostLinksRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostLinksRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
