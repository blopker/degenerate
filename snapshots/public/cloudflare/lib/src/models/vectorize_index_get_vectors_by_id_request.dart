...
import 'package:collection/collection.dart';final class VectorizeIndexGetVectorsByIdRequest {const VectorizeIndexGetVectorsByIdRequest({this.ids});
...
VectorizeIndexGetVectorsByIdRequest copyWith({List<String> Function()? ids}) { return VectorizeIndexGetVectorsByIdRequest(
