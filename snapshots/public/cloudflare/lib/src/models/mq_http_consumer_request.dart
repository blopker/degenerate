...
import 'mq_http_consumer_request_settings.dart';final class MqHttpConsumerRequest {const MqHttpConsumerRequest({this.deadLetterQueue, this.settings, required this.type, });
...
MqHttpConsumerRequest copyWith({String Function()? deadLetterQueue, MqHttpConsumerRequestSettings Function()? settings, String? type, }) { return MqHttpConsumerRequest(
