...
import 'firewall_custom_response.dart';import 'firewall_mode.dart';import 'firewall_timeout.dart';final class InlineObject63 {const InlineObject63({this.mode, this.response, this.timeout, });
...
InlineObject63 copyWith({FirewallMode Function()? mode, FirewallCustomResponse Function()? response, FirewallTimeout Function()? timeout, }) { return InlineObject63(
