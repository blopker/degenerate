...
final class ResponseCommon7Result {const ResponseCommon7Result({this.mapStringObject, this.listObject, this.string, });

factory ResponseCommon7Result.fromJson(Object? json) { return ResponseCommon7Result(
