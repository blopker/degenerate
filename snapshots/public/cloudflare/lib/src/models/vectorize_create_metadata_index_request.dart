...
import 'vectorize_create_metadata_index_request_index_type.dart';final class VectorizeCreateMetadataIndexRequest {const VectorizeCreateMetadataIndexRequest({required this.indexType, required this.propertyName, });
