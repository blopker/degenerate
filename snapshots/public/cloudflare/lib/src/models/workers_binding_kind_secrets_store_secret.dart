...
final class WorkersBindingKindSecretsStoreSecret {const WorkersBindingKindSecretsStoreSecret({required this.name, required this.secretName, required this.storeId, required this.type, });
...
WorkersBindingKindSecretsStoreSecret copyWith({String? name, String? secretName, String? storeId, String? type, }) { return WorkersBindingKindSecretsStoreSecret(
  name: name ?? this.name,
