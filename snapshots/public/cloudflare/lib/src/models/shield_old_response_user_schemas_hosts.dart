...
import 'package:collection/collection.dart';import 'shield_timestamp.dart';import 'shield_uuid.dart';final class ShieldOldResponseUserSchemasHosts {const ShieldOldResponseUserSchemasHosts({required this.createdAt, required this.hosts, required this.name, required this.schemaId, });
