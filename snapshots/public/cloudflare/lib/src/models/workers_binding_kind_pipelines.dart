...
final class WorkersBindingKindPipelines {const WorkersBindingKindPipelines({required this.name, required this.pipeline, required this.type, });
...
WorkersBindingKindPipelines copyWith({String? name, String? pipeline, String? type, }) { return WorkersBindingKindPipelines(
  name: name ?? this.name,
