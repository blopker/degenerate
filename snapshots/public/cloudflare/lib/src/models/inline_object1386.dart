...
import 'package:collection/collection.dart';import 'inline_object1386_add_script_tag.dart';import 'inline_object1386_add_style_tag.dart';import 'inline_object1386_allow_resource_types.dart';import 'inline_object1386_authenticate.dart';import 'inline_object1386_cookies.dart';import 'inline_object1386_goto_options.dart';import 'inline_object1386_pdf_options.dart';import 'inline_object1386_reject_resource_types.dart';import 'inline_object1386_viewport.dart';import 'inline_object1386_wait_for_selector.dart';final class InlineObject1386 {const InlineObject1386({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, this.pdfOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1386.fromJson(Map<String, dynamic> json) { return InlineObject1386(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1386AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1386AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1386AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1386Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1386Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject1386GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  pdfOptions: json['pdfOptions'] != null ? InlineObject1386PdfOptions.fromJson(json['pdfOptions'] as Map<String, dynamic>) : null,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1386RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  viewport: json['viewport'] != null ? InlineObject1386Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1386WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
final List<InlineObject1386AddScriptTag>? addScriptTag;

/// Adds a `<link rel="stylesheet">` tag into the page with the desired URL or a `<style type="text/css">` tag with the content.
final List<InlineObject1386AddStyleTag>? addStyleTag;
...
final List<InlineObject1386AllowResourceTypes>? allowResourceTypes;

/// Provide credentials for HTTP authentication.
final InlineObject1386Authenticate? authenticate;

/// Attempt to proceed when 'awaited' events fail or timeout.
final bool? bestAttempt;

/// Check [options](https://pptr.dev/api/puppeteer.page.setcookie).
final List<InlineObject1386Cookies>? cookies;

final String? emulateMediaType;

/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
final InlineObject1386GotoOptions? gotoOptions;

/// Check [options](https://pptr.dev/api/puppeteer.pdfoptions).
final InlineObject1386PdfOptions? pdfOptions;
...
final List<InlineObject1386RejectResourceTypes>? rejectResourceTypes;
...
InlineObject1386 copyWith({double Function()? actionTimeout, List<InlineObject1386AddScriptTag> Function()? addScriptTag, List<InlineObject1386AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1386AllowResourceTypes> Function()? allowResourceTypes, InlineObject1386Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1386Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject1386GotoOptions Function()? gotoOptions, InlineObject1386PdfOptions Function()? pdfOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1386RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, Uri? url, String Function()? userAgent, InlineObject1386Viewport Function()? viewport, InlineObject1386WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1386(
