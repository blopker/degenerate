...
import 'inline_object1671_screenshot_options_clip.dart';import 'inline_object1671_screenshot_options_type.dart';final class InlineObject1671ScreenshotOptions {const InlineObject1671ScreenshotOptions({this.captureBeyondViewport, this.clip, this.fromSurface, this.fullPage, this.omitBackground, this.optimizeForSpeed, this.quality, this.type, });
...
InlineObject1671ScreenshotOptions copyWith({bool Function()? captureBeyondViewport, InlineObject1671ScreenshotOptionsClip Function()? clip, bool Function()? fromSurface, bool Function()? fullPage, bool Function()? omitBackground, bool Function()? optimizeForSpeed, double Function()? quality, InlineObject1671ScreenshotOptionsType Function()? type, }) { return InlineObject1671ScreenshotOptions(
...
@override String toString() { return 'InlineObject1671ScreenshotOptions(captureBeyondViewport: $captureBeyondViewport, clip: $clip, fromSurface: $fromSurface, fullPage: $fullPage, omitBackground: $omitBackground, optimizeForSpeed: $optimizeForSpeed, quality: $quality, type: $type)'; } 
 }
