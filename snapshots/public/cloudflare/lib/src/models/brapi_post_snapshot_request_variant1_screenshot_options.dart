...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'brapi_post_snapshot_request_variant1_screenshot_options_clip.dart';import 'brapi_post_snapshot_request_variant1_screenshot_options_type.dart';final class BrapiPostSnapshotRequestVariant1ScreenshotOptions {const BrapiPostSnapshotRequestVariant1ScreenshotOptions({this.captureBeyondViewport, this.clip, this.fromSurface, this.fullPage, this.omitBackground, this.optimizeForSpeed, this.quality, this.type, });
...
factory BrapiPostSnapshotRequestVariant1ScreenshotOptions.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant1ScreenshotOptions(
  ...
  type: json['type'] != null ? OneOf3.parse(json['type'], fromA: (v) => BrapiPostSnapshotRequestVariant1ScreenshotOptionsTypeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostSnapshotRequestVariant1ScreenshotOptionsTypeVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostSnapshotRequestVariant1ScreenshotOptionsTypeVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
); }
