...
import 'access_active_device_count.dart';import 'access_last_successful_login.dart';import 'access_schemas_access_seat.dart';import 'access_schemas_email.dart';import 'access_schemas_gateway_seat.dart';import 'access_schemas_seat_uid.dart';import 'access_timestamp.dart';import 'access_uid.dart';import 'access_users_components_schemas_name.dart';import 'access_uuid.dart';final class AccessSchemasUsers {const AccessSchemasUsers({this.accessSeat, this.activeDeviceCount, this.createdAt, this.email, this.gatewaySeat, this.id, this.lastSuccessfulLogin, this.name, this.seatUid, this.uid, this.updatedAt, });
