...
import 'zones_cache_ttl_by_status_value_value.dart';/// Enterprise customers can set cache time-to-live (TTL) based on the
...
factory ZonesCacheTtlByStatus.fromJson(Map<String, dynamic> json) { return ZonesCacheTtlByStatus(
  ...
  value: (json['value'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, ZonesCacheTtlByStatusValueValue.fromJson(v as Map<String, dynamic>))),
); }
