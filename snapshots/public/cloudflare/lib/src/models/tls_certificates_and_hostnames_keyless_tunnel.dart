...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('private_ip') && json['private_ip'] is String &&
      json.containsKey('vnet_id') && json['vnet_id'] is String; } 
TlsCertificatesAndHostnamesKeylessTunnel copyWith({String? privateIp, String? vnetId, }) { return TlsCertificatesAndHostnamesKeylessTunnel(
