...
import 'brapi_post_json_request_variant1_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostJsonRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostJsonRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
