...
import 'package:collection/collection.dart';import 'inline_object1166_add_script_tag.dart';import 'inline_object1166_add_style_tag.dart';import 'inline_object1166_allow_resource_types.dart';import 'inline_object1166_authenticate.dart';import 'inline_object1166_cookies.dart';import 'inline_object1166_goto_options.dart';import 'inline_object1166_reject_resource_types.dart';import 'inline_object1166_viewport.dart';import 'inline_object1166_wait_for_selector.dart';final class InlineObject1166 {const InlineObject1166({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.excludeExternalLinks = false, this.gotoOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.visibleLinksOnly = false, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1166.fromJson(Map<String, dynamic> json) { return InlineObject1166(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1166AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1166AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1166AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1166Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1166Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  gotoOptions: json['gotoOptions'] != null ? InlineObject1166GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1166RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  viewport: json['viewport'] != null ? InlineObject1166Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  visibleLinksOnly: json.containsKey('visibleLinksOnly') ? json['visibleLinksOnly'] as bool : false,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1166WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
InlineObject1166 copyWith({double Function()? actionTimeout, List<InlineObject1166AddScriptTag> Function()? addScriptTag, List<InlineObject1166AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1166AllowResourceTypes> Function()? allowResourceTypes, InlineObject1166Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1166Cookies> Function()? cookies, String Function()? emulateMediaType, bool Function()? excludeExternalLinks, InlineObject1166GotoOptions Function()? gotoOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1166RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, Uri? url, String Function()? userAgent, InlineObject1166Viewport Function()? viewport, bool Function()? visibleLinksOnly, InlineObject1166WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1166(
