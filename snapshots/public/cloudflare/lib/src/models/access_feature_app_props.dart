...
import 'package:collection/collection.dart';import 'access_type.dart';final class AccessFeatureAppProps {const AccessFeatureAppProps({this.allowedIdps, this.autoRedirectToIdentity, this.customDenyUrl, this.customNonIdentityDenyUrl, this.customPages, this.domain, this.name, this.sessionDuration, required this.type, });
...
AccessFeatureAppProps copyWith({List<String> Function()? allowedIdps, bool Function()? autoRedirectToIdentity, String Function()? customDenyUrl, String Function()? customNonIdentityDenyUrl, List<String> Function()? customPages, String Function()? domain, String Function()? name, String Function()? sessionDuration, AccessType? type, }) { return AccessFeatureAppProps(
