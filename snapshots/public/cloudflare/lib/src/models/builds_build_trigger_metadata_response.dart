...
import 'builds_build_trigger_source.dart';import 'builds_scm_provider_type.dart';final class BuildsBuildTriggerMetadataResponse {const BuildsBuildTriggerMetadataResponse({this.author, this.branch, this.buildCommand, this.buildTokenName, this.buildTokenUuid, this.buildTriggerSource, this.commitHash, this.commitMessage, this.deployCommand, this.environmentVariables, this.providerAccountName, this.providerType, this.repoName, this.rootDirectory, });
...
BuildsBuildTriggerMetadataResponse copyWith({String Function()? author, String Function()? branch, String Function()? buildCommand, String Function()? buildTokenName, String Function()? buildTokenUuid, BuildsBuildTriggerSource Function()? buildTriggerSource, String Function()? commitHash, String Function()? commitMessage, String Function()? deployCommand, Map<String, String> Function()? environmentVariables, String Function()? providerAccountName, BuildsScmProviderType Function()? providerType, String Function()? repoName, String Function()? rootDirectory, }) { return BuildsBuildTriggerMetadataResponse(
