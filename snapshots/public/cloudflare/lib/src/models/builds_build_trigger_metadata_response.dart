...
import 'builds_branch.dart';import 'builds_build_command.dart';import 'builds_build_token_name.dart';import 'builds_build_token_uuid.dart';import 'builds_build_trigger_source.dart';import 'builds_commit_hash.dart';import 'builds_deploy_command.dart';import 'builds_provider_account_name.dart';import 'builds_repo_name.dart';import 'builds_root_directory.dart';import 'builds_scm_provider_type.dart';final class BuildsBuildTriggerMetadataResponse {const BuildsBuildTriggerMetadataResponse({this.author, this.branch, this.buildCommand, this.buildTokenName, this.buildTokenUuid, this.buildTriggerSource, this.commitHash, this.commitMessage, this.deployCommand, this.environmentVariables, this.providerAccountName, this.providerType, this.repoName, this.rootDirectory, });
