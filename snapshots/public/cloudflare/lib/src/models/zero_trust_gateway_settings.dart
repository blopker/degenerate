...
import 'zero_trust_gateway_audit_ssh_settings_components_schemas_uuid.dart';import 'zero_trust_gateway_public_key.dart';import 'zero_trust_gateway_read_only_timestamp.dart';final class ZeroTrustGatewaySettings {const ZeroTrustGatewaySettings({this.createdAt, this.publicKey, this.seedId, this.updatedAt, });
