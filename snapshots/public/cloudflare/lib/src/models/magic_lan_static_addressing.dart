...
import 'magic_lan_dhcp_relay.dart';import 'magic_lan_dhcp_server.dart';/// If the site is not configured in high availability mode, this configuration is optional (if omitted, use DHCP). However, if in high availability mode, static_address is required along with secondary and virtual address.
...
MagicLanStaticAddressing copyWith({String? address, MagicLanDhcpRelay Function()? dhcpRelay, MagicLanDhcpServer Function()? dhcpServer, String Function()? secondaryAddress, String Function()? virtualAddress, }) { return MagicLanStaticAddressing(
