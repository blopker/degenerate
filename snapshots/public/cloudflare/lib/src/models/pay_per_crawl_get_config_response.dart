...
import 'package:collection/collection.dart';import 'pay_per_crawl_daric_config.dart';import 'pay_per_crawl_msg.dart';import 'pay_per_crawl_result_info.dart';final class PayPerCrawlGetConfigResponse {const PayPerCrawlGetConfigResponse({this.errors, this.messages, this.result, this.resultInfo, this.success, });
