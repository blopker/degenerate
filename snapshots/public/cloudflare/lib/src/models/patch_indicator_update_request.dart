...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'patch_indicator_update_request_related_events.dart';import 'patch_indicator_update_request_tags.dart';final class PatchIndicatorUpdateRequest {const PatchIndicatorUpdateRequest({this.indicatorType, this.relatedEvents, this.tags, this.value, });
...
factory PatchIndicatorUpdateRequest.fromJson(Map<String, dynamic> json) { return PatchIndicatorUpdateRequest(
  ...
  tags: (json['tags'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PatchIndicatorUpdateRequestTagsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PatchIndicatorUpdateRequestTagsVariant2.canParse(v),)).toList(),
