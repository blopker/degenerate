...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'workers_binding_item.dart';import 'workers_compatibility_date.dart';import 'workers_compatibility_flag.dart';import 'workers_limits.dart';import 'workers_logpush.dart';import 'workers_namespace_script_and_version_settings_item_migrations.dart';import 'workers_observability.dart';import 'workers_placement_info_no_status.dart';import 'workers_tag.dart';import 'workers_tail_consumers_script.dart';import 'workers_usage_model.dart';/// Script and version settings for Workers for Platforms namespace scripts. Same as script-and-version-settings-item but without annotations, which are not supported for namespace scripts.
/// 
...
factory WorkersNamespaceScriptAndVersionSettingsItem.fromJson(Map<String, dynamic> json) { return WorkersNamespaceScriptAndVersionSettingsItem(
  ...
  migrations: json['migrations'] != null ? OneOf2.parse(json['migrations'], fromA: (v) => WorkersMigrationTagConditions.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && WorkersMigrationTagConditions.canParse(v), fromB: (v) => WorkersMigrationTagConditions.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && WorkersMigrationTagConditions.canParse(v),) : null,
