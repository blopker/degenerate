...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_update_gateway_request_dlp.dart';import 'aig_config_update_gateway_request_otel.dart';import 'aig_config_update_gateway_request_stripe.dart';final class AigConfigUpdateGatewayRequestLogManagementStrategy {const AigConfigUpdateGatewayRequestLogManagementStrategy._(this.value);
...
factory AigConfigUpdateGatewayRequest.fromJson(Map<String, dynamic> json) { return AigConfigUpdateGatewayRequest(
  ...
  dlp: json['dlp'] != null ? OneOf2.parse(json['dlp'], fromA: (v) => AigConfigUpdateGatewayRequestDlpVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AigConfigUpdateGatewayRequestDlpVariant1.canParse(v), fromB: (v) => AigConfigUpdateGatewayRequestDlpVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AigConfigUpdateGatewayRequestDlpVariant2.canParse(v),) : null,
