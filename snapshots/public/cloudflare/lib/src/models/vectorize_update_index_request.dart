...
final class VectorizeUpdateIndexRequest {const VectorizeUpdateIndexRequest({required this.description});
...
VectorizeUpdateIndexRequest copyWith({String? description}) { return VectorizeUpdateIndexRequest(
