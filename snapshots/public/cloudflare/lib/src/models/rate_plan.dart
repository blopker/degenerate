...
import 'package:collection/collection.dart';import 'component_value.dart';import 'currency.dart';import 'duration.dart';import 'rate_plan_components_schemas_identifier.dart';import 'schemas_frequency.dart';import 'schemas_name.dart';final class RatePlan {const RatePlan({this.components, this.currency, this.duration, this.frequency, this.id, this.name, });
