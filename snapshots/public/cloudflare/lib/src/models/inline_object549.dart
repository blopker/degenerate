...
import 'package:collection/collection.dart';import 'inline_object549_functions.dart';import 'inline_object549_messages.dart';import 'inline_object549_response_format.dart';import 'inline_object549_tools.dart';final class InlineObject549 {const InlineObject549({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });
...
factory InlineObject549.fromJson(Map<String, dynamic> json) { return InlineObject549(
  ...
  responseFormat: json['response_format'] != null ? InlineObject549ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => InlineObject549Tools.fromJson(e)).toList(),
...
@override String toString() { return 'InlineObject549(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
