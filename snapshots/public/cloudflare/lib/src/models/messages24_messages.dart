...
import 'messages24_messages_content.dart';final class Messages24Messages {const Messages24Messages({required this.content, required this.role, });

factory Messages24Messages.fromJson(Map<String, dynamic> json) { return Messages24Messages(
  content: Messages24MessagesContent.fromJson(json['content']),
