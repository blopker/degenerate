...
import 'dlp_addin_auth.dart';final class DlpAddinAccountMapping {const DlpAddinAccountMapping({required this.addinIdentifierToken, required this.authRequirements, });
