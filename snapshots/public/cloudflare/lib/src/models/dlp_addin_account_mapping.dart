...
import 'dlp_addin_auth.dart';import 'dlp_addin_auth_no_auth.dart';import 'dlp_addin_auth_org.dart';final class DlpAddinAccountMapping {const DlpAddinAccountMapping({required this.addinIdentifierToken, required this.authRequirements, });
...
factory DlpAddinAccountMapping.fromJson(Map<String, dynamic> json) { return DlpAddinAccountMapping(
  ...
  authRequirements: DlpAddinAuth.fromJson(json['auth_requirements'] as Map<String, dynamic>),
); }
