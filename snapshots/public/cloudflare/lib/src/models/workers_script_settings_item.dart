...
import 'package:collection/collection.dart';import 'workers_observability.dart';import 'workers_tail_consumers_script.dart';final class WorkersScriptSettingsItem {const WorkersScriptSettingsItem({this.logpush, this.observability, this.tags, this.tailConsumers, });
...
WorkersScriptSettingsItem copyWith({bool Function()? logpush, WorkersObservability? Function()? observability, List<String>? Function()? tags, List<WorkersTailConsumersScript>? Function()? tailConsumers, }) { return WorkersScriptSettingsItem(
