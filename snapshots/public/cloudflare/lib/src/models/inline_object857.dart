...
final class InlineObject857 {const InlineObject857({required this.inputText, this.maxLength = 1024, });
...
InlineObject857 copyWith({String? inputText, int Function()? maxLength, }) { return InlineObject857(
...
@override String toString() { return 'InlineObject857(inputText: $inputText, maxLength: $maxLength)'; } 
 }
