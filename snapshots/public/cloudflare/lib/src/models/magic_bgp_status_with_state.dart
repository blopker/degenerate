...
import 'magic_bgp_status_with_state_state.dart';final class MagicBgpStatusWithState {const MagicBgpStatusWithState({this.bgpState, this.cfSpeakerIp, this.cfSpeakerPort, this.customerSpeakerIp, this.customerSpeakerPort, required this.state, required this.tcpEstablished, required this.updatedAt, });
