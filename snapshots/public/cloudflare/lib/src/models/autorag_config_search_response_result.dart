...
import 'package:collection/collection.dart';import 'autorag_config_search_response_result_data.dart';final class AutoragConfigSearchResponseResult {const AutoragConfigSearchResponseResult({this.data, this.hasMore = false, this.nextPage, this.object, required this.searchQuery, });
