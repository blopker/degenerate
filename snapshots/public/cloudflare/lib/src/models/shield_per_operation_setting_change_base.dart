...
import 'shield_per_operation_setting_change_base_mitigation_action.dart';final class ShieldPerOperationSettingChangeBase {const ShieldPerOperationSettingChangeBase({this.mitigationAction});
