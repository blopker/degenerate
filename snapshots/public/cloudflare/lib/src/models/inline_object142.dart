...
import 'package:collection/collection.dart';import 'inline_object142_bundle_method.dart';import 'inline_object142_method.dart';import 'inline_object142_status.dart';import 'inline_object142_type.dart';import 'inline_object142_validation_errors.dart';import 'tls_certificates_and_hostnames_certificate_authority.dart';import 'tls_certificates_and_hostnames_sslsettings.dart';import 'tls_certificates_and_hostnames_validation_record.dart';final class InlineObject142 {const InlineObject142({this.bundleMethod = InlineObject142BundleMethod.ubiquitous, this.certificateAuthority, this.customCertificate, this.customCsrId, this.customKey, this.dcvDelegationRecords, this.expiresOn, this.hosts, this.id, this.issuer, this.method, this.serialNumber, this.settings, this.signature, this.status, this.type, this.uploadedOn, this.validationErrors, this.validationRecords, this.wildcard, });
