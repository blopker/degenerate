...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'access_scim_config_authentication.dart';import 'access_scim_config_authentication_access_service_token.dart';import 'access_scim_config_authentication_http_basic.dart';import 'access_scim_config_authentication_oauth2.dart';import 'access_scim_config_authentication_oauth_bearer_token.dart';import 'access_scim_config_mapping.dart';import 'access_scim_config_single_authentication.dart';/// Configuration for provisioning to this application via SCIM. This is currently in closed beta.
...
factory AccessScimConfig.fromJson(Map<String, dynamic> json) { return AccessScimConfig(
  authentication: json['authentication'] != null ? OneOf2.parse(json['authentication'], fromA: (v) => AccessScimConfigSingleAuthentication.fromJson(v as Map<String, dynamic>), fromB: (v) => (v as List<dynamic>).map((e) => AccessScimConfigSingleAuthentication.fromJson(e as Map<String, dynamic>)).toList(),) : null,
