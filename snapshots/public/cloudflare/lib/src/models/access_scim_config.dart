...
import 'package:collection/collection.dart';import 'access_scim_config_authentication.dart';import 'access_scim_config_mapping.dart';/// Configuration for provisioning to this application via SCIM. This is currently in closed beta.
...
factory AccessScimConfig.fromJson(Map<String, dynamic> json) { return AccessScimConfig(
  authentication: json['authentication'] != null ? AccessScimConfigAuthentication.fromJson(json['authentication']) : null,
