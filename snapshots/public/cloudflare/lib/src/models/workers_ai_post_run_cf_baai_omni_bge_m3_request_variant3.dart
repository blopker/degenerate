...
import 'package:collection/collection.dart';import 'workers_ai_post_run_cf_baai_omni_bge_m3_request_variant3_requests.dart';final class WorkersAiPostRunCfBaaiOmniBgeM3RequestVariant3 {const WorkersAiPostRunCfBaaiOmniBgeM3RequestVariant3({required this.requests});
...
factory WorkersAiPostRunCfBaaiOmniBgeM3RequestVariant3.fromJson(Map<String, dynamic> json) { return WorkersAiPostRunCfBaaiOmniBgeM3RequestVariant3(
  requests: (json['requests'] as List<dynamic>).map((e) => WorkersAiPostRunCfBaaiOmniBgeM3RequestVariant3Requests.fromJson(e)).toList(),
); }
