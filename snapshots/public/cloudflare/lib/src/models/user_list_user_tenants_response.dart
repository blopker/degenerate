...
import 'package:collection/collection.dart';import 'message3.dart';import 'organization.dart';final class UserListUserTenantsResponse {const UserListUserTenantsResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
UserListUserTenantsResponse copyWith({List<Map<String,Object?>>? errors, List<Message3>? messages, List<Organization>? result, bool? success, }) { return UserListUserTenantsResponse(
