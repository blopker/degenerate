...
UserListUserTenantsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<Organization>? result, bool? success, }) { return UserListUserTenantsResponse(
