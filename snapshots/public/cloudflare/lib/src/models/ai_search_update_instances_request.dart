...
factory AiSearchUpdateInstancesRequest.fromJson(Map<String, dynamic> json) { return AiSearchUpdateInstancesRequest(
  ...
  aiSearchModel: json['ai_search_model'] != null ? OneOf2.parse(json['ai_search_model'], fromA: (v) => AiSearchUpdateInstancesRequestAiSearchModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesRequestAiSearchModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  embeddingModel: json['embedding_model'] != null ? OneOf2.parse(json['embedding_model'], fromA: (v) => AiSearchUpdateInstancesRequestEmbeddingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesRequestEmbeddingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rerankingModel: json['reranking_model'] != null ? OneOf2.parse(json['reranking_model'], fromA: (v) => AiSearchUpdateInstancesRequestRerankingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesRequestRerankingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rewriteModel: json['rewrite_model'] != null ? OneOf2.parse(json['rewrite_model'], fromA: (v) => AiSearchUpdateInstancesRequestRewriteModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesRequestRewriteModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  summarizationModel: json['summarization_model'] != null ? OneOf2.parse(json['summarization_model'], fromA: (v) => AiSearchUpdateInstancesRequestSummarizationModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesRequestSummarizationModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
