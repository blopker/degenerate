...
import 'package:collection/collection.dart';import 'dlp_context_awareness.dart';import 'dlp_entry_of_new_profile.dart';import 'dlp_new_shared_entry.dart';final class DlpNewCustomProfile {const DlpNewCustomProfile({this.aiContextEnabled = false, this.allowedMatchCount = 0, this.confidenceThreshold = 'low', this.contextAwareness, this.dataClasses, this.dataTags, this.description, this.entries, required this.name, this.ocrEnabled = false, this.sensitivityLevels, this.sharedEntries, });
