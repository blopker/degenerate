...
factory DlpNewCustomProfile.fromJson(Map<String, dynamic> json) { return DlpNewCustomProfile(
  ...
  entries: (json['entries'] as List<dynamic>?)?.map((e) => DlpEntryOfNewProfile.fromJson(e as Map<String, dynamic>)).toList(),
