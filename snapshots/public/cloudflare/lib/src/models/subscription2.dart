...
import 'package:collection/collection.dart';import 'component_value2.dart';import 'currency.dart';import 'current_period_end.dart';import 'current_period_start.dart';import 'frequency.dart';import 'price.dart';import 'rate_plan2.dart';import 'schemas_identifier.dart';import 'state.dart';import 'subscription2_app.dart';import 'zone.dart';final class Subscription2 {const Subscription2({this.app, this.componentValues, this.currency, this.currentPeriodEnd, this.currentPeriodStart, this.frequency, this.id, this.price, this.ratePlan, this.state, this.zone, });
