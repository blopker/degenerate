...
import 'package:collection/collection.dart';import 'component_value2.dart';import 'frequency.dart';import 'rate_plan2.dart';import 'state.dart';import 'subscription2_app.dart';import 'zone.dart';final class Subscription2 {const Subscription2({this.app, this.componentValues, this.currency, this.currentPeriodEnd, this.currentPeriodStart, this.frequency, this.id, this.price, this.ratePlan, this.state, this.zone, });
...
Subscription2 copyWith({Subscription2App Function()? app, List<ComponentValue2> Function()? componentValues, String Function()? currency, DateTime Function()? currentPeriodEnd, DateTime Function()? currentPeriodStart, Frequency Function()? frequency, String Function()? id, double Function()? price, RatePlan2 Function()? ratePlan, State Function()? state, Zone Function()? zone, }) { return Subscription2(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Subscription2 &&
          app == other.app &&
          const ListEquality<dynamic>().equals(componentValues, other.componentValues) &&
