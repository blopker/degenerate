...
factory BrapiPostSnapshotRequestVariant1.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant1(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostSnapshotRequestVariant1AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostSnapshotRequestVariant1RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
