...
import 'workers_kv_bulk_get_result_values_value.dart';final class WorkersKvBulkGetResult {const WorkersKvBulkGetResult({this.values});

factory WorkersKvBulkGetResult.fromJson(Map<String, dynamic> json) { return WorkersKvBulkGetResult(
  values: (json['values'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, WorkersKvBulkGetResultValuesValue.fromJson(v))),
); }
