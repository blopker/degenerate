...
import 'iam_permissions.dart';final class IamRole {const IamRole({required this.description, required this.id, required this.name, required this.permissions, });
...
IamRole copyWith({String? description, String? id, String? name, IamPermissions? permissions, }) { return IamRole(
