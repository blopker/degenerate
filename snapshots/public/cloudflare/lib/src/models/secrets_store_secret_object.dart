...
import 'secrets_store_secret_status.dart';final class SecretsStoreSecretObject {const SecretsStoreSecretObject({this.comment, required this.created, required this.id, required this.modified, required this.name, required this.status, required this.storeId, });
...
SecretsStoreSecretObject copyWith({String Function()? comment, DateTime? created, String? id, DateTime? modified, String? name, SecretsStoreSecretStatus? status, String? storeId, }) { return SecretsStoreSecretObject(
