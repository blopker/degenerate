...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages51_messages_tool_content.dart';final class Messages51MessagesToolRole {const Messages51MessagesToolRole._(this.value);
...
factory Messages51MessagesTool.fromJson(Map<String, dynamic> json) { return Messages51MessagesTool(
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => Messages51MessagesToolContentVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
