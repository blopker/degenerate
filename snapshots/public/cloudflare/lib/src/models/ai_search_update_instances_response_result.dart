...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_update_instances_response_result_ai_search_model.dart';import 'ai_search_update_instances_response_result_custom_metadata.dart';import 'ai_search_update_instances_response_result_embedding_model.dart';import 'ai_search_update_instances_response_result_metadata.dart';import 'ai_search_update_instances_response_result_public_endpoint_params.dart';import 'ai_search_update_instances_response_result_reranking_model.dart';import 'ai_search_update_instances_response_result_retrieval_options.dart';import 'ai_search_update_instances_response_result_rewrite_model.dart';import 'ai_search_update_instances_response_result_source_params.dart';final class AiSearchUpdateInstancesResponseResultCacheThreshold {const AiSearchUpdateInstancesResponseResultCacheThreshold._(this.value);
...
factory AiSearchUpdateInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchUpdateInstancesResponseResult(
  ...
  aiSearchModel: json['ai_search_model'] != null ? OneOf2.parse(json['ai_search_model'], fromA: (v) => AiSearchUpdateInstancesResponseResultAiSearchModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesResponseResultAiSearchModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  embeddingModel: json['embedding_model'] != null ? OneOf2.parse(json['embedding_model'], fromA: (v) => AiSearchUpdateInstancesResponseResultEmbeddingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesResponseResultEmbeddingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rerankingModel: json['reranking_model'] != null ? OneOf2.parse(json['reranking_model'], fromA: (v) => AiSearchUpdateInstancesResponseResultRerankingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesResponseResultRerankingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rewriteModel: json['rewrite_model'] != null ? OneOf2.parse(json['rewrite_model'], fromA: (v) => AiSearchUpdateInstancesResponseResultRewriteModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchUpdateInstancesResponseResultRewriteModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
