...
import 'brapi_post_pdf_request_variant2_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostPdfRequestVariant2GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant2GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostPdfRequestVariant2GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
