...
import 'package:collection/collection.dart';import 'custom_pages_state.dart';import 'custom_pages_timestamp.dart';import 'custom_pages_url.dart';final class CustomPagesCustomPage {const CustomPagesCustomPage({this.createdOn, this.description, this.id, this.modifiedOn, this.previewTarget, this.requiredTokens, this.state, this.url, });
