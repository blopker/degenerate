...
import 'package:collection/collection.dart';final class InlineObject839 {const InlineObject839({this.guidance = 7.5, this.height, this.image, this.imageB64, this.mask, this.negativePrompt, this.numSteps = 20, required this.prompt, this.seed, this.strength = 1.0, this.width, });
...
InlineObject839 copyWith({double Function()? guidance, int Function()? height, List<double> Function()? image, String Function()? imageB64, List<double> Function()? mask, String Function()? negativePrompt, int Function()? numSteps, String? prompt, int Function()? seed, double Function()? strength, int Function()? width, }) { return InlineObject839(
...
@override String toString() { return 'InlineObject839(guidance: $guidance, height: $height, image: $image, imageB64: $imageB64, mask: $mask, negativePrompt: $negativePrompt, numSteps: $numSteps, prompt: $prompt, seed: $seed, strength: $strength, width: $width)'; } 
 }
