...
import 'addressing_bgp_prefix_update_advertisement_on_demand.dart';final class AddressingBgpPrefixUpdateAdvertisement {const AddressingBgpPrefixUpdateAdvertisement({this.asnPrependCount, this.autoAdvertiseWithdraw, this.onDemand, });
...
AddressingBgpPrefixUpdateAdvertisement copyWith({int Function()? asnPrependCount, bool Function()? autoAdvertiseWithdraw, AddressingBgpPrefixUpdateAdvertisementOnDemand Function()? onDemand, }) { return AddressingBgpPrefixUpdateAdvertisement(
