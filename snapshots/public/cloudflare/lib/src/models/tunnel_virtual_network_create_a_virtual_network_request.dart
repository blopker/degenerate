...
final class TunnelVirtualNetworkCreateAVirtualNetworkRequest {const TunnelVirtualNetworkCreateAVirtualNetworkRequest({this.comment, this.isDefault, this.isDefaultNetwork, required this.name, });
...
TunnelVirtualNetworkCreateAVirtualNetworkRequest copyWith({String Function()? comment, bool Function()? isDefault, bool Function()? isDefaultNetwork, String? name, }) { return TunnelVirtualNetworkCreateAVirtualNetworkRequest(
