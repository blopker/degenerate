...
import 'package:collection/collection.dart';import 'iam_effect.dart';import 'iam_permission_group.dart';import 'iam_resources.dart';final class IamPolicyWithPermissionGroupsAndResources {const IamPolicyWithPermissionGroupsAndResources({required this.effect, required this.id, required this.permissionGroups, required this.resources, });
...
IamPolicyWithPermissionGroupsAndResources copyWith({IamEffect? effect, String? id, List<IamPermissionGroup>? permissionGroups, IamResources? resources, }) { return IamPolicyWithPermissionGroupsAndResources(
