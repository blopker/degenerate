...
import 'package:collection/collection.dart';import 'inline_object1611_add_script_tag.dart';import 'inline_object1611_add_style_tag.dart';import 'inline_object1611_allow_resource_types.dart';import 'inline_object1611_authenticate.dart';import 'inline_object1611_cookies.dart';import 'inline_object1611_goto_options.dart';import 'inline_object1611_reject_resource_types.dart';import 'inline_object1611_screenshot_options.dart';import 'inline_object1611_viewport.dart';import 'inline_object1611_wait_for_selector.dart';final class InlineObject1611 {const InlineObject1611({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.screenshotOptions, this.scrollPage, this.selector, this.setExtraHttpHeaders, this.setJavaScriptEnabled, required this.url, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject1611.fromJson(Map<String, dynamic> json) { return InlineObject1611(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject1611AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject1611AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1611AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject1611Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject1611Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject1611GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject1611RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  screenshotOptions: json['screenshotOptions'] != null ? InlineObject1611ScreenshotOptions.fromJson(json['screenshotOptions'] as Map<String, dynamic>) : null,
  ...
  viewport: json['viewport'] != null ? InlineObject1611Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1611WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
final List<InlineObject1611AddScriptTag>? addScriptTag;

/// Adds a `<link rel="stylesheet">` tag into the page with the desired URL or a `<style type="text/css">` tag with the content.
final List<InlineObject1611AddStyleTag>? addStyleTag;
...
final List<InlineObject1611AllowResourceTypes>? allowResourceTypes;

/// Provide credentials for HTTP authentication.
final InlineObject1611Authenticate? authenticate;

/// Attempt to proceed when 'awaited' events fail or timeout.
final bool? bestAttempt;

/// Check [options](https://pptr.dev/api/puppeteer.page.setcookie).
final List<InlineObject1611Cookies>? cookies;

final String? emulateMediaType;

/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
final InlineObject1611GotoOptions? gotoOptions;
...
final List<InlineObject1611RejectResourceTypes>? rejectResourceTypes;

/// Check [options](https://pptr.dev/api/puppeteer.screenshotoptions).
final InlineObject1611ScreenshotOptions? screenshotOptions;
...
InlineObject1611 copyWith({double Function()? actionTimeout, List<InlineObject1611AddScriptTag> Function()? addScriptTag, List<InlineObject1611AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject1611AllowResourceTypes> Function()? allowResourceTypes, InlineObject1611Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject1611Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject1611GotoOptions Function()? gotoOptions, List<String> Function()? rejectRequestPattern, List<InlineObject1611RejectResourceTypes> Function()? rejectResourceTypes, InlineObject1611ScreenshotOptions Function()? screenshotOptions, bool Function()? scrollPage, String Function()? selector, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, Uri? url, String Function()? userAgent, InlineObject1611Viewport Function()? viewport, InlineObject1611WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject1611(
