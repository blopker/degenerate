...
import 'package:collection/collection.dart';import 'zero_trust_gateway_ip_network.dart';final class ZeroTrustGatewayDotEndpoint {const ZeroTrustGatewayDotEndpoint({this.enabled, this.networks, });
