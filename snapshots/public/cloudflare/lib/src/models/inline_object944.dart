...
import 'package:collection/collection.dart';import 'inline_object944_add_script_tag.dart';import 'inline_object944_add_style_tag.dart';import 'inline_object944_allow_resource_types.dart';import 'inline_object944_authenticate.dart';import 'inline_object944_cookies.dart';import 'inline_object944_goto_options.dart';import 'inline_object944_reject_resource_types.dart';import 'inline_object944_viewport.dart';import 'inline_object944_wait_for_selector.dart';final class InlineObject944 {const InlineObject944({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, required this.html, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });

factory InlineObject944.fromJson(Map<String, dynamic> json) { return InlineObject944(
  actionTimeout: json['actionTimeout'] != null ? (json['actionTimeout'] as num).toDouble() : null,
  addScriptTag: (json['addScriptTag'] as List<dynamic>?)?.map((e) => InlineObject944AddScriptTag.fromJson(e as Map<String, dynamic>)).toList(),
  addStyleTag: (json['addStyleTag'] as List<dynamic>?)?.map((e) => InlineObject944AddStyleTag.fromJson(e as Map<String, dynamic>)).toList(),
  allowRequestPattern: (json['allowRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject944AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  authenticate: json['authenticate'] != null ? InlineObject944Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  bestAttempt: json['bestAttempt'] as bool?,
  cookies: (json['cookies'] as List<dynamic>?)?.map((e) => InlineObject944Cookies.fromJson(e as Map<String, dynamic>)).toList(),
  emulateMediaType: json['emulateMediaType'] as String?,
  gotoOptions: json['gotoOptions'] != null ? InlineObject944GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  html: json['html'] as String,
  rejectRequestPattern: (json['rejectRequestPattern'] as List<dynamic>?)?.map((e) => e as String).toList(),
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => InlineObject944RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  viewport: json['viewport'] != null ? InlineObject944Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject944WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
...
InlineObject944 copyWith({double Function()? actionTimeout, List<InlineObject944AddScriptTag> Function()? addScriptTag, List<InlineObject944AddStyleTag> Function()? addStyleTag, List<String> Function()? allowRequestPattern, List<InlineObject944AllowResourceTypes> Function()? allowResourceTypes, InlineObject944Authenticate Function()? authenticate, bool Function()? bestAttempt, List<InlineObject944Cookies> Function()? cookies, String Function()? emulateMediaType, InlineObject944GotoOptions Function()? gotoOptions, String? html, List<String> Function()? rejectRequestPattern, List<InlineObject944RejectResourceTypes> Function()? rejectResourceTypes, Map<String, String> Function()? setExtraHttpHeaders, bool Function()? setJavaScriptEnabled, String Function()? userAgent, InlineObject944Viewport Function()? viewport, InlineObject944WaitForSelector Function()? waitForSelector, double Function()? waitForTimeout, }) { return InlineObject944(
