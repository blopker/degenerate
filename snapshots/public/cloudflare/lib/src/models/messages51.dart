...
import 'package:collection/collection.dart';import 'messages51_audio.dart';import 'messages51_chat_template_kwargs.dart';import 'messages51_function_call.dart';import 'messages51_functions.dart';import 'messages51_messages.dart';import 'messages51_prediction.dart';import 'messages51_response_format.dart';import 'messages51_stop.dart';import 'messages51_stream_options.dart';import 'messages51_tool_choice.dart';import 'messages51_tools.dart';import 'messages51_web_search_options.dart';final class Messages51Modalities {const Messages51Modalities._(this.value);
...
factory Messages51.fromJson(Map<String, dynamic> json) { return Messages51(
  ...
  functionCall: json['function_call'] != null ? Messages51FunctionCall.fromJson(json['function_call'] as Map<String, dynamic>) : null,
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => Messages51Messages.fromJson(e)).toList(),
  ...
  stop: json['stop'] != null ? Messages51Stop.fromJson(json['stop'] as Map<String, dynamic>) : null,
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages51Tools.fromJson(e)).toList(),
