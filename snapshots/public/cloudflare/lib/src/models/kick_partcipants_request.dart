...
import 'package:collection/collection.dart';final class KickPartcipantsRequest {const KickPartcipantsRequest({required this.customParticipantIds, required this.participantIds, });
