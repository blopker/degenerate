...
final class ListsItemBase {const ListsItemBase({this.comment, required this.createdOn, required this.id, required this.modifiedOn, });
...
ListsItemBase copyWith({String Function()? comment, String? createdOn, String? id, String? modifiedOn, }) { return ListsItemBase(
