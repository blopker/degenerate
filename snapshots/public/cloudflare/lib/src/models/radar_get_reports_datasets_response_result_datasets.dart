...
import 'package:collection/collection.dart';final class RadarGetReportsDatasetsResponseResultDatasets {const RadarGetReportsDatasetsResponseResultDatasets({required this.description, required this.id, required this.meta, required this.tags, required this.title, required this.type, });
