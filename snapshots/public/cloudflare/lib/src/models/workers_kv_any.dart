...
final class WorkersKvAny {const WorkersKvAny({this.string, this.$double, this.$int, this.$bool, this.mapStringObject, this.listWorkersKvAny, });

factory WorkersKvAny.fromJson(Object? json) { return WorkersKvAny(
...
bool get isValid { return string != null || $double != null || $int != null || $bool != null || mapStringObject != null || listWorkersKvAny != null; } 
