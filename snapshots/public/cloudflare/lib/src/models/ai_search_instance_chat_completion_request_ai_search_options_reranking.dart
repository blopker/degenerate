...
import 'ai_search_instance_chat_completion_request_ai_search_options_reranking_model.dart';final class AiSearchInstanceChatCompletionRequestAiSearchOptionsReranking {const AiSearchInstanceChatCompletionRequestAiSearchOptionsReranking({this.enabled, this.matchThreshold = 0.4, this.model, });
