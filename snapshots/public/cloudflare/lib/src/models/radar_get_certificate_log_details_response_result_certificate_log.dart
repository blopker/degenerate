...
import 'package:collection/collection.dart';import 'radar_get_certificate_log_details_response_result_certificate_log_api.dart';import 'radar_get_certificate_log_details_response_result_certificate_log_performance.dart';import 'radar_get_certificate_log_details_response_result_certificate_log_related.dart';import 'radar_get_certificate_log_details_response_result_certificate_log_state.dart';final class RadarGetCertificateLogDetailsResponseResultCertificateLog {const RadarGetCertificateLogDetailsResponseResultCertificateLog({required this.api, required this.avgThroughput, required this.description, required this.endExclusive, required this.lastUpdate, required this.$operator, required this.performance, required this.related, required this.slug, required this.startInclusive, required this.state, required this.stateTimestamp, required this.submittableCertCount, required this.submittedCertCount, required this.url, });
