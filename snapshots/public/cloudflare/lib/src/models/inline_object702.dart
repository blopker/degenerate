...
factory InlineObject702.fromJson(Map<String, dynamic> json) { return InlineObject702(
  audio: json['audio'] != null ? InlineObject702Audio.fromJson(json['audio'] as Map<String, dynamic>) : null,
  chatTemplateKwargs: json['chat_template_kwargs'] != null ? InlineObject702ChatTemplateKwargs.fromJson(json['chat_template_kwargs'] as Map<String, dynamic>) : null,
  frequencyPenalty: json['frequency_penalty'] != null ? (json['frequency_penalty'] as num).toDouble() : null,
  functionCall: json['function_call'] != null ? InlineObject702FunctionCall.fromJson(json['function_call'] as Map<String, dynamic>) : null,
  ...
  prediction: json['prediction'] != null ? InlineObject702Prediction.fromJson(json['prediction'] as Map<String, dynamic>) : null,
  ...
  responseFormat: json['response_format'] != null ? InlineObject702ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
  ...
  stop: json['stop'] != null ? InlineObject702Stop.fromJson(json['stop'] as Map<String, dynamic>) : null,
  store: json['store'] as bool?,
  stream: json['stream'] as bool?,
  streamOptions: json['stream_options'] != null ? InlineObject702StreamOptions.fromJson(json['stream_options'] as Map<String, dynamic>) : null,
  temperature: json['temperature'] != null ? (json['temperature'] as num).toDouble() : null,
  toolChoice: json['tool_choice'] != null ? InlineObject702ToolChoice.fromJson(json['tool_choice'] as Map<String, dynamic>) : null,
  ...
  webSearchOptions: json['web_search_options'] != null ? InlineObject702WebSearchOptions.fromJson(json['web_search_options'] as Map<String, dynamic>) : null,
); }
