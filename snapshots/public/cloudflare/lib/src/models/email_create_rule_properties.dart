...
import 'package:collection/collection.dart';import 'email_rule_action.dart';import 'email_rule_matcher.dart';final class EmailCreateRuleProperties {const EmailCreateRuleProperties({required this.actions, this.enabled, required this.matchers, this.name, this.priority, });
...
EmailCreateRuleProperties copyWith({List<EmailRuleAction>? actions, bool Function()? enabled, List<EmailRuleMatcher>? matchers, String Function()? name, double Function()? priority, }) { return EmailCreateRuleProperties(
