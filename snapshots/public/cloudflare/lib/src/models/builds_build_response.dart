...
import 'builds_build_outcome.dart';import 'builds_build_response_pull_request.dart';import 'builds_build_response_trigger.dart';import 'builds_build_status.dart';import 'builds_build_trigger_metadata_response.dart';import 'builds_build_uuid.dart';import 'builds_created_on.dart';import 'builds_modified_on.dart';import 'builds_stopped_on.dart';final class BuildsBuildResponse {const BuildsBuildResponse({this.buildOutcome, this.buildTriggerMetadata, this.buildUuid, this.createdOn, this.initializingOn, this.modifiedOn, this.pullRequest, this.runningOn, this.status, this.stoppedOn, this.trigger, });
