...
import 'builds_build_outcome.dart';import 'builds_build_response_pull_request.dart';import 'builds_build_response_trigger.dart';import 'builds_build_status.dart';import 'builds_build_trigger_metadata_response.dart';final class BuildsBuildResponse {const BuildsBuildResponse({this.buildOutcome, this.buildTriggerMetadata, this.buildUuid, this.createdOn, this.initializingOn, this.modifiedOn, this.pullRequest, this.runningOn, this.status, this.stoppedOn, this.trigger, });
...
factory BuildsBuildResponse.fromJson(Map<String, dynamic> json) { return BuildsBuildResponse(
  ...
  stoppedOn: json['stopped_on'] != null ? DateTime.parse(json['stopped_on'] as String) : null,
...
BuildsBuildResponse copyWith({BuildsBuildOutcome Function()? buildOutcome, BuildsBuildTriggerMetadataResponse Function()? buildTriggerMetadata, String Function()? buildUuid, DateTime Function()? createdOn, DateTime? Function()? initializingOn, DateTime Function()? modifiedOn, BuildsBuildResponsePullRequest? Function()? pullRequest, DateTime? Function()? runningOn, BuildsBuildStatus Function()? status, DateTime? Function()? stoppedOn, BuildsBuildResponseTrigger Function()? trigger, }) { return BuildsBuildResponse(
