...
import 'cloudflare_pipelines_connection_schema.dart';import 'cloudflare_pipelines_format.dart';import 'sinks_response_result_config.dart';import 'sinks_response_result_type.dart';final class SinksResponseResult {const SinksResponseResult({this.config, required this.createdAt, this.format, required this.id, required this.modifiedAt, required this.name, this.schema, required this.type, });
