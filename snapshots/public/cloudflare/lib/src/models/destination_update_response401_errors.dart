...
import 'destination_update_response401_errors_message.dart';final class DestinationUpdateResponse401Errors {const DestinationUpdateResponse401Errors({this.detail, required this.message, });
