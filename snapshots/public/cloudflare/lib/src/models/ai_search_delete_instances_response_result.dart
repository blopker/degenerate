...
factory AiSearchDeleteInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchDeleteInstancesResponseResult(
  ...
  aiSearchModel: json['ai_search_model'] != null ? AiSearchDeleteInstancesResponseResultAiSearchModel.fromJson(json['ai_search_model'] as Map<String, dynamic>) : null,
  ...
  embeddingModel: json['embedding_model'] != null ? AiSearchDeleteInstancesResponseResultEmbeddingModel.fromJson(json['embedding_model'] as Map<String, dynamic>) : null,
  ...
  rerankingModel: json['reranking_model'] != null ? AiSearchDeleteInstancesResponseResultRerankingModel.fromJson(json['reranking_model'] as Map<String, dynamic>) : null,
  ...
  rewriteModel: json['rewrite_model'] != null ? AiSearchDeleteInstancesResponseResultRewriteModel.fromJson(json['rewrite_model'] as Map<String, dynamic>) : null,
