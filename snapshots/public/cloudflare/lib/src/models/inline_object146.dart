...
final class InlineObject146 {const InlineObject146({this.index});

factory InlineObject146.fromJson(Map<String, dynamic> json) { return InlineObject146(
...
InlineObject146 copyWith({int Function()? index}) { return InlineObject146(
  index: index != null ? index() : this.index,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject146 &&
          index == other.index; } 
@override int get hashCode { return index.hashCode; } 
@override String toString() { return 'InlineObject146(index: $index)'; } 
 }
