...
import 'package:collection/collection.dart';import 'brapi_post_pdf_request_variant1_add_script_tag.dart';import 'brapi_post_pdf_request_variant1_add_style_tag.dart';import 'brapi_post_pdf_request_variant1_allow_resource_types.dart';import 'brapi_post_pdf_request_variant1_authenticate.dart';import 'brapi_post_pdf_request_variant1_cookies.dart';import 'brapi_post_pdf_request_variant1_goto_options.dart';import 'brapi_post_pdf_request_variant1_pdf_options.dart';import 'brapi_post_pdf_request_variant1_reject_resource_types.dart';import 'brapi_post_pdf_request_variant1_viewport.dart';import 'brapi_post_pdf_request_variant1_wait_for_selector.dart';final class BrapiPostPdfRequestVariant1 {const BrapiPostPdfRequestVariant1({this.actionTimeout, this.addScriptTag, this.addStyleTag, this.allowRequestPattern, this.allowResourceTypes, this.authenticate, this.bestAttempt, this.cookies, this.emulateMediaType, this.gotoOptions, required this.html, this.pdfOptions, this.rejectRequestPattern, this.rejectResourceTypes, this.setExtraHttpHeaders, this.setJavaScriptEnabled, this.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36', this.viewport, this.waitForSelector, this.waitForTimeout, });
...
factory BrapiPostPdfRequestVariant1.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant1(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostPdfRequestVariant1AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostPdfRequestVariant1RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
