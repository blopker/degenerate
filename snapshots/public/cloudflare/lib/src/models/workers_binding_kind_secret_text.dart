...
final class WorkersBindingKindSecretText {const WorkersBindingKindSecretText({required this.name, required this.text, required this.type, });
...
WorkersBindingKindSecretText copyWith({String? name, String? text, String? type, }) { return WorkersBindingKindSecretText(
  name: name ?? this.name,
  text: text ?? this.text,
  type: type ?? this.type,
); } 
