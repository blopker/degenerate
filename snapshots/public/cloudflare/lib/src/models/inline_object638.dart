...
import 'inline_object638_response_format.dart';final class InlineObject638 {const InlineObject638({this.frequencyPenalty, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });
...
factory InlineObject638.fromJson(Map<String, dynamic> json) { return InlineObject638(
  ...
  responseFormat: json['response_format'] != null ? InlineObject638ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final InlineObject638ResponseFormat? responseFormat;
...
InlineObject638 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject638ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject638(
...
@override String toString() { return 'InlineObject638(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
