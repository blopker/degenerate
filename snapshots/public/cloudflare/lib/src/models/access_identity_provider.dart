...
import 'access_components_schemas_name.dart';import 'access_identity_provider_scim_config.dart';import 'access_identity_provider_type.dart';import 'access_uuid.dart';final class AccessIdentityProvider {const AccessIdentityProvider({required this.config, this.id, required this.name, this.scimConfig, required this.type, });
...
AccessIdentityProvider copyWith({Map<String,String>? config, AccessUuid Function()? id, AccessComponentsSchemasName? name, AccessIdentityProviderScimConfig Function()? scimConfig, AccessIdentityProviderType? type, }) { return AccessIdentityProvider(
