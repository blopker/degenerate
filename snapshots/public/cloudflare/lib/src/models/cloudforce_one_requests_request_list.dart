...
import 'cloudforce_one_requests_request_list_sort_order.dart';import 'cloudforce_one_requests_request_status.dart';import 'cloudforce_one_requests_request_type.dart';import 'cloudforce_one_requests_time.dart';final class CloudforceOneRequestsRequestList {const CloudforceOneRequestsRequestList({this.completedAfter, this.completedBefore, this.createdAfter, this.createdBefore, required this.page, required this.perPage, this.requestType, this.sortBy, this.sortOrder, this.status, });
