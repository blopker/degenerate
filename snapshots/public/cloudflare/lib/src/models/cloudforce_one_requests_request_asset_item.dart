...
final class CloudforceOneRequestsRequestAssetItem {const CloudforceOneRequestsRequestAssetItem({this.created, this.description, this.fileType, required this.id, required this.name, });
...
CloudforceOneRequestsRequestAssetItem copyWith({DateTime Function()? created, String Function()? description, String Function()? fileType, int? id, String? name, }) { return CloudforceOneRequestsRequestAssetItem(
