...
factory MagicVisibilityPcapsPcapsRequestFull.fromJson(Map<String, dynamic> json) { return MagicVisibilityPcapsPcapsRequestFull(
  ...
  filterV1: json['filter_v1'] != null
        ...
        : null,
  packetLimit: json['packet_limit'] != null ? (json['packet_limit'] as num).toDouble() : null,
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('colo_name') && json['colo_name'] is String &&
      json.containsKey('destination_conf') && json['destination_conf'] is String &&
      json.containsKey('system') &&
      json.containsKey('time_limit') && json['time_limit'] is num &&
      json.containsKey('type'); } 
MagicVisibilityPcapsPcapsRequestFull copyWith({double Function()? byteLimit, String? coloName, String? destinationConf, MagicVisibilityPcapsPcapsFilter Function()? filterV1, double Function()? packetLimit, MagicVisibilityPcapsPcapsSystem? system, double? timeLimit, MagicVisibilityPcapsPcapsType? type, }) { return MagicVisibilityPcapsPcapsRequestFull(
