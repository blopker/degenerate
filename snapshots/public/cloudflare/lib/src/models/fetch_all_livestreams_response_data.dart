...
import 'fetch_all_livestreams_response_data_paging.dart';import 'fetch_all_livestreams_response_data_status.dart';final class FetchAllLivestreamsResponseData {const FetchAllLivestreamsResponseData({this.createdAt, this.disabled, this.id, this.ingestServer, this.meetingId, this.name, this.paging, this.playbackUrl, this.status, this.streamKey, this.updatedAt, });
