...
factory AiSearchInstanceChatCompletionRequestAiSearchOptionsQueryRewrite.fromJson(Map<String, dynamic> json) { return AiSearchInstanceChatCompletionRequestAiSearchOptionsQueryRewrite(
  ...
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => AiSearchInstanceChatCompletionRequestAiSearchOptionsQueryRewriteModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchInstanceChatCompletionRequestAiSearchOptionsQueryRewriteModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
