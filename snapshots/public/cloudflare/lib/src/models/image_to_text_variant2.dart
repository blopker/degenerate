...
import 'image_to_text_variant2_image.dart';final class ImageToTextVariant2 {const ImageToTextVariant2({this.frequencyPenalty, required this.image, this.maxTokens = 512, this.presencePenalty, this.prompt, this.raw = false, this.repetitionPenalty, this.seed, this.temperature, this.topK, this.topP, });
...
factory ImageToTextVariant2.fromJson(Map<String, dynamic> json) { return ImageToTextVariant2(
  ...
  image: ImageToTextVariant2Image.fromJson(json['image']),
