...
import 'security_center_issue_class.dart';import 'security_center_issue_payload.dart';import 'security_center_issue_severity.dart';import 'security_center_issue_type.dart';import 'security_center_subject.dart';final class SecurityCenterIssue {const SecurityCenterIssue({this.dismissed, this.id, this.issueClass, this.issueType, this.payload, this.resolveLink, this.resolveText, this.severity, this.since, this.subject, this.timestamp, });
