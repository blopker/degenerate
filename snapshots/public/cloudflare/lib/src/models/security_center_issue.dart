...
import 'security_center_issue_payload.dart';import 'security_center_issue_severity.dart';import 'security_center_issue_type.dart';final class SecurityCenterIssue {const SecurityCenterIssue({this.dismissed, this.id, this.issueClass, this.issueType, this.payload, this.resolveLink, this.resolveText, this.severity, this.since, this.subject, this.timestamp, });
...
SecurityCenterIssue copyWith({bool Function()? dismissed, String Function()? id, String Function()? issueClass, SecurityCenterIssueType Function()? issueType, SecurityCenterIssuePayload Function()? payload, String Function()? resolveLink, String Function()? resolveText, SecurityCenterIssueSeverity Function()? severity, DateTime Function()? since, String Function()? subject, DateTime Function()? timestamp, }) { return SecurityCenterIssue(
