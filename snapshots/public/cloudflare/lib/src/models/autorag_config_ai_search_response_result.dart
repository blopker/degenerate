...
import 'package:collection/collection.dart';import 'autorag_config_ai_search_response_result_data.dart';final class AutoragConfigAiSearchResponseResult {const AutoragConfigAiSearchResponseResult({this.data, this.hasMore = false, this.nextPage, this.object, required this.response, required this.searchQuery, });
