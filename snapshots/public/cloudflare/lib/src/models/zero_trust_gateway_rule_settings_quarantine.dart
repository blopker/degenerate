...
import 'package:collection/collection.dart';import 'zero_trust_gateway_rule_settings_quarantine_file_types.dart';/// Configure settings that apply to quarantine rules. Settable only for `http` rules.
