...
import 'package:collection/collection.dart';import 'access_allowed_methods2.dart';final class AccessSchemasCorsHeaders {const AccessSchemasCorsHeaders({this.allowAllHeaders, this.allowAllMethods, this.allowAllOrigins, this.allowCredentials, this.allowedHeaders, this.allowedMethods, this.allowedOrigins, this.maxAge, });
...
AccessSchemasCorsHeaders copyWith({bool Function()? allowAllHeaders, bool Function()? allowAllMethods, bool Function()? allowAllOrigins, bool Function()? allowCredentials, List<String> Function()? allowedHeaders, List<AccessAllowedMethods2> Function()? allowedMethods, List<String> Function()? allowedOrigins, double Function()? maxAge, }) { return AccessSchemasCorsHeaders(
