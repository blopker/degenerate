...
final class WorkersBindingKindVectorize {const WorkersBindingKindVectorize({required this.indexName, required this.name, required this.type, });
...
WorkersBindingKindVectorize copyWith({String? indexName, String? name, String? type, }) { return WorkersBindingKindVectorize(
