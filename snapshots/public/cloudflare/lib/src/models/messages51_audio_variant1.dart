...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages51_audio_variant1_voice.dart';final class Messages51AudioVariant1Format {const Messages51AudioVariant1Format._(this.value);
...
factory Messages51AudioVariant1.fromJson(Map<String, dynamic> json) { return Messages51AudioVariant1(
  ...
  voice: OneOf2.parse(json['voice'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Messages51AudioVariant1VoiceVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages51AudioVariant1VoiceVariant2.canParse(v),),
); }
