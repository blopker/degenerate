...
import 'firewall_configuration.dart';import 'firewall_schemas_mode.dart';final class UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest {const UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest({required this.configuration, this.description, required this.id, required this.mode, this.paused, });
...
UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest copyWith({FirewallConfiguration? configuration, String Function()? description, String? id, FirewallSchemasMode? mode, bool Function()? paused, }) { return UserAgentBlockingRulesUpdateAUserAgentBlockingRuleRequest(
