...
import 'package:collection/collection.dart';import 'firewall_rewrite_action.dart';final class WafOverridesUpdateWafOverrideRequest {const WafOverridesUpdateWafOverrideRequest({required this.id, required this.rewriteAction, required this.rules, required this.urls, });
...
WafOverridesUpdateWafOverrideRequest copyWith({String? id, FirewallRewriteAction? rewriteAction, Map<String,String>? rules, List<String>? urls, }) { return WafOverridesUpdateWafOverrideRequest(
  id: id ?? this.id,
