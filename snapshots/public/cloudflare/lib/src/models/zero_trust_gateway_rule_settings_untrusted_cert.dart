...
import 'zero_trust_gateway_rule_settings_untrusted_cert_action.dart';/// Configure behavior when an upstream certificate is invalid or an SSL error occurs. Settable only for `http` rules with the action set to `allow`.
