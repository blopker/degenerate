...
import 'package:collection/collection.dart';import 'intel_domain_name.dart';final class IntelWhois {const IntelWhois({this.createdDate, this.domain, this.nameservers, this.registrant, this.registrantCountry, this.registrantEmail, this.registrantOrg, this.registrar, this.updatedDate, });
