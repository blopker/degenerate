...
import 'package:collection/collection.dart';import 'post_event_create_request_indicators.dart';import 'post_event_create_request_raw.dart';final class PostEventCreateRequest {const PostEventCreateRequest({this.accountId, this.attacker, this.attackerCountry, required this.category, this.datasetId, required this.date, required this.event, this.indicator, this.indicatorType, this.indicators, this.insight, required this.raw, this.tags, this.targetCountry, this.targetIndustry, required this.tlp, });
