...
factory AccessAnyValidServiceTokenRule.fromJson(Map<String, dynamic> json) { return AccessAnyValidServiceTokenRule(
  anyValidServiceToken: (json['any_valid_service_token'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)),
); }
...
AccessAnyValidServiceTokenRule copyWith({Map<String,String>? anyValidServiceToken}) { return AccessAnyValidServiceTokenRule(
