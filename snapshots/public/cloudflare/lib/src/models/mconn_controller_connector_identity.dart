...
final class MconnControllerConnectorIdentity {const MconnControllerConnectorIdentity({required this.accountId, required this.activated, required this.id, });
...
MconnControllerConnectorIdentity copyWith({String? accountId, bool? activated, String? id, }) { return MconnControllerConnectorIdentity(
