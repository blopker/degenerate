...
import 'package:collection/collection.dart';import 'radar_get_dns_top_ases_response_result_meta_confidence_info.dart';import 'radar_get_dns_top_ases_response_result_meta_date_range.dart';import 'radar_get_dns_top_ases_response_result_meta_units.dart';/// Normalization method applied to the results. Refer to [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
...
factory RadarGetDnsTopAsesResponseResultMeta.fromJson(Map<String, dynamic> json) { return RadarGetDnsTopAsesResponseResultMeta(
  confidenceInfo: RadarGetDnsTopAsesResponseResultMetaConfidenceInfo.fromJson(json['confidenceInfo'] as Map<String, dynamic>),
