...
import 'autorag_config_ai_search_request_filters_variant2_filters_value.dart';final class AutoragConfigAiSearchRequestFiltersVariant2FiltersType {const AutoragConfigAiSearchRequestFiltersVariant2FiltersType._(this.value);
...
factory AutoragConfigAiSearchRequestFiltersVariant2Filters.fromJson(Map<String, dynamic> json) { return AutoragConfigAiSearchRequestFiltersVariant2Filters(
  ...
  value: AutoragConfigAiSearchRequestFiltersVariant2FiltersValue.fromJson(json['value'] as Map<String, dynamic>),
); }
...
final AutoragConfigAiSearchRequestFiltersVariant2FiltersValue value;
...
AutoragConfigAiSearchRequestFiltersVariant2Filters copyWith({String? key, AutoragConfigAiSearchRequestFiltersVariant2FiltersType? type, AutoragConfigAiSearchRequestFiltersVariant2FiltersValue? value, }) { return AutoragConfigAiSearchRequestFiltersVariant2Filters(
  key: key ?? this.key,
  type: type ?? this.type,
