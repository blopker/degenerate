...
import 'package:collection/collection.dart';import 'pages_messages2.dart';final class ResponseCommonFailure53 {const ResponseCommonFailure53({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure53 copyWith({List<PagesMessages2>? errors, List<PagesMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure53(
