...
factory Prompt43.fromJson(Map<String, dynamic> json) { return Prompt43(
  ...
  functionCall: json['function_call'] != null ? Prompt43FunctionCall.fromJson(json['function_call'] as Map<String, dynamic>) : null,
  ...
  stop: json['stop'] != null ? Prompt43Stop.fromJson(json['stop'] as Map<String, dynamic>) : null,
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Prompt43Tools.fromJson(e)).toList(),
