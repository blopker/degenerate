...
import 'package:collection/collection.dart';final class AccountsBatchMoveAccountsRequest {const AccountsBatchMoveAccountsRequest({required this.accountIds, required this.destinationOrganizationId, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccountsBatchMoveAccountsRequest &&
          const ListEquality<dynamic>().equals(accountIds, other.accountIds) &&
