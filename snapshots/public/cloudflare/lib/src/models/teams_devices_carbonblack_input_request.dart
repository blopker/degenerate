...
import 'teams_devices_carbonblack_input_request_operating_system.dart';final class TeamsDevicesCarbonblackInputRequest {const TeamsDevicesCarbonblackInputRequest({required this.operatingSystem, required this.path, this.sha256, this.thumbprint, });
