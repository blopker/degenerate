...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('disconnect') && json['disconnect'] is bool; } 
TeamsDevicesGlobalWarpOverrideRequest copyWith({bool? disconnect, String Function()? justification, }) { return TeamsDevicesGlobalWarpOverrideRequest(
