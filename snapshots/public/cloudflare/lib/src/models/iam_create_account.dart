...
import 'iam_create_account_unit.dart';final class IamCreateAccount {const IamCreateAccount({required this.name, this.type, this.unit, });
...
IamCreateAccount copyWith({String? name, String Function()? type, IamCreateAccountUnit Function()? unit, }) { return IamCreateAccount(
  name: name ?? this.name,
