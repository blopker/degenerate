...
import 'package:collection/collection.dart';import 'healthchecks_messages2.dart';import 'response_common33_result.dart';final class ResponseCommon33 {const ResponseCommon33({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon33.fromJson(Map<String, dynamic> json) { return ResponseCommon33(
  ...
  result: ResponseCommon33Result.fromJson(json['result'] as Map<String, dynamic>),
