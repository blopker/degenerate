...
import 'package:collection/collection.dart';import 'nsc_interconnect.dart';final class NscInterconnectList {const NscInterconnectList({required this.items, this.next, });
