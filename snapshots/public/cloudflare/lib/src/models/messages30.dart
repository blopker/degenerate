...
factory Messages30.fromJson(Map<String, dynamic> json) { return Messages30(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages30Tools.fromJson(e)).toList(),
