...
import 'package:collection/collection.dart';final class TeamsDevicesDiskEncryptionInputRequest {const TeamsDevicesDiskEncryptionInputRequest({this.checkDisks, this.requireAll, });
...
TeamsDevicesDiskEncryptionInputRequest copyWith({List<String> Function()? checkDisks, bool Function()? requireAll, }) { return TeamsDevicesDiskEncryptionInputRequest(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is TeamsDevicesDiskEncryptionInputRequest &&
          const ListEquality<dynamic>().equals(checkDisks, other.checkDisks) &&
