...
import 'logcontrol_allow_out_of_region_access.dart';import 'logcontrol_regions.dart';final class LogcontrolCmbConfig {const LogcontrolCmbConfig({this.allowOutOfRegionAccess, this.regions, });
