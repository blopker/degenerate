...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_update_gateway_response_result_dlp.dart';import 'aig_config_update_gateway_response_result_otel.dart';import 'aig_config_update_gateway_response_result_stripe.dart';final class AigConfigUpdateGatewayResponseResultLogManagementStrategy {const AigConfigUpdateGatewayResponseResultLogManagementStrategy._(this.value);
...
factory AigConfigUpdateGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigUpdateGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? OneOf2.parse(json['dlp'], fromA: (v) => AigConfigUpdateGatewayResponseResultDlpVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AigConfigUpdateGatewayResponseResultDlpVariant1.canParse(v), fromB: (v) => AigConfigUpdateGatewayResponseResultDlpVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AigConfigUpdateGatewayResponseResultDlpVariant2.canParse(v),) : null,
