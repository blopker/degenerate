...
factory AigConfigUpdateGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigUpdateGatewayResponseResult(
  ...
  dlp: json['dlp'] != null
        ? AigConfigUpdateGatewayResponseResultDlp.fromJson(json['dlp'] as Map<String, dynamic>)
        : null,
  ...
  stripe: json['stripe'] != null
        ? AigConfigUpdateGatewayResponseResultStripe.fromJson(json['stripe'] as Map<String, dynamic>)
        : null,
