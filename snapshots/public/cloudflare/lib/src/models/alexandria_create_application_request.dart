...
import 'package:collection/collection.dart';final class AlexandriaCreateApplicationRequest {const AlexandriaCreateApplicationRequest({required this.applicationTypeId, this.hostnames, required this.humanId, this.ipSubnets, required this.name, this.portProtocols, this.supportDomains, });
...
AlexandriaCreateApplicationRequest copyWith({String? applicationTypeId, List<String> Function()? hostnames, String? humanId, List<String> Function()? ipSubnets, String? name, List<String> Function()? portProtocols, List<String> Function()? supportDomains, }) { return AlexandriaCreateApplicationRequest(
