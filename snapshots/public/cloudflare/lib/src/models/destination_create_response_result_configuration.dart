...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'destination_create_response_result_configuration_logpush_dataset.dart';final class DestinationCreateResponseResultConfigurationType {const DestinationCreateResponseResultConfigurationType._(this.value);
...
factory DestinationCreateResponseResultConfiguration.fromJson(Map<String, dynamic> json) { return DestinationCreateResponseResultConfiguration(
  ...
  logpushDataset: OneOf2.parse(json['logpushDataset'], fromA: (v) => DestinationCreateResponseResultConfigurationLogpushDatasetVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => DestinationCreateResponseResultConfigurationLogpushDatasetVariant2.fromJson(v as String), canParseB: (v) => v is String,),
