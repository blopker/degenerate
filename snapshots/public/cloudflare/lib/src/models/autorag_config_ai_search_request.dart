...
factory AutoragConfigAiSearchRequest.fromJson(Map<String, dynamic> json) { return AutoragConfigAiSearchRequest(
  filters: json['filters'] != null ? OneOf2.parse(json['filters'], fromA: (v) => AutoragConfigAiSearchRequestFiltersVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AutoragConfigAiSearchRequestFiltersVariant1.canParse(v), fromB: (v) => AutoragConfigAiSearchRequestFiltersVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AutoragConfigAiSearchRequestFiltersVariant2.canParse(v),) : null,
  maxNumResults: json.containsKey('max_num_results') ? (json['max_num_results'] as num).toInt() : 10,
  model: json['model'] != null ? OneOf2.parse(json['model'], fromA: (v) => AutoragConfigAiSearchRequestModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AutoragConfigAiSearchRequestModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
