...
import 'input_embedding3_text.dart';final class InputEmbedding3 {const InputEmbedding3({required this.text, this.truncateInputs = false, });

factory InputEmbedding3.fromJson(Map<String, dynamic> json) { return InputEmbedding3(
  text: InputEmbedding3Text.fromJson(json['text']),
