...
import 'inline_object652_response_format.dart';final class InlineObject652 {const InlineObject652({this.frequencyPenalty, this.lora, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });

factory InlineObject652.fromJson(Map<String, dynamic> json) { return InlineObject652(
  ...
  responseFormat: json['response_format'] != null ? InlineObject652ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final InlineObject652ResponseFormat? responseFormat;
...
InlineObject652 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject652ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject652(
...
@override String toString() { return 'InlineObject652(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
