...
import 'teams_devices_tanium_input_request_operator.dart';import 'teams_devices_tanium_input_request_risk_level.dart';import 'teams_devices_tanium_input_request_score_operator.dart';final class TeamsDevicesTaniumInputRequest {const TeamsDevicesTaniumInputRequest({required this.connectionId, this.eidLastSeen, this.$operator, this.riskLevel, this.scoreOperator, this.totalScore, });
