...
final class MconnControllerDevice {const MconnControllerDevice({required this.cryptKey, this.cryptKeyRotationFinishedAt, required this.id, this.imagedAt, this.lastCryptKey, this.serialNumber, });
...
MconnControllerDevice copyWith({String? cryptKey, String Function()? cryptKeyRotationFinishedAt, String? id, String Function()? imagedAt, String Function()? lastCryptKey, String Function()? serialNumber, }) { return MconnControllerDevice(
