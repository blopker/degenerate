...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'brapi_post_snapshot_request_variant2_screenshot_options_clip.dart';import 'brapi_post_snapshot_request_variant2_screenshot_options_type.dart';final class BrapiPostSnapshotRequestVariant2ScreenshotOptions {const BrapiPostSnapshotRequestVariant2ScreenshotOptions({this.captureBeyondViewport, this.clip, this.fromSurface, this.fullPage, this.omitBackground, this.optimizeForSpeed, this.quality, this.type, });
...
factory BrapiPostSnapshotRequestVariant2ScreenshotOptions.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant2ScreenshotOptions(
  ...
  type: json['type'] != null ? OneOf3.parse(json['type'], fromA: (v) => BrapiPostSnapshotRequestVariant2ScreenshotOptionsTypeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostSnapshotRequestVariant2ScreenshotOptionsTypeVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostSnapshotRequestVariant2ScreenshotOptionsTypeVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
); }
