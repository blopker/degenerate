...
import 'd1_jurisdiction_nullable.dart';import 'd1_read_replication_details.dart';/// The details of the D1 database.
...
factory D1DatabaseDetailsResponse.fromJson(Map<String, dynamic> json) { return D1DatabaseDetailsResponse(
  ...
  numTables: json['num_tables'] != null ? (json['num_tables'] as num).toDouble() : null,
...
D1DatabaseDetailsResponse copyWith({DateTime Function()? createdAt, double Function()? fileSize, D1JurisdictionNullable? Function()? jurisdiction, String Function()? name, double Function()? numTables, D1ReadReplicationDetails Function()? readReplication, String Function()? uuid, String Function()? version, }) { return D1DatabaseDetailsResponse(
