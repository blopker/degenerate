...
final class CustomOriginTrustStoreCreateRequest {const CustomOriginTrustStoreCreateRequest({required this.certificate});
...
CustomOriginTrustStoreCreateRequest copyWith({String? certificate}) { return CustomOriginTrustStoreCreateRequest(
