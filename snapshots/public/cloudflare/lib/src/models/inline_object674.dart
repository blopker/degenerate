...
import 'package:collection/collection.dart';import 'inline_object674_functions.dart';import 'inline_object674_messages.dart';import 'inline_object674_tools.dart';final class InlineObject674 {const InlineObject674({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });

factory InlineObject674.fromJson(Map<String, dynamic> json) { return InlineObject674(
  frequencyPenalty: json['frequency_penalty'] != null ? (json['frequency_penalty'] as num).toDouble() : null,
  functions: (json['functions'] as List<dynamic>?)?.map((e) => InlineObject674Functions.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => InlineObject674Messages.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => InlineObject674Tools.fromJson(e)).toList(),
...
InlineObject674 copyWith({double Function()? frequencyPenalty, List<InlineObject674Functions> Function()? functions, Map<String, String> Function()? guidedJson, int Function()? maxTokens, List<InlineObject674Messages>? messages, double Function()? presencePenalty, bool Function()? raw, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, List<InlineObject674Tools> Function()? tools, int Function()? topK, double Function()? topP, }) { return InlineObject674(
...
@override String toString() { return 'InlineObject674(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
