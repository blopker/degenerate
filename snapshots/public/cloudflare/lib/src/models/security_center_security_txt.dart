...
import 'package:collection/collection.dart';final class SecurityCenterSecurityTxt {const SecurityCenterSecurityTxt({this.acknowledgments, this.canonical, this.contact, this.enabled, this.encryption, this.expires, this.hiring, this.policy, this.preferredLanguages, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is SecurityCenterSecurityTxt &&
          const ListEquality<dynamic>().equals(acknowledgments, other.acknowledgments) &&
          const ListEquality<dynamic>().equals(canonical, other.canonical) &&
          const ListEquality<dynamic>().equals(contact, other.contact) &&
          enabled == other.enabled &&
          const ListEquality<dynamic>().equals(encryption, other.encryption) &&
