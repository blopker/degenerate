...
import 'package:collection/collection.dart';import 'aig_config_list_evaluations_response_result.dart';final class AigConfigListEvaluationsResponse {const AigConfigListEvaluationsResponse({required this.result, required this.success, });
