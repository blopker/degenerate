...
import 'package:collection/collection.dart';import 'ai_search_fetch_instances_response_result_source_params_web_crawler.dart';final class AiSearchFetchInstancesResponseResultSourceParams {const AiSearchFetchInstancesResponseResultSourceParams({this.excludeItems, this.includeItems, this.prefix, this.r2Jurisdiction = 'default', this.webCrawler, });
...
factory AiSearchFetchInstancesResponseResultSourceParams.fromJson(Map<String, dynamic> json) { return AiSearchFetchInstancesResponseResultSourceParams(
  ...
  webCrawler: json['web_crawler'] != null
        ? AiSearchFetchInstancesResponseResultSourceParamsWebCrawler.fromJson(json['web_crawler'] as Map<String, dynamic>)
        : null,
); }
