...
import 'package:collection/collection.dart';final class WorkersObservabilityQueryResultsTraces {const WorkersObservabilityQueryResultsTraces({this.errors, required this.rootSpanName, required this.rootTransactionName, required this.service, required this.spans, required this.traceDurationMs, required this.traceEndMs, required this.traceId, required this.traceStartMs, });
