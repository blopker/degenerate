...
factory InlineObject1055.fromJson(Map<String, dynamic> json) { return InlineObject1055(
  ...
  authenticate: json['authenticate'] != null ? InlineObject1055Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  ...
  gotoOptions: json['gotoOptions'] != null ? InlineObject1055GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  ...
  responseFormat: json['response_format'] != null ? InlineObject1055ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
  ...
  viewport: json['viewport'] != null ? InlineObject1055Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1055WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
