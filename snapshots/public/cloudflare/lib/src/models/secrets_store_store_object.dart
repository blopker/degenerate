...
final class SecretsStoreStoreObject {const SecretsStoreStoreObject({required this.created, required this.id, required this.modified, required this.name, });
...
SecretsStoreStoreObject copyWith({DateTime? created, String? id, DateTime? modified, String? name, }) { return SecretsStoreStoreObject(
