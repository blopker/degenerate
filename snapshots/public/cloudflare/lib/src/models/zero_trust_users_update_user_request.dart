...
final class ZeroTrustUsersUpdateUserRequest {const ZeroTrustUsersUpdateUserRequest({required this.email, required this.name, });
...
ZeroTrustUsersUpdateUserRequest copyWith({String? email, String? name, }) { return ZeroTrustUsersUpdateUserRequest(
