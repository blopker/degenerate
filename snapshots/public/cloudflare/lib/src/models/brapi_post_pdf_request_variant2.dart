...
factory BrapiPostPdfRequestVariant2.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant2(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostPdfRequestVariant2AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostPdfRequestVariant2RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
