...
import 'telemetry_values_list_response_result_value.dart';final class TelemetryValuesListResponseResultType {const TelemetryValuesListResponseResultType._(this.value);
...
factory TelemetryValuesListResponseResult.fromJson(Map<String, dynamic> json) { return TelemetryValuesListResponseResult(
  ...
  value: TelemetryValuesListResponseResultValue.fromJson(json['value'] as Map<String, dynamic>),
); }
...
TelemetryValuesListResponseResult copyWith({String? dataset, String? key, TelemetryValuesListResponseResultType? type, TelemetryValuesListResponseResultValue? value, }) { return TelemetryValuesListResponseResult(
