...
import 'package:collection/collection.dart';import 'inline_object533_functions.dart';import 'inline_object533_image.dart';import 'inline_object533_messages.dart';import 'inline_object533_tools.dart';final class InlineObject533 {const InlineObject533({this.frequencyPenalty, this.functions, this.image, this.maxTokens = 256, required this.messages, this.presencePenalty, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory InlineObject533.fromJson(Map<String, dynamic> json) { return InlineObject533(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => InlineObject533Tools.fromJson(e)).toList(),
...
InlineObject533 copyWith({double Function()? frequencyPenalty, List<InlineObject533Functions> Function()? functions, InlineObject533Image Function()? image, int Function()? maxTokens, List<InlineObject533Messages>? messages, double Function()? presencePenalty, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, List<InlineObject533Tools> Function()? tools, int Function()? topK, double Function()? topP, }) { return InlineObject533(
...
@override String toString() { return 'InlineObject533(frequencyPenalty: $frequencyPenalty, functions: $functions, image: $image, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
