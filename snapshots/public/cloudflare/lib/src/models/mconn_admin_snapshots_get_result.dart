...
import 'package:collection/collection.dart';import 'mconn_snapshot_metadata.dart';final class MconnAdminSnapshotsGetResult {const MconnAdminSnapshotsGetResult({required this.count, this.cursor, required this.items, });
