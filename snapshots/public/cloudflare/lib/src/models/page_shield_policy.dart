...
import 'page_shield_policy_action.dart';final class PageShieldPolicy {const PageShieldPolicy({required this.action, required this.description, required this.enabled, required this.expression, required this.value, });
...
PageShieldPolicy copyWith({PageShieldPolicyAction? action, String? description, bool? enabled, String? expression, String? value, }) { return PageShieldPolicy(
