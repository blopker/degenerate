...
import 'load_balancing_schemas_header.dart';final class LoadBalancingOrigin {const LoadBalancingOrigin({this.address, this.disabledAt, this.enabled, this.header, this.name, this.port, this.virtualNetworkId, this.weight, });
...
LoadBalancingOrigin copyWith({String Function()? address, DateTime Function()? disabledAt, bool Function()? enabled, LoadBalancingSchemasHeader Function()? header, String Function()? name, int Function()? port, String Function()? virtualNetworkId, double Function()? weight, }) { return LoadBalancingOrigin(
