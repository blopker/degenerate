...
import 'package:collection/collection.dart';final class PostCategoryUpdateResponse {const PostCategoryUpdateResponse({required this.killChain, this.mitreAttack, required this.name, this.shortname, required this.uuid, });
