...
import 'package:collection/collection.dart';final class AigConfigUpdateProvidersResponse400Errors {const AigConfigUpdateProvidersResponse400Errors({required this.code, required this.message, required this.path, });
