...
import 'radar_get_ct_summary_response_result_meta.dart';import 'radar_get_ct_summary_response_result_summary0.dart';final class RadarGetCtSummaryResponseResult {const RadarGetCtSummaryResponseResult({required this.meta, required this.summary0, });
...
factory RadarGetCtSummaryResponseResult.fromJson(Map<String, dynamic> json) { return RadarGetCtSummaryResponseResult(
  ...
  summary0: RadarGetCtSummaryResponseResultSummary0.fromJson(json['summary_0'] as Map<String, dynamic>),
); }
