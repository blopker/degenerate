...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'ai_search_create_instances_request_ai_search_model.dart';import 'ai_search_create_instances_request_custom_metadata.dart';import 'ai_search_create_instances_request_embedding_model.dart';import 'ai_search_create_instances_request_metadata.dart';import 'ai_search_create_instances_request_public_endpoint_params.dart';import 'ai_search_create_instances_request_reranking_model.dart';import 'ai_search_create_instances_request_retrieval_options.dart';import 'ai_search_create_instances_request_rewrite_model.dart';import 'ai_search_create_instances_request_source_params.dart';final class AiSearchCreateInstancesRequestCacheThreshold {const AiSearchCreateInstancesRequestCacheThreshold._(this.value);
...
factory AiSearchCreateInstancesRequest.fromJson(Map<String, dynamic> json) { return AiSearchCreateInstancesRequest(
  ...
  aiSearchModel: json['ai_search_model'] != null ? OneOf2.parse(json['ai_search_model'], fromA: (v) => AiSearchCreateInstancesRequestAiSearchModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchCreateInstancesRequestAiSearchModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  embeddingModel: json['embedding_model'] != null ? OneOf2.parse(json['embedding_model'], fromA: (v) => AiSearchCreateInstancesRequestEmbeddingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchCreateInstancesRequestEmbeddingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rerankingModel: json['reranking_model'] != null ? OneOf2.parse(json['reranking_model'], fromA: (v) => AiSearchCreateInstancesRequestRerankingModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchCreateInstancesRequestRerankingModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  rewriteModel: json['rewrite_model'] != null ? OneOf2.parse(json['rewrite_model'], fromA: (v) => AiSearchCreateInstancesRequestRewriteModelVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => AiSearchCreateInstancesRequestRewriteModelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
