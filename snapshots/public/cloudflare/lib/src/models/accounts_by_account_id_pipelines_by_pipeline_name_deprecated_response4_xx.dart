...
import 'package:collection/collection.dart';import 'accounts_by_account_id_pipelines_by_pipeline_name_deprecated_response4_xx_errors.dart';final class AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse4Xx {const AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse4Xx({required this.errors, required this.results, required this.success, });
...
AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse4Xx copyWith({List<AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse4XxErrors>? errors, Map<String, String>? Function()? results, bool? success, }) { return AccountsByAccountIdPipelinesByPipelineNameDeprecatedResponse4Xx(
