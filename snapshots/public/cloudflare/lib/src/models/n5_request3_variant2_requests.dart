...
import 'n5_request3_variant2_requests_text.dart';/// The pooling method used in the embedding process. `cls` pooling will generate more accurate embeddings on larger inputs - however, embeddings created with cls pooling are not compatible with embeddings generated with mean pooling. The default pooling method is `mean` in order for this to not be a breaking change, but we highly suggest using the new `cls` pooling for better accuracy.
...
factory $5Request3Variant2Requests.fromJson(Map<String, dynamic> json) { return $5Request3Variant2Requests(
  ...
  text: $5Request3Variant2RequestsText.fromJson(json['text']),
); }
