...
factory WorkersObservabilityQueryResultsEventsSeriesData.fromJson(Map<String, dynamic> json) { return WorkersObservabilityQueryResultsEventsSeriesData(
  ...
  groups: (json['groups'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject151.fromJson(v as Map<String, dynamic>))),
...
WorkersObservabilityQueryResultsEventsSeriesData copyWith({WorkersObservabilityQueryResultsEventsSeriesDataAggregates? aggregates, double? count, double Function()? errors, Map<String, InlineObject151> Function()? groups, double? interval, double? sampleInterval, }) { return WorkersObservabilityQueryResultsEventsSeriesData(
