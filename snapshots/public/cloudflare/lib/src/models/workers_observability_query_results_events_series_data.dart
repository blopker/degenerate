...
factory WorkersObservabilityQueryResultsEventsSeriesData.fromJson(Map<String, dynamic> json) { return WorkersObservabilityQueryResultsEventsSeriesData(
  ...
  groups: (json['groups'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, WorkersObservabilityQueryResultsEventsSeriesDataGroupsValue.fromJson(v as Map<String, dynamic>))),
...
final Map<String,WorkersObservabilityQueryResultsEventsSeriesDataGroupsValue>? groups;
...
Map<String, dynamic> toJson() { return {
  ...
  'count': count,
  'errors': ?errors,
  if (groups != null) 'groups': groups?.map((k, v) => MapEntry(k, v.toJson())),
  'interval': interval,
...
WorkersObservabilityQueryResultsEventsSeriesData copyWith({WorkersObservabilityQueryResultsEventsSeriesDataAggregates? aggregates, double? count, double Function()? errors, Map<String, WorkersObservabilityQueryResultsEventsSeriesDataGroupsValue> Function()? groups, double? interval, double? sampleInterval, }) { return WorkersObservabilityQueryResultsEventsSeriesData(
