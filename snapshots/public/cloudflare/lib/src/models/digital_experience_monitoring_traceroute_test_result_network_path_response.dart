...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_traceroute_test_result_network_path_response_hops.dart';import 'digital_experience_monitoring_uuid.dart';final class DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse {const DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponse({this.deviceName, required this.hops, required this.resultId, this.testId, this.testName, });
