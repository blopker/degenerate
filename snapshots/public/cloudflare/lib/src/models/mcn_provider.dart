...
McnProvider copyWith({String Function()? awsArn, String Function()? azureSubscriptionId, String Function()? azureTenantId, McnCloudType? cloudType, String Function()? description, String? friendlyName, String Function()? gcpProjectId, String Function()? gcpServiceAccountEmail, String? id, String? lastUpdated, McnProviderLifecycleState? lifecycleState, McnProviderDiscoveryStatus? state, McnProviderDiscoveryStatus? stateV2, McnProviderStatus Function()? status, }) { return McnProvider(
