...
import 'package:collection/collection.dart';import 'workers_placement_region.dart';final class WorkersPlacementProvider {const WorkersPlacementProvider({required this.id, required this.regions, });
