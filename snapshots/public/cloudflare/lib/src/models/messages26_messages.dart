...
import 'messages26_messages_content.dart';final class Messages26Messages {const Messages26Messages({required this.content, required this.role, });

factory Messages26Messages.fromJson(Map<String, dynamic> json) { return Messages26Messages(
  content: Messages26MessagesContent.fromJson(json['content']),
