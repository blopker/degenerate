...
import 'package:collection/collection.dart';final class AaaAlertTypes {const AaaAlertTypes({this.description, this.displayName, this.filterOptions, this.type, });
...
AaaAlertTypes copyWith({String Function()? description, String Function()? displayName, List<String> Function()? filterOptions, String Function()? type, }) { return AaaAlertTypes(
