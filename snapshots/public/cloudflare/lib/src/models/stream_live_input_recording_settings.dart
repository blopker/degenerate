...
import 'package:collection/collection.dart';import 'stream_live_input_recording_mode.dart';/// Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be viewable as a live video and transition to on-demand after a condition is satisfied.
...
StreamLiveInputRecordingSettings copyWith({List<String> Function()? allowedOrigins, bool Function()? hideLiveViewerCount, StreamLiveInputRecordingMode Function()? mode, bool Function()? requireSignedUrLs, int Function()? timeoutSeconds, }) { return StreamLiveInputRecordingSettings(
