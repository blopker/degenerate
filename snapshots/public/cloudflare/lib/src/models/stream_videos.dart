...
import 'package:collection/collection.dart';import 'stream_created.dart';import 'stream_creator.dart';import 'stream_duration.dart';import 'stream_identifier.dart';import 'stream_input.dart';import 'stream_live_input2.dart';import 'stream_max_duration_seconds.dart';import 'stream_media_status.dart';import 'stream_modified.dart';import 'stream_one_time_upload_expiry.dart';import 'stream_playback.dart';import 'stream_preview.dart';import 'stream_ready_to_stream.dart';import 'stream_ready_to_stream_at.dart';import 'stream_require_signed_ur_ls.dart';import 'stream_scheduled_deletion.dart';import 'stream_size.dart';import 'stream_thumbnail_timestamp_pct.dart';import 'stream_thumbnail_url.dart';import 'stream_uploaded.dart';import 'stream_watermarks.dart';final class StreamVideos {const StreamVideos({this.allowedOrigins, this.created, this.creator, this.duration, this.input, this.liveInput, this.maxDurationSeconds, this.meta, this.modified, this.playback, this.preview, this.readyToStream, this.readyToStreamAt, this.requireSignedUrLs, this.scheduledDeletion, this.size, this.status, this.thumbnail, this.thumbnailTimestampPct, this.uid, this.uploadExpiry, this.uploaded, this.watermark, });
