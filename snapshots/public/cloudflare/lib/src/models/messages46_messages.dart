...
import 'messages46_messages_content.dart';final class Messages46Messages {const Messages46Messages({required this.content, required this.role, });

factory Messages46Messages.fromJson(Map<String, dynamic> json) { return Messages46Messages(
  content: Messages46MessagesContent.fromJson(json['content']),
