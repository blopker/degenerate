...
import 'messages_inner_messages_content.dart';final class MessagesInnerMessages {const MessagesInnerMessages({this.content, this.role, this.toolCallId, });

factory MessagesInnerMessages.fromJson(Map<String, dynamic> json) { return MessagesInnerMessages(
  content: json['content'] != null ? MessagesInnerMessagesContent.fromJson(json['content']) : null,
