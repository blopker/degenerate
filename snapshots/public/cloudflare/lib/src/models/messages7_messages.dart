...
import 'messages7_messages_content.dart';final class Messages7Messages {const Messages7Messages({required this.content, required this.role, });

factory Messages7Messages.fromJson(Map<String, dynamic> json) { return Messages7Messages(
  content: Messages7MessagesContent.fromJson(json['content']),
