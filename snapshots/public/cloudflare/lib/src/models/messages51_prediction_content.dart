...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages51_prediction_content_content.dart';final class Messages51PredictionContentType {const Messages51PredictionContentType._(this.value);
...
factory Messages51PredictionContent.fromJson(Map<String, dynamic> json) { return Messages51PredictionContent(
  content: OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => Messages51PredictionContentContentVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,),
