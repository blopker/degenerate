...
import 'aaa_mechanism_type.dart';final class AaaHistory {const AaaHistory({this.alertBody, this.alertType, this.description, this.id, this.mechanism, this.mechanismType, this.name, this.policyId, this.sent, });
...
factory AaaHistory.fromJson(Map<String, dynamic> json) { return AaaHistory(
  ...
  sent: json['sent'] != null ? DateTime.parse(json['sent'] as String) : null,
); }
...
AaaHistory copyWith({String Function()? alertBody, String Function()? alertType, String Function()? description, String Function()? id, String Function()? mechanism, AaaMechanismType Function()? mechanismType, String Function()? name, String Function()? policyId, DateTime Function()? sent, }) { return AaaHistory(
