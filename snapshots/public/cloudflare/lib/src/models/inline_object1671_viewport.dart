...
final class InlineObject1671Viewport {const InlineObject1671Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });

factory InlineObject1671Viewport.fromJson(Map<String, dynamic> json) { return InlineObject1671Viewport(
...
InlineObject1671Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return InlineObject1671Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject1671Viewport &&
...
@override String toString() { return 'InlineObject1671Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
