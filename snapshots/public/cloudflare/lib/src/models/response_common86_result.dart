...
final class ResponseCommon86Result {const ResponseCommon86Result({this.mapStringString, this.listString, this.string, });

factory ResponseCommon86Result.fromJson(Object? json) { return ResponseCommon86Result(
