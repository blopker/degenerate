...
import 'inline_object181.dart';import 'inline_object182.dart';import 'zaraz_zaraz_config_base_analytics.dart';import 'zaraz_zaraz_config_base_consent.dart';import 'zaraz_zaraz_config_base_settings.dart';/// Zaraz configuration
...
factory ZarazZarazConfigBase.fromJson(Map<String, dynamic> json) { return ZarazZarazConfigBase(
  ...
  triggers: (json['triggers'] as Map<String, dynamic>).map((k, v) => MapEntry(k, InlineObject181.fromJson(v as Map<String, dynamic>))),
  variables: (json['variables'] as Map<String, dynamic>).map((k, v) => MapEntry(k, InlineObject182.fromJson(v as Map<String, dynamic>))),
...
ZarazZarazConfigBase copyWith({ZarazZarazConfigBaseAnalytics Function()? analytics, ZarazZarazConfigBaseConsent Function()? consent, bool? dataLayer, String? debugKey, bool Function()? historyChange, ZarazZarazConfigBaseSettings? settings, Map<String,InlineObject181>? triggers, Map<String,InlineObject182>? variables, int? zarazVersion, }) { return ZarazZarazConfigBase(
