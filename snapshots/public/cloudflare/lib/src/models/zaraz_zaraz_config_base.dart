...
factory ZarazZarazConfigBase.fromJson(Map<String, dynamic> json) { return ZarazZarazConfigBase(
  ...
  variables: (json['variables'] as Map<String, dynamic>).map((k, v) => MapEntry(k, OneOf3.parse(v, fromA: (v) => ZarazStringVariable.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ZarazStringVariable.canParse(v), fromB: (v) => ZarazSecretVariable.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ZarazSecretVariable.canParse(v), fromC: (v) => ZarazWorkerVariable.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ZarazWorkerVariable.canParse(v),))),
