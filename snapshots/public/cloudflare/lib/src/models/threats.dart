...
factory Threats.fromJson(Map<String, dynamic> json) { return Threats(
  ...
  type: (json['type'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
); }
...
Threats copyWith({int Function()? all, Map<String, String> Function()? country, Map<String, String> Function()? type, }) { return Threats(
