...
import 'realtimekit_meeting_status.dart';final class RealtimekitMeeting {const RealtimekitMeeting({required this.createdAt, required this.id, this.liveStreamOnStart, this.persistChat, this.recordOnStart, this.sessionKeepAliveTimeInSecs = 60.0, this.status, this.summarizeOnEnd, this.title, required this.updatedAt, });
