...
import 'package:collection/collection.dart';final class AigConfigCreateEvaluationsRequest {const AigConfigCreateEvaluationsRequest({required this.datasetIds, required this.evaluationTypeIds, required this.name, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AigConfigCreateEvaluationsRequest &&
          const ListEquality<dynamic>().equals(datasetIds, other.datasetIds) &&
          const ListEquality<dynamic>().equals(evaluationTypeIds, other.evaluationTypeIds) &&
          name == other.name; } 
