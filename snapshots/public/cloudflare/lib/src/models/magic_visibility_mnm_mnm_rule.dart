...
import 'package:collection/collection.dart';import 'magic_visibility_mnm_mnm_rule_duration.dart';import 'magic_visibility_mnm_mnm_rule_prefix_match.dart';import 'magic_visibility_mnm_mnm_rule_type.dart';import 'magic_visibility_mnm_mnm_rule_zscore_sensitivity.dart';import 'magic_visibility_mnm_mnm_rule_zscore_target.dart';final class MagicVisibilityMnmMnmRule {const MagicVisibilityMnmMnmRule({required this.automaticAdvertisement, this.bandwidthThreshold, this.duration, this.id, required this.name, this.packetThreshold, this.prefixMatch, required this.prefixes, required this.type, this.zscoreSensitivity, this.zscoreTarget, });
...
factory MagicVisibilityMnmMnmRule.fromJson(Map<String, dynamic> json) { return MagicVisibilityMnmMnmRule(
  ...
  bandwidthThreshold: json['bandwidth_threshold'] != null ? (json['bandwidth_threshold'] as num).toDouble() : null,
...
MagicVisibilityMnmMnmRule copyWith({bool? Function()? automaticAdvertisement, double Function()? bandwidthThreshold, MagicVisibilityMnmMnmRuleDuration Function()? duration, String Function()? id, String? name, double Function()? packetThreshold, MagicVisibilityMnmMnmRulePrefixMatch? Function()? prefixMatch, List<String>? prefixes, MagicVisibilityMnmMnmRuleType? type, MagicVisibilityMnmMnmRuleZscoreSensitivity? Function()? zscoreSensitivity, MagicVisibilityMnmMnmRuleZscoreTarget? Function()? zscoreTarget, }) { return MagicVisibilityMnmMnmRule(
