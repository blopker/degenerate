...
factory MagicVisibilityPcapsPcapsResponseFull.fromJson(Map<String, dynamic> json) { return MagicVisibilityPcapsPcapsResponseFull(
  byteLimit: json['byte_limit'] != null ? (json['byte_limit'] as num).toDouble() : null,
  ...
  packetsCaptured: json['packets_captured'] != null ? (json['packets_captured'] as num).toInt() : null,
  status: json['status'] != null ? MagicVisibilityPcapsPcapsStatus.fromJson(json['status'] as String) : null,
  stopRequested: json['stop_requested'] != null ? DateTime.parse(json['stop_requested'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  ...
  if (stopRequested != null) 'stop_requested': stopRequested?.toIso8601String(),
  'submitted': ?submitted,
...
MagicVisibilityPcapsPcapsResponseFull copyWith({double Function()? byteLimit, String Function()? coloName, String Function()? destinationConf, String Function()? errorMessage, MagicVisibilityPcapsPcapsFilter Function()? filterV1, String Function()? id, int Function()? packetsCaptured, MagicVisibilityPcapsPcapsStatus Function()? status, DateTime Function()? stopRequested, String Function()? submitted, MagicVisibilityPcapsPcapsSystem Function()? system, double Function()? timeLimit, MagicVisibilityPcapsPcapsType Function()? type, }) { return MagicVisibilityPcapsPcapsResponseFull(
