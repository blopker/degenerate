...
import 'package:collection/collection.dart';final class CreatePollRequest {const CreatePollRequest({this.anonymous, this.hideVotes, required this.options, required this.question, });
