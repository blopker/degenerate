...
import 'package:collection/collection.dart';import 'inline_object178.dart';final class ZarazBaseTool {const ZarazBaseTool({required this.blockingTriggers, required this.defaultFields, this.defaultPurpose, required this.enabled, required this.name, this.vendorName, this.vendorPolicyUrl, });
...
factory ZarazBaseTool.fromJson(Map<String, dynamic> json) { return ZarazBaseTool(
  ...
  defaultFields: (json['defaultFields'] as Map<String, dynamic>).map((k, v) => MapEntry(k, InlineObject178.fromJson(v as Map<String, dynamic>))),
...
ZarazBaseTool copyWith({List<String>? blockingTriggers, Map<String,InlineObject178>? defaultFields, String Function()? defaultPurpose, bool? enabled, String? name, String Function()? vendorName, String Function()? vendorPolicyUrl, }) { return ZarazBaseTool(
