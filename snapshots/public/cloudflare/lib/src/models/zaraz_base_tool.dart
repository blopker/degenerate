...
import 'package:collection/collection.dart';import 'zaraz_base_tool_default_fields_value.dart';final class ZarazBaseTool {const ZarazBaseTool({required this.blockingTriggers, required this.defaultFields, this.defaultPurpose, required this.enabled, required this.name, this.vendorName, this.vendorPolicyUrl, });
...
factory ZarazBaseTool.fromJson(Map<String, dynamic> json) { return ZarazBaseTool(
  ...
  defaultFields: (json['defaultFields'] as Map<String, dynamic>).map((k, v) => MapEntry(k, ZarazBaseToolDefaultFieldsValue.fromJson(v as Map<String, dynamic>))),
...
final Map<String,ZarazBaseToolDefaultFieldsValue> defaultFields;
...
ZarazBaseTool copyWith({List<String>? blockingTriggers, Map<String,ZarazBaseToolDefaultFieldsValue>? defaultFields, String Function()? defaultPurpose, bool? enabled, String? name, String Function()? vendorName, String Function()? vendorPolicyUrl, }) { return ZarazBaseTool(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ZarazBaseTool &&
          const ListEquality<dynamic>().equals(blockingTriggers, other.blockingTriggers) &&
