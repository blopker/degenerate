...
import 'inline_object557_response_format.dart';final class InlineObject557 {const InlineObject557({this.frequencyPenalty, this.guidedJson, this.maxTokens = 256, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.15, this.topK, this.topP, });

factory InlineObject557.fromJson(Map<String, dynamic> json) { return InlineObject557(
  ...
  responseFormat: json['response_format'] != null ? InlineObject557ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
InlineObject557 copyWith({double Function()? frequencyPenalty, Map<String, Object> Function()? guidedJson, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject557ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject557(
