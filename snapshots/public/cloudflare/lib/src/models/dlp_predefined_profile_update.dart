...
import 'package:collection/collection.dart';import 'dlp_context_awareness.dart';import 'dlp_predefined_profile_entry_update.dart';final class DlpPredefinedProfileUpdate {const DlpPredefinedProfileUpdate({this.aiContextEnabled = false, this.allowedMatchCount = 0, this.confidenceThreshold = 'low', this.contextAwareness, this.entries, this.ocrEnabled = false, });
