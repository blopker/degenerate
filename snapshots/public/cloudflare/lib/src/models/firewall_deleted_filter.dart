...
import 'firewall_deleted.dart';import 'firewall_filters_components_schemas_id.dart';final class FirewallDeletedFilter {const FirewallDeletedFilter({required this.deleted, required this.id, });
