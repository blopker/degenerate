...
import 'package:collection/collection.dart';import 'access_schemas_saas_props_saas_app.dart';final class AccessSchemasSaasProps {const AccessSchemasSaasProps({this.allowedIdps, this.appLauncherVisible, this.autoRedirectToIdentity, this.logoUrl, this.name, this.saasApp, this.type, });
...
AccessSchemasSaasProps copyWith({List<String> Function()? allowedIdps, bool Function()? appLauncherVisible, bool Function()? autoRedirectToIdentity, String Function()? logoUrl, String Function()? name, AccessSchemasSaasPropsSaasApp Function()? saasApp, String Function()? type, }) { return AccessSchemasSaasProps(
