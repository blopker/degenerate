...
factory AccessSchemasSaasProps.fromJson(Map<String, dynamic> json) { return AccessSchemasSaasProps(
  ...
  saasApp: json['saas_app'] != null ? OneOf2.parse(json['saas_app'], fromA: (v) => AccessSchemasSamlSaasApp.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AccessSchemasSamlSaasApp.canParse(v), fromB: (v) => AccessSchemasOidcSaasApp.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AccessSchemasOidcSaasApp.canParse(v),) : null,
