...
import 'brapi_post_screenshot_request_variant1_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostScreenshotRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostScreenshotRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
