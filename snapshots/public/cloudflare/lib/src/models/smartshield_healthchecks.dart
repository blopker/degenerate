...
import 'package:collection/collection.dart';import 'smartshield_check_regions2.dart';import 'smartshield_http_config.dart';import 'smartshield_status.dart';import 'smartshield_tcp_config.dart';final class SmartshieldHealthchecks {const SmartshieldHealthchecks({this.address, this.checkRegions, this.consecutiveFails, this.consecutiveSuccesses, this.createdOn, this.description, this.failureReason, this.httpConfig, this.id, this.interval, this.modifiedOn, this.name, this.retries, this.status, this.suspended, this.tcpConfig, this.timeout, this.type, });
...
SmartshieldHealthchecks copyWith({String Function()? address, List<SmartshieldCheckRegions2>? Function()? checkRegions, int Function()? consecutiveFails, int Function()? consecutiveSuccesses, DateTime Function()? createdOn, String Function()? description, String Function()? failureReason, SmartshieldHttpConfig Function()? httpConfig, String Function()? id, int Function()? interval, DateTime Function()? modifiedOn, String Function()? name, int Function()? retries, SmartshieldStatus Function()? status, bool Function()? suspended, SmartshieldTcpConfig Function()? tcpConfig, int Function()? timeout, String Function()? type, }) { return SmartshieldHealthchecks(
