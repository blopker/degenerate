...
final class BuildsCreateBuildTokenRequest {const BuildsCreateBuildTokenRequest({required this.buildTokenName, required this.buildTokenSecret, required this.cloudflareTokenId, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('build_token_name') && json['build_token_name'] is String &&
      json.containsKey('build_token_secret') && json['build_token_secret'] is String &&
      json.containsKey('cloudflare_token_id') && json['cloudflare_token_id'] is String; } 
BuildsCreateBuildTokenRequest copyWith({String? buildTokenName, String? buildTokenSecret, String? cloudflareTokenId, }) { return BuildsCreateBuildTokenRequest(
