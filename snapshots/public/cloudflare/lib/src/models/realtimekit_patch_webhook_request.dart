...
import 'package:collection/collection.dart';import 'realtimekit_patch_webhook_request_events.dart';final class RealtimekitPatchWebhookRequest {const RealtimekitPatchWebhookRequest({this.enabled = true, this.events, this.name, this.url, });
