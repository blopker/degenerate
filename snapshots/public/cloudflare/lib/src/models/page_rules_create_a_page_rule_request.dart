...
import 'package:collection/collection.dart';import 'zones_actions2.dart';import 'zones_status.dart';import 'zones_target.dart';final class PageRulesCreateAPageRuleRequest {const PageRulesCreateAPageRuleRequest({required this.actions, this.priority, this.status, required this.targets, });
...
PageRulesCreateAPageRuleRequest copyWith({List<ZonesActions2>? actions, int Function()? priority, ZonesStatus Function()? status, List<ZonesTarget>? targets, }) { return PageRulesCreateAPageRuleRequest(
