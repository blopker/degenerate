...
import 'package:collection/collection.dart';import 'inline_object100.dart';import 'inline_object101.dart';import 'inline_object102.dart';import 'inline_object103.dart';import 'inline_object104.dart';import 'inline_object117.dart';import 'inline_object94.dart';import 'inline_object95.dart';import 'inline_object96.dart';import 'inline_object97.dart';import 'inline_object98.dart';import 'inline_object99.dart';import 'pages_deployment_config_values_limits.dart';import 'pages_deployment_config_values_placement.dart';/// The usage model for Pages Functions.
...
factory PagesDeploymentConfigValues.fromJson(Map<String, dynamic> json) { return PagesDeploymentConfigValues(
  ...
  d1Databases: (json['d1_databases'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject96.fromJson(v as Map<String, dynamic>))),
  durableObjectNamespaces: (json['durable_object_namespaces'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject97.fromJson(v as Map<String, dynamic>))),
  ...
  hyperdriveBindings: (json['hyperdrive_bindings'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject98.fromJson(v as Map<String, dynamic>))),
  kvNamespaces: (json['kv_namespaces'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject99.fromJson(v as Map<String, dynamic>))),
  limits: json['limits'] != null
        ? PagesDeploymentConfigValuesLimits.fromJson(json['limits'] as Map<String, dynamic>)
        : null,
  mtlsCertificates: (json['mtls_certificates'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject100.fromJson(v as Map<String, dynamic>))),
  placement: json['placement'] != null
        ? PagesDeploymentConfigValuesPlacement.fromJson(json['placement'] as Map<String, dynamic>)
        : null,
  queueProducers: (json['queue_producers'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject101.fromJson(v as Map<String, dynamic>))),
  r2Buckets: (json['r2_buckets'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject102.fromJson(v as Map<String, dynamic>))),
  services: (json['services'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject103.fromJson(v as Map<String, dynamic>))),
  usageModel: PagesDeploymentConfigValuesUsageModel.fromJson(json['usage_model'] as String),
  vectorizeBindings: (json['vectorize_bindings'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject104.fromJson(v as Map<String, dynamic>))),
