...
final class InlineObject614Input {const InlineObject614Input({this.string, this.listObject, });

factory InlineObject614Input.fromJson(Object? json) { return InlineObject614Input(
