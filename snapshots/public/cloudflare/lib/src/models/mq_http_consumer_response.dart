...
import 'mq_http_consumer_response_settings.dart';final class MqHttpConsumerResponse {const MqHttpConsumerResponse({this.consumerId, this.createdOn, this.deadLetterQueue, this.queueName, this.settings, this.type, });
...
MqHttpConsumerResponse copyWith({String Function()? consumerId, DateTime Function()? createdOn, String Function()? deadLetterQueue, String Function()? queueName, MqHttpConsumerResponseSettings Function()? settings, String Function()? type, }) { return MqHttpConsumerResponse(
