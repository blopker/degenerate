...
import 'package:collection/collection.dart';import 'response_message.dart';import 'teams_devices_cursor_result_info.dart';final class DeleteRegistrationsResponse {const DeleteRegistrationsResponse({required this.errors, required this.messages, required this.result, this.resultInfo, required this.success, });
...
DeleteRegistrationsResponse copyWith({List<ResponseMessage>? errors, List<ResponseMessage>? messages, Map<String, Object>? Function()? result, TeamsDevicesCursorResultInfo Function()? resultInfo, bool? success, }) { return DeleteRegistrationsResponse(
