...
import 'realtimekit_storage_config_auth_method.dart';import 'realtimekit_storage_config_type.dart';final class RealtimekitStorageConfig {const RealtimekitStorageConfig({this.accessKey, this.authMethod, this.bucket, this.host, this.password, this.path, this.port, this.privateKey, this.region, this.secret, required this.type, this.username, });
