...
import 'package:collection/collection.dart';final class UrlscannerGetScanResponseResultScanMetaProcessorsTechEvidencePatterns {const UrlscannerGetScanResponseResultScanMetaProcessorsTechEvidencePatterns({required this.confidence, required this.excludes, required this.implies, required this.match, required this.name, required this.regex, required this.type, required this.value, required this.version, });
