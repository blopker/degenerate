...
factory BrapiPostContentRequestVariant2.fromJson(Map<String, dynamic> json) { return BrapiPostContentRequestVariant2(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostContentRequestVariant2AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostContentRequestVariant2RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
