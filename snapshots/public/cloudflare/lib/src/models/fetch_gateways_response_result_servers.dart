...
import 'package:collection/collection.dart';import 'fetch_gateways_response_result_servers_updated_prompts_value.dart';import 'fetch_gateways_response_result_servers_updated_tools_value.dart';final class FetchGatewaysResponseResultServersAuthType {const FetchGatewaysResponseResultServersAuthType._(this.value);
...
factory FetchGatewaysResponseResultServers.fromJson(Map<String, dynamic> json) { return FetchGatewaysResponseResultServers(
  ...
  updatedPrompts: (json['updated_prompts'] as List<dynamic>).map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, FetchGatewaysResponseResultServersUpdatedPromptsValue.fromJson(v as Map<String, dynamic>)))).toList(),
  updatedTools: (json['updated_tools'] as List<dynamic>).map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, FetchGatewaysResponseResultServersUpdatedToolsValue.fromJson(v as Map<String, dynamic>)))).toList(),
); }
...
final List<Map<String,FetchGatewaysResponseResultServersUpdatedPromptsValue>> updatedPrompts;

final List<Map<String,FetchGatewaysResponseResultServersUpdatedToolsValue>> updatedTools;
...
Map<String, dynamic> toJson() { return {
  ...
  'updated_prompts': updatedPrompts.map((e) => e.map((k, v) => MapEntry(k, v.toJson()))).toList(),
  'updated_tools': updatedTools.map((e) => e.map((k, v) => MapEntry(k, v.toJson()))).toList(),
}; } 
