...
import 'iam_dns_verification_code.dart';import 'iam_sso_connector_verification_info_status.dart';final class IamSsoConnectorVerificationInfo {const IamSsoConnectorVerificationInfo({this.code, this.status, });
