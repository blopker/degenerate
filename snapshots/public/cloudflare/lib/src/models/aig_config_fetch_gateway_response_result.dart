...
factory AigConfigFetchGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigFetchGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? OneOf2.parse(json['dlp'], fromA: (v) => AigConfigFetchGatewayResponseResultDlpVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AigConfigFetchGatewayResponseResultDlpVariant1.canParse(v), fromB: (v) => AigConfigFetchGatewayResponseResultDlpVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AigConfigFetchGatewayResponseResultDlpVariant2.canParse(v),) : null,
