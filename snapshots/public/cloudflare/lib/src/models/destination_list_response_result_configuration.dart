...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'destination_list_response_result_configuration_job_status.dart';import 'destination_list_response_result_configuration_logpush_dataset.dart';final class DestinationListResponseResultConfigurationType {const DestinationListResponseResultConfigurationType._(this.value);
...
factory DestinationListResponseResultConfiguration.fromJson(Map<String, dynamic> json) { return DestinationListResponseResultConfiguration(
  ...
  logpushDataset: OneOf2.parse(json['logpushDataset'], fromA: (v) => DestinationListResponseResultConfigurationLogpushDatasetVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => DestinationListResponseResultConfigurationLogpushDatasetVariant2.fromJson(v as String), canParseB: (v) => v is String,),
