...
import 'destination_list_response_result_configuration_job_status.dart';import 'destination_list_response_result_configuration_logpush_dataset.dart';final class DestinationListResponseResultConfigurationType {const DestinationListResponseResultConfigurationType._(this.value);
...
factory DestinationListResponseResultConfiguration.fromJson(Map<String, dynamic> json) { return DestinationListResponseResultConfiguration(
  ...
  logpushDataset: DestinationListResponseResultConfigurationLogpushDataset.fromJson(json['logpushDataset'] as Map<String, dynamic>),
