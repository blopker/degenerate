...
final class WorkersBindingKindQueue {const WorkersBindingKindQueue({required this.name, required this.queueName, required this.type, });
...
WorkersBindingKindQueue copyWith({String? name, String? queueName, String? type, }) { return WorkersBindingKindQueue(
  name: name ?? this.name,
