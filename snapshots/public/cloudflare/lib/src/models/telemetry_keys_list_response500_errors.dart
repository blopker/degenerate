...
import 'telemetry_keys_list_response500_errors_message.dart';final class TelemetryKeysListResponse500Errors {const TelemetryKeysListResponse500Errors({this.detail, required this.message, });
