...
import 'intel_sinkholes_id.dart';import 'intel_sinkholes_name.dart';final class IntelSinkholesSinkholeItem {const IntelSinkholesSinkholeItem({this.accountTag, this.createdOn, this.id, this.modifiedOn, this.name, this.r2Bucket, this.r2Id, });
