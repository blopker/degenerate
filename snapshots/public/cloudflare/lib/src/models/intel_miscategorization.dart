...
import 'package:collection/collection.dart';import 'intel_miscategorization_indicator_type.dart';final class IntelMiscategorization {const IntelMiscategorization({this.contentAdds, this.contentRemoves, this.indicatorType, this.ip, this.securityAdds, this.securityRemoves, this.url, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IntelMiscategorization &&
          const ListEquality<dynamic>().equals(contentAdds, other.contentAdds) &&
          const ListEquality<dynamic>().equals(contentRemoves, other.contentRemoves) &&
          indicatorType == other.indicatorType &&
          ip == other.ip &&
          const ListEquality<dynamic>().equals(securityAdds, other.securityAdds) &&
          const ListEquality<dynamic>().equals(securityRemoves, other.securityRemoves) &&
          url == other.url; } 
