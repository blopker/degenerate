...
factory Pageviews.fromJson(Map<String, dynamic> json) { return Pageviews(
  ...
  searchEngine: (json['search_engine'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
); }
...
Pageviews copyWith({int Function()? all, Map<String, String> Function()? searchEngine, }) { return Pageviews(
