...
import 'package:collection/collection.dart';import 'magic_visibility_mnm_mnm_config_warp_device.dart';final class MagicVisibilityMnmMnmConfig {const MagicVisibilityMnmMnmConfig({required this.defaultSampling, required this.name, required this.routerIps, required this.warpDevices, });
...
MagicVisibilityMnmMnmConfig copyWith({double? defaultSampling, String? name, List<String>? routerIps, List<MagicVisibilityMnmMnmConfigWarpDevice>? warpDevices, }) { return MagicVisibilityMnmMnmConfig(
