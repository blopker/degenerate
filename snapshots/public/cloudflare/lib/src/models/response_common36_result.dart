...
final class ResponseCommon36Result {const ResponseCommon36Result({this.mapStringObject, this.listObject, this.string, });

factory ResponseCommon36Result.fromJson(Object? json) { return ResponseCommon36Result(
