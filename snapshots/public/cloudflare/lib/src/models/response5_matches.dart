...
import 'package:collection/collection.dart';import 'vectorize_vector_identifier.dart';final class Response5Matches {const Response5Matches({this.id, this.metadata, this.namespace, this.score, this.values, });
