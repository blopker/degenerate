...
import 'package:collection/collection.dart';final class Response5Matches {const Response5Matches({this.id, this.metadata, this.namespace, this.score, this.values, });
...
Response5Matches copyWith({String Function()? id, Map<String, String>? Function()? metadata, String? Function()? namespace, double Function()? score, List<double>? Function()? values, }) { return Response5Matches(
