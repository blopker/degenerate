...
import 'load_balancing_address.dart';import 'load_balancing_origin_changed.dart';import 'load_balancing_origin_failure_reason.dart';import 'load_balancing_origin_healthy.dart';import 'load_balancing_origin_ip.dart';import 'load_balancing_schemas_enabled.dart';import 'load_balancing_schemas_name.dart';final class LoadBalancingOriginAnalytics {const LoadBalancingOriginAnalytics({this.address, this.changed, this.enabled, this.failureReason, this.healthy, this.ip, this.name, });
