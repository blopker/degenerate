...
final class ResponseCommon84Result {const ResponseCommon84Result({this.mapStringString, this.listString, this.string, });

factory ResponseCommon84Result.fromJson(Object? json) { return ResponseCommon84Result(
