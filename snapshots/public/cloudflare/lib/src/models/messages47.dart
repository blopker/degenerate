...
factory Messages47.fromJson(Map<String, dynamic> json) { return Messages47(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages47ToolsVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Messages47ToolsVariant1.canParse(v), fromB: (v) => Messages47ToolsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages47ToolsVariant2.canParse(v),)).toList(),
