...
factory Messages47.fromJson(Map<String, dynamic> json) { return Messages47(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages47Tools.fromJson(e)).toList(),
