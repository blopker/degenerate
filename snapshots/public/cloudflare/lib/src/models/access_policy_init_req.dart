...
import 'package:collection/collection.dart';import 'access_policy_init_req_policies.dart';final class AccessPolicyInitReq {const AccessPolicyInitReq({this.policies});

factory AccessPolicyInitReq.fromJson(Map<String, dynamic> json) { return AccessPolicyInitReq(
  policies: (json['policies'] as List<dynamic>?)?.map((e) => AccessPolicyInitReqPolicies.fromJson(e)).toList(),
); }
