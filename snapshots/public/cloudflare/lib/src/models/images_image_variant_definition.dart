...
import 'images_image_variant_options.dart';final class ImagesImageVariantDefinition {const ImagesImageVariantDefinition({required this.id, this.neverRequireSignedUrLs, required this.options, });
...
ImagesImageVariantDefinition copyWith({String? id, bool Function()? neverRequireSignedUrLs, ImagesImageVariantOptions? options, }) { return ImagesImageVariantDefinition(
  id: id ?? this.id,
