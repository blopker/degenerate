...
import 'telemetry_query_response401_errors_message.dart';final class TelemetryQueryResponse401Errors {const TelemetryQueryResponse401Errors({this.detail, required this.message, });
