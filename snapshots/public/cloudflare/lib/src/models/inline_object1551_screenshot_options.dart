...
import 'inline_object1551_screenshot_options_clip.dart';import 'inline_object1551_screenshot_options_encoding.dart';import 'inline_object1551_screenshot_options_type.dart';/// Check [options](https://pptr.dev/api/puppeteer.screenshotoptions).
final class InlineObject1551ScreenshotOptions {const InlineObject1551ScreenshotOptions({this.captureBeyondViewport, this.clip, this.encoding, this.fromSurface, this.fullPage, this.omitBackground, this.optimizeForSpeed, this.quality, this.type, });
...
InlineObject1551ScreenshotOptions copyWith({bool Function()? captureBeyondViewport, InlineObject1551ScreenshotOptionsClip Function()? clip, InlineObject1551ScreenshotOptionsEncoding Function()? encoding, bool Function()? fromSurface, bool Function()? fullPage, bool Function()? omitBackground, bool Function()? optimizeForSpeed, double Function()? quality, InlineObject1551ScreenshotOptionsType Function()? type, }) { return InlineObject1551ScreenshotOptions(
...
@override String toString() { return 'InlineObject1551ScreenshotOptions(captureBeyondViewport: $captureBeyondViewport, clip: $clip, encoding: $encoding, fromSurface: $fromSurface, fullPage: $fullPage, omitBackground: $omitBackground, optimizeForSpeed: $optimizeForSpeed, quality: $quality, type: $type)'; } 
 }
