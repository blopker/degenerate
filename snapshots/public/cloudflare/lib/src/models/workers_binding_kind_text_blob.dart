...
final class WorkersBindingKindTextBlob {const WorkersBindingKindTextBlob({required this.name, required this.$part, required this.type, });
...
WorkersBindingKindTextBlob copyWith({String? name, String? $part, String? type, }) { return WorkersBindingKindTextBlob(
  name: name ?? this.name,
  $part: $part ?? this.$part,
  type: type ?? this.type,
); } 
