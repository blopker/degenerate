...
import 'brapi_post_json_request_variant1_response_format_json_schema_value.dart';final class BrapiPostJsonRequestVariant1ResponseFormat {const BrapiPostJsonRequestVariant1ResponseFormat({this.jsonSchema, required this.type, });
...
factory BrapiPostJsonRequestVariant1ResponseFormat.fromJson(Map<String, dynamic> json) { return BrapiPostJsonRequestVariant1ResponseFormat(
  jsonSchema: (json['json_schema'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, BrapiPostJsonRequestVariant1ResponseFormatJsonSchemaValue.fromJson(v as Map<String, dynamic>))),
