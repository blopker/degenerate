...
import 'package:collection/collection.dart';import 'argo_analytics_messages2.dart';import 'response_common7_result.dart';final class ResponseCommon7 {const ResponseCommon7({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon7.fromJson(Map<String, dynamic> json) { return ResponseCommon7(
  ...
  result: ResponseCommon7Result.fromJson(json['result'] as Map<String, dynamic>),
