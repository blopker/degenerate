...
import 'package:collection/collection.dart';import 'workers_deployment_annotations.dart';import 'workers_deployment_strategy.dart';import 'workers_deployment_versions.dart';final class WorkersDeployment {const WorkersDeployment({this.annotations, this.authorEmail, required this.createdOn, required this.id, required this.source, required this.strategy, required this.versions, });
