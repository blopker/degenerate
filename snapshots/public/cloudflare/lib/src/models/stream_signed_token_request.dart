...
import 'package:collection/collection.dart';import 'stream_access_rules.dart';final class StreamSignedTokenRequest {const StreamSignedTokenRequest({this.accessRules, this.downloadable = false, this.exp, this.id, this.nbf, this.pem, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is StreamSignedTokenRequest &&
          const ListEquality<dynamic>().equals(accessRules, other.accessRules) &&
