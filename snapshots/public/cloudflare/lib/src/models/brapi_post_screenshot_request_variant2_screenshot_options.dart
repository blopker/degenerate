...
import 'brapi_post_screenshot_request_variant2_screenshot_options_clip.dart';import 'brapi_post_screenshot_request_variant2_screenshot_options_encoding.dart';import 'brapi_post_screenshot_request_variant2_screenshot_options_type.dart';/// Check [options](https://pptr.dev/api/puppeteer.screenshotoptions).
...
factory BrapiPostScreenshotRequestVariant2ScreenshotOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant2ScreenshotOptions(
  ...
  encoding: json['encoding'] != null ? BrapiPostScreenshotRequestVariant2ScreenshotOptionsEncoding.fromJson(json['encoding'] as Map<String, dynamic>) : null,
  ...
  type: json['type'] != null ? BrapiPostScreenshotRequestVariant2ScreenshotOptionsType.fromJson(json['type'] as Map<String, dynamic>) : null,
); }
