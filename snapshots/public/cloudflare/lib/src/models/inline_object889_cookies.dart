...
import 'inline_object889_cookies_priority.dart';import 'inline_object889_cookies_same_site.dart';import 'inline_object889_cookies_source_scheme.dart';final class InlineObject889Cookies {const InlineObject889Cookies({this.domain, this.expires, this.httpOnly, required this.name, this.partitionKey, this.path, this.priority, this.sameParty, this.sameSite, this.secure, this.sourcePort, this.sourceScheme, this.url, required this.value, });

factory InlineObject889Cookies.fromJson(Map<String, dynamic> json) { return InlineObject889Cookies(
...
InlineObject889Cookies copyWith({String Function()? domain, double Function()? expires, bool Function()? httpOnly, String? name, String Function()? partitionKey, String Function()? path, InlineObject889CookiesPriority Function()? priority, bool Function()? sameParty, InlineObject889CookiesSameSite Function()? sameSite, bool Function()? secure, double Function()? sourcePort, InlineObject889CookiesSourceScheme Function()? sourceScheme, String Function()? url, String? value, }) { return InlineObject889Cookies(
...
@override String toString() { return 'InlineObject889Cookies(domain: $domain, expires: $expires, httpOnly: $httpOnly, name: $name, partitionKey: $partitionKey, path: $path, priority: $priority, sameParty: $sameParty, sameSite: $sameSite, secure: $secure, sourcePort: $sourcePort, sourceScheme: $sourceScheme, url: $url, value: $value)'; } 
 }
