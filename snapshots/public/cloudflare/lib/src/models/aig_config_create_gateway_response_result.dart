...
factory AigConfigCreateGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigCreateGatewayResponseResult(
  ...
  dlp: json['dlp'] != null
        ? AigConfigCreateGatewayResponseResultDlp.fromJson(json['dlp'] as Map<String, dynamic>)
        : null,
  ...
  stripe: json['stripe'] != null
        ? AigConfigCreateGatewayResponseResultStripe.fromJson(json['stripe'] as Map<String, dynamic>)
        : null,
