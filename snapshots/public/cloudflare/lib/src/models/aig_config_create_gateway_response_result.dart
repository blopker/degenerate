...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_create_gateway_response_result_dlp.dart';import 'aig_config_create_gateway_response_result_otel.dart';import 'aig_config_create_gateway_response_result_stripe.dart';final class AigConfigCreateGatewayResponseResultLogManagementStrategy {const AigConfigCreateGatewayResponseResultLogManagementStrategy._(this.value);
...
factory AigConfigCreateGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigCreateGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? OneOf2.parse(json['dlp'], fromA: (v) => AigConfigCreateGatewayResponseResultDlpVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AigConfigCreateGatewayResponseResultDlpVariant1.canParse(v), fromB: (v) => AigConfigCreateGatewayResponseResultDlpVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AigConfigCreateGatewayResponseResultDlpVariant2.canParse(v),) : null,
