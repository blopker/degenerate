...
import 'package:collection/collection.dart';import 'post_event_create_bulk_request_data_indicators.dart';import 'post_event_create_bulk_request_data_raw.dart';final class PostEventCreateBulkRequestData {const PostEventCreateBulkRequestData({this.accountId, this.attacker, this.attackerCountry, required this.category, this.datasetId, required this.date, required this.event, this.indicator, this.indicatorType, this.indicators, this.insight, required this.raw, this.tags, this.targetCountry, this.targetIndustry, required this.tlp, });
