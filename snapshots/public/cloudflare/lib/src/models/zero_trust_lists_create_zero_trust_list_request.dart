...
import 'package:collection/collection.dart';import 'zero_trust_gateway_items_input2.dart';import 'zero_trust_gateway_schemas_type.dart';final class ZeroTrustListsCreateZeroTrustListRequest {const ZeroTrustListsCreateZeroTrustListRequest({this.description, this.items, required this.name, required this.type, });
...
ZeroTrustListsCreateZeroTrustListRequest copyWith({String Function()? description, List<ZeroTrustGatewayItemsInput2> Function()? items, String? name, ZeroTrustGatewaySchemasType? type, }) { return ZeroTrustListsCreateZeroTrustListRequest(
