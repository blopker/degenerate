...
import 'package:collection/collection.dart';import 'custom_indicator_feeds_messages2.dart';final class ResponseCommonFailure21 {const ResponseCommonFailure21({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure21 copyWith({List<CustomIndicatorFeedsMessages2>? errors, List<CustomIndicatorFeedsMessages2>? messages, Map<String, Object>? Function()? result, bool? success, }) { return ResponseCommonFailure21(
