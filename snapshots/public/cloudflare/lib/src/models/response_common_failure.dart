...
import 'package:collection/collection.dart';import 'aaa_messages2.dart';final class ResponseCommonFailure {const ResponseCommonFailure({required this.errors, required this.messages, required this.success, });
