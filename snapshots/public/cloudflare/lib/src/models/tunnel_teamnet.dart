...
import 'tunnel_tunnel_type.dart';final class TunnelTeamnet {const TunnelTeamnet({this.comment, this.createdAt, this.deletedAt, this.id, this.network, this.tunType, this.tunnelId, this.tunnelName, this.virtualNetworkId, this.virtualNetworkName, });
...
TunnelTeamnet copyWith({String Function()? comment, DateTime Function()? createdAt, DateTime Function()? deletedAt, String Function()? id, String Function()? network, TunnelTunnelType Function()? tunType, String Function()? tunnelId, String Function()? tunnelName, String Function()? virtualNetworkId, String Function()? virtualNetworkName, }) { return TunnelTeamnet(
