...
final class CustomIndicatorFeedsIndicatorFeedItem {const CustomIndicatorFeedsIndicatorFeedItem({this.createdOn, this.description, this.id, this.isAttributable, this.isDownloadable, this.isPublic, this.modifiedOn, this.name, });
...
CustomIndicatorFeedsIndicatorFeedItem copyWith({DateTime Function()? createdOn, String Function()? description, int Function()? id, bool Function()? isAttributable, bool Function()? isDownloadable, bool Function()? isPublic, DateTime Function()? modifiedOn, String Function()? name, }) { return CustomIndicatorFeedsIndicatorFeedItem(
