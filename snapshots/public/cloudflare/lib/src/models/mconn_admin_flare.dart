...
final class MconnAdminFlare {const MconnAdminFlare({required this.id, required this.triggeredAt, });
...
MconnAdminFlare copyWith({String? id, String? triggeredAt, }) { return MconnAdminFlare(
  id: id ?? this.id,
