...
factory ResponseCommon39.fromJson(Map<String, dynamic> json) { return ResponseCommon39(
  ...
  result: OneOf3.parse(json['result'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as Object)), fromB: (v) => (v as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => v as String, fromB: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as Object)),)).toList(), fromC: (v) => v as String,),
