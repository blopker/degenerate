...
import 'package:collection/collection.dart';import 'update_portals_request_servers_updated_prompts.dart';import 'update_portals_request_servers_updated_tools.dart';final class UpdatePortalsRequestServers {const UpdatePortalsRequestServers({this.defaultDisabled = false, this.onBehalf = true, required this.serverId, this.updatedPrompts, this.updatedTools, });
