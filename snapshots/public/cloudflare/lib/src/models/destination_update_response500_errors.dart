...
import 'destination_update_response500_errors_message.dart';final class DestinationUpdateResponse500Errors {const DestinationUpdateResponse500Errors({this.detail, required this.message, });
