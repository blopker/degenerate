...
import 'package:collection/collection.dart';import 'access_decision.dart';import 'access_rule.dart';final class AccessBasePolicyReq {const AccessBasePolicyReq({required this.decision, this.exclude, required this.include, required this.name, this.require, });
...
AccessBasePolicyReq copyWith({AccessDecision? decision, List<AccessRule> Function()? exclude, List<AccessRule>? include, String? name, List<AccessRule> Function()? require, }) { return AccessBasePolicyReq(
