...
factory BrapiPostMarkdownRequestVariant2.fromJson(Map<String, dynamic> json) { return BrapiPostMarkdownRequestVariant2(
  ...
  allowResourceTypes: (json['allowResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostMarkdownRequestVariant2AllowResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  rejectResourceTypes: (json['rejectResourceTypes'] as List<dynamic>?)?.map((e) => BrapiPostMarkdownRequestVariant2RejectResourceTypes.fromJson(e as Map<String, dynamic>)).toList(),
