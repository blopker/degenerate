...
import 'access_schemas_oidc_saas_app_custom_claims_scope.dart';import 'access_schemas_oidc_saas_app_custom_claims_source.dart';final class AccessSchemasOidcSaasAppCustomClaims {const AccessSchemasOidcSaasAppCustomClaims({this.name, this.$required, this.scope, this.source, });
