...
import 'package:collection/collection.dart';import 'intel_domain_history_categorizations_categories.dart';final class IntelDomainHistoryCategorizations {const IntelDomainHistoryCategorizations({this.categories, this.end, this.start, });
