...
import 'can_subscribe.dart';import 'currency.dart';import 'externally_managed.dart';import 'identifier.dart';import 'is_subscribed.dart';import 'legacy_discount.dart';import 'legacy_id.dart';import 'schemas_frequency.dart';import 'schemas_name.dart';import 'schemas_price.dart';final class AvailableRatePlan {const AvailableRatePlan({this.canSubscribe, this.currency, this.externallyManaged, this.frequency, this.id, this.isSubscribed, this.legacyDiscount, this.legacyId, this.name, this.price, });
