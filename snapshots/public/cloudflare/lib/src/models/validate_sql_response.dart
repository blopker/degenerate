...
import 'validate_sql_response_result.dart';final class ValidateSqlResponse {const ValidateSqlResponse({required this.result, required this.success, });
...
ValidateSqlResponse copyWith({ValidateSqlResponseResult? result, bool? success, }) { return ValidateSqlResponse(
