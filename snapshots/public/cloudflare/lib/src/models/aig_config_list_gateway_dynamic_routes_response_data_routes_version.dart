...
import 'aig_config_list_gateway_dynamic_routes_response_data_routes_version_active.dart';final class AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion {const AigConfigListGatewayDynamicRoutesResponseDataRoutesVersion({required this.active, this.comment, required this.createdAt, required this.data, required this.versionId, });
