...
import 'autorag_config_search_request_reranking_model.dart';final class AutoragConfigSearchRequestReranking {const AutoragConfigSearchRequestReranking({this.enabled = false, this.model, });
