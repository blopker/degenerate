...
final class MqQueuePullBatch2 {const MqQueuePullBatch2({this.attempts, this.body, this.id, this.leaseId, this.metadata, this.timestampMs, });
...
MqQueuePullBatch2 copyWith({double Function()? attempts, String Function()? body, String Function()? id, String Function()? leaseId, Map<String, String> Function()? metadata, double Function()? timestampMs, }) { return MqQueuePullBatch2(
