...
import 'package:collection/collection.dart';import 'zones_actions2.dart';import 'zones_status.dart';import 'zones_target.dart';final class ZonesPageRule {const ZonesPageRule({required this.actions, required this.createdOn, required this.id, required this.modifiedOn, required this.priority, required this.status, required this.targets, });
...
ZonesPageRule copyWith({List<ZonesActions2>? actions, DateTime? createdOn, String? id, DateTime? modifiedOn, int? priority, ZonesStatus? status, List<ZonesTarget>? targets, }) { return ZonesPageRule(
