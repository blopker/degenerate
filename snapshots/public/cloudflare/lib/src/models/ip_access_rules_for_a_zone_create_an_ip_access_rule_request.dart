...
import 'firewall_configuration.dart';import 'firewall_schemas_mode.dart';final class IpAccessRulesForAZoneCreateAnIpAccessRuleRequest {const IpAccessRulesForAZoneCreateAnIpAccessRuleRequest({required this.configuration, required this.mode, this.notes, });
...
IpAccessRulesForAZoneCreateAnIpAccessRuleRequest copyWith({FirewallConfiguration? configuration, FirewallSchemasMode? mode, String Function()? notes, }) { return IpAccessRulesForAZoneCreateAnIpAccessRuleRequest(
