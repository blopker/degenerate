...
import 'telemetry_query_request_parameters_needle_value.dart';/// Define an expression to search using full-text search.
...
factory TelemetryQueryRequestParametersNeedle.fromJson(Map<String, dynamic> json) { return TelemetryQueryRequestParametersNeedle(
  ...
  value: TelemetryQueryRequestParametersNeedleValue.fromJson(json['value'] as Map<String, dynamic>),
); }
...
TelemetryQueryRequestParametersNeedle copyWith({bool Function()? isRegex, bool Function()? matchCase, TelemetryQueryRequestParametersNeedleValue? value, }) { return TelemetryQueryRequestParametersNeedle(
