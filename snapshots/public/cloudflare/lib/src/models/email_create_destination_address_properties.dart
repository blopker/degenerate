...
final class EmailCreateDestinationAddressProperties {const EmailCreateDestinationAddressProperties({required this.email});
...
EmailCreateDestinationAddressProperties copyWith({String? email}) { return EmailCreateDestinationAddressProperties(
