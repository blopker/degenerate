...
import 'package:collection/collection.dart';import 'zero_trust_gateway_ip_network.dart';final class ZeroTrustGatewayDohEndpoint {const ZeroTrustGatewayDohEndpoint({this.enabled, this.networks, this.requireToken, });
