...
import 'package:collection/collection.dart';import 'mcn_catalog_sync_destination_type.dart';final class McnCatalogSyncsPrebuiltPolicy {const McnCatalogSyncsPrebuiltPolicy({required this.applicableDestinations, required this.policyDescription, required this.policyName, required this.policyString, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is McnCatalogSyncsPrebuiltPolicy &&
          const ListEquality<dynamic>().equals(applicableDestinations, other.applicableDestinations) &&
