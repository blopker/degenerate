...
import 'messages17_messages_content.dart';final class Messages17Messages {const Messages17Messages({required this.content, required this.role, });

factory Messages17Messages.fromJson(Map<String, dynamic> json) { return Messages17Messages(
  content: Messages17MessagesContent.fromJson(json['content']),
