...
import 'package:collection/collection.dart';import 'resource_sharing_v4error.dart';import 'response_common55_result.dart';final class ResponseCommon55 {const ResponseCommon55({required this.errors, this.result, required this.success, });
...
factory ResponseCommon55.fromJson(Map<String, dynamic> json) { return ResponseCommon55(
  ...
  result: json['result'] != null ? ResponseCommon55Result.fromJson(json['result'] as Map<String, dynamic>) : null,
