...
factory Messages49.fromJson(Map<String, dynamic> json) { return Messages49(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages49Tools.fromJson(e)).toList(),
