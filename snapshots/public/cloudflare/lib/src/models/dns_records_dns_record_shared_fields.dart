...
import 'package:collection/collection.dart';import 'dns_records_settings.dart';import 'dns_records_ttl.dart';final class DnsRecordsDnsRecordSharedFields {const DnsRecordsDnsRecordSharedFields({this.comment, this.name, this.proxied, this.settings, this.tags, this.ttl, });
...
DnsRecordsDnsRecordSharedFields copyWith({String Function()? comment, String Function()? name, bool Function()? proxied, DnsRecordsSettings Function()? settings, List<String> Function()? tags, DnsRecordsTtl Function()? ttl, }) { return DnsRecordsDnsRecordSharedFields(
