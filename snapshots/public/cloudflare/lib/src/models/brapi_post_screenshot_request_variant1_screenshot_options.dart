...
import 'brapi_post_screenshot_request_variant1_screenshot_options_clip.dart';import 'brapi_post_screenshot_request_variant1_screenshot_options_encoding.dart';import 'brapi_post_screenshot_request_variant1_screenshot_options_type.dart';/// Check [options](https://pptr.dev/api/puppeteer.screenshotoptions).
...
factory BrapiPostScreenshotRequestVariant1ScreenshotOptions.fromJson(Map<String, dynamic> json) { return BrapiPostScreenshotRequestVariant1ScreenshotOptions(
  ...
  encoding: json['encoding'] != null ? BrapiPostScreenshotRequestVariant1ScreenshotOptionsEncoding.fromJson(json['encoding'] as Map<String, dynamic>) : null,
  ...
  type: json['type'] != null ? BrapiPostScreenshotRequestVariant1ScreenshotOptionsType.fromJson(json['type'] as Map<String, dynamic>) : null,
); }
