...
import 'package:collection/collection.dart';final class RadarGetBgpIpsTimeseriesResponseResultSerie0 {const RadarGetBgpIpsTimeseriesResponseResultSerie0({required this.ipv4, required this.ipv6, required this.timestamps, });
