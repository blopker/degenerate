...
factory BrapiPostPdfRequestVariant2Cookies.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant2Cookies(
  ...
  priority: json['priority'] != null ? BrapiPostPdfRequestVariant2CookiesPriority.fromJson(json['priority'] as Map<String, dynamic>) : null,
  sameParty: json['sameParty'] as bool?,
  sameSite: json['sameSite'] != null ? BrapiPostPdfRequestVariant2CookiesSameSite.fromJson(json['sameSite'] as Map<String, dynamic>) : null,
  secure: json['secure'] as bool?,
  sourcePort: json['sourcePort'] != null ? (json['sourcePort'] as num).toDouble() : null,
  sourceScheme: json['sourceScheme'] != null ? BrapiPostPdfRequestVariant2CookiesSourceScheme.fromJson(json['sourceScheme'] as Map<String, dynamic>) : null,
