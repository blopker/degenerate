...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'brapi_post_pdf_request_variant2_cookies_priority.dart';import 'brapi_post_pdf_request_variant2_cookies_same_site.dart';import 'brapi_post_pdf_request_variant2_cookies_source_scheme.dart';final class BrapiPostPdfRequestVariant2Cookies {const BrapiPostPdfRequestVariant2Cookies({this.domain, this.expires, this.httpOnly, required this.name, this.partitionKey, this.path, this.priority, this.sameParty, this.sameSite, this.secure, this.sourcePort, this.sourceScheme, this.url, required this.value, });
...
factory BrapiPostPdfRequestVariant2Cookies.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant2Cookies(
  ...
  priority: json['priority'] != null ? OneOf3.parse(json['priority'], fromA: (v) => BrapiPostPdfRequestVariant2CookiesPriorityVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostPdfRequestVariant2CookiesPriorityVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostPdfRequestVariant2CookiesPriorityVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
  sameParty: json['sameParty'] as bool?,
  sameSite: json['sameSite'] != null ? OneOf3.parse(json['sameSite'], fromA: (v) => BrapiPostPdfRequestVariant2CookiesSameSiteVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostPdfRequestVariant2CookiesSameSiteVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostPdfRequestVariant2CookiesSameSiteVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
  secure: json['secure'] as bool?,
  sourcePort: json['sourcePort'] != null ? (json['sourcePort'] as num).toDouble() : null,
  sourceScheme: json['sourceScheme'] != null ? OneOf3.parse(json['sourceScheme'], fromA: (v) => BrapiPostPdfRequestVariant2CookiesSourceSchemeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostPdfRequestVariant2CookiesSourceSchemeVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostPdfRequestVariant2CookiesSourceSchemeVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
