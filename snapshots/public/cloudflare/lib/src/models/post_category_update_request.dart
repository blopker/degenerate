...
import 'package:collection/collection.dart';final class PostCategoryUpdateRequest {const PostCategoryUpdateRequest({this.killChain, this.mitreAttack, this.name, this.shortname, });
