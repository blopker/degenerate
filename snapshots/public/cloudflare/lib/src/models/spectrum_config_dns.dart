...
import 'spectrum_config_dns_type.dart';/// The name and type of DNS record for the Spectrum application.
...
SpectrumConfigDns copyWith({String Function()? name, SpectrumConfigDnsType Function()? type, }) { return SpectrumConfigDns(
