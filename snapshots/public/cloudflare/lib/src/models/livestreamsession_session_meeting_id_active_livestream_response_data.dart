...
import 'livestreamsession_session_meeting_id_active_livestream_response_data_err_message.dart';import 'livestreamsession_session_meeting_id_active_livestream_response_data_paging.dart';final class LivestreamsessionSessionMeetingIdActiveLivestreamResponseData {const LivestreamsessionSessionMeetingIdActiveLivestreamResponseData({this.createdAt, this.errMessage, this.id, this.ingestSeconds, this.invokedTime, this.livestreamId, this.paging, this.stoppedTime, this.updatedAt, this.viewerSeconds, });
