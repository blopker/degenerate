...
final class IpAddressManagementPrefixesAddPrefixRequest {const IpAddressManagementPrefixesAddPrefixRequest({required this.asn, required this.cidr, this.delegateLoaCreation, this.description, this.loaDocumentId, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('asn') && json['asn'] is num &&
      json.containsKey('cidr') && json['cidr'] is String; } 
IpAddressManagementPrefixesAddPrefixRequest copyWith({int? asn, String? cidr, bool Function()? delegateLoaCreation, String Function()? description, String? Function()? loaDocumentId, }) { return IpAddressManagementPrefixesAddPrefixRequest(
  asn: asn ?? this.asn,
  cidr: cidr ?? this.cidr,
