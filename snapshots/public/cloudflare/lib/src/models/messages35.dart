...
factory Messages35.fromJson(Map<String, dynamic> json) { return Messages35(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages35Tools.fromJson(e)).toList(),
