...
import 'package:collection/collection.dart';import 'zero_trust_gateway_action.dart';import 'zero_trust_gateway_components_schemas_name.dart';import 'zero_trust_gateway_deleted_at.dart';import 'zero_trust_gateway_device_posture.dart';import 'zero_trust_gateway_enabled.dart';import 'zero_trust_gateway_expiration.dart';import 'zero_trust_gateway_filters2.dart';import 'zero_trust_gateway_identity.dart';import 'zero_trust_gateway_precedence.dart';import 'zero_trust_gateway_read_only.dart';import 'zero_trust_gateway_read_only_timestamp.dart';import 'zero_trust_gateway_rule_settings.dart';import 'zero_trust_gateway_schedule.dart';import 'zero_trust_gateway_schemas_description.dart';import 'zero_trust_gateway_schemas_uuid.dart';import 'zero_trust_gateway_sharable.dart';import 'zero_trust_gateway_source_account.dart';import 'zero_trust_gateway_traffic.dart';import 'zero_trust_gateway_version.dart';import 'zero_trust_gateway_warning_status.dart';final class ZeroTrustGatewayRules {const ZeroTrustGatewayRules({required this.action, this.createdAt, this.deletedAt, this.description, this.devicePosture, required this.enabled, this.expiration, required this.filters, this.id, this.identity, required this.name, required this.precedence, this.readOnly, this.ruleSettings, this.schedule, this.sharable, this.sourceAccount, required this.traffic, this.updatedAt, this.version, this.warningStatus, });
