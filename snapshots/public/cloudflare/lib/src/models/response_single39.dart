...
import 'package:collection/collection.dart';import 'response_errors3.dart';import 'response_messages2.dart';final class ResponseSingle39 {const ResponseSingle39({required this.errors, required this.messages, required this.success, });
...
ResponseSingle39 copyWith({List<ResponseErrors3>? errors, List<ResponseMessages2>? messages, bool? success, }) { return ResponseSingle39(
