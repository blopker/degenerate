...
import 'firewall_waf_rewrite_action.dart';/// Specifies that, when a WAF rule matches, its configured action will be replaced by the action configured in this object.
