...
import 'package:collection/collection.dart';import 'urlscanner_create_scan_bulk_response429_errors.dart';final class UrlscannerCreateScanBulkResponse429 {const UrlscannerCreateScanBulkResponse429({this.description, required this.errors, required this.message, required this.status, });
