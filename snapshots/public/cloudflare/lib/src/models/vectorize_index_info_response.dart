...
final class VectorizeIndexInfoResponse {const VectorizeIndexInfoResponse({this.dimensions, this.processedUpToDatetime, this.processedUpToMutation, this.vectorCount, });
...
VectorizeIndexInfoResponse copyWith({int Function()? dimensions, DateTime? Function()? processedUpToDatetime, String Function()? processedUpToMutation, int Function()? vectorCount, }) { return VectorizeIndexInfoResponse(
