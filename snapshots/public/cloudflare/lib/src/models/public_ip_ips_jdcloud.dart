...
import 'package:collection/collection.dart';import 'public_ip_etag.dart';final class PublicIpIpsJdcloud {const PublicIpIpsJdcloud({this.etag, this.ipv4Cidrs, this.ipv6Cidrs, this.jdcloudCidrs, });
