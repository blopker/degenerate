...
factory AiSearchListInstancesResponseResult.fromJson(Map<String, dynamic> json) { return AiSearchListInstancesResponseResult(
  ...
  aiSearchModel: json['ai_search_model'] != null ? AiSearchListInstancesResponseResultAiSearchModel.fromJson(json['ai_search_model'] as Map<String, dynamic>) : null,
  ...
  embeddingModel: json['embedding_model'] != null ? AiSearchListInstancesResponseResultEmbeddingModel.fromJson(json['embedding_model'] as Map<String, dynamic>) : null,
  ...
  rerankingModel: json['reranking_model'] != null ? AiSearchListInstancesResponseResultRerankingModel.fromJson(json['reranking_model'] as Map<String, dynamic>) : null,
  ...
  rewriteModel: json['rewrite_model'] != null ? AiSearchListInstancesResponseResultRewriteModel.fromJson(json['rewrite_model'] as Map<String, dynamic>) : null,
