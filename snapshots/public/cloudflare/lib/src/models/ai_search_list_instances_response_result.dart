...
import 'package:collection/collection.dart';import 'ai_search_list_instances_response_result_ai_search_model.dart';import 'ai_search_list_instances_response_result_cache_threshold.dart';import 'ai_search_list_instances_response_result_custom_metadata.dart';import 'ai_search_list_instances_response_result_embedding_model.dart';import 'ai_search_list_instances_response_result_fusion_method.dart';import 'ai_search_list_instances_response_result_metadata.dart';import 'ai_search_list_instances_response_result_public_endpoint_params.dart';import 'ai_search_list_instances_response_result_reranking_model.dart';import 'ai_search_list_instances_response_result_retrieval_options.dart';import 'ai_search_list_instances_response_result_rewrite_model.dart';import 'ai_search_list_instances_response_result_source_params.dart';import 'ai_search_list_instances_response_result_type.dart';final class AiSearchListInstancesResponseResult {const AiSearchListInstancesResponseResult({this.aiGatewayId, this.aiSearchModel, this.cache = true, this.cacheThreshold = AiSearchListInstancesResponseResultCacheThreshold.closeEnough, this.chunkOverlap = 10, this.chunkSize = 256, required this.createdAt, this.createdBy, this.customMetadata, this.embeddingModel, this.enable = true, this.fusionMethod = AiSearchListInstancesResponseResultFusionMethod.rrf, this.hybridSearchEnabled = false, required this.id, this.lastActivity, this.maxNumResults = 10, this.metadata, required this.modifiedAt, this.modifiedBy, this.paused = false, this.publicEndpointId, this.publicEndpointParams, this.reranking = false, this.rerankingModel, this.retrievalOptions, this.rewriteModel, this.rewriteQuery = false, this.scoreThreshold = 0.4, this.source, this.sourceParams, this.status = 'waiting', this.tokenId, this.type, required this.vectorizeName, });
