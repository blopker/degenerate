...
import 'wor_change_status_workflow_instance_request_status.dart';final class WorChangeStatusWorkflowInstanceRequest {const WorChangeStatusWorkflowInstanceRequest({required this.status});
