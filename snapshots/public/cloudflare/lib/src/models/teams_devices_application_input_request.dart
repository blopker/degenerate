...
import 'teams_devices_application_input_request_operating_system.dart';final class TeamsDevicesApplicationInputRequest {const TeamsDevicesApplicationInputRequest({required this.operatingSystem, required this.path, this.sha256, this.thumbprint, });
