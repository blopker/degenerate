...
final class Web3ModifyRequest {const Web3ModifyRequest({this.description, this.dnslink, });
...
Web3ModifyRequest copyWith({String Function()? description, String Function()? dnslink, }) { return Web3ModifyRequest(
