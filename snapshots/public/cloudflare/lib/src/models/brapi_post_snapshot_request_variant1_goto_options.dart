...
import 'brapi_post_snapshot_request_variant1_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostSnapshotRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostSnapshotRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostSnapshotRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
