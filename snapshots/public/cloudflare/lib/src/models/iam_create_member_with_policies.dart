...
import 'package:collection/collection.dart';import 'iam_create_member_policy.dart';import 'iam_email.dart';import 'iam_member_invitation_status.dart';final class IamCreateMemberWithPolicies {const IamCreateMemberWithPolicies({required this.email, required this.policies, this.status, });
