...
import 'package:collection/collection.dart';import 'iam_create_member_policy.dart';import 'iam_member_invitation_status.dart';final class IamCreateMemberWithPolicies {const IamCreateMemberWithPolicies({required this.email, required this.policies, this.status, });
...
IamCreateMemberWithPolicies copyWith({String? email, List<IamCreateMemberPolicy>? policies, IamMemberInvitationStatus Function()? status, }) { return IamCreateMemberWithPolicies(
