...
import 'package:collection/collection.dart';import 'email_security_post_bulk_message_move_request_destination.dart';import 'email_security_postfix_id.dart';final class EmailSecurityPostBulkMessageMoveRequest {const EmailSecurityPostBulkMessageMoveRequest({required this.destination, this.ids, this.postfixIds, });
