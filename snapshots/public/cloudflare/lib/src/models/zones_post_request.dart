...
import 'zones_name.dart';import 'zones_post_request_account.dart';import 'zones_type.dart';final class ZonesPostRequest {const ZonesPostRequest({required this.account, required this.name, this.type, });
