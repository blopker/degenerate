...
import 'package:collection/collection.dart';import 'workers_binding_item.dart';import 'workers_limits.dart';import 'workers_observability.dart';import 'workers_placement_info_no_status.dart';import 'workers_script_and_version_settings_item_annotations.dart';import 'workers_script_and_version_settings_item_migrations.dart';import 'workers_tail_consumers_script.dart';import 'workers_usage_model.dart';final class WorkersScriptAndVersionSettingsItem {const WorkersScriptAndVersionSettingsItem({this.annotations, this.bindings, this.compatibilityDate, this.compatibilityFlags, this.limits, this.logpush, this.migrations, this.observability, this.placement, this.tags, this.tailConsumers, this.usageModel, });
...
WorkersScriptAndVersionSettingsItem copyWith({WorkersScriptAndVersionSettingsItemAnnotations Function()? annotations, List<WorkersBindingItem> Function()? bindings, String Function()? compatibilityDate, List<String> Function()? compatibilityFlags, WorkersLimits Function()? limits, bool Function()? logpush, WorkersScriptAndVersionSettingsItemMigrations Function()? migrations, WorkersObservability Function()? observability, WorkersPlacementInfoNoStatus Function()? placement, List<String>? Function()? tags, List<WorkersTailConsumersScript>? Function()? tailConsumers, WorkersUsageModel Function()? usageModel, }) { return WorkersScriptAndVersionSettingsItem(
