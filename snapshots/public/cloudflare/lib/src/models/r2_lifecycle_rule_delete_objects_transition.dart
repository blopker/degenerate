...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_lifecycle_rule_delete_objects_transition_condition.dart';/// Transition to delete objects.
...
factory R2LifecycleRuleDeleteObjectsTransition.fromJson(Map<String, dynamic> json) { return R2LifecycleRuleDeleteObjectsTransition(
  condition: json['condition'] != null ? OneOf2.parse(json['condition'], fromA: (v) => R2LifecycleAgeCondition.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && R2LifecycleAgeCondition.canParse(v), fromB: (v) => R2LifecycleDateCondition.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && R2LifecycleDateCondition.canParse(v),) : null,
); }
