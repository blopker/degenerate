...
final class WorkersBindingKindDurableObjectNamespace {const WorkersBindingKindDurableObjectNamespace({this.className, this.dispatchNamespace, this.environment, required this.name, this.namespaceId, this.scriptName, required this.type, });
...
WorkersBindingKindDurableObjectNamespace copyWith({String Function()? className, String Function()? dispatchNamespace, String Function()? environment, String? name, String Function()? namespaceId, String Function()? scriptName, String? type, }) { return WorkersBindingKindDurableObjectNamespace(
