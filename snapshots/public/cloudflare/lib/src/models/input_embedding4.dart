...
import 'input_embedding4_text.dart';final class InputEmbedding4 {const InputEmbedding4({required this.text, this.truncateInputs = false, });

factory InputEmbedding4.fromJson(Map<String, dynamic> json) { return InputEmbedding4(
  text: InputEmbedding4Text.fromJson(json['text']),
