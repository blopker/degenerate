...
import 'addressing_bgp_on_demand.dart';import 'addressing_bgp_signal_opts.dart';final class AddressingIpamBgpPrefixes {const AddressingIpamBgpPrefixes({this.asn, this.asnPrependCount, this.autoAdvertiseWithdraw, this.bgpSignalOpts, this.cidr, this.createdAt, this.id, this.modifiedAt, this.onDemand, });
...
factory AddressingIpamBgpPrefixes.fromJson(Map<String, dynamic> json) { return AddressingIpamBgpPrefixes(
  ...
  asnPrependCount: json['asn_prepend_count'] != null ? (json['asn_prepend_count'] as num).toInt() : null,
...
AddressingIpamBgpPrefixes copyWith({int? Function()? asn, int Function()? asnPrependCount, bool Function()? autoAdvertiseWithdraw, AddressingBgpSignalOpts Function()? bgpSignalOpts, String Function()? cidr, DateTime Function()? createdAt, String Function()? id, DateTime Function()? modifiedAt, AddressingBgpOnDemand Function()? onDemand, }) { return AddressingIpamBgpPrefixes(
