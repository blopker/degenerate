...
import 'addressing_asn_prepend_count.dart';import 'addressing_auto_advertise_withdraw.dart';import 'addressing_bgp_on_demand.dart';import 'addressing_bgp_prefix_identifier.dart';import 'addressing_bgp_signal_opts.dart';import 'addressing_cidr.dart';import 'addressing_schemas_asn.dart';import 'addressing_timestamp.dart';final class AddressingIpamBgpPrefixes {const AddressingIpamBgpPrefixes({this.asn, this.asnPrependCount, this.autoAdvertiseWithdraw, this.bgpSignalOpts, this.cidr, this.createdAt, this.id, this.modifiedAt, this.onDemand, });
