...
import 'package:collection/collection.dart';import 'public_ip_messages2.dart';final class ResponseCommonFailure54 {const ResponseCommonFailure54({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommonFailure54 copyWith({List<PublicIpMessages2>? errors, List<PublicIpMessages2>? messages, Map<String, String>? Function()? result, bool? success, }) { return ResponseCommonFailure54(
