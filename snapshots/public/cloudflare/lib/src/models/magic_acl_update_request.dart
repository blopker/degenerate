...
import 'package:collection/collection.dart';import 'magic_acl_update_request_protocols.dart';import 'magic_forward_locally.dart';import 'magic_lan_acl_configuration.dart';import 'magic_unidirectional.dart';final class MagicAclUpdateRequest {const MagicAclUpdateRequest({this.description, this.forwardLocally, this.lan1, this.lan2, this.name, this.protocols, this.unidirectional, });
