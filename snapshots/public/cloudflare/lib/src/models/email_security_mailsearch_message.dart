...
import 'package:collection/collection.dart';import 'email_security_disposition_label.dart';import 'email_security_mailsearch_message_findings.dart';import 'email_security_mailsearch_message_post_delivery_operations.dart';import 'email_security_mailsearch_message_properties.dart';import 'email_security_mailsearch_message_validation.dart';import 'email_security_message_delivery_mode.dart';final class EmailSecurityMailsearchMessage {const EmailSecurityMailsearchMessage({required this.actionLog, this.alertId, required this.clientRecipients, this.deliveryMode, required this.detectionReasons, this.edfHash, this.envelopeFrom, this.envelopeTo, this.finalDisposition, this.findings, this.from, this.fromName, this.htmltextStructureHash, required this.isPhishSubmission, required this.isQuarantined, this.messageId, this.postDeliveryOperations, required this.postfixId, this.postfixIdOutbound, required this.properties, this.replyto, this.sentDate, this.subject, this.threatCategories, this.to, this.toName, required this.ts, this.validation, required this.id, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action_log') && json['action_log'] is String &&
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EmailSecurityMailsearchMessage &&
          ...
          const ListEquality<dynamic>().equals(clientRecipients, other.clientRecipients) &&
          deliveryMode == other.deliveryMode &&
          const ListEquality<dynamic>().equals(detectionReasons, other.detectionReasons) &&
          edfHash == other.edfHash &&
          envelopeFrom == other.envelopeFrom &&
          const ListEquality<dynamic>().equals(envelopeTo, other.envelopeTo) &&
          ...
          const ListEquality<dynamic>().equals(postDeliveryOperations, other.postDeliveryOperations) &&
          ...
          const ListEquality<dynamic>().equals(threatCategories, other.threatCategories) &&
