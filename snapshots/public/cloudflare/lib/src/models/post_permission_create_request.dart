...
import 'post_permission_create_request_role.dart';import 'post_permission_create_request_subject_type.dart';final class PostPermissionCreateRequest {const PostPermissionCreateRequest({required this.role, required this.subjectId, required this.subjectType, });
