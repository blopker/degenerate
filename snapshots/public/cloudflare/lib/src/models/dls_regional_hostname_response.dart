...
import 'dls_hostname.dart';import 'dls_region_key.dart';import 'dls_routing.dart';import 'dls_timestamp.dart';final class DlsRegionalHostnameResponse {const DlsRegionalHostnameResponse({required this.createdOn, required this.hostname, required this.regionKey, this.routing, });
