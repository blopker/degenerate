...
import 'package:collection/collection.dart';import 'magic_transit_colo.dart';import 'magic_transit_error.dart';import 'magic_transit_hop_result.dart';final class MagicTransitColoResult {const MagicTransitColoResult({this.colo, this.error, this.hops, this.targetSummary, this.tracerouteTimeMs, });
...
factory MagicTransitColoResult.fromJson(Map<String, dynamic> json) { return MagicTransitColoResult(
  ...
  tracerouteTimeMs: json['traceroute_time_ms'] != null ? (json['traceroute_time_ms'] as num).toInt() : null,
); }
...
MagicTransitColoResult copyWith({MagicTransitColo Function()? colo, MagicTransitError Function()? error, List<MagicTransitHopResult> Function()? hops, Map<String, String> Function()? targetSummary, int Function()? tracerouteTimeMs, }) { return MagicTransitColoResult(
