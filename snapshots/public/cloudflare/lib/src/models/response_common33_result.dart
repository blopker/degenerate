...
final class ResponseCommon33Result {const ResponseCommon33Result({this.mapStringObject, this.listObject, this.string, });

factory ResponseCommon33Result.fromJson(Object? json) { return ResponseCommon33Result(
