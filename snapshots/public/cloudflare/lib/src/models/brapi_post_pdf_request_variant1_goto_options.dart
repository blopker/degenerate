...
import 'brapi_post_pdf_request_variant1_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostPdfRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostPdfRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
