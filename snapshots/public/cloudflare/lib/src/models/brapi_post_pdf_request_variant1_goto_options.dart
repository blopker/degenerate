...
factory BrapiPostPdfRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostPdfRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? OneOf5.parse(json['waitUntil'], fromA: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant3.fromJson(v as String), canParseC: (v) => v is String, fromD: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant4.fromJson(v as String), canParseD: (v) => v is String, fromE: (v) => (v as List<dynamic>).map((e) => OneOf4.parse(e, fromA: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant5Variant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant5Variant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant5Variant3.fromJson(v as String), canParseC: (v) => v is String, fromD: (v) => BrapiPostPdfRequestVariant1GotoOptionsWaitUntilVariant5Variant4.fromJson(v as String), canParseD: (v) => v is String,)).toList(), canParseE: (v) => v is List,) : null,
); }
