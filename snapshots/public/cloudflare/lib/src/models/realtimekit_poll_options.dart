...
import 'package:collection/collection.dart';import 'realtimekit_poll_options_votes.dart';final class RealtimekitPollOptions {const RealtimekitPollOptions({required this.count, required this.text, required this.votes, });
