...
import 'package:collection/collection.dart';import 'inline_object105.dart';import 'inline_object106.dart';import 'inline_object107.dart';import 'inline_object108.dart';import 'inline_object109.dart';import 'inline_object110.dart';import 'inline_object111.dart';import 'inline_object112.dart';import 'inline_object113.dart';import 'inline_object114.dart';import 'inline_object115.dart';import 'inline_object116.dart';import 'pages_deployment_config_values_request_limits.dart';import 'pages_deployment_config_values_request_placement.dart';import 'pages_deployment_config_values_request_usage_model.dart';final class PagesDeploymentConfigValuesRequest {const PagesDeploymentConfigValuesRequest({this.aiBindings, this.alwaysUseLatestCompatibilityDate = false, this.analyticsEngineDatasets, this.browsers, this.buildImageMajorVersion = 3, this.compatibilityDate, this.compatibilityFlags, this.d1Databases, this.durableObjectNamespaces, this.envVars, this.failOpen = true, this.hyperdriveBindings, this.kvNamespaces, this.limits, this.mtlsCertificates, this.placement, this.queueProducers, this.r2Buckets, this.services, this.usageModel = PagesDeploymentConfigValuesRequestUsageModel.standard, this.vectorizeBindings, this.wranglerConfigHash, });
...
factory PagesDeploymentConfigValuesRequest.fromJson(Map<String, dynamic> json) { return PagesDeploymentConfigValuesRequest(
  ...
  d1Databases: (json['d1_databases'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject107.fromJson(v as Map<String, dynamic>))),
  durableObjectNamespaces: (json['durable_object_namespaces'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject108.fromJson(v as Map<String, dynamic>))),
  envVars: (json['env_vars'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject109.fromJson(v as Map<String, dynamic>))),
  ...
  vectorizeBindings: (json['vectorize_bindings'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject116.fromJson(v as Map<String, dynamic>))),
