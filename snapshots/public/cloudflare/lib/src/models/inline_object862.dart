...
import 'package:collection/collection.dart';import 'inline_object862_messages.dart';final class InlineObject862 {const InlineObject862({this.frequencyPenalty, this.ignoreEos, required this.image, this.maxTokens = 512, required this.messages, this.presencePenalty, this.repetitionPenalty, this.seed, this.temperature, this.topK, this.topP, });

factory InlineObject862.fromJson(Map<String, dynamic> json) { return InlineObject862(
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => InlineObject862Messages.fromJson(e as Map<String, dynamic>)).toList(),
...
InlineObject862 copyWith({double Function()? frequencyPenalty, bool Function()? ignoreEos, String? image, int Function()? maxTokens, List<InlineObject862Messages>? messages, double Function()? presencePenalty, double Function()? repetitionPenalty, double Function()? seed, double Function()? temperature, double Function()? topK, double Function()? topP, }) { return InlineObject862(
...
@override String toString() { return 'InlineObject862(frequencyPenalty: $frequencyPenalty, ignoreEos: $ignoreEos, image: $image, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, repetitionPenalty: $repetitionPenalty, seed: $seed, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
