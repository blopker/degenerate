...
import 'package:collection/collection.dart';import 'image_text_to_text_variant2_messages.dart';final class ImageTextToTextVariant2 {const ImageTextToTextVariant2({this.frequencyPenalty, this.ignoreEos, required this.image, this.maxTokens = 512, required this.messages, this.presencePenalty, this.repetitionPenalty, this.seed, this.temperature, this.topK, this.topP, });
