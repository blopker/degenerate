...
import 'package:collection/collection.dart';import 'urlscanner_create_scan_response4292_errors.dart';final class UrlscannerCreateScanResponse4292 {const UrlscannerCreateScanResponse4292({this.description, required this.errors, required this.message, required this.status, });
