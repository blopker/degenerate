...
import 'streams_by_stream_id_response2_result.dart';final class StreamsByStreamIdResponse2 {const StreamsByStreamIdResponse2({required this.result, required this.success, });
...
StreamsByStreamIdResponse2 copyWith({StreamsByStreamIdResponse2Result? result, bool? success, }) { return StreamsByStreamIdResponse2(
