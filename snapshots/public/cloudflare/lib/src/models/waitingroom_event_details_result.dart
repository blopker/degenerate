...
import 'waitingroom_event_description.dart';import 'waitingroom_event_details_custom_page_html.dart';import 'waitingroom_event_details_disable_session_renewal.dart';import 'waitingroom_event_details_new_users_per_minute.dart';import 'waitingroom_event_details_queueing_method.dart';import 'waitingroom_event_details_session_duration.dart';import 'waitingroom_event_details_total_active_users.dart';import 'waitingroom_event_end_time.dart';import 'waitingroom_event_id.dart';import 'waitingroom_event_name.dart';import 'waitingroom_event_prequeue_start_time.dart';import 'waitingroom_event_shuffle_at_event_start.dart';import 'waitingroom_event_start_time.dart';import 'waitingroom_event_suspended.dart';import 'waitingroom_timestamp.dart';final class WaitingroomEventDetailsResult {const WaitingroomEventDetailsResult({this.createdOn, this.customPageHtml, this.description, this.disableSessionRenewal, this.eventEndTime, this.eventStartTime, this.id, this.modifiedOn, this.name, this.newUsersPerMinute, this.prequeueStartTime, this.queueingMethod, this.sessionDuration, this.shuffleAtEventStart, this.suspended, this.totalActiveUsers, });
