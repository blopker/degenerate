...
import 'r2_bucket_lock_rule_condition.dart';final class R2BucketLockRule {const R2BucketLockRule({required this.condition, required this.enabled, required this.id, this.prefix, });
