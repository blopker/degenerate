...
import 'tunnel_components_schemas_tunnel_id.dart';import 'tunnel_created_at.dart';import 'tunnel_deleted_at.dart';import 'tunnel_hostname.dart';import 'tunnel_hostname_comment.dart';import 'tunnel_hostname_route_id.dart';import 'tunnel_schemas_tunnel_name.dart';final class TunnelHostnameRoute {const TunnelHostnameRoute({this.comment, this.createdAt, this.deletedAt, this.hostname, this.id, this.tunnelId, this.tunnelName, });
