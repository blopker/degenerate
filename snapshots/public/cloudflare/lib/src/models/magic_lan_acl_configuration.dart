...
import 'package:collection/collection.dart';import 'magic_acl_port_range.dart';import 'magic_acl_subnet.dart';import 'magic_port.dart';final class MagicLanAclConfiguration {const MagicLanAclConfiguration({required this.lanId, this.lanName, this.portRanges, this.ports, this.subnets, });
