...
factory AccessSelfHostedProps.fromJson(Map<String, dynamic> json) { return AccessSelfHostedProps(
  ...
  destinations: (json['destinations'] as List<dynamic>?)?.map((e) => OneOf3.parse(e, fromA: (v) => PublicDestination.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PublicDestination.canParse(v), fromB: (v) => PrivateDestination.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PrivateDestination.canParse(v), fromC: (v) => ViaMcpServerPortalDestination.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ViaMcpServerPortalDestination.canParse(v),)).toList(),
