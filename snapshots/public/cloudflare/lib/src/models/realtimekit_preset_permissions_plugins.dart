...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtimekit_preset_permissions_plugins_config.dart';/// Plugin permissions
...
factory RealtimekitPresetPermissionsPlugins.fromJson(Map<String, dynamic> json) { return RealtimekitPresetPermissionsPlugins(
  ...
  config: OneOf2.parse(json['config'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => RealtimekitPresetPermissionsPluginsConfigVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RealtimekitPresetPermissionsPluginsConfigVariant2.canParse(v),),
); }
