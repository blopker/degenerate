...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages51_messages_assistant_audio.dart';import 'messages51_messages_assistant_content.dart';import 'messages51_messages_assistant_function_call.dart';import 'messages51_messages_assistant_tool_calls.dart';final class Messages51MessagesAssistantRole {const Messages51MessagesAssistantRole._(this.value);
...
factory Messages51MessagesAssistant.fromJson(Map<String, dynamic> json) { return Messages51MessagesAssistant(
  ...
  content: json['content'] != null ? OneOf2.parse(json['content'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => Messages51MessagesAssistantContentVariant2.fromJson(e as Map<String, dynamic>)).toList(), canParseB: (v) => v is List,) : null,
  ...
  toolCalls: (json['tool_calls'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => Messages51MessagesAssistantToolCallsFunction.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Messages51MessagesAssistantToolCallsFunction.canParse(v), fromB: (v) => Messages51MessagesAssistantToolCallsCustom.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Messages51MessagesAssistantToolCallsCustom.canParse(v),)).toList(),
); }
