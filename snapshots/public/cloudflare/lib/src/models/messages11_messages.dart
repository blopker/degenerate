...
import 'messages11_messages_content.dart';final class Messages11Messages {const Messages11Messages({required this.content, required this.role, });

factory Messages11Messages.fromJson(Map<String, dynamic> json) { return Messages11Messages(
  content: Messages11MessagesContent.fromJson(json['content']),
