...
import 'package:collection/collection.dart';import 'magic_visibility_pcaps_messages2.dart';import 'response_common47_result.dart';final class ResponseCommon47 {const ResponseCommon47({required this.errors, required this.messages, required this.result, required this.success, });
...
factory ResponseCommon47.fromJson(Map<String, dynamic> json) { return ResponseCommon47(
  ...
  result: ResponseCommon47Result.fromJson(json['result'] as Map<String, dynamic>),
