...
import 'access_oidc_saas_app_custom_claims_scope.dart';import 'access_oidc_saas_app_custom_claims_source.dart';final class AccessOidcSaasAppCustomClaims {const AccessOidcSaasAppCustomClaims({this.name, this.$required, this.scope, this.source, });
