...
import 'package:collection/collection.dart';import 'page_shield_cookie_same_site_attribute.dart';import 'page_shield_cookie_type.dart';final class PageShieldCookie {const PageShieldCookie({this.domainAttribute, this.expiresAttribute, required this.firstSeenAt, required this.host, this.httpOnlyAttribute, required this.id, required this.lastSeenAt, this.maxAgeAttribute, required this.name, this.pageUrls, this.pathAttribute, this.sameSiteAttribute, this.secureAttribute, required this.type, });
