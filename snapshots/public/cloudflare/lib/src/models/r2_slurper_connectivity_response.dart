...
import 'r2_slurper_connectivity_response_connectivity_status.dart';final class R2SlurperConnectivityResponse {const R2SlurperConnectivityResponse({this.connectivityStatus});
