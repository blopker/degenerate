...
import 'package:collection/collection.dart';final class InfraTargetsDeleteBatchPostRequest {const InfraTargetsDeleteBatchPostRequest({required this.targetIds});
...
InfraTargetsDeleteBatchPostRequest copyWith({List<String>? targetIds}) { return InfraTargetsDeleteBatchPostRequest(
