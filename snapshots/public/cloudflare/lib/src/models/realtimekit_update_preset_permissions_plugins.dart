...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'realtimekit_update_preset_permissions_plugins_config.dart';/// Plugin permissions
...
factory RealtimekitUpdatePresetPermissionsPlugins.fromJson(Map<String, dynamic> json) { return RealtimekitUpdatePresetPermissionsPlugins(
  ...
  config: json['config'] != null ? OneOf2.parse(json['config'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => RealtimekitUpdatePresetPermissionsPluginsConfigVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && RealtimekitUpdatePresetPermissionsPluginsConfigVariant2.canParse(v),) : null,
); }
