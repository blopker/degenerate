...
import 'package:collection/collection.dart';import 'mconn_recorded_event.dart';final class MconnCustomerEventsGetLatestResult {const MconnCustomerEventsGetLatestResult({required this.count, required this.items, });
