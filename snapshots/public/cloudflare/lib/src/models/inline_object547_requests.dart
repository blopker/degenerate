...
import 'inline_object547_requests_response_format.dart';final class InlineObject547Requests {const InlineObject547Requests({this.externalReference, this.frequencyPenalty, this.maxTokens = 256, this.presencePenalty, this.prompt, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topP, });

factory InlineObject547Requests.fromJson(Map<String, dynamic> json) { return InlineObject547Requests(
...
InlineObject547Requests copyWith({String Function()? externalReference, double Function()? frequencyPenalty, int Function()? maxTokens, double Function()? presencePenalty, String Function()? prompt, double Function()? repetitionPenalty, InlineObject547RequestsResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, double Function()? topP, }) { return InlineObject547Requests(
...
@override String toString() { return 'InlineObject547Requests(externalReference: $externalReference, frequencyPenalty: $frequencyPenalty, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topP: $topP)'; } 
 }
