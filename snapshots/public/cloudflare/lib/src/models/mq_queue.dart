...
import 'package:collection/collection.dart';import 'mq_consumer_response.dart';import 'mq_producer.dart';import 'mq_queue_name.dart';import 'mq_queue_settings.dart';final class MqQueue {const MqQueue({this.consumers, this.consumersTotalCount, this.createdOn, this.modifiedOn, this.producers, this.producersTotalCount, this.queueId, this.queueName, this.settings, });
