...
import 'firewall_action.dart';import 'firewall_match.dart';final class RateLimitsForAZoneCreateARateLimitRequest {const RateLimitsForAZoneCreateARateLimitRequest({required this.action, required this.match, required this.period, required this.threshold, });
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('action') &&
      ...
      json.containsKey('threshold') && json['threshold'] is num; } 
RateLimitsForAZoneCreateARateLimitRequest copyWith({FirewallAction? action, FirewallMatch? match, double? period, double? threshold, }) { return RateLimitsForAZoneCreateARateLimitRequest(
