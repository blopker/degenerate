...
final class ResponsesAsyncRequestsInput {const ResponsesAsyncRequestsInput({this.string, this.listObject, });

factory ResponsesAsyncRequestsInput.fromJson(Object? json) { return ResponsesAsyncRequestsInput(
