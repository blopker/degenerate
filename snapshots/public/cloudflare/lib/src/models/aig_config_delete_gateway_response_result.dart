...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'aig_config_delete_gateway_response_result_dlp.dart';import 'aig_config_delete_gateway_response_result_otel.dart';import 'aig_config_delete_gateway_response_result_stripe.dart';final class AigConfigDeleteGatewayResponseResultLogManagementStrategy {const AigConfigDeleteGatewayResponseResultLogManagementStrategy._(this.value);
...
factory AigConfigDeleteGatewayResponseResult.fromJson(Map<String, dynamic> json) { return AigConfigDeleteGatewayResponseResult(
  ...
  dlp: json['dlp'] != null ? OneOf2.parse(json['dlp'], fromA: (v) => AigConfigDeleteGatewayResponseResultDlpVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AigConfigDeleteGatewayResponseResultDlpVariant1.canParse(v), fromB: (v) => AigConfigDeleteGatewayResponseResultDlpVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && AigConfigDeleteGatewayResponseResultDlpVariant2.canParse(v),) : null,
