...
import 'package:collection/collection.dart';import 'aig_config_delete_gateway_response_result_dlp.dart';import 'aig_config_delete_gateway_response_result_log_management_strategy.dart';import 'aig_config_delete_gateway_response_result_otel.dart';import 'aig_config_delete_gateway_response_result_rate_limiting_technique.dart';import 'aig_config_delete_gateway_response_result_stripe.dart';import 'aig_config_delete_gateway_response_result_workers_ai_billing_mode.dart';final class AigConfigDeleteGatewayResponseResult {const AigConfigDeleteGatewayResponseResult({this.authentication, required this.cacheInvalidateOnUpdate, required this.cacheTtl, required this.collectLogs, required this.createdAt, this.dlp, required this.id, this.isDefault, this.logManagement, this.logManagementStrategy, this.logpush, this.logpushPublicKey, required this.modifiedAt, this.otel, required this.rateLimitingInterval, required this.rateLimitingLimit, required this.rateLimitingTechnique, this.storeId, this.stripe, this.workersAiBillingMode = AigConfigDeleteGatewayResponseResultWorkersAiBillingMode.postpaid, this.zdr, });
