...
import 'package:collection/collection.dart';final class GetCategoryReadResponse {const GetCategoryReadResponse({required this.killChain, this.mitreAttack, required this.name, this.shortname, required this.uuid, });
