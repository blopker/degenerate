...
import 'contact_properties.dart';import 'transfer_in.dart';final class DomainProperties {const DomainProperties({this.available, this.canRegister, this.createdAt, this.currentRegistrar, this.expiresAt, this.id, this.locked, this.registrantContact, this.registryStatuses, this.supportedTld, this.transferIn, this.updatedAt, });
...
DomainProperties copyWith({bool Function()? available, bool Function()? canRegister, DateTime Function()? createdAt, String Function()? currentRegistrar, DateTime Function()? expiresAt, String Function()? id, bool Function()? locked, ContactProperties Function()? registrantContact, String Function()? registryStatuses, bool Function()? supportedTld, TransferIn Function()? transferIn, DateTime Function()? updatedAt, }) { return DomainProperties(
