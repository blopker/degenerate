...
import 'teams_devices_os_version_input_request_operating_system.dart';import 'teams_devices_os_version_input_request_operator.dart';final class TeamsDevicesOsVersionInputRequest {const TeamsDevicesOsVersionInputRequest({required this.operatingSystem, required this.$operator, this.osDistroName, this.osDistroRevision, this.osVersionExtra, required this.version, });
