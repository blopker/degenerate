...
import 'package:collection/collection.dart';import 'cloudflare_pipelines_field_type.dart';final class CloudflarePipelinesStructField {const CloudflarePipelinesStructField({required this.fields, this.name, });
