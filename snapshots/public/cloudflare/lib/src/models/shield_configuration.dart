...
import 'package:collection/collection.dart';import 'shield_auth_id_characteristics2.dart';final class ShieldConfiguration {const ShieldConfiguration({required this.authIdCharacteristics});

factory ShieldConfiguration.fromJson(Map<String, dynamic> json) { return ShieldConfiguration(
  authIdCharacteristics: (json['auth_id_characteristics'] as List<dynamic>).map((e) => ShieldAuthIdCharacteristics2.fromJson(e as Map<String, dynamic>)).toList(),
); }
