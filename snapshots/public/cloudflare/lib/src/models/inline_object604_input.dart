...
final class InlineObject604Input {const InlineObject604Input({this.string, this.listString, });

factory InlineObject604Input.fromJson(Object? json) { return InlineObject604Input(
