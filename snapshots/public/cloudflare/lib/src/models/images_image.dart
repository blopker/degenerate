...
import 'package:collection/collection.dart';import 'images_image_creator.dart';import 'images_image_filename.dart';import 'images_image_identifier.dart';import 'images_image_require_signed_ur_ls.dart';import 'images_image_uploaded.dart';import 'images_image_variants2.dart';final class ImagesImage {const ImagesImage({this.creator, this.filename, this.id, this.meta, this.requireSignedUrLs, this.uploaded, this.variants, });
...
ImagesImage copyWith({ImagesImageCreator? Function()? creator, ImagesImageFilename Function()? filename, ImagesImageIdentifier Function()? id, Map<String, String> Function()? meta, ImagesImageRequireSignedUrLs Function()? requireSignedUrLs, ImagesImageUploaded Function()? uploaded, List<ImagesImageVariants2> Function()? variants, }) { return ImagesImage(
