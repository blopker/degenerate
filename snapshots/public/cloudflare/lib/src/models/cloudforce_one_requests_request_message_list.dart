...
import 'cloudforce_one_requests_request_message_list_sort_order.dart';import 'cloudforce_one_requests_time.dart';final class CloudforceOneRequestsRequestMessageList {const CloudforceOneRequestsRequestMessageList({this.after, this.before, required this.page, required this.perPage, this.sortBy, this.sortOrder, });
