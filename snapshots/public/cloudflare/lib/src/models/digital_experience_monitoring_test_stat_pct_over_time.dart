...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_test_stat_pct_over_time_slots.dart';final class DigitalExperienceMonitoringTestStatPctOverTime {const DigitalExperienceMonitoringTestStatPctOverTime({this.avg, this.max, this.min, required this.slots, });
