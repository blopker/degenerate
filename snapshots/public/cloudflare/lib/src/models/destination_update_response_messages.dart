...
import 'destination_update_response_messages_message.dart';final class DestinationUpdateResponseMessages {const DestinationUpdateResponseMessages({required this.message});
