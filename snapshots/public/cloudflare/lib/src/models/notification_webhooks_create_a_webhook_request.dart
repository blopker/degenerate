...
final class NotificationWebhooksCreateAWebhookRequest {const NotificationWebhooksCreateAWebhookRequest({required this.name, this.secret, required this.url, });
...
NotificationWebhooksCreateAWebhookRequest copyWith({String? name, String Function()? secret, String? url, }) { return NotificationWebhooksCreateAWebhookRequest(
  name: name ?? this.name,
