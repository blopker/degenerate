...
import 'inline_object360_response_format.dart';final class InlineObject360 {const InlineObject360({this.frequencyPenalty, this.lora, this.maxTokens = 2000, this.presencePenalty, required this.prompt, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.topK, this.topP, });

factory InlineObject360.fromJson(Map<String, dynamic> json) { return InlineObject360(
  ...
  responseFormat: json['response_format'] != null ? InlineObject360ResponseFormat.fromJson(json['response_format'] as Map<String, dynamic>) : null,
...
final InlineObject360ResponseFormat? responseFormat;
...
InlineObject360 copyWith({double Function()? frequencyPenalty, String Function()? lora, int Function()? maxTokens, double Function()? presencePenalty, String? prompt, bool Function()? raw, double Function()? repetitionPenalty, InlineObject360ResponseFormat Function()? responseFormat, int Function()? seed, bool Function()? stream, double Function()? temperature, int Function()? topK, double Function()? topP, }) { return InlineObject360(
...
@override String toString() { return 'InlineObject360(frequencyPenalty: $frequencyPenalty, lora: $lora, maxTokens: $maxTokens, presencePenalty: $presencePenalty, prompt: $prompt, raw: $raw, repetitionPenalty: $repetitionPenalty, responseFormat: $responseFormat, seed: $seed, stream: $stream, temperature: $temperature, topK: $topK, topP: $topP)'; } 
 }
