...
import 'destination_create_response500_errors_message.dart';final class DestinationCreateResponse500Errors {const DestinationCreateResponse500Errors({this.detail, required this.message, });
