...
import 'logpush_dataset.dart';import 'logpush_destination_conf.dart';import 'logpush_enabled.dart';import 'logpush_error_message.dart';import 'logpush_frequency.dart';import 'logpush_id.dart';import 'logpush_kind.dart';import 'logpush_last_complete.dart';import 'logpush_last_error.dart';import 'logpush_logpull_options.dart';import 'logpush_max_upload_bytes.dart';import 'logpush_max_upload_interval_seconds.dart';import 'logpush_max_upload_records.dart';import 'logpush_name.dart';import 'logpush_output_options.dart';final class LogpushLogpushJob {const LogpushLogpushJob({this.dataset, this.destinationConf, this.enabled, this.errorMessage, this.frequency, this.id, this.kind, this.lastComplete, this.lastError, this.logpullOptions, this.maxUploadBytes, this.maxUploadIntervalSeconds, this.maxUploadRecords, this.name, this.outputOptions, });
