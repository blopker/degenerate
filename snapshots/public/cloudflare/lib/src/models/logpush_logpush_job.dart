...
factory LogpushLogpushJob.fromJson(Map<String, dynamic> json) { return LogpushLogpushJob(
  ...
  lastComplete: json['last_complete'] != null ? DateTime.parse(json['last_complete'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  ...
  if (lastComplete != null) 'last_complete': lastComplete?.toIso8601String(),
...
LogpushLogpushJob copyWith({LogpushDataset? Function()? dataset, Uri Function()? destinationConf, bool Function()? enabled, String? Function()? errorMessage, LogpushFrequency? Function()? frequency, int Function()? id, LogpushKind Function()? kind, DateTime? Function()? lastComplete, DateTime? Function()? lastError, String? Function()? logpullOptions, LogpushMaxUploadBytes Function()? maxUploadBytes, LogpushMaxUploadIntervalSeconds Function()? maxUploadIntervalSeconds, LogpushMaxUploadRecords Function()? maxUploadRecords, String? Function()? name, LogpushOutputOptions Function()? outputOptions, }) { return LogpushLogpushJob(
