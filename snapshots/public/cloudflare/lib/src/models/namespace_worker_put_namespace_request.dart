...
final class NamespaceWorkerPutNamespaceRequest {const NamespaceWorkerPutNamespaceRequest({this.name, this.trustedWorkers, });
...
NamespaceWorkerPutNamespaceRequest copyWith({String Function()? name, bool Function()? trustedWorkers, }) { return NamespaceWorkerPutNamespaceRequest(
