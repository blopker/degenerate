...
import 'inline_object179.dart';import 'inline_object180.dart';import 'zaraz_zaraz_config_base_consent_button_text_translations.dart';/// Consent management configuration.
...
factory ZarazZarazConfigBaseConsent.fromJson(Map<String, dynamic> json) { return ZarazZarazConfigBaseConsent(
  ...
  purposes: (json['purposes'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject179.fromJson(v as Map<String, dynamic>))),
  purposesWithTranslations: (json['purposesWithTranslations'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, InlineObject180.fromJson(v as Map<String, dynamic>))),
