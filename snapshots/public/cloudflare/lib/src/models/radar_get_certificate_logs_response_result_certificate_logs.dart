...
import 'radar_get_certificate_logs_response_result_certificate_logs_api.dart';import 'radar_get_certificate_logs_response_result_certificate_logs_state.dart';final class RadarGetCertificateLogsResponseResultCertificateLogs {const RadarGetCertificateLogsResponseResultCertificateLogs({required this.api, required this.description, required this.endExclusive, required this.$operator, required this.slug, required this.startInclusive, required this.state, required this.stateTimestamp, required this.url, });
