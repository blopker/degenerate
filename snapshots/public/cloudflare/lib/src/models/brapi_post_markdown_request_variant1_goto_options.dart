...
import 'brapi_post_markdown_request_variant1_goto_options_wait_until.dart';/// Check [options](https://pptr.dev/api/puppeteer.gotooptions).
...
factory BrapiPostMarkdownRequestVariant1GotoOptions.fromJson(Map<String, dynamic> json) { return BrapiPostMarkdownRequestVariant1GotoOptions(
  ...
  waitUntil: json['waitUntil'] != null ? BrapiPostMarkdownRequestVariant1GotoOptionsWaitUntil.fromJson(json['waitUntil'] as Map<String, dynamic>) : null,
); }
