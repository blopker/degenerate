...
import 'package:collection/collection.dart';import 'vectorize_vector_identifier.dart';final class VectorizeIndexQueryResponseMatches {const VectorizeIndexQueryResponseMatches({this.id, this.metadata, this.score, this.values, });
