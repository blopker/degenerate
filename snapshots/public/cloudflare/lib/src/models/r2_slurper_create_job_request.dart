...
import 'r2_slurper_r2_target_schema.dart';import 'r2_slurper_source_job_schema.dart';final class R2SlurperCreateJobRequest {const R2SlurperCreateJobRequest({this.overwrite = true, this.source, this.target, });
