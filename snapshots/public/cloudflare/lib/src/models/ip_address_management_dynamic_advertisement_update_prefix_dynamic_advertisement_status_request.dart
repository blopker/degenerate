...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('advertised') && json['advertised'] is bool; } 
IpAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatusRequest copyWith({bool? advertised}) { return IpAddressManagementDynamicAdvertisementUpdatePrefixDynamicAdvertisementStatusRequest(
