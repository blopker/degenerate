...
import 'create_single_member_status.dart';import 'create_single_member_user.dart';final class CreateSingleMember {const CreateSingleMember({this.status, required this.user, });
