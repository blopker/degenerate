...
import 'package:collection/collection.dart';import 'r2_add_custom_domain_response_min_tls.dart';final class R2AddCustomDomainResponse {const R2AddCustomDomainResponse({this.ciphers, required this.domain, required this.enabled, this.minTls, });
