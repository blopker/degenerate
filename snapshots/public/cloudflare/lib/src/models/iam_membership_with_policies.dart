...
import 'package:collection/collection.dart';import 'iam_account.dart';import 'iam_list_member_policy.dart';import 'iam_permissions.dart';import 'iam_schemas_status.dart';final class IamMembershipWithPolicies {const IamMembershipWithPolicies({this.account, this.apiAccessEnabled, this.id, this.permissions, this.policies, this.roles, this.status, });
...
IamMembershipWithPolicies copyWith({IamAccount Function()? account, bool? Function()? apiAccessEnabled, String Function()? id, IamPermissions Function()? permissions, List<IamListMemberPolicy> Function()? policies, List<String> Function()? roles, IamSchemasStatus Function()? status, }) { return IamMembershipWithPolicies(
