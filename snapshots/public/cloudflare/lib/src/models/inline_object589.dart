...
import 'package:collection/collection.dart';import 'inline_object589_functions.dart';import 'inline_object589_messages.dart';import 'inline_object589_tools.dart';final class InlineObject589 {const InlineObject589({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });
...
factory InlineObject589.fromJson(Map<String, dynamic> json) { return InlineObject589(
  ...
  functions: (json['functions'] as List<dynamic>?)?.map((e) => InlineObject589Functions.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  messages: (json['messages'] as List<dynamic>).map((e) => InlineObject589Messages.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => InlineObject589Tools.fromJson(e)).toList(),
...
InlineObject589 copyWith({double Function()? frequencyPenalty, List<InlineObject589Functions> Function()? functions, Map<String, String> Function()? guidedJson, int Function()? maxTokens, List<InlineObject589Messages>? messages, double Function()? presencePenalty, bool Function()? raw, double Function()? repetitionPenalty, int Function()? seed, bool Function()? stream, double Function()? temperature, List<InlineObject589Tools> Function()? tools, int Function()? topK, double Function()? topP, }) { return InlineObject589(
...
@override String toString() { return 'InlineObject589(frequencyPenalty: $frequencyPenalty, functions: $functions, guidedJson: $guidedJson, maxTokens: $maxTokens, messages: $messages, presencePenalty: $presencePenalty, raw: $raw, repetitionPenalty: $repetitionPenalty, seed: $seed, stream: $stream, temperature: $temperature, tools: $tools, topK: $topK, topP: $topP)'; } 
 }
