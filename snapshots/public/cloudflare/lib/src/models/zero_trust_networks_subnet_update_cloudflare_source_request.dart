...
final class ZeroTrustNetworksSubnetUpdateCloudflareSourceRequest {const ZeroTrustNetworksSubnetUpdateCloudflareSourceRequest({this.comment, this.name, this.network, });
...
ZeroTrustNetworksSubnetUpdateCloudflareSourceRequest copyWith({String Function()? comment, String Function()? name, String Function()? network, }) { return ZeroTrustNetworksSubnetUpdateCloudflareSourceRequest(
