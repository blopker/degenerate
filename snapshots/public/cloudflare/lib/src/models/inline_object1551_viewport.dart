...
final class InlineObject1551Viewport {const InlineObject1551Viewport({this.deviceScaleFactor, this.hasTouch, required this.height, this.isLandscape, this.isMobile, required this.width, });

factory InlineObject1551Viewport.fromJson(Map<String, dynamic> json) { return InlineObject1551Viewport(
...
InlineObject1551Viewport copyWith({double Function()? deviceScaleFactor, bool Function()? hasTouch, double? height, bool Function()? isLandscape, bool Function()? isMobile, double? width, }) { return InlineObject1551Viewport(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InlineObject1551Viewport &&
...
@override String toString() { return 'InlineObject1551Viewport(deviceScaleFactor: $deviceScaleFactor, hasTouch: $hasTouch, height: $height, isLandscape: $isLandscape, isMobile: $isMobile, width: $width)'; } 
 }
