...
import 'package:collection/collection.dart';import 'r2_add_custom_domain_request_min_tls.dart';final class R2AddCustomDomainRequest {const R2AddCustomDomainRequest({this.ciphers, required this.domain, required this.enabled, this.minTls, required this.zoneId, });
