...
import 'package:collection/collection.dart';import 'dlp_email_rule_action.dart';import 'dlp_email_rule_condition.dart';final class DlpCreateEmailRule {const DlpCreateEmailRule({required this.action, required this.conditions, this.description, required this.enabled, required this.name, });
