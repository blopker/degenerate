...
import 'magic_automatic_return_routing.dart';import 'magic_bgp_config.dart';import 'magic_cloudflare_ipsec_endpoint.dart';import 'magic_components_schemas_description.dart';import 'magic_custom_remote_identities.dart';import 'magic_customer_ipsec_endpoint.dart';import 'magic_health_check_base.dart';import 'magic_interface_address.dart';import 'magic_interface_address6.dart';import 'magic_ipsec_tunnel_name.dart';import 'magic_psk.dart';import 'magic_replay_protection.dart';final class MagicIpsecTunnelAddSingleRequest {const MagicIpsecTunnelAddSingleRequest({this.automaticReturnRouting, this.bgp, required this.cloudflareEndpoint, this.customRemoteIdentities, this.customerEndpoint, this.description, this.healthCheck, required this.interfaceAddress, this.interfaceAddress6, required this.name, this.psk, this.replayProtection, });
