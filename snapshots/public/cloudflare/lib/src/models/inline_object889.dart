...
factory InlineObject889.fromJson(Map<String, dynamic> json) { return InlineObject889(
  ...
  authenticate: json['authenticate'] != null ? InlineObject889Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  ...
  gotoOptions: json['gotoOptions'] != null ? InlineObject889GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  ...
  viewport: json['viewport'] != null ? InlineObject889Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject889WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
