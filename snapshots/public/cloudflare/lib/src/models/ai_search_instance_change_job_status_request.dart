...
import 'ai_search_instance_change_job_status_request_action.dart';final class AiSearchInstanceChangeJobStatusRequest {const AiSearchInstanceChangeJobStatusRequest({required this.action});
