...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'messages_inner_functions.dart';import 'messages_inner_messages.dart';import 'messages_inner_response_format.dart';import 'messages_inner_tools.dart';final class MessagesInner {const MessagesInner({this.frequencyPenalty, this.functions, this.guidedJson, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.15, this.tools, this.topK, this.topP, });
...
factory MessagesInner.fromJson(Map<String, dynamic> json) { return MessagesInner(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => MessagesInnerToolsVariant1.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && MessagesInnerToolsVariant1.canParse(v), fromB: (v) => MessagesInnerToolsVariant2.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && MessagesInnerToolsVariant2.canParse(v),)).toList(),
