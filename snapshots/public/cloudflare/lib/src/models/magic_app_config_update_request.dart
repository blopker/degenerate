...
import 'package:collection/collection.dart';import 'magic_account_app_id.dart';import 'magic_app_breakout.dart';import 'magic_app_priority.dart';import 'magic_identifier.dart';import 'magic_managed_app_id.dart';final class MagicAppConfigUpdateRequest {const MagicAppConfigUpdateRequest({this.accountAppId, this.breakout, this.managedAppId, this.preferredWans, this.priority, });
