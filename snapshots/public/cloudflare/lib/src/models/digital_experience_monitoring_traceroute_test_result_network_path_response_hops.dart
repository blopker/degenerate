...
import 'digital_experience_monitoring_traceroute_test_result_network_path_response_hops_location.dart';import 'digital_experience_monitoring_traceroute_test_result_network_path_response_hops_mile.dart';final class DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHops {const DigitalExperienceMonitoringTracerouteTestResultNetworkPathResponseHops({this.asn, this.aso, this.ipAddress, this.location, this.mile, this.name, this.packetLossPct, this.rttMs, required this.ttl, });
