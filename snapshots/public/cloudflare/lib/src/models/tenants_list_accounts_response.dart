...
TenantsListAccountsResponse copyWith({List<Map<String,String>>? errors, List<Message3>? messages, List<Account>? result, bool? success, }) { return TenantsListAccountsResponse(
