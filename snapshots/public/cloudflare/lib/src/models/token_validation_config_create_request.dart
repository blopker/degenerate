...
import 'package:collection/collection.dart';import 'shield_credentials.dart';import 'shield_token_sources2.dart';import 'shield_token_type.dart';final class TokenValidationConfigCreateRequest {const TokenValidationConfigCreateRequest({required this.credentials, required this.description, required this.title, required this.tokenSources, required this.tokenType, });
...
TokenValidationConfigCreateRequest copyWith({ShieldCredentials? credentials, String? description, String? title, List<ShieldTokenSources2>? tokenSources, ShieldTokenType? tokenType, }) { return TokenValidationConfigCreateRequest(
