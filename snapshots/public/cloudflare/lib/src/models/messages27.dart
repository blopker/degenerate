...
import 'package:collection/collection.dart';import 'messages27_functions.dart';import 'messages27_messages.dart';import 'messages27_response_format.dart';import 'messages27_tools.dart';final class Messages27 {const Messages27({this.frequencyPenalty, this.functions, this.maxTokens = 256, required this.messages, this.presencePenalty, this.raw = false, this.repetitionPenalty, this.responseFormat, this.seed, this.stream = false, this.temperature = 0.6, this.tools, this.topK, this.topP, });
...
factory Messages27.fromJson(Map<String, dynamic> json) { return Messages27(
  ...
  tools: (json['tools'] as List<dynamic>?)?.map((e) => Messages27Tools.fromJson(e)).toList(),
