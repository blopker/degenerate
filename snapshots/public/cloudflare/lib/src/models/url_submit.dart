...
factory UrlSubmit.fromJson(Map<String, dynamic> json) { return UrlSubmit(
  skippedUrls: (json['skipped_urls'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String))).toList(),
  submittedUrls: (json['submitted_urls'] as List<dynamic>?)?.map((e) => (e as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String))).toList(),
); }
...
UrlSubmit copyWith({List<Map<String, String>> Function()? skippedUrls, List<Map<String, String>> Function()? submittedUrls, }) { return UrlSubmit(
