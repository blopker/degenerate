...
import 'package:collection/collection.dart';import 'realtimekit_webhook_request_events.dart';final class RealtimekitWebhookRequest {const RealtimekitWebhookRequest({this.enabled = true, required this.events, required this.name, required this.url, });
