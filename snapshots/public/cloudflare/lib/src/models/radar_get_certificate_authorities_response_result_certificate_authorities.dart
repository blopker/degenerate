...
import 'radar_get_certificate_authorities_response_result_certificate_authorities_certificate_record_type.dart';import 'radar_get_certificate_authorities_response_result_certificate_authorities_revocation_status.dart';final class RadarGetCertificateAuthoritiesResponseResultCertificateAuthorities {const RadarGetCertificateAuthoritiesResponseResultCertificateAuthorities({required this.certificateRecordType, required this.country, required this.countryName, required this.name, required this.owner, required this.parentName, required this.parentSha256Fingerprint, required this.revocationStatus, required this.sha256Fingerprint, });
