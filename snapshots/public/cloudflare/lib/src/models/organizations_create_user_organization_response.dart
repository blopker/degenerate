...
import 'package:collection/collection.dart';import 'message3.dart';import 'organization.dart';final class OrganizationsCreateUserOrganizationResponse {const OrganizationsCreateUserOrganizationResponse({required this.errors, required this.messages, required this.result, required this.success, });
...
OrganizationsCreateUserOrganizationResponse copyWith({List<Map<String,Object?>>? errors, List<Message3>? messages, Organization? result, bool? success, }) { return OrganizationsCreateUserOrganizationResponse(
