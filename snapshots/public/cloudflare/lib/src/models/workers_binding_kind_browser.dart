...
final class WorkersBindingKindBrowser {const WorkersBindingKindBrowser({required this.name, required this.type, });
...
WorkersBindingKindBrowser copyWith({String? name, String? type, }) { return WorkersBindingKindBrowser(
  name: name ?? this.name,
  type: type ?? this.type,
); } 
