...
import 'package:collection/collection.dart';import 'hyperdrive_messages2.dart';final class ResponseCommon34 {const ResponseCommon34({required this.errors, required this.messages, required this.result, required this.success, });
...
ResponseCommon34 copyWith({List<HyperdriveMessages2>? errors, List<HyperdriveMessages2>? messages, Map<String,String>? result, bool? success, }) { return ResponseCommon34(
