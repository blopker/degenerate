...
factory AlexandriaApplication.fromJson(Map<String, dynamic> json) { return AlexandriaApplication(
  ...
  applicationTypeDescription: json['application_type_description'] as String,
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('application_source') && json['application_source'] is String &&
      json.containsKey('application_type') && json['application_type'] is String &&
      json.containsKey('application_type_description') && json['application_type_description'] is String &&
      json.containsKey('created_at') && json['created_at'] is String &&
      json.containsKey('hostnames') &&
      json.containsKey('human_id') && json['human_id'] is String &&
...
AlexandriaApplication copyWith({String? applicationSource, String? applicationType, String? applicationTypeDescription, String? createdAt, List<String>? hostnames, String? humanId, String? id, List<String>? ipSubnets, String? name, List<String>? portProtocols, List<String>? supportDomains, String? updatedAt, String? version, }) { return AlexandriaApplication(
