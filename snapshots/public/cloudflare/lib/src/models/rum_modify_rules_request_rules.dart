...
import 'package:collection/collection.dart';final class RumModifyRulesRequestRules {const RumModifyRulesRequestRules({this.host, this.id, this.inclusive, this.isPaused, this.paths, });
...
RumModifyRulesRequestRules copyWith({String Function()? host, String Function()? id, bool Function()? inclusive, bool Function()? isPaused, List<String> Function()? paths, }) { return RumModifyRulesRequestRules(
