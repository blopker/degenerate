...
factory ListsList.fromJson(Map<String, dynamic> json) { return ListsList(
  ...
  numReferencingFilters: (json['num_referencing_filters'] as num).toDouble(),
); }
...
static bool canParse(Map<String, dynamic> json) { return json.containsKey('created_on') && json['created_on'] is String &&
      ...
      json.containsKey('num_items') && json['num_items'] is num &&
      json.containsKey('num_referencing_filters') && json['num_referencing_filters'] is num; } 
ListsList copyWith({String? createdOn, String Function()? description, String? id, String? kind, String? modifiedOn, String? name, double? numItems, double? numReferencingFilters, }) { return ListsList(
