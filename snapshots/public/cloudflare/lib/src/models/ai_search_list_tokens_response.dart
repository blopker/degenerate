...
import 'package:collection/collection.dart';import 'ai_search_list_tokens_response_result.dart';final class AiSearchListTokensResponse {const AiSearchListTokensResponse({required this.result, required this.success, });
