...
import 'web3_description.dart';import 'web3_dnslink.dart';import 'web3_identifier.dart';import 'web3_name.dart';import 'web3_status.dart';import 'web3_target.dart';import 'web3_timestamp.dart';final class Web3Web3Hostname {const Web3Web3Hostname({this.createdOn, this.description, this.dnslink, this.id, this.modifiedOn, this.name, this.status, this.target, });
