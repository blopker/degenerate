...
import 'web3_status.dart';import 'web3_target.dart';final class Web3Web3Hostname {const Web3Web3Hostname({this.createdOn, this.description, this.dnslink, this.id, this.modifiedOn, this.name, this.status, this.target, });
...
Web3Web3Hostname copyWith({DateTime Function()? createdOn, String Function()? description, String Function()? dnslink, String Function()? id, DateTime Function()? modifiedOn, String Function()? name, Web3Status Function()? status, Web3Target Function()? target, }) { return Web3Web3Hostname(
