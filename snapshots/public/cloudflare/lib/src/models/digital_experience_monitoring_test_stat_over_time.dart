...
import 'package:collection/collection.dart';import 'digital_experience_monitoring_test_stat_over_time_slots.dart';final class DigitalExperienceMonitoringTestStatOverTime {const DigitalExperienceMonitoringTestStatOverTime({this.avg, this.max, this.min, required this.slots, });
