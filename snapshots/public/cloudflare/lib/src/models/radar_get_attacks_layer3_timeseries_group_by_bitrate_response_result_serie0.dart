...
import 'package:collection/collection.dart';final class RadarGetAttacksLayer3TimeseriesGroupByBitrateResponseResultSerie0 {const RadarGetAttacksLayer3TimeseriesGroupByBitrateResponseResultSerie0({required this.$1GbpsTo10Gbps, required this.$10GbpsTo100Gbps, required this.$500MbpsTo1Gbps, required this.over100Gbps, required this.under500Mbps, required this.timestamps, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarGetAttacksLayer3TimeseriesGroupByBitrateResponseResultSerie0 &&
          const ListEquality<dynamic>().equals($1GbpsTo10Gbps, other.$1GbpsTo10Gbps) &&
          const ListEquality<dynamic>().equals($10GbpsTo100Gbps, other.$10GbpsTo100Gbps) &&
          const ListEquality<dynamic>().equals($500MbpsTo1Gbps, other.$500MbpsTo1Gbps) &&
          const ListEquality<dynamic>().equals(over100Gbps, other.over100Gbps) &&
          const ListEquality<dynamic>().equals(under500Mbps, other.under500Mbps) &&
