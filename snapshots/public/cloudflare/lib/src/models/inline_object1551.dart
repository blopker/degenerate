...
factory InlineObject1551.fromJson(Map<String, dynamic> json) { return InlineObject1551(
  ...
  authenticate: json['authenticate'] != null ? InlineObject1551Authenticate.fromJson(json['authenticate'] as Map<String, dynamic>) : null,
  ...
  gotoOptions: json['gotoOptions'] != null ? InlineObject1551GotoOptions.fromJson(json['gotoOptions'] as Map<String, dynamic>) : null,
  ...
  screenshotOptions: json['screenshotOptions'] != null ? InlineObject1551ScreenshotOptions.fromJson(json['screenshotOptions'] as Map<String, dynamic>) : null,
  ...
  viewport: json['viewport'] != null ? InlineObject1551Viewport.fromJson(json['viewport'] as Map<String, dynamic>) : null,
  waitForSelector: json['waitForSelector'] != null ? InlineObject1551WaitForSelector.fromJson(json['waitForSelector'] as Map<String, dynamic>) : null,
