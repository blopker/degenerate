...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'r2_lifecycle_storage_transition_condition.dart';final class R2LifecycleStorageTransitionStorageClass {const R2LifecycleStorageTransitionStorageClass._(this.value);
...
factory R2LifecycleStorageTransition.fromJson(Map<String, dynamic> json) { return R2LifecycleStorageTransition(
  condition: OneOf2.parse(json['condition'], fromA: (v) => R2LifecycleAgeCondition.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && R2LifecycleAgeCondition.canParse(v), fromB: (v) => R2LifecycleDateCondition.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && R2LifecycleDateCondition.canParse(v),),
