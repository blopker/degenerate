...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is UrlscannerGetScanResponseResultScanPage &&
          ...
          ip == other.ip &&
          js == other.js &&
          const ListEquality<dynamic>().equals(securityViolations, other.securityViolations) &&
          status == other.status &&
