...
factory ZonesCacheKeyFieldsValueQueryString.fromJson(Map<String, dynamic> json) { return ZonesCacheKeyFieldsValueQueryString(
  exclude: json['exclude'] != null ? OneOf2.parse(json['exclude'], fromA: (v) => ZonesCacheKeyFieldsValueQueryStringExcludeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseB: (v) => v is List,) : null,
  include: json['include'] != null ? OneOf2.parse(json['include'], fromA: (v) => ZonesCacheKeyFieldsValueQueryStringIncludeVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseB: (v) => v is List,) : null,
); }
