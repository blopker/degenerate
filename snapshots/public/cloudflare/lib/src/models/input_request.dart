...
import 'package:collection/collection.dart';import 'input_request_locations.dart';import 'input_request_operating_system.dart';import 'teams_devices_extended_key_usage_enum.dart';final class InputRequest {const InputRequest({required this.certificateId, required this.checkPrivateKey, this.cn, this.extendedKeyUsage, this.locations, required this.operatingSystem, this.subjectAlternativeNames, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InputRequest &&
          ...
          cn == other.cn &&
          const ListEquality<dynamic>().equals(extendedKeyUsage, other.extendedKeyUsage) &&
          locations == other.locations &&
          operatingSystem == other.operatingSystem &&
          const ListEquality<dynamic>().equals(subjectAlternativeNames, other.subjectAlternativeNames); } 
