...
import 'package:collection/collection.dart';import 'access_meta.dart';final class AccessGroups {const AccessGroups({this.displayName, this.externalId, this.id, this.meta, this.schemas, });
...
AccessGroups copyWith({String Function()? displayName, String Function()? externalId, String Function()? id, AccessMeta Function()? meta, List<String> Function()? schemas, }) { return AccessGroups(
