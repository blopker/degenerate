...
factory BrapiPostScrapeRequestVariant1Cookies.fromJson(Map<String, dynamic> json) { return BrapiPostScrapeRequestVariant1Cookies(
  ...
  priority: json['priority'] != null ? BrapiPostScrapeRequestVariant1CookiesPriority.fromJson(json['priority'] as Map<String, dynamic>) : null,
  sameParty: json['sameParty'] as bool?,
  sameSite: json['sameSite'] != null ? BrapiPostScrapeRequestVariant1CookiesSameSite.fromJson(json['sameSite'] as Map<String, dynamic>) : null,
  secure: json['secure'] as bool?,
  sourcePort: json['sourcePort'] != null ? (json['sourcePort'] as num).toDouble() : null,
  sourceScheme: json['sourceScheme'] != null ? BrapiPostScrapeRequestVariant1CookiesSourceScheme.fromJson(json['sourceScheme'] as Map<String, dynamic>) : null,
