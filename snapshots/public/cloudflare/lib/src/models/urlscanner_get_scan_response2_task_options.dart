...
UrlscannerGetScanResponse2TaskOptions copyWith({Map<String, String> Function()? customHeaders, List<String> Function()? screenshotsResolutions, }) { return UrlscannerGetScanResponse2TaskOptions(
