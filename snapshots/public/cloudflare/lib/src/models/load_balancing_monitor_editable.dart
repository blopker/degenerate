...
factory LoadBalancingMonitorEditable.fromJson(Map<String, dynamic> json) { return LoadBalancingMonitorEditable(
  ...
  consecutiveDown: json['consecutive_down'] != null ? (json['consecutive_down'] as num).toInt() : null,
  consecutiveUp: json['consecutive_up'] != null ? (json['consecutive_up'] as num).toInt() : null,
...
LoadBalancingMonitorEditable copyWith({bool Function()? allowInsecure, int Function()? consecutiveDown, int Function()? consecutiveUp, String Function()? description, String Function()? expectedBody, String Function()? expectedCodes, bool Function()? followRedirects, Map<String, List<String>> Function()? header, int Function()? interval, String Function()? method, String Function()? path, int? Function()? port, String Function()? probeZone, int Function()? retries, int Function()? timeout, LoadBalancingType Function()? type, }) { return LoadBalancingMonitorEditable(
