...
import 'messages30_messages_content.dart';final class Messages30Messages {const Messages30Messages({this.content, this.role, this.toolCallId, });

factory Messages30Messages.fromJson(Map<String, dynamic> json) { return Messages30Messages(
  content: json['content'] != null ? Messages30MessagesContent.fromJson(json['content']) : null,
