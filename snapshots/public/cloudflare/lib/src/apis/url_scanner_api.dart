...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/urlscanner_create_scan_bulk_request.dart';import '../models/urlscanner_create_scan_bulk_response.dart';import '../models/urlscanner_create_scan_request2.dart';import '../models/urlscanner_create_scan_response2.dart';import '../models/urlscanner_get_scan_har_response2.dart';import '../models/urlscanner_get_scan_response2.dart';import '../models/urlscanner_get_scan_screenshot_resolution2.dart';import '../models/urlscanner_search_scans_response2.dart';/// UrlScannerApi operations.
///
...
Future<ApiResult<List<UrlscannerCreateScanBulkResponse>>> urlscannerCreateScanBulkV2({required String accountId, List<UrlscannerCreateScanBulkRequest>? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> urlscannerGetScanDomV2({required String scanId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<UrlscannerGetScanHarResponse2>> urlscannerGetScanHarV2({required String scanId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void>> urlscannerGetResponseV2({required String responseId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<UrlscannerGetScanResponse2>> urlscannerGetScanV2({required String scanId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<UrlscannerCreateScanResponse2>> urlscannerCreateScanV2({required String accountId, UrlscannerCreateScanRequest2? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<void>> urlscannerGetScanScreenshotV2({required String scanId, required String accountId, UrlscannerGetScanScreenshotResolution2? resolution, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<UrlscannerSearchScansResponse2>> urlscannerSearchScansV2({required String accountId, int? size, String? q, }) async  { final request = ApiRequest(
  method: 'GET',
