...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/digital_experience_monitoring_account_identifier.dart';import '../models/digital_experience_monitoring_command_id.dart';import '../models/get_commands_status.dart';import '../models/post_commands_request.dart';import '../models/response_common19.dart';/// DexRemoteCommandsApi operations.
///
...
Future<ApiResult<void, Never>> getCommandsCommandIdDownloadsFilename({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringCommandId commandId, required String filename, }) async  { final request = ApiRequest(
  method: 'GET',
