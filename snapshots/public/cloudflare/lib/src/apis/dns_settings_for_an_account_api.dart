...
final class DnsSettingsForAnAccountApi {const DnsSettingsForAnAccountApi(this._config);
...
Future<ApiResult<ResponseCommon26, Never>> dnsSettingsForAnAccountListDnsSettings({required DnsSettingsIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<ResponseCommon26, Never>> dnsSettingsForAnAccountUpdateDnsSettings({required DnsSettingsIdentifier accountId, required DnsSettingsAccountSettingsPatch body, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
