...
Future<ApiResult<List<BotManagementFeedbackReport>, Never>> botManagementZoneFeedbackList({required String zoneId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void, Never>> botManagementZoneFeedbackCreate({required String zoneId, required BotManagementFeedbackReport body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/zones/${Uri.encodeComponent(zoneId)}/bot_management/feedback',
  headers: {..._config.defaultHeaders
