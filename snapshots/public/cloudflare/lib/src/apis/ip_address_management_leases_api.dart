...
final class IpAddressManagementLeasesApi {const IpAddressManagementLeasesApi(this._config);
...
Future<ApiResult<ResponseCommon4, Never>> ipAddressManagementListLeases({required AddressingSchemasAccountIdentifier accountId, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
