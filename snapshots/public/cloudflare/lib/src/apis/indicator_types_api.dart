...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/get_indicator_types_list_response.dart';import '../models/get_indicator_types_list_response400.dart';/// IndicatorTypesApi operations.
///
...
Future<ApiResult<GetIndicatorTypesListResponse, GetIndicatorTypesListResponse400>> getIndicatorTypesList({required String accountId, List<String>? datasetIds, }) async  { final request = ApiRequest(
  method: 'GET',
