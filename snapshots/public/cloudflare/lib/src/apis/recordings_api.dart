...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/get_all_recordings_sort_by.dart';import '../models/get_all_recordings_sort_order.dart';import '../models/get_all_recordings_status.dart';import '../models/pause_resume_stop_recording_request.dart';import '../models/realtimekit_generic_error_response.dart';import '../models/realtimekit_generic_success_response.dart';import '../models/realtimekit_paging_response.dart';import '../models/start_recording_request.dart';import '../models/start_track_recording_for_a_meeting_request.dart';/// RecordingsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class RecordingsApi {const RecordingsApi(this._config);
...
Future<ApiResult<RealtimekitGenericSuccessResponse, Never>> startRecording({required String accountId, required String appId, required StartRecordingRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<RealtimekitGenericSuccessResponse, Never>> getOneRecording({required String accountId, required String appId, required String recordingId, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings/${Uri.encodeComponent(recordingId)}',
  headers: {..._config.defaultHeaders
  },
);
...
Future<ApiResult<RealtimekitGenericSuccessResponse, Never>> pauseResumeStopRecording({required String accountId, required String appId, required String recordingId, required PauseResumeStopRecordingRequest body, }) async  { final request = ApiRequest(
  method: 'PUT',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings/${Uri.encodeComponent(recordingId)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<RealtimekitGenericSuccessResponse, RealtimekitGenericErrorResponse>> getActiveRecording({required String accountId, required String appId, required String meetingId, }) async  { final request = ApiRequest(
  method: 'GET',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings/active-recording/${Uri.encodeComponent(meetingId)}',
  headers: {..._config.defaultHeaders
  },
);
...
Future<ApiResult<void, Never>> startTrackRecordingForAMeeting({required String accountId, required String appId, required StartTrackRecordingForAMeetingRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/realtime/kit/${Uri.encodeComponent(appId)}/recordings/track',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
  },
  body: jsonEncode(body.toJson()),
