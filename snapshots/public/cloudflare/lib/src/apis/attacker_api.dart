...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/get_attacker_list_response.dart';import '../models/get_attacker_list_response400.dart';/// AttackerApi operations.
///
...
return _execute(
  ...
  onError: (response) {
    try { return GetAttackerListResponse400.fromJson(jsonDecode(response.body) as Map<String, dynamic>); } catch (_) { return null; }
  },
);
 } 
