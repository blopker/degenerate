...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/mcn_account_id.dart';import '../models/mcn_resource_id.dart';import '../models/mcn_resource_type.dart';import '../models/mcn_resources_catalog_policy_preview_request.dart';import '../models/mcn_response.dart';import '../models/mcn_response_collection.dart';/// ResourcesApi operations.
///
...
Future<ApiResult<void, McnResponse>> resourcesCatalogExport({required McnAccountId accountId, String? providerId, List<McnResourceType>? resourceType, List<McnResourceId>? resourceId, String? region, String? resourceGroup, List<String>? search, String? orderBy, bool? desc, bool? v2, }) async  { final request = ApiRequest(
  method: 'GET',
