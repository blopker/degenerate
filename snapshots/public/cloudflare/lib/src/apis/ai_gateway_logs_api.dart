...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/aig_config_delete_gateway_logs_filters.dart';import '../models/aig_config_delete_gateway_logs_order_by.dart';import '../models/aig_config_delete_gateway_logs_order_by_direction.dart';import '../models/aig_config_delete_gateway_logs_response.dart';import '../models/aig_config_get_gateway_log_detail_response.dart';import '../models/aig_config_list_gateway_logs_direction.dart';import '../models/aig_config_list_gateway_logs_feedback.dart';import '../models/aig_config_list_gateway_logs_filters.dart';import '../models/aig_config_list_gateway_logs_order_by.dart';import '../models/aig_config_list_gateway_logs_order_by_direction.dart';import '../models/aig_config_list_gateway_logs_response.dart';import '../models/aig_config_patch_gateway_log_request.dart';import '../models/aig_config_patch_gateway_log_response.dart';/// AiGatewayLogsApi operations.
///
/// All operations return [ApiResult] — use pattern matching to handle
/// success, error, and exception cases.
final class AiGatewayLogsApi {const AiGatewayLogsApi(this._config);
...
Future<ApiResult<AigConfigDeleteGatewayLogsResponse>> aigConfigDeleteGatewayLogs({required String accountId, required String gatewayId, AigConfigDeleteGatewayLogsOrderBy? orderBy, AigConfigDeleteGatewayLogsOrderByDirection? orderByDirection, List<AigConfigDeleteGatewayLogsFilters>? filters, int? limit, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai-gateway/gateways/${Uri.encodeComponent(gatewayId)}/logs',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<AigConfigGetGatewayLogDetailResponse>> aigConfigGetGatewayLogDetail({required String id, required String gatewayId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<AigConfigPatchGatewayLogResponse>> aigConfigPatchGatewayLog({required String id, required String gatewayId, required String accountId, AigConfigPatchGatewayLogRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai-gateway/gateways/${Uri.encodeComponent(gatewayId)}/logs/${Uri.encodeComponent(id)}',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<Map<String, String>>> aigConfigGetGatewayLogRequest({required String id, required String gatewayId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> aigConfigGetGatewayLogResponse({required String id, required String gatewayId, required String accountId, }) async  { final request = ApiRequest(
  method: 'GET',
