...
Future<ApiResult<AbuseReportsSubmitReportResponse, AbuseReportsSubmitErrorResponse>> submitAbuseReport({required String accountId, required String reportParam, required AbuseReportsSubmitReportRequest body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/abuse-reports/${Uri.encodeComponent(reportParam)}',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
