...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/mcn_account_id.dart';import '../models/mcn_create_onramp_request.dart';import '../models/mcn_onramp_id.dart';import '../models/mcn_response.dart';import '../models/mcn_update_magic_wan_address_space_request.dart';import '../models/mcn_update_onramp_request.dart';/// OnRampsApi operations.
///
...
Future<ApiResult<void, McnResponse>> onrampsExport({required McnAccountId accountId, required McnOnrampId onrampId, }) async  { final request = ApiRequest(
  method: 'POST',
