...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/delete_indicator_delete_response.dart';import '../models/get_indicator_list_format.dart';import '../models/get_indicator_list_legacy_response.dart';import '../models/get_indicator_list_response.dart';import '../models/get_indicator_read_response.dart';import '../models/patch_indicator_update_request.dart';import '../models/patch_indicator_update_response.dart';import '../models/post_indicator_create_bulk_request.dart';import '../models/post_indicator_create_request.dart';import '../models/post_indicator_create_response.dart';/// IndicatorApi operations.
///
...
Future<ApiResult<GetIndicatorListLegacyResponse>> getIndicatorListLegacy({required String accountId, required String datasetId, double? page, double? pageSize, String? search, String? indicatorType, List<String>? relatedEvent, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetIndicatorReadResponse>> getIndicatorRead({required String accountId, required String datasetId, required String indicatorId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<PatchIndicatorUpdateResponse>> patchIndicatorUpdate({required String accountId, required String datasetId, required String indicatorId, PatchIndicatorUpdateRequest? body, }) async  { final request = ApiRequest(
  method: 'PATCH',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/${Uri.encodeComponent(datasetId)}/indicators/${Uri.encodeComponent(indicatorId)}',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<DeleteIndicatorDeleteResponse>> deleteIndicatorDelete({required String accountId, required String datasetId, required String indicatorId, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/accounts/${Uri.encodeComponent(accountId)}/cloudforce-one/events/dataset/${Uri.encodeComponent(datasetId)}/indicators/${Uri.encodeComponent(indicatorId)}',
  headers: {..._config.defaultHeaders
  },
...
Future<ApiResult<double>> postIndicatorCreateBulk({required String accountId, required String datasetId, PostIndicatorCreateBulkRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<PostIndicatorCreateResponse>> postIndicatorCreate({required String accountId, required String datasetId, PostIndicatorCreateRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<List<Map<String, String>>>> getIndicatorTagsList({required String accountId, required String datasetId, }) async  { final request = ApiRequest(
  method: 'GET',
