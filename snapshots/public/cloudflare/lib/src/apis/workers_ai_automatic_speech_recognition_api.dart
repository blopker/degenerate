...
import 'dart:convert';import 'dart:typed_data';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/turbo_request.dart';import '../models/workers_ai_post_run_cf_deepgram_flux_request.dart';import '../models/workers_ai_post_run_cf_deepgram_nova3_request.dart';/// WorkersAiAutomaticSpeechRecognitionApi operations.
///
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramFlux({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfDeepgramFlux({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfDeepgramFluxRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/deepgram/flux',
  headers: {..._config.defaultHeaders
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramNova3({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfDeepgramNova3({required String accountId, String? queueRequest, String? tags, WorkersAiPostRunCfDeepgramNova3Request? body, }) async  { final request = ApiRequest(
  method: 'POST',
  path: '/accounts/${Uri.encodeComponent(accountId)}/ai/run/@cf/deepgram/nova-3',
  headers: {..._config.defaultHeaders
    , 'Content-Type': 'application/json'
...
Future<ApiResult<void>> workersAiPostWebsocketRunCfDeepgramNova3Internal({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfOpenaiWhisper({required String accountId, String? queueRequest, String? tags, Uint8List? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfOpenaiWhisperLargeV3Turbo({required String accountId, String? queueRequest, String? tags, TurboRequest? body, }) async  { final request = ApiRequest(
  method: 'POST',
...
Future<ApiResult<Map<String, String>>> workersAiPostRunCfOpenaiWhisperTinyEn({required String accountId, String? queueRequest, String? tags, Uint8List? body, }) async  { final request = ApiRequest(
  method: 'POST',
