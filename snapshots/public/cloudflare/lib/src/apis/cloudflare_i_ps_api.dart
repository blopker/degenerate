...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/response_common52.dart';/// CloudflareIPsApi operations.
///
...
///
/// `GET /ips`
Future<ApiResult<ResponseCommon52, Never>> cloudflareIpsCloudflareIpDetails({String? networks, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
