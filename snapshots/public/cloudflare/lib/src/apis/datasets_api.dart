...
import 'dart:convert';import '../client/api_client.dart';import '../client/api_config.dart';import '../client/api_result.dart';import '../models/post_dataset_populate_response.dart';import '../models/post_dataset_populate_response400.dart';/// DatasetsApi operations.
///
...
return _execute(
  ...
  onError: (response) {
    try { return PostDatasetPopulateResponse400.fromJson(jsonDecode(response.body) as Map<String, dynamic>); } catch (_) { return null; }
  },
);
 } 
