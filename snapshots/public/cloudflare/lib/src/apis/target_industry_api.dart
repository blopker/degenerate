...
Future<ApiResult<GetTargetIndustryListByDatasetResponse>> getTargetIndustryListByDataset({required String accountId, required String datasetId, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetTargetIndustryListResponse>> getTargetIndustryList({required String accountId, List<String>? datasetIds, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<GetTargetIndustryListCompleteResponse>> getTargetIndustryListComplete({required String accountId}) async  { final request = ApiRequest(
  method: 'GET',
