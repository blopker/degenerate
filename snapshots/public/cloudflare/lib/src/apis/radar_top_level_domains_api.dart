...
///
/// `GET /radar/tlds`
Future<ApiResult<RadarGetTldsResponse, RadarGetTldsResponse400>> radarGetTlds({int? limit, int? offset, String? tldManager, RadarGetTldsTldType? tldType, String? tld, RadarGetTldsFormat? format, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
...
///
/// `GET /radar/tlds/{tld}`
Future<ApiResult<RadarGetTldDetailsResponse, RadarGetTldDetailsResponse404>> radarGetTldDetails({required String tld, RadarGetTldDetailsFormat? format, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (format != null) queryParameters['format'] = format.toJson();
