...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsListColos({required DigitalExperienceMonitoringAccountIdentifier accountId, required String from, required String to, DexEndpointsListColosSortBy? sortBy, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
...
Future<ApiResult<ResponseCommon19, Never>> dexFleetStatusLive({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringSinceMinutes sinceMinutes, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
queryParameters['since_minutes'] = sinceMinutes.toString();
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsHttpTestPercentiles({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid testId, List<String>? deviceId, required String from, required String to, String? colo, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (deviceId != null) {
for (final item in deviceId) {
  queryParametersList.add(ApiQueryParameter(name: 'deviceId', value: item, allowReserved: false));
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsListTestsOverview({required DigitalExperienceMonitoringAccountIdentifier accountId, String? colo, String? testName, List<String>? deviceId, double? page, double? perPage, DexEndpointsListTestsOverviewKind? kind, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (colo != null) queryParameters['colo'] = colo;
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsTestsUniqueDevices({required DigitalExperienceMonitoringAccountIdentifier accountId, String? testName, List<String>? deviceId, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (testName != null) queryParameters['testName'] = testName;
if (deviceId != null) {
for (final item in deviceId) {
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsTracerouteTestResultNetworkPath({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid testResultId, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsTracerouteTestDetails({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid testId, List<String>? deviceId, required String from, required String to, required DexEndpointsTracerouteTestDetailsInterval interval, String? colo, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
if (deviceId != null) {
for (final item in deviceId) {
  queryParametersList.add(ApiQueryParameter(name: 'deviceId', value: item, allowReserved: false));
...
Future<ApiResult<ResponseCommon19, Never>> dexEndpointsTracerouteTestNetworkPath({required DigitalExperienceMonitoringAccountIdentifier accountId, required DigitalExperienceMonitoringUuid testId, required String deviceId, required String from, required String to, required DexEndpointsTracerouteTestNetworkPathInterval interval, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
final queryParametersList = <ApiQueryParameter>[];
