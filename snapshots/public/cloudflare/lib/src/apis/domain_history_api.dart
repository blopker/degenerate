...
final class DomainHistoryApi {const DomainHistoryApi(this._config);
...
Future<ApiResult<ResponseCommon39, Never>> domainHistoryGetDomainHistory({required IntelIdentifier accountId, String? domain, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
