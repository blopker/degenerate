...
import '../apis/mcp_portal_servers_api.dart';
import '../apis/access_applications_api.dart';
import '../apis/access_short_lived_certificate_c_as_api.dart';
import '../apis/access_application_scoped_policies_api.dart';
import '../apis/access_m_tls_authentication_api.dart';
import '../apis/access_custom_pages_api.dart';
import '../apis/gateway_ca_api.dart';
import '../apis/access_groups_api.dart';
import '../apis/access_identity_providers_api.dart';
import '../apis/access_key_configuration_api.dart';
import '../apis/access_authentication_logs_api.dart';
import '../apis/access_scim_update_logs_api.dart';
import '../apis/zero_trust_organization_api.dart';
import '../apis/access_reusable_policies_api.dart';
import '../apis/access_policy_tester_api.dart';
import '../apis/zero_trust_seats_api.dart';
import '../apis/access_service_tokens_api.dart';
import '../apis/access_tags_api.dart';
import '../apis/zero_trust_users_api.dart';
import '../apis/ip_address_management_address_maps_api.dart';
import '../apis/ip_address_management_leases_api.dart';
import '../apis/ip_address_management_prefixes_api.dart';
import '../apis/ip_address_management_bgp_prefixes_api.dart';
import '../apis/ip_address_management_service_bindings_api.dart';
import '../apis/ip_address_management_prefix_delegation_api.dart';
import '../apis/dls_regional_services_api.dart';
import '../apis/ai_gateway_evaluations_api.dart';
import '../apis/ai_gateway_gateways_api.dart';
import '../apis/ai_gateway_datasets_api.dart';
import '../apis/ai_gateway_logs_api.dart';
import '../apis/ai_gateway_provider_configs_api.dart';
import '../apis/ai_gateway_dynamic_routes_api.dart';
import '../apis/ai_search_instances_api.dart';
import '../apis/ai_search_instances_jobs_api.dart';
import '../apis/ai_search_tokens_api.dart';
import '../apis/workers_ai_api.dart';
import '../apis/workers_ai_finetune_api.dart';
import '../apis/workers_ai_translation_api.dart';
import '../apis/workers_ai_text_generation_api.dart';
import '../apis/workers_ai_text_embeddings_api.dart';
import '../apis/workers_ai_text_classification_api.dart';
import '../apis/workers_ai_text_to_image_api.dart';
import '../apis/workers_ai_text_to_speech_api.dart';
import '../apis/workers_ai_automatic_speech_recognition_api.dart';
import '../apis/workers_ai_summarization_api.dart';
import '../apis/workers_ai_object_detection_api.dart';
import '../apis/workers_ai_image_classification_api.dart';
import '../apis/workers_ai_dumb_pipe_api.dart';
import '../apis/notification_alert_types_api.dart';
import '../apis/notification_mechanism_eligibility_api.dart';
import '../apis/notification_destinations_with_pager_duty_api.dart';
import '../apis/notification_webhooks_api.dart';
import '../apis/notification_history_api.dart';
import '../apis/notification_policies_api.dart';
import '../apis/notification_silences_api.dart';
import '../apis/audit_logs_api.dart';
import '../apis/auto_rag_rag_search_api.dart';
import '../apis/auto_rag_rag_api.dart';
import '../apis/auto_rag_jobs_api.dart';
import '../apis/billable_usage_api.dart';
import '../apis/botnet_threat_feed_api.dart';
import '../apis/brand_protection_api.dart';
import '../apis/logo_match_api.dart';
import '../apis/domain_search_api.dart';
import '../apis/brapi_api.dart';
import '../apis/account_api.dart';
import '../apis/builds_api.dart';
import '../apis/git_hub_integration_api.dart';
import '../apis/repository_connections_api.dart';
import '../apis/build_tokens_api.dart';
import '../apis/triggers_api.dart';
import '../apis/environment_variables_api.dart';
import '../apis/workers_api.dart';
import '../apis/calls_apps_api.dart';
import '../apis/calls_turn_keys_api.dart';
import '../apis/cloudflare_tunnel_api.dart';
import '../apis/cloudflare_tunnel_configuration_api.dart';
import '../apis/turnstile_api.dart';
import '../apis/bin_db_api.dart';
import '../apis/event_api.dart';
import '../apis/attacker_api.dart';
import '../apis/category_api.dart';
import '../apis/country_api.dart';
import '../apis/dataset_api.dart';
import '../apis/groups_api.dart';
import '../apis/indicators_api.dart';
import '../apis/indicator_api.dart';
import '../apis/permissions_api.dart';
import '../apis/tag_api.dart';
import '../apis/target_industry_api.dart';
import '../apis/datasets_api.dart';
import '../apis/indicator_types_api.dart';
import '../apis/tag_category_api.dart';
import '../apis/request_for_information_rfi_api.dart';
import '../apis/priority_intelligence_requirements_pir_api.dart';
import '../apis/scans_api.dart';
import '../apis/cn_is_api.dart';
import '../apis/interconnects_api.dart';
import '../apis/settings_api.dart';
import '../apis/slots_api.dart';
import '../apis/connectivity_services_api.dart';
import '../apis/containers_api.dart';
import '../apis/image_registries_api.dart';
import '../apis/account_level_custom_nameservers_api.dart';
import '../apis/d1_api.dart';
import '../apis/devices_api.dart';
import '../apis/other_api.dart';
import '../apis/device_managed_networks_api.dart';
import '../apis/physical_devices_api.dart';
import '../apis/device_posture_rules_api.dart';
import '../apis/device_posture_integrations_api.dart';
import '../apis/registrations_api.dart';
import '../apis/devices_resilience_api.dart';
import '../apis/zero_trust_accounts_api.dart';
import '../apis/dex_synthetic_application_monitoring_api.dart';
import '../apis/dex_remote_commands_api.dart';
import '../apis/device_dex_tests_api.dart';
import '../apis/dex_rules_api.dart';
import '../apis/warp_change_events_api.dart';
import '../apis/endpoint_health_checks_api.dart';
import '../apis/diagnostics_api.dart';
import '../apis/dlp_datasets_api.dart';
import '../apis/dlp_document_fingerprints_api.dart';
import '../apis/dlp_email_api.dart';
import '../apis/dlp_entries_api.dart';
import '../apis/dlp_integration_entries_api.dart';
import '../apis/dlp_predefined_entries_api.dart';
import '../apis/dlp_settings_api.dart';
import '../apis/dlp_profiles_api.dart';
import '../apis/dns_firewall_api.dart';
import '../apis/dns_firewall_analytics_api.dart';
import '../apis/dns_records_for_an_account_api.dart';
import '../apis/dns_settings_for_an_account_api.dart';
import '../apis/dns_internal_views_for_an_account_api.dart';
import '../apis/email_security_api.dart';
import '../apis/email_security_settings_api.dart';
import '../apis/email_routing_destination_addresses_api.dart';
import '../apis/r2_bucket_api.dart';
import '../apis/queue_api.dart';
import '../apis/ip_access_rules_for_an_account_api.dart';
import '../apis/zero_trust_gateway_application_and_application_type_mappings_api.dart';
import '../apis/zero_trust_applications_review_status_api.dart';
import '../apis/zero_trust_ssh_settings_api.dart';
import '../apis/zero_trust_gateway_categories_api.dart';
import '../apis/zero_trust_certificates_api.dart';
import '../apis/zero_trust_lists_api.dart';
import '../apis/zero_trust_gateway_locations_api.dart';
import '../apis/zero_trust_gateway_pac_files_api.dart';
import '../apis/zero_trust_gateway_proxy_endpoints_api.dart';
import '../apis/zero_trust_gateway_rules_api.dart';
import '../apis/hyperdrive_api.dart';
import '../apis/account_permission_groups_api.dart';
import '../apis/account_resource_groups_api.dart';
import '../apis/account_user_groups_api.dart';
import '../apis/cloudflare_images_api.dart';
import '../apis/cloudflare_images_keys_api.dart';
import '../apis/cloudflare_images_variants_api.dart';
import '../apis/infrastructure_access_targets_api.dart';
import '../apis/asn_intelligence_api.dart';
import '../apis/security_center_insights_api.dart';
import '../apis/passive_dns_by_ip_api.dart';
import '../apis/domain_intelligence_api.dart';
import '../apis/domain_history_api.dart';
import '../apis/custom_indicator_feeds_api.dart';
import '../apis/ip_intelligence_api.dart';
import '../apis/ip_list_api.dart';
import '../apis/miscategorization_api.dart';
import '../apis/sinkhole_config_api.dart';
import '../apis/whois_record_api.dart';
import '../apis/account_load_balancer_monitor_groups_api.dart';
import '../apis/account_load_balancer_monitors_api.dart';
import '../apis/account_load_balancer_pools_api.dart';
import '../apis/load_balancer_regions_api.dart';
import '../apis/account_load_balancer_search_api.dart';
import '../apis/logpush_jobs_for_an_account_api.dart';
import '../apis/logcontrol_cmb_config_for_an_account_api.dart';
import '../apis/magic_account_apps_api.dart';
import '../apis/magic_interconnects_api.dart';
import '../apis/catalog_sync_api.dart';
import '../apis/on_ramps_api.dart';
import '../apis/cloud_integrations_api.dart';
import '../apis/resources_api.dart';
import '../apis/magic_connectors_api.dart';
import '../apis/magic_gre_tunnels_api.dart';
import '../apis/magic_i_psec_tunnels_api.dart';
import '../apis/magic_static_routes_api.dart';
import '../apis/magic_sites_api.dart';
import '../apis/magic_site_ac_ls_api.dart';
import '../apis/magic_site_app_configs_api.dart';
import '../apis/magic_site_la_ns_api.dart';
import '../apis/magic_site_net_flow_config_api.dart';
import '../apis/magic_site_wa_ns_api.dart';
import '../apis/account_members_api.dart';
import '../apis/magic_network_monitoring_configuration_api.dart';
import '../apis/magic_network_monitoring_rules_api.dart';
import '../apis/magic_network_monitoring_vpc_flow_logs_api.dart';
import '../apis/m_tls_certificate_management_api.dart';
import '../apis/pages_project_api.dart';
import '../apis/pages_deployment_api.dart';
import '../apis/pages_domains_api.dart';
import '../apis/pages_build_cache_api.dart';
import '../apis/ppc_stripe_api.dart';
import '../apis/ppc_config_api.dart';
import '../apis/magic_pcap_collection_api.dart';
import '../apis/workers_pipelines_other_api.dart';
import '../apis/r2_catalog_management_api.dart';
import '../apis/credential_management_api.dart';
import '../apis/maintenance_configuration_api.dart';
import '../apis/namespace_management_api.dart';
import '../apis/table_management_api.dart';
import '../apis/table_maintenance_configuration_api.dart';
import '../apis/r2_account_api.dart';
import '../apis/analytics_api.dart';
import '../apis/live_streams_api.dart';
import '../apis/meetings_api.dart';
import '../apis/active_session_api.dart';
import '../apis/presets_api.dart';
import '../apis/recordings_api.dart';
import '../apis/sessions_api.dart';
import '../apis/webhooks_api.dart';
import '../apis/apps_api.dart';
import '../apis/registrar_domains_api.dart';
import '../apis/account_request_tracer_api.dart';
import '../apis/account_roles_api.dart';
import '../apis/lists_api.dart';
import '../apis/account_rulesets_api.dart';
import '../apis/web_analytics_api.dart';
import '../apis/secondary_dns_acl_api.dart';
import '../apis/secondary_dns_peer_api.dart';
import '../apis/secondary_dns_tsig_api.dart';
import '../apis/secrets_store_api.dart';
import '../apis/resource_sharing_api.dart';
import '../apis/r2_super_slurper_api.dart';
import '../apis/sso_api.dart';
import '../apis/workers_kv_namespace_api.dart';
import '../apis/stream_videos_api.dart';
import '../apis/stream_audio_tracks_api.dart';
import '../apis/stream_subtitles_captions_api.dart';
import '../apis/stream_mp4_downloads_api.dart';
import '../apis/stream_video_clipping_api.dart';
import '../apis/stream_signing_keys_api.dart';
import '../apis/stream_live_inputs_api.dart';
import '../apis/stream_watermark_profile_api.dart';
import '../apis/stream_webhook_api.dart';
import '../apis/account_subscriptions_api.dart';
import '../apis/resource_tagging_api.dart';
import '../apis/tunnel_routing_api.dart';
import '../apis/tunnel_virtual_network_api.dart';
import '../apis/tokens_api.dart';
import '../apis/url_scanner_api.dart';
import '../apis/vectorize_api.dart';
import '../apis/waiting_room_api.dart';
import '../apis/worker_account_settings_api.dart';
import '../apis/worker_script_api.dart';
import '../apis/workers_for_platforms_api.dart';
import '../apis/worker_domain_api.dart';
import '../apis/durable_objects_namespace_api.dart';
import '../apis/destinations_api.dart';
import '../apis/keys_api.dart';
import '../apis/query_run_api.dart';
import '../apis/values_api.dart';
import '../apis/worker_placement_api.dart';
import '../apis/worker_deployments_api.dart';
import '../apis/worker_cron_trigger_api.dart';
import '../apis/worker_tail_logs_api.dart';
import '../apis/worker_versions_api.dart';
import '../apis/worker_environment_api.dart';
import '../apis/worker_subdomain_api.dart';
import '../apis/versions_api.dart';
import '../apis/workflows_api.dart';
import '../apis/zero_trust_connectivity_settings_api.dart';
import '../apis/zero_trust_hostname_route_api.dart';
import '../apis/zero_trust_subnets_api.dart';
import '../apis/zero_trust_risk_scoring_api.dart';
import '../apis/zero_trust_risk_scoring_integrations_api.dart';
import '../apis/custom_pages_for_an_account_api.dart';
import '../apis/applications_api.dart';
import '../apis/origin_ca_api.dart';
import '../apis/cloudflare_i_ps_api.dart';
import '../apis/user_s_account_memberships_api.dart';
import '../apis/organizations_api.dart';
import '../apis/organization_members_api.dart';
import '../apis/radar_ai_bots_api.dart';
import '../apis/radar_ai_inference_api.dart';
import '../apis/radar_annotations_api.dart';
import '../apis/radar_as112_api.dart';
import '../apis/radar_layer3_attacks_api.dart';
import '../apis/radar_layer7_attacks_api.dart';
import '../apis/radar_bgp_api.dart';
import '../apis/radar_bots_api.dart';
import '../apis/radar_web_crawlers_api.dart';
import '../apis/radar_certificate_transparency_api.dart';
import '../apis/radar_datasets_api.dart';
import '../apis/radar_dns_api.dart';
import '../apis/radar_email_routing_api.dart';
import '../apis/radar_email_security_api.dart';
import '../apis/radar_autonomous_systems_api.dart';
import '../apis/radar_ip_api.dart';
import '../apis/radar_locations_api.dart';
import '../apis/radar_geolocations_api.dart';
import '../apis/radar_http_api.dart';
import '../apis/radar_leaked_credential_checks_api.dart';
import '../apis/radar_net_flows_api.dart';
import '../apis/radar_origins_api.dart';
import '../apis/radar_post_quantum_api.dart';
import '../apis/radar_quality_api.dart';
import '../apis/radar_domains_ranking_api.dart';
import '../apis/radar_internet_services_ranking_api.dart';
import '../apis/radar_robots_txt_api.dart';
import '../apis/radar_search_api.dart';
import '../apis/radar_tcp_resets_and_timeouts_api.dart';
import '../apis/radar_top_level_domains_api.dart';
import '../apis/radar_traffic_anomalies_api.dart';
import '../apis/tenants_api.dart';
import '../apis/user_api.dart';
import '../apis/ip_access_rules_for_a_user_api.dart';
import '../apis/user_s_invites_api.dart';
import '../apis/load_balancer_monitors_api.dart';
import '../apis/load_balancer_pools_api.dart';
import '../apis/load_balancer_healthcheck_events_api.dart';
import '../apis/user_subscription_api.dart';
import '../apis/zone_api.dart';
import '../apis/zone_level_access_applications_api.dart';
import '../apis/zone_level_access_short_lived_certificate_c_as_api.dart';
import '../apis/zone_level_access_policies_api.dart';
import '../apis/zone_level_access_m_tls_authentication_api.dart';
import '../apis/zone_level_access_groups_api.dart';
import '../apis/zone_level_access_identity_providers_api.dart';
import '../apis/zone_level_zero_trust_organization_api.dart';
import '../apis/zone_level_access_service_tokens_api.dart';
import '../apis/custom_origin_trust_store_api.dart';
import '../apis/total_tls_api.dart';
import '../apis/argo_analytics_for_zone_api.dart';
import '../apis/argo_analytics_for_geolocation_api.dart';
import '../apis/shield_settings_api.dart';
import '../apis/discovery_api.dart';
import '../apis/shield_waf_expression_templates_api.dart';
import '../apis/shield_endpoint_management_api.dart';
import '../apis/argo_smart_routing_api.dart';
import '../apis/tiered_caching_api.dart';
import '../apis/zone_rate_plan_api.dart';
import '../apis/bot_settings_api.dart';
import '../apis/feedback_api.dart';
import '../apis/zone_cache_settings_api.dart';
import '../apis/origin_post_quantum_api.dart';
import '../apis/smart_tiered_cache_api.dart';
import '../apis/shield_client_certificates_for_a_zone_api.dart';
import '../apis/zone_cloud_connector_rules_get_api.dart';
import '../apis/zone_cloud_connector_rules_put_api.dart';
import '../apis/content_scanning_api.dart';
import '../apis/custom_ssl_for_a_zone_api.dart';
import '../apis/custom_hostname_for_a_zone_api.dart';
import '../apis/custom_hostname_fallback_origin_for_a_zone_api.dart';
import '../apis/dcv_delegation_api.dart';
import '../apis/dns_analytics_api.dart';
import '../apis/dns_records_for_a_zone_api.dart';
import '../apis/dns_settings_for_a_zone_api.dart';
import '../apis/dnssec_api.dart';
import '../apis/email_routing_settings_api.dart';
import '../apis/email_routing_routing_rules_api.dart';
import '../apis/email_sending_subdomains_api.dart';
import '../apis/ip_access_rules_for_a_zone_api.dart';
import '../apis/zone_lockdown_api.dart';
import '../apis/user_agent_blocking_rules_api.dart';
import '../apis/fraud_detection_api.dart';
import '../apis/health_checks_api.dart';
import '../apis/zone_holds_api.dart';
import '../apis/per_hostname_tls_settings_api.dart';
import '../apis/keyless_ssl_for_a_zone_api.dart';
import '../apis/leaked_credential_checks_api.dart';
import '../apis/load_balancers_api.dart';
import '../apis/logpush_jobs_for_a_zone_api.dart';
import '../apis/instant_logs_jobs_for_a_zone_api.dart';
import '../apis/logs_received_api.dart';
import '../apis/managed_transforms_api.dart';
import '../apis/zone_level_authenticated_origin_pulls_api.dart';
import '../apis/per_hostname_authenticated_origin_pull_api.dart';
import '../apis/page_shield_api.dart';
import '../apis/page_rules_api.dart';
import '../apis/zone_rulesets_api.dart';
import '../apis/schema_validation_api.dart';
import '../apis/schema_validation_settings_api.dart';
import '../apis/secondary_dns_secondary_zone_api.dart';
import '../apis/secondary_dns_primary_zone_api.dart';
import '../apis/security_txt_api.dart';
import '../apis/zone_settings_api.dart';
import '../apis/automatic_ssl_tls_api.dart';
import '../apis/zaraz_api.dart';
import '../apis/smart_shield_settings_api.dart';
import '../apis/cache_reserve_clear_api.dart';
import '../apis/zone_snippets_api.dart';
import '../apis/spectrum_analytics_api.dart';
import '../apis/spectrum_applications_api.dart';
import '../apis/observatory_api.dart';
import '../apis/analyze_certificate_api.dart';
import '../apis/certificate_packs_api.dart';
import '../apis/universal_ssl_settings_for_a_zone_api.dart';
import '../apis/ssl_verification_api.dart';
import '../apis/zone_subscription_api.dart';
import '../apis/token_validation_token_configuration_api.dart';
import '../apis/token_validation_token_rules_api.dart';
import '../apis/url_normalization_api.dart';
import '../apis/web3_hostname_api.dart';
import '../apis/worker_routes_api.dart';
import '../apis/custom_pages_for_a_zone_api.dart';
