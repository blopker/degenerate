...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/list_usage_record_last_month_response.dart';/// Api20100401LastMonthApi operations.
///
...
return ListUsageRecordLastMonthResponse.fromJson(json as Map<String, dynamic>);
  },
);
}
}
