...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/list_usage_record_response.dart';/// Api20100401RecordApi operations.
///
/// All operations return [ApiResult] - use pattern matching to handle
/// success, error, and exception cases.
final class Api20100401RecordApi with ApiExecutor {const Api20100401RecordApi(this.apiConfig);
...
return execute(
  request,
  onSuccess: (response) {
    return ListUsageRecordResponse.fromJson(jsonDecode(response.body) as Map<String, dynamic>);
  },
);
 } 
 }
