...
import 'dart:async';import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/account_recording_recording_transcription.dart';import '../models/list_recording_transcription_response.dart';/// Api20100401RecordingTranscriptionApi operations.
///
...
return  AccountRecordingRecordingTranscription.fromJson(json as Map<String, dynamic>);}, );}
/// 
///
...
return   await execute(request, onSuccess: (response) {final json = jsonDecode(response.body);
return  ListRecordingTranscriptionResponse.fromJson(json as Map<String, dynamic>);}, );}
}
