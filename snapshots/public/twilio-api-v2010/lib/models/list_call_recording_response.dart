...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_call_call_recording.dart';final class ListCallRecordingResponse {const ListCallRecordingResponse({this.recordings, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
final List<AccountCallCallRecording>? recordings;
...
ListCallRecordingResponse copyWith({List<AccountCallCallRecording> Function()? recordings, int Function()? end, Uri Function()? firstPageUri, Uri? Function()? nextPageUri, int Function()? page, int Function()? pageSize, Uri? Function()? previousPageUri, int Function()? start, Uri Function()? uri, }) { return ListCallRecordingResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListCallRecordingResponse &&
...
@override String toString() { return 'ListCallRecordingResponse(recordings: $recordings, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
