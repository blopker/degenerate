...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_call_call_recording.dart';@immutable final class ListCallRecordingResponse {const ListCallRecordingResponse({this.recordings, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListCallRecordingResponse copyWith({List<AccountCallCallRecording>? Function()? recordings, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListCallRecordingResponse(
