...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_toll_free.dart';@immutable final class ListAvailablePhoneNumberTollFreeResponse {const ListAvailablePhoneNumberTollFreeResponse({this.availablePhoneNumbers, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListAvailablePhoneNumberTollFreeResponse.fromJson(Map<String, dynamic> json) { return ListAvailablePhoneNumberTollFreeResponse(
  availablePhoneNumbers: (json['available_phone_numbers'] as List<dynamic>?)?.map((e) => AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree>? availablePhoneNumbers;
...
ListAvailablePhoneNumberTollFreeResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree>? Function()? availablePhoneNumbers, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAvailablePhoneNumberTollFreeResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAvailablePhoneNumberTollFreeResponse &&
...
@override String toString() { return 'ListAvailablePhoneNumberTollFreeResponse(availablePhoneNumbers: $availablePhoneNumbers, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
