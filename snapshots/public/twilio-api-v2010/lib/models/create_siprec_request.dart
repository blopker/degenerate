...
@immutable final class SiprecEnumTrack {const SiprecEnumTrack._(this.value);
...
@immutable final class CreateSiprecRequestStatusCallbackMethod {const CreateSiprecRequestStatusCallbackMethod._(this.value);
