...
final class SiprecEnumTrack {const SiprecEnumTrack._(this.value);

factory SiprecEnumTrack.fromJson(String json) { return switch (json) {
...
static const SiprecEnumTrack inboundTrack = SiprecEnumTrack._('inbound_track');

static const SiprecEnumTrack outboundTrack = SiprecEnumTrack._('outbound_track');

static const SiprecEnumTrack bothTracks = SiprecEnumTrack._('both_tracks');

static const List<SiprecEnumTrack> values = [inboundTrack, outboundTrack, bothTracks];
...
@override String toString() { return 'SiprecEnumTrack($value)'; } 
 }
...
/// The http method for the status_callback (one of GET, POST).
final CreateSiprecRequestStatusCallbackMethod? statusCallbackMethod;
