...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_sip_sip_domain.dart';@immutable final class ListSipDomainResponse {const ListSipDomainResponse({this.domains, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListSipDomainResponse.fromJson(Map<String, dynamic> json) { return ListSipDomainResponse(
  domains: (json['domains'] as List<dynamic>?)?.map((e) => AccountSipSipDomain.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountSipSipDomain>? domains;
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'domains', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListSipDomainResponse copyWith({List<AccountSipSipDomain>? Function()? domains, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListSipDomainResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSipDomainResponse &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(domains ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListSipDomainResponse(domains: $domains, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
