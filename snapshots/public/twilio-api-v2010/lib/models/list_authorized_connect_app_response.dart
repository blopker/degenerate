...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_authorized_connect_app.dart';@immutable final class ListAuthorizedConnectAppResponse {const ListAuthorizedConnectAppResponse({this.authorizedConnectApps, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
final List<AccountAuthorizedConnectApp>? authorizedConnectApps;
...
Map<String, dynamic> toJson() { return {
  if (authorizedConnectApps != null) 'authorized_connect_apps': authorizedConnectApps?.map((e) => e.toJson()).toList(),
  'end': ?end,
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'authorized_connect_apps', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListAuthorizedConnectAppResponse copyWith({List<AccountAuthorizedConnectApp>? Function()? authorizedConnectApps, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAuthorizedConnectAppResponse(
  authorizedConnectApps: authorizedConnectApps != null ? authorizedConnectApps() : this.authorizedConnectApps,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAuthorizedConnectAppResponse &&
          listEquals(authorizedConnectApps, other.authorizedConnectApps) &&
          end == other.end &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(authorizedConnectApps ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListAuthorizedConnectAppResponse(authorizedConnectApps: $authorizedConnectApps, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
