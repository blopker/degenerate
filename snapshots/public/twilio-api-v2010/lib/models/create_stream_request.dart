...
factory CreateStreamRequest.fromJson(Map<String, dynamic> json) { return CreateStreamRequest(
  ...
  statusCallbackMethod: json['StatusCallbackMethod'] != null ? CreateStreamRequestStatusCallbackMethod.fromJson(json['StatusCallbackMethod'] as String) : null,
...
/// The HTTP method Twilio uses when sending `status_callback` requests. Possible values are `GET` and `POST`. Default is `POST`.
final CreateStreamRequestStatusCallbackMethod? statusCallbackMethod;
