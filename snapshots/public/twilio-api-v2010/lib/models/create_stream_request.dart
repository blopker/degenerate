...
import 'package:degenerate_runtime/degenerate_runtime.dart';/// The tracks to be included in the Stream. Possible values are `inbound_track`, `outbound_track`, `both_tracks`. Default value is `inbound_track`.
...
@immutable final class CreateStreamRequestStatusCallbackMethod {const CreateStreamRequestStatusCallbackMethod._(this.value);
