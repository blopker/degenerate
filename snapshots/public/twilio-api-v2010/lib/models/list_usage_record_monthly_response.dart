...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_monthly.dart';@immutable final class ListUsageRecordMonthlyResponse {const ListUsageRecordMonthlyResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
final List<AccountUsageUsageRecordUsageRecordMonthly>? usageRecords;
...
ListUsageRecordMonthlyResponse copyWith({List<AccountUsageUsageRecordUsageRecordMonthly>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordMonthlyResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordMonthlyResponse &&
...
@override String toString() { return 'ListUsageRecordMonthlyResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
