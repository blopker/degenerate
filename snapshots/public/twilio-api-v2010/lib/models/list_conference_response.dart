...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_conference.dart';@immutable final class ListConferenceResponse {const ListConferenceResponse({this.conferences, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListConferenceResponse.fromJson(Map<String, dynamic> json) { return ListConferenceResponse(
  conferences: (json['conferences'] as List<dynamic>?)?.map((e) => AccountConference.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountConference>? conferences;
...
Map<String, dynamic> toJson() { return {
  if (conferences != null) 'conferences': conferences?.map((e) => e.toJson()).toList(),
  'end': ?end,
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'conferences', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListConferenceResponse copyWith({List<AccountConference>? Function()? conferences, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListConferenceResponse(
  conferences: conferences != null ? conferences() : this.conferences,
