...
@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineCapabilities {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachineCapabilities({this.mms, this.sms, this.voice, this.fax, });
