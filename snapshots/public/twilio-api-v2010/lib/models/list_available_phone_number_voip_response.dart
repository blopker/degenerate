...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_voip.dart';final class ListAvailablePhoneNumberVoipResponse {const ListAvailablePhoneNumberVoipResponse({this.availablePhoneNumbers, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
final List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip>? availablePhoneNumbers;
...
ListAvailablePhoneNumberVoipResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip> Function()? availablePhoneNumbers, int Function()? end, Uri Function()? firstPageUri, Uri? Function()? nextPageUri, int Function()? page, int Function()? pageSize, Uri? Function()? previousPageUri, int Function()? start, Uri Function()? uri, }) { return ListAvailablePhoneNumberVoipResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAvailablePhoneNumberVoipResponse &&
...
@override String toString() { return 'ListAvailablePhoneNumberVoipResponse(availablePhoneNumbers: $availablePhoneNumbers, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
