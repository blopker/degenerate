...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class CreateSipAuthRegistrationsCredentialListMappingRequest {const CreateSipAuthRegistrationsCredentialListMappingRequest({required this.credentialListSid});
