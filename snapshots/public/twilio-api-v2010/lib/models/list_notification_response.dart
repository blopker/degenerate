...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_notification.dart';@immutable final class ListNotificationResponse {const ListNotificationResponse({this.notifications, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListNotificationResponse copyWith({List<AccountNotification>? Function()? notifications, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListNotificationResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListNotificationResponse &&
...
@override String toString() { return 'ListNotificationResponse(notifications: $notifications, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
