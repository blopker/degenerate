...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account.dart';@immutable final class ListAccountResponse {const ListAccountResponse({this.accounts, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListAccountResponse.fromJson(Map<String, dynamic> json) { return ListAccountResponse(
...
Map<String, dynamic> toJson() { return {
  if (accounts != null) 'accounts': accounts?.map((e) => e.toJson()).toList(),
  'end': ?end,
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'accounts', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListAccountResponse copyWith({List<Account>? Function()? accounts, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAccountResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAccountResponse &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(accounts ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListAccountResponse(accounts: $accounts, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
