...
final List<AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping>? contents;
...
ListSipAuthCallsIpAccessControlListMappingResponse copyWith({List<AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping>? Function()? contents, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListSipAuthCallsIpAccessControlListMappingResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSipAuthCallsIpAccessControlListMappingResponse &&
...
@override String toString() { return 'ListSipAuthCallsIpAccessControlListMappingResponse(contents: $contents, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
