...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_outgoing_caller_id.dart';@immutable final class ListOutgoingCallerIdResponse {const ListOutgoingCallerIdResponse({this.outgoingCallerIds, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListOutgoingCallerIdResponse copyWith({List<AccountOutgoingCallerId>? Function()? outgoingCallerIds, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListOutgoingCallerIdResponse(
