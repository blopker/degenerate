...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_this_month.dart';@immutable final class ListUsageRecordThisMonthResponse {const ListUsageRecordThisMonthResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListUsageRecordThisMonthResponse.fromJson(Map<String, dynamic> json) { return ListUsageRecordThisMonthResponse(
  usageRecords: (json['usage_records'] as List<dynamic>?)?.map((e) => AccountUsageUsageRecordUsageRecordThisMonth.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountUsageUsageRecordUsageRecordThisMonth>? usageRecords;
...
ListUsageRecordThisMonthResponse copyWith({List<AccountUsageUsageRecordUsageRecordThisMonth>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordThisMonthResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordThisMonthResponse &&
...
@override String toString() { return 'ListUsageRecordThisMonthResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
