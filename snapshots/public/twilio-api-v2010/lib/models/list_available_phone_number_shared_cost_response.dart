...
ListAvailablePhoneNumberSharedCostResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost>? Function()? availablePhoneNumbers, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAvailablePhoneNumberSharedCostResponse(
...
@override String toString() { return 'ListAvailablePhoneNumberSharedCostResponse(availablePhoneNumbers: $availablePhoneNumbers, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
