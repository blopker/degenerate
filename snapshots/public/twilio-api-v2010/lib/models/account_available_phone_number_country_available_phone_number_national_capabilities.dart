...
@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities({this.mms, this.sms, this.voice, this.fax, });

factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities.fromJson(Map<String, dynamic> json) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities &&
          mms == other.mms &&
          sms == other.sms &&
          voice == other.voice &&
          fax == other.fax; } 
@override int get hashCode { return Object.hash(mms, sms, voice, fax); } 
@override String toString() { return 'AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities(mms: $mms, sms: $sms, voice: $voice, fax: $fax)'; } 
 }
