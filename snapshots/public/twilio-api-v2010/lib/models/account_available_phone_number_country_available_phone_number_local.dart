...
factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal.fromJson(Map<String, dynamic> json) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal(
  ...
  capabilities: json.containsKey('capabilities') ? Omittable(json['capabilities'] != null ? AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>) : null) : const Omittable.absent(),
); }
...
final Omittable<AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities?> capabilities;
...
AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal copyWith({Omittable<String?>? friendlyName, Omittable<String?>? phoneNumber, Omittable<String?>? lata, Omittable<String?>? locality, Omittable<String?>? rateCenter, Omittable<double?>? latitude, Omittable<double?>? longitude, Omittable<String?>? region, Omittable<String?>? postalCode, Omittable<String?>? isoCountry, Omittable<String?>? addressRequirements, Omittable<bool?>? beta, Omittable<AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities?>? capabilities, }) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal(
