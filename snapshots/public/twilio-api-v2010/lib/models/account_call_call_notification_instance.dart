...
@immutable final class AccountCallCallNotificationInstanceRequestMethod {const AccountCallCallNotificationInstanceRequestMethod._(this.value);

factory AccountCallCallNotificationInstanceRequestMethod.fromJson(String json) { return switch (json) {
  'GET' => $get,
  'POST' => post,
  _ => AccountCallCallNotificationInstanceRequestMethod._(json),
}; }

static const AccountCallCallNotificationInstanceRequestMethod $get = AccountCallCallNotificationInstanceRequestMethod._('GET');

static const AccountCallCallNotificationInstanceRequestMethod post = AccountCallCallNotificationInstanceRequestMethod._('POST');

static const List<AccountCallCallNotificationInstanceRequestMethod> values = [$get, post];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AccountCallCallNotificationInstanceRequestMethod && other.value == value; } 
@override int get hashCode { return value.hashCode; } 
@override String toString() { return 'AccountCallCallNotificationInstanceRequestMethod($value)'; } 
 }
@immutable final class AccountCallCallNotificationInstance {const AccountCallCallNotificationInstance({this.accountSid = const Omittable.absent(), this.apiVersion = const Omittable.absent(), this.callSid = const Omittable.absent(), this.dateCreated = const Omittable.absent(), this.dateUpdated = const Omittable.absent(), this.errorCode = const Omittable.absent(), this.log = const Omittable.absent(), this.messageDate = const Omittable.absent(), this.messageText = const Omittable.absent(), this.moreInfo = const Omittable.absent(), this.requestMethod = const Omittable.absent(), this.requestUrl = const Omittable.absent(), this.requestVariables = const Omittable.absent(), this.responseBody = const Omittable.absent(), this.responseHeaders = const Omittable.absent(), this.sid = const Omittable.absent(), this.uri = const Omittable.absent(), });
...
factory AccountCallCallNotificationInstance.fromJson(Map<String, dynamic> json) { return AccountCallCallNotificationInstance(
  ...
  requestMethod: json.containsKey('request_method') ? Omittable(json['request_method'] != null ? AccountCallCallNotificationInstanceRequestMethod.fromJson(json['request_method'] as String) : null) : const Omittable.absent(),
...
final Omittable<AccountCallCallNotificationInstanceRequestMethod?> requestMethod;
...
AccountCallCallNotificationInstance copyWith({Omittable<String?>? accountSid, Omittable<String?>? apiVersion, Omittable<String?>? callSid, Omittable<String?>? dateCreated, Omittable<String?>? dateUpdated, Omittable<String?>? errorCode, Omittable<String?>? log, Omittable<String?>? messageDate, Omittable<String?>? messageText, Omittable<Uri?>? moreInfo, Omittable<AccountCallCallNotificationInstanceRequestMethod?>? requestMethod, Omittable<Uri?>? requestUrl, Omittable<String?>? requestVariables, Omittable<String?>? responseBody, Omittable<String?>? responseHeaders, Omittable<String?>? sid, Omittable<String?>? uri, }) { return AccountCallCallNotificationInstance(
