...
@immutable final class AccountCallCallNotificationInstance {const AccountCallCallNotificationInstance({this.accountSid, this.apiVersion, this.callSid, this.dateCreated, this.dateUpdated, this.errorCode, this.log, this.messageDate, this.messageText, this.moreInfo, this.requestMethod, this.requestUrl, this.requestVariables, this.responseBody, this.responseHeaders, this.sid, this.uri, });
...
factory AccountCallCallNotificationInstance.fromJson(Map<String, dynamic> json) { return AccountCallCallNotificationInstance(
  ...
  requestMethod: json['request_method'] != null ? AccountCallCallNotificationInstanceRequestMethod.fromJson(json['request_method'] as String) : null,
...
final AccountCallCallNotificationInstanceRequestMethod? requestMethod;
