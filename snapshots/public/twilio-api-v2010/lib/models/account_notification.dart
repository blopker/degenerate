...
@immutable final class AccountNotificationRequestMethod {const AccountNotificationRequestMethod._(this.value);
...
@immutable final class AccountNotification {const AccountNotification({this.accountSid = const Omittable.absent(), this.apiVersion = const Omittable.absent(), this.callSid = const Omittable.absent(), this.dateCreated = const Omittable.absent(), this.dateUpdated = const Omittable.absent(), this.errorCode = const Omittable.absent(), this.log = const Omittable.absent(), this.messageDate = const Omittable.absent(), this.messageText = const Omittable.absent(), this.moreInfo = const Omittable.absent(), this.requestMethod = const Omittable.absent(), this.requestUrl = const Omittable.absent(), this.sid = const Omittable.absent(), this.uri = const Omittable.absent(), });
...
factory AccountNotification.fromJson(Map<String, dynamic> json) { return AccountNotification(
  ...
  requestMethod: json.containsKey('request_method') ? Omittable(json['request_method'] != null ? AccountNotificationRequestMethod.fromJson(json['request_method'] as String) : null) : const Omittable.absent(),
...
final Omittable<AccountNotificationRequestMethod?> requestMethod;
...
AccountNotification copyWith({Omittable<String?>? accountSid, Omittable<String?>? apiVersion, Omittable<String?>? callSid, Omittable<String?>? dateCreated, Omittable<String?>? dateUpdated, Omittable<String?>? errorCode, Omittable<String?>? log, Omittable<String?>? messageDate, Omittable<String?>? messageText, Omittable<Uri?>? moreInfo, Omittable<AccountNotificationRequestMethod?>? requestMethod, Omittable<Uri?>? requestUrl, Omittable<String?>? sid, Omittable<String?>? uri, }) { return AccountNotification(
