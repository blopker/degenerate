...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record.dart';@immutable final class ListUsageRecordResponse {const ListUsageRecordResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListUsageRecordResponse copyWith({List<AccountUsageUsageRecord>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordResponse(
