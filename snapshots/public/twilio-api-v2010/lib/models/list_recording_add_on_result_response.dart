...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_recording_recording_add_on_result.dart';@immutable final class ListRecordingAddOnResultResponse {const ListRecordingAddOnResultResponse({this.addOnResults, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'add_on_results', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListRecordingAddOnResultResponse copyWith({List<AccountRecordingRecordingAddOnResult>? Function()? addOnResults, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListRecordingAddOnResultResponse(
