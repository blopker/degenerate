...
@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities({this.mms, this.sms, this.voice, this.fax, });
