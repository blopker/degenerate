...
import 'account_available_phone_number_country_available_phone_number_mobile_capabilities.dart';final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile({this.friendlyName, this.phoneNumber, this.lata, this.locality, this.rateCenter, this.latitude, this.longitude, this.region, this.postalCode, this.isoCountry, this.addressRequirements, this.beta, this.capabilities, });
...
factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile.fromJson(Map<String, dynamic> json) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile(
  ...
  capabilities: json['capabilities'] != null ? AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>) : null,
); }
...
final AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities? capabilities;
...
AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile copyWith({String? Function()? friendlyName, String? Function()? phoneNumber, String? Function()? lata, String? Function()? locality, String? Function()? rateCenter, double? Function()? latitude, double? Function()? longitude, String? Function()? region, String? Function()? postalCode, String? Function()? isoCountry, String? Function()? addressRequirements, bool? Function()? beta, AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities? Function()? capabilities, }) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile(
