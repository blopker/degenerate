...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_today.dart';@immutable final class ListUsageRecordTodayResponse {const ListUsageRecordTodayResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListUsageRecordTodayResponse.fromJson(Map<String, dynamic> json) { return ListUsageRecordTodayResponse(
  usageRecords: (json['usage_records'] as List<dynamic>?)?.map((e) => AccountUsageUsageRecordUsageRecordToday.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountUsageUsageRecordUsageRecordToday>? usageRecords;
...
ListUsageRecordTodayResponse copyWith({List<AccountUsageUsageRecordUsageRecordToday>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordTodayResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordTodayResponse &&
...
@override String toString() { return 'ListUsageRecordTodayResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
