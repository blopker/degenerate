...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_local.dart';@immutable final class ListAvailablePhoneNumberLocalResponse {const ListAvailablePhoneNumberLocalResponse({this.availablePhoneNumbers, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListAvailablePhoneNumberLocalResponse.fromJson(Map<String, dynamic> json) { return ListAvailablePhoneNumberLocalResponse(
  availablePhoneNumbers: (json['available_phone_numbers'] as List<dynamic>?)?.map((e) => AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal>? availablePhoneNumbers;
...
ListAvailablePhoneNumberLocalResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal>? Function()? availablePhoneNumbers, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAvailablePhoneNumberLocalResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAvailablePhoneNumberLocalResponse &&
...
@override String toString() { return 'ListAvailablePhoneNumberLocalResponse(availablePhoneNumbers: $availablePhoneNumbers, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
