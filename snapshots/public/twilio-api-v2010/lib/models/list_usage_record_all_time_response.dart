...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_all_time.dart';@immutable final class ListUsageRecordAllTimeResponse {const ListUsageRecordAllTimeResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListUsageRecordAllTimeResponse.fromJson(Map<String, dynamic> json) { return ListUsageRecordAllTimeResponse(
  usageRecords: (json['usage_records'] as List<dynamic>?)?.map((e) => AccountUsageUsageRecordUsageRecordAllTime.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountUsageUsageRecordUsageRecordAllTime>? usageRecords;
...
ListUsageRecordAllTimeResponse copyWith({List<AccountUsageUsageRecordUsageRecordAllTime>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordAllTimeResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordAllTimeResponse &&
...
@override String toString() { return 'ListUsageRecordAllTimeResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
