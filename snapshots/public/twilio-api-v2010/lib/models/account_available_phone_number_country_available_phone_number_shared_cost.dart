...
import 'account_available_phone_number_country_available_phone_number_shared_cost_capabilities.dart';final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost({this.friendlyName, this.phoneNumber, this.lata, this.locality, this.rateCenter, this.latitude, this.longitude, this.region, this.postalCode, this.isoCountry, this.addressRequirements, this.beta, this.capabilities, });
