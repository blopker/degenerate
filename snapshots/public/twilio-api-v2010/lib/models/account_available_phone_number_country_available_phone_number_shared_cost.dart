...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_shared_cost_capabilities.dart';@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost({this.friendlyName = const Omittable.absent(), this.phoneNumber = const Omittable.absent(), this.lata = const Omittable.absent(), this.locality = const Omittable.absent(), this.rateCenter = const Omittable.absent(), this.latitude = const Omittable.absent(), this.longitude = const Omittable.absent(), this.region = const Omittable.absent(), this.postalCode = const Omittable.absent(), this.isoCountry = const Omittable.absent(), this.addressRequirements = const Omittable.absent(), this.beta = const Omittable.absent(), this.capabilities = const Omittable.absent(), });

factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost.fromJson(Map<String, dynamic> json) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost(
  ...
  capabilities: json.containsKey('capabilities') ? Omittable(json['capabilities'] != null ? AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>) : null) : const Omittable.absent(),
); }
...
final Omittable<AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities?> capabilities;
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost &&
