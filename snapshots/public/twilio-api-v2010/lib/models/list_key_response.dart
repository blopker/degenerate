...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_key.dart';@immutable final class ListKeyResponse {const ListKeyResponse({this.keys, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListKeyResponse.fromJson(Map<String, dynamic> json) { return ListKeyResponse(
  keys: (json['keys'] as List<dynamic>?)?.map((e) => AccountKey.fromJson(e as Map<String, dynamic>)).toList(),
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'keys', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListKeyResponse copyWith({List<AccountKey>? Function()? keys, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListKeyResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListKeyResponse &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(keys ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListKeyResponse(keys: $keys, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
