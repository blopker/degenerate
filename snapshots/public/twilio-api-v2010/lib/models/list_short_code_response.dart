...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_short_code.dart';@immutable final class ListShortCodeResponse {const ListShortCodeResponse({this.shortCodes, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
final List<AccountShortCode>? shortCodes;
...
Map<String, dynamic> toJson() { return {
  if (shortCodes != null) 'short_codes': shortCodes?.map((e) => e.toJson()).toList(),
  'end': ?end,
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'short_codes', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListShortCodeResponse copyWith({List<AccountShortCode>? Function()? shortCodes, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListShortCodeResponse(
  shortCodes: shortCodes != null ? shortCodes() : this.shortCodes,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListShortCodeResponse &&
          listEquals(shortCodes, other.shortCodes) &&
          end == other.end &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(shortCodes ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListShortCodeResponse(shortCodes: $shortCodes, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
