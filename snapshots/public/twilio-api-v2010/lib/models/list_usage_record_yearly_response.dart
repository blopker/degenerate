...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_yearly.dart';@immutable final class ListUsageRecordYearlyResponse {const ListUsageRecordYearlyResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListUsageRecordYearlyResponse.fromJson(Map<String, dynamic> json) { return ListUsageRecordYearlyResponse(
  usageRecords: (json['usage_records'] as List<dynamic>?)?.map((e) => AccountUsageUsageRecordUsageRecordYearly.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountUsageUsageRecordUsageRecordYearly>? usageRecords;
...
ListUsageRecordYearlyResponse copyWith({List<AccountUsageUsageRecordUsageRecordYearly>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordYearlyResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordYearlyResponse &&
...
@override String toString() { return 'ListUsageRecordYearlyResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
