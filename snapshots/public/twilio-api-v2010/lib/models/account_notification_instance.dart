...
@immutable final class AccountNotificationInstanceRequestMethod {const AccountNotificationInstanceRequestMethod._(this.value);

factory AccountNotificationInstanceRequestMethod.fromJson(String json) { return switch (json) {
  'GET' => $get,
  'POST' => post,
  _ => AccountNotificationInstanceRequestMethod._(json),
}; }

static const AccountNotificationInstanceRequestMethod $get = AccountNotificationInstanceRequestMethod._('GET');

static const AccountNotificationInstanceRequestMethod post = AccountNotificationInstanceRequestMethod._('POST');

static const List<AccountNotificationInstanceRequestMethod> values = [$get, post];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is AccountNotificationInstanceRequestMethod && other.value == value; } 
...
@override String toString() { return 'AccountNotificationInstance(accountSid: $accountSid, apiVersion: $apiVersion, callSid: $callSid, dateCreated: $dateCreated, dateUpdated: $dateUpdated, errorCode: $errorCode, log: $log, messageDate: $messageDate, messageText: $messageText, moreInfo: $moreInfo, requestMethod: $requestMethod, requestUrl: $requestUrl, requestVariables: $requestVariables, responseBody: $responseBody, responseHeaders: $responseHeaders, sid: $sid, uri: $uri)'; } 
 }
