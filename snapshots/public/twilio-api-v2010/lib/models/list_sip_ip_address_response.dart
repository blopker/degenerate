...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_sip_sip_ip_access_control_list_sip_ip_address.dart';@immutable final class ListSipIpAddressResponse {const ListSipIpAddressResponse({this.ipAddresses, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListSipIpAddressResponse.fromJson(Map<String, dynamic> json) { return ListSipIpAddressResponse(
  ipAddresses: (json['ip_addresses'] as List<dynamic>?)?.map((e) => AccountSipSipIpAccessControlListSipIpAddress.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountSipSipIpAccessControlListSipIpAddress>? ipAddresses;
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'ip_addresses', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListSipIpAddressResponse copyWith({List<AccountSipSipIpAccessControlListSipIpAddress>? Function()? ipAddresses, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListSipIpAddressResponse(
