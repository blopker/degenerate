...
import 'account_available_phone_number_country_available_phone_number_national_capabilities.dart';final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational({this.friendlyName, this.phoneNumber, this.lata, this.locality, this.rateCenter, this.latitude, this.longitude, this.region, this.postalCode, this.isoCountry, this.addressRequirements, this.beta, this.capabilities, });
