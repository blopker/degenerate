...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_national_capabilities.dart';@immutable final class AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational {const AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational({this.friendlyName = const Omittable.absent(), this.phoneNumber = const Omittable.absent(), this.lata = const Omittable.absent(), this.locality = const Omittable.absent(), this.rateCenter = const Omittable.absent(), this.latitude = const Omittable.absent(), this.longitude = const Omittable.absent(), this.region = const Omittable.absent(), this.postalCode = const Omittable.absent(), this.isoCountry = const Omittable.absent(), this.addressRequirements = const Omittable.absent(), this.beta = const Omittable.absent(), this.capabilities = const Omittable.absent(), });

factory AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational.fromJson(Map<String, dynamic> json) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational(
  ...
  capabilities: json.containsKey('capabilities') ? Omittable(json['capabilities'] != null ? AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>) : null) : const Omittable.absent(),
); }
...
final Omittable<AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities?> capabilities;
...
AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational copyWith({Omittable<String?>? friendlyName, Omittable<String?>? phoneNumber, Omittable<String?>? lata, Omittable<String?>? locality, Omittable<String?>? rateCenter, Omittable<double?>? latitude, Omittable<double?>? longitude, Omittable<String?>? region, Omittable<String?>? postalCode, Omittable<String?>? isoCountry, Omittable<String?>? addressRequirements, Omittable<bool?>? beta, Omittable<AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities?>? capabilities, }) { return AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational &&
