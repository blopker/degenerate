...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class AccountUsageUsageRecordUsageRecordAllTime {const AccountUsageUsageRecordUsageRecordAllTime({this.accountSid = const Omittable.absent(), this.apiVersion = const Omittable.absent(), this.asOf = const Omittable.absent(), this.category = const Omittable.absent(), this.count = const Omittable.absent(), this.countUnit = const Omittable.absent(), this.description = const Omittable.absent(), this.endDate = const Omittable.absent(), this.price = const Omittable.absent(), this.priceUnit = const Omittable.absent(), this.startDate = const Omittable.absent(), this.subresourceUris = const Omittable.absent(), this.uri = const Omittable.absent(), this.usage = const Omittable.absent(), this.usageUnit = const Omittable.absent(), });
...
@override String toString() { return 'AccountUsageUsageRecordUsageRecordAllTime(accountSid: $accountSid, apiVersion: $apiVersion, asOf: $asOf, category: $category, count: $count, countUnit: $countUnit, description: $description, endDate: $endDate, price: $price, priceUnit: $priceUnit, startDate: $startDate, subresourceUris: $subresourceUris, uri: $uri, usage: $usage, usageUnit: $usageUnit)'; } 
 }
