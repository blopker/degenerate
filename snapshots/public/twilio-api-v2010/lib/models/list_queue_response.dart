...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_queue.dart';@immutable final class ListQueueResponse {const ListQueueResponse({this.queues, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListQueueResponse copyWith({List<AccountQueue>? Function()? queues, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListQueueResponse(
