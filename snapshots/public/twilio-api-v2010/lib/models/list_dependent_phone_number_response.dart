...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_address_dependent_phone_number.dart';@immutable final class ListDependentPhoneNumberResponse {const ListDependentPhoneNumberResponse({this.dependentPhoneNumbers, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
ListDependentPhoneNumberResponse copyWith({List<AccountAddressDependentPhoneNumber>? Function()? dependentPhoneNumbers, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListDependentPhoneNumberResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListDependentPhoneNumberResponse &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(dependentPhoneNumbers ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListDependentPhoneNumberResponse(dependentPhoneNumbers: $dependentPhoneNumbers, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
