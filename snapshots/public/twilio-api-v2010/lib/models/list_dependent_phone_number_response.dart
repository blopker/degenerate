...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_address_dependent_phone_number.dart';final class ListDependentPhoneNumberResponse {const ListDependentPhoneNumberResponse({this.dependentPhoneNumbers, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
