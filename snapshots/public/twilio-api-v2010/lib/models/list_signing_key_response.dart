...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_signing_key.dart';@immutable final class ListSigningKeyResponse {const ListSigningKeyResponse({this.signingKeys, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListSigningKeyResponse.fromJson(Map<String, dynamic> json) { return ListSigningKeyResponse(
  signingKeys: (json['signing_keys'] as List<dynamic>?)?.map((e) => AccountSigningKey.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountSigningKey>? signingKeys;
...
Map<String, dynamic> toJson() { return {
  if (signingKeys != null) 'signing_keys': signingKeys?.map((e) => e.toJson()).toList(),
  'end': ?end,
...
ListSigningKeyResponse copyWith({List<AccountSigningKey>? Function()? signingKeys, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListSigningKeyResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSigningKeyResponse &&
          listEquals(signingKeys, other.signingKeys) &&
          end == other.end &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(signingKeys ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListSigningKeyResponse(signingKeys: $signingKeys, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
