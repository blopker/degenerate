...
final class CreateQueueRequest {const CreateQueueRequest({required this.friendlyName, this.maxSize, });
...
@override String toString() { return 'CreateQueueRequest(friendlyName: $friendlyName, maxSize: $maxSize)'; } 
 }
