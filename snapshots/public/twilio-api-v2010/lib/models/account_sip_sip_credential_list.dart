...
final class AccountSipSipCredentialList {const AccountSipSipCredentialList({this.accountSid, this.dateCreated, this.dateUpdated, this.friendlyName, this.sid, this.subresourceUris, this.uri, });
