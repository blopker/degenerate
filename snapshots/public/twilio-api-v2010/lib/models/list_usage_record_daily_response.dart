...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_usage_usage_record_usage_record_daily.dart';@immutable final class ListUsageRecordDailyResponse {const ListUsageRecordDailyResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListUsageRecordDailyResponse.fromJson(Map<String, dynamic> json) { return ListUsageRecordDailyResponse(
  usageRecords: (json['usage_records'] as List<dynamic>?)?.map((e) => AccountUsageUsageRecordUsageRecordDaily.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountUsageUsageRecordUsageRecordDaily>? usageRecords;
...
ListUsageRecordDailyResponse copyWith({List<AccountUsageUsageRecordUsageRecordDaily>? Function()? usageRecords, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListUsageRecordDailyResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordDailyResponse &&
...
@override String toString() { return 'ListUsageRecordDailyResponse(usageRecords: $usageRecords, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
