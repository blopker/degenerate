...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_available_phone_number_country_available_phone_number_mobile.dart';@immutable final class ListAvailablePhoneNumberMobileResponse {const ListAvailablePhoneNumberMobileResponse({this.availablePhoneNumbers, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });

factory ListAvailablePhoneNumberMobileResponse.fromJson(Map<String, dynamic> json) { return ListAvailablePhoneNumberMobileResponse(
  availablePhoneNumbers: (json['available_phone_numbers'] as List<dynamic>?)?.map((e) => AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile.fromJson(e as Map<String, dynamic>)).toList(),
...
final List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile>? availablePhoneNumbers;
...
ListAvailablePhoneNumberMobileResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile>? Function()? availablePhoneNumbers, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListAvailablePhoneNumberMobileResponse(
