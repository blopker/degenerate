...
ListAvailablePhoneNumberMobileResponse copyWith({List<AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile> Function()? availablePhoneNumbers, int Function()? end, Uri Function()? firstPageUri, Uri? Function()? nextPageUri, int Function()? page, int Function()? pageSize, Uri? Function()? previousPageUri, int Function()? start, Uri Function()? uri, }) { return ListAvailablePhoneNumberMobileResponse(
