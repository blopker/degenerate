...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_conference_participant.dart';@immutable final class ListParticipantResponse {const ListParticipantResponse({this.participants, this.end, this.firstPageUri, this.nextPageUri = const Omittable.absent(), this.page, this.pageSize, this.previousPageUri = const Omittable.absent(), this.start, this.uri, });
...
final List<AccountConferenceParticipant>? participants;
...
static bool canParse(Map<String, dynamic> json) { return json.keys.any((key) => const {'participants', 'end', 'first_page_uri', 'next_page_uri', 'page', 'page_size', 'previous_page_uri', 'start', 'uri'}.contains(key)); } 
ListParticipantResponse copyWith({List<AccountConferenceParticipant>? Function()? participants, int? Function()? end, Uri? Function()? firstPageUri, Omittable<Uri?>? nextPageUri, int? Function()? page, int? Function()? pageSize, Omittable<Uri?>? previousPageUri, int? Function()? start, Uri? Function()? uri, }) { return ListParticipantResponse(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListParticipantResponse &&
          ...
          start == other.start &&
          uri == other.uri; } 
@override int get hashCode { return Object.hash(Object.hashAll(participants ?? const []), end, firstPageUri, nextPageUri, page, pageSize, previousPageUri, start, uri); } 
@override String toString() { return 'ListParticipantResponse(participants: $participants, end: $end, firstPageUri: $firstPageUri, nextPageUri: $nextPageUri, page: $page, pageSize: $pageSize, previousPageUri: $previousPageUri, start: $start, uri: $uri)'; } 
 }
