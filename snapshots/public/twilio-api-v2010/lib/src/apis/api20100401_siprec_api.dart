...
Future<ApiResult<AccountCallSiprec, Never>> createSiprec({required String accountSid, required String callSid, CreateSiprecRequest? body, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<AccountCallSiprec, Never>> updateSiprec({required String accountSid, required String callSid, required String sid, UpdateSiprecRequest? body, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
headers['Content-Type'] = 'application/x-www-form-urlencoded';
