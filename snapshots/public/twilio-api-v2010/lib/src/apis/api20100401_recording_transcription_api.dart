...
final class Api20100401RecordingTranscriptionApi {const Api20100401RecordingTranscriptionApi(this._config);
...
Future<ApiResult<AccountRecordingRecordingTranscription, Never>> fetchRecordingTranscription({required String accountSid, required String recordingSid, required String sid, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<void, Never>> deleteRecordingTranscription({required String accountSid, required String recordingSid, required String sid, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<ListRecordingTranscriptionResponse, Never>> listRecordingTranscription({required String accountSid, required String recordingSid, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
