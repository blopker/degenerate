...
Future<ApiResult<ListSipAuthCallsIpAccessControlListMappingResponse, Never>> listSipAuthCallsIpAccessControlListMapping({required String accountSid, required String domainSid, int? pageSize, int? page, String? pageToken, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
...
Future<ApiResult<AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping, Never>> fetchSipAuthCallsIpAccessControlListMapping({required String accountSid, required String domainSid, required String sid, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<void, Never>> deleteSipAuthCallsIpAccessControlListMapping({required String accountSid, required String domainSid, required String sid, }) async  { final headers = <String, String>{..._config.defaultHeaders};
