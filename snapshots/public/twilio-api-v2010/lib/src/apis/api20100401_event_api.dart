...
final class Api20100401EventApi {const Api20100401EventApi(this._config);
...
Future<ApiResult<ListCallEventResponse, Never>> listCallEvent({required String accountSid, required String callSid, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
