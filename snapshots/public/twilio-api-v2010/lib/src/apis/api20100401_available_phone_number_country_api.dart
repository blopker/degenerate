...
Future<ApiResult<ListAvailablePhoneNumberCountryResponse, Never>> listAvailablePhoneNumberCountry({required String accountSid, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
...
Future<ApiResult<AccountAvailablePhoneNumberCountry, Never>> fetchAvailablePhoneNumberCountry({required String accountSid, required String countryCode, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
