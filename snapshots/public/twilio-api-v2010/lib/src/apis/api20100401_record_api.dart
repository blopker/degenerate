...
final class Api20100401RecordApi {const Api20100401RecordApi(this._config);
...
Future<ApiResult<ListUsageRecordResponse, Never>> listUsageRecord({required String accountSid, String? category, String? startDate, String? endDate, bool? includeSubaccounts, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
