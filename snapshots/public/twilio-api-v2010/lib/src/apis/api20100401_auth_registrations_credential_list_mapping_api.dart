...
Future<ApiResult<ListSipAuthRegistrationsCredentialListMappingResponse, Never>> listSipAuthRegistrationsCredentialListMapping({required String accountSid, required String domainSid, int? pageSize, int? page, String? pageToken, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping, Never>> fetchSipAuthRegistrationsCredentialListMapping({required String accountSid, required String domainSid, required String sid, }) async  { final request = ApiRequest(
  method: 'GET',
...
Future<ApiResult<void, Never>> deleteSipAuthRegistrationsCredentialListMapping({required String accountSid, required String domainSid, required String sid, }) async  { final request = ApiRequest(
  method: 'DELETE',
  path: '/2010-04-01/Accounts/${Uri.encodeComponent(accountSid)}/SIP/Domains/${Uri.encodeComponent(domainSid)}/Auth/Registrations/CredentialListMappings/${Uri.encodeComponent(sid)}.json',
  headers: {..._config.defaultHeaders
  },
