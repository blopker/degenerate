...
import 'dart:convert';import 'package:degenerate_runtime/degenerate_runtime.dart';import '../models/account_incoming_phone_number_incoming_phone_number_assigned_add_on_incoming_phone_number_assigned_add_on_extension.dart';import '../models/list_incoming_phone_number_assigned_add_on_extension_response.dart';/// Api20100401AssignedAddOnExtensionApi operations.
///
...
Future<ApiResult<AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOnIncomingPhoneNumberAssignedAddOnExtension, Never>> fetchIncomingPhoneNumberAssignedAddOnExtension({required String accountSid, required String resourceSid, required String assignedAddOnSid, required String sid, RequestOptions? options, }) async  { final headers = <String, String>{..._config.defaultHeaders};
...
Future<ApiResult<ListIncomingPhoneNumberAssignedAddOnExtensionResponse, Never>> listIncomingPhoneNumberAssignedAddOnExtension({required String accountSid, required String resourceSid, required String assignedAddOnSid, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
