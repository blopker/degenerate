...
final class Api20100401YearlyApi {const Api20100401YearlyApi(this._config);
...
Future<ApiResult<ListUsageRecordYearlyResponse, Never>> listUsageRecordYearly({required String accountSid, String? category, String? startDate, String? endDate, bool? includeSubaccounts, int? pageSize, int? page, String? pageToken, RequestOptions? options, }) async  { final queryParameters = <String, String>{..._config.defaultQueryParameters};
