...
final request = ApiRequest(
  ...
  headers: headers,
  body: [
    if (body.accountSid case final _accountSid?)
      'AccountSid=${Uri.encodeQueryComponent(_accountSid)}',
...
final request = ApiRequest(
  ...
  body: [
    ...
    if (body.phoneNumber case final _phoneNumber?)
      'PhoneNumber=${Uri.encodeQueryComponent(_phoneNumber)}',
    if (body.areaCode case final _areaCode?)
      'AreaCode=${Uri.encodeQueryComponent(_areaCode)}',
  ].join('&'),
);
