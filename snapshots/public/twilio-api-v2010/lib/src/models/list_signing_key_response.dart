...
import 'package:collection/collection.dart';import 'account_signing_key.dart';final class ListSigningKeyResponse {const ListSigningKeyResponse({this.signingKeys, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSigningKeyResponse &&
          const ListEquality<dynamic>().equals(signingKeys, other.signingKeys) &&
          end == other.end &&
