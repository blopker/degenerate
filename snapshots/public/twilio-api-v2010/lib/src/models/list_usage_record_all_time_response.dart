...
import 'package:collection/collection.dart';import 'account_usage_usage_record_usage_record_all_time.dart';final class ListUsageRecordAllTimeResponse {const ListUsageRecordAllTimeResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
