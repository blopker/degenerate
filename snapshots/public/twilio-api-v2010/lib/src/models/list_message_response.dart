...
import 'package:collection/collection.dart';import 'account_message.dart';final class ListMessageResponse {const ListMessageResponse({this.messages, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
