...
import 'package:collection/collection.dart';import 'connect_app_enum_permission.dart';import 'update_connect_app_request_deauthorize_callback_method.dart';final class UpdateConnectAppRequest {const UpdateConnectAppRequest({this.authorizeRedirectUrl, this.companyName, this.deauthorizeCallbackMethod, this.deauthorizeCallbackUrl, this.description, this.friendlyName, this.homepageUrl, this.permissions, });
