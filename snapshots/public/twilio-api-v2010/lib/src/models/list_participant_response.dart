...
import 'package:collection/collection.dart';import 'account_conference_participant.dart';final class ListParticipantResponse {const ListParticipantResponse({this.participants, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
