...
import 'package:collection/collection.dart';import 'account_queue.dart';final class ListQueueResponse {const ListQueueResponse({this.queues, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
