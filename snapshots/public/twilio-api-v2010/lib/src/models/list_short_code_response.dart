...
import 'package:collection/collection.dart';import 'account_short_code.dart';final class ListShortCodeResponse {const ListShortCodeResponse({this.shortCodes, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListShortCodeResponse &&
          const ListEquality<dynamic>().equals(shortCodes, other.shortCodes) &&
          end == other.end &&
