...
final class AccountCallCallNotificationInstanceRequestMethod {const AccountCallCallNotificationInstanceRequestMethod._(this.value);
...
final class AccountCallCallNotificationInstance {const AccountCallCallNotificationInstance({this.accountSid, this.apiVersion, this.callSid, this.dateCreated, this.dateUpdated, this.errorCode, this.log, this.messageDate, this.messageText, this.moreInfo, this.requestMethod, this.requestUrl, this.requestVariables, this.responseBody, this.responseHeaders, this.sid, this.uri, });
