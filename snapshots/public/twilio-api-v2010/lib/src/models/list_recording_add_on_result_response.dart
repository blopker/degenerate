...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListRecordingAddOnResultResponse &&
          const ListEquality<dynamic>().equals(addOnResults, other.addOnResults) &&
          end == other.end &&
