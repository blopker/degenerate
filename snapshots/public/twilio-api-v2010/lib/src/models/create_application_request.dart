...
import 'create_application_request_sms_fallback_method.dart';import 'create_application_request_sms_method.dart';import 'create_application_request_status_callback_method.dart';import 'create_application_request_voice_fallback_method.dart';import 'create_application_request_voice_method.dart';final class CreateApplicationRequest {const CreateApplicationRequest({this.apiVersion, this.voiceUrl, this.voiceMethod, this.voiceFallbackUrl, this.voiceFallbackMethod, this.statusCallback, this.statusCallbackMethod, this.voiceCallerIdLookup, this.smsUrl, this.smsMethod, this.smsFallbackUrl, this.smsFallbackMethod, this.smsStatusCallback, this.messageStatusCallback, this.friendlyName, this.publicApplicationConnectEnabled, });
