...
import 'package:collection/collection.dart';import 'account_usage_usage_record_usage_record_last_month.dart';final class ListUsageRecordLastMonthResponse {const ListUsageRecordLastMonthResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageRecordLastMonthResponse &&
          const ListEquality<dynamic>().equals(usageRecords, other.usageRecords) &&
          end == other.end &&
