...
import 'package:collection/collection.dart';import 'account.dart';final class ListAccountResponse {const ListAccountResponse({this.accounts, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListAccountResponse &&
          const ListEquality<dynamic>().equals(accounts, other.accounts) &&
          end == other.end &&
