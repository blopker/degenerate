...
import 'account_call_call_notification_request_method.dart';final class AccountCallCallNotification {const AccountCallCallNotification({this.accountSid, this.apiVersion, this.callSid, this.dateCreated, this.dateUpdated, this.errorCode, this.log, this.messageDate, this.messageText, this.moreInfo, this.requestMethod, this.requestUrl, this.sid, this.uri, });
