...
import 'package:collection/collection.dart';import 'account_notification.dart';final class ListNotificationResponse {const ListNotificationResponse({this.notifications, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
