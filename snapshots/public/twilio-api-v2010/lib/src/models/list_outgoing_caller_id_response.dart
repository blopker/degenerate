...
import 'package:collection/collection.dart';import 'account_outgoing_caller_id.dart';final class ListOutgoingCallerIdResponse {const ListOutgoingCallerIdResponse({this.outgoingCallerIds, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListOutgoingCallerIdResponse &&
          const ListEquality<dynamic>().equals(outgoingCallerIds, other.outgoingCallerIds) &&
          end == other.end &&
