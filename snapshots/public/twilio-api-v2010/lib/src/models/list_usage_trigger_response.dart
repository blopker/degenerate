...
import 'package:collection/collection.dart';import 'account_usage_usage_trigger.dart';final class ListUsageTriggerResponse {const ListUsageTriggerResponse({this.usageTriggers, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListUsageTriggerResponse &&
          const ListEquality<dynamic>().equals(usageTriggers, other.usageTriggers) &&
          end == other.end &&
