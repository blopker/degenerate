...
import 'siprec_enum_status.dart';final class AccountCallSiprec {const AccountCallSiprec({this.sid, this.accountSid, this.callSid, this.name, this.status, this.dateUpdated, this.uri, });
