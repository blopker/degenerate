...
import 'payments_enum_capture.dart';import 'payments_enum_status.dart';final class UpdatePaymentsRequest {const UpdatePaymentsRequest({required this.idempotencyKey, required this.statusCallback, this.capture, this.status, });
