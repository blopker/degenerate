...
import 'account_incoming_phone_number_incoming_phone_number_local_capabilities.dart';import 'account_incoming_phone_number_incoming_phone_number_local_sms_fallback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_local_sms_method.dart';import 'account_incoming_phone_number_incoming_phone_number_local_status_callback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_local_voice_fallback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_local_voice_method.dart';import 'incoming_phone_number_local_enum_address_requirement.dart';import 'incoming_phone_number_local_enum_emergency_address_status.dart';import 'incoming_phone_number_local_enum_emergency_status.dart';import 'incoming_phone_number_local_enum_voice_receive_mode.dart';final class AccountIncomingPhoneNumberIncomingPhoneNumberLocal {const AccountIncomingPhoneNumberIncomingPhoneNumberLocal({this.accountSid, this.addressSid, this.addressRequirements, this.apiVersion, this.beta, this.capabilities, this.dateCreated, this.dateUpdated, this.friendlyName, this.identitySid, this.phoneNumber, this.origin, this.sid, this.smsApplicationSid, this.smsFallbackMethod, this.smsFallbackUrl, this.smsMethod, this.smsUrl, this.statusCallback, this.statusCallbackMethod, this.trunkSid, this.uri, this.voiceReceiveMode, this.voiceApplicationSid, this.voiceCallerIdLookup, this.voiceFallbackMethod, this.voiceFallbackUrl, this.voiceMethod, this.voiceUrl, this.emergencyStatus, this.emergencyAddressSid, this.emergencyAddressStatus, this.bundleSid, this.status, });
...
factory AccountIncomingPhoneNumberIncomingPhoneNumberLocal.fromJson(Map<String, dynamic> json) { return AccountIncomingPhoneNumberIncomingPhoneNumberLocal(
  ...
  capabilities: json['capabilities'] != null
        ? AccountIncomingPhoneNumberIncomingPhoneNumberLocalCapabilities.fromJson(json['capabilities'] as Map<String, dynamic>)
        : null,
