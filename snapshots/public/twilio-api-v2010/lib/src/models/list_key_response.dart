...
import 'package:collection/collection.dart';import 'account_key.dart';final class ListKeyResponse {const ListKeyResponse({this.keys, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
