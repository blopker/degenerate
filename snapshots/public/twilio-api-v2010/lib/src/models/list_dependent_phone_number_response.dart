...
import 'package:collection/collection.dart';import 'account_address_dependent_phone_number.dart';final class ListDependentPhoneNumberResponse {const ListDependentPhoneNumberResponse({this.dependentPhoneNumbers, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListDependentPhoneNumberResponse &&
          const ListEquality<dynamic>().equals(dependentPhoneNumbers, other.dependentPhoneNumbers) &&
          end == other.end &&
