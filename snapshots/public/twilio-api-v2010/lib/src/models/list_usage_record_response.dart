...
import 'package:collection/collection.dart';import 'account_usage_usage_record.dart';final class ListUsageRecordResponse {const ListUsageRecordResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
