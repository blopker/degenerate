...
import 'package:collection/collection.dart';import 'account_usage_usage_record_usage_record_monthly.dart';final class ListUsageRecordMonthlyResponse {const ListUsageRecordMonthlyResponse({this.usageRecords, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
