...
import 'package:collection/collection.dart';import 'account_sip_sip_credential_list_sip_credential.dart';final class ListSipCredentialResponse {const ListSipCredentialResponse({this.credentials, this.end, this.firstPageUri, this.nextPageUri, this.page, this.pageSize, this.previousPageUri, this.start, this.uri, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ListSipCredentialResponse &&
          const ListEquality<dynamic>().equals(credentials, other.credentials) &&
          end == other.end &&
