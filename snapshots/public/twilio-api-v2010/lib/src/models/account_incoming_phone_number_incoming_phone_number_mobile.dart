...
import 'account_incoming_phone_number_incoming_phone_number_mobile_capabilities.dart';import 'account_incoming_phone_number_incoming_phone_number_mobile_sms_fallback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_mobile_sms_method.dart';import 'account_incoming_phone_number_incoming_phone_number_mobile_status_callback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_mobile_voice_fallback_method.dart';import 'account_incoming_phone_number_incoming_phone_number_mobile_voice_method.dart';import 'incoming_phone_number_mobile_enum_address_requirement.dart';import 'incoming_phone_number_mobile_enum_emergency_address_status.dart';import 'incoming_phone_number_mobile_enum_emergency_status.dart';import 'incoming_phone_number_mobile_enum_voice_receive_mode.dart';final class AccountIncomingPhoneNumberIncomingPhoneNumberMobile {const AccountIncomingPhoneNumberIncomingPhoneNumberMobile({this.accountSid, this.addressSid, this.addressRequirements, this.apiVersion, this.beta, this.capabilities, this.dateCreated, this.dateUpdated, this.friendlyName, this.identitySid, this.phoneNumber, this.origin, this.sid, this.smsApplicationSid, this.smsFallbackMethod, this.smsFallbackUrl, this.smsMethod, this.smsUrl, this.statusCallback, this.statusCallbackMethod, this.trunkSid, this.uri, this.voiceReceiveMode, this.voiceApplicationSid, this.voiceCallerIdLookup, this.voiceFallbackMethod, this.voiceFallbackUrl, this.voiceMethod, this.voiceUrl, this.emergencyStatus, this.emergencyAddressSid, this.emergencyAddressStatus, this.bundleSid, this.status, });
