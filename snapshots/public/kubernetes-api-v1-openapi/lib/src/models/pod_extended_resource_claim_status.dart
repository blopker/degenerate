...
import 'package:collection/collection.dart';import 'container_extended_resource_request.dart';/// PodExtendedResourceClaimStatus is stored in the PodStatus for the extended resource requests backed by DRA. It stores the generated name for the corresponding special ResourceClaim created by the scheduler.
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PodExtendedResourceClaimStatus &&
          const ListEquality<dynamic>().equals(requestMappings, other.requestMappings) &&
