...
import 'package:collection/collection.dart';import 'node_selector.dart';import 'preferred_scheduling_term.dart';/// Node affinity is a group of node affinity scheduling rules.
...
factory NodeAffinity.fromJson(Map<String, dynamic> json) { return NodeAffinity(
  ...
  requiredDuringSchedulingIgnoredDuringExecution: json['requiredDuringSchedulingIgnoredDuringExecution'] != null
        ? NodeSelector.fromJson(json['requiredDuringSchedulingIgnoredDuringExecution'] as Map<String, dynamic>)
        : null,
); }
