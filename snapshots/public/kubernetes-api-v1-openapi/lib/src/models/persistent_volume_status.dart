...
factory PersistentVolumeStatus.fromJson(Map<String, dynamic> json) { return PersistentVolumeStatus(
  lastPhaseTransitionTime: json['lastPhaseTransitionTime'] != null ? DateTime.parse(json['lastPhaseTransitionTime'] as String) : null,
...
final DateTime? lastPhaseTransitionTime;
...
Map<String, dynamic> toJson() { return {
  if (lastPhaseTransitionTime != null) 'lastPhaseTransitionTime': lastPhaseTransitionTime?.toIso8601String(),
  'message': ?message,
  'phase': ?phase,
  'reason': ?reason,
}; } 
static bool canParse(Map<String, dynamic> json) { return true; } 
PersistentVolumeStatus copyWith({DateTime Function()? lastPhaseTransitionTime, String Function()? message, String Function()? phase, String Function()? reason, }) { return PersistentVolumeStatus(
