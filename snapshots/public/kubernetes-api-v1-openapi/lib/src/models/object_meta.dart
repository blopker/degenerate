...
import 'package:collection/collection.dart';import 'managed_fields_entry.dart';import 'owner_reference.dart';/// ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
...
factory ObjectMeta.fromJson(Map<String, dynamic> json) { return ObjectMeta(
  ...
  creationTimestamp: json['creationTimestamp'] != null ? DateTime.parse(json['creationTimestamp'] as String) : null,
  deletionGracePeriodSeconds: json['deletionGracePeriodSeconds'] != null ? (json['deletionGracePeriodSeconds'] as num).toInt() : null,
  deletionTimestamp: json['deletionTimestamp'] != null ? DateTime.parse(json['deletionTimestamp'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  ...
  if (creationTimestamp != null) 'creationTimestamp': creationTimestamp?.toIso8601String(),
  'deletionGracePeriodSeconds': ?deletionGracePeriodSeconds,
  if (deletionTimestamp != null) 'deletionTimestamp': deletionTimestamp?.toIso8601String(),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ObjectMeta &&
          ...
          labels == other.labels &&
          const ListEquality<dynamic>().equals(managedFields, other.managedFields) &&
          name == other.name &&
          namespace == other.namespace &&
          const ListEquality<dynamic>().equals(ownerReferences, other.ownerReferences) &&
