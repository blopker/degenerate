...
factory Taint.fromJson(Map<String, dynamic> json) { return Taint(
  ...
  timeAdded: json['timeAdded'] != null ? DateTime.parse(json['timeAdded'] as String) : null,
...
Taint copyWith({String? effect, String? key, DateTime Function()? timeAdded, String Function()? value, }) { return Taint(
