...
factory NodeCondition.fromJson(Map<String, dynamic> json) { return NodeCondition(
  lastHeartbeatTime: json['lastHeartbeatTime'] != null ? DateTime.parse(json['lastHeartbeatTime'] as String) : null,
  lastTransitionTime: json['lastTransitionTime'] != null ? DateTime.parse(json['lastTransitionTime'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  if (lastHeartbeatTime != null) 'lastHeartbeatTime': lastHeartbeatTime?.toIso8601String(),
  if (lastTransitionTime != null) 'lastTransitionTime': lastTransitionTime?.toIso8601String(),
  'message': ?message,
  'reason': ?reason,
  'status': status,
  'type': type,
...
NodeCondition copyWith({DateTime Function()? lastHeartbeatTime, DateTime Function()? lastTransitionTime, String Function()? message, String Function()? reason, String? status, String? type, }) { return NodeCondition(
