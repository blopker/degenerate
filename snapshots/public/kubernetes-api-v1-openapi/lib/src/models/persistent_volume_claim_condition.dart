...
factory PersistentVolumeClaimCondition.fromJson(Map<String, dynamic> json) { return PersistentVolumeClaimCondition(
  lastProbeTime: json['lastProbeTime'] != null ? DateTime.parse(json['lastProbeTime'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  if (lastProbeTime != null) 'lastProbeTime': lastProbeTime?.toIso8601String(),
...
PersistentVolumeClaimCondition copyWith({DateTime Function()? lastProbeTime, DateTime Function()? lastTransitionTime, String Function()? message, String Function()? reason, String? status, String? type, }) { return PersistentVolumeClaimCondition(
