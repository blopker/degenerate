...
import 'package:collection/collection.dart';import 'label_selector.dart';/// Defines a set of pods (namely those matching the labelSelector relative to the given namespace(s)) that this pod should be co-located (affinity) or not co-located (anti-affinity) with, where co-located is defined as running on a node whose value of the label with key `<topologyKey>` matches that of any node on which a pod of the set of pods is running
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PodAffinityTerm &&
          ...
          const ListEquality<dynamic>().equals(mismatchLabelKeys, other.mismatchLabelKeys) &&
