...
import 'event_series.dart';import 'event_source.dart';import 'object_meta.dart';import 'object_reference.dart';/// Event is a report of an event somewhere in the cluster.  Events have a limited retention time and triggers and messages may evolve with time.  Event consumers should not rely on the timing of an event with a given Reason reflecting a consistent underlying trigger, or the continued existence of events with that Reason.  Events should be treated as informative, best-effort, supplemental data.
...
factory Event.fromJson(Map<String, dynamic> json) { return Event(
  ...
  eventTime: json['eventTime'] != null ? DateTime.parse(json['eventTime'] as String) : null,
  firstTimestamp: json['firstTimestamp'] != null ? DateTime.parse(json['firstTimestamp'] as String) : null,
  involvedObject: ObjectReference.fromJson(json['involvedObject'] as Map<String, dynamic>),
  kind: json['kind'] as String?,
  lastTimestamp: json['lastTimestamp'] != null ? DateTime.parse(json['lastTimestamp'] as String) : null,
...
Map<String, dynamic> toJson() { return {
  ...
  if (firstTimestamp != null) 'firstTimestamp': firstTimestamp?.toIso8601String(),
  'involvedObject': involvedObject.toJson(),
  'kind': ?kind,
  if (lastTimestamp != null) 'lastTimestamp': lastTimestamp?.toIso8601String(),
  'message': ?message,
...
Event copyWith({String Function()? action, String Function()? apiVersion, int Function()? count, DateTime Function()? eventTime, DateTime Function()? firstTimestamp, ObjectReference? involvedObject, String Function()? kind, DateTime Function()? lastTimestamp, String Function()? message, ObjectMeta? metadata, String Function()? reason, ObjectReference Function()? related, String Function()? reportingComponent, String Function()? reportingInstance, EventSeries Function()? series, EventSource Function()? source, String Function()? type, }) { return Event(
