...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'affinity.dart';import 'container.dart';import 'ephemeral_container.dart';import 'host_alias.dart';import 'local_object_reference.dart';import 'pod_dns_config.dart';import 'pod_os.dart';import 'pod_readiness_gate.dart';import 'pod_resource_claim.dart';import 'pod_scheduling_gate.dart';import 'pod_security_context.dart';import 'resource_quantity.dart';import 'resource_requirements.dart';import 'toleration.dart';import 'topology_spread_constraint.dart';import 'volume.dart';import 'workload_reference.dart';/// PodSpec is a description of a pod.
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PodSpec &&
          ...
          const ListEquality<dynamic>().equals(containers, other.containers) &&
          dnsConfig == other.dnsConfig &&
          dnsPolicy == other.dnsPolicy &&
          enableServiceLinks == other.enableServiceLinks &&
          const ListEquality<dynamic>().equals(ephemeralContainers, other.ephemeralContainers) &&
          const ListEquality<dynamic>().equals(hostAliases, other.hostAliases) &&
          ...
          const ListEquality<dynamic>().equals(imagePullSecrets, other.imagePullSecrets) &&
          const ListEquality<dynamic>().equals(initContainers, other.initContainers) &&
          ...
          const ListEquality<dynamic>().equals(readinessGates, other.readinessGates) &&
          const ListEquality<dynamic>().equals(resourceClaims, other.resourceClaims) &&
          resources == other.resources &&
          restartPolicy == other.restartPolicy &&
          runtimeClassName == other.runtimeClassName &&
          schedulerName == other.schedulerName &&
          const ListEquality<dynamic>().equals(schedulingGates, other.schedulingGates) &&
          ...
          const ListEquality<dynamic>().equals(tolerations, other.tolerations) &&
          const ListEquality<dynamic>().equals(topologySpreadConstraints, other.topologySpreadConstraints) &&
