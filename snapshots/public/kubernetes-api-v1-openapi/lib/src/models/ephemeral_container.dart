...
import 'package:collection/collection.dart';import 'container_port.dart';import 'container_resize_policy.dart';import 'container_restart_rule.dart';import 'env_from_source.dart';import 'env_var.dart';import 'lifecycle.dart';import 'probe.dart';import 'resource_requirements.dart';import 'security_context.dart';import 'volume_device.dart';import 'volume_mount.dart';/// An EphemeralContainer is a temporary container that you may add to an existing Pod for user-initiated activities such as debugging. Ephemeral containers have no resource or scheduling guarantees, and they will not be restarted when they exit or when a Pod is removed or restarted. The kubelet may evict a Pod if an ephemeral container causes the Pod to exceed its resource allocation.
/// 
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is EphemeralContainer &&
          ...
          const ListEquality<dynamic>().equals(resizePolicy, other.resizePolicy) &&
          resources == other.resources &&
          restartPolicy == other.restartPolicy &&
          const ListEquality<dynamic>().equals(restartPolicyRules, other.restartPolicyRules) &&
          ...
          tty == other.tty &&
          const ListEquality<dynamic>().equals(volumeDevices, other.volumeDevices) &&
          const ListEquality<dynamic>().equals(volumeMounts, other.volumeMounts) &&
