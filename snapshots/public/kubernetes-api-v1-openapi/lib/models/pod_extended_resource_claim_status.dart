...
@immutable final class PodExtendedResourceClaimStatus {const PodExtendedResourceClaimStatus({required this.requestMappings, required this.resourceClaimName, });
