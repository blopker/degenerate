...
import 'local_object_reference.dart';/// FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.
final class FlexVolumeSource {const FlexVolumeSource({this.driver = '', this.fsType, this.options, this.readOnly, this.secretRef, });
...
FlexVolumeSource copyWith({String? driver, String Function()? fsType, Map<String, String> Function()? options, bool Function()? readOnly, LocalObjectReference Function()? secretRef, }) { return FlexVolumeSource(
...
@override String toString() { return 'FlexVolumeSource(driver: $driver, fsType: $fsType, options: $options, readOnly: $readOnly, secretRef: $secretRef)'; } 
 }
