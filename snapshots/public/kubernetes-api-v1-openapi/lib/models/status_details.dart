...
import 'package:collection/collection.dart';import 'status_cause.dart';/// StatusDetails is a set of additional properties that MAY be set by the server to provide additional information about a response. The Reason field of a Status object defines what attributes will be set. Clients must ignore fields that do not match the defined type of each attribute, and should assume that any attribute may be empty, invalid, or under defined.
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is StatusDetails &&
          const ListEquality<dynamic>().equals(causes, other.causes) &&
          group == other.group &&
          kind == other.kind &&
          name == other.name &&
