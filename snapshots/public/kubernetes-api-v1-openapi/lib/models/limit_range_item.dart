...
@immutable final class LimitRangeItem {const LimitRangeItem({required this.type, this.$default, this.defaultRequest, this.max, this.maxLimitRequestRatio, this.min, });
