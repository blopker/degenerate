...
final class ContainerStatus {const ContainerStatus({this.allocatedResources, this.allocatedResourcesStatus, this.containerId, this.image = '', this.imageId = '', this.lastState, this.name = '', this.ready = false, this.resources, this.restartCount = 0, this.started, this.state, this.stopSignal, this.user, this.volumeMounts, });
