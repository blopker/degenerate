...
factory ServiceSpec.fromJson(Map<String, dynamic> json) { return ServiceSpec(
  ...
  externalIPs: (json['externalIPs'] as List<dynamic>?)?.map((e) => e as String).toList(),
  externalName: json['externalName'] as String?,
  externalTrafficPolicy: json['externalTrafficPolicy'] as String?,
  healthCheckNodePort: json['healthCheckNodePort'] != null ? (json['healthCheckNodePort'] as num).toInt() : null,
  internalTrafficPolicy: json['internalTrafficPolicy'] as String?,
  ipFamilies: (json['ipFamilies'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ...
  loadBalancerSourceRanges: (json['loadBalancerSourceRanges'] as List<dynamic>?)?.map((e) => e as String).toList(),
  ports: (json['ports'] as List<dynamic>?)?.map((e) => ServicePort.fromJson(e as Map<String, dynamic>)).toList(),
...
ServiceSpec copyWith({bool Function()? allocateLoadBalancerNodePorts, String Function()? clusterIp, List<String> Function()? clusterIPs, List<String> Function()? externalIPs, String Function()? externalName, String Function()? externalTrafficPolicy, int Function()? healthCheckNodePort, String Function()? internalTrafficPolicy, List<String> Function()? ipFamilies, String Function()? ipFamilyPolicy, String Function()? loadBalancerClass, String Function()? loadBalancerIp, List<String> Function()? loadBalancerSourceRanges, List<ServicePort> Function()? ports, bool Function()? publishNotReadyAddresses, Map<String, String> Function()? selector, String Function()? sessionAffinity, SessionAffinityConfig Function()? sessionAffinityConfig, String Function()? trafficDistribution, String Function()? type, }) { return ServiceSpec(
  ...
  externalIPs: externalIPs != null ? externalIPs() : this.externalIPs,
  externalName: externalName != null ? externalName() : this.externalName,
  externalTrafficPolicy: externalTrafficPolicy != null ? externalTrafficPolicy() : this.externalTrafficPolicy,
  healthCheckNodePort: healthCheckNodePort != null ? healthCheckNodePort() : this.healthCheckNodePort,
  internalTrafficPolicy: internalTrafficPolicy != null ? internalTrafficPolicy() : this.internalTrafficPolicy,
  ipFamilies: ipFamilies != null ? ipFamilies() : this.ipFamilies,
  ipFamilyPolicy: ipFamilyPolicy != null ? ipFamilyPolicy() : this.ipFamilyPolicy,
  loadBalancerClass: loadBalancerClass != null ? loadBalancerClass() : this.loadBalancerClass,
  loadBalancerIp: loadBalancerIp != null ? loadBalancerIp() : this.loadBalancerIp,
  loadBalancerSourceRanges: loadBalancerSourceRanges != null ? loadBalancerSourceRanges() : this.loadBalancerSourceRanges,
  ports: ports != null ? ports() : this.ports,
  publishNotReadyAddresses: publishNotReadyAddresses != null ? publishNotReadyAddresses() : this.publishNotReadyAddresses,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ServiceSpec &&
          ...
          listEquals(clusterIPs, other.clusterIPs) &&
          listEquals(externalIPs, other.externalIPs) &&
