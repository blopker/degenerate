...
@immutable final class ReplicationControllerCondition {const ReplicationControllerCondition({required this.status, required this.type, this.lastTransitionTime, this.message, this.reason, });
