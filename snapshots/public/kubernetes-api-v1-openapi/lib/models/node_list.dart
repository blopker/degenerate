...
final class NodeList {const NodeList({this.apiVersion, required this.items, this.kind, this.metadata, });
...
@override String toString() { return 'NodeList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)'; } 
 }
