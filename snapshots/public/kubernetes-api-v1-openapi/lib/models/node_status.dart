...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is NodeStatus &&
          ...
          const ListEquality<dynamic>().equals(declaredFeatures, other.declaredFeatures) &&
          features == other.features &&
          const ListEquality<dynamic>().equals(images, other.images) &&
          nodeInfo == other.nodeInfo &&
          phase == other.phase &&
          const ListEquality<dynamic>().equals(runtimeHandlers, other.runtimeHandlers) &&
          const ListEquality<dynamic>().equals(volumesAttached, other.volumesAttached) &&
          const ListEquality<dynamic>().equals(volumesInUse, other.volumesInUse); } 
