...
@immutable final class PodCondition {const PodCondition({required this.status, required this.type, this.lastProbeTime, this.lastTransitionTime, this.message, this.observedGeneration, this.reason, });
