...
@immutable final class ScopedResourceSelectorRequirement {const ScopedResourceSelectorRequirement({required this.$operator, required this.scopeName, this.values, });
