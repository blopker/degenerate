...
@immutable final class ContainerExtendedResourceRequest {const ContainerExtendedResourceRequest({required this.containerName, required this.requestName, required this.resourceName, });
