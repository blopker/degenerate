...
factory ConfigMapList.fromJson(Map<String, dynamic> json) { return ConfigMapList(
  ...
  items: (json['items'] as List<dynamic>).map((e) => ConfigMap.fromJson(e as Map<String, dynamic>)).toList(),
...
ConfigMapList copyWith({String Function()? apiVersion, List<ConfigMap>? items, String Function()? kind, ListMeta Function()? metadata, }) { return ConfigMapList(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ConfigMapList &&
          apiVersion == other.apiVersion &&
          listEquals(items, other.items) &&
          kind == other.kind &&
          metadata == other.metadata; } 
@override int get hashCode { return Object.hash(apiVersion, Object.hashAll(items), kind, metadata); } 
@override String toString() { return 'ConfigMapList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)'; } 
 }
