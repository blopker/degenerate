...
@immutable final class PersistentVolumeClaimCondition {const PersistentVolumeClaimCondition({required this.status, required this.type, this.lastProbeTime, this.lastTransitionTime, this.message, this.reason, });
