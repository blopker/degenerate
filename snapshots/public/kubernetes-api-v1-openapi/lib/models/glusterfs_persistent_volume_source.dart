...
@immutable final class GlusterfsPersistentVolumeSource {const GlusterfsPersistentVolumeSource({required this.endpoints, required this.path, this.endpointsNamespace, this.readOnly, });
