...
@immutable final class OwnerReference {const OwnerReference({required this.apiVersion, required this.kind, required this.name, required this.uid, this.blockOwnerDeletion, this.controller, });
