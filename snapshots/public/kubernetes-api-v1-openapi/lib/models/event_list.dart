...
final class EventList {const EventList({this.apiVersion, required this.items, this.kind, this.metadata, });
...
@override String toString() { return 'EventList(apiVersion: $apiVersion, items: $items, kind: $kind, metadata: $metadata)'; } 
 }
