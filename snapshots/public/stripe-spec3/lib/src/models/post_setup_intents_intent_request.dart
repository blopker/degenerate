...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_setup_intents_intent_request_excluded_payment_method_types.dart';import 'post_setup_intents_intent_request_metadata.dart';import 'post_setup_intents_intent_request_payment_method_data.dart';import 'post_setup_intents_intent_request_payment_method_options.dart';final class PostSetupIntentsIntentRequestFlowDirections {const PostSetupIntentsIntentRequestFlowDirections._(this.value);
...
factory PostSetupIntentsIntentRequest.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentRequest(
  ...
  excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null ? OneOf2.parse(json['excluded_payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostSetupIntentsIntentRequestExcludedPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSetupIntentsIntentRequestExcludedPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostSetupIntentsIntentRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
