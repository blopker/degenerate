...
import 'package:collection/collection.dart';import 'post_setup_intents_intent_request_excluded_payment_method_types.dart';import 'post_setup_intents_intent_request_flow_directions.dart';import 'post_setup_intents_intent_request_metadata.dart';import 'post_setup_intents_intent_request_payment_method_data.dart';import 'post_setup_intents_intent_request_payment_method_options.dart';final class PostSetupIntentsIntentRequest {const PostSetupIntentsIntentRequest({this.attachToSelf, this.customer, this.customerAccount, this.description, this.excludedPaymentMethodTypes, this.expand, this.flowDirections, this.metadata, this.paymentMethod, this.paymentMethodConfiguration, this.paymentMethodData, this.paymentMethodOptions, this.paymentMethodTypes, });
