...
import 'post_checkout_sessions_request_payment_method_options_pix_amount_includes_iof.dart';import 'post_checkout_sessions_request_payment_method_options_pix_setup_future_usage.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsPix {const PostCheckoutSessionsRequestPaymentMethodOptionsPix({this.amountIncludesIof, this.expiresAfterSeconds, this.setupFutureUsage, });
