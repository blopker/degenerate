...
import 'inline_object539_additional_documentation.dart';import 'inline_object539_explanation.dart';import 'inline_object539_received_at.dart';import 'inline_object539_return_description.dart';import 'inline_object539_returned_at.dart';final class InlineObject539ReturnStatus {const InlineObject539ReturnStatus._(this.value);

factory InlineObject539ReturnStatus.fromJson(String json) { return switch (json) {
  '' => $empty,
...
static const InlineObject539ReturnStatus $empty = InlineObject539ReturnStatus._('');

static const InlineObject539ReturnStatus merchantRejected = InlineObject539ReturnStatus._('merchant_rejected');

static const InlineObject539ReturnStatus successful = InlineObject539ReturnStatus._('successful');

static const List<InlineObject539ReturnStatus> values = [$empty, merchantRejected, successful];
...
@override String toString() { return 'InlineObject539ReturnStatus($value)'; } 
 }
...
InlineObject539 copyWith({InlineObject539AdditionalDocumentation Function()? additionalDocumentation, InlineObject539Explanation Function()? explanation, InlineObject539ReceivedAt Function()? receivedAt, InlineObject539ReturnDescription Function()? returnDescription, InlineObject539ReturnStatus Function()? returnStatus, InlineObject539ReturnedAt Function()? returnedAt, }) { return InlineObject539(
...
@override String toString() { return 'InlineObject539(additionalDocumentation: $additionalDocumentation, explanation: $explanation, receivedAt: $receivedAt, returnDescription: $returnDescription, returnStatus: $returnStatus, returnedAt: $returnedAt)'; } 
 }
