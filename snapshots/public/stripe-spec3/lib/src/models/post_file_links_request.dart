...
import 'package:collection/collection.dart';import 'post_file_links_request_metadata.dart';final class PostFileLinksRequest {const PostFileLinksRequest({this.expand, this.expiresAt, required this.file, this.metadata, });
