...
import 'package:collection/collection.dart';import 'billing_credit_balance_summary_customer.dart';import 'billing_credit_balance_summary_object.dart';import 'credit_balance.dart';/// Indicates the billing credit balance for billing credits granted to a customer.
...
factory BillingCreditBalanceSummary.fromJson(Map<String, dynamic> json) { return BillingCreditBalanceSummary(
  ...
  customer: BillingCreditBalanceSummaryCustomer.fromJson(json['customer'] as Map<String, dynamic>),
