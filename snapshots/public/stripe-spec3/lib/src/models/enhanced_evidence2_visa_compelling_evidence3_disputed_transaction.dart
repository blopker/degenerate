...
factory EnhancedEvidence2VisaCompellingEvidence3DisputedTransaction.fromJson(Map<String, dynamic> json) { return EnhancedEvidence2VisaCompellingEvidence3DisputedTransaction(
  customerAccountId: json['customer_account_id'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionCustomerAccountId.fromJson(json['customer_account_id'] as Map<String, dynamic>) : null,
  customerDeviceFingerprint: json['customer_device_fingerprint'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionCustomerDeviceFingerprint.fromJson(json['customer_device_fingerprint'] as Map<String, dynamic>) : null,
  customerDeviceId: json['customer_device_id'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionCustomerDeviceId.fromJson(json['customer_device_id'] as Map<String, dynamic>) : null,
  customerEmailAddress: json['customer_email_address'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionCustomerEmailAddress.fromJson(json['customer_email_address'] as Map<String, dynamic>) : null,
  customerPurchaseIp: json['customer_purchase_ip'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionCustomerPurchaseIp.fromJson(json['customer_purchase_ip'] as Map<String, dynamic>) : null,
  ...
  productDescription: json['product_description'] != null ? EnhancedEvidence2VisaCompellingEvidence3DisputedTransactionProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
