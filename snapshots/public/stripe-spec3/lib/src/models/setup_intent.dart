...
factory SetupIntent.fromJson(Map<String, dynamic> json) { return SetupIntent(
  ...
  latestAttempt: json['latest_attempt'] != null ? OneOf2.parse(json['latest_attempt'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SetupAttempt.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupAttempt.canParse(v),) : null,
  ...
  singleUseMandate: json['single_use_mandate'] != null ? OneOf2.parse(json['single_use_mandate'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Mandate.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Mandate.canParse(v),) : null,
