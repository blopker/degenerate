...
import 'package:collection/collection.dart';import 'post_apps_secrets_request_scope.dart';final class PostAppsSecretsRequest {const PostAppsSecretsRequest({this.expand, this.expiresAt, required this.name, required this.payload, required this.scope, });
