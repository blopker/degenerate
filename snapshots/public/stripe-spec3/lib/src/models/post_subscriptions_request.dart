...
import 'package:collection/collection.dart';import 'post_subscriptions_request_add_invoice_items.dart';import 'post_subscriptions_request_application_fee_percent.dart';import 'post_subscriptions_request_automatic_tax.dart';import 'post_subscriptions_request_billing_cycle_anchor_config.dart';import 'post_subscriptions_request_billing_mode.dart';import 'post_subscriptions_request_billing_thresholds.dart';import 'post_subscriptions_request_cancel_at.dart';import 'post_subscriptions_request_collection_method.dart';import 'post_subscriptions_request_default_tax_rates.dart';import 'post_subscriptions_request_discounts.dart';import 'post_subscriptions_request_invoice_settings.dart';import 'post_subscriptions_request_items.dart';import 'post_subscriptions_request_metadata.dart';import 'post_subscriptions_request_on_behalf_of.dart';import 'post_subscriptions_request_payment_behavior.dart';import 'post_subscriptions_request_payment_settings.dart';import 'post_subscriptions_request_pending_invoice_item_interval.dart';import 'post_subscriptions_request_proration_behavior.dart';import 'post_subscriptions_request_transfer_data.dart';import 'post_subscriptions_request_trial_end.dart';import 'post_subscriptions_request_trial_settings.dart';final class PostSubscriptionsRequest {const PostSubscriptionsRequest({this.addInvoiceItems, this.applicationFeePercent, this.automaticTax, this.backdateStartDate, this.billingCycleAnchor, this.billingCycleAnchorConfig, this.billingMode, this.billingThresholds, this.cancelAt, this.cancelAtPeriodEnd, this.collectionMethod, this.currency, this.customer, this.customerAccount, this.daysUntilDue, this.defaultPaymentMethod, this.defaultSource, this.defaultTaxRates, this.description, this.discounts, this.expand, this.invoiceSettings, this.items, this.metadata, this.offSession, this.onBehalfOf, this.paymentBehavior, this.paymentSettings, this.pendingInvoiceItemInterval, this.prorationBehavior, this.transferData, this.trialEnd, this.trialFromPlan, this.trialPeriodDays, this.trialSettings, });
