...
factory PostSubscriptionsRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequest(
  ...
  applicationFeePercent: json['application_fee_percent'] != null ? OneOf2.parse(json['application_fee_percent'], fromA: (v) => (v as num).toDouble(), canParseA: (v) => v is num, fromB: (v) => PostSubscriptionsRequestApplicationFeePercentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => BillingThresholdsParam8.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingThresholdsParam8.canParse(v), fromB: (v) => PostSubscriptionsRequestBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cancelAt: json['cancel_at'] != null ? OneOf2.parse(json['cancel_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSubscriptionsRequestCancelAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsRequestDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  description: json['description'] as String?,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionsRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostSubscriptionsRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  offSession: json['off_session'] as bool?,
  onBehalfOf: json['on_behalf_of'] != null ? OneOf2.parse(json['on_behalf_of'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSubscriptionsRequestOnBehalfOfVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  pendingInvoiceItemInterval: json['pending_invoice_item_interval'] != null ? OneOf2.parse(json['pending_invoice_item_interval'], fromA: (v) => PendingInvoiceItemIntervalParams3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PendingInvoiceItemIntervalParams3.canParse(v), fromB: (v) => PostSubscriptionsRequestPendingInvoiceItemIntervalVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  trialEnd: json['trial_end'] != null ? OneOf2.parse(json['trial_end'], fromA: (v) => PostSubscriptionsRequestTrialEndVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
