...
factory PostIssuingCardsRequestShipping.fromJson(Map<String, dynamic> json) { return PostIssuingCardsRequestShipping(
  ...
  addressValidation: json['address_validation'] != null
        ? PostIssuingCardsRequestShippingAddressValidation.fromJson(json['address_validation'] as Map<String, dynamic>)
        : null,
  customs: json['customs'] != null
        ? PostIssuingCardsRequestShippingCustoms.fromJson(json['customs'] as Map<String, dynamic>)
        : null,
