...
factory IssuingDisputeDuplicateEvidence.fromJson(Map<String, dynamic> json) { return IssuingDisputeDuplicateEvidence(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
  cardStatement: json['card_statement'] != null ? OneOf2.parse(json['card_statement'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
  cashReceipt: json['cash_receipt'] != null ? OneOf2.parse(json['cash_receipt'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
  checkImage: json['check_image'] != null ? OneOf2.parse(json['check_image'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
