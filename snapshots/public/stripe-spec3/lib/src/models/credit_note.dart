...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'billing_bill_resource_invoicing_taxes_tax.dart';import 'credit_note_customer.dart';import 'credit_note_customer_balance_transaction.dart';import 'credit_note_invoice.dart';import 'credit_note_lines.dart';import 'credit_note_refund.dart';import 'credit_note_shipping_cost.dart';import 'credit_notes_pretax_credit_amount.dart';import 'discounts_resource_discount_amount.dart';/// String representing the object's type. Objects of the same type share the same value.
...
factory CreditNote.fromJson(Map<String, dynamic> json) { return CreditNote(
  ...
  customerBalanceTransaction: json['customer_balance_transaction'] != null ? OneOf2.parse(json['customer_balance_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CustomerBalanceTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CustomerBalanceTransaction.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is CreditNote &&
          ...
          const ListEquality<dynamic>().equals(pretaxCreditAmounts, other.pretaxCreditAmounts) &&
          reason == other.reason &&
