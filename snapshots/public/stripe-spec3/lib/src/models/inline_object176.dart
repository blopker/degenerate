...
import 'inline_object176_shipping_rate_data.dart';final class InlineObject176 {const InlineObject176({this.shippingRate, this.shippingRateData, });
...
InlineObject176 copyWith({String Function()? shippingRate, InlineObject176ShippingRateData Function()? shippingRateData, }) { return InlineObject176(
...
@override String toString() { return 'InlineObject176(shippingRate: $shippingRate, shippingRateData: $shippingRateData)'; } 
 }
