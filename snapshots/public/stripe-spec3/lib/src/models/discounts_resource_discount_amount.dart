...
factory DiscountsResourceDiscountAmount.fromJson(Map<String, dynamic> json) { return DiscountsResourceDiscountAmount(
  ...
  discount: OneOf3.parse(json['discount'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Discount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Discount.canParse(v), fromC: (v) => DeletedDiscount.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DeletedDiscount.canParse(v),),
); }
