...
import 'package:collection/collection.dart';import 'post_billing_meters_request_customer_mapping.dart';import 'post_billing_meters_request_default_aggregation.dart';import 'post_billing_meters_request_event_time_window.dart';import 'post_billing_meters_request_value_settings.dart';final class PostBillingMetersRequest {const PostBillingMetersRequest({this.customerMapping, required this.defaultAggregation, required this.displayName, required this.eventName, this.eventTimeWindow, this.expand, this.valueSettings, });
