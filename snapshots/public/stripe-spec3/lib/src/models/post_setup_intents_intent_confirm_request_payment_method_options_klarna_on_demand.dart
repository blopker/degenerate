...
import 'post_setup_intents_intent_confirm_request_payment_method_options_klarna_on_demand_purchase_interval.dart';final class PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsKlarnaOnDemand {const PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsKlarnaOnDemand({this.averageAmount, this.maximumAmount, this.minimumAmount, this.purchaseInterval, this.purchaseIntervalCount, });
