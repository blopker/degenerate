...
factory PostSubscriptionSchedulesRequestDefaultSettings.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequestDefaultSettings(
  ...
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => BillingThresholdsParam4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingThresholdsParam4.canParse(v), fromB: (v) => PostSubscriptionSchedulesRequestDefaultSettingsBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSubscriptionSchedulesRequestDefaultSettingsDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  onBehalfOf: json['on_behalf_of'] != null ? OneOf2.parse(json['on_behalf_of'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSubscriptionSchedulesRequestDefaultSettingsOnBehalfOfVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  transferData: json['transfer_data'] != null ? OneOf2.parse(json['transfer_data'], fromA: (v) => TransferDataSpecs5.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TransferDataSpecs5.canParse(v), fromB: (v) => PostSubscriptionSchedulesRequestDefaultSettingsTransferDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
