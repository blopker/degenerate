...
final class InlineObject1356 {const InlineObject1356({this.amountGte, this.resetBillingCycleAnchor, });

factory InlineObject1356.fromJson(Map<String, dynamic> json) { return InlineObject1356(
...
InlineObject1356 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject1356(
...
@override String toString() { return 'InlineObject1356(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
