...
factory PostPaymentIntentsIntentConfirmRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentConfirmRequest(
  amountDetails: json['amount_details'] != null ? OneOf2.parse(json['amount_details'], fromA: (v) => AmountDetailsParam2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AmountDetailsParam2.canParse(v), fromB: (v) => PostPaymentIntentsIntentConfirmRequestAmountDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null ? OneOf2.parse(json['excluded_payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentIntentsIntentConfirmRequestExcludedPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentIntentsIntentConfirmRequestExcludedPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  mandateData: json['mandate_data'] != null ? OneOf3.parse(json['mandate_data'], fromA: (v) => SecretKeyParam2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SecretKeyParam2.canParse(v), fromB: (v) => PostPaymentIntentsIntentConfirmRequestMandateDataVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => ClientKeyParam.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ClientKeyParam.canParse(v),) : null,
  offSession: json['off_session'] != null ? OneOf2.parse(json['off_session'], fromA: (v) => v as bool, canParseA: (v) => v is bool, fromB: (v) => PostPaymentIntentsIntentConfirmRequestOffSessionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  paymentDetails: json['payment_details'] != null ? OneOf2.parse(json['payment_details'], fromA: (v) => PaymentDetails2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PaymentDetails2.canParse(v), fromB: (v) => PostPaymentIntentsIntentConfirmRequestPaymentDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  receiptEmail: json['receipt_email'] != null ? OneOf2.parse(json['receipt_email'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentIntentsIntentConfirmRequestReceiptEmailVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => OptionalFieldsShipping2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && OptionalFieldsShipping2.canParse(v), fromB: (v) => PostPaymentIntentsIntentConfirmRequestShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
