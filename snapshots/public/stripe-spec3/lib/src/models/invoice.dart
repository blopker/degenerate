...
factory Invoice.fromJson(Map<String, dynamic> json) { return Invoice(
  ...
  discounts: (json['discounts'] as List<dynamic>).map((e) => OneOf3.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Discount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Discount.canParse(v), fromC: (v) => DeletedDiscount.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DeletedDiscount.canParse(v),)).toList(),
  ...
  latestRevision: json['latest_revision'] != null ? OneOf2.parse(json['latest_revision'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Invoice.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Invoice.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Invoice &&
          ...
          const ListEquality<dynamic>().equals(customerTaxIds, other.customerTaxIds) &&
          ...
          total == other.total &&
          const ListEquality<dynamic>().equals(totalDiscountAmounts, other.totalDiscountAmounts) &&
          totalExcludingTax == other.totalExcludingTax &&
          const ListEquality<dynamic>().equals(totalPretaxCreditAmounts, other.totalPretaxCreditAmounts) &&
          const ListEquality<dynamic>().equals(totalTaxes, other.totalTaxes) &&
