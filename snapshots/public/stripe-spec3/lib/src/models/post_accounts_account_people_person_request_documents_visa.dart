...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_people_person_request_documents_visa_files.dart';final class PostAccountsAccountPeoplePersonRequestDocumentsVisa {const PostAccountsAccountPeoplePersonRequestDocumentsVisa({this.files});
...
factory PostAccountsAccountPeoplePersonRequestDocumentsVisa.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequestDocumentsVisa(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPeoplePersonRequestDocumentsVisaFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
