...
factory PaymentIntentPaymentMethodOptionsParam15MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam15MandateOptions(
  customMandateUrl: json['custom_mandate_url'] != null ? OneOf2.parse(json['custom_mandate_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentPaymentMethodOptionsParam15MandateOptionsCustomMandateUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
