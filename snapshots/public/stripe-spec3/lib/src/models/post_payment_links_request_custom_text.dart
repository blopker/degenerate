...
factory PostPaymentLinksRequestCustomText.fromJson(Map<String, dynamic> json) { return PostPaymentLinksRequestCustomText(
  afterSubmit: json['after_submit'] != null ? OneOf2.parse(json['after_submit'], fromA: (v) => CustomTextPositionParam5.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam5.canParse(v), fromB: (v) => PostPaymentLinksRequestCustomTextAfterSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippingAddress: json['shipping_address'] != null ? OneOf2.parse(json['shipping_address'], fromA: (v) => CustomTextPositionParam6.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam6.canParse(v), fromB: (v) => PostPaymentLinksRequestCustomTextShippingAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  submit: json['submit'] != null ? OneOf2.parse(json['submit'], fromA: (v) => CustomTextPositionParam7.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam7.canParse(v), fromB: (v) => PostPaymentLinksRequestCustomTextSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  termsOfServiceAcceptance: json['terms_of_service_acceptance'] != null ? OneOf2.parse(json['terms_of_service_acceptance'], fromA: (v) => CustomTextPositionParam8.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam8.canParse(v), fromB: (v) => PostPaymentLinksRequestCustomTextTermsOfServiceAcceptanceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
