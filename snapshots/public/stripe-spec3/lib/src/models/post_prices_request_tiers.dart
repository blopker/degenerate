...
factory PostPricesRequestTiers.fromJson(Map<String, dynamic> json) { return PostPricesRequestTiers(
  ...
  upTo: OneOf2.parse(json['up_to'], fromA: (v) => PostPricesRequestTiersUpToVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,),
); }
