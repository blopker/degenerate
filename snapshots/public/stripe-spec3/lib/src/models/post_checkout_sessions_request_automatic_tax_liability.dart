...
import 'post_checkout_sessions_request_automatic_tax_liability_type.dart';final class PostCheckoutSessionsRequestAutomaticTaxLiability {const PostCheckoutSessionsRequestAutomaticTaxLiability({this.account, required this.type, });
