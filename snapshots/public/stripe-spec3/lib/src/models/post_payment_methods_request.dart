...
factory PostPaymentMethodsRequest.fromJson(Map<String, dynamic> json) { return PostPaymentMethodsRequest(
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CardDetailsParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CardDetailsParams.canParse(v), fromB: (v) => TokenParams.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TokenParams.canParse(v),) : null,
