...
factory PostPaymentLinksPaymentLinkRequestSubscriptionData.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequestSubscriptionData(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentLinksPaymentLinkRequestSubscriptionDataMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  trialPeriodDays: json['trial_period_days'] != null ? OneOf2.parse(json['trial_period_days'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostPaymentLinksPaymentLinkRequestSubscriptionDataTrialPeriodDaysVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  trialSettings: json['trial_settings'] != null ? OneOf2.parse(json['trial_settings'], fromA: (v) => TrialSettingsConfig.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TrialSettingsConfig.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestSubscriptionDataTrialSettingsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
