...
import 'package:collection/collection.dart';final class DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdRequest {const DeleteCustomersCustomerSubscriptionsSubscriptionExposedIdRequest({this.expand, this.invoiceNow, this.prorate, });
