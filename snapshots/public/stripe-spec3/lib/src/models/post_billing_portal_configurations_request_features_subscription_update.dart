...
factory PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate(
  ...
  defaultAllowedUpdates: json['default_allowed_updates'] != null ? OneOf2.parse(json['default_allowed_updates'], fromA: (v) => (v as List<dynamic>).map((e) => PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateDefaultAllowedUpdatesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateDefaultAllowedUpdatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  enabled: json['enabled'] as bool,
  products: json['products'] != null ? OneOf2.parse(json['products'], fromA: (v) => (v as List<dynamic>).map((e) => PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateProductsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateProductsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
