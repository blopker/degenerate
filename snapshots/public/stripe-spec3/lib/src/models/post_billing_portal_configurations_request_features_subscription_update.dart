...
import 'post_billing_portal_configurations_request_features_subscription_update_billing_cycle_anchor.dart';import 'post_billing_portal_configurations_request_features_subscription_update_default_allowed_updates.dart';import 'post_billing_portal_configurations_request_features_subscription_update_products.dart';import 'post_billing_portal_configurations_request_features_subscription_update_proration_behavior.dart';import 'post_billing_portal_configurations_request_features_subscription_update_schedule_at_period_end.dart';import 'post_billing_portal_configurations_request_features_subscription_update_trial_update_behavior.dart';final class PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate {const PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate({this.billingCycleAnchor, this.defaultAllowedUpdates, required this.enabled, this.products, this.prorationBehavior, this.scheduleAtPeriodEnd, this.trialUpdateBehavior, });
...
factory PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdate(
  ...
  defaultAllowedUpdates: json['default_allowed_updates'] != null
        ? PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateDefaultAllowedUpdates.fromJson(json['default_allowed_updates'] as Map<String, dynamic>)
        : null,
  enabled: json['enabled'] as bool,
  products: json['products'] != null
        ? PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateProducts.fromJson(json['products'] as Map<String, dynamic>)
        : null,
  ...
  scheduleAtPeriodEnd: json['schedule_at_period_end'] != null
        ? PostBillingPortalConfigurationsRequestFeaturesSubscriptionUpdateScheduleAtPeriodEnd.fromJson(json['schedule_at_period_end'] as Map<String, dynamic>)
        : null,
