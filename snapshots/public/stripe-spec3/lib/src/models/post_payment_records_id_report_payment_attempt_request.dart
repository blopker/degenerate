...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_payment_records_id_report_payment_attempt_request_failed.dart';import 'post_payment_records_id_report_payment_attempt_request_guaranteed.dart';import 'post_payment_records_id_report_payment_attempt_request_metadata.dart';import 'post_payment_records_id_report_payment_attempt_request_payment_method_details.dart';import 'post_payment_records_id_report_payment_attempt_request_shipping_details.dart';/// The outcome of the reported payment.
...
factory PostPaymentRecordsIdReportPaymentAttemptRequest.fromJson(Map<String, dynamic> json) { return PostPaymentRecordsIdReportPaymentAttemptRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentRecordsIdReportPaymentAttemptRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
