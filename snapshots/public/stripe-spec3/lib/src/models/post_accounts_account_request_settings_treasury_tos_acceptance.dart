...
factory PostAccountsAccountRequestSettingsTreasuryTosAcceptance.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestSettingsTreasuryTosAcceptance(
  ...
  userAgent: json['user_agent'] != null ? OneOf2.parse(json['user_agent'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountRequestSettingsTreasuryTosAcceptanceUserAgentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
