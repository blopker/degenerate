...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'credit_note_refund_payment_record_refund.dart';import 'credit_note_refund_refund.dart';/// Type of the refund, one of `refund` or `payment_record_refund`.
...
factory CreditNoteRefund.fromJson(Map<String, dynamic> json) { return CreditNoteRefund(
  ...
  refund: OneOf2.parse(json['refund'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Refund.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Refund.canParse(v),),
