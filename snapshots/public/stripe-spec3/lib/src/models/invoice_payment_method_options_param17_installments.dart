...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'invoice_payment_method_options_param17_installments_plan.dart';final class InvoicePaymentMethodOptionsParam17Installments {const InvoicePaymentMethodOptionsParam17Installments({this.enabled, this.plan, });
...
factory InvoicePaymentMethodOptionsParam17Installments.fromJson(Map<String, dynamic> json) { return InvoicePaymentMethodOptionsParam17Installments(
  ...
  plan: json['plan'] != null ? OneOf2.parse(json['plan'], fromA: (v) => InstallmentPlan.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InstallmentPlan.canParse(v), fromB: (v) => InvoicePaymentMethodOptionsParam17InstallmentsPlanVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
