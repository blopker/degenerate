...
factory PostCustomersCustomerBankAccountsRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerBankAccountsRequest(
  ...
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => CustomerPaymentSourceBankAccount2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceBankAccount2.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CustomerPaymentSourceCard3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceCard3.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
