...
factory PostSubscriptionSchedulesRequestDefaultSettingsInvoiceSettings.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequestDefaultSettingsInvoiceSettings(
  accountTaxIds: json['account_tax_ids'] != null
        ? PostSubscriptionSchedulesRequestDefaultSettingsInvoiceSettingsAccountTaxIds.fromJson(json['account_tax_ids'] as Map<String, dynamic>)
        : null,
  daysUntilDue: json['days_until_due'] != null ? (json['days_until_due'] as num).toInt() : null,
  issuer: json['issuer'] != null
        ? PostSubscriptionSchedulesRequestDefaultSettingsInvoiceSettingsIssuer.fromJson(json['issuer'] as Map<String, dynamic>)
        : null,
); }
