...
factory PostIssuingPersonalizationDesignsRequestCarrierText.fromJson(Map<String, dynamic> json) { return PostIssuingPersonalizationDesignsRequestCarrierText(
  footerBody: json['footer_body'] != null ? OneOf2.parse(json['footer_body'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsRequestCarrierTextFooterBodyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  footerTitle: json['footer_title'] != null ? OneOf2.parse(json['footer_title'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsRequestCarrierTextFooterTitleVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  headerBody: json['header_body'] != null ? OneOf2.parse(json['header_body'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsRequestCarrierTextHeaderBodyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  headerTitle: json['header_title'] != null ? OneOf2.parse(json['header_title'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsRequestCarrierTextHeaderTitleVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
