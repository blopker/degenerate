...
import 'post_subscription_schedules_schedule_request_phases_add_invoice_items_price_data_tax_behavior.dart';final class PostSubscriptionSchedulesScheduleRequestPhasesAddInvoiceItemsPriceData {const PostSubscriptionSchedulesScheduleRequestPhasesAddInvoiceItemsPriceData({required this.currency, required this.product, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
