...
import 'package:collection/collection.dart';import 'webhook_endpoint_object.dart';/// You can configure [webhook endpoints](https://docs.stripe.com/webhooks/) via the API to be
