...
factory PostIssuingCardsRequest.fromJson(Map<String, dynamic> json) { return PostIssuingCardsRequest(
  ...
  secondLine: json['second_line'] != null ? OneOf2.parse(json['second_line'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingCardsRequestSecondLineVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
