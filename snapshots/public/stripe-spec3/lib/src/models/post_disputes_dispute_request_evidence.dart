...
factory PostDisputesDisputeRequestEvidence.fromJson(Map<String, dynamic> json) { return PostDisputesDisputeRequestEvidence(
  ...
  enhancedEvidence: json['enhanced_evidence'] != null ? OneOf2.parse(json['enhanced_evidence'], fromA: (v) => EnhancedEvidence2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EnhancedEvidence2.canParse(v), fromB: (v) => PostDisputesDisputeRequestEvidenceEnhancedEvidenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
