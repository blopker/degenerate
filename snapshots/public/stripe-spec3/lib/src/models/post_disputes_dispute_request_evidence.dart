...
import 'post_disputes_dispute_request_evidence_enhanced_evidence.dart';/// Evidence to upload, to respond to a dispute. Updating any field in the hash will submit all fields in the hash for review. The combined character count of all fields is limited to 150,000.
...
factory PostDisputesDisputeRequestEvidence.fromJson(Map<String, dynamic> json) { return PostDisputesDisputeRequestEvidence(
  ...
  enhancedEvidence: json['enhanced_evidence'] != null ? PostDisputesDisputeRequestEvidenceEnhancedEvidence.fromJson(json['enhanced_evidence'] as Map<String, dynamic>) : null,
