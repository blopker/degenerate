...
import 'package:collection/collection.dart';import 'product_feature.dart';/// String representing the object's type. Objects of the same type share the same value. Always has the value `list`.
