...
factory SetupIntentPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return SetupIntentPaymentMethodOptions(
  acssDebit: json['acss_debit'] != null ? OneOf2.parse(json['acss_debit'], fromA: (v) => SetupIntentPaymentMethodOptionsAcssDebit.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsAcssDebit.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  amazonPay: json['amazon_pay'] != null ? OneOf2.parse(json['amazon_pay'], fromA: (v) => SetupIntentPaymentMethodOptionsAmazonPay.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsAmazonPay.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  bacsDebit: json['bacs_debit'] != null ? OneOf2.parse(json['bacs_debit'], fromA: (v) => SetupIntentPaymentMethodOptionsBacsDebit.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsBacsDebit.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => SetupIntentPaymentMethodOptionsCard.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsCard.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  cardPresent: json['card_present'] != null ? OneOf2.parse(json['card_present'], fromA: (v) => SetupIntentPaymentMethodOptionsCardPresent.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsCardPresent.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  klarna: json['klarna'] != null ? OneOf2.parse(json['klarna'], fromA: (v) => SetupIntentPaymentMethodOptionsKlarna.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsKlarna.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  link: json['link'] != null ? OneOf2.parse(json['link'], fromA: (v) => SetupIntentPaymentMethodOptionsLink.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsLink.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  paypal: json['paypal'] != null ? OneOf2.parse(json['paypal'], fromA: (v) => SetupIntentPaymentMethodOptionsPaypal.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsPaypal.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  payto: json['payto'] != null ? OneOf2.parse(json['payto'], fromA: (v) => SetupIntentPaymentMethodOptionsPayto.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsPayto.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  sepaDebit: json['sepa_debit'] != null ? OneOf2.parse(json['sepa_debit'], fromA: (v) => SetupIntentPaymentMethodOptionsSepaDebit.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsSepaDebit.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
  usBankAccount: json['us_bank_account'] != null ? OneOf2.parse(json['us_bank_account'], fromA: (v) => SetupIntentPaymentMethodOptionsUsBankAccount.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SetupIntentPaymentMethodOptionsUsBankAccount.canParse(v), fromB: (v) => SetupIntentTypeSpecificPaymentMethodOptionsClient.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntentTypeSpecificPaymentMethodOptionsClient.canParse(v),) : null,
); }
