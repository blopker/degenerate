...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_balance_settings_request_payments_payouts_minimum_balance_by_currency.dart';import 'post_balance_settings_request_payments_payouts_schedule.dart';final class PostBalanceSettingsRequestPaymentsPayouts {const PostBalanceSettingsRequestPaymentsPayouts({this.minimumBalanceByCurrency, this.schedule, this.statementDescriptor, });
...
factory PostBalanceSettingsRequestPaymentsPayouts.fromJson(Map<String, dynamic> json) { return PostBalanceSettingsRequestPaymentsPayouts(
  minimumBalanceByCurrency: json['minimum_balance_by_currency'] != null ? OneOf2.parse(json['minimum_balance_by_currency'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, OneOf2.parse(v, fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostBalanceSettingsRequestPaymentsPayoutsMinimumBalanceByCurrencyVariant1ValueVariant2.fromJson(v as String), canParseB: (v) => v is String,))), canParseA: (v) => v is Map, fromB: (v) => PostBalanceSettingsRequestPaymentsPayoutsMinimumBalanceByCurrencyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
