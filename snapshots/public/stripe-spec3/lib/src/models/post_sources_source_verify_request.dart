...
import 'package:collection/collection.dart';final class PostSourcesSourceVerifyRequest {const PostSourcesSourceVerifyRequest({this.expand, required this.values, });
