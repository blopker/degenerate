...
factory PostIssuingPersonalizationDesignsPersonalizationDesignRequest.fromJson(Map<String, dynamic> json) { return PostIssuingPersonalizationDesignsPersonalizationDesignRequest(
  cardLogo: json['card_logo'] != null ? OneOf2.parse(json['card_logo'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsPersonalizationDesignRequestCardLogoVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  carrierText: json['carrier_text'] != null ? OneOf2.parse(json['carrier_text'], fromA: (v) => CarrierTextParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CarrierTextParam.canParse(v), fromB: (v) => PostIssuingPersonalizationDesignsPersonalizationDesignRequestCarrierTextVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  lookupKey: json['lookup_key'] != null ? OneOf2.parse(json['lookup_key'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsPersonalizationDesignRequestLookupKeyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostIssuingPersonalizationDesignsPersonalizationDesignRequestNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
