...
import 'package:collection/collection.dart';final class PostPaymentIntentsIntentApplyCustomerBalanceRequest {const PostPaymentIntentsIntentApplyCustomerBalanceRequest({this.amount, this.currency, this.expand, });
