...
factory PostPaymentIntentsIntentCaptureRequestHooksInputsTax.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentCaptureRequestHooksInputsTax(
  calculation: OneOf2.parse(json['calculation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentIntentsIntentCaptureRequestHooksInputsTaxCalculationVariant2.fromJson(v as String), canParseB: (v) => v is String,),
); }
