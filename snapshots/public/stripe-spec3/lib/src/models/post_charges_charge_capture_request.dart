...
import 'package:collection/collection.dart';import 'post_charges_charge_capture_request_transfer_data.dart';final class PostChargesChargeCaptureRequest {const PostChargesChargeCaptureRequest({this.amount, this.applicationFee, this.applicationFeeAmount, this.expand, this.receiptEmail, this.statementDescriptor, this.statementDescriptorSuffix, this.transferData, this.transferGroup, });
