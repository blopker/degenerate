...
factory PostPaymentIntentsIntentConfirmRequestHooksInputsTax.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentConfirmRequestHooksInputsTax(
  calculation: OneOf2.parse(json['calculation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentIntentsIntentConfirmRequestHooksInputsTaxCalculationVariant2.fromJson(v as String), canParseB: (v) => v is String,),
); }
