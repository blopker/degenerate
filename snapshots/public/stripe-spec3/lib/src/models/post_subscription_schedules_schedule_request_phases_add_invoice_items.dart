...
factory PostSubscriptionSchedulesScheduleRequestPhasesAddInvoiceItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesScheduleRequestPhasesAddInvoiceItems(
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionSchedulesScheduleRequestPhasesAddInvoiceItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
