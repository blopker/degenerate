...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_subscription_schedules_request_billing_mode.dart';import 'post_subscription_schedules_request_default_settings.dart';import 'post_subscription_schedules_request_metadata.dart';import 'post_subscription_schedules_request_metadata.dart';import 'post_subscription_schedules_request_phases.dart';import 'post_subscription_schedules_request_start_date.dart';import 'post_subscription_schedules_request_start_date.dart';/// Behavior of the subscription schedule and underlying subscription when it ends. Possible values are `release` or `cancel` with the default being `release`. `release` will end the subscription schedule and keep the underlying subscription running. `cancel` will end the subscription schedule and cancel the underlying subscription.
