...
factory PostSubscriptionSchedulesRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostSubscriptionSchedulesRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  phases: (json['phases'] as List<dynamic>?)?.map((e) => PostSubscriptionSchedulesRequestPhases.fromJson(e as Map<String, dynamic>)).toList(),
  startDate: json['start_date'] != null ? OneOf2.parse(json['start_date'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSubscriptionSchedulesRequestStartDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
