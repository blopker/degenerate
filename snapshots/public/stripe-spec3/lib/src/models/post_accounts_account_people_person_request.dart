...
factory PostAccountsAccountPeoplePersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequest(
  ...
  dob: json['dob'] != null ? PostAccountsAccountPeoplePersonRequestDob.fromJson(json['dob'] as Map<String, dynamic>) : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null ? PostAccountsAccountPeoplePersonRequestFullNameAliases.fromJson(json['full_name_aliases'] as Map<String, dynamic>) : null,
  ...
  metadata: json['metadata'] != null ? PostAccountsAccountPeoplePersonRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
