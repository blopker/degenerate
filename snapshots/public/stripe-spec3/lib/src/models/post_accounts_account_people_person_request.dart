...
factory PostAccountsAccountPeoplePersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequest(
  ...
  dob: json['dob'] != null ? OneOf2.parse(json['dob'], fromA: (v) => DateOfBirthSpecs4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && DateOfBirthSpecs4.canParse(v), fromB: (v) => PostAccountsAccountPeoplePersonRequestDobVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null ? OneOf2.parse(json['full_name_aliases'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostAccountsAccountPeoplePersonRequestFullNameAliasesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostAccountsAccountPeoplePersonRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
