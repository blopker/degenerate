...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_tokens_request_person_documents_visa_files.dart';final class PostTokensRequestPersonDocumentsVisa {const PostTokensRequestPersonDocumentsVisa({this.files});
...
factory PostTokensRequestPersonDocumentsVisa.fromJson(Map<String, dynamic> json) { return PostTokensRequestPersonDocumentsVisa(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTokensRequestPersonDocumentsVisaFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
