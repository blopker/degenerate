...
factory PostAccountsRequestGroups.fromJson(Map<String, dynamic> json) { return PostAccountsRequestGroups(
  paymentsPricing: json['payments_pricing'] != null ? OneOf2.parse(json['payments_pricing'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsRequestGroupsPaymentsPricingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
