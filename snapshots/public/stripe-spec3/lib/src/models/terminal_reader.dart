...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'terminal_reader_action.dart';import 'terminal_reader_location.dart';/// Device type of the reader.
...
factory TerminalReader.fromJson(Map<String, dynamic> json) { return TerminalReader(
  ...
  location: json['location'] != null ? OneOf2.parse(json['location'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TerminalLocation.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TerminalLocation.canParse(v),) : null,
