...
import 'package:collection/collection.dart';final class PostRadarValueListsValueListRequest {const PostRadarValueListsValueListRequest({this.alias, this.expand, this.metadata, this.name, });
