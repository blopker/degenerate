...
import 'package:collection/collection.dart';final class PostSetupIntentsIntentVerifyMicrodepositsRequest {const PostSetupIntentsIntentVerifyMicrodepositsRequest({this.amounts, this.clientSecret, this.descriptorCode, this.expand, });
