...
factory PostAccountsAccountRequestIndividual.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestIndividual(
  ...
  dob: json['dob'] != null ? OneOf2.parse(json['dob'], fromA: (v) => DateOfBirthSpecs2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && DateOfBirthSpecs2.canParse(v), fromB: (v) => PostAccountsAccountRequestIndividualDobVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  email: json['email'] as String?,
  firstName: json['first_name'] as String?,
  firstNameKana: json['first_name_kana'] as String?,
  firstNameKanji: json['first_name_kanji'] as String?,
  fullNameAliases: json['full_name_aliases'] != null ? OneOf2.parse(json['full_name_aliases'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostAccountsAccountRequestIndividualFullNameAliasesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostAccountsAccountRequestIndividualMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
