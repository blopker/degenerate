...
import 'amount_details_shipping_param2_amount.dart';import 'amount_details_shipping_param2_from_postal_code.dart';import 'amount_details_shipping_param2_to_postal_code.dart';final class AmountDetailsShippingParam2 {const AmountDetailsShippingParam2({this.amount, this.fromPostalCode, this.toPostalCode, });

factory AmountDetailsShippingParam2.fromJson(Map<String, dynamic> json) { return AmountDetailsShippingParam2(
  amount: json['amount'] != null ? AmountDetailsShippingParam2Amount.fromJson(json['amount'] as Map<String, dynamic>) : null,
  fromPostalCode: json['from_postal_code'] != null ? AmountDetailsShippingParam2FromPostalCode.fromJson(json['from_postal_code'] as Map<String, dynamic>) : null,
  toPostalCode: json['to_postal_code'] != null ? AmountDetailsShippingParam2ToPostalCode.fromJson(json['to_postal_code'] as Map<String, dynamic>) : null,
); }
