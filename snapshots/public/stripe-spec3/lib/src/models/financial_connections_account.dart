...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bank_connections_resource_account_number_details.dart';import 'financial_connections_account_account_holder.dart';import 'financial_connections_account_balance.dart';import 'financial_connections_account_balance_refresh.dart';import 'financial_connections_account_ownership2.dart';import 'financial_connections_account_ownership_refresh.dart';import 'financial_connections_account_transaction_refresh.dart';/// The type of the account. Account category is further divided in `subcategory`.
...
factory FinancialConnectionsAccount.fromJson(Map<String, dynamic> json) { return FinancialConnectionsAccount(
  ...
  ownership: json['ownership'] != null ? OneOf2.parse(json['ownership'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => FinancialConnectionsAccountOwnership.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && FinancialConnectionsAccountOwnership.canParse(v),) : null,
