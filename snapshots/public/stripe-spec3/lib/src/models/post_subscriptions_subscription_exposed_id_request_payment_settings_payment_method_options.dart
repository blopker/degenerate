...
factory PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptions(
  acssDebit: json['acss_debit'] != null ? OneOf2.parse(json['acss_debit'], fromA: (v) => InvoicePaymentMethodOptionsParam38.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam38.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsAcssDebitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  bancontact: json['bancontact'] != null ? OneOf2.parse(json['bancontact'], fromA: (v) => InvoicePaymentMethodOptionsParam39.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam39.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsBancontactVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => SubscriptionPaymentMethodOptionsParam4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SubscriptionPaymentMethodOptionsParam4.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsCardVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerBalance: json['customer_balance'] != null ? OneOf2.parse(json['customer_balance'], fromA: (v) => InvoicePaymentMethodOptionsParam40.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam40.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsCustomerBalanceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  konbini: json['konbini'] != null ? OneOf2.parse(json['konbini'], fromA: (v) => InvoicePaymentMethodOptionsParam41.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam41.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsKonbiniVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  payto: json['payto'] != null ? OneOf2.parse(json['payto'], fromA: (v) => InvoicePaymentMethodOptionsParam42.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam42.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsPaytoVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  sepaDebit: json['sepa_debit'] != null ? OneOf2.parse(json['sepa_debit'], fromA: (v) => InvoicePaymentMethodOptionsParam43.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam43.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsSepaDebitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  usBankAccount: json['us_bank_account'] != null ? OneOf2.parse(json['us_bank_account'], fromA: (v) => InvoicePaymentMethodOptionsParam44.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && InvoicePaymentMethodOptionsParam44.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestPaymentSettingsPaymentMethodOptionsUsBankAccountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
