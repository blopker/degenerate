...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'setup_attempt_application.dart';import 'setup_attempt_customer.dart';import 'setup_attempt_on_behalf_of.dart';import 'setup_attempt_payment_method.dart';import 'setup_attempt_payment_method_details.dart';import 'setup_attempt_setup_error.dart';import 'setup_attempt_setup_intent.dart';final class SetupAttemptFlowDirections {const SetupAttemptFlowDirections._(this.value);
...
factory SetupAttempt.fromJson(Map<String, dynamic> json) { return SetupAttempt(
  ...
  paymentMethod: OneOf2.parse(json['payment_method'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentMethod.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PaymentMethod.canParse(v),),
  ...
  setupIntent: OneOf2.parse(json['setup_intent'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SetupIntent.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntent.canParse(v),),
