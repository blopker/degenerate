...
factory PostAccountsAccountExternalAccountsRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountExternalAccountsRequest(
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => ExternalAccountPayoutBankAccount3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ExternalAccountPayoutBankAccount3.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
