...
factory PostInvoicesRequestPaymentSettings.fromJson(Map<String, dynamic> json) { return PostInvoicesRequestPaymentSettings(
  defaultMandate: json['default_mandate'] != null ? OneOf2.parse(json['default_mandate'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesRequestPaymentSettingsDefaultMandateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
