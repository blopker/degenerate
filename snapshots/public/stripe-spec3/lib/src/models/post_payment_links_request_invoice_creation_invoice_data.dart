...
factory PostPaymentLinksRequestInvoiceCreationInvoiceData.fromJson(Map<String, dynamic> json) { return PostPaymentLinksRequestInvoiceCreationInvoiceData(
  accountTaxIds: json['account_tax_ids'] != null
        ? PostPaymentLinksRequestInvoiceCreationInvoiceDataAccountTaxIds.fromJson(json['account_tax_ids'] as Map<String, dynamic>)
        : null,
  customFields: json['custom_fields'] != null
        ? PostPaymentLinksRequestInvoiceCreationInvoiceDataCustomFields.fromJson(json['custom_fields'] as Map<String, dynamic>)
        : null,
  description: json['description'] as String?,
  footer: json['footer'] as String?,
  issuer: json['issuer'] != null
        ? PostPaymentLinksRequestInvoiceCreationInvoiceDataIssuer.fromJson(json['issuer'] as Map<String, dynamic>)
        : null,
  metadata: json['metadata'] != null
        ? PostPaymentLinksRequestInvoiceCreationInvoiceDataMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
  renderingOptions: json['rendering_options'] != null
        ? PostPaymentLinksRequestInvoiceCreationInvoiceDataRenderingOptions.fromJson(json['rendering_options'] as Map<String, dynamic>)
        : null,
); }
