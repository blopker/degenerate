...
factory PostAccountsAccountRequestSettingsCardPayments.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestSettingsCardPayments(
  ...
  statementDescriptorPrefixKana: json['statement_descriptor_prefix_kana'] != null ? OneOf2.parse(json['statement_descriptor_prefix_kana'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountRequestSettingsCardPaymentsStatementDescriptorPrefixKanaVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptorPrefixKanji: json['statement_descriptor_prefix_kanji'] != null ? OneOf2.parse(json['statement_descriptor_prefix_kanji'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountRequestSettingsCardPaymentsStatementDescriptorPrefixKanjiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
