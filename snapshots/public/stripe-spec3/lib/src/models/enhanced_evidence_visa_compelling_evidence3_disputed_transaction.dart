...
factory EnhancedEvidenceVisaCompellingEvidence3DisputedTransaction.fromJson(Map<String, dynamic> json) { return EnhancedEvidenceVisaCompellingEvidence3DisputedTransaction(
  customerAccountId: json['customer_account_id'] != null ? OneOf2.parse(json['customer_account_id'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionCustomerAccountIdVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerDeviceFingerprint: json['customer_device_fingerprint'] != null ? OneOf2.parse(json['customer_device_fingerprint'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionCustomerDeviceFingerprintVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerDeviceId: json['customer_device_id'] != null ? OneOf2.parse(json['customer_device_id'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionCustomerDeviceIdVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerEmailAddress: json['customer_email_address'] != null ? OneOf2.parse(json['customer_email_address'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionCustomerEmailAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerPurchaseIp: json['customer_purchase_ip'] != null ? OneOf2.parse(json['customer_purchase_ip'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionCustomerPurchaseIpVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
