...
factory Duplicate2.fromJson(Map<String, dynamic> json) { return Duplicate2(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Duplicate2AdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cardStatement: json['card_statement'] != null ? OneOf2.parse(json['card_statement'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Duplicate2CardStatementVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cashReceipt: json['cash_receipt'] != null ? OneOf2.parse(json['cash_receipt'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Duplicate2CashReceiptVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  checkImage: json['check_image'] != null ? OneOf2.parse(json['check_image'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Duplicate2CheckImageVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Duplicate2ExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
