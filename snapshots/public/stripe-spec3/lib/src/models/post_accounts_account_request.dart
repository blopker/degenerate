...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_request_business_profile.dart';import 'post_accounts_account_request_capabilities.dart';import 'post_accounts_account_request_company.dart';import 'post_accounts_account_request_documents.dart';import 'post_accounts_account_request_groups.dart';import 'post_accounts_account_request_individual.dart';import 'post_accounts_account_request_metadata.dart';import 'post_accounts_account_request_settings.dart';import 'post_accounts_account_request_tos_acceptance.dart';/// The business type. Once you create an [Account Link](/api/account_links) or [Account Session](/api/account_sessions), this property can only be updated for accounts where [controller.requirement_collection](/api/accounts/object#account_object-controller-requirement_collection) is `application`, which includes Custom accounts.
...
factory PostAccountsAccountRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostAccountsAccountRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
