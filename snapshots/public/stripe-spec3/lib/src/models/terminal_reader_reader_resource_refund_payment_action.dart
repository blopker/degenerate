...
factory TerminalReaderReaderResourceRefundPaymentAction.fromJson(Map<String, dynamic> json) { return TerminalReaderReaderResourceRefundPaymentAction(
  ...
  refund: json['refund'] != null ? OneOf2.parse(json['refund'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Refund.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Refund.canParse(v),) : null,
