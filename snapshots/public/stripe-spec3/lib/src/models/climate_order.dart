...
import 'package:collection/collection.dart';import 'climate_order_cancellation_reason.dart';import 'climate_order_object.dart';import 'climate_order_product.dart';import 'climate_order_status.dart';import 'climate_removals_beneficiary.dart';import 'climate_removals_order_deliveries.dart';/// Orders represent your intent to purchase a particular Climate product. When you create an order, the
...
factory ClimateOrder.fromJson(Map<String, dynamic> json) { return ClimateOrder(
  ...
  product: ClimateOrderProduct.fromJson(json['product'] as Map<String, dynamic>),
