...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'climate_order_product.dart';import 'climate_removals_beneficiary.dart';import 'climate_removals_order_deliveries.dart';/// Reason for the cancellation of this order.
...
factory ClimateOrder.fromJson(Map<String, dynamic> json) { return ClimateOrder(
  ...
  product: OneOf2.parse(json['product'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ClimateProduct.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ClimateProduct.canParse(v),),
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is ClimateOrder &&
          ...
          const ListEquality<dynamic>().equals(deliveryDetails, other.deliveryDetails) &&
