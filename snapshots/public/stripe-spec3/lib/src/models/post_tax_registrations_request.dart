...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_tax_registrations_request_active_from.dart';import 'post_tax_registrations_request_country_options.dart';final class PostTaxRegistrationsRequest {const PostTaxRegistrationsRequest({required this.activeFrom, required this.country, required this.countryOptions, this.expand, this.expiresAt, });

factory PostTaxRegistrationsRequest.fromJson(Map<String, dynamic> json) { return PostTaxRegistrationsRequest(
  activeFrom: OneOf2.parse(json['active_from'], fromA: (v) => PostTaxRegistrationsRequestActiveFromVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,),
