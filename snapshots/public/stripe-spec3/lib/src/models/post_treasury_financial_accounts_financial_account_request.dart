...
factory PostTreasuryFinancialAccountsFinancialAccountRequest.fromJson(Map<String, dynamic> json) { return PostTreasuryFinancialAccountsFinancialAccountRequest(
  ...
  nickname: json['nickname'] != null ? OneOf2.parse(json['nickname'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTreasuryFinancialAccountsFinancialAccountRequestNicknameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
