...
factory PostTokensRequestPersonRelationship.fromJson(Map<String, dynamic> json) { return PostTokensRequestPersonRelationship(
  ...
  percentOwnership: json['percent_ownership'] != null ? OneOf2.parse(json['percent_ownership'], fromA: (v) => (v as num).toDouble(), canParseA: (v) => v is num, fromB: (v) => PostTokensRequestPersonRelationshipPercentOwnershipVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
