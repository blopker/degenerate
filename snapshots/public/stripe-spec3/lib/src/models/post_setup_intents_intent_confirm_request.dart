...
factory PostSetupIntentsIntentConfirmRequest.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentConfirmRequest(
  ...
  mandateData: json['mandate_data'] != null ? OneOf3.parse(json['mandate_data'], fromA: (v) => SecretKeyParam4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SecretKeyParam4.canParse(v), fromB: (v) => PostSetupIntentsIntentConfirmRequestMandateDataVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => ClientKeyParam2.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && ClientKeyParam2.canParse(v),) : null,
