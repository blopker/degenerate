...
factory PostInvoicesRequestShippingDetails.fromJson(Map<String, dynamic> json) { return PostInvoicesRequestShippingDetails(
  ...
  phone: json['phone'] != null ? OneOf2.parse(json['phone'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesRequestShippingDetailsPhoneVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
