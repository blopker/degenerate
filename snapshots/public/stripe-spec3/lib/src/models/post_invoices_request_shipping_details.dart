...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_invoices_request_shipping_details_address.dart';import 'post_invoices_request_shipping_details_phone.dart';import 'post_invoices_request_shipping_details_phone.dart';/// Shipping details for the invoice. The Invoice PDF will use the `shipping_details` value if it is set, otherwise the PDF will render the shipping address from the customer.
