...
factory EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddress.fromJson(Map<String, dynamic> json) { return EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddress(
  city: json['city'] != null ? OneOf2.parse(json['city'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressCityVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  country: json['country'] != null ? OneOf2.parse(json['country'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressCountryVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  line1: json['line1'] != null ? OneOf2.parse(json['line1'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressLine1Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  line2: json['line2'] != null ? OneOf2.parse(json['line2'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressLine2Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  postalCode: json['postal_code'] != null ? OneOf2.parse(json['postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  state: json['state'] != null ? OneOf2.parse(json['state'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3DisputedTransactionShippingAddressStateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
