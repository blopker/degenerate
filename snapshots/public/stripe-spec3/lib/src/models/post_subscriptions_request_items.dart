...
factory PostSubscriptionsRequestItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequestItems(
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => ItemBillingThresholdsParam9.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ItemBillingThresholdsParam9.canParse(v), fromB: (v) => PostSubscriptionsRequestItemsBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionsRequestItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsRequestItemsDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsRequestItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
