...
import 'package:collection/collection.dart';import 'post_terminal_readers_reader_collect_inputs_request_inputs.dart';final class PostTerminalReadersReaderCollectInputsRequest {const PostTerminalReadersReaderCollectInputsRequest({this.expand, required this.inputs, this.metadata, });
