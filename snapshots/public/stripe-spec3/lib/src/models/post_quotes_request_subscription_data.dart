...
factory PostQuotesRequestSubscriptionData.fromJson(Map<String, dynamic> json) { return PostQuotesRequestSubscriptionData(
  ...
  effectiveDate: json['effective_date'] != null ? OneOf3.parse(json['effective_date'], fromA: (v) => PostQuotesRequestSubscriptionDataEffectiveDateVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num, fromC: (v) => PostQuotesRequestSubscriptionDataEffectiveDateVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  trialPeriodDays: json['trial_period_days'] != null ? OneOf2.parse(json['trial_period_days'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostQuotesRequestSubscriptionDataTrialPeriodDaysVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
