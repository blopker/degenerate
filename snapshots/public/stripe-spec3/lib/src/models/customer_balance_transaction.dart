...
factory CustomerBalanceTransaction.fromJson(Map<String, dynamic> json) { return CustomerBalanceTransaction(
  ...
  checkoutSession: json['checkout_session'] != null ? OneOf2.parse(json['checkout_session'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CheckoutSession.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CheckoutSession.canParse(v),) : null,
  created: (json['created'] as num).toInt(),
  creditNote: json['credit_note'] != null ? OneOf2.parse(json['credit_note'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CreditNote.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CreditNote.canParse(v),) : null,
  currency: json['currency'] as String,
  customer: OneOf2.parse(json['customer'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Customer.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Customer.canParse(v),),
