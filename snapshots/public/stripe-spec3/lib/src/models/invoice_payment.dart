...
factory InvoicePayment.fromJson(Map<String, dynamic> json) { return InvoicePayment(
  ...
  invoice: OneOf3.parse(json['invoice'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Invoice.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Invoice.canParse(v), fromC: (v) => DeletedInvoice.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DeletedInvoice.canParse(v),),
