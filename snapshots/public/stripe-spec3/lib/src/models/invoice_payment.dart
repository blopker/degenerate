...
import 'invoice_payment_invoice.dart';import 'invoice_payment_object.dart';import 'invoices_payments_invoice_payment_associated_payment.dart';import 'invoices_payments_invoice_payment_status_transitions.dart';/// Invoice Payments represent payments made against invoices. Invoice Payments can
...
factory InvoicePayment.fromJson(Map<String, dynamic> json) { return InvoicePayment(
  ...
  invoice: InvoicePaymentInvoice.fromJson(json['invoice'] as Map<String, dynamic>),
