...
factory PostCustomersCustomerRequestTax.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerRequestTax(
  ipAddress: json['ip_address'] != null ? OneOf2.parse(json['ip_address'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersCustomerRequestTaxIpAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
