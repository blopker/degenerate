...
import 'package:collection/collection.dart';final class PostInvoiceRenderingTemplatesTemplateArchiveRequest {const PostInvoiceRenderingTemplatesTemplateArchiveRequest({this.expand});
