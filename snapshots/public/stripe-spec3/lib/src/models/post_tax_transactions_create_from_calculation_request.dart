...
import 'package:collection/collection.dart';final class PostTaxTransactionsCreateFromCalculationRequest {const PostTaxTransactionsCreateFromCalculationRequest({required this.calculation, this.expand, this.metadata, this.postedAt, required this.reference, });
