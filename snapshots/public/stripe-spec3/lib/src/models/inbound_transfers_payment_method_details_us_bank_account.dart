...
import 'inbound_transfers_payment_method_details_us_bank_account_mandate.dart';/// Account holder type: individual or company.
...
factory InboundTransfersPaymentMethodDetailsUsBankAccount.fromJson(Map<String, dynamic> json) { return InboundTransfersPaymentMethodDetailsUsBankAccount(
  ...
  mandate: json['mandate'] != null ? InboundTransfersPaymentMethodDetailsUsBankAccountMandate.fromJson(json['mandate'] as Map<String, dynamic>) : null,
