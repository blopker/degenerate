...
factory ApplicationFee.fromJson(Map<String, dynamic> json) { return ApplicationFee(
  account: OneOf2.parse(json['account'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Account.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Account.canParse(v),),
  amount: (json['amount'] as num).toInt(),
  amountRefunded: (json['amount_refunded'] as num).toInt(),
  application: OneOf2.parse(json['application'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Application.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Application.canParse(v),),
  ...
  originatingTransaction: json['originating_transaction'] != null ? OneOf2.parse(json['originating_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Charge.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Charge.canParse(v),) : null,
