...
factory PostAccountsAccountPersonsPersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsPersonRequest(
  additionalTosAcceptances: json['additional_tos_acceptances'] != null
        ? PostAccountsAccountPersonsPersonRequestAdditionalTosAcceptances.fromJson(json['additional_tos_acceptances'] as Map<String, dynamic>)
        : null,
  address: json['address'] != null
        ? PostAccountsAccountPersonsPersonRequestAddress.fromJson(json['address'] as Map<String, dynamic>)
        : null,
  addressKana: json['address_kana'] != null
        ? PostAccountsAccountPersonsPersonRequestAddressKana.fromJson(json['address_kana'] as Map<String, dynamic>)
        : null,
  addressKanji: json['address_kanji'] != null
        ? PostAccountsAccountPersonsPersonRequestAddressKanji.fromJson(json['address_kanji'] as Map<String, dynamic>)
        : null,
  dob: json['dob'] != null
        ? PostAccountsAccountPersonsPersonRequestDob.fromJson(json['dob'] as Map<String, dynamic>)
        : null,
  documents: json['documents'] != null
        ? PostAccountsAccountPersonsPersonRequestDocuments.fromJson(json['documents'] as Map<String, dynamic>)
        : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null
        ? PostAccountsAccountPersonsPersonRequestFullNameAliases.fromJson(json['full_name_aliases'] as Map<String, dynamic>)
        : null,
  ...
  metadata: json['metadata'] != null
        ? PostAccountsAccountPersonsPersonRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
  ...
  registeredAddress: json['registered_address'] != null
        ? PostAccountsAccountPersonsPersonRequestRegisteredAddress.fromJson(json['registered_address'] as Map<String, dynamic>)
        : null,
  relationship: json['relationship'] != null
        ? PostAccountsAccountPersonsPersonRequestRelationship.fromJson(json['relationship'] as Map<String, dynamic>)
        : null,
  ssnLast4: json['ssn_last_4'] as String?,
  usCfpbData: json['us_cfpb_data'] != null
        ? PostAccountsAccountPersonsPersonRequestUsCfpbData.fromJson(json['us_cfpb_data'] as Map<String, dynamic>)
        : null,
  verification: json['verification'] != null
        ? PostAccountsAccountPersonsPersonRequestVerification.fromJson(json['verification'] as Map<String, dynamic>)
        : null,
); }
