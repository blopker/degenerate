...
factory PostAccountsAccountPersonsPersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsPersonRequest(
  ...
  dob: json['dob'] != null ? PostAccountsAccountPersonsPersonRequestDob.fromJson(json['dob'] as Map<String, dynamic>) : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null ? PostAccountsAccountPersonsPersonRequestFullNameAliases.fromJson(json['full_name_aliases'] as Map<String, dynamic>) : null,
  ...
  metadata: json['metadata'] != null ? PostAccountsAccountPersonsPersonRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
