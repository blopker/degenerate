...
import 'post_checkout_sessions_request_payment_method_options_payto_mandate_options.dart';import 'post_checkout_sessions_request_payment_method_options_payto_setup_future_usage.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsPayto {const PostCheckoutSessionsRequestPaymentMethodOptionsPayto({this.mandateOptions, this.setupFutureUsage, });
...
factory PostCheckoutSessionsRequestPaymentMethodOptionsPayto.fromJson(Map<String, dynamic> json) { return PostCheckoutSessionsRequestPaymentMethodOptionsPayto(
  mandateOptions: json['mandate_options'] != null
        ? PostCheckoutSessionsRequestPaymentMethodOptionsPaytoMandateOptions.fromJson(json['mandate_options'] as Map<String, dynamic>)
        : null,
