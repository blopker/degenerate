...
factory PostSubscriptionSchedulesRequestPhasesItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequestPhasesItems(
  billingThresholds: json['billing_thresholds'] != null ? PostSubscriptionSchedulesRequestPhasesItemsBillingThresholds.fromJson(json['billing_thresholds'] as Map<String, dynamic>) : null,
  discounts: json['discounts'] != null ? PostSubscriptionSchedulesRequestPhasesItemsDiscounts.fromJson(json['discounts'] as Map<String, dynamic>) : null,
  ...
  taxRates: json['tax_rates'] != null ? PostSubscriptionSchedulesRequestPhasesItemsTaxRates.fromJson(json['tax_rates'] as Map<String, dynamic>) : null,
); }
