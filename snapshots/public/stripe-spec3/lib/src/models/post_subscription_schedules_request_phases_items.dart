...
factory PostSubscriptionSchedulesRequestPhasesItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequestPhasesItems(
  billingThresholds: json['billing_thresholds'] != null
        ? PostSubscriptionSchedulesRequestPhasesItemsBillingThresholds.fromJson(json['billing_thresholds'] as Map<String, dynamic>)
        : null,
  discounts: json['discounts'] != null
        ? PostSubscriptionSchedulesRequestPhasesItemsDiscounts.fromJson(json['discounts'] as Map<String, dynamic>)
        : null,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  price: json['price'] as String?,
  priceData: json['price_data'] != null
        ? PostSubscriptionSchedulesRequestPhasesItemsPriceData.fromJson(json['price_data'] as Map<String, dynamic>)
        : null,
  quantity: json['quantity'] != null ? (json['quantity'] as num).toInt() : null,
  taxRates: json['tax_rates'] != null
        ? PostSubscriptionSchedulesRequestPhasesItemsTaxRates.fromJson(json['tax_rates'] as Map<String, dynamic>)
        : null,
); }
