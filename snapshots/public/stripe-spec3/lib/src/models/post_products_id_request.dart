...
factory PostProductsIdRequest.fromJson(Map<String, dynamic> json) { return PostProductsIdRequest(
  ...
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostProductsIdRequestDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  images: json['images'] != null ? OneOf2.parse(json['images'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostProductsIdRequestImagesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  marketingFeatures: json['marketing_features'] != null ? OneOf2.parse(json['marketing_features'], fromA: (v) => (v as List<dynamic>).map((e) => PostProductsIdRequestMarketingFeaturesVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostProductsIdRequestMarketingFeaturesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostProductsIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  name: json['name'] as String?,
  packageDimensions: json['package_dimensions'] != null ? OneOf2.parse(json['package_dimensions'], fromA: (v) => PackageDimensionsSpecs.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PackageDimensionsSpecs.canParse(v), fromB: (v) => PostProductsIdRequestPackageDimensionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippable: json['shippable'] as bool?,
  statementDescriptor: json['statement_descriptor'] as String?,
  taxCode: json['tax_code'] != null ? OneOf2.parse(json['tax_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostProductsIdRequestTaxCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  unitLabel: json['unit_label'] != null ? OneOf2.parse(json['unit_label'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostProductsIdRequestUnitLabelVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  url: json['url'] != null ? OneOf2.parse(json['url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostProductsIdRequestUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
