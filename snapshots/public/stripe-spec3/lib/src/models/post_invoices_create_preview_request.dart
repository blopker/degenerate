...
factory PostInvoicesCreatePreviewRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesCreatePreviewRequest(
  ...
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesCreatePreviewRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesCreatePreviewRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  onBehalfOf: json['on_behalf_of'] != null ? OneOf2.parse(json['on_behalf_of'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesCreatePreviewRequestOnBehalfOfVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
