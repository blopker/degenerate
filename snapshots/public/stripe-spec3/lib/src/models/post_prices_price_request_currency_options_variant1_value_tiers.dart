...
factory PostPricesPriceRequestCurrencyOptionsVariant1ValueTiers.fromJson(Map<String, dynamic> json) { return PostPricesPriceRequestCurrencyOptionsVariant1ValueTiers(
  ...
  upTo: OneOf2.parse(json['up_to'], fromA: (v) => PostPricesPriceRequestCurrencyOptionsVariant1ValueTiersUpToVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,),
); }
