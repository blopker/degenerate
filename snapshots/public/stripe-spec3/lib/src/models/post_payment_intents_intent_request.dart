...
factory PostPaymentIntentsIntentRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentRequest(
  ...
  amountDetails: json['amount_details'] != null ? OneOf2.parse(json['amount_details'], fromA: (v) => AmountDetailsParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AmountDetailsParam.canParse(v), fromB: (v) => PostPaymentIntentsIntentRequestAmountDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  applicationFeeAmount: json['application_fee_amount'] != null ? OneOf2.parse(json['application_fee_amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostPaymentIntentsIntentRequestApplicationFeeAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null ? OneOf2.parse(json['excluded_payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentIntentsIntentRequestExcludedPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentIntentsIntentRequestExcludedPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  hooks: json['hooks'] != null ? PostPaymentIntentsIntentRequestHooks.fromJson(json['hooks'] as Map<String, dynamic>) : null,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentIntentsIntentRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  paymentDetails: json['payment_details'] != null ? OneOf2.parse(json['payment_details'], fromA: (v) => PaymentDetails.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PaymentDetails.canParse(v), fromB: (v) => PostPaymentIntentsIntentRequestPaymentDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  receiptEmail: json['receipt_email'] != null ? OneOf2.parse(json['receipt_email'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentIntentsIntentRequestReceiptEmailVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => OptionalFieldsShipping.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && OptionalFieldsShipping.canParse(v), fromB: (v) => PostPaymentIntentsIntentRequestShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
