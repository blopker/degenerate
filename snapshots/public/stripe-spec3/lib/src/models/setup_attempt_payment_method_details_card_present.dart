...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'setup_attempt_payment_method_details_card_present_generated_card.dart';import 'setup_attempt_payment_method_details_card_present_offline.dart';/// 
...
factory SetupAttemptPaymentMethodDetailsCardPresent.fromJson(Map<String, dynamic> json) { return SetupAttemptPaymentMethodDetailsCardPresent(
  generatedCard: json['generated_card'] != null ? OneOf2.parse(json['generated_card'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentMethod.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PaymentMethod.canParse(v),) : null,
