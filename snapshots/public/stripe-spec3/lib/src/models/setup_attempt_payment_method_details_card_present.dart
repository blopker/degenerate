...
factory SetupAttemptPaymentMethodDetailsCardPresent.fromJson(Map<String, dynamic> json) { return SetupAttemptPaymentMethodDetailsCardPresent(
  generatedCard: json['generated_card'] != null
        ? SetupAttemptPaymentMethodDetailsCardPresentGeneratedCard.fromJson(json['generated_card'] as Map<String, dynamic>)
        : null,
  offline: json['offline'] != null
        ? SetupAttemptPaymentMethodDetailsCardPresentOffline.fromJson(json['offline'] as Map<String, dynamic>)
        : null,
); }
