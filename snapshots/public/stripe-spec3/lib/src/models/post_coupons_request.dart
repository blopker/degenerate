...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_coupons_request_applies_to.dart';import 'post_coupons_request_currency_options_value.dart';import 'post_coupons_request_metadata.dart';/// Specifies how long the discount will be in effect if used on a subscription. Defaults to `once`.
...
factory PostCouponsRequest.fromJson(Map<String, dynamic> json) { return PostCouponsRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCouponsRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
