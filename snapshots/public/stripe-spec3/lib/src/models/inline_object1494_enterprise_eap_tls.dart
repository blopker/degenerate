...
final class InlineObject1494EnterpriseEapTls {const InlineObject1494EnterpriseEapTls({this.caCertificateFile, required this.clientCertificateFile, required this.privateKeyFile, this.privateKeyFilePassword, required this.ssid, });

factory InlineObject1494EnterpriseEapTls.fromJson(Map<String, dynamic> json) { return InlineObject1494EnterpriseEapTls(
...
InlineObject1494EnterpriseEapTls copyWith({String Function()? caCertificateFile, String? clientCertificateFile, String? privateKeyFile, String Function()? privateKeyFilePassword, String? ssid, }) { return InlineObject1494EnterpriseEapTls(
...
@override String toString() { return 'InlineObject1494EnterpriseEapTls(caCertificateFile: $caCertificateFile, clientCertificateFile: $clientCertificateFile, privateKeyFile: $privateKeyFile, privateKeyFilePassword: $privateKeyFilePassword, ssid: $ssid)'; } 
 }
