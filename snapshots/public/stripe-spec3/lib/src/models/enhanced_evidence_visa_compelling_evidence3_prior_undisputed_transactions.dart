...
factory EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactions.fromJson(Map<String, dynamic> json) { return EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactions(
  ...
  customerAccountId: json['customer_account_id'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerAccountId.fromJson(json['customer_account_id'] as Map<String, dynamic>) : null,
  customerDeviceFingerprint: json['customer_device_fingerprint'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerDeviceFingerprint.fromJson(json['customer_device_fingerprint'] as Map<String, dynamic>) : null,
  customerDeviceId: json['customer_device_id'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerDeviceId.fromJson(json['customer_device_id'] as Map<String, dynamic>) : null,
  customerEmailAddress: json['customer_email_address'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerEmailAddress.fromJson(json['customer_email_address'] as Map<String, dynamic>) : null,
  customerPurchaseIp: json['customer_purchase_ip'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerPurchaseIp.fromJson(json['customer_purchase_ip'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
