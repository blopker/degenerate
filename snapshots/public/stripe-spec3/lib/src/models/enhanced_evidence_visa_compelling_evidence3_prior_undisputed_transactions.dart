...
factory EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactions.fromJson(Map<String, dynamic> json) { return EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactions(
  ...
  customerAccountId: json['customer_account_id'] != null ? OneOf2.parse(json['customer_account_id'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerAccountIdVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerDeviceFingerprint: json['customer_device_fingerprint'] != null ? OneOf2.parse(json['customer_device_fingerprint'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerDeviceFingerprintVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerDeviceId: json['customer_device_id'] != null ? OneOf2.parse(json['customer_device_id'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerDeviceIdVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerEmailAddress: json['customer_email_address'] != null ? OneOf2.parse(json['customer_email_address'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerEmailAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customerPurchaseIp: json['customer_purchase_ip'] != null ? OneOf2.parse(json['customer_purchase_ip'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsCustomerPurchaseIpVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EnhancedEvidenceVisaCompellingEvidence3PriorUndisputedTransactionsProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
