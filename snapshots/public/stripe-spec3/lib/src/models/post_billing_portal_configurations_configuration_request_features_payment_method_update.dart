...
factory PostBillingPortalConfigurationsConfigurationRequestFeaturesPaymentMethodUpdate.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsConfigurationRequestFeaturesPaymentMethodUpdate(
  ...
  paymentMethodConfiguration: json['payment_method_configuration'] != null ? OneOf2.parse(json['payment_method_configuration'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestFeaturesPaymentMethodUpdatePaymentMethodConfigurationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
