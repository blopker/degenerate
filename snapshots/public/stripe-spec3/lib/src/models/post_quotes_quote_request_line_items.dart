...
factory PostQuotesQuoteRequestLineItems.fromJson(Map<String, dynamic> json) { return PostQuotesQuoteRequestLineItems(
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostQuotesQuoteRequestLineItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesQuoteRequestLineItemsDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesQuoteRequestLineItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
