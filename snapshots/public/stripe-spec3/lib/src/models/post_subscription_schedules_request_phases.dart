...
factory PostSubscriptionSchedulesRequestPhases.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesRequestPhases(
  ...
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => BillingThresholdsParam5.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingThresholdsParam5.canParse(v), fromB: (v) => PostSubscriptionSchedulesRequestPhasesBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionSchedulesRequestPhasesDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSubscriptionSchedulesRequestPhasesDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionSchedulesRequestPhasesDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionSchedulesRequestPhasesDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
