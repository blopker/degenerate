...
import 'beneficiary_params_public_name.dart';final class BeneficiaryParams {const BeneficiaryParams({required this.publicName});

factory BeneficiaryParams.fromJson(Map<String, dynamic> json) { return BeneficiaryParams(
  publicName: BeneficiaryParamsPublicName.fromJson(json['public_name'] as Map<String, dynamic>),
); }
