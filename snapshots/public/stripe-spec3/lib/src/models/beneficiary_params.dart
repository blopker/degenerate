...
factory BeneficiaryParams.fromJson(Map<String, dynamic> json) { return BeneficiaryParams(
  publicName: OneOf2.parse(json['public_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BeneficiaryParamsPublicNameVariant2.fromJson(v as String), canParseB: (v) => v is String,),
); }
