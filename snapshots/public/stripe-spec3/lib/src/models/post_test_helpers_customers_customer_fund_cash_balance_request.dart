...
import 'package:collection/collection.dart';final class PostTestHelpersCustomersCustomerFundCashBalanceRequest {const PostTestHelpersCustomersCustomerFundCashBalanceRequest({required this.amount, required this.currency, this.expand, this.reference, });
