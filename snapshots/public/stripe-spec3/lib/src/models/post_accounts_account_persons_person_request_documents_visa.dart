...
import 'package:collection/collection.dart';import 'post_accounts_account_persons_person_request_documents_visa_files.dart';final class PostAccountsAccountPersonsPersonRequestDocumentsVisa {const PostAccountsAccountPersonsPersonRequestDocumentsVisa({this.files});
...
factory PostAccountsAccountPersonsPersonRequestDocumentsVisa.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsPersonRequestDocumentsVisa(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPersonsPersonRequestDocumentsVisaFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
