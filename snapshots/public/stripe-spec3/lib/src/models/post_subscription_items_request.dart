...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_subscription_items_request_billing_thresholds.dart';import 'post_subscription_items_request_discounts.dart';import 'post_subscription_items_request_price_data.dart';import 'post_subscription_items_request_tax_rates.dart';/// Use `allow_incomplete` to transition the subscription to `status=past_due` if a payment is required but cannot be paid. This allows you to manage scenarios where additional user actions are needed to pay a subscription's invoice. For example, SCA regulation may require 3DS authentication to complete payment. See the [SCA Migration Guide](https://docs.stripe.com/billing/migration/strong-customer-authentication) for Billing to learn more. This is the default behavior.
/// 
...
factory PostSubscriptionItemsRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionItemsRequest(
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => ItemBillingThresholdsParam5.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ItemBillingThresholdsParam5.canParse(v), fromB: (v) => PostSubscriptionItemsRequestBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionItemsRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionItemsRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionItemsRequestTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
