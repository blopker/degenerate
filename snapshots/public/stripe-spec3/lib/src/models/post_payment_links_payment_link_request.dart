...
factory PostPaymentLinksPaymentLinkRequest.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequest(
  ...
  customFields: json['custom_fields'] != null ? OneOf2.parse(json['custom_fields'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentLinksPaymentLinkRequestCustomFieldsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentLinksPaymentLinkRequestCustomFieldsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  inactiveMessage: json['inactive_message'] != null ? OneOf2.parse(json['inactive_message'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentLinksPaymentLinkRequestInactiveMessageVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  nameCollection: json['name_collection'] != null ? OneOf2.parse(json['name_collection'], fromA: (v) => NameCollectionParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && NameCollectionParams.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestNameCollectionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  optionalItems: json['optional_items'] != null ? OneOf2.parse(json['optional_items'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentLinksPaymentLinkRequestOptionalItemsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentLinksPaymentLinkRequestOptionalItemsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  paymentMethodTypes: json['payment_method_types'] != null ? OneOf2.parse(json['payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentLinksPaymentLinkRequestPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  restrictions: json['restrictions'] != null ? OneOf2.parse(json['restrictions'], fromA: (v) => RestrictionsParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RestrictionsParams.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestRestrictionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippingAddressCollection: json['shipping_address_collection'] != null ? OneOf2.parse(json['shipping_address_collection'], fromA: (v) => ShippingAddressCollectionParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ShippingAddressCollectionParams.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestShippingAddressCollectionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
