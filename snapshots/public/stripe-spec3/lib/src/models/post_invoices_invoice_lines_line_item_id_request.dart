...
factory PostInvoicesInvoiceLinesLineItemIdRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceLinesLineItemIdRequest(
  ...
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceLinesLineItemIdRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceLinesLineItemIdRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostInvoicesInvoiceLinesLineItemIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxAmounts: json['tax_amounts'] != null ? OneOf2.parse(json['tax_amounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceLinesLineItemIdRequestTaxAmountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceLinesLineItemIdRequestTaxAmountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceLinesLineItemIdRequestTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
