...
factory PostSourcesRequestMandate.fromJson(Map<String, dynamic> json) { return PostSourcesRequestMandate(
  ...
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSourcesRequestMandateAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
