...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_prices_price_request_currency_options.dart';import 'post_prices_price_request_metadata.dart';/// Only required if a [default tax behavior](https://docs.stripe.com/tax/products-prices-tax-categories-tax-behavior#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of `inclusive`, `exclusive`, or `unspecified`. Once specified as either `inclusive` or `exclusive`, it cannot be changed.
...
factory PostPricesPriceRequest.fromJson(Map<String, dynamic> json) { return PostPricesPriceRequest(
  ...
  currencyOptions: json['currency_options'] != null ? OneOf2.parse(json['currency_options'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, PostPricesPriceRequestCurrencyOptionsVariant1Value.fromJson(v as Map<String, dynamic>))), canParseA: (v) => v is Map, fromB: (v) => PostPricesPriceRequestCurrencyOptionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  lookupKey: json['lookup_key'] as String?,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPricesPriceRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
