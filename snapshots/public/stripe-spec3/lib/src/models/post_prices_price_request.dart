...
import 'package:collection/collection.dart';import 'post_prices_price_request_currency_options.dart';import 'post_prices_price_request_metadata.dart';import 'post_prices_price_request_tax_behavior.dart';final class PostPricesPriceRequest {const PostPricesPriceRequest({this.active, this.currencyOptions, this.expand, this.lookupKey, this.metadata, this.nickname, this.taxBehavior, this.transferLookupKey, });
