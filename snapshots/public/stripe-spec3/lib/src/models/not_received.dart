...
factory NotReceived.fromJson(Map<String, dynamic> json) { return NotReceived(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => NotReceivedAdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expectedAt: json['expected_at'] != null ? OneOf2.parse(json['expected_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => NotReceivedExpectedAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => NotReceivedExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => NotReceivedProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
