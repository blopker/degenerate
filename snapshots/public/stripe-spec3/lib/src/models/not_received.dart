...
import 'not_received_additional_documentation.dart';import 'not_received_expected_at.dart';import 'not_received_explanation.dart';import 'not_received_product_description.dart';final class NotReceivedProductType {const NotReceivedProductType._(this.value);
...
factory NotReceived.fromJson(Map<String, dynamic> json) { return NotReceived(
  additionalDocumentation: json['additional_documentation'] != null ? NotReceivedAdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  expectedAt: json['expected_at'] != null ? NotReceivedExpectedAt.fromJson(json['expected_at'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? NotReceivedExplanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? NotReceivedProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
