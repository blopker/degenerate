...
import 'invoice_payment_method_options_param25_installments_plan.dart';final class InvoicePaymentMethodOptionsParam25Installments {const InvoicePaymentMethodOptionsParam25Installments({this.enabled, this.plan, });
...
factory InvoicePaymentMethodOptionsParam25Installments.fromJson(Map<String, dynamic> json) { return InvoicePaymentMethodOptionsParam25Installments(
  ...
  plan: json['plan'] != null ? InvoicePaymentMethodOptionsParam25InstallmentsPlan.fromJson(json['plan'] as Map<String, dynamic>) : null,
); }
