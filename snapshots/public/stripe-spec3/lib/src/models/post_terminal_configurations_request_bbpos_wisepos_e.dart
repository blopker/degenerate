...
factory PostTerminalConfigurationsRequestBbposWiseposE.fromJson(Map<String, dynamic> json) { return PostTerminalConfigurationsRequestBbposWiseposE(
  splashscreen: json['splashscreen'] != null ? OneOf2.parse(json['splashscreen'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalConfigurationsRequestBbposWiseposESplashscreenVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
