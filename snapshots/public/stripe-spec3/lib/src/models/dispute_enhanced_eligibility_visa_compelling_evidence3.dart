...
import 'package:collection/collection.dart';final class DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions {const DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions._(this.value);
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is DisputeEnhancedEligibilityVisaCompellingEvidence3 &&
          const ListEquality<dynamic>().equals(requiredActions, other.requiredActions) &&
          status == other.status; } 
