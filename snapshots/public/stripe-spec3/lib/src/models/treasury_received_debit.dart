...
factory TreasuryReceivedDebit.fromJson(Map<String, dynamic> json) { return TreasuryReceivedDebit(
  ...
  transaction: json['transaction'] != null ? OneOf2.parse(json['transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TreasuryTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TreasuryTransaction.canParse(v),) : null,
); }
