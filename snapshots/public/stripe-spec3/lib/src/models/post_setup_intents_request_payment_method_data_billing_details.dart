...
factory PostSetupIntentsRequestPaymentMethodDataBillingDetails.fromJson(Map<String, dynamic> json) { return PostSetupIntentsRequestPaymentMethodDataBillingDetails(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => BillingDetailsAddress7.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingDetailsAddress7.canParse(v), fromB: (v) => PostSetupIntentsRequestPaymentMethodDataBillingDetailsAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  email: json['email'] != null ? OneOf2.parse(json['email'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodDataBillingDetailsEmailVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodDataBillingDetailsNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  phone: json['phone'] != null ? OneOf2.parse(json['phone'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodDataBillingDetailsPhoneVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
