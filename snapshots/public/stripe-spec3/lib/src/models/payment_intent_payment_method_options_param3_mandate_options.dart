...
factory PaymentIntentPaymentMethodOptionsParam3MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam3MandateOptions(
  referencePrefix: json['reference_prefix'] != null ? OneOf2.parse(json['reference_prefix'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentPaymentMethodOptionsParam3MandateOptionsReferencePrefixVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
