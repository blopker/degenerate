...
import 'payment_intent_payment_method_options_param3_mandate_options_reference_prefix.dart';final class PaymentIntentPaymentMethodOptionsParam3MandateOptions {const PaymentIntentPaymentMethodOptionsParam3MandateOptions({this.referencePrefix});
...
factory PaymentIntentPaymentMethodOptionsParam3MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam3MandateOptions(
  referencePrefix: json['reference_prefix'] != null ? PaymentIntentPaymentMethodOptionsParam3MandateOptionsReferencePrefix.fromJson(json['reference_prefix'] as Map<String, dynamic>) : null,
); }
