...
factory PostInvoicesCreatePreviewRequestSubscriptionDetails.fromJson(Map<String, dynamic> json) { return PostInvoicesCreatePreviewRequestSubscriptionDetails(
  billingCycleAnchor: json['billing_cycle_anchor'] != null ? OneOf2.parse(json['billing_cycle_anchor'], fromA: (v) => PostInvoicesCreatePreviewRequestSubscriptionDetailsBillingCycleAnchorVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
  ...
  cancelAt: json['cancel_at'] != null ? OneOf3.parse(json['cancel_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesCreatePreviewRequestSubscriptionDetailsCancelAtVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => PostInvoicesCreatePreviewRequestSubscriptionDetailsCancelAtVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
  cancelAtPeriodEnd: json['cancel_at_period_end'] as bool?,
  cancelNow: json['cancel_now'] as bool?,
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesCreatePreviewRequestSubscriptionDetailsDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  trialEnd: json['trial_end'] != null ? OneOf2.parse(json['trial_end'], fromA: (v) => PostInvoicesCreatePreviewRequestSubscriptionDetailsTrialEndVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
); }
