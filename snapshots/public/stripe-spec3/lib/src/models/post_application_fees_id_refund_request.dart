...
import 'package:collection/collection.dart';final class PostApplicationFeesIdRefundRequest {const PostApplicationFeesIdRefundRequest({this.amount, this.directive, this.expand, });
