...
factory PostBillingPortalConfigurationsRequestFeaturesPaymentMethodUpdate.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsRequestFeaturesPaymentMethodUpdate(
  ...
  paymentMethodConfiguration: json['payment_method_configuration'] != null ? OneOf2.parse(json['payment_method_configuration'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsRequestFeaturesPaymentMethodUpdatePaymentMethodConfigurationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
