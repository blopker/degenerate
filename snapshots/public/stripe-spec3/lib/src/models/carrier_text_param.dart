...
factory CarrierTextParam.fromJson(Map<String, dynamic> json) { return CarrierTextParam(
  footerBody: json['footer_body'] != null ? OneOf2.parse(json['footer_body'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CarrierTextParamFooterBodyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  footerTitle: json['footer_title'] != null ? OneOf2.parse(json['footer_title'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CarrierTextParamFooterTitleVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  headerBody: json['header_body'] != null ? OneOf2.parse(json['header_body'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CarrierTextParamHeaderBodyVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  headerTitle: json['header_title'] != null ? OneOf2.parse(json['header_title'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CarrierTextParamHeaderTitleVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
