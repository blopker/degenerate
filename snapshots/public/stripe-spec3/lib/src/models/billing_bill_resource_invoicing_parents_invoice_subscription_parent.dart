...
factory BillingBillResourceInvoicingParentsInvoiceSubscriptionParent.fromJson(Map<String, dynamic> json) { return BillingBillResourceInvoicingParentsInvoiceSubscriptionParent(
  ...
  subscription: OneOf2.parse(json['subscription'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Subscription.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Subscription.canParse(v),),
