...
factory CreditNotesPretaxCreditAmount.fromJson(Map<String, dynamic> json) { return CreditNotesPretaxCreditAmount(
  ...
  creditBalanceTransaction: json['credit_balance_transaction'] != null ? OneOf2.parse(json['credit_balance_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BillingCreditBalanceTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BillingCreditBalanceTransaction.canParse(v),) : null,
  discount: json['discount'] != null ? OneOf3.parse(json['discount'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Discount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Discount.canParse(v), fromC: (v) => DeletedDiscount.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DeletedDiscount.canParse(v),) : null,
