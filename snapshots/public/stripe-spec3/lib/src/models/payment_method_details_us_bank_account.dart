...
import 'payment_method_details_us_bank_account_mandate.dart';/// Account holder type: individual or company.
...
factory PaymentMethodDetailsUsBankAccount.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsUsBankAccount(
  ...
  mandate: json['mandate'] != null ? PaymentMethodDetailsUsBankAccountMandate.fromJson(json['mandate'] as Map<String, dynamic>) : null,
