...
import 'inline_object568_additional_documentation.dart';import 'inline_object568_canceled_at.dart';import 'inline_object568_cancellation_policy_provided.dart';import 'inline_object568_cancellation_reason.dart';import 'inline_object568_expected_at.dart';import 'inline_object568_explanation.dart';import 'inline_object568_product_description.dart';import 'inline_object568_returned_at.dart';final class InlineObject568ProductType {const InlineObject568ProductType._(this.value);

factory InlineObject568ProductType.fromJson(String json) { return switch (json) {
  '' => $empty,
...
static const InlineObject568ProductType merchandise = InlineObject568ProductType._('merchandise');

static const InlineObject568ProductType service = InlineObject568ProductType._('service');

static const List<InlineObject568ProductType> values = [$empty, merchandise, service];
...
@override String toString() { return 'InlineObject568ProductType($value)'; } 
 }
...
InlineObject568 copyWith({InlineObject568AdditionalDocumentation Function()? additionalDocumentation, InlineObject568CanceledAt Function()? canceledAt, InlineObject568CancellationPolicyProvided Function()? cancellationPolicyProvided, InlineObject568CancellationReason Function()? cancellationReason, InlineObject568ExpectedAt Function()? expectedAt, InlineObject568Explanation Function()? explanation, InlineObject568ProductDescription Function()? productDescription, InlineObject568ProductType Function()? productType, InlineObject568ReturnStatus Function()? returnStatus, InlineObject568ReturnedAt Function()? returnedAt, }) { return InlineObject568(
...
@override String toString() { return 'InlineObject568(additionalDocumentation: $additionalDocumentation, canceledAt: $canceledAt, cancellationPolicyProvided: $cancellationPolicyProvided, cancellationReason: $cancellationReason, expectedAt: $expectedAt, explanation: $explanation, productDescription: $productDescription, productType: $productType, returnStatus: $returnStatus, returnedAt: $returnedAt)'; } 
 }
