...
import 'package:collection/collection.dart';final class PostCustomersCustomerSourcesIdVerifyRequest {const PostCustomersCustomerSourcesIdVerifyRequest({this.amounts, this.expand, });
