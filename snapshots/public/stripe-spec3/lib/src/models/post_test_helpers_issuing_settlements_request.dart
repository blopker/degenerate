...
import 'package:collection/collection.dart';import 'post_test_helpers_issuing_settlements_request_network.dart';final class PostTestHelpersIssuingSettlementsRequest {const PostTestHelpersIssuingSettlementsRequest({required this.bin, required this.clearingDate, required this.currency, this.expand, this.interchangeFeesAmount, required this.netTotalAmount, this.network, this.networkSettlementIdentifier, this.transactionAmount, this.transactionCount, });
