...
import 'package:collection/collection.dart';final class PostTerminalConnectionTokensRequest {const PostTerminalConnectionTokensRequest({this.expand, this.location, });
