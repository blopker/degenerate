...
import 'package:collection/collection.dart';import 'post_accounts_account_persons_person_request_documents_passport_files.dart';final class PostAccountsAccountPersonsPersonRequestDocumentsPassport {const PostAccountsAccountPersonsPersonRequestDocumentsPassport({this.files});
...
factory PostAccountsAccountPersonsPersonRequestDocumentsPassport.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsPersonRequestDocumentsPassport(
  files: (json['files'] as List<dynamic>?)?.map((e) => PostAccountsAccountPersonsPersonRequestDocumentsPassportFiles.fromJson(e as Map<String, dynamic>)).toList(),
); }
