...
factory AmountDetailsShippingParam3.fromJson(Map<String, dynamic> json) { return AmountDetailsShippingParam3(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => AmountDetailsShippingParam3AmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  fromPostalCode: json['from_postal_code'] != null ? OneOf2.parse(json['from_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParam3FromPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  toPostalCode: json['to_postal_code'] != null ? OneOf2.parse(json['to_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParam3ToPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
