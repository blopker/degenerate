...
final class PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1 {const PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1._(this.value);
...
final class PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdates {const PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdates({this.listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1, this.postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2, });
...
factory PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdates.fromJson(Object? json) { return PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdates(
  // listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1: skipped (collection type in anyOf not supported)
  postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2: json is String ? PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2.fromJson(json) : null,
); }

final List<PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1>? listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1;

final PostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2? postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2;

/// At least one variant must be present.
bool get isValid { return listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1 != null || postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2 != null; } 
Map<String, dynamic> toJson() { return {
  'listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1': ?listPostBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant1,
  if (postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2 != null) 'postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2': postBillingPortalConfigurationsRequestFeaturesCustomerUpdateAllowedUpdatesVariant2!.toJson(),
}; } 
 }
