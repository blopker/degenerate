...
import 'setup_attempt_payment_method_details_bancontact_generated_sepa_debit.dart';import 'setup_attempt_payment_method_details_bancontact_generated_sepa_debit_mandate.dart';/// Preferred language of the Bancontact authorization page that the customer is redirected to.
...
factory SetupAttemptPaymentMethodDetailsBancontact.fromJson(Map<String, dynamic> json) { return SetupAttemptPaymentMethodDetailsBancontact(
  ...
  generatedSepaDebit: json['generated_sepa_debit'] != null ? SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebit.fromJson(json['generated_sepa_debit'] as Map<String, dynamic>) : null,
  generatedSepaDebitMandate: json['generated_sepa_debit_mandate'] != null ? SetupAttemptPaymentMethodDetailsBancontactGeneratedSepaDebitMandate.fromJson(json['generated_sepa_debit_mandate'] as Map<String, dynamic>) : null,
