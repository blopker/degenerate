...
factory PostTerminalConfigurationsRequestStripeS700.fromJson(Map<String, dynamic> json) { return PostTerminalConfigurationsRequestStripeS700(
  splashscreen: json['splashscreen'] != null ? OneOf2.parse(json['splashscreen'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalConfigurationsRequestStripeS700SplashscreenVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
