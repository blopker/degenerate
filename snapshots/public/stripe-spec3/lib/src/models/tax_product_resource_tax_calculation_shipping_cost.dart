...
import 'package:collection/collection.dart';import 'tax_product_resource_line_item_tax_breakdown.dart';/// Specifies whether the `amount` includes taxes. If `tax_behavior=inclusive`, then the amount includes taxes.
