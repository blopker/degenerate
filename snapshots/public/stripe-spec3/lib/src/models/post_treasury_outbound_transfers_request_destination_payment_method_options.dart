...
factory PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptions(
  usBankAccount: json['us_bank_account'] != null ? OneOf2.parse(json['us_bank_account'], fromA: (v) => PaymentMethodOptionsParam113.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PaymentMethodOptionsParam113.canParse(v), fromB: (v) => PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptionsUsBankAccountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
