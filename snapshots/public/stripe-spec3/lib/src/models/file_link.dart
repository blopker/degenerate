...
factory FileLink.fromJson(Map<String, dynamic> json) { return FileLink(
  ...
  file: OneOf2.parse(json['file'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),),
