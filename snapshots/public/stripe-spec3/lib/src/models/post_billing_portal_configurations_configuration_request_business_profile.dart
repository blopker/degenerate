...
factory PostBillingPortalConfigurationsConfigurationRequestBusinessProfile.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsConfigurationRequestBusinessProfile(
  headline: json['headline'] != null ? OneOf2.parse(json['headline'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestBusinessProfileHeadlineVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  privacyPolicyUrl: json['privacy_policy_url'] != null ? OneOf2.parse(json['privacy_policy_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestBusinessProfilePrivacyPolicyUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  termsOfServiceUrl: json['terms_of_service_url'] != null ? OneOf2.parse(json['terms_of_service_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestBusinessProfileTermsOfServiceUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
