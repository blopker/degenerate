...
import 'payment_method_details_payment_record_us_bank_account_mandate.dart';/// The type of entity that holds the account. This can be either 'individual' or 'company'.
