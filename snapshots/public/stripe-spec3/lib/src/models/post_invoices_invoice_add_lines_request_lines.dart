...
factory PostInvoicesInvoiceAddLinesRequestLines.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceAddLinesRequestLines(
  ...
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceAddLinesRequestLinesDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceAddLinesRequestLinesDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  invoiceItem: json['invoice_item'] as String?,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostInvoicesInvoiceAddLinesRequestLinesMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxAmounts: json['tax_amounts'] != null ? OneOf2.parse(json['tax_amounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceAddLinesRequestLinesTaxAmountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceAddLinesRequestLinesTaxAmountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceAddLinesRequestLinesTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
