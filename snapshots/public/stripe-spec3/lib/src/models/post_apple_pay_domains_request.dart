...
import 'package:collection/collection.dart';final class PostApplePayDomainsRequest {const PostApplePayDomainsRequest({required this.domainName, this.expand, });
