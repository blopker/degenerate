...
factory IssuingCard.fromJson(Map<String, dynamic> json) { return IssuingCard(
  ...
  personalizationDesign: json['personalization_design'] != null ? OneOf2.parse(json['personalization_design'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingPersonalizationDesign.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingPersonalizationDesign.canParse(v),) : null,
  replacedBy: json['replaced_by'] != null ? OneOf2.parse(json['replaced_by'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingCard.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingCard.canParse(v),) : null,
  replacementFor: json['replacement_for'] != null ? OneOf2.parse(json['replacement_for'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingCard.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingCard.canParse(v),) : null,
