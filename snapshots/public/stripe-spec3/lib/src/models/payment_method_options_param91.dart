...
import 'payment_method_options_param91_on_demand.dart';import 'payment_method_options_param91_subscriptions.dart';final class PaymentMethodOptionsParam91CaptureMethod {const PaymentMethodOptionsParam91CaptureMethod._(this.value);
...
factory PaymentMethodOptionsParam91.fromJson(Map<String, dynamic> json) { return PaymentMethodOptionsParam91(
  ...
  subscriptions: json['subscriptions'] != null ? PaymentMethodOptionsParam91Subscriptions.fromJson(json['subscriptions'] as Map<String, dynamic>) : null,
); }
