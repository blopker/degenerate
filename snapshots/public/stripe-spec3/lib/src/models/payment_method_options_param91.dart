...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payment_method_options_param91_on_demand.dart';import 'payment_method_options_param91_subscriptions.dart';final class PaymentMethodOptionsParam91CaptureMethod {const PaymentMethodOptionsParam91CaptureMethod._(this.value);
...
factory PaymentMethodOptionsParam91.fromJson(Map<String, dynamic> json) { return PaymentMethodOptionsParam91(
  ...
  subscriptions: json['subscriptions'] != null ? OneOf2.parse(json['subscriptions'], fromA: (v) => (v as List<dynamic>).map((e) => PaymentMethodOptionsParam91SubscriptionsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PaymentMethodOptionsParam91SubscriptionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
