...
import 'package:collection/collection.dart';import 'post_refunds_request_metadata.dart';/// Origin of the refund
...
factory PostRefundsRequest.fromJson(Map<String, dynamic> json) { return PostRefundsRequest(
  ...
  metadata: json['metadata'] != null ? PostRefundsRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
