...
import 'payment_intent_payment_method_options_param40_mandate_options_reference_prefix.dart';final class PaymentIntentPaymentMethodOptionsParam40MandateOptions {const PaymentIntentPaymentMethodOptionsParam40MandateOptions({this.referencePrefix});
...
factory PaymentIntentPaymentMethodOptionsParam40MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam40MandateOptions(
  referencePrefix: json['reference_prefix'] != null ? PaymentIntentPaymentMethodOptionsParam40MandateOptionsReferencePrefix.fromJson(json['reference_prefix'] as Map<String, dynamic>) : null,
); }
