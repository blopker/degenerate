...
factory PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeopleRequestDocumentsCompanyAuthorization(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPeopleRequestDocumentsCompanyAuthorizationFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
