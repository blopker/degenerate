...
factory GetCreditNotesPreviewLinesLines.fromJson(Map<String, dynamic> json) { return GetCreditNotesPreviewLinesLines(
  ...
  taxAmounts: json['tax_amounts'] != null ? GetCreditNotesPreviewLinesLinesTaxAmounts.fromJson(json['tax_amounts'] as Map<String, dynamic>) : null,
  taxRates: json['tax_rates'] != null ? GetCreditNotesPreviewLinesLinesTaxRates.fromJson(json['tax_rates'] as Map<String, dynamic>) : null,
