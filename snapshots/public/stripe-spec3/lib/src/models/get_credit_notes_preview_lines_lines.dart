...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_credit_notes_preview_lines_lines_tax_amounts.dart';import 'get_credit_notes_preview_lines_lines_tax_rates.dart';final class GetCreditNotesPreviewLinesLinesType {const GetCreditNotesPreviewLinesLinesType._(this.value);
...
factory GetCreditNotesPreviewLinesLines.fromJson(Map<String, dynamic> json) { return GetCreditNotesPreviewLinesLines(
  ...
  taxAmounts: json['tax_amounts'] != null ? OneOf2.parse(json['tax_amounts'], fromA: (v) => (v as List<dynamic>).map((e) => GetCreditNotesPreviewLinesLinesTaxAmountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => GetCreditNotesPreviewLinesLinesTaxAmountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => GetCreditNotesPreviewLinesLinesTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
