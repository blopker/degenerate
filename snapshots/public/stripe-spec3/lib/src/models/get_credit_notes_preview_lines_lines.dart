...
import 'get_credit_notes_preview_lines_lines_tax_amounts.dart';import 'get_credit_notes_preview_lines_lines_tax_rates.dart';import 'get_credit_notes_preview_lines_lines_type.dart';final class GetCreditNotesPreviewLinesLines {const GetCreditNotesPreviewLinesLines({this.amount, this.description, this.invoiceLineItem, this.quantity, this.taxAmounts, this.taxRates, required this.type, this.unitAmount, this.unitAmountDecimal, });
