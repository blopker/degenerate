...
factory PaymentIntentParam.fromJson(Map<String, dynamic> json) { return PaymentIntentParam(
  ...
  statementDescriptorSuffixKana: json['statement_descriptor_suffix_kana'] != null ? PaymentIntentParamStatementDescriptorSuffixKana.fromJson(json['statement_descriptor_suffix_kana'] as Map<String, dynamic>) : null,
  statementDescriptorSuffixKanji: json['statement_descriptor_suffix_kanji'] != null ? PaymentIntentParamStatementDescriptorSuffixKanji.fromJson(json['statement_descriptor_suffix_kanji'] as Map<String, dynamic>) : null,
