...
final class InlineObject418 {const InlineObject418({this.amountGte, this.resetBillingCycleAnchor, });
...
InlineObject418 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject418(
...
@override String toString() { return 'InlineObject418(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
