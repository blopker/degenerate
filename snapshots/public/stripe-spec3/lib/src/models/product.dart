...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'product_default_price.dart';import 'product_marketing_feature.dart';import 'product_package_dimensions.dart';import 'product_tax_code.dart';/// String representing the object's type. Objects of the same type share the same value.
...
factory Product.fromJson(Map<String, dynamic> json) { return Product(
  ...
  defaultPrice: json['default_price'] != null ? OneOf2.parse(json['default_price'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Price.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Price.canParse(v),) : null,
  ...
  taxCode: json['tax_code'] != null ? OneOf2.parse(json['tax_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TaxCode.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TaxCode.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Product &&
          ...
          const ListEquality<dynamic>().equals(marketingFeatures, other.marketingFeatures) &&
