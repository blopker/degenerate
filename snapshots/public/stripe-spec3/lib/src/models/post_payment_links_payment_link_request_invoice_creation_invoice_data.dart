...
factory PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceData.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceData(
  accountTaxIds: json['account_tax_ids'] != null ? OneOf2.parse(json['account_tax_ids'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceDataAccountTaxIdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  customFields: json['custom_fields'] != null ? OneOf2.parse(json['custom_fields'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceDataCustomFieldsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceDataCustomFieldsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceDataMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  renderingOptions: json['rendering_options'] != null ? OneOf2.parse(json['rendering_options'], fromA: (v) => CheckoutRenderingOptionsParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CheckoutRenderingOptionsParam3.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestInvoiceCreationInvoiceDataRenderingOptionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
