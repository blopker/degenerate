...
import 'package:collection/collection.dart';final class PostBillingMeterEventsRequest {const PostBillingMeterEventsRequest({required this.eventName, this.expand, this.identifier, required this.payload, this.timestamp, });
