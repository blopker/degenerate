...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_payment_records_id_report_refund_request_amount.dart';import 'post_payment_records_id_report_refund_request_metadata.dart';import 'post_payment_records_id_report_refund_request_processor_details.dart';import 'post_payment_records_id_report_refund_request_refunded.dart';/// The outcome of the reported refund.
...
factory PostPaymentRecordsIdReportRefundRequest.fromJson(Map<String, dynamic> json) { return PostPaymentRecordsIdReportRefundRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentRecordsIdReportRefundRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
