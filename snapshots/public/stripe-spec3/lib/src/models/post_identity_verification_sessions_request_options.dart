...
factory PostIdentityVerificationSessionsRequestOptions.fromJson(Map<String, dynamic> json) { return PostIdentityVerificationSessionsRequestOptions(
  document: json['document'] != null ? OneOf2.parse(json['document'], fromA: (v) => DocumentOptions.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && DocumentOptions.canParse(v), fromB: (v) => PostIdentityVerificationSessionsRequestOptionsDocumentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
