...
import 'package:collection/collection.dart';final class PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequest {const PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequest({this.expand, required this.incrementAmount, this.isAmountControllable, });
