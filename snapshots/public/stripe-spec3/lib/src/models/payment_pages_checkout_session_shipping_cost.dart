...
import 'package:collection/collection.dart';import 'line_items_tax_amount.dart';import 'payment_pages_checkout_session_shipping_cost_shipping_rate.dart';/// 
...
factory PaymentPagesCheckoutSessionShippingCost.fromJson(Map<String, dynamic> json) { return PaymentPagesCheckoutSessionShippingCost(
  ...
  shippingRate: json['shipping_rate'] != null ? PaymentPagesCheckoutSessionShippingCostShippingRate.fromJson(json['shipping_rate'] as Map<String, dynamic>) : null,
