...
factory PostInvoicesCreatePreviewRequestCustomerDetails.fromJson(Map<String, dynamic> json) { return PostInvoicesCreatePreviewRequestCustomerDetails(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => OptionalFieldsAddress.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && OptionalFieldsAddress.canParse(v), fromB: (v) => PostInvoicesCreatePreviewRequestCustomerDetailsAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => CustomerShipping4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerShipping4.canParse(v), fromB: (v) => PostInvoicesCreatePreviewRequestCustomerDetailsShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
