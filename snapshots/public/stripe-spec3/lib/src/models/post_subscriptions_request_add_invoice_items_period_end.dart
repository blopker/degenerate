...
import 'post_subscriptions_request_add_invoice_items_period_end_type.dart';final class PostSubscriptionsRequestAddInvoiceItemsPeriodEnd {const PostSubscriptionsRequestAddInvoiceItemsPeriodEnd({this.timestamp, required this.type, });
