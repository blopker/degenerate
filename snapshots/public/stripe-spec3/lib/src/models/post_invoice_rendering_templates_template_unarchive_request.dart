...
import 'package:collection/collection.dart';final class PostInvoiceRenderingTemplatesTemplateUnarchiveRequest {const PostInvoiceRenderingTemplatesTemplateUnarchiveRequest({this.expand});
