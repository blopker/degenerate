...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_treasury_transactions_status_transitions_posted_at.dart';final class GetTreasuryTransactionsStatusTransitions {const GetTreasuryTransactionsStatusTransitions({this.postedAt});
...
factory GetTreasuryTransactionsStatusTransitions.fromJson(Map<String, dynamic> json) { return GetTreasuryTransactionsStatusTransitions(
  postedAt: json['posted_at'] != null ? OneOf2.parse(json['posted_at'], fromA: (v) => RangeQuerySpecs60.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RangeQuerySpecs60.canParse(v), fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
); }
