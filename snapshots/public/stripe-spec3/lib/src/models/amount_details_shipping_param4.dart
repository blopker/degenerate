...
factory AmountDetailsShippingParam4.fromJson(Map<String, dynamic> json) { return AmountDetailsShippingParam4(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => AmountDetailsShippingParam4AmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  fromPostalCode: json['from_postal_code'] != null ? OneOf2.parse(json['from_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParam4FromPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  toPostalCode: json['to_postal_code'] != null ? OneOf2.parse(json['to_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParam4ToPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
