...
factory BillingBillResourceInvoicingPricingPricingPriceDetails.fromJson(Map<String, dynamic> json) { return BillingBillResourceInvoicingPricingPricingPriceDetails(
  price: OneOf2.parse(json['price'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Price.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Price.canParse(v),),
