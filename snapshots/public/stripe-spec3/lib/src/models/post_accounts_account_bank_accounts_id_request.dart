...
import 'package:collection/collection.dart';import 'post_accounts_account_bank_accounts_id_request_documents.dart';import 'post_accounts_account_bank_accounts_id_request_metadata.dart';/// The type of entity that holds the account. This can be either `individual` or `company`.
...
factory PostAccountsAccountBankAccountsIdRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountBankAccountsIdRequest(
  ...
  metadata: json['metadata'] != null ? PostAccountsAccountBankAccountsIdRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
