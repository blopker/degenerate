...
factory Errors.fromJson(Map<String, dynamic> json) { return Errors(
  ...
  source: json['source'] != null ? OneOf3.parse(json['source'], fromA: (v) => BankAccount.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BankAccount.canParse(v), fromB: (v) => Card.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Card.canParse(v), fromC: (v) => Source.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && Source.canParse(v),) : null,
