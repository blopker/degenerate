...
import 'post_treasury_financial_accounts_financial_account_close_request_forwarding_settings_type.dart';/// A different bank account where funds can be deposited/debited in order to get the closing FA's balance to $0
