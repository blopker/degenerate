...
import 'package:collection/collection.dart';import 'post_climate_orders_request_beneficiary.dart';final class PostClimateOrdersRequest {const PostClimateOrdersRequest({this.amount, this.beneficiary, this.currency, this.expand, this.metadata, this.metricTons, required this.product, });
