...
import 'package:collection/collection.dart';final class PostTreasuryDebitReversalsRequest {const PostTreasuryDebitReversalsRequest({this.expand, this.metadata, required this.receivedDebit, });
