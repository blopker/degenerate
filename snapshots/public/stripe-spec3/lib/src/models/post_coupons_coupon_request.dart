...
import 'package:collection/collection.dart';import 'inline_object185.dart';import 'post_coupons_coupon_request_metadata.dart';final class PostCouponsCouponRequest {const PostCouponsCouponRequest({this.currencyOptions, this.expand, this.metadata, this.name, });
...
PostCouponsCouponRequest copyWith({Map<String, InlineObject185> Function()? currencyOptions, List<String> Function()? expand, PostCouponsCouponRequestMetadata Function()? metadata, String Function()? name, }) { return PostCouponsCouponRequest(
