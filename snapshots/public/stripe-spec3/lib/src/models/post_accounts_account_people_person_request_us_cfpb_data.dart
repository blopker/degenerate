...
factory PostAccountsAccountPeoplePersonRequestUsCfpbData.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequestUsCfpbData(
  ethnicityDetails: json['ethnicity_details'] != null
        ? PostAccountsAccountPeoplePersonRequestUsCfpbDataEthnicityDetails.fromJson(json['ethnicity_details'] as Map<String, dynamic>)
        : null,
  raceDetails: json['race_details'] != null
        ? PostAccountsAccountPeoplePersonRequestUsCfpbDataRaceDetails.fromJson(json['race_details'] as Map<String, dynamic>)
        : null,
