...
factory PostCustomersRequest.fromJson(Map<String, dynamic> json) { return PostCustomersRequest(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => OptionalFieldsCustomerAddress.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && OptionalFieldsCustomerAddress.canParse(v), fromB: (v) => PostCustomersRequestAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  balance: json['balance'] != null ? (json['balance'] as num).toInt() : null,
  businessName: json['business_name'] != null ? OneOf2.parse(json['business_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersRequestBusinessNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  individualName: json['individual_name'] != null ? OneOf2.parse(json['individual_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersRequestIndividualNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCustomersRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => CustomerShipping2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerShipping2.canParse(v), fromB: (v) => PostCustomersRequestShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
