...
factory PostPaymentIntentsIntentCaptureRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentCaptureRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentIntentsIntentCaptureRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  paymentDetails: json['payment_details'] != null ? OneOf2.parse(json['payment_details'], fromA: (v) => PaymentDetailsCaptureParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PaymentDetailsCaptureParams.canParse(v), fromB: (v) => PostPaymentIntentsIntentCaptureRequestPaymentDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
