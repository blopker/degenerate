...
factory PostPaymentIntentsIntentCaptureRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentCaptureRequest(
  ...
  metadata: json['metadata'] != null ? PostPaymentIntentsIntentCaptureRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
  paymentDetails: json['payment_details'] != null ? PostPaymentIntentsIntentCaptureRequestPaymentDetails.fromJson(json['payment_details'] as Map<String, dynamic>) : null,
