...
import 'merchandise_not_as_described_additional_documentation.dart';import 'merchandise_not_as_described_explanation.dart';import 'merchandise_not_as_described_received_at.dart';import 'merchandise_not_as_described_return_description.dart';import 'merchandise_not_as_described_returned_at.dart';final class MerchandiseNotAsDescribedReturnStatus {const MerchandiseNotAsDescribedReturnStatus._(this.value);
...
factory MerchandiseNotAsDescribed.fromJson(Map<String, dynamic> json) { return MerchandiseNotAsDescribed(
  additionalDocumentation: json['additional_documentation'] != null ? MerchandiseNotAsDescribedAdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? MerchandiseNotAsDescribedExplanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  receivedAt: json['received_at'] != null ? MerchandiseNotAsDescribedReceivedAt.fromJson(json['received_at'] as Map<String, dynamic>) : null,
  returnDescription: json['return_description'] != null ? MerchandiseNotAsDescribedReturnDescription.fromJson(json['return_description'] as Map<String, dynamic>) : null,
  returnStatus: json['return_status'] != null ? MerchandiseNotAsDescribedReturnStatus.fromJson(json['return_status'] as String) : null,
  returnedAt: json['returned_at'] != null ? MerchandiseNotAsDescribedReturnedAt.fromJson(json['returned_at'] as Map<String, dynamic>) : null,
); }
