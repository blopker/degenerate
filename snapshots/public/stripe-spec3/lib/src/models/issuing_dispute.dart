...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'balance_transaction.dart';import 'issuing_dispute_evidence.dart';import 'issuing_dispute_transaction.dart';import 'issuing_dispute_treasury2.dart';/// The enum that describes the dispute loss outcome. If the dispute is not lost, this field will be absent. New enum values may be added in the future, so be sure to handle unknown values.
...
factory IssuingDispute.fromJson(Map<String, dynamic> json) { return IssuingDispute(
  ...
  transaction: OneOf2.parse(json['transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingTransaction.canParse(v),),
