...
factory PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions(
  usBankAccount: json['us_bank_account'] != null ? OneOf2.parse(json['us_bank_account'], fromA: (v) => PaymentMethodOptionsParam112.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PaymentMethodOptionsParam112.canParse(v), fromB: (v) => PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptionsUsBankAccountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
