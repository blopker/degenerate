...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_setup_intents_request_automatic_payment_methods.dart';import 'post_setup_intents_request_mandate_data.dart';import 'post_setup_intents_request_payment_method_data.dart';import 'post_setup_intents_request_payment_method_options.dart';import 'post_setup_intents_request_single_use.dart';final class PostSetupIntentsRequestExcludedPaymentMethodTypes {const PostSetupIntentsRequestExcludedPaymentMethodTypes._(this.value);
...
factory PostSetupIntentsRequest.fromJson(Map<String, dynamic> json) { return PostSetupIntentsRequest(
  ...
  mandateData: json['mandate_data'] != null ? OneOf2.parse(json['mandate_data'], fromA: (v) => SecretKeyParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SecretKeyParam3.canParse(v), fromB: (v) => PostSetupIntentsRequestMandateDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
