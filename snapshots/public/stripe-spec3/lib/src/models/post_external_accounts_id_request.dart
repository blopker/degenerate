...
import 'package:collection/collection.dart';import 'post_external_accounts_id_request_account_holder_type.dart';import 'post_external_accounts_id_request_account_type.dart';import 'post_external_accounts_id_request_documents.dart';import 'post_external_accounts_id_request_metadata.dart';final class PostExternalAccountsIdRequest {const PostExternalAccountsIdRequest({this.accountHolderName, this.accountHolderType, this.accountType, this.addressCity, this.addressCountry, this.addressLine1, this.addressLine2, this.addressState, this.addressZip, this.defaultForCurrency, this.documents, this.expMonth, this.expYear, this.expand, this.metadata, this.name, });
