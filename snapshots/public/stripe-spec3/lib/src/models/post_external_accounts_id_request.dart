...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_external_accounts_id_request_documents.dart';import 'post_external_accounts_id_request_metadata.dart';/// The type of entity that holds the account. This can be either `individual` or `company`.
...
factory PostExternalAccountsIdRequest.fromJson(Map<String, dynamic> json) { return PostExternalAccountsIdRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostExternalAccountsIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
