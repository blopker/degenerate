...
factory Subscription.fromJson(Map<String, dynamic> json) { return Subscription(
  ...
  defaultPaymentMethod: json['default_payment_method'] != null ? OneOf2.parse(json['default_payment_method'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentMethod.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PaymentMethod.canParse(v),) : null,
  defaultSource: json['default_source'] != null ? OneOf4.parse(json['default_source'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BankAccount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BankAccount.canParse(v), fromC: (v) => Card.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && Card.canParse(v), fromD: (v) => Source.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && Source.canParse(v),) : null,
  defaultTaxRates: (json['default_tax_rates'] as List<dynamic>?)?.map((e) => TaxRate.fromJson(e as Map<String, dynamic>)).toList(),
  description: json['description'] as String?,
  discounts: (json['discounts'] as List<dynamic>).map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Discount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Discount.canParse(v),)).toList(),
  ...
  latestInvoice: json['latest_invoice'] != null ? OneOf2.parse(json['latest_invoice'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Invoice.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Invoice.canParse(v),) : null,
  ...
  pendingSetupIntent: json['pending_setup_intent'] != null ? OneOf2.parse(json['pending_setup_intent'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SetupIntent.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntent.canParse(v),) : null,
  pendingUpdate: json['pending_update'] != null ? SubscriptionPendingUpdate.fromJson(json['pending_update'] as Map<String, dynamic>) : null,
  schedule: json['schedule'] != null ? OneOf2.parse(json['schedule'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SubscriptionSchedule.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SubscriptionSchedule.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is Subscription &&
          ...
          const ListEquality<dynamic>().equals(defaultTaxRates, other.defaultTaxRates) &&
