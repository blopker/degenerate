...
factory PostIssuingDisputesDisputeRequestEvidence.fromJson(Map<String, dynamic> json) { return PostIssuingDisputesDisputeRequestEvidence(
  canceled: json['canceled'] != null ? OneOf2.parse(json['canceled'], fromA: (v) => Canceled2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Canceled2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceCanceledVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  duplicate: json['duplicate'] != null ? OneOf2.parse(json['duplicate'], fromA: (v) => Duplicate2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Duplicate2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceDuplicateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  fraudulent: json['fraudulent'] != null ? OneOf2.parse(json['fraudulent'], fromA: (v) => Fraudulent2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Fraudulent2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceFraudulentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  merchandiseNotAsDescribed: json['merchandise_not_as_described'] != null ? OneOf2.parse(json['merchandise_not_as_described'], fromA: (v) => MerchandiseNotAsDescribed2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && MerchandiseNotAsDescribed2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceMerchandiseNotAsDescribedVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  noValidAuthorization: json['no_valid_authorization'] != null ? OneOf2.parse(json['no_valid_authorization'], fromA: (v) => NoValidAuthorization2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && NoValidAuthorization2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceNoValidAuthorizationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  notReceived: json['not_received'] != null ? OneOf2.parse(json['not_received'], fromA: (v) => NotReceived2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && NotReceived2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceNotReceivedVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  other: json['other'] != null ? OneOf2.parse(json['other'], fromA: (v) => Other2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Other2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceOtherVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  reason: json['reason'] != null ? PostIssuingDisputesDisputeRequestEvidenceReason.fromJson(json['reason'] as String) : null,
  serviceNotAsDescribed: json['service_not_as_described'] != null ? OneOf2.parse(json['service_not_as_described'], fromA: (v) => ServiceNotAsDescribed2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ServiceNotAsDescribed2.canParse(v), fromB: (v) => PostIssuingDisputesDisputeRequestEvidenceServiceNotAsDescribedVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
