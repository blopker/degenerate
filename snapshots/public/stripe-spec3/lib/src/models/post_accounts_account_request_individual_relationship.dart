...
import 'post_accounts_account_request_individual_relationship_percent_ownership.dart';final class PostAccountsAccountRequestIndividualRelationship {const PostAccountsAccountRequestIndividualRelationship({this.director, this.executive, this.owner, this.percentOwnership, this.title, });
...
factory PostAccountsAccountRequestIndividualRelationship.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestIndividualRelationship(
  ...
  percentOwnership: json['percent_ownership'] != null ? PostAccountsAccountRequestIndividualRelationshipPercentOwnership.fromJson(json['percent_ownership'] as Map<String, dynamic>) : null,
