...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_people_person_request_documents_passport_files.dart';final class PostAccountsAccountPeoplePersonRequestDocumentsPassport {const PostAccountsAccountPeoplePersonRequestDocumentsPassport({this.files});
...
factory PostAccountsAccountPeoplePersonRequestDocumentsPassport.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequestDocumentsPassport(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPeoplePersonRequestDocumentsPassportFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
