...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bank_account_account.dart';import 'bank_account_customer.dart';import 'bank_account_future_requirements.dart';import 'bank_account_requirements.dart';final class BankAccountAvailablePayoutMethods {const BankAccountAvailablePayoutMethods._(this.value);
...
factory BankAccount.fromJson(Map<String, dynamic> json) { return BankAccount(
  account: json['account'] != null ? OneOf2.parse(json['account'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Account.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Account.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is BankAccount &&
          ...
          const ListEquality<dynamic>().equals(availablePayoutMethods, other.availablePayoutMethods) &&
