...
import 'payment_intent_payment_method_options_param26_mandate_options_reference_prefix.dart';final class PaymentIntentPaymentMethodOptionsParam26MandateOptions {const PaymentIntentPaymentMethodOptionsParam26MandateOptions({this.referencePrefix});
...
factory PaymentIntentPaymentMethodOptionsParam26MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam26MandateOptions(
  referencePrefix: json['reference_prefix'] != null ? PaymentIntentPaymentMethodOptionsParam26MandateOptionsReferencePrefix.fromJson(json['reference_prefix'] as Map<String, dynamic>) : null,
); }
