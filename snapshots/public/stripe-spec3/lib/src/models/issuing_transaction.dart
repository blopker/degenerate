...
factory IssuingTransaction.fromJson(Map<String, dynamic> json) { return IssuingTransaction(
  ...
  authorization: json['authorization'] != null ? OneOf2.parse(json['authorization'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingAuthorization.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingAuthorization.canParse(v),) : null,
  ...
  card: OneOf2.parse(json['card'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingCard.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingCard.canParse(v),),
  ...
  dispute: json['dispute'] != null ? OneOf2.parse(json['dispute'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingDispute.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingDispute.canParse(v),) : null,
