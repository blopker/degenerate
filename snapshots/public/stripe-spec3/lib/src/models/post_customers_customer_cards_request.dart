...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_customers_customer_cards_request_bank_account.dart';import 'post_customers_customer_cards_request_card.dart';final class PostCustomersCustomerCardsRequest {const PostCustomersCustomerCardsRequest({this.alipayAccount, this.bankAccount, this.card, this.expand, this.metadata, this.source, });
...
factory PostCustomersCustomerCardsRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerCardsRequest(
  ...
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => CustomerPaymentSourceBankAccount3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceBankAccount3.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CustomerPaymentSourceCard4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceCard4.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
