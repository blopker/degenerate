...
import 'other2_additional_documentation.dart';import 'other2_explanation.dart';import 'other2_product_description.dart';final class Other2ProductType {const Other2ProductType._(this.value);
...
factory Other2.fromJson(Map<String, dynamic> json) { return Other2(
  additionalDocumentation: json['additional_documentation'] != null ? Other2AdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? Other2Explanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? Other2ProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
