...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_request_settings_payouts_schedule_delay_days.dart';final class PostAccountsAccountRequestSettingsPayoutsScheduleWeeklyPayoutDays {const PostAccountsAccountRequestSettingsPayoutsScheduleWeeklyPayoutDays._(this.value);
...
factory PostAccountsAccountRequestSettingsPayoutsSchedule.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestSettingsPayoutsSchedule(
  delayDays: json['delay_days'] != null ? OneOf2.parse(json['delay_days'], fromA: (v) => PostAccountsAccountRequestSettingsPayoutsScheduleDelayDaysVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
