...
factory PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptions.fromJson(Map<String, dynamic> json) { return PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptions(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptionsAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  endDate: json['end_date'] != null ? OneOf2.parse(json['end_date'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptionsEndDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  paymentsPerPeriod: json['payments_per_period'] != null ? OneOf2.parse(json['payments_per_period'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptionsPaymentsPerPeriodVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  startDate: json['start_date'] != null ? OneOf2.parse(json['start_date'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodOptionsPaytoMandateOptionsStartDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
