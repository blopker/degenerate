...
factory PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequest(
  ...
  applicationFeePercent: json['application_fee_percent'] != null ? OneOf2.parse(json['application_fee_percent'], fromA: (v) => (v as num).toDouble(), canParseA: (v) => v is num, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestApplicationFeePercentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => BillingThresholdsParam2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingThresholdsParam2.canParse(v), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cancelAt: json['cancel_at'] != null ? OneOf3.parse(json['cancel_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancelAtVariant2.fromJson(v as String), canParseB: (v) => v is String, fromC: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancelAtVariant3.fromJson(v as String), canParseC: (v) => v is String,) : null,
  ...
  defaultSource: json['default_source'] != null ? OneOf2.parse(json['default_source'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultSourceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  offSession: json['off_session'] as bool?,
  pauseCollection: json['pause_collection'] != null ? OneOf2.parse(json['pause_collection'], fromA: (v) => PauseCollectionParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PauseCollectionParam.canParse(v), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPauseCollectionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  pendingInvoiceItemInterval: json['pending_invoice_item_interval'] != null ? OneOf2.parse(json['pending_invoice_item_interval'], fromA: (v) => PendingInvoiceItemIntervalParams2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && PendingInvoiceItemIntervalParams2.canParse(v), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPendingInvoiceItemIntervalVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  transferData: json['transfer_data'] != null ? OneOf2.parse(json['transfer_data'], fromA: (v) => TransferDataSpecs.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TransferDataSpecs.canParse(v), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTransferDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  trialEnd: json['trial_end'] != null ? OneOf2.parse(json['trial_end'], fromA: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTrialEndVariant1.fromJson(v as String), canParseA: (v) => v is String, fromB: (v) => (v as num).toInt(), canParseB: (v) => v is num,) : null,
