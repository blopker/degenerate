...
import 'package:collection/collection.dart';final class PostTestHelpersTestClocksRequest {const PostTestHelpersTestClocksRequest({this.expand, required this.frozenTime, this.name, });
