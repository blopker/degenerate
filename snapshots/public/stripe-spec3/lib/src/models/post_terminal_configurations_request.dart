...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_terminal_configurations_request_bbpos_wisepad3.dart';import 'post_terminal_configurations_request_bbpos_wisepos_e.dart';import 'post_terminal_configurations_request_cellular.dart';import 'post_terminal_configurations_request_offline.dart';import 'post_terminal_configurations_request_reboot_window.dart';import 'post_terminal_configurations_request_stripe_s700.dart';import 'post_terminal_configurations_request_stripe_s710.dart';import 'post_terminal_configurations_request_tipping.dart';import 'post_terminal_configurations_request_verifone_p400.dart';import 'post_terminal_configurations_request_wifi.dart';final class PostTerminalConfigurationsRequest {const PostTerminalConfigurationsRequest({this.bbposWisepad3, this.bbposWiseposE, this.cellular, this.expand, this.name, this.offline, this.rebootWindow, this.stripeS700, this.stripeS710, this.tipping, this.verifoneP400, this.wifi, });
...
factory PostTerminalConfigurationsRequest.fromJson(Map<String, dynamic> json) { return PostTerminalConfigurationsRequest(
  ...
  cellular: json['cellular'] != null ? OneOf2.parse(json['cellular'], fromA: (v) => Cellular.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Cellular.canParse(v), fromB: (v) => PostTerminalConfigurationsRequestCellularVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  name: json['name'] as String?,
  offline: json['offline'] != null ? OneOf2.parse(json['offline'], fromA: (v) => Offline.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Offline.canParse(v), fromB: (v) => PostTerminalConfigurationsRequestOfflineVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  tipping: json['tipping'] != null ? OneOf2.parse(json['tipping'], fromA: (v) => Tipping.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Tipping.canParse(v), fromB: (v) => PostTerminalConfigurationsRequestTippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  wifi: json['wifi'] != null ? OneOf2.parse(json['wifi'], fromA: (v) => Wifi.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Wifi.canParse(v), fromB: (v) => PostTerminalConfigurationsRequestWifiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
