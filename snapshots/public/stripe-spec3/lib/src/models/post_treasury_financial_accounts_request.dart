...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_treasury_financial_accounts_request_features.dart';import 'post_treasury_financial_accounts_request_nickname.dart';import 'post_treasury_financial_accounts_request_platform_restrictions.dart';final class PostTreasuryFinancialAccountsRequest {const PostTreasuryFinancialAccountsRequest({this.expand, this.features, this.metadata, this.nickname, this.platformRestrictions, required this.supportedCurrencies, });
...
factory PostTreasuryFinancialAccountsRequest.fromJson(Map<String, dynamic> json) { return PostTreasuryFinancialAccountsRequest(
  ...
  nickname: json['nickname'] != null ? OneOf2.parse(json['nickname'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTreasuryFinancialAccountsRequestNicknameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
