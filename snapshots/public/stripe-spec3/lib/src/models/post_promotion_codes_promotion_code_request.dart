...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_promotion_codes_promotion_code_request_metadata.dart';import 'post_promotion_codes_promotion_code_request_restrictions.dart';final class PostPromotionCodesPromotionCodeRequest {const PostPromotionCodesPromotionCodeRequest({this.active, this.expand, this.metadata, this.restrictions, });
...
factory PostPromotionCodesPromotionCodeRequest.fromJson(Map<String, dynamic> json) { return PostPromotionCodesPromotionCodeRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPromotionCodesPromotionCodeRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
