...
import 'package:collection/collection.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_card_mandate_options_amount_type.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_card_mandate_options_interval.dart';import 'post_setup_intents_intent_confirm_request_payment_method_options_card_mandate_options_supported_types.dart';final class PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsCardMandateOptions {const PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsCardMandateOptions({required this.amount, required this.amountType, required this.currency, this.description, this.endDate, required this.interval, this.intervalCount, required this.reference, required this.startDate, this.supportedTypes, });
