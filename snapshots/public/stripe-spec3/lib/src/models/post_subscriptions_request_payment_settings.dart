...
factory PostSubscriptionsRequestPaymentSettings.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequestPaymentSettings(
  ...
  paymentMethodTypes: json['payment_method_types'] != null ? OneOf2.parse(json['payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionsRequestPaymentSettingsPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
