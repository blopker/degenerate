...
import 'package:collection/collection.dart';final class PostTreasuryCreditReversalsRequest {const PostTreasuryCreditReversalsRequest({this.expand, this.metadata, required this.receivedCredit, });
