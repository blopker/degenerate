...
factory PostCheckoutSessionsRequestBrandingSettings.fromJson(Map<String, dynamic> json) { return PostCheckoutSessionsRequestBrandingSettings(
  backgroundColor: json['background_color'] != null ? OneOf2.parse(json['background_color'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCheckoutSessionsRequestBrandingSettingsBackgroundColorVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  buttonColor: json['button_color'] != null ? OneOf2.parse(json['button_color'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCheckoutSessionsRequestBrandingSettingsButtonColorVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
