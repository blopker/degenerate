...
factory PostPaymentIntentsIntentCaptureRequestAmountDetails.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentCaptureRequestAmountDetails(
  discountAmount: json['discount_amount'] != null ? OneOf2.parse(json['discount_amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostPaymentIntentsIntentCaptureRequestAmountDetailsDiscountAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  enforceArithmeticValidation: json['enforce_arithmetic_validation'] as bool?,
  lineItems: json['line_items'] != null ? OneOf2.parse(json['line_items'], fromA: (v) => (v as List<dynamic>).map((e) => PostPaymentIntentsIntentCaptureRequestAmountDetailsLineItemsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostPaymentIntentsIntentCaptureRequestAmountDetailsLineItemsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => AmountDetailsShippingParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AmountDetailsShippingParam3.canParse(v), fromB: (v) => PostPaymentIntentsIntentCaptureRequestAmountDetailsShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  tax: json['tax'] != null ? OneOf2.parse(json['tax'], fromA: (v) => AmountDetailsTaxParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && AmountDetailsTaxParam3.canParse(v), fromB: (v) => PostPaymentIntentsIntentCaptureRequestAmountDetailsTaxVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
