...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_customers_customer_sources_id_request_metadata.dart';import 'post_customers_customer_sources_id_request_owner.dart';/// The type of entity that holds the account. This can be either `individual` or `company`.
...
factory PostCustomersCustomerSourcesIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSourcesIdRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCustomersCustomerSourcesIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
