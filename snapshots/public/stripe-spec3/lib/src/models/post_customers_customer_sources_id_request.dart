...
import 'package:collection/collection.dart';import 'post_customers_customer_sources_id_request_metadata.dart';import 'post_customers_customer_sources_id_request_owner.dart';/// The type of entity that holds the account. This can be either `individual` or `company`.
...
factory PostCustomersCustomerSourcesIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSourcesIdRequest(
  ...
  metadata: json['metadata'] != null
        ? PostCustomersCustomerSourcesIdRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
  name: json['name'] as String?,
  owner: json['owner'] != null
        ? PostCustomersCustomerSourcesIdRequestOwner.fromJson(json['owner'] as Map<String, dynamic>)
        : null,
); }
