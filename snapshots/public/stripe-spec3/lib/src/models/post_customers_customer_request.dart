...
factory PostCustomersCustomerRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerRequest(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => OptionalFieldsCustomerAddress2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && OptionalFieldsCustomerAddress2.canParse(v), fromB: (v) => PostCustomersCustomerRequestAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  balance: json['balance'] != null ? (json['balance'] as num).toInt() : null,
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => CustomerPaymentSourceBankAccount.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceBankAccount.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  businessName: json['business_name'] != null ? OneOf2.parse(json['business_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersCustomerRequestBusinessNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CustomerPaymentSourceCard2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceCard2.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  ...
  individualName: json['individual_name'] != null ? OneOf2.parse(json['individual_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostCustomersCustomerRequestIndividualNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCustomersCustomerRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  shipping: json['shipping'] != null ? OneOf2.parse(json['shipping'], fromA: (v) => CustomerShipping3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerShipping3.canParse(v), fromB: (v) => PostCustomersCustomerRequestShippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
