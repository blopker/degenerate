...
factory PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetails.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetails(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => BillingDetailsAddress9.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingDetailsAddress9.canParse(v), fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetailsAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  email: json['email'] != null ? OneOf2.parse(json['email'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetailsEmailVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetailsNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  phone: json['phone'] != null ? OneOf2.parse(json['phone'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodDataBillingDetailsPhoneVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
