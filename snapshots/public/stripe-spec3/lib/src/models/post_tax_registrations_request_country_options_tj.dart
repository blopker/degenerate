...
import 'post_tax_registrations_request_country_options_tj_type.dart';final class PostTaxRegistrationsRequestCountryOptionsTj {const PostTaxRegistrationsRequestCountryOptionsTj({required this.type});
