...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_tax_rates_tax_rate_request_metadata.dart';/// The high-level tax type, such as `vat` or `sales_tax`.
...
factory PostTaxRatesTaxRateRequest.fromJson(Map<String, dynamic> json) { return PostTaxRatesTaxRateRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostTaxRatesTaxRateRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
