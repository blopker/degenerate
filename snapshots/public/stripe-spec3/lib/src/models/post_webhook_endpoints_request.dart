...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_webhook_endpoints_request_description.dart';import 'post_webhook_endpoints_request_metadata.dart';final class PostWebhookEndpointsRequestEnabledEvents {const PostWebhookEndpointsRequestEnabledEvents._(this.value);
...
factory PostWebhookEndpointsRequest.fromJson(Map<String, dynamic> json) { return PostWebhookEndpointsRequest(
  ...
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostWebhookEndpointsRequestDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostWebhookEndpointsRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
