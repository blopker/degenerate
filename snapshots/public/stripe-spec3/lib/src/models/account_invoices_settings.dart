...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account_invoices_settings_default_account_tax_ids.dart';/// Whether to save the payment method after a payment is completed for a one-time invoice or a subscription invoice when the customer already has a default payment method on the hosted invoice page.
...
factory AccountInvoicesSettings.fromJson(Map<String, dynamic> json) { return AccountInvoicesSettings(
  defaultAccountTaxIds: (json['default_account_tax_ids'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TaxId.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TaxId.canParse(v),)).toList(),
