...
import 'post_quotes_quote_request_line_items_price_data_recurring.dart';import 'post_quotes_quote_request_line_items_price_data_tax_behavior.dart';final class PostQuotesQuoteRequestLineItemsPriceData {const PostQuotesQuoteRequestLineItemsPriceData({required this.currency, required this.product, this.recurring, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
