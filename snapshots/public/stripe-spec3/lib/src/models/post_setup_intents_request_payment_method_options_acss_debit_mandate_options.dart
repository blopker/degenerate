...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_setup_intents_request_payment_method_options_acss_debit_mandate_options_custom_mandate_url.dart';final class PostSetupIntentsRequestPaymentMethodOptionsAcssDebitMandateOptionsDefaultFor {const PostSetupIntentsRequestPaymentMethodOptionsAcssDebitMandateOptionsDefaultFor._(this.value);
...
factory PostSetupIntentsRequestPaymentMethodOptionsAcssDebitMandateOptions.fromJson(Map<String, dynamic> json) { return PostSetupIntentsRequestPaymentMethodOptionsAcssDebitMandateOptions(
  customMandateUrl: json['custom_mandate_url'] != null ? OneOf2.parse(json['custom_mandate_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsRequestPaymentMethodOptionsAcssDebitMandateOptionsCustomMandateUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
