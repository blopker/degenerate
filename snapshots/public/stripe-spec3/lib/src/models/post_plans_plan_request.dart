...
import 'package:collection/collection.dart';import 'post_plans_plan_request_metadata.dart';final class PostPlansPlanRequest {const PostPlansPlanRequest({this.active, this.expand, this.metadata, this.nickname, this.product, this.trialPeriodDays, });
