...
factory PostTokensRequest.fromJson(Map<String, dynamic> json) { return PostTokensRequest(
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CreditCardSpecs.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CreditCardSpecs.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
