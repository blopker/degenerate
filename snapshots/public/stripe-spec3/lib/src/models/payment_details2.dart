...
import 'payment_details2_customer_reference.dart';import 'payment_details2_order_reference.dart';final class PaymentDetails2 {const PaymentDetails2({this.customerReference, this.orderReference, });

factory PaymentDetails2.fromJson(Map<String, dynamic> json) { return PaymentDetails2(
  customerReference: json['customer_reference'] != null ? PaymentDetails2CustomerReference.fromJson(json['customer_reference'] as Map<String, dynamic>) : null,
  orderReference: json['order_reference'] != null ? PaymentDetails2OrderReference.fromJson(json['order_reference'] as Map<String, dynamic>) : null,
); }
