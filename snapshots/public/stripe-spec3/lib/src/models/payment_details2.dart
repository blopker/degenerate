...
factory PaymentDetails2.fromJson(Map<String, dynamic> json) { return PaymentDetails2(
  customerReference: json['customer_reference'] != null ? OneOf2.parse(json['customer_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetails2CustomerReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  orderReference: json['order_reference'] != null ? OneOf2.parse(json['order_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetails2OrderReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
