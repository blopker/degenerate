...
factory Canceled.fromJson(Map<String, dynamic> json) { return Canceled(
  additionalDocumentation: json['additional_documentation'] != null ? CanceledAdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  canceledAt: json['canceled_at'] != null ? CanceledCanceledAt.fromJson(json['canceled_at'] as Map<String, dynamic>) : null,
  cancellationPolicyProvided: json['cancellation_policy_provided'] != null ? CanceledCancellationPolicyProvided.fromJson(json['cancellation_policy_provided'] as Map<String, dynamic>) : null,
  cancellationReason: json['cancellation_reason'] != null ? CanceledCancellationReason.fromJson(json['cancellation_reason'] as Map<String, dynamic>) : null,
  expectedAt: json['expected_at'] != null ? CanceledExpectedAt.fromJson(json['expected_at'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? CanceledExplanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? CanceledProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
  ...
  returnedAt: json['returned_at'] != null ? CanceledReturnedAt.fromJson(json['returned_at'] as Map<String, dynamic>) : null,
); }
