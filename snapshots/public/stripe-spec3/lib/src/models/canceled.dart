...
factory Canceled.fromJson(Map<String, dynamic> json) { return Canceled(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CanceledAdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  canceledAt: json['canceled_at'] != null ? OneOf2.parse(json['canceled_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => CanceledCanceledAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cancellationPolicyProvided: json['cancellation_policy_provided'] != null ? OneOf2.parse(json['cancellation_policy_provided'], fromA: (v) => v as bool, canParseA: (v) => v is bool, fromB: (v) => CanceledCancellationPolicyProvidedVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cancellationReason: json['cancellation_reason'] != null ? OneOf2.parse(json['cancellation_reason'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CanceledCancellationReasonVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expectedAt: json['expected_at'] != null ? OneOf2.parse(json['expected_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => CanceledExpectedAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CanceledExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CanceledProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  returnedAt: json['returned_at'] != null ? OneOf2.parse(json['returned_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => CanceledReturnedAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
