...
factory PostQuotesQuoteRequest.fromJson(Map<String, dynamic> json) { return PostQuotesQuoteRequest(
  applicationFeeAmount: json['application_fee_amount'] != null ? OneOf2.parse(json['application_fee_amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostQuotesQuoteRequestApplicationFeeAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  applicationFeePercent: json['application_fee_percent'] != null ? OneOf2.parse(json['application_fee_percent'], fromA: (v) => (v as num).toDouble(), canParseA: (v) => v is num, fromB: (v) => PostQuotesQuoteRequestApplicationFeePercentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesQuoteRequestDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostQuotesQuoteRequestDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostQuotesQuoteRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesQuoteRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  expiresAt: json['expires_at'] != null ? (json['expires_at'] as num).toInt() : null,
  footer: json['footer'] != null ? OneOf2.parse(json['footer'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostQuotesQuoteRequestFooterVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  header: json['header'] != null ? OneOf2.parse(json['header'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostQuotesQuoteRequestHeaderVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  onBehalfOf: json['on_behalf_of'] != null ? OneOf2.parse(json['on_behalf_of'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostQuotesQuoteRequestOnBehalfOfVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  transferData: json['transfer_data'] != null ? OneOf2.parse(json['transfer_data'], fromA: (v) => TransferDataSpecs4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TransferDataSpecs4.canParse(v), fromB: (v) => PostQuotesQuoteRequestTransferDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
