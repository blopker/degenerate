...
import 'package:collection/collection.dart';final class PostPaymentMethodDomainsPaymentMethodDomainRequest {const PostPaymentMethodDomainsPaymentMethodDomainRequest({this.enabled, this.expand, });
