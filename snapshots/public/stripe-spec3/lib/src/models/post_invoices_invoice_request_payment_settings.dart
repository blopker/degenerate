...
factory PostInvoicesInvoiceRequestPaymentSettings.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRequestPaymentSettings(
  defaultMandate: json['default_mandate'] != null ? OneOf2.parse(json['default_mandate'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesInvoiceRequestPaymentSettingsDefaultMandateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  paymentMethodTypes: json['payment_method_types'] != null ? OneOf2.parse(json['payment_method_types'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodTypesVariant1.fromJson(e as String)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodTypesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
