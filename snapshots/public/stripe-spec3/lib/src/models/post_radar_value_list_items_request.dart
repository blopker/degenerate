...
import 'package:collection/collection.dart';final class PostRadarValueListItemsRequest {const PostRadarValueListItemsRequest({this.expand, required this.value, required this.valueList, });
