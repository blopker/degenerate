...
import 'payment_intent_amount_details_line_item_object.dart';import 'payment_intent_amount_details_line_item_payment_method_options.dart';import 'payment_intent_amount_details_line_item_tax.dart';/// 
...
factory PaymentIntentAmountDetailsLineItem.fromJson(Map<String, dynamic> json) { return PaymentIntentAmountDetailsLineItem(
  ...
  paymentMethodOptions: json['payment_method_options'] != null
        ? PaymentIntentAmountDetailsLineItemPaymentMethodOptions.fromJson(json['payment_method_options'] as Map<String, dynamic>)
        : null,
  productCode: json['product_code'] as String?,
  productName: json['product_name'] as String,
  quantity: (json['quantity'] as num).toInt(),
  tax: json['tax'] != null
        ? PaymentIntentAmountDetailsLineItemTax.fromJson(json['tax'] as Map<String, dynamic>)
        : null,
