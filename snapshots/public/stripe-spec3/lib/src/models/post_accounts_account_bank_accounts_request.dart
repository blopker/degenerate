...
factory PostAccountsAccountBankAccountsRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountBankAccountsRequest(
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => ExternalAccountPayoutBankAccount2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ExternalAccountPayoutBankAccount2.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
