...
factory AmountDetailsShippingParam.fromJson(Map<String, dynamic> json) { return AmountDetailsShippingParam(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => AmountDetailsShippingParamAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  fromPostalCode: json['from_postal_code'] != null ? OneOf2.parse(json['from_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParamFromPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  toPostalCode: json['to_postal_code'] != null ? OneOf2.parse(json['to_postal_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => AmountDetailsShippingParamToPostalCodeVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
