...
factory PostAccountsRequest.fromJson(Map<String, dynamic> json) { return PostAccountsRequest(
  ...
  bankAccount: json['bank_account'] != null ? OneOf2.parse(json['bank_account'], fromA: (v) => ExternalAccountPayoutBankAccount.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ExternalAccountPayoutBankAccount.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostAccountsRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
