...
factory PaymentMethod.fromJson(Map<String, dynamic> json) { return PaymentMethod(
  ...
  customer: json['customer'] != null ? OneOf2.parse(json['customer'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Customer.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Customer.canParse(v),) : null,
