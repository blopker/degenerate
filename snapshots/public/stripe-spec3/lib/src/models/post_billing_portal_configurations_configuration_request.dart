...
factory PostBillingPortalConfigurationsConfigurationRequest.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsConfigurationRequest(
  ...
  defaultReturnUrl: json['default_return_url'] != null ? OneOf2.parse(json['default_return_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestDefaultReturnUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsConfigurationRequestNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
