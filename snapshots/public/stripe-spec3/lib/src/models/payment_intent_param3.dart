...
factory PaymentIntentParam3.fromJson(Map<String, dynamic> json) { return PaymentIntentParam3(
  ...
  statementDescriptorSuffixKana: json['statement_descriptor_suffix_kana'] != null ? PaymentIntentParam3StatementDescriptorSuffixKana.fromJson(json['statement_descriptor_suffix_kana'] as Map<String, dynamic>) : null,
  statementDescriptorSuffixKanji: json['statement_descriptor_suffix_kanji'] != null ? PaymentIntentParam3StatementDescriptorSuffixKanji.fromJson(json['statement_descriptor_suffix_kanji'] as Map<String, dynamic>) : null,
