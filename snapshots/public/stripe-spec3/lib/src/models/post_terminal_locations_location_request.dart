...
factory PostTerminalLocationsLocationRequest.fromJson(Map<String, dynamic> json) { return PostTerminalLocationsLocationRequest(
  ...
  configurationOverrides: json['configuration_overrides'] != null ? OneOf2.parse(json['configuration_overrides'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalLocationsLocationRequestConfigurationOverridesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  displayName: json['display_name'] != null ? OneOf2.parse(json['display_name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalLocationsLocationRequestDisplayNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  displayNameKana: json['display_name_kana'] != null ? OneOf2.parse(json['display_name_kana'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalLocationsLocationRequestDisplayNameKanaVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  displayNameKanji: json['display_name_kanji'] != null ? OneOf2.parse(json['display_name_kanji'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalLocationsLocationRequestDisplayNameKanjiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostTerminalLocationsLocationRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  phone: json['phone'] != null ? OneOf2.parse(json['phone'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostTerminalLocationsLocationRequestPhoneVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
