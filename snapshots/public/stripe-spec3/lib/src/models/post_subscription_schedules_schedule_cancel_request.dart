...
import 'package:collection/collection.dart';final class PostSubscriptionSchedulesScheduleCancelRequest {const PostSubscriptionSchedulesScheduleCancelRequest({this.expand, this.invoiceNow, this.prorate, });
