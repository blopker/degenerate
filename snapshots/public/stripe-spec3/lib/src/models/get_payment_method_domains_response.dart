...
import 'package:collection/collection.dart';import 'payment_method_domain.dart';/// String representing the object's type. Objects of the same type share the same value. Always has the value `list`.
