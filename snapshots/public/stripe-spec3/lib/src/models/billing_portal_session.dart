...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'billing_portal_session_configuration.dart';import 'billing_portal_session_flow.dart';/// The IETF language tag of the locale Customer Portal is displayed in. If blank or auto, the customer’s `preferred_locales` or browser’s locale is used.
...
factory BillingPortalSession.fromJson(Map<String, dynamic> json) { return BillingPortalSession(
  configuration: OneOf2.parse(json['configuration'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BillingPortalConfiguration.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BillingPortalConfiguration.canParse(v),),
