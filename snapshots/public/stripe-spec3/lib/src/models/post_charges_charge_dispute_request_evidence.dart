...
factory PostChargesChargeDisputeRequestEvidence.fromJson(Map<String, dynamic> json) { return PostChargesChargeDisputeRequestEvidence(
  ...
  enhancedEvidence: json['enhanced_evidence'] != null ? OneOf2.parse(json['enhanced_evidence'], fromA: (v) => EnhancedEvidence.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && EnhancedEvidence.canParse(v), fromB: (v) => PostChargesChargeDisputeRequestEvidenceEnhancedEvidenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
