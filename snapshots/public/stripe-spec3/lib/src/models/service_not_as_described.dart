...
factory ServiceNotAsDescribed.fromJson(Map<String, dynamic> json) { return ServiceNotAsDescribed(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ServiceNotAsDescribedAdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  canceledAt: json['canceled_at'] != null ? OneOf2.parse(json['canceled_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => ServiceNotAsDescribedCanceledAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cancellationReason: json['cancellation_reason'] != null ? OneOf2.parse(json['cancellation_reason'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ServiceNotAsDescribedCancellationReasonVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ServiceNotAsDescribedExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  receivedAt: json['received_at'] != null ? OneOf2.parse(json['received_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => ServiceNotAsDescribedReceivedAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
