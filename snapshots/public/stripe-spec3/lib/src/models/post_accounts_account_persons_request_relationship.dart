...
import 'post_accounts_account_persons_request_relationship_percent_ownership.dart';/// The relationship that this person has with the account's legal entity.
...
factory PostAccountsAccountPersonsRequestRelationship.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestRelationship(
  ...
  percentOwnership: json['percent_ownership'] != null ? PostAccountsAccountPersonsRequestRelationshipPercentOwnership.fromJson(json['percent_ownership'] as Map<String, dynamic>) : null,
