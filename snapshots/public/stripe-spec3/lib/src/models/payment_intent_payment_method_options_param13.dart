...
factory PaymentIntentPaymentMethodOptionsParam13.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam13(
  reference: json['reference'] != null ? OneOf2.parse(json['reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentPaymentMethodOptionsParam13ReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
