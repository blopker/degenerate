...
import 'payment_intent_payment_method_options_param13_reference.dart';final class PaymentIntentPaymentMethodOptionsParam13SetupFutureUsage {const PaymentIntentPaymentMethodOptionsParam13SetupFutureUsage._(this.value);
...
factory PaymentIntentPaymentMethodOptionsParam13.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam13(
  reference: json['reference'] != null ? PaymentIntentPaymentMethodOptionsParam13Reference.fromJson(json['reference'] as Map<String, dynamic>) : null,
