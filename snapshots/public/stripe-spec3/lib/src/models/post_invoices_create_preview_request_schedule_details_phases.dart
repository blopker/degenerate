...
factory PostInvoicesCreatePreviewRequestScheduleDetailsPhases.fromJson(Map<String, dynamic> json) { return PostInvoicesCreatePreviewRequestScheduleDetailsPhases(
  ...
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => BillingThresholdsParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingThresholdsParam3.canParse(v), fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  endDate: json['end_date'] != null ? OneOf2.parse(json['end_date'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesEndDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  startDate: json['start_date'] != null ? OneOf2.parse(json['start_date'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesStartDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  trialEnd: json['trial_end'] != null ? OneOf2.parse(json['trial_end'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesTrialEndVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
