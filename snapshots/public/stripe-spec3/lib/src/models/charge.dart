...
factory Charge.fromJson(Map<String, dynamic> json) { return Charge(
  ...
  applicationFee: json['application_fee'] != null ? OneOf2.parse(json['application_fee'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ApplicationFee.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ApplicationFee.canParse(v),) : null,
  ...
  sourceTransfer: json['source_transfer'] != null ? OneOf2.parse(json['source_transfer'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Transfer.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Transfer.canParse(v),) : null,
  statementDescriptor: json['statement_descriptor'] as String?,
  statementDescriptorSuffix: json['statement_descriptor_suffix'] as String?,
  status: ChargeStatus.fromJson(json['status'] as String),
  transfer: json['transfer'] != null ? OneOf2.parse(json['transfer'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Transfer.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Transfer.canParse(v),) : null,
