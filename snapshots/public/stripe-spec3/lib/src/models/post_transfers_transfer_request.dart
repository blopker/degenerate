...
import 'package:collection/collection.dart';import 'post_transfers_transfer_request_metadata.dart';final class PostTransfersTransferRequest {const PostTransfersTransferRequest({this.description, this.expand, this.metadata, });
