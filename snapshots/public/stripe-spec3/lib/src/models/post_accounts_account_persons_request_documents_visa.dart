...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_persons_request_documents_visa_files.dart';final class PostAccountsAccountPersonsRequestDocumentsVisa {const PostAccountsAccountPersonsRequestDocumentsVisa({this.files});
...
factory PostAccountsAccountPersonsRequestDocumentsVisa.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestDocumentsVisa(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPersonsRequestDocumentsVisaFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
