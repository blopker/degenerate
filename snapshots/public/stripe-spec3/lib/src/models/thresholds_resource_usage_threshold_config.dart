...
import 'package:collection/collection.dart';import 'thresholds_resource_usage_alert_filter.dart';import 'thresholds_resource_usage_threshold_config_meter.dart';/// Defines how the alert will behave.
...
factory ThresholdsResourceUsageThresholdConfig.fromJson(Map<String, dynamic> json) { return ThresholdsResourceUsageThresholdConfig(
  ...
  meter: ThresholdsResourceUsageThresholdConfigMeter.fromJson(json['meter'] as Map<String, dynamic>),
