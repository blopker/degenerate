...
factory PostCheckoutSessionsRequestCustomText.fromJson(Map<String, dynamic> json) { return PostCheckoutSessionsRequestCustomText(
  afterSubmit: json['after_submit'] != null ? OneOf2.parse(json['after_submit'], fromA: (v) => CustomTextPositionParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam.canParse(v), fromB: (v) => PostCheckoutSessionsRequestCustomTextAfterSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippingAddress: json['shipping_address'] != null ? OneOf2.parse(json['shipping_address'], fromA: (v) => CustomTextPositionParam2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam2.canParse(v), fromB: (v) => PostCheckoutSessionsRequestCustomTextShippingAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  submit: json['submit'] != null ? OneOf2.parse(json['submit'], fromA: (v) => CustomTextPositionParam3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam3.canParse(v), fromB: (v) => PostCheckoutSessionsRequestCustomTextSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  termsOfServiceAcceptance: json['terms_of_service_acceptance'] != null ? OneOf2.parse(json['terms_of_service_acceptance'], fromA: (v) => CustomTextPositionParam4.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam4.canParse(v), fromB: (v) => PostCheckoutSessionsRequestCustomTextTermsOfServiceAcceptanceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
