...
factory PostInvoicesInvoiceRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRequest(
  accountTaxIds: json['account_tax_ids'] != null ? OneOf2.parse(json['account_tax_ids'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceRequestAccountTaxIdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  customFields: json['custom_fields'] != null ? OneOf2.parse(json['custom_fields'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceRequestCustomFieldsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceRequestCustomFieldsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  defaultSource: json['default_source'] != null ? OneOf2.parse(json['default_source'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesInvoiceRequestDefaultSourceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  defaultTaxRates: json['default_tax_rates'] != null ? OneOf2.parse(json['default_tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceRequestDefaultTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  description: json['description'] as String?,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostInvoicesInvoiceRequestDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesInvoiceRequestDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  dueDate: json['due_date'] != null ? (json['due_date'] as num).toInt() : null,
  effectiveAt: json['effective_at'] != null ? OneOf2.parse(json['effective_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesInvoiceRequestEffectiveAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  footer: json['footer'] as String?,
  issuer: json['issuer'] != null ? PostInvoicesInvoiceRequestIssuer.fromJson(json['issuer'] as Map<String, dynamic>) : null,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostInvoicesInvoiceRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  number: json['number'] != null ? OneOf2.parse(json['number'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesInvoiceRequestNumberVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  onBehalfOf: json['on_behalf_of'] != null ? OneOf2.parse(json['on_behalf_of'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesInvoiceRequestOnBehalfOfVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  shippingCost: json['shipping_cost'] != null ? OneOf2.parse(json['shipping_cost'], fromA: (v) => ShippingCost.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ShippingCost.canParse(v), fromB: (v) => PostInvoicesInvoiceRequestShippingCostVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippingDetails: json['shipping_details'] != null ? OneOf2.parse(json['shipping_details'], fromA: (v) => RecipientShippingWithOptionalFieldsAddress.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RecipientShippingWithOptionalFieldsAddress.canParse(v), fromB: (v) => PostInvoicesInvoiceRequestShippingDetailsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptor: json['statement_descriptor'] as String?,
  transferData: json['transfer_data'] != null ? OneOf2.parse(json['transfer_data'], fromA: (v) => TransferDataSpecs2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && TransferDataSpecs2.canParse(v), fromB: (v) => PostInvoicesInvoiceRequestTransferDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
