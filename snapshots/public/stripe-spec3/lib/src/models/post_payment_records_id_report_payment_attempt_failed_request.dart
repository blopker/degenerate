...
import 'package:collection/collection.dart';import 'post_payment_records_id_report_payment_attempt_failed_request_metadata.dart';final class PostPaymentRecordsIdReportPaymentAttemptFailedRequest {const PostPaymentRecordsIdReportPaymentAttemptFailedRequest({this.expand, required this.failedAt, this.metadata, });
...
factory PostPaymentRecordsIdReportPaymentAttemptFailedRequest.fromJson(Map<String, dynamic> json) { return PostPaymentRecordsIdReportPaymentAttemptFailedRequest(
  ...
  metadata: json['metadata'] != null ? PostPaymentRecordsIdReportPaymentAttemptFailedRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
); }
