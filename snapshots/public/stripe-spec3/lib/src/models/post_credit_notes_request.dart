...
import 'package:collection/collection.dart';import 'post_credit_notes_request_lines.dart';import 'post_credit_notes_request_refunds.dart';import 'post_credit_notes_request_shipping_cost.dart';/// Type of email to send to the customer, one of `credit_note` or `none` and the default is `credit_note`.
