...
import 'outbound_transfers_payment_method_details.dart';import 'treasury_outbound_transfer_object.dart';import 'treasury_outbound_transfer_returned_details.dart';import 'treasury_outbound_transfer_status.dart';import 'treasury_outbound_transfer_tracking_details.dart';import 'treasury_outbound_transfer_transaction.dart';import 'treasury_outbound_transfers_resource_status_transitions.dart';/// Use [OutboundTransfers](https://docs.stripe.com/docs/treasury/moving-money/financial-accounts/out-of/outbound-transfers) to transfer funds from a [FinancialAccount](https://api.stripe.com#financial_accounts) to a PaymentMethod belonging to the same entity. To send funds to a different party, use [OutboundPayments](https://api.stripe.com#outbound_payments) instead. You can send funds over ACH rails or through a domestic wire transfer to a user's own external bank account.
/// 
