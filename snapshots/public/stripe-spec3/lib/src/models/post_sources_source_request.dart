...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_sources_source_request_mandate.dart';import 'post_sources_source_request_metadata.dart';import 'post_sources_source_request_owner.dart';import 'post_sources_source_request_source_order.dart';final class PostSourcesSourceRequest {const PostSourcesSourceRequest({this.amount, this.expand, this.mandate, this.metadata, this.owner, this.sourceOrder, });
...
factory PostSourcesSourceRequest.fromJson(Map<String, dynamic> json) { return PostSourcesSourceRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostSourcesSourceRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
