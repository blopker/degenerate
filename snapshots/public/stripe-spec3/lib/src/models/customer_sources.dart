...
import 'package:collection/collection.dart';import 'customer_sources_data.dart';/// String representing the object's type. Objects of the same type share the same value. Always has the value `list`.
...
factory CustomerSources.fromJson(Map<String, dynamic> json) { return CustomerSources(
  data: (json['data'] as List<dynamic>).map((e) => CustomerSourcesData.fromJson(e as Map<String, dynamic>)).toList(),
