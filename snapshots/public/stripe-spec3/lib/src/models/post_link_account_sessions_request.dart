...
import 'package:collection/collection.dart';import 'post_link_account_sessions_request_account_holder.dart';import 'post_link_account_sessions_request_filters.dart';import 'post_link_account_sessions_request_permissions.dart';import 'post_link_account_sessions_request_prefetch.dart';final class PostLinkAccountSessionsRequest {const PostLinkAccountSessionsRequest({required this.accountHolder, this.expand, this.filters, required this.permissions, this.prefetch, this.returnUrl, });
...
factory PostLinkAccountSessionsRequest.fromJson(Map<String, dynamic> json) { return PostLinkAccountSessionsRequest(
  ...
  filters: json['filters'] != null
        ? PostLinkAccountSessionsRequestFilters.fromJson(json['filters'] as Map<String, dynamic>)
        : null,
