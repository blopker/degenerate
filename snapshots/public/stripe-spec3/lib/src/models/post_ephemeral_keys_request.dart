...
import 'package:collection/collection.dart';final class PostEphemeralKeysRequest {const PostEphemeralKeysRequest({this.customer, this.expand, this.issuingCard, this.nonce, this.verificationSession, });
