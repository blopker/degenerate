...
factory Transfer.fromJson(Map<String, dynamic> json) { return Transfer(
  ...
  destination: json['destination'] != null ? OneOf2.parse(json['destination'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Account.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Account.canParse(v),) : null,
  destinationPayment: json['destination_payment'] != null ? OneOf2.parse(json['destination_payment'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Charge.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Charge.canParse(v),) : null,
  ...
  sourceTransaction: json['source_transaction'] != null ? OneOf2.parse(json['source_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Charge.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Charge.canParse(v),) : null,
