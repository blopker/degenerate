...
factory Quote.fromJson(Map<String, dynamic> json) { return Quote(
  ...
  defaultTaxRates: (json['default_tax_rates'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => TaxRate.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && TaxRate.canParse(v),)).toList(),
  ...
  invoice: json['invoice'] != null ? OneOf3.parse(json['invoice'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Invoice.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Invoice.canParse(v), fromC: (v) => DeletedInvoice.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && DeletedInvoice.canParse(v),) : null,
  ...
  subscriptionSchedule: json['subscription_schedule'] != null ? OneOf2.parse(json['subscription_schedule'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SubscriptionSchedule.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SubscriptionSchedule.canParse(v),) : null,
