...
factory PostInvoicesCreatePreviewRequestScheduleDetailsPhasesAddInvoiceItems.fromJson(Map<String, dynamic> json) { return PostInvoicesCreatePreviewRequestScheduleDetailsPhasesAddInvoiceItems(
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostInvoicesCreatePreviewRequestScheduleDetailsPhasesAddInvoiceItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
