...
factory StackableDiscountWithDiscountSettings.fromJson(Map<String, dynamic> json) { return StackableDiscountWithDiscountSettings(
  coupon: json['coupon'] != null ? OneOf2.parse(json['coupon'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Coupon.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Coupon.canParse(v),) : null,
  discount: json['discount'] != null ? OneOf2.parse(json['discount'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Discount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Discount.canParse(v),) : null,
  promotionCode: json['promotion_code'] != null ? OneOf2.parse(json['promotion_code'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PromotionCode.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PromotionCode.canParse(v),) : null,
); }
