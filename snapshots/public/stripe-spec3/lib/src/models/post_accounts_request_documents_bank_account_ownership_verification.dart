...
import 'package:collection/collection.dart';final class PostAccountsRequestDocumentsBankAccountOwnershipVerification {const PostAccountsRequestDocumentsBankAccountOwnershipVerification({this.files});
