...
factory PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptancesAccount.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptancesAccount(
  ...
  userAgent: json['user_agent'] != null ? OneOf2.parse(json['user_agent'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPeoplePersonRequestAdditionalTosAcceptancesAccountUserAgentVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
