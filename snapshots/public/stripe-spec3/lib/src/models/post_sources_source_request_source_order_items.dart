...
import 'post_sources_source_request_source_order_items_type.dart';final class PostSourcesSourceRequestSourceOrderItems {const PostSourcesSourceRequestSourceOrderItems({this.amount, this.currency, this.description, this.parent, this.quantity, this.type, });
