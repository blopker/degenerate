...
import 'post_invoices_create_preview_request_invoice_items_price_data_tax_behavior.dart';final class PostInvoicesCreatePreviewRequestInvoiceItemsPriceData {const PostInvoicesCreatePreviewRequestInvoiceItemsPriceData({required this.currency, required this.product, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
