...
factory PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptions(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  endDate: json['end_date'] != null ? OneOf2.parse(json['end_date'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsEndDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  paymentsPerPeriod: json['payments_per_period'] != null ? OneOf2.parse(json['payments_per_period'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsPaymentsPerPeriodVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  startDate: json['start_date'] != null ? OneOf2.parse(json['start_date'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentConfirmRequestPaymentMethodOptionsPaytoMandateOptionsStartDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
