...
factory PostPaymentIntentsRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsRequest(
  ...
  mandateData: json['mandate_data'] != null ? OneOf2.parse(json['mandate_data'], fromA: (v) => SecretKeyParam.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && SecretKeyParam.canParse(v), fromB: (v) => PostPaymentIntentsRequestMandateDataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  offSession: json['off_session'] != null ? OneOf2.parse(json['off_session'], fromA: (v) => v as bool, canParseA: (v) => v is bool, fromB: (v) => PostPaymentIntentsRequestOffSessionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
