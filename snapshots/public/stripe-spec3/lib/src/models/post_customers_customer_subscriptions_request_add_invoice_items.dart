...
import 'package:collection/collection.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_discounts.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_period.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_price_data.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_tax_rates.dart';final class PostCustomersCustomerSubscriptionsRequestAddInvoiceItems {const PostCustomersCustomerSubscriptionsRequestAddInvoiceItems({this.discounts, this.metadata, this.period, this.price, this.priceData, this.quantity, this.taxRates, });
...
factory PostCustomersCustomerSubscriptionsRequestAddInvoiceItems.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsRequestAddInvoiceItems(
  ...
  period: json['period'] != null
        ? PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsPeriod.fromJson(json['period'] as Map<String, dynamic>)
        : null,
  price: json['price'] as String?,
  priceData: json['price_data'] != null
        ? PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsPriceData.fromJson(json['price_data'] as Map<String, dynamic>)
        : null,
  quantity: json['quantity'] != null ? (json['quantity'] as num).toInt() : null,
  taxRates: json['tax_rates'] != null
        ? PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsTaxRates.fromJson(json['tax_rates'] as Map<String, dynamic>)
        : null,
); }
