...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_discounts.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_period.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_price_data.dart';import 'post_customers_customer_subscriptions_request_add_invoice_items_tax_rates.dart';final class PostCustomersCustomerSubscriptionsRequestAddInvoiceItems {const PostCustomersCustomerSubscriptionsRequestAddInvoiceItems({this.discounts, this.metadata, this.period, this.price, this.priceData, this.quantity, this.taxRates, });
...
factory PostCustomersCustomerSubscriptionsRequestAddInvoiceItems.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsRequestAddInvoiceItems(
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
