...
factory PaymentIntentPaymentMethodOptionsParam25MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam25MandateOptions(
  amount: json['amount'] != null ? OneOf2.parse(json['amount'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PaymentIntentPaymentMethodOptionsParam25MandateOptionsAmountVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  endDate: json['end_date'] != null ? OneOf2.parse(json['end_date'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentPaymentMethodOptionsParam25MandateOptionsEndDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  paymentsPerPeriod: json['payments_per_period'] != null ? OneOf2.parse(json['payments_per_period'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PaymentIntentPaymentMethodOptionsParam25MandateOptionsPaymentsPerPeriodVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
