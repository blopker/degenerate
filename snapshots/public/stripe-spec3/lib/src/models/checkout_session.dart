...
factory CheckoutSession.fromJson(Map<String, dynamic> json) { return CheckoutSession(
  ...
  invoice: json['invoice'] != null ? OneOf2.parse(json['invoice'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Invoice.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Invoice.canParse(v),) : null,
  ...
  paymentLink: json['payment_link'] != null ? OneOf2.parse(json['payment_link'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentLink.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PaymentLink.canParse(v),) : null,
  ...
  setupIntent: json['setup_intent'] != null ? OneOf2.parse(json['setup_intent'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => SetupIntent.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && SetupIntent.canParse(v),) : null,
