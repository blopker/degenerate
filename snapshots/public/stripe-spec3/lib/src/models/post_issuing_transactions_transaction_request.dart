...
import 'package:collection/collection.dart';import 'post_issuing_transactions_transaction_request_metadata.dart';final class PostIssuingTransactionsTransactionRequest {const PostIssuingTransactionsTransactionRequest({this.expand, this.metadata, });
...
factory PostIssuingTransactionsTransactionRequest.fromJson(Map<String, dynamic> json) { return PostIssuingTransactionsTransactionRequest(
  ...
  metadata: json['metadata'] != null ? PostIssuingTransactionsTransactionRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>) : null,
); }
