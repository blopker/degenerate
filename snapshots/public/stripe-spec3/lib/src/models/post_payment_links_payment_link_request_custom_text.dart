...
factory PostPaymentLinksPaymentLinkRequestCustomText.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequestCustomText(
  afterSubmit: json['after_submit'] != null ? OneOf2.parse(json['after_submit'], fromA: (v) => CustomTextPositionParam9.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam9.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestCustomTextAfterSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  shippingAddress: json['shipping_address'] != null ? OneOf2.parse(json['shipping_address'], fromA: (v) => CustomTextPositionParam10.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam10.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestCustomTextShippingAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  submit: json['submit'] != null ? OneOf2.parse(json['submit'], fromA: (v) => CustomTextPositionParam11.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam11.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestCustomTextSubmitVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  termsOfServiceAcceptance: json['terms_of_service_acceptance'] != null ? OneOf2.parse(json['terms_of_service_acceptance'], fromA: (v) => CustomTextPositionParam12.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomTextPositionParam12.canParse(v), fromB: (v) => PostPaymentLinksPaymentLinkRequestCustomTextTermsOfServiceAcceptanceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
