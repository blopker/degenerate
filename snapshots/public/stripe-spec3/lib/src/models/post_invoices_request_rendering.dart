...
factory PostInvoicesRequestRendering.fromJson(Map<String, dynamic> json) { return PostInvoicesRequestRendering(
  ...
  templateVersion: json['template_version'] != null ? OneOf2.parse(json['template_version'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PostInvoicesRequestRenderingTemplateVersionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
