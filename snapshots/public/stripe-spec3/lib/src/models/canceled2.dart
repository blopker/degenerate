...
import 'canceled2_additional_documentation.dart';import 'canceled2_canceled_at.dart';import 'canceled2_cancellation_policy_provided.dart';import 'canceled2_cancellation_reason.dart';import 'canceled2_expected_at.dart';import 'canceled2_explanation.dart';import 'canceled2_product_description.dart';import 'canceled2_returned_at.dart';final class Canceled2ProductType {const Canceled2ProductType._(this.value);
...
factory Canceled2.fromJson(Map<String, dynamic> json) { return Canceled2(
  additionalDocumentation: json['additional_documentation'] != null ? Canceled2AdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  canceledAt: json['canceled_at'] != null ? Canceled2CanceledAt.fromJson(json['canceled_at'] as Map<String, dynamic>) : null,
  cancellationPolicyProvided: json['cancellation_policy_provided'] != null ? Canceled2CancellationPolicyProvided.fromJson(json['cancellation_policy_provided'] as Map<String, dynamic>) : null,
  cancellationReason: json['cancellation_reason'] != null ? Canceled2CancellationReason.fromJson(json['cancellation_reason'] as Map<String, dynamic>) : null,
  expectedAt: json['expected_at'] != null ? Canceled2ExpectedAt.fromJson(json['expected_at'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? Canceled2Explanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? Canceled2ProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
  ...
  returnedAt: json['returned_at'] != null ? Canceled2ReturnedAt.fromJson(json['returned_at'] as Map<String, dynamic>) : null,
); }
