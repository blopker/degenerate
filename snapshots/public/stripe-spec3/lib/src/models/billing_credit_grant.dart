...
import 'billing_credit_grant_customer.dart';import 'billing_credit_grant_test_clock.dart';import 'billing_credit_grants_resource_amount.dart';import 'billing_credit_grants_resource_applicability_config.dart';/// The category of this credit grant. This is for tracking purposes and isn't displayed to the customer.
...
factory BillingCreditGrant.fromJson(Map<String, dynamic> json) { return BillingCreditGrant(
  ...
  customer: BillingCreditGrantCustomer.fromJson(json['customer'] as Map<String, dynamic>),
