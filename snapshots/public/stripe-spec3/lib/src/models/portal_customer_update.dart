...
import 'package:collection/collection.dart';final class PortalCustomerUpdateAllowedUpdates {const PortalCustomerUpdateAllowedUpdates._(this.value);
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PortalCustomerUpdate &&
          const ListEquality<dynamic>().equals(allowedUpdates, other.allowedUpdates) &&
