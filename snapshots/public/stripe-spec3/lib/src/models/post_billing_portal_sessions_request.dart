...
import 'package:collection/collection.dart';import 'post_billing_portal_sessions_request_flow_data.dart';import 'post_billing_portal_sessions_request_locale.dart';final class PostBillingPortalSessionsRequest {const PostBillingPortalSessionsRequest({this.configuration, this.customer, this.customerAccount, this.expand, this.flowData, this.locale, this.onBehalfOf, this.returnUrl, });
