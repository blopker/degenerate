...
import 'package:collection/collection.dart';final class PostEntitlementsFeaturesRequest {const PostEntitlementsFeaturesRequest({this.expand, required this.lookupKey, this.metadata, required this.name, });
