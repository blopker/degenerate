...
import 'package:collection/collection.dart';import 'post_customers_customer_bank_accounts_id_request_metadata.dart';import 'post_customers_customer_bank_accounts_id_request_owner.dart';/// The type of entity that holds the account. This can be either `individual` or `company`.
...
factory PostCustomersCustomerBankAccountsIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerBankAccountsIdRequest(
  ...
  metadata: json['metadata'] != null
        ? PostCustomersCustomerBankAccountsIdRequestMetadata.fromJson(json['metadata'] as Map<String, dynamic>)
        : null,
  name: json['name'] as String?,
  owner: json['owner'] != null
        ? PostCustomersCustomerBankAccountsIdRequestOwner.fromJson(json['owner'] as Map<String, dynamic>)
        : null,
); }
