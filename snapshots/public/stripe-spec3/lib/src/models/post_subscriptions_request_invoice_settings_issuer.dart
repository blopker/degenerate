...
import 'post_subscriptions_request_invoice_settings_issuer_type.dart';final class PostSubscriptionsRequestInvoiceSettingsIssuer {const PostSubscriptionsRequestInvoiceSettingsIssuer({this.account, required this.type, });
