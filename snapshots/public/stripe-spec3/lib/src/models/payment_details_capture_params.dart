...
factory PaymentDetailsCaptureParams.fromJson(Map<String, dynamic> json) { return PaymentDetailsCaptureParams(
  customerReference: json['customer_reference'] != null ? OneOf2.parse(json['customer_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetailsCaptureParamsCustomerReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  orderReference: json['order_reference'] != null ? OneOf2.parse(json['order_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetailsCaptureParamsOrderReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
