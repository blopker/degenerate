...
import 'bbpos_wise_pose_splashscreen.dart';final class BbposWisePose {const BbposWisePose({this.splashscreen});

factory BbposWisePose.fromJson(Map<String, dynamic> json) { return BbposWisePose(
  splashscreen: json['splashscreen'] != null ? BbposWisePoseSplashscreen.fromJson(json['splashscreen'] as Map<String, dynamic>) : null,
); }
