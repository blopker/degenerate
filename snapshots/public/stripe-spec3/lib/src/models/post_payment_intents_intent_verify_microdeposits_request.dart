...
import 'package:collection/collection.dart';final class PostPaymentIntentsIntentVerifyMicrodepositsRequest {const PostPaymentIntentsIntentVerifyMicrodepositsRequest({this.amounts, this.clientSecret, this.descriptorCode, this.expand, });
