...
import 'payment_intent_payment_method_options_param12_mandate_options_reference_prefix.dart';final class PaymentIntentPaymentMethodOptionsParam12MandateOptions {const PaymentIntentPaymentMethodOptionsParam12MandateOptions({this.referencePrefix});
...
factory PaymentIntentPaymentMethodOptionsParam12MandateOptions.fromJson(Map<String, dynamic> json) { return PaymentIntentPaymentMethodOptionsParam12MandateOptions(
  referencePrefix: json['reference_prefix'] != null ? PaymentIntentPaymentMethodOptionsParam12MandateOptionsReferencePrefix.fromJson(json['reference_prefix'] as Map<String, dynamic>) : null,
); }
