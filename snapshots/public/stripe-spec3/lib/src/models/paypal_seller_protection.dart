...
import 'package:collection/collection.dart';final class PaypalSellerProtectionDisputeCategories {const PaypalSellerProtectionDisputeCategories._(this.value);
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PaypalSellerProtection &&
          const ListEquality<dynamic>().equals(disputeCategories, other.disputeCategories) &&
          status == other.status; } 
