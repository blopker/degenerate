...
import 'package:collection/collection.dart';final class PostTestHelpersIssuingTransactionsTransactionRefundRequest {const PostTestHelpersIssuingTransactionsTransactionRefundRequest({this.expand, this.refundAmount, });
