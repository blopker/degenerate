...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_persons_request_documents_passport_files.dart';final class PostAccountsAccountPersonsRequestDocumentsPassport {const PostAccountsAccountPersonsRequestDocumentsPassport({this.files});
...
factory PostAccountsAccountPersonsRequestDocumentsPassport.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestDocumentsPassport(
  files: (json['files'] as List<dynamic>?)?.map((e) => OneOf2.parse(e, fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsAccountPersonsRequestDocumentsPassportFilesVariant2.fromJson(v as String), canParseB: (v) => v is String,)).toList(),
); }
