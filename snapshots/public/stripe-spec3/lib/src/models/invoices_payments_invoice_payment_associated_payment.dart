...
factory InvoicesPaymentsInvoicePaymentAssociatedPayment.fromJson(Map<String, dynamic> json) { return InvoicesPaymentsInvoicePaymentAssociatedPayment(
  ...
  paymentRecord: json['payment_record'] != null ? OneOf2.parse(json['payment_record'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentRecord.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && PaymentRecord.canParse(v),) : null,
