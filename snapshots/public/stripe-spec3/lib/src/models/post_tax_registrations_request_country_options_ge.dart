...
import 'post_tax_registrations_request_country_options_ge_type.dart';final class PostTaxRegistrationsRequestCountryOptionsGe {const PostTaxRegistrationsRequestCountryOptionsGe({required this.type});
