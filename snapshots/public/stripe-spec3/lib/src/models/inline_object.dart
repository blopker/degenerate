...
final class InlineObject {const InlineObject({this.gt, this.gte, this.lt, this.lte, });
...
InlineObject copyWith({int Function()? gt, int Function()? gte, int Function()? lt, int Function()? lte, }) { return InlineObject(
...
@override String toString() { return 'InlineObject(gt: $gt, gte: $gte, lt: $lt, lte: $lte)'; } 
 }
