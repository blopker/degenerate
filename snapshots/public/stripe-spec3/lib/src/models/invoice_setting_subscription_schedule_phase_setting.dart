...
import 'package:collection/collection.dart';import 'invoice_setting_subscription_schedule_phase_setting_account_tax_ids.dart';import 'invoice_setting_subscription_schedule_phase_setting_issuer.dart';/// 
...
factory InvoiceSettingSubscriptionSchedulePhaseSetting.fromJson(Map<String, dynamic> json) { return InvoiceSettingSubscriptionSchedulePhaseSetting(
  accountTaxIds: (json['account_tax_ids'] as List<dynamic>?)?.map((e) => InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds.fromJson(e as Map<String, dynamic>)).toList(),
