...
import 'package:collection/collection.dart';import 'post_invoices_request_account_tax_ids.dart';import 'post_invoices_request_automatic_tax.dart';import 'post_invoices_request_collection_method.dart';import 'post_invoices_request_custom_fields.dart';import 'post_invoices_request_discounts.dart';import 'post_invoices_request_from_invoice.dart';import 'post_invoices_request_issuer.dart';import 'post_invoices_request_metadata.dart';import 'post_invoices_request_payment_settings.dart';import 'post_invoices_request_pending_invoice_items_behavior.dart';import 'post_invoices_request_rendering.dart';import 'post_invoices_request_shipping_cost.dart';import 'post_invoices_request_shipping_details.dart';import 'post_invoices_request_transfer_data.dart';final class PostInvoicesRequest {const PostInvoicesRequest({this.accountTaxIds, this.applicationFeeAmount, this.autoAdvance, this.automaticTax, this.automaticallyFinalizesAt, this.collectionMethod, this.currency, this.customFields, this.customer, this.customerAccount, this.daysUntilDue, this.defaultPaymentMethod, this.defaultSource, this.defaultTaxRates, this.description, this.discounts, this.dueDate, this.effectiveAt, this.expand, this.footer, this.fromInvoice, this.issuer, this.metadata, this.number, this.onBehalfOf, this.paymentSettings, this.pendingInvoiceItemsBehavior, this.rendering, this.shippingCost, this.shippingDetails, this.statementDescriptor, this.subscription, this.transferData, });
