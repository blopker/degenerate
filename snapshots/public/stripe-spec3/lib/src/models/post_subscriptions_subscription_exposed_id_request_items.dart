...
factory PostSubscriptionsSubscriptionExposedIdRequestItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionsSubscriptionExposedIdRequestItems(
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => ItemBillingThresholdsParam10.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && ItemBillingThresholdsParam10.canParse(v), fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestItemsBillingThresholdsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  clearUsage: json['clear_usage'] as bool?,
  deleted: json['deleted'] as bool?,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionsSubscriptionExposedIdRequestItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestItemsDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  id: json['id'] as String?,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestItemsMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostSubscriptionsSubscriptionExposedIdRequestItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
