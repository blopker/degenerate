...
factory PostTerminalConfigurationsConfigurationRequest.fromJson(Map<String, dynamic> json) { return PostTerminalConfigurationsConfigurationRequest(
  bbposWisepad3: json['bbpos_wisepad3'] != null ? OneOf2.parse(json['bbpos_wisepad3'], fromA: (v) => BbposWisePad3.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BbposWisePad3.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestBbposWisepad3Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  bbposWiseposE: json['bbpos_wisepos_e'] != null ? OneOf2.parse(json['bbpos_wisepos_e'], fromA: (v) => BbposWisePose.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BbposWisePose.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestBbposWiseposEVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  cellular: json['cellular'] != null ? OneOf2.parse(json['cellular'], fromA: (v) => Cellular2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Cellular2.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestCellularVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  name: json['name'] as String?,
  offline: json['offline'] != null ? OneOf2.parse(json['offline'], fromA: (v) => Offline2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Offline2.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestOfflineVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  rebootWindow: json['reboot_window'] != null ? OneOf2.parse(json['reboot_window'], fromA: (v) => RebootWindow.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RebootWindow.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestRebootWindowVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  stripeS700: json['stripe_s700'] != null ? OneOf2.parse(json['stripe_s700'], fromA: (v) => StripeS700.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && StripeS700.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestStripeS700Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  stripeS710: json['stripe_s710'] != null ? OneOf2.parse(json['stripe_s710'], fromA: (v) => StripeS710.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && StripeS710.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestStripeS710Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  tipping: json['tipping'] != null ? OneOf2.parse(json['tipping'], fromA: (v) => Tipping2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Tipping2.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestTippingVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  verifoneP400: json['verifone_p400'] != null ? OneOf2.parse(json['verifone_p400'], fromA: (v) => VerifoneP400.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && VerifoneP400.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestVerifoneP400Variant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  wifi: json['wifi'] != null ? OneOf2.parse(json['wifi'], fromA: (v) => Wifi2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && Wifi2.canParse(v), fromB: (v) => PostTerminalConfigurationsConfigurationRequestWifiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
