...
factory PaymentMethodDetailsBancontact.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsBancontact(
  ...
  generatedSepaDebit: json['generated_sepa_debit'] != null
        ? PaymentMethodDetailsBancontactGeneratedSepaDebit.fromJson(json['generated_sepa_debit'] as Map<String, dynamic>)
        : null,
  generatedSepaDebitMandate: json['generated_sepa_debit_mandate'] != null
        ? PaymentMethodDetailsBancontactGeneratedSepaDebitMandate.fromJson(json['generated_sepa_debit_mandate'] as Map<String, dynamic>)
        : null,
