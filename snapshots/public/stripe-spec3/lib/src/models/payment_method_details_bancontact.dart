...
import 'payment_method_details_bancontact_generated_sepa_debit.dart';import 'payment_method_details_bancontact_generated_sepa_debit_mandate.dart';/// Preferred language of the Bancontact authorization page that the customer is redirected to.
...
factory PaymentMethodDetailsBancontact.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsBancontact(
  ...
  generatedSepaDebit: json['generated_sepa_debit'] != null ? PaymentMethodDetailsBancontactGeneratedSepaDebit.fromJson(json['generated_sepa_debit'] as Map<String, dynamic>) : null,
  generatedSepaDebitMandate: json['generated_sepa_debit_mandate'] != null ? PaymentMethodDetailsBancontactGeneratedSepaDebitMandate.fromJson(json['generated_sepa_debit_mandate'] as Map<String, dynamic>) : null,
