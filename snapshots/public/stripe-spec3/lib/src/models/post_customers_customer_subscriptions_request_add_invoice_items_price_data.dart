...
import 'post_customers_customer_subscriptions_request_add_invoice_items_price_data_tax_behavior.dart';final class PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsPriceData {const PostCustomersCustomerSubscriptionsRequestAddInvoiceItemsPriceData({required this.currency, required this.product, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
