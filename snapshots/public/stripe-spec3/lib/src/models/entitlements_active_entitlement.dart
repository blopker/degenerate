...
factory EntitlementsActiveEntitlement.fromJson(Map<String, dynamic> json) { return EntitlementsActiveEntitlement(
  feature: OneOf2.parse(json['feature'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => EntitlementsFeature.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && EntitlementsFeature.canParse(v),),
