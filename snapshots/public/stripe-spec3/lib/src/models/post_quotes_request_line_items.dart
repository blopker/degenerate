...
factory PostQuotesRequestLineItems.fromJson(Map<String, dynamic> json) { return PostQuotesRequestLineItems(
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostQuotesRequestLineItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesRequestLineItemsDiscountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostQuotesRequestLineItemsTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
