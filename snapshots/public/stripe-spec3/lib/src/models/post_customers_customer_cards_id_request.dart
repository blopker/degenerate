...
factory PostCustomersCustomerCardsIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerCardsIdRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostCustomersCustomerCardsIdRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
