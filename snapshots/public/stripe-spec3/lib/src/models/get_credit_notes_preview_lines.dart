...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'get_credit_notes_preview_lines_tax_amounts.dart';import 'get_credit_notes_preview_lines_tax_rates.dart';final class GetCreditNotesPreviewLinesType {const GetCreditNotesPreviewLinesType._(this.value);
...
factory GetCreditNotesPreviewLines.fromJson(Map<String, dynamic> json) { return GetCreditNotesPreviewLines(
  ...
  taxAmounts: json['tax_amounts'] != null ? OneOf2.parse(json['tax_amounts'], fromA: (v) => (v as List<dynamic>).map((e) => GetCreditNotesPreviewLinesTaxAmountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => GetCreditNotesPreviewLinesTaxAmountsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => GetCreditNotesPreviewLinesTaxRatesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
