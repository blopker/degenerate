...
factory PostBillingPortalConfigurationsRequestBusinessProfile.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsRequestBusinessProfile(
  headline: json['headline'] != null ? OneOf2.parse(json['headline'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsRequestBusinessProfileHeadlineVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
