...
factory BillingCreditBalanceTransaction.fromJson(Map<String, dynamic> json) { return BillingCreditBalanceTransaction(
  ...
  creditGrant: OneOf2.parse(json['credit_grant'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BillingCreditGrant.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BillingCreditGrant.canParse(v),),
