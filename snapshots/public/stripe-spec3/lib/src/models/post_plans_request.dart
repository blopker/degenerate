...
import 'package:collection/collection.dart';import 'post_plans_request_billing_scheme.dart';import 'post_plans_request_interval.dart';import 'post_plans_request_metadata.dart';import 'post_plans_request_product.dart';import 'post_plans_request_tiers.dart';import 'post_plans_request_tiers_mode.dart';import 'post_plans_request_transform_usage.dart';import 'post_plans_request_usage_type.dart';final class PostPlansRequest {const PostPlansRequest({this.active, this.amount, this.amountDecimal, this.billingScheme, required this.currency, this.expand, this.id, required this.interval, this.intervalCount, this.metadata, this.meter, this.nickname, this.product, this.tiers, this.tiersMode, this.transformUsage, this.trialPeriodDays, this.usageType, });
