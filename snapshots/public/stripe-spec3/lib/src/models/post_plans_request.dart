...
import 'package:collection/collection.dart';import 'post_plans_request_metadata.dart';import 'post_plans_request_product.dart';import 'post_plans_request_tiers.dart';import 'post_plans_request_transform_usage.dart';/// Describes how to compute the price per period. Either `per_unit` or `tiered`. `per_unit` indicates that the fixed amount (specified in `amount`) will be charged per unit in `quantity` (for plans with `usage_type=licensed`), or per unit of total usage (for plans with `usage_type=metered`). `tiered` indicates that the unit pricing will be computed using a tiering strategy as defined using the `tiers` and `tiers_mode` attributes.
