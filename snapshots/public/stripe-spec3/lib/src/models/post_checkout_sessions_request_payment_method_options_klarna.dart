...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_checkout_sessions_request_payment_method_options_klarna_subscriptions.dart';final class PostCheckoutSessionsRequestPaymentMethodOptionsKlarnaCaptureMethod {const PostCheckoutSessionsRequestPaymentMethodOptionsKlarnaCaptureMethod._(this.value);
...
factory PostCheckoutSessionsRequestPaymentMethodOptionsKlarna.fromJson(Map<String, dynamic> json) { return PostCheckoutSessionsRequestPaymentMethodOptionsKlarna(
  ...
  subscriptions: json['subscriptions'] != null ? OneOf2.parse(json['subscriptions'], fromA: (v) => (v as List<dynamic>).map((e) => PostCheckoutSessionsRequestPaymentMethodOptionsKlarnaSubscriptionsVariant1.fromJson(e as Map<String, dynamic>)).toList(), canParseA: (v) => v is List, fromB: (v) => PostCheckoutSessionsRequestPaymentMethodOptionsKlarnaSubscriptionsVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
