...
factory PaymentDetails.fromJson(Map<String, dynamic> json) { return PaymentDetails(
  customerReference: json['customer_reference'] != null ? OneOf2.parse(json['customer_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetailsCustomerReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  orderReference: json['order_reference'] != null ? OneOf2.parse(json['order_reference'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentDetailsOrderReferenceVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
