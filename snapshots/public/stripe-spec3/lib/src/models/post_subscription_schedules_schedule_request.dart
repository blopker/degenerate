...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_subscription_schedules_schedule_request_default_settings.dart';import 'post_subscription_schedules_schedule_request_metadata.dart';import 'post_subscription_schedules_schedule_request_metadata.dart';import 'post_subscription_schedules_schedule_request_phases.dart';/// Behavior of the subscription schedule and underlying subscription when it ends. Possible values are `release` or `cancel` with the default being `release`. `release` will end the subscription schedule and keep the underlying subscription running. `cancel` will end the subscription schedule and cancel the underlying subscription.
