...
import 'get_invoice_payments_payment_type.dart';final class GetInvoicePaymentsPayment {const GetInvoicePaymentsPayment({this.paymentIntent, this.paymentRecord, required this.type, });
