...
factory PostTokensRequestPerson.fromJson(Map<String, dynamic> json) { return PostTokensRequestPerson(
  ...
  dob: json['dob'] != null ? OneOf2.parse(json['dob'], fromA: (v) => DateOfBirthSpecs8.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && DateOfBirthSpecs8.canParse(v), fromB: (v) => PostTokensRequestPersonDobVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null ? OneOf2.parse(json['full_name_aliases'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), canParseA: (v) => v is List, fromB: (v) => PostTokensRequestPersonFullNameAliasesVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostTokensRequestPersonMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
