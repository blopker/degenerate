...
factory PostBillingPortalConfigurationsRequest.fromJson(Map<String, dynamic> json) { return PostBillingPortalConfigurationsRequest(
  ...
  defaultReturnUrl: json['default_return_url'] != null ? OneOf2.parse(json['default_return_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsRequestDefaultReturnUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  ...
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostBillingPortalConfigurationsRequestNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
