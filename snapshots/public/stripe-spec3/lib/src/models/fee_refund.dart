...
factory FeeRefund.fromJson(Map<String, dynamic> json) { return FeeRefund(
  ...
  fee: OneOf2.parse(json['fee'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => ApplicationFee.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && ApplicationFee.canParse(v),),
