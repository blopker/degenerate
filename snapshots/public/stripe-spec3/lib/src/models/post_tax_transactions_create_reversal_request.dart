...
import 'package:collection/collection.dart';import 'post_tax_transactions_create_reversal_request_line_items.dart';import 'post_tax_transactions_create_reversal_request_mode.dart';import 'post_tax_transactions_create_reversal_request_shipping_cost.dart';final class PostTaxTransactionsCreateReversalRequest {const PostTaxTransactionsCreateReversalRequest({this.expand, this.flatAmount, this.lineItems, this.metadata, required this.mode, required this.originalTransaction, required this.reference, this.shippingCost, });
