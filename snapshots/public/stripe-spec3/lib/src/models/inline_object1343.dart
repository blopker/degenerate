...
final class InlineObject1343 {const InlineObject1343({this.amountGte, this.resetBillingCycleAnchor, });

factory InlineObject1343.fromJson(Map<String, dynamic> json) { return InlineObject1343(
...
InlineObject1343 copyWith({int Function()? amountGte, bool Function()? resetBillingCycleAnchor, }) { return InlineObject1343(
...
@override String toString() { return 'InlineObject1343(amountGte: $amountGte, resetBillingCycleAnchor: $resetBillingCycleAnchor)'; } 
 }
