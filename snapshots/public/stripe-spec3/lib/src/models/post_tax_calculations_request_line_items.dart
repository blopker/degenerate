...
import 'post_tax_calculations_request_line_items_tax_behavior.dart';final class PostTaxCalculationsRequestLineItems {const PostTaxCalculationsRequestLineItems({required this.amount, this.metadata, this.product, this.quantity, this.reference, this.taxBehavior, this.taxCode, });
