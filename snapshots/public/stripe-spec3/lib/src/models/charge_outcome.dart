...
factory ChargeOutcome.fromJson(Map<String, dynamic> json) { return ChargeOutcome(
  ...
  rule: json['rule'] != null ? OneOf2.parse(json['rule'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Rule.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Rule.canParse(v),) : null,
