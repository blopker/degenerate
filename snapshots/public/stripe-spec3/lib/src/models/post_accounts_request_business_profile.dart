...
factory PostAccountsRequestBusinessProfile.fromJson(Map<String, dynamic> json) { return PostAccountsRequestBusinessProfile(
  ...
  supportUrl: json['support_url'] != null ? OneOf2.parse(json['support_url'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsRequestBusinessProfileSupportUrlVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
