...
factory CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft.fromJson(Map<String, dynamic> json) { return CustomerBalanceResourceCashBalanceTransactionResourceAdjustedForOverdraft(
  balanceTransaction: OneOf2.parse(json['balance_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BalanceTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BalanceTransaction.canParse(v),),
  linkedTransaction: OneOf2.parse(json['linked_transaction'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => CustomerCashBalanceTransaction.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && CustomerCashBalanceTransaction.canParse(v),),
); }
