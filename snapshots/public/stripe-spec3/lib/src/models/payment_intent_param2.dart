...
factory PaymentIntentParam2.fromJson(Map<String, dynamic> json) { return PaymentIntentParam2(
  ...
  statementDescriptorSuffixKana: json['statement_descriptor_suffix_kana'] != null ? OneOf2.parse(json['statement_descriptor_suffix_kana'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentParam2StatementDescriptorSuffixKanaVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptorSuffixKanji: json['statement_descriptor_suffix_kanji'] != null ? OneOf2.parse(json['statement_descriptor_suffix_kanji'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentIntentParam2StatementDescriptorSuffixKanjiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
