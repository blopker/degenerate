...
import 'payment_intent_param2_installments.dart';import 'payment_intent_param2_mandate_options.dart';import 'payment_intent_param2_statement_descriptor_suffix_kana.dart';import 'payment_intent_param2_statement_descriptor_suffix_kanji.dart';import 'payment_intent_param2_three_d_secure.dart';final class PaymentIntentParam2CaptureMethod {const PaymentIntentParam2CaptureMethod._(this.value);
...
factory PaymentIntentParam2.fromJson(Map<String, dynamic> json) { return PaymentIntentParam2(
  ...
  statementDescriptorSuffixKana: json['statement_descriptor_suffix_kana'] != null ? PaymentIntentParam2StatementDescriptorSuffixKana.fromJson(json['statement_descriptor_suffix_kana'] as Map<String, dynamic>) : null,
  statementDescriptorSuffixKanji: json['statement_descriptor_suffix_kanji'] != null ? PaymentIntentParam2StatementDescriptorSuffixKanji.fromJson(json['statement_descriptor_suffix_kanji'] as Map<String, dynamic>) : null,
