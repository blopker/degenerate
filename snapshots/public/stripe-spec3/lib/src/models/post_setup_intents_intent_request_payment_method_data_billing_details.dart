...
factory PostSetupIntentsIntentRequestPaymentMethodDataBillingDetails.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentRequestPaymentMethodDataBillingDetails(
  address: json['address'] != null ? OneOf2.parse(json['address'], fromA: (v) => BillingDetailsAddress8.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BillingDetailsAddress8.canParse(v), fromB: (v) => PostSetupIntentsIntentRequestPaymentMethodDataBillingDetailsAddressVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  email: json['email'] != null ? OneOf2.parse(json['email'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentRequestPaymentMethodDataBillingDetailsEmailVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  name: json['name'] != null ? OneOf2.parse(json['name'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentRequestPaymentMethodDataBillingDetailsNameVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  phone: json['phone'] != null ? OneOf2.parse(json['phone'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostSetupIntentsIntentRequestPaymentMethodDataBillingDetailsPhoneVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
