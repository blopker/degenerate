...
import 'post_test_helpers_issuing_authorizations_request_merchant_data_category.dart';/// Details about the seller (grocery store, e-commerce website, etc.) where the card authorization happened.
