...
factory PostPaymentLinksPaymentLinkRequestPaymentIntentData.fromJson(Map<String, dynamic> json) { return PostPaymentLinksPaymentLinkRequestPaymentIntentData(
  description: json['description'] != null ? OneOf2.parse(json['description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentIntentDataDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentIntentDataMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptor: json['statement_descriptor'] != null ? OneOf2.parse(json['statement_descriptor'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentIntentDataStatementDescriptorVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptorSuffix: json['statement_descriptor_suffix'] != null ? OneOf2.parse(json['statement_descriptor_suffix'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentIntentDataStatementDescriptorSuffixVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  transferGroup: json['transfer_group'] != null ? OneOf2.parse(json['transfer_group'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostPaymentLinksPaymentLinkRequestPaymentIntentDataTransferGroupVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
