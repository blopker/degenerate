...
import 'package:collection/collection.dart';final class PostAccountsAccountRequestDocumentsProofOfAddress {const PostAccountsAccountRequestDocumentsProofOfAddress({this.files});
