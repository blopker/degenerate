...
factory AccountBrandingSettings.fromJson(Map<String, dynamic> json) { return AccountBrandingSettings(
  icon: json['icon'] != null ? OneOf2.parse(json['icon'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
  logo: json['logo'] != null ? OneOf2.parse(json['logo'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
