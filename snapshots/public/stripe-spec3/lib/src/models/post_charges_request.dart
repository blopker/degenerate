...
factory PostChargesRequest.fromJson(Map<String, dynamic> json) { return PostChargesRequest(
  ...
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => CustomerPaymentSourceCard.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && CustomerPaymentSourceCard.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  currency: json['currency'] as String?,
  customer: json['customer'] as String?,
  description: json['description'] as String?,
  destination: json['destination'] != null ? OneOf2.parse(json['destination'], fromA: (v) => DestinationSpecs.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && DestinationSpecs.canParse(v), fromB: (v) => v as String, canParseB: (v) => v is String,) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostChargesRequestMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
