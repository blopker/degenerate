...
factory IssuingPersonalizationDesign.fromJson(Map<String, dynamic> json) { return IssuingPersonalizationDesign(
  cardLogo: json['card_logo'] != null ? OneOf2.parse(json['card_logo'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => File.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && File.canParse(v),) : null,
  ...
  physicalBundle: OneOf2.parse(json['physical_bundle'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingPhysicalBundle.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingPhysicalBundle.canParse(v),),
