...
import 'package:collection/collection.dart';import 'post_terminal_readers_reader_process_setup_intent_request_allow_redisplay.dart';import 'post_terminal_readers_reader_process_setup_intent_request_process_config.dart';final class PostTerminalReadersReaderProcessSetupIntentRequest {const PostTerminalReadersReaderProcessSetupIntentRequest({required this.allowRedisplay, this.expand, this.processConfig, required this.setupIntent, });
