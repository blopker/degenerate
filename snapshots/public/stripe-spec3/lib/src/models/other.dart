...
factory Other.fromJson(Map<String, dynamic> json) { return Other(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => OtherAdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => OtherExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => OtherProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
