...
import 'other_additional_documentation.dart';import 'other_explanation.dart';import 'other_product_description.dart';final class OtherProductType {const OtherProductType._(this.value);
...
factory Other.fromJson(Map<String, dynamic> json) { return Other(
  additionalDocumentation: json['additional_documentation'] != null ? OtherAdditionalDocumentation.fromJson(json['additional_documentation'] as Map<String, dynamic>) : null,
  explanation: json['explanation'] != null ? OtherExplanation.fromJson(json['explanation'] as Map<String, dynamic>) : null,
  productDescription: json['product_description'] != null ? OtherProductDescription.fromJson(json['product_description'] as Map<String, dynamic>) : null,
