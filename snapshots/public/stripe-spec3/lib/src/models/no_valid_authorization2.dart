...
factory NoValidAuthorization2.fromJson(Map<String, dynamic> json) { return NoValidAuthorization2(
  additionalDocumentation: json['additional_documentation'] != null ? OneOf2.parse(json['additional_documentation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => NoValidAuthorization2AdditionalDocumentationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  explanation: json['explanation'] != null ? OneOf2.parse(json['explanation'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => NoValidAuthorization2ExplanationVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
