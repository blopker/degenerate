...
factory IssuingAuthorization.fromJson(Map<String, dynamic> json) { return IssuingAuthorization(
  ...
  cardholder: json['cardholder'] != null ? OneOf2.parse(json['cardholder'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingCardholder.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingCardholder.canParse(v),) : null,
  ...
  token: json['token'] != null ? OneOf2.parse(json['token'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => IssuingToken.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && IssuingToken.canParse(v),) : null,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is IssuingAuthorization &&
          ...
          fleet == other.fleet &&
          const ListEquality<dynamic>().equals(fraudChallenges, other.fraudChallenges) &&
          fuel == other.fuel &&
          id == other.id &&
          ...
          const ListEquality<dynamic>().equals(requestHistory, other.requestHistory) &&
          status == other.status &&
          token == other.token &&
          const ListEquality<dynamic>().equals(transactions, other.transactions) &&
