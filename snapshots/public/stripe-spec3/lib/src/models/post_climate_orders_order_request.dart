...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_climate_orders_order_request_beneficiary.dart';final class PostClimateOrdersOrderRequest {const PostClimateOrdersOrderRequest({this.beneficiary, this.expand, this.metadata, });

factory PostClimateOrdersOrderRequest.fromJson(Map<String, dynamic> json) { return PostClimateOrdersOrderRequest(
  beneficiary: json['beneficiary'] != null ? OneOf2.parse(json['beneficiary'], fromA: (v) => BeneficiaryParams.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && BeneficiaryParams.canParse(v), fromB: (v) => PostClimateOrdersOrderRequestBeneficiaryVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
