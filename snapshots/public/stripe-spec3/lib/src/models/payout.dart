...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payout_application_fee.dart';import 'payout_balance_transaction.dart';import 'payout_destination.dart';import 'payout_failure_balance_transaction.dart';import 'payout_original_payout.dart';import 'payout_reversed_by.dart';import 'payout_trace_id.dart';/// String representing the object's type. Objects of the same type share the same value.
...
factory Payout.fromJson(Map<String, dynamic> json) { return Payout(
  ...
  destination: json['destination'] != null ? OneOf5.parse(json['destination'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => BankAccount.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && BankAccount.canParse(v), fromC: (v) => Card.fromJson(v as Map<String, dynamic>), canParseC: (v) => v is Map<String, dynamic> && Card.canParse(v), fromD: (v) => DeletedBankAccount.fromJson(v as Map<String, dynamic>), canParseD: (v) => v is Map<String, dynamic> && DeletedBankAccount.canParse(v), fromE: (v) => DeletedCard.fromJson(v as Map<String, dynamic>), canParseE: (v) => v is Map<String, dynamic> && DeletedCard.canParse(v),) : null,
  ...
  originalPayout: json['original_payout'] != null ? OneOf2.parse(json['original_payout'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Payout.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Payout.canParse(v),) : null,
  ...
  reversedBy: json['reversed_by'] != null ? OneOf2.parse(json['reversed_by'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => Payout.fromJson(v as Map<String, dynamic>), canParseB: (v) => v is Map<String, dynamic> && Payout.canParse(v),) : null,
