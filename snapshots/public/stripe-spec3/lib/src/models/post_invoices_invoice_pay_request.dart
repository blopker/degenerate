...
import 'package:collection/collection.dart';import 'post_invoices_invoice_pay_request_mandate.dart';final class PostInvoicesInvoicePayRequest {const PostInvoicesInvoicePayRequest({this.expand, this.forgive, this.mandate, this.offSession, this.paidOutOfBand, this.paymentMethod, this.source, });
