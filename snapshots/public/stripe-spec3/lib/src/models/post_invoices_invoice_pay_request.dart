...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_invoices_invoice_pay_request_mandate.dart';final class PostInvoicesInvoicePayRequest {const PostInvoicesInvoicePayRequest({this.expand, this.forgive, this.mandate, this.offSession, this.paidOutOfBand, this.paymentMethod, this.source, });
...
factory PostInvoicesInvoicePayRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoicePayRequest(
  ...
  mandate: json['mandate'] != null ? OneOf2.parse(json['mandate'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostInvoicesInvoicePayRequestMandateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
