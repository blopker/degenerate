...
factory PostAccountsRequestSettingsCardPayments.fromJson(Map<String, dynamic> json) { return PostAccountsRequestSettingsCardPayments(
  ...
  statementDescriptorPrefixKana: json['statement_descriptor_prefix_kana'] != null ? OneOf2.parse(json['statement_descriptor_prefix_kana'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsRequestSettingsCardPaymentsStatementDescriptorPrefixKanaVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  statementDescriptorPrefixKanji: json['statement_descriptor_prefix_kanji'] != null ? OneOf2.parse(json['statement_descriptor_prefix_kanji'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PostAccountsRequestSettingsCardPaymentsStatementDescriptorPrefixKanjiVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
); }
