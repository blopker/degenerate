...
import 'post_test_helpers_issuing_authorizations_authorization_capture_request_purchase_details_fleet_cardholder_prompt_data.dart';import 'post_test_helpers_issuing_authorizations_authorization_capture_request_purchase_details_fleet_purchase_type.dart';import 'post_test_helpers_issuing_authorizations_authorization_capture_request_purchase_details_fleet_reported_breakdown.dart';import 'post_test_helpers_issuing_authorizations_authorization_capture_request_purchase_details_fleet_service_type.dart';final class PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleet {const PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleet({this.cardholderPromptData, this.purchaseType, this.reportedBreakdown, this.serviceType, });
...
factory PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleet.fromJson(Map<String, dynamic> json) { return PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleet(
  cardholderPromptData: json['cardholder_prompt_data'] != null
        ? PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleetCardholderPromptData.fromJson(json['cardholder_prompt_data'] as Map<String, dynamic>)
        : null,
  ...
  reportedBreakdown: json['reported_breakdown'] != null
        ? PostTestHelpersIssuingAuthorizationsAuthorizationCaptureRequestPurchaseDetailsFleetReportedBreakdown.fromJson(json['reported_breakdown'] as Map<String, dynamic>)
        : null,
