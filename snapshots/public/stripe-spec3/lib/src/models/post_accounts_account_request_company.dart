...
factory PostAccountsAccountRequestCompany.fromJson(Map<String, dynamic> json) { return PostAccountsAccountRequestCompany(
  ...
  registrationDate: json['registration_date'] != null ? OneOf2.parse(json['registration_date'], fromA: (v) => RegistrationDateSpecs2.fromJson(v as Map<String, dynamic>), canParseA: (v) => v is Map<String, dynamic> && RegistrationDateSpecs2.canParse(v), fromB: (v) => PostAccountsAccountRequestCompanyRegistrationDateVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
