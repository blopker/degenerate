...
import 'package:collection/collection.dart';import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_invoices_invoice_remove_lines_request_invoice_metadata.dart';import 'post_invoices_invoice_remove_lines_request_lines.dart';final class PostInvoicesInvoiceRemoveLinesRequest {const PostInvoicesInvoiceRemoveLinesRequest({this.expand, this.invoiceMetadata, required this.lines, });
...
factory PostInvoicesInvoiceRemoveLinesRequest.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRemoveLinesRequest(
  ...
  invoiceMetadata: json['invoice_metadata'] != null ? OneOf2.parse(json['invoice_metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), canParseA: (v) => v is Map, fromB: (v) => PostInvoicesInvoiceRemoveLinesRequestInvoiceMetadataVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
