...
factory PaymentMethodOptionsParam18.fromJson(Map<String, dynamic> json) { return PaymentMethodOptionsParam18(
  confirmationNumber: json['confirmation_number'] != null ? OneOf2.parse(json['confirmation_number'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentMethodOptionsParam18ConfirmationNumberVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expiresAfterDays: json['expires_after_days'] != null ? OneOf2.parse(json['expires_after_days'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PaymentMethodOptionsParam18ExpiresAfterDaysVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  expiresAt: json['expires_at'] != null ? OneOf2.parse(json['expires_at'], fromA: (v) => (v as num).toInt(), canParseA: (v) => v is num, fromB: (v) => PaymentMethodOptionsParam18ExpiresAtVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
  productDescription: json['product_description'] != null ? OneOf2.parse(json['product_description'], fromA: (v) => v as String, canParseA: (v) => v is String, fromB: (v) => PaymentMethodOptionsParam18ProductDescriptionVariant2.fromJson(v as String), canParseB: (v) => v is String,) : null,
