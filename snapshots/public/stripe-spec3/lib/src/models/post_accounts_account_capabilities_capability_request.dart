...
import 'package:collection/collection.dart';final class PostAccountsAccountCapabilitiesCapabilityRequest {const PostAccountsAccountCapabilitiesCapabilityRequest({this.expand, this.requested, });
