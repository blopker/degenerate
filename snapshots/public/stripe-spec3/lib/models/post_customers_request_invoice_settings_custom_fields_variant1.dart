...
final class PostCustomersRequestInvoiceSettingsCustomFieldsVariant1 {const PostCustomersRequestInvoiceSettingsCustomFieldsVariant1({required this.name, required this.value, });
