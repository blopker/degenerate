...
final class PostIssuingCardholdersCardholderRequestIndividualVerificationDocument {const PostIssuingCardholdersCardholderRequestIndividualVerificationDocument({this.back, this.front, });
