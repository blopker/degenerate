...
@immutable final class LegalEntityDob {const LegalEntityDob({this.day = const Omittable.absent(), this.month = const Omittable.absent(), this.year = const Omittable.absent(), });
...
LegalEntityDob copyWith({Omittable<int?>? day, Omittable<int?>? month, Omittable<int?>? year, }) { return LegalEntityDob(
  day: day ?? this.day,
  month: month ?? this.month,
  year: year ?? this.year,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is LegalEntityDob &&
          day == other.day &&
          month == other.month &&
          year == other.year; } 
@override int get hashCode { return Object.hash(day, month, year); } 
@override String toString() { return 'LegalEntityDob(day: $day, month: $month, year: $year)'; } 
 }
