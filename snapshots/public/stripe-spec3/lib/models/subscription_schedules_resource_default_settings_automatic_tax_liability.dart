...
final class SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiability {const SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiability({this.connectAccountReference});

factory SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiability.fromJson(Map<String, dynamic> json) { return SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxLiability(
