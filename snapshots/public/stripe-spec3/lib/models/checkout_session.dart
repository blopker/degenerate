...
factory CheckoutSession.fromJson(Map<String, dynamic> json) {return CheckoutSession(
  ...
  customer: json.containsKey('customer') ? Omittable(json['customer'] != null ? CheckoutSessionCustomer.fromJson(json['customer']) : null) : const Omittable.absent(),
  ...
  invoice: json.containsKey('invoice') ? Omittable(json['invoice'] != null ? CheckoutSessionInvoice.fromJson(json['invoice']) : null) : const Omittable.absent(),
  ...
  paymentIntent: json.containsKey('payment_intent') ? Omittable(json['payment_intent'] != null ? CheckoutSessionPaymentIntent.fromJson(json['payment_intent']) : null) : const Omittable.absent(),
  paymentLink: json.containsKey('payment_link') ? Omittable(json['payment_link'] != null ? CheckoutSessionPaymentLink.fromJson(json['payment_link']) : null) : const Omittable.absent(),
  ...
  setupIntent: json.containsKey('setup_intent') ? Omittable(json['setup_intent'] != null ? CheckoutSessionSetupIntent.fromJson(json['setup_intent']) : null) : const Omittable.absent(),
  ...
  subscription: json.containsKey('subscription') ? Omittable(json['subscription'] != null ? CheckoutSessionSubscription.fromJson(json['subscription']) : null) : const Omittable.absent(),
