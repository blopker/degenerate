...
@immutable final class CheckoutGiropayPaymentMethodOptionsSetupFutureUsage {const CheckoutGiropayPaymentMethodOptionsSetupFutureUsage._(this.value);
...
/// 
@immutable final class CheckoutGiropayPaymentMethodOptions {const CheckoutGiropayPaymentMethodOptions({this.setupFutureUsage});
