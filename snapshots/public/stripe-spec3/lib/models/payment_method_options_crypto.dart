...
final class PaymentMethodOptionsCryptoSetupFutureUsage {const PaymentMethodOptionsCryptoSetupFutureUsage._(this.value);
...
/// 
final class PaymentMethodOptionsCrypto {const PaymentMethodOptionsCrypto({this.setupFutureUsage});
