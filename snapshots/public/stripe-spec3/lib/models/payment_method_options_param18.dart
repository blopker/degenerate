...
factory PaymentMethodOptionsParam18.fromJson(Map<String, dynamic> json) {return PaymentMethodOptionsParam18(
  confirmationNumber: json['confirmation_number'] != null ? PaymentMethodOptionsParam18ConfirmationNumber.fromJson(json['confirmation_number']) : null,
  expiresAfterDays: json['expires_after_days'] != null ? PaymentMethodOptionsParam18ExpiresAfterDays.fromJson(json['expires_after_days']) : null,
  expiresAt: json['expires_at'] != null ? PaymentMethodOptionsParam18ExpiresAt.fromJson(json['expires_at']) : null,
  productDescription: json['product_description'] != null ? PaymentMethodOptionsParam18ProductDescription.fromJson(json['product_description']) : null,
