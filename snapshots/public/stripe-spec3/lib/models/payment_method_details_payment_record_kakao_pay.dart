...
@immutable final class PaymentMethodDetailsPaymentRecordKakaoPay {const PaymentMethodDetailsPaymentRecordKakaoPay({this.buyerId = const Omittable.absent(), this.transactionId = const Omittable.absent(), });
...
PaymentMethodDetailsPaymentRecordKakaoPay copyWith({Omittable<String?>? buyerId, Omittable<String?>? transactionId, }) { return PaymentMethodDetailsPaymentRecordKakaoPay(
