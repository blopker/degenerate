...
final class ExternalAccount {
  const ExternalAccount({this.bankAccount = const Omittable.absent(),
this.card = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ExternalAccount._({required this.rawValue, required this.bankAccount,
required this.card,});
  factory ExternalAccount.fromJson(Object? json) => ExternalAccount._(
...
if (card.isPresent) card.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ExternalAccount && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ExternalAccount(${toJson()})';
}
