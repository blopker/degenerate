...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsDiscounts {const PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsDiscounts({this.coupon, this.discount, this.promotionCode, });
