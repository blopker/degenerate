...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostCreditNotesIdRequest {const PostCreditNotesIdRequest({this.expand, this.memo, this.metadata, });
