...
@immutable
final class TreasuryReceivedCreditTransaction {
  const TreasuryReceivedCreditTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryReceivedCreditTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryReceivedCreditTransaction.fromJson(Object? json) => TreasuryReceivedCreditTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryReceivedCreditTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryReceivedCreditTransaction(${toJson()})';
}
