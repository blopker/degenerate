...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsConfigurationRequestBacsDebitDisplayPreferencePreference {const PostPaymentMethodConfigurationsConfigurationRequestBacsDebitDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsConfigurationRequestBacsDebitDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestBacsDebitDisplayPreference({this.preference});
