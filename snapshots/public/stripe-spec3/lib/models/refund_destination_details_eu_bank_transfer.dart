...
@immutable final class RefundDestinationDetailsEuBankTransfer {const RefundDestinationDetailsEuBankTransfer({this.reference = const Omittable.absent(), this.referenceStatus = const Omittable.absent(), });
...
RefundDestinationDetailsEuBankTransfer copyWith({Omittable<String?>? reference, Omittable<String?>? referenceStatus, }) { return RefundDestinationDetailsEuBankTransfer(
  reference: reference ?? this.reference,
  referenceStatus: referenceStatus ?? this.referenceStatus,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RefundDestinationDetailsEuBankTransfer &&
          reference == other.reference &&
          referenceStatus == other.referenceStatus; } 
@override int get hashCode { return Object.hash(reference, referenceStatus); } 
@override String toString() { return 'RefundDestinationDetailsEuBankTransfer(reference: $reference, referenceStatus: $referenceStatus)'; } 
 }
