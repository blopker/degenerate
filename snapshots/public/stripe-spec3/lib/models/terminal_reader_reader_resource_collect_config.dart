...
final class TerminalReaderReaderResourceCollectConfig {const TerminalReaderReaderResourceCollectConfig({this.enableCustomerCancellation, this.skipTipping, this.tipping, });
