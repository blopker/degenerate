...
final class AmountDetailsParam2LineItemsVariant1PaymentMethodOptionsCardPresent {const AmountDetailsParam2LineItemsVariant1PaymentMethodOptionsCardPresent({this.commodityCode});
