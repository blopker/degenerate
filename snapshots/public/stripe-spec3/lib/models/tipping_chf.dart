...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingChf {const TippingChf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
