...
@immutable final class IssuingCardholderIndividualDob {const IssuingCardholderIndividualDob({this.day = const Omittable.absent(), this.month = const Omittable.absent(), this.year = const Omittable.absent(), });
...
IssuingCardholderIndividualDob copyWith({Omittable<int?>? day, Omittable<int?>? month, Omittable<int?>? year, }) { return IssuingCardholderIndividualDob(
  day: day ?? this.day,
