...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'test_helpers_test_clock.dart';/// ID of the test clock this quote belongs to.
@immutable
final class QuoteTestClock {
  const QuoteTestClock({this.string = const Omittable.absent(),
this.testHelpersTestClock = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const QuoteTestClock._({required this.rawValue, required this.string,
required this.testHelpersTestClock,});
  factory QuoteTestClock.fromJson(Object? json) => QuoteTestClock._(
...
if (testHelpersTestClock.isPresent) testHelpersTestClock.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is QuoteTestClock && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'QuoteTestClock(${toJson()})';
}
