...
factory PostSubscriptionsRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequest(
  ...
  billingThresholds: json['billing_thresholds'] != null ? PostSubscriptionsRequestBillingThresholds.fromJson(json['billing_thresholds']) : null,
  cancelAt: json['cancel_at'] != null ? PostSubscriptionsRequestCancelAt.fromJson(json['cancel_at']) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? PostSubscriptionsRequestDefaultTaxRates.fromJson(json['default_tax_rates']) : null,
  description: json['description'] as String?,
  discounts: json['discounts'] != null ? PostSubscriptionsRequestDiscounts.fromJson(json['discounts']) : null,
  ...
  metadata: json['metadata'] != null ? PostSubscriptionsRequestMetadata.fromJson(json['metadata']) : null,
  offSession: json['off_session'] as bool?,
  onBehalfOf: json['on_behalf_of'] != null ? PostSubscriptionsRequestOnBehalfOf.fromJson(json['on_behalf_of']) : null,
  ...
  pendingInvoiceItemInterval: json['pending_invoice_item_interval'] != null ? PostSubscriptionsRequestPendingInvoiceItemInterval.fromJson(json['pending_invoice_item_interval']) : null,
  ...
  trialEnd: json['trial_end'] != null ? PostSubscriptionsRequestTrialEnd.fromJson(json['trial_end']) : null,
