...
final class PostAccountsAccountRequestBusinessProfileMonthlyEstimatedRevenue {const PostAccountsAccountRequestBusinessProfileMonthlyEstimatedRevenue({required this.amount, required this.currency, });
