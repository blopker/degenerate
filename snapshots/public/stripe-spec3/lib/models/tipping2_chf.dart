...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Chf {const Tipping2Chf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Chf.fromJson(Map<String, dynamic> json) { return Tipping2Chf(
...
Tipping2Chf copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Chf(
...
@override String toString() { return 'Tipping2Chf(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
