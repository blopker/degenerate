...
final class PaymentIntentPaymentMethodOptionsAuBecsDebitSetupFutureUsage {const PaymentIntentPaymentMethodOptionsAuBecsDebitSetupFutureUsage._(this.value);
...
/// 
final class PaymentIntentPaymentMethodOptionsAuBecsDebit {const PaymentIntentPaymentMethodOptionsAuBecsDebit({this.setupFutureUsage, this.targetDate, });
