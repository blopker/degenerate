...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Dkk {const Tipping2Dkk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Dkk.fromJson(Map<String, dynamic> json) { return Tipping2Dkk(
...
Tipping2Dkk copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Dkk(
...
@override String toString() { return 'Tipping2Dkk(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
