...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_payment_method_configurations_request_payto_display_preference.dart';/// PayTo is a [real-time](https://docs.stripe.com/payments/real-time) payment method that enables customers in Australia to pay by providing their bank account details. Customers must accept a mandate authorizing you to debit their account. Check this [page](https://docs.stripe.com/payments/payto) for more details.
@immutable final class PostPaymentMethodConfigurationsRequestPayto {const PostPaymentMethodConfigurationsRequestPayto({this.displayPreference});
