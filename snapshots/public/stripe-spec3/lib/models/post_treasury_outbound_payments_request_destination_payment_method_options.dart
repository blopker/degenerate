...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_treasury_outbound_payments_request_destination_payment_method_options_us_bank_account.dart';/// Payment method-specific configuration for this OutboundPayment.
@immutable final class PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions {const PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions({this.usBankAccount});
...
factory PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions.fromJson(Map<String, dynamic> json) {return PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptions(
  usBankAccount: json['us_bank_account'] != null ? PostTreasuryOutboundPaymentsRequestDestinationPaymentMethodOptionsUsBankAccount.fromJson(json['us_bank_account']) : null,
);}
