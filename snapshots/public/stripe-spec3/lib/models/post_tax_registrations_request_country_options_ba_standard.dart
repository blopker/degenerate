...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsBaStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsBaStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsBaStandard {const PostTaxRegistrationsRequestCountryOptionsBaStandard({this.placeOfSupplyScheme});
