...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingHuf {const TippingHuf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingHuf.fromJson(Map<String, dynamic> json) { return TippingHuf(
...
TippingHuf copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingHuf(
...
@override String toString() { return 'TippingHuf(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
