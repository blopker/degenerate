...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingHuf {const TippingHuf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
