...
/// 
final class PaymentMethodDetailsAuBecsDebit {const PaymentMethodDetailsAuBecsDebit({this.bsbNumber, this.expectedDebitDate, this.fingerprint, this.last4, this.mandate, });
