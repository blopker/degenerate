...
final class PostPaymentMethodConfigurationsConfigurationRequestKakaoPayDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestKakaoPayDisplayPreference({this.preference});
