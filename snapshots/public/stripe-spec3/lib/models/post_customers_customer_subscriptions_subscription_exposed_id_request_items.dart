...
factory PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems(
  ...
  discounts: json['discounts'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsDiscounts.fromJson(json['discounts']) : null,
  id: json['id'] as String?,
  metadata: json['metadata'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsMetadata.fromJson(json['metadata']) : null,
