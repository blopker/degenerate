...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'item_billing_thresholds_param2.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_billing_thresholds.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_discounts.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_discounts_variant1.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_metadata.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_price_data.dart';import 'post_customers_customer_subscriptions_subscription_exposed_id_request_items_tax_rates.dart';final class PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems {const PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems({this.billingThresholds, this.clearUsage, this.deleted, this.discounts, this.id, this.metadata, this.price, this.priceData, this.quantity, this.taxRates, });
...
factory PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItems(
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => ItemBillingThresholdsParam2.fromJson(v as Map<String, dynamic>), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsBillingThresholdsVariant2.fromJson(v as String),) : null,
  clearUsage: json['clear_usage'] as bool?,
  deleted: json['deleted'] as bool?,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsDiscountsVariant2.fromJson(v as String),) : null,
  id: json['id'] as String?,
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsMetadataVariant2.fromJson(v as String),) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), fromB: (v) => PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsTaxRatesVariant2.fromJson(v as String),) : null,
); }
...
final PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsDiscounts? discounts;

final String? id;

final PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsMetadata? metadata;

final String? price;

final PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestItemsPriceData? priceData;
