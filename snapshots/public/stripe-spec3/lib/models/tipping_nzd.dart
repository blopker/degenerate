...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingNzd {const TippingNzd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingNzd.fromJson(Map<String, dynamic> json) { return TippingNzd(
...
TippingNzd copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingNzd(
...
@override String toString() { return 'TippingNzd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
