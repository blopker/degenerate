...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer.dart';import 'deleted_customer.dart';/// ID of the customer receiving the billing credits.
@immutable
final class BillingCreditGrantCustomer {
  const BillingCreditGrantCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const BillingCreditGrantCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory BillingCreditGrantCustomer.fromJson(Object? json) => BillingCreditGrantCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is BillingCreditGrantCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'BillingCreditGrantCustomer(${toJson()})';
}
