...
factory InvoiceLinesObject.fromJson(String json) { return switch (json) {
  'list' => list,
  _ => InvoiceLinesObject._(json),
}; }

static const InvoiceLinesObject list = InvoiceLinesObject._('list');

static const List<InvoiceLinesObject> values = [list];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is InvoiceLinesObject && other.value == value; } 
...
factory InvoiceLines.fromJson(Map<String, dynamic> json) { return InvoiceLines(
  ...
  object: InvoiceLinesObject.fromJson(json['object'] as String),
...
final InvoiceLinesObject object;
...
InvoiceLines copyWith({List<LineItem>? data, bool? hasMore, InvoiceLinesObject? object, String? url, }) { return InvoiceLines(
  data: data ?? this.data,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is InvoiceLines &&
          listEquals(data, other.data) &&
          hasMore == other.hasMore &&
          object == other.object &&
          url == other.url; } 
@override int get hashCode { return Object.hash(Object.hashAll(data), hasMore, object, url); } 
@override String toString() { return 'InvoiceLines(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
