...
final class PostPaymentMethodConfigurationsConfigurationRequestCryptoDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestCryptoDisplayPreference({this.preference});
