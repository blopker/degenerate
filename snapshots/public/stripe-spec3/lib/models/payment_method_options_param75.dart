...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PaymentMethodOptionsParam75CaptureMethod {const PaymentMethodOptionsParam75CaptureMethod._(this.value);
...
@immutable final class PaymentMethodOptionsParam75SetupFutureUsage {const PaymentMethodOptionsParam75SetupFutureUsage._(this.value);
...
@immutable final class PaymentMethodOptionsParam75 {const PaymentMethodOptionsParam75({this.captureMethod, this.preferredLocale, this.setupFutureUsage, });
