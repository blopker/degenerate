...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'card_generated_from_payment_method_details.dart';import 'payment_method_card_generated_card_setup_attempt.dart';/// 
...
factory PaymentMethodCardGeneratedCard.fromJson(Map<String, dynamic> json) {return PaymentMethodCardGeneratedCard(
  ...
  setupAttempt: json.containsKey('setup_attempt') ? Omittable(json['setup_attempt'] != null ? PaymentMethodCardGeneratedCardSetupAttempt.fromJson(json['setup_attempt']) : null) : const Omittable.absent(),
);}
