...
final class PostAccountsRequestBusinessProfileAnnualRevenue {const PostAccountsRequestBusinessProfileAnnualRevenue({required this.amount, required this.currency, required this.fiscalYearEnd, });
