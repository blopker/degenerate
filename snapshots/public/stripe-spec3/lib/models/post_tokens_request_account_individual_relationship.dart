...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_tokens_request_account_individual_relationship_percent_ownership.dart';@immutable final class PostTokensRequestAccountIndividualRelationship {const PostTokensRequestAccountIndividualRelationship({this.director, this.executive, this.owner, this.percentOwnership, this.title, });
