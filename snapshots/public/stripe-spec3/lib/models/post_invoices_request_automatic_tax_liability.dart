...
final class PostInvoicesRequestAutomaticTaxLiabilityType {const PostInvoicesRequestAutomaticTaxLiabilityType._(this.value);
...
final class PostInvoicesRequestAutomaticTaxLiability {const PostInvoicesRequestAutomaticTaxLiability({this.account, required this.type, });
