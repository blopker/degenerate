...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingGbp {const TippingGbp({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingGbp.fromJson(Map<String, dynamic> json) { return TippingGbp(
...
TippingGbp copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingGbp(
...
@override String toString() { return 'TippingGbp(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
