...
final class GetIssuingPhysicalBundlesResponseObject {const GetIssuingPhysicalBundlesResponseObject._(this.value);
...
/// 
final class GetIssuingPhysicalBundlesResponse {const GetIssuingPhysicalBundlesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
