...
@immutable
final class GetCustomersCustomerSourcesResponseData {
  const GetCustomersCustomerSourcesResponseData({this.bankAccount = const Omittable.absent(),
this.card = const Omittable.absent(),
this.source = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const GetCustomersCustomerSourcesResponseData._({required this.rawValue, required this.bankAccount,
required this.card,
required this.source,});
  factory GetCustomersCustomerSourcesResponseData.fromJson(Object? json) => GetCustomersCustomerSourcesResponseData._(
...
if (source.isPresent) source.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is GetCustomersCustomerSourcesResponseData && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'GetCustomersCustomerSourcesResponseData(${toJson()})';
}
