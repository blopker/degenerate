...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsPtStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsPtStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsPtStandard {const PostTaxRegistrationsRequestCountryOptionsPtStandard({required this.placeOfSupplyScheme});
