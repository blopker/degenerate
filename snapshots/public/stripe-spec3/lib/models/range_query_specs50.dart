...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class RangeQuerySpecs50 {const RangeQuerySpecs50({this.gt, this.gte, this.lt, this.lte, });
