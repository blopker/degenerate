...
final class PostBillingPortalConfigurationsConfigurationRequestFeaturesInvoiceHistory {const PostBillingPortalConfigurationsConfigurationRequestFeaturesInvoiceHistory({required this.enabled});
