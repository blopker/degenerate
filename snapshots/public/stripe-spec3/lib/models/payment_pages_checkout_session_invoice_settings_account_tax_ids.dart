...
final class PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds {
  const PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds({this.string = const Omittable.absent(),
this.taxId = const Omittable.absent(),
this.deletedTaxId = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds._({required this.rawValue, required this.string,
required this.taxId,
required this.deletedTaxId,});
  factory PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds.fromJson(Object? json) => PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds._(
...
if (deletedTaxId.isPresent) deletedTaxId.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds(${toJson()})';
}
