...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payment_links_resource_transfer_data_destination.dart';/// 
...
factory PaymentLinksResourceTransferData.fromJson(Map<String, dynamic> json) {return PaymentLinksResourceTransferData(
  ...
  destination: PaymentLinksResourceTransferDataDestination.fromJson(json['destination']),
);}
