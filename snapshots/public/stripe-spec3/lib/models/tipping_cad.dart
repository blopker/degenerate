...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingCad {const TippingCad({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingCad.fromJson(Map<String, dynamic> json) { return TippingCad(
...
TippingCad copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingCad(
...
@override String toString() { return 'TippingCad(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
