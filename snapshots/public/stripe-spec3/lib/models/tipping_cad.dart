...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingCad {const TippingCad({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
