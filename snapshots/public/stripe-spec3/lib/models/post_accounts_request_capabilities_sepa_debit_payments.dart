...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostAccountsRequestCapabilitiesSepaDebitPayments {const PostAccountsRequestCapabilitiesSepaDebitPayments({this.requested});
