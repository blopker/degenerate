...
final class PaymentMethodOptionsZipSetupFutureUsage {const PaymentMethodOptionsZipSetupFutureUsage._(this.value);
...
static const List<PaymentMethodOptionsZipSetupFutureUsage> values = [none];
...
/// 
final class PaymentMethodOptionsZip {const PaymentMethodOptionsZip({this.setupFutureUsage});
