...
PostIssuingPersonalizationDesignsRequestPreferences copyWith({bool? isDefault}) { return PostIssuingPersonalizationDesignsRequestPreferences(
...
@override String toString() { return 'PostIssuingPersonalizationDesignsRequestPreferences(isDefault: $isDefault)'; } 
 }
