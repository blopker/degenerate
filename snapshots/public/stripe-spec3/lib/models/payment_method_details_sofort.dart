...
factory PaymentMethodDetailsSofort.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsSofort(
  ...
  generatedSepaDebit: json.containsKey('generated_sepa_debit') ? Omittable(json['generated_sepa_debit'] != null ? PaymentMethodDetailsSofortGeneratedSepaDebit.fromJson(json['generated_sepa_debit']) : null) : const Omittable.absent(),
  generatedSepaDebitMandate: json.containsKey('generated_sepa_debit_mandate') ? Omittable(json['generated_sepa_debit_mandate'] != null ? PaymentMethodDetailsSofortGeneratedSepaDebitMandate.fromJson(json['generated_sepa_debit_mandate']) : null) : const Omittable.absent(),
