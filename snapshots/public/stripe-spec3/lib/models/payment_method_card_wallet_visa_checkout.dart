...
@immutable final class PaymentMethodCardWalletVisaCheckout {const PaymentMethodCardWalletVisaCheckout({this.billingAddress = const Omittable.absent(), this.email = const Omittable.absent(), this.name = const Omittable.absent(), this.shippingAddress = const Omittable.absent(), });
...
PaymentMethodCardWalletVisaCheckout copyWith({Omittable<Address?>? billingAddress, Omittable<String?>? email, Omittable<String?>? name, Omittable<Address?>? shippingAddress, }) { return PaymentMethodCardWalletVisaCheckout(
