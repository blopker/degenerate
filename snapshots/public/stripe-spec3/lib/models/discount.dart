...
factory Discount.fromJson(Map<String, dynamic> json) { return Discount(
  ...
  promotionCode: json.containsKey('promotion_code') ? Omittable(json['promotion_code'] != null ? DiscountPromotionCode.fromJson(json['promotion_code']) : null) : const Omittable.absent(),
