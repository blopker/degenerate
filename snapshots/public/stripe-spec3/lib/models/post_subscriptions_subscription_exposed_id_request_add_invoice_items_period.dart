...
factory PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriod.fromJson(Map<String, dynamic> json) { return PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriod(
  ...
  start: PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriodStart.fromJson(json['start'] as Map<String, dynamic>),
); }

final PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriodEnd end;

final PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriodStart start;
...
PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriod copyWith({PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriodEnd? end, PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriodStart? start, }) { return PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriod(
  end: end ?? this.end,
...
@override String toString() { return 'PostSubscriptionsSubscriptionExposedIdRequestAddInvoiceItemsPeriod(end: $end, start: $start)'; } 
 }
