...
/// 
final class TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax {const TaxProductRegistrationsResourceCountryOptionsUsLocalLeaseTax({required this.jurisdiction});
