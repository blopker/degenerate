...
/// 
@immutable final class PaymentMethodDetailsFpx {const PaymentMethodDetailsFpx({required this.bank, this.transactionId = const Omittable.absent(), });
...
PaymentMethodDetailsFpx copyWith({PaymentMethodDetailsFpxBank? bank, Omittable<String?>? transactionId, }) { return PaymentMethodDetailsFpx(
  bank: bank ?? this.bank,
