...
@immutable
final class InvoiceitemDiscounts {
  const InvoiceitemDiscounts({this.string = const Omittable.absent(),
this.discount = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InvoiceitemDiscounts._({required this.rawValue, required this.string,
required this.discount,});
  factory InvoiceitemDiscounts.fromJson(Object? json) => InvoiceitemDiscounts._(
...
if (discount.isPresent) discount.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InvoiceitemDiscounts && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InvoiceitemDiscounts(${toJson()})';
}
