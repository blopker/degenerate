...
import 'linked_account_options_common.dart';import 'payment_method_options_us_bank_account_mandate_options.dart';/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
/// 
...
final class PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage {const PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage._(this.value);
...
final class PaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurpose {const PaymentIntentPaymentMethodOptionsUsBankAccountTransactionPurpose._(this.value);
