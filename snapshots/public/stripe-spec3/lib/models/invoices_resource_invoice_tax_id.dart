...
@override String toString() { return 'InvoicesResourceInvoiceTaxIdType($value)'; } 
 }
/// 
@immutable final class InvoicesResourceInvoiceTaxId {const InvoicesResourceInvoiceTaxId({required this.type, this.value = const Omittable.absent(), });
...
InvoicesResourceInvoiceTaxId copyWith({InvoicesResourceInvoiceTaxIdType? type, Omittable<String?>? value, }) { return InvoicesResourceInvoiceTaxId(
  type: type ?? this.type,
