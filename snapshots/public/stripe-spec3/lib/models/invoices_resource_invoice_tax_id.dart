...
final class InvoicesResourceInvoiceTaxIdType {const InvoicesResourceInvoiceTaxIdType._(this.value);
...
/// 
final class InvoicesResourceInvoiceTaxId {const InvoicesResourceInvoiceTaxId({required this.type, this.value, });
