...
factory StackableDiscountWithDiscountSettingsAndDiscountEnd.fromJson(Map<String, dynamic> json) { return StackableDiscountWithDiscountSettingsAndDiscountEnd(
  coupon: json.containsKey('coupon') ? Omittable(json['coupon'] != null ? StackableDiscountWithDiscountSettingsAndDiscountEndCoupon.fromJson(json['coupon']) : null) : const Omittable.absent(),
  discount: json.containsKey('discount') ? Omittable(json['discount'] != null ? StackableDiscountWithDiscountSettingsAndDiscountEndDiscount.fromJson(json['discount']) : null) : const Omittable.absent(),
  promotionCode: json.containsKey('promotion_code') ? Omittable(json['promotion_code'] != null ? StackableDiscountWithDiscountSettingsAndDiscountEndPromotionCode.fromJson(json['promotion_code']) : null) : const Omittable.absent(),
); }
