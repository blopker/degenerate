...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'stackable_discount_with_discount_settings_coupon.dart';import 'stackable_discount_with_discount_settings_discount.dart';import 'stackable_discount_with_discount_settings_promotion_code.dart';/// 
...
factory StackableDiscountWithDiscountSettings.fromJson(Map<String, dynamic> json) { return StackableDiscountWithDiscountSettings(
  coupon: json.containsKey('coupon') ? Omittable(json['coupon'] != null ? StackableDiscountWithDiscountSettingsCoupon.fromJson(json['coupon']) : null) : const Omittable.absent(),
  discount: json.containsKey('discount') ? Omittable(json['discount'] != null ? StackableDiscountWithDiscountSettingsDiscount.fromJson(json['discount']) : null) : const Omittable.absent(),
  promotionCode: json.containsKey('promotion_code') ? Omittable(json['promotion_code'] != null ? StackableDiscountWithDiscountSettingsPromotionCode.fromJson(json['promotion_code']) : null) : const Omittable.absent(),
); }
