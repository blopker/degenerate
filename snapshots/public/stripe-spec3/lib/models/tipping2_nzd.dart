...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Nzd {const Tipping2Nzd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Nzd.fromJson(Map<String, dynamic> json) { return Tipping2Nzd(
...
Tipping2Nzd copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Nzd(
...
@override String toString() { return 'Tipping2Nzd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
