...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Nzd {const Tipping2Nzd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
