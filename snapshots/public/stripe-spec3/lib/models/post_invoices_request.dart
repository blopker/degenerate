...
factory PostInvoicesRequest.fromJson(Map<String, dynamic> json) {return PostInvoicesRequest(
  ...
  customFields: json['custom_fields'] != null ? PostInvoicesRequestCustomFields.fromJson(json['custom_fields']) : null,
  ...
  discounts: json['discounts'] != null ? PostInvoicesRequestDiscounts.fromJson(json['discounts']) : null,
  ...
  metadata: json['metadata'] != null ? PostInvoicesRequestMetadata.fromJson(json['metadata']) : null,
