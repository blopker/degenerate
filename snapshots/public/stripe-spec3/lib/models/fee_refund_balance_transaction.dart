...
@immutable
final class FeeRefundBalanceTransaction {
  const FeeRefundBalanceTransaction({this.string = const Omittable.absent(),
this.balanceTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const FeeRefundBalanceTransaction._({required this.rawValue, required this.string,
required this.balanceTransaction,});
  factory FeeRefundBalanceTransaction.fromJson(Object? json) => FeeRefundBalanceTransaction._(
...
if (balanceTransaction.isPresent) balanceTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is FeeRefundBalanceTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'FeeRefundBalanceTransaction(${toJson()})';
}
