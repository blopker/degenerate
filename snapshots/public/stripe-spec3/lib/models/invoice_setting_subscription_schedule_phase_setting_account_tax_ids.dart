...
@immutable
final class InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds {
  const InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds({this.string = const Omittable.absent(),
this.taxId = const Omittable.absent(),
this.deletedTaxId = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds._({required this.rawValue, required this.string,
required this.taxId,
required this.deletedTaxId,});
  factory InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds.fromJson(Object? json) => InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds._(
...
if (deletedTaxId.isPresent) deletedTaxId.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InvoiceSettingSubscriptionSchedulePhaseSettingAccountTaxIds(${toJson()})';
}
