...
@immutable final class IssuingAuthorizationAmountDetails {const IssuingAuthorizationAmountDetails({this.atmFee = const Omittable.absent(), this.cashbackAmount = const Omittable.absent(), });
...
IssuingAuthorizationAmountDetails copyWith({Omittable<int?>? atmFee, Omittable<int?>? cashbackAmount, }) { return IssuingAuthorizationAmountDetails(
