...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'bank_account.dart';import 'card.dart';import 'source.dart';/// The [source object](https://docs.stripe.com/api/sources/object) for errors returned on a request involving a source.
@immutable
final class ErrorsSource {
  const ErrorsSource({this.bankAccount = const Omittable.absent(),
this.card = const Omittable.absent(),
this.source = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const ErrorsSource._({required this.rawValue, required this.bankAccount,
required this.card,
required this.source,});
  factory ErrorsSource.fromJson(Object? json) => ErrorsSource._(
...
if (source.isPresent) source.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is ErrorsSource && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'ErrorsSource(${toJson()})';
}
