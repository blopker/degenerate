...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsConfigurationRequestBoletoDisplayPreferencePreference {const PostPaymentMethodConfigurationsConfigurationRequestBoletoDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsConfigurationRequestBoletoDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestBoletoDisplayPreference({this.preference});
