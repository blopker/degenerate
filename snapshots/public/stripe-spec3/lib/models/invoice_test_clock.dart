...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'test_helpers_test_clock.dart';/// ID of the test clock this invoice belongs to.
@immutable
final class InvoiceTestClock {
  const InvoiceTestClock({this.string = const Omittable.absent(),
this.testHelpersTestClock = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InvoiceTestClock._({required this.rawValue, required this.string,
required this.testHelpersTestClock,});
  factory InvoiceTestClock.fromJson(Object? json) => InvoiceTestClock._(
...
if (testHelpersTestClock.isPresent) testHelpersTestClock.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InvoiceTestClock && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InvoiceTestClock(${toJson()})';
}
