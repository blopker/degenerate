...
factory PostPaymentIntentsIntentRequest.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentRequest(
  ...
  amountDetails: json['amount_details'] != null ? PostPaymentIntentsIntentRequestAmountDetails.fromJson(json['amount_details']) : null,
  applicationFeeAmount: json['application_fee_amount'] != null ? PostPaymentIntentsIntentRequestApplicationFeeAmount.fromJson(json['application_fee_amount']) : null,
  ...
  excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null ? PostPaymentIntentsIntentRequestExcludedPaymentMethodTypes.fromJson(json['excluded_payment_method_types']) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  hooks: json['hooks'] != null ? PostPaymentIntentsIntentRequestHooks.fromJson(json['hooks'] as Map<String, dynamic>) : null,
  metadata: json['metadata'] != null ? PostPaymentIntentsIntentRequestMetadata.fromJson(json['metadata']) : null,
  paymentDetails: json['payment_details'] != null ? PostPaymentIntentsIntentRequestPaymentDetails.fromJson(json['payment_details']) : null,
  ...
  receiptEmail: json['receipt_email'] != null ? PostPaymentIntentsIntentRequestReceiptEmail.fromJson(json['receipt_email']) : null,
  ...
  shipping: json['shipping'] != null ? PostPaymentIntentsIntentRequestShipping.fromJson(json['shipping']) : null,
