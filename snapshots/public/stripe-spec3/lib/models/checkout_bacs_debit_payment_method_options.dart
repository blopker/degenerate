...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'checkout_payment_method_options_mandate_options_bacs_debit.dart';/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
/// 
...
@immutable final class CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage {const CheckoutBacsDebitPaymentMethodOptionsSetupFutureUsage._(this.value);
...
/// 
@immutable final class CheckoutBacsDebitPaymentMethodOptions {const CheckoutBacsDebitPaymentMethodOptions({this.mandateOptions, this.setupFutureUsage, this.targetDate, });
