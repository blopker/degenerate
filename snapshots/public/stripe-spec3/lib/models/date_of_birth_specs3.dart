...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class DateOfBirthSpecs3 {const DateOfBirthSpecs3({required this.day, required this.month, required this.year, });
