...
final class PaymentMethodOptionsParam54SubscriptionsVariant1NextBilling {const PaymentMethodOptionsParam54SubscriptionsVariant1NextBilling({required this.amount, required this.date, });
