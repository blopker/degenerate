...
@immutable
final class DiscountCustomer {
  const DiscountCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DiscountCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory DiscountCustomer.fromJson(Object? json) => DiscountCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DiscountCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DiscountCustomer(${toJson()})';
}
