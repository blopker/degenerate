...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequest {const PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequest({this.expand, required this.incrementAmount, this.isAmountControllable, });
