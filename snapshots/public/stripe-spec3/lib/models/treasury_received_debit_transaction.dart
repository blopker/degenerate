...
@immutable
final class TreasuryReceivedDebitTransaction {
  const TreasuryReceivedDebitTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryReceivedDebitTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryReceivedDebitTransaction.fromJson(Object? json) => TreasuryReceivedDebitTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryReceivedDebitTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryReceivedDebitTransaction(${toJson()})';
}
