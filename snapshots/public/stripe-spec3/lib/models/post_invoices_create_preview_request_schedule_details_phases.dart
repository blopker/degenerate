...
factory PostInvoicesCreatePreviewRequestScheduleDetailsPhases.fromJson(Map<String, dynamic> json) {return PostInvoicesCreatePreviewRequestScheduleDetailsPhases(
  ...
  billingThresholds: json['billing_thresholds'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesBillingThresholds.fromJson(json['billing_thresholds']) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDefaultTaxRates.fromJson(json['default_tax_rates']) : null,
  description: json['description'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDescription.fromJson(json['description']) : null,
  discounts: json['discounts'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesDiscounts.fromJson(json['discounts']) : null,
  ...
  endDate: json['end_date'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesEndDate.fromJson(json['end_date']) : null,
  ...
  startDate: json['start_date'] != null ? PostInvoicesCreatePreviewRequestScheduleDetailsPhasesStartDate.fromJson(json['start_date']) : null,
