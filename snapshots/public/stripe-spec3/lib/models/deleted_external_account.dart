...
@immutable
final class DeletedExternalAccount {
  const DeletedExternalAccount({this.deletedBankAccount = const Omittable.absent(),
this.deletedCard = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DeletedExternalAccount._({required this.rawValue, required this.deletedBankAccount,
required this.deletedCard,});
  factory DeletedExternalAccount.fromJson(Object? json) => DeletedExternalAccount._(
...
if (deletedCard.isPresent) deletedCard.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DeletedExternalAccount && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DeletedExternalAccount(${toJson()})';
}
