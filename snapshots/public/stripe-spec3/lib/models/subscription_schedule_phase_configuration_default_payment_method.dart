...
@immutable
final class SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod {
  const SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod({this.string = const Omittable.absent(),
this.paymentMethod = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod._({required this.rawValue, required this.string,
required this.paymentMethod,});
  factory SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod.fromJson(Object? json) => SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod._(
...
if (paymentMethod.isPresent) paymentMethod.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod(${toJson()})';
}
