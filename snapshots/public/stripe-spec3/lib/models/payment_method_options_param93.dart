...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PaymentMethodOptionsParam93CaptureMethod {const PaymentMethodOptionsParam93CaptureMethod._(this.value);
...
@immutable final class PaymentMethodOptionsParam93SetupFutureUsage {const PaymentMethodOptionsParam93SetupFutureUsage._(this.value);
...
@immutable final class PaymentMethodOptionsParam93 {const PaymentMethodOptionsParam93({this.captureMethod, this.setupFutureUsage, });
