...
factory Invoiceitem.fromJson(Map<String, dynamic> json) { return Invoiceitem(
  ...
  parent: json.containsKey('parent') ? Omittable(json['parent'] != null ? BillingBillResourceInvoiceItemParentsInvoiceItemParent.fromJson(json['parent'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<List<InvoiceitemDiscounts>?> discounts;

/// Unique identifier for the object.
final String id;

/// The ID of the invoice this invoice item belongs to.
final Omittable<InvoiceitemInvoice?> invoice;
...
final Omittable<BillingBillResourceInvoiceItemParentsInvoiceItemParent?> parent;
