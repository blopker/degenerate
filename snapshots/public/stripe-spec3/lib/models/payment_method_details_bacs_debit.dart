...
/// 
final class PaymentMethodDetailsBacsDebit {const PaymentMethodDetailsBacsDebit({this.expectedDebitDate, this.fingerprint, this.last4, this.mandate, this.sortCode, });
