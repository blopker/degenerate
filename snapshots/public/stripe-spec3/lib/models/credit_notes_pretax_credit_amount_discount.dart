...
@immutable
final class CreditNotesPretaxCreditAmountDiscount {
  const CreditNotesPretaxCreditAmountDiscount({this.string = const Omittable.absent(),
this.discount = const Omittable.absent(),
this.deletedDiscount = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const CreditNotesPretaxCreditAmountDiscount._({required this.rawValue, required this.string,
required this.discount,
required this.deletedDiscount,});
  factory CreditNotesPretaxCreditAmountDiscount.fromJson(Object? json) => CreditNotesPretaxCreditAmountDiscount._(
...
if (deletedDiscount.isPresent) deletedDiscount.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is CreditNotesPretaxCreditAmountDiscount && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'CreditNotesPretaxCreditAmountDiscount(${toJson()})';
}
