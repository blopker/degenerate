...
factory PostPaymentIntentsRequest.fromJson(Map<String, dynamic> json) {return PostPaymentIntentsRequest(
  ...
  mandateData: json['mandate_data'] != null ? PostPaymentIntentsRequestMandateData.fromJson(json['mandate_data']) : null,
  metadata: (json['metadata'] as Map<String, dynamic>?)?.map((k, v) => MapEntry(k, v as String)),
  offSession: json['off_session'] != null ? PostPaymentIntentsRequestOffSession.fromJson(json['off_session']) : null,
