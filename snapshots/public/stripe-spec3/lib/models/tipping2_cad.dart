...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Cad {const Tipping2Cad({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
