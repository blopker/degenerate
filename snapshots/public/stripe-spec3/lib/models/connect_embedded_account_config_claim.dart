...
import 'connect_embedded_account_features_claim.dart';/// 
final class ConnectEmbeddedAccountConfigClaim {const ConnectEmbeddedAccountConfigClaim({required this.enabled, required this.features, });
