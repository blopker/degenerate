...
final class PostAccountsAccountRequestBusinessProfileAnnualRevenue {const PostAccountsAccountRequestBusinessProfileAnnualRevenue({required this.amount, required this.currency, required this.fiscalYearEnd, });
