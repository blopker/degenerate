...
factory SubscriptionSchedulesResourceDefaultSettings.fromJson(Map<String, dynamic> json) {return SubscriptionSchedulesResourceDefaultSettings(
  ...
  defaultPaymentMethod: json.containsKey('default_payment_method') ? Omittable(json['default_payment_method'] != null ? SubscriptionSchedulesResourceDefaultSettingsDefaultPaymentMethod.fromJson(json['default_payment_method']) : null) : const Omittable.absent(),
