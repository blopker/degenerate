...
import 'package:collection/collection.dart';final class PostInvoicesInvoiceAttachPaymentRequest {const PostInvoicesInvoiceAttachPaymentRequest({this.expand, this.paymentIntent, this.paymentRecord, });
