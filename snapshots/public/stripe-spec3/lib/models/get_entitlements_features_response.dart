...
final class GetEntitlementsFeaturesResponseObject {const GetEntitlementsFeaturesResponseObject._(this.value);
...
/// 
final class GetEntitlementsFeaturesResponse {const GetEntitlementsFeaturesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
