...
@immutable final class PostCustomersCustomerSubscriptionsRequestTransferData {const PostCustomersCustomerSubscriptionsRequestTransferData({required this.destination, this.amountPercent, });
