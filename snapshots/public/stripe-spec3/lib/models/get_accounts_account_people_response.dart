...
final class GetAccountsAccountPeopleResponseObject {const GetAccountsAccountPeopleResponseObject._(this.value);
...
/// 
final class GetAccountsAccountPeopleResponse {const GetAccountsAccountPeopleResponse({required this.data, required this.hasMore, required this.object, required this.url, });
...
final GetAccountsAccountPeopleResponseObject object;
