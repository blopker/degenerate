...
final class SubscriptionAutomaticTaxLiability {const SubscriptionAutomaticTaxLiability({this.connectAccountReference});

factory SubscriptionAutomaticTaxLiability.fromJson(Map<String, dynamic> json) { return SubscriptionAutomaticTaxLiability(
