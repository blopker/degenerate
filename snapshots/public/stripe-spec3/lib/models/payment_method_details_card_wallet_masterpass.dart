...
@immutable final class PaymentMethodDetailsCardWalletMasterpass {const PaymentMethodDetailsCardWalletMasterpass({this.billingAddress = const Omittable.absent(), this.email = const Omittable.absent(), this.name = const Omittable.absent(), this.shippingAddress = const Omittable.absent(), });
...
PaymentMethodDetailsCardWalletMasterpass copyWith({Omittable<Address?>? billingAddress, Omittable<String?>? email, Omittable<String?>? name, Omittable<Address?>? shippingAddress, }) { return PaymentMethodDetailsCardWalletMasterpass(
