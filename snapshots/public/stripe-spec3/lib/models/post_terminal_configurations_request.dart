...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_terminal_configurations_request_bbpos_wisepad3.dart';import 'post_terminal_configurations_request_bbpos_wisepos_e.dart';import 'post_terminal_configurations_request_cellular.dart';import 'post_terminal_configurations_request_offline.dart';import 'post_terminal_configurations_request_reboot_window.dart';import 'post_terminal_configurations_request_stripe_s700.dart';import 'post_terminal_configurations_request_stripe_s710.dart';import 'post_terminal_configurations_request_tipping.dart';import 'post_terminal_configurations_request_verifone_p400.dart';import 'post_terminal_configurations_request_wifi.dart';@immutable final class PostTerminalConfigurationsRequest {const PostTerminalConfigurationsRequest({this.bbposWisepad3, this.bbposWiseposE, this.cellular, this.expand, this.name, this.offline, this.rebootWindow, this.stripeS700, this.stripeS710, this.tipping, this.verifoneP400, this.wifi, });
...
factory PostTerminalConfigurationsRequest.fromJson(Map<String, dynamic> json) { return PostTerminalConfigurationsRequest(
  ...
  cellular: json['cellular'] != null ? PostTerminalConfigurationsRequestCellular.fromJson(json['cellular']) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  name: json['name'] as String?,
  offline: json['offline'] != null ? PostTerminalConfigurationsRequestOffline.fromJson(json['offline']) : null,
  ...
  tipping: json['tipping'] != null ? PostTerminalConfigurationsRequestTipping.fromJson(json['tipping']) : null,
  ...
  wifi: json['wifi'] != null ? PostTerminalConfigurationsRequestWifi.fromJson(json['wifi']) : null,
); }
