...
final class QuoteOnBehalfOf {
  const QuoteOnBehalfOf({this.string = const Omittable.absent(),
this.account = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const QuoteOnBehalfOf._({required this.rawValue, required this.string,
required this.account,});
  factory QuoteOnBehalfOf.fromJson(Object? json) => QuoteOnBehalfOf._(
...
if (account.isPresent) account.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is QuoteOnBehalfOf && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'QuoteOnBehalfOf(${toJson()})';
}
