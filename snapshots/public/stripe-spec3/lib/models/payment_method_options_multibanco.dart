...
@immutable final class PaymentMethodOptionsMultibancoSetupFutureUsage {const PaymentMethodOptionsMultibancoSetupFutureUsage._(this.value);
...
/// 
@immutable final class PaymentMethodOptionsMultibanco {const PaymentMethodOptionsMultibanco({this.setupFutureUsage});
