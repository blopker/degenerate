...
final class PostTaxRegistrationsRequestCountryOptionsBeStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsBeStandardPlaceOfSupplyScheme._(this.value);
...
final class PostTaxRegistrationsRequestCountryOptionsBeStandard {const PostTaxRegistrationsRequestCountryOptionsBeStandard({required this.placeOfSupplyScheme});
