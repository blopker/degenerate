...
@immutable final class PaymentMethodDetailsCardChecks {const PaymentMethodDetailsCardChecks({this.addressLine1Check = const Omittable.absent(), this.addressPostalCodeCheck = const Omittable.absent(), this.cvcCheck = const Omittable.absent(), });
...
PaymentMethodDetailsCardChecks copyWith({Omittable<String?>? addressLine1Check, Omittable<String?>? addressPostalCodeCheck, Omittable<String?>? cvcCheck, }) { return PaymentMethodDetailsCardChecks(
