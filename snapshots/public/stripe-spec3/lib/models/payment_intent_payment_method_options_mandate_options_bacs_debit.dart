...
/// 
final class PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit {const PaymentIntentPaymentMethodOptionsMandateOptionsBacsDebit({this.referencePrefix});
