...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Myr {const Tipping2Myr({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Myr.fromJson(Map<String, dynamic> json) { return Tipping2Myr(
...
Tipping2Myr copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Myr(
...
@override String toString() { return 'Tipping2Myr(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
