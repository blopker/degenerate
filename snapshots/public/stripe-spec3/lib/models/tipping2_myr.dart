...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Myr {const Tipping2Myr({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
