...
final class PostTokensRequestAccountIndividualAddressKana {const PostTokensRequestAccountIndividualAddressKana({this.city, this.country, this.line1, this.line2, this.postalCode, this.state, this.town, });
