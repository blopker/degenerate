...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Usd {const Tipping2Usd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Usd.fromJson(Map<String, dynamic> json) { return Tipping2Usd(
...
Tipping2Usd copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Usd(
...
@override String toString() { return 'Tipping2Usd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
