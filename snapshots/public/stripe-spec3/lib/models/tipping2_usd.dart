...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Usd {const Tipping2Usd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
