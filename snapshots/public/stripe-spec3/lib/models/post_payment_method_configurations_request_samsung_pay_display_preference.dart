...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsRequestSamsungPayDisplayPreferencePreference {const PostPaymentMethodConfigurationsRequestSamsungPayDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsRequestSamsungPayDisplayPreference {const PostPaymentMethodConfigurationsRequestSamsungPayDisplayPreference({this.preference});
