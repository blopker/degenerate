...
import 'post_invoices_create_preview_request_subscription_details_items_price_data_recurring.dart';final class PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior {const PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior._(this.value);
...
static const PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior inclusive = PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior._('inclusive');

static const PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior unspecified = PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior._('unspecified');

static const List<PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior> values = [exclusive, inclusive, unspecified];
...
final class PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceData {const PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceData({required this.currency, required this.product, required this.recurring, this.taxBehavior, this.unitAmount, this.unitAmountDecimal, });
...
final PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataRecurring recurring;

final PostInvoicesCreatePreviewRequestSubscriptionDetailsItemsPriceDataTaxBehavior? taxBehavior;
