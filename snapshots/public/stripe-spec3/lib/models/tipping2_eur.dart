...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Eur {const Tipping2Eur({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
