...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Eur {const Tipping2Eur({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Eur.fromJson(Map<String, dynamic> json) { return Tipping2Eur(
...
Tipping2Eur copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Eur(
...
@override String toString() { return 'Tipping2Eur(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
