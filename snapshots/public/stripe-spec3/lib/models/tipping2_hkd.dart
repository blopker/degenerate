...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Hkd {const Tipping2Hkd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
