...
factory PaymentIntent.fromJson(Map<String, dynamic> json) { return PaymentIntent(
  ...
  amountDetails: json['amount_details'] != null ? PaymentIntentAmountDetails.fromJson(json['amount_details']) : null,
  amountReceived: json['amount_received'] != null ? (json['amount_received'] as num).toInt() : null,
  application: json.containsKey('application') ? Omittable(json['application'] != null ? PaymentIntentApplication.fromJson(json['application']) : null) : const Omittable.absent(),
  ...
  customer: json.containsKey('customer') ? Omittable(json['customer'] != null ? PaymentIntentCustomer.fromJson(json['customer']) : null) : const Omittable.absent(),
  ...
  latestCharge: json.containsKey('latest_charge') ? Omittable(json['latest_charge'] != null ? PaymentIntentLatestCharge.fromJson(json['latest_charge']) : null) : const Omittable.absent(),
  ...
  onBehalfOf: json.containsKey('on_behalf_of') ? Omittable(json['on_behalf_of'] != null ? PaymentIntentOnBehalfOf.fromJson(json['on_behalf_of']) : null) : const Omittable.absent(),
  ...
  paymentMethod: json.containsKey('payment_method') ? Omittable(json['payment_method'] != null ? PaymentIntentPaymentMethod.fromJson(json['payment_method']) : null) : const Omittable.absent(),
  ...
  review: json.containsKey('review') ? Omittable(json['review'] != null ? PaymentIntentReview.fromJson(json['review']) : null) : const Omittable.absent(),
