...
/// 
@immutable final class BankConnectionsResourceBalanceRefresh {const BankConnectionsResourceBalanceRefresh({required this.lastAttemptedAt, required this.status, this.nextRefreshAvailableAt, });
