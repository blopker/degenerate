...
PostInvoicesInvoiceAddLinesRequestLinesPriceDataProductData copyWith({String Function()? description, List<String> Function()? images, Map<String, String> Function()? metadata, String? name, String Function()? taxCode, String Function()? unitLabel, }) { return PostInvoicesInvoiceAddLinesRequestLinesPriceDataProductData(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostInvoicesInvoiceAddLinesRequestLinesPriceDataProductData &&
...
@override String toString() { return 'PostInvoicesInvoiceAddLinesRequestLinesPriceDataProductData(description: $description, images: $images, metadata: $metadata, name: $name, taxCode: $taxCode, unitLabel: $unitLabel)'; } 
 }
