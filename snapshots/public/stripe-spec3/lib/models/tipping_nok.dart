...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingNok {const TippingNok({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
