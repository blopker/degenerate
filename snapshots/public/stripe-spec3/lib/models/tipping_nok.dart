...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingNok {const TippingNok({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingNok.fromJson(Map<String, dynamic> json) { return TippingNok(
...
TippingNok copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingNok(
...
@override String toString() { return 'TippingNok(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
