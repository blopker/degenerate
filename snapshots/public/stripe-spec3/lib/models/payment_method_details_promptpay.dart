...
@immutable final class PaymentMethodDetailsPromptpay {const PaymentMethodDetailsPromptpay({this.reference = const Omittable.absent()});
...
PaymentMethodDetailsPromptpay copyWith({Omittable<String?>? reference}) { return PaymentMethodDetailsPromptpay(
