...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Nok {const Tipping2Nok({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Nok.fromJson(Map<String, dynamic> json) { return Tipping2Nok(
...
Tipping2Nok copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Nok(
...
@override String toString() { return 'Tipping2Nok(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
