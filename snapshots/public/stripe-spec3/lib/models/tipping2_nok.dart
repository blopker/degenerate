...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Nok {const Tipping2Nok({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
