...
final class CreditNoteLinesObject {const CreditNoteLinesObject._(this.value);
...
final class CreditNoteLines {const CreditNoteLines({required this.data, required this.hasMore, required this.object, required this.url, });
