...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'application.dart';import 'deleted_application.dart';/// The ID of the Connect application that created the Payment Link.
@immutable
final class PaymentLinkApplication {
  const PaymentLinkApplication({this.string = const Omittable.absent(),
this.application = const Omittable.absent(),
this.deletedApplication = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PaymentLinkApplication._({required this.rawValue, required this.string,
required this.application,
required this.deletedApplication,});
  factory PaymentLinkApplication.fromJson(Object? json) => PaymentLinkApplication._(
...
if (deletedApplication.isPresent) deletedApplication.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PaymentLinkApplication && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PaymentLinkApplication(${toJson()})';
}
