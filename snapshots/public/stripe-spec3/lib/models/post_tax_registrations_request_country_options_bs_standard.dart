...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsBsStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsBsStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsBsStandard {const PostTaxRegistrationsRequestCountryOptionsBsStandard({this.placeOfSupplyScheme});
