...
final class AutomaticTaxLiability {const AutomaticTaxLiability({this.connectAccountReference});

factory AutomaticTaxLiability.fromJson(Map<String, dynamic> json) { return AutomaticTaxLiability(
