...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingEur {const TippingEur({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
