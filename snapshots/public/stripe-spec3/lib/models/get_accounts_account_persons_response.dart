...
final class GetAccountsAccountPersonsResponseObject {const GetAccountsAccountPersonsResponseObject._(this.value);
...
/// 
final class GetAccountsAccountPersonsResponse {const GetAccountsAccountPersonsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
...
@override String toString() { return 'GetAccountsAccountPersonsResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
