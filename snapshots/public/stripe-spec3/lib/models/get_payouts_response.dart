...
@immutable final class GetPayoutsResponseObject {const GetPayoutsResponseObject._(this.value);
...
/// 
@immutable final class GetPayoutsResponse {const GetPayoutsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
