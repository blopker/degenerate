...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingSgd {const TippingSgd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingSgd.fromJson(Map<String, dynamic> json) { return TippingSgd(
...
TippingSgd copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingSgd(
...
@override String toString() { return 'TippingSgd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
