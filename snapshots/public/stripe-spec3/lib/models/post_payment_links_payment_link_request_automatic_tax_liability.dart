...
final class PostPaymentLinksPaymentLinkRequestAutomaticTaxLiability {const PostPaymentLinksPaymentLinkRequestAutomaticTaxLiability({this.account, required this.type, });
