...
@immutable final class GelatoDataVerifiedOutputsDate {const GelatoDataVerifiedOutputsDate({this.day = const Omittable.absent(), this.month = const Omittable.absent(), this.year = const Omittable.absent(), });
...
GelatoDataVerifiedOutputsDate copyWith({Omittable<int?>? day, Omittable<int?>? month, Omittable<int?>? year, }) { return GelatoDataVerifiedOutputsDate(
  day: day ?? this.day,
...
@override String toString() { return 'GelatoDataVerifiedOutputsDate(day: $day, month: $month, year: $year)'; } 
 }
