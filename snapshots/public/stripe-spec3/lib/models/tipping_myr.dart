...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingMyr {const TippingMyr({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
