...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingMyr {const TippingMyr({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingMyr.fromJson(Map<String, dynamic> json) { return TippingMyr(
...
TippingMyr copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingMyr(
...
@override String toString() { return 'TippingMyr(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
