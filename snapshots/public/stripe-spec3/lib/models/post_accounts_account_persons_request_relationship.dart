...
factory PostAccountsAccountPersonsRequestRelationship.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPersonsRequestRelationship(
  ...
  percentOwnership: json['percent_ownership'] != null ? OneOf2.parse(json['percent_ownership'], fromA: (v) => (v as num).toDouble(), fromB: (v) => PostAccountsAccountPersonsRequestRelationshipPercentOwnershipVariant2.fromJson(v as String),) : null,
...
final PostAccountsAccountPersonsRequestRelationshipPercentOwnership? percentOwnership;
...
PostAccountsAccountPersonsRequestRelationship copyWith({bool Function()? authorizer, bool Function()? director, bool Function()? executive, bool Function()? legalGuardian, bool Function()? owner, PostAccountsAccountPersonsRequestRelationshipPercentOwnership Function()? percentOwnership, bool Function()? representative, String Function()? title, }) { return PostAccountsAccountPersonsRequestRelationship(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostAccountsAccountPersonsRequestRelationship &&
...
@override String toString() { return 'PostAccountsAccountPersonsRequestRelationship(authorizer: $authorizer, director: $director, executive: $executive, legalGuardian: $legalGuardian, owner: $owner, percentOwnership: $percentOwnership, representative: $representative, title: $title)'; } 
 }
