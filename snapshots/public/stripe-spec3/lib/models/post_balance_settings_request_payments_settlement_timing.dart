...
factory PostBalanceSettingsRequestPaymentsSettlementTiming.fromJson(Map<String, dynamic> json) { return PostBalanceSettingsRequestPaymentsSettlementTiming(
  delayDaysOverride: json['delay_days_override'] != null ? PostBalanceSettingsRequestPaymentsSettlementTimingDelayDaysOverride.fromJson(json['delay_days_override']) : null,
); }
