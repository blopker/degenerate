...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsRequestGooglePayDisplayPreferencePreference {const PostPaymentMethodConfigurationsRequestGooglePayDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsRequestGooglePayDisplayPreference {const PostPaymentMethodConfigurationsRequestGooglePayDisplayPreference({this.preference});
