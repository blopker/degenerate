...
final class PaymentMethodCardWalletVisaCheckoutShippingAddress {const PaymentMethodCardWalletVisaCheckoutShippingAddress({this.address});

factory PaymentMethodCardWalletVisaCheckoutShippingAddress.fromJson(Map<String, dynamic> json) { return PaymentMethodCardWalletVisaCheckoutShippingAddress(
