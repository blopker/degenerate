...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_treasury_outbound_payments_request_destination_payment_method_data.dart';import 'post_treasury_outbound_payments_request_destination_payment_method_options.dart';import 'post_treasury_outbound_payments_request_end_user_details.dart';final class PostTreasuryOutboundPaymentsRequest {const PostTreasuryOutboundPaymentsRequest({required this.amount, required this.currency, this.customer, this.description, this.destinationPaymentMethod, this.destinationPaymentMethodData, this.destinationPaymentMethodOptions, this.endUserDetails, this.expand, required this.financialAccount, this.metadata, this.statementDescriptor, });
