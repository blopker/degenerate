...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostAccountsAccountRequestDocumentsCompanyTaxIdVerification {const PostAccountsAccountRequestDocumentsCompanyTaxIdVerification({this.files});
