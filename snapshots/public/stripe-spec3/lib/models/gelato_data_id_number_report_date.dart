...
@immutable final class GelatoDataIdNumberReportDate {const GelatoDataIdNumberReportDate({this.day = const Omittable.absent(), this.month = const Omittable.absent(), this.year = const Omittable.absent(), });

factory GelatoDataIdNumberReportDate.fromJson(Map<String, dynamic> json) { return GelatoDataIdNumberReportDate(
...
GelatoDataIdNumberReportDate copyWith({Omittable<int?>? day, Omittable<int?>? month, Omittable<int?>? year, }) { return GelatoDataIdNumberReportDate(
  day: day ?? this.day,
  month: month ?? this.month,
  year: year ?? this.year,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GelatoDataIdNumberReportDate &&
          day == other.day &&
          month == other.month &&
          year == other.year; } 
@override int get hashCode { return Object.hash(day, month, year); } 
@override String toString() { return 'GelatoDataIdNumberReportDate(day: $day, month: $month, year: $year)'; } 
 }
