...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingAed {const TippingAed({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingAed.fromJson(Map<String, dynamic> json) { return TippingAed(
...
TippingAed copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingAed(
...
@override String toString() { return 'TippingAed(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
