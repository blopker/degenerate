...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingAed {const TippingAed({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
