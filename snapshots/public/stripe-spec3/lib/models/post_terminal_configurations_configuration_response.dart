...
final class PostTerminalConfigurationsConfigurationResponse {
  const PostTerminalConfigurationsConfigurationResponse({this.terminalConfiguration = const Omittable.absent(),
this.deletedTerminalConfiguration = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PostTerminalConfigurationsConfigurationResponse._({required this.rawValue, required this.terminalConfiguration,
required this.deletedTerminalConfiguration,});
  factory PostTerminalConfigurationsConfigurationResponse.fromJson(Object? json) => PostTerminalConfigurationsConfigurationResponse._(
...
if (deletedTerminalConfiguration.isPresent) deletedTerminalConfiguration.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PostTerminalConfigurationsConfigurationResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PostTerminalConfigurationsConfigurationResponse(${toJson()})';
}
