...
@immutable final class GetTopupsResponseObject {const GetTopupsResponseObject._(this.value);
...
/// 
@immutable final class GetTopupsResponse {const GetTopupsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
