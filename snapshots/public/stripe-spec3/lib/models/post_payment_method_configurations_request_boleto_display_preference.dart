...
final class PostPaymentMethodConfigurationsRequestBoletoDisplayPreferencePreference {const PostPaymentMethodConfigurationsRequestBoletoDisplayPreferencePreference._(this.value);
...
final class PostPaymentMethodConfigurationsRequestBoletoDisplayPreference {const PostPaymentMethodConfigurationsRequestBoletoDisplayPreference({this.preference});
