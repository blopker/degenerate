...
@immutable
final class InvoiceAccountTaxIds {
  const InvoiceAccountTaxIds({this.string = const Omittable.absent(),
this.taxId = const Omittable.absent(),
this.deletedTaxId = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InvoiceAccountTaxIds._({required this.rawValue, required this.string,
required this.taxId,
required this.deletedTaxId,});
  factory InvoiceAccountTaxIds.fromJson(Object? json) => InvoiceAccountTaxIds._(
...
if (deletedTaxId.isPresent) deletedTaxId.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InvoiceAccountTaxIds && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InvoiceAccountTaxIds(${toJson()})';
}
