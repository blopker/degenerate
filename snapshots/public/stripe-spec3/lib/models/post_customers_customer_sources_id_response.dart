...
@immutable
final class PostCustomersCustomerSourcesIdResponse {
  const PostCustomersCustomerSourcesIdResponse({this.card = const Omittable.absent(),
this.bankAccount = const Omittable.absent(),
this.source = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PostCustomersCustomerSourcesIdResponse._({required this.rawValue, required this.card,
required this.bankAccount,
required this.source,});
  factory PostCustomersCustomerSourcesIdResponse.fromJson(Object? json) => PostCustomersCustomerSourcesIdResponse._(
...
if (source.isPresent) source.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PostCustomersCustomerSourcesIdResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PostCustomersCustomerSourcesIdResponse(${toJson()})';
}
