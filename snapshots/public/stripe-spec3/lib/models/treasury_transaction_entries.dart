...
@immutable final class TreasuryTransactionEntriesObject {const TreasuryTransactionEntriesObject._(this.value);
...
@immutable final class TreasuryTransactionEntries {const TreasuryTransactionEntries({required this.data, required this.hasMore, required this.object, required this.url, });
