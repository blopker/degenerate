...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PaymentMethodOptionsParam24SetupFutureUsage {const PaymentMethodOptionsParam24SetupFutureUsage._(this.value);
...
@immutable final class PaymentMethodOptionsParam24 {const PaymentMethodOptionsParam24({this.expiresAfterDays, this.setupFutureUsage, });
