...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'account.dart';
@immutable
final class CardAccount {
  const CardAccount({this.string = const Omittable.absent(),
this.account = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const CardAccount._({required this.rawValue, required this.string,
required this.account,});
  factory CardAccount.fromJson(Object? json) => CardAccount._(
...
if (account.isPresent) account.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is CardAccount && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'CardAccount(${toJson()})';
}
