...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payment_method_options_param91_subscriptions_variant1_next_billing.dart';@immutable final class PaymentMethodOptionsParam91SubscriptionsVariant1Interval {const PaymentMethodOptionsParam91SubscriptionsVariant1Interval._(this.value);
...
@immutable final class PaymentMethodOptionsParam91SubscriptionsVariant1 {const PaymentMethodOptionsParam91SubscriptionsVariant1({required this.interval, required this.reference, this.intervalCount, this.name, this.nextBilling, });
