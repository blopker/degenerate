...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_payment_method_configurations_request_afterpay_clearpay_display_preference.dart';/// Afterpay gives your customers a way to pay for purchases in installments, check this [page](https://docs.stripe.com/payments/afterpay-clearpay) for more details like country availability. Afterpay is particularly popular among businesses selling fashion, beauty, and sports products.
@immutable final class PostPaymentMethodConfigurationsRequestAfterpayClearpay {const PostPaymentMethodConfigurationsRequestAfterpayClearpay({this.displayPreference});
