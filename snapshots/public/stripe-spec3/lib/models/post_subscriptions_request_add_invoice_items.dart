...
factory PostSubscriptionsRequestAddInvoiceItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequestAddInvoiceItems(
  ...
  period: json['period'] != null ? PostSubscriptionsRequestAddInvoiceItemsPeriod.fromJson(json['period'] as Map<String, dynamic>) : null,
  price: json['price'] as String?,
  priceData: json['price_data'] != null ? PostSubscriptionsRequestAddInvoiceItemsPriceData.fromJson(json['price_data'] as Map<String, dynamic>) : null,
  quantity: json['quantity'] != null ? (json['quantity'] as num).toInt() : null,
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), fromB: (v) => PostSubscriptionsRequestAddInvoiceItemsTaxRatesVariant2.fromJson(v as String),) : null,
); }

final List<PostSubscriptionsRequestAddInvoiceItemsDiscounts>? discounts;

final Map<String,String>? metadata;

final PostSubscriptionsRequestAddInvoiceItemsPeriod? period;

final String? price;

final PostSubscriptionsRequestAddInvoiceItemsPriceData? priceData;

final int? quantity;

final PostSubscriptionsRequestAddInvoiceItemsTaxRates? taxRates;
...
PostSubscriptionsRequestAddInvoiceItems copyWith({List<PostSubscriptionsRequestAddInvoiceItemsDiscounts> Function()? discounts, Map<String, String> Function()? metadata, PostSubscriptionsRequestAddInvoiceItemsPeriod Function()? period, String Function()? price, PostSubscriptionsRequestAddInvoiceItemsPriceData Function()? priceData, int Function()? quantity, PostSubscriptionsRequestAddInvoiceItemsTaxRates Function()? taxRates, }) { return PostSubscriptionsRequestAddInvoiceItems(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostSubscriptionsRequestAddInvoiceItems &&
...
@override String toString() { return 'PostSubscriptionsRequestAddInvoiceItems(discounts: $discounts, metadata: $metadata, period: $period, price: $price, priceData: $priceData, quantity: $quantity, taxRates: $taxRates)'; } 
 }
