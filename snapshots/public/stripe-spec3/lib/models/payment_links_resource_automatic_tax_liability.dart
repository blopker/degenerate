...
final class PaymentLinksResourceAutomaticTaxLiability {const PaymentLinksResourceAutomaticTaxLiability({this.connectAccountReference});

factory PaymentLinksResourceAutomaticTaxLiability.fromJson(Map<String, dynamic> json) { return PaymentLinksResourceAutomaticTaxLiability(
