...
@immutable final class CheckoutAlipayPaymentMethodOptionsSetupFutureUsage {const CheckoutAlipayPaymentMethodOptionsSetupFutureUsage._(this.value);
...
/// 
@immutable final class CheckoutAlipayPaymentMethodOptions {const CheckoutAlipayPaymentMethodOptions({this.setupFutureUsage});
