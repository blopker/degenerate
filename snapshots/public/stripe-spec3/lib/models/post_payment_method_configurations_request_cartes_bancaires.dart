...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_payment_method_configurations_request_cartes_bancaires_display_preference.dart';/// Cartes Bancaires is France's local card network. More than 95% of these cards are co-branded with either Visa or Mastercard, meaning you can process these cards over either Cartes Bancaires or the Visa or Mastercard networks. Check this [page](https://docs.stripe.com/payments/cartes-bancaires) for more details.
@immutable final class PostPaymentMethodConfigurationsRequestCartesBancaires {const PostPaymentMethodConfigurationsRequestCartesBancaires({this.displayPreference});
