...
final class GetCreditNotesPreviewLinesReason {const GetCreditNotesPreviewLinesReason._(this.value);
...
@override String toString() { return 'GetCreditNotesPreviewLinesReason($value)'; } 
 }
