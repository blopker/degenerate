...
@immutable
final class PostCustomersCustomerCardsIdResponse {
  const PostCustomersCustomerCardsIdResponse({this.card = const Omittable.absent(),
this.bankAccount = const Omittable.absent(),
this.source = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PostCustomersCustomerCardsIdResponse._({required this.rawValue, required this.card,
required this.bankAccount,
required this.source,});
  factory PostCustomersCustomerCardsIdResponse.fromJson(Object? json) => PostCustomersCustomerCardsIdResponse._(
...
if (source.isPresent) source.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PostCustomersCustomerCardsIdResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PostCustomersCustomerCardsIdResponse(${toJson()})';
}
