...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'application.dart';import 'deleted_application.dart';/// ID of the Connect Application that created the subscription.
@immutable
final class SubscriptionApplication {
  const SubscriptionApplication({this.string = const Omittable.absent(),
this.application = const Omittable.absent(),
this.deletedApplication = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const SubscriptionApplication._({required this.rawValue, required this.string,
required this.application,
required this.deletedApplication,});
  factory SubscriptionApplication.fromJson(Object? json) => SubscriptionApplication._(
...
if (deletedApplication.isPresent) deletedApplication.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is SubscriptionApplication && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'SubscriptionApplication(${toJson()})';
}
