...
@immutable
final class DisputeEvidenceCustomerCommunication {
  const DisputeEvidenceCustomerCommunication({this.string = const Omittable.absent(),
this.file = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DisputeEvidenceCustomerCommunication._({required this.rawValue, required this.string,
required this.file,});
  factory DisputeEvidenceCustomerCommunication.fromJson(Object? json) => DisputeEvidenceCustomerCommunication._(
...
if (file.isPresent) file.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DisputeEvidenceCustomerCommunication && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DisputeEvidenceCustomerCommunication(${toJson()})';
}
