...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostSubscriptionItemsItemRequestPriceDataRecurringInterval {const PostSubscriptionItemsItemRequestPriceDataRecurringInterval._(this.value);
...
@immutable final class PostSubscriptionItemsItemRequestPriceDataRecurring {const PostSubscriptionItemsItemRequestPriceDataRecurring({required this.interval, this.intervalCount, });
