...
factory PostSetupIntentsIntentRequest.fromJson(Map<String, dynamic> json) { return PostSetupIntentsIntentRequest(
  ...
  excludedPaymentMethodTypes: json['excluded_payment_method_types'] != null ? PostSetupIntentsIntentRequestExcludedPaymentMethodTypes.fromJson(json['excluded_payment_method_types']) : null,
  ...
  metadata: json['metadata'] != null ? PostSetupIntentsIntentRequestMetadata.fromJson(json['metadata']) : null,
