...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingGip {const TippingGip({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingGip.fromJson(Map<String, dynamic> json) { return TippingGip(
...
TippingGip copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingGip(
...
@override String toString() { return 'TippingGip(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
