...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingGip {const TippingGip({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
