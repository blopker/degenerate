...
factory PostInvoicesCreatePreviewRequest.fromJson(Map<String, dynamic> json) {return PostInvoicesCreatePreviewRequest(
  ...
  discounts: json['discounts'] != null ? PostInvoicesCreatePreviewRequestDiscounts.fromJson(json['discounts']) : null,
  ...
  onBehalfOf: json['on_behalf_of'] != null ? PostInvoicesCreatePreviewRequestOnBehalfOf.fromJson(json['on_behalf_of']) : null,
