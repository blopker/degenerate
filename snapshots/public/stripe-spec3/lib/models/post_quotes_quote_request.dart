...
factory PostQuotesQuoteRequest.fromJson(Map<String, dynamic> json) {return PostQuotesQuoteRequest(
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? PostQuotesQuoteRequestDefaultTaxRates.fromJson(json['default_tax_rates']) : null,
  description: json['description'] != null ? PostQuotesQuoteRequestDescription.fromJson(json['description']) : null,
  discounts: json['discounts'] != null ? PostQuotesQuoteRequestDiscounts.fromJson(json['discounts']) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  expiresAt: json['expires_at'] != null ? (json['expires_at'] as num).toInt() : null,
  footer: json['footer'] != null ? PostQuotesQuoteRequestFooter.fromJson(json['footer']) : null,
  header: json['header'] != null ? PostQuotesQuoteRequestHeader.fromJson(json['header']) : null,
