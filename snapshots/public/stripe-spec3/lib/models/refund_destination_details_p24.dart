...
@immutable final class RefundDestinationDetailsP24 {const RefundDestinationDetailsP24({this.reference = const Omittable.absent(), this.referenceStatus = const Omittable.absent(), });
...
RefundDestinationDetailsP24 copyWith({Omittable<String?>? reference, Omittable<String?>? referenceStatus, }) { return RefundDestinationDetailsP24(
