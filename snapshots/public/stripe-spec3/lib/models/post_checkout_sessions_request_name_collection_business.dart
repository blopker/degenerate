...
final class PostCheckoutSessionsRequestNameCollectionBusiness {const PostCheckoutSessionsRequestNameCollectionBusiness({required this.enabled, this.optional, });
