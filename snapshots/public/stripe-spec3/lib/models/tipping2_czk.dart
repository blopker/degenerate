...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Czk {const Tipping2Czk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
