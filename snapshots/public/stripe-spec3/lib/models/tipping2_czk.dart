...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Czk {const Tipping2Czk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Czk.fromJson(Map<String, dynamic> json) { return Tipping2Czk(
...
Tipping2Czk copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Czk(
...
@override String toString() { return 'Tipping2Czk(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
