...
@immutable final class CheckoutAuBecsDebitPaymentMethodOptionsSetupFutureUsage {const CheckoutAuBecsDebitPaymentMethodOptionsSetupFutureUsage._(this.value);
...
/// 
@immutable final class CheckoutAuBecsDebitPaymentMethodOptions {const CheckoutAuBecsDebitPaymentMethodOptions({this.setupFutureUsage, this.targetDate, });
