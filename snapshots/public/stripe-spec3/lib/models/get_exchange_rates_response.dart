...
/// 
final class GetExchangeRatesResponse {const GetExchangeRatesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
...
final GetExchangeRatesResponseObject object;
