...
@immutable final class LegalEntityUboDeclaration {const LegalEntityUboDeclaration({this.date = const Omittable.absent(), this.ip = const Omittable.absent(), this.userAgent = const Omittable.absent(), });
...
LegalEntityUboDeclaration copyWith({Omittable<int?>? date, Omittable<String?>? ip, Omittable<String?>? userAgent, }) { return LegalEntityUboDeclaration(
  date: date ?? this.date,
  ip: ip ?? this.ip,
