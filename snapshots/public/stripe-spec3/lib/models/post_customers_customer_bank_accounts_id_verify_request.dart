...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostCustomersCustomerBankAccountsIdVerifyRequest {const PostCustomersCustomerBankAccountsIdVerifyRequest({this.amounts, this.expand, });
