...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payment_method_details_bancontact_generated_sepa_debit.dart';import 'payment_method_details_bancontact_generated_sepa_debit_mandate.dart';/// Preferred language of the Bancontact authorization page that the customer is redirected to.
...
/// 
@immutable final class PaymentMethodDetailsBancontact {const PaymentMethodDetailsBancontact({this.bankCode = const Omittable.absent(), this.bankName = const Omittable.absent(), this.bic = const Omittable.absent(), this.generatedSepaDebit = const Omittable.absent(), this.generatedSepaDebitMandate = const Omittable.absent(), this.ibanLast4 = const Omittable.absent(), this.preferredLanguage = const Omittable.absent(), this.verifiedName = const Omittable.absent(), });
...
factory PaymentMethodDetailsBancontact.fromJson(Map<String, dynamic> json) { return PaymentMethodDetailsBancontact(
  ...
  generatedSepaDebit: json.containsKey('generated_sepa_debit') ? Omittable(json['generated_sepa_debit'] != null ? PaymentMethodDetailsBancontactGeneratedSepaDebit.fromJson(json['generated_sepa_debit']) : null) : const Omittable.absent(),
  generatedSepaDebitMandate: json.containsKey('generated_sepa_debit_mandate') ? Omittable(json['generated_sepa_debit_mandate'] != null ? PaymentMethodDetailsBancontactGeneratedSepaDebitMandate.fromJson(json['generated_sepa_debit_mandate']) : null) : const Omittable.absent(),
  ibanLast4: json.containsKey('iban_last4') ? Omittable(json['iban_last4'] as String?) : const Omittable.absent(),
  preferredLanguage: json.containsKey('preferred_language') ? Omittable(json['preferred_language'] != null ? PaymentMethodDetailsBancontactPreferredLanguage.fromJson(json['preferred_language'] as String) : null) : const Omittable.absent(),
...
final Omittable<PaymentMethodDetailsBancontactGeneratedSepaDebit?> generatedSepaDebit;

/// The mandate for the SEPA Direct Debit PaymentMethod which was generated by this Charge.
final Omittable<PaymentMethodDetailsBancontactGeneratedSepaDebitMandate?> generatedSepaDebitMandate;
...
/// Can be one of `en`, `de`, `fr`, or `nl`
final Omittable<PaymentMethodDetailsBancontactPreferredLanguage?> preferredLanguage;
...
PaymentMethodDetailsBancontact copyWith({Omittable<String?>? bankCode, Omittable<String?>? bankName, Omittable<String?>? bic, Omittable<PaymentMethodDetailsBancontactGeneratedSepaDebit?>? generatedSepaDebit, Omittable<PaymentMethodDetailsBancontactGeneratedSepaDebitMandate?>? generatedSepaDebitMandate, Omittable<String?>? ibanLast4, Omittable<PaymentMethodDetailsBancontactPreferredLanguage?>? preferredLanguage, Omittable<String?>? verifiedName, }) { return PaymentMethodDetailsBancontact(
