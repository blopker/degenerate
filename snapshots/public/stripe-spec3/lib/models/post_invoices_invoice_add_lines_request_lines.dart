...
factory PostInvoicesInvoiceAddLinesRequestLines.fromJson(Map<String, dynamic> json) {return PostInvoicesInvoiceAddLinesRequestLines(
  ...
  discounts: json['discounts'] != null ? PostInvoicesInvoiceAddLinesRequestLinesDiscounts.fromJson(json['discounts']) : null,
  invoiceItem: json['invoice_item'] as String?,
  metadata: json['metadata'] != null ? PostInvoicesInvoiceAddLinesRequestLinesMetadata.fromJson(json['metadata']) : null,
