...
import 'package:degenerate_runtime/degenerate_runtime.dart';/// Address data.
@immutable final class InsightsResourcesPaymentEvaluationAddress {const InsightsResourcesPaymentEvaluationAddress({this.city = const Omittable.absent(), this.country = const Omittable.absent(), this.line1 = const Omittable.absent(), this.line2 = const Omittable.absent(), this.postalCode = const Omittable.absent(), this.state = const Omittable.absent(), });
...
InsightsResourcesPaymentEvaluationAddress copyWith({Omittable<String?>? city, Omittable<String?>? country, Omittable<String?>? line1, Omittable<String?>? line2, Omittable<String?>? postalCode, Omittable<String?>? state, }) { return InsightsResourcesPaymentEvaluationAddress(
  city: city ?? this.city,
