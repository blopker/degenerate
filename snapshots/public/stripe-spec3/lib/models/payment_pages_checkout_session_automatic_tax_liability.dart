...
final class PaymentPagesCheckoutSessionAutomaticTaxLiability {const PaymentPagesCheckoutSessionAutomaticTaxLiability({this.connectAccountReference});

factory PaymentPagesCheckoutSessionAutomaticTaxLiability.fromJson(Map<String, dynamic> json) { return PaymentPagesCheckoutSessionAutomaticTaxLiability(
