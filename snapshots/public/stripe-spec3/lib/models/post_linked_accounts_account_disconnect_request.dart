...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostLinkedAccountsAccountDisconnectRequest {const PostLinkedAccountsAccountDisconnectRequest({this.expand});
...
@override String toString() { return 'PostLinkedAccountsAccountDisconnectRequest(expand: $expand)'; } 
 }
