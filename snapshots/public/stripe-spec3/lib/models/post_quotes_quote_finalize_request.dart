...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostQuotesQuoteFinalizeRequest {const PostQuotesQuoteFinalizeRequest({this.expand, this.expiresAt, });
