...
final class PaymentMethodCardWalletVisaCheckoutBillingAddress {const PaymentMethodCardWalletVisaCheckoutBillingAddress({this.address});

factory PaymentMethodCardWalletVisaCheckoutBillingAddress.fromJson(Map<String, dynamic> json) { return PaymentMethodCardWalletVisaCheckoutBillingAddress(
