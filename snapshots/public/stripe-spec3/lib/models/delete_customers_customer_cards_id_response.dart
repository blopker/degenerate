...
@immutable
final class DeleteCustomersCustomerCardsIdResponse {
  const DeleteCustomersCustomerCardsIdResponse({this.paymentSource = const Omittable.absent(),
this.deletedPaymentSource = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DeleteCustomersCustomerCardsIdResponse._({required this.rawValue, required this.paymentSource,
required this.deletedPaymentSource,});
  factory DeleteCustomersCustomerCardsIdResponse.fromJson(Object? json) => DeleteCustomersCustomerCardsIdResponse._(
...
if (deletedPaymentSource.isPresent) deletedPaymentSource.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DeleteCustomersCustomerCardsIdResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DeleteCustomersCustomerCardsIdResponse(${toJson()})';
}
