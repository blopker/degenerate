...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Ron {const Tipping2Ron({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Ron.fromJson(Map<String, dynamic> json) { return Tipping2Ron(
...
@override String toString() { return 'Tipping2Ron(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
