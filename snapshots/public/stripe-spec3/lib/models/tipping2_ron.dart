...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Ron {const Tipping2Ron({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
