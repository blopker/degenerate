...
factory PostTreasuryFinancialAccountsFinancialAccountFeaturesRequest.fromJson(Map<String, dynamic> json) { return PostTreasuryFinancialAccountsFinancialAccountFeaturesRequest(
  ...
  financialAddresses: json['financial_addresses'] != null ? PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestFinancialAddresses.fromJson(json['financial_addresses'] as Map<String, dynamic>) : null,
...
final PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestDepositInsurance? depositInsurance;

/// Specifies which fields in the response should be expanded.
final List<String>? expand;

/// Contains Features that add FinancialAddresses to the FinancialAccount.
final PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestFinancialAddresses? financialAddresses;
...
final PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestIntraStripeFlows? intraStripeFlows;

/// Includes Features related to initiating money movement out of the FinancialAccount to someone else's bucket of money.
final PostTreasuryFinancialAccountsFinancialAccountFeaturesRequestOutboundPayments? outboundPayments;
