...
@immutable
final class TreasuryDebitReversalTransaction {
  const TreasuryDebitReversalTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryDebitReversalTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryDebitReversalTransaction.fromJson(Object? json) => TreasuryDebitReversalTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryDebitReversalTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryDebitReversalTransaction(${toJson()})';
}
