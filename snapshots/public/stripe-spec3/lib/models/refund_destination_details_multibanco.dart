...
@immutable final class RefundDestinationDetailsMultibanco {const RefundDestinationDetailsMultibanco({this.reference = const Omittable.absent(), this.referenceStatus = const Omittable.absent(), });

factory RefundDestinationDetailsMultibanco.fromJson(Map<String, dynamic> json) { return RefundDestinationDetailsMultibanco(
...
RefundDestinationDetailsMultibanco copyWith({Omittable<String?>? reference, Omittable<String?>? referenceStatus, }) { return RefundDestinationDetailsMultibanco(
  reference: reference ?? this.reference,
  referenceStatus: referenceStatus ?? this.referenceStatus,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RefundDestinationDetailsMultibanco &&
          reference == other.reference &&
          referenceStatus == other.referenceStatus; } 
@override int get hashCode { return Object.hash(reference, referenceStatus); } 
@override String toString() { return 'RefundDestinationDetailsMultibanco(reference: $reference, referenceStatus: $referenceStatus)'; } 
 }
