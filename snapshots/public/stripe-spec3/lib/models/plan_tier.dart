...
@immutable final class PlanTier {const PlanTier({this.flatAmount = const Omittable.absent(), this.flatAmountDecimal = const Omittable.absent(), this.unitAmount = const Omittable.absent(), this.unitAmountDecimal = const Omittable.absent(), this.upTo = const Omittable.absent(), });
...
PlanTier copyWith({Omittable<int?>? flatAmount, Omittable<String?>? flatAmountDecimal, Omittable<int?>? unitAmount, Omittable<String?>? unitAmountDecimal, Omittable<int?>? upTo, }) { return PlanTier(
