...
final class GetRadarEarlyFraudWarningsResponseObject {const GetRadarEarlyFraudWarningsResponseObject._(this.value);
...
/// 
final class GetRadarEarlyFraudWarningsResponse {const GetRadarEarlyFraudWarningsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
