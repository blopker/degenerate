...
final class DeleteCustomersCustomerBankAccountsIdResponse {
  const DeleteCustomersCustomerBankAccountsIdResponse({this.paymentSource = const Omittable.absent(),
this.deletedPaymentSource = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DeleteCustomersCustomerBankAccountsIdResponse._({required this.rawValue, required this.paymentSource,
required this.deletedPaymentSource,});
  factory DeleteCustomersCustomerBankAccountsIdResponse.fromJson(Object? json) => DeleteCustomersCustomerBankAccountsIdResponse._(
...
if (deletedPaymentSource.isPresent) deletedPaymentSource.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DeleteCustomersCustomerBankAccountsIdResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DeleteCustomersCustomerBankAccountsIdResponse(${toJson()})';
}
