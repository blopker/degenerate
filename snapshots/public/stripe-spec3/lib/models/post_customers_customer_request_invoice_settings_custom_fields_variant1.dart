...
final class PostCustomersCustomerRequestInvoiceSettingsCustomFieldsVariant1 {const PostCustomersCustomerRequestInvoiceSettingsCustomFieldsVariant1({required this.name, required this.value, });
