...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class ClientKeyParam2CustomerAcceptanceOnline {const ClientKeyParam2CustomerAcceptanceOnline({this.ipAddress, this.userAgent, });
