...
final class PostAccountsAccountRequestTosAcceptance {const PostAccountsAccountRequestTosAcceptance({this.date, this.ip, this.serviceAgreement, this.userAgent, });
