...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostRadarValueListsValueListRequest {const PostRadarValueListsValueListRequest({this.alias, this.expand, this.metadata, this.name, });
