...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'application.dart';import 'deleted_application.dart';/// ID of the Connect Application that created the invoice.
@immutable
final class InvoiceApplication {
  const InvoiceApplication({this.string = const Omittable.absent(),
this.application = const Omittable.absent(),
this.deletedApplication = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const InvoiceApplication._({required this.rawValue, required this.string,
required this.application,
required this.deletedApplication,});
  factory InvoiceApplication.fromJson(Object? json) => InvoiceApplication._(
...
if (deletedApplication.isPresent) deletedApplication.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is InvoiceApplication && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'InvoiceApplication(${toJson()})';
}
