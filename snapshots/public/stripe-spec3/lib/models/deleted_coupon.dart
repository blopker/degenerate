...
final class DeletedCouponObject {const DeletedCouponObject._(this.value);
...
/// 
final class DeletedCoupon {const DeletedCoupon({required this.deleted, required this.id, required this.object, });
