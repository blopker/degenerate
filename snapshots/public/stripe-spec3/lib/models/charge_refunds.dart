...
final class ChargeRefunds {const ChargeRefunds({required this.data, required this.hasMore, required this.object, required this.url, });
...
final ChargeRefundsObject object;
