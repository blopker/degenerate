...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer_payment_source_card.dart';import 'destination_specs.dart';import 'post_charges_request_card.dart';import 'post_charges_request_destination.dart';import 'post_charges_request_metadata.dart';import 'post_charges_request_radar_options.dart';import 'post_charges_request_shipping.dart';import 'post_charges_request_transfer_data.dart';final class PostChargesRequest {const PostChargesRequest({this.amount, this.applicationFee, this.applicationFeeAmount, this.capture, this.card, this.currency, this.customer, this.description, this.destination, this.expand, this.metadata, this.onBehalfOf, this.radarOptions, this.receiptEmail, this.shipping, this.source, this.statementDescriptor, this.statementDescriptorSuffix, this.transferData, this.transferGroup, });
