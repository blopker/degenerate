...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer.dart';import 'deleted_customer.dart';/// The customer the balance is for.
@immutable
final class BillingCreditBalanceSummaryCustomer {
  const BillingCreditBalanceSummaryCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const BillingCreditBalanceSummaryCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory BillingCreditBalanceSummaryCustomer.fromJson(Object? json) => BillingCreditBalanceSummaryCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is BillingCreditBalanceSummaryCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'BillingCreditBalanceSummaryCustomer(${toJson()})';
}
