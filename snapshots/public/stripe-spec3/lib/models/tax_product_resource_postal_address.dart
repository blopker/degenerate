...
@immutable final class TaxProductResourcePostalAddress {const TaxProductResourcePostalAddress({required this.country, this.city, this.line1, this.line2, this.postalCode, this.state, });
