...
factory PaymentLink.fromJson(Map<String, dynamic> json) {return PaymentLink(
  ...
  application: json.containsKey('application') ? Omittable(json['application'] != null ? PaymentLinkApplication.fromJson(json['application']) : null) : const Omittable.absent(),
  ...
  onBehalfOf: json.containsKey('on_behalf_of') ? Omittable(json['on_behalf_of'] != null ? PaymentLinkOnBehalfOf.fromJson(json['on_behalf_of']) : null) : const Omittable.absent(),
