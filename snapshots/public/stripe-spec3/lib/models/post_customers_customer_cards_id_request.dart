...
final class PostCustomersCustomerCardsIdRequestAccountHolderType {const PostCustomersCustomerCardsIdRequestAccountHolderType._(this.value);
...
static const PostCustomersCustomerCardsIdRequestAccountHolderType individual = PostCustomersCustomerCardsIdRequestAccountHolderType._('individual');

static const List<PostCustomersCustomerCardsIdRequestAccountHolderType> values = [company, individual];
...
final class PostCustomersCustomerCardsIdRequest {const PostCustomersCustomerCardsIdRequest({this.accountHolderName, this.accountHolderType, this.addressCity, this.addressCountry, this.addressLine1, this.addressLine2, this.addressState, this.addressZip, this.expMonth, this.expYear, this.expand, this.metadata, this.name, this.owner, });
...
factory PostCustomersCustomerCardsIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerCardsIdRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), fromB: (v) => PostCustomersCustomerCardsIdRequestMetadataVariant2.fromJson(v as String),) : null,
...
final PostCustomersCustomerCardsIdRequestAccountHolderType? accountHolderType;
...
final PostCustomersCustomerCardsIdRequestMetadata? metadata;
