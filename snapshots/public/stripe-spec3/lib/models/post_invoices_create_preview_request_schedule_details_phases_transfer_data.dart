...
PostInvoicesCreatePreviewRequestScheduleDetailsPhasesTransferData copyWith({double Function()? amountPercent, String? destination, }) { return PostInvoicesCreatePreviewRequestScheduleDetailsPhasesTransferData(
  amountPercent: amountPercent != null ? amountPercent() : this.amountPercent,
  destination: destination ?? this.destination,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostInvoicesCreatePreviewRequestScheduleDetailsPhasesTransferData &&
          amountPercent == other.amountPercent &&
          destination == other.destination; } 
@override int get hashCode { return Object.hash(amountPercent, destination); } 
@override String toString() { return 'PostInvoicesCreatePreviewRequestScheduleDetailsPhasesTransferData(amountPercent: $amountPercent, destination: $destination)'; } 
 }
