...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {const PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemandPurchaseInterval._(this.value);
...
@immutable final class PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemand {const PostSetupIntentsIntentRequestPaymentMethodOptionsKlarnaOnDemand({this.averageAmount, this.maximumAmount, this.minimumAmount, this.purchaseInterval, this.purchaseIntervalCount, });
