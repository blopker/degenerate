...
final class PaymentMethodDetailsEpsBank {const PaymentMethodDetailsEpsBank._(this.value);
...
/// 
final class PaymentMethodDetailsEps {const PaymentMethodDetailsEps({this.bank, this.verifiedName, });
