...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingAud {const TippingAud({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingAud.fromJson(Map<String, dynamic> json) { return TippingAud(
...
TippingAud copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingAud(
...
@override String toString() { return 'TippingAud(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
