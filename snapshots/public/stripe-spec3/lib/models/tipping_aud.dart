...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingAud {const TippingAud({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
