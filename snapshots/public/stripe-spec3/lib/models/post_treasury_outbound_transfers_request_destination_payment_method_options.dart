...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_treasury_outbound_transfers_request_destination_payment_method_options_us_bank_account.dart';/// Hash describing payment method configuration details.
...
factory PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptions.fromJson(Map<String, dynamic> json) {return PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptions(
  usBankAccount: json['us_bank_account'] != null ? PostTreasuryOutboundTransfersRequestDestinationPaymentMethodOptionsUsBankAccount.fromJson(json['us_bank_account']) : null,
);}
