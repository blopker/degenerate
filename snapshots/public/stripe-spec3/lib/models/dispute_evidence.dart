...
factory DisputeEvidence.fromJson(Map<String, dynamic> json) {return DisputeEvidence(
  ...
  customerCommunication: json.containsKey('customer_communication') ? Omittable(json['customer_communication'] != null ? DisputeEvidenceCustomerCommunication.fromJson(json['customer_communication']) : null) : const Omittable.absent(),
  ...
  customerSignature: json.containsKey('customer_signature') ? Omittable(json['customer_signature'] != null ? DisputeEvidenceCustomerSignature.fromJson(json['customer_signature']) : null) : const Omittable.absent(),
  duplicateChargeDocumentation: json.containsKey('duplicate_charge_documentation') ? Omittable(json['duplicate_charge_documentation'] != null ? DisputeEvidenceDuplicateChargeDocumentation.fromJson(json['duplicate_charge_documentation']) : null) : const Omittable.absent(),
  ...
  receipt: json.containsKey('receipt') ? Omittable(json['receipt'] != null ? DisputeEvidenceReceipt.fromJson(json['receipt']) : null) : const Omittable.absent(),
  refundPolicy: json.containsKey('refund_policy') ? Omittable(json['refund_policy'] != null ? DisputeEvidenceRefundPolicy.fromJson(json['refund_policy']) : null) : const Omittable.absent(),
  ...
  serviceDocumentation: json.containsKey('service_documentation') ? Omittable(json['service_documentation'] != null ? DisputeEvidenceServiceDocumentation.fromJson(json['service_documentation']) : null) : const Omittable.absent(),
  ...
  shippingDocumentation: json.containsKey('shipping_documentation') ? Omittable(json['shipping_documentation'] != null ? DisputeEvidenceShippingDocumentation.fromJson(json['shipping_documentation']) : null) : const Omittable.absent(),
