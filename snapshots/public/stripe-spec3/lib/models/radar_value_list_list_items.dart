...
factory RadarValueListListItemsObject.fromJson(String json) { return switch (json) {
  'list' => list,
  _ => RadarValueListListItemsObject._(json),
}; }

static const RadarValueListListItemsObject list = RadarValueListListItemsObject._('list');

static const List<RadarValueListListItemsObject> values = [list];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is RadarValueListListItemsObject && other.value == value; } 
...
factory RadarValueListListItems.fromJson(Map<String, dynamic> json) { return RadarValueListListItems(
  ...
  object: RadarValueListListItemsObject.fromJson(json['object'] as String),
...
final RadarValueListListItemsObject object;
...
RadarValueListListItems copyWith({List<RadarValueListItem>? data, bool? hasMore, RadarValueListListItemsObject? object, String? url, }) { return RadarValueListListItems(
  data: data ?? this.data,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is RadarValueListListItems &&
          listEquals(data, other.data) &&
          hasMore == other.hasMore &&
          object == other.object &&
          url == other.url; } 
@override int get hashCode { return Object.hash(Object.hashAll(data), hasMore, object, url); } 
@override String toString() { return 'RadarValueListListItems(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
