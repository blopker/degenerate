...
@immutable final class RefundDestinationDetailsJpBankTransfer {const RefundDestinationDetailsJpBankTransfer({this.reference = const Omittable.absent(), this.referenceStatus = const Omittable.absent(), });
...
RefundDestinationDetailsJpBankTransfer copyWith({Omittable<String?>? reference, Omittable<String?>? referenceStatus, }) { return RefundDestinationDetailsJpBankTransfer(
