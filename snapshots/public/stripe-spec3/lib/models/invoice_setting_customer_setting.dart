...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'invoice_setting_custom_field.dart';import 'invoice_setting_customer_rendering_options.dart';import 'invoice_setting_customer_setting_default_payment_method.dart';/// 
...
factory InvoiceSettingCustomerSetting.fromJson(Map<String, dynamic> json) {return InvoiceSettingCustomerSetting(
  ...
  defaultPaymentMethod: json.containsKey('default_payment_method') ? Omittable(json['default_payment_method'] != null ? InvoiceSettingCustomerSettingDefaultPaymentMethod.fromJson(json['default_payment_method']) : null) : const Omittable.absent(),
