...
final class PostPaymentRecordsReportPaymentRequestPaymentMethodDetailsCustom {const PostPaymentRecordsReportPaymentRequestPaymentMethodDetailsCustom({this.displayName, this.type, });
