...
/// 
final class PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity {const PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity({required this.enabled, this.maximum, this.minimum, });
