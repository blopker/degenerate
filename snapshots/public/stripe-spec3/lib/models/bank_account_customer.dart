...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer.dart';import 'deleted_customer.dart';/// The ID of the customer that the bank account is associated with.
@immutable
final class BankAccountCustomer {
  const BankAccountCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const BankAccountCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory BankAccountCustomer.fromJson(Object? json) => BankAccountCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is BankAccountCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'BankAccountCustomer(${toJson()})';
}
