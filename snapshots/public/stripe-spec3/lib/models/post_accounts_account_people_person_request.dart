...
static const PostAccountsAccountPeoplePersonRequestPoliticalExposure none = PostAccountsAccountPeoplePersonRequestPoliticalExposure._('none');

static const List<PostAccountsAccountPeoplePersonRequestPoliticalExposure> values = [existing, none];
...
factory PostAccountsAccountPeoplePersonRequest.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeoplePersonRequest(
  ...
  addressKanji: json['address_kanji'] != null ? PostAccountsAccountPeoplePersonRequestAddressKanji.fromJson(json['address_kanji'] as Map<String, dynamic>) : null,
  dob: json['dob'] != null ? OneOf2.parse(json['dob'], fromA: (v) => DateOfBirthSpecs4.fromJson(v as Map<String, dynamic>), fromB: (v) => PostAccountsAccountPeoplePersonRequestDobVariant2.fromJson(v as String),) : null,
  ...
  fullNameAliases: json['full_name_aliases'] != null ? OneOf2.parse(json['full_name_aliases'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), fromB: (v) => PostAccountsAccountPeoplePersonRequestFullNameAliasesVariant2.fromJson(v as String),) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), fromB: (v) => PostAccountsAccountPeoplePersonRequestMetadataVariant2.fromJson(v as String),) : null,
  nationality: json['nationality'] as String?,
  personToken: json['person_token'] as String?,
  phone: json['phone'] as String?,
  politicalExposure: json['political_exposure'] != null ? PostAccountsAccountPeoplePersonRequestPoliticalExposure.fromJson(json['political_exposure'] as String) : null,
  registeredAddress: json['registered_address'] != null ? PostAccountsAccountPeoplePersonRequestRegisteredAddress.fromJson(json['registered_address'] as Map<String, dynamic>) : null,
...
final PostAccountsAccountPeoplePersonRequestAddressKana? addressKana;

/// The Kanji variation of the person's address (Japan only).
final PostAccountsAccountPeoplePersonRequestAddressKanji? addressKanji;
...
final PostAccountsAccountPeoplePersonRequestMetadata? metadata;
...
final PostAccountsAccountPeoplePersonRequestPoliticalExposure? politicalExposure;

/// The person's registered address.
final PostAccountsAccountPeoplePersonRequestRegisteredAddress? registeredAddress;
...
final PostAccountsAccountPeoplePersonRequestUsCfpbData? usCfpbData;
