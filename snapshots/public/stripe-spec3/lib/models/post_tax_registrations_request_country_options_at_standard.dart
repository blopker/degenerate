...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsAtStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsAtStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsAtStandard {const PostTaxRegistrationsRequestCountryOptionsAtStandard({required this.placeOfSupplyScheme});
