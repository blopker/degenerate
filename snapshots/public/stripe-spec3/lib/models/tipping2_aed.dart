...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Aed {const Tipping2Aed({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Aed.fromJson(Map<String, dynamic> json) { return Tipping2Aed(
...
Tipping2Aed copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Aed(
...
@override String toString() { return 'Tipping2Aed(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
