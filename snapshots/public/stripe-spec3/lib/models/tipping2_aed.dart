...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Aed {const Tipping2Aed({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
