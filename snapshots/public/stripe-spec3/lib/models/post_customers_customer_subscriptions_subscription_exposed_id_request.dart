...
factory PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequest.fromJson(Map<String, dynamic> json) { return PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequest(
  ...
  billingThresholds: json['billing_thresholds'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestBillingThresholds.fromJson(json['billing_thresholds']) : null,
  cancelAt: json['cancel_at'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestCancelAt.fromJson(json['cancel_at']) : null,
  ...
  defaultSource: json['default_source'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultSource.fromJson(json['default_source']) : null,
  defaultTaxRates: json['default_tax_rates'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDefaultTaxRates.fromJson(json['default_tax_rates']) : null,
  discounts: json['discounts'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestDiscounts.fromJson(json['discounts']) : null,
  ...
  metadata: json['metadata'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestMetadata.fromJson(json['metadata']) : null,
  offSession: json['off_session'] as bool?,
  pauseCollection: json['pause_collection'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPauseCollection.fromJson(json['pause_collection']) : null,
  ...
  pendingInvoiceItemInterval: json['pending_invoice_item_interval'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestPendingInvoiceItemInterval.fromJson(json['pending_invoice_item_interval']) : null,
  ...
  transferData: json['transfer_data'] != null ? PostCustomersCustomerSubscriptionsSubscriptionExposedIdRequestTransferData.fromJson(json['transfer_data']) : null,
