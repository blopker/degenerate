...
/// 
final class TreasuryOutboundTransfersResourceStatusTransitions {const TreasuryOutboundTransfersResourceStatusTransitions({this.canceledAt, this.failedAt, this.postedAt, this.returnedAt, });
