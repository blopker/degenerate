...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'item_billing_thresholds_param9.dart';import 'post_subscriptions_request_items_billing_thresholds.dart';import 'post_subscriptions_request_items_discounts.dart';import 'post_subscriptions_request_items_discounts_variant1.dart';import 'post_subscriptions_request_items_price_data.dart';import 'post_subscriptions_request_items_tax_rates.dart';@immutable final class PostSubscriptionsRequestItems {const PostSubscriptionsRequestItems({this.billingThresholds, this.discounts, this.metadata, this.price, this.priceData, this.quantity, this.taxRates, });

factory PostSubscriptionsRequestItems.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequestItems(
  billingThresholds: json['billing_thresholds'] != null ? OneOf2.parse(json['billing_thresholds'], fromA: (v) => ItemBillingThresholdsParam9.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestItemsBillingThresholdsVariant2.fromJson(v as String),) : null,
  discounts: json['discounts'] != null ? OneOf2.parse(json['discounts'], fromA: (v) => (v as List<dynamic>).map((e) => PostSubscriptionsRequestItemsDiscountsVariant1.fromJson(e as Map<String, dynamic>)).toList(), fromB: (v) => PostSubscriptionsRequestItemsDiscountsVariant2.fromJson(v as String),) : null,
  ...
  taxRates: json['tax_rates'] != null ? OneOf2.parse(json['tax_rates'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), fromB: (v) => PostSubscriptionsRequestItemsTaxRatesVariant2.fromJson(v as String),) : null,
); }
