...
@immutable
final class LineItemDiscounts {
  const LineItemDiscounts({this.string = const Omittable.absent(),
this.discount = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const LineItemDiscounts._({required this.rawValue, required this.string,
required this.discount,});
  factory LineItemDiscounts.fromJson(Object? json) => LineItemDiscounts._(
...
if (discount.isPresent) discount.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is LineItemDiscounts && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'LineItemDiscounts(${toJson()})';
}
