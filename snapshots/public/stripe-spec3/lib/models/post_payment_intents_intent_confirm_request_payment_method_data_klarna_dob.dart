...
PostPaymentIntentsIntentConfirmRequestPaymentMethodDataKlarnaDob copyWith({int? day, int? month, int? year, }) { return PostPaymentIntentsIntentConfirmRequestPaymentMethodDataKlarnaDob(
  day: day ?? this.day,
  month: month ?? this.month,
  year: year ?? this.year,
); } 
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostPaymentIntentsIntentConfirmRequestPaymentMethodDataKlarnaDob &&
          day == other.day &&
          month == other.month &&
          year == other.year; } 
@override int get hashCode { return Object.hash(day, month, year); } 
@override String toString() { return 'PostPaymentIntentsIntentConfirmRequestPaymentMethodDataKlarnaDob(day: $day, month: $month, year: $year)'; } 
 }
