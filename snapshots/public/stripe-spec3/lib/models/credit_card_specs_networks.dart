...
final class CreditCardSpecsNetworksPreferred {const CreditCardSpecsNetworksPreferred._(this.value);
...
final class CreditCardSpecsNetworks {const CreditCardSpecsNetworks({this.preferred});
