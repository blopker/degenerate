...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'legal_entity_company_verification_document_back.dart';import 'legal_entity_company_verification_document_front.dart';/// 
...
factory LegalEntityCompanyVerificationDocument.fromJson(Map<String, dynamic> json) {return LegalEntityCompanyVerificationDocument(
  back: json.containsKey('back') ? Omittable(json['back'] != null ? LegalEntityCompanyVerificationDocumentBack.fromJson(json['back']) : null) : const Omittable.absent(),
  ...
  front: json.containsKey('front') ? Omittable(json['front'] != null ? LegalEntityCompanyVerificationDocumentFront.fromJson(json['front']) : null) : const Omittable.absent(),
);}
