...
final class PostAccountsAccountRequestCapabilitiesCartesBancairesPayments {const PostAccountsAccountRequestCapabilitiesCartesBancairesPayments({this.requested});
