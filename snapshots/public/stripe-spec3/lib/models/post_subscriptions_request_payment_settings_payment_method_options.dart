...
factory PostSubscriptionsRequestPaymentSettingsPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostSubscriptionsRequestPaymentSettingsPaymentMethodOptions(
  acssDebit: json['acss_debit'] != null ? OneOf2.parse(json['acss_debit'], fromA: (v) => InvoicePaymentMethodOptionsParam31.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsAcssDebitVariant2.fromJson(v as String),) : null,
  bancontact: json['bancontact'] != null ? OneOf2.parse(json['bancontact'], fromA: (v) => InvoicePaymentMethodOptionsParam32.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsBancontactVariant2.fromJson(v as String),) : null,
  card: json['card'] != null ? OneOf2.parse(json['card'], fromA: (v) => SubscriptionPaymentMethodOptionsParam3.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsCardVariant2.fromJson(v as String),) : null,
  customerBalance: json['customer_balance'] != null ? OneOf2.parse(json['customer_balance'], fromA: (v) => InvoicePaymentMethodOptionsParam33.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsCustomerBalanceVariant2.fromJson(v as String),) : null,
  konbini: json['konbini'] != null ? OneOf2.parse(json['konbini'], fromA: (v) => InvoicePaymentMethodOptionsParam34.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsKonbiniVariant2.fromJson(v as String),) : null,
  payto: json['payto'] != null ? OneOf2.parse(json['payto'], fromA: (v) => InvoicePaymentMethodOptionsParam35.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsPaytoVariant2.fromJson(v as String),) : null,
  sepaDebit: json['sepa_debit'] != null ? OneOf2.parse(json['sepa_debit'], fromA: (v) => InvoicePaymentMethodOptionsParam36.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsSepaDebitVariant2.fromJson(v as String),) : null,
  usBankAccount: json['us_bank_account'] != null ? OneOf2.parse(json['us_bank_account'], fromA: (v) => InvoicePaymentMethodOptionsParam37.fromJson(v as Map<String, dynamic>), fromB: (v) => PostSubscriptionsRequestPaymentSettingsPaymentMethodOptionsUsBankAccountVariant2.fromJson(v as String),) : null,
); }
