...
@immutable
final class PaymentLinksResourceInvoiceSettingsAccountTaxIds {
  const PaymentLinksResourceInvoiceSettingsAccountTaxIds({this.string = const Omittable.absent(),
this.taxId = const Omittable.absent(),
this.deletedTaxId = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const PaymentLinksResourceInvoiceSettingsAccountTaxIds._({required this.rawValue, required this.string,
required this.taxId,
required this.deletedTaxId,});
  factory PaymentLinksResourceInvoiceSettingsAccountTaxIds.fromJson(Object? json) => PaymentLinksResourceInvoiceSettingsAccountTaxIds._(
...
if (deletedTaxId.isPresent) deletedTaxId.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is PaymentLinksResourceInvoiceSettingsAccountTaxIds && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'PaymentLinksResourceInvoiceSettingsAccountTaxIds(${toJson()})';
}
