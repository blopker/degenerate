...
@immutable final class PostPaymentRecordsReportPaymentRequestCustomerDetails {const PostPaymentRecordsReportPaymentRequestCustomerDetails({this.customer, this.email, this.name, this.phone, });
