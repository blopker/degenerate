...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingMxn {const TippingMxn({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingMxn.fromJson(Map<String, dynamic> json) { return TippingMxn(
...
TippingMxn copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingMxn(
...
@override String toString() { return 'TippingMxn(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
