...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingMxn {const TippingMxn({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
