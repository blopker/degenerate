...
factory PostQuotesRequest.fromJson(Map<String, dynamic> json) {return PostQuotesRequest(
  applicationFeeAmount: json['application_fee_amount'] != null ? PostQuotesRequestApplicationFeeAmount.fromJson(json['application_fee_amount']) : null,
  applicationFeePercent: json['application_fee_percent'] != null ? PostQuotesRequestApplicationFeePercent.fromJson(json['application_fee_percent']) : null,
  ...
  defaultTaxRates: json['default_tax_rates'] != null ? PostQuotesRequestDefaultTaxRates.fromJson(json['default_tax_rates']) : null,
  description: json['description'] != null ? PostQuotesRequestDescription.fromJson(json['description']) : null,
  discounts: json['discounts'] != null ? PostQuotesRequestDiscounts.fromJson(json['discounts']) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  expiresAt: json['expires_at'] != null ? (json['expires_at'] as num).toInt() : null,
  footer: json['footer'] != null ? PostQuotesRequestFooter.fromJson(json['footer']) : null,
  fromQuote: json['from_quote'] != null ? PostQuotesRequestFromQuote.fromJson(json['from_quote'] as Map<String, dynamic>) : null,
  header: json['header'] != null ? PostQuotesRequestHeader.fromJson(json['header']) : null,
  ...
  onBehalfOf: json['on_behalf_of'] != null ? PostQuotesRequestOnBehalfOf.fromJson(json['on_behalf_of']) : null,
  ...
  transferData: json['transfer_data'] != null ? PostQuotesRequestTransferData.fromJson(json['transfer_data']) : null,
);}
