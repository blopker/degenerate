...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'payment_intent_payment_method_options_acss_debit2.dart';import 'payment_intent_payment_method_options_affirm.dart';import 'payment_intent_payment_method_options_afterpay_clearpay.dart';import 'payment_intent_payment_method_options_alipay.dart';import 'payment_intent_payment_method_options_alma.dart';import 'payment_intent_payment_method_options_amazon_pay.dart';import 'payment_intent_payment_method_options_au_becs_debit2.dart';import 'payment_intent_payment_method_options_bacs_debit2.dart';import 'payment_intent_payment_method_options_bancontact.dart';import 'payment_intent_payment_method_options_billie.dart';import 'payment_intent_payment_method_options_blik2.dart';import 'payment_intent_payment_method_options_boleto.dart';import 'payment_intent_payment_method_options_card2.dart';import 'payment_intent_payment_method_options_card_present.dart';import 'payment_intent_payment_method_options_cashapp.dart';import 'payment_intent_payment_method_options_crypto.dart';import 'payment_intent_payment_method_options_customer_balance.dart';import 'payment_intent_payment_method_options_eps2.dart';import 'payment_intent_payment_method_options_fpx.dart';import 'payment_intent_payment_method_options_giropay.dart';import 'payment_intent_payment_method_options_grabpay.dart';import 'payment_intent_payment_method_options_ideal.dart';import 'payment_intent_payment_method_options_interac_present.dart';import 'payment_intent_payment_method_options_kakao_pay.dart';import 'payment_intent_payment_method_options_klarna.dart';import 'payment_intent_payment_method_options_konbini.dart';import 'payment_intent_payment_method_options_kr_card.dart';import 'payment_intent_payment_method_options_link2.dart';import 'payment_intent_payment_method_options_mb_way.dart';import 'payment_intent_payment_method_options_mobilepay2.dart';import 'payment_intent_payment_method_options_multibanco.dart';import 'payment_intent_payment_method_options_naver_pay.dart';import 'payment_intent_payment_method_options_nz_bank_account2.dart';import 'payment_intent_payment_method_options_oxxo.dart';import 'payment_intent_payment_method_options_p24.dart';import 'payment_intent_payment_method_options_pay_by_bank.dart';import 'payment_intent_payment_method_options_payco.dart';import 'payment_intent_payment_method_options_paynow.dart';import 'payment_intent_payment_method_options_paypal.dart';import 'payment_intent_payment_method_options_payto2.dart';import 'payment_intent_payment_method_options_pix.dart';import 'payment_intent_payment_method_options_promptpay.dart';import 'payment_intent_payment_method_options_revolut_pay.dart';import 'payment_intent_payment_method_options_samsung_pay.dart';import 'payment_intent_payment_method_options_satispay.dart';import 'payment_intent_payment_method_options_sepa_debit2.dart';import 'payment_intent_payment_method_options_sofort.dart';import 'payment_intent_payment_method_options_swish2.dart';import 'payment_intent_payment_method_options_twint.dart';import 'payment_intent_payment_method_options_us_bank_account2.dart';import 'payment_intent_payment_method_options_wechat_pay.dart';import 'payment_intent_payment_method_options_zip.dart';/// 
@immutable final class PaymentIntentPaymentMethodOptions {const PaymentIntentPaymentMethodOptions({this.eps, this.affirm, this.afterpayClearpay, this.alipay, this.alma, this.amazonPay, this.auBecsDebit, this.bacsDebit, this.bancontact, this.billie, this.blik, this.boleto, this.card, this.cardPresent, this.cashapp, this.crypto, this.customerBalance, this.acssDebit, this.fpx, this.giropay, this.grabpay, this.ideal, this.interacPresent, this.kakaoPay, this.klarna, this.konbini, this.krCard, this.link, this.mbWay, this.mobilepay, this.multibanco, this.naverPay, this.nzBankAccount, this.zip, this.p24, this.payByBank, this.payco, this.paynow, this.paypal, this.payto, this.pix, this.promptpay, this.revolutPay, this.samsungPay, this.satispay, this.sepaDebit, this.sofort, this.swish, this.twint, this.usBankAccount, this.wechatPay, this.oxxo, });

factory PaymentIntentPaymentMethodOptions.fromJson(Map<String, dynamic> json) {return PaymentIntentPaymentMethodOptions(
  acssDebit: json['acss_debit'] != null ? PaymentIntentPaymentMethodOptionsAcssDebit2.fromJson(json['acss_debit']) : null,
  affirm: json['affirm'] != null ? PaymentIntentPaymentMethodOptionsAffirm.fromJson(json['affirm']) : null,
  afterpayClearpay: json['afterpay_clearpay'] != null ? PaymentIntentPaymentMethodOptionsAfterpayClearpay.fromJson(json['afterpay_clearpay']) : null,
  alipay: json['alipay'] != null ? PaymentIntentPaymentMethodOptionsAlipay.fromJson(json['alipay']) : null,
  alma: json['alma'] != null ? PaymentIntentPaymentMethodOptionsAlma.fromJson(json['alma']) : null,
  amazonPay: json['amazon_pay'] != null ? PaymentIntentPaymentMethodOptionsAmazonPay.fromJson(json['amazon_pay']) : null,
  auBecsDebit: json['au_becs_debit'] != null ? PaymentIntentPaymentMethodOptionsAuBecsDebit2.fromJson(json['au_becs_debit']) : null,
  bacsDebit: json['bacs_debit'] != null ? PaymentIntentPaymentMethodOptionsBacsDebit2.fromJson(json['bacs_debit']) : null,
  bancontact: json['bancontact'] != null ? PaymentIntentPaymentMethodOptionsBancontact.fromJson(json['bancontact']) : null,
  billie: json['billie'] != null ? PaymentIntentPaymentMethodOptionsBillie.fromJson(json['billie']) : null,
  blik: json['blik'] != null ? PaymentIntentPaymentMethodOptionsBlik2.fromJson(json['blik']) : null,
  boleto: json['boleto'] != null ? PaymentIntentPaymentMethodOptionsBoleto.fromJson(json['boleto']) : null,
  card: json['card'] != null ? PaymentIntentPaymentMethodOptionsCard2.fromJson(json['card']) : null,
  cardPresent: json['card_present'] != null ? PaymentIntentPaymentMethodOptionsCardPresent.fromJson(json['card_present']) : null,
  cashapp: json['cashapp'] != null ? PaymentIntentPaymentMethodOptionsCashapp.fromJson(json['cashapp']) : null,
  crypto: json['crypto'] != null ? PaymentIntentPaymentMethodOptionsCrypto.fromJson(json['crypto']) : null,
  customerBalance: json['customer_balance'] != null ? PaymentIntentPaymentMethodOptionsCustomerBalance.fromJson(json['customer_balance']) : null,
  eps: json['eps'] != null ? PaymentIntentPaymentMethodOptionsEps2.fromJson(json['eps']) : null,
  fpx: json['fpx'] != null ? PaymentIntentPaymentMethodOptionsFpx.fromJson(json['fpx']) : null,
  giropay: json['giropay'] != null ? PaymentIntentPaymentMethodOptionsGiropay.fromJson(json['giropay']) : null,
  grabpay: json['grabpay'] != null ? PaymentIntentPaymentMethodOptionsGrabpay.fromJson(json['grabpay']) : null,
  ideal: json['ideal'] != null ? PaymentIntentPaymentMethodOptionsIdeal.fromJson(json['ideal']) : null,
  interacPresent: json['interac_present'] != null ? PaymentIntentPaymentMethodOptionsInteracPresent.fromJson(json['interac_present']) : null,
  kakaoPay: json['kakao_pay'] != null ? PaymentIntentPaymentMethodOptionsKakaoPay.fromJson(json['kakao_pay']) : null,
  klarna: json['klarna'] != null ? PaymentIntentPaymentMethodOptionsKlarna.fromJson(json['klarna']) : null,
  konbini: json['konbini'] != null ? PaymentIntentPaymentMethodOptionsKonbini.fromJson(json['konbini']) : null,
  krCard: json['kr_card'] != null ? PaymentIntentPaymentMethodOptionsKrCard.fromJson(json['kr_card']) : null,
  link: json['link'] != null ? PaymentIntentPaymentMethodOptionsLink2.fromJson(json['link']) : null,
  mbWay: json['mb_way'] != null ? PaymentIntentPaymentMethodOptionsMbWay.fromJson(json['mb_way']) : null,
  mobilepay: json['mobilepay'] != null ? PaymentIntentPaymentMethodOptionsMobilepay2.fromJson(json['mobilepay']) : null,
  multibanco: json['multibanco'] != null ? PaymentIntentPaymentMethodOptionsMultibanco.fromJson(json['multibanco']) : null,
  naverPay: json['naver_pay'] != null ? PaymentIntentPaymentMethodOptionsNaverPay.fromJson(json['naver_pay']) : null,
  nzBankAccount: json['nz_bank_account'] != null ? PaymentIntentPaymentMethodOptionsNzBankAccount2.fromJson(json['nz_bank_account']) : null,
  oxxo: json['oxxo'] != null ? PaymentIntentPaymentMethodOptionsOxxo.fromJson(json['oxxo']) : null,
  p24: json['p24'] != null ? PaymentIntentPaymentMethodOptionsP24.fromJson(json['p24']) : null,
  payByBank: json['pay_by_bank'] != null ? PaymentIntentPaymentMethodOptionsPayByBank.fromJson(json['pay_by_bank']) : null,
  payco: json['payco'] != null ? PaymentIntentPaymentMethodOptionsPayco.fromJson(json['payco']) : null,
  paynow: json['paynow'] != null ? PaymentIntentPaymentMethodOptionsPaynow.fromJson(json['paynow']) : null,
  paypal: json['paypal'] != null ? PaymentIntentPaymentMethodOptionsPaypal.fromJson(json['paypal']) : null,
  payto: json['payto'] != null ? PaymentIntentPaymentMethodOptionsPayto2.fromJson(json['payto']) : null,
  pix: json['pix'] != null ? PaymentIntentPaymentMethodOptionsPix.fromJson(json['pix']) : null,
  promptpay: json['promptpay'] != null ? PaymentIntentPaymentMethodOptionsPromptpay.fromJson(json['promptpay']) : null,
  revolutPay: json['revolut_pay'] != null ? PaymentIntentPaymentMethodOptionsRevolutPay.fromJson(json['revolut_pay']) : null,
  samsungPay: json['samsung_pay'] != null ? PaymentIntentPaymentMethodOptionsSamsungPay.fromJson(json['samsung_pay']) : null,
  satispay: json['satispay'] != null ? PaymentIntentPaymentMethodOptionsSatispay.fromJson(json['satispay']) : null,
  sepaDebit: json['sepa_debit'] != null ? PaymentIntentPaymentMethodOptionsSepaDebit2.fromJson(json['sepa_debit']) : null,
  sofort: json['sofort'] != null ? PaymentIntentPaymentMethodOptionsSofort.fromJson(json['sofort']) : null,
  swish: json['swish'] != null ? PaymentIntentPaymentMethodOptionsSwish2.fromJson(json['swish']) : null,
  twint: json['twint'] != null ? PaymentIntentPaymentMethodOptionsTwint.fromJson(json['twint']) : null,
  usBankAccount: json['us_bank_account'] != null ? PaymentIntentPaymentMethodOptionsUsBankAccount2.fromJson(json['us_bank_account']) : null,
  wechatPay: json['wechat_pay'] != null ? PaymentIntentPaymentMethodOptionsWechatPay.fromJson(json['wechat_pay']) : null,
  zip: json['zip'] != null ? PaymentIntentPaymentMethodOptionsZip.fromJson(json['zip']) : null,
);}
