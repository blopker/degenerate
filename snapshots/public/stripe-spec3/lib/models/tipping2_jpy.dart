...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Jpy {const Tipping2Jpy({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
