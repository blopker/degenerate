...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Jpy {const Tipping2Jpy({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Jpy.fromJson(Map<String, dynamic> json) { return Tipping2Jpy(
...
Tipping2Jpy copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Jpy(
...
@override String toString() { return 'Tipping2Jpy(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
