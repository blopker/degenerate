...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsGbStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsGbStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsGbStandard {const PostTaxRegistrationsRequestCountryOptionsGbStandard({this.placeOfSupplyScheme});
