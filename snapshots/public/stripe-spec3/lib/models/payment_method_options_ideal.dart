...
final class PaymentMethodOptionsIdealSetupFutureUsage {const PaymentMethodOptionsIdealSetupFutureUsage._(this.value);
...
static const PaymentMethodOptionsIdealSetupFutureUsage offSession = PaymentMethodOptionsIdealSetupFutureUsage._('off_session');

static const List<PaymentMethodOptionsIdealSetupFutureUsage> values = [none, offSession];
...
/// 
final class PaymentMethodOptionsIdeal {const PaymentMethodOptionsIdeal({this.setupFutureUsage});
