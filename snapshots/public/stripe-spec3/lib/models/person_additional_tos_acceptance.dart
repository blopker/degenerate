...
@immutable final class PersonAdditionalTosAcceptance {const PersonAdditionalTosAcceptance({this.date = const Omittable.absent(), this.ip = const Omittable.absent(), this.userAgent = const Omittable.absent(), });
...
PersonAdditionalTosAcceptance copyWith({Omittable<int?>? date, Omittable<String?>? ip, Omittable<String?>? userAgent, }) { return PersonAdditionalTosAcceptance(
  date: date ?? this.date,
  ip: ip ?? this.ip,
