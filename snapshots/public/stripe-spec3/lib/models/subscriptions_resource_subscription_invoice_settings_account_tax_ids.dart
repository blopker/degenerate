...
@immutable
final class SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds {
  const SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds({this.string = const Omittable.absent(),
this.taxId = const Omittable.absent(),
this.deletedTaxId = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds._({required this.rawValue, required this.string,
required this.taxId,
required this.deletedTaxId,});
  factory SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds.fromJson(Object? json) => SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds._(
...
if (deletedTaxId.isPresent) deletedTaxId.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds(${toJson()})';
}
