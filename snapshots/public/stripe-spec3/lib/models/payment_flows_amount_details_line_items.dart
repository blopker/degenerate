...
factory PaymentFlowsAmountDetailsLineItemsObject.fromJson(String json) { return switch (json) {
  'list' => list,
  _ => PaymentFlowsAmountDetailsLineItemsObject._(json),
}; }

static const PaymentFlowsAmountDetailsLineItemsObject list = PaymentFlowsAmountDetailsLineItemsObject._('list');

static const List<PaymentFlowsAmountDetailsLineItemsObject> values = [list];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is PaymentFlowsAmountDetailsLineItemsObject && other.value == value; } 
...
factory PaymentFlowsAmountDetailsLineItems.fromJson(Map<String, dynamic> json) { return PaymentFlowsAmountDetailsLineItems(
  ...
  object: PaymentFlowsAmountDetailsLineItemsObject.fromJson(json['object'] as String),
...
final PaymentFlowsAmountDetailsLineItemsObject object;
...
PaymentFlowsAmountDetailsLineItems copyWith({List<PaymentIntentAmountDetailsLineItem>? data, bool? hasMore, PaymentFlowsAmountDetailsLineItemsObject? object, String? url, }) { return PaymentFlowsAmountDetailsLineItems(
  data: data ?? this.data,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PaymentFlowsAmountDetailsLineItems &&
          listEquals(data, other.data) &&
          hasMore == other.hasMore &&
          object == other.object &&
          url == other.url; } 
@override int get hashCode { return Object.hash(Object.hashAll(data), hasMore, object, url); } 
@override String toString() { return 'PaymentFlowsAmountDetailsLineItems(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
