...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Gbp {const Tipping2Gbp({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Gbp.fromJson(Map<String, dynamic> json) { return Tipping2Gbp(
...
Tipping2Gbp copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Gbp(
...
@override String toString() { return 'Tipping2Gbp(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
