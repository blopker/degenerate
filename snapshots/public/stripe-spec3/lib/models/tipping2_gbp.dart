...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Gbp {const Tipping2Gbp({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
