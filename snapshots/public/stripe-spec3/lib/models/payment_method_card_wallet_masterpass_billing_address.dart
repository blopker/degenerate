...
final class PaymentMethodCardWalletMasterpassBillingAddress {const PaymentMethodCardWalletMasterpassBillingAddress({this.address});

factory PaymentMethodCardWalletMasterpassBillingAddress.fromJson(Map<String, dynamic> json) { return PaymentMethodCardWalletMasterpassBillingAddress(
