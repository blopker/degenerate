...
factory PostTerminalLocationsRequest.fromJson(Map<String, dynamic> json) { return PostTerminalLocationsRequest(
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), fromB: (v) => PostTerminalLocationsRequestMetadataVariant2.fromJson(v as String),) : null,
...
final PostTerminalLocationsRequestAddressKana? addressKana;

/// The Kanji variation of the full address of the location (Japan only).
final PostTerminalLocationsRequestAddressKanji? addressKanji;
...
final PostTerminalLocationsRequestMetadata? metadata;
