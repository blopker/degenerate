...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostIssuingSettlementsSettlementRequest {const PostIssuingSettlementsSettlementRequest({this.expand, this.metadata, });
...
@override String toString() { return 'PostIssuingSettlementsSettlementRequest(expand: $expand, metadata: $metadata)'; } 
 }
