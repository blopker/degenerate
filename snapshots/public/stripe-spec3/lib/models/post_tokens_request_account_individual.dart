...
factory PostTokensRequestAccountIndividual.fromJson(Map<String, dynamic> json) { return PostTokensRequestAccountIndividual(
  ...
  dob: json['dob'] != null ? OneOf2.parse(json['dob'], fromA: (v) => DateOfBirthSpecs7.fromJson(v as Map<String, dynamic>), fromB: (v) => PostTokensRequestAccountIndividualDobVariant2.fromJson(v as String),) : null,
  email: json['email'] as String?,
  firstName: json['first_name'] as String?,
  firstNameKana: json['first_name_kana'] as String?,
  firstNameKanji: json['first_name_kanji'] as String?,
  fullNameAliases: json['full_name_aliases'] != null ? OneOf2.parse(json['full_name_aliases'], fromA: (v) => (v as List<dynamic>).map((e) => e as String).toList(), fromB: (v) => PostTokensRequestAccountIndividualFullNameAliasesVariant2.fromJson(v as String),) : null,
  ...
  metadata: json['metadata'] != null ? OneOf2.parse(json['metadata'], fromA: (v) => (v as Map<String, dynamic>).map((k, v) => MapEntry(k, v as String)), fromB: (v) => PostTokensRequestAccountIndividualMetadataVariant2.fromJson(v as String),) : null,
