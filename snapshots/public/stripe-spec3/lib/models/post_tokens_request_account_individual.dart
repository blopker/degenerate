...
factory PostTokensRequestAccountIndividual.fromJson(Map<String, dynamic> json) {return PostTokensRequestAccountIndividual(
  ...
  dob: json['dob'] != null ? PostTokensRequestAccountIndividualDob.fromJson(json['dob']) : null,
  email: json['email'] as String?,
  firstName: json['first_name'] as String?,
  firstNameKana: json['first_name_kana'] as String?,
  firstNameKanji: json['first_name_kanji'] as String?,
  fullNameAliases: json['full_name_aliases'] != null ? PostTokensRequestAccountIndividualFullNameAliases.fromJson(json['full_name_aliases']) : null,
  ...
  metadata: json['metadata'] != null ? PostTokensRequestAccountIndividualMetadata.fromJson(json['metadata']) : null,
