...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Huf {const Tipping2Huf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
