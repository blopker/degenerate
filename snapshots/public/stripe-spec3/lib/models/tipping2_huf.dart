...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Huf {const Tipping2Huf({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Huf.fromJson(Map<String, dynamic> json) { return Tipping2Huf(
...
Tipping2Huf copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Huf(
...
@override String toString() { return 'Tipping2Huf(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
