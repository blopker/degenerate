...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer.dart';import 'deleted_customer.dart';/// The ID of the customer associated with this discount.
@immutable
final class DeletedDiscountCustomer {
  const DeletedDiscountCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const DeletedDiscountCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory DeletedDiscountCustomer.fromJson(Object? json) => DeletedDiscountCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is DeletedDiscountCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'DeletedDiscountCustomer(${toJson()})';
}
