...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsConfigurationRequestCartesBancairesDisplayPreferencePreference {const PostPaymentMethodConfigurationsConfigurationRequestCartesBancairesDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsConfigurationRequestCartesBancairesDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestCartesBancairesDisplayPreference({this.preference});
