...
@immutable
final class TreasuryOutboundTransferTransaction {
  const TreasuryOutboundTransferTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryOutboundTransferTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryOutboundTransferTransaction.fromJson(Object? json) => TreasuryOutboundTransferTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryOutboundTransferTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryOutboundTransferTransaction(${toJson()})';
}
