...
final Omittable<List<PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds>?> accountTaxIds;
...
PaymentPagesCheckoutSessionInvoiceSettings copyWith({Omittable<List<PaymentPagesCheckoutSessionInvoiceSettingsAccountTaxIds>?>? accountTaxIds, Omittable<List<InvoiceSettingCustomField>?>? customFields, Omittable<String?>? description, Omittable<String?>? footer, Omittable<ConnectAccountReference?>? issuer, Omittable<Map<String,String>?>? metadata, Omittable<InvoiceSettingCheckoutRenderingOptions?>? renderingOptions, }) { return PaymentPagesCheckoutSessionInvoiceSettings(
