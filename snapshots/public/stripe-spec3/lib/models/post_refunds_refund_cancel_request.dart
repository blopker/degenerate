...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostRefundsRefundCancelRequest {const PostRefundsRefundCancelRequest({this.expand});
