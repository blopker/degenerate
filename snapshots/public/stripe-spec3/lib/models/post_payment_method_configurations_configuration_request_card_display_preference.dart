...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostPaymentMethodConfigurationsConfigurationRequestCardDisplayPreferencePreference {const PostPaymentMethodConfigurationsConfigurationRequestCardDisplayPreferencePreference._(this.value);
...
@immutable final class PostPaymentMethodConfigurationsConfigurationRequestCardDisplayPreference {const PostPaymentMethodConfigurationsConfigurationRequestCardDisplayPreference({this.preference});
