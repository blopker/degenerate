...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingRon {const TippingRon({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingRon.fromJson(Map<String, dynamic> json) { return TippingRon(
...
TippingRon copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingRon(
...
@override String toString() { return 'TippingRon(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
