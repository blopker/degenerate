...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingRon {const TippingRon({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
