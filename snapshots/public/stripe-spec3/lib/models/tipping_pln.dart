...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingPln {const TippingPln({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingPln.fromJson(Map<String, dynamic> json) { return TippingPln(
...
TippingPln copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingPln(
...
@override String toString() { return 'TippingPln(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
