...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingPln {const TippingPln({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
