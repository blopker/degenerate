...
factory CustomerTaxIdsObject.fromJson(String json) { return switch (json) {
  'list' => list,
  _ => CustomerTaxIdsObject._(json),
}; }

static const CustomerTaxIdsObject list = CustomerTaxIdsObject._('list');

static const List<CustomerTaxIdsObject> values = [list];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is CustomerTaxIdsObject && other.value == value; } 
