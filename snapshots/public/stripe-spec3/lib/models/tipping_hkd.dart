...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingHkd {const TippingHkd({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingHkd.fromJson(Map<String, dynamic> json) { return TippingHkd(
...
TippingHkd copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingHkd(
...
@override String toString() { return 'TippingHkd(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
