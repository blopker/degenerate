...
factory PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetails.fromJson(Map<String, dynamic> json) { return PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetails(
  address: json['address'] != null ? PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetailsAddress.fromJson(json['address']) : null,
  email: json['email'] != null ? PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetailsEmail.fromJson(json['email']) : null,
  name: json['name'] != null ? PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetailsName.fromJson(json['name']) : null,
  phone: json['phone'] != null ? PostPaymentIntentsIntentRequestPaymentMethodDataBillingDetailsPhone.fromJson(json['phone']) : null,
