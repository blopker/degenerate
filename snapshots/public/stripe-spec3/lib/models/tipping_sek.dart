...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingSek {const TippingSek({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
