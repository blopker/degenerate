...
final class PostTaxRegistrationsRequestCountryOptionsBfStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsBfStandardPlaceOfSupplyScheme._(this.value);
...
final class PostTaxRegistrationsRequestCountryOptionsBfStandard {const PostTaxRegistrationsRequestCountryOptionsBfStandard({this.placeOfSupplyScheme});
