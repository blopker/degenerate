...
import 'post_tax_registrations_request_country_options_uy_standard.dart';final class PostTaxRegistrationsRequestCountryOptionsUyType {const PostTaxRegistrationsRequestCountryOptionsUyType._(this.value);
...
final class PostTaxRegistrationsRequestCountryOptionsUy {const PostTaxRegistrationsRequestCountryOptionsUy({this.standard, required this.type, });
