...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostAccountsAccountRequestDocumentsBankAccountOwnershipVerification {const PostAccountsAccountRequestDocumentsBankAccountOwnershipVerification({this.files});
