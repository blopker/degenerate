...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostExternalAccountsIdRequestDocumentsBankAccountOwnershipVerification {const PostExternalAccountsIdRequestDocumentsBankAccountOwnershipVerification({this.files});
