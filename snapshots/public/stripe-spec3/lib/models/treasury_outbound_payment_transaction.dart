...
final class TreasuryOutboundPaymentTransaction {
  const TreasuryOutboundPaymentTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryOutboundPaymentTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryOutboundPaymentTransaction.fromJson(Object? json) => TreasuryOutboundPaymentTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryOutboundPaymentTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryOutboundPaymentTransaction(${toJson()})';
}
