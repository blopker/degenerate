...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'customer.dart';import 'deleted_customer.dart';/// ID of the customer who owns the subscription schedule.
@immutable
final class SubscriptionScheduleCustomer {
  const SubscriptionScheduleCustomer({this.string = const Omittable.absent(),
this.customer = const Omittable.absent(),
this.deletedCustomer = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const SubscriptionScheduleCustomer._({required this.rawValue, required this.string,
required this.customer,
required this.deletedCustomer,});
  factory SubscriptionScheduleCustomer.fromJson(Object? json) => SubscriptionScheduleCustomer._(
...
if (deletedCustomer.isPresent) deletedCustomer.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is SubscriptionScheduleCustomer && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'SubscriptionScheduleCustomer(${toJson()})';
}
