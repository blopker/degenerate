...
final class PostTaxRegistrationsRequestCountryOptionsSgStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsSgStandardPlaceOfSupplyScheme._(this.value);
...
final class PostTaxRegistrationsRequestCountryOptionsSgStandard {const PostTaxRegistrationsRequestCountryOptionsSgStandard({this.placeOfSupplyScheme});
