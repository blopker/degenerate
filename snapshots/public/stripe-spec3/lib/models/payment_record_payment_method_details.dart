...
final class PaymentRecordPaymentMethodDetails {const PaymentRecordPaymentMethodDetails({this.paymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails});

factory PaymentRecordPaymentMethodDetails.fromJson(Map<String, dynamic> json) { return PaymentRecordPaymentMethodDetails(
