...
final class PostRadarPaymentEvaluationsRequestCustomerDetails {const PostRadarPaymentEvaluationsRequestCustomerDetails({this.customer, this.customerAccount, this.email, this.name, this.phone, });
