...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostAccountsRequestDocumentsProofOfAddress {const PostAccountsRequestDocumentsProofOfAddress({this.files});
