...
final class PostPaymentMethodConfigurationsRequestGrabpayDisplayPreferencePreference {const PostPaymentMethodConfigurationsRequestGrabpayDisplayPreferencePreference._(this.value);
...
final class PostPaymentMethodConfigurationsRequestGrabpayDisplayPreference {const PostPaymentMethodConfigurationsRequestGrabpayDisplayPreference({this.preference});
