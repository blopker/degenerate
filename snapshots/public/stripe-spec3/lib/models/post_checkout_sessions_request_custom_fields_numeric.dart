...
PostCheckoutSessionsRequestCustomFieldsNumeric copyWith({String Function()? defaultValue, int Function()? maximumLength, int Function()? minimumLength, }) { return PostCheckoutSessionsRequestCustomFieldsNumeric(
...
@override String toString() { return 'PostCheckoutSessionsRequestCustomFieldsNumeric(defaultValue: $defaultValue, maximumLength: $maximumLength, minimumLength: $minimumLength)'; } 
 }
