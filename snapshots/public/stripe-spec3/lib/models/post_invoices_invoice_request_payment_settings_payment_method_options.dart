...
factory PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptions.fromJson(Map<String, dynamic> json) { return PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptions(
  acssDebit: json['acss_debit'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsAcssDebit.fromJson(json['acss_debit']) : null,
  bancontact: json['bancontact'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsBancontact.fromJson(json['bancontact']) : null,
  card: json['card'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsCard.fromJson(json['card']) : null,
  customerBalance: json['customer_balance'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsCustomerBalance.fromJson(json['customer_balance']) : null,
  konbini: json['konbini'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsKonbini.fromJson(json['konbini']) : null,
  payto: json['payto'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsPayto.fromJson(json['payto']) : null,
  sepaDebit: json['sepa_debit'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsSepaDebit.fromJson(json['sepa_debit']) : null,
  usBankAccount: json['us_bank_account'] != null ? PostInvoicesInvoiceRequestPaymentSettingsPaymentMethodOptionsUsBankAccount.fromJson(json['us_bank_account']) : null,
); }
