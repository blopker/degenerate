...
@immutable final class PaymentMethodDetailsCardWalletVisaCheckout {const PaymentMethodDetailsCardWalletVisaCheckout({this.billingAddress = const Omittable.absent(), this.email = const Omittable.absent(), this.name = const Omittable.absent(), this.shippingAddress = const Omittable.absent(), });
...
PaymentMethodDetailsCardWalletVisaCheckout copyWith({Omittable<Address?>? billingAddress, Omittable<String?>? email, Omittable<String?>? name, Omittable<Address?>? shippingAddress, }) { return PaymentMethodDetailsCardWalletVisaCheckout(
