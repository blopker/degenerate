...
@immutable final class PaymentMethodDetailsCardWalletVisaCheckout {const PaymentMethodDetailsCardWalletVisaCheckout({this.billingAddress, this.email, this.name, this.shippingAddress, });
...
PaymentMethodDetailsCardWalletVisaCheckout copyWith({Address? Function()? billingAddress, String? Function()? email, String? Function()? name, Address? Function()? shippingAddress, }) { return PaymentMethodDetailsCardWalletVisaCheckout(
