...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_subscription_items_item_request_billing_thresholds.dart';import 'post_subscription_items_item_request_discounts.dart';import 'post_subscription_items_item_request_metadata.dart';import 'post_subscription_items_item_request_price_data.dart';import 'post_subscription_items_item_request_tax_rates.dart';/// Use `allow_incomplete` to transition the subscription to `status=past_due` if a payment is required but cannot be paid. This allows you to manage scenarios where additional user actions are needed to pay a subscription's invoice. For example, SCA regulation may require 3DS authentication to complete payment. See the [SCA Migration Guide](https://docs.stripe.com/billing/migration/strong-customer-authentication) for Billing to learn more. This is the default behavior.
/// 
...
factory PostSubscriptionItemsItemRequest.fromJson(Map<String, dynamic> json) { return PostSubscriptionItemsItemRequest(
  billingThresholds: json['billing_thresholds'] != null ? PostSubscriptionItemsItemRequestBillingThresholds.fromJson(json['billing_thresholds']) : null,
  discounts: json['discounts'] != null ? PostSubscriptionItemsItemRequestDiscounts.fromJson(json['discounts']) : null,
  expand: (json['expand'] as List<dynamic>?)?.map((e) => e as String).toList(),
  metadata: json['metadata'] != null ? PostSubscriptionItemsItemRequestMetadata.fromJson(json['metadata']) : null,
  ...
  taxRates: json['tax_rates'] != null ? PostSubscriptionItemsItemRequestTaxRates.fromJson(json['tax_rates']) : null,
); }
