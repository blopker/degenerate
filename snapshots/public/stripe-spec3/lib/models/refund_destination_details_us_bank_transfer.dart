...
@immutable final class RefundDestinationDetailsUsBankTransfer {const RefundDestinationDetailsUsBankTransfer({this.reference = const Omittable.absent(), this.referenceStatus = const Omittable.absent(), });
...
RefundDestinationDetailsUsBankTransfer copyWith({Omittable<String?>? reference, Omittable<String?>? referenceStatus, }) { return RefundDestinationDetailsUsBankTransfer(
