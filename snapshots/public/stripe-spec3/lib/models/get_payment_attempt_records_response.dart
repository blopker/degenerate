...
final class GetPaymentAttemptRecordsResponseObject {const GetPaymentAttemptRecordsResponseObject._(this.value);
...
final class GetPaymentAttemptRecordsResponse {const GetPaymentAttemptRecordsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
