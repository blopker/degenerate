...
factory PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettings.fromJson(Map<String, dynamic> json) { return PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettings(
  accountTaxIds: json['account_tax_ids'] != null ? PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsAccountTaxIds.fromJson(json['account_tax_ids']) : null,
  daysUntilDue: json['days_until_due'] != null ? (json['days_until_due'] as num).toInt() : null,
  issuer: json['issuer'] != null ? PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsIssuer.fromJson(json['issuer'] as Map<String, dynamic>) : null,
); }

final PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsAccountTaxIds? accountTaxIds;

final int? daysUntilDue;

final PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsIssuer? issuer;
...
PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettings copyWith({PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsAccountTaxIds? Function()? accountTaxIds, int? Function()? daysUntilDue, PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettingsIssuer? Function()? issuer, }) { return PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettings(
...
@override String toString() { return 'PostSubscriptionSchedulesScheduleRequestPhasesInvoiceSettings(accountTaxIds: $accountTaxIds, daysUntilDue: $daysUntilDue, issuer: $issuer)'; } 
 }
