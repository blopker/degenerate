...
factory GetPlansResponseObject.fromJson(String json) { return switch (json) {
  'list' => list,
  _ => GetPlansResponseObject._(json),
}; }

static const GetPlansResponseObject list = GetPlansResponseObject._('list');

static const List<GetPlansResponseObject> values = [list];
...
@override bool operator ==(Object other) { return identical(this, other) ||
    other is GetPlansResponseObject && other.value == value; } 
...
factory GetPlansResponse.fromJson(Map<String, dynamic> json) { return GetPlansResponse(
  ...
  object: GetPlansResponseObject.fromJson(json['object'] as String),
...
final GetPlansResponseObject object;
...
GetPlansResponse copyWith({List<Plan>? data, bool? hasMore, GetPlansResponseObject? object, String? url, }) { return GetPlansResponse(
  data: data ?? this.data,
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetPlansResponse &&
          listEquals(data, other.data) &&
          hasMore == other.hasMore &&
          object == other.object &&
          url == other.url; } 
@override int get hashCode { return Object.hash(Object.hashAll(data), hasMore, object, url); } 
@override String toString() { return 'GetPlansResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
