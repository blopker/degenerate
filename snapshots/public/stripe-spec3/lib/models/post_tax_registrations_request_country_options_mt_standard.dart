...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class PostTaxRegistrationsRequestCountryOptionsMtStandardPlaceOfSupplyScheme {const PostTaxRegistrationsRequestCountryOptionsMtStandardPlaceOfSupplyScheme._(this.value);
...
@immutable final class PostTaxRegistrationsRequestCountryOptionsMtStandard {const PostTaxRegistrationsRequestCountryOptionsMtStandard({required this.placeOfSupplyScheme});
