...
@immutable
final class TreasuryTransactionEntryTransaction {
  const TreasuryTransactionEntryTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryTransactionEntryTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryTransactionEntryTransaction.fromJson(Object? json) => TreasuryTransactionEntryTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryTransactionEntryTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryTransactionEntryTransaction(${toJson()})';
}
