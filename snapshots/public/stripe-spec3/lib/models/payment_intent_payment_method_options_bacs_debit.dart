...
import 'payment_intent_payment_method_options_mandate_options_bacs_debit.dart';/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
/// 
...
final class PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage {const PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage._(this.value);
...
/// 
final class PaymentIntentPaymentMethodOptionsBacsDebit {const PaymentIntentPaymentMethodOptionsBacsDebit({this.mandateOptions, this.setupFutureUsage, this.targetDate, });
