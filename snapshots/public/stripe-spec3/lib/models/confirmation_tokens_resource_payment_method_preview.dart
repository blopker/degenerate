...
factory ConfirmationTokensResourcePaymentMethodPreview.fromJson(Map<String, dynamic> json) {return ConfirmationTokensResourcePaymentMethodPreview(
  ...
  customer: json.containsKey('customer') ? Omittable(json['customer'] != null ? ConfirmationTokensResourcePaymentMethodPreviewCustomer.fromJson(json['customer']) : null) : const Omittable.absent(),
