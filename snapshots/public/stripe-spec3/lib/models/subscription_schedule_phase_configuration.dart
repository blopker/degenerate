...
factory SubscriptionSchedulePhaseConfiguration.fromJson(Map<String, dynamic> json) {return SubscriptionSchedulePhaseConfiguration(
  ...
  defaultPaymentMethod: json.containsKey('default_payment_method') ? Omittable(json['default_payment_method'] != null ? SubscriptionSchedulePhaseConfigurationDefaultPaymentMethod.fromJson(json['default_payment_method']) : null) : const Omittable.absent(),
  ...
  onBehalfOf: json.containsKey('on_behalf_of') ? Omittable(json['on_behalf_of'] != null ? SubscriptionSchedulePhaseConfigurationOnBehalfOf.fromJson(json['on_behalf_of']) : null) : const Omittable.absent(),
