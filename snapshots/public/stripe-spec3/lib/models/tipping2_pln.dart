...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Pln {const Tipping2Pln({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
