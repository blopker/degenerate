...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Pln {const Tipping2Pln({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Pln.fromJson(Map<String, dynamic> json) { return Tipping2Pln(
...
Tipping2Pln copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Pln(
...
@override String toString() { return 'Tipping2Pln(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
