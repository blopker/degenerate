...
final class TaxTransactionShipFromDetails {const TaxTransactionShipFromDetails({this.taxProductResourceShipFromDetails});

factory TaxTransactionShipFromDetails.fromJson(Map<String, dynamic> json) { return TaxTransactionShipFromDetails(
