...
final class GetSubscriptionSchedulesResponseObject {const GetSubscriptionSchedulesResponseObject._(this.value);
...
/// 
final class GetSubscriptionSchedulesResponse {const GetSubscriptionSchedulesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
...
final GetSubscriptionSchedulesResponseObject object;
