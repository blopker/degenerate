...
import 'package:degenerate_runtime/degenerate_runtime.dart';import 'post_accounts_account_people_request_relationship_percent_ownership.dart';/// The relationship that this person has with the account's legal entity.
@immutable final class PostAccountsAccountPeopleRequestRelationship {const PostAccountsAccountPeopleRequestRelationship({this.authorizer, this.director, this.executive, this.legalGuardian, this.owner, this.percentOwnership, this.representative, this.title, });

factory PostAccountsAccountPeopleRequestRelationship.fromJson(Map<String, dynamic> json) { return PostAccountsAccountPeopleRequestRelationship(
...
final PostAccountsAccountPeopleRequestRelationshipPercentOwnership? percentOwnership;
...
PostAccountsAccountPeopleRequestRelationship copyWith({bool Function()? authorizer, bool Function()? director, bool Function()? executive, bool Function()? legalGuardian, bool Function()? owner, PostAccountsAccountPeopleRequestRelationshipPercentOwnership Function()? percentOwnership, bool Function()? representative, String Function()? title, }) { return PostAccountsAccountPeopleRequestRelationship(
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is PostAccountsAccountPeopleRequestRelationship &&
...
@override String toString() { return 'PostAccountsAccountPeopleRequestRelationship(authorizer: $authorizer, director: $director, executive: $executive, legalGuardian: $legalGuardian, owner: $owner, percentOwnership: $percentOwnership, representative: $representative, title: $title)'; } 
 }
