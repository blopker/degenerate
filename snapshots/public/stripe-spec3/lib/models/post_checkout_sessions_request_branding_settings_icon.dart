...
final class PostCheckoutSessionsRequestBrandingSettingsIcon {const PostCheckoutSessionsRequestBrandingSettingsIcon({this.file, required this.type, this.url, });
