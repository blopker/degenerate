...
final class GetTerminalReadersReaderResponse {
  const GetTerminalReadersReaderResponse({this.terminalReader = const Omittable.absent(),
this.deletedTerminalReader = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const GetTerminalReadersReaderResponse._({required this.rawValue, required this.terminalReader,
required this.deletedTerminalReader,});
  factory GetTerminalReadersReaderResponse.fromJson(Object? json) => GetTerminalReadersReaderResponse._(
...
if (deletedTerminalReader.isPresent) deletedTerminalReader.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is GetTerminalReadersReaderResponse && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'GetTerminalReadersReaderResponse(${toJson()})';
}
