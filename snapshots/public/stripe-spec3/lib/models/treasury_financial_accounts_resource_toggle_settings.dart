...
final class TreasuryFinancialAccountsResourceToggleSettings {const TreasuryFinancialAccountsResourceToggleSettings({required this.requested, required this.status, required this.statusDetails, });
