...
@immutable
final class TreasuryInboundTransferTransaction {
  const TreasuryInboundTransferTransaction({this.string = const Omittable.absent(),
this.treasuryTransaction = const Omittable.absent(),}) : rawValue = const Omittable.absent();
  const TreasuryInboundTransferTransaction._({required this.rawValue, required this.string,
required this.treasuryTransaction,});
  factory TreasuryInboundTransferTransaction.fromJson(Object? json) => TreasuryInboundTransferTransaction._(
...
if (treasuryTransaction.isPresent) treasuryTransaction.value?.toJson(),
  ...
  bool operator ==(Object other) => identical(this, other) ||
      other is TreasuryInboundTransferTransaction && jsonValueEquals(toJson(), other.toJson());
  @override
  int get hashCode => jsonValueHash(toJson());
  @override
  String toString() => 'TreasuryInboundTransferTransaction(${toJson()})';
}
