...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingJpy {const TippingJpy({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
