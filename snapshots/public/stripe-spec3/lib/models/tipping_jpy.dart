...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingJpy {const TippingJpy({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingJpy.fromJson(Map<String, dynamic> json) { return TippingJpy(
...
TippingJpy copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingJpy(
...
@override String toString() { return 'TippingJpy(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
