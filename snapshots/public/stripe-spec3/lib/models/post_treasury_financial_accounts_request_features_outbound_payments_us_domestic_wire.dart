...
final class PostTreasuryFinancialAccountsRequestFeaturesOutboundPaymentsUsDomesticWire {const PostTreasuryFinancialAccountsRequestFeaturesOutboundPaymentsUsDomesticWire({required this.requested});
