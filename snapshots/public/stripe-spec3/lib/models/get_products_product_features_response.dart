...
@immutable final class GetProductsProductFeaturesResponseObject {const GetProductsProductFeaturesResponseObject._(this.value);
...
/// 
@immutable final class GetProductsProductFeaturesResponse {const GetProductsProductFeaturesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
