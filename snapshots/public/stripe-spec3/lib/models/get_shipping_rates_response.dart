...
final class GetShippingRatesResponseObject {const GetShippingRatesResponseObject._(this.value);
...
/// 
final class GetShippingRatesResponse {const GetShippingRatesResponse({required this.data, required this.hasMore, required this.object, required this.url, });
...
@override bool operator ==(Object other) { return identical(this, other) ||
      other is GetShippingRatesResponse &&
          listEquals(data, other.data) &&
          hasMore == other.hasMore &&
          object == other.object &&
          url == other.url; } 
@override int get hashCode { return Object.hash(Object.hashAll(data), hasMore, object, url); } 
@override String toString() { return 'GetShippingRatesResponse(data: $data, hasMore: $hasMore, object: $object, url: $url)'; } 
 }
