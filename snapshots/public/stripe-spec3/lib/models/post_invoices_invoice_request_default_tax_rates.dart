...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostInvoicesInvoiceRequestDefaultTaxRatesVariant2 {const PostInvoicesInvoiceRequestDefaultTaxRatesVariant2._(this.value);
...
typedef PostInvoicesInvoiceRequestDefaultTaxRates = OneOf2<List<String>,PostInvoicesInvoiceRequestDefaultTaxRatesVariant2>;