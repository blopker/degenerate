...
@immutable final class PaymentMethodOptionsKrCardCaptureMethod {const PaymentMethodOptionsKrCardCaptureMethod._(this.value);
...
@immutable final class PaymentMethodOptionsKrCardSetupFutureUsage {const PaymentMethodOptionsKrCardSetupFutureUsage._(this.value);
...
/// 
@immutable final class PaymentMethodOptionsKrCard {const PaymentMethodOptionsKrCard({this.captureMethod, this.setupFutureUsage, });
