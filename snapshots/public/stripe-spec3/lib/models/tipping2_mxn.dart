...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Mxn {const Tipping2Mxn({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
