...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Mxn {const Tipping2Mxn({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Mxn.fromJson(Map<String, dynamic> json) { return Tipping2Mxn(
...
Tipping2Mxn copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Mxn(
...
@override String toString() { return 'Tipping2Mxn(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
