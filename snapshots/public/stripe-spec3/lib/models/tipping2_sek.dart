...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class Tipping2Sek {const Tipping2Sek({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
