...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Sek {const Tipping2Sek({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory Tipping2Sek.fromJson(Map<String, dynamic> json) { return Tipping2Sek(
...
Tipping2Sek copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return Tipping2Sek(
...
@override String toString() { return 'Tipping2Sek(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
