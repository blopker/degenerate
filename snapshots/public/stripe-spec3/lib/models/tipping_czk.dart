...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class TippingCzk {const TippingCzk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });

factory TippingCzk.fromJson(Map<String, dynamic> json) { return TippingCzk(
...
TippingCzk copyWith({List<int> Function()? fixedAmounts, List<int> Function()? percentages, int Function()? smartTipThreshold, }) { return TippingCzk(
...
@override String toString() { return 'TippingCzk(fixedAmounts: $fixedAmounts, percentages: $percentages, smartTipThreshold: $smartTipThreshold)'; } 
 }
