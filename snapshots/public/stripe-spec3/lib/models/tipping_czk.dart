...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class TippingCzk {const TippingCzk({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
