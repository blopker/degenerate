...
import 'package:degenerate_runtime/degenerate_runtime.dart';final class PostCheckoutSessionsSessionExpireRequest {const PostCheckoutSessionsSessionExpireRequest({this.expand});
...
@override String toString() { return 'PostCheckoutSessionsSessionExpireRequest(expand: $expand)'; } 
 }
