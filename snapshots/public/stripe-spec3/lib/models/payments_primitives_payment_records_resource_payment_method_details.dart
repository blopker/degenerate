...
import 'payment_flows_private_payment_methods_alipay_details.dart';import 'payment_method_details_ach_credit_transfer.dart';import 'payment_method_details_ach_debit.dart';import 'payment_method_details_acss_debit.dart';import 'payment_method_details_alma.dart';import 'payment_method_details_amazon_pay.dart';import 'payment_method_details_au_becs_debit.dart';import 'payment_method_details_bacs_debit.dart';import 'payment_method_details_billie.dart';import 'payment_method_details_blik.dart';import 'payment_method_details_card_present.dart';import 'payment_method_details_crypto.dart';import 'payment_method_details_customer_balance.dart';import 'payment_method_details_eps.dart';import 'payment_method_details_fpx.dart';import 'payment_method_details_grabpay.dart';import 'payment_method_details_ideal.dart';import 'payment_method_details_interac_present.dart';import 'payment_method_details_klarna.dart';import 'payment_method_details_kr_card.dart';import 'payment_method_details_link.dart';import 'payment_method_details_mobilepay.dart';import 'payment_method_details_nz_bank_account.dart';import 'payment_method_details_p24.dart';import 'payment_method_details_pay_by_bank.dart';import 'payment_method_details_payco.dart';import 'payment_method_details_payment_record_affirm.dart';import 'payment_method_details_payment_record_afterpay_clearpay.dart';import 'payment_method_details_payment_record_bancontact.dart';import 'payment_method_details_payment_record_boleto.dart';import 'payment_method_details_payment_record_cashapp.dart';import 'payment_method_details_payment_record_giropay.dart';import 'payment_method_details_payment_record_kakao_pay.dart';import 'payment_method_details_payment_record_konbini.dart';import 'payment_method_details_payment_record_mb_way.dart';import 'payment_method_details_payment_record_multibanco.dart';import 'payment_method_details_payment_record_naver_pay.dart';import 'payment_method_details_payment_record_oxxo.dart';import 'payment_method_details_payment_record_paynow.dart';import 'payment_method_details_payment_record_promptpay.dart';import 'payment_method_details_payment_record_us_bank_account.dart';import 'payment_method_details_payment_record_wechat_pay.dart';import 'payment_method_details_payment_record_zip.dart';import 'payment_method_details_paypal.dart';import 'payment_method_details_payto.dart';import 'payment_method_details_pix.dart';import 'payment_method_details_revolut_pay.dart';import 'payment_method_details_samsung_pay.dart';import 'payment_method_details_satispay.dart';import 'payment_method_details_sepa_debit.dart';import 'payment_method_details_sofort.dart';import 'payment_method_details_stripe_account.dart';import 'payment_method_details_swish.dart';import 'payment_method_details_twint.dart';import 'payment_method_details_wechat.dart';import 'payments_primitives_payment_records_resource_payment_method_card_details.dart';import 'payments_primitives_payment_records_resource_payment_method_custom_details.dart';import 'payments_primitives_payment_records_resource_payment_method_details_billing_details.dart';/// Details about the Payment Method used in this payment attempt.
final class PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails {const PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails({this.achCreditTransfer, this.achDebit, this.acssDebit, this.affirm, this.afterpayClearpay, this.alipay, this.alma, this.amazonPay, this.auBecsDebit, this.bacsDebit, this.bancontact, this.billie, this.billingDetails, this.blik, this.boleto, this.card, this.cardPresent, this.cashapp, this.crypto, this.custom, this.customerBalance, this.eps, this.fpx, this.giropay, this.grabpay, this.ideal, this.interacPresent, this.kakaoPay, this.klarna, this.konbini, this.krCard, this.link, this.mbWay, this.mobilepay, this.multibanco, this.naverPay, this.nzBankAccount, this.oxxo, this.p24, this.payByBank, this.payco, this.paymentMethod, this.paynow, this.paypal, this.payto, this.pix, this.promptpay, this.revolutPay, this.samsungPay, this.satispay, this.sepaDebit, this.sofort, this.stripeAccount, this.swish, this.twint, required this.type, this.usBankAccount, this.wechat, this.wechatPay, this.zip, });
...
factory PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails.fromJson(Map<String, dynamic> json) { return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
  ...
  billingDetails: json['billing_details'] != null ? PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsBillingDetails.fromJson(json['billing_details'] as Map<String, dynamic>) : null,
...
final PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetailsBillingDetails? billingDetails;
