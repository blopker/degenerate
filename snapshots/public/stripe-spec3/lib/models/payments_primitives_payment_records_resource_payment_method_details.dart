...
factory PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails.fromJson(Map<String, dynamic> json) { return PaymentsPrimitivesPaymentRecordsResourcePaymentMethodDetails(
  ...
  billingDetails: json.containsKey('billing_details') ? Omittable(json['billing_details'] != null ? PaymentsPrimitivesPaymentRecordsResourceBillingDetails.fromJson(json['billing_details'] as Map<String, dynamic>) : null) : const Omittable.absent(),
...
final Omittable<PaymentsPrimitivesPaymentRecordsResourceBillingDetails?> billingDetails;
