...
import 'package:degenerate_runtime/degenerate_runtime.dart';@immutable final class Tipping2Gip {const Tipping2Gip({this.fixedAmounts, this.percentages, this.smartTipThreshold, });
