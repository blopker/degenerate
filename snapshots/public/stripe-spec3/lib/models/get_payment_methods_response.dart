...
@immutable final class GetPaymentMethodsResponseObject {const GetPaymentMethodsResponseObject._(this.value);
...
/// 
@immutable final class GetPaymentMethodsResponse {const GetPaymentMethodsResponse({required this.data, required this.hasMore, required this.object, required this.url, });
