...
final class LoginLinkObject {const LoginLinkObject._(this.value);
...
final class LoginLink {const LoginLink({required this.created, required this.object, required this.url, });
