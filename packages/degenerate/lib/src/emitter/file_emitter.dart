...
class FileEmitter {
  ...
  /// Write the standard header to a StringBuffer.
  void _writeHeader(StringBuffer buf, String specFileName, String specVersion) {
  ...
  String _emitBarrelFile({
    ...
    _writeHeader(buf, specFileName, specVersion);
