...
class FileEmitter {
  ...
  /// Header comments for code_builder Libraries.
  ...
  String _emitWithHeader(String body, String specFileName, String specVersion) {
    final library = Library((b) {
      b.comments.addAll(_header(specFileName, specVersion));
  ...
  String _emitSdkFacade({
    ...
    buf.writeln('}');
    return _emitWithHeader(buf.toString(), specFileName, specVersion);
  }
